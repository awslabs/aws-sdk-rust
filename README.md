...
# The AWS SDK for Rust [![Docs](https://img.shields.io/badge/docs-blue)](https://awslabs.github.io/aws-sdk-rust/) ![MSRV](https://img.shields.io/badge/msrv-1.91.1-red) [![Usage Guide](https://img.shields.io/badge/Developer_Guide-blue)](https://docs.aws.amazon.com/sdk-for-rust/latest/dg/welcome.html)
...
2. Add dependencies to DynamoDB and Tokio to your **Cargo.toml** file:
    ...
    ```toml
    [dependencies]
    aws-config = { version= "1.8.17", features = ["behavior-version-latest"] }
    aws-sdk-dynamodb = "1.113.0"
...
The SDK currently requires a minimum of Rust 1.91.1, and is not guaranteed to build on compiler versions
