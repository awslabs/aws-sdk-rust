...
pub struct StartTaskExecutionOutput  {
    ...
    #[doc(hidden)]pub task_execution_arn: std::option::Option<std::string::String>,
}
...
pub struct ListTasksOutput  {
    ...
    #[doc(hidden)]pub tasks: std::option::Option<std::vec::Vec<crate::model::TaskListEntry>>,
...
pub struct ListTaskExecutionsOutput  {
    ...
    #[doc(hidden)]pub task_executions: std::option::Option<std::vec::Vec<crate::model::TaskExecutionListEntry>>,
...
pub struct ListTagsForResourceOutput  {
    ...
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<crate::model::TagListEntry>>,
...
pub struct ListLocationsOutput  {
    ...
    #[doc(hidden)]pub locations: std::option::Option<std::vec::Vec<crate::model::LocationListEntry>>,
...
pub struct ListAgentsOutput  {
    ...
    #[doc(hidden)]pub agents: std::option::Option<std::vec::Vec<crate::model::AgentListEntry>>,
...
pub struct DescribeTaskExecutionOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::TaskExecutionStatus>,
    ...
    #[doc(hidden)]pub options: std::option::Option<crate::model::Options>,
    ...
    /// <p> </p>
    #[doc(hidden)]pub excludes: std::option::Option<std::vec::Vec<crate::model::FilterRule>>,
    ...
    /// <p> </p>
    #[doc(hidden)]pub includes: std::option::Option<std::vec::Vec<crate::model::FilterRule>>,
    ...
    #[doc(hidden)]pub estimated_files_to_transfer: i64,
    /// <p>The estimated physical number of bytes that is to be transferred over the network.</p>
    #[doc(hidden)]pub estimated_bytes_to_transfer: i64,
    ...
    #[doc(hidden)]pub files_transferred: i64,
    /// <p>The number of logical bytes written to the destination Amazon Web Services storage resource.</p>
    #[doc(hidden)]pub bytes_written: i64,
    /// <p>The physical number of bytes transferred over the network.</p>
    #[doc(hidden)]pub bytes_transferred: i64,
    /// <p>The result of the task execution.</p>
    #[doc(hidden)]pub result: std::option::Option<crate::model::TaskExecutionResultDetail>,
}
...
impl  std::fmt::Debug for DescribeTaskExecutionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("estimated_files_to_transfer", &self.estimated_files_to_transfer);
        formatter.field("estimated_bytes_to_transfer", &self.estimated_bytes_to_transfer);
...
pub struct DescribeTaskOutput  {
    ...
    #[doc(hidden)]pub task_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub current_task_execution_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the source file system's location.</p>
    #[doc(hidden)]pub source_location_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the Amazon Web Services storage resource's location.</p>
    #[doc(hidden)]pub destination_location_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cloud_watch_log_group_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Names (ARNs) of the source elastic network interfaces (ENIs) that were created for your subnet.</p>
    #[doc(hidden)]pub source_network_interface_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The Amazon Resource Names (ARNs) of the destination elastic network interfaces (ENIs) that were created for your subnet.</p>
    #[doc(hidden)]pub destination_network_interface_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub schedule: std::option::Option<crate::model::TaskSchedule>,
    ...
    #[doc(hidden)]pub error_detail: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for DescribeTaskOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("current_task_execution_arn", &self.current_task_execution_arn);
        ...
        formatter.field("source_network_interface_arns", &self.source_network_interface_arns);
        formatter.field("destination_network_interface_arns", &self.destination_network_interface_arns);
        formatter.field("options", &self.options);
        formatter.field("excludes", &self.excludes);
...
pub struct DescribeLocationSmbOutput  {
    ...
    #[doc(hidden)]pub location_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub agent_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The user who can mount the share, has the permissions to access files and folders in the SMB share.</p>
    #[doc(hidden)]pub user: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub mount_options: std::option::Option<crate::model::SmbMountOptions>,
...
pub struct DescribeLocationS3Output  {
    ...
    #[doc(hidden)]pub s3_storage_class: std::option::Option<crate::model::S3StorageClass>,
    ...
    #[doc(hidden)]pub s3_config: std::option::Option<crate::model::S3Config>,
...
pub struct DescribeLocationObjectStorageOutput  {
    ...
    #[doc(hidden)]pub access_key: std::option::Option<std::string::String>,
    /// <p>The port that your object storage server accepts inbound network traffic on (for example, port 443).</p>
    #[doc(hidden)]pub server_port: std::option::Option<i32>,
    /// <p>The protocol that your object storage server uses to communicate.</p>
    #[doc(hidden)]pub server_protocol: std::option::Option<crate::model::ObjectStorageServerProtocol>,
...
pub struct DescribeLocationNfsOutput  {
    ...
    #[doc(hidden)]pub on_prem_config: std::option::Option<crate::model::OnPremConfig>,
    /// <p>The NFS mount options that DataSync used to mount your NFS share.</p>
    #[doc(hidden)]pub mount_options: std::option::Option<crate::model::NfsMountOptions>,
...
pub struct DescribeLocationHdfsOutput  {
    ...
    #[doc(hidden)]pub name_nodes: std::option::Option<std::vec::Vec<crate::model::HdfsNameNode>>,
    /// <p>The size of the data blocks to write into the HDFS cluster. </p>
    #[doc(hidden)]pub block_size: std::option::Option<i32>,
    /// <p>The number of DataNodes to replicate the data to when writing to the HDFS cluster. </p>
    #[doc(hidden)]pub replication_factor: std::option::Option<i32>,
    /// <p> The URI of the HDFS cluster's Key Management Server (KMS). </p>
    #[doc(hidden)]pub kms_key_provider_uri: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub qop_configuration: std::option::Option<crate::model::QopConfiguration>,
    /// <p>The type of authentication used to determine the identity of the user. </p>
    #[doc(hidden)]pub authentication_type: std::option::Option<crate::model::HdfsAuthenticationType>,
    ...
    #[doc(hidden)]pub simple_user: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub kerberos_principal: std::option::Option<std::string::String>,
...
pub struct DescribeLocationFsxWindowsOutput  {
    ...
    #[doc(hidden)]pub security_group_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct DescribeLocationFsxOpenZfsOutput  {
    ...
    #[doc(hidden)]pub protocol: std::option::Option<crate::model::FsxProtocol>,
...
pub struct DescribeLocationFsxOntapOutput  {
    ...
    #[doc(hidden)]pub storage_virtual_machine_arn: std::option::Option<std::string::String>,
    /// <p>The ARN of the FSx for ONTAP file system.</p>
    #[doc(hidden)]pub fsx_filesystem_arn: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeLocationFsxOntapOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("DescribeLocationFsxOntapOutput");
        formatter.field("creation_time", &self.creation_time);
        formatter.field("location_arn", &self.location_arn);
        formatter.field("location_uri", &self.location_uri);
        formatter.field("protocol", &self.protocol);
        formatter.field("security_group_arns", &self.security_group_arns);
        formatter.field("storage_virtual_machine_arn", &self.storage_virtual_machine_arn);
...
pub struct DescribeLocationEfsOutput  {
    ...
    #[doc(hidden)]pub ec2_config: std::option::Option<crate::model::Ec2Config>,
    /// <p>The time that the location was created.</p>
    #[doc(hidden)]pub creation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The ARN of the access point that DataSync uses to access the Amazon EFS file system.</p>
    #[doc(hidden)]pub access_point_arn: std::option::Option<std::string::String>,
    /// <p>The Identity and Access Management (IAM) role that DataSync assumes when mounting the Amazon EFS file system.</p>
    #[doc(hidden)]pub file_system_access_role_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub in_transit_encryption: std::option::Option<crate::model::EfsInTransitEncryption>,
}
...
impl  std::fmt::Debug for DescribeLocationEfsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("file_system_access_role_arn", &self.file_system_access_role_arn);
...
pub struct DescribeAgentOutput  {
    ...
    #[doc(hidden)]pub agent_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AgentStatus>,
    /// <p>The time that the agent last connected to DataSync.</p>
    #[doc(hidden)]pub last_connection_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub endpoint_type: std::option::Option<crate::model::EndpointType>,
    /// <p>The subnet and the security group that DataSync used to access a VPC endpoint.</p>
    #[doc(hidden)]pub private_link_config: std::option::Option<crate::model::PrivateLinkConfig>,
}
...
impl  std::fmt::Debug for CreateLocationFsxOntapOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut formatter = f.debug_struct("CreateLocationFsxOntapOutput");
        formatter.field("location_arn", &self.location_arn);
        formatter.finish()
    }
}
