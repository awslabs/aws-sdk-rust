...
pub struct DescribeAgentOutput {
    ...
    pub last_connection_time: std::option::Option<smithy_types::Instant>,
...
pub mod describe_agent_output {
    ...
    pub struct Builder {
        ...
        pub(crate) last_connection_time: std::option::Option<smithy_types::Instant>,
        pub(crate) creation_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The time that the agent last connected to DataSync.</p>
        pub fn last_connection_time(mut self, input: smithy_types::Instant) -> Self {
