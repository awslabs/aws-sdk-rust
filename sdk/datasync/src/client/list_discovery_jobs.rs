...
impl super::Client {
    ...
    ///   - [`storage_system_arn(impl Into<String>)`](crate::operation::list_discovery_jobs::builders::ListDiscoveryJobsFluentBuilder::storage_system_arn) / [`set_storage_system_arn(Option<String>)`](crate::operation::list_discovery_jobs::builders::ListDiscoveryJobsFluentBuilder::set_storage_system_arn): <p>Specifies the Amazon Resource Name (ARN) of an on-premises storage system. Use this parameter if you only want to list the discovery jobs that are associated with a specific storage system.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_discovery_jobs::builders::ListDiscoveryJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_discovery_jobs::builders::ListDiscoveryJobsFluentBuilder::set_next_token): <p>Specifies an opaque string that indicates the position to begin the next list of results in the response.</p>
