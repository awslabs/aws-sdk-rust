...
impl super::Client  {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::set_next_token): <p>Specifies an opaque string that indicates the position to begin the next list of results in the response. </p>
