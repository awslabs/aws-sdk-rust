...
impl super::Client {
    ...
    ///   - [`managed_secret_config(Option<ManagedSecretConfig>)`](crate::operation::describe_location_hdfs::DescribeLocationHdfsOutput::managed_secret_config): <p>Describes configuration information for a DataSync-managed secret, such as a <code>KerberosKeytab</code> that DataSync uses to access a specific storage location. DataSync uses the default Amazon Web Services-managed KMS key to encrypt this secret in Secrets Manager.</p>
    ///   - [`cmk_secret_config(Option<CmkSecretConfig>)`](crate::operation::describe_location_hdfs::DescribeLocationHdfsOutput::cmk_secret_config): <p>Describes configuration information for a DataSync-managed secret, such as a <code>KerberosKeytab</code> that DataSync uses to access a specific storage location, with a customer-managed KMS key.</p>
    ///   - [`custom_secret_config(Option<CustomSecretConfig>)`](crate::operation::describe_location_hdfs::DescribeLocationHdfsOutput::custom_secret_config): <p>Describes configuration information for a customer-managed secret, such as a <code>KerberosKeytab</code> that DataSync uses to access a specific storage location, with a customer-managed Identity and Access Management (IAM) role that provides access to the secret.</p>
