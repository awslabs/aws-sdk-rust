...
impl super::Client {
    ...
    pub fn update_task_execution(
        &self,
    ) -> crate::operation::update_task_execution::builders::UpdateTaskExecutionFluentBuilder {
        crate::operation::update_task_execution::builders::UpdateTaskExecutionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
