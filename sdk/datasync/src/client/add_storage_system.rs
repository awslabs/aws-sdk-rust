...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_name): <p>Specifies a familiar name for your on-premises storage system.</p>
