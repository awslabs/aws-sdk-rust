...
impl super::Client {
    ...
    ///   - [`server_configuration(DiscoveryServerConfiguration)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::server_configuration) / [`set_server_configuration(Option<DiscoveryServerConfiguration>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_server_configuration): <p>Specifies the server name and network port required to connect with the management interface of your on-premises storage system.</p>
    ///   - [`system_type(DiscoverySystemType)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::system_type) / [`set_system_type(Option<DiscoverySystemType>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_system_type): <p>Specifies the type of on-premises storage system that you want DataSync Discovery to collect information about.</p> <note>   <p>DataSync Discovery currently supports NetApp Fabric-Attached Storage (FAS) and All Flash FAS (AFF) systems running ONTAP 9.7 or later.</p>  </note>
    ///   - [`agent_arns(Vec<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::agent_arns) / [`set_agent_arns(Option<Vec<String>>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_agent_arns): <p>Specifies the Amazon Resource Name (ARN) of the DataSync agent that connects to and reads from your on-premises storage system's management interface. You can only specify one ARN.</p>
    ///   - [`cloud_watch_log_group_arn(impl ::std::convert::Into<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::cloud_watch_log_group_arn) / [`set_cloud_watch_log_group_arn(Option<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_cloud_watch_log_group_arn): <p>Specifies the ARN of the Amazon CloudWatch log group for monitoring and logging discovery job events.</p>
    ///   - [`tags(Vec<TagListEntry>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::tags) / [`set_tags(Option<Vec<TagListEntry>>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_tags): <p>Specifies labels that help you categorize, filter, and search for your Amazon Web Services resources. We recommend creating at least a name tag for your on-premises storage system.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_name): <p>Specifies a familiar name for your on-premises storage system.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_client_token): <p>Specifies a client token to make sure requests with this API operation are idempotent. If you don't specify a client token, DataSync generates one for you automatically.</p>
    ///   - [`credentials(Credentials)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::credentials) / [`set_credentials(Option<Credentials>)`](crate::operation::add_storage_system::builders::AddStorageSystemFluentBuilder::set_credentials): <p>Specifies the user name and password for accessing your on-premises storage system's management interface.</p>
