...
impl super::Client {
    ...
    ///   - [`location_arn(impl Into<String>)`](crate::operation::delete_location::builders::DeleteLocationFluentBuilder::location_arn) / [`set_location_arn(Option<String>)`](crate::operation::delete_location::builders::DeleteLocationFluentBuilder::set_location_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the location to delete.</p><br>
