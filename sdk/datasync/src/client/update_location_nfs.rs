...
impl super::Client {
    ...
    ///   - [`server_hostname(impl Into<String>)`](crate::operation::update_location_nfs::builders::UpdateLocationNfsFluentBuilder::server_hostname) / [`set_server_hostname(Option<String>)`](crate::operation::update_location_nfs::builders::UpdateLocationNfsFluentBuilder::set_server_hostname):<br>required: **false**<br><p>Specifies the DNS name or IP address (IPv4 or IPv6) of the NFS file server that your DataSync agent connects to.</p><br>
