...
impl super::Client {
    ...
    ///   - [`task_arn(impl ::std::convert::Into<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::task_arn) / [`set_task_arn(Option<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::set_task_arn): <p>The Amazon Resource Name (ARN) of the task whose tasks you want to list.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::set_next_token): <p>An opaque string that indicates the position at which to begin the next list of the executed tasks.</p>
