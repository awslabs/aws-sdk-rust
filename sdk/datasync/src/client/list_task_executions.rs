...
impl super::Client {
    ...
    ///   - [`task_arn(impl Into<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::task_arn) / [`set_task_arn(Option<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::set_task_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the task whose tasks you want to list.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of executed tasks to list.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_task_executions::builders::ListTaskExecutionsFluentBuilder::set_next_token):<br>required: **false**<br><p>An opaque string that indicates the position at which to begin the next list of the executed tasks.</p><br>
