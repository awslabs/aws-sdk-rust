...
impl super::Client {
    ...
    ///   - [`location_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_location_s3::builders::DescribeLocationS3FluentBuilder::location_arn) / [`set_location_arn(Option<String>)`](crate::operation::describe_location_s3::builders::DescribeLocationS3FluentBuilder::set_location_arn): <p>The Amazon Resource Name (ARN) of the Amazon S3 bucket location to describe.</p>
