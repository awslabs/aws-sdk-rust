...
impl super::Client {
    ...
    ///   - [`dns_ip_addresses(Option<Vec::<String>>)`](crate::operation::describe_location_smb::DescribeLocationSmbOutput::dns_ip_addresses): <p>The IPv4 addresses for the DNS servers that your SMB file server belongs to. This element applies only if <code>AuthenticationType</code> is set to <code>KERBEROS</code>.</p>
    ///   - [`kerberos_principal(Option<String>)`](crate::operation::describe_location_smb::DescribeLocationSmbOutput::kerberos_principal): <p>The Kerberos service principal name (SPN) that has permission to access the files, folders, and file metadata in your SMB file server.</p>
