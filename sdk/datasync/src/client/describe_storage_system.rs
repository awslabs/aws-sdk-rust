...
impl super::Client  {
    ...
    ///   - [`storage_system_arn(impl Into<String>)`](crate::operation::describe_storage_system::builders::DescribeStorageSystemFluentBuilder::storage_system_arn) / [`set_storage_system_arn(Option<String>)`](crate::operation::describe_storage_system::builders::DescribeStorageSystemFluentBuilder::set_storage_system_arn): <p>Specifies the Amazon Resource Name (ARN) of an on-premises storage system that you're using with DataSync Discovery.</p>
