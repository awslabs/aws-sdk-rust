...
impl ::std::convert::From<&str> for LocationFilterName {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LocationFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LocationFilterName {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LocationFilterName::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LocationFilterName {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
