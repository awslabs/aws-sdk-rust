...
/// When writing a match expression against `DiscoveryJobStatus`, it is important to ensure
...
///     DiscoveryJobStatus::CompletedWithIssues => { /* ... */ },
///     DiscoveryJobStatus::Failed => { /* ... */ },
///     DiscoveryJobStatus::Running => { /* ... */ },
///     DiscoveryJobStatus::Stopped => { /* ... */ },
///     DiscoveryJobStatus::Terminated => { /* ... */ },
///     DiscoveryJobStatus::Warning => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `discoveryjobstatus` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `DiscoveryJobStatus::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `DiscoveryJobStatus::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `DiscoveryJobStatus::NewFeature` is defined.
...
impl ::std::convert::From<&str> for DiscoveryJobStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DiscoveryJobStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DiscoveryJobStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DiscoveryJobStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DiscoveryJobStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
