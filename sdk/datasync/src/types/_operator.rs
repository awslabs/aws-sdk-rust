...
impl ::std::convert::From<&str> for Operator {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Operator::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Operator {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Operator::from(s))
    }
}
impl Operator {
...
impl ::std::convert::AsRef<str> for Operator {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for Operator {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            Operator::BeginsWith => write!(f, "BeginsWith"),
            Operator::Contains => write!(f, "Contains"),
            Operator::Eq => write!(f, "Equals"),
            Operator::Gt => write!(f, "GreaterThan"),
            Operator::Ge => write!(f, "GreaterThanOrEqual"),
            Operator::In => write!(f, "In"),
            Operator::Lt => write!(f, "LessThan"),
