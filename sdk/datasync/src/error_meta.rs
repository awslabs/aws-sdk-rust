...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::create_agent::CreateAgentError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::delete_agent::DeleteAgentError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError>
    for Error
{
    fn from(
        err: crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError,
    ) -> Self {
        match err {
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::update_agent::UpdateAgentError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
