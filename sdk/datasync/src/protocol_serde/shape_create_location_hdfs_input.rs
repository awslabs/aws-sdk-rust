...
pub fn ser_create_location_hdfs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLocationHdfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
