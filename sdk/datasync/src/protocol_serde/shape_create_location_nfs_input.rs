...
pub fn ser_create_location_nfs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLocationNfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
