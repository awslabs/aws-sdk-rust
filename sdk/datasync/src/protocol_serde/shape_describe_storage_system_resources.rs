...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_storage_system_resources_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesOutput, crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError> {
    Ok({
        #[allow(unused_mut)]
