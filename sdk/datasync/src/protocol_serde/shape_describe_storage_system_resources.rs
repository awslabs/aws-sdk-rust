...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidRequestException" => {
            crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_storage_system_resources_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_storage_system_resources::de_describe_storage_system_resources(_response_body, output)
            .map_err(crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError::unhandled)?;
...
pub fn ser_describe_storage_system_resources_input(
    ...
    crate::protocol_serde::shape_describe_storage_system_resources_input::ser_describe_storage_system_resources_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_describe_storage_system_resources(
    value: &[u8],
    mut builder: crate::operation::describe_storage_system_resources::builders::DescribeStorageSystemResourcesOutputBuilder,
) -> Result<
    crate::operation::describe_storage_system_resources::builders::DescribeStorageSystemResourcesOutputBuilder,
