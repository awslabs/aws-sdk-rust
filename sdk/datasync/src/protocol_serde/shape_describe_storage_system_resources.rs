...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_storage_system_resources_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesOutput, crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_describe_storage_system_resources_input(input: &crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
