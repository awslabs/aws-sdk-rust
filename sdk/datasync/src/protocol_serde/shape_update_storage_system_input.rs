...
pub fn ser_update_storage_system_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_storage_system::UpdateStorageSystemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
