...
pub fn ser_update_location_nfs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLocationNfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
