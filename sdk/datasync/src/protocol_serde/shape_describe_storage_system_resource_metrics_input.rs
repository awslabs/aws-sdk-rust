...
pub fn ser_describe_storage_system_resource_metrics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_storage_system_resource_metrics::DescribeStorageSystemResourceMetricsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
