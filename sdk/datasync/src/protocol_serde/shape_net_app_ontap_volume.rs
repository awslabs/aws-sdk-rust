...
pub(crate) fn de_net_app_ontap_volume<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::NetAppOntapVolume>, aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "NfsExported" => {
                                builder = builder.set_nfs_exported(
