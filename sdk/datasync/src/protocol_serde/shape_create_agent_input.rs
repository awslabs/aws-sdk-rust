...
pub fn ser_create_agent_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAgentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
