...
pub fn ser_update_task_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTaskExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
