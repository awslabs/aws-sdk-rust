...
pub fn ser_update_location_smb_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLocationSmbInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
