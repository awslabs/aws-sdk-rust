...
pub fn ser_start_task_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTaskExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
