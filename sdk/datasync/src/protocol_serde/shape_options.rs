...
pub fn ser_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Options) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Options>, aws_smithy_json::deserialize::error::DeserializeError>
