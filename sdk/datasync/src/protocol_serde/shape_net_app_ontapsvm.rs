...
pub(crate) fn de_net_app_ontapsvm<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::NetAppOntapsvm>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "EnabledProtocols" => {
                            builder = builder.set_enabled_protocols(crate::protocol_serde::shape_enabled_protocols::de_enabled_protocols(tokens)?);
                        }
                        "TotalCapacityUsed" => {
