...
pub fn ser_create_location_smb_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLocationSmbInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
