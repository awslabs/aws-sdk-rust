...
pub fn ser_create_location_fsx_open_zfs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLocationFsxOpenZfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
