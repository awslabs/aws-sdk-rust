...
pub fn ser_create_location_efs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLocationEfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
