...
pub fn ser_describe_storage_system_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
