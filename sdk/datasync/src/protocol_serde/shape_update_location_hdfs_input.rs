...
pub fn ser_update_location_hdfs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLocationHdfsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
