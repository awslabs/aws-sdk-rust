...
pub(crate) fn de_net_app_ontap_cluster<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::NetAppOntapCluster>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "MaxP95Performance" => {
                                builder = builder.set_max_p95_performance(
                                    crate::protocol_serde::shape_max_p95_performance::de_max_p95_performance(tokens)?
                                );
                            }
                            ...
                            "RecommendationStatus" => {
                                builder = builder.set_recommendation_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RecommendationStatus::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
