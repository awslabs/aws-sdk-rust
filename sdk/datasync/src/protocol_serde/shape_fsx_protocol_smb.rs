...
pub fn ser_fsx_protocol_smb(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FsxProtocolSmb) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_fsx_protocol_smb<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FsxProtocolSmb>, aws_smithy_json::deserialize::error::DeserializeError>
