...
pub fn ser_update_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
