...
impl CreateLocationS3Input {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_location_s3::ser_create_location_s3_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationS3 {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_s3::de_create_location_s3_http_response_with_props(status, headers, body)
        }
    }
}
