...
impl CreateLocationHdfsInput {
    /// Consumes the builder and constructs an Operation<[`CreateLocationHdfs`](crate::operation::create_location_hdfs::CreateLocationHdfs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_location_hdfs::CreateLocationHdfs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_location_hdfs::CreateLocationHdfsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_location_hdfs::CreateLocationHdfs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLocationHdfs {
                type Output = std::result::Result<crate::operation::create_location_hdfs::CreateLocationHdfsOutput, crate::operation::create_location_hdfs::CreateLocationHdfsError>;
