...
impl CreateLocationHdfsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_location_hdfs::ser_create_location_hdfs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationHdfs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_hdfs::de_create_location_hdfs_http_response_with_props(status, headers, body)
        }
    }
}
