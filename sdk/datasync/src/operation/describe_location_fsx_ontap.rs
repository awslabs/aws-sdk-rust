...
impl DescribeLocationFsxOntapInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_location_fsx_ontap::DescribeLocationFsxOntap::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocationFsxOntap {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_location_fsx_ontap::de_describe_location_fsx_ontap_http_response_with_props(status, headers, body)
        }
    }
