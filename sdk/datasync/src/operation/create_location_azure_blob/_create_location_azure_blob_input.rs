...
impl CreateLocationAzureBlobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_location_azure_blob::CreateLocationAzureBlobInput, ::aws_smithy_types::error::operation::BuildError> {
