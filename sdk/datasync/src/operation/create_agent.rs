...
impl CreateAgentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_agent::CreateAgent, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_agent::ser_create_agent_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAgent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_agent::de_create_agent_http_response_with_props(status, headers, body)
        }
    }
}
