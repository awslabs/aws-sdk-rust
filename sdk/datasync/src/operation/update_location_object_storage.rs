...
impl UpdateLocationObjectStorageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_location_object_storage::UpdateLocationObjectStorage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLocationObjectStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_location_object_storage::de_update_location_object_storage_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateLocationObjectStorageError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_location_object_storage::UpdateLocationObjectStorageError
{
