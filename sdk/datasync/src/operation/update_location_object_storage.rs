...
impl UpdateLocationObjectStorageInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLocationObjectStorage`](crate::operation::update_location_object_storage::UpdateLocationObjectStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_location_object_storage::UpdateLocationObjectStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_location_object_storage::UpdateLocationObjectStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_location_object_storage::ser_update_location_object_storage_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_location_object_storage::UpdateLocationObjectStorage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLocationObjectStorage {
                type Output = std::result::Result<crate::operation::update_location_object_storage::UpdateLocationObjectStorageOutput, crate::operation::update_location_object_storage::UpdateLocationObjectStorageError>;
