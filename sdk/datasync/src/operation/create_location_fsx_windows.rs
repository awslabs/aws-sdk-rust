...
impl CreateLocationFsxWindows {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLocationFsxWindows {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLocationFsxWindows");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLocationFsxWindowsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLocationFsxWindowsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLocationFsxWindows")
...
.with_interceptor(CreateLocationFsxWindowsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError>::new());
...
#[derive(Debug)]
            struct CreateLocationFsxWindowsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLocationFsxWindowsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_location_fsx_windows::de_create_location_fsx_windows_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_location_fsx_windows::de_create_location_fsx_windows_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateLocationFsxWindowsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLocationFsxWindowsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_location_fsx_windows::ser_create_location_fsx_windows_input(&input)?);
...
#[derive(Debug)]
            struct CreateLocationFsxWindowsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLocationFsxWindowsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLocationFsxWindowsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLocationFsxWindowsInput>()
                        .ok_or("failed to downcast to CreateLocationFsxWindowsInput")?;
...
pub enum CreateLocationFsxWindowsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLocationFsxWindowsError) for what information is available for the error.")]
...
impl CreateLocationFsxWindowsError {
    /// Creates the `CreateLocationFsxWindowsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLocationFsxWindowsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLocationFsxWindowsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsError {
...
mod _create_location_fsx_windows_output;
