...
impl CreateLocationFsxWindowsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_location_fsx_windows::CreateLocationFsxWindows::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationFsxWindows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_fsx_windows::de_create_location_fsx_windows_http_response_with_props(status, headers, body)
        }
    }
}
