...
impl DescribeLocationFsxWindowsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindows,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindows::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocationFsxWindows {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_location_fsx_windows::de_describe_location_fsx_windows_http_response_with_props(
                status, headers, body,
            )
        }
    }
