...
/// Orchestration and serialization glue logic for `DescribeLocationFsxWindows`.
...
impl DescribeLocationFsxWindows {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsInput,
                    ) -> ::std::result::Result<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLocationFsxWindows {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeLocationFsxWindows");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeLocationFsxWindowsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeLocationFsxWindowsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLocationFsxWindows")
...
.with_interceptor(DescribeLocationFsxWindowsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError>::new());
...
#[derive(Debug)]
            struct DescribeLocationFsxWindowsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLocationFsxWindowsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_location_fsx_windows::de_describe_location_fsx_windows_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeLocationFsxWindowsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLocationFsxWindowsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_location_fsx_windows::ser_describe_location_fsx_windows_input(&input)?);
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeLocationFsxWindowsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeLocationFsxWindowsInput>()
                        .ok_or("failed to downcast to DescribeLocationFsxWindowsInput")?;
...
pub enum DescribeLocationFsxWindowsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeLocationFsxWindowsError) for what information is available for the error.")]
...
impl DescribeLocationFsxWindowsError {
    /// Creates the `DescribeLocationFsxWindowsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLocationFsxWindowsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeLocationFsxWindowsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_location_fsx_windows::DescribeLocationFsxWindowsError {
...
mod _describe_location_fsx_windows_output;
