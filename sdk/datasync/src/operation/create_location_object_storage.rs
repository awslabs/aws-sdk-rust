...
impl CreateLocationObjectStorageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_location_object_storage::CreateLocationObjectStorage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationObjectStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_object_storage::de_create_location_object_storage_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateLocationObjectStorageError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_location_object_storage::CreateLocationObjectStorageError
{
