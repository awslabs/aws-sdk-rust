...
impl CreateLocationObjectStorageInput {
    /// Consumes the builder and constructs an Operation<[`CreateLocationObjectStorage`](crate::operation::create_location_object_storage::CreateLocationObjectStorage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_location_object_storage::CreateLocationObjectStorage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_location_object_storage::CreateLocationObjectStorageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_location_object_storage::CreateLocationObjectStorage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLocationObjectStorage {
                type Output = std::result::Result<crate::operation::create_location_object_storage::CreateLocationObjectStorageOutput, crate::operation::create_location_object_storage::CreateLocationObjectStorageError>;
