...
impl DescribeLocationS3Input {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_location_s3::ser_describe_location_s3_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocationS3 {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_location_s3::de_describe_location_s3_http_response_with_props(status, headers, body)
        }
    }
}
