...
impl ListStorageSystemsFluentBuilder  {
    /// Creates a new `ListStorageSystems`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_storage_systems::ListStorageSystems, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_storage_systems::ListStorageSystemsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_storage_systems::ListStorageSystemsOutput, aws_smithy_http::result::SdkError<crate::operation::list_storage_systems::ListStorageSystemsError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_storage_systems::paginator::ListStorageSystemsPaginator::send) which returns a `Stream`.
