...
impl CancelTaskExecutionInput {
    /// Consumes the builder and constructs an Operation<[`CancelTaskExecution`](crate::operation::cancel_task_execution::CancelTaskExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_task_execution::CancelTaskExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_task_execution::CancelTaskExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_task_execution::CancelTaskExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CancelTaskExecution {
                type Output = std::result::Result<crate::operation::cancel_task_execution::CancelTaskExecutionOutput, crate::operation::cancel_task_execution::CancelTaskExecutionError>;
