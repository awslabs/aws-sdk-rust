...
impl CreateLocationFsxOpenZfsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_location_fsx_open_zfs::CreateLocationFsxOpenZfs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationFsxOpenZfs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_fsx_open_zfs::de_create_location_fsx_open_zfs_http_response_with_props(status, headers, body)
        }
    }
}
