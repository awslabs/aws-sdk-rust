...
impl DescribeLocationNfsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLocationNfs`](crate::operation::describe_location_nfs::DescribeLocationNfs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_location_nfs::DescribeLocationNfs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_location_nfs::DescribeLocationNfsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_location_nfs::ser_describe_location_nfs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_location_nfs::DescribeLocationNfs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLocationNfs {
                type Output = std::result::Result<crate::operation::describe_location_nfs::DescribeLocationNfsOutput, crate::operation::describe_location_nfs::DescribeLocationNfsError>;
