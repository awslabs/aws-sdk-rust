...
impl DescribeLocationEfsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLocationEfs`](crate::operation::describe_location_efs::DescribeLocationEfs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_location_efs::DescribeLocationEfs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_location_efs::DescribeLocationEfsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_location_efs::ser_describe_location_efs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_location_efs::DescribeLocationEfs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLocationEfs {
                type Output = std::result::Result<crate::operation::describe_location_efs::DescribeLocationEfsOutput, crate::operation::describe_location_efs::DescribeLocationEfsError>;
