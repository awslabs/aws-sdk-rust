...
impl DescribeLocationEfs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_location_efs::DescribeLocationEfsInput,
                    ) -> ::std::result::Result<crate::operation::describe_location_efs::DescribeLocationEfsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_location_efs::DescribeLocationEfsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_location_efs::DescribeLocationEfsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_location_efs::DescribeLocationEfsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLocationEfs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeLocationEfs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeLocationEfsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeLocationEfsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLocationEfs")
...
.with_interceptor(DescribeLocationEfsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_location_efs::DescribeLocationEfsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_location_efs::DescribeLocationEfsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_location_efs::DescribeLocationEfsError>::new());
...
#[derive(Debug)]
            struct DescribeLocationEfsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLocationEfsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_location_efs::de_describe_location_efs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeLocationEfsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLocationEfsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_location_efs::DescribeLocationEfsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_location_efs::DescribeLocationEfsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_location_efs::ser_describe_location_efs_input(&input)?);
...
#[derive(Debug)]
            struct DescribeLocationEfsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeLocationEfsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeLocationEfsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeLocationEfsInput>()
                        .ok_or("failed to downcast to DescribeLocationEfsInput")?;
...
pub enum DescribeLocationEfsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeLocationEfsError) for what information is available for the error.")]
...
impl DescribeLocationEfsError {
    /// Creates the `DescribeLocationEfsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLocationEfsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeLocationEfsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_location_efs::DescribeLocationEfsError {
...
mod _describe_location_efs_output;
