...
impl DescribeLocationEfsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_location_efs::ser_describe_location_efs_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_location_efs::DescribeLocationEfs::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_location_efs::DescribeLocationEfsError
{
