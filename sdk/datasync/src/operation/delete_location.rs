...
impl DeleteLocationInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_location::DeleteLocation::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLocation {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_location::de_delete_location_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_location::de_delete_location_http_response(
                status, headers, body,
            )
        }
    }
