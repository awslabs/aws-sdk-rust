...
impl StartDiscoveryJob {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_discovery_job::StartDiscoveryJobError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_discovery_job::StartDiscoveryJobOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("datasync", "StartDiscoveryJob", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDiscoveryJob {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDiscoveryJob")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(StartDiscoveryJobEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartDiscoveryJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartDiscoveryJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_discovery_job::StartDiscoveryJobInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::start_discovery_job::StartDiscoveryJobInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_discovery_job::ser_start_discovery_job_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartDiscoveryJobEndpointParamsInterceptor {
...
pub type StartDiscoveryJobErrorKind = StartDiscoveryJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartDiscoveryJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_discovery_job::StartDiscoveryJobError {
...
impl StartDiscoveryJobError {
    ...
    /// Creates the `StartDiscoveryJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
