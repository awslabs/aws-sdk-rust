...
impl UpdateLocationAzureBlobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_location_azure_blob::UpdateLocationAzureBlobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_location_azure_blob::UpdateLocationAzureBlobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_location_azure_blob::UpdateLocationAzureBlobOutput, crate::operation::update_location_azure_blob::UpdateLocationAzureBlobError, Self> {
