...
pub struct UpdateStorageSystemOutput {
    _request_id: Option<String>,
}
impl ::aws_types::request_id::RequestId for UpdateStorageSystemOutput {
...
impl UpdateStorageSystemOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateStorageSystemOutput`](crate::operation::update_storage_system::UpdateStorageSystemOutput).
    pub fn build(self) -> crate::operation::update_storage_system::UpdateStorageSystemOutput {
