...
impl UpdateTaskInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTask`](crate::operation::update_task::UpdateTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_task::UpdateTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_task::UpdateTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_task::UpdateTask::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateTask {
                type Output = std::result::Result<crate::operation::update_task::UpdateTaskOutput, crate::operation::update_task::UpdateTaskError>;
