...
impl UpdateTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_task::UpdateTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_task::ser_update_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_task::de_update_task_http_response_with_props(status, headers, body)
        }
    }
}
