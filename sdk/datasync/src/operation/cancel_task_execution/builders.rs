...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::cancel_task_execution::CancelTaskExecutionOutput,
                    crate::operation::cancel_task_execution::CancelTaskExecutionError,
                > for CancelTaskExecutionFluentBuilder
            {
                fn send(
                    self,
...
impl CancelTaskExecutionFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::cancel_task_execution::builders::CancelTaskExecutionInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_task_execution::CancelTaskExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_task_execution::CancelTaskExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::cancel_task_execution::CancelTaskExecution::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::cancel_task_execution::CancelTaskExecution::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_task_execution::CancelTaskExecutionOutput, crate::operation::cancel_task_execution::CancelTaskExecutionError, Self> {
