...
impl DescribeLocationObjectStorageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_location_object_storage::DescribeLocationObjectStorage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocationObjectStorage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_location_object_storage::de_describe_location_object_storage_http_response_with_props(
                status, headers, body,
            )
        }
    }
