...
impl DescribeLocationFsxOpenZfsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLocationFsxOpenZfs`](crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_location_fsx_open_zfs::ser_describe_location_fsx_open_zfs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLocationFsxOpenZfs {
                type Output = std::result::Result<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsOutput, crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError>;
