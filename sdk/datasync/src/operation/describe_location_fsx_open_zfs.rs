...
impl DescribeLocationFsxOpenZfsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocationFsxOpenZfs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_location_fsx_open_zfs::de_describe_location_fsx_open_zfs_http_response_with_props(
                status, headers, body,
            )
        }
    }
