...
/// Orchestration and serialization glue logic for `DescribeLocationFsxOpenZfs`.
...
impl DescribeLocationFsxOpenZfs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeLocationFsxOpenZfs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeLocationFsxOpenZfs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeLocationFsxOpenZfsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeLocationFsxOpenZfsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeLocationFsxOpenZfs")
...
.with_interceptor(DescribeLocationFsxOpenZfsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError>::new());
...
#[derive(Debug)]
            struct DescribeLocationFsxOpenZfsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeLocationFsxOpenZfsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_location_fsx_open_zfs::de_describe_location_fsx_open_zfs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeLocationFsxOpenZfsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeLocationFsxOpenZfsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_location_fsx_open_zfs::ser_describe_location_fsx_open_zfs_input(&input)?);
...
#[derive(Debug)]
            struct DescribeLocationFsxOpenZfsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeLocationFsxOpenZfsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeLocationFsxOpenZfsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeLocationFsxOpenZfsInput>()
                        .ok_or("failed to downcast to DescribeLocationFsxOpenZfsInput")?;
...
pub enum DescribeLocationFsxOpenZfsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeLocationFsxOpenZfsError) for what information is available for the error.")]
...
impl DescribeLocationFsxOpenZfsError {
    /// Creates the `DescribeLocationFsxOpenZfsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLocationFsxOpenZfsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeLocationFsxOpenZfsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_location_fsx_open_zfs::DescribeLocationFsxOpenZfsError {
...
mod _describe_location_fsx_open_zfs_output;
