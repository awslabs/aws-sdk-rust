...
impl ListAgentsInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::list_agents::ListAgentsError, ::aws_smithy_http::operation::Response>,
    > {
...
impl ListAgentsFluentBuilder {
    ...
    pub async fn customize_middleware(
        ...
        crate::client::customize::CustomizableOperation<crate::operation::list_agents::ListAgents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_agents::paginator::ListAgentsPaginator::send) which returns a `Stream`.
