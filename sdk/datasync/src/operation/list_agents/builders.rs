...
impl ListAgentsFluentBuilder  {
    /// Creates a new `ListAgents`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_agents::ListAgentsOutput, aws_smithy_http::result::SdkError<crate::operation::list_agents::ListAgentsError>>
                     {
