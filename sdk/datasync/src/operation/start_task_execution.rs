...
impl StartTaskExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_task_execution::ser_start_task_execution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTaskExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_task_execution::de_start_task_execution_http_response_with_props(status, headers, body)
        }
    }
}
