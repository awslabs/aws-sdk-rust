...
impl UpdateTaskExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_task_execution::ser_update_task_execution_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_task_execution::UpdateTaskExecution::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_task_execution::UpdateTaskExecutionError
{
