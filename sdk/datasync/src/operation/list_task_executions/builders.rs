...
impl ListTaskExecutionsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_task_executions::paginator::ListTaskExecutionsPaginator {
        crate::operation::list_task_executions::paginator::ListTaskExecutionsPaginator::new(
            self.handle,
            self.inner,
        )
    }
