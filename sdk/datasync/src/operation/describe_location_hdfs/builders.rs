...
impl DescribeLocationHdfsFluentBuilder  {
    /// Creates a new `DescribeLocationHdfs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_location_hdfs::DescribeLocationHdfsOutput, aws_smithy_http::result::SdkError<crate::operation::describe_location_hdfs::DescribeLocationHdfsError>>
                     {
