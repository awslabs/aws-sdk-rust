...
impl ListTaskExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListTaskExecutions`](crate::operation::list_task_executions::ListTaskExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_task_executions::ListTaskExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_task_executions::ListTaskExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_task_executions::ser_list_task_executions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_task_executions::ListTaskExecutions::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTaskExecutions {
                type Output = std::result::Result<crate::operation::list_task_executions::ListTaskExecutionsOutput, crate::operation::list_task_executions::ListTaskExecutionsError>;
