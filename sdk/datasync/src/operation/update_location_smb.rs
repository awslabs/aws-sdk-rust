...
impl UpdateLocationSmbInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_location_smb::ser_update_location_smb_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLocationSmb {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_location_smb::de_update_location_smb_http_response_with_props(status, headers, body)
        }
    }
}
