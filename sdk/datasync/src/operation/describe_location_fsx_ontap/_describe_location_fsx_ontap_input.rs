...
impl DescribeLocationFsxOntapInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_location_fsx_ontap::DescribeLocationFsxOntapInput, ::aws_smithy_types::error::operation::BuildError> {
