...
impl ListAgentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_agents::ListAgents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_agents::ser_list_agents_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAgents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_agents::de_list_agents_http_response_with_props(status, headers, body)
        }
    }
}
