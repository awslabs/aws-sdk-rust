...
impl DescribeTaskExecutionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTaskExecution`](crate::operation::describe_task_execution::DescribeTaskExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_task_execution::DescribeTaskExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_task_execution::DescribeTaskExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_task_execution::DescribeTaskExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeTaskExecution {
                type Output = std::result::Result<crate::operation::describe_task_execution::DescribeTaskExecutionOutput, crate::operation::describe_task_execution::DescribeTaskExecutionError>;
