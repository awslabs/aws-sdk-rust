...
/// Orchestration and serialization glue logic for `DescribeTaskExecution`.
...
impl DescribeTaskExecution {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_task_execution::DescribeTaskExecutionInput,
                    ) -> ::std::result::Result<crate::operation::describe_task_execution::DescribeTaskExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_task_execution::DescribeTaskExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_task_execution::DescribeTaskExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_task_execution::DescribeTaskExecutionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeTaskExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeTaskExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeTaskExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeTaskExecutionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeTaskExecution")
...
.with_interceptor(DescribeTaskExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_task_execution::DescribeTaskExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_task_execution::DescribeTaskExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_task_execution::DescribeTaskExecutionError>::new());
...
#[derive(Debug)]
            struct DescribeTaskExecutionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeTaskExecutionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_task_execution::de_describe_task_execution_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_task_execution::de_describe_task_execution_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeTaskExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeTaskExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_task_execution::DescribeTaskExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_task_execution::DescribeTaskExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_task_execution::ser_describe_task_execution_input(&input)?);
...
#[derive(Debug)]
            struct DescribeTaskExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeTaskExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeTaskExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeTaskExecutionInput>()
                        .ok_or("failed to downcast to DescribeTaskExecutionInput")?;
...
pub enum DescribeTaskExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeTaskExecutionError) for what information is available for the error.")]
...
impl DescribeTaskExecutionError {
    /// Creates the `DescribeTaskExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeTaskExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeTaskExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_task_execution::DescribeTaskExecutionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_task_execution::_describe_task_execution_output::DescribeTaskExecutionOutput;

pub use crate::operation::describe_task_execution::_describe_task_execution_input::DescribeTaskExecutionInput;

mod _describe_task_execution_input;

mod _describe_task_execution_output;
