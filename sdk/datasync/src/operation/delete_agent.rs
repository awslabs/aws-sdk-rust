...
impl DeleteAgentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAgent`](crate::operation::delete_agent::DeleteAgent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_agent::DeleteAgent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_agent::DeleteAgentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_agent::DeleteAgent::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAgent {
                type Output = std::result::Result<crate::operation::delete_agent::DeleteAgentOutput, crate::operation::delete_agent::DeleteAgentError>;
