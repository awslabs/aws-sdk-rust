...
impl DeleteAgentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_agent::DeleteAgent, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_agent::ser_delete_agent_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAgent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_agent::de_delete_agent_http_response_with_props(status, headers, body)
        }
    }
}
