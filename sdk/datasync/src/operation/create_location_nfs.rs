...
impl CreateLocationNfsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_location_nfs::ser_create_location_nfs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationNfs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location_nfs::de_create_location_nfs_http_response_with_props(status, headers, body)
        }
    }
}
