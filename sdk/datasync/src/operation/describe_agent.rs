...
impl DescribeAgentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_agent::DescribeAgent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_agent::de_describe_agent_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_agent::de_describe_agent_http_response_with_props(
                status, headers, body,
            )
        }
    }
