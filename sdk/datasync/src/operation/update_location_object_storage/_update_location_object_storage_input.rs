...
impl UpdateLocationObjectStorageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_location_object_storage::UpdateLocationObjectStorageInput, ::aws_smithy_types::error::operation::BuildError> {
