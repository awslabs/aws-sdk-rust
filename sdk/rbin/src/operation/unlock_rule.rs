...
impl UnlockRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unlock_rule::UnlockRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnlockRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_unlock_rule::de_unlock_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_unlock_rule::de_unlock_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
