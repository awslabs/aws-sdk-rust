...
pub fn ser_list_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRulesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
