...
pub(crate) fn de_unlock_delay<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::UnlockDelay>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "UnlockDelayUnit" => {
                            builder = builder.set_unlock_delay_unit(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::UnlockDelayUnit::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
