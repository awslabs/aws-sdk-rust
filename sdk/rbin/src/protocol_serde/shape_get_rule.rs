...
pub fn de_get_rule_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_rule::GetRuleOutput, crate::operation::get_rule::GetRuleError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::get_rule::builders::GetRuleOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "LockState" => {
                    builder = builder.set_lock_state(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::LockState::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "ResourceTags" => {
