...
pub fn de_unlock_rule_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::unlock_rule::UnlockRuleOutput, crate::operation::unlock_rule::UnlockRuleError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::unlock_rule::builders::UnlockRuleOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
