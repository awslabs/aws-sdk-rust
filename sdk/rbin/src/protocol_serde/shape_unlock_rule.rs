...
pub fn de_unlock_rule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UnlockRuleOutput, crate::error::UnlockRuleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UnlockRuleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_unlock_rule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UnlockRuleOutput, crate::error::UnlockRuleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::unlock_rule_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_unlock_rule::de_unlock_rule(response.body().as_ref(), output).map_err(crate::error::UnlockRuleError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_unlock_rule(value: &[u8], mut builder: crate::output::unlock_rule_output::Builder) -> Result<crate::output::unlock_rule_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
