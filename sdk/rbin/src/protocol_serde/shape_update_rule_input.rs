...
pub fn ser_update_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
