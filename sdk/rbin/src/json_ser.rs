...
pub fn serialize_structure_crate_input_create_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_4 in var_2 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_resource_tag(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
...
pub fn serialize_structure_crate_input_list_rules_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRulesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_17 in var_15 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_resource_tag(&mut object_18, item_17)?;
                object_18.finish();
            }
        }
        array_16.finish();
...
pub fn serialize_structure_crate_input_update_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_retention_period(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RetentionPeriod) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_34) = &input.retention_period_value {
        object.key("RetentionPeriodValue").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_34).into()));
    }
