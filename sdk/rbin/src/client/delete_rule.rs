...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_identifier):<br>required: **true**<br><p>The unique ID of the retention rule.</p><br>
