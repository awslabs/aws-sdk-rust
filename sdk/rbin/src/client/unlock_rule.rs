...
impl super::Client {
    ...
    ///   - [`resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::unlock_rule::UnlockRuleOutput::resource_tags): <p>\[Tag-level retention rules only\] Information about the resource tags used to identify resources that are retained by the retention rule.</p>
    ...
    ///   - [`rule_arn(Option<String>)`](crate::operation::unlock_rule::UnlockRuleOutput::rule_arn): <p>The Amazon Resource Name (ARN) of the retention rule.</p>
    ///   - [`exclude_resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::unlock_rule::UnlockRuleOutput::exclude_resource_tags): <p>\[Region-level retention rules only\] Information about the exclusion tags used to identify resources that are to be excluded, or ignored, by the retention rule.</p>
