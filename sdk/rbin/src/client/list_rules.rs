...
impl super::Client {
    ...
    ///   - [`exclude_resource_tags(ResourceTag)`](crate::operation::list_rules::builders::ListRulesFluentBuilder::exclude_resource_tags) / [`set_exclude_resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::list_rules::builders::ListRulesFluentBuilder::set_exclude_resource_tags):<br>required: **false**<br><p>\[Region-level retention rules only\] Information about the exclusion tags used to identify resources that are to be excluded, or ignored, by the retention rule.</p><br>
