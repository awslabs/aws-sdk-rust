...
impl super::Client {
    ...
    ///   - [`resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::lock_rule::LockRuleOutput::resource_tags): <p>\[Tag-level retention rules only\] Information about the resource tags used to identify resources that are retained by the retention rule.</p>
