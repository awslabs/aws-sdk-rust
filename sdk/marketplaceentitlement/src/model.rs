...
pub struct Entitlement  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::EntitlementValue>,
...
impl EntitlementValue {
    ...
    pub fn as_boolean_value(&self) -> std::result::Result<&bool, &Self> {
        if let EntitlementValue::BooleanValue(val) = &self { Ok(val) } else { Err(self) }
    }
    ...
    pub fn as_double_value(&self) -> std::result::Result<&f64, &Self> {
        if let EntitlementValue::DoubleValue(val) = &self { Ok(val) } else { Err(self) }
    }
    ...
    pub fn as_integer_value(&self) -> std::result::Result<&i32, &Self> {
        if let EntitlementValue::IntegerValue(val) = &self { Ok(val) } else { Err(self) }
    }
    ...
    pub fn as_string_value(&self) -> std::result::Result<&std::string::String, &Self> {
        if let EntitlementValue::StringValue(val) = &self { Ok(val) } else { Err(self) }
    }
