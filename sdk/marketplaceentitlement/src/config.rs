...
impl Builder {
    ...
    /// use aws_sdk_marketplaceentitlement::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_marketplaceentitlement::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    pub fn build(mut self) -> Config {
        ...
        let retry_partition = layer
            ...
            .cloned()
            .unwrap_or_else(|| ::aws_smithy_runtime::client::retries::RetryPartition::new("marketplaceentitlementservice"));
        ...
        layer.store_put(::aws_types::SigningService::from_static("aws-marketplace"));
        layer
