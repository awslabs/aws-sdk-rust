...
impl GetEntitlementsInput {
    /// Consumes the builder and constructs an Operation<[`GetEntitlements`](crate::operation::get_entitlements::GetEntitlements)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_entitlements::GetEntitlements, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_entitlements::GetEntitlementsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_entitlements::ser_get_entitlements_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_entitlements::GetEntitlements::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetEntitlements", "marketplaceentitlementservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetEntitlements {
                type Output = std::result::Result<crate::operation::get_entitlements::GetEntitlementsOutput, crate::operation::get_entitlements::GetEntitlementsError>;
