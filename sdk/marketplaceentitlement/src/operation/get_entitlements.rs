...
impl GetEntitlementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_entitlements::GetEntitlements, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_entitlements::ser_get_entitlements_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_entitlements::GetEntitlements::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("GetEntitlements", "marketplaceentitlementservice"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEntitlements {
    type Output =
        ::std::result::Result<crate::operation::get_entitlements::GetEntitlementsOutput, crate::operation::get_entitlements::GetEntitlementsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_entitlements::de_get_entitlements_http_response_with_props(status, headers, body)
        }
    }
}
