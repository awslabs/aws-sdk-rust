...
pub(crate) fn de_invalid_parameter_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidParameterExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidParameterExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
