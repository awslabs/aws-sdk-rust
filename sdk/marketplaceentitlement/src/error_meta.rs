...
impl From<crate::error::GetEntitlementsError> for Error {
    fn from(err: crate::error::GetEntitlementsError) -> Self {
        match err {
            crate::error::GetEntitlementsError::InternalServiceErrorException(inner) => {
                Error::InternalServiceErrorException(inner)
            }
            crate::error::GetEntitlementsError::InvalidParameterException(inner) => {
                Error::InvalidParameterException(inner)
            }
            crate::error::GetEntitlementsError::ThrottlingException(inner) => {
