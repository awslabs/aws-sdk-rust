...
pub fn serialize_structure_crate_input_get_entitlements_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetEntitlementsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
