...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::put_job_failure_result::builders::PutJobFailureResultFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::put_job_failure_result::builders::PutJobFailureResultFluentBuilder::set_job_id): <p>The unique system-generated ID of the job that failed. This is the same ID returned from <code>PollForJobs</code>.</p>
