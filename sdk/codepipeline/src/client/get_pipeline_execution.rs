...
impl super::Client {
    ...
    pub fn get_pipeline_execution(
        &self,
    ) -> crate::operation::get_pipeline_execution::builders::GetPipelineExecutionFluentBuilder {
        crate::operation::get_pipeline_execution::builders::GetPipelineExecutionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
