...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl ::std::convert::Into<String>)`](crate::operation::enable_stage_transition::builders::EnableStageTransitionFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::enable_stage_transition::builders::EnableStageTransitionFluentBuilder::set_pipeline_name): <p>The name of the pipeline in which you want to enable the flow of artifacts from one stage to another.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::enable_stage_transition::builders::EnableStageTransitionFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::enable_stage_transition::builders::EnableStageTransitionFluentBuilder::set_stage_name): <p>The name of the stage where you want to enable the transition of artifacts, either into the stage (inbound) or from that stage to the next stage (outbound).</p>
