...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl ::std::convert::Into<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::set_pipeline_name): <p>The name of the pipeline that starts processing the revision to the source.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::set_stage_name): <p>The name of the stage that contains the action that acts on the revision.</p>
    ///   - [`action_name(impl ::std::convert::Into<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::action_name) / [`set_action_name(Option<String>)`](crate::operation::put_action_revision::builders::PutActionRevisionFluentBuilder::set_action_name): <p>The name of the action that processes the revision.</p>
