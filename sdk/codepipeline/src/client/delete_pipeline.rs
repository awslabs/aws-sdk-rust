...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_pipeline::builders::DeletePipelineFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_pipeline::builders::DeletePipelineFluentBuilder::set_name):<br>required: **true**<br><p>The name of the pipeline to be deleted.</p><br>
