...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_action_types::builders::ListActionTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_action_types::builders::ListActionTypesFluentBuilder::set_next_token): <p>An identifier that was returned from the previous list action types call, which can be used to return the next set of action types in the list.</p>
    ///   - [`region_filter(impl ::std::convert::Into<String>)`](crate::operation::list_action_types::builders::ListActionTypesFluentBuilder::region_filter) / [`set_region_filter(Option<String>)`](crate::operation::list_action_types::builders::ListActionTypesFluentBuilder::set_region_filter): <p>The Region to filter on for the list of action types.</p>
