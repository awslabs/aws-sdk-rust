...
impl super::Client {
    ...
    ///   - [`provider(impl ::std::convert::Into<String>)`](crate::operation::delete_custom_action_type::builders::DeleteCustomActionTypeFluentBuilder::provider) / [`set_provider(Option<String>)`](crate::operation::delete_custom_action_type::builders::DeleteCustomActionTypeFluentBuilder::set_provider): <p>The provider of the service used in the custom action, such as AWS CodeDeploy.</p>
