...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_webhook::builders::DeleteWebhookFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_webhook::builders::DeleteWebhookFluentBuilder::set_name):<br>required: **true**<br><p>The name of the webhook you want to delete.</p><br>
