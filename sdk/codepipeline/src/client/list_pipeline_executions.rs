...
impl super::Client {
    ...
    ///   - [`filter(PipelineExecutionFilter)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::filter) / [`set_filter(Option<PipelineExecutionFilter>)`](crate::operation::list_pipeline_executions::builders::ListPipelineExecutionsFluentBuilder::set_filter):<br>required: **false**<br><p>The pipeline execution to filter on.</p><br>
