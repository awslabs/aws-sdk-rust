...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_third_party_job_details::builders::GetThirdPartyJobDetailsFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_third_party_job_details::builders::GetThirdPartyJobDetailsFluentBuilder::set_job_id):<br>required: **true**<br><p>The unique system-generated ID used for identifying the job.</p><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::get_third_party_job_details::builders::GetThirdPartyJobDetailsFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::get_third_party_job_details::builders::GetThirdPartyJobDetailsFluentBuilder::set_client_token):<br>required: **true**<br><p>The clientToken portion of the clientId and clientToken pair used to verify that the calling entity is allowed access to the job and its details.</p><br>
