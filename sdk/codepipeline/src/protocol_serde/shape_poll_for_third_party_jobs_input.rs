...
pub fn ser_poll_for_third_party_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PollForThirdPartyJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
