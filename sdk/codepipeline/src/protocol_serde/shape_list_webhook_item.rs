...
pub(crate) fn de_list_webhook_item<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ListWebhookItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "definition" => {
                            builder = builder.set_definition(crate::protocol_serde::shape_webhook_definition::de_webhook_definition(tokens, _value)?);
                        }
                        "url" => {
