            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "filters" => {
                            builder = builder.set_filters(crate::protocol_serde::shape_webhook_filters::de_webhook_filters(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "authenticationConfiguration" => {
                            builder = builder.set_authentication_configuration(
                                crate::protocol_serde::shape_webhook_auth_configuration::de_webhook_auth_configuration(tokens, _value, depth + 1)?,
                            );
                        }
