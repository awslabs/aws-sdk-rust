...
pub fn ser_webhook_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WebhookDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_webhook_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WebhookDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
