...
pub(crate) fn de_git_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::GitConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "push" => {
                                builder = builder.set_push(
                                    crate::protocol_serde::shape_git_push_filter_list::de_git_push_filter_list(tokens)?
                                );
                            }
                            "pullRequest" => {
            ...
            Ok(Some(crate::serde_util::git_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
