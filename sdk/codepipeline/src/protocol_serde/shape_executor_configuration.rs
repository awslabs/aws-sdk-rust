                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "lambdaExecutorConfiguration" => {
                            builder = builder.set_lambda_executor_configuration(
                                crate::protocol_serde::shape_lambda_executor_configuration::de_lambda_executor_configuration(tokens, _value)?,
                            );
                        }
                        "jobWorkerExecutorConfiguration" => {
                            builder = builder.set_job_worker_executor_configuration(
                                crate::protocol_serde::shape_job_worker_executor_configuration::de_job_worker_executor_configuration(tokens, _value)?,
                            );
                        }
