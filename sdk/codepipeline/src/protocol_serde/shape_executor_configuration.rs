...
pub(crate) fn de_executor_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ExecutorConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_executor_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExecutorConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
