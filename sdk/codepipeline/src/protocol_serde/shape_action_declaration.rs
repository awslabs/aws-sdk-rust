...
pub fn ser_action_declaration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionDeclaration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_action_declaration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ActionDeclaration>, aws_smithy_json::deserialize::error::DeserializeError>
