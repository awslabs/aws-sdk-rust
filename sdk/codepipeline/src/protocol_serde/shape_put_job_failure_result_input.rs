...
pub fn ser_put_job_failure_result_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutJobFailureResultInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
