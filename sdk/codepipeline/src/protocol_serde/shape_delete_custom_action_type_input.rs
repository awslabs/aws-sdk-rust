...
pub fn ser_delete_custom_action_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteCustomActionTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
