...
pub fn ser_current_revision(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CurrentRevision) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
