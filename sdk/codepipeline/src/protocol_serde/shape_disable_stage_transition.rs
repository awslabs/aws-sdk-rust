...
pub fn de_disable_stage_transition_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_stage_transition::DisableStageTransitionOutput, crate::operation::disable_stage_transition::DisableStageTransitionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::disable_stage_transition::DisableStageTransitionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disable_stage_transition_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disable_stage_transition::DisableStageTransitionOutput, crate::operation::disable_stage_transition::DisableStageTransitionError> {
    Ok({
        #[allow(unused_mut)]
