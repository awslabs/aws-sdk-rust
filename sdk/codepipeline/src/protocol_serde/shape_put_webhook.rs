...
pub fn de_put_webhook_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_webhook::PutWebhookOutput, crate::operation::put_webhook::PutWebhookError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "InvalidWebhookAuthenticationParametersException" => {
            crate::operation::put_webhook::PutWebhookError::InvalidWebhookAuthenticationParametersException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidWebhookFilterPatternException" => crate::operation::put_webhook::PutWebhookError::InvalidWebhookFilterPatternException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_invalid_webhook_filter_pattern_exception::de_invalid_webhook_filter_pattern_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::put_webhook::PutWebhookError::unhandled)?;
...
pub fn de_put_webhook_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_put_webhook::de_put_webhook(_response_body, output)
            .map_err(crate::operation::put_webhook::PutWebhookError::unhandled)?;
...
) -> ::std::result::Result<crate::operation::put_webhook::builders::PutWebhookOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "webhook" => {
                    builder = builder.set_webhook(crate::protocol_serde::shape_list_webhook_item::de_list_webhook_item(tokens, _value)?);
                }
