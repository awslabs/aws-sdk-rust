...
pub(crate) fn de_action_type_executor<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ActionTypeExecutor>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "configuration" => {
                            builder = builder.set_configuration(crate::protocol_serde::shape_executor_configuration::de_executor_configuration(
                                tokens, _value,
                            )?);
                        }
                        "type" => {
