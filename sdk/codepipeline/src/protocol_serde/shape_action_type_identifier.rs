...
pub(crate) fn de_action_type_identifier<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ActionTypeIdentifier>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
