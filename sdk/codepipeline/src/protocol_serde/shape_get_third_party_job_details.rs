...
pub fn ser_get_third_party_job_details_input(input: &crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
