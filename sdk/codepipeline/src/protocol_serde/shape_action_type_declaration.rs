            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "executor" => {
                            builder = builder.set_executor(crate::protocol_serde::shape_action_type_executor::de_action_type_executor(tokens)?);
                        }
                        "id" => {
                            builder = builder.set_id(crate::protocol_serde::shape_action_type_identifier::de_action_type_identifier(tokens)?);
                        }
                        ...
                        "permissions" => {
                            builder =
                                builder.set_permissions(crate::protocol_serde::shape_action_type_permissions::de_action_type_permissions(tokens)?);
                        }
                        "properties" => {
                            builder = builder.set_properties(crate::protocol_serde::shape_action_type_properties::de_action_type_properties(tokens)?);
                        }
                        "urls" => {
                            builder = builder.set_urls(crate::protocol_serde::shape_action_type_urls::de_action_type_urls(tokens)?);
                        }
