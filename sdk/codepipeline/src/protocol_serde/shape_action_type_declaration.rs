...
pub(crate) fn de_action_type_declaration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ActionTypeDeclaration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_action_type_declaration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionTypeDeclaration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
