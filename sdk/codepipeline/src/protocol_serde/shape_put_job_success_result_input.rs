...
pub fn ser_put_job_success_result_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutJobSuccessResultInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
