...
pub fn ser_stop_pipeline_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopPipelineExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
