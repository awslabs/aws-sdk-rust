            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "retryConfiguration" => {
                            builder = builder.set_retry_configuration(crate::protocol_serde::shape_retry_configuration::de_retry_configuration(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "conditions" => {
                            builder =
                                builder.set_conditions(crate::protocol_serde::shape_condition_list::de_condition_list(tokens, _value, depth + 1)?);
                        }
