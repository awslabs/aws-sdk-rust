...
pub(crate) fn de_third_party_job_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ThirdPartyJobData>, aws_smithy_json::deserialize::error::DeserializeError>
