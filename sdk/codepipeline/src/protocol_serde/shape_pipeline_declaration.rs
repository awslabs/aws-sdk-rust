...
pub(crate) fn de_pipeline_declaration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipelineDeclaration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_pipeline_declaration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipelineDeclaration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
