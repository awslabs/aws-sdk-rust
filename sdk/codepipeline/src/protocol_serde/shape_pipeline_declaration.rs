...
pub(crate) fn de_pipeline_declaration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PipelineDeclaration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::pipeline_declaration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_pipeline_declaration(
    ...
    if let Some(var_11) = &input.version {
        object.key("version").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
