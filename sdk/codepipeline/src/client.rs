    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AcknowledgeJobInput`](crate::input::AcknowledgeJobInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::AcknowledgeJobInput::job_id): <p>The unique system-generated ID of the job for which you want to confirm receipt.</p>
    ///   - [`nonce(Option<String>)`](crate::input::AcknowledgeJobInput::nonce): <p>A system-generated random number that AWS CodePipeline uses to ensure that the job is being worked on by only one job worker. Get this number from the response of the <code>PollForJobs</code> request that returned this job.</p>
    ...
    ///
    /// - Takes [`AcknowledgeThirdPartyJobInput`](crate::input::AcknowledgeThirdPartyJobInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::AcknowledgeThirdPartyJobInput::job_id): <p>The unique system-generated ID of the job.</p>
    ///   - [`nonce(Option<String>)`](crate::input::AcknowledgeThirdPartyJobInput::nonce): <p>A system-generated random number that AWS CodePipeline uses to ensure that the job is being worked on by only one job worker. Get this number from the response to a <code>GetThirdPartyJobDetails</code> request.</p>
    ///   - [`client_token(Option<String>)`](crate::input::AcknowledgeThirdPartyJobInput::client_token): <p>The clientToken portion of the clientId and clientToken pair used to verify that the calling entity is allowed access to the job and its details.</p>
    ...
    ///
    /// - Takes [`CreateCustomActionTypeInput`](crate::input::CreateCustomActionTypeInput) with field(s):
    ///   - [`category(Option<ActionCategory>)`](crate::input::CreateCustomActionTypeInput::category): <p>The category of the custom action, such as a build action or a test action.</p>
    ///   - [`provider(Option<String>)`](crate::input::CreateCustomActionTypeInput::provider): <p>The provider of the service used in the custom action, such as AWS CodeDeploy.</p>
    ///   - [`version(Option<String>)`](crate::input::CreateCustomActionTypeInput::version): <p>The version identifier of the custom action.</p>
    ///   - [`settings(Option<ActionTypeSettings>)`](crate::input::CreateCustomActionTypeInput::settings): <p>URLs that provide users information about this custom action.</p>
    ///   - [`configuration_properties(Option<Vec<ActionConfigurationProperty>>)`](crate::input::CreateCustomActionTypeInput::configuration_properties): <p>The configuration properties for the custom action.</p> <note>   <p>You can refer to a name in the configuration properties of the custom action within the URL templates by following the format of {Config:name}, as long as the configuration property is both required and not secret. For more information, see <a href="https://docs.aws.amazon.com/codepipeline/latest/userguide/how-to-create-custom-action.html">Create a Custom Action for a Pipeline</a>.</p>  </note>
    ///   - [`input_artifact_details(Option<ArtifactDetails>)`](crate::input::CreateCustomActionTypeInput::input_artifact_details): <p>The details of the input artifact for the action, such as its commit ID.</p>
    ///   - [`output_artifact_details(Option<ArtifactDetails>)`](crate::input::CreateCustomActionTypeInput::output_artifact_details): <p>The details of the output artifact of the action, such as its commit ID.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateCustomActionTypeInput::tags): <p>The tags for the custom action.</p>
    ...
    ///   - [`pipeline(Option<PipelineDeclaration>)`](crate::input::CreatePipelineInput::pipeline): <p>Represents the structure of actions and stages to be performed in the pipeline. </p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreatePipelineInput::tags): <p>The tags for the pipeline.</p>
    ...
    ///
    /// - Takes [`DeleteCustomActionTypeInput`](crate::input::DeleteCustomActionTypeInput) with field(s):
    ///   - [`category(Option<ActionCategory>)`](crate::input::DeleteCustomActionTypeInput::category): <p>The category of the custom action that you want to delete, such as source or deploy.</p>
    ///   - [`provider(Option<String>)`](crate::input::DeleteCustomActionTypeInput::provider): <p>The provider of the service used in the custom action, such as AWS CodeDeploy.</p>
    ///   - [`version(Option<String>)`](crate::input::DeleteCustomActionTypeInput::version): <p>The version of the custom action to delete.</p>
    ...
    ///   - [`name(Option<String>)`](crate::input::DeletePipelineInput::name): <p>The name of the pipeline to be deleted.</p>
    ...
    ///   - [`name(Option<String>)`](crate::input::DeleteWebhookInput::name): <p>The name of the webhook you want to delete.</p>
    ...
    ///
    /// - Takes [`DeregisterWebhookWithThirdPartyInput`](crate::input::DeregisterWebhookWithThirdPartyInput) with field(s):
    ///   - [`webhook_name(Option<String>)`](crate::input::DeregisterWebhookWithThirdPartyInput::webhook_name): <p>The name of the webhook you want to deregister.</p>
    ...
    ///
    /// - Takes [`DisableStageTransitionInput`](crate::input::DisableStageTransitionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::DisableStageTransitionInput::pipeline_name): <p>The name of the pipeline in which you want to disable the flow of artifacts from one stage to another.</p>
    ///   - [`stage_name(Option<String>)`](crate::input::DisableStageTransitionInput::stage_name): <p>The name of the stage where you want to disable the inbound or outbound transition of artifacts.</p>
    ///   - [`transition_type(Option<StageTransitionType>)`](crate::input::DisableStageTransitionInput::transition_type): <p>Specifies whether artifacts are prevented from transitioning into the stage and being processed by the actions in that stage (inbound), or prevented from transitioning from the stage after they have been processed by the actions in that stage (outbound).</p>
    ///   - [`reason(Option<String>)`](crate::input::DisableStageTransitionInput::reason): <p>The reason given to the user that a stage is disabled, such as waiting for manual approval or manual tests. This message is displayed in the pipeline console UI.</p>
    ...
    ///
    /// - Takes [`EnableStageTransitionInput`](crate::input::EnableStageTransitionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::EnableStageTransitionInput::pipeline_name): <p>The name of the pipeline in which you want to enable the flow of artifacts from one stage to another.</p>
    ///   - [`stage_name(Option<String>)`](crate::input::EnableStageTransitionInput::stage_name): <p>The name of the stage where you want to enable the transition of artifacts, either into the stage (inbound) or from that stage to the next stage (outbound).</p>
    ///   - [`transition_type(Option<StageTransitionType>)`](crate::input::EnableStageTransitionInput::transition_type): <p>Specifies whether artifacts are allowed to enter the stage and be processed by the actions in that stage (inbound) or whether already processed artifacts are allowed to transition to the next stage (outbound).</p>
    ...
    ///
    /// - Takes [`GetActionTypeInput`](crate::input::GetActionTypeInput) with field(s):
    ///   - [`category(Option<ActionCategory>)`](crate::input::GetActionTypeInput::category): <p>Defines what kind of action can be taken in the stage. The following are the valid values:</p>  <ul>   <li> <p> <code>Source</code> </p> </li>   <li> <p> <code>Build</code> </p> </li>   <li> <p> <code>Test</code> </p> </li>   <li> <p> <code>Deploy</code> </p> </li>   <li> <p> <code>Approval</code> </p> </li>   <li> <p> <code>Invoke</code> </p> </li>  </ul>
    ///   - [`owner(Option<String>)`](crate::input::GetActionTypeInput::owner): <p>The creator of an action type that was created with any supported integration model. There are two valid values: <code>AWS</code> and <code>ThirdParty</code>.</p>
    ///   - [`provider(Option<String>)`](crate::input::GetActionTypeInput::provider): <p>The provider of the action type being called. The provider name is specified when the action type is created.</p>
    ///   - [`version(Option<String>)`](crate::input::GetActionTypeInput::version): <p>A string that describes the action type version.</p>
    ...
    ///
    /// - Takes [`GetJobDetailsInput`](crate::input::GetJobDetailsInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetJobDetailsInput::job_id): <p>The unique system-generated ID for the job.</p>
    ...
    ///
    /// - Takes [`GetPipelineInput`](crate::input::GetPipelineInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::GetPipelineInput::name): <p>The name of the pipeline for which you want to get information. Pipeline names must be unique under an AWS user account.</p>
    ///   - [`version(Option<i32>)`](crate::input::GetPipelineInput::version): <p>The version number of the pipeline. If you do not specify a version, defaults to the current version.</p>
    ...
    ///
    /// - Takes [`GetPipelineExecutionInput`](crate::input::GetPipelineExecutionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::GetPipelineExecutionInput::pipeline_name): <p>The name of the pipeline about which you want to get execution details.</p>
    ///   - [`pipeline_execution_id(Option<String>)`](crate::input::GetPipelineExecutionInput::pipeline_execution_id): <p>The ID of the pipeline execution about which you want to get execution details.</p>
    ...
    ///
    /// - Takes [`GetPipelineStateInput`](crate::input::GetPipelineStateInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::GetPipelineStateInput::name): <p>The name of the pipeline about which you want to get information.</p>
    ...
    ///
    /// - Takes [`GetThirdPartyJobDetailsInput`](crate::input::GetThirdPartyJobDetailsInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetThirdPartyJobDetailsInput::job_id): <p>The unique system-generated ID used for identifying the job.</p>
    ///   - [`client_token(Option<String>)`](crate::input::GetThirdPartyJobDetailsInput::client_token): <p>The clientToken portion of the clientId and clientToken pair used to verify that the calling entity is allowed access to the job and its details.</p>
    ...
    ///
    /// - Takes [`ListActionExecutionsInput`](crate::input::ListActionExecutionsInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::ListActionExecutionsInput::pipeline_name): <p> The name of the pipeline for which you want to list action execution history.</p>
    ///   - [`filter(Option<ActionExecutionFilter>)`](crate::input::ListActionExecutionsInput::filter): <p>Input information used to filter action execution history.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListActionExecutionsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned nextToken value. Action execution history is retained for up to 12 months, based on action execution start times. Default value is 100. </p> <note>   <p>Detailed execution history is available for executions run on or after February 21, 2019.</p>  </note>
    ///   - [`next_token(Option<String>)`](crate::input::ListActionExecutionsInput::next_token): <p>The token that was returned from the previous <code>ListActionExecutions</code> call, which can be used to return the next set of action executions in the list.</p>
    ...
    ///
    /// - Takes [`ListActionTypesInput`](crate::input::ListActionTypesInput) with field(s):
    ///   - [`action_owner_filter(Option<ActionOwner>)`](crate::input::ListActionTypesInput::action_owner_filter): <p>Filters the list of action types to those created by a specified entity.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListActionTypesInput::next_token): <p>An identifier that was returned from the previous list action types call, which can be used to return the next set of action types in the list.</p>
    ///   - [`region_filter(Option<String>)`](crate::input::ListActionTypesInput::region_filter): <p>The Region to filter on for the list of action types.</p>
    ...
    ///
    /// - Takes [`ListPipelineExecutionsInput`](crate::input::ListPipelineExecutionsInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::ListPipelineExecutionsInput::pipeline_name): <p>The name of the pipeline for which you want to get execution summary information.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListPipelineExecutionsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned nextToken value. Pipeline history is limited to the most recent 12 months, based on pipeline execution start times. Default value is 100.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListPipelineExecutionsInput::next_token): <p>The token that was returned from the previous <code>ListPipelineExecutions</code> call, which can be used to return the next set of pipeline executions in the list.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListPipelinesInput::next_token): <p>An identifier that was returned from the previous list pipelines call. It can be used to return the next set of pipelines in the list.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListPipelinesInput::max_results): <p>The maximum number of pipelines to return in a single call. To retrieve the remaining pipelines, make another call with the returned nextToken value. The minimum value you can specify is 1. The maximum accepted value is 1000.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListTagsForResourceInput::next_token): <p>The token that was returned from the previous API call, which would be used to return the next page of the list. The ListTagsforResource call lists all available tags in one call and does not use pagination.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTagsForResourceInput::max_results): <p>The maximum number of results to return in a single call.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListWebhooksInput::next_token): <p>The token that was returned from the previous ListWebhooks call, which can be used to return the next set of webhooks in the list.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListWebhooksInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned nextToken value.</p>
    ...
    ///
    /// - Takes [`PollForJobsInput`](crate::input::PollForJobsInput) with field(s):
    ///   - [`action_type_id(Option<ActionTypeId>)`](crate::input::PollForJobsInput::action_type_id): <p>Represents information about an action type.</p>
    ///   - [`max_batch_size(Option<i32>)`](crate::input::PollForJobsInput::max_batch_size): <p>The maximum number of jobs to return in a poll for jobs call.</p>
    ///   - [`query_param(Option<HashMap<String, String>>)`](crate::input::PollForJobsInput::query_param): <p>A map of property names and values. For an action type with no queryable properties, this value must be null or an empty map. For an action type with a queryable property, you must supply that property as a key in the map. Only jobs whose action configuration matches the mapped value are returned.</p>
    ...
    ///
    /// - Takes [`PollForThirdPartyJobsInput`](crate::input::PollForThirdPartyJobsInput) with field(s):
    ///   - [`action_type_id(Option<ActionTypeId>)`](crate::input::PollForThirdPartyJobsInput::action_type_id): <p>Represents information about an action type.</p>
    ///   - [`max_batch_size(Option<i32>)`](crate::input::PollForThirdPartyJobsInput::max_batch_size): <p>The maximum number of jobs to return in a poll for jobs call.</p>
    ...
    ///
    /// - Takes [`PutActionRevisionInput`](crate::input::PutActionRevisionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::PutActionRevisionInput::pipeline_name): <p>The name of the pipeline that starts processing the revision to the source.</p>
    ///   - [`stage_name(Option<String>)`](crate::input::PutActionRevisionInput::stage_name): <p>The name of the stage that contains the action that acts on the revision.</p>
    ///   - [`action_name(Option<String>)`](crate::input::PutActionRevisionInput::action_name): <p>The name of the action that processes the revision.</p>
    ///   - [`action_revision(Option<ActionRevision>)`](crate::input::PutActionRevisionInput::action_revision): <p>Represents information about the version (or revision) of an action.</p>
    ...
    ///
    /// - Takes [`PutApprovalResultInput`](crate::input::PutApprovalResultInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::PutApprovalResultInput::pipeline_name): <p>The name of the pipeline that contains the action. </p>
    ///   - [`stage_name(Option<String>)`](crate::input::PutApprovalResultInput::stage_name): <p>The name of the stage that contains the action.</p>
    ///   - [`action_name(Option<String>)`](crate::input::PutApprovalResultInput::action_name): <p>The name of the action for which approval is requested.</p>
    ///   - [`result(Option<ApprovalResult>)`](crate::input::PutApprovalResultInput::result): <p>Represents information about the result of the approval request.</p>
    ///   - [`token(Option<String>)`](crate::input::PutApprovalResultInput::token): <p>The system-generated token used to identify a unique approval request. The token for each open approval request can be obtained using the <code>GetPipelineState</code> action. It is used to validate that the approval request corresponding to this token is still valid.</p>
    ...
    ///
    /// - Takes [`PutJobFailureResultInput`](crate::input::PutJobFailureResultInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::PutJobFailureResultInput::job_id): <p>The unique system-generated ID of the job that failed. This is the same ID returned from <code>PollForJobs</code>.</p>
    ///   - [`failure_details(Option<FailureDetails>)`](crate::input::PutJobFailureResultInput::failure_details): <p>The details about the failure of a job.</p>
    ...
    ///
    /// - Takes [`PutJobSuccessResultInput`](crate::input::PutJobSuccessResultInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::PutJobSuccessResultInput::job_id): <p>The unique system-generated ID of the job that succeeded. This is the same ID returned from <code>PollForJobs</code>.</p>
    ///   - [`current_revision(Option<CurrentRevision>)`](crate::input::PutJobSuccessResultInput::current_revision): <p>The ID of the current revision of the artifact successfully worked on by the job.</p>
    ///   - [`continuation_token(Option<String>)`](crate::input::PutJobSuccessResultInput::continuation_token): <p>A token generated by a job worker, such as an AWS CodeDeploy deployment ID, that a successful job provides to identify a custom action in progress. Future jobs use this token to identify the running instance of the action. It can be reused to return more information about the progress of the custom action. When the action is complete, no continuation token should be supplied.</p>
    ///   - [`execution_details(Option<ExecutionDetails>)`](crate::input::PutJobSuccessResultInput::execution_details): <p>The execution details of the successful job, such as the actions taken by the job worker.</p>
    ///   - [`output_variables(Option<HashMap<String, String>>)`](crate::input::PutJobSuccessResultInput::output_variables): <p>Key-value pairs produced as output by a job worker that can be made available to a downstream action configuration. <code>outputVariables</code> can be included only when there is no continuation token on the request.</p>
    ...
    ///
    /// - Takes [`PutThirdPartyJobFailureResultInput`](crate::input::PutThirdPartyJobFailureResultInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::PutThirdPartyJobFailureResultInput::job_id): <p>The ID of the job that failed. This is the same ID returned from <code>PollForThirdPartyJobs</code>.</p>
    ///   - [`client_token(Option<String>)`](crate::input::PutThirdPartyJobFailureResultInput::client_token): <p>The clientToken portion of the clientId and clientToken pair used to verify that the calling entity is allowed access to the job and its details.</p>
    ///   - [`failure_details(Option<FailureDetails>)`](crate::input::PutThirdPartyJobFailureResultInput::failure_details): <p>Represents information about failure details.</p>
    ...
    ///
    /// - Takes [`PutThirdPartyJobSuccessResultInput`](crate::input::PutThirdPartyJobSuccessResultInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::PutThirdPartyJobSuccessResultInput::job_id): <p>The ID of the job that successfully completed. This is the same ID returned from <code>PollForThirdPartyJobs</code>.</p>
    ///   - [`client_token(Option<String>)`](crate::input::PutThirdPartyJobSuccessResultInput::client_token): <p>The clientToken portion of the clientId and clientToken pair used to verify that the calling entity is allowed access to the job and its details.</p>
    ///   - [`current_revision(Option<CurrentRevision>)`](crate::input::PutThirdPartyJobSuccessResultInput::current_revision): <p>Represents information about a current revision.</p>
    ///   - [`continuation_token(Option<String>)`](crate::input::PutThirdPartyJobSuccessResultInput::continuation_token): <p>A token generated by a job worker, such as an AWS CodeDeploy deployment ID, that a successful job provides to identify a partner action in progress. Future jobs use this token to identify the running instance of the action. It can be reused to return more information about the progress of the partner action. When the action is complete, no continuation token should be supplied.</p>
    ///   - [`execution_details(Option<ExecutionDetails>)`](crate::input::PutThirdPartyJobSuccessResultInput::execution_details): <p>The details of the actions taken and results produced on an artifact as it passes through stages in the pipeline. </p>
    ...
    ///
    /// - Takes [`PutWebhookInput`](crate::input::PutWebhookInput) with field(s):
    ///   - [`webhook(Option<WebhookDefinition>)`](crate::input::PutWebhookInput::webhook): <p>The detail provided in an input file to create the webhook, such as the webhook name, the pipeline name, and the action name. Give the webhook a unique name that helps you identify it. You might name the webhook after the pipeline and action it targets so that you can easily recognize what it's used for later.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::PutWebhookInput::tags): <p>The tags for the webhook.</p>
    ...
    ///
    /// - Takes [`RegisterWebhookWithThirdPartyInput`](crate::input::RegisterWebhookWithThirdPartyInput) with field(s):
    ///   - [`webhook_name(Option<String>)`](crate::input::RegisterWebhookWithThirdPartyInput::webhook_name): <p>The name of an existing webhook created with PutWebhook to register with a supported third party. </p>
    ...
    ///
    /// - Takes [`RetryStageExecutionInput`](crate::input::RetryStageExecutionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::RetryStageExecutionInput::pipeline_name): <p>The name of the pipeline that contains the failed stage.</p>
    ///   - [`stage_name(Option<String>)`](crate::input::RetryStageExecutionInput::stage_name): <p>The name of the failed stage to be retried.</p>
    ///   - [`pipeline_execution_id(Option<String>)`](crate::input::RetryStageExecutionInput::pipeline_execution_id): <p>The ID of the pipeline execution in the failed stage to be retried. Use the <code>GetPipelineState</code> action to retrieve the current pipelineExecutionId of the failed stage</p>
    ///   - [`retry_mode(Option<StageRetryMode>)`](crate::input::RetryStageExecutionInput::retry_mode): <p>The scope of the retry attempt. Currently, the only supported value is FAILED_ACTIONS.</p>
    ...
    ///
    /// - Takes [`StartPipelineExecutionInput`](crate::input::StartPipelineExecutionInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::StartPipelineExecutionInput::name): <p>The name of the pipeline to start.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartPipelineExecutionInput::client_request_token): <p>The system-generated unique ID used to identify a unique execution request.</p>
    ...
    ///
    /// - Takes [`StopPipelineExecutionInput`](crate::input::StopPipelineExecutionInput) with field(s):
    ///   - [`pipeline_name(Option<String>)`](crate::input::StopPipelineExecutionInput::pipeline_name): <p>The name of the pipeline to stop.</p>
    ///   - [`pipeline_execution_id(Option<String>)`](crate::input::StopPipelineExecutionInput::pipeline_execution_id): <p>The ID of the pipeline execution to be stopped in the current stage. Use the <code>GetPipelineState</code> action to retrieve the current pipelineExecutionId.</p>
    ///   - [`abandon(bool)`](crate::input::StopPipelineExecutionInput::abandon): <p>Use this option to stop the pipeline execution by abandoning, rather than finishing, in-progress actions.</p> <note>   <p>This option can lead to failed or out-of-sequence tasks.</p>  </note>
    ///   - [`reason(Option<String>)`](crate::input::StopPipelineExecutionInput::reason): <p>Use this option to enter comments, such as the reason the pipeline was stopped.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource you want to add tags to.</p>
    ...
    ///
    /// - Takes [`UpdateActionTypeInput`](crate::input::UpdateActionTypeInput) with field(s):
    ///   - [`action_type(Option<ActionTypeDeclaration>)`](crate::input::UpdateActionTypeInput::action_type): <p>The action type definition for the action type to be updated.</p>
    ...
    ///   - [`pipeline(Option<PipelineDeclaration>)`](crate::input::UpdatePipelineInput::pipeline): <p>The name of the pipeline to be updated.</p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListActionExecutionsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListActionTypesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListPipelineExecutionsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::ListWebhooksPaginator<C, M, R> {
