...
impl ::std::convert::From<&str> for ArtifactLocationType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ArtifactLocationType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ArtifactLocationType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ArtifactLocationType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ArtifactLocationType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
