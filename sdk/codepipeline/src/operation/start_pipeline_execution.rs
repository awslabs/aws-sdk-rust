...
impl StartPipelineExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartPipelineExecution`](crate::operation::start_pipeline_execution::StartPipelineExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_pipeline_execution::StartPipelineExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_pipeline_execution::StartPipelineExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_pipeline_execution::ser_start_pipeline_execution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_pipeline_execution::StartPipelineExecution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartPipelineExecution", "codepipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartPipelineExecution {
                type Output = std::result::Result<crate::operation::start_pipeline_execution::StartPipelineExecutionOutput, crate::operation::start_pipeline_execution::StartPipelineExecutionError>;
