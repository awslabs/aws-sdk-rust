...
impl PutJobFailureResultInput {
    /// Consumes the builder and constructs an Operation<[`PutJobFailureResult`](crate::operation::put_job_failure_result::PutJobFailureResult)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_job_failure_result::PutJobFailureResult, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_job_failure_result::PutJobFailureResultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_job_failure_result::ser_put_job_failure_result_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_job_failure_result::PutJobFailureResult::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutJobFailureResult", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutJobFailureResult`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutJobFailureResult {
                type Output = std::result::Result<crate::operation::put_job_failure_result::PutJobFailureResultOutput, crate::operation::put_job_failure_result::PutJobFailureResultError>;
