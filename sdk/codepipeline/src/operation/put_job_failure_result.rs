...
impl PutJobFailureResultInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_job_failure_result::ser_put_job_failure_result_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_job_failure_result::PutJobFailureResult::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_job_failure_result::PutJobFailureResultError
{
