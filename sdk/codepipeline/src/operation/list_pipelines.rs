...
impl ListPipelinesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_pipelines::ser_list_pipelines_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_pipelines::ListPipelines::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPipelines", "codepipeline"));
