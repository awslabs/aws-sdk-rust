...
impl PollForJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::poll_for_jobs::PollForJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_poll_for_jobs::de_poll_for_jobs_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_poll_for_jobs::de_poll_for_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
