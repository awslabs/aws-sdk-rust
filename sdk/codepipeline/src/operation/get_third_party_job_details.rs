...
/// Orchestration and serialization glue logic for `GetThirdPartyJobDetails`.
...
impl GetThirdPartyJobDetails {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput,
                    ) -> ::std::result::Result<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetThirdPartyJobDetails {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetThirdPartyJobDetails");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetThirdPartyJobDetailsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetThirdPartyJobDetailsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetThirdPartyJobDetails")
...
.with_interceptor(GetThirdPartyJobDetailsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError>::new());
...
#[derive(Debug)]
            struct GetThirdPartyJobDetailsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetThirdPartyJobDetailsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_third_party_job_details::de_get_third_party_job_details_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetThirdPartyJobDetailsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetThirdPartyJobDetailsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_third_party_job_details::ser_get_third_party_job_details_input(&input)?);
...
#[derive(Debug)]
            struct GetThirdPartyJobDetailsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetThirdPartyJobDetailsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetThirdPartyJobDetailsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetThirdPartyJobDetailsInput>()
                        .ok_or("failed to downcast to GetThirdPartyJobDetailsInput")?;
...
pub enum GetThirdPartyJobDetailsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetThirdPartyJobDetailsError) for what information is available for the error.")]
...
impl GetThirdPartyJobDetailsError {
    /// Creates the `GetThirdPartyJobDetailsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetThirdPartyJobDetailsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidJobException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetThirdPartyJobDetailsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError {
...
mod _get_third_party_job_details_output;
