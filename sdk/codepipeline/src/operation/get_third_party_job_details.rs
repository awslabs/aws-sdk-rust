...
impl GetThirdPartyJobDetailsInput {
    /// Consumes the builder and constructs an Operation<[`GetThirdPartyJobDetails`](crate::operation::get_third_party_job_details::GetThirdPartyJobDetails)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_third_party_job_details::GetThirdPartyJobDetails, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_third_party_job_details::ser_get_third_party_job_details_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_third_party_job_details::GetThirdPartyJobDetails::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetThirdPartyJobDetails", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetThirdPartyJobDetails`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetThirdPartyJobDetails {
                type Output = std::result::Result<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsOutput, crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_third_party_job_details::de_get_third_party_job_details_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_third_party_job_details::de_get_third_party_job_details_http_response(response)
                     }
                }
            }
