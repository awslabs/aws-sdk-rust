...
/// Orchestration and serialization glue logic for `PollForThirdPartyJobs`.
...
impl PollForThirdPartyJobs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsInput,
                    ) -> ::std::result::Result<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PollForThirdPartyJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PollForThirdPartyJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PollForThirdPartyJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PollForThirdPartyJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PollForThirdPartyJobs")
...
.with_interceptor(PollForThirdPartyJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError>::new());
...
#[derive(Debug)]
            struct PollForThirdPartyJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PollForThirdPartyJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_poll_for_third_party_jobs::de_poll_for_third_party_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PollForThirdPartyJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PollForThirdPartyJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_poll_for_third_party_jobs::ser_poll_for_third_party_jobs_input(&input)?);
...
#[derive(Debug)]
            struct PollForThirdPartyJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PollForThirdPartyJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PollForThirdPartyJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PollForThirdPartyJobsInput>()
                        .ok_or("failed to downcast to PollForThirdPartyJobsInput")?;
...
pub enum PollForThirdPartyJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PollForThirdPartyJobsError) for what information is available for the error.")]
...
impl PollForThirdPartyJobsError {
    /// Creates the `PollForThirdPartyJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PollForThirdPartyJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ActionTypeNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PollForThirdPartyJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError {
...
mod _poll_for_third_party_jobs_output;
