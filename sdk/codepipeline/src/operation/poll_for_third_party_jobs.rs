...
impl PollForThirdPartyJobsInput {
    /// Consumes the builder and constructs an Operation<[`PollForThirdPartyJobs`](crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_poll_for_third_party_jobs::ser_poll_for_third_party_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PollForThirdPartyJobs", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PollForThirdPartyJobs`.
...
impl aws_smithy_http::response::ParseStrictResponse for PollForThirdPartyJobs {
                type Output = std::result::Result<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsOutput, crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_poll_for_third_party_jobs::de_poll_for_third_party_jobs_http_error(response)
                     } else {
                        crate::protocol_serde::shape_poll_for_third_party_jobs::de_poll_for_third_party_jobs_http_response(response)
                     }
                }
            }
