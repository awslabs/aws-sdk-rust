...
impl PollForThirdPartyJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobs,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForThirdPartyJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_poll_for_third_party_jobs::de_poll_for_third_party_jobs_http_response_with_props(status, headers, body)
        }
    }
}
