...
impl PollForThirdPartyJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsOutput, crate::operation::poll_for_third_party_jobs::PollForThirdPartyJobsError, Self> {
