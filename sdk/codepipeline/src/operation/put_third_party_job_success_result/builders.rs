...
impl PutThirdPartyJobSuccessResultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput, crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError, Self> {
