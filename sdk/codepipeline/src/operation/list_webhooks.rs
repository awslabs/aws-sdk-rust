...
impl ListWebhooksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_webhooks::ListWebhooks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_webhooks::ser_list_webhooks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWebhooks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_webhooks::de_list_webhooks_http_response_with_props(status, headers, body)
        }
    }
}
