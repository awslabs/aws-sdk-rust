    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutThirdPartyJobSuccessResultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutThirdPartyJobSuccessResultRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutThirdPartyJobSuccessResultEndpointParamsInterceptor {
