...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput,
                    crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError,
                > for AcknowledgeThirdPartyJobFluentBuilder
            {
                fn send(
                    self,
...
impl AcknowledgeThirdPartyJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput, crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError, Self> {
