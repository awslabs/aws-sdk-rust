...
impl AcknowledgeThirdPartyJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobInput, ::aws_smithy_types::error::operation::BuildError> {
