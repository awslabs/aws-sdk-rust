...
impl RetryStageExecutionInput {
    /// Consumes the builder and constructs an Operation<[`RetryStageExecution`](crate::operation::retry_stage_execution::RetryStageExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::retry_stage_execution::RetryStageExecution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retry_stage_execution::RetryStageExecutionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::retry_stage_execution::RetryStageExecution::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RetryStageExecution {
                type Output = std::result::Result<crate::operation::retry_stage_execution::RetryStageExecutionOutput, crate::operation::retry_stage_execution::RetryStageExecutionError>;
