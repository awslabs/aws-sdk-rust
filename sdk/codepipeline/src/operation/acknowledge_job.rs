...
impl AcknowledgeJobInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::acknowledge_job::AcknowledgeJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::acknowledge_job::AcknowledgeJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for AcknowledgeJob {
                type Output = std::result::Result<crate::operation::acknowledge_job::AcknowledgeJobOutput, crate::operation::acknowledge_job::AcknowledgeJobError>;
