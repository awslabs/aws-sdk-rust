...
impl AcknowledgeJobInput {
    /// Consumes the builder and constructs an Operation<[`AcknowledgeJob`](crate::operation::acknowledge_job::AcknowledgeJob)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::acknowledge_job::AcknowledgeJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_acknowledge_job::ser_acknowledge_job_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::acknowledge_job::AcknowledgeJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcknowledgeJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_acknowledge_job::de_acknowledge_job_http_response_with_props(status, headers, body)
        }
    }
}
