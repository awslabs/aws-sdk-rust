...
impl RegisterWebhookWithThirdParty {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterWebhookWithThirdParty {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterWebhookWithThirdParty");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterWebhookWithThirdPartyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterWebhookWithThirdPartyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterWebhookWithThirdParty")
...
.with_interceptor(RegisterWebhookWithThirdPartyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError>::new());
...
#[derive(Debug)]
            struct RegisterWebhookWithThirdPartyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterWebhookWithThirdPartyResponseDeserializer {
...
#[derive(Debug)]
            struct RegisterWebhookWithThirdPartyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterWebhookWithThirdPartyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_webhook_with_third_party::ser_register_webhook_with_third_party_input(&input)?);
...
#[derive(Debug)]
            struct RegisterWebhookWithThirdPartyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterWebhookWithThirdPartyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterWebhookWithThirdPartyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterWebhookWithThirdPartyInput>()
                        .ok_or("failed to downcast to RegisterWebhookWithThirdPartyInput")?;
...
pub enum RegisterWebhookWithThirdPartyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterWebhookWithThirdPartyError) for what information is available for the error.")]
...
impl RegisterWebhookWithThirdPartyError {
    /// Creates the `RegisterWebhookWithThirdPartyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterWebhookWithThirdPartyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterWebhookWithThirdPartyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError {
...
mod _register_webhook_with_third_party_output;
