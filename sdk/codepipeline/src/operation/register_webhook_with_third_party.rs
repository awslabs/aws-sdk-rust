...
impl RegisterWebhookWithThirdPartyInput {
    /// Consumes the builder and constructs an Operation<[`RegisterWebhookWithThirdParty`](crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdParty)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdParty, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_webhook_with_third_party::ser_register_webhook_with_third_party_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdParty::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterWebhookWithThirdParty", "codepipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterWebhookWithThirdParty {
                type Output = std::result::Result<crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyOutput, crate::operation::register_webhook_with_third_party::RegisterWebhookWithThirdPartyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_register_webhook_with_third_party::de_register_webhook_with_third_party_http_error(response)
                     } else {
                        crate::protocol_serde::shape_register_webhook_with_third_party::de_register_webhook_with_third_party_http_response(response)
                     }
                }
            }
