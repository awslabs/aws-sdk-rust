...
/// Orchestration and serialization glue logic for `EnableStageTransition`.
...
impl EnableStageTransition {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::enable_stage_transition::EnableStageTransitionInput,
                    ) -> ::std::result::Result<crate::operation::enable_stage_transition::EnableStageTransitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_stage_transition::EnableStageTransitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_stage_transition::EnableStageTransitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_stage_transition::EnableStageTransitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableStageTransition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableStageTransition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableStageTransitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableStageTransitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableStageTransition")
...
.with_interceptor(EnableStageTransitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_stage_transition::EnableStageTransitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_stage_transition::EnableStageTransitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_stage_transition::EnableStageTransitionError>::new());
...
#[derive(Debug)]
            struct EnableStageTransitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableStageTransitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_stage_transition::de_enable_stage_transition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_stage_transition::de_enable_stage_transition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableStageTransitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableStageTransitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_stage_transition::EnableStageTransitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_stage_transition::EnableStageTransitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_enable_stage_transition::ser_enable_stage_transition_input(&input)?);
...
#[derive(Debug)]
            struct EnableStageTransitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableStageTransitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableStageTransitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableStageTransitionInput>()
                        .ok_or("failed to downcast to EnableStageTransitionInput")?;
...
pub enum EnableStageTransitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableStageTransitionError) for what information is available for the error.")]
...
impl EnableStageTransitionError {
    /// Creates the `EnableStageTransitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableStageTransitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableStageTransitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_stage_transition::EnableStageTransitionError {
...
mod _enable_stage_transition_output;
