...
impl EnableStageTransitionInput {
    /// Consumes the builder and constructs an Operation<[`EnableStageTransition`](crate::operation::enable_stage_transition::EnableStageTransition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_stage_transition::EnableStageTransition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_stage_transition::EnableStageTransitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_stage_transition::EnableStageTransition::new())
...
impl aws_smithy_http::response::ParseStrictResponse for EnableStageTransition {
                type Output = std::result::Result<crate::operation::enable_stage_transition::EnableStageTransitionOutput, crate::operation::enable_stage_transition::EnableStageTransitionError>;
