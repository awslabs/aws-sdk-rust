...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::acknowledge_job::AcknowledgeJobOutput,
                    crate::operation::acknowledge_job::AcknowledgeJobError,
                > for AcknowledgeJobFluentBuilder
            {
                fn send(
                    self,
...
impl AcknowledgeJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::acknowledge_job::AcknowledgeJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::acknowledge_job::AcknowledgeJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::acknowledge_job::AcknowledgeJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::acknowledge_job::AcknowledgeJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::acknowledge_job::AcknowledgeJobOutput, crate::operation::acknowledge_job::AcknowledgeJobError, Self> {
