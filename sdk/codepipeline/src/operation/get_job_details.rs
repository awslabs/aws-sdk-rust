...
impl GetJobDetailsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_job_details::GetJobDetails::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetJobDetails {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_job_details::de_get_job_details_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_job_details::de_get_job_details_http_response(
                status, headers, body,
            )
        }
    }
