...
impl GetActionTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_action_type::GetActionType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_action_type::ser_get_action_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetActionType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_action_type::de_get_action_type_http_response_with_props(status, headers, body)
        }
    }
}
