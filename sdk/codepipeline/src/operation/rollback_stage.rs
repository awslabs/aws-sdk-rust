    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RollbackStage")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RollbackStageTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RollbackStageTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RollbackStageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RollbackStageInput>() else {
        ...
        if requested.should_capture("targetPipelineExecutionId") {
            if let ::std::option::Option::Some(value) = input.target_pipeline_execution_id.as_deref() {
                captured.insert("targetPipelineExecutionId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RollbackStageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_rollback_stage::de_rollback_stage_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_rollback_stage::de_rollback_stage_http_response(status, headers, body, _cfg)
        };
