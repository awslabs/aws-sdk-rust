...
impl PutActionRevisionInput {
    /// Consumes the builder and constructs an Operation<[`PutActionRevision`](crate::operation::put_action_revision::PutActionRevision)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_action_revision::PutActionRevision, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_action_revision::PutActionRevisionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_action_revision::ser_put_action_revision_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_action_revision::PutActionRevision::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutActionRevision", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutActionRevision`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutActionRevision {
                type Output = std::result::Result<crate::operation::put_action_revision::PutActionRevisionOutput, crate::operation::put_action_revision::PutActionRevisionError>;
