...
impl PutActionRevisionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_action_revision::PutActionRevision::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutActionRevision {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_action_revision::de_put_action_revision_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_action_revision::PutActionRevisionError
{
