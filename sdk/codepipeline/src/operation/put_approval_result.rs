...
/// Orchestration and serialization glue logic for `PutApprovalResult`.
...
impl PutApprovalResult {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_approval_result::PutApprovalResultInput,
                    ) -> ::std::result::Result<crate::operation::put_approval_result::PutApprovalResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_approval_result::PutApprovalResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_approval_result::PutApprovalResultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_approval_result::PutApprovalResultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutApprovalResult {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutApprovalResult");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutApprovalResultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutApprovalResultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutApprovalResult")
...
.with_interceptor(PutApprovalResultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_approval_result::PutApprovalResultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_approval_result::PutApprovalResultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_approval_result::PutApprovalResultError>::new());
...
#[derive(Debug)]
            struct PutApprovalResultResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutApprovalResultResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_approval_result::de_put_approval_result_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutApprovalResultRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutApprovalResultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_approval_result::PutApprovalResultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_approval_result::PutApprovalResultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_approval_result::ser_put_approval_result_input(&input)?);
...
#[derive(Debug)]
            struct PutApprovalResultEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutApprovalResultEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutApprovalResultEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutApprovalResultInput>()
                        .ok_or("failed to downcast to PutApprovalResultInput")?;
...
pub enum PutApprovalResultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutApprovalResultError) for what information is available for the error.")]
...
impl PutApprovalResultError {
    /// Creates the `PutApprovalResultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutApprovalResultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ApprovalAlreadyCompletedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidApprovalTokenException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutApprovalResultError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_approval_result::PutApprovalResultError {
...
mod _put_approval_result_output;
