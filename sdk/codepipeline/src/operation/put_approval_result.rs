...
impl PutApprovalResultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_approval_result::PutApprovalResult::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutApprovalResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_approval_result::de_put_approval_result_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_approval_result::PutApprovalResultError
{
