...
impl PutApprovalResultInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_approval_result::ser_put_approval_result_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutApprovalResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_approval_result::de_put_approval_result_http_response_with_props(status, headers, body)
        }
    }
}
