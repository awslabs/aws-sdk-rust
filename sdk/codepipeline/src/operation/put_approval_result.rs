...
impl PutApprovalResultInput {
    /// Consumes the builder and constructs an Operation<[`PutApprovalResult`](crate::operation::put_approval_result::PutApprovalResult)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_approval_result::PutApprovalResult, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_approval_result::PutApprovalResultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_approval_result::ser_put_approval_result_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_approval_result::PutApprovalResult::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutApprovalResult", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutApprovalResult`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutApprovalResult {
                type Output = std::result::Result<crate::operation::put_approval_result::PutApprovalResultOutput, crate::operation::put_approval_result::PutApprovalResultError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_approval_result::de_put_approval_result_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_approval_result::de_put_approval_result_http_response(response)
                     }
                }
            }
