...
impl UpdateActionTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_action_type::UpdateActionType,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_action_type::ser_update_action_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateActionType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_action_type::de_update_action_type_http_response_with_props(status, headers, body)
        }
    }
}
