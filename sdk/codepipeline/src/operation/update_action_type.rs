...
impl UpdateActionTypeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateActionType`](crate::operation::update_action_type::UpdateActionType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_action_type::UpdateActionType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_action_type::UpdateActionTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_action_type::ser_update_action_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_action_type::UpdateActionType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateActionType", "codepipeline"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateActionType {
                type Output = std::result::Result<crate::operation::update_action_type::UpdateActionTypeOutput, crate::operation::update_action_type::UpdateActionTypeError>;
