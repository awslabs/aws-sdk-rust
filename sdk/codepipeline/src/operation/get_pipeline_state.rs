...
impl GetPipelineStateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_pipeline_state::ser_get_pipeline_state_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPipelineState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pipeline_state::de_get_pipeline_state_http_response_with_props(status, headers, body)
        }
    }
}
