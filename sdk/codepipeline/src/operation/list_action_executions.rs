...
impl ListActionExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListActionExecutions`](crate::operation::list_action_executions::ListActionExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_action_executions::ListActionExecutions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_action_executions::ListActionExecutionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_action_executions::ser_list_action_executions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_action_executions::ListActionExecutions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListActionExecutions", "codepipeline"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListActionExecutions`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListActionExecutions {
                type Output = std::result::Result<crate::operation::list_action_executions::ListActionExecutionsOutput, crate::operation::list_action_executions::ListActionExecutionsError>;
