...
impl PutWebhook {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_webhook::PutWebhookError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_webhook::PutWebhookOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodePipeline", "PutWebhook", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodePipeline.PutWebhook",
                "rpc.service" = "CodePipeline",
                "rpc.method" = "PutWebhook",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutWebhook {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutWebhookRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutWebhookResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutWebhook")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutWebhookResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_webhook::de_put_webhook_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_webhook::de_put_webhook_http_response(status, headers, body, _cfg)
        };
