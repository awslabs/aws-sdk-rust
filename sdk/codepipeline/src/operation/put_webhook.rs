...
impl PutWebhookInput {
    /// Consumes the builder and constructs an Operation<[`PutWebhook`](crate::operation::put_webhook::PutWebhook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_webhook::PutWebhook, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_webhook::PutWebhookInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
/// `ParseStrictResponse` impl for `PutWebhook`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutWebhook {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_webhook::de_put_webhook_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_webhook::de_put_webhook_http_response(response)
                     }
                }
            }
