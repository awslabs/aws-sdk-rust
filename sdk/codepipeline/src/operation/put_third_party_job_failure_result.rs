...
/// Orchestration and serialization glue logic for `PutThirdPartyJobFailureResult`.
...
impl PutThirdPartyJobFailureResult {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultInput,
                    ) -> ::std::result::Result<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutThirdPartyJobFailureResult {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutThirdPartyJobFailureResult");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutThirdPartyJobFailureResultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutThirdPartyJobFailureResultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutThirdPartyJobFailureResult")
...
.with_interceptor(PutThirdPartyJobFailureResultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError>::new());
...
#[derive(Debug)]
            struct PutThirdPartyJobFailureResultResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutThirdPartyJobFailureResultResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_third_party_job_failure_result::de_put_third_party_job_failure_result_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_third_party_job_failure_result::de_put_third_party_job_failure_result_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutThirdPartyJobFailureResultRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutThirdPartyJobFailureResultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_third_party_job_failure_result::ser_put_third_party_job_failure_result_input(&input)?);
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutThirdPartyJobFailureResultEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutThirdPartyJobFailureResultInput>()
                        .ok_or("failed to downcast to PutThirdPartyJobFailureResultInput")?;
...
pub enum PutThirdPartyJobFailureResultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutThirdPartyJobFailureResultError) for what information is available for the error.")]
...
impl PutThirdPartyJobFailureResultError {
    /// Creates the `PutThirdPartyJobFailureResultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutThirdPartyJobFailureResultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutThirdPartyJobFailureResultError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResultError {
...
mod _put_third_party_job_failure_result_output;
