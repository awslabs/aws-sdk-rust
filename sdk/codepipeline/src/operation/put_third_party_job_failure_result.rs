...
impl PutThirdPartyJobFailureResultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_third_party_job_failure_result::PutThirdPartyJobFailureResult::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutThirdPartyJobFailureResult {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_third_party_job_failure_result::de_put_third_party_job_failure_result_http_response_with_props(
                status, headers, body,
            )
        }
    }
