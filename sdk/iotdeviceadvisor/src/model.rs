...
pub struct SuiteDefinitionConfiguration  {
    ...
    #[doc(hidden)]pub devices: std::option::Option<std::vec::Vec<crate::model::DeviceUnderTest>>,
    /// <p>Gets the tests intended for qualification in a suite.</p>
    #[doc(hidden)]pub intended_for_qualification: bool,
    /// <p> Verifies if the test suite is a long duration test. </p>
    #[doc(hidden)]pub is_long_duration_test: bool,
    /// <p>Gets test suite root group.</p>
    #[doc(hidden)]pub root_group: std::option::Option<std::string::String>,
    /// <p>Gets the device permission ARN.</p>
    #[doc(hidden)]pub device_permission_role_arn: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for SuiteDefinitionConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("intended_for_qualification", &self.intended_for_qualification);
        formatter.field("is_long_duration_test", &self.is_long_duration_test);
        formatter.field("root_group", &self.root_group);
        formatter.field("device_permission_role_arn", &self.device_permission_role_arn);
...
pub struct SuiteRunConfiguration  {
    ...
    #[doc(hidden)]pub primary_device: std::option::Option<crate::model::DeviceUnderTest>,
    /// <p>Gets test case list.</p>
    #[doc(hidden)]pub selected_test_list: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>TRUE if multiple test suites run in parallel.</p>
    #[doc(hidden)]pub parallel_run: bool,
}
...
pub struct SuiteRunInformation  {
    ...
    #[doc(hidden)]pub end_at: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct SuiteDefinitionInformation  {
    ...
    #[doc(hidden)]pub default_devices: std::option::Option<std::vec::Vec<crate::model::DeviceUnderTest>>,
...
pub struct TestResult  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::GroupResult>>,
}
impl TestResult {
    /// <p>Show each group of test results.</p>
...
pub struct GroupResult  {
    ...
    #[doc(hidden)]pub tests: std::option::Option<std::vec::Vec<crate::model::TestCaseRun>>,
}
impl GroupResult {
    /// <p>Group result ID.</p>
...
pub struct TestCaseRun  {
    ...
    #[doc(hidden)]pub test_case_run_id: std::option::Option<std::string::String>,
    /// <p>Provides the test case run definition ID.</p>
    #[doc(hidden)]pub test_case_definition_id: std::option::Option<std::string::String>,
    /// <p>Provides the test case run definition name.</p>
    #[doc(hidden)]pub test_case_definition_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub failure: std::option::Option<std::string::String>,
    /// <p> Provides the test scenarios for the test case run. </p>
    #[doc(hidden)]pub test_scenarios: std::option::Option<std::vec::Vec<crate::model::TestCaseScenario>>,
}
impl TestCaseRun {
    /// <p>Provides the test case run ID.</p>
...
pub struct TestCaseScenario  {
    ...
    #[doc(hidden)]pub test_case_scenario_id: std::option::Option<std::string::String>,
    /// <p>Provides test case scenario type. Type is one of the following:</p> 
    /// <ul> 
    /// <li> <p>Advanced</p> </li> 
    /// <li> <p>Basic</p> </li> 
    /// </ul>
    #[doc(hidden)]pub test_case_scenario_type: std::option::Option<crate::model::TestCaseScenarioType>,
    ...
    /// <li> <p> <code>ERORR</code>: Test faced an error when running due to an internal issue.</p> </li> 
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::TestCaseScenarioStatus>,
    /// <p>Provides test case scenario failure result.</p>
    #[doc(hidden)]pub failure: std::option::Option<std::string::String>,
    /// <p> </p>
    #[doc(hidden)]pub system_message: std::option::Option<std::string::String>,
}
