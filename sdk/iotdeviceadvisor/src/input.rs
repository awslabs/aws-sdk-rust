...
impl CreateSuiteDefinitionInput {
    ...
    > {
        Ok({
            ...
            let body = crate::operation_ser::serialize_operation_create_suite_definition(&self)
                .map_err(|err| {
...
impl DeleteSuiteDefinitionInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_1 = &self.suite_definition_id;
        let input_1 = input_1
            .as_ref()
...
impl GetSuiteDefinitionInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_2 = &self.suite_definition_id;
        let input_2 = input_2
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "suite_definition_id",
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_3) = &self.suite_definition_version {
            query.push_kv(
...
impl GetSuiteRunInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_4 = &self.suite_definition_id;
        let input_4 = input_4
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "suite_definition_id",
...
impl GetSuiteRunReportInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_6 = &self.suite_definition_id;
        let input_6 = input_6
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "suite_definition_id",
...
impl ListSuiteRunsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_9) = &self.suite_definition_id {
            query.push_kv(
                "suiteDefinitionId",
                &smithy_http::query::fmt_string(&inner_9),
            );
        }
        if let Some(inner_10) = &self.suite_definition_version {
            query.push_kv(
                "suiteDefinitionVersion",
...
impl StartSuiteRunInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_start_suite_run(&self).map_err(
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_13 = &self.suite_definition_id;
        let input_13 =
            input_13
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl StopSuiteRunInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_14 = &self.suite_definition_id;
        let input_14 =
            input_14
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let input_15 = &self.suite_run_id;
        let input_15 =
            input_15
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl UpdateSuiteDefinitionInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_suite_definition(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_20 = &self.suite_definition_id;
        let input_20 =
            input_20
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
