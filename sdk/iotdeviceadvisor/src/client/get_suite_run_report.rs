...
impl super::Client {
    ...
    ///   - [`suite_definition_id(impl ::std::convert::Into<String>)`](crate::operation::get_suite_run_report::builders::GetSuiteRunReportFluentBuilder::suite_definition_id) / [`set_suite_definition_id(Option<String>)`](crate::operation::get_suite_run_report::builders::GetSuiteRunReportFluentBuilder::set_suite_definition_id): <p>Suite definition ID of the test suite.</p>
    ///   - [`suite_run_id(impl ::std::convert::Into<String>)`](crate::operation::get_suite_run_report::builders::GetSuiteRunReportFluentBuilder::suite_run_id) / [`set_suite_run_id(Option<String>)`](crate::operation::get_suite_run_report::builders::GetSuiteRunReportFluentBuilder::set_suite_run_id): <p>Suite run ID of the test suite run.</p>
