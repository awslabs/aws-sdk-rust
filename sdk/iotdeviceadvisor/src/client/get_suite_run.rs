...
impl super::Client {
    ...
    ///   - [`suite_definition_id(impl Into<String>)`](crate::operation::get_suite_run::builders::GetSuiteRunFluentBuilder::suite_definition_id) / [`set_suite_definition_id(Option<String>)`](crate::operation::get_suite_run::builders::GetSuiteRunFluentBuilder::set_suite_definition_id):<br>required: **true**<br><p>Suite definition ID for the test suite run.</p><br>
    ///   - [`suite_run_id(impl Into<String>)`](crate::operation::get_suite_run::builders::GetSuiteRunFluentBuilder::suite_run_id) / [`set_suite_run_id(Option<String>)`](crate::operation::get_suite_run::builders::GetSuiteRunFluentBuilder::set_suite_run_id):<br>required: **true**<br><p>Suite run ID for the test suite run.</p><br>
