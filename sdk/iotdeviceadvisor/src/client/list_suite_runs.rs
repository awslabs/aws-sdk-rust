...
impl super::Client {
    ...
    ///   - [`suite_definition_id(impl Into<String>)`](crate::operation::list_suite_runs::builders::ListSuiteRunsFluentBuilder::suite_definition_id) / [`set_suite_definition_id(Option<String>)`](crate::operation::list_suite_runs::builders::ListSuiteRunsFluentBuilder::set_suite_definition_id):<br>required: **false**<br><p>Lists the test suite runs of the specified test suite based on suite definition ID.</p><br>
    ///   - [`suite_definition_version(impl Into<String>)`](crate::operation::list_suite_runs::builders::ListSuiteRunsFluentBuilder::suite_definition_version) / [`set_suite_definition_version(Option<String>)`](crate::operation::list_suite_runs::builders::ListSuiteRunsFluentBuilder::set_suite_definition_version):<br>required: **false**<br><p>Must be passed along with <code>suiteDefinitionId</code>. Lists the test suite runs of the specified test suite based on suite definition version.</p><br>
