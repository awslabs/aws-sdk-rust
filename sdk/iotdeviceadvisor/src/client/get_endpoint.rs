...
impl super::Client {
    ...
    ///   - [`thing_arn(impl ::std::convert::Into<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::thing_arn) / [`set_thing_arn(Option<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::set_thing_arn): <p>The thing ARN of the device. This is an optional parameter.</p>
    ///   - [`certificate_arn(impl ::std::convert::Into<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::certificate_arn) / [`set_certificate_arn(Option<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::set_certificate_arn): <p>The certificate ARN of the device. This is an optional parameter.</p>
    ///   - [`device_role_arn(impl ::std::convert::Into<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::device_role_arn) / [`set_device_role_arn(Option<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::set_device_role_arn): <p>The device role ARN of the device. This is an optional parameter.</p>
