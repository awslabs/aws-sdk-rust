...
impl super::Client {
    ...
    ///   - [`device_role_arn(impl Into<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::device_role_arn) / [`set_device_role_arn(Option<String>)`](crate::operation::get_endpoint::builders::GetEndpointFluentBuilder::set_device_role_arn): <p>The device role ARN of the device. This is an optional parameter.</p>
