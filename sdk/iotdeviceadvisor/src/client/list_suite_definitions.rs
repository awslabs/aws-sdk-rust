...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_suite_definitions::builders::ListSuiteDefinitionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_suite_definitions::builders::ListSuiteDefinitionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return at once.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_suite_definitions::builders::ListSuiteDefinitionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_suite_definitions::builders::ListSuiteDefinitionsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token used to get the next set of results.</p><br>
