...
impl super::Client {
    ...
    ///   - [`suite_definition_id(impl ::std::convert::Into<String>)`](crate::operation::stop_suite_run::builders::StopSuiteRunFluentBuilder::suite_definition_id) / [`set_suite_definition_id(Option<String>)`](crate::operation::stop_suite_run::builders::StopSuiteRunFluentBuilder::set_suite_definition_id): <p>Suite definition ID of the test suite run to be stopped.</p>
