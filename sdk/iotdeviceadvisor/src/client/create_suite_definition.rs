...
impl super::Client {
    ...
    ///   - [`suite_definition_configuration(SuiteDefinitionConfiguration)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::suite_definition_configuration) / [`set_suite_definition_configuration(Option<SuiteDefinitionConfiguration>)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::set_suite_definition_configuration):<br>required: **true**<br><p>Creates a Device Advisor test suite with suite definition configuration.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::set_tags):<br>required: **false**<br><p>The tags to be attached to the suite definition.</p><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_suite_definition::builders::CreateSuiteDefinitionFluentBuilder::set_client_token):<br>required: **false**<br><p>The client token for the test suite definition creation. This token is used for tracking test suite definition creation using retries and obtaining its status. This parameter is optional.</p><br>
