...
pub fn serialize_structure_create_suite_definition_input(
    ...
    if let Some(var_1) = &input.suite_definition_configuration {
        ...
        crate::json_ser::serialize_structure_suite_definition_configuration(&mut object_2, var_1);
        object_2.finish();
    }
...
pub fn serialize_structure_start_suite_run_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_8) = &input.suite_run_configuration {
        ...
        crate::json_ser::serialize_structure_suite_run_configuration(&mut object_9, var_8);
        object_9.finish();
    }
...
pub fn serialize_structure_update_suite_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_18) = &input.suite_definition_configuration {
        ...
        crate::json_ser::serialize_structure_suite_definition_configuration(&mut object_19, var_18);
        object_19.finish();
    }
}

pub fn serialize_structure_suite_definition_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_device_under_test(&mut object_24, item_23);
                object_24.finish();
            }
        }
        array_22.finish();
...
pub fn serialize_structure_suite_run_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_27) = &input.primary_device {
        ...
        crate::json_ser::serialize_structure_device_under_test(&mut object_28, var_27);
        object_28.finish();
    }
...
pub fn serialize_structure_device_under_test(
    object: &mut smithy_json::serialize::JsonObjectWriter,
