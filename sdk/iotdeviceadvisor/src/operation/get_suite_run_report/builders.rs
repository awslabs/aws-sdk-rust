...
impl GetSuiteRunReportFluentBuilder  {
    /// Creates a new `GetSuiteRunReport`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_suite_run_report::GetSuiteRunReportOutput, aws_smithy_http::result::SdkError<crate::operation::get_suite_run_report::GetSuiteRunReportError>>
                     {
