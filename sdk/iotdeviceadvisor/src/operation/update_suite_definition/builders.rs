...
impl UpdateSuiteDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_suite_definition::UpdateSuiteDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_suite_definition::UpdateSuiteDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_suite_definition::UpdateSuiteDefinitionOutput, crate::operation::update_suite_definition::UpdateSuiteDefinitionError, Self> {
