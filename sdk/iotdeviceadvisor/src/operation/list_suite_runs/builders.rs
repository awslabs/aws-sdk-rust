...
impl ListSuiteRunsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_suite_runs::ListSuiteRunsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_suite_runs::ListSuiteRunsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_suite_runs::ListSuiteRunsOutput, crate::operation::list_suite_runs::ListSuiteRunsError, Self> {
