...
impl GetEndpointInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_endpoint::GetEndpoint::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetEndpoint {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_endpoint::de_get_endpoint_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_endpoint::de_get_endpoint_http_response_with_props(
                status, headers, body,
            )
        }
    }
