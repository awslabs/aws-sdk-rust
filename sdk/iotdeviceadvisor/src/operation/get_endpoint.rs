...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_endpoint::GetEndpointError>::new());
...
fn uri_query(_input: &crate::operation::get_endpoint::GetEndpointInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
