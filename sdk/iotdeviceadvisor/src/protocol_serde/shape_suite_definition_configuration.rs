...
pub fn ser_suite_definition_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SuiteDefinitionConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_suite_definition_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SuiteDefinitionConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
