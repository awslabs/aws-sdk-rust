...
pub(crate) fn de_suite_definition_information<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SuiteDefinitionInformation>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "defaultDevices" => {
                            builder = builder.set_default_devices(crate::protocol_serde::shape_device_under_test_list::de_device_under_test_list(
                                tokens, _value,
                            )?);
                        }
