...
pub fn ser_create_suite_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSuiteDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
