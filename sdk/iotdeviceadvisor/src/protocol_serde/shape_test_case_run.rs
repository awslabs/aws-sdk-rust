...
pub(crate) fn de_test_case_run<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::TestCaseRun>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "testScenarios" => {
                            builder = builder.set_test_scenarios(crate::protocol_serde::shape_test_case_scenarios_list::de_test_case_scenarios_list(
                                tokens,
                            )?);
                        }
