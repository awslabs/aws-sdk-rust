...
pub fn ser_update_suite_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSuiteDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
