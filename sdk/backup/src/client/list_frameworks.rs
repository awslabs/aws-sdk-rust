...
impl super::Client {
    ...
    ///   - [`frameworks(Option<Vec::<Framework>>)`](crate::operation::list_frameworks::ListFrameworksOutput::frameworks): <p>The frameworks with details for each framework, including the framework name, Amazon Resource Name (ARN), description, number of controls, creation time, and deployment status.</p>
