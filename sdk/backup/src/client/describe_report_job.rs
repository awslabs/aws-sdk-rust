...
impl super::Client {
    ...
    ///   - [`report_job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_report_job::builders::DescribeReportJobFluentBuilder::report_job_id) / [`set_report_job_id(Option<String>)`](crate::operation::describe_report_job::builders::DescribeReportJobFluentBuilder::set_report_job_id): <p>The identifier of the report job. A unique, randomly generated, Unicode, UTF-8 encoded string that is at most 1,024 bytes long. The report job ID cannot be edited.</p>
