...
impl super::Client {
    ...
    ///   - [`last_backup_vault_arn(Option<String>)`](crate::operation::describe_protected_resource::DescribeProtectedResourceOutput::last_backup_vault_arn): <p>This is the ARN (Amazon Resource Name) of the backup vault that contains the most recent backup recovery point.</p>
    ///   - [`last_recovery_point_arn(Option<String>)`](crate::operation::describe_protected_resource::DescribeProtectedResourceOutput::last_recovery_point_arn): <p>This is the ARN (Amazon Resource Name) of the most recent recovery point.</p>
    ///   - [`latest_restore_execution_time_minutes(Option<i64>)`](crate::operation::describe_protected_resource::DescribeProtectedResourceOutput::latest_restore_execution_time_minutes): <p>This is the time in minutes the most recent restore job took to complete.</p>
    ///   - [`latest_restore_job_creation_date(Option<DateTime>)`](crate::operation::describe_protected_resource::DescribeProtectedResourceOutput::latest_restore_job_creation_date): <p>This is the creation date of the most recent restore job.</p>
    ///   - [`latest_restore_recovery_point_creation_date(Option<DateTime>)`](crate::operation::describe_protected_resource::DescribeProtectedResourceOutput::latest_restore_recovery_point_creation_date): <p>This is the date the most recent recovery point was created.</p>
