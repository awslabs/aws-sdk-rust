...
impl super::Client {
    ...
    ///   - [`copy_job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_copy_job::builders::DescribeCopyJobFluentBuilder::copy_job_id) / [`set_copy_job_id(Option<String>)`](crate::operation::describe_copy_job::builders::DescribeCopyJobFluentBuilder::set_copy_job_id): <p>Uniquely identifies a copy job.</p>
