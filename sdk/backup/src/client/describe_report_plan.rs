...
impl super::Client {
    ...
    ///   - [`report_plan_name(impl Into<String>)`](crate::operation::describe_report_plan::builders::DescribeReportPlanFluentBuilder::report_plan_name) / [`set_report_plan_name(Option<String>)`](crate::operation::describe_report_plan::builders::DescribeReportPlanFluentBuilder::set_report_plan_name):<br>required: **true**<br><p>The unique name of a report plan.</p><br>
