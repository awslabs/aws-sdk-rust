...
impl super::Client {
    ...
    ///   - [`report_plan_name(impl ::std::convert::Into<String>)`](crate::operation::start_report_job::builders::StartReportJobFluentBuilder::report_plan_name) / [`set_report_plan_name(Option<String>)`](crate::operation::start_report_job::builders::StartReportJobFluentBuilder::set_report_plan_name): <p>The unique name of a report plan.</p>
    ///   - [`idempotency_token(impl ::std::convert::Into<String>)`](crate::operation::start_report_job::builders::StartReportJobFluentBuilder::idempotency_token) / [`set_idempotency_token(Option<String>)`](crate::operation::start_report_job::builders::StartReportJobFluentBuilder::set_idempotency_token): <p>A customer-chosen string that you can use to distinguish between otherwise identical calls to <code>StartReportJobInput</code>. Retrying a successful request with the same idempotency token results in a success message with no action taken.</p>
