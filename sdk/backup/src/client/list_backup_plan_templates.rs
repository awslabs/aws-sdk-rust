...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_backup_plan_templates::builders::ListBackupPlanTemplatesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_backup_plan_templates::builders::ListBackupPlanTemplatesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of items to return.</p><br>
