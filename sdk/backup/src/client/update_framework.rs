...
impl super::Client {
    ...
    ///   - [`framework_name(impl ::std::convert::Into<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::framework_name) / [`set_framework_name(Option<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::set_framework_name): <p>The unique name of a framework. This name is between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).</p>
    ///   - [`framework_description(impl ::std::convert::Into<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::framework_description) / [`set_framework_description(Option<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::set_framework_description): <p>An optional description of the framework with a maximum 1,024 characters.</p>
    ...
    ///   - [`idempotency_token(impl ::std::convert::Into<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::idempotency_token) / [`set_idempotency_token(Option<String>)`](crate::operation::update_framework::builders::UpdateFrameworkFluentBuilder::set_idempotency_token): <p>A customer-chosen string that you can use to distinguish between otherwise identical calls to <code>UpdateFrameworkInput</code>. Retrying a successful request with the same idempotency token results in a success message with no action taken.</p>
