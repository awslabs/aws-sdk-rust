...
impl super::Client {
    ...
    ///   - [`global_settings(impl Into<String>, impl Into<String>)`](crate::operation::update_global_settings::builders::UpdateGlobalSettingsFluentBuilder::global_settings) / [`set_global_settings(Option<HashMap::<String, String>>)`](crate::operation::update_global_settings::builders::UpdateGlobalSettingsFluentBuilder::set_global_settings):<br>required: **false**<br><p>A value for <code>isCrossAccountBackupEnabled</code> and a Region. Example: <code>update-global-settings --global-settings isCrossAccountBackupEnabled=false --region us-west-2</code>.</p><br>
