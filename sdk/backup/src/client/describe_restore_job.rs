...
impl super::Client {
    ...
    ///   - [`recovery_point_creation_date(Option<DateTime>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::recovery_point_creation_date): <p>This is the creation date of the recovery point made by the specifed restore job.</p>
    ...
    ///   - [`validation_status(Option<RestoreValidationStatus>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::validation_status): <p>This is the status of validation run on the indicated restore job.</p>
    ///   - [`validation_status_message(Option<String>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::validation_status_message): <p>This describes the status of validation run on the indicated restore job.</p>
    ///   - [`deletion_status(Option<RestoreDeletionStatus>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::deletion_status): <p>This notes the status of the data generated by the restore test. The status may be <code>Deleting</code>, <code>Failed</code>, or <code>Successful</code>.</p>
