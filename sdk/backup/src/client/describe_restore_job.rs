...
impl super::Client {
    ...
    ///   - [`source_resource_arn(Option<String>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::source_resource_arn): <p>The Amazon Resource Name (ARN) of the original resource that was backed up. This provides context about what resource is being restored.</p>
    ///   - [`backup_vault_arn(Option<String>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::backup_vault_arn): <p>The Amazon Resource Name (ARN) of the backup vault containing the recovery point being restored. This helps identify vault access policies and permissions.</p>
    ...
    ///   - [`is_parent(bool)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::is_parent): <p>This is a boolean value indicating whether the restore job is a parent (composite) restore job.</p>
    ///   - [`parent_job_id(Option<String>)`](crate::operation::describe_restore_job::DescribeRestoreJobOutput::parent_job_id): <p>This is the unique identifier of the parent restore job for the selected restore job.</p>
