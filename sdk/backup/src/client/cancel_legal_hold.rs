...
impl super::Client {
    ...
    ///   - [`legal_hold_id(impl Into<String>)`](crate::operation::cancel_legal_hold::builders::CancelLegalHoldFluentBuilder::legal_hold_id) / [`set_legal_hold_id(Option<String>)`](crate::operation::cancel_legal_hold::builders::CancelLegalHoldFluentBuilder::set_legal_hold_id):<br>required: **true**<br><p>The ID of the legal hold.</p><br>
    ///   - [`cancel_description(impl Into<String>)`](crate::operation::cancel_legal_hold::builders::CancelLegalHoldFluentBuilder::cancel_description) / [`set_cancel_description(Option<String>)`](crate::operation::cancel_legal_hold::builders::CancelLegalHoldFluentBuilder::set_cancel_description):<br>required: **true**<br><p>A string the describes the reason for removing the legal hold.</p><br>
