...
impl super::Client {
    ...
    ///   - [`framework_name(impl Into<String>)`](crate::operation::delete_framework::builders::DeleteFrameworkFluentBuilder::framework_name) / [`set_framework_name(Option<String>)`](crate::operation::delete_framework::builders::DeleteFrameworkFluentBuilder::set_framework_name):<br>required: **true**<br><p>The unique name of a framework.</p><br>
