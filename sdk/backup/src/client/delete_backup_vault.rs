...
impl super::Client {
    ...
    ///   - [`backup_vault_name(impl ::std::convert::Into<String>)`](crate::operation::delete_backup_vault::builders::DeleteBackupVaultFluentBuilder::backup_vault_name) / [`set_backup_vault_name(Option<String>)`](crate::operation::delete_backup_vault::builders::DeleteBackupVaultFluentBuilder::set_backup_vault_name): <p>The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the Amazon Web Services Region where they are created. They consist of lowercase letters, numbers, and hyphens.</p>
    ...
    pub fn delete_backup_vault(
        &self,
    ) -> crate::operation::delete_backup_vault::builders::DeleteBackupVaultFluentBuilder {
        crate::operation::delete_backup_vault::builders::DeleteBackupVaultFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
