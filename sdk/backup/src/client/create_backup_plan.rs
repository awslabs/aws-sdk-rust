...
impl super::Client {
    ...
    ///   - [`backup_plan(BackupPlanInput)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::backup_plan) / [`set_backup_plan(Option<BackupPlanInput>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::set_backup_plan): <p>Specifies the body of a backup plan. Includes a <code>BackupPlanName</code> and one or more sets of <code>Rules</code>.</p>
    ///   - [`backup_plan_tags(HashMap<String, String>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::backup_plan_tags) / [`set_backup_plan_tags(Option<HashMap<String, String>>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::set_backup_plan_tags): <p>To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair. The specified tags are assigned to all backups created with this plan.</p>
    ///   - [`creator_request_id(impl ::std::convert::Into<String>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::creator_request_id) / [`set_creator_request_id(Option<String>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::set_creator_request_id): <p>Identifies the request and allows failed requests to be retried without the risk of running the operation twice. If the request includes a <code>CreatorRequestId</code> that matches an existing backup plan, that plan is returned. This parameter is optional.</p>  <p>If used, this parameter must contain 1 to 50 alphanumeric or '-_.' characters.</p>
