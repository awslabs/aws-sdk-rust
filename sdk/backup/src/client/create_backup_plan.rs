...
impl super::Client {
    ...
    ///   - [`backup_plan(BackupPlanInput)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::backup_plan) / [`set_backup_plan(Option<BackupPlanInput>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::set_backup_plan):<br>required: **true**<br><p>The body of a backup plan. Includes a <code>BackupPlanName</code> and one or more sets of <code>Rules</code>.</p><br>
    ///   - [`backup_plan_tags(impl Into<String>, impl Into<String>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::backup_plan_tags) / [`set_backup_plan_tags(Option<HashMap::<String, String>>)`](crate::operation::create_backup_plan::builders::CreateBackupPlanFluentBuilder::set_backup_plan_tags):<br>required: **false**<br><p>The tags to assign to the backup plan.</p><br>
    ...
    ///   - [`backup_plan_id(Option<String>)`](crate::operation::create_backup_plan::CreateBackupPlanOutput::backup_plan_id): <p>The ID of the backup plan.</p>
    ...
    ///   - [`advanced_backup_settings(Option<Vec::<AdvancedBackupSetting>>)`](crate::operation::create_backup_plan::CreateBackupPlanOutput::advanced_backup_settings): <p>The settings for a resource type. This option is only available for Windows Volume Shadow Copy Service (VSS) backup jobs.</p>
