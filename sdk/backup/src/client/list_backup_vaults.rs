...
impl super::Client {
    ...
    ///   - [`by_vault_type(VaultType)`](crate::operation::list_backup_vaults::builders::ListBackupVaultsFluentBuilder::by_vault_type) / [`set_by_vault_type(Option<VaultType>)`](crate::operation::list_backup_vaults::builders::ListBackupVaultsFluentBuilder::set_by_vault_type): <p>This parameter will sort the list of vaults by vault type.</p>
    ///   - [`by_shared(bool)`](crate::operation::list_backup_vaults::builders::ListBackupVaultsFluentBuilder::by_shared) / [`set_by_shared(Option<bool>)`](crate::operation::list_backup_vaults::builders::ListBackupVaultsFluentBuilder::set_by_shared): <p>This parameter will sort the list of vaults by shared vaults.</p>
