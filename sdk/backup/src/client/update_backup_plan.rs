...
impl super::Client {
    ...
    ///   - [`backup_plan_id(impl Into<String>)`](crate::operation::update_backup_plan::builders::UpdateBackupPlanFluentBuilder::backup_plan_id) / [`set_backup_plan_id(Option<String>)`](crate::operation::update_backup_plan::builders::UpdateBackupPlanFluentBuilder::set_backup_plan_id):<br>required: **true**<br><p>Uniquely identifies a backup plan.</p><br>
    ///   - [`backup_plan(BackupPlanInput)`](crate::operation::update_backup_plan::builders::UpdateBackupPlanFluentBuilder::backup_plan) / [`set_backup_plan(Option<BackupPlanInput>)`](crate::operation::update_backup_plan::builders::UpdateBackupPlanFluentBuilder::set_backup_plan):<br>required: **true**<br><p>Specifies the body of a backup plan. Includes a <code>BackupPlanName</code> and one or more sets of <code>Rules</code>.</p><br>
