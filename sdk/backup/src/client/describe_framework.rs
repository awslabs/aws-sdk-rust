...
impl super::Client {
    ...
    ///   - [`framework_controls(Option<Vec::<FrameworkControl>>)`](crate::operation::describe_framework::DescribeFrameworkOutput::framework_controls): <p>The controls that make up the framework. Each control in the list has a name, input parameters, and scope.</p>
