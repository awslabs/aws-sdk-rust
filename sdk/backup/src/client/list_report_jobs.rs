...
impl super::Client {
    ...
    ///   - [`by_report_plan_name(impl ::std::convert::Into<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::by_report_plan_name) / [`set_by_report_plan_name(Option<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::set_by_report_plan_name): <p>Returns only report jobs with the specified report plan name.</p>
    ...
    ///   - [`by_status(impl ::std::convert::Into<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::by_status) / [`set_by_status(Option<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::set_by_status): <p>Returns only report jobs that are in the specified status. The statuses are:</p>  <p> <code>CREATED | RUNNING | COMPLETED | FAILED</code> </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_report_jobs::builders::ListReportJobsFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
