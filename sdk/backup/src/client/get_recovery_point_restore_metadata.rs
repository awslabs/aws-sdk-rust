...
impl super::Client {
    ...
    ///   - [`backup_vault_arn(Option<String>)`](crate::operation::get_recovery_point_restore_metadata::GetRecoveryPointRestoreMetadataOutput::backup_vault_arn): <p>An ARN that uniquely identifies a backup vault; for example, <code>arn:aws:backup:us-east-1:123456789012:backup-vault:aBackupVault</code>.</p>
    ...
    ///   - [`resource_type(Option<String>)`](crate::operation::get_recovery_point_restore_metadata::GetRecoveryPointRestoreMetadataOutput::resource_type): <p>The resource type of the recovery point.</p>
