...
impl super::Client {
    ...
    ///   - [`backup_plan_template_json(impl Into<String>)`](crate::operation::get_backup_plan_from_json::builders::GetBackupPlanFromJSONFluentBuilder::backup_plan_template_json) / [`set_backup_plan_template_json(Option<String>)`](crate::operation::get_backup_plan_from_json::builders::GetBackupPlanFromJSONFluentBuilder::set_backup_plan_template_json):<br>required: **true**<br><p>A customer-supplied backup plan document in JSON format.</p><br>
