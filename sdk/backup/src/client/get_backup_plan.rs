...
impl super::Client {
    ...
    ///   - [`backup_plan_id(impl ::std::convert::Into<String>)`](crate::operation::get_backup_plan::builders::GetBackupPlanFluentBuilder::backup_plan_id) / [`set_backup_plan_id(Option<String>)`](crate::operation::get_backup_plan::builders::GetBackupPlanFluentBuilder::set_backup_plan_id): <p>Uniquely identifies a backup plan.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::get_backup_plan::builders::GetBackupPlanFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::get_backup_plan::builders::GetBackupPlanFluentBuilder::set_version_id): <p>Unique, randomly generated, Unicode, UTF-8 encoded strings that are at most 1,024 bytes long. Version IDs cannot be edited.</p>
