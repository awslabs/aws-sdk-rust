...
impl super::Client {
    ...
    ///   - [`backup_vault_arn(Option<String>)`](crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsOutput::backup_vault_arn): <p>An Amazon Resource Name (ARN) that uniquely identifies a backup vault; for example, <code>arn:aws:backup:us-east-1:123456789012:backup-vault:aBackupVault</code>.</p>
