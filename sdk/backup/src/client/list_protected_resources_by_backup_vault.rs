...
impl super::Client {
    ...
    ///   - [`backup_vault_name(impl Into<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::backup_vault_name) / [`set_backup_vault_name(Option<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::set_backup_vault_name): <p>This is the list of protected resources by backup vault within the vault(s) you specify by name.</p>
    ///   - [`backup_vault_account_id(impl Into<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::backup_vault_account_id) / [`set_backup_vault_account_id(Option<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::set_backup_vault_account_id): <p>This is the list of protected resources by backup vault within the vault(s) you specify by account ID.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_protected_resources_by_backup_vault::builders::ListProtectedResourcesByBackupVaultFluentBuilder::set_next_token): <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
