...
impl super::Client {
    ...
    ///   - [`creation_time(DateTime)`](crate::operation::update_restore_testing_plan::UpdateRestoreTestingPlanOutput::creation_time): <p>The time the resource testing plan was created.</p>
    ...
    ///   - [`update_time(DateTime)`](crate::operation::update_restore_testing_plan::UpdateRestoreTestingPlanOutput::update_time): <p>The time the update completed for the restore testing plan.</p>
