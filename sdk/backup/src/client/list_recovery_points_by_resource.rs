...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::list_recovery_points_by_resource::builders::ListRecoveryPointsByResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_recovery_points_by_resource::builders::ListRecoveryPointsByResourceFluentBuilder::set_resource_arn): <p>An ARN that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_recovery_points_by_resource::builders::ListRecoveryPointsByResourceFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_recovery_points_by_resource::builders::ListRecoveryPointsByResourceFluentBuilder::set_next_token): <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
