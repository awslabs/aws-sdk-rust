...
pub struct ReportSetting  {
    ...
    #[doc(hidden)]pub report_template: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Names (ARNs) of the frameworks a report covers.</p>
    #[doc(hidden)]pub framework_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The number of frameworks a report covers.</p>
    #[doc(hidden)]pub number_of_frameworks: i32,
}
impl ReportSetting {
    /// <p>Identifies the report template for the report. Reports are built using a report template. The report templates are:</p> 
    /// <p> <code>RESOURCE_COMPLIANCE_REPORT | CONTROL_COMPLIANCE_REPORT | BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT</code> </p>
...
pub struct ReportDeliveryChannel  {
    ...
    #[doc(hidden)]pub formats: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct CalculatedLifecycle  {
    ...
    #[doc(hidden)]pub move_to_cold_storage_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A timestamp that specifies when to delete a recovery point.</p>
    #[doc(hidden)]pub delete_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct Lifecycle  {
    ...
    #[doc(hidden)]pub move_to_cold_storage_after_days: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub delete_after_days: std::option::Option<i64>,
}
impl Lifecycle {
    /// <p>Specifies the number of days after creation that a recovery point is moved to cold storage.</p>
...
impl  std::fmt::Debug for Lifecycle  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("move_to_cold_storage_after_days", &self.move_to_cold_storage_after_days);
...
pub struct FrameworkControl  {
    ...
    #[doc(hidden)]pub control_input_parameters: std::option::Option<std::vec::Vec<crate::model::ControlInputParameter>>,
    ...
    #[doc(hidden)]pub control_scope: std::option::Option<crate::model::ControlScope>,
}
impl FrameworkControl {
    ...
    /// <p>A list of <code>ParameterName</code> and <code>ParameterValue</code> pairs.</p>
    pub fn control_input_parameters(&self) -> std::option::Option<& [crate::model::ControlInputParameter]> {
...
pub mod framework_control {
    ...
    pub struct Builder {
        ...
        pub(crate) control_input_parameters: std::option::Option<std::vec::Vec<crate::model::ControlInputParameter>>,
    ...
    impl Builder {
        ...
        ///
        /// <p>A list of <code>ParameterName</code> and <code>ParameterValue</code> pairs.</p>
        pub fn control_input_parameters(mut self, input: crate::model::ControlInputParameter) -> Self {
        ...
        /// <p>A list of <code>ParameterName</code> and <code>ParameterValue</code> pairs.</p>
        pub fn set_control_input_parameters(mut self, input: std::option::Option<std::vec::Vec<crate::model::ControlInputParameter>>) -> Self {
        ...
        /// <p>The scope of a control. The control scope defines what the control will evaluate. Three examples of control scopes are: a specific backup plan, all backup plans with a specific tag, or all backup plans. For more information, see <a href="aws-backup/latest/devguide/API_ControlScope.html"> <code>ControlScope</code>.</a> </p>
        pub fn set_control_scope(mut self, input: std::option::Option<crate::model::ControlScope>) -> Self {
...
pub struct ControlScope  {
    ...
    #[doc(hidden)]pub compliance_resource_ids: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct AdvancedBackupSetting  {
    ...
    #[doc(hidden)]pub backup_options: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct BackupPlanInput  {
    ...
    #[doc(hidden)]pub backup_plan_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub rules: std::option::Option<std::vec::Vec<crate::model::BackupRuleInput>>,
    ...
    #[doc(hidden)]pub advanced_backup_settings: std::option::Option<std::vec::Vec<crate::model::AdvancedBackupSetting>>,
}
...
pub mod backup_plan_input {
    ...
    impl Builder {
        ...
        /// <p>An array of <code>BackupRule</code> objects, each of which specifies a scheduled task that is used to back up a selection of resources.</p>
        pub fn set_rules(mut self, input: std::option::Option<std::vec::Vec<crate::model::BackupRuleInput>>) -> Self {
...
pub struct BackupRuleInput  {
    ...
    #[doc(hidden)]pub target_backup_vault_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub start_window_minutes: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub completion_window_minutes: std::option::Option<i64>,
    ...
    /// <p>Backups transitioned to cold storage must be stored in cold storage for a minimum of 90 days. Therefore, the “retention” setting must be 90 days greater than the “transition to cold after days” setting. The “transition to cold after days” setting cannot be changed after a backup has been transitioned to cold.</p> 
    /// <p>Resource types that are able to be transitioned to cold storage are listed in the "Lifecycle to cold storage" section of the <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html#features-by-resource"> Feature availability by resource</a> table. Backup ignores this expression for other resource types.</p>
    #[doc(hidden)]pub lifecycle: std::option::Option<crate::model::Lifecycle>,
    ...
    #[doc(hidden)]pub recovery_point_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>An array of <code>CopyAction</code> objects, which contains the details of the copy operation.</p>
    #[doc(hidden)]pub copy_actions: std::option::Option<std::vec::Vec<crate::model::CopyAction>>,
    ...
    #[doc(hidden)]pub enable_continuous_backup: std::option::Option<bool>,
}
...
pub mod backup_rule_input {
    ...
    impl Builder {
        ...
        /// <p>An array of <code>CopyAction</code> objects, which contains the details of the copy operation.</p>
        pub fn set_copy_actions(mut self, input: std::option::Option<std::vec::Vec<crate::model::CopyAction>>) -> Self {
...
pub struct CopyAction  {
    ...
    #[doc(hidden)]pub destination_backup_vault_arn: std::option::Option<std::string::String>,
}
impl CopyAction {
    /// <p>Contains an array of <code>Transition</code> objects specifying how long in days before a recovery point transitions to cold storage or is deleted.</p> 
    /// <p>Backups transitioned to cold storage must be stored in cold storage for a minimum of 90 days. Therefore, on the console, the “retention” setting must be 90 days greater than the “transition to cold after days” setting. The “transition to cold after days” setting cannot be changed after a backup has been transitioned to cold.</p> 
...
impl  std::fmt::Debug for CopyAction  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("lifecycle", &self.lifecycle);
        formatter.field("destination_backup_vault_arn", &self.destination_backup_vault_arn);
        formatter.finish()
    }
}
...
pub struct RestoreJobsListMember  {
    ...
    #[doc(hidden)]pub restore_job_id: std::option::Option<std::string::String>,
    /// <p>An ARN that uniquely identifies a recovery point; for example, <code>arn:aws:backup:us-east-1:123456789012:recovery-point:1EB3B5E7-9EB0-435A-A80B-108B488B0D45</code>.</p>
    #[doc(hidden)]pub recovery_point_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub completion_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A status code specifying the state of the job initiated by Backup to restore a recovery point.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::RestoreJobStatus>,
    ...
    #[doc(hidden)]pub percent_done: std::option::Option<std::string::String>,
    /// <p>The size, in bytes, of the restored resource.</p>
    #[doc(hidden)]pub backup_size_in_bytes: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub expected_completion_time_minutes: std::option::Option<i64>,
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
    #[doc(hidden)]pub created_resource_arn: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for RestoreJobsListMember  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("expected_completion_time_minutes", &self.expected_completion_time_minutes);
...
pub struct ReportPlan  {
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
    #[doc(hidden)]pub report_plan_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub report_plan_name: std::option::Option<std::string::String>,
    /// <p>An optional description of the report plan with a maximum 1,024 characters.</p>
    #[doc(hidden)]pub report_plan_description: std::option::Option<std::string::String>,
    /// <p>Identifies the report template for the report. Reports are built using a report template. The report templates are:</p> 
    /// <p> <code>RESOURCE_COMPLIANCE_REPORT | CONTROL_COMPLIANCE_REPORT | BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT</code> </p> 
    ...
    #[doc(hidden)]pub report_setting: std::option::Option<crate::model::ReportSetting>,
    ...
    #[doc(hidden)]pub report_delivery_channel: std::option::Option<crate::model::ReportDeliveryChannel>,
    ...
    #[doc(hidden)]pub last_attempted_execution_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub last_successful_execution_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl ReportPlan {
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
...
impl  std::fmt::Debug for ReportPlan  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_attempted_execution_time", &self.last_attempted_execution_time);
        formatter.field("last_successful_execution_time", &self.last_successful_execution_time);
        formatter.finish()
    }
}
...
pub struct ReportJob  {
    ...
    #[doc(hidden)]pub report_job_id: std::option::Option<std::string::String>,
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
    #[doc(hidden)]pub report_plan_arn: std::option::Option<std::string::String>,
    /// <p>Identifies the report template for the report. Reports are built using a report template. The report templates are: </p> 
    /// <p> <code>RESOURCE_COMPLIANCE_REPORT | CONTROL_COMPLIANCE_REPORT | BACKUP_JOB_REPORT | COPY_JOB_REPORT | RESTORE_JOB_REPORT</code> </p>
    ...
    #[doc(hidden)]pub report_destination: std::option::Option<crate::model::ReportDestination>,
}
impl ReportJob {
    /// <p>The identifier for a report job. A unique, randomly generated, Unicode, UTF-8 encoded string that is at most 1,024 bytes long. Report job IDs cannot be edited.</p>
...
pub mod report_job {
    ...
    impl Builder {
        ...
        /// <p>The S3 bucket name and S3 keys for the destination where the report job publishes the report.</p>
        pub fn set_report_destination(mut self, input: std::option::Option<crate::model::ReportDestination>) -> Self {
...
pub struct RecoveryPointByResource  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::RecoveryPointStatus>,
    ...
    /// <p>The name of a logical container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the Amazon Web Services Region where they are created. They consist of lowercase letters, numbers, and hyphens.</p>
    #[doc(hidden)]pub backup_vault_name: std::option::Option<std::string::String>,
}
...
pub struct RecoveryPointByBackupVault  {
    ...
    #[doc(hidden)]pub backup_vault_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub source_backup_vault_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub created_by: std::option::Option<crate::model::RecoveryPointCreator>,
    /// <p>Specifies the IAM role ARN used to create the target recovery point; for example, <code>arn:aws:iam::123456789012:role/S3Access</code>.</p>
    #[doc(hidden)]pub iam_role_arn: std::option::Option<std::string::String>,
    /// <p>A status code specifying the state of the recovery point.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::RecoveryPointStatus>,
    ...
    #[doc(hidden)]pub calculated_lifecycle: std::option::Option<crate::model::CalculatedLifecycle>,
    /// <p>The lifecycle defines when a protected resource is transitioned to cold storage and when it expires. Backup transitions and expires backups automatically according to the lifecycle that you define. </p> 
    /// <p>Backups transitioned to cold storage must be stored in cold storage for a minimum of 90 days. Therefore, the “retention” setting must be 90 days greater than the “transition to cold after days” setting. The “transition to cold after days” setting cannot be changed after a backup has been transitioned to cold. </p> 
    /// <p>Resource types that are able to be transitioned to cold storage are listed in the "Lifecycle to cold storage" section of the <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html#features-by-resource"> Feature availability by resource</a> table. Backup ignores this expression for other resource types.</p>
    #[doc(hidden)]pub lifecycle: std::option::Option<crate::model::Lifecycle>,
    ...
    #[doc(hidden)]pub is_encrypted: bool,
    ...
    #[doc(hidden)]pub last_restore_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct RecoveryPointCreator  {
    ...
    #[doc(hidden)]pub backup_plan_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub backup_plan_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub backup_plan_version: std::option::Option<std::string::String>,
    /// <p>Uniquely identifies a rule used to schedule the backup of a selection of resources.</p>
    #[doc(hidden)]pub backup_rule_id: std::option::Option<std::string::String>,
}
...
pub struct ProtectedResource  {
    ...
    #[doc(hidden)]pub last_backup_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct Framework  {
    ...
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends on the resource type.</p>
    #[doc(hidden)]pub framework_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub number_of_controls: i32,
...
pub struct CopyJob  {
    ...
    #[doc(hidden)]pub copy_job_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub source_recovery_point_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub destination_recovery_point_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::CopyJobState>,
...
impl  std::fmt::Debug for CopyJob  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("destination_backup_vault_arn", &self.destination_backup_vault_arn);
        formatter.field("destination_recovery_point_arn", &self.destination_recovery_point_arn);
        formatter.field("resource_arn", &self.resource_arn);
        formatter.field("creation_date", &self.creation_date);
        formatter.field("completion_date", &self.completion_date);
...
pub struct BackupVaultListMember  {
    ...
    #[doc(hidden)]pub number_of_recovery_points: i64,
    ...
    #[doc(hidden)]pub locked: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub min_retention_days: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub max_retention_days: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub lock_date: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct BackupSelectionsListMember  {
    ...
    #[doc(hidden)]pub selection_id: std::option::Option<std::string::String>,
    /// <p>The display name of a resource selection document.</p>
    #[doc(hidden)]pub selection_name: std::option::Option<std::string::String>,
    /// <p>Uniquely identifies a backup plan.</p>
    #[doc(hidden)]pub backup_plan_id: std::option::Option<std::string::String>,
...
pub struct BackupPlansListMember  {
    ...
    #[doc(hidden)]pub last_execution_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct BackupPlanTemplatesListMember  {
    ...
    #[doc(hidden)]pub backup_plan_template_id: std::option::Option<std::string::String>,
    /// <p>The optional display name of a backup plan template.</p>
    #[doc(hidden)]pub backup_plan_template_name: std::option::Option<std::string::String>,
}
...
pub struct BackupJob  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::BackupJobState>,
    ...
    #[doc(hidden)]pub expected_completion_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub start_by: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub bytes_transferred: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub backup_type: std::option::Option<std::string::String>,
}
impl BackupJob {
    /// <p>The account ID that owns the backup job.</p>
    pub fn account_id(&self) -> std::option::Option<& str> {
...
pub struct BackupSelection  {
    ...
    /// </ul>
    #[doc(hidden)]pub list_of_tags: std::option::Option<std::vec::Vec<crate::model::Condition>>,
    ...
    #[doc(hidden)]pub not_resources: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of conditions that you define to assign resources to your backup plans using tags. For example, <code>"StringEquals": { "ConditionKey": "aws:ResourceTag/CreatedByCryo", "ConditionValue": "true" },</code>. Condition operators are case sensitive.</p> 
    ...
    /// </ul>
    #[doc(hidden)]pub conditions: std::option::Option<crate::model::Conditions>,
}
...
pub mod backup_selection {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>ListOfTags</code> only supports <code>StringEquals</code>. <code>Conditions</code> supports <code>StringEquals</code>, <code>StringLike</code>, <code>StringNotEquals</code>, and <code>StringNotLike</code>. </p> </li> 
        /// </ul>
        pub fn set_list_of_tags(mut self, input: std::option::Option<std::vec::Vec<crate::model::Condition>>) -> Self {
        ...
        /// <li> <p> <code>Conditions</code> supports <code>StringEquals</code>, <code>StringLike</code>, <code>StringNotEquals</code>, and <code>StringNotLike</code>. <code>ListOfTags</code> only supports <code>StringEquals</code>.</p> </li> 
        /// </ul>
        pub fn set_conditions(mut self, input: std::option::Option<crate::model::Conditions>) -> Self {
...
pub struct Conditions  {
    ...
    #[doc(hidden)]pub string_equals: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
    ...
    #[doc(hidden)]pub string_not_equals: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
    ...
    #[doc(hidden)]pub string_like: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
    ...
    #[doc(hidden)]pub string_not_like: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
}
impl Conditions {
    /// <p>Filters the values of your tagged resources for only those resources that you tagged with the same value. Also called "exact matching."</p>
...
pub mod conditions {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) string_equals: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
        pub(crate) string_not_equals: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
        pub(crate) string_like: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
        pub(crate) string_not_like: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>,
    }
    impl Builder {
        ...
        /// <p>Filters the values of your tagged resources for only those resources that you tagged with the same value. Also called "exact matching."</p>
        pub fn set_string_equals(mut self, input: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>) -> Self {
        ...
        /// <p>Filters the values of your tagged resources for only those resources that you tagged that do not have the same value. Also called "negated matching."</p>
        pub fn set_string_not_equals(mut self, input: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>) -> Self {
        ...
        /// <p>Filters the values of your tagged resources for matching tag values with the use of a wildcard character (*) anywhere in the string. For example, "prod*" or "*rod*" matches the tag value "production".</p>
        pub fn set_string_like(mut self, input: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>) -> Self {
        ...
        /// <p>Filters the values of your tagged resources for non-matching tag values with the use of a wildcard character (*) anywhere in the string.</p>
        pub fn set_string_not_like(mut self, input: std::option::Option<std::vec::Vec<crate::model::ConditionParameter>>) -> Self {
...
pub struct ConditionParameter  {
    ...
    #[doc(hidden)]pub condition_key: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub condition_value: std::option::Option<std::string::String>,
}
...
pub struct Condition  {
    ...
    #[doc(hidden)]pub condition_type: std::option::Option<crate::model::ConditionType>,
    /// <p>The key in a key-value pair. For example, in the tag <code>Department: Accounting</code>, <code>Department</code> is the key.</p>
    #[doc(hidden)]pub condition_key: std::option::Option<std::string::String>,
    /// <p>The value in a key-value pair. For example, in the tag <code>Department: Accounting</code>, <code>Accounting</code> is the value.</p>
    #[doc(hidden)]pub condition_value: std::option::Option<std::string::String>,
...
pub mod condition {
    ...
    impl Builder {
        ...
        /// <p>An operation applied to a key-value pair used to assign resources to your backup plan. Condition only supports <code>StringEquals</code>. For more flexible assignment options, including <code>StringLike</code> and the ability to exclude resources from your backup plan, use <code>Conditions</code> (with an "s" on the end) for your <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/API_BackupSelection.html"> <code>BackupSelection</code> </a>.</p>
        pub fn set_condition_type(mut self, input: std::option::Option<crate::model::ConditionType>) -> Self {
...
pub struct BackupPlan  {
    ...
    #[doc(hidden)]pub backup_plan_name: std::option::Option<std::string::String>,
    /// <p>An array of <code>BackupRule</code> objects, each of which specifies a scheduled task that is used to back up a selection of resources. </p>
    #[doc(hidden)]pub rules: std::option::Option<std::vec::Vec<crate::model::BackupRule>>,
...
pub mod backup_plan {
    ...
    impl Builder {
        ...
        /// <p>An array of <code>BackupRule</code> objects, each of which specifies a scheduled task that is used to back up a selection of resources. </p>
        pub fn set_rules(mut self, input: std::option::Option<std::vec::Vec<crate::model::BackupRule>>) -> Self {
            self.rules = input; self
        }
        /// Appends an item to `advanced_backup_settings`.
        ///
