...
pub struct FrameworkControl  {
    ...
    #[doc(hidden)]
    pub control_input_parameters: std::option::Option<std::vec::Vec<crate::model::ControlInputParameter>>,
...
pub struct CopyJob  {
    ...
    #[doc(hidden)]
    pub child_jobs_in_state: std::option::Option<std::collections::HashMap<crate::model::CopyJobState, i64>>,
}
impl CopyJob {
    /// <p>The account ID that owns the copy job.</p>
    pub fn account_id(&self) -> std::option::Option<& str> {
    ...
    /// <p>This returns the statistics of the included child (nested) copy jobs.</p>
    pub fn child_jobs_in_state(&self) -> std::option::Option<& std::collections::HashMap<crate::model::CopyJobState, i64>> {
...
pub mod copy_job {
    ...
    pub struct Builder {
        ...
        pub(crate) child_jobs_in_state: std::option::Option<std::collections::HashMap<crate::model::CopyJobState, i64>>,
    }
    impl Builder {
        /// <p>The account ID that owns the copy job.</p>
        pub fn account_id(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// <p>This returns the statistics of the included child (nested) copy jobs.</p>
        pub fn set_child_jobs_in_state(mut self, input: std::option::Option<std::collections::HashMap<crate::model::CopyJobState, i64>>) -> Self {
...
pub mod recovery_point_selection {
    ...
    impl Builder {
        ...
        /// <p>This is a resource filter containing FromDate: DateTime and ToDate: DateTime. Both values are required. Future DateTime values are not permitted.</p> 
        /// <p>The date and time are in Unix format and Coordinated Universal Time (UTC), and it is accurate to milliseconds ((milliseconds are optional). For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM.</p>
        pub fn set_date_range(mut self, input: std::option::Option<crate::model::DateRange>) -> Self {
