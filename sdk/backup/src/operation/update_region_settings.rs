...
impl UpdateRegionSettingsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_region_settings::ser_update_region_settings_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_region_settings::UpdateRegionSettings::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_region_settings::UpdateRegionSettingsError
{
