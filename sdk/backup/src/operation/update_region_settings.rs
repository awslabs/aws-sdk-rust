...
impl UpdateRegionSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRegionSettings`](crate::operation::update_region_settings::UpdateRegionSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_region_settings::UpdateRegionSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_region_settings::UpdateRegionSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_region_settings::ser_update_region_settings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_region_settings::UpdateRegionSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRegionSettings {
                type Output = std::result::Result<crate::operation::update_region_settings::UpdateRegionSettingsOutput, crate::operation::update_region_settings::UpdateRegionSettingsError>;
