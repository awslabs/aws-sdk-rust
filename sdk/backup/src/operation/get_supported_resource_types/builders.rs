...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_supported_resource_types::GetSupportedResourceTypesOutput,
                    crate::operation::get_supported_resource_types::GetSupportedResourceTypesError,
                > for GetSupportedResourceTypesFluentBuilder
            {
                fn send(
                    self,
...
impl GetSupportedResourceTypesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_supported_resource_types::GetSupportedResourceTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_supported_resource_types::GetSupportedResourceTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_supported_resource_types::GetSupportedResourceTypesOutput, crate::operation::get_supported_resource_types::GetSupportedResourceTypesError, Self> {
