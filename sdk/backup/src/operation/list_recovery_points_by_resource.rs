...
impl ListRecoveryPointsByResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResource,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recovery_points_by_resource::de_list_recovery_points_by_resource_http_response_with_props(
                status, headers, body,
            )
        }
    }
