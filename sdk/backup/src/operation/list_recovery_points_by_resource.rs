...
impl ListRecoveryPointsByResource {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput,
                    ) -> ::std::result::Result<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRecoveryPointsByResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRecoveryPointsByResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRecoveryPointsByResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRecoveryPointsByResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRecoveryPointsByResource")
...
.with_interceptor(ListRecoveryPointsByResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError>::new());
...
#[derive(Debug)]
            struct ListRecoveryPointsByResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRecoveryPointsByResourceResponseDeserializer {
...
#[derive(Debug)]
            struct ListRecoveryPointsByResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRecoveryPointsByResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/resources/{ResourceArn}/recovery-points", ResourceArn = resource_arn).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.managed_by_aws_backup_only {
         {
            query.push_kv("managedByAWSBackupOnly", ::aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListRecoveryPointsByResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRecoveryPointsByResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRecoveryPointsByResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRecoveryPointsByResourceInput>()
                        .ok_or("failed to downcast to ListRecoveryPointsByResourceInput")?;
...
pub enum ListRecoveryPointsByResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRecoveryPointsByResourceError) for what information is available for the error.")]
...
impl ListRecoveryPointsByResourceError {
    /// Creates the `ListRecoveryPointsByResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRecoveryPointsByResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRecoveryPointsByResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_recovery_points_by_resource::_list_recovery_points_by_resource_output::ListRecoveryPointsByResourceOutput;

pub use crate::operation::list_recovery_points_by_resource::_list_recovery_points_by_resource_input::ListRecoveryPointsByResourceInput;

mod _list_recovery_points_by_resource_input;

mod _list_recovery_points_by_resource_output;
