...
impl ListRecoveryPointsByResourceInput {
    /// Consumes the builder and constructs an Operation<[`ListRecoveryPointsByResource`](crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByResource {
                type Output = std::result::Result<crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceOutput, crate::operation::list_recovery_points_by_resource::ListRecoveryPointsByResourceError>;
