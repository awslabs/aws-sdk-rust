...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBackupVaultAccessPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_backup_vault_access_policy::de_put_backup_vault_access_policy_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError
{
