...
/// Orchestration and serialization glue logic for `PutBackupVaultAccessPolicy`.
...
impl PutBackupVaultAccessPolicy {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBackupVaultAccessPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutBackupVaultAccessPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutBackupVaultAccessPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutBackupVaultAccessPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBackupVaultAccessPolicy")
...
.with_interceptor(PutBackupVaultAccessPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError>::new());
...
#[derive(Debug)]
            struct PutBackupVaultAccessPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBackupVaultAccessPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_backup_vault_access_policy::de_put_backup_vault_access_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_backup_vault_access_policy::de_put_backup_vault_access_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutBackupVaultAccessPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBackupVaultAccessPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.backup_vault_name;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_vault_name", "cannot be empty or unset"))?;
    ...
    if backup_vault_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("backup_vault_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/backup-vaults/{BackupVaultName}/access-policy", BackupVaultName = backup_vault_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_backup_vault_access_policy::ser_put_backup_vault_access_policy_input(&input)?);
...
#[derive(Debug)]
            struct PutBackupVaultAccessPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutBackupVaultAccessPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutBackupVaultAccessPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutBackupVaultAccessPolicyInput>()
                        .ok_or("failed to downcast to PutBackupVaultAccessPolicyInput")?;
...
pub enum PutBackupVaultAccessPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutBackupVaultAccessPolicyError) for what information is available for the error.")]
...
impl PutBackupVaultAccessPolicyError {
    /// Creates the `PutBackupVaultAccessPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutBackupVaultAccessPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutBackupVaultAccessPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError {
...
mod _put_backup_vault_access_policy_output;
