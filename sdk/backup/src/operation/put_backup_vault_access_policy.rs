...
impl PutBackupVaultAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutBackupVaultAccessPolicy`](crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_backup_vault_access_policy::ser_put_backup_vault_access_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutBackupVaultAccessPolicy {
                type Output = std::result::Result<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyOutput, crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyError>;
