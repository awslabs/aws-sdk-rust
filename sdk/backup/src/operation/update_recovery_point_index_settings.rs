...
/// Orchestration and serialization glue logic for `UpdateRecoveryPointIndexSettings`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateRecoveryPointIndexSettings;
impl UpdateRecoveryPointIndexSettings {
    /// Creates a new `UpdateRecoveryPointIndexSettings`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_recovery_point_index_settings::UpdateRecoveryPointIndexSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_recovery_point_index_settings::UpdateRecoveryPointIndexSettingsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Backup",
            "rpc.method" = "UpdateRecoveryPointIndexSettings",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRecoveryPointIndexSettings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRecoveryPointIndexSettings");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateRecoveryPointIndexSettingsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateRecoveryPointIndexSettingsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateRecoveryPointIndexSettings")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRecoveryPointIndexSettings")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateRecoveryPointIndexSettingsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateRecoveryPointIndexSettingsEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateRecoveryPointIndexSettingsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRecoveryPointIndexSettingsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateRecoveryPointIndexSettingsInput>() else {
...
#[derive(Debug)]
struct UpdateRecoveryPointIndexSettingsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRecoveryPointIndexSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_recovery_point_index_settings::de_update_recovery_point_index_settings_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_recovery_point_index_settings::de_update_recovery_point_index_settings_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct UpdateRecoveryPointIndexSettingsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRecoveryPointIndexSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_recovery_point_index_settings::UpdateRecoveryPointIndexSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_recovery_point_index_settings::UpdateRecoveryPointIndexSettingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_recovery_point_index_settings::ser_update_recovery_point_index_settings_input(&input)?,
        );
...
#[derive(Debug)]
struct UpdateRecoveryPointIndexSettingsEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRecoveryPointIndexSettingsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateRecoveryPointIndexSettingsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateRecoveryPointIndexSettingsInput>()
            .ok_or("failed to downcast to UpdateRecoveryPointIndexSettingsInput")?;
...
/// Error type for the `UpdateRecoveryPointIndexSettingsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateRecoveryPointIndexSettingsError {
