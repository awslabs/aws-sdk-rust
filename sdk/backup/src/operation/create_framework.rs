...
impl CreateFrameworkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_framework::CreateFramework, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_framework::ser_create_framework_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFramework {
    type Output =
        ::std::result::Result<crate::operation::create_framework::CreateFrameworkOutput, crate::operation::create_framework::CreateFrameworkError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_framework::de_create_framework_http_response_with_props(status, headers, body)
        }
    }
}
