...
impl DisassociateRecoveryPointInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateRecoveryPoint`](crate::operation::disassociate_recovery_point::DisassociateRecoveryPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_recovery_point::DisassociateRecoveryPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_recovery_point::DisassociateRecoveryPointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_recovery_point::DisassociateRecoveryPoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateRecoveryPoint {
                type Output = std::result::Result<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointOutput, crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError>;
