...
/// Orchestration and serialization glue logic for `DisassociateRecoveryPoint`.
...
impl DisassociateRecoveryPoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_recovery_point::DisassociateRecoveryPointInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateRecoveryPoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateRecoveryPoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateRecoveryPointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateRecoveryPointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateRecoveryPoint")
...
.with_interceptor(DisassociateRecoveryPointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError>::new());
...
#[derive(Debug)]
            struct DisassociateRecoveryPointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateRecoveryPointResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_recovery_point::de_disassociate_recovery_point_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disassociate_recovery_point::de_disassociate_recovery_point_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisassociateRecoveryPointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateRecoveryPointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_recovery_point::DisassociateRecoveryPointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_recovery_point::DisassociateRecoveryPointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backup-vaults/{BackupVaultName}/recovery-points/{RecoveryPointArn}/disassociate", BackupVaultName = backup_vault_name, RecoveryPointArn = recovery_point_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DisassociateRecoveryPointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateRecoveryPointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateRecoveryPointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateRecoveryPointInput>()
                        .ok_or("failed to downcast to DisassociateRecoveryPointInput")?;
...
pub enum DisassociateRecoveryPointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateRecoveryPointError) for what information is available for the error.")]
...
impl DisassociateRecoveryPointError {
    /// Creates the `DisassociateRecoveryPointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateRecoveryPointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateRecoveryPointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_recovery_point::DisassociateRecoveryPointError {
...
mod _disassociate_recovery_point_output;
