...
impl GetBackupVaultNotificationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsInput, ::aws_smithy_types::error::operation::BuildError> {
