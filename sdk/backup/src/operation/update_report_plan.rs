...
impl UpdateReportPlanInput {
    /// Consumes the builder and constructs an Operation<[`UpdateReportPlan`](crate::operation::update_report_plan::UpdateReportPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_report_plan::UpdateReportPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_report_plan::UpdateReportPlanInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.report_plan_name;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("report_plan_name", "cannot be empty or unset"))?;
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_report_plan::ser_update_report_plan_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_report_plan::UpdateReportPlan::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateReportPlan {
                type Output = std::result::Result<crate::operation::update_report_plan::UpdateReportPlanOutput, crate::operation::update_report_plan::UpdateReportPlanError>;
