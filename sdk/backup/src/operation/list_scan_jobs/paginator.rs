...
/// Paginator for [`ListScanJobs`](crate::operation::list_scan_jobs::ListScanJobs)
pub struct ListScanJobsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_scan_jobs::builders::ListScanJobsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListScanJobsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `scan_jobs`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_scan_jobs::paginator::ListScanJobsPaginatorItems {
        crate::operation::list_scan_jobs::paginator::ListScanJobsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_scan_jobs::ListScanJobs::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_scan_jobs_output_output_next_token(resp);
...
/// Flattened paginator for `ListScanJobsPaginator`
///
/// This is created with [`.items()`](ListScanJobsPaginator::items)
pub struct ListScanJobsPaginatorItems(ListScanJobsPaginator);

impl ListScanJobsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_scan_jobs_output_output_scan_jobs(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
