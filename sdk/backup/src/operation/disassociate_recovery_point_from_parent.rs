    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateRecoveryPointFromParent {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateRecoveryPointFromParent");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateRecoveryPointFromParentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateRecoveryPointFromParentResponseDeserializer));
...
.with_interceptor(DisassociateRecoveryPointFromParentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError>::new());
...
#[derive(Debug)]
            struct DisassociateRecoveryPointFromParentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateRecoveryPointFromParentResponseDeserializer {
...
#[derive(Debug)]
            struct DisassociateRecoveryPointFromParentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateRecoveryPointFromParentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DisassociateRecoveryPointFromParentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateRecoveryPointFromParentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateRecoveryPointFromParentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateRecoveryPointFromParentInput>()
                        .ok_or("failed to downcast to DisassociateRecoveryPointFromParentInput")?;
...
pub enum DisassociateRecoveryPointFromParentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateRecoveryPointFromParentError) for what information is available for the error.")]
...
impl DisassociateRecoveryPointFromParentError {
    /// Creates the `DisassociateRecoveryPointFromParentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateRecoveryPointFromParentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateRecoveryPointFromParentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError {
