...
impl ListRecoveryPointsByBackupVault {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListRecoveryPointsByBackupVaultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListRecoveryPointsByBackupVaultRequestSerializer {
