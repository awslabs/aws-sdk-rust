...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRecoveryPointsByBackupVault {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListRecoveryPointsByBackupVault", "backup"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRecoveryPointsByBackupVault")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListRecoveryPointsByBackupVaultResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListRecoveryPointsByBackupVaultRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.by_resource_arn {
                    {
                        query.push_kv("resourceArn", &::aws_smithy_http::query::fmt_string(&inner_4));
                    }
                }
                if let ::std::option::Option::Some(inner_5) = &_input.by_resource_type {
                    {
                        query.push_kv("resourceType", &::aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.by_backup_plan_id {
                    {
                        query.push_kv("backupPlanId", &::aws_smithy_http::query::fmt_string(&inner_6));
                    }
                }
                if let ::std::option::Option::Some(inner_7) = &_input.by_created_before {
                    {
                        query.push_kv(
                            "createdBefore",
                ...
                if let ::std::option::Option::Some(inner_8) = &_input.by_created_after {
                    {
                        query.push_kv(
                            "createdAfter",
                ...
                if let ::std::option::Option::Some(inner_9) = &_input.by_parent_recovery_point_arn {
                    {
                        query.push_kv("parentRecoveryPointArn", &::aws_smithy_http::query::fmt_string(&inner_9));
                    }
                }
                ::std::result::Result::Ok(())
            }
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListRecoveryPointsByBackupVaultEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError {
