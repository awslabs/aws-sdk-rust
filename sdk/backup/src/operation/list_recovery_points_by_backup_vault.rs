...
impl ListRecoveryPointsByBackupVaultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVault::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByBackupVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recovery_points_by_backup_vault::de_list_recovery_points_by_backup_vault_http_response_with_props(
                status, headers, body,
            )
        }
    }
