...
impl ListRecoveryPointsByBackupVaultInput {
    /// Consumes the builder and constructs an Operation<[`ListRecoveryPointsByBackupVault`](crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_4) = &_input.by_resource_arn {
                     {
                        query.push_kv("resourceArn", &aws_smithy_http::query::fmt_string(&inner_4));
                    }
                }
                if let Some(inner_5) = &_input.by_resource_type {
                     {
                        query.push_kv("resourceType", &aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                if let Some(inner_6) = &_input.by_backup_plan_id {
                     {
                        query.push_kv("backupPlanId", &aws_smithy_http::query::fmt_string(&inner_6));
                    }
                }
                if let Some(inner_7) = &_input.by_created_before {
                     {
                        query.push_kv("createdBefore", &aws_smithy_http::query::fmt_timestamp(inner_7, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_8) = &_input.by_created_after {
                     {
                        query.push_kv("createdAfter", &aws_smithy_http::query::fmt_timestamp(inner_8, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_9) = &_input.by_parent_recovery_point_arn {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByBackupVault {
                type Output = std::result::Result<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultOutput, crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError>;
