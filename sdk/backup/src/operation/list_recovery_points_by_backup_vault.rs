...
impl ListRecoveryPointsByBackupVault {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput,
                    ) -> ::std::result::Result<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRecoveryPointsByBackupVault {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRecoveryPointsByBackupVault");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRecoveryPointsByBackupVaultRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRecoveryPointsByBackupVaultResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRecoveryPointsByBackupVault")
...
.with_interceptor(ListRecoveryPointsByBackupVaultEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError>::new());
...
#[derive(Debug)]
            struct ListRecoveryPointsByBackupVaultResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRecoveryPointsByBackupVaultResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_recovery_points_by_backup_vault::de_list_recovery_points_by_backup_vault_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListRecoveryPointsByBackupVaultRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRecoveryPointsByBackupVaultRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backup-vaults/{BackupVaultName}/recovery-points", BackupVaultName = backup_vault_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_8) = &_input.by_created_before {
         {
            query.push_kv("createdBefore", &::aws_smithy_http::query::fmt_timestamp(inner_8, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_9) = &_input.by_created_after {
         {
            query.push_kv("createdAfter", &::aws_smithy_http::query::fmt_timestamp(inner_9, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
...
#[derive(Debug)]
            struct ListRecoveryPointsByBackupVaultEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRecoveryPointsByBackupVaultEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRecoveryPointsByBackupVaultEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRecoveryPointsByBackupVaultInput>()
                        .ok_or("failed to downcast to ListRecoveryPointsByBackupVaultInput")?;
...
pub enum ListRecoveryPointsByBackupVaultError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRecoveryPointsByBackupVaultError) for what information is available for the error.")]
...
impl ListRecoveryPointsByBackupVaultError {
    /// Creates the `ListRecoveryPointsByBackupVaultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRecoveryPointsByBackupVaultError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRecoveryPointsByBackupVaultError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_recovery_points_by_backup_vault::ListRecoveryPointsByBackupVaultError {
...
mod _list_recovery_points_by_backup_vault_output;
