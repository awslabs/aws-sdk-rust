...
impl ListReportPlansFluentBuilder  {
    /// Creates a new `ListReportPlans`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_report_plans::ListReportPlansOutput, aws_smithy_http::result::SdkError<crate::operation::list_report_plans::ListReportPlansError>>
                     {
