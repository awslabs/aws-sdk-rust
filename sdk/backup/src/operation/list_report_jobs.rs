...
impl ListReportJobsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_report_jobs::ListReportJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_report_jobs::ListReportJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/audit/report-jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_report_jobs::ListReportJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_1) = &_input.by_report_plan_name {
                     {
                        query.push_kv("ReportPlanName", &aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
                if let Some(inner_2) = &_input.by_creation_before {
                     {
                        query.push_kv("CreationBefore", &aws_smithy_http::query::fmt_timestamp(inner_2, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_3) = &_input.by_creation_after {
                     {
                        query.push_kv("CreationAfter", &aws_smithy_http::query::fmt_timestamp(inner_3, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_4) = &_input.by_status {
                     {
