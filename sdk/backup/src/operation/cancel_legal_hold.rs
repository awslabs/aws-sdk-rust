...
impl CancelLegalHold {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::cancel_legal_hold::CancelLegalHoldError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::cancel_legal_hold::CancelLegalHoldOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Backup", "CancelLegalHold", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Backup.CancelLegalHold",
                "rpc.service" = "Backup",
                "rpc.method" = "CancelLegalHold",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelLegalHold {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CancelLegalHoldRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CancelLegalHoldResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CancelLegalHold")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CancelLegalHold", "Backup"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelLegalHold")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CancelLegalHoldTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CancelLegalHoldTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelLegalHoldTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CancelLegalHoldInput>() else {
        ...
        if requested.should_capture("CancelDescription") {
            if let ::std::option::Option::Some(value) = input.cancel_description.as_deref() {
                captured.insert("CancelDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelLegalHoldResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_cancel_legal_hold::de_cancel_legal_hold_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_cancel_legal_hold::de_cancel_legal_hold_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelLegalHoldRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::cancel_legal_hold::CancelLegalHoldInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::cancel_legal_hold::CancelLegalHoldInput,
            ...
            fn uri_query(
                ...
                let inner_2 = inner_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("cancel_description", "cannot be empty or unset")
                })?;
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field(
                        "cancel_description",
