...
/// Orchestration and serialization glue logic for `ListBackupPlanTemplates`.
...
impl ListBackupPlanTemplates {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListBackupPlanTemplates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListBackupPlanTemplates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListBackupPlanTemplatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListBackupPlanTemplatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListBackupPlanTemplates")
...
.with_interceptor(ListBackupPlanTemplatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError>::new());
...
#[derive(Debug)]
            struct ListBackupPlanTemplatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListBackupPlanTemplatesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_backup_plan_templates::de_list_backup_plan_templates_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_backup_plan_templates::de_list_backup_plan_templates_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListBackupPlanTemplatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListBackupPlanTemplatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/backup/template/plans").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListBackupPlanTemplatesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListBackupPlanTemplatesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListBackupPlanTemplatesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListBackupPlanTemplatesInput>()
                        .ok_or("failed to downcast to ListBackupPlanTemplatesInput")?;
...
pub enum ListBackupPlanTemplatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListBackupPlanTemplatesError) for what information is available for the error.")]
...
impl ListBackupPlanTemplatesError {
    /// Creates the `ListBackupPlanTemplatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListBackupPlanTemplatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListBackupPlanTemplatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError {
