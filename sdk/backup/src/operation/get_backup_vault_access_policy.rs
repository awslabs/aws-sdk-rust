...
impl GetBackupVaultAccessPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyInput,
                    ) -> ::std::result::Result<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBackupVaultAccessPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBackupVaultAccessPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBackupVaultAccessPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBackupVaultAccessPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBackupVaultAccessPolicy")
...
.with_interceptor(GetBackupVaultAccessPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError>::new());
...
#[derive(Debug)]
            struct GetBackupVaultAccessPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBackupVaultAccessPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_backup_vault_access_policy::de_get_backup_vault_access_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_backup_vault_access_policy::de_get_backup_vault_access_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBackupVaultAccessPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBackupVaultAccessPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetBackupVaultAccessPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBackupVaultAccessPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBackupVaultAccessPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBackupVaultAccessPolicyInput>()
                        .ok_or("failed to downcast to GetBackupVaultAccessPolicyInput")?;
...
pub enum GetBackupVaultAccessPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBackupVaultAccessPolicyError) for what information is available for the error.")]
...
impl GetBackupVaultAccessPolicyError {
    /// Creates the `GetBackupVaultAccessPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBackupVaultAccessPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBackupVaultAccessPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_backup_vault_access_policy::_get_backup_vault_access_policy_output::GetBackupVaultAccessPolicyOutput;

pub use crate::operation::get_backup_vault_access_policy::_get_backup_vault_access_policy_input::GetBackupVaultAccessPolicyInput;

mod _get_backup_vault_access_policy_input;

mod _get_backup_vault_access_policy_output;
