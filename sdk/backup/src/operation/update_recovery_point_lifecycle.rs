...
/// Orchestration and serialization glue logic for `UpdateRecoveryPointLifecycle`.
...
impl UpdateRecoveryPointLifecycle {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRecoveryPointLifecycle {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRecoveryPointLifecycle");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateRecoveryPointLifecycleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateRecoveryPointLifecycleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRecoveryPointLifecycle")
...
.with_interceptor(UpdateRecoveryPointLifecycleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>::new());
...
#[derive(Debug)]
            struct UpdateRecoveryPointLifecycleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRecoveryPointLifecycleResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateRecoveryPointLifecycleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRecoveryPointLifecycleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_recovery_point_lifecycle::ser_update_recovery_point_lifecycle_input(&input)?);
...
#[derive(Debug)]
            struct UpdateRecoveryPointLifecycleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRecoveryPointLifecycleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateRecoveryPointLifecycleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateRecoveryPointLifecycleInput>()
                        .ok_or("failed to downcast to UpdateRecoveryPointLifecycleInput")?;
...
pub enum UpdateRecoveryPointLifecycleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateRecoveryPointLifecycleError) for what information is available for the error.")]
...
impl UpdateRecoveryPointLifecycleError {
    /// Creates the `UpdateRecoveryPointLifecycleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRecoveryPointLifecycleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateRecoveryPointLifecycleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError {
...
mod _update_recovery_point_lifecycle_output;
