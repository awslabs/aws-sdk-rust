...
impl UpdateRecoveryPointLifecycleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycle::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecoveryPointLifecycle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_recovery_point_lifecycle::de_update_recovery_point_lifecycle_http_response_with_props(
                status, headers, body,
            )
        }
    }
