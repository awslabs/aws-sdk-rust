...
impl UpdateRecoveryPointLifecycleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRecoveryPointLifecycle`](crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_recovery_point_lifecycle::ser_update_recovery_point_lifecycle_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycle::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRecoveryPointLifecycle {
                type Output = std::result::Result<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleOutput, crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>;
