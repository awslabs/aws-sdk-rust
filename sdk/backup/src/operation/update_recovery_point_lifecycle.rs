...
impl UpdateRecoveryPointLifecycle {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Backup",
            "rpc.method" = "UpdateRecoveryPointLifecycle",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRecoveryPointLifecycle {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateRecoveryPointLifecycleRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateRecoveryPointLifecycleResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateRecoveryPointLifecycle")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRecoveryPointLifecycle")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateRecoveryPointLifecycleTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateRecoveryPointLifecycleTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRecoveryPointLifecycleTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateRecoveryPointLifecycleInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRecoveryPointLifecycleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_recovery_point_lifecycle::de_update_recovery_point_lifecycle_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_recovery_point_lifecycle::de_update_recovery_point_lifecycle_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRecoveryPointLifecycleRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_recovery_point_lifecycle::ser_update_recovery_point_lifecycle_input(&input)?,
        );
