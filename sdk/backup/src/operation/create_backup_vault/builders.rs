...
impl CreateBackupVaultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_backup_vault::CreateBackupVaultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_backup_vault::CreateBackupVaultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_backup_vault::CreateBackupVaultOutput, crate::operation::create_backup_vault::CreateBackupVaultError, Self> {
