...
impl  ListRestoreTestingPlansOutput  {
    ...
    pub fn restore_testing_plans(&self) -> & [crate::types::RestoreTestingPlanForList] {
        use std::ops::Deref; self.restore_testing_plans.deref()
    }
}
...
impl ListRestoreTestingPlansOutputBuilder {
    ...
    pub fn set_restore_testing_plans(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::RestoreTestingPlanForList>>) -> Self {
        self.restore_testing_plans = input; self
    }
    /// <p>This is a returned list of restore testing plans.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_restore_testing_plans::ListRestoreTestingPlansOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_restore_testing_plans::ListRestoreTestingPlansOutput {
                next_token: self.next_token
                ,
                restore_testing_plans: self.restore_testing_plans
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("restore_testing_plans", "restore_testing_plans was not specified but it is required when building ListRestoreTestingPlansOutput")
                    )?
                ,
