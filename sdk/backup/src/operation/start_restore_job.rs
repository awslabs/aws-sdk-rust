...
impl StartRestoreJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_restore_job::StartRestoreJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_restore_job::ser_start_restore_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRestoreJob {
    type Output =
        ::std::result::Result<crate::operation::start_restore_job::StartRestoreJobOutput, crate::operation::start_restore_job::StartRestoreJobError>;
