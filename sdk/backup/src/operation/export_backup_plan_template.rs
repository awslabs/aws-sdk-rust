...
/// Orchestration and serialization glue logic for `ExportBackupPlanTemplate`.
...
impl ExportBackupPlanTemplate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::export_backup_plan_template::ExportBackupPlanTemplateInput,
                    ) -> ::std::result::Result<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ExportBackupPlanTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ExportBackupPlanTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ExportBackupPlanTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ExportBackupPlanTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExportBackupPlanTemplate")
...
.with_interceptor(ExportBackupPlanTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError>::new());
...
#[derive(Debug)]
            struct ExportBackupPlanTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExportBackupPlanTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_export_backup_plan_template::de_export_backup_plan_template_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_export_backup_plan_template::de_export_backup_plan_template_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ExportBackupPlanTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ExportBackupPlanTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::export_backup_plan_template::ExportBackupPlanTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backup/plans/{BackupPlanId}/toTemplate", BackupPlanId = backup_plan_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct ExportBackupPlanTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExportBackupPlanTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ExportBackupPlanTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ExportBackupPlanTemplateInput>()
                        .ok_or("failed to downcast to ExportBackupPlanTemplateInput")?;
...
pub enum ExportBackupPlanTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ExportBackupPlanTemplateError) for what information is available for the error.")]
...
impl ExportBackupPlanTemplateError {
    /// Creates the `ExportBackupPlanTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ExportBackupPlanTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ExportBackupPlanTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError {
...
mod _export_backup_plan_template_output;
