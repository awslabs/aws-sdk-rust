...
impl ExportBackupPlanTemplateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::export_backup_plan_template::ExportBackupPlanTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportBackupPlanTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_backup_plan_template::de_export_backup_plan_template_http_response_with_props(status, headers, body)
        }
    }
}
