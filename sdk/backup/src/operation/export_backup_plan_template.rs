...
impl ExportBackupPlanTemplateInput {
    /// Consumes the builder and constructs an Operation<[`ExportBackupPlanTemplate`](crate::operation::export_backup_plan_template::ExportBackupPlanTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::export_backup_plan_template::ExportBackupPlanTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_backup_plan_template::ExportBackupPlanTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::export_backup_plan_template::ExportBackupPlanTemplate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExportBackupPlanTemplate {
                type Output = std::result::Result<crate::operation::export_backup_plan_template::ExportBackupPlanTemplateOutput, crate::operation::export_backup_plan_template::ExportBackupPlanTemplateError>;
