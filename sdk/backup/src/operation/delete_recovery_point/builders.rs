...
impl DeleteRecoveryPointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_recovery_point::DeleteRecoveryPointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_recovery_point::DeleteRecoveryPointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_recovery_point::DeleteRecoveryPointOutput, crate::operation::delete_recovery_point::DeleteRecoveryPointError, Self> {
