...
impl GetBackupPlanFromTemplateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackupPlanFromTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_backup_plan_from_template::de_get_backup_plan_from_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
