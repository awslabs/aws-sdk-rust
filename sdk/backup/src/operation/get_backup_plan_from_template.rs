...
impl GetBackupPlanFromTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplate::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateError
{
