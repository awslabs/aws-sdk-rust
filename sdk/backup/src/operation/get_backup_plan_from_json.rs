...
/// Orchestration and serialization glue logic for `GetBackupPlanFromJSON`.
...
impl GetBackupPlanFromJSON {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput,
                    ) -> ::std::result::Result<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBackupPlanFromJSON {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBackupPlanFromJSON");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBackupPlanFromJSONRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBackupPlanFromJSONResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBackupPlanFromJSON")
...
.with_interceptor(GetBackupPlanFromJSONEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>::new());
...
#[derive(Debug)]
            struct GetBackupPlanFromJSONResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBackupPlanFromJSONResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_backup_plan_from_json::de_get_backup_plan_from_json_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_backup_plan_from_json::de_get_backup_plan_from_json_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBackupPlanFromJSONRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBackupPlanFromJSONRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/backup/template/json/toPlan").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_backup_plan_from_json::ser_get_backup_plan_from_json_input(&input)?);
...
#[derive(Debug)]
            struct GetBackupPlanFromJSONEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBackupPlanFromJSONEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBackupPlanFromJSONEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBackupPlanFromJsonInput>()
                        .ok_or("failed to downcast to GetBackupPlanFromJsonInput")?;
...
pub enum GetBackupPlanFromJSONError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBackupPlanFromJSONError) for what information is available for the error.")]
...
impl GetBackupPlanFromJSONError {
    /// Creates the `GetBackupPlanFromJSONError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBackupPlanFromJSONError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBackupPlanFromJSONError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError {
...
mod _get_backup_plan_from_json_output;
