    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/backup/template/json/toPlan")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSON::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError
{
