...
impl GetBackupPlanFromJsonInput {
    /// Consumes the builder and constructs an Operation<[`GetBackupPlanFromJSON`](crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSON)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSON, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_backup_plan_from_json::ser_get_backup_plan_from_json_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSON::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetBackupPlanFromJSON {
                type Output = std::result::Result<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonOutput, crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>;
