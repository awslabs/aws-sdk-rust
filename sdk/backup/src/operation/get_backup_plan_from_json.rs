...
impl GetBackupPlanFromJSON {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJSONError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Backup", "GetBackupPlanFromJSON", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Backup.GetBackupPlanFromJSON",
                "rpc.service" = "Backup",
                "rpc.method" = "GetBackupPlanFromJSON",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBackupPlanFromJSON {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetBackupPlanFromJSONRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetBackupPlanFromJSONResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetBackupPlanFromJSON")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBackupPlanFromJSON")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetBackupPlanFromJSONTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetBackupPlanFromJSONTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBackupPlanFromJSONTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetBackupPlanFromJsonInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("BackupPlanTemplateJson") {
            if let ::std::option::Option::Some(value) = input.backup_plan_template_json.as_deref() {
                captured.insert("BackupPlanTemplateJson", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBackupPlanFromJSONResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_backup_plan_from_json::de_get_backup_plan_from_json_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_backup_plan_from_json::de_get_backup_plan_from_json_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBackupPlanFromJSONRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_backup_plan_from_json::GetBackupPlanFromJsonInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_backup_plan_from_json::ser_get_backup_plan_from_json_input(&input)?,
        );
