...
impl ListCopyJobsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::CopyJob, ::aws_smithy_http::result::SdkError<crate::operation::list_copy_jobs::ListCopyJobsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_copy_jobs_output_copy_jobs(page).unwrap_or_default().into_iter())
    }
}
