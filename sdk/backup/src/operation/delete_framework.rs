...
impl DeleteFrameworkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_framework::DeleteFramework, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFramework {
    type Output =
        ::std::result::Result<crate::operation::delete_framework::DeleteFrameworkOutput, crate::operation::delete_framework::DeleteFrameworkError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_framework::de_delete_framework_http_response_with_props(status, headers, body)
        }
    }
}
