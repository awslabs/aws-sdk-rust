...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByLegalHold {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recovery_points_by_legal_hold::de_list_recovery_points_by_legal_hold_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError
{
