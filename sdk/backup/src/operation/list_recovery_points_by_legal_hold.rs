...
impl ListRecoveryPointsByLegalHoldInput {
    /// Consumes the builder and constructs an Operation<[`ListRecoveryPointsByLegalHold`](crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHold)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHold, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHold::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListRecoveryPointsByLegalHold {
                type Output = std::result::Result<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldOutput, crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError>;
