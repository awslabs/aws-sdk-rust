...
/// Orchestration and serialization glue logic for `ListRecoveryPointsByLegalHold`.
...
impl ListRecoveryPointsByLegalHold {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput,
                    ) -> ::std::result::Result<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRecoveryPointsByLegalHold {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRecoveryPointsByLegalHold");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRecoveryPointsByLegalHoldRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRecoveryPointsByLegalHoldResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRecoveryPointsByLegalHold")
...
.with_interceptor(ListRecoveryPointsByLegalHoldEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError>::new());
...
#[derive(Debug)]
            struct ListRecoveryPointsByLegalHoldResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRecoveryPointsByLegalHoldResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_recovery_points_by_legal_hold::de_list_recovery_points_by_legal_hold_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_recovery_points_by_legal_hold::de_list_recovery_points_by_legal_hold_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRecoveryPointsByLegalHoldRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRecoveryPointsByLegalHoldRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.legal_hold_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("legal_hold_id", "cannot be empty or unset"))?;
    ...
    if legal_hold_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("legal_hold_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/legal-holds/{LegalHoldId}/recovery-points", LegalHoldId = legal_hold_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListRecoveryPointsByLegalHoldEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRecoveryPointsByLegalHoldEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRecoveryPointsByLegalHoldEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRecoveryPointsByLegalHoldInput>()
                        .ok_or("failed to downcast to ListRecoveryPointsByLegalHoldInput")?;
...
pub enum ListRecoveryPointsByLegalHoldError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRecoveryPointsByLegalHoldError) for what information is available for the error.")]
...
impl ListRecoveryPointsByLegalHoldError {
    /// Creates the `ListRecoveryPointsByLegalHoldError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRecoveryPointsByLegalHoldError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRecoveryPointsByLegalHoldError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError {
...
mod _list_recovery_points_by_legal_hold_output;
