...
impl CreateBackupSelectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackupSelection`](crate::operation::create_backup_selection::CreateBackupSelection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_backup_selection::CreateBackupSelection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backup_selection::CreateBackupSelectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_backup_selection::ser_create_backup_selection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_backup_selection::CreateBackupSelection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBackupSelection {
                type Output = std::result::Result<crate::operation::create_backup_selection::CreateBackupSelectionOutput, crate::operation::create_backup_selection::CreateBackupSelectionError>;
