...
impl DeleteBackupVaultLockConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackupVaultLockConfiguration`](crate::operation::delete_backup_vault_lock_configuration::DeleteBackupVaultLockConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_backup_vault_lock_configuration::DeleteBackupVaultLockConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backup_vault_lock_configuration::DeleteBackupVaultLockConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupVaultLockConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_backup_vault_lock_configuration::de_delete_backup_vault_lock_configuration_http_response_with_props(status, headers, body)
        }
    }
}
