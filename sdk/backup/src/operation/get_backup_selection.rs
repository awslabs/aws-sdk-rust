...
impl GetBackupSelectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_backup_selection::GetBackupSelection,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackupSelection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_backup_selection::de_get_backup_selection_http_response_with_props(status, headers, body)
        }
    }
}
