...
impl GetBackupSelectionInput {
    /// Consumes the builder and constructs an Operation<[`GetBackupSelection`](crate::operation::get_backup_selection::GetBackupSelection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_backup_selection::GetBackupSelection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backup_selection::GetBackupSelectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                let input_1 = &_input.backup_plan_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("backup_plan_id", "cannot be empty or unset"))?;
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("selection_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_backup_selection::GetBackupSelection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetBackupSelection {
                type Output = std::result::Result<crate::operation::get_backup_selection::GetBackupSelectionOutput, crate::operation::get_backup_selection::GetBackupSelectionError>;
