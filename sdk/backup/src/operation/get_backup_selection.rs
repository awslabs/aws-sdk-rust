...
/// Orchestration and serialization glue logic for `GetBackupSelection`.
...
impl GetBackupSelection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_backup_selection::GetBackupSelectionInput,
                    ) -> ::std::result::Result<crate::operation::get_backup_selection::GetBackupSelectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_backup_selection::GetBackupSelectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_backup_selection::GetBackupSelectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_backup_selection::GetBackupSelectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBackupSelection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBackupSelection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBackupSelectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBackupSelectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBackupSelection")
...
.with_interceptor(GetBackupSelectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_backup_selection::GetBackupSelectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_backup_selection::GetBackupSelectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_backup_selection::GetBackupSelectionError>::new());
...
#[derive(Debug)]
            struct GetBackupSelectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBackupSelectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_backup_selection::de_get_backup_selection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_backup_selection::de_get_backup_selection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBackupSelectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBackupSelectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_backup_selection::GetBackupSelectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_backup_selection::GetBackupSelectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.backup_plan_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_plan_id", "cannot be empty or unset"))?;
    ...
    if backup_plan_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("backup_plan_id", "cannot be empty or unset"))
                }
    let input_2 = &_input.selection_id;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("selection_id", "cannot be empty or unset"))?;
    let selection_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if selection_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("selection_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/backup/plans/{BackupPlanId}/selections/{SelectionId}", BackupPlanId = backup_plan_id, SelectionId = selection_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetBackupSelectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBackupSelectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBackupSelectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBackupSelectionInput>()
                        .ok_or("failed to downcast to GetBackupSelectionInput")?;
...
pub enum GetBackupSelectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBackupSelectionError) for what information is available for the error.")]
...
impl GetBackupSelectionError {
    /// Creates the `GetBackupSelectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBackupSelectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBackupSelectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_backup_selection::GetBackupSelectionError {
...
mod _get_backup_selection_output;
