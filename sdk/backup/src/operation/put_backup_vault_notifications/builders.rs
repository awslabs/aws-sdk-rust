...
impl crate::operation::put_backup_vault_notifications::builders::PutBackupVaultNotificationsInputBuilder {
...
impl PutBackupVaultNotificationsFluentBuilder {
    /// Creates a new `PutBackupVaultNotificationsFluentBuilder`.
