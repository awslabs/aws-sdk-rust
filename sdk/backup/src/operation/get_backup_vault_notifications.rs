...
impl GetBackupVaultNotificationsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_backup_vault_notifications::GetBackupVaultNotifications::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsError
{
