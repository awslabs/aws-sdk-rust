...
impl DescribeBackupJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_backup_job::DescribeBackupJobInput,
                    ) -> ::std::result::Result<crate::operation::describe_backup_job::DescribeBackupJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_backup_job::DescribeBackupJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_backup_job::DescribeBackupJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_backup_job::DescribeBackupJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBackupJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeBackupJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeBackupJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeBackupJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBackupJob")
...
.with_interceptor(DescribeBackupJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_backup_job::DescribeBackupJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_backup_job::DescribeBackupJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_backup_job::DescribeBackupJobError>::new());
...
#[derive(Debug)]
            struct DescribeBackupJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBackupJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_backup_job::de_describe_backup_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_backup_job::de_describe_backup_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeBackupJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBackupJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_backup_job::DescribeBackupJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_backup_job::DescribeBackupJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.backup_job_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("backup_job_id", "cannot be empty or unset"))?;
    ...
    if backup_job_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("backup_job_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/backup-jobs/{BackupJobId}", BackupJobId = backup_job_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeBackupJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeBackupJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeBackupJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeBackupJobInput>()
                        .ok_or("failed to downcast to DescribeBackupJobInput")?;
...
pub enum DescribeBackupJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeBackupJobError) for what information is available for the error.")]
...
impl DescribeBackupJobError {
    /// Creates the `DescribeBackupJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeBackupJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeBackupJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_backup_job::DescribeBackupJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_backup_job::_describe_backup_job_output::DescribeBackupJobOutput;

pub use crate::operation::describe_backup_job::_describe_backup_job_input::DescribeBackupJobInput;

mod _describe_backup_job_input;

mod _describe_backup_job_output;
