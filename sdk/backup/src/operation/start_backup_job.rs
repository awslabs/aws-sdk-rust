...
impl StartBackupJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_backup_job::StartBackupJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_backup_job::ser_start_backup_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartBackupJob {
    type Output =
        ::std::result::Result<crate::operation::start_backup_job::StartBackupJobOutput, crate::operation::start_backup_job::StartBackupJobError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_backup_job::de_start_backup_job_http_response_with_props(status, headers, body)
        }
    }
}
