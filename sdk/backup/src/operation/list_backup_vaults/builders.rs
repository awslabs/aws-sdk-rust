...
impl ListBackupVaultsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_backup_vaults::ListBackupVaultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError, Self> {
