...
impl ListProtectedResourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListProtectedResources`](crate::operation::list_protected_resources::ListProtectedResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_protected_resources::ListProtectedResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_protected_resources::ListProtectedResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/resources").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_protected_resources::ListProtectedResourcesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_protected_resources::ListProtectedResources::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListProtectedResources {
                type Output = std::result::Result<crate::operation::list_protected_resources::ListProtectedResourcesOutput, crate::operation::list_protected_resources::ListProtectedResourcesError>;
