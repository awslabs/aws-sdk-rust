...
impl ListRestoreJobs {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_restore_jobs::ListRestoreJobsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_restore_jobs::ListRestoreJobsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Backup", "ListRestoreJobs", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Backup.ListRestoreJobs",
                "rpc.service" = "Backup",
                "rpc.method" = "ListRestoreJobs",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRestoreJobs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListRestoreJobsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListRestoreJobsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListRestoreJobs")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListRestoreJobs", "Backup"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRestoreJobs")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListRestoreJobsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListRestoreJobsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRestoreJobsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListRestoreJobsInput>() else {
        ...
        if requested.should_capture("ByRestoreTestingPlanArn") {
            if let ::std::option::Option::Some(value) = input.by_restore_testing_plan_arn.as_deref() {
                captured.insert("ByRestoreTestingPlanArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRestoreJobsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_restore_jobs::de_list_restore_jobs_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_restore_jobs::de_list_restore_jobs_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRestoreJobsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_restore_jobs::ListRestoreJobsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_restore_jobs::ListRestoreJobsInput,
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_11) = &_input.by_parent_job_id {
                    {
                        query.push_kv("parentJobId", &::aws_smithy_http::query::fmt_string(inner_11));
                    }
                }
                ::std::result::Result::Ok(())
            }
