...
impl ListLegalHoldsInput {
    /// Consumes the builder and constructs an Operation<[`ListLegalHolds`](crate::operation::list_legal_holds::ListLegalHolds)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_legal_holds::ListLegalHolds, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_legal_holds::ListLegalHoldsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/legal-holds").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_legal_holds::ListLegalHoldsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_legal_holds::ListLegalHolds::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListLegalHolds {
                type Output = std::result::Result<crate::operation::list_legal_holds::ListLegalHoldsOutput, crate::operation::list_legal_holds::ListLegalHoldsError>;
