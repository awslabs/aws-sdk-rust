...
impl ListLegalHoldsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_legal_holds::ListLegalHolds, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLegalHolds {
    type Output =
        ::std::result::Result<crate::operation::list_legal_holds::ListLegalHoldsOutput, crate::operation::list_legal_holds::ListLegalHoldsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_legal_holds::de_list_legal_holds_http_response_with_props(status, headers, body)
        }
    }
}
