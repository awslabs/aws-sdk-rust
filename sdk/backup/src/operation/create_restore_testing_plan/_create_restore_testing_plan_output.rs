...
impl CreateRestoreTestingPlanOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_restore_testing_plan::CreateRestoreTestingPlanOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_restore_testing_plan::CreateRestoreTestingPlanOutput {
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building CreateRestoreTestingPlanOutput")
                    )?
                ,
                restore_testing_plan_arn: self.restore_testing_plan_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("restore_testing_plan_arn", "restore_testing_plan_arn was not specified but it is required when building CreateRestoreTestingPlanOutput")
                    )?
                ,
                restore_testing_plan_name: self.restore_testing_plan_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("restore_testing_plan_name", "restore_testing_plan_name was not specified but it is required when building CreateRestoreTestingPlanOutput")
                    )?
                ,
