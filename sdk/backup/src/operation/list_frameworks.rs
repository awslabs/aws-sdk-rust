...
impl ListFrameworksInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_frameworks::ListFrameworks::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListFrameworks {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_frameworks::de_list_frameworks_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_frameworks::de_list_frameworks_http_response(
                status, headers, body,
            )
        }
    }
