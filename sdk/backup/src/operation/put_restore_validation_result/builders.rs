...
impl PutRestoreValidationResultFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_restore_validation_result::PutRestoreValidationResultOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_restore_validation_result::PutRestoreValidationResultError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_restore_validation_result::PutRestoreValidationResultOutput, crate::operation::put_restore_validation_result::PutRestoreValidationResultError, Self> {
