...
impl PutBackupVaultNotificationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_backup_vault_notifications::PutBackupVaultNotifications::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBackupVaultNotifications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_backup_vault_notifications::de_put_backup_vault_notifications_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PutBackupVaultNotificationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError
{
