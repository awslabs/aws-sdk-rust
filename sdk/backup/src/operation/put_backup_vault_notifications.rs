...
impl PutBackupVaultNotificationsInput {
    /// Consumes the builder and constructs an Operation<[`PutBackupVaultNotifications`](crate::operation::put_backup_vault_notifications::PutBackupVaultNotifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_backup_vault_notifications::PutBackupVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_backup_vault_notifications::ser_put_backup_vault_notifications_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_backup_vault_notifications::PutBackupVaultNotifications::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutBackupVaultNotifications {
                type Output = std::result::Result<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsOutput, crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError>;
