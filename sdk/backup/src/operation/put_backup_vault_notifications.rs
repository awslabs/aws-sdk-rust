...
/// Orchestration and serialization glue logic for `PutBackupVaultNotifications`.
...
impl PutBackupVaultNotifications {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsInput,
                    ) -> ::std::result::Result<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBackupVaultNotifications {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutBackupVaultNotifications");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutBackupVaultNotificationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutBackupVaultNotificationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBackupVaultNotifications")
...
.with_interceptor(PutBackupVaultNotificationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError>::new());
...
#[derive(Debug)]
            struct PutBackupVaultNotificationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBackupVaultNotificationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_backup_vault_notifications::de_put_backup_vault_notifications_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutBackupVaultNotificationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBackupVaultNotificationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/backup-vaults/{BackupVaultName}/notification-configuration", BackupVaultName = backup_vault_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_backup_vault_notifications::ser_put_backup_vault_notifications_input(&input)?);
...
#[derive(Debug)]
            struct PutBackupVaultNotificationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutBackupVaultNotificationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutBackupVaultNotificationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutBackupVaultNotificationsInput>()
                        .ok_or("failed to downcast to PutBackupVaultNotificationsInput")?;
...
pub enum PutBackupVaultNotificationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutBackupVaultNotificationsError) for what information is available for the error.")]
...
impl PutBackupVaultNotificationsError {
    /// Creates the `PutBackupVaultNotificationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutBackupVaultNotificationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutBackupVaultNotificationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::put_backup_vault_notifications::_put_backup_vault_notifications_output::PutBackupVaultNotificationsOutput;

pub use crate::operation::put_backup_vault_notifications::_put_backup_vault_notifications_input::PutBackupVaultNotificationsInput;

mod _put_backup_vault_notifications_input;

mod _put_backup_vault_notifications_output;
