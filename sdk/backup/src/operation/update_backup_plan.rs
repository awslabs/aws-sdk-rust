...
impl UpdateBackupPlanInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_backup_plan::UpdateBackupPlan,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_backup_plan::ser_update_backup_plan_input(&self)?);
