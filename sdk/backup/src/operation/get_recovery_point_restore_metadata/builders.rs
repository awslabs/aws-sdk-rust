...
impl crate::operation::get_recovery_point_restore_metadata::builders::GetRecoveryPointRestoreMetadataInputBuilder {
...
impl GetRecoveryPointRestoreMetadataFluentBuilder {
    /// Creates a new `GetRecoveryPointRestoreMetadataFluentBuilder`.
