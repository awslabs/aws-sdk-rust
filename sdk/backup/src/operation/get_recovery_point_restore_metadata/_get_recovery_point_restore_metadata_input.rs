...
impl GetRecoveryPointRestoreMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_recovery_point_restore_metadata::GetRecoveryPointRestoreMetadataInput, ::aws_smithy_types::error::operation::BuildError> {
