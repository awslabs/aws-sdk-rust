...
impl DeleteBackupPlanInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackupPlan`](crate::operation::delete_backup_plan::DeleteBackupPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_backup_plan::DeleteBackupPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backup_plan::DeleteBackupPlanInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backup_plan::DeleteBackupPlan::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBackupPlan {
                type Output = std::result::Result<crate::operation::delete_backup_plan::DeleteBackupPlanOutput, crate::operation::delete_backup_plan::DeleteBackupPlanError>;
