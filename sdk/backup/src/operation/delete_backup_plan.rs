...
impl DeleteBackupPlanInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_backup_plan::DeleteBackupPlan::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_backup_plan::de_delete_backup_plan_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_backup_plan::DeleteBackupPlanError
{
