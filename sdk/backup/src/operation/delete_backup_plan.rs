...
impl DeleteBackupPlanInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_backup_plan::DeleteBackupPlan,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupPlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_backup_plan::de_delete_backup_plan_http_response_with_props(status, headers, body)
        }
    }
}
