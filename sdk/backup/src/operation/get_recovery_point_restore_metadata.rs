...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetRecoveryPointRestoreMetadataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetRecoveryPointRestoreMetadataRequestSerializer {
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("recovery_point_arn", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetRecoveryPointRestoreMetadataEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_recovery_point_restore_metadata::GetRecoveryPointRestoreMetadataError {
