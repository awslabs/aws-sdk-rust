...
impl GetRecoveryPointRestoreMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_recovery_point_restore_metadata::GetRecoveryPointRestoreMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRecoveryPointRestoreMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_recovery_point_restore_metadata::de_get_recovery_point_restore_metadata_http_response_with_props(
                status, headers, body,
            )
        }
    }
