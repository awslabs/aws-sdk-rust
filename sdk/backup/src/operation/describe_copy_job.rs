    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/copy-jobs/{CopyJobId}", CopyJobId = copy_job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_copy_job::DescribeCopyJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_copy_job::DescribeCopyJobError
{
