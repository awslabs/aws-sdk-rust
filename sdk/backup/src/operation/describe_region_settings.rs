...
impl DescribeRegionSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_region_settings::DescribeRegionSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRegionSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_region_settings::de_describe_region_settings_http_response_with_props(status, headers, body)
        }
    }
}
