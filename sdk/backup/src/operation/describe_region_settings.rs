...
impl DescribeRegionSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRegionSettings`](crate::operation::describe_region_settings::DescribeRegionSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_region_settings::DescribeRegionSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_region_settings::DescribeRegionSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_region_settings::DescribeRegionSettings::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRegionSettings {
                type Output = std::result::Result<crate::operation::describe_region_settings::DescribeRegionSettingsOutput, crate::operation::describe_region_settings::DescribeRegionSettingsError>;
