...
/// Orchestration and serialization glue logic for `GetLegalHold`.
...
impl GetLegalHold {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_legal_hold::GetLegalHoldInput,
                    ) -> ::std::result::Result<crate::operation::get_legal_hold::GetLegalHoldOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_legal_hold::GetLegalHoldError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_legal_hold::GetLegalHoldError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_legal_hold::GetLegalHoldOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLegalHold {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLegalHold");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLegalHoldRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLegalHoldResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLegalHold")
...
.with_interceptor(GetLegalHoldEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_legal_hold::GetLegalHoldError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_legal_hold::GetLegalHoldError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_legal_hold::GetLegalHoldError>::new());
...
#[derive(Debug)]
            struct GetLegalHoldResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLegalHoldResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_legal_hold::de_get_legal_hold_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_legal_hold::de_get_legal_hold_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetLegalHoldRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLegalHoldRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_legal_hold::GetLegalHoldInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_legal_hold::GetLegalHoldInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/legal-holds/{LegalHoldId}", LegalHoldId = legal_hold_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetLegalHoldEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLegalHoldEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLegalHoldEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLegalHoldInput>()
                        .ok_or("failed to downcast to GetLegalHoldInput")?;
...
pub enum GetLegalHoldError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLegalHoldError) for what information is available for the error.")]
...
impl GetLegalHoldError {
    /// Creates the `GetLegalHoldError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLegalHoldError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLegalHoldError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_legal_hold::GetLegalHoldError {
