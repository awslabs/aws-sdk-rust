...
impl ListBackupVaultsInput {
    /// Consumes the builder and constructs an Operation<[`ListBackupVaults`](crate::operation::list_backup_vaults::ListBackupVaults)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_backup_vaults::ListBackupVaults, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_backup_vaults::ListBackupVaultsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/backup-vaults").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_backup_vaults::ListBackupVaultsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_backup_vaults::ListBackupVaults::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListBackupVaults {
                type Output = std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError>;
