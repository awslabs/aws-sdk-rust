...
impl ListBackupVaultsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_backup_vaults::ListBackupVaults,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBackupVaults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_backup_vaults::de_list_backup_vaults_http_response_with_props(status, headers, body)
        }
    }
}
