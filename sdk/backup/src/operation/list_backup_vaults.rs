...
impl ListBackupVaultsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_backup_vaults::ListBackupVaults::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBackupVaults {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_backup_vaults::de_list_backup_vaults_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_backup_vaults::ListBackupVaultsError
{
