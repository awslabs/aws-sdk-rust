...
impl DescribeRecoveryPointFluentBuilder  {
    /// Creates a new `DescribeRecoveryPoint`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_recovery_point::DescribeRecoveryPointOutput, aws_smithy_http::result::SdkError<crate::operation::describe_recovery_point::DescribeRecoveryPointError>>
                     {
