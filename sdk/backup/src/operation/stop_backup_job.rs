...
impl StopBackupJobInput {
    /// Consumes the builder and constructs an Operation<[`StopBackupJob`](crate::operation::stop_backup_job::StopBackupJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_backup_job::StopBackupJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_backup_job::StopBackupJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_backup_job::StopBackupJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopBackupJob {
                type Output = std::result::Result<crate::operation::stop_backup_job::StopBackupJobOutput, crate::operation::stop_backup_job::StopBackupJobError>;
