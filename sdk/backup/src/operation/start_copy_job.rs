...
impl StartCopyJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_copy_job::StartCopyJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_copy_job::StartCopyJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCopyJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_copy_job::de_start_copy_job_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_copy_job::de_start_copy_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
