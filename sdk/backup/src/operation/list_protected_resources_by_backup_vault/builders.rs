...
impl ListProtectedResourcesByBackupVaultFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_protected_resources_by_backup_vault::paginator::ListProtectedResourcesByBackupVaultPaginator::send) which returns a `Stream`.
