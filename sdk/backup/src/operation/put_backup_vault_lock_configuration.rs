...
impl PutBackupVaultLockConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBackupVaultLockConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_backup_vault_lock_configuration::de_put_backup_vault_lock_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
