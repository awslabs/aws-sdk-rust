...
impl PutBackupVaultLockConfiguration {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBackupVaultLockConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutBackupVaultLockConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutBackupVaultLockConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutBackupVaultLockConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBackupVaultLockConfiguration")
...
.with_interceptor(PutBackupVaultLockConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError>::new());
...
#[derive(Debug)]
            struct PutBackupVaultLockConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutBackupVaultLockConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_backup_vault_lock_configuration::de_put_backup_vault_lock_configuration_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutBackupVaultLockConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutBackupVaultLockConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_backup_vault_lock_configuration::ser_put_backup_vault_lock_configuration_input(&input)?);
...
#[derive(Debug)]
            struct PutBackupVaultLockConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutBackupVaultLockConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutBackupVaultLockConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutBackupVaultLockConfigurationInput>()
                        .ok_or("failed to downcast to PutBackupVaultLockConfigurationInput")?;
...
pub enum PutBackupVaultLockConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutBackupVaultLockConfigurationError) for what information is available for the error.")]
...
impl PutBackupVaultLockConfigurationError {
    /// Creates the `PutBackupVaultLockConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutBackupVaultLockConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutBackupVaultLockConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_backup_vault_lock_configuration::PutBackupVaultLockConfigurationError {
...
mod _put_backup_vault_lock_configuration_output;
