...
impl DescribeBackupVaultInput {
    /// Consumes the builder and constructs an Operation<[`DescribeBackupVault`](crate::operation::describe_backup_vault::DescribeBackupVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_backup_vault::DescribeBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_backup_vault::DescribeBackupVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_backup_vault::DescribeBackupVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeBackupVault {
                type Output = std::result::Result<crate::operation::describe_backup_vault::DescribeBackupVaultOutput, crate::operation::describe_backup_vault::DescribeBackupVaultError>;
