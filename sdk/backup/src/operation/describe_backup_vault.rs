...
impl DescribeBackupVaultInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_backup_vault::DescribeBackupVault,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBackupVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_backup_vault::de_describe_backup_vault_http_response_with_props(status, headers, body)
        }
    }
}
