...
impl DescribeRecoveryPoint {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_recovery_point::DescribeRecoveryPointError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_recovery_point::DescribeRecoveryPointOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Backup", "DescribeRecoveryPoint", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Backup.DescribeRecoveryPoint",
                "rpc.service" = "Backup",
                "rpc.method" = "DescribeRecoveryPoint",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeRecoveryPoint {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeRecoveryPointRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeRecoveryPointResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeRecoveryPoint")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribeRecoveryPointTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeRecoveryPointTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeRecoveryPointTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeRecoveryPointInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRecoveryPointResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_recovery_point::de_describe_recovery_point_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_recovery_point::de_describe_recovery_point_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRecoveryPointRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_recovery_point::DescribeRecoveryPointInput>()
            .expect("correct type");
