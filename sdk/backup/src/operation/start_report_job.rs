...
impl StartReportJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_report_job::StartReportJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_report_job::ser_start_report_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_report_job::de_start_report_job_http_response_with_props(status, headers, body)
        }
    }
}
