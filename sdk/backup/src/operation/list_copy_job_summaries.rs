...
/// Orchestration and serialization glue logic for `ListCopyJobSummaries`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListCopyJobSummaries;
impl ListCopyJobSummaries {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_copy_job_summaries::ListCopyJobSummariesInput,
                    ) -> ::std::result::Result<crate::operation::list_copy_job_summaries::ListCopyJobSummariesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_copy_job_summaries::ListCopyJobSummariesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCopyJobSummaries {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCopyJobSummaries");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCopyJobSummariesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCopyJobSummariesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListCopyJobSummaries")
...
.with_interceptor(ListCopyJobSummariesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesError>::new());
...
#[derive(Debug)]
            struct ListCopyJobSummariesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCopyJobSummariesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_copy_job_summaries::de_list_copy_job_summaries_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_copy_job_summaries::de_list_copy_job_summaries_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListCopyJobSummariesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCopyJobSummariesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_copy_job_summaries::ListCopyJobSummariesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_copy_job_summaries::ListCopyJobSummariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/audit/copy-job-summaries").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_copy_job_summaries::ListCopyJobSummariesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListCopyJobSummariesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCopyJobSummariesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListCopyJobSummariesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCopyJobSummariesInput>()
                        .ok_or("failed to downcast to ListCopyJobSummariesInput")?;
...
/// Error type for the `ListCopyJobSummariesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListCopyJobSummariesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCopyJobSummariesError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListCopyJobSummariesError {
    /// Creates the `ListCopyJobSummariesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCopyJobSummariesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListCopyJobSummariesError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ListCopyJobSummariesError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
}
impl ::std::error::Error for ListCopyJobSummariesError {
...
impl ::std::fmt::Display for ListCopyJobSummariesError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListCopyJobSummariesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCopyJobSummariesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCopyJobSummariesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_copy_job_summaries::ListCopyJobSummariesError {
...
mod _list_copy_job_summaries_output;
