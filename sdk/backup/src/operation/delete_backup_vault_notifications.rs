...
impl DeleteBackupVaultNotificationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotifications,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_backup_vault_notifications::DeleteBackupVaultNotifications::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupVaultNotifications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_backup_vault_notifications::de_delete_backup_vault_notifications_http_response_with_props(
                status, headers, body,
            )
        }
    }
