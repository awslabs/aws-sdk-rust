...
impl ListBackupPlansInput {
    /// Consumes the builder and constructs an Operation<[`ListBackupPlans`](crate::operation::list_backup_plans::ListBackupPlans)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_backup_plans::ListBackupPlans, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_backup_plans::ListBackupPlansInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/backup/plans").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_backup_plans::ListBackupPlansInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.include_deleted {
                    if *inner_3 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_backup_plans::ListBackupPlans::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListBackupPlans {
                type Output = std::result::Result<crate::operation::list_backup_plans::ListBackupPlansOutput, crate::operation::list_backup_plans::ListBackupPlansError>;
