...
pub use crate::operation::list_backup_plan_templates::_list_backup_plan_templates_output::ListBackupPlanTemplatesOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesOutput,
                    crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError,
                > for ListBackupPlanTemplatesFluentBuilder
            {
                fn send(
                    self,
...
impl ListBackupPlanTemplatesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_backup_plan_templates::ListBackupPlanTemplates::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesOutput, crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_backup_plan_templates::paginator::ListBackupPlanTemplatesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
