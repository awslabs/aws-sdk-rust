...
impl ListBackupPlanTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_backup_plan_templates::ListBackupPlanTemplatesInput, ::aws_smithy_types::error::operation::BuildError> {
