...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_backup_plan::DeleteBackupPlanOutput,
                    crate::operation::delete_backup_plan::DeleteBackupPlanError,
                > for DeleteBackupPlanFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteBackupPlanFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_backup_plan::builders::DeleteBackupPlanInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_backup_plan::DeleteBackupPlanOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_backup_plan::DeleteBackupPlanError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::delete_backup_plan::DeleteBackupPlan::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_backup_plan::DeleteBackupPlanOutput, crate::operation::delete_backup_plan::DeleteBackupPlanError, Self> {
