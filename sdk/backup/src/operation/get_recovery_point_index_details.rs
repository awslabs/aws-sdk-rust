...
/// Orchestration and serialization glue logic for `GetRecoveryPointIndexDetails`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetRecoveryPointIndexDetails;
impl GetRecoveryPointIndexDetails {
    /// Creates a new `GetRecoveryPointIndexDetails`
    pub fn new() -> Self {
        Self
    }
    pub(crate) async fn orchestrate(
        runtime_plugins: &::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins,
        input: crate::operation::get_recovery_point_index_details::GetRecoveryPointIndexDetailsInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_recovery_point_index_details::GetRecoveryPointIndexDetailsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_recovery_point_index_details::GetRecoveryPointIndexDetailsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Backup",
            "rpc.method" = "GetRecoveryPointIndexDetails",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRecoveryPointIndexDetails {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRecoveryPointIndexDetails");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRecoveryPointIndexDetailsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRecoveryPointIndexDetailsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRecoveryPointIndexDetails")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRecoveryPointIndexDetails")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRecoveryPointIndexDetailsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRecoveryPointIndexDetailsEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct GetRecoveryPointIndexDetailsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRecoveryPointIndexDetailsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRecoveryPointIndexDetailsInput>() else {
...
#[derive(Debug)]
struct GetRecoveryPointIndexDetailsResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRecoveryPointIndexDetailsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_recovery_point_index_details::de_get_recovery_point_index_details_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_get_recovery_point_index_details::de_get_recovery_point_index_details_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct GetRecoveryPointIndexDetailsRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRecoveryPointIndexDetailsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_recovery_point_index_details::GetRecoveryPointIndexDetailsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_recovery_point_index_details::GetRecoveryPointIndexDetailsInput,
...
#[derive(Debug)]
struct GetRecoveryPointIndexDetailsEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRecoveryPointIndexDetailsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "GetRecoveryPointIndexDetailsEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetRecoveryPointIndexDetailsInput>()
            .ok_or("failed to downcast to GetRecoveryPointIndexDetailsInput")?;
...
/// Error type for the `GetRecoveryPointIndexDetailsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetRecoveryPointIndexDetailsError {
