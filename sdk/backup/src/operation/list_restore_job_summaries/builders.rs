...
pub use crate::operation::list_restore_job_summaries::_list_restore_job_summaries_output::ListRestoreJobSummariesOutputBuilder;

pub use crate::operation::list_restore_job_summaries::_list_restore_job_summaries_input::ListRestoreJobSummariesInputBuilder;
...
impl ListRestoreJobSummariesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_restore_job_summaries();
...
pub struct ListRestoreJobSummariesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_restore_job_summaries::builders::ListRestoreJobSummariesInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_restore_job_summaries::ListRestoreJobSummariesOutput,
                    crate::operation::list_restore_job_summaries::ListRestoreJobSummariesError,
                > for ListRestoreJobSummariesFluentBuilder
            {
                fn send(
                    self,
...
impl ListRestoreJobSummariesFluentBuilder {
    /// Creates a new `ListRestoreJobSummaries`.
    ...
    /// Access the ListRestoreJobSummaries as a reference.
    pub fn as_input(&self) -> &crate::operation::list_restore_job_summaries::builders::ListRestoreJobSummariesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_restore_job_summaries::ListRestoreJobSummariesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_restore_job_summaries::ListRestoreJobSummariesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_restore_job_summaries::ListRestoreJobSummaries::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_restore_job_summaries::ListRestoreJobSummaries::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_restore_job_summaries::ListRestoreJobSummariesOutput, crate::operation::list_restore_job_summaries::ListRestoreJobSummariesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_restore_job_summaries::paginator::ListRestoreJobSummariesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_restore_job_summaries::paginator::ListRestoreJobSummariesPaginator {
                                crate::operation::list_restore_job_summaries::paginator::ListRestoreJobSummariesPaginator::new(self.handle, self.inner)
                            }
