...
impl GetSupportedResourceTypesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_supported_resource_types::GetSupportedResourceTypes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSupportedResourceTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_supported_resource_types::de_get_supported_resource_types_http_response_with_props(status, headers, body)
        }
    }
}
