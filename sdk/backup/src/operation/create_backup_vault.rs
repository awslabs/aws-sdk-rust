...
impl CreateBackupVaultInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_backup_vault::CreateBackupVault::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackupVault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_backup_vault::de_create_backup_vault_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_backup_vault::CreateBackupVaultError
{
