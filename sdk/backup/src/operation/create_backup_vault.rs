...
impl CreateBackupVaultInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackupVault`](crate::operation::create_backup_vault::CreateBackupVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_backup_vault::CreateBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backup_vault::CreateBackupVaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_backup_vault::ser_create_backup_vault_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_backup_vault::CreateBackupVault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBackupVault {
                type Output = std::result::Result<crate::operation::create_backup_vault::CreateBackupVaultOutput, crate::operation::create_backup_vault::CreateBackupVaultError>;
