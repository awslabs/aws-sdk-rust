...
impl ::std::convert::From<&str> for ScanMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "INCREMENTAL_SCAN" => ScanMode::IncrementalScan,
...
impl ScanMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ScanMode::FullScan => "FULL_SCAN",
            ScanMode::IncrementalScan => "INCREMENTAL_SCAN",
...
impl ::std::fmt::Display for ScanMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ScanMode::FullScan => write!(f, "FULL_SCAN"),
            ScanMode::IncrementalScan => write!(f, "INCREMENTAL_SCAN"),
