...
impl  BackupRuleInput  {
    ...
    pub fn target_backup_vault_name(&self) -> & str {
        use std::ops::Deref; self.target_backup_vault_name.deref()
    }
    /// <p>A CRON expression in UTC specifying when Backup initiates a backup job.</p>
...
impl BackupRuleInputBuilder {
    ...
    ///
    /// <p>To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair.</p>
    pub fn recovery_point_tags(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
        ...
        ::std::result::Result::Ok(
            crate::types::BackupRuleInput {
                rule_name: self.rule_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("rule_name", "rule_name was not specified but it is required when building BackupRuleInput")
                    )?
                ,
                target_backup_vault_name: self.target_backup_vault_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("target_backup_vault_name", "target_backup_vault_name was not specified but it is required when building BackupRuleInput")
                    )?
                ,
