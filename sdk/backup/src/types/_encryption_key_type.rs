...
///     EncryptionKeyType::AwsOwnedKmsKey => { /* ... */ },
...
impl ::std::convert::From<&str> for EncryptionKeyType {
    fn from(s: &str) -> Self {
        match s {
            "AWS_OWNED_KMS_KEY" => EncryptionKeyType::AwsOwnedKmsKey,
            "CUSTOMER_MANAGED_KMS_KEY" => EncryptionKeyType::CustomerManagedKmsKey,
...
impl EncryptionKeyType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            EncryptionKeyType::AwsOwnedKmsKey => "AWS_OWNED_KMS_KEY",
            EncryptionKeyType::CustomerManagedKmsKey => "CUSTOMER_MANAGED_KMS_KEY",
...
impl ::std::fmt::Display for EncryptionKeyType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            EncryptionKeyType::AwsOwnedKmsKey => write!(f, "AWS_OWNED_KMS_KEY"),
            EncryptionKeyType::CustomerManagedKmsKey => write!(f, "CUSTOMER_MANAGED_KMS_KEY"),
