        ...
        ::std::result::Result::Ok(
            crate::types::BackupPlan {
                backup_plan_name: self.backup_plan_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("backup_plan_name", "backup_plan_name was not specified but it is required when building BackupPlan")
                    )?
                ,
                rules: self.rules
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("rules", "rules was not specified but it is required when building BackupPlan")
                    )?
                ,
