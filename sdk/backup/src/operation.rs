...
/// Types for the `AssociateBackupVaultMpaApprovalTeam` operation.
pub mod associate_backup_vault_mpa_approval_team;
...
/// Types for the `CreateRestoreAccessBackupVault` operation.
pub mod create_restore_access_backup_vault;
...
/// Types for the `ListRestoreAccessBackupVaults` operation.
pub mod list_restore_access_backup_vaults;
...
/// Types for the `RevokeRestoreAccessBackupVault` operation.
pub mod revoke_restore_access_backup_vault;
