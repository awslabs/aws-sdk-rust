...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MissingParameterValueException" => {
            crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::MissingParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_backup_plan_versions::de_list_backup_plan_versions(_response_body, output)
            .map_err(crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::unhandled)?;
