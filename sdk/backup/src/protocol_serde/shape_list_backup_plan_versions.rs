...
pub fn de_list_backup_plan_versions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_backup_plan_versions::ListBackupPlanVersionsOutput, crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_backup_plan_versions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_backup_plan_versions::ListBackupPlanVersionsOutput, crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_backup_plan_versions::builders::ListBackupPlanVersionsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_backup_plan_versions::de_list_backup_plan_versions(response.body().as_ref(), output).map_err(crate::operation::list_backup_plan_versions::ListBackupPlanVersionsError::unhandled)?;
