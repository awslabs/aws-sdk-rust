...
pub fn ser_backup_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BackupPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
