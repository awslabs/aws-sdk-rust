...
pub fn ser_update_report_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateReportPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
