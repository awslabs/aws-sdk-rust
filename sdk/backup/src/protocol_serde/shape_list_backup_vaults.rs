...
pub fn de_list_backup_vaults_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_backup_vaults_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_backup_vaults::de_list_backup_vaults(_response_body, output)
            .map_err(crate::operation::list_backup_vaults::ListBackupVaultsError::unhandled)?;
...
) -> Result<crate::operation::list_backup_vaults::builders::ListBackupVaultsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BackupVaultList" => {
                    builder = builder.set_backup_vault_list(crate::protocol_serde::shape_backup_vault_list::de_backup_vault_list(tokens)?);
                }
                "NextToken" => {
