...
pub fn de_list_backup_vaults_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_backup_vaults::ListBackupVaultsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_backup_vaults_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_backup_vaults::ListBackupVaultsOutput, crate::operation::list_backup_vaults::ListBackupVaultsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_backup_vaults::builders::ListBackupVaultsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_backup_vaults::de_list_backup_vaults(response.body().as_ref(), output).map_err(crate::operation::list_backup_vaults::ListBackupVaultsError::unhandled)?;
