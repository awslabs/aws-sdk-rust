...
pub fn ser_create_report_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReportPlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
