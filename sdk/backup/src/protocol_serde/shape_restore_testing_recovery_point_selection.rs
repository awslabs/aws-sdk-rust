...
pub fn ser_restore_testing_recovery_point_selection(
    ...
    if input.selection_window_days != 0 {
        object.key("SelectionWindowDays").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.selection_window_days).into()));
    }
    Ok(())
}

pub(crate) fn de_restore_testing_recovery_point_selection<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RestoreTestingRecoveryPointSelection>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_algorithm(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RestoreTestingRecoveryPointSelectionAlgorithm::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "ExcludeVaults" => {
                                builder = builder.set_exclude_vaults(
                                    crate::protocol_serde::shape_string_list::de_string_list(tokens)?
                                );
                            }
                            "IncludeVaults" => {
                                builder = builder.set_include_vaults(
                                    crate::protocol_serde::shape_string_list::de_string_list(tokens)?
                                );
                            }
                            "RecoveryPointTypes" => {
