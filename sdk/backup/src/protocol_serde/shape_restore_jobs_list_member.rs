...
pub(crate) fn de_restore_jobs_list_member<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RestoreJobsListMember>, aws_smithy_json::deserialize::error::DeserializeError>
