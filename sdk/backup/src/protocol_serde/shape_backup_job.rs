...
) -> Result<Option<crate::types::BackupJob>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "State" => {
                                builder = builder.set_state(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::BackupJobState::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "BackupOptions" => {
                                builder = builder.set_backup_options(
                                    crate::protocol_serde::shape_backup_options::de_backup_options(
                                        tokens,
                                    )?,
                                );
                            }
