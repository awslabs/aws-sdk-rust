...
pub fn de_list_protected_resources_by_backup_vault_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_protected_resources_by_backup_vault::ListProtectedResourcesByBackupVaultError::unhandled)?;
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(_response_body, output)
                            .map_err(
                                crate::operation::list_protected_resources_by_backup_vault::ListProtectedResourcesByBackupVaultError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_protected_resources_by_backup_vault_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_protected_resources_by_backup_vault::de_list_protected_resources_by_backup_vault(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_protected_resources_by_backup_vault::ListProtectedResourcesByBackupVaultError::unhandled)?;
