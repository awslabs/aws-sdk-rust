...
pub(crate) fn de_backup_vault_list_member<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BackupVaultListMember>, aws_smithy_json::deserialize::error::DeserializeError>
