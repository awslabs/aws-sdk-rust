...
pub(crate) fn de_backup_vault_list_member<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::BackupVaultListMember>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
