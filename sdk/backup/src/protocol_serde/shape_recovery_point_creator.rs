...
pub(crate) fn de_recovery_point_creator<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::RecoveryPointCreator>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
