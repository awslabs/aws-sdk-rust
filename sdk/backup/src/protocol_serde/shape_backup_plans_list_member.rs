...
pub(crate) fn de_backup_plans_list_member<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BackupPlansListMember>, aws_smithy_json::deserialize::error::DeserializeError>
