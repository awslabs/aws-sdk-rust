...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_protected_resource_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError> {
    Ok({
        #[allow(unused_mut)]
