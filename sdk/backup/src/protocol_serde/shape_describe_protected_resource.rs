...
pub fn de_describe_protected_resource_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_protected_resource_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError> {
    Ok({
        #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "LatestRestoreJobCreationDate" => {
                        builder = builder.set_latest_restore_job_creation_date(
                            ::aws_smithy_json::deserialize::token::expect_timestamp_or_null(tokens.next(), ::aws_smithy_types::date_time::Format::EpochSeconds)?
                        );
                    }
                    "LatestRestoreRecoveryPointCreationDate" => {
                        builder = builder.set_latest_restore_recovery_point_creation_date(
                            ::aws_smithy_json::deserialize::token::expect_timestamp_or_null(tokens.next(), ::aws_smithy_types::date_time::Format::EpochSeconds)?
                        );
                    }
                    "ResourceArn" => {
