...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_protected_resources::ListProtectedResourcesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "InvalidParameterValueException" => {
            crate::operation::list_protected_resources::ListProtectedResourcesError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_protected_resources::de_list_protected_resources(_response_body, output)
            .map_err(crate::operation::list_protected_resources::ListProtectedResourcesError::unhandled)?;
