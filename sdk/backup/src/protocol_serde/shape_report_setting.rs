...
pub fn ser_report_setting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReportSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_report_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReportSetting>, aws_smithy_json::deserialize::error::DeserializeError>
