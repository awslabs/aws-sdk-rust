...
pub fn de_list_recovery_points_by_legal_hold_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldOutput, crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_recovery_points_by_legal_hold_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldOutput, crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldError> {
    Ok({
        #[allow(unused_mut)]
