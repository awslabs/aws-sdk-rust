...
pub fn ser_start_copy_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartCopyJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
