...
pub fn ser_start_backup_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartBackupJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
