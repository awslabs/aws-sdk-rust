...
pub fn ser_update_backup_plan_input(
    ...
    crate::protocol_serde::shape_update_backup_plan_input::ser_update_backup_plan_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_backup_plan::UpdateBackupPlanError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_backup_plan_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_backup_plan::de_update_backup_plan(
            _response_body,
            output,
        )
        .map_err(crate::operation::update_backup_plan::UpdateBackupPlanError::unhandled)?;
