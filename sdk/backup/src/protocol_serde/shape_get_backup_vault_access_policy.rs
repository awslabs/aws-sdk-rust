...
pub fn de_get_backup_vault_access_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBackupVaultAccessPolicyOutput, crate::error::GetBackupVaultAccessPolicyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBackupVaultAccessPolicyError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidParameterValueException" => crate::error::GetBackupVaultAccessPolicyError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "MissingParameterValueException" => crate::error::GetBackupVaultAccessPolicyError::MissingParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetBackupVaultAccessPolicyError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::GetBackupVaultAccessPolicyError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_backup_vault_access_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBackupVaultAccessPolicyOutput, crate::error::GetBackupVaultAccessPolicyError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_get_backup_vault_access_policy(value: &[u8], mut builder: crate::output::get_backup_vault_access_policy_output::Builder) -> Result<crate::output::get_backup_vault_access_policy_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
