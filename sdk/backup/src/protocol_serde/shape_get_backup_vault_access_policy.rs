...
pub fn de_get_backup_vault_access_policy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyOutput, crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_backup_vault_access_policy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyOutput, crate::operation::get_backup_vault_access_policy::GetBackupVaultAccessPolicyError> {
    Ok({
        #[allow(unused_mut)]
