...
pub fn ser_start_restore_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRestoreJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
