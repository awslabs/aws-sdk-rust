...
pub fn ser_backup_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BackupRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
