...
pub fn de_describe_report_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_report_job::DescribeReportJobOutput, crate::operation::describe_report_job::DescribeReportJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_report_job::DescribeReportJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_report_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_report_job::DescribeReportJobOutput, crate::operation::describe_report_job::DescribeReportJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_report_job::builders::DescribeReportJobOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_report_job::de_describe_report_job(response.body().as_ref(), output).map_err(crate::operation::describe_report_job::DescribeReportJobError::unhandled)?;
