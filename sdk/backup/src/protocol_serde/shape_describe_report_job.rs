...
pub fn de_describe_report_job_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_report_job::DescribeReportJobOutput, crate::operation::describe_report_job::DescribeReportJobError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_report_job_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_report_job::DescribeReportJobOutput, crate::operation::describe_report_job::DescribeReportJobError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_report_job::de_describe_report_job(_response_body, output)
            .map_err(crate::operation::describe_report_job::DescribeReportJobError::unhandled)?;
...
) -> Result<crate::operation::describe_report_job::builders::DescribeReportJobOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ReportJob" => {
                    builder = builder.set_report_job(crate::protocol_serde::shape_report_job::de_report_job(tokens)?);
                }
