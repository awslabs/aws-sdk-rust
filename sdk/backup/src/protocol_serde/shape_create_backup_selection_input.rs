...
pub fn ser_create_backup_selection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_backup_selection::CreateBackupSelectionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
