...
pub fn ser_backup_selection(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BackupSelection) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_backup_selection<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BackupSelection>, aws_smithy_json::deserialize::error::DeserializeError>
