            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ListOfTags" => {
                            builder =
                                builder.set_list_of_tags(crate::protocol_serde::shape_list_of_tags::de_list_of_tags(tokens, _value, depth + 1)?);
                        }
                        "NotResources" => {
                            builder =
                                builder.set_not_resources(crate::protocol_serde::shape_resource_arns::de_resource_arns(tokens, _value, depth + 1)?);
                        }
                        "Conditions" => {
