...
pub fn ser_create_backup_plan_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::create_backup_plan::CreateBackupPlanInput,
) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1) = &input.backup_plan {
        #[allow(unused_mut)]
        let mut object_2 = object.key("BackupPlan").start_object();
        crate::protocol_serde::shape_backup_plan_input::ser_backup_plan_input(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
