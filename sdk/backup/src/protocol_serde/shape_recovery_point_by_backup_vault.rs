...
pub(crate) fn de_recovery_point_by_backup_vault<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RecoveryPointByBackupVault>, aws_smithy_json::deserialize::error::DeserializeError>
