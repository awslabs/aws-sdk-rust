...
) -> Result<Option<crate::types::RecoveryPointByBackupVault>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CalculatedLifecycle" => {
                            builder =
                                builder.set_calculated_lifecycle(crate::protocol_serde::shape_calculated_lifecycle::de_calculated_lifecycle(tokens)?);
                        }
                        "Lifecycle" => {
