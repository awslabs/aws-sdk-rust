...
pub(crate) fn create_backup_access_point_output_output_correct_errors(
    ...
    if builder.status.is_none() {
        builder.status = "no value was set".parse::<crate::types::AccessPointStatus>().ok()
    }
    builder
}
...
pub(crate) fn describe_backup_access_point_output_output_correct_errors(
...
pub(crate) fn list_backup_access_points_output_output_correct_errors(
    ...
    if builder.backup_access_points.is_none() {
        builder.backup_access_points = Some(Default::default())
    }
    builder
}

pub(crate) fn list_backup_access_points_by_recovery_point_output_output_correct_errors(
...
pub(crate) fn list_backup_access_points_by_resource_output_output_correct_errors(
...
pub(crate) fn list_access_points_member_correct_errors(
    mut builder: crate::types::builders::ListAccessPointsMemberBuilder,
) -> crate::types::builders::ListAccessPointsMemberBuilder {
    if builder.access_point_arn.is_none() {
        builder.access_point_arn = Some(Default::default())
    }
    if builder.access_point_metadata.is_none() {
        builder.access_point_metadata = Some(Default::default())
    }
    if builder.backup_vault_name.is_none() {
        builder.backup_vault_name = Some(Default::default())
    }
