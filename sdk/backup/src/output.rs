...
pub struct ListRestoreJobsOutput  {
    ...
    #[doc(hidden)]pub restore_jobs: std::option::Option<std::vec::Vec<crate::model::RestoreJobsListMember>>,
    /// <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListReportPlansOutput  {
    ...
    #[doc(hidden)]pub report_plans: std::option::Option<std::vec::Vec<crate::model::ReportPlan>>,
...
pub struct ListReportJobsOutput  {
    ...
    #[doc(hidden)]pub report_jobs: std::option::Option<std::vec::Vec<crate::model::ReportJob>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListRecoveryPointsByResourceOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub recovery_points: std::option::Option<std::vec::Vec<crate::model::RecoveryPointByResource>>,
}
...
pub struct ListRecoveryPointsByBackupVaultOutput  {
    ...
    #[doc(hidden)]pub recovery_points: std::option::Option<std::vec::Vec<crate::model::RecoveryPointByBackupVault>>,
}
...
pub struct ListProtectedResourcesOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::ProtectedResource>>,
    /// <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListFrameworksOutput  {
    ...
    #[doc(hidden)]pub frameworks: std::option::Option<std::vec::Vec<crate::model::Framework>>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListCopyJobsOutput  {
    ...
    #[doc(hidden)]pub copy_jobs: std::option::Option<std::vec::Vec<crate::model::CopyJob>>,
...
pub struct ListBackupVaultsOutput  {
    ...
    #[doc(hidden)]pub backup_vault_list: std::option::Option<std::vec::Vec<crate::model::BackupVaultListMember>>,
    /// <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListBackupSelectionsOutput  {
    ...
    #[doc(hidden)]pub backup_selections_list: std::option::Option<std::vec::Vec<crate::model::BackupSelectionsListMember>>,
}
...
pub struct ListBackupPlanVersionsOutput  {
    ...
    #[doc(hidden)]pub backup_plan_versions_list: std::option::Option<std::vec::Vec<crate::model::BackupPlansListMember>>,
}
...
pub struct ListBackupPlanTemplatesOutput  {
    ...
    #[doc(hidden)]pub backup_plan_templates_list: std::option::Option<std::vec::Vec<crate::model::BackupPlanTemplatesListMember>>,
}
...
impl  std::fmt::Debug for ListBackupPlanTemplatesOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("next_token", &self.next_token);
        formatter.field("backup_plan_templates_list", &self.backup_plan_templates_list);
        formatter.finish()
    }
}
...
pub struct ListBackupPlansOutput  {
    ...
    #[doc(hidden)]pub backup_plans_list: std::option::Option<std::vec::Vec<crate::model::BackupPlansListMember>>,
}
...
pub struct ListBackupJobsOutput  {
    ...
    #[doc(hidden)]pub backup_jobs: std::option::Option<std::vec::Vec<crate::model::BackupJob>>,
    /// <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetRecoveryPointRestoreMetadataOutput  {
    ...
    #[doc(hidden)]pub restore_metadata: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct GetBackupVaultNotificationsOutput  {
    ...
    #[doc(hidden)]pub backup_vault_events: std::option::Option<std::vec::Vec<crate::model::BackupVaultEvent>>,
}
...
pub struct GetBackupSelectionOutput  {
    ...
    #[doc(hidden)]pub backup_selection: std::option::Option<crate::model::BackupSelection>,
...
pub struct GetBackupPlanFromTemplateOutput  {
    ...
    #[doc(hidden)]pub backup_plan_document: std::option::Option<crate::model::BackupPlan>,
}
...
pub struct GetBackupPlanFromJsonOutput  {
    ...
    #[doc(hidden)]pub backup_plan: std::option::Option<crate::model::BackupPlan>,
}
...
pub struct ExportBackupPlanTemplateOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub backup_plan_template_json: std::option::Option<std::string::String>,
}
...
pub struct DescribeReportPlanOutput  {
    ...
    #[doc(hidden)]pub report_plan: std::option::Option<crate::model::ReportPlan>,
}
...
pub struct DescribeReportJobOutput  {
    ...
    #[doc(hidden)]pub report_job: std::option::Option<crate::model::ReportJob>,
}
...
pub struct DescribeRegionSettingsOutput  {
    ...
    #[doc(hidden)]pub resource_type_opt_in_preference: std::option::Option<std::collections::HashMap<std::string::String, bool>>,
    ...
    #[doc(hidden)]pub resource_type_management_preference: std::option::Option<std::collections::HashMap<std::string::String, bool>>,
}
...
impl  std::fmt::Debug for DescribeRegionSettingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("resource_type_opt_in_preference", &self.resource_type_opt_in_preference);
        formatter.field("resource_type_management_preference", &self.resource_type_management_preference);
        formatter.finish()
    }
}
...
pub struct DescribeGlobalSettingsOutput  {
    ...
    #[doc(hidden)]pub global_settings: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
...
pub struct DescribeFrameworkOutput  {
    ...
    #[doc(hidden)]pub framework_controls: std::option::Option<std::vec::Vec<crate::model::FrameworkControl>>,
    /// <p>The date and time that a framework is created, in Unix format and Coordinated Universal Time (UTC). The value of <code>CreationTime</code> is accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM.</p>
    #[doc(hidden)]pub creation_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    /// </ul>
    #[doc(hidden)]pub framework_status: std::option::Option<std::string::String>,
...
pub struct DescribeCopyJobOutput  {
    ...
    #[doc(hidden)]pub copy_job: std::option::Option<crate::model::CopyJob>,
}
