...
pub mod create_backup_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateBackupPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateBackupPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateBackupPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::CreateBackupPlanInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod create_backup_selection_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateBackupSelectionInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
pub mod create_backup_vault_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateBackupVaultInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateBackupVaultInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod create_framework_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateFrameworkInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
pub mod create_report_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CreateReportPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CreateReportPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CreateReportPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::CreateReportPlanInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod delete_backup_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_backup_selection_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupSelectionInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupSelectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupSelection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_backup_vault_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupVaultInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupVaultInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_backup_vault_access_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupVaultAccessPolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupVaultAccessPolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_backup_vault_lock_configuration_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupVaultLockConfigurationInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupVaultLockConfigurationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupVaultLockConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_backup_vault_notifications_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteBackupVaultNotificationsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteBackupVaultNotificationsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteBackupVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_framework_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteFrameworkInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteFrameworkInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteFramework, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_recovery_point_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteRecoveryPointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteRecoveryPointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteRecoveryPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod delete_report_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DeleteReportPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DeleteReportPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DeleteReportPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_backup_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeBackupJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeBackupJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeBackupJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_backup_vault_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeBackupVaultInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeBackupVaultInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_copy_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeCopyJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeCopyJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeCopyJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_framework_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeFrameworkInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeFrameworkInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeFramework, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_global_settings_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeGlobalSettingsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeGlobalSettingsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeGlobalSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeGlobalSettingsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod describe_protected_resource_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeProtectedResourceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeProtectedResourceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeProtectedResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_recovery_point_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeRecoveryPointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeRecoveryPointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeRecoveryPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_region_settings_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeRegionSettingsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeRegionSettingsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeRegionSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::DescribeRegionSettingsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod describe_report_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeReportJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeReportJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeReportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_report_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeReportPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeReportPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeReportPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod describe_restore_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DescribeRestoreJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DescribeRestoreJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DescribeRestoreJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod disassociate_recovery_point_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::DisassociateRecoveryPointInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl DisassociateRecoveryPointInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::DisassociateRecoveryPoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod export_backup_plan_template_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ExportBackupPlanTemplateInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ExportBackupPlanTemplateInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ExportBackupPlanTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_backup_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::GetBackupPlanInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod get_backup_plan_from_json_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupPlanFromJsonInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupPlanFromJsonInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupPlanFromJSON, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetBackupPlanFromJsonInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod get_backup_plan_from_template_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupPlanFromTemplateInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupPlanFromTemplateInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupPlanFromTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_backup_selection_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupSelectionInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupSelectionInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupSelection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_backup_vault_access_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupVaultAccessPolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupVaultAccessPolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_backup_vault_notifications_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetBackupVaultNotificationsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetBackupVaultNotificationsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetBackupVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_recovery_point_restore_metadata_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetRecoveryPointRestoreMetadataInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetRecoveryPointRestoreMetadataInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetRecoveryPointRestoreMetadata, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_supported_resource_types_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetSupportedResourceTypesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetSupportedResourceTypesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetSupportedResourceTypes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetSupportedResourceTypesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod list_backup_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupJobsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupJobsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListBackupJobsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/backup-jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListBackupJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_38) = &_input.by_resource_arn {
                    query.push_kv("resourceArn", &aws_smithy_http::query::fmt_string(&inner_38));
                }
                ...
                if let Some(inner_40) = &_input.by_backup_vault_name {
                    query.push_kv("backupVaultName", &aws_smithy_http::query::fmt_string(&inner_40));
                }
                if let Some(inner_41) = &_input.by_created_before {
                    query.push_kv("createdBefore", &aws_smithy_http::query::fmt_timestamp(inner_41, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_42) = &_input.by_created_after {
                    query.push_kv("createdAfter", &aws_smithy_http::query::fmt_timestamp(inner_42, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_43) = &_input.by_resource_type {
                    query.push_kv("resourceType", &aws_smithy_http::query::fmt_string(&inner_43));
                }
                ...
                if let Some(inner_45) = &_input.by_complete_after {
                    query.push_kv("completeAfter", &aws_smithy_http::query::fmt_timestamp(inner_45, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_46) = &_input.by_complete_before {
                    query.push_kv("completeBefore", &aws_smithy_http::query::fmt_timestamp(inner_46, aws_smithy_types::date_time::Format::DateTime)?);
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_backup_plans_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupPlansInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupPlansInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupPlans, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListBackupPlansInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/backup/plans").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListBackupPlansInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_49) = &_input.include_deleted {
                    query.push_kv("includeDeleted", aws_smithy_types::primitive::Encoder::from(*inner_49).encode());
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_backup_plan_templates_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupPlanTemplatesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupPlanTemplatesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupPlanTemplates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListBackupPlanTemplatesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/backup/template/plans").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListBackupPlanTemplatesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_backup_plan_versions_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupPlanVersionsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupPlanVersionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupPlanVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListBackupPlanVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_backup_selections_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupSelectionsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupSelectionsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupSelections, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListBackupSelectionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_backup_vaults_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListBackupVaultsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListBackupVaultsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListBackupVaults, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListBackupVaultsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/backup-vaults").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListBackupVaultsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_copy_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListCopyJobsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListCopyJobsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListCopyJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListCopyJobsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/copy-jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListCopyJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_62) = &_input.by_resource_arn {
                    query.push_kv("resourceArn", &aws_smithy_http::query::fmt_string(&inner_62));
                }
                ...
                if let Some(inner_64) = &_input.by_created_before {
                    query.push_kv("createdBefore", &aws_smithy_http::query::fmt_timestamp(inner_64, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_65) = &_input.by_created_after {
                    query.push_kv("createdAfter", &aws_smithy_http::query::fmt_timestamp(inner_65, aws_smithy_types::date_time::Format::DateTime)?);
                }
                ...
                if let Some(inner_67) = &_input.by_destination_vault_arn {
                    query.push_kv("destinationVaultArn", &aws_smithy_http::query::fmt_string(&inner_67));
                }
                ...
                if let Some(inner_69) = &_input.by_complete_before {
                    query.push_kv("completeBefore", &aws_smithy_http::query::fmt_timestamp(inner_69, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_70) = &_input.by_complete_after {
                    query.push_kv("completeAfter", &aws_smithy_http::query::fmt_timestamp(inner_70, aws_smithy_types::date_time::Format::DateTime)?);
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_frameworks_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListFrameworksInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListFrameworksInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListFrameworks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListFrameworksInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/audit/frameworks").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListFrameworksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_protected_resources_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListProtectedResourcesInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListProtectedResourcesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListProtectedResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListProtectedResourcesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/resources").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListProtectedResourcesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_recovery_points_by_backup_vault_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListRecoveryPointsByBackupVaultInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListRecoveryPointsByBackupVaultInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListRecoveryPointsByBackupVault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListRecoveryPointsByBackupVaultInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_78) = &_input.by_resource_arn {
                    query.push_kv("resourceArn", &aws_smithy_http::query::fmt_string(&inner_78));
                }
                if let Some(inner_79) = &_input.by_resource_type {
                    query.push_kv("resourceType", &aws_smithy_http::query::fmt_string(&inner_79));
                }
                if let Some(inner_80) = &_input.by_backup_plan_id {
                    query.push_kv("backupPlanId", &aws_smithy_http::query::fmt_string(&inner_80));
                }
                if let Some(inner_81) = &_input.by_created_before {
                    query.push_kv("createdBefore", &aws_smithy_http::query::fmt_timestamp(inner_81, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_82) = &_input.by_created_after {
                    query.push_kv("createdAfter", &aws_smithy_http::query::fmt_timestamp(inner_82, aws_smithy_types::date_time::Format::DateTime)?);
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_recovery_points_by_resource_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListRecoveryPointsByResourceInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListRecoveryPointsByResourceInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListRecoveryPointsByResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListRecoveryPointsByResourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_85) = &_input.max_results {
                    query.push_kv("maxResults", aws_smithy_types::primitive::Encoder::from(*inner_85).encode());
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod list_report_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListReportJobsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListReportJobsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListReportJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListReportJobsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/audit/report-jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListReportJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                if let Some(inner_86) = &_input.by_report_plan_name {
                    query.push_kv("ReportPlanName", &aws_smithy_http::query::fmt_string(&inner_86));
                }
                if let Some(inner_87) = &_input.by_creation_before {
                    query.push_kv("CreationBefore", &aws_smithy_http::query::fmt_timestamp(inner_87, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_88) = &_input.by_creation_after {
                    query.push_kv("CreationAfter", &aws_smithy_http::query::fmt_timestamp(inner_88, aws_smithy_types::date_time::Format::DateTime)?);
                }
...
pub mod list_report_plans_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListReportPlansInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListReportPlansInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListReportPlans, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListReportPlansInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/audit/report-plans").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListReportPlansInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_restore_jobs_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListRestoreJobsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListRestoreJobsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListRestoreJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListRestoreJobsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/restore-jobs").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::ListRestoreJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                ...
                if let Some(inner_97) = &_input.by_created_before {
                    query.push_kv("createdBefore", &aws_smithy_http::query::fmt_timestamp(inner_97, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_98) = &_input.by_created_after {
                    query.push_kv("createdAfter", &aws_smithy_http::query::fmt_timestamp(inner_98, aws_smithy_types::date_time::Format::DateTime)?);
                }
                ...
                if let Some(inner_100) = &_input.by_complete_before {
                    query.push_kv("completeBefore", &aws_smithy_http::query::fmt_timestamp(inner_100, aws_smithy_types::date_time::Format::DateTime)?);
                }
                if let Some(inner_101) = &_input.by_complete_after {
                    query.push_kv("completeAfter", &aws_smithy_http::query::fmt_timestamp(inner_101, aws_smithy_types::date_time::Format::DateTime)?);
                }
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod put_backup_vault_access_policy_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutBackupVaultAccessPolicyInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutBackupVaultAccessPolicyInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutBackupVaultAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod put_backup_vault_lock_configuration_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutBackupVaultLockConfigurationInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutBackupVaultLockConfigurationInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutBackupVaultLockConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod put_backup_vault_notifications_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutBackupVaultNotificationsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutBackupVaultNotificationsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutBackupVaultNotifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod start_backup_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartBackupJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartBackupJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartBackupJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StartBackupJobInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/backup-jobs").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod start_copy_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartCopyJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartCopyJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartCopyJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StartCopyJobInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/copy-jobs").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod start_report_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartReportJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartReportJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartReportJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
...
pub mod start_restore_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartRestoreJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartRestoreJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartRestoreJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StartRestoreJobInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/restore-jobs").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod stop_backup_job_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StopBackupJobInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StopBackupJobInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StopBackupJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod update_backup_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateBackupPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateBackupPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateBackupPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod update_framework_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateFrameworkInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateFrameworkInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateFramework, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
...
pub mod update_recovery_point_lifecycle_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateRecoveryPointLifecycleInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateRecoveryPointLifecycleInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateRecoveryPointLifecycle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod update_region_settings_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateRegionSettingsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateRegionSettingsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateRegionSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateRegionSettingsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                write!(output, "/account-settings").expect("formatting should succeed");
                Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]fn update_http_builder(
...
pub mod update_report_plan_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UpdateReportPlanInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl UpdateReportPlanInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateReportPlan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.idempotency_token.is_none() {
                                self.idempotency_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
...
pub struct UpdateBackupPlanInput  {
    ...
    /// <p>Specifies the body of a backup plan. Includes a <code>BackupPlanName</code> and one or more sets of <code>Rules</code>.</p>
    #[doc(hidden)]pub backup_plan: std::option::Option<crate::model::BackupPlanInput>,
}
impl UpdateBackupPlanInput {
    /// <p>Uniquely identifies a backup plan.</p>
...
pub struct StartCopyJobInput  {
    ...
    #[doc(hidden)]pub recovery_point_arn: std::option::Option<std::string::String>,
    /// <p>The name of a logical source container where backups are stored. Backup vaults are identified by names that are unique to the account used to create them and the Amazon Web Services Region where they are created. They consist of lowercase letters, numbers, and hyphens.</p>
    #[doc(hidden)]pub source_backup_vault_name: std::option::Option<std::string::String>,
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a destination backup vault to copy to; for example, <code>arn:aws:backup:us-east-1:123456789012:vault:aBackupVault</code>.</p>
...
pub struct StartBackupJobInput  {
    ...
    /// <p>A value in minutes during which a successfully started backup must complete, or else Backup will cancel the job. This value is optional. This value begins counting down from when the backup was scheduled. It does not add additional time for <code>StartWindowMinutes</code>, or if the backup started later than scheduled.</p>
    #[doc(hidden)]pub complete_window_minutes: std::option::Option<i64>,
    /// <p>The lifecycle defines when a protected resource is transitioned to cold storage and when it expires. Backup will transition and expire backups automatically according to the lifecycle that you define. </p> 
    /// <p>Backups transitioned to cold storage must be stored in cold storage for a minimum of 90 days. Therefore, the “retention” setting must be 90 days greater than the “transition to cold after days” setting. The “transition to cold after days” setting cannot be changed after a backup has been transitioned to cold. </p> 
    /// <p>Resource types that are able to be transitioned to cold storage are listed in the "Lifecycle to cold storage" section of the <a href="https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html#features-by-resource"> Feature availability by resource</a> table. Backup ignores this expression for other resource types.</p>
    #[doc(hidden)]pub lifecycle: std::option::Option<crate::model::Lifecycle>,
...
pub struct PutBackupVaultLockConfigurationInput  {
    ...
    /// <p>Before the lock date, you can delete Vault Lock from the vault using <code>DeleteBackupVaultLockConfiguration</code> or change the Vault Lock configuration using <code>PutBackupVaultLockConfiguration</code>. On and after the lock date, the Vault Lock becomes immutable and cannot be changed or deleted.</p> 
    /// <p>If this parameter is not specified, you can delete Vault Lock from the vault using <code>DeleteBackupVaultLockConfiguration</code> or change the Vault Lock configuration using <code>PutBackupVaultLockConfiguration</code> at any time.</p>
    #[doc(hidden)]pub changeable_for_days: std::option::Option<i64>,
}
impl PutBackupVaultLockConfigurationInput {
    /// <p>The Backup Vault Lock configuration that specifies the name of the backup vault it protects.</p>
    pub fn backup_vault_name(&self) -> std::option::Option<& str> {
...
pub struct ListRestoreJobsInput  {
    ...
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
    /// <p>The account ID to list the jobs from. Returns only restore jobs associated with the specified account ID.</p>
    #[doc(hidden)]pub by_account_id: std::option::Option<std::string::String>,
    /// <p>Returns only restore jobs that were created before the specified date.</p>
    #[doc(hidden)]pub by_created_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only restore jobs that were created after the specified date.</p>
    #[doc(hidden)]pub by_created_after: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only restore jobs associated with the specified job status.</p>
    #[doc(hidden)]pub by_status: std::option::Option<crate::model::RestoreJobStatus>,
    /// <p>Returns only copy jobs completed before a date expressed in Unix format and Coordinated Universal Time (UTC).</p>
    #[doc(hidden)]pub by_complete_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only copy jobs completed after a date expressed in Unix format and Coordinated Universal Time (UTC).</p>
    #[doc(hidden)]pub by_complete_after: std::option::Option<aws_smithy_types::DateTime>,
}
impl ListRestoreJobsInput {
    /// <p>The next item following a partial list of returned items. For example, if a request is made to return <code>maxResults</code> number of items, <code>NextToken</code> allows you to return more items in your list starting at the location pointed to by the next token.</p>
    pub fn next_token(&self) -> std::option::Option<& str> {
...
pub struct ListReportJobsInput  {
    /// <p>Returns only report jobs with the specified report plan name.</p>
    #[doc(hidden)]pub by_report_plan_name: std::option::Option<std::string::String>,
    /// <p>Returns only report jobs that were created before the date and time specified in Unix format and Coordinated Universal Time (UTC). For example, the value 1516925490 represents Friday, January 26, 2018 12:11:30 AM.</p>
    #[doc(hidden)]pub by_creation_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only report jobs that were created after the date and time specified in Unix format and Coordinated Universal Time (UTC). For example, the value 1516925490 represents Friday, January 26, 2018 12:11:30 AM.</p>
    #[doc(hidden)]pub by_creation_after: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only report jobs that are in the specified status. The statuses are:</p> 
    /// <p> <code>CREATED | RUNNING | COMPLETED | FAILED</code> </p>
    #[doc(hidden)]pub by_status: std::option::Option<std::string::String>,
    /// <p>The number of desired results from 1 to 1000. Optional. If unspecified, the query will return 1 MB of data.</p>
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
    /// <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
...
pub struct ListRecoveryPointsByBackupVaultInput  {
    ...
    #[doc(hidden)]pub max_results: std::option::Option<i32>,
    /// <p>Returns only recovery points that match the specified resource Amazon Resource Name (ARN).</p>
    #[doc(hidden)]pub by_resource_arn: std::option::Option<std::string::String>,
    /// <p>Returns only recovery points that match the specified resource type.</p>
    #[doc(hidden)]pub by_resource_type: std::option::Option<std::string::String>,
    /// <p>Returns only recovery points that match the specified backup plan ID.</p>
    #[doc(hidden)]pub by_backup_plan_id: std::option::Option<std::string::String>,
    /// <p>Returns only recovery points that were created before the specified timestamp.</p>
    #[doc(hidden)]pub by_created_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only recovery points that were created after the specified timestamp.</p>
    #[doc(hidden)]pub by_created_after: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ListCopyJobsInput  {
    ...
    #[doc(hidden)]pub by_resource_arn: std::option::Option<std::string::String>,
    /// <p>Returns only copy jobs that are in the specified state.</p>
    #[doc(hidden)]pub by_state: std::option::Option<crate::model::CopyJobState>,
    /// <p>Returns only copy jobs that were created before the specified date.</p>
    #[doc(hidden)]pub by_created_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only copy jobs that were created after the specified date.</p>
    #[doc(hidden)]pub by_created_after: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub by_resource_type: std::option::Option<std::string::String>,
    /// <p>An Amazon Resource Name (ARN) that uniquely identifies a source backup vault to copy from; for example, <code>arn:aws:backup:us-east-1:123456789012:vault:aBackupVault</code>. </p>
    #[doc(hidden)]pub by_destination_vault_arn: std::option::Option<std::string::String>,
    /// <p>The account ID to list the jobs from. Returns only copy jobs associated with the specified account ID.</p>
    #[doc(hidden)]pub by_account_id: std::option::Option<std::string::String>,
    /// <p>Returns only copy jobs completed before a date expressed in Unix format and Coordinated Universal Time (UTC).</p>
    #[doc(hidden)]pub by_complete_before: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct ListBackupJobsInput  {
    ...
    #[doc(hidden)]pub by_resource_arn: std::option::Option<std::string::String>,
    /// <p>Returns only backup jobs that are in the specified state.</p>
    #[doc(hidden)]pub by_state: std::option::Option<crate::model::BackupJobState>,
    /// <p>Returns only backup jobs that will be stored in the specified backup vault. Backup vaults are identified by names that are unique to the account used to create them and the Amazon Web Services Region where they are created. They consist of lowercase letters, numbers, and hyphens.</p>
    #[doc(hidden)]pub by_backup_vault_name: std::option::Option<std::string::String>,
    /// <p>Returns only backup jobs that were created before the specified date.</p>
    #[doc(hidden)]pub by_created_before: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Returns only backup jobs that were created after the specified date.</p>
    #[doc(hidden)]pub by_created_after: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct CreateReportPlanInput  {
    ...
    #[doc(hidden)]pub report_setting: std::option::Option<crate::model::ReportSetting>,
    /// <p>Metadata that you can assign to help organize the report plans that you create. Each tag is a key-value pair.</p>
    #[doc(hidden)]pub report_plan_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>A customer-chosen string that you can use to distinguish between otherwise identical calls to <code>CreateReportPlanInput</code>. Retrying a successful request with the same idempotency token results in a success message with no action taken.</p>
    #[doc(hidden)]pub idempotency_token: std::option::Option<std::string::String>,
}
impl CreateReportPlanInput {
...
pub struct CreateFrameworkInput  {
    ...
    #[doc(hidden)]pub idempotency_token: std::option::Option<std::string::String>,
    /// <p>Metadata that you can assign to help organize the frameworks that you create. Each tag is a key-value pair.</p>
    #[doc(hidden)]pub framework_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl CreateFrameworkInput {
    /// <p>The unique name of the framework. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).</p>
    pub fn framework_name(&self) -> std::option::Option<& str> {
...
pub struct CreateBackupVaultInput  {
    ...
    #[doc(hidden)]pub backup_vault_name: std::option::Option<std::string::String>,
    /// <p>Metadata that you can assign to help organize the resources that you create. Each tag is a key-value pair.</p>
    #[doc(hidden)]pub backup_vault_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The server-side encryption key that is used to protect your backups; for example, <code>arn:aws:kms:us-west-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab</code>.</p>
...
pub struct CreateBackupPlanInput  {
    ...
    #[doc(hidden)]pub backup_plan: std::option::Option<crate::model::BackupPlanInput>,
    /// <p>To help organize your resources, you can assign your own metadata to the resources that you create. Each tag is a key-value pair. The specified tags are assigned to all backups created with this plan.</p>
    #[doc(hidden)]pub backup_plan_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>Identifies the request and allows failed requests to be retried without the risk of running the operation twice. If the request includes a <code>CreatorRequestId</code> that matches an existing backup plan, that plan is returned. This parameter is optional.</p> 
    /// <p>If used, this parameter must contain 1 to 50 alphanumeric or '-_.' characters.</p>
    #[doc(hidden)]pub creator_request_id: std::option::Option<std::string::String>,
}
