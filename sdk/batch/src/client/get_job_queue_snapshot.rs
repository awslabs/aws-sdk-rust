...
impl super::Client {
    ...
    ///   - [`queue_utilization(Option<QueueSnapshotUtilizationDetail>)`](crate::operation::get_job_queue_snapshot::GetJobQueueSnapshotOutput::queue_utilization): <p>The job queue's capacity utilization, including total usage and breakdown by fairshare scheduling queue.</p>
