...
impl super::Client {
    ...
    ///   - [`jobs(impl Into<String>)`](crate::operation::describe_jobs::builders::DescribeJobsFluentBuilder::jobs) / [`set_jobs(Option<Vec<String>>)`](crate::operation::describe_jobs::builders::DescribeJobsFluentBuilder::set_jobs): <p>A list of up to 100 job IDs.</p>
