...
impl super::Client {
    ...
    ///   - [`job_queues(Vec<String>)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::job_queues) / [`set_job_queues(Option<Vec<String>>)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::set_job_queues): <p>A list of up to 100 queue names or full queue Amazon Resource Name (ARN) entries.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::set_max_results): <p>The maximum number of results returned by <code>DescribeJobQueues</code> in paginated output. When this parameter is used, <code>DescribeJobQueues</code> only returns <code>maxResults</code> results in a single page and a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>DescribeJobQueues</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 100. If this parameter isn't used, then <code>DescribeJobQueues</code> returns up to 100 results and a <code>nextToken</code> value if applicable.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_job_queues::builders::DescribeJobQueuesFluentBuilder::set_next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>DescribeJobQueues</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. This value is <code>null</code> when there are no more results to return.</p> <note>   <p>Treat this token as an opaque identifier that's only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
