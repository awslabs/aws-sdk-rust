...
impl ::std::convert::From<&str> for JqState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JqState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JqState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JqState::from(s))
    }
}
impl JqState {
...
impl ::std::convert::AsRef<str> for JqState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
