...
impl DescribeJobDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_job_definitions::DescribeJobDefinitions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeJobDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_job_definitions::de_describe_job_definitions_http_response_with_props(status, headers, body)
        }
    }
}
