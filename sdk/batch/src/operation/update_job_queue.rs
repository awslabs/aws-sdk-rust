...
impl UpdateJobQueueInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_job_queue::UpdateJobQueue, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_job_queue::ser_update_job_queue_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateJobQueue {
    type Output =
        ::std::result::Result<crate::operation::update_job_queue::UpdateJobQueueOutput, crate::operation::update_job_queue::UpdateJobQueueError>;
