...
impl TerminateJobInput {
    /// Consumes the builder and constructs an Operation<[`TerminateJob`](crate::operation::terminate_job::TerminateJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::terminate_job::TerminateJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::terminate_job::TerminateJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_terminate_job::ser_terminate_job_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_job::TerminateJob::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TerminateJob", "batch"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `TerminateJob`.
...
impl aws_smithy_http::response::ParseStrictResponse for TerminateJob {
                type Output = std::result::Result<crate::operation::terminate_job::TerminateJobOutput, crate::operation::terminate_job::TerminateJobError>;
