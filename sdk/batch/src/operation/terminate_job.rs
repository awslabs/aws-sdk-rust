...
impl TerminateJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::terminate_job::TerminateJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_terminate_job::ser_terminate_job_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_terminate_job::de_terminate_job_http_response_with_props(status, headers, body)
        }
    }
}
