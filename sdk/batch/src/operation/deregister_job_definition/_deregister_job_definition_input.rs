...
impl DeregisterJobDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_job_definition::DeregisterJobDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
