...
impl DescribeJobQueuesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_job_queues::ser_describe_job_queues_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeJobQueues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_job_queues::de_describe_job_queues_http_response_with_props(status, headers, body)
        }
    }
}
