...
/// Paginator for [`ListSchedulingPolicies`](crate::operation::list_scheduling_policies::ListSchedulingPolicies)
            ...
            impl ListSchedulingPoliciesPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_scheduling_policies::ListSchedulingPoliciesOutput, aws_smithy_http::result::SdkError<crate::operation::list_scheduling_policies::ListSchedulingPoliciesError>>> + Unpin
                 {
...
/// Flattened paginator for `ListSchedulingPoliciesPaginator`
                ...
                impl  ListSchedulingPoliciesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::SchedulingPolicyListingDetail, aws_smithy_http::result::SdkError<crate::operation::list_scheduling_policies::ListSchedulingPoliciesError>>> + Unpin
                     {
