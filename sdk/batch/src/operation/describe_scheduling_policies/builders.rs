...
impl DescribeSchedulingPoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_scheduling_policies::DescribeSchedulingPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_scheduling_policies::DescribeSchedulingPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_scheduling_policies::DescribeSchedulingPoliciesOutput, crate::operation::describe_scheduling_policies::DescribeSchedulingPoliciesError, Self> {
