    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compute_environments::DescribeComputeEnvironmentsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compute_environments::DescribeComputeEnvironmentsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeComputeEnvironmentsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeComputeEnvironmentsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_compute_environments::DescribeComputeEnvironmentsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeComputeEnvironmentsEndpointParamsInterceptor {
    ...
    async fn deserialize_describe_compute_response() {
        let expected_output = crate::operation::describe_compute_environments::DescribeComputeEnvironmentsOutput::builder()
            .set_compute_environments(::std::option::Option::Some(vec![crate::types::ComputeEnvironmentDetail::builder()
                ...
                .set_type(::std::option::Option::Some(crate::types::CeType::from("MANAGED")))
                .set_state(::std::option::Option::Some(crate::types::CeState::from("ENABLED")))
                .set_status(::std::option::Option::Some(crate::types::CeStatus::from("VALID")))
                ...
                .set_compute_resources(::std::option::Option::Some(
                    crate::types::ComputeResource::builder()
                        .set_type(::std::option::Option::Some(crate::types::CrType::from("EC2")))
        ...
        let parsed: crate::operation::describe_compute_environments::DescribeComputeEnvironmentsOutput =
