...
impl UpdateSchedulingPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_scheduling_policy::UpdateSchedulingPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_scheduling_policy::UpdateSchedulingPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_scheduling_policy::UpdateSchedulingPolicyOutput, crate::operation::update_scheduling_policy::UpdateSchedulingPolicyError, Self> {
