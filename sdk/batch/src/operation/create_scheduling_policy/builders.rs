...
impl CreateSchedulingPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_scheduling_policy::CreateSchedulingPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_scheduling_policy::CreateSchedulingPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_scheduling_policy::CreateSchedulingPolicyOutput, crate::operation::create_scheduling_policy::CreateSchedulingPolicyError, Self> {
