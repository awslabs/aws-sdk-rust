...
impl UpdateSchedulingPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_scheduling_policy::UpdateSchedulingPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSchedulingPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_scheduling_policy::de_update_scheduling_policy_http_response_with_props(status, headers, body)
        }
    }
}
