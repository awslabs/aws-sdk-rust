...
/// <ol>
/// <li>
/// <p>Create a new compute environment with the new AMI.</p></li>
/// <li>
/// <p>Add the compute environment to an existing job queue.</p></li>
/// <li>
/// <p>Remove the earlier compute environment from your job queue.</p></li>
/// <li>
/// <p>Delete the earlier compute environment.</p></li>
/// </ol>
...
/// <ul>
/// <li>
/// <p>Either don't set the service role (<code>serviceRole</code>) parameter or set it to the <b>AWSBatchServiceRole</b> service-linked role.</p></li>
/// <li>
/// <p>Set the allocation strategy (<code>allocationStrategy</code>) parameter to <code>BEST_FIT_PROGRESSIVE</code>, <code>SPOT_CAPACITY_OPTIMIZED</code>, or <code>SPOT_PRICE_CAPACITY_OPTIMIZED</code>.</p></li>
/// <li>
/// <p>Set the update to latest image version (<code>updateToLatestImageVersion</code>) parameter to <code>true</code>. The <code>updateToLatestImageVersion</code> parameter is used when you update a compute environment. This parameter is ignored when you create a compute environment.</p></li>
/// <li>
...
impl CreateComputeEnvironmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_compute_environment::CreateComputeEnvironmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_compute_environment::CreateComputeEnvironmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_compute_environment::CreateComputeEnvironmentOutput, crate::operation::create_compute_environment::CreateComputeEnvironmentError, Self> {
