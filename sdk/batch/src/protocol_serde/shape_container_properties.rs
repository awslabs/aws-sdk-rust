...
pub fn ser_container_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ContainerProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_container_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContainerProperties>, aws_smithy_json::deserialize::error::DeserializeError>
