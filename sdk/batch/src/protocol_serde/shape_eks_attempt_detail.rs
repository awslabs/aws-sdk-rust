...
pub(crate) fn de_eks_attempt_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EksAttemptDetail>, aws_smithy_json::deserialize::error::DeserializeError>
