...
pub fn ser_compute_resource(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComputeResource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_compute_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ComputeResource>, aws_smithy_json::deserialize::error::DeserializeError>
