...
pub fn ser_eks_volume(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EksVolume) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_eks_volume<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EksVolume>, aws_smithy_json::deserialize::error::DeserializeError>
