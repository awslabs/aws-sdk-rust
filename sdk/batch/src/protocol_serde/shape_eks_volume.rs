...
pub fn ser_eks_volume(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::EksVolume) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
