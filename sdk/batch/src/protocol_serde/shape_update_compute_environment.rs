...
> {
    ...
    Err(match error_code {
        "ClientException" => {
            crate::error::UpdateComputeEnvironmentError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::error::UpdateComputeEnvironmentError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_update_compute_environment::de_update_compute_environment(
