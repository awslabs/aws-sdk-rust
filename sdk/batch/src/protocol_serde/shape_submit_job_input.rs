...
pub fn ser_submit_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SubmitJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
