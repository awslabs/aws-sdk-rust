...
pub fn ser_compute_resource_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ComputeResourceUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
