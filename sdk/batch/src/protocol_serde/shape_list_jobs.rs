...
pub fn de_list_jobs_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_jobs_output_correct_errors(output).build()
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "jobSummaryList" => {
                    builder = builder.set_job_summary_list(crate::protocol_serde::shape_job_summary_list::de_job_summary_list(tokens)?);
                }
                "nextToken" => {
