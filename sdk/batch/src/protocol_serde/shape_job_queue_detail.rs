...
pub(crate) fn de_job_queue_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobQueueDetail>, aws_smithy_json::deserialize::error::DeserializeError>
