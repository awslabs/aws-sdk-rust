...
pub fn ser_node_property_override(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NodePropertyOverride) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
