...
pub(crate) fn de_ecs_task_properties<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EcsTaskProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
