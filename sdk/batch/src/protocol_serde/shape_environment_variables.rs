...
pub(crate) fn de_environment_variables<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::KeyValuePair>>, ::aws_smithy_json::deserialize::error::DeserializeError>
