...
pub fn ser_eks_container(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EksContainer) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_eks_container<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EksContainer>, aws_smithy_json::deserialize::error::DeserializeError>
