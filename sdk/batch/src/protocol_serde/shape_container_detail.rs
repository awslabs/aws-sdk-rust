...
pub(crate) fn de_container_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContainerDetail>, aws_smithy_json::deserialize::error::DeserializeError>
