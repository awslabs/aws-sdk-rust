...
pub fn ser_update_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdatePolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_update_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UpdatePolicy>, aws_smithy_json::deserialize::error::DeserializeError>
