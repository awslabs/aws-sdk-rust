...
pub fn de_create_job_queue_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_job_queue_output_correct_errors(output).build()
    })
}
...
) -> Result<crate::operation::create_job_queue::builders::CreateJobQueueOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
