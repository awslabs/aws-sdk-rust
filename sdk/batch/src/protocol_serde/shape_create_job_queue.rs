...
pub fn ser_create_job_queue_input(
    ...
    crate::protocol_serde::shape_create_job_queue_input::ser_create_job_queue_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_create_job_queue_http_error(
    ...
    Err(match error_code {
        "ClientException" => {
            crate::error::CreateJobQueueError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::error::CreateJobQueueError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub(crate) fn de_create_job_queue(
    ...
    crate::output::create_job_queue_output::Builder,
