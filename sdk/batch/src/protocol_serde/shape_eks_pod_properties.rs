...
pub fn ser_eks_pod_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EksPodProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_eks_pod_properties<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EksPodProperties>, aws_smithy_json::deserialize::error::DeserializeError>
