...
pub(crate) fn de_job_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
