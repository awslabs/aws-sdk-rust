...
) -> Result<Option<crate::types::JobDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "containerProperties" => {
                            builder =
                                builder.set_container_properties(crate::protocol_serde::shape_container_properties::de_container_properties(tokens)?);
                        }
                        "timeout" => {
