...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod describe_compute_environments_request_test {
    ...
    #[tokio::test]async fn deserialize_describe_compute_response() {
