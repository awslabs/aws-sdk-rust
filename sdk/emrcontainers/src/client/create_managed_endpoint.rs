...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_name): <p>The name of the managed endpoint.</p>
    ///   - [`virtual_cluster_id(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::virtual_cluster_id) / [`set_virtual_cluster_id(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_virtual_cluster_id): <p>The ID of the virtual cluster for which a managed endpoint is created.</p>
    ///   - [`r#type(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::type) / [`set_type(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_type): <p>The type of the managed endpoint.</p>
    ///   - [`release_label(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::release_label) / [`set_release_label(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_release_label): <p>The Amazon EMR release version.</p>
    ///   - [`execution_role_arn(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::execution_role_arn) / [`set_execution_role_arn(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_execution_role_arn): <p>The ARN of the execution role.</p>
    ///   - [`certificate_arn(impl Into<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::certificate_arn) / [`set_certificate_arn(Option<String>)`](crate::operation::create_managed_endpoint::builders::CreateManagedEndpointFluentBuilder::set_certificate_arn): <p>The certificate ARN provided by users for the managed endpoint. This field is under deprecation and will be removed in future releases.</p>
