...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_virtual_cluster::builders::DescribeVirtualClusterFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_virtual_cluster::builders::DescribeVirtualClusterFluentBuilder::set_id): <p>The ID of the virtual cluster that will be described.</p>
