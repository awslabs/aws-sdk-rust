...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_virtual_cluster::builders::DescribeVirtualClusterFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_virtual_cluster::builders::DescribeVirtualClusterFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the virtual cluster that will be described.</p><br>
