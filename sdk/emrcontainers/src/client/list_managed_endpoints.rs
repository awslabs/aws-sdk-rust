...
impl super::Client {
    ...
    ///   - [`types(impl Into<String>)`](crate::operation::list_managed_endpoints::builders::ListManagedEndpointsFluentBuilder::types) / [`set_types(Option<Vec<String>>)`](crate::operation::list_managed_endpoints::builders::ListManagedEndpointsFluentBuilder::set_types): <p>The types of the managed endpoints.</p>
    ///   - [`states(EndpointState)`](crate::operation::list_managed_endpoints::builders::ListManagedEndpointsFluentBuilder::states) / [`set_states(Option<Vec<EndpointState>>)`](crate::operation::list_managed_endpoints::builders::ListManagedEndpointsFluentBuilder::set_states): <p>The states of the managed endpoints.</p>
