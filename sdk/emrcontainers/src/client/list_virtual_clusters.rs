...
impl super::Client {
    ...
    ///   - [`states(VirtualClusterState)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::states) / [`set_states(Option<Vec::<VirtualClusterState>>)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::set_states):<br>required: **false**<br><p>The states of the requested virtual clusters.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of virtual clusters that can be listed.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_virtual_clusters::builders::ListVirtualClustersFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of virtual clusters to return.</p><br>
