...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_job_template::builders::DescribeJobTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_job_template::builders::DescribeJobTemplateFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the job template that will be described.</p><br>
