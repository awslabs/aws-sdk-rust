...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::cancel_job_run::builders::CancelJobRunFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::cancel_job_run::builders::CancelJobRunFluentBuilder::set_id): <p>The ID of the job run to cancel.</p>
    ///   - [`virtual_cluster_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_job_run::builders::CancelJobRunFluentBuilder::virtual_cluster_id) / [`set_virtual_cluster_id(Option<String>)`](crate::operation::cancel_job_run::builders::CancelJobRunFluentBuilder::set_virtual_cluster_id): <p>The ID of the virtual cluster for which the job run will be canceled.</p>
