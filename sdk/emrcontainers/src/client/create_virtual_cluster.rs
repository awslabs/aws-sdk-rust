...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_virtual_cluster::builders::CreateVirtualClusterFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_virtual_cluster::builders::CreateVirtualClusterFluentBuilder::set_tags): <p>The tags assigned to the virtual cluster.</p>
