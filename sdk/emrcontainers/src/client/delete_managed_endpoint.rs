...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_managed_endpoint::builders::DeleteManagedEndpointFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_managed_endpoint::builders::DeleteManagedEndpointFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the managed endpoint.</p><br>
