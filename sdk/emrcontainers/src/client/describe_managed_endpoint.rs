...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::set_id): <p>This output displays ID of the managed endpoint.</p>
    ///   - [`virtual_cluster_id(impl ::std::convert::Into<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::virtual_cluster_id) / [`set_virtual_cluster_id(Option<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::set_virtual_cluster_id): <p>The ID of the endpoint's virtual cluster.</p>
