...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::set_id):<br>required: **true**<br><p>This output displays ID of the managed endpoint.</p><br>
    ///   - [`virtual_cluster_id(impl Into<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::virtual_cluster_id) / [`set_virtual_cluster_id(Option<String>)`](crate::operation::describe_managed_endpoint::builders::DescribeManagedEndpointFluentBuilder::set_virtual_cluster_id):<br>required: **true**<br><p>The ID of the endpoint's virtual cluster.</p><br>
