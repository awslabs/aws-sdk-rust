...
/// Paginator for [`ListManagedEndpoints`](crate::operation::ListManagedEndpoints)
            ...
            impl ListManagedEndpointsPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_managed_endpoints_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListManagedEndpointsOutput, aws_smithy_http::result::SdkError<crate::error::ListManagedEndpointsError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Paginator for [`ListVirtualClusters`](crate::operation::ListVirtualClusters)
            ...
            impl ListVirtualClustersPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_virtual_clusters_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                        stop_on_duplicate_token: true,
                ...
                ///
                /// _Note:_ No requests will be dispatched until the stream is used (eg. with [`.next().await`](tokio_stream::StreamExt::next)).
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListVirtualClustersOutput, aws_smithy_http::result::SdkError<crate::error::ListVirtualClustersError>>> + Unpin
                 {
                    // Move individual fields out of self for the borrow checker
                    let builder = self.builder;
                    let handle = self.handle;
...
/// Flattened paginator for `ListJobTemplatesPaginator`
                ...
                impl  ListJobTemplatesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::JobTemplate, aws_smithy_http::result::SdkError<crate::error::ListJobTemplatesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_job_templates_output_templates(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListManagedEndpointsPaginator`
                ...
                impl  ListManagedEndpointsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Endpoint, aws_smithy_http::result::SdkError<crate::error::ListManagedEndpointsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_managed_endpoints_output_endpoints(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListVirtualClustersPaginator`
                ...
                impl  ListVirtualClustersPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::VirtualCluster, aws_smithy_http::result::SdkError<crate::error::ListVirtualClustersError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_structure_crate_output_list_virtual_clusters_output_virtual_clusters(page).unwrap_or_default().into_iter())
                    }
                }
