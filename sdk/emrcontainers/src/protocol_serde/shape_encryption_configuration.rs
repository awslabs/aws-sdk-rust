...
pub fn ser_encryption_configuration(
    ...
    if let Some(var_1) = &input.in_transit_encryption_configuration {
        #[allow(unused_mut)]
        let mut object_2 = object.key("inTransitEncryptionConfiguration").start_object();
        crate::protocol_serde::shape_in_transit_encryption_configuration::ser_in_transit_encryption_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
