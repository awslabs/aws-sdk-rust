...
pub fn ser_parametric_monitoring_configuration(
    ...
    if let Some(var_2) = &input.cloud_watch_monitoring_configuration {
        ...
        crate::protocol_serde::shape_parametric_cloud_watch_monitoring_configuration::ser_parametric_cloud_watch_monitoring_configuration(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "cloudWatchMonitoringConfiguration" => {
                            builder = builder.set_cloud_watch_monitoring_configuration(
                                    crate::protocol_serde::shape_parametric_cloud_watch_monitoring_configuration::de_parametric_cloud_watch_monitoring_configuration(tokens, _value, depth + 1)?
                                );
                        }
