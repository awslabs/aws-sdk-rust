...
pub fn ser_parametric_configuration_overrides(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ParametricConfigurationOverrides) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_parametric_configuration_overrides<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ParametricConfigurationOverrides>, aws_smithy_json::deserialize::error::DeserializeError>
