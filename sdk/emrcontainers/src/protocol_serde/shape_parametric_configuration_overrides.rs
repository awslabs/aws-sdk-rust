...
pub fn ser_parametric_configuration_overrides(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ParametricConfigurationOverrides) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_parametric_configuration_overrides<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ParametricConfigurationOverrides>, aws_smithy_json::deserialize::error::DeserializeError>
