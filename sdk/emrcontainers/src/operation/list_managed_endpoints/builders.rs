...
impl ListManagedEndpointsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_managed_endpoints::ListManagedEndpointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_managed_endpoints::ListManagedEndpointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_managed_endpoints::ListManagedEndpointsOutput, crate::operation::list_managed_endpoints::ListManagedEndpointsError, Self> {
