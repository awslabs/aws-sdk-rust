...
impl DescribeManagedEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_managed_endpoint::DescribeManagedEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
