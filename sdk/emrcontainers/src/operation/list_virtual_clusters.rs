...
/// Orchestration and serialization glue logic for `ListVirtualClusters`.
...
impl ListVirtualClusters {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_virtual_clusters::ListVirtualClustersInput,
                    ) -> ::std::result::Result<crate::operation::list_virtual_clusters::ListVirtualClustersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_virtual_clusters::ListVirtualClustersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_virtual_clusters::ListVirtualClustersError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_virtual_clusters::ListVirtualClustersOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVirtualClusters {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVirtualClusters");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVirtualClustersRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVirtualClustersResponseDeserializer));
...
.with_interceptor(ListVirtualClustersEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_virtual_clusters::ListVirtualClustersError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_virtual_clusters::ListVirtualClustersError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_virtual_clusters::ListVirtualClustersError>::new());
...
#[derive(Debug)]
            struct ListVirtualClustersResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVirtualClustersResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_virtual_clusters::de_list_virtual_clusters_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListVirtualClustersRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVirtualClustersRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_virtual_clusters::ListVirtualClustersInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_virtual_clusters::ListVirtualClustersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/virtualclusters").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_virtual_clusters::ListVirtualClustersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.created_before {
         {
            query.push_kv("createdBefore", &::aws_smithy_http::query::fmt_timestamp(inner_4, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVirtualClustersEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVirtualClustersInput>()
                        .ok_or("failed to downcast to ListVirtualClustersInput")?;
...
pub enum ListVirtualClustersError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVirtualClustersError) for what information is available for the error.")]
...
impl ListVirtualClustersError {
    /// Creates the `ListVirtualClustersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVirtualClustersError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVirtualClustersError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_virtual_clusters::ListVirtualClustersError {
...
mod _list_virtual_clusters_output;
