...
impl DeleteJobTemplateFluentBuilder  {
    /// Creates a new `DeleteJobTemplate`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_job_template::DeleteJobTemplateOutput, aws_smithy_http::result::SdkError<crate::operation::delete_job_template::DeleteJobTemplateError>>
                     {
