...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_virtual_cluster::UpdateVirtualClusterError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_virtual_cluster::UpdateVirtualClusterError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(crate::error::sealed_unhandled::Unhandled {
                meta: ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(&err).clone(),
...
impl From<crate::operation::update_virtual_cluster::UpdateVirtualClusterError> for Error {
    fn from(err: crate::operation::update_virtual_cluster::UpdateVirtualClusterError) -> Self {
        match err {
            crate::operation::update_virtual_cluster::UpdateVirtualClusterError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::update_virtual_cluster::UpdateVirtualClusterError::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
            crate::operation::update_virtual_cluster::UpdateVirtualClusterError::ValidationException(inner) => Error::ValidationException(inner),
            crate::operation::update_virtual_cluster::UpdateVirtualClusterError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
