...
pub(crate) fn de_list_engagement_by_accepting_invitation_task_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::ListEngagementByAcceptingInvitationTaskSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::ListEngagementByAcceptingInvitationTaskSummaryBuilder::default();
            loop {
                match tokens.next().transpose()? {
