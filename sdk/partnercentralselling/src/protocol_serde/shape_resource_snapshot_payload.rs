...
) -> Result<Option<crate::types::ResourceSnapshotPayload>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "OpportunitySummary" => Some(crate::types::ResourceSnapshotPayload::OpportunitySummary(
                            crate::protocol_serde::shape_opportunity_summary_view::de_opportunity_summary_view(tokens)?.ok_or_else(|| {
