...
impl ListEngagementsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `engagement_summary_list`. Queries to the underlying service
...
impl ListEngagementsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_engagements_output_output_engagement_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
