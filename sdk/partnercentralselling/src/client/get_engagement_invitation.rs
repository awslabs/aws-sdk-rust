...
impl super::Client {
    ...
    ///   - [`arn(Option<String>)`](crate::operation::get_engagement_invitation::GetEngagementInvitationOutput::arn): <p>The Amazon Resource Name (ARN) that identifies the engagement invitation.</p>
    ...
    ///   - [`engagement_title(Option<String>)`](crate::operation::get_engagement_invitation::GetEngagementInvitationOutput::engagement_title): <p>The title of the engagement invitation, summarizing the purpose or objectives of the opportunity shared by AWS.</p>
    ///   - [`status(Option<InvitationStatus>)`](crate::operation::get_engagement_invitation::GetEngagementInvitationOutput::status): <p>The current status of the engagement invitation.</p>
