...
impl super::Client {
    ...
    ///   - [`tags(Vec::<Tag>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>A map of the key-value pairs for the tag or tags assigned to the specified resource.</p>
