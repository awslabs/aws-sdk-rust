...
async fn operation_input_test_get_object_10() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("arn:aws:s3:us-west-2:123456789012:".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_15() {
    ...
    rcvr.expect_no_request();
    let error = _result
        .expect_err("expected error: S3 MRAP does not support FIPS [MRAP does not support FIPS]");
    assert!(
...
async fn operation_input_test_get_object_19() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("bucketname".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_22() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("99_ab".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_24() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("example.com#".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_60() {
    ...
    rcvr.expect_no_request();
    let error = _result.expect_err(
        "expected error: Accelerate cannot be used with FIPS [accelerate + fips = error@us-west-2]",
    );
    assert!(
...
async fn operation_input_test_get_object_71() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("bucket.with.dots".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_75() {
    ...
    let _result = dbg!(
        client
            .get_object()
            .set_bucket(Some("99a_b".to_owned()))
            .set_key(Some("key".to_owned()))
            .send()
            .await
    );
...
async fn operation_input_test_get_object_91() {
    ...
    let conf = {
        ...
        let builder = builder.region(aws_types::region::Region::new("us-west-2"));
        let builder = builder
            .endpoint_url("http://control.vpce-1a2b3c4d-5e6f.s3.us-west-2.vpce.amazonaws.com");
        builder.build()
    };
    let client = aws_sdk_s3::Client::from_conf(conf);
    let _result = dbg!(
...
#[tokio::test]
async fn operation_input_test_write_get_object_response_139() {
    /* builtIns: {
        "AWS::Region": "us-west-2"
    } */
    /* clientParams: {} */
    ...
    let _result = dbg!(
        client
            ...
            .set_request_route(Some("RequestRoute".to_owned()))
            .set_request_token(Some("RequestToken".to_owned()))
            .send()
            .await
    );
    let req = rcvr.expect_request();
...
#[tokio::test]
async fn operation_input_test_write_get_object_response_140() {
    /* builtIns: {
        "AWS::Region": "us-west-2",
        "SDK::Endpoint": "https://my-endpoint.com"
    } */
    ...
    let uri = req.uri().to_string();
    assert!(
        uri.starts_with("https://my-endpoint.com"),
        "expected URI to start with `https://my-endpoint.com` but it was `{}`",
        uri
    );
}

#[tokio::test]
async fn operation_input_test_write_get_object_response_141() {
    /* builtIns: {
        "AWS::Region": "us-east-1"
    } */
    /* clientParams: {} */
...
#[tokio::test]
async fn operation_input_test_write_get_object_response_142() {
    /* builtIns: {
        "AWS::Region": "us-east-1",
        "AWS::UseFIPS": true
    } */
...
#[tokio::test]
async fn operation_input_test_write_get_object_response_143() {
    /* builtIns: {
        "AWS::Region": "us-east-1",
        "AWS::UseDualStack": true
    } */
