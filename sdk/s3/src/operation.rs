...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod create_multipart_upload_request_test {
    ...
    #[tokio::test]async fn create_multipart_upload_uri_construction_request() {
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod get_bucket_location_request_test {
    /// This test case validates https://github.com/awslabs/aws-sdk-rust/issues/116
    /// Test ID: GetBucketLocation
    #[tokio::test]async fn get_bucket_location_response() {
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod head_bucket_request_test {
    /// This test case validates https://github.com/awslabs/smithy-rs/issues/456
    /// Test ID: HeadObjectEmptyBody
    #[tokio::test]async fn head_object_empty_body_response() {
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod head_object_request_test {
    /// https://github.com/awslabs/aws-sdk-rust/issues/331
    /// Test ID: HeadObjectUriEncoding
    #[tokio::test]async fn head_object_uri_encoding_request() {
        let config = crate::config::Config::builder().build();
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod list_objects_request_test {
    /// This test validates that parsing respects whitespace
    /// Test ID: KeysWithWhitespace
    #[tokio::test]async fn keys_with_whitespace_response() {
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod put_bucket_lifecycle_configuration_request_test {
    /// This test validates that the content md5 header is set correctly
    /// Test ID: PutBucketLifecycleConfiguration
    #[tokio::test]async fn put_bucket_lifecycle_configuration_request() {
        let config = crate::config::Config::builder().build();
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod put_object_request_test {
    ...
    #[tokio::test]async fn dont_send_duplicate_content_type_request() {
        let config = crate::config::Config::builder().build();
    ...
    #[tokio::test]async fn dont_send_duplicate_content_length_request() {
        let config = crate::config::Config::builder().build();
        let input =crate::input::PutObjectInput::builder()
        .set_bucket(
            Some(
