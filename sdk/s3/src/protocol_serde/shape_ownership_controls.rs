...
pub fn ser_ownership_controls(input: &crate::model::OwnershipControls, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ownership_controls(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::OwnershipControls, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
