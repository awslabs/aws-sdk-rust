...
pub fn ser_ownership_controls(input: &crate::types::OwnershipControls, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_ownership_controls(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::OwnershipControls, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::ownership_controls_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
