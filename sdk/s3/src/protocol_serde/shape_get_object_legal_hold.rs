...
pub fn de_get_object_legal_hold_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_object_legal_hold::GetObjectLegalHoldOutput, crate::operation::get_object_legal_hold::GetObjectLegalHoldError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_object_legal_hold::GetObjectLegalHoldError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_legal_hold_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_object_legal_hold::GetObjectLegalHoldOutput, crate::operation::get_object_legal_hold::GetObjectLegalHoldError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_legal_hold(
            crate::protocol_serde::shape_get_object_legal_hold_output::de_legal_hold_payload(response.body().as_ref())?
        );
