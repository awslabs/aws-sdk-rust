...
pub fn de_inventory_configuration_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::InventoryConfiguration>, crate::operation::get_bucket_inventory_configuration::GetBucketInventoryConfigurationError> {
    (!body.is_empty()).then(||{
