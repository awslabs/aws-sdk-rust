...
pub fn ser_replica_modifications(input: &crate::model::ReplicaModifications, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_replica_modifications(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReplicaModifications, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
