...
pub fn de_put_bucket_cors_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketCorsOutput, crate::error::PutBucketCorsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutBucketCorsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_cors_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketCorsOutput, crate::error::PutBucketCorsError> {
    Ok({
        #[allow(unused_mut)]
