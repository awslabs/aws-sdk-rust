...
pub fn ser_put_bucket_replication_headers(
    ...
    if let Some(inner_5) = &input.token {
...
pub fn de_put_bucket_replication_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketReplicationOutput, crate::error::PutBucketReplicationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutBucketReplicationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_replication_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketReplicationOutput, crate::error::PutBucketReplicationError> {
    Ok({
        #[allow(unused_mut)]
