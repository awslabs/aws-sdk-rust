...
pub fn de_get_object_torrent_op_response(
...
> {
    ...
    crate::protocol_serde::shape_get_object_torrent::de_get_object_torrent_http_response_with_props(
        response,
        &properties,
    )
}
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_get_object_torrent_http_response_with_props(
