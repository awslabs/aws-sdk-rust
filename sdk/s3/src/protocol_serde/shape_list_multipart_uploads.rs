...
#[allow(unused_mut)]
pub fn de_list_multipart_uploads(inp: &[u8], mut builder: crate::output::list_multipart_uploads_output::Builder) -> Result<crate::output::list_multipart_uploads_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
