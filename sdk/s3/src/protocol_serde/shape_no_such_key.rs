...
#[allow(unused_mut)]
pub fn de_no_such_key_xml_err(inp: &[u8], mut builder: crate::error::no_such_key::Builder) -> Result<crate::error::no_such_key::Builder, aws_smithy_xml::decode::XmlDecodeError> {
