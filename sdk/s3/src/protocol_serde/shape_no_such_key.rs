...
#[allow(unused_mut)]
pub fn de_no_such_key_xml_err(inp: &[u8], mut builder: crate::types::error::builders::NoSuchKeyBuilder) -> Result<crate::types::error::builders::NoSuchKeyBuilder, aws_smithy_xml::decode::XmlDecodeError> {
