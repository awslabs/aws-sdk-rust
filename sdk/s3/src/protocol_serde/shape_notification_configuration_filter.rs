...
pub fn de_notification_configuration_filter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::NotificationConfigurationFilter, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_notification_configuration_filter(input: &crate::model::NotificationConfigurationFilter, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
