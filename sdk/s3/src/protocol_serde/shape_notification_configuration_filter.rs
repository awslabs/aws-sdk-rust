...
pub fn ser_notification_configuration_filter(input: &crate::types::NotificationConfigurationFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
