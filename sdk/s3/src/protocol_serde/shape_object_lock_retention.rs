...
pub fn ser_object_lock_retention(input: &crate::types::ObjectLockRetention, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_object_lock_retention(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ObjectLockRetention, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
