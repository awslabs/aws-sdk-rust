...
pub fn ser_object_lock_retention(input: &crate::types::ObjectLockRetention, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
