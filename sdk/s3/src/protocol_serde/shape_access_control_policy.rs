...
pub fn ser_access_control_policy(input: &crate::types::AccessControlPolicy, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
