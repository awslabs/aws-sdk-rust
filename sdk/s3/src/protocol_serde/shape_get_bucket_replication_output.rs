...
pub(crate) fn de_replication_configuration_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ReplicationConfiguration>, crate::operation::get_bucket_replication::GetBucketReplicationError> {
    (!body.is_empty()).then(||{
