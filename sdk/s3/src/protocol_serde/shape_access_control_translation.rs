...
pub fn ser_access_control_translation(input: &crate::model::AccessControlTranslation, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_access_control_translation(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AccessControlTranslation, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
