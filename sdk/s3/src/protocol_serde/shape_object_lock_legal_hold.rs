...
pub fn ser_object_lock_legal_hold(input: &crate::model::ObjectLockLegalHold, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_object_lock_legal_hold(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ObjectLockLegalHold, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
