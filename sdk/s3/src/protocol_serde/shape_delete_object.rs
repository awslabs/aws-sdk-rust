...
pub fn de_delete_object_http_response(
    ...
    Ok({
        ...
        output = output.set_delete_marker(
            match crate::protocol_serde::shape_delete_object_output::de_delete_marker_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::delete_object::DeleteObjectError::unhandled(
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_delete_object_output::de_request_charged_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_version_id(
            match crate::protocol_serde::shape_delete_object_output::de_version_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
