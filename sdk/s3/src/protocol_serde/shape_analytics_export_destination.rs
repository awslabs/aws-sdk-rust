...
pub fn ser_analytics_export_destination(input: &crate::types::AnalyticsExportDestination, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
