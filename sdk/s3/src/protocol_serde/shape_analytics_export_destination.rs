...
pub fn de_analytics_export_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalyticsExportDestination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_analytics_export_destination(input: &crate::model::AnalyticsExportDestination, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
