...
pub fn de_put_bucket_logging_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketLoggingOutput, crate::error::PutBucketLoggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutBucketLoggingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_logging_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketLoggingOutput, crate::error::PutBucketLoggingError> {
    Ok({
        #[allow(unused_mut)]
