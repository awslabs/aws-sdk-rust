...
pub fn de_put_object_tagging_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectTaggingOutput, crate::error::PutObjectTaggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutObjectTaggingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_tagging_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectTaggingOutput, crate::error::PutObjectTaggingError> {
    Ok({
        #[allow(unused_mut)]
