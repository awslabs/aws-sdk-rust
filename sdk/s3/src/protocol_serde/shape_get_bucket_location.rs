...
pub fn de_get_bucket_location_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketLocationOutput, crate::error::GetBucketLocationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBucketLocationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_location_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketLocationOutput, crate::error::GetBucketLocationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_bucket_location_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket_location::de_get_bucket_location(response.body().as_ref(), output).map_err(crate::error::GetBucketLocationError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_bucket_location(inp: &[u8], mut builder: crate::output::get_bucket_location_output::Builder) -> Result<crate::output::get_bucket_location_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
