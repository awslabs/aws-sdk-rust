...
pub fn de_get_bucket_location_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_bucket_location::GetBucketLocationOutput, crate::operation::get_bucket_location::GetBucketLocationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_bucket_location::GetBucketLocationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_location_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_bucket_location::GetBucketLocationOutput, crate::operation::get_bucket_location::GetBucketLocationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_bucket_location::builders::GetBucketLocationOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket_location::de_get_bucket_location(response.body().as_ref(), output).map_err(crate::operation::get_bucket_location::GetBucketLocationError::unhandled)?;
