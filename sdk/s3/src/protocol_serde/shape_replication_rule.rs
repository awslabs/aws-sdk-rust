...
pub fn ser_replication_rule(input: &crate::model::ReplicationRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_replication_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReplicationRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
