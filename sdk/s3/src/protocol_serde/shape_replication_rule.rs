...
pub fn ser_replication_rule(input: &crate::types::ReplicationRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    ...
    if input.priority != 0 {
        ...
        inner_writer.data(
            aws_smithy_types::primitive::Encoder::from(input.priority).encode()
        );
    }
