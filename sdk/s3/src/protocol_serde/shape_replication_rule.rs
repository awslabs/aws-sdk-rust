...
pub fn ser_replication_rule(
    ...
    if let Some(var_4) = &input.source_selection_criteria {
        let inner_writer = scope.start_el("SourceSelectionCriteria");
        crate::protocol_serde::shape_source_selection_criteria::ser_source_selection_criteria(var_4, inner_writer)?
    }
    if let Some(var_5) = &input.existing_object_replication {
        let inner_writer = scope.start_el("ExistingObjectReplication");
        crate::protocol_serde::shape_existing_object_replication::ser_existing_object_replication(var_5, inner_writer)?
    }
    if let Some(var_6) = &input.destination {
        let inner_writer = scope.start_el("Destination");
        crate::protocol_serde::shape_destination::ser_destination(var_6, inner_writer)?
    }
    if let Some(var_7) = &input.delete_marker_replication {
        let inner_writer = scope.start_el("DeleteMarkerReplication");
        crate::protocol_serde::shape_delete_marker_replication::ser_delete_marker_replication(var_7, inner_writer)?
    }
    scope.finish();
    Ok(())
}
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Priority") /* Priority com.amazonaws.s3#ReplicationRule$Priority */ =>  {
                ...
                ;
                builder = builder.set_priority(var_9);
            }
            ,
            ...
            s if s.matches("SourceSelectionCriteria") /* SourceSelectionCriteria com.amazonaws.s3#ReplicationRule$SourceSelectionCriteria */ =>  {
                ...
                ;
                builder = builder.set_source_selection_criteria(var_13);
            }
            ,
            s if s.matches("ExistingObjectReplication") /* ExistingObjectReplication com.amazonaws.s3#ReplicationRule$ExistingObjectReplication */ =>  {
                ...
                ;
                builder = builder.set_existing_object_replication(var_14);
            }
            ,
            s if s.matches("Destination") /* Destination com.amazonaws.s3#ReplicationRule$Destination */ =>  {
                ...
                ;
                builder = builder.set_destination(var_15);
            }
            ,
            s if s.matches("DeleteMarkerReplication") /* DeleteMarkerReplication com.amazonaws.s3#ReplicationRule$DeleteMarkerReplication */ =>  {
                ...
                ;
                builder = builder.set_delete_marker_replication(var_16);
            }
            ,
            _ => {}
        }
