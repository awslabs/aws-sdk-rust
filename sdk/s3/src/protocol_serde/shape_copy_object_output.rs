...
pub fn de_copy_object_result_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::model::CopyObjectResult>, crate::error::CopyObjectError> {
    (!body.is_empty()).then(||{
        crate::protocol_serde::shape_copy_object_output::de_copy_object_result(body).map_err(crate::error::CopyObjectError::unhandled)
    }).transpose()
}
...
pub fn de_copy_object_result(inp: &[u8]) -> Result<crate::model::CopyObjectResult, aws_smithy_xml::decode::XmlDecodeError> {
