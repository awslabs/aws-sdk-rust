...
pub fn ser_metrics(input: &crate::types::Metrics, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metrics(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::Metrics, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::metrics_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
