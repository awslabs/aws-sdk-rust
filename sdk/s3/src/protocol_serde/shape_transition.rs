...
pub fn de_transition(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Transition, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_transition(input: &crate::model::Transition, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
