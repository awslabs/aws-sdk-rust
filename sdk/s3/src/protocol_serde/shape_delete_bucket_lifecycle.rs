...
pub fn de_delete_bucket_lifecycle_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteBucketLifecycleOutput, crate::error::DeleteBucketLifecycleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteBucketLifecycleError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_bucket_lifecycle_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteBucketLifecycleOutput, crate::error::DeleteBucketLifecycleError> {
    Ok({
        #[allow(unused_mut)]
