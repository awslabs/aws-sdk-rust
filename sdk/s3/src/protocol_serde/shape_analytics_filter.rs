...
pub fn ser_analytics_filter(input: &crate::types::AnalyticsFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::AnalyticsFilter::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("AnalyticsFilter"))
    }
    Ok(())
}
