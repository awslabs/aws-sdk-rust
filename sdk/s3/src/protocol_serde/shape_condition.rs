...
pub fn de_condition(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Condition, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_condition(input: &crate::model::Condition, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
