...
pub fn de_delete_objects_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteObjectsOutput, crate::error::DeleteObjectsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteObjectsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_objects_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteObjectsOutput, crate::error::DeleteObjectsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_objects_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_objects::de_delete_objects(response.body().as_ref(), output).map_err(crate::error::DeleteObjectsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_objects(inp: &[u8], mut builder: crate::output::delete_objects_output::Builder) -> Result<crate::output::delete_objects_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
