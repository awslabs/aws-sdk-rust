...
pub fn de_tiering(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Tiering, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_tiering(input: &crate::model::Tiering, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
