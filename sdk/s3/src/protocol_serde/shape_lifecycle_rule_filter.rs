...
pub fn ser_lifecycle_rule_filter(input: &crate::types::LifecycleRuleFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::LifecycleRuleFilter::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("LifecycleRuleFilter"))
    }
    Ok(())
}
