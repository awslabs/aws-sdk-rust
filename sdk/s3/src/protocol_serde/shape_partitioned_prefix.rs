...
pub fn de_partitioned_prefix(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PartitionedPrefix, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_partitioned_prefix(input: &crate::types::PartitionedPrefix, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
