...
pub fn ser_select_object_content_input_input(input: &crate::input::SelectObjectContentInput, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
