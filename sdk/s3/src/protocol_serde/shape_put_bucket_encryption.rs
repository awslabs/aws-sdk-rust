...
pub fn de_put_bucket_encryption_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketEncryptionOutput, crate::error::PutBucketEncryptionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutBucketEncryptionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_encryption_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketEncryptionOutput, crate::error::PutBucketEncryptionError> {
    Ok({
        #[allow(unused_mut)]
