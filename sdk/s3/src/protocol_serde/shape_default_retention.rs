...
pub fn ser_default_retention(input: &crate::types::DefaultRetention, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
