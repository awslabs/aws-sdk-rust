...
pub fn ser_default_retention(input: &crate::model::DefaultRetention, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_default_retention(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DefaultRetention, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
