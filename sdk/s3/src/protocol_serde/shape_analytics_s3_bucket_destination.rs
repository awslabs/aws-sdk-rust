...
pub fn de_analytics_s3_bucket_destination(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AnalyticsS3BucketDestination, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::analytics_s3_bucket_destination_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_analytics_s3_bucket_destination(input: &crate::types::AnalyticsS3BucketDestination, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
