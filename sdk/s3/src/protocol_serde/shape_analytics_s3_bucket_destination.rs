...
pub fn de_analytics_s3_bucket_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalyticsS3BucketDestination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_analytics_s3_bucket_destination(input: &crate::model::AnalyticsS3BucketDestination, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
