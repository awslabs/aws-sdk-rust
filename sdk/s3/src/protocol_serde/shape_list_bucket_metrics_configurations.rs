...
pub fn de_list_bucket_metrics_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListBucketMetricsConfigurationsOutput, crate::error::ListBucketMetricsConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListBucketMetricsConfigurationsError::unhandled)?;
    generic_builder = crate::s3_request_id::apply_extended_request_id(generic_builder, response.headers());
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    Err(crate::error::ListBucketMetricsConfigurationsError::generic(generic))
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_bucket_metrics_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListBucketMetricsConfigurationsOutput, crate::error::ListBucketMetricsConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_bucket_metrics_configurations_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_bucket_metrics_configurations::de_list_bucket_metrics_configurations(response.body().as_ref(), output).map_err(crate::error::ListBucketMetricsConfigurationsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_bucket_metrics_configurations(inp: &[u8], mut builder: crate::output::list_bucket_metrics_configurations_output::Builder) -> Result<crate::output::list_bucket_metrics_configurations_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
