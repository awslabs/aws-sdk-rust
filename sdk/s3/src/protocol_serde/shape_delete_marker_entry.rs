...
pub fn de_delete_marker_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeleteMarkerEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
