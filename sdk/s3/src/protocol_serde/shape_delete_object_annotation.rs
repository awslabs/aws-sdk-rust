...
> {
    Ok({
        ...
        output = output.set_object_version_id(
            match crate::protocol_serde::shape_delete_object_annotation_output::de_object_version_id_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::delete_object_annotation::DeleteObjectAnnotationError::unhandled(
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_delete_object_annotation_output::de_request_charged_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
