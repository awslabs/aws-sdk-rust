...
pub fn de_upload_part_copy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UploadPartCopyOutput, crate::error::UploadPartCopyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UploadPartCopyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_part_copy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UploadPartCopyOutput, crate::error::UploadPartCopyError> {
    Ok({
        #[allow(unused_mut)]
