...
#[allow(unused_mut)]
pub fn de_bucket_already_owned_by_you_xml_err(inp: &[u8], mut builder: crate::error::bucket_already_owned_by_you::Builder) -> Result<crate::error::bucket_already_owned_by_you::Builder, aws_smithy_xml::decode::XmlDecodeError> {
