...
pub fn de_ownership_controls_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::OwnershipControls>, crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsError> {
    (!body.is_empty()).then(||{
