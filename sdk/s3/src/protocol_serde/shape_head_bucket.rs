...
pub fn de_head_bucket_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::head_bucket::HeadBucketOutput, crate::operation::head_bucket::HeadBucketError> {
    Ok({
        ...
        output = output.set_access_point_alias(
            crate::protocol_serde::shape_head_bucket_output::de_access_point_alias_header(_response_headers)
                                        .map_err(|_|crate::operation::head_bucket::HeadBucketError::unhandled("Failed to parse AccessPointAlias from header `x-amz-access-point-alias"))?
        );
        output = output.set_bucket_location_name(
            crate::protocol_serde::shape_head_bucket_output::de_bucket_location_name_header(_response_headers)
                                        .map_err(|_|crate::operation::head_bucket::HeadBucketError::unhandled("Failed to parse BucketLocationName from header `x-amz-bucket-location-name"))?
        );
        output = output.set_bucket_location_type(
            crate::protocol_serde::shape_head_bucket_output::de_bucket_location_type_header(_response_headers)
                                        .map_err(|_|crate::operation::head_bucket::HeadBucketError::unhandled("Failed to parse BucketLocationType from header `x-amz-bucket-location-type"))?
        );
        output = output.set_bucket_region(
            crate::protocol_serde::shape_head_bucket_output::de_bucket_region_header(_response_headers)
                                        .map_err(|_|crate::operation::head_bucket::HeadBucketError::unhandled("Failed to parse BucketRegion from header `x-amz-bucket-region"))?
        );
