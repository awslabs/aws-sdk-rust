...
pub fn de_head_bucket_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::HeadBucketOutput, crate::error::HeadBucketError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::HeadBucketError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_not_found::de_not_found_xml_err(response.body().as_ref(), output).map_err(crate::error::HeadBucketError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_head_bucket_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::HeadBucketOutput, crate::error::HeadBucketError> {
    Ok({
        #[allow(unused_mut)]
