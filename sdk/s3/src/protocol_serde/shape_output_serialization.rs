...
pub fn ser_output_serialization(input: &crate::model::OutputSerialization, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
