...
pub fn de_metrics_and_operator(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricsAndOperator, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_metrics_and_operator(input: &crate::model::MetricsAndOperator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
