...
pub fn de_routing_rule(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::RoutingRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_routing_rule(input: &crate::types::RoutingRule, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
