...
pub fn de_routing_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::RoutingRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_routing_rule(input: &crate::model::RoutingRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
