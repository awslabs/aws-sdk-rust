...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_logging_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_bucket_logging::GetBucketLoggingOutput, crate::operation::get_bucket_logging::GetBucketLoggingError> {
...
pub fn de_get_bucket_logging(
    ...
    if !start_el.matches("BucketLoggingStatus") {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "encountered invalid XML root: expected BucketLoggingStatus but got {:?}. This is likely a bug in the SDK.",
            start_el
        )));
    }
