...
#[allow(unused_mut)]
pub fn de_no_such_upload_xml_err(inp: &[u8], mut builder: crate::types::error::builders::NoSuchUploadBuilder) -> Result<crate::types::error::builders::NoSuchUploadBuilder, aws_smithy_xml::decode::XmlDecodeError> {
