...
#[allow(unused_mut)]
pub fn de_no_such_upload_xml_err(inp: &[u8], mut builder: crate::error::no_such_upload::Builder) -> Result<crate::error::no_such_upload::Builder, aws_smithy_xml::decode::XmlDecodeError> {
