...
pub fn de_list_objects_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectsOutput, crate::error::ListObjectsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListObjectsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_bucket::de_no_such_bucket_xml_err(response.body().as_ref(), output).map_err(crate::error::ListObjectsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectsOutput, crate::error::ListObjectsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_objects_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_objects::de_list_objects(response.body().as_ref(), output).map_err(crate::error::ListObjectsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_objects(inp: &[u8], mut builder: crate::output::list_objects_output::Builder) -> Result<crate::output::list_objects_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
