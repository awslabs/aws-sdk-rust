...
pub fn de_list_objects_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_objects::ListObjectsOutput, crate::operation::list_objects::ListObjectsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_objects::ListObjectsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_bucket::de_no_such_bucket_xml_err(_response_body, output).map_err(crate::operation::list_objects::ListObjectsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_objects::ListObjectsOutput, crate::operation::list_objects::ListObjectsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_objects::builders::ListObjectsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_objects::de_list_objects(_response_body, output).map_err(crate::operation::list_objects::ListObjectsError::unhandled)?;
        output = output.set_request_charged(
            crate::protocol_serde::shape_list_objects_output::de_request_charged_header(_response_headers)
                                        .map_err(|_|crate::operation::list_objects::ListObjectsError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
