...
#[allow(unused_mut)]
pub fn de_object_not_in_active_tier_error_xml_err(inp: &[u8], mut builder: crate::error::object_not_in_active_tier_error::Builder) -> Result<crate::error::object_not_in_active_tier_error::Builder, aws_smithy_xml::decode::XmlDecodeError> {
