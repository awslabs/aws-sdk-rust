...
pub fn de_logging_enabled(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LoggingEnabled, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_logging_enabled(input: &crate::model::LoggingEnabled, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
