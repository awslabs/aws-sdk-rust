...
pub fn ser_existing_object_replication(input: &crate::model::ExistingObjectReplication, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_existing_object_replication(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ExistingObjectReplication, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
