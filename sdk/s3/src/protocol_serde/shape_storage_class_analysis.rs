...
pub fn ser_storage_class_analysis(input: &crate::types::StorageClassAnalysis, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
