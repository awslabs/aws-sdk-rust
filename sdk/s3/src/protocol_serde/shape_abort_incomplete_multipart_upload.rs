...
pub fn ser_abort_incomplete_multipart_upload(input: &crate::types::AbortIncompleteMultipartUpload, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
