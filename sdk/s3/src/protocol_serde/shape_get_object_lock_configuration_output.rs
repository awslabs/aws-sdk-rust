...
pub(crate) fn de_object_lock_configuration_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::ObjectLockConfiguration>, crate::operation::get_object_lock_configuration::GetObjectLockConfigurationError> {
    (!body.is_empty()).then(||{
