...
pub fn ser_destination(input: &crate::model::Destination, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Destination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
