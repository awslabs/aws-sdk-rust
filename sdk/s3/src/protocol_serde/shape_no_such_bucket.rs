...
#[allow(unused_mut)]
pub fn de_no_such_bucket_xml_err(inp: &[u8], mut builder: crate::error::no_such_bucket::Builder) -> Result<crate::error::no_such_bucket::Builder, aws_smithy_xml::decode::XmlDecodeError> {
