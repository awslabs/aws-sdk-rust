...
#[allow(unused_mut)]
pub fn de_no_such_bucket_xml_err(inp: &[u8], mut builder: crate::types::error::builders::NoSuchBucketBuilder) -> Result<crate::types::error::builders::NoSuchBucketBuilder, aws_smithy_xml::decode::XmlDecodeError> {
