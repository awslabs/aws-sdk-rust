...
pub fn ser_server_side_encryption_by_default(input: &crate::model::ServerSideEncryptionByDefault, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_server_side_encryption_by_default(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServerSideEncryptionByDefault, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
