...
pub fn de_inventory_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InventoryConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_inventory_configuration(input: &crate::model::InventoryConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
