...
pub fn de_get_object_tagging_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetObjectTaggingOutput, crate::error::GetObjectTaggingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetObjectTaggingError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_tagging_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetObjectTaggingOutput, crate::error::GetObjectTaggingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_object_tagging_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_object_tagging::de_get_object_tagging(response.body().as_ref(), output).map_err(crate::error::GetObjectTaggingError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_object_tagging(inp: &[u8], mut builder: crate::output::get_object_tagging_output::Builder) -> Result<crate::output::get_object_tagging_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
