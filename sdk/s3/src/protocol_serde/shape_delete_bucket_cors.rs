...
pub fn de_delete_bucket_cors_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteBucketCorsOutput, crate::error::DeleteBucketCorsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteBucketCorsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_bucket_cors_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteBucketCorsOutput, crate::error::DeleteBucketCorsError> {
    Ok({
        #[allow(unused_mut)]
