...
pub fn de_owner(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Owner, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_owner(input: &crate::model::Owner, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
