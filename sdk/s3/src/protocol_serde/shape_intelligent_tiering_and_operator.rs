...
pub fn de_intelligent_tiering_and_operator(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IntelligentTieringAndOperator, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_intelligent_tiering_and_operator(input: &crate::model::IntelligentTieringAndOperator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
