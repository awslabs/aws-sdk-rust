...
pub fn ser_intelligent_tiering_and_operator(input: &crate::types::IntelligentTieringAndOperator, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
