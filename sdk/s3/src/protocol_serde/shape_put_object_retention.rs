...
pub fn de_put_object_retention_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object_retention::PutObjectRetentionOutput, crate::operation::put_object_retention::PutObjectRetentionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_retention_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object_retention::PutObjectRetentionOutput, crate::operation::put_object_retention::PutObjectRetentionError> {
    Ok({
        #[allow(unused_mut)]
    ...
    if let ::std::option::Option::Some(inner_3) = &input.bypass_governance_retention {
        ...
        let formatted_4 = encoder.encode();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("bypass_governance_retention", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
