...
pub fn de_list_objects_v2_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectsV2Output, crate::error::ListObjectsV2Error> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListObjectsV2Error::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_bucket::de_no_such_bucket_xml_err(response.body().as_ref(), output).map_err(crate::error::ListObjectsV2Error::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_v2_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectsV2Output, crate::error::ListObjectsV2Error> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_objects_v2_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_objects_v2::de_list_objects_v2(response.body().as_ref(), output).map_err(crate::error::ListObjectsV2Error::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_objects_v2(inp: &[u8], mut builder: crate::output::list_objects_v2_output::Builder) -> Result<crate::output::list_objects_v2_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
