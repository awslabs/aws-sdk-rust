...
pub fn de_list_objects_v2_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, crate::operation::list_objects_v2::ListObjectsV2Error> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_bucket::de_no_such_bucket_xml_err(_response_body, output).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_v2_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, crate::operation::list_objects_v2::ListObjectsV2Error> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder::default();
        output = crate::protocol_serde::shape_list_objects_v2::de_list_objects_v2(_response_body, output).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
        output = output.set_request_charged(
            crate::protocol_serde::shape_list_objects_v2_output::de_request_charged_header(_response_headers)
                                        .map_err(|_|crate::operation::list_objects_v2::ListObjectsV2Error::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
        ...
        for inner_6 in inner_5 {
            let formatted_7 = ::aws_smithy_http::header::quote_header_value(inner_6.as_str());
                            if !formatted_7.is_empty() {
                                ...
                                let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                    ::aws_smithy_types::error::operation::BuildError::invalid_field("optional_object_attributes", format!(
                                    "`{}` cannot be used as a header value: {}",
                                    &header_value,
                                    err
                                ))
...
#[allow(unused_mut)]
pub fn de_list_objects_v2(inp: &[u8], mut builder: crate::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder) -> Result<crate::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
