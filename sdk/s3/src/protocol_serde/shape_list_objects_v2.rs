...
pub fn de_list_objects_v2_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, crate::operation::list_objects_v2::ListObjectsV2Error> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_bucket::de_no_such_bucket_xml_err(response.body().as_ref(), output).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_v2_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, crate::operation::list_objects_v2::ListObjectsV2Error> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_objects_v2::builders::ListObjectsV2OutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_objects_v2::de_list_objects_v2(response.body().as_ref(), output).map_err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled)?;
