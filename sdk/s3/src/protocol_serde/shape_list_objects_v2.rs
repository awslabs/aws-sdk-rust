...
pub fn de_list_objects_v2_http_response(
    ...
    Ok({
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_list_objects_v2_output::de_request_charged_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::list_objects_v2::ListObjectsV2Error::unhandled(
