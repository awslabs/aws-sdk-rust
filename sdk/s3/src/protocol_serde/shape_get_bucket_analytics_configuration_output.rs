...
pub(crate) fn de_analytics_configuration_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::AnalyticsConfiguration>, crate::operation::get_bucket_analytics_configuration::GetBucketAnalyticsConfigurationError> {
    (!body.is_empty()).then(||{
