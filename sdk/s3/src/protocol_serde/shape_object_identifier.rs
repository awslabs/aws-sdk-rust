...
pub fn ser_object_identifier(input: &crate::model::ObjectIdentifier, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
