...
pub fn de_upload_part_http_response(
    ...
    Ok({
        ...
        output = output.set_bucket_key_enabled(
            match crate::protocol_serde::shape_upload_part_output::de_bucket_key_enabled_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::upload_part::UploadPartError::unhandled(
        ...
        output = output.set_checksum_crc32(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_crc32_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_crc32_c(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_crc32_c_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_crc64_nvme(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_crc64_nvme_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_md5(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_md5_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha1(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_sha1_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha256(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_sha256_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha512(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_sha512_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash128(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_xxhash128_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash3(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_xxhash3_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash64(
            match crate::protocol_serde::shape_upload_part_output::de_checksum_xxhash64_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_e_tag(
            match crate::protocol_serde::shape_upload_part_output::de_e_tag_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_upload_part_output::de_request_charged_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_sse_customer_algorithm(
            match crate::protocol_serde::shape_upload_part_output::de_sse_customer_algorithm_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_sse_customer_key_md5(
            match crate::protocol_serde::shape_upload_part_output::de_sse_customer_key_md5_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_ssekms_key_id(
            match crate::protocol_serde::shape_upload_part_output::de_ssekms_key_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_server_side_encryption(
            match crate::protocol_serde::shape_upload_part_output::de_server_side_encryption_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
