...
pub fn de_upload_part_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UploadPartOutput, crate::error::UploadPartError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UploadPartError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_part_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UploadPartOutput, crate::error::UploadPartError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_checksum_crc32(
            crate::protocol_serde::shape_upload_part_output::de_checksum_crc32_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse ChecksumCRC32 from header `x-amz-checksum-crc32"))?
        );
        output = output.set_checksum_crc32_c(
            crate::protocol_serde::shape_upload_part_output::de_checksum_crc32_c_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse ChecksumCRC32C from header `x-amz-checksum-crc32c"))?
        );
        output = output.set_checksum_sha1(
            crate::protocol_serde::shape_upload_part_output::de_checksum_sha1_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse ChecksumSHA1 from header `x-amz-checksum-sha1"))?
        );
        output = output.set_checksum_sha256(
            crate::protocol_serde::shape_upload_part_output::de_checksum_sha256_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse ChecksumSHA256 from header `x-amz-checksum-sha256"))?
        );
        output = output.set_e_tag(
            crate::protocol_serde::shape_upload_part_output::de_e_tag_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse ETag from header `ETag"))?
        );
        output = output.set_request_charged(
            crate::protocol_serde::shape_upload_part_output::de_request_charged_header(response.headers())
                                    .map_err(|_|crate::error::UploadPartError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
