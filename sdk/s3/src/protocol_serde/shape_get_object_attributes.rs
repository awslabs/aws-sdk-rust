        ...
        let formatted_2 = encoder.encode();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("max_parts", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.part_number_marker {
        let formatted_4 = inner_3.as_str();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("part_number_marker", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
        ...
        for inner_16 in inner_15 {
            let formatted_17 = ::aws_smithy_http::header::quote_header_value(inner_16.as_str());
                            if !formatted_17.is_empty() {
                                ...
                                let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                    ::aws_smithy_types::error::operation::BuildError::invalid_field("object_attributes", format!(
                                    "`{}` cannot be used as a header value: {}",
                                    &header_value,
                                    err
                                ))
