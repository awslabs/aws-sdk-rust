            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(response.body().as_ref(), output).map_err(crate::error::GetObjectAttributesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_object_attributes(inp: &[u8], mut builder: crate::output::get_object_attributes_output::Builder) -> Result<crate::output::get_object_attributes_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
