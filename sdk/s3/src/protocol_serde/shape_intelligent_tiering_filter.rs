...
pub fn ser_intelligent_tiering_filter(input: &crate::types::IntelligentTieringFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
