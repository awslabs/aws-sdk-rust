...
pub fn de_queue_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::QueueConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_queue_configuration(input: &crate::model::QueueConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
