...
pub fn de_target_object_key_format(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::TargetObjectKeyFormat, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_target_object_key_format(input: &crate::types::TargetObjectKeyFormat, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
