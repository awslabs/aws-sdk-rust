...
pub fn de_metrics_filter(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MetricsFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
...
pub fn ser_metrics_filter(input: &crate::types::MetricsFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::MetricsFilter::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("MetricsFilter"))
    }
    Ok(())
}
