...
pub fn ser_metrics_filter(input: &crate::types::MetricsFilter, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::MetricsFilter::Unknown => return Err(aws_smithy_http::operation::error::SerializationError::unknown_variant("MetricsFilter"))
    }
    Ok(())
}
