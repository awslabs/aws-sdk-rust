...
pub fn de_storage_class_analysis_data_export(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::StorageClassAnalysisDataExport, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::storage_class_analysis_data_export_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_storage_class_analysis_data_export(input: &crate::types::StorageClassAnalysisDataExport, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
