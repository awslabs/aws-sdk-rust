...
pub fn de_get_bucket_notification_configuration_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketNotificationConfigurationOutput, crate::error::GetBucketNotificationConfigurationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBucketNotificationConfigurationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_notification_configuration_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketNotificationConfigurationOutput, crate::error::GetBucketNotificationConfigurationError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_bucket_notification_configuration_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket_notification_configuration::de_get_bucket_notification_configuration(response.body().as_ref(), output).map_err(crate::error::GetBucketNotificationConfigurationError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_bucket_notification_configuration(inp: &[u8], mut builder: crate::output::get_bucket_notification_configuration_output::Builder) -> Result<crate::output::get_bucket_notification_configuration_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
