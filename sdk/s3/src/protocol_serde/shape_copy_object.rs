...
pub fn de_copy_object_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_object::CopyObjectOutput, crate::operation::copy_object::CopyObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::copy_object::CopyObjectError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_object_not_in_active_tier_error::de_object_not_in_active_tier_error_xml_err(_response_body, output).map_err(crate::operation::copy_object::CopyObjectError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_object_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_object::CopyObjectOutput, crate::operation::copy_object::CopyObjectError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::copy_object::builders::CopyObjectOutputBuilder::default();
        output = output.set_bucket_key_enabled(
            crate::protocol_serde::shape_copy_object_output::de_bucket_key_enabled_header(_response_headers)
        ...
        output = output.set_request_charged(
            crate::protocol_serde::shape_copy_object_output::de_request_charged_header(_response_headers)
        ...
        output = output.set_ssekms_key_id(
            crate::protocol_serde::shape_copy_object_output::de_ssekms_key_id_header(_response_headers)
    ...
    if let ::std::option::Option::Some(inner_15) = &input.copy_source {
        let formatted_16 = inner_15.as_str();
                        if !formatted_16.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_17) = &input.copy_source_if_match {
        let formatted_18 = inner_17.as_str();
                        if !formatted_18.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_if_match", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_19) = &input.copy_source_if_modified_since {
        let formatted_20 = inner_19.fmt(::aws_smithy_types::date_time::Format::HttpDate)?;
                        if !formatted_20.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_if_modified_since", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_21) = &input.copy_source_if_none_match {
        let formatted_22 = inner_21.as_str();
                        if !formatted_22.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_if_none_match", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_23) = &input.copy_source_if_unmodified_since {
        let formatted_24 = inner_23.fmt(::aws_smithy_types::date_time::Format::HttpDate)?;
                        if !formatted_24.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_if_unmodified_since", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_35) = &input.metadata_directive {
        let formatted_36 = inner_35.as_str();
                        if !formatted_36.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("metadata_directive", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_37) = &input.tagging_directive {
        let formatted_38 = inner_37.as_str();
                        if !formatted_38.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("tagging_directive", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_57) = &input.copy_source_sse_customer_algorithm {
        let formatted_58 = inner_57.as_str();
                        if !formatted_58.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_sse_customer_algorithm", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_59) = &input.copy_source_sse_customer_key {
        let formatted_60 = inner_59.as_str();
                        if !formatted_60.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_sse_customer_key", format!(
                                "`{}` cannot be used as a header value: {}",
                                &"*** Sensitive Data Redacted ***",
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_61) = &input.copy_source_sse_customer_key_md5 {
        let formatted_62 = inner_61.as_str();
                        if !formatted_62.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("copy_source_sse_customer_key_md5", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_75) = &input.expected_source_bucket_owner {
        let formatted_76 = inner_75.as_str();
                        if !formatted_76.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("expected_source_bucket_owner", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
