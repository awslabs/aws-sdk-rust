...
pub fn de_copy_object_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CopyObjectOutput, crate::error::CopyObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::CopyObjectError::unhandled)?;
    ...
    Err(match error_code {
        "ObjectNotInActiveTierError" => crate::error::CopyObjectError::ObjectNotInActiveTierError({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_object_not_in_active_tier_error::de_object_not_in_active_tier_error_xml_err(response.body().as_ref(), output).map_err(crate::error::CopyObjectError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_object_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CopyObjectOutput, crate::error::CopyObjectError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_expiration(
            crate::protocol_serde::shape_copy_object_output::de_expiration_header(response.headers())
                                    .map_err(|_|crate::error::CopyObjectError::unhandled("Failed to parse Expiration from header `x-amz-expiration"))?
        );
        output = output.set_request_charged(
            crate::protocol_serde::shape_copy_object_output::de_request_charged_header(response.headers())
                                    .map_err(|_|crate::error::CopyObjectError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
        ...
        output = output.set_version_id(
            crate::protocol_serde::shape_copy_object_output::de_version_id_header(response.headers())
                                    .map_err(|_|crate::error::CopyObjectError::unhandled("Failed to parse VersionId from header `x-amz-version-id"))?
        );
