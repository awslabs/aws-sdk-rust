...
pub fn ser_restore_request(input: &crate::model::RestoreRequest, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
