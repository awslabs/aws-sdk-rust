...
pub fn ser_target_grant(input: &crate::model::TargetGrant, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_target_grant(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::TargetGrant, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
