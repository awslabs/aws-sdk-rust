...
pub fn de_filter_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::FilterRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_filter_rule(input: &crate::model::FilterRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
