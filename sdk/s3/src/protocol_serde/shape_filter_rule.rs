...
pub fn de_filter_rule(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::FilterRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_filter_rule(input: &crate::types::FilterRule, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
