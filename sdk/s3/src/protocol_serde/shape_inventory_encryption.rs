...
pub fn de_inventory_encryption(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InventoryEncryption, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_inventory_encryption(input: &crate::model::InventoryEncryption, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
