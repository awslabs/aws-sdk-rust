...
pub fn ser_inventory_encryption(input: &crate::types::InventoryEncryption, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
