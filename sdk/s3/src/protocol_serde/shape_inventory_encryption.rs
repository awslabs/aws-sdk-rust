...
pub fn de_inventory_encryption(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::InventoryEncryption, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_inventory_encryption(input: &crate::types::InventoryEncryption, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
