...
pub fn de_s3_key_filter(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::S3KeyFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_s3_key_filter(input: &crate::types::S3KeyFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
