...
pub fn ser_s3_key_filter(input: &crate::types::S3KeyFilter, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
