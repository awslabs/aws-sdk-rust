...
pub fn de_put_bucket_request_payment_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput, crate::operation::put_bucket_request_payment::PutBucketRequestPaymentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::put_bucket_request_payment::PutBucketRequestPaymentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_request_payment_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput, crate::operation::put_bucket_request_payment::PutBucketRequestPaymentError> {
    Ok({
        #[allow(unused_mut)]
