...
#[allow(unused_mut)]
pub fn de_invalid_object_state_xml_err(inp: &[u8], mut builder: crate::types::error::builders::InvalidObjectStateBuilder) -> Result<crate::types::error::builders::InvalidObjectStateBuilder, aws_smithy_xml::decode::XmlDecodeError> {
