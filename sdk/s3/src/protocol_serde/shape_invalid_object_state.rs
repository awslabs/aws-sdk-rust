...
#[allow(unused_mut)]
pub fn de_invalid_object_state_xml_err(inp: &[u8], mut builder: crate::error::invalid_object_state::Builder) -> Result<crate::error::invalid_object_state::Builder, aws_smithy_xml::decode::XmlDecodeError> {
