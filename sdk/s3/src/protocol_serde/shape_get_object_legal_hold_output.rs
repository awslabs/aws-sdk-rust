...
pub fn de_legal_hold_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::ObjectLockLegalHold>, crate::operation::get_object_legal_hold::GetObjectLegalHoldError> {
    (!body.is_empty()).then(||{
