...
pub fn de_inventory_schedule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InventorySchedule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_inventory_schedule(input: &crate::model::InventorySchedule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
