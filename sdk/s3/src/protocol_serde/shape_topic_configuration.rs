...
pub fn ser_topic_configuration(input: &crate::types::TopicConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_7) = &input.topic_arn {
