...
pub fn de_inventory_s3_bucket_destination(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InventoryS3BucketDestination, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_inventory_s3_bucket_destination(input: &crate::model::InventoryS3BucketDestination, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
