...
pub fn de_get_bucket_acl_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketAclOutput, crate::error::GetBucketAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBucketAclError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_acl_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketAclOutput, crate::error::GetBucketAclError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_bucket_acl_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket_acl::de_get_bucket_acl(response.body().as_ref(), output).map_err(crate::error::GetBucketAclError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_bucket_acl(inp: &[u8], mut builder: crate::output::get_bucket_acl_output::Builder) -> Result<crate::output::get_bucket_acl_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
