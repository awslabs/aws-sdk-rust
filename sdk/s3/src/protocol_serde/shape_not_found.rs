...
#[allow(unused_mut)]
pub fn de_not_found_xml_err(inp: &[u8], mut builder: crate::error::not_found::Builder) -> Result<crate::error::not_found::Builder, aws_smithy_xml::decode::XmlDecodeError> {
