...
#[allow(unused_mut)]
pub fn de_not_found_xml_err(inp: &[u8], mut builder: crate::types::error::builders::NotFoundBuilder) -> Result<crate::types::error::builders::NotFoundBuilder, aws_smithy_xml::decode::XmlDecodeError> {
