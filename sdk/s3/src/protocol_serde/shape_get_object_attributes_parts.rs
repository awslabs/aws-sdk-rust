...
pub fn de_get_object_attributes_parts(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::GetObjectAttributesParts, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
