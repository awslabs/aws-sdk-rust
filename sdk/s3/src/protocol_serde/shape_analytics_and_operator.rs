...
pub fn de_analytics_and_operator(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AnalyticsAndOperator, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_analytics_and_operator(input: &crate::types::AnalyticsAndOperator, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
