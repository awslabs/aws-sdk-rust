...
pub fn ser_analytics_and_operator(input: &crate::types::AnalyticsAndOperator, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
