...
pub fn de_list_object_versions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectVersionsOutput, crate::error::ListObjectVersionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListObjectVersionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_object_versions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListObjectVersionsOutput, crate::error::ListObjectVersionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_object_versions_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_object_versions::de_list_object_versions(response.body().as_ref(), output).map_err(crate::error::ListObjectVersionsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_object_versions(inp: &[u8], mut builder: crate::output::list_object_versions_output::Builder) -> Result<crate::output::list_object_versions_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
