...
pub fn de_lambda_function_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::LambdaFunctionConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_lambda_function_configuration(input: &crate::model::LambdaFunctionConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
