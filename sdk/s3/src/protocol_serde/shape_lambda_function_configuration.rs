...
pub fn ser_lambda_function_configuration(input: &crate::types::LambdaFunctionConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
