...
pub fn de_analytics_configuration(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AnalyticsConfiguration, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::analytics_configuration_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_analytics_configuration(input: &crate::types::AnalyticsConfiguration, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
