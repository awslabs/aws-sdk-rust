...
pub fn de_analytics_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnalyticsConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_analytics_configuration(input: &crate::model::AnalyticsConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
