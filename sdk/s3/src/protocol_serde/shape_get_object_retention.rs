...
pub fn de_get_object_retention_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetObjectRetentionOutput, crate::error::GetObjectRetentionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetObjectRetentionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_object_retention_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetObjectRetentionOutput, crate::error::GetObjectRetentionError> {
    Ok({
        #[allow(unused_mut)]
