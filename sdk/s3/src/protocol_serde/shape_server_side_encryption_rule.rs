...
pub fn ser_server_side_encryption_rule(input: &crate::model::ServerSideEncryptionRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_server_side_encryption_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ServerSideEncryptionRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
