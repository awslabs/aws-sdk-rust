...
pub fn ser_server_side_encryption_rule(input: &crate::types::ServerSideEncryptionRule, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
