    ...
    Ok({
        ...
        output = output.set_abort_date(
            crate::protocol_serde::shape_list_parts_output::de_abort_date_header(response.headers())
                                    .map_err(|_|crate::error::ListPartsError::unhandled("Failed to parse AbortDate from header `x-amz-abort-date"))?
        );
        output = output.set_abort_rule_id(
            crate::protocol_serde::shape_list_parts_output::de_abort_rule_id_header(response.headers())
                                    .map_err(|_|crate::error::ListPartsError::unhandled("Failed to parse AbortRuleId from header `x-amz-abort-rule-id"))?
        );
        output = output.set_request_charged(
            crate::protocol_serde::shape_list_parts_output::de_request_charged_header(response.headers())
                                    .map_err(|_|crate::error::ListPartsError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
...
#[allow(unused_mut)]
pub fn de_list_parts(inp: &[u8], mut builder: crate::output::list_parts_output::Builder) -> Result<crate::output::list_parts_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
