...
pub fn ser_replication_time(input: &crate::model::ReplicationTime, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_replication_time(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ReplicationTime, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
