...
pub fn ser_replication_time(input: &crate::types::ReplicationTime, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_replication_time(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ReplicationTime, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::replication_time_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}
