...
pub fn de_get_bucket_cors_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketCorsOutput, crate::error::GetBucketCorsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBucketCorsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_bucket_cors_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBucketCorsOutput, crate::error::GetBucketCorsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_bucket_cors_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_bucket_cors::de_get_bucket_cors(response.body().as_ref(), output).map_err(crate::error::GetBucketCorsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_bucket_cors(inp: &[u8], mut builder: crate::output::get_bucket_cors_output::Builder) -> Result<crate::output::get_bucket_cors_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
