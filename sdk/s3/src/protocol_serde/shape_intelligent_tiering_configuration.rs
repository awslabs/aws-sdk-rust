...
pub fn de_intelligent_tiering_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::IntelligentTieringConfiguration, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_intelligent_tiering_configuration(input: &crate::model::IntelligentTieringConfiguration, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
