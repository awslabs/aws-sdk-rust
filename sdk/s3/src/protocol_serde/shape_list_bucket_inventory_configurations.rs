...
pub fn de_list_bucket_inventory_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListBucketInventoryConfigurationsOutput, crate::error::ListBucketInventoryConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListBucketInventoryConfigurationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_bucket_inventory_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListBucketInventoryConfigurationsOutput, crate::error::ListBucketInventoryConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_bucket_inventory_configurations_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_bucket_inventory_configurations::de_list_bucket_inventory_configurations(response.body().as_ref(), output).map_err(crate::error::ListBucketInventoryConfigurationsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_bucket_inventory_configurations(inp: &[u8], mut builder: crate::output::list_bucket_inventory_configurations_output::Builder) -> Result<crate::output::list_bucket_inventory_configurations_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
