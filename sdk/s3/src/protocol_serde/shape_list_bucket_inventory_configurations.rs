...
pub fn de_list_bucket_inventory_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsOutput, crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_bucket_inventory_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsOutput, crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_bucket_inventory_configurations::de_list_bucket_inventory_configurations(response.body().as_ref(), output).map_err(crate::operation::list_bucket_inventory_configurations::ListBucketInventoryConfigurationsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_bucket_inventory_configurations(inp: &[u8], mut builder: crate::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder) -> Result<crate::operation::list_bucket_inventory_configurations::builders::ListBucketInventoryConfigurationsOutputBuilder, aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("InventoryConfiguration") /* InventoryConfigurationList com.amazonaws.s3.synthetic#ListBucketInventoryConfigurationsOutput$InventoryConfigurationList */ =>  {
                ...
                ;
                builder = builder.set_inventory_configuration_list(var_6);
            }
            ,
            _ => {}
        }
