...
pub fn de_cors_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CorsRule, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_cors_rule(input: &crate::model::CorsRule, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
