...
pub fn de_cors_rule(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::CorsRule, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    Ok(crate::serde_util::cors_rule_correct_errors(builder).build().map_err(|_|::aws_smithy_xml::decode::XmlDecodeError::custom("missing field"))?)
}

pub fn ser_cors_rule(input: &crate::types::CorsRule, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
