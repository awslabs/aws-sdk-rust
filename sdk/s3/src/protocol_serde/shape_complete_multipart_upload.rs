...
pub fn de_complete_multipart_upload_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CompleteMultipartUploadOutput, crate::error::CompleteMultipartUploadError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload(response.body().as_ref(), output).map_err(crate::error::CompleteMultipartUploadError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_complete_multipart_upload(inp: &[u8], mut builder: crate::output::complete_multipart_upload_output::Builder) -> Result<crate::output::complete_multipart_upload_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
