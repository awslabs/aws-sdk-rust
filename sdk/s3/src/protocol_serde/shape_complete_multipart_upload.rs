        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("checksum_crc32", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.checksum_crc32_c {
        let formatted_4 = inner_3.as_str();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("checksum_crc32_c", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_5) = &input.checksum_sha1 {
        let formatted_6 = inner_5.as_str();
                        if !formatted_6.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("checksum_sha1", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_7) = &input.checksum_sha256 {
        let formatted_8 = inner_7.as_str();
                        if !formatted_8.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("checksum_sha256", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
