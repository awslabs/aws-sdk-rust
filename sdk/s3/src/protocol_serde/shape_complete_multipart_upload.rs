...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_complete_multipart_upload::de_complete_multipart_upload(
        ...
        output = output.set_expiration(
            crate::protocol_serde::shape_complete_multipart_upload_output::de_expiration_header(
                response.headers(),
            )
            .map_err(|_| {
        ...
        output = output.set_version_id(
            crate::protocol_serde::shape_complete_multipart_upload_output::de_version_id_header(
                response.headers(),
            )
            .map_err(|_| {
                crate::error::CompleteMultipartUploadError::unhandled(
