...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_acl_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError> {
    Ok({
        #[allow(unused_mut)]
