...
pub fn de_put_object_acl_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectAclOutput, crate::error::PutObjectAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutObjectAclError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(response.body().as_ref(), output).map_err(crate::error::PutObjectAclError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_acl_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectAclOutput, crate::error::PutObjectAclError> {
    Ok({
        #[allow(unused_mut)]
