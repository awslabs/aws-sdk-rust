...
pub fn de_put_object_acl_http_response(
    ...
    Ok({
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_put_object_acl_output::de_request_charged_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::put_object_acl::PutObjectAclError::unhandled(
