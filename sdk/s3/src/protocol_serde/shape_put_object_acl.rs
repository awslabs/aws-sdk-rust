...
pub fn de_put_object_acl_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::put_object_acl::PutObjectAclError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(response.body().as_ref(), output).map_err(crate::operation::put_object_acl::PutObjectAclError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_acl_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::put_object_acl::builders::PutObjectAclOutputBuilder::default();
        let _ = response;
        output = output.set_request_charged(
            crate::protocol_serde::shape_put_object_acl_output::de_request_charged_header(response.headers())
