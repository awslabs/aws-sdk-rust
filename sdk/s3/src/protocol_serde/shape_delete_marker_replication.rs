...
pub fn ser_delete_marker_replication(input: &crate::model::DeleteMarkerReplication, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_delete_marker_replication(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DeleteMarkerReplication, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
