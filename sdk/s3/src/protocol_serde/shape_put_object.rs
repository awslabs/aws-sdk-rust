...
pub fn de_put_object_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object::PutObjectOutput, crate::operation::put_object::PutObjectError> {
    Ok({
        ...
        output = output.set_checksum_crc32(
            crate::protocol_serde::shape_put_object_output::de_checksum_crc32_header(_response_headers)
        ...
        output = output.set_checksum_crc32_c(
            crate::protocol_serde::shape_put_object_output::de_checksum_crc32_c_header(_response_headers)
        ...
        output = output.set_checksum_sha1(
            crate::protocol_serde::shape_put_object_output::de_checksum_sha1_header(_response_headers)
        ...
        output = output.set_checksum_sha256(
            crate::protocol_serde::shape_put_object_output::de_checksum_sha256_header(_response_headers)
        ...
        output = output.set_request_charged(
            crate::protocol_serde::shape_put_object_output::de_request_charged_header(_response_headers)
        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("acl", format!(
    ...
    if let ::std::option::Option::Some(inner_29) = &input.grant_full_control {
        let formatted_30 = inner_29.as_str();
                        if !formatted_30.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("grant_full_control", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_31) = &input.grant_read {
        let formatted_32 = inner_31.as_str();
                        if !formatted_32.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("grant_read", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_33) = &input.grant_read_acp {
        let formatted_34 = inner_33.as_str();
                        if !formatted_34.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("grant_read_acp", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_35) = &input.grant_write_acp {
        let formatted_36 = inner_35.as_str();
                        if !formatted_36.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("grant_write_acp", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_41) = &input.website_redirect_location {
        let formatted_42 = inner_41.as_str();
                        if !formatted_42.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("website_redirect_location", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_51) = &input.ssekms_encryption_context {
        let formatted_52 = inner_51.as_str();
                        if !formatted_52.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("ssekms_encryption_context", format!(
                                "`{}` cannot be used as a header value: {}",
                                &"*** Sensitive Data Redacted ***",
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_57) = &input.tagging {
        let formatted_58 = inner_57.as_str();
                        if !formatted_58.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("tagging", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
