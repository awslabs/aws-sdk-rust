...
pub fn ser_select_parameters(input: &crate::model::SelectParameters, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
