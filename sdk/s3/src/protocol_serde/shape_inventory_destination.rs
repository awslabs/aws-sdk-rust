...
pub fn ser_inventory_destination(input: &crate::types::InventoryDestination, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
