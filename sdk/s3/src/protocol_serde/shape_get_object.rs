...
pub fn de_get_object_http_response(
    ...
    Ok({
        ...
        output = output.set_accept_ranges(
            match crate::protocol_serde::shape_get_object_output::de_accept_ranges_header(_response_headers) {
        ...
        output = output.set_bucket_key_enabled(
            match crate::protocol_serde::shape_get_object_output::de_bucket_key_enabled_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_crc32(
            match crate::protocol_serde::shape_get_object_output::de_checksum_crc32_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_crc32_c(
            match crate::protocol_serde::shape_get_object_output::de_checksum_crc32_c_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_crc64_nvme(
            match crate::protocol_serde::shape_get_object_output::de_checksum_crc64_nvme_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_md5(
            match crate::protocol_serde::shape_get_object_output::de_checksum_md5_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha1(
            match crate::protocol_serde::shape_get_object_output::de_checksum_sha1_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha256(
            match crate::protocol_serde::shape_get_object_output::de_checksum_sha256_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_sha512(
            match crate::protocol_serde::shape_get_object_output::de_checksum_sha512_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_type(
            match crate::protocol_serde::shape_get_object_output::de_checksum_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash128(
            match crate::protocol_serde::shape_get_object_output::de_checksum_xxhash128_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash3(
            match crate::protocol_serde::shape_get_object_output::de_checksum_xxhash3_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_checksum_xxhash64(
            match crate::protocol_serde::shape_get_object_output::de_checksum_xxhash64_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_disposition(
            match crate::protocol_serde::shape_get_object_output::de_content_disposition_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_encoding(
            match crate::protocol_serde::shape_get_object_output::de_content_encoding_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_language(
            match crate::protocol_serde::shape_get_object_output::de_content_language_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_delete_marker(
            match crate::protocol_serde::shape_get_object_output::de_delete_marker_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_expiration(
            match crate::protocol_serde::shape_get_object_output::de_expiration_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_expires(
            match crate::protocol_serde::shape_get_object_output::de_expires_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_expires_string(
            match crate::protocol_serde::shape_get_object_output::de_expires_string_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_metadata(
            match crate::protocol_serde::shape_get_object_output::de_metadata_prefix_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_missing_meta(
            match crate::protocol_serde::shape_get_object_output::de_missing_meta_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_event_hold(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_event_hold_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_event_hold_duration_days(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_event_hold_duration_days_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_event_hold_duration_years(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_event_hold_duration_years_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_legal_hold_status(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_legal_hold_status_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_mode(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_mode_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_object_lock_retain_until_date(
            match crate::protocol_serde::shape_get_object_output::de_object_lock_retain_until_date_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_parts_count(
            match crate::protocol_serde::shape_get_object_output::de_parts_count_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_replication_status(
            match crate::protocol_serde::shape_get_object_output::de_replication_status_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_request_charged(
            match crate::protocol_serde::shape_get_object_output::de_request_charged_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_restore(
            match crate::protocol_serde::shape_get_object_output::de_restore_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_sse_customer_algorithm(
            match crate::protocol_serde::shape_get_object_output::de_sse_customer_algorithm_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_sse_customer_key_md5(
            match crate::protocol_serde::shape_get_object_output::de_sse_customer_key_md5_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_ssekms_key_id(
            match crate::protocol_serde::shape_get_object_output::de_ssekms_key_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_server_side_encryption(
            match crate::protocol_serde::shape_get_object_output::de_server_side_encryption_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_storage_class(
            match crate::protocol_serde::shape_get_object_output::de_storage_class_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_tag_count(
            match crate::protocol_serde::shape_get_object_output::de_tag_count_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_version_id(
            match crate::protocol_serde::shape_get_object_output::de_version_id_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_website_redirect_location(
            match crate::protocol_serde::shape_get_object_output::de_website_redirect_location_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
