            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_object_state::de_invalid_object_state_xml_err(response.body().as_ref(), output).map_err(crate::error::GetObjectError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(response.body().as_ref(), output).map_err(crate::error::GetObjectError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
