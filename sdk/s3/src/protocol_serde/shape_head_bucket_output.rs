...
pub(crate) fn de_access_point_alias_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-access-point-alias");
...
pub(crate) fn de_bucket_location_name_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-bucket-location-name");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_bucket_location_type_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-bucket-location-type");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
...
pub(crate) fn de_bucket_region_header(
    ...
    let headers = header_map.get_all_bytes("x-amz-bucket-region");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
