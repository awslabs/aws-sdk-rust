...
pub fn de_inventory_optional_fields(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::types::InventoryOptionalField>, aws_smithy_xml::decode::XmlDecodeError> {
