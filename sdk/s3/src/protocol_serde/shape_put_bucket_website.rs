...
pub fn de_put_bucket_website_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketWebsiteOutput, crate::error::PutBucketWebsiteError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutBucketWebsiteError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_website_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutBucketWebsiteOutput, crate::error::PutBucketWebsiteError> {
    Ok({
        #[allow(unused_mut)]
