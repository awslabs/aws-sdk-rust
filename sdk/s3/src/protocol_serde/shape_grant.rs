...
pub fn ser_grant(input: &crate::model::Grant, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_grant(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Grant, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
