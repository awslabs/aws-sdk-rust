...
pub fn ser_source_selection_criteria(input: &crate::model::SourceSelectionCriteria, writer: aws_smithy_xml::encode::ElWriter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_source_selection_criteria(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SourceSelectionCriteria, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
