...
pub fn de_put_object_legal_hold_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectLegalHoldOutput, crate::error::PutObjectLegalHoldError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutObjectLegalHoldError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_legal_hold_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutObjectLegalHoldOutput, crate::error::PutObjectLegalHoldError> {
    Ok({
        #[allow(unused_mut)]
