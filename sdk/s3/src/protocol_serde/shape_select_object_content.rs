...
pub fn de_select_object_content_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::select_object_content::SelectObjectContentOutput, crate::operation::select_object_content::SelectObjectContentError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_select_object_content_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::select_object_content::SelectObjectContentOutput, crate::operation::select_object_content::SelectObjectContentError> {
    #[allow(unused_mut)]
...
pub fn ser_select_object_content_op_input(input: &crate::operation::select_object_content::SelectObjectContentInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
