...
impl crate::s3_request_id::RequestIdExt
    for crate::error::PutBucketIntelligentTieringConfigurationError
{
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
...
impl std::error::Error for ListObjectsV2Error {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::NoSuchBucket(_inner) => Some(_inner),
            Self::Unhandled(_inner) => Some(_inner),
        }
    }
}
...
pub type ListBucketIntelligentTieringConfigurationsErrorKind =
...
impl crate::s3_request_id::RequestIdExt
    for crate::error::ListBucketIntelligentTieringConfigurationsError
{
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
...
pub type GetBucketIntelligentTieringConfigurationErrorKind =
...
impl crate::s3_request_id::RequestIdExt
    for crate::error::GetBucketIntelligentTieringConfigurationError
{
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
...
impl crate::s3_request_id::RequestIdExt
    for crate::error::DeleteBucketIntelligentTieringConfigurationError
{
    fn extended_request_id(&self) -> Option<&str> {
        self.meta().extended_request_id()
    }
...
impl std::error::Error for AbortMultipartUploadError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::NoSuchUpload(_inner) => Some(_inner),
            Self::Unhandled(_inner) => Some(_inner),
        }
    }
}
