...
out.push_str("https://");
#[allow(clippy::needless_borrow)]out.push_str(&bucket);
out.push_str(".ec2.");
...
.build());
                                                ...
                                                #[allow(unreachable_code)]return Err(aws_smithy_http::endpoint::ResolveEndpointError::message(format!("No rules matched these parameters. This is a bug. {:?}", _params)));
                                            }
                                            return Ok(aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
out.push_str("https://");
#[allow(clippy::needless_borrow)]out.push_str(&bucket);
...
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&region_partition.dns_suffix());
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("disableDoubleEncoding".to_string(), true.into());
...
#[allow(clippy::needless_borrow)]out.push_str(&bucket);
out.push_str(".op-");
#[allow(clippy::needless_borrow)]out.push_str(&outpost_id);
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&url.authority());
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
...
#[allow(clippy::needless_borrow)]out.push_str(&hardware_type);
out.push('"');
out }));
                                    }
...
out.push('/');
#[allow(clippy::needless_borrow)]out.push_str(&uri_encoded_bucket);
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("disableDoubleEncoding".to_string(), true.into());
...
out.push_str("://");
#[allow(clippy::needless_borrow)]out.push_str(&url.authority());
#[allow(clippy::needless_borrow)]out.push_str(&url.normalized_path());
#[allow(clippy::needless_borrow)]out.push_str(&uri_encoded_bucket);
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
...
#[allow(clippy::needless_borrow)]out.push_str(&url.scheme());
out.push_str("://");
#[allow(clippy::needless_borrow)]out.push_str(&access_point_name);
out.push('-');
...
#[allow(clippy::needless_borrow)]out.push_str(&bucket_arn.region());
out.push('.');
#[allow(clippy::needless_borrow)]out.push_str(&bucket_partition.dns_suffix());
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("disableDoubleEncoding".to_string(), true.into());
...
#[allow(clippy::needless_borrow)]out.push_str(&bucket);
out.push_str("`) has `");
#[allow(clippy::needless_borrow)]out.push_str(&bucket_partition.name());
out.push('`');
out }));
                                                    }
                                                    return Err(aws_smithy_http::endpoint::ResolveEndpointError::message("A valid partition could not be determined"
...
if (*use_dual_stack) == (true) {
                                #[allow(unused)]if let Some(endpoint) = endpoint { return Err(aws_smithy_http::endpoint::ResolveEndpointError::message("DualStack cannot be combined with a Host override (PrivateLink)"
.to_string())); }
                            }
if (*use_fips) == (true) {
                                if (*use_dual_stack) == (true) {
...
#[allow(clippy::needless_borrow)]out.push_str(&bucket_arn.service());
out }));
                            }
                                                                return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
out.push_str("Invalid region in ARN: `");
...
#[allow(clippy::needless_borrow)]out.push_str(&mrap_partition.dns_suffix());
out })
.property("authSchemes", vec![aws_smithy_types::Document::from( {
    let mut out = std::collections::HashMap::<String, aws_smithy_types::Document>::new();
    out.insert("disableDoubleEncoding".to_string(), true.into());
...
.build());
                                            ...
                                            return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
out.push_str("Client was configured for partition `");
#[allow(clippy::needless_borrow)]out.push_str(&mrap_partition.name());
out.push_str("` but bucket referred to partition `");
#[allow(clippy::needless_borrow)]out.push_str(&bucket_arn.partition());
out.push('`');
out }));
                                        }
                                        return Err(aws_smithy_http::endpoint::ResolveEndpointError::message({ let mut out = String::new();
...
.get(2).cloned() { #[allow(unused)]if let Some(access_point_name) = bucket_arn.resource_id()
