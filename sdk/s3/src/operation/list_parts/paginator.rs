...
/// Paginator for [`ListParts`](crate::operation::list_parts::ListParts)
            ...
            impl ListPartsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_parts::ListPartsOutput, aws_smithy_http::result::SdkError<crate::operation::list_parts::ListPartsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListPartsPaginator`
                ...
                impl  ListPartsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::Part, aws_smithy_http::result::SdkError<crate::operation::list_parts::ListPartsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_parts_output_parts(page).unwrap_or_default().into_iter())
                    }
                }
