...
impl ListObjectsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_objects::ListObjects::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListObjects {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_objects::de_list_objects_http_response_with_props(
                status, headers, body,
            )
        }
    }
        ...
        let expected_output = crate::operation::list_objects::ListObjectsOutput::builder()
            ...
            .set_contents(Some(vec![
                crate::types::Object::builder()
                    ...
                    .set_storage_class(Some(crate::types::ObjectStorageClass::from("STANDARD")))
                    .build(),
                crate::types::Object::builder()
