...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::delete_bucket_website::DeleteBucketWebsiteError>::new());
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketWebsiteResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_bucket_website::de_delete_bucket_website_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_bucket_website::de_delete_bucket_website_http_response(status, headers, body, _cfg)
        };
