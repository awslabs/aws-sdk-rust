...
impl PutObjectRetentionInput {
    /// Consumes the builder and constructs an Operation<[`PutObjectRetention`](crate::operation::put_object_retention::PutObjectRetention)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_object_retention::PutObjectRetention, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_object_retention::PutObjectRetentionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::put_object_retention::PutObjectRetentionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_object_retention_input::ser_retention_http_payload(& self.retention)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_object_retention::PutObjectRetention::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutObjectRetention", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutObjectRetention {
                type Output = std::result::Result<crate::operation::put_object_retention::PutObjectRetentionOutput, crate::operation::put_object_retention::PutObjectRetentionError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_object_retention::PutObjectRetentionError {
