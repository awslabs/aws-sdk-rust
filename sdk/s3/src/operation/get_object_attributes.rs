...
impl GetObjectAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetObjectAttributes`](crate::operation::get_object_attributes::GetObjectAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_object_attributes::GetObjectAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_attributes::GetObjectAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object_attributes::GetObjectAttributesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_object_attributes::GetObjectAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetObjectAttributes", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetObjectAttributes {
                type Output = std::result::Result<crate::operation::get_object_attributes::GetObjectAttributesOutput, crate::operation::get_object_attributes::GetObjectAttributesError>;
