...
impl PutBucketOwnershipControlsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsInput, ::aws_smithy_types::error::operation::BuildError> {
