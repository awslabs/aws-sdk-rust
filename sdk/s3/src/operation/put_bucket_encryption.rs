...
impl PutBucketEncryptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_bucket_encryption::PutBucketEncryption,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bucket_encryption::de_put_bucket_encryption_http_response_with_props(status, headers, body)
        }
    }
}
