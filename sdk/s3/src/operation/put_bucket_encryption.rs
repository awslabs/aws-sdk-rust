...
impl PutBucketEncryptionInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketEncryption`](crate::operation::put_bucket_encryption::PutBucketEncryption)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_encryption::PutBucketEncryption, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_encryption::PutBucketEncryptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::put_bucket_encryption::PutBucketEncryptionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bucket_encryption_input::ser_server_side_encryption_configuration_http_payload(& self.server_side_encryption_configuration)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_encryption::PutBucketEncryption::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBucketEncryption", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketEncryption {
                type Output = std::result::Result<crate::operation::put_bucket_encryption::PutBucketEncryptionOutput, crate::operation::put_bucket_encryption::PutBucketEncryptionError>;
