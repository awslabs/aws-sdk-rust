...
impl PutBucketNotificationConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_bucket_notification_configuration::PutBucketNotificationConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_notification_configuration::PutBucketNotificationConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketNotificationConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bucket_notification_configuration::de_put_bucket_notification_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
