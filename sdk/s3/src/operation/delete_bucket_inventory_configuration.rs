...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBucketInventoryConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_bucket_inventory_configuration::de_delete_bucket_inventory_configuration_http_response_with_props(status, headers, body)
        }
    }
}
