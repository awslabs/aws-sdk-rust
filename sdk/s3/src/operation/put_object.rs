...
impl PutObjectInput {
    ...
    async fn _make_presigned_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_object::PutObject, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body =
            ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_object_input::ser_body_http_payload(self.body)?.into_inner());
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutObject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_object::de_put_object_http_response_with_props(status, headers, body)
        }
    }
