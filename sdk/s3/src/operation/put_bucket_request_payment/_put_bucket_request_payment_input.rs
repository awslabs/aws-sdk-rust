...
impl PutBucketRequestPaymentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_bucket_request_payment::PutBucketRequestPaymentInput, ::aws_smithy_types::error::operation::BuildError> {
