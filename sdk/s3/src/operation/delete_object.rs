...
impl DeleteObjectInput {
    ...
    async fn _make_presigned_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_object::DeleteObject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::delete_object::DeleteObjectInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_object::DeleteObject::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteObject", "s3"));
