...
impl GetBucketAccelerateConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bucket_accelerate_configuration::GetBucketAccelerateConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
