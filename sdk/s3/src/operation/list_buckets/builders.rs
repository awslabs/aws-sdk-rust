...
impl ListBucketsFluentBuilder  {
    /// Creates a new `ListBuckets`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_buckets::ListBucketsOutput, aws_smithy_http::result::SdkError<crate::operation::list_buckets::ListBucketsError>>
                     {
