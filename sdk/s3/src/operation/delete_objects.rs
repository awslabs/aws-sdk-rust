...
impl DeleteObjectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_objects::DeleteObjects, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_objects_input::ser_delete_http_payload(&self.delete)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteObjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_objects::de_delete_objects_http_response_with_props(status, headers, body)
        }
    }
}
