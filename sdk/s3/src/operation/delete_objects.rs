    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_delete_objects::ser_delete_objects_headers(
                        input, builder,
                    )?;
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_objects_input::ser_delete_http_payload(
                &self.delete,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_objects::DeleteObjects::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteObjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_objects::de_delete_objects_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_objects::de_delete_objects_http_response_with_props(
                status, headers, body,
            )
        }
    }
