...
impl GetObjectAclInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_object_acl::GetObjectAcl,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_object_acl::GetObjectAcl::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetObjectAcl {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_object_acl::de_get_object_acl_http_response_with_props(
                status, headers, body,
            )
        }
    }
