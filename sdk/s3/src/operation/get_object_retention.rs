...
impl GetObjectRetentionInput {
    /// Consumes the builder and constructs an Operation<[`GetObjectRetention`](crate::operation::get_object_retention::GetObjectRetention)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_object_retention::GetObjectRetention, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_retention::GetObjectRetentionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object_retention::GetObjectRetentionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_object_retention::GetObjectRetention::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetObjectRetention", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetObjectRetention {
                type Output = std::result::Result<crate::operation::get_object_retention::GetObjectRetentionOutput, crate::operation::get_object_retention::GetObjectRetentionError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_object_retention::GetObjectRetentionError {
