...
impl PutBucketAccelerateConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_accelerate_configuration::PutBucketAccelerateConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketAccelerateConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bucket_accelerate_configuration::de_put_bucket_accelerate_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
