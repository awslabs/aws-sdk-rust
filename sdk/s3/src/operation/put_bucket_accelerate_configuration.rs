...
impl PutBucketAccelerateConfiguration {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::put_bucket_accelerate_configuration::PutBucketAccelerateConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutBucketAccelerateConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutBucketAccelerateConfiguration", "s3"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutBucketAccelerateConfiguration")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutBucketAccelerateConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutBucketAccelerateConfigurationRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutBucketAccelerateConfigurationEndpointParamsInterceptor {
