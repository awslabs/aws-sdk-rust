...
impl CopyObjectInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::copy_object::CopyObject,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_object::CopyObject::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CopyObject {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_object::de_copy_object_http_response_with_props(
                status, headers, body,
            )
        }
    }
...
impl std::error::Error for CopyObjectError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::ObjectNotInActiveTierError(_inner) => Some(_inner),
