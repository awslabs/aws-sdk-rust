...
impl CopyObjectInput {
    /// Consumes the builder and constructs an Operation<[`CopyObject`](crate::operation::copy_object::CopyObject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_object::CopyObject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_object::CopyObjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::copy_object::CopyObjectInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::copy_object::CopyObject::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CopyObject", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for CopyObject {
                type Output = std::result::Result<crate::operation::copy_object::CopyObjectOutput, crate::operation::copy_object::CopyObjectError>;
...
impl aws_http::request_id::RequestId for crate::operation::copy_object::CopyObjectError {
