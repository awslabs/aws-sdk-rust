...
impl PutObjectTaggingInput {
    /// Consumes the builder and constructs an Operation<[`PutObjectTagging`](crate::operation::put_object_tagging::PutObjectTagging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_object_tagging::PutObjectTagging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_object_tagging::PutObjectTaggingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::put_object_tagging::PutObjectTaggingInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_object_tagging_input::ser_tagging_http_payload(& self.tagging)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_object_tagging::PutObjectTagging::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutObjectTagging", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutObjectTagging {
                type Output = std::result::Result<crate::operation::put_object_tagging::PutObjectTaggingOutput, crate::operation::put_object_tagging::PutObjectTaggingError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_object_tagging::PutObjectTaggingError {
