...
///
/// <p>Removes an object from a bucket. The behavior depends on the bucket's versioning state. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/DeletingObjects.html#DeletingObjects-best-practices">Best practices to consider before deleting an object</a>.</p>
/// <p>To remove a specific version, you must use the <code>versionId</code> query parameter. Using this query parameter permanently deletes the version. If the object deleted is a delete marker, Amazon S3 sets the response header <code>x-amz-delete-marker</code> to true. If the object you want to delete is in a bucket where the bucket versioning configuration is MFA delete enabled, you must include the <code>x-amz-mfa</code> request header in the DELETE <code>versionId</code> request. Requests that include <code>x-amz-mfa</code> must use HTTPS. For more information about MFA delete and to see example requests, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMFADelete.html">Using MFA delete</a> and <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectDELETE.html#ExampleVersionObjectDelete">Sample request</a> in the <i>Amazon S3 User Guide</i>.</p><note>
/// <ul>
/// <li>
/// <p>S3 Versioning isn't enabled and supported for directory buckets. For this API operation, only the <code>null</code> value of the version ID is supported by directory buckets. You can only specify <code>null</code> to the <code>versionId</code> query parameter in the request.</p></li>
/// <li>
...
/// <li>
/// <p>MFA delete is not supported by directory buckets.</p></li>
/// </ul>
/// </note>
/// <dl>
/// <dt>
...
/// <ul>
/// <li>
/// <p><b> <code>s3:DeleteObject</code> </b> - To delete an object from a bucket, you must always have the <code>s3:DeleteObject</code> permission.</p><note>
/// <p>You can also use <code>PutBucketLifecycle</code> to delete objects in Amazon S3.</p>
/// </note></li>
/// <li>
...
/// <li>
/// <p>If you want to block users or accounts from removing or deleting objects from your bucket, you must deny them the <code>s3:DeleteObject</code>, <code>s3:DeleteObjectVersion</code>, and <code>s3:PutLifeCycleConfiguration</code> permissions.</p></li>
/// </ul></li>
/// <li>
/// <p><b>Directory buckets permissions</b> - To grant access to this API operation on a directory bucket, we recommend that you use the <code>CreateSession</code> API operation for session-based authorization.</p></li>
/// </ul>
/// </dd>
/// <dt>
