...
impl PutBucketLoggingInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketLogging`](crate::operation::put_bucket_logging::PutBucketLogging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_logging::PutBucketLogging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_logging::PutBucketLoggingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::put_bucket_logging::PutBucketLoggingInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bucket_logging_input::ser_bucket_logging_status_http_payload(& self.bucket_logging_status)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_logging::PutBucketLogging::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBucketLogging", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketLogging {
                type Output = std::result::Result<crate::operation::put_bucket_logging::PutBucketLoggingOutput, crate::operation::put_bucket_logging::PutBucketLoggingError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_bucket_logging::PutBucketLoggingError {
