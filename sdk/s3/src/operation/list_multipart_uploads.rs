        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::list_multipart_uploads::ListMultipartUploadsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if _input.max_uploads != 0 {
                    query.push_kv("max-uploads", aws_smithy_types::primitive::Encoder::from(_input.max_uploads).encode());
                }
                ...
                if let Some(inner_5) = &_input.upload_id_marker {
                     {
                        query.push_kv("upload-id-marker", &aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                Ok(())
            }
