...
impl PutBucketMetricsConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_bucket_metrics_configuration::PutBucketMetricsConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBucketMetricsConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_bucket_metrics_configuration::de_put_bucket_metrics_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
