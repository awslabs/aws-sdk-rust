...
/// Paginator for [`ListObjectsV2`](crate::operation::list_objects_v2::ListObjectsV2)
            ...
            impl ListObjectsV2Paginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, aws_smithy_http::result::SdkError<crate::operation::list_objects_v2::ListObjectsV2Error>>> + Unpin
                 {
