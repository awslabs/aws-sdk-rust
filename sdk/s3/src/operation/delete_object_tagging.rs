...
impl DeleteObjectTaggingInput {
    /// Consumes the builder and constructs an Operation<[`DeleteObjectTagging`](crate::operation::delete_object_tagging::DeleteObjectTagging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_object_tagging::DeleteObjectTagging, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_object_tagging::DeleteObjectTaggingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_object_tagging::DeleteObjectTaggingInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_object_tagging::DeleteObjectTagging::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteObjectTagging", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteObjectTagging {
                type Output = std::result::Result<crate::operation::delete_object_tagging::DeleteObjectTaggingOutput, crate::operation::delete_object_tagging::DeleteObjectTaggingError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_object_tagging::DeleteObjectTaggingError {
