...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketLocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_location::de_get_bucket_location_http_response_with_props(status, headers, body)
        }
    }
}
...
mod get_bucket_location_request_test {
    ...
    async fn get_bucket_location_response() {
        let expected_output = crate::operation::get_bucket_location::GetBucketLocationOutput::builder()
            .set_location_constraint(::std::option::Option::Some(crate::types::BucketLocationConstraint::from("us-west-2")))
            .build();
        ...
        let parsed = parsed.unwrap_or_else(|| {
            ...
            <crate::operation::get_bucket_location::GetBucketLocation as ::aws_smithy_http::response::ParseHttpResponse>::parse_loaded(
                &parser,
                &http_response,
            )
        });
