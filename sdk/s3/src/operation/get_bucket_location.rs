...
impl GetBucketLocationInput {
    /// Consumes the builder and constructs an Operation<[`GetBucketLocation`](crate::operation::get_bucket_location::GetBucketLocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_bucket_location::GetBucketLocation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bucket_location::GetBucketLocationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_bucket_location::GetBucketLocationInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_bucket_location::GetBucketLocation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBucketLocation", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBucketLocation {
                type Output = std::result::Result<crate::operation::get_bucket_location::GetBucketLocationOutput, crate::operation::get_bucket_location::GetBucketLocationError>;
...
mod get_bucket_location_request_test {
    ...
    async fn get_bucket_location_response() {
        ...
        use aws_smithy_http::response::ParseHttpResponse;
                    let parser = crate::operation::get_bucket_location::GetBucketLocation::new();
                    ...
                    let parsed = parsed.unwrap_or_else(|| {
                        ...
                        <crate::operation::get_bucket_location::GetBucketLocation as aws_smithy_http::response::ParseHttpResponse>::parse_loaded(&parser, &http_response)
                    });
