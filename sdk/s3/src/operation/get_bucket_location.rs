...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::get_bucket_location::GetBucketLocationError>::new());
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketLocationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_bucket_location::de_get_bucket_location_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_bucket_location::de_get_bucket_location_http_response(status, headers, body, _cfg)
        };
