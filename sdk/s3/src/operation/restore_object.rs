...
impl RestoreObjectInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::restore_object::RestoreObject,
    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_restore_object::ser_restore_object_headers(
                        input, builder,
                    )?;
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_object_input::ser_restore_request_http_payload(
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_object::RestoreObject::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreObject {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_restore_object::de_restore_object_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_restore_object::de_restore_object_http_response_with_props(
                status, headers, body,
            )
        }
    }
