...
impl RestoreObjectInput {
    /// Consumes the builder and constructs an Operation<[`RestoreObject`](crate::operation::restore_object::RestoreObject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_object::RestoreObject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_object::RestoreObjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::restore_object::RestoreObjectInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_object_input::ser_restore_request_http_payload(& self.restore_request)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_object::RestoreObject::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RestoreObject", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreObject {
                type Output = std::result::Result<crate::operation::restore_object::RestoreObjectOutput, crate::operation::restore_object::RestoreObjectError>;
