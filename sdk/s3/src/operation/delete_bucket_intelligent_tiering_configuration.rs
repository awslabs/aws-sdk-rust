...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketIntelligentTieringConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_bucket_intelligent_tiering_configuration::de_delete_bucket_intelligent_tiering_configuration_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_bucket_intelligent_tiering_configuration::de_delete_bucket_intelligent_tiering_configuration_http_response(status, headers, body, _cfg)
        };
