...
impl PutPublicAccessBlockFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_public_access_block::PutPublicAccessBlockOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_public_access_block::PutPublicAccessBlockError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_public_access_block::PutPublicAccessBlockOutput, crate::operation::put_public_access_block::PutPublicAccessBlockError, Self> {
