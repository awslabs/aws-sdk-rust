...
impl PutBucketRequestPaymentInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketRequestPayment`](crate::operation::put_bucket_request_payment::PutBucketRequestPayment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_request_payment::PutBucketRequestPayment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_request_payment::PutBucketRequestPaymentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::put_bucket_request_payment::PutBucketRequestPaymentInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bucket_request_payment_input::ser_request_payment_configuration_http_payload(& self.request_payment_configuration)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_request_payment::PutBucketRequestPayment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBucketRequestPayment", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketRequestPayment {
                type Output = std::result::Result<crate::operation::put_bucket_request_payment::PutBucketRequestPaymentOutput, crate::operation::put_bucket_request_payment::PutBucketRequestPaymentError>;
