...
impl GetBucketMetricsConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bucket_metrics_configuration::GetBucketMetricsConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_metrics_configuration::GetBucketMetricsConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketMetricsConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_metrics_configuration::de_get_bucket_metrics_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
