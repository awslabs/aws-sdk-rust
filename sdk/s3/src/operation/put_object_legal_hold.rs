...
impl PutObjectLegalHoldInput {
    /// Consumes the builder and constructs an Operation<[`PutObjectLegalHold`](crate::operation::put_object_legal_hold::PutObjectLegalHold)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_object_legal_hold::PutObjectLegalHold, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_object_legal_hold::PutObjectLegalHoldInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::put_object_legal_hold::PutObjectLegalHoldInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_object_legal_hold_input::ser_legal_hold_http_payload(& self.legal_hold)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for PutObjectLegalHold {
                type Output = std::result::Result<crate::operation::put_object_legal_hold::PutObjectLegalHoldOutput, crate::operation::put_object_legal_hold::PutObjectLegalHoldError>;
