...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListBucketAnalyticsConfigurations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListBucketAnalyticsConfigurations", "s3"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListBucketAnalyticsConfigurationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListBucketAnalyticsConfigurationsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListBucketAnalyticsConfigurationsEndpointParamsInterceptor {
