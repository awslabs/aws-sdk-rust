...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::list_object_versions::ListObjectVersionsError>::new());
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListObjectVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_object_versions::de_list_object_versions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_object_versions::de_list_object_versions_http_response(status, headers, body, _cfg)
        };
