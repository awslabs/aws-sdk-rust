...
impl ListObjectVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListObjectVersions`](crate::operation::list_object_versions::ListObjectVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_object_versions::ListObjectVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_object_versions::ListObjectVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_object_versions::ListObjectVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.key_marker {
                     {
                ...
                if let Some(inner_5) = &_input.version_id_marker {
                     {
                        query.push_kv("version-id-marker", &aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_object_versions::ListObjectVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListObjectVersions", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListObjectVersions {
                type Output = std::result::Result<crate::operation::list_object_versions::ListObjectVersionsOutput, crate::operation::list_object_versions::ListObjectVersionsError>;
...
impl aws_http::request_id::RequestId for crate::operation::list_object_versions::ListObjectVersionsError {
