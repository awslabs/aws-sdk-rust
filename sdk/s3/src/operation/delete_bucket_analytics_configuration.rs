...
impl DeleteBucketAnalyticsConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_bucket_analytics_configuration::DeleteBucketAnalyticsConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBucketAnalyticsConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_bucket_analytics_configuration::de_delete_bucket_analytics_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
