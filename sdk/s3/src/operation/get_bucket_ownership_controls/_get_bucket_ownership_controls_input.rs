...
impl GetBucketOwnershipControlsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsInput, ::aws_smithy_types::error::operation::BuildError> {
