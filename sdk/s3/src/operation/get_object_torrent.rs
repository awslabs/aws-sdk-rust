...
impl GetObjectTorrentInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_object_torrent::GetObjectTorrent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_torrent::GetObjectTorrentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object_torrent::GetObjectTorrentInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
...
tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                    ...
                    Some(crate::protocol_serde::shape_get_object_torrent::de_get_object_torrent_http_response_(response))
                }
