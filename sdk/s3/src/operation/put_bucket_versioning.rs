...
impl PutBucketVersioningInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketVersioning`](crate::operation::put_bucket_versioning::PutBucketVersioning)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_versioning::PutBucketVersioning, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_versioning::PutBucketVersioningInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::put_bucket_versioning::PutBucketVersioningInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_versioning::PutBucketVersioning::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBucketVersioning", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketVersioning {
                type Output = std::result::Result<crate::operation::put_bucket_versioning::PutBucketVersioningOutput, crate::operation::put_bucket_versioning::PutBucketVersioningError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_bucket_versioning::PutBucketVersioningError {
