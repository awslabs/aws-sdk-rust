...
impl PutObjectAclInput {
    /// Consumes the builder and constructs an Operation<[`PutObjectAcl`](crate::operation::put_object_acl::PutObjectAcl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_object_acl::PutObjectAcl, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_object_acl::PutObjectAclInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::put_object_acl::PutObjectAclInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_object_acl_input::ser_access_control_policy_http_payload(& self.access_control_policy)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_object_acl::PutObjectAcl::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutObjectAcl", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutObjectAcl {
                type Output = std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_object_acl::PutObjectAclError {
