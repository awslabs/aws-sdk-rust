...
impl PutObjectLegalHoldFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_object_legal_hold::PutObjectLegalHoldOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_object_legal_hold::PutObjectLegalHoldError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_object_legal_hold::PutObjectLegalHoldOutput, crate::operation::put_object_legal_hold::PutObjectLegalHoldError, Self> {
