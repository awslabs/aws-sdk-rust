...
impl GetBucketRequestPaymentInput {
    /// Consumes the builder and constructs an Operation<[`GetBucketRequestPayment`](crate::operation::get_bucket_request_payment::GetBucketRequestPayment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_bucket_request_payment::GetBucketRequestPayment, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bucket_request_payment::GetBucketRequestPaymentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_bucket_request_payment::GetBucketRequestPaymentInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_bucket_request_payment::GetBucketRequestPayment::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBucketRequestPayment", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBucketRequestPayment {
                type Output = std::result::Result<crate::operation::get_bucket_request_payment::GetBucketRequestPaymentOutput, crate::operation::get_bucket_request_payment::GetBucketRequestPaymentError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_bucket_request_payment::GetBucketRequestPaymentError {
