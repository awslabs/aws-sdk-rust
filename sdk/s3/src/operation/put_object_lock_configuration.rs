...
impl PutObjectLockConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_object_lock_configuration::PutObjectLockConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutObjectLockConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_object_lock_configuration::de_put_object_lock_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
