...
impl SelectObjectContentInput {
    /// Consumes the builder and constructs an Operation<[`SelectObjectContent`](crate::operation::select_object_content::SelectObjectContent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::select_object_content::SelectObjectContent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::select_object_content::SelectObjectContentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::select_object_content::SelectObjectContentInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_select_object_content::ser_select_object_content_op_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::select_object_content::SelectObjectContent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SelectObjectContent", "s3"));
...
impl aws_smithy_http::response::ParseHttpResponse for SelectObjectContent {
                type Output = std::result::Result<crate::operation::select_object_content::SelectObjectContentOutput, crate::operation::select_object_content::SelectObjectContentError>;
...
tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                    ...
                    Some(crate::protocol_serde::shape_select_object_content::de_select_object_content_http_response_(response))
                }
                fn parse_loaded(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_select_object_content::de_select_object_content_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
