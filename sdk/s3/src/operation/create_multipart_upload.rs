...
impl CreateMultipartUploadInput {
    /// Consumes the builder and constructs an Operation<[`CreateMultipartUpload`](crate::operation::create_multipart_upload::CreateMultipartUpload)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_multipart_upload::CreateMultipartUpload, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_multipart_upload::CreateMultipartUploadInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_multipart_upload::CreateMultipartUploadInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_multipart_upload::CreateMultipartUpload::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateMultipartUpload", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateMultipartUpload {
                type Output = std::result::Result<crate::operation::create_multipart_upload::CreateMultipartUploadOutput, crate::operation::create_multipart_upload::CreateMultipartUploadError>;
...
mod create_multipart_upload_request_test {
    ...
    async fn create_multipart_upload_uri_construction_request() {
        ...
        let input =crate::operation::create_multipart_upload::CreateMultipartUploadInput::builder()
        .set_bucket(
            Some(
