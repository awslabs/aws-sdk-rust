...
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::complete_multipart_upload::CompleteMultipartUploadError>::new());
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_complete_multipart_upload_input::ser_multipart_upload_http_payload(& input.multipart_upload)?);
