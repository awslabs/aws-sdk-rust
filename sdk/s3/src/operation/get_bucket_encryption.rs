...
impl GetBucketEncryptionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bucket_encryption::GetBucketEncryption,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketEncryption {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_encryption::de_get_bucket_encryption_http_response_with_props(status, headers, body)
        }
    }
