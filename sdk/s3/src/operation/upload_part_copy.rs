...
impl UploadPartCopyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upload_part_copy::UploadPartCopy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_part_copy::UploadPartCopyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::upload_part_copy::UploadPartCopyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                query.push_kv("x-id", "UploadPartCopy");
                let inner_2 = &_input.part_number;
                let inner_2 = inner_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("part_number", "cannot be empty or unset"))?;
                query.push_kv("partNumber", aws_smithy_types::primitive::Encoder::from(*inner_2).encode());
                let inner_3 = &_input.upload_id;
                let inner_3 = inner_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("upload_id", "cannot be empty or unset"))?;
                if inner_3.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::upload_part_copy::UploadPartCopy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UploadPartCopy", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for UploadPartCopy {
                type Output = std::result::Result<crate::operation::upload_part_copy::UploadPartCopyOutput, crate::operation::upload_part_copy::UploadPartCopyError>;
