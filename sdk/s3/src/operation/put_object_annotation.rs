...
.with_retry_classifier(::aws_runtime::service_clock_skew::ServiceClockSkewClassifier::<crate::operation::put_object_annotation::PutObjectAnnotationError>::new());
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutObjectAnnotationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_object_annotation::de_put_object_annotation_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_object_annotation::de_put_object_annotation_http_response(status, headers, body, _cfg)
        };
