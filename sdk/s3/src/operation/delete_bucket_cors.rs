...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketCorsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_bucket_cors::de_delete_bucket_cors_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_bucket_cors::de_delete_bucket_cors_http_response(status, headers, body, _cfg)
        };
