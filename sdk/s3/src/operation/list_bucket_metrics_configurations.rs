...
impl ListBucketMetricsConfigurationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_bucket_metrics_configurations::ListBucketMetricsConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBucketMetricsConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_bucket_metrics_configurations::de_list_bucket_metrics_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
