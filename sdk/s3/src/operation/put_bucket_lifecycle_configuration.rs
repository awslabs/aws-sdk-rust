...
.with_interceptor(crate::http_request_checksum::RequestChecksumInterceptor::new(|input: &::aws_smithy_runtime_api::client::interceptors::context::Input| {
                                    let input: &crate::operation::put_bucket_lifecycle_configuration::PutBucketLifecycleConfigurationInput = input.downcast_ref().expect("correct type");
...
mod put_bucket_lifecycle_configuration_request_test {
    ...
    async fn put_bucket_lifecycle_configuration_request() {
        ...
        let result = client.put_bucket_lifecycle_configuration()
        .set_bucket(
                ...
                .set_rules(
                    ::std::option::Option::Some(
                        vec![
                            ...
                            .set_status(
                                ::std::option::Option::Some(
                                    "Enabled".parse::<crate::types::ExpirationStatus>().expect("static value validated to member")
                                )
                            )
                            .set_id(
                                ::std::option::Option::Some(
