...
impl ListBucketMetricsConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_bucket_metrics_configurations::ListBucketMetricsConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
