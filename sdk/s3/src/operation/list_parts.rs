...
impl ListPartsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_parts::ListParts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_parts::ListPartsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_parts::ListPartsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if _input.max_parts != 0 {
                    query.push_kv("max-parts", aws_smithy_types::primitive::Encoder::from(_input.max_parts).encode());
                }
                if let Some(inner_2) = &_input.part_number_marker {
                     {
                        query.push_kv("part-number-marker", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
