...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBucketLifecycleResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_bucket_lifecycle::de_delete_bucket_lifecycle_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_bucket_lifecycle::de_delete_bucket_lifecycle_http_response(status, headers, body, _cfg)
        };
