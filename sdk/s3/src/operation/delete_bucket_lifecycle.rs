...
impl DeleteBucketLifecycleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBucketLifecycle`](crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycleInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycle::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBucketLifecycle", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBucketLifecycle {
                type Output = std::result::Result<crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycleOutput, crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycleError>;
...
impl aws_http::request_id::RequestId for crate::operation::delete_bucket_lifecycle::DeleteBucketLifecycleError {
