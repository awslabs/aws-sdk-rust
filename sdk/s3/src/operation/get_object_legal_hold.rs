...
impl GetObjectLegalHoldInput {
    /// Consumes the builder and constructs an Operation<[`GetObjectLegalHold`](crate::operation::get_object_legal_hold::GetObjectLegalHold)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_object_legal_hold::GetObjectLegalHold, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_legal_hold::GetObjectLegalHoldInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object_legal_hold::GetObjectLegalHoldInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_object_legal_hold::GetObjectLegalHold::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetObjectLegalHold", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetObjectLegalHold {
                type Output = std::result::Result<crate::operation::get_object_legal_hold::GetObjectLegalHoldOutput, crate::operation::get_object_legal_hold::GetObjectLegalHoldError>;
