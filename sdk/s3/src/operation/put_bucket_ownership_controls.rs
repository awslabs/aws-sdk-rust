...
impl PutBucketOwnershipControlsInput {
    /// Consumes the builder and constructs an Operation<[`PutBucketOwnershipControls`](crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControls, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_bucket_ownership_controls_input::ser_ownership_controls_http_payload(& self.ownership_controls)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControls::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutBucketOwnershipControls", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutBucketOwnershipControls {
                type Output = std::result::Result<crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsOutput, crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_bucket_ownership_controls::PutBucketOwnershipControlsError {
