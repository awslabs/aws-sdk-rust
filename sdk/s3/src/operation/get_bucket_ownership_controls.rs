...
impl GetBucketOwnershipControlsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControls::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketOwnershipControls {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_ownership_controls::de_get_bucket_ownership_controls_http_response_with_props(
                status, headers, body,
            )
        }
    }
