...
impl GetObjectLockConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_object_lock_configuration::GetObjectLockConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetObjectLockConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_object_lock_configuration::de_get_object_lock_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
