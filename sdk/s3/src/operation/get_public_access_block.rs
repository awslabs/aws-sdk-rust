...
fn uri_query(_input: &crate::operation::get_public_access_block::GetPublicAccessBlockInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
