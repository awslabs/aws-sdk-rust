...
impl GetBucketLoggingFluentBuilder  {
    /// Creates a new `GetBucketLogging`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_bucket_logging::GetBucketLogging, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_bucket_logging::GetBucketLoggingError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_bucket_logging::GetBucketLoggingOutput, aws_smithy_http::result::SdkError<crate::operation::get_bucket_logging::GetBucketLoggingError>>
                     {
