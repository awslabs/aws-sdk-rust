...
impl GetBucketLoggingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bucket_logging::GetBucketLoggingInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_bucket_logging::GetBucketLoggingInput {
                bucket: self.bucket
                ,
