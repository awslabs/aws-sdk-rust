...
impl WriteGetObjectResponseInput {
    /// Consumes the builder and constructs an Operation<[`WriteGetObjectResponse`](crate::operation::write_get_object_response::WriteGetObjectResponse)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::write_get_object_response::WriteGetObjectResponse, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        .set_use_object_lambda_endpoint(Some(true)).build()
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::write_get_object_response::WriteGetObjectResponseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/WriteGetObjectResponse").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::write_get_object_response::WriteGetObjectResponseInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_write_get_object_response_input::ser_body_http_payload( self.body)?
            .into_inner()
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::write_get_object_response::WriteGetObjectResponse::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("WriteGetObjectResponse", "s3"));
...
impl aws_smithy_http::response::ParseStrictResponse for WriteGetObjectResponse {
                type Output = std::result::Result<crate::operation::write_get_object_response::WriteGetObjectResponseOutput, crate::operation::write_get_object_response::WriteGetObjectResponseError>;
...
impl aws_http::request_id::RequestId for crate::operation::write_get_object_response::WriteGetObjectResponseError {
