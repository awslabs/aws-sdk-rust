...
impl WriteGetObjectResponseInput {
    ...
    > {
        ...
        let params_result = crate::endpoint::Params::builder()
            ...
            .set_use_object_lambda_endpoint(::std::option::Option::Some(true))
            .build()
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_write_get_object_response_input::ser_body_http_payload(self.body)?.into_inner(),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for WriteGetObjectResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_write_get_object_response::de_write_get_object_response_http_response_with_props(status, headers, body)
        }
    }
}
