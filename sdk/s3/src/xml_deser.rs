...
pub fn parse_http_error_metadata(response: &http::Response<bytes::Bytes>) -> Result<aws_smithy_types::error::metadata::Builder, aws_smithy_xml::decode::XmlDecodeError> {
    // S3 HEAD responses have no response body to for an error code. Therefore,
                        ...
                        if response.body().is_empty() {
                            ...
                            crate::rest_xml_unwrapped_errors::parse_error_metadata(response.body().as_ref())
                        }
}
    ...
    while let Some(mut tag) = error_decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("StorageClass") /* StorageClass com.amazonaws.s3#InvalidObjectState$StorageClass */ =>  {
                ...
                ;
                builder = builder.set_storage_class(var_45);
            }
            ,
            s if s.matches("AccessTier") /* AccessTier com.amazonaws.s3#InvalidObjectState$AccessTier */ =>  {
                ...
                ;
                builder = builder.set_access_tier(var_46);
            }
            ,
            _ => {}
        }
