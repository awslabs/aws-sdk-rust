...
#[allow(unused_variables)]
if let Some(region) = region { if (*accelerate) == (true) {
                                if (*use_fips) == (true) {
...
if let Some(endpoint) = endpoint { if (*use_fips) == (true) {
                                return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("A custom endpoint cannot be combined with FIPS"
.to_string()));
                            } }
#[allow(unused_variables)]
if let Some(endpoint) = endpoint { if (*accelerate) == (true) {
                                return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("A custom endpoint cannot be combined with S3 Accelerate"
.to_string()));
                            } }
if (*use_fips) == (true) {
                                #[allow(unused_variables)]
if let Some(partition_result) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if (partition_result.name()) == ("aws-cn") {
...
if let Some(bucket_suffix) = crate::endpoint_lib::substring::substring(bucket
,0
,6
,true, _diagnostic_collector) { if (bucket_suffix) == ("--x-s3") {
                                if (*use_dual_stack) == (true) {
                                return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("S3Express does not support Dual-stack."
.to_string()));
                            }
if (*accelerate) == (true) {
                                return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("S3Express does not support S3 Accelerate."
.to_string()));
                            }
#[allow(unused_variables)]
...
if let Some(disable_s3_express_session_auth) = disable_s3_express_session_auth { if (*disable_s3_express_session_auth) == (true) {
                                if (url.is_ip()) == (true) {
...
.property("authSchemes", vec![::aws_smithy_types::Document::from( {
    ...
    .to_string().into());
    out.insert("signingName".to_string(), "s3express"
    .to_string().into());
...
return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("S3Express bucket name is not a valid virtual hostable name."
.to_string()));
                            } }
if (url.is_ip()) == (true) {
                                let uri_encoded_bucket = crate::endpoint_lib::uri_encode::uri_encode(bucket, _diagnostic_collector);
...
.property("authSchemes", vec![::aws_smithy_types::Document::from( {
    let mut out = ::std::collections::HashMap::<String, ::aws_smithy_types::Document>::new();
    out.insert("disableDoubleEncoding".to_string(), true.into());
    out.insert("name".to_string(), "sigv4-s3express"
    .to_string().into());
    out.insert("signingName".to_string(), "s3express"
    .to_string().into());
    out.insert("signingRegion".to_string(), region.to_owned().into());
...
.to_string())); } }
#[allow(unused_variables)]
if let Some(use_s3_express_control_endpoint) = use_s3_express_control_endpoint { if (*use_s3_express_control_endpoint) == (true) {
                                let uri_encoded_bucket = crate::endpoint_lib::uri_encode::uri_encode(bucket, _diagnostic_collector);
                            if !(endpoint.is_some()) {
                                if (*use_fips) == (true) {
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
...
if let Some(disable_s3_express_session_auth) = disable_s3_express_session_auth { if (*disable_s3_express_session_auth) == (true) {
                                #[allow(unused_variables)]
if let Some(s3express_availability_zone_id) = crate::endpoint_lib::substring::substring(bucket
,6
,14
,true, _diagnostic_collector) { #[allow(unused_variables)]
if let Some(s3express_availability_zone_delim) = crate::endpoint_lib::substring::substring(bucket
,14
,16
,true, _diagnostic_collector) { if (s3express_availability_zone_delim) == ("--") {
                                if (*use_fips) == (true) {
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
out.push_str("https://");
#[allow(clippy::needless_borrow)]
...
return Err(::aws_smithy_http::endpoint::ResolveEndpointError::message("Unrecognized S3Express bucket name format."
.to_string()));
                            } }
#[allow(unused_variables)]
if let Some(s3express_availability_zone_id) = crate::endpoint_lib::substring::substring(bucket
...
,12
,true, _diagnostic_collector) { #[allow(unused_variables)]
if let Some(bucket_alias_suffix) = crate::endpoint_lib::substring::substring(bucket
,0
,7
,true, _diagnostic_collector) { #[allow(unused_variables)]
...
,49
,true, _diagnostic_collector) { #[allow(unused_variables)]
if let Some(region_partition) = partition_resolver.resolve_partition(region, _diagnostic_collector) { if (bucket_alias_suffix) == ("--op-s3") {
