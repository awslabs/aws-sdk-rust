...
impl LifecycleRuleFilter {
    ...
    pub fn as_and(&self) -> ::std::result::Result<&crate::types::LifecycleRuleAndOperator, &Self> {
        if let LifecycleRuleFilter::And(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_object_size_greater_than(&self) -> ::std::result::Result<&i64, &Self> {
        if let LifecycleRuleFilter::ObjectSizeGreaterThan(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_object_size_less_than(&self) -> ::std::result::Result<&i64, &Self> {
        if let LifecycleRuleFilter::ObjectSizeLessThan(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_prefix(&self) -> ::std::result::Result<&::std::string::String, &Self> {
        if let LifecycleRuleFilter::Prefix(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_tag(&self) -> ::std::result::Result<&crate::types::Tag, &Self> {
        if let LifecycleRuleFilter::Tag(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
