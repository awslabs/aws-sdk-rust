...
impl  CorsRule  {
    ...
    pub fn allowed_methods(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.allowed_methods.deref()
    }
    /// <p>One or more origins you want customers to be able to access the bucket from.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::CorsRule {
                ...
                allowed_methods: self.allowed_methods
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("allowed_methods", "allowed_methods was not specified but it is required when building CorsRule")
                    )?
                ,
