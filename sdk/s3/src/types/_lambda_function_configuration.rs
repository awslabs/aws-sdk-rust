        ...
        ::std::result::Result::Ok(
            crate::types::LambdaFunctionConfiguration {
                ...
                lambda_function_arn: self.lambda_function_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("lambda_function_arn", "lambda_function_arn was not specified but it is required when building LambdaFunctionConfiguration")
                    )?
                ,
                events: self.events
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("events", "events was not specified but it is required when building LambdaFunctionConfiguration")
                    )?
                ,
                filter: self.filter
                ,
