...
impl Builder {
    ...
    pub fn set_disable_multi_region_access_points(&mut self, disable_multi_region_access_points: Option<bool>) -> &mut Self {
                                    self.config.store_or_unset(disable_multi_region_access_points.map(crate::config::DisableMultiRegionAccessPoints));
                                    self
                                }
    ...
    pub fn set_disable_s3_express_session_auth(&mut self, disable_s3_express_session_auth: Option<bool>) -> &mut Self {
                                    self.config.store_or_unset(disable_s3_express_session_auth.map(crate::config::DisableS3ExpressSessionAuth));
                                    self
                                }
    ...
    /// Sets the credentials provider for S3 Express One Zone
                            pub fn express_credentials_provider(mut self, credentials_provider: impl crate::config::ProvideCredentials + 'static) -> Self {
                                self.set_express_credentials_provider(::std::option::Option::Some(crate::config::SharedCredentialsProvider::new(credentials_provider)));
                                self
                            }
    /// Sets the credentials provider for S3 Express One Zone
                            pub fn set_express_credentials_provider(&mut self, credentials_provider: ::std::option::Option<crate::config::SharedCredentialsProvider>) -> &mut Self {
                                if let ::std::option::Option::Some(credentials_provider) = credentials_provider {
                                    self.runtime_components.set_identity_resolver(crate::s3_express::auth::SCHEME_ID, credentials_provider);
                                }
                                self
                            }
...
runtime_components.push_auth_scheme(::aws_smithy_runtime_api::client::auth::SharedAuthScheme::new(crate::s3_express::auth::S3ExpressAuthScheme::new()));
...
resolver.config_mut()
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_s3::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
...
pub(crate) fn base_client_runtime_plugins(
    ...
    if config.behavior_version.is_none() {
                    ...
                    plugins = plugins.with_client_plugin(
                            crate::s3_express::runtime_plugin::S3ExpressRuntimePlugin::new(
                                config
                                    .config
