...
impl super::Client  {
    ...
    pub fn list_bucket_intelligent_tiering_configurations(&self) -> crate::client::fluent_builders::ListBucketIntelligentTieringConfigurations {
                                crate::client::fluent_builders::ListBucketIntelligentTieringConfigurations::new(self.handle.clone())
                            }
}
