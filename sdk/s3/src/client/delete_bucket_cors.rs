...
impl super::Client {
    ...
    ///   - [`bucket(impl ::std::convert::Into<String>)`](crate::operation::delete_bucket_cors::builders::DeleteBucketCorsFluentBuilder::bucket) / [`set_bucket(Option<String>)`](crate::operation::delete_bucket_cors::builders::DeleteBucketCorsFluentBuilder::set_bucket): <p>Specifies the bucket whose <code>cors</code> configuration is being deleted.</p>
