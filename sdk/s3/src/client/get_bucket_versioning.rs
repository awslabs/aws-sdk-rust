...
impl super::Client {
    ...
    ///   - [`expected_bucket_owner(impl Into<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::expected_bucket_owner) / [`set_expected_bucket_owner(Option<String>)`](crate::operation::get_bucket_versioning::builders::GetBucketVersioningFluentBuilder::set_expected_bucket_owner):<br>required: **false**<br><p>The account ID of the expected bucket owner. If the bucket is owned by a different account, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p><br>
