...
impl super::Client  {
    ...
    pub fn delete_bucket_intelligent_tiering_configuration(&self) -> crate::client::fluent_builders::DeleteBucketIntelligentTieringConfiguration {
                                crate::client::fluent_builders::DeleteBucketIntelligentTieringConfiguration::new(self.handle.clone())
                            }
}
