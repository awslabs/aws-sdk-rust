...
impl super::Client {
    ...
    ///   - [`bucket(impl ::std::convert::Into<String>)`](crate::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder::bucket) / [`set_bucket(Option<String>)`](crate::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder::set_bucket): <p>The bucket name for which to get the logging information.</p>
    ///   - [`expected_bucket_owner(impl ::std::convert::Into<String>)`](crate::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder::expected_bucket_owner) / [`set_expected_bucket_owner(Option<String>)`](crate::operation::get_bucket_logging::builders::GetBucketLoggingFluentBuilder::set_expected_bucket_owner): <p>The account ID of the expected bucket owner. If the bucket is owned by a different account, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
