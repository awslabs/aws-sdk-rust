...
impl super::Client  {
    ...
    pub fn put_bucket_intelligent_tiering_configuration(&self) -> crate::client::fluent_builders::PutBucketIntelligentTieringConfiguration {
                                crate::client::fluent_builders::PutBucketIntelligentTieringConfiguration::new(self.handle.clone())
                            }
}
