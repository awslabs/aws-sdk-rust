...
impl super::Client {
    ...
    ///   - [`key(impl Into<String>)`](crate::operation::delete_object_tagging::builders::DeleteObjectTaggingFluentBuilder::key) / [`set_key(Option<String>)`](crate::operation::delete_object_tagging::builders::DeleteObjectTaggingFluentBuilder::set_key): <p>The key that identifies the object in the bucket from which to remove all tags.</p>
