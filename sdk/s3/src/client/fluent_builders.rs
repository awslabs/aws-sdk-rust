...
impl CopyObject {
    ...
    /// <p>The canned ACL to apply to the object.</p>
    /// <p>This action is not supported by Amazon S3 on Outposts.</p>
    pub fn set_acl(mut self, input: std::option::Option<crate::model::ObjectCannedAcl>) -> Self {
...
impl DeleteBucketAnalyticsConfiguration {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            ...
            aws_http::retry::AwsResponseRetryClassifier,
        >,
        aws_smithy_http::result::SdkError<crate::error::DeleteBucketAnalyticsConfigurationError>,
    > {
        let handle = self.handle.clone();
        let operation = self
            .inner
...
impl DeleteBucketInventoryConfiguration {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            ...
            aws_http::retry::AwsResponseRetryClassifier,
        >,
        aws_smithy_http::result::SdkError<crate::error::DeleteBucketInventoryConfigurationError>,
    > {
        let handle = self.handle.clone();
        let operation = self
            .inner
...
impl GetBucketNotificationConfiguration {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            ...
            aws_http::retry::AwsResponseRetryClassifier,
        >,
        aws_smithy_http::result::SdkError<crate::error::GetBucketNotificationConfigurationError>,
    > {
        let handle = self.handle.clone();
        let operation = self
            .inner
...
impl ListObjectsV2 {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::paginator::ListObjectsV2Paginator::send) which returns a `Stream`.
...
impl PutBucketNotificationConfiguration {
    ...
    pub async fn customize(
        ...
        crate::operation::customize::CustomizableOperation<
            ...
            aws_http::retry::AwsResponseRetryClassifier,
        >,
        aws_smithy_http::result::SdkError<crate::error::PutBucketNotificationConfigurationError>,
    > {
        let handle = self.handle.clone();
        let operation = self
            .inner
...
impl SelectObjectContent {
    ...
    /// </scanrange></code> - process only the records within the last 50 bytes of the file.</p> </li>
    /// </ul>
    pub fn set_scan_range(mut self, input: std::option::Option<crate::model::ScanRange>) -> Self {
