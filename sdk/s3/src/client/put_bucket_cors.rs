...
impl super::Client {
    ...
    ///   - [`bucket(impl Into<String>)`](crate::operation::put_bucket_cors::builders::PutBucketCorsFluentBuilder::bucket) / [`set_bucket(Option<String>)`](crate::operation::put_bucket_cors::builders::PutBucketCorsFluentBuilder::set_bucket): <p>Specifies the bucket impacted by the <code>cors</code>configuration.</p>
