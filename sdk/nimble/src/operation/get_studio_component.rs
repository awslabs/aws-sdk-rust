...
impl GetStudioComponentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_studio_component::GetStudioComponent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStudioComponent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_studio_component::de_get_studio_component_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_studio_component::GetStudioComponentError
{
