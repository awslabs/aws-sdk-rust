...
impl CreateStreamingSessionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_streaming_session::CreateStreamingSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_streaming_session::CreateStreamingSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_streaming_session::CreateStreamingSessionOutput, crate::operation::create_streaming_session::CreateStreamingSessionError, Self> {
