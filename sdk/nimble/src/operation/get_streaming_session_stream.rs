...
impl GetStreamingSessionStreamInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_streaming_session_stream::GetStreamingSessionStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStreamingSessionStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_streaming_session_stream::de_get_streaming_session_stream_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_streaming_session_stream::GetStreamingSessionStreamError
{
