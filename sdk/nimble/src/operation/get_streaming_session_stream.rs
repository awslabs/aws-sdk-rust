...
impl GetStreamingSessionStreamInput {
    /// Consumes the builder and constructs an Operation<[`GetStreamingSessionStream`](crate::operation::get_streaming_session_stream::GetStreamingSessionStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_streaming_session_stream::GetStreamingSessionStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_streaming_session_stream::GetStreamingSessionStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("stream_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_streaming_session_stream::GetStreamingSessionStream::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetStreamingSessionStream {
                type Output = std::result::Result<crate::operation::get_streaming_session_stream::GetStreamingSessionStreamOutput, crate::operation::get_streaming_session_stream::GetStreamingSessionStreamError>;
