...
impl ListStreamingSessionBackupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_streaming_session_backups::ListStreamingSessionBackups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStreamingSessionBackups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_streaming_session_backups::de_list_streaming_session_backups_http_response_with_props(
                status, headers, body,
            )
        }
    }
