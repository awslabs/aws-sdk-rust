...
impl StartStudioSSOConfigurationRepairFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_studio_sso_configuration_repair::StartStudioSsoConfigurationRepairOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_studio_sso_configuration_repair::StartStudioSSOConfigurationRepairError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_studio_sso_configuration_repair::StartStudioSsoConfigurationRepairOutput, crate::operation::start_studio_sso_configuration_repair::StartStudioSSOConfigurationRepairError, Self> {
