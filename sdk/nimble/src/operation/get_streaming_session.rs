...
impl GetStreamingSessionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_streaming_session::GetStreamingSession::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetStreamingSession {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_streaming_session::de_get_streaming_session_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::get_streaming_session::GetStreamingSessionError
{
