...
impl CreateStreamingSessionInput {
    /// Consumes the builder and constructs an Operation<[`CreateStreamingSession`](crate::operation::create_streaming_session::CreateStreamingSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_streaming_session::CreateStreamingSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_streaming_session::CreateStreamingSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_streaming_session::CreateStreamingSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateStreamingSession {
                type Output = std::result::Result<crate::operation::create_streaming_session::CreateStreamingSessionOutput, crate::operation::create_streaming_session::CreateStreamingSessionError>;
