...
impl DeleteStudioMemberInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_studio_member::DeleteStudioMember,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStudioMember {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_studio_member::de_delete_studio_member_http_response_with_props(status, headers, body)
        }
    }
}
