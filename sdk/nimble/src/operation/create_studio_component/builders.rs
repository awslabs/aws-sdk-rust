...
impl CreateStudioComponentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_studio_component::CreateStudioComponentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_studio_component::CreateStudioComponentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_studio_component::CreateStudioComponentOutput, crate::operation::create_studio_component::CreateStudioComponentError, Self> {
