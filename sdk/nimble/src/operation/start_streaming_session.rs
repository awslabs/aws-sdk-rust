...
impl StartStreamingSessionInput {
    /// Consumes the builder and constructs an Operation<[`StartStreamingSession`](crate::operation::start_streaming_session::StartStreamingSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_streaming_session::StartStreamingSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_streaming_session::StartStreamingSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_streaming_session::StartStreamingSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartStreamingSession {
                type Output = std::result::Result<crate::operation::start_streaming_session::StartStreamingSessionOutput, crate::operation::start_streaming_session::StartStreamingSessionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_streaming_session::de_start_streaming_session_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_streaming_session::de_start_streaming_session_http_response(response)
                     }
                }
            }
