...
impl GetStreamingSessionBackupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_streaming_session_backup::GetStreamingSessionBackup,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_streaming_session_backup::GetStreamingSessionBackup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStreamingSessionBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_streaming_session_backup::de_get_streaming_session_backup_http_response_with_props(status, headers, body)
        }
    }
}
