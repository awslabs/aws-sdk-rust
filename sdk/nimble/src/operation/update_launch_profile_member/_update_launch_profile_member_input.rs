...
impl UpdateLaunchProfileMemberInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_launch_profile_member::UpdateLaunchProfileMemberInput, ::aws_smithy_types::error::operation::BuildError> {
