...
impl UpdateLaunchProfileMemberFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_launch_profile_member::UpdateLaunchProfileMemberOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_launch_profile_member::UpdateLaunchProfileMemberError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_launch_profile_member::UpdateLaunchProfileMemberOutput, crate::operation::update_launch_profile_member::UpdateLaunchProfileMemberError, Self> {
