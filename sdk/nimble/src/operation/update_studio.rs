...
impl UpdateStudioInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStudio`](crate::operation::update_studio::UpdateStudio)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_studio::UpdateStudio, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_studio::ser_update_studio_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_studio::UpdateStudio::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStudio {
    type Output = ::std::result::Result<crate::operation::update_studio::UpdateStudioOutput, crate::operation::update_studio::UpdateStudioError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_studio::de_update_studio_http_response_with_props(status, headers, body)
        }
    }
