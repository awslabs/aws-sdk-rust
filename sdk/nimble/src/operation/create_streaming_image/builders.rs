...
impl CreateStreamingImageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_streaming_image::CreateStreamingImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_streaming_image::CreateStreamingImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_streaming_image::CreateStreamingImageOutput, crate::operation::create_streaming_image::CreateStreamingImageError, Self> {
