...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetLaunchProfileInitializationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetLaunchProfileInitializationRequestSerializer {
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_3 = inner_3.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("launch_profile_protocol_versions", "cannot be empty or unset")
                })?;
                ...
                let inner_5 = inner_5
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("launch_purpose", "cannot be empty or unset"))?;
                if inner_5.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field(
                        "launch_purpose",
                        "cannot be empty or unset",
                ...
                let inner_6 = inner_6
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("platform", "cannot be empty or unset"))?;
                if inner_6.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field(
                        "platform",
                        "cannot be empty or unset",
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetLaunchProfileInitializationEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_launch_profile_initialization::GetLaunchProfileInitializationError {
