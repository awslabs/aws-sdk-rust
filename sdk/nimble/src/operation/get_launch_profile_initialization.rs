...
impl GetLaunchProfileInitializationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_launch_profile_initialization::GetLaunchProfileInitialization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLaunchProfileInitialization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_launch_profile_initialization::de_get_launch_profile_initialization_http_response_with_props(
                status, headers, body,
            )
        }
    }
