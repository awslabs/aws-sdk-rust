...
impl StartStudioSsoConfigurationRepairInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_studio_sso_configuration_repair::StartStudioSSOConfigurationRepair::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartStudioSSOConfigurationRepair {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_studio_sso_configuration_repair::de_start_studio_sso_configuration_repair_http_response_with_props(
                status, headers, body,
            )
        }
    }
