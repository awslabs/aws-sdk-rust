...
impl GetLaunchProfileDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_launch_profile_details::GetLaunchProfileDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
