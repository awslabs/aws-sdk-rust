...
impl UpdateLaunchProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_launch_profile::UpdateLaunchProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLaunchProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_launch_profile::de_update_launch_profile_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_launch_profile::UpdateLaunchProfileError
{
