...
impl  ListStudiosOutput  {
    ...
    pub fn studios(&self) -> & [crate::types::Studio] {
        use std::ops::Deref; self.studios.deref()
    }
}
        ...
        ::std::result::Result::Ok(
            crate::operation::list_studios::ListStudiosOutput {
                ...
                studios: self.studios
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("studios", "studios was not specified but it is required when building ListStudiosOutput")
                    )?
                ,
