    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2020-08-01/eulas/{eulaId}", eulaId = eula_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_eula::GetEula::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEula {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_eula::de_get_eula_http_response_with_props(
                status, headers, body,
            )
        }
    }
