...
impl ListEulasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_eulas::ListEulas,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_eulas::ListEulas::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEulas {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_eulas::de_list_eulas_http_response_with_props(
                status, headers, body,
            )
        }
    }
