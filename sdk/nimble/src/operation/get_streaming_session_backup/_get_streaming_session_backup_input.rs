...
impl GetStreamingSessionBackupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_streaming_session_backup::GetStreamingSessionBackupInput, ::aws_smithy_types::error::operation::BuildError> {
