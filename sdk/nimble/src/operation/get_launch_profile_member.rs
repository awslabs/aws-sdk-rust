...
impl GetLaunchProfileMemberInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_launch_profile_member::GetLaunchProfileMember,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLaunchProfileMember {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_launch_profile_member::de_get_launch_profile_member_http_response_with_props(status, headers, body)
        }
    }
}
