...
impl GetLaunchProfileMemberInput {
    /// Consumes the builder and constructs an Operation<[`GetLaunchProfileMember`](crate::operation::get_launch_profile_member::GetLaunchProfileMember)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_launch_profile_member::GetLaunchProfileMember, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_launch_profile_member::GetLaunchProfileMemberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("principal_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_launch_profile_member::GetLaunchProfileMember::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetLaunchProfileMember {
                type Output = std::result::Result<crate::operation::get_launch_profile_member::GetLaunchProfileMemberOutput, crate::operation::get_launch_profile_member::GetLaunchProfileMemberError>;
