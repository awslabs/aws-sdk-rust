...
impl CreateLaunchProfileInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_launch_profile::CreateLaunchProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLaunchProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_launch_profile::de_create_launch_profile_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_launch_profile::CreateLaunchProfileError
{
