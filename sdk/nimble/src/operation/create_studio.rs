...
impl CreateStudioInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_studio::CreateStudio, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_studio::ser_create_studio_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStudio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_studio::de_create_studio_http_response_with_props(status, headers, body)
        }
    }
