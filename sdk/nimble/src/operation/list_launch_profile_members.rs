...
impl ListLaunchProfileMembersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_launch_profile_members::ListLaunchProfileMembers,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_launch_profile_members::ListLaunchProfileMembers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLaunchProfileMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_launch_profile_members::de_list_launch_profile_members_http_response_with_props(status, headers, body)
        }
    }
}
