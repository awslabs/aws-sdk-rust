...
impl StopStreamingSessionInput {
    /// Consumes the builder and constructs an Operation<[`StopStreamingSession`](crate::operation::stop_streaming_session::StopStreamingSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_streaming_session::StopStreamingSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_streaming_session::StopStreamingSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_streaming_session::StopStreamingSession::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopStreamingSession {
                type Output = std::result::Result<crate::operation::stop_streaming_session::StopStreamingSessionOutput, crate::operation::stop_streaming_session::StopStreamingSessionError>;
