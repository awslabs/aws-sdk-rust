...
impl ListStudioMembersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_studio_members::ListStudioMembers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStudioMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_studio_members::de_list_studio_members_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_studio_members::ListStudioMembersError
{
