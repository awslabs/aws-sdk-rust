...
impl GetStreamingSessionStreamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_streaming_session_stream::GetStreamingSessionStreamInput, ::aws_smithy_types::error::operation::BuildError> {
