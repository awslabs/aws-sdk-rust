...
impl GetStreamingSessionStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_streaming_session_stream::GetStreamingSessionStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_streaming_session_stream::GetStreamingSessionStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_streaming_session_stream::GetStreamingSessionStreamOutput, crate::operation::get_streaming_session_stream::GetStreamingSessionStreamError, Self> {
