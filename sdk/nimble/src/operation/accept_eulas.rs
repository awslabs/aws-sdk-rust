...
impl AcceptEulasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::accept_eulas::AcceptEulas, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_accept_eulas::ser_accept_eulas_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptEulas {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_eulas::de_accept_eulas_http_response_with_props(status, headers, body)
        }
    }
}
