...
impl AcceptEulasInput {
    /// Consumes the builder and constructs an Operation<[`AcceptEulas`](crate::operation::accept_eulas::AcceptEulas)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::accept_eulas::AcceptEulas, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_eulas::AcceptEulasInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::accept_eulas::AcceptEulas::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptEulas {
                type Output = std::result::Result<crate::operation::accept_eulas::AcceptEulasOutput, crate::operation::accept_eulas::AcceptEulasError>;
