...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStreamingSessionStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_streaming_session_stream::de_create_streaming_session_stream_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateStreamingSessionStreamError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_streaming_session_stream::CreateStreamingSessionStreamError
{
