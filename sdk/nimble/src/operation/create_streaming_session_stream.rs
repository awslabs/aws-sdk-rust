...
impl CreateStreamingSessionStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_streaming_session_stream::CreateStreamingSessionStream,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_streaming_session_stream::CreateStreamingSessionStream::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStreamingSessionStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_streaming_session_stream::de_create_streaming_session_stream_http_response_with_props(
                status, headers, body,
            )
        }
    }
