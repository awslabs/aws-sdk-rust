...
impl PutLaunchProfileMembersInput {
    /// Consumes the builder and constructs an Operation<[`PutLaunchProfileMembers`](crate::operation::put_launch_profile_members::PutLaunchProfileMembers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_launch_profile_members::PutLaunchProfileMembers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_launch_profile_members::PutLaunchProfileMembersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_launch_profile_members::PutLaunchProfileMembers::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutLaunchProfileMembers {
                type Output = std::result::Result<crate::operation::put_launch_profile_members::PutLaunchProfileMembersOutput, crate::operation::put_launch_profile_members::PutLaunchProfileMembersError>;
