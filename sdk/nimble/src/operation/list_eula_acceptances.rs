...
impl ListEulaAcceptancesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_eula_acceptances::ListEulaAcceptances::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListEulaAcceptances {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_eula_acceptances::de_list_eula_acceptances_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_eula_acceptances::ListEulaAcceptancesError
{
