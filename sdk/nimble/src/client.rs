...
impl Client  {
    ...
    pub fn get_launch_profile_initialization(&self) -> fluent_builders::GetLaunchProfileInitialization {
    ...
    pub fn start_studio_sso_configuration_repair(&self) -> fluent_builders::StartStudioSSOConfigurationRepair {
