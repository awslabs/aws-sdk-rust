...
pub struct ListStudioMembersOutput  {
    ...
    #[doc(hidden)]pub members: std::option::Option<std::vec::Vec<crate::model::StudioMembership>>,
...
pub struct GetStudioMemberOutput  {
    /// <p>The member.</p>
    #[doc(hidden)]pub member: std::option::Option<crate::model::StudioMembership>,
}
...
pub struct ListStudiosOutput  {
    ...
    #[doc(hidden)]pub studios: std::option::Option<std::vec::Vec<crate::model::Studio>>,
}
...
pub struct ListStudioComponentsOutput  {
    ...
    #[doc(hidden)]pub studio_components: std::option::Option<std::vec::Vec<crate::model::StudioComponent>>,
}
...
pub struct CreateStudioComponentOutput  {
    ...
    #[doc(hidden)]pub studio_component: std::option::Option<crate::model::StudioComponent>,
}
...
pub struct StopStreamingSessionOutput  {
    ...
    #[doc(hidden)]pub session: std::option::Option<crate::model::StreamingSession>,
}
...
pub struct GetStreamingSessionStreamOutput  {
    /// <p>The stream.</p>
    #[doc(hidden)]pub stream: std::option::Option<crate::model::StreamingSessionStream>,
}
...
pub struct ListStreamingSessionsOutput  {
    ...
    #[doc(hidden)]pub sessions: std::option::Option<std::vec::Vec<crate::model::StreamingSession>>,
}
...
pub struct ListStreamingImagesOutput  {
    ...
    #[doc(hidden)]pub streaming_images: std::option::Option<std::vec::Vec<crate::model::StreamingImage>>,
}
...
pub struct CreateStreamingImageOutput  {
    ...
    #[doc(hidden)]pub streaming_image: std::option::Option<crate::model::StreamingImage>,
}
...
pub struct UpdateLaunchProfileMemberOutput  {
    ...
    #[doc(hidden)]pub member: std::option::Option<crate::model::LaunchProfileMembership>,
}
...
pub struct ListLaunchProfileMembersOutput  {
    ...
    #[doc(hidden)]pub members: std::option::Option<std::vec::Vec<crate::model::LaunchProfileMembership>>,
    /// <p>The token for the next set of results, or null if there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetLaunchProfileInitializationOutput  {
    ...
    #[doc(hidden)]pub launch_profile_initialization: std::option::Option<crate::model::LaunchProfileInitialization>,
}
...
impl  std::fmt::Debug for GetLaunchProfileInitializationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("launch_profile_initialization", &self.launch_profile_initialization);
        formatter.finish()
    }
}
...
pub struct GetLaunchProfileDetailsOutput  {
    ...
    #[doc(hidden)]pub launch_profile: std::option::Option<crate::model::LaunchProfile>,
    /// <p>A collection of streaming images.</p>
    #[doc(hidden)]pub streaming_images: std::option::Option<std::vec::Vec<crate::model::StreamingImage>>,
    /// <p>A collection of studio component summaries.</p>
    #[doc(hidden)]pub studio_component_summaries: std::option::Option<std::vec::Vec<crate::model::StudioComponentSummary>>,
}
...
impl  std::fmt::Debug for GetLaunchProfileDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("streaming_images", &self.streaming_images);
        formatter.field("studio_component_summaries", &self.studio_component_summaries);
        formatter.finish()
    }
}
...
pub struct ListLaunchProfilesOutput  {
    ...
    #[doc(hidden)]pub launch_profiles: std::option::Option<std::vec::Vec<crate::model::LaunchProfile>>,
    /// <p>The token for the next set of results, or null if there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListEulasOutput  {
    ...
    #[doc(hidden)]pub eulas: std::option::Option<std::vec::Vec<crate::model::Eula>>,
    /// <p>The token for the next set of results, or null if there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetEulaOutput  {
    /// <p>The EULA.</p>
    #[doc(hidden)]pub eula: std::option::Option<crate::model::Eula>,
}
impl GetEulaOutput {
    /// <p>The EULA.</p>
...
pub struct ListEulaAcceptancesOutput  {
    ...
    #[doc(hidden)]pub eula_acceptances: std::option::Option<std::vec::Vec<crate::model::EulaAcceptance>>,
    /// <p>The token for the next set of results, or null if there are no more results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
