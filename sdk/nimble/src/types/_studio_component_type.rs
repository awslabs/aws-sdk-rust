...
impl ::std::convert::From<&str> for StudioComponentType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StudioComponentType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StudioComponentType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StudioComponentType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StudioComponentType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
