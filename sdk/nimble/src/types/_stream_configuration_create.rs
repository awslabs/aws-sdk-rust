        ...
        ::std::result::Result::Ok(
            crate::types::StreamConfigurationCreate {
                clipboard_mode: self.clipboard_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("clipboard_mode", "clipboard_mode was not specified but it is required when building StreamConfigurationCreate")
                    )?
                ,
                ec2_instance_types: self.ec2_instance_types
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("ec2_instance_types", "ec2_instance_types was not specified but it is required when building StreamConfigurationCreate")
                    )?
                ,
                ...
                streaming_image_ids: self.streaming_image_ids
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("streaming_image_ids", "streaming_image_ids was not specified but it is required when building StreamConfigurationCreate")
                    )?
                ,
