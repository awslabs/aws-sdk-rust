...
impl ::std::convert::From<&str> for LaunchProfileValidationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => LaunchProfileValidationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for LaunchProfileValidationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(LaunchProfileValidationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for LaunchProfileValidationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
