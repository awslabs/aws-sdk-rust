...
impl StudioComponentConfiguration {
    ...
    pub fn as_active_directory_configuration(&self) -> ::std::result::Result<&crate::types::ActiveDirectoryConfiguration, &Self> {
        if let StudioComponentConfiguration::ActiveDirectoryConfiguration(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_compute_farm_configuration(&self) -> ::std::result::Result<&crate::types::ComputeFarmConfiguration, &Self> {
        if let StudioComponentConfiguration::ComputeFarmConfiguration(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_license_service_configuration(&self) -> ::std::result::Result<&crate::types::LicenseServiceConfiguration, &Self> {
        if let StudioComponentConfiguration::LicenseServiceConfiguration(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_shared_file_system_configuration(&self) -> ::std::result::Result<&crate::types::SharedFileSystemConfiguration, &Self> {
        if let StudioComponentConfiguration::SharedFileSystemConfiguration(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
