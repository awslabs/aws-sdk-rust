...
impl ::std::convert::From<&str> for StreamingSessionStorageMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StreamingSessionStorageMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StreamingSessionStorageMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StreamingSessionStorageMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for StreamingSessionStorageMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
