...
impl ::std::convert::From<&str> for SessionBackupMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SessionBackupMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SessionBackupMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SessionBackupMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SessionBackupMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
