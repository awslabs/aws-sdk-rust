...
impl ::std::convert::From<&str> for SessionPersistenceMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SessionPersistenceMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SessionPersistenceMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SessionPersistenceMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SessionPersistenceMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
