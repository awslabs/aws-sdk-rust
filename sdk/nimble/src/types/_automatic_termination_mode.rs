...
impl ::std::convert::From<&str> for AutomaticTerminationMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AutomaticTerminationMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AutomaticTerminationMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AutomaticTerminationMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AutomaticTerminationMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
