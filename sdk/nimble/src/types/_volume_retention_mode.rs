...
impl ::std::convert::From<&str> for VolumeRetentionMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => VolumeRetentionMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for VolumeRetentionMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(VolumeRetentionMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for VolumeRetentionMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
