...
impl ::std::convert::From<&str> for StudioState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => StudioState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for StudioState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(StudioState::from(s))
    }
}
impl StudioState {
...
impl ::std::convert::AsRef<str> for StudioState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
