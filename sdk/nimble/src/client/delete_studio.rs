...
impl super::Client {
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::delete_studio::builders::DeleteStudioFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_studio::builders::DeleteStudioFluentBuilder::set_client_token):<br>required: **false**<br><p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. If you don’t specify a client token, the Amazon Web Services SDK automatically generates a client token and uses it for the request to ensure idempotency.</p><br>
    ///   - [`studio_id(impl Into<String>)`](crate::operation::delete_studio::builders::DeleteStudioFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::delete_studio::builders::DeleteStudioFluentBuilder::set_studio_id):<br>required: **true**<br><p>The studio ID.</p><br>
