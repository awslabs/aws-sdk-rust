...
impl super::Client {
    ...
    ///   - [`studio_id(impl Into<String>)`](crate::operation::get_studio_member::builders::GetStudioMemberFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::get_studio_member::builders::GetStudioMemberFluentBuilder::set_studio_id):<br>required: **true**<br><p>The studio ID.</p><br>
