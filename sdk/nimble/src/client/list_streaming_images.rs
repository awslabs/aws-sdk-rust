...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_streaming_images::builders::ListStreamingImagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_streaming_images::builders::ListStreamingImagesFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next set of results, or null if there are no more results.</p><br>
    ///   - [`owner(impl Into<String>)`](crate::operation::list_streaming_images::builders::ListStreamingImagesFluentBuilder::owner) / [`set_owner(Option<String>)`](crate::operation::list_streaming_images::builders::ListStreamingImagesFluentBuilder::set_owner):<br>required: **false**<br><p>Filter this request to streaming images with the given owner</p><br>
