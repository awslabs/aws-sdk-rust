...
impl super::Client {
    ...
    ///   - [`eula_ids(impl Into<String>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::eula_ids) / [`set_eula_ids(Option<Vec<String>>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::set_eula_ids): <p>The list of EULA IDs that have been previously accepted.</p>
