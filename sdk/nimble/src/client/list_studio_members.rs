...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_studio_members::builders::ListStudioMembersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_studio_members::builders::ListStudioMembersFluentBuilder::set_max_results):<br>required: **false**<br><p>The max number of results to return in the response.</p><br>
