...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. If you don’t specify a client token, the Amazon Web Services SDK automatically generates a client token and uses it for the request to ensure idempotency.</p>
    ///   - [`launch_profile_id(impl ::std::convert::Into<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::launch_profile_id) / [`set_launch_profile_id(Option<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::set_launch_profile_id): <p>The ID of the launch profile used to control access from the streaming session.</p>
    ///   - [`studio_id(impl ::std::convert::Into<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::delete_launch_profile::builders::DeleteLaunchProfileFluentBuilder::set_studio_id): <p>The studio ID. </p>
