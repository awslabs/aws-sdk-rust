...
impl super::Client {
    ...
    ///   - [`states(LaunchProfileState)`](crate::operation::list_launch_profiles::builders::ListLaunchProfilesFluentBuilder::states) / [`set_states(Option<Vec<LaunchProfileState>>)`](crate::operation::list_launch_profiles::builders::ListLaunchProfilesFluentBuilder::set_states): <p>Filter this request to launch profiles in any of the given states.</p>
