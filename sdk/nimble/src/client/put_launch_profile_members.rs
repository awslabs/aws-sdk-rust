...
impl super::Client {
    ...
    ///   - [`members(NewLaunchProfileMember)`](crate::operation::put_launch_profile_members::builders::PutLaunchProfileMembersFluentBuilder::members) / [`set_members(Option<Vec<NewLaunchProfileMember>>)`](crate::operation::put_launch_profile_members::builders::PutLaunchProfileMembersFluentBuilder::set_members): <p>A list of members.</p>
