...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::set_description):<br>required: **false**<br><p>The description.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::set_name):<br>required: **false**<br><p>The name for the streaming image.</p><br>
    ///   - [`streaming_image_id(impl Into<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::streaming_image_id) / [`set_streaming_image_id(Option<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::set_streaming_image_id):<br>required: **true**<br><p>The streaming image ID.</p><br>
    ///   - [`studio_id(impl Into<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::update_streaming_image::builders::UpdateStreamingImageFluentBuilder::set_studio_id):<br>required: **true**<br><p>The studio ID.</p><br>
