...
) -> Result<Option<crate::types::StreamingImage>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "eulaIds" => {
                                builder = builder.set_eula_ids(crate::protocol_serde::shape_eula_id_list::de_eula_id_list(tokens)?);
                            }
                            "name" => {
                            ...
                            "state" => {
                                builder = builder.set_state(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| s.to_unescaped().map(|u| crate::types::StreamingImageState::from(u.as_ref())))
                                        .transpose()?,
                                );
                            }
                            "statusCode" => {
                                builder = builder.set_status_code(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                        .map(|s| s.to_unescaped().map(|u| crate::types::StreamingImageStatusCode::from(u.as_ref())))
                                        .transpose()?,
                                );
                            }
                            "statusMessage" => {
