...
pub(crate) fn de_streaming_image<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StreamingImage>, aws_smithy_json::deserialize::error::DeserializeError>
