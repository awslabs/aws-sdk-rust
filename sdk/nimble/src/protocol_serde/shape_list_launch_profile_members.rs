...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_launch_profile_members::ListLaunchProfileMembersError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_launch_profile_members::ListLaunchProfileMembersError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::list_launch_profile_members::ListLaunchProfileMembersError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::list_launch_profile_members::ListLaunchProfileMembersError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_launch_profile_members::de_list_launch_profile_members(_response_body, output)
            .map_err(crate::operation::list_launch_profile_members::ListLaunchProfileMembersError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "members" => {
                    builder =
                        builder.set_members(crate::protocol_serde::shape_launch_profile_membership_list::de_launch_profile_membership_list(tokens)?);
                }
                "nextToken" => {
