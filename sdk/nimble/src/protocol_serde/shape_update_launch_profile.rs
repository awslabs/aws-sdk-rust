...
> {
    ...
    .map_err(crate::operation::update_launch_profile::UpdateLaunchProfileError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_launch_profile::UpdateLaunchProfileError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_launch_profile_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_update_launch_profile(
    value: &[u8],
    mut builder: crate::operation::update_launch_profile::builders::UpdateLaunchProfileOutputBuilder,
) -> Result<
