...
pub fn ser_create_launch_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLaunchProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
