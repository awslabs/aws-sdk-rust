...
pub(crate) fn de_stream_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StreamConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
