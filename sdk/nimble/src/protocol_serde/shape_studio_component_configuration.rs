...
pub fn ser_studio_component_configuration(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::StudioComponentConfiguration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::StudioComponentConfiguration::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("StudioComponentConfiguration"))
    }
    Ok(())
}
