...
pub fn de_list_streaming_sessions_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, crate::operation::list_streaming_sessions::ListStreamingSessionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_streaming_sessions::ListStreamingSessionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_streaming_sessions_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, crate::operation::list_streaming_sessions::ListStreamingSessionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_streaming_sessions::builders::ListStreamingSessionsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_streaming_sessions::de_list_streaming_sessions(_response_body, output).map_err(crate::operation::list_streaming_sessions::ListStreamingSessionsError::unhandled)?;
