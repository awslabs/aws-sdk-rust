...
pub fn de_list_streaming_sessions_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, crate::operation::list_streaming_sessions::ListStreamingSessionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_streaming_sessions_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_streaming_sessions::ListStreamingSessionsOutput, crate::operation::list_streaming_sessions::ListStreamingSessionsError> {
    Ok({
        #[allow(unused_mut)]
