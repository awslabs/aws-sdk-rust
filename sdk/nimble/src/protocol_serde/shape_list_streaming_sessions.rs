...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_streaming_sessions::de_list_streaming_sessions(_response_body, output)
            .map_err(crate::operation::list_streaming_sessions::ListStreamingSessionsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "sessions" => {
                    builder = builder.set_sessions(crate::protocol_serde::shape_streaming_session_list::de_streaming_session_list(tokens)?);
                }
