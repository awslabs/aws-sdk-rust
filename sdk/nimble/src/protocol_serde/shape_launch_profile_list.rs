...
pub(crate) fn de_launch_profile_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::LaunchProfile>>, aws_smithy_json::deserialize::error::DeserializeError>
