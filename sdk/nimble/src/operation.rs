...
impl aws_smithy_http::response::ParseStrictResponse for GetLaunchProfile {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_launch_profile::de_get_launch_profile_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_launch_profile::de_get_launch_profile_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for GetStreamingImage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_streaming_image::de_get_streaming_image_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_streaming_image::de_get_streaming_image_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for GetStudioMember {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_studio_member::de_get_studio_member_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_studio_member::de_get_studio_member_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListLaunchProfiles {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_launch_profiles::de_list_launch_profiles_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_launch_profiles::de_list_launch_profiles_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListStreamingImages {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_streaming_images::de_list_streaming_images_http_error(
                response,
            )
        } else {
...
impl aws_smithy_http::response::ParseStrictResponse for PutStudioMembers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_put_studio_members::de_put_studio_members_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_put_studio_members::de_put_studio_members_http_response(
                response,
            )
        }
    }
