...
pub struct ValidationException  {
    ...
    #[doc(hidden)]pub code: std::option::Option<std::string::String>,
    /// <p>The exception context.</p>
    #[doc(hidden)]pub context: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
