...
///
/// Fluent builder for the `launch_profile_ready` waiter.
///
...
pub struct LaunchProfileReadyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_launch_profile::builders::GetLaunchProfileInputBuilder,
}
impl LaunchProfileReadyFluentBuilder {
    /// Creates a new `LaunchProfileReadyFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::launch_profile_ready::LaunchProfileReadyFinalPoll,
        crate::waiters::launch_profile_ready::WaitUntilLaunchProfileReadyError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"launchProfile.state","expected":"READY","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_launch_profile_f6afcfb2fd1b2cad8(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"launchProfile.state","expected":"CREATE_FAILED","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_launch_profile_04baa1a2414e3aff8(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
            // Matches: {"output":{"path":"launchProfile.state","expected":"UPDATE_FAILED","comparator":"stringEquals"}}
            if crate::waiters::matchers::match_get_launch_profile_33bf75240fbf84d59(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Failure;
            }
...
/// Successful return type for the `launch_profile_ready` waiter.
pub type LaunchProfileReadyFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::get_launch_profile::GetLaunchProfileOutput,
...
/// Error type for the `launch_profile_ready` waiter.
pub type WaitUntilLaunchProfileReadyError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_launch_profile::GetLaunchProfileOutput,
    crate::operation::get_launch_profile::GetLaunchProfileError,
>;
