...
///
/// Fluent builder for the `services_inactive` waiter.
///
...
impl ServicesInactiveFluentBuilder {
    ...
    pub async fn wait(
        ...
        crate::waiters::services_inactive::ServicesInactiveFinalPoll,
        crate::waiters::services_inactive::WaitUntilServicesInactiveError,
    > {
        let input = self
            .inner
            .build()
...
/// Successful return type for the `services_inactive` waiter.
pub type ServicesInactiveFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_services::DescribeServicesOutput,
...
/// Error type for the `services_inactive` waiter.
pub type WaitUntilServicesInactiveError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_services::DescribeServicesOutput,
    crate::operation::describe_services::DescribeServicesError,
>;
