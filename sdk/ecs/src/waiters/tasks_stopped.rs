...
///
/// Fluent builder for the `tasks_stopped` waiter.
///
...
pub struct TasksStoppedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_tasks::builders::DescribeTasksInputBuilder,
}
impl TasksStoppedFluentBuilder {
    /// Creates a new `TasksStoppedFluentBuilder`.
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::tasks_stopped::TasksStoppedFinalPoll, crate::waiters::tasks_stopped::WaitUntilTasksStoppedError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"tasks[].lastStatus","expected":"STOPPED","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_tasks_2f43971f90a3d02d9(result) {
...
/// Successful return type for the `tasks_stopped` waiter.
pub type TasksStoppedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_tasks::DescribeTasksOutput,
...
/// Error type for the `tasks_stopped` waiter.
pub type WaitUntilTasksStoppedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_tasks::DescribeTasksOutput,
    crate::operation::describe_tasks::DescribeTasksError,
>;
