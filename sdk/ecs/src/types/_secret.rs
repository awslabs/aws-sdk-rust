...
impl  Secret  {
    ...
    pub fn value_from(&self) -> & str {
        use std::ops::Deref; self.value_from.deref()
    }
}
impl Secret {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::Secret, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::Secret {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building Secret")
                    )?
                ,
                value_from: self.value_from
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("value_from", "value_from was not specified but it is required when building Secret")
                    )?
                ,
            }
        )
