...
impl ::std::convert::From<&str> for CpuArchitecture {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => CpuArchitecture::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CpuArchitecture {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CpuArchitecture::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for CpuArchitecture {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
