...
impl TaskManagedEbsVolumeTerminationPolicyBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::TaskManagedEbsVolumeTerminationPolicy, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::TaskManagedEbsVolumeTerminationPolicy {
                delete_on_termination: self.delete_on_termination
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("delete_on_termination", "delete_on_termination was not specified but it is required when building TaskManagedEbsVolumeTerminationPolicy")
                    )?
                ,
            }
        )
