...
impl EbsTagSpecificationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::EbsTagSpecification, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::EbsTagSpecification {
                resource_type: self.resource_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_type", "resource_type was not specified but it is required when building EbsTagSpecification")
                    )?
                ,
                tags: self.tags
                ,
