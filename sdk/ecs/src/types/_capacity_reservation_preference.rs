...
///     CapacityReservationPreference::ReservationsExcluded => { /* ... */ },
///     CapacityReservationPreference::ReservationsFirst => { /* ... */ },
///     CapacityReservationPreference::ReservationsOnly => { /* ... */ },
...
impl ::std::convert::From<&str> for CapacityReservationPreference {
    fn from(s: &str) -> Self {
        match s {
            "RESERVATIONS_EXCLUDED" => CapacityReservationPreference::ReservationsExcluded,
            "RESERVATIONS_FIRST" => CapacityReservationPreference::ReservationsFirst,
            "RESERVATIONS_ONLY" => CapacityReservationPreference::ReservationsOnly,
...
impl CapacityReservationPreference {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CapacityReservationPreference::ReservationsExcluded => "RESERVATIONS_EXCLUDED",
            CapacityReservationPreference::ReservationsFirst => "RESERVATIONS_FIRST",
            CapacityReservationPreference::ReservationsOnly => "RESERVATIONS_ONLY",
...
impl ::std::fmt::Display for CapacityReservationPreference {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            CapacityReservationPreference::ReservationsExcluded => write!(f, "RESERVATIONS_EXCLUDED"),
            CapacityReservationPreference::ReservationsFirst => write!(f, "RESERVATIONS_FIRST"),
            CapacityReservationPreference::ReservationsOnly => write!(f, "RESERVATIONS_ONLY"),
