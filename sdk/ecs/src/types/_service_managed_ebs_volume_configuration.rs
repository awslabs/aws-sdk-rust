...
/// <p>The configuration for the Amazon EBS volume that Amazon ECS creates and manages on your behalf. These settings are used to create each Amazon EBS volume, with one volume created for each task in the service.</p>
...
impl ServiceManagedEbsVolumeConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ServiceManagedEbsVolumeConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ServiceManagedEbsVolumeConfiguration {
                ...
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building ServiceManagedEbsVolumeConfiguration")
                    )?
                ,
