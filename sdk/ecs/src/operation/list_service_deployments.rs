...
impl ListServiceDeployments {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_service_deployments::ListServiceDeploymentsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_service_deployments::ListServiceDeploymentsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "ListServiceDeployments", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.ListServiceDeployments",
                "rpc.service" = "ECS",
                "rpc.method" = "ListServiceDeployments",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListServiceDeployments {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListServiceDeployments");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListServiceDeploymentsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListServiceDeploymentsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListServiceDeployments")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListServiceDeployments")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListServiceDeploymentsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListServiceDeploymentsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListServiceDeploymentsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListServiceDeploymentsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListServiceDeploymentsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_service_deployments::de_list_service_deployments_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_service_deployments::de_list_service_deployments_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListServiceDeploymentsEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<ListServiceDeploymentsInput>()
            .ok_or("failed to downcast to ListServiceDeploymentsInput")?;
...
/// Error type for the `ListServiceDeploymentsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListServiceDeploymentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListServiceDeploymentsError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ListServiceDeploymentsError {
    /// Creates the `ListServiceDeploymentsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `ListServiceDeploymentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::ClusterNotFoundException`.
    pub fn is_cluster_not_found_exception(&self) -> bool {
        matches!(self, Self::ClusterNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::ServerException`.
    pub fn is_server_exception(&self) -> bool {
        matches!(self, Self::ServerException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::ServiceNotFoundException`.
    pub fn is_service_not_found_exception(&self) -> bool {
        matches!(self, Self::ServiceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListServiceDeploymentsError::UnsupportedFeatureException`.
    pub fn is_unsupported_feature_exception(&self) -> bool {
        matches!(self, Self::UnsupportedFeatureException(_))
    }
}
impl ::std::error::Error for ListServiceDeploymentsError {
...
impl ::std::fmt::Display for ListServiceDeploymentsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ListServiceDeploymentsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListServiceDeploymentsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListServiceDeploymentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_service_deployments::ListServiceDeploymentsError {
...
mod _list_service_deployments_output;
