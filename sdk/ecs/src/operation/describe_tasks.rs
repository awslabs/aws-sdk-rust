...
impl DescribeTasksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_tasks::DescribeTasks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_tasks::ser_describe_tasks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_tasks::de_describe_tasks_http_response_with_props(status, headers, body)
        }
    }
}
