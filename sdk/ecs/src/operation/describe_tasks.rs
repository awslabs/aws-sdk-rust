...
impl DescribeTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_tasks::DescribeTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_tasks::de_describe_tasks_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_tasks::de_describe_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
