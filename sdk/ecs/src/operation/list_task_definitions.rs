...
impl ListTaskDefinitionsInput {
    /// Consumes the builder and constructs an Operation<[`ListTaskDefinitions`](crate::operation::list_task_definitions::ListTaskDefinitions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_task_definitions::ListTaskDefinitions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_task_definitions::ListTaskDefinitionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_task_definitions::ser_list_task_definitions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_task_definitions::ListTaskDefinitions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListTaskDefinitions", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListTaskDefinitions {
                type Output = std::result::Result<crate::operation::list_task_definitions::ListTaskDefinitionsOutput, crate::operation::list_task_definitions::ListTaskDefinitionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_task_definitions::de_list_task_definitions_http_error(response)
                     } else {
