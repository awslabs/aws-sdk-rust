...
impl CreateTaskSetInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_task_set::CreateTaskSet::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateTaskSet {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_task_set::de_create_task_set_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_task_set::de_create_task_set_http_response(
                status, headers, body,
            )
        }
    }
