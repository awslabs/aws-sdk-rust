...
impl CreateTaskSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_task_set::CreateTaskSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_task_set::ser_create_task_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTaskSet {
    type Output =
        ::std::result::Result<crate::operation::create_task_set::CreateTaskSetOutput, crate::operation::create_task_set::CreateTaskSetError>;
