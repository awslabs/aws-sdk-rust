...
impl DeregisterTaskDefinitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deregister_task_definition::DeregisterTaskDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_task_definition::DeregisterTaskDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deregister_task_definition::DeregisterTaskDefinitionOutput, crate::operation::deregister_task_definition::DeregisterTaskDefinitionError, Self> {
