...
impl RegisterTaskDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`RegisterTaskDefinition`](crate::operation::register_task_definition::RegisterTaskDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_task_definition::RegisterTaskDefinition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_task_definition::RegisterTaskDefinitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_task_definition::ser_register_task_definition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_task_definition::RegisterTaskDefinition::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterTaskDefinition", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterTaskDefinition {
                type Output = std::result::Result<crate::operation::register_task_definition::RegisterTaskDefinitionOutput, crate::operation::register_task_definition::RegisterTaskDefinitionError>;
