...
impl RegisterTaskDefinition {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "RegisterTaskDefinition", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.RegisterTaskDefinition",
                "rpc.service" = "ECS",
                "rpc.method" = "RegisterTaskDefinition",
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterTaskDefinitionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_task_definition::de_register_task_definition_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_register_task_definition::de_register_task_definition_http_response(status, headers, body, _cfg)
        };
...
impl RegisterTaskDefinitionError {
    ...
    /// Returns `true` if the error kind is `RegisterTaskDefinitionError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `RegisterTaskDefinitionError::LimitExceededException`.
