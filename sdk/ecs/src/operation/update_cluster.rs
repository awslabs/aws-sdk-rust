...
impl UpdateClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_cluster::UpdateCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_cluster::ser_update_cluster_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_cluster::UpdateCluster::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCluster", "ecs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_cluster::de_update_cluster_http_response_with_props(status, headers, body)
        }
    }
}
