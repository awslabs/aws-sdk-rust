...
impl UpdateServicePrimaryTaskSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateServicePrimaryTaskSet`](crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_service_primary_task_set::ser_update_service_primary_task_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateServicePrimaryTaskSet", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateServicePrimaryTaskSet {
                type Output = std::result::Result<crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSetOutput, crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSetError>;
