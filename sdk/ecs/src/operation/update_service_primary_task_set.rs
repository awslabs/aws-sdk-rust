...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateServicePrimaryTaskSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_service_primary_task_set::de_update_service_primary_task_set_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateServicePrimaryTaskSetError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_service_primary_task_set::UpdateServicePrimaryTaskSetError
{
