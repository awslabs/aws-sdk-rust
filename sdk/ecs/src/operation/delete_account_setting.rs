...
impl DeleteAccountSettingInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_account_setting::ser_delete_account_setting_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_account_setting::DeleteAccountSetting::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_account_setting::DeleteAccountSettingError
{
