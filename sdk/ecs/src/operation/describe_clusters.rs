...
impl DescribeClusters {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "DescribeClusters", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeClusters {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DescribeClusters", "ECS"));
...
impl DescribeClustersError {
    ...
    /// Returns `true` if the error kind is `DescribeClustersError::AccessDeniedException`.
