...
impl ListTaskDefinitionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_task_definitions::ListTaskDefinitionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_task_definitions::ListTaskDefinitionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_task_definitions::ListTaskDefinitionsOutput, crate::operation::list_task_definitions::ListTaskDefinitionsError, Self> {
