...
impl PutAccountSettingDefault {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_account_setting_default::PutAccountSettingDefaultError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_account_setting_default::PutAccountSettingDefaultOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "PutAccountSettingDefault", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.PutAccountSettingDefault",
                "rpc.service" = "ECS",
                "rpc.method" = "PutAccountSettingDefault",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAccountSettingDefault {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutAccountSettingDefaultRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutAccountSettingDefaultResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutAccountSettingDefault")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutAccountSettingDefault")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutAccountSettingDefaultTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutAccountSettingDefaultTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutAccountSettingDefaultTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutAccountSettingDefaultInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutAccountSettingDefaultResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_account_setting_default::de_put_account_setting_default_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_account_setting_default::de_put_account_setting_default_http_response(status, headers, body, _cfg)
        };
...
impl PutAccountSettingDefaultError {
    ...
    /// Returns `true` if the error kind is `PutAccountSettingDefaultError::AccessDeniedException`.
