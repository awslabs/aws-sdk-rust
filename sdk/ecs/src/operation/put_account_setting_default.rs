...
impl PutAccountSettingDefaultInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_setting_default::PutAccountSettingDefault::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountSettingDefault {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_setting_default::de_put_account_setting_default_http_response_with_props(status, headers, body)
        }
    }
}
