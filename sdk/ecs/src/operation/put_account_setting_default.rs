...
impl PutAccountSettingDefaultInput {
    /// Consumes the builder and constructs an Operation<[`PutAccountSettingDefault`](crate::operation::put_account_setting_default::PutAccountSettingDefault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_account_setting_default::PutAccountSettingDefault, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_account_setting_default::PutAccountSettingDefaultInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_account_setting_default::ser_put_account_setting_default_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_setting_default::PutAccountSettingDefault::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutAccountSettingDefault {
                type Output = std::result::Result<crate::operation::put_account_setting_default::PutAccountSettingDefaultOutput, crate::operation::put_account_setting_default::PutAccountSettingDefaultError>;
