...
impl CreateService {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_service::CreateServiceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_service::CreateServiceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "CreateService", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.CreateService",
                "rpc.service" = "ECS",
                "rpc.method" = "CreateService",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateService {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateService", "ECS"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateServiceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_service::de_create_service_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_service::de_create_service_http_response(status, headers, body, _cfg)
        };
