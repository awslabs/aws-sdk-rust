...
impl ListTasks {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "ListTasks", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListTasks", "ECS"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTasksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("containerInstance") {
            if let ::std::option::Option::Some(value) = input.container_instance.as_deref() {
                captured.insert("containerInstance", value);
            }
        }
