...
impl SubmitContainerStateChangeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::submit_container_state_change::SubmitContainerStateChange::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubmitContainerStateChange {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_submit_container_state_change::de_submit_container_state_change_http_response_with_props(
                status, headers, body,
            )
        }
    }
