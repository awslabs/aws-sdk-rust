...
impl SubmitContainerStateChange {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::submit_container_state_change::SubmitContainerStateChangeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::submit_container_state_change::SubmitContainerStateChangeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "SubmitContainerStateChange", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.SubmitContainerStateChange",
                "rpc.service" = "ECS",
                "rpc.method" = "SubmitContainerStateChange",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SubmitContainerStateChange {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SubmitContainerStateChangeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SubmitContainerStateChangeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SubmitContainerStateChange")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SubmitContainerStateChange")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SubmitContainerStateChangeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SubmitContainerStateChangeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SubmitContainerStateChangeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SubmitContainerStateChangeInput>() else {
        ...
        if requested.should_capture("runtimeId") {
            if let ::std::option::Option::Some(value) = input.runtime_id.as_deref() {
                captured.insert("runtimeId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubmitContainerStateChangeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_submit_container_state_change::de_submit_container_state_change_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_submit_container_state_change::de_submit_container_state_change_http_response(status, headers, body, _cfg)
        };
...
impl SubmitContainerStateChangeError {
    ...
    /// Returns `true` if the error kind is `SubmitContainerStateChangeError::ClusterNotFoundException`.
    pub fn is_cluster_not_found_exception(&self) -> bool {
        matches!(self, Self::ClusterNotFoundException(_))
    }
    /// Returns `true` if the error kind is `SubmitContainerStateChangeError::InvalidParameterException`.
