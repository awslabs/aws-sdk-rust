...
impl DeregisterTaskDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterTaskDefinition`](crate::operation::deregister_task_definition::DeregisterTaskDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_task_definition::DeregisterTaskDefinition, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_task_definition::DeregisterTaskDefinitionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_task_definition::ser_deregister_task_definition_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_task_definition::DeregisterTaskDefinition::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterTaskDefinition {
                type Output = std::result::Result<crate::operation::deregister_task_definition::DeregisterTaskDefinitionOutput, crate::operation::deregister_task_definition::DeregisterTaskDefinitionError>;
