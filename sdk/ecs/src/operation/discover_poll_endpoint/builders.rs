...
impl DiscoverPollEndpointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::discover_poll_endpoint::DiscoverPollEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, crate::operation::discover_poll_endpoint::DiscoverPollEndpointError, Self> {
