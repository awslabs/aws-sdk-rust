...
impl PutAccountSettingDefaultFluentBuilder {
    ...
    /// <li>
    /// <p><code>fargateEventWindows</code> - When Amazon Web Services determines that a security or infrastructure update is needed for an Amazon ECS task hosted on Fargate, the tasks need to be stopped and new tasks launched to replace them. Use <code>fargateEventWindows</code> to use EC2 Event Windows associated with Fargate tasks to configure time windows for task retirement.</p></li>
    /// <li>
