...
impl DeleteAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_attributes::DeleteAttributes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_attributes::ser_delete_attributes_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_attributes::de_delete_attributes_http_response_with_props(status, headers, body)
        }
    }
}
