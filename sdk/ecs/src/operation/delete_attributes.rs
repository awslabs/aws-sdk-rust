...
impl DeleteAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAttributes`](crate::operation::delete_attributes::DeleteAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_attributes::DeleteAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_attributes::DeleteAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_attributes::ser_delete_attributes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_attributes::DeleteAttributes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAttributes {
                type Output = std::result::Result<crate::operation::delete_attributes::DeleteAttributesOutput, crate::operation::delete_attributes::DeleteAttributesError>;
