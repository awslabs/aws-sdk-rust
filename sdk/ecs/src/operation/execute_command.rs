...
impl ExecuteCommandInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::execute_command::ExecuteCommand, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_command::ser_execute_command_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteCommand {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_execute_command::de_execute_command_http_response_with_props(status, headers, body)
        }
    }
