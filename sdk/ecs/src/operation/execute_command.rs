...
impl ExecuteCommandInput {
    /// Consumes the builder and constructs an Operation<[`ExecuteCommand`](crate::operation::execute_command::ExecuteCommand)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::execute_command::ExecuteCommand, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_command::ExecuteCommandInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_execute_command::ser_execute_command_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::execute_command::ExecuteCommand::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ExecuteCommand {
                type Output = std::result::Result<crate::operation::execute_command::ExecuteCommandOutput, crate::operation::execute_command::ExecuteCommandError>;
