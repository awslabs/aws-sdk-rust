...
impl PutClusterCapacityProviders {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "PutClusterCapacityProviders", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.PutClusterCapacityProviders",
                "rpc.service" = "ECS",
                "rpc.method" = "PutClusterCapacityProviders",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutClusterCapacityProviders {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutClusterCapacityProvidersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutClusterCapacityProvidersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutClusterCapacityProviders")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutClusterCapacityProviders")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutClusterCapacityProvidersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutClusterCapacityProvidersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutClusterCapacityProvidersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutClusterCapacityProvidersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutClusterCapacityProvidersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_cluster_capacity_providers::de_put_cluster_capacity_providers_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_cluster_capacity_providers::de_put_cluster_capacity_providers_http_response(status, headers, body, _cfg)
        };
...
impl PutClusterCapacityProvidersError {
    ...
    /// Returns `true` if the error kind is `PutClusterCapacityProvidersError::AccessDeniedException`.
