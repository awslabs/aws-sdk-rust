...
impl PutClusterCapacityProvidersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_cluster_capacity_providers::PutClusterCapacityProviders::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PutClusterCapacityProvidersError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError
{
