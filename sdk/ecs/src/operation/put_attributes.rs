...
impl PutAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_attributes::PutAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_attributes::de_put_attributes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_attributes::de_put_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
