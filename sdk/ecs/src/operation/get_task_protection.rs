...
impl GetTaskProtectionInput {
    /// Consumes the builder and constructs an Operation<[`GetTaskProtection`](crate::operation::get_task_protection::GetTaskProtection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_task_protection::GetTaskProtection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_task_protection::GetTaskProtectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_task_protection::ser_get_task_protection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_task_protection::GetTaskProtection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetTaskProtection", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetTaskProtection {
                type Output = std::result::Result<crate::operation::get_task_protection::GetTaskProtectionOutput, crate::operation::get_task_protection::GetTaskProtectionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_task_protection::de_get_task_protection_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_task_protection::de_get_task_protection_http_response(response)
                     }
                }
            }
