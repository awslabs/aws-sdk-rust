...
impl GetTaskProtectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_task_protection::GetTaskProtection,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_task_protection::ser_get_task_protection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTaskProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_task_protection::de_get_task_protection_http_response_with_props(status, headers, body)
        }
    }
}
