...
impl StartTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_task::StartTask,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_task::StartTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_task::de_start_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
