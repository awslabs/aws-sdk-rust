...
impl RunTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::run_task::RunTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_run_task::ser_run_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RunTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_run_task::de_run_task_http_response_with_props(status, headers, body)
        }
    }
}
