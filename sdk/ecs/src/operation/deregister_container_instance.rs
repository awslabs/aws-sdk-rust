...
impl DeregisterContainerInstanceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_container_instance::DeregisterContainerInstance::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterContainerInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_container_instance::de_deregister_container_instance_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeregisterContainerInstanceError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_container_instance::DeregisterContainerInstanceError
{
