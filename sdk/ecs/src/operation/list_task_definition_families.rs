...
impl ListTaskDefinitionFamiliesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_task_definition_families::ListTaskDefinitionFamilies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTaskDefinitionFamilies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_task_definition_families::de_list_task_definition_families_http_response_with_props(
                status, headers, body,
            )
        }
    }
