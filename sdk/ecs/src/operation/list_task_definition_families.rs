...
impl ListTaskDefinitionFamilies {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "ListTaskDefinitionFamilies", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.ListTaskDefinitionFamilies",
                "rpc.service" = "ECS",
                "rpc.method" = "ListTaskDefinitionFamilies",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTaskDefinitionFamilies {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListTaskDefinitionFamiliesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListTaskDefinitionFamiliesResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListTaskDefinitionFamilies")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListTaskDefinitionFamiliesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListTaskDefinitionFamiliesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListTaskDefinitionFamiliesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListTaskDefinitionFamiliesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListTaskDefinitionFamiliesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_task_definition_families::de_list_task_definition_families_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_task_definition_families::de_list_task_definition_families_http_response(status, headers, body, _cfg)
        };
...
impl ListTaskDefinitionFamiliesError {
    ...
    /// Returns `true` if the error kind is `ListTaskDefinitionFamiliesError::AccessDeniedException`.
