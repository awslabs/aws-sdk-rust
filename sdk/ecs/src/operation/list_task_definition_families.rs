...
impl ListTaskDefinitionFamiliesInput {
    /// Consumes the builder and constructs an Operation<[`ListTaskDefinitionFamilies`](crate::operation::list_task_definition_families::ListTaskDefinitionFamilies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_task_definition_families::ListTaskDefinitionFamilies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_task_definition_families::ser_list_task_definition_families_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_task_definition_families::ListTaskDefinitionFamilies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListTaskDefinitionFamilies {
                type Output = std::result::Result<crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesOutput, crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesError>;
