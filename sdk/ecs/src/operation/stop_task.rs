...
impl StopTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_task::StopTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_task::ser_stop_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_task::de_stop_task_http_response_with_props(status, headers, body)
        }
    }
}
