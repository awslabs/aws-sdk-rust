...
impl SubmitTaskStateChangeInput {
    /// Consumes the builder and constructs an Operation<[`SubmitTaskStateChange`](crate::operation::submit_task_state_change::SubmitTaskStateChange)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::submit_task_state_change::SubmitTaskStateChange, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::submit_task_state_change::SubmitTaskStateChangeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_submit_task_state_change::ser_submit_task_state_change_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::submit_task_state_change::SubmitTaskStateChange::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SubmitTaskStateChange", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for SubmitTaskStateChange {
                type Output = std::result::Result<crate::operation::submit_task_state_change::SubmitTaskStateChangeOutput, crate::operation::submit_task_state_change::SubmitTaskStateChangeError>;
