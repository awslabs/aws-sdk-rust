...
impl ListAccountSettingsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_account_settings::ser_list_account_settings_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_account_settings::ListAccountSettings::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_account_settings::ListAccountSettingsError
{
