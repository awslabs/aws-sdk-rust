...
impl PutAccountSettingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_account_setting::ser_put_account_setting_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountSetting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_setting::de_put_account_setting_http_response_with_props(status, headers, body)
        }
    }
}
