...
impl PutAccountSettingInput {
    /// Consumes the builder and constructs an Operation<[`PutAccountSetting`](crate::operation::put_account_setting::PutAccountSetting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_account_setting::PutAccountSetting, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_account_setting::PutAccountSettingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_account_setting::ser_put_account_setting_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_setting::PutAccountSetting::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutAccountSetting", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutAccountSetting {
                type Output = std::result::Result<crate::operation::put_account_setting::PutAccountSettingOutput, crate::operation::put_account_setting::PutAccountSettingError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_account_setting::de_put_account_setting_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_account_setting::de_put_account_setting_http_response(response)
                     }
                }
            }
