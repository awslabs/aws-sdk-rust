...
impl ListServicesByNamespaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_services_by_namespace::ListServicesByNamespaceInput, ::aws_smithy_types::error::operation::BuildError> {
