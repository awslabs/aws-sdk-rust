...
impl PutAccountSettingFluentBuilder {
    ...
    /// <li>
    /// <p><code>fargateFIPSMode</code> - When turned on, you can run Fargate workloads in a manner that is compliant with Federal Information Processing Standard (FIPS-140). For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-fips-compliance.html">Fargate Federal Information Processing Standard (FIPS-140)</a>.</p></li>
    /// <li>
