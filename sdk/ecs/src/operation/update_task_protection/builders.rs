...
impl UpdateTaskProtectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_task_protection::UpdateTaskProtectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_task_protection::UpdateTaskProtectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_task_protection::UpdateTaskProtectionOutput, crate::operation::update_task_protection::UpdateTaskProtectionError, Self> {
