...
impl ListAttributesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_attributes::ListAttributes::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttributes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_attributes::de_list_attributes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_attributes::de_list_attributes_http_response(
                status, headers, body,
            )
        }
    }
