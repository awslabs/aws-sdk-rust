...
impl UpdateCapacityProvider {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "UpdateCapacityProvider", input, runtime_plugins, stop_point)
...
impl UpdateCapacityProviderError {
    ...
    /// Returns `true` if the error kind is `UpdateCapacityProviderError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `UpdateCapacityProviderError::ClusterNotFoundException`.
    ...
    /// Returns `true` if the error kind is `UpdateCapacityProviderError::UnsupportedFeatureException`.
