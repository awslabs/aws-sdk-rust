...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContainerInstancesState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_container_instances_state::de_update_container_instances_state_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_container_instances_state::UpdateContainerInstancesStateError
{
