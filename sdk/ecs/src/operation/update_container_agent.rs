...
impl UpdateContainerAgentInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_container_agent::ser_update_container_agent_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_container_agent::UpdateContainerAgent::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_container_agent::UpdateContainerAgentError
{
