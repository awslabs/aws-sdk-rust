...
impl DescribeServiceDeployments {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_service_deployments::DescribeServiceDeploymentsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_service_deployments::DescribeServiceDeploymentsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "DescribeServiceDeployments", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.DescribeServiceDeployments",
                "rpc.service" = "ECS",
                "rpc.method" = "DescribeServiceDeployments",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeServiceDeployments {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeServiceDeployments");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeServiceDeploymentsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeServiceDeploymentsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeServiceDeployments")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeServiceDeployments")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeServiceDeploymentsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_service_deployments::de_describe_service_deployments_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_service_deployments::de_describe_service_deployments_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeServiceDeploymentsEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<DescribeServiceDeploymentsInput>()
            .ok_or("failed to downcast to DescribeServiceDeploymentsInput")?;
...
/// Error type for the `DescribeServiceDeploymentsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeServiceDeploymentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeServiceDeploymentsError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl DescribeServiceDeploymentsError {
    /// Creates the `DescribeServiceDeploymentsError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `DescribeServiceDeploymentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::ClientException`.
    pub fn is_client_exception(&self) -> bool {
        matches!(self, Self::ClientException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::ClusterNotFoundException`.
    pub fn is_cluster_not_found_exception(&self) -> bool {
        matches!(self, Self::ClusterNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::ServerException`.
    pub fn is_server_exception(&self) -> bool {
        matches!(self, Self::ServerException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::ServiceNotFoundException`.
    pub fn is_service_not_found_exception(&self) -> bool {
        matches!(self, Self::ServiceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeServiceDeploymentsError::UnsupportedFeatureException`.
    pub fn is_unsupported_feature_exception(&self) -> bool {
        matches!(self, Self::UnsupportedFeatureException(_))
    }
}
impl ::std::error::Error for DescribeServiceDeploymentsError {
...
impl ::std::fmt::Display for DescribeServiceDeploymentsError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for DescribeServiceDeploymentsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeServiceDeploymentsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeServiceDeploymentsError {
