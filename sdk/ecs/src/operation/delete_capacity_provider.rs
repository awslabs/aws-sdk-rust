...
impl DeleteCapacityProviderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCapacityProvider`](crate::operation::delete_capacity_provider::DeleteCapacityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_capacity_provider::DeleteCapacityProvider, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_capacity_provider::DeleteCapacityProviderInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_capacity_provider::ser_delete_capacity_provider_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_capacity_provider::DeleteCapacityProvider::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteCapacityProvider", "ecs"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteCapacityProvider {
                type Output = std::result::Result<crate::operation::delete_capacity_provider::DeleteCapacityProviderOutput, crate::operation::delete_capacity_provider::DeleteCapacityProviderError>;
