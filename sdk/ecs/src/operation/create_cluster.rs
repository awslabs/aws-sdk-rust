...
impl CreateClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_cluster::CreateCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_cluster::ser_create_cluster_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster::CreateCluster::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateCluster", "ecs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cluster::de_create_cluster_http_response_with_props(status, headers, body)
        }
    }
}
