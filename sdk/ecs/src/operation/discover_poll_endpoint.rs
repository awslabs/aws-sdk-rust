...
impl DiscoverPollEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DiscoverPollEndpoint`](crate::operation::discover_poll_endpoint::DiscoverPollEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::discover_poll_endpoint::DiscoverPollEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::discover_poll_endpoint::DiscoverPollEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_discover_poll_endpoint::ser_discover_poll_endpoint_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::discover_poll_endpoint::DiscoverPollEndpoint::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DiscoverPollEndpoint {
                type Output = std::result::Result<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, crate::operation::discover_poll_endpoint::DiscoverPollEndpointError>;
