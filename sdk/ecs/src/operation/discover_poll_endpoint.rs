...
impl DiscoverPollEndpointInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_discover_poll_endpoint::ser_discover_poll_endpoint_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::discover_poll_endpoint::DiscoverPollEndpoint::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::discover_poll_endpoint::DiscoverPollEndpointError
{
