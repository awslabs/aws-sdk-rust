...
impl SubmitAttachmentStateChanges {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "SubmitAttachmentStateChanges", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.SubmitAttachmentStateChanges",
                "rpc.service" = "ECS",
                "rpc.method" = "SubmitAttachmentStateChanges",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SubmitAttachmentStateChanges {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SubmitAttachmentStateChangesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SubmitAttachmentStateChangesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SubmitAttachmentStateChanges")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SubmitAttachmentStateChanges")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SubmitAttachmentStateChangesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SubmitAttachmentStateChangesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SubmitAttachmentStateChangesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SubmitAttachmentStateChangesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubmitAttachmentStateChangesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_submit_attachment_state_changes::de_submit_attachment_state_changes_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_submit_attachment_state_changes::de_submit_attachment_state_changes_http_response(
