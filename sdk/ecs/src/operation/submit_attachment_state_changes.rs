...
impl SubmitAttachmentStateChangesInput {
    /// Consumes the builder and constructs an Operation<[`SubmitAttachmentStateChanges`](crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChanges)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChanges, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_submit_attachment_state_changes::ser_submit_attachment_state_changes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChanges::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SubmitAttachmentStateChanges {
                type Output = std::result::Result<crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesOutput, crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesError>;
