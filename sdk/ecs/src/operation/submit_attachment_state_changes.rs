...
impl SubmitAttachmentStateChangesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChanges::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubmitAttachmentStateChanges {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_submit_attachment_state_changes::de_submit_attachment_state_changes_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for SubmitAttachmentStateChangesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::submit_attachment_state_changes::SubmitAttachmentStateChangesError
{
