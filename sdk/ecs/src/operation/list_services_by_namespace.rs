...
impl ListServicesByNamespace {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_services_by_namespace::ListServicesByNamespaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_services_by_namespace::ListServicesByNamespaceOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "ListServicesByNamespace", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "ECS.ListServicesByNamespace",
                "rpc.service" = "ECS",
                "rpc.method" = "ListServicesByNamespace",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListServicesByNamespace {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListServicesByNamespaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListServicesByNamespaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListServicesByNamespace")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListServicesByNamespace")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListServicesByNamespaceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListServicesByNamespaceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListServicesByNamespaceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListServicesByNamespaceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListServicesByNamespaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_services_by_namespace::de_list_services_by_namespace_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_services_by_namespace::de_list_services_by_namespace_http_response(status, headers, body, _cfg)
        };
...
impl ListServicesByNamespaceError {
    ...
    /// Returns `true` if the error kind is `ListServicesByNamespaceError::AccessDeniedException`.
