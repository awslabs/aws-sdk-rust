...
impl DeleteTaskDefinitionsFluentBuilder  {
    /// Creates a new `DeleteTaskDefinitions`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_task_definitions::DeleteTaskDefinitionsOutput, aws_smithy_http::result::SdkError<crate::operation::delete_task_definitions::DeleteTaskDefinitionsError>>
                     {
