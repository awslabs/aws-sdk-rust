...
impl CreateCapacityProvider {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ECS", "CreateCapacityProvider", input, runtime_plugins, stop_point)
...
impl CreateCapacityProviderError {
    ...
    /// Returns `true` if the error kind is `CreateCapacityProviderError::ClusterNotFoundException`.
    ...
    /// Returns `true` if the error kind is `CreateCapacityProviderError::UnsupportedFeatureException`.
