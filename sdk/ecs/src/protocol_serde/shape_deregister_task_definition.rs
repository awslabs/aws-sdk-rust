...
pub fn de_deregister_task_definition_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deregister_task_definition::DeregisterTaskDefinitionOutput, crate::operation::deregister_task_definition::DeregisterTaskDefinitionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::deregister_task_definition::DeregisterTaskDefinitionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_task_definition_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::deregister_task_definition::DeregisterTaskDefinitionOutput, crate::operation::deregister_task_definition::DeregisterTaskDefinitionError> {
    Ok({
        #[allow(unused_mut)]
