...
> {
    ...
    Err(match error_code {
        "ClientException" => {
            crate::error::DeregisterTaskDefinitionError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::error::DeregisterTaskDefinitionError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_deregister_task_definition::de_deregister_task_definition(
