...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::discover_poll_endpoint::DiscoverPollEndpointError::unhandled(
                    generic,
                ),
            )
        }
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::discover_poll_endpoint::DiscoverPollEndpointError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServerException" => {
            crate::operation::discover_poll_endpoint::DiscoverPollEndpointError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_discover_poll_endpoint_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
