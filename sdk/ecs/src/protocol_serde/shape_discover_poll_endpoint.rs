...
pub fn de_discover_poll_endpoint_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, crate::operation::discover_poll_endpoint::DiscoverPollEndpointError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_discover_poll_endpoint_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, crate::operation::discover_poll_endpoint::DiscoverPollEndpointError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_discover_poll_endpoint_input(input: &crate::operation::discover_poll_endpoint::DiscoverPollEndpointInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_discover_poll_endpoint(value: &[u8], mut builder: crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointOutputBuilder) -> Result<crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
