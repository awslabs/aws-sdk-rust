...
pub fn ser_discover_poll_endpoint_input(
    ...
    crate::protocol_serde::shape_discover_poll_endpoint_input::ser_discover_poll_endpoint_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        "ClientException" => {
            crate::error::DiscoverPollEndpointError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerException" => {
            crate::error::DiscoverPollEndpointError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_discover_poll_endpoint::de_discover_poll_endpoint(
