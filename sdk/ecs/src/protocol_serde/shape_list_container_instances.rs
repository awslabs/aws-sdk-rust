...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_container_instances::ListContainerInstancesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "containerInstanceArns" => {
                    builder =
                        builder.set_container_instance_arns(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
