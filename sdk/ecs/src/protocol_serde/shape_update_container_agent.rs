...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::update_container_agent::UpdateContainerAgentError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_container_agent::de_update_container_agent(_response_body, output)
            .map_err(crate::operation::update_container_agent::UpdateContainerAgentError::unhandled)?;
