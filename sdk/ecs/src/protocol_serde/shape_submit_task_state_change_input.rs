...
pub fn ser_submit_task_state_change_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SubmitTaskStateChangeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
