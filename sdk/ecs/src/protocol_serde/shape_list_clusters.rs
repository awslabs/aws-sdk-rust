...
pub fn ser_list_clusters_input(input: &crate::operation::list_clusters::ListClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
