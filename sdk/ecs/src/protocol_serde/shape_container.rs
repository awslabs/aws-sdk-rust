            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "networkBindings" => {
                            builder = builder.set_network_bindings(crate::protocol_serde::shape_network_bindings::de_network_bindings(tokens)?);
                        }
                        "networkInterfaces" => {
                        ...
                        "managedAgents" => {
                            builder = builder.set_managed_agents(crate::protocol_serde::shape_managed_agents::de_managed_agents(tokens)?);
                        }
                        "cpu" => {
                        ...
                        "gpuIds" => {
                            builder = builder.set_gpu_ids(crate::protocol_serde::shape_gpu_ids::de_gpu_ids(tokens)?);
                        }
