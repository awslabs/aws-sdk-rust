...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::delete_account_setting::DeleteAccountSettingError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_account_setting::de_delete_account_setting(_response_body, output)
            .map_err(crate::operation::delete_account_setting::DeleteAccountSettingError::unhandled)?;
