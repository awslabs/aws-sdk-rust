...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::update_container_instances_state::UpdateContainerInstancesStateError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_container_instances_state::de_update_container_instances_state(_response_body, output)
            .map_err(crate::operation::update_container_instances_state::UpdateContainerInstancesStateError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "containerInstances" => {
                    builder = builder.set_container_instances(crate::protocol_serde::shape_container_instances::de_container_instances(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
