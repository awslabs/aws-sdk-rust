...
pub fn ser_register_task_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterTaskDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
