...
pub fn ser_stop_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
