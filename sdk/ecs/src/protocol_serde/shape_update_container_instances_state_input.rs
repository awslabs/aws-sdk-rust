...
pub fn ser_update_container_instances_state_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateContainerInstancesStateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
