...
pub fn ser_list_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
