...
pub fn ser_submit_attachment_state_changes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SubmitAttachmentStateChangesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
