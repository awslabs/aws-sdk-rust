...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_describe_tasks_input::ser_describe_tasks_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_tasks::DescribeTasksError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "ClientException" => {
            crate::operation::describe_tasks::DescribeTasksError::ClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServerException" => {
            crate::operation::describe_tasks::DescribeTasksError::ServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_tasks_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_tasks::de_describe_tasks(_response_body, output)
                .map_err(crate::operation::describe_tasks::DescribeTasksError::unhandled)?;
