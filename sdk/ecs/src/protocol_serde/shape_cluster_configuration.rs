                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "executeCommandConfiguration" => {
                            builder = builder.set_execute_command_configuration(
                                crate::protocol_serde::shape_execute_command_configuration::de_execute_command_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "managedStorageConfiguration" => {
                            builder = builder.set_managed_storage_configuration(
                                crate::protocol_serde::shape_managed_storage_configuration::de_managed_storage_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
