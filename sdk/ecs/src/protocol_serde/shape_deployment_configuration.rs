...
pub fn ser_deployment_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DeploymentConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_deployment_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeploymentConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
