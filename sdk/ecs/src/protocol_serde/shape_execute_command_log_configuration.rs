...
pub fn ser_execute_command_log_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExecuteCommandLogConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_execute_command_log_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ExecuteCommandLogConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
