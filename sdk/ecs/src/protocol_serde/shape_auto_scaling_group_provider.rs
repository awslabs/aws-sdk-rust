...
pub fn ser_auto_scaling_group_provider(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AutoScalingGroupProvider) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
