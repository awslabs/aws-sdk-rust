...
pub fn de_start_task_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::start_task::StartTaskOutput, crate::operation::start_task::StartTaskError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::start_task::StartTaskError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_task_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::start_task::StartTaskOutput, crate::operation::start_task::StartTaskError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::start_task::builders::StartTaskOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_start_task::de_start_task(response.body().as_ref(), output).map_err(crate::operation::start_task::StartTaskError::unhandled)?;
