...
pub fn de_start_task_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::start_task::StartTaskError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "NamespaceNotFoundException" => crate::operation::start_task::StartTaskError::NamespaceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
