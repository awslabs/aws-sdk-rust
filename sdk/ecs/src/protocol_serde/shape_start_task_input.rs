...
pub fn ser_start_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
