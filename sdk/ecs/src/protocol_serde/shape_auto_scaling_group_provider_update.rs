...
pub fn ser_auto_scaling_group_provider_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoScalingGroupProviderUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
