...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_task_definition_families::de_list_task_definition_families(_response_body, output)
            .map_err(crate::operation::list_task_definition_families::ListTaskDefinitionFamiliesError::unhandled)?;
...
pub(crate) fn de_list_task_definition_families(
    _value: &[u8],
    mut builder: crate::operation::list_task_definition_families::builders::ListTaskDefinitionFamiliesOutputBuilder,
) -> ::std::result::Result<
    crate::operation::list_task_definition_families::builders::ListTaskDefinitionFamiliesOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "families" => {
                    builder = builder.set_families(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
