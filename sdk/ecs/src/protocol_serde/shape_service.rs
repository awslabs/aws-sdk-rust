                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "loadBalancers" => {
                                builder = builder.set_load_balancers(
                                    crate::protocol_serde::shape_load_balancers::de_load_balancers(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "deployments" => {
                                builder = builder.set_deployments(
                                    crate::protocol_serde::shape_deployments::de_deployments(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "events" => {
                                builder = builder.set_events(
                                    crate::protocol_serde::shape_service_events::de_service_events(
                                        tokens,
                                    )?,
                                );
                            }
