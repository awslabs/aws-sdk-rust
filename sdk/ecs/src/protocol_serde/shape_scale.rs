...
) -> ::std::result::Result<Option<crate::types::Scale>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "unit" => {
                            builder = builder.set_unit(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ScaleUnit::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
