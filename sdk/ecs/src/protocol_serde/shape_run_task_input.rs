...
pub fn ser_run_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RunTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
