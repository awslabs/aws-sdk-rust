...
pub(crate) fn de_port_mapping_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::PortMapping>>, aws_smithy_json::deserialize::error::DeserializeError>
