...
pub fn ser_tmpfs(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Tmpfs) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_tmpfs<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Tmpfs>, aws_smithy_json::deserialize::error::DeserializeError>
