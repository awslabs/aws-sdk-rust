...
pub fn ser_describe_tasks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_tasks::DescribeTasksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
