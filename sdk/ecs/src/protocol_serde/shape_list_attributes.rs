...
) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError>
{
    ...
    crate::protocol_serde::shape_list_attributes_input::ser_list_attributes_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_attributes::ListAttributesError::unhandled(generic))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_attributes_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_attributes::de_list_attributes(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_attributes::ListAttributesError::unhandled)?;
