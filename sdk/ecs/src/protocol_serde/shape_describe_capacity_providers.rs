...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(
        crate::operation::describe_capacity_providers::DescribeCapacityProvidersError::unhandled,
    )?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "capacityProviders" => {
                        builder = builder.set_capacity_providers(
                            crate::protocol_serde::shape_capacity_providers::de_capacity_providers(
                                tokens,
                            )?,
                        );
                    }
