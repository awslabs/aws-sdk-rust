...
pub fn ser_delete_task_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteTaskSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
