...
pub fn de_run_task_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::run_task::RunTaskOutput, crate::operation::run_task::RunTaskError> {
    #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::run_task::builders::RunTaskOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
