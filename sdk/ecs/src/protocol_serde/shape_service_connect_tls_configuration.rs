...
pub(crate) fn de_service_connect_tls_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ServiceConnectTlsConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
