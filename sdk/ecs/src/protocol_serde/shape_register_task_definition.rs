...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::register_task_definition::RegisterTaskDefinitionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::register_task_definition::RegisterTaskDefinitionError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => crate::operation::register_task_definition::RegisterTaskDefinitionError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_register_task_definition::de_register_task_definition(_response_body, output)
            .map_err(crate::operation::register_task_definition::RegisterTaskDefinitionError::unhandled)?;
