...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_task_definitions::de_delete_task_definitions(_response_body, output)
            .map_err(crate::operation::delete_task_definitions::DeleteTaskDefinitionsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "taskDefinitions" => {
                    builder = builder.set_task_definitions(crate::protocol_serde::shape_task_definition_list::de_task_definition_list(tokens)?);
                }
                "failures" => {
