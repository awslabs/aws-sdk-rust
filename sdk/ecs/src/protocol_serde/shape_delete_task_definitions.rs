...
pub fn de_delete_task_definitions_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_task_definitions::DeleteTaskDefinitionsOutput, crate::operation::delete_task_definitions::DeleteTaskDefinitionsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_task_definitions::DeleteTaskDefinitionsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_task_definitions_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_task_definitions::DeleteTaskDefinitionsOutput, crate::operation::delete_task_definitions::DeleteTaskDefinitionsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_task_definitions::builders::DeleteTaskDefinitionsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_task_definitions::de_delete_task_definitions(response.body().as_ref(), output).map_err(crate::operation::delete_task_definitions::DeleteTaskDefinitionsError::unhandled)?;
