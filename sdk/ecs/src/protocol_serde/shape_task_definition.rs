                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "containerDefinitions" => {
                            builder = builder
                                .set_container_definitions(crate::protocol_serde::shape_container_definitions::de_container_definitions(tokens)?);
                        }
                        "family" => {
                        ...
                        "volumes" => {
                            builder = builder.set_volumes(crate::protocol_serde::shape_volume_list::de_volume_list(tokens)?);
                        }
                        "status" => {
                        ...
                        "requiresAttributes" => {
                            builder =
                                builder.set_requires_attributes(crate::protocol_serde::shape_requires_attributes::de_requires_attributes(tokens)?);
                        }
                        ...
                        "compatibilities" => {
                            builder = builder.set_compatibilities(crate::protocol_serde::shape_compatibility_list::de_compatibility_list(tokens)?);
                        }
                        "runtimePlatform" => {
                        ...
                        "requiresCompatibilities" => {
                            builder =
                                builder.set_requires_compatibilities(crate::protocol_serde::shape_compatibility_list::de_compatibility_list(tokens)?);
                        }
                        "cpu" => {
