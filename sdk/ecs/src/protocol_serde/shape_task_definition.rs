...
pub(crate) fn de_task_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TaskDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
