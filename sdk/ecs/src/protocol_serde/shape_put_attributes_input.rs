...
pub fn ser_put_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
