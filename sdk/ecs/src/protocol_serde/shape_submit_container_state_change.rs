...
> {
    ...
    Err(match error_code {
        ...
        "ClusterNotFoundException" => crate::operation::submit_container_state_change::SubmitContainerStateChangeError::ClusterNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterException" => crate::operation::submit_container_state_change::SubmitContainerStateChangeError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
