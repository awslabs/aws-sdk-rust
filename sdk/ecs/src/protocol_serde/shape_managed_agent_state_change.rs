...
pub fn ser_managed_agent_state_change(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ManagedAgentStateChange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
