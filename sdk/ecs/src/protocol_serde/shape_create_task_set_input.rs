...
pub fn ser_create_task_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTaskSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
