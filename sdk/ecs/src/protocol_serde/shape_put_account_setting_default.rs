...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_account_setting_default::PutAccountSettingDefaultError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::put_account_setting_default::PutAccountSettingDefaultError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_account_setting_default::de_put_account_setting_default(_response_body, output)
            .map_err(crate::operation::put_account_setting_default::PutAccountSettingDefaultError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "setting" => {
                    builder = builder.set_setting(crate::protocol_serde::shape_setting::de_setting(tokens, _value, depth + 1)?);
                }
