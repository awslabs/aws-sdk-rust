...
) -> Result<crate::operation::list_services::builders::ListServicesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "serviceArns" => {
                    builder = builder.set_service_arns(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                }
                "nextToken" => {
