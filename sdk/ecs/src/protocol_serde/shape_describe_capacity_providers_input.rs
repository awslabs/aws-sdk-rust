...
pub fn ser_describe_capacity_providers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeCapacityProvidersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
