...
pub fn ser_list_tasks_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTasksInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
