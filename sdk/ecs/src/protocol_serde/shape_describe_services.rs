...
pub fn de_describe_services_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::describe_services::DescribeServicesError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "services" => {
                    builder = builder.set_services(crate::protocol_serde::shape_services::de_services(tokens, _value, depth + 1)?);
                }
                "failures" => {
