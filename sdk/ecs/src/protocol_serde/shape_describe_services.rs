...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_services_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_services::DescribeServicesOutput, crate::operation::describe_services::DescribeServicesError> {
...
) -> Result<crate::operation::describe_services::builders::DescribeServicesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "services" => {
                    builder = builder.set_services(crate::protocol_serde::shape_services::de_services(tokens)?);
                }
                "failures" => {
