...
pub(crate) fn de_capacity_provider<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CapacityProvider>, aws_smithy_json::deserialize::error::DeserializeError>
