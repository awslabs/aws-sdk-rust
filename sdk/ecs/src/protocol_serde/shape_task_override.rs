            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "containerOverrides" => {
                            builder = builder.set_container_overrides(crate::protocol_serde::shape_container_overrides::de_container_overrides(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "inferenceAcceleratorOverrides" => {
                            builder = builder.set_inference_accelerator_overrides(
                                crate::protocol_serde::shape_inference_accelerator_overrides::de_inference_accelerator_overrides(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
