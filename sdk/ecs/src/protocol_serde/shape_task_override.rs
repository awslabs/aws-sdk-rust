...
pub fn ser_task_override(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TaskOverride) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_task_override<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TaskOverride>, aws_smithy_json::deserialize::error::DeserializeError>
