...
pub fn de_delete_task_set_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_task_set::DeleteTaskSetOutput, crate::operation::delete_task_set::DeleteTaskSetError> {
    #[allow(unused_mut)]
...
pub fn de_delete_task_set_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_task_set::de_delete_task_set(_response_body, output)
            .map_err(crate::operation::delete_task_set::DeleteTaskSetError::unhandled)?;
...
) -> Result<crate::operation::delete_task_set::builders::DeleteTaskSetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "taskSet" => {
                    builder = builder.set_task_set(crate::protocol_serde::shape_task_set::de_task_set(tokens)?);
                }
