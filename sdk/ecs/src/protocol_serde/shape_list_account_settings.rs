...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_account_settings::ListAccountSettingsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_account_settings::de_list_account_settings(_response_body, output)
            .map_err(crate::operation::list_account_settings::ListAccountSettingsError::unhandled)?;
