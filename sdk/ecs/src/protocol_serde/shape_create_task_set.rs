...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_task_set_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_task_set::CreateTaskSetOutput, crate::operation::create_task_set::CreateTaskSetError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_task_set::de_create_task_set(_response_body, output)
            .map_err(crate::operation::create_task_set::CreateTaskSetError::unhandled)?;
...
) -> Result<crate::operation::create_task_set::builders::CreateTaskSetOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
