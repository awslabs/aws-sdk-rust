...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_task_protection::de_update_task_protection(_response_body, output)
            .map_err(crate::operation::update_task_protection::UpdateTaskProtectionError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "protectedTasks" => {
                    builder = builder.set_protected_tasks(crate::protocol_serde::shape_protected_tasks::de_protected_tasks(tokens)?);
                }
                "failures" => {
