...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::list_task_definitions::ListTaskDefinitionsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_task_definitions::de_list_task_definitions(_response_body, output)
            .map_err(crate::operation::list_task_definitions::ListTaskDefinitionsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "taskDefinitionArns" => {
                    builder = builder.set_task_definition_arns(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
