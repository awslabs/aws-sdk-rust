...
pub fn ser_describe_task_sets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeTaskSetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
