...
pub fn ser_list_account_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_account_settings::ListAccountSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
