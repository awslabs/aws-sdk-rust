...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::register_container_instance::RegisterContainerInstanceError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_register_container_instance::de_register_container_instance(_response_body, output)
            .map_err(crate::operation::register_container_instance::RegisterContainerInstanceError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "containerInstance" => {
                    builder = builder.set_container_instance(crate::protocol_serde::shape_container_instance::de_container_instance(tokens)?);
                }
