            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "configuration" => {
                            builder =
                                builder.set_configuration(crate::protocol_serde::shape_cluster_configuration::de_cluster_configuration(tokens)?);
                        }
                        "status" => {
                        ...
                        "settings" => {
                            builder = builder.set_settings(crate::protocol_serde::shape_cluster_settings::de_cluster_settings(tokens)?);
                        }
                        "capacityProviders" => {
                            builder = builder.set_capacity_providers(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
