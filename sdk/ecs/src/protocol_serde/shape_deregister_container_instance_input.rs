...
pub fn ser_deregister_container_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeregisterContainerInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
