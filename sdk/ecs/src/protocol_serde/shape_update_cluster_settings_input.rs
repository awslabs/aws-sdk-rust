...
pub fn ser_update_cluster_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateClusterSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
