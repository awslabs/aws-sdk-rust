...
pub fn de_get_task_protection_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_task_protection::GetTaskProtectionOutput, crate::operation::get_task_protection::GetTaskProtectionError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_task_protection_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_task_protection::GetTaskProtectionOutput, crate::operation::get_task_protection::GetTaskProtectionError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_get_task_protection::de_get_task_protection(_response_body, output)
            .map_err(crate::operation::get_task_protection::GetTaskProtectionError::unhandled)?;
...
) -> Result<crate::operation::get_task_protection::builders::GetTaskProtectionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
