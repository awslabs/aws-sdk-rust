...
pub fn ser_efs_volume_configuration(
    ...
    if let Some(var_5) = &input.authorization_config {
        ...
        crate::protocol_serde::shape_efs_authorization_config::ser_efs_authorization_config(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
...
pub(crate) fn de_efs_volume_configuration<'a, I>(
    ...
    Option<crate::model::EfsVolumeConfiguration>,
    ...
    >,
{
    match tokens.next().transpose()? {
        ...
        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::efs_volume_configuration::Builder::default();
            loop {
                match tokens.next().transpose()? {
