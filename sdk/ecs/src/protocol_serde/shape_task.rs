            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "connectivityAt" => {
                            builder = builder.set_connectivity_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                        ...
                        "executionStoppedAt" => {
                            builder = builder.set_execution_stopped_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        ...
                        "inferenceAccelerators" => {
                            builder = builder.set_inference_accelerators(
                                crate::protocol_serde::shape_inference_accelerators::de_inference_accelerators(tokens, _value, depth + 1)?,
                            );
                        }
                        "lastStatus" => {
                        ...
                        "overrides" => {
                            builder = builder.set_overrides(crate::protocol_serde::shape_task_override::de_task_override(tokens, _value, depth + 1)?);
                        }
                        "platformVersion" => {
                        ...
                        "pullStartedAt" => {
                            builder = builder.set_pull_started_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        "pullStoppedAt" => {
                            builder = builder.set_pull_stopped_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        ...
                        "stopCode" => {
                            builder = builder.set_stop_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TaskStopCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "stoppedAt" => {
                        ...
                        "stoppingAt" => {
                            builder = builder.set_stopping_at(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        ...
                        "fargateEphemeralStorage" => {
                            builder = builder.set_fargate_ephemeral_storage(
                                crate::protocol_serde::shape_task_ephemeral_storage::de_task_ephemeral_storage(tokens, _value, depth + 1)?,
                            );
                        }
