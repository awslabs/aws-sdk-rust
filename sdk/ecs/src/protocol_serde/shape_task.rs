                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "inferenceAccelerators" => {
                            builder = builder
                                .set_inference_accelerators(crate::protocol_serde::shape_inference_accelerators::de_inference_accelerators(tokens)?);
                        }
                        "lastStatus" => {
                        ...
                        "overrides" => {
                            builder = builder.set_overrides(crate::protocol_serde::shape_task_override::de_task_override(tokens)?);
                        }
                        "platformVersion" => {
