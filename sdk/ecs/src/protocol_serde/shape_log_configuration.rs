...
pub fn ser_log_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LogConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_log_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LogConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
