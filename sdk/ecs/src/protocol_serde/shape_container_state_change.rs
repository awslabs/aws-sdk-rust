...
pub fn ser_container_state_change(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ContainerStateChange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
