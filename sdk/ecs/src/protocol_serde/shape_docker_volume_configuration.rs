...
pub fn ser_docker_volume_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DockerVolumeConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_docker_volume_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DockerVolumeConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
