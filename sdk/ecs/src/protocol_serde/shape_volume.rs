...
pub fn ser_volume(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Volume) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
