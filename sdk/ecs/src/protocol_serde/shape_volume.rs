...
pub fn ser_volume(
    ...
    if let Some(var_2) = &input.host {
        ...
        crate::protocol_serde::shape_host_volume_properties::ser_host_volume_properties(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_4) = &input.docker_volume_configuration {
        ...
        crate::protocol_serde::shape_docker_volume_configuration::ser_docker_volume_configuration(
            &mut object_5,
            var_4,
        )?;
        object_5.finish();
