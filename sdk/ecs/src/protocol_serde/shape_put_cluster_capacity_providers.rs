...
pub fn de_put_cluster_capacity_providers_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersOutput, crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError::unhandled(generic))
                            };
    ...
    Err(match error_code {
        ...
        "InvalidParameterException" => crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UpdateInProgressException" => crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError::UpdateInProgressException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub fn ser_put_cluster_capacity_providers_input(input: &crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
...
pub(crate) fn de_put_cluster_capacity_providers(value: &[u8], mut builder: crate::operation::put_cluster_capacity_providers::builders::PutClusterCapacityProvidersOutputBuilder) -> Result<crate::operation::put_cluster_capacity_providers::builders::PutClusterCapacityProvidersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
