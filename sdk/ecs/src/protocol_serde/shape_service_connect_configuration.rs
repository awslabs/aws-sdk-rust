...
pub fn ser_service_connect_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServiceConnectConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
...
pub(crate) fn de_service_connect_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServiceConnectConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
