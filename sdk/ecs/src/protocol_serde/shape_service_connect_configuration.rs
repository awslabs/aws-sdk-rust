    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "services" => {
                                builder = builder.set_services(
                                    crate::protocol_serde::shape_service_connect_service_list::de_service_connect_service_list(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "accessLogConfiguration" => {
                                builder = builder.set_access_log_configuration(
                                    crate::protocol_serde::shape_service_connect_access_log_configuration::de_service_connect_access_log_configuration(tokens, _value, depth + 1)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::service_connect_configuration_correct_errors(builder).build()))
        }
