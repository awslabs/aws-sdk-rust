...
pub fn ser_delete_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
