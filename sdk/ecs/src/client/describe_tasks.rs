...
impl super::Client {
    ...
    ///   - [`tasks(impl Into<String>)`](crate::operation::describe_tasks::builders::DescribeTasksFluentBuilder::tasks) / [`set_tasks(Option<Vec<String>>)`](crate::operation::describe_tasks::builders::DescribeTasksFluentBuilder::set_tasks): <p>A list of up to 100 task IDs or full ARN entries.</p>
