...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder::set_name):<br>required: **true**<br><p>The name of the capacity provider to update.</p><br>
    ///   - [`cluster(impl Into<String>)`](crate::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::update_capacity_provider::builders::UpdateCapacityProviderFluentBuilder::set_cluster):<br>required: **false**<br><p>The name of the cluster that contains the capacity provider to update. Managed instances capacity providers are cluster-scoped and can only be updated within their associated cluster.</p><br>
