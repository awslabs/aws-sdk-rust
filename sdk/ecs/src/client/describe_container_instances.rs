...
impl super::Client {
    ...
    ///   - [`include(ContainerInstanceField)`](crate::operation::describe_container_instances::builders::DescribeContainerInstancesFluentBuilder::include) / [`set_include(Option<Vec<ContainerInstanceField>>)`](crate::operation::describe_container_instances::builders::DescribeContainerInstancesFluentBuilder::set_include): <p>Specifies whether you want to see the resource tags for the container instance. If <code>TAGS</code> is specified, the tags are included in the response. If <code>CONTAINER_INSTANCE_HEALTH</code> is specified, the container instance health is included in the response. If this field is omitted, tags and container instance health status aren't included in the response.</p>
