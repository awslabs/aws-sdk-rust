...
impl super::Client {
    ...
    ///   - [`cluster(impl Into<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::set_cluster):<br>required: **true**<br><p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task sets exist in.</p><br>
    ///   - [`tasks(impl Into<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::tasks) / [`set_tasks(Option<Vec::<String>>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::set_tasks):<br>required: **false**<br><p>A list of up to 100 task IDs or full ARN entries.</p><br>
