...
impl super::Client {
    ...
    ///   - [`tasks(impl Into<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::tasks) / [`set_tasks(Option<Vec<String>>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::set_tasks): <p>A list of up to 100 task IDs or full ARN entries.</p>
