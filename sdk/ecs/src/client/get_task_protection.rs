...
impl super::Client {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::get_task_protection::builders::GetTaskProtectionFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task sets exist in.</p>
