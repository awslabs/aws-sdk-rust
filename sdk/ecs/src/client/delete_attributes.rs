...
impl super::Client {
    ...
    ///   - [`cluster(impl Into<String>)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::set_cluster):<br>required: **false**<br><p>The short name or full Amazon Resource Name (ARN) of the cluster that contains the resource to delete attributes. If you do not specify a cluster, the default cluster is assumed.</p><br>
    ///   - [`attributes(Attribute)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::attributes) / [`set_attributes(Option<Vec::<Attribute>>)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::set_attributes):<br>required: **true**<br><p>The attributes to delete from your resource. You can specify up to 10 attributes for each request. For custom attributes, specify the attribute name and target ID, but don't specify the value. If you specify the target ID using the short form, you must also specify the target type.</p><br>
