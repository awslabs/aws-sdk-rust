...
impl super::Client {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::delete_attributes::builders::DeleteAttributesFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that contains the resource to delete attributes. If you do not specify a cluster, the default cluster is assumed.</p>
