...
impl super::Client {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to use when filtering the <code>ListServices</code> results. If you do not specify a cluster, the default cluster is assumed.</p>
    ...
    ///   - [`launch_type(LaunchType)`](crate::operation::list_services::builders::ListServicesFluentBuilder::launch_type) / [`set_launch_type(Option<LaunchType>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::set_launch_type): <p>The launch type to use when filtering the <code>ListServices</code> results.</p>
    ///   - [`scheduling_strategy(SchedulingStrategy)`](crate::operation::list_services::builders::ListServicesFluentBuilder::scheduling_strategy) / [`set_scheduling_strategy(Option<SchedulingStrategy>)`](crate::operation::list_services::builders::ListServicesFluentBuilder::set_scheduling_strategy): <p>The scheduling strategy to use when filtering the <code>ListServices</code> results.</p>
