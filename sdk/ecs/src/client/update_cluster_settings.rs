...
impl super::Client {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::update_cluster_settings::builders::UpdateClusterSettingsFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::update_cluster_settings::builders::UpdateClusterSettingsFluentBuilder::set_cluster): <p>The name of the cluster to modify the settings for.</p>
