...
impl super::Client {
    ...
    ///   - [`container_instance(impl Into<String>)`](crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointFluentBuilder::container_instance) / [`set_container_instance(Option<String>)`](crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointFluentBuilder::set_container_instance):<br>required: **false**<br><p>The container instance ID or full ARN of the container instance. For more information about the ARN format, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html#ecs-resource-ids">Amazon Resource Name (ARN)</a> in the <i>Amazon ECS Developer Guide</i>.</p><br>
    ///   - [`cluster(impl Into<String>)`](crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::discover_poll_endpoint::builders::DiscoverPollEndpointFluentBuilder::set_cluster):<br>required: **false**<br><p>The short name or full Amazon Resource Name (ARN) of the cluster that the container instance belongs to.</p><br>
