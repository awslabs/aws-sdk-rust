...
impl Builder {
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone()).with_name("aws_sdk_ecs::config::Config").freeze(),
                                    cloneable: layer,
...
#[derive(::std::fmt::Debug)]
            ...
            impl ServiceRuntimePlugin {
                pub fn new(_service_config: crate::config::Config) -> Self {
                    let config = { let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AmazonEC2ContainerServiceV20141113");
                ...
                pub(crate) fn new(
                    ...
                    Self {
                        config: ::aws_smithy_types::config_bag::Layer::from(layer)
                            .with_name("aws_sdk_ecs::config::ConfigOverrideRuntimePlugin").freeze(),
                        components,
                    }
                }
            }
