    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`cluster_name(Option<String>)`](crate::input::CreateClusterInput::cluster_name): <p>The name of your cluster. If you don't specify a name for your cluster, you create a cluster that's named <code>default</code>. Up to 255 letters (uppercase and lowercase), numbers, underscores, and hyphens are allowed. </p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateClusterInput::tags): <p>The metadata that you apply to the cluster to help you categorize and organize them. Each tag consists of a key and an optional value. You define both.</p>  <p>The following basic restrictions apply to tags:</p>  <ul>   <li> <p>Maximum number of tags per resource - 50</p> </li>   <li> <p>For each resource, each tag key must be unique, and each tag key can have only one value.</p> </li>   <li> <p>Maximum key length - 128 Unicode characters in UTF-8</p> </li>   <li> <p>Maximum value length - 256 Unicode characters in UTF-8</p> </li>   <li> <p>If your tagging schema is used across multiple services and resources, remember that other services may have restrictions on allowed characters. Generally allowed characters are: letters, numbers, and spaces representable in UTF-8, and the following characters: + - = . _ : / @.</p> </li>   <li> <p>Tag keys and values are case-sensitive.</p> </li>   <li> <p>Do not use <code>aws:</code>, <code>AWS:</code>, or any upper or lowercase combination of such as a prefix for either keys or values as it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or values with this prefix. Tags with this prefix do not count against your tags per resource limit.</p> </li>  </ul>
    ///   - [`settings(Option<Vec<ClusterSetting>>)`](crate::input::CreateClusterInput::settings): <p>The setting to use when creating a cluster. This parameter is used to enable CloudWatch Container Insights for a cluster. If this value is specified, it overrides the <code>containerInsights</code> value set with <code>PutAccountSetting</code> or <code>PutAccountSettingDefault</code>.</p>
    ///   - [`configuration(Option<ClusterConfiguration>)`](crate::input::CreateClusterInput::configuration): <p>The execute command configuration for the cluster.</p>
    ///   - [`capacity_providers(Option<Vec<String>>)`](crate::input::CreateClusterInput::capacity_providers): <p>The short name of one or more capacity providers to associate with the cluster. A capacity provider must be associated with a cluster before it can be included as part of the default capacity provider strategy of the cluster or used in a capacity provider strategy when calling the <code>CreateService</code> or <code>RunTask</code> actions.</p>  <p>If specifying a capacity provider that uses an Auto Scaling group, the capacity provider must be created but not associated with another cluster. New Auto Scaling group capacity providers can be created with the <code>CreateCapacityProvider</code> API operation.</p>  <p>To use a Fargate capacity provider, specify either the <code>FARGATE</code> or <code>FARGATE_SPOT</code> capacity providers. The Fargate capacity providers are available to all accounts and only need to be associated with a cluster to be used.</p>  <p>The <code>PutClusterCapacityProviders</code> API operation is used to update the list of available capacity providers for a cluster after the cluster is created.</p>
    ///   - [`default_capacity_provider_strategy(Option<Vec<CapacityProviderStrategyItem>>)`](crate::input::CreateClusterInput::default_capacity_provider_strategy): <p>The capacity provider strategy to set as the default for the cluster. After a default capacity provider strategy is set for a cluster, when you call the <code>RunTask</code> or <code>CreateService</code> APIs with no capacity provider strategy or launch type specified, the default capacity provider strategy for the cluster is used.</p>  <p>If a default capacity provider strategy isn't defined for a cluster when it was created, it can be defined later with the <code>PutClusterCapacityProviders</code> API operation.</p>
    ...
    ///
    /// - Takes [`CreateTaskSetInput`](crate::input::CreateTaskSetInput) with field(s):
    ///   - [`service(Option<String>)`](crate::input::CreateTaskSetInput::service): <p>The short name or full Amazon Resource Name (ARN) of the service to create the task set in.</p>
    ///   - [`cluster(Option<String>)`](crate::input::CreateTaskSetInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service to create the task set in.</p>
    ///   - [`external_id(Option<String>)`](crate::input::CreateTaskSetInput::external_id): <p>An optional non-unique tag that identifies this task set in external systems. If the task set is associated with a service discovery registry, the tasks in this task set will have the <code>ECS_TASK_SET_EXTERNAL_ID</code> Cloud Map attribute set to the provided value.</p>
    ///   - [`task_definition(Option<String>)`](crate::input::CreateTaskSetInput::task_definition): <p>The task definition for the tasks in the task set to use.</p>
    ///   - [`network_configuration(Option<NetworkConfiguration>)`](crate::input::CreateTaskSetInput::network_configuration): <p>An object representing the network configuration for a task set.</p>
    ///   - [`load_balancers(Option<Vec<LoadBalancer>>)`](crate::input::CreateTaskSetInput::load_balancers): <p>A load balancer object representing the load balancer to use with the task set. The supported load balancer types are either an Application Load Balancer or a Network Load Balancer.</p>
    ///   - [`service_registries(Option<Vec<ServiceRegistry>>)`](crate::input::CreateTaskSetInput::service_registries): <p>The details of the service discovery registries to assign to this task set. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-discovery.html">Service Discovery</a>.</p>
    ///   - [`launch_type(Option<LaunchType>)`](crate::input::CreateTaskSetInput::launch_type): <p>The launch type that new tasks in the task set uses. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html">Amazon ECS Launch Types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>  <p>If a <code>launchType</code> is specified, the <code>capacityProviderStrategy</code> parameter must be omitted.</p>
    ///   - [`capacity_provider_strategy(Option<Vec<CapacityProviderStrategyItem>>)`](crate::input::CreateTaskSetInput::capacity_provider_strategy): <p>The capacity provider strategy to use for the task set.</p>  <p>A capacity provider strategy consists of one or more capacity providers along with the <code>base</code> and <code>weight</code> to assign to them. A capacity provider must be associated with the cluster to be used in a capacity provider strategy. The <code>PutClusterCapacityProviders</code> API is used to associate a capacity provider with a cluster. Only capacity providers with an <code>ACTIVE</code> or <code>UPDATING</code> status can be used.</p>  <p>If a <code>capacityProviderStrategy</code> is specified, the <code>launchType</code> parameter must be omitted. If no <code>capacityProviderStrategy</code> or <code>launchType</code> is specified, the <code>defaultCapacityProviderStrategy</code> for the cluster is used.</p>  <p>If specifying a capacity provider that uses an Auto Scaling group, the capacity provider must already be created. New capacity providers can be created with the <code>CreateCapacityProvider</code> API operation.</p>  <p>To use a Fargate capacity provider, specify either the <code>FARGATE</code> or <code>FARGATE_SPOT</code> capacity providers. The Fargate capacity providers are available to all accounts and only need to be associated with a cluster to be used.</p>  <p>The <code>PutClusterCapacityProviders</code> API operation is used to update the list of available capacity providers for a cluster after the cluster is created.</p>
    ///   - [`platform_version(Option<String>)`](crate::input::CreateTaskSetInput::platform_version): <p>The platform version that the tasks in the task set uses. A platform version is specified only for tasks using the Fargate launch type. If one isn't specified, the <code>LATEST</code> platform version is used.</p>
    ///   - [`scale(Option<Scale>)`](crate::input::CreateTaskSetInput::scale): <p>A floating-point percentage of the desired number of tasks to place and keep running in the task set.</p>
    ///   - [`client_token(Option<String>)`](crate::input::CreateTaskSetInput::client_token): <p>The identifier that you provide to ensure the idempotency of the request. It's case sensitive and must be unique. It can be up to 32 ASCII characters are allowed.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateTaskSetInput::tags): <p>The metadata that you apply to the task set to help you categorize and organize them. Each tag consists of a key and an optional value. You define both. When a service is deleted, the tags are deleted.</p>  <p>The following basic restrictions apply to tags:</p>  <ul>   <li> <p>Maximum number of tags per resource - 50</p> </li>   <li> <p>For each resource, each tag key must be unique, and each tag key can have only one value.</p> </li>   <li> <p>Maximum key length - 128 Unicode characters in UTF-8</p> </li>   <li> <p>Maximum value length - 256 Unicode characters in UTF-8</p> </li>   <li> <p>If your tagging schema is used across multiple services and resources, remember that other services may have restrictions on allowed characters. Generally allowed characters are: letters, numbers, and spaces representable in UTF-8, and the following characters: + - = . _ : / @.</p> </li>   <li> <p>Tag keys and values are case-sensitive.</p> </li>   <li> <p>Do not use <code>aws:</code>, <code>AWS:</code>, or any upper or lowercase combination of such as a prefix for either keys or values as it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or values with this prefix. Tags with this prefix do not count against your tags per resource limit.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`DeleteAttributesInput`](crate::input::DeleteAttributesInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::DeleteAttributesInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that contains the resource to delete attributes. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`attributes(Option<Vec<Attribute>>)`](crate::input::DeleteAttributesInput::attributes): <p>The attributes to delete from your resource. You can specify up to 10 attributes for each request. For custom attributes, specify the attribute name and target ID, but don't specify the value. If you specify the target ID using the short form, you must also specify the target type.</p>
    ...
    ///
    /// - Takes [`DeleteCapacityProviderInput`](crate::input::DeleteCapacityProviderInput) with field(s):
    ///   - [`capacity_provider(Option<String>)`](crate::input::DeleteCapacityProviderInput::capacity_provider): <p>The short name or full Amazon Resource Name (ARN) of the capacity provider to delete.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::DeleteClusterInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to delete.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::DeleteServiceInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service to delete. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`service(Option<String>)`](crate::input::DeleteServiceInput::service): <p>The name of the service to delete.</p>
    ///   - [`force(Option<bool>)`](crate::input::DeleteServiceInput::force): <p>If <code>true</code>, allows you to delete a service even if it wasn't scaled down to zero tasks. It's only necessary to use this if the service uses the <code>REPLICA</code> scheduling strategy.</p>
    ...
    ///
    /// - Takes [`DeleteTaskSetInput`](crate::input::DeleteTaskSetInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::DeleteTaskSetInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task set found in to delete.</p>
    ///   - [`service(Option<String>)`](crate::input::DeleteTaskSetInput::service): <p>The short name or full Amazon Resource Name (ARN) of the service that hosts the task set to delete.</p>
    ///   - [`task_set(Option<String>)`](crate::input::DeleteTaskSetInput::task_set): <p>The task set ID or full Amazon Resource Name (ARN) of the task set to delete.</p>
    ///   - [`force(Option<bool>)`](crate::input::DeleteTaskSetInput::force): <p>If <code>true</code>, you can delete a task set even if it hasn't been scaled down to zero.</p>
    ...
    ///
    /// - Takes [`DeregisterContainerInstanceInput`](crate::input::DeregisterContainerInstanceInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::DeregisterContainerInstanceInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the container instance to deregister. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container_instance(Option<String>)`](crate::input::DeregisterContainerInstanceInput::container_instance): <p>The container instance ID or full ARN of the container instance to deregister. The ARN contains the <code>arn:aws:ecs</code> namespace, followed by the Region of the container instance, the Amazon Web Services account ID of the container instance owner, the <code>container-instance</code> namespace, and then the container instance ID. For example, <code>arn:aws:ecs:region:aws_account_id:container-instance/container_instance_ID</code>.</p>
    ///   - [`force(Option<bool>)`](crate::input::DeregisterContainerInstanceInput::force): <p>Forces the container instance to be deregistered. If you have tasks running on the container instance when you deregister it with the <code>force</code> option, these tasks remain running until you terminate the instance or the tasks stop through some other means, but they're orphaned (no longer monitored or accounted for by Amazon ECS). If an orphaned task on your container instance is part of an Amazon ECS service, then the service scheduler starts another copy of that task, on a different container instance if possible. </p>  <p>Any containers in orphaned service tasks that are registered with a Classic Load Balancer or an Application Load Balancer target group are deregistered. They begin connection draining according to the settings on the load balancer or target group.</p>
    ...
    ///
    /// - Takes [`DeregisterTaskDefinitionInput`](crate::input::DeregisterTaskDefinitionInput) with field(s):
    ///   - [`task_definition(Option<String>)`](crate::input::DeregisterTaskDefinitionInput::task_definition): <p>The <code>family</code> and <code>revision</code> (<code>family:revision</code>) or full Amazon Resource Name (ARN) of the task definition to deregister. You must specify a <code>revision</code>.</p>
    ...
    ///
    /// - Takes [`DescribeCapacityProvidersInput`](crate::input::DescribeCapacityProvidersInput) with field(s):
    ///   - [`capacity_providers(Option<Vec<String>>)`](crate::input::DescribeCapacityProvidersInput::capacity_providers): <p>The short name or full Amazon Resource Name (ARN) of one or more capacity providers. Up to <code>100</code> capacity providers can be described in an action.</p>
    ///   - [`include(Option<Vec<CapacityProviderField>>)`](crate::input::DescribeCapacityProvidersInput::include): <p>Specifies whether or not you want to see the resource tags for the capacity provider. If <code>TAGS</code> is specified, the tags are included in the response. If this field is omitted, tags aren't included in the response.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeCapacityProvidersInput::max_results): <p>The maximum number of account setting results returned by <code>DescribeCapacityProviders</code> in paginated output. When this parameter is used, <code>DescribeCapacityProviders</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>DescribeCapacityProviders</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 10. If this parameter is not used, then <code>DescribeCapacityProviders</code> returns up to 10 results and a <code>nextToken</code> value if applicable.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeCapacityProvidersInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>DescribeCapacityProviders</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value.</p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::DescribeServicesInput::cluster): <p>The short name or full Amazon Resource Name (ARN)the cluster that hosts the service to describe. If you do not specify a cluster, the default cluster is assumed. This parameter is required if the service or services you are describing were launched in any cluster other than the default cluster.</p>
    ///   - [`services(Option<Vec<String>>)`](crate::input::DescribeServicesInput::services): <p>A list of services to describe. You may specify up to 10 services to describe in a single operation.</p>
    ///   - [`include(Option<Vec<ServiceField>>)`](crate::input::DescribeServicesInput::include): <p>Determines whether you want to see the resource tags for the service. If <code>TAGS</code> is specified, the tags are included in the response. If this field is omitted, tags aren't included in the response.</p>
    ...
    ///
    /// - Takes [`DescribeTaskDefinitionInput`](crate::input::DescribeTaskDefinitionInput) with field(s):
    ///   - [`task_definition(Option<String>)`](crate::input::DescribeTaskDefinitionInput::task_definition): <p>The <code>family</code> for the latest <code>ACTIVE</code> revision, <code>family</code> and <code>revision</code> (<code>family:revision</code>) for a specific revision in the family, or full Amazon Resource Name (ARN) of the task definition to describe.</p>
    ///   - [`include(Option<Vec<TaskDefinitionField>>)`](crate::input::DescribeTaskDefinitionInput::include): <p>Determines whether to see the resource tags for the task definition. If <code>TAGS</code> is specified, the tags are included in the response. If this field is omitted, tags aren't included in the response.</p>
    ...
    ///
    /// - Takes [`DescribeTasksInput`](crate::input::DescribeTasksInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::DescribeTasksInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the task or tasks to describe. If you do not specify a cluster, the default cluster is assumed. This parameter is required if the task or tasks you are describing were launched in any cluster other than the default cluster.</p>
    ///   - [`tasks(Option<Vec<String>>)`](crate::input::DescribeTasksInput::tasks): <p>A list of up to 100 task IDs or full ARN entries.</p>
    ///   - [`include(Option<Vec<TaskField>>)`](crate::input::DescribeTasksInput::include): <p>Specifies whether you want to see the resource tags for the task. If <code>TAGS</code> is specified, the tags are included in the response. If this field is omitted, tags aren't included in the response.</p>
    ...
    ///
    /// - Takes [`DescribeTaskSetsInput`](crate::input::DescribeTaskSetsInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::DescribeTaskSetsInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task sets exist in.</p>
    ///   - [`service(Option<String>)`](crate::input::DescribeTaskSetsInput::service): <p>The short name or full Amazon Resource Name (ARN) of the service that the task sets exist in.</p>
    ///   - [`task_sets(Option<Vec<String>>)`](crate::input::DescribeTaskSetsInput::task_sets): <p>The ID or full Amazon Resource Name (ARN) of task sets to describe.</p>
    ///   - [`include(Option<Vec<TaskSetField>>)`](crate::input::DescribeTaskSetsInput::include): <p>Specifies whether to see the resource tags for the task set. If <code>TAGS</code> is specified, the tags are included in the response. If this field is omitted, tags aren't included in the response.</p>
    ...
    ///
    /// - Takes [`DiscoverPollEndpointInput`](crate::input::DiscoverPollEndpointInput) with field(s):
    ///   - [`container_instance(Option<String>)`](crate::input::DiscoverPollEndpointInput::container_instance): <p>The container instance ID or full ARN of the container instance. The ARN contains the <code>arn:aws:ecs</code> namespace, followed by the Region of the container instance, the Amazon Web Services account ID of the container instance owner, the <code>container-instance</code> namespace, and then the container instance ID. For example, <code>arn:aws:ecs:region:aws_account_id:container-instance/container_instance_ID</code>.</p>
    ///   - [`cluster(Option<String>)`](crate::input::DiscoverPollEndpointInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that the container instance belongs to.</p>
    ...
    ///
    /// - Takes [`ExecuteCommandInput`](crate::input::ExecuteCommandInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::ExecuteCommandInput::cluster): <p>The Amazon Resource Name (ARN) or short name of the cluster the task is running in. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container(Option<String>)`](crate::input::ExecuteCommandInput::container): <p>The name of the container to execute the command on. A container name only needs to be specified for tasks containing multiple containers.</p>
    ///   - [`command(Option<String>)`](crate::input::ExecuteCommandInput::command): <p>The command to run on the container.</p>
    ///   - [`interactive(bool)`](crate::input::ExecuteCommandInput::interactive): <p>Use this flag to run your command in interactive mode.</p>
    ///   - [`task(Option<String>)`](crate::input::ExecuteCommandInput::task): <p>The Amazon Resource Name (ARN) or ID of the task the container is part of.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::ListServicesInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to use when filtering the <code>ListServices</code> results. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListServicesInput::next_token): <p>The <code>nextToken</code> value returned from a <code>ListServices</code> request indicating that more results are available to fulfill the request and further calls will be needed. If <code>maxResults</code> was provided, it is possible the number of results to be fewer than <code>maxResults</code>.</p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ///   - [`max_results(Option<i32>)`](crate::input::ListServicesInput::max_results): <p>The maximum number of service results that <code>ListServices</code> returned in paginated output. When this parameter is used, <code>ListServices</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListServices</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 100. If this parameter isn't used, then <code>ListServices</code> returns up to 10 results and a <code>nextToken</code> value if applicable.</p>
    ///   - [`launch_type(Option<LaunchType>)`](crate::input::ListServicesInput::launch_type): <p>The launch type to use when filtering the <code>ListServices</code> results.</p>
    ///   - [`scheduling_strategy(Option<SchedulingStrategy>)`](crate::input::ListServicesInput::scheduling_strategy): <p>The scheduling strategy to use when filtering the <code>ListServices</code> results.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) that identifies the resource to list the tags for. Currently, the supported resources are Amazon ECS tasks, services, task definitions, clusters, and container instances.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::ListTasksInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to use when filtering the <code>ListTasks</code> results. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container_instance(Option<String>)`](crate::input::ListTasksInput::container_instance): <p>The container instance ID or full ARN of the container instance to use when filtering the <code>ListTasks</code> results. Specifying a <code>containerInstance</code> limits the results to tasks that belong to that container instance.</p>
    ///   - [`family(Option<String>)`](crate::input::ListTasksInput::family): <p>The name of the task definition family to use when filtering the <code>ListTasks</code> results. Specifying a <code>family</code> limits the results to tasks that belong to that family.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTasksInput::next_token): <p>The <code>nextToken</code> value returned from a <code>ListTasks</code> request indicating that more results are available to fulfill the request and further calls will be needed. If <code>maxResults</code> was provided, it's possible the number of results to be fewer than <code>maxResults</code>.</p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTasksInput::max_results): <p>The maximum number of task results that <code>ListTasks</code> returned in paginated output. When this parameter is used, <code>ListTasks</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListTasks</code> request with the returned <code>nextToken</code> value. This value can be between 1 and 100. If this parameter isn't used, then <code>ListTasks</code> returns up to 100 results and a <code>nextToken</code> value if applicable.</p>
    ///   - [`started_by(Option<String>)`](crate::input::ListTasksInput::started_by): <p>The <code>startedBy</code> value to filter the task results with. Specifying a <code>startedBy</code> value limits the results to tasks that were started with that value.</p>
    ///   - [`service_name(Option<String>)`](crate::input::ListTasksInput::service_name): <p>The name of the service to use when filtering the <code>ListTasks</code> results. Specifying a <code>serviceName</code> limits the results to tasks that belong to that service.</p>
    ///   - [`desired_status(Option<DesiredStatus>)`](crate::input::ListTasksInput::desired_status): <p>The task desired status to use when filtering the <code>ListTasks</code> results. Specifying a <code>desiredStatus</code> of <code>STOPPED</code> limits the results to tasks that Amazon ECS has set the desired status to <code>STOPPED</code>. This can be useful for debugging tasks that aren't starting properly or have died or finished. The default status filter is <code>RUNNING</code>, which shows tasks that Amazon ECS has set the desired status to <code>RUNNING</code>.</p> <note>   <p>Although you can filter results based on a desired status of <code>PENDING</code>, this doesn't return any results. Amazon ECS never sets the desired status of a task to that value (only a task's <code>lastStatus</code> may have a value of <code>PENDING</code>).</p>  </note>
    ///   - [`launch_type(Option<LaunchType>)`](crate::input::ListTasksInput::launch_type): <p>The launch type to use when filtering the <code>ListTasks</code> results.</p>
    ...
    ///
    /// - Takes [`PutAccountSettingInput`](crate::input::PutAccountSettingInput) with field(s):
    ///   - [`name(Option<SettingName>)`](crate::input::PutAccountSettingInput::name): <p>The Amazon ECS resource name for which to modify the account setting. If <code>serviceLongArnFormat</code> is specified, the ARN for your Amazon ECS services is affected. If <code>taskLongArnFormat</code> is specified, the ARN and resource ID for your Amazon ECS tasks is affected. If <code>containerInstanceLongArnFormat</code> is specified, the ARN and resource ID for your Amazon ECS container instances is affected. If <code>awsvpcTrunking</code> is specified, the elastic network interface (ENI) limit for your Amazon ECS container instances is affected. If <code>containerInsights</code> is specified, the default setting for CloudWatch Container Insights for your clusters is affected.</p>
    ///   - [`value(Option<String>)`](crate::input::PutAccountSettingInput::value): <p>The account setting value for the specified principal ARN. Accepted values are <code>enabled</code> and <code>disabled</code>.</p>
    ///   - [`principal_arn(Option<String>)`](crate::input::PutAccountSettingInput::principal_arn): <p>The ARN of the principal, which can be an IAM user, IAM role, or the root user. If you specify the root user, it modifies the account setting for all IAM users, IAM roles, and the root user of the account unless an IAM user or role explicitly overrides these settings. If this field is omitted, the setting is changed only for the authenticated user.</p> <note>   <p>Federated users assume the account setting of the root user and can't have explicit account settings set for them.</p>  </note>
    ...
    ///
    /// - Takes [`PutAccountSettingDefaultInput`](crate::input::PutAccountSettingDefaultInput) with field(s):
    ///   - [`name(Option<SettingName>)`](crate::input::PutAccountSettingDefaultInput::name): <p>The resource name for which to modify the account setting. If <code>serviceLongArnFormat</code> is specified, the ARN for your Amazon ECS services is affected. If <code>taskLongArnFormat</code> is specified, the ARN and resource ID for your Amazon ECS tasks is affected. If <code>containerInstanceLongArnFormat</code> is specified, the ARN and resource ID for your Amazon ECS container instances is affected. If <code>awsvpcTrunking</code> is specified, the ENI limit for your Amazon ECS container instances is affected. If <code>containerInsights</code> is specified, the default setting for CloudWatch Container Insights for your clusters is affected.</p>
    ///   - [`value(Option<String>)`](crate::input::PutAccountSettingDefaultInput::value): <p>The account setting value for the specified principal ARN. Accepted values are <code>enabled</code> and <code>disabled</code>.</p>
    ...
    ///
    /// - Takes [`PutAttributesInput`](crate::input::PutAttributesInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::PutAttributesInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that contains the resource to apply attributes. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`attributes(Option<Vec<Attribute>>)`](crate::input::PutAttributesInput::attributes): <p>The attributes to apply to your resource. You can specify up to 10 custom attributes for each resource. You can specify up to 10 attributes in a single call.</p>
    ...
    ///
    /// - Takes [`PutClusterCapacityProvidersInput`](crate::input::PutClusterCapacityProvidersInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::PutClusterCapacityProvidersInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to modify the capacity provider settings for. If you don't specify a cluster, the default cluster is assumed.</p>
    ///   - [`capacity_providers(Option<Vec<String>>)`](crate::input::PutClusterCapacityProvidersInput::capacity_providers): <p>The name of one or more capacity providers to associate with the cluster.</p>  <p>If specifying a capacity provider that uses an Auto Scaling group, the capacity provider must already be created. New capacity providers can be created with the <code>CreateCapacityProvider</code> API operation.</p>  <p>To use a Fargate capacity provider, specify either the <code>FARGATE</code> or <code>FARGATE_SPOT</code> capacity providers. The Fargate capacity providers are available to all accounts and only need to be associated with a cluster to be used.</p>
    ///   - [`default_capacity_provider_strategy(Option<Vec<CapacityProviderStrategyItem>>)`](crate::input::PutClusterCapacityProvidersInput::default_capacity_provider_strategy): <p>The capacity provider strategy to use by default for the cluster.</p>  <p>When creating a service or running a task on a cluster, if no capacity provider or launch type is specified then the default capacity provider strategy for the cluster is used.</p>  <p>A capacity provider strategy consists of one or more capacity providers along with the <code>base</code> and <code>weight</code> to assign to them. A capacity provider must be associated with the cluster to be used in a capacity provider strategy. The <code>PutClusterCapacityProviders</code> API is used to associate a capacity provider with a cluster. Only capacity providers with an <code>ACTIVE</code> or <code>UPDATING</code> status can be used.</p>  <p>If specifying a capacity provider that uses an Auto Scaling group, the capacity provider must already be created. New capacity providers can be created with the <code>CreateCapacityProvider</code> API operation.</p>  <p>To use a Fargate capacity provider, specify either the <code>FARGATE</code> or <code>FARGATE_SPOT</code> capacity providers. The Fargate capacity providers are available to all accounts and only need to be associated with a cluster to be used.</p>
    ...
    ///
    /// - Takes [`RegisterContainerInstanceInput`](crate::input::RegisterContainerInstanceInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::RegisterContainerInstanceInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to register your container instance with. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`instance_identity_document(Option<String>)`](crate::input::RegisterContainerInstanceInput::instance_identity_document): <p>The instance identity document for the EC2 instance to register. This document can be found by running the following command from the instance: <code>curl http://169.254.169.254/latest/dynamic/instance-identity/document/</code> </p>
    ///   - [`instance_identity_document_signature(Option<String>)`](crate::input::RegisterContainerInstanceInput::instance_identity_document_signature): <p>The instance identity document signature for the EC2 instance to register. This signature can be found by running the following command from the instance: <code>curl http://169.254.169.254/latest/dynamic/instance-identity/signature/</code> </p>
    ///   - [`total_resources(Option<Vec<Resource>>)`](crate::input::RegisterContainerInstanceInput::total_resources): <p>The resources available on the instance.</p>
    ///   - [`version_info(Option<VersionInfo>)`](crate::input::RegisterContainerInstanceInput::version_info): <p>The version information for the Amazon ECS container agent and Docker daemon that runs on the container instance.</p>
    ///   - [`container_instance_arn(Option<String>)`](crate::input::RegisterContainerInstanceInput::container_instance_arn): <p>The ARN of the container instance (if it was previously registered).</p>
    ///   - [`attributes(Option<Vec<Attribute>>)`](crate::input::RegisterContainerInstanceInput::attributes): <p>The container instance attributes that this container instance supports.</p>
    ///   - [`platform_devices(Option<Vec<PlatformDevice>>)`](crate::input::RegisterContainerInstanceInput::platform_devices): <p>The devices that are available on the container instance. The only supported device type is a GPU.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::RegisterContainerInstanceInput::tags): <p>The metadata that you apply to the container instance to help you categorize and organize them. Each tag consists of a key and an optional value. You define both.</p>  <p>The following basic restrictions apply to tags:</p>  <ul>   <li> <p>Maximum number of tags per resource - 50</p> </li>   <li> <p>For each resource, each tag key must be unique, and each tag key can have only one value.</p> </li>   <li> <p>Maximum key length - 128 Unicode characters in UTF-8</p> </li>   <li> <p>Maximum value length - 256 Unicode characters in UTF-8</p> </li>   <li> <p>If your tagging schema is used across multiple services and resources, remember that other services may have restrictions on allowed characters. Generally allowed characters are: letters, numbers, and spaces representable in UTF-8, and the following characters: + - = . _ : / @.</p> </li>   <li> <p>Tag keys and values are case-sensitive.</p> </li>   <li> <p>Do not use <code>aws:</code>, <code>AWS:</code>, or any upper or lowercase combination of such as a prefix for either keys or values as it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or values with this prefix. Tags with this prefix do not count against your tags per resource limit.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`RunTaskInput`](crate::input::RunTaskInput) with field(s):
    ///   - [`capacity_provider_strategy(Option<Vec<CapacityProviderStrategyItem>>)`](crate::input::RunTaskInput::capacity_provider_strategy): <p>The capacity provider strategy to use for the task.</p>  <p>If a <code>capacityProviderStrategy</code> is specified, the <code>launchType</code> parameter must be omitted. If no <code>capacityProviderStrategy</code> or <code>launchType</code> is specified, the <code>defaultCapacityProviderStrategy</code> for the cluster is used.</p>  <p>When you use cluster auto scaling, you must specify <code>capacityProviderStrategy</code> and not <code>launchType</code>. </p>  <p>A capacity provider strategy may contain a maximum of 6 capacity providers.</p>
    ///   - [`cluster(Option<String>)`](crate::input::RunTaskInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster to run your task on. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`count(Option<i32>)`](crate::input::RunTaskInput::count): <p>The number of instantiations of the specified task to place on your cluster. You can specify up to 10 tasks for each call.</p>
    ///   - [`enable_ecs_managed_tags(bool)`](crate::input::RunTaskInput::enable_ecs_managed_tags): <p>Specifies whether to enable Amazon ECS managed tags for the task. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html">Tagging Your Amazon ECS Resources</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    ///   - [`enable_execute_command(bool)`](crate::input::RunTaskInput::enable_execute_command): <p>Determines whether to enable the execute command functionality for the containers in this task. If <code>true</code>, this enables execute command functionality on all containers in the task.</p>
    ///   - [`group(Option<String>)`](crate::input::RunTaskInput::group): <p>The name of the task group to associate with the task. The default value is the family name of the task definition (for example, <code>family:my-family-name</code>).</p>
    ///   - [`launch_type(Option<LaunchType>)`](crate::input::RunTaskInput::launch_type): <p>The infrastructure to run your standalone task on. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html">Amazon ECS launch types</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>  <p>The <code>FARGATE</code> launch type runs your tasks on Fargate On-Demand infrastructure.</p> <note>   <p>Fargate Spot infrastructure is available for use but a capacity provider strategy must be used. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/userguide/fargate-capacity-providers.html">Fargate capacity providers</a> in the <i>Amazon ECS User Guide for Fargate</i>.</p>  </note>  <p>The <code>EC2</code> launch type runs your tasks on Amazon EC2 instances registered to your cluster.</p>  <p>The <code>EXTERNAL</code> launch type runs your tasks on your on-premises server or virtual machine (VM) capacity registered to your cluster.</p>  <p>A task can use either a launch type or a capacity provider strategy. If a <code>launchType</code> is specified, the <code>capacityProviderStrategy</code> parameter must be omitted.</p>  <p>When you use cluster auto scaling, you must specify <code>capacityProviderStrategy</code> and not <code>launchType</code>. </p>
    ///   - [`network_configuration(Option<NetworkConfiguration>)`](crate::input::RunTaskInput::network_configuration): <p>The network configuration for the task. This parameter is required for task definitions that use the <code>awsvpc</code> network mode to receive their own elastic network interface, and it isn't supported for other network modes. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html">Task networking</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    ///   - [`overrides(Option<TaskOverride>)`](crate::input::RunTaskInput::overrides): <p>A list of container overrides in JSON format that specify the name of a container in the specified task definition and the overrides it should receive. You can override the default command for a container (that's specified in the task definition or Docker image) with a <code>command</code> override. You can also override existing environment variables (that are specified in the task definition or Docker image) on a container or add new environment variables to it with an <code>environment</code> override.</p>  <p>A total of 8192 characters are allowed for overrides. This limit includes the JSON formatting characters of the override structure.</p>
    ///   - [`placement_constraints(Option<Vec<PlacementConstraint>>)`](crate::input::RunTaskInput::placement_constraints): <p>An array of placement constraint objects to use for the task. You can specify up to 10 constraints for each task (including constraints in the task definition and those specified at runtime).</p>
    ///   - [`placement_strategy(Option<Vec<PlacementStrategy>>)`](crate::input::RunTaskInput::placement_strategy): <p>The placement strategy objects to use for the task. You can specify a maximum of 5 strategy rules for each task.</p>
    ///   - [`platform_version(Option<String>)`](crate::input::RunTaskInput::platform_version): <p>The platform version the task uses. A platform version is only specified for tasks hosted on Fargate. If one isn't specified, the <code>LATEST</code> platform version is used. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html">Fargate platform versions</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    ///   - [`propagate_tags(Option<PropagateTags>)`](crate::input::RunTaskInput::propagate_tags): <p>Specifies whether to propagate the tags from the task definition to the task. If no value is specified, the tags aren't propagated. Tags can only be propagated to the task during task creation. To add tags to a task after task creation, use the <code>TagResource</code> API action.</p> <note>   <p>An error will be received if you specify the <code>SERVICE</code> option when running a task.</p>  </note>
    ///   - [`reference_id(Option<String>)`](crate::input::RunTaskInput::reference_id): <p>The reference ID to use for the task. The reference ID can have a maximum length of 1024 characters.</p>
    ///   - [`started_by(Option<String>)`](crate::input::RunTaskInput::started_by): <p>An optional tag specified when a task is started. For example, if you automatically trigger a task to run a batch process job, you could apply a unique identifier for that job to your task with the <code>startedBy</code> parameter. You can then identify which tasks belong to that job by filtering the results of a <code>ListTasks</code> call with the <code>startedBy</code> value. Up to 36 letters (uppercase and lowercase), numbers, hyphens (-), and underscores (_) are allowed.</p>  <p>If a task is started by an Amazon ECS service, then the <code>startedBy</code> parameter contains the deployment ID of the service that starts it.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::RunTaskInput::tags): <p>The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define.</p>  <p>The following basic restrictions apply to tags:</p>  <ul>   <li> <p>Maximum number of tags per resource - 50</p> </li>   <li> <p>For each resource, each tag key must be unique, and each tag key can have only one value.</p> </li>   <li> <p>Maximum key length - 128 Unicode characters in UTF-8</p> </li>   <li> <p>Maximum value length - 256 Unicode characters in UTF-8</p> </li>   <li> <p>If your tagging schema is used across multiple services and resources, remember that other services may have restrictions on allowed characters. Generally allowed characters are: letters, numbers, and spaces representable in UTF-8, and the following characters: + - = . _ : / @.</p> </li>   <li> <p>Tag keys and values are case-sensitive.</p> </li>   <li> <p>Do not use <code>aws:</code>, <code>AWS:</code>, or any upper or lowercase combination of such as a prefix for either keys or values as it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or values with this prefix. Tags with this prefix do not count against your tags per resource limit.</p> </li>  </ul>
    ///   - [`task_definition(Option<String>)`](crate::input::RunTaskInput::task_definition): <p>The <code>family</code> and <code>revision</code> (<code>family:revision</code>) or full ARN of the task definition to run. If a <code>revision</code> isn't specified, the latest <code>ACTIVE</code> revision is used.</p>  <p>The full ARN value must match the value that you specified as the <code>Resource</code> of the IAM principal's permissions policy. For example, if the <code>Resource</code> is arn:aws:ecs:us-east-1:111122223333:task-definition/TaskFamilyName:*, the <code>taskDefinition</code> ARN value must be <code>arn:aws:ecs:us-east-1:111122223333:task-definition/TaskFamilyName</code>.</p>
    ...
    ///
    /// - Takes [`StartTaskInput`](crate::input::StartTaskInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::StartTaskInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster where to start your task. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container_instances(Option<Vec<String>>)`](crate::input::StartTaskInput::container_instances): <p>The container instance IDs or full ARN entries for the container instances where you would like to place your task. You can specify up to 10 container instances.</p>
    ///   - [`enable_ecs_managed_tags(bool)`](crate::input::StartTaskInput::enable_ecs_managed_tags): <p>Specifies whether to enable Amazon ECS managed tags for the task. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html">Tagging Your Amazon ECS Resources</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    ///   - [`enable_execute_command(bool)`](crate::input::StartTaskInput::enable_execute_command): <p>Whether or not the execute command functionality is enabled for the task. If <code>true</code>, this enables execute command functionality on all containers in the task.</p>
    ///   - [`group(Option<String>)`](crate::input::StartTaskInput::group): <p>The name of the task group to associate with the task. The default value is the family name of the task definition (for example, family:my-family-name).</p>
    ///   - [`network_configuration(Option<NetworkConfiguration>)`](crate::input::StartTaskInput::network_configuration): <p>The VPC subnet and security group configuration for tasks that receive their own elastic network interface by using the <code>awsvpc</code> networking mode.</p>
    ///   - [`overrides(Option<TaskOverride>)`](crate::input::StartTaskInput::overrides): <p>A list of container overrides in JSON format that specify the name of a container in the specified task definition and the overrides it receives. You can override the default command for a container (that's specified in the task definition or Docker image) with a <code>command</code> override. You can also override existing environment variables (that are specified in the task definition or Docker image) on a container or add new environment variables to it with an <code>environment</code> override.</p> <note>   <p>A total of 8192 characters are allowed for overrides. This limit includes the JSON formatting characters of the override structure.</p>  </note>
    ///   - [`propagate_tags(Option<PropagateTags>)`](crate::input::StartTaskInput::propagate_tags): <p>Specifies whether to propagate the tags from the task definition or the service to the task. If no value is specified, the tags aren't propagated.</p>
    ///   - [`reference_id(Option<String>)`](crate::input::StartTaskInput::reference_id): <p>The reference ID to use for the task.</p>
    ///   - [`started_by(Option<String>)`](crate::input::StartTaskInput::started_by): <p>An optional tag specified when a task is started. For example, if you automatically trigger a task to run a batch process job, you could apply a unique identifier for that job to your task with the <code>startedBy</code> parameter. You can then identify which tasks belong to that job by filtering the results of a <code>ListTasks</code> call with the <code>startedBy</code> value. Up to 36 letters (uppercase and lowercase), numbers, hyphens (-), and underscores (_) are allowed.</p>  <p>If a task is started by an Amazon ECS service, the <code>startedBy</code> parameter contains the deployment ID of the service that starts it.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::StartTaskInput::tags): <p>The metadata that you apply to the task to help you categorize and organize them. Each tag consists of a key and an optional value, both of which you define.</p>  <p>The following basic restrictions apply to tags:</p>  <ul>   <li> <p>Maximum number of tags per resource - 50</p> </li>   <li> <p>For each resource, each tag key must be unique, and each tag key can have only one value.</p> </li>   <li> <p>Maximum key length - 128 Unicode characters in UTF-8</p> </li>   <li> <p>Maximum value length - 256 Unicode characters in UTF-8</p> </li>   <li> <p>If your tagging schema is used across multiple services and resources, remember that other services may have restrictions on allowed characters. Generally allowed characters are: letters, numbers, and spaces representable in UTF-8, and the following characters: + - = . _ : / @.</p> </li>   <li> <p>Tag keys and values are case-sensitive.</p> </li>   <li> <p>Do not use <code>aws:</code>, <code>AWS:</code>, or any upper or lowercase combination of such as a prefix for either keys or values as it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or values with this prefix. Tags with this prefix do not count against your tags per resource limit.</p> </li>  </ul>
    ///   - [`task_definition(Option<String>)`](crate::input::StartTaskInput::task_definition): <p>The <code>family</code> and <code>revision</code> (<code>family:revision</code>) or full ARN of the task definition to start. If a <code>revision</code> isn't specified, the latest <code>ACTIVE</code> revision is used.</p>
    ...
    ///
    /// - Takes [`StopTaskInput`](crate::input::StopTaskInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::StopTaskInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the task to stop. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`task(Option<String>)`](crate::input::StopTaskInput::task): <p>The task ID or full Amazon Resource Name (ARN) of the task to stop.</p>
    ///   - [`reason(Option<String>)`](crate::input::StopTaskInput::reason): <p>An optional message specified when a task is stopped. For example, if you're using a custom scheduler, you can use this parameter to specify the reason for stopping the task here, and the message appears in subsequent <code>DescribeTasks</code> API operations on this task. Up to 255 characters are allowed in this message.</p>
    ...
    ///
    /// - Takes [`SubmitAttachmentStateChangesInput`](crate::input::SubmitAttachmentStateChangesInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::SubmitAttachmentStateChangesInput::cluster): <p>The short name or full ARN of the cluster that hosts the container instance the attachment belongs to.</p>
    ///   - [`attachments(Option<Vec<AttachmentStateChange>>)`](crate::input::SubmitAttachmentStateChangesInput::attachments): <p>Any attachments associated with the state change request.</p>
    ...
    ///
    /// - Takes [`SubmitContainerStateChangeInput`](crate::input::SubmitContainerStateChangeInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::SubmitContainerStateChangeInput::cluster): <p>The short name or full ARN of the cluster that hosts the container.</p>
    ///   - [`task(Option<String>)`](crate::input::SubmitContainerStateChangeInput::task): <p>The task ID or full Amazon Resource Name (ARN) of the task that hosts the container.</p>
    ///   - [`container_name(Option<String>)`](crate::input::SubmitContainerStateChangeInput::container_name): <p>The name of the container.</p>
    ///   - [`runtime_id(Option<String>)`](crate::input::SubmitContainerStateChangeInput::runtime_id): <p>The ID of the Docker container.</p>
    ///   - [`status(Option<String>)`](crate::input::SubmitContainerStateChangeInput::status): <p>The status of the state change request.</p>
    ///   - [`exit_code(Option<i32>)`](crate::input::SubmitContainerStateChangeInput::exit_code): <p>The exit code that's returned for the state change request.</p>
    ///   - [`reason(Option<String>)`](crate::input::SubmitContainerStateChangeInput::reason): <p>The reason for the state change request.</p>
    ///   - [`network_bindings(Option<Vec<NetworkBinding>>)`](crate::input::SubmitContainerStateChangeInput::network_bindings): <p>The network bindings of the container.</p>
    ...
    ///
    /// - Takes [`SubmitTaskStateChangeInput`](crate::input::SubmitTaskStateChangeInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::SubmitTaskStateChangeInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the task.</p>
    ///   - [`task(Option<String>)`](crate::input::SubmitTaskStateChangeInput::task): <p>The task ID or full ARN of the task in the state change request.</p>
    ///   - [`status(Option<String>)`](crate::input::SubmitTaskStateChangeInput::status): <p>The status of the state change request.</p>
    ///   - [`reason(Option<String>)`](crate::input::SubmitTaskStateChangeInput::reason): <p>The reason for the state change request.</p>
    ///   - [`containers(Option<Vec<ContainerStateChange>>)`](crate::input::SubmitTaskStateChangeInput::containers): <p>Any containers that's associated with the state change request.</p>
    ///   - [`attachments(Option<Vec<AttachmentStateChange>>)`](crate::input::SubmitTaskStateChangeInput::attachments): <p>Any attachments associated with the state change request.</p>
    ///   - [`managed_agents(Option<Vec<ManagedAgentStateChange>>)`](crate::input::SubmitTaskStateChangeInput::managed_agents): <p>The details for the managed agent that's associated with the task.</p>
    ///   - [`pull_started_at(Option<DateTime>)`](crate::input::SubmitTaskStateChangeInput::pull_started_at): <p>The Unix timestamp for the time when the container image pull started.</p>
    ///   - [`pull_stopped_at(Option<DateTime>)`](crate::input::SubmitTaskStateChangeInput::pull_stopped_at): <p>The Unix timestamp for the time when the container image pull completed.</p>
    ///   - [`execution_stopped_at(Option<DateTime>)`](crate::input::SubmitTaskStateChangeInput::execution_stopped_at): <p>The Unix timestamp for the time when the task execution stopped.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource to add tags to. Currently, the supported resources are Amazon ECS capacity providers, tasks, services, task definitions, clusters, and container instances.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource to delete tags from. Currently, the supported resources are Amazon ECS capacity providers, tasks, services, task definitions, clusters, and container instances.</p>
    ...
    ///
    /// - Takes [`UpdateCapacityProviderInput`](crate::input::UpdateCapacityProviderInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::UpdateCapacityProviderInput::name): <p>The name of the capacity provider to update.</p>
    ///   - [`auto_scaling_group_provider(Option<AutoScalingGroupProviderUpdate>)`](crate::input::UpdateCapacityProviderInput::auto_scaling_group_provider): <p>An object that represent the parameters to update for the Auto Scaling group capacity provider.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::UpdateClusterInput::cluster): <p>The name of the cluster to modify the settings for.</p>
    ///   - [`settings(Option<Vec<ClusterSetting>>)`](crate::input::UpdateClusterInput::settings): <p>The cluster settings for your cluster.</p>
    ///   - [`configuration(Option<ClusterConfiguration>)`](crate::input::UpdateClusterInput::configuration): <p>The execute command configuration for the cluster.</p>
    ...
    ///
    /// - Takes [`UpdateClusterSettingsInput`](crate::input::UpdateClusterSettingsInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::UpdateClusterSettingsInput::cluster): <p>The name of the cluster to modify the settings for.</p>
    ///   - [`settings(Option<Vec<ClusterSetting>>)`](crate::input::UpdateClusterSettingsInput::settings): <p>The setting to use by default for a cluster. This parameter is used to enable CloudWatch Container Insights for a cluster. If this value is specified, it overrides the <code>containerInsights</code> value set with <code>PutAccountSetting</code> or <code>PutAccountSettingDefault</code>.</p>
    ...
    ///
    /// - Takes [`UpdateContainerAgentInput`](crate::input::UpdateContainerAgentInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::UpdateContainerAgentInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that your container instance is running on. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container_instance(Option<String>)`](crate::input::UpdateContainerAgentInput::container_instance): <p>The container instance ID or full ARN entries for the container instance where you would like to update the Amazon ECS container agent.</p>
    ...
    ///
    /// - Takes [`UpdateContainerInstancesStateInput`](crate::input::UpdateContainerInstancesStateInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::UpdateContainerInstancesStateInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the container instance to update. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`container_instances(Option<Vec<String>>)`](crate::input::UpdateContainerInstancesStateInput::container_instances): <p>A list of up to 10 container instance IDs or full ARN entries.</p>
    ///   - [`status(Option<ContainerInstanceStatus>)`](crate::input::UpdateContainerInstancesStateInput::status): <p>The container instance state to update the container instance with. The only valid values for this action are <code>ACTIVE</code> and <code>DRAINING</code>. A container instance can only be updated to <code>DRAINING</code> status once it has reached an <code>ACTIVE</code> state. If a container instance is in <code>REGISTERING</code>, <code>DEREGISTERING</code>, or <code>REGISTRATION_FAILED</code> state you can describe the container instance but can't update the container instance state.</p>
    ...
    ///   - [`cluster(Option<String>)`](crate::input::UpdateServiceInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that your service runs on. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`service(Option<String>)`](crate::input::UpdateServiceInput::service): <p>The name of the service to update.</p>
    ///   - [`desired_count(Option<i32>)`](crate::input::UpdateServiceInput::desired_count): <p>The number of instantiations of the task to place and keep running in your service.</p>
    ///   - [`task_definition(Option<String>)`](crate::input::UpdateServiceInput::task_definition): <p>The <code>family</code> and <code>revision</code> (<code>family:revision</code>) or full ARN of the task definition to run in your service. If a <code>revision</code> is not specified, the latest <code>ACTIVE</code> revision is used. If you modify the task definition with <code>UpdateService</code>, Amazon ECS spawns a task with the new version of the task definition and then stops an old task after the new version is running.</p>
    ///   - [`capacity_provider_strategy(Option<Vec<CapacityProviderStrategyItem>>)`](crate::input::UpdateServiceInput::capacity_provider_strategy): <p>The capacity provider strategy to update the service to use.</p>  <p>if the service uses the default capacity provider strategy for the cluster, the service can be updated to use one or more capacity providers as opposed to the default capacity provider strategy. However, when a service is using a capacity provider strategy that's not the default capacity provider strategy, the service can't be updated to use the cluster's default capacity provider strategy.</p>  <p>A capacity provider strategy consists of one or more capacity providers along with the <code>base</code> and <code>weight</code> to assign to them. A capacity provider must be associated with the cluster to be used in a capacity provider strategy. The <code>PutClusterCapacityProviders</code> API is used to associate a capacity provider with a cluster. Only capacity providers with an <code>ACTIVE</code> or <code>UPDATING</code> status can be used.</p>  <p>If specifying a capacity provider that uses an Auto Scaling group, the capacity provider must already be created. New capacity providers can be created with the <code>CreateCapacityProvider</code> API operation.</p>  <p>To use a Fargate capacity provider, specify either the <code>FARGATE</code> or <code>FARGATE_SPOT</code> capacity providers. The Fargate capacity providers are available to all accounts and only need to be associated with a cluster to be used.</p>  <p>The <code>PutClusterCapacityProviders</code> API operation is used to update the list of available capacity providers for a cluster after the cluster is created.</p>  <p></p>
    ///   - [`deployment_configuration(Option<DeploymentConfiguration>)`](crate::input::UpdateServiceInput::deployment_configuration): <p>Optional deployment parameters that control how many tasks run during the deployment and the ordering of stopping and starting tasks.</p>
    ///   - [`network_configuration(Option<NetworkConfiguration>)`](crate::input::UpdateServiceInput::network_configuration): <p>An object representing the network configuration for the service.</p>
    ///   - [`placement_constraints(Option<Vec<PlacementConstraint>>)`](crate::input::UpdateServiceInput::placement_constraints): <p>An array of task placement constraint objects to update the service to use. If no value is specified, the existing placement constraints for the service will remain unchanged. If this value is specified, it will override any existing placement constraints defined for the service. To remove all existing placement constraints, specify an empty array.</p>  <p>You can specify a maximum of 10 constraints for each task. This limit includes constraints in the task definition and those specified at runtime.</p>
    ///   - [`placement_strategy(Option<Vec<PlacementStrategy>>)`](crate::input::UpdateServiceInput::placement_strategy): <p>The task placement strategy objects to update the service to use. If no value is specified, the existing placement strategy for the service will remain unchanged. If this value is specified, it will override the existing placement strategy defined for the service. To remove an existing placement strategy, specify an empty object.</p>  <p>You can specify a maximum of five strategy rules for each service.</p>
    ///   - [`platform_version(Option<String>)`](crate::input::UpdateServiceInput::platform_version): <p>The platform version that your tasks in the service run on. A platform version is only specified for tasks using the Fargate launch type. If a platform version is not specified, the <code>LATEST</code> platform version is used. For more information, see <a href="https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html">Fargate Platform Versions</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.</p>
    ///   - [`force_new_deployment(bool)`](crate::input::UpdateServiceInput::force_new_deployment): <p>Determines whether to force a new deployment of the service. By default, deployments aren't forced. You can use this option to start a new deployment with no service definition changes. For example, you can update a service's tasks to use a newer Docker image with the same image/tag combination (<code>my_image:latest</code>) or to roll Fargate tasks onto a newer platform version.</p>
    ///   - [`health_check_grace_period_seconds(Option<i32>)`](crate::input::UpdateServiceInput::health_check_grace_period_seconds): <p>The period of time, in seconds, that the Amazon ECS service scheduler ignores unhealthy Elastic Load Balancing target health checks after a task has first started. This is only valid if your service is configured to use a load balancer. If your service's tasks take a while to start and respond to Elastic Load Balancing health checks, you can specify a health check grace period of up to 2,147,483,647 seconds. During that time, the Amazon ECS service scheduler ignores the Elastic Load Balancing health check status. This grace period can prevent the ECS service scheduler from marking tasks as unhealthy and stopping them before they have time to come up.</p>
    ///   - [`enable_execute_command(Option<bool>)`](crate::input::UpdateServiceInput::enable_execute_command): <p>If <code>true</code>, this enables execute command functionality on all task containers.</p>  <p>If you do not want to override the value that was set when the service was created, you can set this to <code>null</code> when performing this action.</p>
    ...
    ///
    /// - Takes [`UpdateServicePrimaryTaskSetInput`](crate::input::UpdateServicePrimaryTaskSetInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::UpdateServicePrimaryTaskSetInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task set exists in.</p>
    ///   - [`service(Option<String>)`](crate::input::UpdateServicePrimaryTaskSetInput::service): <p>The short name or full Amazon Resource Name (ARN) of the service that the task set exists in.</p>
    ///   - [`primary_task_set(Option<String>)`](crate::input::UpdateServicePrimaryTaskSetInput::primary_task_set): <p>The short name or full Amazon Resource Name (ARN) of the task set to set as the primary task set in the deployment.</p>
    /// - On success, responds with [`UpdateServicePrimaryTaskSetOutput`](crate::output::UpdateServicePrimaryTaskSetOutput) with field(s):
    ///   - [`task_set(Option<TaskSet>)`](crate::output::UpdateServicePrimaryTaskSetOutput::task_set): <p>Details about the task set.</p>
    ...
    ///
    /// - Takes [`UpdateTaskSetInput`](crate::input::UpdateTaskSetInput) with field(s):
    ///   - [`cluster(Option<String>)`](crate::input::UpdateTaskSetInput::cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service that the task set is found in.</p>
    ///   - [`service(Option<String>)`](crate::input::UpdateTaskSetInput::service): <p>The short name or full Amazon Resource Name (ARN) of the service that the task set is found in.</p>
    ///   - [`task_set(Option<String>)`](crate::input::UpdateTaskSetInput::task_set): <p>The short name or full Amazon Resource Name (ARN) of the task set to update.</p>
    ///   - [`scale(Option<Scale>)`](crate::input::UpdateTaskSetInput::scale): <p>A floating-point percentage of the desired number of tasks to place and keep running in the task set.</p>
