...
pub fn ser_create_container_service_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateContainerServiceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
