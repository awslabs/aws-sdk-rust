...
pub fn ser_instance_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
