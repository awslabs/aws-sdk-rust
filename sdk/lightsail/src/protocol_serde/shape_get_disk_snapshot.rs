...
pub fn de_get_disk_snapshot_http_error(
    ...
    Err(match error_code {
        ...
        "AccountSetupInProgressException" => {
            crate::error::GetDiskSnapshotError::AccountSetupInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "OperationFailureException" => {
            crate::error::GetDiskSnapshotError::OperationFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::error::GetDiskSnapshotError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthenticatedException" => {
            crate::error::GetDiskSnapshotError::UnauthenticatedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
