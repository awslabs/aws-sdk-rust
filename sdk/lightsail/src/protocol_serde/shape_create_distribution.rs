...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_distribution::de_create_distribution(_response_body, output)
            .map_err(crate::operation::create_distribution::CreateDistributionError::unhandled)?;
...
) -> Result<crate::operation::create_distribution::builders::CreateDistributionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
