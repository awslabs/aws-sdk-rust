...
pub fn ser_get_bucket_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_bucket_metric_data::GetBucketMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
