...
pub fn ser_get_bucket_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetBucketMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
