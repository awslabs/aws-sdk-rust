...
pub(crate) fn de_container_service_power<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ContainerServicePower>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
