...
pub fn ser_get_cost_estimate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_cost_estimate::GetCostEstimateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
