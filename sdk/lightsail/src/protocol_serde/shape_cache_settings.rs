...
pub fn ser_cache_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CacheSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cache_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CacheSettings>, aws_smithy_json::deserialize::error::DeserializeError>
