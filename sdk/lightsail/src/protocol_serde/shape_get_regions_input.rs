...
pub fn ser_get_regions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetRegionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
