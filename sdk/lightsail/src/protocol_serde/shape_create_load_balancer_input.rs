...
pub fn ser_create_load_balancer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLoadBalancerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
