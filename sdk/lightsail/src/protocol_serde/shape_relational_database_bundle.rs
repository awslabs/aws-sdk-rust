...
pub(crate) fn de_relational_database_bundle<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RelationalDatabaseBundle>, aws_smithy_json::deserialize::error::DeserializeError>
