...
pub fn ser_delete_domain_entry_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_domain_entry::DeleteDomainEntryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
