...
pub fn ser_get_container_log_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetContainerLogInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
