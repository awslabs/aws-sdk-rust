...
pub fn ser_create_distribution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDistributionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
