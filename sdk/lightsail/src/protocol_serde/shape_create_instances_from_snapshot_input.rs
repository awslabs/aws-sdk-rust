...
pub fn ser_create_instances_from_snapshot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateInstancesFromSnapshotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
