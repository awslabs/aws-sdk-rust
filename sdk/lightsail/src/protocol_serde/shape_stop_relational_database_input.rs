...
pub fn ser_stop_relational_database_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopRelationalDatabaseInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
