...
pub fn ser_get_instance_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_instance_metric_data::GetInstanceMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
