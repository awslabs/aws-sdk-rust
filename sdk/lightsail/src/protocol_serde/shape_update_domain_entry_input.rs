...
pub fn ser_update_domain_entry_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDomainEntryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
