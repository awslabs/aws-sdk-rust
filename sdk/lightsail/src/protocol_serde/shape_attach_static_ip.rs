...
pub fn de_attach_static_ip_http_error(
    ...
    Err(match error_code {
        ...
        "AccountSetupInProgressException" => {
            crate::error::AttachStaticIpError::AccountSetupInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "OperationFailureException" => {
            crate::error::AttachStaticIpError::OperationFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::error::AttachStaticIpError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthenticatedException" => {
            crate::error::AttachStaticIpError::UnauthenticatedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub(crate) fn de_attach_static_ip(
    ...
    crate::output::attach_static_ip_output::Builder,
