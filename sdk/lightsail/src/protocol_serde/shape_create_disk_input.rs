...
pub fn ser_create_disk_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDiskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
