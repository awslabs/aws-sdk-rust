...
pub fn ser_create_relational_database_snapshot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRelationalDatabaseSnapshotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
