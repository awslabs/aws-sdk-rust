...
pub fn ser_set_resource_access_for_bucket_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetResourceAccessForBucketInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
