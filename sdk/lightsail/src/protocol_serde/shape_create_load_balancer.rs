...
> {
    ...
    Err(match error_code {
        ...
        "AccountSetupInProgressException" => {
            crate::error::CreateLoadBalancerError::AccountSetupInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "OperationFailureException" => {
            crate::error::CreateLoadBalancerError::OperationFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::error::CreateLoadBalancerError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthenticatedException" => {
            crate::error::CreateLoadBalancerError::UnauthenticatedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
