...
pub fn ser_get_relational_database_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_relational_database_metric_data::GetRelationalDatabaseMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
