...
pub fn ser_get_container_service_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetContainerServiceMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
