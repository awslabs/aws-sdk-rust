...
pub(crate) fn de_relational_database<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RelationalDatabase>, aws_smithy_json::deserialize::error::DeserializeError>
