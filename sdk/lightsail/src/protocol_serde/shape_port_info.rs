...
pub fn ser_port_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PortInfo) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
