...
pub fn de_get_load_balancer_metric_data_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_load_balancer_metric_data_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError> {
    Ok({
        #[allow(unused_mut)]
