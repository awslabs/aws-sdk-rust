...
> {
    ...
    Err(match error_code {
        ...
        "AccountSetupInProgressException" => {
            crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError::AccountSetupInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data(_response_body, output)
            .map_err(crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError::unhandled)?;
...
pub(crate) fn de_get_load_balancer_metric_data(
    value: &[u8],
    mut builder: crate::operation::get_load_balancer_metric_data::builders::GetLoadBalancerMetricDataOutputBuilder,
) -> Result<
    crate::operation::get_load_balancer_metric_data::builders::GetLoadBalancerMetricDataOutputBuilder,
                ...
                "metricName" => {
                    builder = builder.set_metric_name(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::LoadBalancerMetricName::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "metricData" => {
