...
pub fn ser_endpoint_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EndpointRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
