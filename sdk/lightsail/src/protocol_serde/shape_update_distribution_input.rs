...
pub fn ser_update_distribution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_distribution::UpdateDistributionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
