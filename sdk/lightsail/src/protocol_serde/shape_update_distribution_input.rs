...
pub fn ser_update_distribution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDistributionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
