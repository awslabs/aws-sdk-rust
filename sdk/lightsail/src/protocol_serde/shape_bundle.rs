...
) -> Result<Option<crate::types::Bundle>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "supportedPlatforms" => {
                            builder = builder
                                .set_supported_platforms(crate::protocol_serde::shape_instance_platform_list::de_instance_platform_list(tokens)?);
                        }
