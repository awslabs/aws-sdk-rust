...
pub fn de_set_resource_access_for_bucket_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput, crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_resource_access_for_bucket_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput, crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError> {
    Ok({
        #[allow(unused_mut)]
