        ...
        Some(::aws_smithy_json::deserialize::Token::StartArray { .. }) => {
            ...
            loop {
                match tokens.peek() {
                    ...
                    _ => {
                        let value =
                            crate::protocol_serde::shape_load_balancer_tls_certificate_domain_validation_option::de_load_balancer_tls_certificate_domain_validation_option(tokens, _value)?
                        ;
