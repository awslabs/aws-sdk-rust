...
pub fn de_get_container_service_powers_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_container_service_powers::GetContainerServicePowersOutput, crate::operation::get_container_service_powers::GetContainerServicePowersError> {
    #[allow(unused_mut)]
...
pub fn ser_get_container_service_powers_input(_input: &crate::operation::get_container_service_powers::GetContainerServicePowersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
