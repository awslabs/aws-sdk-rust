...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::error::GetContainerServicePowersError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => {
            crate::error::GetContainerServicePowersError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceException" => {
            crate::error::GetContainerServicePowersError::ServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthenticatedException" => {
            crate::error::GetContainerServicePowersError::UnauthenticatedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
