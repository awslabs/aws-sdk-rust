...
pub(crate) fn de_contact_method<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContactMethod>, aws_smithy_json::deserialize::error::DeserializeError>
