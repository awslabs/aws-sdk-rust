...
pub(crate) fn de_lightsail_distribution<'a, I>(
    ...
    Option<crate::types::LightsailDistribution>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "defaultCacheBehavior" => {
                                builder = builder.set_default_cache_behavior(
                                    crate::protocol_serde::shape_cache_behavior::de_cache_behavior(
                                        tokens,
                                    )?,
                                );
                            }
                            "cacheBehaviorSettings" => {
                                builder = builder.set_cache_behavior_settings(
                                    crate::protocol_serde::shape_cache_settings::de_cache_settings(
                                        tokens,
                                    )?,
                                );
                            }
