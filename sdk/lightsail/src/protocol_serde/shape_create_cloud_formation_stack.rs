...
pub fn ser_create_cloud_formation_stack_input(input: &crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
