...
) -> Result<Option<crate::types::ContainerService>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "power" => {
                            builder = builder.set_power(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ContainerServicePowerName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "powerId" => {
                        ...
                        "state" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ContainerServiceState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "stateDetail" => {
