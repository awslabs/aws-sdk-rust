...
pub fn ser_get_alarms_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAlarmsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
