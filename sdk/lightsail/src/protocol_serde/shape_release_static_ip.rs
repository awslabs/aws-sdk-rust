...
pub fn de_release_static_ip_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_release_static_ip::de_release_static_ip(_response_body, output)
            .map_err(crate::operation::release_static_ip::ReleaseStaticIpError::unhandled)?;
...
) -> Result<crate::operation::release_static_ip::builders::ReleaseStaticIpOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
