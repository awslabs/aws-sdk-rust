...
pub fn de_release_static_ip_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::release_static_ip::ReleaseStaticIpOutput, crate::operation::release_static_ip::ReleaseStaticIpError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::release_static_ip::ReleaseStaticIpError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_release_static_ip_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::release_static_ip::ReleaseStaticIpOutput, crate::operation::release_static_ip::ReleaseStaticIpError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::release_static_ip::builders::ReleaseStaticIpOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_release_static_ip::de_release_static_ip(response.body().as_ref(), output).map_err(crate::operation::release_static_ip::ReleaseStaticIpError::unhandled)?;
