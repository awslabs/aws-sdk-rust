...
pub fn ser_get_load_balancer_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetLoadBalancerMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
