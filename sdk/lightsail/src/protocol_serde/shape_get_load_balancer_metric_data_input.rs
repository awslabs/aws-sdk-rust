...
pub fn ser_get_load_balancer_metric_data_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
