...
pub fn ser_create_domain_entry_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_domain_entry::CreateDomainEntryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
