...
pub fn ser_create_domain_entry_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDomainEntryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
