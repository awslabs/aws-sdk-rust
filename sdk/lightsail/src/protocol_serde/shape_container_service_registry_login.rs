...
pub(crate) fn de_container_service_registry_login<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ContainerServiceRegistryLogin>, aws_smithy_json::deserialize::error::DeserializeError>
