...
impl CreateLoadBalancer {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "CreateLoadBalancer", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLoadBalancerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("certificateDomainName") {
            if let ::std::option::Option::Some(value) = input.certificate_domain_name.as_deref() {
                captured.insert("certificateDomainName", value);
            }
        }
        if requested.should_capture("tlsPolicyName") {
            if let ::std::option::Option::Some(value) = input.tls_policy_name.as_deref() {
                captured.insert("tlsPolicyName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoadBalancerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_load_balancer::ser_create_load_balancer_input(&input)?);
...
impl CreateLoadBalancerError {
    ...
    /// Returns `true` if the error kind is `CreateLoadBalancerError::RegionSetupInProgressException`.
