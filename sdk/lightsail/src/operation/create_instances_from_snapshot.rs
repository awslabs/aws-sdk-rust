...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInstancesFromSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_instances_from_snapshot::de_create_instances_from_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateInstancesFromSnapshotError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshotError
{
