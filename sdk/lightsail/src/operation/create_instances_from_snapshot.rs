...
impl CreateInstancesFromSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInstancesFromSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_instances_from_snapshot::de_create_instances_from_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
