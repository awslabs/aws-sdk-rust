...
impl CreateInstancesFromSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CreateInstancesFromSnapshot`](crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_instances_from_snapshot::ser_create_instances_from_snapshot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateInstancesFromSnapshot", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateInstancesFromSnapshot {
                type Output = std::result::Result<crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshotOutput, crate::operation::create_instances_from_snapshot::CreateInstancesFromSnapshotError>;
