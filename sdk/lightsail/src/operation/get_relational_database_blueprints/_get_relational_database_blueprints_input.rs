...
impl GetRelationalDatabaseBlueprintsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsInput, ::aws_smithy_types::error::operation::BuildError> {
