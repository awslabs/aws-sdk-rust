...
impl DeleteContactMethodInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_contact_method::ser_delete_contact_method_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_contact_method::DeleteContactMethod::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContactMethod {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_contact_method::de_delete_contact_method_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_contact_method::DeleteContactMethodError
{
