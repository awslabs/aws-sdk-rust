...
/// Orchestration and serialization glue logic for `DeleteContactMethod`.
...
impl DeleteContactMethod {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_contact_method::DeleteContactMethodInput,
                    ) -> ::std::result::Result<crate::operation::delete_contact_method::DeleteContactMethodOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_contact_method::DeleteContactMethodError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_contact_method::DeleteContactMethodError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_contact_method::DeleteContactMethodOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteContactMethod {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteContactMethod");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteContactMethodRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteContactMethodResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteContactMethod")
...
.with_interceptor(DeleteContactMethodEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_contact_method::DeleteContactMethodError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_contact_method::DeleteContactMethodError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_contact_method::DeleteContactMethodError>::new());
...
#[derive(Debug)]
            struct DeleteContactMethodResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteContactMethodResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_contact_method::de_delete_contact_method_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_contact_method::de_delete_contact_method_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteContactMethodRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteContactMethodRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_contact_method::DeleteContactMethodInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_contact_method::DeleteContactMethodInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_contact_method::ser_delete_contact_method_input(&input)?);
...
#[derive(Debug)]
            struct DeleteContactMethodEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteContactMethodEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteContactMethodEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteContactMethodInput>()
                        .ok_or("failed to downcast to DeleteContactMethodInput")?;
...
pub enum DeleteContactMethodError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteContactMethodError) for what information is available for the error.")]
...
impl DeleteContactMethodError {
    /// Creates the `DeleteContactMethodError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteContactMethodError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteContactMethodError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_contact_method::DeleteContactMethodError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_contact_method::_delete_contact_method_output::DeleteContactMethodOutput;

pub use crate::operation::delete_contact_method::_delete_contact_method_input::DeleteContactMethodInput;

mod _delete_contact_method_input;

mod _delete_contact_method_output;
