...
impl DeleteContactMethodInput {
    /// Consumes the builder and constructs an Operation<[`DeleteContactMethod`](crate::operation::delete_contact_method::DeleteContactMethod)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_contact_method::DeleteContactMethod, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_contact_method::DeleteContactMethodInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_contact_method::ser_delete_contact_method_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_contact_method::DeleteContactMethod::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteContactMethod", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteContactMethod`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteContactMethod {
                type Output = std::result::Result<crate::operation::delete_contact_method::DeleteContactMethodOutput, crate::operation::delete_contact_method::DeleteContactMethodError>;
