...
impl GetRegionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_regions::GetRegions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_regions::ser_get_regions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRegions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_regions::de_get_regions_http_response_with_props(status, headers, body)
        }
    }
}
