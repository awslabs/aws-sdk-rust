...
impl GetBucketsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_buckets::GetBuckets::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetBuckets {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_buckets::de_get_buckets_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_buckets::de_get_buckets_http_response_with_props(
                status, headers, body,
            )
        }
    }
