...
impl GetBundlesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_bundles::GetBundles, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_bundles::ser_get_bundles_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBundles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bundles::de_get_bundles_http_response_with_props(status, headers, body)
        }
    }
}
