...
impl GetBundlesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bundles::GetBundles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBundles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bundles::de_get_bundles_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_bundles::de_get_bundles_http_response_with_props(
                status, headers, body,
            )
        }
    }
