...
impl ReleaseStaticIp {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::release_static_ip::ReleaseStaticIpError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::release_static_ip::ReleaseStaticIpOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "ReleaseStaticIp", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.ReleaseStaticIp",
                "rpc.service" = "Lightsail",
                "rpc.method" = "ReleaseStaticIp",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseStaticIp {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ReleaseStaticIpRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ReleaseStaticIpResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ReleaseStaticIp")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseStaticIp")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ReleaseStaticIpTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ReleaseStaticIpTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReleaseStaticIpTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ReleaseStaticIpInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("staticIpName") {
            if let ::std::option::Option::Some(value) = input.static_ip_name.as_deref() {
                captured.insert("staticIpName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReleaseStaticIpResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReleaseStaticIpRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::release_static_ip::ReleaseStaticIpInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::release_static_ip::ReleaseStaticIpInput,
...
impl ReleaseStaticIpError {
    ...
    /// Returns `true` if the error kind is `ReleaseStaticIpError::RegionSetupInProgressException`.
