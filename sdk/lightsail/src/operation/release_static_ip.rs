...
impl ReleaseStaticIpInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::release_static_ip::ReleaseStaticIp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_release_static_ip::ser_release_static_ip_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReleaseStaticIp {
    type Output =
        ::std::result::Result<crate::operation::release_static_ip::ReleaseStaticIpOutput, crate::operation::release_static_ip::ReleaseStaticIpError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_response_with_props(status, headers, body)
        }
    }
}
