...
impl ReleaseStaticIpInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::release_static_ip::ReleaseStaticIp,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::release_static_ip::ReleaseStaticIp::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ReleaseStaticIp {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_error(
                status, headers, body,
            )
        } else {
