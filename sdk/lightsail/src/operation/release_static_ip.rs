...
impl ReleaseStaticIpInput {
    /// Consumes the builder and constructs an Operation<[`ReleaseStaticIp`](crate::operation::release_static_ip::ReleaseStaticIp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::release_static_ip::ReleaseStaticIp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::release_static_ip::ReleaseStaticIpInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_release_static_ip::ser_release_static_ip_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::release_static_ip::ReleaseStaticIp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ReleaseStaticIp", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ReleaseStaticIp`.
...
impl aws_smithy_http::response::ParseStrictResponse for ReleaseStaticIp {
                type Output = std::result::Result<crate::operation::release_static_ip::ReleaseStaticIpOutput, crate::operation::release_static_ip::ReleaseStaticIpError>;
