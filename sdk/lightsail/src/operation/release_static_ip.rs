...
/// Orchestration and serialization glue logic for `ReleaseStaticIp`.
...
impl ReleaseStaticIp {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::release_static_ip::ReleaseStaticIpOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::release_static_ip::ReleaseStaticIpError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::release_static_ip::ReleaseStaticIpError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::release_static_ip::ReleaseStaticIpOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseStaticIp {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ReleaseStaticIp");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ReleaseStaticIpRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ReleaseStaticIpResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseStaticIp")
...
.with_interceptor(ReleaseStaticIpEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::release_static_ip::ReleaseStaticIpError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::release_static_ip::ReleaseStaticIpError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::release_static_ip::ReleaseStaticIpError>::new());
...
#[derive(Debug)]
            struct ReleaseStaticIpResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReleaseStaticIpResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_release_static_ip::de_release_static_ip_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ReleaseStaticIpRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReleaseStaticIpRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::release_static_ip::ReleaseStaticIpInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::release_static_ip::ReleaseStaticIpInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_release_static_ip::ser_release_static_ip_input(&input)?);
...
#[derive(Debug)]
            struct ReleaseStaticIpEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReleaseStaticIpEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ReleaseStaticIpEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ReleaseStaticIpInput>()
                        .ok_or("failed to downcast to ReleaseStaticIpInput")?;
...
pub enum ReleaseStaticIpError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ReleaseStaticIpError) for what information is available for the error.")]
...
impl ReleaseStaticIpError {
    /// Creates the `ReleaseStaticIpError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReleaseStaticIpError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ReleaseStaticIpError {
...
impl ::aws_types::request_id::RequestId for crate::operation::release_static_ip::ReleaseStaticIpError {
