...
impl crate::operation::delete_bucket_access_key::builders::DeleteBucketAccessKeyInputBuilder {
...
/// <p>For more information about access keys, see <a href="https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-creating-bucket-access-keys">Creating access keys for a bucket in Amazon Lightsail</a> in the <i>Amazon Lightsail Developer Guide</i>.</p>
...
impl DeleteBucketAccessKeyFluentBuilder {
    /// Creates a new `DeleteBucketAccessKeyFluentBuilder`.
