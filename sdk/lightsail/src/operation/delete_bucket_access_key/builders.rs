...
impl DeleteBucketAccessKeyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyOutput, crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyError, Self> {
