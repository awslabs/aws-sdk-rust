...
impl GetOperationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_operations::GetOperations, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_operations::ser_get_operations_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOperations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_operations::de_get_operations_http_response_with_props(status, headers, body)
        }
    }
}
