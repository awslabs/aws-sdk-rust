...
impl GetBlueprintsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_blueprints::GetBlueprints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlueprints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_blueprints::de_get_blueprints_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_blueprints::de_get_blueprints_http_response_with_props(
                status, headers, body,
            )
        }
    }
