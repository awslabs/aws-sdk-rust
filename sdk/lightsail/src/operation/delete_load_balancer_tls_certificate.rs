...
impl DeleteLoadBalancerTlsCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancerTlsCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_load_balancer_tls_certificate::de_delete_load_balancer_tls_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
