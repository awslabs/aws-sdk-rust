...
impl DeleteDistributionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDistribution`](crate::operation::delete_distribution::DeleteDistribution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_distribution::DeleteDistribution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_distribution::DeleteDistributionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_distribution::ser_delete_distribution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_distribution::DeleteDistribution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDistribution", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDistribution {
                type Output = std::result::Result<crate::operation::delete_distribution::DeleteDistributionOutput, crate::operation::delete_distribution::DeleteDistributionError>;
