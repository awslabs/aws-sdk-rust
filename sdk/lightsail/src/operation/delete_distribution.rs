...
impl DeleteDistributionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_distribution::ser_delete_distribution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_distribution::de_delete_distribution_http_response_with_props(status, headers, body)
        }
    }
}
