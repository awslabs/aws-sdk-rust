...
impl GetKeyPairsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_key_pairs::GetKeyPairs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_key_pairs::ser_get_key_pairs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKeyPairs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_key_pairs::de_get_key_pairs_http_response_with_props(status, headers, body)
        }
    }
}
