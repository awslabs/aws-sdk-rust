...
impl CreateGuiSessionAccessDetailsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_gui_session_access_details::CreateGUISessionAccessDetails::new(
            ),
        )
...
/// `ParseStrictResponse` impl for `CreateGUISessionAccessDetails`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGUISessionAccessDetails {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_gui_session_access_details::de_create_gui_session_access_details_http_error(response)
        } else {
            crate::protocol_serde::shape_create_gui_session_access_details::de_create_gui_session_access_details_http_response(response)
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateGUISessionAccessDetailsError
{
...
impl aws_http::request_id::RequestId
    for crate::operation::create_gui_session_access_details::CreateGUISessionAccessDetailsError
{
