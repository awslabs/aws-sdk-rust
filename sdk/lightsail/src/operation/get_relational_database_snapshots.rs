...
impl GetRelationalDatabaseSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseSnapshots`](crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_snapshots::ser_get_relational_database_snapshots_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseSnapshots", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetRelationalDatabaseSnapshots`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseSnapshots {
                type Output = std::result::Result<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsOutput, crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError>;
