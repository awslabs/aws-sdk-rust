...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_snapshots::de_get_relational_database_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError
{
