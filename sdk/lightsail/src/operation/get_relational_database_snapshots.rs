...
/// Orchestration and serialization glue logic for `GetRelationalDatabaseSnapshots`.
...
impl GetRelationalDatabaseSnapshots {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsInput,
                    ) -> ::std::result::Result<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRelationalDatabaseSnapshots {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRelationalDatabaseSnapshots");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRelationalDatabaseSnapshotsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRelationalDatabaseSnapshotsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRelationalDatabaseSnapshots")
...
.with_interceptor(GetRelationalDatabaseSnapshotsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError>::new());
...
#[derive(Debug)]
            struct GetRelationalDatabaseSnapshotsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRelationalDatabaseSnapshotsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_relational_database_snapshots::de_get_relational_database_snapshots_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_relational_database_snapshots::de_get_relational_database_snapshots_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRelationalDatabaseSnapshotsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRelationalDatabaseSnapshotsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_relational_database_snapshots::ser_get_relational_database_snapshots_input(&input)?);
...
#[derive(Debug)]
            struct GetRelationalDatabaseSnapshotsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRelationalDatabaseSnapshotsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRelationalDatabaseSnapshotsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRelationalDatabaseSnapshotsInput>()
                        .ok_or("failed to downcast to GetRelationalDatabaseSnapshotsInput")?;
...
pub enum GetRelationalDatabaseSnapshotsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRelationalDatabaseSnapshotsError) for what information is available for the error.")]
...
impl GetRelationalDatabaseSnapshotsError {
    /// Creates the `GetRelationalDatabaseSnapshotsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRelationalDatabaseSnapshotsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetRelationalDatabaseSnapshotsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRelationalDatabaseSnapshotsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_relational_database_snapshots::_get_relational_database_snapshots_output::GetRelationalDatabaseSnapshotsOutput;

pub use crate::operation::get_relational_database_snapshots::_get_relational_database_snapshots_input::GetRelationalDatabaseSnapshotsInput;

mod _get_relational_database_snapshots_input;

mod _get_relational_database_snapshots_output;
