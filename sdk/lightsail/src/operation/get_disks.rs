...
impl GetDisksInput {
    /// Consumes the builder and constructs an Operation<[`GetDisks`](crate::operation::get_disks::GetDisks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_disks::GetDisks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_disks::GetDisksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_disks::ser_get_disks_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_disks::GetDisks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDisks", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDisks`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDisks {
                type Output = std::result::Result<crate::operation::get_disks::GetDisksOutput, crate::operation::get_disks::GetDisksError>;
