...
impl GetDisksInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_disks::GetDisks, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_disks::ser_get_disks_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDisks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_disks::de_get_disks_http_response_with_props(status, headers, body)
        }
    }
}
