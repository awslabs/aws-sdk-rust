...
impl DeleteCertificateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_certificate::ser_delete_certificate_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_certificate::DeleteCertificate::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteCertificate", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_certificate::de_delete_certificate_http_response_with_props(status, headers, body)
        }
    }
}
