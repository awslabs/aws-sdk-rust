...
impl DeleteRelationalDatabaseSnapshot {
    ...
    pub(crate) async fn orchestrate(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError,
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DeleteRelationalDatabaseSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRelationalDatabaseSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteRelationalDatabaseSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteRelationalDatabaseSnapshotResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteRelationalDatabaseSnapshot")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRelationalDatabaseSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteRelationalDatabaseSnapshotInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("relationalDatabaseSnapshotName") {
            if let ::std::option::Option::Some(value) = input.relational_database_snapshot_name.as_deref() {
                captured.insert("relationalDatabaseSnapshotName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRelationalDatabaseSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_relational_database_snapshot::de_delete_relational_database_snapshot_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_delete_relational_database_snapshot::de_delete_relational_database_snapshot_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRelationalDatabaseSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_relational_database_snapshot::ser_delete_relational_database_snapshot_input(&input)?,
        );
...
impl DeleteRelationalDatabaseSnapshotError {
    ...
    /// Returns `true` if the error kind is `DeleteRelationalDatabaseSnapshotError::RegionSetupInProgressException`.
