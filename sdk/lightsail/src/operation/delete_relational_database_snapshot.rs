...
/// Orchestration and serialization glue logic for `DeleteRelationalDatabaseSnapshot`.
...
impl DeleteRelationalDatabaseSnapshot {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotInput,
                    ) -> ::std::result::Result<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRelationalDatabaseSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteRelationalDatabaseSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteRelationalDatabaseSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteRelationalDatabaseSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRelationalDatabaseSnapshot")
...
.with_interceptor(DeleteRelationalDatabaseSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>::new());
...
#[derive(Debug)]
            struct DeleteRelationalDatabaseSnapshotResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRelationalDatabaseSnapshotResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteRelationalDatabaseSnapshotRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRelationalDatabaseSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_relational_database_snapshot::ser_delete_relational_database_snapshot_input(&input)?);
...
#[derive(Debug)]
            struct DeleteRelationalDatabaseSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRelationalDatabaseSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteRelationalDatabaseSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteRelationalDatabaseSnapshotInput>()
                        .ok_or("failed to downcast to DeleteRelationalDatabaseSnapshotInput")?;
...
pub enum DeleteRelationalDatabaseSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteRelationalDatabaseSnapshotError) for what information is available for the error.")]
...
impl DeleteRelationalDatabaseSnapshotError {
    /// Creates the `DeleteRelationalDatabaseSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteRelationalDatabaseSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteRelationalDatabaseSnapshotError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteRelationalDatabaseSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError {
...
mod _delete_relational_database_snapshot_output;
