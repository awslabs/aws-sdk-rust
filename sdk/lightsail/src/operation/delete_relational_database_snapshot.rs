...
impl DeleteRelationalDatabaseSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRelationalDatabaseSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_relational_database_snapshot::de_delete_relational_database_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
