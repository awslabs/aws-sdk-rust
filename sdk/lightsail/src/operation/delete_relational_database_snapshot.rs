...
impl DeleteRelationalDatabaseSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRelationalDatabaseSnapshot`](crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_relational_database_snapshot::ser_delete_relational_database_snapshot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRelationalDatabaseSnapshot", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteRelationalDatabaseSnapshot`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRelationalDatabaseSnapshot {
                type Output = std::result::Result<crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotOutput, crate::operation::delete_relational_database_snapshot::DeleteRelationalDatabaseSnapshotError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_relational_database_snapshot::de_delete_relational_database_snapshot_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_relational_database_snapshot::de_delete_relational_database_snapshot_http_response(response)
                     }
                }
            }
