...
impl StopGuiSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_gui_session::StopGUISession,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_gui_session::StopGUISession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopGUISession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_gui_session::de_stop_gui_session_http_error(
                status, headers, body,
            )
        } else {
