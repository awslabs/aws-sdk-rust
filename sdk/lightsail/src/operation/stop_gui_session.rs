...
impl StopGuiSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_gui_session::StopGUISession, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_gui_session::ser_stop_gui_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopGUISession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_gui_session::de_stop_gui_session_http_response_with_props(status, headers, body)
        }
    }
}
