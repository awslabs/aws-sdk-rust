...
impl CreateInstanceSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_instance_snapshot::CreateInstanceSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_instance_snapshot::CreateInstanceSnapshotOutput, crate::operation::create_instance_snapshot::CreateInstanceSnapshotError, Self> {
