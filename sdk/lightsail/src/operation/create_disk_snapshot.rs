...
impl CreateDiskSnapshotInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_disk_snapshot::ser_create_disk_snapshot_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_disk_snapshot::CreateDiskSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDiskSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_disk_snapshot::de_create_disk_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_disk_snapshot::CreateDiskSnapshotError
{
