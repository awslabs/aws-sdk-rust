...
impl CreateDiskSnapshotInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_disk_snapshot::ser_create_disk_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDiskSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_disk_snapshot::de_create_disk_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
