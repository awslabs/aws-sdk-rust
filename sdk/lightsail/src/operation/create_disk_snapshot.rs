...
impl CreateDiskSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CreateDiskSnapshot`](crate::operation::create_disk_snapshot::CreateDiskSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_disk_snapshot::CreateDiskSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_disk_snapshot::CreateDiskSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_disk_snapshot::ser_create_disk_snapshot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_disk_snapshot::CreateDiskSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDiskSnapshot", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `CreateDiskSnapshot`.
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDiskSnapshot {
                type Output = std::result::Result<crate::operation::create_disk_snapshot::CreateDiskSnapshotOutput, crate::operation::create_disk_snapshot::CreateDiskSnapshotError>;
