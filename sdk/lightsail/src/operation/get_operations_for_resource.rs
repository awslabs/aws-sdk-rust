...
impl GetOperationsForResource {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_operations_for_resource::GetOperationsForResourceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_operations_for_resource::GetOperationsForResourceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetOperationsForResource",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOperationsForResource {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetOperationsForResourceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetOperationsForResourceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetOperationsForResource")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOperationsForResource")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOperationsForResourceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetOperationsForResourceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOperationsForResourceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOperationsForResourceInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOperationsForResourceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_operations_for_resource::de_get_operations_for_resource_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_operations_for_resource::de_get_operations_for_resource_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOperationsForResourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_operations_for_resource::GetOperationsForResourceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_operations_for_resource::GetOperationsForResourceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_operations_for_resource::ser_get_operations_for_resource_input(&input)?,
        );
...
impl GetOperationsForResourceError {
    ...
    /// Returns `true` if the error kind is `GetOperationsForResourceError::RegionSetupInProgressException`.
