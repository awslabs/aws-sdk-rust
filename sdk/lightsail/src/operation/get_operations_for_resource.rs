...
impl GetOperationsForResourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_operations_for_resource::GetOperationsForResource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOperationsForResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_operations_for_resource::de_get_operations_for_resource_http_response_with_props(status, headers, body)
        }
    }
}
