...
impl UpdateRelationalDatabaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_relational_database::UpdateRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput, crate::operation::update_relational_database::UpdateRelationalDatabaseError, Self> {
