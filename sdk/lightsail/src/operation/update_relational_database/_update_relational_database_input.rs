...
impl UpdateRelationalDatabaseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_relational_database::UpdateRelationalDatabaseInput, ::aws_smithy_types::error::operation::BuildError> {
