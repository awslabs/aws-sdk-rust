...
impl GetInstanceMetricDataInput {
    /// Consumes the builder and constructs an Operation<[`GetInstanceMetricData`](crate::operation::get_instance_metric_data::GetInstanceMetricData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instance_metric_data::GetInstanceMetricData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instance_metric_data::GetInstanceMetricDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_metric_data::ser_get_instance_metric_data_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instance_metric_data::GetInstanceMetricData::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstanceMetricData", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstanceMetricData {
                type Output = std::result::Result<crate::operation::get_instance_metric_data::GetInstanceMetricDataOutput, crate::operation::get_instance_metric_data::GetInstanceMetricDataError>;
