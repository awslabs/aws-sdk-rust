...
/// Orchestration and serialization glue logic for `GetInstanceMetricData`.
...
impl GetInstanceMetricData {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_instance_metric_data::GetInstanceMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_instance_metric_data::GetInstanceMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_instance_metric_data::GetInstanceMetricDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_instance_metric_data::GetInstanceMetricDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstanceMetricData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetInstanceMetricData");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetInstanceMetricDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetInstanceMetricDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstanceMetricData")
...
.with_interceptor(GetInstanceMetricDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_instance_metric_data::GetInstanceMetricDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_instance_metric_data::GetInstanceMetricDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_instance_metric_data::GetInstanceMetricDataError>::new());
...
#[derive(Debug)]
            struct GetInstanceMetricDataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstanceMetricDataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_instance_metric_data::de_get_instance_metric_data_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetInstanceMetricDataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstanceMetricDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_instance_metric_data::GetInstanceMetricDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_instance_metric_data::GetInstanceMetricDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_instance_metric_data::ser_get_instance_metric_data_input(&input)?);
...
#[derive(Debug)]
            struct GetInstanceMetricDataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstanceMetricDataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetInstanceMetricDataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetInstanceMetricDataInput>()
                        .ok_or("failed to downcast to GetInstanceMetricDataInput")?;
...
pub enum GetInstanceMetricDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetInstanceMetricDataError) for what information is available for the error.")]
...
impl GetInstanceMetricDataError {
    /// Creates the `GetInstanceMetricDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetInstanceMetricDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetInstanceMetricDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_instance_metric_data::GetInstanceMetricDataError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_instance_metric_data::_get_instance_metric_data_output::GetInstanceMetricDataOutput;

pub use crate::operation::get_instance_metric_data::_get_instance_metric_data_input::GetInstanceMetricDataInput;

mod _get_instance_metric_data_input;

mod _get_instance_metric_data_output;
