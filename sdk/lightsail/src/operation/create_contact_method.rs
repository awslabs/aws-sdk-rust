...
impl CreateContactMethodInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_contact_method::ser_create_contact_method_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_contact_method::CreateContactMethod::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateContactMethod {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_contact_method::de_create_contact_method_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::create_contact_method::CreateContactMethodError
{
