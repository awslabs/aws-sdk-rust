...
impl CreateContactMethodInput {
    /// Consumes the builder and constructs an Operation<[`CreateContactMethod`](crate::operation::create_contact_method::CreateContactMethod)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_contact_method::CreateContactMethod, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_contact_method::CreateContactMethodInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_contact_method::ser_create_contact_method_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_contact_method::CreateContactMethod::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateContactMethod", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateContactMethod {
                type Output = std::result::Result<crate::operation::create_contact_method::CreateContactMethodOutput, crate::operation::create_contact_method::CreateContactMethodError>;
