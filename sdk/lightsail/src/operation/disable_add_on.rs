...
impl DisableAddOnInput {
    /// Consumes the builder and constructs an Operation<[`DisableAddOn`](crate::operation::disable_add_on::DisableAddOn)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disable_add_on::DisableAddOn, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_add_on::DisableAddOnInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_add_on::ser_disable_add_on_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disable_add_on::DisableAddOn::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DisableAddOn", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DisableAddOn`.
...
impl aws_smithy_http::response::ParseStrictResponse for DisableAddOn {
                type Output = std::result::Result<crate::operation::disable_add_on::DisableAddOnOutput, crate::operation::disable_add_on::DisableAddOnError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_disable_add_on::de_disable_add_on_http_error(response)
                     } else {
                        crate::protocol_serde::shape_disable_add_on::de_disable_add_on_http_response(response)
                     }
                }
            }
