...
impl DisableAddOnInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::disable_add_on::DisableAddOn, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disable_add_on::ser_disable_add_on_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableAddOn {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_add_on::de_disable_add_on_http_response_with_props(status, headers, body)
        }
    }
}
