...
impl GetContainerServicePowersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_container_service_powers::GetContainerServicePowersInput, ::aws_smithy_types::error::operation::BuildError> {
