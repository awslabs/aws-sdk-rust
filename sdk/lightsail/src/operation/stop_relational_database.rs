...
impl StopRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`StopRelationalDatabase`](crate::operation::stop_relational_database::StopRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_relational_database::StopRelationalDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_relational_database::StopRelationalDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_relational_database::ser_stop_relational_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_relational_database::StopRelationalDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopRelationalDatabase", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopRelationalDatabase {
                type Output = std::result::Result<crate::operation::stop_relational_database::StopRelationalDatabaseOutput, crate::operation::stop_relational_database::StopRelationalDatabaseError>;
