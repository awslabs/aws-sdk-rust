...
impl StopRelationalDatabase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "StopRelationalDatabase", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.StopRelationalDatabase",
                "rpc.service" = "Lightsail",
                "rpc.method" = "StopRelationalDatabase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopRelationalDatabase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopRelationalDatabaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopRelationalDatabaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopRelationalDatabase")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopRelationalDatabase")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopRelationalDatabaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopRelationalDatabaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopRelationalDatabaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopRelationalDatabaseInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopRelationalDatabaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_stop_relational_database::de_stop_relational_database_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_relational_database::de_stop_relational_database_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopRelationalDatabaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_relational_database::StopRelationalDatabaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_stop_relational_database::ser_stop_relational_database_input(&input)?,
        );
...
impl StopRelationalDatabaseError {
    ...
    /// Returns `true` if the error kind is `StopRelationalDatabaseError::RegionSetupInProgressException`.
