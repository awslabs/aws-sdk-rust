...
/// Orchestration and serialization glue logic for `StopRelationalDatabase`.
...
impl StopRelationalDatabase {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::stop_relational_database::StopRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_relational_database::StopRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopRelationalDatabase {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StopRelationalDatabase");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StopRelationalDatabaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StopRelationalDatabaseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopRelationalDatabase")
...
.with_interceptor(StopRelationalDatabaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::stop_relational_database::StopRelationalDatabaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::stop_relational_database::StopRelationalDatabaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::stop_relational_database::StopRelationalDatabaseError>::new());
...
#[derive(Debug)]
            struct StopRelationalDatabaseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopRelationalDatabaseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_stop_relational_database::de_stop_relational_database_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_stop_relational_database::de_stop_relational_database_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StopRelationalDatabaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopRelationalDatabaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::stop_relational_database::StopRelationalDatabaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::stop_relational_database::StopRelationalDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_stop_relational_database::ser_stop_relational_database_input(&input)?);
...
#[derive(Debug)]
            struct StopRelationalDatabaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopRelationalDatabaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StopRelationalDatabaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StopRelationalDatabaseInput>()
                        .ok_or("failed to downcast to StopRelationalDatabaseInput")?;
...
pub enum StopRelationalDatabaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StopRelationalDatabaseError) for what information is available for the error.")]
...
impl StopRelationalDatabaseError {
    /// Creates the `StopRelationalDatabaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopRelationalDatabaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StopRelationalDatabaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::stop_relational_database::StopRelationalDatabaseError {
...
mod _stop_relational_database_output;
