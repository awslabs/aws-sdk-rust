...
impl GetCloudFormationStackRecordsFluentBuilder  {
    /// Creates a new `GetCloudFormationStackRecords`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsOutput, aws_smithy_http::result::SdkError<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>>
                     {
