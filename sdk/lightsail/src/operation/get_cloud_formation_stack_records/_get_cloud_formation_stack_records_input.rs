...
impl GetCloudFormationStackRecordsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput, ::aws_smithy_types::error::operation::BuildError> {
