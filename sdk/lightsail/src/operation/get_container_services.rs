...
impl GetContainerServicesInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerServices`](crate::operation::get_container_services::GetContainerServices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_container_services::GetContainerServices, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_services::GetContainerServicesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_container_services::GetContainerServicesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_1) = &_input.service_name {
                     {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_services::ser_get_container_services_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_services::GetContainerServices::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContainerServices", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetContainerServices {
                type Output = std::result::Result<crate::operation::get_container_services::GetContainerServicesOutput, crate::operation::get_container_services::GetContainerServicesError>;
