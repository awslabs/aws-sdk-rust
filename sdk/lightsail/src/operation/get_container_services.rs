...
impl GetContainerServicesInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_services::ser_get_container_services_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_container_services::GetContainerServices::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_container_services::GetContainerServicesError
{
