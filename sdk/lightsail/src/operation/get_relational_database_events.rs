...
impl GetRelationalDatabaseEventsInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseEvents`](crate::operation::get_relational_database_events::GetRelationalDatabaseEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_relational_database_events::GetRelationalDatabaseEvents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_events::GetRelationalDatabaseEventsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_events::ser_get_relational_database_events_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_events::GetRelationalDatabaseEvents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseEvents", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetRelationalDatabaseEvents`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseEvents {
                type Output = std::result::Result<crate::operation::get_relational_database_events::GetRelationalDatabaseEventsOutput, crate::operation::get_relational_database_events::GetRelationalDatabaseEventsError>;
