...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_events::de_get_relational_database_events_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetRelationalDatabaseEventsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_relational_database_events::GetRelationalDatabaseEventsError
{
