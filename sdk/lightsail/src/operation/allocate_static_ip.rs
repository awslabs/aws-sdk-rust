...
impl AllocateStaticIpInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_allocate_static_ip::ser_allocate_static_ip_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AllocateStaticIp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_response_with_props(status, headers, body)
        }
    }
}
