...
impl AllocateStaticIpInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::allocate_static_ip::AllocateStaticIp::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AllocateStaticIp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::allocate_static_ip::AllocateStaticIpError
{
