...
/// Orchestration and serialization glue logic for `AllocateStaticIp`.
...
impl AllocateStaticIp {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::allocate_static_ip::AllocateStaticIpOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::allocate_static_ip::AllocateStaticIpError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::allocate_static_ip::AllocateStaticIpError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::allocate_static_ip::AllocateStaticIpOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateStaticIp {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AllocateStaticIp");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AllocateStaticIpRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AllocateStaticIpResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateStaticIp")
...
.with_interceptor(AllocateStaticIpEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::allocate_static_ip::AllocateStaticIpError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::allocate_static_ip::AllocateStaticIpError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::allocate_static_ip::AllocateStaticIpError>::new());
...
#[derive(Debug)]
            struct AllocateStaticIpResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocateStaticIpResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AllocateStaticIpRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocateStaticIpRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::allocate_static_ip::AllocateStaticIpInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::allocate_static_ip::AllocateStaticIpInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_allocate_static_ip::ser_allocate_static_ip_input(&input)?);
...
#[derive(Debug)]
            struct AllocateStaticIpEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocateStaticIpEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AllocateStaticIpEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AllocateStaticIpInput>()
                        .ok_or("failed to downcast to AllocateStaticIpInput")?;
...
pub enum AllocateStaticIpError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AllocateStaticIpError) for what information is available for the error.")]
...
impl AllocateStaticIpError {
    /// Creates the `AllocateStaticIpError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AllocateStaticIpError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AllocateStaticIpError {
...
impl ::aws_types::request_id::RequestId for crate::operation::allocate_static_ip::AllocateStaticIpError {
...
mod _allocate_static_ip_output;
