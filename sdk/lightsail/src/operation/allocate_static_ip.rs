...
impl AllocateStaticIpInput {
    /// Consumes the builder and constructs an Operation<[`AllocateStaticIp`](crate::operation::allocate_static_ip::AllocateStaticIp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::allocate_static_ip::AllocateStaticIp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::allocate_static_ip::AllocateStaticIpInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_allocate_static_ip::ser_allocate_static_ip_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::allocate_static_ip::AllocateStaticIp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AllocateStaticIp", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AllocateStaticIp`.
...
impl aws_smithy_http::response::ParseStrictResponse for AllocateStaticIp {
                type Output = std::result::Result<crate::operation::allocate_static_ip::AllocateStaticIpOutput, crate::operation::allocate_static_ip::AllocateStaticIpError>;
