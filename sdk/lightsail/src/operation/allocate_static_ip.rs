...
impl AllocateStaticIp {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::allocate_static_ip::AllocateStaticIpError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::allocate_static_ip::AllocateStaticIpOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "AllocateStaticIp", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.AllocateStaticIp",
                "rpc.service" = "Lightsail",
                "rpc.method" = "AllocateStaticIp",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AllocateStaticIp {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AllocateStaticIpRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AllocateStaticIpResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AllocateStaticIp")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AllocateStaticIp")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AllocateStaticIpTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AllocateStaticIpTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AllocateStaticIpTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AllocateStaticIpInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AllocateStaticIpResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_allocate_static_ip::de_allocate_static_ip_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AllocateStaticIpRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::allocate_static_ip::AllocateStaticIpInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::allocate_static_ip::AllocateStaticIpInput,
...
impl AllocateStaticIpError {
    ...
    /// Returns `true` if the error kind is `AllocateStaticIpError::RegionSetupInProgressException`.
