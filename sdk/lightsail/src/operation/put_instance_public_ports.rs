...
impl PutInstancePublicPortsInput {
    /// Consumes the builder and constructs an Operation<[`PutInstancePublicPorts`](crate::operation::put_instance_public_ports::PutInstancePublicPorts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_instance_public_ports::PutInstancePublicPorts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_instance_public_ports::PutInstancePublicPortsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_instance_public_ports::ser_put_instance_public_ports_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_instance_public_ports::PutInstancePublicPorts::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutInstancePublicPorts", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutInstancePublicPorts {
                type Output = std::result::Result<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput, crate::operation::put_instance_public_ports::PutInstancePublicPortsError>;
