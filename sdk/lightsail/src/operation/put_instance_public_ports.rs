...
impl PutInstancePublicPorts {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "PutInstancePublicPorts", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.PutInstancePublicPorts",
                "rpc.service" = "Lightsail",
                "rpc.method" = "PutInstancePublicPorts",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutInstancePublicPorts {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutInstancePublicPortsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutInstancePublicPortsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutInstancePublicPorts")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutInstancePublicPorts")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutInstancePublicPortsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutInstancePublicPortsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutInstancePublicPortsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutInstancePublicPortsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutInstancePublicPortsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_instance_public_ports::de_put_instance_public_ports_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_instance_public_ports::de_put_instance_public_ports_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutInstancePublicPortsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_instance_public_ports::PutInstancePublicPortsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_instance_public_ports::ser_put_instance_public_ports_input(&input)?,
        );
