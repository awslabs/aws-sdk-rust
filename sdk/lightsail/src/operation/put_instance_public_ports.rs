...
/// Orchestration and serialization glue logic for `PutInstancePublicPorts`.
...
impl PutInstancePublicPorts {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_instance_public_ports::PutInstancePublicPortsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutInstancePublicPorts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutInstancePublicPorts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutInstancePublicPortsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutInstancePublicPortsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutInstancePublicPorts")
...
.with_interceptor(PutInstancePublicPortsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_instance_public_ports::PutInstancePublicPortsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_instance_public_ports::PutInstancePublicPortsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_instance_public_ports::PutInstancePublicPortsError>::new());
...
#[derive(Debug)]
            struct PutInstancePublicPortsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutInstancePublicPortsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_instance_public_ports::de_put_instance_public_ports_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_put_instance_public_ports::de_put_instance_public_ports_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PutInstancePublicPortsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutInstancePublicPortsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_instance_public_ports::PutInstancePublicPortsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_instance_public_ports::PutInstancePublicPortsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_instance_public_ports::ser_put_instance_public_ports_input(&input)?);
...
#[derive(Debug)]
            struct PutInstancePublicPortsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutInstancePublicPortsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutInstancePublicPortsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutInstancePublicPortsInput>()
                        .ok_or("failed to downcast to PutInstancePublicPortsInput")?;
...
pub enum PutInstancePublicPortsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutInstancePublicPortsError) for what information is available for the error.")]
...
impl PutInstancePublicPortsError {
    /// Creates the `PutInstancePublicPortsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutInstancePublicPortsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutInstancePublicPortsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_instance_public_ports::PutInstancePublicPortsError {
...
mod _put_instance_public_ports_output;
