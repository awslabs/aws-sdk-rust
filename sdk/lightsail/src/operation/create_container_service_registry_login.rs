...
impl CreateContainerServiceRegistryLogin {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginInput,
                    ) -> ::std::result::Result<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContainerServiceRegistryLogin {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateContainerServiceRegistryLogin");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateContainerServiceRegistryLoginRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateContainerServiceRegistryLoginResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateContainerServiceRegistryLogin")
...
.with_interceptor(CreateContainerServiceRegistryLoginEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError>::new());
...
#[derive(Debug)]
            struct CreateContainerServiceRegistryLoginResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContainerServiceRegistryLoginResponseDeserializer {
...
#[derive(Debug)]
            struct CreateContainerServiceRegistryLoginRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContainerServiceRegistryLoginRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_container_service_registry_login::ser_create_container_service_registry_login_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct CreateContainerServiceRegistryLoginEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContainerServiceRegistryLoginEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateContainerServiceRegistryLoginEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateContainerServiceRegistryLoginInput>()
                        .ok_or("failed to downcast to CreateContainerServiceRegistryLoginInput")?;
...
pub enum CreateContainerServiceRegistryLoginError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateContainerServiceRegistryLoginError) for what information is available for the error.")]
...
impl CreateContainerServiceRegistryLoginError {
    /// Creates the `CreateContainerServiceRegistryLoginError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateContainerServiceRegistryLoginError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateContainerServiceRegistryLoginError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateContainerServiceRegistryLoginError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError {
...
mod _create_container_service_registry_login_output;
