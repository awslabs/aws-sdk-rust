...
impl CreateContainerServiceRegistryLogin {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateContainerServiceRegistryLogin",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContainerServiceRegistryLogin {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateContainerServiceRegistryLoginRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateContainerServiceRegistryLoginResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateContainerServiceRegistryLogin")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContainerServiceRegistryLoginResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_container_service_registry_login::de_create_container_service_registry_login_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_container_service_registry_login::de_create_container_service_registry_login_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContainerServiceRegistryLoginRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_container_service_registry_login::CreateContainerServiceRegistryLoginInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_container_service_registry_login::ser_create_container_service_registry_login_input(&input)?,
        );
...
impl CreateContainerServiceRegistryLoginError {
    ...
    /// Returns `true` if the error kind is `CreateContainerServiceRegistryLoginError::RegionSetupInProgressException`.
