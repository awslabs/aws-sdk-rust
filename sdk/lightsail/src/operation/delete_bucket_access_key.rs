...
impl DeleteBucketAccessKeyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBucketAccessKey`](crate::operation::delete_bucket_access_key::DeleteBucketAccessKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_bucket_access_key::DeleteBucketAccessKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_bucket_access_key::ser_delete_bucket_access_key_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bucket_access_key::DeleteBucketAccessKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteBucketAccessKey", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteBucketAccessKey`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteBucketAccessKey {
                type Output = std::result::Result<crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyOutput, crate::operation::delete_bucket_access_key::DeleteBucketAccessKeyError>;
