...
impl GetInstancePortStatesInput {
    /// Consumes the builder and constructs an Operation<[`GetInstancePortStates`](crate::operation::get_instance_port_states::GetInstancePortStates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instance_port_states::GetInstancePortStates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instance_port_states::GetInstancePortStatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_port_states::ser_get_instance_port_states_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instance_port_states::GetInstancePortStates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstancePortStates", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetInstancePortStates`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstancePortStates {
                type Output = std::result::Result<crate::operation::get_instance_port_states::GetInstancePortStatesOutput, crate::operation::get_instance_port_states::GetInstancePortStatesError>;
