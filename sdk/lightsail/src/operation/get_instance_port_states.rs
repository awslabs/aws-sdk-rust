...
impl GetInstancePortStates {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_instance_port_states::GetInstancePortStatesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_instance_port_states::GetInstancePortStatesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetInstancePortStates", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetInstancePortStates",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetInstancePortStates",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstancePortStates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetInstancePortStatesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetInstancePortStatesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetInstancePortStates")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstancePortStates")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetInstancePortStatesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetInstancePortStatesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstancePortStatesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetInstancePortStatesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstancePortStatesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_instance_port_states::de_get_instance_port_states_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_instance_port_states::de_get_instance_port_states_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstancePortStatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_instance_port_states::GetInstancePortStatesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_instance_port_states::GetInstancePortStatesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_port_states::ser_get_instance_port_states_input(&input)?,
        );
...
impl GetInstancePortStatesError {
    ...
    /// Returns `true` if the error kind is `GetInstancePortStatesError::RegionSetupInProgressException`.
