...
impl GetContainerServicePowersInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerServicePowers`](crate::operation::get_container_service_powers::GetContainerServicePowers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_container_service_powers::GetContainerServicePowers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_service_powers::GetContainerServicePowersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_service_powers::ser_get_container_service_powers_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_service_powers::GetContainerServicePowers::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContainerServicePowers", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetContainerServicePowers {
                type Output = std::result::Result<crate::operation::get_container_service_powers::GetContainerServicePowersOutput, crate::operation::get_container_service_powers::GetContainerServicePowersError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_container_service_powers::de_get_container_service_powers_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_container_service_powers::de_get_container_service_powers_http_response(response)
                     }
                }
            }
