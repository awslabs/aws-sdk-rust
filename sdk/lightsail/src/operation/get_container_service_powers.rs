...
impl GetContainerServicePowers {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_container_service_powers::GetContainerServicePowersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_container_service_powers::GetContainerServicePowersOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetContainerServicePowers",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerServicePowers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetContainerServicePowersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetContainerServicePowersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetContainerServicePowers")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContainerServicePowersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_container_service_powers::de_get_container_service_powers_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_container_service_powers::de_get_container_service_powers_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContainerServicePowersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_container_service_powers::GetContainerServicePowersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_container_service_powers::GetContainerServicePowersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_service_powers::ser_get_container_service_powers_input(&input)?,
        );
...
impl GetContainerServicePowersError {
    ...
    /// Returns `true` if the error kind is `GetContainerServicePowersError::RegionSetupInProgressException`.
