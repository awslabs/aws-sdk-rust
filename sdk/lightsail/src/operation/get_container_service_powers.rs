...
impl GetContainerServicePowersInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_service_powers::GetContainerServicePowers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerServicePowers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_container_service_powers::de_get_container_service_powers_http_response_with_props(status, headers, body)
        }
    }
}
