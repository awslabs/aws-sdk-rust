...
impl GetInstanceStateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_instance_state::GetInstanceState,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_instance_state::ser_get_instance_state_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstanceState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instance_state::de_get_instance_state_http_response_with_props(status, headers, body)
        }
    }
}
