...
impl GetInstanceStateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_instance_state::GetInstanceState::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstanceState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_instance_state::de_get_instance_state_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_instance_state::GetInstanceStateError
{
