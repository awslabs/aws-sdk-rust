...
impl GetAutoSnapshotsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_auto_snapshots::ser_get_auto_snapshots_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAutoSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_auto_snapshots::de_get_auto_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
