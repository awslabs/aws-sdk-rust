...
impl GetAutoSnapshotsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_auto_snapshots::GetAutoSnapshots::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAutoSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_auto_snapshots::de_get_auto_snapshots_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_auto_snapshots::GetAutoSnapshotsError
{
