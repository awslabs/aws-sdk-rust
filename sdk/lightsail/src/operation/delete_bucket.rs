...
impl DeleteBucketInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_bucket::DeleteBucket, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_bucket::ser_delete_bucket_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBucket {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_bucket::de_delete_bucket_http_response_with_props(status, headers, body)
        }
    }
}
