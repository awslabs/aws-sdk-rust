...
impl CreateGUISessionAccessDetailsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_gui_session_access_details::CreateGuiSessionAccessDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_gui_session_access_details::CreateGUISessionAccessDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_gui_session_access_details::CreateGuiSessionAccessDetailsOutput, crate::operation::create_gui_session_access_details::CreateGUISessionAccessDetailsError, Self> {
