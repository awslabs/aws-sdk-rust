...
impl AttachCertificateToDistributionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::attach_certificate_to_distribution::AttachCertificateToDistributionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_certificate_to_distribution::AttachCertificateToDistributionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::attach_certificate_to_distribution::AttachCertificateToDistributionOutput, crate::operation::attach_certificate_to_distribution::AttachCertificateToDistributionError, Self> {
