...
impl CreateCloudFormationStackInput {
    /// Consumes the builder and constructs an Operation<[`CreateCloudFormationStack`](crate::operation::create_cloud_formation_stack::CreateCloudFormationStack)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_cloud_formation_stack::CreateCloudFormationStack, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_cloud_formation_stack::ser_create_cloud_formation_stack_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_cloud_formation_stack::CreateCloudFormationStack::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateCloudFormationStack", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateCloudFormationStack {
                type Output = std::result::Result<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackOutput, crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_response(response)
                     }
                }
            }
