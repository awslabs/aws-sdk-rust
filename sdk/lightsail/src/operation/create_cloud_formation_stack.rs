...
impl CreateCloudFormationStackInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cloud_formation_stack::CreateCloudFormationStack::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCloudFormationStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_response_with_props(status, headers, body)
        }
    }
}
