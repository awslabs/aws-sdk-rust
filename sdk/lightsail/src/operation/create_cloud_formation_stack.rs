...
impl CreateCloudFormationStack {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCloudFormationStack {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCloudFormationStack");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCloudFormationStackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCloudFormationStackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCloudFormationStack")
...
.with_interceptor(CreateCloudFormationStackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>::new());
...
#[derive(Debug)]
            struct CreateCloudFormationStackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCloudFormationStackResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateCloudFormationStackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCloudFormationStackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_cloud_formation_stack::ser_create_cloud_formation_stack_input(&input)?);
...
#[derive(Debug)]
            struct CreateCloudFormationStackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCloudFormationStackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCloudFormationStackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCloudFormationStackInput>()
                        .ok_or("failed to downcast to CreateCloudFormationStackInput")?;
...
pub enum CreateCloudFormationStackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCloudFormationStackError) for what information is available for the error.")]
...
impl CreateCloudFormationStackError {
    /// Creates the `CreateCloudFormationStackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCloudFormationStackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCloudFormationStackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_cloud_formation_stack::_create_cloud_formation_stack_output::CreateCloudFormationStackOutput;

pub use crate::operation::create_cloud_formation_stack::_create_cloud_formation_stack_input::CreateCloudFormationStackInput;

mod _create_cloud_formation_stack_input;

mod _create_cloud_formation_stack_output;
