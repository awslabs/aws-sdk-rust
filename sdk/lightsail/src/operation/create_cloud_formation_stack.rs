...
impl CreateCloudFormationStack {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateCloudFormationStack",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCloudFormationStack {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateCloudFormationStackRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateCloudFormationStackResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCloudFormationStackResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_cloud_formation_stack::de_create_cloud_formation_stack_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCloudFormationStackRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_cloud_formation_stack::ser_create_cloud_formation_stack_input(&input)?,
        );
...
impl CreateCloudFormationStackError {
    ...
    /// Returns `true` if the error kind is `CreateCloudFormationStackError::RegionSetupInProgressException`.
