...
impl SetIpAddressTypeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_ip_address_type::ser_set_ip_address_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIpAddressType {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_ip_address_type::de_set_ip_address_type_http_response_with_props(status, headers, body)
        }
    }
}
