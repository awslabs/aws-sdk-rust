...
impl SetIpAddressType {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_ip_address_type::SetIpAddressTypeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_ip_address_type::SetIpAddressTypeOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "SetIpAddressType", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.SetIpAddressType",
                "rpc.service" = "Lightsail",
                "rpc.method" = "SetIpAddressType",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIpAddressType {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetIpAddressTypeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetIpAddressTypeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetIpAddressType")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetIpAddressType")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetIpAddressTypeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetIpAddressTypeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetIpAddressTypeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetIpAddressTypeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetIpAddressTypeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_ip_address_type::de_set_ip_address_type_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_ip_address_type::de_set_ip_address_type_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetIpAddressTypeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_ip_address_type::SetIpAddressTypeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::set_ip_address_type::SetIpAddressTypeInput,
...
impl SetIpAddressTypeError {
    ...
    /// Returns `true` if the error kind is `SetIpAddressTypeError::RegionSetupInProgressException`.
