...
impl SetIpAddressTypeInput {
    /// Consumes the builder and constructs an Operation<[`SetIpAddressType`](crate::operation::set_ip_address_type::SetIpAddressType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_ip_address_type::SetIpAddressType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_ip_address_type::SetIpAddressTypeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_ip_address_type::ser_set_ip_address_type_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_ip_address_type::SetIpAddressType::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetIpAddressType", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetIpAddressType {
                type Output = std::result::Result<crate::operation::set_ip_address_type::SetIpAddressTypeOutput, crate::operation::set_ip_address_type::SetIpAddressTypeError>;
