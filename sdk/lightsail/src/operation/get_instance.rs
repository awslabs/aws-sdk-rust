...
impl GetInstanceInput {
    /// Consumes the builder and constructs an Operation<[`GetInstance`](crate::operation::get_instance::GetInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instance::GetInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instance::GetInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance::ser_get_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instance::GetInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstance", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstance {
                type Output = std::result::Result<crate::operation::get_instance::GetInstanceOutput, crate::operation::get_instance::GetInstanceError>;
