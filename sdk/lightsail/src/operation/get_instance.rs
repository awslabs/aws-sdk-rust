...
impl GetInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_instance::GetInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_instance::ser_get_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instance::de_get_instance_http_response_with_props(status, headers, body)
        }
    }
}
