...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachCertificateToDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_certificate_to_distribution::de_attach_certificate_to_distribution_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::attach_certificate_to_distribution::AttachCertificateToDistributionError
{
