...
impl AttachCertificateToDistributionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_certificate_to_distribution::AttachCertificateToDistribution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachCertificateToDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_certificate_to_distribution::de_attach_certificate_to_distribution_http_response_with_props(
                status, headers, body,
            )
        }
    }
