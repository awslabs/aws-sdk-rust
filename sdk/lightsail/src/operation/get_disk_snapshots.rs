...
impl GetDiskSnapshotsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_disk_snapshots::GetDiskSnapshots,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_disk_snapshots::ser_get_disk_snapshots_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDiskSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_disk_snapshots::de_get_disk_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
