...
impl GetDiskSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`GetDiskSnapshots`](crate::operation::get_disk_snapshots::GetDiskSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_disk_snapshots::GetDiskSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_disk_snapshots::GetDiskSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_disk_snapshots::ser_get_disk_snapshots_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_disk_snapshots::GetDiskSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDiskSnapshots", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDiskSnapshots {
                type Output = std::result::Result<crate::operation::get_disk_snapshots::GetDiskSnapshotsOutput, crate::operation::get_disk_snapshots::GetDiskSnapshotsError>;
