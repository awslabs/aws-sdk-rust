...
impl PeerVpcInput {
    /// Consumes the builder and constructs an Operation<[`PeerVpc`](crate::operation::peer_vpc::PeerVpc)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::peer_vpc::PeerVpc, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::peer_vpc::PeerVpcInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_peer_vpc::ser_peer_vpc_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::peer_vpc::PeerVpc::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PeerVpc", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for PeerVpc {
                type Output = std::result::Result<crate::operation::peer_vpc::PeerVpcOutput, crate::operation::peer_vpc::PeerVpcError>;
