...
impl PeerVpc {
    ...
    > {
        let map_err =
            |err: ::aws_smithy_runtime_api::client::result::SdkError<
                ...
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >| { err.map_service_error(|err| err.downcast::<crate::operation::peer_vpc::PeerVpcError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::peer_vpc::PeerVpcOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "PeerVpc", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PeerVpc {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PeerVpcRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PeerVpcResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PeerVpc")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("PeerVpc", "Lightsail"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PeerVpcResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_peer_vpc::de_peer_vpc_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_peer_vpc::de_peer_vpc_http_response(status, headers, body, _cfg)
        };
...
impl PeerVpcError {
    ...
    /// Returns `true` if the error kind is `PeerVpcError::RegionSetupInProgressException`.
