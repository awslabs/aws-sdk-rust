...
impl PeerVpcInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::peer_vpc::PeerVpc, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_peer_vpc::ser_peer_vpc_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PeerVpc {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_peer_vpc::de_peer_vpc_http_response_with_props(status, headers, body)
        }
    }
}
