...
impl RegisterContainerImageInput {
    /// Consumes the builder and constructs an Operation<[`RegisterContainerImage`](crate::operation::register_container_image::RegisterContainerImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_container_image::RegisterContainerImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_container_image::RegisterContainerImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_container_image::ser_register_container_image_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_container_image::RegisterContainerImage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterContainerImage", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `RegisterContainerImage`.
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterContainerImage {
                type Output = std::result::Result<crate::operation::register_container_image::RegisterContainerImageOutput, crate::operation::register_container_image::RegisterContainerImageError>;
