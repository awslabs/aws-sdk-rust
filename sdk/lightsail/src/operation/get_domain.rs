...
impl GetDomainInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_domain::ser_get_domain_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_domain::GetDomain::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDomain", "lightsail"));
