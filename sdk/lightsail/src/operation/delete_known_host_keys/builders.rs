...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_known_host_keys::DeleteKnownHostKeysOutput,
                    crate::operation::delete_known_host_keys::DeleteKnownHostKeysError,
                > for DeleteKnownHostKeysFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteKnownHostKeysFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_known_host_keys::DeleteKnownHostKeysOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_known_host_keys::DeleteKnownHostKeysError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_known_host_keys::DeleteKnownHostKeys::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_known_host_keys::DeleteKnownHostKeysOutput, crate::operation::delete_known_host_keys::DeleteKnownHostKeysError, Self> {
