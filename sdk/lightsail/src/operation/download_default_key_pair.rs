...
impl DownloadDefaultKeyPair {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::download_default_key_pair::DownloadDefaultKeyPairInput,
                    ) -> ::std::result::Result<crate::operation::download_default_key_pair::DownloadDefaultKeyPairOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DownloadDefaultKeyPair {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DownloadDefaultKeyPair");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DownloadDefaultKeyPairRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DownloadDefaultKeyPairResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DownloadDefaultKeyPair")
...
.with_interceptor(DownloadDefaultKeyPairEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_download_default_key_pair::de_download_default_key_pair_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_download_default_key_pair::de_download_default_key_pair_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DownloadDefaultKeyPairRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::download_default_key_pair::DownloadDefaultKeyPairInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_download_default_key_pair::ser_download_default_key_pair_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DownloadDefaultKeyPairEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DownloadDefaultKeyPairInput>()
                        .ok_or("failed to downcast to DownloadDefaultKeyPairInput")?;
...
pub enum DownloadDefaultKeyPairError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DownloadDefaultKeyPairError) for what information is available for the error.")]
...
impl DownloadDefaultKeyPairError {
    /// Creates the `DownloadDefaultKeyPairError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DownloadDefaultKeyPairError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DownloadDefaultKeyPairError {
...
impl ::aws_types::request_id::RequestId for crate::operation::download_default_key_pair::DownloadDefaultKeyPairError {
...
mod _download_default_key_pair_output;
