...
impl DownloadDefaultKeyPair {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "DownloadDefaultKeyPair", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.DownloadDefaultKeyPair",
                "rpc.service" = "Lightsail",
                "rpc.method" = "DownloadDefaultKeyPair",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DownloadDefaultKeyPair {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DownloadDefaultKeyPairRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DownloadDefaultKeyPairResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DownloadDefaultKeyPair")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DownloadDefaultKeyPairRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::download_default_key_pair::DownloadDefaultKeyPairInput>()
            .expect("correct type");
...
impl DownloadDefaultKeyPairError {
    ...
    /// Returns `true` if the error kind is `DownloadDefaultKeyPairError::RegionSetupInProgressException`.
