...
impl DownloadDefaultKeyPairInput {
    /// Consumes the builder and constructs an Operation<[`DownloadDefaultKeyPair`](crate::operation::download_default_key_pair::DownloadDefaultKeyPair)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::download_default_key_pair::DownloadDefaultKeyPair, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::download_default_key_pair::DownloadDefaultKeyPairInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_download_default_key_pair::ser_download_default_key_pair_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::download_default_key_pair::DownloadDefaultKeyPair::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DownloadDefaultKeyPair", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DownloadDefaultKeyPair {
                type Output = std::result::Result<crate::operation::download_default_key_pair::DownloadDefaultKeyPairOutput, crate::operation::download_default_key_pair::DownloadDefaultKeyPairError>;
