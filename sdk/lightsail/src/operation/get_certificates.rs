...
impl GetCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`GetCertificates`](crate::operation::get_certificates::GetCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_certificates::GetCertificates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_certificates::GetCertificatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_certificates::ser_get_certificates_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_certificates::GetCertificates::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetCertificates", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetCertificates {
                type Output = std::result::Result<crate::operation::get_certificates::GetCertificatesOutput, crate::operation::get_certificates::GetCertificatesError>;
