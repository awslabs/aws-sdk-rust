...
impl GetCertificatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_certificates::GetCertificates, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_certificates::ser_get_certificates_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_certificates::de_get_certificates_http_response_with_props(status, headers, body)
        }
    }
}
