...
impl GetRelationalDatabaseParametersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_relational_database_parameters::GetRelationalDatabaseParameters::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_parameters::de_get_relational_database_parameters_http_response_with_props(
                status, headers, body,
            )
        }
    }
