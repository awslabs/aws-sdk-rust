...
impl DeleteKnownHostKeysInput {
    /// Consumes the builder and constructs an Operation<[`DeleteKnownHostKeys`](crate::operation::delete_known_host_keys::DeleteKnownHostKeys)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_known_host_keys::DeleteKnownHostKeys, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_known_host_keys::DeleteKnownHostKeysInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_known_host_keys::ser_delete_known_host_keys_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_known_host_keys::DeleteKnownHostKeys::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteKnownHostKeys", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteKnownHostKeys {
                type Output = std::result::Result<crate::operation::delete_known_host_keys::DeleteKnownHostKeysOutput, crate::operation::delete_known_host_keys::DeleteKnownHostKeysError>;
