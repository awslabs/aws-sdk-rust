...
impl DeleteKnownHostKeysInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_known_host_keys::ser_delete_known_host_keys_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_known_host_keys::DeleteKnownHostKeys::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_known_host_keys::DeleteKnownHostKeysError
{
