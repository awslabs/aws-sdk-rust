...
impl StopInstanceInput {
    /// Consumes the builder and constructs an Operation<[`StopInstance`](crate::operation::stop_instance::StopInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_instance::StopInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_instance::StopInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_instance::ser_stop_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_instance::StopInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopInstance", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopInstance {
                type Output = std::result::Result<crate::operation::stop_instance::StopInstanceOutput, crate::operation::stop_instance::StopInstanceError>;
