...
impl StopInstanceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_instance::StopInstance, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_instance::ser_stop_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_instance::de_stop_instance_http_response_with_props(status, headers, body)
        }
    }
}
