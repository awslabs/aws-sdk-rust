...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_relational_database::GetRelationalDatabaseOutput,
                    crate::operation::get_relational_database::GetRelationalDatabaseError,
                > for GetRelationalDatabaseFluentBuilder
            {
                fn send(
                    self,
...
impl GetRelationalDatabaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_relational_database::GetRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database::GetRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_relational_database::GetRelationalDatabaseOutput, crate::operation::get_relational_database::GetRelationalDatabaseError, Self> {
