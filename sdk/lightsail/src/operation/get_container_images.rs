...
impl GetContainerImagesInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerImages`](crate::operation::get_container_images::GetContainerImages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_container_images::GetContainerImages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_images::GetContainerImagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_images::ser_get_container_images_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_images::GetContainerImages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContainerImages", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetContainerImages {
                type Output = std::result::Result<crate::operation::get_container_images::GetContainerImagesOutput, crate::operation::get_container_images::GetContainerImagesError>;
