...
impl GetDiskSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_disk_snapshot::GetDiskSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_disk_snapshot::ser_get_disk_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDiskSnapshot {
    type Output =
        ::std::result::Result<crate::operation::get_disk_snapshot::GetDiskSnapshotOutput, crate::operation::get_disk_snapshot::GetDiskSnapshotError>;
