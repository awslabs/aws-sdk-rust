...
impl GetDiskInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_disk::GetDiskError, ::aws_smithy_http::operation::Response>,
    > {
...
impl GetDiskFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::get_disk::GetDiskOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_disk::GetDiskError>>
    {
        let op = self
            .inner
            .build()
