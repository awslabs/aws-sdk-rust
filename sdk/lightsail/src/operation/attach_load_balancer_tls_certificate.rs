...
impl AttachLoadBalancerTlsCertificateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancerTlsCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_load_balancer_tls_certificate::de_attach_load_balancer_tls_certificate_http_response_with_props(
                status, headers, body,
            )
        }
    }
