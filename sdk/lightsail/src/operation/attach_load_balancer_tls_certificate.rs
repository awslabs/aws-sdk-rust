...
impl AttachLoadBalancerTlsCertificate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AttachLoadBalancerTlsCertificate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachLoadBalancerTlsCertificate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AttachLoadBalancerTlsCertificateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AttachLoadBalancerTlsCertificateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AttachLoadBalancerTlsCertificate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachLoadBalancerTlsCertificate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AttachLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AttachLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AttachLoadBalancerTlsCertificateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachLoadBalancerTlsCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_attach_load_balancer_tls_certificate::de_attach_load_balancer_tls_certificate_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_attach_load_balancer_tls_certificate::de_attach_load_balancer_tls_certificate_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachLoadBalancerTlsCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_attach_load_balancer_tls_certificate::ser_attach_load_balancer_tls_certificate_input(&input)?,
        );
...
impl AttachLoadBalancerTlsCertificateError {
    ...
    /// Returns `true` if the error kind is `AttachLoadBalancerTlsCertificateError::RegionSetupInProgressException`.
