...
impl GetExportSnapshotRecordsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsOutput, crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError, Self> {
