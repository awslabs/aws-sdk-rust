...
impl GetLoadBalancerMetricDataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError, Self> {
