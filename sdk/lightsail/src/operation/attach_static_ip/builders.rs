...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::attach_static_ip::AttachStaticIpOutput,
                    crate::operation::attach_static_ip::AttachStaticIpError,
                > for AttachStaticIpFluentBuilder
            {
                fn send(
                    self,
...
impl AttachStaticIpFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::attach_static_ip::AttachStaticIpOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_static_ip::AttachStaticIpError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::attach_static_ip::AttachStaticIp::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::attach_static_ip::AttachStaticIp::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::attach_static_ip::AttachStaticIpOutput, crate::operation::attach_static_ip::AttachStaticIpError, Self> {
