...
impl GetRelationalDatabaseLogEventsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEvents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseLogEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_log_events::de_get_relational_database_log_events_http_response_with_props(
                status, headers, body,
            )
        }
    }
