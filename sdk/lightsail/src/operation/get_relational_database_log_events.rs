...
impl GetRelationalDatabaseLogEvents {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetRelationalDatabaseLogEvents",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRelationalDatabaseLogEvents {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRelationalDatabaseLogEventsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRelationalDatabaseLogEventsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRelationalDatabaseLogEvents")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRelationalDatabaseLogEvents")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRelationalDatabaseLogEventsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetRelationalDatabaseLogEventsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRelationalDatabaseLogEventsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRelationalDatabaseLogEventsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRelationalDatabaseLogEventsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_relational_database_log_events::de_get_relational_database_log_events_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_get_relational_database_log_events::de_get_relational_database_log_events_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRelationalDatabaseLogEventsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_log_events::ser_get_relational_database_log_events_input(&input)?,
        );
...
impl GetRelationalDatabaseLogEventsError {
    ...
    /// Returns `true` if the error kind is `GetRelationalDatabaseLogEventsError::RegionSetupInProgressException`.
