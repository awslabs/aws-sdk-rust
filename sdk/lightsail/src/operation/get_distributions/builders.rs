...
impl GetDistributionsFluentBuilder  {
    /// Creates a new `GetDistributions`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_distributions::GetDistributions, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_distributions::GetDistributionsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_distributions::GetDistributionsOutput, aws_smithy_http::result::SdkError<crate::operation::get_distributions::GetDistributionsError>>
                     {
