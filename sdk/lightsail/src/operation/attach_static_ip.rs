...
impl AttachStaticIpInput {
    /// Consumes the builder and constructs an Operation<[`AttachStaticIp`](crate::operation::attach_static_ip::AttachStaticIp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_static_ip::AttachStaticIp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_static_ip::AttachStaticIpInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_static_ip::ser_attach_static_ip_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_static_ip::AttachStaticIp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AttachStaticIp", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AttachStaticIp`.
...
impl aws_smithy_http::response::ParseStrictResponse for AttachStaticIp {
                type Output = std::result::Result<crate::operation::attach_static_ip::AttachStaticIpOutput, crate::operation::attach_static_ip::AttachStaticIpError>;
