...
/// Orchestration and serialization glue logic for `AttachStaticIp`.
...
impl AttachStaticIp {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::attach_static_ip::AttachStaticIpInput,
                    ) -> ::std::result::Result<crate::operation::attach_static_ip::AttachStaticIpOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_static_ip::AttachStaticIpError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::attach_static_ip::AttachStaticIpError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::attach_static_ip::AttachStaticIpOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachStaticIp {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AttachStaticIp");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AttachStaticIpRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AttachStaticIpResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachStaticIp")
...
.with_interceptor(AttachStaticIpEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::attach_static_ip::AttachStaticIpError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::attach_static_ip::AttachStaticIpError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::attach_static_ip::AttachStaticIpError>::new());
...
#[derive(Debug)]
            struct AttachStaticIpResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachStaticIpResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_attach_static_ip::de_attach_static_ip_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_attach_static_ip::de_attach_static_ip_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AttachStaticIpRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachStaticIpRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::attach_static_ip::AttachStaticIpInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::attach_static_ip::AttachStaticIpInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_attach_static_ip::ser_attach_static_ip_input(&input)?);
...
#[derive(Debug)]
            struct AttachStaticIpEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachStaticIpEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AttachStaticIpEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AttachStaticIpInput>()
                        .ok_or("failed to downcast to AttachStaticIpInput")?;
...
pub enum AttachStaticIpError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AttachStaticIpError) for what information is available for the error.")]
...
impl AttachStaticIpError {
    /// Creates the `AttachStaticIpError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AttachStaticIpError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AttachStaticIpError {
...
impl ::aws_types::request_id::RequestId for crate::operation::attach_static_ip::AttachStaticIpError {
