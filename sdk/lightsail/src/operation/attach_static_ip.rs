...
impl AttachStaticIpInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::attach_static_ip::AttachStaticIp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_attach_static_ip::ser_attach_static_ip_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachStaticIp {
    type Output =
        ::std::result::Result<crate::operation::attach_static_ip::AttachStaticIpOutput, crate::operation::attach_static_ip::AttachStaticIpError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_static_ip::de_attach_static_ip_http_response_with_props(status, headers, body)
        }
    }
}
