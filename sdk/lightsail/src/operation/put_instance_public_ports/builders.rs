...
impl PutInstancePublicPortsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_instance_public_ports::PutInstancePublicPortsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_instance_public_ports::PutInstancePublicPortsOutput, crate::operation::put_instance_public_ports::PutInstancePublicPortsError, Self> {
