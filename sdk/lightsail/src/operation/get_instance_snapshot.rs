...
impl GetInstanceSnapshotInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_snapshot::ser_get_instance_snapshot_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_instance_snapshot::GetInstanceSnapshot::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_instance_snapshot::GetInstanceSnapshotError
{
