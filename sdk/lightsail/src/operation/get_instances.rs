...
impl GetInstancesInput {
    /// Consumes the builder and constructs an Operation<[`GetInstances`](crate::operation::get_instances::GetInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instances::GetInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instances::GetInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instances::ser_get_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instances::GetInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstances", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetInstances`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstances {
                type Output = std::result::Result<crate::operation::get_instances::GetInstancesOutput, crate::operation::get_instances::GetInstancesError>;
