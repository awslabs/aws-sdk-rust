...
impl GetInstancesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_instances::GetInstances, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_instances::ser_get_instances_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instances::de_get_instances_http_response_with_props(status, headers, body)
        }
    }
}
