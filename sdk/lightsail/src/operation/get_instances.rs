...
impl GetInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_instances::GetInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_instances::de_get_instances_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_instances::de_get_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
