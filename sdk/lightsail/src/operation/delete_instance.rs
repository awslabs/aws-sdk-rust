...
impl DeleteInstance {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "DeleteInstance", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteInstanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_instance::ser_delete_instance_input(&input)?);
...
impl DeleteInstanceError {
    ...
    /// Returns `true` if the error kind is `DeleteInstanceError::RegionSetupInProgressException`.
