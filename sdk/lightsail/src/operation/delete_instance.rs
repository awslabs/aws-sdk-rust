...
impl DeleteInstanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_instance::ser_delete_instance_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_instance::DeleteInstance::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteInstance", "lightsail"));
