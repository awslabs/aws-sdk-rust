...
impl CreateDomainInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_domain::CreateDomain, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_domain::ser_create_domain_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_domain::CreateDomain::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDomain", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_domain::de_create_domain_http_response_with_props(status, headers, body)
        }
    }
}
