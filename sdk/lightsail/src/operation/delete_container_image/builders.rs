...
impl DeleteContainerImageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_container_image::DeleteContainerImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_container_image::DeleteContainerImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_container_image::DeleteContainerImageOutput, crate::operation::delete_container_image::DeleteContainerImageError, Self> {
