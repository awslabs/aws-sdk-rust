...
impl GetOperationsForResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_operations_for_resource::GetOperationsForResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_operations_for_resource::GetOperationsForResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_operations_for_resource::GetOperationsForResourceOutput, crate::operation::get_operations_for_resource::GetOperationsForResourceError, Self> {
