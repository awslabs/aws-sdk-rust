...
impl GetOperationsForResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_operations_for_resource::GetOperationsForResourceInput, ::aws_smithy_types::error::operation::BuildError> {
