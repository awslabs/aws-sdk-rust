...
impl GetBucketAccessKeys {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_bucket_access_keys::GetBucketAccessKeysError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_bucket_access_keys::GetBucketAccessKeysOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetBucketAccessKeys", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetBucketAccessKeys",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetBucketAccessKeys",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBucketAccessKeys {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetBucketAccessKeysRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetBucketAccessKeysResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetBucketAccessKeys")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBucketAccessKeys")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetBucketAccessKeysTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetBucketAccessKeysTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBucketAccessKeysTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetBucketAccessKeysInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketAccessKeysResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_bucket_access_keys::de_get_bucket_access_keys_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_bucket_access_keys::de_get_bucket_access_keys_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketAccessKeysRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_bucket_access_keys::GetBucketAccessKeysInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_bucket_access_keys::GetBucketAccessKeysInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_bucket_access_keys::ser_get_bucket_access_keys_input(
            &input,
        )?);
...
impl GetBucketAccessKeysError {
    ...
    /// Returns `true` if the error kind is `GetBucketAccessKeysError::RegionSetupInProgressException`.
