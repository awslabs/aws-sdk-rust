...
impl GetBucketAccessKeysInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_bucket_access_keys::ser_get_bucket_access_keys_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_access_keys::GetBucketAccessKeys::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_bucket_access_keys::GetBucketAccessKeysError
{
