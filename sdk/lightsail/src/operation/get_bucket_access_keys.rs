...
impl GetBucketAccessKeysInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bucket_access_keys::GetBucketAccessKeys,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketAccessKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_access_keys::de_get_bucket_access_keys_http_response_with_props(status, headers, body)
        }
    }
