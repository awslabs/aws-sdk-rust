...
impl DeleteDomain {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "DeleteDomain", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteDomain {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("DeleteDomain", "Lightsail"));
...
impl DeleteDomainError {
    ...
    /// Returns `true` if the error kind is `DeleteDomainError::RegionSetupInProgressException`.
