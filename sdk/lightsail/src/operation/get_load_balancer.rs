...
impl GetLoadBalancerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_load_balancer::GetLoadBalancer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_load_balancer::ser_get_load_balancer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancer {
    type Output =
        ::std::result::Result<crate::operation::get_load_balancer::GetLoadBalancerOutput, crate::operation::get_load_balancer::GetLoadBalancerError>;
