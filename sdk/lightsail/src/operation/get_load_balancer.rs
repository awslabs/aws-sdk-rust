...
impl GetLoadBalancerInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_load_balancer::GetLoadBalancer,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_load_balancer::GetLoadBalancer::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetLoadBalancer {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_load_balancer::de_get_load_balancer_http_error(
                response,
            )
        } else {
