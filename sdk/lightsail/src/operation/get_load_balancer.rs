...
impl GetLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`GetLoadBalancer`](crate::operation::get_load_balancer::GetLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_load_balancer::GetLoadBalancer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_load_balancer::GetLoadBalancerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancer::ser_get_load_balancer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_load_balancer::GetLoadBalancer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetLoadBalancer", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetLoadBalancer`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetLoadBalancer {
                type Output = std::result::Result<crate::operation::get_load_balancer::GetLoadBalancerOutput, crate::operation::get_load_balancer::GetLoadBalancerError>;
