...
/// Orchestration and serialization glue logic for `GetLoadBalancer`.
...
impl GetLoadBalancer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_load_balancer::GetLoadBalancerInput,
                    ) -> ::std::result::Result<crate::operation::get_load_balancer::GetLoadBalancerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_load_balancer::GetLoadBalancerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_load_balancer::GetLoadBalancerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_load_balancer::GetLoadBalancerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLoadBalancer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLoadBalancer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLoadBalancerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLoadBalancerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLoadBalancer")
...
.with_interceptor(GetLoadBalancerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_load_balancer::GetLoadBalancerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_load_balancer::GetLoadBalancerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_load_balancer::GetLoadBalancerError>::new());
...
#[derive(Debug)]
            struct GetLoadBalancerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoadBalancerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_load_balancer::de_get_load_balancer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_load_balancer::de_get_load_balancer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetLoadBalancerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoadBalancerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_load_balancer::GetLoadBalancerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_load_balancer::GetLoadBalancerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_load_balancer::ser_get_load_balancer_input(&input)?);
...
#[derive(Debug)]
            struct GetLoadBalancerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLoadBalancerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetLoadBalancerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLoadBalancerInput>()
                        .ok_or("failed to downcast to GetLoadBalancerInput")?;
...
pub enum GetLoadBalancerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLoadBalancerError) for what information is available for the error.")]
...
impl GetLoadBalancerError {
    /// Creates the `GetLoadBalancerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLoadBalancerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLoadBalancerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_load_balancer::GetLoadBalancerError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_load_balancer::_get_load_balancer_output::GetLoadBalancerOutput;

pub use crate::operation::get_load_balancer::_get_load_balancer_input::GetLoadBalancerInput;

mod _get_load_balancer_input;

mod _get_load_balancer_output;
