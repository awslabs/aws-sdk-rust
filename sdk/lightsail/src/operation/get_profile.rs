...
impl GetProfile {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetProfile", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetProfile",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetProfile {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetProfile", "Lightsail"));
...
impl GetProfileError {
    ...
    /// Returns `true` if the error kind is `GetProfileError::AccountSetupInProgressException`.
    pub fn is_account_setup_in_progress_exception(&self) -> bool {
        matches!(self, Self::AccountSetupInProgressException(_))
    }
    /// Returns `true` if the error kind is `GetProfileError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetProfileError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `GetProfileError::UnauthenticatedException`.
