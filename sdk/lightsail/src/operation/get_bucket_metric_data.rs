...
impl GetBucketMetricDataInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_bucket_metric_data::ser_get_bucket_metric_data_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_metric_data::GetBucketMetricData::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_bucket_metric_data::GetBucketMetricDataError
{
