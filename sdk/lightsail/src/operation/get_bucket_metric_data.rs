...
impl GetBucketMetricData {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_bucket_metric_data::GetBucketMetricDataInput,
                    ) -> ::std::result::Result<crate::operation::get_bucket_metric_data::GetBucketMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_bucket_metric_data::GetBucketMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_bucket_metric_data::GetBucketMetricDataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_bucket_metric_data::GetBucketMetricDataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBucketMetricData {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetBucketMetricData");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetBucketMetricDataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetBucketMetricDataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetBucketMetricData")
...
.with_interceptor(GetBucketMetricDataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_bucket_metric_data::GetBucketMetricDataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_bucket_metric_data::GetBucketMetricDataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_bucket_metric_data::GetBucketMetricDataError>::new());
...
#[derive(Debug)]
            struct GetBucketMetricDataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetBucketMetricDataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_bucket_metric_data::de_get_bucket_metric_data_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_bucket_metric_data::de_get_bucket_metric_data_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetBucketMetricDataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketMetricDataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_bucket_metric_data::GetBucketMetricDataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_bucket_metric_data::GetBucketMetricDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_bucket_metric_data::ser_get_bucket_metric_data_input(&input)?);
...
#[derive(Debug)]
            struct GetBucketMetricDataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetBucketMetricDataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetBucketMetricDataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetBucketMetricDataInput>()
                        .ok_or("failed to downcast to GetBucketMetricDataInput")?;
...
pub enum GetBucketMetricDataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetBucketMetricDataError) for what information is available for the error.")]
...
impl GetBucketMetricDataError {
    /// Creates the `GetBucketMetricDataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetBucketMetricDataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetBucketMetricDataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_bucket_metric_data::GetBucketMetricDataError {
...
mod _get_bucket_metric_data_output;
