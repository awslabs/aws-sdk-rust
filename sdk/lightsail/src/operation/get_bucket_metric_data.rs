...
impl GetBucketMetricDataInput {
    /// Consumes the builder and constructs an Operation<[`GetBucketMetricData`](crate::operation::get_bucket_metric_data::GetBucketMetricData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_bucket_metric_data::GetBucketMetricData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bucket_metric_data::GetBucketMetricDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_bucket_metric_data::ser_get_bucket_metric_data_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_bucket_metric_data::GetBucketMetricData::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetBucketMetricData", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetBucketMetricData {
                type Output = std::result::Result<crate::operation::get_bucket_metric_data::GetBucketMetricDataOutput, crate::operation::get_bucket_metric_data::GetBucketMetricDataError>;
