...
impl GetActiveNamesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_active_names::GetActiveNames,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_active_names::GetActiveNames::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetActiveNames {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_active_names::de_get_active_names_http_error(
                status, headers, body,
            )
        } else {
