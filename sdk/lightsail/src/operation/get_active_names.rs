...
impl GetActiveNamesInput {
    /// Consumes the builder and constructs an Operation<[`GetActiveNames`](crate::operation::get_active_names::GetActiveNames)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_active_names::GetActiveNames, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_active_names::GetActiveNamesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_active_names::ser_get_active_names_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_active_names::GetActiveNames::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetActiveNames", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetActiveNames`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetActiveNames {
                type Output = std::result::Result<crate::operation::get_active_names::GetActiveNamesOutput, crate::operation::get_active_names::GetActiveNamesError>;
