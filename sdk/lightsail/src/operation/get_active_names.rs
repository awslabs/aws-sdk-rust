...
impl GetActiveNamesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_active_names::GetActiveNames, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_active_names::ser_get_active_names_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetActiveNames {
    type Output =
        ::std::result::Result<crate::operation::get_active_names::GetActiveNamesOutput, crate::operation::get_active_names::GetActiveNamesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_active_names::de_get_active_names_http_response_with_props(status, headers, body)
        }
    }
}
