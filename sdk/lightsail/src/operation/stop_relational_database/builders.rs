...
impl StopRelationalDatabaseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_relational_database::StopRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_relational_database::StopRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_relational_database::StopRelationalDatabaseOutput, crate::operation::stop_relational_database::StopRelationalDatabaseError, Self> {
