...
impl UpdateRelationalDatabaseParametersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_relational_database_parameters::UpdateRelationalDatabaseParameters::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRelationalDatabaseParameters {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_relational_database_parameters::de_update_relational_database_parameters_http_response_with_props(
                status, headers, body,
            )
        }
    }
