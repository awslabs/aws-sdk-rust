...
impl UpdateRelationalDatabaseParameters {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_relational_database_parameters::UpdateRelationalDatabaseParametersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_relational_database_parameters::UpdateRelationalDatabaseParametersOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateRelationalDatabaseParameters",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRelationalDatabaseParameters {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateRelationalDatabaseParametersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateRelationalDatabaseParametersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateRelationalDatabaseParameters")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateRelationalDatabaseParameters")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateRelationalDatabaseParametersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateRelationalDatabaseParametersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRelationalDatabaseParametersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateRelationalDatabaseParametersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRelationalDatabaseParametersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_relational_database_parameters::de_update_relational_database_parameters_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_relational_database_parameters::de_update_relational_database_parameters_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRelationalDatabaseParametersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_relational_database_parameters::UpdateRelationalDatabaseParametersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_relational_database_parameters::UpdateRelationalDatabaseParametersInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_relational_database_parameters::ser_update_relational_database_parameters_input(&input)?,
        );
...
impl UpdateRelationalDatabaseParametersError {
    ...
    /// Returns `true` if the error kind is `UpdateRelationalDatabaseParametersError::RegionSetupInProgressException`.
