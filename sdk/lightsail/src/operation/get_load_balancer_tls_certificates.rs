...
impl GetLoadBalancerTlsCertificates {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetLoadBalancerTlsCertificates",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLoadBalancerTlsCertificates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetLoadBalancerTlsCertificatesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetLoadBalancerTlsCertificatesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetLoadBalancerTlsCertificates")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLoadBalancerTlsCertificates")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetLoadBalancerTlsCertificatesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetLoadBalancerTlsCertificatesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLoadBalancerTlsCertificatesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetLoadBalancerTlsCertificatesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoadBalancerTlsCertificatesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_load_balancer_tls_certificates::de_get_load_balancer_tls_certificates_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_get_load_balancer_tls_certificates::de_get_load_balancer_tls_certificates_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoadBalancerTlsCertificatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancer_tls_certificates::ser_get_load_balancer_tls_certificates_input(&input)?,
        );
...
impl GetLoadBalancerTlsCertificatesError {
    ...
    /// Returns `true` if the error kind is `GetLoadBalancerTlsCertificatesError::RegionSetupInProgressException`.
