...
impl GetLoadBalancerTlsCertificatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancerTlsCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_load_balancer_tls_certificates::de_get_load_balancer_tls_certificates_http_response_with_props(
                status, headers, body,
            )
        }
    }
