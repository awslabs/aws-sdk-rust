...
impl UpdateLoadBalancerAttribute {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateLoadBalancerAttribute",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateLoadBalancerAttribute {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateLoadBalancerAttributeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateLoadBalancerAttributeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateLoadBalancerAttribute")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateLoadBalancerAttribute")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateLoadBalancerAttributeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateLoadBalancerAttributeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateLoadBalancerAttributeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateLoadBalancerAttributeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateLoadBalancerAttributeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_load_balancer_attribute::de_update_load_balancer_attribute_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_load_balancer_attribute::de_update_load_balancer_attribute_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateLoadBalancerAttributeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_load_balancer_attribute::ser_update_load_balancer_attribute_input(&input)?,
        );
...
impl UpdateLoadBalancerAttributeError {
    ...
    /// Returns `true` if the error kind is `UpdateLoadBalancerAttributeError::RegionSetupInProgressException`.
