...
impl CloseInstancePublicPortsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::close_instance_public_ports::CloseInstancePublicPortsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::close_instance_public_ports::CloseInstancePublicPortsOutput, crate::operation::close_instance_public_ports::CloseInstancePublicPortsError, Self> {
