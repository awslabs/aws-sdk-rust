...
impl DeleteLoadBalancerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_load_balancer::ser_delete_load_balancer_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_load_balancer::DeleteLoadBalancer::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_load_balancer::DeleteLoadBalancerError
{
