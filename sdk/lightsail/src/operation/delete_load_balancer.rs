...
impl DeleteLoadBalancerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_load_balancer::ser_delete_load_balancer_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_load_balancer::de_delete_load_balancer_http_response_with_props(status, headers, body)
        }
    }
}
