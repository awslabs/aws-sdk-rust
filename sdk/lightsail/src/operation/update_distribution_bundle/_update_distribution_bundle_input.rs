...
impl UpdateDistributionBundleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_distribution_bundle::UpdateDistributionBundleInput, ::aws_smithy_types::error::operation::BuildError> {
