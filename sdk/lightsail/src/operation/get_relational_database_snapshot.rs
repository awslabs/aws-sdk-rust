    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_relational_database_snapshot::GetRelationalDatabaseSnapshotError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_relational_database_snapshot::GetRelationalDatabaseSnapshotOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetRelationalDatabaseSnapshotResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetRelationalDatabaseSnapshotRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetRelationalDatabaseSnapshotEndpointParamsInterceptor {
