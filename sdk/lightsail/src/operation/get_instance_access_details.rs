...
impl GetInstanceAccessDetails {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_instance_access_details::GetInstanceAccessDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstanceAccessDetails {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetInstanceAccessDetails");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetInstanceAccessDetailsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetInstanceAccessDetailsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstanceAccessDetails")
...
.with_interceptor(GetInstanceAccessDetailsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError>::new());
...
#[derive(Debug)]
            struct GetInstanceAccessDetailsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstanceAccessDetailsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_instance_access_details::de_get_instance_access_details_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetInstanceAccessDetailsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstanceAccessDetailsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_instance_access_details::GetInstanceAccessDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_instance_access_details::ser_get_instance_access_details_input(&input)?);
...
#[derive(Debug)]
            struct GetInstanceAccessDetailsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstanceAccessDetailsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetInstanceAccessDetailsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetInstanceAccessDetailsInput>()
                        .ok_or("failed to downcast to GetInstanceAccessDetailsInput")?;
...
pub enum GetInstanceAccessDetailsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetInstanceAccessDetailsError) for what information is available for the error.")]
...
impl GetInstanceAccessDetailsError {
    /// Creates the `GetInstanceAccessDetailsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetInstanceAccessDetailsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetInstanceAccessDetailsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_instance_access_details::GetInstanceAccessDetailsError {
...
mod _get_instance_access_details_output;
