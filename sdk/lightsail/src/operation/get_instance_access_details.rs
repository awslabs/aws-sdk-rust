...
impl GetInstanceAccessDetails {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetInstanceAccessDetails",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstanceAccessDetails {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetInstanceAccessDetailsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetInstanceAccessDetailsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetInstanceAccessDetails")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstanceAccessDetails")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetInstanceAccessDetailsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetInstanceAccessDetailsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstanceAccessDetailsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetInstanceAccessDetailsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstanceAccessDetailsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_instance_access_details::de_get_instance_access_details_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_instance_access_details::de_get_instance_access_details_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstanceAccessDetailsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_instance_access_details::GetInstanceAccessDetailsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_instance_access_details::GetInstanceAccessDetailsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_access_details::ser_get_instance_access_details_input(&input)?,
        );
...
impl GetInstanceAccessDetailsError {
    ...
    /// Returns `true` if the error kind is `GetInstanceAccessDetailsError::RegionSetupInProgressException`.
