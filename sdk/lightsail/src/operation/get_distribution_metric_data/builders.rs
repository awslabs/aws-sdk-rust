...
impl GetDistributionMetricDataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_distribution_metric_data::GetDistributionMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_distribution_metric_data::GetDistributionMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_distribution_metric_data::GetDistributionMetricDataOutput, crate::operation::get_distribution_metric_data::GetDistributionMetricDataError, Self> {
