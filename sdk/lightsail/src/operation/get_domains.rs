...
impl GetDomainsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_domains::GetDomains, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_domains::ser_get_domains_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomains {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domains::de_get_domains_http_response_with_props(status, headers, body)
        }
    }
}
