...
impl DetachCertificateFromDistributionInput {
    /// Consumes the builder and constructs an Operation<[`DetachCertificateFromDistribution`](crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistribution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistribution, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistributionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_certificate_from_distribution::ser_detach_certificate_from_distribution_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistribution::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachCertificateFromDistribution", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetachCertificateFromDistribution {
                type Output = std::result::Result<crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistributionOutput, crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistributionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_detach_certificate_from_distribution::de_detach_certificate_from_distribution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_detach_certificate_from_distribution::de_detach_certificate_from_distribution_http_response(response)
                     }
                }
            }
