...
impl DetachCertificateFromDistributionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistribution,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_certificate_from_distribution::DetachCertificateFromDistribution::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachCertificateFromDistribution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_certificate_from_distribution::de_detach_certificate_from_distribution_http_response_with_props(
                status, headers, body,
            )
        }
    }
