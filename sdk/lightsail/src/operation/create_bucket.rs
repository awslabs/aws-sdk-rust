...
impl CreateBucket {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "CreateBucket", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateBucket {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CreateBucket", "Lightsail"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBucketResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_bucket::de_create_bucket_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_bucket::de_create_bucket_http_response(status, headers, body, _cfg)
        };
...
impl CreateBucketError {
    ...
    /// Returns `true` if the error kind is `CreateBucketError::RegionSetupInProgressException`.
