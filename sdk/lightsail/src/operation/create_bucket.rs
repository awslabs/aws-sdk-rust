...
impl CreateBucketInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_bucket::CreateBucket, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_bucket::ser_create_bucket_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBucket {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_bucket::de_create_bucket_http_response_with_props(status, headers, body)
        }
    }
}
