...
impl GetDistributionsInput {
    /// Consumes the builder and constructs an Operation<[`GetDistributions`](crate::operation::get_distributions::GetDistributions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_distributions::GetDistributions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_distributions::GetDistributionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_distributions::ser_get_distributions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_distributions::GetDistributions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDistributions", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDistributions {
                type Output = std::result::Result<crate::operation::get_distributions::GetDistributionsOutput, crate::operation::get_distributions::GetDistributionsError>;
