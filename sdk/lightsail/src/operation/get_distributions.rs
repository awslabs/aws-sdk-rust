...
impl GetDistributionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_distributions::GetDistributions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_distributions::ser_get_distributions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_distributions::de_get_distributions_http_response_with_props(status, headers, body)
        }
    }
}
