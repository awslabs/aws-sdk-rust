...
impl GetDistributionBundlesFluentBuilder  {
    /// Creates a new `GetDistributionBundles`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_distribution_bundles::GetDistributionBundlesOutput, aws_smithy_http::result::SdkError<crate::operation::get_distribution_bundles::GetDistributionBundlesError>>
                     {
