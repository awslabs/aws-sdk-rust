...
/// Orchestration and serialization glue logic for `CloseInstancePublicPorts`.
...
impl CloseInstancePublicPorts {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::close_instance_public_ports::CloseInstancePublicPortsInput,
                    ) -> ::std::result::Result<crate::operation::close_instance_public_ports::CloseInstancePublicPortsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CloseInstancePublicPorts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CloseInstancePublicPorts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CloseInstancePublicPortsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CloseInstancePublicPortsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CloseInstancePublicPorts")
...
.with_interceptor(CloseInstancePublicPortsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError>::new());
...
#[derive(Debug)]
            struct CloseInstancePublicPortsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CloseInstancePublicPortsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_close_instance_public_ports::de_close_instance_public_ports_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CloseInstancePublicPortsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CloseInstancePublicPortsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::close_instance_public_ports::CloseInstancePublicPortsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_close_instance_public_ports::ser_close_instance_public_ports_input(&input)?);
...
#[derive(Debug)]
            struct CloseInstancePublicPortsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CloseInstancePublicPortsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CloseInstancePublicPortsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CloseInstancePublicPortsInput>()
                        .ok_or("failed to downcast to CloseInstancePublicPortsInput")?;
...
pub enum CloseInstancePublicPortsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CloseInstancePublicPortsError) for what information is available for the error.")]
...
impl CloseInstancePublicPortsError {
    /// Creates the `CloseInstancePublicPortsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CloseInstancePublicPortsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CloseInstancePublicPortsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::close_instance_public_ports::CloseInstancePublicPortsError {
...
mod _close_instance_public_ports_output;
