...
impl CloseInstancePublicPortsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::close_instance_public_ports::CloseInstancePublicPorts::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CloseInstancePublicPorts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_close_instance_public_ports::de_close_instance_public_ports_http_response_with_props(status, headers, body)
        }
    }
}
