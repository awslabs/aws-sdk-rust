...
impl CloseInstancePublicPorts {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CloseInstancePublicPorts",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CloseInstancePublicPorts {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CloseInstancePublicPortsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CloseInstancePublicPortsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CloseInstancePublicPorts")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CloseInstancePublicPorts")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CloseInstancePublicPortsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CloseInstancePublicPortsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CloseInstancePublicPortsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CloseInstancePublicPortsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CloseInstancePublicPortsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_close_instance_public_ports::de_close_instance_public_ports_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_close_instance_public_ports::de_close_instance_public_ports_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CloseInstancePublicPortsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::close_instance_public_ports::CloseInstancePublicPortsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::close_instance_public_ports::CloseInstancePublicPortsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_close_instance_public_ports::ser_close_instance_public_ports_input(&input)?,
        );
...
impl CloseInstancePublicPortsError {
    ...
    /// Returns `true` if the error kind is `CloseInstancePublicPortsError::RegionSetupInProgressException`.
