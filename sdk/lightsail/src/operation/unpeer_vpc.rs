...
impl UnpeerVpc {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "UnpeerVpc", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.UnpeerVpc",
                "rpc.service" = "Lightsail",
                "rpc.method" = "UnpeerVpc",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnpeerVpc {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UnpeerVpc")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UnpeerVpc", "Lightsail"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnpeerVpc")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnpeerVpcResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_unpeer_vpc::de_unpeer_vpc_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_unpeer_vpc::de_unpeer_vpc_http_response(status, headers, body, _cfg)
        };
...
impl UnpeerVpcError {
    ...
    /// Returns `true` if the error kind is `UnpeerVpcError::RegionSetupInProgressException`.
