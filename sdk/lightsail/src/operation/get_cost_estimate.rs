...
#[non_exhaustive]
pub struct GetCostEstimate;
impl GetCostEstimate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_cost_estimate::GetCostEstimateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cost_estimate::GetCostEstimateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_cost_estimate::GetCostEstimateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_cost_estimate::GetCostEstimateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCostEstimate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCostEstimate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCostEstimateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCostEstimateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCostEstimate")
...
.with_interceptor(GetCostEstimateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_cost_estimate::GetCostEstimateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_cost_estimate::GetCostEstimateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_cost_estimate::GetCostEstimateError>::new());
...
#[derive(Debug)]
            struct GetCostEstimateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCostEstimateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_cost_estimate::de_get_cost_estimate_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_cost_estimate::de_get_cost_estimate_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCostEstimateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCostEstimateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_cost_estimate::GetCostEstimateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_cost_estimate::GetCostEstimateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder = _header_serialization_settings.set_default_header(
                        ...
                        "Lightsail_20161128.GetCostEstimate"
                    );
builder
                    };
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_cost_estimate::ser_get_cost_estimate_input(&input)?);
...
#[derive(Debug)]
            struct GetCostEstimateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCostEstimateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCostEstimateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCostEstimateInput>()
                        .ok_or("failed to downcast to GetCostEstimateInput")?;
...
/// Error type for the `GetCostEstimateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetCostEstimateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCostEstimateError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetCostEstimateError {
    /// Creates the `GetCostEstimateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCostEstimateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetCostEstimateError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetCostEstimateError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetCostEstimateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetCostEstimateError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `GetCostEstimateError::UnauthenticatedException`.
    pub fn is_unauthenticated_exception(&self) -> bool {
        matches!(self, Self::UnauthenticatedException(_))
    }
}
impl ::std::error::Error for GetCostEstimateError {
...
impl ::std::fmt::Display for GetCostEstimateError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetCostEstimateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCostEstimateError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCostEstimateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_cost_estimate::GetCostEstimateError {
