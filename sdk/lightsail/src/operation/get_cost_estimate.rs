...
impl GetCostEstimateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_cost_estimate::GetCostEstimate, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cost_estimate::ser_get_cost_estimate_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostEstimate {
    type Output =
        ::std::result::Result<crate::operation::get_cost_estimate::GetCostEstimateOutput, crate::operation::get_cost_estimate::GetCostEstimateError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cost_estimate::de_get_cost_estimate_http_response_with_props(status, headers, body)
        }
    }
}
