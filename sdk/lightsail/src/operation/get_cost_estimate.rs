...
impl GetCostEstimate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_cost_estimate::GetCostEstimateError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_cost_estimate::GetCostEstimateOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("lightsail", "GetCostEstimate", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCostEstimate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetCostEstimate", "lightsail"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCostEstimate")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetCostEstimateEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetCostEstimateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetCostEstimateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_cost_estimate::GetCostEstimateInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cost_estimate::ser_get_cost_estimate_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetCostEstimateEndpointParamsInterceptor {
...
pub type GetCostEstimateErrorKind = GetCostEstimateError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetCostEstimateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cost_estimate::GetCostEstimateError {
...
impl GetCostEstimateError {
    ...
    /// Creates the `GetCostEstimateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
