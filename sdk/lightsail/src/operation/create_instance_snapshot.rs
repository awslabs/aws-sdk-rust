...
/// Orchestration and serialization glue logic for `CreateInstanceSnapshot`.
...
impl CreateInstanceSnapshot {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_instance_snapshot::CreateInstanceSnapshotInput,
                    ) -> ::std::result::Result<crate::operation::create_instance_snapshot::CreateInstanceSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateInstanceSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateInstanceSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateInstanceSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateInstanceSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateInstanceSnapshot")
...
.with_interceptor(CreateInstanceSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotError>::new());
...
#[derive(Debug)]
            struct CreateInstanceSnapshotResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateInstanceSnapshotResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_instance_snapshot::de_create_instance_snapshot_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateInstanceSnapshotRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateInstanceSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_instance_snapshot::CreateInstanceSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_instance_snapshot::CreateInstanceSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_instance_snapshot::ser_create_instance_snapshot_input(&input)?);
...
#[derive(Debug)]
            struct CreateInstanceSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateInstanceSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateInstanceSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateInstanceSnapshotInput>()
                        .ok_or("failed to downcast to CreateInstanceSnapshotInput")?;
...
pub enum CreateInstanceSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateInstanceSnapshotError) for what information is available for the error.")]
...
impl CreateInstanceSnapshotError {
    /// Creates the `CreateInstanceSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateInstanceSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateInstanceSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_instance_snapshot::CreateInstanceSnapshotError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_instance_snapshot::_create_instance_snapshot_output::CreateInstanceSnapshotOutput;

pub use crate::operation::create_instance_snapshot::_create_instance_snapshot_input::CreateInstanceSnapshotInput;

mod _create_instance_snapshot_input;

mod _create_instance_snapshot_output;
