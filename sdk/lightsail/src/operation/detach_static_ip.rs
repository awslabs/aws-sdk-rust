...
impl DetachStaticIpInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::detach_static_ip::DetachStaticIp,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_static_ip::DetachStaticIp::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachStaticIp {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detach_static_ip::de_detach_static_ip_http_error(
                status, headers, body,
            )
        } else {
