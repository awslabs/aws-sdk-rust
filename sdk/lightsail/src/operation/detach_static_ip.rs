...
impl DetachStaticIpInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_static_ip::DetachStaticIp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_static_ip::ser_detach_static_ip_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachStaticIp {
    type Output =
        ::std::result::Result<crate::operation::detach_static_ip::DetachStaticIpOutput, crate::operation::detach_static_ip::DetachStaticIpError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_static_ip::de_detach_static_ip_http_response_with_props(status, headers, body)
        }
    }
}
