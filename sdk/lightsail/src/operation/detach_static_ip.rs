...
impl DetachStaticIpInput {
    /// Consumes the builder and constructs an Operation<[`DetachStaticIp`](crate::operation::detach_static_ip::DetachStaticIp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_static_ip::DetachStaticIp, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_static_ip::DetachStaticIpInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_static_ip::ser_detach_static_ip_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_static_ip::DetachStaticIp::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachStaticIp", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DetachStaticIp`.
...
impl aws_smithy_http::response::ParseStrictResponse for DetachStaticIp {
                type Output = std::result::Result<crate::operation::detach_static_ip::DetachStaticIpOutput, crate::operation::detach_static_ip::DetachStaticIpError>;
