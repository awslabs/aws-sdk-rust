...
impl DetachDiskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detach_disk::DetachDisk::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachDisk {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detach_disk::de_detach_disk_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_detach_disk::de_detach_disk_http_response_with_props(
                status, headers, body,
            )
        }
    }
