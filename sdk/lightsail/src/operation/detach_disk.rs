...
impl DetachDiskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detach_disk::DetachDisk, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detach_disk::ser_detach_disk_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachDisk {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detach_disk::de_detach_disk_http_response_with_props(status, headers, body)
        }
    }
}
