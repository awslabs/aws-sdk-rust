...
impl DetachDiskInput {
    /// Consumes the builder and constructs an Operation<[`DetachDisk`](crate::operation::detach_disk::DetachDisk)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detach_disk::DetachDisk, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_disk::DetachDiskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_disk::ser_detach_disk_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detach_disk::DetachDisk::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DetachDisk", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DetachDisk {
                type Output = std::result::Result<crate::operation::detach_disk::DetachDiskOutput, crate::operation::detach_disk::DetachDiskError>;
