...
impl DeleteRelationalDatabase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_relational_database::DeleteRelationalDatabaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_relational_database::DeleteRelationalDatabaseOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DeleteRelationalDatabase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRelationalDatabase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteRelationalDatabaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteRelationalDatabaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteRelationalDatabase")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRelationalDatabase")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DeleteRelationalDatabaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteRelationalDatabaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRelationalDatabaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteRelationalDatabaseInput>() else {
        ...
        if requested.should_capture("finalRelationalDatabaseSnapshotName") {
            if let ::std::option::Option::Some(value) = input.final_relational_database_snapshot_name.as_deref() {
                captured.insert("finalRelationalDatabaseSnapshotName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRelationalDatabaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_relational_database::de_delete_relational_database_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_relational_database::de_delete_relational_database_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRelationalDatabaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_relational_database::DeleteRelationalDatabaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::delete_relational_database::DeleteRelationalDatabaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_relational_database::ser_delete_relational_database_input(&input)?,
        );
...
impl DeleteRelationalDatabaseError {
    ...
    /// Returns `true` if the error kind is `DeleteRelationalDatabaseError::RegionSetupInProgressException`.
