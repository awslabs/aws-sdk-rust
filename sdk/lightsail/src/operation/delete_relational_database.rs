...
impl DeleteRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRelationalDatabase`](crate::operation::delete_relational_database::DeleteRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_relational_database::DeleteRelationalDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_relational_database::DeleteRelationalDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_relational_database::ser_delete_relational_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_relational_database::DeleteRelationalDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteRelationalDatabase", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteRelationalDatabase`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRelationalDatabase {
                type Output = std::result::Result<crate::operation::delete_relational_database::DeleteRelationalDatabaseOutput, crate::operation::delete_relational_database::DeleteRelationalDatabaseError>;
