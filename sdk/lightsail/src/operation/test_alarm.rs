...
impl TestAlarmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::test_alarm::TestAlarm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_test_alarm::ser_test_alarm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestAlarm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_alarm::de_test_alarm_http_response_with_props(status, headers, body)
        }
    }
}
