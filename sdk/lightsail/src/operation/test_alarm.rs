...
impl TestAlarmInput {
    /// Consumes the builder and constructs an Operation<[`TestAlarm`](crate::operation::test_alarm::TestAlarm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::test_alarm::TestAlarm, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_alarm::TestAlarmInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_alarm::ser_test_alarm_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::test_alarm::TestAlarm::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TestAlarm", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `TestAlarm`.
...
impl aws_smithy_http::response::ParseStrictResponse for TestAlarm {
                type Output = std::result::Result<crate::operation::test_alarm::TestAlarmOutput, crate::operation::test_alarm::TestAlarmError>;
