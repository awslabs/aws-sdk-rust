...
impl GetDistributionBundles {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_distribution_bundles::GetDistributionBundlesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_distribution_bundles::GetDistributionBundlesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetDistributionBundles", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetDistributionBundles",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetDistributionBundles",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDistributionBundles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDistributionBundlesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDistributionBundlesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDistributionBundles")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDistributionBundlesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_distribution_bundles::de_get_distribution_bundles_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_distribution_bundles::de_get_distribution_bundles_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDistributionBundlesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_distribution_bundles::GetDistributionBundlesInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_distribution_bundles::ser_get_distribution_bundles_input(&input)?,
        );
