...
impl ImportKeyPairInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_key_pair::ser_import_key_pair_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_key_pair::ImportKeyPair::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportKeyPair", "lightsail"));
