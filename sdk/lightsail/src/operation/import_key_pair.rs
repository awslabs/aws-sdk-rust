...
impl ImportKeyPair {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "ImportKeyPair", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ImportKeyPairTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("keyPairName") {
            if let ::std::option::Option::Some(value) = input.key_pair_name.as_deref() {
                captured.insert("keyPairName", value);
            }
        }
        if requested.should_capture("publicKeyBase64") {
            if let ::std::option::Option::Some(value) = input.public_key_base64.as_deref() {
                captured.insert("publicKeyBase64", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ImportKeyPairRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_import_key_pair::ser_import_key_pair_input(&input)?);
...
impl ImportKeyPairError {
    ...
    /// Returns `true` if the error kind is `ImportKeyPairError::RegionSetupInProgressException`.
