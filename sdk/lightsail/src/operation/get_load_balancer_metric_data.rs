...
impl GetLoadBalancerMetricData {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetLoadBalancerMetricData",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLoadBalancerMetricData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetLoadBalancerMetricDataRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetLoadBalancerMetricDataResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetLoadBalancerMetricData")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLoadBalancerMetricData")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetLoadBalancerMetricDataTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetLoadBalancerMetricDataTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLoadBalancerMetricDataTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetLoadBalancerMetricDataInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoadBalancerMetricDataResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoadBalancerMetricDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancer_metric_data::ser_get_load_balancer_metric_data_input(&input)?,
        );
...
impl GetLoadBalancerMetricDataError {
    ...
    /// Returns `true` if the error kind is `GetLoadBalancerMetricDataError::RegionSetupInProgressException`.
