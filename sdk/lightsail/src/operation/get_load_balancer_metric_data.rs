...
impl GetLoadBalancerMetricDataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricData::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancerMetricData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data_http_response_with_props(
                status, headers, body,
            )
        }
    }
