...
impl GetDistributionLatestCacheResetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheReset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributionLatestCacheReset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_distribution_latest_cache_reset::de_get_distribution_latest_cache_reset_http_response_with_props(
                status, headers, body,
            )
        }
    }
