...
impl GetDistributionLatestCacheReset {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetDistributionLatestCacheReset",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDistributionLatestCacheReset {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDistributionLatestCacheResetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDistributionLatestCacheResetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDistributionLatestCacheReset")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDistributionLatestCacheReset")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetDistributionLatestCacheResetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetDistributionLatestCacheResetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDistributionLatestCacheResetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetDistributionLatestCacheResetInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDistributionLatestCacheResetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_distribution_latest_cache_reset::de_get_distribution_latest_cache_reset_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_get_distribution_latest_cache_reset::de_get_distribution_latest_cache_reset_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDistributionLatestCacheResetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_distribution_latest_cache_reset::ser_get_distribution_latest_cache_reset_input(&input)?,
        );
