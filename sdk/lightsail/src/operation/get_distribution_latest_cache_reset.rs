...
impl GetDistributionLatestCacheResetInput {
    /// Consumes the builder and constructs an Operation<[`GetDistributionLatestCacheReset`](crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheReset)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheReset, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_distribution_latest_cache_reset::ser_get_distribution_latest_cache_reset_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheReset::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDistributionLatestCacheReset", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDistributionLatestCacheReset {
                type Output = std::result::Result<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetOutput, crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_distribution_latest_cache_reset::de_get_distribution_latest_cache_reset_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_distribution_latest_cache_reset::de_get_distribution_latest_cache_reset_http_response(response)
                     }
                }
            }
