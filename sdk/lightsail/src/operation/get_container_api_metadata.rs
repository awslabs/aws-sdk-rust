    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_container_api_metadata::GetContainerAPIMetadataError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_container_api_metadata::GetContainerApiMetadataOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetContainerAPIMetadata", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.method" = "GetContainerAPIMetadata",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerAPIMetadata {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetContainerAPIMetadata")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContainerAPIMetadata")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContainerAPIMetadataResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_container_api_metadata::de_get_container_api_metadata_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_container_api_metadata::de_get_container_api_metadata_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContainerAPIMetadataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_container_api_metadata::GetContainerApiMetadataInput>()
            .expect("correct type");
