...
impl UpdateRelationalDatabase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateRelationalDatabase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRelationalDatabase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateRelationalDatabaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateRelationalDatabaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateRelationalDatabase")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateRelationalDatabaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_relational_database::de_update_relational_database_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_relational_database::de_update_relational_database_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRelationalDatabaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_relational_database::UpdateRelationalDatabaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_relational_database::ser_update_relational_database_input(&input)?,
        );
...
impl UpdateRelationalDatabaseError {
    ...
    /// Returns `true` if the error kind is `UpdateRelationalDatabaseError::RegionSetupInProgressException`.
