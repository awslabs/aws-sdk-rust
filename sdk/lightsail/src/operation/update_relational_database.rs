...
/// Orchestration and serialization glue logic for `UpdateRelationalDatabase`.
...
impl UpdateRelationalDatabase {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_relational_database::UpdateRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateRelationalDatabase {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateRelationalDatabase");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateRelationalDatabaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateRelationalDatabaseResponseDeserializer));
...
.with_interceptor(UpdateRelationalDatabaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_relational_database::UpdateRelationalDatabaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_relational_database::UpdateRelationalDatabaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_relational_database::UpdateRelationalDatabaseError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_relational_database::de_update_relational_database_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateRelationalDatabaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateRelationalDatabaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_relational_database::UpdateRelationalDatabaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_relational_database::UpdateRelationalDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_relational_database::ser_update_relational_database_input(&input)?);
...
#[derive(Debug)]
            struct UpdateRelationalDatabaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateRelationalDatabaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateRelationalDatabaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateRelationalDatabaseInput>()
                        .ok_or("failed to downcast to UpdateRelationalDatabaseInput")?;
...
pub enum UpdateRelationalDatabaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateRelationalDatabaseError) for what information is available for the error.")]
...
impl UpdateRelationalDatabaseError {
    /// Creates the `UpdateRelationalDatabaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRelationalDatabaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateRelationalDatabaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_relational_database::UpdateRelationalDatabaseError {
...
mod _update_relational_database_output;
