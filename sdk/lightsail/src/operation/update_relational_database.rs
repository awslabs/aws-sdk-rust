...
impl UpdateRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRelationalDatabase`](crate::operation::update_relational_database::UpdateRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_relational_database::UpdateRelationalDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_relational_database::UpdateRelationalDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_relational_database::ser_update_relational_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_relational_database::UpdateRelationalDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateRelationalDatabase", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateRelationalDatabase`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRelationalDatabase {
                type Output = std::result::Result<crate::operation::update_relational_database::UpdateRelationalDatabaseOutput, crate::operation::update_relational_database::UpdateRelationalDatabaseError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_relational_database::de_update_relational_database_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_relational_database::de_update_relational_database_http_response(response)
                     }
                }
            }
