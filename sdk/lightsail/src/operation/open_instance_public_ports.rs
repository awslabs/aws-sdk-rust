...
impl OpenInstancePublicPortsInput {
    /// Consumes the builder and constructs an Operation<[`OpenInstancePublicPorts`](crate::operation::open_instance_public_ports::OpenInstancePublicPorts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::open_instance_public_ports::OpenInstancePublicPorts, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_open_instance_public_ports::ser_open_instance_public_ports_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::open_instance_public_ports::OpenInstancePublicPorts::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("OpenInstancePublicPorts", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `OpenInstancePublicPorts`.
...
impl aws_smithy_http::response::ParseStrictResponse for OpenInstancePublicPorts {
                type Output = std::result::Result<crate::operation::open_instance_public_ports::OpenInstancePublicPortsOutput, crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_error(response)
                     } else {
                        crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_response(response)
                     }
                }
            }
