...
/// Orchestration and serialization glue logic for `OpenInstancePublicPorts`.
...
impl OpenInstancePublicPorts {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput,
                    ) -> ::std::result::Result<crate::operation::open_instance_public_ports::OpenInstancePublicPortsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for OpenInstancePublicPorts {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("OpenInstancePublicPorts");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(OpenInstancePublicPortsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(OpenInstancePublicPortsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("OpenInstancePublicPorts")
...
.with_interceptor(OpenInstancePublicPortsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>::new());
...
#[derive(Debug)]
            struct OpenInstancePublicPortsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for OpenInstancePublicPortsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct OpenInstancePublicPortsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for OpenInstancePublicPortsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_open_instance_public_ports::ser_open_instance_public_ports_input(&input)?);
...
#[derive(Debug)]
            struct OpenInstancePublicPortsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for OpenInstancePublicPortsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "OpenInstancePublicPortsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<OpenInstancePublicPortsInput>()
                        .ok_or("failed to downcast to OpenInstancePublicPortsInput")?;
...
pub enum OpenInstancePublicPortsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-OpenInstancePublicPortsError) for what information is available for the error.")]
...
impl OpenInstancePublicPortsError {
    /// Creates the `OpenInstancePublicPortsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `OpenInstancePublicPortsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for OpenInstancePublicPortsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::open_instance_public_ports::OpenInstancePublicPortsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::open_instance_public_ports::_open_instance_public_ports_output::OpenInstancePublicPortsOutput;

pub use crate::operation::open_instance_public_ports::_open_instance_public_ports_input::OpenInstancePublicPortsInput;

mod _open_instance_public_ports_input;

mod _open_instance_public_ports_output;
