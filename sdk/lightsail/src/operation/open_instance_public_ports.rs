...
impl OpenInstancePublicPorts {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "OpenInstancePublicPorts", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.OpenInstancePublicPorts",
                "rpc.service" = "Lightsail",
                "rpc.method" = "OpenInstancePublicPorts",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for OpenInstancePublicPorts {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            OpenInstancePublicPortsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            OpenInstancePublicPortsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("OpenInstancePublicPorts")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("OpenInstancePublicPorts")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                OpenInstancePublicPortsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct OpenInstancePublicPortsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for OpenInstancePublicPortsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<OpenInstancePublicPortsInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("instanceName") {
            if let ::std::option::Option::Some(value) = input.instance_name.as_deref() {
                captured.insert("instanceName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for OpenInstancePublicPortsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for OpenInstancePublicPortsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_open_instance_public_ports::ser_open_instance_public_ports_input(&input)?,
        );
...
impl OpenInstancePublicPortsError {
    ...
    /// Returns `true` if the error kind is `OpenInstancePublicPortsError::RegionSetupInProgressException`.
