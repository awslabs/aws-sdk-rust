...
impl OpenInstancePublicPortsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::open_instance_public_ports::OpenInstancePublicPorts,
...
impl ::aws_smithy_http::response::ParseStrictResponse for OpenInstancePublicPorts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_open_instance_public_ports::de_open_instance_public_ports_http_response_with_props(status, headers, body)
        }
    }
}
