...
impl crate::operation::get_relational_database_log_streams::builders::GetRelationalDatabaseLogStreamsInputBuilder {
...
impl GetRelationalDatabaseLogStreamsFluentBuilder {
    /// Creates a new `GetRelationalDatabaseLogStreamsFluentBuilder`.
