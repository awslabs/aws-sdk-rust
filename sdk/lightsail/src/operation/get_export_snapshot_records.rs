...
impl GetExportSnapshotRecordsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_export_snapshot_records::GetExportSnapshotRecords::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExportSnapshotRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_export_snapshot_records::de_get_export_snapshot_records_http_response_with_props(status, headers, body)
        }
    }
}
