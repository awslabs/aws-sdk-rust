...
/// Orchestration and serialization glue logic for `GetExportSnapshotRecords`.
...
impl GetExportSnapshotRecords {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetExportSnapshotRecords {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetExportSnapshotRecords");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetExportSnapshotRecordsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetExportSnapshotRecordsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetExportSnapshotRecords")
...
.with_interceptor(GetExportSnapshotRecordsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError>::new());
...
#[derive(Debug)]
            struct GetExportSnapshotRecordsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetExportSnapshotRecordsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_export_snapshot_records::de_get_export_snapshot_records_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_export_snapshot_records::de_get_export_snapshot_records_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetExportSnapshotRecordsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetExportSnapshotRecordsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_export_snapshot_records::ser_get_export_snapshot_records_input(&input)?);
...
#[derive(Debug)]
            struct GetExportSnapshotRecordsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetExportSnapshotRecordsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetExportSnapshotRecordsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetExportSnapshotRecordsInput>()
                        .ok_or("failed to downcast to GetExportSnapshotRecordsInput")?;
...
pub enum GetExportSnapshotRecordsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetExportSnapshotRecordsError) for what information is available for the error.")]
...
impl GetExportSnapshotRecordsError {
    /// Creates the `GetExportSnapshotRecordsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetExportSnapshotRecordsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetExportSnapshotRecordsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_export_snapshot_records::_get_export_snapshot_records_output::GetExportSnapshotRecordsOutput;

pub use crate::operation::get_export_snapshot_records::_get_export_snapshot_records_input::GetExportSnapshotRecordsInput;

mod _get_export_snapshot_records_input;

mod _get_export_snapshot_records_output;
