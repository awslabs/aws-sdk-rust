...
impl GetExportSnapshotRecords {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetExportSnapshotRecords",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetExportSnapshotRecords {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetExportSnapshotRecordsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetExportSnapshotRecordsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetExportSnapshotRecords")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetExportSnapshotRecords")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetExportSnapshotRecordsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetExportSnapshotRecordsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetExportSnapshotRecordsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetExportSnapshotRecordsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetExportSnapshotRecordsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_export_snapshot_records::de_get_export_snapshot_records_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_export_snapshot_records::de_get_export_snapshot_records_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetExportSnapshotRecordsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_export_snapshot_records::GetExportSnapshotRecordsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_export_snapshot_records::ser_get_export_snapshot_records_input(&input)?,
        );
...
impl GetExportSnapshotRecordsError {
    ...
    /// Returns `true` if the error kind is `GetExportSnapshotRecordsError::RegionSetupInProgressException`.
