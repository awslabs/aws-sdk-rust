...
impl IsVpcPeered {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::is_vpc_peered::IsVpcPeeredError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::is_vpc_peered::IsVpcPeeredOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "IsVpcPeered", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.IsVpcPeered",
                "rpc.service" = "Lightsail",
                "rpc.method" = "IsVpcPeered",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for IsVpcPeered {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            IsVpcPeeredRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            IsVpcPeeredResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("IsVpcPeered")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("IsVpcPeered", "Lightsail"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for IsVpcPeeredResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for IsVpcPeeredRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::is_vpc_peered::IsVpcPeeredInput>()
            .expect("correct type");
...
impl IsVpcPeeredError {
    ...
    /// Returns `true` if the error kind is `IsVpcPeeredError::RegionSetupInProgressException`.
