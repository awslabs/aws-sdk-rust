...
impl IsVpcPeeredInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::is_vpc_peered::IsVpcPeered, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_is_vpc_peered::ser_is_vpc_peered_input(&self)?);
