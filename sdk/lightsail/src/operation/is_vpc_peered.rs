...
impl IsVpcPeeredInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::is_vpc_peered::IsVpcPeered::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsVpcPeered {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_response_with_props(
                status, headers, body,
            )
        }
    }
