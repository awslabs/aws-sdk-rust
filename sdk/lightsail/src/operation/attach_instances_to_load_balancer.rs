...
impl AttachInstancesToLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`AttachInstancesToLoadBalancer`](crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_instances_to_load_balancer::ser_attach_instances_to_load_balancer_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AttachInstancesToLoadBalancer", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for AttachInstancesToLoadBalancer {
                type Output = std::result::Result<crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerOutput, crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerError>;
