...
impl AttachInstancesToLoadBalancerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachInstancesToLoadBalancer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_instances_to_load_balancer::de_attach_instances_to_load_balancer_http_response_with_props(
                status, headers, body,
            )
        }
    }
