...
impl AttachInstancesToLoadBalancer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AttachInstancesToLoadBalancer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AttachInstancesToLoadBalancer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AttachInstancesToLoadBalancerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AttachInstancesToLoadBalancerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AttachInstancesToLoadBalancer")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AttachInstancesToLoadBalancer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AttachInstancesToLoadBalancerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AttachInstancesToLoadBalancerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AttachInstancesToLoadBalancerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AttachInstancesToLoadBalancerInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AttachInstancesToLoadBalancerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_attach_instances_to_load_balancer::de_attach_instances_to_load_balancer_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_attach_instances_to_load_balancer::de_attach_instances_to_load_balancer_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AttachInstancesToLoadBalancerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::attach_instances_to_load_balancer::AttachInstancesToLoadBalancerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_attach_instances_to_load_balancer::ser_attach_instances_to_load_balancer_input(&input)?,
        );
...
impl AttachInstancesToLoadBalancerError {
    ...
    /// Returns `true` if the error kind is `AttachInstancesToLoadBalancerError::RegionSetupInProgressException`.
