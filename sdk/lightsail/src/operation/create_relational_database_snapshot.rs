...
impl CreateRelationalDatabaseSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRelationalDatabaseSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_relational_database_snapshot::de_create_relational_database_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
