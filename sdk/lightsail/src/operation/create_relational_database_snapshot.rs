...
impl CreateRelationalDatabaseSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateRelationalDatabaseSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRelationalDatabaseSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateRelationalDatabaseSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateRelationalDatabaseSnapshotResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateRelationalDatabaseSnapshot")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateRelationalDatabaseSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRelationalDatabaseSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateRelationalDatabaseSnapshotInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRelationalDatabaseSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_relational_database_snapshot::de_create_relational_database_snapshot_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_create_relational_database_snapshot::de_create_relational_database_snapshot_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRelationalDatabaseSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_relational_database_snapshot::ser_create_relational_database_snapshot_input(&input)?,
        );
...
impl CreateRelationalDatabaseSnapshotError {
    ...
    /// Returns `true` if the error kind is `CreateRelationalDatabaseSnapshotError::RegionSetupInProgressException`.
