...
impl DetachInstancesFromLoadBalancer {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::detach_instances_from_load_balancer::DetachInstancesFromLoadBalancerError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::detach_instances_from_load_balancer::DetachInstancesFromLoadBalancerOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DetachInstancesFromLoadBalancer",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetachInstancesFromLoadBalancer {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DetachInstancesFromLoadBalancerRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DetachInstancesFromLoadBalancerResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DetachInstancesFromLoadBalancer")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetachInstancesFromLoadBalancer")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DetachInstancesFromLoadBalancerTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DetachInstancesFromLoadBalancerTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetachInstancesFromLoadBalancerTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DetachInstancesFromLoadBalancerInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetachInstancesFromLoadBalancerResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_detach_instances_from_load_balancer::de_detach_instances_from_load_balancer_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetachInstancesFromLoadBalancerRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::detach_instances_from_load_balancer::DetachInstancesFromLoadBalancerInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::detach_instances_from_load_balancer::DetachInstancesFromLoadBalancerInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_detach_instances_from_load_balancer::ser_detach_instances_from_load_balancer_input(&input)?,
        );
...
impl DetachInstancesFromLoadBalancerError {
    ...
    /// Returns `true` if the error kind is `DetachInstancesFromLoadBalancerError::RegionSetupInProgressException`.
