...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInstanceMetadataOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_instance_metadata_options::de_update_instance_metadata_options_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError
{
