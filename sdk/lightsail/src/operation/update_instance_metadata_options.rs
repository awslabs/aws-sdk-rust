...
impl UpdateInstanceMetadataOptionsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateInstanceMetadataOptions`](crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_instance_metadata_options::ser_update_instance_metadata_options_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateInstanceMetadataOptions", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateInstanceMetadataOptions {
                type Output = std::result::Result<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsOutput, crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError>;
