...
impl UpdateInstanceMetadataOptions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsInput,
                    ) -> ::std::result::Result<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateInstanceMetadataOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateInstanceMetadataOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateInstanceMetadataOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateInstanceMetadataOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateInstanceMetadataOptions")
...
.with_interceptor(UpdateInstanceMetadataOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError>::new());
...
#[derive(Debug)]
            struct UpdateInstanceMetadataOptionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateInstanceMetadataOptionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_instance_metadata_options::de_update_instance_metadata_options_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_instance_metadata_options::de_update_instance_metadata_options_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateInstanceMetadataOptionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateInstanceMetadataOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_instance_metadata_options::ser_update_instance_metadata_options_input(&input)?);
...
#[derive(Debug)]
            struct UpdateInstanceMetadataOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateInstanceMetadataOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateInstanceMetadataOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateInstanceMetadataOptionsInput>()
                        .ok_or("failed to downcast to UpdateInstanceMetadataOptionsInput")?;
...
pub enum UpdateInstanceMetadataOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateInstanceMetadataOptionsError) for what information is available for the error.")]
...
impl UpdateInstanceMetadataOptionsError {
    /// Creates the `UpdateInstanceMetadataOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateInstanceMetadataOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateInstanceMetadataOptionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateInstanceMetadataOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_instance_metadata_options::_update_instance_metadata_options_output::UpdateInstanceMetadataOptionsOutput;

pub use crate::operation::update_instance_metadata_options::_update_instance_metadata_options_input::UpdateInstanceMetadataOptionsInput;

mod _update_instance_metadata_options_input;

mod _update_instance_metadata_options_output;
