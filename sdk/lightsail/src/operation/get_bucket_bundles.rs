...
impl GetBucketBundlesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_bucket_bundles::GetBucketBundles,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_bucket_bundles::ser_get_bucket_bundles_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketBundles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_bucket_bundles::de_get_bucket_bundles_http_response_with_props(status, headers, body)
        }
    }
}
