...
impl GetBucketBundlesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_bucket_bundles::GetBucketBundles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketBundles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_bucket_bundles::de_get_bucket_bundles_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_bucket_bundles::GetBucketBundlesError
{
