...
impl GetBucketBundles {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_bucket_bundles::GetBucketBundlesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_bucket_bundles::GetBucketBundlesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetBucketBundles", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetBucketBundles",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetBucketBundles",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetBucketBundles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetBucketBundlesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetBucketBundlesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetBucketBundles")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetBucketBundlesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_bucket_bundles::GetBucketBundlesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_bucket_bundles::GetBucketBundlesInput,
...
impl GetBucketBundlesError {
    ...
    /// Returns `true` if the error kind is `GetBucketBundlesError::RegionSetupInProgressException`.
