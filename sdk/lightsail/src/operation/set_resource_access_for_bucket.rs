...
impl SetResourceAccessForBucketInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucket::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetResourceAccessForBucket {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_response_with_props(
                status, headers, body,
            )
        }
    }
