...
impl SetResourceAccessForBucket {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "SetResourceAccessForBucket",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetResourceAccessForBucket {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetResourceAccessForBucketRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetResourceAccessForBucketResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetResourceAccessForBucket")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetResourceAccessForBucket")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetResourceAccessForBucketTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetResourceAccessForBucketTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetResourceAccessForBucketTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetResourceAccessForBucketInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetResourceAccessForBucketResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetResourceAccessForBucketRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_set_resource_access_for_bucket::ser_set_resource_access_for_bucket_input(&input)?,
        );
...
impl SetResourceAccessForBucketError {
    ...
    /// Returns `true` if the error kind is `SetResourceAccessForBucketError::RegionSetupInProgressException`.
