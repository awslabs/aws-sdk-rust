...
impl GetContactMethodsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_contact_methods::ser_get_contact_methods_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContactMethods {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_contact_methods::de_get_contact_methods_http_response_with_props(status, headers, body)
        }
    }
}
