...
impl GetContactMethodsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_contact_methods::GetContactMethods::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContactMethods {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_contact_methods::de_get_contact_methods_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_contact_methods::GetContactMethodsError
{
