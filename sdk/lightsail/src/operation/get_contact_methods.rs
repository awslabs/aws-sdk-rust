...
/// Orchestration and serialization glue logic for `GetContactMethods`.
...
impl GetContactMethods {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_contact_methods::GetContactMethodsInput,
                    ) -> ::std::result::Result<crate::operation::get_contact_methods::GetContactMethodsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_contact_methods::GetContactMethodsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_contact_methods::GetContactMethodsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_contact_methods::GetContactMethodsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContactMethods {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetContactMethods");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetContactMethodsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetContactMethodsResponseDeserializer));
...
.with_interceptor(GetContactMethodsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_contact_methods::GetContactMethodsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_contact_methods::GetContactMethodsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_contact_methods::GetContactMethodsError>::new());
...
#[derive(Debug)]
            struct GetContactMethodsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContactMethodsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_contact_methods::de_get_contact_methods_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetContactMethodsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContactMethodsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_contact_methods::GetContactMethodsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_contact_methods::GetContactMethodsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_contact_methods::ser_get_contact_methods_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContactMethodsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetContactMethodsInput>()
                        .ok_or("failed to downcast to GetContactMethodsInput")?;
...
pub enum GetContactMethodsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetContactMethodsError) for what information is available for the error.")]
...
impl GetContactMethodsError {
    /// Creates the `GetContactMethodsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetContactMethodsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetContactMethodsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_contact_methods::GetContactMethodsError {
...
mod _get_contact_methods_output;
