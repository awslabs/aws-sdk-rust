...
impl GetContactMethodsInput {
    /// Consumes the builder and constructs an Operation<[`GetContactMethods`](crate::operation::get_contact_methods::GetContactMethods)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_contact_methods::GetContactMethods, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_contact_methods::GetContactMethodsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_contact_methods::ser_get_contact_methods_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_contact_methods::GetContactMethods::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetContactMethods", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetContactMethods`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetContactMethods {
                type Output = std::result::Result<crate::operation::get_contact_methods::GetContactMethodsOutput, crate::operation::get_contact_methods::GetContactMethodsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_contact_methods::de_get_contact_methods_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_contact_methods::de_get_contact_methods_http_response(response)
                     }
                }
            }
