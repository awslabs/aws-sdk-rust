...
impl GetStaticIpsFluentBuilder  {
    /// Creates a new `GetStaticIps`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_static_ips::GetStaticIpsOutput, aws_smithy_http::result::SdkError<crate::operation::get_static_ips::GetStaticIpsError>>
                     {
