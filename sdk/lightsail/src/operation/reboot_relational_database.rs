...
impl RebootRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`RebootRelationalDatabase`](crate::operation::reboot_relational_database::RebootRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_relational_database::RebootRelationalDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_relational_database::RebootRelationalDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_relational_database::ser_reboot_relational_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_relational_database::RebootRelationalDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RebootRelationalDatabase", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for RebootRelationalDatabase {
                type Output = std::result::Result<crate::operation::reboot_relational_database::RebootRelationalDatabaseOutput, crate::operation::reboot_relational_database::RebootRelationalDatabaseError>;
