...
impl RebootRelationalDatabase {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::reboot_relational_database::RebootRelationalDatabaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::reboot_relational_database::RebootRelationalDatabaseOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RebootRelationalDatabase",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RebootRelationalDatabase {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RebootRelationalDatabaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RebootRelationalDatabaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RebootRelationalDatabase")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RebootRelationalDatabase")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RebootRelationalDatabaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RebootRelationalDatabaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RebootRelationalDatabaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RebootRelationalDatabaseInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RebootRelationalDatabaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_reboot_relational_database::de_reboot_relational_database_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_reboot_relational_database::de_reboot_relational_database_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RebootRelationalDatabaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::reboot_relational_database::RebootRelationalDatabaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::reboot_relational_database::RebootRelationalDatabaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_relational_database::ser_reboot_relational_database_input(&input)?,
        );
...
impl RebootRelationalDatabaseError {
    ...
    /// Returns `true` if the error kind is `RebootRelationalDatabaseError::RegionSetupInProgressException`.
