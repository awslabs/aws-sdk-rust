...
impl EnableAddOnInput {
    /// Consumes the builder and constructs an Operation<[`EnableAddOn`](crate::operation::enable_add_on::EnableAddOn)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::enable_add_on::EnableAddOn, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_add_on::EnableAddOnInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_add_on::ser_enable_add_on_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::enable_add_on::EnableAddOn::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("EnableAddOn", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `EnableAddOn`.
...
impl aws_smithy_http::response::ParseStrictResponse for EnableAddOn {
                type Output = std::result::Result<crate::operation::enable_add_on::EnableAddOnOutput, crate::operation::enable_add_on::EnableAddOnError>;
