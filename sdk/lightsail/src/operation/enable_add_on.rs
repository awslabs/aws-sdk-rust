...
impl EnableAddOnInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::enable_add_on::EnableAddOn,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_add_on::EnableAddOn::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableAddOn {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_enable_add_on::de_enable_add_on_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_enable_add_on::de_enable_add_on_http_response_with_props(
                status, headers, body,
            )
        }
    }
