...
impl GetLoadBalancersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_load_balancers::GetLoadBalancers,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_load_balancers::ser_get_load_balancers_input(&self)?);
