...
impl GetLoadBalancers {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_load_balancers::GetLoadBalancersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_load_balancers::GetLoadBalancersOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetLoadBalancers", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetLoadBalancers",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetLoadBalancers",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLoadBalancers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetLoadBalancersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetLoadBalancersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetLoadBalancers")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetLoadBalancers")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetLoadBalancersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetLoadBalancersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLoadBalancersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetLoadBalancersInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetLoadBalancersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_load_balancers::de_get_load_balancers_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_load_balancers::de_get_load_balancers_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLoadBalancersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_load_balancers::GetLoadBalancersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_load_balancers::GetLoadBalancersInput,
...
impl GetLoadBalancersError {
    ...
    /// Returns `true` if the error kind is `GetLoadBalancersError::RegionSetupInProgressException`.
