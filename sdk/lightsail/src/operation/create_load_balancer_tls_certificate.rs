...
impl CreateLoadBalancerTlsCertificate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateLoadBalancerTlsCertificate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLoadBalancerTlsCertificate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateLoadBalancerTlsCertificateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateLoadBalancerTlsCertificateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateLoadBalancerTlsCertificate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLoadBalancerTlsCertificate")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLoadBalancerTlsCertificateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateLoadBalancerTlsCertificateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLoadBalancerTlsCertificateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_load_balancer_tls_certificate::de_create_load_balancer_tls_certificate_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_load_balancer_tls_certificate::de_create_load_balancer_tls_certificate_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLoadBalancerTlsCertificateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_load_balancer_tls_certificate::ser_create_load_balancer_tls_certificate_input(&input)?,
        );
...
impl CreateLoadBalancerTlsCertificateError {
    ...
    /// Returns `true` if the error kind is `CreateLoadBalancerTlsCertificateError::RegionSetupInProgressException`.
