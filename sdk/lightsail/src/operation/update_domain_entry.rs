...
impl UpdateDomainEntryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_domain_entry::ser_update_domain_entry_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainEntry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_entry::de_update_domain_entry_http_response_with_props(status, headers, body)
        }
    }
}
