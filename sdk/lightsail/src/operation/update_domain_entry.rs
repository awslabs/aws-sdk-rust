...
impl UpdateDomainEntryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDomainEntry`](crate::operation::update_domain_entry::UpdateDomainEntry)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_domain_entry::UpdateDomainEntry, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_domain_entry::UpdateDomainEntryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_domain_entry::ser_update_domain_entry_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_entry::UpdateDomainEntry::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateDomainEntry", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateDomainEntry`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDomainEntry {
                type Output = std::result::Result<crate::operation::update_domain_entry::UpdateDomainEntryOutput, crate::operation::update_domain_entry::UpdateDomainEntryError>;
