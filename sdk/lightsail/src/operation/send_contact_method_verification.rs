...
impl SendContactMethodVerificationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_contact_method_verification::SendContactMethodVerification::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendContactMethodVerification {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_response_with_props(
                status, headers, body,
            )
        }
    }
