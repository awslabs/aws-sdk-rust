...
/// Orchestration and serialization glue logic for `SendContactMethodVerification`.
...
impl SendContactMethodVerification {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::send_contact_method_verification::SendContactMethodVerificationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::send_contact_method_verification::SendContactMethodVerificationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendContactMethodVerification {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SendContactMethodVerification");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SendContactMethodVerificationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SendContactMethodVerificationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SendContactMethodVerification")
...
.with_interceptor(SendContactMethodVerificationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::send_contact_method_verification::SendContactMethodVerificationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::send_contact_method_verification::SendContactMethodVerificationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::send_contact_method_verification::SendContactMethodVerificationError>::new());
...
#[derive(Debug)]
            struct SendContactMethodVerificationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendContactMethodVerificationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SendContactMethodVerificationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendContactMethodVerificationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::send_contact_method_verification::SendContactMethodVerificationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_send_contact_method_verification::ser_send_contact_method_verification_input(&input)?);
...
#[derive(Debug)]
            struct SendContactMethodVerificationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SendContactMethodVerificationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SendContactMethodVerificationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SendContactMethodVerificationInput>()
                        .ok_or("failed to downcast to SendContactMethodVerificationInput")?;
...
pub enum SendContactMethodVerificationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SendContactMethodVerificationError) for what information is available for the error.")]
...
impl SendContactMethodVerificationError {
    /// Creates the `SendContactMethodVerificationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendContactMethodVerificationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SendContactMethodVerificationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SendContactMethodVerificationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::send_contact_method_verification::SendContactMethodVerificationError {
...
mod _send_contact_method_verification_output;
