...
impl SendContactMethodVerification {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "SendContactMethodVerification",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SendContactMethodVerification {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SendContactMethodVerificationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SendContactMethodVerificationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SendContactMethodVerification")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SendContactMethodVerificationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SendContactMethodVerificationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::send_contact_method_verification::SendContactMethodVerificationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::send_contact_method_verification::SendContactMethodVerificationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_send_contact_method_verification::ser_send_contact_method_verification_input(&input)?,
        );
...
impl SendContactMethodVerificationError {
    ...
    /// Returns `true` if the error kind is `SendContactMethodVerificationError::RegionSetupInProgressException`.
