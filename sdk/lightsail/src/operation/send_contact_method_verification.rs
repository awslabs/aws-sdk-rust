...
impl SendContactMethodVerificationInput {
    /// Consumes the builder and constructs an Operation<[`SendContactMethodVerification`](crate::operation::send_contact_method_verification::SendContactMethodVerification)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_contact_method_verification::SendContactMethodVerification, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_contact_method_verification::SendContactMethodVerificationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_send_contact_method_verification::ser_send_contact_method_verification_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_contact_method_verification::SendContactMethodVerification::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendContactMethodVerification", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SendContactMethodVerification`.
...
impl aws_smithy_http::response::ParseStrictResponse for SendContactMethodVerification {
                type Output = std::result::Result<crate::operation::send_contact_method_verification::SendContactMethodVerificationOutput, crate::operation::send_contact_method_verification::SendContactMethodVerificationError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_error(response)
                     } else {
                        crate::protocol_serde::shape_send_contact_method_verification::de_send_contact_method_verification_http_response(response)
                     }
                }
            }
