...
impl GetKeyPairInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_key_pair::GetKeyPair::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKeyPair {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_key_pair::de_get_key_pair_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_key_pair::de_get_key_pair_http_response_with_props(
                status, headers, body,
            )
        }
    }
