...
pub use crate::operation::get_disk_snapshot::_get_disk_snapshot_output::GetDiskSnapshotOutputBuilder;
...
pub struct GetDiskSnapshotFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_disk_snapshot::builders::GetDiskSnapshotInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_disk_snapshot::GetDiskSnapshotOutput,
                    crate::operation::get_disk_snapshot::GetDiskSnapshotError,
                > for GetDiskSnapshotFluentBuilder
            {
                fn send(
                    self,
...
impl GetDiskSnapshotFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_disk_snapshot::GetDiskSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_disk_snapshot::GetDiskSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_disk_snapshot::GetDiskSnapshot::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_disk_snapshot::GetDiskSnapshot::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_disk_snapshot::GetDiskSnapshotOutput, crate::operation::get_disk_snapshot::GetDiskSnapshotError, Self> {
