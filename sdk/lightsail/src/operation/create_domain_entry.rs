...
impl CreateDomainEntryInput {
    /// Consumes the builder and constructs an Operation<[`CreateDomainEntry`](crate::operation::create_domain_entry::CreateDomainEntry)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_domain_entry::CreateDomainEntry, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_domain_entry::CreateDomainEntryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_domain_entry::ser_create_domain_entry_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_domain_entry::CreateDomainEntry::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDomainEntry", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDomainEntry {
                type Output = std::result::Result<crate::operation::create_domain_entry::CreateDomainEntryOutput, crate::operation::create_domain_entry::CreateDomainEntryError>;
