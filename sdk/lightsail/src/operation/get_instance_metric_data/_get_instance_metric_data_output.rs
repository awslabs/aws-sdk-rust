...
impl ::aws_http::request_id::RequestId for GetInstanceMetricDataOutput {
...
impl GetInstanceMetricDataOutput {
    ...
    pub fn builder(
    ) -> crate::operation::get_instance_metric_data::builders::GetInstanceMetricDataOutputBuilder
    {
