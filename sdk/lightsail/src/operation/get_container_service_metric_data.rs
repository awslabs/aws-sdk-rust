...
impl GetContainerServiceMetricData {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetContainerServiceMetricData",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerServiceMetricData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetContainerServiceMetricDataRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetContainerServiceMetricDataResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetContainerServiceMetricData")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetContainerServiceMetricData")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetContainerServiceMetricDataTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetContainerServiceMetricDataTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetContainerServiceMetricDataTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetContainerServiceMetricDataInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetContainerServiceMetricDataResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_container_service_metric_data::de_get_container_service_metric_data_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_get_container_service_metric_data::de_get_container_service_metric_data_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetContainerServiceMetricDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput>()
            .expect("correct type");
...
impl GetContainerServiceMetricDataError {
    ...
    /// Returns `true` if the error kind is `GetContainerServiceMetricDataError::RegionSetupInProgressException`.
