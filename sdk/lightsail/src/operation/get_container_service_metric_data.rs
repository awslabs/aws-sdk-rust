    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetContainerServiceMetricData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetContainerServiceMetricData", "lightsail"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetContainerServiceMetricDataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetContainerServiceMetricDataRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetContainerServiceMetricDataEndpointParamsInterceptor {
