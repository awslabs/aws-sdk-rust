...
impl GetCloudFormationStackRecords {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput,
                    ) -> ::std::result::Result<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCloudFormationStackRecords {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCloudFormationStackRecords");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCloudFormationStackRecordsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCloudFormationStackRecordsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCloudFormationStackRecords")
...
.with_interceptor(GetCloudFormationStackRecordsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>::new());
...
#[derive(Debug)]
            struct GetCloudFormationStackRecordsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCloudFormationStackRecordsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_cloud_formation_stack_records::de_get_cloud_formation_stack_records_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_cloud_formation_stack_records::de_get_cloud_formation_stack_records_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCloudFormationStackRecordsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCloudFormationStackRecordsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_cloud_formation_stack_records::ser_get_cloud_formation_stack_records_input(&input)?);
...
#[derive(Debug)]
            struct GetCloudFormationStackRecordsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCloudFormationStackRecordsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCloudFormationStackRecordsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCloudFormationStackRecordsInput>()
                        .ok_or("failed to downcast to GetCloudFormationStackRecordsInput")?;
...
pub enum GetCloudFormationStackRecordsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCloudFormationStackRecordsError) for what information is available for the error.")]
...
impl GetCloudFormationStackRecordsError {
    /// Creates the `GetCloudFormationStackRecordsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCloudFormationStackRecordsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCloudFormationStackRecordsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCloudFormationStackRecordsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError {
...
mod _get_cloud_formation_stack_records_output;
