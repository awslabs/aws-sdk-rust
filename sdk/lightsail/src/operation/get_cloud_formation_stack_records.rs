...
impl GetCloudFormationStackRecordsInput {
    /// Consumes the builder and constructs an Operation<[`GetCloudFormationStackRecords`](crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecords)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecords, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_cloud_formation_stack_records::ser_get_cloud_formation_stack_records_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecords::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetCloudFormationStackRecords", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetCloudFormationStackRecords {
                type Output = std::result::Result<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsOutput, crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>;
