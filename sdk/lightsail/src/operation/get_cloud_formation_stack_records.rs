...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCloudFormationStackRecords {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cloud_formation_stack_records::de_get_cloud_formation_stack_records_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError
{
