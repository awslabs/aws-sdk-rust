...
impl GetCloudFormationStackRecords {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetCloudFormationStackRecords",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCloudFormationStackRecords {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetCloudFormationStackRecordsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetCloudFormationStackRecordsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetCloudFormationStackRecords")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCloudFormationStackRecords")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCloudFormationStackRecordsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetCloudFormationStackRecordsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCloudFormationStackRecordsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetCloudFormationStackRecordsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCloudFormationStackRecordsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_cloud_formation_stack_records::GetCloudFormationStackRecordsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_cloud_formation_stack_records::ser_get_cloud_formation_stack_records_input(&input)?,
        );
...
impl GetCloudFormationStackRecordsError {
    ...
    /// Returns `true` if the error kind is `GetCloudFormationStackRecordsError::RegionSetupInProgressException`.
