...
impl GetDistributionLatestCacheResetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetOutput, crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetError, Self> {
