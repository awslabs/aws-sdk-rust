...
impl GetAlarmsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_alarms::GetAlarms, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_alarms::ser_get_alarms_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAlarms {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_alarms::de_get_alarms_http_response_with_props(status, headers, body)
        }
    }
}
