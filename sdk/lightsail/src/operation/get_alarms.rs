...
impl GetAlarms {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_alarms::GetAlarmsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_alarms::GetAlarmsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetAlarms", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetAlarms",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetAlarms",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAlarms {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetAlarmsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetAlarmsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetAlarms")
                .build()
                .expect("required fields set"),
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("GetAlarms", "Lightsail"));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAlarms")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetAlarmsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetAlarmsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAlarmsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetAlarmsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAlarmsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_alarms::de_get_alarms_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_alarms::de_get_alarms_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAlarmsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_alarms::GetAlarmsInput,
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.alarm_name {
                    {
                        query.push_kv("alarmName", &::aws_smithy_http::query::fmt_string(inner_1));
                    }
                }
                if let ::std::option::Option::Some(inner_2) = &_input.page_token {
                    {
                        query.push_kv("pageToken", &::aws_smithy_http::query::fmt_string(inner_2));
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.monitored_resource_name {
                    {
                        query.push_kv("monitoredResourceName", &::aws_smithy_http::query::fmt_string(inner_3));
                    }
                }
                ::std::result::Result::Ok(())
            }
...
impl GetAlarmsError {
    ...
    /// Returns `true` if the error kind is `GetAlarmsError::RegionSetupInProgressException`.
