...
impl GetAlarmsInput {
    /// Consumes the builder and constructs an Operation<[`GetAlarms`](crate::operation::get_alarms::GetAlarms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_alarms::GetAlarms, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_alarms::GetAlarmsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_alarms::ser_get_alarms_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_alarms::GetAlarms::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAlarms", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAlarms {
                type Output = std::result::Result<crate::operation::get_alarms::GetAlarmsOutput, crate::operation::get_alarms::GetAlarmsError>;
