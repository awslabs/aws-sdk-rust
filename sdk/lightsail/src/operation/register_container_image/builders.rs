...
impl RegisterContainerImageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_container_image::RegisterContainerImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_container_image::RegisterContainerImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_container_image::RegisterContainerImageOutput, crate::operation::register_container_image::RegisterContainerImageError, Self> {
