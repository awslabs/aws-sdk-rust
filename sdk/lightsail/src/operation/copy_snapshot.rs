...
impl CopySnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_snapshot::CopySnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_snapshot::CopySnapshotOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "CopySnapshot", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopySnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopySnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopySnapshotResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("CopySnapshot", "Lightsail"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopySnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("sourceSnapshotName") {
            if let ::std::option::Option::Some(value) = input.source_snapshot_name.as_deref() {
                captured.insert("sourceSnapshotName", value);
            }
        }
        if requested.should_capture("sourceResourceName") {
            if let ::std::option::Option::Some(value) = input.source_resource_name.as_deref() {
                captured.insert("sourceResourceName", value);
            }
        }
        if requested.should_capture("restoreDate") {
            if let ::std::option::Option::Some(value) = input.restore_date.as_deref() {
                captured.insert("restoreDate", value);
            }
        }
        if requested.should_capture("targetSnapshotName") {
            if let ::std::option::Option::Some(value) = input.target_snapshot_name.as_deref() {
                captured.insert("targetSnapshotName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopySnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_snapshot::de_copy_snapshot_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_snapshot::de_copy_snapshot_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopySnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_snapshot::CopySnapshotInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_snapshot::CopySnapshotInput,
...
impl CopySnapshotError {
    ...
    /// Returns `true` if the error kind is `CopySnapshotError::RegionSetupInProgressException`.
