...
impl DeleteAutoSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_auto_snapshot::DeleteAutoSnapshot,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_auto_snapshot::ser_delete_auto_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAutoSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_auto_snapshot::de_delete_auto_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
