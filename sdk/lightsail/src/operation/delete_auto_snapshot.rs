...
impl DeleteAutoSnapshotInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_auto_snapshot::ser_delete_auto_snapshot_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_auto_snapshot::DeleteAutoSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAutoSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_auto_snapshot::de_delete_auto_snapshot_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_auto_snapshot::DeleteAutoSnapshotError
{
