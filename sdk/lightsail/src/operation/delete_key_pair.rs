...
impl DeleteKeyPair {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "DeleteKeyPair", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteKeyPairTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("expectedFingerprint") {
            if let ::std::option::Option::Some(value) = input.expected_fingerprint.as_deref() {
                captured.insert("expectedFingerprint", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteKeyPairRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_key_pair::ser_delete_key_pair_input(&input)?);
...
impl DeleteKeyPairError {
    ...
    /// Returns `true` if the error kind is `DeleteKeyPairError::RegionSetupInProgressException`.
