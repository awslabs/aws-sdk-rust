...
impl GetInstanceSnapshots {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_instance_snapshots::GetInstanceSnapshotsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_instance_snapshots::GetInstanceSnapshotsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "GetInstanceSnapshots", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.GetInstanceSnapshots",
                "rpc.service" = "Lightsail",
                "rpc.method" = "GetInstanceSnapshots",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInstanceSnapshots {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetInstanceSnapshotsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetInstanceSnapshotsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetInstanceSnapshots")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInstanceSnapshots")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetInstanceSnapshotsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetInstanceSnapshotsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInstanceSnapshotsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetInstanceSnapshotsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInstanceSnapshotsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_instance_snapshots::de_get_instance_snapshots_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_instance_snapshots::de_get_instance_snapshots_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInstanceSnapshotsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_instance_snapshots::GetInstanceSnapshotsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_instance_snapshots::GetInstanceSnapshotsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_instance_snapshots::ser_get_instance_snapshots_input(
            &input,
        )?);
...
impl GetInstanceSnapshotsError {
    ...
    /// Returns `true` if the error kind is `GetInstanceSnapshotsError::RegionSetupInProgressException`.
