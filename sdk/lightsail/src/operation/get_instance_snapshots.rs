...
impl GetInstanceSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`GetInstanceSnapshots`](crate::operation::get_instance_snapshots::GetInstanceSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_instance_snapshots::GetInstanceSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instance_snapshots::GetInstanceSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_snapshots::ser_get_instance_snapshots_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_instance_snapshots::GetInstanceSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInstanceSnapshots", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetInstanceSnapshots {
                type Output = std::result::Result<crate::operation::get_instance_snapshots::GetInstanceSnapshotsOutput, crate::operation::get_instance_snapshots::GetInstanceSnapshotsError>;
