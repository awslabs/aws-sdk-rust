...
pub use crate::operation::reboot_relational_database::_reboot_relational_database_output::RebootRelationalDatabaseOutputBuilder;
...
pub struct RebootRelationalDatabaseFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::reboot_relational_database::builders::RebootRelationalDatabaseInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::reboot_relational_database::RebootRelationalDatabaseOutput,
                    crate::operation::reboot_relational_database::RebootRelationalDatabaseError,
                > for RebootRelationalDatabaseFluentBuilder
            {
                fn send(
                    self,
...
impl RebootRelationalDatabaseFluentBuilder {
    ...
    /// Access the RebootRelationalDatabase as a reference.
    pub fn as_input(&self) -> &crate::operation::reboot_relational_database::builders::RebootRelationalDatabaseInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reboot_relational_database::RebootRelationalDatabaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_relational_database::RebootRelationalDatabaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::reboot_relational_database::RebootRelationalDatabase::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::reboot_relational_database::RebootRelationalDatabase::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reboot_relational_database::RebootRelationalDatabaseOutput, crate::operation::reboot_relational_database::RebootRelationalDatabaseError, Self> {
