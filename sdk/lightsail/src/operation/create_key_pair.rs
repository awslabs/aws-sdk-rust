...
impl CreateKeyPairInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_key_pair::CreateKeyPair, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_key_pair::ser_create_key_pair_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKeyPair {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_key_pair::de_create_key_pair_http_response_with_props(status, headers, body)
        }
    }
}
