...
impl DeleteDiskSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDiskSnapshot`](crate::operation::delete_disk_snapshot::DeleteDiskSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_disk_snapshot::DeleteDiskSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_disk_snapshot::DeleteDiskSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_disk_snapshot::ser_delete_disk_snapshot_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_disk_snapshot::DeleteDiskSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDiskSnapshot", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDiskSnapshot {
                type Output = std::result::Result<crate::operation::delete_disk_snapshot::DeleteDiskSnapshotOutput, crate::operation::delete_disk_snapshot::DeleteDiskSnapshotError>;
