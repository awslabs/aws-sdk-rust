...
impl CreateDiskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_disk::CreateDisk, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_disk::ser_create_disk_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDisk {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_disk::de_create_disk_http_response_with_props(status, headers, body)
        }
    }
}
