...
impl DeleteContainerImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_container_image::ser_delete_container_image_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_container_image::DeleteContainerImage::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_container_image::DeleteContainerImageError
{
