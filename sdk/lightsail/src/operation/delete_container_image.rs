...
impl DeleteContainerImageInput {
    /// Consumes the builder and constructs an Operation<[`DeleteContainerImage`](crate::operation::delete_container_image::DeleteContainerImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_container_image::DeleteContainerImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_container_image::DeleteContainerImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_container_image::ser_delete_container_image_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_container_image::DeleteContainerImage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteContainerImage", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteContainerImage`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteContainerImage {
                type Output = std::result::Result<crate::operation::delete_container_image::DeleteContainerImageOutput, crate::operation::delete_container_image::DeleteContainerImageError>;
