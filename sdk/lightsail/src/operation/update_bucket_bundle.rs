...
impl UpdateBucketBundleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBucketBundle`](crate::operation::update_bucket_bundle::UpdateBucketBundle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_bucket_bundle::UpdateBucketBundle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_bucket_bundle::UpdateBucketBundleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_bucket_bundle::ser_update_bucket_bundle_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_bucket_bundle::UpdateBucketBundle::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateBucketBundle", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateBucketBundle`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBucketBundle {
                type Output = std::result::Result<crate::operation::update_bucket_bundle::UpdateBucketBundleOutput, crate::operation::update_bucket_bundle::UpdateBucketBundleError>;
