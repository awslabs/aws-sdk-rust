...
impl UpdateBucketBundleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_bucket_bundle::ser_update_bucket_bundle_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_bucket_bundle::UpdateBucketBundle::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBucketBundle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_bucket_bundle::de_update_bucket_bundle_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_bucket_bundle::UpdateBucketBundleError
{
