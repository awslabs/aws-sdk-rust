...
impl UpdateBucketBundleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_bucket_bundle::ser_update_bucket_bundle_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBucketBundle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_bucket_bundle::de_update_bucket_bundle_http_response_with_props(status, headers, body)
        }
    }
}
