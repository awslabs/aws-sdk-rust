...
impl GetRelationalDatabaseBundlesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesOutput, crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError, Self> {
