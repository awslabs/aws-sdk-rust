...
impl GetRelationalDatabaseMetricDataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_relational_database_metric_data::GetRelationalDatabaseMetricData::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseMetricData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_metric_data::de_get_relational_database_metric_data_http_response_with_props(
                status, headers, body,
            )
        }
    }
