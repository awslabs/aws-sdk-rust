...
impl GetRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabase`](crate::operation::get_relational_database::GetRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_relational_database::GetRelationalDatabase, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database::GetRelationalDatabaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database::ser_get_relational_database_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database::GetRelationalDatabase::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRelationalDatabase", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabase {
                type Output = std::result::Result<crate::operation::get_relational_database::GetRelationalDatabaseOutput, crate::operation::get_relational_database::GetRelationalDatabaseError>;
