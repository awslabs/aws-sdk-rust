...
impl GetRelationalDatabaseInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_relational_database::GetRelationalDatabase,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabase {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database::de_get_relational_database_http_response_with_props(status, headers, body)
        }
    }
}
