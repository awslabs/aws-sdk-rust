...
impl GetRelationalDatabaseBundles {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRelationalDatabaseBundles {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetRelationalDatabaseBundles");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetRelationalDatabaseBundlesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetRelationalDatabaseBundlesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRelationalDatabaseBundles")
...
.with_interceptor(GetRelationalDatabaseBundlesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError>::new());
...
#[derive(Debug)]
            struct GetRelationalDatabaseBundlesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRelationalDatabaseBundlesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_get_relational_database_bundles::de_get_relational_database_bundles_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetRelationalDatabaseBundlesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRelationalDatabaseBundlesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_relational_database_bundles::ser_get_relational_database_bundles_input(&input)?);
...
#[derive(Debug)]
            struct GetRelationalDatabaseBundlesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRelationalDatabaseBundlesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetRelationalDatabaseBundlesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetRelationalDatabaseBundlesInput>()
                        .ok_or("failed to downcast to GetRelationalDatabaseBundlesInput")?;
...
pub enum GetRelationalDatabaseBundlesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetRelationalDatabaseBundlesError) for what information is available for the error.")]
...
impl GetRelationalDatabaseBundlesError {
    /// Creates the `GetRelationalDatabaseBundlesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetRelationalDatabaseBundlesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetRelationalDatabaseBundlesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError {
