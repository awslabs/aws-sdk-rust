...
impl GetRelationalDatabaseBundlesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundles::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError
{
