...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseMasterUserPassword {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_relational_database_master_user_password::de_get_relational_database_master_user_password_http_response_with_props(status, headers, body)
        }
    }
