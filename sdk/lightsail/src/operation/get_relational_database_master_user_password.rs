...
impl GetRelationalDatabaseMasterUserPasswordInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseMasterUserPassword`](crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPassword, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPasswordInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_master_user_password::ser_get_relational_database_master_user_password_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPassword::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseMasterUserPassword", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseMasterUserPassword {
                type Output = std::result::Result<crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPasswordOutput, crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPasswordError>;
...
impl aws_http::request_id::RequestId for crate::operation::get_relational_database_master_user_password::GetRelationalDatabaseMasterUserPasswordError {
