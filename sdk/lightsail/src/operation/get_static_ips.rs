...
impl GetStaticIpsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_static_ips::GetStaticIps::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStaticIps {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_static_ips::de_get_static_ips_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_static_ips::de_get_static_ips_http_response_with_props(
                status, headers, body,
            )
        }
    }
