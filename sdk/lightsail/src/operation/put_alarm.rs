...
impl PutAlarmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_alarm::PutAlarm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_alarm::ser_put_alarm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAlarm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_alarm::de_put_alarm_http_response_with_props(status, headers, body)
        }
    }
}
