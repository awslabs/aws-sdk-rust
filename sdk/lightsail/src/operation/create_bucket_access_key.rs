...
impl CreateBucketAccessKey {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_bucket_access_key::CreateBucketAccessKeyInput,
                    ) -> ::std::result::Result<crate::operation::create_bucket_access_key::CreateBucketAccessKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_bucket_access_key::CreateBucketAccessKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateBucketAccessKey {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateBucketAccessKey");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateBucketAccessKeyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateBucketAccessKeyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateBucketAccessKey")
...
.with_interceptor(CreateBucketAccessKeyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyError>::new());
...
#[derive(Debug)]
            struct CreateBucketAccessKeyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateBucketAccessKeyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_bucket_access_key::de_create_bucket_access_key_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_bucket_access_key::de_create_bucket_access_key_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateBucketAccessKeyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateBucketAccessKeyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_bucket_access_key::CreateBucketAccessKeyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_bucket_access_key::CreateBucketAccessKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_bucket_access_key::ser_create_bucket_access_key_input(&input)?);
...
#[derive(Debug)]
            struct CreateBucketAccessKeyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateBucketAccessKeyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateBucketAccessKeyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateBucketAccessKeyInput>()
                        .ok_or("failed to downcast to CreateBucketAccessKeyInput")?;
...
pub enum CreateBucketAccessKeyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateBucketAccessKeyError) for what information is available for the error.")]
...
impl CreateBucketAccessKeyError {
    /// Creates the `CreateBucketAccessKeyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateBucketAccessKeyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateBucketAccessKeyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_bucket_access_key::CreateBucketAccessKeyError {
...
mod _create_bucket_access_key_output;
