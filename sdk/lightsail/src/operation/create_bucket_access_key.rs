...
impl CreateBucketAccessKeyInput {
    /// Consumes the builder and constructs an Operation<[`CreateBucketAccessKey`](crate::operation::create_bucket_access_key::CreateBucketAccessKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_bucket_access_key::CreateBucketAccessKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_bucket_access_key::CreateBucketAccessKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_bucket_access_key::ser_create_bucket_access_key_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_bucket_access_key::CreateBucketAccessKey::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateBucketAccessKey", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateBucketAccessKey {
                type Output = std::result::Result<crate::operation::create_bucket_access_key::CreateBucketAccessKeyOutput, crate::operation::create_bucket_access_key::CreateBucketAccessKeyError>;
