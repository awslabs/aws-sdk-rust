...
impl CreateRelationalDatabaseFromSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_relational_database_from_snapshot::CreateRelationalDatabaseFromSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_relational_database_from_snapshot::CreateRelationalDatabaseFromSnapshotOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateRelationalDatabaseFromSnapshot",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRelationalDatabaseFromSnapshot {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateRelationalDatabaseFromSnapshotRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateRelationalDatabaseFromSnapshotResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateRelationalDatabaseFromSnapshot")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateRelationalDatabaseFromSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateRelationalDatabaseFromSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateRelationalDatabaseFromSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRelationalDatabaseFromSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateRelationalDatabaseFromSnapshotInput>() else {
        ...
        if requested.should_capture("relationalDatabaseBundleId") {
            if let ::std::option::Option::Some(value) = input.relational_database_bundle_id.as_deref() {
                captured.insert("relationalDatabaseBundleId", value);
            }
        }
        if requested.should_capture("sourceRelationalDatabaseName") {
            if let ::std::option::Option::Some(value) = input.source_relational_database_name.as_deref() {
                captured.insert("sourceRelationalDatabaseName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRelationalDatabaseFromSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_relational_database_from_snapshot::de_create_relational_database_from_snapshot_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_relational_database_from_snapshot::de_create_relational_database_from_snapshot_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRelationalDatabaseFromSnapshotRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_relational_database_from_snapshot::CreateRelationalDatabaseFromSnapshotInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_relational_database_from_snapshot::ser_create_relational_database_from_snapshot_input(&input)?,
        );
...
impl CreateRelationalDatabaseFromSnapshotError {
    ...
    /// Returns `true` if the error kind is `CreateRelationalDatabaseFromSnapshotError::RegionSetupInProgressException`.
