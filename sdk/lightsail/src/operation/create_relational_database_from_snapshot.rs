...
impl aws_smithy_http::response::ParseStrictResponse for CreateRelationalDatabaseFromSnapshot {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_relational_database_from_snapshot::de_create_relational_database_from_snapshot_http_response_with_props(status, headers, body)
        }
    }
}
