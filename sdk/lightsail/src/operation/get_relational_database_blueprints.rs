    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetRelationalDatabaseBlueprintsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetRelationalDatabaseBlueprintsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetRelationalDatabaseBlueprintsEndpointParamsInterceptor {
