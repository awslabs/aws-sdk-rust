...
impl ResetDistributionCache {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::reset_distribution_cache::ResetDistributionCacheError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::reset_distribution_cache::ResetDistributionCacheOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lightsail", "ResetDistributionCache", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Lightsail.ResetDistributionCache",
                "rpc.service" = "Lightsail",
                "rpc.method" = "ResetDistributionCache",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ResetDistributionCache {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ResetDistributionCacheRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ResetDistributionCacheResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ResetDistributionCache")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ResetDistributionCache")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ResetDistributionCacheTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ResetDistributionCacheTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ResetDistributionCacheTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ResetDistributionCacheInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ResetDistributionCacheResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_reset_distribution_cache::de_reset_distribution_cache_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_reset_distribution_cache::de_reset_distribution_cache_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ResetDistributionCacheRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::reset_distribution_cache::ResetDistributionCacheInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::reset_distribution_cache::ResetDistributionCacheInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_reset_distribution_cache::ser_reset_distribution_cache_input(&input)?,
        );
