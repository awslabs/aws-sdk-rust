...
impl ResetDistributionCacheInput {
    /// Consumes the builder and constructs an Operation<[`ResetDistributionCache`](crate::operation::reset_distribution_cache::ResetDistributionCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reset_distribution_cache::ResetDistributionCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_distribution_cache::ResetDistributionCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_distribution_cache::ser_reset_distribution_cache_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reset_distribution_cache::ResetDistributionCache::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResetDistributionCache", "lightsail"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResetDistributionCache {
                type Output = std::result::Result<crate::operation::reset_distribution_cache::ResetDistributionCacheOutput, crate::operation::reset_distribution_cache::ResetDistributionCacheError>;
