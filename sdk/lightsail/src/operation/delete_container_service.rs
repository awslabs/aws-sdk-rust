...
impl DeleteContainerServiceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteContainerService`](crate::operation::delete_container_service::DeleteContainerService)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_container_service::DeleteContainerService, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_container_service::DeleteContainerServiceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_container_service::ser_delete_container_service_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_container_service::DeleteContainerService::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteContainerService", "lightsail"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteContainerService`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteContainerService {
                type Output = std::result::Result<crate::operation::delete_container_service::DeleteContainerServiceOutput, crate::operation::delete_container_service::DeleteContainerServiceError>;
