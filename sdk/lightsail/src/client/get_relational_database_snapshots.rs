...
impl super::Client {
    ...
    ///   - [`page_token(impl Into<String>)`](crate::operation::get_relational_database_snapshots::builders::GetRelationalDatabaseSnapshotsFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::get_relational_database_snapshots::builders::GetRelationalDatabaseSnapshotsFluentBuilder::set_page_token):<br>required: **false**<br><p>The token to advance to the next page of results from your request.</p> <p>To get a page token, perform an initial <code>GetRelationalDatabaseSnapshots</code> request. If your results are paginated, the response will return a next page token that you can specify as the page token in a subsequent request.</p><br>
