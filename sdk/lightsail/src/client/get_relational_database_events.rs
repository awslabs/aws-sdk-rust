...
impl super::Client {
    ...
    ///   - [`duration_in_minutes(i32)`](crate::operation::get_relational_database_events::builders::GetRelationalDatabaseEventsFluentBuilder::duration_in_minutes) / [`set_duration_in_minutes(Option<i32>)`](crate::operation::get_relational_database_events::builders::GetRelationalDatabaseEventsFluentBuilder::set_duration_in_minutes):<br>required: **false**<br><p>The number of minutes in the past from which to retrieve events. For example, to get all events from the past 2 hours, enter 120.</p> <p>Default: <code>60</code></p> <p>The minimum is 1 and the maximum is 14 days (20160 minutes).</p><br>
    ///   - [`page_token(impl Into<String>)`](crate::operation::get_relational_database_events::builders::GetRelationalDatabaseEventsFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::get_relational_database_events::builders::GetRelationalDatabaseEventsFluentBuilder::set_page_token):<br>required: **false**<br><p>The token to advance to the next page of results from your request.</p> <p>To get a page token, perform an initial <code>GetRelationalDatabaseEvents</code> request. If your results are paginated, the response will return a next page token that you can specify as the page token in a subsequent request.</p><br>
