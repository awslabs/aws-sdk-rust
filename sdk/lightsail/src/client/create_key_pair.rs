...
impl super::Client {
    ...
    ///   - [`key_pair_name(impl ::std::convert::Into<String>)`](crate::operation::create_key_pair::builders::CreateKeyPairFluentBuilder::key_pair_name) / [`set_key_pair_name(Option<String>)`](crate::operation::create_key_pair::builders::CreateKeyPairFluentBuilder::set_key_pair_name): <p>The name for your new key pair.</p>
