...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::delete_domain::builders::DeleteDomainFluentBuilder::set_domain_name): <p>The specific domain name to delete.</p>
