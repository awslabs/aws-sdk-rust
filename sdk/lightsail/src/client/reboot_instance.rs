...
impl super::Client {
    ...
    ///   - [`instance_name(impl ::std::convert::Into<String>)`](crate::operation::reboot_instance::builders::RebootInstanceFluentBuilder::instance_name) / [`set_instance_name(Option<String>)`](crate::operation::reboot_instance::builders::RebootInstanceFluentBuilder::set_instance_name): <p>The name of the instance to reboot.</p>
