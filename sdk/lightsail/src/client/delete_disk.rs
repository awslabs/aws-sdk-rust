...
impl super::Client {
    ...
    ///   - [`disk_name(impl Into<String>)`](crate::operation::delete_disk::builders::DeleteDiskFluentBuilder::disk_name) / [`set_disk_name(Option<String>)`](crate::operation::delete_disk::builders::DeleteDiskFluentBuilder::set_disk_name):<br>required: **true**<br><p>The unique name of the disk you want to delete (<code>my-disk</code>).</p><br>
