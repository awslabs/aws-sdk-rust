...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::create_domain_entry::builders::CreateDomainEntryFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::create_domain_entry::builders::CreateDomainEntryFluentBuilder::set_domain_name):<br>required: **true**<br><p>The domain name (<code>example.com</code>) for which you want to create the domain entry.</p><br>
