...
impl super::Client {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::set_ip_address_type::builders::SetIpAddressTypeFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::set_ip_address_type::builders::SetIpAddressTypeFluentBuilder::set_resource_name): <p>The name of the resource for which to set the IP address type.</p>
