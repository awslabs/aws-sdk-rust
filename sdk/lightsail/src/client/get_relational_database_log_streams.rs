...
impl super::Client {
    ...
    ///   - [`relational_database_name(impl Into<String>)`](crate::operation::get_relational_database_log_streams::builders::GetRelationalDatabaseLogStreamsFluentBuilder::relational_database_name) / [`set_relational_database_name(Option<String>)`](crate::operation::get_relational_database_log_streams::builders::GetRelationalDatabaseLogStreamsFluentBuilder::set_relational_database_name):<br>required: **true**<br><p>The name of your database for which to get log streams.</p><br>
