...
impl super::Client {
    ...
    ///   - [`add_on_type(AddOnType)`](crate::operation::disable_add_on::builders::DisableAddOnFluentBuilder::add_on_type) / [`set_add_on_type(Option<AddOnType>)`](crate::operation::disable_add_on::builders::DisableAddOnFluentBuilder::set_add_on_type):<br>required: **true**<br><p>The add-on type to disable.</p><br>
    ///   - [`resource_name(impl Into<String>)`](crate::operation::disable_add_on::builders::DisableAddOnFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::disable_add_on::builders::DisableAddOnFluentBuilder::set_resource_name):<br>required: **true**<br><p>The name of the source resource for which to disable the add-on.</p><br>
