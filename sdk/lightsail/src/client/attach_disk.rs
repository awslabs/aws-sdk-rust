...
impl super::Client {
    ...
    ///   - [`disk_name(impl Into<String>)`](crate::operation::attach_disk::builders::AttachDiskFluentBuilder::disk_name) / [`set_disk_name(Option<String>)`](crate::operation::attach_disk::builders::AttachDiskFluentBuilder::set_disk_name):<br>required: **true**<br><p>The unique Lightsail disk name (e.g., <code>my-disk</code>).</p><br>
    ...
    ///   - [`disk_path(impl Into<String>)`](crate::operation::attach_disk::builders::AttachDiskFluentBuilder::disk_path) / [`set_disk_path(Option<String>)`](crate::operation::attach_disk::builders::AttachDiskFluentBuilder::set_disk_path):<br>required: **true**<br><p>The disk path to expose to the instance (e.g., <code>/dev/xvdf</code>).</p><br>
