...
impl super::Client {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::start_gui_session::builders::StartGUISessionFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::start_gui_session::builders::StartGUISessionFluentBuilder::set_resource_name): <p>The resource name.</p>
