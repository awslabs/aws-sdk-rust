...
impl super::Client {
    ...
    ///   - [`static_ip_name(impl Into<String>)`](crate::operation::attach_static_ip::builders::AttachStaticIpFluentBuilder::static_ip_name) / [`set_static_ip_name(Option<String>)`](crate::operation::attach_static_ip::builders::AttachStaticIpFluentBuilder::set_static_ip_name):<br>required: **true**<br><p>The name of the static IP.</p><br>
