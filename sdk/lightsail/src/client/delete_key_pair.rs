...
impl super::Client {
    ...
    ///   - [`key_pair_name(impl ::std::convert::Into<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::key_pair_name) / [`set_key_pair_name(Option<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::set_key_pair_name): <p>The name of the key pair to delete.</p>
    ///   - [`expected_fingerprint(impl ::std::convert::Into<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::expected_fingerprint) / [`set_expected_fingerprint(Option<String>)`](crate::operation::delete_key_pair::builders::DeleteKeyPairFluentBuilder::set_expected_fingerprint): <p>The RSA fingerprint of the Lightsail default key pair to delete.</p> <note>   <p>The <code>expectedFingerprint</code> parameter is required only when specifying to delete a Lightsail default key pair.</p>  </note>
