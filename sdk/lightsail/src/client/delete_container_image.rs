...
impl super::Client {
    ...
    ///   - [`service_name(impl ::std::convert::Into<String>)`](crate::operation::delete_container_image::builders::DeleteContainerImageFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::delete_container_image::builders::DeleteContainerImageFluentBuilder::set_service_name): <p>The name of the container service for which to delete a registered container image.</p>
