...
impl super::Client {
    ...
    ///   - [`service_name(impl Into<String>)`](crate::operation::delete_container_image::builders::DeleteContainerImageFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::delete_container_image::builders::DeleteContainerImageFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the container service for which to delete a registered container image.</p><br>
