...
impl super::Client {
    ...
    ///   - [`relational_database_name(impl Into<String>)`](crate::operation::get_relational_database_parameters::builders::GetRelationalDatabaseParametersFluentBuilder::relational_database_name) / [`set_relational_database_name(Option<String>)`](crate::operation::get_relational_database_parameters::builders::GetRelationalDatabaseParametersFluentBuilder::set_relational_database_name):<br>required: **true**<br><p>The name of your database for which to get parameters.</p><br>
    ///   - [`page_token(impl Into<String>)`](crate::operation::get_relational_database_parameters::builders::GetRelationalDatabaseParametersFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::get_relational_database_parameters::builders::GetRelationalDatabaseParametersFluentBuilder::set_page_token):<br>required: **false**<br><p>The token to advance to the next page of results from your request.</p> <p>To get a page token, perform an initial <code>GetRelationalDatabaseParameters</code> request. If your results are paginated, the response will return a next page token that you can specify as the page token in a subsequent request.</p><br>
