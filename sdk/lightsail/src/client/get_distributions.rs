...
impl super::Client {
    ...
    ///   - [`distribution_name(impl ::std::convert::Into<String>)`](crate::operation::get_distributions::builders::GetDistributionsFluentBuilder::distribution_name) / [`set_distribution_name(Option<String>)`](crate::operation::get_distributions::builders::GetDistributionsFluentBuilder::set_distribution_name): <p>The name of the distribution for which to return information.</p>  <p>When omitted, the response includes all of your distributions in the Amazon Web Services Region where the request is made.</p>
    ///   - [`page_token(impl ::std::convert::Into<String>)`](crate::operation::get_distributions::builders::GetDistributionsFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::get_distributions::builders::GetDistributionsFluentBuilder::set_page_token): <p>The token to advance to the next page of results from your request.</p>  <p>To get a page token, perform an initial <code>GetDistributions</code> request. If your results are paginated, the response will return a next page token that you can specify as the page token in a subsequent request.</p>
