...
impl super::Client {
    ...
    ///   - [`static_ip_name(impl Into<String>)`](crate::operation::release_static_ip::builders::ReleaseStaticIpFluentBuilder::static_ip_name) / [`set_static_ip_name(Option<String>)`](crate::operation::release_static_ip::builders::ReleaseStaticIpFluentBuilder::set_static_ip_name):<br>required: **true**<br><p>The name of the static IP to delete.</p><br>
