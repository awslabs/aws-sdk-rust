...
impl super::Client {
    ...
    ///   - [`service_name(impl ::std::convert::Into<String>)`](crate::operation::get_container_services::builders::GetContainerServicesFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::get_container_services::builders::GetContainerServicesFluentBuilder::set_service_name): <p>The name of the container service for which to return information.</p>  <p>When omitted, the response includes all of your container services in the Amazon Web Services Region where the request is made.</p>
    ...
    pub fn get_container_services(
        &self,
    ) -> crate::operation::get_container_services::builders::GetContainerServicesFluentBuilder {
        crate::operation::get_container_services::builders::GetContainerServicesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
