...
impl super::Client {
    ...
    ///   - [`disk_name(impl ::std::convert::Into<String>)`](crate::operation::detach_disk::builders::DetachDiskFluentBuilder::disk_name) / [`set_disk_name(Option<String>)`](crate::operation::detach_disk::builders::DetachDiskFluentBuilder::set_disk_name): <p>The unique name of the disk you want to detach from your instance (e.g., <code>my-disk</code>).</p>
