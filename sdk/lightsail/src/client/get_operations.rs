...
impl super::Client {
    ...
    ///   - [`page_token(impl ::std::convert::Into<String>)`](crate::operation::get_operations::builders::GetOperationsFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::get_operations::builders::GetOperationsFluentBuilder::set_page_token): <p>The token to advance to the next page of results from your request.</p>  <p>To get a page token, perform an initial <code>GetOperations</code> request. If your results are paginated, the response will return a next page token that you can specify as the page token in a subsequent request.</p>
