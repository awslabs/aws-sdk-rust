...
impl super::Client {
    ...
    ///   - [`cache_behaviors(Vec<CacheBehaviorPerPath>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::cache_behaviors) / [`set_cache_behaviors(Option<Vec<CacheBehaviorPerPath>>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::set_cache_behaviors): <p>An array of objects that describe the per-path cache behavior for the distribution.</p>
    ///   - [`is_enabled(bool)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::is_enabled) / [`set_is_enabled(Option<bool>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::set_is_enabled): <p>Indicates whether to enable the distribution.</p>
