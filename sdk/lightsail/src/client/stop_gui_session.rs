...
impl super::Client {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::stop_gui_session::builders::StopGUISessionFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::stop_gui_session::builders::StopGUISessionFluentBuilder::set_resource_name): <p>The resource name.</p>
