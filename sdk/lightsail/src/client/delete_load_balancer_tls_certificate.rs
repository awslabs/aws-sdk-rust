...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl ::std::convert::Into<String>)`](crate::operation::delete_load_balancer_tls_certificate::builders::DeleteLoadBalancerTlsCertificateFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::delete_load_balancer_tls_certificate::builders::DeleteLoadBalancerTlsCertificateFluentBuilder::set_load_balancer_name): <p>The load balancer name.</p>
    ///   - [`certificate_name(impl ::std::convert::Into<String>)`](crate::operation::delete_load_balancer_tls_certificate::builders::DeleteLoadBalancerTlsCertificateFluentBuilder::certificate_name) / [`set_certificate_name(Option<String>)`](crate::operation::delete_load_balancer_tls_certificate::builders::DeleteLoadBalancerTlsCertificateFluentBuilder::set_certificate_name): <p>The SSL/TLS certificate name.</p>
