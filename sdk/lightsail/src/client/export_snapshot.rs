...
impl super::Client {
    ...
    ///   - [`source_snapshot_name(impl Into<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::source_snapshot_name) / [`set_source_snapshot_name(Option<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::set_source_snapshot_name):<br>required: **true**<br><p>The name of the instance or disk snapshot to be exported to Amazon EC2.</p><br>
