...
impl super::Client {
    ...
    ///   - [`instance_name(impl ::std::convert::Into<String>)`](crate::operation::stop_instance::builders::StopInstanceFluentBuilder::instance_name) / [`set_instance_name(Option<String>)`](crate::operation::stop_instance::builders::StopInstanceFluentBuilder::set_instance_name): <p>The name of the instance (a virtual private server) to stop.</p>
