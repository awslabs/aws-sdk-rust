...
impl super::Client {
    ...
    ///   - [`static_ip_name(impl Into<String>)`](crate::operation::allocate_static_ip::builders::AllocateStaticIpFluentBuilder::static_ip_name) / [`set_static_ip_name(Option<String>)`](crate::operation::allocate_static_ip::builders::AllocateStaticIpFluentBuilder::set_static_ip_name):<br>required: **true**<br><p>The name of the static IP address.</p><br>
