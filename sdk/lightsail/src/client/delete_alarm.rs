...
impl super::Client {
    ...
    ///   - [`alarm_name(impl ::std::convert::Into<String>)`](crate::operation::delete_alarm::builders::DeleteAlarmFluentBuilder::alarm_name) / [`set_alarm_name(Option<String>)`](crate::operation::delete_alarm::builders::DeleteAlarmFluentBuilder::set_alarm_name): <p>The name of the alarm to delete.</p>
