...
impl super::Client {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::set_resource_access_for_bucket::builders::SetResourceAccessForBucketFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::set_resource_access_for_bucket::builders::SetResourceAccessForBucketFluentBuilder::set_resource_name): <p>The name of the Lightsail instance for which to set bucket access. The instance must be in a running or stopped state.</p>
    ///   - [`bucket_name(impl ::std::convert::Into<String>)`](crate::operation::set_resource_access_for_bucket::builders::SetResourceAccessForBucketFluentBuilder::bucket_name) / [`set_bucket_name(Option<String>)`](crate::operation::set_resource_access_for_bucket::builders::SetResourceAccessForBucketFluentBuilder::set_bucket_name): <p>The name of the bucket for which to set access to another Lightsail resource.</p>
