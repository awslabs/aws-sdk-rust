...
impl super::Client {
    ...
    ///   - [`load_balancer_name(impl ::std::convert::Into<String>)`](crate::operation::get_load_balancer::builders::GetLoadBalancerFluentBuilder::load_balancer_name) / [`set_load_balancer_name(Option<String>)`](crate::operation::get_load_balancer::builders::GetLoadBalancerFluentBuilder::set_load_balancer_name): <p>The name of the load balancer.</p>
