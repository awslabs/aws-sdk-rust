...
impl super::Client {
    ...
    ///   - [`bucket_name(impl ::std::convert::Into<String>)`](crate::operation::delete_bucket::builders::DeleteBucketFluentBuilder::bucket_name) / [`set_bucket_name(Option<String>)`](crate::operation::delete_bucket::builders::DeleteBucketFluentBuilder::set_bucket_name): <p>The name of the bucket to delete.</p>  <p>Use the <a href="https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetBuckets.html">GetBuckets</a> action to get a list of bucket names that you can specify.</p>
