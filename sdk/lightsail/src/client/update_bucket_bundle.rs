...
impl super::Client {
    ...
    ///   - [`bucket_name(impl ::std::convert::Into<String>)`](crate::operation::update_bucket_bundle::builders::UpdateBucketBundleFluentBuilder::bucket_name) / [`set_bucket_name(Option<String>)`](crate::operation::update_bucket_bundle::builders::UpdateBucketBundleFluentBuilder::set_bucket_name): <p>The name of the bucket for which to update the bundle.</p>
    ///   - [`bundle_id(impl ::std::convert::Into<String>)`](crate::operation::update_bucket_bundle::builders::UpdateBucketBundleFluentBuilder::bundle_id) / [`set_bundle_id(Option<String>)`](crate::operation::update_bucket_bundle::builders::UpdateBucketBundleFluentBuilder::set_bundle_id): <p>The ID of the new bundle to apply to the bucket.</p>  <p>Use the <a href="https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetBucketBundles.html">GetBucketBundles</a> action to get a list of bundle IDs that you can specify.</p>
