...
impl super::Client {
    ...
    ///   - [`relational_database_snapshot_name(impl Into<String>)`](crate::operation::get_relational_database_snapshot::builders::GetRelationalDatabaseSnapshotFluentBuilder::relational_database_snapshot_name) / [`set_relational_database_snapshot_name(Option<String>)`](crate::operation::get_relational_database_snapshot::builders::GetRelationalDatabaseSnapshotFluentBuilder::set_relational_database_snapshot_name):<br>required: **true**<br><p>The name of the database snapshot for which to get information.</p><br>
