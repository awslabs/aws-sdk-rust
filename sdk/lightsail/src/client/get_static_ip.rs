...
impl super::Client {
    ...
    ///   - [`static_ip_name(impl ::std::convert::Into<String>)`](crate::operation::get_static_ip::builders::GetStaticIpFluentBuilder::static_ip_name) / [`set_static_ip_name(Option<String>)`](crate::operation::get_static_ip::builders::GetStaticIpFluentBuilder::set_static_ip_name): <p>The name of the static IP in Lightsail.</p>
