...
impl super::Client {
    ...
    ///   - [`instance_names(impl Into<String>)`](crate::operation::detach_instances_from_load_balancer::builders::DetachInstancesFromLoadBalancerFluentBuilder::instance_names) / [`set_instance_names(Option<Vec<String>>)`](crate::operation::detach_instances_from_load_balancer::builders::DetachInstancesFromLoadBalancerFluentBuilder::set_instance_names): <p>An array of strings containing the names of the instances you want to detach from the load balancer.</p>
