...
impl super::Client {
    ...
    ///   - [`instances(InstanceEntry)`](crate::operation::create_cloud_formation_stack::builders::CreateCloudFormationStackFluentBuilder::instances) / [`set_instances(Option<Vec::<InstanceEntry>>)`](crate::operation::create_cloud_formation_stack::builders::CreateCloudFormationStackFluentBuilder::set_instances):<br>required: **true**<br><p>An array of parameters that will be used to create the new Amazon EC2 instance. You can only pass one instance entry at a time in this array. You will get an invalid parameter error if you pass more than one instance entry in this array.</p><br>
