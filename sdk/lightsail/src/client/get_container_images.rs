...
impl super::Client {
    ...
    ///   - [`service_name(impl Into<String>)`](crate::operation::get_container_images::builders::GetContainerImagesFluentBuilder::service_name) / [`set_service_name(Option<String>)`](crate::operation::get_container_images::builders::GetContainerImagesFluentBuilder::set_service_name):<br>required: **true**<br><p>The name of the container service for which to return registered container images.</p><br>
