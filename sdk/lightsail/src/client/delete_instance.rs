...
impl super::Client {
    ...
    ///   - [`instance_name(impl Into<String>)`](crate::operation::delete_instance::builders::DeleteInstanceFluentBuilder::instance_name) / [`set_instance_name(Option<String>)`](crate::operation::delete_instance::builders::DeleteInstanceFluentBuilder::set_instance_name):<br>required: **true**<br><p>The name of the instance to delete.</p><br>
