...
/// Operation shape for `DeleteResourcePermission`.
            ...
            /// [`delete_resource_permission`](crate::client::fluent_builders::DeleteResourcePermission).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteResourcePermission {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_resource_permission::de_delete_resource_permission_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_resource_permission::de_delete_resource_permission_http_response(response)
                     }
                }
            }
...
/// Operation shape for `DeregisterApplication`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`deregister_application`](crate::client::fluent_builders::DeregisterApplication).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterApplication {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_deregister_application::de_deregister_application_http_error(response)
                     } else {
                        crate::protocol_serde::shape_deregister_application::de_deregister_application_http_response(response)
                     }
                }
            }
...
/// Operation shape for `GetOperation`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_operation`](crate::client::fluent_builders::GetOperation).
            ///
...
/// Operation shape for `GetResourcePermission`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`get_resource_permission`](crate::client::fluent_builders::GetResourcePermission).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourcePermission {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_resource_permission::de_get_resource_permission_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_resource_permission::de_get_resource_permission_http_response(response)
                     }
                }
            }
...
/// Operation shape for `PutResourcePermission`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`put_resource_permission`](crate::client::fluent_builders::PutResourcePermission).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for PutResourcePermission {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_resource_permission::de_put_resource_permission_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_resource_permission::de_put_resource_permission_http_response(response)
                     }
                }
            }
...
/// Operation shape for `RegisterApplication`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`register_application`](crate::client::fluent_builders::RegisterApplication).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterApplication {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_register_application::de_register_application_http_error(response)
                     } else {
                        crate::protocol_serde::shape_register_application::de_register_application_http_response(response)
                     }
                }
            }
...
/// Operation shape for `UpdateApplicationSettings`.
            ///
            /// This is usually constructed for you using the the fluent builder returned by
            /// [`update_application_settings`](crate::client::fluent_builders::UpdateApplicationSettings).
            ///
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateApplicationSettings {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_application_settings::de_update_application_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_application_settings::de_update_application_settings_http_response(response)
                     }
                }
            }
