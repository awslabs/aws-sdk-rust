...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::resource_arn) / [`set_resource_arn(impl Into<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the resource.</p><br>
