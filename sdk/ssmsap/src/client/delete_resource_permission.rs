...
impl super::Client {
    ...
    ///   - [`source_resource_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::source_resource_arn) / [`set_source_resource_arn(Option<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::set_source_resource_arn): <p>The Amazon Resource Name (ARN) of the source resource.</p>
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::delete_resource_permission::builders::DeleteResourcePermissionFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the resource.</p>
