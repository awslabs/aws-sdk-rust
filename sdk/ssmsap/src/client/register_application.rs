...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::set_application_id):<br>required: **true**<br><p>The ID of the application.</p><br>
    ///   - [`application_type(ApplicationType)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::application_type) / [`set_application_type(ApplicationType)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::set_application_type):<br>required: **true**<br><p>The type of the application.</p><br>
    ///   - [`instances(impl Into<String>)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::instances) / [`set_instances(Vec<String>)`](crate::operation::register_application::builders::RegisterApplicationFluentBuilder::set_instances):<br>required: **true**<br><p>The Amazon EC2 instances on which your SAP application is running.</p><br>
