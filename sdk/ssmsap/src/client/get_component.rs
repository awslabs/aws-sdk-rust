...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::set_application_id):<br>required: **true**<br><p>The ID of the application.</p><br>
    ///   - [`component_id(impl Into<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::component_id) / [`set_component_id(impl Into<String>)`](crate::operation::get_component::builders::GetComponentFluentBuilder::set_component_id):<br>required: **true**<br><p>The ID of the component.</p><br>
