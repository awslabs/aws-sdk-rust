...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::start_application_refresh::builders::StartApplicationRefreshFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::start_application_refresh::builders::StartApplicationRefreshFluentBuilder::set_application_id): <p>The ID of the application.</p>
