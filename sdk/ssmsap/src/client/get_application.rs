...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::set_application_id): <p>The ID of the application.</p>
    ///   - [`application_arn(impl ::std::convert::Into<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::application_arn) / [`set_application_arn(Option<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::set_application_arn): <p>The Amazon Resource Name (ARN) of the application. </p>
    ///   - [`app_registry_arn(impl ::std::convert::Into<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::app_registry_arn) / [`set_app_registry_arn(Option<String>)`](crate::operation::get_application::builders::GetApplicationFluentBuilder::set_app_registry_arn): <p>The Amazon Resource Name (ARN) of the application registry.</p>
