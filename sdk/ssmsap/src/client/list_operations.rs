...
impl super::Client {
    ...
    ///   - [`filters(Filter)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::list_operations::builders::ListOperationsFluentBuilder::set_filters): <p>The filters of an operation.</p>
