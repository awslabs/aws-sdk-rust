...
pub fn ser_list_configuration_check_operations_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::list_configuration_check_operations::ListConfigurationCheckOperationsInput,
    ...
    if let Some(var_6) = &input.list_mode {
        object.key("ListMode").string(var_6.as_str());
    }
