...
pub(crate) fn de_operation_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Operation>>, aws_smithy_json::deserialize::error::DeserializeError>
