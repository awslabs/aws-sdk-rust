...
pub fn ser_delete_resource_permission_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_resource_permission::DeleteResourcePermissionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
