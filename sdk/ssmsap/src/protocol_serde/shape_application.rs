            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Components" => {
                            builder = builder.set_components(crate::protocol_serde::shape_component_id_list::de_component_id_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "AssociatedApplicationArns" => {
                            builder = builder.set_associated_application_arns(
                                crate::protocol_serde::shape_application_arn_list::de_application_arn_list(tokens, _value, depth + 1)?,
                            );
                        }
