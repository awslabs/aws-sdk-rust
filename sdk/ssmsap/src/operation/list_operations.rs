...
impl ListOperationsInput {
    /// Consumes the builder and constructs an Operation<[`ListOperations`](crate::operation::list_operations::ListOperations)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_operations::ListOperations, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_operations::ser_list_operations_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_operations::ListOperations::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListOperations", "ssmsap"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOperations {
    type Output =
        ::std::result::Result<crate::operation::list_operations::ListOperationsOutput, crate::operation::list_operations::ListOperationsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_operations::de_list_operations_http_response_with_props(status, headers, body)
        }
    }
}
