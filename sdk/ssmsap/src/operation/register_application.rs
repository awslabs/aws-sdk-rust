...
impl RegisterApplicationInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_application::ser_register_application_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_application::RegisterApplication::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::register_application::RegisterApplicationError
{
