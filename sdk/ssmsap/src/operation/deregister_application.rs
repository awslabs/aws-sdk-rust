...
impl DeregisterApplicationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_application::DeregisterApplication,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_application::de_deregister_application_http_response_with_props(status, headers, body)
        }
    }
}
