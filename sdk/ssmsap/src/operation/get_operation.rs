...
impl GetOperationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_operation::GetOperation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_operation::ser_get_operation_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOperation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_operation::de_get_operation_http_response_with_props(status, headers, body)
        }
    }
}
