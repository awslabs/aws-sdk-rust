...
/// Paginator for [`ListOperations`](crate::operation::ListOperations)
            ...
            impl ListOperationsPaginator  {
                ...
                /// Create a flattened paginator
                    ...
                    /// are dispatched lazily.
                    pub fn items(self) -> crate::paginator::ListOperationsPaginatorItems {
...
/// Flattened paginator for `ListDatabasesPaginator`
                ...
                impl  ListDatabasesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::DatabaseSummary, aws_smithy_http::result::SdkError<crate::error::ListDatabasesError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_databases_output_databases(page).unwrap_or_default().into_iter())
                    }
                }
...
/// Flattened paginator for `ListOperationsPaginator`
                ...
                impl  ListOperationsPaginatorItems  {
                    ...
                    ///
                    /// To read the entirety of the paginator, use [`.collect::<Result<Vec<_>, _>()`](tokio_stream::StreamExt::collect).
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::Operation, aws_smithy_http::result::SdkError<crate::error::ListOperationsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_operations_output_operations(page).unwrap_or_default().into_iter())
                    }
                }
