...
impl super::Client {
    ...
    ///   - [`configuration_id(impl Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::configuration_id) / [`set_configuration_id(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_configuration_id):<br>required: **true**<br><p>The unique ID that Amazon MQ generates for the configuration.</p><br>
    ///   - [`configuration_revision(impl Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::configuration_revision) / [`set_configuration_revision(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_configuration_revision):<br>required: **true**<br><p>The revision of the configuration.</p><br>
