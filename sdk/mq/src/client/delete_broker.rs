...
impl super::Client {
    ...
    ///   - [`broker_id(impl Into<String>)`](crate::operation::delete_broker::builders::DeleteBrokerFluentBuilder::broker_id) / [`set_broker_id(Option<String>)`](crate::operation::delete_broker::builders::DeleteBrokerFluentBuilder::set_broker_id):<br>required: **true**<br><p>The unique ID that Amazon MQ generates for the broker.</p><br>
