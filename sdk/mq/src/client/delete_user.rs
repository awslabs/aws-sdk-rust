...
impl super::Client {
    ...
    ///   - [`broker_id(impl ::std::convert::Into<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::broker_id) / [`set_broker_id(Option<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::set_broker_id): <p>The unique ID that Amazon MQ generates for the broker.</p>
    ///   - [`username(impl ::std::convert::Into<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::username) / [`set_username(Option<String>)`](crate::operation::delete_user::builders::DeleteUserFluentBuilder::set_username): <p>The username of the ActiveMQ user. This value can contain only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value must be 2-100 characters long.</p>
