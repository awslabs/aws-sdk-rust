...
impl Client {
    ...
    pub fn create_broker(&self) -> crate::client::fluent_builders::CreateBroker {
        crate::client::fluent_builders::CreateBroker::new(self.handle.clone())
    }
    ...
    pub fn update_broker(&self) -> crate::client::fluent_builders::UpdateBroker {
        crate::client::fluent_builders::UpdateBroker::new(self.handle.clone())
    }
