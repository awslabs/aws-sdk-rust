...
pub use crate::operation::promote::_promote_output::PromoteOutputBuilder;

pub use crate::operation::promote::_promote_input::PromoteInputBuilder;

impl crate::operation::promote::builders::PromoteInputBuilder {
...
pub struct PromoteFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::promote::builders::PromoteInputBuilder,
    config_override: ::std::option::Option<crate::config::Builder>,
}
impl crate::client::customize::internal::CustomizableSend<crate::operation::promote::PromoteOutput, crate::operation::promote::PromoteError>
    for PromoteFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::promote::PromoteOutput, crate::operation::promote::PromoteError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl PromoteFluentBuilder {
    /// Creates a new `PromoteFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins = crate::operation::promote::Promote::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::promote::Promote::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> crate::client::customize::CustomizableOperation<crate::operation::promote::PromoteOutput, crate::operation::promote::PromoteError, Self>
    {
