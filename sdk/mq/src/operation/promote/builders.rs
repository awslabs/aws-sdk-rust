...
impl PromoteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::promote::PromoteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::promote::PromoteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
