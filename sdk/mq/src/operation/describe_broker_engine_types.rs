    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/broker-engine-types")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypes::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError
{
