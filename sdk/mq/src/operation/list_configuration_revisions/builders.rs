...
impl crate::operation::list_configuration_revisions::builders::ListConfigurationRevisionsInputBuilder {
...
impl ListConfigurationRevisionsFluentBuilder {
    /// Creates a new `ListConfigurationRevisionsFluentBuilder`.
