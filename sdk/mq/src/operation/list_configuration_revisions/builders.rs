...
impl ListConfigurationRevisionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_configuration_revisions::ListConfigurationRevisionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_configuration_revisions::ListConfigurationRevisionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_configuration_revisions::ListConfigurationRevisionsOutput, crate::operation::list_configuration_revisions::ListConfigurationRevisionsError, Self> {
