...
impl RebootBrokerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reboot_broker::RebootBroker,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let broker_id = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reboot_broker::RebootBroker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootBroker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reboot_broker::de_reboot_broker_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_reboot_broker::de_reboot_broker_http_response_with_props(
                status, headers, body,
            )
        }
    }
