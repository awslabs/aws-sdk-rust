    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/brokers/{BrokerId}", BrokerId = broker_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_broker::DeleteBroker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBroker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_broker::de_delete_broker_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_broker::de_delete_broker_http_response_with_props(
                status, headers, body,
            )
        }
    }
