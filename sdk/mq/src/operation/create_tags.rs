...
impl CreateTagsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_tags::CreateTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_create_tags::de_create_tags_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_tags::de_create_tags_http_response_with_props(
                status, headers, body,
            )
        }
    }
