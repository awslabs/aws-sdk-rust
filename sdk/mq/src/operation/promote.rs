...
impl PromoteInput {
    /// Consumes the builder and constructs an Operation<[`Promote`](crate::operation::promote::Promote)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::promote::Promote, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_promote::ser_promote_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::promote::Promote::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("Promote", "mq"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for Promote {
    type Output = ::std::result::Result<crate::operation::promote::PromoteOutput, crate::operation::promote::PromoteError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_promote::de_promote_http_response_with_props(status, headers, body)
        }
    }
}
