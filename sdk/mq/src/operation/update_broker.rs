...
impl UpdateBrokerInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_broker::UpdateBroker, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_broker::ser_update_broker_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBroker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_broker::de_update_broker_http_response_with_props(status, headers, body)
        }
    }
}
