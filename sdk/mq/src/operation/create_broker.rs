...
impl CreateBrokerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_broker::CreateBroker::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBroker {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_broker::de_create_broker_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_broker::de_create_broker_http_response_with_props(
                status, headers, body,
            )
        }
    }
