...
impl CreateBrokerInput {
    /// Consumes the builder and constructs an Operation<[`CreateBroker`](crate::operation::create_broker::CreateBroker)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_broker::CreateBroker, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        if self.creator_request_id.is_none() {
            self.creator_request_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
        }
        let mut request = {
            fn uri_base(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_broker::ser_create_broker_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_broker::CreateBroker::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBroker {
    type Output = ::std::result::Result<crate::operation::create_broker::CreateBrokerOutput, crate::operation::create_broker::CreateBrokerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_broker::de_create_broker_http_response_with_props(status, headers, body)
        }
    }
}
