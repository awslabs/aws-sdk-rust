...
pub struct SanitizationWarning  {
    ...
    #[doc(hidden)]pub element_name: std::option::Option<std::string::String>,
    /// <p>Required. The reason for which the XML elements or attributes were sanitized.</p>
    #[doc(hidden)]pub reason: std::option::Option<crate::model::SanitizationWarningReason>,
}
...
pub struct WeeklyStartTime  {
    ...
    #[doc(hidden)]pub time_of_day: std::option::Option<std::string::String>,
...
pub struct Logs  {
    ...
    #[doc(hidden)]pub audit: bool,
    /// <p>Enables general logging.</p>
    #[doc(hidden)]pub general: bool,
}
impl Logs {
    /// <p>Enables audit logging. Every user management action made using JMX or the ActiveMQ Web Console is logged. Does not apply to RabbitMQ brokers.</p>
...
pub struct LdapServerMetadataOutput  {
    ...
    #[doc(hidden)]pub hosts: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub role_base: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub role_search_matching: std::option::Option<std::string::String>,
    /// <p>The directory search scope for the role. If set to true, scope is to search the entire subtree.</p>
    #[doc(hidden)]pub role_search_subtree: bool,
    ...
    #[doc(hidden)]pub service_account_username: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub user_base: std::option::Option<std::string::String>,
    /// <p>Specifies the name of the LDAP attribute for the user group membership.</p>
    #[doc(hidden)]pub user_role_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub user_search_matching: std::option::Option<std::string::String>,
    /// <p>The directory search scope for the user. If set to true, scope is to search the entire subtree.</p>
    #[doc(hidden)]pub user_search_subtree: bool,
}
...
pub struct LdapServerMetadataInput  {
    ...
    #[doc(hidden)]pub service_account_password: std::option::Option<std::string::String>,
    /// <p>Service account username. A service account is an account in your LDAP server that has access to initiate a connection. For example, cn=admin,dc=corp, dc=example, dc=com.</p>
    #[doc(hidden)]pub service_account_username: std::option::Option<std::string::String>,
    /// <p>Select a particular subtree of the directory information tree (DIT) to search for user entries. The subtree is specified by a DN, which specifies the base node of the subtree. For example, by setting this option to ou=Users,ou=corp, dc=corp, dc=example, dc=com, the search for user entries is restricted to the subtree beneath ou=Users, ou=corp, dc=corp, dc=example, dc=com.</p>
    #[doc(hidden)]pub user_base: std::option::Option<std::string::String>,
...
pub struct UserSummary  {
    ...
    #[doc(hidden)]pub pending_change: std::option::Option<crate::model::ChangeType>,
...
pub struct Configuration  {
    ...
    #[doc(hidden)]pub latest_revision: std::option::Option<crate::model::ConfigurationRevision>,
...
pub struct BrokerSummary  {
    ...
    #[doc(hidden)]pub broker_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub broker_state: std::option::Option<crate::model::BrokerState>,
...
pub struct BrokerInstanceOption  {
    ...
    #[doc(hidden)]pub supported_deployment_modes: std::option::Option<std::vec::Vec<crate::model::DeploymentMode>>,
    /// <p>The list of supported engine versions.</p>
    #[doc(hidden)]pub supported_engine_versions: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for BrokerInstanceOption  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("supported_deployment_modes", &self.supported_deployment_modes);
...
pub struct BrokerEngineType  {
    ...
    #[doc(hidden)]pub engine_versions: std::option::Option<std::vec::Vec<crate::model::EngineVersion>>,
}
...
pub struct LogsSummary  {
    ...
    #[doc(hidden)]pub audit_log_group: std::option::Option<std::string::String>,
    /// <p>Enables general logging.</p>
    #[doc(hidden)]pub general: bool,
    /// <p>The location of the CloudWatch Logs log group where general logs are sent.</p>
    #[doc(hidden)]pub general_log_group: std::option::Option<std::string::String>,
    /// <p>The list of information about logs pending to be deployed for the specified broker.</p>
    #[doc(hidden)]pub pending: std::option::Option<crate::model::PendingLogs>,
}
impl LogsSummary {
    /// <p>Enables audit logging. Every user management action made using JMX or the ActiveMQ Web Console is logged.</p>
    pub fn audit(&self) -> bool {
...
pub struct EncryptionOptions  {
    ...
    #[doc(hidden)]pub use_aws_owned_key: bool,
}
...
pub struct Configurations  {
    ...
    #[doc(hidden)]pub current: std::option::Option<crate::model::ConfigurationId>,
    /// <p>The history of configurations applied to the broker.</p>
    #[doc(hidden)]pub history: std::option::Option<std::vec::Vec<crate::model::ConfigurationId>>,
    /// <p>The broker's pending configuration.</p>
    #[doc(hidden)]pub pending: std::option::Option<crate::model::ConfigurationId>,
}
impl Configurations {
    /// <p>The broker's current configuration.</p>
...
pub struct BrokerInstance  {
    ...
    #[doc(hidden)]pub console_url: std::option::Option<std::string::String>,
    /// <p>The broker's wire-level protocol endpoints.</p>
    #[doc(hidden)]pub endpoints: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ActionRequired  {
    ...
    #[doc(hidden)]pub action_required_code: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub action_required_info: std::option::Option<std::string::String>,
}
impl ActionRequired {
    /// <p>The code you can use to resolve your broker issue when the broker is in a CRITICAL_ACTION_REQUIRED state. You can find instructions by choosing the link for your code from the list of action required codes in <a href="https://docs.aws.amazon.com//latest/developer-guide/troubleshooting-action-required-codes.html">Amazon MQ action required codes</a>. Each code references a topic with detailed information, instructions, and recommendations for how to resolve the issue and prevent future occurrences.</p>
