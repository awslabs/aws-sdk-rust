...
pub struct UpdateConfigurationOutput  {
    ...
    #[doc(hidden)]pub warnings: std::option::Option<std::vec::Vec<crate::model::SanitizationWarning>>,
}
...
pub struct UpdateBrokerOutput  {
    ...
    #[doc(hidden)]pub ldap_server_metadata: std::option::Option<crate::model::LdapServerMetadataOutput>,
...
pub struct ListUsersOutput  {
    ...
    #[doc(hidden)]pub users: std::option::Option<std::vec::Vec<crate::model::UserSummary>>,
}
...
pub struct ListConfigurationRevisionsOutput  {
    ...
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>The list of all revisions for the specified configuration.</p>
    #[doc(hidden)]pub revisions: std::option::Option<std::vec::Vec<crate::model::ConfigurationRevision>>,
}
...
pub struct ListBrokersOutput  {
    ...
    #[doc(hidden)]pub broker_summaries: std::option::Option<std::vec::Vec<crate::model::BrokerSummary>>,
    /// <p>The token that specifies the next page of results Amazon MQ should return. To request the first page, leave nextToken empty.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeUserOutput  {
    ...
    #[doc(hidden)]pub pending: std::option::Option<crate::model::UserPendingChanges>,
...
pub struct DescribeBrokerInstanceOptionsOutput  {
    ...
    #[doc(hidden)]pub broker_instance_options: std::option::Option<std::vec::Vec<crate::model::BrokerInstanceOption>>,
...
pub struct DescribeBrokerEngineTypesOutput  {
    ...
    #[doc(hidden)]pub broker_engine_types: std::option::Option<std::vec::Vec<crate::model::BrokerEngineType>>,
...
pub struct DescribeBrokerOutput  {
    ...
    #[doc(hidden)]pub actions_required: std::option::Option<std::vec::Vec<crate::model::ActionRequired>>,
    ...
    #[doc(hidden)]pub broker_instances: std::option::Option<std::vec::Vec<crate::model::BrokerInstance>>,
    ...
    /// <p>The list of all revisions for the specified configuration.</p>
    #[doc(hidden)]pub configurations: std::option::Option<crate::model::Configurations>,
    ...
    #[doc(hidden)]pub logs: std::option::Option<crate::model::LogsSummary>,
    /// <p>The parameters that determine the WeeklyStartTime.</p>
    #[doc(hidden)]pub maintenance_window_start_time: std::option::Option<crate::model::WeeklyStartTime>,
    /// <p>The authentication strategy that will be applied when the broker is rebooted. The default is SIMPLE.</p>
    #[doc(hidden)]pub pending_authentication_strategy: std::option::Option<crate::model::AuthenticationStrategy>,
    /// <p>The broker engine version to upgrade to. For a list of supported engine versions, see <a href="https://docs.aws.amazon.com//amazon-mq/latest/developer-guide/broker-engine.html">Supported engines</a>.</p>
    #[doc(hidden)]pub pending_engine_version: std::option::Option<std::string::String>,
    /// <p>The broker's host instance type to upgrade to. For a list of supported instance types, see <a href="https://docs.aws.amazon.com//amazon-mq/latest/developer-guide/broker.html#broker-instance-types">Broker instance types</a>.</p>
    #[doc(hidden)]pub pending_host_instance_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub pending_ldap_server_metadata: std::option::Option<crate::model::LdapServerMetadataOutput>,
    /// <p>The list of pending security groups to authorize connections to brokers.</p>
    #[doc(hidden)]pub pending_security_groups: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for DescribeBrokerOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("logs", &self.logs);
        formatter.field("maintenance_window_start_time", &self.maintenance_window_start_time);
        formatter.field("pending_authentication_strategy", &self.pending_authentication_strategy);
        formatter.field("pending_engine_version", &self.pending_engine_version);
        formatter.field("pending_host_instance_type", &self.pending_host_instance_type);
        formatter.field("pending_ldap_server_metadata", &self.pending_ldap_server_metadata);
