...
pub fn ser_create_broker_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBrokerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
