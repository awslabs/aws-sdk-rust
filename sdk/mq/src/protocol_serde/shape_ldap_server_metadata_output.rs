...
pub(crate) fn de_ldap_server_metadata_output<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LdapServerMetadataOutput>, aws_smithy_json::deserialize::error::DeserializeError>
