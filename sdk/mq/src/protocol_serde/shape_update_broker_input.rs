...
pub fn ser_update_broker_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateBrokerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
