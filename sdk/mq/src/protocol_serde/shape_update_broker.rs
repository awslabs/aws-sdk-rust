...
pub fn de_update_broker_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_broker::UpdateBrokerOutput, crate::operation::update_broker::UpdateBrokerError> {
    #[allow(unused_mut)]
...
pub fn de_update_broker_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_broker::de_update_broker(_response_body, output)
            .map_err(crate::operation::update_broker::UpdateBrokerError::unhandled)?;
...
) -> Result<crate::operation::update_broker::builders::UpdateBrokerOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "autoMinorVersionUpgrade" => {
                    builder = builder.set_auto_minor_version_upgrade(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "brokerId" => {
                ...
                "dataReplicationMode" => {
                    builder = builder.set_data_replication_mode(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::DataReplicationMode::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "engineVersion" => {
