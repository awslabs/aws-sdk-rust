...
pub fn de_describe_broker_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_broker::DescribeBrokerOutput, crate::operation::describe_broker::DescribeBrokerError> {
    #[allow(unused_mut)]
...
pub fn de_describe_broker_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_broker::de_describe_broker(_response_body, output)
            .map_err(crate::operation::describe_broker::DescribeBrokerError::unhandled)?;
...
) -> Result<crate::operation::describe_broker::builders::DescribeBrokerOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "encryptionOptions" => {
                    builder = builder.set_encryption_options(crate::protocol_serde::shape_encryption_options::de_encryption_options(tokens)?);
                }
                "engineType" => {
                ...
                "logs" => {
                    builder = builder.set_logs(crate::protocol_serde::shape_logs_summary::de_logs_summary(tokens)?);
                }
