...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_broker_instance_options::de_describe_broker_instance_options(_response_body, output)
            .map_err(crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "brokerInstanceOptions" => {
                    builder = builder.set_broker_instance_options(
                        crate::protocol_serde::shape_list_of_broker_instance_option::de_list_of_broker_instance_option(tokens, _value, depth + 1)?,
                    );
                }
                "maxResults" => {
