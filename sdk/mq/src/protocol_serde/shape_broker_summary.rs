...
pub(crate) fn de_broker_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BrokerSummary>, aws_smithy_json::deserialize::error::DeserializeError>
