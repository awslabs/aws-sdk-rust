...
pub(crate) fn de_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Configuration>, aws_smithy_json::deserialize::error::DeserializeError>
