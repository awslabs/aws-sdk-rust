...
impl DeleteLogGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_log_group::DeleteLogGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_log_group::ser_delete_log_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLogGroup {
    type Output =
        ::std::result::Result<crate::operation::delete_log_group::DeleteLogGroupOutput, crate::operation::delete_log_group::DeleteLogGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_log_group::de_delete_log_group_http_response_with_props(status, headers, body)
        }
    }
}
