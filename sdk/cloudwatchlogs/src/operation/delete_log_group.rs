...
impl DeleteLogGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLogGroup`](crate::operation::delete_log_group::DeleteLogGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_log_group::DeleteLogGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_log_group::DeleteLogGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_log_group::DeleteLogGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteLogGroup", "cloudwatchlogs"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DeleteLogGroup`.
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteLogGroup {
                type Output = std::result::Result<crate::operation::delete_log_group::DeleteLogGroupOutput, crate::operation::delete_log_group::DeleteLogGroupError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_log_group::de_delete_log_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_log_group::de_delete_log_group_http_response(response)
                     }
                }
            }
