...
impl DeleteRetentionPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_retention_policy::DeleteRetentionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_retention_policy::DeleteRetentionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_retention_policy::DeleteRetentionPolicyOutput, crate::operation::delete_retention_policy::DeleteRetentionPolicyError, Self> {
