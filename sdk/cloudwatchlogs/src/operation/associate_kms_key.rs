...
impl AssociateKmsKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_kms_key::AssociateKmsKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_kms_key::ser_associate_kms_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateKmsKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_kms_key::de_associate_kms_key_http_response_with_props(status, headers, body)
        }
    }
}
