...
impl UpdateLogAnomalyDetectorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_log_anomaly_detector::UpdateLogAnomalyDetectorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_log_anomaly_detector::UpdateLogAnomalyDetectorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_log_anomaly_detector::UpdateLogAnomalyDetectorOutput, crate::operation::update_log_anomaly_detector::UpdateLogAnomalyDetectorError, Self> {
