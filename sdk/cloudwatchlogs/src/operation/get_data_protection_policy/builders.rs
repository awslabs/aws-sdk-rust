...
impl GetDataProtectionPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_data_protection_policy::GetDataProtectionPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_data_protection_policy::GetDataProtectionPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_data_protection_policy::GetDataProtectionPolicyOutput, crate::operation::get_data_protection_policy::GetDataProtectionPolicyError, Self> {
