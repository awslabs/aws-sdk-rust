...
impl FilterLogEventsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::filter_log_events::FilterLogEvents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_filter_log_events::ser_filter_log_events_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for FilterLogEvents {
    type Output =
        ::std::result::Result<crate::operation::filter_log_events::FilterLogEventsOutput, crate::operation::filter_log_events::FilterLogEventsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_filter_log_events::de_filter_log_events_http_response_with_props(status, headers, body)
        }
    }
}
