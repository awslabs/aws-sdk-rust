...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDeliveryDestination {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetDeliveryDestination", "cloudwatchlogs"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDeliveryDestination")
...
pub type GetDeliveryDestinationErrorKind = GetDeliveryDestinationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_delivery_destination::GetDeliveryDestinationError {
...
impl GetDeliveryDestinationError {
    ...
    /// Creates the `GetDeliveryDestinationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
