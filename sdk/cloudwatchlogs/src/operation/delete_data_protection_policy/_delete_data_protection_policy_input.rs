...
impl DeleteDataProtectionPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_data_protection_policy::DeleteDataProtectionPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
