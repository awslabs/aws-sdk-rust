...
impl PutDataProtectionPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutDataProtectionPolicy`](crate::operation::put_data_protection_policy::PutDataProtectionPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_data_protection_policy::PutDataProtectionPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_data_protection_policy::PutDataProtectionPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_data_protection_policy::PutDataProtectionPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutDataProtectionPolicy", "cloudwatchlogs"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `PutDataProtectionPolicy`.
...
impl aws_smithy_http::response::ParseStrictResponse for PutDataProtectionPolicy {
                type Output = std::result::Result<crate::operation::put_data_protection_policy::PutDataProtectionPolicyOutput, crate::operation::put_data_protection_policy::PutDataProtectionPolicyError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_data_protection_policy::de_put_data_protection_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_data_protection_policy::de_put_data_protection_policy_http_response(response)
                     }
                }
            }
