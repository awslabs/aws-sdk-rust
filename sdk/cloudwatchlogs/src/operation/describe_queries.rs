...
impl DescribeQueriesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_queries::DescribeQueries, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_queries::ser_describe_queries_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeQueries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_queries::de_describe_queries_http_response_with_props(status, headers, body)
        }
    }
}
