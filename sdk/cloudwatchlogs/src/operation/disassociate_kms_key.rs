...
impl DisassociateKmsKeyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_kms_key::ser_disassociate_kms_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateKmsKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_kms_key::de_disassociate_kms_key_http_response_with_props(status, headers, body)
        }
    }
}
