...
impl PutRetentionPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_retention_policy::ser_put_retention_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRetentionPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_retention_policy::de_put_retention_policy_http_response_with_props(status, headers, body)
        }
    }
}
