...
impl CancelExportTaskInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_export_task::ser_cancel_export_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelExportTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_export_task::de_cancel_export_task_http_response_with_props(status, headers, body)
        }
    }
}
