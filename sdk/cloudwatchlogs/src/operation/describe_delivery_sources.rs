...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDeliverySources {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DescribeDeliverySources", "cloudwatchlogs"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDeliverySources")
...
pub type DescribeDeliverySourcesErrorKind = DescribeDeliverySourcesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_delivery_sources::DescribeDeliverySourcesError {
...
impl DescribeDeliverySourcesError {
    ...
    /// Creates the `DescribeDeliverySourcesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
