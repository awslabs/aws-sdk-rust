...
/// Paginator for [`DescribeSubscriptionFilters`](crate::operation::describe_subscription_filters::DescribeSubscriptionFilters)
            ...
            impl DescribeSubscriptionFiltersPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersOutput, aws_smithy_http::result::SdkError<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersError>>> + Unpin
                 {
...
/// Flattened paginator for `DescribeSubscriptionFiltersPaginator`
                ...
                impl  DescribeSubscriptionFiltersPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::SubscriptionFilter, aws_smithy_http::result::SdkError<crate::operation::describe_subscription_filters::DescribeSubscriptionFiltersError>>> + Unpin
                     {
