...
impl DescribeLogGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_log_groups::ser_describe_log_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLogGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_log_groups::de_describe_log_groups_http_response_with_props(status, headers, body)
        }
    }
}
