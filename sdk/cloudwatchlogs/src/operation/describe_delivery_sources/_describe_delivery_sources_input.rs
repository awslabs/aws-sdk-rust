...
impl DescribeDeliverySourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_delivery_sources::DescribeDeliverySourcesInput, ::aws_smithy_types::error::operation::BuildError> {
