...
impl PutMetricFilterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_metric_filter::PutMetricFilter, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_metric_filter::ser_put_metric_filter_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricFilter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_metric_filter::de_put_metric_filter_http_response_with_props(status, headers, body)
        }
    }
}
