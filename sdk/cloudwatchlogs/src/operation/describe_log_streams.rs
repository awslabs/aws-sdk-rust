...
impl DescribeLogStreamsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLogStreams`](crate::operation::describe_log_streams::DescribeLogStreams)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_log_streams::DescribeLogStreams, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_log_streams::DescribeLogStreamsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_log_streams::ser_describe_log_streams_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_log_streams::DescribeLogStreams::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeLogStreams", "cloudwatchlogs"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeLogStreams`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLogStreams {
                type Output = std::result::Result<crate::operation::describe_log_streams::DescribeLogStreamsOutput, crate::operation::describe_log_streams::DescribeLogStreamsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_log_streams::de_describe_log_streams_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_log_streams::de_describe_log_streams_http_response(response)
                     }
                }
            }
