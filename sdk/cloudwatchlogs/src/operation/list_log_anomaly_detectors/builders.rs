...
impl ListLogAnomalyDetectorsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsOutput, crate::operation::list_log_anomaly_detectors::ListLogAnomalyDetectorsError, Self> {
