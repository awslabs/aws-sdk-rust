...
impl StartLiveTail {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudwatchlogs", "StartLiveTail", input, runtime_plugins, stop_point)
            .await
    }
