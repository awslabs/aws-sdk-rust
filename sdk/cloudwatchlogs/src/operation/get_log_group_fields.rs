...
impl GetLogGroupFieldsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_log_group_fields::ser_get_log_group_fields_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLogGroupFields {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_log_group_fields::de_get_log_group_fields_http_response_with_props(status, headers, body)
        }
    }
}
