...
pub type PutDeliveryDestinationPolicyErrorKind = PutDeliveryDestinationPolicyError;
...
impl PutDeliveryDestinationPolicyError {
    ...
    /// Creates the `PutDeliveryDestinationPolicyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
