...
pub fn ser_describe_deliveries_input(
    ...
    crate::protocol_serde::shape_describe_deliveries_input::ser_describe_deliveries_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "deliveries" => {
                    builder = builder.set_deliveries(crate::protocol_serde::shape_deliveries::de_deliveries(tokens)?);
                }
                "nextToken" => {
