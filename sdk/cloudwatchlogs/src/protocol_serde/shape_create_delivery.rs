...
pub fn de_create_delivery_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_delivery::CreateDeliveryOutput, crate::operation::create_delivery::CreateDeliveryError> {
    #[allow(unused_mut)]
...
pub fn ser_create_delivery_input(
    ...
    crate::protocol_serde::shape_create_delivery_input::ser_create_delivery_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::create_delivery::builders::CreateDeliveryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
