...
pub fn ser_get_delivery_destination_input(
    ...
    crate::protocol_serde::shape_get_delivery_destination_input::ser_get_delivery_destination_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "deliveryDestination" => {
                    builder = builder.set_delivery_destination(crate::protocol_serde::shape_delivery_destination::de_delivery_destination(tokens)?);
                }
