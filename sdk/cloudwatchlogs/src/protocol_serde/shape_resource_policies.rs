...
pub(crate) fn de_resource_policies<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ResourcePolicy>>, aws_smithy_json::deserialize::error::DeserializeError>
