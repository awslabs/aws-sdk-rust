...
) -> Result<crate::operation::test_metric_filter::builders::TestMetricFilterOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "matches" => {
                    builder = builder.set_matches(crate::protocol_serde::shape_metric_filter_matches::de_metric_filter_matches(tokens)?);
                }
