...
pub fn ser_describe_log_groups_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeLogGroupsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
