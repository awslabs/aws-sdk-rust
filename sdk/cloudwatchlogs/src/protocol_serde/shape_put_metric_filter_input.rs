...
pub fn ser_put_metric_filter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutMetricFilterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
