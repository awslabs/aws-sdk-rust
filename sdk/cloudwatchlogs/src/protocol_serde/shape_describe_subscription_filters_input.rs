...
pub fn ser_describe_subscription_filters_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeSubscriptionFiltersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
