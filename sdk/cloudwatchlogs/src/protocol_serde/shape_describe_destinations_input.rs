...
pub fn ser_describe_destinations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeDestinationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
