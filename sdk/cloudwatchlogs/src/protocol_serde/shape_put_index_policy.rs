...
) -> Result<crate::operation::put_index_policy::builders::PutIndexPolicyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "indexPolicy" => {
                    builder = builder.set_index_policy(crate::protocol_serde::shape_index_policy::de_index_policy(tokens)?);
                }
