...
pub fn ser_put_log_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutLogEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
