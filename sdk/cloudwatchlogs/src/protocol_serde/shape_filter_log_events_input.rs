...
pub fn ser_filter_log_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::FilterLogEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
