...
pub fn ser_describe_queries_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeQueriesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
