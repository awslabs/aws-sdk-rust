...
) -> Result<Option<crate::types::UpperCaseString>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "withKeys" => {
                            builder = builder.set_with_keys(
                                crate::protocol_serde::shape_upper_case_string_with_keys::de_upper_case_string_with_keys(tokens)?,
                            );
                        }
