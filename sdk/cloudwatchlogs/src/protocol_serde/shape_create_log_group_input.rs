...
pub fn ser_create_log_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLogGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
