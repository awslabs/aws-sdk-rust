...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_log_streams_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::describe_log_streams::builders::DescribeLogStreamsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "logStreams" => {
                    builder = builder.set_log_streams(crate::protocol_serde::shape_log_streams::de_log_streams(tokens)?);
                }
                "nextToken" => {
