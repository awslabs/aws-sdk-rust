...
) -> Result<crate::operation::describe_log_groups::builders::DescribeLogGroupsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "logGroups" => {
                    builder = builder.set_log_groups(crate::protocol_serde::shape_log_groups::de_log_groups(tokens)?);
                }
                "nextToken" => {
