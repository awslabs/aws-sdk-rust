...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_log_group_fields_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::get_log_group_fields::builders::GetLogGroupFieldsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "logGroupFields" => {
                    builder = builder.set_log_group_fields(crate::protocol_serde::shape_log_group_field_list::de_log_group_field_list(tokens)?);
                }
