...
) -> Result<crate::operation::test_transformer::builders::TestTransformerOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "transformedLogs" => {
                    builder = builder.set_transformed_logs(crate::protocol_serde::shape_transformed_logs::de_transformed_logs(tokens)?);
                }
