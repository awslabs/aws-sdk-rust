...
pub fn ser_metric_transformation(
    ...
    if let Some(var_1) = &input.default_value {
        object.key("defaultValue").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_1).into()));
    }
...
pub(crate) fn de_metric_transformation<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MetricTransformation>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::metric_transformation_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
