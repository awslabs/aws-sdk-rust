...
pub fn ser_put_subscription_filter_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutSubscriptionFilterInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
