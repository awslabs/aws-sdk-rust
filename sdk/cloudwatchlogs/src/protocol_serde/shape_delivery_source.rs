...
) -> Result<Option<crate::types::DeliverySource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "resourceArns" => {
                            builder = builder.set_resource_arns(crate::protocol_serde::shape_resource_arns::de_resource_arns(tokens)?);
                        }
                        "service" => {
