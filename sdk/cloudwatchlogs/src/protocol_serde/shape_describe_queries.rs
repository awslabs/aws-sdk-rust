...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_queries_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_queries::DescribeQueriesOutput, crate::operation::describe_queries::DescribeQueriesError> {
...
) -> Result<crate::operation::describe_queries::builders::DescribeQueriesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "queries" => {
                    builder = builder.set_queries(crate::protocol_serde::shape_query_info_list::de_query_info_list(tokens)?);
                }
                "nextToken" => {
