...
pub fn ser_get_delivery_input(
    ...
    crate::protocol_serde::shape_get_delivery_input::ser_get_delivery_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::get_delivery::builders::GetDeliveryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
