...
pub(crate) fn de_live_tail_session_start_payload(
    ...
    let result = crate::protocol_serde::shape_live_tail_session_start::de_live_tail_session_start(tokens)?
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "logGroupIdentifiers" => {
                            builder = builder.set_log_group_identifiers(
                                crate::protocol_serde::shape_start_live_tail_log_group_identifiers::de_start_live_tail_log_group_identifiers(tokens)?,
                            );
                        }
                        "logStreamNames" => {
                            builder =
                                builder.set_log_stream_names(crate::protocol_serde::shape_input_log_stream_names::de_input_log_stream_names(tokens)?);
                        }
                        "logStreamNamePrefixes" => {
                            builder = builder.set_log_stream_name_prefixes(
                                crate::protocol_serde::shape_input_log_stream_names::de_input_log_stream_names(tokens)?,
                            );
                        }
