...
pub fn ser_untag_log_group_input(
    ...
    crate::protocol_serde::shape_untag_log_group_input::ser_untag_log_group_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        "ResourceNotFoundException" => {
            crate::operation::untag_log_group::UntagLogGroupError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_untag_log_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
