...
pub fn ser_describe_metric_filters_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeMetricFiltersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
