...
pub fn de_delete_delivery_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_delivery::DeleteDeliveryOutput, crate::operation::delete_delivery::DeleteDeliveryError> {
    #[allow(unused_mut)]
...
pub fn ser_delete_delivery_input(
    ...
    crate::protocol_serde::shape_delete_delivery_input::ser_delete_delivery_input(&mut object, input)?;
    object.finish();
