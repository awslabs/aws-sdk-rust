...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_log_events_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_log_events::GetLogEventsOutput, crate::operation::get_log_events::GetLogEventsError> {
...
) -> Result<crate::operation::get_log_events::builders::GetLogEventsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "events" => {
                    builder = builder.set_events(crate::protocol_serde::shape_output_log_events::de_output_log_events(tokens)?);
                }
                "nextForwardToken" => {
