...
impl  Anomaly  {
    ...
    pub fn pattern_id(&self) -> & str {
        use std::ops::Deref; self.pattern_id.deref()
    }
    /// <p>The ARN of the anomaly detector that identified this anomaly.</p>
    pub fn anomaly_detector_arn(&self) -> & str {
        use std::ops::Deref; self.anomaly_detector_arn.deref()
    }
    /// <p>The pattern used to help identify this anomaly, in string format.</p>
    pub fn pattern_string(&self) -> & str {
        use std::ops::Deref; self.pattern_string.deref()
    }
    /// <p>The pattern used to help identify this anomaly, in regular expression format.</p>
    ...
    pub fn log_samples(&self) -> & [crate::types::LogEvent] {
        use std::ops::Deref; self.log_samples.deref()
    }
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    pub fn pattern_tokens(&self) -> & [crate::types::PatternToken] {
        use std::ops::Deref; self.pattern_tokens.deref()
    }
    /// <p>An array of ARNS of the log groups that contained log events considered to be part of this anomaly.</p>
    pub fn log_group_arn_list(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.log_group_arn_list.deref()
    }
    /// <p>Indicates whether this anomaly is currently suppressed. To suppress an anomaly, use <a href="https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_UpdateAnomaly.html">UpdateAnomaly</a>.</p>
...
impl AnomalyBuilder {
    ...
    pub fn set_pattern_string(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.pattern_string = input; self
    }
    /// <p>The pattern used to help identify this anomaly, in string format.</p>
    ...
    pub fn set_pattern_tokens(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::PatternToken>>) -> Self {
        self.pattern_tokens = input; self
    }
    /// <p>An array of structures where each structure contains information about one token that makes up the pattern.</p>
    ...
    pub fn set_log_group_arn_list(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::string::String>>) -> Self {
        self.log_group_arn_list = input; self
    }
    /// <p>An array of ARNS of the log groups that contained log events considered to be part of this anomaly.</p>
    ...
    pub fn set_suppressed_date(mut self, input: ::std::option::Option<i64>) -> Self {
        self.suppressed_date = input; self
    }
    /// <p>If the anomaly is suppressed, this indicates when it was suppressed.</p>
    ...
    pub fn set_suppressed_until(mut self, input: ::std::option::Option<i64>) -> Self {
        self.suppressed_until = input; self
    }
    /// <p>If the anomaly is suppressed, this indicates when the suppression will end. If this value is <code>0</code>, the anomaly was suppressed with no expiration, with the <code>INFINITE</code> value.</p>
    ...
    pub fn set_is_pattern_level_suppression(mut self, input: ::std::option::Option<bool>) -> Self {
        self.is_pattern_level_suppression = input; self
    }
    /// <p>If this anomaly is suppressed, this field is <code>true</code> if the suppression is because the pattern is suppressed. If <code>false</code>, then only this particular anomaly is suppressed.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::Anomaly {
                anomaly_id: self.anomaly_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("anomaly_id", "anomaly_id was not specified but it is required when building Anomaly")
                    )?
                ,
                pattern_id: self.pattern_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pattern_id", "pattern_id was not specified but it is required when building Anomaly")
                    )?
                ,
                anomaly_detector_arn: self.anomaly_detector_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("anomaly_detector_arn", "anomaly_detector_arn was not specified but it is required when building Anomaly")
                    )?
                ,
                pattern_string: self.pattern_string
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pattern_string", "pattern_string was not specified but it is required when building Anomaly")
                    )?
                ,
                ...
                description: self.description
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("description", "description was not specified but it is required when building Anomaly")
                    )?
                ,
                active: self.active
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("active", "active was not specified but it is required when building Anomaly")
                    )?
                ,
                state: self.state
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("state", "state was not specified but it is required when building Anomaly")
                    )?
                ,
                histogram: self.histogram
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("histogram", "histogram was not specified but it is required when building Anomaly")
                    )?
                ,
                log_samples: self.log_samples
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("log_samples", "log_samples was not specified but it is required when building Anomaly")
                    )?
                ,
                pattern_tokens: self.pattern_tokens
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("pattern_tokens", "pattern_tokens was not specified but it is required when building Anomaly")
                    )?
                ,
                log_group_arn_list: self.log_group_arn_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("log_group_arn_list", "log_group_arn_list was not specified but it is required when building Anomaly")
                    )?
                ,
                suppressed: self.suppressed
                ,
                suppressed_date: self.suppressed_date
                    .unwrap_or_default()
                ,
