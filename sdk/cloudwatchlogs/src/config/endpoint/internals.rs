...
if (*use_fips) == (true) {
                                ...
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url("https://logs.us-gov-east-1.amazonaws.com"
.to_string())
.build());
                            }
if (region) == ("us-gov-west-1") {
                                return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url("https://logs.us-gov-west-1.amazonaws.com"
.to_string())
.build());
                            }
return Ok(::aws_smithy_types::endpoint::Endpoint::builder().url({ let mut out = String::new();
