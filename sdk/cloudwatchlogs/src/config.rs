...
impl Builder {
    ...
    /// use aws_sdk_cloudwatchlogs::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("cloudwatchlogs"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("logs"));
        layer
