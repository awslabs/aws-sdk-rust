...
impl super::Client {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_log_stream::builders::CreateLogStreamFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::create_log_stream::builders::CreateLogStreamFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
