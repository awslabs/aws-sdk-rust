...
impl super::Client {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
    ///   - [`filter_name(impl ::std::convert::Into<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::filter_name) / [`set_filter_name(Option<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::set_filter_name): <p>A name for the metric filter.</p>
    ///   - [`filter_pattern(impl ::std::convert::Into<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::filter_pattern) / [`set_filter_pattern(Option<String>)`](crate::operation::put_metric_filter::builders::PutMetricFilterFluentBuilder::set_filter_pattern): <p>A filter pattern for extracting metric data out of ingested log events.</p>
