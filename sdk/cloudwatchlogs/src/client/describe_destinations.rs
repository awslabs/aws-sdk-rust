...
impl super::Client  {
    ...
    pub fn describe_destinations(&self) -> crate::client::fluent_builders::DescribeDestinations {
                                crate::client::fluent_builders::DescribeDestinations::new(self.handle.clone())
                            }
}
