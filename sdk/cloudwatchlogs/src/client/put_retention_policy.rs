...
impl super::Client {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_retention_policy::builders::PutRetentionPolicyFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::put_retention_policy::builders::PutRetentionPolicyFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
