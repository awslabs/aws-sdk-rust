...
impl super::Client {
    ...
    ///   - [`policy_type(PolicyType)`](crate::operation::describe_account_policies::builders::DescribeAccountPoliciesFluentBuilder::policy_type) / [`set_policy_type(Option<PolicyType>)`](crate::operation::describe_account_policies::builders::DescribeAccountPoliciesFluentBuilder::set_policy_type):<br>required: **true**<br><p>Use this parameter to limit the returned policies to only the policies that match the policy type that you specify. Currently, the only valid value is <code>DATA_PROTECTION_POLICY</code>.</p><br>
