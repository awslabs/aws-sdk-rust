...
impl super::Client {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_log_stream::builders::DeleteLogStreamFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::delete_log_stream::builders::DeleteLogStreamFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
