...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>)`](crate::operation::untag_log_group::builders::UntagLogGroupFluentBuilder::tags) / [`set_tags(Option<Vec<String>>)`](crate::operation::untag_log_group::builders::UntagLogGroupFluentBuilder::set_tags): <p>The tag keys. The corresponding tags are removed from the log group.</p>
