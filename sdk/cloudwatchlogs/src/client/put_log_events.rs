...
impl super::Client {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
    ///   - [`log_stream_name(impl ::std::convert::Into<String>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::log_stream_name) / [`set_log_stream_name(Option<String>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::set_log_stream_name): <p>The name of the log stream.</p>
