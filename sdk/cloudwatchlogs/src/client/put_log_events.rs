...
impl super::Client {
    ...
    ///   - [`log_events(InputLogEvent)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::log_events) / [`set_log_events(Option<Vec<InputLogEvent>>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::set_log_events): <p>The log events.</p>
