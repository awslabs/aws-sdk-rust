...
impl super::Client {
    ...
    ///   - [`entity(Entity)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::entity) / [`set_entity(Option<Entity>)`](crate::operation::put_log_events::builders::PutLogEventsFluentBuilder::set_entity):<br>required: **false**<br><p>Reserved for future use.</p><br>
    ...
    ///   - [`rejected_entity_info(Option<RejectedEntityInfo>)`](crate::operation::put_log_events::PutLogEventsOutput::rejected_entity_info): <p>Reserved for future use.</p>
