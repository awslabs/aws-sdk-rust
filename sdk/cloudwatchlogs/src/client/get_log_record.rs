...
impl super::Client {
    ...
    ///   - [`log_record_pointer(impl ::std::convert::Into<String>)`](crate::operation::get_log_record::builders::GetLogRecordFluentBuilder::log_record_pointer) / [`set_log_record_pointer(Option<String>)`](crate::operation::get_log_record::builders::GetLogRecordFluentBuilder::set_log_record_pointer): <p>The pointer corresponding to the log event record you want to retrieve. You get this from the response of a <code>GetQueryResults</code> operation. In that response, the value of the <code>@ptr</code> field for a log event is the value to use as <code>logRecordPointer</code> to retrieve that complete log event record.</p>
    ///   - [`unmask(bool)`](crate::operation::get_log_record::builders::GetLogRecordFluentBuilder::unmask) / [`set_unmask(Option<bool>)`](crate::operation::get_log_record::builders::GetLogRecordFluentBuilder::set_unmask): <p>Specify <code>true</code> to display the log event fields with all sensitive data unmasked and visible. The default is <code>false</code>.</p>  <p>To use this operation with this parameter, you must be signed into an account with the <code>logs:Unmask</code> permission.</p>
