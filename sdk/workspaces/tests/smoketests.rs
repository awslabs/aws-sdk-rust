...
//! ```
//!
use aws_sdk_workspaces::{config, Client};
/// Smoke tests for the `describe_workspaces` operation
#[::tokio::test]
async fn test_describe_workspaces_success() {
    ...
    let res = client.describe_workspaces().send().await;
