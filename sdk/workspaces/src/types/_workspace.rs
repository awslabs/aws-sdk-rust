...
impl  Workspace  {
    ...
    pub fn standby_workspaces_properties(&self) -> & [crate::types::StandbyWorkspacesProperties] {
        self.standby_workspaces_properties.as_deref()
        .unwrap_or_default()
    }
}
impl Workspace {
...
impl WorkspaceBuilder {
    ...
    pub fn set_data_replication_settings(mut self, input: ::std::option::Option<crate::types::DataReplicationSettings>) -> Self {
        self.data_replication_settings = input; self
    }
    /// <p>Indicates the settings of the data replication.</p>
    ...
    /// <p>The properties of the standby WorkSpace</p>
    pub fn set_standby_workspaces_properties(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::StandbyWorkspacesProperties>>) -> Self {
        self.standby_workspaces_properties = input; self
    }
    /// <p>The properties of the standby WorkSpace</p>
