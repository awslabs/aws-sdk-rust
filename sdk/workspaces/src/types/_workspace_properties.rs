...
pub struct WorkspaceProperties {
    ...
    /// <li>
    /// <p>Unavailable for Windows 7 WorkSpaces and WorkSpaces using GPU-based bundles (Graphics, GraphicsPro, Graphics.g4dn, GraphicsPro.g4dn, Graphics.g6, and Graphics.g7).</p></li>
    /// </ul>
    /// </note>
