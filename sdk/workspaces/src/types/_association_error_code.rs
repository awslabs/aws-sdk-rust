...
impl AssociationErrorCode {
    ...
    AssociationErrorCode::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["DeploymentError.InternalServerError", "DeploymentError.WorkspaceUnreachable", "ValidationError.InsufficientDiskSpace", "ValidationError.InsufficientMemory", "ValidationError.UnsupportedOperatingSystem"]
                }
            }
