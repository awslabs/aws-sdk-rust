...
impl Builder {
    ...
    /// use aws_sdk_workspaces::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_workspaces::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
