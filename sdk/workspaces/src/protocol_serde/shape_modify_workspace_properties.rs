...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidParameterValuesException" => {
            crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::InvalidParameterValuesException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidResourceStateException" => {
            crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::InvalidResourceStateException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationInProgressException" => {
            crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::OperationInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceUnavailableException" => {
            crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::ResourceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedWorkspaceConfigurationException" => {
            crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError::UnsupportedWorkspaceConfigurationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
