...
pub(crate) fn de_modification_state<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ModificationState>, aws_smithy_json::deserialize::error::DeserializeError>
