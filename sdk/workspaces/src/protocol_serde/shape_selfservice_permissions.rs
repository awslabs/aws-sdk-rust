...
pub fn ser_selfservice_permissions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SelfservicePermissions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_selfservice_permissions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SelfservicePermissions>, aws_smithy_json::deserialize::error::DeserializeError>
