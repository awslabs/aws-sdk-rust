...
pub fn ser_stop_workspaces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StopWorkspacesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
