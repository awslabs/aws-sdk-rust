...
pub(crate) fn de_workspace_image<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkspaceImage>, aws_smithy_json::deserialize::error::DeserializeError>
