                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ModificationStates" => {
                            builder = builder.set_modification_states(
                                crate::protocol_serde::shape_modification_state_list::de_modification_state_list(tokens, _value)?,
                            );
                        }
                        "RelatedWorkspaces" => {
                            builder = builder
                                .set_related_workspaces(crate::protocol_serde::shape_related_workspaces::de_related_workspaces(tokens, _value)?);
                        }
                        "DataReplicationSettings" => {
                            builder = builder.set_data_replication_settings(
                                crate::protocol_serde::shape_data_replication_settings::de_data_replication_settings(tokens, _value)?,
                            );
                        }
