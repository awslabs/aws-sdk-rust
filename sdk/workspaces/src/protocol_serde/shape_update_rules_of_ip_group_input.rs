...
pub fn ser_update_rules_of_ip_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_rules_of_ip_group::UpdateRulesOfIpGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
