...
pub fn ser_import_client_branding_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ImportClientBrandingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
