...
pub fn ser_workspace_creation_properties(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkspaceCreationProperties) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
