...
pub fn ser_describe_workspaces_pools_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::describe_workspaces_pools::DescribeWorkspacesPoolsInput,
) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.pool_ids {
        let mut array_2 = object.key("PoolIds").start_array();
        for item_3 in var_1 {
            {
        ...
        for item_6 in var_4 {
            {
                ...
                crate::protocol_serde::shape_describe_workspaces_pools_filter::ser_describe_workspaces_pools_filter(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
