...
pub fn ser_modify_saml_properties_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::modify_saml_properties::ModifySamlPropertiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
