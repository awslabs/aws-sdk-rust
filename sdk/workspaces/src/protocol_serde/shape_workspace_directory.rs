...
pub(crate) fn de_workspace_directory<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkspaceDirectory>, aws_smithy_json::deserialize::error::DeserializeError>
