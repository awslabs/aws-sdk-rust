...
pub(crate) fn reflens_describe_application_associations_output_output_next_token(
    input: &crate::operation::describe_application_associations::DescribeApplicationAssociationsOutput,
...
pub(crate) fn reflens_describe_applications_output_output_next_token(
    input: &crate::operation::describe_applications::DescribeApplicationsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_describe_workspace_bundles_output_output_next_token(
...
pub(crate) fn reflens_describe_workspace_directories_output_output_next_token(
...
pub(crate) fn reflens_describe_workspaces_output_output_next_token(
...
pub(crate) fn lens_describe_workspace_directories_output_output_directories(
    input: crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::WorkspaceDirectory>> {
    let input = input.directories?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_describe_workspaces_output_output_workspaces(
    input: crate::operation::describe_workspaces::DescribeWorkspacesOutput,
