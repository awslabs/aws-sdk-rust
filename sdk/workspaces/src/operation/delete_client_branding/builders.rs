...
impl DeleteClientBrandingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_client_branding::DeleteClientBrandingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_client_branding::DeleteClientBrandingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_client_branding::DeleteClientBrandingOutput, crate::operation::delete_client_branding::DeleteClientBrandingError, Self> {
