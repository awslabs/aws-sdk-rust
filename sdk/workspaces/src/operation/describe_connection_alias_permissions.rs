    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeConnectionAliasPermissions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeConnectionAliasPermissions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeConnectionAliasPermissionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeConnectionAliasPermissionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeConnectionAliasPermissions")
...
.with_interceptor(DescribeConnectionAliasPermissionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsError>::new());
...
#[derive(Debug)]
            struct DescribeConnectionAliasPermissionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeConnectionAliasPermissionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_connection_alias_permissions::de_describe_connection_alias_permissions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_connection_alias_permissions::de_describe_connection_alias_permissions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeConnectionAliasPermissionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeConnectionAliasPermissionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_connection_alias_permissions::ser_describe_connection_alias_permissions_input(&input)?);
...
#[derive(Debug)]
            struct DescribeConnectionAliasPermissionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeConnectionAliasPermissionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeConnectionAliasPermissionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeConnectionAliasPermissionsInput>()
                        .ok_or("failed to downcast to DescribeConnectionAliasPermissionsInput")?;
...
pub enum DescribeConnectionAliasPermissionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeConnectionAliasPermissionsError) for what information is available for the error.")]
...
impl DescribeConnectionAliasPermissionsError {
    /// Creates the `DescribeConnectionAliasPermissionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConnectionAliasPermissionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeConnectionAliasPermissionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsError {
...
mod _describe_connection_alias_permissions_output;
