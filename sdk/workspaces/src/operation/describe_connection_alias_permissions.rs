...
impl DescribeConnectionAliasPermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConnectionAliasPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_connection_alias_permissions::de_describe_connection_alias_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
