...
impl UpdateWorkspaceBundleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateWorkspaceBundle`](crate::operation::update_workspace_bundle::UpdateWorkspaceBundle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_workspace_bundle::UpdateWorkspaceBundle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_workspace_bundle::UpdateWorkspaceBundleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_workspace_bundle::UpdateWorkspaceBundle::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateWorkspaceBundle {
                type Output = std::result::Result<crate::operation::update_workspace_bundle::UpdateWorkspaceBundleOutput, crate::operation::update_workspace_bundle::UpdateWorkspaceBundleError>;
