...
impl crate::operation::migrate_workspace::builders::MigrateWorkspaceInputBuilder {
...
/// <p>For available migration scenarios, details about what happens during migration, and best practices, see <a href="https://docs.aws.amazon.com/workspaces/latest/adminguide/migrate-workspaces.html">Migrate a WorkSpace</a>.</p><note>
/// <p>If the source WorkSpace has nested virtualization enabled and the target bundle does not support nested virtualization, the migration fails.</p>
/// </note>
...
impl MigrateWorkspaceFluentBuilder {
    /// Creates a new `MigrateWorkspaceFluentBuilder`.
