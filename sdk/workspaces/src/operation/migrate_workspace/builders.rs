...
impl MigrateWorkspaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::migrate_workspace::MigrateWorkspaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::migrate_workspace::MigrateWorkspaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::migrate_workspace::MigrateWorkspaceOutput, crate::operation::migrate_workspace::MigrateWorkspaceError, Self> {
