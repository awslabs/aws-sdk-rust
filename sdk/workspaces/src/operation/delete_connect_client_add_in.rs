...
impl DeleteConnectClientAddInInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_connect_client_add_in::DeleteConnectClientAddIn::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConnectClientAddIn {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_connect_client_add_in::de_delete_connect_client_add_in_http_response_with_props(status, headers, body)
        }
    }
}
