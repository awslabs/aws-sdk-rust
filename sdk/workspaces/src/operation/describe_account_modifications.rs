...
impl DescribeAccountModificationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_account_modifications::DescribeAccountModifications,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_account_modifications::DescribeAccountModifications::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountModifications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_account_modifications::de_describe_account_modifications_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeAccountModificationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_account_modifications::DescribeAccountModificationsError
{
