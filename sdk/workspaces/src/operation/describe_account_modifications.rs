...
impl DescribeAccountModificationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccountModifications`](crate::operation::describe_account_modifications::DescribeAccountModifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_account_modifications::DescribeAccountModifications, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_account_modifications::DescribeAccountModificationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_account_modifications::DescribeAccountModifications::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAccountModifications {
                type Output = std::result::Result<crate::operation::describe_account_modifications::DescribeAccountModificationsOutput, crate::operation::describe_account_modifications::DescribeAccountModificationsError>;
