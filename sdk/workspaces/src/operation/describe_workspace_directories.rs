...
impl DescribeWorkspaceDirectoriesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_workspace_directories::DescribeWorkspaceDirectories::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaceDirectories {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_workspace_directories::de_describe_workspace_directories_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_workspace_directories::de_describe_workspace_directories_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesError
{
