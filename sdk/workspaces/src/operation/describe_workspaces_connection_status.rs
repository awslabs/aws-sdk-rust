...
/// Orchestration and serialization glue logic for `DescribeWorkspacesConnectionStatus`.
    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeWorkspacesConnectionStatus {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeWorkspacesConnectionStatus");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeWorkspacesConnectionStatusRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeWorkspacesConnectionStatusResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeWorkspacesConnectionStatus")
...
.with_interceptor(DescribeWorkspacesConnectionStatusEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusError>::new());
...
#[derive(Debug)]
            struct DescribeWorkspacesConnectionStatusResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeWorkspacesConnectionStatusResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_workspaces_connection_status::de_describe_workspaces_connection_status_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_workspaces_connection_status::de_describe_workspaces_connection_status_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeWorkspacesConnectionStatusRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeWorkspacesConnectionStatusRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_workspaces_connection_status::ser_describe_workspaces_connection_status_input(&input)?);
...
#[derive(Debug)]
            struct DescribeWorkspacesConnectionStatusEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeWorkspacesConnectionStatusEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeWorkspacesConnectionStatusEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeWorkspacesConnectionStatusInput>()
                        .ok_or("failed to downcast to DescribeWorkspacesConnectionStatusInput")?;
...
pub enum DescribeWorkspacesConnectionStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeWorkspacesConnectionStatusError) for what information is available for the error.")]
...
impl DescribeWorkspacesConnectionStatusError {
    /// Creates the `DescribeWorkspacesConnectionStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeWorkspacesConnectionStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeWorkspacesConnectionStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatusError {
...
mod _describe_workspaces_connection_status_output;
