...
impl DescribeWorkspacesConnectionStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatus,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_workspaces_connection_status::DescribeWorkspacesConnectionStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkspacesConnectionStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_workspaces_connection_status::de_describe_workspaces_connection_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
