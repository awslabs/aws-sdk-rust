...
impl UpdateWorkspaceBundleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_workspace_bundle::UpdateWorkspaceBundleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_workspace_bundle::UpdateWorkspaceBundleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_workspace_bundle::UpdateWorkspaceBundleOutput, crate::operation::update_workspace_bundle::UpdateWorkspaceBundleError, Self> {
