...
impl DeleteClientBrandingInput {
    /// Consumes the builder and constructs an Operation<[`DeleteClientBranding`](crate::operation::delete_client_branding::DeleteClientBranding)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_client_branding::DeleteClientBranding, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_client_branding::DeleteClientBrandingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_client_branding::DeleteClientBranding::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteClientBranding {
                type Output = std::result::Result<crate::operation::delete_client_branding::DeleteClientBrandingOutput, crate::operation::delete_client_branding::DeleteClientBrandingError>;
