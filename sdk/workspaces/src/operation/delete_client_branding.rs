...
impl DeleteClientBrandingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_client_branding::DeleteClientBranding,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClientBranding {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_client_branding::de_delete_client_branding_http_response_with_props(status, headers, body)
        }
    }
}
