...
impl UpdateConnectionAliasPermissionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermission::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectionAliasPermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connection_alias_permission::de_update_connection_alias_permission_http_response_with_props(
                status, headers, body,
            )
        }
    }
