...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectionAliasPermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connection_alias_permission::de_update_connection_alias_permission_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermissionError
{
