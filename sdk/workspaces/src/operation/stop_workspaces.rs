...
impl StopWorkspacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_workspaces::StopWorkspaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_workspaces::ser_stop_workspaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_workspaces::de_stop_workspaces_http_response_with_props(status, headers, body)
        }
    }
}
