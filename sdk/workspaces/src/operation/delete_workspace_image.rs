...
/// Orchestration and serialization glue logic for `DeleteWorkspaceImage`.
...
impl DeleteWorkspaceImage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_workspace_image::DeleteWorkspaceImageInput,
                    ) -> ::std::result::Result<crate::operation::delete_workspace_image::DeleteWorkspaceImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_workspace_image::DeleteWorkspaceImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_workspace_image::DeleteWorkspaceImageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_workspace_image::DeleteWorkspaceImageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteWorkspaceImage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteWorkspaceImage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteWorkspaceImageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteWorkspaceImageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteWorkspaceImage")
...
.with_interceptor(DeleteWorkspaceImageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_workspace_image::DeleteWorkspaceImageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_workspace_image::DeleteWorkspaceImageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_workspace_image::DeleteWorkspaceImageError>::new());
...
#[derive(Debug)]
            struct DeleteWorkspaceImageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteWorkspaceImageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_workspace_image::de_delete_workspace_image_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_workspace_image::de_delete_workspace_image_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteWorkspaceImageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteWorkspaceImageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_workspace_image::DeleteWorkspaceImageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_workspace_image::DeleteWorkspaceImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_workspace_image::ser_delete_workspace_image_input(&input)?);
...
#[derive(Debug)]
            struct DeleteWorkspaceImageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteWorkspaceImageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteWorkspaceImageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteWorkspaceImageInput>()
                        .ok_or("failed to downcast to DeleteWorkspaceImageInput")?;
...
pub enum DeleteWorkspaceImageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteWorkspaceImageError) for what information is available for the error.")]
...
impl DeleteWorkspaceImageError {
    /// Creates the `DeleteWorkspaceImageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteWorkspaceImageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ResourceAssociatedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteWorkspaceImageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_workspace_image::DeleteWorkspaceImageError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_workspace_image::_delete_workspace_image_output::DeleteWorkspaceImageOutput;

pub use crate::operation::delete_workspace_image::_delete_workspace_image_input::DeleteWorkspaceImageInput;

mod _delete_workspace_image_input;

mod _delete_workspace_image_output;
