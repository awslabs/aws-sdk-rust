...
impl ModifyClientPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyClientProperties`](crate::operation::modify_client_properties::ModifyClientProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_client_properties::ModifyClientProperties, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_client_properties::ModifyClientPropertiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_client_properties::ModifyClientProperties::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyClientProperties {
                type Output = std::result::Result<crate::operation::modify_client_properties::ModifyClientPropertiesOutput, crate::operation::modify_client_properties::ModifyClientPropertiesError>;
