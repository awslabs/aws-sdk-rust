...
impl ModifyCertificateBasedAuthPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyCertificateBasedAuthProperties`](crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthProperties, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthProperties::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyCertificateBasedAuthProperties {
    type Output = ::std::result::Result<crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthPropertiesOutput, crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthPropertiesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_certificate_based_auth_properties::de_modify_certificate_based_auth_properties_http_response_with_props(status, headers, body)
        }
    }
}
