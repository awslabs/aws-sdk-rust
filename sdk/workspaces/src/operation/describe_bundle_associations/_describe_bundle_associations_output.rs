...
impl DescribeBundleAssociationsOutput {
    /// <p>List of information about the specified associations.</p>
    pub fn associations(&self) -> ::std::option::Option<&[crate::types::BundleResourceAssociation]> {
        self.associations.as_deref()
    }
}
impl ::aws_http::request_id::RequestId for DescribeBundleAssociationsOutput {
