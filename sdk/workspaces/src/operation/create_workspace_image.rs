...
impl CreateWorkspaceImageInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_workspace_image::CreateWorkspaceImage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateWorkspaceImage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_workspace_image::de_create_workspace_image_http_error(response)
        } else {
            crate::protocol_serde::shape_create_workspace_image::de_create_workspace_image_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::create_workspace_image::CreateWorkspaceImageError
{
