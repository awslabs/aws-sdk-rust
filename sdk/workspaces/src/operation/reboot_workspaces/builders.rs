...
/// <p>You cannot reboot a WorkSpace unless its state is <code>AVAILABLE</code>, <code>UNHEALTHY</code>, or <code>REBOOTING</code>. Reboot a WorkSpace in the <code>REBOOTING</code> state only if your WorkSpace has been stuck in the <code>REBOOTING</code> state for over 20 minutes.</p>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::reboot_workspaces::RebootWorkspacesOutput,
                    crate::operation::reboot_workspaces::RebootWorkspacesError,
                > for RebootWorkspacesFluentBuilder
            {
                fn send(
                    self,
...
impl RebootWorkspacesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reboot_workspaces::RebootWorkspacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reboot_workspaces::RebootWorkspacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reboot_workspaces::RebootWorkspacesOutput, crate::operation::reboot_workspaces::RebootWorkspacesError, Self> {
