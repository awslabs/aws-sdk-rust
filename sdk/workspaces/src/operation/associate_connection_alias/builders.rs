...
impl AssociateConnectionAliasFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_connection_alias::AssociateConnectionAliasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_connection_alias::AssociateConnectionAliasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_connection_alias::AssociateConnectionAliasOutput, crate::operation::associate_connection_alias::AssociateConnectionAliasError, Self> {
