...
impl ModifyWorkspaceState {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_workspace_state::ModifyWorkspaceStateInput,
                    ) -> ::std::result::Result<crate::operation::modify_workspace_state::ModifyWorkspaceStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_workspace_state::ModifyWorkspaceStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_workspace_state::ModifyWorkspaceStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_workspace_state::ModifyWorkspaceStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyWorkspaceState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyWorkspaceState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyWorkspaceStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyWorkspaceStateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyWorkspaceState")
...
.with_interceptor(ModifyWorkspaceStateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_workspace_state::ModifyWorkspaceStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_workspace_state::ModifyWorkspaceStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_workspace_state::ModifyWorkspaceStateError>::new());
...
#[derive(Debug)]
            struct ModifyWorkspaceStateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyWorkspaceStateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_workspace_state::de_modify_workspace_state_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_workspace_state::de_modify_workspace_state_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyWorkspaceStateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyWorkspaceStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_workspace_state::ModifyWorkspaceStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_workspace_state::ModifyWorkspaceStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_workspace_state::ser_modify_workspace_state_input(&input)?);
...
#[derive(Debug)]
            struct ModifyWorkspaceStateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyWorkspaceStateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyWorkspaceStateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyWorkspaceStateInput>()
                        .ok_or("failed to downcast to ModifyWorkspaceStateInput")?;
...
pub enum ModifyWorkspaceStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyWorkspaceStateError) for what information is available for the error.")]
...
impl ModifyWorkspaceStateError {
    /// Creates the `ModifyWorkspaceStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyWorkspaceStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyWorkspaceStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_workspace_state::ModifyWorkspaceStateError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::modify_workspace_state::_modify_workspace_state_output::ModifyWorkspaceStateOutput;

pub use crate::operation::modify_workspace_state::_modify_workspace_state_input::ModifyWorkspaceStateInput;

mod _modify_workspace_state_input;

mod _modify_workspace_state_output;
