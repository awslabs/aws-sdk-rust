...
impl ModifyAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_account::ModifyAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_account::de_modify_account_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_modify_account::de_modify_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
