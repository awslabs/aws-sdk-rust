...
impl DisassociateIpGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateIpGroups`](crate::operation::disassociate_ip_groups::DisassociateIpGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_ip_groups::DisassociateIpGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_ip_groups::DisassociateIpGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_ip_groups::DisassociateIpGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateIpGroups {
                type Output = std::result::Result<crate::operation::disassociate_ip_groups::DisassociateIpGroupsOutput, crate::operation::disassociate_ip_groups::DisassociateIpGroupsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_disassociate_ip_groups::de_disassociate_ip_groups_http_error(response)
                     } else {
                        crate::protocol_serde::shape_disassociate_ip_groups::de_disassociate_ip_groups_http_response(response)
                     }
                }
            }
