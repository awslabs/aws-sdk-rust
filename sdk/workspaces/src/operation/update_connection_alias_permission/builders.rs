...
impl UpdateConnectionAliasPermissionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermissionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermissionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermissionOutput, crate::operation::update_connection_alias_permission::UpdateConnectionAliasPermissionError, Self> {
