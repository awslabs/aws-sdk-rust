...
impl ModifySelfservicePermissionsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_selfservice_permissions::ModifySelfservicePermissions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ModifySelfservicePermissions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_modify_selfservice_permissions::de_modify_selfservice_permissions_http_error(response)
        } else {
            crate::protocol_serde::shape_modify_selfservice_permissions::de_modify_selfservice_permissions_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsError
{
