...
impl ModifyWorkspacePropertiesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyWorkspaceProperties`](crate::operation::modify_workspace_properties::ModifyWorkspaceProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_workspace_properties::ModifyWorkspaceProperties, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_workspace_properties::ModifyWorkspaceProperties::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyWorkspaceProperties {
                type Output = std::result::Result<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesOutput, crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError>;
