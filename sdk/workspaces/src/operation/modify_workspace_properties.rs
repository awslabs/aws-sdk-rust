...
/// Orchestration and serialization glue logic for `ModifyWorkspaceProperties`.
...
impl ModifyWorkspaceProperties {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyWorkspaceProperties {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyWorkspaceProperties");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyWorkspacePropertiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyWorkspacePropertiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyWorkspaceProperties")
...
.with_interceptor(ModifyWorkspacePropertiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError>::new());
...
#[derive(Debug)]
            struct ModifyWorkspacePropertiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyWorkspacePropertiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_workspace_properties::de_modify_workspace_properties_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_workspace_properties::de_modify_workspace_properties_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyWorkspacePropertiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyWorkspacePropertiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_workspace_properties::ser_modify_workspace_properties_input(&input)?);
...
#[derive(Debug)]
            struct ModifyWorkspacePropertiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyWorkspacePropertiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyWorkspacePropertiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyWorkspacePropertiesInput>()
                        .ok_or("failed to downcast to ModifyWorkspacePropertiesInput")?;
...
pub enum ModifyWorkspacePropertiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyWorkspacePropertiesError) for what information is available for the error.")]
...
impl ModifyWorkspacePropertiesError {
    /// Creates the `ModifyWorkspacePropertiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyWorkspacePropertiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::UnsupportedWorkspaceConfigurationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyWorkspacePropertiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesError {
...
mod _modify_workspace_properties_output;
