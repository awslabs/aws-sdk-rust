...
impl ModifyWorkspacePropertiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_workspace_properties::ModifyWorkspaceProperties::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyWorkspaceProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_workspace_properties::de_modify_workspace_properties_http_response_with_props(status, headers, body)
        }
    }
}
