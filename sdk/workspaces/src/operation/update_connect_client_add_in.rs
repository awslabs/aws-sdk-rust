...
/// Orchestration and serialization glue logic for `UpdateConnectClientAddIn`.
...
impl UpdateConnectClientAddIn {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateConnectClientAddIn {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateConnectClientAddIn");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateConnectClientAddInRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateConnectClientAddInResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateConnectClientAddIn")
...
.with_interceptor(UpdateConnectClientAddInEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError>::new());
...
#[derive(Debug)]
            struct UpdateConnectClientAddInResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateConnectClientAddInResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateConnectClientAddInRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateConnectClientAddInRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_connect_client_add_in::UpdateConnectClientAddInInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_connect_client_add_in::ser_update_connect_client_add_in_input(&input)?);
...
#[derive(Debug)]
            struct UpdateConnectClientAddInEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateConnectClientAddInEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateConnectClientAddInEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateConnectClientAddInInput>()
                        .ok_or("failed to downcast to UpdateConnectClientAddInInput")?;
...
pub enum UpdateConnectClientAddInError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateConnectClientAddInError) for what information is available for the error.")]
...
impl UpdateConnectClientAddInError {
    /// Creates the `UpdateConnectClientAddInError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateConnectClientAddInError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateConnectClientAddInError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_connect_client_add_in::UpdateConnectClientAddInError {
...
mod _update_connect_client_add_in_output;
