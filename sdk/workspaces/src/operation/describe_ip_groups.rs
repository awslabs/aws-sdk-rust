...
impl DescribeIpGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_ip_groups::ser_describe_ip_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIpGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_ip_groups::de_describe_ip_groups_http_response_with_props(status, headers, body)
        }
    }
}
