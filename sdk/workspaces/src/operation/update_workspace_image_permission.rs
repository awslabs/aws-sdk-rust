...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkspaceImagePermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_workspace_image_permission::de_update_workspace_image_permission_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_workspace_image_permission::UpdateWorkspaceImagePermissionError
{
