...
impl StartWorkspacesInput {
    /// Consumes the builder and constructs an Operation<[`StartWorkspaces`](crate::operation::start_workspaces::StartWorkspaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_workspaces::StartWorkspaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_workspaces::StartWorkspacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_workspaces::StartWorkspaces::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartWorkspaces {
                type Output = std::result::Result<crate::operation::start_workspaces::StartWorkspacesOutput, crate::operation::start_workspaces::StartWorkspacesError>;
