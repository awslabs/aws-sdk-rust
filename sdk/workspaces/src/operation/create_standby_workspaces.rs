...
/// Orchestration and serialization glue logic for `CreateStandbyWorkspaces`.
...
impl CreateStandbyWorkspaces {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateStandbyWorkspaces {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateStandbyWorkspaces");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateStandbyWorkspacesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateStandbyWorkspacesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateStandbyWorkspaces")
...
.with_interceptor(CreateStandbyWorkspacesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError>::new());
...
#[derive(Debug)]
            struct CreateStandbyWorkspacesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateStandbyWorkspacesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_standby_workspaces::de_create_standby_workspaces_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateStandbyWorkspacesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateStandbyWorkspacesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_standby_workspaces::CreateStandbyWorkspacesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_standby_workspaces::CreateStandbyWorkspacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_standby_workspaces::ser_create_standby_workspaces_input(&input)?);
...
#[derive(Debug)]
            struct CreateStandbyWorkspacesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateStandbyWorkspacesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateStandbyWorkspacesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateStandbyWorkspacesInput>()
                        .ok_or("failed to downcast to CreateStandbyWorkspacesInput")?;
...
pub enum CreateStandbyWorkspacesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateStandbyWorkspacesError) for what information is available for the error.")]
...
impl CreateStandbyWorkspacesError {
    /// Creates the `CreateStandbyWorkspacesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateStandbyWorkspacesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateStandbyWorkspacesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_standby_workspaces::CreateStandbyWorkspacesError {
...
mod _create_standby_workspaces_output;
