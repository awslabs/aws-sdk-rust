...
impl AssociateIpGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_ip_groups::ser_associate_ip_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateIpGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_ip_groups::de_associate_ip_groups_http_response_with_props(status, headers, body)
        }
    }
}
