...
impl AssociateIpGroupsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateIpGroups`](crate::operation::associate_ip_groups::AssociateIpGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_ip_groups::AssociateIpGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_ip_groups::AssociateIpGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_ip_groups::AssociateIpGroups::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateIpGroups {
                type Output = std::result::Result<crate::operation::associate_ip_groups::AssociateIpGroupsOutput, crate::operation::associate_ip_groups::AssociateIpGroupsError>;
