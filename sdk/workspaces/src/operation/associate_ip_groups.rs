...
impl AssociateIpGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_ip_groups::AssociateIpGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateIpGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_ip_groups::de_associate_ip_groups_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_ip_groups::AssociateIpGroupsError
{
