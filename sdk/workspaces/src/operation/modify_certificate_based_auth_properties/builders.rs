...
impl ModifyCertificateBasedAuthPropertiesFluentBuilder {
    /// Creates a new `ModifyCertificateBasedAuthPropertiesFluentBuilder`.
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::modify_certificate_based_auth_properties::ModifyCertificateBasedAuthProperties::operation_runtime_plugins(
