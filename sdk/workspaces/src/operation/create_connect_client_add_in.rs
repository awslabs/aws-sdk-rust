...
impl CreateConnectClientAddInInput {
    /// Consumes the builder and constructs an Operation<[`CreateConnectClientAddIn`](crate::operation::create_connect_client_add_in::CreateConnectClientAddIn)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_connect_client_add_in::CreateConnectClientAddIn, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_connect_client_add_in::CreateConnectClientAddInInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_connect_client_add_in::CreateConnectClientAddIn::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateConnectClientAddIn {
                type Output = std::result::Result<crate::operation::create_connect_client_add_in::CreateConnectClientAddInOutput, crate::operation::create_connect_client_add_in::CreateConnectClientAddInError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_connect_client_add_in::de_create_connect_client_add_in_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_connect_client_add_in::de_create_connect_client_add_in_http_response(response)
                     }
                }
            }
