...
impl CreateConnectClientAddIn {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_connect_client_add_in::CreateConnectClientAddInInput,
                    ) -> ::std::result::Result<crate::operation::create_connect_client_add_in::CreateConnectClientAddInOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_connect_client_add_in::CreateConnectClientAddInError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateConnectClientAddIn {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateConnectClientAddIn");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateConnectClientAddInRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateConnectClientAddInResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateConnectClientAddIn")
...
.with_interceptor(CreateConnectClientAddInEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInError>::new());
...
#[derive(Debug)]
            struct CreateConnectClientAddInResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateConnectClientAddInResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_connect_client_add_in::de_create_connect_client_add_in_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateConnectClientAddInRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateConnectClientAddInRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_connect_client_add_in::CreateConnectClientAddInInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_connect_client_add_in::CreateConnectClientAddInInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_connect_client_add_in::ser_create_connect_client_add_in_input(&input)?);
...
#[derive(Debug)]
            struct CreateConnectClientAddInEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateConnectClientAddInEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateConnectClientAddInEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateConnectClientAddInInput>()
                        .ok_or("failed to downcast to CreateConnectClientAddInInput")?;
...
pub enum CreateConnectClientAddInError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateConnectClientAddInError) for what information is available for the error.")]
...
impl CreateConnectClientAddInError {
    /// Creates the `CreateConnectClientAddInError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateConnectClientAddInError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ResourceCreationFailedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateConnectClientAddInError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_connect_client_add_in::CreateConnectClientAddInError {
...
mod _create_connect_client_add_in_output;
