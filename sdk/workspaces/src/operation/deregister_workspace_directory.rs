...
impl DeregisterWorkspaceDirectoryInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectory::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterWorkspaceDirectory {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_deregister_workspace_directory::de_deregister_workspace_directory_http_error(response)
        } else {
            crate::protocol_serde::shape_deregister_workspace_directory::de_deregister_workspace_directory_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError
{
