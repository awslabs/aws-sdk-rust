...
impl DeregisterWorkspaceDirectory {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeregisterWorkspaceDirectory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeregisterWorkspaceDirectory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeregisterWorkspaceDirectoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeregisterWorkspaceDirectoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeregisterWorkspaceDirectory")
...
.with_interceptor(DeregisterWorkspaceDirectoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError>::new());
...
#[derive(Debug)]
            struct DeregisterWorkspaceDirectoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeregisterWorkspaceDirectoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_deregister_workspace_directory::de_deregister_workspace_directory_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeregisterWorkspaceDirectoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeregisterWorkspaceDirectoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_deregister_workspace_directory::ser_deregister_workspace_directory_input(&input)?);
...
#[derive(Debug)]
            struct DeregisterWorkspaceDirectoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeregisterWorkspaceDirectoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeregisterWorkspaceDirectoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeregisterWorkspaceDirectoryInput>()
                        .ok_or("failed to downcast to DeregisterWorkspaceDirectoryInput")?;
...
pub enum DeregisterWorkspaceDirectoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeregisterWorkspaceDirectoryError) for what information is available for the error.")]
...
impl DeregisterWorkspaceDirectoryError {
    /// Creates the `DeregisterWorkspaceDirectoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeregisterWorkspaceDirectoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeregisterWorkspaceDirectoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError {
