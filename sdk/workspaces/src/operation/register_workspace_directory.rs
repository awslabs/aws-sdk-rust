...
/// Orchestration and serialization glue logic for `RegisterWorkspaceDirectory`.
...
impl RegisterWorkspaceDirectory {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterWorkspaceDirectory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterWorkspaceDirectory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterWorkspaceDirectoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterWorkspaceDirectoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterWorkspaceDirectory")
...
.with_interceptor(RegisterWorkspaceDirectoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>::new());
...
#[derive(Debug)]
            struct RegisterWorkspaceDirectoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterWorkspaceDirectoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_workspace_directory::de_register_workspace_directory_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_register_workspace_directory::de_register_workspace_directory_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RegisterWorkspaceDirectoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterWorkspaceDirectoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_workspace_directory::ser_register_workspace_directory_input(&input)?);
...
#[derive(Debug)]
            struct RegisterWorkspaceDirectoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterWorkspaceDirectoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterWorkspaceDirectoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterWorkspaceDirectoryInput>()
                        .ok_or("failed to downcast to RegisterWorkspaceDirectoryInput")?;
...
pub enum RegisterWorkspaceDirectoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterWorkspaceDirectoryError) for what information is available for the error.")]
...
impl RegisterWorkspaceDirectoryError {
    /// Creates the `RegisterWorkspaceDirectoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterWorkspaceDirectoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::WorkspacesDefaultRoleNotFoundException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterWorkspaceDirectoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError {
...
mod _register_workspace_directory_output;
