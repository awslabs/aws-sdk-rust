...
impl RegisterWorkspaceDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`RegisterWorkspaceDirectory`](crate::operation::register_workspace_directory::RegisterWorkspaceDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_workspace_directory::RegisterWorkspaceDirectory, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_workspace_directory::RegisterWorkspaceDirectory::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterWorkspaceDirectory {
                type Output = std::result::Result<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryOutput, crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>;
