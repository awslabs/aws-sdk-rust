...
impl RegisterWorkspaceDirectory {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RegisterWorkspaceDirectory",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterWorkspaceDirectory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegisterWorkspaceDirectoryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegisterWorkspaceDirectoryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterWorkspaceDirectory")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterWorkspaceDirectory")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterWorkspaceDirectoryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegisterWorkspaceDirectoryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterWorkspaceDirectoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterWorkspaceDirectoryInput>() else {
        ...
        if requested.should_capture("WorkspaceDirectoryName") {
            if let ::std::option::Option::Some(value) = input.workspace_directory_name.as_deref() {
                captured.insert("WorkspaceDirectoryName", value);
            }
        }
        if requested.should_capture("WorkspaceDirectoryDescription") {
            if let ::std::option::Option::Some(value) = input.workspace_directory_description.as_deref() {
                captured.insert("WorkspaceDirectoryDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterWorkspaceDirectoryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_workspace_directory::de_register_workspace_directory_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_register_workspace_directory::de_register_workspace_directory_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterWorkspaceDirectoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_register_workspace_directory::ser_register_workspace_directory_input(&input)?,
        );
...
impl ::std::error::Error for RegisterWorkspaceDirectoryError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::WorkspacesDefaultRoleNotFoundException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterWorkspaceDirectoryError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::WorkspacesDefaultRoleNotFoundException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
