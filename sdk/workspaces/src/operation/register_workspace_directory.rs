...
impl RegisterWorkspaceDirectoryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_workspace_directory::RegisterWorkspaceDirectory::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterWorkspaceDirectory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_workspace_directory::de_register_workspace_directory_http_response_with_props(status, headers, body)
        }
    }
}
