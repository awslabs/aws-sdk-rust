...
impl DescribeWorkspacesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_workspaces::ser_describe_workspaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_workspaces::de_describe_workspaces_http_response_with_props(status, headers, body)
        }
    }
}
