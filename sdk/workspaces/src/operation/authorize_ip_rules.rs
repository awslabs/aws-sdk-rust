...
impl AuthorizeIpRulesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::authorize_ip_rules::AuthorizeIpRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeIpRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_authorize_ip_rules::de_authorize_ip_rules_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::authorize_ip_rules::AuthorizeIpRulesError
{
