...
impl AuthorizeIpRulesInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeIpRules`](crate::operation::authorize_ip_rules::AuthorizeIpRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::authorize_ip_rules::AuthorizeIpRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_ip_rules::AuthorizeIpRulesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_ip_rules::AuthorizeIpRules::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AuthorizeIpRules {
                type Output = std::result::Result<crate::operation::authorize_ip_rules::AuthorizeIpRulesOutput, crate::operation::authorize_ip_rules::AuthorizeIpRulesError>;
