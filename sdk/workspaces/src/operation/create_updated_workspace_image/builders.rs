...
impl crate::operation::create_updated_workspace_image::builders::CreateUpdatedWorkspaceImageInputBuilder {
...
impl CreateUpdatedWorkspaceImageFluentBuilder {
    /// Creates a new `CreateUpdatedWorkspaceImageFluentBuilder`.
