...
/// Orchestration and serialization glue logic for `DescribeWorkspaceBundles`.
...
impl DescribeWorkspaceBundles {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeWorkspaceBundles {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeWorkspaceBundles");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeWorkspaceBundlesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeWorkspaceBundlesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeWorkspaceBundles")
...
.with_interceptor(DescribeWorkspaceBundlesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError>::new());
...
#[derive(Debug)]
            struct DescribeWorkspaceBundlesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeWorkspaceBundlesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_workspace_bundles::de_describe_workspace_bundles_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_workspace_bundles::de_describe_workspace_bundles_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeWorkspaceBundlesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeWorkspaceBundlesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_workspace_bundles::ser_describe_workspace_bundles_input(&input)?);
...
#[derive(Debug)]
            struct DescribeWorkspaceBundlesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeWorkspaceBundlesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeWorkspaceBundlesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeWorkspaceBundlesInput>()
                        .ok_or("failed to downcast to DescribeWorkspaceBundlesInput")?;
...
pub enum DescribeWorkspaceBundlesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeWorkspaceBundlesError) for what information is available for the error.")]
...
impl DescribeWorkspaceBundlesError {
    /// Creates the `DescribeWorkspaceBundlesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeWorkspaceBundlesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeWorkspaceBundlesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesError {
...
mod _describe_workspace_bundles_output;
