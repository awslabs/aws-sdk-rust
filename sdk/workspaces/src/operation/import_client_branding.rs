...
impl ImportClientBrandingInput {
    /// Consumes the builder and constructs an Operation<[`ImportClientBranding`](crate::operation::import_client_branding::ImportClientBranding)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_client_branding::ImportClientBranding, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_client_branding::ImportClientBrandingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::import_client_branding::ImportClientBranding::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ImportClientBranding {
                type Output = std::result::Result<crate::operation::import_client_branding::ImportClientBrandingOutput, crate::operation::import_client_branding::ImportClientBrandingError>;
