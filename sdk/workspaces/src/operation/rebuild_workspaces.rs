...
impl RebuildWorkspacesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::rebuild_workspaces::RebuildWorkspaces::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebuildWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_rebuild_workspaces::de_rebuild_workspaces_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::rebuild_workspaces::RebuildWorkspacesError
{
