...
impl RebuildWorkspacesInput {
    /// Consumes the builder and constructs an Operation<[`RebuildWorkspaces`](crate::operation::rebuild_workspaces::RebuildWorkspaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::rebuild_workspaces::RebuildWorkspaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rebuild_workspaces::RebuildWorkspacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::rebuild_workspaces::RebuildWorkspaces::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RebuildWorkspaces {
                type Output = std::result::Result<crate::operation::rebuild_workspaces::RebuildWorkspacesOutput, crate::operation::rebuild_workspaces::RebuildWorkspacesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_rebuild_workspaces::de_rebuild_workspaces_http_error(response)
                     } else {
                        crate::protocol_serde::shape_rebuild_workspaces::de_rebuild_workspaces_http_response(response)
                     }
                }
            }
