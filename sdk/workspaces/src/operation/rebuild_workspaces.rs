...
impl RebuildWorkspacesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_rebuild_workspaces::ser_rebuild_workspaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebuildWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_rebuild_workspaces::de_rebuild_workspaces_http_response_with_props(status, headers, body)
        }
    }
}
