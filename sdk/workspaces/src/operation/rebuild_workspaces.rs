...
/// Orchestration and serialization glue logic for `RebuildWorkspaces`.
...
impl RebuildWorkspaces {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::rebuild_workspaces::RebuildWorkspacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::rebuild_workspaces::RebuildWorkspacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::rebuild_workspaces::RebuildWorkspacesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::rebuild_workspaces::RebuildWorkspacesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RebuildWorkspaces {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RebuildWorkspaces");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RebuildWorkspacesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RebuildWorkspacesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RebuildWorkspaces")
...
.with_interceptor(RebuildWorkspacesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::rebuild_workspaces::RebuildWorkspacesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::rebuild_workspaces::RebuildWorkspacesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::rebuild_workspaces::RebuildWorkspacesError>::new());
...
#[derive(Debug)]
            struct RebuildWorkspacesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RebuildWorkspacesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_rebuild_workspaces::de_rebuild_workspaces_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RebuildWorkspacesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RebuildWorkspacesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::rebuild_workspaces::RebuildWorkspacesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::rebuild_workspaces::RebuildWorkspacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_rebuild_workspaces::ser_rebuild_workspaces_input(&input)?);
...
#[derive(Debug)]
            struct RebuildWorkspacesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RebuildWorkspacesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RebuildWorkspacesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RebuildWorkspacesInput>()
                        .ok_or("failed to downcast to RebuildWorkspacesInput")?;
...
pub enum RebuildWorkspacesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RebuildWorkspacesError) for what information is available for the error.")]
...
impl RebuildWorkspacesError {
    /// Creates the `RebuildWorkspacesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RebuildWorkspacesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RebuildWorkspacesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::rebuild_workspaces::RebuildWorkspacesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::rebuild_workspaces::_rebuild_workspaces_output::RebuildWorkspacesOutput;

pub use crate::operation::rebuild_workspaces::_rebuild_workspaces_input::RebuildWorkspacesInput;

mod _rebuild_workspaces_input;

mod _rebuild_workspaces_output;
