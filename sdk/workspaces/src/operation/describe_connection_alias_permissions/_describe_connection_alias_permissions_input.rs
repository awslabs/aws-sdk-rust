...
impl DescribeConnectionAliasPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_connection_alias_permissions::DescribeConnectionAliasPermissionsInput, ::aws_smithy_types::error::operation::BuildError> {
