...
impl AssociateConnectionAlias {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_connection_alias::AssociateConnectionAliasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_connection_alias::AssociateConnectionAliasOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AssociateConnectionAlias",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateConnectionAlias {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateConnectionAliasRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateConnectionAliasResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociateConnectionAlias")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateConnectionAlias")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AssociateConnectionAliasTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AssociateConnectionAliasTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateConnectionAliasTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssociateConnectionAliasInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateConnectionAliasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_connection_alias::de_associate_connection_alias_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_associate_connection_alias::de_associate_connection_alias_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateConnectionAliasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_connection_alias::AssociateConnectionAliasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_connection_alias::AssociateConnectionAliasInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_connection_alias::ser_associate_connection_alias_input(&input)?,
        );
