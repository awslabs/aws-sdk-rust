...
impl DescribeConnectClientAddInsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_connect_client_add_ins::DescribeConnectClientAddInsInput, ::aws_smithy_types::error::operation::BuildError> {
