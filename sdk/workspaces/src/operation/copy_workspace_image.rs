...
impl CopyWorkspaceImage {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_workspace_image::CopyWorkspaceImageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_workspace_image::CopyWorkspaceImageOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("WorkSpaces", "CopyWorkspaceImage", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "WorkSpaces.CopyWorkspaceImage",
                "rpc.service" = "WorkSpaces",
                "rpc.method" = "CopyWorkspaceImage",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopyWorkspaceImage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopyWorkspaceImageRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopyWorkspaceImageResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CopyWorkspaceImage")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyWorkspaceImage")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyWorkspaceImageTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CopyWorkspaceImageTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyWorkspaceImageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CopyWorkspaceImageInput>() else {
        ...
        if requested.should_capture("SourceImageId") {
            if let ::std::option::Option::Some(value) = input.source_image_id.as_deref() {
                captured.insert("SourceImageId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyWorkspaceImageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_workspace_image::de_copy_workspace_image_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_workspace_image::de_copy_workspace_image_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyWorkspaceImageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_workspace_image::CopyWorkspaceImageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_workspace_image::CopyWorkspaceImageInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_copy_workspace_image::ser_copy_workspace_image_input(&input)?);
