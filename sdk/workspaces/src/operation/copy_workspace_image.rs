...
impl CopyWorkspaceImageInput {
    /// Consumes the builder and constructs an Operation<[`CopyWorkspaceImage`](crate::operation::copy_workspace_image::CopyWorkspaceImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::copy_workspace_image::CopyWorkspaceImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_workspace_image::CopyWorkspaceImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::copy_workspace_image::CopyWorkspaceImage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CopyWorkspaceImage {
                type Output = std::result::Result<crate::operation::copy_workspace_image::CopyWorkspaceImageOutput, crate::operation::copy_workspace_image::CopyWorkspaceImageError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_copy_workspace_image::de_copy_workspace_image_http_error(response)
                     } else {
                        crate::protocol_serde::shape_copy_workspace_image::de_copy_workspace_image_http_response(response)
                     }
                }
            }
