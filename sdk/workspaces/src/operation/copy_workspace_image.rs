...
impl CopyWorkspaceImageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::copy_workspace_image::CopyWorkspaceImage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyWorkspaceImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_copy_workspace_image::de_copy_workspace_image_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::copy_workspace_image::CopyWorkspaceImageError
{
