...
impl MigrateWorkspaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::migrate_workspace::MigrateWorkspace::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for MigrateWorkspace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_migrate_workspace::de_migrate_workspace_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::migrate_workspace::MigrateWorkspaceError
{
