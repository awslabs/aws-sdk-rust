...
impl MigrateWorkspaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::migrate_workspace::MigrateWorkspace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_migrate_workspace::ser_migrate_workspace_input(&self)?);
