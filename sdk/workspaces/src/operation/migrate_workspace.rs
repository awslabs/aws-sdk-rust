...
impl MigrateWorkspaceInput {
    /// Consumes the builder and constructs an Operation<[`MigrateWorkspace`](crate::operation::migrate_workspace::MigrateWorkspace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::migrate_workspace::MigrateWorkspace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::migrate_workspace::MigrateWorkspaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::migrate_workspace::MigrateWorkspace::new())
...
impl aws_smithy_http::response::ParseStrictResponse for MigrateWorkspace {
                type Output = std::result::Result<crate::operation::migrate_workspace::MigrateWorkspaceOutput, crate::operation::migrate_workspace::MigrateWorkspaceError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_migrate_workspace::de_migrate_workspace_http_error(response)
                     } else {
                        crate::protocol_serde::shape_migrate_workspace::de_migrate_workspace_http_response(response)
                     }
                }
            }
