...
/// Orchestration and serialization glue logic for `MigrateWorkspace`.
...
impl MigrateWorkspace {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::migrate_workspace::MigrateWorkspaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::migrate_workspace::MigrateWorkspaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::migrate_workspace::MigrateWorkspaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::migrate_workspace::MigrateWorkspaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MigrateWorkspace {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("MigrateWorkspace");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(MigrateWorkspaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(MigrateWorkspaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MigrateWorkspace")
...
.with_interceptor(MigrateWorkspaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::migrate_workspace::MigrateWorkspaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::migrate_workspace::MigrateWorkspaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::migrate_workspace::MigrateWorkspaceError>::new());
...
#[derive(Debug)]
            struct MigrateWorkspaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MigrateWorkspaceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_migrate_workspace::de_migrate_workspace_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct MigrateWorkspaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MigrateWorkspaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::migrate_workspace::MigrateWorkspaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::migrate_workspace::MigrateWorkspaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_migrate_workspace::ser_migrate_workspace_input(&input)?);
...
#[derive(Debug)]
            struct MigrateWorkspaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MigrateWorkspaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "MigrateWorkspaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<MigrateWorkspaceInput>()
                        .ok_or("failed to downcast to MigrateWorkspaceInput")?;
...
pub enum MigrateWorkspaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-MigrateWorkspaceError) for what information is available for the error.")]
...
impl MigrateWorkspaceError {
    /// Creates the `MigrateWorkspaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `MigrateWorkspaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for MigrateWorkspaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::migrate_workspace::MigrateWorkspaceError {
