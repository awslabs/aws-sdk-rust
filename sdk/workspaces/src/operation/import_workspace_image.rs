...
impl ImportWorkspaceImageInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_workspace_image::ImportWorkspaceImage::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ImportWorkspaceImage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_import_workspace_image::de_import_workspace_image_http_error(response)
        } else {
            crate::protocol_serde::shape_import_workspace_image::de_import_workspace_image_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::import_workspace_image::ImportWorkspaceImageError
{
