...
impl RebootWorkspacesInput {
    /// Consumes the builder and constructs an Operation<[`RebootWorkspaces`](crate::operation::reboot_workspaces::RebootWorkspaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::reboot_workspaces::RebootWorkspaces, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_workspaces::RebootWorkspacesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_workspaces::RebootWorkspaces::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RebootWorkspaces {
                type Output = std::result::Result<crate::operation::reboot_workspaces::RebootWorkspacesOutput, crate::operation::reboot_workspaces::RebootWorkspacesError>;
