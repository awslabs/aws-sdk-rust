...
impl RebootWorkspacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reboot_workspaces::RebootWorkspaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reboot_workspaces::ser_reboot_workspaces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reboot_workspaces::de_reboot_workspaces_http_response_with_props(status, headers, body)
        }
    }
}
