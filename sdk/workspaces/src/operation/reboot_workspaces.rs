...
impl RebootWorkspacesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reboot_workspaces::RebootWorkspaces::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RebootWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_reboot_workspaces::de_reboot_workspaces_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::reboot_workspaces::RebootWorkspacesError
{
