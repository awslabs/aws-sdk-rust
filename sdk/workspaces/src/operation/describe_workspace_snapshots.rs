...
/// Orchestration and serialization glue logic for `DescribeWorkspaceSnapshots`.
...
impl DescribeWorkspaceSnapshots {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeWorkspaceSnapshots {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeWorkspaceSnapshots");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeWorkspaceSnapshotsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeWorkspaceSnapshotsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeWorkspaceSnapshots")
...
.with_interceptor(DescribeWorkspaceSnapshotsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError>::new());
...
#[derive(Debug)]
            struct DescribeWorkspaceSnapshotsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeWorkspaceSnapshotsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_workspace_snapshots::de_describe_workspace_snapshots_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_workspace_snapshots::de_describe_workspace_snapshots_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeWorkspaceSnapshotsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeWorkspaceSnapshotsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_workspace_snapshots::ser_describe_workspace_snapshots_input(&input)?);
...
#[derive(Debug)]
            struct DescribeWorkspaceSnapshotsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeWorkspaceSnapshotsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeWorkspaceSnapshotsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeWorkspaceSnapshotsInput>()
                        .ok_or("failed to downcast to DescribeWorkspaceSnapshotsInput")?;
...
pub enum DescribeWorkspaceSnapshotsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeWorkspaceSnapshotsError) for what information is available for the error.")]
...
impl DescribeWorkspaceSnapshotsError {
    /// Creates the `DescribeWorkspaceSnapshotsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeWorkspaceSnapshotsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeWorkspaceSnapshotsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError {
...
mod _describe_workspace_snapshots_output;
