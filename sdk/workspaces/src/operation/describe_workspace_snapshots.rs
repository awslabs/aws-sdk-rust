...
impl DescribeWorkspaceSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkspaceSnapshots`](crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshots::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaceSnapshots {
                type Output = std::result::Result<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsOutput, crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsError>;
