...
impl RestoreWorkspaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::restore_workspace::RestoreWorkspace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_restore_workspace::ser_restore_workspace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreWorkspace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_workspace::de_restore_workspace_http_response_with_props(status, headers, body)
        }
    }
}
