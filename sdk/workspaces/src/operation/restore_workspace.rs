...
impl RestoreWorkspaceInput {
    /// Consumes the builder and constructs an Operation<[`RestoreWorkspace`](crate::operation::restore_workspace::RestoreWorkspace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_workspace::RestoreWorkspace, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_workspace::RestoreWorkspaceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_workspace::RestoreWorkspace::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreWorkspace {
                type Output = std::result::Result<crate::operation::restore_workspace::RestoreWorkspaceOutput, crate::operation::restore_workspace::RestoreWorkspaceError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_restore_workspace::de_restore_workspace_http_error(response)
                     } else {
                        crate::protocol_serde::shape_restore_workspace::de_restore_workspace_http_response(response)
                     }
                }
            }
