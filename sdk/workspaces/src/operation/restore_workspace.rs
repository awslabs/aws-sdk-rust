...
impl RestoreWorkspaceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_workspace::RestoreWorkspace::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreWorkspace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_restore_workspace::de_restore_workspace_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::restore_workspace::RestoreWorkspaceError
{
