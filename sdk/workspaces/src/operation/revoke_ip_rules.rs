...
impl RevokeIpRulesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_ip_rules::RevokeIpRules::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for RevokeIpRules {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_revoke_ip_rules::de_revoke_ip_rules_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_revoke_ip_rules::de_revoke_ip_rules_http_response(
                status, headers, body,
            )
        }
    }
