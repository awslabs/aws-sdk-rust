...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_client_properties::DescribeClientPropertiesOutput,
                    crate::operation::describe_client_properties::DescribeClientPropertiesError,
                > for DescribeClientPropertiesFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeClientPropertiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_client_properties::DescribeClientPropertiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_client_properties::DescribeClientPropertiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_client_properties::DescribeClientPropertiesOutput, crate::operation::describe_client_properties::DescribeClientPropertiesError, Self> {
