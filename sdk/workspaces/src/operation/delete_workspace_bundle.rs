...
/// Orchestration and serialization glue logic for `DeleteWorkspaceBundle`.
...
impl DeleteWorkspaceBundle {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteWorkspaceBundle {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteWorkspaceBundle");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteWorkspaceBundleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteWorkspaceBundleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteWorkspaceBundle")
...
.with_interceptor(DeleteWorkspaceBundleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError>::new());
...
#[derive(Debug)]
            struct DeleteWorkspaceBundleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteWorkspaceBundleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_workspace_bundle::de_delete_workspace_bundle_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_workspace_bundle::de_delete_workspace_bundle_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteWorkspaceBundleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteWorkspaceBundleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_workspace_bundle::ser_delete_workspace_bundle_input(&input)?);
...
#[derive(Debug)]
            struct DeleteWorkspaceBundleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteWorkspaceBundleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteWorkspaceBundleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteWorkspaceBundleInput>()
                        .ok_or("failed to downcast to DeleteWorkspaceBundleInput")?;
...
pub enum DeleteWorkspaceBundleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteWorkspaceBundleError) for what information is available for the error.")]
...
impl DeleteWorkspaceBundleError {
    /// Creates the `DeleteWorkspaceBundleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteWorkspaceBundleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteWorkspaceBundleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_workspace_bundle::DeleteWorkspaceBundleError {
...
mod _delete_workspace_bundle_output;
