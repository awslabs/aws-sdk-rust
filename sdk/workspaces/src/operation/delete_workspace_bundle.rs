...
impl DeleteWorkspaceBundleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_workspace_bundle::DeleteWorkspaceBundle,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWorkspaceBundle {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_workspace_bundle::de_delete_workspace_bundle_http_response_with_props(status, headers, body)
        }
    }
}
