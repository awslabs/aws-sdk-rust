...
/// Orchestration and serialization glue logic for `CreateWorkspaceBundle`.
...
impl CreateWorkspaceBundle {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_workspace_bundle::CreateWorkspaceBundleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_workspace_bundle::CreateWorkspaceBundleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateWorkspaceBundle {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateWorkspaceBundle");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateWorkspaceBundleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateWorkspaceBundleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateWorkspaceBundle")
...
.with_interceptor(CreateWorkspaceBundleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleError>::new());
...
#[derive(Debug)]
            struct CreateWorkspaceBundleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateWorkspaceBundleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_workspace_bundle::de_create_workspace_bundle_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateWorkspaceBundleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateWorkspaceBundleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_workspace_bundle::CreateWorkspaceBundleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_workspace_bundle::CreateWorkspaceBundleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_workspace_bundle::ser_create_workspace_bundle_input(&input)?);
...
#[derive(Debug)]
            struct CreateWorkspaceBundleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateWorkspaceBundleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateWorkspaceBundleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateWorkspaceBundleInput>()
                        .ok_or("failed to downcast to CreateWorkspaceBundleInput")?;
...
pub enum CreateWorkspaceBundleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateWorkspaceBundleError) for what information is available for the error.")]
...
impl CreateWorkspaceBundleError {
    /// Creates the `CreateWorkspaceBundleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateWorkspaceBundleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateWorkspaceBundleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_workspace_bundle::CreateWorkspaceBundleError {
...
mod _create_workspace_bundle_output;
