...
impl CreateWorkspaceBundleInput {
    /// Consumes the builder and constructs an Operation<[`CreateWorkspaceBundle`](crate::operation::create_workspace_bundle::CreateWorkspaceBundle)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_workspace_bundle::CreateWorkspaceBundle, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_workspace_bundle::CreateWorkspaceBundleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_workspace_bundle::CreateWorkspaceBundle::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateWorkspaceBundle {
                type Output = std::result::Result<crate::operation::create_workspace_bundle::CreateWorkspaceBundleOutput, crate::operation::create_workspace_bundle::CreateWorkspaceBundleError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_workspace_bundle::de_create_workspace_bundle_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_workspace_bundle::de_create_workspace_bundle_http_response(response)
                     }
                }
            }
