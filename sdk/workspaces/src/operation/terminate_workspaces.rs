...
impl TerminateWorkspacesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_terminate_workspaces::ser_terminate_workspaces_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::terminate_workspaces::TerminateWorkspaces::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateWorkspaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_terminate_workspaces::de_terminate_workspaces_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::terminate_workspaces::TerminateWorkspacesError
{
