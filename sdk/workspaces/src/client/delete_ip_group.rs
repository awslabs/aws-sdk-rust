...
impl super::Client {
    ...
    ///   - [`group_id(impl Into<String>)`](crate::operation::delete_ip_group::builders::DeleteIpGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::delete_ip_group::builders::DeleteIpGroupFluentBuilder::set_group_id):<br>required: **true**<br><p>The identifier of the IP access control group.</p><br>
