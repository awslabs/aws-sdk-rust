...
impl super::Client {
    ...
    ///   - [`bundle_id(impl ::std::convert::Into<String>)`](crate::operation::update_workspace_bundle::builders::UpdateWorkspaceBundleFluentBuilder::bundle_id) / [`set_bundle_id(Option<String>)`](crate::operation::update_workspace_bundle::builders::UpdateWorkspaceBundleFluentBuilder::set_bundle_id): <p>The identifier of the bundle.</p>
