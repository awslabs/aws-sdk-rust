...
impl super::Client {
    ...
    ///   - [`workspaces(WorkspaceRequest)`](crate::operation::create_workspaces::builders::CreateWorkspacesFluentBuilder::workspaces) / [`set_workspaces(Option<Vec<WorkspaceRequest>>)`](crate::operation::create_workspaces::builders::CreateWorkspacesFluentBuilder::set_workspaces): <p>The WorkSpaces to create. You can specify up to 25 WorkSpaces.</p>
