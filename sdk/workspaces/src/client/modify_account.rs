...
impl super::Client {
    ...
    /// - On success, responds with [`ModifyAccountOutput`](crate::operation::modify_account::ModifyAccountOutput) with field(s):
    ///   - [`message(Option<String>)`](crate::operation::modify_account::ModifyAccountOutput::message): <p>The text message to describe the status of BYOL modification.</p>
