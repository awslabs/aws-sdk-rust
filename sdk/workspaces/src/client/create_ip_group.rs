...
impl super::Client {
    ...
    ///   - [`user_rules(IpRuleItem)`](crate::operation::create_ip_group::builders::CreateIpGroupFluentBuilder::user_rules) / [`set_user_rules(Option<Vec<IpRuleItem>>)`](crate::operation::create_ip_group::builders::CreateIpGroupFluentBuilder::set_user_rules): <p>The rules to add to the group.</p>
    ///   - [`tags(Tag)`](crate::operation::create_ip_group::builders::CreateIpGroupFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_ip_group::builders::CreateIpGroupFluentBuilder::set_tags): <p>The tags. Each WorkSpaces resource can have a maximum of 50 tags.</p>
