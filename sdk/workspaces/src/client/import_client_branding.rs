...
impl super::Client {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_resource_id): <p>The directory identifier of the WorkSpace for which you want to import client branding.</p>
    ///   - [`device_type_windows(DefaultImportClientBrandingAttributes)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::device_type_windows) / [`set_device_type_windows(Option<DefaultImportClientBrandingAttributes>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_device_type_windows): <p>The branding information to import for Windows devices.</p>
    ///   - [`device_type_osx(DefaultImportClientBrandingAttributes)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::device_type_osx) / [`set_device_type_osx(Option<DefaultImportClientBrandingAttributes>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_device_type_osx): <p>The branding information to import for macOS devices.</p>
    ///   - [`device_type_android(DefaultImportClientBrandingAttributes)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::device_type_android) / [`set_device_type_android(Option<DefaultImportClientBrandingAttributes>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_device_type_android): <p>The branding information to import for Android devices.</p>
    ...
    ///   - [`device_type_linux(DefaultImportClientBrandingAttributes)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::device_type_linux) / [`set_device_type_linux(Option<DefaultImportClientBrandingAttributes>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_device_type_linux): <p>The branding information to import for Linux devices.</p>
    ///   - [`device_type_web(DefaultImportClientBrandingAttributes)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::device_type_web) / [`set_device_type_web(Option<DefaultImportClientBrandingAttributes>)`](crate::operation::import_client_branding::builders::ImportClientBrandingFluentBuilder::set_device_type_web): <p>The branding information to import for web access.</p>
