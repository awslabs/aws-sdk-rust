...
impl super::Client {
    ...
    ///   - [`image_id(impl Into<String>)`](crate::operation::delete_workspace_image::builders::DeleteWorkspaceImageFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::delete_workspace_image::builders::DeleteWorkspaceImageFluentBuilder::set_image_id):<br>required: **true**<br><p>The identifier of the image.</p><br>
