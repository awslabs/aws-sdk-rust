...
impl super::Client {
    ...
    ///   - [`group_ids(impl Into<String>)`](crate::operation::describe_ip_groups::builders::DescribeIpGroupsFluentBuilder::group_ids) / [`set_group_ids(Option<Vec<String>>)`](crate::operation::describe_ip_groups::builders::DescribeIpGroupsFluentBuilder::set_group_ids): <p>The identifiers of one or more IP access control groups.</p>
