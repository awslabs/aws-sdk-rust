...
impl super::Client {
    ...
    ///   - [`owner(impl ::std::convert::Into<String>)`](crate::operation::describe_workspace_bundles::builders::DescribeWorkspaceBundlesFluentBuilder::owner) / [`set_owner(Option<String>)`](crate::operation::describe_workspace_bundles::builders::DescribeWorkspaceBundlesFluentBuilder::set_owner): <p>The owner of the bundles. You cannot combine this parameter with any other filter.</p>  <p>To describe the bundles provided by Amazon Web Services, specify <code>AMAZON</code>. To describe the bundles that belong to your account, don't specify a value.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_workspace_bundles::builders::DescribeWorkspaceBundlesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_workspace_bundles::builders::DescribeWorkspaceBundlesFluentBuilder::set_next_token): <p>The token for the next set of results. (You received this token from a previous call.)</p>
