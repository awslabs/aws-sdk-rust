...
impl super::Client {
    ...
    ///   - [`image_ids(impl Into<String>)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::image_ids) / [`set_image_ids(Option<Vec::<String>>)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::set_image_ids):<br>required: **false**<br><p>The identifier of the image.</p><br>
    ///   - [`image_type(ImageType)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::image_type) / [`set_image_type(Option<ImageType>)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::set_image_type):<br>required: **false**<br><p>The type (owned or shared) of the image.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_workspace_images::builders::DescribeWorkspaceImagesFluentBuilder::set_next_token):<br>required: **false**<br><p>If you received a <code>NextToken</code> from a previous call that was paginated, provide this token to receive the next set of results.</p><br>
