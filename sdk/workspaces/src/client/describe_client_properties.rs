...
impl super::Client {
    ...
    ///   - [`resource_ids(impl Into<String>)`](crate::operation::describe_client_properties::builders::DescribeClientPropertiesFluentBuilder::resource_ids) / [`set_resource_ids(Option<Vec<String>>)`](crate::operation::describe_client_properties::builders::DescribeClientPropertiesFluentBuilder::set_resource_ids): <p>The resource identifier, in the form of directory IDs.</p>
