...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::set_name):<br>required: **true**<br><p>The name of the new WorkSpace image.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::set_description):<br>required: **true**<br><p>The description of the new WorkSpace image.</p><br>
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The identifier of the source WorkSpace</p><br>
    ///   - [`tags(Tag)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::set_tags):<br>required: **false**<br><p>The tags that you want to add to the new WorkSpace image. To add tags when you're creating the image, you must create an IAM policy that grants your IAM user permission to use <code>workspaces:CreateTags</code>.</p><br>
