...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_workspace_image::builders::CreateWorkspaceImageFluentBuilder::set_tags): <p>The tags that you want to add to the new WorkSpace image. To add tags when you're creating the image, you must create an IAM policy that grants your IAM user permission to use <code>workspaces:CreateTags</code>.</p>
