...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::restore_workspace::builders::RestoreWorkspaceFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::restore_workspace::builders::RestoreWorkspaceFluentBuilder::set_workspace_id):<br>required: **true**<br><p>The identifier of the WorkSpace.</p><br>
