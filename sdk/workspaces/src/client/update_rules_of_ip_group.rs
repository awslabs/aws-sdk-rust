...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::update_rules_of_ip_group::builders::UpdateRulesOfIpGroupFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::update_rules_of_ip_group::builders::UpdateRulesOfIpGroupFluentBuilder::set_group_id): <p>The identifier of the group.</p>
