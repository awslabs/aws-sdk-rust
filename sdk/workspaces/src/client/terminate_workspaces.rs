...
impl super::Client {
    ...
    ///   - [`terminate_workspace_requests(TerminateRequest)`](crate::operation::terminate_workspaces::builders::TerminateWorkspacesFluentBuilder::terminate_workspace_requests) / [`set_terminate_workspace_requests(Option<Vec::<TerminateRequest>>)`](crate::operation::terminate_workspaces::builders::TerminateWorkspacesFluentBuilder::set_terminate_workspace_requests):<br>required: **true**<br><p>The WorkSpaces to terminate. You can specify up to 25 WorkSpaces.</p><br>
