...
impl super::Client {
    ...
    ///   - [`bundle_id(impl Into<String>)`](crate::operation::delete_workspace_bundle::builders::DeleteWorkspaceBundleFluentBuilder::bundle_id) / [`set_bundle_id(Option<String>)`](crate::operation::delete_workspace_bundle::builders::DeleteWorkspaceBundleFluentBuilder::set_bundle_id):<br>required: **false**<br><p>The identifier of the bundle.</p><br>
