...
impl super::Client {
    ...
    pub fn delete_workspace_bundle(
        &self,
    ) -> crate::operation::delete_workspace_bundle::builders::DeleteWorkspaceBundleFluentBuilder
    {
        crate::operation::delete_workspace_bundle::builders::DeleteWorkspaceBundleFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
