...
impl super::Client {
    ...
    ///   - [`workspace_access_properties(WorkspaceAccessProperties)`](crate::operation::modify_workspace_access_properties::builders::ModifyWorkspaceAccessPropertiesFluentBuilder::workspace_access_properties) / [`set_workspace_access_properties(Option<WorkspaceAccessProperties>)`](crate::operation::modify_workspace_access_properties::builders::ModifyWorkspaceAccessPropertiesFluentBuilder::set_workspace_access_properties):<br>required: **true**<br><p>The device types and operating systems to enable or disable for access.</p><br>
