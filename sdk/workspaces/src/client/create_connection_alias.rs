...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_connection_alias::builders::CreateConnectionAliasFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_connection_alias::builders::CreateConnectionAliasFluentBuilder::set_tags): <p>The tags to associate with the connection alias.</p>
