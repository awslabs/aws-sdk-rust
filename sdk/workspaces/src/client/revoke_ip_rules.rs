...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::revoke_ip_rules::builders::RevokeIpRulesFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::revoke_ip_rules::builders::RevokeIpRulesFluentBuilder::set_group_id): <p>The identifier of the group.</p>
