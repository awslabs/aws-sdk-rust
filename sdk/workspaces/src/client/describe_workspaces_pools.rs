...
impl super::Client {
    ...
    ///   - [`pool_ids(impl Into<String>)`](crate::operation::describe_workspaces_pools::builders::DescribeWorkspacesPoolsFluentBuilder::pool_ids) / [`set_pool_ids(Option<Vec::<String>>)`](crate::operation::describe_workspaces_pools::builders::DescribeWorkspacesPoolsFluentBuilder::set_pool_ids):<br>required: **false**<br><p>The identifier of the WorkSpaces pool.</p><br>
