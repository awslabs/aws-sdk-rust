...
impl super::Client {
    ...
    ///   - [`user_rules(IpRuleItem)`](crate::operation::authorize_ip_rules::builders::AuthorizeIpRulesFluentBuilder::user_rules) / [`set_user_rules(Option<Vec<IpRuleItem>>)`](crate::operation::authorize_ip_rules::builders::AuthorizeIpRulesFluentBuilder::set_user_rules): <p>The rules to add to the group.</p>
