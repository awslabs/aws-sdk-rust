...
impl super::Client {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::authorize_ip_rules::builders::AuthorizeIpRulesFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::authorize_ip_rules::builders::AuthorizeIpRulesFluentBuilder::set_group_id): <p>The identifier of the group.</p>
