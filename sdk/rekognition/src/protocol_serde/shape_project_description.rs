...
pub(crate) fn de_project_description<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ProjectDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Datasets" => {
                            builder = builder.set_datasets(crate::protocol_serde::shape_dataset_metadata_list::de_dataset_metadata_list(
                                tokens, _value,
                            )?);
                        }
                        "Feature" => {
