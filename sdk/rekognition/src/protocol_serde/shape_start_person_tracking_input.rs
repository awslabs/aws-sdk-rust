...
pub fn ser_start_person_tracking_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartPersonTrackingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
