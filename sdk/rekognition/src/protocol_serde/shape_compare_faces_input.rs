...
pub fn ser_compare_faces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CompareFacesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
