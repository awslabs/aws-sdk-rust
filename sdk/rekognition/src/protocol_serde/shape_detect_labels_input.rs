...
pub fn ser_detect_labels_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DetectLabelsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
