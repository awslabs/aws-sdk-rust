...
pub fn ser_create_stream_processor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStreamProcessorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
