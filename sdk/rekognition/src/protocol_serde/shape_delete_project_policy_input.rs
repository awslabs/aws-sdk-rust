...
pub fn ser_delete_project_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteProjectPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
