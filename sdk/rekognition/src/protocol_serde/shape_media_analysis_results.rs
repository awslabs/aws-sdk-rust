...
pub(crate) fn de_media_analysis_results<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MediaAnalysisResults>, ::aws_smithy_json::deserialize::error::DeserializeError>
