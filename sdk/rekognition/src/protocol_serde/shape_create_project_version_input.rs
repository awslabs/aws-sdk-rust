...
pub fn ser_create_project_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProjectVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
