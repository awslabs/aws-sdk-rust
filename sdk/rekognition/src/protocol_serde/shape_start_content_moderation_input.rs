...
pub fn ser_start_content_moderation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartContentModerationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
