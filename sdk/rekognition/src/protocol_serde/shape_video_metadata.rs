...
pub(crate) fn de_video_metadata<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::VideoMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ColorRange" => {
                            builder = builder.set_color_range(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::VideoColorRange::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
