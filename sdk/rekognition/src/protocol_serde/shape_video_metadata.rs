...
pub(crate) fn de_video_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VideoMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
