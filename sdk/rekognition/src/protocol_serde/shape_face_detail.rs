...
pub(crate) fn de_face_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FaceDetail>, aws_smithy_json::deserialize::error::DeserializeError>
