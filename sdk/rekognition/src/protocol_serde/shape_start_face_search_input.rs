...
pub fn ser_start_face_search_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartFaceSearchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
