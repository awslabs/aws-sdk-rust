...
pub fn ser_update_stream_processor_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStreamProcessorInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
