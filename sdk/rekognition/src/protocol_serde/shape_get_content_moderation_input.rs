...
pub fn ser_get_content_moderation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetContentModerationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
