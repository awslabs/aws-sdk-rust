...
pub fn ser_get_face_search_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetFaceSearchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
