...
pub fn ser_list_faces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFacesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
