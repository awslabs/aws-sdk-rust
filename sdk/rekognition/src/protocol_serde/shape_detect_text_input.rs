...
pub fn ser_detect_text_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DetectTextInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
