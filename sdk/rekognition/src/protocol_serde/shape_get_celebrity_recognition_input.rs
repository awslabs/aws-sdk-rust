...
pub fn ser_get_celebrity_recognition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_celebrity_recognition::GetCelebrityRecognitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
