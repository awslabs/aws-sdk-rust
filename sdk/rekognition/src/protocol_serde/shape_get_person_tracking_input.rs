...
pub fn ser_get_person_tracking_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPersonTrackingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
