...
pub fn ser_start_label_detection_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartLabelDetectionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
