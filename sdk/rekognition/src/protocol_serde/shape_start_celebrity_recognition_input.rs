...
pub fn ser_start_celebrity_recognition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartCelebrityRecognitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
