...
pub fn ser_copy_project_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CopyProjectVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
