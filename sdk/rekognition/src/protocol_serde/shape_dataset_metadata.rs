...
pub(crate) fn de_dataset_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DatasetMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
