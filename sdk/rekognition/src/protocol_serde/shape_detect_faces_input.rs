...
pub fn ser_detect_faces_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DetectFacesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
