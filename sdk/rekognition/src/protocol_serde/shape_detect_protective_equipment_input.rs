...
pub fn ser_detect_protective_equipment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DetectProtectiveEquipmentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
