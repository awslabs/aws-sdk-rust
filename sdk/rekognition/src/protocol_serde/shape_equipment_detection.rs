...
pub(crate) fn de_equipment_detection<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::EquipmentDetection>, aws_smithy_json::deserialize::error::DeserializeError>
