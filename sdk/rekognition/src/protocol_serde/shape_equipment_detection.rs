...
) -> ::std::result::Result<Option<crate::types::EquipmentDetection>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ProtectiveEquipmentType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CoversBodyPart" => {
                            builder = builder.set_covers_body_part(crate::protocol_serde::shape_covers_body_part::de_covers_body_part(tokens)?);
                        }
