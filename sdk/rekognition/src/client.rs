    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CreateCollectionInput`](crate::input::CreateCollectionInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::CreateCollectionInput::collection_id): <p>ID for the collection that you are creating.</p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::CreateCollectionInput::tags): <p> A set of tags (key-value pairs) that you want to attach to the collection. </p>
    ...
    ///   - [`dataset_type(Option<DatasetType>)`](crate::input::CreateDatasetInput::dataset_type): <p> The type of the dataset. Specify <code>train</code> to create a training dataset. Specify <code>test</code> to create a test dataset. </p>
    ///   - [`project_arn(Option<String>)`](crate::input::CreateDatasetInput::project_arn): <p> The ARN of the Amazon Rekognition Custom Labels project to which you want to asssign the dataset. </p>
    ...
    ///   - [`project_name(Option<String>)`](crate::input::CreateProjectInput::project_name): <p>The name of the project to create.</p>
    ...
    ///
    /// - Takes [`CreateProjectVersionInput`](crate::input::CreateProjectVersionInput) with field(s):
    ///   - [`project_arn(Option<String>)`](crate::input::CreateProjectVersionInput::project_arn): <p>The ARN of the Amazon Rekognition Custom Labels project that manages the model that you want to train.</p>
    ///   - [`version_name(Option<String>)`](crate::input::CreateProjectVersionInput::version_name): <p>A name for the version of the model. This value must be unique.</p>
    ///   - [`output_config(Option<OutputConfig>)`](crate::input::CreateProjectVersionInput::output_config): <p>The Amazon S3 bucket location to store the results of training. The S3 bucket can be in any AWS account as long as the caller has <code>s3:PutObject</code> permissions on the S3 bucket.</p>
    ///   - [`training_data(Option<TrainingData>)`](crate::input::CreateProjectVersionInput::training_data): <p>Specifies an external manifest that the services uses to train the model. If you specify <code>TrainingData</code> you must also specify <code>TestingData</code>. The project must not have any associated datasets. </p>
    ///   - [`testing_data(Option<TestingData>)`](crate::input::CreateProjectVersionInput::testing_data): <p>Specifies an external manifest that the service uses to test the model. If you specify <code>TestingData</code> you must also specify <code>TrainingData</code>. The project must not have any associated datasets.</p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::CreateProjectVersionInput::tags): <p> A set of tags (key-value pairs) that you want to attach to the model. </p>
    ///   - [`kms_key_id(Option<String>)`](crate::input::CreateProjectVersionInput::kms_key_id): <p>The identifier for your AWS Key Management Service key (AWS KMS key). You can supply the Amazon Resource Name (ARN) of your KMS key, the ID of your KMS key, an alias for your KMS key, or an alias ARN. The key is used to encrypt training and test images copied into the service for model training. Your source images are unaffected. The key is also used to encrypt training results and manifest files written to the output Amazon S3 bucket (<code>OutputConfig</code>).</p>  <p>If you choose to use your own KMS key, you need the following permissions on the KMS key.</p>  <ul>   <li> <p>kms:CreateGrant</p> </li>   <li> <p>kms:DescribeKey</p> </li>   <li> <p>kms:GenerateDataKey</p> </li>   <li> <p>kms:Decrypt</p> </li>  </ul>  <p>If you don't specify a value for <code>KmsKeyId</code>, images copied into the service are encrypted using a key that AWS owns and manages.</p>
    ...
    ///
    /// - Takes [`CreateStreamProcessorInput`](crate::input::CreateStreamProcessorInput) with field(s):
    ///   - [`input(Option<StreamProcessorInput>)`](crate::input::CreateStreamProcessorInput::input): <p>Kinesis video stream stream that provides the source streaming video. If you are using the AWS CLI, the parameter name is <code>StreamProcessorInput</code>.</p>
    ///   - [`output(Option<StreamProcessorOutput>)`](crate::input::CreateStreamProcessorInput::output): <p>Kinesis data stream stream to which Amazon Rekognition Video puts the analysis results. If you are using the AWS CLI, the parameter name is <code>StreamProcessorOutput</code>.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateStreamProcessorInput::name): <p>An identifier you assign to the stream processor. You can use <code>Name</code> to manage the stream processor. For example, you can get the current status of the stream processor by calling <code>DescribeStreamProcessor</code>. <code>Name</code> is idempotent. </p>
    ///   - [`settings(Option<StreamProcessorSettings>)`](crate::input::CreateStreamProcessorInput::settings): <p>Face recognition input parameters to be used by the stream processor. Includes the collection to use for face recognition and the face attributes to detect.</p>
    ///   - [`role_arn(Option<String>)`](crate::input::CreateStreamProcessorInput::role_arn): <p>ARN of the IAM role that allows access to the stream processor.</p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::CreateStreamProcessorInput::tags): <p> A set of tags (key-value pairs) that you want to attach to the stream processor. </p>
    ...
    ///
    /// - Takes [`DeleteCollectionInput`](crate::input::DeleteCollectionInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::DeleteCollectionInput::collection_id): <p>ID of the collection to delete.</p>
    ...
    ///   - [`dataset_arn(Option<String>)`](crate::input::DeleteDatasetInput::dataset_arn): <p> The ARN of the Amazon Rekognition Custom Labels dataset that you want to delete. </p>
    ...
    ///
    /// - Takes [`DeleteFacesInput`](crate::input::DeleteFacesInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::DeleteFacesInput::collection_id): <p>Collection from which to remove the specific faces.</p>
    ///   - [`face_ids(Option<Vec<String>>)`](crate::input::DeleteFacesInput::face_ids): <p>An array of face IDs to delete.</p>
    ...
    ///   - [`project_arn(Option<String>)`](crate::input::DeleteProjectInput::project_arn): <p>The Amazon Resource Name (ARN) of the project that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteProjectVersionInput`](crate::input::DeleteProjectVersionInput) with field(s):
    ///   - [`project_version_arn(Option<String>)`](crate::input::DeleteProjectVersionInput::project_version_arn): <p>The Amazon Resource Name (ARN) of the model version that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteStreamProcessorInput`](crate::input::DeleteStreamProcessorInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::DeleteStreamProcessorInput::name): <p>The name of the stream processor you want to delete.</p>
    ...
    ///
    /// - Takes [`DescribeCollectionInput`](crate::input::DescribeCollectionInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::DescribeCollectionInput::collection_id): <p>The ID of the collection to describe.</p>
    ...
    ///   - [`dataset_arn(Option<String>)`](crate::input::DescribeDatasetInput::dataset_arn): <p> The Amazon Resource Name (ARN) of the dataset that you want to describe. </p>
    ...
    ///
    /// - Takes [`DescribeProjectsInput`](crate::input::DescribeProjectsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::DescribeProjectsInput::next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeProjectsInput::max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. </p>
    ///   - [`project_names(Option<Vec<String>>)`](crate::input::DescribeProjectsInput::project_names): <p>A list of the projects that you want Amazon Rekognition Custom Labels to describe. If you don't specify a value, the response includes descriptions for all the projects in your AWS account.</p>
    ...
    ///
    /// - Takes [`DescribeProjectVersionsInput`](crate::input::DescribeProjectVersionsInput) with field(s):
    ///   - [`project_arn(Option<String>)`](crate::input::DescribeProjectVersionsInput::project_arn): <p>The Amazon Resource Name (ARN) of the project that contains the models you want to describe.</p>
    ///   - [`version_names(Option<Vec<String>>)`](crate::input::DescribeProjectVersionsInput::version_names): <p>A list of model version names that you want to describe. You can add up to 10 model version names to the list. If you don't specify a value, all model descriptions are returned. A version name is part of a model (ProjectVersion) ARN. For example, <code>my-model.2020-01-21T09.10.15</code> is the version name in the following ARN. <code>arn:aws:rekognition:us-east-1:123456789012:project/getting-started/version/<i>my-model.2020-01-21T09.10.15</i>/1234567890123</code>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeProjectVersionsInput::next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeProjectVersionsInput::max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. </p>
    ...
    ///
    /// - Takes [`DescribeStreamProcessorInput`](crate::input::DescribeStreamProcessorInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::DescribeStreamProcessorInput::name): <p>Name of the stream processor for which you want information.</p>
    ...
    ///
    /// - Takes [`DetectLabelsInput`](crate::input::DetectLabelsInput) with field(s):
    ///   - [`image(Option<Image>)`](crate::input::DetectLabelsInput::image): <p>The input image as base64-encoded bytes or an S3 object. If you use the AWS CLI to call Amazon Rekognition operations, passing image bytes is not supported. Images stored in an S3 Bucket do not need to be base64-encoded.</p>  <p>If you are using an AWS SDK to call Amazon Rekognition, you might not need to base64-encode image bytes passed using the <code>Bytes</code> field. For more information, see Images in the Amazon Rekognition developer guide.</p>
    ///   - [`max_labels(Option<i32>)`](crate::input::DetectLabelsInput::max_labels): <p>Maximum number of labels you want the service to return in the response. The service returns the specified number of highest confidence labels. </p>
    ///   - [`min_confidence(Option<f32>)`](crate::input::DetectLabelsInput::min_confidence): <p>Specifies the minimum confidence level for the labels to return. Amazon Rekognition doesn't return any labels with confidence lower than this specified value.</p>  <p>If <code>MinConfidence</code> is not specified, the operation returns labels with a confidence values greater than or equal to 55 percent.</p>
    ...
    ///
    /// - Takes [`DetectModerationLabelsInput`](crate::input::DetectModerationLabelsInput) with field(s):
    ///   - [`image(Option<Image>)`](crate::input::DetectModerationLabelsInput::image): <p>The input image as base64-encoded bytes or an S3 object. If you use the AWS CLI to call Amazon Rekognition operations, passing base64-encoded image bytes is not supported. </p>  <p>If you are using an AWS SDK to call Amazon Rekognition, you might not need to base64-encode image bytes passed using the <code>Bytes</code> field. For more information, see Images in the Amazon Rekognition developer guide.</p>
    ///   - [`min_confidence(Option<f32>)`](crate::input::DetectModerationLabelsInput::min_confidence): <p>Specifies the minimum confidence level for the labels to return. Amazon Rekognition doesn't return any labels with a confidence level lower than this specified value.</p>  <p>If you don't specify <code>MinConfidence</code>, the operation returns labels with confidence values greater than or equal to 50 percent.</p>
    ///   - [`human_loop_config(Option<HumanLoopConfig>)`](crate::input::DetectModerationLabelsInput::human_loop_config): <p>Sets up the configuration for human evaluation, including the FlowDefinition the image will be sent to.</p>
    ...
    ///
    /// - Takes [`DetectProtectiveEquipmentInput`](crate::input::DetectProtectiveEquipmentInput) with field(s):
    ///   - [`image(Option<Image>)`](crate::input::DetectProtectiveEquipmentInput::image): <p>The image in which you want to detect PPE on detected persons. The image can be passed as image bytes or you can reference an image stored in an Amazon S3 bucket. </p>
    ///   - [`summarization_attributes(Option<ProtectiveEquipmentSummarizationAttributes>)`](crate::input::DetectProtectiveEquipmentInput::summarization_attributes): <p>An array of PPE types that you want to summarize.</p>
    ...
    ///
    /// - Takes [`DetectTextInput`](crate::input::DetectTextInput) with field(s):
    ///   - [`image(Option<Image>)`](crate::input::DetectTextInput::image): <p>The input image as base64-encoded bytes or an Amazon S3 object. If you use the AWS CLI to call Amazon Rekognition operations, you can't pass image bytes. </p>  <p>If you are using an AWS SDK to call Amazon Rekognition, you might not need to base64-encode image bytes passed using the <code>Bytes</code> field. For more information, see Images in the Amazon Rekognition developer guide.</p>
    ///   - [`filters(Option<DetectTextFilters>)`](crate::input::DetectTextInput::filters): <p>Optional parameters that let you set the criteria that the text must meet to be included in your response.</p>
    ...
    ///
    /// - Takes [`DistributeDatasetEntriesInput`](crate::input::DistributeDatasetEntriesInput) with field(s):
    ///   - [`datasets(Option<Vec<DistributeDataset>>)`](crate::input::DistributeDatasetEntriesInput::datasets): <p>The ARNS for the training dataset and test dataset that you want to use. The datasets must belong to the same project. The test dataset must be empty. </p>
    ...
    ///
    /// - Takes [`GetCelebrityInfoInput`](crate::input::GetCelebrityInfoInput) with field(s):
    ///   - [`id(Option<String>)`](crate::input::GetCelebrityInfoInput::id): <p>The ID for the celebrity. You get the celebrity ID from a call to the <code>RecognizeCelebrities</code> operation, which recognizes celebrities in an image. </p>
    ...
    ///
    /// - Takes [`GetCelebrityRecognitionInput`](crate::input::GetCelebrityRecognitionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetCelebrityRecognitionInput::job_id): <p>Job identifier for the required celebrity recognition analysis. You can get the job identifer from a call to <code>StartCelebrityRecognition</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetCelebrityRecognitionInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetCelebrityRecognitionInput::next_token): <p>If the previous response was incomplete (because there is more recognized celebrities to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of celebrities. </p>
    ///   - [`sort_by(Option<CelebrityRecognitionSortBy>)`](crate::input::GetCelebrityRecognitionInput::sort_by): <p>Sort to use for celebrities returned in <code>Celebrities</code> field. Specify <code>ID</code> to sort by the celebrity identifier, specify <code>TIMESTAMP</code> to sort by the time the celebrity was recognized.</p>
    ...
    ///
    /// - Takes [`GetContentModerationInput`](crate::input::GetContentModerationInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetContentModerationInput::job_id): <p>The identifier for the inappropriate, unwanted, or offensive content moderation job. Use <code>JobId</code> to identify the job in a subsequent call to <code>GetContentModeration</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetContentModerationInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetContentModerationInput::next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Rekognition returns a pagination token in the response. You can use this pagination token to retrieve the next set of content moderation labels.</p>
    ///   - [`sort_by(Option<ContentModerationSortBy>)`](crate::input::GetContentModerationInput::sort_by): <p>Sort to use for elements in the <code>ModerationLabelDetections</code> array. Use <code>TIMESTAMP</code> to sort array elements by the time labels are detected. Use <code>NAME</code> to alphabetically group elements for a label together. Within each label group, the array element are sorted by detection confidence. The default sort is by <code>TIMESTAMP</code>.</p>
    ...
    ///
    /// - Takes [`GetFaceDetectionInput`](crate::input::GetFaceDetectionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetFaceDetectionInput::job_id): <p>Unique identifier for the face detection job. The <code>JobId</code> is returned from <code>StartFaceDetection</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetFaceDetectionInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetFaceDetectionInput::next_token): <p>If the previous response was incomplete (because there are more faces to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of faces.</p>
    ...
    ///
    /// - Takes [`GetFaceSearchInput`](crate::input::GetFaceSearchInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetFaceSearchInput::job_id): <p>The job identifer for the search request. You get the job identifier from an initial call to <code>StartFaceSearch</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetFaceSearchInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetFaceSearchInput::next_token): <p>If the previous response was incomplete (because there is more search results to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of search results. </p>
    ///   - [`sort_by(Option<FaceSearchSortBy>)`](crate::input::GetFaceSearchInput::sort_by): <p>Sort to use for grouping faces in the response. Use <code>TIMESTAMP</code> to group faces by the time that they are recognized. Use <code>INDEX</code> to sort by recognized faces. </p>
    ...
    ///
    /// - Takes [`GetLabelDetectionInput`](crate::input::GetLabelDetectionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetLabelDetectionInput::job_id): <p>Job identifier for the label detection operation for which you want results returned. You get the job identifer from an initial call to <code>StartlabelDetection</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetLabelDetectionInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetLabelDetectionInput::next_token): <p>If the previous response was incomplete (because there are more labels to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of labels. </p>
    ///   - [`sort_by(Option<LabelDetectionSortBy>)`](crate::input::GetLabelDetectionInput::sort_by): <p>Sort to use for elements in the <code>Labels</code> array. Use <code>TIMESTAMP</code> to sort array elements by the time labels are detected. Use <code>NAME</code> to alphabetically group elements for a label together. Within each label group, the array element are sorted by detection confidence. The default sort is by <code>TIMESTAMP</code>.</p>
    ...
    ///
    /// - Takes [`GetPersonTrackingInput`](crate::input::GetPersonTrackingInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetPersonTrackingInput::job_id): <p>The identifier for a job that tracks persons in a video. You get the <code>JobId</code> from a call to <code>StartPersonTracking</code>. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetPersonTrackingInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetPersonTrackingInput::next_token): <p>If the previous response was incomplete (because there are more persons to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of persons. </p>
    ///   - [`sort_by(Option<PersonTrackingSortBy>)`](crate::input::GetPersonTrackingInput::sort_by): <p>Sort to use for elements in the <code>Persons</code> array. Use <code>TIMESTAMP</code> to sort array elements by the time persons are detected. Use <code>INDEX</code> to sort by the tracked persons. If you sort by <code>INDEX</code>, the array elements for each person are sorted by detection confidence. The default sort is by <code>TIMESTAMP</code>.</p>
    ...
    ///
    /// - Takes [`GetSegmentDetectionInput`](crate::input::GetSegmentDetectionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetSegmentDetectionInput::job_id): <p>Job identifier for the text detection operation for which you want results returned. You get the job identifer from an initial call to <code>StartSegmentDetection</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetSegmentDetectionInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetSegmentDetectionInput::next_token): <p>If the response is truncated, Amazon Rekognition Video returns this token that you can use in the subsequent request to retrieve the next set of text.</p>
    ...
    ///
    /// - Takes [`GetTextDetectionInput`](crate::input::GetTextDetectionInput) with field(s):
    ///   - [`job_id(Option<String>)`](crate::input::GetTextDetectionInput::job_id): <p>Job identifier for the text detection operation for which you want results returned. You get the job identifer from an initial call to <code>StartTextDetection</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetTextDetectionInput::max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetTextDetectionInput::next_token): <p>If the previous response was incomplete (because there are more labels to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of text.</p>
    ...
    ///
    /// - Takes [`ListCollectionsInput`](crate::input::ListCollectionsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListCollectionsInput::next_token): <p>Pagination token from the previous response.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListCollectionsInput::max_results): <p>Maximum number of collection IDs to return. </p>
    ...
    ///   - [`dataset_arn(Option<String>)`](crate::input::ListDatasetEntriesInput::dataset_arn): <p> The Amazon Resource Name (ARN) for the dataset that you want to use. </p>
    ///   - [`contains_labels(Option<Vec<String>>)`](crate::input::ListDatasetEntriesInput::contains_labels): <p>Specifies a label filter for the response. The response includes an entry only if one or more of the labels in <code>ContainsLabels</code> exist in the entry. </p>
    ///   - [`labeled(Option<bool>)`](crate::input::ListDatasetEntriesInput::labeled): <p> Specify <code>true</code> to get only the JSON Lines where the image is labeled. Specify <code>false</code> to get only the JSON Lines where the image isn't labeled. If you don't specify <code>Labeled</code>, <code>ListDatasetEntries</code> returns JSON Lines for labeled and unlabeled images. </p>
    ///   - [`source_ref_contains(Option<String>)`](crate::input::ListDatasetEntriesInput::source_ref_contains): <p>If specified, <code>ListDatasetEntries</code> only returns JSON Lines where the value of <code>SourceRefContains</code> is part of the <code>source-ref</code> field. The <code>source-ref</code> field contains the Amazon S3 location of the image. You can use <code>SouceRefContains</code> for tasks such as getting the JSON Line for a single image, or gettting JSON Lines for all images within a specific folder.</p>
    ///   - [`has_errors(Option<bool>)`](crate::input::ListDatasetEntriesInput::has_errors): <p>Specifies an error filter for the response. Specify <code>True</code> to only include entries that have errors. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDatasetEntriesInput::next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ...
    ///
    /// - Takes [`ListDatasetLabelsInput`](crate::input::ListDatasetLabelsInput) with field(s):
    ///   - [`dataset_arn(Option<String>)`](crate::input::ListDatasetLabelsInput::dataset_arn): <p> The Amazon Resource Name (ARN) of the dataset that you want to use. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDatasetLabelsInput::next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListDatasetLabelsInput::max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. </p>
    ...
    ///
    /// - Takes [`ListFacesInput`](crate::input::ListFacesInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::ListFacesInput::collection_id): <p>ID of the collection from which to list the faces.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListFacesInput::next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Rekognition returns a pagination token in the response. You can use this pagination token to retrieve the next set of faces.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListFacesInput::max_results): <p>Maximum number of faces to return.</p>
    ...
    ///
    /// - Takes [`ListStreamProcessorsInput`](crate::input::ListStreamProcessorsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListStreamProcessorsInput::next_token): <p>If the previous response was incomplete (because there are more stream processors to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of stream processors. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListStreamProcessorsInput::max_results): <p>Maximum number of stream processors you want Amazon Rekognition Video to return in the response. The default is 1000. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p> Amazon Resource Name (ARN) of the model, collection, or stream processor that contains the tags that you want a list of. </p>
    ...
    ///
    /// - Takes [`RecognizeCelebritiesInput`](crate::input::RecognizeCelebritiesInput) with field(s):
    ///   - [`image(Option<Image>)`](crate::input::RecognizeCelebritiesInput::image): <p>The input image as base64-encoded bytes or an S3 object. If you use the AWS CLI to call Amazon Rekognition operations, passing base64-encoded image bytes is not supported. </p>  <p>If you are using an AWS SDK to call Amazon Rekognition, you might not need to base64-encode image bytes passed using the <code>Bytes</code> field. For more information, see Images in the Amazon Rekognition developer guide.</p>
    ...
    ///
    /// - Takes [`SearchFacesInput`](crate::input::SearchFacesInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::SearchFacesInput::collection_id): <p>ID of the collection the face belongs to.</p>
    ///   - [`face_id(Option<String>)`](crate::input::SearchFacesInput::face_id): <p>ID of a face to find matches for in the collection.</p>
    ///   - [`max_faces(Option<i32>)`](crate::input::SearchFacesInput::max_faces): <p>Maximum number of faces to return. The operation returns the maximum number of faces with the highest confidence in the match.</p>
    ///   - [`face_match_threshold(Option<f32>)`](crate::input::SearchFacesInput::face_match_threshold): <p>Optional value specifying the minimum confidence in the face match to return. For example, don't return any matches where confidence in matches is less than 70%. The default value is 80%. </p>
    ...
    ///
    /// - Takes [`SearchFacesByImageInput`](crate::input::SearchFacesByImageInput) with field(s):
    ///   - [`collection_id(Option<String>)`](crate::input::SearchFacesByImageInput::collection_id): <p>ID of the collection to search.</p>
    ///   - [`image(Option<Image>)`](crate::input::SearchFacesByImageInput::image): <p>The input image as base64-encoded bytes or an S3 object. If you use the AWS CLI to call Amazon Rekognition operations, passing base64-encoded image bytes is not supported. </p>  <p>If you are using an AWS SDK to call Amazon Rekognition, you might not need to base64-encode image bytes passed using the <code>Bytes</code> field. For more information, see Images in the Amazon Rekognition developer guide.</p>
    ///   - [`max_faces(Option<i32>)`](crate::input::SearchFacesByImageInput::max_faces): <p>Maximum number of faces to return. The operation returns the maximum number of faces with the highest confidence in the match.</p>
    ///   - [`face_match_threshold(Option<f32>)`](crate::input::SearchFacesByImageInput::face_match_threshold): <p>(Optional) Specifies the minimum confidence in the face match to return. For example, don't return any matches where confidence in matches is less than 70%. The default value is 80%.</p>
    ///   - [`quality_filter(Option<QualityFilter>)`](crate::input::SearchFacesByImageInput::quality_filter): <p>A filter that specifies a quality bar for how much filtering is done to identify faces. Filtered faces aren't searched for in the collection. If you specify <code>AUTO</code>, Amazon Rekognition chooses the quality bar. If you specify <code>LOW</code>, <code>MEDIUM</code>, or <code>HIGH</code>, filtering removes all faces that don’t meet the chosen quality bar. The quality bar is based on a variety of common use cases. Low-quality detections can occur for a number of reasons. Some examples are an object that's misidentified as a face, a face that's too blurry, or a face with a pose that's too extreme to use. If you specify <code>NONE</code>, no filtering is performed. The default value is <code>NONE</code>. </p>  <p>To use quality filtering, the collection you are using must be associated with version 3 of the face model or higher.</p>
    ...
    ///
    /// - Takes [`StartCelebrityRecognitionInput`](crate::input::StartCelebrityRecognitionInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartCelebrityRecognitionInput::video): <p>The video in which you want to recognize celebrities. The video must be stored in an Amazon S3 bucket.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartCelebrityRecognitionInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartCelebrityRecognition</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartCelebrityRecognitionInput::notification_channel): <p>The Amazon SNS topic ARN that you want Amazon Rekognition Video to publish the completion status of the celebrity recognition analysis to. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartCelebrityRecognitionInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartContentModerationInput`](crate::input::StartContentModerationInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartContentModerationInput::video): <p>The video in which you want to detect inappropriate, unwanted, or offensive content. The video must be stored in an Amazon S3 bucket.</p>
    ///   - [`min_confidence(Option<f32>)`](crate::input::StartContentModerationInput::min_confidence): <p>Specifies the minimum confidence that Amazon Rekognition must have in order to return a moderated content label. Confidence represents how certain Amazon Rekognition is that the moderated content is correctly identified. 0 is the lowest confidence. 100 is the highest confidence. Amazon Rekognition doesn't return any moderated content labels with a confidence level lower than this specified value. If you don't specify <code>MinConfidence</code>, <code>GetContentModeration</code> returns labels with confidence values greater than or equal to 50 percent.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartContentModerationInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartContentModeration</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartContentModerationInput::notification_channel): <p>The Amazon SNS topic ARN that you want Amazon Rekognition Video to publish the completion status of the content analysis to. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy to access the topic.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartContentModerationInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartFaceDetectionInput`](crate::input::StartFaceDetectionInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartFaceDetectionInput::video): <p>The video in which you want to detect faces. The video must be stored in an Amazon S3 bucket.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartFaceDetectionInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartFaceDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartFaceDetectionInput::notification_channel): <p>The ARN of the Amazon SNS topic to which you want Amazon Rekognition Video to publish the completion status of the face detection operation. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy.</p>
    ///   - [`face_attributes(Option<FaceAttributes>)`](crate::input::StartFaceDetectionInput::face_attributes): <p>The face attributes you want returned.</p>  <p> <code>DEFAULT</code> - The following subset of facial attributes are returned: BoundingBox, Confidence, Pose, Quality and Landmarks. </p>  <p> <code>ALL</code> - All facial attributes are returned.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartFaceDetectionInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartFaceSearchInput`](crate::input::StartFaceSearchInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartFaceSearchInput::video): <p>The video you want to search. The video must be stored in an Amazon S3 bucket. </p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartFaceSearchInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartFaceSearch</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`face_match_threshold(Option<f32>)`](crate::input::StartFaceSearchInput::face_match_threshold): <p>The minimum confidence in the person match to return. For example, don't return any matches where confidence in matches is less than 70%. The default value is 80%.</p>
    ///   - [`collection_id(Option<String>)`](crate::input::StartFaceSearchInput::collection_id): <p>ID of the collection that contains the faces you want to search for.</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartFaceSearchInput::notification_channel): <p>The ARN of the Amazon SNS topic to which you want Amazon Rekognition Video to publish the completion status of the search. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy to access the topic.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartFaceSearchInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartLabelDetectionInput`](crate::input::StartLabelDetectionInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartLabelDetectionInput::video): <p>The video in which you want to detect labels. The video must be stored in an Amazon S3 bucket.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartLabelDetectionInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartLabelDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`min_confidence(Option<f32>)`](crate::input::StartLabelDetectionInput::min_confidence): <p>Specifies the minimum confidence that Amazon Rekognition Video must have in order to return a detected label. Confidence represents how certain Amazon Rekognition is that a label is correctly identified.0 is the lowest confidence. 100 is the highest confidence. Amazon Rekognition Video doesn't return any labels with a confidence level lower than this specified value.</p>  <p>If you don't specify <code>MinConfidence</code>, the operation returns labels with confidence values greater than or equal to 50 percent.</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartLabelDetectionInput::notification_channel): <p>The Amazon SNS topic ARN you want Amazon Rekognition Video to publish the completion status of the label detection operation to. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartLabelDetectionInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartPersonTrackingInput`](crate::input::StartPersonTrackingInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartPersonTrackingInput::video): <p>The video in which you want to detect people. The video must be stored in an Amazon S3 bucket.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartPersonTrackingInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartPersonTracking</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartPersonTrackingInput::notification_channel): <p>The Amazon SNS topic ARN you want Amazon Rekognition Video to publish the completion status of the people detection operation to. The Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartPersonTrackingInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ...
    ///
    /// - Takes [`StartProjectVersionInput`](crate::input::StartProjectVersionInput) with field(s):
    ///   - [`project_version_arn(Option<String>)`](crate::input::StartProjectVersionInput::project_version_arn): <p>The Amazon Resource Name(ARN) of the model version that you want to start.</p>
    ///   - [`min_inference_units(Option<i32>)`](crate::input::StartProjectVersionInput::min_inference_units): <p>The minimum number of inference units to use. A single inference unit represents 1 hour of processing and can support up to 5 Transaction Pers Second (TPS). Use a higher number to increase the TPS throughput of your model. You are charged for the number of inference units that you use. </p>
    ...
    ///
    /// - Takes [`StartSegmentDetectionInput`](crate::input::StartSegmentDetectionInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartSegmentDetectionInput::video): <p>Video file stored in an Amazon S3 bucket. Amazon Rekognition video start operations such as <code>StartLabelDetection</code> use <code>Video</code> to specify a video for analysis. The supported file formats are .mp4, .mov and .avi.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartSegmentDetectionInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartSegmentDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartSegmentDetectionInput::notification_channel): <p>The ARN of the Amazon SNS topic to which you want Amazon Rekognition Video to publish the completion status of the segment detection operation. Note that the Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy to access the topic.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartSegmentDetectionInput::job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ///   - [`filters(Option<StartSegmentDetectionFilters>)`](crate::input::StartSegmentDetectionInput::filters): <p>Filters for technical cue or shot detection.</p>
    ///   - [`segment_types(Option<Vec<SegmentType>>)`](crate::input::StartSegmentDetectionInput::segment_types): <p>An array of segment types to detect in the video. Valid values are TECHNICAL_CUE and SHOT.</p>
    ...
    ///
    /// - Takes [`StartStreamProcessorInput`](crate::input::StartStreamProcessorInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::StartStreamProcessorInput::name): <p>The name of the stream processor to start processing.</p>
    ...
    ///
    /// - Takes [`StartTextDetectionInput`](crate::input::StartTextDetectionInput) with field(s):
    ///   - [`video(Option<Video>)`](crate::input::StartTextDetectionInput::video): <p>Video file stored in an Amazon S3 bucket. Amazon Rekognition video start operations such as <code>StartLabelDetection</code> use <code>Video</code> to specify a video for analysis. The supported file formats are .mp4, .mov and .avi.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::StartTextDetectionInput::client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartTextDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidentaly started more than once.</p>
    ///   - [`notification_channel(Option<NotificationChannel>)`](crate::input::StartTextDetectionInput::notification_channel): <p>The Amazon Simple Notification Service topic to which Amazon Rekognition publishes the completion status of a video analysis operation. For more information, see <code>api-video</code>. Note that the Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy to access the topic. For more information, see <a href="https://docs.aws.amazon.com/rekognition/latest/dg/api-video-roles.html#api-video-roles-all-topics">Giving access to multiple Amazon SNS topics</a>.</p>
    ///   - [`job_tag(Option<String>)`](crate::input::StartTextDetectionInput::job_tag): <p>An identifier returned in the completion status published by your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ///   - [`filters(Option<StartTextDetectionFilters>)`](crate::input::StartTextDetectionInput::filters): <p>Optional parameters that let you set criteria the text must meet to be included in your response.</p>
    ...
    ///
    /// - Takes [`StopProjectVersionInput`](crate::input::StopProjectVersionInput) with field(s):
    ///   - [`project_version_arn(Option<String>)`](crate::input::StopProjectVersionInput::project_version_arn): <p>The Amazon Resource Name (ARN) of the model version that you want to delete.</p>  <p>This operation requires permissions to perform the <code>rekognition:StopProjectVersion</code> action.</p>
    ...
    ///
    /// - Takes [`StopStreamProcessorInput`](crate::input::StopStreamProcessorInput) with field(s):
    ///   - [`name(Option<String>)`](crate::input::StopStreamProcessorInput::name): <p>The name of a stream processor created by <code>CreateStreamProcessor</code>.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p> Amazon Resource Name (ARN) of the model, collection, or stream processor that you want to assign the tags to. </p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::TagResourceInput::tags): <p> The key-value tags to assign to the resource. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p> Amazon Resource Name (ARN) of the model, collection, or stream processor that you want to remove the tags from. </p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p> A list of the tags that you want to remove. </p>
    ...
    ///   - [`dataset_arn(Option<String>)`](crate::input::UpdateDatasetEntriesInput::dataset_arn): <p> The Amazon Resource Name (ARN) of the dataset that you want to update. </p>
    ///   - [`changes(Option<DatasetChanges>)`](crate::input::UpdateDatasetEntriesInput::changes): <p> The changes that you want to make to the dataset. </p>
