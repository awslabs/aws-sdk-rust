...
impl ::std::convert::From<&str> for CustomizationFeature {
    fn from(s: &str) -> Self {
        match s {
            "CONTENT_MODERATION" => CustomizationFeature::ContentModeration,
            "CUSTOM_LABELS" => CustomizationFeature::CustomLabels,
            other => CustomizationFeature::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for CustomizationFeature {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(CustomizationFeature::from(s))
    }
}
impl CustomizationFeature {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            CustomizationFeature::ContentModeration => "CONTENT_MODERATION",
            CustomizationFeature::CustomLabels => "CUSTOM_LABELS",
            CustomizationFeature::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for CustomizationFeature {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
