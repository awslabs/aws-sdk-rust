...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::set_job_id): <p>Job identifier for the text detection operation for which you want results returned. You get the job identifer from an initial call to <code>StartSegmentDetection</code>.</p>
    ///   - [`max_results(i32)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::set_max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_segment_detection::builders::GetSegmentDetectionFluentBuilder::set_next_token): <p>If the response is truncated, Amazon Rekognition Video returns this token that you can use in the subsequent request to retrieve the next set of text.</p>
