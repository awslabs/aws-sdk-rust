...
impl super::Client {
    ...
    ///   - [`collection_id(impl Into<String>)`](crate::operation::delete_collection::builders::DeleteCollectionFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::delete_collection::builders::DeleteCollectionFluentBuilder::set_collection_id):<br>required: **true**<br><p>ID of the collection to delete.</p><br>
