...
impl super::Client {
    ...
    ///   - [`job_tag(impl ::std::convert::Into<String>)`](crate::operation::start_face_search::builders::StartFaceSearchFluentBuilder::job_tag) / [`set_job_tag(Option<String>)`](crate::operation::start_face_search::builders::StartFaceSearchFluentBuilder::set_job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
