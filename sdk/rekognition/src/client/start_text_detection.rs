...
impl super::Client {
    ...
    ///   - [`video(Video)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::video) / [`set_video(Option<Video>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::set_video): <p>Video file stored in an Amazon S3 bucket. Amazon Rekognition video start operations such as <code>StartLabelDetection</code> use <code>Video</code> to specify a video for analysis. The supported file formats are .mp4, .mov and .avi.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::set_client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartTextDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidentaly started more than once.</p>
    ///   - [`notification_channel(NotificationChannel)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::notification_channel) / [`set_notification_channel(Option<NotificationChannel>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::set_notification_channel): <p>The Amazon Simple Notification Service topic to which Amazon Rekognition publishes the completion status of a video analysis operation. For more information, see <a href="https://docs.aws.amazon.com/rekognition/latest/dg/api-video.html">Calling Amazon Rekognition Video operations</a>. Note that the Amazon SNS topic must have a topic name that begins with <i>AmazonRekognition</i> if you are using the AmazonRekognitionServiceRole permissions policy to access the topic. For more information, see <a href="https://docs.aws.amazon.com/rekognition/latest/dg/api-video-roles.html#api-video-roles-all-topics">Giving access to multiple Amazon SNS topics</a>.</p>
    ///   - [`job_tag(impl ::std::convert::Into<String>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::job_tag) / [`set_job_tag(Option<String>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::set_job_tag): <p>An identifier returned in the completion status published by your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
    ///   - [`filters(StartTextDetectionFilters)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::filters) / [`set_filters(Option<StartTextDetectionFilters>)`](crate::operation::start_text_detection::builders::StartTextDetectionFluentBuilder::set_filters): <p>Optional parameters that let you set criteria the text must meet to be included in your response.</p>
