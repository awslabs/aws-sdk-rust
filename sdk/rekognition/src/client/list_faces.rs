...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_user_id): <p>An array of user IDs to match when listing faces in a collection.</p>
    ///   - [`face_ids(impl Into<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::face_ids) / [`set_face_ids(Option<Vec<String>>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_face_ids): <p>An array of face IDs to match when listing faces in a collection.</p>
