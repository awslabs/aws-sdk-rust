...
impl super::Client {
    ...
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder::set_job_id): <p>Job identifier for the text detection operation for which you want results returned. You get the job identifer from an initial call to <code>StartTextDetection</code>.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there are more labels to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of text.</p>
    ...
    pub fn get_text_detection(
        &self,
    ) -> crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder {
        crate::operation::get_text_detection::builders::GetTextDetectionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
