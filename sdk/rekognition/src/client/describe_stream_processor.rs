...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_stream_processor::builders::DescribeStreamProcessorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_stream_processor::builders::DescribeStreamProcessorFluentBuilder::set_name): <p>Name of the stream processor for which you want information.</p>
