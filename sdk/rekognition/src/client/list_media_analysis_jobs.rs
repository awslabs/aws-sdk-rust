...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_media_analysis_jobs::builders::ListMediaAnalysisJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_media_analysis_jobs::builders::ListMediaAnalysisJobsFluentBuilder::set_next_token): <p>Pagination token, if the previous response was incomplete.</p>
    ///   - [`max_results(i32)`](crate::operation::list_media_analysis_jobs::builders::ListMediaAnalysisJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_media_analysis_jobs::builders::ListMediaAnalysisJobsFluentBuilder::set_max_results): <p>The maximum number of results to return per paginated call. The largest value user can specify is 100. If user specifies a value greater than 100, an <code>InvalidParameterException</code> error occurs. The default value is 100.</p>
    ...
    ///   - [`media_analysis_jobs(Option<Vec<MediaAnalysisJobDescription>>)`](crate::operation::list_media_analysis_jobs::ListMediaAnalysisJobsOutput::media_analysis_jobs): <p>Contains a list of all media analysis jobs.</p>
