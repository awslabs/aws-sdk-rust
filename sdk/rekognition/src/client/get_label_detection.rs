...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::set_max_results): <p>Maximum number of results to return per paginated call. The largest value you can specify is 1000. If you specify a value greater than 1000, a maximum of 1000 results is returned. The default value is 1000.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there are more labels to retrieve), Amazon Rekognition Video returns a pagination token in the response. You can use this pagination token to retrieve the next set of labels. </p>
    ///   - [`sort_by(LabelDetectionSortBy)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::sort_by) / [`set_sort_by(Option<LabelDetectionSortBy>)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::set_sort_by): <p>Sort to use for elements in the <code>Labels</code> array. Use <code>TIMESTAMP</code> to sort array elements by the time labels are detected. Use <code>NAME</code> to alphabetically group elements for a label together. Within each label group, the array element are sorted by detection confidence. The default sort is by <code>TIMESTAMP</code>.</p>
    ///   - [`aggregate_by(LabelDetectionAggregateBy)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::aggregate_by) / [`set_aggregate_by(Option<LabelDetectionAggregateBy>)`](crate::operation::get_label_detection::builders::GetLabelDetectionFluentBuilder::set_aggregate_by): <p>Defines how to aggregate the returned results. Results can be aggregated by timestamps or segments.</p>
