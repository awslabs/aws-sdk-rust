...
impl super::Client {
    ...
    ///   - [`feature(CustomizationFeature)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::feature) / [`set_feature(Option<CustomizationFeature>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::set_feature): <p>Specifies feature that is being customized. If no value is provided CUSTOM_LABELS is used as a default.</p>
    ///   - [`auto_update(ProjectAutoUpdate)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::auto_update) / [`set_auto_update(Option<ProjectAutoUpdate>)`](crate::operation::create_project::builders::CreateProjectFluentBuilder::set_auto_update): <p>Specifies whether automatic retraining should be attempted for the versions of the project. Automatic retraining is done as a best effort. Required argument for Content Moderation. Applicable only to adapters.</p>
