...
impl super::Client {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_collection_id): <p>The ID of an existing collection containing the UserID, used with a UserId or FaceId. If a FaceId is provided, UserId isn’t required to be present in the Collection.</p>
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_user_id): <p>ID for the existing User.</p>
    ///   - [`face_id(impl ::std::convert::Into<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::face_id) / [`set_face_id(Option<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_face_id): <p>ID for the existing face.</p>
    ///   - [`user_match_threshold(f32)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::user_match_threshold) / [`set_user_match_threshold(Option<f32>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_user_match_threshold): <p>Optional value that specifies the minimum confidence in the matched UserID to return. Default value of 80.</p>
    ///   - [`max_users(i32)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::max_users) / [`set_max_users(Option<i32>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_max_users): <p>Maximum number of identities to return.</p>
