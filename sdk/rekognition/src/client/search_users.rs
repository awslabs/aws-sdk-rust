...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_user_id): <p>ID for the existing User.</p>
    ///   - [`face_id(impl Into<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::face_id) / [`set_face_id(Option<String>)`](crate::operation::search_users::builders::SearchUsersFluentBuilder::set_face_id): <p>ID for the existing face.</p>
