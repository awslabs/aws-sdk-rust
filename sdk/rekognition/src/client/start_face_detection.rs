...
impl super::Client {
    ...
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::start_face_detection::builders::StartFaceDetectionFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::start_face_detection::builders::StartFaceDetectionFluentBuilder::set_client_request_token): <p>Idempotent token used to identify the start request. If you use the same token with multiple <code>StartFaceDetection</code> requests, the same <code>JobId</code> is returned. Use <code>ClientRequestToken</code> to prevent the same job from being accidently started more than once. </p>
    ...
    ///   - [`job_tag(impl Into<String>)`](crate::operation::start_face_detection::builders::StartFaceDetectionFluentBuilder::job_tag) / [`set_job_tag(Option<String>)`](crate::operation::start_face_detection::builders::StartFaceDetectionFluentBuilder::set_job_tag): <p>An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use <code>JobTag</code> to group related jobs and identify them in the completion notification.</p>
