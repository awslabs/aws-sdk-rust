...
impl super::Client {
    ...
    pub fn recognize_celebrities(
        &self,
    ) -> crate::operation::recognize_celebrities::builders::RecognizeCelebritiesFluentBuilder {
        crate::operation::recognize_celebrities::builders::RecognizeCelebritiesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
