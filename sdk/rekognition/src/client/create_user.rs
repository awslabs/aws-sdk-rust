...
impl super::Client {
    ...
    ///   - [`collection_id(impl Into<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_collection_id): <p>The ID of an existing collection to which the new UserID needs to be created.</p>
    ///   - [`user_id(impl Into<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::create_user::builders::CreateUserFluentBuilder::set_user_id): <p>ID for the UserID to be created. This ID needs to be unique within the collection.</p>
