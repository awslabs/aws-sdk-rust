...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_collection::builders::CreateCollectionFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_collection::builders::CreateCollectionFluentBuilder::set_tags): <p> A set of tags (key-value pairs) that you want to attach to the collection. </p>
