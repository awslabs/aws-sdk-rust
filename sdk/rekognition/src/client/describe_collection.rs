...
impl super::Client {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::describe_collection::builders::DescribeCollectionFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::describe_collection::builders::DescribeCollectionFluentBuilder::set_collection_id): <p>The ID of the collection to describe.</p>
