...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::set_project_arn): <p>The Amazon Resource Name (ARN) of the project that contains the models you want to describe.</p>
    ///   - [`version_names(Vec<String>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::version_names) / [`set_version_names(Option<Vec<String>>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::set_version_names): <p>A list of model version names that you want to describe. You can add up to 10 model version names to the list. If you don't specify a value, all model descriptions are returned. A version name is part of a model (ProjectVersion) ARN. For example, <code>my-model.2020-01-21T09.10.15</code> is the version name in the following ARN. <code>arn:aws:rekognition:us-east-1:123456789012:project/getting-started/version/<i>my-model.2020-01-21T09.10.15</i>/1234567890123</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Amazon Rekognition Custom Labels returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
    ///   - [`max_results(i32)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_project_versions::builders::DescribeProjectVersionsFluentBuilder::set_max_results): <p>The maximum number of results to return per paginated call. The largest value you can specify is 100. If you specify a value greater than 100, a ValidationException error occurs. The default value is 100. </p>
