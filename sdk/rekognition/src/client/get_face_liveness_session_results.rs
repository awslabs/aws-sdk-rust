...
impl super::Client {
    ...
    ///   - [`session_id(Option<String>)`](crate::operation::get_face_liveness_session_results::GetFaceLivenessSessionResultsOutput::session_id): <p>The sessionId for which this request was called.</p>
    ///   - [`status(Option<LivenessSessionStatus>)`](crate::operation::get_face_liveness_session_results::GetFaceLivenessSessionResultsOutput::status): <p>Represents a status corresponding to the state of the session. Possible statuses are: CREATED, IN_PROGRESS, SUCCEEDED, FAILED, EXPIRED.</p>
