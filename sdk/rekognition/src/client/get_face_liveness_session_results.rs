...
impl super::Client {
    ...
    ///   - [`challenge(Option<Challenge>)`](crate::operation::get_face_liveness_session_results::GetFaceLivenessSessionResultsOutput::challenge): <p>Contains information regarding the challenge type used for the Face Liveness check.</p>
