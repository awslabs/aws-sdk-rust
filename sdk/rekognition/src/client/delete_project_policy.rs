...
impl super::Client {
    ...
    ///   - [`project_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_project_policy::builders::DeleteProjectPolicyFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::delete_project_policy::builders::DeleteProjectPolicyFluentBuilder::set_project_arn): <p>The Amazon Resource Name (ARN) of the project that the project policy you want to delete is attached to.</p>
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::delete_project_policy::builders::DeleteProjectPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::delete_project_policy::builders::DeleteProjectPolicyFluentBuilder::set_policy_name): <p>The name of the policy that you want to delete.</p>
