...
impl super::Client {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::search_faces::builders::SearchFacesFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::search_faces::builders::SearchFacesFluentBuilder::set_collection_id): <p>ID of the collection the face belongs to.</p>
    ///   - [`face_id(impl ::std::convert::Into<String>)`](crate::operation::search_faces::builders::SearchFacesFluentBuilder::face_id) / [`set_face_id(Option<String>)`](crate::operation::search_faces::builders::SearchFacesFluentBuilder::set_face_id): <p>ID of a face to find matches for in the collection.</p>
