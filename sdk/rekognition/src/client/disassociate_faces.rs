...
impl super::Client {
    ...
    ///   - [`user_id(impl Into<String>)`](crate::operation::disassociate_faces::builders::DisassociateFacesFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::disassociate_faces::builders::DisassociateFacesFluentBuilder::set_user_id): <p>ID for the existing UserID.</p>
    ...
    ///   - [`face_ids(impl Into<String>)`](crate::operation::disassociate_faces::builders::DisassociateFacesFluentBuilder::face_ids) / [`set_face_ids(Option<Vec<String>>)`](crate::operation::disassociate_faces::builders::DisassociateFacesFluentBuilder::set_face_ids): <p>An array of face IDs to disassociate from the UserID. </p>
