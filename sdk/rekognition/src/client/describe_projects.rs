...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_projects::builders::DescribeProjectsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_projects::builders::DescribeProjectsFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more results to retrieve), Rekognition returns a pagination token in the response. You can use this pagination token to retrieve the next set of results. </p>
