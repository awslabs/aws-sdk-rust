...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_stream_processor::builders::UpdateStreamProcessorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_stream_processor::builders::UpdateStreamProcessorFluentBuilder::set_name): <p> Name of the stream processor that you want to update. </p>
