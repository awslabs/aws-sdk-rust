...
impl super::Client {
    ...
    ///   - [`collection_id(impl Into<String>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::set_collection_id): <p>The ID of an existing collection containing the UserID.</p>
    ///   - [`user_id(impl Into<String>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::set_user_id): <p>The ID for the existing UserID.</p>
    ///   - [`face_ids(impl Into<String>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::face_ids) / [`set_face_ids(Option<Vec<String>>)`](crate::operation::associate_faces::builders::AssociateFacesFluentBuilder::set_face_ids): <p>An array of FaceIDs to associate with the UserID.</p>
