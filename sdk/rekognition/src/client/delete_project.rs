...
impl super::Client {
    ...
    ///   - [`project_arn(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::project_arn) / [`set_project_arn(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_project_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the project that you want to delete.</p><br>
