...
///
/// Fluent builder for the `project_version_training_completed` waiter.
///
...
pub struct ProjectVersionTrainingCompletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_project_versions::builders::DescribeProjectVersionsInputBuilder,
}
impl ProjectVersionTrainingCompletedFluentBuilder {
    /// Creates a new `ProjectVersionTrainingCompletedFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::project_version_training_completed::ProjectVersionTrainingCompletedFinalPoll,
        crate::waiters::project_version_training_completed::WaitUntilProjectVersionTrainingCompletedError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"ProjectVersionDescriptions[].Status","expected":"TRAINING_COMPLETED","comparator":"allStringEquals"}}
            if crate::waiters::matchers::match_describe_project_versions_c0de0dba73a4550df(result) {
                return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
            }
            // Matches: {"output":{"path":"ProjectVersionDescriptions[].Status","expected":"TRAINING_FAILED","comparator":"anyStringEquals"}}
            if crate::waiters::matchers::match_describe_project_versions_d574c78b065cace74(result) {
...
/// Successful return type for the `project_version_training_completed` waiter.
pub type ProjectVersionTrainingCompletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_project_versions::DescribeProjectVersionsOutput,
...
/// Error type for the `project_version_training_completed` waiter.
pub type WaitUntilProjectVersionTrainingCompletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_project_versions::DescribeProjectVersionsOutput,
    crate::operation::describe_project_versions::DescribeProjectVersionsError,
>;
