...
pub(crate) mod shape_associate_faces;
...
pub(crate) mod shape_disassociate_faces;
...
pub(crate) mod shape_search_users_by_image;
...
pub(crate) mod shape_associate_faces_input;
...
pub(crate) mod shape_disassociate_faces_input;
...
pub(crate) mod shape_search_users_by_image_input;
...
pub(crate) mod shape_associated_faces_list;
...
pub(crate) mod shape_disassociated_faces_list;
...
pub(crate) mod shape_searched_face;

pub(crate) mod shape_searched_face_details;

pub(crate) mod shape_searched_user;
...
pub(crate) mod shape_unsearched_faces_list;

pub(crate) mod shape_unsuccessful_face_association_list;

pub(crate) mod shape_unsuccessful_face_deletions_list;

pub(crate) mod shape_unsuccessful_face_disassociation_list;

pub(crate) mod shape_urls;

pub(crate) mod shape_user_list;

pub(crate) mod shape_user_match_list;
...
pub(crate) mod shape_associated_face;
...
pub(crate) mod shape_disassociated_face;
...
pub(crate) mod shape_unsearched_face;

pub(crate) mod shape_unsuccessful_face_association;

pub(crate) mod shape_unsuccessful_face_deletion;

pub(crate) mod shape_unsuccessful_face_disassociation;

pub(crate) mod shape_user;

pub(crate) mod shape_user_match;
...
pub(crate) mod shape_matched_user;
...
pub(crate) mod shape_unsearched_face_reasons;

pub(crate) mod shape_unsuccessful_face_association_reasons;
