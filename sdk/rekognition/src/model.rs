...
pub struct ProjectVersionDescription {
    ...
    pub training_end_timestamp: std::option::Option<smithy_types::Instant>,
...
pub mod project_version_description {
    ...
    pub struct Builder {
        ...
        pub(crate) training_end_timestamp: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The Unix date and time that training of the model ended.</p>
        pub fn training_end_timestamp(mut self, input: smithy_types::Instant) -> Self {
