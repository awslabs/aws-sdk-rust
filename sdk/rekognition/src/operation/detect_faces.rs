...
impl DetectFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detect_faces::DetectFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_faces::ser_detect_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_faces::de_detect_faces_http_response_with_props(status, headers, body)
        }
    }
}
