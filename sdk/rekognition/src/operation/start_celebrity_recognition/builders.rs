...
impl StartCelebrityRecognitionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_celebrity_recognition::StartCelebrityRecognition::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_celebrity_recognition::StartCelebrityRecognition::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionOutput, crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError, Self> {
