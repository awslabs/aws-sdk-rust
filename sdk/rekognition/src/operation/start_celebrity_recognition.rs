...
/// Orchestration and serialization glue logic for `StartCelebrityRecognition`.
...
impl StartCelebrityRecognition {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartCelebrityRecognition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartCelebrityRecognition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartCelebrityRecognitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartCelebrityRecognitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartCelebrityRecognition")
...
.with_interceptor(StartCelebrityRecognitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError>::new());
...
#[derive(Debug)]
            struct StartCelebrityRecognitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartCelebrityRecognitionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_celebrity_recognition::de_start_celebrity_recognition_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_celebrity_recognition::de_start_celebrity_recognition_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartCelebrityRecognitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartCelebrityRecognitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_celebrity_recognition::StartCelebrityRecognitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_celebrity_recognition::ser_start_celebrity_recognition_input(&input)?);
...
#[derive(Debug)]
            struct StartCelebrityRecognitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartCelebrityRecognitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartCelebrityRecognitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartCelebrityRecognitionInput>()
                        .ok_or("failed to downcast to StartCelebrityRecognitionInput")?;
...
pub enum StartCelebrityRecognitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartCelebrityRecognitionError) for what information is available for the error.")]
...
impl StartCelebrityRecognitionError {
    /// Creates the `StartCelebrityRecognitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartCelebrityRecognitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartCelebrityRecognitionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_celebrity_recognition::StartCelebrityRecognitionError {
...
mod _start_celebrity_recognition_output;
