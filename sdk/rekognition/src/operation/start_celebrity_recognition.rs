...
impl StartCelebrityRecognitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_celebrity_recognition::StartCelebrityRecognition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCelebrityRecognition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_celebrity_recognition::de_start_celebrity_recognition_http_response_with_props(status, headers, body)
        }
    }
}
