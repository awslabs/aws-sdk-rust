...
impl IndexFacesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::index_faces::IndexFaces::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for IndexFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_index_faces::de_index_faces_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_index_faces::de_index_faces_http_response_with_props(
                status, headers, body,
            )
        }
    }
