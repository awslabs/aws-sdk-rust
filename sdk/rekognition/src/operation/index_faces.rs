...
impl IndexFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::index_faces::IndexFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_index_faces::ser_index_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for IndexFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_index_faces::de_index_faces_http_response_with_props(status, headers, body)
        }
    }
}
