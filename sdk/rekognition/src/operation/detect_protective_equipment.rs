...
impl DetectProtectiveEquipmentInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::detect_protective_equipment::DetectProtectiveEquipment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectProtectiveEquipment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_protective_equipment::de_detect_protective_equipment_http_response_with_props(status, headers, body)
        }
    }
}
