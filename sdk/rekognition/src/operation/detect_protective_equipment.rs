...
/// Orchestration and serialization glue logic for `DetectProtectiveEquipment`.
...
impl DetectProtectiveEquipment {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectProtectiveEquipment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetectProtectiveEquipment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetectProtectiveEquipmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetectProtectiveEquipmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectProtectiveEquipment")
...
.with_interceptor(DetectProtectiveEquipmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError>::new());
...
#[derive(Debug)]
            struct DetectProtectiveEquipmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectProtectiveEquipmentResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detect_protective_equipment::de_detect_protective_equipment_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detect_protective_equipment::de_detect_protective_equipment_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DetectProtectiveEquipmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectProtectiveEquipmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detect_protective_equipment::DetectProtectiveEquipmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_protective_equipment::ser_detect_protective_equipment_input(&input)?);
...
#[derive(Debug)]
            struct DetectProtectiveEquipmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectProtectiveEquipmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetectProtectiveEquipmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetectProtectiveEquipmentInput>()
                        .ok_or("failed to downcast to DetectProtectiveEquipmentInput")?;
...
pub enum DetectProtectiveEquipmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetectProtectiveEquipmentError) for what information is available for the error.")]
...
impl DetectProtectiveEquipmentError {
    /// Creates the `DetectProtectiveEquipmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetectProtectiveEquipmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetectProtectiveEquipmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detect_protective_equipment::DetectProtectiveEquipmentError {
...
mod _detect_protective_equipment_output;
