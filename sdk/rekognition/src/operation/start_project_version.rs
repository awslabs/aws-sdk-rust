...
impl StartProjectVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_project_version::ser_start_project_version_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_project_version::StartProjectVersion::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_project_version::StartProjectVersionError
{
