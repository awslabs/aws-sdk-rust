...
impl GetContentModerationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_content_moderation::ser_get_content_moderation_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_content_moderation::GetContentModeration::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_content_moderation::GetContentModerationError
{
