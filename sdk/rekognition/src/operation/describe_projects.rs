...
impl DescribeProjectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_projects::DescribeProjects, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_projects::ser_describe_projects_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_projects::de_describe_projects_http_response_with_props(status, headers, body)
        }
    }
}
