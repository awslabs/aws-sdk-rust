...
impl SearchFacesByImage {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::search_faces_by_image::SearchFacesByImageError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::search_faces_by_image::SearchFacesByImageOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Rekognition", "SearchFacesByImage", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Rekognition.SearchFacesByImage",
                "rpc.service" = "Rekognition",
                "rpc.method" = "SearchFacesByImage",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchFacesByImage {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SearchFacesByImageRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SearchFacesByImageResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchFacesByImage")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SearchFacesByImageTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SearchFacesByImageTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchFacesByImageTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SearchFacesByImageInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchFacesByImageResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_search_faces_by_image::de_search_faces_by_image_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_search_faces_by_image::de_search_faces_by_image_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchFacesByImageRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::search_faces_by_image::SearchFacesByImageInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::search_faces_by_image::SearchFacesByImageInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_faces_by_image::ser_search_faces_by_image_input(
            &input,
        )?);
