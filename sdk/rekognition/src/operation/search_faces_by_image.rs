...
impl SearchFacesByImageInput {
    /// Consumes the builder and constructs an Operation<[`SearchFacesByImage`](crate::operation::search_faces_by_image::SearchFacesByImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::search_faces_by_image::SearchFacesByImage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_faces_by_image::SearchFacesByImageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_faces_by_image::ser_search_faces_by_image_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::search_faces_by_image::SearchFacesByImage::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SearchFacesByImage {
                type Output = std::result::Result<crate::operation::search_faces_by_image::SearchFacesByImageOutput, crate::operation::search_faces_by_image::SearchFacesByImageError>;
