...
/// Orchestration and serialization glue logic for `SearchFacesByImage`.
...
impl SearchFacesByImage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::search_faces_by_image::SearchFacesByImageInput,
                    ) -> ::std::result::Result<crate::operation::search_faces_by_image::SearchFacesByImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_faces_by_image::SearchFacesByImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_faces_by_image::SearchFacesByImageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_faces_by_image::SearchFacesByImageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchFacesByImage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchFacesByImage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchFacesByImageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchFacesByImageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchFacesByImage")
...
.with_interceptor(SearchFacesByImageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_faces_by_image::SearchFacesByImageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_faces_by_image::SearchFacesByImageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_faces_by_image::SearchFacesByImageError>::new());
...
#[derive(Debug)]
            struct SearchFacesByImageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchFacesByImageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_faces_by_image::de_search_faces_by_image_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SearchFacesByImageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchFacesByImageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_faces_by_image::SearchFacesByImageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_faces_by_image::SearchFacesByImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_faces_by_image::ser_search_faces_by_image_input(&input)?);
...
#[derive(Debug)]
            struct SearchFacesByImageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchFacesByImageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchFacesByImageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchFacesByImageInput>()
                        .ok_or("failed to downcast to SearchFacesByImageInput")?;
...
pub enum SearchFacesByImageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchFacesByImageError) for what information is available for the error.")]
...
impl SearchFacesByImageError {
    /// Creates the `SearchFacesByImageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchFacesByImageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchFacesByImageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_faces_by_image::SearchFacesByImageError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::search_faces_by_image::_search_faces_by_image_output::SearchFacesByImageOutput;

pub use crate::operation::search_faces_by_image::_search_faces_by_image_input::SearchFacesByImageInput;

mod _search_faces_by_image_input;

mod _search_faces_by_image_output;
