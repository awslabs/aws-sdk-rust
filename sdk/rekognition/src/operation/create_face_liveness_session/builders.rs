...
impl CreateFaceLivenessSessionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_face_liveness_session::CreateFaceLivenessSessionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_face_liveness_session::CreateFaceLivenessSessionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_face_liveness_session::CreateFaceLivenessSessionOutput, crate::operation::create_face_liveness_session::CreateFaceLivenessSessionError, Self> {
