...
impl CreateFaceLivenessSessionOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_face_liveness_session::CreateFaceLivenessSessionOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_face_liveness_session::CreateFaceLivenessSessionOutput {
                session_id: self.session_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("session_id", "session_id was not specified but it is required when building CreateFaceLivenessSessionOutput")
                    )?
                ,
