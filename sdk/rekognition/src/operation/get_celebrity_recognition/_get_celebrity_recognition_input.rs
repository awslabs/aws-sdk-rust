...
impl GetCelebrityRecognitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_celebrity_recognition::GetCelebrityRecognitionInput, ::aws_smithy_types::error::operation::BuildError> {
