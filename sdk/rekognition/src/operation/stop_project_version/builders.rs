...
impl StopProjectVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_project_version::StopProjectVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_project_version::StopProjectVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_project_version::StopProjectVersionOutput, crate::operation::stop_project_version::StopProjectVersionError, Self> {
