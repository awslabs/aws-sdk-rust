...
impl SearchUsersByImageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_users_by_image::SearchUsersByImageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_users_by_image::SearchUsersByImageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_users_by_image::SearchUsersByImageOutput, crate::operation::search_users_by_image::SearchUsersByImageError, Self> {
