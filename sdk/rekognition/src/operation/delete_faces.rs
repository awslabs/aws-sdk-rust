...
impl DeleteFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_faces::DeleteFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_faces::ser_delete_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_faces::de_delete_faces_http_response_with_props(status, headers, body)
        }
    }
}
