...
impl StartStreamProcessorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_stream_processor::StartStreamProcessorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_stream_processor::StartStreamProcessorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_stream_processor::StartStreamProcessorOutput, crate::operation::start_stream_processor::StartStreamProcessorError, Self> {
