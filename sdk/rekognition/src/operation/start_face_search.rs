...
impl StartFaceSearch {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Rekognition", "StartFaceSearch", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Rekognition.StartFaceSearch",
                "rpc.service" = "Rekognition",
                "rpc.method" = "StartFaceSearch",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartFaceSearch")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartFaceSearch")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartFaceSearchTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartFaceSearchTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartFaceSearchTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartFaceSearchInput>() else {
        ...
        if requested.should_capture("CollectionId") {
            if let ::std::option::Option::Some(value) = input.collection_id.as_deref() {
                captured.insert("CollectionId", value);
            }
        }
        if requested.should_capture("JobTag") {
            if let ::std::option::Option::Some(value) = input.job_tag.as_deref() {
                captured.insert("JobTag", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartFaceSearchResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_face_search::de_start_face_search_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_face_search::de_start_face_search_http_response(status, headers, body, _cfg)
        };
