...
impl StartFaceSearchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_face_search::StartFaceSearch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_face_search::ser_start_face_search_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartFaceSearch {
    type Output =
        ::std::result::Result<crate::operation::start_face_search::StartFaceSearchOutput, crate::operation::start_face_search::StartFaceSearchError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_face_search::de_start_face_search_http_response_with_props(status, headers, body)
        }
    }
}
