...
impl StartFaceSearchInput {
    /// Consumes the builder and constructs an Operation<[`StartFaceSearch`](crate::operation::start_face_search::StartFaceSearch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_face_search::StartFaceSearch, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_face_search::StartFaceSearchInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_face_search::ser_start_face_search_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_face_search::StartFaceSearch::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartFaceSearch {
                type Output = std::result::Result<crate::operation::start_face_search::StartFaceSearchOutput, crate::operation::start_face_search::StartFaceSearchError>;
