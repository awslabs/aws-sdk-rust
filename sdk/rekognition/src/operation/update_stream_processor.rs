...
impl UpdateStreamProcessorInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStreamProcessor`](crate::operation::update_stream_processor::UpdateStreamProcessor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_stream_processor::UpdateStreamProcessor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_stream_processor::UpdateStreamProcessorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_stream_processor::ser_update_stream_processor_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_stream_processor::UpdateStreamProcessor::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStreamProcessor {
                type Output = std::result::Result<crate::operation::update_stream_processor::UpdateStreamProcessorOutput, crate::operation::update_stream_processor::UpdateStreamProcessorError>;
