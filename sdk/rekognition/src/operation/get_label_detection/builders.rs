...
impl GetLabelDetectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_label_detection::GetLabelDetectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_label_detection::GetLabelDetectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_label_detection::GetLabelDetectionOutput, crate::operation::get_label_detection::GetLabelDetectionError, Self> {
