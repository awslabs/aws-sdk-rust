...
impl GetSegmentDetectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_segment_detection::ser_get_segment_detection_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_segment_detection::GetSegmentDetection::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_segment_detection::GetSegmentDetectionError
{
