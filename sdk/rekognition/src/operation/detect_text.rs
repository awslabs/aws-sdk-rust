...
impl DetectTextInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detect_text::DetectText, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_text::ser_detect_text_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectText {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_text::de_detect_text_http_response_with_props(status, headers, body)
        }
    }
}
