...
impl GetFaceLivenessSessionResultsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_face_liveness_session_results::GetFaceLivenessSessionResultsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
