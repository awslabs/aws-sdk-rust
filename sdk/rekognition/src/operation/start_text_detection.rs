...
/// Orchestration and serialization glue logic for `StartTextDetection`.
...
impl StartTextDetection {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::start_text_detection::StartTextDetectionInput,
                    ) -> ::std::result::Result<crate::operation::start_text_detection::StartTextDetectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_text_detection::StartTextDetectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_text_detection::StartTextDetectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_text_detection::StartTextDetectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartTextDetection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartTextDetection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartTextDetectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartTextDetectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartTextDetection")
...
.with_interceptor(StartTextDetectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_text_detection::StartTextDetectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_text_detection::StartTextDetectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_text_detection::StartTextDetectionError>::new());
...
#[derive(Debug)]
            struct StartTextDetectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartTextDetectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_text_detection::de_start_text_detection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_text_detection::de_start_text_detection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartTextDetectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartTextDetectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_text_detection::StartTextDetectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_text_detection::StartTextDetectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_text_detection::ser_start_text_detection_input(&input)?);
...
#[derive(Debug)]
            struct StartTextDetectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartTextDetectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartTextDetectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartTextDetectionInput>()
                        .ok_or("failed to downcast to StartTextDetectionInput")?;
...
pub enum StartTextDetectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartTextDetectionError) for what information is available for the error.")]
...
impl StartTextDetectionError {
    /// Creates the `StartTextDetectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartTextDetectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartTextDetectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_text_detection::StartTextDetectionError {
...
mod _start_text_detection_output;
