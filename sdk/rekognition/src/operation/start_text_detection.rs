...
impl StartTextDetectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_text_detection::ser_start_text_detection_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_text_detection::StartTextDetection::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_text_detection::StartTextDetectionError
{
