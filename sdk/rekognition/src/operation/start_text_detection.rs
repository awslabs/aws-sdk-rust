...
impl StartTextDetectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_text_detection::StartTextDetection,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_text_detection::ser_start_text_detection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTextDetection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_text_detection::de_start_text_detection_http_response_with_props(status, headers, body)
        }
    }
}
