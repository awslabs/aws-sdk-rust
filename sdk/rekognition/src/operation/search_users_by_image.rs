...
impl SearchUsersByImageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_users_by_image::ser_search_users_by_image_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_users_by_image::SearchUsersByImage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchUsersByImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_users_by_image::de_search_users_by_image_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_users_by_image::SearchUsersByImageError
{
