...
impl SearchUsersByImageInput {
    /// Consumes the builder and constructs an Operation<[`SearchUsersByImage`](crate::operation::search_users_by_image::SearchUsersByImage)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_users_by_image::SearchUsersByImage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchUsersByImage", "rekognition"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchUsersByImage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_users_by_image::de_search_users_by_image_http_response_with_props(status, headers, body)
        }
    }
}
