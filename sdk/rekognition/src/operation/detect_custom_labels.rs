...
impl DetectCustomLabels {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::detect_custom_labels::DetectCustomLabelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detect_custom_labels::DetectCustomLabelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectCustomLabels {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DetectCustomLabels");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DetectCustomLabelsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DetectCustomLabelsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectCustomLabels")
...
.with_interceptor(DetectCustomLabelsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::detect_custom_labels::DetectCustomLabelsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::detect_custom_labels::DetectCustomLabelsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::detect_custom_labels::DetectCustomLabelsError>::new());
...
#[derive(Debug)]
            struct DetectCustomLabelsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectCustomLabelsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_detect_custom_labels::de_detect_custom_labels_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_detect_custom_labels::de_detect_custom_labels_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DetectCustomLabelsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectCustomLabelsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::detect_custom_labels::DetectCustomLabelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_custom_labels::ser_detect_custom_labels_input(&input)?);
...
#[derive(Debug)]
            struct DetectCustomLabelsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectCustomLabelsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DetectCustomLabelsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DetectCustomLabelsInput>()
                        .ok_or("failed to downcast to DetectCustomLabelsInput")?;
...
pub enum DetectCustomLabelsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DetectCustomLabelsError) for what information is available for the error.")]
...
impl DetectCustomLabelsError {
    /// Creates the `DetectCustomLabelsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetectCustomLabelsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DetectCustomLabelsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::detect_custom_labels::DetectCustomLabelsError {
