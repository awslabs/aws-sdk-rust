...
impl DetectCustomLabelsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::detect_custom_labels::DetectCustomLabels, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_custom_labels::DetectCustomLabelsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detect_custom_labels::ser_detect_custom_labels_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::detect_custom_labels::DetectCustomLabels::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DetectCustomLabels {
                type Output = std::result::Result<crate::operation::detect_custom_labels::DetectCustomLabelsOutput, crate::operation::detect_custom_labels::DetectCustomLabelsError>;
