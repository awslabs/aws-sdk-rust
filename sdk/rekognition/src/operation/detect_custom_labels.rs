...
impl DetectCustomLabels {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Rekognition", "DetectCustomLabels", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Rekognition.DetectCustomLabels",
                "rpc.service" = "Rekognition",
                "rpc.method" = "DetectCustomLabels",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DetectCustomLabels {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DetectCustomLabelsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DetectCustomLabelsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DetectCustomLabels")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DetectCustomLabels")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DetectCustomLabelsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DetectCustomLabelsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DetectCustomLabelsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DetectCustomLabelsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DetectCustomLabelsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_detect_custom_labels::de_detect_custom_labels_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_detect_custom_labels::de_detect_custom_labels_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DetectCustomLabelsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::detect_custom_labels::DetectCustomLabelsInput>()
            .expect("correct type");
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_detect_custom_labels::ser_detect_custom_labels_input(&input)?);
