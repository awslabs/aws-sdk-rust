...
impl StartPersonTrackingInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_person_tracking::ser_start_person_tracking_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_person_tracking::StartPersonTracking::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::start_person_tracking::StartPersonTrackingError
{
