...
impl StartPersonTrackingInput {
    /// Consumes the builder and constructs an Operation<[`StartPersonTracking`](crate::operation::start_person_tracking::StartPersonTracking)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_person_tracking::StartPersonTracking, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_person_tracking::StartPersonTrackingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_person_tracking::ser_start_person_tracking_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_person_tracking::StartPersonTracking::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartPersonTracking {
                type Output = std::result::Result<crate::operation::start_person_tracking::StartPersonTrackingOutput, crate::operation::start_person_tracking::StartPersonTrackingError>;
