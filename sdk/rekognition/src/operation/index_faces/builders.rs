...
/// <ul>
/// <li>
/// <p>The number of faces detected exceeds the value of the <code>MaxFaces</code> request parameter.</p></li>
/// <li>
/// <p>The face is too small compared to the image dimensions.</p></li>
/// <li>
/// <p>The face is too blurry.</p></li>
/// <li>
/// <p>The image is too dark.</p></li>
/// <li>
/// <p>The face has an extreme pose.</p></li>
/// <li>
/// <p>The face doesn’t have enough detail to be suitable for face search.</p></li>
/// </ul>
...
/// <ul>
/// <li>
/// <p>The bounding box, <code>BoundingBox</code>, of the detected face.</p></li>
/// <li>
/// <p>A confidence value, <code>Confidence</code>, which indicates the confidence that the bounding box contains a face.</p></li>
/// <li>
/// <p>A face ID, <code>FaceId</code>, assigned by the service for each face that's detected and stored.</p></li>
/// <li>
/// <p>An image ID, <code>ImageId</code>, assigned by the service for the input image.</p></li>
/// </ul>
...
impl IndexFacesFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::index_faces::builders::IndexFacesInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::index_faces::IndexFacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::index_faces::IndexFacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::index_faces::IndexFaces::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::index_faces::IndexFacesOutput, crate::operation::index_faces::IndexFacesError, Self> {
