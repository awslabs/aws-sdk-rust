...
impl CompareFacesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::compare_faces::CompareFaces::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CompareFaces {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_compare_faces::de_compare_faces_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_compare_faces::de_compare_faces_http_response_with_props(
                status, headers, body,
            )
        }
    }
