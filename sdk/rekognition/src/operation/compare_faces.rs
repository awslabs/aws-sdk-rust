...
impl CompareFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::compare_faces::CompareFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_compare_faces::ser_compare_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CompareFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_compare_faces::de_compare_faces_http_response_with_props(status, headers, body)
        }
    }
}
