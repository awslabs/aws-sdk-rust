...
impl CreateCollectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_collection::CreateCollection, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_collection::ser_create_collection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCollection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_collection::de_create_collection_http_response_with_props(status, headers, body)
        }
    }
}
