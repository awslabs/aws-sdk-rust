...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDatasetEntries {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListDatasetEntries", "rekognition"));
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListDatasetEntriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_dataset_entries::ser_list_dataset_entries_input(&input)?);
