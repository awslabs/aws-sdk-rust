...
impl DetectLabelsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::detect_labels::DetectLabels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectLabels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_detect_labels::de_detect_labels_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_detect_labels::de_detect_labels_http_response_with_props(
                status, headers, body,
            )
        }
    }
