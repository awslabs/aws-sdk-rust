...
impl DetectLabelsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::detect_labels::DetectLabels, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_detect_labels::ser_detect_labels_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectLabels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_detect_labels::de_detect_labels_http_response_with_props(status, headers, body)
        }
    }
}
