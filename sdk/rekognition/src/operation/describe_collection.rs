...
impl DescribeCollectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_collection::ser_describe_collection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCollection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_collection::de_describe_collection_http_response_with_props(status, headers, body)
        }
    }
}
