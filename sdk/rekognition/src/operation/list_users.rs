...
impl ListUsers {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("rekognition", "ListUsers", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUsers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListUsers", "rekognition"));
...
impl ListUsersError {
    ...
    /// Returns `true` if the error kind is `ListUsersError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
    /// Returns `true` if the error kind is `ListUsersError::InvalidPaginationTokenException`.
    ...
    /// Returns `true` if the error kind is `ListUsersError::ProvisionedThroughputExceededException`.
