...
impl StopProjectVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_project_version::ser_stop_project_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopProjectVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_project_version::de_stop_project_version_http_response_with_props(status, headers, body)
        }
    }
}
