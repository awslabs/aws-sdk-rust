...
impl StopProjectVersionInput {
    /// Consumes the builder and constructs an Operation<[`StopProjectVersion`](crate::operation::stop_project_version::StopProjectVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_project_version::StopProjectVersion, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_project_version::StopProjectVersionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_project_version::StopProjectVersion::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StopProjectVersion {
                type Output = std::result::Result<crate::operation::stop_project_version::StopProjectVersionOutput, crate::operation::stop_project_version::StopProjectVersionError>;
