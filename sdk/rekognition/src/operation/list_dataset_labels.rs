...
impl ListDatasetLabelsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_dataset_labels::ser_list_dataset_labels_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDatasetLabels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_dataset_labels::de_list_dataset_labels_http_response_with_props(status, headers, body)
        }
    }
}
