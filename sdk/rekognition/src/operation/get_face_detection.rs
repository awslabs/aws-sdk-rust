...
impl GetFaceDetectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_face_detection::ser_get_face_detection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFaceDetection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_face_detection::de_get_face_detection_http_response_with_props(status, headers, body)
        }
    }
}
