...
impl RecognizeCelebritiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::recognize_celebrities::RecognizeCelebritiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::recognize_celebrities::RecognizeCelebritiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::recognize_celebrities::RecognizeCelebritiesOutput, crate::operation::recognize_celebrities::RecognizeCelebritiesError, Self> {
