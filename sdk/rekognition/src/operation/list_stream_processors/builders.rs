...
impl ListStreamProcessorsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_stream_processors::paginator::ListStreamProcessorsPaginator {
        crate::operation::list_stream_processors::paginator::ListStreamProcessorsPaginator::new(
            self.handle,
            self.inner,
        )
    }
