...
impl ListStreamProcessorsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_stream_processors::ListStreamProcessorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_stream_processors::ListStreamProcessorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_stream_processors::ListStreamProcessorsOutput, crate::operation::list_stream_processors::ListStreamProcessorsError, Self> {
