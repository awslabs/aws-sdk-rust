...
impl SearchFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_faces::SearchFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_faces::ser_search_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_faces::de_search_faces_http_response_with_props(status, headers, body)
        }
    }
}
