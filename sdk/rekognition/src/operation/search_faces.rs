...
impl SearchFacesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_faces::SearchFaces::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_faces::de_search_faces_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_faces::de_search_faces_http_response_with_props(
                status, headers, body,
            )
        }
    }
