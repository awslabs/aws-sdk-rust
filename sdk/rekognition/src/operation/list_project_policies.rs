...
impl ListProjectPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_project_policies::ListProjectPolicies,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProjectPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_project_policies::de_list_project_policies_http_response_with_props(status, headers, body)
        }
    }
}
