...
impl ListProjectPoliciesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_project_policies::ser_list_project_policies_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_project_policies::ListProjectPolicies::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_project_policies::ListProjectPoliciesError
{
