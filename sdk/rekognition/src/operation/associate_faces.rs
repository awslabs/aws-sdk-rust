...
impl AssociateFacesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_faces::AssociateFaces::new(),
        )
...
/// `ParseStrictResponse` impl for `AssociateFaces`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_faces::de_associate_faces_http_error(
                status, headers, body,
            )
        } else {
