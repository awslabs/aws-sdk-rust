...
impl StartStreamProcessorInput {
    /// Consumes the builder and constructs an Operation<[`StartStreamProcessor`](crate::operation::start_stream_processor::StartStreamProcessor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_stream_processor::StartStreamProcessor, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_stream_processor::StartStreamProcessorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_stream_processor::ser_start_stream_processor_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_stream_processor::StartStreamProcessor::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartStreamProcessor {
                type Output = std::result::Result<crate::operation::start_stream_processor::StartStreamProcessorOutput, crate::operation::start_stream_processor::StartStreamProcessorError>;
