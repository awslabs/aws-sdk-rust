...
impl StartStreamProcessorInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_stream_processor::ser_start_stream_processor_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_stream_processor::StartStreamProcessor::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::start_stream_processor::StartStreamProcessorError
{
