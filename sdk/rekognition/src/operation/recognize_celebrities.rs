    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Rekognition", "RecognizeCelebrities", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.method" = "RecognizeCelebrities",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RecognizeCelebrities {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RecognizeCelebrities")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RecognizeCelebrities")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RecognizeCelebritiesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_recognize_celebrities::de_recognize_celebrities_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_recognize_celebrities::de_recognize_celebrities_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RecognizeCelebritiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_recognize_celebrities::ser_recognize_celebrities_input(
            &input,
        )?);
