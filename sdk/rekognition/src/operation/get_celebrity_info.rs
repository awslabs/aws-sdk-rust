...
impl GetCelebrityInfo {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_celebrity_info::GetCelebrityInfoOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_celebrity_info::GetCelebrityInfoError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_celebrity_info::GetCelebrityInfoError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_celebrity_info::GetCelebrityInfoOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCelebrityInfo {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCelebrityInfo");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCelebrityInfoRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCelebrityInfoResponseDeserializer));
...
.with_interceptor(GetCelebrityInfoEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_celebrity_info::GetCelebrityInfoError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_celebrity_info::GetCelebrityInfoError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_celebrity_info::GetCelebrityInfoError>::new());
...
#[derive(Debug)]
            struct GetCelebrityInfoResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCelebrityInfoResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_celebrity_info::de_get_celebrity_info_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_celebrity_info::de_get_celebrity_info_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCelebrityInfoRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCelebrityInfoRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_celebrity_info::GetCelebrityInfoInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_celebrity_info::GetCelebrityInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_celebrity_info::ser_get_celebrity_info_input(&input)?);
...
#[derive(Debug)]
            struct GetCelebrityInfoEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCelebrityInfoEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCelebrityInfoEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCelebrityInfoInput>()
                        .ok_or("failed to downcast to GetCelebrityInfoInput")?;
...
pub enum GetCelebrityInfoError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCelebrityInfoError) for what information is available for the error.")]
...
impl GetCelebrityInfoError {
    /// Creates the `GetCelebrityInfoError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCelebrityInfoError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCelebrityInfoError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_celebrity_info::GetCelebrityInfoError {
...
mod _get_celebrity_info_output;
