...
impl UpdateDatasetEntriesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDatasetEntries`](crate::operation::update_dataset_entries::UpdateDatasetEntries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_dataset_entries::UpdateDatasetEntries, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_dataset_entries::UpdateDatasetEntriesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_dataset_entries::ser_update_dataset_entries_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_dataset_entries::UpdateDatasetEntries::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateDatasetEntries {
                type Output = std::result::Result<crate::operation::update_dataset_entries::UpdateDatasetEntriesOutput, crate::operation::update_dataset_entries::UpdateDatasetEntriesError>;
