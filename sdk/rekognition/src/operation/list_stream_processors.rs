...
impl ListStreamProcessorsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_stream_processors::ListStreamProcessors,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStreamProcessors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_stream_processors::de_list_stream_processors_http_response_with_props(status, headers, body)
        }
    }
}
