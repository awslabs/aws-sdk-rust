...
impl ListStreamProcessorsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_stream_processors::ser_list_stream_processors_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_stream_processors::ListStreamProcessors::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_stream_processors::ListStreamProcessorsError
{
