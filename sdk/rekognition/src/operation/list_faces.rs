...
impl ListFacesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_faces::ListFaces, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_faces::ser_list_faces_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_faces::de_list_faces_http_response_with_props(status, headers, body)
        }
    }
}
