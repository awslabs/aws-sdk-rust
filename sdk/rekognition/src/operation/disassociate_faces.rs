...
impl DisassociateFacesInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateFaces`](crate::operation::disassociate_faces::DisassociateFaces)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_faces::ser_disassociate_faces_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_faces::DisassociateFaces::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateFaces", "rekognition"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateFaces {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_faces::de_disassociate_faces_http_response_with_props(status, headers, body)
        }
    }
}
