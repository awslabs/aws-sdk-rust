...
impl CopyProjectVersionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_copy_project_version::ser_copy_project_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyProjectVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_copy_project_version::de_copy_project_version_http_response_with_props(status, headers, body)
        }
    }
}
