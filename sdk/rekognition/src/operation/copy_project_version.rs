...
impl CopyProjectVersion {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::copy_project_version::CopyProjectVersionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::copy_project_version::CopyProjectVersionOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Rekognition", "CopyProjectVersion", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Rekognition.CopyProjectVersion",
                "rpc.service" = "Rekognition",
                "rpc.method" = "CopyProjectVersion",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CopyProjectVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CopyProjectVersionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CopyProjectVersionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CopyProjectVersion")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CopyProjectVersion")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CopyProjectVersionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CopyProjectVersionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CopyProjectVersionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CopyProjectVersionInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SourceProjectArn") {
            if let ::std::option::Option::Some(value) = input.source_project_arn.as_deref() {
                captured.insert("SourceProjectArn", value);
            }
        }
        if requested.should_capture("SourceProjectVersionArn") {
            if let ::std::option::Option::Some(value) = input.source_project_version_arn.as_deref() {
                captured.insert("SourceProjectVersionArn", value);
            }
        }
        if requested.should_capture("DestinationProjectArn") {
            if let ::std::option::Option::Some(value) = input.destination_project_arn.as_deref() {
                captured.insert("DestinationProjectArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CopyProjectVersionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_copy_project_version::de_copy_project_version_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_copy_project_version::de_copy_project_version_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CopyProjectVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::copy_project_version::CopyProjectVersionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::copy_project_version::CopyProjectVersionInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_copy_project_version::ser_copy_project_version_input(&input)?);
