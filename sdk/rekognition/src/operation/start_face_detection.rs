...
impl StartFaceDetectionInput {
    /// Consumes the builder and constructs an Operation<[`StartFaceDetection`](crate::operation::start_face_detection::StartFaceDetection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_face_detection::StartFaceDetection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_face_detection::StartFaceDetectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_face_detection::ser_start_face_detection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_face_detection::StartFaceDetection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartFaceDetection {
                type Output = std::result::Result<crate::operation::start_face_detection::StartFaceDetectionOutput, crate::operation::start_face_detection::StartFaceDetectionError>;
