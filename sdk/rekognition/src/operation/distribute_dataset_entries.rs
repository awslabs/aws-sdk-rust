...
impl DistributeDatasetEntries {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DistributeDatasetEntries {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DistributeDatasetEntries");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DistributeDatasetEntriesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DistributeDatasetEntriesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DistributeDatasetEntries")
...
.with_interceptor(DistributeDatasetEntriesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError>::new());
...
#[derive(Debug)]
            struct DistributeDatasetEntriesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DistributeDatasetEntriesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_distribute_dataset_entries::de_distribute_dataset_entries_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_distribute_dataset_entries::de_distribute_dataset_entries_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DistributeDatasetEntriesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DistributeDatasetEntriesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::distribute_dataset_entries::DistributeDatasetEntriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_distribute_dataset_entries::ser_distribute_dataset_entries_input(&input)?);
...
#[derive(Debug)]
            struct DistributeDatasetEntriesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DistributeDatasetEntriesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DistributeDatasetEntriesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DistributeDatasetEntriesInput>()
                        .ok_or("failed to downcast to DistributeDatasetEntriesInput")?;
...
pub enum DistributeDatasetEntriesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DistributeDatasetEntriesError) for what information is available for the error.")]
...
impl DistributeDatasetEntriesError {
    /// Creates the `DistributeDatasetEntriesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DistributeDatasetEntriesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DistributeDatasetEntriesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError {
...
mod _distribute_dataset_entries_output;
