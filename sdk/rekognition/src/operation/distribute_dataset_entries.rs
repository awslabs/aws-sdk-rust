...
impl DistributeDatasetEntriesInput {
    /// Consumes the builder and constructs an Operation<[`DistributeDatasetEntries`](crate::operation::distribute_dataset_entries::DistributeDatasetEntries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::distribute_dataset_entries::DistributeDatasetEntries, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::distribute_dataset_entries::DistributeDatasetEntriesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_distribute_dataset_entries::ser_distribute_dataset_entries_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::distribute_dataset_entries::DistributeDatasetEntries::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DistributeDatasetEntries {
                type Output = std::result::Result<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesOutput, crate::operation::distribute_dataset_entries::DistributeDatasetEntriesError>;
