...
impl GetFaceSearchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_face_search::GetFaceSearch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_face_search::ser_get_face_search_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFaceSearch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_face_search::de_get_face_search_http_response_with_props(status, headers, body)
        }
    }
}
