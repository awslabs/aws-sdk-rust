...
impl DescribeStreamProcessorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_stream_processor::DescribeStreamProcessorInput, ::aws_smithy_types::error::operation::BuildError> {
