...
impl PutProjectPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_project_policy::PutProjectPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_project_policy::PutProjectPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_project_policy::PutProjectPolicyOutput, crate::operation::put_project_policy::PutProjectPolicyError, Self> {
