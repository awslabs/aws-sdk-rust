...
impl Builder {
    ...
    /// Set the retry_config for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_route53recoverycluster::config::{AsyncSleep, Sleep, Config};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_route53recoverycluster::config::{AsyncSleep, Sleep, Builder, Config};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Overrides the endpoint resolver to use when making requests.
                        ...
                        /// for `aws_sdk_route53recoverycluster`.
                        ///
                        /// # Examples
                        /// ```no_run
                        /// # fn wrapper() -> Result<(), aws_smithy_http::endpoint::error::InvalidEndpointError> {
                        /// use aws_sdk_route53recoverycluster::config::{Config, Endpoint, Region};
                        ///
