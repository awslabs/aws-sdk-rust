...
impl smithy_types::retry::ProvideErrorKind for GetRoutingControlStateError {
...
impl GetRoutingControlStateError {
    pub fn new(kind: GetRoutingControlStateErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for UpdateRoutingControlStateError {
    fn code(&self) -> Option<&str> {
...
impl UpdateRoutingControlStateError {
    pub fn new(kind: UpdateRoutingControlStateErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for UpdateRoutingControlStatesError {
    fn code(&self) -> Option<&str> {
...
impl UpdateRoutingControlStatesError {
    pub fn new(kind: UpdateRoutingControlStatesErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
