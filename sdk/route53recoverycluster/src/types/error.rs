...
pub use crate::types::error::_endpoint_temporarily_unavailable_exception::EndpointTemporarilyUnavailableException;
...
mod _endpoint_temporarily_unavailable_exception;
