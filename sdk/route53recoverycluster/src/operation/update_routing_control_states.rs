...
impl UpdateRoutingControlStatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_routing_control_states::UpdateRoutingControlStates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoutingControlStates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_routing_control_states::de_update_routing_control_states_http_response_with_props(
                status, headers, body,
            )
        }
    }
