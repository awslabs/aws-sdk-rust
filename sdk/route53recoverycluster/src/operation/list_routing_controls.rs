...
impl ListRoutingControlsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_routing_controls::ser_list_routing_controls_input(
            &self,
        )?);
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_routing_controls::ListRoutingControls::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListRoutingControls", "route53recoverycluster"),
            );
