...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_routing_control_state::GetRoutingControlStateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "EndpointTemporarilyUnavailableException" => {
            crate::operation::get_routing_control_state::GetRoutingControlStateError::EndpointTemporarilyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::get_routing_control_state_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_routing_control_state::GetRoutingControlStateError::unhandled)?
    })
}
