...
pub(crate) fn deser_structure_crate_error_endpoint_temporarily_unavailable_exception_json_err(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_get_routing_control_state(
    value: &[u8],
...
pub(crate) fn deser_operation_crate_operation_list_routing_controls(
    value: &[u8],
...
pub(crate) fn deser_list_com_amazonaws_route53recoverycluster_validation_exception_field_list<
    'a,
    I,
>(
...
#[allow(non_snake_case)]
pub(crate) fn deser_list_com_amazonaws_route53recoverycluster_routing_controls<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
...
pub(crate) fn deser_structure_crate_model_routing_control<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
