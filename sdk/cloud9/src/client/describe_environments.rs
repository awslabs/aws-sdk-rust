...
impl super::Client {
    ...
    ///   - [`environment_ids(impl Into<String>)`](crate::operation::describe_environments::builders::DescribeEnvironmentsFluentBuilder::environment_ids) / [`set_environment_ids(Option<Vec<String>>)`](crate::operation::describe_environments::builders::DescribeEnvironmentsFluentBuilder::set_environment_ids): <p>The IDs of individual environments to get information about.</p>
