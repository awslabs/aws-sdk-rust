...
impl super::Client {
    ...
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::update_environment_membership::builders::UpdateEnvironmentMembershipFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::update_environment_membership::builders::UpdateEnvironmentMembershipFluentBuilder::set_environment_id): <p>The ID of the environment for the environment member whose settings you want to change.</p>
    ///   - [`user_arn(impl ::std::convert::Into<String>)`](crate::operation::update_environment_membership::builders::UpdateEnvironmentMembershipFluentBuilder::user_arn) / [`set_user_arn(Option<String>)`](crate::operation::update_environment_membership::builders::UpdateEnvironmentMembershipFluentBuilder::set_user_arn): <p>The Amazon Resource Name (ARN) of the environment member whose settings you want to change.</p>
