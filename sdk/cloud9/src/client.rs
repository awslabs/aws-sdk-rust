    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CreateEnvironmentEc2Input`](crate::input::CreateEnvironmentEc2Input) with field(s):
    ///   - [`name(Option<String>)`](crate::input::CreateEnvironmentEc2Input::name): <p>The name of the environment to create.</p>  <p>This name is visible to other IAM users in the same Amazon Web Services account.</p>
    ///   - [`description(Option<String>)`](crate::input::CreateEnvironmentEc2Input::description): <p>The description of the environment to create.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateEnvironmentEc2Input::client_request_token): <p>A unique, case-sensitive string that helps Cloud9 to ensure this operation completes no more than one time.</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html">Client Tokens</a> in the <i>Amazon EC2 API Reference</i>.</p>
    ///   - [`instance_type(Option<String>)`](crate::input::CreateEnvironmentEc2Input::instance_type): <p>The type of instance to connect to the environment (for example, <code>t2.micro</code>).</p>
    ///   - [`subnet_id(Option<String>)`](crate::input::CreateEnvironmentEc2Input::subnet_id): <p>The ID of the subnet in Amazon VPC that Cloud9 will use to communicate with the Amazon EC2 instance.</p>
    ///   - [`image_id(Option<String>)`](crate::input::CreateEnvironmentEc2Input::image_id): <p>The identifier for the Amazon Machine Image (AMI) that's used to create the EC2 instance. To choose an AMI for the instance, you must specify a valid AMI alias or a valid Amazon EC2 Systems Manager (SSM) path.</p>  <p>The default AMI is used if the parameter isn't explicitly assigned a value in the request. Because Amazon Linux AMI has ended standard support as of December 31, 2020, we recommend you choose Amazon Linux 2, which includes long term support through 2023.</p>  <p> <b>AMI aliases </b> </p>  <ul>   <li> <p> <b>Amazon Linux (default): <code>amazonlinux-1-x86_64</code> </b> </p> </li>   <li> <p>Amazon Linux 2: <code>amazonlinux-2-x86_64</code> </p> </li>   <li> <p>Ubuntu 18.04: <code>ubuntu-18.04-x86_64</code> </p> </li>  </ul>  <p> <b>SSM paths</b> </p>  <ul>   <li> <p> <b>Amazon Linux (default): <code>resolve:ssm:/aws/service/cloud9/amis/amazonlinux-1-x86_64</code> </b> </p> </li>   <li> <p>Amazon Linux 2: <code>resolve:ssm:/aws/service/cloud9/amis/amazonlinux-2-x86_64</code> </p> </li>   <li> <p>Ubuntu 18.04: <code>resolve:ssm:/aws/service/cloud9/amis/ubuntu-18.04-x86_64</code> </p> </li>  </ul>
    ///   - [`automatic_stop_time_minutes(Option<i32>)`](crate::input::CreateEnvironmentEc2Input::automatic_stop_time_minutes): <p>The number of minutes until the running instance is shut down after the environment has last been used.</p>
    ///   - [`owner_arn(Option<String>)`](crate::input::CreateEnvironmentEc2Input::owner_arn): <p>The Amazon Resource Name (ARN) of the environment owner. This ARN can be the ARN of any IAM principal. If this value is not specified, the ARN defaults to this environment's creator.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateEnvironmentEc2Input::tags): <p>An array of key-value pairs that will be associated with the new Cloud9 development environment.</p>
    ///   - [`connection_type(Option<ConnectionType>)`](crate::input::CreateEnvironmentEc2Input::connection_type): <p>The connection type used for connecting to an Amazon EC2 environment. Valid values are <code>CONNECT_SSH</code> (default) and <code>CONNECT_SSM</code> (connected through Amazon EC2 Systems Manager).</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/cloud9/latest/user-guide/ec2-ssm.html">Accessing no-ingress EC2 instances with Amazon EC2 Systems Manager</a> in the <i>Cloud9 User Guide</i>.</p>
    ///   - [`dry_run(Option<bool>)`](crate::input::CreateEnvironmentEc2Input::dry_run): <p>Checks whether you have the required permissions for the action, without actually making the request, and provides an error response. If you have the required permissions, the error response is <code>DryRunOperation</code>. Otherwise, it is <code>UnauthorizedOperation</code>.</p>
    ...
    ///
    /// - Takes [`CreateEnvironmentMembershipInput`](crate::input::CreateEnvironmentMembershipInput) with field(s):
    ///   - [`environment_id(Option<String>)`](crate::input::CreateEnvironmentMembershipInput::environment_id): <p>The ID of the environment that contains the environment member you want to add.</p>
    ///   - [`user_arn(Option<String>)`](crate::input::CreateEnvironmentMembershipInput::user_arn): <p>The Amazon Resource Name (ARN) of the environment member you want to add.</p>
    ///   - [`permissions(Option<MemberPermissions>)`](crate::input::CreateEnvironmentMembershipInput::permissions): <p>The type of environment member permissions you want to associate with this environment member. Available values include:</p>  <ul>   <li> <p> <code>read-only</code>: Has read-only access to the environment.</p> </li>   <li> <p> <code>read-write</code>: Has read-write access to the environment.</p> </li>  </ul>
    ...
    ///   - [`environment_id(Option<String>)`](crate::input::DeleteEnvironmentInput::environment_id): <p>The ID of the environment to delete.</p>
    ...
    ///
    /// - Takes [`DeleteEnvironmentMembershipInput`](crate::input::DeleteEnvironmentMembershipInput) with field(s):
    ///   - [`environment_id(Option<String>)`](crate::input::DeleteEnvironmentMembershipInput::environment_id): <p>The ID of the environment to delete the environment member from.</p>
    ///   - [`user_arn(Option<String>)`](crate::input::DeleteEnvironmentMembershipInput::user_arn): <p>The Amazon Resource Name (ARN) of the environment member to delete from the environment.</p>
    ...
    ///
    /// - Takes [`DescribeEnvironmentMembershipsInput`](crate::input::DescribeEnvironmentMembershipsInput) with field(s):
    ///   - [`user_arn(Option<String>)`](crate::input::DescribeEnvironmentMembershipsInput::user_arn): <p>The Amazon Resource Name (ARN) of an individual environment member to get information about. If no value is specified, information about all environment members are returned.</p>
    ///   - [`environment_id(Option<String>)`](crate::input::DescribeEnvironmentMembershipsInput::environment_id): <p>The ID of the environment to get environment member information about.</p>
    ///   - [`permissions(Option<Vec<Permissions>>)`](crate::input::DescribeEnvironmentMembershipsInput::permissions): <p>The type of environment member permissions to get information about. Available values include:</p>  <ul>   <li> <p> <code>owner</code>: Owns the environment.</p> </li>   <li> <p> <code>read-only</code>: Has read-only access to the environment.</p> </li>   <li> <p> <code>read-write</code>: Has read-write access to the environment.</p> </li>  </ul>  <p>If no value is specified, information about all environment members are returned.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeEnvironmentMembershipsInput::next_token): <p>During a previous call, if there are more than 25 items in the list, only the first 25 items are returned, along with a unique string called a <i>next token</i>. To get the next batch of items in the list, call this operation again, adding the next token to the call. To get all of the items in the list, keep calling this operation with each subsequent next token that is returned, until no more next tokens are returned.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeEnvironmentMembershipsInput::max_results): <p>The maximum number of environment members to get information about.</p>
    ...
    ///   - [`environment_ids(Option<Vec<String>>)`](crate::input::DescribeEnvironmentsInput::environment_ids): <p>The IDs of individual environments to get information about.</p>
    ...
    ///
    /// - Takes [`DescribeEnvironmentStatusInput`](crate::input::DescribeEnvironmentStatusInput) with field(s):
    ///   - [`environment_id(Option<String>)`](crate::input::DescribeEnvironmentStatusInput::environment_id): <p>The ID of the environment to get status information about.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the Cloud9 development environment to get the tags for.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the Cloud9 development environment to add tags to.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>The list of tags to add to the given Cloud9 development environment.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the Cloud9 development environment to remove tags from.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>The tag names of the tags to remove from the given Cloud9 development environment.</p>
    ...
    ///   - [`environment_id(Option<String>)`](crate::input::UpdateEnvironmentInput::environment_id): <p>The ID of the environment to change settings.</p>
    ///   - [`name(Option<String>)`](crate::input::UpdateEnvironmentInput::name): <p>A replacement name for the environment.</p>
    ///   - [`description(Option<String>)`](crate::input::UpdateEnvironmentInput::description): <p>Any new or replacement description for the environment.</p>
    ...
    ///
    /// - Takes [`UpdateEnvironmentMembershipInput`](crate::input::UpdateEnvironmentMembershipInput) with field(s):
    ///   - [`environment_id(Option<String>)`](crate::input::UpdateEnvironmentMembershipInput::environment_id): <p>The ID of the environment for the environment member whose settings you want to change.</p>
    ///   - [`user_arn(Option<String>)`](crate::input::UpdateEnvironmentMembershipInput::user_arn): <p>The Amazon Resource Name (ARN) of the environment member whose settings you want to change.</p>
    ///   - [`permissions(Option<MemberPermissions>)`](crate::input::UpdateEnvironmentMembershipInput::permissions): <p>The replacement type of environment member permissions you want to associate with this environment member. Available values include:</p>  <ul>   <li> <p> <code>read-only</code>: Has read-only access to the environment.</p> </li>   <li> <p> <code>read-write</code>: Has read-write access to the environment.</p> </li>  </ul>
