...
impl DescribeEnvironmentStatusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_environment_status::DescribeEnvironmentStatus,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_environment_status::DescribeEnvironmentStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEnvironmentStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_environment_status::de_describe_environment_status_http_response_with_props(status, headers, body)
        }
    }
}
