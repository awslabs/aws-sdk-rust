...
impl UpdateEnvironmentMembershipFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_environment_membership::UpdateEnvironmentMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_environment_membership::UpdateEnvironmentMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_environment_membership::UpdateEnvironmentMembershipOutput, crate::operation::update_environment_membership::UpdateEnvironmentMembershipError, Self> {
