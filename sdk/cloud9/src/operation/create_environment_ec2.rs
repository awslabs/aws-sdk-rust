...
/// Orchestration and serialization glue logic for `CreateEnvironmentEC2`.
...
impl CreateEnvironmentEC2 {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_environment_ec2::CreateEnvironmentEc2Output, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_environment_ec2::CreateEnvironmentEC2Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_environment_ec2::CreateEnvironmentEC2Error>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_environment_ec2::CreateEnvironmentEc2Output>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateEnvironmentEC2 {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateEnvironmentEC2");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateEnvironmentEC2RequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateEnvironmentEC2ResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateEnvironmentEC2")
...
.with_interceptor(CreateEnvironmentEC2EndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_environment_ec2::CreateEnvironmentEC2Error>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_environment_ec2::CreateEnvironmentEC2Error>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_environment_ec2::CreateEnvironmentEC2Error>::new());
...
#[derive(Debug)]
            struct CreateEnvironmentEC2ResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateEnvironmentEC2ResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_environment_ec2::de_create_environment_ec2_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_environment_ec2::de_create_environment_ec2_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateEnvironmentEC2RequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateEnvironmentEC2RequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_environment_ec2::CreateEnvironmentEc2Input>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_environment_ec2::CreateEnvironmentEc2Input, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_environment_ec2::ser_create_environment_ec2_input(&input)?);
...
#[derive(Debug)]
            struct CreateEnvironmentEC2EndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateEnvironmentEC2EndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateEnvironmentEC2EndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateEnvironmentEc2Input>()
                        .ok_or("failed to downcast to CreateEnvironmentEc2Input")?;
...
pub enum CreateEnvironmentEC2Error {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateEnvironmentEC2Error) for what information is available for the error.")]
...
impl CreateEnvironmentEC2Error {
    /// Creates the `CreateEnvironmentEC2Error::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateEnvironmentEC2Error::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateEnvironmentEC2Error {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_environment_ec2::CreateEnvironmentEC2Error {
...
mod _create_environment_ec2_output;
