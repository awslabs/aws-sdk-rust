...
impl CreateEnvironmentEc2Input {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_environment_ec2::ser_create_environment_ec2_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_environment_ec2::CreateEnvironmentEC2::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_environment_ec2::CreateEnvironmentEC2Error
{
