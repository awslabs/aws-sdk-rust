...
impl DeleteEnvironmentMembershipInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_environment_membership::DeleteEnvironmentMembership::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEnvironmentMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_environment_membership::de_delete_environment_membership_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteEnvironmentMembershipError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_environment_membership::DeleteEnvironmentMembershipError
{
