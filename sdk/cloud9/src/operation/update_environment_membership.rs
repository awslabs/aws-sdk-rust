...
impl UpdateEnvironmentMembershipInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_environment_membership::UpdateEnvironmentMembership::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEnvironmentMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_environment_membership::de_update_environment_membership_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateEnvironmentMembershipError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_environment_membership::UpdateEnvironmentMembershipError
{
