...
pub struct EnvironmentMember  {
    ...
    /// </ul>
    #[doc(hidden)]pub permissions: std::option::Option<crate::model::Permissions>,
    ...
    #[doc(hidden)]pub last_access: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct Environment  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::EnvironmentType>,
    ...
    #[doc(hidden)]pub lifecycle: std::option::Option<crate::model::EnvironmentLifecycle>,
    ...
    /// <li> <p> <code>DISABLED_BY_DEFAULT</code> </p> </li> 
    /// </ul>
    #[doc(hidden)]pub managed_credentials_status: std::option::Option<crate::model::ManagedCredentialsStatus>,
}
impl Environment {
    /// <p>The ID of the environment.</p>
...
pub struct EnvironmentLifecycle  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::EnvironmentLifecycleStatus>,
    ...
    #[doc(hidden)]pub failure_resource: std::option::Option<std::string::String>,
}
