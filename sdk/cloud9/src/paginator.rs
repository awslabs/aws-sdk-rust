...
impl<C, M, R> DescribeEnvironmentMembershipsPaginator<C, M, R>
where
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.next_token = crate::lens::reflens_structure_crate_output_describe_environment_memberships_output_next_token(resp).cloned();
