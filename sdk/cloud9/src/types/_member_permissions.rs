...
impl ::std::convert::From<&str> for MemberPermissions {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => MemberPermissions::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for MemberPermissions {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(MemberPermissions::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for MemberPermissions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
