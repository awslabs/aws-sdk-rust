...
pub fn ser_create_environment_ec2_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateEnvironmentEc2Input) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
