...
impl super::Client {
    ...
    pub fn get_resource_metadata(
        &self,
    ) -> crate::operation::get_resource_metadata::builders::GetResourceMetadataFluentBuilder {
        crate::operation::get_resource_metadata::builders::GetResourceMetadataFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
