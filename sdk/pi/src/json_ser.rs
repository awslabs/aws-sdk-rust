...
pub fn serialize_structure_describe_dimension_keys_input(
    ...
    if let Some(var_7) = &input.group_by {
        ...
        crate::json_ser::serialize_structure_dimension_group(&mut object_8, var_7);
        object_8.finish();
    }
    if let Some(var_9) = &input.partition_by {
        let mut object_10 = object.key("PartitionBy").start_object();
        crate::json_ser::serialize_structure_dimension_group(&mut object_10, var_9);
        object_10.finish();
    }
...
pub fn serialize_structure_get_dimension_key_details_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_resource_metrics_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_28 in var_26 {
            {
                ...
                crate::json_ser::serialize_structure_metric_query(&mut object_29, item_28);
                object_29.finish();
            }
        }
        array_27.finish();
...
pub fn serialize_structure_dimension_group(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_metric_query(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_41) = &input.group_by {
        ...
        crate::json_ser::serialize_structure_dimension_group(&mut object_42, var_41);
        object_42.finish();
    }
