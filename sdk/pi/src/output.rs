...
pub struct ListAvailableResourceMetricsOutput  {
    ...
    #[doc(hidden)]pub metrics: std::option::Option<std::vec::Vec<crate::model::ResponseResourceMetric>>,
...
pub mod list_available_resource_metrics_output {
    ...
    impl Builder {
        ...
        /// <p>An array of metrics available to query. Each array element contains the full name, description, and unit of the metric. </p>
        pub fn set_metrics(mut self, input: std::option::Option<std::vec::Vec<crate::model::ResponseResourceMetric>>) -> Self {
...
pub struct ListAvailableResourceDimensionsOutput  {
    ...
    #[doc(hidden)]pub metric_dimensions: std::option::Option<std::vec::Vec<crate::model::MetricDimensionGroups>>,
...
pub mod list_available_resource_dimensions_output {
    ...
    impl Builder {
        ...
        /// <p>The dimension information returned for requested metric types.</p>
        pub fn set_metric_dimensions(mut self, input: std::option::Option<std::vec::Vec<crate::model::MetricDimensionGroups>>) -> Self {
...
pub struct GetResourceMetricsOutput  {
    ...
    #[doc(hidden)]pub aligned_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub aligned_end_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub metric_list: std::option::Option<std::vec::Vec<crate::model::MetricKeyDataPoints>>,
    /// <p>An optional pagination token provided by a previous request. If this parameter is specified, the response includes only records beyond the token, up to the value specified by <code>MaxRecords</code>. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod get_resource_metrics_output {
    ...
    impl Builder {
        ...
        /// <p>An array of metric results, where each array element contains all of the data points for a particular dimension.</p>
        pub fn set_metric_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::MetricKeyDataPoints>>) -> Self {
...
pub struct GetResourceMetadataOutput  {
    ...
    #[doc(hidden)]pub features: std::option::Option<std::collections::HashMap<std::string::String, crate::model::FeatureMetadata>>,
}
impl GetResourceMetadataOutput {
    ...
    /// <p>The metadata for different features. For example, the metadata might indicate that a feature is turned on or off on a specific DB instance.</p>
    pub fn features(&self) -> std::option::Option<& std::collections::HashMap<std::string::String, crate::model::FeatureMetadata>> {
...
pub mod get_resource_metadata_output {
    ...
    impl Builder {
        ...
        ///
        /// <p>The metadata for different features. For example, the metadata might indicate that a feature is turned on or off on a specific DB instance.</p>
        pub fn features(mut self, k: impl Into<std::string::String>, v: crate::model::FeatureMetadata) -> Self {
...
pub struct GetDimensionKeyDetailsOutput  {
    ...
    #[doc(hidden)]pub dimensions: std::option::Option<std::vec::Vec<crate::model::DimensionKeyDetail>>,
}
...
pub struct DescribeDimensionKeysOutput  {
    ...
    #[doc(hidden)]pub partition_keys: std::option::Option<std::vec::Vec<crate::model::ResponsePartitionKey>>,
    /// <p>The dimension keys that were requested.</p>
    #[doc(hidden)]pub keys: std::option::Option<std::vec::Vec<crate::model::DimensionKeyDescription>>,
    /// <p>A pagination token that indicates the response didn’t return all available records because <code>MaxRecords</code> was specified in the previous request. To get the remaining records, specify <code>NextToken</code> in a separate request with this value. </p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub mod describe_dimension_keys_output {
    ...
    impl Builder {
        ...
        /// <p>If <code>PartitionBy</code> was present in the request, <code>PartitionKeys</code> contains the breakdown of dimension keys by the specified partitions. </p>
        pub fn set_partition_keys(mut self, input: std::option::Option<std::vec::Vec<crate::model::ResponsePartitionKey>>) -> Self {
        ...
        /// <p>The dimension keys that were requested.</p>
        pub fn set_keys(mut self, input: std::option::Option<std::vec::Vec<crate::model::DimensionKeyDescription>>) -> Self {
