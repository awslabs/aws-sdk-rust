...
pub struct GetResourceMetricsOutput {
    ...
    pub aligned_start_time: std::option::Option<smithy_types::Instant>,
    ...
    pub aligned_end_time: std::option::Option<smithy_types::Instant>,
...
pub mod get_resource_metrics_output {
    ...
    pub struct Builder {
        pub(crate) aligned_start_time: std::option::Option<smithy_types::Instant>,
        pub(crate) aligned_end_time: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// specified by <code>PeriodInSeconds</code>). <code>AlignedStartTime</code> will be less than or
        /// equal to the value of the user-specified <code>StartTime</code>.</p>
        pub fn aligned_start_time(mut self, input: smithy_types::Instant) -> Self {
        ...
        /// specified by <code>PeriodInSeconds</code>). <code>AlignedEndTime</code> will be greater than
        /// or equal to the value of the user-specified <code>Endtime</code>.</p>
        pub fn aligned_end_time(mut self, input: smithy_types::Instant) -> Self {
