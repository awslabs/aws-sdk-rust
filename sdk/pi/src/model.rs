...
pub struct MetricDimensionGroups  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::DimensionGroupDetail>>,
}
...
pub mod metric_dimension_groups {
    ...
    impl Builder {
        ...
        /// <p>The available dimension groups for a metric type.</p>
        pub fn set_groups(mut self, input: std::option::Option<std::vec::Vec<crate::model::DimensionGroupDetail>>) -> Self {
...
pub struct DimensionGroupDetail  {
    ...
    #[doc(hidden)]pub dimensions: std::option::Option<std::vec::Vec<crate::model::DimensionDetail>>,
}
...
pub mod dimension_group_detail {
    ...
    impl Builder {
        ...
        /// <p>The dimensions within a dimension group.</p>
        pub fn set_dimensions(mut self, input: std::option::Option<std::vec::Vec<crate::model::DimensionDetail>>) -> Self {
...
pub struct MetricKeyDataPoints  {
    ...
    #[doc(hidden)]pub key: std::option::Option<crate::model::ResponseResourceMetricKey>,
    /// <p>An array of timestamp-value pairs, representing measurements over a period of time.</p>
    #[doc(hidden)]pub data_points: std::option::Option<std::vec::Vec<crate::model::DataPoint>>,
}
...
pub mod metric_key_data_points {
    ...
    impl Builder {
        ...
        /// <p>The dimensions to which the data points apply.</p>
        pub fn set_key(mut self, input: std::option::Option<crate::model::ResponseResourceMetricKey>) -> Self {
            self.key = input; self
        }
        ...
        /// <p>An array of timestamp-value pairs, representing measurements over a period of time.</p>
        pub fn set_data_points(mut self, input: std::option::Option<std::vec::Vec<crate::model::DataPoint>>) -> Self {
...
pub struct MetricQuery  {
    ...
    #[doc(hidden)]pub group_by: std::option::Option<crate::model::DimensionGroup>,
    ...
    /// </ul>
    #[doc(hidden)]pub filter: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl MetricQuery {
    /// <p>The name of a Performance Insights metric to be measured.</p> 
    /// <p>Valid values for <code>Metric</code> are:</p> 
...
pub mod metric_query {
    ...
    impl Builder {
        ...
        /// <p>A specification for how to aggregate the data points from a query result. You must specify a valid dimension group. Performance Insights will return all of the dimensions within that group, unless you provide the names of specific dimensions within that group. You can also request that Performance Insights return a limited number of values for a dimension.</p>
        pub fn set_group_by(mut self, input: std::option::Option<crate::model::DimensionGroup>) -> Self {
...
pub struct DimensionGroup  {
    ...
    /// </ul>
    #[doc(hidden)]pub dimensions: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct DimensionKeyDetail  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::DetailStatus>,
}
...
pub mod dimension_key_detail {
    ...
    impl Builder {
        ...
        /// <li> <p> <code>UNAVAILABLE</code> - The dimension detail data could not be collected successfully.</p> </li> 
        /// </ul>
        pub fn set_status(mut self, input: std::option::Option<crate::model::DetailStatus>) -> Self {
            self.status = input; self
        }
...
pub struct DimensionKeyDescription  {
    ...
    #[doc(hidden)]pub total: std::option::Option<f64>,
    /// <p>A map that contains the value for each additional metric.</p>
    #[doc(hidden)]pub additional_metrics: std::option::Option<std::collections::HashMap<std::string::String, f64>>,
    /// <p>If <code>PartitionBy</code> was specified, <code>PartitionKeys</code> contains the dimensions that were.</p>
    #[doc(hidden)]pub partitions: std::option::Option<std::vec::Vec<f64>>,
}
