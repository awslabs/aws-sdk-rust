...
pub fn ser_get_resource_metrics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetResourceMetricsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
