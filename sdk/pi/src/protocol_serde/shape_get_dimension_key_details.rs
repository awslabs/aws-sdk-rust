...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_dimension_key_details::GetDimensionKeyDetailsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_dimension_key_details::de_get_dimension_key_details(_response_body, output)
            .map_err(crate::operation::get_dimension_key_details::GetDimensionKeyDetailsError::unhandled)?;
