...
pub fn ser_describe_dimension_keys_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeDimensionKeysInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
