...
pub fn ser_list_available_resource_dimensions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAvailableResourceDimensionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
