...
pub fn ser_dimension_group(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DimensionGroup) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
