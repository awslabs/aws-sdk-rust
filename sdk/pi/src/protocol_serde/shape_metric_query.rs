...
pub fn ser_metric_query(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricQuery) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
