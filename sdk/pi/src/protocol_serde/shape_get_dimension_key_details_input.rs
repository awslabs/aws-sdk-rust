...
pub fn ser_get_dimension_key_details_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_dimension_key_details::GetDimensionKeyDetailsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
