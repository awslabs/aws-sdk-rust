...
pub fn ser_list_available_resource_metrics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAvailableResourceMetricsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
