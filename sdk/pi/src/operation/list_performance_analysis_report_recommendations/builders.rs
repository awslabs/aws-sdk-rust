...
pub use crate::operation::list_performance_analysis_report_recommendations::_list_performance_analysis_report_recommendations_input::ListPerformanceAnalysisReportRecommendationsInputBuilder;

pub use crate::operation::list_performance_analysis_report_recommendations::_list_performance_analysis_report_recommendations_output::ListPerformanceAnalysisReportRecommendationsOutputBuilder;

impl crate::operation::list_performance_analysis_report_recommendations::builders::ListPerformanceAnalysisReportRecommendationsInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_performance_analysis_report_recommendations();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListPerformanceAnalysisReportRecommendations`.
///
/// <p>Retrieves recommendations for a performance analysis report.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct ListPerformanceAnalysisReportRecommendationsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_performance_analysis_report_recommendations::builders::ListPerformanceAnalysisReportRecommendationsInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_performance_analysis_report_recommendations::ListPerformanceAnalysisReportRecommendationsOutput,
        crate::operation::list_performance_analysis_report_recommendations::ListPerformanceAnalysisReportRecommendationsError,
    > for ListPerformanceAnalysisReportRecommendationsFluentBuilder
{
    fn send(
        self,
...
impl ListPerformanceAnalysisReportRecommendationsFluentBuilder {
    /// Creates a new `ListPerformanceAnalysisReportRecommendationsFluentBuilder`.
    ...
    /// Access the ListPerformanceAnalysisReportRecommendations as a reference.
    pub fn as_input(
        &self,
    ...
    > {
        ...
        crate::operation::list_performance_analysis_report_recommendations::ListPerformanceAnalysisReportRecommendations::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_performance_analysis_report_recommendations::paginator::ListPerformanceAnalysisReportRecommendationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_performance_analysis_report_recommendations::paginator::ListPerformanceAnalysisReportRecommendationsPaginator {
        crate::operation::list_performance_analysis_report_recommendations::paginator::ListPerformanceAnalysisReportRecommendationsPaginator::new(
            self.handle,
            self.inner,
        )
    }
