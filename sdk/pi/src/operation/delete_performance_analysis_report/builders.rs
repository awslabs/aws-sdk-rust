...
impl DeletePerformanceAnalysisReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_performance_analysis_report::DeletePerformanceAnalysisReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_performance_analysis_report::DeletePerformanceAnalysisReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_performance_analysis_report::DeletePerformanceAnalysisReportOutput, crate::operation::delete_performance_analysis_report::DeletePerformanceAnalysisReportError, Self> {
