...
impl GetResourceMetadataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_resource_metadata::GetResourceMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resource_metadata::GetResourceMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_resource_metadata::GetResourceMetadataOutput, crate::operation::get_resource_metadata::GetResourceMetadataError, Self> {
