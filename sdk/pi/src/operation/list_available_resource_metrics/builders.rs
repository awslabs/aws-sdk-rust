...
impl crate::operation::list_available_resource_metrics::builders::ListAvailableResourceMetricsInputBuilder {
...
impl ListAvailableResourceMetricsFluentBuilder {
    /// Creates a new `ListAvailableResourceMetricsFluentBuilder`.
