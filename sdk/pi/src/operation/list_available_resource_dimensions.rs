...
impl ListAvailableResourceDimensionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_available_resource_dimensions::ListAvailableResourceDimensions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableResourceDimensions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_resource_dimensions::de_list_available_resource_dimensions_http_response_with_props(
                status, headers, body,
            )
        }
    }
