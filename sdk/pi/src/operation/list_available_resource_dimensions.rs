...
impl ListAvailableResourceDimensionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_available_resource_dimensions::ListAvailableResourceDimensions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableResourceDimensions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_resource_dimensions::de_list_available_resource_dimensions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListAvailableResourceDimensionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_available_resource_dimensions::ListAvailableResourceDimensionsError
{
