...
impl GetResourceMetadataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_resource_metadata::ser_get_resource_metadata_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_metadata::GetResourceMetadata::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_resource_metadata::de_get_resource_metadata_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_resource_metadata::GetResourceMetadataError
{
