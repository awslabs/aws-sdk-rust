...
impl GetPerformanceAnalysisReportFluentBuilder {
    /// Creates a new `GetPerformanceAnalysisReport`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_performance_analysis_report::GetPerformanceAnalysisReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_performance_analysis_report::GetPerformanceAnalysisReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_performance_analysis_report::GetPerformanceAnalysisReportOutput, crate::operation::get_performance_analysis_report::GetPerformanceAnalysisReportError, Self> {
