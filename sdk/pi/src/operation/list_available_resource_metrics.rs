...
impl ListAvailableResourceMetricsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_available_resource_metrics::ListAvailableResourceMetrics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableResourceMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_resource_metrics::de_list_available_resource_metrics_http_response_with_props(
                status, headers, body,
            )
        }
    }
