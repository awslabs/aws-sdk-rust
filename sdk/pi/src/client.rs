...
{
    pub fn describe_dimension_keys(&self) -> fluent_builders::DescribeDimensionKeys<C> {
        fluent_builders::DescribeDimensionKeys::new(self.handle.clone())
    }
    pub fn get_dimension_key_details(&self) -> fluent_builders::GetDimensionKeyDetails<C> {
        fluent_builders::GetDimensionKeyDetails::new(self.handle.clone())
    }
    pub fn get_resource_metrics(&self) -> fluent_builders::GetResourceMetrics<C> {
        fluent_builders::GetResourceMetrics::new(self.handle.clone())
    }
}
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct DescribeDimensionKeys<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_dimension_keys_input::Builder,
    }
    impl<C> DescribeDimensionKeys<C> {
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetDimensionKeyDetails<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_dimension_key_details_input::Builder,
    }
    impl<C> GetDimensionKeyDetails<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn group_identifier(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.group_identifier(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetResourceMetrics<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_resource_metrics_input::Builder,
    }
    impl<C> GetResourceMetrics<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
