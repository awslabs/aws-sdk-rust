...
pub(crate) fn de_speke_key_provider<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SpekeKeyProvider>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_speke_key_provider(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SpekeKeyProvider) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
