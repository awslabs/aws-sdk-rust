...
pub fn de_configure_logs_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::configure_logs::ConfigureLogsOutput, crate::operation::configure_logs::ConfigureLogsError> {
    #[allow(unused_mut)]
...
pub fn de_configure_logs_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_configure_logs::de_configure_logs(_response_body, output)
            .map_err(crate::operation::configure_logs::ConfigureLogsError::unhandled)?;
...
) -> Result<crate::operation::configure_logs::builders::ConfigureLogsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
