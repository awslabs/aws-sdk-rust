...
pub fn ser_dash_manifest(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashManifest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_dash_manifest<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DashManifest>, aws_smithy_json::deserialize::error::DeserializeError>
