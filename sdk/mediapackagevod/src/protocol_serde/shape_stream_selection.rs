...
pub(crate) fn de_stream_selection<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::StreamSelection>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "streamOrder" => {
                            builder = builder.set_stream_order(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::StreamOrder::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
