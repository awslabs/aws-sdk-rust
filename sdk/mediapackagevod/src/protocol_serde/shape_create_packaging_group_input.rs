...
pub fn ser_create_packaging_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePackagingGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
