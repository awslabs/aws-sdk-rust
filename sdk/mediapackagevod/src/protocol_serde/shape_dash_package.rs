...
pub(crate) fn de_dash_package<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DashPackage>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_dash_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashPackage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
