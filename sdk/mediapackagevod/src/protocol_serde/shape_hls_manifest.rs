...
pub fn ser_hls_manifest(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsManifest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_hls_manifest<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HlsManifest>, aws_smithy_json::deserialize::error::DeserializeError>
