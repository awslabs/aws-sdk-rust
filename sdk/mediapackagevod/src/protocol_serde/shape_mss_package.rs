                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "mssManifests" => {
                                builder = builder.set_mss_manifests(
                                    crate::protocol_serde::shape_list_of_mss_manifest::de_list_of_mss_manifest(tokens)?
                                );
                            }
...
pub fn ser_mss_package(
    ...
    if let Some(var_7) = &input.segment_duration_seconds {
        object.key("segmentDurationSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    Ok(())
}
