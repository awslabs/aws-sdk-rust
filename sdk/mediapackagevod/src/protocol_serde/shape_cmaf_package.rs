...
pub fn ser_cmaf_package(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CmafPackage) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
