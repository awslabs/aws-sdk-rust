...
pub struct Authorization  {
    ...
    #[doc(hidden)]pub cdn_identifier_secret: std::option::Option<std::string::String>,
    /// The Amazon Resource Name (ARN) for the IAM role that allows MediaPackage to communicate with AWS Secrets Manager.
    #[doc(hidden)]pub secrets_role_arn: std::option::Option<std::string::String>,
}
impl Authorization {
    /// The Amazon Resource Name (ARN) for the secret in AWS Secrets Manager that is used for CDN authorization.
...
pub struct MssPackage  {
    ...
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::MssEncryption>,
    /// A list of MSS manifest configurations.
    #[doc(hidden)]pub mss_manifests: std::option::Option<std::vec::Vec<crate::model::MssManifest>>,
    /// The duration (in seconds) of each segment.
    #[doc(hidden)]pub segment_duration_seconds: i32,
}
impl MssPackage {
    /// A Microsoft Smooth Streaming (MSS) encryption configuration.
...
pub mod mss_package {
    ...
    impl Builder {
        ...
        /// A list of MSS manifest configurations.
        pub fn set_mss_manifests(mut self, input: std::option::Option<std::vec::Vec<crate::model::MssManifest>>) -> Self {
...
pub struct MssManifest  {
    ...
    #[doc(hidden)]pub stream_selection: std::option::Option<crate::model::StreamSelection>,
}
impl MssManifest {
    /// An optional string to include in the name of the manifest.
...
pub struct StreamSelection  {
    ...
    #[doc(hidden)]pub max_video_bits_per_second: i32,
    /// The minimum video bitrate (bps) to include in output.
    #[doc(hidden)]pub min_video_bits_per_second: i32,
    /// A directive that determines the order of streams in the output.
    #[doc(hidden)]pub stream_order: std::option::Option<crate::model::StreamOrder>,
}
...
pub struct MssEncryption  {
    ...
    #[doc(hidden)]pub speke_key_provider: std::option::Option<crate::model::SpekeKeyProvider>,
}
impl MssEncryption {
    /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
...
pub struct SpekeKeyProvider  {
    ...
    #[doc(hidden)]pub system_ids: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct HlsPackage  {
    ...
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::HlsEncryption>,
    /// A list of HLS manifest configurations.
    #[doc(hidden)]pub hls_manifests: std::option::Option<std::vec::Vec<crate::model::HlsManifest>>,
    /// When enabled, MediaPackage passes through digital video broadcasting (DVB) subtitles into the output.
    #[doc(hidden)]pub include_dvb_subtitles: bool,
    /// Duration (in seconds) of each fragment. Actual fragments will be rounded to the nearest multiple of the source fragment duration.
    #[doc(hidden)]pub segment_duration_seconds: i32,
    /// When enabled, audio streams will be placed in rendition groups in the output.
    #[doc(hidden)]pub use_audio_rendition_group: bool,
}
impl HlsPackage {
    /// An HTTP Live Streaming (HLS) encryption configuration.
...
pub struct HlsManifest  {
    ...
    #[doc(hidden)]pub ad_markers: std::option::Option<crate::model::AdMarkers>,
    /// When enabled, an I-Frame only stream will be included in the output.
    #[doc(hidden)]pub include_iframe_only_stream: bool,
    /// An optional string to include in the name of the manifest.
    #[doc(hidden)]pub manifest_name: std::option::Option<std::string::String>,
    /// The interval (in seconds) between each EXT-X-PROGRAM-DATE-TIME tag inserted into manifests. Additionally, when an interval is specified ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content. If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be inserted into manifests and no ID3Timed Metadata messages will be generated. Note that irrespective of this parameter, if any ID3 Timed Metadata is found in HTTP Live Streaming (HLS) input, it will be passed through to HLS output.
    #[doc(hidden)]pub program_date_time_interval_seconds: i32,
    /// When enabled, the EXT-X-KEY tag will be repeated in output manifests.
    #[doc(hidden)]pub repeat_ext_x_key: bool,
    /// A StreamSelection configuration.
    #[doc(hidden)]pub stream_selection: std::option::Option<crate::model::StreamSelection>,
}
impl HlsManifest {
...
impl  std::fmt::Debug for HlsManifest  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("include_iframe_only_stream", &self.include_iframe_only_stream);
        formatter.field("manifest_name", &self.manifest_name);
        formatter.field("program_date_time_interval_seconds", &self.program_date_time_interval_seconds);
...
pub struct HlsEncryption  {
    ...
    #[doc(hidden)]pub constant_initialization_vector: std::option::Option<std::string::String>,
    /// The encryption method to use.
    #[doc(hidden)]pub encryption_method: std::option::Option<crate::model::EncryptionMethod>,
    /// A configuration for accessing an external Secure Packager and Encoder Key Exchange (SPEKE) service that will provide encryption keys.
    #[doc(hidden)]pub speke_key_provider: std::option::Option<crate::model::SpekeKeyProvider>,
}
impl HlsEncryption {
...
impl  std::fmt::Debug for HlsEncryption  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("constant_initialization_vector", &self.constant_initialization_vector);
...
pub struct DashPackage  {
    ...
    #[doc(hidden)]pub dash_manifests: std::option::Option<std::vec::Vec<crate::model::DashManifest>>,
    /// A Dynamic Adaptive Streaming over HTTP (DASH) encryption configuration.
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::DashEncryption>,
    /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
    #[doc(hidden)]pub include_encoder_configuration_in_segments: bool,
    /// A list of triggers that controls when the outgoing Dynamic Adaptive Streaming over HTTP (DASH) Media Presentation Description (MPD) will be partitioned into multiple periods. If empty, the content will not be partitioned into more than one period. If the list contains "ADS", new periods will be created where the Asset contains SCTE-35 ad markers.
    #[doc(hidden)]pub period_triggers: std::option::Option<std::vec::Vec<crate::model::PeriodTriggersElement>>,
    /// Duration (in seconds) of each segment. Actual segments will be rounded to the nearest multiple of the source segment duration.
    #[doc(hidden)]pub segment_duration_seconds: i32,
    /// Determines the type of SegmentTemplate included in the Media Presentation Description (MPD). When set to NUMBER_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Number$ media URLs. When set to TIME_WITH_TIMELINE, a full timeline is presented in each SegmentTemplate, with $Time$ media URLs. When set to NUMBER_WITH_DURATION, only a duration is included in each SegmentTemplate, with $Number$ media URLs.
    #[doc(hidden)]pub segment_template_format: std::option::Option<crate::model::SegmentTemplateFormat>,
}
impl DashPackage {
    /// A list of DASH manifest configurations.
...
impl  std::fmt::Debug for DashPackage  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("encryption", &self.encryption);
        formatter.field("include_encoder_configuration_in_segments", &self.include_encoder_configuration_in_segments);
...
pub mod dash_package {
    ...
    impl Builder {
        ...
        /// A list of DASH manifest configurations.
        pub fn set_dash_manifests(mut self, input: std::option::Option<std::vec::Vec<crate::model::DashManifest>>) -> Self {
...
pub struct DashManifest  {
    ...
    #[doc(hidden)]pub manifest_layout: std::option::Option<crate::model::ManifestLayout>,
    /// An optional string to include in the name of the manifest.
    #[doc(hidden)]pub manifest_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub scte_markers_source: std::option::Option<crate::model::ScteMarkersSource>,
    /// A StreamSelection configuration.
    #[doc(hidden)]pub stream_selection: std::option::Option<crate::model::StreamSelection>,
}
impl DashManifest {
...
pub mod dash_manifest {
    ...
    impl Builder {
        ...
        /// The source of scte markers used. When set to SEGMENTS, the scte markers are sourced from the segments of the ingested content. When set to MANIFEST, the scte markers are sourced from the manifest of the ingested content.
        pub fn set_scte_markers_source(mut self, input: std::option::Option<crate::model::ScteMarkersSource>) -> Self {
...
pub struct CmafPackage  {
    ...
    #[doc(hidden)]pub encryption: std::option::Option<crate::model::CmafEncryption>,
    /// A list of HLS manifest configurations.
    #[doc(hidden)]pub hls_manifests: std::option::Option<std::vec::Vec<crate::model::HlsManifest>>,
    /// When includeEncoderConfigurationInSegments is set to true, MediaPackage places your encoder's Sequence Parameter Set (SPS), Picture Parameter Set (PPS), and Video Parameter Set (VPS) metadata in every video segment instead of in the init fragment. This lets you use different SPS/PPS/VPS settings for your assets during content playback.
    #[doc(hidden)]pub include_encoder_configuration_in_segments: bool,
...
pub struct EgressEndpoint  {
    ...
    #[doc(hidden)]pub packaging_configuration_id: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for EgressEndpoint  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("packaging_configuration_id", &self.packaging_configuration_id);
