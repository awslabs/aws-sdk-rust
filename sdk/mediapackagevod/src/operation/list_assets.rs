...
impl ListAssets {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaPackage Vod", "ListAssets", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.packaging_group_id {
                    {
                        query.push_kv("packagingGroupId", &::aws_smithy_http::query::fmt_string(inner_3));
                    }
                }
                ::std::result::Result::Ok(())
            }
