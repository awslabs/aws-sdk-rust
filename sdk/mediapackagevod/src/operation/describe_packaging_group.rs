    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/packaging_groups/{Id}", Id = id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_packaging_group::DescribePackagingGroup::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_packaging_group::DescribePackagingGroupError
{
