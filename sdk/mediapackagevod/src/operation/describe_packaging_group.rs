...
/// Orchestration and serialization glue logic for `DescribePackagingGroup`.
...
impl DescribePackagingGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_packaging_group::DescribePackagingGroupInput,
                    ) -> ::std::result::Result<crate::operation::describe_packaging_group::DescribePackagingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_packaging_group::DescribePackagingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_packaging_group::DescribePackagingGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_packaging_group::DescribePackagingGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePackagingGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribePackagingGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribePackagingGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribePackagingGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePackagingGroup")
...
.with_interceptor(DescribePackagingGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_packaging_group::DescribePackagingGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_packaging_group::DescribePackagingGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_packaging_group::DescribePackagingGroupError>::new());
...
#[derive(Debug)]
            struct DescribePackagingGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePackagingGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_packaging_group::de_describe_packaging_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribePackagingGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePackagingGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_packaging_group::DescribePackagingGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_packaging_group::DescribePackagingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/packaging_groups/{Id}", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribePackagingGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribePackagingGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribePackagingGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribePackagingGroupInput>()
                        .ok_or("failed to downcast to DescribePackagingGroupInput")?;
...
pub enum DescribePackagingGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribePackagingGroupError) for what information is available for the error.")]
...
impl DescribePackagingGroupError {
    /// Creates the `DescribePackagingGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribePackagingGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribePackagingGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_packaging_group::DescribePackagingGroupError {
...
mod _describe_packaging_group_output;
