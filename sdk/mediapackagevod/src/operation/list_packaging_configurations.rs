    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/packaging_configurations")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackagingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_packaging_configurations::de_list_packaging_configurations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListPackagingConfigurationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_packaging_configurations::ListPackagingConfigurationsError
{
