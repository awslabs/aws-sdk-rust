...
impl ListPackagingConfigurationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_packaging_configurations::ListPackagingConfigurations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_packaging_configurations::ListPackagingConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackagingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_packaging_configurations::de_list_packaging_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
