...
/// Orchestration and serialization glue logic for `UpdatePackagingGroup`.
...
impl UpdatePackagingGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::update_packaging_group::UpdatePackagingGroupInput,
                    ) -> ::std::result::Result<crate::operation::update_packaging_group::UpdatePackagingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_packaging_group::UpdatePackagingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_packaging_group::UpdatePackagingGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_packaging_group::UpdatePackagingGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdatePackagingGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdatePackagingGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdatePackagingGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdatePackagingGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdatePackagingGroup")
...
.with_interceptor(UpdatePackagingGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_packaging_group::UpdatePackagingGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_packaging_group::UpdatePackagingGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_packaging_group::UpdatePackagingGroupError>::new());
...
#[derive(Debug)]
            struct UpdatePackagingGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdatePackagingGroupResponseDeserializer {
...
#[derive(Debug)]
            struct UpdatePackagingGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdatePackagingGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_packaging_group::UpdatePackagingGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_packaging_group::UpdatePackagingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_packaging_group::ser_update_packaging_group_input(&input)?);
...
#[derive(Debug)]
            struct UpdatePackagingGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdatePackagingGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdatePackagingGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdatePackagingGroupInput>()
                        .ok_or("failed to downcast to UpdatePackagingGroupInput")?;
...
pub enum UpdatePackagingGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdatePackagingGroupError) for what information is available for the error.")]
...
impl UpdatePackagingGroupError {
    /// Creates the `UpdatePackagingGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdatePackagingGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdatePackagingGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_packaging_group::UpdatePackagingGroupError {
...
mod _update_packaging_group_output;
