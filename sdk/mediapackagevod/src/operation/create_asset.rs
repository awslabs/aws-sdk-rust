...
impl CreateAssetInput {
    /// Consumes the builder and constructs an Operation<[`CreateAsset`](crate::operation::create_asset::CreateAsset)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_asset::CreateAsset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_asset::ser_create_asset_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_asset::CreateAsset::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAsset {
    type Output = ::std::result::Result<crate::operation::create_asset::CreateAssetOutput, crate::operation::create_asset::CreateAssetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_asset::de_create_asset_http_response_with_props(status, headers, body)
        }
    }
}
