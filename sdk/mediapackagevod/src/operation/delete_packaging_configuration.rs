    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/packaging_configurations/{Id}", Id = id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePackagingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_packaging_configuration::de_delete_packaging_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeletePackagingConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_packaging_configuration::DeletePackagingConfigurationError
{
