...
impl DeletePackagingConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_packaging_configuration::DeletePackagingConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePackagingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_packaging_configuration::de_delete_packaging_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
