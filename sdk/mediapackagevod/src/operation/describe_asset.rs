...
impl DescribeAssetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_asset::DescribeAsset,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_asset::DescribeAsset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAsset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_asset::de_describe_asset_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_asset::de_describe_asset_http_response_with_props(
                status, headers, body,
            )
        }
    }
