...
impl ListPackagingGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_packaging_groups::ListPackagingGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackagingGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_packaging_groups::de_list_packaging_groups_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_packaging_groups::ListPackagingGroupsError
{
