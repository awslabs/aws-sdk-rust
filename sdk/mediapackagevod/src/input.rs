...
impl CreatePackagingConfigurationInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_packaging_configuration(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
...
impl CreatePackagingGroupInput {
    ...
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_packaging_group(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl ListAssetsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_9) = &self.packaging_group_id {
            query.push_kv(
                "packagingGroupId",
...
impl ListPackagingConfigurationsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_11) = &self.packaging_group_id {
            query.push_kv(
                "packagingGroupId",
...
impl UpdatePackagingGroupInput {
    ...
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_packaging_group(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
