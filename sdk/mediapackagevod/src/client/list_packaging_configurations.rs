...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::set_max_results): Upper bound on number of records to return.
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::set_next_token): A token used to resume pagination from the end of a previous request.
    ///   - [`packaging_group_id(impl ::std::convert::Into<String>)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::packaging_group_id) / [`set_packaging_group_id(Option<String>)`](crate::operation::list_packaging_configurations::builders::ListPackagingConfigurationsFluentBuilder::set_packaging_group_id): Returns MediaPackage VOD PackagingConfigurations associated with the specified PackagingGroup.
