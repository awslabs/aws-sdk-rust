...
impl PutRecommendationFeedbackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_recommendation_feedback::PutRecommendationFeedbackInput, ::aws_smithy_types::error::operation::BuildError> {
