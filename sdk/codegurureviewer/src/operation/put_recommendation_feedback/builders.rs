...
impl PutRecommendationFeedbackFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_recommendation_feedback::PutRecommendationFeedbackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_recommendation_feedback::PutRecommendationFeedbackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_recommendation_feedback::PutRecommendationFeedbackOutput, crate::operation::put_recommendation_feedback::PutRecommendationFeedbackError, Self> {
