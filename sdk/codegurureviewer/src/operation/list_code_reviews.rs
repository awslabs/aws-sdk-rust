...
impl ListCodeReviewsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_code_reviews::ListCodeReviews, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCodeReviews {
    type Output =
        ::std::result::Result<crate::operation::list_code_reviews::ListCodeReviewsOutput, crate::operation::list_code_reviews::ListCodeReviewsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_code_reviews::de_list_code_reviews_http_response_with_props(status, headers, body)
        }
    }
}
