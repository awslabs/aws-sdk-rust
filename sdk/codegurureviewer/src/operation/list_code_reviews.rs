...
/// Orchestration and serialization glue logic for `ListCodeReviews`.
...
impl ListCodeReviews {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_code_reviews::ListCodeReviewsInput,
                    ) -> ::std::result::Result<crate::operation::list_code_reviews::ListCodeReviewsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_code_reviews::ListCodeReviewsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_code_reviews::ListCodeReviewsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_code_reviews::ListCodeReviewsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListCodeReviews {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListCodeReviews");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListCodeReviewsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListCodeReviewsResponseDeserializer));
...
.with_interceptor(ListCodeReviewsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_code_reviews::ListCodeReviewsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_code_reviews::ListCodeReviewsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_code_reviews::ListCodeReviewsError>::new());
...
#[derive(Debug)]
            struct ListCodeReviewsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListCodeReviewsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_code_reviews::de_list_code_reviews_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_code_reviews::de_list_code_reviews_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListCodeReviewsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListCodeReviewsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_code_reviews::ListCodeReviewsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_code_reviews::ListCodeReviewsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/codereviews").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_code_reviews::ListCodeReviewsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_7 = &_input.r#type;
    let inner_7 = inner_7.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "cannot be empty or unset"))?;
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListCodeReviewsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListCodeReviewsInput>()
                        .ok_or("failed to downcast to ListCodeReviewsInput")?;
...
pub enum ListCodeReviewsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListCodeReviewsError) for what information is available for the error.")]
...
impl ListCodeReviewsError {
    /// Creates the `ListCodeReviewsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCodeReviewsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListCodeReviewsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_code_reviews::ListCodeReviewsError {
