...
impl ListCodeReviewsInput {
    ...
    > {
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.states {
                    {
                        for inner_4 in inner_3 {
                            query
                                .push_kv("States", &::aws_smithy_http::query::fmt_string(&inner_4));
                        }
                    }
                }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_code_reviews::ListCodeReviews::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_code_reviews::ListCodeReviewsError
{
