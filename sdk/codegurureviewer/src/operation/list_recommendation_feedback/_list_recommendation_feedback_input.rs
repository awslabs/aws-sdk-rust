...
impl ListRecommendationFeedbackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_recommendation_feedback::ListRecommendationFeedbackInput, ::aws_smithy_types::error::operation::BuildError> {
