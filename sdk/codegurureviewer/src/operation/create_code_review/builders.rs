...
impl CreateCodeReviewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_code_review::CreateCodeReviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_code_review::CreateCodeReviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_code_review::CreateCodeReviewOutput, crate::operation::create_code_review::CreateCodeReviewError, Self> {
    ...
    pub fn get_repository_association_arn(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_repository_association_arn()
    }
