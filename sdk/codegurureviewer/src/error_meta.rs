...
impl From<crate::error::DescribeRecommendationFeedbackError> for Error {
    fn from(err: crate::error::DescribeRecommendationFeedbackError) -> Self {
        match err.kind {
            crate::error::DescribeRecommendationFeedbackErrorKind::AccessDeniedException(inner) => {
                Error::AccessDeniedException(inner)
            }
            crate::error::DescribeRecommendationFeedbackErrorKind::InternalServerException(
                inner,
            ) => Error::InternalServerException(inner),
            crate::error::DescribeRecommendationFeedbackErrorKind::ResourceNotFoundException(
                inner,
            ) => Error::ResourceNotFoundException(inner),
            crate::error::DescribeRecommendationFeedbackErrorKind::ThrottlingException(inner) => {
                Error::ThrottlingException(inner)
            }
            crate::error::DescribeRecommendationFeedbackErrorKind::ValidationException(inner) => {
                Error::ValidationException(inner)
            }
            crate::error::DescribeRecommendationFeedbackErrorKind::Unhandled(inner) => {
                Error::Unhandled(crate::error::Unhandled::new(inner.into()))
            }
        }
    }
...
impl From<crate::error::DescribeRepositoryAssociationError> for Error {
    fn from(err: crate::error::DescribeRepositoryAssociationError) -> Self {
        match err.kind {
            crate::error::DescribeRepositoryAssociationErrorKind::AccessDeniedException(inner) => {
                Error::AccessDeniedException(inner)
            }
            ...
            crate::error::DescribeRepositoryAssociationErrorKind::ThrottlingException(inner) => {
                Error::ThrottlingException(inner)
            }
            crate::error::DescribeRepositoryAssociationErrorKind::ValidationException(inner) => {
                Error::ValidationException(inner)
            }
...
impl From<crate::error::ListCodeReviewsError> for Error {
    fn from(err: crate::error::ListCodeReviewsError) -> Self {
        match err.kind {
            ...
            crate::error::ListCodeReviewsErrorKind::Unhandled(inner) => {
                Error::Unhandled(crate::error::Unhandled::new(inner.into()))
            }
        }
    }
...
impl From<crate::error::ListRecommendationFeedbackError> for Error {
    fn from(err: crate::error::ListRecommendationFeedbackError) -> Self {
        match err.kind {
            ...
            crate::error::ListRecommendationFeedbackErrorKind::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::error::ListRecommendationFeedbackErrorKind::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
...
impl From<crate::error::ListRepositoryAssociationsError> for Error {
    fn from(err: crate::error::ListRepositoryAssociationsError) -> Self {
        match err.kind {
            crate::error::ListRepositoryAssociationsErrorKind::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
...
impl From<crate::error::PutRecommendationFeedbackError> for Error {
    fn from(err: crate::error::PutRecommendationFeedbackError) -> Self {
        match err.kind {
            ...
            crate::error::PutRecommendationFeedbackErrorKind::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::error::PutRecommendationFeedbackErrorKind::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
