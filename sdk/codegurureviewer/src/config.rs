...
impl Builder {
    ...
    /// Sets the idempotency token provider to use for service calls that require tokens.
                        pub fn make_token(mut self, make_token: impl Into<crate::idempotency_token::IdempotencyTokenProvider>) -> Self {
                            self.set_make_token(Some(make_token.into()));
                            self
                        }
    
                        /// Sets the idempotency token provider to use for service calls that require tokens.
                        pub fn set_make_token(&mut self, make_token: Option<crate::idempotency_token::IdempotencyTokenProvider>) -> &mut Self {
    ...
    /// Set the retry_config for the builder
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_codegurureviewer::config::{AsyncSleep, Sleep, Config};
                            ///
                            /// #[derive(Debug)]
                            ...
                            ///
                            /// ```no_run
                            /// use aws_sdk_codegurureviewer::config::{AsyncSleep, Sleep, Builder, Config};
                            ///
                            /// #[derive(Debug)]
                            /// pub struct ForeverSleep;
                            ///
    ...
    /// Overrides the endpoint resolver to use when making requests.
                        ...
                        /// for `aws_sdk_codegurureviewer`.
                        ///
                        /// # Examples
                        /// ```no_run
                        /// # fn wrapper() -> Result<(), aws_smithy_http::endpoint::error::InvalidEndpointError> {
                        /// use aws_sdk_codegurureviewer::config::{Config, Endpoint, Region};
                        ///
    ...
    pub fn build(self) -> Config {
        Config {
            make_token: self.make_token.unwrap_or_else(crate::idempotency_token::default_provider),
