...
pub fn serialize_structure_associate_repository_input(
    ...
    if let Some(var_2) = &input.kms_key_details {
        ...
        crate::json_ser::serialize_structure_kms_key_details(&mut object_3, var_2);
        object_3.finish();
    }
    if let Some(var_4) = &input.repository {
        let mut object_5 = object.key("Repository").start_object();
        crate::json_ser::serialize_structure_repository(&mut object_5, var_4);
        object_5.finish();
    }
...
pub fn serialize_structure_create_code_review_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_13) = &input.r#type {
        ...
        crate::json_ser::serialize_structure_code_review_type(&mut object_14, var_13);
        object_14.finish();
    }
}

pub fn serialize_structure_put_recommendation_feedback_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_kms_key_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_code_review_type(
    ...
    if let Some(var_34) = &input.repository_analysis {
        ...
        crate::json_ser::serialize_structure_repository_analysis(&mut object_35, var_34);
        object_35.finish();
    }
...
pub fn serialize_structure_code_commit_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_third_party_source_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_s3_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_repository_analysis(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_45) = &input.repository_head {
        ...
        crate::json_ser::serialize_structure_repository_head_source_code_type(
            &mut object_46,
            var_45,
        );
        object_46.finish();
    ...
    if let Some(var_47) = &input.source_code_type {
        ...
        crate::json_ser::serialize_structure_source_code_type(&mut object_48, var_47);
        object_48.finish();
    }
}

pub fn serialize_structure_repository_head_source_code_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_source_code_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SourceCodeType,
) {
    if let Some(var_50) = &input.commit_diff {
        let mut object_51 = object.key("CommitDiff").start_object();
        crate::json_ser::serialize_structure_commit_diff_source_code_type(&mut object_51, var_50);
        object_51.finish();
    }
    ...
    if let Some(var_54) = &input.branch_diff {
        ...
        crate::json_ser::serialize_structure_branch_diff_source_code_type(&mut object_55, var_54);
        object_55.finish();
    }
    if let Some(var_56) = &input.s3_bucket_repository {
        let mut object_57 = object.key("S3BucketRepository").start_object();
        crate::json_ser::serialize_structure_s3_bucket_repository(&mut object_57, var_56);
        object_57.finish();
    }
    if let Some(var_58) = &input.request_metadata {
        let mut object_59 = object.key("RequestMetadata").start_object();
        crate::json_ser::serialize_structure_request_metadata(&mut object_59, var_58);
        object_59.finish();
    }
}

pub fn serialize_structure_commit_diff_source_code_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_branch_diff_source_code_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_s3_bucket_repository(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_66) = &input.details {
        ...
        crate::json_ser::serialize_structure_s3_repository_details(&mut object_67, var_66);
        object_67.finish();
    }
}

pub fn serialize_structure_request_metadata(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_70) = &input.event_info {
        ...
        crate::json_ser::serialize_structure_event_info(&mut object_71, var_70);
        object_71.finish();
    }
...
pub fn serialize_structure_s3_repository_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_74) = &input.code_artifacts {
        ...
        crate::json_ser::serialize_structure_code_artifacts(&mut object_75, var_74);
        object_75.finish();
    }
}

pub fn serialize_structure_event_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_code_artifacts(
    object: &mut smithy_json::serialize::JsonObjectWriter,
