...
impl super::Client {
    ...
    ///   - [`association_arn(impl Into<String>)`](crate::operation::disassociate_repository::builders::DisassociateRepositoryFluentBuilder::association_arn) / [`set_association_arn(Option<String>)`](crate::operation::disassociate_repository::builders::DisassociateRepositoryFluentBuilder::set_association_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_RepositoryAssociation.html">RepositoryAssociation</a> object. You can retrieve this ARN by calling <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_ListRepositoryAssociations.html">ListRepositoryAssociations</a>.</p><br>
