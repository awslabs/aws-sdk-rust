...
impl super::Client {
    ...
    ///   - [`code_review_arn(impl ::std::convert::Into<String>)`](crate::operation::put_recommendation_feedback::builders::PutRecommendationFeedbackFluentBuilder::code_review_arn) / [`set_code_review_arn(Option<String>)`](crate::operation::put_recommendation_feedback::builders::PutRecommendationFeedbackFluentBuilder::set_code_review_arn): <p>The Amazon Resource Name (ARN) of the <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReview.html">CodeReview</a> object. </p>
    ///   - [`recommendation_id(impl ::std::convert::Into<String>)`](crate::operation::put_recommendation_feedback::builders::PutRecommendationFeedbackFluentBuilder::recommendation_id) / [`set_recommendation_id(Option<String>)`](crate::operation::put_recommendation_feedback::builders::PutRecommendationFeedbackFluentBuilder::set_recommendation_id): <p>The recommendation ID that can be used to track the provided recommendations and then to collect the feedback.</p>
