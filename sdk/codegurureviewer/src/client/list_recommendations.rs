...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::set_next_token): <p>Pagination token.</p>
    ...
    ///   - [`code_review_arn(impl ::std::convert::Into<String>)`](crate::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::code_review_arn) / [`set_code_review_arn(Option<String>)`](crate::operation::list_recommendations::builders::ListRecommendationsFluentBuilder::set_code_review_arn): <p>The Amazon Resource Name (ARN) of the <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReview.html">CodeReview</a> object. </p>
