...
pub(crate) fn de_metrics_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MetricsSummary>, aws_smithy_json::deserialize::error::DeserializeError>
