...
pub fn ser_code_review_type(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CodeReviewType) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
