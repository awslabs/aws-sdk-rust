...
pub(crate) fn de_request_metadata<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RequestMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_request_metadata(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RequestMetadata) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
