    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`r#type(Option<CodeReviewType>)`](crate::input::CreateCodeReviewInput::type): <p> The type of code review to create. This is specified using a <a href="https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReviewType.html"> <code>CodeReviewType</code> </a> object. You can create a code review only of type <code>RepositoryAnalysis</code>. </p>
    ...
    ///   - [`r#type(Option<Type>)`](crate::input::ListCodeReviewsInput::type): <p> The type of code reviews to list in the response. </p>
