...
pub trait Waiters {
    ...
    fn wait_until_code_review_completed(&self) -> crate::waiters::code_review_completed::CodeReviewCompletedFluentBuilder;
    /// Wait until a repository association is complete.
    fn wait_until_repository_association_succeeded(
        &self,
    ) -> crate::waiters::repository_association_succeeded::RepositoryAssociationSucceededFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_code_review_completed(&self) -> crate::waiters::code_review_completed::CodeReviewCompletedFluentBuilder {
        crate::waiters::code_review_completed::CodeReviewCompletedFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_repository_association_succeeded(
        &self,
    ) -> crate::waiters::repository_association_succeeded::RepositoryAssociationSucceededFluentBuilder {
        crate::waiters::repository_association_succeeded::RepositoryAssociationSucceededFluentBuilder::new(self.handle.clone())
    }
}
...
mod describe_code_review;

mod describe_recommendation_feedback;

mod describe_repository_association;

mod disassociate_repository;

mod list_code_reviews;

mod list_recommendation_feedback;

mod list_recommendations;

mod list_repository_associations;

mod list_tags_for_resource;

mod put_recommendation_feedback;
