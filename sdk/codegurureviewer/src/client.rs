...
impl Client  {
    ...
    pub fn describe_recommendation_feedback(&self) -> fluent_builders::DescribeRecommendationFeedback {
    ...
    pub fn describe_repository_association(&self) -> fluent_builders::DescribeRepositoryAssociation {
