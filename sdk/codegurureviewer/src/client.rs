...
{
    pub fn associate_repository(&self) -> fluent_builders::AssociateRepository<C> {
        fluent_builders::AssociateRepository::new(self.handle.clone())
    }
    pub fn create_code_review(&self) -> fluent_builders::CreateCodeReview<C> {
        fluent_builders::CreateCodeReview::new(self.handle.clone())
    }
    pub fn describe_code_review(&self) -> fluent_builders::DescribeCodeReview<C> {
        fluent_builders::DescribeCodeReview::new(self.handle.clone())
    }
    pub fn describe_recommendation_feedback(
        &self,
    ) -> fluent_builders::DescribeRecommendationFeedback<C> {
        fluent_builders::DescribeRecommendationFeedback::new(self.handle.clone())
    }
    pub fn describe_repository_association(
        &self,
    ) -> fluent_builders::DescribeRepositoryAssociation<C> {
        fluent_builders::DescribeRepositoryAssociation::new(self.handle.clone())
    }
    pub fn disassociate_repository(&self) -> fluent_builders::DisassociateRepository<C> {
        fluent_builders::DisassociateRepository::new(self.handle.clone())
    }
    pub fn list_code_reviews(&self) -> fluent_builders::ListCodeReviews<C> {
        fluent_builders::ListCodeReviews::new(self.handle.clone())
    }
    pub fn list_recommendation_feedback(&self) -> fluent_builders::ListRecommendationFeedback<C> {
    ...
    pub fn list_repository_associations(&self) -> fluent_builders::ListRepositoryAssociations<C> {
        fluent_builders::ListRepositoryAssociations::new(self.handle.clone())
    }
    pub fn list_tags_for_resource(&self) -> fluent_builders::ListTagsForResource<C> {
        fluent_builders::ListTagsForResource::new(self.handle.clone())
    }
    pub fn put_recommendation_feedback(&self) -> fluent_builders::PutRecommendationFeedback<C> {
...
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct AssociateRepository<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::associate_repository_input::Builder,
    }
    impl<C> AssociateRepository<C> {
    ...
    #[derive(std::fmt::Debug)]
    pub struct CreateCodeReview<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::create_code_review_input::Builder,
    }
    impl<C> CreateCodeReview<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn repository_association_arn(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.repository_association_arn(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeCodeReview<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_code_review_input::Builder,
    }
    impl<C> DescribeCodeReview<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn code_review_arn(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.code_review_arn(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeRecommendationFeedback<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_recommendation_feedback_input::Builder,
    }
    impl<C> DescribeRecommendationFeedback<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn recommendation_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.recommendation_id(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DescribeRepositoryAssociation<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::describe_repository_association_input::Builder,
    }
    impl<C> DescribeRepositoryAssociation<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn association_arn(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.association_arn(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct DisassociateRepository<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::disassociate_repository_input::Builder,
    }
    impl<C> DisassociateRepository<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListCodeReviews<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_code_reviews_input::Builder,
    }
    impl<C> ListCodeReviews<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListRecommendationFeedback<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_recommendation_feedback_input::Builder,
    }
    impl<C> ListRecommendationFeedback<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListRepositoryAssociations<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_repository_associations_input::Builder,
    }
    impl<C> ListRepositoryAssociations<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutRecommendationFeedback<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_recommendation_feedback_input::Builder,
    }
    impl<C> PutRecommendationFeedback<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
