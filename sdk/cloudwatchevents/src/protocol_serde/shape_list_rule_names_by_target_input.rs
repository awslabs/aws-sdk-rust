...
pub fn ser_list_rule_names_by_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRuleNamesByTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
