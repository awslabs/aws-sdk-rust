...
pub fn ser_http_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HttpParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_http_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HttpParameters>, aws_smithy_json::deserialize::error::DeserializeError>
