...
> {
    ...
    Err(match error_code {
        "InternalException" => {
            crate::operation::describe_rule::DescribeRuleError::InternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_rule_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_rule::de_describe_rule(_response_body, output)
                .map_err(crate::operation::describe_rule::DescribeRuleError::unhandled)?;
