...
pub fn ser_list_archives_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListArchivesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
