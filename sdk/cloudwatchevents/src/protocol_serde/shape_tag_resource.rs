...
pub fn de_tag_resource_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::tag_resource::TagResourceOutput, crate::operation::tag_resource::TagResourceError> {
    ...
    Err(match error_code {
        ...
        "ManagedRuleException" => crate::operation::tag_resource::TagResourceError::ManagedRuleException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::ManagedRuleExceptionBuilder::default();
                    output = crate::protocol_serde::shape_managed_rule_exception::de_managed_rule_exception_json_err(_response_body, output).map_err(crate::operation::tag_resource::TagResourceError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
