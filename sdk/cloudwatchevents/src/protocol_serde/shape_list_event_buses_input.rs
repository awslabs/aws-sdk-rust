...
pub fn ser_list_event_buses_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEventBusesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
