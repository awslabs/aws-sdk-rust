...
pub fn ser_list_replays_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListReplaysInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
