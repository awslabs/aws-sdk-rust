...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::activate_event_source::builders::ActivateEventSourceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::activate_event_source::builders::ActivateEventSourceFluentBuilder::set_name):<br>required: **true**<br><p>The name of the partner event source to activate.</p><br>
