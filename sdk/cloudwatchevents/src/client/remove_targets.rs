...
impl super::Client {
    ...
    ///   - [`ids(impl Into<String>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::ids) / [`set_ids(Option<Vec<String>>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::set_ids): <p>The IDs of the targets to remove from the rule.</p>
