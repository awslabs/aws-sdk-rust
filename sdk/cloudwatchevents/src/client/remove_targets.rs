...
impl super::Client {
    ...
    ///   - [`rule(impl ::std::convert::Into<String>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::rule) / [`set_rule(Option<String>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::set_rule): <p>The name of the rule.</p>
    ///   - [`event_bus_name(impl ::std::convert::Into<String>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::event_bus_name) / [`set_event_bus_name(Option<String>)`](crate::operation::remove_targets::builders::RemoveTargetsFluentBuilder::set_event_bus_name): <p>The name or ARN of the event bus associated with the rule. If you omit this, the default event bus is used.</p>
