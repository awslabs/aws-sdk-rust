...
impl super::Client {
    ...
    ///   - [`archive_name(impl ::std::convert::Into<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::archive_name) / [`set_archive_name(Option<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::set_archive_name): <p>The name of the archive to update.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::set_description): <p>The description for the archive.</p>
    ///   - [`event_pattern(impl ::std::convert::Into<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::event_pattern) / [`set_event_pattern(Option<String>)`](crate::operation::update_archive::builders::UpdateArchiveFluentBuilder::set_event_pattern): <p>The event pattern to use to filter events sent to the archive.</p>
