...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::set_name): <p>The name of the API destination to update.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::set_description): <p>The name of the API destination to update.</p>
    ///   - [`connection_arn(impl ::std::convert::Into<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::connection_arn) / [`set_connection_arn(Option<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::set_connection_arn): <p>The ARN of the connection to use for the API destination.</p>
    ///   - [`invocation_endpoint(impl ::std::convert::Into<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::invocation_endpoint) / [`set_invocation_endpoint(Option<String>)`](crate::operation::update_api_destination::builders::UpdateApiDestinationFluentBuilder::set_invocation_endpoint): <p>The URL to the endpoint to use for the API destination.</p>
