...
impl super::Client {
    ...
    ///   - [`archive_name(impl ::std::convert::Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::archive_name) / [`set_archive_name(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_archive_name): <p>The name for the archive to create.</p>
    ///   - [`event_source_arn(impl ::std::convert::Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::event_source_arn) / [`set_event_source_arn(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_event_source_arn): <p>The ARN of the event bus that sends events to the archive.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_description): <p>A description for the archive.</p>
    ///   - [`event_pattern(impl ::std::convert::Into<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::event_pattern) / [`set_event_pattern(Option<String>)`](crate::operation::create_archive::builders::CreateArchiveFluentBuilder::set_event_pattern): <p>An event pattern to use to filter events sent to the archive.</p>
