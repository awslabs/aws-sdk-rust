...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::disable_rule::builders::DisableRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::disable_rule::builders::DisableRuleFluentBuilder::set_name): <p>The name of the rule.</p>
