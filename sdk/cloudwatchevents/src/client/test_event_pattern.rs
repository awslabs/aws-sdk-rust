...
impl super::Client {
    ...
    ///   - [`event_pattern(impl ::std::convert::Into<String>)`](crate::operation::test_event_pattern::builders::TestEventPatternFluentBuilder::event_pattern) / [`set_event_pattern(Option<String>)`](crate::operation::test_event_pattern::builders::TestEventPatternFluentBuilder::set_event_pattern): <p>The event pattern. For more information, see <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-and-event-patterns.html">Events and Event Patterns</a> in the <i>Amazon EventBridge User Guide</i>.</p>
    ///   - [`event(impl ::std::convert::Into<String>)`](crate::operation::test_event_pattern::builders::TestEventPatternFluentBuilder::event) / [`set_event(Option<String>)`](crate::operation::test_event_pattern::builders::TestEventPatternFluentBuilder::set_event): <p>The event, in JSON format, to test against the event pattern. The JSON must follow the format specified in <a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/aws-events.html">Amazon Web Services Events</a>, and the following fields are mandatory:</p>  <ul>   <li> <p> <code>id</code> </p> </li>   <li> <p> <code>account</code> </p> </li>   <li> <p> <code>source</code> </p> </li>   <li> <p> <code>time</code> </p> </li>   <li> <p> <code>region</code> </p> </li>   <li> <p> <code>resources</code> </p> </li>   <li> <p> <code>detail-type</code> </p> </li>  </ul>
