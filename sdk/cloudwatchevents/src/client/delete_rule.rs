...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_name): <p>The name of the rule.</p>
    ///   - [`event_bus_name(impl ::std::convert::Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::event_bus_name) / [`set_event_bus_name(Option<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_event_bus_name): <p>The name or ARN of the event bus associated with the rule. If you omit this, the default event bus is used.</p>
