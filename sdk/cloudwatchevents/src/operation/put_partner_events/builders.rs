...
impl PutPartnerEventsFluentBuilder  {
    /// Creates a new `PutPartnerEvents`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::put_partner_events::PutPartnerEventsOutput, aws_smithy_http::result::SdkError<crate::operation::put_partner_events::PutPartnerEventsError>>
                     {
