...
impl CreateEventBusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_event_bus::CreateEventBus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_event_bus::ser_create_event_bus_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEventBus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_event_bus::de_create_event_bus_http_response_with_props(status, headers, body)
        }
    }
}
