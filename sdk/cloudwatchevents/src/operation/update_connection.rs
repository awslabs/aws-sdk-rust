...
impl UpdateConnectionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_connection::UpdateConnection, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_connection::ser_update_connection_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_connection::de_update_connection_http_response_with_props(status, headers, body)
        }
    }
}
