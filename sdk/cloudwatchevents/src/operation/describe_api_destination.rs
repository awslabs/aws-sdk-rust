...
impl DescribeApiDestinationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_api_destination::DescribeApiDestination,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApiDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_api_destination::de_describe_api_destination_http_response_with_props(status, headers, body)
        }
    }
}
