...
impl DeletePartnerEventSourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_partner_event_source::DeletePartnerEventSourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_partner_event_source::DeletePartnerEventSourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_partner_event_source::DeletePartnerEventSourceOutput, crate::operation::delete_partner_event_source::DeletePartnerEventSourceError, Self> {
