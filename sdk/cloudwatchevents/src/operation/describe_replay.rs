...
impl DescribeReplayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_replay::DescribeReplay, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_replay::ser_describe_replay_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplay {
    type Output =
        ::std::result::Result<crate::operation::describe_replay::DescribeReplayOutput, crate::operation::describe_replay::DescribeReplayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_replay::de_describe_replay_http_response_with_props(status, headers, body)
        }
    }
}
