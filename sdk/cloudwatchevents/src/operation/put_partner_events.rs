...
impl PutPartnerEventsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_partner_events::PutPartnerEvents,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_partner_events::ser_put_partner_events_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutPartnerEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_partner_events::de_put_partner_events_http_response_with_props(status, headers, body)
        }
    }
}
