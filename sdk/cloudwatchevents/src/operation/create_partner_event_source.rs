...
impl CreatePartnerEventSourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_partner_event_source::CreatePartnerEventSource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePartnerEventSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_partner_event_source::de_create_partner_event_source_http_response_with_props(status, headers, body)
        }
    }
}
