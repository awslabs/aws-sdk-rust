...
impl DeletePartnerEventSourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_partner_event_source::DeletePartnerEventSource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePartnerEventSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_partner_event_source::de_delete_partner_event_source_http_response_with_props(status, headers, body)
        }
    }
}
