...
impl DeactivateEventSourceInput {
    /// Consumes the builder and constructs an Operation<[`DeactivateEventSource`](crate::operation::deactivate_event_source::DeactivateEventSource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deactivate_event_source::DeactivateEventSource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deactivate_event_source::DeactivateEventSourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deactivate_event_source::DeactivateEventSource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeactivateEventSource {
                type Output = std::result::Result<crate::operation::deactivate_event_source::DeactivateEventSourceOutput, crate::operation::deactivate_event_source::DeactivateEventSourceError>;
