...
impl DeleteArchive {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "CloudWatch Events.DeleteArchive",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudWatch Events", "DeleteArchive", input, runtime_plugins, stop_point)
            .await
    }
