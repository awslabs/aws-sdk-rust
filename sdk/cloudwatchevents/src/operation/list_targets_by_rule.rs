...
impl ListTargetsByRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_targets_by_rule::ser_list_targets_by_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTargetsByRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_targets_by_rule::de_list_targets_by_rule_http_response_with_props(status, headers, body)
        }
    }
}
