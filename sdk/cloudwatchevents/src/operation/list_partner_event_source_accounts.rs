...
impl ListPartnerEventSourceAccountsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_partner_event_source_accounts::ListPartnerEventSourceAccounts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPartnerEventSourceAccounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_partner_event_source_accounts::de_list_partner_event_source_accounts_http_response_with_props(
                status, headers, body,
            )
        }
    }
