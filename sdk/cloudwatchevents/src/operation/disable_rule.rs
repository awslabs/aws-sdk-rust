...
impl DisableRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::disable_rule::DisableRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disable_rule::ser_disable_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_rule::de_disable_rule_http_response_with_props(status, headers, body)
        }
    }
}
