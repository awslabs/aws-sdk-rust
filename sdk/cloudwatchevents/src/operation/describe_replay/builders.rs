...
impl DescribeReplayFluentBuilder  {
    /// Creates a new `DescribeReplay`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_replay::DescribeReplay, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_replay::DescribeReplayError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_replay::DescribeReplayOutput, aws_smithy_http::result::SdkError<crate::operation::describe_replay::DescribeReplayError>>
                     {
