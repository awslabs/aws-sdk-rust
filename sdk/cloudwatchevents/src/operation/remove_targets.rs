...
impl RemoveTargetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_targets::RemoveTargets,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_targets::RemoveTargets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_remove_targets::de_remove_targets_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_remove_targets::de_remove_targets_http_response_with_props(
                status, headers, body,
            )
        }
    }
