...
impl RemoveTargetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::remove_targets::RemoveTargets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_remove_targets::ser_remove_targets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_targets::de_remove_targets_http_response_with_props(status, headers, body)
        }
    }
}
