...
impl CreatePartnerEventSourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_partner_event_source::CreatePartnerEventSourceInput, ::aws_smithy_types::error::operation::BuildError> {
