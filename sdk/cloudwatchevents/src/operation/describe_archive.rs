...
impl DescribeArchiveInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_archive::DescribeArchive, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_archive::ser_describe_archive_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeArchive {
    type Output =
        ::std::result::Result<crate::operation::describe_archive::DescribeArchiveOutput, crate::operation::describe_archive::DescribeArchiveError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_archive::de_describe_archive_http_response_with_props(status, headers, body)
        }
    }
}
