...
impl ListArchivesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_archives::ListArchives, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_archives::ser_list_archives_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListArchives {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_archives::de_list_archives_http_response_with_props(status, headers, body)
        }
    }
}
