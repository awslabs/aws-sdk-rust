...
/// <ul>
/// <li>
/// <p><a href="https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-api-destinations.html">API destination</a></p></li>
/// <li>
/// <p>Amazon API Gateway REST API endpoints</p></li>
/// <li>
/// <p>API Gateway</p></li>
/// <li>
/// <p>Batch job queue</p></li>
/// <li>
/// <p>CloudWatch Logs group</p></li>
/// <li>
/// <p>CodeBuild project</p></li>
/// <li>
/// <p>CodePipeline</p></li>
/// <li>
/// <p>Amazon EC2 <code>CreateSnapshot</code> API call</p></li>
/// <li>
/// <p>Amazon EC2 <code>RebootInstances</code> API call</p></li>
/// <li>
/// <p>Amazon EC2 <code>StopInstances</code> API call</p></li>
/// <li>
/// <p>Amazon EC2 <code>TerminateInstances</code> API call</p></li>
/// <li>
/// <p>Amazon ECS tasks</p></li>
/// <li>
...
/// <li>
/// <p>Kinesis stream (Kinesis Data Stream)</p></li>
/// <li>
/// <p>Lambda function</p></li>
/// <li>
/// <p>Redshift clusters (Data API statement execution)</p></li>
/// <li>
/// <p>Amazon SNS topic</p></li>
/// <li>
/// <p>Amazon SQS queues (includes FIFO queues</p></li>
/// <li>
/// <p>SSM Automation</p></li>
/// <li>
/// <p>SSM OpsItem</p></li>
/// <li>
/// <p>SSM Run Command</p></li>
/// <li>
/// <p>Step Functions state machines</p></li>
/// </ul>
