...
impl DescribePartnerEventSourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_partner_event_source::DescribePartnerEventSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePartnerEventSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_partner_event_source::de_describe_partner_event_source_http_response_with_props(
                status, headers, body,
            )
        }
    }
