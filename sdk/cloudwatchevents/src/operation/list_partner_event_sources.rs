...
impl ListPartnerEventSourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_partner_event_sources::ListPartnerEventSources,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPartnerEventSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_partner_event_sources::de_list_partner_event_sources_http_response_with_props(status, headers, body)
        }
    }
}
