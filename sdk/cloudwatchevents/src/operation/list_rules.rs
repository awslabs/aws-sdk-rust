...
impl ListRulesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_rules::ListRules, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_rules::ser_list_rules_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_rules::de_list_rules_http_response_with_props(status, headers, body)
        }
    }
}
