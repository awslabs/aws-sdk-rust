...
impl DeleteRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRule`](crate::operation::delete_rule::DeleteRule)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_rule::DeleteRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_rule::ser_delete_rule_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_rule::DeleteRule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRule {
    type Output = ::std::result::Result<crate::operation::delete_rule::DeleteRuleOutput, crate::operation::delete_rule::DeleteRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_rule::de_delete_rule_http_response_with_props(status, headers, body)
        }
    }
}
