...
impl DeleteRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_rule::DeleteRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_rule::de_delete_rule_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_rule::de_delete_rule_http_response_with_props(
                status, headers, body,
            )
        }
    }
