...
pub struct UpdateArchiveOutput  {
    ...
    #[doc(hidden)]pub archive_arn: std::option::Option<std::string::String>,
...
pub struct StartReplayOutput  {
    ...
    #[doc(hidden)]pub replay_arn: std::option::Option<std::string::String>,
...
pub struct RemoveTargetsOutput  {
    ...
    #[doc(hidden)]pub failed_entry_count: i32,
    /// <p>The failed target entries.</p>
    #[doc(hidden)]pub failed_entries: std::option::Option<std::vec::Vec<crate::model::RemoveTargetsResultEntry>>,
}
...
pub struct PutTargetsOutput  {
    ...
    #[doc(hidden)]pub failed_entry_count: i32,
    /// <p>The failed target entries.</p>
    #[doc(hidden)]pub failed_entries: std::option::Option<std::vec::Vec<crate::model::PutTargetsResultEntry>>,
}
...
pub struct PutPartnerEventsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::PutPartnerEventsResultEntry>>,
}
...
pub struct PutEventsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::PutEventsResultEntry>>,
}
...
pub struct ListRuleNamesByTargetOutput  {
    ...
    #[doc(hidden)]pub rule_names: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Indicates whether there are additional results to retrieve. If there are no more results, the value is null.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListReplaysOutput  {
    ...
    #[doc(hidden)]pub replays: std::option::Option<std::vec::Vec<crate::model::Replay>>,
...
pub struct ListPartnerEventSourcesOutput  {
    ...
    #[doc(hidden)]pub partner_event_sources: std::option::Option<std::vec::Vec<crate::model::PartnerEventSource>>,
...
pub struct ListPartnerEventSourceAccountsOutput  {
    /// <p>The list of partner event sources returned by the operation.</p>
    #[doc(hidden)]pub partner_event_source_accounts: std::option::Option<std::vec::Vec<crate::model::PartnerEventSourceAccount>>,
    /// <p>A token you can use in a subsequent operation to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListPartnerEventSourceAccountsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("partner_event_source_accounts", &self.partner_event_source_accounts);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListEventSourcesOutput  {
    ...
    #[doc(hidden)]pub event_sources: std::option::Option<std::vec::Vec<crate::model::EventSource>>,
    /// <p>A token you can use in a subsequent operation to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListEventBusesOutput  {
    ...
    #[doc(hidden)]pub event_buses: std::option::Option<std::vec::Vec<crate::model::EventBus>>,
    /// <p>A token you can use in a subsequent operation to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListArchivesOutput  {
    ...
    #[doc(hidden)]pub archives: std::option::Option<std::vec::Vec<crate::model::Archive>>,
    /// <p>The token returned by a previous call to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApiDestinationsOutput  {
    ...
    #[doc(hidden)]pub api_destinations: std::option::Option<std::vec::Vec<crate::model::ApiDestination>>,
    /// <p>A token you can use in a subsequent request to retrieve the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribeConnectionOutput  {
    ...
    #[doc(hidden)]pub auth_parameters: std::option::Option<crate::model::ConnectionAuthResponseParameters>,
    /// <p>A time stamp for the time that the connection was created.</p>
    #[doc(hidden)]pub creation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A time stamp for the time that the connection was last modified.</p>
    #[doc(hidden)]pub last_modified_time: std::option::Option<aws_smithy_types::DateTime>,
