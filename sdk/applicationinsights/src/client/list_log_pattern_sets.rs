...
impl super::Client {
    ...
    ///   - [`account_id(Option<String>)`](crate::operation::list_log_pattern_sets::ListLogPatternSetsOutput::account_id): <p>The Amazon Web Services account ID for the resource group owner.</p>
