...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::set_account_id): <p>The AWS account ID for the resource group owner.</p>
