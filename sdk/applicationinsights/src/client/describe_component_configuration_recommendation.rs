...
impl super::Client {
    ...
    ///   - [`recommendation_type(RecommendationType)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::recommendation_type) / [`set_recommendation_type(Option<RecommendationType>)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::set_recommendation_type): <p>The recommended configuration type.</p>
