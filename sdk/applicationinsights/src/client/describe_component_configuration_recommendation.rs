...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl ::std::convert::Into<String>)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(impl ::std::convert::Into<String>)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::component_name) / [`set_component_name(Option<String>)`](crate::operation::describe_component_configuration_recommendation::builders::DescribeComponentConfigurationRecommendationFluentBuilder::set_component_name): <p>The name of the component.</p>
