...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_log_patterns::builders::ListLogPatternsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_log_patterns::builders::ListLogPatternsFluentBuilder::set_account_id): <p>The AWS account ID for the resource group owner.</p>
