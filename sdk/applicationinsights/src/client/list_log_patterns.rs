...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::list_log_patterns::builders::ListLogPatternsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_log_patterns::builders::ListLogPatternsFluentBuilder::set_account_id):<br>required: **false**<br><p>The Amazon Web Services account ID for the resource group owner.</p><br>
    ...
    ///   - [`account_id(Option<String>)`](crate::operation::list_log_patterns::ListLogPatternsOutput::account_id): <p>The Amazon Web Services account ID for the resource group owner.</p>
