...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_component::builders::CreateComponentFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::create_component::builders::CreateComponentFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(impl ::std::convert::Into<String>)`](crate::operation::create_component::builders::CreateComponentFluentBuilder::component_name) / [`set_component_name(Option<String>)`](crate::operation::create_component::builders::CreateComponentFluentBuilder::set_component_name): <p>The name of the component.</p>
