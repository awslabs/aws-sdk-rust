...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl Into<String>)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(impl Into<String>)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::component_name) / [`set_component_name(Option<String>)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::set_component_name): <p>The name of the component.</p>
    ///   - [`workload_configuration(WorkloadConfiguration)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::workload_configuration) / [`set_workload_configuration(Option<WorkloadConfiguration>)`](crate::operation::add_workload::builders::AddWorkloadFluentBuilder::set_workload_configuration): <p>The configuration settings of the workload. The value is the escaped JSON of the configuration.</p>
