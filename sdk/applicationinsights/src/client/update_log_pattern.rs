...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl ::std::convert::Into<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(impl ::std::convert::Into<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::pattern_set_name) / [`set_pattern_set_name(Option<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::set_pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`pattern_name(impl ::std::convert::Into<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::pattern_name) / [`set_pattern_name(Option<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::set_pattern_name): <p>The name of the log pattern.</p>
    ///   - [`pattern(impl ::std::convert::Into<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::pattern) / [`set_pattern(Option<String>)`](crate::operation::update_log_pattern::builders::UpdateLogPatternFluentBuilder::set_pattern): <p>The log pattern. The pattern must be DFA compatible. Patterns that utilize forward lookahead or backreference constructions are not supported.</p>
