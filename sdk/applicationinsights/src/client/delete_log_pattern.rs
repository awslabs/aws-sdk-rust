...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl Into<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::set_resource_group_name):<br>required: **true**<br><p>The name of the resource group.</p><br>
    ///   - [`pattern_set_name(impl Into<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::pattern_set_name) / [`set_pattern_set_name(Option<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::set_pattern_set_name):<br>required: **true**<br><p>The name of the log pattern set.</p><br>
    ///   - [`pattern_name(impl Into<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::pattern_name) / [`set_pattern_name(Option<String>)`](crate::operation::delete_log_pattern::builders::DeleteLogPatternFluentBuilder::set_pattern_name):<br>required: **true**<br><p>The name of the log pattern.</p><br>
