...
impl super::Client {
    ...
    ///   - [`resource_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(impl ::std::convert::Into<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::pattern_set_name) / [`set_pattern_set_name(Option<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::set_pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`pattern_name(impl ::std::convert::Into<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::pattern_name) / [`set_pattern_name(Option<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::set_pattern_name): <p>The name of the log pattern.</p>
    ///   - [`pattern(impl ::std::convert::Into<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::pattern) / [`set_pattern(Option<String>)`](crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::set_pattern): <p>The log pattern. The pattern must be DFA compatible. Patterns that utilize forward lookahead or backreference constructions are not supported.</p>
    ...
    pub fn create_log_pattern(
        &self,
    ) -> crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder {
        crate::operation::create_log_pattern::builders::CreateLogPatternFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
