...
impl ListLogPatternsFluentBuilder  {
    /// Creates a new `ListLogPatterns`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_log_patterns::ListLogPatterns, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_log_patterns::ListLogPatternsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_log_patterns::ListLogPatternsOutput, aws_smithy_http::result::SdkError<crate::operation::list_log_patterns::ListLogPatternsError>>
                     {
    ...
    /// Create a paginator for this request
                        ///
                        /// Paginators are used by calling [`send().await`](crate::operation::list_log_patterns::paginator::ListLogPatternsPaginator::send) which returns a `Stream`.
