...
impl CreateLogPatternFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_log_pattern::CreateLogPatternOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_log_pattern::CreateLogPatternError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_log_pattern::CreateLogPatternOutput, crate::operation::create_log_pattern::CreateLogPatternError, Self> {
