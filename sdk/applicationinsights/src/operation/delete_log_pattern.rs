...
impl DeleteLogPatternInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_log_pattern::ser_delete_log_pattern_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLogPattern {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_log_pattern::de_delete_log_pattern_http_response_with_props(status, headers, body)
        }
    }
}
