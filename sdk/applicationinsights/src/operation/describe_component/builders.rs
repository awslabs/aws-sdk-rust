...
impl DescribeComponentFluentBuilder  {
    /// Creates a new `DescribeComponent`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_component::DescribeComponentOutput, aws_smithy_http::result::SdkError<crate::operation::describe_component::DescribeComponentError>>
                     {
