...
impl ListApplicationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_applications::ListApplications, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_applications::ser_list_applications_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListApplications {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_applications::de_list_applications_http_response_with_props(status, headers, body)
        }
    }
}
