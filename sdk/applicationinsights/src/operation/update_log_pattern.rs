...
impl UpdateLogPatternInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_log_pattern::ser_update_log_pattern_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLogPattern {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_log_pattern::de_update_log_pattern_http_response_with_props(status, headers, body)
        }
    }
}
