...
impl ListConfigurationHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_configuration_history::ListConfigurationHistoryInput, ::aws_smithy_types::error::operation::BuildError> {
