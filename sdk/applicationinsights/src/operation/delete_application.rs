...
impl DeleteApplicationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_application::ser_delete_application_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application::de_delete_application_http_response_with_props(status, headers, body)
        }
    }
}
