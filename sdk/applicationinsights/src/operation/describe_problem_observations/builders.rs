...
impl crate::operation::describe_problem_observations::builders::DescribeProblemObservationsInputBuilder {
...
impl DescribeProblemObservationsFluentBuilder {
    /// Creates a new `DescribeProblemObservationsFluentBuilder`.
