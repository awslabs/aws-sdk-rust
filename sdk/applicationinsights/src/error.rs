...
/// Do not use this.
            ...
            /// Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).
            #[deprecated(note = "Operation `*Error/*ErrorKind` types were combined into a single `*Error` enum. The `.kind` field on `*Error` no longer exists and isn't needed anymore (you can just match on the error directly since it's an enum now).")]
            pub type DescribeComponentConfigurationRecommendationErrorKind = DescribeComponentConfigurationRecommendationError;
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeComponentConfigurationRecommendationError {
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeComponentConfigurationRecommendationError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InternalServerException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_http::request_id::RequestId for crate::error::DescribeComponentConfigurationRecommendationError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl aws_smithy_types::retry::ProvideErrorKind for DescribeComponentConfigurationRecommendationError {
    fn code(&self) -> Option<&str> {
        aws_smithy_types::error::metadata::ProvideErrorMetadata::code(self)
    }
    fn retryable_error_kind(&self) -> Option<aws_smithy_types::retry::ErrorKind> {
