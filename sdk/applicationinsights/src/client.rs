...
/// 
/// ```no_run
/// # async fn wrapper() -> Result<(), aws_sdk_applicationinsights::Error> {
...
mod delete_log_pattern;

mod describe_application;

mod describe_component;

mod describe_component_configuration;

mod describe_component_configuration_recommendation;

mod describe_log_pattern;

mod describe_observation;

mod describe_problem;
...
mod list_configuration_history;

mod list_log_pattern_sets;

mod list_log_patterns;
