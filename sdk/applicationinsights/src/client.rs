    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::CreateApplicationInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`ops_center_enabled(Option<bool>)`](crate::input::CreateApplicationInput::ops_center_enabled): <p> When set to <code>true</code>, creates opsItems for any problems detected on an application. </p>
    ///   - [`cwe_monitor_enabled(Option<bool>)`](crate::input::CreateApplicationInput::cwe_monitor_enabled): <p> Indicates whether Application Insights can listen to CloudWatch events for the application resources, such as <code>instance terminated</code>, <code>failed deployment</code>, and others. </p>
    ///   - [`ops_item_sns_topic_arn(Option<String>)`](crate::input::CreateApplicationInput::ops_item_sns_topic_arn): <p> The SNS topic provided to Application Insights that is associated to the created opsItem. Allows you to receive notifications for updates to the opsItem. </p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateApplicationInput::tags): <p>List of tags to add to the application. tag key (<code>Key</code>) and an associated tag value (<code>Value</code>). The maximum length of a tag key is 128 characters. The maximum length of a tag value is 256 characters.</p>
    ///   - [`auto_config_enabled(Option<bool>)`](crate::input::CreateApplicationInput::auto_config_enabled): (undocumented)
    ///   - [`auto_create(Option<bool>)`](crate::input::CreateApplicationInput::auto_create): (undocumented)
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::CreateComponentInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::CreateComponentInput::component_name): <p>The name of the component.</p>
    ///   - [`resource_list(Option<Vec<String>>)`](crate::input::CreateComponentInput::resource_list): <p>The list of resource ARNs that belong to the component.</p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::DeleteApplicationInput::resource_group_name): <p>The name of the resource group.</p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::DeleteComponentInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::DeleteComponentInput::component_name): <p>The name of the component.</p>
    ...
    ///
    /// - Takes [`DeleteLogPatternInput`](crate::input::DeleteLogPatternInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::DeleteLogPatternInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(Option<String>)`](crate::input::DeleteLogPatternInput::pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`pattern_name(Option<String>)`](crate::input::DeleteLogPatternInput::pattern_name): <p>The name of the log pattern.</p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::DescribeApplicationInput::resource_group_name): <p>The name of the resource group.</p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::DescribeComponentInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::DescribeComponentInput::component_name): <p>The name of the component.</p>
    ...
    ///
    /// - Takes [`DescribeComponentConfigurationInput`](crate::input::DescribeComponentConfigurationInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::DescribeComponentConfigurationInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::DescribeComponentConfigurationInput::component_name): <p>The name of the component.</p>
    ...
    ///
    /// - Takes [`DescribeComponentConfigurationRecommendationInput`](crate::input::DescribeComponentConfigurationRecommendationInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::DescribeComponentConfigurationRecommendationInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::DescribeComponentConfigurationRecommendationInput::component_name): <p>The name of the component.</p>
    ///   - [`tier(Option<Tier>)`](crate::input::DescribeComponentConfigurationRecommendationInput::tier): <p>The tier of the application component. Supported tiers include <code>DOT_NET_CORE</code>, <code>DOT_NET_WORKER</code>, <code>DOT_NET_WEB</code>, <code>SQL_SERVER</code>, and <code>DEFAULT</code>.</p>
    ...
    ///
    /// - Takes [`DescribeLogPatternInput`](crate::input::DescribeLogPatternInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::DescribeLogPatternInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(Option<String>)`](crate::input::DescribeLogPatternInput::pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`pattern_name(Option<String>)`](crate::input::DescribeLogPatternInput::pattern_name): <p>The name of the log pattern.</p>
    ...
    ///
    /// - Takes [`DescribeObservationInput`](crate::input::DescribeObservationInput) with field(s):
    ///   - [`observation_id(Option<String>)`](crate::input::DescribeObservationInput::observation_id): <p>The ID of the observation.</p>
    ...
    ///
    /// - Takes [`DescribeProblemInput`](crate::input::DescribeProblemInput) with field(s):
    ///   - [`problem_id(Option<String>)`](crate::input::DescribeProblemInput::problem_id): <p>The ID of the problem.</p>
    ...
    ///
    /// - Takes [`DescribeProblemObservationsInput`](crate::input::DescribeProblemObservationsInput) with field(s):
    ///   - [`problem_id(Option<String>)`](crate::input::DescribeProblemObservationsInput::problem_id): <p>The ID of the problem.</p>
    ...
    ///   - [`max_results(Option<i32>)`](crate::input::ListApplicationsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListApplicationsInput::next_token): <p>The token to request the next page of results.</p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::ListComponentsInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListComponentsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ...
    ///
    /// - Takes [`ListLogPatternsInput`](crate::input::ListLogPatternsInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::ListLogPatternsInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(Option<String>)`](crate::input::ListLogPatternsInput::pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListLogPatternsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListLogPatternsInput::next_token): <p>The token to request the next page of results.</p>
    ...
    ///
    /// - Takes [`ListLogPatternSetsInput`](crate::input::ListLogPatternSetsInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::ListLogPatternSetsInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListLogPatternSetsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListLogPatternSetsInput::next_token): <p>The token to request the next page of results.</p>
    ...
    ///
    /// - Takes [`ListProblemsInput`](crate::input::ListProblemsInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::ListProblemsInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::ListProblemsInput::start_time): <p>The time when the problem was detected, in epoch seconds. If you don't specify a time frame for the request, problems within the past seven days are returned.</p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::ListProblemsInput::end_time): <p>The time when the problem ended, in epoch seconds. If not specified, problems within the past seven days are returned.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListProblemsInput::max_results): <p>The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned <code>NextToken</code> value.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListProblemsInput::next_token): <p>The token to request the next page of results.</p>
    ///   - [`component_name(Option<String>)`](crate::input::ListProblemsInput::component_name): (undocumented)
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the application that you want to retrieve tag information for.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the application that you want to add one or more tags to.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>A list of tags that to add to the application. A tag consists of a required tag key (<code>Key</code>) and an associated tag value (<code>Value</code>). The maximum length of a tag key is 128 characters. The maximum length of a tag value is 256 characters.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the application that you want to remove one or more tags from.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>The tags (tag keys) that you want to remove from the resource. When you specify a tag key, the action removes both that key and its associated tag value.</p>  <p>To remove more than one tag from the application, append the <code>TagKeys</code> parameter and argument for each additional tag to remove, separated by an ampersand. </p>
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::UpdateApplicationInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`ops_center_enabled(Option<bool>)`](crate::input::UpdateApplicationInput::ops_center_enabled): <p> When set to <code>true</code>, creates opsItems for any problems detected on an application. </p>
    ///   - [`cwe_monitor_enabled(Option<bool>)`](crate::input::UpdateApplicationInput::cwe_monitor_enabled): <p> Indicates whether Application Insights can listen to CloudWatch events for the application resources, such as <code>instance terminated</code>, <code>failed deployment</code>, and others. </p>
    ///   - [`ops_item_sns_topic_arn(Option<String>)`](crate::input::UpdateApplicationInput::ops_item_sns_topic_arn): <p> The SNS topic provided to Application Insights that is associated to the created opsItem. Allows you to receive notifications for updates to the opsItem.</p>
    ///   - [`remove_sns_topic(Option<bool>)`](crate::input::UpdateApplicationInput::remove_sns_topic): <p> Disassociates the SNS topic from the opsItem created for detected problems.</p>
    ///   - [`auto_config_enabled(Option<bool>)`](crate::input::UpdateApplicationInput::auto_config_enabled): (undocumented)
    ...
    ///   - [`resource_group_name(Option<String>)`](crate::input::UpdateComponentInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::UpdateComponentInput::component_name): <p>The name of the component.</p>
    ///   - [`new_component_name(Option<String>)`](crate::input::UpdateComponentInput::new_component_name): <p>The new name of the component.</p>
    ///   - [`resource_list(Option<Vec<String>>)`](crate::input::UpdateComponentInput::resource_list): <p>The list of resource ARNs that belong to the component.</p>
    ...
    ///
    /// - Takes [`UpdateComponentConfigurationInput`](crate::input::UpdateComponentConfigurationInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::UpdateComponentConfigurationInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`component_name(Option<String>)`](crate::input::UpdateComponentConfigurationInput::component_name): <p>The name of the component.</p>
    ///   - [`monitor(Option<bool>)`](crate::input::UpdateComponentConfigurationInput::monitor): <p>Indicates whether the application component is monitored.</p>
    ///   - [`tier(Option<Tier>)`](crate::input::UpdateComponentConfigurationInput::tier): <p>The tier of the application component. Supported tiers include <code>DOT_NET_WORKER</code>, <code>DOT_NET_WEB</code>, <code>DOT_NET_CORE</code>, <code>SQL_SERVER</code>, and <code>DEFAULT</code>.</p>
    ///   - [`component_configuration(Option<String>)`](crate::input::UpdateComponentConfigurationInput::component_configuration): <p>The configuration settings of the component. The value is the escaped JSON of the configuration. For more information about the JSON format, see <a href="https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/working-with-json.html">Working with JSON</a>. You can send a request to <code>DescribeComponentConfigurationRecommendation</code> to see the recommended configuration for a component. For the complete format of the component configuration file, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/component-config.html">Component Configuration</a>.</p>
    ///   - [`auto_config_enabled(Option<bool>)`](crate::input::UpdateComponentConfigurationInput::auto_config_enabled): (undocumented)
    ...
    ///
    /// - Takes [`UpdateLogPatternInput`](crate::input::UpdateLogPatternInput) with field(s):
    ///   - [`resource_group_name(Option<String>)`](crate::input::UpdateLogPatternInput::resource_group_name): <p>The name of the resource group.</p>
    ///   - [`pattern_set_name(Option<String>)`](crate::input::UpdateLogPatternInput::pattern_set_name): <p>The name of the log pattern set.</p>
    ///   - [`pattern_name(Option<String>)`](crate::input::UpdateLogPatternInput::pattern_name): <p>The name of the log pattern.</p>
    ///   - [`pattern(Option<String>)`](crate::input::UpdateLogPatternInput::pattern): <p>The log pattern. The pattern must be DFA compatible. Patterns that utilize forward lookahead or backreference constructions are not supported.</p>
    ///   - [`rank(i32)`](crate::input::UpdateLogPatternInput::rank): <p>Rank of the log pattern. Must be a value between <code>1</code> and <code>1,000,000</code>. The patterns are sorted by rank, so we recommend that you set your highest priority patterns with the lowest rank. A pattern of rank <code>1</code> will be the first to get matched to a log line. A pattern of rank <code>1,000,000</code> will be last to get matched. When you configure custom log patterns from the console, a <code>Low</code> severity pattern translates to a <code>750,000</code> rank. A <code>Medium</code> severity pattern translates to a <code>500,000</code> rank. And a <code>High</code> severity pattern translates to a <code>250,000</code> rank. Rank values less than <code>1</code> or greater than <code>1,000,000</code> are reserved for AWS-provided patterns. </p>
