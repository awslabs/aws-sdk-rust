...
pub fn ser_list_applications_input(
    input: &crate::operation::list_applications::ListApplicationsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        let encoder = &mut encoder;
        crate::protocol_serde::shape_list_applications_input::ser_list_applications_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::list_applications::builders::ListApplicationsOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
{
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "ApplicationInfoList" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(
                    builder.set_application_info_list(Some(crate::protocol_serde::shape_application_info_list::de_application_info_list(
                        decoder,
                        depth + 1,
                    )?)),
                )
