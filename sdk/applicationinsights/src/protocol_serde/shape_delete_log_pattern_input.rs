...
pub fn ser_delete_log_pattern_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteLogPatternInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
