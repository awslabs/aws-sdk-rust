...
pub fn ser_create_component_input(
    ...
    crate::protocol_serde::shape_create_component_input::ser_create_component_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    Err(match error_code {
        ...
        "ResourceInUseException" => {
            crate::operation::create_component::CreateComponentError::ResourceInUseException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundException" => {
            crate::operation::create_component::CreateComponentError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ValidationException" => {
            crate::operation::create_component::CreateComponentError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
