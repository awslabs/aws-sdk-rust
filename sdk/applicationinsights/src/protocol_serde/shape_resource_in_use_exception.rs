...
pub(crate) fn de_resource_in_use_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ResourceInUseExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ResourceInUseExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
