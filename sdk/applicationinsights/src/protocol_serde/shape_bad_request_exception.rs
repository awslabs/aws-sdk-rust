...
pub(crate) fn de_bad_request_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::BadRequestExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::BadRequestExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
