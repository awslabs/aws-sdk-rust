                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SeverityLevel" => {
                            builder = builder.set_severity_level(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::SeverityLevel::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "AccountId" => {
                        ...
                        "Feedback" => {
                            builder = builder.set_feedback(crate::protocol_serde::shape_feedback::de_feedback(tokens, _value, depth + 1)?);
                        }
                        "RecurringCount" => {
                        ...
                        "LastRecurrenceTime" => {
                            builder = builder.set_last_recurrence_time(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                                tokens.next(),
                                ::aws_smithy_types::date_time::Format::EpochSeconds,
                            )?);
                        }
                        ...
                        "ResolutionMethod" => {
                            builder = builder.set_resolution_method(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ResolutionMethod::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
