...
pub fn ser_update_log_pattern_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLogPatternInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
