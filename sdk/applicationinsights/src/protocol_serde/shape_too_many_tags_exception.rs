...
pub(crate) fn de_too_many_tags_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::TooManyTagsExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::TooManyTagsExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    fn pair(
        ...
        builder =
            match decoder.str()?.as_ref() {
                ...
                "ResourceName" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                    Ok(builder.set_resource_name(Some(decoder.string()?)))
                })?,
                _ => {
                    decoder.skip()?;
                    builder
