...
pub fn ser_list_configuration_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListConfigurationHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
