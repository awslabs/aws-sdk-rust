...
pub fn ser_describe_log_pattern_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeLogPatternInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
