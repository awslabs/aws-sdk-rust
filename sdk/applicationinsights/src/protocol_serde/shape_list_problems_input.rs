...
pub fn ser_list_problems_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListProblemsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
