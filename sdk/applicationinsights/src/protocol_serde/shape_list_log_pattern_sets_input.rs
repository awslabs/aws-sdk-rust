...
pub fn ser_list_log_pattern_sets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLogPatternSetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
