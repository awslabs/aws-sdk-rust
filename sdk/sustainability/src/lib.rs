...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-sustainability/latest/aws_sdk_sustainability/client/struct.Client.html)
...
/// let config = aws_sdk_sustainability::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`GetEstimatedCarbonEmissions`](crate::operation::get_estimated_carbon_emissions) operation has
/// a [`Client::get_estimated_carbon_emissions`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.get_estimated_carbon_emissions()
///     .granularity("example")
///     .send()
///     .await;
/// ```
