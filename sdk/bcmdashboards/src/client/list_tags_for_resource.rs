...
impl super::Client {
    ...
    ///   - [`resource_tags(Option<Vec::<ResourceTag>>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::resource_tags): <p>The list of tags associated with the specified dashboard resource.</p>
