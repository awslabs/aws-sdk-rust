...
pub struct DescribeValidDbInstanceModificationsOutput  {
    ...
    #[doc(hidden)]pub valid_db_instance_modifications_message: std::option::Option<crate::model::ValidDbInstanceModificationsMessage>,
}
...
impl  std::fmt::Debug for DescribeValidDbInstanceModificationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("valid_db_instance_modifications_message", &self.valid_db_instance_modifications_message);
        formatter.finish()
    }
}
...
pub struct DescribeDbParameterGroupsOutput  {
    ...
    #[doc(hidden)]pub db_parameter_groups: std::option::Option<std::vec::Vec<crate::model::DbParameterGroup>>,
}
...
pub struct DescribeDbClusterEndpointsOutput  {
    ...
    #[doc(hidden)]pub db_cluster_endpoints: std::option::Option<std::vec::Vec<crate::model::DbClusterEndpoint>>,
}
...
pub struct CreateDbParameterGroupOutput  {
    ...
    #[doc(hidden)]pub db_parameter_group: std::option::Option<crate::model::DbParameterGroup>,
}
