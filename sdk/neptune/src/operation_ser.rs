...
pub fn serialize_operation_crate_operation_create_db_cluster(input: &crate::input::CreateDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_123 = writer.prefix("GlobalClusterIdentifier");
...
pub fn serialize_operation_crate_operation_create_db_cluster_endpoint(input: &crate::input::CreateDbClusterEndpointInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_125 = writer.prefix("DBClusterIdentifier");
    if let Some(var_126) = &input.db_cluster_identifier {
        scope_125.string(var_126);
    }
    #[allow(unused_mut)]let mut scope_127 = writer.prefix("DBClusterEndpointIdentifier");
    if let Some(var_128) = &input.db_cluster_endpoint_identifier {
        scope_127.string(var_128);
    }
    #[allow(unused_mut)]let mut scope_129 = writer.prefix("EndpointType");
    if let Some(var_130) = &input.endpoint_type {
        scope_129.string(var_130);
    }
    #[allow(unused_mut)]let mut scope_131 = writer.prefix("StaticMembers");
    ...
    #[allow(unused_mut)]let mut scope_136 = writer.prefix("ExcludedMembers");
...
pub fn serialize_operation_crate_operation_create_db_cluster_parameter_group(input: &crate::input::CreateDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_146 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_147) = &input.db_cluster_parameter_group_name {
        scope_146.string(var_147);
    }
    #[allow(unused_mut)]let mut scope_148 = writer.prefix("DBParameterGroupFamily");
    if let Some(var_149) = &input.db_parameter_group_family {
        scope_148.string(var_149);
    }
    #[allow(unused_mut)]let mut scope_150 = writer.prefix("Description");
...
pub fn serialize_operation_crate_operation_create_db_cluster_snapshot(input: &crate::input::CreateDbClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_157 = writer.prefix("DBClusterSnapshotIdentifier");
    if let Some(var_158) = &input.db_cluster_snapshot_identifier {
        scope_157.string(var_158);
    }
    #[allow(unused_mut)]let mut scope_159 = writer.prefix("DBClusterIdentifier");
    if let Some(var_160) = &input.db_cluster_identifier {
        scope_159.string(var_160);
    }
    #[allow(unused_mut)]let mut scope_161 = writer.prefix("Tags");
...
pub fn serialize_operation_crate_operation_create_db_instance(input: &crate::input::CreateDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_166 = writer.prefix("DBName");
    if let Some(var_167) = &input.db_name {
        scope_166.string(var_167);
    }
    #[allow(unused_mut)]let mut scope_168 = writer.prefix("DBInstanceIdentifier");
    if let Some(var_169) = &input.db_instance_identifier {
        scope_168.string(var_169);
    }
    #[allow(unused_mut)]let mut scope_170 = writer.prefix("AllocatedStorage");
    if let Some(var_171) = &input.allocated_storage {
        scope_170.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_171).into()));
    }
    #[allow(unused_mut)]let mut scope_172 = writer.prefix("DBInstanceClass");
    if let Some(var_173) = &input.db_instance_class {
        scope_172.string(var_173);
    }
    #[allow(unused_mut)]let mut scope_174 = writer.prefix("Engine");
    if let Some(var_175) = &input.engine {
        scope_174.string(var_175);
    }
    #[allow(unused_mut)]let mut scope_176 = writer.prefix("MasterUsername");
    if let Some(var_177) = &input.master_username {
        scope_176.string(var_177);
    }
    #[allow(unused_mut)]let mut scope_178 = writer.prefix("MasterUserPassword");
    if let Some(var_179) = &input.master_user_password {
        scope_178.string(var_179);
    }
    #[allow(unused_mut)]let mut scope_180 = writer.prefix("DBSecurityGroups");
    ...
    #[allow(unused_mut)]let mut scope_185 = writer.prefix("VpcSecurityGroupIds");
    ...
    #[allow(unused_mut)]let mut scope_190 = writer.prefix("AvailabilityZone");
    if let Some(var_191) = &input.availability_zone {
        scope_190.string(var_191);
    }
    #[allow(unused_mut)]let mut scope_192 = writer.prefix("DBSubnetGroupName");
    if let Some(var_193) = &input.db_subnet_group_name {
        scope_192.string(var_193);
    }
    #[allow(unused_mut)]let mut scope_194 = writer.prefix("PreferredMaintenanceWindow");
    if let Some(var_195) = &input.preferred_maintenance_window {
        scope_194.string(var_195);
    }
    #[allow(unused_mut)]let mut scope_196 = writer.prefix("DBParameterGroupName");
    if let Some(var_197) = &input.db_parameter_group_name {
        scope_196.string(var_197);
    }
    #[allow(unused_mut)]let mut scope_198 = writer.prefix("BackupRetentionPeriod");
    if let Some(var_199) = &input.backup_retention_period {
        scope_198.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_199).into()));
    }
    #[allow(unused_mut)]let mut scope_200 = writer.prefix("PreferredBackupWindow");
    if let Some(var_201) = &input.preferred_backup_window {
        scope_200.string(var_201);
    }
    #[allow(unused_mut)]let mut scope_202 = writer.prefix("Port");
    ...
    #[allow(unused_mut)]let mut scope_204 = writer.prefix("MultiAZ");
    if let Some(var_205) = &input.multi_az {
        scope_204.boolean(*var_205);
    }
    #[allow(unused_mut)]let mut scope_206 = writer.prefix("EngineVersion");
    if let Some(var_207) = &input.engine_version {
        scope_206.string(var_207);
    }
    #[allow(unused_mut)]let mut scope_208 = writer.prefix("AutoMinorVersionUpgrade");
    if let Some(var_209) = &input.auto_minor_version_upgrade {
        scope_208.boolean(*var_209);
    }
    #[allow(unused_mut)]let mut scope_210 = writer.prefix("LicenseModel");
    if let Some(var_211) = &input.license_model {
        scope_210.string(var_211);
    }
    #[allow(unused_mut)]let mut scope_212 = writer.prefix("Iops");
    ...
    #[allow(unused_mut)]let mut scope_214 = writer.prefix("OptionGroupName");
    if let Some(var_215) = &input.option_group_name {
        scope_214.string(var_215);
    }
    #[allow(unused_mut)]let mut scope_216 = writer.prefix("CharacterSetName");
    if let Some(var_217) = &input.character_set_name {
        scope_216.string(var_217);
    }
    #[allow(unused_mut)]let mut scope_218 = writer.prefix("PubliclyAccessible");
    if let Some(var_219) = &input.publicly_accessible {
        scope_218.boolean(*var_219);
    }
    #[allow(unused_mut)]let mut scope_220 = writer.prefix("Tags");
    ...
    #[allow(unused_mut)]let mut scope_225 = writer.prefix("DBClusterIdentifier");
    if let Some(var_226) = &input.db_cluster_identifier {
        scope_225.string(var_226);
    }
    #[allow(unused_mut)]let mut scope_227 = writer.prefix("StorageType");
    if let Some(var_228) = &input.storage_type {
        scope_227.string(var_228);
    }
    #[allow(unused_mut)]let mut scope_229 = writer.prefix("TdeCredentialArn");
    if let Some(var_230) = &input.tde_credential_arn {
        scope_229.string(var_230);
    }
    #[allow(unused_mut)]let mut scope_231 = writer.prefix("TdeCredentialPassword");
    if let Some(var_232) = &input.tde_credential_password {
        scope_231.string(var_232);
    }
    #[allow(unused_mut)]let mut scope_233 = writer.prefix("StorageEncrypted");
    if let Some(var_234) = &input.storage_encrypted {
        scope_233.boolean(*var_234);
    }
    #[allow(unused_mut)]let mut scope_235 = writer.prefix("KmsKeyId");
    if let Some(var_236) = &input.kms_key_id {
        scope_235.string(var_236);
    }
    #[allow(unused_mut)]let mut scope_237 = writer.prefix("Domain");
    if let Some(var_238) = &input.domain {
        scope_237.string(var_238);
    }
    #[allow(unused_mut)]let mut scope_239 = writer.prefix("CopyTagsToSnapshot");
    if let Some(var_240) = &input.copy_tags_to_snapshot {
        scope_239.boolean(*var_240);
    }
    #[allow(unused_mut)]let mut scope_241 = writer.prefix("MonitoringInterval");
    ...
    #[allow(unused_mut)]let mut scope_243 = writer.prefix("MonitoringRoleArn");
    if let Some(var_244) = &input.monitoring_role_arn {
        scope_243.string(var_244);
    }
    #[allow(unused_mut)]let mut scope_245 = writer.prefix("DomainIAMRoleName");
    if let Some(var_246) = &input.domain_iam_role_name {
        scope_245.string(var_246);
    }
    #[allow(unused_mut)]let mut scope_247 = writer.prefix("PromotionTier");
    if let Some(var_248) = &input.promotion_tier {
        scope_247.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_248).into()));
    }
    #[allow(unused_mut)]let mut scope_249 = writer.prefix("Timezone");
    if let Some(var_250) = &input.timezone {
        scope_249.string(var_250);
    }
    #[allow(unused_mut)]let mut scope_251 = writer.prefix("EnableIAMDatabaseAuthentication");
    if let Some(var_252) = &input.enable_iam_database_authentication {
        scope_251.boolean(*var_252);
    }
    #[allow(unused_mut)]let mut scope_253 = writer.prefix("EnablePerformanceInsights");
    if let Some(var_254) = &input.enable_performance_insights {
        scope_253.boolean(*var_254);
    }
    #[allow(unused_mut)]let mut scope_255 = writer.prefix("PerformanceInsightsKMSKeyId");
    if let Some(var_256) = &input.performance_insights_kms_key_id {
        scope_255.string(var_256);
    }
    #[allow(unused_mut)]let mut scope_257 = writer.prefix("EnableCloudwatchLogsExports");
    if let Some(var_258) = &input.enable_cloudwatch_logs_exports {
        ...
        for item_259 in var_258 {
            #[allow(unused_mut)]let mut entry_261 = list_260.entry();
            entry_261.string(item_259);
        }
        list_260.finish();
    }
    #[allow(unused_mut)]let mut scope_262 = writer.prefix("DeletionProtection");
...
pub fn serialize_operation_crate_operation_create_db_subnet_group(input: &crate::input::CreateDbSubnetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_275 = writer.prefix("DBSubnetGroupName");
    if let Some(var_276) = &input.db_subnet_group_name {
        scope_275.string(var_276);
    }
    #[allow(unused_mut)]let mut scope_277 = writer.prefix("DBSubnetGroupDescription");
    if let Some(var_278) = &input.db_subnet_group_description {
        scope_277.string(var_278);
    }
    #[allow(unused_mut)]let mut scope_279 = writer.prefix("SubnetIds");
...
pub fn serialize_operation_crate_operation_create_event_subscription(input: &crate::input::CreateEventSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_289 = writer.prefix("SubscriptionName");
    if let Some(var_290) = &input.subscription_name {
        scope_289.string(var_290);
    }
    #[allow(unused_mut)]let mut scope_291 = writer.prefix("SnsTopicArn");
    if let Some(var_292) = &input.sns_topic_arn {
        scope_291.string(var_292);
    }
    #[allow(unused_mut)]let mut scope_293 = writer.prefix("SourceType");
    if let Some(var_294) = &input.source_type {
        scope_293.string(var_294);
    }
    #[allow(unused_mut)]let mut scope_295 = writer.prefix("EventCategories");
    ...
    #[allow(unused_mut)]let mut scope_300 = writer.prefix("SourceIds");
    ...
    #[allow(unused_mut)]let mut scope_305 = writer.prefix("Enabled");
    if let Some(var_306) = &input.enabled {
        scope_305.boolean(*var_306);
    }
    #[allow(unused_mut)]let mut scope_307 = writer.prefix("Tags");
...
pub fn serialize_operation_crate_operation_create_global_cluster(input: &crate::input::CreateGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_312 = writer.prefix("GlobalClusterIdentifier");
    if let Some(var_313) = &input.global_cluster_identifier {
        scope_312.string(var_313);
    }
    #[allow(unused_mut)]let mut scope_314 = writer.prefix("SourceDBClusterIdentifier");
    if let Some(var_315) = &input.source_db_cluster_identifier {
        scope_314.string(var_315);
    }
    #[allow(unused_mut)]let mut scope_316 = writer.prefix("Engine");
    if let Some(var_317) = &input.engine {
        scope_316.string(var_317);
    }
    #[allow(unused_mut)]let mut scope_318 = writer.prefix("EngineVersion");
    if let Some(var_319) = &input.engine_version {
        scope_318.string(var_319);
    }
    #[allow(unused_mut)]let mut scope_320 = writer.prefix("DeletionProtection");
    if let Some(var_321) = &input.deletion_protection {
        scope_320.boolean(*var_321);
    }
    #[allow(unused_mut)]let mut scope_322 = writer.prefix("StorageEncrypted");
...
pub fn serialize_operation_crate_operation_delete_db_cluster(input: &crate::input::DeleteDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_324 = writer.prefix("DBClusterIdentifier");
    if let Some(var_325) = &input.db_cluster_identifier {
        scope_324.string(var_325);
    }
    #[allow(unused_mut)]let mut scope_326 = writer.prefix("SkipFinalSnapshot");
    if input.skip_final_snapshot {
        scope_326.boolean(input.skip_final_snapshot);
    }
    #[allow(unused_mut)]let mut scope_327 = writer.prefix("FinalDBSnapshotIdentifier");
...
pub fn serialize_operation_crate_operation_delete_db_cluster_endpoint(input: &crate::input::DeleteDbClusterEndpointInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_329 = writer.prefix("DBClusterEndpointIdentifier");
...
pub fn serialize_operation_crate_operation_delete_db_cluster_parameter_group(input: &crate::input::DeleteDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_331 = writer.prefix("DBClusterParameterGroupName");
...
pub fn serialize_operation_crate_operation_delete_db_cluster_snapshot(input: &crate::input::DeleteDbClusterSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_333 = writer.prefix("DBClusterSnapshotIdentifier");
...
pub fn serialize_operation_crate_operation_delete_db_instance(input: &crate::input::DeleteDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_335 = writer.prefix("DBInstanceIdentifier");
    if let Some(var_336) = &input.db_instance_identifier {
        scope_335.string(var_336);
    }
    #[allow(unused_mut)]let mut scope_337 = writer.prefix("SkipFinalSnapshot");
    if input.skip_final_snapshot {
        scope_337.boolean(input.skip_final_snapshot);
    }
    #[allow(unused_mut)]let mut scope_338 = writer.prefix("FinalDBSnapshotIdentifier");
...
pub fn serialize_operation_crate_operation_delete_db_parameter_group(input: &crate::input::DeleteDbParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_340 = writer.prefix("DBParameterGroupName");
...
pub fn serialize_operation_crate_operation_delete_db_subnet_group(input: &crate::input::DeleteDbSubnetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_342 = writer.prefix("DBSubnetGroupName");
...
pub fn serialize_operation_crate_operation_delete_event_subscription(input: &crate::input::DeleteEventSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_344 = writer.prefix("SubscriptionName");
...
pub fn serialize_operation_crate_operation_delete_global_cluster(input: &crate::input::DeleteGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_346 = writer.prefix("GlobalClusterIdentifier");
...
pub fn serialize_operation_crate_operation_describe_db_cluster_endpoints(input: &crate::input::DescribeDbClusterEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_348 = writer.prefix("DBClusterIdentifier");
    if let Some(var_349) = &input.db_cluster_identifier {
        scope_348.string(var_349);
    }
    #[allow(unused_mut)]let mut scope_350 = writer.prefix("DBClusterEndpointIdentifier");
    if let Some(var_351) = &input.db_cluster_endpoint_identifier {
        scope_350.string(var_351);
    }
    #[allow(unused_mut)]let mut scope_352 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_357 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_359 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_cluster_parameter_groups(input: &crate::input::DescribeDbClusterParameterGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_361 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_362) = &input.db_cluster_parameter_group_name {
        scope_361.string(var_362);
    }
    #[allow(unused_mut)]let mut scope_363 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_368 = writer.prefix("MaxRecords");
    if let Some(var_369) = &input.max_records {
        scope_368.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_369).into()));
    }
    #[allow(unused_mut)]let mut scope_370 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_cluster_parameters(input: &crate::input::DescribeDbClusterParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_372 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_373) = &input.db_cluster_parameter_group_name {
        scope_372.string(var_373);
    }
    #[allow(unused_mut)]let mut scope_374 = writer.prefix("Source");
    if let Some(var_375) = &input.source {
        scope_374.string(var_375);
    }
    #[allow(unused_mut)]let mut scope_376 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_381 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_383 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_clusters(input: &crate::input::DescribeDbClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_385 = writer.prefix("DBClusterIdentifier");
    if let Some(var_386) = &input.db_cluster_identifier {
        scope_385.string(var_386);
    }
    #[allow(unused_mut)]let mut scope_387 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_392 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_394 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_cluster_snapshot_attributes(input: &crate::input::DescribeDbClusterSnapshotAttributesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_396 = writer.prefix("DBClusterSnapshotIdentifier");
...
pub fn serialize_operation_crate_operation_describe_db_cluster_snapshots(input: &crate::input::DescribeDbClusterSnapshotsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_398 = writer.prefix("DBClusterIdentifier");
    if let Some(var_399) = &input.db_cluster_identifier {
        scope_398.string(var_399);
    }
    #[allow(unused_mut)]let mut scope_400 = writer.prefix("DBClusterSnapshotIdentifier");
    if let Some(var_401) = &input.db_cluster_snapshot_identifier {
        scope_400.string(var_401);
    }
    #[allow(unused_mut)]let mut scope_402 = writer.prefix("SnapshotType");
    if let Some(var_403) = &input.snapshot_type {
        scope_402.string(var_403);
    }
    #[allow(unused_mut)]let mut scope_404 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_413 = writer.prefix("IncludeShared");
    if input.include_shared {
        scope_413.boolean(input.include_shared);
    }
    #[allow(unused_mut)]let mut scope_414 = writer.prefix("IncludePublic");
...
pub fn serialize_operation_crate_operation_describe_db_engine_versions(input: &crate::input::DescribeDbEngineVersionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_415 = writer.prefix("Engine");
    if let Some(var_416) = &input.engine {
        scope_415.string(var_416);
    }
    #[allow(unused_mut)]let mut scope_417 = writer.prefix("EngineVersion");
    if let Some(var_418) = &input.engine_version {
        scope_417.string(var_418);
    }
    #[allow(unused_mut)]let mut scope_419 = writer.prefix("DBParameterGroupFamily");
    if let Some(var_420) = &input.db_parameter_group_family {
        scope_419.string(var_420);
    }
    #[allow(unused_mut)]let mut scope_421 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_426 = writer.prefix("MaxRecords");
    if let Some(var_427) = &input.max_records {
        scope_426.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_427).into()));
    }
    #[allow(unused_mut)]let mut scope_428 = writer.prefix("Marker");
    if let Some(var_429) = &input.marker {
        scope_428.string(var_429);
    }
    #[allow(unused_mut)]let mut scope_430 = writer.prefix("DefaultOnly");
    if input.default_only {
        scope_430.boolean(input.default_only);
    }
    #[allow(unused_mut)]let mut scope_431 = writer.prefix("ListSupportedCharacterSets");
    if let Some(var_432) = &input.list_supported_character_sets {
        scope_431.boolean(*var_432);
    }
    #[allow(unused_mut)]let mut scope_433 = writer.prefix("ListSupportedTimezones");
...
pub fn serialize_operation_crate_operation_describe_db_instances(input: &crate::input::DescribeDbInstancesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_435 = writer.prefix("DBInstanceIdentifier");
    if let Some(var_436) = &input.db_instance_identifier {
        scope_435.string(var_436);
    }
    #[allow(unused_mut)]let mut scope_437 = writer.prefix("Filters");
    if let Some(var_438) = &input.filters {
        let mut list_440 = scope_437.start_list(false, Some("Filter"));
        for item_439 in var_438 {
            #[allow(unused_mut)]let mut entry_441 = list_440.entry();
            crate::query_ser::serialize_structure_crate_model_filter(entry_441, item_439)?;
        }
        list_440.finish();
    }
    #[allow(unused_mut)]let mut scope_442 = writer.prefix("MaxRecords");
    if let Some(var_443) = &input.max_records {
        scope_442.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_443).into()));
    }
    #[allow(unused_mut)]let mut scope_444 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_parameter_groups(input: &crate::input::DescribeDbParameterGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_446 = writer.prefix("DBParameterGroupName");
    if let Some(var_447) = &input.db_parameter_group_name {
        scope_446.string(var_447);
    }
    #[allow(unused_mut)]let mut scope_448 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_453 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_455 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_parameters(input: &crate::input::DescribeDbParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_468 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_db_subnet_groups(input: &crate::input::DescribeDbSubnetGroupsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_470 = writer.prefix("DBSubnetGroupName");
    if let Some(var_471) = &input.db_subnet_group_name {
        scope_470.string(var_471);
    }
    #[allow(unused_mut)]let mut scope_472 = writer.prefix("Filters");
    if let Some(var_473) = &input.filters {
        let mut list_475 = scope_472.start_list(false, Some("Filter"));
        for item_474 in var_473 {
            #[allow(unused_mut)]let mut entry_476 = list_475.entry();
            crate::query_ser::serialize_structure_crate_model_filter(entry_476, item_474)?;
        }
        list_475.finish();
    }
    #[allow(unused_mut)]let mut scope_477 = writer.prefix("MaxRecords");
    if let Some(var_478) = &input.max_records {
        scope_477.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_478).into()));
    }
    #[allow(unused_mut)]let mut scope_479 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_engine_default_cluster_parameters(input: &crate::input::DescribeEngineDefaultClusterParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_481 = writer.prefix("DBParameterGroupFamily");
    if let Some(var_482) = &input.db_parameter_group_family {
        scope_481.string(var_482);
    }
    #[allow(unused_mut)]let mut scope_483 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_488 = writer.prefix("MaxRecords");
    if let Some(var_489) = &input.max_records {
        scope_488.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_489).into()));
    }
    #[allow(unused_mut)]let mut scope_490 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_engine_default_parameters(input: &crate::input::DescribeEngineDefaultParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_492 = writer.prefix("DBParameterGroupFamily");
    if let Some(var_493) = &input.db_parameter_group_family {
        scope_492.string(var_493);
    }
    #[allow(unused_mut)]let mut scope_494 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_499 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_501 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_event_categories(input: &crate::input::DescribeEventCategoriesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_503 = writer.prefix("SourceType");
    if let Some(var_504) = &input.source_type {
        scope_503.string(var_504);
    }
    #[allow(unused_mut)]let mut scope_505 = writer.prefix("Filters");
...
pub fn serialize_operation_crate_operation_describe_events(input: &crate::input::DescribeEventsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_510 = writer.prefix("SourceIdentifier");
    if let Some(var_511) = &input.source_identifier {
        scope_510.string(var_511);
    }
    #[allow(unused_mut)]let mut scope_512 = writer.prefix("SourceType");
    if let Some(var_513) = &input.source_type {
        scope_512.string(var_513.as_str());
    }
    #[allow(unused_mut)]let mut scope_514 = writer.prefix("StartTime");
    if let Some(var_515) = &input.start_time {
        scope_514.date_time(var_515, aws_smithy_types::date_time::Format::DateTime)?;
    }
    #[allow(unused_mut)]let mut scope_516 = writer.prefix("EndTime");
    if let Some(var_517) = &input.end_time {
        scope_516.date_time(var_517, aws_smithy_types::date_time::Format::DateTime)?;
    }
    #[allow(unused_mut)]let mut scope_518 = writer.prefix("Duration");
    if let Some(var_519) = &input.duration {
        scope_518.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_519).into()));
    }
    #[allow(unused_mut)]let mut scope_520 = writer.prefix("EventCategories");
    ...
    #[allow(unused_mut)]let mut scope_525 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_530 = writer.prefix("MaxRecords");
    ...
    #[allow(unused_mut)]let mut scope_532 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_event_subscriptions(input: &crate::input::DescribeEventSubscriptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_534 = writer.prefix("SubscriptionName");
    if let Some(var_535) = &input.subscription_name {
        scope_534.string(var_535);
    }
    #[allow(unused_mut)]let mut scope_536 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_541 = writer.prefix("MaxRecords");
    if let Some(var_542) = &input.max_records {
        scope_541.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_542).into()));
    }
    #[allow(unused_mut)]let mut scope_543 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_global_clusters(input: &crate::input::DescribeGlobalClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_545 = writer.prefix("GlobalClusterIdentifier");
...
pub fn serialize_operation_crate_operation_describe_orderable_db_instance_options(input: &crate::input::DescribeOrderableDbInstanceOptionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_551 = writer.prefix("Engine");
    if let Some(var_552) = &input.engine {
        scope_551.string(var_552);
    }
    #[allow(unused_mut)]let mut scope_553 = writer.prefix("EngineVersion");
    if let Some(var_554) = &input.engine_version {
        scope_553.string(var_554);
    }
    #[allow(unused_mut)]let mut scope_555 = writer.prefix("DBInstanceClass");
    if let Some(var_556) = &input.db_instance_class {
        scope_555.string(var_556);
    }
    #[allow(unused_mut)]let mut scope_557 = writer.prefix("LicenseModel");
    if let Some(var_558) = &input.license_model {
        scope_557.string(var_558);
    }
    #[allow(unused_mut)]let mut scope_559 = writer.prefix("Vpc");
    if let Some(var_560) = &input.vpc {
        scope_559.boolean(*var_560);
    }
    #[allow(unused_mut)]let mut scope_561 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_566 = writer.prefix("MaxRecords");
    if let Some(var_567) = &input.max_records {
        scope_566.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_567).into()));
    }
    #[allow(unused_mut)]let mut scope_568 = writer.prefix("Marker");
...
pub fn serialize_operation_crate_operation_describe_pending_maintenance_actions(input: &crate::input::DescribePendingMaintenanceActionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_570 = writer.prefix("ResourceIdentifier");
    if let Some(var_571) = &input.resource_identifier {
        scope_570.string(var_571);
    }
    #[allow(unused_mut)]let mut scope_572 = writer.prefix("Filters");
    ...
    #[allow(unused_mut)]let mut scope_577 = writer.prefix("Marker");
    if let Some(var_578) = &input.marker {
        scope_577.string(var_578);
    }
    #[allow(unused_mut)]let mut scope_579 = writer.prefix("MaxRecords");
    if let Some(var_580) = &input.max_records {
        scope_579.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_580).into()));
    }
    writer.finish();
    Ok(aws_smithy_http::body::SdkBody::from(out))
}
...
pub fn serialize_operation_crate_operation_describe_valid_db_instance_modifications(input: &crate::input::DescribeValidDbInstanceModificationsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_581 = writer.prefix("DBInstanceIdentifier");
...
pub fn serialize_operation_crate_operation_failover_db_cluster(input: &crate::input::FailoverDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_583 = writer.prefix("DBClusterIdentifier");
    if let Some(var_584) = &input.db_cluster_identifier {
        scope_583.string(var_584);
    }
    #[allow(unused_mut)]let mut scope_585 = writer.prefix("TargetDBInstanceIdentifier");
...
pub fn serialize_operation_crate_operation_failover_global_cluster(input: &crate::input::FailoverGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_587 = writer.prefix("GlobalClusterIdentifier");
    if let Some(var_588) = &input.global_cluster_identifier {
        scope_587.string(var_588);
    }
    #[allow(unused_mut)]let mut scope_589 = writer.prefix("TargetDbClusterIdentifier");
...
pub fn serialize_operation_crate_operation_modify_db_cluster(input: &crate::input::ModifyDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_598 = writer.prefix("DBClusterIdentifier");
    if let Some(var_599) = &input.db_cluster_identifier {
        scope_598.string(var_599);
    }
    #[allow(unused_mut)]let mut scope_600 = writer.prefix("NewDBClusterIdentifier");
    if let Some(var_601) = &input.new_db_cluster_identifier {
        scope_600.string(var_601);
    }
    #[allow(unused_mut)]let mut scope_602 = writer.prefix("ApplyImmediately");
    if input.apply_immediately {
        scope_602.boolean(input.apply_immediately);
    }
    #[allow(unused_mut)]let mut scope_603 = writer.prefix("BackupRetentionPeriod");
    if let Some(var_604) = &input.backup_retention_period {
        scope_603.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_604).into()));
    }
    #[allow(unused_mut)]let mut scope_605 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_606) = &input.db_cluster_parameter_group_name {
        scope_605.string(var_606);
    }
    #[allow(unused_mut)]let mut scope_607 = writer.prefix("VpcSecurityGroupIds");
    ...
    #[allow(unused_mut)]let mut scope_612 = writer.prefix("Port");
    ...
    #[allow(unused_mut)]let mut scope_614 = writer.prefix("MasterUserPassword");
    if let Some(var_615) = &input.master_user_password {
        scope_614.string(var_615);
    }
    #[allow(unused_mut)]let mut scope_616 = writer.prefix("OptionGroupName");
    if let Some(var_617) = &input.option_group_name {
        scope_616.string(var_617);
    }
    #[allow(unused_mut)]let mut scope_618 = writer.prefix("PreferredBackupWindow");
    if let Some(var_619) = &input.preferred_backup_window {
        scope_618.string(var_619);
    }
    #[allow(unused_mut)]let mut scope_620 = writer.prefix("PreferredMaintenanceWindow");
    if let Some(var_621) = &input.preferred_maintenance_window {
        scope_620.string(var_621);
    }
    #[allow(unused_mut)]let mut scope_622 = writer.prefix("EnableIAMDatabaseAuthentication");
    if let Some(var_623) = &input.enable_iam_database_authentication {
        scope_622.boolean(*var_623);
    }
    #[allow(unused_mut)]let mut scope_624 = writer.prefix("CloudwatchLogsExportConfiguration");
    if let Some(var_625) = &input.cloudwatch_logs_export_configuration {
        crate::query_ser::serialize_structure_crate_model_cloudwatch_logs_export_configuration(scope_624, var_625)?;
    }
    #[allow(unused_mut)]let mut scope_626 = writer.prefix("EngineVersion");
    if let Some(var_627) = &input.engine_version {
        scope_626.string(var_627);
    }
    #[allow(unused_mut)]let mut scope_628 = writer.prefix("AllowMajorVersionUpgrade");
    if input.allow_major_version_upgrade {
        scope_628.boolean(input.allow_major_version_upgrade);
    }
    #[allow(unused_mut)]let mut scope_629 = writer.prefix("DBInstanceParameterGroupName");
    if let Some(var_630) = &input.db_instance_parameter_group_name {
        scope_629.string(var_630);
    }
    #[allow(unused_mut)]let mut scope_631 = writer.prefix("DeletionProtection");
    if let Some(var_632) = &input.deletion_protection {
        scope_631.boolean(*var_632);
    }
    #[allow(unused_mut)]let mut scope_633 = writer.prefix("CopyTagsToSnapshot");
...
pub fn serialize_operation_crate_operation_modify_db_cluster_endpoint(input: &crate::input::ModifyDbClusterEndpointInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_637 = writer.prefix("EndpointType");
    if let Some(var_638) = &input.endpoint_type {
        scope_637.string(var_638);
    }
    #[allow(unused_mut)]let mut scope_639 = writer.prefix("StaticMembers");
    if let Some(var_640) = &input.static_members {
        let mut list_642 = scope_639.start_list(false, None);
        for item_641 in var_640 {
            #[allow(unused_mut)]let mut entry_643 = list_642.entry();
            entry_643.string(item_641);
        }
        list_642.finish();
    }
    #[allow(unused_mut)]let mut scope_644 = writer.prefix("ExcludedMembers");
...
pub fn serialize_operation_crate_operation_modify_db_cluster_parameter_group(input: &crate::input::ModifyDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_649 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_650) = &input.db_cluster_parameter_group_name {
        scope_649.string(var_650);
    }
    #[allow(unused_mut)]let mut scope_651 = writer.prefix("Parameters");
...
pub fn serialize_operation_crate_operation_modify_db_cluster_snapshot_attribute(input: &crate::input::ModifyDbClusterSnapshotAttributeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_656 = writer.prefix("DBClusterSnapshotIdentifier");
    if let Some(var_657) = &input.db_cluster_snapshot_identifier {
        scope_656.string(var_657);
    }
    #[allow(unused_mut)]let mut scope_658 = writer.prefix("AttributeName");
    if let Some(var_659) = &input.attribute_name {
        scope_658.string(var_659);
    }
    #[allow(unused_mut)]let mut scope_660 = writer.prefix("ValuesToAdd");
    ...
    #[allow(unused_mut)]let mut scope_665 = writer.prefix("ValuesToRemove");
    if let Some(var_666) = &input.values_to_remove {
        ...
        for item_667 in var_666 {
            #[allow(unused_mut)]let mut entry_669 = list_668.entry();
...
pub fn serialize_operation_crate_operation_modify_db_instance(input: &crate::input::ModifyDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_670 = writer.prefix("DBInstanceIdentifier");
    if let Some(var_671) = &input.db_instance_identifier {
        scope_670.string(var_671);
    }
    #[allow(unused_mut)]let mut scope_672 = writer.prefix("AllocatedStorage");
    if let Some(var_673) = &input.allocated_storage {
        scope_672.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_673).into()));
    }
    #[allow(unused_mut)]let mut scope_674 = writer.prefix("DBInstanceClass");
    if let Some(var_675) = &input.db_instance_class {
        scope_674.string(var_675);
    }
    #[allow(unused_mut)]let mut scope_676 = writer.prefix("DBSubnetGroupName");
    if let Some(var_677) = &input.db_subnet_group_name {
        scope_676.string(var_677);
    }
    #[allow(unused_mut)]let mut scope_678 = writer.prefix("DBSecurityGroups");
    ...
    #[allow(unused_mut)]let mut scope_683 = writer.prefix("VpcSecurityGroupIds");
    ...
    #[allow(unused_mut)]let mut scope_688 = writer.prefix("ApplyImmediately");
    if input.apply_immediately {
        scope_688.boolean(input.apply_immediately);
    }
    #[allow(unused_mut)]let mut scope_689 = writer.prefix("MasterUserPassword");
    if let Some(var_690) = &input.master_user_password {
        scope_689.string(var_690);
    }
    #[allow(unused_mut)]let mut scope_691 = writer.prefix("DBParameterGroupName");
    if let Some(var_692) = &input.db_parameter_group_name {
        scope_691.string(var_692);
    }
    #[allow(unused_mut)]let mut scope_693 = writer.prefix("BackupRetentionPeriod");
    if let Some(var_694) = &input.backup_retention_period {
        scope_693.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_694).into()));
    }
    #[allow(unused_mut)]let mut scope_695 = writer.prefix("PreferredBackupWindow");
    if let Some(var_696) = &input.preferred_backup_window {
        scope_695.string(var_696);
    }
    #[allow(unused_mut)]let mut scope_697 = writer.prefix("PreferredMaintenanceWindow");
    if let Some(var_698) = &input.preferred_maintenance_window {
        scope_697.string(var_698);
    }
    #[allow(unused_mut)]let mut scope_699 = writer.prefix("MultiAZ");
    if let Some(var_700) = &input.multi_az {
        scope_699.boolean(*var_700);
    }
    #[allow(unused_mut)]let mut scope_701 = writer.prefix("EngineVersion");
    if let Some(var_702) = &input.engine_version {
        scope_701.string(var_702);
    }
    #[allow(unused_mut)]let mut scope_703 = writer.prefix("AllowMajorVersionUpgrade");
    if input.allow_major_version_upgrade {
        scope_703.boolean(input.allow_major_version_upgrade);
    }
    #[allow(unused_mut)]let mut scope_704 = writer.prefix("AutoMinorVersionUpgrade");
    if let Some(var_705) = &input.auto_minor_version_upgrade {
        scope_704.boolean(*var_705);
    }
    #[allow(unused_mut)]let mut scope_706 = writer.prefix("LicenseModel");
    if let Some(var_707) = &input.license_model {
        scope_706.string(var_707);
    }
    #[allow(unused_mut)]let mut scope_708 = writer.prefix("Iops");
    ...
    #[allow(unused_mut)]let mut scope_710 = writer.prefix("OptionGroupName");
    if let Some(var_711) = &input.option_group_name {
        scope_710.string(var_711);
    }
    #[allow(unused_mut)]let mut scope_712 = writer.prefix("NewDBInstanceIdentifier");
    if let Some(var_713) = &input.new_db_instance_identifier {
        scope_712.string(var_713);
    }
    #[allow(unused_mut)]let mut scope_714 = writer.prefix("StorageType");
    if let Some(var_715) = &input.storage_type {
        scope_714.string(var_715);
    }
    #[allow(unused_mut)]let mut scope_716 = writer.prefix("TdeCredentialArn");
    if let Some(var_717) = &input.tde_credential_arn {
        scope_716.string(var_717);
    }
    #[allow(unused_mut)]let mut scope_718 = writer.prefix("TdeCredentialPassword");
    if let Some(var_719) = &input.tde_credential_password {
        scope_718.string(var_719);
    }
    #[allow(unused_mut)]let mut scope_720 = writer.prefix("CACertificateIdentifier");
    if let Some(var_721) = &input.ca_certificate_identifier {
        scope_720.string(var_721);
    }
    #[allow(unused_mut)]let mut scope_722 = writer.prefix("Domain");
    if let Some(var_723) = &input.domain {
        scope_722.string(var_723);
    }
    #[allow(unused_mut)]let mut scope_724 = writer.prefix("CopyTagsToSnapshot");
    if let Some(var_725) = &input.copy_tags_to_snapshot {
        scope_724.boolean(*var_725);
    }
    #[allow(unused_mut)]let mut scope_726 = writer.prefix("MonitoringInterval");
    ...
    #[allow(unused_mut)]let mut scope_728 = writer.prefix("DBPortNumber");
    ...
    #[allow(unused_mut)]let mut scope_730 = writer.prefix("PubliclyAccessible");
    if let Some(var_731) = &input.publicly_accessible {
        scope_730.boolean(*var_731);
    }
    #[allow(unused_mut)]let mut scope_732 = writer.prefix("MonitoringRoleArn");
    if let Some(var_733) = &input.monitoring_role_arn {
        scope_732.string(var_733);
    }
    #[allow(unused_mut)]let mut scope_734 = writer.prefix("DomainIAMRoleName");
    if let Some(var_735) = &input.domain_iam_role_name {
        scope_734.string(var_735);
    }
    #[allow(unused_mut)]let mut scope_736 = writer.prefix("PromotionTier");
    if let Some(var_737) = &input.promotion_tier {
        scope_736.number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_737).into()));
    }
    #[allow(unused_mut)]let mut scope_738 = writer.prefix("EnableIAMDatabaseAuthentication");
    if let Some(var_739) = &input.enable_iam_database_authentication {
        scope_738.boolean(*var_739);
    }
    #[allow(unused_mut)]let mut scope_740 = writer.prefix("EnablePerformanceInsights");
    if let Some(var_741) = &input.enable_performance_insights {
        scope_740.boolean(*var_741);
    }
    #[allow(unused_mut)]let mut scope_742 = writer.prefix("PerformanceInsightsKMSKeyId");
    if let Some(var_743) = &input.performance_insights_kms_key_id {
        scope_742.string(var_743);
    }
    #[allow(unused_mut)]let mut scope_744 = writer.prefix("CloudwatchLogsExportConfiguration");
    if let Some(var_745) = &input.cloudwatch_logs_export_configuration {
        crate::query_ser::serialize_structure_crate_model_cloudwatch_logs_export_configuration(scope_744, var_745)?;
    }
    #[allow(unused_mut)]let mut scope_746 = writer.prefix("DeletionProtection");
...
pub fn serialize_operation_crate_operation_modify_db_parameter_group(input: &crate::input::ModifyDbParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_748 = writer.prefix("DBParameterGroupName");
    if let Some(var_749) = &input.db_parameter_group_name {
        scope_748.string(var_749);
    }
    #[allow(unused_mut)]let mut scope_750 = writer.prefix("Parameters");
...
pub fn serialize_operation_crate_operation_modify_db_subnet_group(input: &crate::input::ModifyDbSubnetGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_755 = writer.prefix("DBSubnetGroupName");
    if let Some(var_756) = &input.db_subnet_group_name {
        scope_755.string(var_756);
    }
    #[allow(unused_mut)]let mut scope_757 = writer.prefix("DBSubnetGroupDescription");
    if let Some(var_758) = &input.db_subnet_group_description {
        scope_757.string(var_758);
    }
    #[allow(unused_mut)]let mut scope_759 = writer.prefix("SubnetIds");
    if let Some(var_760) = &input.subnet_ids {
        ...
        for item_761 in var_760 {
            #[allow(unused_mut)]let mut entry_763 = list_762.entry();
...
pub fn serialize_operation_crate_operation_modify_event_subscription(input: &crate::input::ModifyEventSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_764 = writer.prefix("SubscriptionName");
    if let Some(var_765) = &input.subscription_name {
        scope_764.string(var_765);
    }
    #[allow(unused_mut)]let mut scope_766 = writer.prefix("SnsTopicArn");
    if let Some(var_767) = &input.sns_topic_arn {
        scope_766.string(var_767);
    }
    #[allow(unused_mut)]let mut scope_768 = writer.prefix("SourceType");
    if let Some(var_769) = &input.source_type {
        scope_768.string(var_769);
    }
    #[allow(unused_mut)]let mut scope_770 = writer.prefix("EventCategories");
    ...
    #[allow(unused_mut)]let mut scope_775 = writer.prefix("Enabled");
...
pub fn serialize_operation_crate_operation_modify_global_cluster(input: &crate::input::ModifyGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_777 = writer.prefix("GlobalClusterIdentifier");
    if let Some(var_778) = &input.global_cluster_identifier {
        scope_777.string(var_778);
    }
    #[allow(unused_mut)]let mut scope_779 = writer.prefix("NewGlobalClusterIdentifier");
    if let Some(var_780) = &input.new_global_cluster_identifier {
        scope_779.string(var_780);
    }
    #[allow(unused_mut)]let mut scope_781 = writer.prefix("DeletionProtection");
    if let Some(var_782) = &input.deletion_protection {
        scope_781.boolean(*var_782);
    }
    #[allow(unused_mut)]let mut scope_783 = writer.prefix("EngineVersion");
    if let Some(var_784) = &input.engine_version {
        scope_783.string(var_784);
    }
    #[allow(unused_mut)]let mut scope_785 = writer.prefix("AllowMajorVersionUpgrade");
...
pub fn serialize_operation_crate_operation_promote_read_replica_db_cluster(input: &crate::input::PromoteReadReplicaDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_787 = writer.prefix("DBClusterIdentifier");
...
pub fn serialize_operation_crate_operation_reboot_db_instance(input: &crate::input::RebootDbInstanceInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_789 = writer.prefix("DBInstanceIdentifier");
    if let Some(var_790) = &input.db_instance_identifier {
        scope_789.string(var_790);
    }
    #[allow(unused_mut)]let mut scope_791 = writer.prefix("ForceFailover");
...
pub fn serialize_operation_crate_operation_remove_from_global_cluster(input: &crate::input::RemoveFromGlobalClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_793 = writer.prefix("GlobalClusterIdentifier");
    if let Some(var_794) = &input.global_cluster_identifier {
        scope_793.string(var_794);
    }
    #[allow(unused_mut)]let mut scope_795 = writer.prefix("DbClusterIdentifier");
...
pub fn serialize_operation_crate_operation_remove_role_from_db_cluster(input: &crate::input::RemoveRoleFromDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_797 = writer.prefix("DBClusterIdentifier");
    if let Some(var_798) = &input.db_cluster_identifier {
        scope_797.string(var_798);
    }
    #[allow(unused_mut)]let mut scope_799 = writer.prefix("RoleArn");
    if let Some(var_800) = &input.role_arn {
        scope_799.string(var_800);
    }
    #[allow(unused_mut)]let mut scope_801 = writer.prefix("FeatureName");
...
pub fn serialize_operation_crate_operation_remove_source_identifier_from_subscription(input: &crate::input::RemoveSourceIdentifierFromSubscriptionInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_803 = writer.prefix("SubscriptionName");
    if let Some(var_804) = &input.subscription_name {
        scope_803.string(var_804);
    }
    #[allow(unused_mut)]let mut scope_805 = writer.prefix("SourceIdentifier");
...
pub fn serialize_operation_crate_operation_reset_db_cluster_parameter_group(input: &crate::input::ResetDbClusterParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_814 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_815) = &input.db_cluster_parameter_group_name {
        scope_814.string(var_815);
    }
    #[allow(unused_mut)]let mut scope_816 = writer.prefix("ResetAllParameters");
    if input.reset_all_parameters {
        scope_816.boolean(input.reset_all_parameters);
    }
    #[allow(unused_mut)]let mut scope_817 = writer.prefix("Parameters");
...
pub fn serialize_operation_crate_operation_reset_db_parameter_group(input: &crate::input::ResetDbParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_822 = writer.prefix("DBParameterGroupName");
    if let Some(var_823) = &input.db_parameter_group_name {
        scope_822.string(var_823);
    }
    #[allow(unused_mut)]let mut scope_824 = writer.prefix("ResetAllParameters");
    if input.reset_all_parameters {
        scope_824.boolean(input.reset_all_parameters);
    }
    #[allow(unused_mut)]let mut scope_825 = writer.prefix("Parameters");
...
pub fn serialize_operation_crate_operation_restore_db_cluster_from_snapshot(input: &crate::input::RestoreDbClusterFromSnapshotInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_830 = writer.prefix("AvailabilityZones");
    ...
    #[allow(unused_mut)]let mut scope_835 = writer.prefix("DBClusterIdentifier");
    if let Some(var_836) = &input.db_cluster_identifier {
        scope_835.string(var_836);
    }
    #[allow(unused_mut)]let mut scope_837 = writer.prefix("SnapshotIdentifier");
    if let Some(var_838) = &input.snapshot_identifier {
        scope_837.string(var_838);
    }
    #[allow(unused_mut)]let mut scope_839 = writer.prefix("Engine");
    if let Some(var_840) = &input.engine {
        scope_839.string(var_840);
    }
    #[allow(unused_mut)]let mut scope_841 = writer.prefix("EngineVersion");
    if let Some(var_842) = &input.engine_version {
        scope_841.string(var_842);
    }
    #[allow(unused_mut)]let mut scope_843 = writer.prefix("Port");
    ...
    #[allow(unused_mut)]let mut scope_845 = writer.prefix("DBSubnetGroupName");
    if let Some(var_846) = &input.db_subnet_group_name {
        scope_845.string(var_846);
    }
    #[allow(unused_mut)]let mut scope_847 = writer.prefix("DatabaseName");
    if let Some(var_848) = &input.database_name {
        scope_847.string(var_848);
    }
    #[allow(unused_mut)]let mut scope_849 = writer.prefix("OptionGroupName");
    if let Some(var_850) = &input.option_group_name {
        scope_849.string(var_850);
    }
    #[allow(unused_mut)]let mut scope_851 = writer.prefix("VpcSecurityGroupIds");
    if let Some(var_852) = &input.vpc_security_group_ids {
        ...
        for item_853 in var_852 {
            #[allow(unused_mut)]let mut entry_855 = list_854.entry();
            entry_855.string(item_853);
        }
        list_854.finish();
    }
    #[allow(unused_mut)]let mut scope_856 = writer.prefix("Tags");
    if let Some(var_857) = &input.tags {
        let mut list_859 = scope_856.start_list(false, Some("Tag"));
        for item_858 in var_857 {
            #[allow(unused_mut)]let mut entry_860 = list_859.entry();
            crate::query_ser::serialize_structure_crate_model_tag(entry_860, item_858)?;
        }
        list_859.finish();
    }
    #[allow(unused_mut)]let mut scope_861 = writer.prefix("KmsKeyId");
    if let Some(var_862) = &input.kms_key_id {
        scope_861.string(var_862);
    }
    #[allow(unused_mut)]let mut scope_863 = writer.prefix("EnableIAMDatabaseAuthentication");
    if let Some(var_864) = &input.enable_iam_database_authentication {
        scope_863.boolean(*var_864);
    }
    #[allow(unused_mut)]let mut scope_865 = writer.prefix("EnableCloudwatchLogsExports");
    ...
    #[allow(unused_mut)]let mut scope_870 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_871) = &input.db_cluster_parameter_group_name {
        scope_870.string(var_871);
    }
    #[allow(unused_mut)]let mut scope_872 = writer.prefix("DeletionProtection");
    if let Some(var_873) = &input.deletion_protection {
        scope_872.boolean(*var_873);
    }
    #[allow(unused_mut)]let mut scope_874 = writer.prefix("CopyTagsToSnapshot");
...
pub fn serialize_operation_crate_operation_restore_db_cluster_to_point_in_time(input: &crate::input::RestoreDbClusterToPointInTimeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_887 = writer.prefix("DBSubnetGroupName");
    if let Some(var_888) = &input.db_subnet_group_name {
        scope_887.string(var_888);
    }
    #[allow(unused_mut)]let mut scope_889 = writer.prefix("OptionGroupName");
    if let Some(var_890) = &input.option_group_name {
        scope_889.string(var_890);
    }
    #[allow(unused_mut)]let mut scope_891 = writer.prefix("VpcSecurityGroupIds");
    ...
    if let Some(var_906) = &input.enable_cloudwatch_logs_exports {
        ...
        for item_907 in var_906 {
            #[allow(unused_mut)]let mut entry_909 = list_908.entry();
            entry_909.string(item_907);
        }
        list_908.finish();
    }
    #[allow(unused_mut)]let mut scope_910 = writer.prefix("DBClusterParameterGroupName");
    if let Some(var_911) = &input.db_cluster_parameter_group_name {
        scope_910.string(var_911);
    }
    #[allow(unused_mut)]let mut scope_912 = writer.prefix("DeletionProtection");
...
pub fn serialize_operation_crate_operation_start_db_cluster(input: &crate::input::StartDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_914 = writer.prefix("DBClusterIdentifier");
...
pub fn serialize_operation_crate_operation_stop_db_cluster(input: &crate::input::StopDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::SerializationError> {
    ...
    #[allow(unused_mut)]let mut scope_916 = writer.prefix("DBClusterIdentifier");
