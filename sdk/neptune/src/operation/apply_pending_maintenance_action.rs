...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_apply_pending_maintenance_action_input::ser_apply_pending_maintenance_action_input_input_input(&input)?);
