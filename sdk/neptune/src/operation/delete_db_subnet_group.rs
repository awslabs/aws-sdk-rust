...
impl DeleteDbSubnetGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDBSubnetGroup`](crate::operation::delete_db_subnet_group::DeleteDBSubnetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_db_subnet_group::DeleteDBSubnetGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_db_subnet_group::DeleteDbSubnetGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_db_subnet_group::DeleteDBSubnetGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDBSubnetGroup", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDBSubnetGroup {
                type Output = std::result::Result<crate::operation::delete_db_subnet_group::DeleteDbSubnetGroupOutput, crate::operation::delete_db_subnet_group::DeleteDBSubnetGroupError>;
