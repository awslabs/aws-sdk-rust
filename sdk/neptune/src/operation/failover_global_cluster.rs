...
impl FailoverGlobalClusterInput {
    /// Consumes the builder and constructs an Operation<[`FailoverGlobalCluster`](crate::operation::failover_global_cluster::FailoverGlobalCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::failover_global_cluster::FailoverGlobalCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::failover_global_cluster::FailoverGlobalClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::failover_global_cluster::FailoverGlobalCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("FailoverGlobalCluster", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for FailoverGlobalCluster {
                type Output = std::result::Result<crate::operation::failover_global_cluster::FailoverGlobalClusterOutput, crate::operation::failover_global_cluster::FailoverGlobalClusterError>;
