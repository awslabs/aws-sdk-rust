...
impl FailoverGlobalCluster {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::failover_global_cluster::FailoverGlobalClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::failover_global_cluster::FailoverGlobalClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::failover_global_cluster::FailoverGlobalClusterError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::failover_global_cluster::FailoverGlobalClusterOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for FailoverGlobalCluster {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("FailoverGlobalCluster");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(FailoverGlobalClusterRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(FailoverGlobalClusterResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("FailoverGlobalCluster")
...
.with_interceptor(FailoverGlobalClusterEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::failover_global_cluster::FailoverGlobalClusterError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::failover_global_cluster::FailoverGlobalClusterError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::failover_global_cluster::FailoverGlobalClusterError>::new());
...
#[derive(Debug)]
            struct FailoverGlobalClusterResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for FailoverGlobalClusterResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_failover_global_cluster::de_failover_global_cluster_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_failover_global_cluster::de_failover_global_cluster_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct FailoverGlobalClusterRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for FailoverGlobalClusterRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::failover_global_cluster::FailoverGlobalClusterInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::failover_global_cluster::FailoverGlobalClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_failover_global_cluster_input::ser_failover_global_cluster_input_input_input(&input)?);
...
#[derive(Debug)]
            struct FailoverGlobalClusterEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for FailoverGlobalClusterEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "FailoverGlobalClusterEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<FailoverGlobalClusterInput>()
                        .ok_or("failed to downcast to FailoverGlobalClusterInput")?;
...
pub enum FailoverGlobalClusterError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-FailoverGlobalClusterError) for what information is available for the error.")]
...
impl FailoverGlobalClusterError {
    /// Creates the `FailoverGlobalClusterError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `FailoverGlobalClusterError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for FailoverGlobalClusterError {
...
impl ::aws_types::request_id::RequestId for crate::operation::failover_global_cluster::FailoverGlobalClusterError {
...
mod _failover_global_cluster_output;
