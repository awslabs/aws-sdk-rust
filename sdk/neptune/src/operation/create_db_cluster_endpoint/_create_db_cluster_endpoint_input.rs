...
impl CreateDbClusterEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_db_cluster_endpoint::CreateDbClusterEndpointInput, ::aws_smithy_types::error::operation::BuildError> {
