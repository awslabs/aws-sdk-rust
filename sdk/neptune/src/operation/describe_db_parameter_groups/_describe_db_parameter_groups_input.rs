...
impl DescribeDbParameterGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_db_parameter_groups::DescribeDbParameterGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
