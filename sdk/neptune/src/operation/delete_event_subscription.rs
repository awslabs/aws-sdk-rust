...
impl DeleteEventSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteEventSubscription`](crate::operation::delete_event_subscription::DeleteEventSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_event_subscription::DeleteEventSubscription, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_event_subscription::DeleteEventSubscriptionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_event_subscription::DeleteEventSubscription::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteEventSubscription", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEventSubscription {
                type Output = std::result::Result<crate::operation::delete_event_subscription::DeleteEventSubscriptionOutput, crate::operation::delete_event_subscription::DeleteEventSubscriptionError>;
