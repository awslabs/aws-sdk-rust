...
/// Paginator for [`DescribeEventSubscriptions`](crate::operation::describe_event_subscriptions::DescribeEventSubscriptions)
pub struct DescribeEventSubscriptionsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::describe_event_subscriptions::builders::DescribeEventSubscriptionsInputBuilder,
...
impl DescribeEventSubscriptionsPaginator {
    ...
    pub fn items(self) -> crate::operation::describe_event_subscriptions::paginator::DescribeEventSubscriptionsPaginatorItems {
        crate::operation::describe_event_subscriptions::paginator::DescribeEventSubscriptionsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_event_subscriptions::DescribeEventSubscriptions::orchestrate(&runtime_plugins, input.clone())
                                .await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_event_subscriptions_output_output_marker(resp);
...
impl DescribeEventSubscriptionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_event_subscriptions_output_output_event_subscriptions_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
