...
impl AddTagsToResourceInput {
    /// Consumes the builder and constructs an Operation<[`AddTagsToResource`](crate::operation::add_tags_to_resource::AddTagsToResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_tags_to_resource::AddTagsToResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_tags_to_resource::AddTagsToResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_resource::AddTagsToResource::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddTagsToResource", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddTagsToResource {
                type Output = std::result::Result<crate::operation::add_tags_to_resource::AddTagsToResourceOutput, crate::operation::add_tags_to_resource::AddTagsToResourceError>;
