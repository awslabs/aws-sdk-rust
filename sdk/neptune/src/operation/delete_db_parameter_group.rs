...
impl DeleteDbParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDBParameterGroup`](crate::operation::delete_db_parameter_group::DeleteDBParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_db_parameter_group::DeleteDBParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_db_parameter_group::DeleteDbParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_db_parameter_group::DeleteDBParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteDBParameterGroup", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDBParameterGroup {
                type Output = std::result::Result<crate::operation::delete_db_parameter_group::DeleteDbParameterGroupOutput, crate::operation::delete_db_parameter_group::DeleteDBParameterGroupError>;
