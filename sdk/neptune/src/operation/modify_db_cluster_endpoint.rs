...
impl ModifyDBClusterEndpoint {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointInput,
                    ) -> ::std::result::Result<crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyDBClusterEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ModifyDBClusterEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ModifyDBClusterEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ModifyDBClusterEndpointResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyDBClusterEndpoint")
...
.with_interceptor(ModifyDBClusterEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError>::new());
...
#[derive(Debug)]
            struct ModifyDBClusterEndpointResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyDBClusterEndpointResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_modify_db_cluster_endpoint::de_modify_db_cluster_endpoint_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_modify_db_cluster_endpoint::de_modify_db_cluster_endpoint_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ModifyDBClusterEndpointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyDBClusterEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_modify_db_cluster_endpoint_input::ser_modify_db_cluster_endpoint_input_input_input(&input)?);
...
#[derive(Debug)]
            struct ModifyDBClusterEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyDBClusterEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ModifyDBClusterEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ModifyDbClusterEndpointInput>()
                        .ok_or("failed to downcast to ModifyDbClusterEndpointInput")?;
...
pub enum ModifyDBClusterEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ModifyDBClusterEndpointError) for what information is available for the error.")]
...
impl ModifyDBClusterEndpointError {
    /// Creates the `ModifyDBClusterEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyDBClusterEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ModifyDBClusterEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError {
...
mod _modify_db_cluster_endpoint_output;
