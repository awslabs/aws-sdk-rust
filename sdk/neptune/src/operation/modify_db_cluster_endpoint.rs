...
impl ModifyDbClusterEndpointInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDBClusterEndpoint`](crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDBClusterEndpoint", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDBClusterEndpoint {
                type Output = std::result::Result<crate::operation::modify_db_cluster_endpoint::ModifyDbClusterEndpointOutput, crate::operation::modify_db_cluster_endpoint::ModifyDBClusterEndpointError>;
