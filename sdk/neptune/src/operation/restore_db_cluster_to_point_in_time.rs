    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreDBClusterToPointInTime")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RestoreDBClusterToPointInTimeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RestoreDBClusterToPointInTimeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreDBClusterToPointInTimeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RestoreDbClusterToPointInTimeInput>() else {
        ...
        if requested.should_capture("RestoreType") {
            if let ::std::option::Option::Some(value) = input.restore_type.as_deref() {
                captured.insert("RestoreType", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreDBClusterToPointInTimeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_restore_db_cluster_to_point_in_time::de_restore_db_cluster_to_point_in_time_http_error(
...
impl RestoreDBClusterToPointInTimeError {
    ...
    /// Returns `true` if the error kind is `RestoreDBClusterToPointInTimeError::NetworkTypeNotSupportedFault`.
