...
impl RestoreDbClusterToPointInTimeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_db_cluster_to_point_in_time::RestoreDBClusterToPointInTime::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreDBClusterToPointInTime {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_db_cluster_to_point_in_time::de_restore_db_cluster_to_point_in_time_http_response_with_props(
                status, headers, body,
            )
        }
    }
