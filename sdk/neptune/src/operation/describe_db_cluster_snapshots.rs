...
/// Orchestration and serialization glue logic for `DescribeDBClusterSnapshots`.
...
impl DescribeDBClusterSnapshots {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsInput,
                    ) -> ::std::result::Result<crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDBClusterSnapshots {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDBClusterSnapshots");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDBClusterSnapshotsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDBClusterSnapshotsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDBClusterSnapshots")
...
.with_interceptor(DescribeDBClusterSnapshotsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDBClusterSnapshotsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_db_cluster_snapshots::de_describe_db_cluster_snapshots_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_db_cluster_snapshots::de_describe_db_cluster_snapshots_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDBClusterSnapshotsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_db_cluster_snapshots_input::ser_describe_db_cluster_snapshots_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeDBClusterSnapshotsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDBClusterSnapshotsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDBClusterSnapshotsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDbClusterSnapshotsInput>()
                        .ok_or("failed to downcast to DescribeDbClusterSnapshotsInput")?;
...
pub enum DescribeDBClusterSnapshotsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDBClusterSnapshotsError) for what information is available for the error.")]
...
impl DescribeDBClusterSnapshotsError {
    /// Creates the `DescribeDBClusterSnapshotsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDBClusterSnapshotsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDBClusterSnapshotsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_db_cluster_snapshots::DescribeDBClusterSnapshotsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_db_cluster_snapshots::_describe_db_cluster_snapshots_output::DescribeDbClusterSnapshotsOutput;

pub use crate::operation::describe_db_cluster_snapshots::_describe_db_cluster_snapshots_input::DescribeDbClusterSnapshotsInput;

mod _describe_db_cluster_snapshots_input;

mod _describe_db_cluster_snapshots_output;
