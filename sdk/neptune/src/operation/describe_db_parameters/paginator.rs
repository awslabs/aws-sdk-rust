...
impl DescribeDbParametersPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_db_parameters::paginator::DescribeDbParametersPaginatorItems
    {
        crate::operation::describe_db_parameters::paginator::DescribeDbParametersPaginatorItems(
            self,
        )
            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_db_parameters_output_marker(resp);
...
impl DescribeDbParametersPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_db_parameters_output_parameters(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
