...
impl DescribeDbParameterGroupsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_parameter_groups::DescribeDBParameterGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDBParameterGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_db_parameter_groups::de_describe_db_parameter_groups_http_response_with_props(status, headers, body)
        }
    }
}
