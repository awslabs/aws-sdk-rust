...
impl DescribeDbParameterGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDBParameterGroups`](crate::operation::describe_db_parameter_groups::DescribeDBParameterGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_db_parameter_groups::DescribeDBParameterGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_db_parameter_groups::DescribeDbParameterGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_db_parameter_groups::DescribeDBParameterGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDBParameterGroups", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDBParameterGroups {
                type Output = std::result::Result<crate::operation::describe_db_parameter_groups::DescribeDbParameterGroupsOutput, crate::operation::describe_db_parameter_groups::DescribeDBParameterGroupsError>;
