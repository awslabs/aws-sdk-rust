...
impl RemoveRoleFromDbClusterInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_role_from_db_cluster::RemoveRoleFromDbClusterInput, ::aws_smithy_types::error::operation::BuildError> {
