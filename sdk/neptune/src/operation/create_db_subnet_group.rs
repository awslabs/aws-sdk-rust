...
impl CreateDBSubnetGroup {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Neptune", "CreateDBSubnetGroup", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Neptune.CreateDBSubnetGroup",
                "rpc.service" = "Neptune",
                "rpc.method" = "CreateDBSubnetGroup",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDBSubnetGroup")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateDBSubnetGroupTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateDBSubnetGroupTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDBSubnetGroupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateDbSubnetGroupInput>() else {
        ...
        if requested.should_capture("DBSubnetGroupDescription") {
            if let ::std::option::Option::Some(value) = input.db_subnet_group_description.as_deref() {
                captured.insert("DBSubnetGroupDescription", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDBSubnetGroupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_db_subnet_group::de_create_db_subnet_group_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_db_subnet_group::de_create_db_subnet_group_http_response(status, headers, body, _cfg)
        };
