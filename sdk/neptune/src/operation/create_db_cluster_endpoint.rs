...
impl CreateDbClusterEndpointInput {
    /// Consumes the builder and constructs an Operation<[`CreateDBClusterEndpoint`](crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_db_cluster_endpoint::CreateDbClusterEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDBClusterEndpoint", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDBClusterEndpoint {
                type Output = std::result::Result<crate::operation::create_db_cluster_endpoint::CreateDbClusterEndpointOutput, crate::operation::create_db_cluster_endpoint::CreateDBClusterEndpointError>;
