...
/// Paginator for [`DescribeDBClusterParameters`](crate::operation::describe_db_cluster_parameters::DescribeDBClusterParameters)
pub struct DescribeDbClusterParametersPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::describe_db_cluster_parameters::builders::DescribeDbClusterParametersInputBuilder,
...
impl DescribeDbClusterParametersPaginator {
    ...
    pub fn items(self) -> crate::operation::describe_db_cluster_parameters::paginator::DescribeDbClusterParametersPaginatorItems {
        crate::operation::describe_db_cluster_parameters::paginator::DescribeDbClusterParametersPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::describe_db_cluster_parameters::DescribeDBClusterParameters::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_describe_db_cluster_parameters_output_output_marker(resp);
...
impl DescribeDbClusterParametersPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_db_cluster_parameters_output_output_parameters(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
