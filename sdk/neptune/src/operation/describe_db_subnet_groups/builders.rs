...
impl DescribeDBSubnetGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_db_subnet_groups::DescribeDbSubnetGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_db_subnet_groups::DescribeDbSubnetGroupsOutput, crate::operation::describe_db_subnet_groups::DescribeDBSubnetGroupsError, Self> {
