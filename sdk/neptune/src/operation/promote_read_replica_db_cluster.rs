...
impl PromoteReadReplicaDbClusterInput {
    /// Consumes the builder and constructs an Operation<[`PromoteReadReplicaDBCluster`](crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PromoteReadReplicaDBCluster", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for PromoteReadReplicaDBCluster {
                type Output = std::result::Result<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterOutput, crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError>;
