...
impl ::aws_smithy_http::response::ParseStrictResponse for PromoteReadReplicaDBCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_promote_read_replica_db_cluster::de_promote_read_replica_db_cluster_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for PromoteReadReplicaDBClusterError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError
{
