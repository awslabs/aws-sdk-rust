    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PromoteReadReplicaDBClusterResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PromoteReadReplicaDBClusterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_promote_read_replica_db_cluster_input::ser_promote_read_replica_db_cluster_input_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PromoteReadReplicaDBClusterEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError {
