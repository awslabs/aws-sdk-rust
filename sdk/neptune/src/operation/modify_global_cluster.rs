...
impl ModifyGlobalClusterInput {
    /// Consumes the builder and constructs an Operation<[`ModifyGlobalCluster`](crate::operation::modify_global_cluster::ModifyGlobalCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_global_cluster::ModifyGlobalCluster, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_global_cluster::ModifyGlobalClusterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_global_cluster::ModifyGlobalCluster::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyGlobalCluster", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyGlobalCluster {
                type Output = std::result::Result<crate::operation::modify_global_cluster::ModifyGlobalClusterOutput, crate::operation::modify_global_cluster::ModifyGlobalClusterError>;
