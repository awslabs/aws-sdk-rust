...
impl ModifyGlobalCluster {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::modify_global_cluster::ModifyGlobalClusterError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::modify_global_cluster::ModifyGlobalClusterOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Neptune", "ModifyGlobalCluster", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Neptune.ModifyGlobalCluster",
                "rpc.service" = "Neptune",
                "rpc.method" = "ModifyGlobalCluster",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ModifyGlobalCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ModifyGlobalClusterRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ModifyGlobalClusterResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ModifyGlobalCluster")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyGlobalCluster")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ModifyGlobalClusterTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ModifyGlobalClusterTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ModifyGlobalClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ModifyGlobalClusterInput>() else {
        ...
        if requested.should_capture("NewGlobalClusterIdentifier") {
            if let ::std::option::Option::Some(value) = input.new_global_cluster_identifier.as_deref() {
                captured.insert("NewGlobalClusterIdentifier", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ModifyGlobalClusterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_modify_global_cluster::de_modify_global_cluster_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_modify_global_cluster::de_modify_global_cluster_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ModifyGlobalClusterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::modify_global_cluster::ModifyGlobalClusterInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::modify_global_cluster::ModifyGlobalClusterInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_modify_global_cluster_input::ser_modify_global_cluster_input_input_input(&input)?,
        );
