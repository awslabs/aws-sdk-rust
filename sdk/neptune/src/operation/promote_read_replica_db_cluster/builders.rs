...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterOutput,
                    crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError,
                > for PromoteReadReplicaDBClusterFluentBuilder
            {
                fn send(
                    self,
...
impl PromoteReadReplicaDBClusterFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBCluster::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBCluster::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDbClusterOutput, crate::operation::promote_read_replica_db_cluster::PromoteReadReplicaDBClusterError, Self> {
