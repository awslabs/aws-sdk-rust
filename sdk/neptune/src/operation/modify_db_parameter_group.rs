...
impl ModifyDbParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyDBParameterGroup`](crate::operation::modify_db_parameter_group::ModifyDBParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_db_parameter_group::ModifyDBParameterGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_parameter_group::ModifyDbParameterGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_parameter_group::ModifyDBParameterGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ModifyDBParameterGroup", "neptune"));
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyDBParameterGroup {
                type Output = std::result::Result<crate::operation::modify_db_parameter_group::ModifyDbParameterGroupOutput, crate::operation::modify_db_parameter_group::ModifyDBParameterGroupError>;
