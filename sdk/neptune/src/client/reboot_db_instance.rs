...
impl super::Client {
    ...
    ///   - [`force_failover(bool)`](crate::operation::reboot_db_instance::builders::RebootDBInstanceFluentBuilder::force_failover) / [`set_force_failover(Option<bool>)`](crate::operation::reboot_db_instance::builders::RebootDBInstanceFluentBuilder::set_force_failover):<br>required: **false**<br><p>When <code>true</code>, the reboot is conducted through a MultiAZ failover.</p> <p>Constraint: You can't specify <code>true</code> if the instance is not configured for MultiAZ.</p><br>
