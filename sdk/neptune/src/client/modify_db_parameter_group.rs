...
impl super::Client {
    ...
    ///   - [`db_parameter_group_name(impl Into<String>)`](crate::operation::modify_db_parameter_group::builders::ModifyDBParameterGroupFluentBuilder::db_parameter_group_name) / [`set_db_parameter_group_name(Option<String>)`](crate::operation::modify_db_parameter_group::builders::ModifyDBParameterGroupFluentBuilder::set_db_parameter_group_name):<br>required: **true**<br><p>The name of the DB parameter group.</p> <p>Constraints:</p> <ul>  <li>   <p>If supplied, must match the name of an existing DBParameterGroup.</p></li> </ul><br>
    ///   - [`parameters(Parameter)`](crate::operation::modify_db_parameter_group::builders::ModifyDBParameterGroupFluentBuilder::parameters) / [`set_parameters(Option<Vec::<Parameter>>)`](crate::operation::modify_db_parameter_group::builders::ModifyDBParameterGroupFluentBuilder::set_parameters):<br>required: **true**<br><p>An array of parameter names, values, and the apply method for the parameter update. At least one parameter name, value, and apply method must be supplied; subsequent arguments are optional. A maximum of 20 parameters can be modified in a single request.</p> <p>Valid Values (for the application method): <code>immediate | pending-reboot</code></p><note>  <p>You can use the immediate value with dynamic parameters only. You can use the pending-reboot value for both dynamic and static parameters, and changes are applied when you reboot the DB instance without failover.</p> </note><br>
