...
impl super::Client {
    ...
    ///   - [`db_subnet_group_name(impl Into<String>)`](crate::operation::delete_db_subnet_group::builders::DeleteDBSubnetGroupFluentBuilder::db_subnet_group_name) / [`set_db_subnet_group_name(Option<String>)`](crate::operation::delete_db_subnet_group::builders::DeleteDBSubnetGroupFluentBuilder::set_db_subnet_group_name):<br>required: **true**<br><p>The name of the database subnet group to delete.</p><note>  <p>You can't delete the default subnet group.</p> </note> <p>Constraints:</p> <p>Constraints: Must match the name of an existing DBSubnetGroup. Must not be default.</p> <p>Example: <code>mySubnetgroup</code></p><br>
