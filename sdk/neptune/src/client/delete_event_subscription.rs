...
impl super::Client {
    ...
    ///   - [`subscription_name(impl Into<String>)`](crate::operation::delete_event_subscription::builders::DeleteEventSubscriptionFluentBuilder::subscription_name) / [`set_subscription_name(Option<String>)`](crate::operation::delete_event_subscription::builders::DeleteEventSubscriptionFluentBuilder::set_subscription_name):<br>required: **true**<br><p>The name of the event notification subscription you want to delete.</p><br>
