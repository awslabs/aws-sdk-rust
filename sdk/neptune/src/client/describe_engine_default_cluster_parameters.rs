...
impl super::Client  {
    ...
    pub fn describe_engine_default_cluster_parameters(&self) -> crate::client::fluent_builders::DescribeEngineDefaultClusterParameters {
                                crate::client::fluent_builders::DescribeEngineDefaultClusterParameters::new(self.handle.clone())
                            }
}
