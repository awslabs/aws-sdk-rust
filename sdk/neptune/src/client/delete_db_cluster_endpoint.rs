...
impl super::Client {
    ...
    ///   - [`db_cluster_endpoint_identifier(impl ::std::convert::Into<String>)`](crate::operation::delete_db_cluster_endpoint::builders::DeleteDBClusterEndpointFluentBuilder::db_cluster_endpoint_identifier) / [`set_db_cluster_endpoint_identifier(Option<String>)`](crate::operation::delete_db_cluster_endpoint::builders::DeleteDBClusterEndpointFluentBuilder::set_db_cluster_endpoint_identifier): <p>The identifier associated with the custom endpoint. This parameter is stored as a lowercase string.</p>
