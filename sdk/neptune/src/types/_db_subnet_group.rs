...
pub struct DbSubnetGroup {
    ...
    /// <p>Valid network types include <code>IPV4</code> and <code>DUAL</code>. A DB subnet group supports <code>DUAL</code> if all subnets in the group have both IPv4 and IPv6 CIDRs.</p>
