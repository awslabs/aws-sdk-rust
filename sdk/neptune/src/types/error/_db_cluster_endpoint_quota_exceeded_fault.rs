...
impl ::std::fmt::Display for DbClusterEndpointQuotaExceededFault {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ::std::write!(f, "DbClusterEndpointQuotaExceededFault [DBClusterEndpointQuotaExceededFault]")?;
...
impl ::aws_types::request_id::RequestId for crate::types::error::DbClusterEndpointQuotaExceededFault {
...
impl DbClusterEndpointQuotaExceededFault {
    ...
    pub fn builder() -> crate::types::error::builders::DbClusterEndpointQuotaExceededFaultBuilder {
        crate::types::error::builders::DbClusterEndpointQuotaExceededFaultBuilder::default()
    }
}

/// A builder for [`DbClusterEndpointQuotaExceededFault`](crate::types::error::DbClusterEndpointQuotaExceededFault).
#[non_exhaustive]
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
pub struct DbClusterEndpointQuotaExceededFaultBuilder {
    pub(crate) message: ::std::option::Option<::std::string::String>,
    meta: std::option::Option<::aws_smithy_types::error::ErrorMetadata>,
}
impl DbClusterEndpointQuotaExceededFaultBuilder {
    /// <p>A message describing the details of the problem.</p>
