...
pub fn ser_copy_db_parameter_group_input_input(input: &crate::input::CopyDbParameterGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
