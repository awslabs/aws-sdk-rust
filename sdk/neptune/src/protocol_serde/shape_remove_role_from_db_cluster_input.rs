...
pub fn ser_remove_role_from_db_cluster_input_input(input: &crate::input::RemoveRoleFromDbClusterInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
