...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_db_cluster_snapshot::CreateDBClusterSnapshotError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_db_cluster_snapshot::CreateDBClusterSnapshotError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "DBClusterSnapshotAlreadyExistsFault" => {
            crate::operation::create_db_cluster_snapshot::CreateDBClusterSnapshotError::DbClusterSnapshotAlreadyExistsFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidDBClusterSnapshotStateFault" => {
            crate::operation::create_db_cluster_snapshot::CreateDBClusterSnapshotError::InvalidDbClusterSnapshotStateFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_db_cluster_snapshot::de_create_db_cluster_snapshot(_response_body, output)
            .map_err(crate::operation::create_db_cluster_snapshot::CreateDBClusterSnapshotError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("CreateDBClusterSnapshotResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected CreateDBClusterSnapshotResult got {start_el:?}"
            )));
        }
