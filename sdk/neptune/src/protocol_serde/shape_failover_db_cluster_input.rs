...
pub fn ser_failover_db_cluster_input_input_input(input: &crate::operation::failover_db_cluster::FailoverDbClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
