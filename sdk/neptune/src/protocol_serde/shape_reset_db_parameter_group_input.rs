...
pub fn ser_reset_db_parameter_group_input_input_input(input: &crate::operation::reset_db_parameter_group::ResetDbParameterGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
