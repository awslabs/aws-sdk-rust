...
pub fn de_delete_event_subscription_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteEventSubscriptionOutput, crate::error::DeleteEventSubscriptionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteEventSubscriptionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_event_subscription_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteEventSubscriptionOutput, crate::error::DeleteEventSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::delete_event_subscription_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_event_subscription::de_delete_event_subscription(response.body().as_ref(), output).map_err(crate::error::DeleteEventSubscriptionError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_delete_event_subscription(inp: &[u8], mut builder: crate::output::delete_event_subscription_output::Builder) -> Result<crate::output::delete_event_subscription_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
