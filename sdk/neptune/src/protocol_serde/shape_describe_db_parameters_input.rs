...
pub fn ser_describe_db_parameters_input_input(input: &crate::operation::describe_db_parameters::DescribeDbParametersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
