...
pub fn de_orderable_db_instance_options_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::OrderableDbInstanceOption>, aws_smithy_xml::decode::XmlDecodeError> {
