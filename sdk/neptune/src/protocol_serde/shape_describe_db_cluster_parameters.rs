...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_db_cluster_parameters::DescribeDBClusterParametersError::unhandled)?;
    ...
    Err(match error_code {
        "DBParameterGroupNotFound" => {
            crate::operation::describe_db_cluster_parameters::DescribeDBClusterParametersError::DbParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_cluster_parameters::de_describe_db_cluster_parameters(_response_body, output)
            .map_err(crate::operation::describe_db_cluster_parameters::DescribeDBClusterParametersError::unhandled)?;
...
> {
    ...
    if !(start_el.matches("DescribeDBClusterParametersResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected DescribeDBClusterParametersResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBClusterParametersResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBClusterParametersResult got {start_el:?}"
            )));
        }
