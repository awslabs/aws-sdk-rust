...
pub fn de_stop_db_cluster_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_db_cluster::StopDbClusterOutput, crate::operation::stop_db_cluster::StopDBClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::stop_db_cluster::StopDBClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_db_cluster_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_db_cluster::StopDbClusterOutput, crate::operation::stop_db_cluster::StopDBClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::stop_db_cluster::builders::StopDbClusterOutputBuilder::default();
        output = crate::protocol_serde::shape_stop_db_cluster::de_stop_db_cluster(_response_body, output).map_err(crate::operation::stop_db_cluster::StopDBClusterError::unhandled)?;
