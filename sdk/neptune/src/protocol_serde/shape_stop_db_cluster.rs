...
pub fn de_stop_db_cluster_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_db_cluster::StopDbClusterOutput, crate::operation::stop_db_cluster::StopDBClusterError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_db_cluster_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_db_cluster::StopDbClusterOutput, crate::operation::stop_db_cluster::StopDBClusterError> {
    Ok({
        #[allow(unused_mut)]
