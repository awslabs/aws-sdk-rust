...
pub fn ser_describe_global_clusters_input_input_input(input: &crate::operation::describe_global_clusters::DescribeGlobalClustersInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
