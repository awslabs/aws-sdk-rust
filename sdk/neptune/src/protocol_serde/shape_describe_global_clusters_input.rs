...
pub fn ser_describe_global_clusters_input_input(input: &crate::input::DescribeGlobalClustersInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
