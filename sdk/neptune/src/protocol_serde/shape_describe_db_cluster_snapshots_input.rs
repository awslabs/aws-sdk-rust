...
pub fn ser_describe_db_cluster_snapshots_input_input_input(input: &crate::operation::describe_db_cluster_snapshots::DescribeDbClusterSnapshotsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
