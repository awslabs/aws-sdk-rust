...
pub fn de_copy_db_cluster_parameter_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_db_cluster_parameter_group::CopyDbClusterParameterGroupOutput, crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroupError> {
    #[allow(unused_mut)]
