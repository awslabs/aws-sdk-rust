...
pub fn ser_describe_db_cluster_endpoints_input_input(input: &crate::input::DescribeDbClusterEndpointsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
