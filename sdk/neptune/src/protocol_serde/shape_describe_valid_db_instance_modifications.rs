...
pub fn de_describe_valid_db_instance_modifications_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModificationsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModificationsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "DBInstanceNotFound" => {
            crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModificationsError::DbInstanceNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_valid_db_instance_modifications_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_valid_db_instance_modifications::de_describe_valid_db_instance_modifications(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_valid_db_instance_modifications::DescribeValidDBInstanceModificationsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeValidDBInstanceModificationsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeValidDBInstanceModificationsResult got {start_el:?}"
            )));
        }
