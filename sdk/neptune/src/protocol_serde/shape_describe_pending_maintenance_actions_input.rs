...
pub fn ser_describe_pending_maintenance_actions_input_input(input: &crate::input::DescribePendingMaintenanceActionsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
