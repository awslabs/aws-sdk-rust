...
pub fn de_event_subscription(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::EventSubscription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
