...
#[allow(unused_mut)]
pub fn de_insufficient_db_cluster_capacity_fault_xml_err(
    inp: &[u8],
    mut builder: crate::types::error::builders::InsufficientDbClusterCapacityFaultBuilder,
) -> std::result::Result<crate::types::error::builders::InsufficientDbClusterCapacityFaultBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    if inp.is_empty() {
        return Ok(builder);
    }
