...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_parameters_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_parameters::de_describe_db_parameters(_response_body, output)
            .map_err(crate::operation::describe_db_parameters::DescribeDBParametersError::unhandled)?;
...
) -> Result<crate::operation::describe_db_parameters::builders::DescribeDbParametersOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
