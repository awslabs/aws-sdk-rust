...
pub fn de_valid_storage_options(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ValidStorageOptions, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
