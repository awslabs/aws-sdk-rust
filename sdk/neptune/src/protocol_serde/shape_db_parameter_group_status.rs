...
pub fn de_db_parameter_group_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbParameterGroupStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
