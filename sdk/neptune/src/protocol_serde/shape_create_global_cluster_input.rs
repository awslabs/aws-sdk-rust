...
pub fn ser_create_global_cluster_input_input_input(input: &crate::operation::create_global_cluster::CreateGlobalClusterInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
