...
pub fn ser_remove_source_identifier_from_subscription_input_input(
    input: &crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionInput,
