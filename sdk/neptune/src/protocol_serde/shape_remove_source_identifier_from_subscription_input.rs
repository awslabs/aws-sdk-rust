...
pub fn ser_remove_source_identifier_from_subscription_input_input_input(input: &crate::operation::remove_source_identifier_from_subscription::RemoveSourceIdentifierFromSubscriptionInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
