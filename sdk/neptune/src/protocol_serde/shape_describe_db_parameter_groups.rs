...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_db_parameter_groups::DescribeDBParameterGroupsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_db_parameter_groups::DescribeDBParameterGroupsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "DBParameterGroupNotFound" => {
            crate::operation::describe_db_parameter_groups::DescribeDBParameterGroupsError::DbParameterGroupNotFoundFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_db_parameter_groups::de_describe_db_parameter_groups(_response_body, output)
            .map_err(crate::operation::describe_db_parameter_groups::DescribeDBParameterGroupsError::unhandled)?;
...
> {
    ...
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("DescribeDBParameterGroupsResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected DescribeDBParameterGroupsResult got {start_el:?}"
            )));
        }
