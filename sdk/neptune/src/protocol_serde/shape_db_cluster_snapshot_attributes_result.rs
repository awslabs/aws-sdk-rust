...
pub fn de_db_cluster_snapshot_attributes_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterSnapshotAttributesResult, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
