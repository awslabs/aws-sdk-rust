...
pub fn de_db_cluster_option_group_status(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DbClusterOptionGroupStatus, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
