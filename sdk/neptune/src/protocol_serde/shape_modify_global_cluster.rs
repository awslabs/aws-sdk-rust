...
> {
    ...
    Err(match error_code {
        ...
        "InvalidDBClusterStateFault" => crate::operation::modify_global_cluster::ModifyGlobalClusterError::InvalidDbClusterStateFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidDBInstanceState" => crate::operation::modify_global_cluster::ModifyGlobalClusterError::InvalidDbInstanceStateFault({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_global_cluster_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_modify_global_cluster::de_modify_global_cluster(_response_body, output)
            .map_err(crate::operation::modify_global_cluster::ModifyGlobalClusterError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_modify_global_cluster(
    inp: &[u8],
    mut builder: crate::operation::modify_global_cluster::builders::ModifyGlobalClusterOutputBuilder,
) -> std::result::Result<crate::operation::modify_global_cluster::builders::ModifyGlobalClusterOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError>
{
    ...
    if !(start_el.matches("ModifyGlobalClusterResponse")) {
        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
            "invalid root, expected ModifyGlobalClusterResponse got {start_el:?}"
        )));
    }
    if let Some(mut result_tag) = decoder.next_tag() {
        ...
        if !(start_el.matches("ModifyGlobalClusterResult")) {
            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!(
                "invalid result, expected ModifyGlobalClusterResult got {start_el:?}"
            )));
        }
