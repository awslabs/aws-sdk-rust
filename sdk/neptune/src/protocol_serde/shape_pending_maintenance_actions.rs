...
pub fn de_pending_maintenance_actions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ResourcePendingMaintenanceActions>, aws_smithy_xml::decode::XmlDecodeError> {
