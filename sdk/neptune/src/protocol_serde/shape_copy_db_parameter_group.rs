...
pub fn de_copy_db_parameter_group_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_db_parameter_group::CopyDbParameterGroupOutput, crate::operation::copy_db_parameter_group::CopyDBParameterGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_db_parameter_group_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_db_parameter_group::CopyDbParameterGroupOutput, crate::operation::copy_db_parameter_group::CopyDBParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
