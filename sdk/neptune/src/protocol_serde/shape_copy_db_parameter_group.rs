...
pub fn de_copy_db_parameter_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_db_parameter_group::CopyDbParameterGroupOutput, crate::operation::copy_db_parameter_group::CopyDBParameterGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::copy_db_parameter_group::CopyDBParameterGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_db_parameter_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_db_parameter_group::CopyDbParameterGroupOutput, crate::operation::copy_db_parameter_group::CopyDBParameterGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::copy_db_parameter_group::builders::CopyDbParameterGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_copy_db_parameter_group::de_copy_db_parameter_group(_response_body, output).map_err(crate::operation::copy_db_parameter_group::CopyDBParameterGroupError::unhandled)?;
