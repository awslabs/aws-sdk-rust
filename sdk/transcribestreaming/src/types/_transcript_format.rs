...
///     TranscriptFormat::Spoken => { /* ... */ },
///     TranscriptFormat::Written => { /* ... */ },
...
impl ::std::convert::From<&str> for TranscriptFormat {
    fn from(s: &str) -> Self {
        match s {
            "spoken" => TranscriptFormat::Spoken,
            "written" => TranscriptFormat::Written,
...
impl TranscriptFormat {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            TranscriptFormat::Spoken => "spoken",
            TranscriptFormat::Written => "written",
...
impl ::std::fmt::Display for TranscriptFormat {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            TranscriptFormat::Spoken => write!(f, "spoken"),
            TranscriptFormat::Written => write!(f, "written"),
