...
impl ::aws_smithy_eventstream::frame::MarshallMessage for AudioStreamErrorMarshaller {
    ...
    fn marshall(&self, _input: Self::Input) -> std::result::Result<::aws_smithy_types::event_stream::Message, ::aws_smithy_eventstream::error::Error> {
        let mut headers = Vec::new();
        headers.push(::aws_smithy_types::event_stream::Header::new(":message-type", ::aws_smithy_types::event_stream::HeaderValue::String("exception".into())));
        let payload = Vec::new();
...
impl ::aws_smithy_eventstream::frame::MarshallMessage for AudioStreamMarshaller {
    ...
    fn marshall(&self, input: Self::Input) -> std::result::Result<::aws_smithy_types::event_stream::Message, ::aws_smithy_eventstream::error::Error> {
        let mut headers = Vec::new();
        headers.push(::aws_smithy_types::event_stream::Header::new(":message-type", ::aws_smithy_types::event_stream::HeaderValue::String("event".into())));
            ...
            "exception" =>  {
                ...
                "BadRequestException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::CallAnalyticsTranscriptResultStreamError::BadRequestException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "LimitExceededException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::CallAnalyticsTranscriptResultStreamError::LimitExceededException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "InternalFailureException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::CallAnalyticsTranscriptResultStreamError::InternalFailureException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "ConflictException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::CallAnalyticsTranscriptResultStreamError::ConflictException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "ServiceUnavailableException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::CallAnalyticsTranscriptResultStreamError::ServiceUnavailableException(
                                                                builder.build()
                                                            )
                                                        ))
                }
            ...
            "exception" =>  {
                ...
                "BadRequestException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::MedicalTranscriptResultStreamError::BadRequestException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "LimitExceededException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::MedicalTranscriptResultStreamError::LimitExceededException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "InternalFailureException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::MedicalTranscriptResultStreamError::InternalFailureException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "ConflictException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::MedicalTranscriptResultStreamError::ConflictException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "ServiceUnavailableException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::MedicalTranscriptResultStreamError::ServiceUnavailableException(
                                                                builder.build()
                                                            )
                                                        ))
                }
            ...
            "exception" =>  {
                ...
                "LimitExceededException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::TranscriptResultStreamError::LimitExceededException(
                                                                builder.build()
                                                            )
                                                        ))
                }
                "InternalFailureException" =>  {
                    ...
                    builder = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(&message.payload()[..], builder)
                                                        ...
                                                        builder.set_meta(Some(generic));
                                                        return Ok(::aws_smithy_eventstream::frame::UnmarshalledMessage::Error(
                                                            crate::types::error::TranscriptResultStreamError::InternalFailureException(
                                                                builder.build()
                                                            )
                                                        ))
                }
