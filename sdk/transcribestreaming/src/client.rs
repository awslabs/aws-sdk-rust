    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`StartMedicalStreamTranscriptionInput`](crate::input::StartMedicalStreamTranscriptionInput) with field(s):
    ///   - [`language_code(Option<LanguageCode>)`](crate::input::StartMedicalStreamTranscriptionInput::language_code): <p> Indicates the source language used in the input audio stream. For Amazon Transcribe Medical, this is US English (en-US). </p>
    ///   - [`media_sample_rate_hertz(Option<i32>)`](crate::input::StartMedicalStreamTranscriptionInput::media_sample_rate_hertz): <p>The sample rate of the input audio in Hertz.</p>
    ...
    ///   - [`enable_channel_identification(bool)`](crate::input::StartMedicalStreamTranscriptionInput::enable_channel_identification): <p>When <code>true</code>, instructs Amazon Transcribe Medical to process each audio channel separately and then merge the transcription output of each channel into a single transcription.</p>  <p>Amazon Transcribe Medical also produces a transcription of each item. An item includes the start time, end time, and any alternative transcriptions.</p>  <p>You can't set both <code>ShowSpeakerLabel</code> and <code>EnableChannelIdentification</code> in the same request. If you set both, your request returns a <code>BadRequestException</code>.</p>
    ///   - [`number_of_channels(Option<i32>)`](crate::input::StartMedicalStreamTranscriptionInput::number_of_channels): <p>The number of channels that are in your audio stream.</p>
    ///   - [`content_identification_type(Option<MedicalContentIdentificationType>)`](crate::input::StartMedicalStreamTranscriptionInput::content_identification_type): <p>Set this field to <code>PHI</code> to identify personal health information in the transcription output.</p>
    ...
    ///
    /// - Takes [`StartStreamTranscriptionInput`](crate::input::StartStreamTranscriptionInput) with field(s):
    ///   - [`language_code(Option<LanguageCode>)`](crate::input::StartStreamTranscriptionInput::language_code): <p>The language code of the input audio stream.</p>
    ///   - [`media_sample_rate_hertz(Option<i32>)`](crate::input::StartStreamTranscriptionInput::media_sample_rate_hertz): <p>The sample rate, in Hertz (Hz), of the input audio. We suggest that you use 8,000 Hz for low quality audio and 16,000 Hz or higher for high quality audio.</p>
    ///   - [`media_encoding(Option<MediaEncoding>)`](crate::input::StartStreamTranscriptionInput::media_encoding): <p>The encoding used for the input audio.</p>
    ///   - [`vocabulary_name(Option<String>)`](crate::input::StartStreamTranscriptionInput::vocabulary_name): <p>The name of the vocabulary to use when processing the transcription job.</p>
    ///   - [`session_id(Option<String>)`](crate::input::StartStreamTranscriptionInput::session_id): <p>A identifier for the transcription session. Use this parameter when you want to retry a session. If you don't provide a session ID, Amazon Transcribe will generate one for you and return it in the response.</p>
    ///   - [`audio_stream(EventStreamInput<crate::model::AudioStream>)`](crate::input::StartStreamTranscriptionInput::audio_stream): <p>PCM-encoded stream of audio blobs. The audio stream is encoded as an HTTP/2 data frame.</p>
    ///   - [`vocabulary_filter_name(Option<String>)`](crate::input::StartStreamTranscriptionInput::vocabulary_filter_name): <p>The name of the vocabulary filter you've created that is unique to your account. Provide the name in this field to successfully use it in a stream.</p>
    ///   - [`vocabulary_filter_method(Option<VocabularyFilterMethod>)`](crate::input::StartStreamTranscriptionInput::vocabulary_filter_method): <p>The manner in which you use your vocabulary filter to filter words in your transcript. <code>Remove</code> removes filtered words from your transcription results. <code>Mask</code> masks filtered words with a <code>***</code> in your transcription results. <code>Tag</code> keeps the filtered words in your transcription results and tags them. The tag appears as <code>VocabularyFilterMatch</code> equal to <code>True</code>.</p>
    ///   - [`show_speaker_label(bool)`](crate::input::StartStreamTranscriptionInput::show_speaker_label): <p>When <code>true</code>, enables speaker identification in your media stream.</p>
    ///   - [`enable_channel_identification(bool)`](crate::input::StartStreamTranscriptionInput::enable_channel_identification): <p>When <code>true</code>, instructs Amazon Transcribe to process each audio channel separately, then merges the transcription output of each channel into a single transcription.</p>  <p>Amazon Transcribe also produces a transcription of each item. An item includes the start time, end time, and any alternative transcriptions.</p>  <p>You can't set both <code>ShowSpeakerLabel</code> and <code>EnableChannelIdentification</code> in the same request. If you set both, your request returns a <code>BadRequestException</code>.</p>
    ///   - [`number_of_channels(Option<i32>)`](crate::input::StartStreamTranscriptionInput::number_of_channels): <p>The number of channels that are in your audio stream.</p>
    ///   - [`enable_partial_results_stabilization(bool)`](crate::input::StartStreamTranscriptionInput::enable_partial_results_stabilization): <p>When <code>true</code>, instructs Amazon Transcribe to present transcription results that have the partial results stabilized. Normally, any word or phrase from one partial result can change in a subsequent partial result. With partial results stabilization enabled, only the last few words of one partial result can change in another partial result.</p>
    ///   - [`partial_results_stability(Option<PartialResultsStability>)`](crate::input::StartStreamTranscriptionInput::partial_results_stability): <p>You can use this field to set the stability level of the transcription results. A higher stability level means that the transcription results are less likely to change. Higher stability levels can come with lower overall transcription accuracy.</p>
    ///   - [`content_identification_type(Option<ContentIdentificationType>)`](crate::input::StartStreamTranscriptionInput::content_identification_type): <p>Set this field to PII to identify personally identifiable information (PII) in the transcription output. Content identification is performed only upon complete transcription of the audio segments.</p>  <p>You can’t set both <code>ContentIdentificationType</code> and <code>ContentRedactionType</code> in the same request. If you set both, your request returns a <code>BadRequestException</code>.</p>
    ///   - [`content_redaction_type(Option<ContentRedactionType>)`](crate::input::StartStreamTranscriptionInput::content_redaction_type): <p>Set this field to PII to redact personally identifiable information (PII) in the transcription output. Content redaction is performed only upon complete transcription of the audio segments.</p>  <p>You can’t set both <code>ContentRedactionType</code> and <code>ContentIdentificationType</code> in the same request. If you set both, your request returns a <code>BadRequestException</code>.</p>
    ///   - [`pii_entity_types(Option<String>)`](crate::input::StartStreamTranscriptionInput::pii_entity_types): <p>List the PII entity types you want to identify or redact. In order to specify entity types, you must have either <code>ContentIdentificationType</code> or <code>ContentRedactionType</code> enabled.</p>  <p> <code>PIIEntityTypes</code> must be comma-separated; the available values are: <code>BANK_ACCOUNT_NUMBER</code>, <code>BANK_ROUTING</code>, <code>CREDIT_DEBIT_NUMBER</code>, <code>CREDIT_DEBIT_CVV</code>, <code>CREDIT_DEBIT_EXPIRY</code>, <code>PIN</code>, <code>EMAIL</code>, <code>ADDRESS</code>, <code>NAME</code>, <code>PHONE</code>, <code>SSN</code>, and <code>ALL</code>.</p>  <p> <code>PiiEntityTypes</code> is an optional parameter with a default value of <code>ALL</code>.</p>
    ///   - [`language_model_name(Option<String>)`](crate::input::StartStreamTranscriptionInput::language_model_name): <p>The name of the language model you want to use.</p>
    ///   - [`identify_language(bool)`](crate::input::StartStreamTranscriptionInput::identify_language): <p>Optional. Set this value to <code>true</code> to enable language identification for your media stream.</p>
    ///   - [`language_options(Option<String>)`](crate::input::StartStreamTranscriptionInput::language_options): <p>An object containing a list of languages that might be present in your audio.</p>  <p>You must provide two or more language codes to help Amazon Transcribe identify the correct language of your media stream with the highest possible accuracy. You can only select one variant per language; for example, you can't include both <code>en-US</code> and <code>en-UK</code> in the same request.</p>  <p>You can only use this parameter if you've set <code>IdentifyLanguage</code> to <code>true</code>in your request.</p>
    ///   - [`preferred_language(Option<LanguageCode>)`](crate::input::StartStreamTranscriptionInput::preferred_language): <p>Optional. From the subset of languages codes you provided for <code>LanguageOptions</code>, you can select one preferred language for your transcription.</p>  <p>You can only use this parameter if you've set <code>IdentifyLanguage</code> to <code>true</code>in your request.</p>
