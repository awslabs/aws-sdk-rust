...
#[non_exhaustive]pub struct StartStreamTranscriptionOutput  {
    ...
    #[doc(hidden)]pub media_encoding: std::option::Option<crate::model::MediaEncoding>,
    ...
    #[doc(hidden)]pub show_speaker_label: bool,
    /// <p>Shows whether channel identification was enabled in the stream.</p>
    #[doc(hidden)]pub enable_channel_identification: bool,
    /// <p>The number of channels identified in the stream.</p>
    #[doc(hidden)]pub number_of_channels: std::option::Option<i32>,
    /// <p>Shows whether partial results stabilization was enabled in the transcription.</p>
    #[doc(hidden)]pub enable_partial_results_stabilization: bool,
    /// <p>If partial results stabilization has been enabled in the stream, shows the stability level.</p>
    #[doc(hidden)]pub partial_results_stability: std::option::Option<crate::model::PartialResultsStability>,
    /// <p>Shows whether content identification was enabled in this stream.</p>
    #[doc(hidden)]pub content_identification_type: std::option::Option<crate::model::ContentIdentificationType>,
    /// <p>Shows whether content redaction was enabled in this stream.</p>
    #[doc(hidden)]pub content_redaction_type: std::option::Option<crate::model::ContentRedactionType>,
    ...
    #[doc(hidden)]pub identify_language: bool,
    /// <p>The language codes used in the identification of your media stream's predominant language.</p>
    #[doc(hidden)]pub language_options: std::option::Option<std::string::String>,
    /// <p>The preferred language you specified in your request.</p>
    #[doc(hidden)]pub preferred_language: std::option::Option<crate::model::LanguageCode>,
    /// <p>The name of the custom vocabulary used when processing the stream.</p>
    #[doc(hidden)]pub vocabulary_names: std::option::Option<std::string::String>,
    /// <p>The name of the vocabulary filter used when processing the stream.</p>
    #[doc(hidden)]pub vocabulary_filter_names: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for StartStreamTranscriptionOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("enable_channel_identification", &self.enable_channel_identification);
...
pub mod start_stream_transcription_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::output::StartStreamTranscriptionOutput, aws_smithy_http::operation::BuildError> {
            Ok(
...
#[allow(missing_docs)] // documentation missing in model
#[non_exhaustive]pub struct StartMedicalStreamTranscriptionOutput  {
...
pub mod start_medical_stream_transcription_output {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::output::StartMedicalStreamTranscriptionOutput, aws_smithy_http::operation::BuildError> {
            Ok(
