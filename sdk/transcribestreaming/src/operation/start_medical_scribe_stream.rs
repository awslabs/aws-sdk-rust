...
impl StartMedicalScribeStream {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_medical_scribe_stream::StartMedicalScribeStreamError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_medical_scribe_stream::StartMedicalScribeStreamOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartMedicalScribeStream",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMedicalScribeStream {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartMedicalScribeStream");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartMedicalScribeStreamRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartMedicalScribeStreamResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartMedicalScribeStream")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMedicalScribeStream")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartMedicalScribeStreamTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartMedicalScribeStreamTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMedicalScribeStreamTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartMedicalScribeStreamInput>() else {
...
#[derive(Debug)]
struct StartMedicalScribeStreamResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMedicalScribeStreamResponseDeserializer {
    fn deserialize_streaming_with_config(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_start_medical_scribe_stream::de_start_medical_scribe_stream_http_response(response, _cfg),
        ))
    }
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMedicalScribeStreamEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartMedicalScribeStreamInput>()
            .ok_or("failed to downcast to StartMedicalScribeStreamInput")?;
...
/// Error type for the `StartMedicalScribeStreamError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StartMedicalScribeStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartMedicalScribeStreamError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl StartMedicalScribeStreamError {
    /// Creates the `StartMedicalScribeStreamError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `StartMedicalScribeStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `StartMedicalScribeStreamError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `StartMedicalScribeStreamError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `StartMedicalScribeStreamError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `StartMedicalScribeStreamError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `StartMedicalScribeStreamError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
}
impl ::std::error::Error for StartMedicalScribeStreamError {
...
impl ::std::fmt::Display for StartMedicalScribeStreamError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for StartMedicalScribeStreamError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartMedicalScribeStreamError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartMedicalScribeStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_medical_scribe_stream::StartMedicalScribeStreamError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::start_medical_scribe_stream::_start_medical_scribe_stream_input::StartMedicalScribeStreamInput;

pub use crate::operation::start_medical_scribe_stream::_start_medical_scribe_stream_output::StartMedicalScribeStreamOutput;

mod _start_medical_scribe_stream_input;

mod _start_medical_scribe_stream_output;
