...
impl GetMedicalScribeStream {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_medical_scribe_stream::GetMedicalScribeStreamError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_medical_scribe_stream::GetMedicalScribeStreamOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetMedicalScribeStream",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMedicalScribeStream {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMedicalScribeStream");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetMedicalScribeStreamRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetMedicalScribeStreamResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetMedicalScribeStream")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMedicalScribeStream")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetMedicalScribeStreamTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetMedicalScribeStreamTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMedicalScribeStreamTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetMedicalScribeStreamInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMedicalScribeStreamResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_medical_scribe_stream::de_get_medical_scribe_stream_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_medical_scribe_stream::de_get_medical_scribe_stream_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMedicalScribeStreamEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<GetMedicalScribeStreamInput>()
            .ok_or("failed to downcast to GetMedicalScribeStreamInput")?;
...
/// Error type for the `GetMedicalScribeStreamError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetMedicalScribeStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMedicalScribeStreamError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl GetMedicalScribeStreamError {
    /// Creates the `GetMedicalScribeStreamError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `GetMedicalScribeStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `GetMedicalScribeStreamError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetMedicalScribeStreamError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GetMedicalScribeStreamError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `GetMedicalScribeStreamError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
}
impl ::std::error::Error for GetMedicalScribeStreamError {
...
impl ::std::fmt::Display for GetMedicalScribeStreamError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for GetMedicalScribeStreamError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetMedicalScribeStreamError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMedicalScribeStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_medical_scribe_stream::GetMedicalScribeStreamError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::get_medical_scribe_stream::_get_medical_scribe_stream_input::GetMedicalScribeStreamInput;

pub use crate::operation::get_medical_scribe_stream::_get_medical_scribe_stream_output::GetMedicalScribeStreamOutput;

mod _get_medical_scribe_stream_input;

mod _get_medical_scribe_stream_output;
