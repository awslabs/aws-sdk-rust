...
impl smithy_types::retry::ProvideErrorKind for StartMedicalStreamTranscriptionError {
...
impl StartMedicalStreamTranscriptionError {
    pub fn new(kind: StartMedicalStreamTranscriptionErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
...
impl smithy_types::retry::ProvideErrorKind for StartStreamTranscriptionError {
    fn code(&self) -> Option<&str> {
...
impl StartStreamTranscriptionError {
    pub fn new(kind: StartStreamTranscriptionErrorKind, meta: smithy_types::Error) -> Self {
        Self { kind, meta }
    }
