...
mod test {
    ...
    fn test_5() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.ca-central-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ca-central-1.api.aws")
                .build()
        );
    }
    ...
    fn test_6() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.ca-central-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_7() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.ca-central-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.ca-central-1.api.aws")
                .build()
        );
    }
    ...
    fn test_9() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.eu-central-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-central-1.api.aws")
                .build()
        );
    }
    ...
    fn test_10() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.eu-central-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-central-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_11() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.eu-central-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.eu-central-1.api.aws")
                .build()
        );
    }
    ...
    fn test_13() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming-fips.us-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.us-west-2.api.aws")
                .build()
        );
    }
    ...
    fn test_14() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.us-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_15() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.us-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.us-west-2.api.aws")
                .build()
        );
    }
    ...
    fn test_17() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming-fips.eu-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-west-2.api.aws")
                .build()
        );
    }
    ...
    fn test_18() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.eu-west-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-west-2.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_19() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.eu-west-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.eu-west-2.api.aws")
                .build()
        );
    }
    ...
    fn test_21() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming-fips.eu-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-west-1.api.aws")
                .build()
        );
    }
    ...
    fn test_22() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.eu-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.eu-west-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_23() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.eu-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.eu-west-1.api.aws")
                .build()
        );
    }
    ...
    fn test_25() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.ap-northeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-northeast-2.api.aws")
                .build()
        );
    }
    ...
    fn test_26() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-northeast-2.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_27() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.ap-northeast-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.ap-northeast-2.api.aws")
                .build()
        );
    }
    ...
    fn test_29() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.ap-northeast-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-northeast-1.api.aws")
                .build()
        );
    }
    ...
    fn test_30() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-northeast-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_31() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.ap-northeast-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.ap-northeast-1.api.aws")
                .build()
        );
    }
    ...
    fn test_33() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming-fips.sa-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.sa-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_34() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.sa-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.sa-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_35() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.sa-east-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.sa-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_41() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.us-gov-west-1.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.us-gov-west-1.api.aws")
                .build()
        );
    }
    ...
    fn test_42() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.us-gov-west-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.us-gov-west-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_43() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.us-gov-west-1.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.us-gov-west-1.api.aws")
                .build()
        );
    }
    ...
    fn test_45() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.ap-southeast-2.api.aws",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-southeast-2.api.aws")
                .build()
        );
    }
    ...
    fn test_46() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.ap-southeast-2.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_47() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.ap-southeast-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.ap-southeast-2.api.aws")
                .build()
        );
    }
    ...
    fn test_57() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming-fips.us-east-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.us-east-2.api.aws")
                .build()
        );
    }
    ...
    fn test_58() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://transcribestreaming-fips.us-east-2.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
    ...
    fn test_59() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://transcribestreaming.us-east-2.api.aws");
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.us-east-2.api.aws")
                .build()
        );
    }
    ...
    fn test_61() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.cn-northwest-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_62() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming-fips.cn-northwest-1.amazonaws.com.cn")
                .build()
        );
    }
    ...
    fn test_63() {
        ...
        assert_eq!(
            endpoint,
            aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://transcribestreaming.cn-northwest-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
