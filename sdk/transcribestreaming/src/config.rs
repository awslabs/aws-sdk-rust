...
/// Configuration for a aws_sdk_transcribestreaming service client.
///
...
impl Builder {
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_transcribestreaming::Config::builder();
    ...
    /// impl aws_sdk_transcribestreaming::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_transcribestreaming::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_transcribestreaming::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_transcribestreaming::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::Config;
    /// use aws_sdk_transcribestreaming::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_transcribestreaming::config::Config;
    /// use aws_sdk_transcribestreaming::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `transcribestreaming`
    /// (or `transcribestreaming-<region>` if a region is configured).
    /// All Transcribe Streaming clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::Config;
    /// use aws_sdk_transcribestreaming::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::Config;
    /// use aws_sdk_transcribestreaming::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::IdentityCache;
    ///
    /// let config = aws_sdk_transcribestreaming::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_transcribestreaming::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_transcribestreaming::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_transcribestreaming::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("transcribe"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_transcribestreaming::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_transcribestreaming::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
