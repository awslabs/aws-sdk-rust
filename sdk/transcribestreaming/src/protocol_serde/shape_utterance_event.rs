...
pub fn de_utterance_event_payload(input: &[u8]) -> Result<crate::model::UtteranceEvent, aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_utterance_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UtteranceEvent>, aws_smithy_json::deserialize::error::DeserializeError>
