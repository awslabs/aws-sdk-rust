...
pub fn de_start_medical_stream_transcription_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionOutput, crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_medical_stream_transcription_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionOutput, crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionError> {
    #[allow(unused_mut)]
    ...
    if let ::std::option::Option::Some(inner_9) = &input.specialty {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("specialty", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_11) = &input.r#type {
        let formatted_12 = inner_11.as_str();
                        if !formatted_12.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("r#type", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
