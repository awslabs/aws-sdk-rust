...
pub fn ser_channel_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ChannelDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
