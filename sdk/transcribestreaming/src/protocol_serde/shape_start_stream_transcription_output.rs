...
pub(crate) fn de_identify_language_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<bool>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_identify_multiple_languages_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<bool>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-transcribe-identify-multiple-languages");
...
pub(crate) fn de_language_options_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_preferred_language_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::LanguageCode>, ::aws_smithy_http::header::ParseError> {
...
pub fn de_transcript_result_stream_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<crate::event_receiver::EventReceiver<crate::types::TranscriptResultStream, crate::types::error::TranscriptResultStreamError>, crate::operation::start_stream_transcription::StartStreamTranscriptionError> {
...
pub(crate) fn de_vocabulary_filter_names_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_vocabulary_names_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
