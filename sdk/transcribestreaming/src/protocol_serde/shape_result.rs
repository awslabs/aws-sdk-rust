            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Alternatives" => {
                            builder = builder.set_alternatives(crate::protocol_serde::shape_alternative_list::de_alternative_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "LanguageIdentification" => {
                            builder = builder.set_language_identification(
                                crate::protocol_serde::shape_language_identification::de_language_identification(tokens, _value, depth + 1)?,
                            );
                        }
