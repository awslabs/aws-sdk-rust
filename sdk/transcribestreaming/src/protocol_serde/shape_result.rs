...
) -> Result<Option<crate::types::Result>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Alternatives" => {
                            builder = builder.set_alternatives(crate::protocol_serde::shape_alternative_list::de_alternative_list(tokens)?);
                        }
                        "ChannelId" => {
