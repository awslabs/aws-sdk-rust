...
pub(crate) fn de_content_identification_type_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::MedicalContentIdentificationType>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-transcribe-content-identification-type");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub(crate) fn de_enable_channel_identification_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<bool>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-transcribe-enable-channel-identification");
...
pub(crate) fn de_language_code_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::LanguageCode>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_number_of_channels_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<i32>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-transcribe-number-of-channels");
...
pub(crate) fn de_show_speaker_label_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<bool>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_specialty_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::Specialty>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all("x-amzn-transcribe-specialty");
    ::aws_smithy_http::header::one_or_none(headers)
}

pub fn de_transcript_result_stream_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<crate::event_receiver::EventReceiver<crate::types::MedicalTranscriptResultStream, crate::types::error::MedicalTranscriptResultStreamError>, crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionError> {
...
pub(crate) fn de_type_header(header_map: &::aws_smithy_runtime_api::http::Headers) -> ::std::result::Result<::std::option::Option<crate::types::Type>, ::aws_smithy_http::header::ParseError> {
