...
pub fn ser_post_call_analytics_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PostCallAnalyticsSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
