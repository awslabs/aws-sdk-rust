...
pub fn de_start_stream_transcription_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::start_stream_transcription::StartStreamTranscriptionOutput, crate::operation::start_stream_transcription::StartStreamTranscriptionError> {
    ...
    Ok({
        ...
        output = output.set_identify_multiple_languages(
            crate::protocol_serde::shape_start_stream_transcription_output::de_identify_multiple_languages_header(_response_headers)
                                        .map_err(|_|crate::operation::start_stream_transcription::StartStreamTranscriptionError::unhandled("Failed to parse IdentifyMultipleLanguages from header `x-amzn-transcribe-identify-multiple-languages"))?
        );
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_stream_transcription_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::start_stream_transcription::StartStreamTranscriptionOutput, crate::operation::start_stream_transcription::StartStreamTranscriptionError> {
    #[allow(unused_mut)]
        ...
        let formatted_2 = inner_1.as_str();
                        if !formatted_2.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("language_code", format!(
    ...
    if let ::std::option::Option::Some(inner_3) = &input.media_sample_rate_hertz {
        ...
        let formatted_4 = encoder.encode();
                        if !formatted_4.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("media_sample_rate_hertz", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_5) = &input.media_encoding {
        let formatted_6 = inner_5.as_str();
                        if !formatted_6.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("media_encoding", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_7) = &input.vocabulary_name {
        let formatted_8 = inner_7.as_str();
                        if !formatted_8.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("vocabulary_name", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_9) = &input.session_id {
        let formatted_10 = inner_9.as_str();
                        if !formatted_10.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("session_id", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_11) = &input.vocabulary_filter_name {
        let formatted_12 = inner_11.as_str();
                        if !formatted_12.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("vocabulary_filter_name", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_13) = &input.vocabulary_filter_method {
        let formatted_14 = inner_13.as_str();
                        if !formatted_14.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("vocabulary_filter_method", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_15) = &input.show_speaker_label {
        ...
        let formatted_16 = encoder.encode();
                        if !formatted_16.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("show_speaker_label", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_17) = &input.enable_channel_identification {
        ...
        let formatted_18 = encoder.encode();
                        if !formatted_18.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("enable_channel_identification", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_19) = &input.number_of_channels {
        ...
        let formatted_20 = encoder.encode();
                        if !formatted_20.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("number_of_channels", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_21) = &input.enable_partial_results_stabilization {
        ...
        let formatted_22 = encoder.encode();
                        if !formatted_22.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("enable_partial_results_stabilization", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_23) = &input.partial_results_stability {
        let formatted_24 = inner_23.as_str();
                        if !formatted_24.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("partial_results_stability", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_25) = &input.content_identification_type {
        let formatted_26 = inner_25.as_str();
                        if !formatted_26.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("content_identification_type", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_27) = &input.content_redaction_type {
        let formatted_28 = inner_27.as_str();
                        if !formatted_28.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("content_redaction_type", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_29) = &input.pii_entity_types {
        let formatted_30 = inner_29.as_str();
                        if !formatted_30.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("pii_entity_types", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_31) = &input.language_model_name {
        let formatted_32 = inner_31.as_str();
                        if !formatted_32.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("language_model_name", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_33) = &input.identify_language {
        ...
        let formatted_34 = encoder.encode();
                        if !formatted_34.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("identify_language", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_35) = &input.language_options {
        let formatted_36 = inner_35.as_str();
                        if !formatted_36.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("language_options", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_37) = &input.preferred_language {
        let formatted_38 = inner_37.as_str();
                        if !formatted_38.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("preferred_language", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_39) = &input.identify_multiple_languages {
        ...
        let formatted_40 = encoder.encode();
                        if !formatted_40.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("identify_multiple_languages", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_41) = &input.vocabulary_names {
        let formatted_42 = inner_41.as_str();
                        if !formatted_42.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("vocabulary_names", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
    ...
    if let ::std::option::Option::Some(inner_43) = &input.vocabulary_filter_names {
        let formatted_44 = inner_43.as_str();
                        if !formatted_44.is_empty() {
                            ...
                            let header_value: ::http::HeaderValue = header_value.parse().map_err(|err| {
                                ::aws_smithy_types::error::operation::BuildError::invalid_field("vocabulary_filter_names", format!(
                                "`{}` cannot be used as a header value: {}",
                                &header_value,
                                err
                            ))
