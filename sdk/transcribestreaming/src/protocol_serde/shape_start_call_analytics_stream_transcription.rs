...
pub fn de_start_call_analytics_stream_transcription_op_response(op_response: &mut aws_smithy_http::operation::Response) -> std::result::Result<crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionOutput, crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError>{
    #[allow(unused_variables)]
    let (response, properties) = op_response.parts_mut();
    crate::protocol_serde::shape_start_call_analytics_stream_transcription::de_start_call_analytics_stream_transcription_http_response_with_props(response, &properties)
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_start_call_analytics_stream_transcription_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionOutput, crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError>{
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_json_err(_response_body, output).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(_response_body, output).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_conflict_exception::de_conflict_exception_json_err(_response_body, output).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_json_err(_response_body, output).map_err(crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_start_call_analytics_stream_transcription_http_response_with_props(response: &mut http::Response<aws_smithy_http::body::SdkBody>, properties: &aws_smithy_http::property_bag::PropertyBag) -> std::result::Result<crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionOutput, crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionError>{
    ...
    Ok({
        ...
        output = output.set_call_analytics_transcript_result_stream(
            Some(crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_call_analytics_transcript_result_stream_payload(_response_body)?)
        );
        ...
        output = output.set_enable_partial_results_stabilization(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_enable_partial_results_stabilization_header(_response_headers)
        ...
        output = output.set_language_code(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_language_code_header(_response_headers)
        ...
        output = output.set_language_model_name(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_language_model_name_header(_response_headers)
        ...
        output = output.set_media_encoding(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_media_encoding_header(_response_headers)
        ...
        output = output.set_pii_entity_types(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_pii_entity_types_header(_response_headers)
        ...
        output = output.set_request_id(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_request_id_header(_response_headers)
        ...
        output = output.set_session_id(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_session_id_header(_response_headers)
        ...
        output = output.set_vocabulary_name(
            crate::protocol_serde::shape_start_call_analytics_stream_transcription_output::de_vocabulary_name_header(_response_headers)
