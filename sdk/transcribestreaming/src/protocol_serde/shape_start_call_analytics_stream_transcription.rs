...
pub fn de_start_call_analytics_stream_transcription_op_response(
...
> {
    ...
    crate::protocol_serde::shape_start_call_analytics_stream_transcription::de_start_call_analytics_stream_transcription_http_response_with_props(
        response,
        &properties,
    )
}
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_start_call_analytics_stream_transcription_http_response_with_props(
