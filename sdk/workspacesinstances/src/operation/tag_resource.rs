...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Workspaces Instances", "TagResource", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TagResourceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("WorkspaceInstanceId") {
            if let ::std::option::Option::Some(value) = input.workspace_instance_id.as_deref() {
                captured.insert("WorkspaceInstanceId", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/EUCMIFrontendAPIService/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
