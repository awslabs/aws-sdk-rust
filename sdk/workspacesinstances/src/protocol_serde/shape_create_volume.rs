...
pub fn de_create_volume_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::create_volume::CreateVolumeError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::create_volume::CreateVolumeError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::create_volume::CreateVolumeError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::create_volume::CreateVolumeError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::create_volume::CreateVolumeError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::create_volume::CreateVolumeError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_create_volume_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_create_volume_input::ser_create_volume_input_input(encoder, input)?;
    }
...
pub(crate) fn de_create_volume(
...
) -> ::std::result::Result<crate::operation::create_volume::builders::CreateVolumeOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    ) -> ::std::result::Result<crate::operation::create_volume::builders::CreateVolumeOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
    {
        builder = match decoder.str()?.as_ref() {
            "VolumeId" => {
                ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| Ok(builder.set_volume_id(Some(decoder.string()?))))?
            }
            _ => {
                decoder.skip()?;
                builder
