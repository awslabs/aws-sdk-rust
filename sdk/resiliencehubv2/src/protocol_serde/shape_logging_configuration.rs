...
pub fn ser_logging_configuration(
    ...
    if let Some(var_2) = &input.cloud_watch_log_group_arn {
        object.key("cloudWatchLogGroupArn").string(var_2.as_str());
    }
    if let Some(var_3) = &input.log_schema_version {
        object.key("logSchemaVersion").string(var_3.as_str());
    }
    Ok(())
}
