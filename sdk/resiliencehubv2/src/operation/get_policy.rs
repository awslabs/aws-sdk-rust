...
impl GetPolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("resiliencehubv2", "GetPolicy", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "resiliencehubv2.GetPolicy",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/v2/get-policy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::get_policy::GetPolicyInput,
                ...
                query.push_kv("policyArn", &::aws_smithy_http::query::fmt_string(inner_1));
                ::std::result::Result::Ok(())
            }
...
impl GetPolicyError {
    ...
    /// Returns `true` if the error kind is `GetPolicyError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `GetPolicyError::ValidationException`.
