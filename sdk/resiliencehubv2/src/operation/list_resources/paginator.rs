...
impl ListResourcesPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `service_resources`. Queries to the underlying service
...
impl ListResourcesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_resources_output_output_service_resources(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
