...
pub(crate) fn reflens_list_batch_job_definitions_output_output_next_token(
...
pub(crate) fn reflens_list_batch_job_executions_output_output_next_token(
...
pub(crate) fn lens_list_application_versions_output_output_application_versions(
    input: crate::operation::list_application_versions::ListApplicationVersionsOutput,
...
pub(crate) fn lens_list_batch_job_definitions_output_output_batch_job_definitions(
    input: crate::operation::list_batch_job_definitions::ListBatchJobDefinitionsOutput,
...
pub(crate) fn lens_list_batch_job_executions_output_output_batch_job_executions(
    input: crate::operation::list_batch_job_executions::ListBatchJobExecutionsOutput,
...
pub(crate) fn lens_list_data_set_import_history_output_output_data_set_import_tasks(
    input: crate::operation::list_data_set_import_history::ListDataSetImportHistoryOutput,
...
pub(crate) fn lens_list_engine_versions_output_output_engine_versions(
    input: crate::operation::list_engine_versions::ListEngineVersionsOutput,
