...
impl ListDeploymentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_deployments::ListDeployments, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeployments {
    type Output =
        ::std::result::Result<crate::operation::list_deployments::ListDeploymentsOutput, crate::operation::list_deployments::ListDeploymentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_deployments::de_list_deployments_http_response_with_props(status, headers, body)
        }
    }
}
