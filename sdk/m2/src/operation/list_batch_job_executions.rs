...
/// Orchestration and serialization glue logic for `ListBatchJobExecutions`.
...
impl ListBatchJobExecutions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_batch_job_executions::ListBatchJobExecutionsInput,
                    ) -> ::std::result::Result<crate::operation::list_batch_job_executions::ListBatchJobExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_batch_job_executions::ListBatchJobExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListBatchJobExecutions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListBatchJobExecutions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListBatchJobExecutionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListBatchJobExecutionsResponseDeserializer));
...
.with_interceptor(ListBatchJobExecutionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsError>::new());
...
#[derive(Debug)]
            struct ListBatchJobExecutionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListBatchJobExecutionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_batch_job_executions::de_list_batch_job_executions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_batch_job_executions::de_list_batch_job_executions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListBatchJobExecutionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListBatchJobExecutionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_batch_job_executions::ListBatchJobExecutionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_batch_job_executions::ListBatchJobExecutionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/applications/{applicationId}/batch-job-executions", applicationId = application_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_batch_job_executions::ListBatchJobExecutionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_8) = &_input.started_after {
         {
            query.push_kv("startedAfter", &::aws_smithy_http::query::fmt_timestamp(inner_8, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_9) = &_input.started_before {
         {
            query.push_kv("startedBefore", &::aws_smithy_http::query::fmt_timestamp(inner_9, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    ::std::result::Result::Ok(())
}
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListBatchJobExecutionsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListBatchJobExecutionsInput>()
                        .ok_or("failed to downcast to ListBatchJobExecutionsInput")?;
...
pub enum ListBatchJobExecutionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListBatchJobExecutionsError) for what information is available for the error.")]
...
impl ListBatchJobExecutionsError {
    /// Creates the `ListBatchJobExecutionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListBatchJobExecutionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListBatchJobExecutionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_batch_job_executions::ListBatchJobExecutionsError {
...
mod _list_batch_job_executions_output;
