...
impl ListDataSetImportHistoryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_data_set_import_history::ListDataSetImportHistory::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDataSetImportHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_data_set_import_history::de_list_data_set_import_history_http_response_with_props(status, headers, body)
        }
    }
}
