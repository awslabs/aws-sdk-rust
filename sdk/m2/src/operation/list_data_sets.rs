...
impl ListDataSets {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_data_sets::ListDataSetsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_data_sets::ListDataSetsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("m2", "ListDataSets", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDataSets {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListDataSets", "m2"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDataSetsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("nameFilter") {
            if let ::std::option::Option::Some(value) = input.name_filter.as_deref() {
                captured.insert("nameFilter", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDataSetsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_data_sets::de_list_data_sets_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_data_sets::de_list_data_sets_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDataSetsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_data_sets::ListDataSetsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_data_sets::ListDataSetsInput,
