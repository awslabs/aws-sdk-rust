...
impl UpdateEnvironmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_environment::ser_update_environment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_environment::de_update_environment_http_response_with_props(status, headers, body)
        }
    }
}
