...
impl DeleteApplicationFromEnvironmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_application_from_environment::DeleteApplicationFromEnvironment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApplicationFromEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_application_from_environment::de_delete_application_from_environment_http_response_with_props(
                status, headers, body,
            )
        }
    }
