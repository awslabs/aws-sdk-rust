...
impl CancelBatchJobExecutionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_batch_job_execution::CancelBatchJobExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_batch_job_execution::CancelBatchJobExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_batch_job_execution::CancelBatchJobExecutionOutput, crate::operation::cancel_batch_job_execution::CancelBatchJobExecutionError, Self> {
