                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::create_deployment::CreateDeploymentError::unhandled(
...
pub fn de_create_deployment_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_deployment_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_deployment::CreateDeploymentError::unhandled)?
    })
}
