                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_data_set_details::GetDataSetDetailsError::unhandled(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "dataSetOrg" => {
                    builder = builder.set_data_set_org(
                        crate::protocol_serde::shape_dataset_detail_org_attributes::de_dataset_detail_org_attributes(tokens, _value, depth + 1)?,
                    );
                }
                "fileSize" => {
