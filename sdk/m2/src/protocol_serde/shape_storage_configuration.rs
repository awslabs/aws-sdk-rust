...
pub fn ser_storage_configuration(object_17: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StorageConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_storage_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StorageConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
