...
pub fn ser_data_set(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataSet) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
