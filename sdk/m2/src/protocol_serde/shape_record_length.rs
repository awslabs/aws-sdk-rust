...
pub fn ser_record_length(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RecordLength) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
