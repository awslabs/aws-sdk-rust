...
pub fn ser_dataset_org_attributes(object_4: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetOrgAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
