...
pub fn ser_start_batch_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartBatchJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
