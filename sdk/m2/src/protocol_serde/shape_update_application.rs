...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::update_application::UpdateApplicationError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ConflictException" => {
            crate::operation::update_application::UpdateApplicationError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
