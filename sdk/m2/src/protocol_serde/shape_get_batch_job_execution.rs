...
pub fn de_get_batch_job_execution_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBatchJobExecutionOutput, crate::error::GetBatchJobExecutionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetBatchJobExecutionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_batch_job_execution_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetBatchJobExecutionOutput, crate::error::GetBatchJobExecutionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_batch_job_execution_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_batch_job_execution::de_get_batch_job_execution(response.body().as_ref(), output).map_err(crate::error::GetBatchJobExecutionError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_batch_job_execution(value: &[u8], mut builder: crate::output::get_batch_job_execution_output::Builder) -> Result<crate::output::get_batch_job_execution_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
