...
pub fn de_list_data_set_import_history_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListDataSetImportHistoryOutput, crate::error::ListDataSetImportHistoryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListDataSetImportHistoryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_data_set_import_history_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListDataSetImportHistoryOutput, crate::error::ListDataSetImportHistoryError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_data_set_import_history(value: &[u8], mut builder: crate::output::list_data_set_import_history_output::Builder) -> Result<crate::output::list_data_set_import_history_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
