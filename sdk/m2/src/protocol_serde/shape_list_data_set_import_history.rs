...
pub fn de_list_data_set_import_history_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_data_set_import_history::ListDataSetImportHistoryOutput, crate::operation::list_data_set_import_history::ListDataSetImportHistoryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_data_set_import_history::ListDataSetImportHistoryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_data_set_import_history_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_data_set_import_history::ListDataSetImportHistoryOutput, crate::operation::list_data_set_import_history::ListDataSetImportHistoryError> {
    Ok({
        #[allow(unused_mut)]
