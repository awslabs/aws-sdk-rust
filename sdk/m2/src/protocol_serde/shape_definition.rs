...
pub fn ser_definition(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Definition) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
