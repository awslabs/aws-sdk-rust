...
pub(crate) fn de_batch_job_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchJobDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
