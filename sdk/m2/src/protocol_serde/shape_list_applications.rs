...
pub fn de_list_applications_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_applications::ListApplicationsOutput, crate::operation::list_applications::ListApplicationsError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_applications::ListApplicationsError::unhandled(
...
) -> Result<crate::operation::list_applications::builders::ListApplicationsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "applications" => {
                    builder = builder.set_applications(crate::protocol_serde::shape_application_summary_list::de_application_summary_list(
                        tokens,
                    )?);
                }
                "nextToken" => {
