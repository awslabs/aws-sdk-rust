...
pub fn de_list_applications_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_applications::ListApplicationsOutput, crate::operation::list_applications::ListApplicationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_applications_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_applications::ListApplicationsOutput, crate::operation::list_applications::ListApplicationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_applications::builders::ListApplicationsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_applications::de_list_applications(response.body().as_ref(), output).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
