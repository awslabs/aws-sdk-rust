...
pub struct EnvironmentSummary  {
    ...
    #[doc(hidden)]pub environment_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::EnvironmentLifecycle>,
...
pub struct PendingMaintenance  {
    ...
    #[doc(hidden)]pub schedule: std::option::Option<crate::model::MaintenanceSchedule>,
...
pub struct ScriptBatchJobIdentifier  {
    ...
    #[doc(hidden)]pub script_name: std::option::Option<std::string::String>,
}
...
pub struct FileBatchJobIdentifier  {
    ...
    #[doc(hidden)]pub file_name: std::option::Option<std::string::String>,
    /// <p>The relative path to the file name for the batch job identifier.</p>
    #[doc(hidden)]pub folder_path: std::option::Option<std::string::String>,
}
...
pub struct DeploymentSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::DeploymentLifecycle>,
...
pub struct DataSetSummary  {
    ...
    #[doc(hidden)]pub data_set_org: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub last_referenced_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl DataSetSummary {
    /// <p>The name of the data set.</p>
...
pub struct DataSetImportTask  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::DataSetTaskLifecycle>,
    /// <p>A summary of the data set import task.</p>
    #[doc(hidden)]pub summary: std::option::Option<crate::model::DataSetImportSummary>,
}
...
pub struct BatchJobExecutionSummary  {
    ...
    #[doc(hidden)]pub job_type: std::option::Option<crate::model::BatchJobType>,
...
pub struct ApplicationVersionSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ApplicationVersionLifecycle>,
    /// <p>The reason for the reported status.</p>
    #[doc(hidden)]pub status_reason: std::option::Option<std::string::String>,
...
pub struct GdgDetailAttributes  {
    ...
    #[doc(hidden)]pub roll_disposition: std::option::Option<std::string::String>,
}
...
pub struct VsamDetailAttributes  {
    ...
    #[doc(hidden)]pub encoding: std::option::Option<std::string::String>,
    /// <p>The record format of the data set.</p>
    #[doc(hidden)]pub record_format: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub compressed: std::option::Option<bool>,
    /// <p>If set to True, enforces loading the data set into cache before it’s used by the application.</p>
    #[doc(hidden)]pub cache_at_startup: std::option::Option<bool>,
    /// <p>The primary key of the data set.</p>
    #[doc(hidden)]pub primary_key: std::option::Option<crate::model::PrimaryKey>,
    ...
    #[doc(hidden)]pub alternate_keys: std::option::Option<std::vec::Vec<crate::model::AlternateKey>>,
}
...
pub struct AlternateKey  {
    ...
    #[doc(hidden)]pub allow_duplicates: bool,
}
impl AlternateKey {
    /// <p>The name of the alternate key.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct DataSetImportItem  {
    /// <p>The data set.</p>
    #[doc(hidden)]pub data_set: std::option::Option<crate::model::DataSet>,
    /// <p>The location of the data set.</p>
    #[doc(hidden)]pub external_location: std::option::Option<crate::model::ExternalLocation>,
}
...
impl ExternalLocation {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`S3Location`](crate::model::ExternalLocation::S3Location), extracting the inner [`String`](std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
    pub fn as_s3_location(&self) -> std::result::Result<&std::string::String, &Self> {
...
pub struct DataSet  {
    ...
    #[doc(hidden)]pub dataset_org: std::option::Option<crate::model::DatasetOrgAttributes>,
    /// <p>The relative location of the data set in the database or file system. </p>
    #[doc(hidden)]pub relative_path: std::option::Option<std::string::String>,
    /// <p>The length of a record.</p>
    #[doc(hidden)]pub record_length: std::option::Option<crate::model::RecordLength>,
}
impl DataSet {
    /// <p>The storage type of the data set: database or file system. For Micro Focus, database corresponds to datastore and file system corresponds to EFS/FSX. For Blu Age, there is no support of file system and database corresponds to Blusam. </p>
...
pub struct VsamAttributes  {
    ...
    #[doc(hidden)]pub encoding: std::option::Option<std::string::String>,
    /// <p>Indicates whether indexes for this dataset are stored as compressed values. If you have a large data set (typically &gt; 100 Mb), consider setting this flag to True.</p>
    #[doc(hidden)]pub compressed: bool,
    /// <p>The primary key of the data set.</p>
    #[doc(hidden)]pub primary_key: std::option::Option<crate::model::PrimaryKey>,
    /// <p>The alternate key definitions, if any. A legacy dataset might not have any alternate key defined, but if those alternate keys definitions exist, provide them as some applications will make use of them.</p>
    #[doc(hidden)]pub alternate_keys: std::option::Option<std::vec::Vec<crate::model::AlternateKey>>,
...
pub struct ApplicationSummary  {
    ...
    #[doc(hidden)]pub application_arn: std::option::Option<std::string::String>,
    /// <p>The version of the application.</p>
    #[doc(hidden)]pub application_version: std::option::Option<i32>,
    /// <p>The status of the application.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ApplicationLifecycle>,
    ...
    #[doc(hidden)]pub last_start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Indicates the status of the latest version of the application.</p>
    #[doc(hidden)]pub version_status: std::option::Option<crate::model::ApplicationVersionLifecycle>,
    /// <p>Indicates whether there is an ongoing deployment or if the application has ever deployed successfully.</p>
    #[doc(hidden)]pub deployment_status: std::option::Option<crate::model::ApplicationDeploymentLifecycle>,
}
...
impl ApplicationLifecycle {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "Available", "Created", "Creating", "Deleting", "Failed", "Ready", "Running", "Starting", "Stopped", "Stopping"
        ]
    }
}
...
pub struct LogGroupSummary  {
    /// <p>The type of log.</p>
    #[doc(hidden)]pub log_type: std::option::Option<std::string::String>,
