...
impl aws_smithy_http::response::ParseStrictResponse for CancelBatchJobExecution {
                type Output = std::result::Result<crate::output::CancelBatchJobExecutionOutput, crate::error::CancelBatchJobExecutionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_batch_job_execution::de_cancel_batch_job_execution_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_batch_job_execution::de_cancel_batch_job_execution_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDataSetImportTask {
                type Output = std::result::Result<crate::output::CreateDataSetImportTaskOutput, crate::error::CreateDataSetImportTaskError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_data_set_import_task::de_create_data_set_import_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_data_set_import_task::de_create_data_set_import_task_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateEnvironment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_environment::de_create_environment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_environment::de_create_environment_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteApplicationFromEnvironment {
                type Output = std::result::Result<crate::output::DeleteApplicationFromEnvironmentOutput, crate::error::DeleteApplicationFromEnvironmentError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_application_from_environment::de_delete_application_from_environment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_application_from_environment::de_delete_application_from_environment_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteEnvironment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_environment::de_delete_environment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_environment::de_delete_environment_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetApplicationVersion {
                type Output = std::result::Result<crate::output::GetApplicationVersionOutput, crate::error::GetApplicationVersionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_application_version::de_get_application_version_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_application_version::de_get_application_version_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetBatchJobExecution {
                type Output = std::result::Result<crate::output::GetBatchJobExecutionOutput, crate::error::GetBatchJobExecutionError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
...
impl aws_smithy_http::response::ParseStrictResponse for GetDataSetDetails {
                type Output = std::result::Result<crate::output::GetDataSetDetailsOutput, crate::error::GetDataSetDetailsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_data_set_details::de_get_data_set_details_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_data_set_details::de_get_data_set_details_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetDataSetImportTask {
                type Output = std::result::Result<crate::output::GetDataSetImportTaskOutput, crate::error::GetDataSetImportTaskError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_data_set_import_task::de_get_data_set_import_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_data_set_import_task::de_get_data_set_import_task_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListBatchJobDefinitions {
                type Output = std::result::Result<crate::output::ListBatchJobDefinitionsOutput, crate::error::ListBatchJobDefinitionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
...
impl aws_smithy_http::response::ParseStrictResponse for ListBatchJobExecutions {
                type Output = std::result::Result<crate::output::ListBatchJobExecutionsOutput, crate::error::ListBatchJobExecutionsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_batch_job_executions::de_list_batch_job_executions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_batch_job_executions::de_list_batch_job_executions_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListDataSetImportHistory {
                type Output = std::result::Result<crate::output::ListDataSetImportHistoryOutput, crate::error::ListDataSetImportHistoryError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_data_set_import_history::de_list_data_set_import_history_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_data_set_import_history::de_list_data_set_import_history_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListEngineVersions {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_engine_versions::de_list_engine_versions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_engine_versions::de_list_engine_versions_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListEnvironments {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_environments::de_list_environments_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_environments::de_list_environments_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StartApplication {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_application::de_start_application_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_application::de_start_application_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StartBatchJob {
                type Output = std::result::Result<crate::output::StartBatchJobOutput, crate::error::StartBatchJobError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_batch_job::de_start_batch_job_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_batch_job::de_start_batch_job_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StopApplication {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        ...
                        crate::protocol_serde::shape_stop_application::de_stop_application_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateEnvironment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_environment::de_update_environment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_environment::de_update_environment_http_response(response)
                     }
                }
            }
