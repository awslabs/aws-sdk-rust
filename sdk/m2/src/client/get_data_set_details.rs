...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_data_set_details::builders::GetDataSetDetailsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_data_set_details::builders::GetDataSetDetailsFluentBuilder::set_application_id): <p>The unique identifier of the application that this data set is associated with.</p>
    ///   - [`data_set_name(impl ::std::convert::Into<String>)`](crate::operation::get_data_set_details::builders::GetDataSetDetailsFluentBuilder::data_set_name) / [`set_data_set_name(Option<String>)`](crate::operation::get_data_set_details::builders::GetDataSetDetailsFluentBuilder::set_data_set_name): <p>The name of the data set.</p>
