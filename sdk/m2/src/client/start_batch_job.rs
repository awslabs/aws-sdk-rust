...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::start_batch_job::builders::StartBatchJobFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::start_batch_job::builders::StartBatchJobFluentBuilder::set_application_id): <p>The unique identifier of the application associated with this batch job.</p>
