...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::start_batch_job::builders::StartBatchJobFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::start_batch_job::builders::StartBatchJobFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier of the application associated with this batch job.</p><br>
