...
impl super::Client {
    ...
    ///   - [`job_step_restart_marker(Option<JobStepRestartMarker>)`](crate::operation::get_batch_job_execution::GetBatchJobExecutionOutput::job_step_restart_marker): <p>The restart steps information for the most recent restart operation.</p>
