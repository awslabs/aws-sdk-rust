...
impl super::Client {
    ...
    ///   - [`names(impl Into<String>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::set_names): <p>The names of the applications.</p>
