...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::set_next_token): <p>A pagination token to control the number of batch job executions displayed in the list.</p>
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::set_application_id): <p>The unique identifier of the application.</p>
    ...
    ///   - [`job_name(impl ::std::convert::Into<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::job_name) / [`set_job_name(Option<String>)`](crate::operation::list_batch_job_executions::builders::ListBatchJobExecutionsFluentBuilder::set_job_name): <p>The name of each batch job execution.</p>
