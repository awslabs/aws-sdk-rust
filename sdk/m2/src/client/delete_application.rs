...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::delete_application::builders::DeleteApplicationFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::delete_application::builders::DeleteApplicationFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier of the application you want to delete.</p><br>
