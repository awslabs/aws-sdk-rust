...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::application_id) / [`set_application_id(impl Into<String>)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::set_application_id):<br>required: **true**<br><p>The unique identifier of the application you want to stop.</p><br>
    ///   - [`force_stop(bool)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::force_stop) / [`set_force_stop(bool)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::set_force_stop):<br>required: **false**<br><p>Stopping an application process can take a long time. Setting this parameter to true lets you force stop the application so you don't need to wait until the process finishes to apply another action on the application. The default value is false.</p><br>
