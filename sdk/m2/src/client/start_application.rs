...
impl super::Client {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::start_application::builders::StartApplicationFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::start_application::builders::StartApplicationFluentBuilder::set_application_id): <p>The unique identifier of the application you want to start.</p>
