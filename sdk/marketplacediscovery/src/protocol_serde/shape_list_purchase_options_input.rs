...
pub fn ser_list_purchase_options_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::list_purchase_options::ListPurchaseOptionsInput,
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_purchase_option_filter::ser_purchase_option_filter(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
