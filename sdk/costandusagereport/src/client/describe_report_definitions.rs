...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_report_definitions::builders::DescribeReportDefinitionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_report_definitions::builders::DescribeReportDefinitionsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results that AWS returns for the operation.</p><br>
