...
impl PutReportDefinitionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_report_definition::PutReportDefinition::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("PutReportDefinition", "costandusagereportservice"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutReportDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_report_definition::de_put_report_definition_http_response_with_props(status, headers, body)
        }
    }
}
