...
impl DescribeReportDefinitionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_report_definitions::DescribeReportDefinitions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReportDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_report_definitions::de_describe_report_definitions_http_response_with_props(status, headers, body)
        }
    }
}
