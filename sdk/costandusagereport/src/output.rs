...
pub struct DescribeReportDefinitionsOutput  {
    ...
    #[doc(hidden)]pub report_definitions: std::option::Option<std::vec::Vec<crate::model::ReportDefinition>>,
...
pub struct DeleteReportDefinitionOutput  {
    ...
    #[doc(hidden)]pub response_message: std::option::Option<std::string::String>,
}
