...
pub fn serialize_structure_delete_report_definition_input(
...
pub fn serialize_structure_describe_report_definitions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_modify_report_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_5) = &input.report_definition {
        ...
        crate::json_ser::serialize_structure_report_definition(&mut object_6, var_5);
        object_6.finish();
    }
}

pub fn serialize_structure_put_report_definition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_7) = &input.report_definition {
        ...
        crate::json_ser::serialize_structure_report_definition(&mut object_8, var_7);
        object_8.finish();
    }
}

pub fn serialize_structure_report_definition(
    object: &mut smithy_json::serialize::JsonObjectWriter,
