...
pub fn ser_report_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ReportDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
