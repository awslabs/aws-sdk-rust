...
pub fn ser_modify_report_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ModifyReportDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
