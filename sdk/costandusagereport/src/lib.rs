...
//! aws-sdk-costandusagereport = "1.101.0"
...
//! offered by AWS Cost and Usage Report Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Cost and Usage Report Service.
...
/// let config = aws_sdk_costandusagereport::config::Builder::from(&sdk_config)
/// # /*
