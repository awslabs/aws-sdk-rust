...
pub struct ReportDefinition  {
    ...
    #[doc(hidden)]pub format: std::option::Option<crate::model::ReportFormat>,
    /// <p>The compression format that AWS uses for the report.</p>
    #[doc(hidden)]pub compression: std::option::Option<crate::model::CompressionFormat>,
    ...
    #[doc(hidden)]pub additional_schema_elements: std::option::Option<std::vec::Vec<crate::model::SchemaElement>>,
    ...
    #[doc(hidden)]pub s3_region: std::option::Option<crate::model::AwsRegion>,
    /// <p>A list of manifests that you want Amazon Web Services to create for this report.</p>
    #[doc(hidden)]pub additional_artifacts: std::option::Option<std::vec::Vec<crate::model::AdditionalArtifact>>,
    ...
    #[doc(hidden)]pub refresh_closed_reports: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub report_versioning: std::option::Option<crate::model::ReportVersioning>,
    /// <p> The Amazon resource name of the billing view. You can get this value by using the billing view service public APIs. </p>
    #[doc(hidden)]pub billing_view_arn: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ReportDefinition  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("additional_schema_elements", &self.additional_schema_elements);
