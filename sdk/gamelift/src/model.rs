...
pub struct GameSessionQueue  {
    ...
    #[doc(hidden)]
    pub player_latency_policies: std::option::Option<std::vec::Vec<crate::model::PlayerLatencyPolicy>>,
...
pub struct GameSession  {
    ...
    #[doc(hidden)]
    pub player_session_creation_policy: std::option::Option<crate::model::PlayerSessionCreationPolicy>,
...
pub struct GameServerGroup  {
    ...
    #[doc(hidden)]
    pub game_server_protection_policy: std::option::Option<crate::model::GameServerProtectionPolicy>,
...
pub mod anywhere_configuration {
    ...
    impl Builder {
        ...
        pub fn build(self) -> crate::model::AnywhereConfiguration {
            crate::model::AnywhereConfiguration {
                cost: self.cost
                ,
            }
        }
...
pub struct GameSessionPlacement  {
    ...
    #[doc(hidden)]
    pub placed_player_sessions: std::option::Option<std::vec::Vec<crate::model::PlacedPlayerSession>>,
...
pub struct GameSessionConnectionInfo  {
    ...
    #[doc(hidden)]
    pub matched_player_sessions: std::option::Option<std::vec::Vec<crate::model::MatchedPlayerSession>>,
}
...
pub struct Player  {
    ...
    #[doc(hidden)]
    pub player_attributes: std::option::Option<std::collections::HashMap<std::string::String, crate::model::AttributeValue>>,
...
pub mod compute {
    ...
    impl Builder {
        ...
        /// <p>Current status of the compute. A compute must have an <code>ACTIVE</code> status to host game sessions.</p>
        pub fn set_compute_status(mut self, input: std::option::Option<crate::model::ComputeStatus>) -> Self {
...
pub struct FleetAttributes  {
    ...
    /// <p>The policy is evaluated when a player tries to create a new game session. On receiving a <code>CreateGameSession</code> request, GameLift checks that the player (identified by <code>CreatorId</code>) has created fewer than game session limit in the specified time period.</p>
    #[doc(hidden)]
    pub resource_creation_limit_policy: std::option::Option<crate::model::ResourceCreationLimitPolicy>,
...
impl FleetAttributes {
    ...
    /// <p>GameLift Anywhere configuration options for your Anywhere fleets.</p>
    pub fn anywhere_configuration(&self) -> std::option::Option<& crate::model::AnywhereConfiguration> {
