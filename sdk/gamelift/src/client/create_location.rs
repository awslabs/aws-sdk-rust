...
impl super::Client {
    ...
    ///   - [`location_name(impl ::std::convert::Into<String>)`](crate::operation::create_location::builders::CreateLocationFluentBuilder::location_name) / [`set_location_name(Option<String>)`](crate::operation::create_location::builders::CreateLocationFluentBuilder::set_location_name): <p>A descriptive name for the custom location.</p>
