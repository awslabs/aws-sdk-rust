...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::get_instance_access::builders::GetInstanceAccessFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::get_instance_access::builders::GetInstanceAccessFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet that contains the instance you want to access. You can request access to instances in EC2 fleets with the following statuses: <code>ACTIVATING</code>, <code>ACTIVE</code>, or <code>ERROR</code>. Use either a fleet ID or an ARN value. </p> <note>   <p>You can access fleets in <code>ERROR</code> status for a short period of time before Amazon GameLift deletes them.</p>  </note>
    ///   - [`instance_id(impl Into<String>)`](crate::operation::get_instance_access::builders::GetInstanceAccessFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::get_instance_access::builders::GetInstanceAccessFluentBuilder::set_instance_id): <p>A unique identifier for the instance you want to access. You can access an instance in any status.</p>
