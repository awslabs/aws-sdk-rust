...
impl super::Client {
    ...
    ///   - [`ticket_ids(impl Into<String>)`](crate::operation::describe_matchmaking::builders::DescribeMatchmakingFluentBuilder::ticket_ids) / [`set_ticket_ids(Option<Vec<String>>)`](crate::operation::describe_matchmaking::builders::DescribeMatchmakingFluentBuilder::set_ticket_ids): <p>A unique identifier for a matchmaking ticket. You can include up to 10 ID values. </p>
