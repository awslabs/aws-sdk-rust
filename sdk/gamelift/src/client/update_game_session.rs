...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_game_session::builders::UpdateGameSessionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_game_session::builders::UpdateGameSessionFluentBuilder::set_name): <p>A descriptive label that is associated with a game session. Session names do not need to be unique.</p>
