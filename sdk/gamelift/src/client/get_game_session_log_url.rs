...
impl super::Client {
    ...
    pub fn get_game_session_log_url(
        &self,
    ) -> crate::operation::get_game_session_log_url::builders::GetGameSessionLogUrlFluentBuilder
    {
        crate::operation::get_game_session_log_url::builders::GetGameSessionLogUrlFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
