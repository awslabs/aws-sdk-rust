...
impl super::Client {
    ...
    ///   - [`alias_id(impl Into<String>)`](crate::operation::describe_alias::builders::DescribeAliasFluentBuilder::alias_id) / [`set_alias_id(Option<String>)`](crate::operation::describe_alias::builders::DescribeAliasFluentBuilder::set_alias_id):<br>required: **true**<br><p>The unique identifier for the fleet alias that you want to retrieve. You can use either the alias ID or ARN value.</p><br>
