...
impl super::Client {
    ...
    ///   - [`player_data(impl Into<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::player_data) / [`set_player_data(Option<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::set_player_data): <p>Developer-defined information related to a player. Amazon GameLift does not use this data, so it can be formatted as needed for use in the game.</p>
