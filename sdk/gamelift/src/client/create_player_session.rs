...
impl super::Client {
    ...
    ///   - [`game_session_id(impl Into<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::game_session_id) / [`set_game_session_id(Option<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::set_game_session_id):<br>required: **true**<br><p>A unique identifier for the game session to add a player to.</p><br>
    ...
    ///   - [`player_data(impl Into<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::player_data) / [`set_player_data(Option<String>)`](crate::operation::create_player_session::builders::CreatePlayerSessionFluentBuilder::set_player_data):<br>required: **false**<br><p>Developer-defined information related to a player. Amazon GameLift does not use this data, so it can be formatted as needed for use in the game.</p><br>
