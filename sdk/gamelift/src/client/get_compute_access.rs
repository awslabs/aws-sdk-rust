...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet that contains the compute resource you want to connect to. You can use either the fleet ID or ARN value.</p>
    ///   - [`compute_name(impl Into<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::compute_name) / [`set_compute_name(Option<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::set_compute_name): <p>A unique identifier for the compute resource that you want to connect to. You can use either a registered compute name or an instance ID.</p>
