...
impl super::Client {
    ...
    ///   - [`fleet_id(impl ::std::convert::Into<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet that the compute resource is registered to.</p>
    ///   - [`compute_name(impl ::std::convert::Into<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::compute_name) / [`set_compute_name(Option<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::set_compute_name): <p>The name of the compute resource you are requesting credentials for.</p>
