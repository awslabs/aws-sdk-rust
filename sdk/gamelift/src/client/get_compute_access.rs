...
impl super::Client {
    ...
    ///   - [`compute_name(impl Into<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::compute_name) / [`set_compute_name(Option<String>)`](crate::operation::get_compute_access::builders::GetComputeAccessFluentBuilder::set_compute_name):<br>required: **true**<br><p>A unique identifier for the compute resource that you want to connect to. For an EC2 fleet compute, use the instance ID. Use <code>ListCompute</code> to retrieve compute identifiers.</p><br>
    ...
    ///   - [`target(Option<String>)`](crate::operation::get_compute_access::GetComputeAccessOutput::target): <p>The instance ID where the compute resource is running.</p>
    ///   - [`container_identifiers(Option<Vec::<ContainerIdentifier>>)`](crate::operation::get_compute_access::GetComputeAccessOutput::container_identifiers): <p>For a managed container fleet, a list of containers on the compute. Use the container runtime ID with Docker commands to connect to a specific container.</p>
