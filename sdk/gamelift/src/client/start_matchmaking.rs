...
impl super::Client {
    ...
    ///   - [`ticket_id(impl Into<String>)`](crate::operation::start_matchmaking::builders::StartMatchmakingFluentBuilder::ticket_id) / [`set_ticket_id(Option<String>)`](crate::operation::start_matchmaking::builders::StartMatchmakingFluentBuilder::set_ticket_id):<br>required: **false**<br><p>A unique identifier for a matchmaking ticket. If no ticket ID is specified here, Amazon GameLift Servers will generate one in the form of a UUID. Use this identifier to track the matchmaking ticket status and retrieve match results.</p><br>
