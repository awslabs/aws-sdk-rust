...
impl super::Client {
    ...
    ///   - [`filters(LocationFilter)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::filters) / [`set_filters(Option<Vec::<LocationFilter>>)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::set_filters):<br>required: **false**<br><p>Filters the list for <code>AWS</code> or <code>CUSTOM</code> locations. Use this parameter to narrow down results to only Amazon Web Services-managed locations (Amazon EC2 or container) or only your custom locations (such as an Amazon GameLift Servers Anywhere fleet).</p><br>
    ///   - [`limit(i32)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of results to return. Use this parameter with <code>NextToken</code> to get results as a set of sequential pages.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_locations::builders::ListLocationsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token that indicates the start of the next sequential page of results. Use the token that is returned with a previous call to this operation. To start at the beginning of the result set, do not specify a value.</p><br>
    /// - On success, responds with [`ListLocationsOutput`](crate::operation::list_locations::ListLocationsOutput) with field(s):
    ///   - [`locations(Option<Vec::<LocationModel>>)`](crate::operation::list_locations::ListLocationsOutput::locations): <p>A collection of locations, including both Amazon Web Services and custom locations. Each location includes a name and ping beacon information that can be used to measure network latency between player devices and the location.</p>
