...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::describe_game_sessions::builders::DescribeGameSessionsFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::describe_game_sessions::builders::DescribeGameSessionsFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet to retrieve game sessions for. You can use either the fleet ID or ARN value. </p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_game_sessions::builders::DescribeGameSessionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_game_sessions::builders::DescribeGameSessionsFluentBuilder::set_next_token): <p>A token that indicates the start of the next sequential page of results. Use the token that is returned with a previous call to this operation. To start at the beginning of the result set, do not specify a value.</p>
