...
impl super::Client {
    ...
    ///   - [`fleet_id(impl ::std::convert::Into<String>)`](crate::operation::stop_fleet_actions::builders::StopFleetActionsFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::stop_fleet_actions::builders::StopFleetActionsFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet to stop actions on. You can use either the fleet ID or ARN value.</p>
