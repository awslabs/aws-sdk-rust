...
impl super::Client {
    ...
    ///   - [`actions(FleetAction)`](crate::operation::stop_fleet_actions::builders::StopFleetActionsFluentBuilder::actions) / [`set_actions(Option<Vec<FleetAction>>)`](crate::operation::stop_fleet_actions::builders::StopFleetActionsFluentBuilder::set_actions): <p>List of actions to suspend on the fleet. </p>
