...
impl super::Client {
    ...
    ///   - [`location_name(impl Into<String>)`](crate::operation::delete_location::builders::DeleteLocationFluentBuilder::location_name) / [`set_location_name(Option<String>)`](crate::operation::delete_location::builders::DeleteLocationFluentBuilder::set_location_name):<br>required: **true**<br><p>The location name of the custom location to be deleted.</p><br>
