...
impl super::Client {
    ...
    ///   - [`ticket_id(impl ::std::convert::Into<String>)`](crate::operation::accept_match::builders::AcceptMatchFluentBuilder::ticket_id) / [`set_ticket_id(Option<String>)`](crate::operation::accept_match::builders::AcceptMatchFluentBuilder::set_ticket_id): <p>A unique identifier for a matchmaking ticket. The ticket must be in status <code>REQUIRES_ACCEPTANCE</code>; otherwise this request will fail.</p>
