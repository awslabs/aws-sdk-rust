...
impl super::Client {
    ...
    ///   - [`script_id(impl Into<String>)`](crate::operation::describe_script::builders::DescribeScriptFluentBuilder::script_id) / [`set_script_id(Option<String>)`](crate::operation::describe_script::builders::DescribeScriptFluentBuilder::set_script_id):<br>required: **true**<br><p>A unique identifier for the Realtime script to retrieve properties for. You can use either the script ID or ARN value.</p><br>
