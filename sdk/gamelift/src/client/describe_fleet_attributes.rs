...
impl super::Client {
    ...
    ///   - [`fleet_ids(impl Into<String>)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::fleet_ids) / [`set_fleet_ids(Option<Vec::<String>>)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::set_fleet_ids):<br>required: **false**<br><p>A list of unique fleet identifiers to retrieve attributes for. You can use either the fleet ID or ARN value. To retrieve attributes for all current fleets, do not include this parameter.</p><br>
    ///   - [`limit(i32)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of results to return. Use this parameter with <code>NextToken</code> to get results as a set of sequential pages. This parameter is ignored when the request specifies one or a list of fleet IDs.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_fleet_attributes::builders::DescribeFleetAttributesFluentBuilder::set_next_token):<br>required: **false**<br><p>A token that indicates the start of the next sequential page of results. Use the token that is returned with a previous call to this operation. To start at the beginning of the result set, do not specify a value. This parameter is ignored when the request specifies one or a list of fleet IDs.</p><br>
