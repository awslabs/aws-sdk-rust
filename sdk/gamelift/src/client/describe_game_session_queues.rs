...
impl super::Client {
    ...
    ///   - [`names(impl Into<String>)`](crate::operation::describe_game_session_queues::builders::DescribeGameSessionQueuesFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::describe_game_session_queues::builders::DescribeGameSessionQueuesFluentBuilder::set_names): <p>A list of queue names to retrieve information for. You can use either the queue ID or ARN value. To request settings for all queues, leave this parameter empty. </p>
