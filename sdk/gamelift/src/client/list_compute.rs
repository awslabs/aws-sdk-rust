...
impl super::Client {
    ...
    ///   - [`fleet_id(impl Into<String>)`](crate::operation::list_compute::builders::ListComputeFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::list_compute::builders::ListComputeFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet to retrieve compute resources for.</p>
    ///   - [`location(impl Into<String>)`](crate::operation::list_compute::builders::ListComputeFluentBuilder::location) / [`set_location(Option<String>)`](crate::operation::list_compute::builders::ListComputeFluentBuilder::set_location): <p>The name of a location to retrieve compute resources for.</p>
