...
impl super::Client {
    ...
    ///   - [`ip_address(impl Into<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::ip_address) / [`set_ip_address(Option<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::set_ip_address):<br>required: **false**<br><p>The IP address of the compute resource. Amazon GameLift requires either a DNS name or IP address. When registering an Anywhere fleet, an IP address is required.</p><br>
