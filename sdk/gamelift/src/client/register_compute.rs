...
impl super::Client {
    ...
    ///   - [`compute_name(impl Into<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::compute_name) / [`set_compute_name(Option<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::set_compute_name): <p>A descriptive label for the compute resource.</p>
    ///   - [`certificate_path(impl Into<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::certificate_path) / [`set_certificate_path(Option<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::set_certificate_path): <p>The path to a TLS certificate on your compute resource. Amazon GameLift doesn't validate the path and certificate.</p>
    ...
    ///   - [`ip_address(impl Into<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::ip_address) / [`set_ip_address(Option<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::set_ip_address): <p>The IP address of the compute resource. Amazon GameLift requires either a DNS name or IP address.</p>
    ///   - [`location(impl Into<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::location) / [`set_location(Option<String>)`](crate::operation::register_compute::builders::RegisterComputeFluentBuilder::set_location): <p>The name of a custom location to associate with the compute resource being registered. </p>
