...
impl super::Client {
    ...
    ///   - [`game_server_group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_game_server_group::builders::DeleteGameServerGroupFluentBuilder::game_server_group_name) / [`set_game_server_group_name(Option<String>)`](crate::operation::delete_game_server_group::builders::DeleteGameServerGroupFluentBuilder::set_game_server_group_name): <p>A unique identifier for the game server group. Use either the name or ARN value.</p>
