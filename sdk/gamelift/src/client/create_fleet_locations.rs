...
impl super::Client {
    ...
    ///   - [`locations(LocationConfiguration)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::locations) / [`set_locations(Option<Vec<LocationConfiguration>>)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::set_locations): <p>A list of locations to deploy additional instances to and manage as part of the fleet. You can add any Amazon GameLift-supported Amazon Web Services Region as a remote location, in the form of an Amazon Web Services Region code such as <code>us-west-2</code>. </p>
