...
impl super::Client {
    ...
    ///   - [`fleet_id(impl ::std::convert::Into<String>)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::fleet_id) / [`set_fleet_id(Option<String>)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::set_fleet_id): <p>A unique identifier for the fleet to add locations to. You can use either the fleet ID or ARN value.</p>
    ///   - [`locations(Vec<LocationConfiguration>)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::locations) / [`set_locations(Option<Vec<LocationConfiguration>>)`](crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::set_locations): <p>A list of locations to deploy additional instances to and manage as part of the fleet. You can add any Amazon GameLift-supported Amazon Web Services Region as a remote location, in the form of an Amazon Web Services Region code such as <code>us-west-2</code>. </p>
    ...
    pub fn create_fleet_locations(
        &self,
    ) -> crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder {
        crate::operation::create_fleet_locations::builders::CreateFleetLocationsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
