...
/// <p>You can update a support container definition and deploy the updates to an existing fleet. When creating or updating a game server container group definition, use the property <code>GameServerContainerDefinitionInput</code>.</p>
...
pub struct SupportContainerDefinition {
    ...
    /// <p><b>Related data type: </b> <code>ContainerGroupDefinition$TotalMemoryLimitMebibytes</code></p>
    ...
    /// <p><b>Related data type: </b> <code>ContainerGroupDefinition$TotalVcpuLimit</code></p>
