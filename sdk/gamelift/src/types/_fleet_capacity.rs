...
/// <p>Current resource capacity settings for managed EC2 fleets and container fleets. For multi-location fleets, location values might refer to a fleet's remote location or its home Region.</p>
...
pub struct FleetCapacity {
    ...
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> The number and status of replica container groups in a container fleet.</p>
    pub replica_container_group_counts: ::std::option::Option<crate::types::ReplicaContainerGroupCounts>,
}
impl FleetCapacity {
    /// <p>A unique identifier for the fleet associated with the location.</p>
    ...
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> The number and status of replica container groups in a container fleet.</p>
    pub fn replica_container_group_counts(&self) -> ::std::option::Option<&crate::types::ReplicaContainerGroupCounts> {
        self.replica_container_group_counts.as_ref()
    }
}
impl FleetCapacity {
...
pub struct FleetCapacityBuilder {
    ...
    pub(crate) replica_container_group_counts: ::std::option::Option<crate::types::ReplicaContainerGroupCounts>,
}
impl FleetCapacityBuilder {
    ...
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> The number and status of replica container groups in a container fleet.</p>
    pub fn replica_container_group_counts(mut self, input: crate::types::ReplicaContainerGroupCounts) -> Self {
        self.replica_container_group_counts = ::std::option::Option::Some(input);
        self
    }
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> The number and status of replica container groups in a container fleet.</p>
    pub fn set_replica_container_group_counts(mut self, input: ::std::option::Option<crate::types::ReplicaContainerGroupCounts>) -> Self {
        self.replica_container_group_counts = input;
        self
    }
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> The number and status of replica container groups in a container fleet.</p>
    pub fn get_replica_container_group_counts(&self) -> &::std::option::Option<crate::types::ReplicaContainerGroupCounts> {
        &self.replica_container_group_counts
    }
    ...
    pub fn build(self) -> crate::types::FleetCapacity {
        crate::types::FleetCapacity {
            ...
            replica_container_group_counts: self.replica_container_group_counts,
        }
    }
}
