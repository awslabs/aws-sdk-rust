...
/// <p>Describes an Amazon GameLift fleet of game hosting resources. Attributes differ based on the fleet's compute type, as follows:</p>
/// <ul>
/// <li>
/// <p>EC2 fleet attributes identify a <code>Build</code> resource (for fleets with customer game server builds) or a <code>Script</code> resource (for Realtime Servers fleets).</p></li>
/// <li>
/// <p>Container fleets have <code>ContainerGroupsAttributes</code>, which identify the fleet's <code>ContainerGroupDefinition</code> resources.</p></li>
/// <li>
...
pub struct FleetAttributes {
    ...
    /// <p>The type of game session protection to set on all new instances that are started in the fleet. This attribute is used with fleets where <code>ComputeType</code> is "EC2" or "Container".</p>
    /// <ul>
    /// <li>
    ...
    /// <p>Name of a metric group that metrics for this fleet are added to. In Amazon CloudWatch, you can view aggregated metrics for fleets that are in a metric group. A fleet can be included in only one metric group at a time. This attribute is used with fleets where <code>ComputeType</code> is "EC2" or "Container".</p>
    pub metric_groups: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    /// <p>A list of fleet activity that has been suspended using <a href="https://docs.aws.amazon.com/gamelift/latest/apireference/API_StopFleetActions.html">StopFleetActions</a>. This includes fleet auto-scaling. This attribute is used with fleets where <code>ComputeType</code> is "EC2" or "Container".</p>
    pub stopped_actions: ::std::option::Option<::std::vec::Vec<crate::types::FleetAction>>,
    /// <p>A unique identifier for an IAM role with access permissions to other Amazon Web Services services. Any application that runs on an instance in the fleet--including install scripts, server processes, and other processes--can use these permissions to interact with Amazon Web Services resources that you own or have access to. For more information about using the role with your game server builds, see <a href="https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-resources.html"> Communicate with other Amazon Web Services resources from your fleets</a>. This attribute is used with fleets where <code>ComputeType</code> is "EC2" or "Container".</p>
    ...
    /// <p><b>This property is used with the Amazon GameLift containers feature, which is currently in public preview.</b> A set of attributes that describe the container groups that are deployed on the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code> only. This attribute is used with fleets where <code>ComputeType</code> is "Container".</p>
    ...
    /// <p>A set of properties that describe the container groups that are deployed to the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code>.</p>
    pub container_groups_attributes: ::std::option::Option<crate::types::ContainerGroupsAttributes>,
}
impl FleetAttributes {
    ...
    /// <p>A set of properties that describe the container groups that are deployed to the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code>.</p>
    pub fn container_groups_attributes(&self) -> ::std::option::Option<&crate::types::ContainerGroupsAttributes> {
        self.container_groups_attributes.as_ref()
    }
}
impl FleetAttributes {
...
pub struct FleetAttributesBuilder {
    ...
    pub(crate) container_groups_attributes: ::std::option::Option<crate::types::ContainerGroupsAttributes>,
}
impl FleetAttributesBuilder {
    ...
    /// <p>A set of properties that describe the container groups that are deployed to the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code>.</p>
    pub fn container_groups_attributes(mut self, input: crate::types::ContainerGroupsAttributes) -> Self {
        self.container_groups_attributes = ::std::option::Option::Some(input);
        self
    }
    /// <p>A set of properties that describe the container groups that are deployed to the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code>.</p>
    pub fn set_container_groups_attributes(mut self, input: ::std::option::Option<crate::types::ContainerGroupsAttributes>) -> Self {
        self.container_groups_attributes = input;
        self
    }
    /// <p>A set of properties that describe the container groups that are deployed to the fleet. These attributes are included for fleets with compute type <code>CONTAINER</code>.</p>
    pub fn get_container_groups_attributes(&self) -> &::std::option::Option<crate::types::ContainerGroupsAttributes> {
        &self.container_groups_attributes
    }
    ...
    pub fn build(self) -> crate::types::FleetAttributes {
        crate::types::FleetAttributes {
            ...
            container_groups_attributes: self.container_groups_attributes,
        }
    }
}
