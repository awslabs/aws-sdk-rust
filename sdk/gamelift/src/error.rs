...
impl aws_smithy_http::result::CreateUnhandledError for ValidateMatchmakingRuleSetError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: ValidateMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(source)),
...
impl std::fmt::Display for ValidateMatchmakingRuleSetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ValidateMatchmakingRuleSetErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ValidateMatchmakingRuleSetErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ValidateMatchmakingRuleSetErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            ValidateMatchmakingRuleSetErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ValidateMatchmakingRuleSetError {
    /// Creates a new `ValidateMatchmakingRuleSetError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ValidateMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ValidateMatchmakingRuleSetErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ValidateMatchmakingRuleSetErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ValidateMatchmakingRuleSetErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, ValidateMatchmakingRuleSetErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for UpdateScriptError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateScriptErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateScriptErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateScriptErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateScriptErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateScriptErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateScriptError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateScriptErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateScriptErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateScriptErrorKind::InvalidRequestException(_))
    }
...
impl aws_smithy_http::result::CreateUnhandledError for UpdateRuntimeConfigurationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: UpdateRuntimeConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for UpdateRuntimeConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateRuntimeConfigurationErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRuntimeConfigurationErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRuntimeConfigurationErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRuntimeConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRuntimeConfigurationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateRuntimeConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateRuntimeConfigurationError {
    /// Creates a new `UpdateRuntimeConfigurationError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateRuntimeConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateRuntimeConfigurationErrorKind::InternalServiceException(_))
    }
    ...
    pub fn is_invalid_fleet_status_exception(&self) -> bool {
        matches!(&self.kind, UpdateRuntimeConfigurationErrorKind::InvalidFleetStatusException(_))
    }
    /// Returns `true` if the error kind is `UpdateRuntimeConfigurationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateRuntimeConfigurationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateRuntimeConfigurationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, UpdateRuntimeConfigurationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateRuntimeConfigurationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, UpdateRuntimeConfigurationErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for UpdateMatchmakingConfigurationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: UpdateMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for UpdateMatchmakingConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UpdateMatchmakingConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateMatchmakingConfigurationErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateMatchmakingConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateMatchmakingConfigurationError {
    /// Creates a new `UpdateMatchmakingConfigurationError`.
                    pub fn new(kind: UpdateMatchmakingConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateMatchmakingConfigurationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateMatchmakingConfigurationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateMatchmakingConfigurationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateMatchmakingConfigurationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, UpdateMatchmakingConfigurationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateMatchmakingConfigurationErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, UpdateMatchmakingConfigurationErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for UpdateGameSessionQueueError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGameSessionQueueErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionQueueErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionQueueErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionQueueErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionQueueErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateGameSessionQueueError {
    /// Creates a new `UpdateGameSessionQueueError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateGameSessionQueueErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionQueueErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameSessionQueueErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionQueueErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameSessionQueueErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionQueueErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameSessionQueueErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionQueueErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for UpdateGameSessionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGameSessionErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::InvalidGameSessionStatusException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameSessionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateGameSessionError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionErrorKind::InternalServiceException(_))
    }
    ...
    pub fn is_invalid_game_session_status_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionErrorKind::InvalidGameSessionStatusException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameSessionErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameSessionErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for UpdateGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerGroupErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateGameServerGroupError {
    /// Creates a new `UpdateGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameServerGroupErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerGroupErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for UpdateGameServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateGameServerErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateGameServerErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateGameServerError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateGameServerErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, UpdateGameServerErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for UpdateFleetPortSettingsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateFleetPortSettingsErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetPortSettingsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateFleetPortSettingsError {
    /// Creates a new `UpdateFleetPortSettingsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateFleetPortSettingsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
...
impl std::fmt::Display for UpdateFleetCapacityError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateFleetCapacityErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetCapacityErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for UpdateFleetAttributesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateFleetAttributesErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateFleetAttributesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateFleetAttributesError {
    /// Creates a new `UpdateFleetAttributesError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: UpdateFleetAttributesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
...
impl std::fmt::Display for UpdateBuildError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateBuildErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBuildErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBuildErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBuildErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateBuildErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UpdateBuildError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateBuildErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for UpdateAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UpdateAliasErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAliasErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAliasErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            UpdateAliasErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl UpdateAliasError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, UpdateAliasErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for UntagResourceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            UntagResourceErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl UntagResourceError {
    ...
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, UntagResourceErrorKind::TaggingFailedException(_))
    }
}
...
impl std::fmt::Display for TagResourceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            TagResourceErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for SuspendGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SuspendGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            SuspendGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            SuspendGameServerGroupErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SuspendGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            SuspendGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SuspendGameServerGroupError {
    /// Creates a new `SuspendGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: SuspendGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, SuspendGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `SuspendGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, SuspendGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SuspendGameServerGroupErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, SuspendGameServerGroupErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `SuspendGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, SuspendGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for StopMatchmakingError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StopMatchmakingErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StopMatchmakingErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StopMatchmakingErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StopMatchmakingErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            StopMatchmakingErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StopMatchmakingError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StopMatchmakingErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StopMatchmakingErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StopMatchmakingErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, StopMatchmakingErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for StopGameSessionPlacementError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: StopGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for StopGameSessionPlacementError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StopGameSessionPlacementErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StopGameSessionPlacementErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StopGameSessionPlacementErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StopGameSessionPlacementErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            StopGameSessionPlacementErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StopGameSessionPlacementError {
    /// Creates a new `StopGameSessionPlacementError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: StopGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StopGameSessionPlacementErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StopGameSessionPlacementErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StopGameSessionPlacementErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `StopGameSessionPlacementErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, StopGameSessionPlacementErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopGameSessionPlacementErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, StopGameSessionPlacementErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for StopFleetActionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StopFleetActionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StopFleetActionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StopFleetActionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StopFleetActionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            StopFleetActionsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            StopFleetActionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StopFleetActionsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StopFleetActionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StopFleetActionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StopFleetActionsErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, StopFleetActionsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `StopFleetActionsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, StopFleetActionsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for StartMatchmakingError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StartMatchmakingErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchmakingErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchmakingErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchmakingErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchmakingErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartMatchmakingError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StartMatchmakingErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartMatchmakingErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StartMatchmakingErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, StartMatchmakingErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for StartMatchBackfillError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StartMatchBackfillErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchBackfillErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchBackfillErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchBackfillErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            StartMatchBackfillErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartMatchBackfillError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StartMatchBackfillErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartMatchBackfillErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StartMatchBackfillErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `StartMatchBackfillErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, StartMatchBackfillErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartMatchBackfillErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, StartMatchBackfillErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for StartGameSessionPlacementError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: StartGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for StartGameSessionPlacementError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StartGameSessionPlacementErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StartGameSessionPlacementErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StartGameSessionPlacementErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StartGameSessionPlacementErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            StartGameSessionPlacementErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartGameSessionPlacementError {
    /// Creates a new `StartGameSessionPlacementError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: StartGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StartGameSessionPlacementErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartGameSessionPlacementErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StartGameSessionPlacementErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `StartGameSessionPlacementErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, StartGameSessionPlacementErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartGameSessionPlacementErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, StartGameSessionPlacementErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for StartFleetActionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            StartFleetActionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            StartFleetActionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            StartFleetActionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            StartFleetActionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            StartFleetActionsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            StartFleetActionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartFleetActionsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, StartFleetActionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartFleetActionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, StartFleetActionsErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, StartFleetActionsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `StartFleetActionsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, StartFleetActionsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for SearchGameSessionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SearchGameSessionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            SearchGameSessionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl SearchGameSessionsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `SearchGameSessionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SearchGameSessionsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::NotFoundException(_))
    }
    ...
    pub fn is_terminal_routing_strategy_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::TerminalRoutingStrategyException(_))
    }
    /// Returns `true` if the error kind is `SearchGameSessionsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `SearchGameSessionsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, SearchGameSessionsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for ResumeGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ResumeGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ResumeGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ResumeGameServerGroupErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ResumeGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ResumeGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ResumeGameServerGroupError {
    /// Creates a new `ResumeGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ResumeGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ResumeGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ResumeGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ResumeGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ResumeGameServerGroupErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, ResumeGameServerGroupErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `ResumeGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, ResumeGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for ResolveAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ResolveAliasErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ResolveAliasErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ResolveAliasErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ResolveAliasErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            ResolveAliasErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ResolveAliasErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ResolveAliasError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ResolveAliasErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ResolveAliasErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ResolveAliasErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_terminal_routing_strategy_exception(&self) -> bool {
        matches!(&self.kind, ResolveAliasErrorKind::TerminalRoutingStrategyException(_))
    }
...
impl aws_smithy_http::result::CreateUnhandledError for RequestUploadCredentialsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: RequestUploadCredentialsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for RequestUploadCredentialsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RequestUploadCredentialsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            RequestUploadCredentialsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            RequestUploadCredentialsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            RequestUploadCredentialsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            RequestUploadCredentialsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RequestUploadCredentialsError {
    /// Creates a new `RequestUploadCredentialsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: RequestUploadCredentialsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, RequestUploadCredentialsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `RequestUploadCredentialsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, RequestUploadCredentialsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RequestUploadCredentialsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, RequestUploadCredentialsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `RequestUploadCredentialsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, RequestUploadCredentialsErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for RegisterGameServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RegisterGameServerErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterGameServerErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterGameServerErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterGameServerErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterGameServerErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterGameServerErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RegisterGameServerError {
    ...
    pub fn is_conflict_exception(&self) -> bool {
        matches!(&self.kind, RegisterGameServerErrorKind::ConflictException(_))
    }
    /// Returns `true` if the error kind is `RegisterGameServerErrorKind::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, RegisterGameServerErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `RegisterGameServerErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, RegisterGameServerErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RegisterGameServerErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, RegisterGameServerErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `RegisterGameServerErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, RegisterGameServerErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for RegisterComputeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            RegisterComputeErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterComputeErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterComputeErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterComputeErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            RegisterComputeErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl RegisterComputeError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, RegisterComputeErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `RegisterComputeErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, RegisterComputeErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RegisterComputeErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, RegisterComputeErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for PutScalingPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            PutScalingPolicyErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            PutScalingPolicyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            PutScalingPolicyErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl PutScalingPolicyError {
    ...
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, PutScalingPolicyErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, PutScalingPolicyErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for ListTagsForResourceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            ListTagsForResourceErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListTagsForResourceError {
    ...
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, ListTagsForResourceErrorKind::TaggingFailedException(_))
    }
}
...
impl std::fmt::Display for ListScriptsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListScriptsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListScriptsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListScriptsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ListScriptsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListScriptsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListScriptsErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for ListLocationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListLocationsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListLocationsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListLocationsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListLocationsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListLocationsErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for ListGameServersError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListGameServersErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServersErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServersErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServersErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListGameServersError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListGameServersErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListGameServersErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ListGameServersErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListGameServersErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, ListGameServersErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for ListGameServerGroupsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListGameServerGroupsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServerGroupsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServerGroupsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ListGameServerGroupsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListGameServerGroupsError {
    /// Creates a new `ListGameServerGroupsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: ListGameServerGroupsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListGameServerGroupsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListGameServerGroupsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ListGameServerGroupsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListGameServerGroupsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, ListGameServerGroupsErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for ListFleetsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListFleetsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListFleetsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListFleetsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for ListComputeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListComputeErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListComputeErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListComputeErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ListComputeErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ListComputeError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListComputeErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for ListBuildsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListBuildsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListBuildsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListBuildsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl std::fmt::Display for ListAliasesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ListAliasesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ListAliasesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ListAliasesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListAliasesError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ListAliasesErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for GetInstanceAccessError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetInstanceAccessErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceAccessErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceAccessErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceAccessErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            GetInstanceAccessErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetInstanceAccessError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, GetInstanceAccessErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetInstanceAccessErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, GetInstanceAccessErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, GetInstanceAccessErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for GetGameSessionLogUrlError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetGameSessionLogUrlErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            GetGameSessionLogUrlErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetGameSessionLogUrlErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetGameSessionLogUrlErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            GetGameSessionLogUrlErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetGameSessionLogUrlError {
    /// Creates a new `GetGameSessionLogUrlError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetGameSessionLogUrlErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, GetGameSessionLogUrlErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetGameSessionLogUrlErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, GetGameSessionLogUrlErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `GetGameSessionLogUrlErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, GetGameSessionLogUrlErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetGameSessionLogUrlErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, GetGameSessionLogUrlErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for GetComputeAuthTokenError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetComputeAuthTokenErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAuthTokenErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAuthTokenErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAuthTokenErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAuthTokenErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetComputeAuthTokenError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAuthTokenErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetComputeAuthTokenErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAuthTokenErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `GetComputeAuthTokenErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAuthTokenErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetComputeAuthTokenErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAuthTokenErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for GetComputeAccessError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetComputeAccessErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAccessErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAccessErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAccessErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            GetComputeAccessErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetComputeAccessError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAccessErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetComputeAccessErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAccessErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, GetComputeAccessErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeVpcPeeringConnectionsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeVpcPeeringConnectionsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeVpcPeeringConnectionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeVpcPeeringConnectionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeVpcPeeringConnectionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeVpcPeeringConnectionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeVpcPeeringConnectionsError {
    /// Creates a new `DescribeVpcPeeringConnectionsError`.
                    pub fn new(kind: DescribeVpcPeeringConnectionsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeVpcPeeringConnectionsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringConnectionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeVpcPeeringConnectionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringConnectionsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeVpcPeeringConnectionsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringConnectionsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeVpcPeeringConnectionsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringConnectionsErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeVpcPeeringAuthorizationsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeVpcPeeringAuthorizationsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeVpcPeeringAuthorizationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeVpcPeeringAuthorizationsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeVpcPeeringAuthorizationsError {
    /// Creates a new `DescribeVpcPeeringAuthorizationsError`.
                    pub fn new(kind: DescribeVpcPeeringAuthorizationsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeVpcPeeringAuthorizationsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringAuthorizationsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeVpcPeeringAuthorizationsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringAuthorizationsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeVpcPeeringAuthorizationsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeVpcPeeringAuthorizationsErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeScriptError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeScriptErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScriptErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScriptErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScriptErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScriptErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeScriptError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeScriptErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeScriptErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeScriptErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeScriptErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeScalingPoliciesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeScalingPoliciesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScalingPoliciesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScalingPoliciesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeScalingPoliciesErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DescribeScalingPoliciesError {
    ...
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeScalingPoliciesErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeScalingPoliciesErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeScalingPoliciesErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeScalingPoliciesErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeScalingPoliciesErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeScalingPoliciesErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeScalingPoliciesErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeRuntimeConfigurationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeRuntimeConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeRuntimeConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeRuntimeConfigurationErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeRuntimeConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeRuntimeConfigurationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeRuntimeConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeRuntimeConfigurationError {
    /// Creates a new `DescribeRuntimeConfigurationError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeRuntimeConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeRuntimeConfigurationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeRuntimeConfigurationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeRuntimeConfigurationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeRuntimeConfigurationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeRuntimeConfigurationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeRuntimeConfigurationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeRuntimeConfigurationErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribePlayerSessionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribePlayerSessionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribePlayerSessionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribePlayerSessionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribePlayerSessionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribePlayerSessionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribePlayerSessionsError {
    /// Creates a new `DescribePlayerSessionsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribePlayerSessionsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribePlayerSessionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribePlayerSessionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribePlayerSessionsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribePlayerSessionsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribePlayerSessionsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribePlayerSessionsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribePlayerSessionsErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeMatchmakingRuleSetsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeMatchmakingRuleSetsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeMatchmakingRuleSetsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeMatchmakingRuleSetsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingRuleSetsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingRuleSetsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingRuleSetsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingRuleSetsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeMatchmakingRuleSetsError {
    /// Creates a new `DescribeMatchmakingRuleSetsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeMatchmakingRuleSetsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingRuleSetsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingRuleSetsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingRuleSetsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingRuleSetsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingRuleSetsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingRuleSetsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingRuleSetsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeMatchmakingConfigurationsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeMatchmakingConfigurationsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeMatchmakingConfigurationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeMatchmakingConfigurationsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeMatchmakingConfigurationsError {
    /// Creates a new `DescribeMatchmakingConfigurationsError`.
                    pub fn new(kind: DescribeMatchmakingConfigurationsErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeMatchmakingConfigurationsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingConfigurationsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingConfigurationsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingConfigurationsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingConfigurationsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingConfigurationsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DescribeMatchmakingError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeMatchmakingErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeMatchmakingErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeMatchmakingError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeMatchmakingErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeMatchmakingErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DescribeInstancesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeInstancesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeInstancesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeInstancesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeInstancesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeInstancesErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DescribeInstancesError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeInstancesErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeInstancesErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeInstancesErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeInstancesErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeInstancesErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeInstancesErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DescribeGameSessionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameSessionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameSessionsError {
    /// Creates a new `DescribeGameSessionsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameSessionsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionsErrorKind::TerminalRoutingStrategyException`.
    pub fn is_terminal_routing_strategy_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::TerminalRoutingStrategyException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeGameSessionQueuesError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeGameSessionQueuesErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeGameSessionQueuesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameSessionQueuesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionQueuesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionQueuesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionQueuesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionQueuesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameSessionQueuesError {
    /// Creates a new `DescribeGameSessionQueuesError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameSessionQueuesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionQueuesErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionQueuesErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionQueuesErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionQueuesErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionQueuesErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionQueuesErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionQueuesErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeGameSessionPlacementError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeGameSessionPlacementError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeGameSessionPlacementErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionPlacementErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionPlacementErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionPlacementErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameSessionPlacementError {
    /// Creates a new `DescribeGameSessionPlacementError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameSessionPlacementErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionPlacementErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionPlacementErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionPlacementErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionPlacementErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionPlacementErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionPlacementErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionPlacementErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeGameSessionDetailsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeGameSessionDetailsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeGameSessionDetailsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameSessionDetailsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameSessionDetailsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameSessionDetailsError {
    /// Creates a new `DescribeGameSessionDetailsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameSessionDetailsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionDetailsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionDetailsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionDetailsErrorKind::TerminalRoutingStrategyException`.
    pub fn is_terminal_routing_strategy_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::TerminalRoutingStrategyException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionDetailsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameSessionDetailsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameSessionDetailsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeGameServerInstancesError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeGameServerInstancesErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeGameServerInstancesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameServerInstancesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerInstancesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerInstancesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerInstancesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerInstancesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameServerInstancesError {
    /// Creates a new `DescribeGameServerInstancesError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameServerInstancesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerInstancesErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerInstancesErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerInstancesErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerInstancesErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerInstancesErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerInstancesErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerInstancesErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerGroupErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameServerGroupError {
    /// Creates a new `DescribeGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerGroupErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerGroupErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeGameServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeGameServerErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeGameServerErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeGameServerError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeGameServerErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeGameServerErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeFleetUtilizationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeFleetUtilizationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeFleetUtilizationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeFleetUtilizationErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetUtilizationErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetUtilizationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetUtilizationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetUtilizationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetUtilizationError {
    /// Creates a new `DescribeFleetUtilizationError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetUtilizationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetUtilizationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetUtilizationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetUtilizationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetUtilizationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetUtilizationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetUtilizationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetUtilizationErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeFleetPortSettingsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeFleetPortSettingsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeFleetPortSettingsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeFleetPortSettingsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetPortSettingsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetPortSettingsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetPortSettingsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetPortSettingsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetPortSettingsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetPortSettingsError {
    /// Creates a new `DescribeFleetPortSettingsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetPortSettingsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetPortSettingsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetPortSettingsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetPortSettingsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetPortSettingsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetPortSettingsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetPortSettingsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetPortSettingsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetPortSettingsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetPortSettingsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeFleetLocationUtilizationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeFleetLocationUtilizationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeFleetLocationUtilizationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeFleetLocationUtilizationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DescribeFleetLocationUtilizationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetLocationUtilizationError {
    /// Creates a new `DescribeFleetLocationUtilizationError`.
                    pub fn new(kind: DescribeFleetLocationUtilizationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetLocationUtilizationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationUtilizationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationUtilizationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationUtilizationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationUtilizationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationUtilizationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationUtilizationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationUtilizationErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationUtilizationErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationUtilizationErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeFleetLocationCapacityError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeFleetLocationCapacityErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeFleetLocationCapacityError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeFleetLocationCapacityErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetLocationCapacityErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetLocationCapacityErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetLocationCapacityErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetLocationCapacityError {
    /// Creates a new `DescribeFleetLocationCapacityError`.
                    pub fn new(kind: DescribeFleetLocationCapacityErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetLocationCapacityErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationCapacityErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationCapacityErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationCapacityErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationCapacityErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationCapacityErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationCapacityErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationCapacityErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationCapacityErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationCapacityErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeFleetLocationAttributesError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeFleetLocationAttributesErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeFleetLocationAttributesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DescribeFleetLocationAttributesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DescribeFleetLocationAttributesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetLocationAttributesError {
    /// Creates a new `DescribeFleetLocationAttributesError`.
                    pub fn new(kind: DescribeFleetLocationAttributesErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetLocationAttributesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationAttributesErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationAttributesErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationAttributesErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationAttributesErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationAttributesErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationAttributesErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationAttributesErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetLocationAttributesErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetLocationAttributesErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DescribeFleetEventsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeFleetEventsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetEventsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetEventsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetEventsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetEventsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetEventsError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetEventsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetEventsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetEventsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetEventsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetEventsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetEventsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetEventsErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeFleetCapacityError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeFleetCapacityErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetCapacityErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetCapacityErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetCapacityErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetCapacityErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetCapacityError {
    /// Creates a new `DescribeFleetCapacityError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetCapacityErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetCapacityErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetCapacityErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetCapacityErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetCapacityErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetCapacityErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetCapacityErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetCapacityErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeFleetAttributesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeFleetAttributesErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetAttributesErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetAttributesErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetAttributesErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeFleetAttributesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeFleetAttributesError {
    /// Creates a new `DescribeFleetAttributesError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeFleetAttributesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetAttributesErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetAttributesErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetAttributesErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetAttributesErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetAttributesErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeFleetAttributesErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeFleetAttributesErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeEC2InstanceLimitsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeEC2InstanceLimitsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeEC2InstanceLimitsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeEC2InstanceLimitsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeEC2InstanceLimitsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeEC2InstanceLimitsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeEC2InstanceLimitsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeEC2InstanceLimitsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeEC2InstanceLimitsError {
    /// Creates a new `DescribeEC2InstanceLimitsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeEC2InstanceLimitsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeEC2InstanceLimitsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeEC2InstanceLimitsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeEC2InstanceLimitsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeEC2InstanceLimitsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeEC2InstanceLimitsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DescribeEC2InstanceLimitsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DescribeEC2InstanceLimitsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DescribeComputeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeComputeErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeComputeErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeComputeErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeComputeErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeComputeErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeComputeError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeComputeErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeComputeErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeComputeErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DescribeComputeErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DescribeBuildError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeBuildErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeBuildErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeBuildErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeBuildErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeBuildErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeBuildError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeBuildErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeBuildErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeBuildErrorKind::InvalidRequestException(_))
    }
...
impl std::fmt::Display for DescribeAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeAliasErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAliasErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAliasErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAliasErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAliasErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeAliasError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DescribeAliasErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeAliasErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeAliasErrorKind::InvalidRequestException(_))
    }
...
impl std::fmt::Display for DeregisterGameServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeregisterGameServerErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterGameServerErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterGameServerErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterGameServerErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterGameServerErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeregisterGameServerError {
    /// Creates a new `DeregisterGameServerError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeregisterGameServerErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeregisterGameServerErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeregisterGameServerErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeregisterGameServerErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeregisterGameServerErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeregisterGameServerErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeregisterGameServerErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeregisterGameServerErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DeregisterComputeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeregisterComputeErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterComputeErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterComputeErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterComputeErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeregisterComputeErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeregisterComputeError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeregisterComputeErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeregisterComputeErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeregisterComputeErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeregisterComputeErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DeleteVpcPeeringConnectionError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DeleteVpcPeeringConnectionErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DeleteVpcPeeringConnectionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteVpcPeeringConnectionErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringConnectionErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringConnectionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringConnectionErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringConnectionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteVpcPeeringConnectionError {
    /// Creates a new `DeleteVpcPeeringConnectionError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteVpcPeeringConnectionErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringConnectionErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringConnectionErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringConnectionErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringConnectionErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringConnectionErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringConnectionErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringConnectionErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DeleteVpcPeeringAuthorizationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DeleteVpcPeeringAuthorizationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DeleteVpcPeeringAuthorizationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeleteVpcPeeringAuthorizationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringAuthorizationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteVpcPeeringAuthorizationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteVpcPeeringAuthorizationError {
    /// Creates a new `DeleteVpcPeeringAuthorizationError`.
                    pub fn new(kind: DeleteVpcPeeringAuthorizationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteVpcPeeringAuthorizationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringAuthorizationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringAuthorizationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringAuthorizationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringAuthorizationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringAuthorizationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteVpcPeeringAuthorizationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteVpcPeeringAuthorizationErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DeleteScriptError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteScriptErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScriptErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScriptErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScriptErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScriptErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScriptErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteScriptError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteScriptErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteScriptErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteScriptErrorKind::InvalidRequestException(_))
    }
...
impl std::fmt::Display for DeleteScalingPolicyError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeleteScalingPolicyErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScalingPolicyErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteScalingPolicyErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteScalingPolicyError {
    ...
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteScalingPolicyErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteScalingPolicyErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteScalingPolicyErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteScalingPolicyErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteScalingPolicyErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DeleteMatchmakingRuleSetError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DeleteMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DeleteMatchmakingRuleSetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteMatchmakingRuleSetErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteMatchmakingRuleSetErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteMatchmakingRuleSetErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteMatchmakingRuleSetErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteMatchmakingRuleSetErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteMatchmakingRuleSetErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteMatchmakingRuleSetError {
    /// Creates a new `DeleteMatchmakingRuleSetError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingRuleSetErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingRuleSetErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingRuleSetErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingRuleSetErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingRuleSetErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingRuleSetErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingRuleSetErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingRuleSetErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingRuleSetErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DeleteMatchmakingConfigurationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DeleteMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DeleteMatchmakingConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DeleteMatchmakingConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            DeleteMatchmakingConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteMatchmakingConfigurationError {
    /// Creates a new `DeleteMatchmakingConfigurationError`.
                    pub fn new(kind: DeleteMatchmakingConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingConfigurationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingConfigurationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingConfigurationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingConfigurationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingConfigurationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingConfigurationErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingConfigurationErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `DeleteMatchmakingConfigurationErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DeleteMatchmakingConfigurationErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DeleteLocationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteLocationErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLocationErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLocationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteLocationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteLocationError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteLocationErrorKind::InternalServiceException(_))
    }
    ...
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteLocationErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DeleteGameSessionQueueError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteGameSessionQueueErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameSessionQueueErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameSessionQueueErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameSessionQueueErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameSessionQueueErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameSessionQueueErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteGameSessionQueueError {
    /// Creates a new `DeleteGameSessionQueueError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteGameSessionQueueErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameSessionQueueErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameSessionQueueErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameSessionQueueErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameSessionQueueErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameSessionQueueErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameSessionQueueErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameSessionQueueErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameSessionQueueErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameSessionQueueErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DeleteGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameServerGroupErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteGameServerGroupError {
    /// Creates a new `DeleteGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameServerGroupErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameServerGroupErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for DeleteFleetLocationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteFleetLocationsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetLocationsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetLocationsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetLocationsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetLocationsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetLocationsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteFleetLocationsError {
    /// Creates a new `DeleteFleetLocationsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DeleteFleetLocationsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetLocationsErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteFleetLocationsErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetLocationsErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteFleetLocationsErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetLocationsErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteFleetLocationsErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetLocationsErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `DeleteFleetLocationsErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetLocationsErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for DeleteFleetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteFleetErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteFleetErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteFleetError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteFleetErrorKind::InvalidFleetStatusException`.
    pub fn is_invalid_fleet_status_exception(&self) -> bool {
        matches!(&self.kind, DeleteFleetErrorKind::InvalidFleetStatusException(_))
    }
...
impl std::fmt::Display for DeleteBuildError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteBuildErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBuildErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBuildErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBuildErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBuildErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteBuildErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DeleteBuildError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteBuildErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for DeleteAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DeleteAliasErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAliasErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAliasErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAliasErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            DeleteAliasErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DeleteAliasError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, DeleteAliasErrorKind::InternalServiceException(_))
    }
...
impl aws_smithy_http::result::CreateUnhandledError for CreateVpcPeeringConnectionError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: CreateVpcPeeringConnectionErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for CreateVpcPeeringConnectionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateVpcPeeringConnectionErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringConnectionErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringConnectionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringConnectionErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringConnectionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateVpcPeeringConnectionError {
    /// Creates a new `CreateVpcPeeringConnectionError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateVpcPeeringConnectionErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringConnectionErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringConnectionErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringConnectionErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringConnectionErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringConnectionErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringConnectionErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringConnectionErrorKind::UnauthorizedException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for CreateVpcPeeringAuthorizationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: CreateVpcPeeringAuthorizationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for CreateVpcPeeringAuthorizationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateVpcPeeringAuthorizationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringAuthorizationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateVpcPeeringAuthorizationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateVpcPeeringAuthorizationError {
    /// Creates a new `CreateVpcPeeringAuthorizationError`.
                    pub fn new(kind: CreateVpcPeeringAuthorizationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateVpcPeeringAuthorizationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringAuthorizationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringAuthorizationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringAuthorizationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringAuthorizationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringAuthorizationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateVpcPeeringAuthorizationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateVpcPeeringAuthorizationErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for CreateScriptError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateScriptErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateScriptErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateScriptErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateScriptErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateScriptErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateScriptErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateScriptError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateScriptErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateScriptErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateScriptErrorKind::InvalidRequestException(_))
    }
...
impl std::fmt::Display for CreatePlayerSessionsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreatePlayerSessionsErrorKind::GameSessionFullException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::InvalidGameSessionStatusException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreatePlayerSessionsError {
    /// Creates a new `CreatePlayerSessionsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreatePlayerSessionsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
...
impl std::fmt::Display for CreatePlayerSessionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreatePlayerSessionErrorKind::GameSessionFullException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::InvalidGameSessionStatusException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreatePlayerSessionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl aws_smithy_http::result::CreateUnhandledError for CreateMatchmakingRuleSetError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: CreateMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for CreateMatchmakingRuleSetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateMatchmakingRuleSetErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateMatchmakingRuleSetErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateMatchmakingRuleSetErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateMatchmakingRuleSetErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateMatchmakingRuleSetErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            CreateMatchmakingRuleSetErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateMatchmakingRuleSetError {
    /// Creates a new `CreateMatchmakingRuleSetError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateMatchmakingRuleSetErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingRuleSetErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingRuleSetErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingRuleSetErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingRuleSetErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingRuleSetErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingRuleSetErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingRuleSetErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingRuleSetErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingRuleSetErrorKind::UnsupportedRegionException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for CreateMatchmakingConfigurationError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: CreateMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for CreateMatchmakingConfigurationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateMatchmakingConfigurationErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            CreateMatchmakingConfigurationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateMatchmakingConfigurationError {
    /// Creates a new `CreateMatchmakingConfigurationError`.
                    pub fn new(kind: CreateMatchmakingConfigurationErrorKind, meta: aws_smithy_types::Error) -> Self {
                        Self { kind, meta }
                    }
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateMatchmakingConfigurationErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingConfigurationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingConfigurationErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingConfigurationErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingConfigurationErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateMatchmakingConfigurationErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, CreateMatchmakingConfigurationErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for CreateLocationError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateLocationErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateLocationErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateLocationError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateLocationErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateLocationErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateLocationErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateLocationErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateLocationErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateLocationErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, CreateLocationErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateLocationErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateLocationErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for CreateGameSessionQueueError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateGameSessionQueueErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionQueueErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateGameSessionQueueError {
    /// Creates a new `CreateGameSessionQueueError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateGameSessionQueueErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionQueueErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionQueueErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionQueueErrorKind::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionQueueErrorKind::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionQueueErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionQueueErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for CreateGameSessionError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateGameSessionErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::FleetCapacityExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::IdempotentParameterMismatchException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::TerminalRoutingStrategyException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameSessionErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateGameSessionError {
    ...
    pub fn is_fleet_capacity_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::FleetCapacityExceededException(_))
    }
    ...
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::InvalidFleetStatusException`.
    pub fn is_invalid_fleet_status_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::InvalidFleetStatusException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::LimitExceededException(_))
    }
    ...
    pub fn is_terminal_routing_strategy_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::TerminalRoutingStrategyException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `CreateGameSessionErrorKind::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, CreateGameSessionErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for CreateGameServerGroupError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateGameServerGroupErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameServerGroupErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameServerGroupErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameServerGroupErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameServerGroupErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateGameServerGroupErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateGameServerGroupError {
    /// Creates a new `CreateGameServerGroupError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateGameServerGroupErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_conflict_exception(&self) -> bool {
        matches!(&self.kind, CreateGameServerGroupErrorKind::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CreateGameServerGroupErrorKind::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateGameServerGroupErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateGameServerGroupErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, CreateGameServerGroupErrorKind::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateGameServerGroupErrorKind::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(&self.kind, CreateGameServerGroupErrorKind::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateGameServerGroupErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, CreateGameServerGroupErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for CreateFleetLocationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateFleetLocationsErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::InvalidFleetStatusException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetLocationsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateFleetLocationsError {
    /// Creates a new `CreateFleetLocationsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: CreateFleetLocationsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
...
impl std::fmt::Display for CreateFleetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            CreateFleetErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            CreateFleetErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateFleetErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateFleetError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateFleetErrorKind::InternalServiceException(_))
    }
    ...
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, CreateFleetErrorKind::UnsupportedRegionException(_))
    }
}
...
impl std::fmt::Display for CreateBuildError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateBuildErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateBuildErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateBuildErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateBuildErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateBuildErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateBuildErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl CreateBuildError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateBuildErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for CreateAliasError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            CreateAliasErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAliasErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAliasErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAliasErrorKind::LimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAliasErrorKind::TaggingFailedException(_inner) =>
            _inner.fmt(f)
            ,
            CreateAliasErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateAliasError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, CreateAliasErrorKind::InternalServiceException(_))
    }
...
impl std::fmt::Display for ClaimGameServerError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ClaimGameServerErrorKind::ConflictException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::OutOfCapacityException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::UnauthorizedException(_inner) =>
            _inner.fmt(f)
            ,
            ClaimGameServerErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl ClaimGameServerError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, ClaimGameServerErrorKind::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ClaimGameServerErrorKind::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(&self.kind, ClaimGameServerErrorKind::InvalidRequestException(_))
    }
    ...
    pub fn is_out_of_capacity_exception(&self) -> bool {
        matches!(&self.kind, ClaimGameServerErrorKind::OutOfCapacityException(_))
    }
    /// Returns `true` if the error kind is `ClaimGameServerErrorKind::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(&self.kind, ClaimGameServerErrorKind::UnauthorizedException(_))
    }
}
...
impl std::fmt::Display for AcceptMatchError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            AcceptMatchErrorKind::InternalServiceException(_inner) =>
            _inner.fmt(f)
            ,
            AcceptMatchErrorKind::InvalidRequestException(_inner) =>
            _inner.fmt(f)
            ,
            AcceptMatchErrorKind::NotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            AcceptMatchErrorKind::UnsupportedRegionException(_inner) =>
            _inner.fmt(f)
            ,
            AcceptMatchErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl AcceptMatchError {
    ...
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(&self.kind, AcceptMatchErrorKind::InternalServiceException(_))
    }
    ...
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(&self.kind, AcceptMatchErrorKind::UnsupportedRegionException(_))
    }
}
