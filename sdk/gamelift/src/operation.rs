...
impl aws_smithy_http::response::ParseStrictResponse for ClaimGameServer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_claim_game_server::de_claim_game_server_http_error(response)
                     } else {
                        crate::protocol_serde::shape_claim_game_server::de_claim_game_server_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGameSession {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_game_session::de_create_game_session_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_game_session::de_create_game_session_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterCompute {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_deregister_compute::de_deregister_compute_http_error(response)
                     } else {
                        crate::protocol_serde::shape_deregister_compute::de_deregister_compute_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCompute {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        ...
                        crate::protocol_serde::shape_describe_compute::de_describe_compute_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFleetEvents {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_fleet_events::de_describe_fleet_events_http_error(response)
                     } else {
...
impl aws_smithy_http::response::ParseStrictResponse for GetComputeAccess {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_compute_access::de_get_compute_access_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_compute_access::de_get_compute_access_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListGameServers {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_game_servers::de_list_game_servers_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_game_servers::de_list_game_servers_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterGameServer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_register_game_server::de_register_game_server_http_error(response)
                     } else {
                        crate::protocol_serde::shape_register_game_server::de_register_game_server_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StartFleetActions {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StopFleetActions {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_stop_fleet_actions::de_stop_fleet_actions_http_error(response)
                     } else {
                        crate::protocol_serde::shape_stop_fleet_actions::de_stop_fleet_actions_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGameServer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_game_server::de_update_game_server_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_game_server::de_update_game_server_http_response(response)
                     }
                }
            }
