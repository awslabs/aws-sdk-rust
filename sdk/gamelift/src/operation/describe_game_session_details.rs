...
impl DescribeGameSessionDetailsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_game_session_details::DescribeGameSessionDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGameSessionDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_game_session_details::de_describe_game_session_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
