...
impl DeleteFleetLocationsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFleetLocations`](crate::operation::delete_fleet_locations::DeleteFleetLocations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_fleet_locations::DeleteFleetLocations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_fleet_locations::DeleteFleetLocationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_fleet_locations::ser_delete_fleet_locations_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_fleet_locations::DeleteFleetLocations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteFleetLocations", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFleetLocations {
                type Output = std::result::Result<crate::operation::delete_fleet_locations::DeleteFleetLocationsOutput, crate::operation::delete_fleet_locations::DeleteFleetLocationsError>;
