...
impl ListComputeInput {
    /// Consumes the builder and constructs an Operation<[`ListCompute`](crate::operation::list_compute::ListCompute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_compute::ListCompute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_compute::ListComputeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compute::ser_list_compute_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_compute::ListCompute::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListCompute", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListCompute {
                type Output = std::result::Result<crate::operation::list_compute::ListComputeOutput, crate::operation::list_compute::ListComputeError>;
