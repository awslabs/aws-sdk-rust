...
impl ListComputeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_compute::ListCompute, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_compute::ser_list_compute_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCompute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_compute::de_list_compute_http_response_with_props(status, headers, body)
        }
    }
}
