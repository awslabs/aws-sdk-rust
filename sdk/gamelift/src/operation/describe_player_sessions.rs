...
impl DescribePlayerSessions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_player_sessions::DescribePlayerSessionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_player_sessions::DescribePlayerSessionsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "DescribePlayerSessions", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.DescribePlayerSessions",
                "rpc.service" = "GameLift",
                "rpc.method" = "DescribePlayerSessions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribePlayerSessions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribePlayerSessionsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribePlayerSessionsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribePlayerSessions")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribePlayerSessions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DescribePlayerSessionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribePlayerSessionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribePlayerSessionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribePlayerSessionsInput>() else {
        ...
        if requested.should_capture("PlayerSessionId") {
            if let ::std::option::Option::Some(value) = input.player_session_id.as_deref() {
                captured.insert("PlayerSessionId", value);
            }
        }
        if requested.should_capture("PlayerSessionStatusFilter") {
            if let ::std::option::Option::Some(value) = input.player_session_status_filter.as_deref() {
                captured.insert("PlayerSessionStatusFilter", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribePlayerSessionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_player_sessions::de_describe_player_sessions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_player_sessions::de_describe_player_sessions_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribePlayerSessionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_player_sessions::DescribePlayerSessionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::describe_player_sessions::DescribePlayerSessionsInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/DescribePlayerSessions").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_player_sessions::ser_describe_player_sessions_input(&input)?,
        );
