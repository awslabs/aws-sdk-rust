...
impl DescribePlayerSessionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribePlayerSessions`](crate::operation::describe_player_sessions::DescribePlayerSessions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_player_sessions::DescribePlayerSessions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_player_sessions::DescribePlayerSessionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_player_sessions::ser_describe_player_sessions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_player_sessions::DescribePlayerSessions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePlayerSessions", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePlayerSessions {
                type Output = std::result::Result<crate::operation::describe_player_sessions::DescribePlayerSessionsOutput, crate::operation::describe_player_sessions::DescribePlayerSessionsError>;
