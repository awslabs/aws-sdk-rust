...
impl DescribeFleetLocationUtilizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fleet_location_utilization::DescribeFleetLocationUtilization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetLocationUtilization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_location_utilization::de_describe_fleet_location_utilization_http_response_with_props(
                status, headers, body,
            )
        }
    }
