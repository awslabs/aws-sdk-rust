...
impl ListGameServersFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_game_servers::ListGameServersOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_game_servers::ListGameServersError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_game_servers::ListGameServersOutput, crate::operation::list_game_servers::ListGameServersError, Self> {
