...
impl ListGameServersPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_game_servers::paginator::ListGameServersPaginatorItems {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_game_servers_output_next_token(resp);
...
impl ListGameServersPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_game_servers_output_game_servers(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
