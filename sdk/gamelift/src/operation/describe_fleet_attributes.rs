...
impl DescribeFleetAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetAttributes`](crate::operation::describe_fleet_attributes::DescribeFleetAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_fleet_attributes::DescribeFleetAttributes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_attributes::DescribeFleetAttributesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_attributes::ser_describe_fleet_attributes_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_attributes::DescribeFleetAttributes::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeFleetAttributes", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFleetAttributes {
                type Output = std::result::Result<crate::operation::describe_fleet_attributes::DescribeFleetAttributesOutput, crate::operation::describe_fleet_attributes::DescribeFleetAttributesError>;
