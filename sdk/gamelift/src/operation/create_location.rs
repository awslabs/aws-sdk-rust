...
impl CreateLocationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_location::CreateLocation,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_location::CreateLocation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_location::de_create_location_http_error(
                status, headers, body,
            )
        } else {
