...
impl CreateLocationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_location::CreateLocation, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_location::ser_create_location_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_location::de_create_location_http_response_with_props(status, headers, body)
        }
    }
}
