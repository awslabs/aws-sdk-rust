...
impl CreateLocationInput {
    /// Consumes the builder and constructs an Operation<[`CreateLocation`](crate::operation::create_location::CreateLocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_location::CreateLocation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_location::CreateLocationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_location::ser_create_location_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_location::CreateLocation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateLocation", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLocation {
                type Output = std::result::Result<crate::operation::create_location::CreateLocationOutput, crate::operation::create_location::CreateLocationError>;
