...
impl DescribeGameServerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_server::ser_describe_game_server_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_game_server::DescribeGameServer::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_game_server::DescribeGameServerError
{
