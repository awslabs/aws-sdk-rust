...
impl DescribeGameServerGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_game_server_group::DescribeGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_game_server_group::DescribeGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_game_server_group::DescribeGameServerGroupOutput, crate::operation::describe_game_server_group::DescribeGameServerGroupError, Self> {
