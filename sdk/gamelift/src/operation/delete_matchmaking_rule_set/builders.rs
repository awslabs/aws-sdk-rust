...
impl DeleteMatchmakingRuleSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetOutput, crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetError, Self> {
