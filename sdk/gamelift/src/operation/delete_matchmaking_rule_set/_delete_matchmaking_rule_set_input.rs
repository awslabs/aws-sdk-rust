...
impl DeleteMatchmakingRuleSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetInput, ::aws_smithy_types::error::operation::BuildError> {
