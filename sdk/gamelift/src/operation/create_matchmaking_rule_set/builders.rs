...
impl CreateMatchmakingRuleSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetOutput, crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetError, Self> {
