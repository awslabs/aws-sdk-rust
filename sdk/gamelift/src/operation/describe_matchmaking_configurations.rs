...
impl DescribeMatchmakingConfigurationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_matchmaking_configurations::DescribeMatchmakingConfigurations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_matchmaking_configurations::DescribeMatchmakingConfigurations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMatchmakingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_matchmaking_configurations::de_describe_matchmaking_configurations_http_response_with_props(
                status, headers, body,
            )
        }
    }
