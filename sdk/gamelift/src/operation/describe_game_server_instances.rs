...
impl DescribeGameServerInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_game_server_instances::DescribeGameServerInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGameServerInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_game_server_instances::de_describe_game_server_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
