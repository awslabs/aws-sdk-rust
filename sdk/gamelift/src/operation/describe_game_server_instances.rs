...
impl DescribeGameServerInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameServerInstances`](crate::operation::describe_game_server_instances::DescribeGameServerInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_game_server_instances::DescribeGameServerInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_server_instances::DescribeGameServerInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_server_instances::ser_describe_game_server_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_server_instances::DescribeGameServerInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeGameServerInstances", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGameServerInstances {
                type Output = std::result::Result<crate::operation::describe_game_server_instances::DescribeGameServerInstancesOutput, crate::operation::describe_game_server_instances::DescribeGameServerInstancesError>;
