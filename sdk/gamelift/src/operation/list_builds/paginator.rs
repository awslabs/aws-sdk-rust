...
impl ListBuildsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Build, ::aws_smithy_http::result::SdkError<crate::operation::list_builds::ListBuildsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_builds_output_builds(page).unwrap_or_default().into_iter())
    }
}
