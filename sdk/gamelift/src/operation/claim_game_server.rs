...
impl ClaimGameServerInput {
    /// Consumes the builder and constructs an Operation<[`ClaimGameServer`](crate::operation::claim_game_server::ClaimGameServer)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::claim_game_server::ClaimGameServer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_claim_game_server::ser_claim_game_server_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::claim_game_server::ClaimGameServer::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ClaimGameServer", "gamelift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClaimGameServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_claim_game_server::de_claim_game_server_http_response_with_props(status, headers, body)
        }
    }
}
