...
impl ClaimGameServerInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::claim_game_server::ClaimGameServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::claim_game_server::ClaimGameServerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_claim_game_server::ser_claim_game_server_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for ClaimGameServer {
                type Output = std::result::Result<crate::operation::claim_game_server::ClaimGameServerOutput, crate::operation::claim_game_server::ClaimGameServerError>;
