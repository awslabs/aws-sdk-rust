...
impl DeleteLocationFluentBuilder  {
    /// Creates a new `DeleteLocation`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_location::DeleteLocationOutput, aws_smithy_http::result::SdkError<crate::operation::delete_location::DeleteLocationError>>
                     {
