...
/// Orchestration and serialization glue logic for `CreateContainerFleet`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateContainerFleet;
impl CreateContainerFleet {
    /// Creates a new `CreateContainerFleet`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_container_fleet::CreateContainerFleetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_container_fleet::CreateContainerFleetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "CreateContainerFleet", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.CreateContainerFleet",
                "rpc.service" = "GameLift",
                "rpc.method" = "CreateContainerFleet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateContainerFleet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateContainerFleet");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateContainerFleetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateContainerFleetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateContainerFleet")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateContainerFleet")
            ...
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateContainerFleetEndpointParamsInterceptor,
            ))
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateContainerFleetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_container_fleet::de_create_container_fleet_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_container_fleet::de_create_container_fleet_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateContainerFleetRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateContainerFleetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_container_fleet::CreateContainerFleetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_container_fleet::CreateContainerFleetInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/CreateContainerFleet").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_container_fleet::ser_create_container_fleet_input(
            &input,
        )?);
...
#[derive(Debug)]
struct CreateContainerFleetEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateContainerFleetEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateContainerFleetEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateContainerFleetInput>()
            .ok_or("failed to downcast to CreateContainerFleetInput")?;
...
/// Error type for the `CreateContainerFleetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateContainerFleetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateContainerFleetError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateContainerFleetError {
    /// Creates the `CreateContainerFleetError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `CreateContainerFleetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateContainerFleetError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::TaggingFailedException`.
    pub fn is_tagging_failed_exception(&self) -> bool {
        matches!(self, Self::TaggingFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(self, Self::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `CreateContainerFleetError::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(self, Self::UnsupportedRegionException(_))
    }
}
impl ::std::error::Error for CreateContainerFleetError {
...
impl ::std::fmt::Display for CreateContainerFleetError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateContainerFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateContainerFleetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateContainerFleetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_container_fleet::CreateContainerFleetError {
...
mod _create_container_fleet_output;
