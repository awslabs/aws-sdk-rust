...
impl DeleteGameSessionQueueInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGameSessionQueue`](crate::operation::delete_game_session_queue::DeleteGameSessionQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_game_session_queue::DeleteGameSessionQueue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_game_session_queue::DeleteGameSessionQueueInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_game_session_queue::ser_delete_game_session_queue_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_game_session_queue::DeleteGameSessionQueue::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGameSessionQueue", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGameSessionQueue {
                type Output = std::result::Result<crate::operation::delete_game_session_queue::DeleteGameSessionQueueOutput, crate::operation::delete_game_session_queue::DeleteGameSessionQueueError>;
