...
impl UpdateGameSessionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_game_session::ser_update_game_session_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGameSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_game_session::de_update_game_session_http_response_with_props(status, headers, body)
        }
    }
}
