...
impl UpdateGameSessionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGameSession`](crate::operation::update_game_session::UpdateGameSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_game_session::UpdateGameSession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_game_session::UpdateGameSessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_game_session::ser_update_game_session_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_game_session::UpdateGameSession::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGameSession", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGameSession {
                type Output = std::result::Result<crate::operation::update_game_session::UpdateGameSessionOutput, crate::operation::update_game_session::UpdateGameSessionError>;
