...
impl DeleteScriptInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScript`](crate::operation::delete_script::DeleteScript)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_script::DeleteScript, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_script::DeleteScriptInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_script::ser_delete_script_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_script::DeleteScript::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteScript", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteScript {
                type Output = std::result::Result<crate::operation::delete_script::DeleteScriptOutput, crate::operation::delete_script::DeleteScriptError>;
