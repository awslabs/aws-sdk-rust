...
impl GetInstanceAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_instance_access::GetInstanceAccess,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_instance_access::ser_get_instance_access_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstanceAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_instance_access::de_get_instance_access_http_response_with_props(status, headers, body)
        }
    }
