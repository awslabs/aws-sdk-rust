...
impl DescribeFleetUtilizationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetUtilization`](crate::operation::describe_fleet_utilization::DescribeFleetUtilization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_fleet_utilization::DescribeFleetUtilization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_utilization::DescribeFleetUtilizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_utilization::ser_describe_fleet_utilization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_utilization::DescribeFleetUtilization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeFleetUtilization", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFleetUtilization {
                type Output = std::result::Result<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationOutput, crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError>;
