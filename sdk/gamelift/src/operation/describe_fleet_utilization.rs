...
/// Orchestration and serialization glue logic for `DescribeFleetUtilization`.
...
impl DescribeFleetUtilization {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFleetUtilization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFleetUtilization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFleetUtilizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFleetUtilizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFleetUtilization")
...
.with_interceptor(DescribeFleetUtilizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError>::new());
...
#[derive(Debug)]
            struct DescribeFleetUtilizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFleetUtilizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_fleet_utilization::de_describe_fleet_utilization_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeFleetUtilizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFleetUtilizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_fleet_utilization::DescribeFleetUtilizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_fleet_utilization::DescribeFleetUtilizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_fleet_utilization::ser_describe_fleet_utilization_input(&input)?);
...
#[derive(Debug)]
            struct DescribeFleetUtilizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFleetUtilizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFleetUtilizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFleetUtilizationInput>()
                        .ok_or("failed to downcast to DescribeFleetUtilizationInput")?;
...
pub enum DescribeFleetUtilizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFleetUtilizationError) for what information is available for the error.")]
...
impl DescribeFleetUtilizationError {
    /// Creates the `DescribeFleetUtilizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFleetUtilizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFleetUtilizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_fleet_utilization::DescribeFleetUtilizationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_fleet_utilization::_describe_fleet_utilization_output::DescribeFleetUtilizationOutput;

pub use crate::operation::describe_fleet_utilization::_describe_fleet_utilization_input::DescribeFleetUtilizationInput;

mod _describe_fleet_utilization_input;

mod _describe_fleet_utilization_output;
