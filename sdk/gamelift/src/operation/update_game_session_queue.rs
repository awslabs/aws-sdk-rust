...
impl UpdateGameSessionQueueInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGameSessionQueue`](crate::operation::update_game_session_queue::UpdateGameSessionQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_game_session_queue::UpdateGameSessionQueue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_game_session_queue::UpdateGameSessionQueueInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_game_session_queue::ser_update_game_session_queue_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_game_session_queue::UpdateGameSessionQueue::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateGameSessionQueue", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGameSessionQueue {
                type Output = std::result::Result<crate::operation::update_game_session_queue::UpdateGameSessionQueueOutput, crate::operation::update_game_session_queue::UpdateGameSessionQueueError>;
