...
/// Orchestration and serialization glue logic for `UpdateGameSessionQueue`.
...
impl UpdateGameSessionQueue {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_game_session_queue::UpdateGameSessionQueueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_game_session_queue::UpdateGameSessionQueueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_game_session_queue::UpdateGameSessionQueueError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_game_session_queue::UpdateGameSessionQueueOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateGameSessionQueue {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateGameSessionQueue");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateGameSessionQueueRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateGameSessionQueueResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateGameSessionQueue")
...
.with_interceptor(UpdateGameSessionQueueEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_game_session_queue::UpdateGameSessionQueueError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_game_session_queue::UpdateGameSessionQueueError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_game_session_queue::UpdateGameSessionQueueError>::new());
...
#[derive(Debug)]
            struct UpdateGameSessionQueueResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateGameSessionQueueResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_game_session_queue::de_update_game_session_queue_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_game_session_queue::de_update_game_session_queue_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateGameSessionQueueRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateGameSessionQueueRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_game_session_queue::UpdateGameSessionQueueInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_game_session_queue::UpdateGameSessionQueueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_game_session_queue::ser_update_game_session_queue_input(&input)?);
...
#[derive(Debug)]
            struct UpdateGameSessionQueueEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateGameSessionQueueEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateGameSessionQueueEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateGameSessionQueueInput>()
                        .ok_or("failed to downcast to UpdateGameSessionQueueInput")?;
...
pub enum UpdateGameSessionQueueError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateGameSessionQueueError) for what information is available for the error.")]
...
impl UpdateGameSessionQueueError {
    /// Creates the `UpdateGameSessionQueueError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateGameSessionQueueError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateGameSessionQueueError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_game_session_queue::UpdateGameSessionQueueError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_game_session_queue::_update_game_session_queue_output::UpdateGameSessionQueueOutput;

pub use crate::operation::update_game_session_queue::_update_game_session_queue_input::UpdateGameSessionQueueInput;

mod _update_game_session_queue_input;

mod _update_game_session_queue_output;
