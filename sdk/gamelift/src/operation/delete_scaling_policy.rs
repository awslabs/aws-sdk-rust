...
impl DeleteScalingPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScalingPolicy`](crate::operation::delete_scaling_policy::DeleteScalingPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_scaling_policy::DeleteScalingPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_scaling_policy::DeleteScalingPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_scaling_policy::ser_delete_scaling_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_scaling_policy::DeleteScalingPolicy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteScalingPolicy", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteScalingPolicy {
                type Output = std::result::Result<crate::operation::delete_scaling_policy::DeleteScalingPolicyOutput, crate::operation::delete_scaling_policy::DeleteScalingPolicyError>;
