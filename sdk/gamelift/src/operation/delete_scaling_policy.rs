...
impl DeleteScalingPolicyInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_scaling_policy::ser_delete_scaling_policy_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_scaling_policy::DeleteScalingPolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_scaling_policy::DeleteScalingPolicyError
{
