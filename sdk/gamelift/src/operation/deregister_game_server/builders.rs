...
impl DeregisterGameServerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deregister_game_server::DeregisterGameServerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deregister_game_server::DeregisterGameServerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deregister_game_server::DeregisterGameServerOutput, crate::operation::deregister_game_server::DeregisterGameServerError, Self> {
