...
impl AcceptMatchInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_match::AcceptMatch::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptMatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_accept_match::de_accept_match_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_accept_match::de_accept_match_http_response_with_props(
                status, headers, body,
            )
        }
    }
