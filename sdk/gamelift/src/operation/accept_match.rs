...
impl AcceptMatchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::accept_match::AcceptMatch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_accept_match::ser_accept_match_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptMatch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_match::de_accept_match_http_response_with_props(status, headers, body)
        }
    }
}
