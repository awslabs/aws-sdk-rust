...
impl AcceptMatchInput {
    /// Consumes the builder and constructs an Operation<[`AcceptMatch`](crate::operation::accept_match::AcceptMatch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::accept_match::AcceptMatch, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_match::AcceptMatchInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_accept_match::ser_accept_match_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::accept_match::AcceptMatch::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AcceptMatch", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptMatch {
                type Output = std::result::Result<crate::operation::accept_match::AcceptMatchOutput, crate::operation::accept_match::AcceptMatchError>;
