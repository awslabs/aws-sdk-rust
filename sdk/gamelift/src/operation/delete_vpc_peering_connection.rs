...
impl DeleteVpcPeeringConnectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVpcPeeringConnection`](crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vpc_peering_connection::ser_delete_vpc_peering_connection_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnection::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteVpcPeeringConnection", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVpcPeeringConnection {
                type Output = std::result::Result<crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionOutput, crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnectionError>;
