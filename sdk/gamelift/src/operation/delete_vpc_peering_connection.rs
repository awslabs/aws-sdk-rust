...
impl DeleteVpcPeeringConnectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vpc_peering_connection::DeleteVpcPeeringConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcPeeringConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_peering_connection::de_delete_vpc_peering_connection_http_response_with_props(
                status, headers, body,
            )
        }
    }
