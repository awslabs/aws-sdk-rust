...
impl CreateVpcPeeringAuthorizationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorization,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcPeeringAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vpc_peering_authorization::de_create_vpc_peering_authorization_http_response_with_props(
                status, headers, body,
            )
        }
    }
