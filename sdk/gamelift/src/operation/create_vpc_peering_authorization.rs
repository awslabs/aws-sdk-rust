...
/// Orchestration and serialization glue logic for `CreateVpcPeeringAuthorization`.
...
impl CreateVpcPeeringAuthorization {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationInput,
                    ) -> ::std::result::Result<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateVpcPeeringAuthorization {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateVpcPeeringAuthorization");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateVpcPeeringAuthorizationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateVpcPeeringAuthorizationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateVpcPeeringAuthorization")
...
.with_interceptor(CreateVpcPeeringAuthorizationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError>::new());
...
#[derive(Debug)]
            struct CreateVpcPeeringAuthorizationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateVpcPeeringAuthorizationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_vpc_peering_authorization::de_create_vpc_peering_authorization_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_vpc_peering_authorization::de_create_vpc_peering_authorization_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateVpcPeeringAuthorizationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateVpcPeeringAuthorizationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_vpc_peering_authorization::ser_create_vpc_peering_authorization_input(&input)?);
...
#[derive(Debug)]
            struct CreateVpcPeeringAuthorizationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateVpcPeeringAuthorizationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateVpcPeeringAuthorizationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateVpcPeeringAuthorizationInput>()
                        .ok_or("failed to downcast to CreateVpcPeeringAuthorizationInput")?;
...
pub enum CreateVpcPeeringAuthorizationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateVpcPeeringAuthorizationError) for what information is available for the error.")]
...
impl CreateVpcPeeringAuthorizationError {
    /// Creates the `CreateVpcPeeringAuthorizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVpcPeeringAuthorizationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateVpcPeeringAuthorizationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateVpcPeeringAuthorizationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_vpc_peering_authorization::_create_vpc_peering_authorization_output::CreateVpcPeeringAuthorizationOutput;

pub use crate::operation::create_vpc_peering_authorization::_create_vpc_peering_authorization_input::CreateVpcPeeringAuthorizationInput;

mod _create_vpc_peering_authorization_input;

mod _create_vpc_peering_authorization_output;
