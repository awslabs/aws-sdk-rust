...
impl CreateVpcPeeringAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpcPeeringAuthorization`](crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorization, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpc_peering_authorization::ser_create_vpc_peering_authorization_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorization::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateVpcPeeringAuthorization", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVpcPeeringAuthorization {
                type Output = std::result::Result<crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationOutput, crate::operation::create_vpc_peering_authorization::CreateVpcPeeringAuthorizationError>;
