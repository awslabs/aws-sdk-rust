...
impl CreateGameServerGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateGameServerGroup`](crate::operation::create_game_server_group::CreateGameServerGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_game_server_group::CreateGameServerGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_game_server_group::CreateGameServerGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_game_server_group::ser_create_game_server_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_game_server_group::CreateGameServerGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateGameServerGroup", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGameServerGroup {
                type Output = std::result::Result<crate::operation::create_game_server_group::CreateGameServerGroupOutput, crate::operation::create_game_server_group::CreateGameServerGroupError>;
