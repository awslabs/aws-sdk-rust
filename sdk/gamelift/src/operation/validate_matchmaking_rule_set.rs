...
impl ValidateMatchmakingRuleSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSet,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateMatchmakingRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
