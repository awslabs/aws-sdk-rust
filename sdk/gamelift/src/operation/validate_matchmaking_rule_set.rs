...
impl ValidateMatchmakingRuleSet {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidateMatchmakingRuleSet {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ValidateMatchmakingRuleSet");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ValidateMatchmakingRuleSetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ValidateMatchmakingRuleSetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidateMatchmakingRuleSet")
...
.with_interceptor(ValidateMatchmakingRuleSetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>::new());
...
#[derive(Debug)]
            struct ValidateMatchmakingRuleSetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidateMatchmakingRuleSetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ValidateMatchmakingRuleSetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidateMatchmakingRuleSetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_validate_matchmaking_rule_set::ser_validate_matchmaking_rule_set_input(&input)?);
...
#[derive(Debug)]
            struct ValidateMatchmakingRuleSetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidateMatchmakingRuleSetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ValidateMatchmakingRuleSetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ValidateMatchmakingRuleSetInput>()
                        .ok_or("failed to downcast to ValidateMatchmakingRuleSetInput")?;
...
pub enum ValidateMatchmakingRuleSetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ValidateMatchmakingRuleSetError) for what information is available for the error.")]
...
impl ValidateMatchmakingRuleSetError {
    /// Creates the `ValidateMatchmakingRuleSetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ValidateMatchmakingRuleSetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ValidateMatchmakingRuleSetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError {
...
mod _validate_matchmaking_rule_set_output;
