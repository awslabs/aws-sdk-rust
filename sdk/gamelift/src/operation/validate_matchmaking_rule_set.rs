...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateMatchmakingRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError
{
