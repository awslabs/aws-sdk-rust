...
impl ValidateMatchmakingRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`ValidateMatchmakingRuleSet`](crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_validate_matchmaking_rule_set::ser_validate_matchmaking_rule_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ValidateMatchmakingRuleSet", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ValidateMatchmakingRuleSet {
                type Output = std::result::Result<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetOutput, crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>;
