...
impl ValidateMatchmakingRuleSet {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ValidateMatchmakingRuleSet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidateMatchmakingRuleSet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ValidateMatchmakingRuleSetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ValidateMatchmakingRuleSetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ValidateMatchmakingRuleSet")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidateMatchmakingRuleSet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ValidateMatchmakingRuleSetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ValidateMatchmakingRuleSetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidateMatchmakingRuleSetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ValidateMatchmakingRuleSetInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("RuleSetBody") {
            if let ::std::option::Option::Some(value) = input.rule_set_body.as_deref() {
                captured.insert("RuleSetBody", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidateMatchmakingRuleSetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_validate_matchmaking_rule_set::de_validate_matchmaking_rule_set_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidateMatchmakingRuleSetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/ValidateMatchmakingRuleSet").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_validate_matchmaking_rule_set::ser_validate_matchmaking_rule_set_input(&input)?,
        );
