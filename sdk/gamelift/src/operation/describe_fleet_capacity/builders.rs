...
impl DescribeFleetCapacityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_fleet_capacity::DescribeFleetCapacityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_fleet_capacity::DescribeFleetCapacityOutput, crate::operation::describe_fleet_capacity::DescribeFleetCapacityError, Self> {
