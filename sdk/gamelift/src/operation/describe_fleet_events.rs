...
impl DescribeFleetEventsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_events::ser_describe_fleet_events_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fleet_events::DescribeFleetEvents::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_fleet_events::DescribeFleetEventsError
{
