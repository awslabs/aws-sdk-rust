...
impl DescribeMatchmakingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_matchmaking::ser_describe_matchmaking_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMatchmaking {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_matchmaking::de_describe_matchmaking_http_response_with_props(status, headers, body)
        }
    }
}
