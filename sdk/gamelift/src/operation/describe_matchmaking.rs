...
impl DescribeMatchmakingInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMatchmaking`](crate::operation::describe_matchmaking::DescribeMatchmaking)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_matchmaking::DescribeMatchmaking, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_matchmaking::DescribeMatchmakingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_matchmaking::ser_describe_matchmaking_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_matchmaking::DescribeMatchmaking::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeMatchmaking", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeMatchmaking {
                type Output = std::result::Result<crate::operation::describe_matchmaking::DescribeMatchmakingOutput, crate::operation::describe_matchmaking::DescribeMatchmakingError>;
