...
/// Orchestration and serialization glue logic for `DescribeMatchmaking`.
...
impl DescribeMatchmaking {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_matchmaking::DescribeMatchmakingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_matchmaking::DescribeMatchmakingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_matchmaking::DescribeMatchmakingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_matchmaking::DescribeMatchmakingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeMatchmaking {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeMatchmaking");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeMatchmakingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeMatchmakingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeMatchmaking")
...
.with_interceptor(DescribeMatchmakingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_matchmaking::DescribeMatchmakingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_matchmaking::DescribeMatchmakingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_matchmaking::DescribeMatchmakingError>::new());
...
#[derive(Debug)]
            struct DescribeMatchmakingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeMatchmakingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_matchmaking::de_describe_matchmaking_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_matchmaking::de_describe_matchmaking_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeMatchmakingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeMatchmakingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_matchmaking::DescribeMatchmakingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_matchmaking::DescribeMatchmakingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_matchmaking::ser_describe_matchmaking_input(&input)?);
...
#[derive(Debug)]
            struct DescribeMatchmakingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeMatchmakingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeMatchmakingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeMatchmakingInput>()
                        .ok_or("failed to downcast to DescribeMatchmakingInput")?;
...
pub enum DescribeMatchmakingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeMatchmakingError) for what information is available for the error.")]
...
impl DescribeMatchmakingError {
    /// Creates the `DescribeMatchmakingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeMatchmakingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeMatchmakingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_matchmaking::DescribeMatchmakingError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_matchmaking::_describe_matchmaking_output::DescribeMatchmakingOutput;

pub use crate::operation::describe_matchmaking::_describe_matchmaking_input::DescribeMatchmakingInput;

mod _describe_matchmaking_input;

mod _describe_matchmaking_output;
