...
/// Orchestration and serialization glue logic for `SuspendGameServerGroup`.
...
impl SuspendGameServerGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::suspend_game_server_group::SuspendGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::suspend_game_server_group::SuspendGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::suspend_game_server_group::SuspendGameServerGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::suspend_game_server_group::SuspendGameServerGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SuspendGameServerGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SuspendGameServerGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SuspendGameServerGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SuspendGameServerGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SuspendGameServerGroup")
...
.with_interceptor(SuspendGameServerGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::suspend_game_server_group::SuspendGameServerGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::suspend_game_server_group::SuspendGameServerGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::suspend_game_server_group::SuspendGameServerGroupError>::new());
...
#[derive(Debug)]
            struct SuspendGameServerGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SuspendGameServerGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_suspend_game_server_group::de_suspend_game_server_group_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SuspendGameServerGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SuspendGameServerGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::suspend_game_server_group::SuspendGameServerGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::suspend_game_server_group::SuspendGameServerGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_suspend_game_server_group::ser_suspend_game_server_group_input(&input)?);
...
#[derive(Debug)]
            struct SuspendGameServerGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SuspendGameServerGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SuspendGameServerGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SuspendGameServerGroupInput>()
                        .ok_or("failed to downcast to SuspendGameServerGroupInput")?;
...
pub enum SuspendGameServerGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SuspendGameServerGroupError) for what information is available for the error.")]
...
impl SuspendGameServerGroupError {
    /// Creates the `SuspendGameServerGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SuspendGameServerGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SuspendGameServerGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::suspend_game_server_group::SuspendGameServerGroupError {
...
mod _suspend_game_server_group_output;
