...
impl SuspendGameServerGroupInput {
    /// Consumes the builder and constructs an Operation<[`SuspendGameServerGroup`](crate::operation::suspend_game_server_group::SuspendGameServerGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::suspend_game_server_group::SuspendGameServerGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::suspend_game_server_group::SuspendGameServerGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_suspend_game_server_group::ser_suspend_game_server_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::suspend_game_server_group::SuspendGameServerGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SuspendGameServerGroup", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for SuspendGameServerGroup {
                type Output = std::result::Result<crate::operation::suspend_game_server_group::SuspendGameServerGroupOutput, crate::operation::suspend_game_server_group::SuspendGameServerGroupError>;
