...
impl crate::operation::update_fleet_attributes::builders::UpdateFleetAttributesInputBuilder {
...
/// <p>To update fleet attributes, specify the fleet ID and the property values that you want to change. If successful, Amazon GameLift Servers returns the identifiers for the updated fleet.</p><note>
...
impl UpdateFleetAttributesFluentBuilder {
    /// Creates a new `UpdateFleetAttributesFluentBuilder`.
