...
/// Orchestration and serialization glue logic for `GetGameSessionLogUrl`.
...
impl GetGameSessionLogUrl {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_game_session_log_url::GetGameSessionLogUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_game_session_log_url::GetGameSessionLogUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetGameSessionLogUrl {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetGameSessionLogUrl");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetGameSessionLogUrlRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetGameSessionLogUrlResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetGameSessionLogUrl")
...
.with_interceptor(GetGameSessionLogUrlEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlError>::new());
...
#[derive(Debug)]
            struct GetGameSessionLogUrlResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetGameSessionLogUrlResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_game_session_log_url::de_get_game_session_log_url_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetGameSessionLogUrlRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetGameSessionLogUrlRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_game_session_log_url::GetGameSessionLogUrlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_game_session_log_url::GetGameSessionLogUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_game_session_log_url::ser_get_game_session_log_url_input(&input)?);
...
#[derive(Debug)]
            struct GetGameSessionLogUrlEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetGameSessionLogUrlEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetGameSessionLogUrlEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetGameSessionLogUrlInput>()
                        .ok_or("failed to downcast to GetGameSessionLogUrlInput")?;
...
pub enum GetGameSessionLogUrlError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetGameSessionLogUrlError) for what information is available for the error.")]
...
impl GetGameSessionLogUrlError {
    /// Creates the `GetGameSessionLogUrlError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetGameSessionLogUrlError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetGameSessionLogUrlError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_game_session_log_url::GetGameSessionLogUrlError {
...
mod _get_game_session_log_url_output;
