...
impl GetGameSessionLogUrlInput {
    /// Consumes the builder and constructs an Operation<[`GetGameSessionLogUrl`](crate::operation::get_game_session_log_url::GetGameSessionLogUrl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_game_session_log_url::GetGameSessionLogUrl, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_game_session_log_url::GetGameSessionLogUrlInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_game_session_log_url::ser_get_game_session_log_url_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_game_session_log_url::GetGameSessionLogUrl::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetGameSessionLogUrl", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetGameSessionLogUrl {
                type Output = std::result::Result<crate::operation::get_game_session_log_url::GetGameSessionLogUrlOutput, crate::operation::get_game_session_log_url::GetGameSessionLogUrlError>;
