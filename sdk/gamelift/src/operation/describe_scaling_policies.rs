...
impl DescribeScalingPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScalingPolicies`](crate::operation::describe_scaling_policies::DescribeScalingPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_scaling_policies::DescribeScalingPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_scaling_policies::DescribeScalingPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_policies::DescribeScalingPolicies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeScalingPolicies", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeScalingPolicies {
                type Output = std::result::Result<crate::operation::describe_scaling_policies::DescribeScalingPoliciesOutput, crate::operation::describe_scaling_policies::DescribeScalingPoliciesError>;
