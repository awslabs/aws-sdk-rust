...
/// Orchestration and serialization glue logic for `DescribeScalingPolicies`.
...
impl DescribeScalingPolicies {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_scaling_policies::DescribeScalingPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_scaling_policies::DescribeScalingPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeScalingPolicies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeScalingPolicies");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeScalingPoliciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeScalingPoliciesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeScalingPolicies")
...
.with_interceptor(DescribeScalingPoliciesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesError>::new());
...
#[derive(Debug)]
            struct DescribeScalingPoliciesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeScalingPoliciesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_scaling_policies::de_describe_scaling_policies_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_scaling_policies::de_describe_scaling_policies_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeScalingPoliciesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeScalingPoliciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_scaling_policies::DescribeScalingPoliciesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_scaling_policies::DescribeScalingPoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_scaling_policies::ser_describe_scaling_policies_input(&input)?);
...
#[derive(Debug)]
            struct DescribeScalingPoliciesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeScalingPoliciesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeScalingPoliciesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeScalingPoliciesInput>()
                        .ok_or("failed to downcast to DescribeScalingPoliciesInput")?;
...
pub enum DescribeScalingPoliciesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeScalingPoliciesError) for what information is available for the error.")]
...
impl DescribeScalingPoliciesError {
    /// Creates the `DescribeScalingPoliciesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeScalingPoliciesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeScalingPoliciesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_scaling_policies::DescribeScalingPoliciesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_scaling_policies::_describe_scaling_policies_output::DescribeScalingPoliciesOutput;

pub use crate::operation::describe_scaling_policies::_describe_scaling_policies_input::DescribeScalingPoliciesInput;

mod _describe_scaling_policies_input;

mod _describe_scaling_policies_output;
