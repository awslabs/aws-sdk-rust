...
impl CreateVpcPeeringConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_vpc_peering_connection::CreateVpcPeeringConnectionInput, ::aws_smithy_types::error::operation::BuildError> {
