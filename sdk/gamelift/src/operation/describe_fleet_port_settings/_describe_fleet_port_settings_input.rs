...
impl DescribeFleetPortSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fleet_port_settings::DescribeFleetPortSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
