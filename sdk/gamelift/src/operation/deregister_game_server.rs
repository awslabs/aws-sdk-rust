...
impl DeregisterGameServerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_game_server::ser_deregister_game_server_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_game_server::DeregisterGameServer::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_game_server::DeregisterGameServerError
{
