...
impl DeregisterGameServerInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterGameServer`](crate::operation::deregister_game_server::DeregisterGameServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_game_server::DeregisterGameServer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_game_server::DeregisterGameServerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_game_server::ser_deregister_game_server_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_game_server::DeregisterGameServer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterGameServer", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterGameServer {
                type Output = std::result::Result<crate::operation::deregister_game_server::DeregisterGameServerOutput, crate::operation::deregister_game_server::DeregisterGameServerError>;
