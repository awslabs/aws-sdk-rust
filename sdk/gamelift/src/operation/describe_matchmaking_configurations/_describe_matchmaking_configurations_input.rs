...
impl DescribeMatchmakingConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_matchmaking_configurations::DescribeMatchmakingConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
