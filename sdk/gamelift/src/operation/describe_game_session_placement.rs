...
impl DescribeGameSessionPlacementInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameSessionPlacement`](crate::operation::describe_game_session_placement::DescribeGameSessionPlacement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_game_session_placement::DescribeGameSessionPlacement, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_session_placement::DescribeGameSessionPlacementInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_session_placement::ser_describe_game_session_placement_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_session_placement::DescribeGameSessionPlacement::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeGameSessionPlacement", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGameSessionPlacement {
                type Output = std::result::Result<crate::operation::describe_game_session_placement::DescribeGameSessionPlacementOutput, crate::operation::describe_game_session_placement::DescribeGameSessionPlacementError>;
