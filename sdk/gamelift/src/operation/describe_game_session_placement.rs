...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGameSessionPlacementResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_game_session_placement::de_describe_game_session_placement_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_game_session_placement::de_describe_game_session_placement_http_response(
