...
impl DescribeGameSessionPlacementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_game_session_placement::DescribeGameSessionPlacement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGameSessionPlacement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_game_session_placement::de_describe_game_session_placement_http_response_with_props(
                status, headers, body,
            )
        }
    }
