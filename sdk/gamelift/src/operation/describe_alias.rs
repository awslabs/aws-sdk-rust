...
impl DescribeAliasInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_alias::DescribeAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_alias::de_describe_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_alias::de_describe_alias_http_response_with_props(
                status, headers, body,
            )
        }
    }
