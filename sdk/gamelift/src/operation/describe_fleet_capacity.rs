...
impl DescribeFleetCapacityInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetCapacity`](crate::operation::describe_fleet_capacity::DescribeFleetCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_fleet_capacity::DescribeFleetCapacity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_capacity::DescribeFleetCapacityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_capacity::ser_describe_fleet_capacity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_capacity::DescribeFleetCapacity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeFleetCapacity", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFleetCapacity {
                type Output = std::result::Result<crate::operation::describe_fleet_capacity::DescribeFleetCapacityOutput, crate::operation::describe_fleet_capacity::DescribeFleetCapacityError>;
