...
impl DescribeFleetCapacity {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_fleet_capacity::DescribeFleetCapacityInput,
                    ) -> ::std::result::Result<crate::operation::describe_fleet_capacity::DescribeFleetCapacityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeFleetCapacity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeFleetCapacity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeFleetCapacityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeFleetCapacityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeFleetCapacity")
...
.with_interceptor(DescribeFleetCapacityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityError>::new());
...
#[derive(Debug)]
            struct DescribeFleetCapacityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeFleetCapacityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_fleet_capacity::de_describe_fleet_capacity_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_fleet_capacity::de_describe_fleet_capacity_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeFleetCapacityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeFleetCapacityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_fleet_capacity::DescribeFleetCapacityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_fleet_capacity::DescribeFleetCapacityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_fleet_capacity::ser_describe_fleet_capacity_input(&input)?);
...
#[derive(Debug)]
            struct DescribeFleetCapacityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeFleetCapacityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeFleetCapacityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeFleetCapacityInput>()
                        .ok_or("failed to downcast to DescribeFleetCapacityInput")?;
...
pub enum DescribeFleetCapacityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeFleetCapacityError) for what information is available for the error.")]
...
impl DescribeFleetCapacityError {
    /// Creates the `DescribeFleetCapacityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFleetCapacityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeFleetCapacityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_fleet_capacity::DescribeFleetCapacityError {
...
mod _describe_fleet_capacity_output;
