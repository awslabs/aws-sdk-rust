...
impl RegisterGameServerInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_game_server::ser_register_game_server_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_game_server::RegisterGameServer::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::register_game_server::RegisterGameServerError
{
