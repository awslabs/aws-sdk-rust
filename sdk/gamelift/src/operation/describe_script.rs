...
impl DescribeScriptInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_script::DescribeScript, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_script::ser_describe_script_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScript {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_script::de_describe_script_http_response_with_props(status, headers, body)
        }
    }
}
