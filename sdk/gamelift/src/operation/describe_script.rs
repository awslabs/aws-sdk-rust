...
impl DescribeScriptInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScript`](crate::operation::describe_script::DescribeScript)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_script::DescribeScript, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_script::DescribeScriptInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_script::ser_describe_script_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_script::DescribeScript::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeScript", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeScript {
                type Output = std::result::Result<crate::operation::describe_script::DescribeScriptOutput, crate::operation::describe_script::DescribeScriptError>;
