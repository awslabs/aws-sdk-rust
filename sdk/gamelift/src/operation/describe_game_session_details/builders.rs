...
impl DescribeGameSessionDetailsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_game_session_details();
...
/// <ul>
/// <li>
/// <p>To retrieve details for all game sessions that are currently running on all locations in a fleet, provide a fleet or alias ID, with an optional status filter. This approach returns details from the fleet's home Region and all remote locations.</p></li>
/// <li>
/// <p>To retrieve details for all game sessions that are currently running on a specific fleet location, provide a fleet or alias ID and a location name, with optional status filter. The location can be the fleet's home Region or any remote location.</p></li>
/// <li>
/// <p>To retrieve details for a specific game session, provide the game session ID. This approach looks for the game session ID in all fleets that reside in the Amazon Web Services Region defined in the request.</p></li>
/// </ul>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_game_session_details::DescribeGameSessionDetailsOutput,
                    crate::operation::describe_game_session_details::DescribeGameSessionDetailsError,
                > for DescribeGameSessionDetailsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeGameSessionDetailsFluentBuilder {
    ...
    /// Access the DescribeGameSessionDetails as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_game_session_details::builders::DescribeGameSessionDetailsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_game_session_details::DescribeGameSessionDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_game_session_details::DescribeGameSessionDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_game_session_details::DescribeGameSessionDetails::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_game_session_details::DescribeGameSessionDetailsOutput, crate::operation::describe_game_session_details::DescribeGameSessionDetailsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_game_session_details::paginator::DescribeGameSessionDetailsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
