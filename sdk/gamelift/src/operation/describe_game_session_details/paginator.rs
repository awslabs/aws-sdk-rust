        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_game_session_details::DescribeGameSessionDetails::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl DescribeGameSessionDetailsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_game_session_details_output_output_game_session_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
