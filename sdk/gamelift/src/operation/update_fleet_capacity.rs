...
impl UpdateFleetCapacityInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFleetCapacity`](crate::operation::update_fleet_capacity::UpdateFleetCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_fleet_capacity::UpdateFleetCapacity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_fleet_capacity::UpdateFleetCapacityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_fleet_capacity::ser_update_fleet_capacity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_fleet_capacity::UpdateFleetCapacity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateFleetCapacity", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFleetCapacity {
                type Output = std::result::Result<crate::operation::update_fleet_capacity::UpdateFleetCapacityOutput, crate::operation::update_fleet_capacity::UpdateFleetCapacityError>;
