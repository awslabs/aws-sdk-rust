...
impl UpdateFleetCapacityInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_fleet_capacity::ser_update_fleet_capacity_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_fleet_capacity::UpdateFleetCapacity::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_fleet_capacity::UpdateFleetCapacityError
{
