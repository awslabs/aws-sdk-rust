...
impl ResumeGameServerGroupInput {
    /// Consumes the builder and constructs an Operation<[`ResumeGameServerGroup`](crate::operation::resume_game_server_group::ResumeGameServerGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::resume_game_server_group::ResumeGameServerGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resume_game_server_group::ResumeGameServerGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resume_game_server_group::ser_resume_game_server_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::resume_game_server_group::ResumeGameServerGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ResumeGameServerGroup", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ResumeGameServerGroup {
                type Output = std::result::Result<crate::operation::resume_game_server_group::ResumeGameServerGroupOutput, crate::operation::resume_game_server_group::ResumeGameServerGroupError>;
