...
impl DeleteMatchmakingRuleSetInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMatchmakingRuleSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_matchmaking_rule_set::de_delete_matchmaking_rule_set_http_response_with_props(status, headers, body)
        }
    }
}
