...
impl DeleteMatchmakingRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMatchmakingRuleSet`](crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_matchmaking_rule_set::ser_delete_matchmaking_rule_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteMatchmakingRuleSet", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteMatchmakingRuleSet {
                type Output = std::result::Result<crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetOutput, crate::operation::delete_matchmaking_rule_set::DeleteMatchmakingRuleSetError>;
