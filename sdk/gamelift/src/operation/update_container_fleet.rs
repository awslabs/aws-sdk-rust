...
/// Orchestration and serialization glue logic for `UpdateContainerFleet`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateContainerFleet;
impl UpdateContainerFleet {
    /// Creates a new `UpdateContainerFleet`
    pub fn new() -> Self {
        Self
    }
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_container_fleet::UpdateContainerFleetError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_container_fleet::UpdateContainerFleetOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "UpdateContainerFleet", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.UpdateContainerFleet",
                "rpc.service" = "GameLift",
                "rpc.method" = "UpdateContainerFleet",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateContainerFleet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateContainerFleet");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateContainerFleetRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateContainerFleetResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateContainerFleet")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateContainerFleet")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateContainerFleetTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateContainerFleetEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateContainerFleetTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateContainerFleetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateContainerFleetInput>() else {
...
#[derive(Debug)]
struct UpdateContainerFleetResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateContainerFleetResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_container_fleet::de_update_container_fleet_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_container_fleet::de_update_container_fleet_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct UpdateContainerFleetRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateContainerFleetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_container_fleet::UpdateContainerFleetInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_container_fleet::UpdateContainerFleetInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/UpdateContainerFleet").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_container_fleet::ser_update_container_fleet_input(
            &input,
        )?);
...
#[derive(Debug)]
struct UpdateContainerFleetEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateContainerFleetEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "UpdateContainerFleetEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateContainerFleetInput>()
            .ok_or("failed to downcast to UpdateContainerFleetInput")?;
...
/// Error type for the `UpdateContainerFleetError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateContainerFleetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateContainerFleetError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl UpdateContainerFleetError {
    /// Creates the `UpdateContainerFleetError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `UpdateContainerFleetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `UpdateContainerFleetError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::NotReadyException`.
    pub fn is_not_ready_exception(&self) -> bool {
        matches!(self, Self::NotReadyException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::UnauthorizedException`.
    pub fn is_unauthorized_exception(&self) -> bool {
        matches!(self, Self::UnauthorizedException(_))
    }
    /// Returns `true` if the error kind is `UpdateContainerFleetError::UnsupportedRegionException`.
    pub fn is_unsupported_region_exception(&self) -> bool {
        matches!(self, Self::UnsupportedRegionException(_))
    }
}
impl ::std::error::Error for UpdateContainerFleetError {
...
impl ::std::fmt::Display for UpdateContainerFleetError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateContainerFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateContainerFleetError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateContainerFleetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_container_fleet::UpdateContainerFleetError {
    fn request_id(&self) -> Option<&str> {
        self.meta().request_id()
    }
}

pub use crate::operation::update_container_fleet::_update_container_fleet_input::UpdateContainerFleetInput;

pub use crate::operation::update_container_fleet::_update_container_fleet_output::UpdateContainerFleetOutput;

mod _update_container_fleet_input;

mod _update_container_fleet_output;
