...
/// Paginator for [`ListContainerFleets`](crate::operation::list_container_fleets::ListContainerFleets)
pub struct ListContainerFleetsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_container_fleets::builders::ListContainerFleetsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListContainerFleetsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `container_fleets`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_container_fleets::paginator::ListContainerFleetsPaginatorItems {
        crate::operation::list_container_fleets::paginator::ListContainerFleetsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_container_fleets::ListContainerFleets::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_container_fleets_output_output_next_token(resp);
...
/// Flattened paginator for `ListContainerFleetsPaginator`
///
/// This is created with [`.items()`](ListContainerFleetsPaginator::items)
pub struct ListContainerFleetsPaginatorItems(ListContainerFleetsPaginator);

impl ListContainerFleetsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_container_fleets_output_output_container_fleets(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
