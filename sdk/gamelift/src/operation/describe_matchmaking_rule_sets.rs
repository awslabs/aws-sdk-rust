...
impl DescribeMatchmakingRuleSetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_matchmaking_rule_sets::DescribeMatchmakingRuleSets::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeMatchmakingRuleSetsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_matchmaking_rule_sets::DescribeMatchmakingRuleSetsError
{
