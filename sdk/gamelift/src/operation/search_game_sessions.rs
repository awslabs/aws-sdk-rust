...
impl SearchGameSessionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_game_sessions::ser_search_game_sessions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_game_sessions::SearchGameSessions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_game_sessions::SearchGameSessionsError
{
