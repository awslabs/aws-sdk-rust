...
impl SearchGameSessionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_game_sessions::ser_search_game_sessions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchGameSessions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_game_sessions::de_search_game_sessions_http_response_with_props(status, headers, body)
        }
    }
}
