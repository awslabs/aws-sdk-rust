...
impl SearchGameSessionsInput {
    /// Consumes the builder and constructs an Operation<[`SearchGameSessions`](crate::operation::search_game_sessions::SearchGameSessions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::search_game_sessions::SearchGameSessions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_game_sessions::SearchGameSessionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_game_sessions::ser_search_game_sessions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::search_game_sessions::SearchGameSessions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SearchGameSessions", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for SearchGameSessions {
                type Output = std::result::Result<crate::operation::search_game_sessions::SearchGameSessionsOutput, crate::operation::search_game_sessions::SearchGameSessionsError>;
