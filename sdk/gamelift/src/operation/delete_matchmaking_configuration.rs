...
impl DeleteMatchmakingConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMatchmakingConfiguration`](crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_matchmaking_configuration::ser_delete_matchmaking_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteMatchmakingConfiguration", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteMatchmakingConfiguration {
                type Output = std::result::Result<crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfigurationOutput, crate::operation::delete_matchmaking_configuration::DeleteMatchmakingConfigurationError>;
