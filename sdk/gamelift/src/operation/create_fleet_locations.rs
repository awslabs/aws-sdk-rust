...
impl CreateFleetLocationsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_fleet_locations::ser_create_fleet_locations_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_fleet_locations::CreateFleetLocations::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_fleet_locations::CreateFleetLocationsError
{
