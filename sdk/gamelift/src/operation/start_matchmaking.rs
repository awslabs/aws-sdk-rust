...
impl StartMatchmakingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_matchmaking::StartMatchmaking, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_matchmaking::ser_start_matchmaking_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMatchmaking {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_matchmaking::de_start_matchmaking_http_response_with_props(status, headers, body)
        }
    }
}
