...
impl ResumeGameServerGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::resume_game_server_group::ResumeGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resume_game_server_group::ResumeGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::resume_game_server_group::ResumeGameServerGroupOutput, crate::operation::resume_game_server_group::ResumeGameServerGroupError, Self> {
