...
impl StartGameSessionPlacement {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "StartGameSessionPlacement",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartGameSessionPlacement {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartGameSessionPlacementRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartGameSessionPlacementResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartGameSessionPlacement")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartGameSessionPlacement")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartGameSessionPlacementTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartGameSessionPlacementTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartGameSessionPlacementTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartGameSessionPlacementInput>() else {
        ...
        if requested.should_capture("GameSessionQueueName") {
            if let ::std::option::Option::Some(value) = input.game_session_queue_name.as_deref() {
                captured.insert("GameSessionQueueName", value);
            }
        }
        if requested.should_capture("GameSessionName") {
            if let ::std::option::Option::Some(value) = input.game_session_name.as_deref() {
                captured.insert("GameSessionName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartGameSessionPlacementResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_game_session_placement::de_start_game_session_placement_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_game_session_placement::de_start_game_session_placement_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartGameSessionPlacementRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_game_session_placement::StartGameSessionPlacementInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_game_session_placement::StartGameSessionPlacementInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/StartGameSessionPlacement").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_start_game_session_placement::ser_start_game_session_placement_input(&input)?,
        );
