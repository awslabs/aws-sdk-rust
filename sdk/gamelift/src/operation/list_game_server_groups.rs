...
impl ListGameServerGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListGameServerGroups`](crate::operation::list_game_server_groups::ListGameServerGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_game_server_groups::ListGameServerGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_game_server_groups::ListGameServerGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_game_server_groups::ser_list_game_server_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_game_server_groups::ListGameServerGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGameServerGroups", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListGameServerGroups {
                type Output = std::result::Result<crate::operation::list_game_server_groups::ListGameServerGroupsOutput, crate::operation::list_game_server_groups::ListGameServerGroupsError>;
