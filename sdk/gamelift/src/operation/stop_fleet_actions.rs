...
impl StopFleetActionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_fleet_actions::ser_stop_fleet_actions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopFleetActions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_fleet_actions::de_stop_fleet_actions_http_response_with_props(status, headers, body)
        }
    }
}
