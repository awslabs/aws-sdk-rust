...
impl StopFleetActionsInput {
    /// Consumes the builder and constructs an Operation<[`StopFleetActions`](crate::operation::stop_fleet_actions::StopFleetActions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_fleet_actions::StopFleetActions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_fleet_actions::StopFleetActionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_fleet_actions::ser_stop_fleet_actions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_fleet_actions::StopFleetActions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopFleetActions", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopFleetActions {
                type Output = std::result::Result<crate::operation::stop_fleet_actions::StopFleetActionsOutput, crate::operation::stop_fleet_actions::StopFleetActionsError>;
