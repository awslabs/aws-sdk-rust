...
impl DescribeGameServerGroupInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameServerGroup`](crate::operation::describe_game_server_group::DescribeGameServerGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_game_server_group::DescribeGameServerGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_server_group::DescribeGameServerGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_server_group::ser_describe_game_server_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_server_group::DescribeGameServerGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeGameServerGroup", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGameServerGroup {
                type Output = std::result::Result<crate::operation::describe_game_server_group::DescribeGameServerGroupOutput, crate::operation::describe_game_server_group::DescribeGameServerGroupError>;
