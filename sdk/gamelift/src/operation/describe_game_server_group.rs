...
/// Orchestration and serialization glue logic for `DescribeGameServerGroup`.
...
impl DescribeGameServerGroup {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_game_server_group::DescribeGameServerGroupInput,
                    ) -> ::std::result::Result<crate::operation::describe_game_server_group::DescribeGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_game_server_group::DescribeGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_game_server_group::DescribeGameServerGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_game_server_group::DescribeGameServerGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeGameServerGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeGameServerGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeGameServerGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeGameServerGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeGameServerGroup")
...
.with_interceptor(DescribeGameServerGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_game_server_group::DescribeGameServerGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_game_server_group::DescribeGameServerGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_game_server_group::DescribeGameServerGroupError>::new());
...
#[derive(Debug)]
            struct DescribeGameServerGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGameServerGroupResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_game_server_group::de_describe_game_server_group_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_game_server_group::de_describe_game_server_group_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeGameServerGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGameServerGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_game_server_group::DescribeGameServerGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_game_server_group::DescribeGameServerGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_game_server_group::ser_describe_game_server_group_input(&input)?);
...
#[derive(Debug)]
            struct DescribeGameServerGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeGameServerGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeGameServerGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeGameServerGroupInput>()
                        .ok_or("failed to downcast to DescribeGameServerGroupInput")?;
...
pub enum DescribeGameServerGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeGameServerGroupError) for what information is available for the error.")]
...
impl DescribeGameServerGroupError {
    /// Creates the `DescribeGameServerGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeGameServerGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeGameServerGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_game_server_group::DescribeGameServerGroupError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_game_server_group::_describe_game_server_group_output::DescribeGameServerGroupOutput;

pub use crate::operation::describe_game_server_group::_describe_game_server_group_input::DescribeGameServerGroupInput;

mod _describe_game_server_group_input;

mod _describe_game_server_group_output;
