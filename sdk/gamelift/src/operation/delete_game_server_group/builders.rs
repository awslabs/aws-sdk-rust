...
impl DeleteGameServerGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_game_server_group::DeleteGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_game_server_group::DeleteGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_game_server_group::DeleteGameServerGroupOutput, crate::operation::delete_game_server_group::DeleteGameServerGroupError, Self> {
