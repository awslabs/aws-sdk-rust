...
impl UpdateBuildInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBuild`](crate::operation::update_build::UpdateBuild)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_build::UpdateBuild, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_build::UpdateBuildInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_build::ser_update_build_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_build::UpdateBuild::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateBuild", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBuild {
                type Output = std::result::Result<crate::operation::update_build::UpdateBuildOutput, crate::operation::update_build::UpdateBuildError>;
