...
impl UpdateBuildInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_build::UpdateBuild, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_build::ser_update_build_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBuild {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_build::de_update_build_http_response_with_props(status, headers, body)
        }
    }
}
