...
impl DescribeRuntimeConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_runtime_configuration::DescribeRuntimeConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRuntimeConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_runtime_configuration::de_describe_runtime_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
