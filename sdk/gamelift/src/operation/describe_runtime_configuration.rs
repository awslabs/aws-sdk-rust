...
impl DescribeRuntimeConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRuntimeConfiguration`](crate::operation::describe_runtime_configuration::DescribeRuntimeConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_runtime_configuration::DescribeRuntimeConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_runtime_configuration::DescribeRuntimeConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_runtime_configuration::ser_describe_runtime_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_runtime_configuration::DescribeRuntimeConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeRuntimeConfiguration", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRuntimeConfiguration {
                type Output = std::result::Result<crate::operation::describe_runtime_configuration::DescribeRuntimeConfigurationOutput, crate::operation::describe_runtime_configuration::DescribeRuntimeConfigurationError>;
