...
impl DescribeGameSessionQueuesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesInput, ::aws_smithy_types::error::operation::BuildError> {
