        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::describe_game_session_queues::DescribeGameSessionQueues::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl DescribeGameSessionQueuesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_describe_game_session_queues_output_output_game_session_queues(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
