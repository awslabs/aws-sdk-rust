...
impl DescribeGameSessionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_sessions::ser_describe_game_sessions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_game_sessions::DescribeGameSessions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_game_sessions::DescribeGameSessionsError
{
