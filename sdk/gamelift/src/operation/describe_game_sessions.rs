...
impl DescribeGameSessionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameSessions`](crate::operation::describe_game_sessions::DescribeGameSessions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_game_sessions::DescribeGameSessions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_sessions::DescribeGameSessionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_sessions::ser_describe_game_sessions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_sessions::DescribeGameSessions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeGameSessions", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGameSessions {
                type Output = std::result::Result<crate::operation::describe_game_sessions::DescribeGameSessionsOutput, crate::operation::describe_game_sessions::DescribeGameSessionsError>;
