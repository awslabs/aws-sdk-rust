...
impl DeleteVpcPeeringAuthorizationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vpc_peering_authorization::DeleteVpcPeeringAuthorization::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcPeeringAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vpc_peering_authorization::de_delete_vpc_peering_authorization_http_response_with_props(
                status, headers, body,
            )
        }
    }
