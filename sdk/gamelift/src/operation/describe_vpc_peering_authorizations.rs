...
impl DescribeVpcPeeringAuthorizationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVpcPeeringAuthorizations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_vpc_peering_authorizations::de_describe_vpc_peering_authorizations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError
{
