...
/// Orchestration and serialization glue logic for `DescribeVpcPeeringAuthorizations`.
...
impl DescribeVpcPeeringAuthorizations {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsInput,
                    ) -> ::std::result::Result<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcPeeringAuthorizations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeVpcPeeringAuthorizations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeVpcPeeringAuthorizationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeVpcPeeringAuthorizationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeVpcPeeringAuthorizations")
...
.with_interceptor(DescribeVpcPeeringAuthorizationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError>::new());
...
#[derive(Debug)]
            struct DescribeVpcPeeringAuthorizationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeVpcPeeringAuthorizationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_vpc_peering_authorizations::de_describe_vpc_peering_authorizations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_vpc_peering_authorizations::de_describe_vpc_peering_authorizations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeVpcPeeringAuthorizationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeVpcPeeringAuthorizationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_vpc_peering_authorizations::ser_describe_vpc_peering_authorizations_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct DescribeVpcPeeringAuthorizationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeVpcPeeringAuthorizationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeVpcPeeringAuthorizationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeVpcPeeringAuthorizationsInput>()
                        .ok_or("failed to downcast to DescribeVpcPeeringAuthorizationsInput")?;
...
pub enum DescribeVpcPeeringAuthorizationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeVpcPeeringAuthorizationsError) for what information is available for the error.")]
...
impl DescribeVpcPeeringAuthorizationsError {
    /// Creates the `DescribeVpcPeeringAuthorizationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeVpcPeeringAuthorizationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeVpcPeeringAuthorizationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeVpcPeeringAuthorizationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError {
...
mod _describe_vpc_peering_authorizations_output;
