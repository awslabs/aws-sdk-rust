...
impl DescribeVpcPeeringAuthorizations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "DescribeVpcPeeringAuthorizations",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeVpcPeeringAuthorizations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DescribeVpcPeeringAuthorizationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DescribeVpcPeeringAuthorizationsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeVpcPeeringAuthorizations")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeVpcPeeringAuthorizationsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_describe_vpc_peering_authorizations::de_describe_vpc_peering_authorizations_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeVpcPeeringAuthorizationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GameLift/operation/DescribeVpcPeeringAuthorizations").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_describe_vpc_peering_authorizations::ser_describe_vpc_peering_authorizations_input(&input)?,
        );
