...
impl ClaimGameServerInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::claim_game_server::ClaimGameServerError, ::aws_smithy_http::operation::Response>,
    > {
...
/// <li> <p>If the game server is running on an instance in <code>DRAINING</code> status and the provided filter option does not allow placing on <code>DRAINING</code> instances.</p> </li>
/// </ul>
/// <p> <b>Learn more</b> </p>
