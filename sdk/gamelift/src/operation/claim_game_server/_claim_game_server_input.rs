...
impl ClaimGameServerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::claim_game_server::ClaimGameServerInput, ::aws_smithy_types::error::operation::BuildError> {
