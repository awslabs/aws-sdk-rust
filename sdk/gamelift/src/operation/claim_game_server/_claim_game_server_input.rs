...
impl ::std::fmt::Debug for ClaimGameServerInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("filter_option", &self.filter_option);
        formatter.finish()
    }
}
impl ClaimGameServerInput {
...
impl ::std::fmt::Debug for ClaimGameServerInputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("ClaimGameServerInputBuilder");
        formatter.field("game_server_group_name", &self.game_server_group_name);
        formatter.field("game_server_id", &self.game_server_id);
        formatter.field("game_server_data", &"*** Sensitive Data Redacted ***");
        formatter.field("filter_option", &self.filter_option);
