...
impl ListGameServerGroupsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::list_game_server_groups::paginator::ListGameServerGroupsPaginatorItems
    {
        crate::operation::list_game_server_groups::paginator::ListGameServerGroupsPaginatorItems(
            self,
        )
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_game_server_groups_output_next_token(
                                    resp,
                                );
...
impl ListGameServerGroupsPaginatorItems {
    ...
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_game_server_groups_output_game_server_groups(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
