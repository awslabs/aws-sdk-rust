...
impl ListGameServersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_game_servers::ListGameServers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_game_servers::ser_list_game_servers_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGameServers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_game_servers::de_list_game_servers_http_response_with_props(status, headers, body)
        }
    }
}
