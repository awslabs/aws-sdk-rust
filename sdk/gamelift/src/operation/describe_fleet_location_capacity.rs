...
impl DescribeFleetLocationCapacityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_fleet_location_capacity::DescribeFleetLocationCapacity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetLocationCapacity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_fleet_location_capacity::de_describe_fleet_location_capacity_http_response_with_props(
                status, headers, body,
            )
        }
    }
