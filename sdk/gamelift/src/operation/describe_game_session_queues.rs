...
impl DescribeGameSessionQueuesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameSessionQueues`](crate::operation::describe_game_session_queues::DescribeGameSessionQueues)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_game_session_queues::DescribeGameSessionQueues, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_session_queues::DescribeGameSessionQueuesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_session_queues::ser_describe_game_session_queues_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_session_queues::DescribeGameSessionQueues::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeGameSessionQueues", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeGameSessionQueues {
                type Output = std::result::Result<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesOutput, crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError>;
