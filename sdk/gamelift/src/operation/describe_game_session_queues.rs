...
/// Orchestration and serialization glue logic for `DescribeGameSessionQueues`.
...
impl DescribeGameSessionQueues {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeGameSessionQueues {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeGameSessionQueues");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeGameSessionQueuesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeGameSessionQueuesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeGameSessionQueues")
...
.with_interceptor(DescribeGameSessionQueuesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError>::new());
...
#[derive(Debug)]
            struct DescribeGameSessionQueuesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeGameSessionQueuesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_game_session_queues::de_describe_game_session_queues_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_game_session_queues::de_describe_game_session_queues_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeGameSessionQueuesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeGameSessionQueuesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_game_session_queues::DescribeGameSessionQueuesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_game_session_queues::DescribeGameSessionQueuesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_game_session_queues::ser_describe_game_session_queues_input(&input)?);
...
#[derive(Debug)]
            struct DescribeGameSessionQueuesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeGameSessionQueuesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeGameSessionQueuesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeGameSessionQueuesInput>()
                        .ok_or("failed to downcast to DescribeGameSessionQueuesInput")?;
...
pub enum DescribeGameSessionQueuesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeGameSessionQueuesError) for what information is available for the error.")]
...
impl DescribeGameSessionQueuesError {
    /// Creates the `DescribeGameSessionQueuesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeGameSessionQueuesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeGameSessionQueuesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_game_session_queues::DescribeGameSessionQueuesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_game_session_queues::_describe_game_session_queues_output::DescribeGameSessionQueuesOutput;

pub use crate::operation::describe_game_session_queues::_describe_game_session_queues_input::DescribeGameSessionQueuesInput;

mod _describe_game_session_queues_input;

mod _describe_game_session_queues_output;
