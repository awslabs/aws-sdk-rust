...
impl RequestUploadCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`RequestUploadCredentials`](crate::operation::request_upload_credentials::RequestUploadCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::request_upload_credentials::RequestUploadCredentials, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_upload_credentials::RequestUploadCredentialsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_request_upload_credentials::ser_request_upload_credentials_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::request_upload_credentials::RequestUploadCredentials::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RequestUploadCredentials", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for RequestUploadCredentials {
                type Output = std::result::Result<crate::operation::request_upload_credentials::RequestUploadCredentialsOutput, crate::operation::request_upload_credentials::RequestUploadCredentialsError>;
