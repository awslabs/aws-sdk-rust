...
impl crate::operation::describe_runtime_configuration::builders::DescribeRuntimeConfigurationInputBuilder {
...
///
/// <p>Retrieves a fleet's runtime configuration settings. The runtime configuration determines which server processes run, and how they run, and how many run concurrently on computes in managed EC2 and Anywhere fleets. You can update a fleet's runtime configuration at any time using <code>UpdateRuntimeConfiguration</code>.</p>
