...
impl StartMatchBackfillInput {
    /// Consumes the builder and constructs an Operation<[`StartMatchBackfill`](crate::operation::start_match_backfill::StartMatchBackfill)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_match_backfill::StartMatchBackfill, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_match_backfill::StartMatchBackfillInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_match_backfill::ser_start_match_backfill_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_match_backfill::StartMatchBackfill::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartMatchBackfill", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartMatchBackfill {
                type Output = std::result::Result<crate::operation::start_match_backfill::StartMatchBackfillOutput, crate::operation::start_match_backfill::StartMatchBackfillError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_match_backfill::de_start_match_backfill_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_match_backfill::de_start_match_backfill_http_response(response)
                     }
                }
            }
