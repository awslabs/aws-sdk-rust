...
impl StartMatchBackfill {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_match_backfill::StartMatchBackfillError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_match_backfill::StartMatchBackfillOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "StartMatchBackfill", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.StartMatchBackfill",
                "rpc.service" = "GameLift",
                "rpc.method" = "StartMatchBackfill",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMatchBackfill {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartMatchBackfillRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartMatchBackfillResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartMatchBackfill")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMatchBackfill")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartMatchBackfillTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartMatchBackfillTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMatchBackfillTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartMatchBackfillInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("TicketId") {
            if let ::std::option::Option::Some(value) = input.ticket_id.as_deref() {
                captured.insert("TicketId", value);
            }
        }
        if requested.should_capture("ConfigurationName") {
            if let ::std::option::Option::Some(value) = input.configuration_name.as_deref() {
                captured.insert("ConfigurationName", value);
            }
        }
        if requested.should_capture("GameSessionArn") {
            if let ::std::option::Option::Some(value) = input.game_session_arn.as_deref() {
                captured.insert("GameSessionArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMatchBackfillResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_match_backfill::de_start_match_backfill_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_match_backfill::de_start_match_backfill_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartMatchBackfillRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_match_backfill::StartMatchBackfillInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_match_backfill::StartMatchBackfillInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/StartMatchBackfill").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_match_backfill::ser_start_match_backfill_input(&input)?);
