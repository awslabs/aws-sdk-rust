...
/// Orchestration and serialization glue logic for `StartMatchBackfill`.
...
impl StartMatchBackfill {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_match_backfill::StartMatchBackfillOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_match_backfill::StartMatchBackfillError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_match_backfill::StartMatchBackfillError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_match_backfill::StartMatchBackfillOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartMatchBackfill {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartMatchBackfill");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartMatchBackfillRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartMatchBackfillResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartMatchBackfill")
...
.with_interceptor(StartMatchBackfillEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_match_backfill::StartMatchBackfillError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_match_backfill::StartMatchBackfillError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_match_backfill::StartMatchBackfillError>::new());
...
#[derive(Debug)]
            struct StartMatchBackfillResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartMatchBackfillResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_match_backfill::de_start_match_backfill_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StartMatchBackfillRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartMatchBackfillRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_match_backfill::StartMatchBackfillInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_match_backfill::StartMatchBackfillInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_match_backfill::ser_start_match_backfill_input(&input)?);
...
#[derive(Debug)]
            struct StartMatchBackfillEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartMatchBackfillEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartMatchBackfillEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartMatchBackfillInput>()
                        .ok_or("failed to downcast to StartMatchBackfillInput")?;
...
pub enum StartMatchBackfillError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartMatchBackfillError) for what information is available for the error.")]
...
impl StartMatchBackfillError {
    /// Creates the `StartMatchBackfillError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartMatchBackfillError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartMatchBackfillError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_match_backfill::StartMatchBackfillError {
...
mod _start_match_backfill_output;
