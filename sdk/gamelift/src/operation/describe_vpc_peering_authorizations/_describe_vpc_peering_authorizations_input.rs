...
impl DescribeVpcPeeringAuthorizationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_vpc_peering_authorizations::DescribeVpcPeeringAuthorizationsInput, ::aws_smithy_http::operation::error::BuildError>{
