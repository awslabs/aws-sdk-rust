...
impl CreateBuildInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_build::CreateBuild::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBuild {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_build::de_create_build_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_build::de_create_build_http_response_with_props(
                status, headers, body,
            )
        }
    }
