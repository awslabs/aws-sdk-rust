...
impl SuspendGameServerGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::suspend_game_server_group::SuspendGameServerGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::suspend_game_server_group::SuspendGameServerGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::suspend_game_server_group::SuspendGameServerGroupOutput, crate::operation::suspend_game_server_group::SuspendGameServerGroupError, Self> {
