...
impl CreatePlayerSessionsInput {
    /// Consumes the builder and constructs an Operation<[`CreatePlayerSessions`](crate::operation::create_player_sessions::CreatePlayerSessions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_player_sessions::CreatePlayerSessions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_player_sessions::CreatePlayerSessionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_player_sessions::ser_create_player_sessions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_player_sessions::CreatePlayerSessions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePlayerSessions", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePlayerSessions {
                type Output = std::result::Result<crate::operation::create_player_sessions::CreatePlayerSessionsOutput, crate::operation::create_player_sessions::CreatePlayerSessionsError>;
