...
impl CreatePlayerSessionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_player_sessions::ser_create_player_sessions_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_player_sessions::CreatePlayerSessions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_player_sessions::CreatePlayerSessionsError
{
