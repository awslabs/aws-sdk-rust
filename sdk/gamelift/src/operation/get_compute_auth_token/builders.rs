...
impl GetComputeAuthTokenFluentBuilder  {
    /// Creates a new `GetComputeAuthToken`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_compute_auth_token::GetComputeAuthTokenOutput, aws_smithy_http::result::SdkError<crate::operation::get_compute_auth_token::GetComputeAuthTokenError>>
                     {
