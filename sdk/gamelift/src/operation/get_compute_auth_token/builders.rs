...
impl GetComputeAuthTokenFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_compute_auth_token::GetComputeAuthTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_compute_auth_token::GetComputeAuthTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_compute_auth_token::GetComputeAuthTokenOutput, crate::operation::get_compute_auth_token::GetComputeAuthTokenError, Self> {
