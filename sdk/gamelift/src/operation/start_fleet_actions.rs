...
impl StartFleetActions {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_fleet_actions::StartFleetActionsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_fleet_actions::StartFleetActionsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "StartFleetActions", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.StartFleetActions",
                "rpc.service" = "GameLift",
                "rpc.method" = "StartFleetActions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartFleetActions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartFleetActions")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartFleetActions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartFleetActionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartFleetActionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartFleetActionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartFleetActionsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartFleetActionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartFleetActionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_fleet_actions::StartFleetActionsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GameLift/operation/StartFleetActions").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
