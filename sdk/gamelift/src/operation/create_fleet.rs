...
impl CreateFleet {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "CreateFleet", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFleetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("ServerLaunchPath") {
            if let ::std::option::Option::Some(value) = input.server_launch_path.as_deref() {
                captured.insert("ServerLaunchPath", value);
            }
        }
        if requested.should_capture("ServerLaunchParameters") {
            if let ::std::option::Option::Some(value) = input.server_launch_parameters.as_deref() {
                captured.insert("ServerLaunchParameters", value);
            }
        }
        if requested.should_capture("PeerVpcAwsAccountId") {
            if let ::std::option::Option::Some(value) = input.peer_vpc_aws_account_id.as_deref() {
                captured.insert("PeerVpcAwsAccountId", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GameLift/operation/CreateFleet").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
