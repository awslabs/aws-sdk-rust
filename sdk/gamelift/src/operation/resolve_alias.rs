...
impl ResolveAliasInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::resolve_alias::ResolveAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_resolve_alias::de_resolve_alias_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_resolve_alias::de_resolve_alias_http_response_with_props(
                status, headers, body,
            )
        }
    }
