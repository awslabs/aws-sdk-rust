...
/// Orchestration and serialization glue logic for `CreateGameSessionQueue`.
...
impl CreateGameSessionQueue {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_game_session_queue::CreateGameSessionQueueInput,
                    ) -> ::std::result::Result<crate::operation::create_game_session_queue::CreateGameSessionQueueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_game_session_queue::CreateGameSessionQueueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_game_session_queue::CreateGameSessionQueueError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_game_session_queue::CreateGameSessionQueueOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateGameSessionQueue {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateGameSessionQueue");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateGameSessionQueueRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateGameSessionQueueResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateGameSessionQueue")
...
.with_interceptor(CreateGameSessionQueueEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_game_session_queue::CreateGameSessionQueueError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_game_session_queue::CreateGameSessionQueueError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_game_session_queue::CreateGameSessionQueueError>::new());
...
#[derive(Debug)]
            struct CreateGameSessionQueueResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateGameSessionQueueResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_game_session_queue::de_create_game_session_queue_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_game_session_queue::de_create_game_session_queue_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateGameSessionQueueRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateGameSessionQueueRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_game_session_queue::CreateGameSessionQueueInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_game_session_queue::CreateGameSessionQueueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_game_session_queue::ser_create_game_session_queue_input(&input)?);
...
#[derive(Debug)]
            struct CreateGameSessionQueueEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateGameSessionQueueEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateGameSessionQueueEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateGameSessionQueueInput>()
                        .ok_or("failed to downcast to CreateGameSessionQueueInput")?;
...
pub enum CreateGameSessionQueueError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateGameSessionQueueError) for what information is available for the error.")]
...
impl CreateGameSessionQueueError {
    /// Creates the `CreateGameSessionQueueError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateGameSessionQueueError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateGameSessionQueueError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_game_session_queue::CreateGameSessionQueueError {
...
mod _create_game_session_queue_output;
