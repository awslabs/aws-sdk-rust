...
impl CreateGameSessionQueueInput {
    /// Consumes the builder and constructs an Operation<[`CreateGameSessionQueue`](crate::operation::create_game_session_queue::CreateGameSessionQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_game_session_queue::CreateGameSessionQueue, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_game_session_queue::CreateGameSessionQueueInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_game_session_queue::ser_create_game_session_queue_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_game_session_queue::CreateGameSessionQueue::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateGameSessionQueue", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGameSessionQueue {
                type Output = std::result::Result<crate::operation::create_game_session_queue::CreateGameSessionQueueOutput, crate::operation::create_game_session_queue::CreateGameSessionQueueError>;
