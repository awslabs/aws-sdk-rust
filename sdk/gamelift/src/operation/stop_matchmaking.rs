...
impl StopMatchmakingInput {
    /// Consumes the builder and constructs an Operation<[`StopMatchmaking`](crate::operation::stop_matchmaking::StopMatchmaking)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::stop_matchmaking::StopMatchmaking, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_matchmaking::StopMatchmakingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_matchmaking::ser_stop_matchmaking_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::stop_matchmaking::StopMatchmaking::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StopMatchmaking", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for StopMatchmaking {
                type Output = std::result::Result<crate::operation::stop_matchmaking::StopMatchmakingOutput, crate::operation::stop_matchmaking::StopMatchmakingError>;
