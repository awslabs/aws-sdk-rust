...
impl StopMatchmakingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_matchmaking::StopMatchmaking, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_matchmaking::ser_stop_matchmaking_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopMatchmaking {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_matchmaking::de_stop_matchmaking_http_response_with_props(status, headers, body)
        }
    }
}
