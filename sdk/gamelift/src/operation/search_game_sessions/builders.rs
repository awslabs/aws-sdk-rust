...
impl SearchGameSessionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_game_sessions::SearchGameSessionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_game_sessions::SearchGameSessionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_game_sessions::SearchGameSessionsOutput, crate::operation::search_game_sessions::SearchGameSessionsError, Self> {
