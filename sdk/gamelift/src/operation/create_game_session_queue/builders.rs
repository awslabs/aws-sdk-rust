...
impl CreateGameSessionQueueFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_game_session_queue::CreateGameSessionQueueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_game_session_queue::CreateGameSessionQueueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_game_session_queue::CreateGameSessionQueueOutput, crate::operation::create_game_session_queue::CreateGameSessionQueueError, Self> {
