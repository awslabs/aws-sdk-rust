...
impl DescribeGameServerInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_game_server_instances::DescribeGameServerInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
