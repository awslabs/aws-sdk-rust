...
impl DeleteGameServerGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGameServerGroup`](crate::operation::delete_game_server_group::DeleteGameServerGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_game_server_group::DeleteGameServerGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_game_server_group::DeleteGameServerGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_game_server_group::ser_delete_game_server_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_game_server_group::DeleteGameServerGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteGameServerGroup", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteGameServerGroup {
                type Output = std::result::Result<crate::operation::delete_game_server_group::DeleteGameServerGroupOutput, crate::operation::delete_game_server_group::DeleteGameServerGroupError>;
