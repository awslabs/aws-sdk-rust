...
impl DescribeInstancesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_instances::ser_describe_instances_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_instances::de_describe_instances_http_response_with_props(status, headers, body)
        }
    }
}
