...
impl DeregisterComputeInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterCompute`](crate::operation::deregister_compute::DeregisterCompute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::deregister_compute::DeregisterCompute, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_compute::DeregisterComputeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_compute::ser_deregister_compute_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_compute::DeregisterCompute::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeregisterCompute", "gamelift"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeregisterCompute {
                type Output = std::result::Result<crate::operation::deregister_compute::DeregisterComputeOutput, crate::operation::deregister_compute::DeregisterComputeError>;
