...
impl DeregisterComputeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_deregister_compute::ser_deregister_compute_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterCompute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_compute::de_deregister_compute_http_response_with_props(status, headers, body)
        }
    }
}
