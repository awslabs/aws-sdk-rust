...
impl DescribeFleetAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fleet_attributes::DescribeFleetAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
