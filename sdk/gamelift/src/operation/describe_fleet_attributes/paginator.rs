...
impl DescribeFleetAttributesPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::describe_fleet_attributes::paginator::DescribeFleetAttributesPaginatorItems
    {
                ...
                loop {
                    ...
                    let done = match resp {
                        ::std::result::Result::Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_describe_fleet_attributes_output_next_token(
                                    resp,
                                );
