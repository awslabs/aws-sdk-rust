...
impl DeleteBuildInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_build::DeleteBuild, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_build::ser_delete_build_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBuild {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_build::de_delete_build_http_response_with_props(status, headers, body)
        }
    }
}
