...
impl GetComputeAuthToken {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_compute_auth_token::GetComputeAuthTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_compute_auth_token::GetComputeAuthTokenOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "GetComputeAuthToken", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "GameLift.GetComputeAuthToken",
                "rpc.service" = "GameLift",
                "rpc.method" = "GetComputeAuthToken",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetComputeAuthToken {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetComputeAuthTokenRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetComputeAuthTokenResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetComputeAuthToken")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetComputeAuthToken")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetComputeAuthTokenTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetComputeAuthTokenTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetComputeAuthTokenTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetComputeAuthTokenInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetComputeAuthTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_compute_auth_token::de_get_compute_auth_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_compute_auth_token::de_get_compute_auth_token_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetComputeAuthTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_compute_auth_token::GetComputeAuthTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_compute_auth_token::GetComputeAuthTokenInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GameLift/operation/GetComputeAuthToken").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_compute_auth_token::ser_get_compute_auth_token_input(
            &input,
        )?);
...
impl GetComputeAuthTokenError {
    ...
    /// Returns `true` if the error kind is `GetComputeAuthTokenError::UnsupportedRegionException`.
