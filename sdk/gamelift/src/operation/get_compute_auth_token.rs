...
impl GetComputeAuthTokenInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_compute_auth_token::ser_get_compute_auth_token_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_compute_auth_token::GetComputeAuthToken::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_compute_auth_token::GetComputeAuthTokenError
{
