...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_game_session_log_url::de_get_game_session_log_url(_response_body, output)
            .map_err(crate::operation::get_game_session_log_url::GetGameSessionLogUrlError::unhandled)?;
...
pub fn ser_get_game_session_log_url_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_get_game_session_log_url_input::ser_get_game_session_log_url_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "PreSignedUrl" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_pre_signed_url(Some(decoder.string()?)))
            })?,
            _ => {
                decoder.skip()?;
                builder
