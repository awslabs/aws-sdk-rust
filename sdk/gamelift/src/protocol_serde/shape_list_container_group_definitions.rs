...
pub fn de_list_container_group_definitions_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServiceException" => {
            crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::InternalServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedRegionException" => {
            crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::UnsupportedRegionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_container_group_definitions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_container_group_definitions::builders::ListContainerGroupDefinitionsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_container_group_definitions::de_list_container_group_definitions(_response_body, output)
            .map_err(crate::operation::list_container_group_definitions::ListContainerGroupDefinitionsError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ContainerGroupDefinitions" => {
                    builder = builder.set_container_group_definitions(
                        crate::protocol_serde::shape_container_group_definition_list::de_container_group_definition_list(tokens, _value)?,
                    );
                }
                "NextToken" => {
