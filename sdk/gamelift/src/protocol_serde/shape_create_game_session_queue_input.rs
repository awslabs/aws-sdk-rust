...
pub fn ser_create_game_session_queue_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_game_session_queue::CreateGameSessionQueueInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
