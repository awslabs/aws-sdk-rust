...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::deregister_compute::DeregisterComputeError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "InternalServiceException" => {
            crate::operation::deregister_compute::DeregisterComputeError::InternalServiceException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::deregister_compute::DeregisterComputeError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::deregister_compute::DeregisterComputeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedException" => {
            crate::operation::deregister_compute::DeregisterComputeError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
