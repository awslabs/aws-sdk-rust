...
pub fn de_deregister_compute_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_compute::DeregisterComputeOutput, crate::operation::deregister_compute::DeregisterComputeError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::deregister_compute::DeregisterComputeError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "InternalServiceException" => crate::operation::deregister_compute::DeregisterComputeError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::operation::deregister_compute::DeregisterComputeError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => crate::operation::deregister_compute::DeregisterComputeError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::operation::deregister_compute::DeregisterComputeError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::deregister_compute::DeregisterComputeError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_compute_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_compute::DeregisterComputeOutput, crate::operation::deregister_compute::DeregisterComputeError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_deregister_compute_input(input: &crate::operation::deregister_compute::DeregisterComputeInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
