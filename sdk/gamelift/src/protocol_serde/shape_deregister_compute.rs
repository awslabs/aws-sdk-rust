...
pub fn ser_deregister_compute_input(input: &crate::operation::deregister_compute::DeregisterComputeInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
