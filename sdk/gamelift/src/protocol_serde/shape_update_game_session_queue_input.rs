...
pub fn ser_update_game_session_queue_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGameSessionQueueInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
