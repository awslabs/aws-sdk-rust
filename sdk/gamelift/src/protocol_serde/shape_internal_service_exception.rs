...
pub(crate) fn de_internal_service_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InternalServiceExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InternalServiceExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
