...
pub(crate) fn de_limit_exceeded_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::LimitExceededExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::LimitExceededExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
