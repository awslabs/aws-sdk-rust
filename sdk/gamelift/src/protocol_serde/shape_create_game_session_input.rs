...
pub fn ser_create_game_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGameSessionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
