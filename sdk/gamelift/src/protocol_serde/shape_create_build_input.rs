...
pub fn ser_create_build_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBuildInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
