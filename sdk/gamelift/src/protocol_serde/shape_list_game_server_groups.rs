...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_game_server_groups::de_list_game_server_groups(_response_body, output)
            .map_err(crate::operation::list_game_server_groups::ListGameServerGroupsError::unhandled)?;
...
pub fn ser_list_game_server_groups_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_game_server_groups_input::ser_list_game_server_groups_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "GameServerGroups" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_game_server_groups(Some(crate::protocol_serde::shape_game_server_groups::de_game_server_groups(decoder)?)))
            })?,
            "NextToken" => {
