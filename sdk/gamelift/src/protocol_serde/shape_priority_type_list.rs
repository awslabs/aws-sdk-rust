...
pub(crate) fn de_priority_type_list(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<::std::vec::Vec<crate::types::PriorityType>, ::aws_smithy_cbor::decode::DeserializeError> {
    fn member(
        mut list: ::std::vec::Vec<crate::types::PriorityType>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::PriorityType>, ::aws_smithy_cbor::decode::DeserializeError> {
