...
pub fn ser_update_game_server_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGameServerGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
