...
pub(crate) fn de_compute_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Compute>>, aws_smithy_json::deserialize::error::DeserializeError>
