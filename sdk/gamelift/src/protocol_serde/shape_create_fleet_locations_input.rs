...
pub fn ser_create_fleet_locations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_fleet_locations::CreateFleetLocationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
