...
pub(crate) fn de_linux_capability_list(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<::std::vec::Vec<crate::types::LinuxCapability>, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::LinuxCapability>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::LinuxCapability>, ::aws_smithy_cbor::decode::DeserializeError> {
