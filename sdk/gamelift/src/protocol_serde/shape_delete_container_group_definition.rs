...
pub fn de_delete_container_group_definition_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServiceException" => {
            crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::InternalServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TaggingFailedException" => {
            crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::TaggingFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedException" => crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::UnauthorizedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnsupportedRegionException" => {
            crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::UnsupportedRegionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::delete_container_group_definition::DeleteContainerGroupDefinitionError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_container_group_definition_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_container_group_definition::builders::DeleteContainerGroupDefinitionOutputBuilder::default();
