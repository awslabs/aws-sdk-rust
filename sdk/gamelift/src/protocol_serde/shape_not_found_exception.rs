...
pub(crate) fn de_not_found_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::NotFoundExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::NotFoundExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
