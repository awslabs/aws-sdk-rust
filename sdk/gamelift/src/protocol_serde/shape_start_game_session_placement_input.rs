...
pub fn ser_start_game_session_placement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartGameSessionPlacementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
