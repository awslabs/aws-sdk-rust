...
pub fn ser_list_compute_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListComputeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
