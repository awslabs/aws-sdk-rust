...
pub fn ser_describe_player_sessions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePlayerSessionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
