        ...
        builder = match decoder.str()?.as_ref() {
            ...
            "ResourceCreationLimitPolicy" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_resource_creation_limit_policy(Some(
                    crate::protocol_serde::shape_resource_creation_limit_policy::de_resource_creation_limit_policy(decoder, depth + 1)?,
                )))
            })?,
            ...
            "CertificateConfiguration" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_certificate_configuration(Some(
                    crate::protocol_serde::shape_certificate_configuration::de_certificate_configuration(decoder, depth + 1)?,
                )))
            })?,
            ...
            "PlayerGatewayConfiguration" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_player_gateway_configuration(Some(
                    crate::protocol_serde::shape_player_gateway_configuration::de_player_gateway_configuration(decoder, depth + 1)?,
                )))
            })?,
            _ => {
                decoder.skip()?;
