...
pub(crate) fn de_locational_deployment(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::LocationalDeployment, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::LocationalDeploymentBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ...
    let mut builder = crate::types::builders::LocationalDeploymentBuilder::default();
