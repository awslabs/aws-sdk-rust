...
pub fn ser_update_fleet_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFleetAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
