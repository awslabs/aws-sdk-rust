...
pub(crate) fn de_unauthorized_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::UnauthorizedExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::UnauthorizedExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
