...
pub fn ser_update_script_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateScriptInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
