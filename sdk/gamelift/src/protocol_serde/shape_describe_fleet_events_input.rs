...
pub fn ser_describe_fleet_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
