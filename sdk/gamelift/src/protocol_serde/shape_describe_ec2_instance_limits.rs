...
> {
    ...
    let mut generic_builder = crate::cbor_errors::parse_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_ec2_instance_limits::de_describe_ec2_instance_limits(_response_body, output)
            .map_err(crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError::unhandled)?;
...
pub fn ser_describe_ec2_instance_limits_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_describe_ec2_instance_limits_input::ser_describe_ec2_instance_limits_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "EC2InstanceLimits" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(
