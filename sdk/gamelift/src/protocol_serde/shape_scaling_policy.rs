                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ScalingStatusType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ScalingAdjustment" => {
                        ...
                        "ScalingAdjustmentType" => {
                            builder = builder.set_scaling_adjustment_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ScalingAdjustmentType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "ComparisonOperator" => {
                            builder = builder.set_comparison_operator(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ComparisonOperatorType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Threshold" => {
