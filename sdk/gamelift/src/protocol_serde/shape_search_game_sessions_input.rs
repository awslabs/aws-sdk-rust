...
pub fn ser_search_game_sessions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchGameSessionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
