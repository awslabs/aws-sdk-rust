...
> {
    ...
    Err(match error_code {
        ...
        "UnsupportedRegionException" => crate::operation::get_compute_auth_token::GetComputeAuthTokenError::UnsupportedRegionException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_compute_auth_token::de_get_compute_auth_token(_response_body, output)
            .map_err(crate::operation::get_compute_auth_token::GetComputeAuthTokenError::unhandled)?;
...
pub fn ser_get_compute_auth_token_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_get_compute_auth_token_input::ser_get_compute_auth_token_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            ...
            "AuthToken" => {
                ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| Ok(builder.set_auth_token(Some(decoder.string()?))))?
            }
            "ExpirationTimestamp" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_expiration_timestamp(Some(decoder.timestamp()?)))
            })?,
            _ => {
                decoder.skip()?;
                builder
