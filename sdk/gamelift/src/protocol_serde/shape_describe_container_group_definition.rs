...
pub fn de_describe_container_group_definition_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "InternalServiceException" => {
            crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::InternalServiceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "UnauthorizedException" => {
            crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedRegionException" => {
            crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::UnsupportedRegionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_container_group_definition_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_container_group_definition::builders::DescribeContainerGroupDefinitionOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_container_group_definition::de_describe_container_group_definition(_response_body, output)
            .map_err(crate::operation::describe_container_group_definition::DescribeContainerGroupDefinitionError::unhandled)?;
