    ...
    fn pair(
        ...
        builder = match decoder.str()?.as_ref() {
            ...
            "InstanceCounts" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_instance_counts(Some(crate::protocol_serde::shape_ec2_instance_counts::de_ec2_instance_counts(decoder)?)))
            })?,
            "Location" => {
            ...
            "GameServerContainerGroupCounts" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_game_server_container_group_counts(Some(
                    crate::protocol_serde::shape_game_server_container_group_counts::de_game_server_container_group_counts(decoder)?,
                )))
            })?,
