...
pub fn ser_describe_fleet_attributes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeFleetAttributesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
