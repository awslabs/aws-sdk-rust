...
/// When writing a match expression against `InstanceFleetType`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `instancefleettype` represents
...
/// version of SDK where the variant `InstanceFleetType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for InstanceFleetType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => InstanceFleetType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for InstanceFleetType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(InstanceFleetType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for InstanceFleetType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
