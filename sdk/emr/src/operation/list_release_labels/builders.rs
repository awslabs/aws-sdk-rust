...
impl ListReleaseLabelsFluentBuilder  {
    /// Creates a new `ListReleaseLabels`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_release_labels::ListReleaseLabelsOutput, aws_smithy_http::result::SdkError<crate::operation::list_release_labels::ListReleaseLabelsError>>
                     {
