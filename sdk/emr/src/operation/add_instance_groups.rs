...
impl AddInstanceGroupsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_instance_groups::AddInstanceGroups::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddInstanceGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_add_instance_groups::de_add_instance_groups_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_instance_groups::AddInstanceGroupsError
{
