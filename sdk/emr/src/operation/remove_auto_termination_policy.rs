...
impl RemoveAutoTerminationPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_auto_termination_policy::RemoveAutoTerminationPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_auto_termination_policy::RemoveAutoTerminationPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveAutoTerminationPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_auto_termination_policy::de_remove_auto_termination_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
