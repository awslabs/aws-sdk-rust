...
impl DescribeNotebookExecutionInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_notebook_execution::DescribeNotebookExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotebookExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_notebook_execution::de_describe_notebook_execution_http_response_with_props(status, headers, body)
        }
    }
}
