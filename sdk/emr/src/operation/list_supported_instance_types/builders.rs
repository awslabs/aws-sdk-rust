...
impl ListSupportedInstanceTypesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_supported_instance_types::ListSupportedInstanceTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_supported_instance_types::ListSupportedInstanceTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_supported_instance_types::ListSupportedInstanceTypesOutput, crate::operation::list_supported_instance_types::ListSupportedInstanceTypesError, Self> {
