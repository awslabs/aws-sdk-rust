...
impl DeleteStudioSessionMappingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_studio_session_mapping::DeleteStudioSessionMapping::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStudioSessionMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_studio_session_mapping::de_delete_studio_session_mapping_http_response_with_props(
                status, headers, body,
            )
        }
    }
