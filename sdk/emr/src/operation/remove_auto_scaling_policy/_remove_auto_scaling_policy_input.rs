...
impl RemoveAutoScalingPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_auto_scaling_policy::RemoveAutoScalingPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
