...
impl GetManagedScalingPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_managed_scaling_policy::GetManagedScalingPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
