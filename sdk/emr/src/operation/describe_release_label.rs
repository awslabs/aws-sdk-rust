...
impl DescribeReleaseLabelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_release_label::ser_describe_release_label_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_release_label::DescribeReleaseLabel::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_release_label::DescribeReleaseLabelError
{
