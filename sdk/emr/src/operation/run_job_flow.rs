...
impl RunJobFlow {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EMR", "RunJobFlow", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EMR.RunJobFlow",
                "rpc.service" = "EMR",
                "rpc.method" = "RunJobFlow",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RunJobFlow {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("RunJobFlow", "EMR"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RunJobFlowResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_run_job_flow::de_run_job_flow_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_run_job_flow::de_run_job_flow_http_response(status, headers, body, _cfg)
        };
