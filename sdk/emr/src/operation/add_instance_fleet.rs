...
impl AddInstanceFleetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_instance_fleet::ser_add_instance_fleet_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddInstanceFleet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_instance_fleet::de_add_instance_fleet_http_response_with_props(status, headers, body)
        }
    }
}
