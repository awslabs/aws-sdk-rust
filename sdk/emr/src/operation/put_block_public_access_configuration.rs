...
impl PutBlockPublicAccessConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_block_public_access_configuration::PutBlockPublicAccessConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBlockPublicAccessConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_block_public_access_configuration::de_put_block_public_access_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
