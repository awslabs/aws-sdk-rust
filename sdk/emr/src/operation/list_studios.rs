...
impl ListStudiosInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_studios::ser_list_studios_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_studios::ListStudios::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListStudios", "emr"));
