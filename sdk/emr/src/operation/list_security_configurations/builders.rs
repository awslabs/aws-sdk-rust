...
impl ListSecurityConfigurationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_security_configurations::ListSecurityConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_security_configurations::ListSecurityConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_security_configurations::ListSecurityConfigurationsOutput, crate::operation::list_security_configurations::ListSecurityConfigurationsError, Self> {
