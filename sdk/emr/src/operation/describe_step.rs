...
impl DescribeStepInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_step::DescribeStep, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_step::ser_describe_step_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStep {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_step::de_describe_step_http_response_with_props(status, headers, body)
        }
    }
}
