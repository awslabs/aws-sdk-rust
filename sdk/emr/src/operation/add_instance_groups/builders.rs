...
impl AddInstanceGroupsFluentBuilder  {
    /// Creates a new `AddInstanceGroups`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::add_instance_groups::AddInstanceGroupsOutput, aws_smithy_http::result::SdkError<crate::operation::add_instance_groups::AddInstanceGroupsError>>
                     {
