...
/// Orchestration and serialization glue logic for `StartNotebookExecution`.
...
impl StartNotebookExecution {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_notebook_execution::StartNotebookExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_notebook_execution::StartNotebookExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_notebook_execution::StartNotebookExecutionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_notebook_execution::StartNotebookExecutionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartNotebookExecution {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartNotebookExecution");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartNotebookExecutionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartNotebookExecutionResponseDeserializer));
...
.with_interceptor(StartNotebookExecutionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_notebook_execution::StartNotebookExecutionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_notebook_execution::StartNotebookExecutionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_notebook_execution::StartNotebookExecutionError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_notebook_execution::de_start_notebook_execution_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_notebook_execution::de_start_notebook_execution_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartNotebookExecutionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartNotebookExecutionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_notebook_execution::StartNotebookExecutionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_notebook_execution::StartNotebookExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_notebook_execution::ser_start_notebook_execution_input(&input)?);
...
#[derive(Debug)]
            struct StartNotebookExecutionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartNotebookExecutionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartNotebookExecutionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartNotebookExecutionInput>()
                        .ok_or("failed to downcast to StartNotebookExecutionInput")?;
...
pub enum StartNotebookExecutionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartNotebookExecutionError) for what information is available for the error.")]
...
impl StartNotebookExecutionError {
    /// Creates the `StartNotebookExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartNotebookExecutionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartNotebookExecutionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_notebook_execution::StartNotebookExecutionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::start_notebook_execution::_start_notebook_execution_output::StartNotebookExecutionOutput;

pub use crate::operation::start_notebook_execution::_start_notebook_execution_input::StartNotebookExecutionInput;

mod _start_notebook_execution_input;

mod _start_notebook_execution_output;
