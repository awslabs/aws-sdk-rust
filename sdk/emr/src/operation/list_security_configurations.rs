...
impl ListSecurityConfigurationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_security_configurations::ListSecurityConfigurations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSecurityConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_security_configurations::de_list_security_configurations_http_response_with_props(status, headers, body)
        }
    }
}
