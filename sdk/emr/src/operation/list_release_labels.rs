...
impl ListReleaseLabelsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_release_labels::ListReleaseLabels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReleaseLabels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_release_labels::de_list_release_labels_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_release_labels::ListReleaseLabelsError
{
