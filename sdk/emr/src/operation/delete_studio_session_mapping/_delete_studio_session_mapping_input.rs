...
impl DeleteStudioSessionMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_studio_session_mapping::DeleteStudioSessionMappingInput, ::aws_smithy_types::error::operation::BuildError> {
