...
impl PutAutoTerminationPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_auto_termination_policy::PutAutoTerminationPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAutoTerminationPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_auto_termination_policy::de_put_auto_termination_policy_http_response_with_props(status, headers, body)
        }
    }
}
