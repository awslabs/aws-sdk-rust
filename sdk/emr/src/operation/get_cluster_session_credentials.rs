...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterSessionCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cluster_session_credentials::de_get_cluster_session_credentials_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetClusterSessionCredentialsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_cluster_session_credentials::GetClusterSessionCredentialsError
{
