...
impl GetClusterSessionCredentialsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cluster_session_credentials::GetClusterSessionCredentials::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterSessionCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cluster_session_credentials::de_get_cluster_session_credentials_http_response_with_props(
                status, headers, body,
            )
        }
    }
