...
impl UpdateStudioSessionMappingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_studio_session_mapping::UpdateStudioSessionMapping::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStudioSessionMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_studio_session_mapping::de_update_studio_session_mapping_http_response_with_props(
                status, headers, body,
            )
        }
    }
