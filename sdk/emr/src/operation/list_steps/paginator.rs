...
/// Paginator for [`ListSteps`](crate::operation::list_steps::ListSteps)
                ...
                impl ListStepsPaginator {
                    ...
                    pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::operation::list_steps::ListStepsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_steps::ListStepsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
...
/// Flattened paginator for `ListStepsPaginator`
                    ...
                    impl ListStepsPaginatorItems {
                        ...
                        pub fn send(self) -> ::aws_smithy_async::future::pagination_stream::PaginationStream<::std::result::Result<crate::types::StepSummary, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_steps::ListStepsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>>> {
                            ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_steps_output_output_steps(page).unwrap_or_default().into_iter())
                        }
                    }
