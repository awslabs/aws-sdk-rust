...
/// Paginator for [`ListSteps`](crate::operation::list_steps::ListSteps)
            ...
            impl ListStepsPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_steps::ListStepsOutput, aws_smithy_http::result::SdkError<crate::operation::list_steps::ListStepsError>>> + Unpin
                 {
...
/// Flattened paginator for `ListStepsPaginator`
                ...
                impl  ListStepsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::StepSummary, aws_smithy_http::result::SdkError<crate::operation::list_steps::ListStepsError>>> + Unpin
                     {
