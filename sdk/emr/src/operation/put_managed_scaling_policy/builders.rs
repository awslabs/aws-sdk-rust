...
impl PutManagedScalingPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_managed_scaling_policy::PutManagedScalingPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_managed_scaling_policy::PutManagedScalingPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_managed_scaling_policy::PutManagedScalingPolicyOutput, crate::operation::put_managed_scaling_policy::PutManagedScalingPolicyError, Self> {
