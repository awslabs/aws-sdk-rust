...
impl ListInstanceFleetsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_instance_fleets::paginator::ListInstanceFleetsPaginator {
        crate::operation::list_instance_fleets::paginator::ListInstanceFleetsPaginator::new(
            self.handle,
            self.inner,
        )
    }
