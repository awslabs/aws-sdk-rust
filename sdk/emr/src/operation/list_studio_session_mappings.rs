...
impl ListStudioSessionMappingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_studio_session_mappings::ListStudioSessionMappings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStudioSessionMappings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_studio_session_mappings::de_list_studio_session_mappings_http_response_with_props(status, headers, body)
        }
    }
}
