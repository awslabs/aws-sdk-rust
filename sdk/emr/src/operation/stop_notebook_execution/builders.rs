...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::stop_notebook_execution::StopNotebookExecutionOutput,
                    crate::operation::stop_notebook_execution::StopNotebookExecutionError,
                > for StopNotebookExecutionFluentBuilder
            {
                fn send(
                    self,
...
impl StopNotebookExecutionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::stop_notebook_execution::StopNotebookExecutionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::stop_notebook_execution::StopNotebookExecutionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::stop_notebook_execution::StopNotebookExecution::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::stop_notebook_execution::StopNotebookExecution::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::stop_notebook_execution::StopNotebookExecutionOutput, crate::operation::stop_notebook_execution::StopNotebookExecutionError, Self> {
