...
impl SetUnhealthyNodeReplacementFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_unhealthy_node_replacement::SetUnhealthyNodeReplacementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_unhealthy_node_replacement::SetUnhealthyNodeReplacementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_unhealthy_node_replacement::SetUnhealthyNodeReplacementOutput, crate::operation::set_unhealthy_node_replacement::SetUnhealthyNodeReplacementError, Self> {
