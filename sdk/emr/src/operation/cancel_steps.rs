...
impl CancelStepsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_steps::CancelSteps, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_steps::ser_cancel_steps_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelSteps {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_steps::de_cancel_steps_http_response_with_props(status, headers, body)
        }
    }
}
