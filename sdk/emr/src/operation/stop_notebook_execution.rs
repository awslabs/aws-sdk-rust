...
impl StopNotebookExecutionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::stop_notebook_execution::StopNotebookExecution,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopNotebookExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_notebook_execution::de_stop_notebook_execution_http_response_with_props(status, headers, body)
        }
    }
}
