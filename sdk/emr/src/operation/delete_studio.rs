...
impl DeleteStudioInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_studio::DeleteStudio, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_studio::ser_delete_studio_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStudio {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_studio::de_delete_studio_http_response_with_props(status, headers, body)
        }
    }
}
