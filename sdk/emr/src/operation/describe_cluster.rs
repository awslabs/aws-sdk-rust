...
impl DescribeClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_cluster::DescribeCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_cluster::ser_describe_cluster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster::de_describe_cluster_http_response_with_props(status, headers, body)
        }
    }
}
