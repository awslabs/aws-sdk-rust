...
impl CreateStudioSessionMappingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_studio_session_mapping::CreateStudioSessionMapping::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStudioSessionMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_studio_session_mapping::de_create_studio_session_mapping_http_response_with_props(
                status, headers, body,
            )
        }
    }
