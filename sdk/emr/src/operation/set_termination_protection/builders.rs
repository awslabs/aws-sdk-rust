...
impl SetTerminationProtectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_termination_protection::SetTerminationProtectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_termination_protection::SetTerminationProtectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_termination_protection::SetTerminationProtectionOutput, crate::operation::set_termination_protection::SetTerminationProtectionError, Self> {
