...
impl DescribeStudioFluentBuilder  {
    /// Creates a new `DescribeStudio`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_studio::DescribeStudioOutput, aws_smithy_http::result::SdkError<crate::operation::describe_studio::DescribeStudioError>>
                     {
