...
impl CreateStudioSessionMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_studio_session_mapping::CreateStudioSessionMappingInput, ::aws_smithy_types::error::operation::BuildError> {
