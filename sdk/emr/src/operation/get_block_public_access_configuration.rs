...
impl GetBlockPublicAccessConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlockPublicAccessConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_block_public_access_configuration::de_get_block_public_access_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
