...
impl super::Client {
    ...
    ///   - [`studio_id(impl Into<String>)`](crate::operation::describe_studio::builders::DescribeStudioFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::describe_studio::builders::DescribeStudioFluentBuilder::set_studio_id):<br>required: **true**<br><p>The Amazon EMR Studio ID.</p><br>
