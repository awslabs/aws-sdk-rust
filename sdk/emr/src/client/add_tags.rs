...
impl super::Client {
    ...
    ///   - [`cluster_id(impl Into<String>)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::add_tags::builders::AddTagsFluentBuilder::set_cluster_id):<br>required: **false**<br><p>The ID of the cluster that scopes the tag operation. Required when the resource being tagged is a session-scoped resource.</p><br>
