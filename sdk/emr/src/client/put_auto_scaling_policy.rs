...
impl super::Client {
    ...
    ///   - [`instance_group_id(impl Into<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::instance_group_id) / [`set_instance_group_id(Option<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::set_instance_group_id):<br>required: **true**<br><p>Specifies the ID of the instance group to which the automatic scaling policy is applied.</p><br>
    ///   - [`auto_scaling_policy(AutoScalingPolicy)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::auto_scaling_policy) / [`set_auto_scaling_policy(Option<AutoScalingPolicy>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::set_auto_scaling_policy):<br>required: **true**<br><p>Specifies the definition of the automatic scaling policy.</p><br>
