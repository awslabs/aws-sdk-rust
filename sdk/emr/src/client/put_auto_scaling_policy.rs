...
impl super::Client {
    ...
    ///   - [`cluster_id(impl ::std::convert::Into<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::set_cluster_id): <p>Specifies the ID of a cluster. The instance group to which the automatic scaling policy is applied is within this cluster.</p>
    ///   - [`instance_group_id(impl ::std::convert::Into<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::instance_group_id) / [`set_instance_group_id(Option<String>)`](crate::operation::put_auto_scaling_policy::builders::PutAutoScalingPolicyFluentBuilder::set_instance_group_id): <p>Specifies the ID of the instance group to which the automatic scaling policy is applied.</p>
