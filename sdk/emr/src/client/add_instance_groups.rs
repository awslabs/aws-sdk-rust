...
impl super::Client {
    ...
    ///   - [`instance_groups(InstanceGroupConfig)`](crate::operation::add_instance_groups::builders::AddInstanceGroupsFluentBuilder::instance_groups) / [`set_instance_groups(Option<Vec<InstanceGroupConfig>>)`](crate::operation::add_instance_groups::builders::AddInstanceGroupsFluentBuilder::set_instance_groups): <p>Instance groups to add.</p>
