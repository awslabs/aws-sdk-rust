...
impl super::Client {
    ...
    ///   - [`cluster_id(impl ::std::convert::Into<String>)`](crate::operation::get_cluster_session_credentials::builders::GetClusterSessionCredentialsFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::get_cluster_session_credentials::builders::GetClusterSessionCredentialsFluentBuilder::set_cluster_id): <p>The unique identifier of the cluster.</p>
    ///   - [`execution_role_arn(impl ::std::convert::Into<String>)`](crate::operation::get_cluster_session_credentials::builders::GetClusterSessionCredentialsFluentBuilder::execution_role_arn) / [`set_execution_role_arn(Option<String>)`](crate::operation::get_cluster_session_credentials::builders::GetClusterSessionCredentialsFluentBuilder::set_execution_role_arn): <p>The Amazon Resource Name (ARN) of the runtime role for interactive workload submission on the cluster. The runtime role can be a cross-account IAM role. The runtime role ARN is a combination of account ID, role name, and role type using the following format: <code>arn:partition:service:region:account:resource</code>.</p>
