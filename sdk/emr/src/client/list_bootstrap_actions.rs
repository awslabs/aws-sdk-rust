...
impl super::Client {
    ...
    ///   - [`cluster_id(impl ::std::convert::Into<String>)`](crate::operation::list_bootstrap_actions::builders::ListBootstrapActionsFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::list_bootstrap_actions::builders::ListBootstrapActionsFluentBuilder::set_cluster_id): <p>The cluster identifier for the bootstrap actions to list.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_bootstrap_actions::builders::ListBootstrapActionsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_bootstrap_actions::builders::ListBootstrapActionsFluentBuilder::set_marker): <p>The pagination token that indicates the next set of results to retrieve.</p>
