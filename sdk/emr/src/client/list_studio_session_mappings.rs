...
impl super::Client {
    ...
    ///   - [`studio_id(impl ::std::convert::Into<String>)`](crate::operation::list_studio_session_mappings::builders::ListStudioSessionMappingsFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::list_studio_session_mappings::builders::ListStudioSessionMappingsFluentBuilder::set_studio_id): <p>The ID of the Amazon EMR Studio.</p>
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_studio_session_mappings::builders::ListStudioSessionMappingsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_studio_session_mappings::builders::ListStudioSessionMappingsFluentBuilder::set_marker): <p>The pagination token that indicates the set of results to retrieve.</p>
