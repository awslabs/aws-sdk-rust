...
impl super::Client  {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_security_configuration::builders::DeleteSecurityConfigurationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_security_configuration::builders::DeleteSecurityConfigurationFluentBuilder::set_name): <p>The name of the security configuration.</p>
