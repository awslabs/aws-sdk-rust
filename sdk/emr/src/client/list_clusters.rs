...
impl super::Client {
    ...
    ///   - [`cluster_states(ClusterState)`](crate::operation::list_clusters::builders::ListClustersFluentBuilder::cluster_states) / [`set_cluster_states(Option<Vec::<ClusterState>>)`](crate::operation::list_clusters::builders::ListClustersFluentBuilder::set_cluster_states):<br>required: **false**<br><p>The cluster state filters to apply when listing clusters. Clusters that change state while this action runs may be not be returned as expected in the list of clusters.</p><br>
    ///   - [`marker(impl Into<String>)`](crate::operation::list_clusters::builders::ListClustersFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_clusters::builders::ListClustersFluentBuilder::set_marker):<br>required: **false**<br><p>The pagination token that indicates the next set of results to retrieve.</p><br>
