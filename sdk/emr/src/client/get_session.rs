...
impl super::Client {
    ...
    ///   - [`cluster_id(impl Into<String>)`](crate::operation::get_session::builders::GetSessionFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::get_session::builders::GetSessionFluentBuilder::set_cluster_id):<br>required: **true**<br><p>The ID of the cluster that the session belongs to.</p><br>
