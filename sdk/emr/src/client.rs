...
pub trait Waiters {
    ...
    fn wait_until_cluster_running(&self) -> crate::waiters::cluster_running::ClusterRunningFluentBuilder;
    /// Wait for `cluster_terminated`
    fn wait_until_cluster_terminated(&self) -> crate::waiters::cluster_terminated::ClusterTerminatedFluentBuilder;
    /// Wait for `step_complete`
    fn wait_until_step_complete(&self) -> crate::waiters::step_complete::StepCompleteFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_cluster_running(&self) -> crate::waiters::cluster_running::ClusterRunningFluentBuilder {
        crate::waiters::cluster_running::ClusterRunningFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_cluster_terminated(&self) -> crate::waiters::cluster_terminated::ClusterTerminatedFluentBuilder {
        crate::waiters::cluster_terminated::ClusterTerminatedFluentBuilder::new(self.handle.clone())
    }
    fn wait_until_step_complete(&self) -> crate::waiters::step_complete::StepCompleteFluentBuilder {
        crate::waiters::step_complete::StepCompleteFluentBuilder::new(self.handle.clone())
    }
}
