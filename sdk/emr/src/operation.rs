...
impl aws_smithy_http::response::ParseStrictResponse for AddJobFlowSteps {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_add_job_flow_steps::de_add_job_flow_steps_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_add_job_flow_steps::de_add_job_flow_steps_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeJobFlows {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_job_flows::de_describe_job_flows_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_describe_job_flows::de_describe_job_flows_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListInstanceFleets {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_instance_fleets::de_list_instance_fleets_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_instance_fleets::de_list_instance_fleets_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ListInstanceGroups {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_instance_groups::de_list_instance_groups_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_instance_groups::de_list_instance_groups_http_response(
                response,
            )
        }
    }
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyInstanceFleet {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_modify_instance_fleet::de_modify_instance_fleet_http_error(
                response,
            )
        } else {
...
impl aws_smithy_http::response::ParseStrictResponse for TerminateJobFlows {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_terminate_job_flows::de_terminate_job_flows_http_error(
                response,
            )
        } else {
