...
pub struct ExecutionEngineConfig  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ExecutionEngineType>,
    ...
    #[doc(hidden)]pub master_instance_security_group_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ExecutionEngineConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("master_instance_security_group_id", &self.master_instance_security_group_id);
        formatter.finish()
    }
}
...
pub struct AutoTerminationPolicy  {
    ...
    #[doc(hidden)]pub idle_timeout: i64,
}
...
pub struct PlacementGroupConfig  {
    ...
    #[doc(hidden)]pub instance_role: std::option::Option<crate::model::InstanceRoleType>,
    ...
    #[doc(hidden)]pub placement_strategy: std::option::Option<crate::model::PlacementGroupStrategy>,
}
...
pub struct ManagedScalingPolicy  {
    ...
    #[doc(hidden)]pub compute_limits: std::option::Option<crate::model::ComputeLimits>,
}
...
pub struct ComputeLimits  {
    ...
    #[doc(hidden)]pub unit_type: std::option::Option<crate::model::ComputeLimitsUnitType>,
    ...
    #[doc(hidden)]pub minimum_capacity_units: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub maximum_capacity_units: std::option::Option<i32>,
    /// <p> The upper boundary of On-Demand EC2 units. It is measured through vCPU cores or instances for instance groups and measured through units for instance fleets. The On-Demand units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between On-Demand and Spot Instances. </p>
    #[doc(hidden)]pub maximum_on_demand_capacity_units: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub maximum_core_capacity_units: std::option::Option<i32>,
}
impl ComputeLimits {
    /// <p> The unit type used for specifying a managed scaling policy. </p>
...
impl  std::fmt::Debug for ComputeLimits  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("maximum_on_demand_capacity_units", &self.maximum_on_demand_capacity_units);
        formatter.field("maximum_core_capacity_units", &self.maximum_core_capacity_units);
        formatter.finish()
    }
}
...
pub struct KerberosAttributes  {
    ...
    #[doc(hidden)]pub realm: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub kdc_admin_password: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub cross_realm_trust_principal_password: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ad_domain_join_user: std::option::Option<std::string::String>,
    /// <p>The Active Directory password for <code>ADDomainJoinUser</code>.</p>
    #[doc(hidden)]pub ad_domain_join_password: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for KerberosAttributes  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cross_realm_trust_principal_password", &self.cross_realm_trust_principal_password);
...
pub struct Application  {
    ...
    #[doc(hidden)]pub additional_info: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl Application {
    /// <p>The name of the application.</p>
...
pub struct BootstrapActionConfig  {
    ...
    #[doc(hidden)]pub script_bootstrap_action: std::option::Option<crate::model::ScriptBootstrapActionConfig>,
}
...
pub struct StepConfig  {
    ...
    #[doc(hidden)]pub action_on_failure: std::option::Option<crate::model::ActionOnFailure>,
    /// <p>The JAR file used for the step.</p>
    #[doc(hidden)]pub hadoop_jar_step: std::option::Option<crate::model::HadoopJarStepConfig>,
}
impl StepConfig {
    /// <p>The name of the step.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct HadoopJarStepConfig  {
    ...
    #[doc(hidden)]pub properties: std::option::Option<std::vec::Vec<crate::model::KeyValue>>,
    /// <p>A path to a JAR file run during the step.</p>
    #[doc(hidden)]pub jar: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub main_class: std::option::Option<std::string::String>,
...
pub struct JobFlowInstancesConfig  {
    ...
    #[doc(hidden)]pub master_instance_type: std::option::Option<std::string::String>,
    /// <p>The EC2 instance type of the core and task nodes.</p>
    #[doc(hidden)]pub slave_instance_type: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub instance_fleets: std::option::Option<std::vec::Vec<crate::model::InstanceFleetConfig>>,
    /// <p>The name of the EC2 key pair that can be used to connect to the master node using SSH as the user called "hadoop."</p>
    #[doc(hidden)]pub ec2_key_name: std::option::Option<std::string::String>,
    /// <p>The Availability Zone in which the cluster runs.</p>
    #[doc(hidden)]pub placement: std::option::Option<crate::model::PlacementType>,
    ...
    #[doc(hidden)]pub keep_job_flow_alive_when_no_steps: bool,
    ...
    #[doc(hidden)]pub hadoop_version: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ec2_subnet_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub emr_managed_master_security_group: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub emr_managed_slave_security_group: std::option::Option<std::string::String>,
    /// <p>The identifier of the Amazon EC2 security group for the Amazon EMR service to access clusters in VPC private subnets.</p>
    #[doc(hidden)]pub service_access_security_group: std::option::Option<std::string::String>,
    /// <p>A list of additional Amazon EC2 security group IDs for the master node.</p>
    #[doc(hidden)]pub additional_master_security_groups: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>A list of additional Amazon EC2 security group IDs for the core and task nodes.</p>
    #[doc(hidden)]pub additional_slave_security_groups: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for JobFlowInstancesConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("keep_job_flow_alive_when_no_steps", &self.keep_job_flow_alive_when_no_steps);
        ...
        formatter.field("emr_managed_master_security_group", &self.emr_managed_master_security_group);
        formatter.field("emr_managed_slave_security_group", &self.emr_managed_slave_security_group);
        formatter.field("service_access_security_group", &self.service_access_security_group);
        formatter.field("additional_master_security_groups", &self.additional_master_security_groups);
        formatter.field("additional_slave_security_groups", &self.additional_slave_security_groups);
        formatter.finish()
    }
}
...
pub struct InstanceFleetConfig  {
    ...
    /// </note>
    #[doc(hidden)]pub target_on_demand_capacity: std::option::Option<i32>,
    ...
    /// </note>
    #[doc(hidden)]pub target_spot_capacity: std::option::Option<i32>,
    /// <p>The instance type configurations that define the EC2 instances in the instance fleet.</p>
    #[doc(hidden)]pub instance_type_configs: std::option::Option<std::vec::Vec<crate::model::InstanceTypeConfig>>,
    /// <p>The launch specification for the instance fleet.</p>
    #[doc(hidden)]pub launch_specifications: std::option::Option<crate::model::InstanceFleetProvisioningSpecifications>,
}
...
pub struct InstanceFleetProvisioningSpecifications  {
    ...
    #[doc(hidden)]pub spot_specification: std::option::Option<crate::model::SpotProvisioningSpecification>,
    ...
    /// </note>
    #[doc(hidden)]pub on_demand_specification: std::option::Option<crate::model::OnDemandProvisioningSpecification>,
}
...
pub struct OnDemandProvisioningSpecification  {
    ...
    #[doc(hidden)]pub allocation_strategy: std::option::Option<crate::model::OnDemandProvisioningAllocationStrategy>,
    /// <p>The launch specification for On-Demand instances in the instance fleet, which determines the allocation strategy.</p>
    #[doc(hidden)]pub capacity_reservation_options: std::option::Option<crate::model::OnDemandCapacityReservationOptions>,
}
...
impl  std::fmt::Debug for OnDemandProvisioningSpecification  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("capacity_reservation_options", &self.capacity_reservation_options);
        formatter.finish()
    }
}
...
pub struct OnDemandCapacityReservationOptions  {
    ...
    #[doc(hidden)]pub usage_strategy: std::option::Option<crate::model::OnDemandCapacityReservationUsageStrategy>,
    ...
    /// </ul>
    #[doc(hidden)]pub capacity_reservation_preference: std::option::Option<crate::model::OnDemandCapacityReservationPreference>,
    /// <p>The ARN of the Capacity Reservation resource group in which to run the instance.</p>
    #[doc(hidden)]pub capacity_reservation_resource_group_arn: std::option::Option<std::string::String>,
}
...
pub struct SpotProvisioningSpecification  {
    ...
    #[doc(hidden)]pub timeout_duration_minutes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub timeout_action: std::option::Option<crate::model::SpotProvisioningTimeoutAction>,
    ...
    /// <p>Spot Instances with a defined duration (also known as Spot blocks) are no longer available to new customers from July 1, 2021. For customers who have previously used the feature, we will continue to support Spot Instances with a defined duration until December 31, 2022. </p> 
    /// </note>
    #[doc(hidden)]pub block_duration_minutes: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub allocation_strategy: std::option::Option<crate::model::SpotProvisioningAllocationStrategy>,
}
...
pub struct InstanceTypeConfig  {
    ...
    #[doc(hidden)]pub weighted_capacity: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub bid_price: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub bid_price_as_percentage_of_on_demand_price: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub ebs_configuration: std::option::Option<crate::model::EbsConfiguration>,
...
impl  std::fmt::Debug for InstanceTypeConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bid_price_as_percentage_of_on_demand_price", &self.bid_price_as_percentage_of_on_demand_price);
...
pub struct EbsConfiguration  {
    ...
    #[doc(hidden)]pub ebs_block_device_configs: std::option::Option<std::vec::Vec<crate::model::EbsBlockDeviceConfig>>,
...
pub struct EbsBlockDeviceConfig  {
    ...
    #[doc(hidden)]pub volume_specification: std::option::Option<crate::model::VolumeSpecification>,
    ...
    #[doc(hidden)]pub volumes_per_instance: std::option::Option<i32>,
}
...
pub struct VolumeSpecification  {
    ...
    #[doc(hidden)]pub size_in_gb: std::option::Option<i32>,
...
pub struct InstanceGroupConfig  {
    ...
    #[doc(hidden)]pub market: std::option::Option<crate::model::MarketType>,
...
pub struct AutoScalingPolicy  {
    ...
    #[doc(hidden)]pub constraints: std::option::Option<crate::model::ScalingConstraints>,
    /// <p>The scale-in and scale-out rules that comprise the automatic scaling policy.</p>
    #[doc(hidden)]pub rules: std::option::Option<std::vec::Vec<crate::model::ScalingRule>>,
}
...
pub struct ScalingRule  {
    ...
    #[doc(hidden)]pub action: std::option::Option<crate::model::ScalingAction>,
    /// <p>The CloudWatch alarm definition that determines when automatic scaling activity is triggered.</p>
    #[doc(hidden)]pub trigger: std::option::Option<crate::model::ScalingTrigger>,
}
impl ScalingRule {
    /// <p>The name used to identify an automatic scaling rule. Rule names must be unique within a scaling policy.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ScalingTrigger  {
    ...
    #[doc(hidden)]pub cloud_watch_alarm_definition: std::option::Option<crate::model::CloudWatchAlarmDefinition>,
}
impl ScalingTrigger {
    /// <p>The definition of a CloudWatch metric alarm. When the defined alarm conditions are met along with other trigger parameters, scaling activity begins.</p>
...
impl  std::fmt::Debug for ScalingTrigger  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("cloud_watch_alarm_definition", &self.cloud_watch_alarm_definition);
        formatter.finish()
    }
}
...
pub struct ScalingAction  {
    ...
    #[doc(hidden)]pub market: std::option::Option<crate::model::MarketType>,
    /// <p>The type of adjustment the automatic scaling activity makes when triggered, and the periodicity of the adjustment.</p>
    #[doc(hidden)]pub simple_scaling_policy_configuration: std::option::Option<crate::model::SimpleScalingPolicyConfiguration>,
}
impl ScalingAction {
    /// <p>Not available for instance groups. Instance groups use the market type specified for the group.</p>
    pub fn market(&self) -> std::option::Option<& crate::model::MarketType> {
...
impl  std::fmt::Debug for ScalingAction  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("market", &self.market);
        formatter.field("simple_scaling_policy_configuration", &self.simple_scaling_policy_configuration);
        formatter.finish()
    }
}
...
pub struct SimpleScalingPolicyConfiguration  {
    ...
    #[doc(hidden)]pub cool_down: std::option::Option<i32>,
}
...
pub struct BlockPublicAccessConfiguration  {
    ...
    #[doc(hidden)]pub block_public_security_group_rules: bool,
    ...
    #[doc(hidden)]pub permitted_public_security_group_rule_ranges: std::option::Option<std::vec::Vec<crate::model::PortRange>>,
    /// <p>The classification within a configuration.</p>
    #[doc(hidden)]pub classification: std::option::Option<std::string::String>,
    /// <p>A list of additional configurations to apply within a configuration object.</p>
    #[doc(hidden)]pub configurations: std::option::Option<std::vec::Vec<crate::model::Configuration>>,
...
impl  std::fmt::Debug for BlockPublicAccessConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("block_public_security_group_rules", &self.block_public_security_group_rules);
        formatter.field("permitted_public_security_group_rule_ranges", &self.permitted_public_security_group_rule_ranges);
        formatter.field("classification", &self.classification);
        formatter.field("configurations", &self.configurations);
        formatter.field("properties", &self.properties);
        formatter.finish()
...
pub struct PortRange  {
    ...
    #[doc(hidden)]pub min_range: std::option::Option<i32>,
    /// <p>The smallest port number in a specified range of port numbers.</p>
    #[doc(hidden)]pub max_range: std::option::Option<i32>,
}
impl PortRange {
    /// <p>The smallest port number in a specified range of port numbers.</p>
...
pub struct AutoScalingPolicyDescription  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AutoScalingPolicyStatus>,
    /// <p>The upper and lower EC2 instance limits for an automatic scaling policy. Automatic scaling activity will not cause an instance group to grow above or below these limits.</p>
    #[doc(hidden)]pub constraints: std::option::Option<crate::model::ScalingConstraints>,
    /// <p>The scale-in and scale-out rules that comprise the automatic scaling policy.</p>
    #[doc(hidden)]pub rules: std::option::Option<std::vec::Vec<crate::model::ScalingRule>>,
...
pub struct AutoScalingPolicyStatus  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::AutoScalingPolicyState>,
    /// <p>The reason for a change in status.</p>
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::AutoScalingPolicyStateChangeReason>,
}
...
pub struct AutoScalingPolicyStateChangeReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::AutoScalingPolicyStateChangeReasonCode>,
...
pub struct InstanceGroupModifyConfig  {
    ...
    #[doc(hidden)]pub ec2_instance_ids_to_terminate: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Policy for customizing shrink operations.</p>
    #[doc(hidden)]pub shrink_policy: std::option::Option<crate::model::ShrinkPolicy>,
    /// <p>Type of reconfiguration requested. Valid values are MERGE and OVERWRITE.</p>
    #[doc(hidden)]pub reconfiguration_type: std::option::Option<crate::model::ReconfigurationType>,
...
impl  std::fmt::Debug for InstanceGroupModifyConfig  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("instance_count", &self.instance_count);
        formatter.field("ec2_instance_ids_to_terminate", &self.ec2_instance_ids_to_terminate);
...
pub struct ShrinkPolicy  {
    ...
    #[doc(hidden)]pub decommission_timeout: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub instance_resize_policy: std::option::Option<crate::model::InstanceResizePolicy>,
}
impl ShrinkPolicy {
    /// <p>The desired timeout for decommissioning an instance. Overrides the default YARN decommissioning timeout.</p>
...
pub struct InstanceResizePolicy  {
    ...
    #[doc(hidden)]pub instances_to_terminate: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Specific list of instances to be protected when shrinking an instance group.</p>
    #[doc(hidden)]pub instances_to_protect: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Decommissioning timeout override for the specific list of instances to be terminated.</p>
    #[doc(hidden)]pub instance_termination_timeout: std::option::Option<i32>,
}
...
impl  std::fmt::Debug for InstanceResizePolicy  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("instance_termination_timeout", &self.instance_termination_timeout);
        formatter.finish()
    }
}
...
pub struct StepSummary  {
    ...
    #[doc(hidden)]pub config: std::option::Option<crate::model::HadoopStepConfig>,
...
pub struct StepStatus  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::StepState>,
    /// <p>The reason for the step execution status change.</p>
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::StepStateChangeReason>,
    ...
    #[doc(hidden)]pub timeline: std::option::Option<crate::model::StepTimeline>,
}
impl StepStatus {
    /// <p>The execution state of the cluster step.</p>
...
pub struct FailureDetails  {
    ...
    #[doc(hidden)]pub log_file: std::option::Option<std::string::String>,
}
impl FailureDetails {
    /// <p>The reason for the step failure. In the case where the service cannot successfully determine the root cause of the failure, it returns "Unknown Error" as a reason.</p>
...
pub struct StepStateChangeReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::StepStateChangeReasonCode>,
...
pub struct Instance  {
    ...
    #[doc(hidden)]pub ebs_volumes: std::option::Option<std::vec::Vec<crate::model::EbsVolume>>,
}
impl Instance {
    /// <p>The unique identifier for the instance in Amazon EMR.</p>
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct InstanceStatus  {
    ...
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::InstanceStateChangeReason>,
    /// <p>The timeline of the instance status over time.</p>
    #[doc(hidden)]pub timeline: std::option::Option<crate::model::InstanceTimeline>,
}
impl InstanceStatus {
    /// <p>The current state of the instance.</p>
...
pub struct InstanceTimeline  {
    ...
    #[doc(hidden)]pub ready_date_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct InstanceStateChangeReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::InstanceStateChangeReasonCode>,
...
pub struct InstanceGroup  {
    ...
    #[doc(hidden)]pub instance_group_type: std::option::Option<crate::model::InstanceGroupType>,
    /// <p>If specified, indicates that the instance group uses Spot Instances. This is the maximum price you are willing to pay for Spot Instances. Specify <code>OnDemandPrice</code> to set the amount equal to the On-Demand price, or specify an amount in USD.</p>
    #[doc(hidden)]pub bid_price: std::option::Option<std::string::String>,
    /// <p>The EC2 instance type for all instances in the instance group.</p>
    #[doc(hidden)]pub instance_type: std::option::Option<std::string::String>,
    /// <p>The target number of instances for the instance group.</p>
    #[doc(hidden)]pub requested_instance_count: std::option::Option<i32>,
    /// <p>The number of instances currently running in this instance group.</p>
    #[doc(hidden)]pub running_instance_count: std::option::Option<i32>,
    /// <p>The current status of the instance group.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::InstanceGroupStatus>,
    /// <note> 
    /// <p>Amazon EMR releases 4.x or later.</p> 
    /// </note> 
    ...
    #[doc(hidden)]pub configurations_version: i64,
    /// <p>A list of configurations that were successfully applied for an instance group last time.</p>
    #[doc(hidden)]pub last_successfully_applied_configurations: std::option::Option<std::vec::Vec<crate::model::Configuration>>,
    /// <p>The version number of a configuration specification that was successfully applied for an instance group last time. </p>
    #[doc(hidden)]pub last_successfully_applied_configurations_version: i64,
    /// <p>The EBS block devices that are mapped to this instance group.</p>
    #[doc(hidden)]pub ebs_block_devices: std::option::Option<std::vec::Vec<crate::model::EbsBlockDevice>>,
...
impl  std::fmt::Debug for InstanceGroup  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_successfully_applied_configurations", &self.last_successfully_applied_configurations);
        formatter.field("last_successfully_applied_configurations_version", &self.last_successfully_applied_configurations_version);
...
pub struct InstanceGroupStatus  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::InstanceGroupState>,
    /// <p>The status change reason details for the instance group.</p>
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::InstanceGroupStateChangeReason>,
    /// <p>The timeline of the instance group status over time.</p>
    #[doc(hidden)]pub timeline: std::option::Option<crate::model::InstanceGroupTimeline>,
}
...
pub struct InstanceGroupStateChangeReason  {
    /// <p>The programmable code for the state change reason.</p>
    #[doc(hidden)]pub code: std::option::Option<crate::model::InstanceGroupStateChangeReasonCode>,
    /// <p>The status change reason description.</p>
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
}
...
pub struct InstanceFleet  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::InstanceFleetStatus>,
    ...
    #[doc(hidden)]pub provisioned_on_demand_capacity: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub provisioned_spot_capacity: std::option::Option<i32>,
    /// <p>An array of specifications for the instance types that comprise an instance fleet.</p>
    #[doc(hidden)]pub instance_type_specifications: std::option::Option<std::vec::Vec<crate::model::InstanceTypeSpecification>>,
...
impl  std::fmt::Debug for InstanceFleet  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("target_on_demand_capacity", &self.target_on_demand_capacity);
        formatter.field("target_spot_capacity", &self.target_spot_capacity);
        formatter.field("provisioned_on_demand_capacity", &self.provisioned_on_demand_capacity);
        formatter.field("provisioned_spot_capacity", &self.provisioned_spot_capacity);
        formatter.field("instance_type_specifications", &self.instance_type_specifications);
        formatter.field("launch_specifications", &self.launch_specifications);
        formatter.finish()
    }
}
...
pub struct InstanceFleetStatus  {
    ...
    /// </ul>
    #[doc(hidden)]pub state: std::option::Option<crate::model::InstanceFleetState>,
    /// <p>Provides status change reason details for the instance fleet.</p>
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::InstanceFleetStateChangeReason>,
    ...
    #[doc(hidden)]pub timeline: std::option::Option<crate::model::InstanceFleetTimeline>,
}
...
pub struct InstanceFleetStateChangeReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::InstanceFleetStateChangeReasonCode>,
...
pub struct ClusterSummary  {
    ...
    #[doc(hidden)]pub normalized_instance_hours: std::option::Option<i32>,
...
pub struct ClusterStatus  {
    ...
    #[doc(hidden)]pub state_change_reason: std::option::Option<crate::model::ClusterStateChangeReason>,
    /// <p>A timeline that represents the status of a cluster over the lifetime of the cluster.</p>
    #[doc(hidden)]pub timeline: std::option::Option<crate::model::ClusterTimeline>,
}
impl ClusterStatus {
    /// <p>The current state of the cluster.</p>
...
pub struct ClusterStateChangeReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::ClusterStateChangeReasonCode>,
    /// <p>The descriptive message for the state change reason.</p>
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
}
...
pub struct Command  {
    ...
    #[doc(hidden)]pub script_path: std::option::Option<std::string::String>,
...
pub struct BlockPublicAccessConfigurationMetadata  {
    ...
    #[doc(hidden)]pub created_by_arn: std::option::Option<std::string::String>,
}
...
pub struct Studio  {
    ...
    #[doc(hidden)]pub studio_arn: std::option::Option<std::string::String>,
    /// <p>The name of the Amazon EMR Studio.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The detailed description of the Amazon EMR Studio.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
...
pub struct NotebookExecution  {
    ...
    #[doc(hidden)]pub output_notebook_uri: std::option::Option<std::string::String>,
    /// <p>The reason for the latest status change of the notebook execution.</p>
    #[doc(hidden)]pub last_state_change_reason: std::option::Option<std::string::String>,
...
pub struct JobFlowDetail  {
    ...
    #[doc(hidden)]pub execution_status_detail: std::option::Option<crate::model::JobFlowExecutionStatusDetail>,
    /// <p>Describes the Amazon EC2 instances of the job flow.</p>
    #[doc(hidden)]pub instances: std::option::Option<crate::model::JobFlowInstancesDetail>,
    /// <p>A list of steps run by the job flow.</p>
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::StepDetail>>,
    /// <p>A list of the bootstrap actions run by the job flow.</p>
    #[doc(hidden)]pub bootstrap_actions: std::option::Option<std::vec::Vec<crate::model::BootstrapActionDetail>>,
...
pub struct BootstrapActionDetail  {
    ...
    #[doc(hidden)]pub bootstrap_action_config: std::option::Option<crate::model::BootstrapActionConfig>,
}
...
pub struct StepDetail  {
    ...
    #[doc(hidden)]pub step_config: std::option::Option<crate::model::StepConfig>,
    /// <p>The description of the step status.</p>
    #[doc(hidden)]pub execution_status_detail: std::option::Option<crate::model::StepExecutionStatusDetail>,
}
impl StepDetail {
    /// <p>The step configuration.</p>
...
pub struct StepExecutionStatusDetail  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::StepExecutionState>,
...
pub struct JobFlowInstancesDetail  {
    ...
    #[doc(hidden)]pub master_public_dns_name: std::option::Option<std::string::String>,
    /// <p>The Amazon EC2 instance identifier of the master node.</p>
    #[doc(hidden)]pub master_instance_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub instance_groups: std::option::Option<std::vec::Vec<crate::model::InstanceGroupDetail>>,
...
pub struct InstanceGroupDetail  {
    ...
    #[doc(hidden)]pub instance_request_count: std::option::Option<i32>,
    /// <p>Actual count of running instances.</p>
    #[doc(hidden)]pub instance_running_count: std::option::Option<i32>,
...
pub struct JobFlowExecutionStatusDetail  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::JobFlowExecutionState>,
...
pub struct Cluster  {
    ...
    #[doc(hidden)]pub ec2_instance_attributes: std::option::Option<crate::model::Ec2InstanceAttributes>,
    /// <note> 
    /// <p>The instance fleet configuration is available only in Amazon EMR versions 4.8.0 and later, excluding 5.0.x versions.</p> 
    /// </note> 
    ...
    #[doc(hidden)]pub instance_collection_type: std::option::Option<crate::model::InstanceCollectionType>,
    ...
    #[doc(hidden)]pub requested_ami_version: std::option::Option<std::string::String>,
    /// <p>The AMI version running on this cluster.</p>
    #[doc(hidden)]pub running_ami_version: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub auto_terminate: bool,
    ...
    #[doc(hidden)]pub placement_groups: std::option::Option<std::vec::Vec<crate::model::PlacementGroupConfig>>,
...
pub struct Ec2InstanceAttributes  {
    ...
    #[doc(hidden)]pub requested_ec2_subnet_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The Availability Zone in which the cluster will run. </p>
    #[doc(hidden)]pub ec2_availability_zone: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub requested_ec2_availability_zones: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for Ec2InstanceAttributes  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("requested_ec2_availability_zones", &self.requested_ec2_availability_zones);
...
pub struct CancelStepsInfo  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CancelStepsRequestStatus>,
