...
pub fn ser_start_notebook_execution_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartNotebookExecutionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
