...
pub fn ser_update_studio_session_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateStudioSessionMappingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
