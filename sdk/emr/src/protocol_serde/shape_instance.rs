            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(crate::protocol_serde::shape_instance_status::de_instance_status(tokens, _value)?);
                        }
                        "InstanceGroupId" => {
                        ...
                        "Market" => {
                            builder = builder.set_market(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MarketType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "InstanceType" => {
                        ...
                        "EbsVolumes" => {
                            builder = builder.set_ebs_volumes(crate::protocol_serde::shape_ebs_volume_list::de_ebs_volume_list(tokens, _value)?);
                        }
