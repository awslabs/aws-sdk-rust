            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(crate::protocol_serde::shape_instance_status::de_instance_status(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "EbsVolumes" => {
                            builder = builder.set_ebs_volumes(crate::protocol_serde::shape_ebs_volume_list::de_ebs_volume_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
