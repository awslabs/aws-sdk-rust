...
pub fn ser_get_studio_session_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetStudioSessionMappingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
