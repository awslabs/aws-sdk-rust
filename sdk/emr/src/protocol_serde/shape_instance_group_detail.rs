...
pub(crate) fn de_instance_group_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceGroupDetail>, aws_smithy_json::deserialize::error::DeserializeError>
