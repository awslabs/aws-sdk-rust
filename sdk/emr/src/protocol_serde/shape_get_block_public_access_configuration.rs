...
> {
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfigurationError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfigurationError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "BlockPublicAccessConfiguration" => {
                    builder = builder.set_block_public_access_configuration(
                        crate::protocol_serde::shape_block_public_access_configuration::de_block_public_access_configuration(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
