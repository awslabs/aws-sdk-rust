...
pub fn de_get_block_public_access_configuration_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfigurationOutput, crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfigurationError> {
    Ok({
        ...
        crate::serde_util::get_block_public_access_configuration_output_output_correct_errors(output).build()
    })
}

pub fn ser_get_block_public_access_configuration_input(_input: &crate::operation::get_block_public_access_configuration::GetBlockPublicAccessConfigurationInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
