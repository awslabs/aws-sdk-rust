...
pub(crate) fn de_session_mapping_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SessionMappingSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
