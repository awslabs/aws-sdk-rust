...
pub fn ser_cloud_watch_alarm_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CloudWatchAlarmDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cloud_watch_alarm_definition<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CloudWatchAlarmDefinition>, aws_smithy_json::deserialize::error::DeserializeError>
