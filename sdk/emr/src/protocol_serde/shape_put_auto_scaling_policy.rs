...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_auto_scaling_policy_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_auto_scaling_policy::de_put_auto_scaling_policy(_response_body, output)
            .map_err(crate::operation::put_auto_scaling_policy::PutAutoScalingPolicyError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "AutoScalingPolicy" => {
                    builder = builder.set_auto_scaling_policy(
                        crate::protocol_serde::shape_auto_scaling_policy_description::de_auto_scaling_policy_description(tokens, _value, depth + 1)?,
                    );
                }
                "ClusterArn" => {
