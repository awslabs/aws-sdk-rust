...
pub fn ser_run_job_flow_input_input(
    ...
    if let Some(var_43) = &input.ebs_root_volume_size {
        object.key("EbsRootVolumeSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_43).into()));
    }
    ...
    if let Some(var_47) = &input.step_concurrency_level {
        object.key("StepConcurrencyLevel").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_47).into()));
    }
    ...
    if let Some(var_57) = &input.ebs_root_volume_iops {
        object.key("EbsRootVolumeIops").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_57).into()));
    }
    if let Some(var_58) = &input.ebs_root_volume_throughput {
        object.key("EbsRootVolumeThroughput").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_58).into()));
    }
    Ok(())
}
