...
pub fn ser_job_flow_instances_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobFlowInstancesConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
