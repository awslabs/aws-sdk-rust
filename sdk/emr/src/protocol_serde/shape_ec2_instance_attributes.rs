...
pub(crate) fn de_ec2_instance_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Ec2InstanceAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
