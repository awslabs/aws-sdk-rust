...
) -> Result<Option<crate::types::Ec2InstanceAttributes>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AdditionalMasterSecurityGroups" => {
                            builder =
                                builder.set_additional_master_security_groups(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "AdditionalSlaveSecurityGroups" => {
                            builder = builder.set_additional_slave_security_groups(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
