...
) -> Result<Option<crate::types::JobFlowInstancesDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Placement" => {
                            builder = builder.set_placement(crate::protocol_serde::shape_placement_type::de_placement_type(tokens)?);
                        }
