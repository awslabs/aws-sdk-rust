...
pub(crate) fn de_job_flow_instances_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobFlowInstancesDetail>, aws_smithy_json::deserialize::error::DeserializeError>
