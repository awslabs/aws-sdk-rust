...
pub(crate) fn de_managed_scaling_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ManagedScalingPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
