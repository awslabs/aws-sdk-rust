...
pub fn ser_create_studio_session_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStudioSessionMappingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
