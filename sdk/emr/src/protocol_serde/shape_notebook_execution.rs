...
) -> Result<Option<crate::types::NotebookExecution>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExecutionEngine" => {
                            builder = builder
                                .set_execution_engine(crate::protocol_serde::shape_execution_engine_config::de_execution_engine_config(tokens)?);
                        }
