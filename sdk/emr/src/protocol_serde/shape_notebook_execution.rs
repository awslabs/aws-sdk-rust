...
pub(crate) fn de_notebook_execution<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NotebookExecution>, aws_smithy_json::deserialize::error::DeserializeError>
