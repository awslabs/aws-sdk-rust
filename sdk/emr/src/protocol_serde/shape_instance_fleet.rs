...
pub(crate) fn de_instance_fleet<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceFleet>, aws_smithy_json::deserialize::error::DeserializeError>
