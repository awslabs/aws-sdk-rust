...
) -> Result<Option<crate::types::InstanceFleet>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(crate::protocol_serde::shape_instance_fleet_status::de_instance_fleet_status(tokens)?);
                        }
                        "InstanceFleetType" => {
                            builder = builder.set_instance_fleet_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::InstanceFleetType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
