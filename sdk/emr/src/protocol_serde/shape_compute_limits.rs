...
) -> ::std::result::Result<Option<crate::types::ComputeLimits>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "UnitType" => {
                            builder = builder.set_unit_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ComputeLimitsUnitType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
