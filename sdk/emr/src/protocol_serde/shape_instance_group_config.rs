...
pub fn ser_instance_group_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceGroupConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
