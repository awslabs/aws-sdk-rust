...
pub(crate) fn de_spot_resizing_specification<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SpotResizingSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
