...
pub(crate) fn de_instance_type_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceTypeSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
