...
pub(crate) fn de_session_mapping_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SessionMappingDetail>, aws_smithy_json::deserialize::error::DeserializeError>
