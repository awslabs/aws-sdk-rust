...
pub(crate) fn de_session_mapping_detail<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SessionMappingDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
