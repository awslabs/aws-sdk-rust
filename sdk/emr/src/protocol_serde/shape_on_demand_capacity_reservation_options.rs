...
pub fn ser_on_demand_capacity_reservation_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OnDemandCapacityReservationOptions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_on_demand_capacity_reservation_options<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OnDemandCapacityReservationOptions>, aws_smithy_json::deserialize::error::DeserializeError>
