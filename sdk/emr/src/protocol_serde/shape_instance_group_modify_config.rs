...
pub fn ser_instance_group_modify_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InstanceGroupModifyConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
