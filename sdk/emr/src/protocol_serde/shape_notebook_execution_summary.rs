...
pub(crate) fn de_notebook_execution_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::NotebookExecutionSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
