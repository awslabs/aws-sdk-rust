...
pub(crate) fn de_step_execution_status_detail<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StepExecutionStatusDetail>, aws_smithy_json::deserialize::error::DeserializeError>
