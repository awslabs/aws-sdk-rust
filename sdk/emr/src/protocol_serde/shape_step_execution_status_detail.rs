...
) -> ::std::result::Result<Option<crate::types::StepExecutionStatusDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                        ...
                        "State" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::StepExecutionState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CreationDateTime" => {
            ...
            Ok(Some(crate::serde_util::step_execution_status_detail_correct_errors(builder).build()))
        }
