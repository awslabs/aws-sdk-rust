                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "SpotResizeSpecification" => {
                            builder = builder.set_spot_resize_specification(
                                crate::protocol_serde::shape_spot_resizing_specification::de_spot_resizing_specification(tokens, _value, depth + 1)?,
                            );
                        }
                        "OnDemandResizeSpecification" => {
                            builder = builder.set_on_demand_resize_specification(
                                crate::protocol_serde::shape_on_demand_resizing_specification::de_on_demand_resizing_specification(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
