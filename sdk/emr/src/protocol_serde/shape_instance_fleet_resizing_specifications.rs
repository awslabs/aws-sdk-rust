...
pub fn ser_instance_fleet_resizing_specifications(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::InstanceFleetResizingSpecifications) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_instance_fleet_resizing_specifications<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::InstanceFleetResizingSpecifications>, aws_smithy_json::deserialize::error::DeserializeError>
