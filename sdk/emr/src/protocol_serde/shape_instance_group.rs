...
pub(crate) fn de_instance_group<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceGroup>, aws_smithy_json::deserialize::error::DeserializeError>
