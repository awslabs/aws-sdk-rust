...
) -> Result<Option<crate::types::InstanceGroup>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "InstanceGroupType" => {
                            builder = builder.set_instance_group_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::InstanceGroupType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "BidPrice" => {
                        ...
                        "Status" => {
                            builder = builder.set_status(crate::protocol_serde::shape_instance_group_status::de_instance_group_status(tokens)?);
                        }
                        "Configurations" => {
                        ...
                        "EbsBlockDevices" => {
                            builder =
                                builder.set_ebs_block_devices(crate::protocol_serde::shape_ebs_block_device_list::de_ebs_block_device_list(tokens)?);
                        }
                        "EbsOptimized" => {
                            builder = builder.set_ebs_optimized(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "ShrinkPolicy" => {
                            builder = builder.set_shrink_policy(crate::protocol_serde::shape_shrink_policy::de_shrink_policy(tokens)?);
                        }
                        "AutoScalingPolicy" => {
