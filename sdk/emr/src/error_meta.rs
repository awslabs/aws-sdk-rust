...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::cancel_steps::CancelStepsError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::list_studios::ListStudiosError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::list_supported_instance_types::ListSupportedInstanceTypesError>
    for Error
{
    fn from(
        err: crate::operation::list_supported_instance_types::ListSupportedInstanceTypesError,
    ) -> Self {
        match err {
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::run_job_flow::RunJobFlowError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
