...
pub struct StartNotebookExecutionOutput  {
    ...
    #[doc(hidden)]pub notebook_execution_id: std::option::Option<std::string::String>,
}
...
pub struct RunJobFlowOutput  {
    ...
    #[doc(hidden)]pub job_flow_id: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    #[doc(hidden)]pub cluster_arn: std::option::Option<std::string::String>,
}
...
pub struct PutAutoScalingPolicyOutput  {
    ...
    #[doc(hidden)]pub instance_group_id: std::option::Option<std::string::String>,
    /// <p>The automatic scaling policy definition.</p>
    #[doc(hidden)]pub auto_scaling_policy: std::option::Option<crate::model::AutoScalingPolicyDescription>,
    /// <p>The Amazon Resource Name (ARN) of the cluster.</p>
    #[doc(hidden)]pub cluster_arn: std::option::Option<std::string::String>,
}
...
pub struct ModifyClusterOutput  {
    ...
    #[doc(hidden)]pub step_concurrency_level: std::option::Option<i32>,
}
...
pub struct ListStudioSessionMappingsOutput  {
    ...
    #[doc(hidden)]pub session_mappings: std::option::Option<std::vec::Vec<crate::model::SessionMappingSummary>>,
...
pub mod list_studio_session_mappings_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) session_mappings: std::option::Option<std::vec::Vec<crate::model::SessionMappingSummary>>,
    ...
    impl Builder {
        ...
        /// <p>A list of session mapping summary objects. Each object includes session mapping details such as creation time, identity type (user or group), and Amazon EMR Studio ID.</p>
        pub fn set_session_mappings(mut self, input: std::option::Option<std::vec::Vec<crate::model::SessionMappingSummary>>) -> Self {
...
pub struct ListStudiosOutput  {
    ...
    #[doc(hidden)]pub studios: std::option::Option<std::vec::Vec<crate::model::StudioSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
pub mod list_studios_output {
    ...
    impl Builder {
        ...
        /// <p>The list of Studio summary objects.</p>
        pub fn set_studios(mut self, input: std::option::Option<std::vec::Vec<crate::model::StudioSummary>>) -> Self {
...
pub struct ListStepsOutput  {
    ...
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::StepSummary>>,
...
pub mod list_steps_output {
    ...
    impl Builder {
        ...
        /// <p>The filtered list of steps for the cluster.</p>
        pub fn set_steps(mut self, input: std::option::Option<std::vec::Vec<crate::model::StepSummary>>) -> Self {
...
pub struct ListSecurityConfigurationsOutput  {
    ...
    #[doc(hidden)]pub security_configurations: std::option::Option<std::vec::Vec<crate::model::SecurityConfigurationSummary>>,
...
impl ListSecurityConfigurationsOutput {
    /// <p>The creation date and time, and name, of each security configuration.</p>
    pub fn security_configurations(&self) -> std::option::Option<& [crate::model::SecurityConfigurationSummary]> {
...
pub mod list_security_configurations_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) security_configurations: std::option::Option<std::vec::Vec<crate::model::SecurityConfigurationSummary>>,
        pub(crate) marker: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        ///
        /// <p>The creation date and time, and name, of each security configuration.</p>
        pub fn security_configurations(mut self, input: crate::model::SecurityConfigurationSummary) -> Self {
        ...
        /// <p>The creation date and time, and name, of each security configuration.</p>
        pub fn set_security_configurations(mut self, input: std::option::Option<std::vec::Vec<crate::model::SecurityConfigurationSummary>>) -> Self {
...
pub struct ListReleaseLabelsOutput  {
    ...
    #[doc(hidden)]pub release_labels: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ListNotebookExecutionsOutput  {
    ...
    #[doc(hidden)]pub notebook_executions: std::option::Option<std::vec::Vec<crate::model::NotebookExecutionSummary>>,
...
impl ListNotebookExecutionsOutput {
    /// <p>A list of notebook executions.</p>
    pub fn notebook_executions(&self) -> std::option::Option<& [crate::model::NotebookExecutionSummary]> {
...
pub mod list_notebook_executions_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) notebook_executions: std::option::Option<std::vec::Vec<crate::model::NotebookExecutionSummary>>,
        pub(crate) marker: std::option::Option<std::string::String>,
    }
    impl Builder {
        ...
        ///
        /// <p>A list of notebook executions.</p>
        pub fn notebook_executions(mut self, input: crate::model::NotebookExecutionSummary) -> Self {
        ...
        /// <p>A list of notebook executions.</p>
        pub fn set_notebook_executions(mut self, input: std::option::Option<std::vec::Vec<crate::model::NotebookExecutionSummary>>) -> Self {
...
pub struct ListInstanceGroupsOutput  {
    ...
    #[doc(hidden)]pub instance_groups: std::option::Option<std::vec::Vec<crate::model::InstanceGroup>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
pub mod list_instance_groups_output {
    ...
    impl Builder {
        ...
        /// <p>The list of instance groups for the cluster and given filters.</p>
        pub fn set_instance_groups(mut self, input: std::option::Option<std::vec::Vec<crate::model::InstanceGroup>>) -> Self {
...
pub struct ListInstanceFleetsOutput  {
    ...
    #[doc(hidden)]pub instance_fleets: std::option::Option<std::vec::Vec<crate::model::InstanceFleet>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
pub mod list_instance_fleets_output {
    ...
    impl Builder {
        ...
        /// <p>The list of instance fleets for the cluster and given filters.</p>
        pub fn set_instance_fleets(mut self, input: std::option::Option<std::vec::Vec<crate::model::InstanceFleet>>) -> Self {
...
pub struct ListClustersOutput  {
    ...
    #[doc(hidden)]pub clusters: std::option::Option<std::vec::Vec<crate::model::ClusterSummary>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
pub mod list_clusters_output {
    ...
    impl Builder {
        ...
        /// <p>The list of clusters for the account based on the given filters.</p>
        pub fn set_clusters(mut self, input: std::option::Option<std::vec::Vec<crate::model::ClusterSummary>>) -> Self {
...
pub struct ListBootstrapActionsOutput  {
    ...
    #[doc(hidden)]pub bootstrap_actions: std::option::Option<std::vec::Vec<crate::model::Command>>,
    /// <p>The pagination token that indicates the next set of results to retrieve.</p>
    #[doc(hidden)]pub marker: std::option::Option<std::string::String>,
}
...
pub mod list_bootstrap_actions_output {
    ...
    impl Builder {
        ...
        /// <p>The bootstrap actions associated with the cluster.</p>
        pub fn set_bootstrap_actions(mut self, input: std::option::Option<std::vec::Vec<crate::model::Command>>) -> Self {
...
pub struct GetStudioSessionMappingOutput  {
    ...
    #[doc(hidden)]pub session_mapping: std::option::Option<crate::model::SessionMappingDetail>,
}
...
pub mod get_studio_session_mapping_output {
    ...
    impl Builder {
        ...
        /// <p>The session mapping details for the specified Amazon EMR Studio and identity, including session policy ARN and creation time.</p>
        pub fn set_session_mapping(mut self, input: std::option::Option<crate::model::SessionMappingDetail>) -> Self {
...
pub struct GetManagedScalingPolicyOutput  {
    ...
    #[doc(hidden)]pub managed_scaling_policy: std::option::Option<crate::model::ManagedScalingPolicy>,
}
impl GetManagedScalingPolicyOutput {
    /// <p>Specifies the managed scaling policy that is attached to an Amazon EMR cluster. </p>
    pub fn managed_scaling_policy(&self) -> std::option::Option<& crate::model::ManagedScalingPolicy> {
...
pub struct GetBlockPublicAccessConfigurationOutput  {
    ...
    /// </note>
    #[doc(hidden)]pub block_public_access_configuration: std::option::Option<crate::model::BlockPublicAccessConfiguration>,
    ...
    #[doc(hidden)]pub block_public_access_configuration_metadata: std::option::Option<crate::model::BlockPublicAccessConfigurationMetadata>,
}
impl GetBlockPublicAccessConfigurationOutput {
    /// <p>A configuration for Amazon EMR block public access. The configuration applies to all clusters created in your account for the current Region. The configuration specifies whether block public access is enabled. If block public access is enabled, security groups associated with the cluster cannot have rules that allow inbound traffic from 0.0.0.0/0 or ::/0 on a port, unless the port is specified as an exception using <code>PermittedPublicSecurityGroupRuleRanges</code> in the <code>BlockPublicAccessConfiguration</code>. By default, Port 22 (SSH) is an exception, and public access is allowed on this port. You can change this by updating the block public access configuration to remove the exception.</p> <note> 
    /// <p>For accounts that created clusters in a Region before November 25, 2019, block public access is disabled by default in that Region. To use this feature, you must manually enable and configure it. For accounts that did not create an EMR cluster in a Region before this date, block public access is enabled by default in that Region.</p> 
    /// </note>
    pub fn block_public_access_configuration(&self) -> std::option::Option<& crate::model::BlockPublicAccessConfiguration> {
        self.block_public_access_configuration.as_ref()
    }
    /// <p>Properties that describe the Amazon Web Services principal that created the <code>BlockPublicAccessConfiguration</code> using the <code>PutBlockPublicAccessConfiguration</code> action as well as the date and time that the configuration was created. Each time a configuration for block public access is updated, Amazon EMR updates this metadata.</p>
    pub fn block_public_access_configuration_metadata(&self) -> std::option::Option<& crate::model::BlockPublicAccessConfigurationMetadata> {
...
impl  std::fmt::Debug for GetBlockPublicAccessConfigurationOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("block_public_access_configuration", &self.block_public_access_configuration);
        formatter.field("block_public_access_configuration_metadata", &self.block_public_access_configuration_metadata);
        formatter.finish()
    }
}
...
pub mod get_block_public_access_configuration_output {
    ...
    pub struct Builder {
        ...
        pub(crate) block_public_access_configuration_metadata: std::option::Option<crate::model::BlockPublicAccessConfigurationMetadata>,
    }
    impl Builder {
        /// <p>A configuration for Amazon EMR block public access. The configuration applies to all clusters created in your account for the current Region. The configuration specifies whether block public access is enabled. If block public access is enabled, security groups associated with the cluster cannot have rules that allow inbound traffic from 0.0.0.0/0 or ::/0 on a port, unless the port is specified as an exception using <code>PermittedPublicSecurityGroupRuleRanges</code> in the <code>BlockPublicAccessConfiguration</code>. By default, Port 22 (SSH) is an exception, and public access is allowed on this port. You can change this by updating the block public access configuration to remove the exception.</p> <note> 
        /// <p>For accounts that created clusters in a Region before November 25, 2019, block public access is disabled by default in that Region. To use this feature, you must manually enable and configure it. For accounts that did not create an EMR cluster in a Region before this date, block public access is enabled by default in that Region.</p> 
        ...
        /// <p>Properties that describe the Amazon Web Services principal that created the <code>BlockPublicAccessConfiguration</code> using the <code>PutBlockPublicAccessConfiguration</code> action as well as the date and time that the configuration was created. Each time a configuration for block public access is updated, Amazon EMR updates this metadata.</p>
        pub fn block_public_access_configuration_metadata(mut self, input: crate::model::BlockPublicAccessConfigurationMetadata) -> Self {
            self.block_public_access_configuration_metadata = Some(input);
            self
        }
        /// <p>Properties that describe the Amazon Web Services principal that created the <code>BlockPublicAccessConfiguration</code> using the <code>PutBlockPublicAccessConfiguration</code> action as well as the date and time that the configuration was created. Each time a configuration for block public access is updated, Amazon EMR updates this metadata.</p>
        pub fn set_block_public_access_configuration_metadata(mut self, input: std::option::Option<crate::model::BlockPublicAccessConfigurationMetadata>) -> Self {
...
pub struct GetAutoTerminationPolicyOutput  {
    ...
    #[doc(hidden)]pub auto_termination_policy: std::option::Option<crate::model::AutoTerminationPolicy>,
}
impl GetAutoTerminationPolicyOutput {
    /// <p>Specifies the auto-termination policy that is attached to an Amazon EMR cluster. </p>
    pub fn auto_termination_policy(&self) -> std::option::Option<& crate::model::AutoTerminationPolicy> {
...
pub mod get_auto_termination_policy_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) auto_termination_policy: std::option::Option<crate::model::AutoTerminationPolicy>,
    }
    impl Builder {
        /// <p>Specifies the auto-termination policy that is attached to an Amazon EMR cluster. </p>
...
pub struct DescribeStudioOutput  {
    ...
    #[doc(hidden)]pub studio: std::option::Option<crate::model::Studio>,
}
...
pub struct DescribeStepOutput  {
    ...
    #[doc(hidden)]pub step: std::option::Option<crate::model::Step>,
}
...
pub struct DescribeSecurityConfigurationOutput  {
    ...
    #[doc(hidden)]pub security_configuration: std::option::Option<std::string::String>,
...
pub struct DescribeReleaseLabelOutput  {
    ...
    #[doc(hidden)]pub applications: std::option::Option<std::vec::Vec<crate::model::SimplifiedApplication>>,
    ...
    #[doc(hidden)]pub available_os_releases: std::option::Option<std::vec::Vec<crate::model::OsRelease>>,
}
...
pub mod describe_release_label_output {
    ...
    pub struct Builder {
        ...
        pub(crate) applications: std::option::Option<std::vec::Vec<crate::model::SimplifiedApplication>>,
        pub(crate) next_token: std::option::Option<std::string::String>,
        pub(crate) available_os_releases: std::option::Option<std::vec::Vec<crate::model::OsRelease>>,
    }
    impl Builder {
        /// <p>The target release label described in the response.</p>
        ...
        /// <p>The list of applications available for the target release label. <code>Name</code> is the name of the application. <code>Version</code> is the concise version of the application.</p>
        pub fn set_applications(mut self, input: std::option::Option<std::vec::Vec<crate::model::SimplifiedApplication>>) -> Self {
        ...
        /// <p>The list of available Amazon Linux release versions for an Amazon EMR release. Contains a Label field that is formatted as shown in <a href="https://docs.aws.amazon.com/AL2/latest/relnotes/relnotes-al2.html"> <i>Amazon Linux 2 Release Notes</i> </a>. For example, <a href="https://docs.aws.amazon.com/AL2/latest/relnotes/relnotes-20220218.html">2.0.20220218.1</a>.</p>
        pub fn set_available_os_releases(mut self, input: std::option::Option<std::vec::Vec<crate::model::OsRelease>>) -> Self {
...
pub struct DescribeNotebookExecutionOutput  {
    ...
    #[doc(hidden)]pub notebook_execution: std::option::Option<crate::model::NotebookExecution>,
}
...
pub mod describe_notebook_execution_output {
    ...
    impl Builder {
        ...
        /// <p>Properties of the notebook execution.</p>
        pub fn set_notebook_execution(mut self, input: std::option::Option<crate::model::NotebookExecution>) -> Self {
...
pub struct DescribeJobFlowsOutput  {
    ...
    #[doc(hidden)]pub job_flows: std::option::Option<std::vec::Vec<crate::model::JobFlowDetail>>,
}
...
pub mod describe_job_flows_output {
    ...
    impl Builder {
        ...
        /// <p>A list of job flows matching the parameters supplied.</p>
        pub fn set_job_flows(mut self, input: std::option::Option<std::vec::Vec<crate::model::JobFlowDetail>>) -> Self {
...
pub struct CancelStepsOutput  {
    ...
    #[doc(hidden)]pub cancel_steps_info_list: std::option::Option<std::vec::Vec<crate::model::CancelStepsInfo>>,
}
...
pub mod cancel_steps_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) cancel_steps_info_list: std::option::Option<std::vec::Vec<crate::model::CancelStepsInfo>>,
    }
    impl Builder {
        ...
        /// <p>A list of <code>CancelStepsInfo</code>, which shows the status of specified cancel requests for each <code>StepID</code> specified.</p>
        pub fn set_cancel_steps_info_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::CancelStepsInfo>>) -> Self {
...
pub struct AddJobFlowStepsOutput  {
    ...
    #[doc(hidden)]pub step_ids: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct AddInstanceGroupsOutput  {
    ...
    #[doc(hidden)]pub instance_group_ids: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct AddInstanceFleetOutput  {
    ...
    #[doc(hidden)]pub instance_fleet_id: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name of the cluster.</p>
    #[doc(hidden)]pub cluster_arn: std::option::Option<std::string::String>,
}
