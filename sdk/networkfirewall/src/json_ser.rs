...
pub fn serialize_structure_crate_model_firewall_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FirewallPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_154 in var_152 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_stateless_rule_group_reference(&mut object_155, item_154)?;
                object_155.finish();
            }
        }
        array_153.finish();
        ...
        for item_164 in var_162 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_custom_action(&mut object_165, item_164)?;
                object_165.finish();
            }
        }
        array_163.finish();
        ...
        for item_168 in var_166 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_stateful_rule_group_reference(&mut object_169, item_168)?;
                object_169.finish();
            }
        }
        array_167.finish();
    ...
    if let Some(var_173) = &input.stateful_engine_options {
        ...
        crate::json_ser::serialize_structure_crate_model_stateful_engine_options(&mut object_174, var_173)?;
        object_174.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_rule_group(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleGroup) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_181) = &input.stateful_rule_options {
        ...
        crate::json_ser::serialize_structure_crate_model_stateful_rule_options(&mut object_182, var_181)?;
        object_182.finish();
    }
    Ok(())
}
        ...
        for item_187 in var_185 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_log_destination_config(&mut object_188, item_187)?;
                object_188.finish();
            }
        }
        array_186.finish();
...
pub fn serialize_structure_crate_model_custom_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CustomAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_191) = &input.action_definition {
        ...
        crate::json_ser::serialize_structure_crate_model_action_definition(&mut object_192, var_191)?;
        object_192.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_stateful_rule_group_reference(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::StatefulRuleGroupReference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_194) = &input.priority {
        object.key("Priority").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_194).into()));
    }
    if let Some(var_195) = &input.r#override {
        #[allow(unused_mut)]
        let mut object_196 = object.key("Override").start_object();
        crate::json_ser::serialize_structure_crate_model_stateful_rule_group_override(&mut object_196, var_195)?;
        object_196.finish();
    }
    Ok(())
}
        ...
        for (key_201, value_202) in var_199 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_ip_set(&mut object_203, value_202)?;
                object_203.finish();
            }
        }
        object_200.finish();
        ...
        for (key_206, value_207) in var_204 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_port_set(&mut object_208, value_207)?;
                object_208.finish();
            }
        }
        object_205.finish();
        ...
        for (key_211, value_212) in var_209 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_ip_set_reference(&mut object_213, value_212)?;
                object_213.finish();
            }
        }
        object_210.finish();
...
pub fn serialize_structure_crate_model_rules_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RulesSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_215) = &input.rules_source_list {
        ...
        crate::json_ser::serialize_structure_crate_model_rules_source_list(&mut object_216, var_215)?;
        object_216.finish();
    }
        ...
        for item_219 in var_217 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_stateful_rule(&mut object_220, item_219)?;
                object_220.finish();
            }
        }
        array_218.finish();
    ...
    if let Some(var_221) = &input.stateless_rules_and_custom_actions {
        ...
        crate::json_ser::serialize_structure_crate_model_stateless_rules_and_custom_actions(&mut object_222, var_221)?;
        object_222.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_action_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_230) = &input.publish_metric_action {
        ...
        crate::json_ser::serialize_structure_crate_model_publish_metric_action(&mut object_231, var_230)?;
        object_231.finish();
    }
    Ok(())
}
        ...
        for item_252 in var_250 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_rule_option(&mut object_253, item_252)?;
                object_253.finish();
            }
        }
        array_251.finish();
        ...
        for item_256 in var_254 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_stateless_rule(&mut object_257, item_256)?;
                object_257.finish();
            }
        }
        array_255.finish();
        ...
        for item_260 in var_258 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_custom_action(&mut object_261, item_260)?;
                object_261.finish();
            }
        }
        array_259.finish();
        ...
        for item_264 in var_262 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_dimension(&mut object_265, item_264)?;
                object_265.finish();
            }
        }
        array_263.finish();
...
pub fn serialize_structure_crate_model_rule_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_279) = &input.match_attributes {
        ...
        crate::json_ser::serialize_structure_crate_model_match_attributes(&mut object_280, var_279)?;
        object_280.finish();
    }
...
pub fn serialize_structure_crate_model_match_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MatchAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_286 in var_284 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_address(&mut object_287, item_286)?;
                object_287.finish();
            }
        }
        array_285.finish();
        ...
        for item_290 in var_288 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_address(&mut object_291, item_290)?;
                object_291.finish();
            }
        }
        array_289.finish();
        ...
        for item_294 in var_292 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_port_range(&mut object_295, item_294)?;
                object_295.finish();
            }
        }
        array_293.finish();
        ...
        for item_298 in var_296 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_port_range(&mut object_299, item_298)?;
                object_299.finish();
            }
        }
        array_297.finish();
    ...
    if let Some(var_300) = &input.protocols {
        ...
        for item_302 in var_300 {
             {
                array_301.value().number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*item_302).into()));
            }
        }
        array_301.finish();
    }
        ...
        for item_305 in var_303 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_tcp_flag_field(&mut object_306, item_305)?;
                object_306.finish();
            }
        }
        array_304.finish();
