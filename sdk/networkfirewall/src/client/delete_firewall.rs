...
impl super::Client {
    ...
    pub fn delete_firewall(
        &self,
    ) -> crate::operation::delete_firewall::builders::DeleteFirewallFluentBuilder {
        crate::operation::delete_firewall::builders::DeleteFirewallFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
