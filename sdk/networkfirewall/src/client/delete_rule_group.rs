...
impl super::Client {
    ...
    ///   - [`rule_group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::rule_group_name) / [`set_rule_group_name(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_rule_group_name): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::rule_group_arn) / [`set_rule_group_arn(Option<String>)`](crate::operation::delete_rule_group::builders::DeleteRuleGroupFluentBuilder::set_rule_group_arn): <p>The Amazon Resource Name (ARN) of the rule group.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
