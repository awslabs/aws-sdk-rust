...
impl super::Client {
    ...
    ///   - [`firewall_arn(impl Into<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::firewall_arn) / [`set_firewall_arn(Option<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::set_firewall_arn):<br>required: **false**<br><p>The Amazon Resource Name (ARN) of the firewall.</p> <p>You must specify the ARN or the name, and you can specify both.</p><br>
    ///   - [`firewall_name(impl Into<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::firewall_name) / [`set_firewall_name(Option<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::set_firewall_name):<br>required: **false**<br><p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p> <p>You must specify the ARN or the name, and you can specify both.</p><br>
