...
impl super::Client {
    ...
    ///   - [`container_associations(Option<Vec::<ContainerAssociationSummary>>)`](crate::operation::list_container_associations::ListContainerAssociationsOutput::container_associations): <p>The container association metadata objects for the account and Region.</p>
