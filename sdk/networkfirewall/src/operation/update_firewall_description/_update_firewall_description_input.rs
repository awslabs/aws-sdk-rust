...
impl UpdateFirewallDescriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_firewall_description::UpdateFirewallDescriptionInput, ::aws_smithy_types::error::operation::BuildError> {
