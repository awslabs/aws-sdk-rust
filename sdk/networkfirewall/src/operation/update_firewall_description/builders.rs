...
impl UpdateFirewallDescriptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_firewall_description::UpdateFirewallDescriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_firewall_description::UpdateFirewallDescriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_firewall_description::UpdateFirewallDescriptionOutput, crate::operation::update_firewall_description::UpdateFirewallDescriptionError, Self> {
