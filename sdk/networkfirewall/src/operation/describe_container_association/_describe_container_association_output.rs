...
pub struct DescribeContainerAssociationOutput {
...
impl DescribeContainerAssociationOutput {
    /// <p>The descriptive name of the container association.</p>
...
impl ::aws_types::request_id::RequestId for DescribeContainerAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DescribeContainerAssociationOutput {
    /// Creates a new builder-style object to manufacture [`DescribeContainerAssociationOutput`](crate::operation::describe_container_association::DescribeContainerAssociationOutput).
    pub fn builder() -> crate::operation::describe_container_association::builders::DescribeContainerAssociationOutputBuilder {
        crate::operation::describe_container_association::builders::DescribeContainerAssociationOutputBuilder::default()
    }
}

/// A builder for [`DescribeContainerAssociationOutput`](crate::operation::describe_container_association::DescribeContainerAssociationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DescribeContainerAssociationOutputBuilder {
...
impl DescribeContainerAssociationOutputBuilder {
    /// <p>The descriptive name of the container association.</p>
    ...
    /// Consumes the builder and constructs a [`DescribeContainerAssociationOutput`](crate::operation::describe_container_association::DescribeContainerAssociationOutput).
    pub fn build(self) -> crate::operation::describe_container_association::DescribeContainerAssociationOutput {
