...
/// Orchestration and serialization glue logic for `UpdateFirewallPolicyChangeProtection`.
...
impl UpdateFirewallPolicyChangeProtection {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFirewallPolicyChangeProtection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateFirewallPolicyChangeProtection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateFirewallPolicyChangeProtectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateFirewallPolicyChangeProtectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFirewallPolicyChangeProtection")
...
.with_interceptor(UpdateFirewallPolicyChangeProtectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError>::new());
...
#[derive(Debug)]
            struct UpdateFirewallPolicyChangeProtectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFirewallPolicyChangeProtectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_firewall_policy_change_protection::de_update_firewall_policy_change_protection_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_firewall_policy_change_protection::de_update_firewall_policy_change_protection_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateFirewallPolicyChangeProtectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFirewallPolicyChangeProtectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_firewall_policy_change_protection::ser_update_firewall_policy_change_protection_input(&input)?);
...
#[derive(Debug)]
            struct UpdateFirewallPolicyChangeProtectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFirewallPolicyChangeProtectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateFirewallPolicyChangeProtectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateFirewallPolicyChangeProtectionInput>()
                        .ok_or("failed to downcast to UpdateFirewallPolicyChangeProtectionInput")?;
...
pub enum UpdateFirewallPolicyChangeProtectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateFirewallPolicyChangeProtectionError) for what information is available for the error.")]
...
impl UpdateFirewallPolicyChangeProtectionError {
    /// Creates the `UpdateFirewallPolicyChangeProtectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateFirewallPolicyChangeProtectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateFirewallPolicyChangeProtectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_firewall_policy_change_protection::UpdateFirewallPolicyChangeProtectionError {
...
mod _update_firewall_policy_change_protection_output;
