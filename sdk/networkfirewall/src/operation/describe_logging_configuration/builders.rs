...
impl DescribeLoggingConfigurationFluentBuilder  {
    /// Creates a new `DescribeLoggingConfiguration`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_logging_configuration::DescribeLoggingConfiguration, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_logging_configuration::DescribeLoggingConfigurationError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_logging_configuration::DescribeLoggingConfigurationOutput, aws_smithy_http::result::SdkError<crate::operation::describe_logging_configuration::DescribeLoggingConfigurationError>>
                     {
