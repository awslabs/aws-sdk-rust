...
pub struct DeleteContainerAssociationOutput {
...
impl DeleteContainerAssociationOutput {
    /// <p>The descriptive name of the container association.</p>
...
impl ::aws_types::request_id::RequestId for DeleteContainerAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DeleteContainerAssociationOutput {
    /// Creates a new builder-style object to manufacture [`DeleteContainerAssociationOutput`](crate::operation::delete_container_association::DeleteContainerAssociationOutput).
    pub fn builder() -> crate::operation::delete_container_association::builders::DeleteContainerAssociationOutputBuilder {
        crate::operation::delete_container_association::builders::DeleteContainerAssociationOutputBuilder::default()
    }
}

/// A builder for [`DeleteContainerAssociationOutput`](crate::operation::delete_container_association::DeleteContainerAssociationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteContainerAssociationOutputBuilder {
...
impl DeleteContainerAssociationOutputBuilder {
    /// <p>The descriptive name of the container association.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteContainerAssociationOutput`](crate::operation::delete_container_association::DeleteContainerAssociationOutput).
    pub fn build(self) -> crate::operation::delete_container_association::DeleteContainerAssociationOutput {
        crate::operation::delete_container_association::DeleteContainerAssociationOutput {
