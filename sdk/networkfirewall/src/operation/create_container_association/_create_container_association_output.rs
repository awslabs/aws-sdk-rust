...
pub struct CreateContainerAssociationOutput {
...
impl ::aws_types::request_id::RequestId for CreateContainerAssociationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateContainerAssociationOutput {
    /// Creates a new builder-style object to manufacture [`CreateContainerAssociationOutput`](crate::operation::create_container_association::CreateContainerAssociationOutput).
    pub fn builder() -> crate::operation::create_container_association::builders::CreateContainerAssociationOutputBuilder {
        crate::operation::create_container_association::builders::CreateContainerAssociationOutputBuilder::default()
    }
}

/// A builder for [`CreateContainerAssociationOutput`](crate::operation::create_container_association::CreateContainerAssociationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateContainerAssociationOutputBuilder {
...
impl CreateContainerAssociationOutputBuilder {
    /// <p>The descriptive name of the container association.</p>
    ...
    /// Consumes the builder and constructs a [`CreateContainerAssociationOutput`](crate::operation::create_container_association::CreateContainerAssociationOutput).
    pub fn build(self) -> crate::operation::create_container_association::CreateContainerAssociationOutput {
