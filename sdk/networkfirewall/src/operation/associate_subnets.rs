...
impl AssociateSubnetsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateSubnets`](crate::operation::associate_subnets::AssociateSubnets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_subnets::AssociateSubnets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_subnets::AssociateSubnetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_subnets::AssociateSubnets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateSubnets {
                type Output = std::result::Result<crate::operation::associate_subnets::AssociateSubnetsOutput, crate::operation::associate_subnets::AssociateSubnetsError>;
