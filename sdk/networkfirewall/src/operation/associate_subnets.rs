...
impl AssociateSubnetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_subnets::AssociateSubnets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_subnets::ser_associate_subnets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSubnets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_subnets::de_associate_subnets_http_response_with_props(status, headers, body)
        }
    }
}
