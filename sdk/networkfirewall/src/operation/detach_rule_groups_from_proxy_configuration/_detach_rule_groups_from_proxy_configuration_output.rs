...
pub struct DetachRuleGroupsFromProxyConfigurationOutput {
...
impl DetachRuleGroupsFromProxyConfigurationOutput {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
...
impl ::aws_types::request_id::RequestId for DetachRuleGroupsFromProxyConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl DetachRuleGroupsFromProxyConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`DetachRuleGroupsFromProxyConfigurationOutput`](crate::operation::detach_rule_groups_from_proxy_configuration::DetachRuleGroupsFromProxyConfigurationOutput).
    pub fn builder() -> crate::operation::detach_rule_groups_from_proxy_configuration::builders::DetachRuleGroupsFromProxyConfigurationOutputBuilder {
...
/// A builder for [`DetachRuleGroupsFromProxyConfigurationOutput`](crate::operation::detach_rule_groups_from_proxy_configuration::DetachRuleGroupsFromProxyConfigurationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DetachRuleGroupsFromProxyConfigurationOutputBuilder {
...
impl DetachRuleGroupsFromProxyConfigurationOutputBuilder {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
    ...
    /// Consumes the builder and constructs a [`DetachRuleGroupsFromProxyConfigurationOutput`](crate::operation::detach_rule_groups_from_proxy_configuration::DetachRuleGroupsFromProxyConfigurationOutput).
    pub fn build(self) -> crate::operation::detach_rule_groups_from_proxy_configuration::DetachRuleGroupsFromProxyConfigurationOutput {
