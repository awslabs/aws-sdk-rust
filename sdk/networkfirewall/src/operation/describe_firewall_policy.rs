...
impl DescribeFirewallPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFirewallPolicy`](crate::operation::describe_firewall_policy::DescribeFirewallPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_firewall_policy::DescribeFirewallPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_firewall_policy::DescribeFirewallPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_firewall_policy::DescribeFirewallPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFirewallPolicy {
                type Output = std::result::Result<crate::operation::describe_firewall_policy::DescribeFirewallPolicyOutput, crate::operation::describe_firewall_policy::DescribeFirewallPolicyError>;
