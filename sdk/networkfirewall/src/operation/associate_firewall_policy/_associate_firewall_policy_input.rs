...
impl AssociateFirewallPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_firewall_policy::AssociateFirewallPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
