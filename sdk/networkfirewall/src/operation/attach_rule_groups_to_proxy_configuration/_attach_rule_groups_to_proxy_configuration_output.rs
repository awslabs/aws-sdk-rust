...
pub struct AttachRuleGroupsToProxyConfigurationOutput {
...
impl AttachRuleGroupsToProxyConfigurationOutput {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
...
impl ::aws_types::request_id::RequestId for AttachRuleGroupsToProxyConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl AttachRuleGroupsToProxyConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`AttachRuleGroupsToProxyConfigurationOutput`](crate::operation::attach_rule_groups_to_proxy_configuration::AttachRuleGroupsToProxyConfigurationOutput).
    pub fn builder() -> crate::operation::attach_rule_groups_to_proxy_configuration::builders::AttachRuleGroupsToProxyConfigurationOutputBuilder {
...
/// A builder for [`AttachRuleGroupsToProxyConfigurationOutput`](crate::operation::attach_rule_groups_to_proxy_configuration::AttachRuleGroupsToProxyConfigurationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AttachRuleGroupsToProxyConfigurationOutputBuilder {
...
impl AttachRuleGroupsToProxyConfigurationOutputBuilder {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
    ...
    /// Consumes the builder and constructs a [`AttachRuleGroupsToProxyConfigurationOutput`](crate::operation::attach_rule_groups_to_proxy_configuration::AttachRuleGroupsToProxyConfigurationOutput).
    pub fn build(self) -> crate::operation::attach_rule_groups_to_proxy_configuration::AttachRuleGroupsToProxyConfigurationOutput {
