...
impl DeleteFirewallInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_firewall::DeleteFirewall, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_firewall::ser_delete_firewall_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFirewall {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_firewall::de_delete_firewall_http_response_with_props(status, headers, body)
        }
    }
}
