...
impl DeleteRuleGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_rule_group::DeleteRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_rule_group::ser_delete_rule_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRuleGroup {
    type Output =
        ::std::result::Result<crate::operation::delete_rule_group::DeleteRuleGroupOutput, crate::operation::delete_rule_group::DeleteRuleGroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_rule_group::de_delete_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
