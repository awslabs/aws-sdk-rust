...
impl UpdateSubnetChangeProtectionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionOutput, crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionError, Self> {
