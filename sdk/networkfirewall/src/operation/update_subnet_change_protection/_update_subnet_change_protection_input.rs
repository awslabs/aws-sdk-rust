...
impl UpdateSubnetChangeProtectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionInput, ::aws_smithy_types::error::operation::BuildError> {
