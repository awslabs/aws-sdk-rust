...
impl DescribeRuleGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_rule_group::ser_describe_rule_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRuleGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_rule_group::de_describe_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
