...
impl DescribeRuleGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_rule_group::DescribeRuleGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRuleGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_rule_group::de_describe_rule_group_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_rule_group::DescribeRuleGroupError
{
