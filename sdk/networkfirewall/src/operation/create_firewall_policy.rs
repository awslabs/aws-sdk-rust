...
impl CreateFirewallPolicyInput {
    /// Consumes the builder and constructs an Operation<[`CreateFirewallPolicy`](crate::operation::create_firewall_policy::CreateFirewallPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_firewall_policy::CreateFirewallPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_firewall_policy::CreateFirewallPolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_firewall_policy::ser_create_firewall_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_firewall_policy::CreateFirewallPolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateFirewallPolicy {
                type Output = std::result::Result<crate::operation::create_firewall_policy::CreateFirewallPolicyOutput, crate::operation::create_firewall_policy::CreateFirewallPolicyError>;
