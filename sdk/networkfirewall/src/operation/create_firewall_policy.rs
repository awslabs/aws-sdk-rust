...
/// Orchestration and serialization glue logic for `CreateFirewallPolicy`.
...
impl CreateFirewallPolicy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_firewall_policy::CreateFirewallPolicyInput,
                    ) -> ::std::result::Result<crate::operation::create_firewall_policy::CreateFirewallPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_firewall_policy::CreateFirewallPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_firewall_policy::CreateFirewallPolicyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_firewall_policy::CreateFirewallPolicyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFirewallPolicy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFirewallPolicy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateFirewallPolicyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateFirewallPolicyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFirewallPolicy")
...
.with_interceptor(CreateFirewallPolicyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_firewall_policy::CreateFirewallPolicyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_firewall_policy::CreateFirewallPolicyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_firewall_policy::CreateFirewallPolicyError>::new());
...
#[derive(Debug)]
            struct CreateFirewallPolicyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFirewallPolicyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_firewall_policy::de_create_firewall_policy_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_firewall_policy::de_create_firewall_policy_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateFirewallPolicyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFirewallPolicyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_firewall_policy::CreateFirewallPolicyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_firewall_policy::CreateFirewallPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_firewall_policy::ser_create_firewall_policy_input(&input)?);
...
#[derive(Debug)]
            struct CreateFirewallPolicyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFirewallPolicyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateFirewallPolicyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateFirewallPolicyInput>()
                        .ok_or("failed to downcast to CreateFirewallPolicyInput")?;
...
pub enum CreateFirewallPolicyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFirewallPolicyError) for what information is available for the error.")]
...
impl CreateFirewallPolicyError {
    /// Creates the `CreateFirewallPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFirewallPolicyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFirewallPolicyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_firewall_policy::CreateFirewallPolicyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_firewall_policy::_create_firewall_policy_output::CreateFirewallPolicyOutput;

pub use crate::operation::create_firewall_policy::_create_firewall_policy_input::CreateFirewallPolicyInput;

mod _create_firewall_policy_input;

mod _create_firewall_policy_output;
