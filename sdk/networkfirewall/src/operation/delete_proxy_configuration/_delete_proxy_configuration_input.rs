...
pub struct DeleteProxyConfigurationInput {
...
impl DeleteProxyConfigurationInput {
    /// <p>The descriptive name of the proxy configuration. You can't change the name of a proxy configuration after you create it.</p>
    /// <p>You must specify the ARN or the name, and you can specify both.</p>
...
impl DeleteProxyConfigurationInput {
    /// Creates a new builder-style object to manufacture [`DeleteProxyConfigurationInput`](crate::operation::delete_proxy_configuration::DeleteProxyConfigurationInput).
    pub fn builder() -> crate::operation::delete_proxy_configuration::builders::DeleteProxyConfigurationInputBuilder {
        crate::operation::delete_proxy_configuration::builders::DeleteProxyConfigurationInputBuilder::default()
    }
}

/// A builder for [`DeleteProxyConfigurationInput`](crate::operation::delete_proxy_configuration::DeleteProxyConfigurationInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct DeleteProxyConfigurationInputBuilder {
...
impl DeleteProxyConfigurationInputBuilder {
    /// <p>The descriptive name of the proxy configuration. You can't change the name of a proxy configuration after you create it.</p>
    /// <p>You must specify the ARN or the name, and you can specify both.</p>
    ...
    /// Consumes the builder and constructs a [`DeleteProxyConfigurationInput`](crate::operation::delete_proxy_configuration::DeleteProxyConfigurationInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::delete_proxy_configuration::DeleteProxyConfigurationInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::delete_proxy_configuration::DeleteProxyConfigurationInput {
