...
impl UpdateFirewallDeleteProtectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFirewallDeleteProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_firewall_delete_protection::de_update_firewall_delete_protection_http_response_with_props(
                status, headers, body,
            )
        }
    }
