...
impl UpdateSubnetChangeProtectionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSubnetChangeProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_subnet_change_protection::de_update_subnet_change_protection_http_response_with_props(
                status, headers, body,
            )
        }
    }
