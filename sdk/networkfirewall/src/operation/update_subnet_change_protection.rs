...
impl UpdateSubnetChangeProtectionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSubnetChangeProtection`](crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtection, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtection::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSubnetChangeProtection {
                type Output = std::result::Result<crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionOutput, crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionError>;
