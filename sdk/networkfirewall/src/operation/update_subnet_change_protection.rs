...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSubnetChangeProtection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_subnet_change_protection::de_update_subnet_change_protection_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateSubnetChangeProtectionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_subnet_change_protection::UpdateSubnetChangeProtectionError
{
