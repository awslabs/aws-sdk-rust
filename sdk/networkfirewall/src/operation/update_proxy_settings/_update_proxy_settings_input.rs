...
impl UpdateProxySettingsInput {
    /// Creates a new builder-style object to manufacture [`UpdateProxySettingsInput`](crate::operation::update_proxy_settings::UpdateProxySettingsInput).
    pub fn builder() -> crate::operation::update_proxy_settings::builders::UpdateProxySettingsInputBuilder {
        crate::operation::update_proxy_settings::builders::UpdateProxySettingsInputBuilder::default()
    }
}

/// A builder for [`UpdateProxySettingsInput`](crate::operation::update_proxy_settings::UpdateProxySettingsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateProxySettingsInputBuilder {
...
impl UpdateProxySettingsInputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the firewall.</p>
    /// <p>You must specify the ARN or the name, and you can specify both.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateProxySettingsInput`](crate::operation::update_proxy_settings::UpdateProxySettingsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_proxy_settings::UpdateProxySettingsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::update_proxy_settings::UpdateProxySettingsInput {
