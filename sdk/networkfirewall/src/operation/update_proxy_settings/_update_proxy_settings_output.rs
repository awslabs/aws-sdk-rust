...
impl UpdateProxySettingsOutput {
    /// <p>The Amazon Resource Name (ARN) of the firewall.</p>
...
impl ::aws_types::request_id::RequestId for UpdateProxySettingsOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateProxySettingsOutput {
    /// Creates a new builder-style object to manufacture [`UpdateProxySettingsOutput`](crate::operation::update_proxy_settings::UpdateProxySettingsOutput).
    pub fn builder() -> crate::operation::update_proxy_settings::builders::UpdateProxySettingsOutputBuilder {
        crate::operation::update_proxy_settings::builders::UpdateProxySettingsOutputBuilder::default()
    }
}

/// A builder for [`UpdateProxySettingsOutput`](crate::operation::update_proxy_settings::UpdateProxySettingsOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateProxySettingsOutputBuilder {
...
impl UpdateProxySettingsOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the firewall.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateProxySettingsOutput`](crate::operation::update_proxy_settings::UpdateProxySettingsOutput).
    pub fn build(self) -> crate::operation::update_proxy_settings::UpdateProxySettingsOutput {
