...
impl CreateRuleGroup {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Network Firewall", "CreateRuleGroup", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRuleGroupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("Rules") {
            if let ::std::option::Option::Some(value) = input.rules.as_deref() {
                captured.insert("Rules", value);
            }
        }
