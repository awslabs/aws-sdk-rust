...
impl UpdateFirewallDeleteProtectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_firewall_delete_protection::UpdateFirewallDeleteProtectionInput, ::aws_smithy_types::error::operation::BuildError> {
