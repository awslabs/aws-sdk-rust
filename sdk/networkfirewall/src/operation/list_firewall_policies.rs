...
impl ListFirewallPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListFirewallPolicies`](crate::operation::list_firewall_policies::ListFirewallPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_firewall_policies::ListFirewallPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_firewall_policies::ListFirewallPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_firewall_policies::ser_list_firewall_policies_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_firewall_policies::ListFirewallPolicies::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListFirewallPolicies {
                type Output = std::result::Result<crate::operation::list_firewall_policies::ListFirewallPoliciesOutput, crate::operation::list_firewall_policies::ListFirewallPoliciesError>;
