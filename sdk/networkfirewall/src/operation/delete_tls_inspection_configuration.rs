...
impl DeleteTlsInspectionConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_tls_inspection_configuration::DeleteTLSInspectionConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTLSInspectionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_tls_inspection_configuration::de_delete_tls_inspection_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
