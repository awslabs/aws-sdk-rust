...
pub struct UpdateProxyConfigurationOutput {
...
impl UpdateProxyConfigurationOutput {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
...
impl ::aws_types::request_id::RequestId for UpdateProxyConfigurationOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateProxyConfigurationOutput {
    /// Creates a new builder-style object to manufacture [`UpdateProxyConfigurationOutput`](crate::operation::update_proxy_configuration::UpdateProxyConfigurationOutput).
    pub fn builder() -> crate::operation::update_proxy_configuration::builders::UpdateProxyConfigurationOutputBuilder {
        crate::operation::update_proxy_configuration::builders::UpdateProxyConfigurationOutputBuilder::default()
    }
}

/// A builder for [`UpdateProxyConfigurationOutput`](crate::operation::update_proxy_configuration::UpdateProxyConfigurationOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateProxyConfigurationOutputBuilder {
...
impl UpdateProxyConfigurationOutputBuilder {
    /// <p>The updated proxy configuration resource that reflects the updates from the request.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateProxyConfigurationOutput`](crate::operation::update_proxy_configuration::UpdateProxyConfigurationOutput).
    pub fn build(self) -> crate::operation::update_proxy_configuration::UpdateProxyConfigurationOutput {
