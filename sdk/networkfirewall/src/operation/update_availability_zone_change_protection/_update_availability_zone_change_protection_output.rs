...
pub struct UpdateAvailabilityZoneChangeProtectionOutput {
...
impl UpdateAvailabilityZoneChangeProtectionOutput {
    /// <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request.</p>
    /// <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>
    /// <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token.</p>
...
impl ::aws_types::request_id::RequestId for UpdateAvailabilityZoneChangeProtectionOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateAvailabilityZoneChangeProtectionOutput {
    /// Creates a new builder-style object to manufacture [`UpdateAvailabilityZoneChangeProtectionOutput`](crate::operation::update_availability_zone_change_protection::UpdateAvailabilityZoneChangeProtectionOutput).
    pub fn builder() -> crate::operation::update_availability_zone_change_protection::builders::UpdateAvailabilityZoneChangeProtectionOutputBuilder {
        crate::operation::update_availability_zone_change_protection::builders::UpdateAvailabilityZoneChangeProtectionOutputBuilder::default()
    }
}

/// A builder for [`UpdateAvailabilityZoneChangeProtectionOutput`](crate::operation::update_availability_zone_change_protection::UpdateAvailabilityZoneChangeProtectionOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateAvailabilityZoneChangeProtectionOutputBuilder {
...
impl UpdateAvailabilityZoneChangeProtectionOutputBuilder {
    /// <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request.</p>
    /// <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>
    /// <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateAvailabilityZoneChangeProtectionOutput`](crate::operation::update_availability_zone_change_protection::UpdateAvailabilityZoneChangeProtectionOutput).
    pub fn build(self) -> crate::operation::update_availability_zone_change_protection::UpdateAvailabilityZoneChangeProtectionOutput {
        crate::operation::update_availability_zone_change_protection::UpdateAvailabilityZoneChangeProtectionOutput {
