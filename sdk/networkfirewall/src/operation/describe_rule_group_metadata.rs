...
impl DescribeRuleGroupMetadataInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRuleGroupMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_rule_group_metadata::de_describe_rule_group_metadata_http_response_with_props(status, headers, body)
        }
    }
}
