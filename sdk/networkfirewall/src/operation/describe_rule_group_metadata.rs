...
/// Orchestration and serialization glue logic for `DescribeRuleGroupMetadata`.
...
impl DescribeRuleGroupMetadata {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeRuleGroupMetadata {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeRuleGroupMetadata");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeRuleGroupMetadataRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeRuleGroupMetadataResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeRuleGroupMetadata")
...
.with_interceptor(DescribeRuleGroupMetadataEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError>::new());
...
#[derive(Debug)]
            struct DescribeRuleGroupMetadataResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRuleGroupMetadataResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_rule_group_metadata::de_describe_rule_group_metadata_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_rule_group_metadata::de_describe_rule_group_metadata_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeRuleGroupMetadataRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRuleGroupMetadataRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_rule_group_metadata::ser_describe_rule_group_metadata_input(&input)?);
...
#[derive(Debug)]
            struct DescribeRuleGroupMetadataEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeRuleGroupMetadataEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeRuleGroupMetadataEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeRuleGroupMetadataInput>()
                        .ok_or("failed to downcast to DescribeRuleGroupMetadataInput")?;
...
pub enum DescribeRuleGroupMetadataError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeRuleGroupMetadataError) for what information is available for the error.")]
...
impl DescribeRuleGroupMetadataError {
    /// Creates the `DescribeRuleGroupMetadataError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeRuleGroupMetadataError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeRuleGroupMetadataError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataError {
...
mod _describe_rule_group_metadata_output;
