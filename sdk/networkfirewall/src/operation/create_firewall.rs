...
impl CreateFirewallInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_firewall::CreateFirewall, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_firewall::ser_create_firewall_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFirewall {
    type Output =
        ::std::result::Result<crate::operation::create_firewall::CreateFirewallOutput, crate::operation::create_firewall::CreateFirewallError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_firewall::de_create_firewall_http_response_with_props(status, headers, body)
        }
    }
}
