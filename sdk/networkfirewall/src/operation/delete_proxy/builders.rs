...
pub use crate::operation::delete_proxy::_delete_proxy_output::DeleteProxyOutputBuilder;

pub use crate::operation::delete_proxy::_delete_proxy_input::DeleteProxyInputBuilder;

impl crate::operation::delete_proxy::builders::DeleteProxyInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.delete_proxy();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `DeleteProxy`.
///
/// <p>Deletes the specified <code>Proxy</code>.</p>
/// <p>Detaches a Proxy configuration from a NAT Gateway.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct DeleteProxyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::delete_proxy::builders::DeleteProxyInputBuilder,
...
impl DeleteProxyFluentBuilder {
    /// Creates a new `DeleteProxyFluentBuilder`.
    ...
    /// Access the DeleteProxy as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_proxy::builders::DeleteProxyInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::delete_proxy::DeleteProxy::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::delete_proxy::DeleteProxy::orchestrate(&runtime_plugins, input).await
    }
