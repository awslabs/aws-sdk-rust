...
impl ListRuleGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_rule_groups::ListRuleGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_rule_groups::ser_list_rule_groups_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRuleGroups {
    type Output =
        ::std::result::Result<crate::operation::list_rule_groups::ListRuleGroupsOutput, crate::operation::list_rule_groups::ListRuleGroupsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_rule_groups::de_list_rule_groups_http_response_with_props(status, headers, body)
        }
    }
}
