...
impl DescribeFirewallInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_firewall::DescribeFirewall, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_firewall::ser_describe_firewall_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFirewall {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_firewall::de_describe_firewall_http_response_with_props(status, headers, body)
        }
    }
}
