    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::CreateRuleGroupInput::r#type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p>
    ...
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::DescribeRuleGroupInput::r#type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::DescribeRuleGroupMetadataInput::r#type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///   - [`r#type(Option<RuleGroupType>)`](crate::output::DescribeRuleGroupMetadataOutput::r#type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::UpdateRuleGroupInput::r#type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
