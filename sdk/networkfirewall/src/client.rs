    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AssociateFirewallPolicyInput`](crate::input::AssociateFirewallPolicyInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::AssociateFirewallPolicyInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::AssociateFirewallPolicyInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::AssociateFirewallPolicyInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy_arn(Option<String>)`](crate::input::AssociateFirewallPolicyInput::firewall_policy_arn): <p>The Amazon Resource Name (ARN) of the firewall policy.</p>
    ...
    ///
    /// - Takes [`AssociateSubnetsInput`](crate::input::AssociateSubnetsInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::AssociateSubnetsInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::AssociateSubnetsInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::AssociateSubnetsInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`subnet_mappings(Option<Vec<SubnetMapping>>)`](crate::input::AssociateSubnetsInput::subnet_mappings): <p>The IDs of the subnets that you want to associate with the firewall. </p>
    ...
    ///
    /// - Takes [`CreateFirewallInput`](crate::input::CreateFirewallInput) with field(s):
    ///   - [`firewall_name(Option<String>)`](crate::input::CreateFirewallInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>
    ///   - [`firewall_policy_arn(Option<String>)`](crate::input::CreateFirewallInput::firewall_policy_arn): <p>The Amazon Resource Name (ARN) of the <code>FirewallPolicy</code> that you want to use for the firewall.</p>
    ///   - [`vpc_id(Option<String>)`](crate::input::CreateFirewallInput::vpc_id): <p>The unique identifier of the VPC where Network Firewall should create the firewall. </p>  <p>You can't change this setting after you create the firewall. </p>
    ///   - [`subnet_mappings(Option<Vec<SubnetMapping>>)`](crate::input::CreateFirewallInput::subnet_mappings): <p>The public subnets to use for your Network Firewall firewalls. Each subnet must belong to a different Availability Zone in the VPC. Network Firewall creates a firewall endpoint in each subnet. </p>
    ///   - [`delete_protection(bool)`](crate::input::CreateFirewallInput::delete_protection): <p>A flag indicating whether it is possible to delete the firewall. A setting of <code>TRUE</code> indicates that the firewall is protected against deletion. Use this setting to protect against accidentally deleting a firewall that is in use. When you create a firewall, the operation initializes this flag to <code>TRUE</code>.</p>
    ///   - [`subnet_change_protection(bool)`](crate::input::CreateFirewallInput::subnet_change_protection): <p>A setting indicating whether the firewall is protected against changes to the subnet associations. Use this setting to protect against accidentally modifying the subnet associations for a firewall that is in use. When you create a firewall, the operation initializes this setting to <code>TRUE</code>.</p>
    ///   - [`firewall_policy_change_protection(bool)`](crate::input::CreateFirewallInput::firewall_policy_change_protection): <p>A setting indicating whether the firewall is protected against a change to the firewall policy association. Use this setting to protect against accidentally modifying the firewall policy for a firewall that is in use. When you create a firewall, the operation initializes this setting to <code>TRUE</code>.</p>
    ///   - [`description(Option<String>)`](crate::input::CreateFirewallInput::description): <p>A description of the firewall.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateFirewallInput::tags): <p>The key:value pairs to associate with the resource.</p>
    ...
    ///
    /// - Takes [`CreateFirewallPolicyInput`](crate::input::CreateFirewallPolicyInput) with field(s):
    ///   - [`firewall_policy_name(Option<String>)`](crate::input::CreateFirewallPolicyInput::firewall_policy_name): <p>The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.</p>
    ///   - [`firewall_policy(Option<FirewallPolicy>)`](crate::input::CreateFirewallPolicyInput::firewall_policy): <p>The rule groups and policy actions to use in the firewall policy.</p>
    ///   - [`description(Option<String>)`](crate::input::CreateFirewallPolicyInput::description): <p>A description of the firewall policy.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateFirewallPolicyInput::tags): <p>The key:value pairs to associate with the resource.</p>
    ///   - [`dry_run(bool)`](crate::input::CreateFirewallPolicyInput::dry_run): <p>Indicates whether you want Network Firewall to just check the validity of the request, rather than run the request. </p>  <p>If set to <code>TRUE</code>, Network Firewall checks whether the request can run successfully, but doesn't actually make the requested changes. The call returns the value that the request would return if you ran it with dry run set to <code>FALSE</code>, but doesn't make additions or changes to your resources. This option allows you to make sure that you have the required permissions to run the request and that your request parameters are valid. </p>  <p>If set to <code>FALSE</code>, Network Firewall makes the requested changes to your resources. </p>
    ...
    ///
    /// - Takes [`DeleteFirewallInput`](crate::input::DeleteFirewallInput) with field(s):
    ///   - [`firewall_name(Option<String>)`](crate::input::DeleteFirewallInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::DeleteFirewallInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ...
    ///
    /// - Takes [`DeleteFirewallPolicyInput`](crate::input::DeleteFirewallPolicyInput) with field(s):
    ///   - [`firewall_policy_name(Option<String>)`](crate::input::DeleteFirewallPolicyInput::firewall_policy_name): <p>The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy_arn(Option<String>)`](crate::input::DeleteFirewallPolicyInput::firewall_policy_arn): <p>The Amazon Resource Name (ARN) of the firewall policy.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::DeleteResourcePolicyInput::resource_arn): <p>The Amazon Resource Name (ARN) of the rule group or firewall policy whose resource policy you want to delete. </p>
    ...
    ///   - [`rule_group_name(Option<String>)`](crate::input::DeleteRuleGroupInput::rule_group_name): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group_arn(Option<String>)`](crate::input::DeleteRuleGroupInput::rule_group_arn): <p>The Amazon Resource Name (ARN) of the rule group.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::DeleteRuleGroupInput::type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///
    /// - Takes [`DescribeFirewallInput`](crate::input::DescribeFirewallInput) with field(s):
    ///   - [`firewall_name(Option<String>)`](crate::input::DescribeFirewallInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::DescribeFirewallInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ...
    ///
    /// - Takes [`DescribeFirewallPolicyInput`](crate::input::DescribeFirewallPolicyInput) with field(s):
    ///   - [`firewall_policy_name(Option<String>)`](crate::input::DescribeFirewallPolicyInput::firewall_policy_name): <p>The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy_arn(Option<String>)`](crate::input::DescribeFirewallPolicyInput::firewall_policy_arn): <p>The Amazon Resource Name (ARN) of the firewall policy.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ...
    ///
    /// - Takes [`DescribeLoggingConfigurationInput`](crate::input::DescribeLoggingConfigurationInput) with field(s):
    ///   - [`firewall_arn(Option<String>)`](crate::input::DescribeLoggingConfigurationInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::DescribeLoggingConfigurationInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ...
    ///
    /// - Takes [`DescribeResourcePolicyInput`](crate::input::DescribeResourcePolicyInput) with field(s):
    ///   - [`resource_arn(Option<String>)`](crate::input::DescribeResourcePolicyInput::resource_arn): <p>The Amazon Resource Name (ARN) of the rule group or firewall policy whose resource policy you want to retrieve. </p>
    ...
    ///
    /// - Takes [`DescribeRuleGroupInput`](crate::input::DescribeRuleGroupInput) with field(s):
    ///   - [`rule_group_name(Option<String>)`](crate::input::DescribeRuleGroupInput::rule_group_name): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group_arn(Option<String>)`](crate::input::DescribeRuleGroupInput::rule_group_arn): <p>The Amazon Resource Name (ARN) of the rule group.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::DescribeRuleGroupInput::type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///
    /// - Takes [`DescribeRuleGroupMetadataInput`](crate::input::DescribeRuleGroupMetadataInput) with field(s):
    ///   - [`rule_group_name(Option<String>)`](crate::input::DescribeRuleGroupMetadataInput::rule_group_name): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group_arn(Option<String>)`](crate::input::DescribeRuleGroupMetadataInput::rule_group_arn): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::DescribeRuleGroupMetadataInput::type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ...
    ///
    /// - Takes [`DisassociateSubnetsInput`](crate::input::DisassociateSubnetsInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::DisassociateSubnetsInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::DisassociateSubnetsInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::DisassociateSubnetsInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`subnet_ids(Option<Vec<String>>)`](crate::input::DisassociateSubnetsInput::subnet_ids): <p>The unique identifiers for the subnets that you want to disassociate. </p>
    ...
    ///
    /// - Takes [`ListFirewallPoliciesInput`](crate::input::ListFirewallPoliciesInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListFirewallPoliciesInput::next_token): <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListFirewallPoliciesInput::max_results): <p>The maximum number of objects that you want Network Firewall to return for this request. If more objects are available, in the response, Network Firewall provides a <code>NextToken</code> value that you can use in a subsequent call to get the next batch of objects.</p>
    ...
    ///
    /// - Takes [`ListFirewallsInput`](crate::input::ListFirewallsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListFirewallsInput::next_token): <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    ///   - [`vpc_ids(Option<Vec<String>>)`](crate::input::ListFirewallsInput::vpc_ids): <p>The unique identifiers of the VPCs that you want Network Firewall to retrieve the firewalls for. Leave this blank to retrieve all firewalls that you have defined.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListFirewallsInput::max_results): <p>The maximum number of objects that you want Network Firewall to return for this request. If more objects are available, in the response, Network Firewall provides a <code>NextToken</code> value that you can use in a subsequent call to get the next batch of objects.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListRuleGroupsInput::next_token): <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListRuleGroupsInput::max_results): <p>The maximum number of objects that you want Network Firewall to return for this request. If more objects are available, in the response, Network Firewall provides a <code>NextToken</code> value that you can use in a subsequent call to get the next batch of objects.</p>
    ///   - [`scope(Option<ResourceManagedStatus>)`](crate::input::ListRuleGroupsInput::scope): <p>The scope of the request. The default setting of <code>ACCOUNT</code> or a setting of <code>NULL</code> returns all of the rule groups in your account. A setting of <code>MANAGED</code> returns all available managed rule groups.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListTagsForResourceInput::next_token): <p>When you request a list of objects with a <code>MaxResults</code> setting, if the number of objects that are still available for retrieval exceeds the maximum you requested, Network Firewall returns a <code>NextToken</code> value in the response. To retrieve the next batch of objects, use the token returned from the prior request in your next request.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTagsForResourceInput::max_results): <p>The maximum number of objects that you want Network Firewall to return for this request. If more objects are available, in the response, Network Firewall provides a <code>NextToken</code> value that you can use in a subsequent call to get the next batch of objects.</p>
    ...
    ///
    /// - Takes [`UpdateFirewallDeleteProtectionInput`](crate::input::UpdateFirewallDeleteProtectionInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::UpdateFirewallDeleteProtectionInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::UpdateFirewallDeleteProtectionInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::UpdateFirewallDeleteProtectionInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`delete_protection(bool)`](crate::input::UpdateFirewallDeleteProtectionInput::delete_protection): <p>A flag indicating whether it is possible to delete the firewall. A setting of <code>TRUE</code> indicates that the firewall is protected against deletion. Use this setting to protect against accidentally deleting a firewall that is in use. When you create a firewall, the operation initializes this flag to <code>TRUE</code>.</p>
    ...
    ///
    /// - Takes [`UpdateFirewallDescriptionInput`](crate::input::UpdateFirewallDescriptionInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::UpdateFirewallDescriptionInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::UpdateFirewallDescriptionInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::UpdateFirewallDescriptionInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`description(Option<String>)`](crate::input::UpdateFirewallDescriptionInput::description): <p>The new description for the firewall. If you omit this setting, Network Firewall removes the description for the firewall.</p>
    ...
    ///
    /// - Takes [`UpdateFirewallPolicyInput`](crate::input::UpdateFirewallPolicyInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::UpdateFirewallPolicyInput::update_token): <p>A token used for optimistic locking. Network Firewall returns a token to your requests that access the firewall policy. The token marks the state of the policy resource at the time of the request. </p>  <p>To make changes to the policy, you provide the token in your request. Network Firewall uses the token to ensure that the policy hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall policy again to get a current copy of it with current token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_policy_arn(Option<String>)`](crate::input::UpdateFirewallPolicyInput::firewall_policy_arn): <p>The Amazon Resource Name (ARN) of the firewall policy.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy_name(Option<String>)`](crate::input::UpdateFirewallPolicyInput::firewall_policy_name): <p>The descriptive name of the firewall policy. You can't change the name of a firewall policy after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy(Option<FirewallPolicy>)`](crate::input::UpdateFirewallPolicyInput::firewall_policy): <p>The updated firewall policy to use for the firewall. </p>
    ///   - [`description(Option<String>)`](crate::input::UpdateFirewallPolicyInput::description): <p>A description of the firewall policy.</p>
    ///   - [`dry_run(bool)`](crate::input::UpdateFirewallPolicyInput::dry_run): <p>Indicates whether you want Network Firewall to just check the validity of the request, rather than run the request. </p>  <p>If set to <code>TRUE</code>, Network Firewall checks whether the request can run successfully, but doesn't actually make the requested changes. The call returns the value that the request would return if you ran it with dry run set to <code>FALSE</code>, but doesn't make additions or changes to your resources. This option allows you to make sure that you have the required permissions to run the request and that your request parameters are valid. </p>  <p>If set to <code>FALSE</code>, Network Firewall makes the requested changes to your resources. </p>
    ...
    ///
    /// - Takes [`UpdateFirewallPolicyChangeProtectionInput`](crate::input::UpdateFirewallPolicyChangeProtectionInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::UpdateFirewallPolicyChangeProtectionInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::UpdateFirewallPolicyChangeProtectionInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::UpdateFirewallPolicyChangeProtectionInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_policy_change_protection(bool)`](crate::input::UpdateFirewallPolicyChangeProtectionInput::firewall_policy_change_protection): <p>A setting indicating whether the firewall is protected against a change to the firewall policy association. Use this setting to protect against accidentally modifying the firewall policy for a firewall that is in use. When you create a firewall, the operation initializes this setting to <code>TRUE</code>.</p>
    ...
    ///
    /// - Takes [`UpdateLoggingConfigurationInput`](crate::input::UpdateLoggingConfigurationInput) with field(s):
    ///   - [`firewall_arn(Option<String>)`](crate::input::UpdateLoggingConfigurationInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::UpdateLoggingConfigurationInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`logging_configuration(Option<LoggingConfiguration>)`](crate::input::UpdateLoggingConfigurationInput::logging_configuration): <p>Defines how Network Firewall performs logging for a firewall. If you omit this setting, Network Firewall disables logging for the firewall.</p>
    ...
    ///   - [`update_token(Option<String>)`](crate::input::UpdateRuleGroupInput::update_token): <p>A token used for optimistic locking. Network Firewall returns a token to your requests that access the rule group. The token marks the state of the rule group resource at the time of the request. </p>  <p>To make changes to the rule group, you provide the token in your request. Network Firewall uses the token to ensure that the rule group hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the rule group again to get a current copy of it with a current token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`rule_group_arn(Option<String>)`](crate::input::UpdateRuleGroupInput::rule_group_arn): <p>The Amazon Resource Name (ARN) of the rule group.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group_name(Option<String>)`](crate::input::UpdateRuleGroupInput::rule_group_name): <p>The descriptive name of the rule group. You can't change the name of a rule group after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`rule_group(Option<RuleGroup>)`](crate::input::UpdateRuleGroupInput::rule_group): <p>An object that defines the rule group rules. </p> <note>   <p>You must provide either this rule group setting or a <code>Rules</code> setting, but not both. </p>  </note>
    ///   - [`rules(Option<String>)`](crate::input::UpdateRuleGroupInput::rules): <p>A string containing stateful rule group rules specifications in Suricata flat format, with one rule per line. Use this to import your existing Suricata compatible rule groups. </p> <note>   <p>You must provide either this rules setting or a populated <code>RuleGroup</code> setting, but not both. </p>  </note>  <p>You can provide your rule group specification in Suricata flat format through this setting when you create or update your rule group. The call response returns a <code>RuleGroup</code> object that Network Firewall has populated from your string. </p>
    ///   - [`r#type(Option<RuleGroupType>)`](crate::input::UpdateRuleGroupInput::type): <p>Indicates whether the rule group is stateless or stateful. If the rule group is stateless, it contains stateless rules. If it is stateful, it contains stateful rules. </p> <note>   <p>This setting is required for requests that do not include the <code>RuleGroupARN</code>.</p>  </note>
    ///   - [`description(Option<String>)`](crate::input::UpdateRuleGroupInput::description): <p>A description of the rule group. </p>
    ///   - [`dry_run(bool)`](crate::input::UpdateRuleGroupInput::dry_run): <p>Indicates whether you want Network Firewall to just check the validity of the request, rather than run the request. </p>  <p>If set to <code>TRUE</code>, Network Firewall checks whether the request can run successfully, but doesn't actually make the requested changes. The call returns the value that the request would return if you ran it with dry run set to <code>FALSE</code>, but doesn't make additions or changes to your resources. This option allows you to make sure that you have the required permissions to run the request and that your request parameters are valid. </p>  <p>If set to <code>FALSE</code>, Network Firewall makes the requested changes to your resources. </p>
    ...
    ///
    /// - Takes [`UpdateSubnetChangeProtectionInput`](crate::input::UpdateSubnetChangeProtectionInput) with field(s):
    ///   - [`update_token(Option<String>)`](crate::input::UpdateSubnetChangeProtectionInput::update_token): <p>An optional token that you can use for optimistic locking. Network Firewall returns a token to your requests that access the firewall. The token marks the state of the firewall resource at the time of the request. </p>  <p>To make an unconditional change to the firewall, omit the token in your update request. Without the token, Network Firewall performs your updates regardless of whether the firewall has changed since you last retrieved it.</p>  <p>To make a conditional change to the firewall, provide the token in your update request. Network Firewall uses the token to ensure that the firewall hasn't changed since you last retrieved it. If it has changed, the operation fails with an <code>InvalidTokenException</code>. If this happens, retrieve the firewall again to get a current copy of it with a new token. Reapply your changes as needed, then try the operation again using the new token. </p>
    ///   - [`firewall_arn(Option<String>)`](crate::input::UpdateSubnetChangeProtectionInput::firewall_arn): <p>The Amazon Resource Name (ARN) of the firewall.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`firewall_name(Option<String>)`](crate::input::UpdateSubnetChangeProtectionInput::firewall_name): <p>The descriptive name of the firewall. You can't change the name of a firewall after you create it.</p>  <p>You must specify the ARN or the name, and you can specify both. </p>
    ///   - [`subnet_change_protection(bool)`](crate::input::UpdateSubnetChangeProtectionInput::subnet_change_protection): <p>A setting indicating whether the firewall is protected against changes to the subnet associations. Use this setting to protect against accidentally modifying the subnet associations for a firewall that is in use. When you create a firewall, the operation initializes this setting to <code>TRUE</code>.</p>
