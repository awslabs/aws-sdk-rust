...
pub struct UpdateRuleGroupOutput  {
    ...
    #[doc(hidden)]pub rule_group_response: std::option::Option<crate::model::RuleGroupResponse>,
}
...
pub struct UpdateFirewallPolicyOutput  {
    ...
    #[doc(hidden)]pub firewall_policy_response: std::option::Option<crate::model::FirewallPolicyResponse>,
}
...
pub struct ListRuleGroupsOutput  {
    ...
    #[doc(hidden)]pub rule_groups: std::option::Option<std::vec::Vec<crate::model::RuleGroupMetadata>>,
}
...
pub struct ListFirewallsOutput  {
    ...
    #[doc(hidden)]pub firewalls: std::option::Option<std::vec::Vec<crate::model::FirewallMetadata>>,
}
...
pub struct ListFirewallPoliciesOutput  {
    ...
    #[doc(hidden)]pub firewall_policies: std::option::Option<std::vec::Vec<crate::model::FirewallPolicyMetadata>>,
}
...
pub struct DescribeRuleGroupMetadataOutput  {
    ...
    #[doc(hidden)]pub stateful_rule_options: std::option::Option<crate::model::StatefulRuleOptions>,
...
pub struct DescribeFirewallOutput  {
    ...
    #[doc(hidden)]pub firewall: std::option::Option<crate::model::Firewall>,
    ...
    #[doc(hidden)]pub firewall_status: std::option::Option<crate::model::FirewallStatus>,
}
