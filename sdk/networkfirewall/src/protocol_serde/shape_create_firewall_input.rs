...
pub fn ser_create_firewall_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFirewallInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
