...
pub fn ser_list_firewalls_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFirewallsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
