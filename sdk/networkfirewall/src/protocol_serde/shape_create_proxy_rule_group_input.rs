...
pub fn ser_create_proxy_rule_group_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::create_proxy_rule_group::CreateProxyRuleGroupInput,
    ...
    if let Some(var_3) = &input.rules {
        ...
        crate::protocol_serde::shape_proxy_rules_by_request_phase::ser_proxy_rules_by_request_phase(&mut object_4, var_3)?;
        object_4.finish();
    }
