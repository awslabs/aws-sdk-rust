...
pub(crate) fn de_firewall_policy_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FirewallPolicyResponse>, aws_smithy_json::deserialize::error::DeserializeError>
