...
pub fn ser_header(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Header) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_header<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Header>, aws_smithy_json::deserialize::error::DeserializeError>
