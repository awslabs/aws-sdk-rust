...
pub fn ser_update_firewall_description_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFirewallDescriptionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
