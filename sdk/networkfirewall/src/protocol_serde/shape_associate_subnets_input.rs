...
pub fn ser_associate_subnets_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateSubnetsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
