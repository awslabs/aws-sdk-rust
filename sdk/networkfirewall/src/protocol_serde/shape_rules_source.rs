...
pub fn ser_rules_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RulesSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rules_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RulesSource>, aws_smithy_json::deserialize::error::DeserializeError>
