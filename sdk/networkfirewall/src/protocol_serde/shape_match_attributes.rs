...
pub fn ser_match_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MatchAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_match_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MatchAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
