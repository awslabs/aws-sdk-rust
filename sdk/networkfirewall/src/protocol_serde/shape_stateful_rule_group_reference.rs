...
pub fn ser_stateful_rule_group_reference(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::StatefulRuleGroupReference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
