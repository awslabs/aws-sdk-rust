...
pub fn ser_update_firewall_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFirewallPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
