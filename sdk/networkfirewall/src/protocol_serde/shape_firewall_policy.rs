...
pub fn ser_firewall_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FirewallPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_firewall_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FirewallPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
