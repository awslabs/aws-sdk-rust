...
) -> Result<Option<crate::types::RuleGroupResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::RuleGroupType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Capacity" => {
                        ...
                        "SourceMetadata" => {
                            builder = builder.set_source_metadata(crate::protocol_serde::shape_source_metadata::de_source_metadata(tokens)?);
                        }
                        "SnsTopic" => {
            ...
            Ok(Some(crate::serde_util::rule_group_response_correct_errors(builder).build().map_err(
