...
pub(crate) fn de_rule_group_response<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RuleGroupResponse>, aws_smithy_json::deserialize::error::DeserializeError>
