...
pub fn ser_describe_rule_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_rule_group::DescribeRuleGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
