...
pub(crate) fn de_port_ranges<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::PortRange>>, aws_smithy_json::deserialize::error::DeserializeError>
