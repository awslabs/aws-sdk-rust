...
pub(crate) fn reflens_list_tls_inspection_configurations_output_next_token(
...
pub(crate) fn lens_list_tls_inspection_configurations_output_tls_inspection_configurations(
    input: crate::operation::list_tls_inspection_configurations::ListTlsInspectionConfigurationsOutput,
