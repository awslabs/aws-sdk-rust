...
impl CreateFhirDatastoreInput {
    ...
    > {
        Ok({
            ...
            let body =
                crate::operation_ser::serialize_operation_crate_operation_create_fhir_datastore(
                    &self,
                )
                .map_err(|err| {
...
impl DeleteFhirDatastoreInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_delete_fhir_datastore(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
impl ListFhirDatastoresInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_list_fhir_datastores(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
pub mod list_fhir_export_jobs_input {
    ...
    pub struct Builder {
        ...
        pub(crate) submitted_before: std::option::Option<smithy_types::Instant>,
        pub(crate) submitted_after: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>
...
impl ListFhirExportJobsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_list_fhir_export_jobs(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
impl ListFhirImportJobsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_list_fhir_import_jobs(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
impl StartFhirExportJobInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_start_fhir_export_job(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
impl StartFhirImportJobInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_start_fhir_import_job(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
pub struct ListFhirImportJobsInput {
    ...
    /// This parameter limits the response to FHIR import jobs submitted before a user specified date.
    /// </p>
    pub submitted_before: std::option::Option<smithy_types::Instant>,
    /// <p>
    /// This parameter limits the response to FHIR import jobs submitted after a user specified date.
    /// </p>
    pub submitted_after: std::option::Option<smithy_types::Instant>,
}
