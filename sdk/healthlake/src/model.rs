...
impl OutputDataConfig {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`S3Configuration`](crate::model::OutputDataConfig::S3Configuration), extracting the inner [`S3Configuration`](crate::model::S3Configuration).
...
impl InputDataConfig {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`S3Uri`](crate::model::InputDataConfig::S3Uri), extracting the inner [`String`](std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct PreloadDataConfig  {
    ...
    #[doc(hidden)]pub preload_data_type: std::option::Option<crate::model::PreloadDataType>,
}
...
pub struct KmsEncryptionConfig  {
    ...
    #[doc(hidden)]pub cmk_type: std::option::Option<crate::model::CmkType>,
