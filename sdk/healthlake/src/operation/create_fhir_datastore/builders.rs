...
impl CreateFHIRDatastoreFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_fhir_datastore::CreateFhirDatastoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_fhir_datastore::CreateFHIRDatastoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_fhir_datastore::CreateFhirDatastoreOutput, crate::operation::create_fhir_datastore::CreateFHIRDatastoreError, Self> {
