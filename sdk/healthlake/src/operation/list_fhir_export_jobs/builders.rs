...
impl ListFHIRExportJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_fhir_export_jobs::ListFhirExportJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_fhir_export_jobs::ListFHIRExportJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_fhir_export_jobs::ListFhirExportJobsOutput, crate::operation::list_fhir_export_jobs::ListFHIRExportJobsError, Self> {
