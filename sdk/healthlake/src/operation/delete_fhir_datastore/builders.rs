...
impl DeleteFHIRDatastoreFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fhir_datastore::DeleteFHIRDatastoreError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput, crate::operation::delete_fhir_datastore::DeleteFHIRDatastoreError, Self> {
