...
pub use crate::operation::list_fhir_import_jobs::_list_fhir_import_jobs_output::ListFhirImportJobsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_fhir_import_jobs::ListFhirImportJobsOutput,
                    crate::operation::list_fhir_import_jobs::ListFHIRImportJobsError,
                > for ListFHIRImportJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListFHIRImportJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_fhir_import_jobs::ListFhirImportJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_fhir_import_jobs::ListFHIRImportJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_fhir_import_jobs::ListFHIRImportJobs::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_fhir_import_jobs::ListFHIRImportJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_fhir_import_jobs::ListFhirImportJobsOutput, crate::operation::list_fhir_import_jobs::ListFHIRImportJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_fhir_import_jobs::paginator::ListFhirImportJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
