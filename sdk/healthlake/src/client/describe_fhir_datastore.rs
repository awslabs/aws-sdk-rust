...
impl super::Client {
    ...
    ///   - [`datastore_properties(Option<DatastoreProperties>)`](crate::operation::describe_fhir_datastore::DescribeFhirDatastoreOutput::datastore_properties): <p>The data store properties.</p>
