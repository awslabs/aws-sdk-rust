...
impl super::Client {
    ...
    ///   - [`datastore_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fhir_import_job::builders::DescribeFHIRImportJobFluentBuilder::datastore_id) / [`set_datastore_id(Option<String>)`](crate::operation::describe_fhir_import_job::builders::DescribeFHIRImportJobFluentBuilder::set_datastore_id): <p>The AWS-generated ID of the data store.</p>
    ///   - [`job_id(impl ::std::convert::Into<String>)`](crate::operation::describe_fhir_import_job::builders::DescribeFHIRImportJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_fhir_import_job::builders::DescribeFHIRImportJobFluentBuilder::set_job_id): <p>The AWS-generated job ID.</p>
