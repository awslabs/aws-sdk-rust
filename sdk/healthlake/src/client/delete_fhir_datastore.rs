...
impl super::Client {
    ...
    ///   - [`datastore_id(String)`](crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput::datastore_id): <p>The Amazon Web Services-generated ID for the deleted data store.</p>
    ///   - [`datastore_arn(String)`](crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput::datastore_arn): <p>The Amazon Resource Name (ARN) that grants access permission to HealthLake.</p>
    ...
    ///   - [`datastore_endpoint(String)`](crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput::datastore_endpoint): <p>The Amazon Web Services endpoint of the data store to be deleted.</p>
