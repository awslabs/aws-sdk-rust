...
impl super::Client {
    ...
    ///   - [`datastore_arn(Option<String>)`](crate::operation::delete_fhir_datastore::DeleteFhirDatastoreOutput::datastore_arn): <p>The Amazon Resource Name (ARN) that gives AWS HealthLake access permission.</p>
