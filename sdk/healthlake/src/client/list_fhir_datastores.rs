...
impl super::Client {
    ...
    ///   - [`datastore_properties_list(Vec::<DatastoreProperties>)`](crate::operation::list_fhir_datastores::ListFhirDatastoresOutput::datastore_properties_list): <p>The properties associated with all listed data stores.</p>
    ///   - [`next_token(Option<String>)`](crate::operation::list_fhir_datastores::ListFhirDatastoresOutput::next_token): <p>The pagination token used to retrieve the next page of results.</p>
