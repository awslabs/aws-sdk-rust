...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_fhir_datastores::builders::ListFHIRDatastoresFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_fhir_datastores::builders::ListFHIRDatastoresFluentBuilder::set_next_token): <p>Fetches the next page of data stores when results are paginated.</p>
