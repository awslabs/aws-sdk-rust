...
impl super::Client {
    ...
    ///   - [`datastore_name(impl ::std::convert::Into<String>)`](crate::operation::create_fhir_datastore::builders::CreateFHIRDatastoreFluentBuilder::datastore_name) / [`set_datastore_name(Option<String>)`](crate::operation::create_fhir_datastore::builders::CreateFHIRDatastoreFluentBuilder::set_datastore_name): <p>The user generated name for the data store.</p>
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_fhir_datastore::builders::CreateFHIRDatastoreFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_fhir_datastore::builders::CreateFHIRDatastoreFluentBuilder::set_client_token): <p>Optional user provided token used for ensuring idempotency.</p>
    ...
    ///   - [`datastore_arn(Option<String>)`](crate::operation::create_fhir_datastore::CreateFhirDatastoreOutput::datastore_arn): <p>The data store ARN is generated during the creation of the data store and can be found in the output from the initial data store creation call.</p>
