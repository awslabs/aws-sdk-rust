...
pub fn ser_start_fhir_export_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_fhir_export_job::StartFhirExportJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.datastore_id {
        object.key("DatastoreId").string(var_4.as_str());
    }
