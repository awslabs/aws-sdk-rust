...
pub struct IdentityProviderConfiguration {
    /// <p>The authorization strategy selected when the HealthLake data store is created.</p><note>
    /// <p>HealthLake provides support for both SMART on FHIR V1 and V2 as described below.</p>
    /// <ul>
    /// <li>
    /// <p><code>SMART_ON_FHIR_V1</code> – Support for only SMART on FHIR V1, which includes <code>read</code> (read/search) and <code>write</code> (create/update/delete) permissions.</p></li>
    /// <li>
