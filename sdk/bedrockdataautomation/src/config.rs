...
/// Configuration for a aws_sdk_bedrockdataautomation service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_bedrockdataautomation::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_bedrockdataautomation::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_bedrockdataautomation::Config::builder();
    ...
    /// impl aws_sdk_bedrockdataautomation::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_bedrockdataautomation::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_bedrockdataautomation::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_bedrockdataautomation::Client::from_conf(config);
    /// ```
    ...
    /// rules for `aws_sdk_bedrockdataautomation`.
    ///
    ///
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_bedrockdataautomation::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_bedrockdataautomation::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::Config;
    /// use aws_sdk_bedrockdataautomation::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_bedrockdataautomation::config::Config;
    /// use aws_sdk_bedrockdataautomation::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `bedrockdataautomation`
    /// (or `bedrockdataautomation-<region>` if a region is configured).
    /// All Bedrock Data Automation clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::Config;
    /// use aws_sdk_bedrockdataautomation::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::Config;
    /// use aws_sdk_bedrockdataautomation::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::IdentityCache;
    ///
    /// let config = aws_sdk_bedrockdataautomation::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_bedrockdataautomation::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_bedrockdataautomation::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_bedrockdataautomation::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_bedrockdataautomation::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AmazonBedrockKeystoneBuildTimeService");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_bedrockdataautomation::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "bedrockdataautomation";
    ...
    let scope = "aws-sdk-bedrockdataautomation";
