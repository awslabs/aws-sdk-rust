...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_blueprint::builders::CreateBlueprintFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_blueprint::builders::CreateBlueprintFluentBuilder::set_tags):<br>required: **false**<br>List of tags<br>
