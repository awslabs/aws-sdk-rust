                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "types" => {
                            builder = builder.set_types(
                                crate::protocol_serde::shape_audio_extraction_category_types::de_audio_extraction_category_types(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "typeConfiguration" => {
                            builder = builder.set_type_configuration(
                                    crate::protocol_serde::shape_audio_extraction_category_type_configuration::de_audio_extraction_category_type_configuration(tokens, _value, depth + 1)?
                                );
                        }
