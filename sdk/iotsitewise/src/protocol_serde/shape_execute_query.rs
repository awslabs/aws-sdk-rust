...
pub(crate) fn de_execute_query(
    ...
    crate::operation::execute_query::builders::ExecuteQueryOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "columns" => {
                    builder = builder.set_columns(crate::protocol_serde::shape_columns_list::de_columns_list(tokens, _value, depth + 1)?);
                }
                "nextToken" => {
                ...
                "rows" => {
                    builder = builder.set_rows(crate::protocol_serde::shape_rows::de_rows(tokens, _value, depth + 1)?);
                }
