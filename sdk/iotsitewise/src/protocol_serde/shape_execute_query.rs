...
pub fn de_execute_query_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_execute_query::de_execute_query(_response_body, output)
            .map_err(crate::operation::execute_query::ExecuteQueryError::unhandled)?;
...
pub(crate) fn de_execute_query(
    value: &[u8],
    mut builder: crate::operation::execute_query::builders::ExecuteQueryOutputBuilder,
) -> Result<crate::operation::execute_query::builders::ExecuteQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "columns" => {
                    builder = builder.set_columns(crate::protocol_serde::shape_columns_list::de_columns_list(tokens)?);
                }
                "nextToken" => {
                ...
                "rows" => {
                    builder = builder.set_rows(crate::protocol_serde::shape_rows::de_rows(tokens)?);
                }
