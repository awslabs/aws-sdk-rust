...
pub fn ser_disassociate_time_series_from_asset_property_input(
    ...
    crate::protocol_serde::shape_disassociate_time_series_from_asset_property_input::ser_disassociate_time_series_from_asset_property_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_time_series_from_asset_property::DisassociateTimeSeriesFromAssetPropertyError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::disassociate_time_series_from_asset_property::DisassociateTimeSeriesFromAssetPropertyError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_time_series_from_asset_property_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
