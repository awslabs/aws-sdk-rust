...
pub(crate) fn de_trace_payload(input: &[u8]) -> ::std::result::Result<crate::types::Trace, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
    let tokens = &mut tokens_owned;
    let result = crate::protocol_serde::shape_trace::de_trace(tokens)?
