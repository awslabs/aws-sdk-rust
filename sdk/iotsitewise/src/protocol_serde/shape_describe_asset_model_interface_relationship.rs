...
pub fn de_describe_asset_model_interface_relationship_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::unhandled,
                        )?;
        ...
        "InvalidRequestException" => {
            crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_asset_model_interface_relationship_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_asset_model_interface_relationship::de_describe_asset_model_interface_relationship(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_asset_model_interface_relationship_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_asset_model_interface_relationship::DescribeAssetModelInterfaceRelationshipError::unhandled)?
    })
}
