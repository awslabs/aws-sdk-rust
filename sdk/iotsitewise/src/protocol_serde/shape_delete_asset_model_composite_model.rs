...
pub fn de_delete_asset_model_composite_model_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::delete_asset_model_composite_model::DeleteAssetModelCompositeModelError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_asset_model_composite_model_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_asset_model_composite_model::de_delete_asset_model_composite_model(_response_body, output)
            .map_err(crate::operation::delete_asset_model_composite_model::DeleteAssetModelCompositeModelError::unhandled)?;
