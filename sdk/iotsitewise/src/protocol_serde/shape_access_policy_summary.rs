...
pub(crate) fn de_access_policy_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AccessPolicySummary>, aws_smithy_json::deserialize::error::DeserializeError>
