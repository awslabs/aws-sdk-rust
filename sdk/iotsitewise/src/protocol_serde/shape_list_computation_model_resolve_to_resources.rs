...
pub fn de_list_computation_model_resolve_to_resources_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::InternalFailureException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::unhandled,
                        )?;
        ...
        _ => crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_list_computation_model_resolve_to_resources_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_computation_model_resolve_to_resources::de_list_computation_model_resolve_to_resources(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_computation_model_resolve_to_resources_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_computation_model_resolve_to_resources::ListComputationModelResolveToResourcesError::unhandled)?
    })
}

pub(crate) fn de_list_computation_model_resolve_to_resources(
    _value: &[u8],
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "computationModelResolveToResourceSummaries" => {
                    builder = builder.set_computation_model_resolve_to_resource_summaries(
                            crate::protocol_serde::shape_computation_model_resolve_to_resource_summaries::de_computation_model_resolve_to_resource_summaries(tokens, _value, depth + 1)?
                        );
                }
                "nextToken" => {
