...
pub fn ser_property_type(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::PropertyType,
...
pub(crate) fn de_property_type<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::PropertyType>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "attribute" => {
                            builder = builder.set_attribute(crate::protocol_serde::shape_attribute::de_attribute(tokens, _value, depth + 1)?);
                        }
                        "measurement" => {
                            builder = builder.set_measurement(crate::protocol_serde::shape_measurement::de_measurement(tokens, _value, depth + 1)?);
                        }
                        "transform" => {
                            builder = builder.set_transform(crate::protocol_serde::shape_transform::de_transform(tokens, _value, depth + 1)?);
                        }
                        "metric" => {
                            builder = builder.set_metric(crate::protocol_serde::shape_metric::de_metric(tokens, _value, depth + 1)?);
                        }
