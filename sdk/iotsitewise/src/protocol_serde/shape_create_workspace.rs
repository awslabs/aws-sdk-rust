...
pub fn de_create_workspace_http_error(
    ...
    Err(match error_code {
        ...
        "ConflictingOperationException" => crate::operation::create_workspace::CreateWorkspaceError::ConflictingOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalFailureException" => crate::operation::create_workspace::CreateWorkspaceError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
