...
pub fn de_delete_asset_model_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_asset_model::DeleteAssetModelOutput, crate::operation::delete_asset_model::DeleteAssetModelError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "PreconditionFailedException" => crate::operation::delete_asset_model::DeleteAssetModelError::PreconditionFailedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_asset_model_headers(
    input: &crate::operation::delete_asset_model::DeleteAssetModelInput,
...
) -> Result<crate::operation::delete_asset_model::builders::DeleteAssetModelOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
