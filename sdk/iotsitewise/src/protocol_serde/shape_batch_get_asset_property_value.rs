...
> {
    ...
    Err(match error_code {
        ...
        "ServiceUnavailableException" => {
            crate::operation::batch_get_asset_property_value::BatchGetAssetPropertyValueError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::batch_get_asset_property_value_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::batch_get_asset_property_value::BatchGetAssetPropertyValueError::unhandled)?
    })
}
                ...
                match key.to_unescaped()?.as_ref() {
                    "errorEntries" => {
                        builder = builder.set_error_entries(
                            crate::protocol_serde::shape_batch_get_asset_property_value_error_entries::de_batch_get_asset_property_value_error_entries(tokens, _value, depth + 1)?
                        );
                    }
                    "nextToken" => {
                    ...
                    "skippedEntries" => {
                        builder = builder.set_skipped_entries(
                            crate::protocol_serde::shape_batch_get_asset_property_value_skipped_entries::de_batch_get_asset_property_value_skipped_entries(tokens, _value, depth + 1)?
                        );
                    }
                    "successEntries" => {
                        builder = builder.set_success_entries(
                            crate::protocol_serde::shape_batch_get_asset_property_value_success_entries::de_batch_get_asset_property_value_success_entries(tokens, _value, depth + 1)?
                        );
                    }
