...
pub fn de_list_applications_http_error(
    ...
    Err(match error_code {
        ...
        "InternalFailureException" => crate::operation::list_applications::ListApplicationsError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::operation::list_applications::ListApplicationsError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "applications" => {
                    builder = builder.set_applications(crate::protocol_serde::shape_application_list::de_application_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
