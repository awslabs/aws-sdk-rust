...
pub fn ser_update_asset_model_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_asset_model::UpdateAssetModelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
