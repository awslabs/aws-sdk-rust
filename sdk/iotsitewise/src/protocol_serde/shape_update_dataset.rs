...
pub fn de_update_dataset_http_error(
    ...
    Err(match error_code {
        "ConflictingOperationException" => crate::operation::update_dataset::UpdateDatasetError::ConflictingOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "LimitExceededException" => crate::operation::update_dataset::UpdateDatasetError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
