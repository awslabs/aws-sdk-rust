...
pub fn ser_asset_model_property(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AssetModelProperty) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_asset_model_property<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AssetModelProperty>, aws_smithy_json::deserialize::error::DeserializeError>
