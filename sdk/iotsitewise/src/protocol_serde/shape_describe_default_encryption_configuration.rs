...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError::unhandled(generic))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_default_encryption_configuration::de_describe_default_encryption_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_default_encryption_configuration_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError::unhandled)?
    })
}
