...
pub(crate) fn de_variant<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Variant>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_variant(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Variant) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
