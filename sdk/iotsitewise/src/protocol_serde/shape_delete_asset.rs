...
pub fn de_delete_asset_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteAssetOutput, crate::error::DeleteAssetError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_asset::de_delete_asset(response.body().as_ref(), output).map_err(crate::error::DeleteAssetError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_asset(value: &[u8], mut builder: crate::output::delete_asset_output::Builder) -> Result<crate::output::delete_asset_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
