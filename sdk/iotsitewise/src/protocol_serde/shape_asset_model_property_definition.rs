...
pub fn ser_asset_model_property_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AssetModelPropertyDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
