...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_bulk_import_job::de_describe_bulk_import_job(_response_body, output)
            .map_err(crate::operation::describe_bulk_import_job::DescribeBulkImportJobError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_bulk_import_job_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_bulk_import_job::DescribeBulkImportJobError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "jobLastUpdateDate" => {
                    builder = builder.set_job_last_update_date(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                        tokens.next(),
                        ::aws_smithy_types::date_time::Format::EpochSeconds,
                    )?);
                }
