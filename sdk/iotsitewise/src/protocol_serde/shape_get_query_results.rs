...
pub fn de_get_query_results_http_error(
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::get_query_results::GetQueryResultsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalFailureException" => crate::operation::get_query_results::GetQueryResultsError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::operation::get_query_results::GetQueryResultsError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::get_query_results::GetQueryResultsError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "columnInfo" => {
                    builder = builder.set_column_info(crate::protocol_serde::shape_column_information_list::de_column_information_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
