...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_gateway_capability_configuration::DescribeGatewayCapabilityConfigurationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::operation::describe_gateway_capability_configuration::DescribeGatewayCapabilityConfigurationError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_gateway_capability_configuration::de_describe_gateway_capability_configuration(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_gateway_capability_configuration::DescribeGatewayCapabilityConfigurationError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_gateway_capability_configuration_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_gateway_capability_configuration::DescribeGatewayCapabilityConfigurationError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "capabilitySyncStatus" => {
                    builder = builder.set_capability_sync_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::CapabilitySyncStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "gatewayId" => {
