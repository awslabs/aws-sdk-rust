...
pub fn ser_create_asset_model_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAssetModelInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
