...
pub fn de_update_asset_model_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_asset_model::UpdateAssetModelOutput, crate::operation::update_asset_model::UpdateAssetModelError> {
    #[allow(unused_mut)]
...
pub fn ser_update_asset_model_headers(
...
) -> Result<crate::operation::update_asset_model::builders::UpdateAssetModelOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
