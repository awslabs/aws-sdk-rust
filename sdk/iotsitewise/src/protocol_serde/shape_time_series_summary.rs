...
pub(crate) fn de_time_series_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimeSeriesSummary>, aws_smithy_json::deserialize::error::DeserializeError>
