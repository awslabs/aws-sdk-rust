...
pub fn ser_batch_get_asset_property_value_history_entry(
    ...
    if let Some(var_4) = &input.start_date {
        object.key("startDate").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_5) = &input.end_date {
        object.key("endDate").date_time(var_5, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
