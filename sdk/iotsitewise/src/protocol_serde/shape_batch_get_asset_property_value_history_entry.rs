...
pub fn ser_batch_get_asset_property_value_history_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchGetAssetPropertyValueHistoryEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
