...
> {
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValuesError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "interpolatedAssetPropertyValues" => {
                    builder = builder.set_interpolated_asset_property_values(
                        crate::protocol_serde::shape_interpolated_asset_property_values::de_interpolated_asset_property_values(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
