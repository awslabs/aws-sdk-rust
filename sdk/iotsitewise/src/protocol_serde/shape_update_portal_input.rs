...
pub fn ser_update_portal_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePortalInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
