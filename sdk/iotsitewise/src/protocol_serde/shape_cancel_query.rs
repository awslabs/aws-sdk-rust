...
pub fn de_cancel_query_http_error(
    ...
    Err(match error_code {
        ...
        "ConflictingOperationException" => crate::operation::cancel_query::CancelQueryError::ConflictingOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalFailureException" => crate::operation::cancel_query::CancelQueryError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::operation::cancel_query::CancelQueryError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_cancel_query_http_response(
    ...
    Ok({
        ...
        crate::serde_util::cancel_query_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::cancel_query::CancelQueryError::unhandled)?
    })
}
