...
pub fn ser_update_asset_property_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAssetPropertyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
