...
pub fn de_create_project_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_project_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_project::CreateProjectError::unhandled)?
    })
}
...
) -> Result<crate::operation::create_project::builders::CreateProjectOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
