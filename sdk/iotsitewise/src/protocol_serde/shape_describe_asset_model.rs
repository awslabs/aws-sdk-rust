...
> {
    Ok({
        ...
        crate::serde_util::describe_asset_model_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_asset_model::DescribeAssetModelError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_asset_model::builders::DescribeAssetModelOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "assetModelHierarchies" => {
                    builder = builder
                        .set_asset_model_hierarchies(crate::protocol_serde::shape_asset_model_hierarchies::de_asset_model_hierarchies(tokens)?);
                }
                "assetModelId" => {
                ...
                "assetModelProperties" => {
                    builder =
                        builder.set_asset_model_properties(crate::protocol_serde::shape_asset_model_properties::de_asset_model_properties(tokens)?);
                }
                "assetModelStatus" => {
