...
pub fn ser_batch_get_asset_property_aggregates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchGetAssetPropertyAggregatesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
