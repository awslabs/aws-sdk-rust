...
pub fn ser_put_asset_property_value_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PutAssetPropertyValueEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
