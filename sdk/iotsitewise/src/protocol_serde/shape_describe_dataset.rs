        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "datasetLastUpdateDate" => {
                    builder = builder.set_dataset_last_update_date(::aws_smithy_json::deserialize::token::expect_timestamp_or_null(
                        tokens.next(),
                        ::aws_smithy_types::date_time::Format::EpochSeconds,
                    )?);
                }
                ...
                "datasetSource" => {
                    builder = builder.set_dataset_source(crate::protocol_serde::shape_dataset_source::de_dataset_source(tokens, _value, depth + 1)?);
                }
                "datasetStatus" => {
