...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_access_policies::de_list_access_policies(_response_body, output)
            .map_err(crate::operation::list_access_policies::ListAccessPoliciesError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_access_policies_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_access_policies::ListAccessPoliciesError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_access_policies::builders::ListAccessPoliciesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "accessPolicySummaries" => {
                    builder = builder
                        .set_access_policy_summaries(crate::protocol_serde::shape_access_policy_summaries::de_access_policy_summaries(tokens)?);
                }
                "nextToken" => {
