...
impl Builder {
    ...
    /// use aws_sdk_iotsitewise::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_iotsitewise::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
