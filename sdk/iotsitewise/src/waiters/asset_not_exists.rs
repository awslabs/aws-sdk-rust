...
///
/// Fluent builder for the `asset_not_exists` waiter.
///
...
pub struct AssetNotExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_asset::builders::DescribeAssetInputBuilder,
}
impl AssetNotExistsFluentBuilder {
    /// Creates a new `AssetNotExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::asset_not_exists::AssetNotExistsFinalPoll,
        crate::waiters::asset_not_exists::WaitUntilAssetNotExistsError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            ...
            if crate::waiters::matchers::match_describe_asset_1cce2c05524fb92d4(result) {
...
/// Successful return type for the `asset_not_exists` waiter.
pub type AssetNotExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_asset::DescribeAssetOutput,
...
/// Error type for the `asset_not_exists` waiter.
pub type WaitUntilAssetNotExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_asset::DescribeAssetOutput,
    crate::operation::describe_asset::DescribeAssetError,
>;
