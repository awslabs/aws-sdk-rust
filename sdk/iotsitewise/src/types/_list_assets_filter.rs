...
impl ::std::convert::From<&str> for ListAssetsFilter {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListAssetsFilter::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListAssetsFilter {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListAssetsFilter::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListAssetsFilter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
