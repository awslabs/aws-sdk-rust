...
impl ::std::convert::From<&str> for ListTimeSeriesType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ListTimeSeriesType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ListTimeSeriesType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ListTimeSeriesType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ListTimeSeriesType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
