...
impl ::std::convert::From<&str> for QueryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CANCELING" => QueryStatus::Canceling,
            "COMPLETED" => QueryStatus::Completed,
            "FAILED" => QueryStatus::Failed,
            "RUNNING" => QueryStatus::Running,
            "SUBMITTED" => QueryStatus::Submitted,
...
impl QueryStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            QueryStatus::Canceling => "CANCELING",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["CANCELED", "CANCELING", "COMPLETED", "FAILED", "RUNNING", "SUBMITTED"]
    }
}
