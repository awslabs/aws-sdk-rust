...
impl ::std::fmt::Debug for SearchSummary {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SearchSummary");
...
impl SearchSummaryBuilder {
    ...
    /// - [`search_id`](crate::types::builders::SearchSummaryBuilder::search_id)
    /// - [`workspace_name`](crate::types::builders::SearchSummaryBuilder::workspace_name)
    /// - [`status`](crate::types::builders::SearchSummaryBuilder::status)
    /// - [`query_statement`](crate::types::builders::SearchSummaryBuilder::query_statement)
    /// - [`search_type`](crate::types::builders::SearchSummaryBuilder::search_type)
    pub fn build(self) -> ::std::result::Result<crate::types::SearchSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::SearchSummary {
            search_id: self.search_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "search_id",
                    "search_id was not specified but it is required when building SearchSummary",
                )
            })?,
            workspace_name: self.workspace_name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "workspace_name",
                    "workspace_name was not specified but it is required when building SearchSummary",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building SearchSummary",
                )
            })?,
            query_statement: self.query_statement.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "query_statement",
                    "query_statement was not specified but it is required when building SearchSummary",
                )
            })?,
            search_type: self.search_type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "search_type",
                    "search_type was not specified but it is required when building SearchSummary",
                )
            })?,
...
impl ::std::fmt::Debug for SearchSummaryBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("SearchSummaryBuilder");
        formatter.field("search_id", &self.search_id);
        formatter.field("workspace_name", &self.workspace_name);
        formatter.field("status", &self.status);
        formatter.field("query_statement", &"*** Sensitive Data Redacted ***");
