...
impl ::std::convert::From<&str> for BatchEntryCompletionStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => BatchEntryCompletionStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for BatchEntryCompletionStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(BatchEntryCompletionStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for BatchEntryCompletionStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
