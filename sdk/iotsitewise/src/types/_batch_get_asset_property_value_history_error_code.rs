...
other => BatchGetAssetPropertyValueHistoryErrorCode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for BatchGetAssetPropertyValueHistoryErrorCode {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(BatchGetAssetPropertyValueHistoryErrorCode::from(s))
                    }
                }
