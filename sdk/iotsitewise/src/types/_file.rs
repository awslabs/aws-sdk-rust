...
impl FileBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::File, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(crate::types::File {
            ...
            key: self.key.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field("key", "key was not specified but it is required when building File")
            })?,
