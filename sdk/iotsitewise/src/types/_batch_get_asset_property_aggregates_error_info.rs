...
impl BatchGetAssetPropertyAggregatesErrorInfoBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::BatchGetAssetPropertyAggregatesErrorInfo, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::BatchGetAssetPropertyAggregatesErrorInfo {
                error_code: self.error_code
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error_code", "error_code was not specified but it is required when building BatchGetAssetPropertyAggregatesErrorInfo")
                    )?
                ,
                error_timestamp: self.error_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("error_timestamp", "error_timestamp was not specified but it is required when building BatchGetAssetPropertyAggregatesErrorInfo")
                    )?
                ,
            }
        )
