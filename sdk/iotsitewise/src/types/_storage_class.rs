...
/// match storageclass {
///     StorageClass::Standard1 => { /* ... */ },
///     StorageClass::Standard2 => { /* ... */ },
///     StorageClass::Throughput1 => { /* ... */ },
///     StorageClass::Throughput2 => { /* ... */ },
...
impl ::std::convert::From<&str> for StorageClass {
    fn from(s: &str) -> Self {
        match s {
            "STANDARD_1" => StorageClass::Standard1,
            "STANDARD_2" => StorageClass::Standard2,
            "THROUGHPUT_1" => StorageClass::Throughput1,
            "THROUGHPUT_2" => StorageClass::Throughput2,
...
impl StorageClass {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            StorageClass::Standard1 => "STANDARD_1",
            StorageClass::Standard2 => "STANDARD_2",
            StorageClass::Throughput1 => "THROUGHPUT_1",
            StorageClass::Throughput2 => "THROUGHPUT_2",
...
impl ::std::fmt::Display for StorageClass {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            StorageClass::Standard1 => write!(f, "STANDARD_1"),
            StorageClass::Standard2 => write!(f, "STANDARD_2"),
            StorageClass::Throughput1 => write!(f, "THROUGHPUT_1"),
            StorageClass::Throughput2 => write!(f, "THROUGHPUT_2"),
