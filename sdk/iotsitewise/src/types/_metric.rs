        ...
        ::std::result::Result::Ok(
            crate::types::Metric {
                expression: self.expression
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("expression", "expression was not specified but it is required when building Metric")
                    )?
                ,
                variables: self.variables
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("variables", "variables was not specified but it is required when building Metric")
                    )?
                ,
                window: self.window
                ,
