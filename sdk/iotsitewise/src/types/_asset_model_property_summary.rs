...
/// <p>Contains a summary of a property associated with a model. This includes information about which interfaces the property belongs to, if any.</p>
#[non_exhaustive]
...
pub struct AssetModelPropertySummary {
    ...
    pub interface_summaries: ::std::option::Option<::std::vec::Vec<crate::types::InterfaceSummary>>,
}
impl AssetModelPropertySummary {
    ...
    pub fn interface_summaries(&self) -> &[crate::types::InterfaceSummary] {
        self.interface_summaries.as_deref().unwrap_or_default()
    }
}
impl AssetModelPropertySummary {
...
pub struct AssetModelPropertySummaryBuilder {
    ...
    pub(crate) interface_summaries: ::std::option::Option<::std::vec::Vec<crate::types::InterfaceSummary>>,
}
impl AssetModelPropertySummaryBuilder {
    ...
    ///
    /// To override the contents of this collection use [`set_interface_summaries`](Self::set_interface_summaries).
    ///
    /// <p>A list of interface summaries that describe which interfaces this property belongs to, including the interface asset model ID and the corresponding property ID in the interface.</p>
    pub fn interface_summaries(mut self, input: crate::types::InterfaceSummary) -> Self {
        let mut v = self.interface_summaries.unwrap_or_default();
        v.push(input);
        self.interface_summaries = ::std::option::Option::Some(v);
        self
    }
    /// <p>A list of interface summaries that describe which interfaces this property belongs to, including the interface asset model ID and the corresponding property ID in the interface.</p>
    pub fn set_interface_summaries(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::InterfaceSummary>>) -> Self {
        self.interface_summaries = input;
        self
    }
    /// <p>A list of interface summaries that describe which interfaces this property belongs to, including the interface asset model ID and the corresponding property ID in the interface.</p>
    pub fn get_interface_summaries(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::InterfaceSummary>> {
        &self.interface_summaries
    }
