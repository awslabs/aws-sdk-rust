...
///
/// <p>The current state of a workspace. The state changes as the workspace is created, updated,
/// or deleted.</p>
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for WorkspaceState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => WorkspaceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for WorkspaceState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(WorkspaceState::from(s))
    }
}
impl WorkspaceState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            WorkspaceState::Deleting => "DELETING",
...
impl ::std::convert::AsRef<str> for WorkspaceState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for WorkspaceState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            WorkspaceState::Creating => write!(f, "CREATING"),
            WorkspaceState::Deleting => write!(f, "DELETING"),
