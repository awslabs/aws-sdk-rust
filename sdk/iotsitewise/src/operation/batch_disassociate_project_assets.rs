...
impl BatchDisassociateProjectAssetsInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
