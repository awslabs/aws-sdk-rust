...
impl BatchDisassociateProjectAssetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateProjectAssets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_disassociate_project_assets::de_batch_disassociate_project_assets_http_response_with_props(
                status, headers, body,
            )
        }
    }
