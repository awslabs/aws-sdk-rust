    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetAssetPropertyValueHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchGetAssetPropertyValueHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchGetAssetPropertyValueHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchGetAssetPropertyValueHistoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchGetAssetPropertyValueHistory")
...
.with_interceptor(BatchGetAssetPropertyValueHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryError>::new());
...
#[derive(Debug)]
            struct BatchGetAssetPropertyValueHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetAssetPropertyValueHistoryResponseDeserializer {
...
#[derive(Debug)]
            struct BatchGetAssetPropertyValueHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetAssetPropertyValueHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_get_asset_property_value_history::ser_batch_get_asset_property_value_history_input(&input)?);
...
#[derive(Debug)]
            struct BatchGetAssetPropertyValueHistoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchGetAssetPropertyValueHistoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchGetAssetPropertyValueHistoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchGetAssetPropertyValueHistoryInput>()
                        .ok_or("failed to downcast to BatchGetAssetPropertyValueHistoryInput")?;
...
pub enum BatchGetAssetPropertyValueHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchGetAssetPropertyValueHistoryError) for what information is available for the error.")]
...
impl BatchGetAssetPropertyValueHistoryError {
    /// Creates the `BatchGetAssetPropertyValueHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchGetAssetPropertyValueHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchGetAssetPropertyValueHistoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryError {
