...
impl BatchGetAssetPropertyValueHistoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetAssetPropertyValueHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_asset_property_value_history::de_batch_get_asset_property_value_history_http_response_with_props(
                status, headers, body,
            )
        }
    }
