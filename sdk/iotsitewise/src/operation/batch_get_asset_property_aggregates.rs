...
impl BatchGetAssetPropertyAggregatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_asset_property_aggregates::BatchGetAssetPropertyAggregates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetAssetPropertyAggregates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_asset_property_aggregates::de_batch_get_asset_property_aggregates_http_response_with_props(
                status, headers, body,
            )
        }
    }
