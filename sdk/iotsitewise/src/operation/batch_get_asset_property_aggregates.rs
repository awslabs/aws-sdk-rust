...
impl BatchGetAssetPropertyAggregates {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_asset_property_aggregates::BatchGetAssetPropertyAggregatesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchGetAssetPropertyAggregatesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchGetAssetPropertyAggregatesRequestSerializer {
