...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_portal::DescribePortalOutput,
                    crate::operation::describe_portal::DescribePortalError,
                > for DescribePortalFluentBuilder
            {
                fn send(
                    self,
...
impl DescribePortalFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_portal::DescribePortalOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_portal::DescribePortalError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_portal::DescribePortal::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_portal::DescribePortalOutput, crate::operation::describe_portal::DescribePortalError, Self> {
