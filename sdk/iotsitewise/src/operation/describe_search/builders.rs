...
pub use crate::operation::describe_search::_describe_search_input::DescribeSearchInputBuilder;

pub use crate::operation::describe_search::_describe_search_output::DescribeSearchOutputBuilder;

impl crate::operation::describe_search::builders::DescribeSearchInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.describe_search();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `DescribeSearch`.
///
...
pub struct DescribeSearchFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_search::builders::DescribeSearchInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::describe_search::DescribeSearchOutput,
        crate::operation::describe_search::DescribeSearchError,
    > for DescribeSearchFluentBuilder
{
    fn send(
        self,
...
impl DescribeSearchFluentBuilder {
    /// Creates a new `DescribeSearchFluentBuilder`.
    ...
    /// Access the DescribeSearch as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_search::builders::DescribeSearchInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::describe_search::DescribeSearch::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::describe_search::DescribeSearch::orchestrate(&runtime_plugins, input).await
    }
