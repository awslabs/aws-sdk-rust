...
impl DescribeDefaultEncryptionConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDefaultEncryptionConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDefaultEncryptionConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDefaultEncryptionConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDefaultEncryptionConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDefaultEncryptionConfiguration")
...
.with_interceptor(DescribeDefaultEncryptionConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError>::new());
...
#[derive(Debug)]
            struct DescribeDefaultEncryptionConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDefaultEncryptionConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_default_encryption_configuration::de_describe_default_encryption_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_default_encryption_configuration::de_describe_default_encryption_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeDefaultEncryptionConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDefaultEncryptionConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeDefaultEncryptionConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDefaultEncryptionConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDefaultEncryptionConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDefaultEncryptionConfigurationInput>()
                        .ok_or("failed to downcast to DescribeDefaultEncryptionConfigurationInput")?;
...
pub enum DescribeDefaultEncryptionConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDefaultEncryptionConfigurationError) for what information is available for the error.")]
...
impl DescribeDefaultEncryptionConfigurationError {
    /// Creates the `DescribeDefaultEncryptionConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDefaultEncryptionConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDefaultEncryptionConfigurationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDefaultEncryptionConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_default_encryption_configuration::DescribeDefaultEncryptionConfigurationError {
...
mod _describe_default_encryption_configuration_output;
