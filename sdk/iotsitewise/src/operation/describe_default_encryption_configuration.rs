...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDefaultEncryptionConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_default_encryption_configuration::de_describe_default_encryption_configuration_http_response_with_props(status, headers, body)
        }
    }
}
