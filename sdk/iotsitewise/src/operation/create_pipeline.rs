...
impl CreatePipeline {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "CreatePipeline", input, runtime_plugins, stop_point)
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_pipeline::CreatePipelineInput = input.downcast_mut().expect("correct type");
...
impl CreatePipelineError {
    ...
    /// Returns `true` if the error kind is `CreatePipelineError::ConflictingOperationException`.
