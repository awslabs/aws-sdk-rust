...
impl ListTasksPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `task_summaries`. Queries to the underlying service
...
impl ListTasksPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_tasks_output_output_task_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
