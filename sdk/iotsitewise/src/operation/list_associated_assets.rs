...
impl ListAssociatedAssetsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssociatedAssets`](crate::operation::list_associated_assets::ListAssociatedAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_associated_assets::ListAssociatedAssets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_associated_assets::ListAssociatedAssetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_associated_assets::ListAssociatedAssetsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.hierarchy_id {
                     {
                        query.push_kv("hierarchyId", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.traversal_direction {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_associated_assets::ListAssociatedAssets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssociatedAssets {
                type Output = std::result::Result<crate::operation::list_associated_assets::ListAssociatedAssetsOutput, crate::operation::list_associated_assets::ListAssociatedAssetsError>;
