    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/assets/{assetId}/hierarchies", assetId = asset_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_associated_assets::ListAssociatedAssets::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_associated_assets::ListAssociatedAssetsError
{
