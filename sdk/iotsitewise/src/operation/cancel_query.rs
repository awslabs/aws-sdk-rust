...
impl CancelQuery {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "CancelQuery", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(
                    output,
                    "/workspaces/{workspaceName}/queries/{queryId}/cancel",
...
impl CancelQueryError {
    ...
    /// Returns `true` if the error kind is `CancelQueryError::ConflictingOperationException`.
    pub fn is_conflicting_operation_exception(&self) -> bool {
        matches!(self, Self::ConflictingOperationException(_))
    }
    /// Returns `true` if the error kind is `CancelQueryError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CancelQueryError::InvalidRequestException`.
