...
impl DescribePortalInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_portal::DescribePortal::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePortal {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_portal::de_describe_portal_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_portal::de_describe_portal_http_response(
                status, headers, body,
            )
        }
    }
