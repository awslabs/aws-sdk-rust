...
impl GetAssetPropertyAggregatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput, ::aws_smithy_types::error::operation::BuildError> {
