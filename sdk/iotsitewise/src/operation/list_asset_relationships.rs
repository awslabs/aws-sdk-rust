...
/// Orchestration and serialization glue logic for `ListAssetRelationships`.
...
impl ListAssetRelationships {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_asset_relationships::ListAssetRelationshipsInput,
                    ) -> ::std::result::Result<crate::operation::list_asset_relationships::ListAssetRelationshipsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_asset_relationships::ListAssetRelationshipsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_asset_relationships::ListAssetRelationshipsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_asset_relationships::ListAssetRelationshipsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssetRelationships {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssetRelationships");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssetRelationshipsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssetRelationshipsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssetRelationships")
...
.with_interceptor(ListAssetRelationshipsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_asset_relationships::ListAssetRelationshipsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_asset_relationships::ListAssetRelationshipsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_asset_relationships::ListAssetRelationshipsError>::new());
...
#[derive(Debug)]
            struct ListAssetRelationshipsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssetRelationshipsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_asset_relationships::de_list_asset_relationships_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAssetRelationshipsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssetRelationshipsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_asset_relationships::ListAssetRelationshipsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_asset_relationships::ListAssetRelationshipsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/assets/{assetId}/assetRelationships", assetId = asset_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_asset_relationships::ListAssetRelationshipsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_2 = &_input.traversal_type;
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("traversal_type", "cannot be empty or unset"))?;
    query.push_kv("traversalType", &::aws_smithy_http::query::fmt_string(inner_2));
...
#[derive(Debug)]
            struct ListAssetRelationshipsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssetRelationshipsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAssetRelationshipsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssetRelationshipsInput>()
                        .ok_or("failed to downcast to ListAssetRelationshipsInput")?;
...
pub enum ListAssetRelationshipsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssetRelationshipsError) for what information is available for the error.")]
...
impl ListAssetRelationshipsError {
    /// Creates the `ListAssetRelationshipsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssetRelationshipsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssetRelationshipsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_asset_relationships::ListAssetRelationshipsError {
...
mod _list_asset_relationships_output;
