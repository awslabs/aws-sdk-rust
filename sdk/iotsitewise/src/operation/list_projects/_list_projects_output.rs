...
impl  ListProjectsOutput  {
    ...
    pub fn project_summaries(&self) -> & [crate::types::ProjectSummary] {
        use std::ops::Deref; self.project_summaries.deref()
    }
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::list_projects::ListProjectsOutput {
                project_summaries: self.project_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("project_summaries", "project_summaries was not specified but it is required when building ListProjectsOutput")
                    )?
                ,
