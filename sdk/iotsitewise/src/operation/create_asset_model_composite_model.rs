...
impl CreateAssetModelCompositeModel {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_asset_model_composite_model::CreateAssetModelCompositeModelError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_asset_model_composite_model::CreateAssetModelCompositeModelOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateAssetModelCompositeModel",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_asset_model_composite_model::CreateAssetModelCompositeModelInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAssetModelCompositeModel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateAssetModelCompositeModelRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateAssetModelCompositeModelResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateAssetModelCompositeModel")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAssetModelCompositeModel")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateAssetModelCompositeModelTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateAssetModelCompositeModelTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAssetModelCompositeModelTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateAssetModelCompositeModelInput>() else {
        ...
        if requested.should_capture("parentAssetModelCompositeModelId") {
            if let ::std::option::Option::Some(value) = input.parent_asset_model_composite_model_id.as_deref() {
                captured.insert("parentAssetModelCompositeModelId", value);
            }
        }
        ...
        if requested.should_capture("assetModelCompositeModelType") {
            if let ::std::option::Option::Some(value) = input.asset_model_composite_model_type.as_deref() {
                captured.insert("assetModelCompositeModelType", value);
            }
        }
        ...
        if requested.should_capture("composedAssetModelId") {
            if let ::std::option::Option::Some(value) = input.composed_asset_model_id.as_deref() {
                captured.insert("composedAssetModelId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAssetModelCompositeModelResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            ...
            crate::protocol_serde::shape_create_asset_model_composite_model::de_create_asset_model_composite_model_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAssetModelCompositeModelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_asset_model_composite_model::CreateAssetModelCompositeModelInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_asset_model_composite_model::CreateAssetModelCompositeModelInput,
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("asset_model_id", "cannot be empty or unset"))?;
                ...
                ::std::write!(output, "/asset-models/{assetModelId}/composite-models", assetModelId = asset_model_id)
            ...
            fn update_http_builder(
                ...
                let builder =
                    crate::protocol_serde::shape_create_asset_model_composite_model::ser_create_asset_model_composite_model_headers(input, builder)?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_asset_model_composite_model::ser_create_asset_model_composite_model_input(&input)?,
        );
...
impl CreateAssetModelCompositeModelError {
    ...
    /// Returns `true` if the error kind is `CreateAssetModelCompositeModelError::PreconditionFailedException`.
