...
impl GetQueryResultsPaginator {
    ...
    pub fn items(self) -> crate::operation::get_query_results::paginator::GetQueryResultsPaginatorItems {
        crate::operation::get_query_results::paginator::GetQueryResultsPaginatorItems(self)
    }
...
/// Flattened paginator for `GetQueryResultsPaginator`
///
/// This is created with [`.items()`](GetQueryResultsPaginator::items)
pub struct GetQueryResultsPaginatorItems(GetQueryResultsPaginator);

impl GetQueryResultsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_query_results_output_output_rows(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
