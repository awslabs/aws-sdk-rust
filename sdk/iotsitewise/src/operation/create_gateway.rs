...
impl CreateGatewayInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_gateway::CreateGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_gateway::ser_create_gateway_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_gateway::de_create_gateway_http_response_with_props(status, headers, body)
        }
    }
}
