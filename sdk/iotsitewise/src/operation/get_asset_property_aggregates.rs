...
impl GetAssetPropertyAggregates {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAssetPropertyAggregates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAssetPropertyAggregates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAssetPropertyAggregatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAssetPropertyAggregatesResponseDeserializer));
...
.with_interceptor(GetAssetPropertyAggregatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError>::new());
...
#[derive(Debug)]
            struct GetAssetPropertyAggregatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAssetPropertyAggregatesResponseDeserializer {
...
#[derive(Debug)]
            struct GetAssetPropertyAggregatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAssetPropertyAggregatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/properties/aggregates").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_4 = inner_4.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("aggregate_types", "cannot be empty or unset"))?;
    for inner_5 in inner_4 {
        query.push_kv("aggregateTypes", &::aws_smithy_http::query::fmt_string(inner_5));
    }
    let inner_6 = &_input.resolution;
    let inner_6 = inner_6.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("resolution", "cannot be empty or unset"))?;
    if inner_6.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("resolution", "cannot be empty or unset"));
    }
    ...
    let inner_9 = inner_9.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("start_date", "cannot be empty or unset"))?;
    ...
    let inner_10 = inner_10.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("end_date", "cannot be empty or unset"))?;
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAssetPropertyAggregatesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAssetPropertyAggregatesInput>()
                        .ok_or("failed to downcast to GetAssetPropertyAggregatesInput")?;
...
pub enum GetAssetPropertyAggregatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAssetPropertyAggregatesError) for what information is available for the error.")]
...
impl GetAssetPropertyAggregatesError {
    /// Creates the `GetAssetPropertyAggregatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAssetPropertyAggregatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAssetPropertyAggregatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesError {
