...
impl GetAssetPropertyAggregatesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/properties/aggregates").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregatesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_7) = &_input.qualities {
                     {
                ...
                if let Some(inner_11) = &_input.time_ordering {
                     {
