...
impl GetAssetPropertyAggregatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_asset_property_aggregates::GetAssetPropertyAggregates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAssetPropertyAggregates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_asset_property_aggregates::de_get_asset_property_aggregates_http_response_with_props(
                status, headers, body,
            )
        }
    }
