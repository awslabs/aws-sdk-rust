...
impl ListAssetModelPropertiesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_asset_model_properties::ListAssetModelProperties::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssetModelProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_asset_model_properties::de_list_asset_model_properties_http_response_with_props(status, headers, body)
        }
    }
}
