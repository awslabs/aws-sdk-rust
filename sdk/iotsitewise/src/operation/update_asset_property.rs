...
impl UpdateAssetPropertyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAssetProperty`](crate::operation::update_asset_property::UpdateAssetProperty)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_asset_property::UpdateAssetProperty, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_asset_property::UpdateAssetPropertyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("property_id", "cannot be empty or unset"))?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_asset_property::UpdateAssetProperty::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAssetProperty {
                type Output = std::result::Result<crate::operation::update_asset_property::UpdateAssetPropertyOutput, crate::operation::update_asset_property::UpdateAssetPropertyError>;
