...
impl CreateAsset {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "CreateAsset", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAssetTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("assetExternalId") {
            if let ::std::option::Option::Some(value) = input.asset_external_id.as_deref() {
                captured.insert("assetExternalId", value);
            }
        }
        ...
        if requested.should_capture("assetDescription") {
            if let ::std::option::Option::Some(value) = input.asset_description.as_deref() {
                captured.insert("assetDescription", value);
            }
        }
