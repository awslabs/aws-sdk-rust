...
pub struct ListDatasetDataSegmentsInput {
...
impl ListDatasetDataSegmentsInput {
    /// <p>The ID of the dataset.</p>
...
impl ListDatasetDataSegmentsInput {
    /// Creates a new builder-style object to manufacture [`ListDatasetDataSegmentsInput`](crate::operation::list_dataset_data_segments::ListDatasetDataSegmentsInput).
    pub fn builder() -> crate::operation::list_dataset_data_segments::builders::ListDatasetDataSegmentsInputBuilder {
        crate::operation::list_dataset_data_segments::builders::ListDatasetDataSegmentsInputBuilder::default()
    }
}

/// A builder for [`ListDatasetDataSegmentsInput`](crate::operation::list_dataset_data_segments::ListDatasetDataSegmentsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListDatasetDataSegmentsInputBuilder {
...
impl ListDatasetDataSegmentsInputBuilder {
    /// <p>The ID of the dataset.</p>
    ...
    /// Consumes the builder and constructs a [`ListDatasetDataSegmentsInput`](crate::operation::list_dataset_data_segments::ListDatasetDataSegmentsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::list_dataset_data_segments::ListDatasetDataSegmentsInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::list_dataset_data_segments::ListDatasetDataSegmentsInput {
