...
fn uri_query(_input: &crate::operation::list_actions::ListActionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("target_resource_type", "cannot be empty or unset"))?;
    query.push_kv("targetResourceType", &::aws_smithy_http::query::fmt_string(inner_1));
    let inner_2 = &_input.target_resource_id;
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("target_resource_id", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("target_resource_id", "cannot be empty or unset"));
    }
...
impl ListActionsError {
    ...
    /// Returns `true` if the error kind is `ListActionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListActionsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListActionsError::ResourceNotFoundException`.
