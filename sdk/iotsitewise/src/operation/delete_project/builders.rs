...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_project::DeleteProjectOutput,
                    crate::operation::delete_project::DeleteProjectError,
                > for DeleteProjectFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteProjectFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_project::DeleteProjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_project::DeleteProjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_project::DeleteProjectOutput, crate::operation::delete_project::DeleteProjectError, Self> {
