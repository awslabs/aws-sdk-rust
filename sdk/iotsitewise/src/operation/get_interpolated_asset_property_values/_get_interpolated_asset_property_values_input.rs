...
impl GetInterpolatedAssetPropertyValuesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValuesInput, ::aws_smithy_types::error::operation::BuildError> {
