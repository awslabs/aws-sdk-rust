...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGatewayCapabilityConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_update_gateway_capability_configuration::de_update_gateway_capability_configuration_http_response_with_props(status, headers, body)
        }
    }
}
