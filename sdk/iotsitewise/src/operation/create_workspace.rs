...
impl CreateWorkspace {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "CreateWorkspace", input, runtime_plugins, stop_point)
...
impl CreateWorkspaceError {
    ...
    /// Returns `true` if the error kind is `CreateWorkspaceError::ConflictingOperationException`.
    pub fn is_conflicting_operation_exception(&self) -> bool {
        matches!(self, Self::ConflictingOperationException(_))
    }
    /// Returns `true` if the error kind is `CreateWorkspaceError::InternalFailureException`.
