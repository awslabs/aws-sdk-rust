...
impl ListAssetPropertiesFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_asset_properties::paginator::ListAssetPropertiesPaginator {
        crate::operation::list_asset_properties::paginator::ListAssetPropertiesPaginator::new(
            self.handle,
            self.inner,
        )
    }
