...
impl ListAssetModelCompositeModelsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_asset_model_composite_models::ListAssetModelCompositeModelsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_asset_model_composite_models::ListAssetModelCompositeModelsOutput {
                asset_model_composite_model_summaries: self.asset_model_composite_model_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("asset_model_composite_model_summaries", "asset_model_composite_model_summaries was not specified but it is required when building ListAssetModelCompositeModelsOutput")
                    )?
                ,
