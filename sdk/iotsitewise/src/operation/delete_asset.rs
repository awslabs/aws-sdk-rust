...
impl DeleteAssetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_asset::DeleteAsset,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/assets/{assetId}", assetId = asset_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_asset::DeleteAsset::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAsset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_asset::de_delete_asset_http_error(
                status, headers, body,
            )
        } else {
