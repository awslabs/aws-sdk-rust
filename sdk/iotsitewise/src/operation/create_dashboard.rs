...
impl CreateDashboardInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_dashboard::CreateDashboard, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_dashboard::ser_create_dashboard_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDashboard {
    type Output =
        ::std::result::Result<crate::operation::create_dashboard::CreateDashboardOutput, crate::operation::create_dashboard::CreateDashboardError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_dashboard::de_create_dashboard_http_response_with_props(status, headers, body)
        }
    }
}
