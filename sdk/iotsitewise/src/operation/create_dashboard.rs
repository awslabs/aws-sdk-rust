...
impl CreateDashboardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_dashboard::CreateDashboard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_dashboard::de_create_dashboard_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_dashboard::CreateDashboardError
{
