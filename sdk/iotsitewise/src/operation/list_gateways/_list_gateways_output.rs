...
impl  ListGatewaysOutput  {
    ...
    pub fn gateway_summaries(&self) -> & [crate::types::GatewaySummary] {
        use std::ops::Deref; self.gateway_summaries.deref()
    }
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
...
impl ListGatewaysOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_gateways::ListGatewaysOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_gateways::ListGatewaysOutput {
                gateway_summaries: self.gateway_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("gateway_summaries", "gateway_summaries was not specified but it is required when building ListGatewaysOutput")
                    )?
                ,
