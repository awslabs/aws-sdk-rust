...
impl CreateAssetModelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_asset_model::ser_create_asset_model_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAssetModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_asset_model::de_create_asset_model_http_response_with_props(status, headers, body)
        }
    }
}
