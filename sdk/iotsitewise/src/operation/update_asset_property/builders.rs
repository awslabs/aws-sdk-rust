...
impl UpdateAssetPropertyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_asset_property::UpdateAssetPropertyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_asset_property::UpdateAssetPropertyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_asset_property::UpdateAssetPropertyOutput, crate::operation::update_asset_property::UpdateAssetPropertyError, Self> {
