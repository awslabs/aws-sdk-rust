...
impl DescribePipelineExecutionFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::describe_pipeline_execution::paginator::DescribePipelineExecutionPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::describe_pipeline_execution::paginator::DescribePipelineExecutionPaginator {
        crate::operation::describe_pipeline_execution::paginator::DescribePipelineExecutionPaginator::new(self.handle, self.inner)
    }
