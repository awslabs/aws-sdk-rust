...
impl DescribeDashboardInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_dashboard::DescribeDashboard,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_dashboard::de_describe_dashboard_http_response_with_props(status, headers, body)
        }
    }
}
