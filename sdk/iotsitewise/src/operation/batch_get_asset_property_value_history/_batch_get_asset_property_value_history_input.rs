...
impl BatchGetAssetPropertyValueHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryInput, ::aws_smithy_types::error::operation::BuildError> {
