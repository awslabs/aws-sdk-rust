...
impl BatchGetAssetPropertyValueHistoryInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::batch_get_asset_property_value_history::BatchGetAssetPropertyValueHistoryInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
