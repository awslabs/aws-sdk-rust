...
impl DeleteApplication {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "DeleteApplication", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(
                    output,
                    "/workspaces/{workspaceName}/applications/{id}",
...
impl DeleteApplicationError {
    ...
    /// Returns `true` if the error kind is `DeleteApplicationError::ConflictingOperationException`.
