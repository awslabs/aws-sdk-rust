...
impl BatchGetAssetPropertyValueInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_asset_property_value::BatchGetAssetPropertyValue::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetAssetPropertyValue {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_asset_property_value::de_batch_get_asset_property_value_http_response_with_props(
                status, headers, body,
            )
        }
    }
