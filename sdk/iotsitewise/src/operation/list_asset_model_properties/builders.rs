...
impl ListAssetModelPropertiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_asset_model_properties::ListAssetModelPropertiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_asset_model_properties::ListAssetModelPropertiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_asset_model_properties::ListAssetModelPropertiesOutput, crate::operation::list_asset_model_properties::ListAssetModelPropertiesError, Self> {
