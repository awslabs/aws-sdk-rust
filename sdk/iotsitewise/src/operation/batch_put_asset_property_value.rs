...
impl BatchPutAssetPropertyValue {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "BatchPutAssetPropertyValue",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchPutAssetPropertyValue {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchPutAssetPropertyValueRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchPutAssetPropertyValueResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchPutAssetPropertyValue")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchPutAssetPropertyValueResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_put_asset_property_value::de_batch_put_asset_property_value_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_put_asset_property_value::de_batch_put_asset_property_value_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchPutAssetPropertyValueRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_batch_put_asset_property_value::ser_batch_put_asset_property_value_input(&input)?,
        );
