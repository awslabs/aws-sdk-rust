...
impl DisassociateAssetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_disassociate_assets::ser_disassociate_assets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateAssets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_assets::de_disassociate_assets_http_response_with_props(status, headers, body)
        }
    }
}
