...
impl DisassociateAssetsInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateAssets`](crate::operation::disassociate_assets::DisassociateAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::disassociate_assets::DisassociateAssets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_assets::DisassociateAssetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_assets::DisassociateAssets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateAssets {
                type Output = std::result::Result<crate::operation::disassociate_assets::DisassociateAssetsOutput, crate::operation::disassociate_assets::DisassociateAssetsError>;
