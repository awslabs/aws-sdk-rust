...
impl GetAssetPropertyValueFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_asset_property_value::GetAssetPropertyValueOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_asset_property_value::GetAssetPropertyValueError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_asset_property_value::GetAssetPropertyValueOutput, crate::operation::get_asset_property_value::GetAssetPropertyValueError, Self> {
