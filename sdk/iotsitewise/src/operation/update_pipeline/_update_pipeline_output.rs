...
impl UpdatePipelineOutputBuilder {
    ...
    /// - [`version`](crate::operation::update_pipeline::builders::UpdatePipelineOutputBuilder::version)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::update_pipeline::UpdatePipelineOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_pipeline::UpdatePipelineOutput {
            version: self.version.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "version",
                    "version was not specified but it is required when building UpdatePipelineOutput",
                )
            })?,
            status: self.status,
