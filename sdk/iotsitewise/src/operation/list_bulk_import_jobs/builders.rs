...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_bulk_import_jobs::ListBulkImportJobsOutput,
                    crate::operation::list_bulk_import_jobs::ListBulkImportJobsError,
                > for ListBulkImportJobsFluentBuilder
            {
                fn send(
                    self,
...
impl ListBulkImportJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_bulk_import_jobs::ListBulkImportJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_bulk_import_jobs::ListBulkImportJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_bulk_import_jobs::ListBulkImportJobs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_bulk_import_jobs::ListBulkImportJobsOutput, crate::operation::list_bulk_import_jobs::ListBulkImportJobsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_bulk_import_jobs::paginator::ListBulkImportJobsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
