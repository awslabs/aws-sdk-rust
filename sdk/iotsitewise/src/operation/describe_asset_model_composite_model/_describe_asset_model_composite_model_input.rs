...
impl DescribeAssetModelCompositeModelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_asset_model_composite_model::DescribeAssetModelCompositeModelInput, ::aws_smithy_types::error::operation::BuildError> {
