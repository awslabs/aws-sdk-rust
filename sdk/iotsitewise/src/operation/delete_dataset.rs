...
impl DeleteDataset {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("iotsitewise", "DeleteDataset", input, runtime_plugins, stop_point).await
    }
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::delete_dataset::DeleteDatasetInput = input.downcast_mut().expect("correct type");
...
impl DeleteDatasetError {
    ...
    /// Returns `true` if the error kind is `DeleteDatasetError::ConflictingOperationException`.
