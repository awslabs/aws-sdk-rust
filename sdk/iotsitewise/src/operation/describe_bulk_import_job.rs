...
/// Orchestration and serialization glue logic for `DescribeBulkImportJob`.
...
impl DescribeBulkImportJob {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_bulk_import_job::DescribeBulkImportJobInput,
                    ) -> ::std::result::Result<crate::operation::describe_bulk_import_job::DescribeBulkImportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_bulk_import_job::DescribeBulkImportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeBulkImportJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeBulkImportJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeBulkImportJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeBulkImportJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeBulkImportJob")
...
.with_interceptor(DescribeBulkImportJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobError>::new());
...
#[derive(Debug)]
            struct DescribeBulkImportJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeBulkImportJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_bulk_import_job::de_describe_bulk_import_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_bulk_import_job::de_describe_bulk_import_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeBulkImportJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeBulkImportJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_bulk_import_job::DescribeBulkImportJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_bulk_import_job::DescribeBulkImportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeBulkImportJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeBulkImportJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeBulkImportJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeBulkImportJobInput>()
                        .ok_or("failed to downcast to DescribeBulkImportJobInput")?;
...
pub enum DescribeBulkImportJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeBulkImportJobError) for what information is available for the error.")]
...
impl DescribeBulkImportJobError {
    /// Creates the `DescribeBulkImportJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeBulkImportJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeBulkImportJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_bulk_import_job::DescribeBulkImportJobError {
...
mod _describe_bulk_import_job_output;
