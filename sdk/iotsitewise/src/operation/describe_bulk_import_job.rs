    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/jobs/{jobId}", jobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_bulk_import_job::DescribeBulkImportJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_bulk_import_job::DescribeBulkImportJobError
{
