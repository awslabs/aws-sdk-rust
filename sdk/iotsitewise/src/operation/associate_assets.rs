...
impl AssociateAssetsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateAssets`](crate::operation::associate_assets::AssociateAssets)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::associate_assets::AssociateAssets, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_associate_assets::ser_associate_assets_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_assets::AssociateAssets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAssets {
    type Output =
        ::std::result::Result<crate::operation::associate_assets::AssociateAssetsOutput, crate::operation::associate_assets::AssociateAssetsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_assets::de_associate_assets_http_response_with_props(status, headers, body)
        }
    }
}
