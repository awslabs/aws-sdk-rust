...
impl AssociateAssetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_assets::AssociateAssets,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/assets/{assetId}/associate", assetId = asset_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_assets::AssociateAssets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAssets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_assets::de_associate_assets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_assets::AssociateAssetsError
{
