...
impl  ListAssociatedAssetsOutput  {
    ...
    pub fn asset_summaries(&self) -> & [crate::types::AssociatedAssetsSummary] {
        use std::ops::Deref; self.asset_summaries.deref()
    }
    /// <p>The token for the next set of results, or null if there are no additional results.</p>
...
impl ListAssociatedAssetsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_associated_assets::ListAssociatedAssetsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_associated_assets::ListAssociatedAssetsOutput {
                asset_summaries: self.asset_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("asset_summaries", "asset_summaries was not specified but it is required when building ListAssociatedAssetsOutput")
                    )?
                ,
