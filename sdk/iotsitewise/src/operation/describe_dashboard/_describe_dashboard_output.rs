...
impl  DescribeDashboardOutput  {
    ...
    pub fn dashboard_arn(&self) -> & str {
        use std::ops::Deref; self.dashboard_arn.deref()
    }
    /// <p>The name of the dashboard.</p>
    pub fn dashboard_name(&self) -> & str {
        use std::ops::Deref; self.dashboard_name.deref()
    }
    /// <p>The ID of the project that the dashboard is in.</p>
    ...
    pub fn dashboard_definition(&self) -> & str {
        use std::ops::Deref; self.dashboard_definition.deref()
    }
    /// <p>The date the dashboard was created, in Unix epoch time.</p>
...
impl DescribeDashboardOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_dashboard::DescribeDashboardOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_dashboard::DescribeDashboardOutput {
                dashboard_id: self.dashboard_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_id", "dashboard_id was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                dashboard_arn: self.dashboard_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_arn", "dashboard_arn was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                dashboard_name: self.dashboard_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_name", "dashboard_name was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                project_id: self.project_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("project_id", "project_id was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                ...
                dashboard_definition: self.dashboard_definition
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_definition", "dashboard_definition was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                dashboard_creation_date: self.dashboard_creation_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_creation_date", "dashboard_creation_date was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
                dashboard_last_update_date: self.dashboard_last_update_date
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dashboard_last_update_date", "dashboard_last_update_date was not specified but it is required when building DescribeDashboardOutput")
                    )?
                ,
