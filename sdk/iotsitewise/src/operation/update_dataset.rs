...
impl UpdateDataset {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "UpdateDataset", input, runtime_plugins, stop_point)
...
impl UpdateDatasetError {
    ...
    /// Returns `true` if the error kind is `UpdateDatasetError::ConflictingOperationException`.
    ...
    /// Returns `true` if the error kind is `UpdateDatasetError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateDatasetError::ResourceAlreadyExistsException`.
