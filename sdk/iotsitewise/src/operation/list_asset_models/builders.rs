...
impl ListAssetModelsFluentBuilder  {
    /// Creates a new `ListAssetModels`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_asset_models::ListAssetModelsOutput, aws_smithy_http::result::SdkError<crate::operation::list_asset_models::ListAssetModelsError>>
                     {
