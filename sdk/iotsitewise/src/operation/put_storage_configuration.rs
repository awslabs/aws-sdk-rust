...
impl PutStorageConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutStorageConfiguration`](crate::operation::put_storage_configuration::PutStorageConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_storage_configuration::PutStorageConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_storage_configuration::PutStorageConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_storage_configuration::PutStorageConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutStorageConfiguration {
                type Output = std::result::Result<crate::operation::put_storage_configuration::PutStorageConfigurationOutput, crate::operation::put_storage_configuration::PutStorageConfigurationError>;
