...
impl AssociateTimeSeriesToAssetPropertyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetProperty::operation_runtime_plugins(
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyOutput, crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyError, Self> {
