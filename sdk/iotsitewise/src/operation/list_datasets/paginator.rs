...
impl ListDatasetsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `dataset_summaries`. Queries to the underlying service
...
impl ListDatasetsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_datasets_output_output_dataset_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
