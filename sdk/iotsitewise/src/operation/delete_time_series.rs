...
impl DeleteTimeSeriesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_time_series::ser_delete_time_series_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTimeSeries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_time_series::de_delete_time_series_http_response_with_props(status, headers, body)
        }
    }
}
