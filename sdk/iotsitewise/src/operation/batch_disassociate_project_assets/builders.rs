...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsOutput,
                    crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsError,
                > for BatchDisassociateProjectAssetsFluentBuilder
            {
                fn send(
                    self,
...
impl BatchDisassociateProjectAssetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsOutput, crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsError, Self> {
