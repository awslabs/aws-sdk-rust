...
impl BatchDisassociateProjectAssetsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsOutput, ::aws_smithy_http::result::SdkError<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsError, ::aws_smithy_http::operation::Response>>
