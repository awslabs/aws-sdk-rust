...
impl CreateBulkImportJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_bulk_import_job::CreateBulkImportJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_bulk_import_job::CreateBulkImportJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_bulk_import_job::CreateBulkImportJobOutput, crate::operation::create_bulk_import_job::CreateBulkImportJobError, Self> {
