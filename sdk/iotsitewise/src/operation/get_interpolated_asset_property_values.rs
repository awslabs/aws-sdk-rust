...
impl GetInterpolatedAssetPropertyValues {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValuesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValuesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetInterpolatedAssetPropertyValues",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInterpolatedAssetPropertyValues {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetInterpolatedAssetPropertyValuesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetInterpolatedAssetPropertyValuesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetInterpolatedAssetPropertyValues")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInterpolatedAssetPropertyValues")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetInterpolatedAssetPropertyValuesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetInterpolatedAssetPropertyValuesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInterpolatedAssetPropertyValuesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetInterpolatedAssetPropertyValuesInput>() else {
        ...
        if requested.should_capture("propertyId") {
            if let ::std::option::Option::Some(value) = input.property_id.as_deref() {
                captured.insert("propertyId", value);
            }
        }
        if requested.should_capture("propertyAlias") {
            if let ::std::option::Option::Some(value) = input.property_alias.as_deref() {
                captured.insert("propertyAlias", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInterpolatedAssetPropertyValuesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_get_interpolated_asset_property_values::de_get_interpolated_asset_property_values_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInterpolatedAssetPropertyValuesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValuesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                query.push_kv("quality", &::aws_smithy_http::query::fmt_string(inner_8.as_str()));
