...
impl GetInterpolatedAssetPropertyValuesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_interpolated_asset_property_values::GetInterpolatedAssetPropertyValues::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInterpolatedAssetPropertyValues {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_interpolated_asset_property_values::de_get_interpolated_asset_property_values_http_response_with_props(
                status, headers, body,
            )
        }
    }
