...
impl DescribeAssetModelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_asset_model::DescribeAssetModel,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssetModel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_asset_model::de_describe_asset_model_http_response_with_props(status, headers, body)
        }
    }
}
