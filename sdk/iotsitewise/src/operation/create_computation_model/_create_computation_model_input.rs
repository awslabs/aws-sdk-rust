...
pub struct CreateComputationModelInput {
...
impl CreateComputationModelInput {
    /// <p>The name of the computation model.</p>
...
impl CreateComputationModelInput {
    /// Creates a new builder-style object to manufacture [`CreateComputationModelInput`](crate::operation::create_computation_model::CreateComputationModelInput).
    pub fn builder() -> crate::operation::create_computation_model::builders::CreateComputationModelInputBuilder {
        crate::operation::create_computation_model::builders::CreateComputationModelInputBuilder::default()
    }
}

/// A builder for [`CreateComputationModelInput`](crate::operation::create_computation_model::CreateComputationModelInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateComputationModelInputBuilder {
...
impl CreateComputationModelInputBuilder {
    /// <p>The name of the computation model.</p>
    ...
    /// Consumes the builder and constructs a [`CreateComputationModelInput`](crate::operation::create_computation_model::CreateComputationModelInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<
        crate::operation::create_computation_model::CreateComputationModelInput,
        ::aws_smithy_types::error::operation::BuildError,
    > {
        ::std::result::Result::Ok(crate::operation::create_computation_model::CreateComputationModelInput {
