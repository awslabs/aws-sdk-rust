...
/// Orchestration and serialization glue logic for `GetAssetPropertyValueHistory`.
...
impl GetAssetPropertyValueHistory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryInput,
                    ) -> ::std::result::Result<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAssetPropertyValueHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAssetPropertyValueHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAssetPropertyValueHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAssetPropertyValueHistoryResponseDeserializer));
...
.with_interceptor(GetAssetPropertyValueHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError>::new());
...
#[derive(Debug)]
            struct GetAssetPropertyValueHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAssetPropertyValueHistoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_asset_property_value_history::de_get_asset_property_value_history_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_asset_property_value_history::de_get_asset_property_value_history_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetAssetPropertyValueHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAssetPropertyValueHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/properties/history").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAssetPropertyValueHistoryEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAssetPropertyValueHistoryInput>()
                        .ok_or("failed to downcast to GetAssetPropertyValueHistoryInput")?;
...
pub enum GetAssetPropertyValueHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAssetPropertyValueHistoryError) for what information is available for the error.")]
...
impl GetAssetPropertyValueHistoryError {
    /// Creates the `GetAssetPropertyValueHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAssetPropertyValueHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAssetPropertyValueHistoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_asset_property_value_history::GetAssetPropertyValueHistoryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_asset_property_value_history::_get_asset_property_value_history_output::GetAssetPropertyValueHistoryOutput;

pub use crate::operation::get_asset_property_value_history::_get_asset_property_value_history_input::GetAssetPropertyValueHistoryInput;

mod _get_asset_property_value_history_input;

mod _get_asset_property_value_history_output;
