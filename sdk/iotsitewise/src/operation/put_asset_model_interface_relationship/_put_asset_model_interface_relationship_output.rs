...
pub struct PutAssetModelInterfaceRelationshipOutput {
...
impl PutAssetModelInterfaceRelationshipOutput {
    /// <p>The ID of the asset model.</p>
...
impl ::aws_types::request_id::RequestId for PutAssetModelInterfaceRelationshipOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl PutAssetModelInterfaceRelationshipOutput {
    /// Creates a new builder-style object to manufacture [`PutAssetModelInterfaceRelationshipOutput`](crate::operation::put_asset_model_interface_relationship::PutAssetModelInterfaceRelationshipOutput).
    pub fn builder() -> crate::operation::put_asset_model_interface_relationship::builders::PutAssetModelInterfaceRelationshipOutputBuilder {
        crate::operation::put_asset_model_interface_relationship::builders::PutAssetModelInterfaceRelationshipOutputBuilder::default()
    }
}

/// A builder for [`PutAssetModelInterfaceRelationshipOutput`](crate::operation::put_asset_model_interface_relationship::PutAssetModelInterfaceRelationshipOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct PutAssetModelInterfaceRelationshipOutputBuilder {
...
impl PutAssetModelInterfaceRelationshipOutputBuilder {
    /// <p>The ID of the asset model.</p>
    ...
    /// Consumes the builder and constructs a [`PutAssetModelInterfaceRelationshipOutput`](crate::operation::put_asset_model_interface_relationship::PutAssetModelInterfaceRelationshipOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`asset_model_id`](crate::operation::put_asset_model_interface_relationship::builders::PutAssetModelInterfaceRelationshipOutputBuilder::asset_model_id)
    /// - [`interface_asset_model_id`](crate::operation::put_asset_model_interface_relationship::builders::PutAssetModelInterfaceRelationshipOutputBuilder::interface_asset_model_id)
    /// - [`asset_model_arn`](crate::operation::put_asset_model_interface_relationship::builders::PutAssetModelInterfaceRelationshipOutputBuilder::asset_model_arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<
            ...
            crate::operation::put_asset_model_interface_relationship::PutAssetModelInterfaceRelationshipOutput {
                asset_model_id: self.asset_model_id.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "asset_model_id",
                        "asset_model_id was not specified but it is required when building PutAssetModelInterfaceRelationshipOutput",
                    )
                })?,
                interface_asset_model_id: self.interface_asset_model_id.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "interface_asset_model_id",
                        "interface_asset_model_id was not specified but it is required when building PutAssetModelInterfaceRelationshipOutput",
                    )
                })?,
                asset_model_arn: self.asset_model_arn.ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field(
                        "asset_model_arn",
                        "asset_model_arn was not specified but it is required when building PutAssetModelInterfaceRelationshipOutput",
                    )
                })?,
