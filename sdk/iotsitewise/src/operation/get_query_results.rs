...
impl GetQueryResults {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "GetQueryResults", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(
                    output,
                    "/workspaces/{workspaceName}/queries/{queryId}/results",
...
impl GetQueryResultsError {
    ...
    /// Returns `true` if the error kind is `GetQueryResultsError::InternalFailureException`.
