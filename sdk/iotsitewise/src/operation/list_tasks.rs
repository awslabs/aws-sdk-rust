...
impl ListTasks {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("IoTSiteWise", "ListTasks", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListTasks", "IoTSiteWise"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/workspaces/{workspaceName}/tasks", workspaceName = workspace_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_tasks::ListTasksInput,
...
impl ListTasksError {
    ...
    /// Returns `true` if the error kind is `ListTasksError::InternalFailureException`.
    ...
    /// Returns `true` if the error kind is `ListTasksError::ResourceNotFoundException`.
