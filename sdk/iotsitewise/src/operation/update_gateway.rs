...
impl UpdateGatewayInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGateway`](crate::operation::update_gateway::UpdateGateway)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_gateway::UpdateGateway, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_gateway::ser_update_gateway_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_gateway::UpdateGateway::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGateway {
    type Output = ::std::result::Result<crate::operation::update_gateway::UpdateGatewayOutput, crate::operation::update_gateway::UpdateGatewayError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_gateway::de_update_gateway_http_response_with_props(status, headers, body)
        }
    }
}
