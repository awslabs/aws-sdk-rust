...
impl DeleteAccessPolicyInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_access_policy::DeleteAccessPolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::delete_access_policy::DeleteAccessPolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
