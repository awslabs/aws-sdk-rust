...
impl ListAssetPropertiesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_asset_properties::ListAssetProperties,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssetProperties {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_asset_properties::de_list_asset_properties_http_response_with_props(status, headers, body)
        }
    }
}
