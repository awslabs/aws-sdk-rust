...
impl ListAssetPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`ListAssetProperties`](crate::operation::list_asset_properties::ListAssetProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_asset_properties::ListAssetProperties, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_asset_properties::ListAssetPropertiesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_asset_properties::ListAssetPropertiesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_4) = &_input.filter {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_asset_properties::ListAssetProperties::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssetProperties {
                type Output = std::result::Result<crate::operation::list_asset_properties::ListAssetPropertiesOutput, crate::operation::list_asset_properties::ListAssetPropertiesError>;
