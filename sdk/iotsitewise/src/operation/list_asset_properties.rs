    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/assets/{assetId}/properties", assetId = asset_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_asset_properties::ListAssetProperties::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_asset_properties::ListAssetPropertiesError
{
