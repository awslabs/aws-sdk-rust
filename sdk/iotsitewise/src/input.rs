...
impl DeleteAccessPolicyInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_4 = &self.access_policy_id;
        let input_4 = input_4
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DeleteAssetModelInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_8 = &self.asset_model_id;
        let input_8 = input_8
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DeleteDashboardInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_10 = &self.dashboard_id;
        let input_10 =
            input_10
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DeletePortalInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_14) = &self.client_token {
...
impl DeleteProjectInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_16) = &self.client_token {
...
impl DescribeAccessPolicyInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_17 = &self.access_policy_id;
        let input_17 =
            input_17
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DescribeAssetModelInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_19 = &self.asset_model_id;
        let input_19 =
            input_19
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DescribeDashboardInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_22 = &self.dashboard_id;
        let input_22 =
            input_22
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DescribeGatewayCapabilityConfigurationInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let input_25 = &self.capability_namespace;
        let input_25 =
            input_25
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl GetAssetPropertyAggregatesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_38) = &self.end_date {
            query.push_kv(
                "endDate",
                &smithy_http::query::fmt_timestamp(
                    inner_38,
        ...
        if let Some(inner_39) = &self.time_ordering {
...
impl GetAssetPropertyValueHistoryInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_49) = &self.end_date {
            query.push_kv(
                "endDate",
                &smithy_http::query::fmt_timestamp(
                    inner_49,
