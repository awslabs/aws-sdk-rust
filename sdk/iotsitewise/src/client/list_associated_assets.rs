...
impl super::Client {
    ...
    ///   - [`asset_id(impl ::std::convert::Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_asset_id): <p>The ID of the asset to query.</p>
    ///   - [`hierarchy_id(impl ::std::convert::Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::hierarchy_id) / [`set_hierarchy_id(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_hierarchy_id): <p>The ID of the hierarchy by which child assets are associated to the asset. To find a hierarchy ID, use the <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeAsset.html">DescribeAsset</a> or <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeAssetModel.html">DescribeAssetModel</a> operations. This parameter is required if you choose <code>CHILD</code> for <code>traversalDirection</code>.</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html">Asset hierarchies</a> in the <i>IoT SiteWise User Guide</i>.</p>
    ///   - [`traversal_direction(TraversalDirection)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::traversal_direction) / [`set_traversal_direction(Option<TraversalDirection>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_traversal_direction): <p>The direction to list associated assets. Choose one of the following options:</p>  <ul>   <li> <p> <code>CHILD</code> – The list includes all child assets associated to the asset. The <code>hierarchyId</code> parameter is required if you choose <code>CHILD</code>.</p> </li>   <li> <p> <code>PARENT</code> – The list includes the asset's parent asset.</p> </li>  </ul>  <p>Default: <code>CHILD</code> </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_max_results): <p>The maximum number of results to return for each paginated request.</p>  <p>Default: 50</p>
