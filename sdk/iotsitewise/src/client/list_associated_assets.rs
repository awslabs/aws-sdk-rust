...
impl super::Client {
    ...
    ///   - [`asset_id(impl Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_asset_id): <p>The ID of the asset to query.</p>
    ///   - [`hierarchy_id(impl Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::hierarchy_id) / [`set_hierarchy_id(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_hierarchy_id): <p>The ID of the hierarchy by which child assets are associated to the asset. To find a hierarchy ID, use the <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeAsset.html">DescribeAsset</a> or <a href="https://docs.aws.amazon.com/iot-sitewise/latest/APIReference/API_DescribeAssetModel.html">DescribeAssetModel</a> operations. This parameter is required if you choose <code>CHILD</code> for <code>traversalDirection</code>.</p>  <p>For more information, see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/asset-hierarchies.html">Asset hierarchies</a> in the <i>IoT SiteWise User Guide</i>.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_associated_assets::builders::ListAssociatedAssetsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
