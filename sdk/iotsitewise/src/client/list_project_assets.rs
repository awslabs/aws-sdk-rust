...
impl super::Client {
    ...
    ///   - [`project_id(impl ::std::convert::Into<String>)`](crate::operation::list_project_assets::builders::ListProjectAssetsFluentBuilder::project_id) / [`set_project_id(Option<String>)`](crate::operation::list_project_assets::builders::ListProjectAssetsFluentBuilder::set_project_id): <p>The ID of the project.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_project_assets::builders::ListProjectAssetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_project_assets::builders::ListProjectAssetsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
