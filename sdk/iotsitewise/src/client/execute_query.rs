...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return at one time.</p> <ul>  <li>   <p>Minimum is 1</p></li>  <li>   <p>Maximum is 20000</p></li>  <li>   <p>Default is 250</p></li> </ul><br>
