...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return at one time.</p> <ul>  <li>   <p>Minimum is 1</p></li>  <li>   <p>Maximum is 20000</p></li>  <li>   <p>Default is 20000</p></li> </ul><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::execute_query::builders::ExecuteQueryFluentBuilder::set_client_token):<br>required: **false**<br><p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p><br>
