...
impl super::Client {
    ...
    ///   - [`dashboard_id(impl ::std::convert::Into<String>)`](crate::operation::delete_dashboard::builders::DeleteDashboardFluentBuilder::dashboard_id) / [`set_dashboard_id(Option<String>)`](crate::operation::delete_dashboard::builders::DeleteDashboardFluentBuilder::set_dashboard_id): <p>The ID of the dashboard to delete.</p>
