...
impl super::Client {
    ...
    ///   - [`retention_period(Option<RetentionPeriod>)`](crate::operation::describe_storage_configuration::DescribeStorageConfigurationOutput::retention_period): <p>How many days your data is kept in the hot tier. By default, your data is kept indefinitely in the hot tier.</p>
