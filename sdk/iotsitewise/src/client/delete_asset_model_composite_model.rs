...
impl super::Client {
    ...
    pub fn delete_asset_model_composite_model(&self) -> crate::operation::delete_asset_model_composite_model::builders::DeleteAssetModelCompositeModelFluentBuilder {
