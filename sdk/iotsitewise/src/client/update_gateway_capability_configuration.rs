...
impl super::Client {
    /// Constructs a fluent builder for the [`UpdateGatewayCapabilityConfiguration`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`gateway_id(impl Into<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::gateway_id) / [`set_gateway_id(Option<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::set_gateway_id): <p>The ID of the gateway to be updated.</p>
    ///   - [`capability_namespace(impl Into<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::capability_namespace) / [`set_capability_namespace(Option<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::set_capability_namespace): <p>The namespace of the gateway capability configuration to be updated. For example, if you configure OPC-UA sources from the IoT SiteWise console, your OPC-UA capability configuration has the namespace <code>iotsitewise:opcuacollector:version</code>, where <code>version</code> is a number such as <code>1</code>.</p>
    ///   - [`capability_configuration(impl Into<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::capability_configuration) / [`set_capability_configuration(Option<String>)`](crate::operation::update_gateway_capability_configuration::builders::UpdateGatewayCapabilityConfigurationFluentBuilder::set_capability_configuration): <p>The JSON document that defines the configuration for the gateway capability. For more information, see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/configure-sources.html#configure-source-cli">Configuring data sources (CLI)</a> in the <i>IoT SiteWise User Guide</i>.</p>
    /// - On success, responds with [`UpdateGatewayCapabilityConfigurationOutput`](crate::operation::update_gateway_capability_configuration::UpdateGatewayCapabilityConfigurationOutput) with field(s):
