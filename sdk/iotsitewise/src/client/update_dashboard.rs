...
impl super::Client {
    ...
    ///   - [`dashboard_definition(impl Into<String>)`](crate::operation::update_dashboard::builders::UpdateDashboardFluentBuilder::dashboard_definition) / [`set_dashboard_definition(Option<String>)`](crate::operation::update_dashboard::builders::UpdateDashboardFluentBuilder::set_dashboard_definition):<br>required: **true**<br><p>The new dashboard definition, as specified in a JSON literal.</p> <ul>  <li>   <p>IoT SiteWise Monitor (Classic) see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/create-dashboards-using-aws-cli.html">Create dashboards (CLI)</a></p></li>  <li>   <p>IoT SiteWise Monitor (AI-aware) see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/create-dashboards-ai-dashboard-cli.html">Create dashboards (CLI)</a></p></li> </ul> <p>in the <i>IoT SiteWise User Guide</i></p><br>
