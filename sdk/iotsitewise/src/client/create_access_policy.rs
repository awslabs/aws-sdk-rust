...
impl super::Client {
    ...
    ///   - [`access_policy_identity(Identity)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::access_policy_identity) / [`set_access_policy_identity(Option<Identity>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::set_access_policy_identity): <p>The identity for this access policy. Choose an IAM Identity Center user, an IAM Identity Center group, or an IAM user.</p>
    ///   - [`access_policy_resource(Resource)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::access_policy_resource) / [`set_access_policy_resource(Option<Resource>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::set_access_policy_resource): <p>The IoT SiteWise Monitor resource for this access policy. Choose either a portal or a project.</p>
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::set_client_token): <p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_access_policy::builders::CreateAccessPolicyFluentBuilder::set_tags): <p>A list of key-value pairs that contain metadata for the access policy. For more information, see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/tag-resources.html">Tagging your IoT SiteWise resources</a> in the <i>IoT SiteWise User Guide</i>.</p>
