...
impl super::Client {
    ...
    ///   - [`portal_id(impl ::std::convert::Into<String>)`](crate::operation::delete_portal::builders::DeletePortalFluentBuilder::portal_id) / [`set_portal_id(Option<String>)`](crate::operation::delete_portal::builders::DeletePortalFluentBuilder::set_portal_id): <p>The ID of the portal to delete.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_portal::builders::DeletePortalFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_portal::builders::DeletePortalFluentBuilder::set_client_token): <p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p>
