...
impl super::Client {
    ...
    ///   - [`asset_id(impl ::std::convert::Into<String>)`](crate::operation::delete_asset::builders::DeleteAssetFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::delete_asset::builders::DeleteAssetFluentBuilder::set_asset_id): <p>The ID of the asset to delete.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_asset::builders::DeleteAssetFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_asset::builders::DeleteAssetFluentBuilder::set_client_token): <p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p>
