...
impl super::Client {
    ...
    ///   - [`asset_id(impl Into<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::set_asset_id): <p>The ID of the asset to be updated.</p>
    ///   - [`property_id(impl Into<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::property_id) / [`set_property_id(Option<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::set_property_id): <p>The ID of the asset property to be updated.</p>
    ...
    ///   - [`property_notification_state(PropertyNotificationState)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::property_notification_state) / [`set_property_notification_state(Option<PropertyNotificationState>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::set_property_notification_state): <p>The MQTT notification state (enabled or disabled) for this asset property. When the notification state is enabled, IoT SiteWise publishes property value updates to a unique MQTT topic. For more information, see <a href="https://docs.aws.amazon.com/iot-sitewise/latest/userguide/interact-with-other-services.html">Interacting with other services</a> in the <i>IoT SiteWise User Guide</i>.</p>  <p>If you omit this parameter, the notification state is set to <code>DISABLED</code>.</p>
    ///   - [`client_token(impl Into<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::set_client_token): <p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p>
    ///   - [`property_unit(impl Into<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::property_unit) / [`set_property_unit(Option<String>)`](crate::operation::update_asset_property::builders::UpdateAssetPropertyFluentBuilder::set_property_unit): <p>The unit of measure (such as Newtons or RPM) of the asset property. If you don't specify a value for this parameter, the service uses the value of the <code>assetModelProperty</code> in the asset model.</p>
