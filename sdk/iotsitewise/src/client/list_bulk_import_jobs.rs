...
impl super::Client {
    ...
    ///   - [`workspace_name(impl Into<String>)`](crate::operation::list_bulk_import_jobs::builders::ListBulkImportJobsFluentBuilder::workspace_name) / [`set_workspace_name(Option<String>)`](crate::operation::list_bulk_import_jobs::builders::ListBulkImportJobsFluentBuilder::set_workspace_name):<br>required: **false**<br><p>The name of the workspace.</p><br>
