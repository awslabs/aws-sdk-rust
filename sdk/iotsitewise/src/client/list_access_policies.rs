...
impl super::Client {
    ...
    ///   - [`identity_id(impl ::std::convert::Into<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::identity_id) / [`set_identity_id(Option<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_identity_id): <p>The ID of the identity. This parameter is required if you specify <code>USER</code> or <code>GROUP</code> for <code>identityType</code>.</p>
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_resource_id): <p>The ID of the resource. This parameter is required if you specify <code>resourceType</code>.</p>
    ///   - [`iam_arn(impl ::std::convert::Into<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::iam_arn) / [`set_iam_arn(Option<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_iam_arn): <p>The ARN of the IAM user. For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html">IAM ARNs</a> in the <i>IAM User Guide</i>. This parameter is required if you specify <code>IAM</code> for <code>identityType</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_access_policies::builders::ListAccessPoliciesFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
