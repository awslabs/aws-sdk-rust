...
impl super::Client {
    ...
    ///   - [`asset_id(impl ::std::convert::Into<String>)`](crate::operation::list_asset_relationships::builders::ListAssetRelationshipsFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::list_asset_relationships::builders::ListAssetRelationshipsFluentBuilder::set_asset_id): <p>The ID of the asset.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_asset_relationships::builders::ListAssetRelationshipsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_asset_relationships::builders::ListAssetRelationshipsFluentBuilder::set_next_token): <p>The token to be used for the next set of paginated results.</p>
