...
impl super::Client {
    ...
    ///   - [`alias(impl ::std::convert::Into<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::alias) / [`set_alias(Option<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::set_alias): <p>The alias that identifies the time series.</p>
    ///   - [`asset_id(impl ::std::convert::Into<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::asset_id) / [`set_asset_id(Option<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::set_asset_id): <p>The ID of the asset in which the asset property was created.</p>
    ///   - [`property_id(impl ::std::convert::Into<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::property_id) / [`set_property_id(Option<String>)`](crate::operation::describe_time_series::builders::DescribeTimeSeriesFluentBuilder::set_property_id): <p>The ID of the asset property.</p>
