...
//! ```
use aws_sdk_elasticsearch::{config, Client};
/// Smoke tests for the `list_domain_names` operation
#[::tokio::test]
async fn test_list_domain_names_success() {
    ...
    let res = client.list_domain_names().send().await;
