...
impl super::Client  {
    ...
    pub fn create_outbound_cross_cluster_search_connection(&self) -> crate::client::fluent_builders::CreateOutboundCrossClusterSearchConnection {
                                crate::client::fluent_builders::CreateOutboundCrossClusterSearchConnection::new(self.handle.clone())
                            }
}
