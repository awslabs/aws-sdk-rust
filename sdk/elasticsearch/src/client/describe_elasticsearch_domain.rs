...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::describe_elasticsearch_domain::builders::DescribeElasticsearchDomainFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::describe_elasticsearch_domain::builders::DescribeElasticsearchDomainFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of the Elasticsearch domain for which you want information.</p><br>
