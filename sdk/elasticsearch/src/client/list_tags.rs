...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_tags::builders::ListTagsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_tags::builders::ListTagsFluentBuilder::set_arn): <p> Specify the <code>ARN</code> for the Elasticsearch domain to which the tags are attached that you want to view.</p>
