...
impl super::Client  {
    ...
    pub fn describe_reserved_elasticsearch_instance_offerings(&self) -> crate::client::fluent_builders::DescribeReservedElasticsearchInstanceOfferings {
                                crate::client::fluent_builders::DescribeReservedElasticsearchInstanceOfferings::new(self.handle.clone())
                            }
}
