...
impl super::Client {
    ...
    ///   - [`reserved_elasticsearch_instance_offering_id(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::reserved_elasticsearch_instance_offering_id) / [`set_reserved_elasticsearch_instance_offering_id(Option<String>)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::set_reserved_elasticsearch_instance_offering_id): <p>The offering identifier filter value. Use this parameter to show only the available offering that matches the specified reservation identifier.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::set_max_results): <p>Set this value to limit the number of results returned. If not specified, defaults to 100.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_reserved_elasticsearch_instance_offerings::builders::DescribeReservedElasticsearchInstanceOfferingsFluentBuilder::set_next_token): <p>NextToken should be sent in case if earlier API call produced result containing NextToken. It is used for pagination.</p>
