...
impl super::Client {
    ...
    ///   - [`domain_names(impl Into<String>)`](crate::operation::describe_elasticsearch_domains::builders::DescribeElasticsearchDomainsFluentBuilder::domain_names) / [`set_domain_names(Option<Vec<String>>)`](crate::operation::describe_elasticsearch_domains::builders::DescribeElasticsearchDomainsFluentBuilder::set_domain_names): <p>The Elasticsearch domains for which you want information.</p>
