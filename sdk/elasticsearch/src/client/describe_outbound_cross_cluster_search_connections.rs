...
impl super::Client  {
    ...
    pub fn describe_outbound_cross_cluster_search_connections(&self) -> crate::client::fluent_builders::DescribeOutboundCrossClusterSearchConnections {
                                crate::client::fluent_builders::DescribeOutboundCrossClusterSearchConnections::new(self.handle.clone())
                            }
}
