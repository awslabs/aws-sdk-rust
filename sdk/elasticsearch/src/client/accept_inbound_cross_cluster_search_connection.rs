...
impl super::Client  {
    ...
    pub fn accept_inbound_cross_cluster_search_connection(&self) -> crate::client::fluent_builders::AcceptInboundCrossClusterSearchConnection {
                                crate::client::fluent_builders::AcceptInboundCrossClusterSearchConnection::new(self.handle.clone())
                            }
}
