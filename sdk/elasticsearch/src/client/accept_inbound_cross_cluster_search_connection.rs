...
impl super::Client {
    ...
    ///   - [`cross_cluster_search_connection_id(impl ::std::convert::Into<String>)`](crate::operation::accept_inbound_cross_cluster_search_connection::builders::AcceptInboundCrossClusterSearchConnectionFluentBuilder::cross_cluster_search_connection_id) / [`set_cross_cluster_search_connection_id(Option<String>)`](crate::operation::accept_inbound_cross_cluster_search_connection::builders::AcceptInboundCrossClusterSearchConnectionFluentBuilder::set_cross_cluster_search_connection_id): <p>The id of the inbound connection that you want to accept.</p>
