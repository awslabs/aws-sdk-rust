...
impl super::Client {
    ...
    ///   - [`package_id(impl ::std::convert::Into<String>)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::set_package_id): <p>Returns an audit history of versions of the package.</p>
    ///   - [`max_results(i32)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::set_max_results): <p>Limits results to a maximum number of versions.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_package_version_history::builders::GetPackageVersionHistoryFluentBuilder::set_next_token): <p>Used for pagination. Only necessary if a previous API call includes a non-null NextToken value. If provided, returns results for the next page.</p>
