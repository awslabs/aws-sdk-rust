...
impl super::Client  {
    ...
    pub fn describe_inbound_cross_cluster_search_connections(&self) -> crate::client::fluent_builders::DescribeInboundCrossClusterSearchConnections {
                                crate::client::fluent_builders::DescribeInboundCrossClusterSearchConnections::new(self.handle.clone())
                            }
}
