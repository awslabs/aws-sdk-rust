...
impl super::Client  {
    ...
    pub fn reject_inbound_cross_cluster_search_connection(&self) -> crate::client::fluent_builders::RejectInboundCrossClusterSearchConnection {
                                crate::client::fluent_builders::RejectInboundCrossClusterSearchConnection::new(self.handle.clone())
                            }
}
