...
impl super::Client {
    ...
    ///   - [`cross_cluster_search_connection_id(impl ::std::convert::Into<String>)`](crate::operation::reject_inbound_cross_cluster_search_connection::builders::RejectInboundCrossClusterSearchConnectionFluentBuilder::cross_cluster_search_connection_id) / [`set_cross_cluster_search_connection_id(Option<String>)`](crate::operation::reject_inbound_cross_cluster_search_connection::builders::RejectInboundCrossClusterSearchConnectionFluentBuilder::set_cross_cluster_search_connection_id): <p>The id of the inbound connection that you want to reject.</p>
