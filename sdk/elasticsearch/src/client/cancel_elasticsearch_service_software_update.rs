...
impl super::Client  {
    ...
    pub fn cancel_elasticsearch_service_software_update(&self) -> crate::client::fluent_builders::CancelElasticsearchServiceSoftwareUpdate {
                                crate::client::fluent_builders::CancelElasticsearchServiceSoftwareUpdate::new(self.handle.clone())
                            }
}
