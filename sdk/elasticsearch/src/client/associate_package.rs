...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::set_domain_name):<br>required: **true**<br><p>Name of the domain that you want to associate the package with.</p><br>
