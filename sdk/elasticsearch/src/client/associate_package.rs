...
impl super::Client {
    ...
    ///   - [`package_id(impl ::std::convert::Into<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::set_package_id): <p>Internal ID of the package that you want to associate with a domain. Use <code>DescribePackages</code> to find this value.</p>
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::associate_package::builders::AssociatePackageFluentBuilder::set_domain_name): <p>Name of the domain that you want to associate the package with.</p>
