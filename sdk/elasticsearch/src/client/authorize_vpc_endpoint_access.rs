...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::authorize_vpc_endpoint_access::builders::AuthorizeVpcEndpointAccessFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::authorize_vpc_endpoint_access::builders::AuthorizeVpcEndpointAccessFluentBuilder::set_domain_name):<br>required: **true**<br><p>The name of the OpenSearch Service domain to provide access to.</p><br>
    ///   - [`account(impl Into<String>)`](crate::operation::authorize_vpc_endpoint_access::builders::AuthorizeVpcEndpointAccessFluentBuilder::account) / [`set_account(Option<String>)`](crate::operation::authorize_vpc_endpoint_access::builders::AuthorizeVpcEndpointAccessFluentBuilder::set_account):<br>required: **true**<br><p>The account ID to grant access to.</p><br>
