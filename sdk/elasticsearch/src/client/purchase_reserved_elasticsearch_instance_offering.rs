...
impl super::Client  {
    ...
    pub fn purchase_reserved_elasticsearch_instance_offering(&self) -> crate::client::fluent_builders::PurchaseReservedElasticsearchInstanceOffering {
                                crate::client::fluent_builders::PurchaseReservedElasticsearchInstanceOffering::new(self.handle.clone())
                            }
}
