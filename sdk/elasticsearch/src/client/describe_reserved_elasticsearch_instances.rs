...
impl super::Client  {
    ...
    pub fn describe_reserved_elasticsearch_instances(&self) -> crate::client::fluent_builders::DescribeReservedElasticsearchInstances {
                                crate::client::fluent_builders::DescribeReservedElasticsearchInstances::new(self.handle.clone())
                            }
}
