...
impl super::Client {
    ...
    ///   - [`package_id(impl Into<String>)`](crate::operation::dissociate_package::builders::DissociatePackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::dissociate_package::builders::DissociatePackageFluentBuilder::set_package_id):<br>required: **true**<br><p>Internal ID of the package that you want to associate with a domain. Use <code>DescribePackages</code> to find this value.</p><br>
