    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/serviceSoftwareUpdate/start")
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartElasticsearchServiceSoftwareUpdate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_elasticsearch_service_software_update::de_start_elasticsearch_service_software_update_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type StartElasticsearchServiceSoftwareUpdateErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for StartElasticsearchServiceSoftwareUpdateError
{
