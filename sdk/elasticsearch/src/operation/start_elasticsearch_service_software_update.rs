...
impl StartElasticsearchServiceSoftwareUpdateInput {
    /// Consumes the builder and constructs an Operation<[`StartElasticsearchServiceSoftwareUpdate`](crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2015-01-01/es/serviceSoftwareUpdate/start").expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdate::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartElasticsearchServiceSoftwareUpdate", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for StartElasticsearchServiceSoftwareUpdate {
                type Output = std::result::Result<crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdateOutput, crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdateError>;
...
impl aws_http::request_id::RequestId for crate::operation::start_elasticsearch_service_software_update::StartElasticsearchServiceSoftwareUpdateError {
