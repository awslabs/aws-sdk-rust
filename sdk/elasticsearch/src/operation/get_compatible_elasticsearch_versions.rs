...
impl GetCompatibleElasticsearchVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCompatibleElasticsearchVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_compatible_elasticsearch_versions::de_get_compatible_elasticsearch_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
