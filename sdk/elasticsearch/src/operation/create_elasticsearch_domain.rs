...
impl CreateElasticsearchDomain {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elasticsearch Service.CreateElasticsearchDomain",
            "rpc.service" = "Elasticsearch Service",
            "rpc.method" = "CreateElasticsearchDomain",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateElasticsearchDomain")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateElasticsearchDomain")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateElasticsearchDomainTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateElasticsearchDomainTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateElasticsearchDomainTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateElasticsearchDomainInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateElasticsearchDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_elasticsearch_domain::de_create_elasticsearch_domain_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_elasticsearch_domain::de_create_elasticsearch_domain_http_response(status, headers, body, _cfg)
        };
