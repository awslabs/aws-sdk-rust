...
impl GetCompatibleElasticsearchVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput, ::aws_smithy_types::error::operation::BuildError> {
