...
impl GetUpgradeStatusFluentBuilder  {
    /// Creates a new `GetUpgradeStatus`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_upgrade_status::GetUpgradeStatusOutput, aws_smithy_http::result::SdkError<crate::operation::get_upgrade_status::GetUpgradeStatusError>>
                     {
