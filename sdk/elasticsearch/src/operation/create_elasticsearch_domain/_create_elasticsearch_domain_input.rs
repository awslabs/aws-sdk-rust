...
impl CreateElasticsearchDomainInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_elasticsearch_domain::CreateElasticsearchDomainInput, ::aws_smithy_types::error::operation::BuildError> {
