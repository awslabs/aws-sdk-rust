    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_reserved_elasticsearch_instances::DescribeReservedElasticsearchInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/reservedInstances")
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                if let ::std::option::Option::Some(inner_1) =
                    &_input.reserved_elasticsearch_instance_id
                {
                    {
                        query.push_kv(
                            "reservationId",
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedElasticsearchInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_reserved_elasticsearch_instances::de_describe_reserved_elasticsearch_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type DescribeReservedElasticsearchInstancesErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for DescribeReservedElasticsearchInstancesError
{
