    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DescribeReservedElasticsearchInstanceOfferings")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReservedElasticsearchInstanceOfferings")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DescribeReservedElasticsearchInstanceOfferingsTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DescribeReservedElasticsearchInstanceOfferingsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReservedElasticsearchInstanceOfferingsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DescribeReservedElasticsearchInstanceOfferingsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReservedElasticsearchInstanceOfferingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_describe_reserved_elasticsearch_instance_offerings::de_describe_reserved_elasticsearch_instance_offerings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_describe_reserved_elasticsearch_instance_offerings::de_describe_reserved_elasticsearch_instance_offerings_http_response(status, headers, body, _cfg)
        };
