...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDomainChangeProgress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_domain_change_progress::de_describe_domain_change_progress_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeDomainChangeProgressError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError
{
