...
impl DescribeDomainChangeProgressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_domain_change_progress::DescribeDomainChangeProgress::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDomainChangeProgress {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_domain_change_progress::de_describe_domain_change_progress_http_response_with_props(
                status, headers, body,
            )
        }
    }
