...
impl DescribeDomainChangeProgress {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressInput,
                    ) -> ::std::result::Result<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDomainChangeProgress {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDomainChangeProgress");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDomainChangeProgressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDomainChangeProgressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDomainChangeProgress")
...
.with_interceptor(DescribeDomainChangeProgressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError>::new());
...
#[derive(Debug)]
            struct DescribeDomainChangeProgressResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDomainChangeProgressResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_domain_change_progress::de_describe_domain_change_progress_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeDomainChangeProgressRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDomainChangeProgressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-01-01/es/domain/{DomainName}/progress", DomainName = domain_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_2) = &_input.change_id {
         {
            query.push_kv("changeid", &::aws_smithy_http::query::fmt_string(inner_2));
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct DescribeDomainChangeProgressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDomainChangeProgressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDomainChangeProgressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDomainChangeProgressInput>()
                        .ok_or("failed to downcast to DescribeDomainChangeProgressInput")?;
...
pub enum DescribeDomainChangeProgressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDomainChangeProgressError) for what information is available for the error.")]
...
impl DescribeDomainChangeProgressError {
    /// Creates the `DescribeDomainChangeProgressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDomainChangeProgressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDomainChangeProgressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_domain_change_progress::DescribeDomainChangeProgressError {
...
mod _describe_domain_change_progress_output;
