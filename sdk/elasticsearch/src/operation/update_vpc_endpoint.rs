    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/vpcEndpoints/update")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_vpc_endpoint::UpdateVpcEndpoint::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_vpc_endpoint::UpdateVpcEndpointError
{
