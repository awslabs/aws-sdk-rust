...
impl UpdateVpcEndpointInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVpcEndpoint`](crate::operation::update_vpc_endpoint::UpdateVpcEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_vpc_endpoint::UpdateVpcEndpoint, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_vpc_endpoint::UpdateVpcEndpointInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2015-01-01/es/vpcEndpoints/update").expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_vpc_endpoint::UpdateVpcEndpoint::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateVpcEndpoint", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVpcEndpoint {
                type Output = std::result::Result<crate::operation::update_vpc_endpoint::UpdateVpcEndpointOutput, crate::operation::update_vpc_endpoint::UpdateVpcEndpointError>;
