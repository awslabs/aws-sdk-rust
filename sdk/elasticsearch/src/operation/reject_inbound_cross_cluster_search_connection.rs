...
impl ::aws_smithy_http::response::ParseStrictResponse
    for RejectInboundCrossClusterSearchConnection
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_inbound_cross_cluster_search_connection::de_reject_inbound_cross_cluster_search_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type RejectInboundCrossClusterSearchConnectionErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for RejectInboundCrossClusterSearchConnectionError
{
