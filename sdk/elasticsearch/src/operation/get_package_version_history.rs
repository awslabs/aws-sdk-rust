...
/// Orchestration and serialization glue logic for `GetPackageVersionHistory`.
...
impl GetPackageVersionHistory {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_package_version_history::GetPackageVersionHistoryInput,
                    ) -> ::std::result::Result<crate::operation::get_package_version_history::GetPackageVersionHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_package_version_history::GetPackageVersionHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_package_version_history::GetPackageVersionHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_package_version_history::GetPackageVersionHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPackageVersionHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPackageVersionHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPackageVersionHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPackageVersionHistoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPackageVersionHistory")
...
.with_interceptor(GetPackageVersionHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_package_version_history::GetPackageVersionHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_package_version_history::GetPackageVersionHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_package_version_history::GetPackageVersionHistoryError>::new());
...
#[derive(Debug)]
            struct GetPackageVersionHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPackageVersionHistoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_package_version_history::de_get_package_version_history_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetPackageVersionHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPackageVersionHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_package_version_history::GetPackageVersionHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_package_version_history::GetPackageVersionHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-01-01/packages/{PackageID}/history", PackageID = package_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_package_version_history::GetPackageVersionHistoryInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetPackageVersionHistoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPackageVersionHistoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPackageVersionHistoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPackageVersionHistoryInput>()
                        .ok_or("failed to downcast to GetPackageVersionHistoryInput")?;
...
pub enum GetPackageVersionHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPackageVersionHistoryError) for what information is available for the error.")]
...
impl GetPackageVersionHistoryError {
    /// Creates the `GetPackageVersionHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPackageVersionHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPackageVersionHistoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_package_version_history::GetPackageVersionHistoryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_package_version_history::_get_package_version_history_output::GetPackageVersionHistoryOutput;

pub use crate::operation::get_package_version_history::_get_package_version_history_input::GetPackageVersionHistoryInput;

mod _get_package_version_history_input;

mod _get_package_version_history_output;
