...
impl GetPackageVersionHistoryInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_package_version_history::GetPackageVersionHistory::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPackageVersionHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_package_version_history::de_get_package_version_history_http_response_with_props(status, headers, body)
        }
    }
}
