    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/vpcEndpoints")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_vpc_endpoints::ListVpcEndpoints::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_vpc_endpoints::ListVpcEndpointsError
{
