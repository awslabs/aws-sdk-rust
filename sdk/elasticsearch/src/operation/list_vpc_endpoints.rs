...
/// Orchestration and serialization glue logic for `ListVpcEndpoints`.
...
impl ListVpcEndpoints {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_vpc_endpoints::ListVpcEndpointsInput,
                    ) -> ::std::result::Result<crate::operation::list_vpc_endpoints::ListVpcEndpointsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_vpc_endpoints::ListVpcEndpointsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_vpc_endpoints::ListVpcEndpointsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_vpc_endpoints::ListVpcEndpointsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVpcEndpoints {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVpcEndpoints");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVpcEndpointsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVpcEndpointsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVpcEndpoints")
...
.with_interceptor(ListVpcEndpointsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_vpc_endpoints::ListVpcEndpointsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_vpc_endpoints::ListVpcEndpointsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_vpc_endpoints::ListVpcEndpointsError>::new());
...
#[derive(Debug)]
            struct ListVpcEndpointsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVpcEndpointsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_vpc_endpoints::de_list_vpc_endpoints_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_vpc_endpoints::de_list_vpc_endpoints_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVpcEndpointsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVpcEndpointsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_vpc_endpoints::ListVpcEndpointsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_vpc_endpoints::ListVpcEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/vpcEndpoints").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_vpc_endpoints::ListVpcEndpointsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListVpcEndpointsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVpcEndpointsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListVpcEndpointsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVpcEndpointsInput>()
                        .ok_or("failed to downcast to ListVpcEndpointsInput")?;
...
pub enum ListVpcEndpointsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVpcEndpointsError) for what information is available for the error.")]
...
impl ListVpcEndpointsError {
    /// Creates the `ListVpcEndpointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVpcEndpointsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVpcEndpointsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_vpc_endpoints::ListVpcEndpointsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_vpc_endpoints::_list_vpc_endpoints_output::ListVpcEndpointsOutput;

pub use crate::operation::list_vpc_endpoints::_list_vpc_endpoints_input::ListVpcEndpointsInput;

mod _list_vpc_endpoints_input;

mod _list_vpc_endpoints_output;
