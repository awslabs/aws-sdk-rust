...
impl ListVpcEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`ListVpcEndpoints`](crate::operation::list_vpc_endpoints::ListVpcEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_vpc_endpoints::ListVpcEndpoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vpc_endpoints::ListVpcEndpointsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2015-01-01/es/vpcEndpoints").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_vpc_endpoints::ListVpcEndpointsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpc_endpoints::ListVpcEndpoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListVpcEndpoints", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListVpcEndpoints {
                type Output = std::result::Result<crate::operation::list_vpc_endpoints::ListVpcEndpointsOutput, crate::operation::list_vpc_endpoints::ListVpcEndpointsError>;
