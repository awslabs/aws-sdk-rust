...
impl ListVpcEndpointsForDomainInput {
    /// Consumes the builder and constructs an Operation<[`ListVpcEndpointsForDomain`](crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-01-01/es/domain/{DomainName}/vpcEndpoints", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListVpcEndpointsForDomain", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListVpcEndpointsForDomain {
                type Output = std::result::Result<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainOutput, crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError>;
