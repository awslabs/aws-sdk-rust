...
/// Orchestration and serialization glue logic for `ListVpcEndpointsForDomain`.
...
impl ListVpcEndpointsForDomain {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput,
                    ) -> ::std::result::Result<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVpcEndpointsForDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVpcEndpointsForDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVpcEndpointsForDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVpcEndpointsForDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVpcEndpointsForDomain")
...
.with_interceptor(ListVpcEndpointsForDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError>::new());
...
#[derive(Debug)]
            struct ListVpcEndpointsForDomainResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVpcEndpointsForDomainResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_vpc_endpoints_for_domain::de_list_vpc_endpoints_for_domain_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_vpc_endpoints_for_domain::de_list_vpc_endpoints_for_domain_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVpcEndpointsForDomainRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVpcEndpointsForDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-01-01/es/domain/{DomainName}/vpcEndpoints", DomainName = domain_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListVpcEndpointsForDomainEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVpcEndpointsForDomainEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListVpcEndpointsForDomainEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVpcEndpointsForDomainInput>()
                        .ok_or("failed to downcast to ListVpcEndpointsForDomainInput")?;
...
pub enum ListVpcEndpointsForDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVpcEndpointsForDomainError) for what information is available for the error.")]
...
impl ListVpcEndpointsForDomainError {
    /// Creates the `ListVpcEndpointsForDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVpcEndpointsForDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVpcEndpointsForDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError {
...
mod _list_vpc_endpoints_for_domain_output;
