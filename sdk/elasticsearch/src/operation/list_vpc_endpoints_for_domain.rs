...
impl ListVpcEndpointsForDomainInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVpcEndpointsForDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_vpc_endpoints_for_domain::de_list_vpc_endpoints_for_domain_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_vpc_endpoints_for_domain::ListVpcEndpointsForDomainError
{
