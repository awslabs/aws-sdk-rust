    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PurchaseReservedElasticsearchInstanceOffering {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PurchaseReservedElasticsearchInstanceOffering");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PurchaseReservedElasticsearchInstanceOfferingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PurchaseReservedElasticsearchInstanceOfferingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PurchaseReservedElasticsearchInstanceOffering")
...
.with_interceptor(PurchaseReservedElasticsearchInstanceOfferingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingError>::new());
...
#[derive(Debug)]
            struct PurchaseReservedElasticsearchInstanceOfferingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PurchaseReservedElasticsearchInstanceOfferingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_purchase_reserved_elasticsearch_instance_offering::de_purchase_reserved_elasticsearch_instance_offering_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_purchase_reserved_elasticsearch_instance_offering::de_purchase_reserved_elasticsearch_instance_offering_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PurchaseReservedElasticsearchInstanceOfferingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PurchaseReservedElasticsearchInstanceOfferingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/purchaseReservedInstanceOffering").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_purchase_reserved_elasticsearch_instance_offering::ser_purchase_reserved_elasticsearch_instance_offering_input(&input)?);
...
#[derive(Debug)]
            struct PurchaseReservedElasticsearchInstanceOfferingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PurchaseReservedElasticsearchInstanceOfferingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PurchaseReservedElasticsearchInstanceOfferingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PurchaseReservedElasticsearchInstanceOfferingInput>()
                        .ok_or("failed to downcast to PurchaseReservedElasticsearchInstanceOfferingInput")?;
...
pub enum PurchaseReservedElasticsearchInstanceOfferingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PurchaseReservedElasticsearchInstanceOfferingError) for what information is available for the error.")]
...
impl PurchaseReservedElasticsearchInstanceOfferingError {
    /// Creates the `PurchaseReservedElasticsearchInstanceOfferingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PurchaseReservedElasticsearchInstanceOfferingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PurchaseReservedElasticsearchInstanceOfferingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOfferingError {
...
mod _purchase_reserved_elasticsearch_instance_offering_output;
