    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::purchase_reserved_elasticsearch_instance_offering::PurchaseReservedElasticsearchInstanceOffering, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/purchaseReservedInstanceOffering")
    ...
    for PurchaseReservedElasticsearchInstanceOffering
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_purchase_reserved_elasticsearch_instance_offering::de_purchase_reserved_elasticsearch_instance_offering_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type PurchaseReservedElasticsearchInstanceOfferingErrorKind =
