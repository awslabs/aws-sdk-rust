...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for PurchaseReservedElasticsearchInstanceOfferingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PurchaseReservedElasticsearchInstanceOfferingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_purchase_reserved_elasticsearch_instance_offering::ser_purchase_reserved_elasticsearch_instance_offering_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PurchaseReservedElasticsearchInstanceOfferingEndpointParamsInterceptor {
