...
impl DescribeDomainAutoTunesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_domain_auto_tunes::DescribeDomainAutoTunesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_domain_auto_tunes::DescribeDomainAutoTunesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_domain_auto_tunes::DescribeDomainAutoTunesOutput, crate::operation::describe_domain_auto_tunes::DescribeDomainAutoTunesError, Self> {
