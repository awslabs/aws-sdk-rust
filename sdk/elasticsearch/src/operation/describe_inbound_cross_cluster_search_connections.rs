    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_inbound_cross_cluster_search_connections::DescribeInboundCrossClusterSearchConnections, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/ccs/inboundConnection/search")
    ...
    for DescribeInboundCrossClusterSearchConnections
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_inbound_cross_cluster_search_connections::de_describe_inbound_cross_cluster_search_connections_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type DescribeInboundCrossClusterSearchConnectionsErrorKind =
