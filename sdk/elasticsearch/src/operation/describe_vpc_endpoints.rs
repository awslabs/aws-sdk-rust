    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_vpc_endpoints::DescribeVpcEndpoints, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_vpc_endpoints::DescribeVpcEndpointsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2015-01-01/es/vpcEndpoints/describe").expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_vpc_endpoints::DescribeVpcEndpoints::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeVpcEndpoints", "elasticsearchservice"));
