...
impl DescribeVpcEndpoints {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elasticsearch Service.DescribeVpcEndpoints",
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/2015-01-01/es/vpcEndpoints/describe").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_vpc_endpoints::ser_describe_vpc_endpoints_input(
            &input,
        )?);
