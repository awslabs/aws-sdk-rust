...
impl ListElasticsearchVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListElasticsearchVersions`](crate::operation::list_elasticsearch_versions::ListElasticsearchVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_elasticsearch_versions::ListElasticsearchVersions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2015-01-01/es/versions").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_elasticsearch_versions::ListElasticsearchVersions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListElasticsearchVersions", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListElasticsearchVersions {
                type Output = std::result::Result<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsOutput, crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError>;
