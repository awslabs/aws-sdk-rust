...
/// Orchestration and serialization glue logic for `ListElasticsearchVersions`.
...
impl ListElasticsearchVersions {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput,
                    ) -> ::std::result::Result<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListElasticsearchVersions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListElasticsearchVersions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListElasticsearchVersionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListElasticsearchVersionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListElasticsearchVersions")
...
.with_interceptor(ListElasticsearchVersionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError>::new());
...
#[derive(Debug)]
            struct ListElasticsearchVersionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListElasticsearchVersionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_elasticsearch_versions::de_list_elasticsearch_versions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_elasticsearch_versions::de_list_elasticsearch_versions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListElasticsearchVersionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListElasticsearchVersionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/versions").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListElasticsearchVersionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListElasticsearchVersionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListElasticsearchVersionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListElasticsearchVersionsInput>()
                        .ok_or("failed to downcast to ListElasticsearchVersionsInput")?;
...
pub enum ListElasticsearchVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListElasticsearchVersionsError) for what information is available for the error.")]
...
impl ListElasticsearchVersionsError {
    /// Creates the `ListElasticsearchVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListElasticsearchVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListElasticsearchVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_elasticsearch_versions::_list_elasticsearch_versions_output::ListElasticsearchVersionsOutput;

pub use crate::operation::list_elasticsearch_versions::_list_elasticsearch_versions_input::ListElasticsearchVersionsInput;

mod _list_elasticsearch_versions_input;

mod _list_elasticsearch_versions_output;
