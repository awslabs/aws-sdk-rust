    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/versions")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_elasticsearch_versions::ListElasticsearchVersions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_elasticsearch_versions::ListElasticsearchVersionsError
{
