...
impl ListElasticsearchVersionsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_elasticsearch_versions::ListElasticsearchVersions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListElasticsearchVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_elasticsearch_versions::de_list_elasticsearch_versions_http_response_with_props(status, headers, body)
        }
    }
}
