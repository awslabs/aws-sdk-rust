...
impl RevokeVpcEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`RevokeVpcEndpointAccess`](crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-01-01/es/domain/{DomainName}/revokeVpcEndpointAccess", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RevokeVpcEndpointAccess", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for RevokeVpcEndpointAccess {
                type Output = std::result::Result<crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessOutput, crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessError>;
