...
impl RevokeVpcEndpointAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elasticsearch Service.RevokeVpcEndpointAccess",
            "rpc.service" = "Elasticsearch Service",
            "rpc.method" = "RevokeVpcEndpointAccess",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeVpcEndpointAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RevokeVpcEndpointAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RevokeVpcEndpointAccessResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RevokeVpcEndpointAccess")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeVpcEndpointAccess")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RevokeVpcEndpointAccessTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RevokeVpcEndpointAccessTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeVpcEndpointAccessTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RevokeVpcEndpointAccessInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeVpcEndpointAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_revoke_vpc_endpoint_access::de_revoke_vpc_endpoint_access_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_revoke_vpc_endpoint_access::de_revoke_vpc_endpoint_access_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeVpcEndpointAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_vpc_endpoint_access::ser_revoke_vpc_endpoint_access_input(&input)?,
        );
