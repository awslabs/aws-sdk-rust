...
impl RevokeVpcEndpointAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccess,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeVpcEndpointAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_vpc_endpoint_access::de_revoke_vpc_endpoint_access_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::revoke_vpc_endpoint_access::RevokeVpcEndpointAccessError
{
