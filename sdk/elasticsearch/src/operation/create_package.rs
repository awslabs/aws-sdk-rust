...
impl CreatePackageInput {
    /// Consumes the builder and constructs an Operation<[`CreatePackage`](crate::operation::create_package::CreatePackage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_package::CreatePackage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_package::ser_create_package_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_package::CreatePackage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePackage", "elasticsearchservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePackage {
    type Output = ::std::result::Result<crate::operation::create_package::CreatePackageOutput, crate::operation::create_package::CreatePackageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_package::de_create_package_http_response_with_props(status, headers, body)
        }
    }
}
