    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpgradeElasticsearchDomainResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpgradeElasticsearchDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpgradeElasticsearchDomainEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError {
