...
/// Orchestration and serialization glue logic for `UpgradeElasticsearchDomain`.
...
impl UpgradeElasticsearchDomain {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpgradeElasticsearchDomain {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpgradeElasticsearchDomain");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpgradeElasticsearchDomainRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpgradeElasticsearchDomainResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpgradeElasticsearchDomain")
...
.with_interceptor(UpgradeElasticsearchDomainEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>::new());
...
#[derive(Debug)]
            struct UpgradeElasticsearchDomainResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpgradeElasticsearchDomainResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_upgrade_elasticsearch_domain::de_upgrade_elasticsearch_domain_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_upgrade_elasticsearch_domain::de_upgrade_elasticsearch_domain_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpgradeElasticsearchDomainRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpgradeElasticsearchDomainRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/upgradeDomain").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_upgrade_elasticsearch_domain::ser_upgrade_elasticsearch_domain_input(&input)?);
...
#[derive(Debug)]
            struct UpgradeElasticsearchDomainEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpgradeElasticsearchDomainEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpgradeElasticsearchDomainEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpgradeElasticsearchDomainInput>()
                        .ok_or("failed to downcast to UpgradeElasticsearchDomainInput")?;
...
pub enum UpgradeElasticsearchDomainError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpgradeElasticsearchDomainError) for what information is available for the error.")]
...
impl UpgradeElasticsearchDomainError {
    /// Creates the `UpgradeElasticsearchDomainError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpgradeElasticsearchDomainError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpgradeElasticsearchDomainError {
...
impl ::aws_types::request_id::RequestId for crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError {
...
mod _upgrade_elasticsearch_domain_output;
