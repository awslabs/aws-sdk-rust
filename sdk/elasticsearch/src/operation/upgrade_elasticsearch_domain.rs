...
impl UpgradeElasticsearchDomain {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elasticsearch Service.UpgradeElasticsearchDomain",
            "rpc.service" = "Elasticsearch Service",
            "rpc.method" = "UpgradeElasticsearchDomain",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpgradeElasticsearchDomain {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpgradeElasticsearchDomainRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpgradeElasticsearchDomainResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpgradeElasticsearchDomain")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpgradeElasticsearchDomain")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpgradeElasticsearchDomainTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpgradeElasticsearchDomainTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpgradeElasticsearchDomainTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpgradeElasticsearchDomainInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpgradeElasticsearchDomainResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_upgrade_elasticsearch_domain::de_upgrade_elasticsearch_domain_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_upgrade_elasticsearch_domain::de_upgrade_elasticsearch_domain_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpgradeElasticsearchDomainRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_upgrade_elasticsearch_domain::ser_upgrade_elasticsearch_domain_input(&input)?,
        );
