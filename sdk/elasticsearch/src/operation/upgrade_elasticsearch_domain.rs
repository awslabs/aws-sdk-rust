...
impl UpgradeElasticsearchDomainInput {
    /// Consumes the builder and constructs an Operation<[`UpgradeElasticsearchDomain`](crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomain, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomain::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpgradeElasticsearchDomain", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpgradeElasticsearchDomain {
                type Output = std::result::Result<crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainOutput, crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomainError>;
