...
impl UpgradeElasticsearchDomainInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::upgrade_elasticsearch_domain::UpgradeElasticsearchDomain::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpgradeElasticsearchDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_upgrade_elasticsearch_domain::de_upgrade_elasticsearch_domain_http_response_with_props(status, headers, body)
        }
    }
}
