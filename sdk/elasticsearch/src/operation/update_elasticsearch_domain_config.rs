...
impl UpdateElasticsearchDomainConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_elasticsearch_domain_config::UpdateElasticsearchDomainConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateElasticsearchDomainConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_elasticsearch_domain_config::de_update_elasticsearch_domain_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
