...
impl DescribeElasticsearchDomainInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainInput, ::aws_smithy_types::error::operation::BuildError> {
