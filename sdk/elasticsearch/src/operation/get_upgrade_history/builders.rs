...
impl GetUpgradeHistoryFluentBuilder  {
    /// Creates a new `GetUpgradeHistory`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_upgrade_history::GetUpgradeHistoryOutput, aws_smithy_http::result::SdkError<crate::operation::get_upgrade_history::GetUpgradeHistoryError>>
                     {
