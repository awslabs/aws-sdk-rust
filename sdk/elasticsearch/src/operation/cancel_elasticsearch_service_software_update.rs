...
impl CancelElasticsearchServiceSoftwareUpdate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelElasticsearchServiceSoftwareUpdate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CancelElasticsearchServiceSoftwareUpdate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CancelElasticsearchServiceSoftwareUpdateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CancelElasticsearchServiceSoftwareUpdateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelElasticsearchServiceSoftwareUpdate")
...
.with_interceptor(CancelElasticsearchServiceSoftwareUpdateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError>::new());
...
#[derive(Debug)]
            struct CancelElasticsearchServiceSoftwareUpdateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelElasticsearchServiceSoftwareUpdateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_cancel_elasticsearch_service_software_update::de_cancel_elasticsearch_service_software_update_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CancelElasticsearchServiceSoftwareUpdateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelElasticsearchServiceSoftwareUpdateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/serviceSoftwareUpdate/cancel").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_cancel_elasticsearch_service_software_update::ser_cancel_elasticsearch_service_software_update_input(&input)?);
...
#[derive(Debug)]
            struct CancelElasticsearchServiceSoftwareUpdateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelElasticsearchServiceSoftwareUpdateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CancelElasticsearchServiceSoftwareUpdateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CancelElasticsearchServiceSoftwareUpdateInput>()
                        .ok_or("failed to downcast to CancelElasticsearchServiceSoftwareUpdateInput")?;
...
pub enum CancelElasticsearchServiceSoftwareUpdateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CancelElasticsearchServiceSoftwareUpdateError) for what information is available for the error.")]
...
impl CancelElasticsearchServiceSoftwareUpdateError {
    /// Creates the `CancelElasticsearchServiceSoftwareUpdateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelElasticsearchServiceSoftwareUpdateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CancelElasticsearchServiceSoftwareUpdateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::cancel_elasticsearch_service_software_update::CancelElasticsearchServiceSoftwareUpdateError {
...
mod _cancel_elasticsearch_service_software_update_output;
