...
impl DeleteElasticsearchServiceRoleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRole,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteElasticsearchServiceRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_elasticsearch_service_role::de_delete_elasticsearch_service_role_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteElasticsearchServiceRoleError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError
{
