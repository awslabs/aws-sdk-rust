...
impl DeleteElasticsearchServiceRole {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleInput,
                    ) -> ::std::result::Result<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteElasticsearchServiceRole {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteElasticsearchServiceRole");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteElasticsearchServiceRoleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteElasticsearchServiceRoleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteElasticsearchServiceRole")
...
.with_interceptor(DeleteElasticsearchServiceRoleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError>::new());
...
#[derive(Debug)]
            struct DeleteElasticsearchServiceRoleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteElasticsearchServiceRoleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_elasticsearch_service_role::de_delete_elasticsearch_service_role_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteElasticsearchServiceRoleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteElasticsearchServiceRoleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/role").expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteElasticsearchServiceRoleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteElasticsearchServiceRoleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteElasticsearchServiceRoleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteElasticsearchServiceRoleInput>()
                        .ok_or("failed to downcast to DeleteElasticsearchServiceRoleInput")?;
...
pub enum DeleteElasticsearchServiceRoleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteElasticsearchServiceRoleError) for what information is available for the error.")]
...
impl DeleteElasticsearchServiceRoleError {
    /// Creates the `DeleteElasticsearchServiceRoleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteElasticsearchServiceRoleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteElasticsearchServiceRoleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleError {
...
mod _delete_elasticsearch_service_role_output;
