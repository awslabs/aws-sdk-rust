...
impl DeleteElasticsearchServiceRoleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRole::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteElasticsearchServiceRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_elasticsearch_service_role::de_delete_elasticsearch_service_role_http_response_with_props(
                status, headers, body,
            )
        }
    }
