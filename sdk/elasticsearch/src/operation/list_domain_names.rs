    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                ...
                ::std::write!(output, "/2015-01-01/domain").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_domain_names::ListDomainNames::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDomainNames", "elasticsearchservice"));
