...
impl AuthorizeVpcEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeVpcEndpointAccess`](crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-01-01/es/domain/{DomainName}/authorizeVpcEndpointAccess", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AuthorizeVpcEndpointAccess", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for AuthorizeVpcEndpointAccess {
                type Output = std::result::Result<crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessOutput, crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessError>;
