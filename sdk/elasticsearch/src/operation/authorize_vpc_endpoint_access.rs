...
impl AuthorizeVpcEndpointAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccess,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeVpcEndpointAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_authorize_vpc_endpoint_access::de_authorize_vpc_endpoint_access_http_response_with_props(
                status, headers, body,
            )
        }
    }
