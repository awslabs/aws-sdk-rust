...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeElasticsearchInstanceTypeLimits {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_elasticsearch_instance_type_limits::de_describe_elasticsearch_instance_type_limits_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type DescribeElasticsearchInstanceTypeLimitsErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for DescribeElasticsearchInstanceTypeLimitsError
{
