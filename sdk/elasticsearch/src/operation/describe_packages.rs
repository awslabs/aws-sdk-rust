...
impl DescribePackagesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePackages`](crate::operation::describe_packages::DescribePackages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_packages::DescribePackages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_packages::DescribePackagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_packages::DescribePackages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribePackages", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribePackages {
                type Output = std::result::Result<crate::operation::describe_packages::DescribePackagesOutput, crate::operation::describe_packages::DescribePackagesError>;
