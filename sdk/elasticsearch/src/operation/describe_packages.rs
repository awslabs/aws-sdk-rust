...
impl DescribePackagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_packages::DescribePackages, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_packages::ser_describe_packages_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_packages::de_describe_packages_http_response_with_props(status, headers, body)
        }
    }
}
