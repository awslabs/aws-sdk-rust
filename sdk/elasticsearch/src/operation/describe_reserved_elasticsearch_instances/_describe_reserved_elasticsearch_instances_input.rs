...
impl DescribeReservedElasticsearchInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_reserved_elasticsearch_instances::DescribeReservedElasticsearchInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
