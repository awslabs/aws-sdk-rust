...
impl DescribeElasticsearchDomainConfigInput {
    /// Consumes the builder and constructs an Operation<[`DescribeElasticsearchDomainConfig`](crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfig, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-01-01/es/domain/{DomainName}/config", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfig::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeElasticsearchDomainConfig", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeElasticsearchDomainConfig {
                type Output = std::result::Result<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigOutput, crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError>;
