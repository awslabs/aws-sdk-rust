    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeElasticsearchDomainConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeElasticsearchDomainConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeElasticsearchDomainConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeElasticsearchDomainConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeElasticsearchDomainConfig")
...
.with_interceptor(DescribeElasticsearchDomainConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError>::new());
...
#[derive(Debug)]
            struct DescribeElasticsearchDomainConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeElasticsearchDomainConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_elasticsearch_domain_config::de_describe_elasticsearch_domain_config_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_elasticsearch_domain_config::de_describe_elasticsearch_domain_config_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeElasticsearchDomainConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeElasticsearchDomainConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-01-01/es/domain/{DomainName}/config", DomainName = domain_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DescribeElasticsearchDomainConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeElasticsearchDomainConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeElasticsearchDomainConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeElasticsearchDomainConfigInput>()
                        .ok_or("failed to downcast to DescribeElasticsearchDomainConfigInput")?;
...
pub enum DescribeElasticsearchDomainConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeElasticsearchDomainConfigError) for what information is available for the error.")]
...
impl DescribeElasticsearchDomainConfigError {
    /// Creates the `DescribeElasticsearchDomainConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeElasticsearchDomainConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeElasticsearchDomainConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_elasticsearch_domain_config::DescribeElasticsearchDomainConfigError {
...
mod _describe_elasticsearch_domain_config_output;
