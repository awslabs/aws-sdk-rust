    ...
    pub(crate) async fn orchestrate(
                        ...
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateOutboundCrossClusterSearchConnection {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateOutboundCrossClusterSearchConnection");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateOutboundCrossClusterSearchConnectionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateOutboundCrossClusterSearchConnectionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateOutboundCrossClusterSearchConnection")
...
.with_interceptor(CreateOutboundCrossClusterSearchConnectionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError>::new());
...
#[derive(Debug)]
            struct CreateOutboundCrossClusterSearchConnectionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateOutboundCrossClusterSearchConnectionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_outbound_cross_cluster_search_connection::de_create_outbound_cross_cluster_search_connection_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateOutboundCrossClusterSearchConnectionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateOutboundCrossClusterSearchConnectionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/2015-01-01/es/ccs/outboundConnection").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_outbound_cross_cluster_search_connection::ser_create_outbound_cross_cluster_search_connection_input(&input)?);
...
#[derive(Debug)]
            struct CreateOutboundCrossClusterSearchConnectionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateOutboundCrossClusterSearchConnectionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateOutboundCrossClusterSearchConnectionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateOutboundCrossClusterSearchConnectionInput>()
                        .ok_or("failed to downcast to CreateOutboundCrossClusterSearchConnectionInput")?;
...
pub enum CreateOutboundCrossClusterSearchConnectionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateOutboundCrossClusterSearchConnectionError) for what information is available for the error.")]
...
impl CreateOutboundCrossClusterSearchConnectionError {
    /// Creates the `CreateOutboundCrossClusterSearchConnectionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateOutboundCrossClusterSearchConnectionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateOutboundCrossClusterSearchConnectionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_outbound_cross_cluster_search_connection::_create_outbound_cross_cluster_search_connection_output::CreateOutboundCrossClusterSearchConnectionOutput;

pub use crate::operation::create_outbound_cross_cluster_search_connection::_create_outbound_cross_cluster_search_connection_input::CreateOutboundCrossClusterSearchConnectionInput;

mod _create_outbound_cross_cluster_search_connection_input;

mod _create_outbound_cross_cluster_search_connection_output;
