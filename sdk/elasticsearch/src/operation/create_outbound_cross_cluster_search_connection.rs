...
impl CreateOutboundCrossClusterSearchConnectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateOutboundCrossClusterSearchConnection`](crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2015-01-01/es/ccs/outboundConnection")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateOutboundCrossClusterSearchConnection", "elasticsearchservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse
    for CreateOutboundCrossClusterSearchConnection
{
    type Output = ::std::result::Result<crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionOutput, crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_outbound_cross_cluster_search_connection::de_create_outbound_cross_cluster_search_connection_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type CreateOutboundCrossClusterSearchConnectionErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for CreateOutboundCrossClusterSearchConnectionError
{
...
impl ::aws_http::request_id::RequestId for crate::operation::create_outbound_cross_cluster_search_connection::CreateOutboundCrossClusterSearchConnectionError {
