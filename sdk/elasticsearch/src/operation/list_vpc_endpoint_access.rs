...
impl ListVpcEndpointAccess {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Elasticsearch Service.ListVpcEndpointAccess",
            "rpc.service" = "Elasticsearch Service",
            "rpc.method" = "ListVpcEndpointAccess",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVpcEndpointAccess {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListVpcEndpointAccessRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListVpcEndpointAccessResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListVpcEndpointAccess")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVpcEndpointAccess")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListVpcEndpointAccessTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListVpcEndpointAccessTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVpcEndpointAccessTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListVpcEndpointAccessInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVpcEndpointAccessResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_vpc_endpoint_access::de_list_vpc_endpoint_access_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_vpc_endpoint_access::de_list_vpc_endpoint_access_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVpcEndpointAccessRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput,
