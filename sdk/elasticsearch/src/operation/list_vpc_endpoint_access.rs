...
/// Orchestration and serialization glue logic for `ListVpcEndpointAccess`.
...
impl ListVpcEndpointAccess {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput,
                    ) -> ::std::result::Result<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListVpcEndpointAccess {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListVpcEndpointAccess");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListVpcEndpointAccessRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListVpcEndpointAccessResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListVpcEndpointAccess")
...
.with_interceptor(ListVpcEndpointAccessEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>::new());
...
#[derive(Debug)]
            struct ListVpcEndpointAccessResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListVpcEndpointAccessResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_vpc_endpoint_access::de_list_vpc_endpoint_access_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_vpc_endpoint_access::de_list_vpc_endpoint_access_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListVpcEndpointAccessRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListVpcEndpointAccessRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/2015-01-01/es/domain/{DomainName}/listVpcEndpointAccess", DomainName = domain_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListVpcEndpointAccessEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListVpcEndpointAccessEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListVpcEndpointAccessEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListVpcEndpointAccessInput>()
                        .ok_or("failed to downcast to ListVpcEndpointAccessInput")?;
...
pub enum ListVpcEndpointAccessError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListVpcEndpointAccessError) for what information is available for the error.")]
...
impl ListVpcEndpointAccessError {
    /// Creates the `ListVpcEndpointAccessError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListVpcEndpointAccessError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListVpcEndpointAccessError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_vpc_endpoint_access::_list_vpc_endpoint_access_output::ListVpcEndpointAccessOutput;

pub use crate::operation::list_vpc_endpoint_access::_list_vpc_endpoint_access_input::ListVpcEndpointAccessInput;

mod _list_vpc_endpoint_access_input;

mod _list_vpc_endpoint_access_output;
