...
impl ListVpcEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`ListVpcEndpointAccess`](crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccess, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/2015-01-01/es/domain/{DomainName}/listVpcEndpointAccess", DomainName = domain_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccess::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListVpcEndpointAccess", "elasticsearchservice"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListVpcEndpointAccess {
                type Output = std::result::Result<crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessOutput, crate::operation::list_vpc_endpoint_access::ListVpcEndpointAccessError>;
