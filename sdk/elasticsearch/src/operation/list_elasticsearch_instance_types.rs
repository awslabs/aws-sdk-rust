...
impl ListElasticsearchInstanceTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_elasticsearch_instance_types::ListElasticsearchInstanceTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListElasticsearchInstanceTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_elasticsearch_instance_types::de_list_elasticsearch_instance_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
