...
> {
    ...
    Err(match error_code {
        ...
        "DisabledOperationException" => {
            crate::operation::authorize_vpc_endpoint_access::AuthorizeVpcEndpointAccessError::DisabledOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AuthorizedPrincipal" => {
                    builder = builder.set_authorized_principal(crate::protocol_serde::shape_authorized_principal::de_authorized_principal(tokens)?);
                }
