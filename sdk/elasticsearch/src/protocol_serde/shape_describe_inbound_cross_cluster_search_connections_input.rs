...
pub fn ser_describe_inbound_cross_cluster_search_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribeInboundCrossClusterSearchConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
