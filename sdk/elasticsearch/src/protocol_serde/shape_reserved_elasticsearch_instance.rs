...
pub(crate) fn de_reserved_elasticsearch_instance<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ReservedElasticsearchInstance>, aws_smithy_json::deserialize::error::DeserializeError>
