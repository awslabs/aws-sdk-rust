...
) -> Result<Option<crate::types::ElasticsearchDomainConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ElasticsearchVersion" => {
                            builder = builder.set_elasticsearch_version(
                                crate::protocol_serde::shape_elasticsearch_version_status::de_elasticsearch_version_status(tokens)?,
                            );
                        }
                        "ElasticsearchClusterConfig" => {
                            builder = builder.set_elasticsearch_cluster_config(
                                crate::protocol_serde::shape_elasticsearch_cluster_config_status::de_elasticsearch_cluster_config_status(tokens)?,
                            );
                        }
                        "EBSOptions" => {
                            builder = builder.set_ebs_options(crate::protocol_serde::shape_ebs_options_status::de_ebs_options_status(tokens)?);
                        }
                        "AccessPolicies" => {
                            builder =
                        ...
                        "VPCOptions" => {
                            builder =
                                builder.set_vpc_options(crate::protocol_serde::shape_vpc_derived_info_status::de_vpc_derived_info_status(tokens)?);
                        }
                        "CognitoOptions" => {
                            builder =
                                builder.set_cognito_options(crate::protocol_serde::shape_cognito_options_status::de_cognito_options_status(tokens)?);
                        }
                        ...
                        "AdvancedOptions" => {
                            builder = builder
                                .set_advanced_options(crate::protocol_serde::shape_advanced_options_status::de_advanced_options_status(tokens)?);
                        }
