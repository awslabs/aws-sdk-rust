...
pub(crate) fn de_elasticsearch_domain_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ElasticsearchDomainConfig>, aws_smithy_json::deserialize::error::DeserializeError>
