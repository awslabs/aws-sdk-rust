...
) -> std::result::Result<crate::operation::delete_vpc_endpoint::DeleteVpcEndpointOutput, crate::operation::delete_vpc_endpoint::DeleteVpcEndpointError>
{
    Ok({
        ...
        crate::serde_util::delete_vpc_endpoint_output_correct_errors(output).build()
    })
}
...
) -> Result<crate::operation::delete_vpc_endpoint::builders::DeleteVpcEndpointOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
