...
pub(crate) fn de_reserved_elasticsearch_instance_offering<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ReservedElasticsearchInstanceOffering>, aws_smithy_json::deserialize::error::DeserializeError>
