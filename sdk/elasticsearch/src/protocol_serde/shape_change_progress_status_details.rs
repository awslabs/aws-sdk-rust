...
) -> Result<Option<crate::types::ChangeProgressStatusDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::OverallChangeStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "PendingProperties" => {
                            builder = builder.set_pending_properties(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "CompletedProperties" => {
                            builder = builder.set_completed_properties(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "TotalNumberOfStages" => {
