...
pub(crate) fn de_encryption_at_rest_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::EncryptionAtRestOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
