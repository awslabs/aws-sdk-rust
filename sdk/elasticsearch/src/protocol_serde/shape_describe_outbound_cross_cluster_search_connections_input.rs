...
pub fn ser_describe_outbound_cross_cluster_search_connections_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_outbound_cross_cluster_search_connections::DescribeOutboundCrossClusterSearchConnectionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
