...
pub(crate) fn de_domain_endpoint_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DomainEndpointOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "EnforceHTTPS" => {
                            builder = builder.set_enforce_https(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "TLSSecurityPolicy" => {
                            builder = builder.set_tls_security_policy(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TlsSecurityPolicy::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "CustomEndpointEnabled" => {
                            builder = builder.set_custom_endpoint_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "CustomEndpoint" => {
