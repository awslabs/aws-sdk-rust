...
pub(crate) fn de_elasticsearch_domain_status<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ElasticsearchDomainStatus>, aws_smithy_json::deserialize::error::DeserializeError>
