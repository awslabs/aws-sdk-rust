...
pub fn ser_cancel_elasticsearch_service_software_update_input(
    ...
    crate::protocol_serde::shape_cancel_elasticsearch_service_software_update_input::ser_cancel_elasticsearch_service_software_update_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_elasticsearch_service_software_update_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
