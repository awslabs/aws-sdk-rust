...
pub fn ser_elasticsearch_cluster_config(
    ...
    if let Some(var_5) = &input.zone_awareness_config {
        ...
        crate::protocol_serde::shape_zone_awareness_config::ser_zone_awareness_config(
            &mut object_6,
            var_5,
        )?;
        object_6.finish();
    ...
    if let Some(var_12) = &input.cold_storage_options {
        ...
        crate::protocol_serde::shape_cold_storage_options::ser_cold_storage_options(
            &mut object_13,
            var_12,
        )?;
        object_13.finish();
...
pub(crate) fn de_elasticsearch_cluster_config<'a, I>(
    ...
    Option<crate::types::ElasticsearchClusterConfig>,
