...
pub fn ser_elasticsearch_cluster_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ElasticsearchClusterConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_elasticsearch_cluster_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ElasticsearchClusterConfig>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "WarmType" => {
                                builder = builder.set_warm_type(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::EsWarmPartitionInstanceType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
