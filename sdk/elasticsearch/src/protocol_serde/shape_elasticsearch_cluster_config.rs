...
pub fn ser_elasticsearch_cluster_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ElasticsearchClusterConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_elasticsearch_cluster_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ElasticsearchClusterConfig>, aws_smithy_json::deserialize::error::DeserializeError>
