...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_elasticsearch_domain::CreateElasticsearchDomainError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_elasticsearch_domain::CreateElasticsearchDomainError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ResourceAlreadyExistsException" => {
            crate::operation::create_elasticsearch_domain::CreateElasticsearchDomainError::ResourceAlreadyExistsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_elasticsearch_domain::de_create_elasticsearch_domain(_response_body, output)
            .map_err(crate::operation::create_elasticsearch_domain::CreateElasticsearchDomainError::unhandled)?;
