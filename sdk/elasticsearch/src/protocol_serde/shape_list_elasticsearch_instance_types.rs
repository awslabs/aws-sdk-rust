...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_elasticsearch_instance_types::ListElasticsearchInstanceTypesError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_elasticsearch_instance_types::ListElasticsearchInstanceTypesError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_elasticsearch_instance_types::de_list_elasticsearch_instance_types(_response_body, output)
            .map_err(crate::operation::list_elasticsearch_instance_types::ListElasticsearchInstanceTypesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ElasticsearchInstanceTypes" => {
                    builder = builder.set_elasticsearch_instance_types(
                        crate::protocol_serde::shape_elasticsearch_instance_type_list::de_elasticsearch_instance_type_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
