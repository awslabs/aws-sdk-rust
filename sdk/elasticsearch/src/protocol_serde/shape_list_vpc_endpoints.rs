...
pub fn de_list_vpc_endpoints_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_vpc_endpoints_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_vpc_endpoints::ListVpcEndpointsError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "VpcEndpointSummaryList" => {
                    builder = builder.set_vpc_endpoint_summary_list(
                        crate::protocol_serde::shape_vpc_endpoint_summary_list::de_vpc_endpoint_summary_list(tokens, _value, depth + 1)?,
                    );
                }
