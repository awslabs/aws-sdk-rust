...
pub fn de_delete_elasticsearch_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_elasticsearch_domain::DeleteElasticsearchDomainOutput, crate::operation::delete_elasticsearch_domain::DeleteElasticsearchDomainError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_elasticsearch_domain::DeleteElasticsearchDomainError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_elasticsearch_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_elasticsearch_domain::DeleteElasticsearchDomainOutput, crate::operation::delete_elasticsearch_domain::DeleteElasticsearchDomainError> {
    Ok({
        #[allow(unused_mut)]
