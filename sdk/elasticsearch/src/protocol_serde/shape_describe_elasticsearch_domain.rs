...
pub fn de_describe_elasticsearch_domain_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainOutput, crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_elasticsearch_domain_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainOutput, crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainError> {
    Ok({
        #[allow(unused_mut)]
