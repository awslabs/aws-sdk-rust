...
pub fn ser_create_elasticsearch_domain_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateElasticsearchDomainInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
