...
pub fn de_get_package_version_history_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_package_version_history::GetPackageVersionHistoryOutput, crate::operation::get_package_version_history::GetPackageVersionHistoryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_package_version_history::GetPackageVersionHistoryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_package_version_history_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_package_version_history::GetPackageVersionHistoryOutput, crate::operation::get_package_version_history::GetPackageVersionHistoryError> {
    Ok({
        #[allow(unused_mut)]
