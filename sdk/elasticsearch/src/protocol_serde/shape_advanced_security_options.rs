            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "SAMLOptions" => {
                            builder = builder.set_saml_options(crate::protocol_serde::shape_saml_options_output::de_saml_options_output(tokens)?);
                        }
                        ...
                        "AnonymousAuthEnabled" => {
                            builder = builder.set_anonymous_auth_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
