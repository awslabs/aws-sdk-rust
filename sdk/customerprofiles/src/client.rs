...
impl Client  {
    ...
    pub fn get_profile_object_type_template(&self) -> fluent_builders::GetProfileObjectTypeTemplate {
    ...
    pub fn list_profile_object_type_templates(&self) -> fluent_builders::ListProfileObjectTypeTemplates {
