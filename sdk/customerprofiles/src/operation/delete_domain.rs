    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/domains/{DomainName}", DomainName = domain_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_domain::DeleteDomain::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDomain {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_domain::de_delete_domain_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_domain::de_delete_domain_http_response_with_props(
                status, headers, body,
            )
        }
    }
