...
impl SearchProfilesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_profiles::SearchProfiles, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_profiles::ser_search_profiles_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchProfiles {
    type Output =
        ::std::result::Result<crate::operation::search_profiles::SearchProfilesOutput, crate::operation::search_profiles::SearchProfilesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_profiles::de_search_profiles_http_response_with_props(status, headers, body)
        }
    }
}
