...
impl ListIdentityResolutionJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_identity_resolution_jobs::ListIdentityResolutionJobsInput, ::aws_smithy_types::error::operation::BuildError> {
