...
impl GetIntegrationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_integration::ser_get_integration_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_integration::GetIntegration::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetIntegration", "customerprofiles"));
