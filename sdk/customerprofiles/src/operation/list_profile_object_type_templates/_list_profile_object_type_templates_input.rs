...
impl ListProfileObjectTypeTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_profile_object_type_templates::ListProfileObjectTypeTemplatesInput, ::aws_smithy_types::error::operation::BuildError> {
