...
impl GetIntegrationOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_integration::GetIntegrationOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_integration::GetIntegrationOutput {
                domain_name: self.domain_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_name", "domain_name was not specified but it is required when building GetIntegrationOutput")
                    )?
                ,
                uri: self.uri
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("uri", "uri was not specified but it is required when building GetIntegrationOutput")
                    )?
                ,
                ...
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building GetIntegrationOutput")
                    )?
                ,
                last_updated_at: self.last_updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_updated_at", "last_updated_at was not specified but it is required when building GetIntegrationOutput")
                    )?
                ,
                tags: self.tags
                ,
