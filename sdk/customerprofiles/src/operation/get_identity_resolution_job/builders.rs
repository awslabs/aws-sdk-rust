...
impl GetIdentityResolutionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_identity_resolution_job::GetIdentityResolutionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_identity_resolution_job::GetIdentityResolutionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_identity_resolution_job::GetIdentityResolutionJobOutput, crate::operation::get_identity_resolution_job::GetIdentityResolutionJobError, Self> {
