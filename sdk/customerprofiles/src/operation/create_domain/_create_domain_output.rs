        ...
        ::std::result::Result::Ok(
            crate::operation::create_domain::CreateDomainOutput {
                domain_name: self.domain_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("domain_name", "domain_name was not specified but it is required when building CreateDomainOutput")
                    )?
                ,
                default_expiration_days: self.default_expiration_days
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("default_expiration_days", "default_expiration_days was not specified but it is required when building CreateDomainOutput")
                    )?
                ,
                ...
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building CreateDomainOutput")
                    )?
                ,
                last_updated_at: self.last_updated_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_updated_at", "last_updated_at was not specified but it is required when building CreateDomainOutput")
                    )?
                ,
                tags: self.tags
                ,
