...
pub use crate::operation::delete_profile_object::_delete_profile_object_output::DeleteProfileObjectOutputBuilder;

pub use crate::operation::delete_profile_object::_delete_profile_object_input::DeleteProfileObjectInputBuilder;
...
impl DeleteProfileObjectInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.delete_profile_object();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_profile_object::DeleteProfileObjectOutput,
                    crate::operation::delete_profile_object::DeleteProfileObjectError,
                > for DeleteProfileObjectFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteProfileObjectFluentBuilder {
    ...
    /// Access the DeleteProfileObject as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_profile_object::builders::DeleteProfileObjectInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_profile_object::DeleteProfileObjectOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_profile_object::DeleteProfileObjectError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_profile_object::DeleteProfileObject::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_profile_object::DeleteProfileObject::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_profile_object::DeleteProfileObjectOutput, crate::operation::delete_profile_object::DeleteProfileObjectError, Self> {
    ...
    pub fn get_profile_object_unique_key(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_profile_object_unique_key()
    }
