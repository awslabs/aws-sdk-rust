...
impl DeleteProfileObjectFluentBuilder  {
    /// Creates a new `DeleteProfileObject`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_profile_object::DeleteProfileObjectOutput, aws_smithy_http::result::SdkError<crate::operation::delete_profile_object::DeleteProfileObjectError>>
                     {
