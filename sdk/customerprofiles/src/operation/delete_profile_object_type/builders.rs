...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_profile_object_type::DeleteProfileObjectTypeOutput,
                    crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError,
                > for DeleteProfileObjectTypeFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteProfileObjectTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_profile_object_type::DeleteProfileObjectTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_profile_object_type::DeleteProfileObjectTypeOutput, crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError, Self> {
