...
impl DeleteIntegrationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_integration::ser_delete_integration_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_integration::DeleteIntegration::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteIntegration", "customerprofiles"));
