...
impl GetAutoMergingPreviewFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_auto_merging_preview::GetAutoMergingPreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_auto_merging_preview::GetAutoMergingPreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_auto_merging_preview::GetAutoMergingPreviewOutput, crate::operation::get_auto_merging_preview::GetAutoMergingPreviewError, Self> {
