...
pub struct UpdateDomainOutput  {
    ...
    #[doc(hidden)]pub matching: std::option::Option<crate::model::MatchingResponse>,
...
pub struct SearchProfilesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::Profile>>,
...
pub struct PutIntegrationOutput  {
    ...
    #[doc(hidden)]pub is_unstructured: std::option::Option<bool>,
}
...
pub struct ListWorkflowsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListWorkflowsItem>>,
...
pub struct ListProfileObjectTypeTemplatesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListProfileObjectTypeTemplateItem>>,
...
pub struct ListProfileObjectTypesOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListProfileObjectTypeItem>>,
...
pub struct ListProfileObjectsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListProfileObjectsItem>>,
...
pub struct ListIntegrationsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListIntegrationItem>>,
...
pub struct ListIdentityResolutionJobsOutput  {
    ...
    #[doc(hidden)]pub identity_resolution_jobs_list: std::option::Option<std::vec::Vec<crate::model::IdentityResolutionJob>>,
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListIdentityResolutionJobsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("identity_resolution_jobs_list", &self.identity_resolution_jobs_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListDomainsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::ListDomainItem>>,
...
pub struct GetWorkflowStepsOutput  {
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::WorkflowStepItem>>,
    /// <p>If there are additional results, this is the token for the next set of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetWorkflowOutput  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<crate::model::WorkflowAttributes>,
    /// <p>Workflow specific execution metrics.</p>
    #[doc(hidden)]pub metrics: std::option::Option<crate::model::WorkflowMetrics>,
}
...
pub struct GetProfileObjectTypeTemplateOutput  {
    ...
    #[doc(hidden)]pub source_object: std::option::Option<std::string::String>,
    /// <p>Indicates whether a profile should be created when data is received if one doesn’t exist for an object of this type. The default is <code>FALSE</code>. If the AllowProfileCreation flag is set to <code>FALSE</code>, then the service tries to fetch a standard profile and associate this object with the profile. If it is set to <code>TRUE</code>, and if no match is found, then the service creates a new standard profile.</p>
    #[doc(hidden)]pub allow_profile_creation: bool,
...
pub struct GetMatchesOutput  {
    ...
    #[doc(hidden)]pub match_generation_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The number of potential matches found.</p>
    #[doc(hidden)]pub potential_matches: std::option::Option<i32>,
    /// <p>The list of matched profiles for this instance.</p>
    #[doc(hidden)]pub matches: std::option::Option<std::vec::Vec<crate::model::MatchItem>>,
}
...
pub struct GetIdentityResolutionJobOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::IdentityResolutionJobStatus>,
    ...
    #[doc(hidden)]pub job_start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The timestamp of when the Identity Resolution Job was completed.</p>
    #[doc(hidden)]pub job_end_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub job_expiration_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Configuration settings for how to perform the auto-merging of profiles.</p>
    #[doc(hidden)]pub auto_merging: std::option::Option<crate::model::AutoMerging>,
    /// <p>The S3 location where the Identity Resolution Job writes result files.</p>
    #[doc(hidden)]pub exporting_location: std::option::Option<crate::model::ExportingLocation>,
    /// <p>Statistics about the Identity Resolution Job.</p>
    #[doc(hidden)]pub job_stats: std::option::Option<crate::model::JobStats>,
}
...
pub struct GetDomainOutput  {
    ...
    #[doc(hidden)]pub stats: std::option::Option<crate::model::DomainStats>,
    /// <p>The process of matching duplicate profiles. If <code>Matching</code> = <code>true</code>, Amazon Connect Customer Profiles starts a weekly batch process called Identity Resolution Job. If you do not specify a date and time for Identity Resolution Job to run, by default it runs every Saturday at 12AM UTC to detect duplicate profiles in your domains. </p> 
    /// <p>After the Identity Resolution Job completes, use the <a href="https://docs.aws.amazon.com/customerprofiles/latest/APIReference/API_GetMatches.html">GetMatches</a> API to return and review the results. Or, if you have configured <code>ExportingConfig</code> in the <code>MatchingRequest</code>, you can download the results from S3.</p>
    #[doc(hidden)]pub matching: std::option::Option<crate::model::MatchingResponse>,
    /// <p>The timestamp of when the domain was created.</p>
...
pub struct GetAutoMergingPreviewOutput  {
    ...
    #[doc(hidden)]pub number_of_matches_in_sample: i64,
    /// <p>The number of profiles found in this preview dry run.</p>
    #[doc(hidden)]pub number_of_profiles_in_sample: i64,
    /// <p>The number of profiles that would be merged if this wasn't a preview dry run.</p>
    #[doc(hidden)]pub number_of_profiles_will_be_merged: i64,
}
...
impl  std::fmt::Debug for GetAutoMergingPreviewOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("domain_name", &self.domain_name);
        formatter.field("number_of_matches_in_sample", &self.number_of_matches_in_sample);
        formatter.field("number_of_profiles_in_sample", &self.number_of_profiles_in_sample);
        formatter.field("number_of_profiles_will_be_merged", &self.number_of_profiles_will_be_merged);
        formatter.finish()
    }
}
