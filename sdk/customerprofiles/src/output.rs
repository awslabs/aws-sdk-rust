...
pub struct GetMatchesOutput {
    ...
    pub match_generation_date: std::option::Option<smithy_types::Instant>,
...
pub mod get_matches_output {
    ...
    pub struct Builder {
        pub(crate) next_token: std::option::Option<std::string::String>,
        pub(crate) match_generation_date: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The timestamp this version of Match Result generated.</p>
        pub fn match_generation_date(mut self, input: smithy_types::Instant) -> Self {
