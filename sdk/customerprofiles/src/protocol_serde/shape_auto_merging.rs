...
pub(crate) fn de_auto_merging<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoMerging>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_auto_merging(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoMerging) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
