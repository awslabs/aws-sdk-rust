...
) -> Result<Option<crate::types::MatchingResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "JobSchedule" => {
                            builder = builder.set_job_schedule(crate::protocol_serde::shape_job_schedule::de_job_schedule(tokens)?);
                        }
                        "AutoMerging" => {
