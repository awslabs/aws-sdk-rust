...
pub fn ser_matching_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MatchingRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
