...
pub fn de_delete_profile_object_type_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_profile_object_type::DeleteProfileObjectTypeOutput, crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_profile_object_type_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_profile_object_type::DeleteProfileObjectTypeOutput, crate::operation::delete_profile_object_type::DeleteProfileObjectTypeError> {
    Ok({
        #[allow(unused_mut)]
