                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "PartyType" => {
                            builder = builder.set_party_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::PartyType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "BusinessName" => {
                        ...
                        "MailingAddress" => {
                            builder = builder.set_mailing_address(crate::protocol_serde::shape_address::de_address(tokens)?);
                        }
                        "BillingAddress" => {
                            builder = builder.set_billing_address(crate::protocol_serde::shape_address::de_address(tokens)?);
                        }
                        "Attributes" => {
                            builder = builder.set_attributes(crate::protocol_serde::shape_attributes::de_attributes(tokens)?);
                        }
                        "FoundByItems" => {
                            builder = builder.set_found_by_items(crate::protocol_serde::shape_found_by_list::de_found_by_list(tokens)?);
                        }
                        "PartyTypeString" => {
