...
pub fn ser_put_profile_object_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutProfileObjectTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
