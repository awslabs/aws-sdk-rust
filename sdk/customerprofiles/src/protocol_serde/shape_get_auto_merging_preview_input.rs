...
pub fn ser_get_auto_merging_preview_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetAutoMergingPreviewInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
