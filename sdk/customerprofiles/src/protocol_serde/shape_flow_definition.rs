...
pub fn ser_flow_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FlowDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
