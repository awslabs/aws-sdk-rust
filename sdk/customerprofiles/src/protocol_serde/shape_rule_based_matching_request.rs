...
pub fn ser_rule_based_matching_request(
    ...
    if let Some(var_5) = &input.max_allowed_rule_level_for_merging {
        object.key("MaxAllowedRuleLevelForMerging").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.max_allowed_rule_level_for_matching {
        object.key("MaxAllowedRuleLevelForMatching").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
