...
pub(crate) fn de_rule_based_matching_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RuleBasedMatchingResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "MatchingRules" => {
                                builder = builder.set_matching_rules(
                                    crate::protocol_serde::shape_matching_rules::de_matching_rules(tokens)?
                                );
                            }
                            "Status" => {
                                builder = builder.set_status(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RuleBasedMatchingStatus::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
