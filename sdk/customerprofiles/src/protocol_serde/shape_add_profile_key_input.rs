...
pub fn ser_add_profile_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddProfileKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
