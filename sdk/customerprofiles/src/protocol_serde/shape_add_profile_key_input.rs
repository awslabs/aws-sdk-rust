...
pub fn ser_add_profile_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::add_profile_key::AddProfileKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
