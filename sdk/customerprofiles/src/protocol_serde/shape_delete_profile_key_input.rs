...
pub fn ser_delete_profile_key_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteProfileKeyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
