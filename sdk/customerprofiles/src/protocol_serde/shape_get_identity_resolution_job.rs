...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_identity_resolution_job::GetIdentityResolutionJobError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_identity_resolution_job::GetIdentityResolutionJobError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_identity_resolution_job::de_get_identity_resolution_job(_response_body, output)
            .map_err(crate::operation::get_identity_resolution_job::GetIdentityResolutionJobError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "AutoMerging" => {
                    builder = builder.set_auto_merging(crate::protocol_serde::shape_auto_merging::de_auto_merging(tokens, _value, depth + 1)?);
                }
                "DomainName" => {
                ...
                "ExportingLocation" => {
                    builder = builder.set_exporting_location(crate::protocol_serde::shape_exporting_location::de_exporting_location(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "JobStats" => {
                    builder = builder.set_job_stats(crate::protocol_serde::shape_job_stats::de_job_stats(tokens, _value, depth + 1)?);
                }
                "LastUpdatedAt" => {
                ...
                "Status" => {
                    builder = builder.set_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::IdentityResolutionJobStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
