...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_profile_object_type::de_get_profile_object_type(_response_body, output)
            .map_err(crate::operation::get_profile_object_type::GetProfileObjectTypeError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_profile_object_type_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_profile_object_type::GetProfileObjectTypeError::unhandled)?
    })
}
