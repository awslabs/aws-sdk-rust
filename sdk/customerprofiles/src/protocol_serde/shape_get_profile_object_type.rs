...
pub fn de_get_profile_object_type_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_profile_object_type::GetProfileObjectTypeOutput, crate::operation::get_profile_object_type::GetProfileObjectTypeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_profile_object_type::GetProfileObjectTypeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_profile_object_type_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_profile_object_type::GetProfileObjectTypeOutput, crate::operation::get_profile_object_type::GetProfileObjectTypeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_profile_object_type::builders::GetProfileObjectTypeOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_profile_object_type::de_get_profile_object_type(response.body().as_ref(), output).map_err(crate::operation::get_profile_object_type::GetProfileObjectTypeError::unhandled)?;
