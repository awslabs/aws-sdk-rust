        ...
        for (key_2, value_3) in &input.attributes {
            {
                ...
                crate::protocol_serde::shape_filter_attribute_dimension::ser_filter_attribute_dimension(&mut object_4, value_3)?;
                object_4.finish();
            }
        }
        object_1.finish();
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::FilterDimensionBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(crate::serde_util::filter_dimension_correct_errors(builder).build().map_err(
