...
pub(crate) fn de_list_calculated_attribute_definition_item<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ListCalculatedAttributeDefinitionItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
