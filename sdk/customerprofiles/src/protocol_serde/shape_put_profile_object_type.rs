...
pub fn ser_put_profile_object_type_input(
    ...
    crate::protocol_serde::shape_put_profile_object_type_input::ser_put_profile_object_type_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::put_profile_object_type::PutProfileObjectTypeError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_profile_object_type_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_profile_object_type::de_put_profile_object_type(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_profile_object_type::PutProfileObjectTypeError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                match key.to_unescaped()?.as_ref() {
                    ...
                    "Keys" => {
                        builder = builder
                            .set_keys(crate::protocol_serde::shape_key_map::de_key_map(tokens)?);
                    }
                    "LastUpdatedAt" => {
