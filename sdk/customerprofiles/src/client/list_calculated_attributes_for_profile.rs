...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::list_calculated_attributes_for_profile::builders::ListCalculatedAttributesForProfileFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::list_calculated_attributes_for_profile::builders::ListCalculatedAttributesForProfileFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
    ///   - [`profile_id(impl Into<String>)`](crate::operation::list_calculated_attributes_for_profile::builders::ListCalculatedAttributesForProfileFluentBuilder::profile_id) / [`set_profile_id(Option<String>)`](crate::operation::list_calculated_attributes_for_profile::builders::ListCalculatedAttributesForProfileFluentBuilder::set_profile_id): <p>The unique identifier of a customer profile.</p>
