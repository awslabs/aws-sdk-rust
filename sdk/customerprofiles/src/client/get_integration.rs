...
impl super::Client  {
    ...
    ///   - [`is_unstructured(Option<bool>)`](crate::operation::get_integration::GetIntegrationOutput::is_unstructured): <p>Boolean to indicate if the Flow associated with the Integration is created via Appflow console or with ObjectTypeName equals _unstructured via API/CLI in flowDefinition</p>
