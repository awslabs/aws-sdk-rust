...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_auto_merging_preview::builders::GetAutoMergingPreviewFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_auto_merging_preview::builders::GetAutoMergingPreviewFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
