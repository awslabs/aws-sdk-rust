...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
    ///   - [`uri(impl Into<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::uri) / [`set_uri(Option<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::set_uri): <p>The URI of the S3 bucket or any other type of data source.</p>
    ///   - [`object_type_name(impl Into<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::object_type_name) / [`set_object_type_name(Option<String>)`](crate::operation::put_integration::builders::PutIntegrationFluentBuilder::set_object_type_name): <p>The name of the profile object type.</p>
