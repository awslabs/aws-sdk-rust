...
impl super::Client {
    ...
    ///   - [`domain_name(impl Into<String>)`](crate::operation::list_event_streams::builders::ListEventStreamsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::list_event_streams::builders::ListEventStreamsFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_event_streams::builders::ListEventStreamsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_event_streams::builders::ListEventStreamsFluentBuilder::set_next_token): <p>Identifies the next page of results to return.</p>
