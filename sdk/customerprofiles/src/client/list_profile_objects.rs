...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::set_next_token):<br>required: **false**<br><p>The pagination token from the previous call to ListProfileObjects.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of objects returned per page.</p><br>
    ///   - [`domain_name(impl Into<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::set_domain_name):<br>required: **true**<br><p>The unique name of the domain.</p><br>
    ///   - [`object_type_name(impl Into<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::object_type_name) / [`set_object_type_name(Option<String>)`](crate::operation::list_profile_objects::builders::ListProfileObjectsFluentBuilder::set_object_type_name):<br>required: **true**<br><p>The name of the profile object type.</p><br>
