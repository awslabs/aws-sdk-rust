...
impl ::std::convert::From<&str> for SegmentType {
    fn from(s: &str) -> Self {
        match s {
            "CLASSIC" => SegmentType::Classic,
            "ENHANCED" => SegmentType::Enhanced,
...
impl SegmentType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SegmentType::Classic => "CLASSIC",
            SegmentType::Enhanced => "ENHANCED",
...
impl ::std::fmt::Display for SegmentType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SegmentType::Classic => write!(f, "CLASSIC"),
            SegmentType::Enhanced => write!(f, "ENHANCED"),
