...
impl ::std::fmt::Display for ComparisonOperator {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ComparisonOperator::After => write!(f, "AFTER"),
            ComparisonOperator::Before => write!(f, "BEFORE"),
