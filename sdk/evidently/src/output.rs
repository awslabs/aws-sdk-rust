...
pub struct ListSegmentReferencesOutput  {
    ...
    #[doc(hidden)]pub referenced_by: std::option::Option<std::vec::Vec<crate::model::RefResource>>,
...
pub struct ListSegmentsOutput  {
    ...
    #[doc(hidden)]pub segments: std::option::Option<std::vec::Vec<crate::model::Segment>>,
...
pub struct CreateSegmentOutput  {
    ...
    #[doc(hidden)]pub segment: std::option::Option<crate::model::Segment>,
}
...
pub struct PutProjectEventsOutput  {
    ...
    #[doc(hidden)]pub failed_event_count: std::option::Option<i32>,
    /// <p>A structure that contains Evidently's response to the sent events, including an event ID and error codes, if any.</p>
    #[doc(hidden)]pub event_results: std::option::Option<std::vec::Vec<crate::model::PutProjectEventsResultEntry>>,
}
...
pub struct BatchEvaluateFeatureOutput  {
    ...
    #[doc(hidden)]pub results: std::option::Option<std::vec::Vec<crate::model::EvaluationResult>>,
}
...
pub struct StartLaunchOutput  {
    ...
    #[doc(hidden)]pub launch: std::option::Option<crate::model::Launch>,
}
...
pub struct ListLaunchesOutput  {
    ...
    #[doc(hidden)]pub launches: std::option::Option<std::vec::Vec<crate::model::Launch>>,
...
pub struct ListFeaturesOutput  {
    ...
    #[doc(hidden)]pub features: std::option::Option<std::vec::Vec<crate::model::FeatureSummary>>,
...
pub struct CreateFeatureOutput  {
    ...
    #[doc(hidden)]pub feature: std::option::Option<crate::model::Feature>,
}
...
pub struct GetExperimentResultsOutput  {
    ...
    #[doc(hidden)]pub results_data: std::option::Option<std::vec::Vec<crate::model::ExperimentResultsData>>,
    /// <p>An array of structures that include the reports that you requested.</p>
    #[doc(hidden)]pub reports: std::option::Option<std::vec::Vec<crate::model::ExperimentReport>>,
...
pub struct ListExperimentsOutput  {
    ...
    #[doc(hidden)]pub experiments: std::option::Option<std::vec::Vec<crate::model::Experiment>>,
...
pub struct CreateExperimentOutput  {
    ...
    #[doc(hidden)]pub experiment: std::option::Option<crate::model::Experiment>,
}
...
pub struct TestSegmentPatternOutput  {
    ...
    #[doc(hidden)]pub r#match: std::option::Option<bool>,
}
