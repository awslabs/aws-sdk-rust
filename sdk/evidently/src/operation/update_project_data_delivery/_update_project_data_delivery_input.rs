...
impl UpdateProjectDataDeliveryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_project_data_delivery::UpdateProjectDataDeliveryInput, ::aws_smithy_types::error::operation::BuildError> {
