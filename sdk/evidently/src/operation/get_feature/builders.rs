...
impl GetFeatureFluentBuilder  {
    /// Creates a new `GetFeature`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_feature::GetFeatureOutput, aws_smithy_http::result::SdkError<crate::operation::get_feature::GetFeatureError>>
                     {
