...
impl CreateSegmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_segment::CreateSegment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_segment::ser_create_segment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSegment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_segment::de_create_segment_http_response_with_props(status, headers, body)
        }
    }
}
