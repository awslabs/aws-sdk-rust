...
impl crate::operation::get_launch::builders::GetLaunchInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_launch::GetLaunchOutput, crate::operation::get_launch::GetLaunchError>
    for GetLaunchFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_launch::GetLaunchOutput, crate::operation::get_launch::GetLaunchError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetLaunchFluentBuilder {
    /// Creates a new `GetLaunchFluentBuilder`.
