...
impl BatchEvaluateFeatureFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_evaluate_feature::BatchEvaluateFeatureOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_evaluate_feature::BatchEvaluateFeatureError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_evaluate_feature::BatchEvaluateFeatureOutput, crate::operation::batch_evaluate_feature::BatchEvaluateFeatureError, Self> {
