...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::delete_launch::builders::DeleteLaunchFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::delete_launch::builders::DeleteLaunchFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the launch to delete.</p><br>
