...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::set_project): <p>The name or ARN of the project that you want to create the launch in.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::set_name): <p>The name for the new launch.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_launch::builders::CreateLaunchFluentBuilder::set_description): <p>An optional description for the launch.</p>
