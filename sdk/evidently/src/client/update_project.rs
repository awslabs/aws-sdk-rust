...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::update_project::builders::UpdateProjectFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::update_project::builders::UpdateProjectFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project to update.</p><br>
