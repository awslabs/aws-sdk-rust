...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::stop_launch::builders::StopLaunchFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::stop_launch::builders::StopLaunchFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the launch that you want to stop.</p><br>
    ///   - [`launch(impl Into<String>)`](crate::operation::stop_launch::builders::StopLaunchFluentBuilder::launch) / [`set_launch(impl Into<String>)`](crate::operation::stop_launch::builders::StopLaunchFluentBuilder::set_launch):<br>required: **true**<br><p>The name of the launch to stop.</p><br>
