...
impl super::Client {
    ...
    ///   - [`segment(impl Into<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::segment) / [`set_segment(Option<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::set_segment):<br>required: **true**<br><p>The ARN of the segment to return information for.</p><br>
