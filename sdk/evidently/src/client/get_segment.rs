...
impl super::Client {
    ...
    ///   - [`segment(impl ::std::convert::Into<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::segment) / [`set_segment(Option<String>)`](crate::operation::get_segment::builders::GetSegmentFluentBuilder::set_segment): <p>The ARN of the segment to return information for.</p>
