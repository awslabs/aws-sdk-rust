...
impl super::Client {
    ...
    ///   - [`segment(impl Into<String>)`](crate::operation::delete_segment::builders::DeleteSegmentFluentBuilder::segment) / [`set_segment(impl Into<String>)`](crate::operation::delete_segment::builders::DeleteSegmentFluentBuilder::set_segment):<br>required: **true**<br><p>Specifies the segment to delete.</p><br>
