...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the experiment.</p><br>
    ///   - [`experiment(impl Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::experiment) / [`set_experiment(impl Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::set_experiment):<br>required: **true**<br><p>The name of the experiment that you want to see the details of.</p><br>
