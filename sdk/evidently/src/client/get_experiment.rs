...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::set_project): <p>The name or ARN of the project that contains the experiment.</p>
    ///   - [`experiment(impl ::std::convert::Into<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::experiment) / [`set_experiment(Option<String>)`](crate::operation::get_experiment::builders::GetExperimentFluentBuilder::set_experiment): <p>The name of the experiment that you want to see the details of.</p>
