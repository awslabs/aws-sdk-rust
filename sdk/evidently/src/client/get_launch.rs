...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::get_launch::builders::GetLaunchFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::get_launch::builders::GetLaunchFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the launch.</p><br>
    ///   - [`launch(impl Into<String>)`](crate::operation::get_launch::builders::GetLaunchFluentBuilder::launch) / [`set_launch(impl Into<String>)`](crate::operation::get_launch::builders::GetLaunchFluentBuilder::set_launch):<br>required: **true**<br><p>The name of the launch that you want to see the details of.</p><br>
