...
impl super::Client {
    ...
    ///   - [`events(Event)`](crate::operation::put_project_events::builders::PutProjectEventsFluentBuilder::events) / [`set_events(Option<Vec<Event>>)`](crate::operation::put_project_events::builders::PutProjectEventsFluentBuilder::set_events): <p>An array of event structures that contain the performance data that is being sent to Evidently.</p>
