...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that you want to see the details of.</p><br>
