...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::set_project): <p>The name or ARN of the project that you want to see the details of.</p>
