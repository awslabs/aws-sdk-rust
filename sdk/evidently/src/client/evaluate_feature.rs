...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::set_project): <p>The name or ARN of the project that contains this feature.</p>
    ///   - [`feature(impl ::std::convert::Into<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::feature) / [`set_feature(Option<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::set_feature): <p>The name of the feature being evaluated.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::set_entity_id): <p>An internal ID that represents a unique user of the application. This <code>entityID</code> is checked against any override rules assigned for this feature.</p>
    ///   - [`evaluation_context(impl ::std::convert::Into<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::evaluation_context) / [`set_evaluation_context(Option<String>)`](crate::operation::evaluate_feature::builders::EvaluateFeatureFluentBuilder::set_evaluation_context): <p>A JSON object of attributes that you can optionally pass in as part of the evaluation event sent to Evidently from the user session. Evidently can use this value to match user sessions with defined audience segments. For more information, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Evidently-segments.html">Use segments to focus your audience</a>.</p>  <p>If you include this parameter, the value must be a JSON object. A JSON array is not supported.</p>
