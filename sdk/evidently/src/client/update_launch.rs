...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::set_project): <p>The name or ARN of the project that contains the launch that you want to update.</p>
    ///   - [`launch(impl ::std::convert::Into<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::launch) / [`set_launch(Option<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::set_launch): <p>The name of the launch that is to be updated.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::set_description): <p>An optional description for the launch.</p>
    ...
    ///   - [`randomization_salt(impl ::std::convert::Into<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::randomization_salt) / [`set_randomization_salt(Option<String>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::set_randomization_salt): <p>When Evidently assigns a particular user session to a launch, it must use a randomization ID to determine which variation the user session is served. This randomization ID is a combination of the entity ID and <code>randomizationSalt</code>. If you omit <code>randomizationSalt</code>, Evidently uses the launch name as the <code>randomizationSalt</code>.</p>
