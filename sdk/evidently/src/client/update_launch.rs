...
impl super::Client {
    ...
    ///   - [`metric_monitors(MetricMonitorConfig)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::metric_monitors) / [`set_metric_monitors(Option<Vec<MetricMonitorConfig>>)`](crate::operation::update_launch::builders::UpdateLaunchFluentBuilder::set_metric_monitors): <p>An array of structures that define the metrics that will be used to monitor the launch performance.</p>
