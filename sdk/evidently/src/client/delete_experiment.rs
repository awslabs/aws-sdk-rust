...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the experiment to delete.</p><br>
    ///   - [`experiment(impl Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::experiment) / [`set_experiment(impl Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::set_experiment):<br>required: **true**<br><p>The name of the experiment to delete.</p><br>
