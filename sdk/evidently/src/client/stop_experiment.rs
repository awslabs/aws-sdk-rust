...
impl super::Client {
    ...
    ///   - [`project(impl Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::project) / [`set_project(impl Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_project):<br>required: **true**<br><p>The name or ARN of the project that contains the experiment to stop.</p><br>
    ///   - [`experiment(impl Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::experiment) / [`set_experiment(impl Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_experiment):<br>required: **true**<br><p>The name of the experiment to stop.</p><br>
    ...
    ///   - [`reason(impl Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::reason) / [`set_reason(Option<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_reason):<br>required: **false**<br><p>A string that describes why you are stopping the experiment.</p><br>
