...
impl super::Client {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_project): <p>The name or ARN of the project that contains the experiment to stop.</p>
    ///   - [`experiment(impl ::std::convert::Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::experiment) / [`set_experiment(Option<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_experiment): <p>The name of the experiment to stop.</p>
    ...
    ///   - [`reason(impl ::std::convert::Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::reason) / [`set_reason(Option<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_reason): <p>A string that describes why you are stopping the experiment.</p>
