...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::set_name): <p>A name for the segment.</p>
    ///   - [`pattern(impl ::std::convert::Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::pattern) / [`set_pattern(Option<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::set_pattern): <p>The pattern to use for the segment. For more information about pattern syntax, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Evidently-segments.html#CloudWatch-Evidently-segments-syntax.html"> Segment rule pattern syntax</a>.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::set_description): <p>An optional description for this segment.</p>
