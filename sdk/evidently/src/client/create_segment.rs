...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::set_name):<br>required: **true**<br><p>A name for the segment.</p><br>
    ///   - [`pattern(impl Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::pattern) / [`set_pattern(impl Into<String>)`](crate::operation::create_segment::builders::CreateSegmentFluentBuilder::set_pattern):<br>required: **true**<br><p>The pattern to use for the segment. For more information about pattern syntax, see <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Evidently-segments.html#CloudWatch-Evidently-segments-syntax.html"> Segment rule pattern syntax</a>.</p><br>
