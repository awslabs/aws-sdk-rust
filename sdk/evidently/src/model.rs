...
pub struct RefResource  {
    ...
    #[doc(hidden)]pub last_updated_on: std::option::Option<std::string::String>,
}
impl RefResource {
    /// <p>The name of the experiment or launch.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct Segment  {
    ...
    #[doc(hidden)]pub last_updated_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub experiment_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub launch_count: std::option::Option<i64>,
...
pub struct Project  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ProjectStatus>,
    ...
    #[doc(hidden)]pub feature_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub active_launch_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub active_experiment_count: std::option::Option<i64>,
    /// <p>A structure that contains information about where Evidently is to store evaluation events for longer term storage.</p>
    #[doc(hidden)]pub data_delivery: std::option::Option<crate::model::ProjectDataDelivery>,
    ...
    #[doc(hidden)]pub app_config_resource: std::option::Option<crate::model::ProjectAppConfigResource>,
...
pub struct ProjectDataDelivery  {
    ...
    #[doc(hidden)]pub cloud_watch_logs: std::option::Option<crate::model::CloudWatchLogsDestination>,
}
...
pub struct CloudWatchLogsDestination  {
    ...
    #[doc(hidden)]pub log_group: std::option::Option<std::string::String>,
}
...
pub struct Event  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::EventType>,
    /// <p>The event data.</p>
...
pub struct EvaluationResult  {
    ...
    #[doc(hidden)]pub variation: std::option::Option<std::string::String>,
    /// <p>The value assigned to this variation to differentiate it from the other variations of this feature.</p>
    #[doc(hidden)]pub value: std::option::Option<crate::model::VariableValue>,
...
pub struct Launch  {
    ...
    #[doc(hidden)]pub execution: std::option::Option<crate::model::LaunchExecution>,
    /// <p>An array of structures that define the feature variations that are being used in the launch.</p>
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::LaunchGroup>>,
    /// <p>An array of structures that define the metrics that are being used to monitor the launch performance.</p>
    #[doc(hidden)]pub metric_monitors: std::option::Option<std::vec::Vec<crate::model::MetricMonitor>>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::LaunchType>,
    ...
    #[doc(hidden)]pub scheduled_splits_definition: std::option::Option<crate::model::ScheduledSplitsLaunchDefinition>,
    /// <p>The list of tag keys and values associated with this launch.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl Launch {
...
impl  std::fmt::Debug for Launch  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("r#type", &self.r#type);
        formatter.field("scheduled_splits_definition", &self.scheduled_splits_definition);
        formatter.field("tags", &self.tags);
        formatter.finish()
    }
}
...
pub struct ScheduledSplitsLaunchDefinition  {
    ...
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::ScheduledSplit>>,
}
...
pub struct ScheduledSplit  {
    ...
    #[doc(hidden)]pub group_weights: std::option::Option<std::collections::HashMap<std::string::String, i64>>,
    ...
    #[doc(hidden)]pub segment_overrides: std::option::Option<std::vec::Vec<crate::model::SegmentOverride>>,
}
impl ScheduledSplit {
    /// <p>The date and time that this step of the launch starts.</p>
...
pub struct SegmentOverride  {
    ...
    #[doc(hidden)]pub evaluation_order: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub weights: std::option::Option<std::collections::HashMap<std::string::String, i64>>,
}
...
pub struct MetricMonitor  {
    ...
    #[doc(hidden)]pub metric_definition: std::option::Option<crate::model::MetricDefinition>,
}
impl MetricMonitor {
    /// <p>A structure that defines the metric.</p>
...
pub struct MetricDefinition  {
    ...
    #[doc(hidden)]pub entity_id_key: std::option::Option<std::string::String>,
    /// <p>The value that is tracked to produce the metric.</p>
    #[doc(hidden)]pub value_key: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub unit_label: std::option::Option<std::string::String>,
}
...
pub struct LaunchGroup  {
    ...
    #[doc(hidden)]pub feature_variations: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl LaunchGroup {
    /// <p>The name of the launch group.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct LaunchExecution  {
    ...
    #[doc(hidden)]pub started_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time that the launch ended.</p>
    #[doc(hidden)]pub ended_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct MetricMonitorConfig  {
    /// <p>A structure that defines the metric.</p>
    #[doc(hidden)]pub metric_definition: std::option::Option<crate::model::MetricDefinitionConfig>,
}
...
pub struct ScheduledSplitsLaunchConfig  {
    /// <p>An array of structures that define the traffic allocation percentages among the feature variations during each step of the launch. This also defines the start time of each step.</p>
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::ScheduledSplitConfig>>,
}
...
pub struct FeatureSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::FeatureStatus>,
    ...
    #[doc(hidden)]pub evaluation_rules: std::option::Option<std::vec::Vec<crate::model::EvaluationRule>>,
...
pub struct Feature  {
    ...
    #[doc(hidden)]pub value_type: std::option::Option<crate::model::VariationValueType>,
    /// <p>An array of structures that contain the configuration of the feature's different variations.</p>
    #[doc(hidden)]pub variations: std::option::Option<std::vec::Vec<crate::model::Variation>>,
    /// <p>The name of the variation that is used as the default variation. The default variation is served to users who are not allocated to any ongoing launches or experiments of this feature.</p> 
...
pub struct ExperimentReport  {
    ...
    #[doc(hidden)]pub treatment_name: std::option::Option<std::string::String>,
    /// <p>The type of analysis used for this report.</p>
    #[doc(hidden)]pub report_name: std::option::Option<crate::model::ExperimentReportName>,
...
pub struct ExperimentResultsData  {
    ...
    #[doc(hidden)]pub result_stat: std::option::Option<crate::model::ExperimentResultResponseType>,
...
pub struct Experiment  {
    ...
    #[doc(hidden)]pub schedule: std::option::Option<crate::model::ExperimentSchedule>,
    /// <p>A structure that contains the date and time that the experiment started and ended.</p>
    #[doc(hidden)]pub execution: std::option::Option<crate::model::ExperimentExecution>,
    /// <p>An array of structures that describe the configuration of each feature variation used in the experiment.</p>
    #[doc(hidden)]pub treatments: std::option::Option<std::vec::Vec<crate::model::Treatment>>,
    ...
    #[doc(hidden)]pub metric_goals: std::option::Option<std::vec::Vec<crate::model::MetricGoal>>,
    ...
    #[doc(hidden)]pub sampling_rate: i64,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ExperimentType>,
    ...
    #[doc(hidden)]pub online_ab_definition: std::option::Option<crate::model::OnlineAbDefinition>,
...
pub struct OnlineAbDefinition  {
    ...
    #[doc(hidden)]pub control_treatment_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub treatment_weights: std::option::Option<std::collections::HashMap<std::string::String, i64>>,
}
...
pub struct MetricGoal  {
    ...
    #[doc(hidden)]pub desired_change: std::option::Option<crate::model::ChangeDirectionEnum>,
}
impl MetricGoal {
    /// <p>A structure that contains details about the metric.</p>
    pub fn metric_definition(&self) -> std::option::Option<& crate::model::MetricDefinition> {
