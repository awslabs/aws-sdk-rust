        ...
        ::std::result::Result::Ok(
            crate::types::ScheduledSplitConfig {
                start_time: self.start_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("start_time", "start_time was not specified but it is required when building ScheduledSplitConfig")
                    )?
                ,
                group_weights: self.group_weights
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("group_weights", "group_weights was not specified but it is required when building ScheduledSplitConfig")
                    )?
                ,
