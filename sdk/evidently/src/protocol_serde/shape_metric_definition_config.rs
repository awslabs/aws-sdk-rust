...
pub fn ser_metric_definition_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricDefinitionConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
