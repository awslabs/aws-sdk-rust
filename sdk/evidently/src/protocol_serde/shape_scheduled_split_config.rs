...
pub fn ser_scheduled_split_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ScheduledSplitConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
