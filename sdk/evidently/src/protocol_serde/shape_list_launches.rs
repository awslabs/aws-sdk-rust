...
pub fn de_list_launches_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListLaunchesOutput, crate::error::ListLaunchesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListLaunchesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_launches_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListLaunchesOutput, crate::error::ListLaunchesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_launches_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_launches::de_list_launches(response.body().as_ref(), output).map_err(crate::error::ListLaunchesError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_launches(value: &[u8], mut builder: crate::output::list_launches_output::Builder) -> Result<crate::output::list_launches_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
