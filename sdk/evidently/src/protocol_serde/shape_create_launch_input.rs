...
pub fn ser_create_launch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLaunchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
