...
pub fn ser_update_launch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLaunchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
