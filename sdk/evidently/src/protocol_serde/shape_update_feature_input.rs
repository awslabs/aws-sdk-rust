...
pub fn ser_update_feature_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFeatureInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
