...
pub fn ser_create_feature_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFeatureInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
