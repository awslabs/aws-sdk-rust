...
pub fn ser_create_experiment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateExperimentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
