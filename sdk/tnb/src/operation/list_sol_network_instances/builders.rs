...
impl ListSolNetworkInstancesFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_sol_network_instances::ListSolNetworkInstancesOutput, aws_smithy_http::result::SdkError<crate::operation::list_sol_network_instances::ListSolNetworkInstancesError>>
                     {
