...
impl crate::operation::put_sol_network_package_content::builders::PutSolNetworkPackageContentInputBuilder {
...
impl PutSolNetworkPackageContentFluentBuilder {
    /// Creates a new `PutSolNetworkPackageContentFluentBuilder`.
