...
impl PutSolNetworkPackageContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_sol_network_package_content::PutSolNetworkPackageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_sol_network_package_content::PutSolNetworkPackageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_sol_network_package_content::PutSolNetworkPackageContentOutput, crate::operation::put_sol_network_package_content::PutSolNetworkPackageContentError, Self> {
