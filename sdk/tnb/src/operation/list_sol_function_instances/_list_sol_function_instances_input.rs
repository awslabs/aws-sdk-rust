...
impl ListSolFunctionInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sol_function_instances::ListSolFunctionInstancesInput, ::aws_smithy_types::error::operation::BuildError> {
