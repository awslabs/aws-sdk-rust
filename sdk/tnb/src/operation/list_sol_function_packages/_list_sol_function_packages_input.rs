...
impl ListSolFunctionPackagesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sol_function_packages::ListSolFunctionPackagesInput, ::aws_smithy_types::error::operation::BuildError> {
