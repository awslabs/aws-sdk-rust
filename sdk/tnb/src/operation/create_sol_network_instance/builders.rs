...
impl CreateSolNetworkInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_sol_network_instance::CreateSolNetworkInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_sol_network_instance::CreateSolNetworkInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_sol_network_instance::CreateSolNetworkInstanceOutput, crate::operation::create_sol_network_instance::CreateSolNetworkInstanceError, Self> {
