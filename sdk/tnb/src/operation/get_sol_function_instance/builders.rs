...
impl GetSolFunctionInstanceFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_sol_function_instance::GetSolFunctionInstance, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_sol_function_instance::GetSolFunctionInstanceOutput, aws_smithy_http::result::SdkError<crate::operation::get_sol_function_instance::GetSolFunctionInstanceError>>
                     {
