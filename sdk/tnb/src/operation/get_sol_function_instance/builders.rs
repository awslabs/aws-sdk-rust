...
impl GetSolFunctionInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_sol_function_instance::GetSolFunctionInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sol_function_instance::GetSolFunctionInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_sol_function_instance::GetSolFunctionInstanceOutput, crate::operation::get_sol_function_instance::GetSolFunctionInstanceError, Self> {
