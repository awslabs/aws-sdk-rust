...
impl ValidateSolFunctionPackageContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentOutput, crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError, Self> {
