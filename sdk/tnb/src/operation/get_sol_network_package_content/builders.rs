...
impl crate::operation::get_sol_network_package_content::builders::GetSolNetworkPackageContentInputBuilder {
...
impl GetSolNetworkPackageContentFluentBuilder {
    /// Creates a new `GetSolNetworkPackageContentFluentBuilder`.
