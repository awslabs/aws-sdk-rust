...
impl GetSolNetworkPackageContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_sol_network_package_content::GetSolNetworkPackageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sol_network_package_content::GetSolNetworkPackageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_sol_network_package_content::GetSolNetworkPackageContentOutput, crate::operation::get_sol_network_package_content::GetSolNetworkPackageContentError, Self> {
