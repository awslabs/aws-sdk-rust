...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationOutput,
                    crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationError,
                > for CancelSolNetworkOperationFluentBuilder
            {
                fn send(
                    self,
...
impl CancelSolNetworkOperationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::cancel_sol_network_operation::CancelSolNetworkOperation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationOutput, crate::operation::cancel_sol_network_operation::CancelSolNetworkOperationError, Self> {
