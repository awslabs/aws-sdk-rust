...
impl GetSolFunctionPackageDescriptorInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::get_sol_function_package_descriptor::GetSolFunctionPackageDescriptorOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_sol_function_package_descriptor::GetSolFunctionPackageDescriptorError, ::aws_smithy_http::operation::Response>>
