...
impl crate::operation::terminate_sol_network_instance::builders::TerminateSolNetworkInstanceInputBuilder {
...
impl TerminateSolNetworkInstanceFluentBuilder {
    /// Creates a new `TerminateSolNetworkInstanceFluentBuilder`.
