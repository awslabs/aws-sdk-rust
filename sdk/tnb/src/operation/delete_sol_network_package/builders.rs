...
impl DeleteSolNetworkPackageFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_sol_network_package::DeleteSolNetworkPackageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_sol_network_package::DeleteSolNetworkPackageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_sol_network_package::DeleteSolNetworkPackageOutput, crate::operation::delete_sol_network_package::DeleteSolNetworkPackageError, Self> {
