...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentOutput,
                    crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentError,
                > for PutSolFunctionPackageContentFluentBuilder
            {
                fn send(
                    self,
...
impl PutSolFunctionPackageContentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::put_sol_function_package_content::PutSolFunctionPackageContent::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::put_sol_function_package_content::PutSolFunctionPackageContent::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentOutput, crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentError, Self> {
