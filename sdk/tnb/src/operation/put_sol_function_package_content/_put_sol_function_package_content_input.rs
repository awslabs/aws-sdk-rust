...
impl PutSolFunctionPackageContentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_sol_function_package_content::PutSolFunctionPackageContentInput, ::aws_smithy_types::error::operation::BuildError> {
