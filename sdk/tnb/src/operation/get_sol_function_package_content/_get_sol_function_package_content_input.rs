...
impl GetSolFunctionPackageContentInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_sol_function_package_content::GetSolFunctionPackageContentInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
