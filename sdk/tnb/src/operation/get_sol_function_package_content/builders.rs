...
impl crate::operation::get_sol_function_package_content::builders::GetSolFunctionPackageContentInputBuilder {
...
impl GetSolFunctionPackageContentFluentBuilder {
    /// Creates a new `GetSolFunctionPackageContentFluentBuilder`.
