...
other => NsState::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
...
impl NsState {
    ...
    NsState::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["DELETED", "IMPAIRED", "INSTANTIATED", "INSTANTIATE_IN_PROGRESS", "NOT_INSTANTIATED", "STOPPED", "TERMINATE_IN_PROGRESS", "UPDATE_IN_PROGRESS"]
                }
            }
impl AsRef<str> for NsState {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
