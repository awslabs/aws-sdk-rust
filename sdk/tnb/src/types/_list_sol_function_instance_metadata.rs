...
impl ListSolFunctionInstanceMetadataBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ListSolFunctionInstanceMetadata, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ListSolFunctionInstanceMetadata {
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building ListSolFunctionInstanceMetadata")
                    )?
                ,
                last_modified: self.last_modified
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified", "last_modified was not specified but it is required when building ListSolFunctionInstanceMetadata")
                    )?
                ,
            }
        )
