...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::set_max_results): <p>The maximum number of results to include in the response.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
