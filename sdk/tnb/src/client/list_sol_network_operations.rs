...
impl super::Client {
    ...
    ///   - [`ns_instance_id(impl Into<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::ns_instance_id) / [`set_ns_instance_id(Option<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::set_ns_instance_id):<br>required: **false**<br><p>Network instance id filter, to retrieve network operations associated to a network instance.</p><br>
