...
impl super::Client  {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_sol_network_operations::builders::ListSolNetworkOperationsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
