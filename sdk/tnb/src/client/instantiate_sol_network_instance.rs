...
impl super::Client {
    ...
    ///   - [`ns_instance_id(impl ::std::convert::Into<String>)`](crate::operation::instantiate_sol_network_instance::builders::InstantiateSolNetworkInstanceFluentBuilder::ns_instance_id) / [`set_ns_instance_id(Option<String>)`](crate::operation::instantiate_sol_network_instance::builders::InstantiateSolNetworkInstanceFluentBuilder::set_ns_instance_id): <p>ID of the network instance.</p>
    ...
    ///   - [`ns_lcm_op_occ_id(Option<String>)`](crate::operation::instantiate_sol_network_instance::InstantiateSolNetworkInstanceOutput::ns_lcm_op_occ_id): <p>The identifier of the network operation.</p>
