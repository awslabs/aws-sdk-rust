...
impl super::Client {
    ...
    ///   - [`nsd_info_id(impl ::std::convert::Into<String>)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::nsd_info_id) / [`set_nsd_info_id(Option<String>)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::set_nsd_info_id): <p>Network service descriptor file.</p>
    ///   - [`content_type(PackageContentType)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::content_type) / [`set_content_type(Option<PackageContentType>)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::set_content_type): <p>Network package content type.</p>
    ///   - [`file(Blob)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::file) / [`set_file(Option<Blob>)`](crate::operation::validate_sol_network_package_content::builders::ValidateSolNetworkPackageContentFluentBuilder::set_file): <p>Network package file.</p>
    ...
    ///   - [`id(Option<String>)`](crate::operation::validate_sol_network_package_content::ValidateSolNetworkPackageContentOutput::id): <p>Network package ID.</p>
    ///   - [`arn(Option<String>)`](crate::operation::validate_sol_network_package_content::ValidateSolNetworkPackageContentOutput::arn): <p>Network package ARN.</p>
    ///   - [`nsd_id(Option<String>)`](crate::operation::validate_sol_network_package_content::ValidateSolNetworkPackageContentOutput::nsd_id): <p>Network service descriptor ID.</p>
    ///   - [`nsd_name(Option<String>)`](crate::operation::validate_sol_network_package_content::ValidateSolNetworkPackageContentOutput::nsd_name): <p>Network service descriptor name.</p>
    ///   - [`nsd_version(Option<String>)`](crate::operation::validate_sol_network_package_content::ValidateSolNetworkPackageContentOutput::nsd_version): <p>Network service descriptor version.</p>
