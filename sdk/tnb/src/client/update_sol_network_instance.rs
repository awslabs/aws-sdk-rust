...
impl super::Client {
    ...
    ///   - [`ns_instance_id(impl Into<String>)`](crate::operation::update_sol_network_instance::builders::UpdateSolNetworkInstanceFluentBuilder::ns_instance_id) / [`set_ns_instance_id(Option<String>)`](crate::operation::update_sol_network_instance::builders::UpdateSolNetworkInstanceFluentBuilder::set_ns_instance_id): <p>ID of the network instance.</p>
