...
impl super::Client {
    ...
    ///   - [`vnf_pkg_id(impl Into<String>)`](crate::operation::get_sol_function_package_descriptor::builders::GetSolFunctionPackageDescriptorFluentBuilder::vnf_pkg_id) / [`set_vnf_pkg_id(Option<String>)`](crate::operation::get_sol_function_package_descriptor::builders::GetSolFunctionPackageDescriptorFluentBuilder::set_vnf_pkg_id): <p>ID of the function package.</p>
