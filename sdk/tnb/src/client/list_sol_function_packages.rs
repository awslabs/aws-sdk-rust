...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_sol_function_packages::builders::ListSolFunctionPackagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_sol_function_packages::builders::ListSolFunctionPackagesFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
