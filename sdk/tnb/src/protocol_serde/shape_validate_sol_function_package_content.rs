...
> {
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::validate_sol_function_package_content::ValidateSolFunctionPackageContentError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_validate_sol_function_package_content_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_validate_sol_function_package_content(
    value: &[u8],
