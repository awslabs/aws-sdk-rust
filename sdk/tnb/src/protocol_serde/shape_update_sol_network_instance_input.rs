...
pub fn ser_update_sol_network_instance_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_sol_network_instance::UpdateSolNetworkInstanceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
