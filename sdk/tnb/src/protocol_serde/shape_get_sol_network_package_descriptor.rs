...
pub fn de_get_sol_network_package_descriptor_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorOutput, crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sol_network_package_descriptor_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorOutput, crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError> {
    Ok({
        #[allow(unused_mut)]
