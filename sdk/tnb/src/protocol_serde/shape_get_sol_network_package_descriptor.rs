...
pub fn de_get_sol_network_package_descriptor_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorOutput, crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sol_network_package_descriptor_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorOutput, crate::operation::get_sol_network_package_descriptor::GetSolNetworkPackageDescriptorError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_nsd(
            crate::protocol_serde::shape_get_sol_network_package_descriptor_output::de_nsd_payload(_response_body)?
        );
