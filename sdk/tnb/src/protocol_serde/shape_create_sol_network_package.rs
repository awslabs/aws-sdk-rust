...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_sol_network_package::CreateSolNetworkPackageError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_sol_network_package::CreateSolNetworkPackageError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::create_sol_network_package_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_sol_network_package::CreateSolNetworkPackageError::unhandled)?
    })
}
