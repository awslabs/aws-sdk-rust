...
pub struct PolicyDetails  {
    ...
    #[doc(hidden)]pub policy_type: std::option::Option<crate::model::PolicyTypeValues>,
    ...
    #[doc(hidden)]pub resource_locations: std::option::Option<std::vec::Vec<crate::model::ResourceLocationValues>>,
    /// <p> <b>[Snapshot and AMI policies only]</b> The single tag that identifies targeted resources for this policy.</p>
    #[doc(hidden)]pub target_tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
    ...
    /// </note>
    #[doc(hidden)]pub parameters: std::option::Option<crate::model::Parameters>,
...
pub struct Action  {
    ...
    #[doc(hidden)]pub cross_region_copy: std::option::Option<std::vec::Vec<crate::model::CrossRegionCopyAction>>,
}
impl Action {
    /// <p>A descriptive name for the action.</p>
...
pub struct CrossRegionCopyAction  {
    ...
    #[doc(hidden)]pub retain_rule: std::option::Option<crate::model::CrossRegionCopyRetainRule>,
}
...
pub struct CrossRegionCopyRetainRule  {
    ...
    #[doc(hidden)]pub interval_unit: std::option::Option<crate::model::RetentionIntervalUnitValues>,
}
...
pub struct EncryptionConfiguration  {
    ...
    #[doc(hidden)]pub cmk_arn: std::option::Option<std::string::String>,
}
...
pub struct EventSource  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::EventSourceValues>,
    /// <p>Information about the event.</p>
    #[doc(hidden)]pub parameters: std::option::Option<crate::model::EventParameters>,
}
impl EventSource {
    /// <p>The source of the event. Currently only managed CloudWatch Events rules are supported.</p>
...
pub struct EventParameters  {
    ...
    #[doc(hidden)]pub event_type: std::option::Option<crate::model::EventTypeValues>,
    ...
    #[doc(hidden)]pub snapshot_owner: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub description_regex: std::option::Option<std::string::String>,
}
...
pub struct Parameters  {
    ...
    #[doc(hidden)]pub exclude_boot_volume: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub no_reboot: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub exclude_data_volume_tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
}
impl Parameters {
    /// <p> <b>[Snapshot policies that target instances only]</b> Indicates whether to exclude the root volume from multi-volume snapshot sets. The default is <code>false</code>. If you specify <code>true</code>, then the root volumes attached to targeted instances will be excluded from the multi-volume snapshot sets created by the policy.</p>
...
pub struct Schedule  {
    ...
    #[doc(hidden)]pub variable_tags: std::option::Option<std::vec::Vec<crate::model::Tag>>,
    /// <p>The creation rule.</p>
    #[doc(hidden)]pub create_rule: std::option::Option<crate::model::CreateRule>,
    /// <p>The retention rule for snapshots or AMIs created by the policy.</p>
    #[doc(hidden)]pub retain_rule: std::option::Option<crate::model::RetainRule>,
    /// <p> <b>[Snapshot policies only]</b> The rule for enabling fast snapshot restore.</p>
    #[doc(hidden)]pub fast_restore_rule: std::option::Option<crate::model::FastRestoreRule>,
    ...
    /// </note>
    #[doc(hidden)]pub cross_region_copy_rules: std::option::Option<std::vec::Vec<crate::model::CrossRegionCopyRule>>,
    /// <p> <b>[Snapshot policies only]</b> The rule for sharing snapshots with other Amazon Web Services accounts.</p>
    #[doc(hidden)]pub share_rules: std::option::Option<std::vec::Vec<crate::model::ShareRule>>,
    /// <p> <b>[AMI policies only]</b> The AMI deprecation rule for the schedule.</p>
    #[doc(hidden)]pub deprecate_rule: std::option::Option<crate::model::DeprecateRule>,
    ...
    #[doc(hidden)]pub archive_rule: std::option::Option<crate::model::ArchiveRule>,
}
impl Schedule {
    /// <p>The name of the schedule.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ArchiveRule  {
    ...
    #[doc(hidden)]pub retain_rule: std::option::Option<crate::model::ArchiveRetainRule>,
}
impl ArchiveRule {
    /// <p>Information about the retention period for the snapshot archiving rule.</p>
...
pub struct ArchiveRetainRule  {
    ...
    #[doc(hidden)]pub retention_archive_tier: std::option::Option<crate::model::RetentionArchiveTier>,
}
...
pub struct ShareRule  {
    ...
    #[doc(hidden)]pub target_accounts: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The period after which snapshots that are shared with other Amazon Web Services accounts are automatically unshared.</p>
    #[doc(hidden)]pub unshare_interval: i32,
    /// <p>The unit of time for the automatic unsharing interval.</p>
    #[doc(hidden)]pub unshare_interval_unit: std::option::Option<crate::model::RetentionIntervalUnitValues>,
}
impl ShareRule {
    /// <p>The IDs of the Amazon Web Services accounts with which to share the snapshots.</p>
...
pub struct CrossRegionCopyRule  {
    ...
    /// </note>
    #[doc(hidden)]pub target_region: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub deprecate_rule: std::option::Option<crate::model::CrossRegionCopyDeprecateRule>,
}
...
pub struct CreateRule  {
    ...
    #[doc(hidden)]pub location: std::option::Option<crate::model::LocationValues>,
    /// <p>The interval between snapshots. The supported values are 1, 2, 3, 4, 6, 8, 12, and 24.</p>
    #[doc(hidden)]pub interval: i32,
    /// <p>The interval unit.</p>
    #[doc(hidden)]pub interval_unit: std::option::Option<crate::model::IntervalUnitValues>,
    ...
    #[doc(hidden)]pub times: std::option::Option<std::vec::Vec<std::string::String>>,
