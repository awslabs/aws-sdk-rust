...
/// Orchestration and serialization glue logic for `GetLifecyclePolicies`.
...
impl GetLifecyclePolicies {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_lifecycle_policies::GetLifecyclePoliciesInput,
                    ) -> ::std::result::Result<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetLifecyclePolicies {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetLifecyclePolicies");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetLifecyclePoliciesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetLifecyclePoliciesResponseDeserializer));
...
.with_interceptor(GetLifecyclePoliciesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_lifecycle_policies::de_get_lifecycle_policies_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_lifecycle_policies::de_get_lifecycle_policies_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetLifecyclePoliciesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_lifecycle_policies::GetLifecyclePoliciesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_lifecycle_policies::GetLifecyclePoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/policies").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_lifecycle_policies::GetLifecyclePoliciesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetLifecyclePoliciesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetLifecyclePoliciesInput>()
                        .ok_or("failed to downcast to GetLifecyclePoliciesInput")?;
...
pub enum GetLifecyclePoliciesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetLifecyclePoliciesError) for what information is available for the error.")]
...
impl GetLifecyclePoliciesError {
    /// Creates the `GetLifecyclePoliciesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetLifecyclePoliciesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetLifecyclePoliciesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_lifecycle_policies::GetLifecyclePoliciesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_lifecycle_policies::_get_lifecycle_policies_output::GetLifecyclePoliciesOutput;

pub use crate::operation::get_lifecycle_policies::_get_lifecycle_policies_input::GetLifecyclePoliciesInput;

mod _get_lifecycle_policies_input;

mod _get_lifecycle_policies_output;
