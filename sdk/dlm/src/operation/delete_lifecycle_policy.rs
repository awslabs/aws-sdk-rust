    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let policy_id = ::aws_smithy_http::label::fmt_string(
                    input_1,
                ...
                ::std::write!(output, "/policies/{PolicyId}", PolicyId = policy_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_lifecycle_policy::DeleteLifecyclePolicy::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_lifecycle_policy::DeleteLifecyclePolicyError
{
