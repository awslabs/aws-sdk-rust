...
/// <p> <b>[Snapshot and AMI policies only]</b> Specifies a cross-Region copy rule for a snapshot and AMI policies.</p> <note>
...
pub struct CrossRegionCopyRule {
    ...
    /// <p></p>
    /// </note>
    /// <p> <b>[AMI policies only]</b> The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.</p>
    ...
    /// </note>
    /// <p> <b>[Snapshot policies only]</b> The target Region or the Amazon Resource Name (ARN) of the target Outpost for the snapshot copies.</p>
