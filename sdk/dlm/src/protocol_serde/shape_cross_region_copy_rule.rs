...
pub fn ser_cross_region_copy_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CrossRegionCopyRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cross_region_copy_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CrossRegionCopyRule>, aws_smithy_json::deserialize::error::DeserializeError>
