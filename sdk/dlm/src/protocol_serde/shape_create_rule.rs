            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Times" => {
                            builder = builder.set_times(crate::protocol_serde::shape_times_list::de_times_list(tokens, _value, depth + 1)?);
                        }
                        "CronExpression" => {
                        ...
                        "Scripts" => {
                            builder = builder.set_scripts(crate::protocol_serde::shape_scripts_list::de_scripts_list(tokens, _value, depth + 1)?);
                        }
