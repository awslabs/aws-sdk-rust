...
pub fn ser_update_lifecycle_policy_input_input(
    ...
    if let Some(var_2) = &input.create_interval {
        object.key("CreateInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    ...
    if let Some(var_14) = &input.retain_interval {
        object.key("RetainInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
