...
pub fn ser_update_lifecycle_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLifecyclePolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
