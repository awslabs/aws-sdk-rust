...
pub fn ser_fast_restore_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FastRestoreRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.count != 0 {
...
pub(crate) fn de_fast_restore_rule<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FastRestoreRule>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::fast_restore_rule::Builder::default();
            loop {
                match tokens.next().transpose()? {
                                ...
                                builder = builder.set_interval_unit(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::RetentionIntervalUnitValues::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
