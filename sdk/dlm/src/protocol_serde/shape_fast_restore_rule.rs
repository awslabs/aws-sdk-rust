                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AvailabilityZones" => {
                                builder = builder.set_availability_zones(
                                    crate::protocol_serde::shape_availability_zone_list::de_availability_zone_list(tokens, _value, depth + 1)?,
                                );
                            }
                            "AvailabilityZoneIds" => {
                                builder = builder.set_availability_zone_ids(
                                    crate::protocol_serde::shape_availability_zone_id_list::de_availability_zone_id_list(tokens, _value, depth + 1)?,
                                );
                            }
