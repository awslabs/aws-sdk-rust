...
pub fn ser_archive_rule(
    ...
    if let Some(var_1) = &input.retain_rule {
        ...
        crate::protocol_serde::shape_archive_retain_rule::ser_archive_retain_rule(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
...
) -> Result<Option<crate::types::ArchiveRule>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
