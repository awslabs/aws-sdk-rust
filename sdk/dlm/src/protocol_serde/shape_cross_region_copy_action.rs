...
pub fn ser_cross_region_copy_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::CrossRegionCopyAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
