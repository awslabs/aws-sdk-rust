...
pub fn ser_cross_region_copy_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CrossRegionCopyAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_cross_region_copy_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CrossRegionCopyAction>, aws_smithy_json::deserialize::error::DeserializeError>
