...
pub fn ser_policy_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PolicyDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_policy_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PolicyDetails>, aws_smithy_json::deserialize::error::DeserializeError>
