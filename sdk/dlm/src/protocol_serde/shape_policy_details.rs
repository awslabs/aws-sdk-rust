...
pub fn ser_policy_details(
    ...
    if let Some(var_26) = &input.create_interval {
        object.key("CreateInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.retain_interval {
        object.key("RetainInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "PolicyLanguage" => {
                                builder = builder.set_policy_language(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::PolicyLanguageValues::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "ResourceType" => {
                                builder = builder.set_resource_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ResourceTypeValues::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "ExtendDeletion" => {
                                builder = builder.set_extend_deletion(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "Exclusions" => {
                                builder = builder.set_exclusions(
                                    crate::protocol_serde::shape_exclusions::de_exclusions(tokens)?
                                );
                            }
