...
pub struct InvalidRequestException  {
    ...
    #[doc(hidden)]pub required_parameters: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The request included parameters that cannot be provided together.</p>
    #[doc(hidden)]pub mutually_exclusive_parameters: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for InvalidRequestException  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("mutually_exclusive_parameters", &self.mutually_exclusive_parameters);
        formatter.finish()
    }
}
impl InvalidRequestException {
