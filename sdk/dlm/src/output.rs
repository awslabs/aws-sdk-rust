...
pub struct GetLifecyclePolicyOutput  {
    ...
    #[doc(hidden)]pub policy: std::option::Option<crate::model::LifecyclePolicy>,
}
...
pub struct GetLifecyclePoliciesOutput  {
    ...
    #[doc(hidden)]pub policies: std::option::Option<std::vec::Vec<crate::model::LifecyclePolicySummary>>,
}
