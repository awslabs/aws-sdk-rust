...
impl super::Client {
    ...
    ///   - [`policy_id(impl Into<String>)`](crate::operation::get_lifecycle_policy::builders::GetLifecyclePolicyFluentBuilder::policy_id) / [`set_policy_id(Option<String>)`](crate::operation::get_lifecycle_policy::builders::GetLifecyclePolicyFluentBuilder::set_policy_id):<br>required: **true**<br><p>The identifier of the lifecycle policy.</p><br>
