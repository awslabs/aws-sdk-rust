    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/rules/{ruleName}/disable", ruleName = rule_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_topic_rule::DisableTopicRule::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_topic_rule::DisableTopicRuleError
{
