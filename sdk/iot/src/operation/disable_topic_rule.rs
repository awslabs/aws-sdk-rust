...
impl DisableTopicRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disable_topic_rule::DisableTopicRule,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableTopicRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_topic_rule::de_disable_topic_rule_http_response_with_props(status, headers, body)
        }
    }
}
