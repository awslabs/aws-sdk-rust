...
impl SetV2LoggingOptionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_v2_logging_options::SetV2LoggingOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_v2_logging_options::SetV2LoggingOptionsOutput, crate::operation::set_v2_logging_options::SetV2LoggingOptionsError, Self> {
