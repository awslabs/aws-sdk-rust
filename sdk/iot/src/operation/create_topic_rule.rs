    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder =
                    crate::protocol_serde::shape_create_topic_rule::ser_create_topic_rule_headers(
                        input, builder,
                    )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_topic_rule::CreateTopicRule::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_topic_rule::CreateTopicRuleError
{
