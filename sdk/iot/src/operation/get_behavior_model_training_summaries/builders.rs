...
impl GetBehaviorModelTrainingSummariesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesError, ::aws_smithy_http::operation::Response>>
...
impl GetBehaviorModelTrainingSummariesFluentBuilder {
    ...
    #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            ...
                            ::aws_smithy_http::result::SdkError<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesError>
    >{
    ...
    // This function will go away in the near future. Do not rely on it.
    #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesError>>
                         {
        let op = self
            .inner
            .build()
    ...
    /// set when configuring the client.
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummariesError>>
                             {
