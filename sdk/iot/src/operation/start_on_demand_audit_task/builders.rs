...
impl StartOnDemandAuditTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskOutput, crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskError, Self> {
