...
impl RejectCertificateTransferInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::reject_certificate_transfer::RejectCertificateTransfer,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::reject_certificate_transfer::RejectCertificateTransfer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectCertificateTransfer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_reject_certificate_transfer::de_reject_certificate_transfer_http_response_with_props(status, headers, body)
        }
    }
}
