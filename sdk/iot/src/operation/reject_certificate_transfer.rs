    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_certificate_transfer::RejectCertificateTransferError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_certificate_transfer::RejectCertificateTransferOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RejectCertificateTransferResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RejectCertificateTransferRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::reject_certificate_transfer::RejectCertificateTransferInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RejectCertificateTransferEndpointParamsInterceptor {
...
pub type RejectCertificateTransferErrorKind = RejectCertificateTransferError;
...
impl ::aws_http::request_id::RequestId for crate::operation::reject_certificate_transfer::RejectCertificateTransferError {
...
impl RejectCertificateTransferError {
    ...
    /// Creates the `RejectCertificateTransferError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
