...
impl GetPercentilesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_percentiles::GetPercentiles, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_percentiles::ser_get_percentiles_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPercentiles {
    type Output =
        ::std::result::Result<crate::operation::get_percentiles::GetPercentilesOutput, crate::operation::get_percentiles::GetPercentilesError>;
