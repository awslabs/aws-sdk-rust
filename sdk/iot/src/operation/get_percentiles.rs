...
impl GetPercentilesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_percentiles::GetPercentiles, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_percentiles::GetPercentilesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_percentiles::GetPercentiles::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPercentiles", "iot"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPercentiles {
                type Output = std::result::Result<crate::operation::get_percentiles::GetPercentilesOutput, crate::operation::get_percentiles::GetPercentilesError>;
