...
impl AttachPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::attach_policy::AttachPolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_attach_policy::ser_attach_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_attach_policy::de_attach_policy_http_response_with_props(status, headers, body)
        }
    }
}
