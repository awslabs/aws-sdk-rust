...
impl AttachPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::attach_policy::AttachPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::attach_policy::AttachPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_attach_policy::de_attach_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_attach_policy::de_attach_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
