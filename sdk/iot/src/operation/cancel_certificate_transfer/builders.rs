...
impl CancelCertificateTransferFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_certificate_transfer::CancelCertificateTransferOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_certificate_transfer::CancelCertificateTransferError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_certificate_transfer::CancelCertificateTransferOutput, crate::operation::cancel_certificate_transfer::CancelCertificateTransferError, Self> {
