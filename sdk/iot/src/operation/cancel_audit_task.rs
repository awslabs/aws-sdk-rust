    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/audit/tasks/{taskId}/cancel", taskId = task_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_audit_task::CancelAuditTask::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_audit_task::CancelAuditTaskError
{
