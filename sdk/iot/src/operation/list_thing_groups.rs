...
impl ListThingGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_thing_groups::ListThingGroups, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThingGroups {
    type Output =
        ::std::result::Result<crate::operation::list_thing_groups::ListThingGroupsOutput, crate::operation::list_thing_groups::ListThingGroupsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_thing_groups::de_list_thing_groups_http_response_with_props(status, headers, body)
        }
    }
}
