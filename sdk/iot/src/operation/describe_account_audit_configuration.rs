...
impl DescribeAccountAuditConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_account_audit_configuration::DescribeAccountAuditConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_account_audit_configuration::DescribeAccountAuditConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountAuditConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_account_audit_configuration::de_describe_account_audit_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
