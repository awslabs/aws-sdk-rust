...
impl DeleteTopicRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_topic_rule::DeleteTopicRule, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTopicRule {
    type Output =
        ::std::result::Result<crate::operation::delete_topic_rule::DeleteTopicRuleOutput, crate::operation::delete_topic_rule::DeleteTopicRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_topic_rule::de_delete_topic_rule_http_response_with_props(status, headers, body)
        }
    }
}
