...
#[derive(Debug)]
    ...
    ::std::write!(output, "/policies/{policyName}/version/{policyVersionId}", policyName = policy_name, policyVersionId = policy_version_id).expect("formatting should succeed");
