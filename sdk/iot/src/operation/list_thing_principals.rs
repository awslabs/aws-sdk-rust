...
impl ListThingPrincipalsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_thing_principals::ListThingPrincipals,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThingPrincipals {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_thing_principals::de_list_thing_principals_http_response_with_props(status, headers, body)
        }
    }
}
