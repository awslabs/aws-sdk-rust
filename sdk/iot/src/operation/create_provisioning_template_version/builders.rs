...
impl CreateProvisioningTemplateVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_provisioning_template_version::CreateProvisioningTemplateVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_provisioning_template_version::CreateProvisioningTemplateVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_provisioning_template_version::CreateProvisioningTemplateVersionOutput, crate::operation::create_provisioning_template_version::CreateProvisioningTemplateVersionError, Self> {
