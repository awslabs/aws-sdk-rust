    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/attached-policies/{target}", target = target)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_attached_policies::ListAttachedPolicies::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_attached_policies::ListAttachedPoliciesError
{
