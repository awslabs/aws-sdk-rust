...
impl UpdateScheduledAuditInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_scheduled_audit::ser_update_scheduled_audit_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_scheduled_audit::UpdateScheduledAudit::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_scheduled_audit::UpdateScheduledAuditError
{
