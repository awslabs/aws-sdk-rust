...
impl DescribeProvisioningTemplateVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_provisioning_template_version::DescribeProvisioningTemplateVersion,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_provisioning_template_version::DescribeProvisioningTemplateVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProvisioningTemplateVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_provisioning_template_version::de_describe_provisioning_template_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
