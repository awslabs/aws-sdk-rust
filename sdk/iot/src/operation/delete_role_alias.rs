...
impl DeleteRoleAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_role_alias::DeleteRoleAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRoleAlias {
    type Output =
        ::std::result::Result<crate::operation::delete_role_alias::DeleteRoleAliasOutput, crate::operation::delete_role_alias::DeleteRoleAliasError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_role_alias::de_delete_role_alias_http_response_with_props(status, headers, body)
        }
    }
}
