...
impl DeleteRoleAliasInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::delete_role_alias::DeleteRoleAlias,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_role_alias::DeleteRoleAlias::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteRoleAlias {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_role_alias::de_delete_role_alias_http_error(
                status, headers, body,
            )
        } else {
