...
impl ListProvisioningTemplatesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_provisioning_templates::ListProvisioningTemplates::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProvisioningTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_provisioning_templates::de_list_provisioning_templates_http_response_with_props(status, headers, body)
        }
    }
}
