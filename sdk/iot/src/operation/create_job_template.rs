...
impl CreateJobTemplateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_job_template::ser_create_job_template_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateJobTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_job_template::de_create_job_template_http_response_with_props(status, headers, body)
        }
    }
}
