    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_audit_suppression::UpdateAuditSuppressionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_audit_suppression::UpdateAuditSuppressionOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateAuditSuppressionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateAuditSuppressionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_audit_suppression::UpdateAuditSuppressionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_audit_suppression::ser_update_audit_suppression_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateAuditSuppressionEndpointParamsInterceptor {
...
pub type UpdateAuditSuppressionErrorKind = UpdateAuditSuppressionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_audit_suppression::UpdateAuditSuppressionError {
...
impl UpdateAuditSuppressionError {
    ...
    /// Creates the `UpdateAuditSuppressionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
