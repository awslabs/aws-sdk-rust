...
impl DeleteFleetMetricInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_fleet_metric::DeleteFleetMetric::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFleetMetric {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_fleet_metric::de_delete_fleet_metric_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_fleet_metric::DeleteFleetMetricError
{
