...
impl AddThingToThingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_thing_to_thing_group::AddThingToThingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_thing_to_thing_group::AddThingToThingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_thing_to_thing_group::AddThingToThingGroupOutput, crate::operation::add_thing_to_thing_group::AddThingToThingGroupError, Self> {
