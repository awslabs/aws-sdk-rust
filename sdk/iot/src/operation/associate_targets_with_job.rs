    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/jobs/{jobId}/targets", jobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_targets_with_job::AssociateTargetsWithJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_targets_with_job::AssociateTargetsWithJobError
{
