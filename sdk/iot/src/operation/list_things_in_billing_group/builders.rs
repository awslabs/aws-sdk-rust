...
pub use crate::operation::list_things_in_billing_group::_list_things_in_billing_group_output::ListThingsInBillingGroupOutputBuilder;

pub use crate::operation::list_things_in_billing_group::_list_things_in_billing_group_input::ListThingsInBillingGroupInputBuilder;
...
impl ListThingsInBillingGroupInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_things_in_billing_group();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_things_in_billing_group::ListThingsInBillingGroupOutput,
                    crate::operation::list_things_in_billing_group::ListThingsInBillingGroupError,
                > for ListThingsInBillingGroupFluentBuilder
            {
                fn send(
                    self,
...
impl ListThingsInBillingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_things_in_billing_group::ListThingsInBillingGroup::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_things_in_billing_group::ListThingsInBillingGroup::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupOutput, crate::operation::list_things_in_billing_group::ListThingsInBillingGroupError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_things_in_billing_group::paginator::ListThingsInBillingGroupPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
