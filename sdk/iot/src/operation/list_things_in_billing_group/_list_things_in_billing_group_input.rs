...
impl ListThingsInBillingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupInput, ::aws_smithy_types::error::operation::BuildError> {
