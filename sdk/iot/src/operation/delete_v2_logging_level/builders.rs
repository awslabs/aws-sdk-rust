...
impl DeleteV2LoggingLevelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelOutput, crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError, Self> {
