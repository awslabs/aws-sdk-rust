...
impl DescribeAuditTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_audit_task::DescribeAuditTask,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuditTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_audit_task::de_describe_audit_task_http_response_with_props(status, headers, body)
        }
    }
}
