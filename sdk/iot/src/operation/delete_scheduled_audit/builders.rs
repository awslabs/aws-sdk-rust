...
impl DeleteScheduledAuditFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_scheduled_audit::DeleteScheduledAuditOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_scheduled_audit::DeleteScheduledAuditError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_scheduled_audit::DeleteScheduledAuditOutput, crate::operation::delete_scheduled_audit::DeleteScheduledAuditError, Self> {
