...
impl DescribeAuthorizerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_authorizer::DescribeAuthorizer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuthorizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_authorizer::de_describe_authorizer_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_authorizer::DescribeAuthorizerError
{
