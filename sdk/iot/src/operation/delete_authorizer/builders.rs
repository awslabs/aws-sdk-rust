...
pub use crate::operation::delete_authorizer::_delete_authorizer_output::DeleteAuthorizerOutputBuilder;
...
pub struct DeleteAuthorizerFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_authorizer::builders::DeleteAuthorizerInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_authorizer::DeleteAuthorizerOutput,
                    crate::operation::delete_authorizer::DeleteAuthorizerError,
                > for DeleteAuthorizerFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteAuthorizerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_authorizer::DeleteAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_authorizer::DeleteAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_authorizer::DeleteAuthorizer::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_authorizer::DeleteAuthorizer::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_authorizer::DeleteAuthorizerOutput, crate::operation::delete_authorizer::DeleteAuthorizerError, Self> {
