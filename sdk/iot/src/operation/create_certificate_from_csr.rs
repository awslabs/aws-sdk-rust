...
impl CreateCertificateFromCsr {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateCertificateFromCsr {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateCertificateFromCsr");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateCertificateFromCsrRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateCertificateFromCsrResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateCertificateFromCsr")
...
.with_interceptor(CreateCertificateFromCsrEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError>::new());
...
#[derive(Debug)]
            struct CreateCertificateFromCsrResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateCertificateFromCsrResponseDeserializer {
...
#[derive(Debug)]
            struct CreateCertificateFromCsrRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateCertificateFromCsrRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_certificate_from_csr::CreateCertificateFromCsrInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_certificate_from_csr::CreateCertificateFromCsrInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/certificates").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::create_certificate_from_csr::CreateCertificateFromCsrInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_certificate_from_csr::ser_create_certificate_from_csr_input(&input)?);
...
#[derive(Debug)]
            struct CreateCertificateFromCsrEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateCertificateFromCsrEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateCertificateFromCsrEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateCertificateFromCsrInput>()
                        .ok_or("failed to downcast to CreateCertificateFromCsrInput")?;
...
pub enum CreateCertificateFromCsrError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateCertificateFromCsrError) for what information is available for the error.")]
...
impl CreateCertificateFromCsrError {
    /// Creates the `CreateCertificateFromCsrError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCertificateFromCsrError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateCertificateFromCsrError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_certificate_from_csr::CreateCertificateFromCsrError {
