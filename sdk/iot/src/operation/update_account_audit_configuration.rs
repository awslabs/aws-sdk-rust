...
impl UpdateAccountAuditConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_account_audit_configuration::UpdateAccountAuditConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccountAuditConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_account_audit_configuration::de_update_account_audit_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
