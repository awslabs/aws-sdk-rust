...
impl CancelJobExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_job_execution::ser_cancel_job_execution_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_job_execution::CancelJobExecution::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_job_execution::CancelJobExecutionError
{
