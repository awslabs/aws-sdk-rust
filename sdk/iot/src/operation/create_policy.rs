    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/policies/{policyName}", policyName = policy_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_policy::CreatePolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_policy::de_create_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_policy::de_create_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
