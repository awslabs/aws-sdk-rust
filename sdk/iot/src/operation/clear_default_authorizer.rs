...
/// Orchestration and serialization glue logic for `ClearDefaultAuthorizer`.
...
impl ClearDefaultAuthorizer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::clear_default_authorizer::ClearDefaultAuthorizerInput,
                    ) -> ::std::result::Result<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ClearDefaultAuthorizer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ClearDefaultAuthorizer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ClearDefaultAuthorizerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ClearDefaultAuthorizerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ClearDefaultAuthorizer")
...
.with_interceptor(ClearDefaultAuthorizerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError>::new());
...
#[derive(Debug)]
            struct ClearDefaultAuthorizerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ClearDefaultAuthorizerResponseDeserializer {
...
#[derive(Debug)]
            struct ClearDefaultAuthorizerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ClearDefaultAuthorizerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::clear_default_authorizer::ClearDefaultAuthorizerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::clear_default_authorizer::ClearDefaultAuthorizerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/default-authorizer").expect("formatting should succeed");
...
#[derive(Debug)]
            struct ClearDefaultAuthorizerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ClearDefaultAuthorizerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ClearDefaultAuthorizerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ClearDefaultAuthorizerInput>()
                        .ok_or("failed to downcast to ClearDefaultAuthorizerInput")?;
...
/// Error type for the `ClearDefaultAuthorizerError` operation.
#[non_exhaustive]
...
pub enum ClearDefaultAuthorizerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ClearDefaultAuthorizerError) for what information is available for the error.")]
...
impl ClearDefaultAuthorizerError {
    /// Creates the `ClearDefaultAuthorizerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ClearDefaultAuthorizerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ClearDefaultAuthorizerError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ClearDefaultAuthorizerError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ClearDefaultAuthorizerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::clear_default_authorizer::ClearDefaultAuthorizerError {
...
mod _clear_default_authorizer_output;
