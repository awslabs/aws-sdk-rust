...
impl ClearDefaultAuthorizerInput {
    /// Consumes the builder and constructs an Operation<[`ClearDefaultAuthorizer`](crate::operation::clear_default_authorizer::ClearDefaultAuthorizer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::clear_default_authorizer::ClearDefaultAuthorizer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::clear_default_authorizer::ClearDefaultAuthorizerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::clear_default_authorizer::ClearDefaultAuthorizer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ClearDefaultAuthorizer", "iot"));
