...
impl SetV2LoggingOptionsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_v2_logging_options::ser_set_v2_logging_options_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_v2_logging_options::SetV2LoggingOptions::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::set_v2_logging_options::SetV2LoggingOptionsError
{
