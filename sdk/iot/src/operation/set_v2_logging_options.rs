    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetV2LoggingOptions")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(SetV2LoggingOptionsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SetV2LoggingOptionsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SetV2LoggingOptionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_v2_logging_options::ser_set_v2_logging_options_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetV2LoggingOptionsEndpointParamsInterceptor {
...
pub type SetV2LoggingOptionsErrorKind = SetV2LoggingOptionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::set_v2_logging_options::SetV2LoggingOptionsError {
...
impl SetV2LoggingOptionsError {
    ...
    /// Creates the `SetV2LoggingOptionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
