...
impl SetV2LoggingOptions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_v2_logging_options::SetV2LoggingOptionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetV2LoggingOptions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetV2LoggingOptions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetV2LoggingOptionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetV2LoggingOptionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetV2LoggingOptions")
...
.with_interceptor(SetV2LoggingOptionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsError>::new());
...
#[derive(Debug)]
            struct SetV2LoggingOptionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetV2LoggingOptionsResponseDeserializer {
...
#[derive(Debug)]
            struct SetV2LoggingOptionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetV2LoggingOptionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_v2_logging_options::SetV2LoggingOptionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_v2_logging_options::SetV2LoggingOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v2LoggingOptions").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_v2_logging_options::ser_set_v2_logging_options_input(&input)?);
...
#[derive(Debug)]
            struct SetV2LoggingOptionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetV2LoggingOptionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetV2LoggingOptionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetV2LoggingOptionsInput>()
                        .ok_or("failed to downcast to SetV2LoggingOptionsInput")?;
...
/// Error type for the `SetV2LoggingOptionsError` operation.
#[non_exhaustive]
...
pub enum SetV2LoggingOptionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetV2LoggingOptionsError) for what information is available for the error.")]
...
impl SetV2LoggingOptionsError {
    /// Creates the `SetV2LoggingOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetV2LoggingOptionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `SetV2LoggingOptionsError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingOptionsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingOptionsError::ServiceUnavailableException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SetV2LoggingOptionsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetV2LoggingOptionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_v2_logging_options::SetV2LoggingOptionsError {
...
mod _set_v2_logging_options_output;
