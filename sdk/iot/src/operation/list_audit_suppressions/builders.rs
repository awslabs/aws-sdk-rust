...
impl ListAuditSuppressionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_audit_suppressions::ListAuditSuppressionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_audit_suppressions::ListAuditSuppressionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_audit_suppressions::ListAuditSuppressionsOutput, crate::operation::list_audit_suppressions::ListAuditSuppressionsError, Self> {
