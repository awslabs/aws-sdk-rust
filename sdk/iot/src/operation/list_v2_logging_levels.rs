    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListV2LoggingLevels")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListV2LoggingLevelsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListV2LoggingLevelsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListV2LoggingLevelsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListV2LoggingLevelsEndpointParamsInterceptor {
...
pub type ListV2LoggingLevelsErrorKind = ListV2LoggingLevelsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError {
...
impl ListV2LoggingLevelsError {
    ...
    /// Creates the `ListV2LoggingLevelsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
