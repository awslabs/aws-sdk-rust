...
/// Orchestration and serialization glue logic for `ListV2LoggingLevels`.
...
impl ListV2LoggingLevels {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_v2_logging_levels::ListV2LoggingLevelsInput,
                    ) -> ::std::result::Result<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListV2LoggingLevels {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListV2LoggingLevels");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListV2LoggingLevelsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListV2LoggingLevelsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListV2LoggingLevels")
...
.with_interceptor(ListV2LoggingLevelsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError>::new());
...
#[derive(Debug)]
            struct ListV2LoggingLevelsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListV2LoggingLevelsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_v2_logging_levels::de_list_v2_logging_levels_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListV2LoggingLevelsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListV2LoggingLevelsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_v2_logging_levels::ListV2LoggingLevelsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_v2_logging_levels::ListV2LoggingLevelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v2LoggingLevel").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_v2_logging_levels::ListV2LoggingLevelsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.target_type {
         {
...
#[derive(Debug)]
            struct ListV2LoggingLevelsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListV2LoggingLevelsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListV2LoggingLevelsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListV2LoggingLevelsInput>()
                        .ok_or("failed to downcast to ListV2LoggingLevelsInput")?;
...
/// Error type for the `ListV2LoggingLevelsError` operation.
#[non_exhaustive]
...
pub enum ListV2LoggingLevelsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListV2LoggingLevelsError) for what information is available for the error.")]
...
impl ListV2LoggingLevelsError {
    /// Creates the `ListV2LoggingLevelsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListV2LoggingLevelsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListV2LoggingLevelsError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `ListV2LoggingLevelsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListV2LoggingLevelsError::NotConfiguredException`.
    pub fn is_not_configured_exception(&self) -> bool {
        matches!(self, Self::NotConfiguredException(_))
    }
    /// Returns `true` if the error kind is `ListV2LoggingLevelsError::ServiceUnavailableException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListV2LoggingLevelsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListV2LoggingLevelsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_v2_logging_levels::ListV2LoggingLevelsError {
...
mod _list_v2_logging_levels_output;
