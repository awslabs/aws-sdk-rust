...
impl StartThingRegistrationTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_thing_registration_task::StartThingRegistrationTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_thing_registration_task::StartThingRegistrationTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_thing_registration_task::StartThingRegistrationTaskOutput, crate::operation::start_thing_registration_task::StartThingRegistrationTaskError, Self> {
