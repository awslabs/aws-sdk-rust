...
impl crate::operation::start_thing_registration_task::builders::StartThingRegistrationTaskInputBuilder {
...
impl StartThingRegistrationTaskFluentBuilder {
    /// Creates a new `StartThingRegistrationTaskFluentBuilder`.
