...
impl UpdateDomainConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_configuration::UpdateDomainConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_configuration::de_update_domain_configuration_http_response_with_props(status, headers, body)
        }
    }
}
