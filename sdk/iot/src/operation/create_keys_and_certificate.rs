...
impl CreateKeysAndCertificateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_keys_and_certificate::CreateKeysAndCertificate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKeysAndCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_keys_and_certificate::de_create_keys_and_certificate_http_response_with_props(status, headers, body)
        }
    }
