...
impl ListOutgoingCertificatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput, ::aws_smithy_types::error::operation::BuildError> {
