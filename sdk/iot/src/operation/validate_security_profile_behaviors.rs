...
impl ValidateSecurityProfileBehaviorsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::validate_security_profile_behaviors::ValidateSecurityProfileBehaviors::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateSecurityProfileBehaviors {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_security_profile_behaviors::de_validate_security_profile_behaviors_http_response_with_props(
                status, headers, body,
            )
        }
    }
