...
impl ValidateSecurityProfileBehaviors {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::validate_security_profile_behaviors::ValidateSecurityProfileBehaviorsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ValidateSecurityProfileBehaviorsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ValidateSecurityProfileBehaviorsRequestSerializer {
