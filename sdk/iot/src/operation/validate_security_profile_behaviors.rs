    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/security-profile-behaviors/validate")
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ValidateSecurityProfileBehaviorsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::validate_security_profile_behaviors::ValidateSecurityProfileBehaviorsError
{
