...
impl DescribeThingInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_thing::DescribeThing::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeThing {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_thing::de_describe_thing_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_thing::de_describe_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
