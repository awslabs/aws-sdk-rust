...
impl UpdatePackageInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePackage`](crate::operation::update_package::UpdatePackage)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_package::UpdatePackage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_package::ser_update_package_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_package::UpdatePackage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePackage", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePackage {
    type Output = ::std::result::Result<crate::operation::update_package::UpdatePackageOutput, crate::operation::update_package::UpdatePackageError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_package::de_update_package_http_response_with_props(status, headers, body)
        }
    }
}
