...
impl ReplaceTopicRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::replace_topic_rule::ReplaceTopicRule,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceTopicRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replace_topic_rule::de_replace_topic_rule_http_response_with_props(status, headers, body)
        }
    }
}
