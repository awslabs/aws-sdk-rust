...
impl ReplaceTopicRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::replace_topic_rule::ReplaceTopicRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceTopicRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_replace_topic_rule::de_replace_topic_rule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::replace_topic_rule::ReplaceTopicRuleError
{
