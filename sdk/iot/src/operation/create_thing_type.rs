...
impl CreateThingTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_thing_type::CreateThingType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_thing_type::ser_create_thing_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateThingType {
    type Output =
        ::std::result::Result<crate::operation::create_thing_type::CreateThingTypeOutput, crate::operation::create_thing_type::CreateThingTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_thing_type::de_create_thing_type_http_response_with_props(status, headers, body)
        }
    }
}
