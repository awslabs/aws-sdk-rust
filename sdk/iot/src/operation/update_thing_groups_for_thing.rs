    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThingError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThingOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateThingGroupsForThing {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateThingGroupsForThing", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateThingGroupsForThing")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateThingGroupsForThingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateThingGroupsForThingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThingInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateThingGroupsForThingEndpointParamsInterceptor {
...
pub type UpdateThingGroupsForThingErrorKind = UpdateThingGroupsForThingError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThingError {
...
impl UpdateThingGroupsForThingError {
    ...
    /// Creates the `UpdateThingGroupsForThingError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
