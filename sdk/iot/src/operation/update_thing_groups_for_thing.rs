...
impl UpdateThingGroupsForThingInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThing::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateThingGroupsForThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_thing_groups_for_thing::de_update_thing_groups_for_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
