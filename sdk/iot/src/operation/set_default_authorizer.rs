...
impl SetDefaultAuthorizer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_default_authorizer::SetDefaultAuthorizerInput,
                    ) -> ::std::result::Result<crate::operation::set_default_authorizer::SetDefaultAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_authorizer::SetDefaultAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_default_authorizer::SetDefaultAuthorizerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_default_authorizer::SetDefaultAuthorizerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetDefaultAuthorizer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetDefaultAuthorizer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetDefaultAuthorizerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetDefaultAuthorizerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetDefaultAuthorizer")
...
.with_interceptor(SetDefaultAuthorizerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_default_authorizer::SetDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_default_authorizer::SetDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_default_authorizer::SetDefaultAuthorizerError>::new());
...
#[derive(Debug)]
            struct SetDefaultAuthorizerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetDefaultAuthorizerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_default_authorizer::de_set_default_authorizer_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_default_authorizer::de_set_default_authorizer_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetDefaultAuthorizerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetDefaultAuthorizerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_default_authorizer::SetDefaultAuthorizerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_default_authorizer::SetDefaultAuthorizerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_default_authorizer::ser_set_default_authorizer_input(&input)?);
...
#[derive(Debug)]
            struct SetDefaultAuthorizerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetDefaultAuthorizerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetDefaultAuthorizerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetDefaultAuthorizerInput>()
                        .ok_or("failed to downcast to SetDefaultAuthorizerInput")?;
...
/// Error type for the `SetDefaultAuthorizerError` operation.
#[non_exhaustive]
...
pub enum SetDefaultAuthorizerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetDefaultAuthorizerError) for what information is available for the error.")]
...
impl SetDefaultAuthorizerError {
    /// Creates the `SetDefaultAuthorizerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetDefaultAuthorizerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::ResourceAlreadyExistsException`.
    pub fn is_resource_already_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultAuthorizerError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SetDefaultAuthorizerError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetDefaultAuthorizerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_default_authorizer::SetDefaultAuthorizerError {
...
mod _set_default_authorizer_output;
