...
impl GetBehaviorModelTrainingSummariesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_behavior_model_training_summaries::GetBehaviorModelTrainingSummaries::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBehaviorModelTrainingSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_behavior_model_training_summaries::de_get_behavior_model_training_summaries_http_response_with_props(
                status, headers, body,
            )
        }
    }
