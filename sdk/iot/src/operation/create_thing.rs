    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/things/{thingName}", thingName = thing_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_thing::CreateThing::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_thing::de_create_thing_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_thing::de_create_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
