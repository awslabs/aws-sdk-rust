...
impl CreateThingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_thing::CreateThing, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_thing::ser_create_thing_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_thing::de_create_thing_http_response_with_props(status, headers, body)
        }
    }
}
