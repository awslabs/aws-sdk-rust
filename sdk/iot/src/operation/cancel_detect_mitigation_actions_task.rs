...
impl CancelDetectMitigationActionsTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_detect_mitigation_actions_task::CancelDetectMitigationActionsTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelDetectMitigationActionsTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_detect_mitigation_actions_task::de_cancel_detect_mitigation_actions_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
