...
impl ListOTAUpdatesFluentBuilder  {
    /// Creates a new `ListOTAUpdates`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_ota_updates::ListOtaUpdatesOutput, aws_smithy_http::result::SdkError<crate::operation::list_ota_updates::ListOTAUpdatesError>>
                     {
