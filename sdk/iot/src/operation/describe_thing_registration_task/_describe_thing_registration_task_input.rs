...
impl DescribeThingRegistrationTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskInput, ::aws_smithy_types::error::operation::BuildError> {
