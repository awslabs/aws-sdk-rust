...
impl SetV2LoggingLevelFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_v2_logging_level::SetV2LoggingLevelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_v2_logging_level::SetV2LoggingLevelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_v2_logging_level::SetV2LoggingLevelOutput, crate::operation::set_v2_logging_level::SetV2LoggingLevelError, Self> {
