...
impl UpdateIndexingConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_indexing_configuration::UpdateIndexingConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIndexingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_indexing_configuration::de_update_indexing_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
