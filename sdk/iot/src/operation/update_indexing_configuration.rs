    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_indexing_configuration::UpdateIndexingConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_indexing_configuration::UpdateIndexingConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateIndexingConfiguration {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateIndexingConfiguration")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateIndexingConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateIndexingConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_indexing_configuration::UpdateIndexingConfigurationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateIndexingConfigurationEndpointParamsInterceptor {
...
pub type UpdateIndexingConfigurationErrorKind = UpdateIndexingConfigurationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_indexing_configuration::UpdateIndexingConfigurationError {
...
impl UpdateIndexingConfigurationError {
    ...
    /// Creates the `UpdateIndexingConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
