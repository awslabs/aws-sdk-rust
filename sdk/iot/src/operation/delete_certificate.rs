    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                ...
                ::std::write!(output, "/certificates/{certificateId}", certificateId = certificate_id).expect("formatting should succeed");
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.force_delete {
                    if *inner_2 {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteCertificateError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::CertificateStateException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
