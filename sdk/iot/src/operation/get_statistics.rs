...
impl GetStatisticsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_statistics::GetStatistics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_statistics::de_get_statistics_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_statistics::de_get_statistics_http_response_with_props(
                status, headers, body,
            )
        }
    }
