        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_security_profiles_for_target::ListSecurityProfilesForTarget::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl ListSecurityProfilesForTargetPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_security_profiles_for_target_output_output_security_profile_target_mappings(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
