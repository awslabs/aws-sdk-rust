...
impl ListPoliciesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_policies::ListPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_policies::de_list_policies_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_policies::de_list_policies_http_response_with_props(
                status, headers, body,
            )
        }
    }
