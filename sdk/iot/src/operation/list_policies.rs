...
impl ListPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListPolicies`](crate::operation::list_policies::ListPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_policies::ListPolicies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policies::ListPoliciesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/policies").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_policies::ListPoliciesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if _input.ascending_order {
                    query.push_kv("isAscendingOrder", aws_smithy_types::primitive::Encoder::from(_input.ascending_order).encode());
                }
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_policies::ListPolicies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListPolicies", "iot"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListPolicies {
                type Output = std::result::Result<crate::operation::list_policies::ListPoliciesOutput, crate::operation::list_policies::ListPoliciesError>;
