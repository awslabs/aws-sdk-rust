...
impl DescribeAuditMitigationActionsTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTask,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuditMitigationActionsTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_audit_mitigation_actions_task::de_describe_audit_mitigation_actions_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
