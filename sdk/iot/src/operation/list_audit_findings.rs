    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_audit_findings::ListAuditFindingsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_audit_findings::ListAuditFindingsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAuditFindings {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAuditFindings")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListAuditFindingsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListAuditFindingsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListAuditFindingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_audit_findings::ListAuditFindingsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_audit_findings::ser_list_audit_findings_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListAuditFindingsEndpointParamsInterceptor {
...
pub type ListAuditFindingsErrorKind = ListAuditFindingsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_audit_findings::ListAuditFindingsError {
...
impl ListAuditFindingsError {
    ...
    /// Creates the `ListAuditFindingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
