...
impl GetTopicRuleDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_topic_rule_destination::GetTopicRuleDestinationInput, ::aws_smithy_types::error::operation::BuildError> {
