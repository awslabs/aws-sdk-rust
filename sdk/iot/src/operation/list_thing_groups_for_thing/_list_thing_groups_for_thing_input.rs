...
impl ListThingGroupsForThingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_thing_groups_for_thing::ListThingGroupsForThingInput, ::aws_smithy_types::error::operation::BuildError> {
