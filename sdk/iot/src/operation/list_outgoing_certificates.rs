...
/// Orchestration and serialization glue logic for `ListOutgoingCertificates`.
...
impl ListOutgoingCertificates {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput,
                    ) -> ::std::result::Result<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListOutgoingCertificates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListOutgoingCertificates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListOutgoingCertificatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListOutgoingCertificatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListOutgoingCertificates")
...
.with_interceptor(ListOutgoingCertificatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_outgoing_certificates::de_list_outgoing_certificates_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListOutgoingCertificatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/certificates-out-going").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListOutgoingCertificatesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListOutgoingCertificatesInput>()
                        .ok_or("failed to downcast to ListOutgoingCertificatesInput")?;
...
/// Error type for the `ListOutgoingCertificatesError` operation.
#[non_exhaustive]
...
pub enum ListOutgoingCertificatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListOutgoingCertificatesError) for what information is available for the error.")]
...
impl ListOutgoingCertificatesError {
    /// Creates the `ListOutgoingCertificatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListOutgoingCertificatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListOutgoingCertificatesError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListOutgoingCertificatesError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListOutgoingCertificatesError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `ListOutgoingCertificatesError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ListOutgoingCertificatesError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListOutgoingCertificatesError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListOutgoingCertificatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError {
...
mod _list_outgoing_certificates_output;
