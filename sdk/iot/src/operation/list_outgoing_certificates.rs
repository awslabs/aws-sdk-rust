    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListOutgoingCertificates {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListOutgoingCertificates", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListOutgoingCertificates")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListOutgoingCertificatesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListOutgoingCertificatesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_outgoing_certificates::ListOutgoingCertificatesInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
pub type ListOutgoingCertificatesErrorKind = ListOutgoingCertificatesError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_outgoing_certificates::ListOutgoingCertificatesError {
...
impl ListOutgoingCertificatesError {
    ...
    /// Creates the `ListOutgoingCertificatesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
