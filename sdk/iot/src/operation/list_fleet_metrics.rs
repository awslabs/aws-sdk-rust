...
impl ListFleetMetricsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_fleet_metrics::ListFleetMetrics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFleetMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_fleet_metrics::de_list_fleet_metrics_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_fleet_metrics::ListFleetMetricsError
{
