...
impl ListFleetMetricsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_fleet_metrics::ListFleetMetrics,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFleetMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_fleet_metrics::de_list_fleet_metrics_http_response_with_props(status, headers, body)
        }
    }
}
