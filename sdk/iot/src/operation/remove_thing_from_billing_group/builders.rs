...
impl RemoveThingFromBillingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupOutput, crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupError, Self> {
