...
impl crate::operation::remove_thing_from_billing_group::builders::RemoveThingFromBillingGroupInputBuilder {
...
impl RemoveThingFromBillingGroupFluentBuilder {
    /// Creates a new `RemoveThingFromBillingGroupFluentBuilder`.
