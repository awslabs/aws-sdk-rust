...
/// Orchestration and serialization glue logic for `RegisterCertificateWithoutCA`.
...
impl RegisterCertificateWithoutCA {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterCertificateWithoutCA {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterCertificateWithoutCA");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterCertificateWithoutCARequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterCertificateWithoutCAResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterCertificateWithoutCA")
...
.with_interceptor(RegisterCertificateWithoutCAEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError>::new());
...
#[derive(Debug)]
            struct RegisterCertificateWithoutCAResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterCertificateWithoutCAResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_certificate_without_ca::de_register_certificate_without_ca_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_register_certificate_without_ca::de_register_certificate_without_ca_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RegisterCertificateWithoutCARequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterCertificateWithoutCARequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/certificate/register-no-ca").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_certificate_without_ca::ser_register_certificate_without_ca_input(&input)?);
...
#[derive(Debug)]
            struct RegisterCertificateWithoutCAEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterCertificateWithoutCAEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterCertificateWithoutCAEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterCertificateWithoutCaInput>()
                        .ok_or("failed to downcast to RegisterCertificateWithoutCaInput")?;
...
/// Error type for the `RegisterCertificateWithoutCAError` operation.
#[non_exhaustive]
...
pub enum RegisterCertificateWithoutCAError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterCertificateWithoutCAError) for what information is available for the error.")]
...
impl RegisterCertificateWithoutCAError {
    /// Creates the `RegisterCertificateWithoutCAError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterCertificateWithoutCAError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::CertificateStateException`.
    pub fn is_certificate_state_exception(&self) -> bool {
        matches!(self, Self::CertificateStateException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::CertificateValidationException`.
    pub fn is_certificate_validation_exception(&self) -> bool {
        matches!(self, Self::CertificateValidationException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::ResourceAlreadyExistsException`.
    pub fn is_resource_already_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `RegisterCertificateWithoutCAError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterCertificateWithoutCAError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterCertificateWithoutCAError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError {
...
mod _register_certificate_without_ca_output;
