    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterCertificateWithoutCA {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterCertificateWithoutCA")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RegisterCertificateWithoutCAResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RegisterCertificateWithoutCARequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCaInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RegisterCertificateWithoutCAEndpointParamsInterceptor {
...
pub type RegisterCertificateWithoutCAErrorKind = RegisterCertificateWithoutCAError;
...
impl ::aws_http::request_id::RequestId for crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError {
...
impl RegisterCertificateWithoutCAError {
    ...
    /// Creates the `RegisterCertificateWithoutCAError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
