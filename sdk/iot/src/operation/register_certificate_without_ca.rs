    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/certificate/register-no-ca")
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterCertificateWithoutCA {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_certificate_without_ca::de_register_certificate_without_ca_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RegisterCertificateWithoutCAError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_certificate_without_ca::RegisterCertificateWithoutCAError
{
