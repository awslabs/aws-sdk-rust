...
impl ListPrincipalThingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_principal_things::ListPrincipalThingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_principal_things::ListPrincipalThingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_principal_things::ListPrincipalThingsOutput, crate::operation::list_principal_things::ListPrincipalThingsError, Self> {
