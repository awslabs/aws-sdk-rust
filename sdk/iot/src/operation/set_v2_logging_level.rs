    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_level::SetV2LoggingLevelError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_level::SetV2LoggingLevelOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetV2LoggingLevel")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(SetV2LoggingLevelEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SetV2LoggingLevelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SetV2LoggingLevelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_v2_logging_level::SetV2LoggingLevelInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_set_v2_logging_level::ser_set_v2_logging_level_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetV2LoggingLevelEndpointParamsInterceptor {
...
pub type SetV2LoggingLevelErrorKind = SetV2LoggingLevelError;
...
impl ::aws_http::request_id::RequestId for crate::operation::set_v2_logging_level::SetV2LoggingLevelError {
...
impl SetV2LoggingLevelError {
    ...
    /// Creates the `SetV2LoggingLevelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::NotConfiguredException(e) => e.meta(),
