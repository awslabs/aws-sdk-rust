...
impl SetV2LoggingLevelInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_v2_logging_level::ser_set_v2_logging_level_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_v2_logging_level::SetV2LoggingLevel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetV2LoggingLevel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_v2_logging_level::de_set_v2_logging_level_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_v2_logging_level::SetV2LoggingLevelError
{
