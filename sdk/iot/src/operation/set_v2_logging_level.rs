...
impl SetV2LoggingLevel {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_v2_logging_level::SetV2LoggingLevelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_v2_logging_level::SetV2LoggingLevelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_v2_logging_level::SetV2LoggingLevelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_v2_logging_level::SetV2LoggingLevelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetV2LoggingLevel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetV2LoggingLevel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetV2LoggingLevelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetV2LoggingLevelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetV2LoggingLevel")
...
.with_interceptor(SetV2LoggingLevelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_v2_logging_level::SetV2LoggingLevelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_v2_logging_level::SetV2LoggingLevelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_v2_logging_level::SetV2LoggingLevelError>::new());
...
#[derive(Debug)]
            struct SetV2LoggingLevelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetV2LoggingLevelResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_v2_logging_level::de_set_v2_logging_level_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_v2_logging_level::de_set_v2_logging_level_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetV2LoggingLevelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetV2LoggingLevelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_v2_logging_level::SetV2LoggingLevelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_v2_logging_level::SetV2LoggingLevelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v2LoggingLevel").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_v2_logging_level::ser_set_v2_logging_level_input(&input)?);
...
#[derive(Debug)]
            struct SetV2LoggingLevelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetV2LoggingLevelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetV2LoggingLevelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetV2LoggingLevelInput>()
                        .ok_or("failed to downcast to SetV2LoggingLevelInput")?;
...
/// Error type for the `SetV2LoggingLevelError` operation.
#[non_exhaustive]
...
pub enum SetV2LoggingLevelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetV2LoggingLevelError) for what information is available for the error.")]
...
impl SetV2LoggingLevelError {
    /// Creates the `SetV2LoggingLevelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetV2LoggingLevelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NotConfiguredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::ServiceUnavailableException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::Unhandled(e) => &e.meta,
        }
    }
    /// Returns `true` if the error kind is `SetV2LoggingLevelError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingLevelError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingLevelError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingLevelError::NotConfiguredException`.
    pub fn is_not_configured_exception(&self) -> bool {
        matches!(self, Self::NotConfiguredException(_))
    }
    /// Returns `true` if the error kind is `SetV2LoggingLevelError::ServiceUnavailableException`.
...
impl ::std::error::Error for SetV2LoggingLevelError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::NotConfiguredException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SetV2LoggingLevelError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetV2LoggingLevelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_v2_logging_level::SetV2LoggingLevelError {
...
mod _set_v2_logging_level_output;
