    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteProvisioningTemplate {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteProvisioningTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteProvisioningTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteProvisioningTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteProvisioningTemplateEndpointParamsInterceptor {
...
pub type DeleteProvisioningTemplateErrorKind = DeleteProvisioningTemplateError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_provisioning_template::DeleteProvisioningTemplateError {
...
impl DeleteProvisioningTemplateError {
    ...
    /// Creates the `DeleteProvisioningTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
