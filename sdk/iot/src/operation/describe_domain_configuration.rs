...
impl DescribeDomainConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_domain_configuration::DescribeDomainConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDomainConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_domain_configuration::de_describe_domain_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
