    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_configuration::DescribeDomainConfigurationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_configuration::DescribeDomainConfigurationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDomainConfiguration {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDomainConfiguration")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeDomainConfigurationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeDomainConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_domain_configuration::DescribeDomainConfigurationInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1.as_ref().ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field("domain_configuration_name", "cannot be empty or unset")
                })?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeDomainConfigurationEndpointParamsInterceptor {
...
pub type DescribeDomainConfigurationErrorKind = DescribeDomainConfigurationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_domain_configuration::DescribeDomainConfigurationError {
...
impl DescribeDomainConfigurationError {
    ...
    /// Creates the `DescribeDomainConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
