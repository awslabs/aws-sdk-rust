...
impl GetLoggingOptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_logging_options::GetLoggingOptions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoggingOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_logging_options::de_get_logging_options_http_response_with_props(status, headers, body)
        }
    }
}
