...
impl DescribeDefaultAuthorizerInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_default_authorizer::DescribeDefaultAuthorizer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDefaultAuthorizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_default_authorizer::de_describe_default_authorizer_http_response_with_props(status, headers, body)
        }
    }
}
