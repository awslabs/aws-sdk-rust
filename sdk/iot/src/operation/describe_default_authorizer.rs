...
/// Orchestration and serialization glue logic for `DescribeDefaultAuthorizer`.
...
impl DescribeDefaultAuthorizer {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerInput,
                    ) -> ::std::result::Result<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeDefaultAuthorizer {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeDefaultAuthorizer");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeDefaultAuthorizerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeDefaultAuthorizerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeDefaultAuthorizer")
...
.with_interceptor(DescribeDefaultAuthorizerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError>::new());
...
#[derive(Debug)]
            struct DescribeDefaultAuthorizerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeDefaultAuthorizerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_default_authorizer::de_describe_default_authorizer_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeDefaultAuthorizerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeDefaultAuthorizerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeDefaultAuthorizerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeDefaultAuthorizerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeDefaultAuthorizerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeDefaultAuthorizerInput>()
                        .ok_or("failed to downcast to DescribeDefaultAuthorizerInput")?;
...
/// Error type for the `DescribeDefaultAuthorizerError` operation.
#[non_exhaustive]
...
pub enum DescribeDefaultAuthorizerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeDefaultAuthorizerError) for what information is available for the error.")]
...
impl DescribeDefaultAuthorizerError {
    /// Creates the `DescribeDefaultAuthorizerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDefaultAuthorizerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DescribeDefaultAuthorizerError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDefaultAuthorizerError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeDefaultAuthorizerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError {
...
mod _describe_default_authorizer_output;
