...
impl PutVerificationStateOnViolationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_verification_state_on_violation::PutVerificationStateOnViolation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutVerificationStateOnViolation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_verification_state_on_violation::de_put_verification_state_on_violation_http_response_with_props(
                status, headers, body,
            )
        }
    }
