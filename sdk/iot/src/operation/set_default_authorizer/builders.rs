...
impl SetDefaultAuthorizerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_default_authorizer::SetDefaultAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_authorizer::SetDefaultAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_default_authorizer::SetDefaultAuthorizerOutput, crate::operation::set_default_authorizer::SetDefaultAuthorizerError, Self> {
