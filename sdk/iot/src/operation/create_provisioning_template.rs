...
impl CreateProvisioningTemplateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_provisioning_template::CreateProvisioningTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProvisioningTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_provisioning_template::de_create_provisioning_template_http_response_with_props(status, headers, body)
        }
    }
}
