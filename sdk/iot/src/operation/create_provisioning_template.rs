    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_provisioning_template::CreateProvisioningTemplateError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_provisioning_template::CreateProvisioningTemplateOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateProvisioningTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CreateProvisioningTemplate", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateProvisioningTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateProvisioningTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateProvisioningTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_provisioning_template::CreateProvisioningTemplateInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateProvisioningTemplateEndpointParamsInterceptor {
...
pub type CreateProvisioningTemplateErrorKind = CreateProvisioningTemplateError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_provisioning_template::CreateProvisioningTemplateError {
...
impl CreateProvisioningTemplateError {
    ...
    /// Creates the `CreateProvisioningTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
