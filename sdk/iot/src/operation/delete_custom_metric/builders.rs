...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_custom_metric::DeleteCustomMetricOutput,
                    crate::operation::delete_custom_metric::DeleteCustomMetricError,
                > for DeleteCustomMetricFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteCustomMetricFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_custom_metric::DeleteCustomMetricOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_custom_metric::DeleteCustomMetricError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_custom_metric::DeleteCustomMetricOutput, crate::operation::delete_custom_metric::DeleteCustomMetricError, Self> {
