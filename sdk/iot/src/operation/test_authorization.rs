...
impl TestAuthorizationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_test_authorization::ser_test_authorization_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestAuthorization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_test_authorization::de_test_authorization_http_response_with_props(status, headers, body)
        }
    }
}
