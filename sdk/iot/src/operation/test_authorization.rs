    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::test_authorization::TestAuthorizationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::test_authorization::TestAuthorizationOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TestAuthorization {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TestAuthorization")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(TestAuthorizationEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for TestAuthorizationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for TestAuthorizationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::test_authorization::TestAuthorizationInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_test_authorization::ser_test_authorization_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for TestAuthorizationEndpointParamsInterceptor {
...
pub type TestAuthorizationErrorKind = TestAuthorizationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::test_authorization::TestAuthorizationError {
...
impl TestAuthorizationError {
    ...
    /// Creates the `TestAuthorizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
