    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_provisioning_template::UpdateProvisioningTemplateError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_provisioning_template::UpdateProvisioningTemplateOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateProvisioningTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateProvisioningTemplate", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateProvisioningTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateProvisioningTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateProvisioningTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_provisioning_template::UpdateProvisioningTemplateInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateProvisioningTemplateEndpointParamsInterceptor {
...
pub type UpdateProvisioningTemplateErrorKind = UpdateProvisioningTemplateError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_provisioning_template::UpdateProvisioningTemplateError {
...
impl UpdateProvisioningTemplateError {
    ...
    /// Creates the `UpdateProvisioningTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
