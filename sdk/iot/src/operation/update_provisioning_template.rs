...
impl UpdateProvisioningTemplateInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_provisioning_template::UpdateProvisioningTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProvisioningTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_provisioning_template::de_update_provisioning_template_http_response_with_props(status, headers, body)
        }
    }
}
