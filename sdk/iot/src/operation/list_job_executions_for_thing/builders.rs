...
impl ListJobExecutionsForThingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingOutput, crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError, Self> {
