...
impl ListJobExecutionsForThingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput, ::aws_smithy_types::error::operation::BuildError> {
