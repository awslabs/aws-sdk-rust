...
impl ListThingPrincipalsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_thing_principals::paginator::ListThingPrincipalsPaginator {
        crate::operation::list_thing_principals::paginator::ListThingPrincipalsPaginator::new(
            self.handle,
            self.inner,
        )
    }
