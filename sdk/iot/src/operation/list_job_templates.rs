...
impl ListJobTemplatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_job_templates::ListJobTemplates::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListJobTemplates", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListJobTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_job_templates::de_list_job_templates_http_response_with_props(status, headers, body)
        }
    }
}
