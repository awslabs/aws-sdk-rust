...
impl UpdateCustomMetricFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_custom_metric::UpdateCustomMetricOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_custom_metric::UpdateCustomMetricError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_custom_metric::UpdateCustomMetricOutput, crate::operation::update_custom_metric::UpdateCustomMetricError, Self> {
