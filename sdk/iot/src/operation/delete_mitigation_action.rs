...
impl DeleteMitigationActionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_mitigation_action::DeleteMitigationAction,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMitigationAction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_mitigation_action::de_delete_mitigation_action_http_response_with_props(status, headers, body)
        }
    }
}
