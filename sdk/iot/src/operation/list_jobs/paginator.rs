...
impl ListJobsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::JobSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_jobs::ListJobsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_jobs_output_jobs(page).unwrap_or_default().into_iter())
    }
}
