...
impl CreateThingGroupInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_thing_group::ser_create_thing_group_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateThingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_thing_group::de_create_thing_group_http_response_with_props(status, headers, body)
        }
    }
}
