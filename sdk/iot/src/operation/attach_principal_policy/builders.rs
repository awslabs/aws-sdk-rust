...
impl AttachPrincipalPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::attach_principal_policy::AttachPrincipalPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::attach_principal_policy::AttachPrincipalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::attach_principal_policy::AttachPrincipalPolicyOutput, crate::operation::attach_principal_policy::AttachPrincipalPolicyError, Self> {
