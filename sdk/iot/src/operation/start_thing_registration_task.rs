    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_thing_registration_task::StartThingRegistrationTaskError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_thing_registration_task::StartThingRegistrationTaskOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartThingRegistrationTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StartThingRegistrationTask", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartThingRegistrationTask")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartThingRegistrationTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartThingRegistrationTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_thing_registration_task::StartThingRegistrationTaskInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartThingRegistrationTaskEndpointParamsInterceptor {
...
pub type StartThingRegistrationTaskErrorKind = StartThingRegistrationTaskError;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_thing_registration_task::StartThingRegistrationTaskError {
...
impl StartThingRegistrationTaskError {
    ...
    /// Creates the `StartThingRegistrationTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
