...
impl StartThingRegistrationTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_thing_registration_task::StartThingRegistrationTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartThingRegistrationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_thing_registration_task::de_start_thing_registration_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
