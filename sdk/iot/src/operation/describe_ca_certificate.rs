...
impl DescribeCaCertificateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_ca_certificate::DescribeCACertificate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCACertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_ca_certificate::de_describe_ca_certificate_http_response_with_props(status, headers, body)
        }
    }
}
