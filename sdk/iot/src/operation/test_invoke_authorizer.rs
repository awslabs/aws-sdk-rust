...
impl TestInvokeAuthorizerInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_invoke_authorizer::ser_test_invoke_authorizer_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::test_invoke_authorizer::TestInvokeAuthorizer::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::test_invoke_authorizer::TestInvokeAuthorizerError
{
