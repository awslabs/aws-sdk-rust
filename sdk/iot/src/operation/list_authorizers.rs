...
impl ListAuthorizersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_authorizers::ListAuthorizers, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAuthorizers {
    type Output =
        ::std::result::Result<crate::operation::list_authorizers::ListAuthorizersOutput, crate::operation::list_authorizers::ListAuthorizersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_authorizers::de_list_authorizers_http_response_with_props(status, headers, body)
        }
    }
}
