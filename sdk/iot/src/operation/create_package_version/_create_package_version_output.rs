...
impl ::aws_http::request_id::RequestId for CreatePackageVersionOutput {
...
impl ::std::fmt::Debug for CreatePackageVersionOutputBuilder {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        let mut formatter = f.debug_struct("CreatePackageVersionOutputBuilder");
        formatter.field("package_version_arn", &self.package_version_arn);
        formatter.field("package_name", &self.package_name);
        formatter.field("version_name", &self.version_name);
        formatter.field("description", &"*** Sensitive Data Redacted ***");
