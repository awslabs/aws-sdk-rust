...
impl UpdateTopicRuleDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_topic_rule_destination::UpdateTopicRuleDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTopicRuleDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_topic_rule_destination::de_update_topic_rule_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
