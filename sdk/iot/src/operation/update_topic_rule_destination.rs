    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_rule_destination::UpdateTopicRuleDestinationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_rule_destination::UpdateTopicRuleDestinationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateTopicRuleDestination {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateTopicRuleDestination", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateTopicRuleDestination")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for UpdateTopicRuleDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for UpdateTopicRuleDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::update_topic_rule_destination::UpdateTopicRuleDestinationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for UpdateTopicRuleDestinationEndpointParamsInterceptor {
...
pub type UpdateTopicRuleDestinationErrorKind = UpdateTopicRuleDestinationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_topic_rule_destination::UpdateTopicRuleDestinationError {
...
impl UpdateTopicRuleDestinationError {
    ...
    /// Creates the `UpdateTopicRuleDestinationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            Self::ConflictingResourceUpdateException(e) => e.meta(),
