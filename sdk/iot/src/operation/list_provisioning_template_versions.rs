...
impl ListProvisioningTemplateVersionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_provisioning_template_versions::ListProvisioningTemplateVersions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProvisioningTemplateVersions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_provisioning_template_versions::de_list_provisioning_template_versions_http_response_with_props(
                status, headers, body,
            )
        }
    }
