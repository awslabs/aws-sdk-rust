...
impl SearchIndexInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_index::SearchIndex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_index::de_search_index_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_index::de_search_index_http_response_with_props(
                status, headers, body,
            )
        }
    }
