    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteTopicRuleDestination {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteTopicRuleDestination", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteTopicRuleDestination")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteTopicRuleDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteTopicRuleDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteTopicRuleDestinationEndpointParamsInterceptor {
...
pub type DeleteTopicRuleDestinationErrorKind = DeleteTopicRuleDestinationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError {
...
impl DeleteTopicRuleDestinationError {
    ...
    /// Creates the `DeleteTopicRuleDestinationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
