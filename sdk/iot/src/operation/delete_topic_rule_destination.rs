    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/destinations/{arn}", arn = arn)
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTopicRuleDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_topic_rule_destination::de_delete_topic_rule_destination_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError
{
