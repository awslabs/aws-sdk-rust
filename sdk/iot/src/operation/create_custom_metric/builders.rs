...
impl CreateCustomMetricFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_custom_metric::CreateCustomMetricOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_custom_metric::CreateCustomMetricError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_custom_metric::CreateCustomMetricOutput, crate::operation::create_custom_metric::CreateCustomMetricError, Self> {
