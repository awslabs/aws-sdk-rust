...
impl DescribeManagedJobTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_managed_job_template::DescribeManagedJobTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeManagedJobTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_managed_job_template::de_describe_managed_job_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
