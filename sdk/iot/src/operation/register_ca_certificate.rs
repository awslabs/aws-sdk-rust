...
impl RegisterCaCertificateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_ca_certificate::RegisterCACertificate::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::register_ca_certificate::RegisterCACertificateError
{
...
impl std::error::Error for RegisterCACertificateError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::RegistrationCodeValidationException(_inner) => Some(_inner),
