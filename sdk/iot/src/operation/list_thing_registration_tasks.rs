...
impl ListThingRegistrationTasksInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_thing_registration_tasks::ListThingRegistrationTasks::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThingRegistrationTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_thing_registration_tasks::de_list_thing_registration_tasks_http_response_with_props(
                status, headers, body,
            )
        }
    }
