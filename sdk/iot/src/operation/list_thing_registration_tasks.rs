...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThingRegistrationTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_thing_registration_tasks::de_list_thing_registration_tasks_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksError
{
