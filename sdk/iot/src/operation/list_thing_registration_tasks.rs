    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListThingRegistrationTasks {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListThingRegistrationTasks")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListThingRegistrationTasksResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListThingRegistrationTasksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListThingRegistrationTasksEndpointParamsInterceptor {
...
pub type ListThingRegistrationTasksErrorKind = ListThingRegistrationTasksError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksError {
...
impl ListThingRegistrationTasksError {
    ...
    /// Creates the `ListThingRegistrationTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
