...
impl CreateDomainConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_domain_configuration::CreateDomainConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_domain_configuration::CreateDomainConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_domain_configuration::CreateDomainConfigurationOutput, crate::operation::create_domain_configuration::CreateDomainConfigurationError, Self> {
