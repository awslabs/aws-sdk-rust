...
impl CreateTopicRuleDestination {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationInput,
                    ) -> ::std::result::Result<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTopicRuleDestination {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateTopicRuleDestination");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateTopicRuleDestinationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateTopicRuleDestinationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTopicRuleDestination")
...
.with_interceptor(CreateTopicRuleDestinationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError>::new());
...
#[derive(Debug)]
            struct CreateTopicRuleDestinationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateTopicRuleDestinationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_topic_rule_destination::de_create_topic_rule_destination_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateTopicRuleDestinationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateTopicRuleDestinationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_topic_rule_destination::ser_create_topic_rule_destination_input(&input)?);
...
#[derive(Debug)]
            struct CreateTopicRuleDestinationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateTopicRuleDestinationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateTopicRuleDestinationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateTopicRuleDestinationInput>()
                        .ok_or("failed to downcast to CreateTopicRuleDestinationInput")?;
...
/// Error type for the `CreateTopicRuleDestinationError` operation.
#[non_exhaustive]
...
pub enum CreateTopicRuleDestinationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateTopicRuleDestinationError) for what information is available for the error.")]
...
impl CreateTopicRuleDestinationError {
    /// Creates the `CreateTopicRuleDestinationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTopicRuleDestinationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateTopicRuleDestinationError::ConflictingResourceUpdateException`.
    pub fn is_conflicting_resource_update_exception(&self) -> bool {
        matches!(self, Self::ConflictingResourceUpdateException(_))
    }
    /// Returns `true` if the error kind is `CreateTopicRuleDestinationError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `CreateTopicRuleDestinationError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateTopicRuleDestinationError::ResourceAlreadyExistsException`.
    pub fn is_resource_already_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceAlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateTopicRuleDestinationError::ServiceUnavailableException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTopicRuleDestinationError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateTopicRuleDestinationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError {
...
mod _create_topic_rule_destination_output;
