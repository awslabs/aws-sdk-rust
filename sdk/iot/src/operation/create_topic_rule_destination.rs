...
impl CreateTopicRuleDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_topic_rule_destination::CreateTopicRuleDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTopicRuleDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_topic_rule_destination::de_create_topic_rule_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
