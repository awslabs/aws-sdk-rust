    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateTopicRuleDestination {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateTopicRuleDestination")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateTopicRuleDestinationResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateTopicRuleDestinationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateTopicRuleDestinationEndpointParamsInterceptor {
...
pub type CreateTopicRuleDestinationErrorKind = CreateTopicRuleDestinationError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationError {
...
impl CreateTopicRuleDestinationError {
    ...
    /// Creates the `CreateTopicRuleDestinationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
