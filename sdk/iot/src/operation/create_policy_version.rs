...
fn uri_query(_input: &crate::operation::create_policy_version::CreatePolicyVersionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_policy_version::ser_create_policy_version_input(&input)?);
