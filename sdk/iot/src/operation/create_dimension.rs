...
impl CreateDimensionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_dimension::CreateDimension, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_dimension::ser_create_dimension_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDimension {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_dimension::de_create_dimension_http_response_with_props(status, headers, body)
        }
    }
}
