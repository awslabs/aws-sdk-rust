...
impl ListScheduledAuditsFluentBuilder  {
    /// Creates a new `ListScheduledAudits`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_scheduled_audits::ListScheduledAuditsOutput, aws_smithy_http::result::SdkError<crate::operation::list_scheduled_audits::ListScheduledAuditsError>>
                     {
