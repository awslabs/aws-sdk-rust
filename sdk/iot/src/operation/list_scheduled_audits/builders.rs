...
pub use crate::operation::list_scheduled_audits::_list_scheduled_audits_output::ListScheduledAuditsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_scheduled_audits::ListScheduledAuditsOutput,
                    crate::operation::list_scheduled_audits::ListScheduledAuditsError,
                > for ListScheduledAuditsFluentBuilder
            {
                fn send(
                    self,
...
impl ListScheduledAuditsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_scheduled_audits::ListScheduledAuditsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_scheduled_audits::ListScheduledAuditsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_scheduled_audits::ListScheduledAudits::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_scheduled_audits::ListScheduledAuditsOutput, crate::operation::list_scheduled_audits::ListScheduledAuditsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_scheduled_audits::paginator::ListScheduledAuditsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
