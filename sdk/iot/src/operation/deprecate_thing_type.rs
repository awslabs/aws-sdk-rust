...
impl DeprecateThingTypeInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deprecate_thing_type::ser_deprecate_thing_type_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deprecate_thing_type::DeprecateThingType::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::deprecate_thing_type::DeprecateThingTypeError
{
