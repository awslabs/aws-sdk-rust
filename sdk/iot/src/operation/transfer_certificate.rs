...
impl TransferCertificateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_transfer_certificate::ser_transfer_certificate_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::transfer_certificate::TransferCertificate::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::transfer_certificate::TransferCertificateError
{
