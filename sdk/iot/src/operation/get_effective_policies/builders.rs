...
impl GetEffectivePoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_effective_policies::GetEffectivePoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_effective_policies::GetEffectivePoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_effective_policies::GetEffectivePoliciesOutput, crate::operation::get_effective_policies::GetEffectivePoliciesError, Self> {
