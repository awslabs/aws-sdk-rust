...
impl CreateScheduledAuditInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_scheduled_audit::ser_create_scheduled_audit_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_scheduled_audit::CreateScheduledAudit::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_scheduled_audit::CreateScheduledAuditError
{
