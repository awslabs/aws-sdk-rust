...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_billing_group::DeleteBillingGroupOutput,
                    crate::operation::delete_billing_group::DeleteBillingGroupError,
                > for DeleteBillingGroupFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteBillingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_billing_group::DeleteBillingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_billing_group::DeleteBillingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_billing_group::DeleteBillingGroupOutput, crate::operation::delete_billing_group::DeleteBillingGroupError, Self> {
