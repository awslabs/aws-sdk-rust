...
impl ConfirmTopicRuleDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::confirm_topic_rule_destination::ConfirmTopicRuleDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmTopicRuleDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_confirm_topic_rule_destination::de_confirm_topic_rule_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
