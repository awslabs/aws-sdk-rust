...
impl UpdateEventConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_event_configurations::UpdateEventConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
