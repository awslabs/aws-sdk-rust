...
impl StartDetectMitigationActionsTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_detect_mitigation_actions_task::StartDetectMitigationActionsTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDetectMitigationActionsTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_detect_mitigation_actions_task::de_start_detect_mitigation_actions_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
