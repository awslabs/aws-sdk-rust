...
impl ListCaCertificatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_ca_certificates::ListCACertificates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCACertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_ca_certificates::de_list_ca_certificates_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_ca_certificates::ListCACertificatesError
{
