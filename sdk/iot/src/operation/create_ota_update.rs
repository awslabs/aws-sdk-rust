...
impl CreateOtaUpdateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_ota_update::CreateOTAUpdate, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_ota_update::ser_create_ota_update_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOTAUpdate {
    type Output =
        ::std::result::Result<crate::operation::create_ota_update::CreateOtaUpdateOutput, crate::operation::create_ota_update::CreateOTAUpdateError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_ota_update::de_create_ota_update_http_response_with_props(status, headers, body)
        }
    }
}
