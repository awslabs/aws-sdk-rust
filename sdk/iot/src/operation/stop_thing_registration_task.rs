...
impl StopThingRegistrationTaskInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_thing_registration_task::StopThingRegistrationTask::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::stop_thing_registration_task::StopThingRegistrationTaskError
{
