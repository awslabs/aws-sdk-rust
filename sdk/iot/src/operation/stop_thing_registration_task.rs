    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_thing_registration_task::StopThingRegistrationTaskError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_thing_registration_task::StopThingRegistrationTaskOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopThingRegistrationTask {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("StopThingRegistrationTask", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopThingRegistrationTask")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StopThingRegistrationTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StopThingRegistrationTaskRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::stop_thing_registration_task::StopThingRegistrationTaskInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StopThingRegistrationTaskEndpointParamsInterceptor {
...
pub type StopThingRegistrationTaskErrorKind = StopThingRegistrationTaskError;
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_thing_registration_task::StopThingRegistrationTaskError {
...
impl StopThingRegistrationTaskError {
    ...
    /// Creates the `StopThingRegistrationTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
