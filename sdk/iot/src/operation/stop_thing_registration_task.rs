...
impl StopThingRegistrationTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_thing_registration_task::StopThingRegistrationTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopThingRegistrationTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_thing_registration_task::de_stop_thing_registration_task_http_response_with_props(status, headers, body)
        }
    }
}
