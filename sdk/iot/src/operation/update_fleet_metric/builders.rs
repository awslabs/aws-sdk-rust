...
impl UpdateFleetMetricFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_fleet_metric::UpdateFleetMetricOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_fleet_metric::UpdateFleetMetricError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_fleet_metric::UpdateFleetMetricOutput, crate::operation::update_fleet_metric::UpdateFleetMetricError, Self> {
