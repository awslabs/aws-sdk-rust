...
impl CancelAuditMitigationActionsTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_audit_mitigation_actions_task::CancelAuditMitigationActionsTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelAuditMitigationActionsTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_audit_mitigation_actions_task::de_cancel_audit_mitigation_actions_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
