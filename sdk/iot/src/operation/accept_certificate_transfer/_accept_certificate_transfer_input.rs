...
impl AcceptCertificateTransferInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_certificate_transfer::AcceptCertificateTransferInput, ::aws_smithy_types::error::operation::BuildError> {
