...
impl DeleteDomainConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_domain_configuration::DeleteDomainConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDomainConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_domain_configuration::de_delete_domain_configuration_http_response_with_props(status, headers, body)
        }
    }
}
