...
impl UpdateRoleAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_role_alias::UpdateRoleAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_role_alias::ser_update_role_alias_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoleAlias {
    type Output =
        ::std::result::Result<crate::operation::update_role_alias::UpdateRoleAliasOutput, crate::operation::update_role_alias::UpdateRoleAliasError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_role_alias::de_update_role_alias_http_response_with_props(status, headers, body)
        }
    }
}
