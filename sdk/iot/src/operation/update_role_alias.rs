...
impl UpdateRoleAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_role_alias::UpdateRoleAlias,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/role-aliases/{roleAlias}", roleAlias = role_alias)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_role_alias::UpdateRoleAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoleAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_role_alias::de_update_role_alias_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_role_alias::UpdateRoleAliasError
{
