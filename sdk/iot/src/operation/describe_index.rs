...
impl DescribeIndexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_index::DescribeIndex,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/indices/{indexName}", indexName = index_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_index::DescribeIndex::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_index::de_describe_index_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_index::de_describe_index_http_response_with_props(
                status, headers, body,
            )
        }
    }
