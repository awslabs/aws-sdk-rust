...
impl TransferCertificateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::transfer_certificate::TransferCertificateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::transfer_certificate::TransferCertificateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::transfer_certificate::TransferCertificateOutput, crate::operation::transfer_certificate::TransferCertificateError, Self> {
