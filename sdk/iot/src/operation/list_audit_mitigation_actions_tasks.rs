...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAuditMitigationActionsTasks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListAuditMitigationActionsTasks", "iot"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListAuditMitigationActionsTasksResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListAuditMitigationActionsTasksRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListAuditMitigationActionsTasksEndpointParamsInterceptor {
