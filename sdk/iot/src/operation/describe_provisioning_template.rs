...
impl DescribeProvisioningTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_provisioning_template::DescribeProvisioningTemplate,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_provisioning_template::DescribeProvisioningTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProvisioningTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_provisioning_template::de_describe_provisioning_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
