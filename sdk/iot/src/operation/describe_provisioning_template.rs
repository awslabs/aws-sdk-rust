    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_provisioning_template::DescribeProvisioningTemplateError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_provisioning_template::DescribeProvisioningTemplateOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeProvisioningTemplate {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeProvisioningTemplate")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DescribeProvisioningTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DescribeProvisioningTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::describe_provisioning_template::DescribeProvisioningTemplateInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DescribeProvisioningTemplateEndpointParamsInterceptor {
...
pub type DescribeProvisioningTemplateErrorKind = DescribeProvisioningTemplateError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_provisioning_template::DescribeProvisioningTemplateError {
...
impl DescribeProvisioningTemplateError {
    ...
    /// Creates the `DescribeProvisioningTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
