...
impl ListPrincipalPoliciesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_principal_policies::ListPrincipalPolicies,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPrincipalPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_principal_policies::de_list_principal_policies_http_response_with_props(status, headers, body)
        }
    }
}
