...
impl ListTargetsForSecurityProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileInput, ::aws_smithy_types::error::operation::BuildError> {
