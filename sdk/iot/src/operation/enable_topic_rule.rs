...
/// Orchestration and serialization glue logic for `EnableTopicRule`.
...
impl EnableTopicRule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::enable_topic_rule::EnableTopicRuleInput,
                    ) -> ::std::result::Result<crate::operation::enable_topic_rule::EnableTopicRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_topic_rule::EnableTopicRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::enable_topic_rule::EnableTopicRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::enable_topic_rule::EnableTopicRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableTopicRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("EnableTopicRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(EnableTopicRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(EnableTopicRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableTopicRule")
...
.with_interceptor(EnableTopicRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::enable_topic_rule::EnableTopicRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::enable_topic_rule::EnableTopicRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::enable_topic_rule::EnableTopicRuleError>::new());
...
#[derive(Debug)]
            struct EnableTopicRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableTopicRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_enable_topic_rule::de_enable_topic_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_enable_topic_rule::de_enable_topic_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct EnableTopicRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableTopicRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::enable_topic_rule::EnableTopicRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::enable_topic_rule::EnableTopicRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/rules/{ruleName}/enable", ruleName = rule_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct EnableTopicRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableTopicRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "EnableTopicRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<EnableTopicRuleInput>()
                        .ok_or("failed to downcast to EnableTopicRuleInput")?;
...
/// Error type for the `EnableTopicRuleError` operation.
#[non_exhaustive]
...
pub enum EnableTopicRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-EnableTopicRuleError) for what information is available for the error.")]
...
impl EnableTopicRuleError {
    /// Creates the `EnableTopicRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableTopicRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `EnableTopicRuleError::ConflictingResourceUpdateException`.
    pub fn is_conflicting_resource_update_exception(&self) -> bool {
        matches!(self, Self::ConflictingResourceUpdateException(_))
    }
    /// Returns `true` if the error kind is `EnableTopicRuleError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `EnableTopicRuleError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `EnableTopicRuleError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `EnableTopicRuleError::UnauthorizedException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableTopicRuleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for EnableTopicRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::enable_topic_rule::EnableTopicRuleError {
