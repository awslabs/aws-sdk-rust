...
impl EnableTopicRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::enable_topic_rule::EnableTopicRule,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/rules/{ruleName}/enable", ruleName = rule_name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_topic_rule::EnableTopicRule::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::enable_topic_rule::EnableTopicRuleError
{
