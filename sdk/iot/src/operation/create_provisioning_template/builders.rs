...
impl crate::operation::create_provisioning_template::builders::CreateProvisioningTemplateInputBuilder {
...
impl CreateProvisioningTemplateFluentBuilder {
    /// Creates a new `CreateProvisioningTemplateFluentBuilder`.
