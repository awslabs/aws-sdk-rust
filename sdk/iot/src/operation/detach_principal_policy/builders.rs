...
impl DetachPrincipalPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::detach_principal_policy::DetachPrincipalPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::detach_principal_policy::DetachPrincipalPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::detach_principal_policy::DetachPrincipalPolicyOutput, crate::operation::detach_principal_policy::DetachPrincipalPolicyError, Self> {
