...
impl CreateMitigationActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_mitigation_action::CreateMitigationActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_mitigation_action::CreateMitigationActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_mitigation_action::CreateMitigationActionOutput, crate::operation::create_mitigation_action::CreateMitigationActionError, Self> {
