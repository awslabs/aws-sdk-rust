...
impl DeprecateThingTypeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::deprecate_thing_type::DeprecateThingTypeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::deprecate_thing_type::DeprecateThingTypeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::deprecate_thing_type::DeprecateThingTypeOutput, crate::operation::deprecate_thing_type::DeprecateThingTypeError, Self> {
