...
impl UpdateAuditSuppressionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_audit_suppression::UpdateAuditSuppressionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_audit_suppression::UpdateAuditSuppressionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_audit_suppression::UpdateAuditSuppressionOutput, crate::operation::update_audit_suppression::UpdateAuditSuppressionError, Self> {
