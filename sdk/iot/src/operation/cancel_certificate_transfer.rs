...
impl CancelCertificateTransferInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::cancel_certificate_transfer::CancelCertificateTransfer,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_certificate_transfer::CancelCertificateTransfer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelCertificateTransfer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_certificate_transfer::de_cancel_certificate_transfer_http_response_with_props(status, headers, body)
        }
    }
}
