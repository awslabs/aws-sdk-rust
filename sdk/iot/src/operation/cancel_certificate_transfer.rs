    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_certificate_transfer::CancelCertificateTransferError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_certificate_transfer::CancelCertificateTransferOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CancelCertificateTransferResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CancelCertificateTransferRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::cancel_certificate_transfer::CancelCertificateTransferInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelCertificateTransferEndpointParamsInterceptor {
...
pub type CancelCertificateTransferErrorKind = CancelCertificateTransferError;
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_certificate_transfer::CancelCertificateTransferError {
...
impl CancelCertificateTransferError {
    ...
    /// Creates the `CancelCertificateTransferError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::TransferAlreadyCompletedException(e) => e.meta(),
