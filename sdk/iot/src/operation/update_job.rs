...
fn uri_query(_input: &crate::operation::update_job::UpdateJobInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
