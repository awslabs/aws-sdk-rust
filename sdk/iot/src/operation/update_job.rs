...
impl UpdateJob {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("iot", "UpdateJob", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateJob", "iot"));
...
impl UpdateJobError {
    ...
    /// Returns `true` if the error kind is `UpdateJobError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `UpdateJobError::ServiceUnavailableException`.
