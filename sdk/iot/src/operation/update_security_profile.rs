...
impl UpdateSecurityProfileInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_security_profile::UpdateSecurityProfile::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_security_profile::UpdateSecurityProfileError
{
...
impl std::error::Error for UpdateSecurityProfileError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::VersionConflictException(_inner) => Some(_inner),
