...
impl DescribeAuditSuppressionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_audit_suppression::DescribeAuditSuppressionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_audit_suppression::DescribeAuditSuppressionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_audit_suppression::DescribeAuditSuppressionOutput, crate::operation::describe_audit_suppression::DescribeAuditSuppressionError, Self> {
