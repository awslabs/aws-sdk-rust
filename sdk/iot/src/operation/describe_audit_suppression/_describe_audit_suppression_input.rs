...
impl DescribeAuditSuppressionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_audit_suppression::DescribeAuditSuppressionInput, ::aws_smithy_types::error::operation::BuildError> {
