...
impl crate::operation::describe_domain_configuration::builders::DescribeDomainConfigurationInputBuilder {
...
impl DescribeDomainConfigurationFluentBuilder {
    /// Creates a new `DescribeDomainConfigurationFluentBuilder`.
