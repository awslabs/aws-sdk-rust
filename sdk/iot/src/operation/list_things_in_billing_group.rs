...
impl ListThingsInBillingGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_things_in_billing_group::ListThingsInBillingGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThingsInBillingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_things_in_billing_group::de_list_things_in_billing_group_http_response_with_props(status, headers, body)
        }
    }
}
