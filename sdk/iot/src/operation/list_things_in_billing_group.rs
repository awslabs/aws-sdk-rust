    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListThingsInBillingGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListThingsInBillingGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListThingsInBillingGroupEndpointParamsInterceptor {
...
pub type ListThingsInBillingGroupErrorKind = ListThingsInBillingGroupError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_things_in_billing_group::ListThingsInBillingGroupError {
...
impl ListThingsInBillingGroupError {
    ...
    /// Creates the `ListThingsInBillingGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
