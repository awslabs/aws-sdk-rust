...
impl CreateAuditSuppressionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_audit_suppression::CreateAuditSuppressionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_audit_suppression::CreateAuditSuppressionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_audit_suppression::CreateAuditSuppressionOutput, crate::operation::create_audit_suppression::CreateAuditSuppressionError, Self> {
