...
impl ListTopicRuleDestinationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_topic_rule_destinations::ListTopicRuleDestinationsInput, ::aws_smithy_types::error::operation::BuildError> {
