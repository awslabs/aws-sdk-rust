    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_audit_suppression::CreateAuditSuppressionError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_audit_suppression::CreateAuditSuppressionOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateAuditSuppressionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateAuditSuppressionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_audit_suppression::CreateAuditSuppressionInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_audit_suppression::ser_create_audit_suppression_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateAuditSuppressionEndpointParamsInterceptor {
...
pub type CreateAuditSuppressionErrorKind = CreateAuditSuppressionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_audit_suppression::CreateAuditSuppressionError {
...
impl CreateAuditSuppressionError {
    ...
    /// Creates the `CreateAuditSuppressionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
