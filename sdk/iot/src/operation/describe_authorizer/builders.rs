...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_authorizer::DescribeAuthorizerOutput,
                    crate::operation::describe_authorizer::DescribeAuthorizerError,
                > for DescribeAuthorizerFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeAuthorizerFluentBuilder {
    ...
    /// Access the DescribeAuthorizer as a reference.
    pub fn as_input(&self) -> &crate::operation::describe_authorizer::builders::DescribeAuthorizerInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_authorizer::DescribeAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_authorizer::DescribeAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_authorizer::DescribeAuthorizer::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_authorizer::DescribeAuthorizer::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_authorizer::DescribeAuthorizerOutput, crate::operation::describe_authorizer::DescribeAuthorizerError, Self> {
