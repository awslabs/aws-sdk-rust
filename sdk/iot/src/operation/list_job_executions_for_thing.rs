...
impl ListJobExecutionsForThingInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_job_executions_for_thing::ListJobExecutionsForThing::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListJobExecutionsForThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_job_executions_for_thing::de_list_job_executions_for_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
