...
/// Orchestration and serialization glue logic for `ListJobExecutionsForThing`.
...
impl ListJobExecutionsForThing {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput,
                    ) -> ::std::result::Result<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListJobExecutionsForThing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListJobExecutionsForThing");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListJobExecutionsForThingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListJobExecutionsForThingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListJobExecutionsForThing")
...
.with_interceptor(ListJobExecutionsForThingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_job_executions_for_thing::de_list_job_executions_for_thing_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_job_executions_for_thing::de_list_job_executions_for_thing_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListJobExecutionsForThingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/things/{thingName}/jobs", thingName = thing_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_6) = &_input.job_id {
         {
            query.push_kv("jobId", &::aws_smithy_http::query::fmt_string(inner_6));
        }
    }
    ::std::result::Result::Ok(())
}
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListJobExecutionsForThingEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListJobExecutionsForThingInput>()
                        .ok_or("failed to downcast to ListJobExecutionsForThingInput")?;
...
/// Error type for the `ListJobExecutionsForThingError` operation.
#[non_exhaustive]
...
pub enum ListJobExecutionsForThingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListJobExecutionsForThingError) for what information is available for the error.")]
...
impl ListJobExecutionsForThingError {
    /// Creates the `ListJobExecutionsForThingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListJobExecutionsForThingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListJobExecutionsForThingError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListJobExecutionsForThingError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListJobExecutionsForThingError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `ListJobExecutionsForThingError::ThrottlingException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListJobExecutionsForThingError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListJobExecutionsForThingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError {
...
mod _list_job_executions_for_thing_output;
