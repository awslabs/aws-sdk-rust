    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListJobExecutionsForThing {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListJobExecutionsForThing", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListJobExecutionsForThing")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListJobExecutionsForThingResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListJobExecutionsForThingRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingInput>::assume_from(input).expect("correct type").unwrap();
...
pub type ListJobExecutionsForThingErrorKind = ListJobExecutionsForThingError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_job_executions_for_thing::ListJobExecutionsForThingError {
...
impl ListJobExecutionsForThingError {
    ...
    /// Creates the `ListJobExecutionsForThingError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
