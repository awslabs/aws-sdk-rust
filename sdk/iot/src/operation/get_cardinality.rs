...
impl GetCardinalityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_cardinality::GetCardinality, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_cardinality::ser_get_cardinality_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCardinality {
    type Output =
        ::std::result::Result<crate::operation::get_cardinality::GetCardinalityOutput, crate::operation::get_cardinality::GetCardinalityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_cardinality::de_get_cardinality_http_response_with_props(status, headers, body)
        }
    }
}
