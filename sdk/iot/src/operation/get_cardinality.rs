...
impl GetCardinalityInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_cardinality::GetCardinality::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetCardinality {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_cardinality::de_get_cardinality_http_error(
                status, headers, body,
            )
        } else {
...
impl std::error::Error for GetCardinalityError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            Self::IndexNotReadyException(_inner) => Some(_inner),
            Self::InternalFailureException(_inner) => Some(_inner),
            Self::InvalidAggregationException(_inner) => Some(_inner),
            Self::InvalidQueryException(_inner) => Some(_inner),
