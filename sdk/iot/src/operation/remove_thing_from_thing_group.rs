    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveThingFromThingGroup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("RemoveThingFromThingGroup", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveThingFromThingGroup")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RemoveThingFromThingGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RemoveThingFromThingGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RemoveThingFromThingGroupEndpointParamsInterceptor {
...
pub type RemoveThingFromThingGroupErrorKind = RemoveThingFromThingGroupError;
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError {
...
impl RemoveThingFromThingGroupError {
    ...
    /// Creates the `RemoveThingFromThingGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
