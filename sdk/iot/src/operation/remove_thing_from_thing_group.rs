...
/// Orchestration and serialization glue logic for `RemoveThingFromThingGroup`.
...
impl RemoveThingFromThingGroup {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveThingFromThingGroup {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveThingFromThingGroup");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveThingFromThingGroupRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveThingFromThingGroupResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveThingFromThingGroup")
...
.with_interceptor(RemoveThingFromThingGroupEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError>::new());
...
#[derive(Debug)]
            struct RemoveThingFromThingGroupResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveThingFromThingGroupResponseDeserializer {
...
#[derive(Debug)]
            struct RemoveThingFromThingGroupRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveThingFromThingGroupRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/thing-groups/removeThingFromThingGroup").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_thing_from_thing_group::ser_remove_thing_from_thing_group_input(&input)?);
...
#[derive(Debug)]
            struct RemoveThingFromThingGroupEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveThingFromThingGroupEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveThingFromThingGroupEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveThingFromThingGroupInput>()
                        .ok_or("failed to downcast to RemoveThingFromThingGroupInput")?;
...
/// Error type for the `RemoveThingFromThingGroupError` operation.
#[non_exhaustive]
...
pub enum RemoveThingFromThingGroupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveThingFromThingGroupError) for what information is available for the error.")]
...
impl RemoveThingFromThingGroupError {
    /// Creates the `RemoveThingFromThingGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveThingFromThingGroupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `RemoveThingFromThingGroupError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `RemoveThingFromThingGroupError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RemoveThingFromThingGroupError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `RemoveThingFromThingGroupError::ThrottlingException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RemoveThingFromThingGroupError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveThingFromThingGroupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupError {
...
mod _remove_thing_from_thing_group_output;
