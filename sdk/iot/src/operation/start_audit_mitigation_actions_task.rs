...
impl StartAuditMitigationActionsTaskInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_audit_mitigation_actions_task::StartAuditMitigationActionsTask::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAuditMitigationActionsTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_audit_mitigation_actions_task::de_start_audit_mitigation_actions_task_http_response_with_props(
                status, headers, body,
            )
        }
    }
