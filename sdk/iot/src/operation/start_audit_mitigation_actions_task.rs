...
impl StartAuditMitigationActionsTask {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::start_audit_mitigation_actions_task::StartAuditMitigationActionsTaskOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for StartAuditMitigationActionsTaskResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for StartAuditMitigationActionsTaskRequestSerializer {
