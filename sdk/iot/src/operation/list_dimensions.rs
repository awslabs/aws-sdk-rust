...
impl ListDimensionsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_dimensions::ListDimensions,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_dimensions::ListDimensions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDimensions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_dimensions::de_list_dimensions_http_error(
                status, headers, body,
            )
        } else {
