...
impl DeleteV2LoggingLevel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelInput,
                    ) -> ::std::result::Result<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteV2LoggingLevel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteV2LoggingLevel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteV2LoggingLevelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteV2LoggingLevelResponseDeserializer));
...
.with_interceptor(DeleteV2LoggingLevelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError>::new());
...
#[derive(Debug)]
            struct DeleteV2LoggingLevelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteV2LoggingLevelResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteV2LoggingLevelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteV2LoggingLevelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/v2LoggingLevel").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.target_type;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("target_type", "cannot be empty or unset"))?;
    query.push_kv("targetType", &::aws_smithy_http::query::fmt_string(inner_1));
    let inner_2 = &_input.target_name;
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("target_name", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("target_name", "cannot be empty or unset"));
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteV2LoggingLevelEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteV2LoggingLevelInput>()
                        .ok_or("failed to downcast to DeleteV2LoggingLevelInput")?;
...
/// Error type for the `DeleteV2LoggingLevelError` operation.
#[non_exhaustive]
...
pub enum DeleteV2LoggingLevelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteV2LoggingLevelError) for what information is available for the error.")]
...
impl DeleteV2LoggingLevelError {
    /// Creates the `DeleteV2LoggingLevelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteV2LoggingLevelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `DeleteV2LoggingLevelError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `DeleteV2LoggingLevelError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteV2LoggingLevelError::ServiceUnavailableException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteV2LoggingLevelError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteV2LoggingLevelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError {
...
mod _delete_v2_logging_level_output;
