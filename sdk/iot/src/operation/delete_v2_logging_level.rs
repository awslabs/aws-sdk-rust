...
impl DeleteV2LoggingLevel {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("iot", "DeleteV2LoggingLevel", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteV2LoggingLevel {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteV2LoggingLevel", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteV2LoggingLevel")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for DeleteV2LoggingLevelResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for DeleteV2LoggingLevelRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                let inner_1 = inner_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("target_type", "cannot be empty or unset"))?;
                query.push_kv("targetType", &::aws_smithy_http::query::fmt_string(&inner_1));
                let inner_2 = &_input.target_name;
                let inner_2 = inner_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("target_name", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteV2LoggingLevelEndpointParamsInterceptor {
...
pub type DeleteV2LoggingLevelErrorKind = DeleteV2LoggingLevelError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_v2_logging_level::DeleteV2LoggingLevelError {
...
impl DeleteV2LoggingLevelError {
    ...
    /// Creates the `DeleteV2LoggingLevelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
