...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAccountAuditConfiguration {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_account_audit_configuration::de_delete_account_audit_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteAccountAuditConfigurationError
{
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_account_audit_configuration::DeleteAccountAuditConfigurationError
{
