...
impl ListActiveViolationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_active_violations::ListActiveViolations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListActiveViolations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_active_violations::de_list_active_violations_http_response_with_props(status, headers, body)
        }
    }
}
