...
impl ListActiveViolations {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_active_violations::ListActiveViolationsInput,
                    ) -> ::std::result::Result<crate::operation::list_active_violations::ListActiveViolationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_active_violations::ListActiveViolationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_active_violations::ListActiveViolationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_active_violations::ListActiveViolationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListActiveViolations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListActiveViolations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListActiveViolationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListActiveViolationsResponseDeserializer));
...
.with_interceptor(ListActiveViolationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_active_violations::ListActiveViolationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_active_violations::ListActiveViolationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_active_violations::ListActiveViolationsError>::new());
...
#[derive(Debug)]
            struct ListActiveViolationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListActiveViolationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_active_violations::de_list_active_violations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_active_violations::de_list_active_violations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListActiveViolationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListActiveViolationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_active_violations::ListActiveViolationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_active_violations::ListActiveViolationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/active-violations").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_active_violations::ListActiveViolationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.list_suppressed_alerts {
         {
            query.push_kv("listSuppressedAlerts", ::aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
        }
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListActiveViolationsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListActiveViolationsInput>()
                        .ok_or("failed to downcast to ListActiveViolationsInput")?;
...
/// Error type for the `ListActiveViolationsError` operation.
#[non_exhaustive]
...
pub enum ListActiveViolationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListActiveViolationsError) for what information is available for the error.")]
...
impl ListActiveViolationsError {
    /// Creates the `ListActiveViolationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListActiveViolationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListActiveViolationsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListActiveViolationsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListActiveViolationsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListActiveViolationsError::ThrottlingException`.
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListActiveViolationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListActiveViolationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_active_violations::ListActiveViolationsError {
...
mod _list_active_violations_output;
