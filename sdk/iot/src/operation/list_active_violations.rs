...
impl ListActiveViolations {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_active_violations::ListActiveViolationsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_active_violations::ListActiveViolationsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("iot", "ListActiveViolations", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListActiveViolations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListActiveViolations", "iot"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListActiveViolations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListActiveViolationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListActiveViolationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_active_violations::ListActiveViolationsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListActiveViolationsEndpointParamsInterceptor {
...
pub type ListActiveViolationsErrorKind = ListActiveViolationsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_active_violations::ListActiveViolationsError {
...
impl ListActiveViolationsError {
    ...
    /// Creates the `ListActiveViolationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
