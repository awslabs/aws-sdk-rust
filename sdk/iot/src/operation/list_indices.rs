...
impl ListIndicesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_indices::ListIndices::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIndices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_indices::de_list_indices_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_indices::de_list_indices_http_response_with_props(
                status, headers, body,
            )
        }
    }
