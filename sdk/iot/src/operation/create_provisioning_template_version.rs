...
impl CreateProvisioningTemplateVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_provisioning_template_version::CreateProvisioningTemplateVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProvisioningTemplateVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_provisioning_template_version::de_create_provisioning_template_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
