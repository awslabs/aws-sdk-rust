    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_certificates_by_ca::ListCertificatesByCAError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_certificates_by_ca::ListCertificatesByCaOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListCertificatesByCAResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListCertificatesByCARequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_certificates_by_ca::ListCertificatesByCaInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("ca_certificate_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListCertificatesByCAEndpointParamsInterceptor {
...
pub type ListCertificatesByCAErrorKind = ListCertificatesByCAError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_certificates_by_ca::ListCertificatesByCAError {
...
impl ListCertificatesByCAError {
    ...
    /// Creates the `ListCertificatesByCAError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
