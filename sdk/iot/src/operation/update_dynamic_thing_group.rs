...
impl UpdateDynamicThingGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_dynamic_thing_group::UpdateDynamicThingGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDynamicThingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_dynamic_thing_group::de_update_dynamic_thing_group_http_response_with_props(status, headers, body)
        }
    }
}
