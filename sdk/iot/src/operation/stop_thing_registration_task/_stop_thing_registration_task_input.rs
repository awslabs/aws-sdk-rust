...
impl StopThingRegistrationTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_thing_registration_task::StopThingRegistrationTaskInput, ::aws_smithy_types::error::operation::BuildError> {
