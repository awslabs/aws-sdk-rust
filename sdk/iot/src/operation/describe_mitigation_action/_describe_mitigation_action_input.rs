...
impl DescribeMitigationActionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_mitigation_action::DescribeMitigationActionInput, ::aws_smithy_types::error::operation::BuildError> {
