...
impl DescribeMitigationActionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_mitigation_action::DescribeMitigationActionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_mitigation_action::DescribeMitigationActionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_mitigation_action::DescribeMitigationActionOutput, crate::operation::describe_mitigation_action::DescribeMitigationActionError, Self> {
