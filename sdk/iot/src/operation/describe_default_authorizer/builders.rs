...
impl DescribeDefaultAuthorizerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerOutput, crate::operation::describe_default_authorizer::DescribeDefaultAuthorizerError, Self> {
