...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_provisioning_template::DeleteProvisioningTemplateOutput,
                    crate::operation::delete_provisioning_template::DeleteProvisioningTemplateError,
                > for DeleteProvisioningTemplateFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteProvisioningTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_provisioning_template::DeleteProvisioningTemplateOutput, crate::operation::delete_provisioning_template::DeleteProvisioningTemplateError, Self> {
