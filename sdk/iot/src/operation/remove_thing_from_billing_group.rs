    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveThingFromBillingGroup {
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveThingFromBillingGroup")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for RemoveThingFromBillingGroupResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for RemoveThingFromBillingGroupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for RemoveThingFromBillingGroupEndpointParamsInterceptor {
...
pub type RemoveThingFromBillingGroupErrorKind = RemoveThingFromBillingGroupError;
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupError {
...
impl RemoveThingFromBillingGroupError {
    ...
    /// Creates the `RemoveThingFromBillingGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
