    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/billing-groups/removeThingFromBillingGroup")
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveThingFromBillingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_thing_from_billing_group::de_remove_thing_from_billing_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RemoveThingFromBillingGroupError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroupError
{
