...
impl RemoveThingFromBillingGroupInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_thing_from_billing_group::RemoveThingFromBillingGroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveThingFromBillingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_thing_from_billing_group::de_remove_thing_from_billing_group_http_response_with_props(
                status, headers, body,
            )
        }
    }
