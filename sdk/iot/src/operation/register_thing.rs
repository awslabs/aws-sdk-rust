...
impl RegisterThing {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_thing::RegisterThingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_thing::RegisterThingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_thing::RegisterThingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_thing::RegisterThingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterThing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterThing");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterThingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterThingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterThing")
...
.with_interceptor(RegisterThingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_thing::RegisterThingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_thing::RegisterThingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_thing::RegisterThingError>::new());
...
#[derive(Debug)]
            struct RegisterThingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterThingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_thing::de_register_thing_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_register_thing::de_register_thing_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RegisterThingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterThingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_thing::RegisterThingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_thing::RegisterThingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_thing::ser_register_thing_input(&input)?);
...
#[derive(Debug)]
            struct RegisterThingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterThingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterThingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterThingInput>()
                        .ok_or("failed to downcast to RegisterThingInput")?;
...
/// Error type for the `RegisterThingError` operation.
#[non_exhaustive]
...
pub enum RegisterThingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterThingError) for what information is available for the error.")]
...
impl RegisterThingError {
    /// Creates the `RegisterThingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterThingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ResourceRegistrationFailureException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `RegisterThingError::ConflictingResourceUpdateException`.
    pub fn is_conflicting_resource_update_exception(&self) -> bool {
        matches!(self, Self::ConflictingResourceUpdateException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::ResourceRegistrationFailureException`.
    pub fn is_resource_registration_failure_exception(&self) -> bool {
        matches!(self, Self::ResourceRegistrationFailureException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `RegisterThingError::UnauthorizedException`.
...
impl ::std::error::Error for RegisterThingError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            ::std::option::Option::Some(_inner)
            ,
            Self::ResourceRegistrationFailureException(_inner) =>
            ::std::option::Option::Some(_inner)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterThingError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterThingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_thing::RegisterThingError {
