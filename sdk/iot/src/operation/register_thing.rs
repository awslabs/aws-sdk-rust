...
impl RegisterThingInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_thing::RegisterThing::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterThing {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_thing::de_register_thing_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_register_thing::de_register_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
...
impl std::error::Error for RegisterThingError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::ResourceRegistrationFailureException(_inner) => Some(_inner),
