...
impl RegisterThingInput {
    /// Consumes the builder and constructs an Operation<[`RegisterThing`](crate::operation::register_thing::RegisterThing)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::register_thing::RegisterThing, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_register_thing::ser_register_thing_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_thing::RegisterThing::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterThing", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterThing {
    type Output = ::std::result::Result<crate::operation::register_thing::RegisterThingOutput, crate::operation::register_thing::RegisterThingError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_thing::de_register_thing_http_response_with_props(status, headers, body)
        }
    }
}
