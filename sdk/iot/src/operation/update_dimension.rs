...
impl UpdateDimensionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_dimension::UpdateDimension, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_dimension::ser_update_dimension_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDimension {
    type Output =
        ::std::result::Result<crate::operation::update_dimension::UpdateDimensionOutput, crate::operation::update_dimension::UpdateDimensionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_dimension::de_update_dimension_http_response_with_props(status, headers, body)
        }
    }
}
