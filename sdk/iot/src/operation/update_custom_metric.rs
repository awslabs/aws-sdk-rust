...
impl UpdateCustomMetricInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_custom_metric::ser_update_custom_metric_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomMetric {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_custom_metric::de_update_custom_metric_http_response_with_props(status, headers, body)
        }
    }
}
