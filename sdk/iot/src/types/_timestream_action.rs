        ...
        ::std::result::Result::Ok(
            crate::types::TimestreamAction {
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building TimestreamAction")
                    )?
                ,
                database_name: self.database_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("database_name", "database_name was not specified but it is required when building TimestreamAction")
                    )?
                ,
                table_name: self.table_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("table_name", "table_name was not specified but it is required when building TimestreamAction")
                    )?
                ,
                dimensions: self.dimensions
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("dimensions", "dimensions was not specified but it is required when building TimestreamAction")
                    )?
                ,
