        ...
        ::std::result::Result::Ok(
            crate::types::AwsJobAbortCriteria {
                failure_type: self.failure_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("failure_type", "failure_type was not specified but it is required when building AwsJobAbortCriteria")
                    )?
                ,
                action: self.action
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("action", "action was not specified but it is required when building AwsJobAbortCriteria")
                    )?
                ,
                threshold_percentage: self.threshold_percentage
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("threshold_percentage", "threshold_percentage was not specified but it is required when building AwsJobAbortCriteria")
                    )?
                ,
                min_number_of_executed_things: self.min_number_of_executed_things
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("min_number_of_executed_things", "min_number_of_executed_things was not specified but it is required when building AwsJobAbortCriteria")
                    )?
                ,
            }
        )
