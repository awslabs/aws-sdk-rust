        ...
        ::std::result::Result::Ok(
            crate::types::ThingGroupIndexingConfiguration {
                thing_group_indexing_mode: self.thing_group_indexing_mode
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("thing_group_indexing_mode", "thing_group_indexing_mode was not specified but it is required when building ThingGroupIndexingConfiguration")
                    )?
                ,
