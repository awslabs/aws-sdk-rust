...
impl ConfigurationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConfigurationStatus::Healthy => "HEALTHY",
            ConfigurationStatus::Unhealthy => "UNHEALTHY",
...
impl ::std::fmt::Display for ConfigurationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConfigurationStatus::Healthy => write!(f, "HEALTHY"),
            ConfigurationStatus::Unhealthy => write!(f, "UNHEALTHY"),
