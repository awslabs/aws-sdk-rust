...
pub(crate) fn reflens_list_managed_job_templates_output_next_token(
...
pub(crate) fn reflens_list_related_resources_for_audit_finding_output_next_token(
...
pub(crate) fn lens_list_managed_job_templates_output_managed_job_templates(
    input: crate::operation::list_managed_job_templates::ListManagedJobTemplatesOutput,
...
pub(crate) fn lens_list_related_resources_for_audit_finding_output_related_resources(
    input: crate::operation::list_related_resources_for_audit_finding::ListRelatedResourcesForAuditFindingOutput,
