...
pub fn ser_add_thing_to_thing_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddThingToThingGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
