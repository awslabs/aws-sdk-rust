...
pub fn ser_resource_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
