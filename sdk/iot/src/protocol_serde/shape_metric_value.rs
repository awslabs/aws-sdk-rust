            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ports" => {
                            builder = builder.set_ports(crate::protocol_serde::shape_ports::de_ports(tokens, _value, depth + 1)?);
                        }
                        "number" => {
                            builder = builder
                        ...
                        "numbers" => {
                            builder = builder.set_numbers(crate::protocol_serde::shape_number_list::de_number_list(tokens, _value, depth + 1)?);
                        }
                        "strings" => {
                            builder = builder.set_strings(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                        }
