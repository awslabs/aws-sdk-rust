...
pub fn ser_metric_value(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
