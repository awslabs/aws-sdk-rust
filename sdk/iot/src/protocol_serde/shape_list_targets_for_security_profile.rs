...
pub fn de_list_targets_for_security_profile_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileOutput, crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_targets_for_security_profile_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileOutput, crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError> {
    Ok({
        #[allow(unused_mut)]
