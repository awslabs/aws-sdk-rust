...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError::unhandled)?;
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_targets_for_security_profile::de_list_targets_for_security_profile(_response_body, output)
            .map_err(crate::operation::list_targets_for_security_profile::ListTargetsForSecurityProfileError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "securityProfileTargets" => {
                    builder = builder.set_security_profile_targets(
                        crate::protocol_serde::shape_security_profile_targets::de_security_profile_targets(tokens, _value, depth + 1)?,
                    );
                }
