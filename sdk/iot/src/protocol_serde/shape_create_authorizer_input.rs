...
pub fn ser_create_authorizer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAuthorizerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
