...
pub fn ser_create_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
