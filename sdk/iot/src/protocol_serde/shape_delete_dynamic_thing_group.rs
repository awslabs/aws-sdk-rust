...
> {
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::error::DeleteDynamicThingGroupError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::error::DeleteDynamicThingGroupError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "VersionConflictException" => {
            crate::error::DeleteDynamicThingGroupError::VersionConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
