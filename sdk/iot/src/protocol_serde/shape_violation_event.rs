...
pub(crate) fn de_violation_event<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ViolationEvent>, aws_smithy_json::deserialize::error::DeserializeError>
