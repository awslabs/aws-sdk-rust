...
pub fn ser_get_buckets_aggregation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetBucketsAggregationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
