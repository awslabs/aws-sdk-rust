...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_mitigation_actions::ListMitigationActionsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_mitigation_actions::de_list_mitigation_actions(_response_body, output)
            .map_err(crate::operation::list_mitigation_actions::ListMitigationActionsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "actionIdentifiers" => {
                    builder = builder.set_action_identifiers(
                        crate::protocol_serde::shape_mitigation_action_identifier_list::de_mitigation_action_identifier_list(tokens, _value)?,
                    );
                }
                "nextToken" => {
