...
pub fn de_replace_topic_rule_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ReplaceTopicRuleOutput, crate::error::ReplaceTopicRuleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ReplaceTopicRuleError::unhandled)?;
    ...
    Err(match error_code {
        "ConflictingResourceUpdateException" => crate::error::ReplaceTopicRuleError::ConflictingResourceUpdateException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::error::ReplaceTopicRuleError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::ReplaceTopicRuleError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_replace_topic_rule_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ReplaceTopicRuleOutput, crate::error::ReplaceTopicRuleError> {
    Ok({
        #[allow(unused_mut)]
