...
pub fn ser_set_v2_logging_options_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SetV2LoggingOptionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
