...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::unhandled)?;
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_audit_mitigation_actions_task_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_describe_audit_mitigation_actions_task::de_describe_audit_mitigation_actions_task(_response_body, output)
                .map_err(crate::operation::describe_audit_mitigation_actions_task::DescribeAuditMitigationActionsTaskError::unhandled)?;
                ...
                "taskStatus" => {
                    builder = builder.set_task_status(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::AuditMitigationActionsTaskStatus::from(u.as_ref())))
                            .transpose()?,
                    );
                }
