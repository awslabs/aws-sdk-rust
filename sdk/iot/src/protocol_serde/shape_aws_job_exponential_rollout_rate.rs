...
pub(crate) fn de_aws_job_exponential_rollout_rate<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsJobExponentialRolloutRate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "rateIncreaseCriteria" => {
                            builder = builder.set_rate_increase_criteria(
                                crate::protocol_serde::shape_aws_job_rate_increase_criteria::de_aws_job_rate_increase_criteria(tokens, _value)?,
                            );
                        }
