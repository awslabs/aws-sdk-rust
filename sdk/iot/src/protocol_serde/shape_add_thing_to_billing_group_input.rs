...
pub fn ser_add_thing_to_billing_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AddThingToBillingGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
