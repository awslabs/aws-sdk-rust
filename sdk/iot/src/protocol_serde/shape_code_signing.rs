...
pub fn ser_code_signing(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CodeSigning,
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "startSigningJobParameter" => {
                            builder = builder.set_start_signing_job_parameter(
                                crate::protocol_serde::shape_start_signing_job_parameter::de_start_signing_job_parameter(tokens, _value, depth + 1)?,
                            );
                        }
                        "customCodeSigning" => {
                            builder = builder.set_custom_code_signing(crate::protocol_serde::shape_custom_code_signing::de_custom_code_signing(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
