...
pub fn ser_logging_options_payload_http_payload(
    payload: &std::option::Option<crate::types::LoggingOptionsPayload>,
...
pub fn ser_logging_options_payload_payload(
    ...
    crate::protocol_serde::shape_logging_options_payload::ser_logging_options_payload(
        &mut object,
        input,
    )?;
    object.finish();
