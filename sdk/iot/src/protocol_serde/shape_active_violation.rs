...
pub(crate) fn de_active_violation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ActiveViolation>, aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "lastViolationValue" => {
                                builder = builder.set_last_violation_value(
                            ...
                            "violationStartTime" => {
                                builder = builder.set_violation_start_time(
                                    aws_smithy_json::deserialize::token::expect_timestamp_or_null(tokens.next(), aws_smithy_types::date_time::Format::EpochSeconds)?
                                );
                            }
