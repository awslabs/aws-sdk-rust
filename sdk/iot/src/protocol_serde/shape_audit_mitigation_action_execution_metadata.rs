...
pub(crate) fn de_audit_mitigation_action_execution_metadata<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AuditMitigationActionExecutionMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::AuditMitigationActionsExecutionStatus::from(u.as_ref()))
                                    })
                                    .transpose()?,
                            );
                        }
