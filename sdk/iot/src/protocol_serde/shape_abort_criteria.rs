...
pub(crate) fn de_abort_criteria<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AbortCriteria>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "failureType" => {
                            builder = builder.set_failure_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::JobExecutionFailureType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "action" => {
                            builder = builder.set_action(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AbortAction::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "thresholdPercentage" => {
