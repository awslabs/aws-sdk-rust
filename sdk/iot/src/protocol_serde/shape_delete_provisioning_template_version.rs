...
pub fn de_delete_provisioning_template_version_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_provisioning_template_version::DeleteProvisioningTemplateVersionOutput, crate::operation::delete_provisioning_template_version::DeleteProvisioningTemplateVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_provisioning_template_version_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_provisioning_template_version::DeleteProvisioningTemplateVersionOutput, crate::operation::delete_provisioning_template_version::DeleteProvisioningTemplateVersionError> {
    Ok({
        #[allow(unused_mut)]
