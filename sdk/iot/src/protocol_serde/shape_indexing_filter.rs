...
pub(crate) fn de_indexing_filter<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IndexingFilter>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "geoLocations" => {
                                builder = builder.set_geo_locations(
                                    crate::protocol_serde::shape_geo_locations_filter::de_geo_locations_filter(tokens)?
                                );
                            }
