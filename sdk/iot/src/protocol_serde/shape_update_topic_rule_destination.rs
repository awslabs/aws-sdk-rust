...
> {
    ...
    Err(match error_code {
        ...
        "InvalidRequestException" => {
            crate::error::UpdateTopicRuleDestinationError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::error::UpdateTopicRuleDestinationError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedException" => {
            crate::error::UpdateTopicRuleDestinationError::UnauthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
