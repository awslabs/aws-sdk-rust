...
pub fn ser_start_signing_job_parameter(
    ...
    if let Some(var_1) = &input.signing_profile_parameter {
        ...
        crate::protocol_serde::shape_signing_profile_parameter::ser_signing_profile_parameter(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
...
pub(crate) fn de_start_signing_job_parameter<'a, I>(
    ...
    Option<crate::model::StartSigningJobParameter>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "destination" => {
                                builder = builder.set_destination(
                                    crate::protocol_serde::shape_destination::de_destination(
                                        tokens,
                                    )?,
                                );
                            }
