...
pub fn de_get_policy_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetPolicyVersionOutput, crate::error::GetPolicyVersionError> {
    ...
    Err(match error_code {
        "InternalFailureException" => crate::error::GetPolicyVersionError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::error::GetPolicyVersionError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::GetPolicyVersionError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::GetPolicyVersionError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
pub(crate) fn de_get_policy_version(value: &[u8], mut builder: crate::output::get_policy_version_output::Builder) -> Result<crate::output::get_policy_version_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
