...
) -> Result<crate::operation::get_policy_version::builders::GetPolicyVersionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "isDefaultVersion" => {
                    builder = builder.set_is_default_version(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "lastModifiedDate" => {
