...
pub fn de_get_v2_logging_options_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_v2_logging_options::GetV2LoggingOptionsOutput, crate::operation::get_v2_logging_options::GetV2LoggingOptionsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_v2_logging_options_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_v2_logging_options::GetV2LoggingOptionsOutput, crate::operation::get_v2_logging_options::GetV2LoggingOptionsError> {
    Ok({
        #[allow(unused_mut)]
