...
pub fn ser_update_audit_suppression_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAuditSuppressionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
