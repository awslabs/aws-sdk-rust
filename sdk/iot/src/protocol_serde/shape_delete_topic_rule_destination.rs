...
pub fn de_delete_topic_rule_destination_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationOutput, crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_topic_rule_destination_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationOutput, crate::operation::delete_topic_rule_destination::DeleteTopicRuleDestinationError> {
    Ok({
        #[allow(unused_mut)]
