...
pub fn de_get_ota_update_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetOtaUpdateOutput, crate::error::GetOTAUpdateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetOTAUpdateError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => crate::error::GetOTAUpdateError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::error::GetOTAUpdateError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ota_update_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetOtaUpdateOutput, crate::error::GetOTAUpdateError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_ota_update_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_ota_update::de_get_ota_update(response.body().as_ref(), output).map_err(crate::error::GetOTAUpdateError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_ota_update(value: &[u8], mut builder: crate::output::get_ota_update_output::Builder) -> Result<crate::output::get_ota_update_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
