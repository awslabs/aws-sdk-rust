...
) -> Result<Option<crate::types::DetectMitigationActionsTaskSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "actionsDefinition" => {
                            builder = builder
                                .set_actions_definition(crate::protocol_serde::shape_mitigation_action_list::de_mitigation_action_list(tokens)?);
                        }
                        "taskStatistics" => {
