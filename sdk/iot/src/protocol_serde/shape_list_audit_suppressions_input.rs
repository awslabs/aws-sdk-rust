...
pub fn ser_list_audit_suppressions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAuditSuppressionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
