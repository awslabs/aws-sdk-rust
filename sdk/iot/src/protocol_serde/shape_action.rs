            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "sns" => {
                            builder = builder.set_sns(crate::protocol_serde::shape_sns_action::de_sns_action(tokens, _value)?);
                        }
                        "sqs" => {
                            builder = builder.set_sqs(crate::protocol_serde::shape_sqs_action::de_sqs_action(tokens, _value)?);
                        }
                        "kinesis" => {
                            builder = builder.set_kinesis(crate::protocol_serde::shape_kinesis_action::de_kinesis_action(tokens, _value)?);
                        }
                        "republish" => {
                            builder = builder.set_republish(crate::protocol_serde::shape_republish_action::de_republish_action(tokens, _value)?);
                        }
                        "s3" => {
                            builder = builder.set_s3(crate::protocol_serde::shape_s3_action::de_s3_action(tokens, _value)?);
                        }
                        "firehose" => {
                        ...
                        "cloudwatchMetric" => {
                            builder = builder.set_cloudwatch_metric(
                                crate::protocol_serde::shape_cloudwatch_metric_action::de_cloudwatch_metric_action(tokens, _value)?,
                            );
                        }
                        "cloudwatchAlarm" => {
                            builder = builder.set_cloudwatch_alarm(crate::protocol_serde::shape_cloudwatch_alarm_action::de_cloudwatch_alarm_action(
                                tokens, _value,
                            )?);
                        }
                        "cloudwatchLogs" => {
                            builder = builder.set_cloudwatch_logs(crate::protocol_serde::shape_cloudwatch_logs_action::de_cloudwatch_logs_action(
                                tokens, _value,
                            )?);
                        }
                        "elasticsearch" => {
                        ...
                        "salesforce" => {
                            builder = builder.set_salesforce(crate::protocol_serde::shape_salesforce_action::de_salesforce_action(tokens, _value)?);
                        }
                        "iotAnalytics" => {
                        ...
                        "timestream" => {
                            builder = builder.set_timestream(crate::protocol_serde::shape_timestream_action::de_timestream_action(tokens, _value)?);
                        }
                        "http" => {
                            builder = builder.set_http(crate::protocol_serde::shape_http_action::de_http_action(tokens, _value)?);
                        }
                        "kafka" => {
                            builder = builder.set_kafka(crate::protocol_serde::shape_kafka_action::de_kafka_action(tokens, _value)?);
                        }
                        "openSearch" => {
                            builder =
                                builder.set_open_search(crate::protocol_serde::shape_open_search_action::de_open_search_action(tokens, _value)?);
                        }
                        "location" => {
                            builder = builder.set_location(crate::protocol_serde::shape_location_action::de_location_action(tokens, _value)?);
                        }
