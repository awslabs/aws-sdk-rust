                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            "dynamoDB" => {
                                builder = builder.set_dynamo_db(crate::protocol_serde::shape_dynamo_db_action::de_dynamo_db_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "dynamoDBv2" => {
                                builder = builder.set_dynamo_dbv2(crate::protocol_serde::shape_dynamo_dbv2_action::de_dynamo_dbv2_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "lambda" => {
                                builder =
                                    builder.set_lambda(crate::protocol_serde::shape_lambda_action::de_lambda_action(tokens, _value, depth + 1)?);
                            }
                            "sns" => {
                                builder = builder.set_sns(crate::protocol_serde::shape_sns_action::de_sns_action(tokens, _value, depth + 1)?);
                            }
                            "sqs" => {
                                builder = builder.set_sqs(crate::protocol_serde::shape_sqs_action::de_sqs_action(tokens, _value, depth + 1)?);
                            }
                            "kinesis" => {
                                builder =
                                    builder.set_kinesis(crate::protocol_serde::shape_kinesis_action::de_kinesis_action(tokens, _value, depth + 1)?);
                            }
                            "republish" => {
                                builder = builder.set_republish(crate::protocol_serde::shape_republish_action::de_republish_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "s3" => {
                                builder = builder.set_s3(crate::protocol_serde::shape_s3_action::de_s3_action(tokens, _value, depth + 1)?);
                            }
                            "firehose" => {
                                builder = builder.set_firehose(crate::protocol_serde::shape_firehose_action::de_firehose_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "cloudwatchMetric" => {
                                builder = builder.set_cloudwatch_metric(
                                    crate::protocol_serde::shape_cloudwatch_metric_action::de_cloudwatch_metric_action(tokens, _value, depth + 1)?,
                                );
                            }
                            "cloudwatchAlarm" => {
                                builder = builder.set_cloudwatch_alarm(
                                    crate::protocol_serde::shape_cloudwatch_alarm_action::de_cloudwatch_alarm_action(tokens, _value, depth + 1)?,
                                );
                            }
                            "cloudwatchLogs" => {
                                builder = builder.set_cloudwatch_logs(
                                    crate::protocol_serde::shape_cloudwatch_logs_action::de_cloudwatch_logs_action(tokens, _value, depth + 1)?,
                                );
                            }
                            "elasticsearch" => {
                                builder = builder.set_elasticsearch(crate::protocol_serde::shape_elasticsearch_action::de_elasticsearch_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "salesforce" => {
                                builder = builder.set_salesforce(crate::protocol_serde::shape_salesforce_action::de_salesforce_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "iotAnalytics" => {
                                builder = builder.set_iot_analytics(crate::protocol_serde::shape_iot_analytics_action::de_iot_analytics_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "iotEvents" => {
                                builder = builder.set_iot_events(crate::protocol_serde::shape_iot_events_action::de_iot_events_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "stepFunctions" => {
                                builder = builder.set_step_functions(crate::protocol_serde::shape_step_functions_action::de_step_functions_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "timestream" => {
                                builder = builder.set_timestream(crate::protocol_serde::shape_timestream_action::de_timestream_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "http" => {
                                builder = builder.set_http(crate::protocol_serde::shape_http_action::de_http_action(tokens, _value, depth + 1)?);
                            }
                            "kafka" => {
                                builder = builder.set_kafka(crate::protocol_serde::shape_kafka_action::de_kafka_action(tokens, _value, depth + 1)?);
                            }
                            "openSearch" => {
                                builder = builder.set_open_search(crate::protocol_serde::shape_open_search_action::de_open_search_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "location" => {
                                builder = builder.set_location(crate::protocol_serde::shape_location_action::de_location_action(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
