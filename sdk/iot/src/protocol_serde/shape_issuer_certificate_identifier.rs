...
pub fn ser_issuer_certificate_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IssuerCertificateIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_issuer_certificate_identifier<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IssuerCertificateIdentifier>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::issuer_certificate_identifier::Builder::default();
            loop {
                match tokens.next().transpose()? {
