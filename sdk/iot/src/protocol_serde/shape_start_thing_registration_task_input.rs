...
pub fn ser_start_thing_registration_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartThingRegistrationTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
