...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_certificate_transfer_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_certificate_transfer::CancelCertificateTransferOutput, crate::operation::cancel_certificate_transfer::CancelCertificateTransferError> {
    Ok({
        #[allow(unused_mut)]
