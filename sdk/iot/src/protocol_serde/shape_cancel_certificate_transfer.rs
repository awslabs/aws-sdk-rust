...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_certificate_transfer::CancelCertificateTransferError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::cancel_certificate_transfer::CancelCertificateTransferError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceUnavailableException" => {
            crate::operation::cancel_certificate_transfer::CancelCertificateTransferError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TransferAlreadyCompletedException" => {
            crate::operation::cancel_certificate_transfer::CancelCertificateTransferError::TransferAlreadyCompletedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
