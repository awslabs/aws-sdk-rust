...
pub fn de_cancel_audit_mitigation_actions_task_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_audit_mitigation_actions_task::CancelAuditMitigationActionsTaskOutput, crate::operation::cancel_audit_mitigation_actions_task::CancelAuditMitigationActionsTaskError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_audit_mitigation_actions_task_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::cancel_audit_mitigation_actions_task::CancelAuditMitigationActionsTaskOutput, crate::operation::cancel_audit_mitigation_actions_task::CancelAuditMitigationActionsTaskError> {
    Ok({
        #[allow(unused_mut)]
