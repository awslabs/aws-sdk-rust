...
pub(crate) fn de_timestream_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TimestreamAction>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::timestream_action::Builder::default();
            loop {
                match tokens.next().transpose()? {
...
pub fn ser_timestream_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TimestreamAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
