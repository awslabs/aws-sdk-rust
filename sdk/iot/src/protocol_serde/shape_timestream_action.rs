...
pub(crate) fn de_timestream_action<'a, I>(
    ...
    Option<crate::types::TimestreamAction>,
...
pub fn ser_timestream_action(
        ...
        for item_6 in var_4 {
            {
                ...
                crate::protocol_serde::shape_timestream_dimension::ser_timestream_dimension(
                    &mut object_7,
                    item_6,
                )?;
                object_7.finish();
    ...
    if let Some(var_8) = &input.timestamp {
        ...
        crate::protocol_serde::shape_timestream_timestamp::ser_timestream_timestamp(
            &mut object_9,
            var_8,
        )?;
        object_9.finish();
