...
pub(crate) fn de_thing_group_indexing_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ThingGroupIndexingConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_thing_group_indexing_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ThingGroupIndexingConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
