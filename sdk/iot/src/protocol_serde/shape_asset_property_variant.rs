...
pub fn ser_asset_property_variant(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AssetPropertyVariant) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
                ...
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.to_unescaped()?.as_ref() {
                            "stringValue" => {
                                Some(crate::model::AssetPropertyVariant::StringValue(
                            ...
                            "integerValue" => {
                                Some(crate::model::AssetPropertyVariant::IntegerValue(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            u.into_owned()
                                        )
                            ...
                            "doubleValue" => {
                                Some(crate::model::AssetPropertyVariant::DoubleValue(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            u.into_owned()
                                        )
                            ...
                            "booleanValue" => {
                                Some(crate::model::AssetPropertyVariant::BooleanValue(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            u.into_owned()
                                        )
