...
pub(crate) fn de_republish_action<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::RepublishAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "headers" => {
                            builder = builder.set_headers(crate::protocol_serde::shape_mqtt_headers::de_mqtt_headers(tokens, _value, depth + 1)?);
                        }
