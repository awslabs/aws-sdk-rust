...
pub fn de_describe_thing_registration_task_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskOutput, crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_internal_failure_exception::de_internal_failure_exception_json_err(_response_body, output).map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_request_exception::de_invalid_request_exception_json_err(_response_body, output).map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(_response_body, output).map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(_response_body, output).map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unauthorized_exception::de_unauthorized_exception_json_err(_response_body, output).map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_thing_registration_task_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskOutput, crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError> {
    Ok({
        #[allow(unused_mut)]
