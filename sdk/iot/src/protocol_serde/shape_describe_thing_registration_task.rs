...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_thing_registration_task::de_describe_thing_registration_task(_response_body, output)
            .map_err(crate::operation::describe_thing_registration_task::DescribeThingRegistrationTaskError::unhandled)?;
