...
pub fn de_delete_job_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteJobTemplateOutput, crate::error::DeleteJobTemplateError> {
    ...
    Err(match error_code {
        "InternalFailureException" => crate::error::DeleteJobTemplateError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => crate::error::DeleteJobTemplateError::InvalidRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::error::DeleteJobTemplateError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
