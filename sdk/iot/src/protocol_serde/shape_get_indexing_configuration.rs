...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_indexing_configuration::GetIndexingConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_indexing_configuration::GetIndexingConfigurationError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_indexing_configuration::de_get_indexing_configuration(_response_body, output)
            .map_err(crate::operation::get_indexing_configuration::GetIndexingConfigurationError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "thingGroupIndexingConfiguration" => {
                    builder = builder.set_thing_group_indexing_configuration(
                        crate::protocol_serde::shape_thing_group_indexing_configuration::de_thing_group_indexing_configuration(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "thingIndexingConfiguration" => {
                    builder = builder.set_thing_indexing_configuration(
                        crate::protocol_serde::shape_thing_indexing_configuration::de_thing_indexing_configuration(tokens, _value, depth + 1)?,
                    );
                }
