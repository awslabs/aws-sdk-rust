...
pub fn ser_create_fleet_metric_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFleetMetricInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
