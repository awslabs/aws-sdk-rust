...
pub fn ser_create_thing_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateThingTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
