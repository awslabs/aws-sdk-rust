...
pub fn ser_start_detect_mitigation_actions_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartDetectMitigationActionsTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
