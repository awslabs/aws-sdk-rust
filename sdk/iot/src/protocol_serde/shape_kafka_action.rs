...
pub(crate) fn de_kafka_action<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::KafkaAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "clientProperties" => {
                            builder = builder.set_client_properties(crate::protocol_serde::shape_client_properties::de_client_properties(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "headers" => {
                            builder = builder.set_headers(crate::protocol_serde::shape_kafka_headers::de_kafka_headers(tokens, _value, depth + 1)?);
                        }
