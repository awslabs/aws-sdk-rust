            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "clientProperties" => {
                            builder =
                                builder.set_client_properties(crate::protocol_serde::shape_client_properties::de_client_properties(tokens, _value)?);
                        }
                        "headers" => {
                            builder = builder.set_headers(crate::protocol_serde::shape_kafka_headers::de_kafka_headers(tokens, _value)?);
                        }
