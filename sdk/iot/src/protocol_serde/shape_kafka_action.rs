...
pub(crate) fn de_kafka_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::KafkaAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "headers" => {
                                builder = builder.set_headers(
                                    crate::protocol_serde::shape_kafka_headers::de_kafka_headers(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::kafka_action_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
