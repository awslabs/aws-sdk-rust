...
pub(crate) fn de_ca_certificate_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CaCertificateDescription>, aws_smithy_json::deserialize::error::DeserializeError>
