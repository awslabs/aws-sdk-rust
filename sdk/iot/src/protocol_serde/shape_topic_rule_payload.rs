...
pub fn ser_topic_rule_payload(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TopicRulePayload) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
