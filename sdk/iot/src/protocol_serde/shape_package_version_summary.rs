...
pub(crate) fn de_package_version_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PackageVersionSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
