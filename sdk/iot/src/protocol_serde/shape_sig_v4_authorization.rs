...
pub(crate) fn de_sig_v4_authorization<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SigV4Authorization>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_sig_v4_authorization(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SigV4Authorization) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
