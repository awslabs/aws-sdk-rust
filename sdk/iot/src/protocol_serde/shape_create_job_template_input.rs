...
pub fn ser_create_job_template_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_job_template::CreateJobTemplateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_13 in var_11 {
             {
                ...
                crate::protocol_serde::shape_maintenance_window::ser_maintenance_window(&mut object_14, item_13)?;
                object_14.finish();
            }
        }
        array_12.finish();
    ...
    if let Some(var_15) = &input.presigned_url_config {
        ...
        crate::protocol_serde::shape_presigned_url_config::ser_presigned_url_config(&mut object_16, var_15)?;
        object_16.finish();
    }
