...
impl super::Client {
    ...
    ///   - [`task_id(impl ::std::convert::Into<String>)`](crate::operation::describe_thing_registration_task::builders::DescribeThingRegistrationTaskFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::describe_thing_registration_task::builders::DescribeThingRegistrationTaskFluentBuilder::set_task_id): <p>The task ID.</p>
