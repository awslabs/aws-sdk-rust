...
impl super::Client {
    ...
    ///   - [`thing_name(impl Into<String>)`](crate::operation::list_detect_mitigation_actions_executions::builders::ListDetectMitigationActionsExecutionsFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::list_detect_mitigation_actions_executions::builders::ListDetectMitigationActionsExecutionsFluentBuilder::set_thing_name): <p> The name of the thing whose mitigation actions are listed. </p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_detect_mitigation_actions_executions::builders::ListDetectMitigationActionsExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_detect_mitigation_actions_executions::builders::ListDetectMitigationActionsExecutionsFluentBuilder::set_next_token): <p> The token for the next set of results. </p>
