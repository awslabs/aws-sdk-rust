...
impl super::Client {
    ...
    ///   - [`thing_group_name(impl Into<String>)`](crate::operation::delete_thing_group::builders::DeleteThingGroupFluentBuilder::thing_group_name) / [`set_thing_group_name(Option<String>)`](crate::operation::delete_thing_group::builders::DeleteThingGroupFluentBuilder::set_thing_group_name):<br>required: **true**<br><p>The name of the thing group to delete.</p><br>
    ///   - [`expected_version(i64)`](crate::operation::delete_thing_group::builders::DeleteThingGroupFluentBuilder::expected_version) / [`set_expected_version(Option<i64>)`](crate::operation::delete_thing_group::builders::DeleteThingGroupFluentBuilder::set_expected_version):<br>required: **false**<br><p>The expected version of the thing group to delete.</p><br>
