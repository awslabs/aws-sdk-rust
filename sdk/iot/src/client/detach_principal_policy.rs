...
impl super::Client {
    ...
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::detach_principal_policy::builders::DetachPrincipalPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::detach_principal_policy::builders::DetachPrincipalPolicyFluentBuilder::set_policy_name): <p>The name of the policy to detach.</p>
    ///   - [`principal(impl ::std::convert::Into<String>)`](crate::operation::detach_principal_policy::builders::DetachPrincipalPolicyFluentBuilder::principal) / [`set_principal(Option<String>)`](crate::operation::detach_principal_policy::builders::DetachPrincipalPolicyFluentBuilder::set_principal): <p>The principal.</p>  <p>Valid principals are CertificateArn (arn:aws:iot:<i>region</i>:<i>accountId</i>:cert/<i>certificateId</i>), thingGroupArn (arn:aws:iot:<i>region</i>:<i>accountId</i>:thinggroup/<i>groupName</i>) and CognitoId (<i>region</i>:<i>id</i>).</p>
