...
impl super::Client {
    ...
    ///   - [`index_name(impl Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::index_name) / [`set_index_name(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_index_name):<br>required: **false**<br><p>The name of the index to search.</p><br>
    ...
    ///   - [`aggregation_field(impl Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::aggregation_field) / [`set_aggregation_field(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_aggregation_field):<br>required: **true**<br><p>The aggregation field.</p><br>
    ///   - [`query_version(impl Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::query_version) / [`set_query_version(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_query_version):<br>required: **false**<br><p>The version of the query.</p><br>
