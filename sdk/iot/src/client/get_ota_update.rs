...
impl super::Client {
    ...
    ///   - [`ota_update_id(impl Into<String>)`](crate::operation::get_ota_update::builders::GetOTAUpdateFluentBuilder::ota_update_id) / [`set_ota_update_id(Option<String>)`](crate::operation::get_ota_update::builders::GetOTAUpdateFluentBuilder::set_ota_update_id):<br>required: **true**<br><p>The OTA update ID.</p><br>
