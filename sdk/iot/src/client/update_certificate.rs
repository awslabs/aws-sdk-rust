...
impl super::Client {
    ...
    ///   - [`certificate_id(impl ::std::convert::Into<String>)`](crate::operation::update_certificate::builders::UpdateCertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::update_certificate::builders::UpdateCertificateFluentBuilder::set_certificate_id): <p>The ID of the certificate. (The last part of the certificate ARN contains the certificate ID.)</p>
