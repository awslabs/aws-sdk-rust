...
impl super::Client {
    ...
    ///   - [`query_version(impl ::std::convert::Into<String>)`](crate::operation::search_index::builders::SearchIndexFluentBuilder::query_version) / [`set_query_version(Option<String>)`](crate::operation::search_index::builders::SearchIndexFluentBuilder::set_query_version): <p>The query version.</p>
