...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::search_index::builders::SearchIndexFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::search_index::builders::SearchIndexFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return at one time. The response might contain fewer results but will never contain more.</p><br>
