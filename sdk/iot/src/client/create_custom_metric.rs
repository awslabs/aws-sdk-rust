...
impl super::Client {
    ...
    ///   - [`metric_name(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_metric_name): <p> The name of the custom metric. This will be used in the metric report submitted from the device/thing. The name can't begin with <code>aws:</code>. You can't change the name after you define it.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_display_name): <p> The friendly name in the console for the custom metric. This name doesn't have to be unique. Don't use this name as the metric identifier in the device metric report. You can update the friendly name after you define it.</p>
    ///   - [`metric_type(CustomMetricType)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::metric_type) / [`set_metric_type(Option<CustomMetricType>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_metric_type): <p> The type of the custom metric. </p> <important>   <p>The type <code>number</code> only takes a single metric value as an input, but when you submit the metrics value in the DeviceMetrics report, you must pass it as an array with a single value.</p>  </important>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_tags): <p> Metadata that can be used to manage the custom metric. </p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_client_request_token): <p>Each custom metric must have a unique client request token. If you try to create a new custom metric that already exists with a different token, an exception occurs. If you omit this value, Amazon Web Services SDKs will automatically generate a unique client request. </p>
