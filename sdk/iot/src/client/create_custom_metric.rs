...
impl super::Client {
    ...
    ///   - [`metric_name(impl Into<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_metric_name): <p> The name of the custom metric. This will be used in the metric report submitted from the device/thing. The name can't begin with <code>aws:</code>. You can't change the name after you define it.</p>
    ...
    ///   - [`client_request_token(impl Into<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_custom_metric::builders::CreateCustomMetricFluentBuilder::set_client_request_token): <p>Each custom metric must have a unique client request token. If you try to create a new custom metric that already exists with a different token, an exception occurs. If you omit this value, Amazon Web Services SDKs will automatically generate a unique client request. </p>
