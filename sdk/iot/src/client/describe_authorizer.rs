...
impl super::Client {
    ...
    ///   - [`authorizer_name(impl ::std::convert::Into<String>)`](crate::operation::describe_authorizer::builders::DescribeAuthorizerFluentBuilder::authorizer_name) / [`set_authorizer_name(Option<String>)`](crate::operation::describe_authorizer::builders::DescribeAuthorizerFluentBuilder::set_authorizer_name): <p>The name of the authorizer to describe.</p>
    ...
    pub fn describe_authorizer(
        &self,
    ) -> crate::operation::describe_authorizer::builders::DescribeAuthorizerFluentBuilder {
        crate::operation::describe_authorizer::builders::DescribeAuthorizerFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
