...
impl super::Client {
    ...
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::attach_principal_policy::builders::AttachPrincipalPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::attach_principal_policy::builders::AttachPrincipalPolicyFluentBuilder::set_policy_name): <p>The policy name.</p>
    ///   - [`principal(impl ::std::convert::Into<String>)`](crate::operation::attach_principal_policy::builders::AttachPrincipalPolicyFluentBuilder::principal) / [`set_principal(Option<String>)`](crate::operation::attach_principal_policy::builders::AttachPrincipalPolicyFluentBuilder::set_principal): <p>The principal, which can be a certificate ARN (as returned from the CreateCertificate operation) or an Amazon Cognito ID.</p>
