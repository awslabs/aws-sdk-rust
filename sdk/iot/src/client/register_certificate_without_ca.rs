...
impl super::Client {
    ...
    ///   - [`certificate_pem(impl ::std::convert::Into<String>)`](crate::operation::register_certificate_without_ca::builders::RegisterCertificateWithoutCAFluentBuilder::certificate_pem) / [`set_certificate_pem(Option<String>)`](crate::operation::register_certificate_without_ca::builders::RegisterCertificateWithoutCAFluentBuilder::set_certificate_pem): <p>The certificate data, in PEM format.</p>
