...
impl super::Client {
    ...
    ///   - [`package_name(impl ::std::convert::Into<String>)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::package_name) / [`set_package_name(Option<String>)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::set_package_name): <p>The name of the target package.</p>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::set_max_results): <p>The maximum number of results to return at one time.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_package_versions::builders::ListPackageVersionsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
