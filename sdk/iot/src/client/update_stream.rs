...
impl super::Client {
    ...
    ///   - [`stream_id(impl ::std::convert::Into<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::stream_id) / [`set_stream_id(Option<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::set_stream_id): <p>The stream ID.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::set_description): <p>The description of the stream.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_stream::builders::UpdateStreamFluentBuilder::set_role_arn): <p>An IAM role that allows the IoT service principal assumes to access your S3 files.</p>
