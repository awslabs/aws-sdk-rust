...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::delete_dimension::builders::DeleteDimensionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_dimension::builders::DeleteDimensionFluentBuilder::set_name):<br>required: **true**<br><p>The unique identifier for the dimension that you want to delete.</p><br>
