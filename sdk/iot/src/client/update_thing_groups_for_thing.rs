...
impl super::Client {
    ...
    ///   - [`thing_name(impl Into<String>)`](crate::operation::update_thing_groups_for_thing::builders::UpdateThingGroupsForThingFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::update_thing_groups_for_thing::builders::UpdateThingGroupsForThingFluentBuilder::set_thing_name):<br>required: **false**<br><p>The thing whose group memberships will be updated.</p><br>
    ///   - [`thing_groups_to_add(impl Into<String>)`](crate::operation::update_thing_groups_for_thing::builders::UpdateThingGroupsForThingFluentBuilder::thing_groups_to_add) / [`set_thing_groups_to_add(Option<Vec::<String>>)`](crate::operation::update_thing_groups_for_thing::builders::UpdateThingGroupsForThingFluentBuilder::set_thing_groups_to_add):<br>required: **false**<br><p>The groups to which the thing will be added.</p><br>
