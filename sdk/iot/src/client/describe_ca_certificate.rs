...
impl super::Client {
    ...
    ///   - [`certificate_id(impl Into<String>)`](crate::operation::describe_ca_certificate::builders::DescribeCACertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::describe_ca_certificate::builders::DescribeCACertificateFluentBuilder::set_certificate_id):<br>required: **true**<br><p>The CA certificate identifier.</p><br>
