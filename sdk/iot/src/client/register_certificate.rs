...
impl super::Client {
    ...
    ///   - [`certificate_pem(impl Into<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::certificate_pem) / [`set_certificate_pem(Option<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_certificate_pem):<br>required: **true**<br><p>The certificate data, in PEM format.</p><br>
    ///   - [`ca_certificate_pem(impl Into<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::ca_certificate_pem) / [`set_ca_certificate_pem(Option<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_ca_certificate_pem):<br>required: **false**<br><p>The CA certificate used to sign the device certificate being registered.</p><br>
    ///   - [`set_as_active(bool)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_as_active) / [`set_set_as_active(Option<bool>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_set_as_active):<br>required: **false**<br><p>A boolean value that specifies if the certificate is set to active.</p> <p>Valid values: <code>ACTIVE | INACTIVE</code></p><br>
    ///   - [`status(CertificateStatus)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::status) / [`set_status(Option<CertificateStatus>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_status):<br>required: **false**<br><p>The status of the register certificate request. Valid values that you can use include <code>ACTIVE</code>, <code>INACTIVE</code>, and <code>REVOKED</code>.</p><br>
