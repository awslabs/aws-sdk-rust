...
impl super::Client {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::set_thing_name): <p>The name of the thing whose active violations are listed.</p>
    ///   - [`security_profile_name(impl ::std::convert::Into<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::security_profile_name) / [`set_security_profile_name(Option<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::set_security_profile_name): <p>The name of the Device Defender security profile for which violations are listed.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_active_violations::builders::ListActiveViolationsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
