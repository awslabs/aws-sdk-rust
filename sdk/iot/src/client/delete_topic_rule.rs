...
impl super::Client {
    ...
    ///   - [`rule_name(impl Into<String>)`](crate::operation::delete_topic_rule::builders::DeleteTopicRuleFluentBuilder::rule_name) / [`set_rule_name(Option<String>)`](crate::operation::delete_topic_rule::builders::DeleteTopicRuleFluentBuilder::set_rule_name):<br>required: **true**<br><p>The name of the rule.</p><br>
