...
impl super::Client {
    ...
    ///   - [`principal(impl Into<String>)`](crate::operation::get_effective_policies::builders::GetEffectivePoliciesFluentBuilder::principal) / [`set_principal(Option<String>)`](crate::operation::get_effective_policies::builders::GetEffectivePoliciesFluentBuilder::set_principal):<br>required: **false**<br><p>The principal. Valid principals are CertificateArn (arn:aws:iot:<i>region</i>:<i>accountId</i>:cert/<i>certificateId</i>), thingGroupArn (arn:aws:iot:<i>region</i>:<i>accountId</i>:thinggroup/<i>groupName</i>) and CognitoId (<i>region</i>:<i>id</i>).</p><br>
