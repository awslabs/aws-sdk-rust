...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_mitigation_actions::builders::ListMitigationActionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_mitigation_actions::builders::ListMitigationActionsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
