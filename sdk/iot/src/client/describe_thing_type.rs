...
impl super::Client {
    ...
    ///   - [`thing_type_name(impl Into<String>)`](crate::operation::describe_thing_type::builders::DescribeThingTypeFluentBuilder::thing_type_name) / [`set_thing_type_name(Option<String>)`](crate::operation::describe_thing_type::builders::DescribeThingTypeFluentBuilder::set_thing_type_name):<br>required: **true**<br><p>The name of the thing type.</p><br>
