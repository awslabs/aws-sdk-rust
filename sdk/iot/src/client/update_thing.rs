...
impl super::Client {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::update_thing::builders::UpdateThingFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::update_thing::builders::UpdateThingFluentBuilder::set_thing_name): <p>The name of the thing to update.</p>  <p>You can't change a thing's name. To change a thing's name, you must create a new thing, give it the new name, and then delete the old thing.</p>
    ///   - [`thing_type_name(impl ::std::convert::Into<String>)`](crate::operation::update_thing::builders::UpdateThingFluentBuilder::thing_type_name) / [`set_thing_type_name(Option<String>)`](crate::operation::update_thing::builders::UpdateThingFluentBuilder::set_thing_type_name): <p>The name of the thing type.</p>
