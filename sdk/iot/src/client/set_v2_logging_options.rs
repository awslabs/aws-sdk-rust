...
impl super::Client {
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::set_v2_logging_options::builders::SetV2LoggingOptionsFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::set_v2_logging_options::builders::SetV2LoggingOptionsFluentBuilder::set_role_arn): <p>The ARN of the role that allows IoT to write to Cloudwatch logs.</p>
