...
impl super::Client {
    ...
    ///   - [`event_configurations(LogEventConfiguration)`](crate::operation::set_v2_logging_options::builders::SetV2LoggingOptionsFluentBuilder::event_configurations) / [`set_event_configurations(Option<Vec::<LogEventConfiguration>>)`](crate::operation::set_v2_logging_options::builders::SetV2LoggingOptionsFluentBuilder::set_event_configurations):<br>required: **false**<br><p>The list of event configurations that override account-level logging.</p><br>
