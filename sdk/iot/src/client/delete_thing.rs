...
impl super::Client {
    ...
    ///   - [`thing_name(impl Into<String>)`](crate::operation::delete_thing::builders::DeleteThingFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::delete_thing::builders::DeleteThingFluentBuilder::set_thing_name):<br>required: **true**<br><p>The name of the thing to delete.</p><br>
