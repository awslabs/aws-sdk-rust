...
impl super::Client {
    ...
    ///   - [`role_alias(impl Into<String>)`](crate::operation::delete_role_alias::builders::DeleteRoleAliasFluentBuilder::role_alias) / [`set_role_alias(Option<String>)`](crate::operation::delete_role_alias::builders::DeleteRoleAliasFluentBuilder::set_role_alias):<br>required: **true**<br><p>The role alias to delete.</p><br>
