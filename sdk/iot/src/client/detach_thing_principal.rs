...
impl super::Client {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::detach_thing_principal::builders::DetachThingPrincipalFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::detach_thing_principal::builders::DetachThingPrincipalFluentBuilder::set_thing_name): <p>The name of the thing.</p>
