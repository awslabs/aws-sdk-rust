...
impl super::Client {
    ...
    ///   - [`rule_name(impl Into<String>)`](crate::operation::get_topic_rule::builders::GetTopicRuleFluentBuilder::rule_name) / [`set_rule_name(Option<String>)`](crate::operation::get_topic_rule::builders::GetTopicRuleFluentBuilder::set_rule_name):<br>required: **true**<br><p>The name of the rule.</p><br>
