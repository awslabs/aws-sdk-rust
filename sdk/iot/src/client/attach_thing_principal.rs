...
impl super::Client {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::attach_thing_principal::builders::AttachThingPrincipalFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::attach_thing_principal::builders::AttachThingPrincipalFluentBuilder::set_thing_name): <p>The name of the thing.</p>
