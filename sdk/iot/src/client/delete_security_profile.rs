...
impl super::Client {
    ...
    ///   - [`security_profile_name(impl Into<String>)`](crate::operation::delete_security_profile::builders::DeleteSecurityProfileFluentBuilder::security_profile_name) / [`set_security_profile_name(Option<String>)`](crate::operation::delete_security_profile::builders::DeleteSecurityProfileFluentBuilder::set_security_profile_name):<br>required: **true**<br><p>The name of the security profile to be deleted.</p><br>
    ///   - [`expected_version(i64)`](crate::operation::delete_security_profile::builders::DeleteSecurityProfileFluentBuilder::expected_version) / [`set_expected_version(Option<i64>)`](crate::operation::delete_security_profile::builders::DeleteSecurityProfileFluentBuilder::set_expected_version):<br>required: **false**<br><p>The expected version of the security profile. A new version is generated whenever the security profile is updated. If you specify a value that is different from the actual version, a <code>VersionConflictException</code> is thrown.</p><br>
