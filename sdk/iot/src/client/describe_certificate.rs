...
impl super::Client {
    ...
    ///   - [`certificate_id(impl Into<String>)`](crate::operation::describe_certificate::builders::DescribeCertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::describe_certificate::builders::DescribeCertificateFluentBuilder::set_certificate_id):<br>required: **true**<br><p>The ID of the certificate. (The last part of the certificate ARN contains the certificate ID.)</p><br>
