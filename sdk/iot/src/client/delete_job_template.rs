...
impl super::Client {
    ...
    ///   - [`job_template_id(impl Into<String>)`](crate::operation::delete_job_template::builders::DeleteJobTemplateFluentBuilder::job_template_id) / [`set_job_template_id(Option<String>)`](crate::operation::delete_job_template::builders::DeleteJobTemplateFluentBuilder::set_job_template_id):<br>required: **true**<br><p>The unique identifier of the job template to delete.</p><br>
