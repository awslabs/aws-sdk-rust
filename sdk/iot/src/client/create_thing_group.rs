...
impl super::Client {
    ...
    ///   - [`thing_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::thing_group_name) / [`set_thing_group_name(Option<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::set_thing_group_name): <p>The thing group name to create.</p>
    ///   - [`parent_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::parent_group_name) / [`set_parent_group_name(Option<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::set_parent_group_name): <p>The name of the parent thing group.</p>
