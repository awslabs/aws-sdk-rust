...
impl super::Client {
    ...
    ///   - [`thing_group_name(impl Into<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::thing_group_name) / [`set_thing_group_name(Option<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::set_thing_group_name):<br>required: **true**<br><p>The thing group name to create.</p><br>
    ///   - [`parent_group_name(impl Into<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::parent_group_name) / [`set_parent_group_name(Option<String>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::set_parent_group_name):<br>required: **false**<br><p>The name of the parent thing group.</p><br>
    ...
    ///   - [`tags(Tag)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::tags) / [`set_tags(Option<Vec::<Tag>>)`](crate::operation::create_thing_group::builders::CreateThingGroupFluentBuilder::set_tags):<br>required: **false**<br><p>Metadata which can be used to manage the thing group.</p><br>
