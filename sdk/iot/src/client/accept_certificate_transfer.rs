...
impl super::Client {
    ...
    ///   - [`certificate_id(impl ::std::convert::Into<String>)`](crate::operation::accept_certificate_transfer::builders::AcceptCertificateTransferFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::accept_certificate_transfer::builders::AcceptCertificateTransferFluentBuilder::set_certificate_id): <p>The ID of the certificate. (The last part of the certificate ARN contains the certificate ID.)</p>
