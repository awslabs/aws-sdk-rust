...
impl super::Client {
    ...
    ///   - [`rule_name(impl ::std::convert::Into<String>)`](crate::operation::create_topic_rule::builders::CreateTopicRuleFluentBuilder::rule_name) / [`set_rule_name(Option<String>)`](crate::operation::create_topic_rule::builders::CreateTopicRuleFluentBuilder::set_rule_name): <p>The name of the rule.</p>
