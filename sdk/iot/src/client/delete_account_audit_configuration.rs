...
impl super::Client {
    ...
    ///   - [`delete_scheduled_audits(bool)`](crate::operation::delete_account_audit_configuration::builders::DeleteAccountAuditConfigurationFluentBuilder::delete_scheduled_audits) / [`set_delete_scheduled_audits(Option<bool>)`](crate::operation::delete_account_audit_configuration::builders::DeleteAccountAuditConfigurationFluentBuilder::set_delete_scheduled_audits):<br>required: **false**<br><p>If true, all scheduled audits are deleted.</p><br>
