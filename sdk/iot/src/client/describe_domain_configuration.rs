...
impl super::Client {
    ...
    ///   - [`domain_configuration_name(impl ::std::convert::Into<String>)`](crate::operation::describe_domain_configuration::builders::DescribeDomainConfigurationFluentBuilder::domain_configuration_name) / [`set_domain_configuration_name(Option<String>)`](crate::operation::describe_domain_configuration::builders::DescribeDomainConfigurationFluentBuilder::set_domain_configuration_name): <p>The name of the domain configuration.</p>
