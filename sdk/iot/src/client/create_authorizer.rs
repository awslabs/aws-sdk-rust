...
impl super::Client {
    ...
    ///   - [`authorizer_name(impl Into<String>)`](crate::operation::create_authorizer::builders::CreateAuthorizerFluentBuilder::authorizer_name) / [`set_authorizer_name(Option<String>)`](crate::operation::create_authorizer::builders::CreateAuthorizerFluentBuilder::set_authorizer_name): <p>The authorizer name.</p>
