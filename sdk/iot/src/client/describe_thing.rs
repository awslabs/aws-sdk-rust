...
impl super::Client {
    ...
    ///   - [`thing_name(impl Into<String>)`](crate::operation::describe_thing::builders::DescribeThingFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::describe_thing::builders::DescribeThingFluentBuilder::set_thing_name):<br>required: **true**<br><p>The name of the thing.</p><br>
