...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::set_tags): <p>Metadata which can be used to manage the role alias.</p> <note>   <p>For URI Request parameters use format: ...key1=value1&amp;key2=value2...</p>   <p>For the CLI command-line parameter use format: &amp;&amp;tags "key1=value1&amp;key2=value2..."</p>   <p>For the cli-input-json file use format: "tags": "key1=value1&amp;key2=value2..."</p>  </note>
