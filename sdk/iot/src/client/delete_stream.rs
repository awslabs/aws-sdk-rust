...
impl super::Client {
    ...
    ///   - [`stream_id(impl Into<String>)`](crate::operation::delete_stream::builders::DeleteStreamFluentBuilder::stream_id) / [`set_stream_id(Option<String>)`](crate::operation::delete_stream::builders::DeleteStreamFluentBuilder::set_stream_id):<br>required: **true**<br><p>The stream ID.</p><br>
