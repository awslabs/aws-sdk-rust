...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_dimension::builders::DescribeDimensionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_dimension::builders::DescribeDimensionFluentBuilder::set_name): <p>The unique identifier for the dimension.</p>
