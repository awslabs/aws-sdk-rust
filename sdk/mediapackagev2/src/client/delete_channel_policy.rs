...
impl super::Client {
    ...
    ///   - [`channel_group_name(impl Into<String>)`](crate::operation::delete_channel_policy::builders::DeleteChannelPolicyFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::delete_channel_policy::builders::DeleteChannelPolicyFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ///   - [`channel_name(impl Into<String>)`](crate::operation::delete_channel_policy::builders::DeleteChannelPolicyFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::delete_channel_policy::builders::DeleteChannelPolicyFluentBuilder::set_channel_name): <p>The name that describes the channel. The name is the primary identifier for the channel, and must be unique for your account in the AWS Region and channel group.</p>
