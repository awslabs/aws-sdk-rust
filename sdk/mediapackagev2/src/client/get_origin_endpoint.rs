...
impl super::Client {
    ...
    pub fn get_origin_endpoint(
        &self,
    ) -> crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder {
        crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
