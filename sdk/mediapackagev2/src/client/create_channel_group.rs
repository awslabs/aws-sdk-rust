...
impl super::Client {
    ...
    ///   - [`channel_group_name(impl Into<String>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region. You can't use spaces in the name. You can't change the name after you create the channel group.</p>
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::set_client_token): <p>A unique, case-sensitive token that you provide to ensure the idempotency of the request.</p>
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_channel_group::builders::CreateChannelGroupFluentBuilder::set_tags): <p>A comma-separated list of tag key:value pairs that you define. For example:</p>  <p> <code>"Key1": "Value1",</code> </p>  <p> <code>"Key2": "Value2"</code> </p>
