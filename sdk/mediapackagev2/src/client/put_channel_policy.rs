...
impl super::Client {
    ...
    ///   - [`channel_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
