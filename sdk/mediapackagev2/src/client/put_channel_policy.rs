...
impl super::Client {
    ...
    ///   - [`channel_group_name(impl Into<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ...
    ///   - [`policy(impl Into<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::policy) / [`set_policy(Option<String>)`](crate::operation::put_channel_policy::builders::PutChannelPolicyFluentBuilder::set_policy): <p>The policy to attach to the specified channel.</p>
