...
impl super::Client {
    ...
    ///   - [`channel_group_name(impl Into<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ///   - [`channel_name(impl Into<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_channel_name): <p>The name that describes the channel. The name is the primary identifier for the channel, and must be unique for your account in the AWS Region and channel group. </p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_origin_endpoints::builders::ListOriginEndpointsFluentBuilder::set_next_token): <p>The pagination token from the GET list request. Use the token to fetch the next page of results.</p>
