...
impl super::Client {
    ...
    ///   - [`egress_domain(Option<String>)`](crate::operation::get_channel_group::GetChannelGroupOutput::egress_domain): <p>The output domain where the source stream should be sent. Integrate the domain with a downstream CDN (such as Amazon CloudFront) or playback device.</p>
    ///   - [`created_at(Option<DateTime>)`](crate::operation::get_channel_group::GetChannelGroupOutput::created_at): <p>The date and time the channel group was created.</p>
    ///   - [`modified_at(Option<DateTime>)`](crate::operation::get_channel_group::GetChannelGroupOutput::modified_at): <p>The date and time the channel group was modified.</p>
