...
impl super::Client {
    ...
    ///   - [`channel_name(impl Into<String>)`](crate::operation::delete_origin_endpoint_policy::builders::DeleteOriginEndpointPolicyFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::delete_origin_endpoint_policy::builders::DeleteOriginEndpointPolicyFluentBuilder::set_channel_name): <p>The name that describes the channel. The name is the primary identifier for the channel, and must be unique for your account in the AWS Region and channel group. </p>
