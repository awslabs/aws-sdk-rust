...
mod test {
    ...
    fn test_1() {
        ...
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2-fips.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_2() {
        ...
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://mediapackagev2-fips.us-gov-east-1.amazonaws.com",
        );
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_3() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.us-gov-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-gov-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_4() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.us-gov-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-gov-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_5() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.cn-north-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_6() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://mediapackagev2-fips.cn-north-1.amazonaws.com.cn",
        );
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.cn-north-1.amazonaws.com.cn")
                .build()
        );
    }
    ...
    fn test_7() {
        ...
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.cn-north-1.api.amazonwebservices.com.cn")
                .build()
        );
    }
    ...
    fn test_8() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.cn-north-1.amazonaws.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.cn-north-1.amazonaws.com.cn")
                .build()
        );
    }
    ...
    fn test_10() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://mediapackagev2-fips.us-iso-east-1.c2s.ic.gov",
        );
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_12() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.us-iso-east-1.c2s.ic.gov");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-iso-east-1.c2s.ic.gov")
                .build()
        );
    }
    ...
    fn test_13() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2-fips.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_14() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2-fips.us-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_15() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint =
            endpoint.expect("Expected valid endpoint: https://mediapackagev2.us-east-1.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-east-1.api.aws")
                .build()
        );
    }
    ...
    fn test_16() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.us-east-1.amazonaws.com");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-east-1.amazonaws.com")
                .build()
        );
    }
    ...
    fn test_18() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect(
            "Expected valid endpoint: https://mediapackagev2-fips.us-isob-east-1.sc2s.sgov.gov",
        );
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2-fips.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
    ...
    fn test_20() {
        ...
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint
            .expect("Expected valid endpoint: https://mediapackagev2.us-isob-east-1.sc2s.sgov.gov");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://mediapackagev2.us-isob-east-1.sc2s.sgov.gov")
                .build()
        );
    }
