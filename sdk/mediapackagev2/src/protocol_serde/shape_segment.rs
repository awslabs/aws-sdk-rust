...
pub(crate) fn de_segment<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Segment>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "TsUseAudioRenditionGroup" => {
                                builder = builder.set_ts_use_audio_rendition_group(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "IncludeIframeOnlyStreams" => {
                                builder = builder.set_include_iframe_only_streams(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "TsIncludeDvbSubtitles" => {
                                builder = builder.set_ts_include_dvb_subtitles(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "Scte" => {
                                builder = builder.set_scte(
                                    crate::protocol_serde::shape_scte::de_scte(tokens)?
                                );
                            }
                            "Encryption" => {
...
pub fn ser_segment(
    ...
    if let Some(var_1) = &input.segment_duration_seconds {
        object.key("SegmentDurationSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
