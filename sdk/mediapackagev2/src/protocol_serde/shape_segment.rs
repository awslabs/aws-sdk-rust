...
pub(crate) fn de_segment<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::Segment>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Scte" => {
                            builder = builder.set_scte(crate::protocol_serde::shape_scte::de_scte(tokens, _value, depth + 1)?);
                        }
                        "Encryption" => {
