...
pub fn ser_create_low_latency_hls_manifest_configuration(
    ...
    if let Some(var_4) = &input.manifest_window_seconds {
        object.key("ManifestWindowSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.program_date_time_interval_seconds {
        object.key("ProgramDateTimeIntervalSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
