...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_origin_endpoint_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_origin_endpoint::de_update_origin_endpoint(_response_body, output)
            .map_err(crate::operation::update_origin_endpoint::UpdateOriginEndpointError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::update_origin_endpoint_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_origin_endpoint::UpdateOriginEndpointError::unhandled)?
    })
}
