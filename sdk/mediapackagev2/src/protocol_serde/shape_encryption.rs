                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "EncryptionMethod" => {
                                builder = builder.set_encryption_method(
                                    crate::protocol_serde::shape_encryption_method::de_encryption_method(tokens)?
                                );
                            }
...
pub fn ser_encryption(
    ...
    if let Some(var_4) = &input.key_rotation_interval_seconds {
        object.key("KeyRotationIntervalSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
