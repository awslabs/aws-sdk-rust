...
pub(crate) fn de_speke_key_provider<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SpekeKeyProvider>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DrmSystems" => {
                                builder = builder.set_drm_systems(
                                    crate::protocol_serde::shape_drm_systems::de_drm_systems(tokens)?
                                );
                            }
                            "RoleArn" => {
            ...
            Ok(Some(crate::serde_util::speke_key_provider_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
