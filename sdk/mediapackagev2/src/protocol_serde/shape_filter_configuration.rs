...
pub fn ser_filter_configuration(
    ...
    if let Some(var_2) = &input.start {
        object.key("Start").date_time(var_2, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_4) = &input.time_delay_seconds {
        object.key("TimeDelaySeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    Ok(())
}

pub(crate) fn de_filter_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FilterConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
