...
impl GetLowLatencyHlsManifestConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::GetLowLatencyHlsManifestConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::GetLowLatencyHlsManifestConfiguration {
                manifest_name: self.manifest_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("manifest_name", "manifest_name was not specified but it is required when building GetLowLatencyHlsManifestConfiguration")
                    )?
                ,
                url: self.url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("url", "url was not specified but it is required when building GetLowLatencyHlsManifestConfiguration")
                    )?
                ,
