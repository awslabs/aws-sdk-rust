...
impl DeleteChannelPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteChannelPolicy`](crate::operation::delete_channel_policy::DeleteChannelPolicy)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_channel_policy::DeleteChannelPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_channel_policy::DeleteChannelPolicy::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteChannelPolicy", "mediapackagev2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteChannelPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_channel_policy::de_delete_channel_policy_http_response_with_props(status, headers, body)
        }
    }
}
