...
impl PutOriginEndpointPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_origin_endpoint_policy::PutOriginEndpointPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_origin_endpoint_policy::PutOriginEndpointPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_origin_endpoint_policy::PutOriginEndpointPolicyOutput, crate::operation::put_origin_endpoint_policy::PutOriginEndpointPolicyError, Self> {
