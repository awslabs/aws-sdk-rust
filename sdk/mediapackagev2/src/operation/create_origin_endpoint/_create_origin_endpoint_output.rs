...
impl CreateOriginEndpointOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_origin_endpoint::CreateOriginEndpointOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_origin_endpoint::CreateOriginEndpointOutput {
                arn: self.arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("arn", "arn was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                channel_group_name: self.channel_group_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("channel_group_name", "channel_group_name was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                channel_name: self.channel_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("channel_name", "channel_name was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                origin_endpoint_name: self.origin_endpoint_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("origin_endpoint_name", "origin_endpoint_name was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                container_type: self.container_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("container_type", "container_type was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                ...
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
                modified_at: self.modified_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("modified_at", "modified_at was not specified but it is required when building CreateOriginEndpointOutput")
                    )?
                ,
