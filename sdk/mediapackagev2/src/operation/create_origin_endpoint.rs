...
impl CreateOriginEndpointInput {
    /// Consumes the builder and constructs an Operation<[`CreateOriginEndpoint`](crate::operation::create_origin_endpoint::CreateOriginEndpoint)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_origin_endpoint::CreateOriginEndpoint::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateOriginEndpoint", "mediapackagev2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOriginEndpoint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_origin_endpoint::de_create_origin_endpoint_http_response_with_props(status, headers, body)
        }
    }
}
