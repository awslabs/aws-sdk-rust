...
impl GetOriginEndpointPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
