...
pub struct GetOriginEndpointPolicyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_origin_endpoint_policy::builders::GetOriginEndpointPolicyInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyOutput,
                    crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyError,
                > for GetOriginEndpointPolicyFluentBuilder
            {
                fn send(
                    self,
...
impl GetOriginEndpointPolicyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::get_origin_endpoint_policy::builders::GetOriginEndpointPolicyInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicy::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicy::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyOutput, crate::operation::get_origin_endpoint_policy::GetOriginEndpointPolicyError, Self> {
