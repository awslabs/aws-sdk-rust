...
impl GetOriginEndpointFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_origin_endpoint::GetOriginEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_origin_endpoint::GetOriginEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_origin_endpoint::GetOriginEndpointOutput, crate::operation::get_origin_endpoint::GetOriginEndpointError, Self> {
