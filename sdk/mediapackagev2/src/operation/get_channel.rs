...
impl GetChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetChannel`](crate::operation::get_channel::GetChannel)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_channel::GetChannel, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_channel::GetChannel::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetChannel", "mediapackagev2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChannel {
    type Output = ::std::result::Result<crate::operation::get_channel::GetChannelOutput, crate::operation::get_channel::GetChannelError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_channel::de_get_channel_http_response_with_props(status, headers, body)
        }
    }
}
