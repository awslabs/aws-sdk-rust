...
impl GetChannelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_channel::GetChannel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_channel::de_get_channel_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_channel::de_get_channel_http_response_with_props(
                status, headers, body,
            )
        }
    }
