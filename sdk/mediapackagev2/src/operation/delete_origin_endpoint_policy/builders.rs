...
impl crate::operation::delete_origin_endpoint_policy::builders::DeleteOriginEndpointPolicyInputBuilder {
...
impl DeleteOriginEndpointPolicyFluentBuilder {
    /// Creates a new `DeleteOriginEndpointPolicyFluentBuilder`.
