...
impl DeleteOriginEndpointPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_origin_endpoint_policy::DeleteOriginEndpointPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
