...
impl ListOriginEndpointsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_origin_endpoints::ListOriginEndpoints::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOriginEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_origin_endpoints::de_list_origin_endpoints_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_origin_endpoints::ListOriginEndpointsError
{
