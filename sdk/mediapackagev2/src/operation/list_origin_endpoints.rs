...
impl ListOriginEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`ListOriginEndpoints`](crate::operation::list_origin_endpoints::ListOriginEndpoints)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_origin_endpoints::ListOriginEndpoints,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_origin_endpoints::ListOriginEndpoints::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListOriginEndpoints", "mediapackagev2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOriginEndpoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_origin_endpoints::de_list_origin_endpoints_http_response_with_props(status, headers, body)
        }
    }
}
