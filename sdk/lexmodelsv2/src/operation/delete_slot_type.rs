...
impl DeleteSlotTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_slot_type::DeleteSlotType, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSlotType {
    type Output =
        ::std::result::Result<crate::operation::delete_slot_type::DeleteSlotTypeOutput, crate::operation::delete_slot_type::DeleteSlotTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_slot_type::de_delete_slot_type_http_response_with_props(status, headers, body)
        }
    }
}
