...
impl ListSessionMetricsInput {
    /// Consumes the builder and constructs an Operation<[`ListSessionMetrics`](crate::operation::list_session_metrics::ListSessionMetrics)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_session_metrics::ListSessionMetrics,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_session_metrics::ser_list_session_metrics_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_session_metrics::ListSessionMetrics::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListSessionMetrics", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSessionMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_session_metrics::de_list_session_metrics_http_response_with_props(status, headers, body)
        }
    }
}
