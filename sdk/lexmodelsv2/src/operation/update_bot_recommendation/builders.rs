...
impl UpdateBotRecommendationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_bot_recommendation::UpdateBotRecommendationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_bot_recommendation::UpdateBotRecommendationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_bot_recommendation::UpdateBotRecommendationOutput, crate::operation::update_bot_recommendation::UpdateBotRecommendationError, Self> {
