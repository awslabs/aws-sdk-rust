    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{botId}/utterances", botId = bot_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_utterances::DeleteUtterances::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_utterances::DeleteUtterancesError
{
