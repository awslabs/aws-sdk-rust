...
impl CreateSlotTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_slot_type::CreateSlotType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_slot_type::ser_create_slot_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSlotType {
    type Output =
        ::std::result::Result<crate::operation::create_slot_type::CreateSlotTypeOutput, crate::operation::create_slot_type::CreateSlotTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_slot_type::de_create_slot_type_http_response_with_props(status, headers, body)
        }
    }
}
