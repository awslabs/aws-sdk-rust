...
impl ListUtteranceAnalyticsDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsDataInput, ::aws_smithy_types::error::operation::BuildError> {
