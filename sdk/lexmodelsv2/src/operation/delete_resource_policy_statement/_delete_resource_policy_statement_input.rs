...
impl DeleteResourcePolicyStatementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_resource_policy_statement::DeleteResourcePolicyStatementInput, ::aws_smithy_types::error::operation::BuildError> {
