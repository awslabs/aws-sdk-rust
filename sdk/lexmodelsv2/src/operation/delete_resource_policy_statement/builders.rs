...
impl DeleteResourcePolicyStatementFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_resource_policy_statement::DeleteResourcePolicyStatementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_resource_policy_statement::DeleteResourcePolicyStatementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_resource_policy_statement::DeleteResourcePolicyStatementOutput, crate::operation::delete_resource_policy_statement::DeleteResourcePolicyStatementError, Self> {
