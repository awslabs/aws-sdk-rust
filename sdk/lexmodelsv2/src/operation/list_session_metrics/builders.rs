...
pub use crate::operation::list_session_metrics::_list_session_metrics_output::ListSessionMetricsOutputBuilder;

pub use crate::operation::list_session_metrics::_list_session_metrics_input::ListSessionMetricsInputBuilder;
...
impl ListSessionMetricsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_session_metrics();
...
pub struct ListSessionMetricsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_session_metrics::builders::ListSessionMetricsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_session_metrics::ListSessionMetricsOutput,
                    crate::operation::list_session_metrics::ListSessionMetricsError,
                > for ListSessionMetricsFluentBuilder
            {
                fn send(
                    self,
...
impl ListSessionMetricsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_session_metrics::builders::ListSessionMetricsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_session_metrics::ListSessionMetricsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_session_metrics::ListSessionMetricsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_session_metrics::ListSessionMetrics::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_session_metrics::ListSessionMetrics::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_session_metrics::ListSessionMetricsOutput, crate::operation::list_session_metrics::ListSessionMetricsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_session_metrics::paginator::ListSessionMetricsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_session_metrics::paginator::ListSessionMetricsPaginator {
                                crate::operation::list_session_metrics::paginator::ListSessionMetricsPaginator::new(self.handle, self.inner)
                            }
