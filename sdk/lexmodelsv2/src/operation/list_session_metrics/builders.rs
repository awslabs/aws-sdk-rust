...
impl ListSessionMetricsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_session_metrics::paginator::ListSessionMetricsPaginator {
        crate::operation::list_session_metrics::paginator::ListSessionMetricsPaginator::new(
            self.handle,
            self.inner,
        )
    }
