...
impl ListIntentsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_intents::ListIntentsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
            crate::operation::list_intents::ListIntentsInput {
                bot_id: self.bot_id
                ,
