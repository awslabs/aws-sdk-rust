...
impl CreateBotInput {
    /// Consumes the builder and constructs an Operation<[`CreateBot`](crate::operation::create_bot::CreateBot)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_bot::CreateBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_bot::ser_create_bot_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_bot::CreateBot::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBot {
    type Output = ::std::result::Result<crate::operation::create_bot::CreateBotOutput, crate::operation::create_bot::CreateBotError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_bot::de_create_bot_http_response_with_props(status, headers, body)
        }
    }
}
