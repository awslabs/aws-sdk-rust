...
impl BatchCreateCustomVocabularyItem {
    ...
    > {
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_create_custom_vocabulary_item::BatchCreateCustomVocabularyItemOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchCreateCustomVocabularyItemResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchCreateCustomVocabularyItemRequestSerializer {
