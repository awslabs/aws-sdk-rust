...
impl crate::operation::list_slots::builders::ListSlotsInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::list_slots::ListSlotsOutput, crate::operation::list_slots::ListSlotsError>
    for ListSlotsFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::list_slots::ListSlotsOutput, crate::operation::list_slots::ListSlotsError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl ListSlotsFluentBuilder {
    /// Creates a new `ListSlotsFluentBuilder`.
