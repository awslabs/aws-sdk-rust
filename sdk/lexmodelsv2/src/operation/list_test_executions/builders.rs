...
pub use crate::operation::list_test_executions::_list_test_executions_output::ListTestExecutionsOutputBuilder;
...
pub struct ListTestExecutionsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_test_executions::builders::ListTestExecutionsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_test_executions::ListTestExecutionsOutput,
                    crate::operation::list_test_executions::ListTestExecutionsError,
                > for ListTestExecutionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListTestExecutionsFluentBuilder {
    /// Creates a new `ListTestExecutions`.
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_test_executions::ListTestExecutionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_test_executions::ListTestExecutionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_test_executions::ListTestExecutions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_test_executions::ListTestExecutionsOutput, crate::operation::list_test_executions::ListTestExecutionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_test_executions::paginator::ListTestExecutionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
