    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_session_analytics_data::ListSessionAnalyticsDataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_session_analytics_data::ListSessionAnalyticsDataOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListSessionAnalyticsDataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListSessionAnalyticsDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_session_analytics_data::ListSessionAnalyticsDataInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListSessionAnalyticsDataEndpointParamsInterceptor {
...
pub type ListSessionAnalyticsDataErrorKind = ListSessionAnalyticsDataError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListSessionAnalyticsDataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_session_analytics_data::ListSessionAnalyticsDataError {
...
impl ListSessionAnalyticsDataError {
    ...
    /// Creates the `ListSessionAnalyticsDataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
