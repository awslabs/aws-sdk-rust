...
impl ListSessionAnalyticsDataInput {
    /// Consumes the builder and constructs an Operation<[`ListSessionAnalyticsData`](crate::operation::list_session_analytics_data::ListSessionAnalyticsData)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_session_analytics_data::ser_list_session_analytics_data_input(&self)?,
        );
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_session_analytics_data::ListSessionAnalyticsData::new())
                .with_metadata(::aws_smithy_http::operation::Metadata::new("ListSessionAnalyticsData", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSessionAnalyticsData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_session_analytics_data::de_list_session_analytics_data_http_response_with_props(status, headers, body)
        }
    }
}
