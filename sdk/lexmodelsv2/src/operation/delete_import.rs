...
impl DeleteImportInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_import::DeleteImport,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_import::DeleteImport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_import::de_delete_import_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_import::de_delete_import_http_response_with_props(
                status, headers, body,
            )
        }
    }
