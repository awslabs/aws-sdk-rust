...
impl UpdateBotLocaleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_bot_locale::UpdateBotLocaleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_bot_locale::UpdateBotLocaleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_bot_locale::UpdateBotLocaleOutput, crate::operation::update_bot_locale::UpdateBotLocaleError, Self> {
