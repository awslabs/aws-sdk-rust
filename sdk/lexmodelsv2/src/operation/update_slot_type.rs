...
impl UpdateSlotTypeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_slot_type::UpdateSlotType, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_slot_type::ser_update_slot_type_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSlotType {
    type Output =
        ::std::result::Result<crate::operation::update_slot_type::UpdateSlotTypeOutput, crate::operation::update_slot_type::UpdateSlotTypeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_slot_type::de_update_slot_type_http_response_with_props(status, headers, body)
        }
    }
}
