    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{botId}/botversions", botId = bot_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_bot_version::CreateBotVersion::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_bot_version::CreateBotVersionError
{
