...
impl CreateIntentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_intent::CreateIntent, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_intent::ser_create_intent_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIntent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_intent::de_create_intent_http_response_with_props(status, headers, body)
        }
    }
}
