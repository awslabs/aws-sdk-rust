...
impl UpdateSlotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_slot::UpdateSlot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSlot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_slot::de_update_slot_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_slot::de_update_slot_http_response_with_props(
                status, headers, body,
            )
        }
    }
