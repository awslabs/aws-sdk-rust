...
impl UpdateBotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_bot::UpdateBot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_bot::ser_update_bot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_bot::de_update_bot_http_response_with_props(status, headers, body)
        }
    }
}
