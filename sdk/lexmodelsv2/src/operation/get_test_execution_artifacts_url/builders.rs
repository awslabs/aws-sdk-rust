...
pub use crate::operation::get_test_execution_artifacts_url::_get_test_execution_artifacts_url_output::GetTestExecutionArtifactsUrlOutputBuilder;
...
pub struct GetTestExecutionArtifactsUrlFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_test_execution_artifacts_url::builders::GetTestExecutionArtifactsUrlInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlOutput,
                    crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlError,
                > for GetTestExecutionArtifactsUrlFluentBuilder
            {
                fn send(
                    self,
...
impl GetTestExecutionArtifactsUrlFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrl::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrl::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlOutput, crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlError, Self> {
