...
impl SearchAssociatedTranscriptsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_associated_transcripts::SearchAssociatedTranscripts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchAssociatedTranscripts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_associated_transcripts::de_search_associated_transcripts_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for SearchAssociatedTranscriptsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::search_associated_transcripts::SearchAssociatedTranscriptsError
{
