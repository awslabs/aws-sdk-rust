...
impl DescribeIntentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_intent::DescribeIntent,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_intent::DescribeIntent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIntent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_intent::de_describe_intent_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_intent::de_describe_intent_http_response_with_props(status, headers, body)
        }
    }
}
