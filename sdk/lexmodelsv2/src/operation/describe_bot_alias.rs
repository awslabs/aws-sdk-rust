...
impl DescribeBotAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_bot_alias::DescribeBotAlias,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBotAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_bot_alias::de_describe_bot_alias_http_response_with_props(status, headers, body)
        }
    }
}
