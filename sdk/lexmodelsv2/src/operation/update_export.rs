    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/exports/{exportId}", exportId = export_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_export::UpdateExport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateExport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_update_export::de_update_export_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_export::de_update_export_http_response_with_props(
                status, headers, body,
            )
        }
    }
