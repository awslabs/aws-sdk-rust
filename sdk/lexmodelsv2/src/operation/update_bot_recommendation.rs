...
impl UpdateBotRecommendationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBotRecommendation`](crate::operation::update_bot_recommendation::UpdateBotRecommendation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_bot_recommendation::UpdateBotRecommendation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_bot_recommendation::UpdateBotRecommendation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateBotRecommendation {
                type Output = std::result::Result<crate::operation::update_bot_recommendation::UpdateBotRecommendationOutput, crate::operation::update_bot_recommendation::UpdateBotRecommendationError>;
