...
impl ListIntentPathsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_intent_paths::ser_list_intent_paths_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_intent_paths::ListIntentPaths::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIntentPaths {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_intent_paths::de_list_intent_paths_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_intent_paths::ListIntentPathsError
{
