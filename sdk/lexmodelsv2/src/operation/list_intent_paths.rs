...
impl ListIntentPaths {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_paths::ListIntentPathsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_paths::ListIntentPathsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("lexmodelsv2", "ListIntentPaths", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIntentPaths {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListIntentPaths", "lexmodelsv2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListIntentPaths")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListIntentPathsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListIntentPathsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListIntentPathsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_paths::ListIntentPathsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_intent_paths::ser_list_intent_paths_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListIntentPathsEndpointParamsInterceptor {
...
pub type ListIntentPathsErrorKind = ListIntentPathsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListIntentPathsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_intent_paths::ListIntentPathsError {
...
impl ListIntentPathsError {
    ...
    /// Creates the `ListIntentPathsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
