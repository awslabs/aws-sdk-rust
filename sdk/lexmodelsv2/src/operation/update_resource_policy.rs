...
impl UpdateResourcePolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateResourcePolicy`](crate::operation::update_resource_policy::UpdateResourcePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_resource_policy::UpdateResourcePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_resource_policy::UpdateResourcePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_resource_policy::UpdateResourcePolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_resource_policy::ser_update_resource_policy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_resource_policy::UpdateResourcePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateResourcePolicy {
                type Output = std::result::Result<crate::operation::update_resource_policy::UpdateResourcePolicyOutput, crate::operation::update_resource_policy::UpdateResourcePolicyError>;
