...
impl DeleteSlotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_slot::DeleteSlot,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_slot::DeleteSlot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSlot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_slot::de_delete_slot_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_slot::de_delete_slot_http_response_with_props(
                status, headers, body,
            )
        }
    }
