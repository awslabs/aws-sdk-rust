...
impl UpdateBotAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_bot_alias::UpdateBotAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_bot_alias::ser_update_bot_alias_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBotAlias {
    type Output =
        ::std::result::Result<crate::operation::update_bot_alias::UpdateBotAliasOutput, crate::operation::update_bot_alias::UpdateBotAliasError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_bot_alias::de_update_bot_alias_http_response_with_props(status, headers, body)
        }
    }
}
