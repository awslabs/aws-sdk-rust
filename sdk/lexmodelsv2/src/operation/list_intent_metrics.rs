...
impl ListIntentMetrics {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_metrics::ListIntentMetricsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_metrics::ListIntentMetricsOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("lexmodelsv2", "ListIntentMetrics", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListIntentMetrics {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListIntentMetrics", "lexmodelsv2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListIntentMetrics")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListIntentMetricsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListIntentMetricsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListIntentMetricsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_metrics::ListIntentMetricsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_intent_metrics::ListIntentMetricsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_intent_metrics::ser_list_intent_metrics_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListIntentMetricsEndpointParamsInterceptor {
...
pub type ListIntentMetricsErrorKind = ListIntentMetricsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListIntentMetricsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_intent_metrics::ListIntentMetricsError {
...
impl ListIntentMetricsError {
    ...
    /// Creates the `ListIntentMetricsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
