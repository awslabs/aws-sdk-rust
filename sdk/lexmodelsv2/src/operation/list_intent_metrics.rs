...
impl ListIntentMetricsInput {
    /// Consumes the builder and constructs an Operation<[`ListIntentMetrics`](crate::operation::list_intent_metrics::ListIntentMetrics)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_intent_metrics::ser_list_intent_metrics_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_intent_metrics::ListIntentMetrics::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIntentMetrics", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIntentMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_intent_metrics::de_list_intent_metrics_http_response_with_props(status, headers, body)
        }
    }
}
