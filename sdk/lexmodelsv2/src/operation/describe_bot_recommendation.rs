...
impl DescribeBotRecommendationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_bot_recommendation::DescribeBotRecommendation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBotRecommendation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_bot_recommendation::de_describe_bot_recommendation_http_response_with_props(status, headers, body)
        }
    }
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_bot_recommendation::DescribeBotRecommendationError
{
