    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListIntentStageMetricsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListIntentStageMetricsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_intent_stage_metrics::ListIntentStageMetricsInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListIntentStageMetricsEndpointParamsInterceptor {
...
pub type ListIntentStageMetricsErrorKind = ListIntentStageMetricsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListIntentStageMetricsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_intent_stage_metrics::ListIntentStageMetricsError {
...
impl ListIntentStageMetricsError {
    ...
    /// Creates the `ListIntentStageMetricsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
