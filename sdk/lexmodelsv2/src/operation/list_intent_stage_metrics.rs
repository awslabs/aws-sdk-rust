...
impl ListIntentStageMetricsInput {
    /// Consumes the builder and constructs an Operation<[`ListIntentStageMetrics`](crate::operation::list_intent_stage_metrics::ListIntentStageMetrics)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_intent_stage_metrics::ser_list_intent_stage_metrics_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_intent_stage_metrics::ListIntentStageMetrics::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIntentStageMetrics", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIntentStageMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_intent_stage_metrics::de_list_intent_stage_metrics_http_response_with_props(status, headers, body)
        }
    }
}
