    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{botId}/botaliases", botId = bot_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_bot_alias::CreateBotAlias::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBotAlias {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_create_bot_alias::de_create_bot_alias_http_error(
                status, headers, body,
            )
        } else {
