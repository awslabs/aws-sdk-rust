...
impl CreateBotLocaleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_bot_locale::CreateBotLocale, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_bot_locale::ser_create_bot_locale_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBotLocale {
    type Output =
        ::std::result::Result<crate::operation::create_bot_locale::CreateBotLocaleOutput, crate::operation::create_bot_locale::CreateBotLocaleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_bot_locale::de_create_bot_locale_http_response_with_props(status, headers, body)
        }
    }
}
