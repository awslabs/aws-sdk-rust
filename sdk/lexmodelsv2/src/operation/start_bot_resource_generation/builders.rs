...
impl StartBotResourceGenerationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_bot_resource_generation::StartBotResourceGenerationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_bot_resource_generation::StartBotResourceGenerationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_bot_resource_generation::StartBotResourceGenerationOutput, crate::operation::start_bot_resource_generation::StartBotResourceGenerationError, Self> {
