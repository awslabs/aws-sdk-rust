...
impl UpdateBotLocaleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBotLocale`](crate::operation::update_bot_locale::UpdateBotLocale)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_bot_locale::UpdateBotLocale, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_bot_locale::ser_update_bot_locale_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_bot_locale::UpdateBotLocale::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBotLocale {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_bot_locale::de_update_bot_locale_http_response_with_props(status, headers, body)
        }
    }
}
