...
impl ListBotAliasesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_bot_aliases::ListBotAliases, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_bot_aliases::ser_list_bot_aliases_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBotAliases {
    type Output =
        ::std::result::Result<crate::operation::list_bot_aliases::ListBotAliasesOutput, crate::operation::list_bot_aliases::ListBotAliasesError>;
