...
impl StopBotRecommendation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::stop_bot_recommendation::StopBotRecommendationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::stop_bot_recommendation::StopBotRecommendationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Lex Models V2.StopBotRecommendation",
            "rpc.service" = "Lex Models V2",
            "rpc.method" = "StopBotRecommendation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StopBotRecommendation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StopBotRecommendationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StopBotRecommendationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StopBotRecommendation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StopBotRecommendation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StopBotRecommendationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StopBotRecommendationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StopBotRecommendationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StopBotRecommendationInput>() else {
        ...
        if requested.should_capture("botRecommendationId") {
            if let ::std::option::Option::Some(value) = input.bot_recommendation_id.as_deref() {
                captured.insert("botRecommendationId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StopBotRecommendationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 202 || force_error {
            crate::protocol_serde::shape_stop_bot_recommendation::de_stop_bot_recommendation_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_stop_bot_recommendation::de_stop_bot_recommendation_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StopBotRecommendationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::stop_bot_recommendation::StopBotRecommendationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::stop_bot_recommendation::StopBotRecommendationInput,
                ...
                let input_4 = input_4.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("bot_recommendation_id", "cannot be empty or unset")
                })?;
