...
impl StartBotRecommendationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_bot_recommendation::StartBotRecommendationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_bot_recommendation::StartBotRecommendationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_bot_recommendation::StartBotRecommendationOutput, crate::operation::start_bot_recommendation::StartBotRecommendationError, Self> {
