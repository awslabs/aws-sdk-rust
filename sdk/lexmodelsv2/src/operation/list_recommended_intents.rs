...
impl ListRecommendedIntentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_recommended_intents::ListRecommendedIntents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecommendedIntents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recommended_intents::de_list_recommended_intents_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_recommended_intents::ListRecommendedIntentsError
{
