    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsDataError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsDataOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUtteranceAnalyticsData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListUtteranceAnalyticsData", "lexmodelsv2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListUtteranceAnalyticsData")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListUtteranceAnalyticsDataResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListUtteranceAnalyticsDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsDataInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListUtteranceAnalyticsDataEndpointParamsInterceptor {
...
pub type ListUtteranceAnalyticsDataErrorKind = ListUtteranceAnalyticsDataError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListUtteranceAnalyticsDataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsDataError {
...
impl ListUtteranceAnalyticsDataError {
    ...
    /// Creates the `ListUtteranceAnalyticsDataError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
