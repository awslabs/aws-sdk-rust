...
impl ListUtteranceAnalyticsDataInput {
    /// Consumes the builder and constructs an Operation<[`ListUtteranceAnalyticsData`](crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsData)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_utterance_analytics_data::ser_list_utterance_analytics_data_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_utterance_analytics_data::ListUtteranceAnalyticsData::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("ListUtteranceAnalyticsData", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUtteranceAnalyticsData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_utterance_analytics_data::de_list_utterance_analytics_data_http_response_with_props(
                status, headers, body,
            )
        }
    }
