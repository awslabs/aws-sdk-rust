...
impl DeleteBotAliasInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_bot_alias::DeleteBotAlias, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBotAlias {
    type Output =
        ::std::result::Result<crate::operation::delete_bot_alias::DeleteBotAliasOutput, crate::operation::delete_bot_alias::DeleteBotAliasError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_bot_alias::de_delete_bot_alias_http_response_with_props(status, headers, body)
        }
    }
}
