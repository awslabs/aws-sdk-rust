...
impl DescribeBotLocaleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_bot_locale::DescribeBotLocaleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_bot_locale::DescribeBotLocaleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_bot_locale::DescribeBotLocaleOutput, crate::operation::describe_bot_locale::DescribeBotLocaleError, Self> {
