...
impl ListImports {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Lex Models V2", "ListImports", input, runtime_plugins, stop_point).await
    }
