...
impl BatchUpdateCustomVocabularyItemInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_update_custom_vocabulary_item::BatchUpdateCustomVocabularyItem::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpdateCustomVocabularyItem {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_update_custom_vocabulary_item::de_batch_update_custom_vocabulary_item_http_response_with_props(
                status, headers, body,
            )
        }
    }
