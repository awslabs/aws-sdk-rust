...
impl DeleteCustomVocabularyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_custom_vocabulary::DeleteCustomVocabulary,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCustomVocabulary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_custom_vocabulary::de_delete_custom_vocabulary_http_response_with_props(status, headers, body)
        }
    }
}
