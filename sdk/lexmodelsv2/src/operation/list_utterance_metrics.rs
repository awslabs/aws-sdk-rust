...
impl ListUtteranceMetricsInput {
    /// Consumes the builder and constructs an Operation<[`ListUtteranceMetrics`](crate::operation::list_utterance_metrics::ListUtteranceMetrics)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_utterance_metrics::ListUtteranceMetrics::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListUtteranceMetrics", "lexmodelsv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUtteranceMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_utterance_metrics::de_list_utterance_metrics_http_response_with_props(status, headers, body)
        }
    }
}
