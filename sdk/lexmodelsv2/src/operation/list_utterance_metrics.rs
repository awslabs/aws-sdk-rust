...
impl ListUtteranceMetricsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_utterance_metrics::ser_list_utterance_metrics_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_utterance_metrics::ListUtteranceMetrics::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_utterance_metrics::ListUtteranceMetricsError
{
