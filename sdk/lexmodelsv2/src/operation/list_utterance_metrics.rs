    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_metrics::ListUtteranceMetricsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_metrics::ListUtteranceMetricsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListUtteranceMetricsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListUtteranceMetricsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_utterance_metrics::ListUtteranceMetricsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_utterance_metrics::ser_list_utterance_metrics_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListUtteranceMetricsEndpointParamsInterceptor {
...
pub type ListUtteranceMetricsErrorKind = ListUtteranceMetricsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListUtteranceMetricsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_utterance_metrics::ListUtteranceMetricsError {
...
impl ListUtteranceMetricsError {
    ...
    /// Creates the `ListUtteranceMetricsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
