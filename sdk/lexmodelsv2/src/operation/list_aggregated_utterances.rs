...
/// Orchestration and serialization glue logic for `ListAggregatedUtterances`.
...
impl ListAggregatedUtterances {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAggregatedUtterances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAggregatedUtterances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAggregatedUtterancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAggregatedUtterancesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAggregatedUtterances")
...
.with_interceptor(ListAggregatedUtterancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError>::new());
...
#[derive(Debug)]
            struct ListAggregatedUtterancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAggregatedUtterancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_aggregated_utterances::de_list_aggregated_utterances_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAggregatedUtterancesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAggregatedUtterancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_aggregated_utterances::ListAggregatedUtterancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/bots/{botId}/aggregatedutterances", botId = bot_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_aggregated_utterances::ser_list_aggregated_utterances_input(&input)?);
...
#[derive(Debug)]
            struct ListAggregatedUtterancesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAggregatedUtterancesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAggregatedUtterancesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAggregatedUtterancesInput>()
                        .ok_or("failed to downcast to ListAggregatedUtterancesInput")?;
...
pub enum ListAggregatedUtterancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAggregatedUtterancesError) for what information is available for the error.")]
...
impl ListAggregatedUtterancesError {
    /// Creates the `ListAggregatedUtterancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAggregatedUtterancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAggregatedUtterancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError {
...
mod _list_aggregated_utterances_output;
