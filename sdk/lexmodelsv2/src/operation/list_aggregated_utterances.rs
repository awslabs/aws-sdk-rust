    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/bots/{botId}/aggregatedutterances", botId = bot_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_aggregated_utterances::ListAggregatedUtterances::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_aggregated_utterances::ListAggregatedUtterancesError
{
