...
impl crate::operation::search_associated_transcripts::builders::SearchAssociatedTranscriptsInputBuilder {
...
impl SearchAssociatedTranscriptsFluentBuilder {
    /// Creates a new `SearchAssociatedTranscriptsFluentBuilder`.
