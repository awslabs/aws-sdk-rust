...
pub use crate::operation::list_utterance_metrics::_list_utterance_metrics_output::ListUtteranceMetricsOutputBuilder;
...
impl ListUtteranceMetricsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_utterance_metrics();
...
pub struct ListUtteranceMetricsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_utterance_metrics::builders::ListUtteranceMetricsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_utterance_metrics::ListUtteranceMetricsOutput,
                    crate::operation::list_utterance_metrics::ListUtteranceMetricsError,
                > for ListUtteranceMetricsFluentBuilder
            {
                fn send(
                    self,
...
impl ListUtteranceMetricsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_utterance_metrics::ListUtteranceMetricsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_utterance_metrics::ListUtteranceMetricsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_utterance_metrics::ListUtteranceMetrics::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_utterance_metrics::ListUtteranceMetrics::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_utterance_metrics::ListUtteranceMetricsOutput, crate::operation::list_utterance_metrics::ListUtteranceMetricsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_utterance_metrics::paginator::ListUtteranceMetricsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
