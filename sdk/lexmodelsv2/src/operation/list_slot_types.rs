...
impl ListSlotTypesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_slot_types::ListSlotTypes, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_slot_types::ser_list_slot_types_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSlotTypes {
    type Output =
        ::std::result::Result<crate::operation::list_slot_types::ListSlotTypesOutput, crate::operation::list_slot_types::ListSlotTypesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_slot_types::de_list_slot_types_http_response_with_props(status, headers, body)
        }
    }
}
