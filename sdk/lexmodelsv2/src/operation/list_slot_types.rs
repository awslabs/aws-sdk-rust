...
impl ListSlotTypesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_slot_types::ListSlotTypes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_slot_types::ListSlotTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSlotTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_slot_types::de_list_slot_types_http_error(
                status, headers, body,
            )
        } else {
