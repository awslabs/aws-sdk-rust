...
impl CreateBotInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_bot(&self).map_err(|err| {
...
impl CreateBotAliasInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_bot_alias(&self).map_err(
...
impl CreateBotLocaleInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_bot_locale(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl CreateExportInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_export(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl CreateIntentInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_intent(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl CreateResourcePolicyInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_resource_policy(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl CreateResourcePolicyStatementInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_resource_policy_statement(&self)
                    .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_13) = &self.expected_revision_id {
            query.push_kv(
                "expectedRevisionId",
...
impl CreateSlotInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_create_slot(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl CreateSlotTypeInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_slot_type(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl DeleteBotInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if self.skip_resource_in_use_check {
            query.push_kv(
                "skipResourceInUseCheck",
                &smithy_types::primitive::Encoder::from(self.skip_resource_in_use_check).encode(),
            );
        }
    }
    #[allow(clippy::unnecessary_wraps)]
...
impl DeleteBotAliasInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let input_23 = &self.bot_alias_id;
        let input_23 =
            input_23
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DeleteResourcePolicyInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_36) = &self.expected_revision_id {
            query.push_kv(
                "expectedRevisionId",
...
impl DeleteResourcePolicyStatementInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let input_38 = &self.statement_id;
        let input_38 =
            input_38
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_39) = &self.expected_revision_id {
            query.push_kv(
                "expectedRevisionId",
...
impl DeleteSlotTypeInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let input_48 = &self.slot_type_id;
        let input_48 =
            input_48
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
...
impl DescribeBotAliasInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_50, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let input_51 = &self.bot_alias_id;
        let input_51 =
            input_51
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let bot_alias_id = smithy_http::label::fmt_string(input_51, false);
        if bot_alias_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_alias_id",
                details: "cannot be empty or unset",
...
impl DescribeBotLocaleInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_version = smithy_http::label::fmt_string(input_53, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_54, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
...
impl DescribeExportInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let export_id = smithy_http::label::fmt_string(input_57, false);
        if export_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "export_id",
                details: "cannot be empty or unset",
...
impl DescribeImportInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let import_id = smithy_http::label::fmt_string(input_58, false);
        if import_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "import_id",
                details: "cannot be empty or unset",
...
impl DescribeIntentInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_59, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_60, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_61, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let intent_id = smithy_http::label::fmt_string(input_62, false);
        if intent_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "intent_id",
                details: "cannot be empty or unset",
...
impl DescribeResourcePolicyInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_63 = &self.resource_arn;
        let input_63 =
            input_63
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let resource_arn = smithy_http::label::fmt_string(input_63, false);
        if resource_arn.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "resource_arn",
                details: "cannot be empty or unset",
...
impl DescribeSlotInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_64, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_65, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_66, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let intent_id = smithy_http::label::fmt_string(input_67, false);
        if intent_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "intent_id",
                details: "cannot be empty or unset",
        ...
        let slot_id = smithy_http::label::fmt_string(input_68, false);
        if slot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "slot_id",
                details: "cannot be empty or unset",
...
impl DescribeSlotTypeInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_69, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_70, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_71, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let input_72 = &self.slot_type_id;
        let input_72 =
            input_72
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let slot_type_id = smithy_http::label::fmt_string(input_72, false);
        if slot_type_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "slot_type_id",
                details: "cannot be empty or unset",
...
impl ListBotAliasesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_bot_aliases(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_73, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
...
impl ListBotLocalesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_bot_locales(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_74, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_75, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
...
impl ListBotsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_list_bots(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl ListBotVersionsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_bot_versions(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl ListBuiltInIntentsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_built_in_intents(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let locale_id = smithy_http::label::fmt_string(input_77, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
...
impl ListBuiltInSlotTypesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_built_in_slot_types(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let locale_id = smithy_http::label::fmt_string(input_78, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
...
impl ListIntentsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_list_intents(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_79, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_80, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
...
impl ListSlotsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_list_slots(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_82, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_83, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_84, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let intent_id = smithy_http::label::fmt_string(input_85, false);
        if intent_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "intent_id",
                details: "cannot be empty or unset",
...
impl ListSlotTypesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_slot_types(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl UntagResourceInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_91 = &self.resource_arn;
        let input_91 =
            input_91
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let resource_arn = smithy_http::label::fmt_string(input_91, false);
        if resource_arn.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "resource_arn",
                details: "cannot be empty or unset",
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_92) = &self.tag_keys {
            for inner_93 in inner_92 {
                query.push_kv("tagKeys", &smithy_http::query::fmt_string(&inner_93));
            }
        }
    }
    #[allow(clippy::unnecessary_wraps)]
...
impl UpdateBotInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_bot(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_94, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
...
impl UpdateBotAliasInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_bot_alias(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_95, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let input_96 = &self.bot_alias_id;
        let input_96 =
            input_96
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let bot_alias_id = smithy_http::label::fmt_string(input_96, false);
        if bot_alias_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_alias_id",
                details: "cannot be empty or unset",
...
impl UpdateBotLocaleInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_bot_locale(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_97, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let bot_version = smithy_http::label::fmt_string(input_98, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_99, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
...
impl UpdateExportInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_export(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let export_id = smithy_http::label::fmt_string(input_100, false);
        if export_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "export_id",
                details: "cannot be empty or unset",
...
impl UpdateIntentInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_intent(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let input_102 = &self.bot_version;
        let input_102 =
            input_102
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let intent_id = smithy_http::label::fmt_string(input_104, false);
        if intent_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "intent_id",
                details: "cannot be empty or unset",
...
impl UpdateResourcePolicyInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_resource_policy(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_105 = &self.resource_arn;
        let input_105 =
            input_105
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_106) = &self.expected_revision_id {
            query.push_kv(
                "expectedRevisionId",
...
impl UpdateSlotInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_update_slot(&self).map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_107, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let input_108 = &self.bot_version;
        let input_108 =
            input_108
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let bot_version = smithy_http::label::fmt_string(input_108, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_109, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let intent_id = smithy_http::label::fmt_string(input_110, false);
        if intent_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "intent_id",
                details: "cannot be empty or unset",
        ...
        let slot_id = smithy_http::label::fmt_string(input_111, false);
        if slot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "slot_id",
                details: "cannot be empty or unset",
...
impl UpdateSlotTypeInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_slot_type(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let bot_id = smithy_http::label::fmt_string(input_112, false);
        if bot_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_id",
                details: "cannot be empty or unset",
        ...
        let input_113 = &self.bot_version;
        let input_113 =
            input_113
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let bot_version = smithy_http::label::fmt_string(input_113, false);
        if bot_version.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "bot_version",
                details: "cannot be empty or unset",
        ...
        let locale_id = smithy_http::label::fmt_string(input_114, false);
        if locale_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "locale_id",
                details: "cannot be empty or unset",
        ...
        let input_115 = &self.slot_type_id;
        let input_115 =
            input_115
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let slot_type_id = smithy_http::label::fmt_string(input_115, false);
        if slot_type_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "slot_type_id",
                details: "cannot be empty or unset",
