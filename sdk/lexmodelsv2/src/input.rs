    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StopBotRecommendation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::StopBotRecommendationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_118, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_119, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_120, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_recommendation_id = aws_smithy_http::label::fmt_string(input_121, false);
                if bot_recommendation_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_recommendation_id", details: "cannot be empty or unset" })
                            }
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::TagResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::TagResourceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let resource_arn = aws_smithy_http::label::fmt_string(input_122, false);
                if resource_arn.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "resource_arn", details: "cannot be empty or unset" })
                            }
                write!(output, "/tags/{resourceARN}", resourceARN = resource_arn).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UntagResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UntagResourceInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let resource_arn = aws_smithy_http::label::fmt_string(input_123, false);
                if resource_arn.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "resource_arn", details: "cannot be empty or unset" })
                            }
                write!(output, "/tags/{resourceARN}", resourceARN = resource_arn).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateBot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateBotInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_126, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}", botId = bot_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateBotAlias, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateBotAliasInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_alias_id = aws_smithy_http::label::fmt_string(input_128, false);
                if bot_alias_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_alias_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botaliases/{botAliasId}", botId = bot_id, botAliasId = bot_alias_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateBotLocale, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateBotLocaleInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_129, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_130, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_131, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}", botId = bot_id, botVersion = bot_version, localeId = locale_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateBotRecommendation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateBotRecommendationInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_132, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_133, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_134, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_recommendation_id = aws_smithy_http::label::fmt_string(input_135, false);
                if bot_recommendation_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_recommendation_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/botrecommendations/{botRecommendationId}", botId = bot_id, botVersion = bot_version, localeId = locale_id, botRecommendationId = bot_recommendation_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateExport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateExportInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let export_id = aws_smithy_http::label::fmt_string(input_136, false);
                if export_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "export_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/exports/{exportId}", exportId = export_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateIntent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateIntentInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_137, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_138, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_139, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                ...
                let intent_id = aws_smithy_http::label::fmt_string(input_140, false);
                if intent_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "intent_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}", botId = bot_id, botVersion = bot_version, localeId = locale_id, intentId = intent_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateResourcePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateResourcePolicyInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let resource_arn = aws_smithy_http::label::fmt_string(input_141, false);
                if resource_arn.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "resource_arn", details: "cannot be empty or unset" })
                            }
                write!(output, "/policy/{resourceArn}", resourceArn = resource_arn).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateSlot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateSlotInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_143, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_144, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_145, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                ...
                let intent_id = aws_smithy_http::label::fmt_string(input_146, false);
                if intent_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "intent_id", details: "cannot be empty or unset" })
                            }
                ...
                let slot_id = aws_smithy_http::label::fmt_string(input_147, false);
                if slot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "slot_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots/{slotId}", botId = bot_id, botVersion = bot_version, localeId = locale_id, intentId = intent_id, slotId = slot_id).expect("formatting should succeed");
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UpdateSlotType, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::UpdateSlotTypeInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let bot_id = aws_smithy_http::label::fmt_string(input_148, false);
                if bot_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_id", details: "cannot be empty or unset" })
                            }
                ...
                let bot_version = aws_smithy_http::label::fmt_string(input_149, false);
                if bot_version.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "bot_version", details: "cannot be empty or unset" })
                            }
                ...
                let locale_id = aws_smithy_http::label::fmt_string(input_150, false);
                if locale_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "locale_id", details: "cannot be empty or unset" })
                            }
                ...
                let slot_type_id = aws_smithy_http::label::fmt_string(input_151, false);
                if slot_type_id.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "slot_type_id", details: "cannot be empty or unset" })
                            }
                write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/slottypes/{slotTypeId}", botId = bot_id, botVersion = bot_version, localeId = locale_id, slotTypeId = slot_type_id).expect("formatting should succeed");
