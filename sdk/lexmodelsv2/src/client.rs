...
impl Client {
    ...
    pub fn batch_delete_custom_vocabulary_item(
        &self,
    ) -> crate::client::fluent_builders::BatchDeleteCustomVocabularyItem {
    ...
    pub fn batch_update_custom_vocabulary_item(
        &self,
    ) -> crate::client::fluent_builders::BatchUpdateCustomVocabularyItem {
    ...
    pub fn list_aggregated_utterances(
        &self,
    ) -> crate::client::fluent_builders::ListAggregatedUtterances {
    ...
    pub fn search_associated_transcripts(
        &self,
    ) -> crate::client::fluent_builders::SearchAssociatedTranscripts {
