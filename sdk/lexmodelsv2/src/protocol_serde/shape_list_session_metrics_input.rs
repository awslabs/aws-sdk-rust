...
pub fn ser_list_session_metrics_input_input(
        ...
        for item_8 in var_6 {
             {
                ...
                crate::protocol_serde::shape_analytics_session_filter::ser_analytics_session_filter(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
        ...
        for item_12 in var_10 {
             {
                ...
                crate::protocol_serde::shape_analytics_session_group_by_specification::ser_analytics_session_group_by_specification(&mut object_13, item_12)?;
                object_13.finish();
            }
        }
        array_11.finish();
        ...
        for item_17 in var_15 {
             {
                ...
                crate::protocol_serde::shape_analytics_session_metric::ser_analytics_session_metric(&mut object_18, item_17)?;
                object_18.finish();
            }
        }
        array_16.finish();
