...
pub(crate) fn de_fulfillment_updates_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FulfillmentUpdatesSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_fulfillment_updates_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FulfillmentUpdatesSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
