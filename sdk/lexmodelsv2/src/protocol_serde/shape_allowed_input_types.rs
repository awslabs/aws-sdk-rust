            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "allowAudioInput" => {
                            builder = builder.set_allow_audio_input(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "allowDTMFInput" => {
                            builder = builder.set_allow_dtmf_input(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
