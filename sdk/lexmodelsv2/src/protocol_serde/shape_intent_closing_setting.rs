...
pub(crate) fn de_intent_closing_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IntentClosingSetting>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_intent_closing_setting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IntentClosingSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
