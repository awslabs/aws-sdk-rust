                        ...
                        match key.to_unescaped()?.as_ref() {
                            "textLogSettings" => {
                                builder = builder.set_text_log_settings(
                                    crate::protocol_serde::shape_text_log_settings_list::de_text_log_settings_list(tokens, _value, depth + 1)?,
                                );
                            }
                            "audioLogSettings" => {
                                builder = builder.set_audio_log_settings(
                                    crate::protocol_serde::shape_audio_log_settings_list::de_audio_log_settings_list(tokens, _value, depth + 1)?,
                                );
                            }
