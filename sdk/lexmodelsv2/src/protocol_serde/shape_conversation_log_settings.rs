            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "textLogSettings" => {
                            builder = builder.set_text_log_settings(crate::protocol_serde::shape_text_log_settings_list::de_text_log_settings_list(
                                tokens, _value,
                            )?);
                        }
                        "audioLogSettings" => {
                            builder = builder.set_audio_log_settings(
                                crate::protocol_serde::shape_audio_log_settings_list::de_audio_log_settings_list(tokens, _value)?,
                            );
                        }
