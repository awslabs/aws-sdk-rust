...
pub(crate) fn de_intent_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IntentSummary>, aws_smithy_json::deserialize::error::DeserializeError>
