...
pub fn ser_bot_member(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::BotMember) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
