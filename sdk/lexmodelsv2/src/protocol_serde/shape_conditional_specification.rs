...
pub(crate) fn de_conditional_specification<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::ConditionalSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "conditionalBranches" => {
                            builder = builder.set_conditional_branches(crate::protocol_serde::shape_conditional_branches::de_conditional_branches(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "defaultBranch" => {
                            builder = builder.set_default_branch(
                                crate::protocol_serde::shape_default_conditional_branch::de_default_conditional_branch(tokens, _value, depth + 1)?,
                            );
                        }
