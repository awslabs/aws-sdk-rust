...
pub(crate) fn de_conditional_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConditionalSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_conditional_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConditionalSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
