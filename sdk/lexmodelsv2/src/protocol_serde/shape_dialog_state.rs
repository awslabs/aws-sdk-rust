...
pub(crate) fn de_dialog_state<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DialogState>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "intent" => {
                            builder = builder.set_intent(crate::protocol_serde::shape_intent_override::de_intent_override(tokens, _value)?);
                        }
                        "sessionAttributes" => {
