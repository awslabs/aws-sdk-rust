...
) -> ::std::result::Result<Option<crate::types::ElicitationCodeHookInvocationSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "enableCodeHookInvocation" => {
                            builder =
                                builder.set_enable_code_hook_invocation(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "invocationLabel" => {
