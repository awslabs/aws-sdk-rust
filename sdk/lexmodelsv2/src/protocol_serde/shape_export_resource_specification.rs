                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "botExportSpecification" => {
                            builder = builder.set_bot_export_specification(
                                crate::protocol_serde::shape_bot_export_specification::de_bot_export_specification(tokens, _value, depth + 1)?,
                            );
                        }
                        "botLocaleExportSpecification" => {
                            builder = builder.set_bot_locale_export_specification(
                                crate::protocol_serde::shape_bot_locale_export_specification::de_bot_locale_export_specification(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "testSetExportSpecification" => {
                            builder = builder.set_test_set_export_specification(
                                crate::protocol_serde::shape_test_set_export_specification::de_test_set_export_specification(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
