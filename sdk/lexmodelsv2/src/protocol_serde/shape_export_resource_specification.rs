...
pub(crate) fn de_export_resource_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ExportResourceSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_export_resource_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ExportResourceSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
