...
pub fn ser_conditional_branch(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConditionalBranch) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_conditional_branch<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConditionalBranch>, aws_smithy_json::deserialize::error::DeserializeError>
