...
pub(crate) fn de_grammar_slot_type_source<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::GrammarSlotTypeSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
