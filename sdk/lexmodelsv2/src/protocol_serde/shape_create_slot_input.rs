...
pub fn ser_create_slot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSlotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
