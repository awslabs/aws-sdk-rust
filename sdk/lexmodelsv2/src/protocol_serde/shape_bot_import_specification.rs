...
pub(crate) fn de_bot_import_specification<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::BotImportSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::bot_import_specification_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_bot_import_specification(
    ...
    if let Some(var_3) = &input.idle_session_ttl_in_seconds {
        object.key("idleSessionTTLInSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
