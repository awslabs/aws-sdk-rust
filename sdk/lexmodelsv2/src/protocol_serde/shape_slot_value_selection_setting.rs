...
pub(crate) fn de_slot_value_selection_setting<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::SlotValueSelectionSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "regexFilter" => {
                            builder = builder.set_regex_filter(crate::protocol_serde::shape_slot_value_regex_filter::de_slot_value_regex_filter(
                                tokens, _value,
                            )?);
                        }
                        "advancedRecognitionSetting" => {
                            builder = builder.set_advanced_recognition_setting(
                                crate::protocol_serde::shape_advanced_recognition_setting::de_advanced_recognition_setting(tokens, _value)?,
                            );
                        }
