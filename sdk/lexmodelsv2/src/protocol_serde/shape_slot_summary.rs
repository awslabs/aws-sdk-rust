...
pub(crate) fn de_slot_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SlotSummary>, aws_smithy_json::deserialize::error::DeserializeError>
