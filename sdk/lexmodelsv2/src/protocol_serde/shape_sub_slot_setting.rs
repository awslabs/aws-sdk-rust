...
pub(crate) fn de_sub_slot_setting<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::SubSlotSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "slotSpecifications" => {
                            builder = builder.set_slot_specifications(
                                crate::protocol_serde::shape_sub_slot_specification_map::de_sub_slot_specification_map(tokens, _value, depth + 1)?,
                            );
                        }
