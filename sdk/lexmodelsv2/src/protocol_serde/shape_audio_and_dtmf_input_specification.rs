...
pub fn ser_audio_and_dtmf_input_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AudioAndDtmfInputSpecification) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_audio_and_dtmf_input_specification<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AudioAndDtmfInputSpecification>, aws_smithy_json::deserialize::error::DeserializeError>
