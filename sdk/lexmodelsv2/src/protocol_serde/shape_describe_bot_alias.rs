...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::describe_bot_alias::DescribeBotAliasError::unhandled(generic),
            )
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_bot_alias_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_bot_alias::de_describe_bot_alias(
            _response_body,
            output,
        )
        .map_err(crate::operation::describe_bot_alias::DescribeBotAliasError::unhandled)?;
