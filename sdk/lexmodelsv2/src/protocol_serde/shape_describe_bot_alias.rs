                    ...
                    match crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::describe_bot_alias::DescribeBotAliasError::unhandled(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "botAliasHistoryEvents" => {
                    builder = builder.set_bot_alias_history_events(
                        crate::protocol_serde::shape_bot_alias_history_events_list::de_bot_alias_history_events_list(tokens, _value, depth + 1)?,
                    );
                }
                "botAliasId" => {
