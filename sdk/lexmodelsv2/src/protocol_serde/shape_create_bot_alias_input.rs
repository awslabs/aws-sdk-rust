...
pub fn ser_create_bot_alias_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBotAliasInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
