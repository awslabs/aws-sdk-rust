...
pub fn ser_list_bots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListBotsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
