...
pub fn ser_list_bots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_bots::ListBotsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_bot_filter::ser_bot_filter(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_7) = &input.sort_by {
        ...
        crate::protocol_serde::shape_bot_sort_by::ser_bot_sort_by(&mut object_8, var_7)?;
        object_8.finish();
    }
    Ok(())
}
