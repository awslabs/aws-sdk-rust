...
pub fn de_describe_intent_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_intent::DescribeIntentOutput, crate::operation::describe_intent::DescribeIntentError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_intent_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_intent::DescribeIntentOutput, crate::operation::describe_intent::DescribeIntentError> {
    Ok({
        #[allow(unused_mut)]
