...
pub fn de_create_intent_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_intent::CreateIntentOutput, crate::operation::create_intent::CreateIntentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::create_intent::CreateIntentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_intent_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::create_intent::CreateIntentOutput, crate::operation::create_intent::CreateIntentError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_intent::builders::CreateIntentOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_create_intent::de_create_intent(response.body().as_ref(), output).map_err(crate::operation::create_intent::CreateIntentError::unhandled)?;
