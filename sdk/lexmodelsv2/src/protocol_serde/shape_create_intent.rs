...
pub fn de_create_intent_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_intent::CreateIntentOutput, crate::operation::create_intent::CreateIntentError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_intent::CreateIntentError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
                output.build()
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_intent_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_intent::CreateIntentOutput, crate::operation::create_intent::CreateIntentError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_intent::de_create_intent(_response_body, output)
            .map_err(crate::operation::create_intent::CreateIntentError::unhandled)?;
...
) -> Result<crate::operation::create_intent::builders::CreateIntentOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
