...
pub(crate) fn de_bot_alias_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BotAliasSummary>, aws_smithy_json::deserialize::error::DeserializeError>
