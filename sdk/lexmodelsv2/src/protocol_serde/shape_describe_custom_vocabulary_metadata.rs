...
pub fn de_describe_custom_vocabulary_metadata_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeCustomVocabularyMetadataOutput, crate::error::DescribeCustomVocabularyMetadataError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeCustomVocabularyMetadataError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_custom_vocabulary_metadata_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeCustomVocabularyMetadataOutput, crate::error::DescribeCustomVocabularyMetadataError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_custom_vocabulary_metadata(value: &[u8], mut builder: crate::output::describe_custom_vocabulary_metadata_output::Builder) -> Result<crate::output::describe_custom_vocabulary_metadata_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
