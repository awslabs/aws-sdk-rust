...
pub fn ser_list_utterance_metrics_input_input(
    ...
    if let Some(var_9) = &input.end_date_time {
        object.key("endDateTime").date_time(var_9, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_24) = &input.start_date_time {
        object.key("startDateTime").date_time(var_24, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
