...
pub(crate) fn de_nlu_improvement_specification<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::NluImprovementSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::NluImprovementSpecificationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "intentDisambiguationSettings" => {
                            builder = builder.set_intent_disambiguation_settings(
                                crate::protocol_serde::shape_intent_disambiguation_settings::de_intent_disambiguation_settings(tokens, _value)?,
                            );
                        }
            ...
            Ok(Some(crate::serde_util::nlu_improvement_specification_correct_errors(builder).build()))
        }
...
pub fn ser_nlu_improvement_specification(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::NluImprovementSpecification,
