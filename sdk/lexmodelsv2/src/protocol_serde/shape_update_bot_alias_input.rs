...
pub fn ser_update_bot_alias_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateBotAliasInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
