...
pub fn ser_sub_slot_value_elicitation_setting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SubSlotValueElicitationSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_sub_slot_value_elicitation_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SubSlotValueElicitationSetting>, aws_smithy_json::deserialize::error::DeserializeError>
