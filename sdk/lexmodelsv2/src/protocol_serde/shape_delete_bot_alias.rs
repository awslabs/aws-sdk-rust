...
pub fn de_delete_bot_alias_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteBotAliasOutput, crate::error::DeleteBotAliasError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_bot_alias::de_delete_bot_alias(response.body().as_ref(), output).map_err(crate::error::DeleteBotAliasError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_bot_alias(value: &[u8], mut builder: crate::output::delete_bot_alias_output::Builder) -> Result<crate::output::delete_bot_alias_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
