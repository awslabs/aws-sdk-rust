...
pub fn de_delete_slot_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteSlotOutput, crate::error::DeleteSlotError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteSlotError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_slot_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteSlotOutput, crate::error::DeleteSlotError> {
    Ok({
        #[allow(unused_mut)]
