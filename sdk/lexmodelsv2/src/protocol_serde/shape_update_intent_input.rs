...
pub fn ser_update_intent_input_input(
    ...
    if let Some(var_33) = &input.slot_priorities {
        let mut array_34 = object.key("slotPriorities").start_array();
        for item_35 in var_33 {
            {
                #[allow(unused_mut)]
                let mut object_36 = array_34.value().start_object();
                crate::protocol_serde::shape_slot_priority::ser_slot_priority(&mut object_36, item_35)?;
                object_36.finish();
            }
        }
        array_34.finish();
