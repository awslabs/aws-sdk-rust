...
pub fn ser_update_intent_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateIntentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
