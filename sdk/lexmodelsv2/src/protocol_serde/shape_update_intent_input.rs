...
pub fn ser_update_intent_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_intent::UpdateIntentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
