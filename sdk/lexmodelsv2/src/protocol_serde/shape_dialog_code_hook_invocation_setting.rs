...
pub(crate) fn de_dialog_code_hook_invocation_setting<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DialogCodeHookInvocationSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::dialog_code_hook_invocation_setting_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
...
pub fn ser_dialog_code_hook_invocation_setting(
    ...
    if let Some(var_2) = &input.post_code_hook_specification {
        ...
        crate::protocol_serde::shape_post_dialog_code_hook_invocation_specification::ser_post_dialog_code_hook_invocation_specification(&mut object_3, var_2)?;
        object_3.finish();
    }
    Ok(())
}
