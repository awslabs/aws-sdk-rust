...
pub fn ser_create_bot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
