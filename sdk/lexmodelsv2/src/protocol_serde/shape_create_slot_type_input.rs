...
pub fn ser_create_slot_type_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_slot_type::CreateSlotTypeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
