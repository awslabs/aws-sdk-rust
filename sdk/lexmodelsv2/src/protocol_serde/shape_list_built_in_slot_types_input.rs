...
pub fn ser_list_built_in_slot_types_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_built_in_slot_types::ListBuiltInSlotTypesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
