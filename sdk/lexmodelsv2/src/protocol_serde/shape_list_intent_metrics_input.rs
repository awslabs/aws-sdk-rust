...
pub fn ser_list_intent_metrics_input_input(
    ...
    if let Some(var_5) = &input.end_date_time {
        object.key("endDateTime").date_time(var_5, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    ...
    if let Some(var_20) = &input.start_date_time {
        object.key("startDateTime").date_time(var_20, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
