...
pub fn ser_create_intent_input(
    ...
    if let Some(var_2) = &input.dialog_code_hook {
        ...
        crate::protocol_serde::shape_dialog_code_hook_settings::ser_dialog_code_hook_settings(
            &mut object_3,
            var_2,
        )?;
        object_3.finish();
    ...
    if let Some(var_6) = &input.initial_response_setting {
        ...
        crate::protocol_serde::shape_initial_response_setting::ser_initial_response_setting(
            &mut object_7,
            var_6,
        )?;
        object_7.finish();
    ...
    if let Some(var_12) = &input.intent_closing_setting {
        ...
        crate::protocol_serde::shape_intent_closing_setting::ser_intent_closing_setting(
            &mut object_13,
            var_12,
        )?;
        object_13.finish();
    ...
    if let Some(var_14) = &input.intent_confirmation_setting {
        ...
        crate::protocol_serde::shape_intent_confirmation_setting::ser_intent_confirmation_setting(
            &mut object_15,
            var_14,
        )?;
        object_15.finish();
