...
pub fn ser_create_intent_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateIntentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
