...
pub(crate) fn de_slot_value_elicitation_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SlotValueElicitationSetting>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_slot_value_elicitation_setting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SlotValueElicitationSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
