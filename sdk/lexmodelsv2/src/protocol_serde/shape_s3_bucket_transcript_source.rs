...
pub(crate) fn de_s3_bucket_transcript_source<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::S3BucketTranscriptSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "pathFormat" => {
                            builder = builder.set_path_format(crate::protocol_serde::shape_path_format::de_path_format(tokens, _value, depth + 1)?);
                        }
                        "transcriptFormat" => {
                        ...
                        "transcriptFilter" => {
                            builder = builder.set_transcript_filter(crate::protocol_serde::shape_transcript_filter::de_transcript_filter(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
