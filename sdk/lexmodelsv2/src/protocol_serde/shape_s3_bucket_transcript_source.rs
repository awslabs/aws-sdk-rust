...
pub(crate) fn de_s3_bucket_transcript_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3BucketTranscriptSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::s3_bucket_transcript_source_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
