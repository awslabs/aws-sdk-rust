...
pub(crate) fn de_s3_bucket_transcript_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3BucketTranscriptSource>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_s3_bucket_transcript_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3BucketTranscriptSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
