            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "pathFormat" => {
                            builder = builder.set_path_format(crate::protocol_serde::shape_path_format::de_path_format(tokens, _value)?);
                        }
                        "transcriptFormat" => {
                        ...
                        "transcriptFilter" => {
                            builder =
                                builder.set_transcript_filter(crate::protocol_serde::shape_transcript_filter::de_transcript_filter(tokens, _value)?);
                        }
                        "kmsKeyArn" => {
