...
pub fn ser_update_slot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSlotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
