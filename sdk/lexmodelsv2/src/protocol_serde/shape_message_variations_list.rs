...
pub(crate) fn de_message_variations_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Message>>, aws_smithy_json::deserialize::error::DeserializeError>
