...
pub(crate) fn de_user_turn_result<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::UserTurnResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "input" => {
                            builder = builder.set_input(
                                crate::protocol_serde::shape_user_turn_input_specification::de_user_turn_input_specification(tokens, _value)?,
                            );
                        }
                        "expectedOutput" => {
                            builder = builder.set_expected_output(
                                crate::protocol_serde::shape_user_turn_output_specification::de_user_turn_output_specification(tokens, _value)?,
                            );
                        }
                        "actualOutput" => {
                        ...
                        "errorDetails" => {
                            builder = builder.set_error_details(crate::protocol_serde::shape_execution_error_details::de_execution_error_details(
                                tokens, _value,
                            )?);
                        }
                        "endToEndResult" => {
                        ...
                        "conversationLevelResult" => {
                            builder = builder.set_conversation_level_result(
                                crate::protocol_serde::shape_conversation_level_result_detail::de_conversation_level_result_detail(tokens, _value)?,
                            );
                        }
