...
pub(crate) fn de_opensearch_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::OpensearchConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "exactResponse" => {
                                builder = builder.set_exact_response(
                                    ::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?
                                );
                            }
                            "exactResponseFields" => {
                                builder = builder.set_exact_response_fields(
                                    crate::protocol_serde::shape_exact_response_fields::de_exact_response_fields(tokens)?
                                );
                            }
                            "includeFields" => {
                                builder = builder.set_include_fields(
                                    crate::protocol_serde::shape_os_include_fields::de_os_include_fields(tokens)?
                                );
                            }
            ...
            Ok(Some(crate::serde_util::opensearch_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
