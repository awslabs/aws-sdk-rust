...
pub(crate) fn de_dialog_action<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::DialogAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "suppressNextMessage" => {
                            builder = builder.set_suppress_next_message(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
