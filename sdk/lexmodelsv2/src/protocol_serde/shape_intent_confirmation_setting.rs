...
) -> Result<Option<crate::types::IntentConfirmationSetting>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "declinationResponse" => {
                            builder = builder
                                .set_declination_response(crate::protocol_serde::shape_response_specification::de_response_specification(tokens)?);
                        }
                        "active" => {
                        ...
                        "confirmationResponse" => {
                            builder = builder
                                .set_confirmation_response(crate::protocol_serde::shape_response_specification::de_response_specification(tokens)?);
                        }
                        "confirmationNextStep" => {
                            builder = builder.set_confirmation_next_step(crate::protocol_serde::shape_dialog_state::de_dialog_state(tokens)?);
                        }
                        ...
                        "declinationNextStep" => {
                            builder = builder.set_declination_next_step(crate::protocol_serde::shape_dialog_state::de_dialog_state(tokens)?);
                        }
                        ...
                        "failureResponse" => {
                            builder =
                                builder.set_failure_response(crate::protocol_serde::shape_response_specification::de_response_specification(tokens)?);
                        }
                        "failureNextStep" => {
                            builder = builder.set_failure_next_step(crate::protocol_serde::shape_dialog_state::de_dialog_state(tokens)?);
                        }
                        "failureConditional" => {
            ...
            Ok(Some(crate::serde_util::intent_confirmation_setting_correct_errors(builder).build()))
        }
