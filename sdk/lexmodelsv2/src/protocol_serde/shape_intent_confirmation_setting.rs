...
pub(crate) fn de_intent_confirmation_setting<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IntentConfirmationSetting>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_intent_confirmation_setting(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IntentConfirmationSetting) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
