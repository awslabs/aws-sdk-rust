            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::describe_export::DescribeExportError::unhandled(
...
) -> Result<crate::operation::describe_export::builders::DescribeExportOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "fileFormat" => {
                    builder = builder.set_file_format(
                        ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                            .map(|s| s.to_unescaped().map(|u| crate::types::ImportExportFileFormat::from(u.as_ref())))
                            .transpose()?,
                    );
                }
                "lastUpdatedDateTime" => {
