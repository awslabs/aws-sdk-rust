...
pub fn ser_list_slots_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListSlotsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
