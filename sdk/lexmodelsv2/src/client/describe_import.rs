...
impl super::Client {
    ...
    ///   - [`import_id(impl ::std::convert::Into<String>)`](crate::operation::describe_import::builders::DescribeImportFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::describe_import::builders::DescribeImportFluentBuilder::set_import_id): <p>The unique identifier of the import to describe.</p>
