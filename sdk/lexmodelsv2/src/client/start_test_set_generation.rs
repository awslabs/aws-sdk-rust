...
impl super::Client {
    ...
    ///   - [`test_set_name(impl ::std::convert::Into<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::test_set_name) / [`set_test_set_name(Option<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_test_set_name): <p>The test set name for the test set generation request.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_description): <p>The test set description for the test set generation request.</p>
    ///   - [`storage_location(TestSetStorageLocation)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::storage_location) / [`set_storage_location(Option<TestSetStorageLocation>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_storage_location): <p>The Amazon S3 storage location for the test set generation.</p>
    ///   - [`generation_data_source(TestSetGenerationDataSource)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::generation_data_source) / [`set_generation_data_source(Option<TestSetGenerationDataSource>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_generation_data_source): <p>The data source for the test set generation.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_role_arn): <p>The roleARN used for any operation in the test set to access resources in the Amazon Web Services account.</p>
    ///   - [`test_set_tags(HashMap<String, String>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::test_set_tags) / [`set_test_set_tags(Option<HashMap<String, String>>)`](crate::operation::start_test_set_generation::builders::StartTestSetGenerationFluentBuilder::set_test_set_tags): <p>A list of tags to add to the test set. You can only add tags when you import/generate a new test set. You can't use the <code>UpdateTestSet</code> operation to update tags. To update tags, use the <code>TagResource</code> operation.</p>
