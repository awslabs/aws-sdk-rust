...
impl super::Client {
    ...
    ///   - [`bot_id(impl Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the locale.</p>
    ...
    ///   - [`locale_id(impl Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_locale_id): <p>The identifier of the language and locale to update. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_description): <p>The new description of the locale.</p>
