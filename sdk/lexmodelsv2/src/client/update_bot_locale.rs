...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the locale.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_bot_version): <p>The version of the bot that contains the locale to be updated. The version can only be the <code>DRAFT</code> version.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_locale_id): <p>The identifier of the language and locale to update. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_description): <p>The new description of the locale.</p>
    ///   - [`nlu_intent_confidence_threshold(f64)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::nlu_intent_confidence_threshold) / [`set_nlu_intent_confidence_threshold(Option<f64>)`](crate::operation::update_bot_locale::builders::UpdateBotLocaleFluentBuilder::set_nlu_intent_confidence_threshold): <p>The new confidence threshold where Amazon Lex inserts the <code>AMAZON.FallbackIntent</code> and <code>AMAZON.KendraSearchIntent</code> intents in the list of possible intents for an utterance.</p>
