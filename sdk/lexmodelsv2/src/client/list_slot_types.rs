...
impl super::Client {
    ...
    ///   - [`bot_id(impl Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the slot types.</p>
    ///   - [`bot_version(impl Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_bot_version): <p>The version of the bot that contains the slot type.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_next_token): <p>If the response from the <code>ListSlotTypes</code> operation contains more results than specified in the <code>maxResults</code> parameter, a token is returned in the response. Use that token in the <code>nextToken</code> parameter to return the next page of results.</p>
