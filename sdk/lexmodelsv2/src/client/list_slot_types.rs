...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the slot types.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_bot_version): <p>The version of the bot that contains the slot type.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_locale_id): <p>The identifier of the language and locale of the slot types to list. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
    ///   - [`sort_by(SlotTypeSortBy)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::sort_by) / [`set_sort_by(Option<SlotTypeSortBy>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_sort_by): <p>Determines the sort order for the response from the <code>ListSlotTypes</code> operation. You can choose to sort by the slot type name or last updated date in either ascending or descending order.</p>
    ///   - [`filters(Vec<SlotTypeFilter>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::filters) / [`set_filters(Option<Vec<SlotTypeFilter>>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_filters): <p>Provides the specification of a filter used to limit the slot types in the response to only those that match the filter specification. You can only specify one filter and only one string to filter on.</p>
    ///   - [`max_results(i32)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_max_results): <p>The maximum number of slot types to return in each page of results. If there are fewer results than the max page size, only the actual number of results are returned.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::set_next_token): <p>If the response from the <code>ListSlotTypes</code> operation contains more results than specified in the <code>maxResults</code> parameter, a token is returned in the response. Use that token in the <code>nextToken</code> parameter to return the next page of results.</p>
    ...
    pub fn list_slot_types(
        &self,
    ) -> crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder {
        crate::operation::list_slot_types::builders::ListSlotTypesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
