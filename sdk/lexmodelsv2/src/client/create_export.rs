...
impl super::Client {
    ...
    ///   - [`resource_specification(ExportResourceSpecification)`](crate::operation::create_export::builders::CreateExportFluentBuilder::resource_specification) / [`set_resource_specification(Option<ExportResourceSpecification>)`](crate::operation::create_export::builders::CreateExportFluentBuilder::set_resource_specification):<br>required: **true**<br><p>Specifies the type of resource to export, either a bot or a bot locale. You can only specify one type of resource to export.</p><br>
    ///   - [`file_format(ImportExportFileFormat)`](crate::operation::create_export::builders::CreateExportFluentBuilder::file_format) / [`set_file_format(Option<ImportExportFileFormat>)`](crate::operation::create_export::builders::CreateExportFluentBuilder::set_file_format):<br>required: **true**<br><p>The file format of the bot or bot locale definition files.</p><br>
    ///   - [`file_password(impl Into<String>)`](crate::operation::create_export::builders::CreateExportFluentBuilder::file_password) / [`set_file_password(Option<String>)`](crate::operation::create_export::builders::CreateExportFluentBuilder::set_file_password):<br>required: **false**<br><p>An password to use to encrypt the exported archive. Using a password is optional, but you should encrypt the archive to protect the data in transit between Amazon Lex and your local computer.</p><br>
