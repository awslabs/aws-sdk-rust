...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the locale.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::set_bot_version): <p>The identifier of the version of the bot associated with the locale.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::set_locale_id): <p>The unique identifier of the locale to describe. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>. </p>
