...
impl super::Client {
    ...
    ///   - [`unified_speech_settings(Option<UnifiedSpeechSettings>)`](crate::operation::describe_bot_locale::DescribeBotLocaleOutput::unified_speech_settings): <p>The unified speech settings configured for the bot locale.</p>
    ///   - [`audio_filler_settings(Option<AudioFillerSettings>)`](crate::operation::describe_bot_locale::DescribeBotLocaleOutput::audio_filler_settings): <p>The audio filler settings configured for the bot locale.</p>
    ///   - [`speech_recognition_settings(Option<SpeechRecognitionSettings>)`](crate::operation::describe_bot_locale::DescribeBotLocaleOutput::speech_recognition_settings): <p>The speech-to-text settings configured for the bot locale.</p>
