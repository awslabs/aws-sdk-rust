...
impl super::Client {
    ...
    ///   - [`bot_version(impl Into<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::describe_bot_locale::builders::DescribeBotLocaleFluentBuilder::set_bot_version): <p>The version of the bot associated with the locale.</p>
