...
impl super::Client {
    ...
    ///   - [`bot_id(impl Into<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the bot recommendation list.</p>
    ///   - [`bot_version(impl Into<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::set_bot_version): <p>The version of the bot that contains the bot recommendation list.</p>
    ///   - [`locale_id(impl Into<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::set_locale_id): <p>The identifier of the language and locale of the bot recommendation list.</p>
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_bot_recommendations::builders::ListBotRecommendationsFluentBuilder::set_next_token): <p>If the response from the ListBotRecommendation operation contains more results than specified in the maxResults parameter, a token is returned in the response. Use that token in the nextToken parameter to return the next page of results.</p>
