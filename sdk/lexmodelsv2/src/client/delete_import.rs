...
impl super::Client {
    ...
    ///   - [`import_id(impl Into<String>)`](crate::operation::delete_import::builders::DeleteImportFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::delete_import::builders::DeleteImportFluentBuilder::set_import_id):<br>required: **true**<br><p>The unique identifier of the import to delete.</p><br>
