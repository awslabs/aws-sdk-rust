...
impl super::Client {
    ...
    ///   - [`sort_by(TestExecutionSortBy)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::sort_by) / [`set_sort_by(Option<TestExecutionSortBy>)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::set_sort_by): <p>The sort order of the test set executions.</p>
    ///   - [`max_results(i32)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::set_max_results): <p>The maximum number of test executions to return in each page. If there are fewer results than the max page size, only the actual number of results are returned.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_test_executions::builders::ListTestExecutionsFluentBuilder::set_next_token): <p>If the response from the ListTestExecutions operation contains more results than specified in the maxResults parameter, a token is returned in the response. Use that token in the nextToken parameter to return the next page of results.</p>
