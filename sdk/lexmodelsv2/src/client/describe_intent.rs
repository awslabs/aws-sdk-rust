...
impl super::Client {
    ...
    ///   - [`intent_id(impl ::std::convert::Into<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::intent_id) / [`set_intent_id(Option<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::set_intent_id): <p>The identifier of the intent to describe.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the intent.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::set_bot_version): <p>The version of the bot associated with the intent.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::describe_intent::builders::DescribeIntentFluentBuilder::set_locale_id): <p>The identifier of the language and locale of the intent to describe. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
