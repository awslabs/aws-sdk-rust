...
impl super::Client {
    ...
    ///   - [`q_in_connect_intent_configuration(Option<QInConnectIntentConfiguration>)`](crate::operation::describe_intent::DescribeIntentOutput::q_in_connect_intent_configuration): <p>Qinconnect intent configuration details for the describe intent response.</p>
