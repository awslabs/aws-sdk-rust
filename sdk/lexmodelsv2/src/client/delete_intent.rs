...
impl super::Client {
    ...
    ///   - [`intent_id(impl ::std::convert::Into<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::intent_id) / [`set_intent_id(Option<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::set_intent_id): <p>The unique identifier of the intent to delete.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the intent.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::delete_intent::builders::DeleteIntentFluentBuilder::set_bot_version): <p>The version of the bot associated with the intent.</p>
