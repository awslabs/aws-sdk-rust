...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot::builders::DeleteBotFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_bot::builders::DeleteBotFluentBuilder::set_bot_id): <p>The identifier of the bot to delete. </p>
