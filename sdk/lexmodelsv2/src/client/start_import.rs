...
impl super::Client {
    ...
    ///   - [`import_id(impl ::std::convert::Into<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_import_id): <p>The unique identifier for the import. It is included in the response from the <a href="https://docs.aws.amazon.com/lexv2/latest/APIReference/API_CreateUploadUrl.html">CreateUploadUrl</a> operation.</p>
    ...
    ///   - [`file_password(impl ::std::convert::Into<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::file_password) / [`set_file_password(Option<String>)`](crate::operation::start_import::builders::StartImportFluentBuilder::set_file_password): <p>The password used to encrypt the zip archive that contains the resource definition. You should always encrypt the zip archive to protect it during transit between your site and Amazon Lex.</p>
