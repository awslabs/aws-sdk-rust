...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_utterances::builders::DeleteUtterancesFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_utterances::builders::DeleteUtterancesFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the utterances.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::delete_utterances::builders::DeleteUtterancesFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::delete_utterances::builders::DeleteUtterancesFluentBuilder::set_locale_id): <p>The identifier of the language and locale where the utterances were collected. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
