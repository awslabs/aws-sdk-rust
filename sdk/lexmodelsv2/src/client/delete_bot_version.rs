...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_version::builders::DeleteBotVersionFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_bot_version::builders::DeleteBotVersionFluentBuilder::set_bot_id): <p>The identifier of the bot that contains the version.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_version::builders::DeleteBotVersionFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::delete_bot_version::builders::DeleteBotVersionFluentBuilder::set_bot_version): <p>The version of the bot to delete.</p>
