...
impl super::Client {
    ...
    ///   - [`export_id(impl Into<String>)`](crate::operation::update_export::builders::UpdateExportFluentBuilder::export_id) / [`set_export_id(Option<String>)`](crate::operation::update_export::builders::UpdateExportFluentBuilder::set_export_id):<br>required: **true**<br><p>The unique identifier Amazon Lex assigned to the export.</p><br>
    ///   - [`file_password(impl Into<String>)`](crate::operation::update_export::builders::UpdateExportFluentBuilder::file_password) / [`set_file_password(Option<String>)`](crate::operation::update_export::builders::UpdateExportFluentBuilder::set_file_password):<br>required: **false**<br><p>The new password to use to encrypt the export zip archive.</p><br>
