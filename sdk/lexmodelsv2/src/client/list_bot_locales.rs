...
impl super::Client {
    ...
    ///   - [`bot_id(impl Into<String>)`](crate::operation::list_bot_locales::builders::ListBotLocalesFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_bot_locales::builders::ListBotLocalesFluentBuilder::set_bot_id): <p>The identifier of the bot to list locales for.</p>
    ///   - [`bot_version(impl Into<String>)`](crate::operation::list_bot_locales::builders::ListBotLocalesFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::list_bot_locales::builders::ListBotLocalesFluentBuilder::set_bot_version): <p>The version of the bot to list locales for.</p>
