...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::list_bot_aliases::builders::ListBotAliasesFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_bot_aliases::builders::ListBotAliasesFluentBuilder::set_bot_id): <p>The identifier of the bot to list aliases for.</p>
