...
impl super::Client {
    ...
    ///   - [`slot_type_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::slot_type_id) / [`set_slot_type_id(Option<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::set_slot_type_id): <p>The identifier of the slot type.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the slot type.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::set_bot_version): <p>The version of the bot associated with the slot type.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::describe_slot_type::builders::DescribeSlotTypeFluentBuilder::set_locale_id): <p>The identifier of the language and locale of the slot type to describe. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
