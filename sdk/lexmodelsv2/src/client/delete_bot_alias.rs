...
impl super::Client {
    ...
    ///   - [`bot_alias_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::bot_alias_id) / [`set_bot_alias_id(Option<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::set_bot_alias_id): <p>The unique identifier of the bot alias to delete.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::set_bot_id): <p>The unique identifier of the bot associated with the alias to delete.</p>
    ///   - [`skip_resource_in_use_check(bool)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::skip_resource_in_use_check) / [`set_skip_resource_in_use_check(Option<bool>)`](crate::operation::delete_bot_alias::builders::DeleteBotAliasFluentBuilder::set_skip_resource_in_use_check): <p>By default, Amazon Lex checks if any other resource, such as a bot network, is using the bot alias before it is deleted and throws a <code>ResourceInUseException</code> exception if the alias is being used by another resource. Set this parameter to <code>true</code> to skip this check and remove the alias even if it is being used by another resource.</p>
