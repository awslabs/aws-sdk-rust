...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::set_bot_id): <p>The unique identifier of the bot that contains the locale.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::set_bot_version): <p>The version of the bot that contains the locale. </p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::delete_bot_locale::builders::DeleteBotLocaleFluentBuilder::set_locale_id): <p>The identifier of the language and locale that will be deleted. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
