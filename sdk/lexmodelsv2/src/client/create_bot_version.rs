...
impl super::Client {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::create_bot_version::builders::CreateBotVersionFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::create_bot_version::builders::CreateBotVersionFluentBuilder::set_bot_id): <p>The identifier of the bot to create the version for.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_bot_version::builders::CreateBotVersionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_bot_version::builders::CreateBotVersionFluentBuilder::set_description): <p>A description of the version. Use the description to help identify the version in lists.</p>
