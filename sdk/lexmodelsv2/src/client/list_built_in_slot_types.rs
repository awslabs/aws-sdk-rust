...
impl super::Client {
    ...
    pub fn list_built_in_slot_types(&self) -> crate::client::fluent_builders::ListBuiltInSlotTypes {
        crate::client::fluent_builders::ListBuiltInSlotTypes::new(self.handle.clone())
    }
}
