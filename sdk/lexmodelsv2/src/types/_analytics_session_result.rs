...
pub struct AnalyticsSessionResult {
    ...
    #[doc(hidden)]
    pub group_by_keys:
        ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionGroupByKey>>,
    ...
    #[doc(hidden)]
    pub metrics_results:
        ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>>,
}
impl AnalyticsSessionResult {
    ...
    pub fn group_by_keys(
        &self,
    ) -> ::std::option::Option<&[crate::types::AnalyticsSessionGroupByKey]> {
        self.group_by_keys.as_deref()
    }
    /// <p>A list of objects, each of which contains a metric you want to list, the statistic for the metric you want to return, and the method by which to organize the results.</p>
    pub fn metrics_results(
        &self,
    ) -> ::std::option::Option<&[crate::types::AnalyticsSessionMetricResult]> {
...
impl AnalyticsSessionResultBuilder {
    ...
    pub fn set_group_by_keys(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionGroupByKey>>,
    ) -> Self {
    ...
    pub fn set_metrics_results(
        mut self,
        input: ::std::option::Option<::std::vec::Vec<crate::types::AnalyticsSessionMetricResult>>,
    ) -> Self {
