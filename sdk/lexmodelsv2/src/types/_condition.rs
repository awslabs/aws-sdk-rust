...
impl  Condition  {
    ...
    pub fn expression_string(&self) -> & str {
        use std::ops::Deref; self.expression_string.deref()
    }
}
impl Condition {
        ...
        ::std::result::Result::Ok(
            crate::types::Condition {
                expression_string: self.expression_string
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("expression_string", "expression_string was not specified but it is required when building Condition")
                    )?
                ,
            }
        )
