...
pub struct TestExecutionResultItems {
    ...
    #[doc(hidden)]
    pub conversation_level_test_results:
        ::std::option::Option<crate::types::ConversationLevelTestResults>,
    ...
    #[doc(hidden)]
    pub intent_classification_test_results:
        ::std::option::Option<crate::types::IntentClassificationTestResults>,
    ...
    #[doc(hidden)]
    pub intent_level_slot_resolution_test_results:
        ::std::option::Option<crate::types::IntentLevelSlotResolutionTestResults>,
    /// <p>Results related to utterances in the test set.</p>
    #[doc(hidden)]
    pub utterance_level_test_results:
        ::std::option::Option<crate::types::UtteranceLevelTestResults>,
}
impl TestExecutionResultItems {
    ...
    /// <p>Results related to conversations in the test set, including metrics about success and failure of conversations and intent and slot failures.</p>
    pub fn conversation_level_test_results(
        &self,
    ) -> ::std::option::Option<&crate::types::ConversationLevelTestResults> {
        self.conversation_level_test_results.as_ref()
    }
    /// <p>Intent recognition results aggregated by intent name. The aggregated results contain success and failure rates of intent recognition, speech transcriptions, and end-to-end conversations.</p>
    pub fn intent_classification_test_results(
        &self,
    ) -> ::std::option::Option<&crate::types::IntentClassificationTestResults> {
        self.intent_classification_test_results.as_ref()
    }
    /// <p>Slot resolution results aggregated by intent and slot name. The aggregated results contain success and failure rates of slot resolution, speech transcriptions, and end-to-end conversations</p>
    pub fn intent_level_slot_resolution_test_results(
        &self,
    ) -> ::std::option::Option<&crate::types::IntentLevelSlotResolutionTestResults> {
        self.intent_level_slot_resolution_test_results.as_ref()
    }
    /// <p>Results related to utterances in the test set.</p>
    pub fn utterance_level_test_results(
        &self,
    ) -> ::std::option::Option<&crate::types::UtteranceLevelTestResults> {
...
pub struct TestExecutionResultItemsBuilder {
    ...
    pub(crate) conversation_level_test_results:
        ::std::option::Option<crate::types::ConversationLevelTestResults>,
    pub(crate) intent_classification_test_results:
        ::std::option::Option<crate::types::IntentClassificationTestResults>,
    pub(crate) intent_level_slot_resolution_test_results:
        ::std::option::Option<crate::types::IntentLevelSlotResolutionTestResults>,
    pub(crate) utterance_level_test_results:
        ::std::option::Option<crate::types::UtteranceLevelTestResults>,
}
impl TestExecutionResultItemsBuilder {
    ...
    /// <p>Overall results for the test execution, including the breakdown of conversations and single-input utterances.</p>
    pub fn set_overall_test_results(
        mut self,
        input: ::std::option::Option<crate::types::OverallTestResults>,
    ) -> Self {
        self.overall_test_results = input;
        self
    }
    /// <p>Overall results for the test execution, including the breakdown of conversations and single-input utterances.</p>
    pub fn get_overall_test_results(
        &self,
    ) -> &::std::option::Option<crate::types::OverallTestResults> {
        &self.overall_test_results
    }
    /// <p>Results related to conversations in the test set, including metrics about success and failure of conversations and intent and slot failures.</p>
    pub fn conversation_level_test_results(
        mut self,
        input: crate::types::ConversationLevelTestResults,
    ) -> Self {
        self.conversation_level_test_results = ::std::option::Option::Some(input);
        self
    }
    /// <p>Results related to conversations in the test set, including metrics about success and failure of conversations and intent and slot failures.</p>
    pub fn set_conversation_level_test_results(
        mut self,
        input: ::std::option::Option<crate::types::ConversationLevelTestResults>,
    ) -> Self {
        self.conversation_level_test_results = input;
        self
    }
    /// <p>Results related to conversations in the test set, including metrics about success and failure of conversations and intent and slot failures.</p>
    pub fn get_conversation_level_test_results(
        &self,
    ) -> &::std::option::Option<crate::types::ConversationLevelTestResults> {
    ...
    pub fn intent_classification_test_results(
        mut self,
        input: crate::types::IntentClassificationTestResults,
    ) -> Self {
        self.intent_classification_test_results = ::std::option::Option::Some(input);
        self
    }
    /// <p>Intent recognition results aggregated by intent name. The aggregated results contain success and failure rates of intent recognition, speech transcriptions, and end-to-end conversations.</p>
    pub fn set_intent_classification_test_results(
        mut self,
        input: ::std::option::Option<crate::types::IntentClassificationTestResults>,
    ) -> Self {
        self.intent_classification_test_results = input;
        self
    }
    /// <p>Intent recognition results aggregated by intent name. The aggregated results contain success and failure rates of intent recognition, speech transcriptions, and end-to-end conversations.</p>
    pub fn get_intent_classification_test_results(
        &self,
    ) -> &::std::option::Option<crate::types::IntentClassificationTestResults> {
    ...
    pub fn intent_level_slot_resolution_test_results(
        mut self,
        input: crate::types::IntentLevelSlotResolutionTestResults,
    ) -> Self {
    ...
    /// <p>Slot resolution results aggregated by intent and slot name. The aggregated results contain success and failure rates of slot resolution, speech transcriptions, and end-to-end conversations</p>
    pub fn get_intent_level_slot_resolution_test_results(
        &self,
    ) -> &::std::option::Option<crate::types::IntentLevelSlotResolutionTestResults> {
    ...
    pub fn utterance_level_test_results(
        mut self,
        input: crate::types::UtteranceLevelTestResults,
    ) -> Self {
        self.utterance_level_test_results = ::std::option::Option::Some(input);
        self
    }
    /// <p>Results related to utterances in the test set.</p>
    pub fn set_utterance_level_test_results(
        mut self,
        input: ::std::option::Option<crate::types::UtteranceLevelTestResults>,
    ) -> Self {
        self.utterance_level_test_results = input;
        self
    }
    /// <p>Results related to utterances in the test set.</p>
    pub fn get_utterance_level_test_results(
        &self,
    ) -> &::std::option::Option<crate::types::UtteranceLevelTestResults> {
    ...
    pub fn build(self) -> crate::types::TestExecutionResultItems {
        crate::types::TestExecutionResultItems {
            ...
            intent_level_slot_resolution_test_results: self
