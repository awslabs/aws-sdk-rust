...
impl AnalyticsIntentStageMetricBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::AnalyticsIntentStageMetric, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::AnalyticsIntentStageMetric {
                name: self.name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("name", "name was not specified but it is required when building AnalyticsIntentStageMetric")
                    )?
                ,
                statistic: self.statistic
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("statistic", "statistic was not specified but it is required when building AnalyticsIntentStageMetric")
                    )?
                ,
                order: self.order
                ,
