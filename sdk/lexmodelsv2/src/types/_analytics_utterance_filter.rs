...
pub struct AnalyticsUtteranceFilter {
    ...
    /// </ul>
    #[doc(hidden)]
    pub name: ::std::option::Option<crate::types::AnalyticsUtteranceFilterName>,
...
impl AnalyticsUtteranceFilter {
    ...
    /// <li> <p> <code>UtteranceText</code> – The text in the utterance.</p> </li>
    /// </ul>
    pub fn name(&self) -> ::std::option::Option<&crate::types::AnalyticsUtteranceFilterName> {
        self.name.as_ref()
    }
    /// <p>The operation by which to filter the category. The following operations are possible:</p>
    /// <ul>
...
impl AnalyticsUtteranceFilterBuilder {
    ...
    pub fn set_name(
        mut self,
        input: ::std::option::Option<crate::types::AnalyticsUtteranceFilterName>,
    ) -> Self {
        self.name = input;
        self
    }
    ...
    pub fn build(self) -> crate::types::AnalyticsUtteranceFilter {
