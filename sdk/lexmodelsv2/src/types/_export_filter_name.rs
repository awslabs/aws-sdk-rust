...
other => ExportFilterName::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for ExportFilterName {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(ExportFilterName::from(s))
                    }
                }
...
impl ::std::convert::AsRef<str> for ExportFilterName {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
...
impl ::std::fmt::Display for ExportFilterName {
                        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                            match self {
                                ExportFilterName::ExportResourceType => write!(f, "ExportResourceType"),
ExportFilterName::Unknown(value) => write!(f, "{}", value)
                            }
                        }
                    }
