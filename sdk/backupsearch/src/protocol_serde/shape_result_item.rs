...
) -> Result<Option<crate::types::ResultItem>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "S3ResultItem" => Some(crate::types::ResultItem::S3ResultItem(
                            crate::protocol_serde::shape_s3_result_item::de_s3_result_item(tokens)?.ok_or_else(|| {
                        ...
                        "EBSResultItem" => Some(crate::types::ResultItem::EbsResultItem(
                            crate::protocol_serde::shape_ebs_result_item::de_ebs_result_item(tokens)?.ok_or_else(|| {
