...
/// Paginator for [`ListSearchJobBackups`](crate::operation::list_search_job_backups::ListSearchJobBackups)
pub struct ListSearchJobBackupsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_search_job_backups::builders::ListSearchJobBackupsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListSearchJobBackupsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_search_job_backups::paginator::ListSearchJobBackupsPaginatorItems {
        crate::operation::list_search_job_backups::paginator::ListSearchJobBackupsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_search_job_backups::ListSearchJobBackups::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_search_job_backups_output_output_next_token(resp);
...
/// Flattened paginator for `ListSearchJobBackupsPaginator`
///
/// This is created with [`.items()`](ListSearchJobBackupsPaginator::items)
pub struct ListSearchJobBackupsPaginatorItems(ListSearchJobBackupsPaginator);

impl ListSearchJobBackupsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_search_job_backups_output_output_results(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
