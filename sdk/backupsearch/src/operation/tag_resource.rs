...
impl TagResource {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "backupsearch.TagResource",
                "rpc.service" = "backupsearch",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("backupsearch", "TagResource", input, runtime_plugins, stop_point).await
    }
