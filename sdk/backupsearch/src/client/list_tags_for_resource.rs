...
impl super::Client {
    ...
    ///   - [`tags(Option<HashMap::<String, Option<String>>>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>List of tags returned by the operation.</p>
