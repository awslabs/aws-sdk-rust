...
impl super::Client {
    ...
    ///   - [`tileset(impl Into<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::tileset) / [`set_tileset(Option<String>)`](crate::operation::get_tile::builders::GetTileFluentBuilder::set_tileset):<br>required: **true**<br><p>Specifies the desired tile set.</p> <p>Valid Values: <code>raster.satellite | vector.basemap | vector.traffic | raster.dem</code></p><br>
