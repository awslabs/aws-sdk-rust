...
pub(crate) fn de_blob_payload(
    body: &[u8],
) -> std::result::Result<::std::option::Option<::aws_smithy_types::Blob>, crate::operation::get_static_map::GetStaticMapError> {
...
pub(crate) fn de_pricing_bucket_header(
    header_map: &::aws_smithy_runtime_api::http::Headers,
) -> ::std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
    let headers = header_map.get_all_bytes("x-amz-geo-pricing-bucket");
    ::aws_smithy_http::header::one_or_none_bytes(headers)
}
