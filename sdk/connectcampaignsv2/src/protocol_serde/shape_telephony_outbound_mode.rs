                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "progressive" => Some(crate::types::TelephonyOutboundMode::Progressive(
                            crate::protocol_serde::shape_progressive_config::de_progressive_config(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "predictive" => Some(crate::types::TelephonyOutboundMode::Predictive(
                            crate::protocol_serde::shape_predictive_config::de_predictive_config(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "preview" => Some(crate::types::TelephonyOutboundMode::Preview(
                            crate::protocol_serde::shape_preview_config::de_preview_config(tokens, _value, depth + 1)?.ok_or_else(|| {
