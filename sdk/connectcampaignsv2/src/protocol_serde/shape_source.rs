...
pub fn ser_source(
    ...
    match input {
        crate::types::Source::CustomerProfilesSegmentArn(inner) => {
            object_15.key("customerProfilesSegmentArn").string(inner.as_str());
        }
        crate::types::Source::EventTrigger(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_15.key("eventTrigger").start_object();
            ...
            match tokens.next().transpose()? {
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "customerProfilesSegmentArn" => Some(crate::types::Source::CustomerProfilesSegmentArn(
                        ...
                        "eventTrigger" => Some(crate::types::Source::EventTrigger(
                            crate::protocol_serde::shape_event_trigger::de_event_trigger(tokens, _value, depth + 1)?.ok_or_else(|| {
