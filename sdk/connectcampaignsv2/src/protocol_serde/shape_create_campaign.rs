    ...
    Err(match error_code {
                    ...
                    match crate::protocol_serde::shape_access_denied_exception::de_x_amz_error_type_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::create_campaign::CreateCampaignError::unhandled(
        ...
        "ServiceQuotaExceededException" => crate::operation::create_campaign::CreateCampaignError::ServiceQuotaExceededException({
            ...
            let mut tmp = {
                ...
                .map_err(crate::operation::create_campaign::CreateCampaignError::unhandled)?;
                output = output.set_x_amz_error_type(
                    match crate::protocol_serde::shape_service_quota_exceeded_exception::de_x_amz_error_type_header(_response_headers) {
                        ::std::result::Result::Ok(value) => value,
                        ::std::result::Result::Err(err) => {
                            let _ = &err;
                            let has_unreadable_value = _response_headers
