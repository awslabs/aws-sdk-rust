    ...
    Err(match error_code {
            ...
            let mut tmp = {
                ...
                output = output.set_x_amz_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_x_amz_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::create_campaign::CreateCampaignError::unhandled(
        ...
        "ServiceQuotaExceededException" => crate::operation::create_campaign::CreateCampaignError::ServiceQuotaExceededException({
            ...
            let mut tmp = {
                ...
                .map_err(crate::operation::create_campaign::CreateCampaignError::unhandled)?;
                output = output.set_x_amz_error_type(
                    crate::protocol_serde::shape_service_quota_exceeded_exception::de_x_amz_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::create_campaign::CreateCampaignError::unhandled(
                            "Failed to parse xAmzErrorType from header `x-amzn-ErrorType",
                        )
                    })?,
