...
pub fn de_get_campaign_state_batch_http_error(
            ...
            let mut tmp = {
                ...
                output = output.set_x_amz_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_x_amz_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::get_campaign_state_batch::GetCampaignStateBatchError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_campaign_state_batch_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_campaign_state_batch::de_get_campaign_state_batch(_response_body, output)
            .map_err(crate::operation::get_campaign_state_batch::GetCampaignStateBatchError::unhandled)?;
...
pub fn ser_get_campaign_state_batch_input(
    ...
    crate::protocol_serde::shape_get_campaign_state_batch_input::ser_get_campaign_state_batch_input_input(&mut object, input)?;
    object.finish();
...
pub(crate) fn de_get_campaign_state_batch(
    value: &[u8],
    mut builder: crate::operation::get_campaign_state_batch::builders::GetCampaignStateBatchOutputBuilder,
) -> Result<
