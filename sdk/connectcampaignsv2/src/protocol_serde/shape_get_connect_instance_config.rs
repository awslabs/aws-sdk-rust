...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_connect_instance_config::GetConnectInstanceConfigError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_connect_instance_config::de_get_connect_instance_config(_response_body, output)
            .map_err(crate::operation::get_connect_instance_config::GetConnectInstanceConfigError::unhandled)?;
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "connectInstanceConfig" => {
                    builder = builder.set_connect_instance_config(crate::protocol_serde::shape_instance_config::de_instance_config(tokens, _value)?);
                }
