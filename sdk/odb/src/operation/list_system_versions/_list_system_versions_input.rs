...
pub struct ListSystemVersionsInput {
...
impl ListSystemVersionsInput {
    /// Creates a new builder-style object to manufacture [`ListSystemVersionsInput`](crate::operation::list_system_versions::ListSystemVersionsInput).
    pub fn builder() -> crate::operation::list_system_versions::builders::ListSystemVersionsInputBuilder {
        crate::operation::list_system_versions::builders::ListSystemVersionsInputBuilder::default()
    }
}

/// A builder for [`ListSystemVersionsInput`](crate::operation::list_system_versions::ListSystemVersionsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListSystemVersionsInputBuilder {
...
impl ListSystemVersionsInputBuilder {
    /// <p>The maximum number of items to return for this request. To get the next page of items, make another request with the token returned in the output.</p>
    /// <p>Default: <code>10</code></p>
    ...
    /// Consumes the builder and constructs a [`ListSystemVersionsInput`](crate::operation::list_system_versions::ListSystemVersionsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_system_versions::ListSystemVersionsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_system_versions::ListSystemVersionsInput {
