    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::OdbNetworkBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "peeredCidrs" => {
                            builder = builder.set_peered_cidrs(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "ociNetworkAnchorId" => {
                        ...
                        "ociDnsForwardingConfigs" => {
                            builder = builder.set_oci_dns_forwarding_configs(
                                crate::protocol_serde::shape_oci_dns_forwarding_config_list::de_oci_dns_forwarding_config_list(tokens)?,
                            );
                        }
                        "createdAt" => {
                        ...
                        "managedServices" => {
                            builder = builder.set_managed_services(crate::protocol_serde::shape_managed_services::de_managed_services(tokens)?);
                        }
            ...
            Ok(Some(crate::serde_util::odb_network_correct_errors(builder).build().map_err(|err| {
