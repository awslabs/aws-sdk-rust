    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DbServerBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "dbServerPatchingDetails" => {
                            builder = builder.set_db_server_patching_details(
                                crate::protocol_serde::shape_db_server_patching_details::de_db_server_patching_details(tokens)?,
                            );
                        }
                        "displayName" => {
                        ...
                        "vmClusterIds" => {
                            builder = builder.set_vm_cluster_ids(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "computeModel" => {
                        ...
                        "autonomousVmClusterIds" => {
                            builder = builder.set_autonomous_vm_cluster_ids(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
                        "autonomousVirtualMachineIds" => {
                            builder = builder.set_autonomous_virtual_machine_ids(crate::protocol_serde::shape_string_list::de_string_list(tokens)?);
                        }
