...
pub(crate) fn reflens_list_autonomous_database_backups_output_output_next_token(
    input: &crate::operation::list_autonomous_database_backups::ListAutonomousDatabaseBackupsOutput,
...
pub(crate) fn reflens_list_autonomous_database_character_sets_output_output_next_token(
    input: &crate::operation::list_autonomous_database_character_sets::ListAutonomousDatabaseCharacterSetsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_autonomous_database_clones_output_output_next_token(
    input: &crate::operation::list_autonomous_database_clones::ListAutonomousDatabaseClonesOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_autonomous_database_peers_output_output_next_token(
    input: &crate::operation::list_autonomous_database_peers::ListAutonomousDatabasePeersOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_autonomous_database_versions_output_output_next_token(
    input: &crate::operation::list_autonomous_database_versions::ListAutonomousDatabaseVersionsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_autonomous_databases_output_output_next_token(
    input: &crate::operation::list_autonomous_databases::ListAutonomousDatabasesOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_list_autonomous_database_backups_output_output_autonomous_database_backups(
    input: crate::operation::list_autonomous_database_backups::ListAutonomousDatabaseBackupsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabaseBackupSummary>> {
    let input = input.autonomous_database_backups;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_autonomous_database_character_sets_output_output_autonomous_database_character_sets(
    input: crate::operation::list_autonomous_database_character_sets::ListAutonomousDatabaseCharacterSetsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabaseCharacterSetSummary>> {
    let input = input.autonomous_database_character_sets;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_autonomous_database_clones_output_output_autonomous_database_clones(
    input: crate::operation::list_autonomous_database_clones::ListAutonomousDatabaseClonesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabaseSummary>> {
    let input = input.autonomous_database_clones;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_autonomous_database_peers_output_output_autonomous_database_peers(
    input: crate::operation::list_autonomous_database_peers::ListAutonomousDatabasePeersOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabasePeerSummary>> {
    let input = input.autonomous_database_peers;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_autonomous_database_versions_output_output_autonomous_database_versions(
    input: crate::operation::list_autonomous_database_versions::ListAutonomousDatabaseVersionsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabaseVersionSummary>> {
    let input = input.autonomous_database_versions;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_autonomous_databases_output_output_autonomous_databases(
    input: crate::operation::list_autonomous_databases::ListAutonomousDatabasesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AutonomousDatabaseSummary>> {
    let input = input.autonomous_databases;
    ::std::option::Option::Some(input)
}
