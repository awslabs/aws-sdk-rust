...
mod create_odb_peering_connection;
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_odb::Error> {
/// # let client: aws_sdk_odb::Client = unimplemented!();
...
mod get_cloud_exadata_infrastructure;

mod get_cloud_exadata_infrastructure_unallocated_resources;

mod get_cloud_vm_cluster;
...
mod list_cloud_autonomous_vm_clusters;

mod list_cloud_exadata_infrastructures;

mod list_cloud_vm_clusters;
...
mod list_odb_networks;

mod list_odb_peering_connections;

mod list_system_versions;
