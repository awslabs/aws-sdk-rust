...
impl super::Client {
    ...
    ///   - [`cloud_vm_cluster_id(impl Into<String>)`](crate::operation::get_db_node::builders::GetDbNodeFluentBuilder::cloud_vm_cluster_id) / [`set_cloud_vm_cluster_id(Option<String>)`](crate::operation::get_db_node::builders::GetDbNodeFluentBuilder::set_cloud_vm_cluster_id):<br>required: **false**<br><p>The unique identifier of the VM cluster that contains the DB node. You must specify either this parameter or <code>exadbVmClusterId</code>.</p><br>
    ///   - [`exadb_vm_cluster_id(impl Into<String>)`](crate::operation::get_db_node::builders::GetDbNodeFluentBuilder::exadb_vm_cluster_id) / [`set_exadb_vm_cluster_id(Option<String>)`](crate::operation::get_db_node::builders::GetDbNodeFluentBuilder::set_exadb_vm_cluster_id):<br>required: **false**<br><p>The unique identifier of the Exascale VM cluster that contains the DB node. You must specify either this parameter or <code>cloudVmClusterId</code>.</p><br>
