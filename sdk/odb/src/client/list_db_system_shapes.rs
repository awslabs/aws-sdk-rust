...
impl super::Client {
    ...
    ///   - [`shape_family(impl Into<String>)`](crate::operation::list_db_system_shapes::builders::ListDbSystemShapesFluentBuilder::shape_family) / [`set_shape_family(Option<String>)`](crate::operation::list_db_system_shapes::builders::ListDbSystemShapesFluentBuilder::set_shape_family):<br>required: **false**<br><p>The shape family to filter results by.</p><br>
