...
impl super::Client {
    ...
    ///   - [`cloud_vm_cluster_id(impl Into<String>)`](crate::operation::reboot_db_node::builders::RebootDbNodeFluentBuilder::cloud_vm_cluster_id) / [`set_cloud_vm_cluster_id(Option<String>)`](crate::operation::reboot_db_node::builders::RebootDbNodeFluentBuilder::set_cloud_vm_cluster_id):<br>required: **false**<br><p>The unique identifier of the VM cluster that contains the DB node to reboot. You must specify either this parameter or <code>exadbVmClusterId</code>.</p><br>
    ///   - [`exadb_vm_cluster_id(impl Into<String>)`](crate::operation::reboot_db_node::builders::RebootDbNodeFluentBuilder::exadb_vm_cluster_id) / [`set_exadb_vm_cluster_id(Option<String>)`](crate::operation::reboot_db_node::builders::RebootDbNodeFluentBuilder::set_exadb_vm_cluster_id):<br>required: **false**<br><p>The unique identifier of the Exascale VM cluster that contains the DB node to reboot. You must specify either this parameter or <code>cloudVmClusterId</code>.</p><br>
