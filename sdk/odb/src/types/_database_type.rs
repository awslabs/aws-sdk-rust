...
impl ::std::convert::From<&str> for DatabaseType {
    fn from(s: &str) -> Self {
        match s {
            "CLONE" => DatabaseType::Clone,
            "REGULAR" => DatabaseType::Regular,
...
impl DatabaseType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DatabaseType::Clone => "CLONE",
            DatabaseType::Regular => "REGULAR",
...
impl ::std::fmt::Display for DatabaseType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DatabaseType::Clone => write!(f, "CLONE"),
            DatabaseType::Regular => write!(f, "REGULAR"),
