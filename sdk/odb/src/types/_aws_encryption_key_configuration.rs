...
pub struct AwsEncryptionKeyConfiguration {
...
impl AwsEncryptionKeyConfiguration {
    /// <p>The Amazon Resource Name (ARN) of the Amazon Web Services Identity and Access Management (IAM) role that grants access to the KMS key.</p>
...
impl AwsEncryptionKeyConfiguration {
    /// Creates a new builder-style object to manufacture [`AwsEncryptionKeyConfiguration`](crate::types::AwsEncryptionKeyConfiguration).
    pub fn builder() -> crate::types::builders::AwsEncryptionKeyConfigurationBuilder {
        crate::types::builders::AwsEncryptionKeyConfigurationBuilder::default()
    }
}

/// A builder for [`AwsEncryptionKeyConfiguration`](crate::types::AwsEncryptionKeyConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct AwsEncryptionKeyConfigurationBuilder {
    pub(crate) iam_role_arn: ::std::option::Option<::std::string::String>,
    pub(crate) external_id_type: ::std::option::Option<crate::types::ExternalIdType>,
    pub(crate) kms_key_id: ::std::option::Option<::std::string::String>,
}
impl AwsEncryptionKeyConfigurationBuilder {
    /// <p>The Amazon Resource Name (ARN) of the Amazon Web Services Identity and Access Management (IAM) role that grants access to the KMS key.</p>
    ...
    /// Consumes the builder and constructs a [`AwsEncryptionKeyConfiguration`](crate::types::AwsEncryptionKeyConfiguration).
    pub fn build(self) -> crate::types::AwsEncryptionKeyConfiguration {
        crate::types::AwsEncryptionKeyConfiguration {
