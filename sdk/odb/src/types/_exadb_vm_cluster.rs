...
impl ExadbVmCluster {
    /// Creates a new builder-style object to manufacture [`ExadbVmCluster`](crate::types::ExadbVmCluster).
    pub fn builder() -> crate::types::builders::ExadbVmClusterBuilder {
        crate::types::builders::ExadbVmClusterBuilder::default()
    }
}

/// A builder for [`ExadbVmCluster`](crate::types::ExadbVmCluster).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ExadbVmClusterBuilder {
...
impl ExadbVmClusterBuilder {
    ...
    /// Consumes the builder and constructs a [`ExadbVmCluster`](crate::types::ExadbVmCluster).
    /// This method will fail if any of the following fields are not set:
    /// - [`exadb_vm_cluster_id`](crate::types::builders::ExadbVmClusterBuilder::exadb_vm_cluster_id)
    pub fn build(self) -> ::std::result::Result<crate::types::ExadbVmCluster, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ExadbVmCluster {
            exadb_vm_cluster_id: self.exadb_vm_cluster_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "exadb_vm_cluster_id",
                    "exadb_vm_cluster_id was not specified but it is required when building ExadbVmCluster",
                )
            })?,
