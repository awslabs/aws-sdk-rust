...
pub struct CustomerManagedAwsSecretConfiguration {
...
impl CustomerManagedAwsSecretConfiguration {
    /// <p>The Amazon Resource Name (ARN) of the Amazon Web Services Identity and Access Management (IAM) role that OCI assumes to retrieve the secret value.</p>
...
impl CustomerManagedAwsSecretConfiguration {
    /// Creates a new builder-style object to manufacture [`CustomerManagedAwsSecretConfiguration`](crate::types::CustomerManagedAwsSecretConfiguration).
    pub fn builder() -> crate::types::builders::CustomerManagedAwsSecretConfigurationBuilder {
        crate::types::builders::CustomerManagedAwsSecretConfigurationBuilder::default()
    }
}

/// A builder for [`CustomerManagedAwsSecretConfiguration`](crate::types::CustomerManagedAwsSecretConfiguration).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CustomerManagedAwsSecretConfigurationBuilder {
    pub(crate) iam_role_arn: ::std::option::Option<::std::string::String>,
    pub(crate) secret_id: ::std::option::Option<::std::string::String>,
    pub(crate) external_id_type: ::std::option::Option<crate::types::ExternalIdType>,
}
impl CustomerManagedAwsSecretConfigurationBuilder {
    /// <p>The Amazon Resource Name (ARN) of the Amazon Web Services Identity and Access Management (IAM) role that OCI assumes to retrieve the secret value.</p>
    ...
    /// Consumes the builder and constructs a [`CustomerManagedAwsSecretConfiguration`](crate::types::CustomerManagedAwsSecretConfiguration).
    pub fn build(self) -> crate::types::CustomerManagedAwsSecretConfiguration {
        crate::types::CustomerManagedAwsSecretConfiguration {
