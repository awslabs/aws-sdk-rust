...
impl ::std::convert::From<&str> for FailoverMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FailoverMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FailoverMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FailoverMode::from(s))
    }
}
impl FailoverMode {
...
impl ::std::convert::AsRef<str> for FailoverMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
