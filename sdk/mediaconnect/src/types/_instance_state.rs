...
///     InstanceState::Deregistered => { /* ... */ },
///     InstanceState::Deregistering => { /* ... */ },
///     InstanceState::DeregistrationError => { /* ... */ },
///     InstanceState::Registering => { /* ... */ },
///     InstanceState::RegistrationError => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `instancestate` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `InstanceState::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `InstanceState::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `InstanceState::NewFeature` is defined.
...
"DEREGISTRATION_ERROR" => InstanceState::DeregistrationError,
"REGISTERING" => InstanceState::Registering,
"REGISTRATION_ERROR" => InstanceState::RegistrationError,
other => InstanceState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned()))
                        }
                    }
                }
impl ::std::str::FromStr for InstanceState {
                    ...
                    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                        ::std::result::Result::Ok(InstanceState::from(s))
                    }
                }
impl InstanceState {
    ...
    InstanceState::Deregistered => "DEREGISTERED",
    InstanceState::Deregistering => "DEREGISTERING",
    InstanceState::DeregistrationError => "DEREGISTRATION_ERROR",
    InstanceState::Registering => "REGISTERING",
    InstanceState::RegistrationError => "REGISTRATION_ERROR",
    InstanceState::Unknown(value) => value.as_str()
}
                }
                /// Returns all the `&str` representations of the enum members.
                pub const fn values() -> &'static [&'static str] {
                    &["ACTIVE", "DEREGISTERED", "DEREGISTERING", "DEREGISTRATION_ERROR", "REGISTERING", "REGISTRATION_ERROR"]
                }
            }
