...
/// When writing a match expression against `RouterInputType`, it is important to ensure
...
///
/// ```text
/// # let routerinputtype = unimplemented!();
...
/// }
/// ```
/// The above code demonstrates that when `routerinputtype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `RouterInputType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `RouterInputType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `RouterInputType::NewFeature` is defined.
/// Specifically, when `routerinputtype` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `RouterInputType::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for RouterInputType {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for RouterInputType {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(RouterInputType::from(s))
    }
}
impl RouterInputType {
...
impl ::std::fmt::Display for RouterInputType {
