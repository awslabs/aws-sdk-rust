...
pub struct UpdateFlowMediaStreamOutput  {
    ...
    #[doc(hidden)]pub media_stream: std::option::Option<crate::model::MediaStream>,
}
...
pub struct UpdateFlowEntitlementOutput  {
    ...
    #[doc(hidden)]pub entitlement: std::option::Option<crate::model::Entitlement>,
...
pub struct UpdateFlowOutput  {
    ...
    #[doc(hidden)]pub flow: std::option::Option<crate::model::Flow>,
}
...
pub struct RemoveFlowVpcInterfaceOutput  {
    ...
    #[doc(hidden)]pub non_deleted_network_interface_ids: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for RemoveFlowVpcInterfaceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("flow_arn", &self.flow_arn);
        formatter.field("non_deleted_network_interface_ids", &self.non_deleted_network_interface_ids);
...
pub struct PurchaseOfferingOutput  {
    ...
    #[doc(hidden)]pub reservation: std::option::Option<crate::model::Reservation>,
}
...
pub struct ListReservationsOutput  {
    ...
    #[doc(hidden)]pub reservations: std::option::Option<std::vec::Vec<crate::model::Reservation>>,
}
...
pub struct ListOfferingsOutput  {
    ...
    #[doc(hidden)]pub offerings: std::option::Option<std::vec::Vec<crate::model::Offering>>,
}
...
pub struct ListFlowsOutput  {
    ...
    #[doc(hidden)]pub flows: std::option::Option<std::vec::Vec<crate::model::ListedFlow>>,
...
pub struct ListEntitlementsOutput  {
    ...
    #[doc(hidden)]pub entitlements: std::option::Option<std::vec::Vec<crate::model::ListedEntitlement>>,
...
pub struct GrantFlowEntitlementsOutput  {
    ...
    #[doc(hidden)]pub entitlements: std::option::Option<std::vec::Vec<crate::model::Entitlement>>,
...
pub struct DescribeOfferingOutput  {
    ...
    #[doc(hidden)]pub offering: std::option::Option<crate::model::Offering>,
}
...
pub struct DescribeFlowOutput  {
    ...
    #[doc(hidden)]pub messages: std::option::Option<crate::model::Messages>,
}
...
pub struct AddFlowVpcInterfacesOutput  {
    ...
    #[doc(hidden)]pub vpc_interfaces: std::option::Option<std::vec::Vec<crate::model::VpcInterface>>,
}
...
pub struct AddFlowSourcesOutput  {
    ...
    #[doc(hidden)]pub sources: std::option::Option<std::vec::Vec<crate::model::Source>>,
}
...
pub struct AddFlowMediaStreamsOutput  {
    ...
    #[doc(hidden)]pub media_streams: std::option::Option<std::vec::Vec<crate::model::MediaStream>>,
}
