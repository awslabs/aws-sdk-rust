...
/// Orchestration and serialization glue logic for `AddFlowVpcInterfaces`.
...
impl AddFlowVpcInterfaces {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddFlowVpcInterfaces {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddFlowVpcInterfaces");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddFlowVpcInterfacesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddFlowVpcInterfacesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddFlowVpcInterfaces")
...
.with_interceptor(AddFlowVpcInterfacesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError>::new());
...
#[derive(Debug)]
            struct AddFlowVpcInterfacesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddFlowVpcInterfacesResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_add_flow_vpc_interfaces::de_add_flow_vpc_interfaces_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_add_flow_vpc_interfaces::de_add_flow_vpc_interfaces_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AddFlowVpcInterfacesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddFlowVpcInterfacesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/flows/{FlowArn}/vpcInterfaces", FlowArn = flow_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_flow_vpc_interfaces::ser_add_flow_vpc_interfaces_input(&input)?);
...
#[derive(Debug)]
            struct AddFlowVpcInterfacesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddFlowVpcInterfacesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddFlowVpcInterfacesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddFlowVpcInterfacesInput>()
                        .ok_or("failed to downcast to AddFlowVpcInterfacesInput")?;
...
pub enum AddFlowVpcInterfacesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddFlowVpcInterfacesError) for what information is available for the error.")]
...
impl AddFlowVpcInterfacesError {
    /// Creates the `AddFlowVpcInterfacesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddFlowVpcInterfacesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddFlowVpcInterfacesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError {
...
mod _add_flow_vpc_interfaces_output;
