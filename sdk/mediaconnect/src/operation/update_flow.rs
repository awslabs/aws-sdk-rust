...
impl UpdateFlowInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_flow::UpdateFlow, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_flow::ser_update_flow_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFlow {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_flow::de_update_flow_http_response_with_props(status, headers, body)
        }
    }
}
