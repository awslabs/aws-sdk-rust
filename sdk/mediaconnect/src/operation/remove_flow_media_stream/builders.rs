...
impl RemoveFlowMediaStreamFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamOutput, crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError, Self> {
