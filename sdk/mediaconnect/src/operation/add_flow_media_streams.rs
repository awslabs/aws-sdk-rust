...
impl AddFlowMediaStreamsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_flow_media_streams::ser_add_flow_media_streams_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_flow_media_streams::AddFlowMediaStreams::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_flow_media_streams::AddFlowMediaStreamsError
{
