...
/// Orchestration and serialization glue logic for `AddFlowMediaStreams`.
...
impl AddFlowMediaStreams {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::add_flow_media_streams::AddFlowMediaStreamsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_flow_media_streams::AddFlowMediaStreamsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddFlowMediaStreams {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddFlowMediaStreams");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddFlowMediaStreamsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddFlowMediaStreamsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddFlowMediaStreams")
...
.with_interceptor(AddFlowMediaStreamsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsError>::new());
...
#[derive(Debug)]
            struct AddFlowMediaStreamsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddFlowMediaStreamsResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_add_flow_media_streams::de_add_flow_media_streams_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_add_flow_media_streams::de_add_flow_media_streams_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AddFlowMediaStreamsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddFlowMediaStreamsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_flow_media_streams::AddFlowMediaStreamsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_flow_media_streams::AddFlowMediaStreamsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/flows/{FlowArn}/mediaStreams", FlowArn = flow_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_flow_media_streams::ser_add_flow_media_streams_input(&input)?);
...
#[derive(Debug)]
            struct AddFlowMediaStreamsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddFlowMediaStreamsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddFlowMediaStreamsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddFlowMediaStreamsInput>()
                        .ok_or("failed to downcast to AddFlowMediaStreamsInput")?;
...
pub enum AddFlowMediaStreamsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddFlowMediaStreamsError) for what information is available for the error.")]
...
impl AddFlowMediaStreamsError {
    /// Creates the `AddFlowMediaStreamsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddFlowMediaStreamsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddFlowMediaStreamsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_flow_media_streams::AddFlowMediaStreamsError {
...
mod _add_flow_media_streams_output;
