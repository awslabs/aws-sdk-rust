...
impl RevokeFlowEntitlement {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementInput,
                    ) -> ::std::result::Result<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RevokeFlowEntitlement {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RevokeFlowEntitlement");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RevokeFlowEntitlementRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RevokeFlowEntitlementResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RevokeFlowEntitlement")
...
.with_interceptor(RevokeFlowEntitlementEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError>::new());
...
#[derive(Debug)]
            struct RevokeFlowEntitlementResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RevokeFlowEntitlementResponseDeserializer {
            ...
            let parse_result = if !success && status != 202 || force_error {
                crate::protocol_serde::shape_revoke_flow_entitlement::de_revoke_flow_entitlement_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RevokeFlowEntitlementRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RevokeFlowEntitlementRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.entitlement_arn;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("entitlement_arn", "cannot be empty or unset"))?;
    let entitlement_arn = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if entitlement_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("entitlement_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v1/flows/{FlowArn}/entitlements/{EntitlementArn}", FlowArn = flow_arn, EntitlementArn = entitlement_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct RevokeFlowEntitlementEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RevokeFlowEntitlementEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RevokeFlowEntitlementEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RevokeFlowEntitlementInput>()
                        .ok_or("failed to downcast to RevokeFlowEntitlementInput")?;
...
pub enum RevokeFlowEntitlementError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RevokeFlowEntitlementError) for what information is available for the error.")]
...
impl RevokeFlowEntitlementError {
    /// Creates the `RevokeFlowEntitlementError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeFlowEntitlementError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RevokeFlowEntitlementError {
...
impl ::aws_types::request_id::RequestId for crate::operation::revoke_flow_entitlement::RevokeFlowEntitlementError {
...
mod _revoke_flow_entitlement_output;
