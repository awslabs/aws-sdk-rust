...
impl UpdateBridgeOutputFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::update_bridge_output::UpdateBridgeOutput, aws_http::retry::AwsResponseRetryClassifier,>,
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_bridge_output::UpdateBridgeOutputOutput, aws_smithy_http::result::SdkError<crate::operation::update_bridge_output::UpdateBridgeOutputError>>
                     {
