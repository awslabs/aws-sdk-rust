...
impl RemoveFlowVpcInterface {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceInput,
                    ) -> ::std::result::Result<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveFlowVpcInterface {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveFlowVpcInterface");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveFlowVpcInterfaceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveFlowVpcInterfaceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveFlowVpcInterface")
...
.with_interceptor(RemoveFlowVpcInterfaceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError>::new());
...
#[derive(Debug)]
            struct RemoveFlowVpcInterfaceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveFlowVpcInterfaceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_flow_vpc_interface::de_remove_flow_vpc_interface_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RemoveFlowVpcInterfaceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveFlowVpcInterfaceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.vpc_interface_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("vpc_interface_name", "cannot be empty or unset"))?;
    let vpc_interface_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if vpc_interface_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("vpc_interface_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v1/flows/{FlowArn}/vpcInterfaces/{VpcInterfaceName}", FlowArn = flow_arn, VpcInterfaceName = vpc_interface_name).expect("formatting should succeed");
...
#[derive(Debug)]
            struct RemoveFlowVpcInterfaceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveFlowVpcInterfaceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveFlowVpcInterfaceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveFlowVpcInterfaceInput>()
                        .ok_or("failed to downcast to RemoveFlowVpcInterfaceInput")?;
...
pub enum RemoveFlowVpcInterfaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveFlowVpcInterfaceError) for what information is available for the error.")]
...
impl RemoveFlowVpcInterfaceError {
    /// Creates the `RemoveFlowVpcInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveFlowVpcInterfaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveFlowVpcInterfaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_flow_vpc_interface::RemoveFlowVpcInterfaceError {
...
mod _remove_flow_vpc_interface_output;
