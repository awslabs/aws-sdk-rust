    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::add_bridge_outputs::AddBridgeOutputsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::add_bridge_outputs::AddBridgeOutputsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddBridgeOutputs {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("AddBridgeOutputs", "mediaconnect"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddBridgeOutputs")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(AddBridgeOutputsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for AddBridgeOutputsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for AddBridgeOutputsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::add_bridge_outputs::AddBridgeOutputsInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_bridge_outputs::ser_add_bridge_outputs_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for AddBridgeOutputsEndpointParamsInterceptor {
...
pub type AddBridgeOutputsErrorKind = AddBridgeOutputsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for AddBridgeOutputsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::add_bridge_outputs::AddBridgeOutputsError {
...
impl AddBridgeOutputsError {
    ...
    /// Creates the `AddBridgeOutputsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
