...
impl AddBridgeOutputsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_bridge_outputs::ser_add_bridge_outputs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddBridgeOutputs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_add_bridge_outputs::de_add_bridge_outputs_http_response_with_props(status, headers, body)
        }
    }
}
