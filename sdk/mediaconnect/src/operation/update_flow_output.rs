...
impl UpdateFlowOutputInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_flow_output::ser_update_flow_output_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFlowOutput {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_flow_output::de_update_flow_output_http_response_with_props(status, headers, body)
        }
    }
}
