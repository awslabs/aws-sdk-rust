    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/flows/{FlowArn}/source", FlowArn = flow_arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_flow_sources::AddFlowSources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddFlowSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_add_flow_sources::de_add_flow_sources_http_error(
                status, headers, body,
            )
        } else {
