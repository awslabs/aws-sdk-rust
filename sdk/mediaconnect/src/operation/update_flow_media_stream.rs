...
impl UpdateFlowMediaStream {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFlowMediaStream {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateFlowMediaStream");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateFlowMediaStreamRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateFlowMediaStreamResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateFlowMediaStream")
...
.with_interceptor(UpdateFlowMediaStreamEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError>::new());
...
#[derive(Debug)]
            struct UpdateFlowMediaStreamResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateFlowMediaStreamResponseDeserializer {
            ...
            let parse_result = if !success && status != 202 || force_error {
                crate::protocol_serde::shape_update_flow_media_stream::de_update_flow_media_stream_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateFlowMediaStreamRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateFlowMediaStreamRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_flow_media_stream::UpdateFlowMediaStreamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_flow_media_stream::UpdateFlowMediaStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.media_stream_name;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("media_stream_name", "cannot be empty or unset"))?;
    let media_stream_name = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if media_stream_name.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("media_stream_name", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v1/flows/{FlowArn}/mediaStreams/{MediaStreamName}", FlowArn = flow_arn, MediaStreamName = media_stream_name).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_flow_media_stream::ser_update_flow_media_stream_input(&input)?);
...
#[derive(Debug)]
            struct UpdateFlowMediaStreamEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateFlowMediaStreamEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateFlowMediaStreamEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateFlowMediaStreamInput>()
                        .ok_or("failed to downcast to UpdateFlowMediaStreamInput")?;
...
pub enum UpdateFlowMediaStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateFlowMediaStreamError) for what information is available for the error.")]
...
impl UpdateFlowMediaStreamError {
    /// Creates the `UpdateFlowMediaStreamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateFlowMediaStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateFlowMediaStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_flow_media_stream::UpdateFlowMediaStreamError {
...
mod _update_flow_media_stream_output;
