...
impl PurchaseOfferingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::purchase_offering::PurchaseOffering, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_purchase_offering::ser_purchase_offering_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseOffering {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_purchase_offering::de_purchase_offering_http_response_with_props(status, headers, body)
        }
    }
}
