...
impl PurchaseOfferingInput {
    /// Consumes the builder and constructs an Operation<[`PurchaseOffering`](crate::operation::purchase_offering::PurchaseOffering)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::purchase_offering::PurchaseOffering, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purchase_offering::PurchaseOfferingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.offering_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("offering_arn", "cannot be empty or unset"))?;
                ...
                if offering_arn.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("offering_arn", "cannot be empty or unset"))
                            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_purchase_offering::ser_purchase_offering_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_offering::PurchaseOffering::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PurchaseOffering {
                type Output = std::result::Result<crate::operation::purchase_offering::PurchaseOfferingOutput, crate::operation::purchase_offering::PurchaseOfferingError>;
