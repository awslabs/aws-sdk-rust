...
/// Orchestration and serialization glue logic for `GrantFlowEntitlements`.
...
impl GrantFlowEntitlements {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GrantFlowEntitlements {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GrantFlowEntitlements");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GrantFlowEntitlementsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GrantFlowEntitlementsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GrantFlowEntitlements")
...
.with_interceptor(GrantFlowEntitlementsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError>::new());
...
#[derive(Debug)]
            struct GrantFlowEntitlementsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GrantFlowEntitlementsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_grant_flow_entitlements::de_grant_flow_entitlements_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GrantFlowEntitlementsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GrantFlowEntitlementsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::grant_flow_entitlements::GrantFlowEntitlementsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::grant_flow_entitlements::GrantFlowEntitlementsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/v1/flows/{FlowArn}/entitlements", FlowArn = flow_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_grant_flow_entitlements::ser_grant_flow_entitlements_input(&input)?);
...
#[derive(Debug)]
            struct GrantFlowEntitlementsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GrantFlowEntitlementsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GrantFlowEntitlementsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GrantFlowEntitlementsInput>()
                        .ok_or("failed to downcast to GrantFlowEntitlementsInput")?;
...
pub enum GrantFlowEntitlementsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GrantFlowEntitlementsError) for what information is available for the error.")]
...
impl GrantFlowEntitlementsError {
    /// Creates the `GrantFlowEntitlementsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GrantFlowEntitlementsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::GrantFlowEntitlements420Exception(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GrantFlowEntitlementsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError {
...
mod _grant_flow_entitlements_output;
