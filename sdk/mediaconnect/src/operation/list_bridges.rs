...
impl ListBridgesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_bridges::ListBridges::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBridges {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_bridges::de_list_bridges_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_bridges::de_list_bridges_http_response_with_props(
                status, headers, body,
            )
        }
    }
