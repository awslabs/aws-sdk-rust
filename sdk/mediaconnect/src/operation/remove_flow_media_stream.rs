...
impl RemoveFlowMediaStream {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamInput,
                    ) -> ::std::result::Result<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveFlowMediaStream {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveFlowMediaStream");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveFlowMediaStreamRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveFlowMediaStreamResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveFlowMediaStream")
...
.with_interceptor(RemoveFlowMediaStreamEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError>::new());
...
#[derive(Debug)]
            struct RemoveFlowMediaStreamResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveFlowMediaStreamResponseDeserializer {
...
#[derive(Debug)]
            struct RemoveFlowMediaStreamRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveFlowMediaStreamRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct RemoveFlowMediaStreamEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveFlowMediaStreamEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveFlowMediaStreamEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveFlowMediaStreamInput>()
                        .ok_or("failed to downcast to RemoveFlowMediaStreamInput")?;
...
pub enum RemoveFlowMediaStreamError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveFlowMediaStreamError) for what information is available for the error.")]
...
impl RemoveFlowMediaStreamError {
    /// Creates the `RemoveFlowMediaStreamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveFlowMediaStreamError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveFlowMediaStreamError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_flow_media_stream::RemoveFlowMediaStreamError {
...
mod _remove_flow_media_stream_output;
