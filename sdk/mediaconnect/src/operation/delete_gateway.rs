    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let gateway_arn = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_gateway::DeleteGateway::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGateway {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_gateway::de_delete_gateway_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_gateway::de_delete_gateway_http_response_with_props(
                status, headers, body,
            )
        }
    }
