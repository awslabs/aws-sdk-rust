...
impl AddBridgeSourcesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_add_bridge_sources::ser_add_bridge_sources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddBridgeSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_add_bridge_sources::de_add_bridge_sources_http_response_with_props(status, headers, body)
        }
    }
}
