    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/flows/{FlowArn}/outputs", FlowArn = flow_arn)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_flow_outputs::AddFlowOutputs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddFlowOutputs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_add_flow_outputs::de_add_flow_outputs_http_error(
                status, headers, body,
            )
        } else {
