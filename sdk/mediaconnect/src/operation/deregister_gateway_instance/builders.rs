...
impl DeregisterGatewayInstanceFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceOutput, aws_smithy_http::result::SdkError<crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError>>
                     {
