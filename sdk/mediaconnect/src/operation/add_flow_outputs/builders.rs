...
impl AddFlowOutputsFluentBuilder  {
    /// Creates a new `AddFlowOutputs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::add_flow_outputs::AddFlowOutputsOutput, aws_smithy_http::result::SdkError<crate::operation::add_flow_outputs::AddFlowOutputsError>>
                     {
