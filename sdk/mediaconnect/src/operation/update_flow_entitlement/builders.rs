...
impl UpdateFlowEntitlementFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_flow_entitlement::UpdateFlowEntitlementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_flow_entitlement::UpdateFlowEntitlementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_flow_entitlement::UpdateFlowEntitlementOutput, crate::operation::update_flow_entitlement::UpdateFlowEntitlementError, Self> {
