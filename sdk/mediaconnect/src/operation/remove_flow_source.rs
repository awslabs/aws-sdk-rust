...
impl RemoveFlowSourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_flow_source::RemoveFlowSource,
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveFlowSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_remove_flow_source::de_remove_flow_source_http_response_with_props(status, headers, body)
        }
    }
}
