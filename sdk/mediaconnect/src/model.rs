...
pub struct Source  {
    ...
    #[doc(hidden)]pub data_transfer_subscriber_fee_percent: i32,
    /// The type of encryption that is used on the content ingested from this source.
    #[doc(hidden)]pub decryption: std::option::Option<crate::model::Encryption>,
    ...
    #[doc(hidden)]pub ingest_ip: std::option::Option<std::string::String>,
    /// The port that the flow will be listening on for incoming content.
    #[doc(hidden)]pub ingest_port: i32,
    /// The media streams that are associated with the source, and the parameters for those associations.
    #[doc(hidden)]pub media_stream_source_configurations: std::option::Option<std::vec::Vec<crate::model::MediaStreamSourceConfiguration>>,
    ...
    #[doc(hidden)]pub transport: std::option::Option<crate::model::Transport>,
...
impl  std::fmt::Debug for Source  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("data_transfer_subscriber_fee_percent", &self.data_transfer_subscriber_fee_percent);
...
pub struct MediaStreamSourceConfiguration  {
    ...
    #[doc(hidden)]pub encoding_name: std::option::Option<crate::model::EncodingName>,
...
pub struct InputConfiguration  {
    ...
    #[doc(hidden)]pub input_ip: std::option::Option<std::string::String>,
    /// The port that the flow listens on for an incoming media stream.
    #[doc(hidden)]pub input_port: i32,
    /// The VPC interface where the media stream comes in from.
    #[doc(hidden)]pub interface: std::option::Option<crate::model::Interface>,
}
...
pub struct MediaStreamSourceConfigurationRequest  {
    ...
    #[doc(hidden)]pub input_configurations: std::option::Option<std::vec::Vec<crate::model::InputConfigurationRequest>>,
    /// The name of the media stream.
    #[doc(hidden)]pub media_stream_name: std::option::Option<std::string::String>,
}
...
pub struct InputConfigurationRequest  {
    ...
    #[doc(hidden)]pub interface: std::option::Option<crate::model::InterfaceRequest>,
}
...
pub struct Output  {
    ...
    #[doc(hidden)]pub listener_address: std::option::Option<std::string::String>,
    /// The input ARN of the AWS Elemental MediaLive channel. This parameter is relevant only for outputs that were added by creating a MediaLive input.
    #[doc(hidden)]pub media_live_input_arn: std::option::Option<std::string::String>,
    /// The configuration for each media stream that is associated with the output.
    #[doc(hidden)]pub media_stream_output_configurations: std::option::Option<std::vec::Vec<crate::model::MediaStreamOutputConfiguration>>,
...
pub struct MediaStreamOutputConfiguration  {
    ...
    #[doc(hidden)]pub destination_configurations: std::option::Option<std::vec::Vec<crate::model::DestinationConfiguration>>,
    /// The format that was used to encode the data. For ancillary data streams, set the encoding name to smpte291. For audio streams, set the encoding name to pcm. For video, 2110 streams, set the encoding name to raw. For video, JPEG XS streams, set the encoding name to jxsv.
    #[doc(hidden)]pub encoding_name: std::option::Option<crate::model::EncodingName>,
    /// Encoding parameters
    #[doc(hidden)]pub encoding_parameters: std::option::Option<crate::model::EncodingParameters>,
    /// The name of the media stream.
    #[doc(hidden)]pub media_stream_name: std::option::Option<std::string::String>,
}
...
pub struct EncodingParameters  {
    ...
    #[doc(hidden)]pub compression_factor: f64,
    /// A setting on the encoder that drives compression settings. This property only applies to video media streams associated with outputs that use the ST 2110 JPEG XS protocol, with a flow source that uses the CDI protocol.
    #[doc(hidden)]pub encoder_profile: std::option::Option<crate::model::EncoderProfile>,
}
...
pub struct DestinationConfiguration  {
    ...
    #[doc(hidden)]pub destination_ip: std::option::Option<std::string::String>,
    /// The port to use when the content of the media stream is distributed to the output.
    #[doc(hidden)]pub destination_port: i32,
    /// The VPC interface that is used for the media stream associated with the output.
    #[doc(hidden)]pub interface: std::option::Option<crate::model::Interface>,
    /// The IP address that the receiver requires in order to establish a connection with the flow. This value is represented by the elastic network interface IP address of the VPC. This field applies only to outputs that use the CDI or ST 2110 JPEG XS protocol.
    #[doc(hidden)]pub outbound_ip: std::option::Option<std::string::String>,
}
...
pub struct MediaStreamOutputConfigurationRequest  {
    /// The transport parameters that you want to associate with the media stream.
    #[doc(hidden)]pub destination_configurations: std::option::Option<std::vec::Vec<crate::model::DestinationConfigurationRequest>>,
    /// The format that will be used to encode the data. For ancillary data streams, set the encoding name to smpte291. For audio streams, set the encoding name to pcm. For video, 2110 streams, set the encoding name to raw. For video, JPEG XS streams, set the encoding name to jxsv.
    #[doc(hidden)]pub encoding_name: std::option::Option<crate::model::EncodingName>,
    /// A collection of parameters that determine how MediaConnect will convert the content. These fields only apply to outputs on flows that have a CDI source.
    #[doc(hidden)]pub encoding_parameters: std::option::Option<crate::model::EncodingParametersRequest>,
...
pub struct MediaStream  {
    ...
    #[doc(hidden)]pub attributes: std::option::Option<crate::model::MediaStreamAttributes>,
    /// The sample rate for the stream. This value is measured in Hz.
    #[doc(hidden)]pub clock_rate: i32,
    /// A description that can help you quickly identify what your media stream is used for.
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// The format type number (sometimes referred to as RTP payload type) of the media stream. MediaConnect assigns this value to the media stream. For ST 2110 JPEG XS outputs, you need to provide this value to the receiver.
    #[doc(hidden)]pub fmt: i32,
    /// A unique identifier for the media stream.
    #[doc(hidden)]pub media_stream_id: i32,
...
pub struct MediaStreamAttributes  {
    ...
    #[doc(hidden)]pub fmtp: std::option::Option<crate::model::Fmtp>,
    /// The audio language, in a format that is recognized by the receiver.
    #[doc(hidden)]pub lang: std::option::Option<std::string::String>,
}
...
pub struct Fmtp  {
    ...
    #[doc(hidden)]pub channel_order: std::option::Option<std::string::String>,
    /// The format that is used for the representation of color.
    #[doc(hidden)]pub colorimetry: std::option::Option<crate::model::Colorimetry>,
    /// The frame rate for the video stream, in frames/second. For example: 60000/1001. If you specify a whole number, MediaConnect uses a ratio of N/1. For example, if you specify 60, MediaConnect uses 60/1 as the exactFramerate.
    #[doc(hidden)]pub exact_framerate: std::option::Option<std::string::String>,
    /// The pixel aspect ratio (PAR) of the video.
    #[doc(hidden)]pub par: std::option::Option<std::string::String>,
    /// The encoding range of the video.
    #[doc(hidden)]pub range: std::option::Option<crate::model::Range>,
    /// The type of compression that was used to smooth the video’s appearance
    #[doc(hidden)]pub scan_mode: std::option::Option<crate::model::ScanMode>,
    /// The transfer characteristic system (TCS) that is used in the video.
    #[doc(hidden)]pub tcs: std::option::Option<crate::model::Tcs>,
}
impl Fmtp {
    /// The format of the audio channel.
...
pub struct MediaStreamAttributesRequest  {
    ...
    #[doc(hidden)]pub fmtp: std::option::Option<crate::model::FmtpRequest>,
    /// The audio language, in a format that is recognized by the receiver.
    #[doc(hidden)]pub lang: std::option::Option<std::string::String>,
}
...
pub struct Flow  {
    ...
    #[doc(hidden)]pub egress_ip: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub maintenance: std::option::Option<crate::model::Maintenance>,
}
impl Flow {
    /// The Availability Zone that you want to create the flow in. These options are limited to the Availability Zones within the current AWS.
...
pub struct Maintenance  {
    ...
    #[doc(hidden)]pub maintenance_day: std::option::Option<crate::model::MaintenanceDay>,
    /// The Maintenance has to be performed before this deadline in ISO UTC format. Example: 2021-01-30T08:30:00Z.
    #[doc(hidden)]pub maintenance_deadline: std::option::Option<std::string::String>,
    /// A scheduled date in ISO UTC format when the maintenance will happen. Use YYYY-MM-DD format. Example: 2021-01-30.
    #[doc(hidden)]pub maintenance_scheduled_date: std::option::Option<std::string::String>,
    /// UTC time when the maintenance will happen. Use 24-hour HH:MM format. Minutes must be 00. Example: 13:00. The default value is 02:00.
    #[doc(hidden)]pub maintenance_start_hour: std::option::Option<std::string::String>,
}
impl Maintenance {
    /// A day of a week when the maintenance will happen. Use Monday/Tuesday/Wednesday/Thursday/Friday/Saturday/Sunday.
...
impl  std::fmt::Debug for Maintenance  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("maintenance_scheduled_date", &self.maintenance_scheduled_date);
...
pub struct VpcInterface  {
    ...
    #[doc(hidden)]pub network_interface_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    /// The type of network interface.
    #[doc(hidden)]pub network_interface_type: std::option::Option<crate::model::NetworkInterfaceType>,
...
pub struct FailoverConfig  {
    ...
    #[doc(hidden)]pub failover_mode: std::option::Option<crate::model::FailoverMode>,
    /// Search window time to look for dash-7 packets
    #[doc(hidden)]pub recovery_window: i32,
    /// The priority you want to assign to a source. You can have a primary stream and a backup stream or two equally prioritized streams.
    #[doc(hidden)]pub source_priority: std::option::Option<crate::model::SourcePriority>,
    #[allow(missing_docs)] // documentation missing in model
...
pub struct SourcePriority  {
    ...
    #[doc(hidden)]pub primary_source: std::option::Option<std::string::String>,
}
impl SourcePriority {
    /// The name of the source you choose as the primary source for this flow.
...
pub struct Reservation  {
    ...
    #[doc(hidden)]pub duration_units: std::option::Option<crate::model::DurationUnits>,
    ...
    #[doc(hidden)]pub price_per_unit: std::option::Option<std::string::String>,
    /// The unit of measurement that is used for billing. This value, in combination with pricePerUnit, makes up the rate. MediaConnect defines this value in the offering.
    #[doc(hidden)]pub price_units: std::option::Option<crate::model::PriceUnits>,
    ...
    #[doc(hidden)]pub reservation_state: std::option::Option<crate::model::ReservationState>,
    /// A definition of the amount of outbound bandwidth that you would be reserving if you purchase the offering. MediaConnect defines the values that make up the resourceSpecification in the offering.
    #[doc(hidden)]pub resource_specification: std::option::Option<crate::model::ResourceSpecification>,
...
pub struct ResourceSpecification  {
    ...
    #[doc(hidden)]pub reserved_bitrate: i32,
...
pub struct ListedEntitlement  {
    ...
    #[doc(hidden)]pub entitlement_arn: std::option::Option<std::string::String>,
    /// The name of the entitlement.
    #[doc(hidden)]pub entitlement_name: std::option::Option<std::string::String>,
}
...
pub struct Messages  {
    ...
    #[doc(hidden)]pub errors: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Messages {
    /// A list of errors that might have been generated from processes on this flow.
