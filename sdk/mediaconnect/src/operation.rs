...
impl smithy_http::response::ParseStrictResponse for AddFlowMediaStreams {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::operation_ser::parse_add_flow_media_streams_error(response)
        } else {
            crate::operation_ser::parse_add_flow_media_streams_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for AddFlowOutputs {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::operation_ser::parse_add_flow_outputs_error(response)
        } else {
            crate::operation_ser::parse_add_flow_outputs_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for AddFlowSources {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::operation_ser::parse_add_flow_sources_error(response)
        } else {
            crate::operation_ser::parse_add_flow_sources_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for AddFlowVpcInterfaces {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::operation_ser::parse_add_flow_vpc_interfaces_error(response)
        } else {
            crate::operation_ser::parse_add_flow_vpc_interfaces_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for CreateFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::operation_ser::parse_create_flow_error(response)
        } else {
            crate::operation_ser::parse_create_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DeleteFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_delete_flow_error(response)
        } else {
            crate::operation_ser::parse_delete_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DescribeFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_flow_error(response)
        } else {
            crate::operation_ser::parse_describe_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for GrantFlowEntitlements {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_grant_flow_entitlements_error(response)
        } else {
            crate::operation_ser::parse_grant_flow_entitlements_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for ListEntitlements {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_list_entitlements_error(response)
        } else {
            crate::operation_ser::parse_list_entitlements_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for ListFlows {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_list_flows_error(response)
        } else {
            crate::operation_ser::parse_list_flows_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RemoveFlowMediaStream {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_remove_flow_media_stream_error(response)
        } else {
            crate::operation_ser::parse_remove_flow_media_stream_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RemoveFlowOutput {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_remove_flow_output_error(response)
        } else {
            crate::operation_ser::parse_remove_flow_output_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RemoveFlowSource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_remove_flow_source_error(response)
        } else {
            crate::operation_ser::parse_remove_flow_source_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RemoveFlowVpcInterface {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_remove_flow_vpc_interface_error(response)
        } else {
            crate::operation_ser::parse_remove_flow_vpc_interface_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for RevokeFlowEntitlement {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_revoke_flow_entitlement_error(response)
        } else {
            crate::operation_ser::parse_revoke_flow_entitlement_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for StartFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_start_flow_error(response)
        } else {
            crate::operation_ser::parse_start_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for StopFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_stop_flow_error(response)
        } else {
            crate::operation_ser::parse_stop_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateFlow {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_update_flow_error(response)
        } else {
            crate::operation_ser::parse_update_flow_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateFlowEntitlement {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_update_flow_entitlement_error(response)
        } else {
            crate::operation_ser::parse_update_flow_entitlement_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateFlowMediaStream {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_update_flow_media_stream_error(response)
        } else {
            crate::operation_ser::parse_update_flow_media_stream_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateFlowOutput {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_update_flow_output_error(response)
        } else {
            crate::operation_ser::parse_update_flow_output_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for UpdateFlowSource {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 202 {
            crate::operation_ser::parse_update_flow_source_error(response)
        } else {
            crate::operation_ser::parse_update_flow_source_response(response)
        }
    }
}
