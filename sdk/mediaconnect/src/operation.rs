...
impl aws_smithy_http::response::ParseStrictResponse for AddFlowOutputs {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        ...
                        crate::protocol_serde::shape_add_flow_outputs::de_add_flow_outputs_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for AddFlowSources {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        ...
                        crate::protocol_serde::shape_add_flow_sources::de_add_flow_sources_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFlowSource {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 202 {
                        crate::protocol_serde::shape_update_flow_source::de_update_flow_source_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_flow_source::de_update_flow_source_http_response(response)
                     }
                }
            }
