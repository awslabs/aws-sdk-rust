...
pub(crate) fn reflens_structure_crate_output_list_entitlements_output_next_token(
    input: &crate::output::ListEntitlementsOutput,
...
pub(crate) fn lens_structure_crate_output_list_entitlements_output_entitlements(
    input: crate::output::ListEntitlementsOutput,
...
pub(crate) fn lens_structure_crate_output_list_flows_output_flows(
    input: crate::output::ListFlowsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ListedFlow>> {
