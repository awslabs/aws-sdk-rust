...
pub fn de_start_flow_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::start_flow::StartFlowOutput, crate::operation::start_flow::StartFlowError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::start_flow::builders::StartFlowOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
