...
pub fn ser_add_bridge_network_output_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AddBridgeNetworkOutputRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
