...
pub fn de_add_bridge_outputs_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::add_bridge_outputs::AddBridgeOutputsOutput, crate::operation::add_bridge_outputs::AddBridgeOutputsError> {
    #[allow(unused_mut)]
...
pub fn de_add_bridge_outputs_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_add_bridge_outputs::de_add_bridge_outputs(_response_body, output)
            .map_err(crate::operation::add_bridge_outputs::AddBridgeOutputsError::unhandled)?;
...
) -> Result<crate::operation::add_bridge_outputs::builders::AddBridgeOutputsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
