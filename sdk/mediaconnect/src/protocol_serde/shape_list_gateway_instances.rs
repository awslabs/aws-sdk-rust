...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_gateway_instances::de_list_gateway_instances(_response_body, output)
            .map_err(crate::operation::list_gateway_instances::ListGatewayInstancesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "instances" => {
                    builder = builder.set_instances(
                        crate::protocol_serde::shape_list_of_listed_gateway_instance::de_list_of_listed_gateway_instance(tokens, _value, depth + 1)?,
                    );
                }
                "nextToken" => {
