...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_bridges_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_bridges::ListBridgesOutput, crate::operation::list_bridges::ListBridgesError> {
...
) -> ::std::result::Result<crate::operation::list_bridges::builders::ListBridgesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "bridges" => {
                    builder = builder.set_bridges(crate::protocol_serde::shape_list_of_listed_bridge::de_list_of_listed_bridge(tokens)?);
                }
                "nextToken" => {
