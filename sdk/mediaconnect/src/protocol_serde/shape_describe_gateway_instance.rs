...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_gateway_instance::DescribeGatewayInstanceError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_gateway_instance::DescribeGatewayInstanceError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_gateway_instance::de_describe_gateway_instance(_response_body, output)
            .map_err(crate::operation::describe_gateway_instance::DescribeGatewayInstanceError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "gatewayInstance" => {
                    builder = builder.set_gateway_instance(crate::protocol_serde::shape_gateway_instance::de_gateway_instance(tokens)?);
                }
