...
pub fn ser_update_failover_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateFailoverConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
