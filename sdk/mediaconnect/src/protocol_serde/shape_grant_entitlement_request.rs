...
pub fn ser_grant_entitlement_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GrantEntitlementRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
