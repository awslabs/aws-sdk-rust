...
pub(crate) fn de_list_of_input_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::InputConfiguration>>, ::aws_smithy_json::deserialize::error::DeserializeError>
