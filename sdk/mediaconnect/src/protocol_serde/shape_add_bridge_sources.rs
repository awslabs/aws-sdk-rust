...
pub fn de_add_bridge_sources_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::add_bridge_sources::AddBridgeSourcesOutput, crate::operation::add_bridge_sources::AddBridgeSourcesError> {
    #[allow(unused_mut)]
...
pub fn de_add_bridge_sources_http_response_with_props(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_add_bridge_sources::de_add_bridge_sources(_response_body, output)
            .map_err(crate::operation::add_bridge_sources::AddBridgeSourcesError::unhandled)?;
...
) -> Result<crate::operation::add_bridge_sources::builders::AddBridgeSourcesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
