                    ...
                    variant = match key.as_ref() {
                            "standard" => {
                                Some(crate::types::RouterInputStreamDetails::Standard(
                                    crate::protocol_serde::shape_standard_router_input_stream_details::de_standard_router_input_stream_details(tokens)?
                            ...
                            "failover" => {
                                Some(crate::types::RouterInputStreamDetails::Failover(
                                    crate::protocol_serde::shape_failover_router_input_stream_details::de_failover_router_input_stream_details(tokens)?
                            ...
                            "merge" => {
                                Some(crate::types::RouterInputStreamDetails::Merge(
                                    crate::protocol_serde::shape_merge_router_input_stream_details::de_merge_router_input_stream_details(tokens)?
                            ...
                            "mediaConnectFlow" => {
                                Some(crate::types::RouterInputStreamDetails::MediaConnectFlow(
                                    crate::protocol_serde::shape_media_connect_flow_router_input_stream_details::de_media_connect_flow_router_input_stream_details(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'MediaConnectFlow' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                                                                              Some(crate::types::RouterInputStreamDetails::Unknown)
                                                                            }
                        };
                }
                other => {
