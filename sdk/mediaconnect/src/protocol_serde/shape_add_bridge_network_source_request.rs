...
pub fn ser_add_bridge_network_source_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AddBridgeNetworkSourceRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
