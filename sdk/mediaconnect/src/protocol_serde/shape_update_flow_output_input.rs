...
pub fn ser_update_flow_output_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFlowOutputInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
