...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_remove_bridge_source::de_remove_bridge_source(_response_body, output)
            .map_err(crate::operation::remove_bridge_source::RemoveBridgeSourceError::unhandled)?;
...
) -> Result<crate::operation::remove_bridge_source::builders::RemoveBridgeSourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
