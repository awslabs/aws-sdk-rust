...
pub(crate) fn de_bridge<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Bridge>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "bridgeState" => {
                                builder = builder.set_bridge_state(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::BridgeState::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            ...
                            "sources" => {
                                builder = builder.set_sources(
                                    crate::protocol_serde::shape_list_of_bridge_source::de_list_of_bridge_source(tokens)?
                                );
                            }
