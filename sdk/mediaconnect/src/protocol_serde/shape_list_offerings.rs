...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_offerings_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_offerings::de_list_offerings(_response_body, output)
                .map_err(crate::operation::list_offerings::ListOfferingsError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "offerings" => {
                        builder = builder.set_offerings(
                            crate::protocol_serde::shape___list_of_offering::de___list_of_offering(
                                tokens,
                            )?,
                        );
                    }
