...
pub fn ser_update_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateEncryption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
