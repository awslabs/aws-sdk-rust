...
pub(crate) fn de_list_of_reservation<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Reservation>>, ::aws_smithy_json::deserialize::error::DeserializeError>
