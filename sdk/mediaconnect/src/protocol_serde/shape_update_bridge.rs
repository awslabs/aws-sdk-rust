...
pub fn de_update_bridge_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_bridge::UpdateBridgeOutput, crate::operation::update_bridge::UpdateBridgeError> {
    #[allow(unused_mut)]
...
pub fn de_update_bridge_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_bridge::de_update_bridge(_response_body, output)
            .map_err(crate::operation::update_bridge::UpdateBridgeError::unhandled)?;
...
) -> Result<crate::operation::update_bridge::builders::UpdateBridgeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "bridge" => {
                    builder = builder.set_bridge(crate::protocol_serde::shape_bridge::de_bridge(tokens)?);
                }
