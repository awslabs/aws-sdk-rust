...
pub(crate) fn de_entitlement<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Entitlement>, aws_smithy_json::deserialize::error::DeserializeError>
