...
pub fn de_create_flow_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_flow::CreateFlowOutput, crate::operation::create_flow::CreateFlowError> {
    #[allow(unused_mut)]
    ...
    Err(match error_code {
        ...
        "CreateFlow420Exception" => crate::operation::create_flow::CreateFlowError::CreateFlow420Exception({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_create_flow420_exception::de_create_flow420_exception_json_err(_response_body, output)
                    .map_err(crate::operation::create_flow::CreateFlowError::unhandled)?;
                let output = output.meta(generic);
...
) -> ::std::result::Result<crate::operation::create_flow::builders::CreateFlowOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "flow" => {
                    builder = builder.set_flow(crate::protocol_serde::shape_flow::de_flow(tokens, _value, depth + 1)?);
                }
