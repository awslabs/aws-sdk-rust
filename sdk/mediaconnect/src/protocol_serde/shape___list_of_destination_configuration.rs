...
pub(crate) fn de___list_of_destination_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DestinationConfiguration>>, aws_smithy_json::deserialize::error::DeserializeError>
