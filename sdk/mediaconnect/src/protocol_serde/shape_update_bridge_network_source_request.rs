...
pub fn ser_update_bridge_network_source_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateBridgeNetworkSourceRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
