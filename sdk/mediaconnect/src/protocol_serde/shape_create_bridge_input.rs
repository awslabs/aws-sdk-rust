...
pub fn ser_create_bridge_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_bridge::CreateBridgeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
