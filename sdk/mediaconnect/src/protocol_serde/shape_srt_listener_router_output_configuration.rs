...
pub fn ser_srt_listener_router_output_configuration(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::SrtListenerRouterOutputConfiguration,
    ...
    if let Some(var_1) = &input.encryption_configuration {
        ...
        crate::protocol_serde::shape_srt_encryption_configuration::ser_srt_encryption_configuration(&mut object_2, var_1)?;
        object_2.finish();
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    ...
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::SrtListenerRouterOutputConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "encryptionConfiguration" => {
                            builder = builder.set_encryption_configuration(
                                crate::protocol_serde::shape_srt_encryption_configuration::de_srt_encryption_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
            ...
            Ok(Some(
                crate::serde_util::srt_listener_router_output_configuration_correct_errors(builder)
                    .build()
