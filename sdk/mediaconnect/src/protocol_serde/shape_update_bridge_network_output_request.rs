...
pub fn ser_update_bridge_network_output_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateBridgeNetworkOutputRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
