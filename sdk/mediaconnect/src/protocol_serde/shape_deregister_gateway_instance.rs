...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InternalServerErrorException" => {
            crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError::InternalServerErrorException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_deregister_gateway_instance::de_deregister_gateway_instance(_response_body, output)
            .map_err(crate::operation::deregister_gateway_instance::DeregisterGatewayInstanceError::unhandled)?;
