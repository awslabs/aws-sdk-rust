...
pub fn de_add_flow_vpc_interfaces_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput, crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_flow_vpc_interfaces_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput, crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_add_flow_vpc_interfaces_input(input: &crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
