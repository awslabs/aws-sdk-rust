...
> {
    ...
    .map_err(crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::unhandled(
                    generic,
                ),
            )
        }
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_add_flow_vpc_interfaces_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
