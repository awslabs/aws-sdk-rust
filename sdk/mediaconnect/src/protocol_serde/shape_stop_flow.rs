...
pub fn de_stop_flow_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StopFlowOutput, crate::error::StopFlowError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::StopFlowError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_flow_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::StopFlowOutput, crate::error::StopFlowError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::stop_flow_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_stop_flow::de_stop_flow(response.body().as_ref(), output).map_err(crate::error::StopFlowError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_stop_flow(value: &[u8], mut builder: crate::output::stop_flow_output::Builder) -> Result<crate::output::stop_flow_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
