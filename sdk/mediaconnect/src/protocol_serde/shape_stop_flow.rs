...
pub fn de_stop_flow_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::stop_flow::StopFlowOutput, crate::operation::stop_flow::StopFlowError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::stop_flow::StopFlowError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_flow_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::stop_flow::StopFlowOutput, crate::operation::stop_flow::StopFlowError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::stop_flow::builders::StopFlowOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_stop_flow::de_stop_flow(response.body().as_ref(), output).map_err(crate::operation::stop_flow::StopFlowError::unhandled)?;
