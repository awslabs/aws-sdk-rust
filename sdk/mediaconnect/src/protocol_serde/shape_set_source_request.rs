...
pub fn ser_set_source_request(
    ...
    if let Some(var_5) = &input.ingest_port {
        object.key("ingestPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.max_bitrate {
        object.key("maxBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.max_latency {
        object.key("maxLatency").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.max_sync_buffer {
        object.key("maxSyncBuffer").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    ...
    if let Some(var_16) = &input.sender_control_port {
        object.key("senderControlPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    ...
    if let Some(var_19) = &input.source_listener_port {
        object.key("sourceListenerPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_19).into()));
    }
