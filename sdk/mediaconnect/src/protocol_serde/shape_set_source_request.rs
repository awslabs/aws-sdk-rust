...
pub fn ser_set_source_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SetSourceRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
