...
> {
    ...
    Err(match error_code {
        ...
        "GrantFlowEntitlements420Exception" => {
            crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError::GrantFlowEntitlements420Exception({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::GrantFlowEntitlements420ExceptionBuilder::default();
                    output = crate::protocol_serde::shape_grant_flow_entitlements420_exception::de_grant_flow_entitlements420_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_grant_flow_entitlements::de_grant_flow_entitlements(_response_body, output)
            .map_err(crate::operation::grant_flow_entitlements::GrantFlowEntitlementsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "entitlements" => {
                    builder = builder.set_entitlements(crate::protocol_serde::shape_list_of_entitlement::de_list_of_entitlement(tokens, _value)?);
                }
                "flowArn" => {
