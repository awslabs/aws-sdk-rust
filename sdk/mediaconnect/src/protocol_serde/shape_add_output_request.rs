...
pub fn ser_add_output_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AddOutputRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
