...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_description): A description of the entitlement. This description appears only on the AWS Elemental MediaConnect console and will not be seen by the subscriber or end user.
