...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_description): A description of the entitlement. This description appears only on the AWS Elemental MediaConnect console and will not be seen by the subscriber or end user.
    ///   - [`encryption(UpdateEncryption)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::encryption) / [`set_encryption(Option<UpdateEncryption>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_encryption): The type of encryption that will be used on the output associated with this entitlement. Allowable encryption types: static-key, speke.
    ///   - [`entitlement_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::entitlement_arn) / [`set_entitlement_arn(Option<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_entitlement_arn): The ARN of the entitlement that you want to update.
    ...
    ///   - [`flow_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::flow_arn) / [`set_flow_arn(Option<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_flow_arn): The flow that is associated with the entitlement that you want to update.
    ///   - [`subscribers(Vec<String>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::subscribers) / [`set_subscribers(Option<Vec<String>>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_subscribers): The AWS account IDs that you want to share your content with. The receiving accounts (subscribers) will be allowed to create their own flow using your content as the source.
