...
impl super::Client {
    ...
    ///   - [`encryption(UpdateEncryption)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::encryption) / [`set_encryption(Option<UpdateEncryption>)`](crate::operation::update_flow_entitlement::builders::UpdateFlowEntitlementFluentBuilder::set_encryption): The type of encryption that will be used on the output associated with this entitlement.
