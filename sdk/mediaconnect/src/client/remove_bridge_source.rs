...
impl super::Client {
    ...
    pub fn remove_bridge_source(
        &self,
    ) -> crate::operation::remove_bridge_source::builders::RemoveBridgeSourceFluentBuilder {
        crate::operation::remove_bridge_source::builders::RemoveBridgeSourceFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
