...
impl super::Client {
    ...
    ///   - [`force(bool)`](crate::operation::deregister_gateway_instance::builders::DeregisterGatewayInstanceFluentBuilder::force) / [`set_force(Option<bool>)`](crate::operation::deregister_gateway_instance::builders::DeregisterGatewayInstanceFluentBuilder::set_force): Force the deregistration of an instance. Force will deregister an instance, even if there are bridges running on it.
    ///   - [`gateway_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::deregister_gateway_instance::builders::DeregisterGatewayInstanceFluentBuilder::gateway_instance_arn) / [`set_gateway_instance_arn(Option<String>)`](crate::operation::deregister_gateway_instance::builders::DeregisterGatewayInstanceFluentBuilder::set_gateway_instance_arn): The Amazon Resource Name (ARN) of the gateway that contains the instance that you want to deregister.
