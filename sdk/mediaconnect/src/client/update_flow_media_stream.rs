...
impl super::Client {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::set_description): Description
    ///   - [`flow_arn(impl ::std::convert::Into<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::flow_arn) / [`set_flow_arn(Option<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::set_flow_arn): The Amazon Resource Name (ARN) of the flow.
    ///   - [`media_stream_name(impl ::std::convert::Into<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::media_stream_name) / [`set_media_stream_name(Option<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::set_media_stream_name): The name of the media stream that you want to update.
    ...
    ///   - [`video_format(impl ::std::convert::Into<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::video_format) / [`set_video_format(Option<String>)`](crate::operation::update_flow_media_stream::builders::UpdateFlowMediaStreamFluentBuilder::set_video_format): The resolution of the video.
