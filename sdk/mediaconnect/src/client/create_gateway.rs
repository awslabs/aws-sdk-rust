...
impl super::Client {
    ...
    ///   - [`networks(GatewayNetwork)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::networks) / [`set_networks(Option<Vec<GatewayNetwork>>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_networks): The list of networks that you want to add.
