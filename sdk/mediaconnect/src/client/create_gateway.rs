...
impl super::Client  {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_name): The name of the gateway. This name can not be modified after the gateway is created.
