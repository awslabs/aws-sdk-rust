...
impl super::Client {
    ...
    ///   - [`egress_cidr_blocks(Vec<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::egress_cidr_blocks) / [`set_egress_cidr_blocks(Option<Vec<String>>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_egress_cidr_blocks): The range of IP addresses that are allowed to contribute content or initiate output requests for flows communicating with this gateway. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block; for example, 10.0.0.0/16.
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_name): The name of the gateway. This name can not be modified after the gateway is created.
    ///   - [`networks(Vec<GatewayNetwork>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::networks) / [`set_networks(Option<Vec<GatewayNetwork>>)`](crate::operation::create_gateway::builders::CreateGatewayFluentBuilder::set_networks): The list of networks that you want to add.
