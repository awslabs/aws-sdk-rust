...
impl super::Client {
    ...
    ///   - [`flow_arn(impl ::std::convert::Into<String>)`](crate::operation::remove_flow_media_stream::builders::RemoveFlowMediaStreamFluentBuilder::flow_arn) / [`set_flow_arn(Option<String>)`](crate::operation::remove_flow_media_stream::builders::RemoveFlowMediaStreamFluentBuilder::set_flow_arn): The Amazon Resource Name (ARN) of the flow.
    ///   - [`media_stream_name(impl ::std::convert::Into<String>)`](crate::operation::remove_flow_media_stream::builders::RemoveFlowMediaStreamFluentBuilder::media_stream_name) / [`set_media_stream_name(Option<String>)`](crate::operation::remove_flow_media_stream::builders::RemoveFlowMediaStreamFluentBuilder::set_media_stream_name): The name of the media stream that you want to remove.
