...
impl super::Client {
    ...
    ///   - [`entitlements(GrantEntitlementRequest)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::entitlements) / [`set_entitlements(Option<Vec<GrantEntitlementRequest>>)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::set_entitlements): The entitlements that you want to grant on a flow.
    ...
    ///   - [`outputs(AddOutputRequest)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::outputs) / [`set_outputs(Option<Vec<AddOutputRequest>>)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::set_outputs): The outputs that you want to add to this flow.
    ...
    ///   - [`sources(SetSourceRequest)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::sources) / [`set_sources(Option<Vec<SetSourceRequest>>)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::set_sources): (undocumented)
    ///   - [`vpc_interfaces(VpcInterfaceRequest)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::vpc_interfaces) / [`set_vpc_interfaces(Option<Vec<VpcInterfaceRequest>>)`](crate::operation::create_flow::builders::CreateFlowFluentBuilder::set_vpc_interfaces): The VPC interfaces you want on the flow.
