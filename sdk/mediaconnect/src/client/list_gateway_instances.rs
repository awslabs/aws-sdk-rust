...
impl super::Client {
    ...
    ///   - [`filter_arn(impl ::std::convert::Into<String>)`](crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder::filter_arn) / [`set_filter_arn(Option<String>)`](crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder::set_filter_arn): Filter the list results to display only the instances associated with the selected Gateway Amazon Resource Name (ARN).
    ///   - [`max_results(i32)`](crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder::set_max_results): The maximum number of results to return per API request. For example, you submit a ListInstances request with MaxResults set at 5. Although 20 items match your request, the service returns no more than the first 5 items. (The service also returns a NextToken value that you can use to fetch the next batch of results.) The service might return fewer results than the MaxResults value. If MaxResults is not included in the request, the service defaults to pagination with a maximum of 10 results per page.
    ...
    pub fn list_gateway_instances(
        &self,
    ) -> crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder {
        crate::operation::list_gateway_instances::builders::ListGatewayInstancesFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
