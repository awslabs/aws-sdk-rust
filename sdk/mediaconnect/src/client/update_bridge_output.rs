...
impl super::Client {
    ...
    ///   - [`bridge_arn(impl ::std::convert::Into<String>)`](crate::operation::update_bridge_output::builders::UpdateBridgeOutputFluentBuilder::bridge_arn) / [`set_bridge_arn(Option<String>)`](crate::operation::update_bridge_output::builders::UpdateBridgeOutputFluentBuilder::set_bridge_arn): The ARN of the bridge that you want to update.
    ...
    ///   - [`output_name(impl ::std::convert::Into<String>)`](crate::operation::update_bridge_output::builders::UpdateBridgeOutputFluentBuilder::output_name) / [`set_output_name(Option<String>)`](crate::operation::update_bridge_output::builders::UpdateBridgeOutputFluentBuilder::set_output_name): The name of the bridge output that you want to update.
