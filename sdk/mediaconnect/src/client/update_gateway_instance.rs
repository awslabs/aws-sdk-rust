...
impl super::Client {
    ...
    ///   - [`gateway_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::update_gateway_instance::builders::UpdateGatewayInstanceFluentBuilder::gateway_instance_arn) / [`set_gateway_instance_arn(Option<String>)`](crate::operation::update_gateway_instance::builders::UpdateGatewayInstanceFluentBuilder::set_gateway_instance_arn): The Amazon Resource Name (ARN) of the instance that you want to update.
