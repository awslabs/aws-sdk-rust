...
impl super::Client {
    ...
    ///   - [`bridge_arn(impl ::std::convert::Into<String>)`](crate::operation::add_bridge_outputs::builders::AddBridgeOutputsFluentBuilder::bridge_arn) / [`set_bridge_arn(Option<String>)`](crate::operation::add_bridge_outputs::builders::AddBridgeOutputsFluentBuilder::set_bridge_arn): The ARN of the bridge that you want to update.
