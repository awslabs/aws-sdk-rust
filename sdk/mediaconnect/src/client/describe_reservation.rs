...
impl super::Client {
    ...
    ///   - [`reservation_arn(impl Into<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::reservation_arn) / [`set_reservation_arn(Option<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::set_reservation_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the offering.</p><br>
    ...
    ///   - [`reservation(Option<Reservation>)`](crate::operation::describe_reservation::DescribeReservationOutput::reservation): <p>A pricing agreement for a discounted rate for a specific outbound bandwidth that your MediaConnect account will use each month over a specific time period. The discounted rate in the reservation applies to outbound bandwidth for all flows from your account until your account reaches the amount of bandwidth in your reservation. If you use more outbound bandwidth than the agreed upon amount in a single month, the overage is charged at the on-demand rate.</p>
