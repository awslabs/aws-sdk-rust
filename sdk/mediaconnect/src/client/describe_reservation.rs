...
impl super::Client {
    ...
    ///   - [`reservation_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::reservation_arn) / [`set_reservation_arn(Option<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::set_reservation_arn): The Amazon Resource Name (ARN) of the reservation.
