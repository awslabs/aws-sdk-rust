...
impl super::Client {
    ...
    ///   - [`reservation_arn(impl Into<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::reservation_arn) / [`set_reservation_arn(Option<String>)`](crate::operation::describe_reservation::builders::DescribeReservationFluentBuilder::set_reservation_arn):<br>required: **true**<br>The Amazon Resource Name (ARN) of the reservation.<br>
