...
impl super::Client {
    ...
    ///   - [`offering_arn(impl ::std::convert::Into<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::offering_arn) / [`set_offering_arn(Option<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::set_offering_arn): The Amazon Resource Name (ARN) of the offering.
    ///   - [`reservation_name(impl ::std::convert::Into<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::reservation_name) / [`set_reservation_name(Option<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::set_reservation_name): The name that you want to use for the reservation.
    ///   - [`start(impl ::std::convert::Into<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::start) / [`set_start(Option<String>)`](crate::operation::purchase_offering::builders::PurchaseOfferingFluentBuilder::set_start): The date and time that you want the reservation to begin, in Coordinated Universal Time (UTC). You can specify any date and time between 12:00am on the first day of the current month to the current time on today's date, inclusive. Specify the start in a 24-hour notation. Use the following format: YYYY-MM-DDTHH:mm:SSZ, where T and Z are literal characters. For example, to specify 11:30pm on March 5, 2020, enter 2020-03-05T23:30:00Z.
