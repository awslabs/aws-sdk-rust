...
impl super::Client  {
    ...
    ///   - [`filter_arn(impl Into<String>)`](crate::operation::list_bridges::builders::ListBridgesFluentBuilder::filter_arn) / [`set_filter_arn(Option<String>)`](crate::operation::list_bridges::builders::ListBridgesFluentBuilder::set_filter_arn): Filter the list results to display only the bridges associated with the selected Amazon Resource Name (ARN).
