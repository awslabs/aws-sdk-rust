...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_assessment_template::DeleteAssessmentTemplateError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "AssessmentRunInProgressException" => {
            crate::operation::delete_assessment_template::DeleteAssessmentTemplateError::AssessmentRunInProgressException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::AssessmentRunInProgressExceptionBuilder::default();
                    output = crate::protocol_serde::shape_assessment_run_in_progress_exception::de_assessment_run_in_progress_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::delete_assessment_template::DeleteAssessmentTemplateError::unhandled)?;
        ...
        "ServiceTemporarilyUnavailableException" => {
            crate::operation::delete_assessment_template::DeleteAssessmentTemplateError::ServiceTemporarilyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
