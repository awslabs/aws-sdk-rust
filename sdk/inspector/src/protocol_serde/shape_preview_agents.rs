...
pub fn de_preview_agents_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::preview_agents::PreviewAgentsOutput, crate::operation::preview_agents::PreviewAgentsError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::preview_agents::builders::PreviewAgentsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "agentPreviews" => {
                    builder = builder.set_agent_previews(crate::protocol_serde::shape_agent_preview_list::de_agent_preview_list(tokens)?);
                }
                "nextToken" => {
