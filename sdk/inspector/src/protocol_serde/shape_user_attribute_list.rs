...
pub(crate) fn de_user_attribute_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Attribute>>, aws_smithy_json::deserialize::error::DeserializeError>
