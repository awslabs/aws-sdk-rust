...
pub fn ser_list_assessment_templates_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAssessmentTemplatesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
