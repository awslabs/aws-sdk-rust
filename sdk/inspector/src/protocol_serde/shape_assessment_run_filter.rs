...
pub fn ser_assessment_run_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AssessmentRunFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
