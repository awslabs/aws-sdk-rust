...
> {
    ...
    Err(match error_code {
        ...
        "AgentsAlreadyRunningAssessmentException" => {
            crate::operation::start_assessment_run::StartAssessmentRunError::AgentsAlreadyRunningAssessmentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceTemporarilyUnavailableException" => {
            crate::operation::start_assessment_run::StartAssessmentRunError::ServiceTemporarilyUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::start_assessment_run_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::start_assessment_run::StartAssessmentRunError::unhandled)?
    })
}
...
) -> Result<crate::operation::start_assessment_run::builders::StartAssessmentRunOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
