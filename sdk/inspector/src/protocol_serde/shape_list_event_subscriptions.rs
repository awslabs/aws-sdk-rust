...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_event_subscriptions::ListEventSubscriptionsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        crate::serde_util::list_event_subscriptions_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_event_subscriptions::ListEventSubscriptionsError::unhandled)?
    })
}
