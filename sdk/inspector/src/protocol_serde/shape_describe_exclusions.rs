...
> {
    Ok({
        ...
        crate::serde_util::describe_exclusions_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_exclusions::DescribeExclusionsError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_exclusions::builders::DescribeExclusionsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "exclusions" => {
                    builder = builder.set_exclusions(crate::protocol_serde::shape_exclusion_map::de_exclusion_map(tokens)?);
                }
                "failedItems" => {
