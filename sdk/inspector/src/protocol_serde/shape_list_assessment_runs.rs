...
> {
    Ok({
        ...
        crate::serde_util::list_assessment_runs_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_assessment_runs::ListAssessmentRunsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_assessment_runs::builders::ListAssessmentRunsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "assessmentRunArns" => {
                    builder =
                        builder.set_assessment_run_arns(crate::protocol_serde::shape_list_returned_arn_list::de_list_returned_arn_list(tokens)?);
                }
                "nextToken" => {
