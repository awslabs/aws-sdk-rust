...
pub fn ser_list_assessment_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAssessmentRunsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
