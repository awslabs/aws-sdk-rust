...
pub fn ser_list_assessment_runs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_assessment_runs::ListAssessmentRunsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
