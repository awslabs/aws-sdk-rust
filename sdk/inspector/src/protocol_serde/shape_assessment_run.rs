                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "rulesPackageArns" => {
                            builder = builder.set_rules_package_arns(
                                crate::protocol_serde::shape_assessment_rules_package_arn_list::de_assessment_rules_package_arn_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "stateChanges" => {
                            builder = builder.set_state_changes(
                                crate::protocol_serde::shape_assessment_run_state_change_list::de_assessment_run_state_change_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "notifications" => {
                            builder = builder.set_notifications(
                                crate::protocol_serde::shape_assessment_run_notification_list::de_assessment_run_notification_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "findingCounts" => {
                            builder = builder.set_finding_counts(
                                crate::protocol_serde::shape_assessment_run_finding_counts::de_assessment_run_finding_counts(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
