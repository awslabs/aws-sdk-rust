...
pub(crate) fn de_assessment_run<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AssessmentRun>, aws_smithy_json::deserialize::error::DeserializeError>
