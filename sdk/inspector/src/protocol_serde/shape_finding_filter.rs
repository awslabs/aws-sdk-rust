...
pub fn ser_finding_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FindingFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
