...
pub fn de_remove_attributes_from_findings_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_attributes_from_findings_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError> {
    Ok({
        #[allow(unused_mut)]
