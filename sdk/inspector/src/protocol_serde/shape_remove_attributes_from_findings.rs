...
pub fn de_remove_attributes_from_findings_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_exception_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::invalid_input_exception_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::no_such_entity_exception_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::service_temporarily_unavailable_exception_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_attributes_from_findings_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError> {
    Ok({
        #[allow(unused_mut)]
        ...
        crate::serde_util::remove_attributes_from_findings_output_output_correct_errors(output).build().map_err(crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError::unhandled)?
    })
}

pub fn ser_remove_attributes_from_findings_input(input: &crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
