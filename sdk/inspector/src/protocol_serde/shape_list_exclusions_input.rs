...
pub fn ser_list_exclusions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListExclusionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
