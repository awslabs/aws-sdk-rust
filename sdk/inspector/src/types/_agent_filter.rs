...
impl  AgentFilter  {
    ...
    pub fn agent_healths(&self) -> & [crate::types::AgentHealth] {
        use std::ops::Deref; self.agent_healths.deref()
    }
    /// <p>The detailed health state of the agent. Values can be set to <b>IDLE</b>, <b>RUNNING</b>, <b>SHUTDOWN</b>, <b>UNHEALTHY</b>, <b>THROTTLED</b>, and <b>UNKNOWN</b>.</p>
    pub fn agent_health_codes(&self) -> & [crate::types::AgentHealthCode] {
        use std::ops::Deref; self.agent_health_codes.deref()
    }
}
impl AgentFilter {
        ...
        ::std::result::Result::Ok(
            crate::types::AgentFilter {
                agent_healths: self.agent_healths
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("agent_healths", "agent_healths was not specified but it is required when building AgentFilter")
                    )?
                ,
                agent_health_codes: self.agent_health_codes
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("agent_health_codes", "agent_health_codes was not specified but it is required when building AgentFilter")
                    )?
                ,
            }
        )
