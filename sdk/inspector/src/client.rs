...
impl Client  {
    ...
    pub fn describe_cross_account_access_role(&self) -> fluent_builders::DescribeCrossAccountAccessRole {
    ...
    pub fn register_cross_account_access_role(&self) -> fluent_builders::RegisterCrossAccountAccessRole {
