...
impl Builder {
    ...
    /// use aws_sdk_inspector::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_inspector::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("inspector"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("inspector"));
        layer
