...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::list_event_subscriptions::builders::ListEventSubscriptionsFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_event_subscriptions::builders::ListEventSubscriptionsFluentBuilder::set_resource_arn): <p>The ARN of the assessment template for which you want to list the existing event subscriptions.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_event_subscriptions::builders::ListEventSubscriptionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_event_subscriptions::builders::ListEventSubscriptionsFluentBuilder::set_next_token): <p>You can use this parameter when paginating results. Set the value of this parameter to null on your first call to the <b>ListEventSubscriptions</b> action. Subsequent calls to the action fill <b>nextToken</b> in the request with the value of <b>NextToken</b> from the previous response to continue listing data.</p>
