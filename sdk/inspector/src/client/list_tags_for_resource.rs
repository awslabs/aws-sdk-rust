...
impl super::Client {
    ...
    ///   - [`tags(Vec::<Tag>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>A collection of key and value pairs.</p>
