...
impl super::Client {
    ...
    ///   - [`assessment_target_arn(impl ::std::convert::Into<String>)`](crate::operation::update_assessment_target::builders::UpdateAssessmentTargetFluentBuilder::assessment_target_arn) / [`set_assessment_target_arn(Option<String>)`](crate::operation::update_assessment_target::builders::UpdateAssessmentTargetFluentBuilder::set_assessment_target_arn): <p>The ARN of the assessment target that you want to update.</p>
    ///   - [`assessment_target_name(impl ::std::convert::Into<String>)`](crate::operation::update_assessment_target::builders::UpdateAssessmentTargetFluentBuilder::assessment_target_name) / [`set_assessment_target_name(Option<String>)`](crate::operation::update_assessment_target::builders::UpdateAssessmentTargetFluentBuilder::set_assessment_target_name): <p>The name of the assessment target that you want to update.</p>
