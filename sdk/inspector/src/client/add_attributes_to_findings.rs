...
impl super::Client {
    ...
    ///   - [`finding_arns(impl Into<String>)`](crate::operation::add_attributes_to_findings::builders::AddAttributesToFindingsFluentBuilder::finding_arns) / [`set_finding_arns(Option<Vec<String>>)`](crate::operation::add_attributes_to_findings::builders::AddAttributesToFindingsFluentBuilder::set_finding_arns): <p>The ARNs that specify the findings that you want to assign attributes to.</p>
    ///   - [`attributes(Attribute)`](crate::operation::add_attributes_to_findings::builders::AddAttributesToFindingsFluentBuilder::attributes) / [`set_attributes(Option<Vec<Attribute>>)`](crate::operation::add_attributes_to_findings::builders::AddAttributesToFindingsFluentBuilder::set_attributes): <p>The array of attributes that you want to assign to specified findings.</p>
