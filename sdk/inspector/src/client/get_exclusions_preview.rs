...
impl super::Client {
    ...
    ///   - [`assessment_template_arn(impl ::std::convert::Into<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::assessment_template_arn) / [`set_assessment_template_arn(Option<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::set_assessment_template_arn): <p>The ARN that specifies the assessment template for which the exclusions preview was requested.</p>
    ///   - [`preview_token(impl ::std::convert::Into<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::preview_token) / [`set_preview_token(Option<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::set_preview_token): <p>The unique identifier associated of the exclusions preview.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::set_next_token): <p>You can use this parameter when paginating results. Set the value of this parameter to null on your first call to the GetExclusionsPreviewRequest action. Subsequent calls to the action fill nextToken in the request with the value of nextToken from the previous response to continue listing data.</p>
    ///   - [`max_results(i32)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_exclusions_preview::builders::GetExclusionsPreviewFluentBuilder::set_max_results): <p>You can use this parameter to indicate the maximum number of items you want in the response. The default value is 100. The maximum value is 500.</p>
    ...
    ///   - [`preview_status(Option<PreviewStatus>)`](crate::operation::get_exclusions_preview::GetExclusionsPreviewOutput::preview_status): <p>Specifies the status of the request to generate an exclusions preview.</p>
