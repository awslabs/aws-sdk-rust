...
pub struct FailedItemDetails  {
    ...
    #[doc(hidden)]pub failure_code: std::option::Option<crate::model::FailedItemErrorCode>,
    /// <p>Indicates whether you can immediately retry a request for this item for a specified resource.</p>
    #[doc(hidden)]pub retryable: std::option::Option<bool>,
}
...
pub struct AgentPreview  {
    ...
    #[doc(hidden)]pub auto_scaling_group: std::option::Option<std::string::String>,
    /// <p>The health status of the Amazon Inspector Agent.</p>
    #[doc(hidden)]pub agent_health: std::option::Option<crate::model::AgentHealth>,
    ...
    #[doc(hidden)]pub kernel_version: std::option::Option<std::string::String>,
...
pub struct FindingFilter  {
    ...
    #[doc(hidden)]pub severities: std::option::Option<std::vec::Vec<crate::model::Severity>>,
    ...
    #[doc(hidden)]pub user_attributes: std::option::Option<std::vec::Vec<crate::model::Attribute>>,
    /// <p>The time range during which the finding is generated.</p>
    #[doc(hidden)]pub creation_time_range: std::option::Option<crate::model::TimestampRange>,
}
impl FindingFilter {
    /// <p>For a record to match a filter, one of the values that is specified for this data type property must be the exact match of the value of the <b>agentId</b> property of the <code>Finding</code> data type.</p>
...
pub struct TimestampRange  {
    ...
    #[doc(hidden)]pub begin_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct Subscription  {
    ...
    #[doc(hidden)]pub event_subscriptions: std::option::Option<std::vec::Vec<crate::model::EventSubscription>>,
}
impl Subscription {
    /// <p>The ARN of the assessment template that is used during the event for which the SNS notification is sent.</p>
...
pub struct EventSubscription  {
    ...
    #[doc(hidden)]pub subscribed_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct AssessmentTemplateFilter  {
    ...
    #[doc(hidden)]pub name_pattern: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub duration_range: std::option::Option<crate::model::DurationRange>,
...
pub struct AssessmentTargetFilter  {
    ...
    #[doc(hidden)]pub assessment_target_name_pattern: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for AssessmentTargetFilter  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("assessment_target_name_pattern", &self.assessment_target_name_pattern);
        formatter.finish()
    }
}
...
pub struct AssessmentRunFilter  {
    ...
    #[doc(hidden)]pub states: std::option::Option<std::vec::Vec<crate::model::AssessmentRunState>>,
    ...
    #[doc(hidden)]pub start_time_range: std::option::Option<crate::model::TimestampRange>,
    ...
    #[doc(hidden)]pub completion_time_range: std::option::Option<crate::model::TimestampRange>,
    ...
    #[doc(hidden)]pub state_change_time_range: std::option::Option<crate::model::TimestampRange>,
}
...
pub struct AssessmentRunAgent  {
    ...
    #[doc(hidden)]pub agent_health_code: std::option::Option<crate::model::AgentHealthCode>,
    /// <p>The description for the agent health code.</p>
    #[doc(hidden)]pub agent_health_details: std::option::Option<std::string::String>,
...
pub struct AgentFilter  {
    ...
    #[doc(hidden)]pub agent_healths: std::option::Option<std::vec::Vec<crate::model::AgentHealth>>,
    ...
    #[doc(hidden)]pub agent_health_codes: std::option::Option<std::vec::Vec<crate::model::AgentHealthCode>>,
}
impl AgentFilter {
    /// <p>The current health state of the agent. Values can be set to <b>HEALTHY</b> or <b>UNHEALTHY</b>.</p>
...
pub struct ExclusionPreview  {
    ...
    #[doc(hidden)]pub recommendation: std::option::Option<std::string::String>,
    /// <p>The AWS resources for which the exclusion preview pertains.</p>
    #[doc(hidden)]pub scopes: std::option::Option<std::vec::Vec<crate::model::Scope>>,
...
pub struct Scope  {
    ...
    #[doc(hidden)]pub key: std::option::Option<crate::model::ScopeType>,
...
pub struct ResourceGroup  {
    ...
    #[doc(hidden)]pub tags: std::option::Option<std::vec::Vec<crate::model::ResourceGroupTag>>,
...
pub struct Finding  {
    ...
    #[doc(hidden)]pub schema_version: i32,
    ...
    #[doc(hidden)]pub service_attributes: std::option::Option<crate::model::InspectorServiceAttributes>,
    ...
    #[doc(hidden)]pub asset_attributes: std::option::Option<crate::model::AssetAttributes>,
    ...
    #[doc(hidden)]pub numeric_severity: f64,
    /// <p>This data element is currently not used.</p>
    #[doc(hidden)]pub confidence: i32,
    /// <p>This data element is currently not used.</p>
    #[doc(hidden)]pub indicator_of_compromise: std::option::Option<bool>,
...
pub struct AssetAttributes  {
    ...
    #[doc(hidden)]pub ipv4_addresses: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct NetworkInterface  {
    ...
    #[doc(hidden)]pub private_ip_addresses: std::option::Option<std::vec::Vec<crate::model::PrivateIp>>,
...
pub struct InspectorServiceAttributes  {
    ...
    #[doc(hidden)]pub rules_package_arn: std::option::Option<std::string::String>,
}
...
pub struct AssessmentTemplate  {
    ...
    #[doc(hidden)]pub last_assessment_run_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub assessment_run_count: std::option::Option<i32>,
...
pub struct AssessmentRun  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::AssessmentRunState>,
    ...
    #[doc(hidden)]pub state_changed_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>A Boolean value (true or false) that specifies whether the process of collecting data from the agents is completed.</p>
    #[doc(hidden)]pub data_collected: std::option::Option<bool>,
    /// <p>A list of the assessment run state changes.</p>
    #[doc(hidden)]pub state_changes: std::option::Option<std::vec::Vec<crate::model::AssessmentRunStateChange>>,
    ...
    #[doc(hidden)]pub notifications: std::option::Option<std::vec::Vec<crate::model::AssessmentRunNotification>>,
    /// <p>Provides a total count of generated findings per severity.</p>
    #[doc(hidden)]pub finding_counts: std::option::Option<std::collections::HashMap<crate::model::Severity, i32>>,
}
impl AssessmentRun {
    /// <p>The ARN of the assessment run.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct AssessmentRunNotification  {
    ...
    #[doc(hidden)]pub error: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub sns_publish_status_code: std::option::Option<crate::model::AssessmentRunNotificationSnsStatusCode>,
}
