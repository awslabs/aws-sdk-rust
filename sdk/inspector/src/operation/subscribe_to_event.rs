...
impl SubscribeToEventInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_subscribe_to_event::ser_subscribe_to_event_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubscribeToEvent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_subscribe_to_event::de_subscribe_to_event_http_response_with_props(status, headers, body)
        }
    }
}
