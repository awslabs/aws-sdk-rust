...
impl SubscribeToEventInput {
    /// Consumes the builder and constructs an Operation<[`SubscribeToEvent`](crate::operation::subscribe_to_event::SubscribeToEvent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::subscribe_to_event::SubscribeToEvent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::subscribe_to_event::SubscribeToEventInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::subscribe_to_event::SubscribeToEvent::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SubscribeToEvent", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SubscribeToEvent`.
...
impl aws_smithy_http::response::ParseStrictResponse for SubscribeToEvent {
                type Output = std::result::Result<crate::operation::subscribe_to_event::SubscribeToEventOutput, crate::operation::subscribe_to_event::SubscribeToEventError>;
