...
/// Orchestration and serialization glue logic for `SubscribeToEvent`.
...
impl SubscribeToEvent {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::subscribe_to_event::SubscribeToEventInput,
                    ) -> ::std::result::Result<crate::operation::subscribe_to_event::SubscribeToEventOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::subscribe_to_event::SubscribeToEventError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::subscribe_to_event::SubscribeToEventError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::subscribe_to_event::SubscribeToEventOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SubscribeToEvent {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SubscribeToEvent");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SubscribeToEventRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SubscribeToEventResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SubscribeToEvent")
...
.with_interceptor(SubscribeToEventEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::subscribe_to_event::SubscribeToEventError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::subscribe_to_event::SubscribeToEventError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::subscribe_to_event::SubscribeToEventError>::new());
...
#[derive(Debug)]
            struct SubscribeToEventResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SubscribeToEventResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_subscribe_to_event::de_subscribe_to_event_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_subscribe_to_event::de_subscribe_to_event_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SubscribeToEventRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SubscribeToEventRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::subscribe_to_event::SubscribeToEventInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::subscribe_to_event::SubscribeToEventInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_subscribe_to_event::ser_subscribe_to_event_input(&input)?);
...
#[derive(Debug)]
            struct SubscribeToEventEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SubscribeToEventEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SubscribeToEventEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SubscribeToEventInput>()
                        .ok_or("failed to downcast to SubscribeToEventInput")?;
...
pub enum SubscribeToEventError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SubscribeToEventError) for what information is available for the error.")]
...
impl SubscribeToEventError {
    /// Creates the `SubscribeToEventError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SubscribeToEventError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SubscribeToEventError {
...
impl ::aws_types::request_id::RequestId for crate::operation::subscribe_to_event::SubscribeToEventError {
...
mod _subscribe_to_event_output;
