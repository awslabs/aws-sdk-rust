...
impl SubscribeToEventInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::subscribe_to_event::SubscribeToEvent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubscribeToEvent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_subscribe_to_event::de_subscribe_to_event_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::subscribe_to_event::SubscribeToEventError
{
