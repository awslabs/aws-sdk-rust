...
impl ListAssessmentTargetsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssessmentTargets`](crate::operation::list_assessment_targets::ListAssessmentTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_assessment_targets::ListAssessmentTargets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_assessment_targets::ListAssessmentTargetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_assessment_targets::ListAssessmentTargets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssessmentTargets {
                type Output = std::result::Result<crate::operation::list_assessment_targets::ListAssessmentTargetsOutput, crate::operation::list_assessment_targets::ListAssessmentTargetsError>;
