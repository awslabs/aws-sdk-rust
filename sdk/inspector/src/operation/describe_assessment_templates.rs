...
impl DescribeAssessmentTemplatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_assessment_templates::DescribeAssessmentTemplates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssessmentTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_assessment_templates::de_describe_assessment_templates_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeAssessmentTemplatesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError
{
