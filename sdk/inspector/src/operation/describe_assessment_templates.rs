...
/// Orchestration and serialization glue logic for `DescribeAssessmentTemplates`.
...
impl DescribeAssessmentTemplates {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAssessmentTemplates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAssessmentTemplates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAssessmentTemplatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAssessmentTemplatesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAssessmentTemplates")
...
.with_interceptor(DescribeAssessmentTemplatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError>::new());
...
#[derive(Debug)]
            struct DescribeAssessmentTemplatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAssessmentTemplatesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_assessment_templates::de_describe_assessment_templates_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_assessment_templates::de_describe_assessment_templates_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeAssessmentTemplatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAssessmentTemplatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_assessment_templates::ser_describe_assessment_templates_input(&input)?);
...
#[derive(Debug)]
            struct DescribeAssessmentTemplatesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAssessmentTemplatesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAssessmentTemplatesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAssessmentTemplatesInput>()
                        .ok_or("failed to downcast to DescribeAssessmentTemplatesInput")?;
...
pub enum DescribeAssessmentTemplatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAssessmentTemplatesError) for what information is available for the error.")]
...
impl DescribeAssessmentTemplatesError {
    /// Creates the `DescribeAssessmentTemplatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAssessmentTemplatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAssessmentTemplatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError {
...
mod _describe_assessment_templates_output;
