...
impl DescribeAssessmentTemplatesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAssessmentTemplates`](crate::operation::describe_assessment_templates::DescribeAssessmentTemplates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_assessment_templates::DescribeAssessmentTemplates, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_assessment_templates::DescribeAssessmentTemplates::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAssessmentTemplates {
                type Output = std::result::Result<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesOutput, crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesError>;
