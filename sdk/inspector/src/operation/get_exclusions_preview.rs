...
/// Orchestration and serialization glue logic for `GetExclusionsPreview`.
...
impl GetExclusionsPreview {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_exclusions_preview::GetExclusionsPreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_exclusions_preview::GetExclusionsPreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_exclusions_preview::GetExclusionsPreviewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_exclusions_preview::GetExclusionsPreviewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetExclusionsPreview {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetExclusionsPreview");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetExclusionsPreviewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetExclusionsPreviewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetExclusionsPreview")
...
.with_interceptor(GetExclusionsPreviewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_exclusions_preview::GetExclusionsPreviewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_exclusions_preview::GetExclusionsPreviewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_exclusions_preview::GetExclusionsPreviewError>::new());
...
#[derive(Debug)]
            struct GetExclusionsPreviewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetExclusionsPreviewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_exclusions_preview::de_get_exclusions_preview_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetExclusionsPreviewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetExclusionsPreviewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_exclusions_preview::GetExclusionsPreviewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_exclusions_preview::GetExclusionsPreviewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_exclusions_preview::ser_get_exclusions_preview_input(&input)?);
...
#[derive(Debug)]
            struct GetExclusionsPreviewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetExclusionsPreviewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetExclusionsPreviewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetExclusionsPreviewInput>()
                        .ok_or("failed to downcast to GetExclusionsPreviewInput")?;
...
pub enum GetExclusionsPreviewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetExclusionsPreviewError) for what information is available for the error.")]
...
impl GetExclusionsPreviewError {
    /// Creates the `GetExclusionsPreviewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetExclusionsPreviewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetExclusionsPreviewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_exclusions_preview::GetExclusionsPreviewError {
...
mod _get_exclusions_preview_output;
