...
impl UnsubscribeFromEventFluentBuilder  {
    /// Creates a new `UnsubscribeFromEvent`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::unsubscribe_from_event::UnsubscribeFromEvent, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::unsubscribe_from_event::UnsubscribeFromEventError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::unsubscribe_from_event::UnsubscribeFromEventOutput, aws_smithy_http::result::SdkError<crate::operation::unsubscribe_from_event::UnsubscribeFromEventError>>
                     {
