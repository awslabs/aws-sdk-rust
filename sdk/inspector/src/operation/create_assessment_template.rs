...
impl CreateAssessmentTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateAssessmentTemplate`](crate::operation::create_assessment_template::CreateAssessmentTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_assessment_template::CreateAssessmentTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_assessment_template::CreateAssessmentTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_assessment_template::CreateAssessmentTemplate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAssessmentTemplate {
                type Output = std::result::Result<crate::operation::create_assessment_template::CreateAssessmentTemplateOutput, crate::operation::create_assessment_template::CreateAssessmentTemplateError>;
