...
/// Orchestration and serialization glue logic for `CreateAssessmentTemplate`.
...
impl CreateAssessmentTemplate {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_assessment_template::CreateAssessmentTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_assessment_template::CreateAssessmentTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_assessment_template::CreateAssessmentTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_assessment_template::CreateAssessmentTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAssessmentTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAssessmentTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateAssessmentTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateAssessmentTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAssessmentTemplate")
...
.with_interceptor(CreateAssessmentTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_assessment_template::CreateAssessmentTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_assessment_template::CreateAssessmentTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_assessment_template::CreateAssessmentTemplateError>::new());
...
#[derive(Debug)]
            struct CreateAssessmentTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAssessmentTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_assessment_template::de_create_assessment_template_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_assessment_template::de_create_assessment_template_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateAssessmentTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAssessmentTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_assessment_template::CreateAssessmentTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_assessment_template::CreateAssessmentTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_assessment_template::ser_create_assessment_template_input(&input)?);
...
#[derive(Debug)]
            struct CreateAssessmentTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAssessmentTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateAssessmentTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateAssessmentTemplateInput>()
                        .ok_or("failed to downcast to CreateAssessmentTemplateInput")?;
...
pub enum CreateAssessmentTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAssessmentTemplateError) for what information is available for the error.")]
...
impl CreateAssessmentTemplateError {
    /// Creates the `CreateAssessmentTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAssessmentTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAssessmentTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_assessment_template::CreateAssessmentTemplateError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_assessment_template::_create_assessment_template_output::CreateAssessmentTemplateOutput;

pub use crate::operation::create_assessment_template::_create_assessment_template_input::CreateAssessmentTemplateInput;

mod _create_assessment_template_input;

mod _create_assessment_template_output;
