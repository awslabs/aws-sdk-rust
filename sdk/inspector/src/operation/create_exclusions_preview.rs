...
/// Orchestration and serialization glue logic for `CreateExclusionsPreview`.
...
impl CreateExclusionsPreview {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_exclusions_preview::CreateExclusionsPreviewOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_exclusions_preview::CreateExclusionsPreviewError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateExclusionsPreview {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateExclusionsPreview");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateExclusionsPreviewRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateExclusionsPreviewResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateExclusionsPreview")
...
.with_interceptor(CreateExclusionsPreviewEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewError>::new());
...
#[derive(Debug)]
            struct CreateExclusionsPreviewResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateExclusionsPreviewResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_exclusions_preview::de_create_exclusions_preview_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_exclusions_preview::de_create_exclusions_preview_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateExclusionsPreviewRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateExclusionsPreviewRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_exclusions_preview::CreateExclusionsPreviewInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_exclusions_preview::CreateExclusionsPreviewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_exclusions_preview::ser_create_exclusions_preview_input(&input)?);
...
#[derive(Debug)]
            struct CreateExclusionsPreviewEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateExclusionsPreviewEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateExclusionsPreviewEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateExclusionsPreviewInput>()
                        .ok_or("failed to downcast to CreateExclusionsPreviewInput")?;
...
pub enum CreateExclusionsPreviewError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateExclusionsPreviewError) for what information is available for the error.")]
...
impl CreateExclusionsPreviewError {
    /// Creates the `CreateExclusionsPreviewError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateExclusionsPreviewError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::PreviewGenerationInProgressException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateExclusionsPreviewError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_exclusions_preview::CreateExclusionsPreviewError {
...
mod _create_exclusions_preview_output;
