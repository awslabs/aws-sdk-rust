...
impl ListEventSubscriptionsInput {
    /// Consumes the builder and constructs an Operation<[`ListEventSubscriptions`](crate::operation::list_event_subscriptions::ListEventSubscriptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_event_subscriptions::ListEventSubscriptions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_event_subscriptions::ListEventSubscriptionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_event_subscriptions::ListEventSubscriptions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListEventSubscriptions", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListEventSubscriptions`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListEventSubscriptions {
                type Output = std::result::Result<crate::operation::list_event_subscriptions::ListEventSubscriptionsOutput, crate::operation::list_event_subscriptions::ListEventSubscriptionsError>;
