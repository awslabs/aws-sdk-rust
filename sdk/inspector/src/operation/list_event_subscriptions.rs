...
impl ListEventSubscriptionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_event_subscriptions::ListEventSubscriptions,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventSubscriptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_event_subscriptions::de_list_event_subscriptions_http_response_with_props(status, headers, body)
        }
    }
}
