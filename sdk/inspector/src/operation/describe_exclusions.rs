...
impl DescribeExclusionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_exclusions::ser_describe_exclusions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExclusions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_exclusions::de_describe_exclusions_http_response_with_props(status, headers, body)
        }
    }
}
