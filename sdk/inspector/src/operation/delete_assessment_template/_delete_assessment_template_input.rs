...
impl DeleteAssessmentTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_assessment_template::DeleteAssessmentTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
