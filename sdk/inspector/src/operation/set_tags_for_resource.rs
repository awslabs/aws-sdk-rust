...
impl SetTagsForResourceInput {
    /// Consumes the builder and constructs an Operation<[`SetTagsForResource`](crate::operation::set_tags_for_resource::SetTagsForResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_tags_for_resource::SetTagsForResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_tags_for_resource::SetTagsForResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_tags_for_resource::ser_set_tags_for_resource_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_tags_for_resource::SetTagsForResource::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SetTagsForResource {
                type Output = std::result::Result<crate::operation::set_tags_for_resource::SetTagsForResourceOutput, crate::operation::set_tags_for_resource::SetTagsForResourceError>;
