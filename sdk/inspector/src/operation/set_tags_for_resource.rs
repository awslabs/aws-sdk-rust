...
impl SetTagsForResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_tags_for_resource::SetTagsForResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetTagsForResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_set_tags_for_resource::de_set_tags_for_resource_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_tags_for_resource::SetTagsForResourceError
{
