...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput,
                    crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError,
                > for RegisterCrossAccountAccessRoleFluentBuilder
            {
                fn send(
                    self,
...
impl RegisterCrossAccountAccessRoleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRole::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRole::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput, crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError, Self> {
