...
impl DeleteAssessmentTemplateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAssessmentTemplate`](crate::operation::delete_assessment_template::DeleteAssessmentTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_assessment_template::DeleteAssessmentTemplate, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_assessment_template::DeleteAssessmentTemplateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_assessment_template::DeleteAssessmentTemplate::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAssessmentTemplate {
                type Output = std::result::Result<crate::operation::delete_assessment_template::DeleteAssessmentTemplateOutput, crate::operation::delete_assessment_template::DeleteAssessmentTemplateError>;
