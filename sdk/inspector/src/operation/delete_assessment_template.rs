...
impl DeleteAssessmentTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_assessment_template::DeleteAssessmentTemplate,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAssessmentTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_assessment_template::de_delete_assessment_template_http_response_with_props(status, headers, body)
        }
    }
}
