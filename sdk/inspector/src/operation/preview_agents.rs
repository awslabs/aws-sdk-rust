...
impl PreviewAgentsInput {
    /// Consumes the builder and constructs an Operation<[`PreviewAgents`](crate::operation::preview_agents::PreviewAgents)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::preview_agents::PreviewAgents, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_preview_agents::ser_preview_agents_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::preview_agents::PreviewAgents::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PreviewAgents {
    type Output = ::std::result::Result<crate::operation::preview_agents::PreviewAgentsOutput, crate::operation::preview_agents::PreviewAgentsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_preview_agents::de_preview_agents_http_response_with_props(status, headers, body)
        }
    }
}
