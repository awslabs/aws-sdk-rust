...
impl PreviewAgentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::preview_agents::PreviewAgents::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PreviewAgents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_preview_agents::de_preview_agents_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_preview_agents::de_preview_agents_http_response_with_props(
                status, headers, body,
            )
        }
    }
