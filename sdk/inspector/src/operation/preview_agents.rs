...
/// Orchestration and serialization glue logic for `PreviewAgents`.
...
impl PreviewAgents {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::preview_agents::PreviewAgentsInput,
                    ) -> ::std::result::Result<crate::operation::preview_agents::PreviewAgentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::preview_agents::PreviewAgentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::preview_agents::PreviewAgentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::preview_agents::PreviewAgentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PreviewAgents {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PreviewAgents");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PreviewAgentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PreviewAgentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PreviewAgents")
...
.with_interceptor(PreviewAgentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::preview_agents::PreviewAgentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::preview_agents::PreviewAgentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::preview_agents::PreviewAgentsError>::new());
...
#[derive(Debug)]
            struct PreviewAgentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PreviewAgentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_preview_agents::de_preview_agents_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_preview_agents::de_preview_agents_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct PreviewAgentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PreviewAgentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::preview_agents::PreviewAgentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::preview_agents::PreviewAgentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_preview_agents::ser_preview_agents_input(&input)?);
...
#[derive(Debug)]
            struct PreviewAgentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PreviewAgentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PreviewAgentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PreviewAgentsInput>()
                        .ok_or("failed to downcast to PreviewAgentsInput")?;
...
pub enum PreviewAgentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PreviewAgentsError) for what information is available for the error.")]
...
impl PreviewAgentsError {
    /// Creates the `PreviewAgentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PreviewAgentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PreviewAgentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::preview_agents::PreviewAgentsError {
