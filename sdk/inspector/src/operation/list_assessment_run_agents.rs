...
/// Orchestration and serialization glue logic for `ListAssessmentRunAgents`.
...
impl ListAssessmentRunAgents {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssessmentRunAgents {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssessmentRunAgents");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssessmentRunAgentsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssessmentRunAgentsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAssessmentRunAgents")
...
.with_interceptor(ListAssessmentRunAgentsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError>::new());
...
#[derive(Debug)]
            struct ListAssessmentRunAgentsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssessmentRunAgentsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_assessment_run_agents::de_list_assessment_run_agents_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_assessment_run_agents::de_list_assessment_run_agents_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAssessmentRunAgentsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssessmentRunAgentsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_assessment_run_agents::ser_list_assessment_run_agents_input(&input)?);
...
#[derive(Debug)]
            struct ListAssessmentRunAgentsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssessmentRunAgentsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAssessmentRunAgentsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssessmentRunAgentsInput>()
                        .ok_or("failed to downcast to ListAssessmentRunAgentsInput")?;
...
pub enum ListAssessmentRunAgentsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssessmentRunAgentsError) for what information is available for the error.")]
...
impl ListAssessmentRunAgentsError {
    /// Creates the `ListAssessmentRunAgentsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssessmentRunAgentsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssessmentRunAgentsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError {
...
mod _list_assessment_run_agents_output;
