...
impl ListAssessmentRunAgentsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssessmentRunAgents`](crate::operation::list_assessment_run_agents::ListAssessmentRunAgents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_assessment_run_agents::ListAssessmentRunAgents, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_assessment_run_agents::ListAssessmentRunAgents::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAssessmentRunAgents", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListAssessmentRunAgents`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssessmentRunAgents {
                type Output = std::result::Result<crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsOutput, crate::operation::list_assessment_run_agents::ListAssessmentRunAgentsError>;
