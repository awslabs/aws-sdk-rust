...
impl ListAssessmentRunsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssessmentRuns`](crate::operation::list_assessment_runs::ListAssessmentRuns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_assessment_runs::ListAssessmentRuns, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_assessment_runs::ListAssessmentRunsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_assessment_runs::ser_list_assessment_runs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_assessment_runs::ListAssessmentRuns::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAssessmentRuns", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListAssessmentRuns`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssessmentRuns {
                type Output = std::result::Result<crate::operation::list_assessment_runs::ListAssessmentRunsOutput, crate::operation::list_assessment_runs::ListAssessmentRunsError>;
