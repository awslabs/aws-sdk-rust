...
impl ListAssessmentRunsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_assessment_runs::ser_list_assessment_runs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssessmentRuns {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_assessment_runs::de_list_assessment_runs_http_response_with_props(status, headers, body)
        }
    }
}
