...
impl RegisterCrossAccountAccessRoleInput {
    /// Consumes the builder and constructs an Operation<[`RegisterCrossAccountAccessRole`](crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRole::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegisterCrossAccountAccessRole", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `RegisterCrossAccountAccessRole`.
...
impl aws_smithy_http::response::ParseStrictResponse for RegisterCrossAccountAccessRole {
                type Output = std::result::Result<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput, crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_register_cross_account_access_role::de_register_cross_account_access_role_http_error(response)
                     } else {
                        crate::protocol_serde::shape_register_cross_account_access_role::de_register_cross_account_access_role_http_response(response)
                     }
                }
            }
