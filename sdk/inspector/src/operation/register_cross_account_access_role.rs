...
/// Orchestration and serialization glue logic for `RegisterCrossAccountAccessRole`.
...
impl RegisterCrossAccountAccessRole {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegisterCrossAccountAccessRole {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegisterCrossAccountAccessRole");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegisterCrossAccountAccessRoleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegisterCrossAccountAccessRoleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterCrossAccountAccessRole")
...
.with_interceptor(RegisterCrossAccountAccessRoleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError>::new());
...
#[derive(Debug)]
            struct RegisterCrossAccountAccessRoleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterCrossAccountAccessRoleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_register_cross_account_access_role::de_register_cross_account_access_role_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RegisterCrossAccountAccessRoleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegisterCrossAccountAccessRoleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_register_cross_account_access_role::ser_register_cross_account_access_role_input(&input)?);
...
#[derive(Debug)]
            struct RegisterCrossAccountAccessRoleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterCrossAccountAccessRoleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegisterCrossAccountAccessRoleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegisterCrossAccountAccessRoleInput>()
                        .ok_or("failed to downcast to RegisterCrossAccountAccessRoleInput")?;
...
pub enum RegisterCrossAccountAccessRoleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegisterCrossAccountAccessRoleError) for what information is available for the error.")]
...
impl RegisterCrossAccountAccessRoleError {
    /// Creates the `RegisterCrossAccountAccessRoleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterCrossAccountAccessRoleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterCrossAccountAccessRoleError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegisterCrossAccountAccessRoleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError {
...
mod _register_cross_account_access_role_output;
