...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterCrossAccountAccessRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_cross_account_access_role::de_register_cross_account_access_role_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleError
{
