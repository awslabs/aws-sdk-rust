...
pub use crate::operation::describe_rules_packages::_describe_rules_packages_output::DescribeRulesPackagesOutputBuilder;

pub use crate::operation::describe_rules_packages::_describe_rules_packages_input::DescribeRulesPackagesInputBuilder;
...
impl DescribeRulesPackagesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_rules_packages();
...
pub struct DescribeRulesPackagesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_rules_packages::builders::DescribeRulesPackagesInputBuilder,
...
impl DescribeRulesPackagesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_rules_packages::DescribeRulesPackagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_rules_packages::DescribeRulesPackagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::describe_rules_packages::DescribeRulesPackages::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::describe_rules_packages::DescribeRulesPackages::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_rules_packages::DescribeRulesPackagesOutput, crate::operation::describe_rules_packages::DescribeRulesPackagesError, Self> {
