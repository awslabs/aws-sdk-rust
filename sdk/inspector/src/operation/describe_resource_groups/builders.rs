...
impl DescribeResourceGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_resource_groups::DescribeResourceGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_resource_groups::DescribeResourceGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_resource_groups::DescribeResourceGroupsOutput, crate::operation::describe_resource_groups::DescribeResourceGroupsError, Self> {
