...
pub use crate::operation::delete_assessment_run::_delete_assessment_run_output::DeleteAssessmentRunOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_assessment_run::DeleteAssessmentRunOutput,
                    crate::operation::delete_assessment_run::DeleteAssessmentRunError,
                > for DeleteAssessmentRunFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteAssessmentRunFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_assessment_run::builders::DeleteAssessmentRunInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_assessment_run::DeleteAssessmentRunOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_assessment_run::DeleteAssessmentRunError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_assessment_run::DeleteAssessmentRun::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_assessment_run::DeleteAssessmentRun::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_assessment_run::DeleteAssessmentRunOutput, crate::operation::delete_assessment_run::DeleteAssessmentRunError, Self> {
