...
impl  ListAssessmentTemplatesOutput  {
    ...
    pub fn assessment_template_arns(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.assessment_template_arns.deref()
    }
    /// <p>When a response is generated, if there is more data to be listed, this parameter is present in the response and contains the value to use for the <b>nextToken</b> parameter in a subsequent pagination request. If there is no more data to be listed, this parameter is set to null.</p>
...
impl ListAssessmentTemplatesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_assessment_templates::ListAssessmentTemplatesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_assessment_templates::ListAssessmentTemplatesOutput {
                assessment_template_arns: self.assessment_template_arns
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assessment_template_arns", "assessment_template_arns was not specified but it is required when building ListAssessmentTemplatesOutput")
                    )?
                ,
