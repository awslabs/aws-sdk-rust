...
impl ListAssessmentTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_assessment_templates::ListAssessmentTemplatesInput, ::aws_smithy_types::error::operation::BuildError> {
