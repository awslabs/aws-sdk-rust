...
impl  DescribeAssessmentRunsOutput  {
    ...
    pub fn assessment_runs(&self) -> & [crate::types::AssessmentRun] {
        use std::ops::Deref; self.assessment_runs.deref()
    }
    /// <p>Assessment run details that cannot be described. An error code is provided for each failed item.</p>
...
impl DescribeAssessmentRunsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_assessment_runs::DescribeAssessmentRunsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_assessment_runs::DescribeAssessmentRunsOutput {
                assessment_runs: self.assessment_runs
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assessment_runs", "assessment_runs was not specified but it is required when building DescribeAssessmentRunsOutput")
                    )?
                ,
                failed_items: self.failed_items
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("failed_items", "failed_items was not specified but it is required when building DescribeAssessmentRunsOutput")
                    )?
                ,
