...
pub use crate::operation::preview_agents::_preview_agents_output::PreviewAgentsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::preview_agents::PreviewAgentsOutput,
                    crate::operation::preview_agents::PreviewAgentsError,
                > for PreviewAgentsFluentBuilder
            {
                fn send(
                    self,
...
impl PreviewAgentsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::preview_agents::PreviewAgentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::preview_agents::PreviewAgentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::preview_agents::PreviewAgents::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::preview_agents::PreviewAgentsOutput, crate::operation::preview_agents::PreviewAgentsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::preview_agents::paginator::PreviewAgentsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
