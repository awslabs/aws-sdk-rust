...
impl DescribeRulesPackagesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRulesPackages`](crate::operation::describe_rules_packages::DescribeRulesPackages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_rules_packages::DescribeRulesPackages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_rules_packages::DescribeRulesPackagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_rules_packages::DescribeRulesPackages::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeRulesPackages {
                type Output = std::result::Result<crate::operation::describe_rules_packages::DescribeRulesPackagesOutput, crate::operation::describe_rules_packages::DescribeRulesPackagesError>;
