...
/// Orchestration and serialization glue logic for `DescribeRulesPackages`.
...
impl DescribeRulesPackages {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_rules_packages::DescribeRulesPackagesInput,
                    ) -> ::std::result::Result<crate::operation::describe_rules_packages::DescribeRulesPackagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_rules_packages::DescribeRulesPackagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_rules_packages::DescribeRulesPackagesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_rules_packages::DescribeRulesPackagesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeRulesPackages {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeRulesPackages");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeRulesPackagesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeRulesPackagesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeRulesPackages")
...
.with_interceptor(DescribeRulesPackagesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_rules_packages::DescribeRulesPackagesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_rules_packages::DescribeRulesPackagesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_rules_packages::DescribeRulesPackagesError>::new());
...
#[derive(Debug)]
            struct DescribeRulesPackagesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeRulesPackagesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_rules_packages::de_describe_rules_packages_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_rules_packages::de_describe_rules_packages_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeRulesPackagesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeRulesPackagesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_rules_packages::DescribeRulesPackagesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_rules_packages::DescribeRulesPackagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_rules_packages::ser_describe_rules_packages_input(&input)?);
...
#[derive(Debug)]
            struct DescribeRulesPackagesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeRulesPackagesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeRulesPackagesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeRulesPackagesInput>()
                        .ok_or("failed to downcast to DescribeRulesPackagesInput")?;
...
pub enum DescribeRulesPackagesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeRulesPackagesError) for what information is available for the error.")]
...
impl DescribeRulesPackagesError {
    /// Creates the `DescribeRulesPackagesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeRulesPackagesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeRulesPackagesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_rules_packages::DescribeRulesPackagesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_rules_packages::_describe_rules_packages_output::DescribeRulesPackagesOutput;

pub use crate::operation::describe_rules_packages::_describe_rules_packages_input::DescribeRulesPackagesInput;

mod _describe_rules_packages_input;

mod _describe_rules_packages_output;
