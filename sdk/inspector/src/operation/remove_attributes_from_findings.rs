...
impl RemoveAttributesFromFindings {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RemoveAttributesFromFindings",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveAttributesFromFindings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RemoveAttributesFromFindingsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RemoveAttributesFromFindingsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RemoveAttributesFromFindings")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveAttributesFromFindingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_remove_attributes_from_findings::de_remove_attributes_from_findings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_remove_attributes_from_findings::de_remove_attributes_from_findings_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveAttributesFromFindingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_remove_attributes_from_findings::ser_remove_attributes_from_findings_input(&input)?,
        );
