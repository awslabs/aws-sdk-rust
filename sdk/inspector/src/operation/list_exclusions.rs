...
impl ListExclusionsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_exclusions::ListExclusions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListExclusions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_exclusions::de_list_exclusions_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_exclusions::de_list_exclusions_http_response(
                status, headers, body,
            )
        }
    }
