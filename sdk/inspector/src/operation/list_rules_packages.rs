...
impl ListRulesPackagesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_rules_packages::ser_list_rules_packages_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRulesPackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_rules_packages::de_list_rules_packages_http_response_with_props(status, headers, body)
        }
    }
}
