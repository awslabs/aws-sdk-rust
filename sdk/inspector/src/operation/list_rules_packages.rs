...
impl ListRulesPackagesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_rules_packages::ListRulesPackages::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRulesPackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_rules_packages::de_list_rules_packages_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_rules_packages::ListRulesPackagesError
{
