...
impl StartAssessmentRunInput {
    /// Consumes the builder and constructs an Operation<[`StartAssessmentRun`](crate::operation::start_assessment_run::StartAssessmentRun)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_assessment_run::ser_start_assessment_run_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_assessment_run::StartAssessmentRun::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAssessmentRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_assessment_run::de_start_assessment_run_http_response_with_props(status, headers, body)
        }
    }
}
