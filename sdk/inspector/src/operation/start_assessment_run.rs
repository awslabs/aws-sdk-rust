...
impl StartAssessmentRunInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_assessment_run::StartAssessmentRun::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAssessmentRun {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_assessment_run::de_start_assessment_run_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_assessment_run::StartAssessmentRunError
{
