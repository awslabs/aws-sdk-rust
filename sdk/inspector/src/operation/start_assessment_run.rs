...
/// Orchestration and serialization glue logic for `StartAssessmentRun`.
...
impl StartAssessmentRun {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::start_assessment_run::StartAssessmentRunInput,
    ) -> ::std::result::Result<
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_assessment_run::StartAssessmentRunError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_assessment_run::StartAssessmentRunOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Inspector", "StartAssessmentRun", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Inspector.StartAssessmentRun",
                "rpc.service" = "Inspector",
                "rpc.method" = "StartAssessmentRun",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartAssessmentRun {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartAssessmentRun");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            StartAssessmentRunRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            StartAssessmentRunResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("StartAssessmentRun")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartAssessmentRun")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartAssessmentRunTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartAssessmentRunEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct StartAssessmentRunTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAssessmentRunTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartAssessmentRunInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("assessmentTemplateArn") {
            if let ::std::option::Option::Some(value) = input.assessment_template_arn.as_deref() {
                captured.insert("assessmentTemplateArn", value);
            }
        }
        if requested.should_capture("assessmentRunName") {
            if let ::std::option::Option::Some(value) = input.assessment_run_name.as_deref() {
                captured.insert("assessmentRunName", value);
            }
        }
...
#[derive(Debug)]
struct StartAssessmentRunResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartAssessmentRunResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_start_assessment_run::de_start_assessment_run_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_assessment_run::de_start_assessment_run_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct StartAssessmentRunRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartAssessmentRunRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::start_assessment_run::StartAssessmentRunInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::start_assessment_run::StartAssessmentRunInput,
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_assessment_run::ser_start_assessment_run_input(&input)?);
...
#[derive(Debug)]
struct StartAssessmentRunEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartAssessmentRunEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "StartAssessmentRunEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<StartAssessmentRunInput>()
            .ok_or("failed to downcast to StartAssessmentRunInput")?;
...
pub enum StartAssessmentRunError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartAssessmentRunError) for what information is available for the error.")]
...
impl StartAssessmentRunError {
    ...
    /// Creates the `StartAssessmentRunError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AgentsAlreadyRunningAssessmentException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InternalException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidCrossAccountRoleException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::ServiceTemporarilyUnavailableException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for StartAssessmentRunError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::AgentsAlreadyRunningAssessmentException(_inner) => ::std::option::Option::Some(_inner),
            Self::InternalException(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidCrossAccountRoleException(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::ServiceTemporarilyUnavailableException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartAssessmentRunError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::AgentsAlreadyRunningAssessmentException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InternalException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidCrossAccountRoleException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::ServiceTemporarilyUnavailableException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartAssessmentRunError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_assessment_run::StartAssessmentRunError {
...
mod _start_assessment_run_output;
