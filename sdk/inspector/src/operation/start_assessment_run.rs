...
impl StartAssessmentRunInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_assessment_run::StartAssessmentRun, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_assessment_run::StartAssessmentRunInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_assessment_run::ser_start_assessment_run_input(&self)?
        );
...
/// `ParseStrictResponse` impl for `StartAssessmentRun`.
...
impl aws_smithy_http::response::ParseStrictResponse for StartAssessmentRun {
                type Output = std::result::Result<crate::operation::start_assessment_run::StartAssessmentRunOutput, crate::operation::start_assessment_run::StartAssessmentRunError>;
