...
impl CreateResourceGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateResourceGroup`](crate::operation::create_resource_group::CreateResourceGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_resource_group::CreateResourceGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_resource_group::CreateResourceGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_resource_group::ser_create_resource_group_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource_group::CreateResourceGroup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateResourceGroup {
                type Output = std::result::Result<crate::operation::create_resource_group::CreateResourceGroupOutput, crate::operation::create_resource_group::CreateResourceGroupError>;
