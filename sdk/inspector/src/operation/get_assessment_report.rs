...
impl GetAssessmentReportInput {
    /// Consumes the builder and constructs an Operation<[`GetAssessmentReport`](crate::operation::get_assessment_report::GetAssessmentReport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_assessment_report::GetAssessmentReport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_assessment_report::GetAssessmentReportInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_assessment_report::GetAssessmentReport::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetAssessmentReport {
                type Output = std::result::Result<crate::operation::get_assessment_report::GetAssessmentReportOutput, crate::operation::get_assessment_report::GetAssessmentReportError>;
