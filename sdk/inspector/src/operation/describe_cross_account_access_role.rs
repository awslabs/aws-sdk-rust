...
impl DescribeCrossAccountAccessRoleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRole::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCrossAccountAccessRole {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_cross_account_access_role::de_describe_cross_account_access_role_http_response_with_props(
                status, headers, body,
            )
        }
    }
