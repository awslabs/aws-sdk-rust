...
impl DescribeCrossAccountAccessRoleInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCrossAccountAccessRole`](crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRole, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRoleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRole::new())
