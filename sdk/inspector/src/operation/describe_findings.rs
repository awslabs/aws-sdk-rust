...
impl DescribeFindingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFindings`](crate::operation::describe_findings::DescribeFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_findings::DescribeFindings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_findings::DescribeFindingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_findings::DescribeFindings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeFindings", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `DescribeFindings`.
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeFindings {
                type Output = std::result::Result<crate::operation::describe_findings::DescribeFindingsOutput, crate::operation::describe_findings::DescribeFindingsError>;
