...
impl DescribeFindingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_findings::DescribeFindings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_findings::de_describe_findings_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_findings::DescribeFindingsError
{
