...
impl DescribeFindingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_findings::DescribeFindings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_findings::ser_describe_findings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_findings::de_describe_findings_http_response_with_props(status, headers, body)
        }
    }
}
