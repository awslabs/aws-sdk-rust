...
impl ListEventSubscriptionsFluentBuilder {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_event_subscriptions::paginator::ListEventSubscriptionsPaginator::send) which returns a `Stream`.
