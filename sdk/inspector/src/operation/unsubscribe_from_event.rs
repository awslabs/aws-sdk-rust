...
impl UnsubscribeFromEvent {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::unsubscribe_from_event::UnsubscribeFromEventError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::unsubscribe_from_event::UnsubscribeFromEventOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Inspector", "UnsubscribeFromEvent", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Inspector.UnsubscribeFromEvent",
                "rpc.service" = "Inspector",
                "rpc.method" = "UnsubscribeFromEvent",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnsubscribeFromEvent {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UnsubscribeFromEventRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UnsubscribeFromEventResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UnsubscribeFromEvent")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnsubscribeFromEvent")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UnsubscribeFromEventTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UnsubscribeFromEventTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UnsubscribeFromEventTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UnsubscribeFromEventInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnsubscribeFromEventResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_unsubscribe_from_event::de_unsubscribe_from_event_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_unsubscribe_from_event::de_unsubscribe_from_event_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnsubscribeFromEventRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::unsubscribe_from_event::UnsubscribeFromEventInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::unsubscribe_from_event::UnsubscribeFromEventInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_unsubscribe_from_event::ser_unsubscribe_from_event_input(
            &input,
        )?);
