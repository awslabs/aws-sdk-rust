...
impl AddAttributesToFindings {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::add_attributes_to_findings::AddAttributesToFindingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::add_attributes_to_findings::AddAttributesToFindingsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Inspector", "AddAttributesToFindings", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Inspector.AddAttributesToFindings",
                "rpc.service" = "Inspector",
                "rpc.method" = "AddAttributesToFindings",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddAttributesToFindings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AddAttributesToFindingsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AddAttributesToFindingsResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AddAttributesToFindings")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddAttributesToFindingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_add_attributes_to_findings::de_add_attributes_to_findings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_add_attributes_to_findings::de_add_attributes_to_findings_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddAttributesToFindingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::add_attributes_to_findings::AddAttributesToFindingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::add_attributes_to_findings::AddAttributesToFindingsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_add_attributes_to_findings::ser_add_attributes_to_findings_input(&input)?,
        );
