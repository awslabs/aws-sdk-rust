...
impl AddAttributesToFindingsInput {
    /// Consumes the builder and constructs an Operation<[`AddAttributesToFindings`](crate::operation::add_attributes_to_findings::AddAttributesToFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_attributes_to_findings::AddAttributesToFindings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_attributes_to_findings::AddAttributesToFindingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_attributes_to_findings::AddAttributesToFindings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddAttributesToFindings", "inspector"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `AddAttributesToFindings`.
...
impl aws_smithy_http::response::ParseStrictResponse for AddAttributesToFindings {
                type Output = std::result::Result<crate::operation::add_attributes_to_findings::AddAttributesToFindingsOutput, crate::operation::add_attributes_to_findings::AddAttributesToFindingsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_add_attributes_to_findings::de_add_attributes_to_findings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_add_attributes_to_findings::de_add_attributes_to_findings_http_response(response)
                     }
                }
            }
