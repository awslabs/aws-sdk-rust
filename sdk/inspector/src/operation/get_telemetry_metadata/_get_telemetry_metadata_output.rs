...
impl GetTelemetryMetadataOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_telemetry_metadata::GetTelemetryMetadataOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_telemetry_metadata::GetTelemetryMetadataOutput {
                telemetry_metadata: self.telemetry_metadata
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("telemetry_metadata", "telemetry_metadata was not specified but it is required when building GetTelemetryMetadataOutput")
                    )?
                ,
