...
pub fn ser_output_config(
    ...
    match input {
        crate::types::OutputConfig::Cropping(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_2.key("cropping").start_object();
            crate::protocol_serde::shape_cropping_config::ser_cropping_config(&mut object_1, inner)?;
            object_1.finish();
        }
        crate::types::OutputConfig::Clipping(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_2.key("clipping").start_object();
