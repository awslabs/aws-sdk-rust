...
impl ::aws_types::request_id::RequestId for GetDictionaryOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetDictionaryOutput {
    /// Creates a new builder-style object to manufacture [`GetDictionaryOutput`](crate::operation::get_dictionary::GetDictionaryOutput).
    pub fn builder() -> crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder {
        crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::default()
    }
}

/// A builder for [`GetDictionaryOutput`](crate::operation::get_dictionary::GetDictionaryOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetDictionaryOutputBuilder {
...
impl GetDictionaryOutputBuilder {
    /// <p>The name of the dictionary.</p>
    ...
    /// Consumes the builder and constructs a [`GetDictionaryOutput`](crate::operation::get_dictionary::GetDictionaryOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`name`](crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::name)
    /// - [`arn`](crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::arn)
    /// - [`id`](crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::id)
    /// - [`language`](crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::language)
    /// - [`status`](crate::operation::get_dictionary::builders::GetDictionaryOutputBuilder::status)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::get_dictionary::GetDictionaryOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::get_dictionary::GetDictionaryOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building GetDictionaryOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building GetDictionaryOutput",
                )
            })?,
            id: self.id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "id",
                    "id was not specified but it is required when building GetDictionaryOutput",
                )
            })?,
            language: self.language.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "language",
                    "language was not specified but it is required when building GetDictionaryOutput",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building GetDictionaryOutput",
                )
            })?,
