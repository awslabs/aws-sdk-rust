...
impl super::Client {
    ...
    ///   - [`dry_run(bool)`](crate::operation::disassociate_feed::builders::DisassociateFeedFluentBuilder::dry_run) / [`set_dry_run(Option<bool>)`](crate::operation::disassociate_feed::builders::DisassociateFeedFluentBuilder::set_dry_run):<br>required: **false**<br><p>Set to true if you want to do a dry run of the disassociate action.</p> <p>Elemental Inference will validate that the real request would succeed without actually making any changes. A dry run catches errors such as missing IAM permissions. If the dry run fails, the action returns a 4xx error code.</p><br>
    /// - On success, responds with [`DisassociateFeedOutput`](crate::operation::disassociate_feed::DisassociateFeedOutput) with field(s):
    ///   - [`arn(String)`](crate::operation::disassociate_feed::DisassociateFeedOutput::arn): <p>The ARN of the feed.</p>
    ///   - [`id(String)`](crate::operation::disassociate_feed::DisassociateFeedOutput::id): <p>The ID of the feed.</p>
