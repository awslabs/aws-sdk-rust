...
pub trait Waiters {
    ...
    fn wait_until_feed_deleted(&self) -> crate::waiters::feed_deleted::FeedDeletedFluentBuilder;
}
impl Waiters for Client {
    fn wait_until_feed_deleted(&self) -> crate::waiters::feed_deleted::FeedDeletedFluentBuilder {
        crate::waiters::feed_deleted::FeedDeletedFluentBuilder::new(self.handle.clone())
    }
}
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_elementalinference::Error> {
/// # let client: aws_sdk_elementalinference::Client = unimplemented!();
