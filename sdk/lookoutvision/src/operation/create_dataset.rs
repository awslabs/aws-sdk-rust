...
impl CreateDatasetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_dataset::CreateDataset, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_dataset::ser_create_dataset_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataset {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_dataset::de_create_dataset_http_response_with_props(status, headers, body)
        }
    }
}
