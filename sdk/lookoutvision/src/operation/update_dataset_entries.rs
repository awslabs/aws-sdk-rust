    ...
    pub(crate) async fn orchestrate(
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::update_dataset_entries::UpdateDatasetEntriesInput = input.downcast_mut().expect("correct type");
...
#[derive(Debug)]
    ...
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("dataset_type", "cannot be empty or unset"))?;
    ...
    if dataset_type.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("dataset_type", "cannot be empty or unset"))
                }
    ::std::write!(output, "/2020-11-20/projects/{ProjectName}/datasets/{DatasetType}/entries", ProjectName = project_name, DatasetType = dataset_type).expect("formatting should succeed");
