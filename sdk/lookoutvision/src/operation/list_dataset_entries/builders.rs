...
impl ListDatasetEntriesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_dataset_entries::ListDatasetEntriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_dataset_entries::ListDatasetEntriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_dataset_entries::ListDatasetEntriesOutput, crate::operation::list_dataset_entries::ListDatasetEntriesError, Self> {
