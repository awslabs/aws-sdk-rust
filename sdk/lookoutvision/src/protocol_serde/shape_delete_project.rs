            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::delete_project::DeleteProjectError::unhandled("Failed to parse RetryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
                output.build()
...
) -> Result<crate::operation::delete_project::builders::DeleteProjectOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
