...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_model_packaging_jobs::ListModelPackagingJobsError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_model_packaging_jobs::de_list_model_packaging_jobs(_response_body, output)
            .map_err(crate::operation::list_model_packaging_jobs::ListModelPackagingJobsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "ModelPackagingJobs" => {
                    builder = builder.set_model_packaging_jobs(crate::protocol_serde::shape_model_packaging_jobs_list::de_model_packaging_jobs_list(
                        tokens,
                    )?);
                }
                "NextToken" => {
