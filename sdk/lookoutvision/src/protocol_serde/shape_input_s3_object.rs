...
pub fn ser_input_s3_object(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputS3Object) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
