...
) -> ::std::result::Result<Option<crate::types::GreengrassConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "S3OutputLocation" => {
                            builder = builder.set_s3_output_location(crate::protocol_serde::shape_s3_location::de_s3_location(tokens)?);
                        }
                        "ComponentName" => {
