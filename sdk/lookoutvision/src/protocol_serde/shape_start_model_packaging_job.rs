...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_model_packaging_job::StartModelPackagingJobError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_model_packaging_job::de_start_model_packaging_job(_response_body, output)
            .map_err(crate::operation::start_model_packaging_job::StartModelPackagingJobError::unhandled)?;
