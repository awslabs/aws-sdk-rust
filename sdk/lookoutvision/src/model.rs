...
pub struct ModelPackagingConfiguration  {
    ...
    #[doc(hidden)]pub greengrass: std::option::Option<crate::model::GreengrassConfiguration>,
}
...
pub struct GreengrassConfiguration  {
    ...
    #[doc(hidden)]pub compiler_options: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub target_device: std::option::Option<crate::model::TargetDevice>,
    /// <p>The target platform for the model. If you specify <code>TargetPlatform</code>, you can't specify <code>TargetDevice</code>. </p>
    #[doc(hidden)]pub target_platform: std::option::Option<crate::model::TargetPlatform>,
    /// <p> An S3 location in which Lookout for Vision stores the component artifacts. </p>
    #[doc(hidden)]pub s3_output_location: std::option::Option<crate::model::S3Location>,
    ...
    #[doc(hidden)]pub component_description: std::option::Option<std::string::String>,
...
pub struct TargetPlatform  {
    ...
    #[doc(hidden)]pub os: std::option::Option<crate::model::TargetPlatformOs>,
    ...
    #[doc(hidden)]pub arch: std::option::Option<crate::model::TargetPlatformArch>,
    ...
    /// </ul>
    #[doc(hidden)]pub accelerator: std::option::Option<crate::model::TargetPlatformAccelerator>,
}
impl TargetPlatform {
    /// <p>The target operating system for the model. Linux is the only operating system that is currently supported. </p>
...
pub struct ModelMetadata  {
    ...
    #[doc(hidden)]pub performance: std::option::Option<crate::model::ModelPerformance>,
}
impl ModelMetadata {
    /// <p>The unix timestamp for the date and time that the model was created. </p>
    pub fn creation_timestamp(&self) -> std::option::Option<& aws_smithy_types::DateTime> {
...
pub struct ModelPerformance  {
    ...
    #[doc(hidden)]pub recall: std::option::Option<f32>,
    /// <p>The overall precision metric value for the trained model.</p>
    #[doc(hidden)]pub precision: std::option::Option<f32>,
}
...
pub struct ModelPackagingJobMetadata  {
    ...
    #[doc(hidden)]pub model_packaging_job_description: std::option::Option<std::string::String>,
    /// <p> The AWS service used to package the job. Currently Lookout for Vision can package jobs with AWS IoT Greengrass. </p>
    #[doc(hidden)]pub model_packaging_method: std::option::Option<std::string::String>,
    /// <p>The status of the model packaging job. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ModelPackagingJobStatus>,
...
impl  std::fmt::Debug for ModelPackagingJobMetadata  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("project_name", &self.project_name);
        formatter.field("model_version", &self.model_version);
        formatter.field("model_packaging_job_description", &self.model_packaging_job_description);
...
pub struct DetectAnomalyResult  {
    ...
    /// <p>An image classification model doesn't return an <code>Anomalies</code> list. </p>
    #[doc(hidden)]pub anomaly_mask: std::option::Option<aws_smithy_types::Blob>,
}
...
pub struct Anomaly  {
    ...
    #[doc(hidden)]pub pixel_anomaly: std::option::Option<crate::model::PixelAnomaly>,
}
impl Anomaly {
    /// <p>The name of an anomaly type found in an image. <code>Name</code> maps to an anomaly type in the training dataset, apart from the anomaly type <code>background</code>. The service automatically inserts the <code>background</code> anomaly type into the response from <code>DetectAnomalies</code>. </p>
...
pub struct PixelAnomaly  {
    ...
    #[doc(hidden)]pub total_percentage_area: std::option::Option<f32>,
    ...
    #[doc(hidden)]pub color: std::option::Option<std::string::String>,
}
impl PixelAnomaly {
    /// <p>The percentage area of the image that the anomaly type covers.</p>
...
pub struct ModelPackagingDescription  {
    ...
    #[doc(hidden)]pub model_packaging_configuration: std::option::Option<crate::model::ModelPackagingConfiguration>,
    /// <p>The description for the model packaging job. </p>
    #[doc(hidden)]pub model_packaging_job_description: std::option::Option<std::string::String>,
    /// <p>The AWS service used to package the job. Currently Lookout for Vision can package jobs with AWS IoT Greengrass. </p>
    #[doc(hidden)]pub model_packaging_method: std::option::Option<std::string::String>,
    /// <p>Information about the output of the model packaging job. For more information, see <code>DescribeModelPackagingJob</code>. </p>
    #[doc(hidden)]pub model_packaging_output_details: std::option::Option<crate::model::ModelPackagingOutputDetails>,
    /// <p> The status of the model packaging job. </p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ModelPackagingJobStatus>,
    /// <p> The status message for the model packaging job. </p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for ModelPackagingDescription  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("project_name", &self.project_name);
        formatter.field("model_version", &self.model_version);
        formatter.field("model_packaging_configuration", &self.model_packaging_configuration);
        formatter.field("model_packaging_job_description", &self.model_packaging_job_description);
        formatter.field("model_packaging_method", &self.model_packaging_method);
        formatter.field("model_packaging_output_details", &self.model_packaging_output_details);
        formatter.field("status", &self.status);
        formatter.field("status_message", &self.status_message);
        formatter.field("creation_timestamp", &self.creation_timestamp);
        formatter.field("last_updated_timestamp", &self.last_updated_timestamp);
...
pub struct ModelPackagingOutputDetails  {
    ...
    #[doc(hidden)]pub greengrass: std::option::Option<crate::model::GreengrassOutputDetails>,
}
...
pub struct ModelDescription  {
    ...
    #[doc(hidden)]pub evaluation_manifest: std::option::Option<crate::model::OutputS3Object>,
    /// <p>The S3 location where Amazon Lookout for Vision saves the performance metrics.</p>
    #[doc(hidden)]pub evaluation_result: std::option::Option<crate::model::OutputS3Object>,
    /// <p>The unix timestamp for the date and time that the evaluation ended. </p>
    #[doc(hidden)]pub evaluation_end_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct DatasetDescription  {
    ...
    #[doc(hidden)]pub image_stats: std::option::Option<crate::model::DatasetImageStats>,
}
...
pub struct DatasetImageStats  {
    ...
    #[doc(hidden)]pub labeled: std::option::Option<i32>,
    /// <p>The total number of images labeled as normal.</p>
    #[doc(hidden)]pub normal: std::option::Option<i32>,
    /// <p>the total number of images labeled as an anomaly.</p>
    #[doc(hidden)]pub anomaly: std::option::Option<i32>,
}
...
pub struct DatasetSource  {
    ...
    #[doc(hidden)]pub ground_truth_manifest: std::option::Option<crate::model::DatasetGroundTruthManifest>,
}
impl DatasetSource {
    /// <p>Location information for the manifest file.</p>
...
pub struct DatasetGroundTruthManifest  {
    ...
    #[doc(hidden)]pub s3_object: std::option::Option<crate::model::InputS3Object>,
}
