...
pub struct ModelDescription {
    ...
    pub evaluation_end_timestamp: std::option::Option<smithy_types::Instant>,
...
pub mod model_description {
    ...
    pub struct Builder {
        ...
        pub(crate) evaluation_end_timestamp: std::option::Option<smithy_types::Instant>,
    ...
    impl Builder {
        ...
        /// <p>The unix timestamp for the date and time that the evaluation ended. </p>
        pub fn evaluation_end_timestamp(mut self, input: smithy_types::Instant) -> Self {
