...
impl super::Client {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::detect_anomalies::builders::DetectAnomaliesFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::detect_anomalies::builders::DetectAnomaliesFluentBuilder::set_project_name): <p>The name of the project that contains the model version that you want to use.</p>
    ///   - [`model_version(impl ::std::convert::Into<String>)`](crate::operation::detect_anomalies::builders::DetectAnomaliesFluentBuilder::model_version) / [`set_model_version(Option<String>)`](crate::operation::detect_anomalies::builders::DetectAnomaliesFluentBuilder::set_model_version): <p>The version of the model that you want to use.</p>
