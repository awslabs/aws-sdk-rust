...
impl super::Client {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::set_project_name): <p>The name of the project that contains the dataset that you want to describe.</p>
    ///   - [`dataset_type(impl ::std::convert::Into<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::dataset_type) / [`set_dataset_type(Option<String>)`](crate::operation::describe_dataset::builders::DescribeDatasetFluentBuilder::set_dataset_type): <p>The type of the dataset to describe. Specify <code>train</code> to describe the training dataset. Specify <code>test</code> to describe the test dataset. If you have a single dataset project, specify <code>train</code> </p>
