...
pub(crate) fn lens_structure_crate_output_list_model_packaging_jobs_output_model_packaging_jobs(
    input: crate::output::ListModelPackagingJobsOutput,
...
pub(crate) fn lens_structure_crate_output_list_models_output_models(
    input: crate::output::ListModelsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ModelMetadata>> {
...
pub(crate) fn lens_structure_crate_output_list_projects_output_projects(
    input: crate::output::ListProjectsOutput,
) -> std::option::Option<std::vec::Vec<crate::model::ProjectMetadata>> {
