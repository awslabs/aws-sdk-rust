...
impl Builder {
    ...
    /// use aws_sdk_lookoutvision::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_lookoutvision::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
