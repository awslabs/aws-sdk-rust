...
impl super::Client {
    ...
    ///   - [`resource_properties(impl Into<String>)`](crate::operation::update_profile_resource_association::builders::UpdateProfileResourceAssociationFluentBuilder::resource_properties) / [`set_resource_properties(Option<String>)`](crate::operation::update_profile_resource_association::builders::UpdateProfileResourceAssociationFluentBuilder::set_resource_properties):<br>required: **false**<br><p>If you are adding a DNS Firewall rule group, include also a priority in this format:</p> <p><code>Key=FirewallRuleGroupPriority,Value=100</code>.</p><br>
