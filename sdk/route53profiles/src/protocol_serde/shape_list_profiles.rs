...
pub fn de_list_profiles_http_error(
    ...
    Err(match error_code {
        ...
        "InvalidParameterException" => crate::operation::list_profiles::ListProfilesError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ProfileSummaries" => {
                    builder = builder.set_profile_summaries(crate::protocol_serde::shape_profile_summary_list::de_profile_summary_list(tokens)?);
                }
