    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`DeleteRecommendationPreferencesInput`](crate::input::DeleteRecommendationPreferencesInput) with field(s):
    ///   - [`resource_type(Option<ResourceType>)`](crate::input::DeleteRecommendationPreferencesInput::resource_type): <p>The target resource type of the recommendation preference to delete.</p>  <p>The <code>Ec2Instance</code> option encompasses standalone instances and instances that are part of Auto Scaling groups. The <code>AutoScalingGroup</code> option encompasses only instances that are part of an Auto Scaling group.</p>
    ///   - [`scope(Option<Scope>)`](crate::input::DeleteRecommendationPreferencesInput::scope): <p>An object that describes the scope of the recommendation preference to delete.</p>  <p>You can delete recommendation preferences that are created at the organization level (for management accounts of an organization only), account level, and resource level. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/enhanced-infrastructure-metrics.html">Activating enhanced infrastructure metrics</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`recommendation_preference_names(Option<Vec<RecommendationPreferenceName>>)`](crate::input::DeleteRecommendationPreferencesInput::recommendation_preference_names): <p>The name of the recommendation preference to delete.</p>  <p>Enhanced infrastructure metrics (<code>EnhancedInfrastructureMetrics</code>) is the only feature that can be activated through preferences. Therefore, it is also the only recommendation preference that can be deleted.</p>
    ...
    ///
    /// - Takes [`DescribeRecommendationExportJobsInput`](crate::input::DescribeRecommendationExportJobsInput) with field(s):
    ///   - [`job_ids(Option<Vec<String>>)`](crate::input::DescribeRecommendationExportJobsInput::job_ids): <p>The identification numbers of the export jobs to return.</p>  <p>An export job ID is returned when you create an export using the <code>ExportAutoScalingGroupRecommendations</code> or <code>ExportEC2InstanceRecommendations</code> actions.</p>  <p>All export jobs created in the last seven days are returned if this parameter is omitted.</p>
    ///   - [`filters(Option<Vec<JobFilter>>)`](crate::input::DescribeRecommendationExportJobsInput::filters): <p>An array of objects to specify a filter that returns a more specific list of export jobs.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeRecommendationExportJobsInput::next_token): <p>The token to advance to the next page of export jobs.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeRecommendationExportJobsInput::max_results): <p>The maximum number of export jobs to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ...
    ///
    /// - Takes [`ExportEbsVolumeRecommendationsInput`](crate::input::ExportEbsVolumeRecommendationsInput) with field(s):
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::ExportEbsVolumeRecommendationsInput::account_ids): <p>The IDs of the Amazon Web Services accounts for which to export Amazon EBS volume recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to export recommendations.</p>  <p>This parameter cannot be specified together with the include member accounts parameter. The parameters are mutually exclusive.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the include member accounts parameter, is omitted.</p>  <p>You can specify multiple account IDs per request.</p>
    ///   - [`filters(Option<Vec<EbsFilter>>)`](crate::input::ExportEbsVolumeRecommendationsInput::filters): <p>An array of objects to specify a filter that exports a more specific set of Amazon EBS volume recommendations.</p>
    ///   - [`fields_to_export(Option<Vec<ExportableVolumeField>>)`](crate::input::ExportEbsVolumeRecommendationsInput::fields_to_export): <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`s3_destination_config(Option<S3DestinationConfig>)`](crate::input::ExportEbsVolumeRecommendationsInput::s3_destination_config): <p>Describes the destination Amazon Simple Storage Service (Amazon S3) bucket name and key prefix for a recommendations export job.</p>  <p>You must create the destination Amazon S3 bucket for your recommendations export before you create the export job. Compute Optimizer does not create the S3 bucket for you. After you create the S3 bucket, ensure that it has the required permission policy to allow Compute Optimizer to write the export file to it. If you plan to specify an object prefix when you create the export job, you must include the object prefix in the policy that you add to the S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/create-s3-bucket-policy-for-compute-optimizer.html">Amazon S3 Bucket Policy for Compute Optimizer</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`file_format(Option<FileFormat>)`](crate::input::ExportEbsVolumeRecommendationsInput::file_format): <p>The format of the export file.</p>  <p>The only export file format currently supported is <code>Csv</code>.</p>
    ///   - [`include_member_accounts(bool)`](crate::input::ExportEbsVolumeRecommendationsInput::include_member_accounts): <p>Indicates whether to include recommendations for resources in all member accounts of the organization if your account is the management account of an organization.</p>  <p>The member accounts must also be opted in to Compute Optimizer, and trusted access for Compute Optimizer must be enabled in the organization account. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/security-iam.html#trusted-service-access">Compute Optimizer and Amazon Web Services Organizations trusted access</a> in the <i>Compute Optimizer User Guide</i>.</p>  <p>Recommendations for member accounts of the organization are not included in the export file if this parameter is omitted.</p>  <p>This parameter cannot be specified together with the account IDs parameter. The parameters are mutually exclusive.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the account IDs parameter, is omitted.</p>
    ...
    ///
    /// - Takes [`ExportEc2InstanceRecommendationsInput`](crate::input::ExportEc2InstanceRecommendationsInput) with field(s):
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::ExportEc2InstanceRecommendationsInput::account_ids): <p>The IDs of the Amazon Web Services accounts for which to export instance recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to export recommendations.</p>  <p>This parameter cannot be specified together with the include member accounts parameter. The parameters are mutually exclusive.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the include member accounts parameter, is omitted.</p>  <p>You can specify multiple account IDs per request.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::ExportEc2InstanceRecommendationsInput::filters): <p>An array of objects to specify a filter that exports a more specific set of instance recommendations.</p>
    ///   - [`fields_to_export(Option<Vec<ExportableInstanceField>>)`](crate::input::ExportEc2InstanceRecommendationsInput::fields_to_export): <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`s3_destination_config(Option<S3DestinationConfig>)`](crate::input::ExportEc2InstanceRecommendationsInput::s3_destination_config): <p>An object to specify the destination Amazon Simple Storage Service (Amazon S3) bucket name and key prefix for the export job.</p>  <p>You must create the destination Amazon S3 bucket for your recommendations export before you create the export job. Compute Optimizer does not create the S3 bucket for you. After you create the S3 bucket, ensure that it has the required permissions policy to allow Compute Optimizer to write the export file to it. If you plan to specify an object prefix when you create the export job, you must include the object prefix in the policy that you add to the S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/create-s3-bucket-policy-for-compute-optimizer.html">Amazon S3 Bucket Policy for Compute Optimizer</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`file_format(Option<FileFormat>)`](crate::input::ExportEc2InstanceRecommendationsInput::file_format): <p>The format of the export file.</p>  <p>The only export file format currently supported is <code>Csv</code>.</p>
    ///   - [`include_member_accounts(bool)`](crate::input::ExportEc2InstanceRecommendationsInput::include_member_accounts): <p>Indicates whether to include recommendations for resources in all member accounts of the organization if your account is the management account of an organization.</p>  <p>The member accounts must also be opted in to Compute Optimizer, and trusted access for Compute Optimizer must be enabled in the organization account. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/security-iam.html#trusted-service-access">Compute Optimizer and Amazon Web Services Organizations trusted access</a> in the <i>Compute Optimizer User Guide</i>.</p>  <p>Recommendations for member accounts of the organization are not included in the export file if this parameter is omitted.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the account IDs parameter, is omitted.</p>
    ///   - [`recommendation_preferences(Option<RecommendationPreferences>)`](crate::input::ExportEc2InstanceRecommendationsInput::recommendation_preferences): <p>An object to specify the preferences for the Amazon EC2 instance recommendations to export.</p>
    ...
    ///
    /// - Takes [`ExportLambdaFunctionRecommendationsInput`](crate::input::ExportLambdaFunctionRecommendationsInput) with field(s):
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::ExportLambdaFunctionRecommendationsInput::account_ids): <p>The IDs of the Amazon Web Services accounts for which to export Lambda function recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to export recommendations.</p>  <p>This parameter cannot be specified together with the include member accounts parameter. The parameters are mutually exclusive.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the include member accounts parameter, is omitted.</p>  <p>You can specify multiple account IDs per request.</p>
    ///   - [`filters(Option<Vec<LambdaFunctionRecommendationFilter>>)`](crate::input::ExportLambdaFunctionRecommendationsInput::filters): <p>An array of objects to specify a filter that exports a more specific set of Lambda function recommendations.</p>
    ///   - [`fields_to_export(Option<Vec<ExportableLambdaFunctionField>>)`](crate::input::ExportLambdaFunctionRecommendationsInput::fields_to_export): <p>The recommendations data to include in the export file. For more information about the fields that can be exported, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/exporting-recommendations.html#exported-files">Exported files</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`s3_destination_config(Option<S3DestinationConfig>)`](crate::input::ExportLambdaFunctionRecommendationsInput::s3_destination_config): <p>Describes the destination Amazon Simple Storage Service (Amazon S3) bucket name and key prefix for a recommendations export job.</p>  <p>You must create the destination Amazon S3 bucket for your recommendations export before you create the export job. Compute Optimizer does not create the S3 bucket for you. After you create the S3 bucket, ensure that it has the required permission policy to allow Compute Optimizer to write the export file to it. If you plan to specify an object prefix when you create the export job, you must include the object prefix in the policy that you add to the S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/create-s3-bucket-policy-for-compute-optimizer.html">Amazon S3 Bucket Policy for Compute Optimizer</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`file_format(Option<FileFormat>)`](crate::input::ExportLambdaFunctionRecommendationsInput::file_format): <p>The format of the export file.</p>  <p>The only export file format currently supported is <code>Csv</code>.</p>
    ///   - [`include_member_accounts(bool)`](crate::input::ExportLambdaFunctionRecommendationsInput::include_member_accounts): <p>Indicates whether to include recommendations for resources in all member accounts of the organization if your account is the management account of an organization.</p>  <p>The member accounts must also be opted in to Compute Optimizer, and trusted access for Compute Optimizer must be enabled in the organization account. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/security-iam.html#trusted-service-access">Compute Optimizer and Amazon Web Services Organizations trusted access</a> in the <i>Compute Optimizer User Guide</i>.</p>  <p>Recommendations for member accounts of the organization are not included in the export file if this parameter is omitted.</p>  <p>This parameter cannot be specified together with the account IDs parameter. The parameters are mutually exclusive.</p>  <p>Recommendations for member accounts are not included in the export if this parameter, or the account IDs parameter, is omitted.</p>
    ...
    ///
    /// - Takes [`GetAutoScalingGroupRecommendationsInput`](crate::input::GetAutoScalingGroupRecommendationsInput) with field(s):
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::GetAutoScalingGroupRecommendationsInput::account_ids): <p>The ID of the Amazon Web Services account for which to return Auto Scaling group recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return Auto Scaling group recommendations.</p>  <p>Only one account ID can be specified per request.</p>
    ///   - [`auto_scaling_group_arns(Option<Vec<String>>)`](crate::input::GetAutoScalingGroupRecommendationsInput::auto_scaling_group_arns): <p>The Amazon Resource Name (ARN) of the Auto Scaling groups for which to return recommendations.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetAutoScalingGroupRecommendationsInput::next_token): <p>The token to advance to the next page of Auto Scaling group recommendations.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetAutoScalingGroupRecommendationsInput::max_results): <p>The maximum number of Auto Scaling group recommendations to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::GetAutoScalingGroupRecommendationsInput::filters): <p>An array of objects to specify a filter that returns a more specific list of Auto Scaling group recommendations.</p>
    ///   - [`recommendation_preferences(Option<RecommendationPreferences>)`](crate::input::GetAutoScalingGroupRecommendationsInput::recommendation_preferences): <p>An object to specify the preferences for the Auto Scaling group recommendations to return in the response.</p>
    ...
    ///
    /// - Takes [`GetEbsVolumeRecommendationsInput`](crate::input::GetEbsVolumeRecommendationsInput) with field(s):
    ///   - [`volume_arns(Option<Vec<String>>)`](crate::input::GetEbsVolumeRecommendationsInput::volume_arns): <p>The Amazon Resource Name (ARN) of the volumes for which to return recommendations.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetEbsVolumeRecommendationsInput::next_token): <p>The token to advance to the next page of volume recommendations.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetEbsVolumeRecommendationsInput::max_results): <p>The maximum number of volume recommendations to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ///   - [`filters(Option<Vec<EbsFilter>>)`](crate::input::GetEbsVolumeRecommendationsInput::filters): <p>An array of objects to specify a filter that returns a more specific list of volume recommendations.</p>
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::GetEbsVolumeRecommendationsInput::account_ids): <p>The ID of the Amazon Web Services account for which to return volume recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return volume recommendations.</p>  <p>Only one account ID can be specified per request.</p>
    ...
    ///
    /// - Takes [`GetEc2InstanceRecommendationsInput`](crate::input::GetEc2InstanceRecommendationsInput) with field(s):
    ///   - [`instance_arns(Option<Vec<String>>)`](crate::input::GetEc2InstanceRecommendationsInput::instance_arns): <p>The Amazon Resource Name (ARN) of the instances for which to return recommendations.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetEc2InstanceRecommendationsInput::next_token): <p>The token to advance to the next page of instance recommendations.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetEc2InstanceRecommendationsInput::max_results): <p>The maximum number of instance recommendations to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::GetEc2InstanceRecommendationsInput::filters): <p>An array of objects to specify a filter that returns a more specific list of instance recommendations.</p>
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::GetEc2InstanceRecommendationsInput::account_ids): <p>The ID of the Amazon Web Services account for which to return instance recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return instance recommendations.</p>  <p>Only one account ID can be specified per request.</p>
    ///   - [`recommendation_preferences(Option<RecommendationPreferences>)`](crate::input::GetEc2InstanceRecommendationsInput::recommendation_preferences): <p>An object to specify the preferences for the Amazon EC2 instance recommendations to return in the response.</p>
    ...
    ///
    /// - Takes [`GetEc2RecommendationProjectedMetricsInput`](crate::input::GetEc2RecommendationProjectedMetricsInput) with field(s):
    ///   - [`instance_arn(Option<String>)`](crate::input::GetEc2RecommendationProjectedMetricsInput::instance_arn): <p>The Amazon Resource Name (ARN) of the instances for which to return recommendation projected metrics.</p>
    ///   - [`stat(Option<MetricStatistic>)`](crate::input::GetEc2RecommendationProjectedMetricsInput::stat): <p>The statistic of the projected metrics.</p>
    ///   - [`period(i32)`](crate::input::GetEc2RecommendationProjectedMetricsInput::period): <p>The granularity, in seconds, of the projected metrics data points.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::GetEc2RecommendationProjectedMetricsInput::start_time): <p>The timestamp of the first projected metrics data point to return.</p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::GetEc2RecommendationProjectedMetricsInput::end_time): <p>The timestamp of the last projected metrics data point to return.</p>
    ///   - [`recommendation_preferences(Option<RecommendationPreferences>)`](crate::input::GetEc2RecommendationProjectedMetricsInput::recommendation_preferences): <p>An object to specify the preferences for the Amazon EC2 recommendation projected metrics to return in the response.</p>
    ...
    ///
    /// - Takes [`GetEffectiveRecommendationPreferencesInput`](crate::input::GetEffectiveRecommendationPreferencesInput) with field(s):
    ///   - [`resource_arn(Option<String>)`](crate::input::GetEffectiveRecommendationPreferencesInput::resource_arn): <p>The Amazon Resource Name (ARN) of the resource for which to confirm effective recommendation preferences. Only EC2 instance and Auto Scaling group ARNs are currently supported.</p>
    ...
    ///
    /// - Takes [`GetEnrollmentStatusInput`](crate::input::GetEnrollmentStatusInput)
    ...
    ///
    /// - Takes [`GetEnrollmentStatusesForOrganizationInput`](crate::input::GetEnrollmentStatusesForOrganizationInput) with field(s):
    ///   - [`filters(Option<Vec<EnrollmentFilter>>)`](crate::input::GetEnrollmentStatusesForOrganizationInput::filters): <p>An array of objects to specify a filter that returns a more specific list of account enrollment statuses.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetEnrollmentStatusesForOrganizationInput::next_token): <p>The token to advance to the next page of account enrollment statuses.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetEnrollmentStatusesForOrganizationInput::max_results): <p>The maximum number of account enrollment statuses to return with a single request. You can specify up to 100 statuses to return with each request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ...
    ///
    /// - Takes [`GetLambdaFunctionRecommendationsInput`](crate::input::GetLambdaFunctionRecommendationsInput) with field(s):
    ///   - [`function_arns(Option<Vec<String>>)`](crate::input::GetLambdaFunctionRecommendationsInput::function_arns): <p>The Amazon Resource Name (ARN) of the functions for which to return recommendations.</p>  <p>You can specify a qualified or unqualified ARN. If you specify an unqualified ARN without a function version suffix, Compute Optimizer will return recommendations for the latest (<code>$LATEST</code>) version of the function. If you specify a qualified ARN with a version suffix, Compute Optimizer will return recommendations for the specified function version. For more information about using function versions, see <a href="https://docs.aws.amazon.com/lambda/latest/dg/configuration-versions.html#versioning-versions-using">Using versions</a> in the <i>Lambda Developer Guide</i>.</p>
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::GetLambdaFunctionRecommendationsInput::account_ids): <p>The ID of the Amazon Web Services account for which to return function recommendations.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return function recommendations.</p>  <p>Only one account ID can be specified per request.</p>
    ///   - [`filters(Option<Vec<LambdaFunctionRecommendationFilter>>)`](crate::input::GetLambdaFunctionRecommendationsInput::filters): <p>An array of objects to specify a filter that returns a more specific list of function recommendations.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetLambdaFunctionRecommendationsInput::next_token): <p>The token to advance to the next page of function recommendations.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetLambdaFunctionRecommendationsInput::max_results): <p>The maximum number of function recommendations to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ...
    ///
    /// - Takes [`GetRecommendationPreferencesInput`](crate::input::GetRecommendationPreferencesInput) with field(s):
    ///   - [`resource_type(Option<ResourceType>)`](crate::input::GetRecommendationPreferencesInput::resource_type): <p>The target resource type of the recommendation preference for which to return preferences.</p>  <p>The <code>Ec2Instance</code> option encompasses standalone instances and instances that are part of Auto Scaling groups. The <code>AutoScalingGroup</code> option encompasses only instances that are part of an Auto Scaling group.</p>
    ///   - [`scope(Option<Scope>)`](crate::input::GetRecommendationPreferencesInput::scope): <p>An object that describes the scope of the recommendation preference to return.</p>  <p>You can return recommendation preferences that are created at the organization level (for management accounts of an organization only), account level, and resource level. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/enhanced-infrastructure-metrics.html">Activating enhanced infrastructure metrics</a> in the <i>Compute Optimizer User Guide</i>.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetRecommendationPreferencesInput::next_token): <p>The token to advance to the next page of recommendation preferences.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetRecommendationPreferencesInput::max_results): <p>The maximum number of recommendation preferences to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ...
    ///
    /// - Takes [`GetRecommendationSummariesInput`](crate::input::GetRecommendationSummariesInput) with field(s):
    ///   - [`account_ids(Option<Vec<String>>)`](crate::input::GetRecommendationSummariesInput::account_ids): <p>The ID of the Amazon Web Services account for which to return recommendation summaries.</p>  <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return recommendation summaries.</p>  <p>Only one account ID can be specified per request.</p>
    ///   - [`next_token(Option<String>)`](crate::input::GetRecommendationSummariesInput::next_token): <p>The token to advance to the next page of recommendation summaries.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::GetRecommendationSummariesInput::max_results): <p>The maximum number of recommendation summaries to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
    ...
    ///
    /// - Takes [`PutRecommendationPreferencesInput`](crate::input::PutRecommendationPreferencesInput) with field(s):
    ///   - [`resource_type(Option<ResourceType>)`](crate::input::PutRecommendationPreferencesInput::resource_type): <p>The target resource type of the recommendation preference to create.</p>  <p>The <code>Ec2Instance</code> option encompasses standalone instances and instances that are part of Auto Scaling groups. The <code>AutoScalingGroup</code> option encompasses only instances that are part of an Auto Scaling group.</p>
    ///   - [`scope(Option<Scope>)`](crate::input::PutRecommendationPreferencesInput::scope): <p>An object that describes the scope of the recommendation preference to create.</p>  <p>You can create recommendation preferences at the organization level (for management accounts of an organization only), account level, and resource level. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/enhanced-infrastructure-metrics.html">Activating enhanced infrastructure metrics</a> in the <i>Compute Optimizer User Guide</i>.</p> <note>   <p>You cannot create recommendation preferences for Auto Scaling groups at the organization and account levels. You can create recommendation preferences for Auto Scaling groups only at the resource level by specifying a scope name of <code>ResourceArn</code> and a scope value of the Auto Scaling group Amazon Resource Name (ARN). This will configure the preference for all instances that are part of the specified the Auto Scaling group.</p>  </note>
    ///   - [`enhanced_infrastructure_metrics(Option<EnhancedInfrastructureMetrics>)`](crate::input::PutRecommendationPreferencesInput::enhanced_infrastructure_metrics): <p>The status of the enhanced infrastructure metrics recommendation preference to create or update.</p>  <p>A status of <code>Active</code> confirms that the preference is applied in the latest recommendation refresh, and a status of <code>Inactive</code> confirms that it's not yet applied.</p>
