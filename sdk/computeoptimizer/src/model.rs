...
pub struct Scope  {
    ...
    /// </ul>
    #[doc(hidden)]pub name: std::option::Option<crate::model::ScopeName>,
...
pub struct RecommendationSummary  {
    ...
    #[doc(hidden)]pub summaries: std::option::Option<std::vec::Vec<crate::model::Summary>>,
    /// <p>The resource type that the recommendation summary applies to.</p>
    #[doc(hidden)]pub recommendation_resource_type: std::option::Option<crate::model::RecommendationSourceType>,
    ...
    #[doc(hidden)]pub savings_opportunity: std::option::Option<crate::model::SavingsOpportunity>,
    /// <p>An object that describes the performance risk ratings for a given resource type.</p>
    #[doc(hidden)]pub current_performance_risk_ratings: std::option::Option<crate::model::CurrentPerformanceRiskRatings>,
}
...
impl  std::fmt::Debug for RecommendationSummary  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("recommendation_resource_type", &self.recommendation_resource_type);
        formatter.field("account_id", &self.account_id);
        formatter.field("savings_opportunity", &self.savings_opportunity);
        formatter.field("current_performance_risk_ratings", &self.current_performance_risk_ratings);
        formatter.finish()
    }
}
...
pub struct SavingsOpportunity  {
    ...
    #[doc(hidden)]pub savings_opportunity_percentage: f64,
    ...
    #[doc(hidden)]pub estimated_monthly_savings: std::option::Option<crate::model::EstimatedMonthlySavings>,
}
...
impl  std::fmt::Debug for SavingsOpportunity  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("savings_opportunity_percentage", &self.savings_opportunity_percentage);
...
pub struct Summary  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::Finding>,
    /// <p>The value of the recommendation summary.</p>
    #[doc(hidden)]pub value: f64,
    /// <p>An array of objects that summarize a finding reason code.</p>
    #[doc(hidden)]pub reason_code_summaries: std::option::Option<std::vec::Vec<crate::model::ReasonCodeSummary>>,
}
impl Summary {
    /// <p>The finding classification of the recommendation.</p>
...
pub struct ReasonCodeSummary  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::FindingReasonCode>,
...
pub struct RecommendationPreferencesDetail  {
    ...
    #[doc(hidden)]pub inferred_workload_types: std::option::Option<crate::model::InferredWorkloadTypesPreference>,
}
...
pub struct LambdaFunctionRecommendation  {
    ...
    /// </note> </li> 
    /// </ul>
    #[doc(hidden)]pub finding: std::option::Option<crate::model::LambdaFunctionRecommendationFinding>,
    ...
    /// </ul>
    #[doc(hidden)]pub finding_reason_codes: std::option::Option<std::vec::Vec<crate::model::LambdaFunctionRecommendationFindingReasonCode>>,
    /// <p>An array of objects that describe the memory configuration recommendation options for the function.</p>
    #[doc(hidden)]pub memory_size_recommendation_options: std::option::Option<std::vec::Vec<crate::model::LambdaFunctionMemoryRecommendationOption>>,
    ...
    #[doc(hidden)]pub current_performance_risk: std::option::Option<crate::model::CurrentPerformanceRisk>,
}
...
impl  std::fmt::Debug for LambdaFunctionRecommendation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("memory_size_recommendation_options", &self.memory_size_recommendation_options);
...
pub struct LambdaFunctionMemoryRecommendationOption  {
    ...
    #[doc(hidden)]pub memory_size: i32,
    /// <p>An array of objects that describe the projected utilization metrics of the function recommendation option.</p>
    #[doc(hidden)]pub projected_utilization_metrics: std::option::Option<std::vec::Vec<crate::model::LambdaFunctionMemoryProjectedMetric>>,
...
impl  std::fmt::Debug for LambdaFunctionMemoryRecommendationOption  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("projected_utilization_metrics", &self.projected_utilization_metrics);
        formatter.field("savings_opportunity", &self.savings_opportunity);
        formatter.finish()
    }
}
...
pub struct LambdaFunctionMemoryProjectedMetric  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::LambdaFunctionMemoryMetricName>,
    /// <p>The statistic of the projected utilization metric.</p>
    #[doc(hidden)]pub statistic: std::option::Option<crate::model::LambdaFunctionMemoryMetricStatistic>,
...
pub struct LambdaFunctionUtilizationMetric  {
    ...
    /// </ul>
    #[doc(hidden)]pub name: std::option::Option<crate::model::LambdaFunctionMetricName>,
    ...
    #[doc(hidden)]pub statistic: std::option::Option<crate::model::LambdaFunctionMetricStatistic>,
...
pub struct LambdaFunctionRecommendationFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::LambdaFunctionRecommendationFilterName>,
...
pub struct EnrollmentFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::EnrollmentFilterName>,
    /// <p>The value of the filter.</p> 
...
pub struct RecommendedOptionProjectedMetric  {
    ...
    #[doc(hidden)]pub projected_metrics: std::option::Option<std::vec::Vec<crate::model::ProjectedMetric>>,
}
...
pub struct ProjectedMetric  {
    ...
    /// </note> </li> 
    /// </ul>
    #[doc(hidden)]pub name: std::option::Option<crate::model::MetricName>,
...
pub struct RecommendationPreferences  {
    ...
    /// </ul>
    #[doc(hidden)]pub cpu_vendor_architectures: std::option::Option<std::vec::Vec<crate::model::CpuVendorArchitecture>>,
}
...
pub struct InstanceRecommendation  {
    ...
    #[doc(hidden)]pub current_instance_type: std::option::Option<std::string::String>,
    ...
    /// </note>
    #[doc(hidden)]pub finding_reason_codes: std::option::Option<std::vec::Vec<crate::model::InstanceRecommendationFindingReasonCode>>,
    /// <p>An array of objects that describe the utilization metrics of the instance.</p>
    #[doc(hidden)]pub utilization_metrics: std::option::Option<std::vec::Vec<crate::model::UtilizationMetric>>,
    /// <p>The number of days for which utilization metrics were analyzed for the instance.</p>
    #[doc(hidden)]pub look_back_period_in_days: f64,
    /// <p>An array of objects that describe the recommendation options for the instance.</p>
    #[doc(hidden)]pub recommendation_options: std::option::Option<std::vec::Vec<crate::model::InstanceRecommendationOption>>,
    /// <p>An array of objects that describe the source resource of the recommendation.</p>
    #[doc(hidden)]pub recommendation_sources: std::option::Option<std::vec::Vec<crate::model::RecommendationSource>>,
    ...
    #[doc(hidden)]pub effective_recommendation_preferences: std::option::Option<crate::model::EffectiveRecommendationPreferences>,
    ...
    /// </ul>
    #[doc(hidden)]pub inferred_workload_types: std::option::Option<std::vec::Vec<crate::model::InferredWorkloadType>>,
}
...
impl  std::fmt::Debug for InstanceRecommendation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("last_refresh_timestamp", &self.last_refresh_timestamp);
        formatter.field("current_performance_risk", &self.current_performance_risk);
        formatter.field("effective_recommendation_preferences", &self.effective_recommendation_preferences);
        formatter.field("inferred_workload_types", &self.inferred_workload_types);
        formatter.finish()
    }
}
...
pub struct RecommendationSource  {
    ...
    #[doc(hidden)]pub recommendation_source_arn: std::option::Option<std::string::String>,
    /// <p>The resource type of the recommendation source.</p>
    #[doc(hidden)]pub recommendation_source_type: std::option::Option<crate::model::RecommendationSourceType>,
}
...
impl  std::fmt::Debug for RecommendationSource  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("recommendation_source_type", &self.recommendation_source_type);
        formatter.finish()
    }
}
...
pub struct InstanceRecommendationOption  {
    ...
    /// </note>
    #[doc(hidden)]pub projected_utilization_metrics: std::option::Option<std::vec::Vec<crate::model::UtilizationMetric>>,
    ...
    #[doc(hidden)]pub performance_risk: f64,
    ...
    #[doc(hidden)]pub migration_effort: std::option::Option<crate::model::MigrationEffort>,
}
...
pub struct Filter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::FilterName>,
    /// <p>The value of the filter.</p> 
...
pub struct VolumeRecommendation  {
    ...
    #[doc(hidden)]pub current_configuration: std::option::Option<crate::model::VolumeConfiguration>,
    ...
    /// </ul>
    #[doc(hidden)]pub finding: std::option::Option<crate::model::EbsFinding>,
    /// <p>An array of objects that describe the utilization metrics of the volume.</p>
    #[doc(hidden)]pub utilization_metrics: std::option::Option<std::vec::Vec<crate::model::EbsUtilizationMetric>>,
    ...
    #[doc(hidden)]pub volume_recommendation_options: std::option::Option<std::vec::Vec<crate::model::VolumeRecommendationOption>>,
...
impl  std::fmt::Debug for VolumeRecommendation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("utilization_metrics", &self.utilization_metrics);
        formatter.field("look_back_period_in_days", &self.look_back_period_in_days);
        formatter.field("volume_recommendation_options", &self.volume_recommendation_options);
        formatter.field("last_refresh_timestamp", &self.last_refresh_timestamp);
        formatter.field("current_performance_risk", &self.current_performance_risk);
        formatter.finish()
    }
...
pub struct VolumeRecommendationOption  {
    ...
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::VolumeConfiguration>,
...
pub struct VolumeConfiguration  {
    ...
    #[doc(hidden)]pub volume_size: i32,
    /// <p>The baseline IOPS of the volume.</p>
    #[doc(hidden)]pub volume_baseline_iops: i32,
    /// <p>The burst IOPS of the volume.</p>
    #[doc(hidden)]pub volume_burst_iops: i32,
    /// <p>The baseline throughput of the volume.</p>
    #[doc(hidden)]pub volume_baseline_throughput: i32,
    /// <p>The burst throughput of the volume.</p>
    #[doc(hidden)]pub volume_burst_throughput: i32,
}
...
impl  std::fmt::Debug for VolumeConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("volume_baseline_throughput", &self.volume_baseline_throughput);
...
pub struct EbsUtilizationMetric  {
    ...
    /// </ul>
    #[doc(hidden)]pub name: std::option::Option<crate::model::EbsMetricName>,
    /// <p>The statistic of the utilization metric.</p> 
    /// <p>The Compute Optimizer API, Command Line Interface (CLI), and SDKs return utilization metrics using only the <code>Maximum</code> statistic, which is the highest value observed during the specified period.</p> 
    /// <p>The Compute Optimizer console displays graphs for some utilization metrics using the <code>Average</code> statistic, which is the value of <code>Sum</code> / <code>SampleCount</code> during the specified period. For more information, see <a href="https://docs.aws.amazon.com/compute-optimizer/latest/ug/viewing-recommendations.html">Viewing resource recommendations</a> in the <i>Compute Optimizer User Guide</i>. You can also get averaged utilization metric data for your resources using Amazon CloudWatch. For more information, see the <a href="https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html">Amazon CloudWatch User Guide</a>.</p>
    #[doc(hidden)]pub statistic: std::option::Option<crate::model::MetricStatistic>,
...
pub struct EbsFilter  {
    /// <p>The name of the filter.</p> 
    /// <p>Specify <code>Finding</code> to return recommendations with a specific finding classification (for example, <code>NotOptimized</code>).</p>
    #[doc(hidden)]pub name: std::option::Option<crate::model::EbsFilterName>,
    /// <p>The value of the filter.</p> 
...
pub struct AutoScalingGroupRecommendation  {
    ...
    #[doc(hidden)]pub current_configuration: std::option::Option<crate::model::AutoScalingGroupConfiguration>,
    /// <p>An array of objects that describe the recommendation options for the Auto Scaling group.</p>
    #[doc(hidden)]pub recommendation_options: std::option::Option<std::vec::Vec<crate::model::AutoScalingGroupRecommendationOption>>,
...
pub struct AutoScalingGroupRecommendationOption  {
    ...
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::AutoScalingGroupConfiguration>,
...
pub struct AutoScalingGroupConfiguration  {
    ...
    #[doc(hidden)]pub desired_capacity: i32,
...
pub struct RecommendationExportJob  {
    ...
    #[doc(hidden)]pub destination: std::option::Option<crate::model::ExportDestination>,
...
pub struct ExportDestination  {
    ...
    #[doc(hidden)]pub s3: std::option::Option<crate::model::S3Destination>,
}
...
pub struct JobFilter  {
    ...
    #[doc(hidden)]pub name: std::option::Option<crate::model::JobFilterName>,
    /// <p>The value of the filter.</p> 
    /// <p>The valid values for this parameter are as follows, depending on what you specify for the <code>name</code> parameter:</p> 
    /// <ul> 
