...
pub fn ser_get_license_recommendations_input_input(
    ...
    input: &crate::operation::get_license_recommendations::GetLicenseRecommendationsInput,
        ...
        for item_8 in var_6 {
            {
                ...
                crate::protocol_serde::shape_license_recommendation_filter::ser_license_recommendation_filter(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
