...
pub fn ser_get_ec2_instance_recommendations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_ec2_instance_recommendations::GetEc2InstanceRecommendationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_1) = &input.instance_arns {
        let mut array_2 = object.key("instanceArns").start_array();
        for item_3 in var_1 {
             {
