                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "recommendationOptions" => {
                            builder = builder
                                .set_recommendation_options(crate::protocol_serde::shape_recommendation_options::de_recommendation_options(tokens)?);
                        }
                        "recommendationSources" => {
                            builder = builder
                                .set_recommendation_sources(crate::protocol_serde::shape_recommendation_sources::de_recommendation_sources(tokens)?);
                        }
