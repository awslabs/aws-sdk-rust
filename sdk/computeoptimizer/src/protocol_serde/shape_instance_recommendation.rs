...
pub(crate) fn de_instance_recommendation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceRecommendation>, aws_smithy_json::deserialize::error::DeserializeError>
