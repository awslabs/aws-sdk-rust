...
pub(crate) fn de_cpu_vendor_architectures(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<::std::vec::Vec<crate::types::CpuVendorArchitecture>, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::CpuVendorArchitecture>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::CpuVendorArchitecture>, ::aws_smithy_cbor::decode::DeserializeError> {
