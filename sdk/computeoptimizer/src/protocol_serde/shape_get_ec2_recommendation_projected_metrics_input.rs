...
pub fn ser_get_ec2_recommendation_projected_metrics_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetEc2RecommendationProjectedMetricsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
