...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OptInRequiredException" => {
            crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::OptInRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                ...
                let mut tmp = {
                    ...
                    output =
                        crate::protocol_serde::shape_service_unavailable_exception::de_service_unavailable_exception_cbor_err(_response_body, output)
                            .map_err(
                                crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::unhandled,
                            )?;
                    let output = output.meta(generic);
                    output.build()
                };
        ...
        "ThrottlingException" => {
            crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_ec2_recommendation_projected_metrics::de_get_ec2_recommendation_projected_metrics(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_ec2_recommendation_projected_metrics::GetEC2RecommendationProjectedMetricsError::unhandled)?;
...
pub fn ser_get_ec2_recommendation_projected_metrics_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_get_ec2_recommendation_projected_metrics_input::ser_get_ec2_recommendation_projected_metrics_input_input(
            encoder, input,
        )?;
    }
...
pub(crate) fn de_get_ec2_recommendation_projected_metrics(
    value: &[u8],
    mut builder: crate::operation::get_ec2_recommendation_projected_metrics::builders::GetEc2RecommendationProjectedMetricsOutputBuilder,
) -> ::std::result::Result<
    crate::operation::get_ec2_recommendation_projected_metrics::builders::GetEc2RecommendationProjectedMetricsOutputBuilder,
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "recommendedOptionProjectedMetrics" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_recommended_option_projected_metrics(Some(
                    crate::protocol_serde::shape_recommended_option_projected_metrics::de_recommended_option_projected_metrics(decoder, depth + 1)?,
                )))
            })?,
            _ => {
                decoder.skip()?;
