...
pub(crate) fn de_ecs_service_recommendation_option<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EcsServiceRecommendationOption>, aws_smithy_json::deserialize::error::DeserializeError>
