...
pub fn ser_delete_recommendation_preferences_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteRecommendationPreferencesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
