...
pub(crate) fn de_auto_scaling_group_recommendation_option<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoScalingGroupRecommendationOption>, aws_smithy_json::deserialize::error::DeserializeError>
