...
pub(crate) fn de_rds_instance_finding_reason_codes(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<::std::vec::Vec<crate::types::RdsInstanceFindingReasonCode>, ::aws_smithy_cbor::decode::DeserializeError> {
    fn member(
        mut list: ::std::vec::Vec<crate::types::RdsInstanceFindingReasonCode>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::RdsInstanceFindingReasonCode>, ::aws_smithy_cbor::decode::DeserializeError> {
