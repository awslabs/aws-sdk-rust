...
pub(crate) fn de_license_recommendation<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LicenseRecommendation>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "finding" => {
                                builder = builder.set_finding(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::LicenseFinding::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
