        ...
        builder = match decoder.str()?.as_ref() {
            ...
            "findingReasonCodes" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_finding_reason_codes(Some(
                    crate::protocol_serde::shape_license_finding_reason_codes::de_license_finding_reason_codes(decoder, depth + 1)?,
                )))
            })?,
            "licenseRecommendationOptions" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_license_recommendation_options(Some(
                    crate::protocol_serde::shape_license_recommendation_options::de_license_recommendation_options(decoder, depth + 1)?,
                )))
            })?,
