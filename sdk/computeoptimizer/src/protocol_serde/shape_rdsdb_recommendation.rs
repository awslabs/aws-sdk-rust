                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "instanceFindingReasonCodes" => {
                            builder = builder.set_instance_finding_reason_codes(
                                crate::protocol_serde::shape_rds_instance_finding_reason_codes::de_rds_instance_finding_reason_codes(tokens, _value)?,
                            );
                        }
                        ...
                        "storageFindingReasonCodes" => {
                            builder = builder.set_storage_finding_reason_codes(
                                crate::protocol_serde::shape_rds_storage_finding_reason_codes::de_rds_storage_finding_reason_codes(tokens, _value)?,
                            );
                        }
                        "instanceRecommendationOptions" => {
                            builder = builder.set_instance_recommendation_options(
                                crate::protocol_serde::shape_rdsdb_instance_recommendation_options::de_rdsdb_instance_recommendation_options(
                                    tokens, _value,
                                )?,
                            );
                        }
                        "storageRecommendationOptions" => {
                            builder = builder.set_storage_recommendation_options(
                                crate::protocol_serde::shape_rdsdb_storage_recommendation_options::de_rdsdb_storage_recommendation_options(
                                    tokens, _value,
                                )?,
                            );
                        }
                        "utilizationMetrics" => {
                            builder = builder.set_utilization_metrics(
                                crate::protocol_serde::shape_rdsdb_utilization_metrics::de_rdsdb_utilization_metrics(tokens, _value)?,
                            );
                        }
