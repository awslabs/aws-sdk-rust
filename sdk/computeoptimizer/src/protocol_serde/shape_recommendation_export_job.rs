...
) -> ::std::result::Result<Option<crate::types::RecommendationExportJob>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "destination" => {
                            builder = builder.set_destination(crate::protocol_serde::shape_export_destination::de_export_destination(tokens)?);
                        }
                        "resourceType" => {
