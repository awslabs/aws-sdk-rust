...
pub fn ser_export_ebs_volume_recommendations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::export_ebs_volume_recommendations::ExportEbsVolumeRecommendationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
        ...
        for item_6 in var_4 {
             {
                ...
                crate::protocol_serde::shape_ebs_filter::ser_ebs_filter(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
