...
pub(crate) fn de_auto_scaling_group_recommendation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoScalingGroupRecommendation>, aws_smithy_json::deserialize::error::DeserializeError>
