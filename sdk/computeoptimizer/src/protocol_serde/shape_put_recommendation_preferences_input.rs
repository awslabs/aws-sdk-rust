...
pub fn ser_put_recommendation_preferences_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutRecommendationPreferencesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
