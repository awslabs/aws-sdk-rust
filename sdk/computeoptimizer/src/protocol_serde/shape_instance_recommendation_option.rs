...
pub(crate) fn de_instance_recommendation_option<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InstanceRecommendationOption>, aws_smithy_json::deserialize::error::DeserializeError>
