...
pub fn ser_export_ec2_instance_recommendations_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_14) = &input.recommendation_preferences {
        ...
        crate::protocol_serde::shape_recommendation_preferences::ser_recommendation_preferences(&mut object_15, var_14)?;
        object_15.finish();
    }
    Ok(())
}
