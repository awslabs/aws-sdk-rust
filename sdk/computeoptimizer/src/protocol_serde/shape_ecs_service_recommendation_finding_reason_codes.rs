...
pub(crate) fn de_ecs_service_recommendation_finding_reason_codes(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<::std::vec::Vec<crate::types::EcsServiceRecommendationFindingReasonCode>, ::aws_smithy_cbor::decode::DeserializeError> {
    fn member(
        mut list: ::std::vec::Vec<crate::types::EcsServiceRecommendationFindingReasonCode>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::EcsServiceRecommendationFindingReasonCode>, ::aws_smithy_cbor::decode::DeserializeError>
    {
