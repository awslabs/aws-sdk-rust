...
pub(crate) fn de_lambda_estimated_monthly_savings(
    decoder: &mut ::aws_smithy_cbor::Decoder,
) -> ::std::result::Result<crate::types::LambdaEstimatedMonthlySavings, ::aws_smithy_cbor::decode::DeserializeError> {
    #[allow(clippy::match_single_binding)]
    fn pair(
        mut builder: crate::types::builders::LambdaEstimatedMonthlySavingsBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
    ...
    let mut builder = crate::types::builders::LambdaEstimatedMonthlySavingsBuilder::default();
