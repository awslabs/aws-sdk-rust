...
pub(crate) fn de_external_metrics_preference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ExternalMetricsPreference>, aws_smithy_json::deserialize::error::DeserializeError>
