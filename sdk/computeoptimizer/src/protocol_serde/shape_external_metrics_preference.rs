...
) -> ::std::result::Result<Option<crate::types::ExternalMetricsPreference>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "source" => {
                            builder = builder.set_source(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ExternalMetricsSource::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
