                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "currentConfiguration" => {
                            builder = builder
                                .set_current_configuration(crate::protocol_serde::shape_volume_configuration::de_volume_configuration(tokens)?);
                        }
                        "finding" => {
                        ...
                        "utilizationMetrics" => {
                            builder = builder
                                .set_utilization_metrics(crate::protocol_serde::shape_ebs_utilization_metrics::de_ebs_utilization_metrics(tokens)?);
                        }
