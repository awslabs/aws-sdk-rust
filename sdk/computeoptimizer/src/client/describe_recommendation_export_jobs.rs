...
impl super::Client {
    ...
    ///   - [`job_ids(Vec<String>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::job_ids) / [`set_job_ids(Option<Vec<String>>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::set_job_ids): <p>The identification numbers of the export jobs to return.</p>  <p>An export job ID is returned when you create an export using the <code>ExportAutoScalingGroupRecommendations</code> or <code>ExportEC2InstanceRecommendations</code> actions.</p>  <p>All export jobs created in the last seven days are returned if this parameter is omitted.</p>
    ///   - [`filters(Vec<JobFilter>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::filters) / [`set_filters(Option<Vec<JobFilter>>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::set_filters): <p>An array of objects to specify a filter that returns a more specific list of export jobs.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::set_next_token): <p>The token to advance to the next page of export jobs.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_recommendation_export_jobs::builders::DescribeRecommendationExportJobsFluentBuilder::set_max_results): <p>The maximum number of export jobs to return with a single request.</p>  <p>To retrieve the remaining results, make another request with the returned <code>nextToken</code> value.</p>
