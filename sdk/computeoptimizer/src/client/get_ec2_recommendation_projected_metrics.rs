...
impl super::Client {
    ...
    ///   - [`instance_arn(impl ::std::convert::Into<String>)`](crate::operation::get_ec2_recommendation_projected_metrics::builders::GetEC2RecommendationProjectedMetricsFluentBuilder::instance_arn) / [`set_instance_arn(Option<String>)`](crate::operation::get_ec2_recommendation_projected_metrics::builders::GetEC2RecommendationProjectedMetricsFluentBuilder::set_instance_arn): <p>The Amazon Resource Name (ARN) of the instances for which to return recommendation projected metrics.</p>
