...
impl super::Client  {
    ...
    pub fn get_ec2_recommendation_projected_metrics(&self) -> crate::client::fluent_builders::GetEC2RecommendationProjectedMetrics {
                                crate::client::fluent_builders::GetEC2RecommendationProjectedMetrics::new(self.handle.clone())
                            }
}
