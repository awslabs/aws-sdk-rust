...
impl ExportAutoScalingGroupRecommendations {
    ...
    pub fn set_fields_to_export(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::ExportableAutoScalingGroupField>>,
    ) -> Self {
...
impl ExportLambdaFunctionRecommendations {
    ...
    pub fn set_filters(
        mut self,
        input: std::option::Option<std::vec::Vec<crate::model::LambdaFunctionRecommendationFilter>>,
    ) -> Self {
        self.inner = self.inner.set_filters(input);
        self
    }
