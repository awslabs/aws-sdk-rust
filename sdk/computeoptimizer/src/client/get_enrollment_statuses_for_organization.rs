...
impl super::Client  {
    ...
    pub fn get_enrollment_statuses_for_organization(&self) -> crate::client::fluent_builders::GetEnrollmentStatusesForOrganization {
                                crate::client::fluent_builders::GetEnrollmentStatusesForOrganization::new(self.handle.clone())
                            }
}
