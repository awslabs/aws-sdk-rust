...
impl GetEffectiveRecommendationPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_effective_recommendation_preferences::GetEffectiveRecommendationPreferencesInput, ::aws_smithy_types::error::operation::BuildError> {
