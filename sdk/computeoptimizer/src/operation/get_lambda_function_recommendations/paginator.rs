        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_lambda_function_recommendations::GetLambdaFunctionRecommendations::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl GetLambdaFunctionRecommendationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_lambda_function_recommendations_output_output_lambda_function_recommendations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
