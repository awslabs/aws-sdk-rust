...
impl ExportEc2InstanceRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_ec2_instance_recommendations::ExportEC2InstanceRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportEC2InstanceRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_ec2_instance_recommendations::de_export_ec2_instance_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
