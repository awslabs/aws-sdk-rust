...
impl GetRecommendationSummariesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_recommendation_summaries::GetRecommendationSummariesInput, ::aws_smithy_types::error::operation::BuildError> {
