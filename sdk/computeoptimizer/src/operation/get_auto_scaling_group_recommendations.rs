...
impl GetAutoScalingGroupRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_auto_scaling_group_recommendations::GetAutoScalingGroupRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAutoScalingGroupRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_auto_scaling_group_recommendations::de_get_auto_scaling_group_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
