...
impl GetEc2InstanceRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_ec2_instance_recommendations::GetEC2InstanceRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEC2InstanceRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ec2_instance_recommendations::de_get_ec2_instance_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
