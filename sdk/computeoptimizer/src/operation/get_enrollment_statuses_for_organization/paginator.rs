...
impl GetEnrollmentStatusesForOrganizationPaginator {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_enrollment_statuses_for_organization::GetEnrollmentStatusesForOrganization::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_enrollment_statuses_for_organization::GetEnrollmentStatusesForOrganization::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl GetEnrollmentStatusesForOrganizationPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_enrollment_statuses_for_organization_output_output_account_enrollment_statuses(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
