...
impl crate::operation::get_enrollment_statuses_for_organization::builders::GetEnrollmentStatusesForOrganizationInputBuilder {
...
impl GetEnrollmentStatusesForOrganizationFluentBuilder {
    /// Creates a new `GetEnrollmentStatusesForOrganizationFluentBuilder`.
