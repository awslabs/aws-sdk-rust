...
impl ExportEcsServiceRecommendationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::export_ecs_service_recommendations::ExportECSServiceRecommendations,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_ecs_service_recommendations::ExportECSServiceRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportECSServiceRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_ecs_service_recommendations::de_export_ecs_service_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
