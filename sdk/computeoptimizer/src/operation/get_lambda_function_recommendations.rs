...
impl GetLambdaFunctionRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_lambda_function_recommendations::GetLambdaFunctionRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLambdaFunctionRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lambda_function_recommendations::de_get_lambda_function_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
