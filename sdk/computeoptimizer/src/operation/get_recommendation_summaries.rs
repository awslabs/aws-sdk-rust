...
impl GetRecommendationSummariesInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_recommendation_summaries::GetRecommendationSummaries::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRecommendationSummaries {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_recommendation_summaries::de_get_recommendation_summaries_http_response_with_props(status, headers, body)
        }
    }
}
