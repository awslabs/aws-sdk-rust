...
impl DescribeRecommendationExportJobsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_recommendation_export_jobs::DescribeRecommendationExportJobs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRecommendationExportJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_recommendation_export_jobs::de_describe_recommendation_export_jobs_http_response_with_props(
                status, headers, body,
            )
        }
    }
