...
impl GetEcsServiceRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_ecs_service_recommendations::GetECSServiceRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetECSServiceRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ecs_service_recommendations::de_get_ecs_service_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
