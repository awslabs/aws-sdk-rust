...
impl GetRecommendationPreferencesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.get_recommendation_preferences();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_recommendation_preferences::GetRecommendationPreferencesOutput,
                    crate::operation::get_recommendation_preferences::GetRecommendationPreferencesError,
                > for GetRecommendationPreferencesFluentBuilder
            {
                fn send(
                    self,
...
impl GetRecommendationPreferencesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_recommendation_preferences::GetRecommendationPreferencesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_recommendation_preferences::GetRecommendationPreferencesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_recommendation_preferences::GetRecommendationPreferences::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_recommendation_preferences::GetRecommendationPreferences::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_recommendation_preferences::GetRecommendationPreferencesOutput, crate::operation::get_recommendation_preferences::GetRecommendationPreferencesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::get_recommendation_preferences::paginator::GetRecommendationPreferencesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
