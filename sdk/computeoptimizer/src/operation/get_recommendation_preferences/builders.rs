...
impl crate::operation::get_recommendation_preferences::builders::GetRecommendationPreferencesInputBuilder {
...
/// <p>Use the <code>scope</code> parameter to specify which preferences to return. You can specify to return preferences for an organization, a specific account ID, or a specific EC2 instance or Amazon EC2 Auto Scaling group Amazon Resource Name (ARN).</p>
...
impl GetRecommendationPreferencesFluentBuilder {
    /// Creates a new `GetRecommendationPreferencesFluentBuilder`.
