        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_recommendation_preferences::GetRecommendationPreferences::orchestrate(
                            &runtime_plugins,
                            input.clone(),
                        )
                        .await;
...
impl GetRecommendationPreferencesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_recommendation_preferences_output_output_recommendation_preferences_details(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
