...
impl GetEcsServiceRecommendationProjectedMetricsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ecs_service_recommendation_projected_metrics::GetEcsServiceRecommendationProjectedMetricsInput, ::aws_smithy_types::error::operation::BuildError> {
