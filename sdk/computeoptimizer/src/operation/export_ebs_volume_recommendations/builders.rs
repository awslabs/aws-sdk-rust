...
pub use crate::operation::export_ebs_volume_recommendations::_export_ebs_volume_recommendations_output::ExportEbsVolumeRecommendationsOutputBuilder;

pub use crate::operation::export_ebs_volume_recommendations::_export_ebs_volume_recommendations_input::ExportEbsVolumeRecommendationsInputBuilder;
...
impl ExportEbsVolumeRecommendationsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.export_ebs_volume_recommendations();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::export_ebs_volume_recommendations::ExportEbsVolumeRecommendationsOutput,
                    crate::operation::export_ebs_volume_recommendations::ExportEBSVolumeRecommendationsError,
                > for ExportEBSVolumeRecommendationsFluentBuilder
            {
                fn send(
                    self,
...
impl ExportEBSVolumeRecommendationsFluentBuilder {
    ...
    /// Access the ExportEBSVolumeRecommendations as a reference.
    pub fn as_input(&self) -> &crate::operation::export_ebs_volume_recommendations::builders::ExportEbsVolumeRecommendationsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::export_ebs_volume_recommendations::ExportEbsVolumeRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::export_ebs_volume_recommendations::ExportEBSVolumeRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::export_ebs_volume_recommendations::ExportEBSVolumeRecommendations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::export_ebs_volume_recommendations::ExportEBSVolumeRecommendations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::export_ebs_volume_recommendations::ExportEbsVolumeRecommendationsOutput, crate::operation::export_ebs_volume_recommendations::ExportEBSVolumeRecommendationsError, Self> {
