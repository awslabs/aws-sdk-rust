...
impl ExportEbsVolumeRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_ebs_volume_recommendations::ExportEbsVolumeRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
