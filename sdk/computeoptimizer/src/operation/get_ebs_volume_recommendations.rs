...
impl GetEbsVolumeRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_ebs_volume_recommendations::GetEBSVolumeRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEBSVolumeRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_ebs_volume_recommendations::de_get_ebs_volume_recommendations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetEBSVolumeRecommendationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_ebs_volume_recommendations::GetEBSVolumeRecommendationsError
{
