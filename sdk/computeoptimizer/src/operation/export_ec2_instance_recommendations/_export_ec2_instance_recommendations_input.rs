...
pub struct ExportEc2InstanceRecommendationsInput {
    ...
    pub fields_to_export:
        ::std::option::Option<::std::vec::Vec<crate::types::ExportableInstanceField>>,
...
impl ExportEc2InstanceRecommendationsInput {
    ...
    pub fn fields_to_export(
        &self,
    ) -> ::std::option::Option<&[crate::types::ExportableInstanceField]> {
...
impl ExportEc2InstanceRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsInput, ::aws_smithy_http::operation::error::BuildError>{
