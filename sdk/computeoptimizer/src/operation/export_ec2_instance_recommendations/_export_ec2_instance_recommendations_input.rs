...
impl ExportEc2InstanceRecommendationsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::export_ec2_instance_recommendations::ExportEc2InstanceRecommendationsInput, aws_smithy_http::operation::error::BuildError>{
        Ok(
