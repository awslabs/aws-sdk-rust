...
impl GetAutoScalingGroupRecommendationsFluentBuilder {
    ...
    ///
    /// <p>The ID of the Amazon Web Services account for which to return Amazon EC2 Auto Scaling group recommendations.</p>
    /// <p>If your account is the management account of an organization, use this parameter to specify the member account for which you want to return Amazon EC2 Auto Scaling group recommendations.</p>
    ...
    ///
    /// <p>The Amazon Resource Name (ARN) of the Amazon EC2 Auto Scaling groups for which to return recommendations.</p>
    ...
    /// <p>The token to advance to the next page of Amazon EC2 Auto Scaling group recommendations.</p>
    ...
    /// <p>The maximum number of Amazon EC2 Auto Scaling group recommendations to return with a single request.</p>
    ...
    /// <p>An object to specify the preferences for the Amazon EC2 Auto Scaling group recommendations to return in the response.</p>
