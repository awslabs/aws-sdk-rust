...
impl GetECSServiceRecommendationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_ecs_service_recommendations::GetEcsServiceRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_ecs_service_recommendations::GetECSServiceRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_ecs_service_recommendations::GetEcsServiceRecommendationsOutput, crate::operation::get_ecs_service_recommendations::GetECSServiceRecommendationsError, Self> {
