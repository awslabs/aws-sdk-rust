...
impl ExportLambdaFunctionRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_lambda_function_recommendations::ExportLambdaFunctionRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
