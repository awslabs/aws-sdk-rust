...
impl ExportLambdaFunctionRecommendationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_lambda_function_recommendations::ExportLambdaFunctionRecommendations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportLambdaFunctionRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_lambda_function_recommendations::de_export_lambda_function_recommendations_http_response_with_props(
                status, headers, body,
            )
        }
    }
