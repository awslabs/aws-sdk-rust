...
pub fn serialize_structure_export_auto_scaling_group_recommendations_input(
    ...
    if let Some(var_23) = &input.recommendation_preferences {
        ...
        crate::json_ser::serialize_structure_recommendation_preferences(&mut object_24, var_23);
        object_24.finish();
    }
}
...
pub fn serialize_structure_export_ebs_volume_recommendations_input(
        ...
        for item_30 in var_28 {
            {
                ...
                crate::json_ser::serialize_structure_ebs_filter(&mut object_31, item_30);
                object_31.finish();
            }
        }
        array_29.finish();
    ...
    if let Some(var_35) = &input.s3_destination_config {
        ...
        crate::json_ser::serialize_structure_s3_destination_config(&mut object_36, var_35);
        object_36.finish();
    }
...
pub fn serialize_structure_export_ec2_instance_recommendations_input(
        ...
        for item_43 in var_41 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_44, item_43);
                object_44.finish();
            }
        }
        array_42.finish();
    ...
    if let Some(var_48) = &input.s3_destination_config {
        ...
        crate::json_ser::serialize_structure_s3_destination_config(&mut object_49, var_48);
        object_49.finish();
    }
    ...
    if let Some(var_51) = &input.recommendation_preferences {
        ...
        crate::json_ser::serialize_structure_recommendation_preferences(&mut object_52, var_51);
        object_52.finish();
    }
}
...
pub fn serialize_structure_export_lambda_function_recommendations_input(
    ...
    if let Some(var_63) = &input.s3_destination_config {
        ...
        crate::json_ser::serialize_structure_s3_destination_config(&mut object_64, var_63);
        object_64.finish();
    }
...
pub fn serialize_structure_get_auto_scaling_group_recommendations_input(
        ...
        for item_76 in var_74 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_77, item_76);
                object_77.finish();
            }
        }
        array_75.finish();
    ...
    if let Some(var_78) = &input.recommendation_preferences {
        ...
        crate::json_ser::serialize_structure_recommendation_preferences(&mut object_79, var_78);
        object_79.finish();
    }
}
        ...
        for item_87 in var_85 {
            {
                ...
                crate::json_ser::serialize_structure_ebs_filter(&mut object_88, item_87);
                object_88.finish();
            }
        }
        array_86.finish();
...
pub fn serialize_structure_get_ec2_instance_recommendations_input(
        ...
        for item_99 in var_97 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_100, item_99);
                object_100.finish();
            }
        }
        array_98.finish();
    ...
    if let Some(var_104) = &input.recommendation_preferences {
        ...
        crate::json_ser::serialize_structure_recommendation_preferences(&mut object_105, var_104);
        object_105.finish();
    }
}
...
pub fn serialize_structure_get_ec2_recommendation_projected_metrics_input(
    ...
    if let Some(var_109) = &input.end_time {
        object
            .key("endTime")
            .instant(var_109, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_110) = &input.recommendation_preferences {
        let mut object_111 = object.key("recommendationPreferences").start_object();
        crate::json_ser::serialize_structure_recommendation_preferences(&mut object_111, var_110);
        object_111.finish();
    }
}

pub fn serialize_structure_get_enrollment_statuses_for_organization_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_114 in var_112 {
            {
                ...
                crate::json_ser::serialize_structure_enrollment_filter(&mut object_115, item_114);
                object_115.finish();
            }
        }
        array_113.finish();
...
pub fn serialize_structure_recommendation_preferences(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_enrollment_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
