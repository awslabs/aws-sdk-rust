...
pub struct AutoScalingGroupRecommendationOption {
    ...
    /// <p>Describes the GPU accelerator settings for the recommended instance type of the Amazon EC2 Auto Scaling group.</p>
    pub instance_gpu_info: ::std::option::Option<crate::types::GpuInfo>,
    /// <p>An array of objects that describe the projected utilization metrics of the Amazon EC2 Auto Scaling group recommendation option.</p><note>
    ...
    /// <p>The performance risk of the Amazon EC2 Auto Scaling group configuration recommendation.</p>
    ...
    pub rank: i32,
    /// <p>An object that describes the savings opportunity for the Amazon EC2 Auto Scaling group recommendation option. Savings opportunity includes the estimated monthly savings amount and percentage.</p>
    pub savings_opportunity: ::std::option::Option<crate::types::SavingsOpportunity>,
    /// <p>An object that describes the savings opportunity for the Amazon EC2 Auto Scaling group recommendation option that includes Savings Plans and Reserved Instances discounts. Savings opportunity includes the estimated monthly savings and percentage.</p>
