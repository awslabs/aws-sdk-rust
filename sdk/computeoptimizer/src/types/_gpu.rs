...
pub struct Gpu {
    ...
    pub gpu_memory_size_in_mi_b: i32,
}
impl Gpu {
    /// <p> The number of GPUs for the instance type. </p>
    ...
    /// <p> The total size of the memory for the GPU accelerators for the instance type, in MiB. </p>
    pub fn gpu_memory_size_in_mi_b(&self) -> i32 {
        self.gpu_memory_size_in_mi_b
    }
}
impl Gpu {
...
pub struct GpuBuilder {
    ...
    pub(crate) gpu_memory_size_in_mi_b: ::std::option::Option<i32>,
}
impl GpuBuilder {
    /// <p> The number of GPUs for the instance type. </p>
    ...
    /// <p> The total size of the memory for the GPU accelerators for the instance type, in MiB. </p>
    pub fn gpu_memory_size_in_mi_b(mut self, input: i32) -> Self {
        self.gpu_memory_size_in_mi_b = ::std::option::Option::Some(input);
        self
    }
    /// <p> The total size of the memory for the GPU accelerators for the instance type, in MiB. </p>
    pub fn set_gpu_memory_size_in_mi_b(mut self, input: ::std::option::Option<i32>) -> Self {
        self.gpu_memory_size_in_mi_b = input;
        self
    }
    /// <p> The total size of the memory for the GPU accelerators for the instance type, in MiB. </p>
    pub fn get_gpu_memory_size_in_mi_b(&self) -> &::std::option::Option<i32> {
        &self.gpu_memory_size_in_mi_b
    }
    ...
    pub fn build(self) -> crate::types::Gpu {
        crate::types::Gpu {
            ...
            gpu_memory_size_in_mi_b: self.gpu_memory_size_in_mi_b.unwrap_or_default(),
        }
    }
}
