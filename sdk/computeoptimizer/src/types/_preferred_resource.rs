...
/// <ul>
/// <li> <p>This preference is only available for the Amazon EC2 instance and Auto Scaling group resource types.</p> </li>
/// <li> <p>Compute Optimizer only supports the customization of <code>Ec2InstanceTypes</code>.</p> </li>
/// </ul>
/// </note>
#[non_exhaustive]
