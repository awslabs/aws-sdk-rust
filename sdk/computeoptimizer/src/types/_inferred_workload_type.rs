...
other => InferredWorkloadType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
...
impl InferredWorkloadType {
    ...
    InferredWorkloadType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AmazonEmr", "ApacheCassandra", "ApacheHadoop", "Kafka", "Memcached", "Nginx", "PostgreSql", "Redis"]
                }
            }
