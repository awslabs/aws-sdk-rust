...
pub struct AutoScalingGroupRecommendation {
    ...
    /// <ul>
    /// <li>
    /// <p><b> <code>NotOptimized</code> </b>—An Amazon EC2 Auto Scaling group is considered not optimized when Compute Optimizer identifies a recommendation that can provide better performance for your workload.</p></li>
    /// <li>
    /// <p><b> <code>Optimized</code> </b>—An Amazon EC2 Auto Scaling group is considered optimized when Compute Optimizer determines that the group is correctly provisioned to run your workload based on the chosen instance type. For optimized resources, Compute Optimizer might recommend a new generation instance type.</p></li>
    /// </ul>
    pub finding: ::std::option::Option<crate::types::Finding>,
    /// <p>An array of objects that describe the utilization metrics of the Amazon EC2 Auto Scaling group.</p>
    ...
    /// <p>An array of objects that describe the current configuration of the Amazon EC2 Auto Scaling group.</p>
    pub current_configuration: ::std::option::Option<crate::types::AutoScalingGroupConfiguration>,
    /// <p>Describes the GPU accelerator settings for the current instance type of the Amazon EC2 Auto Scaling group.</p>
    pub current_instance_gpu_info: ::std::option::Option<crate::types::GpuInfo>,
    /// <p>An array of objects that describe the recommendation options for the Amazon EC2 Auto Scaling group.</p>
    pub recommendation_options: ::std::option::Option<::std::vec::Vec<crate::types::AutoScalingGroupRecommendationOption>>,
    /// <p>The timestamp of when the Amazon EC2 Auto Scaling group recommendation was last generated.</p>
    pub last_refresh_timestamp: ::std::option::Option<::aws_smithy_types::DateTime>,
    /// <p>The risk of the current Amazon EC2 Auto Scaling group not meeting the performance needs of its workloads. The higher the risk, the more likely the current Amazon EC2 Auto Scaling group configuration has insufficient capacity and cannot meet workload requirements.</p>
    ...
    /// <p>The applications that might be running on the instances in the Amazon EC2 Auto Scaling group as inferred by Compute Optimizer.</p>
