...
impl ::std::convert::From<&str> for EcsServiceMetricStatistic {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => EcsServiceMetricStatistic::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for EcsServiceMetricStatistic {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(EcsServiceMetricStatistic::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for EcsServiceMetricStatistic {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
