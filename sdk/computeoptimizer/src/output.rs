...
pub struct GetEnrollmentStatusesForOrganizationOutput  {
    ...
    #[doc(hidden)]
    pub account_enrollment_statuses: std::option::Option<std::vec::Vec<crate::model::AccountEnrollmentStatus>>,
...
pub struct GetEcsServiceRecommendationsOutput  {
    ...
    #[doc(hidden)]
    pub ecs_service_recommendations: std::option::Option<std::vec::Vec<crate::model::EcsServiceRecommendation>>,
...
impl GetEcsServiceRecommendationsOutput {
    ...
    /// <p> An array of objects that describe the ECS service recommendations. </p>
    pub fn ecs_service_recommendations(&self) -> std::option::Option<& [crate::model::EcsServiceRecommendation]> {
...
pub mod get_ecs_service_recommendations_output {
    ...
    impl Builder {
        ...
        ///
        /// <p> An array of objects that describe the ECS service recommendations. </p>
        pub fn ecs_service_recommendations(mut self, input: crate::model::EcsServiceRecommendation) -> Self {
        ...
        /// <p> An array of objects that describe the ECS service recommendations. </p>
        pub fn set_ecs_service_recommendations(mut self, input: std::option::Option<std::vec::Vec<crate::model::EcsServiceRecommendation>>) -> Self {
...
impl GetEcsServiceRecommendationProjectedMetricsOutput {
    /// <p> An array of objects that describes the projected metrics. </p>
    pub fn recommended_option_projected_metrics(&self) -> std::option::Option<& [crate::model::EcsServiceRecommendedOptionProjectedMetric]> {
...
pub mod get_ecs_service_recommendation_projected_metrics_output {
    ...
    impl Builder {
        ...
        ///
        /// <p> An array of objects that describes the projected metrics. </p>
        pub fn recommended_option_projected_metrics(mut self, input: crate::model::EcsServiceRecommendedOptionProjectedMetric) -> Self {
...
impl GetEcsServiceRecommendationProjectedMetricsOutput {
    ...
    pub fn builder() -> crate::output::get_ecs_service_recommendation_projected_metrics_output::Builder {
...
pub struct GetEc2InstanceRecommendationsOutput  {
    ...
    #[doc(hidden)]
    pub instance_recommendations: std::option::Option<std::vec::Vec<crate::model::InstanceRecommendation>>,
    /// <p>An array of objects that describe errors of the request.</p> 
...
pub struct GetEbsVolumeRecommendationsOutput  {
    ...
    #[doc(hidden)]
    pub volume_recommendations: std::option::Option<std::vec::Vec<crate::model::VolumeRecommendation>>,
    /// <p>An array of objects that describe errors of the request.</p> 
...
pub struct GetAutoScalingGroupRecommendationsOutput  {
    ...
    #[doc(hidden)]
    pub auto_scaling_group_recommendations: std::option::Option<std::vec::Vec<crate::model::AutoScalingGroupRecommendation>>,
    /// <p>An array of objects that describe errors of the request.</p> 
...
pub struct DescribeRecommendationExportJobsOutput  {
    ...
    #[doc(hidden)]
    pub recommendation_export_jobs: std::option::Option<std::vec::Vec<crate::model::RecommendationExportJob>>,
