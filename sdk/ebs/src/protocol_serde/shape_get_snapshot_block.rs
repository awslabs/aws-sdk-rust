...
pub fn de_get_snapshot_block_op_response(
...
> {
    ...
    crate::protocol_serde::shape_get_snapshot_block::de_get_snapshot_block_http_response_with_props(
        response,
        &properties,
    )
}
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_get_snapshot_block_http_response_with_props(
