...
{
    pub fn complete_snapshot(&self) -> fluent_builders::CompleteSnapshot<C> {
        fluent_builders::CompleteSnapshot::new(self.handle.clone())
    }
    pub fn get_snapshot_block(&self) -> fluent_builders::GetSnapshotBlock<C> {
        fluent_builders::GetSnapshotBlock::new(self.handle.clone())
    }
    pub fn list_changed_blocks(&self) -> fluent_builders::ListChangedBlocks<C> {
        fluent_builders::ListChangedBlocks::new(self.handle.clone())
    }
    pub fn list_snapshot_blocks(&self) -> fluent_builders::ListSnapshotBlocks<C> {
        fluent_builders::ListSnapshotBlocks::new(self.handle.clone())
    }
    pub fn put_snapshot_block(&self) -> fluent_builders::PutSnapshotBlock<C> {
        fluent_builders::PutSnapshotBlock::new(self.handle.clone())
    }
    pub fn start_snapshot(&self) -> fluent_builders::StartSnapshot<C> {
        fluent_builders::StartSnapshot::new(self.handle.clone())
    }
}
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct CompleteSnapshot<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::complete_snapshot_input::Builder,
    }
    impl<C> CompleteSnapshot<C> {
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetSnapshotBlock<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_snapshot_block_input::Builder,
    }
    impl<C> GetSnapshotBlock<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn block_token(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.block_token(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListChangedBlocks<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_changed_blocks_input::Builder,
    }
    impl<C> ListChangedBlocks<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn first_snapshot_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.first_snapshot_id(input);
            self
        }
        ...
        pub fn second_snapshot_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.second_snapshot_id(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListSnapshotBlocks<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_snapshot_blocks_input::Builder,
    }
    impl<C> ListSnapshotBlocks<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct PutSnapshotBlock<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::put_snapshot_block_input::Builder,
    }
    impl<C> PutSnapshotBlock<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct StartSnapshot<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::start_snapshot_input::Builder,
    }
    impl<C> StartSnapshot<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub fn parent_snapshot_id(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.parent_snapshot_id(input);
            self
        }
