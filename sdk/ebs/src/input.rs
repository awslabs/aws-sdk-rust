...
pub mod complete_snapshot_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::CompleteSnapshotInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl CompleteSnapshotInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::CompleteSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
...
pub mod get_snapshot_block_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetSnapshotBlockInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetSnapshotBlockInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetSnapshotBlock, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetSnapshotBlockInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let input_3 = input_3.as_ref().ok_or(aws_smithy_http::operation::BuildError::MissingField { field: "block_index", details: "cannot be empty or unset" })?;
                ...
                if block_index.is_empty() {
                                return Err(aws_smithy_http::operation::BuildError::MissingField { field: "block_index", details: "cannot be empty or unset" })
                            }
            ...
            fn uri_query(_input: &crate::input::GetSnapshotBlockInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
pub mod list_changed_blocks_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListChangedBlocksInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListChangedBlocksInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListChangedBlocks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListChangedBlocksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod list_snapshot_blocks_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::ListSnapshotBlocksInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListSnapshotBlocksInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListSnapshotBlocks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::ListSnapshotBlocksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
...
pub mod put_snapshot_block_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::PutSnapshotBlockInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl PutSnapshotBlockInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::PutSnapshotBlock, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::PutSnapshotBlockInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
                ...
                let input_15 = input_15.as_ref().ok_or(aws_smithy_http::operation::BuildError::MissingField { field: "block_index", details: "cannot be empty or unset" })?;
...
pub mod start_snapshot_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::StartSnapshotInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartSnapshotInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        if self.client_token.is_none() {
                                self.client_token = Some(_config.make_token.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::input::StartSnapshotInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
...
#[non_exhaustive]pub struct PutSnapshotBlockInput  {
    ...
    /// <p>The progress of the write process, as a percentage.</p>
    #[doc(hidden)]pub progress: std::option::Option<i32>,
    /// <p>A Base64-encoded SHA256 checksum of the data. Only SHA256 checksums are supported.</p>
...
pub struct ListSnapshotBlocksInput  {
    ...
    /// <p>The block index from which the list should start. The list in the response will start from this block index or the next valid block index in the snapshot.</p> 
    /// <p>If you specify <b>NextToken</b>, then <b>StartingBlockIndex</b> is ignored.</p>
    #[doc(hidden)]pub starting_block_index: std::option::Option<i32>,
}
impl ListSnapshotBlocksInput {
    /// <p>The ID of the snapshot from which to get block indexes and block tokens.</p>
    pub fn snapshot_id(&self) -> std::option::Option<& str> {
...
pub struct ListChangedBlocksInput  {
    ...
    /// <p>The <code>FirstSnapshotID</code> parameter must be specified with a <code>SecondSnapshotId</code> parameter; otherwise, an error occurs.</p> 
    /// </important>
    #[doc(hidden)]pub first_snapshot_id: std::option::Option<std::string::String>,
    /// <p>The ID of the second snapshot to use for the comparison.</p> <important> 
    /// <p>The <code>SecondSnapshotId</code> parameter must be specified with a <code>FirstSnapshotID</code> parameter; otherwise, an error occurs.</p> 
    /// </important>
    #[doc(hidden)]pub second_snapshot_id: std::option::Option<std::string::String>,
    /// <p>The token to request the next page of results.</p> 
    /// <p>If you specify <b>NextToken</b>, then <b>StartingBlockIndex</b> is ignored.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>The maximum number of blocks to be returned by the request.</p> 
...
pub struct CompleteSnapshotInput  {
    ...
    #[doc(hidden)]pub snapshot_id: std::option::Option<std::string::String>,
    /// <p>The number of blocks that were written to the snapshot.</p>
    #[doc(hidden)]pub changed_blocks_count: std::option::Option<i32>,
    /// <p>An aggregated Base-64 SHA256 checksum based on the checksums of each written block.</p> 
    /// <p>To generate the aggregated checksum using the linear aggregation method, arrange the checksums for each written block in ascending order of their block index, concatenate them to form a single string, and then generate the checksum on the entire string using the SHA256 algorithm.</p>
    #[doc(hidden)]pub checksum: std::option::Option<std::string::String>,
    /// <p>The algorithm used to generate the checksum. Currently, the only supported algorithm is <code>SHA256</code>.</p>
    #[doc(hidden)]pub checksum_algorithm: std::option::Option<crate::model::ChecksumAlgorithm>,
    /// <p>The aggregation method used to generate the checksum. Currently, the only supported aggregation method is <code>LINEAR</code>.</p>
    #[doc(hidden)]pub checksum_aggregation_method: std::option::Option<crate::model::ChecksumAggregationMethod>,
}
impl CompleteSnapshotInput {
    /// <p>The ID of the snapshot.</p>
    pub fn snapshot_id(&self) -> std::option::Option<& str> {
...
impl  std::fmt::Debug for CompleteSnapshotInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("checksum", &self.checksum);
        formatter.field("checksum_algorithm", &self.checksum_algorithm);
        formatter.field("checksum_aggregation_method", &self.checksum_aggregation_method);
        formatter.finish()
    }
}
