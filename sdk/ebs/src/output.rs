...
pub struct StartSnapshotOutput  {
    ...
    #[doc(hidden)]pub volume_size: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub parent_snapshot_id: std::option::Option<std::string::String>,
...
pub struct ListChangedBlocksOutput  {
    ...
    #[doc(hidden)]pub changed_blocks: std::option::Option<std::vec::Vec<crate::model::ChangedBlock>>,
    /// <p>The time when the <code>BlockToken</code> expires.</p>
    #[doc(hidden)]pub expiry_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The size of the volume in GB.</p>
    #[doc(hidden)]pub volume_size: std::option::Option<i64>,
...
#[non_exhaustive]pub struct GetSnapshotBlockOutput  {
    ...
    #[doc(hidden)]pub data_length: std::option::Option<i32>,
