...
impl super::Client {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::get_snapshot_block::builders::GetSnapshotBlockFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::get_snapshot_block::builders::GetSnapshotBlockFluentBuilder::set_snapshot_id): <p>The ID of the snapshot containing the block from which to get data.</p> <important>   <p>If the specified snapshot is encrypted, you must have permission to use the KMS key that was used to encrypt the snapshot. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebsapis-using-encryption.html"> Using encryption</a> in the <i>Amazon Elastic Compute Cloud User Guide</i>.</p>  </important>
    ...
    ///   - [`block_token(impl ::std::convert::Into<String>)`](crate::operation::get_snapshot_block::builders::GetSnapshotBlockFluentBuilder::block_token) / [`set_block_token(Option<String>)`](crate::operation::get_snapshot_block::builders::GetSnapshotBlockFluentBuilder::set_block_token): <p>The block token of the block from which to get data. You can obtain the <code>BlockToken</code> by running the <code>ListChangedBlocks</code> or <code>ListSnapshotBlocks</code> operations.</p>
