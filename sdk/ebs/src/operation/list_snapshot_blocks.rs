...
impl ListSnapshotBlocksInput {
    /// Consumes the builder and constructs an Operation<[`ListSnapshotBlocks`](crate::operation::list_snapshot_blocks::ListSnapshotBlocks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_snapshot_blocks::ListSnapshotBlocks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_snapshot_blocks::ListSnapshotBlocksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/snapshots/{SnapshotId}/blocks", SnapshotId = snapshot_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_snapshot_blocks::ListSnapshotBlocksInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_4) = &_input.starting_block_index {
                    if *inner_4 != 0 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_snapshot_blocks::ListSnapshotBlocks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSnapshotBlocks", "ebs"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListSnapshotBlocks {
                type Output = std::result::Result<crate::operation::list_snapshot_blocks::ListSnapshotBlocksOutput, crate::operation::list_snapshot_blocks::ListSnapshotBlocksError>;
