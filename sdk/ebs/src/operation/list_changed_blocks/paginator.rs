...
/// Paginator for [`ListChangedBlocks`](crate::operation::list_changed_blocks::ListChangedBlocks)
            ...
            impl ListChangedBlocksPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_changed_blocks::ListChangedBlocksOutput, aws_smithy_http::result::SdkError<crate::operation::list_changed_blocks::ListChangedBlocksError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_changed_blocks_output_next_token(resp);
