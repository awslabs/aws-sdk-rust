...
impl ::aws_smithy_http::response::ParseHttpResponse for GetSnapshotBlock {
    ...
    fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
        ...
        ::std::option::Option::Some(crate::protocol_serde::shape_get_snapshot_block::de_get_snapshot_block_op_response(
            response,
        ))
    }
...
mod get_snapshot_block_request_test {
    ...
    async fn lowercase_message_response() {
        ...
        let parsed = parsed.unwrap_or_else(|| {
            ...
            <crate::operation::get_snapshot_block::GetSnapshotBlock as ::aws_smithy_http::response::ParseHttpResponse>::parse_loaded(
                &parser,
                &http_response,
            )
        });
