...
/// Paginator for [`ListSnapshotBlocks`](crate::operation::list_snapshot_blocks::ListSnapshotBlocks)
            ...
            impl ListSnapshotBlocksPaginator  {
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::operation::list_snapshot_blocks::ListSnapshotBlocksOutput, aws_smithy_http::result::SdkError<crate::operation::list_snapshot_blocks::ListSnapshotBlocksError>>> + Unpin
                 {
