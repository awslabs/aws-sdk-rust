...
impl ListSnapshotBlocksFluentBuilder  {
    /// Creates a new `ListSnapshotBlocks`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_snapshot_blocks::ListSnapshotBlocks, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_snapshot_blocks::ListSnapshotBlocksError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_snapshot_blocks::ListSnapshotBlocksOutput, aws_smithy_http::result::SdkError<crate::operation::list_snapshot_blocks::ListSnapshotBlocksError>>
                     {
