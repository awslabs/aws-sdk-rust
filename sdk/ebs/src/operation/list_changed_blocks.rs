...
impl ListChangedBlocks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_changed_blocks::ListChangedBlocksError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_changed_blocks::ListChangedBlocksOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EBS", "ListChangedBlocks", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EBS.ListChangedBlocks",
                "rpc.service" = "EBS",
                "rpc.method" = "ListChangedBlocks",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListChangedBlocks")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListChangedBlocks")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListChangedBlocksTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListChangedBlocksTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChangedBlocksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListChangedBlocksInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("FirstSnapshotId") {
            if let ::std::option::Option::Some(value) = input.first_snapshot_id.as_deref() {
                captured.insert("FirstSnapshotId", value);
            }
        }
        if requested.should_capture("SecondSnapshotId") {
            if let ::std::option::Option::Some(value) = input.second_snapshot_id.as_deref() {
                captured.insert("SecondSnapshotId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChangedBlocksResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_changed_blocks::de_list_changed_blocks_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_changed_blocks::de_list_changed_blocks_http_response(status, headers, body, _cfg)
        };
...
mod list_changed_blocks_test {
    ...
    async fn lowercase_message_response() {
        ...
        let parsed: &crate::operation::list_changed_blocks::ListChangedBlocksError =
