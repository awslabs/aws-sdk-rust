...
impl StartSnapshotInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::start_snapshot::StartSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_snapshot::ser_start_snapshot_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_start_snapshot::de_start_snapshot_http_response_with_props(status, headers, body)
        }
    }
