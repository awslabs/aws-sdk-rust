...
impl StartSnapshot {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::start_snapshot::StartSnapshotError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::start_snapshot::StartSnapshotOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("EBS", "StartSnapshot", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "EBS.StartSnapshot",
                "rpc.service" = "EBS",
                "rpc.method" = "StartSnapshot",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartSnapshot")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                StartSnapshotTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct StartSnapshotTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartSnapshotTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<StartSnapshotInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("ParentSnapshotId") {
            if let ::std::option::Option::Some(value) = input.parent_snapshot_id.as_deref() {
                captured.insert("ParentSnapshotId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartSnapshotResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_start_snapshot::de_start_snapshot_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_start_snapshot::de_start_snapshot_http_response(status, headers, body, _cfg)
        };
...
mod start_snapshot_test {
    ...
    async fn lowercase_message_response() {
        ...
        let parsed: &crate::operation::start_snapshot::StartSnapshotError =
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartSnapshotError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ConcurrentLimitExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
