...
impl PutSnapshotBlockInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_snapshot_block_input::ser_block_data_http_payload(self.block_data)?.into_inner(),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSnapshotBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_put_snapshot_block::de_put_snapshot_block_http_response_with_props(status, headers, body)
        }
    }
}
...
mod put_snapshot_block_request_test {
    ...
    async fn lowercase_message_response() {
        ...
        let parsed = parsed.unwrap_or_else(|| {
            ...
            <crate::operation::put_snapshot_block::PutSnapshotBlock as ::aws_smithy_http::response::ParseHttpResponse>::parse_loaded(
                &parser,
                &http_response,
            )
        });
