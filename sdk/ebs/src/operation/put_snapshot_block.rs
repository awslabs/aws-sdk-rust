...
impl PutSnapshotBlockInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_snapshot_block_input::ser_block_data_http_payload(
                self.block_data,
            )?
            .into_inner(),
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_snapshot_block::PutSnapshotBlock::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSnapshotBlock {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_put_snapshot_block::de_put_snapshot_block_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_snapshot_block::PutSnapshotBlockError
{
