...
/// Auth scheme resolver trait specific to Amazon Elastic Block Store
        ...
        Self {
            ...
            operation_overrides: [(
                ...
                vec![::aws_smithy_runtime_api::client::auth::AuthSchemeOption::builder()
                    .scheme_id(::aws_runtime::auth::sigv4::SCHEME_ID)
                    .properties({
                        let mut layer = ::aws_smithy_types::config_bag::Layer::new("PutSnapshotBlockAuthOptionProperties");
