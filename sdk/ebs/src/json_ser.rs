...
pub fn serialize_structure_crate_input_start_snapshot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartSnapshotInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
