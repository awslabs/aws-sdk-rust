...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod complete_snapshot_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
    ...
    #[tokio::test]async fn uppercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
        .set_message(
            Some(
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod get_snapshot_block_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod list_changed_blocks_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod list_snapshot_blocks_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod put_snapshot_block_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
...
#[cfg(test)]#[allow(unreachable_code, unused_variables)]mod start_snapshot_request_test {
    /// This test case validates case insensitive parsing of `message`
    /// Test ID: LowercaseMessage
    #[tokio::test]async fn lowercase_message_response() {
        let expected_output =crate::error::ValidationException::builder()
