...
//! as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-lambdacore` to
//! your project, add the following to your **Cargo.toml** file:
//!
//! ```toml
//! [dependencies]
//! aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
//! aws-sdk-lambdacore = "1.6.0"
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-lambdacore/latest/aws_sdk_lambdacore/client/struct.Client.html)
...
//! offered by AWS Lambda Core. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Lambda Core.
...
/// let config = aws_sdk_lambdacore::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`CreateNetworkConnector`](crate::operation::create_network_connector) operation has
/// a [`Client::create_network_connector`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `send()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.create_network_connector()
///     .name("example")
///     .send()
///     .await;
/// ```
...
/// Configuration for AWS Lambda Core.
pub mod config;
