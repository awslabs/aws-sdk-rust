...
impl CreateIntegrationResponseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_integration_response::CreateIntegrationResponseInput, ::aws_smithy_types::error::operation::BuildError> {
