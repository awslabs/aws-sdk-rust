...
impl CreateIntegrationResponseFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_integration_response::CreateIntegrationResponseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_integration_response::CreateIntegrationResponseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_integration_response::CreateIntegrationResponseOutput, crate::operation::create_integration_response::CreateIntegrationResponseError, Self> {
