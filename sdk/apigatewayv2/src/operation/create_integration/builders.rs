...
impl CreateIntegrationFluentBuilder  {
    /// Creates a new `CreateIntegration`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::create_integration::CreateIntegration, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::create_integration::CreateIntegrationError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::create_integration::CreateIntegrationOutput, aws_smithy_http::result::SdkError<crate::operation::create_integration::CreateIntegrationError>>
                     {
