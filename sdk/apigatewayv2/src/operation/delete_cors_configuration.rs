...
impl DeleteCorsConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_cors_configuration::DeleteCorsConfiguration,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCorsConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_cors_configuration::de_delete_cors_configuration_http_response_with_props(status, headers, body)
        }
    }
}
