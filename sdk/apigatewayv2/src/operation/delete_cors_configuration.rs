    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v2/apis/{ApiId}/cors", ApiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_cors_configuration::DeleteCorsConfiguration::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_cors_configuration::DeleteCorsConfigurationError
{
