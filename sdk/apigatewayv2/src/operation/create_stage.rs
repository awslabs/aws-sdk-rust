...
impl CreateStageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_stage::CreateStage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_stage::ser_create_stage_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stage::CreateStage::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStage", "apigatewayv2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_stage::de_create_stage_http_response_with_props(status, headers, body)
        }
    }
}
