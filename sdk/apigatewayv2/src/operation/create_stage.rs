...
impl CreateStageInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_stage::CreateStage::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_stage::de_create_stage_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_stage::de_create_stage_http_response_with_props(
                status, headers, body,
            )
        }
    }
