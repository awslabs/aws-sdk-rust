    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v2/apis/{ApiId}/models", ApiId = api_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_models::GetModels::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetModels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_models::de_get_models_http_response_with_props(
                status, headers, body,
            )
        }
    }
