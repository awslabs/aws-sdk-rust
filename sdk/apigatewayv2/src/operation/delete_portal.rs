...
impl DeletePortal {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("ApiGatewayV2", "DeletePortal", input, runtime_plugins, stop_point)
...
impl DeletePortalError {
    ...
    /// Returns `true` if the error kind is `DeletePortalError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeletePortalError::TooManyRequestsException`.
