...
impl DeleteRouteRequestParameterInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_route_request_parameter::DeleteRouteRequestParameter::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRouteRequestParameter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_route_request_parameter::de_delete_route_request_parameter_http_response_with_props(
                status, headers, body,
            )
        }
    }
