    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let request_parameter_key = ::aws_smithy_http::label::fmt_string(
                    input_3,
                    ::aws_smithy_http::label::EncodingStrategy::Default,
                );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRouteRequestParameter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_route_request_parameter::de_delete_route_request_parameter_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteRouteRequestParameterError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_route_request_parameter::DeleteRouteRequestParameterError
{
