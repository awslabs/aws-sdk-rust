...
impl UpdateStageInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_stage::UpdateStage, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_stage::ser_update_stage_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_stage::de_update_stage_http_response_with_props(status, headers, body)
        }
    }
}
