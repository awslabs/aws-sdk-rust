    ...
    > {
        ...
        let mut request = {
            ...
            ) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError>
            {
                ...
                let specification = aws_smithy_http::label::fmt_string(
                    input_2,
                    aws_smithy_http::label::EncodingStrategy::Default,
                );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::export_api::ExportApi::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ExportApi {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_export_api::de_export_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
