...
impl UpdateVpcLinkFluentBuilder  {
    /// Creates a new `UpdateVpcLink`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_vpc_link::UpdateVpcLinkOutput, aws_smithy_http::result::SdkError<crate::operation::update_vpc_link::UpdateVpcLinkError>>
                     {
