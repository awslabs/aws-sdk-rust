...
impl DeleteApiFluentBuilder  {
    /// Creates a new `DeleteApi`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_api::DeleteApi, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_api::DeleteApiError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_api::DeleteApiOutput, aws_smithy_http::result::SdkError<crate::operation::delete_api::DeleteApiError>>
                     {
