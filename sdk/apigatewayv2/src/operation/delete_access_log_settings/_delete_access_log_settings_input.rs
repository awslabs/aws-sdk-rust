...
impl DeleteAccessLogSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_access_log_settings::DeleteAccessLogSettingsInput, ::aws_smithy_types::error::operation::BuildError> {
