...
impl CreateApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_api::CreateApi,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_api::CreateApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_api::de_create_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
