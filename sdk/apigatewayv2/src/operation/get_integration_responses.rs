...
impl GetIntegrationResponsesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_integration_responses::GetIntegrationResponses,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIntegrationResponses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_integration_responses::de_get_integration_responses_http_response_with_props(status, headers, body)
        }
    }
}
