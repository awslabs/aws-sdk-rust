...
impl CreateVpcLinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_vpc_link::CreateVpcLink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_vpc_link::ser_create_vpc_link_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcLink {
    type Output =
        ::std::result::Result<crate::operation::create_vpc_link::CreateVpcLinkOutput, crate::operation::create_vpc_link::CreateVpcLinkError>;
