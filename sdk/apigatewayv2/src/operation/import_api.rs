    ...
    > {
        ...
        let mut request = {
            ...
            fn uri_query(
                ...
                if let Some(inner_2) = &_input.fail_on_warnings {
                    if *inner_2 {
                        query.push_kv(
                            "failOnWarnings",
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_api::ImportApi::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ImportApi {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_import_api::de_import_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
