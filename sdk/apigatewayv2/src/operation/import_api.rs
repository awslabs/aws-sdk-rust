...
impl ImportApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::import_api::ImportApi, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_api::ser_import_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_import_api::de_import_api_http_response_with_props(status, headers, body)
        }
    }
}
