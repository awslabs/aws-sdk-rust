...
impl CreateIntegrationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_integration::ser_create_integration_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIntegration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_integration::de_create_integration_http_response_with_props(status, headers, body)
        }
    }
}
