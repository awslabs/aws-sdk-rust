...
impl UpdateApiMappingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_api_mapping::ser_update_api_mapping_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApiMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_api_mapping::de_update_api_mapping_http_response_with_props(status, headers, body)
        }
    }
}
