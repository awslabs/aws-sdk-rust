    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v2/vpclinks/{VpcLinkId}", VpcLinkId = vpc_link_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_vpc_link::DeleteVpcLink::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpcLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            crate::protocol_serde::shape_delete_vpc_link::de_delete_vpc_link_http_error(
                status, headers, body,
            )
        } else {
