...
impl GetDomainNamesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_domain_names::GetDomainNames,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_domain_names::GetDomainNames::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainNames {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_domain_names::de_get_domain_names_http_error(
                status, headers, body,
            )
        } else {
