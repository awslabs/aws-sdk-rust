    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let route_response_id = ::aws_smithy_http::label::fmt_string(
                    input_3,
                    ::aws_smithy_http::label::EncodingStrategy::Default,
                );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_route_response::DeleteRouteResponse::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRouteResponse {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_route_response::de_delete_route_response_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_route_response::DeleteRouteResponseError
{
