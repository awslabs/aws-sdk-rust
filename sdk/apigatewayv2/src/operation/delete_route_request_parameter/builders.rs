...
impl DeleteRouteRequestParameterFluentBuilder  {
    /// Creates a new `DeleteRouteRequestParameter`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_route_request_parameter::DeleteRouteRequestParameter, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_route_request_parameter::DeleteRouteRequestParameterError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_route_request_parameter::DeleteRouteRequestParameterOutput, aws_smithy_http::result::SdkError<crate::operation::delete_route_request_parameter::DeleteRouteRequestParameterError>>
                     {
