...
impl CreateDomainNameInput {
    /// Consumes the builder and constructs an Operation<[`CreateDomainName`](crate::operation::create_domain_name::CreateDomainName)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_domain_name::CreateDomainName, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_domain_name::CreateDomainNameInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_domain_name::ser_create_domain_name_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_domain_name::CreateDomainName::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDomainName", "apigatewayv2"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDomainName {
                type Output = std::result::Result<crate::operation::create_domain_name::CreateDomainNameOutput, crate::operation::create_domain_name::CreateDomainNameError>;
