...
impl CreateDomainNameInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_domain_name::ser_create_domain_name_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDomainName {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_domain_name::de_create_domain_name_http_response_with_props(status, headers, body)
        }
    }
}
