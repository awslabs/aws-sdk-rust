...
impl DeleteApiMappingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_api_mapping::DeleteApiMapping::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApiMapping {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_api_mapping::de_delete_api_mapping_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_api_mapping::DeleteApiMappingError
{
