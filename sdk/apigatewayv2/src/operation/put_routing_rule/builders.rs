...
pub use crate::operation::put_routing_rule::_put_routing_rule_input::PutRoutingRuleInputBuilder;

pub use crate::operation::put_routing_rule::_put_routing_rule_output::PutRoutingRuleOutputBuilder;

impl crate::operation::put_routing_rule::builders::PutRoutingRuleInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::put_routing_rule::PutRoutingRuleError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.put_routing_rule();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `PutRoutingRule`.
///
/// <p>Updates a routing rule.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct PutRoutingRuleFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::put_routing_rule::builders::PutRoutingRuleInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::put_routing_rule::PutRoutingRuleOutput,
        crate::operation::put_routing_rule::PutRoutingRuleError,
    > for PutRoutingRuleFluentBuilder
{
    fn send(
        self,
...
impl PutRoutingRuleFluentBuilder {
    /// Creates a new `PutRoutingRuleFluentBuilder`.
    ...
    /// Access the PutRoutingRule as a reference.
    pub fn as_input(&self) -> &crate::operation::put_routing_rule::builders::PutRoutingRuleInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::put_routing_rule::PutRoutingRule::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::put_routing_rule::PutRoutingRule::orchestrate(&runtime_plugins, input).await
    }
