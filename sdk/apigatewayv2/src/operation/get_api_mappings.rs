...
impl GetApiMappingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_api_mappings::GetApiMappings, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApiMappings {
    type Output =
        ::std::result::Result<crate::operation::get_api_mappings::GetApiMappingsOutput, crate::operation::get_api_mappings::GetApiMappingsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_api_mappings::de_get_api_mappings_http_response_with_props(status, headers, body)
        }
    }
}
