...
impl GetApiMappingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_api_mappings::GetApiMappings,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_api_mappings::GetApiMappings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApiMappings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_api_mappings::de_get_api_mappings_http_error(
                status, headers, body,
            )
        } else {
