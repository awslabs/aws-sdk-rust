...
impl GetIntegrationResponsesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_integration_responses::GetIntegrationResponsesInput, ::aws_smithy_types::error::operation::BuildError> {
