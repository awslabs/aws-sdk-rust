...
impl DeleteRouteSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_route_settings::DeleteRouteSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRouteSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_route_settings::de_delete_route_settings_http_response_with_props(status, headers, body)
        }
    }
}
