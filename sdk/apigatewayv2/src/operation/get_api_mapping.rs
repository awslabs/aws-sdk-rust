...
impl GetApiMappingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_api_mapping::GetApiMapping, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApiMapping {
    type Output =
        ::std::result::Result<crate::operation::get_api_mapping::GetApiMappingOutput, crate::operation::get_api_mapping::GetApiMappingError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_api_mapping::de_get_api_mapping_http_response_with_props(status, headers, body)
        }
    }
}
