...
impl UpdateIntegrationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_integration::ser_update_integration_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIntegration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_integration::de_update_integration_http_response_with_props(status, headers, body)
        }
    }
}
