...
impl ReimportApiInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::reimport_api::ReimportApi::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReimportApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_reimport_api::de_reimport_api_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_reimport_api::de_reimport_api_http_response_with_props(
                status, headers, body,
            )
        }
    }
