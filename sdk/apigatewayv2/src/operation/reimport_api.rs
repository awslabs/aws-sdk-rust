...
impl ReimportApiInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::reimport_api::ReimportApi, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_reimport_api::ser_reimport_api_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReimportApi {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_reimport_api::de_reimport_api_http_response_with_props(status, headers, body)
        }
    }
}
