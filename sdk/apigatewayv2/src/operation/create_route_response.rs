    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                ...
                let route_id = aws_smithy_http::label::fmt_string(
                    input_2,
                    aws_smithy_http::label::EncodingStrategy::Default,
                );
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_route_response::ser_create_route_response_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_route_response::CreateRouteResponse::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRouteResponse {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 201 {
            crate::protocol_serde::shape_create_route_response::de_create_route_response_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::create_route_response::CreateRouteResponseError
{
