...
impl DeleteIntegrationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_integration::DeleteIntegration,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIntegration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_integration::de_delete_integration_http_response_with_props(status, headers, body)
        }
    }
}
