...
pub fn serialize_structure_create_api_input(
    ...
    if let Some(var_2) = &input.cors_configuration {
        ...
        crate::json_ser::serialize_structure_cors(&mut object_3, var_2);
        object_3.finish();
    }
...
pub fn serialize_structure_create_api_mapping_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_authorizer_input(
    ...
    if let Some(var_27) = &input.jwt_configuration {
        ...
        crate::json_ser::serialize_structure_jwt_configuration(&mut object_28, var_27);
        object_28.finish();
    }
        ...
        for item_35 in var_33 {
            {
                ...
                crate::json_ser::serialize_structure_domain_name_configuration(
                    &mut object_36,
                    item_35,
                );
                object_36.finish();
...
pub fn serialize_structure_create_integration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_70) = &input.tls_config {
        ...
        crate::json_ser::serialize_structure_tls_config_input(&mut object_71, var_70);
        object_71.finish();
    }
}

pub fn serialize_structure_create_integration_response_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_route_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_100, value_101) in var_98 {
            {
                ...
                crate::json_ser::serialize_structure_parameter_constraints(
                    &mut object_102,
                    value_101,
                );
                object_102.finish();
...
pub fn serialize_structure_create_route_response_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_stage_input(
    ...
    if let Some(var_117) = &input.access_log_settings {
        ...
        crate::json_ser::serialize_structure_access_log_settings(&mut object_118, var_117);
        object_118.finish();
    }
    ...
    if let Some(var_120) = &input.default_route_settings {
        ...
        crate::json_ser::serialize_structure_route_settings(&mut object_121, var_120);
        object_121.finish();
    }
        ...
        for (key_126, value_127) in var_124 {
            {
                ...
                crate::json_ser::serialize_structure_route_settings(&mut object_128, value_127);
                object_128.finish();
            }
        }
        object_125.finish();
...
pub fn serialize_structure_import_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_reimport_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_api_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_156) = &input.cors_configuration {
        ...
        crate::json_ser::serialize_structure_cors(&mut object_157, var_156);
        object_157.finish();
    }
...
pub fn serialize_structure_update_api_mapping_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_authorizer_input(
    ...
    if let Some(var_176) = &input.jwt_configuration {
        ...
        crate::json_ser::serialize_structure_jwt_configuration(&mut object_177, var_176);
        object_177.finish();
    }
...
pub fn serialize_structure_update_integration_input(
    ...
    if let Some(var_213) = &input.tls_config {
        ...
        crate::json_ser::serialize_structure_tls_config_input(&mut object_214, var_213);
        object_214.finish();
    }
}
...
pub fn serialize_structure_update_route_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_route_response_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_stage_input(
    ...
    if let Some(var_260) = &input.access_log_settings {
        ...
        crate::json_ser::serialize_structure_access_log_settings(&mut object_261, var_260);
        object_261.finish();
    }
    if input.auto_deploy {
        object.key("autoDeploy").boolean(input.auto_deploy);
    ...
    if let Some(var_263) = &input.default_route_settings {
        ...
        crate::json_ser::serialize_structure_route_settings(&mut object_264, var_263);
        object_264.finish();
    }
        ...
        for (key_269, value_270) in var_267 {
            {
                ...
                crate::json_ser::serialize_structure_route_settings(&mut object_271, value_270);
                object_271.finish();
            }
        }
        object_268.finish();
...
pub fn serialize_structure_cors(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_jwt_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_domain_name_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_tls_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_parameter_constraints(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_access_log_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_route_settings(
    object: &mut smithy_json::serialize::JsonObjectWriter,
