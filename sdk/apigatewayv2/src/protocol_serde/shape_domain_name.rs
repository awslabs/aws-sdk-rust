...
pub(crate) fn de_domain_name<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DomainName>, aws_smithy_json::deserialize::error::DeserializeError>
