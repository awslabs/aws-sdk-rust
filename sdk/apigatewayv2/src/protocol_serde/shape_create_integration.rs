...
pub fn ser_create_integration_input(
    ...
    crate::protocol_serde::shape_create_integration_input::ser_create_integration_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_integration::CreateIntegrationError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::create_integration::CreateIntegrationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ConflictException" => {
            crate::operation::create_integration::CreateIntegrationError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::create_integration::CreateIntegrationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "TooManyRequestsException" => {
            crate::operation::create_integration::CreateIntegrationError::TooManyRequestsException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_create_integration::de_create_integration(
