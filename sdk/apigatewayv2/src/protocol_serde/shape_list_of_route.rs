...
pub(crate) fn de_list_of_route<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::Route>>, ::aws_smithy_json::deserialize::error::DeserializeError>
