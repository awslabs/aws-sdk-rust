...
pub fn ser_create_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
