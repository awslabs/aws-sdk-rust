...
> {
    ...
    Err(match error_code {
        ...
        "ConflictException" => {
            crate::operation::create_deployment::CreateDeploymentError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotFoundException" => {
            crate::operation::create_deployment::CreateDeploymentError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "TooManyRequestsException" => {
            crate::operation::create_deployment::CreateDeploymentError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "deploymentStatus" => {
                        builder = builder.set_deployment_status(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::DeploymentStatus::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
