...
pub fn ser_domain_name_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DomainNameConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_domain_name_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DomainNameConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
