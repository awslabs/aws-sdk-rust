...
pub fn de_delete_authorizer_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteAuthorizerOutput, crate::error::DeleteAuthorizerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteAuthorizerError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "TooManyRequestsException" => crate::error::DeleteAuthorizerError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_authorizer_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteAuthorizerOutput, crate::error::DeleteAuthorizerError> {
    Ok({
        #[allow(unused_mut)]
