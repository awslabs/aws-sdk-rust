...
pub fn de_get_deployment_http_error(
    ...
    Err(match error_code {
        "NotFoundException" => crate::error::GetDeploymentError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                let mut output = crate::error::not_found_exception::Builder::default();
                let _ = response;
                output = crate::protocol_serde::shape_not_found_exception::de_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::error::GetDeploymentError::unhandled)?;
        ...
        "TooManyRequestsException" => crate::error::GetDeploymentError::TooManyRequestsException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(response.body().as_ref(), output).map_err(crate::error::GetDeploymentError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
...
pub fn de_get_deployment_http_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_deployment::de_get_deployment(
...
pub(crate) fn de_get_deployment(
    ...
    crate::output::get_deployment_output::Builder,
