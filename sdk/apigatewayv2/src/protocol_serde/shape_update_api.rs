...
pub fn de_update_api_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::update_api::UpdateApiOutput, crate::operation::update_api::UpdateApiError> {
    #[allow(unused_mut)]
...
) -> ::std::result::Result<crate::operation::update_api::builders::UpdateApiOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
