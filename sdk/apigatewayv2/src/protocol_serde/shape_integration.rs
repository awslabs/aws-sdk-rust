            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "requestParameters" => {
                            builder = builder
                                .set_request_parameters(crate::protocol_serde::shape_integration_parameters::de_integration_parameters(tokens)?);
                        }
                        "requestTemplates" => {
                        ...
                        "responseParameters" => {
                            builder =
                                builder.set_response_parameters(crate::protocol_serde::shape_response_parameters::de_response_parameters(tokens)?);
                        }
