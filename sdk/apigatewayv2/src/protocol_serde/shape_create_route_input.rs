...
pub fn ser_create_route_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateRouteInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
