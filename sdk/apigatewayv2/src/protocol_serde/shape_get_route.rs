...
pub fn de_get_route_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_route::GetRouteOutput, crate::operation::get_route::GetRouteError> {
    #[allow(unused_mut)]
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "requestModels" => {
                    builder = builder.set_request_models(crate::protocol_serde::shape_route_models::de_route_models(tokens, _value, depth + 1)?);
                }
                "requestParameters" => {
                    builder = builder.set_request_parameters(crate::protocol_serde::shape_route_parameters::de_route_parameters(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
