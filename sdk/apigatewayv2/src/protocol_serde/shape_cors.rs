...
pub(crate) fn de_cors<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Cors>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_cors(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Cors) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
