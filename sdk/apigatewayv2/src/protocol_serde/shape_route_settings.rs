...
pub(crate) fn de_route_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RouteSettings>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_route_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RouteSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
