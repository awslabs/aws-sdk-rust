...
pub fn ser_update_api_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_api::UpdateApiInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
