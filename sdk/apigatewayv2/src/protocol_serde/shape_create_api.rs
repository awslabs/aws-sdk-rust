...
pub fn de_create_api_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_api::CreateApiOutput, crate::operation::create_api::CreateApiError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::create_api::builders::CreateApiOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
