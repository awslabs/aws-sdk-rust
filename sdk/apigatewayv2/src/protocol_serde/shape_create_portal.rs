...
pub fn de_create_portal_http_error(
    ...
    Err(match error_code {
        ...
        "BadRequestException" => crate::operation::create_portal::CreatePortalError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::create_portal::CreatePortalError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
