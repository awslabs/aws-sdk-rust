...
pub fn ser_create_integration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateIntegrationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
