...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::reset_authorizers_cache::builders::ResetAuthorizersCacheFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::reset_authorizers_cache::builders::ResetAuthorizersCacheFluentBuilder::set_api_id): <p>The API identifier.</p>
