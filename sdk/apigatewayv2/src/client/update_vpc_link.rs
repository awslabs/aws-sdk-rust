...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder::set_name): <p>The name of the VPC link.</p>
    ///   - [`vpc_link_id(impl ::std::convert::Into<String>)`](crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder::vpc_link_id) / [`set_vpc_link_id(Option<String>)`](crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder::set_vpc_link_id): <p>The ID of the VPC link.</p>
    ...
    pub fn update_vpc_link(
        &self,
    ) -> crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder {
        crate::operation::update_vpc_link::builders::UpdateVpcLinkFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
