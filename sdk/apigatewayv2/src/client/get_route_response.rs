...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::get_route_response::builders::GetRouteResponseFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::get_route_response::builders::GetRouteResponseFluentBuilder::set_api_id):<br>required: **true**<br><p>The API identifier.</p><br>
    ///   - [`route_id(impl Into<String>)`](crate::operation::get_route_response::builders::GetRouteResponseFluentBuilder::route_id) / [`set_route_id(Option<String>)`](crate::operation::get_route_response::builders::GetRouteResponseFluentBuilder::set_route_id):<br>required: **true**<br><p>The route ID.</p><br>
