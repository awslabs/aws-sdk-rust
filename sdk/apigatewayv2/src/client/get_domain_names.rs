...
impl super::Client {
    ...
    ///   - [`max_results(impl ::std::convert::Into<String>)`](crate::operation::get_domain_names::builders::GetDomainNamesFluentBuilder::max_results) / [`set_max_results(Option<String>)`](crate::operation::get_domain_names::builders::GetDomainNamesFluentBuilder::set_max_results): <p>The maximum number of elements to be returned for this resource.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_domain_names::builders::GetDomainNamesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_domain_names::builders::GetDomainNamesFluentBuilder::set_next_token): <p>The next page of elements from this collection. Not valid for the last element of the collection.</p>
