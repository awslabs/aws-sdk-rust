...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_deployment::builders::DeleteDeploymentFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_deployment::builders::DeleteDeploymentFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::delete_deployment::builders::DeleteDeploymentFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::delete_deployment::builders::DeleteDeploymentFluentBuilder::set_deployment_id): <p>The deployment ID.</p>
