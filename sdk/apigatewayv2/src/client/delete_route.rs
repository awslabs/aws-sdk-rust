...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`route_id(impl ::std::convert::Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::route_id) / [`set_route_id(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_route_id): <p>The route ID.</p>
