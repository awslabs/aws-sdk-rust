...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::set_domain_name): <p>The domain name.</p>
    ...
    pub fn create_domain_name(
        &self,
    ) -> crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder {
        crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
