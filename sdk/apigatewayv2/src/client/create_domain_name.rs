...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::set_tags): <p>The collection of tags associated with a domain name.</p>
