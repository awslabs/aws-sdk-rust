...
impl super::Client {
    ...
    ///   - [`routing_mode(RoutingMode)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::routing_mode) / [`set_routing_mode(Option<RoutingMode>)`](crate::operation::create_domain_name::builders::CreateDomainNameFluentBuilder::set_routing_mode):<br>required: **false**<br><p>The routing mode.</p><br>
    ...
    ///   - [`domain_name_arn(Option<String>)`](crate::operation::create_domain_name::CreateDomainNameOutput::domain_name_arn): <p>Represents an Amazon Resource Name (ARN).</p>
    ...
    ///   - [`routing_mode(Option<RoutingMode>)`](crate::operation::create_domain_name::CreateDomainNameOutput::routing_mode): <p>The routing mode.</p>
