...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::delete_stage::builders::DeleteStageFluentBuilder::set_stage_name): <p>The stage name. Stage names can only contain alphanumeric characters, hyphens, and underscores. Maximum length is 128 characters.</p>
