...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`basepath(impl ::std::convert::Into<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::basepath) / [`set_basepath(Option<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::set_basepath): <p>Specifies how to interpret the base path of the API during import. Valid values are ignore, prepend, and split. The default value is ignore. To learn more, see <a href="https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-import-api-basePath.html">Set the OpenAPI basePath Property</a>. Supported only for HTTP APIs.</p>
    ///   - [`body(impl ::std::convert::Into<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::body) / [`set_body(Option<String>)`](crate::operation::reimport_api::builders::ReimportApiFluentBuilder::set_body): <p>The OpenAPI definition. Supported only for HTTP APIs.</p>
