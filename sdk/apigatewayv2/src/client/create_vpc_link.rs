...
impl super::Client {
    ...
    ///   - [`security_group_ids(impl Into<String>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::security_group_ids) / [`set_security_group_ids(Option<Vec<String>>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::set_security_group_ids): <p>A list of security group IDs for the VPC link.</p>
    ///   - [`subnet_ids(impl Into<String>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::subnet_ids) / [`set_subnet_ids(Option<Vec<String>>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::set_subnet_ids): <p>A list of subnet IDs to include in the VPC link.</p>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_vpc_link::builders::CreateVpcLinkFluentBuilder::set_tags): <p>A list of tags.</p>
