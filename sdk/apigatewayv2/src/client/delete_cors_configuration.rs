...
impl super::Client {
    ...
    ///   - [`api_id(impl Into<String>)`](crate::operation::delete_cors_configuration::builders::DeleteCorsConfigurationFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_cors_configuration::builders::DeleteCorsConfigurationFluentBuilder::set_api_id):<br>required: **true**<br><p>The API identifier.</p><br>
