...
impl super::Client {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`auto_deploy(bool)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::auto_deploy) / [`set_auto_deploy(Option<bool>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_auto_deploy): <p>Specifies whether updates to an API automatically trigger a new deployment. The default value is false.</p>
    ///   - [`client_certificate_id(impl ::std::convert::Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::client_certificate_id) / [`set_client_certificate_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_client_certificate_id): <p>The identifier of a client certificate for a Stage. Supported only for WebSocket APIs.</p>
    ...
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_deployment_id): <p>The deployment identifier of the API stage.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_description): <p>The description for the API stage.</p>
