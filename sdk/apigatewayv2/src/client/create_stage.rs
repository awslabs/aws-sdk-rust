...
impl super::Client {
    ...
    ///   - [`access_log_settings(AccessLogSettings)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::access_log_settings) / [`set_access_log_settings(Option<AccessLogSettings>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_access_log_settings): <p>Settings for logging access in this stage.</p>
    ///   - [`api_id(impl Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`auto_deploy(bool)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::auto_deploy) / [`set_auto_deploy(bool)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_auto_deploy): <p>Specifies whether updates to an API automatically trigger a new deployment. The default value is false.</p>
    ///   - [`client_certificate_id(impl Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::client_certificate_id) / [`set_client_certificate_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_client_certificate_id): <p>The identifier of a client certificate for a Stage. Supported only for WebSocket APIs.</p>
    ///   - [`default_route_settings(RouteSettings)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::default_route_settings) / [`set_default_route_settings(Option<RouteSettings>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_default_route_settings): <p>The default route settings for the stage.</p>
    ///   - [`deployment_id(impl Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_deployment_id): <p>The deployment identifier of the API stage.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_description): <p>The description for the API stage.</p>
    ///   - [`route_settings(HashMap<String, RouteSettings>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::route_settings) / [`set_route_settings(Option<HashMap<String, RouteSettings>>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_route_settings): <p>Route settings for the stage, by routeKey.</p>
    ...
    ///   - [`stage_variables(HashMap<String, String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::stage_variables) / [`set_stage_variables(Option<HashMap<String, String>>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_stage_variables): <p>A map that defines the stage variables for a Stage. Variable names can have alphanumeric and underscore characters, and the values must match [A-Za-z0-9-._~:/?#&amp;=,]+.</p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_tags): <p>The collection of tags. Each tag element is associated with a given resource.</p>
    ...
    ///   - [`api_gateway_managed(bool)`](crate::operation::create_stage::CreateStageOutput::api_gateway_managed): <p>Specifies whether a stage is managed by API Gateway. If you created an API using quick create, the $default stage is managed by API Gateway. You can't modify the $default stage.</p>
    ///   - [`auto_deploy(bool)`](crate::operation::create_stage::CreateStageOutput::auto_deploy): <p>Specifies whether updates to an API automatically trigger a new deployment. The default value is false.</p>
