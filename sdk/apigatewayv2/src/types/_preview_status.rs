...
/// match previewstatus {
///     PreviewStatus::PreviewFailed => { /* ... */ },
///     PreviewStatus::PreviewInProgress => { /* ... */ },
...
impl ::std::convert::From<&str> for PreviewStatus {
    fn from(s: &str) -> Self {
        match s {
            "PREVIEW_FAILED" => PreviewStatus::PreviewFailed,
            "PREVIEW_IN_PROGRESS" => PreviewStatus::PreviewInProgress,
            "PREVIEW_READY" => PreviewStatus::PreviewReady,
...
impl PreviewStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            PreviewStatus::PreviewFailed => "PREVIEW_FAILED",
            PreviewStatus::PreviewInProgress => "PREVIEW_IN_PROGRESS",
            PreviewStatus::PreviewReady => "PREVIEW_READY",
            PreviewStatus::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["PREVIEW_FAILED", "PREVIEW_IN_PROGRESS", "PREVIEW_READY"]
    }
}
...
impl ::std::fmt::Display for PreviewStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            PreviewStatus::PreviewFailed => write!(f, "PREVIEW_FAILED"),
            PreviewStatus::PreviewInProgress => write!(f, "PREVIEW_IN_PROGRESS"),
            PreviewStatus::PreviewReady => write!(f, "PREVIEW_READY"),
