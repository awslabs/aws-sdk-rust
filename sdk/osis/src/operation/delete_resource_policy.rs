...
impl DeleteResourcePolicy {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("OSIS", "DeleteResourcePolicy", input, runtime_plugins, stop_point)
...
impl DeleteResourcePolicyError {
    ...
    /// Returns `true` if the error kind is `DeleteResourcePolicyError::DisabledOperationException`.
