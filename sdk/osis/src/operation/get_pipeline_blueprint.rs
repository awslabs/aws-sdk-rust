...
impl GetPipelineBlueprintInput {
    /// Consumes the builder and constructs an Operation<[`GetPipelineBlueprint`](crate::operation::get_pipeline_blueprint::GetPipelineBlueprint)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_pipeline_blueprint::GetPipelineBlueprint::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPipelineBlueprint", "osis"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPipelineBlueprint {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pipeline_blueprint::de_get_pipeline_blueprint_http_response_with_props(status, headers, body)
        }
    }
}
