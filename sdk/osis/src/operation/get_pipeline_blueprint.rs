    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_pipeline_blueprint::GetPipelineBlueprintError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_pipeline_blueprint::GetPipelineBlueprintOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetPipelineBlueprintResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetPipelineBlueprintRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_pipeline_blueprint::GetPipelineBlueprintInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("blueprint_name", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetPipelineBlueprintEndpointParamsInterceptor {
...
pub type GetPipelineBlueprintErrorKind = GetPipelineBlueprintError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetPipelineBlueprintError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_pipeline_blueprint::GetPipelineBlueprintError {
...
impl GetPipelineBlueprintError {
    ...
    /// Creates the `GetPipelineBlueprintError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
