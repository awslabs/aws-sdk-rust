...
impl GetPipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_pipeline::GetPipeline,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_pipeline::GetPipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_pipeline::de_get_pipeline_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_pipeline::de_get_pipeline_http_response_with_props(
                status, headers, body,
            )
        }
    }
