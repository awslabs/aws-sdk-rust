...
impl GetPipelineInput {
    /// Consumes the builder and constructs an Operation<[`GetPipeline`](crate::operation::get_pipeline::GetPipeline)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_pipeline::GetPipeline, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_pipeline::GetPipeline::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPipeline", "osis"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPipeline {
    type Output = ::std::result::Result<crate::operation::get_pipeline::GetPipelineOutput, crate::operation::get_pipeline::GetPipelineError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_pipeline::de_get_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
