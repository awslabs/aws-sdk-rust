    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_blueprints::ListPipelineBlueprintsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_blueprints::ListPipelineBlueprintsOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListPipelineBlueprintsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListPipelineBlueprintsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_pipeline_blueprints::ListPipelineBlueprintsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListPipelineBlueprintsEndpointParamsInterceptor {
...
pub type ListPipelineBlueprintsErrorKind = ListPipelineBlueprintsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListPipelineBlueprintsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_pipeline_blueprints::ListPipelineBlueprintsError {
...
impl ListPipelineBlueprintsError {
    ...
    /// Creates the `ListPipelineBlueprintsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
