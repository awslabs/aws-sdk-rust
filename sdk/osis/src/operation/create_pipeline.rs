...
impl CreatePipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_pipeline::CreatePipeline, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_pipeline::ser_create_pipeline_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_pipeline::CreatePipeline::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePipeline", "osis"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePipeline {
    type Output =
        ::std::result::Result<crate::operation::create_pipeline::CreatePipelineOutput, crate::operation::create_pipeline::CreatePipelineError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_pipeline::de_create_pipeline_http_response_with_props(status, headers, body)
        }
    }
}
