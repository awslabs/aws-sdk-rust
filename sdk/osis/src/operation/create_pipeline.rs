    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2022-01-01/osis/createPipeline")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_pipeline::CreatePipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_pipeline::de_create_pipeline_http_error(
                status, headers, body,
            )
        } else {
