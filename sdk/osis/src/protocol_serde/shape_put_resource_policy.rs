...
) -> std::result::Result<crate::operation::put_resource_policy::PutResourcePolicyOutput, crate::operation::put_resource_policy::PutResourcePolicyError>
{
    ...
    Err(match error_code {
        ...
        "DisabledOperationException" => crate::operation::put_resource_policy::PutResourcePolicyError::DisabledOperationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalException" => crate::operation::put_resource_policy::PutResourcePolicyError::InternalException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
