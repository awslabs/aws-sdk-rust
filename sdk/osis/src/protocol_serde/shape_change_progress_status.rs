...
) -> Result<Option<crate::types::ChangeProgressStatus>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ChangeProgressStatuses::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "TotalNumberOfStages" => {
