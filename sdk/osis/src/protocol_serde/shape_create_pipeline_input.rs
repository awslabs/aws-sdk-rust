...
pub fn ser_create_pipeline_input_input(
    ...
    if let Some(var_7) = &input.max_units {
        object.key("MaxUnits").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.min_units {
        object.key("MinUnits").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
