...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl Into<String>)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::set_pipeline_name): <p>The name of the OpenSearch Ingestion pipeline to create. Pipeline names are unique across the pipelines owned by an account within an Amazon Web Services Region.</p>
    ...
    ///   - [`pipeline_configuration_body(impl Into<String>)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::pipeline_configuration_body) / [`set_pipeline_configuration_body(Option<String>)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::set_pipeline_configuration_body): <p>The pipeline configuration in YAML format. The command accepts the pipeline configuration as a string or within a .yaml file. If you provide the configuration as a string, each new line must be escaped with <code>\n</code>.</p>
    ...
    ///   - [`tags(Tag)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_pipeline::builders::CreatePipelineFluentBuilder::set_tags): <p>List of tags to add to the pipeline upon creation.</p>
