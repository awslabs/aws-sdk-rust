...
impl super::Client {
    ...
    ///   - [`pipeline_name(impl ::std::convert::Into<String>)`](crate::operation::get_pipeline_change_progress::builders::GetPipelineChangeProgressFluentBuilder::pipeline_name) / [`set_pipeline_name(Option<String>)`](crate::operation::get_pipeline_change_progress::builders::GetPipelineChangeProgressFluentBuilder::set_pipeline_name): <p>The name of the pipeline.</p>
