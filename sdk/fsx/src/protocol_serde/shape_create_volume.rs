    ...
    Err(match error_code {
        ...
        "MissingVolumeConfiguration" => crate::operation::create_volume::CreateVolumeError::MissingVolumeConfiguration({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_missing_volume_configuration::de_missing_volume_configuration_json_err(_response_body, output)
                    .map_err(crate::operation::create_volume::CreateVolumeError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "StorageVirtualMachineNotFound" => crate::operation::create_volume::CreateVolumeError::StorageVirtualMachineNotFound({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_storage_virtual_machine_not_found::de_storage_virtual_machine_not_found_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::create_volume::CreateVolumeError::unhandled)?;
...
) -> Result<crate::operation::create_volume::builders::CreateVolumeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
