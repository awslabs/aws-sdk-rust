...
pub fn ser_file_cache_data_repository_association(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FileCacheDataRepositoryAssociation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
