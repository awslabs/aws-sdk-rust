...
pub fn ser_create_file_system_from_backup_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateFileSystemFromBackupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
