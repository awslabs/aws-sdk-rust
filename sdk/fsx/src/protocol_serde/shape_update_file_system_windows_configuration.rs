...
pub fn ser_update_file_system_windows_configuration(
    ...
    if let Some(var_11) = &input.fsrm_configuration {
        #[allow(unused_mut)]
        let mut object_12 = object.key("FsrmConfiguration").start_object();
        crate::protocol_serde::shape_windows_fsrm_configuration::ser_windows_fsrm_configuration(&mut object_12, var_11)?;
        object_12.finish();
    }
    Ok(())
}
