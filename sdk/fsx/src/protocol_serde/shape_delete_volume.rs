...
pub fn de_delete_volume_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_volume::de_delete_volume(_response_body, output)
            .map_err(crate::operation::delete_volume::DeleteVolumeError::unhandled)?;
...
) -> Result<crate::operation::delete_volume::builders::DeleteVolumeOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
