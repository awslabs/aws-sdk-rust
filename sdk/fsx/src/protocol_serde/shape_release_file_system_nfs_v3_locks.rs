...
pub fn de_release_file_system_nfs_v3_locks_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksOutput, crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksError> {
    #[allow(unused_mut)]
...
pub fn ser_release_file_system_nfs_v3_locks_input(input: &crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_release_file_system_nfs_v3_locks_input::ser_release_file_system_nfs_v3_locks_input_input(&mut object, input)?;
    object.finish();
