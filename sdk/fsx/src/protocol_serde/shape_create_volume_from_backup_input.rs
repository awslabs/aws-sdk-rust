...
pub fn ser_create_volume_from_backup_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateVolumeFromBackupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
