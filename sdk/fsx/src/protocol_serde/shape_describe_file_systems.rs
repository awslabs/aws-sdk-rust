...
pub fn ser_describe_file_systems_input(input: &crate::input::DescribeFileSystemsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
