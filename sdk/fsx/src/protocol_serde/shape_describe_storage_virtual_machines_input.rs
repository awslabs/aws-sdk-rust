...
pub fn ser_describe_storage_virtual_machines_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_storage_virtual_machines::DescribeStorageVirtualMachinesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
