...
pub(crate) fn de_lustre_file_system_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LustreFileSystemConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
