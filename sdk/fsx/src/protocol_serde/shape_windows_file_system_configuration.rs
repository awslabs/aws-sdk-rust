...
pub(crate) fn de_windows_file_system_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WindowsFileSystemConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
