...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_storage_virtual_machines::DescribeStorageVirtualMachinesError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "StorageVirtualMachineNotFound" => {
            crate::operation::describe_storage_virtual_machines::DescribeStorageVirtualMachinesError::StorageVirtualMachineNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_storage_virtual_machines::de_describe_storage_virtual_machines(_response_body, output)
            .map_err(crate::operation::describe_storage_virtual_machines::DescribeStorageVirtualMachinesError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "StorageVirtualMachines" => {
                    builder = builder.set_storage_virtual_machines(
                        crate::protocol_serde::shape_storage_virtual_machines::de_storage_virtual_machines(tokens, _value, depth + 1)?,
                    );
                }
                "NextToken" => {
