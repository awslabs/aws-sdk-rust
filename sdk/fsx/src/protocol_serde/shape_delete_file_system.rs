...
pub fn de_delete_file_system_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_file_system::DeleteFileSystemOutput, crate::operation::delete_file_system::DeleteFileSystemError> {
    #[allow(unused_mut)]
...
pub fn de_delete_file_system_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_file_system::de_delete_file_system(_response_body, output)
            .map_err(crate::operation::delete_file_system::DeleteFileSystemError::unhandled)?;
...
) -> Result<crate::operation::delete_file_system::builders::DeleteFileSystemOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
