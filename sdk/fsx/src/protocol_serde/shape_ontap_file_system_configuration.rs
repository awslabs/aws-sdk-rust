...
pub(crate) fn de_ontap_file_system_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OntapFileSystemConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
