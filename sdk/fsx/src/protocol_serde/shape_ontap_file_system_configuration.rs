...
) -> Result<Option<crate::types::OntapFileSystemConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DeploymentType" => {
                            builder = builder.set_deployment_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::OntapDeploymentType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        ...
                        "Endpoints" => {
                            builder = builder.set_endpoints(crate::protocol_serde::shape_file_system_endpoints::de_file_system_endpoints(tokens)?);
                        }
                        ...
                        "FsxAdminPassword" => {
                            builder = builder.set_fsx_admin_password(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                                    .transpose()?,
                            );
