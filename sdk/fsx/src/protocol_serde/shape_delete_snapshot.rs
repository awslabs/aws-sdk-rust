...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerError" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "SnapshotNotFound" => {
            crate::operation::delete_snapshot::DeleteSnapshotError::SnapshotNotFound({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                ...
                match key.to_unescaped()?.as_ref() {
                    ...
                    "Lifecycle" => {
                        builder = builder.set_lifecycle(
                            ...
                            .map(|s| {
                                s.to_unescaped()
                                    .map(|u| crate::types::SnapshotLifecycle::from(u.as_ref()))
                            })
                            .transpose()?,
                        );
                    }
