...
pub(crate) fn de_open_zfs_file_system_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OpenZfsFileSystemConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
