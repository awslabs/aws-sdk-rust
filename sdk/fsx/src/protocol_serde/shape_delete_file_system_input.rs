...
pub fn ser_delete_file_system_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DeleteFileSystemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
