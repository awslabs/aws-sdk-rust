...
pub fn ser_update_file_system_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFileSystemInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
