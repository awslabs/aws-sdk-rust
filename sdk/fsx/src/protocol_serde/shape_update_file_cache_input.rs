...
pub fn ser_update_file_cache_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFileCacheInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
