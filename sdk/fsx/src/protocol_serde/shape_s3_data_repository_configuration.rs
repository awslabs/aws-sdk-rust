...
pub fn ser_s3_data_repository_configuration(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::S3DataRepositoryConfiguration,
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AutoImportPolicy" => {
                            builder = builder.set_auto_import_policy(crate::protocol_serde::shape_auto_import_policy::de_auto_import_policy(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "AutoExportPolicy" => {
                            builder = builder.set_auto_export_policy(crate::protocol_serde::shape_auto_export_policy::de_auto_export_policy(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
