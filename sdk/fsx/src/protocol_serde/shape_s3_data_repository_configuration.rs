...
pub fn ser_s3_data_repository_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3DataRepositoryConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_s3_data_repository_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::S3DataRepositoryConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
