...
pub fn ser_delete_file_system_open_zfs_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DeleteFileSystemOpenZfsConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_6) = &input.options {
        let mut array_7 = object.key("Options").start_array();
        for item_8 in var_6 {
             {
