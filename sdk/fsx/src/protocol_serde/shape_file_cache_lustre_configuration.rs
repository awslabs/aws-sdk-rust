...
pub(crate) fn de_file_cache_lustre_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FileCacheLustreConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
