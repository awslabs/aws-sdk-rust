...
pub fn ser_create_volume_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_volume::CreateVolumeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
