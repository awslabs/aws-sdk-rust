...
pub(crate) fn de_snapshots<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::Snapshot>>, aws_smithy_json::deserialize::error::DeserializeError>
