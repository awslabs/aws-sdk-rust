...
pub fn ser_create_storage_virtual_machine_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateStorageVirtualMachineInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
