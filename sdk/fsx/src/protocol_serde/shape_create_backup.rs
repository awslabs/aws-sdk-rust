    ...
    Err(match error_code {
        "BackupInProgress" => crate::operation::create_backup::CreateBackupError::BackupInProgress({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_backup_in_progress::de_backup_in_progress_json_err(_response_body, output)
                    .map_err(crate::operation::create_backup::CreateBackupError::unhandled)?;
...
) -> Result<crate::operation::create_backup::builders::CreateBackupOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
