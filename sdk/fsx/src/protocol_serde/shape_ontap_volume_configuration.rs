...
) -> Result<Option<crate::types::OntapVolumeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TieringPolicy" => {
                            builder = builder.set_tiering_policy(crate::protocol_serde::shape_tiering_policy::de_tiering_policy(tokens)?);
                        }
                        "UUID" => {
