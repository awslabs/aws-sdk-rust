...
pub fn de_update_storage_virtual_machine_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_storage_virtual_machine_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_storage_virtual_machine_input(input: &crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
