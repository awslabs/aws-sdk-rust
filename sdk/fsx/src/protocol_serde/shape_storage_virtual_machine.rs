...
pub(crate) fn de_storage_virtual_machine<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StorageVirtualMachine>, aws_smithy_json::deserialize::error::DeserializeError>
