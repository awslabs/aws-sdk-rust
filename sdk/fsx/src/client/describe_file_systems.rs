...
impl super::Client {
    ...
    ///   - [`file_system_ids(impl Into<String>)`](crate::operation::describe_file_systems::builders::DescribeFileSystemsFluentBuilder::file_system_ids) / [`set_file_system_ids(Option<Vec<String>>)`](crate::operation::describe_file_systems::builders::DescribeFileSystemsFluentBuilder::set_file_system_ids): <p>IDs of the file systems whose descriptions you want to retrieve (String).</p>
