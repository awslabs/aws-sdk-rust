...
impl super::Client {
    ...
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::set_client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 63 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::set_snapshot_id): <p>The ID of the snapshot that you want to delete.</p>
