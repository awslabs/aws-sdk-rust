...
impl super::Client {
    ...
    ///   - [`file_cache_id(impl ::std::convert::Into<String>)`](crate::operation::delete_file_cache::builders::DeleteFileCacheFluentBuilder::file_cache_id) / [`set_file_cache_id(Option<String>)`](crate::operation::delete_file_cache::builders::DeleteFileCacheFluentBuilder::set_file_cache_id): <p>The ID of the cache that's being deleted.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::delete_file_cache::builders::DeleteFileCacheFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::delete_file_cache::builders::DeleteFileCacheFluentBuilder::set_client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 63 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
