...
impl super::Client {
    ...
    ///   - [`backup_ids(impl Into<String>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::backup_ids) / [`set_backup_ids(Option<Vec<String>>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::set_backup_ids): <p>The IDs of the backups that you want to retrieve. This parameter value overrides any filters. If any IDs aren't found, a <code>BackupNotFound</code> error occurs.</p>
    ///   - [`filters(Filter)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::filters) / [`set_filters(Option<Vec<Filter>>)`](crate::operation::describe_backups::builders::DescribeBackupsFluentBuilder::set_filters): <p>The filters structure. The supported names are <code>file-system-id</code>, <code>backup-type</code>, <code>file-system-type</code>, and <code>volume-id</code>.</p>
