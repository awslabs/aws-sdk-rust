...
impl super::Client {
    ...
    ///   - [`filters(SnapshotFilter)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::filters) / [`set_filters(Option<Vec<SnapshotFilter>>)`](crate::operation::describe_snapshots::builders::DescribeSnapshotsFluentBuilder::set_filters): <p>The filters structure. The supported names are <code>file-system-id</code> or <code>volume-id</code>.</p>
