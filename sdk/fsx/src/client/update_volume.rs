...
impl super::Client {
    ...
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 63 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`volume_id(impl ::std::convert::Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_volume_id): <p>The ID of the volume that you want to update, in the format <code>fsvol-0123456789abcdef0</code>.</p>
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_volume::builders::UpdateVolumeFluentBuilder::set_name): <p>The name of the OpenZFS volume. OpenZFS root volumes are automatically named <code>FSX</code>. Child volume names must be unique among their parent volume's children. The name of the volume is part of the mount string for the OpenZFS volume. </p>
