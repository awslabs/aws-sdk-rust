...
impl super::Client {
    ...
    ///   - [`file_cache_id(impl ::std::convert::Into<String>)`](crate::operation::update_file_cache::builders::UpdateFileCacheFluentBuilder::file_cache_id) / [`set_file_cache_id(Option<String>)`](crate::operation::update_file_cache::builders::UpdateFileCacheFluentBuilder::set_file_cache_id): <p>The ID of the cache that you are updating.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::update_file_cache::builders::UpdateFileCacheFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::update_file_cache::builders::UpdateFileCacheFluentBuilder::set_client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 63 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
