...
impl DescribeSnapshotsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSnapshots`](crate::operation::describe_snapshots::DescribeSnapshots)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_snapshots::DescribeSnapshots, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_snapshots::DescribeSnapshotsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_snapshots::DescribeSnapshots::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeSnapshots", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeSnapshots {
                type Output = std::result::Result<crate::operation::describe_snapshots::DescribeSnapshotsOutput, crate::operation::describe_snapshots::DescribeSnapshotsError>;
