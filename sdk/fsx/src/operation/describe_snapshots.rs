...
impl DescribeSnapshotsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_snapshots::ser_describe_snapshots_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_snapshots::de_describe_snapshots_http_response_with_props(status, headers, body)
        }
    }
