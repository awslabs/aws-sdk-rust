...
impl DescribeDataRepositoryTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDataRepositoryTasks`](crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasks, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasksInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_data_repository_tasks::ser_describe_data_repository_tasks_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasks::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeDataRepositoryTasks", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeDataRepositoryTasks {
                type Output = std::result::Result<crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasksOutput, crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasksError>;
