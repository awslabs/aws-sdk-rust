...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataRepositoryTasks {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_repository_tasks::de_describe_data_repository_tasks_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeDataRepositoryTasksError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_data_repository_tasks::DescribeDataRepositoryTasksError
{
