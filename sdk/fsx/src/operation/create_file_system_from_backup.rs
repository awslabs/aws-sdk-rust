...
impl CreateFileSystemFromBackupInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_file_system_from_backup::CreateFileSystemFromBackup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_file_system_from_backup::CreateFileSystemFromBackup::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateFileSystemFromBackup {
                type Output = std::result::Result<crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupOutput, crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupError>;
