...
impl CreateFileSystemFromBackup {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("FSx", "CreateFileSystemFromBackup", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "FSx.CreateFileSystemFromBackup",
                "rpc.service" = "FSx",
                "rpc.method" = "CreateFileSystemFromBackup",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFileSystemFromBackup {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFileSystemFromBackup");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateFileSystemFromBackupRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateFileSystemFromBackupResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateFileSystemFromBackup")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFileSystemFromBackup")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateFileSystemFromBackupTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateFileSystemFromBackupEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateFileSystemFromBackupTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFileSystemFromBackupTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateFileSystemFromBackupInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("BackupId") {
            if let ::std::option::Option::Some(value) = input.backup_id.as_deref() {
                captured.insert("BackupId", value);
            }
        }
        ...
        if requested.should_capture("FileSystemTypeVersion") {
            if let ::std::option::Option::Some(value) = input.file_system_type_version.as_deref() {
                captured.insert("FileSystemTypeVersion", value);
            }
        }
...
#[derive(Debug)]
struct CreateFileSystemFromBackupResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFileSystemFromBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_response(status, headers, body, _cfg)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateFileSystemFromBackupRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFileSystemFromBackupRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_file_system_from_backup::ser_create_file_system_from_backup_input(&input)?,
        );
...
#[derive(Debug)]
struct CreateFileSystemFromBackupEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFileSystemFromBackupEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "CreateFileSystemFromBackupEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateFileSystemFromBackupInput>()
            .ok_or("failed to downcast to CreateFileSystemFromBackupInput")?;
...
pub enum CreateFileSystemFromBackupError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFileSystemFromBackupError) for what information is available for the error.")]
...
impl CreateFileSystemFromBackupError {
    ...
    /// Creates the `CreateFileSystemFromBackupError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ActiveDirectoryError(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::BackupNotFound(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::InvalidNetworkSettings(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidPerUnitStorageThroughput(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::MissingFileSystemConfiguration(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for CreateFileSystemFromBackupError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::ActiveDirectoryError(_inner) => ::std::option::Option::Some(_inner),
            Self::BackupNotFound(_inner) => ::std::option::Option::Some(_inner),
            ...
            Self::InvalidNetworkSettings(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidPerUnitStorageThroughput(_inner) => ::std::option::Option::Some(_inner),
            Self::MissingFileSystemConfiguration(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFileSystemFromBackupError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::ActiveDirectoryError(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::BackupNotFound(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            ...
            Self::InvalidNetworkSettings(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidPerUnitStorageThroughput(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::MissingFileSystemConfiguration(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::ServiceLimitExceeded(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFileSystemFromBackupError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupError {
...
mod _create_file_system_from_backup_output;
