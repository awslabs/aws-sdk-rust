...
impl CreateFileSystemFromBackupInput {
    /// Consumes the builder and constructs an Operation<[`CreateFileSystemFromBackup`](crate::operation::create_file_system_from_backup::CreateFileSystemFromBackup)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_file_system_from_backup::CreateFileSystemFromBackup,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_file_system_from_backup::ser_create_file_system_from_backup_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_file_system_from_backup::CreateFileSystemFromBackup::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFileSystemFromBackup", "fsx"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFileSystemFromBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_response_with_props(
                status, headers, body,
            )
        }
    }
