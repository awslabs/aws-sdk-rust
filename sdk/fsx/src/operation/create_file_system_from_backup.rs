...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFileSystemFromBackupResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_response(status, headers, body)
        };
