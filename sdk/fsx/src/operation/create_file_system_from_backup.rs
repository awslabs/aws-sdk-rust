...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFileSystemFromBackup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_file_system_from_backup::de_create_file_system_from_backup_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_file_system_from_backup::CreateFileSystemFromBackupError
{
