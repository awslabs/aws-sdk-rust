...
impl crate::operation::update_storage_virtual_machine::builders::UpdateStorageVirtualMachineInputBuilder {
...
impl UpdateStorageVirtualMachineFluentBuilder {
    /// Creates a new `UpdateStorageVirtualMachineFluentBuilder`.
