...
impl UpdateFileCacheInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFileCache`](crate::operation::update_file_cache::UpdateFileCache)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_file_cache::UpdateFileCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_file_cache::ser_update_file_cache_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_file_cache::UpdateFileCache::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFileCache", "fsx"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFileCache {
    type Output =
        ::std::result::Result<crate::operation::update_file_cache::UpdateFileCacheOutput, crate::operation::update_file_cache::UpdateFileCacheError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_file_cache::de_update_file_cache_http_response_with_props(status, headers, body)
        }
    }
}
