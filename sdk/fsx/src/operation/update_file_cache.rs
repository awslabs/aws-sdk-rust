...
impl UpdateFileCacheInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_file_cache::UpdateFileCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_file_cache::UpdateFileCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_file_cache::ser_update_file_cache_input(&self)?
        );
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFileCache {
                type Output = std::result::Result<crate::operation::update_file_cache::UpdateFileCacheOutput, crate::operation::update_file_cache::UpdateFileCacheError>;
