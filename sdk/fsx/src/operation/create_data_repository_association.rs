...
impl CreateDataRepositoryAssociationInput {
    /// Consumes the builder and constructs an Operation<[`CreateDataRepositoryAssociation`](crate::operation::create_data_repository_association::CreateDataRepositoryAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_data_repository_association::CreateDataRepositoryAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_data_repository_association::CreateDataRepositoryAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_data_repository_association::ser_create_data_repository_association_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_repository_association::CreateDataRepositoryAssociation::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDataRepositoryAssociation", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDataRepositoryAssociation {
                type Output = std::result::Result<crate::operation::create_data_repository_association::CreateDataRepositoryAssociationOutput, crate::operation::create_data_repository_association::CreateDataRepositoryAssociationError>;
