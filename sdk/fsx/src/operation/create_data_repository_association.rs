...
impl CreateDataRepositoryAssociation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_data_repository_association::CreateDataRepositoryAssociationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_data_repository_association::CreateDataRepositoryAssociationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "FSx",
            "rpc.method" = "CreateDataRepositoryAssociation",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_data_repository_association::CreateDataRepositoryAssociationInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataRepositoryAssociation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateDataRepositoryAssociationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateDataRepositoryAssociationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDataRepositoryAssociation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDataRepositoryAssociation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateDataRepositoryAssociationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CreateDataRepositoryAssociationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateDataRepositoryAssociationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CreateDataRepositoryAssociationInput>() else {
        ...
        if requested.should_capture("FileSystemPath") {
            if let ::std::option::Option::Some(value) = input.file_system_path.as_deref() {
                captured.insert("FileSystemPath", value);
            }
        }
        if requested.should_capture("DataRepositoryPath") {
            if let ::std::option::Option::Some(value) = input.data_repository_path.as_deref() {
                captured.insert("DataRepositoryPath", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataRepositoryAssociationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_create_data_repository_association::de_create_data_repository_association_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataRepositoryAssociationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_data_repository_association::CreateDataRepositoryAssociationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_data_repository_association::CreateDataRepositoryAssociationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_data_repository_association::ser_create_data_repository_association_input(&input)?,
        );
