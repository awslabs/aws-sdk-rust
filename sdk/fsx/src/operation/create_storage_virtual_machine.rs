...
impl CreateStorageVirtualMachineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachine::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateStorageVirtualMachineError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachineError
{
