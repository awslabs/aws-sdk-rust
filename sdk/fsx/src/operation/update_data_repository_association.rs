...
impl UpdateDataRepositoryAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_data_repository_association::UpdateDataRepositoryAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataRepositoryAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_data_repository_association::de_update_data_repository_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
