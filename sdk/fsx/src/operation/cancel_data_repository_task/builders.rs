...
impl CancelDataRepositoryTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskOutput, crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskError, Self> {
