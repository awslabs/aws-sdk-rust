...
impl crate::operation::delete_storage_virtual_machine::builders::DeleteStorageVirtualMachineInputBuilder {
...
impl DeleteStorageVirtualMachineFluentBuilder {
    /// Creates a new `DeleteStorageVirtualMachineFluentBuilder`.
