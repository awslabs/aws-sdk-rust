...
impl CancelDataRepositoryTaskInput {
    /// Consumes the builder and constructs an Operation<[`CancelDataRepositoryTask`](crate::operation::cancel_data_repository_task::CancelDataRepositoryTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_data_repository_task::CancelDataRepositoryTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_data_repository_task::CancelDataRepositoryTask::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CancelDataRepositoryTask {
                type Output = std::result::Result<crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskOutput, crate::operation::cancel_data_repository_task::CancelDataRepositoryTaskError>;
