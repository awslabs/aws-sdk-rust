...
impl CancelDataRepositoryTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_data_repository_task::CancelDataRepositoryTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelDataRepositoryTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_data_repository_task::de_cancel_data_repository_task_http_response_with_props(status, headers, body)
        }
    }
}
