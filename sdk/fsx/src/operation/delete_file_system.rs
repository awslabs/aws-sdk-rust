...
impl DeleteFileSystemInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFileSystem`](crate::operation::delete_file_system::DeleteFileSystem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_file_system::DeleteFileSystem, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_file_system::DeleteFileSystemInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_file_system::ser_delete_file_system_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_file_system::DeleteFileSystem::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteFileSystem", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFileSystem {
                type Output = std::result::Result<crate::operation::delete_file_system::DeleteFileSystemOutput, crate::operation::delete_file_system::DeleteFileSystemError>;
