...
impl AssociateFileSystemAliasesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_file_system_aliases::AssociateFileSystemAliases::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateFileSystemAliases {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_file_system_aliases::de_associate_file_system_aliases_http_response_with_props(
                status, headers, body,
            )
        }
    }
