...
impl AssociateFileSystemAliases {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateFileSystemAliases {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateFileSystemAliases");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateFileSystemAliasesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateFileSystemAliasesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateFileSystemAliases")
...
.with_interceptor(AssociateFileSystemAliasesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError>::new());
...
#[derive(Debug)]
            struct AssociateFileSystemAliasesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateFileSystemAliasesResponseDeserializer {
...
#[derive(Debug)]
            struct AssociateFileSystemAliasesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateFileSystemAliasesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_file_system_aliases::ser_associate_file_system_aliases_input(&input)?);
...
#[derive(Debug)]
            struct AssociateFileSystemAliasesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateFileSystemAliasesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateFileSystemAliasesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateFileSystemAliasesInput>()
                        .ok_or("failed to downcast to AssociateFileSystemAliasesInput")?;
...
pub enum AssociateFileSystemAliasesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateFileSystemAliasesError) for what information is available for the error.")]
...
impl AssociateFileSystemAliasesError {
    /// Creates the `AssociateFileSystemAliasesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateFileSystemAliasesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateFileSystemAliasesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_file_system_aliases::AssociateFileSystemAliasesError {
