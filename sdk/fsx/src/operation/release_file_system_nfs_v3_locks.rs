...
impl ReleaseFileSystemNfsV3Locks {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("FSx", "ReleaseFileSystemNfsV3Locks", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "FSx.ReleaseFileSystemNfsV3Locks",
                "rpc.service" = "FSx",
                "rpc.method" = "ReleaseFileSystemNfsV3Locks",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ReleaseFileSystemNfsV3Locks {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ReleaseFileSystemNfsV3LocksRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ReleaseFileSystemNfsV3LocksResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ReleaseFileSystemNfsV3Locks")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ReleaseFileSystemNfsV3Locks")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ReleaseFileSystemNfsV3LocksTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ReleaseFileSystemNfsV3LocksTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ReleaseFileSystemNfsV3LocksTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ReleaseFileSystemNfsV3LocksInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ReleaseFileSystemNfsV3LocksResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_release_file_system_nfs_v3_locks::de_release_file_system_nfs_v3_locks_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_release_file_system_nfs_v3_locks::de_release_file_system_nfs_v3_locks_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ReleaseFileSystemNfsV3LocksRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_release_file_system_nfs_v3_locks::ser_release_file_system_nfs_v3_locks_input(&input)?,
        );
