...
impl CreateVolumeFromBackupInput {
    /// Consumes the builder and constructs an Operation<[`CreateVolumeFromBackup`](crate::operation::create_volume_from_backup::CreateVolumeFromBackup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_volume_from_backup::CreateVolumeFromBackup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_volume_from_backup::CreateVolumeFromBackupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_volume_from_backup::ser_create_volume_from_backup_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_volume_from_backup::CreateVolumeFromBackup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateVolumeFromBackup", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateVolumeFromBackup {
                type Output = std::result::Result<crate::operation::create_volume_from_backup::CreateVolumeFromBackupOutput, crate::operation::create_volume_from_backup::CreateVolumeFromBackupError>;
