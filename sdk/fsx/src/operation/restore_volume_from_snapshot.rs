...
/// Orchestration and serialization glue logic for `RestoreVolumeFromSnapshot`.
...
impl RestoreVolumeFromSnapshot {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RestoreVolumeFromSnapshot {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RestoreVolumeFromSnapshot");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RestoreVolumeFromSnapshotRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RestoreVolumeFromSnapshotResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RestoreVolumeFromSnapshot")
...
.with_interceptor(RestoreVolumeFromSnapshotEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError>::new());
...
#[derive(Debug)]
            struct RestoreVolumeFromSnapshotResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RestoreVolumeFromSnapshotResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_restore_volume_from_snapshot::de_restore_volume_from_snapshot_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RestoreVolumeFromSnapshotRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RestoreVolumeFromSnapshotRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_restore_volume_from_snapshot::ser_restore_volume_from_snapshot_input(&input)?);
...
#[derive(Debug)]
            struct RestoreVolumeFromSnapshotEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RestoreVolumeFromSnapshotEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RestoreVolumeFromSnapshotEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RestoreVolumeFromSnapshotInput>()
                        .ok_or("failed to downcast to RestoreVolumeFromSnapshotInput")?;
...
pub enum RestoreVolumeFromSnapshotError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RestoreVolumeFromSnapshotError) for what information is available for the error.")]
...
impl RestoreVolumeFromSnapshotError {
    /// Creates the `RestoreVolumeFromSnapshotError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreVolumeFromSnapshotError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RestoreVolumeFromSnapshotError {
...
impl ::aws_types::request_id::RequestId for crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError {
