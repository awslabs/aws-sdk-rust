...
impl RestoreVolumeFromSnapshotInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshot::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotError
{
