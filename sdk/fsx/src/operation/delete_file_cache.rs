...
impl DeleteFileCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_file_cache::DeleteFileCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_file_cache::ser_delete_file_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFileCache {
    type Output =
        ::std::result::Result<crate::operation::delete_file_cache::DeleteFileCacheOutput, crate::operation::delete_file_cache::DeleteFileCacheError>;
