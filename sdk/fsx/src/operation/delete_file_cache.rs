...
impl DeleteFileCacheInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFileCache`](crate::operation::delete_file_cache::DeleteFileCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_file_cache::DeleteFileCache, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_file_cache::DeleteFileCacheInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_file_cache::ser_delete_file_cache_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_file_cache::DeleteFileCache::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteFileCache", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteFileCache {
                type Output = std::result::Result<crate::operation::delete_file_cache::DeleteFileCacheOutput, crate::operation::delete_file_cache::DeleteFileCacheError>;
