...
impl UpdateStorageVirtualMachineInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStorageVirtualMachine`](crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachine)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachine, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_storage_virtual_machine::ser_update_storage_virtual_machine_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachine::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateStorageVirtualMachine", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateStorageVirtualMachine {
                type Output = std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_response(response)
                     }
                }
            }
