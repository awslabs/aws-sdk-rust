...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStorageVirtualMachine {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateStorageVirtualMachineError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError
{
