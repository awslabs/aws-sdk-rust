...
impl UpdateStorageVirtualMachine {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("FSx", "UpdateStorageVirtualMachine", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "FSx.UpdateStorageVirtualMachine",
                "rpc.service" = "FSx",
                "rpc.method" = "UpdateStorageVirtualMachine",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateStorageVirtualMachine {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateStorageVirtualMachineRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateStorageVirtualMachineResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateStorageVirtualMachine")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateStorageVirtualMachine")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateStorageVirtualMachineTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateStorageVirtualMachineTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateStorageVirtualMachineTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateStorageVirtualMachineInput>() else {
        ...
        if requested.should_capture("StorageVirtualMachineId") {
            if let ::std::option::Option::Some(value) = input.storage_virtual_machine_id.as_deref() {
                captured.insert("StorageVirtualMachineId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateStorageVirtualMachineResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateStorageVirtualMachineRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_storage_virtual_machine::ser_update_storage_virtual_machine_input(&input)?,
        );
...
impl ::std::error::Error for UpdateStorageVirtualMachineError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::StorageVirtualMachineNotFound(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateStorageVirtualMachineError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::StorageVirtualMachineNotFound(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
