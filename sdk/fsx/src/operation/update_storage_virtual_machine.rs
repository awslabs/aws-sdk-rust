...
impl UpdateStorageVirtualMachineInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachine::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStorageVirtualMachine {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_storage_virtual_machine::de_update_storage_virtual_machine_http_response_with_props(
                status, headers, body,
            )
        }
    }
