...
impl DescribeDataRepositoryAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDataRepositoryAssociations`](crate::operation::describe_data_repository_associations::DescribeDataRepositoryAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_data_repository_associations::DescribeDataRepositoryAssociations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_data_repository_associations::ser_describe_data_repository_associations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_data_repository_associations::DescribeDataRepositoryAssociations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDataRepositoryAssociations", "fsx"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataRepositoryAssociations {
    type Output = ::std::result::Result<crate::operation::describe_data_repository_associations::DescribeDataRepositoryAssociationsOutput, crate::operation::describe_data_repository_associations::DescribeDataRepositoryAssociationsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_data_repository_associations::de_describe_data_repository_associations_http_response_with_props(status, headers, body)
        }
    }
}
