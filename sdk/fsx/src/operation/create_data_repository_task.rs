...
impl CreateDataRepositoryTaskInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_repository_task::CreateDataRepositoryTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataRepositoryTask {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_repository_task::de_create_data_repository_task_http_response_with_props(status, headers, body)
        }
    }
}
