...
impl CreateDataRepositoryTaskInput {
    /// Consumes the builder and constructs an Operation<[`CreateDataRepositoryTask`](crate::operation::create_data_repository_task::CreateDataRepositoryTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_data_repository_task::CreateDataRepositoryTask, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_data_repository_task::CreateDataRepositoryTaskInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_data_repository_task::ser_create_data_repository_task_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_repository_task::CreateDataRepositoryTask::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateDataRepositoryTask", "fsx"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateDataRepositoryTask {
                type Output = std::result::Result<crate::operation::create_data_repository_task::CreateDataRepositoryTaskOutput, crate::operation::create_data_repository_task::CreateDataRepositoryTaskError>;
