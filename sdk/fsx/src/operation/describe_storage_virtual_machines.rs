...
impl DescribeStorageVirtualMachinesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_storage_virtual_machines::DescribeStorageVirtualMachines::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStorageVirtualMachines {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_storage_virtual_machines::de_describe_storage_virtual_machines_http_response_with_props(
                status, headers, body,
            )
        }
    }
