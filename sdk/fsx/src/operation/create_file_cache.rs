...
impl CreateFileCacheInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_file_cache::CreateFileCache, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_file_cache::ser_create_file_cache_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFileCache {
    type Output =
        ::std::result::Result<crate::operation::create_file_cache::CreateFileCacheOutput, crate::operation::create_file_cache::CreateFileCacheError>;
