...
impl UpdateVolumeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVolume`](crate::operation::update_volume::UpdateVolume)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_volume::UpdateVolume, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_volume::ser_update_volume_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_volume::UpdateVolume::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateVolume", "fsx"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateVolume {
    type Output = ::std::result::Result<crate::operation::update_volume::UpdateVolumeOutput, crate::operation::update_volume::UpdateVolumeError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_volume::de_update_volume_http_response_with_props(status, headers, body)
        }
    }
