    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`CancelDataRepositoryTaskInput`](crate::input::CancelDataRepositoryTaskInput) with field(s):
    ///   - [`task_id(Option<String>)`](crate::input::CancelDataRepositoryTaskInput::task_id): <p>Specifies the data repository task to cancel.</p>
    ...
    ///
    /// - Takes [`CopyBackupInput`](crate::input::CopyBackupInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::CopyBackupInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`source_backup_id(Option<String>)`](crate::input::CopyBackupInput::source_backup_id): <p>The ID of the source backup. Specifies the ID of the backup that's being copied.</p>
    ///   - [`source_region(Option<String>)`](crate::input::CopyBackupInput::source_region): <p>The source Amazon Web Services Region of the backup. Specifies the Amazon Web Services Region from which the backup is being copied. The source and destination Regions must be in the same Amazon Web Services partition. If you don't specify a Region, <code>SourceRegion</code> defaults to the Region where the request is sent from (in-Region copy).</p>
    ///   - [`kms_key_id(Option<String>)`](crate::input::CopyBackupInput::kms_key_id): <p>The ID of the Key Management Service (KMS) key used to encrypt the file system's data for Amazon FSx for Windows File Server file systems, Amazon FSx for NetApp ONTAP file systems, and Amazon FSx for Lustre <code>PERSISTENT_1</code> and <code>PERSISTENT_2</code> file systems at rest. If this ID isn't specified, the key managed by Amazon FSx is used. The Amazon FSx for Lustre <code>SCRATCH_1</code> and <code>SCRATCH_2</code> file systems are always encrypted at rest using Amazon FSx-managed keys. For more information, see <a href="https://docs.aws.amazon.com/kms/latest/APIReference/API_Encrypt.html">Encrypt</a> in the <i>Key Management Service API Reference</i>.</p>
    ///   - [`copy_tags(Option<bool>)`](crate::input::CopyBackupInput::copy_tags): <p>A Boolean flag indicating whether tags from the source backup should be copied to the backup copy. This value defaults to <code>false</code>.</p>  <p>If you set <code>CopyTags</code> to <code>true</code> and the source backup has existing tags, you can use the <code>Tags</code> parameter to create new tags, provided that the sum of the source backup tags and the new tags doesn't exceed 50. Both sets of tags are merged. If there are tag conflicts (for example, two tags with the same key but different values), the tags created with the <code>Tags</code> parameter take precedence.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CopyBackupInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ...
    ///   - [`file_system_id(Option<String>)`](crate::input::CreateBackupInput::file_system_id): <p>The ID of the file system to back up.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateBackupInput::client_request_token): <p>(Optional) A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent creation. This string is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateBackupInput::tags): <p>(Optional) The tags to apply to the backup at backup creation. The key value of the <code>Name</code> tag appears in the console as the backup name. If you have set <code>CopyTagsToBackups</code> to <code>true</code>, and you specify one or more tags using the <code>CreateBackup</code> operation, no existing file system tags are copied from the file system to the backup.</p>
    ///   - [`volume_id(Option<String>)`](crate::input::CreateBackupInput::volume_id): <p>(Optional) The ID of the FSx for ONTAP volume to back up.</p>
    ...
    ///
    /// - Takes [`CreateDataRepositoryTaskInput`](crate::input::CreateDataRepositoryTaskInput) with field(s):
    ///   - [`r#type(Option<DataRepositoryTaskType>)`](crate::input::CreateDataRepositoryTaskInput::r#type): <p>Specifies the type of data repository task to create.</p>
    ///   - [`paths(Option<Vec<String>>)`](crate::input::CreateDataRepositoryTaskInput::paths): <p>(Optional) The path or paths on the Amazon FSx file system to use when the data repository task is processed. The default path is the file system root directory. The paths you provide need to be relative to the mount point of the file system. If the mount point is <code>/mnt/fsx</code> and <code>/mnt/fsx/path1</code> is a directory or file on the file system you want to export, then the path to provide is <code>path1</code>. If a path that you provide isn't valid, the task fails.</p>
    ///   - [`file_system_id(Option<String>)`](crate::input::CreateDataRepositoryTaskInput::file_system_id): <p>The globally unique ID of the file system, assigned by Amazon FSx.</p>
    ///   - [`report(Option<CompletionReport>)`](crate::input::CreateDataRepositoryTaskInput::report): <p>Defines whether or not Amazon FSx provides a CompletionReport once the task has completed. A CompletionReport provides a detailed report on the files that Amazon FSx processed that meet the criteria specified by the <code>Scope</code> parameter. For more information, see <a href="https://docs.aws.amazon.com/fsx/latest/LustreGuide/task-completion-report.html">Working with Task Completion Reports</a>.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateDataRepositoryTaskInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateDataRepositoryTaskInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ...
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateSnapshotInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateSnapshotInput::name): <p>The name of the snapshot. </p>
    ///   - [`volume_id(Option<String>)`](crate::input::CreateSnapshotInput::volume_id): <p>The ID of the volume that you are taking a snapshot of.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateSnapshotInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ...
    ///
    /// - Takes [`CreateStorageVirtualMachineInput`](crate::input::CreateStorageVirtualMachineInput) with field(s):
    ///   - [`active_directory_configuration(Option<CreateSvmActiveDirectoryConfiguration>)`](crate::input::CreateStorageVirtualMachineInput::active_directory_configuration): <p>Describes the self-managed Microsoft Active Directory to which you want to join the SVM. Joining an Active Directory provides user authentication and access control for SMB clients, including Microsoft Windows and macOS client accessing the file system.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateStorageVirtualMachineInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`file_system_id(Option<String>)`](crate::input::CreateStorageVirtualMachineInput::file_system_id): <p>The globally unique ID of the file system, assigned by Amazon FSx.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateStorageVirtualMachineInput::name): <p>The name of the SVM.</p>
    ///   - [`svm_admin_password(Option<String>)`](crate::input::CreateStorageVirtualMachineInput::svm_admin_password): <p>The password to use when managing the SVM using the NetApp ONTAP CLI or REST API. If you do not specify a password, you can still use the file system's <code>fsxadmin</code> user to manage the SVM.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateStorageVirtualMachineInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ///   - [`root_volume_security_style(Option<StorageVirtualMachineRootVolumeSecurityStyle>)`](crate::input::CreateStorageVirtualMachineInput::root_volume_security_style): <p>The security style of the root volume of the SVM. Specify one of the following values:</p>  <ul>   <li> <p> <code>UNIX</code> if the file system is managed by a UNIX administrator, the majority of users are NFS clients, and an application accessing the data uses a UNIX user as the service account.</p> </li>   <li> <p> <code>NTFS</code> if the file system is managed by a Windows administrator, the majority of users are SMB clients, and an application accessing the data uses a Windows user as the service account.</p> </li>   <li> <p> <code>MIXED</code> if the file system is managed by both UNIX and Windows administrators and users consist of both NFS and SMB clients.</p> </li>  </ul>
    ...
    ///
    /// - Takes [`CreateVolumeInput`](crate::input::CreateVolumeInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateVolumeInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`volume_type(Option<VolumeType>)`](crate::input::CreateVolumeInput::volume_type): <p>Specifies the type of volume to create; <code>ONTAP</code> and <code>OPENZFS</code> are the only valid volume types.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateVolumeInput::name): <p>Specifies the name of the volume that you're creating.</p>
    ///   - [`ontap_configuration(Option<CreateOntapVolumeConfiguration>)`](crate::input::CreateVolumeInput::ontap_configuration): <p>Specifies the configuration to use when creating the ONTAP volume.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateVolumeInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ///   - [`open_zfs_configuration(Option<CreateOpenZfsVolumeConfiguration>)`](crate::input::CreateVolumeInput::open_zfs_configuration): <p>Specifies the configuration to use when creating the OpenZFS volume.</p>
    ...
    ///
    /// - Takes [`CreateVolumeFromBackupInput`](crate::input::CreateVolumeFromBackupInput) with field(s):
    ///   - [`backup_id(Option<String>)`](crate::input::CreateVolumeFromBackupInput::backup_id): <p>The ID of the source backup. Specifies the backup that you are copying.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::CreateVolumeFromBackupInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`name(Option<String>)`](crate::input::CreateVolumeFromBackupInput::name): <p>The name of the new volume you're creating.</p>
    ///   - [`ontap_configuration(Option<CreateOntapVolumeConfiguration>)`](crate::input::CreateVolumeFromBackupInput::ontap_configuration): <p>Specifies the configuration of the ONTAP volume that you are creating.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateVolumeFromBackupInput::tags): <p>A list of <code>Tag</code> values, with a maximum of 50 elements.</p>
    ...
    ///   - [`backup_id(Option<String>)`](crate::input::DeleteBackupInput::backup_id): <p>The ID of the backup that you want to delete.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteBackupInput::client_request_token): <p>A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent deletion. This parameter is automatically filled on your behalf when using the CLI or SDK.</p>
    ...
    ///
    /// - Takes [`DeleteDataRepositoryAssociationInput`](crate::input::DeleteDataRepositoryAssociationInput) with field(s):
    ///   - [`association_id(Option<String>)`](crate::input::DeleteDataRepositoryAssociationInput::association_id): <p>The ID of the data repository association that you want to delete.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteDataRepositoryAssociationInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`delete_data_in_file_system(Option<bool>)`](crate::input::DeleteDataRepositoryAssociationInput::delete_data_in_file_system): <p>Set to <code>true</code> to delete the data in the file system that corresponds to the data repository association.</p>
    ...
    ///   - [`file_system_id(Option<String>)`](crate::input::DeleteFileSystemInput::file_system_id): <p>The ID of the file system that you want to delete.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteFileSystemInput::client_request_token): <p>A string of up to 64 ASCII characters that Amazon FSx uses to ensure idempotent deletion. This token is automatically filled on your behalf when using the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`windows_configuration(Option<DeleteFileSystemWindowsConfiguration>)`](crate::input::DeleteFileSystemInput::windows_configuration): <p>The configuration object for the Microsoft Windows file system used in the <code>DeleteFileSystem</code> operation.</p>
    ///   - [`lustre_configuration(Option<DeleteFileSystemLustreConfiguration>)`](crate::input::DeleteFileSystemInput::lustre_configuration): <p>The configuration object for the Amazon FSx for Lustre file system being deleted in the <code>DeleteFileSystem</code> operation.</p>
    ///   - [`open_zfs_configuration(Option<DeleteFileSystemOpenZfsConfiguration>)`](crate::input::DeleteFileSystemInput::open_zfs_configuration): <p>The configuration object for the OpenZFS file system used in the <code>DeleteFileSystem</code> operation.</p>
    ...
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteSnapshotInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`snapshot_id(Option<String>)`](crate::input::DeleteSnapshotInput::snapshot_id): <p>The ID of the snapshot that you want to delete.</p>
    ...
    ///
    /// - Takes [`DeleteStorageVirtualMachineInput`](crate::input::DeleteStorageVirtualMachineInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteStorageVirtualMachineInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`storage_virtual_machine_id(Option<String>)`](crate::input::DeleteStorageVirtualMachineInput::storage_virtual_machine_id): <p>The ID of the SVM that you want to delete.</p>
    ...
    ///   - [`client_request_token(Option<String>)`](crate::input::DeleteVolumeInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`volume_id(Option<String>)`](crate::input::DeleteVolumeInput::volume_id): <p>The ID of the volume that you are deleting.</p>
    ///   - [`ontap_configuration(Option<DeleteVolumeOntapConfiguration>)`](crate::input::DeleteVolumeInput::ontap_configuration): <p>For Amazon FSx for ONTAP volumes, specify whether to take a final backup of the volume and apply tags to the backup. To apply tags to the backup, you must have the <code>fsx:TagResource</code> permission.</p>
    ///   - [`open_zfs_configuration(Option<DeleteVolumeOpenZfsConfiguration>)`](crate::input::DeleteVolumeInput::open_zfs_configuration): <p>For Amazon FSx for OpenZFS volumes, specify whether to delete all child volumes and snapshots.</p>
    ...
    ///   - [`backup_ids(Option<Vec<String>>)`](crate::input::DescribeBackupsInput::backup_ids): <p>The IDs of the backups that you want to retrieve. This parameter value overrides any filters. If any IDs aren't found, a <code>BackupNotFound</code> error occurs.</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::DescribeBackupsInput::filters): <p>The filters structure. The supported names are <code>file-system-id</code>, <code>backup-type</code>, <code>file-system-type</code>, and <code>volume-id</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeBackupsInput::max_results): <p>Maximum number of backups to return in the response. This parameter value must be greater than 0. The number of items that Amazon FSx returns is the minimum of the <code>MaxResults</code> parameter specified in the request and the service's internal maximum number of items per page.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeBackupsInput::next_token): <p>An opaque pagination token returned from a previous <code>DescribeBackups</code> operation. If a token is present, the operation continues the list from where the returning call left off.</p>
    ...
    ///
    /// - Takes [`DescribeDataRepositoryAssociationsInput`](crate::input::DescribeDataRepositoryAssociationsInput) with field(s):
    ///   - [`association_ids(Option<Vec<String>>)`](crate::input::DescribeDataRepositoryAssociationsInput::association_ids): <p>IDs of the data repository associations whose descriptions you want to retrieve (String).</p>
    ///   - [`filters(Option<Vec<Filter>>)`](crate::input::DescribeDataRepositoryAssociationsInput::filters): <p>A list of <code>Filter</code> elements.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeDataRepositoryAssociationsInput::max_results): <p>The maximum number of resources to return in the response. This value must be an integer greater than zero.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeDataRepositoryAssociationsInput::next_token): <p>(Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous <code>NextToken</code> value left off.</p>
    ...
    ///
    /// - Takes [`DescribeDataRepositoryTasksInput`](crate::input::DescribeDataRepositoryTasksInput) with field(s):
    ///   - [`task_ids(Option<Vec<String>>)`](crate::input::DescribeDataRepositoryTasksInput::task_ids): <p>(Optional) IDs of the tasks whose descriptions you want to retrieve (String).</p>
    ///   - [`filters(Option<Vec<DataRepositoryTaskFilter>>)`](crate::input::DescribeDataRepositoryTasksInput::filters): <p>(Optional) You can use filters to narrow the <code>DescribeDataRepositoryTasks</code> response to include just tasks for specific file systems, or tasks in a specific lifecycle state.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeDataRepositoryTasksInput::max_results): <p>The maximum number of resources to return in the response. This value must be an integer greater than zero.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeDataRepositoryTasksInput::next_token): <p>(Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous <code>NextToken</code> value left off.</p>
    ...
    ///
    /// - Takes [`DescribeFileSystemAliasesInput`](crate::input::DescribeFileSystemAliasesInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::DescribeFileSystemAliasesInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`file_system_id(Option<String>)`](crate::input::DescribeFileSystemAliasesInput::file_system_id): <p>The ID of the file system to return the associated DNS aliases for (String).</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeFileSystemAliasesInput::max_results): <p>Maximum number of DNS aliases to return in the response (integer). This parameter value must be greater than 0. The number of items that Amazon FSx returns is the minimum of the <code>MaxResults</code> parameter specified in the request and the service's internal maximum number of items per page.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeFileSystemAliasesInput::next_token): <p>Opaque pagination token returned from a previous <code>DescribeFileSystemAliases</code> operation (String). If a token is included in the request, the action continues the list from where the previous returning call left off.</p>
    ...
    ///   - [`file_system_ids(Option<Vec<String>>)`](crate::input::DescribeFileSystemsInput::file_system_ids): <p>IDs of the file systems whose descriptions you want to retrieve (String).</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeFileSystemsInput::max_results): <p>Maximum number of file systems to return in the response (integer). This parameter value must be greater than 0. The number of items that Amazon FSx returns is the minimum of the <code>MaxResults</code> parameter specified in the request and the service's internal maximum number of items per page.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeFileSystemsInput::next_token): <p>Opaque pagination token returned from a previous <code>DescribeFileSystems</code> operation (String). If a token present, the operation continues the list from where the returning call left off.</p>
    ...
    ///   - [`snapshot_ids(Option<Vec<String>>)`](crate::input::DescribeSnapshotsInput::snapshot_ids): <p>The IDs of the snapshots that you want to retrieve. This parameter value overrides any filters. If any IDs aren't found, a <code>SnapshotNotFound</code> error occurs.</p>
    ///   - [`filters(Option<Vec<SnapshotFilter>>)`](crate::input::DescribeSnapshotsInput::filters): <p>The filters structure. The supported names are <code>file-system-id</code> or <code>volume-id</code>.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeSnapshotsInput::max_results): <p>The maximum number of resources to return in the response. This value must be an integer greater than zero.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeSnapshotsInput::next_token): <p>(Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous <code>NextToken</code> value left off.</p>
    ...
    ///
    /// - Takes [`DescribeStorageVirtualMachinesInput`](crate::input::DescribeStorageVirtualMachinesInput) with field(s):
    ///   - [`storage_virtual_machine_ids(Option<Vec<String>>)`](crate::input::DescribeStorageVirtualMachinesInput::storage_virtual_machine_ids): <p>Enter the ID of one or more SVMs that you want to view.</p>
    ///   - [`filters(Option<Vec<StorageVirtualMachineFilter>>)`](crate::input::DescribeStorageVirtualMachinesInput::filters): <p>Enter a filter name:value pair to view a select set of SVMs.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeStorageVirtualMachinesInput::max_results): <p>The maximum number of resources to return in the response. This value must be an integer greater than zero.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeStorageVirtualMachinesInput::next_token): <p>(Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous <code>NextToken</code> value left off.</p>
    ...
    ///   - [`volume_ids(Option<Vec<String>>)`](crate::input::DescribeVolumesInput::volume_ids): <p>The IDs of the volumes whose descriptions you want to retrieve.</p>
    ///   - [`filters(Option<Vec<VolumeFilter>>)`](crate::input::DescribeVolumesInput::filters): <p>Enter a filter <code>Name</code> and <code>Values</code> pair to view a select set of volumes.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::DescribeVolumesInput::max_results): <p>The maximum number of resources to return in the response. This value must be an integer greater than zero.</p>
    ///   - [`next_token(Option<String>)`](crate::input::DescribeVolumesInput::next_token): <p>(Optional) Opaque pagination token returned from a previous operation (String). If present, this token indicates from what point you can continue processing the request, where the previous <code>NextToken</code> value left off.</p>
    ...
    ///
    /// - Takes [`DisassociateFileSystemAliasesInput`](crate::input::DisassociateFileSystemAliasesInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::DisassociateFileSystemAliasesInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`file_system_id(Option<String>)`](crate::input::DisassociateFileSystemAliasesInput::file_system_id): <p>Specifies the file system from which to disassociate the DNS aliases.</p>
    ///   - [`aliases(Option<Vec<String>>)`](crate::input::DisassociateFileSystemAliasesInput::aliases): <p>An array of one or more DNS alias names to disassociate, or remove, from the file system.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p>The ARN of the Amazon FSx resource that will have its tags listed.</p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListTagsForResourceInput::max_results): <p>Maximum number of tags to return in the response (integer). This parameter value must be greater than 0. The number of items that Amazon FSx returns is the minimum of the <code>MaxResults</code> parameter specified in the request and the service's internal maximum number of items per page.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTagsForResourceInput::next_token): <p>Opaque pagination token returned from a previous <code>ListTagsForResource</code> operation (String). If a token present, the action continues the list from where the returning call left off.</p>
    ...
    ///
    /// - Takes [`ReleaseFileSystemNfsV3LocksInput`](crate::input::ReleaseFileSystemNfsV3LocksInput) with field(s):
    ///   - [`file_system_id(Option<String>)`](crate::input::ReleaseFileSystemNfsV3LocksInput::file_system_id): <p>The globally unique ID of the file system, assigned by Amazon FSx.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::ReleaseFileSystemNfsV3LocksInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ...
    ///
    /// - Takes [`RestoreVolumeFromSnapshotInput`](crate::input::RestoreVolumeFromSnapshotInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::RestoreVolumeFromSnapshotInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`volume_id(Option<String>)`](crate::input::RestoreVolumeFromSnapshotInput::volume_id): <p>The ID of the volume that you are restoring.</p>
    ///   - [`snapshot_id(Option<String>)`](crate::input::RestoreVolumeFromSnapshotInput::snapshot_id): <p>The ID of the source snapshot. Specifies the snapshot that you are restoring from.</p>
    ///   - [`options(Option<Vec<RestoreOpenZfsVolumeOption>>)`](crate::input::RestoreVolumeFromSnapshotInput::options): <p>The settings used when restoring the specified volume from snapshot. </p>  <ul>   <li> <p> <code>DELETE_INTERMEDIATE_SNAPSHOTS</code> - Deletes snapshots between the current state and the specified snapshot. If there are intermediate snapshots and this option isn't used, <code>RestoreVolumeFromSnapshot</code> fails.</p> </li>   <li> <p> <code>DELETE_CLONED_VOLUMES</code> - Deletes any volumes cloned from this volume. If there are any cloned volumes and this option isn't used, <code>RestoreVolumeFromSnapshot</code> fails.</p> </li>  </ul>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p>The Amazon Resource Name (ARN) of the Amazon FSx resource that you want to tag.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p>A list of tags for the resource. If a tag with a given key already exists, the value is replaced by the one specified in this parameter.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p>The ARN of the Amazon FSx resource to untag.</p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p>A list of keys of tags on the resource to untag. In case the tag key doesn't exist, the call will still succeed to be idempotent.</p>
    ...
    ///
    /// - Takes [`UpdateDataRepositoryAssociationInput`](crate::input::UpdateDataRepositoryAssociationInput) with field(s):
    ///   - [`association_id(Option<String>)`](crate::input::UpdateDataRepositoryAssociationInput::association_id): <p>The ID of the data repository association that you are updating.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::UpdateDataRepositoryAssociationInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`imported_file_chunk_size(Option<i32>)`](crate::input::UpdateDataRepositoryAssociationInput::imported_file_chunk_size): <p>For files imported from a data repository, this value determines the stripe count and maximum amount of data per file (in MiB) stored on a single physical disk. The maximum number of disks that a single file can be striped across is limited by the total number of disks that make up the file system.</p>  <p>The default chunk size is 1,024 MiB (1 GiB) and can go as high as 512,000 MiB (500 GiB). Amazon S3 objects have a maximum size of 5 TB.</p>
    ///   - [`s3(Option<S3DataRepositoryConfiguration>)`](crate::input::UpdateDataRepositoryAssociationInput::s3): <p>The configuration for an Amazon S3 data repository linked to an Amazon FSx Lustre file system with a data repository association. The configuration defines which file events (new, changed, or deleted files or directories) are automatically imported from the linked data repository to the file system or automatically exported from the file system to the data repository.</p>
    ...
    ///
    /// - Takes [`UpdateSnapshotInput`](crate::input::UpdateSnapshotInput) with field(s):
    ///   - [`client_request_token(Option<String>)`](crate::input::UpdateSnapshotInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`name(Option<String>)`](crate::input::UpdateSnapshotInput::name): <p>The name of the snapshot to update. </p>
    ///   - [`snapshot_id(Option<String>)`](crate::input::UpdateSnapshotInput::snapshot_id): <p>The ID of the snapshot that you want to update, in the format <code>fsvolsnap-0123456789abcdef0</code>.</p>
    ...
    ///
    /// - Takes [`UpdateStorageVirtualMachineInput`](crate::input::UpdateStorageVirtualMachineInput) with field(s):
    ///   - [`active_directory_configuration(Option<UpdateSvmActiveDirectoryConfiguration>)`](crate::input::UpdateStorageVirtualMachineInput::active_directory_configuration): <p>Updates the Microsoft Active Directory (AD) configuration for an SVM that is joined to an AD.</p>
    ///   - [`client_request_token(Option<String>)`](crate::input::UpdateStorageVirtualMachineInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`storage_virtual_machine_id(Option<String>)`](crate::input::UpdateStorageVirtualMachineInput::storage_virtual_machine_id): <p>The ID of the SVM that you want to update, in the format <code>svm-0123456789abcdef0</code>.</p>
    ///   - [`svm_admin_password(Option<String>)`](crate::input::UpdateStorageVirtualMachineInput::svm_admin_password): <p>Enter a new SvmAdminPassword if you are updating it.</p>
    ...
    ///   - [`client_request_token(Option<String>)`](crate::input::UpdateVolumeInput::client_request_token): <p>(Optional) An idempotency token for resource creation, in a string of up to 64 ASCII characters. This token is automatically filled on your behalf when you use the Command Line Interface (CLI) or an Amazon Web Services SDK.</p>
    ///   - [`volume_id(Option<String>)`](crate::input::UpdateVolumeInput::volume_id): <p>The ID of the volume that you want to update, in the format <code>fsvol-0123456789abcdef0</code>.</p>
    ///   - [`ontap_configuration(Option<UpdateOntapVolumeConfiguration>)`](crate::input::UpdateVolumeInput::ontap_configuration): <p>The configuration of the ONTAP volume that you are updating.</p>
    ///   - [`name(Option<String>)`](crate::input::UpdateVolumeInput::name): <p>The name of the OpenZFS volume. OpenZFS root volumes are automatically named <code>FSX</code>. Child volume names must be unique among their parent volume's children. The name of the volume is part of the mount string for the OpenZFS volume. </p>
    ///   - [`open_zfs_configuration(Option<UpdateOpenZfsVolumeConfiguration>)`](crate::input::UpdateVolumeInput::open_zfs_configuration): <p>The configuration of the OpenZFS volume that you are updating.</p>
...
pub mod fluent_builders {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::DescribeDataRepositoryAssociationsPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::DescribeDataRepositoryTasksPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(
            self,
        ) -> crate::paginator::DescribeStorageVirtualMachinesPaginator<C, M, R> {
        ...
        R: aws_smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn into_paginator(self) -> crate::paginator::DescribeVolumesPaginator<C, M, R> {
