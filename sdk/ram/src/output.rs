...
pub struct UpdateResourceShareOutput  {
    ...
    #[doc(hidden)]pub resource_share: std::option::Option<crate::model::ResourceShare>,
...
pub struct RejectResourceShareInvitationOutput  {
    ...
    #[doc(hidden)]pub resource_share_invitation: std::option::Option<crate::model::ResourceShareInvitation>,
    /// <p>The idempotency identifier associated with this request. If you want to repeat the same operation in an idempotent manner then you must include this value in the <code>clientToken</code> request parameter of that later call. All other parameters must also have the same values that you used in the first call.</p>
    #[doc(hidden)]pub client_token: std::option::Option<std::string::String>,
}
...
pub struct PromoteResourceShareCreatedFromPolicyOutput  {
    ...
    #[doc(hidden)]pub return_value: std::option::Option<bool>,
}
...
pub struct ListResourceTypesOutput  {
    ...
    #[doc(hidden)]pub resource_types: std::option::Option<std::vec::Vec<crate::model::ServiceNameAndResourceType>>,
...
pub struct ListResourceSharePermissionsOutput  {
    ...
    #[doc(hidden)]pub permissions: std::option::Option<std::vec::Vec<crate::model::ResourceSharePermissionSummary>>,
    /// <p>If present, this value indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>. This indicates that this is the last page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetResourceSharesOutput  {
    ...
    #[doc(hidden)]pub resource_shares: std::option::Option<std::vec::Vec<crate::model::ResourceShare>>,
    /// <p>If present, this value indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>. This indicates that this is the last page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetResourceShareInvitationsOutput  {
    ...
    #[doc(hidden)]pub resource_share_invitations: std::option::Option<std::vec::Vec<crate::model::ResourceShareInvitation>>,
    /// <p>If present, this value indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>. This indicates that this is the last page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetResourceShareInvitationsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("resource_share_invitations", &self.resource_share_invitations);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct GetResourceShareAssociationsOutput  {
    ...
    #[doc(hidden)]pub resource_share_associations: std::option::Option<std::vec::Vec<crate::model::ResourceShareAssociation>>,
    /// <p>If present, this value indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>. This indicates that this is the last page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetResourcePoliciesOutput  {
    ...
    #[doc(hidden)]pub policies: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>If present, this value indicates that more output is available than is included in the current response. Use this value in the <code>NextToken</code> request parameter in a subsequent call to the operation to get the next part of the output. You should repeat this until the <code>NextToken</code> response element comes back as <code>null</code>. This indicates that this is the last page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetPermissionOutput  {
    ...
    #[doc(hidden)]pub permission: std::option::Option<crate::model::ResourceSharePermissionDetail>,
}
