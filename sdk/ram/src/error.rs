...
impl aws_http::request_id::RequestId for crate::error::ResourceShareInvitationAlreadyRejectedException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_http::request_id::RequestId for crate::error::ResourceShareInvitationAlreadyAcceptedException {
    fn request_id(&self) -> Option<&str> {
        use aws_smithy_types::error::metadata::ProvideErrorMetadata;
        self.meta().request_id()
    }
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateResourceSharePermissionError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InvalidClientTokenException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata for AcceptResourceShareInvitationError {
    fn meta(&self) -> &aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::IdempotentParameterMismatchException(_inner) =>
            aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
