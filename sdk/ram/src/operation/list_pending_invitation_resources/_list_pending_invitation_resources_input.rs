...
impl ListPendingInvitationResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_pending_invitation_resources::ListPendingInvitationResourcesInput, ::aws_smithy_types::error::operation::BuildError> {
