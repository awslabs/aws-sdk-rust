...
impl ListReplacePermissionAssociationsWorkInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_replace_permission_associations_work::ListReplacePermissionAssociationsWorkInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
