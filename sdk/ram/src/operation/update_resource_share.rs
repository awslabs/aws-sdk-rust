...
impl UpdateResourceShareInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_resource_share::ser_update_resource_share_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_resource_share::UpdateResourceShare::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateResourceShare {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_resource_share::de_update_resource_share_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::update_resource_share::UpdateResourceShareError
{
