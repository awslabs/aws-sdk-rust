...
impl UpdateResourceShareInput {
    /// Consumes the builder and constructs an Operation<[`UpdateResourceShare`](crate::operation::update_resource_share::UpdateResourceShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_resource_share::UpdateResourceShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_resource_share::UpdateResourceShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_resource_share::ser_update_resource_share_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_resource_share::UpdateResourceShare::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateResourceShare {
                type Output = std::result::Result<crate::operation::update_resource_share::UpdateResourceShareOutput, crate::operation::update_resource_share::UpdateResourceShareError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_resource_share::de_update_resource_share_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_resource_share::de_update_resource_share_http_response(response)
                     }
                }
            }
