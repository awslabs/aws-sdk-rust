...
pub type PromotePermissionCreatedFromPolicyErrorKind = PromotePermissionCreatedFromPolicyError;
...
impl PromotePermissionCreatedFromPolicyError {
    ...
    /// Creates the `PromotePermissionCreatedFromPolicyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
