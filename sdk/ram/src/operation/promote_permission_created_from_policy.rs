...
impl PromotePermissionCreatedFromPolicyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PromotePermissionCreatedFromPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_promote_permission_created_from_policy::de_promote_permission_created_from_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
