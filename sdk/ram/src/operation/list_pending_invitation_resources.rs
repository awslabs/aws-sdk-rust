...
impl ListPendingInvitationResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_pending_invitation_resources::ListPendingInvitationResources,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_pending_invitation_resources::ListPendingInvitationResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPendingInvitationResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pending_invitation_resources::de_list_pending_invitation_resources_http_response_with_props(
                status, headers, body,
            )
        }
    }
