    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/getresourceshareinvitations")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceShareInvitations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_share_invitations::de_get_resource_share_invitations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetResourceShareInvitationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_resource_share_invitations::GetResourceShareInvitationsError
{
