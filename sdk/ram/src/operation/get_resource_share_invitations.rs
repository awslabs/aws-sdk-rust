...
impl GetResourceShareInvitationsInput {
    /// Consumes the builder and constructs an Operation<[`GetResourceShareInvitations`](crate::operation::get_resource_share_invitations::GetResourceShareInvitations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_resource_share_invitations::GetResourceShareInvitations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_share_invitations::GetResourceShareInvitationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_share_invitations::GetResourceShareInvitations::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourceShareInvitations {
                type Output = std::result::Result<crate::operation::get_resource_share_invitations::GetResourceShareInvitationsOutput, crate::operation::get_resource_share_invitations::GetResourceShareInvitationsError>;
