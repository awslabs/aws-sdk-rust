...
impl GetResourceShareInvitationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_share_invitations::GetResourceShareInvitations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceShareInvitations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_share_invitations::de_get_resource_share_invitations_http_response_with_props(
                status, headers, body,
            )
        }
    }
