...
impl EnableSharingWithAwsOrganizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_sharing_with_aws_organization::EnableSharingWithAwsOrganizationInput, ::aws_smithy_http::operation::error::BuildError>{
