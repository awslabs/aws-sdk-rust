    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/listpermissionversions")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_permission_versions::ListPermissionVersions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_permission_versions::ListPermissionVersionsError
{
