...
impl ListPermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_permissions::ListPermissions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_permissions::ser_list_permissions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_permissions::de_list_permissions_http_response_with_props(status, headers, body)
        }
    }
}
