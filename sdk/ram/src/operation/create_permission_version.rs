    ...
    > {
        ...
        let mut request = {
            ...
            ) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError>
            {
                ...
                write!(output, "/createpermissionversion").expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_permission_version::CreatePermissionVersion::new(),
        )
...
/// `ParseStrictResponse` impl for `CreatePermissionVersion`.
...
impl aws_http::request_id::RequestId
    for crate::operation::create_permission_version::CreatePermissionVersionError
{
...
impl std::error::Error for CreatePermissionVersionError {
    fn source(&self) -> std::option::Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            Self::PermissionVersionsLimitExceededException(_inner) => Some(_inner),
