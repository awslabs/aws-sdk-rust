...
/// Orchestration and serialization glue logic for `ListResourceSharePermissions`.
...
impl ListResourceSharePermissions {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourceSharePermissions {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListResourceSharePermissions");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListResourceSharePermissionsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListResourceSharePermissionsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourceSharePermissions")
...
.with_interceptor(ListResourceSharePermissionsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError>::new());
...
#[derive(Debug)]
            struct ListResourceSharePermissionsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourceSharePermissionsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_resource_share_permissions::de_list_resource_share_permissions_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_resource_share_permissions::de_list_resource_share_permissions_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListResourceSharePermissionsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourceSharePermissionsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_resource_share_permissions::ListResourceSharePermissionsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_resource_share_permissions::ListResourceSharePermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/listresourcesharepermissions").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_resource_share_permissions::ser_list_resource_share_permissions_input(&input)?);
...
#[derive(Debug)]
            struct ListResourceSharePermissionsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListResourceSharePermissionsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListResourceSharePermissionsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListResourceSharePermissionsInput>()
                        .ok_or("failed to downcast to ListResourceSharePermissionsInput")?;
...
pub enum ListResourceSharePermissionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListResourceSharePermissionsError) for what information is available for the error.")]
...
impl ListResourceSharePermissionsError {
    /// Creates the `ListResourceSharePermissionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListResourceSharePermissionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListResourceSharePermissionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError {
