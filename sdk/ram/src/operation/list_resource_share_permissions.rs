...
impl ListResourceSharePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_resource_share_permissions::ListResourceSharePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceSharePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resource_share_permissions::de_list_resource_share_permissions_http_response_with_props(
                status, headers, body,
            )
        }
    }
