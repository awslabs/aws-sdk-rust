    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/listresourcesharepermissions")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceSharePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_resource_share_permissions::de_list_resource_share_permissions_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListResourceSharePermissionsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_resource_share_permissions::ListResourceSharePermissionsError
{
