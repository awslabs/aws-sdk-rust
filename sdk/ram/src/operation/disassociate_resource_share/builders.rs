...
impl DisassociateResourceShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_resource_share::DisassociateResourceShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_resource_share::DisassociateResourceShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disassociate_resource_share::DisassociateResourceShareOutput, crate::operation::disassociate_resource_share::DisassociateResourceShareError, Self> {
