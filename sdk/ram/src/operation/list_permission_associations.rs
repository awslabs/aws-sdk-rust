    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_permission_associations::ListPermissionAssociationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_permission_associations::ListPermissionAssociationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListPermissionAssociations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListPermissionAssociations", "ram"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListPermissionAssociations")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListPermissionAssociationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListPermissionAssociationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_permission_associations::ListPermissionAssociationsInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListPermissionAssociationsEndpointParamsInterceptor {
...
pub type ListPermissionAssociationsErrorKind = ListPermissionAssociationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListPermissionAssociationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_permission_associations::ListPermissionAssociationsError {
...
impl ListPermissionAssociationsError {
    ...
    /// Creates the `ListPermissionAssociationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
