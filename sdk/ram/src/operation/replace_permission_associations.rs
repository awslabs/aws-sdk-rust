...
impl ReplacePermissionAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::replace_permission_associations::ReplacePermissionAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplacePermissionAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replace_permission_associations::de_replace_permission_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
