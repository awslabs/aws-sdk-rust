    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/replacepermissionassociations")
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplacePermissionAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_replace_permission_associations::de_replace_permission_associations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ReplacePermissionAssociationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::replace_permission_associations::ReplacePermissionAssociationsError
{
