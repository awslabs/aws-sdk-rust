...
impl AssociateResourceShareFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_resource_share::AssociateResourceShareOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_resource_share::AssociateResourceShareError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_resource_share::AssociateResourceShareOutput, crate::operation::associate_resource_share::AssociateResourceShareError, Self> {
