...
impl CreatePermissionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_permission::CreatePermission, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_permission::CreatePermissionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_permission::CreatePermission::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreatePermission", "ram"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreatePermission {
                type Output = std::result::Result<crate::operation::create_permission::CreatePermissionOutput, crate::operation::create_permission::CreatePermissionError>;
