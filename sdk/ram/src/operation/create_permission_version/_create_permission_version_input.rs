...
impl CreatePermissionVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_permission_version::CreatePermissionVersionInput, ::aws_smithy_types::error::operation::BuildError> {
