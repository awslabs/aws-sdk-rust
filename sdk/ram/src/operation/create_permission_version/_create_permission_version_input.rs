...
impl CreatePermissionVersionInputBuilder {
    ...
    pub fn policy_template(mut self, input: impl Into<std::string::String>) -> Self {
        self.policy_template = Some(input.into());
        self
    }
    /// <p>A string in JSON format string that contains the following elements of a resource-based policy:</p> 
    /// <ul> 
    ...
    pub fn build(self) -> Result<crate::operation::create_permission_version::CreatePermissionVersionInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
