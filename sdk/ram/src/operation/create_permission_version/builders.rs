...
impl CreatePermissionVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_permission_version::CreatePermissionVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_permission_version::CreatePermissionVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_permission_version::CreatePermissionVersionOutput, crate::operation::create_permission_version::CreatePermissionVersionError, Self> {
