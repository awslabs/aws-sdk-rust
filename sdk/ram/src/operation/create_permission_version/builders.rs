...
impl CreatePermissionVersionFluentBuilder  {
    ...
    /// Consume this builder, creating a customizable operation that can be modified before being
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::create_permission_version::CreatePermissionVersionOutput, aws_smithy_http::result::SdkError<crate::operation::create_permission_version::CreatePermissionVersionError>>
                     {
    ...
    pub fn policy_template(mut self, input: impl Into<std::string::String>) -> Self {
