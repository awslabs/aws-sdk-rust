    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetDefaultPermissionVersion {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("SetDefaultPermissionVersion", "ram"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetDefaultPermissionVersion")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SetDefaultPermissionVersionResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SetDefaultPermissionVersionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetDefaultPermissionVersionEndpointParamsInterceptor {
...
pub type SetDefaultPermissionVersionErrorKind = SetDefaultPermissionVersionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for SetDefaultPermissionVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::set_default_permission_version::SetDefaultPermissionVersionError {
...
impl SetDefaultPermissionVersionError {
    ...
    /// Creates the `SetDefaultPermissionVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
