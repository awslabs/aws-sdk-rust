...
impl SetDefaultPermissionVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_default_permission_version::SetDefaultPermissionVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetDefaultPermissionVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_default_permission_version::de_set_default_permission_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
