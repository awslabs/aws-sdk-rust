...
/// Orchestration and serialization glue logic for `SetDefaultPermissionVersion`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct SetDefaultPermissionVersion;
impl SetDefaultPermissionVersion {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::set_default_permission_version::SetDefaultPermissionVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetDefaultPermissionVersion {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetDefaultPermissionVersion");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetDefaultPermissionVersionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetDefaultPermissionVersionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetDefaultPermissionVersion")
...
.with_interceptor(SetDefaultPermissionVersionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError>::new());
...
#[derive(Debug)]
            struct SetDefaultPermissionVersionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetDefaultPermissionVersionResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_default_permission_version::de_set_default_permission_version_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_default_permission_version::de_set_default_permission_version_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetDefaultPermissionVersionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetDefaultPermissionVersionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_default_permission_version::SetDefaultPermissionVersionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_default_permission_version::SetDefaultPermissionVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/setdefaultpermissionversion").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_default_permission_version::ser_set_default_permission_version_input(&input)?);
...
#[derive(Debug)]
            struct SetDefaultPermissionVersionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetDefaultPermissionVersionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetDefaultPermissionVersionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetDefaultPermissionVersionInput>()
                        .ok_or("failed to downcast to SetDefaultPermissionVersionInput")?;
...
/// Error type for the `SetDefaultPermissionVersionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum SetDefaultPermissionVersionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetDefaultPermissionVersionError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl SetDefaultPermissionVersionError {
    /// Creates the `SetDefaultPermissionVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetDefaultPermissionVersionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::InvalidClientTokenException`.
    pub fn is_invalid_client_token_exception(&self) -> bool {
        matches!(self, Self::InvalidClientTokenException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::MalformedArnException`.
    pub fn is_malformed_arn_exception(&self) -> bool {
        matches!(self, Self::MalformedArnException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::ServerInternalException`.
    pub fn is_server_internal_exception(&self) -> bool {
        matches!(self, Self::ServerInternalException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `SetDefaultPermissionVersionError::UnknownResourceException`.
    pub fn is_unknown_resource_exception(&self) -> bool {
        matches!(self, Self::UnknownResourceException(_))
    }
}
impl ::std::error::Error for SetDefaultPermissionVersionError {
...
impl ::std::fmt::Display for SetDefaultPermissionVersionError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for SetDefaultPermissionVersionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SetDefaultPermissionVersionError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetDefaultPermissionVersionError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_default_permission_version::SetDefaultPermissionVersionError {
...
mod _set_default_permission_version_output;
