...
impl ReplacePermissionAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::replace_permission_associations::ReplacePermissionAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
