...
impl ListPrincipalsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_principals::ListPrincipals, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_principals::ListPrincipalsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for ListPrincipals {
                type Output = std::result::Result<crate::operation::list_principals::ListPrincipalsOutput, crate::operation::list_principals::ListPrincipalsError>;
