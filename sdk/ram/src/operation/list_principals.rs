...
impl ListPrincipalsInput {
    /// Consumes the builder and constructs an Operation<[`ListPrincipals`](crate::operation::list_principals::ListPrincipals)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_principals::ListPrincipals, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_principals::ser_list_principals_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_principals::ListPrincipals::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPrincipals {
    type Output =
        ::std::result::Result<crate::operation::list_principals::ListPrincipalsOutput, crate::operation::list_principals::ListPrincipalsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_principals::de_list_principals_http_response_with_props(status, headers, body)
        }
    }
}
