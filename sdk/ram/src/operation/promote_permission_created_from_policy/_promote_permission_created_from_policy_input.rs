...
impl PromotePermissionCreatedFromPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
