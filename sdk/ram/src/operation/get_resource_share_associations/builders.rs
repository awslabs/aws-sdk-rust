...
///
/// <p>Retrieves the lists of resources and principals that associated for resource shares that you own.</p><note>
...
impl GetResourceShareAssociationsFluentBuilder {
    /// Creates a new `GetResourceShareAssociationsFluentBuilder`.
