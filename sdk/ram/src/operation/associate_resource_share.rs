    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/associateresourceshare")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_resource_share::AssociateResourceShare::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::associate_resource_share::AssociateResourceShareError
{
