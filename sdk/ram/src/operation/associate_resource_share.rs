...
impl AssociateResourceShareInput {
    /// Consumes the builder and constructs an Operation<[`AssociateResourceShare`](crate::operation::associate_resource_share::AssociateResourceShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::associate_resource_share::AssociateResourceShare, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_resource_share::AssociateResourceShareInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::associate_resource_share::AssociateResourceShare::new())
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateResourceShare {
                type Output = std::result::Result<crate::operation::associate_resource_share::AssociateResourceShareOutput, crate::operation::associate_resource_share::AssociateResourceShareError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_associate_resource_share::de_associate_resource_share_http_error(response)
                     } else {
                        crate::protocol_serde::shape_associate_resource_share::de_associate_resource_share_http_response(response)
                     }
                }
            }
