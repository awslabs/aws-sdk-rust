...
impl DeleteResourceShareInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_resource_share::DeleteResourceShare::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResourceShare {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_resource_share::de_delete_resource_share_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_resource_share::DeleteResourceShareError
{
