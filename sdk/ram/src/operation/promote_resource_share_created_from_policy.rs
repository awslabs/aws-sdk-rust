...
impl PromoteResourceShareCreatedFromPolicy {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::promote_resource_share_created_from_policy::PromoteResourceShareCreatedFromPolicyError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::promote_resource_share_created_from_policy::PromoteResourceShareCreatedFromPolicyOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "RAM",
            "rpc.method" = "PromoteResourceShareCreatedFromPolicy",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PromoteResourceShareCreatedFromPolicy {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PromoteResourceShareCreatedFromPolicyRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PromoteResourceShareCreatedFromPolicyResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PromoteResourceShareCreatedFromPolicy")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PromoteResourceShareCreatedFromPolicy")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PromoteResourceShareCreatedFromPolicyTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PromoteResourceShareCreatedFromPolicyTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PromoteResourceShareCreatedFromPolicyTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PromoteResourceShareCreatedFromPolicyInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PromoteResourceShareCreatedFromPolicyResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_promote_resource_share_created_from_policy::de_promote_resource_share_created_from_policy_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_promote_resource_share_created_from_policy::de_promote_resource_share_created_from_policy_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PromoteResourceShareCreatedFromPolicyRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::promote_resource_share_created_from_policy::PromoteResourceShareCreatedFromPolicyInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::promote_resource_share_created_from_policy::PromoteResourceShareCreatedFromPolicyInput,
...
impl ::std::error::Error for PromoteResourceShareCreatedFromPolicyError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::UnmatchedPolicyPermissionException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for PromoteResourceShareCreatedFromPolicyError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::UnmatchedPolicyPermissionException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PromoteResourceShareCreatedFromPolicyError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::UnmatchedPolicyPermissionException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
