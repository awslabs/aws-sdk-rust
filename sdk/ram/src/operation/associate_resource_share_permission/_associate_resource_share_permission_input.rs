...
impl AssociateResourceSharePermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_resource_share_permission::AssociateResourceSharePermissionInput, ::aws_smithy_types::error::operation::BuildError> {
