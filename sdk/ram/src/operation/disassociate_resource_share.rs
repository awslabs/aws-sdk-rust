...
impl DisassociateResourceShare {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_resource_share::DisassociateResourceShareError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_resource_share::DisassociateResourceShareOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RAM", "DisassociateResourceShare", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RAM.DisassociateResourceShare",
                "rpc.service" = "RAM",
                "rpc.method" = "DisassociateResourceShare",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateResourceShare {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateResourceShareRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateResourceShareResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateResourceShare")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateResourceShare")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisassociateResourceShareTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisassociateResourceShareTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateResourceShareTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociateResourceShareInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateResourceShareResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_resource_share::de_disassociate_resource_share_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_disassociate_resource_share::de_disassociate_resource_share_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateResourceShareRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_resource_share::DisassociateResourceShareInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disassociate_resource_share::DisassociateResourceShareInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_resource_share::ser_disassociate_resource_share_input(&input)?,
        );
