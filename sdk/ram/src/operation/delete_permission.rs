...
impl DeletePermissionInput {
    /// Consumes the builder and constructs an Operation<[`DeletePermission`](crate::operation::delete_permission::DeletePermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_permission::DeletePermission, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_permission::DeletePermissionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/deletepermission").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_permission::DeletePermissionInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_permission::DeletePermission::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeletePermission", "ram"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePermission {
                type Output = std::result::Result<crate::operation::delete_permission::DeletePermissionOutput, crate::operation::delete_permission::DeletePermissionError>;
