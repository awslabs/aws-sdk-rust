...
impl GetResourceSharesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_resource_shares::ser_get_resource_shares_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceShares {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_shares::de_get_resource_shares_http_response_with_props(status, headers, body)
        }
    }
}
