...
impl crate::operation::list_principals::builders::ListPrincipalsInputBuilder {
...
///
/// <p>Lists the principals that you are sharing resources with or that are sharing resources with you.</p><note>
...
impl ListPrincipalsFluentBuilder {
    /// Creates a new `ListPrincipalsFluentBuilder`.
