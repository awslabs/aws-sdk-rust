    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_sharing_with_aws_organization::EnableSharingWithAwsOrganization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/enablesharingwithawsorganization")
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableSharingWithAwsOrganization {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_sharing_with_aws_organization::de_enable_sharing_with_aws_organization_http_response_with_props(status, headers, body)
        }
    }
}
