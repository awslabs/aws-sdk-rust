...
impl GetPermissionInput {
    /// Consumes the builder and constructs an Operation<[`GetPermission`](crate::operation::get_permission::GetPermission)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_permission::GetPermission, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_permission::ser_get_permission_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_permission::GetPermission::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPermission {
    type Output = ::std::result::Result<crate::operation::get_permission::GetPermissionOutput, crate::operation::get_permission::GetPermissionError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_permission::de_get_permission_http_response_with_props(status, headers, body)
        }
    }
}
