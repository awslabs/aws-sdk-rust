...
impl DisassociateResourceSharePermission {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_resource_share_permission::DisassociateResourceSharePermissionError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_resource_share_permission::DisassociateResourceSharePermissionOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "RAM",
            "rpc.method" = "DisassociateResourceSharePermission",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateResourceSharePermission {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociateResourceSharePermissionRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociateResourceSharePermissionResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociateResourceSharePermission")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateResourceSharePermission")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisassociateResourceSharePermissionTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisassociateResourceSharePermissionTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateResourceSharePermissionTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociateResourceSharePermissionInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateResourceSharePermissionResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_resource_share_permission::de_disassociate_resource_share_permission_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_disassociate_resource_share_permission::de_disassociate_resource_share_permission_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateResourceSharePermissionRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_resource_share_permission::DisassociateResourceSharePermissionInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disassociate_resource_share_permission::DisassociateResourceSharePermissionInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_resource_share_permission::ser_disassociate_resource_share_permission_input(&input)?,
        );
