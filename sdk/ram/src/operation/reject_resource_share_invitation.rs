...
impl RejectResourceShareInvitation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RAM", "RejectResourceShareInvitation", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RAM.RejectResourceShareInvitation",
                "rpc.service" = "RAM",
                "rpc.method" = "RejectResourceShareInvitation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RejectResourceShareInvitation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RejectResourceShareInvitationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RejectResourceShareInvitationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RejectResourceShareInvitation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RejectResourceShareInvitation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RejectResourceShareInvitationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RejectResourceShareInvitationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RejectResourceShareInvitationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RejectResourceShareInvitationInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("resourceShareInvitationArn") {
            if let ::std::option::Option::Some(value) = input.resource_share_invitation_arn.as_deref() {
                captured.insert("resourceShareInvitationArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RejectResourceShareInvitationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_reject_resource_share_invitation::de_reject_resource_share_invitation_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_reject_resource_share_invitation::de_reject_resource_share_invitation_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RejectResourceShareInvitationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_reject_resource_share_invitation::ser_reject_resource_share_invitation_input(&input)?,
        );
