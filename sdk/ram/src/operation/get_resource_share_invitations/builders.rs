...
pub use crate::operation::get_resource_share_invitations::_get_resource_share_invitations_output::GetResourceShareInvitationsOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_resource_share_invitations::GetResourceShareInvitationsOutput,
                    crate::operation::get_resource_share_invitations::GetResourceShareInvitationsError,
                > for GetResourceShareInvitationsFluentBuilder
            {
                fn send(
                    self,
...
impl GetResourceShareInvitationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_resource_share_invitations::GetResourceShareInvitationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_resource_share_invitations::GetResourceShareInvitationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_resource_share_invitations::GetResourceShareInvitations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_resource_share_invitations::GetResourceShareInvitations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_resource_share_invitations::GetResourceShareInvitationsOutput, crate::operation::get_resource_share_invitations::GetResourceShareInvitationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::get_resource_share_invitations::paginator::GetResourceShareInvitationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
