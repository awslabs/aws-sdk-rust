...
impl GetResourceShareInvitationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resource_share_invitations::GetResourceShareInvitationsInput, ::aws_smithy_types::error::operation::BuildError> {
