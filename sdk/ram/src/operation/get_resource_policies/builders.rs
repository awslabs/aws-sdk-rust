...
impl crate::operation::get_resource_policies::builders::GetResourcePoliciesInputBuilder {
...
///
/// <p>Retrieves the resource policies for the specified resources that you own and have shared.</p><note>
...
impl GetResourcePoliciesFluentBuilder {
    /// Creates a new `GetResourcePoliciesFluentBuilder`.
