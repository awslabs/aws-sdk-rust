...
impl SetDefaultPermissionVersionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::set_default_permission_version::SetDefaultPermissionVersionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_default_permission_version::SetDefaultPermissionVersionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::set_default_permission_version::SetDefaultPermissionVersionOutput, crate::operation::set_default_permission_version::SetDefaultPermissionVersionError, Self> {
