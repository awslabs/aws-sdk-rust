...
impl crate::operation::set_default_permission_version::builders::SetDefaultPermissionVersionInputBuilder {
...
impl SetDefaultPermissionVersionFluentBuilder {
    /// Creates a new `SetDefaultPermissionVersionFluentBuilder`.
