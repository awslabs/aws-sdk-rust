...
impl AcceptResourceShareInvitation {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitationOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("RAM", "AcceptResourceShareInvitation", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "RAM.AcceptResourceShareInvitation",
                "rpc.service" = "RAM",
                "rpc.method" = "AcceptResourceShareInvitation",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AcceptResourceShareInvitation {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AcceptResourceShareInvitationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AcceptResourceShareInvitationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AcceptResourceShareInvitation")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AcceptResourceShareInvitation")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AcceptResourceShareInvitationTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AcceptResourceShareInvitationTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AcceptResourceShareInvitationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AcceptResourceShareInvitationInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AcceptResourceShareInvitationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AcceptResourceShareInvitationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_accept_resource_share_invitation::ser_accept_resource_share_invitation_input(&input)?,
        );
