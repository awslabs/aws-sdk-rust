    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/acceptresourceshareinvitation")
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptResourceShareInvitation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitationError
{
