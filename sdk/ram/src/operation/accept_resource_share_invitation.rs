...
impl AcceptResourceShareInvitationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::accept_resource_share_invitation::AcceptResourceShareInvitation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptResourceShareInvitation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_response_with_props(
                status, headers, body,
            )
        }
    }
