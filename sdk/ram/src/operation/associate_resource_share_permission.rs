...
impl AssociateResourceSharePermissionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_resource_share_permission::AssociateResourceSharePermission::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateResourceSharePermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_resource_share_permission::de_associate_resource_share_permission_http_response_with_props(
                status, headers, body,
            )
        }
    }
