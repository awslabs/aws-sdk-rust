...
pub fn de_get_permission_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_permission::GetPermissionOutput, crate::operation::get_permission::GetPermissionError> {
    #[allow(unused_mut)]
...
pub fn de_get_permission_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_get_permission::de_get_permission(_response_body, output)
            .map_err(crate::operation::get_permission::GetPermissionError::unhandled)?;
...
) -> Result<crate::operation::get_permission::builders::GetPermissionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "permission" => {
                    builder = builder
                        .set_permission(crate::protocol_serde::shape_resource_share_permission_detail::de_resource_share_permission_detail(tokens)?);
                }
