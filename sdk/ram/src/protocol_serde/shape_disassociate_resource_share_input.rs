...
pub fn ser_disassociate_resource_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisassociateResourceShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
