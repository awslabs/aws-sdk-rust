...
pub fn de_promote_permission_created_from_policy_http_error(
...
> {
    ...
    Err(match error_code {
        "InvalidParameterException" => {
            crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerInternalException" => {
            crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyError::ServerInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnknownResourceException" => {
            crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyError::UnknownResourceException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_promote_permission_created_from_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_promote_permission_created_from_policy::de_promote_permission_created_from_policy(_response_body, output)
                .map_err(crate::operation::promote_permission_created_from_policy::PromotePermissionCreatedFromPolicyError::unhandled)?;
