...
pub fn de_list_replace_permission_associations_work_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_replace_permission_associations_work::ListReplacePermissionAssociationsWorkError::unhandled(generic))
        }
    };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_replace_permission_associations_work_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_replace_permission_associations_work::de_list_replace_permission_associations_work(
            _response_body,
            output,
        )
        .map_err(crate::operation::list_replace_permission_associations_work::ListReplacePermissionAssociationsWorkError::unhandled)?;
...
pub fn ser_list_replace_permission_associations_work_input(
    ...
    crate::protocol_serde::shape_list_replace_permission_associations_work_input::ser_list_replace_permission_associations_work_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_list_replace_permission_associations_work(
    _value: &[u8],
    mut builder: crate::operation::list_replace_permission_associations_work::builders::ListReplacePermissionAssociationsWorkOutputBuilder,
) -> ::std::result::Result<
    crate::operation::list_replace_permission_associations_work::builders::ListReplacePermissionAssociationsWorkOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "replacePermissionAssociationsWorks" => {
                    builder = builder.set_replace_permission_associations_works(
                        crate::protocol_serde::shape_replace_permission_associations_work_list::de_replace_permission_associations_work_list(
                            tokens, _value,
                        )?,
                    );
                }
