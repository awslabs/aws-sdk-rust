...
pub fn ser_associate_resource_share_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::associate_resource_share::AssociateResourceShareInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
