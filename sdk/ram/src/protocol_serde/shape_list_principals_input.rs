...
pub fn ser_list_principals_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPrincipalsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
