...
pub fn de_list_principals_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_list_principals::de_list_principals(_response_body, output)
            .map_err(crate::operation::list_principals::ListPrincipalsError::unhandled)?;
...
) -> Result<crate::operation::list_principals::builders::ListPrincipalsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
