    ...
    Err(match error_code {
        ...
        "ResourceArnNotFoundException" => crate::operation::get_resource_policies::GetResourcePoliciesError::ResourceArnNotFoundException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_resource_arn_not_found_exception::de_resource_arn_not_found_exception_json_err(
                    _response_body,
                    output,
                )
                .map_err(crate::operation::get_resource_policies::GetResourcePoliciesError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_resource_policies::de_get_resource_policies(_response_body, output)
            .map_err(crate::operation::get_resource_policies::GetResourcePoliciesError::unhandled)?;
