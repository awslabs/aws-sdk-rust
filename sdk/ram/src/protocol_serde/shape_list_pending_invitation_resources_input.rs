...
pub fn ser_list_pending_invitation_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListPendingInvitationResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
