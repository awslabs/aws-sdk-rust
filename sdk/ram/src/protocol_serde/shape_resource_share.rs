...
pub(crate) fn de_resource_share<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResourceShare>, aws_smithy_json::deserialize::error::DeserializeError>
