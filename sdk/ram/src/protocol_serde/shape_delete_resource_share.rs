...
pub fn de_delete_resource_share_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_resource_share::DeleteResourceShareOutput, crate::operation::delete_resource_share::DeleteResourceShareError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_resource_share::DeleteResourceShareError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_resource_share_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_resource_share::DeleteResourceShareOutput, crate::operation::delete_resource_share::DeleteResourceShareError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_resource_share::builders::DeleteResourceShareOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_resource_share::de_delete_resource_share(response.body().as_ref(), output).map_err(crate::operation::delete_resource_share::DeleteResourceShareError::unhandled)?;
