...
pub fn de_delete_permission_version_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_permission_version::DeletePermissionVersionError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "IdempotentParameterMismatchException" => {
            crate::operation::delete_permission_version::DeletePermissionVersionError::IdempotentParameterMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotPermittedException" => {
            crate::operation::delete_permission_version::DeletePermissionVersionError::OperationNotPermittedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_permission_version_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_permission_version::de_delete_permission_version(_response_body, output)
            .map_err(crate::operation::delete_permission_version::DeletePermissionVersionError::unhandled)?;
