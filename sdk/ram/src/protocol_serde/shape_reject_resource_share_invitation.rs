...
> {
    ...
    Err(match error_code {
        "IdempotentParameterMismatchException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::IdempotentParameterMismatchException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidClientTokenException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::InvalidClientTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotPermittedException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::OperationNotPermittedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceShareInvitationAlreadyAcceptedException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ResourceShareInvitationAlreadyAcceptedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceShareInvitationAlreadyRejectedException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ResourceShareInvitationAlreadyRejectedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceShareInvitationArnNotFoundException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ResourceShareInvitationArnNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceShareInvitationExpiredException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ResourceShareInvitationExpiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServerInternalException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ServerInternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reject_resource_share_invitation_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_reject_resource_share_invitation::de_reject_resource_share_invitation(_response_body, output)
            .map_err(crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationError::unhandled)?;
...
pub(crate) fn de_reject_resource_share_invitation(
    value: &[u8],
    mut builder: crate::operation::reject_resource_share_invitation::builders::RejectResourceShareInvitationOutputBuilder,
) -> Result<
    crate::operation::reject_resource_share_invitation::builders::RejectResourceShareInvitationOutputBuilder,
