...
pub fn de_list_permission_associations_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "ServiceUnavailableException" => {
            crate::operation::list_permission_associations::ListPermissionAssociationsError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_permission_associations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_permission_associations::de_list_permission_associations(_response_body, output)
            .map_err(crate::operation::list_permission_associations::ListPermissionAssociationsError::unhandled)?;
...
pub(crate) fn de_list_permission_associations(
    value: &[u8],
    mut builder: crate::operation::list_permission_associations::builders::ListPermissionAssociationsOutputBuilder,
) -> Result<
    crate::operation::list_permission_associations::builders::ListPermissionAssociationsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "permissions" => {
                    builder = builder.set_permissions(crate::protocol_serde::shape_associated_permission_list::de_associated_permission_list(
                        tokens,
                    )?);
                }
