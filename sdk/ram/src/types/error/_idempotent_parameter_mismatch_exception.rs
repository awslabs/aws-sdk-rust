...
impl IdempotentParameterMismatchExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::IdempotentParameterMismatchException, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::error::IdempotentParameterMismatchException {
                message: self.message
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("message", "message was not specified but it is required when building IdempotentParameterMismatchException")
                    )?
                ,
