...
impl std::fmt::Display for UnmatchedPolicyPermissionException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "UnmatchedPolicyPermissionException")?;
...
impl aws_http::request_id::RequestId for crate::types::error::UnmatchedPolicyPermissionException {
...
impl aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UnmatchedPolicyPermissionException
{
...
impl UnmatchedPolicyPermissionExceptionBuilder {
    ...
    pub fn build(self) -> crate::types::error::UnmatchedPolicyPermissionException {
