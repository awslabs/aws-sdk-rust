...
impl ::std::convert::From<&str> for ResourceShareInvitationStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ResourceShareInvitationStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ResourceShareInvitationStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourceShareInvitationStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ResourceShareInvitationStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
