...
pub struct ResourceShare  {
    ...
    #[doc(hidden)]pub owning_account_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ResourceShareStatus>,
    ...
    /// </ul>
    #[doc(hidden)]pub feature_set: std::option::Option<crate::model::ResourceShareFeatureSet>,
}
impl ResourceShare {
    /// <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resoure Name (ARN)</a> of the resource share</p>
...
pub struct ResourceShareInvitation  {
    ...
    /// <p>The name of the resource share.</p>
    #[doc(hidden)]pub resource_share_name: std::option::Option<std::string::String>,
    /// <p>The <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resoure Name (ARN)</a> of the resource share</p>
    #[doc(hidden)]pub resource_share_arn: std::option::Option<std::string::String>,
    /// <p>The ID of the Amazon Web Services account that sent the invitation.</p>
    #[doc(hidden)]pub sender_account_id: std::option::Option<std::string::String>,
    /// <p>The ID of the Amazon Web Services account that received the invitation.</p>
    #[doc(hidden)]pub receiver_account_id: std::option::Option<std::string::String>,
    /// <p>The date and time when the invitation was sent.</p>
    #[doc(hidden)]pub invitation_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The current status of the invitation.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ResourceShareInvitationStatus>,
    ...
    #[deprecated(note = "This member has been deprecated. Use ListPendingInvitationResources.")]#[doc(hidden)]pub resource_share_associations: std::option::Option<std::vec::Vec<crate::model::ResourceShareAssociation>>,
    ...
    #[doc(hidden)]pub receiver_arn: std::option::Option<std::string::String>,
}
impl ResourceShareInvitation {
    ...
    /// <p>To view the resources associated with a pending resource share invitation, use <code>ListPendingInvitationResources</code>.</p>
    #[deprecated(note = "This member has been deprecated. Use ListPendingInvitationResources.")]pub fn resource_share_associations(&self) -> std::option::Option<& [crate::model::ResourceShareAssociation]> {
...
impl  std::fmt::Debug for ResourceShareInvitation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status", &self.status);
        formatter.field("resource_share_associations", &self.resource_share_associations);
...
pub mod resource_share_invitation {
    ...
    impl Builder {
        ...
        ///
        /// <p>To view the resources associated with a pending resource share invitation, use <code>ListPendingInvitationResources</code>.</p>
        #[deprecated(note = "This member has been deprecated. Use ListPendingInvitationResources.")]pub fn resource_share_associations(mut self, input: crate::model::ResourceShareAssociation) -> Self {
        ...
        /// <p>To view the resources associated with a pending resource share invitation, use <code>ListPendingInvitationResources</code>.</p>
        #[deprecated(note = "This member has been deprecated. Use ListPendingInvitationResources.")]pub fn set_resource_share_associations(mut self, input: std::option::Option<std::vec::Vec<crate::model::ResourceShareAssociation>>) -> Self {
...
pub struct ResourceShareAssociation  {
    ...
    /// </ul> </li> 
    /// </ul>
    #[doc(hidden)]pub associated_entity: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ResourceShareAssociationStatus>,
    ...
    #[doc(hidden)]pub external: std::option::Option<bool>,
}
...
pub struct ServiceNameAndResourceType  {
    ...
    /// </ul>
    #[doc(hidden)]pub resource_region_scope: std::option::Option<crate::model::ResourceRegionScope>,
}
...
pub struct ResourceSharePermissionSummary  {
    ...
    #[doc(hidden)]pub default_version: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub is_resource_type_default: std::option::Option<bool>,
}
...
pub struct Resource  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ResourceStatus>,
...
pub struct ResourceSharePermissionDetail  {
    ...
    #[doc(hidden)]pub permission: std::option::Option<std::string::String>,
    /// <p>The date and time when the permission was created.</p>
    #[doc(hidden)]pub creation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time when the permission was last updated.</p>
    #[doc(hidden)]pub last_updated_time: std::option::Option<aws_smithy_types::DateTime>,
