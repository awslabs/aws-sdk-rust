...
impl super::Client {
    ...
    ///   - [`principal(impl Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::principal) / [`set_principal(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_principal): <p>Specifies the principal.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_next_token): <p>Specifies that you want to receive the next page of results. Valid only if you received a <code>NextToken</code> response in the previous request. If you did, it indicates that more output is available. Set this parameter to the value provided by the previous call's <code>NextToken</code> response to request the next page of results.</p>
