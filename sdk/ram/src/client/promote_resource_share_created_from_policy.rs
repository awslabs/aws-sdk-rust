...
impl super::Client {
    ...
    ///   - [`resource_share_arn(impl ::std::convert::Into<String>)`](crate::operation::promote_resource_share_created_from_policy::builders::PromoteResourceShareCreatedFromPolicyFluentBuilder::resource_share_arn) / [`set_resource_share_arn(Option<String>)`](crate::operation::promote_resource_share_created_from_policy::builders::PromoteResourceShareCreatedFromPolicyFluentBuilder::set_resource_share_arn): <p>Specifies the <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Name (ARN)</a> of the resource share to promote.</p>
