...
impl super::Client  {
    ...
    pub fn promote_resource_share_created_from_policy(&self) -> crate::client::fluent_builders::PromoteResourceShareCreatedFromPolicy {
                                crate::client::fluent_builders::PromoteResourceShareCreatedFromPolicy::new(self.handle.clone())
                            }
}
