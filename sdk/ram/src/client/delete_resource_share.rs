...
impl super::Client {
    ...
    pub fn delete_resource_share(&self) -> crate::client::fluent_builders::DeleteResourceShare {
        crate::client::fluent_builders::DeleteResourceShare::new(self.handle.clone())
    }
}
