...
impl super::Client  {
    ...
    pub fn reject_resource_share_invitation(&self) -> crate::client::fluent_builders::RejectResourceShareInvitation {
                                crate::client::fluent_builders::RejectResourceShareInvitation::new(self.handle.clone())
                            }
}
