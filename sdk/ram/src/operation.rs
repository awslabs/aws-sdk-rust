...
/// [`accept_resource_share_invitation`](crate::client::fluent_builders::AcceptResourceShareInvitation).
///
...
impl aws_smithy_http::response::ParseStrictResponse for AcceptResourceShareInvitation {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_error(response)
        } else {
            crate::protocol_serde::shape_accept_resource_share_invitation::de_accept_resource_share_invitation_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`associate_resource_share`](crate::client::fluent_builders::AssociateResourceShare).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`associate_resource_share_permission`](crate::client::fluent_builders::AssociateResourceSharePermission).
///
...
impl aws_smithy_http::response::ParseStrictResponse for AssociateResourceSharePermission {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_associate_resource_share_permission::de_associate_resource_share_permission_http_error(response)
        } else {
            crate::protocol_serde::shape_associate_resource_share_permission::de_associate_resource_share_permission_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`create_resource_share`](crate::client::fluent_builders::CreateResourceShare).
///
...
impl aws_smithy_http::response::ParseStrictResponse for CreateResourceShare {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_resource_share::de_create_resource_share_http_error(
                response,
            )
        } else {
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`delete_resource_share`](crate::client::fluent_builders::DeleteResourceShare).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`disassociate_resource_share`](crate::client::fluent_builders::DisassociateResourceShare).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`disassociate_resource_share_permission`](crate::client::fluent_builders::DisassociateResourceSharePermission).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`enable_sharing_with_aws_organization`](crate::client::fluent_builders::EnableSharingWithAwsOrganization).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_permission`](crate::client::fluent_builders::GetPermission).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_resource_share_associations`](crate::client::fluent_builders::GetResourceShareAssociations).
///
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourceShareAssociations {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_resource_share_associations::de_get_resource_share_associations_http_error(response)
        } else {
            crate::protocol_serde::shape_get_resource_share_associations::de_get_resource_share_associations_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_resource_share_invitations`](crate::client::fluent_builders::GetResourceShareInvitations).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_resource_shares`](crate::client::fluent_builders::GetResourceShares).
///
...
impl aws_smithy_http::response::ParseStrictResponse for GetResourceShares {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_resource_shares::de_get_resource_shares_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_resource_shares::de_get_resource_shares_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_pending_invitation_resources`](crate::client::fluent_builders::ListPendingInvitationResources).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_permission_versions`](crate::client::fluent_builders::ListPermissionVersions).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListPermissionVersions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_permission_versions::de_list_permission_versions_http_error(response)
        } else {
            crate::protocol_serde::shape_list_permission_versions::de_list_permission_versions_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_principals`](crate::client::fluent_builders::ListPrincipals).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_resource_share_permissions`](crate::client::fluent_builders::ListResourceSharePermissions).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_resource_types`](crate::client::fluent_builders::ListResourceTypes).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListResourceTypes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_resource_types::de_list_resource_types_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_resource_types::de_list_resource_types_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`promote_resource_share_created_from_policy`](crate::client::fluent_builders::PromoteResourceShareCreatedFromPolicy).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`reject_resource_share_invitation`](crate::client::fluent_builders::RejectResourceShareInvitation).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`update_resource_share`](crate::client::fluent_builders::UpdateResourceShare).
///
