...
impl super::Client {
    ...
    ///   - [`hapg_arn(impl Into<String>)`](crate::operation::describe_hapg::builders::DescribeHapgFluentBuilder::hapg_arn) / [`set_hapg_arn(Option<String>)`](crate::operation::describe_hapg::builders::DescribeHapgFluentBuilder::set_hapg_arn):<br>required: **true**<br><p>The ARN of the high-availability partition group to describe.</p><br>
