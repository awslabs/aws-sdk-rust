...
impl super::Client {
    ...
    pub fn modify_luna_client(
        &self,
    ) -> crate::operation::modify_luna_client::builders::ModifyLunaClientFluentBuilder {
        crate::operation::modify_luna_client::builders::ModifyLunaClientFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
