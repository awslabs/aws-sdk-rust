...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_luna_clients::builders::ListLunaClientsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_luna_clients::builders::ListLunaClientsFluentBuilder::set_next_token):<br>required: **false**<br><p>The <code>NextToken</code> value from a previous call to <code>ListLunaClients</code>. Pass null if this is the first call.</p><br>
                            /// - On success, responds with [`ListLunaClientsOutput`](crate::operation::list_luna_clients::ListLunaClientsOutput) with field(s):
    ///   - [`client_list(Vec::<String>)`](crate::operation::list_luna_clients::ListLunaClientsOutput::client_list): <p>The list of clients.</p>
