...
impl ListAvailableZones {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_available_zones::ListAvailableZonesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_available_zones::ListAvailableZonesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudHSM", "ListAvailableZones", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CloudHSM.ListAvailableZones",
                "rpc.service" = "CloudHSM",
                "rpc.method" = "ListAvailableZones",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAvailableZones {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAvailableZonesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAvailableZonesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAvailableZones")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAvailableZonesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_available_zones::de_list_available_zones_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_available_zones::de_list_available_zones_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAvailableZonesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_available_zones::ListAvailableZonesInput>()
            .expect("correct type");
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_available_zones::ser_list_available_zones_input(&input)?);
