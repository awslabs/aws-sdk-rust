...
impl ListAvailableZonesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_available_zones::ListAvailableZones,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_available_zones::ser_list_available_zones_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAvailableZones {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_available_zones::de_list_available_zones_http_response_with_props(status, headers, body)
        }
    }
}
