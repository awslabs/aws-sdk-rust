...
impl ModifyHsmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_hsm::ModifyHsm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_hsm::ser_modify_hsm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyHsm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_hsm::de_modify_hsm_http_response_with_props(status, headers, body)
        }
    }
}
