...
impl ModifyHsmInput {
    /// Consumes the builder and constructs an Operation<[`ModifyHsm`](crate::operation::modify_hsm::ModifyHsm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::modify_hsm::ModifyHsm, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_hsm::ModifyHsmInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::modify_hsm::ModifyHsm::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ModifyHsm {
                type Output = std::result::Result<crate::operation::modify_hsm::ModifyHsmOutput, crate::operation::modify_hsm::ModifyHsmError>;
