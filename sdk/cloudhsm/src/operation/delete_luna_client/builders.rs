...
impl DeleteLunaClientFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_luna_client::DeleteLunaClientOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_luna_client::DeleteLunaClientError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_luna_client::DeleteLunaClientOutput, crate::operation::delete_luna_client::DeleteLunaClientError, Self> {
