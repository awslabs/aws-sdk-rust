...
impl ModifyHapgInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::modify_hapg::ModifyHapg::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyHapg {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_modify_hapg::de_modify_hapg_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_modify_hapg::de_modify_hapg_http_response_with_props(
                status, headers, body,
            )
        }
    }
