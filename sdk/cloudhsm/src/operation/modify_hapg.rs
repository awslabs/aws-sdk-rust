    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_hapg::ModifyHapgError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_hapg::ModifyHapgOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ModifyHapg")
                ...
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ModifyHapgEndpointParamsInterceptor) as _),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ModifyHapgResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ModifyHapgRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::modify_hapg::ModifyHapgInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_hapg::ser_modify_hapg_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ModifyHapgEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_hapg::ModifyHapgError {
