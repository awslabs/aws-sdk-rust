...
impl ModifyHapgInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::modify_hapg::ModifyHapg, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_modify_hapg::ser_modify_hapg_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyHapg {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_modify_hapg::de_modify_hapg_http_response_with_props(status, headers, body)
        }
    }
}
