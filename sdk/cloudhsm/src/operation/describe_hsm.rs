...
impl DescribeHsmInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_hsm::DescribeHsm::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHsm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_hsm::de_describe_hsm_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_hsm::de_describe_hsm_http_response_with_props(
                status, headers, body,
            )
        }
    }
