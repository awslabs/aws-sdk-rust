...
impl DescribeHapgFluentBuilder  {
    /// Creates a new `DescribeHapg`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::describe_hapg::DescribeHapg, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::describe_hapg::DescribeHapgError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_hapg::DescribeHapgOutput, aws_smithy_http::result::SdkError<crate::operation::describe_hapg::DescribeHapgError>>
                     {
