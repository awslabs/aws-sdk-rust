...
impl DescribeLunaClientInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_luna_client::ser_describe_luna_client_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLunaClient {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_luna_client::de_describe_luna_client_http_response_with_props(status, headers, body)
        }
    }
}
