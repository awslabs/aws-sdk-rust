...
impl DescribeHsmFluentBuilder  {
    /// Creates a new `DescribeHsm`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_hsm::DescribeHsmOutput, aws_smithy_http::result::SdkError<crate::operation::describe_hsm::DescribeHsmError>>
                     {
