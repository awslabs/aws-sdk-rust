...
impl CreateLunaClientFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_luna_client::CreateLunaClientOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_luna_client::CreateLunaClientError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_luna_client::CreateLunaClientOutput, crate::operation::create_luna_client::CreateLunaClientError, Self> {
