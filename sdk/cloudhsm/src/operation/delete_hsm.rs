...
impl DeleteHsmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_hsm::DeleteHsm, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_hsm::ser_delete_hsm_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHsm {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_hsm::de_delete_hsm_http_response_with_props(status, headers, body)
        }
    }
}
