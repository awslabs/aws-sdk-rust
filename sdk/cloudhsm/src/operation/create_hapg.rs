...
impl CreateHapgInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_hapg::CreateHapg, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_hapg::ser_create_hapg_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHapg {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_hapg::de_create_hapg_http_response_with_props(status, headers, body)
        }
    }
}
