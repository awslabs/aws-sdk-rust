...
impl ListHapgsFluentBuilder  {
    /// Creates a new `ListHapgs`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_hapgs::ListHapgsOutput, aws_smithy_http::result::SdkError<crate::operation::list_hapgs::ListHapgsError>>
                     {
