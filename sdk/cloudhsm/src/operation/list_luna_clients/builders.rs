...
pub use crate::operation::list_luna_clients::_list_luna_clients_output::ListLunaClientsOutputBuilder;

pub use crate::operation::list_luna_clients::_list_luna_clients_input::ListLunaClientsInputBuilder;
...
impl ListLunaClientsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_luna_clients();
...
pub struct ListLunaClientsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_luna_clients::builders::ListLunaClientsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_luna_clients::ListLunaClientsOutput,
                    crate::operation::list_luna_clients::ListLunaClientsError,
                > for ListLunaClientsFluentBuilder
            {
                fn send(
                    self,
...
impl ListLunaClientsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_luna_clients::builders::ListLunaClientsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_luna_clients::ListLunaClientsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_luna_clients::ListLunaClientsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_luna_clients::ListLunaClients::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_luna_clients::ListLunaClients::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_luna_clients::ListLunaClientsOutput, crate::operation::list_luna_clients::ListLunaClientsError, Self> {
