...
pub fn de_list_hapgs_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_hapgs_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_hapgs::ListHapgsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_hapgs::builders::ListHapgsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
