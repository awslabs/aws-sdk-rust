    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::ListTagsForResourceErrorKind::CloudHsmInternalException(
                        inner,
                    ) => Error::CloudHsmInternalException(inner),
    ...
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        ...
        match err {
            aws_smithy_http::result::SdkError::ServiceError(context) => {
                match context.into_err().kind {
                    crate::error::RemoveTagsFromResourceErrorKind::CloudHsmInternalException(
                        inner,
                    ) => Error::CloudHsmInternalException(inner),
                    crate::error::RemoveTagsFromResourceErrorKind::CloudHsmServiceException(
                        inner,
                    ) => Error::CloudHsmServiceException(inner),
                    crate::error::RemoveTagsFromResourceErrorKind::InvalidRequestException(
                        inner,
                    ) => Error::InvalidRequestException(inner),
