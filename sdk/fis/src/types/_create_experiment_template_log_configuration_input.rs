...
impl CreateExperimentTemplateLogConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::CreateExperimentTemplateLogConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::CreateExperimentTemplateLogConfigurationInput {
                ...
                log_schema_version: self.log_schema_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("log_schema_version", "log_schema_version was not specified but it is required when building CreateExperimentTemplateLogConfigurationInput")
                    )?
                ,
            }
        )
