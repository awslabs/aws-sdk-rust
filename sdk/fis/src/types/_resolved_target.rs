...
impl ResolvedTargetBuilder {
    ...
    ///
    /// <p>Information about the target.</p>
    pub fn target_information(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    /// <p>Information about the target.</p>
    pub fn set_target_information(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>>) -> Self {
        self.target_information = input; self
    }
    /// <p>Information about the target.</p>
