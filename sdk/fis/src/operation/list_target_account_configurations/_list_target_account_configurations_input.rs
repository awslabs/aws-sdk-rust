...
impl ListTargetAccountConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_target_account_configurations::ListTargetAccountConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
