...
impl ListActionsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_actions::paginator::ListActionsPaginatorItems {
        crate::operation::list_actions::paginator::ListActionsPaginatorItems(self)
    }
...
impl ListActionsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_actions_output_output_actions(page).unwrap_or_default().into_iter())
    }
}
