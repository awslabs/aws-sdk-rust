...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_action::builders::GetActionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_action::builders::GetActionFluentBuilder::set_id): <p>The ID of the action.</p>
