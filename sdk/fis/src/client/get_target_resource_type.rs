...
impl super::Client {
    ...
    ///   - [`resource_type(impl Into<String>)`](crate::operation::get_target_resource_type::builders::GetTargetResourceTypeFluentBuilder::resource_type) / [`set_resource_type(Option<String>)`](crate::operation::get_target_resource_type::builders::GetTargetResourceTypeFluentBuilder::set_resource_type):<br>required: **true**<br><p>The resource type.</p><br>
