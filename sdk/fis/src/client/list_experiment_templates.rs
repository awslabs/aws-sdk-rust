...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_experiment_templates::builders::ListExperimentTemplatesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_experiment_templates::builders::ListExperimentTemplatesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return with a single call. To retrieve the remaining results, make another call with the returned <code>nextToken</code> value.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_experiment_templates::builders::ListExperimentTemplatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_experiment_templates::builders::ListExperimentTemplatesFluentBuilder::set_next_token):<br>required: **false**<br><p>The token for the next page of results.</p><br>
