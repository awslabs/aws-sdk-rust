...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::update_experiment_template::builders::UpdateExperimentTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_experiment_template::builders::UpdateExperimentTemplateFluentBuilder::set_id): <p>The ID of the experiment template.</p>
