...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::set_description): <p>A description for the experiment template.</p>
    ...
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::create_experiment_template::builders::CreateExperimentTemplateFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) of an IAM role that grants the FIS service permission to perform service actions on your behalf.</p>
