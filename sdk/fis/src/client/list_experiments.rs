...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_experiments::builders::ListExperimentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_experiments::builders::ListExperimentsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
