...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::stop_experiment::builders::StopExperimentFluentBuilder::set_id): <p>The ID of the experiment.</p>
