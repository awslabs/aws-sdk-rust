...
pub fn serialize_structure_create_experiment_template_input(
        ...
        for (key_3, value_4) in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_create_experiment_template_action_input(
                    &mut object_5,
                    value_4,
                );
                object_5.finish();
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_create_experiment_template_stop_condition_input(&mut object_12, item_11);
                object_12.finish();
            }
        }
        array_10.finish();
        ...
        for (key_19, value_20) in var_17 {
            {
                ...
                crate::json_ser::serialize_structure_create_experiment_template_target_input(
                    &mut object_21,
                    value_20,
                );
                object_21.finish();
...
pub fn serialize_structure_start_experiment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_experiment_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_34, value_35) in var_32 {
            {
                ...
                crate::json_ser::serialize_structure_update_experiment_template_action_input_item(
                    &mut object_36,
                    value_35,
                );
                object_36.finish();
        ...
        for item_41 in var_39 {
            {
                ...
                crate::json_ser::serialize_structure_update_experiment_template_stop_condition_input(&mut object_42, item_41);
                object_42.finish();
            }
        }
        array_40.finish();
        ...
        for (key_45, value_46) in var_43 {
            {
                ...
                crate::json_ser::serialize_structure_update_experiment_template_target_input(
                    &mut object_47,
                    value_46,
                );
                object_47.finish();
...
pub fn serialize_structure_create_experiment_template_action_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_experiment_template_stop_condition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_experiment_template_target_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_73 in var_71 {
            {
                ...
                crate::json_ser::serialize_structure_experiment_template_target_input_filter(
                    &mut object_74,
                    item_73,
                );
                object_74.finish();
...
pub fn serialize_structure_update_experiment_template_action_input_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_experiment_template_stop_condition_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_experiment_template_target_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_experiment_template_target_input_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
