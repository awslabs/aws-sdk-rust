...
pub fn ser_create_experiment_template_input_input(
    ...
    if let Some(var_8) = &input.experiment_options {
        ...
        crate::protocol_serde::shape_create_experiment_template_experiment_options_input::ser_create_experiment_template_experiment_options_input(&mut object_9, var_8)?;
        object_9.finish();
    }
    if let Some(var_10) = &input.log_configuration {
        #[allow(unused_mut)]
        let mut object_11 = object.key("logConfiguration").start_object();
        crate::protocol_serde::shape_create_experiment_template_log_configuration_input::ser_create_experiment_template_log_configuration_input(&mut object_11, var_10)?;
        object_11.finish();
    }
        ...
        for item_15 in var_13 {
             {
                ...
                crate::protocol_serde::shape_create_experiment_template_stop_condition_input::ser_create_experiment_template_stop_condition_input(&mut object_16, item_15)?;
                object_16.finish();
            }
        }
        array_14.finish();
        ...
        for (key_23, value_24) in var_21 {
             {
                ...
                crate::protocol_serde::shape_create_experiment_template_target_input::ser_create_experiment_template_target_input(&mut object_25, value_24)?;
                object_25.finish();
            }
        }
        object_22.finish();
