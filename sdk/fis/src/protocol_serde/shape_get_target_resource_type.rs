...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_target_resource_type::de_get_target_resource_type(_response_body, output)
            .map_err(crate::operation::get_target_resource_type::GetTargetResourceTypeError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "targetResourceType" => {
                    builder = builder.set_target_resource_type(crate::protocol_serde::shape_target_resource_type::de_target_resource_type(tokens)?);
                }
