...
pub fn ser_create_experiment_template_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateExperimentTemplateTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
