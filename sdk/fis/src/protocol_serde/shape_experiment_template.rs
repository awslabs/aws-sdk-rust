...
) -> Result<Option<crate::types::ExperimentTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "targets" => {
                            builder = builder
                                .set_targets(crate::protocol_serde::shape_experiment_template_target_map::de_experiment_template_target_map(tokens)?);
                        }
                        "actions" => {
                            builder = builder
                                .set_actions(crate::protocol_serde::shape_experiment_template_action_map::de_experiment_template_action_map(tokens)?);
                        }
                        "stopConditions" => {
