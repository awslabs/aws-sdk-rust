...
pub fn ser_update_experiment_template_target_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateExperimentTemplateTargetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
