...
pub fn de_delete_experiment_template_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_experiment_template::DeleteExperimentTemplateOutput, crate::operation::delete_experiment_template::DeleteExperimentTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_experiment_template::DeleteExperimentTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_experiment_template_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_experiment_template::DeleteExperimentTemplateOutput, crate::operation::delete_experiment_template::DeleteExperimentTemplateError> {
    Ok({
        #[allow(unused_mut)]
