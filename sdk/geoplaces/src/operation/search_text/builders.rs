...
pub use crate::operation::search_text::_search_text_output::SearchTextOutputBuilder;

pub use crate::operation::search_text::_search_text_input::SearchTextInputBuilder;

impl crate::operation::search_text::builders::SearchTextInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.search_text();
...
/// <p>For more information, see <a href="https://docs.aws.amazon.com/location/latest/developerguide/search-text.html">Search Text</a> in the <i>Amazon Location Service Developer Guide</i>.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct SearchTextFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::search_text::builders::SearchTextInputBuilder,
...
impl SearchTextFluentBuilder {
    /// Creates a new `SearchTextFluentBuilder`.
    ...
    /// Access the SearchText as a reference.
    pub fn as_input(&self) -> &crate::operation::search_text::builders::SearchTextInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::search_text::SearchText::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::search_text::SearchText::orchestrate(&runtime_plugins, input).await
    }
