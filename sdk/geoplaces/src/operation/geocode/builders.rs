...
pub use crate::operation::geocode::_geocode_output::GeocodeOutputBuilder;

pub use crate::operation::geocode::_geocode_input::GeocodeInputBuilder;

impl crate::operation::geocode::builders::GeocodeInputBuilder {
    /// Sends a request with this input using the given client.
    pub async fn send_with(
        self,
        client: &crate::Client,
    ) -> ::std::result::Result<
        crate::operation::geocode::GeocodeOutput,
        ::aws_smithy_runtime_api::client::result::SdkError<
            crate::operation::geocode::GeocodeError,
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >,
    > {
        let mut fluent_builder = client.geocode();
...
pub struct GeocodeFluentBuilder {
    ...
    inner: crate::operation::geocode::builders::GeocodeInputBuilder,
    config_override: ::std::option::Option<crate::config::Builder>,
}
impl crate::client::customize::internal::CustomizableSend<crate::operation::geocode::GeocodeOutput, crate::operation::geocode::GeocodeError>
    for GeocodeFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::geocode::GeocodeOutput, crate::operation::geocode::GeocodeError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GeocodeFluentBuilder {
    /// Creates a new `GeocodeFluentBuilder`.
    ...
    /// Access the Geocode as a reference.
    pub fn as_input(&self) -> &crate::operation::geocode::builders::GeocodeInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::geocode::Geocode::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::geocode::Geocode::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> crate::client::customize::CustomizableOperation<crate::operation::geocode::GeocodeOutput, crate::operation::geocode::GeocodeError, Self>
    {
