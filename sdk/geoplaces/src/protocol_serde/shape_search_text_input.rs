...
pub fn ser_search_text_input_input(
    ...
    if let Some(var_7) = &input.filter {
        ...
        crate::protocol_serde::shape_search_text_filter::ser_search_text_filter(&mut object_8, var_7)?;
        object_8.finish();
    }
    ...
    if let Some(var_13) = &input.political_view {
        object.key("PoliticalView").string(var_13.as_str());
    }
    if let Some(var_14) = &input.query_id {
        object.key("QueryId").string(var_14.as_str());
    }
