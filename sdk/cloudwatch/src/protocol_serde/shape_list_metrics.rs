...
pub fn de_list_metrics_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListMetricsOutput, crate::error::ListMetricsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListMetricsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_metrics_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListMetricsOutput, crate::error::ListMetricsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_metrics_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_metrics::de_list_metrics(response.body().as_ref(), output).map_err(crate::error::ListMetricsError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_metrics(inp: &[u8], mut builder: crate::output::list_metrics_output::Builder) -> Result<crate::output::list_metrics_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
