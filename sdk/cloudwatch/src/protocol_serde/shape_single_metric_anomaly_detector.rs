...
#[allow(unused_mut)]
pub fn ser_single_metric_anomaly_detector(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::SingleMetricAnomalyDetector) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
