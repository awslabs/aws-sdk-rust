...
#[allow(unused_mut)]
pub fn ser_single_metric_anomaly_detector(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::SingleMetricAnomalyDetector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_single_metric_anomaly_detector(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SingleMetricAnomalyDetector, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
