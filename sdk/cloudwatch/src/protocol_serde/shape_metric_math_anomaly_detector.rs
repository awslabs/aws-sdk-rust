...
#[allow(unused_mut)]
pub fn ser_metric_math_anomaly_detector(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MetricMathAnomalyDetector) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metric_math_anomaly_detector(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::MetricMathAnomalyDetector, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::MetricMathAnomalyDetector::builder();
