...
#[allow(unused_mut)]
pub fn ser_metric_math_anomaly_detector(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::types::MetricMathAnomalyDetector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
