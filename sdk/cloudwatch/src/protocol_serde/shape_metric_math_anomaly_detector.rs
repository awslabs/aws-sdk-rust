...
#[allow(unused_mut)]
pub fn ser_metric_math_anomaly_detector(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MetricMathAnomalyDetector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metric_math_anomaly_detector(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricMathAnomalyDetector, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
