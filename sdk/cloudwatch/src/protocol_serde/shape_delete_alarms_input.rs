...
pub fn ser_delete_alarms_input_input_input(input: &crate::operation::delete_alarms::DeleteAlarmsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
