...
pub fn ser_get_metric_statistics_input_input(input: &crate::input::GetMetricStatisticsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
