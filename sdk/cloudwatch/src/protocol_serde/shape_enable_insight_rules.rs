...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_insight_rules_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_insight_rules::EnableInsightRulesOutput, crate::operation::enable_insight_rules::EnableInsightRulesError> {
    Ok({
        #[allow(unused_mut)]
