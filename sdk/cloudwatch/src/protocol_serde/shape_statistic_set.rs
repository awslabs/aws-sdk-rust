...
#[allow(unused_mut)]
pub fn ser_statistic_set(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::StatisticSet) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
