...
#[allow(unused_mut)]
pub fn ser_statistic_set(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::StatisticSet) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
