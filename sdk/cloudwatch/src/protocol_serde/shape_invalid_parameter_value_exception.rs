...
pub(crate) fn de_invalid_parameter_value_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidParameterValueExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidParameterValueExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
