...
#[allow(unused_mut)]
pub fn de_dashboard_invalid_input_error_xml_err(inp: &[u8], mut builder: crate::error::dashboard_invalid_input_error::Builder) -> Result<crate::error::dashboard_invalid_input_error::Builder, aws_smithy_xml::decode::XmlDecodeError> {
