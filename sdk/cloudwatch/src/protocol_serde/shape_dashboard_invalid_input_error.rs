...
pub(crate) fn de_dashboard_invalid_input_error_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::DashboardInvalidInputErrorBuilder,
) -> ::std::result::Result<crate::types::error::builders::DashboardInvalidInputErrorBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
