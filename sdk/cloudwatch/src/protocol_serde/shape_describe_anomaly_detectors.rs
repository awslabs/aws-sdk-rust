...
> {
    ...
    Err(match error_code {
        "InternalServiceError" => {
            crate::error::DescribeAnomalyDetectorsError::InternalServiceFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidNextToken" => {
            crate::error::DescribeAnomalyDetectorsError::InvalidNextToken({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValue" => {
            crate::error::DescribeAnomalyDetectorsError::InvalidParameterValueException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
> {
    Ok({
        ...
        let _ = response;
        output =
            crate::protocol_serde::shape_describe_anomaly_detectors::de_describe_anomaly_detectors(
