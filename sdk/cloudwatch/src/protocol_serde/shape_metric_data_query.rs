...
#[allow(unused_mut)]
pub fn ser_metric_data_query(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MetricDataQuery) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
