...
#[allow(unused_mut)]
pub fn ser_metric_data_query(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MetricDataQuery) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metric_data_query(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricDataQuery, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
