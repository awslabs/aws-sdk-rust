...
pub(crate) fn de_metric_stream_filters(
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::MetricStreamFilter>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::MetricStreamFilter>, ::aws_smithy_cbor::decode::DeserializeError> {
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_metric_stream_filter::de_metric_stream_filter(decoder, depth + 1)?,
        };
        list.push(value);
        Ok(list)
    }
