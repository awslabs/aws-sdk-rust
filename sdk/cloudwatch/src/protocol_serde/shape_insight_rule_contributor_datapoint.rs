...
pub fn de_insight_rule_contributor_datapoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleContributorDatapoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
