...
pub fn ser_put_anomaly_detector_input_input_input(input: &crate::operation::put_anomaly_detector::PutAnomalyDetectorInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
