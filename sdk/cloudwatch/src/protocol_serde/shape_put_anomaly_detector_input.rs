...
pub fn ser_put_anomaly_detector_input_input(input: &crate::input::PutAnomalyDetectorInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
