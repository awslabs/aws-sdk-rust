...
pub fn ser_put_managed_insight_rules_input_input_input(input: &crate::operation::put_managed_insight_rules::PutManagedInsightRulesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
