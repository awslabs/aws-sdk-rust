...
pub fn ser_put_managed_insight_rules_input_input(input: &crate::input::PutManagedInsightRulesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
