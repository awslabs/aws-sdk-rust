...
pub fn ser_put_metric_data_input_input(input: &crate::input::PutMetricDataInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
