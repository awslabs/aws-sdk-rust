...
pub fn ser_put_metric_stream_input_input(input: &crate::input::PutMetricStreamInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
