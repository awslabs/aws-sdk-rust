...
pub fn ser_put_metric_stream_input_input_input(input: &crate::operation::put_metric_stream::PutMetricStreamInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
