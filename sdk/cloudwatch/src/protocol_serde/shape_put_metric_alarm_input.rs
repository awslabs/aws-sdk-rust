...
pub fn ser_put_metric_alarm_input_input(input: &crate::input::PutMetricAlarmInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
