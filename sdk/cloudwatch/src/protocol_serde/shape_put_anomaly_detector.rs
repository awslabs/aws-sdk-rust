...
pub fn de_put_anomaly_detector_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_anomaly_detector::PutAnomalyDetectorOutput, crate::operation::put_anomaly_detector::PutAnomalyDetectorError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::put_anomaly_detector::PutAnomalyDetectorError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_anomaly_detector_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::put_anomaly_detector::PutAnomalyDetectorOutput, crate::operation::put_anomaly_detector::PutAnomalyDetectorError> {
    Ok({
        #[allow(unused_mut)]
