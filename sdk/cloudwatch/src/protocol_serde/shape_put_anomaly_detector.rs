...
pub fn de_put_anomaly_detector_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutAnomalyDetectorOutput, crate::error::PutAnomalyDetectorError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::PutAnomalyDetectorError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_anomaly_detector_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PutAnomalyDetectorOutput, crate::error::PutAnomalyDetectorError> {
    Ok({
        #[allow(unused_mut)]
