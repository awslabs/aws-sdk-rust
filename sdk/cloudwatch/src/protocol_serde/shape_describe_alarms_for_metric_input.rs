...
pub fn ser_describe_alarms_for_metric_input_input(input: &crate::input::DescribeAlarmsForMetricInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
