...
pub fn ser_describe_alarms_for_metric_input_input_input(input: &crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
