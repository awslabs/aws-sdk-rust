...
pub fn de_metric_stream_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStreamEntry, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
