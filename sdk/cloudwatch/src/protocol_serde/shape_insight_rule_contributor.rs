...
pub fn de_insight_rule_contributor(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleContributor, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
