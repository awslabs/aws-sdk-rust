...
pub(crate) fn de_kms_access_denied_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::KmsAccessDeniedExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::KmsAccessDeniedExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
