...
pub fn ser_describe_alarms_input_input(input: &crate::input::DescribeAlarmsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
