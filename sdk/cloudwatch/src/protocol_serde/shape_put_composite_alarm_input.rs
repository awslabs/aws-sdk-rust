...
pub fn ser_put_composite_alarm_input_input_input(input: &crate::operation::put_composite_alarm::PutCompositeAlarmInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
