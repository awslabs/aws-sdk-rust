...
pub fn ser_put_composite_alarm_input_input(input: &crate::input::PutCompositeAlarmInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
