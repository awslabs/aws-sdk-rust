...
pub fn de_list_metric_streams_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_metric_streams::ListMetricStreamsOutput, crate::operation::list_metric_streams::ListMetricStreamsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_metric_streams_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_metric_streams::ListMetricStreamsOutput, crate::operation::list_metric_streams::ListMetricStreamsError> {
    Ok({
        #[allow(unused_mut)]
