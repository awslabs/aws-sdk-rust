...
pub fn ser_get_metric_data_input_input_input(input: &crate::operation::get_metric_data::GetMetricDataInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
