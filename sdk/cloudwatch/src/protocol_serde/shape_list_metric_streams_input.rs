...
pub fn ser_list_metric_streams_input_input_input(input: &crate::operation::list_metric_streams::ListMetricStreamsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
