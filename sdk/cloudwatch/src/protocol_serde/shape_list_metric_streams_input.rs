...
pub fn ser_list_metric_streams_input_input(input: &crate::input::ListMetricStreamsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
