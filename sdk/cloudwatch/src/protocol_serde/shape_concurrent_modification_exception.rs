...
pub(crate) fn de_concurrent_modification_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ConcurrentModificationExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ConcurrentModificationExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
