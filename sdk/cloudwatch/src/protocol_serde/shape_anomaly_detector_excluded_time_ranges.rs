...
pub(crate) fn de_anomaly_detector_excluded_time_ranges(
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::Range>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::Range>, ::aws_smithy_cbor::decode::DeserializeError> {
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_range::de_range(decoder, depth + 1)?,
        };
        list.push(value);
        Ok(list)
    }
