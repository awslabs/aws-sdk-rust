...
#[allow(unused_mut)]
pub fn ser_metric_stat(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MetricStat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_metric_stat(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStat, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
