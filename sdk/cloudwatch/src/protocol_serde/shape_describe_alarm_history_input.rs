...
pub fn ser_describe_alarm_history_input_input(input: &crate::input::DescribeAlarmHistoryInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
