...
pub fn ser_describe_alarm_history_input_input_input(input: &crate::operation::describe_alarm_history::DescribeAlarmHistoryInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
