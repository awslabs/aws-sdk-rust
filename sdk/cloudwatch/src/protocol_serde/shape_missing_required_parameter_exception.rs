...
pub(crate) fn de_missing_required_parameter_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::MissingRequiredParameterExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::MissingRequiredParameterExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
