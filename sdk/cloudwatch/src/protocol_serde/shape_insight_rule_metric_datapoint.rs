...
pub fn de_insight_rule_metric_datapoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleMetricDatapoint, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
