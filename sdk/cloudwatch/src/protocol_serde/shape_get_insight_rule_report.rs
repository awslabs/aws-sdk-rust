...
> {
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::get_insight_rule_report::GetInsightRuleReportError::unhandled(
                    generic,
                ),
            )
        }
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_get_insight_rule_report::de_get_insight_rule_report(
