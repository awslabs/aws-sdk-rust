...
pub fn de_timestamps(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<aws_smithy_types::DateTime>, aws_smithy_xml::decode::XmlDecodeError> {
