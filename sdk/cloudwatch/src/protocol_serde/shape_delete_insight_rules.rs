...
pub fn ser_delete_insight_rules_input(
    input: &crate::operation::delete_insight_rules::DeleteInsightRulesInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        let encoder = &mut encoder;
        crate::protocol_serde::shape_delete_insight_rules_input::ser_delete_insight_rules_input_input(encoder, input)?;
    }
    Ok(::aws_smithy_types::body::SdkBody::from(encoder.into_writer()))
}

pub(crate) fn de_delete_insight_rules(
    value: &[u8],
