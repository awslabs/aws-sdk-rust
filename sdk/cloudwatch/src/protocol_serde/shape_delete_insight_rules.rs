...
pub fn de_delete_insight_rules_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_insight_rules::DeleteInsightRulesOutput, crate::operation::delete_insight_rules::DeleteInsightRulesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_insight_rules::DeleteInsightRulesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_insight_rules_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_insight_rules::DeleteInsightRulesOutput, crate::operation::delete_insight_rules::DeleteInsightRulesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_insight_rules::builders::DeleteInsightRulesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_insight_rules::de_delete_insight_rules(response.body().as_ref(), output).map_err(crate::operation::delete_insight_rules::DeleteInsightRulesError::unhandled)?;
