...
pub(crate) fn de_invalid_next_token_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidNextTokenBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidNextTokenBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
