...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_managed_insight_rules_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, crate::operation::list_managed_insight_rules::ListManagedInsightRulesError> {
    Ok({
        #[allow(unused_mut)]
