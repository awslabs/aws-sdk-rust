...
pub fn de_list_managed_insight_rules_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, crate::operation::list_managed_insight_rules::ListManagedInsightRulesError> {
    #[allow(unused_mut)]
