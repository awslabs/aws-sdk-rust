...
pub fn de_dashboard_validation_message(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DashboardValidationMessage, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
