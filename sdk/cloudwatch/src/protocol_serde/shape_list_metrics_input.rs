...
pub fn ser_list_metrics_input_input(input: &crate::input::ListMetricsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
