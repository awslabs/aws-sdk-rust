...
pub fn ser_list_managed_insight_rules_input_input(input: &crate::input::ListManagedInsightRulesInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
