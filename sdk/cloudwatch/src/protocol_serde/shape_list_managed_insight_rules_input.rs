...
pub fn ser_list_managed_insight_rules_input_input_input(input: &crate::operation::list_managed_insight_rules::ListManagedInsightRulesInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
