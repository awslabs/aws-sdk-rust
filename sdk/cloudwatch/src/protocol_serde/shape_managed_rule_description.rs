...
pub fn de_managed_rule_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedRuleDescription, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
