...
pub fn ser_describe_anomaly_detectors_input_input_input(input: &crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
