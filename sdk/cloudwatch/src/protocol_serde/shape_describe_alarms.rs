...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_alarms_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::describe_alarms::DescribeAlarmsOutput, crate::operation::describe_alarms::DescribeAlarmsError> {
...
) -> Result<crate::operation::describe_alarms::builders::DescribeAlarmsOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
