...
pub fn de_get_metric_statistics_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_statistics::GetMetricStatisticsOutput, crate::operation::get_metric_statistics::GetMetricStatisticsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_metric_statistics::GetMetricStatisticsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_metric_statistics_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_statistics::GetMetricStatisticsOutput, crate::operation::get_metric_statistics::GetMetricStatisticsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_metric_statistics::builders::GetMetricStatisticsOutputBuilder::default();
        output = crate::protocol_serde::shape_get_metric_statistics::de_get_metric_statistics(_response_body, output).map_err(crate::operation::get_metric_statistics::GetMetricStatisticsError::unhandled)?;
