...
pub fn de_get_metric_statistics_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_statistics::GetMetricStatisticsOutput, crate::operation::get_metric_statistics::GetMetricStatisticsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_metric_statistics_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_statistics::GetMetricStatisticsOutput, crate::operation::get_metric_statistics::GetMetricStatisticsError> {
    Ok({
        #[allow(unused_mut)]
