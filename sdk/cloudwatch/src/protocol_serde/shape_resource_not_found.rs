...
pub(crate) fn de_resource_not_found_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ResourceNotFoundBuilder,
) -> ::std::result::Result<crate::types::error::builders::ResourceNotFoundBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
