...
pub fn de_get_metric_stream_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_stream::GetMetricStreamOutput, crate::operation::get_metric_stream::GetMetricStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_internal_service_fault::de_internal_service_fault_xml_err(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_xml_err(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_xml_err(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_missing_required_parameter_exception::de_missing_required_parameter_exception_xml_err(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_metric_stream_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_stream::GetMetricStreamOutput, crate::operation::get_metric_stream::GetMetricStreamError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_metric_stream::builders::GetMetricStreamOutputBuilder::default();
        output = crate::protocol_serde::shape_get_metric_stream::de_get_metric_stream(_response_body, output).map_err(crate::operation::get_metric_stream::GetMetricStreamError::unhandled)?;
