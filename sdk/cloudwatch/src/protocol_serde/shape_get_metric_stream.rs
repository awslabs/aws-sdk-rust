...
pub fn de_get_metric_stream_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetMetricStreamOutput, crate::error::GetMetricStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetMetricStreamError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_internal_service_fault::de_internal_service_fault_xml_err(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_parameter_value_exception::de_invalid_parameter_value_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_missing_required_parameter_exception::de_missing_required_parameter_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_xml_err(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_metric_stream_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetMetricStreamOutput, crate::error::GetMetricStreamError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_metric_stream_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_metric_stream::de_get_metric_stream(response.body().as_ref(), output).map_err(crate::error::GetMetricStreamError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_get_metric_stream(inp: &[u8], mut builder: crate::output::get_metric_stream_output::Builder) -> Result<crate::output::get_metric_stream_output::Builder, aws_smithy_xml::decode::XmlDecodeError> {
