...
pub fn de_get_metric_stream_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_stream::GetMetricStreamOutput, crate::operation::get_metric_stream::GetMetricStreamError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_metric_stream_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_metric_stream::GetMetricStreamOutput, crate::operation::get_metric_stream::GetMetricStreamError> {
    Ok({
        #[allow(unused_mut)]
