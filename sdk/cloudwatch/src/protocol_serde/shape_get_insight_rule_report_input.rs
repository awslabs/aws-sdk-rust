...
pub fn ser_get_insight_rule_report_input_input_input(input: &crate::operation::get_insight_rule_report::GetInsightRuleReportInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
