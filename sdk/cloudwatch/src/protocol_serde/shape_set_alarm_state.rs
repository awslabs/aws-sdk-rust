...
pub fn de_set_alarm_state_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SetAlarmStateOutput, crate::error::SetAlarmStateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::SetAlarmStateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_alarm_state_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::SetAlarmStateOutput, crate::error::SetAlarmStateError> {
    Ok({
        #[allow(unused_mut)]
