...
#[allow(unused_mut)]
pub fn ser_dimension(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::Dimension) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_dimension(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::Dimension, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::Dimension::builder();
