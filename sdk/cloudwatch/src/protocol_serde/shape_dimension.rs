...
#[allow(unused_mut)]
pub fn ser_dimension(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::Dimension) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_dimension(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Dimension, aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
