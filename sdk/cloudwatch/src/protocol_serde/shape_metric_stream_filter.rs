...
#[allow(unused_mut)]
pub fn ser_metric_stream_filter(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MetricStreamFilter) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    #[allow(unused_mut)]
