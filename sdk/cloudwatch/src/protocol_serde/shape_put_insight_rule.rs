...
pub fn de_put_insight_rule_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::put_insight_rule::PutInsightRuleOutput, crate::operation::put_insight_rule::PutInsightRuleError> {
    #[allow(unused_mut)]
...
pub fn ser_put_insight_rule_input(
    input: &crate::operation::put_insight_rule::PutInsightRuleInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        let encoder = &mut encoder;
        crate::protocol_serde::shape_put_insight_rule_input::ser_put_insight_rule_input_input(encoder, input)?;
    }
