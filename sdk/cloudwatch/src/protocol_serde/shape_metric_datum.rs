...
#[allow(unused_mut)]
pub fn ser_metric_datum(mut writer: aws_smithy_query::QueryValueWriter, input: &crate::model::MetricDatum) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
