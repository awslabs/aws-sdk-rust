...
> {
    ...
    Err(match error_code {
        "ResourceNotFound" => {
            crate::operation::get_dashboard::GetDashboardError::DashboardNotFoundError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServiceError" => {
            crate::operation::get_dashboard::GetDashboardError::InternalServiceFault({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_dashboard_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_get_dashboard::de_get_dashboard(_response_body, output)
                .map_err(crate::operation::get_dashboard::GetDashboardError::unhandled)?;
