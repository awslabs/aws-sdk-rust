...
pub fn ser_delete_anomaly_detector_input_input(input: &crate::input::DeleteAnomalyDetectorInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
