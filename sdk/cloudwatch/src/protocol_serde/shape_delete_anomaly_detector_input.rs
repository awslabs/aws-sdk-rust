...
pub fn ser_delete_anomaly_detector_input_input_input(input: &crate::operation::delete_anomaly_detector::DeleteAnomalyDetectorInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
