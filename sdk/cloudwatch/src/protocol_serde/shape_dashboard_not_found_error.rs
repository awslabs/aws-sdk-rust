...
pub(crate) fn de_dashboard_not_found_error_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::DashboardNotFoundErrorBuilder,
) -> ::std::result::Result<crate::types::error::builders::DashboardNotFoundErrorBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
