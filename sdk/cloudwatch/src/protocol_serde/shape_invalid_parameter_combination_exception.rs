...
pub(crate) fn de_invalid_parameter_combination_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidParameterCombinationExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidParameterCombinationExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
