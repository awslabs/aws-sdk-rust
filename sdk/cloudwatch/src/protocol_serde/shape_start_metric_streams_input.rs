...
pub fn ser_start_metric_streams_input_input(input: &crate::input::StartMetricStreamsInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
