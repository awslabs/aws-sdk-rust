...
pub fn de_delete_metric_stream_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteMetricStreamOutput, crate::error::DeleteMetricStreamError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeleteMetricStreamError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_metric_stream_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeleteMetricStreamOutput, crate::error::DeleteMetricStreamError> {
    Ok({
        #[allow(unused_mut)]
