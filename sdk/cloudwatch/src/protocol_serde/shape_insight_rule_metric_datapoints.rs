...
pub(crate) fn de_insight_rule_metric_datapoints(
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::InsightRuleMetricDatapoint>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::InsightRuleMetricDatapoint>, ::aws_smithy_cbor::decode::DeserializeError> {
        let value = match decoder.datatype()? {
            ...
            _ => crate::protocol_serde::shape_insight_rule_metric_datapoint::de_insight_rule_metric_datapoint(decoder, depth + 1)?,
        };
        list.push(value);
        Ok(list)
    }
