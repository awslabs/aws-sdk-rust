...
pub struct MetricStreamStatisticsConfiguration  {
    ...
    #[doc(hidden)]pub include_metrics: std::option::Option<std::vec::Vec<crate::model::MetricStreamStatisticsMetric>>,
    ...
    #[doc(hidden)]pub additional_statistics: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl MetricStreamStatisticsConfiguration {
    /// <p>An array of metric name and namespace pairs that stream the additional statistics listed in the value of the <code>AdditionalStatistics</code> parameter. There can be as many as 100 pairs in the array.</p> 
    /// <p>All metrics that match the combination of metric name and namespace will be streamed with the additional statistics, no matter their dimensions.</p>
    pub fn include_metrics(&self) -> std::option::Option<& [crate::model::MetricStreamStatisticsMetric]> {
...
pub mod metric_stream_statistics_configuration {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug, )]
    pub struct Builder {
        pub(crate) include_metrics: std::option::Option<std::vec::Vec<crate::model::MetricStreamStatisticsMetric>>,
    ...
    impl Builder {
        ...
        /// <p>An array of metric name and namespace pairs that stream the additional statistics listed in the value of the <code>AdditionalStatistics</code> parameter. There can be as many as 100 pairs in the array.</p> 
        /// <p>All metrics that match the combination of metric name and namespace will be streamed with the additional statistics, no matter their dimensions.</p>
        pub fn include_metrics(mut self, input: crate::model::MetricStreamStatisticsMetric) -> Self {
        ...
        /// <p>An array of metric name and namespace pairs that stream the additional statistics listed in the value of the <code>AdditionalStatistics</code> parameter. There can be as many as 100 pairs in the array.</p> 
        /// <p>All metrics that match the combination of metric name and namespace will be streamed with the additional statistics, no matter their dimensions.</p>
        pub fn set_include_metrics(mut self, input: std::option::Option<std::vec::Vec<crate::model::MetricStreamStatisticsMetric>>) -> Self {
...
pub struct MetricDatum  {
    ...
    #[doc(hidden)]pub statistic_values: std::option::Option<crate::model::StatisticSet>,
    ...
    #[doc(hidden)]pub counts: std::option::Option<std::vec::Vec<f64>>,
    ...
    #[doc(hidden)]pub storage_resolution: std::option::Option<i32>,
}
impl MetricDatum {
    /// <p>The name of the metric.</p>
    pub fn metric_name(&self) -> std::option::Option<& str> {
...
pub struct StatisticSet  {
    ...
    #[doc(hidden)]pub sample_count: std::option::Option<f64>,
...
pub struct PartialFailure  {
    ...
    #[doc(hidden)]pub exception_type: std::option::Option<std::string::String>,
...
pub struct DashboardValidationMessage  {
    ...
    #[doc(hidden)]pub data_path: std::option::Option<std::string::String>,
...
pub struct AnomalyDetectorConfiguration  {
    ...
    #[doc(hidden)]pub excluded_time_ranges: std::option::Option<std::vec::Vec<crate::model::Range>>,
    ...
    #[doc(hidden)]pub metric_timezone: std::option::Option<std::string::String>,
}
...
pub mod anomaly_detector_configuration {
    ...
    impl Builder {
        ...
        /// <p>An array of time ranges to exclude from use when the anomaly detection model is trained. Use this to make sure that events that could cause unusual values for the metric, such as deployments, aren't used when CloudWatch creates the model.</p>
        pub fn set_excluded_time_ranges(mut self, input: std::option::Option<std::vec::Vec<crate::model::Range>>) -> Self {
...
pub struct ManagedRuleDescription  {
    ...
    #[doc(hidden)]pub rule_state: std::option::Option<crate::model::ManagedRuleState>,
}
...
pub mod managed_rule_description {
    ...
    impl Builder {
        ...
        /// <p> Describes the state of a managed rule. If present, it contains information about the Contributor Insights rule that contains information about the related Amazon Web Services resource. </p>
        pub fn set_rule_state(mut self, input: std::option::Option<crate::model::ManagedRuleState>) -> Self {
...
pub struct Datapoint  {
    ...
    #[doc(hidden)]pub extended_statistics: std::option::Option<std::collections::HashMap<std::string::String, f64>>,
}
impl Datapoint {
    /// <p>The time stamp used for the data point.</p>
    pub fn timestamp(&self) -> std::option::Option<& aws_smithy_types::DateTime> {
...
pub struct InsightRuleMetricDatapoint  {
    ...
    #[doc(hidden)]pub unique_contributors: std::option::Option<f64>,
    ...
    /// <p>This statistic is returned only if you included it in the <code>Metrics</code> array in your request.</p>
    #[doc(hidden)]pub max_contributor_value: std::option::Option<f64>,
...
pub struct InsightRuleContributor  {
    ...
    #[doc(hidden)]pub approximate_aggregate_value: std::option::Option<f64>,
    ...
    #[doc(hidden)]pub datapoints: std::option::Option<std::vec::Vec<crate::model::InsightRuleContributorDatapoint>>,
}
impl InsightRuleContributor {
    ...
    /// <p>An array of the data points where this contributor is present. Only the data points when this contributor appeared are included in the array.</p>
    pub fn datapoints(&self) -> std::option::Option<& [crate::model::InsightRuleContributorDatapoint]> {
...
impl  std::fmt::Debug for InsightRuleContributor  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("approximate_aggregate_value", &self.approximate_aggregate_value);
...
pub mod insight_rule_contributor {
    ...
    pub struct Builder {
        ...
        pub(crate) datapoints: std::option::Option<std::vec::Vec<crate::model::InsightRuleContributorDatapoint>>,
    }
    impl Builder {
        ...
        /// <p>An array of the data points where this contributor is present. Only the data points when this contributor appeared are included in the array.</p>
        pub fn set_datapoints(mut self, input: std::option::Option<std::vec::Vec<crate::model::InsightRuleContributorDatapoint>>) -> Self {
...
pub struct InsightRuleContributorDatapoint  {
    ...
    #[doc(hidden)]pub approximate_value: std::option::Option<f64>,
}
...
pub struct InsightRule  {
    ...
    #[doc(hidden)]pub managed_rule: bool,
}
impl InsightRule {
    /// <p>The name of the rule.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct AnomalyDetector  {
    ...
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Namespace property.")]#[doc(hidden)]pub namespace: std::option::Option<std::string::String>,
    /// <p>The name of the metric associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.MetricName property.")]#[doc(hidden)]pub metric_name: std::option::Option<std::string::String>,
    /// <p>The metric dimensions associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Dimensions property.")]#[doc(hidden)]pub dimensions: std::option::Option<std::vec::Vec<crate::model::Dimension>>,
    /// <p>The statistic associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Stat property.")]#[doc(hidden)]pub stat: std::option::Option<std::string::String>,
    /// <p>The configuration specifies details about how the anomaly detection model is to be trained, including time ranges to exclude from use for training the model, and the time zone to use for the metric.</p>
    ...
    #[doc(hidden)]pub state_value: std::option::Option<crate::model::AnomalyDetectorStateValue>,
...
impl AnomalyDetector {
    /// <p>The namespace of the metric associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Namespace property.")]pub fn namespace(&self) -> std::option::Option<& str> {
        self.namespace.as_deref()
    }
    /// <p>The name of the metric associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.MetricName property.")]pub fn metric_name(&self) -> std::option::Option<& str> {
        self.metric_name.as_deref()
    }
    /// <p>The metric dimensions associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Dimensions property.")]pub fn dimensions(&self) -> std::option::Option<& [crate::model::Dimension]> {
        self.dimensions.as_deref()
    }
    /// <p>The statistic associated with the anomaly detection model.</p>
    #[deprecated(note = "Use SingleMetricAnomalyDetector.Stat property.")]pub fn stat(&self) -> std::option::Option<& str> {
        self.stat.as_deref()
    }
    /// <p>The configuration specifies details about how the anomaly detection model is to be trained, including time ranges to exclude from use for training the model, and the time zone to use for the metric.</p>
...
pub mod anomaly_detector {
    ...
    impl Builder {
        /// <p>The namespace of the metric associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Namespace property.")]pub fn namespace(mut self, input: impl Into<std::string::String>) -> Self {
            self.namespace = Some(input.into());
            self
        }
        /// <p>The namespace of the metric associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Namespace property.")]pub fn set_namespace(mut self, input: std::option::Option<std::string::String>) -> Self {
            self.namespace = input; self
        }
        /// <p>The name of the metric associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.MetricName property.")]pub fn metric_name(mut self, input: impl Into<std::string::String>) -> Self {
            self.metric_name = Some(input.into());
            self
        }
        /// <p>The name of the metric associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.MetricName property.")]pub fn set_metric_name(mut self, input: std::option::Option<std::string::String>) -> Self {
            self.metric_name = input; self
        }
        /// Appends an item to `dimensions`.
        ///
        ...
        ///
        /// <p>The metric dimensions associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Dimensions property.")]pub fn dimensions(mut self, input: crate::model::Dimension) -> Self {
            let mut v = self.dimensions.unwrap_or_default();
                            v.push(input);
                            self.dimensions = Some(v);
                            self
        ...
        /// <p>The metric dimensions associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Dimensions property.")]pub fn set_dimensions(mut self, input: std::option::Option<std::vec::Vec<crate::model::Dimension>>) -> Self {
            self.dimensions = input; self
        }
        /// <p>The statistic associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Stat property.")]pub fn stat(mut self, input: impl Into<std::string::String>) -> Self {
            self.stat = Some(input.into());
            self
        }
        /// <p>The statistic associated with the anomaly detection model.</p>
        #[deprecated(note = "Use SingleMetricAnomalyDetector.Stat property.")]pub fn set_stat(mut self, input: std::option::Option<std::string::String>) -> Self {
            self.stat = input; self
        }
        /// <p>The configuration specifies details about how the anomaly detection model is to be trained, including time ranges to exclude from use for training the model, and the time zone to use for the metric.</p>
        ...
        /// <p>The current status of the anomaly detector's training. The possible values are <code>TRAINED | PENDING_TRAINING | TRAINED_INSUFFICIENT_DATA</code> </p>
        pub fn set_state_value(mut self, input: std::option::Option<crate::model::AnomalyDetectorStateValue>) -> Self {
...
pub struct MetricAlarm  {
    ...
    #[doc(hidden)]pub alarm_configuration_updated_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub state_updated_timestamp: std::option::Option<aws_smithy_types::DateTime>,
...
impl  std::fmt::Debug for MetricAlarm  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("alarm_configuration_updated_timestamp", &self.alarm_configuration_updated_timestamp);
...
pub struct CompositeAlarm  {
    ...
    #[doc(hidden)]pub state_transitioned_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub actions_suppressed_by: std::option::Option<crate::model::ActionsSuppressedBy>,
    /// <p> Captures the reason for action suppression. </p>
    #[doc(hidden)]pub actions_suppressed_reason: std::option::Option<std::string::String>,
...
impl  std::fmt::Debug for CompositeAlarm  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("state_updated_timestamp", &self.state_updated_timestamp);
        formatter.field("state_value", &self.state_value);
        formatter.field("state_transitioned_timestamp", &self.state_transitioned_timestamp);
...
pub mod composite_alarm {
    ...
    impl Builder {
        ...
        /// <p> When the value is <code>ALARM</code>, it means that the actions are suppressed because the suppressor alarm is in <code>ALARM</code> When the value is <code>WaitPeriod</code>, it means that the actions are suppressed because the composite alarm is waiting for the suppressor alarm to go into into the <code>ALARM</code> state. The maximum waiting time is as specified in <code>ActionsSuppressorWaitPeriod</code>. After this time, the composite alarm performs its actions. When the value is <code>ExtensionPeriod</code>, it means that the actions are suppressed because the composite alarm is waiting after the suppressor alarm went out of the <code>ALARM</code> state. The maximum waiting time is as specified in <code>ActionsSuppressorExtensionPeriod</code>. After this time, the composite alarm performs its actions. </p>
        pub fn set_actions_suppressed_by(mut self, input: std::option::Option<crate::model::ActionsSuppressedBy>) -> Self {
...
pub struct AlarmHistoryItem  {
    ...
    #[doc(hidden)]pub alarm_type: std::option::Option<crate::model::AlarmType>,
    ...
    #[doc(hidden)]pub history_summary: std::option::Option<std::string::String>,
    /// <p>Data about the alarm, in JSON format.</p>
    #[doc(hidden)]pub history_data: std::option::Option<std::string::String>,
}
...
pub mod alarm_history_item {
    ...
    impl Builder {
        ...
        /// <p>The type of alarm, either metric alarm or composite alarm.</p>
        pub fn set_alarm_type(mut self, input: std::option::Option<crate::model::AlarmType>) -> Self {
