...
impl StartMetricStreamsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_metric_streams::StartMetricStreams,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMetricStreams {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_metric_streams::de_start_metric_streams_http_response_with_props(status, headers, body)
        }
    }
}
