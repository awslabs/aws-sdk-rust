...
impl DescribeAlarmsForMetricFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricOutput, crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricError, Self> {
