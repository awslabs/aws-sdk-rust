...
impl DescribeAnomalyDetectors {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeAnomalyDetectors {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeAnomalyDetectors");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeAnomalyDetectorsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeAnomalyDetectorsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeAnomalyDetectors")
...
.with_interceptor(DescribeAnomalyDetectorsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError>::new());
...
#[derive(Debug)]
            struct DescribeAnomalyDetectorsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeAnomalyDetectorsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_anomaly_detectors::de_describe_anomaly_detectors_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_describe_anomaly_detectors::de_describe_anomaly_detectors_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DescribeAnomalyDetectorsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeAnomalyDetectorsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_anomaly_detectors_input::ser_describe_anomaly_detectors_input_input_input(&input)?);
...
#[derive(Debug)]
            struct DescribeAnomalyDetectorsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeAnomalyDetectorsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeAnomalyDetectorsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeAnomalyDetectorsInput>()
                        .ok_or("failed to downcast to DescribeAnomalyDetectorsInput")?;
...
pub enum DescribeAnomalyDetectorsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeAnomalyDetectorsError) for what information is available for the error.")]
...
impl DescribeAnomalyDetectorsError {
    /// Creates the `DescribeAnomalyDetectorsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAnomalyDetectorsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeAnomalyDetectorsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_anomaly_detectors::DescribeAnomalyDetectorsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::describe_anomaly_detectors::_describe_anomaly_detectors_output::DescribeAnomalyDetectorsOutput;

pub use crate::operation::describe_anomaly_detectors::_describe_anomaly_detectors_input::DescribeAnomalyDetectorsInput;

mod _describe_anomaly_detectors_input;

mod _describe_anomaly_detectors_output;
