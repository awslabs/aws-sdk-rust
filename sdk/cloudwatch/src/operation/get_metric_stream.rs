...
impl GetMetricStream {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudwatch", "GetMetricStream", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMetricStream {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetMetricStream", "cloudwatch"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMetricStreamRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_metric_stream_input::ser_get_metric_stream_input_input_input(&input)?,
        );
