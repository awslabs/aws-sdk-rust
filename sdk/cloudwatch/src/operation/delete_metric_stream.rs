...
impl DeleteMetricStreamInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_metric_stream::DeleteMetricStream,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMetricStream {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_metric_stream::de_delete_metric_stream_http_response_with_props(status, headers, body)
        }
    }
}
