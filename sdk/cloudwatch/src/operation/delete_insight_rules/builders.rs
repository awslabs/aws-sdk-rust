...
impl DeleteInsightRulesFluentBuilder  {
    /// Creates a new `DeleteInsightRules`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_insight_rules::DeleteInsightRulesOutput, aws_smithy_http::result::SdkError<crate::operation::delete_insight_rules::DeleteInsightRulesError>>
                     {
