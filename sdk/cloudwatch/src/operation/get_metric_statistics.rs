...
/// Orchestration and serialization glue logic for `GetMetricStatistics`.
...
impl GetMetricStatistics {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_metric_statistics::GetMetricStatisticsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_metric_statistics::GetMetricStatisticsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_metric_statistics::GetMetricStatisticsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_metric_statistics::GetMetricStatisticsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMetricStatistics {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetMetricStatistics");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetMetricStatisticsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetMetricStatisticsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMetricStatistics")
...
.with_interceptor(GetMetricStatisticsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_metric_statistics::GetMetricStatisticsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_metric_statistics::GetMetricStatisticsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_metric_statistics::GetMetricStatisticsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMetricStatisticsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_metric_statistics::de_get_metric_statistics_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_metric_statistics::de_get_metric_statistics_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMetricStatisticsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_metric_statistics::GetMetricStatisticsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_metric_statistics::GetMetricStatisticsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_metric_statistics_input::ser_get_metric_statistics_input_input_input(&input)?);
...
#[derive(Debug)]
            struct GetMetricStatisticsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetMetricStatisticsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetMetricStatisticsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetMetricStatisticsInput>()
                        .ok_or("failed to downcast to GetMetricStatisticsInput")?;
...
pub enum GetMetricStatisticsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetMetricStatisticsError) for what information is available for the error.")]
...
impl GetMetricStatisticsError {
    /// Creates the `GetMetricStatisticsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMetricStatisticsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetMetricStatisticsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_metric_statistics::GetMetricStatisticsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_metric_statistics::_get_metric_statistics_output::GetMetricStatisticsOutput;

pub use crate::operation::get_metric_statistics::_get_metric_statistics_input::GetMetricStatisticsInput;

mod _get_metric_statistics_input;

mod _get_metric_statistics_output;
