...
impl DisableAlarmActionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::disable_alarm_actions::DisableAlarmActionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_alarm_actions::DisableAlarmActionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::disable_alarm_actions::DisableAlarmActionsOutput, crate::operation::disable_alarm_actions::DisableAlarmActionsError, Self> {
