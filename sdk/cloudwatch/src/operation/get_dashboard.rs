...
impl GetDashboardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_dashboard::GetDashboard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_dashboard::de_get_dashboard_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_dashboard::de_get_dashboard_http_response_with_props(
                status, headers, body,
            )
        }
    }
