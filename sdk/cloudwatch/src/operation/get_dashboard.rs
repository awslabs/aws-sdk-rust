...
impl GetDashboardInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_dashboard::GetDashboard, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_dashboard_input::ser_get_dashboard_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_dashboard::de_get_dashboard_http_response_with_props(status, headers, body)
        }
    }
}
