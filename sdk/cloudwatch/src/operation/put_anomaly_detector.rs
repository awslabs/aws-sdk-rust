...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutAnomalyDetectorTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("Stat") {
            if let ::std::option::Option::Some(value) = input.stat.as_deref() {
                captured.insert("Stat", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GraniteServiceVersion20100801/operation/PutAnomalyDetector").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
