...
impl ListMetricsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_metrics::ListMetrics, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_metrics_input::ser_list_metrics_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMetrics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_metrics::de_list_metrics_http_response_with_props(status, headers, body)
        }
    }
}
