...
impl ListMetrics {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudWatch", "ListMetrics", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMetrics {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListMetrics", "CloudWatch"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMetricsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("OwningAccount") {
            if let ::std::option::Option::Some(value) = input.owning_account.as_deref() {
                captured.insert("OwningAccount", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GraniteServiceVersion20100801/operation/ListMetrics").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_metrics::ser_list_metrics_input(&input)?);
