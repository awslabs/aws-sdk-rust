...
impl GetMetricDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_metric_data::GetMetricData,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_metric_data_input::ser_get_metric_data_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_metric_data::GetMetricData::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMetricData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_metric_data::de_get_metric_data_http_error(
                status, headers, body,
            )
        } else {
