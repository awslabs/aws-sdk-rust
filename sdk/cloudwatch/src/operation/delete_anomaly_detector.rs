...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAnomalyDetector {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteAnomalyDetector", "cloudwatch"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAnomalyDetectorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_anomaly_detector_input::ser_delete_anomaly_detector_input_input(&input)?,
        );
