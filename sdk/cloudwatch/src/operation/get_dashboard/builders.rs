...
impl GetDashboardFluentBuilder  {
    /// Creates a new `GetDashboard`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_dashboard::GetDashboardOutput, aws_smithy_http::result::SdkError<crate::operation::get_dashboard::GetDashboardError>>
                     {
