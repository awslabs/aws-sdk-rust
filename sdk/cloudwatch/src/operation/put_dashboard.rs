...
impl PutDashboardInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_dashboard::PutDashboard::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_dashboard::de_put_dashboard_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_dashboard::de_put_dashboard_http_response_with_props(
                status, headers, body,
            )
        }
    }
