...
impl PutDashboardInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_dashboard::PutDashboard, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_dashboard_input::ser_put_dashboard_input_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutDashboard {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_dashboard::de_put_dashboard_http_response_with_props(status, headers, body)
        }
    }
}
