...
impl PutMetricAlarmInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_metric_alarm_input::ser_put_metric_alarm_input_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_metric_alarm::PutMetricAlarm::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for PutMetricAlarm {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_metric_alarm::de_put_metric_alarm_http_error(
                status, headers, body,
            )
        } else {
