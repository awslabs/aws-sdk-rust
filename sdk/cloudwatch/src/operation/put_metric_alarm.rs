...
impl PutMetricAlarm {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_metric_alarm::PutMetricAlarmError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_metric_alarm::PutMetricAlarmOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CloudWatch", "PutMetricAlarm", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMetricAlarm {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutMetricAlarmRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutMetricAlarmResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutMetricAlarm")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutMetricAlarmResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_metric_alarm::de_put_metric_alarm_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_metric_alarm::de_put_metric_alarm_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMetricAlarmRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_metric_alarm::PutMetricAlarmInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_metric_alarm::PutMetricAlarmInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/GraniteServiceVersion20100801/operation/PutMetricAlarm").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_metric_alarm::ser_put_metric_alarm_input(&input)?);
