...
impl PutMetricAlarmInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_metric_alarm::PutMetricAlarm, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricAlarm {
    type Output =
        ::std::result::Result<crate::operation::put_metric_alarm::PutMetricAlarmOutput, crate::operation::put_metric_alarm::PutMetricAlarmError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_metric_alarm::de_put_metric_alarm_http_response_with_props(status, headers, body)
        }
    }
}
