...
impl PutCompositeAlarmFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_composite_alarm::PutCompositeAlarmOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_composite_alarm::PutCompositeAlarmError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_composite_alarm::PutCompositeAlarmOutput, crate::operation::put_composite_alarm::PutCompositeAlarmError, Self> {
