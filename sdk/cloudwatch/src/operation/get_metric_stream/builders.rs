...
impl GetMetricStreamFluentBuilder  {
    /// Creates a new `GetMetricStream`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_metric_stream::GetMetricStream, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_metric_stream::GetMetricStreamError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_metric_stream::GetMetricStreamOutput, aws_smithy_http::result::SdkError<crate::operation::get_metric_stream::GetMetricStreamError>>
                     {
