...
impl PutMetricStreamInput {
    /// Consumes the builder and constructs an Operation<[`PutMetricStream`](crate::operation::put_metric_stream::PutMetricStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_metric_stream::PutMetricStream, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_metric_stream::PutMetricStreamInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_metric_stream::PutMetricStream::new())
...
impl aws_smithy_http::response::ParseStrictResponse for PutMetricStream {
                type Output = std::result::Result<crate::operation::put_metric_stream::PutMetricStreamOutput, crate::operation::put_metric_stream::PutMetricStreamError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_metric_stream::de_put_metric_stream_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_metric_stream::de_put_metric_stream_http_response(response)
                     }
                }
            }
