...
impl PutMetricDataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_metric_data::PutMetricData, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricData {
    type Output =
        ::std::result::Result<crate::operation::put_metric_data::PutMetricDataOutput, crate::operation::put_metric_data::PutMetricDataError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_metric_data::de_put_metric_data_http_response_with_props(status, headers, body)
        }
    }
}
