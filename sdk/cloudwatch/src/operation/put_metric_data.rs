...
impl PutMetricDataInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_metric_data_input::ser_put_metric_data_input_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_metric_data::PutMetricData::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMetricData {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_put_metric_data::de_put_metric_data_http_error(
                status, headers, body,
            )
        } else {
