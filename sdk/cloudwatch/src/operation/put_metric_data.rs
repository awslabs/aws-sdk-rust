...
impl PutMetricDataInput {
    /// Consumes the builder and constructs an Operation<[`PutMetricData`](crate::operation::put_metric_data::PutMetricData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_metric_data::PutMetricData, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_metric_data::PutMetricDataInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_metric_data_input::ser_put_metric_data_input_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_metric_data::PutMetricData::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutMetricData", "cloudwatch"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutMetricData {
                type Output = std::result::Result<crate::operation::put_metric_data::PutMetricDataOutput, crate::operation::put_metric_data::PutMetricDataError>;
