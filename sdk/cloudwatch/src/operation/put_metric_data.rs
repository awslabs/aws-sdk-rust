...
impl PutMetricData {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("cloudwatch", "PutMetricData", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutMetricData {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutMetricData", "cloudwatch"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutMetricDataRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_metric_data_input::ser_put_metric_data_input_input_input(&input)?,
        );
