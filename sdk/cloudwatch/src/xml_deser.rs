...
#[allow(unused_mut)]pub fn deser_structure_crate_error_resource_not_found_xml_err(inp: &[u8], mut builder: crate::error::resource_not_found::Builder) -> Result<crate::error::resource_not_found::Builder, aws_smithy_xml::decode::XmlError> {
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_internal_service_fault_xml_err(inp: &[u8], mut builder: crate::error::internal_service_fault::Builder) -> Result<crate::error::internal_service_fault::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_missing_required_parameter_exception_xml_err(inp: &[u8], mut builder: crate::error::missing_required_parameter_exception::Builder) -> Result<crate::error::missing_required_parameter_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_resource_not_found_exception_xml_err(inp: &[u8], mut builder: crate::error::resource_not_found_exception::Builder) -> Result<crate::error::resource_not_found_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_dashboard_not_found_error_xml_err(inp: &[u8], mut builder: crate::error::dashboard_not_found_error::Builder) -> Result<crate::error::dashboard_not_found_error::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_delete_insight_rules(inp: &[u8], mut builder: crate::output::delete_insight_rules_output::Builder) -> Result<crate::output::delete_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    ...
    if !(start_el.matches("DeleteInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DeleteInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DeleteInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DeleteInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DeleteInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_invalid_next_token_xml_err(inp: &[u8], mut builder: crate::error::invalid_next_token::Builder) -> Result<crate::error::invalid_next_token::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_alarm_history(inp: &[u8], mut builder: crate::output::describe_alarm_history_output::Builder) -> Result<crate::output::describe_alarm_history_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeAlarmHistoryResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeAlarmHistoryResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeAlarmHistoryResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeAlarmHistoryResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeAlarmHistoryResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_alarms(inp: &[u8], mut builder: crate::output::describe_alarms_output::Builder) -> Result<crate::output::describe_alarms_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeAlarmsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeAlarmsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeAlarmsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeAlarmsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeAlarmsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_alarms_for_metric(inp: &[u8], mut builder: crate::output::describe_alarms_for_metric_output::Builder) -> Result<crate::output::describe_alarms_for_metric_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeAlarmsForMetricResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeAlarmsForMetricResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeAlarmsForMetricResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeAlarmsForMetricResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeAlarmsForMetricResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_anomaly_detectors(inp: &[u8], mut builder: crate::output::describe_anomaly_detectors_output::Builder) -> Result<crate::output::describe_anomaly_detectors_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeAnomalyDetectorsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeAnomalyDetectorsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeAnomalyDetectorsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeAnomalyDetectorsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeAnomalyDetectorsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_describe_insight_rules(inp: &[u8], mut builder: crate::output::describe_insight_rules_output::Builder) -> Result<crate::output::describe_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DescribeInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DescribeInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DescribeInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DescribeInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DescribeInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_disable_insight_rules(inp: &[u8], mut builder: crate::output::disable_insight_rules_output::Builder) -> Result<crate::output::disable_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("DisableInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected DisableInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("DisableInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected DisableInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected DisableInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_limit_exceeded_exception_xml_err(inp: &[u8], mut builder: crate::error::limit_exceeded_exception::Builder) -> Result<crate::error::limit_exceeded_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_enable_insight_rules(inp: &[u8], mut builder: crate::output::enable_insight_rules_output::Builder) -> Result<crate::output::enable_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("EnableInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected EnableInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("EnableInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected EnableInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected EnableInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_dashboard(inp: &[u8], mut builder: crate::output::get_dashboard_output::Builder) -> Result<crate::output::get_dashboard_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetDashboardResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetDashboardResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetDashboardResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetDashboardResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetDashboardResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_insight_rule_report(inp: &[u8], mut builder: crate::output::get_insight_rule_report_output::Builder) -> Result<crate::output::get_insight_rule_report_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetInsightRuleReportResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetInsightRuleReportResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetInsightRuleReportResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetInsightRuleReportResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetInsightRuleReportResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_metric_data(inp: &[u8], mut builder: crate::output::get_metric_data_output::Builder) -> Result<crate::output::get_metric_data_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetMetricDataResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetMetricDataResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetMetricDataResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetMetricDataResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetMetricDataResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_metric_statistics(inp: &[u8], mut builder: crate::output::get_metric_statistics_output::Builder) -> Result<crate::output::get_metric_statistics_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetMetricStatisticsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetMetricStatisticsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetMetricStatisticsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetMetricStatisticsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetMetricStatisticsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_metric_stream(inp: &[u8], mut builder: crate::output::get_metric_stream_output::Builder) -> Result<crate::output::get_metric_stream_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetMetricStreamResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetMetricStreamResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetMetricStreamResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetMetricStreamResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetMetricStreamResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_get_metric_widget_image(inp: &[u8], mut builder: crate::output::get_metric_widget_image_output::Builder) -> Result<crate::output::get_metric_widget_image_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("GetMetricWidgetImageResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected GetMetricWidgetImageResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("GetMetricWidgetImageResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected GetMetricWidgetImageResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected GetMetricWidgetImageResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_list_dashboards(inp: &[u8], mut builder: crate::output::list_dashboards_output::Builder) -> Result<crate::output::list_dashboards_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("ListDashboardsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ListDashboardsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ListDashboardsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ListDashboardsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ListDashboardsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_list_managed_insight_rules(inp: &[u8], mut builder: crate::output::list_managed_insight_rules_output::Builder) -> Result<crate::output::list_managed_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("ListManagedInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ListManagedInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ListManagedInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ListManagedInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ListManagedInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_list_metrics(inp: &[u8], mut builder: crate::output::list_metrics_output::Builder) -> Result<crate::output::list_metrics_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("ListMetricsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ListMetricsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ListMetricsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ListMetricsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ListMetricsResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_list_metric_streams(inp: &[u8], mut builder: crate::output::list_metric_streams_output::Builder) -> Result<crate::output::list_metric_streams_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("ListMetricStreamsResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected ListMetricStreamsResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ListMetricStreamsResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected ListMetricStreamsResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Entries") /* Entries com.amazonaws.cloudwatch.synthetic#ListMetricStreamsOutput$Entries */ =>  {
                ...
                ;
                builder = builder.set_entries(var_58);
            }
            ,
            _ => {}
        }
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected ListMetricStreamsResult tag"))
                    };
    Ok(builder)
}
    ...
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            s if s.matches("Tags") /* Tags com.amazonaws.cloudwatch.synthetic#ListTagsForResourceOutput$Tags */ =>  {
                ...
                ;
                builder = builder.set_tags(var_59);
            }
            ,
            _ => {}
        }
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_limit_exceeded_fault_xml_err(inp: &[u8], mut builder: crate::error::limit_exceeded_fault::Builder) -> Result<crate::error::limit_exceeded_fault::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_structure_crate_error_dashboard_invalid_input_error_xml_err(inp: &[u8], mut builder: crate::error::dashboard_invalid_input_error::Builder) -> Result<crate::error::dashboard_invalid_input_error::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_put_dashboard(inp: &[u8], mut builder: crate::output::put_dashboard_output::Builder) -> Result<crate::output::put_dashboard_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("PutDashboardResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected PutDashboardResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("PutDashboardResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected PutDashboardResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected PutDashboardResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_operation_crate_operation_put_managed_insight_rules(inp: &[u8], mut builder: crate::output::put_managed_insight_rules_output::Builder) -> Result<crate::output::put_managed_insight_rules_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("PutManagedInsightRulesResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected PutManagedInsightRulesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("PutManagedInsightRulesResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected PutManagedInsightRulesResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            s if s.matches("Failures") /* Failures com.amazonaws.cloudwatch.synthetic#PutManagedInsightRulesOutput$Failures */ =>  {
                ...
                ;
                builder = builder.set_failures(var_64);
            }
            ,
            _ => {}
        }
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected PutManagedInsightRulesResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_concurrent_modification_exception_xml_err(inp: &[u8], mut builder: crate::error::concurrent_modification_exception::Builder) -> Result<crate::error::concurrent_modification_exception::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
#[allow(unused_mut)]pub fn deser_operation_crate_operation_put_metric_stream(inp: &[u8], mut builder: crate::output::put_metric_stream_output::Builder) -> Result<crate::output::put_metric_stream_output::Builder, aws_smithy_xml::decode::XmlError> {
    let mut doc = aws_smithy_xml::decode::Document::try_from(inp)?;
    ...
    if !(start_el.matches("PutMetricStreamResponse")) {
                        return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid root, expected PutMetricStreamResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("PutMetricStreamResult")) {
                            return Err(aws_smithy_xml::decode::XmlError::custom(format!("invalid result, expected PutMetricStreamResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            s if s.matches("Arn") /* Arn com.amazonaws.cloudwatch.synthetic#PutMetricStreamOutput$Arn */ =>  {
                ...
                ;
                builder = builder.set_arn(var_66);
            }
            ,
            _ => {}
        }
                        ...
                        return Err(aws_smithy_xml::decode::XmlError::custom("expected PutMetricStreamResult tag"))
                    };
    Ok(builder)
}

#[allow(unused_mut)]pub fn deser_structure_crate_error_invalid_format_fault_xml_err(inp: &[u8], mut builder: crate::error::invalid_format_fault::Builder) -> Result<crate::error::invalid_format_fault::Builder, aws_smithy_xml::decode::XmlError> {
    if inp.is_empty() { return Ok(builder) }
    let mut document = aws_smithy_xml::decode::Document::try_from(inp)?;
                            #[allow(unused_mut)]
                            let mut error_decoder = crate::rest_xml_wrapped_errors::error_scope(&mut document)?;
...
pub fn deser_list_com_amazonaws_cloudwatch_batch_failures(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::PartialFailure>, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_cloudwatch_alarm_history_items(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::AlarmHistoryItem>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_composite_alarms(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::CompositeAlarm>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_alarms(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricAlarm>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_anomaly_detectors(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::AnomalyDetector>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rules(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::InsightRule>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rule_contributor_key_labels(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rule_contributors(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::InsightRuleContributor>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rule_metric_datapoints(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::InsightRuleMetricDatapoint>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_data_results(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricDataResult>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_data_result_messages(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MessageData>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_datapoints(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Datapoint>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_stream_filters(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricStreamFilter>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_stream_statistics_configurations(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricStreamStatisticsConfiguration>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_dashboard_entries(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::DashboardEntry>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_managed_rule_descriptions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::ManagedRuleDescription>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Metric>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_stream_entries(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricStreamEntry>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_tag_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Tag>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_dashboard_validation_messages(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::DashboardValidationMessage>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_partial_failure(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::PartialFailure, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::PartialFailure::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("FailureResource") /* FailureResource com.amazonaws.cloudwatch#PartialFailure$FailureResource */ =>  {
                ...
                ;
                builder = builder.set_failure_resource(var_68);
            }
            ,
            s if s.matches("ExceptionType") /* ExceptionType com.amazonaws.cloudwatch#PartialFailure$ExceptionType */ =>  {
                ...
                ;
                builder = builder.set_exception_type(var_69);
            }
            ,
            s if s.matches("FailureCode") /* FailureCode com.amazonaws.cloudwatch#PartialFailure$FailureCode */ =>  {
                ...
                ;
                builder = builder.set_failure_code(var_70);
            }
            ,
            s if s.matches("FailureDescription") /* FailureDescription com.amazonaws.cloudwatch#PartialFailure$FailureDescription */ =>  {
                ...
                ;
                builder = builder.set_failure_description(var_71);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_alarm_history_item(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AlarmHistoryItem, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::AlarmHistoryItem::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("AlarmName") /* AlarmName com.amazonaws.cloudwatch#AlarmHistoryItem$AlarmName */ =>  {
                ...
                ;
                builder = builder.set_alarm_name(var_72);
            }
            ,
            s if s.matches("AlarmType") /* AlarmType com.amazonaws.cloudwatch#AlarmHistoryItem$AlarmType */ =>  {
                ...
                ;
                builder = builder.set_alarm_type(var_73);
            }
            ,
            s if s.matches("Timestamp") /* Timestamp com.amazonaws.cloudwatch#AlarmHistoryItem$Timestamp */ =>  {
                ...
                ;
                builder = builder.set_timestamp(var_74);
            }
            ,
            s if s.matches("HistoryItemType") /* HistoryItemType com.amazonaws.cloudwatch#AlarmHistoryItem$HistoryItemType */ =>  {
                ...
                ;
                builder = builder.set_history_item_type(var_75);
            }
            ,
            s if s.matches("HistorySummary") /* HistorySummary com.amazonaws.cloudwatch#AlarmHistoryItem$HistorySummary */ =>  {
                ...
                ;
                builder = builder.set_history_summary(var_76);
            }
            ,
            s if s.matches("HistoryData") /* HistoryData com.amazonaws.cloudwatch#AlarmHistoryItem$HistoryData */ =>  {
                ...
                ;
                builder = builder.set_history_data(var_77);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_composite_alarm(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::CompositeAlarm, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::CompositeAlarm::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("ActionsEnabled") /* ActionsEnabled com.amazonaws.cloudwatch#CompositeAlarm$ActionsEnabled */ =>  {
                ...
                ;
                builder = builder.set_actions_enabled(var_78);
            }
            ,
            s if s.matches("AlarmActions") /* AlarmActions com.amazonaws.cloudwatch#CompositeAlarm$AlarmActions */ =>  {
                ...
                ;
                builder = builder.set_alarm_actions(var_79);
            }
            ,
            s if s.matches("AlarmArn") /* AlarmArn com.amazonaws.cloudwatch#CompositeAlarm$AlarmArn */ =>  {
                ...
                ;
                builder = builder.set_alarm_arn(var_80);
            }
            ,
            s if s.matches("AlarmConfigurationUpdatedTimestamp") /* AlarmConfigurationUpdatedTimestamp com.amazonaws.cloudwatch#CompositeAlarm$AlarmConfigurationUpdatedTimestamp */ =>  {
                ...
                ;
                builder = builder.set_alarm_configuration_updated_timestamp(var_81);
            }
            ,
            s if s.matches("AlarmDescription") /* AlarmDescription com.amazonaws.cloudwatch#CompositeAlarm$AlarmDescription */ =>  {
                ...
                ;
                builder = builder.set_alarm_description(var_82);
            }
            ,
            s if s.matches("AlarmName") /* AlarmName com.amazonaws.cloudwatch#CompositeAlarm$AlarmName */ =>  {
                ...
                ;
                builder = builder.set_alarm_name(var_83);
            }
            ,
            s if s.matches("AlarmRule") /* AlarmRule com.amazonaws.cloudwatch#CompositeAlarm$AlarmRule */ =>  {
                ...
                ;
                builder = builder.set_alarm_rule(var_84);
            }
            ,
            s if s.matches("InsufficientDataActions") /* InsufficientDataActions com.amazonaws.cloudwatch#CompositeAlarm$InsufficientDataActions */ =>  {
                ...
                ;
                builder = builder.set_insufficient_data_actions(var_85);
            }
            ,
            s if s.matches("OKActions") /* OKActions com.amazonaws.cloudwatch#CompositeAlarm$OKActions */ =>  {
                ...
                ;
                builder = builder.set_ok_actions(var_86);
            }
            ,
            s if s.matches("StateReason") /* StateReason com.amazonaws.cloudwatch#CompositeAlarm$StateReason */ =>  {
                ...
                ;
                builder = builder.set_state_reason(var_87);
            }
            ,
            s if s.matches("StateReasonData") /* StateReasonData com.amazonaws.cloudwatch#CompositeAlarm$StateReasonData */ =>  {
                ...
                ;
                builder = builder.set_state_reason_data(var_88);
            }
            ,
            s if s.matches("StateUpdatedTimestamp") /* StateUpdatedTimestamp com.amazonaws.cloudwatch#CompositeAlarm$StateUpdatedTimestamp */ =>  {
                ...
                ;
                builder = builder.set_state_updated_timestamp(var_89);
            }
            ,
            s if s.matches("StateValue") /* StateValue com.amazonaws.cloudwatch#CompositeAlarm$StateValue */ =>  {
                ...
                ;
                builder = builder.set_state_value(var_90);
            }
            ,
            s if s.matches("StateTransitionedTimestamp") /* StateTransitionedTimestamp com.amazonaws.cloudwatch#CompositeAlarm$StateTransitionedTimestamp */ =>  {
                ...
                ;
                builder = builder.set_state_transitioned_timestamp(var_91);
            }
            ,
            s if s.matches("ActionsSuppressedBy") /* ActionsSuppressedBy com.amazonaws.cloudwatch#CompositeAlarm$ActionsSuppressedBy */ =>  {
                let var_92 =
                    Some(
                        Result::<crate::model::ActionsSuppressedBy, aws_smithy_xml::decode::XmlError>::Ok(
                ...
                ;
                builder = builder.set_actions_suppressed_by(var_92);
            }
            ,
            s if s.matches("ActionsSuppressedReason") /* ActionsSuppressedReason com.amazonaws.cloudwatch#CompositeAlarm$ActionsSuppressedReason */ =>  {
                ...
                ;
                builder = builder.set_actions_suppressed_reason(var_93);
            }
            ,
            s if s.matches("ActionsSuppressor") /* ActionsSuppressor com.amazonaws.cloudwatch#CompositeAlarm$ActionsSuppressor */ =>  {
                ...
                ;
                builder = builder.set_actions_suppressor(var_94);
            }
            ,
                    ...
                    Some(
                         {
                            ...
                            .map_err(|_|aws_smithy_xml::decode::XmlError::custom("expected (integer: `com.amazonaws.cloudwatch#SuppressorPeriod`)"))
                        }
                        ?
                    )
                ;
                builder = builder.set_actions_suppressor_wait_period(var_95);
            }
            ,
            s if s.matches("ActionsSuppressorExtensionPeriod") /* ActionsSuppressorExtensionPeriod com.amazonaws.cloudwatch#CompositeAlarm$ActionsSuppressorExtensionPeriod */ =>  {
                ...
                ;
                builder = builder.set_actions_suppressor_extension_period(var_96);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_alarm(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricAlarm, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricAlarm::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("AlarmName") /* AlarmName com.amazonaws.cloudwatch#MetricAlarm$AlarmName */ =>  {
                ...
                ;
                builder = builder.set_alarm_name(var_97);
            }
            ,
            s if s.matches("AlarmArn") /* AlarmArn com.amazonaws.cloudwatch#MetricAlarm$AlarmArn */ =>  {
                ...
                ;
                builder = builder.set_alarm_arn(var_98);
            }
            ,
            s if s.matches("AlarmDescription") /* AlarmDescription com.amazonaws.cloudwatch#MetricAlarm$AlarmDescription */ =>  {
                ...
                ;
                builder = builder.set_alarm_description(var_99);
            }
            ,
            s if s.matches("AlarmConfigurationUpdatedTimestamp") /* AlarmConfigurationUpdatedTimestamp com.amazonaws.cloudwatch#MetricAlarm$AlarmConfigurationUpdatedTimestamp */ =>  {
                ...
                ;
                builder = builder.set_alarm_configuration_updated_timestamp(var_100);
            }
            ,
            s if s.matches("ActionsEnabled") /* ActionsEnabled com.amazonaws.cloudwatch#MetricAlarm$ActionsEnabled */ =>  {
                ...
                ;
                builder = builder.set_actions_enabled(var_101);
            }
            ,
            s if s.matches("OKActions") /* OKActions com.amazonaws.cloudwatch#MetricAlarm$OKActions */ =>  {
                ...
                ;
                builder = builder.set_ok_actions(var_102);
            }
            ,
            s if s.matches("AlarmActions") /* AlarmActions com.amazonaws.cloudwatch#MetricAlarm$AlarmActions */ =>  {
                ...
                ;
                builder = builder.set_alarm_actions(var_103);
            }
            ,
            s if s.matches("InsufficientDataActions") /* InsufficientDataActions com.amazonaws.cloudwatch#MetricAlarm$InsufficientDataActions */ =>  {
                ...
                ;
                builder = builder.set_insufficient_data_actions(var_104);
            }
            ,
            s if s.matches("StateValue") /* StateValue com.amazonaws.cloudwatch#MetricAlarm$StateValue */ =>  {
                ...
                ;
                builder = builder.set_state_value(var_105);
            }
            ,
            s if s.matches("StateReason") /* StateReason com.amazonaws.cloudwatch#MetricAlarm$StateReason */ =>  {
                ...
                ;
                builder = builder.set_state_reason(var_106);
            }
            ,
            s if s.matches("StateReasonData") /* StateReasonData com.amazonaws.cloudwatch#MetricAlarm$StateReasonData */ =>  {
                ...
                ;
                builder = builder.set_state_reason_data(var_107);
            }
            ,
            s if s.matches("StateUpdatedTimestamp") /* StateUpdatedTimestamp com.amazonaws.cloudwatch#MetricAlarm$StateUpdatedTimestamp */ =>  {
                ...
                ;
                builder = builder.set_state_updated_timestamp(var_108);
            }
            ,
            s if s.matches("MetricName") /* MetricName com.amazonaws.cloudwatch#MetricAlarm$MetricName */ =>  {
                ...
                ;
                builder = builder.set_metric_name(var_109);
            }
            ,
            s if s.matches("Namespace") /* Namespace com.amazonaws.cloudwatch#MetricAlarm$Namespace */ =>  {
                ...
                ;
                builder = builder.set_namespace(var_110);
            }
            ,
            s if s.matches("Statistic") /* Statistic com.amazonaws.cloudwatch#MetricAlarm$Statistic */ =>  {
                ...
                ;
                builder = builder.set_statistic(var_111);
            }
            ,
            s if s.matches("ExtendedStatistic") /* ExtendedStatistic com.amazonaws.cloudwatch#MetricAlarm$ExtendedStatistic */ =>  {
                ...
                ;
                builder = builder.set_extended_statistic(var_112);
            }
            ,
            s if s.matches("Dimensions") /* Dimensions com.amazonaws.cloudwatch#MetricAlarm$Dimensions */ =>  {
                ...
                ;
                builder = builder.set_dimensions(var_113);
            }
            ,
            s if s.matches("Period") /* Period com.amazonaws.cloudwatch#MetricAlarm$Period */ =>  {
                ...
                ;
                builder = builder.set_period(var_114);
            }
            ,
            s if s.matches("Unit") /* Unit com.amazonaws.cloudwatch#MetricAlarm$Unit */ =>  {
                ...
                ;
                builder = builder.set_unit(var_115);
            }
            ,
            s if s.matches("EvaluationPeriods") /* EvaluationPeriods com.amazonaws.cloudwatch#MetricAlarm$EvaluationPeriods */ =>  {
                ...
                ;
                builder = builder.set_evaluation_periods(var_116);
            }
            ,
            s if s.matches("DatapointsToAlarm") /* DatapointsToAlarm com.amazonaws.cloudwatch#MetricAlarm$DatapointsToAlarm */ =>  {
                ...
                ;
                builder = builder.set_datapoints_to_alarm(var_117);
            }
            ,
            s if s.matches("Threshold") /* Threshold com.amazonaws.cloudwatch#MetricAlarm$Threshold */ =>  {
                ...
                ;
                builder = builder.set_threshold(var_118);
            }
            ,
            s if s.matches("ComparisonOperator") /* ComparisonOperator com.amazonaws.cloudwatch#MetricAlarm$ComparisonOperator */ =>  {
                ...
                ;
                builder = builder.set_comparison_operator(var_119);
            }
            ,
            s if s.matches("TreatMissingData") /* TreatMissingData com.amazonaws.cloudwatch#MetricAlarm$TreatMissingData */ =>  {
                ...
                ;
                builder = builder.set_treat_missing_data(var_120);
            }
            ,
            s if s.matches("EvaluateLowSampleCountPercentile") /* EvaluateLowSampleCountPercentile com.amazonaws.cloudwatch#MetricAlarm$EvaluateLowSampleCountPercentile */ =>  {
                ...
                ;
                builder = builder.set_evaluate_low_sample_count_percentile(var_121);
            }
            ,
            s if s.matches("Metrics") /* Metrics com.amazonaws.cloudwatch#MetricAlarm$Metrics */ =>  {
                ...
                ;
                builder = builder.set_metrics(var_122);
            }
            ,
            s if s.matches("ThresholdMetricId") /* ThresholdMetricId com.amazonaws.cloudwatch#MetricAlarm$ThresholdMetricId */ =>  {
                ...
                ;
                builder = builder.set_threshold_metric_id(var_123);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_anomaly_detector(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnomalyDetector, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::AnomalyDetector::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Namespace") /* Namespace com.amazonaws.cloudwatch#AnomalyDetector$Namespace */ =>  {
                ...
                ;
                builder = builder.set_namespace(var_124);
            }
            ,
            s if s.matches("MetricName") /* MetricName com.amazonaws.cloudwatch#AnomalyDetector$MetricName */ =>  {
                ...
                ;
                builder = builder.set_metric_name(var_125);
            }
            ,
            s if s.matches("Dimensions") /* Dimensions com.amazonaws.cloudwatch#AnomalyDetector$Dimensions */ =>  {
                ...
                ;
                builder = builder.set_dimensions(var_126);
            }
            ,
            s if s.matches("Stat") /* Stat com.amazonaws.cloudwatch#AnomalyDetector$Stat */ =>  {
                ...
                ;
                builder = builder.set_stat(var_127);
            }
            ,
            s if s.matches("Configuration") /* Configuration com.amazonaws.cloudwatch#AnomalyDetector$Configuration */ =>  {
                ...
                ;
                builder = builder.set_configuration(var_128);
            }
            ,
            s if s.matches("StateValue") /* StateValue com.amazonaws.cloudwatch#AnomalyDetector$StateValue */ =>  {
                ...
                ;
                builder = builder.set_state_value(var_129);
            }
            ,
            s if s.matches("SingleMetricAnomalyDetector") /* SingleMetricAnomalyDetector com.amazonaws.cloudwatch#AnomalyDetector$SingleMetricAnomalyDetector */ =>  {
                ...
                ;
                builder = builder.set_single_metric_anomaly_detector(var_130);
            }
            ,
            s if s.matches("MetricMathAnomalyDetector") /* MetricMathAnomalyDetector com.amazonaws.cloudwatch#AnomalyDetector$MetricMathAnomalyDetector */ =>  {
                ...
                ;
                builder = builder.set_metric_math_anomaly_detector(var_131);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_insight_rule(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRule, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::InsightRule::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Name") /* Name com.amazonaws.cloudwatch#InsightRule$Name */ =>  {
                ...
                ;
                builder = builder.set_name(var_132);
            }
            ,
            ...
            s if s.matches("Schema") /* Schema com.amazonaws.cloudwatch#InsightRule$Schema */ =>  {
                ...
                ;
                builder = builder.set_schema(var_134);
            }
            ,
            s if s.matches("Definition") /* Definition com.amazonaws.cloudwatch#InsightRule$Definition */ =>  {
                ...
                ;
                builder = builder.set_definition(var_135);
            }
            ,
                    ...
                    Some(
                         {
                            ...
                            .map_err(|_|aws_smithy_xml::decode::XmlError::custom("expected (boolean: `com.amazonaws.cloudwatch#InsightRuleIsManaged`)"))
                        }
                        ?
                    )
                ;
                builder = builder.set_managed_rule(var_136);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_insight_rule_contributor(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleContributor, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::InsightRuleContributor::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Keys") /* Keys com.amazonaws.cloudwatch#InsightRuleContributor$Keys */ =>  {
                ...
                ;
                builder = builder.set_keys(var_137);
            }
            ,
            s if s.matches("ApproximateAggregateValue") /* ApproximateAggregateValue com.amazonaws.cloudwatch#InsightRuleContributor$ApproximateAggregateValue */ =>  {
                ...
                ;
                builder = builder.set_approximate_aggregate_value(var_138);
            }
            ,
            s if s.matches("Datapoints") /* Datapoints com.amazonaws.cloudwatch#InsightRuleContributor$Datapoints */ =>  {
                ...
                ;
                builder = builder.set_datapoints(var_139);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_insight_rule_metric_datapoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleMetricDatapoint, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::InsightRuleMetricDatapoint::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Timestamp") /* Timestamp com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$Timestamp */ =>  {
                ...
                ;
                builder = builder.set_timestamp(var_140);
            }
            ,
            s if s.matches("UniqueContributors") /* UniqueContributors com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$UniqueContributors */ =>  {
                ...
                ;
                builder = builder.set_unique_contributors(var_141);
            }
            ,
            s if s.matches("MaxContributorValue") /* MaxContributorValue com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$MaxContributorValue */ =>  {
                ...
                ;
                builder = builder.set_max_contributor_value(var_142);
            }
            ,
            s if s.matches("SampleCount") /* SampleCount com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$SampleCount */ =>  {
                ...
                ;
                builder = builder.set_sample_count(var_143);
            }
            ,
            s if s.matches("Average") /* Average com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$Average */ =>  {
                ...
                ;
                builder = builder.set_average(var_144);
            }
            ,
            s if s.matches("Sum") /* Sum com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$Sum */ =>  {
                ...
                ;
                builder = builder.set_sum(var_145);
            }
            ,
            s if s.matches("Minimum") /* Minimum com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$Minimum */ =>  {
                ...
                ;
                builder = builder.set_minimum(var_146);
            }
            ,
            s if s.matches("Maximum") /* Maximum com.amazonaws.cloudwatch#InsightRuleMetricDatapoint$Maximum */ =>  {
                ...
                ;
                builder = builder.set_maximum(var_147);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_data_result(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricDataResult, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricDataResult::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Label") /* Label com.amazonaws.cloudwatch#MetricDataResult$Label */ =>  {
                ...
                ;
                builder = builder.set_label(var_149);
            }
            ,
            s if s.matches("Timestamps") /* Timestamps com.amazonaws.cloudwatch#MetricDataResult$Timestamps */ =>  {
                ...
                ;
                builder = builder.set_timestamps(var_150);
            }
            ,
            s if s.matches("Values") /* Values com.amazonaws.cloudwatch#MetricDataResult$Values */ =>  {
                ...
                ;
                builder = builder.set_values(var_151);
            }
            ,
            s if s.matches("StatusCode") /* StatusCode com.amazonaws.cloudwatch#MetricDataResult$StatusCode */ =>  {
                ...
                ;
                builder = builder.set_status_code(var_152);
            }
            ,
            s if s.matches("Messages") /* Messages com.amazonaws.cloudwatch#MetricDataResult$Messages */ =>  {
                ...
                ;
                builder = builder.set_messages(var_153);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_message_data(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MessageData, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MessageData::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Code") /* Code com.amazonaws.cloudwatch#MessageData$Code */ =>  {
                ...
                ;
                builder = builder.set_code(var_154);
            }
            ,
            s if s.matches("Value") /* Value com.amazonaws.cloudwatch#MessageData$Value */ =>  {
                ...
                ;
                builder = builder.set_value(var_155);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_datapoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Datapoint, aws_smithy_xml::decode::XmlError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Timestamp") /* Timestamp com.amazonaws.cloudwatch#Datapoint$Timestamp */ =>  {
                ...
                ;
                builder = builder.set_timestamp(var_156);
            }
            ,
            s if s.matches("SampleCount") /* SampleCount com.amazonaws.cloudwatch#Datapoint$SampleCount */ =>  {
                ...
                ;
                builder = builder.set_sample_count(var_157);
            }
            ,
            s if s.matches("Average") /* Average com.amazonaws.cloudwatch#Datapoint$Average */ =>  {
                ...
                ;
                builder = builder.set_average(var_158);
            }
            ,
            s if s.matches("Sum") /* Sum com.amazonaws.cloudwatch#Datapoint$Sum */ =>  {
                ...
                ;
                builder = builder.set_sum(var_159);
            }
            ,
            s if s.matches("Minimum") /* Minimum com.amazonaws.cloudwatch#Datapoint$Minimum */ =>  {
                ...
                ;
                builder = builder.set_minimum(var_160);
            }
            ,
            s if s.matches("Maximum") /* Maximum com.amazonaws.cloudwatch#Datapoint$Maximum */ =>  {
                ...
                ;
                builder = builder.set_maximum(var_161);
            }
            ,
            s if s.matches("Unit") /* Unit com.amazonaws.cloudwatch#Datapoint$Unit */ =>  {
                ...
                ;
                builder = builder.set_unit(var_162);
            }
            ,
            s if s.matches("ExtendedStatistics") /* ExtendedStatistics com.amazonaws.cloudwatch#Datapoint$ExtendedStatistics */ =>  {
                ...
                ;
                builder = builder.set_extended_statistics(var_163);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_stream_filter(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStreamFilter, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricStreamFilter::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Namespace") /* Namespace com.amazonaws.cloudwatch#MetricStreamFilter$Namespace */ =>  {
                ...
                ;
                builder = builder.set_namespace(var_164);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_stream_statistics_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStreamStatisticsConfiguration, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricStreamStatisticsConfiguration::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("IncludeMetrics") /* IncludeMetrics com.amazonaws.cloudwatch#MetricStreamStatisticsConfiguration$IncludeMetrics */ =>  {
                ...
                ;
                builder = builder.set_include_metrics(var_165);
            }
            ,
            s if s.matches("AdditionalStatistics") /* AdditionalStatistics com.amazonaws.cloudwatch#MetricStreamStatisticsConfiguration$AdditionalStatistics */ =>  {
                ...
                ;
                builder = builder.set_additional_statistics(var_166);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_dashboard_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DashboardEntry, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::DashboardEntry::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("DashboardName") /* DashboardName com.amazonaws.cloudwatch#DashboardEntry$DashboardName */ =>  {
                ...
                ;
                builder = builder.set_dashboard_name(var_167);
            }
            ,
            s if s.matches("DashboardArn") /* DashboardArn com.amazonaws.cloudwatch#DashboardEntry$DashboardArn */ =>  {
                ...
                ;
                builder = builder.set_dashboard_arn(var_168);
            }
            ,
            s if s.matches("LastModified") /* LastModified com.amazonaws.cloudwatch#DashboardEntry$LastModified */ =>  {
                ...
                ;
                builder = builder.set_last_modified(var_169);
            }
            ,
            s if s.matches("Size") /* Size com.amazonaws.cloudwatch#DashboardEntry$Size */ =>  {
                ...
                ;
                builder = builder.set_size(var_170);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_managed_rule_description(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedRuleDescription, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::ManagedRuleDescription::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("TemplateName") /* TemplateName com.amazonaws.cloudwatch#ManagedRuleDescription$TemplateName */ =>  {
                ...
                ;
                builder = builder.set_template_name(var_171);
            }
            ,
            s if s.matches("ResourceARN") /* ResourceARN com.amazonaws.cloudwatch#ManagedRuleDescription$ResourceARN */ =>  {
                ...
                ;
                builder = builder.set_resource_arn(var_172);
            }
            ,
            s if s.matches("RuleState") /* RuleState com.amazonaws.cloudwatch#ManagedRuleDescription$RuleState */ =>  {
                ...
                ;
                builder = builder.set_rule_state(var_173);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Metric, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_metric_stream_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStreamEntry, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricStreamEntry::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Arn") /* Arn com.amazonaws.cloudwatch#MetricStreamEntry$Arn */ =>  {
                ...
                ;
                builder = builder.set_arn(var_177);
            }
            ,
            s if s.matches("CreationDate") /* CreationDate com.amazonaws.cloudwatch#MetricStreamEntry$CreationDate */ =>  {
                ...
                ;
                builder = builder.set_creation_date(var_178);
            }
            ,
            s if s.matches("LastUpdateDate") /* LastUpdateDate com.amazonaws.cloudwatch#MetricStreamEntry$LastUpdateDate */ =>  {
                ...
                ;
                builder = builder.set_last_update_date(var_179);
            }
            ,
            s if s.matches("Name") /* Name com.amazonaws.cloudwatch#MetricStreamEntry$Name */ =>  {
                ...
                ;
                builder = builder.set_name(var_180);
            }
            ,
            s if s.matches("FirehoseArn") /* FirehoseArn com.amazonaws.cloudwatch#MetricStreamEntry$FirehoseArn */ =>  {
                ...
                ;
                builder = builder.set_firehose_arn(var_181);
            }
            ,
            s if s.matches("State") /* State com.amazonaws.cloudwatch#MetricStreamEntry$State */ =>  {
                ...
                ;
                builder = builder.set_state(var_182);
            }
            ,
            s if s.matches("OutputFormat") /* OutputFormat com.amazonaws.cloudwatch#MetricStreamEntry$OutputFormat */ =>  {
                ...
                ;
                builder = builder.set_output_format(var_183);
            }
            ,
            _ => {}
        }
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Key") /* Key com.amazonaws.cloudwatch#Tag$Key */ =>  {
                ...
                ;
                builder = builder.set_key(var_184);
            }
            ,
            s if s.matches("Value") /* Value com.amazonaws.cloudwatch#Tag$Value */ =>  {
                ...
                ;
                builder = builder.set_value(var_185);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_dashboard_validation_message(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::DashboardValidationMessage, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::DashboardValidationMessage::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("DataPath") /* DataPath com.amazonaws.cloudwatch#DashboardValidationMessage$DataPath */ =>  {
                ...
                ;
                builder = builder.set_data_path(var_186);
            }
            ,
...
pub fn deser_list_com_amazonaws_cloudwatch_resource_list(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_dimensions(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Dimension>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_data_queries(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricDataQuery>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_anomaly_detector_configuration(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::AnomalyDetectorConfiguration, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::AnomalyDetectorConfiguration::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("ExcludedTimeRanges") /* ExcludedTimeRanges com.amazonaws.cloudwatch#AnomalyDetectorConfiguration$ExcludedTimeRanges */ =>  {
                ...
                ;
                builder = builder.set_excluded_time_ranges(var_188);
            }
            ,
            s if s.matches("MetricTimezone") /* MetricTimezone com.amazonaws.cloudwatch#AnomalyDetectorConfiguration$MetricTimezone */ =>  {
                ...
                ;
                builder = builder.set_metric_timezone(var_189);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_single_metric_anomaly_detector(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::SingleMetricAnomalyDetector, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::SingleMetricAnomalyDetector::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Namespace") /* Namespace com.amazonaws.cloudwatch#SingleMetricAnomalyDetector$Namespace */ =>  {
                ...
                ;
                builder = builder.set_namespace(var_190);
            }
            ,
            s if s.matches("MetricName") /* MetricName com.amazonaws.cloudwatch#SingleMetricAnomalyDetector$MetricName */ =>  {
                ...
                ;
                builder = builder.set_metric_name(var_191);
            }
            ,
            s if s.matches("Dimensions") /* Dimensions com.amazonaws.cloudwatch#SingleMetricAnomalyDetector$Dimensions */ =>  {
                ...
                ;
                builder = builder.set_dimensions(var_192);
            }
            ,
            s if s.matches("Stat") /* Stat com.amazonaws.cloudwatch#SingleMetricAnomalyDetector$Stat */ =>  {
                ...
                ;
                builder = builder.set_stat(var_193);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_math_anomaly_detector(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricMathAnomalyDetector, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricMathAnomalyDetector::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rule_contributor_keys(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_insight_rule_contributor_datapoints(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::InsightRuleContributorDatapoint>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_timestamps(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<aws_smithy_types::DateTime>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_datapoint_values(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<f64>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_map_com_amazonaws_cloudwatch_datapoint_value_map(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::collections::HashMap<std::string::String, f64>, aws_smithy_xml::decode::XmlError> {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_stream_statistics_include_metrics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::MetricStreamStatisticsMetric>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_list_com_amazonaws_cloudwatch_metric_stream_statistics_additional_statistics(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<std::string::String>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_managed_rule_state(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::ManagedRuleState, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::ManagedRuleState::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("RuleName") /* RuleName com.amazonaws.cloudwatch#ManagedRuleState$RuleName */ =>  {
                ...
                ;
                builder = builder.set_rule_name(var_195);
            }
            ,
            s if s.matches("State") /* State com.amazonaws.cloudwatch#ManagedRuleState$State */ =>  {
                ...
                ;
                builder = builder.set_state(var_196);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_dimension(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Dimension, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::Dimension::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Name") /* Name com.amazonaws.cloudwatch#Dimension$Name */ =>  {
                ...
                ;
                builder = builder.set_name(var_197);
            }
            ,
            s if s.matches("Value") /* Value com.amazonaws.cloudwatch#Dimension$Value */ =>  {
                ...
                ;
                builder = builder.set_value(var_198);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_data_query(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricDataQuery, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricDataQuery::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Id") /* Id com.amazonaws.cloudwatch#MetricDataQuery$Id */ =>  {
                ...
                ;
                builder = builder.set_id(var_199);
            }
            ,
            s if s.matches("MetricStat") /* MetricStat com.amazonaws.cloudwatch#MetricDataQuery$MetricStat */ =>  {
                ...
                ;
                builder = builder.set_metric_stat(var_200);
            }
            ,
            s if s.matches("Expression") /* Expression com.amazonaws.cloudwatch#MetricDataQuery$Expression */ =>  {
                ...
                ;
                builder = builder.set_expression(var_201);
            }
            ,
            s if s.matches("Label") /* Label com.amazonaws.cloudwatch#MetricDataQuery$Label */ =>  {
                ...
                ;
                builder = builder.set_label(var_202);
            }
            ,
            s if s.matches("ReturnData") /* ReturnData com.amazonaws.cloudwatch#MetricDataQuery$ReturnData */ =>  {
                ...
                ;
                builder = builder.set_return_data(var_203);
            }
            ,
            s if s.matches("Period") /* Period com.amazonaws.cloudwatch#MetricDataQuery$Period */ =>  {
                ...
                ;
                builder = builder.set_period(var_204);
            }
            ,
...
pub fn deser_list_com_amazonaws_cloudwatch_anomaly_detector_excluded_time_ranges(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<std::vec::Vec<crate::model::Range>, aws_smithy_xml::decode::XmlError> {
    let mut out = std::vec::Vec::new();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
...
pub fn deser_structure_crate_model_insight_rule_contributor_datapoint(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::InsightRuleContributorDatapoint, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::InsightRuleContributorDatapoint::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Timestamp") /* Timestamp com.amazonaws.cloudwatch#InsightRuleContributorDatapoint$Timestamp */ =>  {
                ...
                ;
                builder = builder.set_timestamp(var_206);
            }
            ,
            s if s.matches("ApproximateValue") /* ApproximateValue com.amazonaws.cloudwatch#InsightRuleContributorDatapoint$ApproximateValue */ =>  {
                ...
                ;
                builder = builder.set_approximate_value(var_207);
            }
            ,
            _ => {}
        }
...
pub fn deser_map_com_amazonaws_cloudwatch_datapoint_value_map_entry(decoder: &mut aws_smithy_xml::decode::ScopedDecoder, out: &mut std::collections::HashMap<std::string::String, f64>) -> Result<(), aws_smithy_xml::decode::XmlError> {
...
pub fn deser_structure_crate_model_metric_stream_statistics_metric(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStreamStatisticsMetric, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricStreamStatisticsMetric::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Namespace") /* Namespace com.amazonaws.cloudwatch#MetricStreamStatisticsMetric$Namespace */ =>  {
                ...
                ;
                builder = builder.set_namespace(var_208);
            }
            ,
            s if s.matches("MetricName") /* MetricName com.amazonaws.cloudwatch#MetricStreamStatisticsMetric$MetricName */ =>  {
                ...
                ;
                builder = builder.set_metric_name(var_209);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_metric_stat(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::MetricStat, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::MetricStat::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("Metric") /* Metric com.amazonaws.cloudwatch#MetricStat$Metric */ =>  {
                ...
                ;
                builder = builder.set_metric(var_210);
            }
            ,
            s if s.matches("Period") /* Period com.amazonaws.cloudwatch#MetricStat$Period */ =>  {
                ...
                ;
                builder = builder.set_period(var_211);
            }
            ,
            s if s.matches("Stat") /* Stat com.amazonaws.cloudwatch#MetricStat$Stat */ =>  {
                ...
                ;
                builder = builder.set_stat(var_212);
            }
            ,
            s if s.matches("Unit") /* Unit com.amazonaws.cloudwatch#MetricStat$Unit */ =>  {
                ...
                ;
                builder = builder.set_unit(var_213);
            }
            ,
            _ => {}
        }
...
pub fn deser_structure_crate_model_range(decoder: &mut aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::model::Range, aws_smithy_xml::decode::XmlError> {
    #[allow(unused_mut)]let mut builder = crate::model::Range::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            s if s.matches("StartTime") /* StartTime com.amazonaws.cloudwatch#Range$StartTime */ =>  {
                ...
                ;
                builder = builder.set_start_time(var_214);
            }
            ,
            s if s.matches("EndTime") /* EndTime com.amazonaws.cloudwatch#Range$EndTime */ =>  {
                ...
                ;
                builder = builder.set_end_time(var_215);
            }
            ,
            _ => {}
        }
