...
pub fn serialize_operation_delete_alarms(
...
pub fn serialize_operation_delete_anomaly_detector(
    ...
    if let Some(var_11) = &input.dimensions {
        ...
        for item_12 in var_11 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_14, item_12);
        }
        list_13.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_delete_dashboards(
...
pub fn serialize_operation_delete_insight_rules(
...
pub fn serialize_operation_delete_metric_stream(
...
pub fn serialize_operation_describe_alarm_history(
...
pub fn serialize_operation_describe_alarms(
...
pub fn serialize_operation_describe_alarms_for_metric(
    ...
    if let Some(var_81) = &input.dimensions {
        ...
        for item_82 in var_81 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_84, item_82);
        }
        list_83.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_describe_anomaly_detectors(
    ...
    if let Some(var_98) = &input.dimensions {
        ...
        for item_99 in var_98 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_101, item_99);
        }
        list_100.finish();
    }
    writer.finish();
...
pub fn serialize_operation_describe_insight_rules(
...
pub fn serialize_operation_disable_alarm_actions(
...
pub fn serialize_operation_disable_insight_rules(
...
pub fn serialize_operation_enable_alarm_actions(
...
pub fn serialize_operation_enable_insight_rules(
...
pub fn serialize_operation_get_dashboard(
...
pub fn serialize_operation_get_insight_rule_report(
...
pub fn serialize_operation_get_metric_data(
    ...
    if let Some(var_146) = &input.metric_data_queries {
        ...
        for item_147 in var_146 {
            ...
            crate::query_ser::serialize_structure_metric_data_query(entry_149, item_147);
        }
        list_148.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_161) = &input.label_options {
        crate::query_ser::serialize_structure_label_options(scope_160, var_161);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_get_metric_statistics(
    ...
    if let Some(var_167) = &input.dimensions {
        ...
        for item_168 in var_167 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_170, item_168);
        }
        list_169.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_get_metric_stream(
...
pub fn serialize_operation_get_metric_widget_image(
...
pub fn serialize_operation_list_dashboards(
...
pub fn serialize_operation_list_metrics(
    ...
    if let Some(var_204) = &input.dimensions {
        ...
        for item_205 in var_204 {
            ...
            crate::query_ser::serialize_structure_dimension_filter(entry_207, item_205);
        }
        list_206.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_list_metric_streams(
...
pub fn serialize_operation_put_anomaly_detector(
    ...
    if let Some(var_223) = &input.dimensions {
        ...
        for item_224 in var_223 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_226, item_224);
        }
        list_225.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_230) = &input.configuration {
        crate::query_ser::serialize_structure_anomaly_detector_configuration(scope_229, var_230);
    }
    writer.finish();
    Ok(smithy_http::body::SdkBody::from(out))
}

pub fn serialize_operation_put_composite_alarm(
    ...
    if let Some(var_255) = &input.tags {
        ...
        for item_256 in var_255 {
            ...
            crate::query_ser::serialize_structure_tag(entry_258, item_256);
        }
        list_257.finish();
    }
    writer.finish();
...
pub fn serialize_operation_put_dashboard(
...
pub fn serialize_operation_put_insight_rule(
    ...
    if let Some(var_270) = &input.tags {
        ...
        for item_271 in var_270 {
            ...
            crate::query_ser::serialize_structure_tag(entry_273, item_271);
        }
        list_272.finish();
    }
    writer.finish();
...
pub fn serialize_operation_put_metric_alarm(
    ...
    if let Some(var_304) = &input.dimensions {
        ...
        for item_305 in var_304 {
            ...
            crate::query_ser::serialize_structure_dimension(entry_307, item_305);
        }
        list_306.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_325) = &input.metrics {
        ...
        for item_326 in var_325 {
            ...
            crate::query_ser::serialize_structure_metric_data_query(entry_328, item_326);
        }
        list_327.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_330) = &input.tags {
        ...
        for item_331 in var_330 {
            ...
            crate::query_ser::serialize_structure_tag(entry_333, item_331);
        }
        list_332.finish();
    }
    #[allow(unused_mut)]
...
pub fn serialize_operation_put_metric_data(
    ...
    if let Some(var_339) = &input.metric_data {
        ...
        for item_340 in var_339 {
            ...
            crate::query_ser::serialize_structure_metric_datum(entry_342, item_340);
        }
        list_341.finish();
    }
    writer.finish();
...
pub fn serialize_operation_put_metric_stream(
    ...
    if let Some(var_346) = &input.include_filters {
        ...
        for item_347 in var_346 {
            ...
            crate::query_ser::serialize_structure_metric_stream_filter(entry_349, item_347);
        }
        list_348.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_351) = &input.exclude_filters {
        ...
        for item_352 in var_351 {
            ...
            crate::query_ser::serialize_structure_metric_stream_filter(entry_354, item_352);
        }
        list_353.finish();
    }
    #[allow(unused_mut)]
    ...
    if let Some(var_362) = &input.tags {
        ...
        for item_363 in var_362 {
            ...
            crate::query_ser::serialize_structure_tag(entry_365, item_363);
        }
        list_364.finish();
    }
    writer.finish();
...
pub fn serialize_operation_set_alarm_state(
...
pub fn serialize_operation_start_metric_streams(
...
pub fn serialize_operation_stop_metric_streams(
...
pub fn serialize_operation_tag_resource(
    ...
    if let Some(var_387) = &input.tags {
        ...
        for item_388 in var_387 {
            ...
            crate::query_ser::serialize_structure_tag(entry_390, item_388);
        }
        list_389.finish();
    }
    writer.finish();
