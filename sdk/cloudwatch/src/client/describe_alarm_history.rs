...
impl super::Client {
    ...
    ///   - [`alarm_name(impl Into<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::alarm_name) / [`set_alarm_name(Option<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_alarm_name): <p>The name of the alarm.</p>
