...
impl super::Client {
    ...
    ///   - [`alarm_name(impl ::std::convert::Into<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::alarm_name) / [`set_alarm_name(Option<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_alarm_name): <p>The name of the alarm.</p>
    ///   - [`alarm_types(Vec<AlarmType>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::alarm_types) / [`set_alarm_types(Option<Vec<AlarmType>>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_alarm_types): <p>Use this parameter to specify whether you want the operation to return metric alarms or composite alarms. If you omit this parameter, only metric alarms are returned.</p>
    ...
    ///   - [`start_date(DateTime)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::start_date) / [`set_start_date(Option<DateTime>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_start_date): <p>The starting date to retrieve alarm history.</p>
    ///   - [`end_date(DateTime)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::end_date) / [`set_end_date(Option<DateTime>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_end_date): <p>The ending date to retrieve alarm history.</p>
    ///   - [`max_records(i32)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::max_records) / [`set_max_records(Option<i32>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_max_records): <p>The maximum number of alarm history records to retrieve.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_next_token): <p>The token returned by a previous call to indicate that there is more data available.</p>
    ///   - [`scan_by(ScanBy)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::scan_by) / [`set_scan_by(Option<ScanBy>)`](crate::operation::describe_alarm_history::builders::DescribeAlarmHistoryFluentBuilder::set_scan_by): <p>Specified whether to return the newest or oldest alarm history first. Specify <code>TimestampDescending</code> to have the newest event history returned first, and specify <code>TimestampAscending</code> to have the oldest history returned first.</p>
