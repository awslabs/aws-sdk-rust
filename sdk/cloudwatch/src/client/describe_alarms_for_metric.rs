...
impl super::Client {
    ...
    ///   - [`metric_name(impl ::std::convert::Into<String>)`](crate::operation::describe_alarms_for_metric::builders::DescribeAlarmsForMetricFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::describe_alarms_for_metric::builders::DescribeAlarmsForMetricFluentBuilder::set_metric_name): <p>The name of the metric.</p>
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::describe_alarms_for_metric::builders::DescribeAlarmsForMetricFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::describe_alarms_for_metric::builders::DescribeAlarmsForMetricFluentBuilder::set_namespace): <p>The namespace of the metric.</p>
