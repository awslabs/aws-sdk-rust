...
impl super::Client {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_namespace): <p>The metric namespace to filter against. Only the namespace that matches exactly will be returned.</p>
    ///   - [`metric_name(impl Into<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_metric_name): <p>The name of the metric to filter against. Only the metrics with names that match exactly will be returned.</p>
    ///   - [`dimensions(Vec<DimensionFilter>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::dimensions) / [`set_dimensions(Option<Vec<DimensionFilter>>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_dimensions): <p>The dimensions to filter against. Only the dimensions that match exactly will be returned.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_next_token): <p>The token returned by a previous call to indicate that there is more data available.</p>
    ///   - [`recently_active(RecentlyActive)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::recently_active) / [`set_recently_active(Option<RecentlyActive>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_recently_active): <p>To filter the results to show only metrics that have had data points published in the past three hours, specify this parameter with a value of <code>PT3H</code>. This is the only valid value for this parameter.</p>  <p>The results that are returned are an approximation of the value you specify. There is a low probability that the returned results include metrics with last published data as much as 40 minutes more than the specified time interval.</p>
    ///   - [`include_linked_accounts(bool)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::include_linked_accounts) / [`set_include_linked_accounts(bool)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_include_linked_accounts): <p>If you are using this operation in a monitoring account, specify <code>true</code> to include metrics from source accounts in the returned data.</p>  <p>The default is <code>false</code>.</p>
    ///   - [`owning_account(impl Into<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::owning_account) / [`set_owning_account(Option<String>)`](crate::operation::list_metrics::builders::ListMetricsFluentBuilder::set_owning_account): <p>When you use this operation in a monitoring account, use this field to return metrics only from one source account. To do so, specify that source account ID in this field, and also specify <code>true</code> for <code>IncludeLinkedAccounts</code>.</p>
