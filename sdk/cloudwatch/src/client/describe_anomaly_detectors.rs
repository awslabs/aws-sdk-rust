...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_next_token): <p>Use the token returned by the previous operation to request the next page of results.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_max_results): <p>The maximum number of results to return in one operation. The maximum value that you can specify is 100.</p>  <p>To retrieve the remaining results, make another call with the returned <code>NextToken</code> value. </p>
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_namespace): <p>Limits the results to only the anomaly detection models that are associated with the specified namespace.</p>
    ///   - [`metric_name(impl ::std::convert::Into<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_metric_name): <p>Limits the results to only the anomaly detection models that are associated with the specified metric name. If there are multiple metrics with this name in different namespaces that have anomaly detection models, they're all returned.</p>
    ///   - [`dimensions(Vec<Dimension>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::dimensions) / [`set_dimensions(Option<Vec<Dimension>>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_dimensions): <p>Limits the results to only the anomaly detection models that are associated with the specified metric dimensions. If there are multiple metrics that have these dimensions and have anomaly detection models associated, they're all returned.</p>
    ///   - [`anomaly_detector_types(Vec<AnomalyDetectorType>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::anomaly_detector_types) / [`set_anomaly_detector_types(Option<Vec<AnomalyDetectorType>>)`](crate::operation::describe_anomaly_detectors::builders::DescribeAnomalyDetectorsFluentBuilder::set_anomaly_detector_types): <p>The anomaly detector types to request when using <code>DescribeAnomalyDetectorsInput</code>. If empty, defaults to <code>SINGLE_METRIC</code>.</p>
