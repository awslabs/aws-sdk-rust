...
impl super::Client {
    ...
    ///   - [`alarm_name(impl ::std::convert::Into<String>)`](crate::operation::set_alarm_state::builders::SetAlarmStateFluentBuilder::alarm_name) / [`set_alarm_name(Option<String>)`](crate::operation::set_alarm_state::builders::SetAlarmStateFluentBuilder::set_alarm_name): <p>The name of the alarm.</p>
