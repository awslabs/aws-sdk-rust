...
impl super::Client {
    ...
    ///   - [`alarm_names(impl Into<String>)`](crate::operation::disable_alarm_actions::builders::DisableAlarmActionsFluentBuilder::alarm_names) / [`set_alarm_names(Option<Vec<String>>)`](crate::operation::disable_alarm_actions::builders::DisableAlarmActionsFluentBuilder::set_alarm_names): <p>The names of the alarms.</p>
