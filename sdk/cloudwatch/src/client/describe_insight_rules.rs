...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_insight_rules::builders::DescribeInsightRulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_insight_rules::builders::DescribeInsightRulesFluentBuilder::set_next_token): <p>Include this value, if it was returned by the previous operation, to get the next set of rules.</p>
