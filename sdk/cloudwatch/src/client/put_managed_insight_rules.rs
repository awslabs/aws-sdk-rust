...
impl super::Client {
    ...
    ///   - [`managed_rules(ManagedRule)`](crate::operation::put_managed_insight_rules::builders::PutManagedInsightRulesFluentBuilder::managed_rules) / [`set_managed_rules(Option<Vec<ManagedRule>>)`](crate::operation::put_managed_insight_rules::builders::PutManagedInsightRulesFluentBuilder::set_managed_rules): <p> A list of <code>ManagedRules</code> to enable. </p>
