...
impl super::Client {
    ...
    ///   - [`dashboard_name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_dashboards::builders::ListDashboardsFluentBuilder::dashboard_name_prefix) / [`set_dashboard_name_prefix(Option<String>)`](crate::operation::list_dashboards::builders::ListDashboardsFluentBuilder::set_dashboard_name_prefix): <p>If you specify this parameter, only the dashboards with names starting with the specified string are listed. The maximum length is 255, and valid characters are A-Z, a-z, 0-9, ".", "-", and "_". </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_dashboards::builders::ListDashboardsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_dashboards::builders::ListDashboardsFluentBuilder::set_next_token): <p>The token returned by a previous call to indicate that there is more data available.</p>
