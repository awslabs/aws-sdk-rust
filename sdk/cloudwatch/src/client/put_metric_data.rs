...
impl super::Client  {
    ...
    ///   - [`namespace(impl Into<String>)`](crate::operation::put_metric_data::builders::PutMetricDataFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::put_metric_data::builders::PutMetricDataFluentBuilder::set_namespace): <p>The namespace for the metric data. You can use ASCII characters for the namespace, except for control characters which are not supported.</p>  <p>To avoid conflicts with Amazon Web Services service namespaces, you should not specify a namespace that begins with <code>AWS/</code> </p>
