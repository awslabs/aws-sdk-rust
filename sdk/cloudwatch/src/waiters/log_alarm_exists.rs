...
///
/// Fluent builder for the `log_alarm_exists` waiter.
///
...
pub struct LogAlarmExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_alarms::builders::DescribeAlarmsInputBuilder,
}
impl LogAlarmExistsFluentBuilder {
    /// Creates a new `LogAlarmExistsFluentBuilder`.
    ...
    pub async fn wait(
        ...
        crate::waiters::log_alarm_exists::LogAlarmExistsFinalPoll,
        crate::waiters::log_alarm_exists::WaitUntilLogAlarmExistsError,
    > {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"length(LogAlarms[]) > `0`","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_alarms_6fbdc6ef75a228d90(result) {
...
/// Successful return type for the `log_alarm_exists` waiter.
pub type LogAlarmExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_alarms::DescribeAlarmsOutput,
...
/// Error type for the `log_alarm_exists` waiter.
pub type WaitUntilLogAlarmExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_alarms::DescribeAlarmsOutput,
    crate::operation::describe_alarms::DescribeAlarmsError,
>;
