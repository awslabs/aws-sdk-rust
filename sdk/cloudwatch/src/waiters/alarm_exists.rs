...
///
/// Fluent builder for the `alarm_exists` waiter.
///
...
pub struct AlarmExistsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::describe_alarms::builders::DescribeAlarmsInputBuilder,
}
impl AlarmExistsFluentBuilder {
    /// Creates a new `AlarmExistsFluentBuilder`.
    ...
    /// Wait for `alarm_exists`
    pub async fn wait(
        self,
        max_wait: ::std::time::Duration,
    ) -> ::std::result::Result<crate::waiters::alarm_exists::AlarmExistsFinalPoll, crate::waiters::alarm_exists::WaitUntilAlarmExistsError> {
        let input = self
            .inner
            .build()
        ...
        >| {
            // Matches: {"output":{"path":"length(MetricAlarms[]) > `0`","expected":"true","comparator":"booleanEquals"}}
            if crate::waiters::matchers::match_describe_alarms_beb7bce02503b1deb(result) {
    ...
    ///
    /// <p>Use this parameter to specify whether you want the operation to return metric alarms, composite alarms, or log alarms. If you omit this parameter, only metric alarms are returned, even if composite alarms or log alarms exist in the account.</p>
    /// <p>For example, if you omit this parameter or specify <code>MetricAlarms</code>, the operation returns only a list of metric alarms. It does not return any composite alarms or log alarms, even if they exist in the account.</p>
    /// <p>If you specify <code>CompositeAlarms</code>, the operation returns only a list of composite alarms, and does not return any metric alarms or log alarms.</p>
    /// <p>If you specify <code>LogAlarms</code>, the operation returns only a list of log alarms, and does not return any metric alarms or composite alarms.</p>
...
/// Successful return type for the `alarm_exists` waiter.
pub type AlarmExistsFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
    crate::operation::describe_alarms::DescribeAlarmsOutput,
...
/// Error type for the `alarm_exists` waiter.
pub type WaitUntilAlarmExistsError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::describe_alarms::DescribeAlarmsOutput,
    crate::operation::describe_alarms::DescribeAlarmsError,
>;
