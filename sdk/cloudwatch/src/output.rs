...
pub struct GetMetricWidgetImageOutput {
    ...
    pub metric_widget_image: std::option::Option<smithy_types::Blob>,
}
...
pub mod get_metric_widget_image_output {
    ...
    #[derive(std::default::Default, std::clone::Clone, std::cmp::PartialEq, std::fmt::Debug)]
    pub struct Builder {
        pub(crate) metric_widget_image: std::option::Option<smithy_types::Blob>,
    }
    impl Builder {
        /// <p>The image of the graph, in the output format specified. The output is base64-encoded.</p>
        pub fn metric_widget_image(mut self, input: smithy_types::Blob) -> Self {
