...
pub struct PutManagedInsightRulesOutput  {
    ...
    #[doc(hidden)]pub failures: std::option::Option<std::vec::Vec<crate::model::PartialFailure>>,
}
...
pub struct ListMetricStreamsOutput  {
    ...
    #[doc(hidden)]pub entries: std::option::Option<std::vec::Vec<crate::model::MetricStreamEntry>>,
}
...
pub struct ListMetricsOutput  {
    ...
    #[doc(hidden)]pub metrics: std::option::Option<std::vec::Vec<crate::model::Metric>>,
...
pub struct ListManagedInsightRulesOutput  {
    ...
    #[doc(hidden)]pub managed_rules: std::option::Option<std::vec::Vec<crate::model::ManagedRuleDescription>>,
...
pub struct ListDashboardsOutput  {
    ...
    #[doc(hidden)]pub dashboard_entries: std::option::Option<std::vec::Vec<crate::model::DashboardEntry>>,
    /// <p>The token that marks the start of the next batch of returned results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetMetricWidgetImageOutput  {
    ...
    #[doc(hidden)]pub metric_widget_image: std::option::Option<aws_smithy_types::Blob>,
}
...
pub struct GetMetricDataOutput  {
    ...
    #[doc(hidden)]pub metric_data_results: std::option::Option<std::vec::Vec<crate::model::MetricDataResult>>,
    ...
    #[doc(hidden)]pub messages: std::option::Option<std::vec::Vec<crate::model::MessageData>>,
}
...
pub struct GetInsightRuleReportOutput  {
    ...
    #[doc(hidden)]pub key_labels: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>Specifies whether this rule aggregates contributor data by COUNT or SUM.</p>
    #[doc(hidden)]pub aggregation_statistic: std::option::Option<std::string::String>,
    /// <p>The sum of the values from all individual contributors that match the rule.</p>
    #[doc(hidden)]pub aggregate_value: std::option::Option<f64>,
    /// <p>An approximate count of the unique contributors found by this rule in this time period.</p>
    #[doc(hidden)]pub approximate_unique_count: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub contributors: std::option::Option<std::vec::Vec<crate::model::InsightRuleContributor>>,
    /// <p>A time series of metric data points that matches the time period in the rule request.</p>
    #[doc(hidden)]pub metric_datapoints: std::option::Option<std::vec::Vec<crate::model::InsightRuleMetricDatapoint>>,
}
...
pub struct DescribeInsightRulesOutput  {
    ...
    #[doc(hidden)]pub insight_rules: std::option::Option<std::vec::Vec<crate::model::InsightRule>>,
}
...
pub struct DescribeAnomalyDetectorsOutput  {
    ...
    #[doc(hidden)]pub anomaly_detectors: std::option::Option<std::vec::Vec<crate::model::AnomalyDetector>>,
...
pub struct DescribeAlarmsForMetricOutput  {
    ...
    #[doc(hidden)]pub metric_alarms: std::option::Option<std::vec::Vec<crate::model::MetricAlarm>>,
}
...
pub struct DescribeAlarmsOutput  {
    ...
    #[doc(hidden)]pub composite_alarms: std::option::Option<std::vec::Vec<crate::model::CompositeAlarm>>,
...
pub struct DescribeAlarmHistoryOutput  {
    ...
    #[doc(hidden)]pub alarm_history_items: std::option::Option<std::vec::Vec<crate::model::AlarmHistoryItem>>,
    /// <p>The token that marks the start of the next batch of returned results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
