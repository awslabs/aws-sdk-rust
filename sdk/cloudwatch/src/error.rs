...
pub struct DashboardInvalidInputError  {
    ...
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    #[allow(missing_docs)] // documentation missing in model
    #[doc(hidden)]pub dashboard_validation_messages: std::option::Option<std::vec::Vec<crate::model::DashboardValidationMessage>>,
}
...
impl  std::fmt::Debug for DashboardInvalidInputError  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("message", &self.message);
        formatter.field("dashboard_validation_messages", &self.dashboard_validation_messages);
        formatter.finish()
    }
}
impl DashboardInvalidInputError {
