...
pub fn ser_on_premise_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::OnPremiseConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_on_premise_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::OnPremiseConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
