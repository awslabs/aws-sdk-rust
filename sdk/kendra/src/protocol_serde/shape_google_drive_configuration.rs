...
pub fn ser_google_drive_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GoogleDriveConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_google_drive_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GoogleDriveConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
