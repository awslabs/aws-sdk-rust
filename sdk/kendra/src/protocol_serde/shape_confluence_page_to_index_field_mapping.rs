...
pub(crate) fn de_confluence_page_to_index_field_mapping<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::ConfluencePageToIndexFieldMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "DataSourceFieldName" => {
                            builder = builder.set_data_source_field_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ConfluencePageFieldName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "DateFieldFormat" => {
