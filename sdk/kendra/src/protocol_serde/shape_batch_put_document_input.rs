...
pub fn ser_batch_put_document_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::BatchPutDocumentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
