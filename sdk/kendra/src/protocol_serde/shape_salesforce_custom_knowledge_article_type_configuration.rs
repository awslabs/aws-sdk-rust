...
pub fn ser_salesforce_custom_knowledge_article_type_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceCustomKnowledgeArticleTypeConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_salesforce_custom_knowledge_article_type_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SalesforceCustomKnowledgeArticleTypeConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
