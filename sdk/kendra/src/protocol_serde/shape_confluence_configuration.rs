                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SpaceConfiguration" => {
                                builder = builder.set_space_configuration(
                                    crate::protocol_serde::shape_confluence_space_configuration::de_confluence_space_configuration(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "PageConfiguration" => {
                                builder = builder.set_page_configuration(
                                    crate::protocol_serde::shape_confluence_page_configuration::de_confluence_page_configuration(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "BlogConfiguration" => {
                                builder = builder.set_blog_configuration(
                                    crate::protocol_serde::shape_confluence_blog_configuration::de_confluence_blog_configuration(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
