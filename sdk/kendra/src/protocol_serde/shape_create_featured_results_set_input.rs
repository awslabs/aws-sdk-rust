...
pub fn ser_create_featured_results_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_featured_results_set::CreateFeaturedResultsSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
