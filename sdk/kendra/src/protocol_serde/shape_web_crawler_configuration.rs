...
pub fn ser_web_crawler_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WebCrawlerConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_web_crawler_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WebCrawlerConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
