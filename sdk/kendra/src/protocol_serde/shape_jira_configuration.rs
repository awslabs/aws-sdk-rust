...
pub fn ser_jira_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JiraConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_jira_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JiraConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
