...
pub fn ser_update_featured_results_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_featured_results_set::UpdateFeaturedResultsSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
