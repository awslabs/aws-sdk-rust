...
pub fn ser_create_index_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateIndexInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
