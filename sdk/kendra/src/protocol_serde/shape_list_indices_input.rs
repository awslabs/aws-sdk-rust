...
pub fn ser_list_indices_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListIndicesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
