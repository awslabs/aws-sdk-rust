...
pub fn ser_salesforce_knowledge_article_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceKnowledgeArticleConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_salesforce_knowledge_article_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SalesforceKnowledgeArticleConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
