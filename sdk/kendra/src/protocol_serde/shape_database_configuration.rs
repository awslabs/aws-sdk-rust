...
pub fn ser_database_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatabaseConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_database_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DatabaseConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
