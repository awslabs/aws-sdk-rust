...
pub fn ser_list_faqs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFaqsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
