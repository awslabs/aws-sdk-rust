                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "JwtTokenTypeConfiguration" => {
                            builder = builder.set_jwt_token_type_configuration(
                                crate::protocol_serde::shape_jwt_token_type_configuration::de_jwt_token_type_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "JsonTokenTypeConfiguration" => {
                            builder = builder.set_json_token_type_configuration(
                                crate::protocol_serde::shape_json_token_type_configuration::de_json_token_type_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
