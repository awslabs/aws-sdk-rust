...
pub fn ser_git_hub_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GitHubConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_git_hub_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GitHubConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
