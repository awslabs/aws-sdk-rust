...
pub fn ser_confluence_space_to_index_field_mapping(
...
pub(crate) fn de_confluence_space_to_index_field_mapping<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::ConfluenceSpaceToIndexFieldMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "DataSourceFieldName" => {
                            builder = builder.set_data_source_field_name(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ConfluenceSpaceFieldName::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "DateFieldFormat" => {
