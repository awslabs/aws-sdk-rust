...
pub fn ser_one_drive_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OneDriveConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_one_drive_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OneDriveConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
