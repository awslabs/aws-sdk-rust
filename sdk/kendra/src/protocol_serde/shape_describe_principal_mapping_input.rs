...
pub fn ser_describe_principal_mapping_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DescribePrincipalMappingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
