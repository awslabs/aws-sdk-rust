...
pub fn ser_update_data_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDataSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
