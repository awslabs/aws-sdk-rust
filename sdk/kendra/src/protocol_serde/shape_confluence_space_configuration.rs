...
pub fn ser_confluence_space_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfluenceSpaceConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_confluence_space_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfluenceSpaceConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
