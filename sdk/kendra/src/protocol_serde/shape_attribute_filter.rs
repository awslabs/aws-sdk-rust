...
pub fn ser_attribute_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AttributeFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
