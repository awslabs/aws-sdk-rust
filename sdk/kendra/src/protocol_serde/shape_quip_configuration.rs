...
pub fn ser_quip_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QuipConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_quip_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::QuipConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
