...
pub fn ser_fsx_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FsxConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_fsx_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FsxConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
