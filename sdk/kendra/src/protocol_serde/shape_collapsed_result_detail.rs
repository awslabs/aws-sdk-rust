            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DocumentAttribute" => {
                            builder = builder.set_document_attribute(crate::protocol_serde::shape_document_attribute::de_document_attribute(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ExpandedResults" => {
                            builder = builder.set_expanded_results(crate::protocol_serde::shape_expanded_result_list::de_expanded_result_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
