...
pub fn ser_salesforce_chatter_feed_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SalesforceChatterFeedConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_salesforce_chatter_feed_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SalesforceChatterFeedConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
