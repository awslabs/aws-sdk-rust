...
pub fn ser_salesforce_configuration(
        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_salesforce_standard_object_configuration::ser_salesforce_standard_object_configuration(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_5) = &input.knowledge_article_configuration {
        ...
        crate::protocol_serde::shape_salesforce_knowledge_article_configuration::ser_salesforce_knowledge_article_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    ...
    if let Some(var_9) = &input.standard_object_attachment_configuration {
        ...
        crate::protocol_serde::shape_salesforce_standard_object_attachment_configuration::ser_salesforce_standard_object_attachment_configuration(&mut object_10, var_9)?;
        object_10.finish();
    }
...
pub(crate) fn de_salesforce_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SalesforceConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::salesforce_configuration_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
