...
pub fn ser_box_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BoxConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_box_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BoxConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
