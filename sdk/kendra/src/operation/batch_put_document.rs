...
impl BatchPutDocumentInput {
    /// Consumes the builder and constructs an Operation<[`BatchPutDocument`](crate::operation::batch_put_document::BatchPutDocument)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_put_document::BatchPutDocument, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_put_document::BatchPutDocumentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_put_document::ser_batch_put_document_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_put_document::BatchPutDocument::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchPutDocument", "kendra"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchPutDocument {
                type Output = std::result::Result<crate::operation::batch_put_document::BatchPutDocumentOutput, crate::operation::batch_put_document::BatchPutDocumentError>;
