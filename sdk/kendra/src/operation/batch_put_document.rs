...
impl BatchPutDocumentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_batch_put_document::ser_batch_put_document_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchPutDocument {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_put_document::de_batch_put_document_http_response_with_props(status, headers, body)
        }
    }
}
