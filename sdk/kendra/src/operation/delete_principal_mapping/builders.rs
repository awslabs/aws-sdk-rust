...
impl DeletePrincipalMappingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_principal_mapping::DeletePrincipalMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_principal_mapping::DeletePrincipalMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_principal_mapping::DeletePrincipalMappingOutput, crate::operation::delete_principal_mapping::DeletePrincipalMappingError, Self> {
