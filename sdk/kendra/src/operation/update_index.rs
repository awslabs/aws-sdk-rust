...
impl UpdateIndexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_index::UpdateIndex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_index::ser_update_index_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_index::de_update_index_http_response_with_props(status, headers, body)
        }
    }
}
