...
impl UpdateIndexInput {
    /// Consumes the builder and constructs an Operation<[`UpdateIndex`](crate::operation::update_index::UpdateIndex)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_index::UpdateIndex, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_index::UpdateIndexInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_index::ser_update_index_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_index::UpdateIndex::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateIndex", "kendra"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateIndex {
                type Output = std::result::Result<crate::operation::update_index::UpdateIndexOutput, crate::operation::update_index::UpdateIndexError>;
