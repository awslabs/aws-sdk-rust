...
/// Orchestration and serialization glue logic for `CreateAccessControlConfiguration`.
...
impl CreateAccessControlConfiguration {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::create_access_control_configuration::CreateAccessControlConfigurationInput,
                    ) -> ::std::result::Result<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::create_access_control_configuration::CreateAccessControlConfigurationInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateAccessControlConfiguration {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateAccessControlConfiguration");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateAccessControlConfigurationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateAccessControlConfigurationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateAccessControlConfiguration")
...
.with_interceptor(CreateAccessControlConfigurationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError>::new());
...
#[derive(Debug)]
            struct CreateAccessControlConfigurationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateAccessControlConfigurationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_access_control_configuration::de_create_access_control_configuration_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_access_control_configuration::de_create_access_control_configuration_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateAccessControlConfigurationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateAccessControlConfigurationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_access_control_configuration::CreateAccessControlConfigurationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_access_control_configuration::CreateAccessControlConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_access_control_configuration::ser_create_access_control_configuration_input(&input)?);
...
#[derive(Debug)]
            struct CreateAccessControlConfigurationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateAccessControlConfigurationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateAccessControlConfigurationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateAccessControlConfigurationInput>()
                        .ok_or("failed to downcast to CreateAccessControlConfigurationInput")?;
...
pub enum CreateAccessControlConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateAccessControlConfigurationError) for what information is available for the error.")]
...
impl CreateAccessControlConfigurationError {
    /// Creates the `CreateAccessControlConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAccessControlConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateAccessControlConfigurationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError {
...
mod _create_access_control_configuration_output;
