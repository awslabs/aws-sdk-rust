...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccessControlConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_access_control_configuration::de_create_access_control_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_access_control_configuration::CreateAccessControlConfigurationError
{
