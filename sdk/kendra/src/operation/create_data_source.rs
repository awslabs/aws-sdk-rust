...
impl CreateDataSourceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_data_source::ser_create_data_source_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_data_source::de_create_data_source_http_response_with_props(status, headers, body)
        }
    }
}
