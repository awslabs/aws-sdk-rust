...
impl CreateDataSourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_data_source::CreateDataSource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_data_source::de_create_data_source_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_data_source::CreateDataSourceError
{
