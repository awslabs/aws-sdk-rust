...
/// Orchestration and serialization glue logic for `AssociatePersonasToEntities`.
...
impl AssociatePersonasToEntities {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociatePersonasToEntities {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociatePersonasToEntities");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociatePersonasToEntitiesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociatePersonasToEntitiesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociatePersonasToEntities")
...
.with_interceptor(AssociatePersonasToEntitiesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError>::new());
...
#[derive(Debug)]
            struct AssociatePersonasToEntitiesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociatePersonasToEntitiesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_personas_to_entities::de_associate_personas_to_entities_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AssociatePersonasToEntitiesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociatePersonasToEntitiesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_personas_to_entities::ser_associate_personas_to_entities_input(&input)?);
...
#[derive(Debug)]
            struct AssociatePersonasToEntitiesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociatePersonasToEntitiesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociatePersonasToEntitiesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociatePersonasToEntitiesInput>()
                        .ok_or("failed to downcast to AssociatePersonasToEntitiesInput")?;
...
pub enum AssociatePersonasToEntitiesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociatePersonasToEntitiesError) for what information is available for the error.")]
...
impl AssociatePersonasToEntitiesError {
    /// Creates the `AssociatePersonasToEntitiesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociatePersonasToEntitiesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociatePersonasToEntitiesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_personas_to_entities::AssociatePersonasToEntitiesError {
...
mod _associate_personas_to_entities_output;
