...
impl AssociatePersonasToEntitiesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_personas_to_entities::AssociatePersonasToEntities::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociatePersonasToEntities {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_personas_to_entities::de_associate_personas_to_entities_http_response_with_props(
                status, headers, body,
            )
        }
    }
