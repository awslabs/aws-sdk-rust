...
impl GetSnapshotsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_snapshots::GetSnapshots, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_snapshots::ser_get_snapshots_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_snapshots::de_get_snapshots_http_response_with_props(status, headers, body)
        }
    }
}
