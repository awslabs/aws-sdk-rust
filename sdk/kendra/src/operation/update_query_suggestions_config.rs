...
/// Orchestration and serialization glue logic for `UpdateQuerySuggestionsConfig`.
...
impl UpdateQuerySuggestionsConfig {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateQuerySuggestionsConfig {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateQuerySuggestionsConfig");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateQuerySuggestionsConfigRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateQuerySuggestionsConfigResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateQuerySuggestionsConfig")
...
.with_interceptor(UpdateQuerySuggestionsConfigEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError>::new());
...
#[derive(Debug)]
            struct UpdateQuerySuggestionsConfigResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateQuerySuggestionsConfigResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_query_suggestions_config::de_update_query_suggestions_config_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateQuerySuggestionsConfigRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateQuerySuggestionsConfigRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_query_suggestions_config::ser_update_query_suggestions_config_input(&input)?);
...
#[derive(Debug)]
            struct UpdateQuerySuggestionsConfigEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateQuerySuggestionsConfigEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateQuerySuggestionsConfigEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateQuerySuggestionsConfigInput>()
                        .ok_or("failed to downcast to UpdateQuerySuggestionsConfigInput")?;
...
pub enum UpdateQuerySuggestionsConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateQuerySuggestionsConfigError) for what information is available for the error.")]
...
impl UpdateQuerySuggestionsConfigError {
    /// Creates the `UpdateQuerySuggestionsConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateQuerySuggestionsConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateQuerySuggestionsConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError {
...
mod _update_query_suggestions_config_output;
