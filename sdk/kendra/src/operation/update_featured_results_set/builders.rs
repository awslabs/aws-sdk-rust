...
impl UpdateFeaturedResultsSetFluentBuilder  {
    /// Creates a new `UpdateFeaturedResultsSet`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_featured_results_set::UpdateFeaturedResultsSetOutput, aws_smithy_http::result::SdkError<crate::operation::update_featured_results_set::UpdateFeaturedResultsSetError>>
                     {
