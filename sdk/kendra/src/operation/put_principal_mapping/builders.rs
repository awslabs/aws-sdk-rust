...
impl PutPrincipalMappingFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_principal_mapping::PutPrincipalMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_principal_mapping::PutPrincipalMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_principal_mapping::PutPrincipalMappingOutput, crate::operation::put_principal_mapping::PutPrincipalMappingError, Self> {
