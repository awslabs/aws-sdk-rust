...
impl UpdateQuerySuggestionsConfigFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigOutput, crate::operation::update_query_suggestions_config::UpdateQuerySuggestionsConfigError, Self> {
