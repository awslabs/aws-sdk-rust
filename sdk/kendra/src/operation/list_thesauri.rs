...
impl ListThesauriInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_thesauri::ListThesauri, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_thesauri::ser_list_thesauri_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThesauri {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_thesauri::de_list_thesauri_http_response_with_props(status, headers, body)
        }
    }
}
