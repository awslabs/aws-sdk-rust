...
impl DescribeQuerySuggestionsBlockListInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_query_suggestions_block_list::DescribeQuerySuggestionsBlockListInput, ::aws_smithy_types::error::operation::BuildError> {
