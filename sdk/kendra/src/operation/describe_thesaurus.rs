...
impl DescribeThesaurusInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_thesaurus::ser_describe_thesaurus_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeThesaurus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_thesaurus::de_describe_thesaurus_http_response_with_props(status, headers, body)
        }
    }
}
