...
impl DescribeThesaurusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_thesaurus::DescribeThesaurus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeThesaurus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_thesaurus::de_describe_thesaurus_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_thesaurus::DescribeThesaurusError
{
