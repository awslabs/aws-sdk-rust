...
impl CreateThesaurusInput {
    /// Consumes the builder and constructs an Operation<[`CreateThesaurus`](crate::operation::create_thesaurus::CreateThesaurus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_thesaurus::CreateThesaurus, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_thesaurus::CreateThesaurusInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_thesaurus::ser_create_thesaurus_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_thesaurus::CreateThesaurus::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateThesaurus", "kendra"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateThesaurus {
                type Output = std::result::Result<crate::operation::create_thesaurus::CreateThesaurusOutput, crate::operation::create_thesaurus::CreateThesaurusError>;
