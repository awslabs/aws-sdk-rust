...
impl CreateThesaurusInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_thesaurus::CreateThesaurus, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_thesaurus::ser_create_thesaurus_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateThesaurus {
    type Output =
        ::std::result::Result<crate::operation::create_thesaurus::CreateThesaurusOutput, crate::operation::create_thesaurus::CreateThesaurusError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_thesaurus::de_create_thesaurus_http_response_with_props(status, headers, body)
        }
    }
}
