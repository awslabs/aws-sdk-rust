...
impl Query {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("kendra", "Query", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for Query {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("Query", "kendra"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for QueryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("VisitorId") {
            if let ::std::option::Option::Some(value) = input.visitor_id.as_deref() {
                captured.insert("VisitorId", value);
            }
        }
