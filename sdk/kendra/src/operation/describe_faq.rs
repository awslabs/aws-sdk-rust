...
impl DescribeFaqInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_faq::DescribeFaq::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFaq {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_faq::de_describe_faq_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_faq::de_describe_faq_http_response_with_props(
                status, headers, body,
            )
        }
    }
