...
impl crate::operation::describe_featured_results_set::builders::DescribeFeaturedResultsSetInputBuilder {
...
impl DescribeFeaturedResultsSetFluentBuilder {
    /// Creates a new `DescribeFeaturedResultsSetFluentBuilder`.
