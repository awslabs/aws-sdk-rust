...
impl CreateIndexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_index::CreateIndex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_index::ser_create_index_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_index::de_create_index_http_response_with_props(status, headers, body)
        }
    }
}
