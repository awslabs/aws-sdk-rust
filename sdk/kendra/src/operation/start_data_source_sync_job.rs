...
impl StartDataSourceSyncJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_data_source_sync_job::StartDataSourceSyncJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDataSourceSyncJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_data_source_sync_job::de_start_data_source_sync_job_http_response_with_props(status, headers, body)
        }
    }
}
