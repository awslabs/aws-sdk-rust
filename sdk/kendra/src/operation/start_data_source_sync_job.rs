...
/// Orchestration and serialization glue logic for `StartDataSourceSyncJob`.
...
impl StartDataSourceSyncJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartDataSourceSyncJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartDataSourceSyncJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartDataSourceSyncJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartDataSourceSyncJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartDataSourceSyncJob")
...
.with_interceptor(StartDataSourceSyncJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError>::new());
...
#[derive(Debug)]
            struct StartDataSourceSyncJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartDataSourceSyncJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_data_source_sync_job::de_start_data_source_sync_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct StartDataSourceSyncJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartDataSourceSyncJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_data_source_sync_job::StartDataSourceSyncJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_data_source_sync_job::StartDataSourceSyncJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_data_source_sync_job::ser_start_data_source_sync_job_input(&input)?);
...
#[derive(Debug)]
            struct StartDataSourceSyncJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartDataSourceSyncJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartDataSourceSyncJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartDataSourceSyncJobInput>()
                        .ok_or("failed to downcast to StartDataSourceSyncJobInput")?;
...
pub enum StartDataSourceSyncJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartDataSourceSyncJobError) for what information is available for the error.")]
...
impl StartDataSourceSyncJobError {
    /// Creates the `StartDataSourceSyncJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartDataSourceSyncJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartDataSourceSyncJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_data_source_sync_job::StartDataSourceSyncJobError {
...
mod _start_data_source_sync_job_output;
