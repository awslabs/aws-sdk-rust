...
impl ListQuerySuggestionsBlockListsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_query_suggestions_block_lists::ListQuerySuggestionsBlockListsInput, ::aws_smithy_types::error::operation::BuildError> {
