...
impl DeleteAccessControlConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_access_control_configuration::DeleteAccessControlConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessControlConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_access_control_configuration::de_delete_access_control_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
