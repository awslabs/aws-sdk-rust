...
impl DescribeDataSourceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_data_source::ser_describe_data_source_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_data_source::DescribeDataSource::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDataSource", "kendra"));
