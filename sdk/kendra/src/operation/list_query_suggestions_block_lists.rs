...
impl ListQuerySuggestionsBlockListsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_query_suggestions_block_lists::ListQuerySuggestionsBlockLists::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQuerySuggestionsBlockLists {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_query_suggestions_block_lists::de_list_query_suggestions_block_lists_http_response_with_props(
                status, headers, body,
            )
        }
    }
