...
impl GetQuerySuggestionsInput {
    /// Consumes the builder and constructs an Operation<[`GetQuerySuggestions`](crate::operation::get_query_suggestions::GetQuerySuggestions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_query_suggestions::GetQuerySuggestions, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_query_suggestions::GetQuerySuggestionsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_query_suggestions::ser_get_query_suggestions_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_query_suggestions::GetQuerySuggestions::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetQuerySuggestions", "kendra"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetQuerySuggestions {
                type Output = std::result::Result<crate::operation::get_query_suggestions::GetQuerySuggestionsOutput, crate::operation::get_query_suggestions::GetQuerySuggestionsError>;
