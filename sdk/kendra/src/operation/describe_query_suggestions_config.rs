...
impl DescribeQuerySuggestionsConfigInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_query_suggestions_config::DescribeQuerySuggestionsConfig::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeQuerySuggestionsConfig {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_query_suggestions_config::de_describe_query_suggestions_config_http_response_with_props(
                status, headers, body,
            )
        }
    }
