...
impl crate::operation::describe_query_suggestions_config::builders::DescribeQuerySuggestionsConfigInputBuilder {
...
impl DescribeQuerySuggestionsConfigFluentBuilder {
    /// Creates a new `DescribeQuerySuggestionsConfigFluentBuilder`.
