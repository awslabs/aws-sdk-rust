...
impl ListDataSourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_data_sources::ListDataSources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_data_sources::ser_list_data_sources_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDataSources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_data_sources::de_list_data_sources_http_response_with_props(status, headers, body)
        }
    }
}
