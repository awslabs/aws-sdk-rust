...
impl ListDataSourcesInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_data_sources::ListDataSources,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_data_sources::ListDataSources::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDataSources {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_data_sources::de_list_data_sources_http_error(
                status, headers, body,
            )
        } else {
