...
impl ListGroupsOlderThanOrderingIdInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_groups_older_than_ordering_id::ListGroupsOlderThanOrderingId::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupsOlderThanOrderingId {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_groups_older_than_ordering_id::de_list_groups_older_than_ordering_id_http_response_with_props(
                status, headers, body,
            )
        }
    }
