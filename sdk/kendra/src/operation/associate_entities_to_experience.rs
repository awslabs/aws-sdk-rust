...
impl AssociateEntitiesToExperience {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceInput,
                    ) -> ::std::result::Result<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateEntitiesToExperience {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssociateEntitiesToExperience");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssociateEntitiesToExperienceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssociateEntitiesToExperienceResponseDeserializer));
...
.with_interceptor(AssociateEntitiesToExperienceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError>::new());
...
#[derive(Debug)]
            struct AssociateEntitiesToExperienceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateEntitiesToExperienceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_associate_entities_to_experience::de_associate_entities_to_experience_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AssociateEntitiesToExperienceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateEntitiesToExperienceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_associate_entities_to_experience::ser_associate_entities_to_experience_input(&input)?);
...
#[derive(Debug)]
            struct AssociateEntitiesToExperienceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociateEntitiesToExperienceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssociateEntitiesToExperienceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssociateEntitiesToExperienceInput>()
                        .ok_or("failed to downcast to AssociateEntitiesToExperienceInput")?;
...
pub enum AssociateEntitiesToExperienceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssociateEntitiesToExperienceError) for what information is available for the error.")]
...
impl AssociateEntitiesToExperienceError {
    /// Creates the `AssociateEntitiesToExperienceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateEntitiesToExperienceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssociateEntitiesToExperienceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError {
...
mod _associate_entities_to_experience_output;
