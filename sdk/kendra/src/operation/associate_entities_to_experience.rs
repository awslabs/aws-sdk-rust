...
impl aws_smithy_http::response::ParseStrictResponse for AssociateEntitiesToExperience {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_entities_to_experience::de_associate_entities_to_experience_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceError
{
