...
impl DeleteFaqInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_faq::DeleteFaq,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_faq::DeleteFaq::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFaq {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_faq::de_delete_faq_http_response_with_props(
                status, headers, body,
            )
        }
    }
