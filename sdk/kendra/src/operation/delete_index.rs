...
impl DeleteIndexInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_index::DeleteIndex, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_index::ser_delete_index_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIndex {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_index::de_delete_index_http_response_with_props(status, headers, body)
        }
    }
}
