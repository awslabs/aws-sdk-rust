...
impl PutPrincipalMapping {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::put_principal_mapping::PutPrincipalMappingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_principal_mapping::PutPrincipalMappingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_principal_mapping::PutPrincipalMappingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::put_principal_mapping::PutPrincipalMappingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutPrincipalMapping {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutPrincipalMapping");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(PutPrincipalMappingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(PutPrincipalMappingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutPrincipalMapping")
...
.with_interceptor(PutPrincipalMappingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::put_principal_mapping::PutPrincipalMappingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::put_principal_mapping::PutPrincipalMappingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::put_principal_mapping::PutPrincipalMappingError>::new());
...
#[derive(Debug)]
            struct PutPrincipalMappingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutPrincipalMappingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_put_principal_mapping::de_put_principal_mapping_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct PutPrincipalMappingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutPrincipalMappingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::put_principal_mapping::PutPrincipalMappingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::put_principal_mapping::PutPrincipalMappingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_principal_mapping::ser_put_principal_mapping_input(&input)?);
...
#[derive(Debug)]
            struct PutPrincipalMappingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutPrincipalMappingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "PutPrincipalMappingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<PutPrincipalMappingInput>()
                        .ok_or("failed to downcast to PutPrincipalMappingInput")?;
...
pub enum PutPrincipalMappingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutPrincipalMappingError) for what information is available for the error.")]
...
impl PutPrincipalMappingError {
    /// Creates the `PutPrincipalMappingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutPrincipalMappingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutPrincipalMappingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_principal_mapping::PutPrincipalMappingError {
...
mod _put_principal_mapping_output;
