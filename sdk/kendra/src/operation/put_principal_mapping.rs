...
impl PutPrincipalMappingInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_principal_mapping::ser_put_principal_mapping_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_principal_mapping::PutPrincipalMapping::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::put_principal_mapping::PutPrincipalMappingError
{
