...
impl PutPrincipalMappingInput {
    /// Consumes the builder and constructs an Operation<[`PutPrincipalMapping`](crate::operation::put_principal_mapping::PutPrincipalMapping)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_principal_mapping::PutPrincipalMapping, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_principal_mapping::PutPrincipalMappingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_principal_mapping::ser_put_principal_mapping_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_principal_mapping::PutPrincipalMapping::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutPrincipalMapping", "kendra"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutPrincipalMapping {
                type Output = std::result::Result<crate::operation::put_principal_mapping::PutPrincipalMappingOutput, crate::operation::put_principal_mapping::PutPrincipalMappingError>;
