...
impl RetrieveInput {
    /// Consumes the builder and constructs an Operation<[`Retrieve`](crate::operation::retrieve::Retrieve)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::retrieve::Retrieve, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_retrieve::ser_retrieve_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve::Retrieve::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("Retrieve", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for Retrieve {
    type Output = ::std::result::Result<crate::operation::retrieve::RetrieveOutput, crate::operation::retrieve::RetrieveError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_retrieve::de_retrieve_http_response_with_props(status, headers, body)
        }
    }
}
