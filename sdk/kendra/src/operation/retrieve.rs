...
impl RetrieveInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_retrieve::ser_retrieve_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::retrieve::Retrieve::new(),
        )
...
/// `ParseStrictResponse` impl for `Retrieve`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for Retrieve {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_retrieve::de_retrieve_http_response_with_props(
                status, headers, body,
            )
        }
    }
