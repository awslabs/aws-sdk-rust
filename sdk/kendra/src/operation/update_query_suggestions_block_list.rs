...
impl UpdateQuerySuggestionsBlockListInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_query_suggestions_block_list::UpdateQuerySuggestionsBlockList::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateQuerySuggestionsBlockList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_query_suggestions_block_list::de_update_query_suggestions_block_list_http_response_with_props(
                status, headers, body,
            )
        }
    }
