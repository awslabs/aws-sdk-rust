...
impl DescribeIndexInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_index::ser_describe_index_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_index::DescribeIndex::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeIndex", "kendra"));
