...
impl ServiceNowServiceCatalogConfigurationBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ServiceNowServiceCatalogConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ServiceNowServiceCatalogConfiguration {
                ...
                document_data_field_name: self.document_data_field_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("document_data_field_name", "document_data_field_name was not specified but it is required when building ServiceNowServiceCatalogConfiguration")
                    )?
                ,
