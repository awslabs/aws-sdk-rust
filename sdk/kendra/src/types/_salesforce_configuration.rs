...
impl SalesforceConfigurationBuilder {
    ...
    /// <p>Configuration information for processing attachments to Salesforce standard objects.</p>
    pub fn get_standard_object_attachment_configuration(&self) -> &::std::option::Option<crate::types::SalesforceStandardObjectAttachmentConfiguration> {
        ...
        ::std::result::Result::Ok(
            crate::types::SalesforceConfiguration {
                server_url: self.server_url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("server_url", "server_url was not specified but it is required when building SalesforceConfiguration")
                    )?
                ,
                secret_arn: self.secret_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("secret_arn", "secret_arn was not specified but it is required when building SalesforceConfiguration")
                    )?
                ,
