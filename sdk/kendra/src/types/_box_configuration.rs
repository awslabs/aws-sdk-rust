...
impl  BoxConfiguration  {
    ...
    pub fn enterprise_id(&self) -> & str {
        use std::ops::Deref; self.enterprise_id.deref()
    }
    /// <p>The Amazon Resource Name (ARN) of an Secrets Manager secret that contains the key-value pairs required to connect to your Box platform. The secret must contain a JSON structure with the following keys:</p>
    /// <ul>
    /// <li>
        ...
        ::std::result::Result::Ok(
            crate::types::BoxConfiguration {
                enterprise_id: self.enterprise_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("enterprise_id", "enterprise_id was not specified but it is required when building BoxConfiguration")
                    )?
                ,
                secret_arn: self.secret_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("secret_arn", "secret_arn was not specified but it is required when building BoxConfiguration")
                    )?
                ,
