...
impl  OneDriveConfiguration  {
    ...
    pub fn tenant_domain(&self) -> & str {
        use std::ops::Deref; self.tenant_domain.deref()
    }
    /// <p>The Amazon Resource Name (ARN) of an Secrets Managersecret that contains the user name and password to connect to OneDrive. The user name should be the application ID for the OneDrive application, and the password is the application key for the OneDrive application.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::OneDriveConfiguration {
                tenant_domain: self.tenant_domain
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("tenant_domain", "tenant_domain was not specified but it is required when building OneDriveConfiguration")
                    )?
                ,
                secret_arn: self.secret_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("secret_arn", "secret_arn was not specified but it is required when building OneDriveConfiguration")
                    )?
                ,
