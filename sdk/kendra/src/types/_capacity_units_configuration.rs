        ...
        ::std::result::Result::Ok(
            crate::types::CapacityUnitsConfiguration {
                storage_capacity_units: self.storage_capacity_units
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("storage_capacity_units", "storage_capacity_units was not specified but it is required when building CapacityUnitsConfiguration")
                    )?
                ,
                query_capacity_units: self.query_capacity_units
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("query_capacity_units", "query_capacity_units was not specified but it is required when building CapacityUnitsConfiguration")
                    )?
                ,
            }
        )
