...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_indices::builders::ListIndicesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_indices::builders::ListIndicesFluentBuilder::set_next_token):<br>required: **false**<br><p>If the previous response was incomplete (because there is more data to retrieve), Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of indexes.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_indices::builders::ListIndicesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_indices::builders::ListIndicesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of indices to return.</p><br>
