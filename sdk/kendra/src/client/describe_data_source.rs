...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_data_source::builders::DescribeDataSourceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_data_source::builders::DescribeDataSourceFluentBuilder::set_id): <p>The identifier of the data source connector.</p>
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::describe_data_source::builders::DescribeDataSourceFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::describe_data_source::builders::DescribeDataSourceFluentBuilder::set_index_id): <p>The identifier of the index used with the data source connector.</p>
