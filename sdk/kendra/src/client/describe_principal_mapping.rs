...
impl super::Client {
    ...
    ///   - [`index_id(impl Into<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::set_index_id): <p>The identifier of the index required to check the processing of <code>PUT</code> and <code>DELETE</code> actions for mapping users to their groups.</p>
    ///   - [`data_source_id(impl Into<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::data_source_id) / [`set_data_source_id(Option<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::set_data_source_id): <p>The identifier of the data source to check the processing of <code>PUT</code> and <code>DELETE</code> actions for mapping users to their groups.</p>
    ///   - [`group_id(impl Into<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::describe_principal_mapping::builders::DescribePrincipalMappingFluentBuilder::set_group_id): <p>The identifier of the group required to check the processing of <code>PUT</code> and <code>DELETE</code> actions for mapping users to their groups.</p>
