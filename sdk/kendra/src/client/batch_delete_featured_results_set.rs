...
impl super::Client {
    ...
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_featured_results_set::builders::BatchDeleteFeaturedResultsSetFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::batch_delete_featured_results_set::builders::BatchDeleteFeaturedResultsSetFluentBuilder::set_index_id): <p>The identifier of the index used for featuring results.</p>
    ///   - [`featured_results_set_ids(Vec<String>)`](crate::operation::batch_delete_featured_results_set::builders::BatchDeleteFeaturedResultsSetFluentBuilder::featured_results_set_ids) / [`set_featured_results_set_ids(Option<Vec<String>>)`](crate::operation::batch_delete_featured_results_set::builders::BatchDeleteFeaturedResultsSetFluentBuilder::set_featured_results_set_ids): <p>The identifiers of the featured results sets that you want to delete.</p>
