...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_faq::builders::DescribeFaqFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_faq::builders::DescribeFaqFluentBuilder::set_id): <p>The identifier of the FAQ you want to get information on.</p>
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::describe_faq::builders::DescribeFaqFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::describe_faq::builders::DescribeFaqFluentBuilder::set_index_id): <p>The identifier of the index for the FAQ.</p>
