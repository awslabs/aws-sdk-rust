...
impl super::Client {
    ...
    ///   - [`index_id(impl Into<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_index_id): <p>The identifier of the index to get search metrics data.</p>
    ...
    ///   - [`snap_shot_time_filter(Option<TimeRange>)`](crate::operation::get_snapshots::GetSnapshotsOutput::snap_shot_time_filter): <p>The date-time for the beginning and end of the time window for the search metrics data.</p>
