...
impl super::Client {
    ...
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_index_id): <p>The identifier of the index to get search metrics data.</p>
    ///   - [`interval(Interval)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::interval) / [`set_interval(Option<Interval>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_interval): <p>The time interval or time window to get search metrics data. The time interval uses the time zone of your index. You can view data in the following time windows:</p>  <ul>   <li> <p> <code>THIS_WEEK</code>: The current week, starting on the Sunday and ending on the day before the current date.</p> </li>   <li> <p> <code>ONE_WEEK_AGO</code>: The previous week, starting on the Sunday and ending on the following Saturday.</p> </li>   <li> <p> <code>TWO_WEEKS_AGO</code>: The week before the previous week, starting on the Sunday and ending on the following Saturday.</p> </li>   <li> <p> <code>THIS_MONTH</code>: The current month, starting on the first day of the month and ending on the day before the current date.</p> </li>   <li> <p> <code>ONE_MONTH_AGO</code>: The previous month, starting on the first day of the month and ending on the last day of the month.</p> </li>   <li> <p> <code>TWO_MONTHS_AGO</code>: The month before the previous month, starting on the first day of the month and ending on last day of the month.</p> </li>  </ul>
    ///   - [`metric_type(MetricType)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::metric_type) / [`set_metric_type(Option<MetricType>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_metric_type): <p>The metric you want to retrieve. You can specify only one metric per call.</p>  <p>For more information about the metrics you can view, see <a href="https://docs.aws.amazon.com/kendra/latest/dg/search-analytics.html">Gaining insights with search analytics</a>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of search metrics data.</p>
    ///   - [`max_results(i32)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_snapshots::builders::GetSnapshotsFluentBuilder::set_max_results): <p>The maximum number of returned data for the metric.</p>
