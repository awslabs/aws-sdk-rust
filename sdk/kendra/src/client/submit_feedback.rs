...
impl super::Client {
    ...
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::set_index_id): <p>The identifier of the index that was queried.</p>
    ///   - [`query_id(impl ::std::convert::Into<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::query_id) / [`set_query_id(Option<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::set_query_id): <p>The identifier of the specific query for which you are submitting feedback. The query ID is returned in the response to the <code>Query</code> API.</p>
