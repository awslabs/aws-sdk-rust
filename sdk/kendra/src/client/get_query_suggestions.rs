...
impl super::Client {
    ...
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::get_query_suggestions::builders::GetQuerySuggestionsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::get_query_suggestions::builders::GetQuerySuggestionsFluentBuilder::set_index_id): <p>The identifier of the index you want to get query suggestions from.</p>
    ///   - [`query_text(impl ::std::convert::Into<String>)`](crate::operation::get_query_suggestions::builders::GetQuerySuggestionsFluentBuilder::query_text) / [`set_query_text(Option<String>)`](crate::operation::get_query_suggestions::builders::GetQuerySuggestionsFluentBuilder::set_query_text): <p>The text of a user's query to generate query suggestions.</p>  <p>A query is suggested if the query prefix matches what a user starts to type as their query.</p>  <p>Amazon Kendra does not show any suggestions if a user types fewer than two characters or more than 60 characters. A query must also have at least one search result and contain at least one word of more than four characters.</p>
