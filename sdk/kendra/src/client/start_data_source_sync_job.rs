...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::start_data_source_sync_job::builders::StartDataSourceSyncJobFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::start_data_source_sync_job::builders::StartDataSourceSyncJobFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the data source connector to synchronize.</p><br>
