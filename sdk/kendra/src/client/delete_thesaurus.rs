...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_thesaurus::builders::DeleteThesaurusFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_thesaurus::builders::DeleteThesaurusFluentBuilder::set_id): <p>The identifier of the thesaurus you want to delete.</p>
