...
impl super::Client {
    ...
    ///   - [`index_id(impl Into<String>)`](crate::operation::list_faqs::builders::ListFaqsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::list_faqs::builders::ListFaqsFluentBuilder::set_index_id):<br>required: **true**<br><p>The index for the FAQs.</p><br>
    ...
    ///   - [`faq_summary_items(Option<Vec::<FaqSummary>>)`](crate::operation::list_faqs::ListFaqsOutput::faq_summary_items): <p>Summary information about the FAQs for a specified index.</p>
