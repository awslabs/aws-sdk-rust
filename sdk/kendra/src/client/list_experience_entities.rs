...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::set_id): <p>The identifier of your Amazon Kendra experience.</p>
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::set_index_id): <p>The identifier of the index for your Amazon Kendra experience.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of users or groups.</p>
    ...
    pub fn list_experience_entities(
        &self,
    ) -> crate::operation::list_experience_entities::builders::ListExperienceEntitiesFluentBuilder
    {
