...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_thesaurus::builders::DescribeThesaurusFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_thesaurus::builders::DescribeThesaurusFluentBuilder::set_id): <p>The identifier of the thesaurus you want to get information on.</p>
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::describe_thesaurus::builders::DescribeThesaurusFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::describe_thesaurus::builders::DescribeThesaurusFluentBuilder::set_index_id): <p>The identifier of the index for the thesaurus.</p>
