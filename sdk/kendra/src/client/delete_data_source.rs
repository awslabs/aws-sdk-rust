...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the data source connector you want to delete.</p><br>
