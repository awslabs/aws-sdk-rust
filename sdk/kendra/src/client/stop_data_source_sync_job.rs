...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::stop_data_source_sync_job::builders::StopDataSourceSyncJobFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::stop_data_source_sync_job::builders::StopDataSourceSyncJobFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the data source connector for which to stop the synchronization jobs.</p><br>
    ///   - [`index_id(impl Into<String>)`](crate::operation::stop_data_source_sync_job::builders::StopDataSourceSyncJobFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::stop_data_source_sync_job::builders::StopDataSourceSyncJobFluentBuilder::set_index_id):<br>required: **true**<br><p>The identifier of the index used with the data source connector.</p><br>
