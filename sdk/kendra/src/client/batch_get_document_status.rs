...
impl super::Client {
    ...
    ///   - [`index_id(impl Into<String>)`](crate::operation::batch_get_document_status::builders::BatchGetDocumentStatusFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::batch_get_document_status::builders::BatchGetDocumentStatusFluentBuilder::set_index_id):<br>required: **true**<br><p>The identifier of the index to add documents to. The index ID is returned by the <a href="https://docs.aws.amazon.com/kendra/latest/dg/API_CreateIndex.html">CreateIndex </a> API.</p><br>
    ///   - [`document_info_list(DocumentInfo)`](crate::operation::batch_get_document_status::builders::BatchGetDocumentStatusFluentBuilder::document_info_list) / [`set_document_info_list(Option<Vec::<DocumentInfo>>)`](crate::operation::batch_get_document_status::builders::BatchGetDocumentStatusFluentBuilder::set_document_info_list):<br>required: **true**<br><p>A list of <code>DocumentInfo</code> objects that identify the documents for which to get the status. You identify the documents by their document ID and optional attributes.</p><br>
