...
impl super::Client {
    ...
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::set_index_id): <p>The identifier of the index used for featuring results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::set_next_token): <p>If the response is truncated, Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of featured results sets.</p>
    ///   - [`max_results(i32)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_featured_results_sets::builders::ListFeaturedResultsSetsFluentBuilder::set_max_results): <p>The maximum number of featured results sets to return.</p>
