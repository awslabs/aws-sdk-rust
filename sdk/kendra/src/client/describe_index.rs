...
impl super::Client {
    ...
    ///   - [`server_side_encryption_configuration(Option<ServerSideEncryptionConfiguration>)`](crate::operation::describe_index::DescribeIndexOutput::server_side_encryption_configuration): <p>The identifier of the KMS customer master key (CMK) that is used to encrypt your data. Amazon Kendra doesn't support asymmetric CMKs.</p>
    ...
    ///   - [`updated_at(Option<DateTime>)`](crate::operation::describe_index::DescribeIndexOutput::updated_at): <p>The Unix timestamp when the index was last updated.</p>
    ...
    ///   - [`user_group_resolution_configuration(Option<UserGroupResolutionConfiguration>)`](crate::operation::describe_index::DescribeIndexOutput::user_group_resolution_configuration): <p>Whether you have enabled IAM Identity Center identity source for your users and groups. This is useful for user context filtering, where search results are filtered based on the user or their group access to documents.</p>
