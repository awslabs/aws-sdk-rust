...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_id): <p>The identifier of the data source connector.</p>
