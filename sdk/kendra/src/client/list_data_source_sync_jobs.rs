...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_id): <p>The identifier of the data source connector.</p>
    ///   - [`index_id(impl ::std::convert::Into<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::index_id) / [`set_index_id(Option<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_index_id): <p>The identifier of the index used with the data source connector.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Kendra returns a pagination token in the response. You can use this pagination token to retrieve the next set of jobs.</p>
    ///   - [`max_results(i32)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_max_results): <p>The maximum number of synchronization jobs to return in the response. If there are fewer results in the list, this response contains only the actual results.</p>
    ///   - [`start_time_filter(TimeRange)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::start_time_filter) / [`set_start_time_filter(Option<TimeRange>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_start_time_filter): <p>When specified, the synchronization jobs returned in the list are limited to jobs between the specified dates.</p>
    ///   - [`status_filter(DataSourceSyncJobStatus)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::status_filter) / [`set_status_filter(Option<DataSourceSyncJobStatus>)`](crate::operation::list_data_source_sync_jobs::builders::ListDataSourceSyncJobsFluentBuilder::set_status_filter): <p>Only returns synchronization jobs with the <code>Status</code> field equal to the specified status.</p>
