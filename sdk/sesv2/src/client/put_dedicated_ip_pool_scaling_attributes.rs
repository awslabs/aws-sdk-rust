...
impl super::Client {
    ...
    ///   - [`pool_name(impl Into<String>)`](crate::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesFluentBuilder::pool_name) / [`set_pool_name(Option<String>)`](crate::operation::put_dedicated_ip_pool_scaling_attributes::builders::PutDedicatedIpPoolScalingAttributesFluentBuilder::set_pool_name): <p>The name of the dedicated IP pool.</p>
