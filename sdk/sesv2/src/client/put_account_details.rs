...
impl super::Client {
    ...
    ///   - [`mail_type(MailType)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::mail_type) / [`set_mail_type(Option<MailType>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_mail_type): <p>The type of email your account will send.</p>
    ///   - [`website_url(impl ::std::convert::Into<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::website_url) / [`set_website_url(Option<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_website_url): <p>The URL of your website. This information helps us better understand the type of content that you plan to send.</p>
    ///   - [`contact_language(ContactLanguage)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::contact_language) / [`set_contact_language(Option<ContactLanguage>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_contact_language): <p>The language you would prefer to be contacted with.</p>
    ///   - [`use_case_description(impl ::std::convert::Into<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::use_case_description) / [`set_use_case_description(Option<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_use_case_description): <p>A description of the types of email that you plan to send.</p>
    ///   - [`additional_contact_email_addresses(Vec<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::additional_contact_email_addresses) / [`set_additional_contact_email_addresses(Option<Vec<String>>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_additional_contact_email_addresses): <p>Additional email addresses that you would like to be notified regarding Amazon SES matters.</p>
