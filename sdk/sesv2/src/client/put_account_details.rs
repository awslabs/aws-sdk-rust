...
impl super::Client {
    ...
    ///   - [`website_url(impl Into<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::website_url) / [`set_website_url(Option<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_website_url): <p>The URL of your website. This information helps us better understand the type of content that you plan to send.</p>
    ...
    ///   - [`use_case_description(impl Into<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::use_case_description) / [`set_use_case_description(Option<String>)`](crate::operation::put_account_details::builders::PutAccountDetailsFluentBuilder::set_use_case_description): <p>A description of the types of email that you plan to send.</p>
