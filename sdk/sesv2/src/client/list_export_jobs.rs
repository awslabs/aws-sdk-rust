...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::set_next_token): <p>The pagination token returned from a previous call to <code>ListExportJobs</code> to indicate the position in the list of export jobs.</p>
    ///   - [`page_size(i32)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::page_size) / [`set_page_size(Option<i32>)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::set_page_size): <p>Maximum number of export jobs to return at once. Use this parameter to paginate results. If additional export jobs exist beyond the specified limit, the <code>NextToken</code> element is sent in the response. Use the <code>NextToken</code> value in subsequent calls to <code>ListExportJobs</code> to retrieve additional export jobs.</p>
    ///   - [`export_source_type(ExportSourceType)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::export_source_type) / [`set_export_source_type(Option<ExportSourceType>)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::set_export_source_type): <p>A value used to list export jobs that have a certain <code>ExportSourceType</code>.</p>
    ///   - [`job_status(JobStatus)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::job_status) / [`set_job_status(Option<JobStatus>)`](crate::operation::list_export_jobs::builders::ListExportJobsFluentBuilder::set_job_status): <p>A value used to list export jobs that have a certain <code>JobStatus</code>.</p>
