...
impl super::Client {
    ...
    ///   - [`configuration_set_name(impl ::std::convert::Into<String>)`](crate::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsFluentBuilder::configuration_set_name) / [`set_configuration_set_name(Option<String>)`](crate::operation::put_configuration_set_sending_options::builders::PutConfigurationSetSendingOptionsFluentBuilder::set_configuration_set_name): <p>The name of the configuration set to enable or disable email sending for.</p>
