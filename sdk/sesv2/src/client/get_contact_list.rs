...
impl super::Client {
    ...
    ///   - [`contact_list_name(impl ::std::convert::Into<String>)`](crate::operation::get_contact_list::builders::GetContactListFluentBuilder::contact_list_name) / [`set_contact_list_name(Option<String>)`](crate::operation::get_contact_list::builders::GetContactListFluentBuilder::set_contact_list_name): <p>The name of the contact list.</p>
