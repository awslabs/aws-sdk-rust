...
impl super::Client {
    ...
    ///   - [`report_id(impl ::std::convert::Into<String>)`](crate::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportFluentBuilder::report_id) / [`set_report_id(Option<String>)`](crate::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportFluentBuilder::set_report_id): <p>A unique string that identifies the predictive inbox placement test.</p>
