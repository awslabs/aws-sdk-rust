...
impl super::Client {
    ...
    ///   - [`email_identity(impl Into<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::email_identity) / [`set_email_identity(Option<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_email_identity): <p>The email address or domain to verify.</p>
