...
impl super::Client {
    ...
    ///   - [`email_identity(impl ::std::convert::Into<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::email_identity) / [`set_email_identity(Option<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_email_identity): <p>The email address or domain to verify.</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_tags): <p>An array of objects that define the tags (keys and values) to associate with the email identity.</p>
    ///   - [`dkim_signing_attributes(DkimSigningAttributes)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::dkim_signing_attributes) / [`set_dkim_signing_attributes(Option<DkimSigningAttributes>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_dkim_signing_attributes): <p>If your request includes this object, Amazon SES configures the identity to use Bring Your Own DKIM (BYODKIM) for DKIM authentication purposes, or, configures the key length to be used for <a href="https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html">Easy DKIM</a>.</p>  <p>You can only specify this object if the email identity is a domain, as opposed to an address.</p>
    ///   - [`configuration_set_name(impl ::std::convert::Into<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::configuration_set_name) / [`set_configuration_set_name(Option<String>)`](crate::operation::create_email_identity::builders::CreateEmailIdentityFluentBuilder::set_configuration_set_name): <p>The configuration set to use by default when sending from this identity. Note that any configuration set defined in the email sending request takes precedence. </p>
