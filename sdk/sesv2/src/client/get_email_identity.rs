...
impl super::Client {
    ...
    ///   - [`email_identity(impl ::std::convert::Into<String>)`](crate::operation::get_email_identity::builders::GetEmailIdentityFluentBuilder::email_identity) / [`set_email_identity(Option<String>)`](crate::operation::get_email_identity::builders::GetEmailIdentityFluentBuilder::set_email_identity): <p>The email identity.</p>
