...
impl super::Client {
    ...
    ///   - [`configuration_set_name(impl ::std::convert::Into<String>)`](crate::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsFluentBuilder::configuration_set_name) / [`set_configuration_set_name(Option<String>)`](crate::operation::put_configuration_set_vdm_options::builders::PutConfigurationSetVdmOptionsFluentBuilder::set_configuration_set_name): <p>The name of the configuration set.</p>
