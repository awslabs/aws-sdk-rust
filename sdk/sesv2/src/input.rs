    ...
    > {
        let mut request = {
            ...
            fn uri_query(
                ...
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_33 = &_input.start_date;
    ...
    > {
        let mut request = {
            ...
            fn uri_query(
                ...
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_54 = &_input.start_date;
    ...
    > {
        let mut request = {
            ...
            fn uri_query(
                ...
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                let inner_84 = &_input.resource_arn;
