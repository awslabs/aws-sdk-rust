...
impl GetEmailIdentityPoliciesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesOutput, crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesError, Self> {
