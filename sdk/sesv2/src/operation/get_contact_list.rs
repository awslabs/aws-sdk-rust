...
impl GetContactListInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_contact_list::GetContactList, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContactList {
    type Output =
        ::std::result::Result<crate::operation::get_contact_list::GetContactListOutput, crate::operation::get_contact_list::GetContactListError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_contact_list::de_get_contact_list_http_response_with_props(status, headers, body)
        }
    }
}
