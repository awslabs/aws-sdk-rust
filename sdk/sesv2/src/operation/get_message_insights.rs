...
impl GetMessageInsights {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("sesv2", "GetMessageInsights", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMessageInsights {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetMessageInsights", "sesv2"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetMessageInsights")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetMessageInsightsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetMessageInsightsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetMessageInsightsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetMessageInsightsEndpointParamsInterceptor {
...
pub type GetMessageInsightsErrorKind = GetMessageInsightsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetMessageInsightsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_message_insights::GetMessageInsightsError {
...
impl GetMessageInsightsError {
    ...
    /// Creates the `GetMessageInsightsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
