...
impl GetDeliverabilityTestReport {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput,
                    ) -> ::std::result::Result<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDeliverabilityTestReport {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDeliverabilityTestReport");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDeliverabilityTestReportRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDeliverabilityTestReportResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDeliverabilityTestReport")
...
.with_interceptor(GetDeliverabilityTestReportEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError>::new());
...
#[derive(Debug)]
            struct GetDeliverabilityTestReportResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDeliverabilityTestReportResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_deliverability_test_report::de_get_deliverability_test_report_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDeliverabilityTestReportRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDeliverabilityTestReportRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.report_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("report_id", "cannot be empty or unset"))?;
    let report_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if report_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("report_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/v2/email/deliverability-dashboard/test-reports/{ReportId}", ReportId = report_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetDeliverabilityTestReportEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDeliverabilityTestReportEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDeliverabilityTestReportEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDeliverabilityTestReportInput>()
                        .ok_or("failed to downcast to GetDeliverabilityTestReportInput")?;
...
pub enum GetDeliverabilityTestReportError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDeliverabilityTestReportError) for what information is available for the error.")]
...
impl GetDeliverabilityTestReportError {
    /// Creates the `GetDeliverabilityTestReportError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDeliverabilityTestReportError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDeliverabilityTestReportError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError {
...
mod _get_deliverability_test_report_output;
