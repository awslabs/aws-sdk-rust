...
impl PutEmailIdentityDkimSigningAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_email_identity_dkim_signing_attributes::PutEmailIdentityDkimSigningAttributesInput, ::aws_smithy_types::error::operation::BuildError> {
