...
impl DeleteEmailIdentityPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_email_identity_policy::DeleteEmailIdentityPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEmailIdentityPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_email_identity_policy::de_delete_email_identity_policy_http_response_with_props(status, headers, body)
        }
    }
}
