...
impl ListImportJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_import_jobs::ListImportJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_import_jobs::ser_list_import_jobs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImportJobs {
    type Output =
        ::std::result::Result<crate::operation::list_import_jobs::ListImportJobsOutput, crate::operation::list_import_jobs::ListImportJobsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_import_jobs::de_list_import_jobs_http_response_with_props(status, headers, body)
        }
    }
}
