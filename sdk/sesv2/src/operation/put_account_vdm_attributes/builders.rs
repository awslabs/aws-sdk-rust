...
impl PutAccountVdmAttributesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_account_vdm_attributes::PutAccountVdmAttributesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_account_vdm_attributes::PutAccountVdmAttributesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_account_vdm_attributes::PutAccountVdmAttributesOutput, crate::operation::put_account_vdm_attributes::PutAccountVdmAttributesError, Self> {
