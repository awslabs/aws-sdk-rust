...
impl SendEmailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_email::SendEmail, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_email::ser_send_email_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_email::de_send_email_http_response_with_props(status, headers, body)
        }
    }
}
