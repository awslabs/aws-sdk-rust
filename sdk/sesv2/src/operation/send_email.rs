    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v2/email/outbound-emails")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_email::SendEmail::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendEmail {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_email::de_send_email_http_response_with_props(
                status, headers, body,
            )
        }
    }
