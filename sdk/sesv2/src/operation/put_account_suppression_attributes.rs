...
impl PutAccountSuppressionAttributesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_account_suppression_attributes::PutAccountSuppressionAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountSuppressionAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_suppression_attributes::de_put_account_suppression_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
