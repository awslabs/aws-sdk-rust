...
impl DeleteContactListInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_contact_list::DeleteContactList,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContactList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_contact_list::de_delete_contact_list_http_response_with_props(status, headers, body)
        }
    }
}
