...
impl UpdateEmailIdentityPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_email_identity_policy::UpdateEmailIdentityPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_email_identity_policy::UpdateEmailIdentityPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_email_identity_policy::UpdateEmailIdentityPolicyOutput, crate::operation::update_email_identity_policy::UpdateEmailIdentityPolicyError, Self> {
