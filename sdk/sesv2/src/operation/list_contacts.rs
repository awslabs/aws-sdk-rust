...
impl ListContactsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_contacts::ListContacts, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_contacts::ser_list_contacts_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContacts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_contacts::de_list_contacts_http_response_with_props(status, headers, body)
        }
    }
}
