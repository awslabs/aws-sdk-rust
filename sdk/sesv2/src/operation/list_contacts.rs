...
impl ListContactsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_contacts::ListContacts::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContacts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_contacts::de_list_contacts_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_contacts::de_list_contacts_http_response_with_props(
                status, headers, body,
            )
        }
    }
