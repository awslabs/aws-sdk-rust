...
impl DeleteSuppressedDestinationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_suppressed_destination::DeleteSuppressedDestination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSuppressedDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_suppressed_destination::de_delete_suppressed_destination_http_response_with_props(
                status, headers, body,
            )
        }
    }
