...
impl PutEmailIdentityMailFromAttributesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributes,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_email_identity_mail_from_attributes::PutEmailIdentityMailFromAttributes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEmailIdentityMailFromAttributes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_email_identity_mail_from_attributes::de_put_email_identity_mail_from_attributes_http_response_with_props(
                status, headers, body,
            )
        }
    }
