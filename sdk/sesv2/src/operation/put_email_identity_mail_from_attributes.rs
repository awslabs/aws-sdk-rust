...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutEmailIdentityMailFromAttributes {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("PutEmailIdentityMailFromAttributes", "sesv2"));
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for PutEmailIdentityMailFromAttributesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for PutEmailIdentityMailFromAttributesRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutEmailIdentityMailFromAttributesEndpointParamsInterceptor {
