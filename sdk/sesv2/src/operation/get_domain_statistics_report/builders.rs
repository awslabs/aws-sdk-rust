...
impl GetDomainStatisticsReportFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_domain_statistics_report::GetDomainStatisticsReportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_domain_statistics_report::GetDomainStatisticsReportOutput, crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError, Self> {
