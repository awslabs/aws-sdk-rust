...
impl ListExportJobsFluentBuilder {
    ...
    pub async fn customize(
        ...
        crate::client::customize::orchestrator::CustomizableOperation<
            ...
            Self,
        >,
        ::aws_smithy_http::result::SdkError<crate::operation::list_export_jobs::ListExportJobsError>,
    > {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_export_jobs::paginator::ListExportJobsPaginator::send) which returns a `Stream`.
