...
impl DeleteDedicatedIpPoolFluentBuilder  {
    /// Creates a new `DeleteDedicatedIpPool`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolOutput, aws_smithy_http::result::SdkError<crate::operation::delete_dedicated_ip_pool::DeleteDedicatedIpPoolError>>
                     {
