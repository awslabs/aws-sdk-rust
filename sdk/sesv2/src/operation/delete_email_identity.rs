...
impl DeleteEmailIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_email_identity::DeleteEmailIdentity,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEmailIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_email_identity::de_delete_email_identity_http_response_with_props(status, headers, body)
        }
    }
}
