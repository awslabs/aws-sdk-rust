...
impl UpdateEmailIdentityPolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_email_identity_policy::UpdateEmailIdentityPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEmailIdentityPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_email_identity_policy::de_update_email_identity_policy_http_response_with_props(status, headers, body)
        }
    }
}
