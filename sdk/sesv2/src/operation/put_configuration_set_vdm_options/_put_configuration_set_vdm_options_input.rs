...
impl PutConfigurationSetVdmOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_configuration_set_vdm_options::PutConfigurationSetVdmOptionsInput, ::aws_smithy_types::error::operation::BuildError> {
