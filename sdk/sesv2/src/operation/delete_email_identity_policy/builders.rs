...
impl DeleteEmailIdentityPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyOutput, crate::operation::delete_email_identity_policy::DeleteEmailIdentityPolicyError, Self> {
