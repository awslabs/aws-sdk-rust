...
impl UpdateContactListInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_contact_list::ser_update_contact_list_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContactList {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_contact_list::de_update_contact_list_http_response_with_props(status, headers, body)
        }
    }
}
