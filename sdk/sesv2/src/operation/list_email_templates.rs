...
impl ListEmailTemplatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_email_templates::ListEmailTemplates,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEmailTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_email_templates::de_list_email_templates_http_response_with_props(status, headers, body)
        }
    }
}
