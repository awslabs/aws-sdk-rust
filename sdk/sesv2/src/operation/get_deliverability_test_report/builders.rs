...
impl crate::operation::get_deliverability_test_report::builders::GetDeliverabilityTestReportInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.get_deliverability_test_report();
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportOutput,
        crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportError,
    > for GetDeliverabilityTestReportFluentBuilder
{
    fn send(
        self,
