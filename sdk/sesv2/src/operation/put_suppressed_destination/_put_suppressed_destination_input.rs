...
impl PutSuppressedDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_suppressed_destination::PutSuppressedDestinationInput, ::aws_smithy_types::error::operation::BuildError> {
