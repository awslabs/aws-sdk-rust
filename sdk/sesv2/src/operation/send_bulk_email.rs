...
impl SendBulkEmailInput {
    /// Consumes the builder and constructs an Operation<[`SendBulkEmail`](crate::operation::send_bulk_email::SendBulkEmail)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::send_bulk_email::SendBulkEmail, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_bulk_email::SendBulkEmailInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::send_bulk_email::SendBulkEmail::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SendBulkEmail", "sesv2"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `SendBulkEmail`.
...
impl aws_smithy_http::response::ParseStrictResponse for SendBulkEmail {
                type Output = std::result::Result<crate::operation::send_bulk_email::SendBulkEmailOutput, crate::operation::send_bulk_email::SendBulkEmailError>;
