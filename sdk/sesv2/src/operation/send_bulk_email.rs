...
impl SendBulkEmailInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::send_bulk_email::SendBulkEmail, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_bulk_email::ser_send_bulk_email_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendBulkEmail {
    type Output =
        ::std::result::Result<crate::operation::send_bulk_email::SendBulkEmailOutput, crate::operation::send_bulk_email::SendBulkEmailError>;
