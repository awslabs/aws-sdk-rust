...
impl PutAccountDetailsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_account_details::ser_put_account_details_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_account_details::de_put_account_details_http_response_with_props(status, headers, body)
        }
    }
}
