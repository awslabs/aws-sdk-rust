...
impl TestRenderEmailTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::test_render_email_template::TestRenderEmailTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
