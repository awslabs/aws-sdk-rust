...
impl TestRenderEmailTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::test_render_email_template::TestRenderEmailTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_render_email_template::TestRenderEmailTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::test_render_email_template::TestRenderEmailTemplateOutput, crate::operation::test_render_email_template::TestRenderEmailTemplateError, Self> {
