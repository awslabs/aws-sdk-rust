...
impl GetDedicatedIpFluentBuilder  {
    /// Creates a new `GetDedicatedIp`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_dedicated_ip::GetDedicatedIpOutput, aws_smithy_http::result::SdkError<crate::operation::get_dedicated_ip::GetDedicatedIpError>>
                     {
