...
pub use crate::operation::create_email_identity_policy::_create_email_identity_policy_output::CreateEmailIdentityPolicyOutputBuilder;
...
pub struct CreateEmailIdentityPolicyFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyOutput,
                    crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyError,
                > for CreateEmailIdentityPolicyFluentBuilder
            {
                fn send(
                    self,
...
impl CreateEmailIdentityPolicyFluentBuilder {
    ...
    /// Access the CreateEmailIdentityPolicy as a reference.
    pub fn as_input(&self) -> &crate::operation::create_email_identity_policy::builders::CreateEmailIdentityPolicyInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_email_identity_policy::CreateEmailIdentityPolicy::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_email_identity_policy::CreateEmailIdentityPolicy::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyOutput, crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyError, Self> {
