...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomVerificationEmailTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_custom_verification_email_templates::de_list_custom_verification_email_templates_http_response_with_props(status, headers, body)
        }
    }
}
