...
impl GetDeliverabilityDashboardOptionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_deliverability_dashboard_options::GetDeliverabilityDashboardOptions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDeliverabilityDashboardOptions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_deliverability_dashboard_options::de_get_deliverability_dashboard_options_http_response_with_props(
                status, headers, body,
            )
        }
    }
