...
pub fn serialize_structure_create_configuration_set_input(
    ...
    if let Some(var_8) = &input.suppression_options {
        ...
        crate::json_ser::serialize_structure_suppression_options(&mut object_9, var_8);
        object_9.finish();
    }
    ...
    if let Some(var_14) = &input.tracking_options {
        ...
        crate::json_ser::serialize_structure_tracking_options(&mut object_15, var_14);
        object_15.finish();
    }
}
...
pub fn serialize_structure_create_configuration_set_event_destination_input(
    ...
    if let Some(var_16) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_17, var_16);
        object_17.finish();
    }
    if let Some(var_18) = &input.event_destination_name {
        object.key("EventDestinationName").string(var_18);
    }
}
...
pub fn serialize_structure_create_contact_input(
    ...
    if let Some(var_19) = &input.attributes_data {
        object.key("AttributesData").string(var_19);
    }
    if let Some(var_20) = &input.email_address {
        object.key("EmailAddress").string(var_20);
    }
        ...
        for item_23 in var_21 {
            {
                ...
                crate::json_ser::serialize_structure_topic_preference(&mut object_24, item_23);
                object_24.finish();
            }
        }
        array_22.finish();
...
pub fn serialize_structure_create_contact_list_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::CreateContactListInput,
) {
    if let Some(var_25) = &input.contact_list_name {
        object.key("ContactListName").string(var_25);
    }
        ...
        for item_33 in var_31 {
            {
                ...
                crate::json_ser::serialize_structure_topic(&mut object_34, item_33);
                object_34.finish();
            }
        }
        array_32.finish();
...
pub fn serialize_structure_create_custom_verification_email_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::CreateCustomVerificationEmailTemplateInput,
) {
    if let Some(var_35) = &input.failure_redirection_url {
        object.key("FailureRedirectionURL").string(var_35);
    }
    if let Some(var_36) = &input.from_email_address {
        object.key("FromEmailAddress").string(var_36);
    }
    if let Some(var_37) = &input.success_redirection_url {
        object.key("SuccessRedirectionURL").string(var_37);
    }
    if let Some(var_38) = &input.template_content {
        object.key("TemplateContent").string(var_38);
    }
    if let Some(var_39) = &input.template_name {
        object.key("TemplateName").string(var_39);
    }
    if let Some(var_40) = &input.template_subject {
        object.key("TemplateSubject").string(var_40);
    }
}
...
pub fn serialize_structure_create_dedicated_ip_pool_input(
    ...
    if let Some(var_41) = &input.pool_name {
        object.key("PoolName").string(var_41);
    }
...
pub fn serialize_structure_create_deliverability_test_report_input(
    ...
    if let Some(var_46) = &input.content {
        ...
        crate::json_ser::serialize_structure_email_content(&mut object_47, var_46);
        object_47.finish();
    }
    if let Some(var_48) = &input.from_email_address {
        object.key("FromEmailAddress").string(var_48);
    }
    if let Some(var_49) = &input.report_name {
        object.key("ReportName").string(var_49);
    }
...
pub fn serialize_structure_create_email_identity_input(
    ...
    if let Some(var_54) = &input.configuration_set_name {
        object.key("ConfigurationSetName").string(var_54);
    }
    if let Some(var_55) = &input.dkim_signing_attributes {
        let mut object_56 = object.key("DkimSigningAttributes").start_object();
        crate::json_ser::serialize_structure_dkim_signing_attributes(&mut object_56, var_55);
        object_56.finish();
    }
    if let Some(var_57) = &input.email_identity {
        object.key("EmailIdentity").string(var_57);
    }
...
pub fn serialize_structure_create_email_identity_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::CreateEmailIdentityPolicyInput,
) {
    if let Some(var_62) = &input.policy {
        object.key("Policy").string(var_62);
    }
}

pub fn serialize_structure_create_email_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_63) = &input.template_content {
        ...
        crate::json_ser::serialize_structure_email_template_content(&mut object_64, var_63);
        object_64.finish();
    }
    if let Some(var_65) = &input.template_name {
        object.key("TemplateName").string(var_65);
    }
}

pub fn serialize_structure_create_import_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_66) = &input.import_data_source {
        ...
        crate::json_ser::serialize_structure_import_data_source(&mut object_67, var_66);
        object_67.finish();
    }
    if let Some(var_68) = &input.import_destination {
        let mut object_69 = object.key("ImportDestination").start_object();
        crate::json_ser::serialize_structure_import_destination(&mut object_69, var_68);
        object_69.finish();
    }
}
...
pub fn serialize_structure_list_contacts_input(
    ...
    if let Some(var_70) = &input.filter {
        ...
        crate::json_ser::serialize_structure_list_contacts_filter(&mut object_71, var_70);
        object_71.finish();
    }
}

pub fn serialize_structure_list_import_jobs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_account_details_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_79) = &input.use_case_description {
        object.key("UseCaseDescription").string(var_79);
    }
    if let Some(var_80) = &input.website_url {
        object.key("WebsiteURL").string(var_80);
    }
}
...
pub fn serialize_structure_put_account_suppression_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_delivery_options_input(
    ...
    if let Some(var_84) = &input.sending_pool_name {
        object.key("SendingPoolName").string(var_84);
    }
...
pub fn serialize_structure_put_configuration_set_suppression_options_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_configuration_set_tracking_options_input(
    ...
    if let Some(var_89) = &input.custom_redirect_domain {
        object.key("CustomRedirectDomain").string(var_89);
    }
}
...
pub fn serialize_structure_put_dedicated_ip_in_pool_input(
    ...
    if let Some(var_90) = &input.destination_pool_name {
        object.key("DestinationPoolName").string(var_90);
    }
}
...
pub fn serialize_structure_put_email_identity_configuration_set_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::PutEmailIdentityConfigurationSetAttributesInput,
) {
    if let Some(var_96) = &input.configuration_set_name {
        object.key("ConfigurationSetName").string(var_96);
    }
}
...
pub fn serialize_structure_put_email_identity_dkim_signing_attributes_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_97) = &input.signing_attributes {
        ...
        crate::json_ser::serialize_structure_dkim_signing_attributes(&mut object_98, var_97);
        object_98.finish();
    }
...
pub fn serialize_structure_put_email_identity_mail_from_attributes_input(
    ...
    if let Some(var_101) = &input.mail_from_domain {
        object.key("MailFromDomain").string(var_101);
    }
}

pub fn serialize_structure_put_suppressed_destination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::PutSuppressedDestinationInput,
) {
    if let Some(var_102) = &input.email_address {
        object.key("EmailAddress").string(var_102);
    }
...
pub fn serialize_structure_send_bulk_email_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_106 in var_104 {
            {
                ...
                crate::json_ser::serialize_structure_bulk_email_entry(&mut object_107, item_106);
                object_107.finish();
            }
        }
        array_105.finish();
    ...
    if let Some(var_108) = &input.configuration_set_name {
        object.key("ConfigurationSetName").string(var_108);
    }
    if let Some(var_109) = &input.default_content {
        let mut object_110 = object.key("DefaultContent").start_object();
        crate::json_ser::serialize_structure_bulk_email_content(&mut object_110, var_109);
        object_110.finish();
    }
        ...
        for item_113 in var_111 {
            {
                ...
                crate::json_ser::serialize_structure_message_tag(&mut object_114, item_113);
                object_114.finish();
            }
        }
        array_112.finish();
    ...
    if let Some(var_115) = &input.feedback_forwarding_email_address {
        object.key("FeedbackForwardingEmailAddress").string(var_115);
    }
    ...
    if let Some(var_117) = &input.from_email_address {
        object.key("FromEmailAddress").string(var_117);
    }
    if let Some(var_118) = &input.from_email_address_identity_arn {
        object.key("FromEmailAddressIdentityArn").string(var_118);
    }
...
pub fn serialize_structure_send_custom_verification_email_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::SendCustomVerificationEmailInput,
) {
    if let Some(var_122) = &input.configuration_set_name {
        object.key("ConfigurationSetName").string(var_122);
    }
    if let Some(var_123) = &input.email_address {
        object.key("EmailAddress").string(var_123);
    }
...
pub fn serialize_structure_send_email_input(
    ...
    if let Some(var_125) = &input.configuration_set_name {
        object.key("ConfigurationSetName").string(var_125);
    }
    if let Some(var_126) = &input.content {
        let mut object_127 = object.key("Content").start_object();
        crate::json_ser::serialize_structure_email_content(&mut object_127, var_126);
        object_127.finish();
    }
    if let Some(var_128) = &input.destination {
        let mut object_129 = object.key("Destination").start_object();
        crate::json_ser::serialize_structure_destination(&mut object_129, var_128);
        object_129.finish();
    }
        ...
        for item_132 in var_130 {
            {
                ...
                crate::json_ser::serialize_structure_message_tag(&mut object_133, item_132);
                object_133.finish();
            }
        }
        array_131.finish();
    ...
    if let Some(var_134) = &input.feedback_forwarding_email_address {
        object.key("FeedbackForwardingEmailAddress").string(var_134);
    }
    ...
    if let Some(var_136) = &input.from_email_address {
        object.key("FromEmailAddress").string(var_136);
    }
    if let Some(var_137) = &input.from_email_address_identity_arn {
        object.key("FromEmailAddressIdentityArn").string(var_137);
    }
    if let Some(var_138) = &input.list_management_options {
        let mut object_139 = object.key("ListManagementOptions").start_object();
        crate::json_ser::serialize_structure_list_management_options(&mut object_139, var_138);
        object_139.finish();
    }
...
pub fn serialize_structure_test_render_email_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::TestRenderEmailTemplateInput,
) {
    if let Some(var_148) = &input.template_data {
        object.key("TemplateData").string(var_148);
    }
}
...
pub fn serialize_structure_update_configuration_set_event_destination_input(
    ...
    if let Some(var_149) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_150, var_149);
        object_150.finish();
    }
}
...
pub fn serialize_structure_update_contact_input(
    ...
    if let Some(var_151) = &input.attributes_data {
        object.key("AttributesData").string(var_151);
    }
        ...
        for item_154 in var_152 {
            {
                ...
                crate::json_ser::serialize_structure_topic_preference(&mut object_155, item_154);
                object_155.finish();
            }
        }
        array_153.finish();
...
pub fn serialize_structure_update_contact_list_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_159 in var_157 {
            {
                ...
                crate::json_ser::serialize_structure_topic(&mut object_160, item_159);
                object_160.finish();
            }
        }
        array_158.finish();
...
pub fn serialize_structure_update_custom_verification_email_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::UpdateCustomVerificationEmailTemplateInput,
) {
    if let Some(var_161) = &input.failure_redirection_url {
        object.key("FailureRedirectionURL").string(var_161);
    }
    if let Some(var_162) = &input.from_email_address {
        object.key("FromEmailAddress").string(var_162);
    }
    if let Some(var_163) = &input.success_redirection_url {
        object.key("SuccessRedirectionURL").string(var_163);
    }
    if let Some(var_164) = &input.template_content {
        object.key("TemplateContent").string(var_164);
    }
    if let Some(var_165) = &input.template_subject {
        object.key("TemplateSubject").string(var_165);
    }
}

pub fn serialize_structure_update_email_identity_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_email_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_167) = &input.template_content {
        ...
        crate::json_ser::serialize_structure_email_template_content(&mut object_168, var_167);
        object_168.finish();
    }
}
...
pub fn serialize_structure_delivery_options(
    ...
    if let Some(var_170) = &input.sending_pool_name {
        object.key("SendingPoolName").string(var_170);
    }
}
...
pub fn serialize_structure_suppression_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_tag(
    ...
    if let Some(var_175) = &input.key {
        object.key("Key").string(var_175);
    }
    if let Some(var_176) = &input.value {
        object.key("Value").string(var_176);
    }
}
...
pub fn serialize_structure_tracking_options(
    ...
    if let Some(var_177) = &input.custom_redirect_domain {
        object.key("CustomRedirectDomain").string(var_177);
    }
}
...
pub fn serialize_structure_event_destination_definition(
    ...
    if let Some(var_181) = &input.kinesis_firehose_destination {
        ...
        crate::json_ser::serialize_structure_kinesis_firehose_destination(&mut object_182, var_181);
        object_182.finish();
    }
    if let Some(var_183) = &input.cloud_watch_destination {
        let mut object_184 = object.key("CloudWatchDestination").start_object();
        crate::json_ser::serialize_structure_cloud_watch_destination(&mut object_184, var_183);
        object_184.finish();
    }
    if let Some(var_185) = &input.sns_destination {
        let mut object_186 = object.key("SnsDestination").start_object();
        crate::json_ser::serialize_structure_sns_destination(&mut object_186, var_185);
        object_186.finish();
    }
    if let Some(var_187) = &input.pinpoint_destination {
        let mut object_188 = object.key("PinpointDestination").start_object();
        crate::json_ser::serialize_structure_pinpoint_destination(&mut object_188, var_187);
        object_188.finish();
    }
}

pub fn serialize_structure_topic_preference(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::TopicPreference,
) {
    if let Some(var_189) = &input.topic_name {
        object.key("TopicName").string(var_189);
    }
...
pub fn serialize_structure_topic(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::Topic,
) {
    if let Some(var_191) = &input.topic_name {
        object.key("TopicName").string(var_191);
    }
    if let Some(var_192) = &input.display_name {
        object.key("DisplayName").string(var_192);
    }
...
pub fn serialize_structure_email_content(
    ...
    if let Some(var_195) = &input.simple {
        ...
        crate::json_ser::serialize_structure_message(&mut object_196, var_195);
        object_196.finish();
    }
    if let Some(var_197) = &input.raw {
        let mut object_198 = object.key("Raw").start_object();
        crate::json_ser::serialize_structure_raw_message(&mut object_198, var_197);
        object_198.finish();
    }
    if let Some(var_199) = &input.template {
        let mut object_200 = object.key("Template").start_object();
        crate::json_ser::serialize_structure_template(&mut object_200, var_199);
        object_200.finish();
    }
}

pub fn serialize_structure_dkim_signing_attributes(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::DkimSigningAttributes,
) {
    if let Some(var_201) = &input.domain_signing_selector {
        object.key("DomainSigningSelector").string(var_201);
    }
    if let Some(var_202) = &input.domain_signing_private_key {
        object.key("DomainSigningPrivateKey").string(var_202);
    }
}

pub fn serialize_structure_email_template_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::EmailTemplateContent,
) {
    if let Some(var_203) = &input.subject {
        object.key("Subject").string(var_203);
    }
    if let Some(var_204) = &input.text {
        object.key("Text").string(var_204);
    }
    if let Some(var_205) = &input.html {
        object.key("Html").string(var_205);
    }
}
...
pub fn serialize_structure_import_data_source(
    ...
    if let Some(var_206) = &input.s3_url {
        object.key("S3Url").string(var_206);
    }
    if let Some(var_207) = &input.data_format {
        object.key("DataFormat").string(var_207.as_str());
    }
}

pub fn serialize_structure_import_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ImportDestination,
) {
    if let Some(var_208) = &input.suppression_list_destination {
        let mut object_209 = object.key("SuppressionListDestination").start_object();
        crate::json_ser::serialize_structure_suppression_list_destination(&mut object_209, var_208);
        object_209.finish();
    }
    if let Some(var_210) = &input.contact_list_destination {
        let mut object_211 = object.key("ContactListDestination").start_object();
        crate::json_ser::serialize_structure_contact_list_destination(&mut object_211, var_210);
        object_211.finish();
    }
}

pub fn serialize_structure_list_contacts_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ListContactsFilter,
) {
    if let Some(var_212) = &input.filtered_status {
        object.key("FilteredStatus").string(var_212.as_str());
    }
    if let Some(var_213) = &input.topic_filter {
        let mut object_214 = object.key("TopicFilter").start_object();
        crate::json_ser::serialize_structure_topic_filter(&mut object_214, var_213);
        object_214.finish();
    }
}
...
pub fn serialize_structure_domain_deliverability_tracking_option(
    ...
    if let Some(var_215) = &input.domain {
        object.key("Domain").string(var_215);
    }
    if let Some(var_216) = &input.subscription_start_date {
        object
            .key("SubscriptionStartDate")
            .instant(var_216, smithy_types::instant::Format::EpochSeconds);
    }
    if let Some(var_217) = &input.inbox_placement_tracking_option {
        let mut object_218 = object.key("InboxPlacementTrackingOption").start_object();
...
pub fn serialize_structure_bulk_email_entry(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::BulkEmailEntry,
) {
    if let Some(var_219) = &input.destination {
        let mut object_220 = object.key("Destination").start_object();
        crate::json_ser::serialize_structure_destination(&mut object_220, var_219);
        object_220.finish();
    }
    if let Some(var_221) = &input.replacement_tags {
        let mut array_222 = object.key("ReplacementTags").start_array();
        for item_223 in var_221 {
            {
                let mut object_224 = array_222.value().start_object();
                crate::json_ser::serialize_structure_message_tag(&mut object_224, item_223);
                object_224.finish();
            }
        }
        array_222.finish();
    }
    if let Some(var_225) = &input.replacement_email_content {
        let mut object_226 = object.key("ReplacementEmailContent").start_object();
        crate::json_ser::serialize_structure_replacement_email_content(&mut object_226, var_225);
        object_226.finish();
    }
}

pub fn serialize_structure_bulk_email_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::BulkEmailContent,
) {
    if let Some(var_227) = &input.template {
        let mut object_228 = object.key("Template").start_object();
        crate::json_ser::serialize_structure_template(&mut object_228, var_227);
        object_228.finish();
    }
}
...
pub fn serialize_structure_destination(
    ...
    if let Some(var_231) = &input.to_addresses {
        let mut array_232 = object.key("ToAddresses").start_array();
    ...
    if let Some(var_234) = &input.cc_addresses {
        let mut array_235 = object.key("CcAddresses").start_array();
    ...
    if let Some(var_237) = &input.bcc_addresses {
        let mut array_238 = object.key("BccAddresses").start_array();
...
pub fn serialize_structure_list_management_options(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ListManagementOptions,
) {
    if let Some(var_240) = &input.contact_list_name {
        object.key("ContactListName").string(var_240);
    }
    if let Some(var_241) = &input.topic_name {
        object.key("TopicName").string(var_241);
    }
}
...
pub fn serialize_structure_kinesis_firehose_destination(
    ...
    if let Some(var_242) = &input.iam_role_arn {
        object.key("IamRoleArn").string(var_242);
    }
    if let Some(var_243) = &input.delivery_stream_arn {
        object.key("DeliveryStreamArn").string(var_243);
    }
}
...
pub fn serialize_structure_cloud_watch_destination(
    ...
    if let Some(var_244) = &input.dimension_configurations {
        let mut array_245 = object.key("DimensionConfigurations").start_array();
...
pub fn serialize_structure_sns_destination(
    ...
    if let Some(var_248) = &input.topic_arn {
        object.key("TopicArn").string(var_248);
    }
}
...
pub fn serialize_structure_pinpoint_destination(
    ...
    if let Some(var_249) = &input.application_arn {
        object.key("ApplicationArn").string(var_249);
    }
}
...
pub fn serialize_structure_message(
    ...
    if let Some(var_250) = &input.subject {
        let mut object_251 = object.key("Subject").start_object();
        crate::json_ser::serialize_structure_content(&mut object_251, var_250);
        object_251.finish();
    }
    if let Some(var_252) = &input.body {
        let mut object_253 = object.key("Body").start_object();
        crate::json_ser::serialize_structure_body(&mut object_253, var_252);
        object_253.finish();
    }
}
...
pub fn serialize_structure_raw_message(
    ...
    if let Some(var_254) = &input.data {
        object
            .key("Data")
            .string_unchecked(&smithy_types::base64::encode(var_254));
    }
}
...
pub fn serialize_structure_template(
    ...
    if let Some(var_255) = &input.template_name {
        object.key("TemplateName").string(var_255);
    }
    if let Some(var_256) = &input.template_arn {
        object.key("TemplateArn").string(var_256);
    }
    if let Some(var_257) = &input.template_data {
        object.key("TemplateData").string(var_257);
    }
}

pub fn serialize_structure_suppression_list_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::SuppressionListDestination,
) {
    if let Some(var_258) = &input.suppression_list_import_action {
        object
...
pub fn serialize_structure_contact_list_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ContactListDestination,
) {
    if let Some(var_259) = &input.contact_list_name {
        object.key("ContactListName").string(var_259);
    }
    if let Some(var_260) = &input.contact_list_import_action {
        object
...
pub fn serialize_structure_topic_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::TopicFilter,
) {
    if let Some(var_261) = &input.topic_name {
        object.key("TopicName").string(var_261);
    }
...
pub fn serialize_structure_inbox_placement_tracking_option(
    ...
    if let Some(var_262) = &input.tracked_isps {
        let mut array_263 = object.key("TrackedIsps").start_array();
...
pub fn serialize_structure_replacement_email_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ReplacementEmailContent,
) {
    if let Some(var_265) = &input.replacement_template {
        let mut object_266 = object.key("ReplacementTemplate").start_object();
        crate::json_ser::serialize_structure_replacement_template(&mut object_266, var_265);
        object_266.finish();
    }
}
...
pub fn serialize_structure_cloud_watch_dimension_configuration(
    ...
    if let Some(var_267) = &input.dimension_name {
        object.key("DimensionName").string(var_267);
    }
    if let Some(var_268) = &input.dimension_value_source {
        object.key("DimensionValueSource").string(var_268.as_str());
    }
    if let Some(var_269) = &input.default_dimension_value {
        object.key("DefaultDimensionValue").string(var_269);
    }
}
...
pub fn serialize_structure_content(
    ...
    if let Some(var_270) = &input.data {
        object.key("Data").string(var_270);
    }
    if let Some(var_271) = &input.charset {
        object.key("Charset").string(var_271);
    }
}
...
pub fn serialize_structure_body(
    ...
    if let Some(var_272) = &input.text {
        let mut object_273 = object.key("Text").start_object();
        crate::json_ser::serialize_structure_content(&mut object_273, var_272);
        object_273.finish();
    }
    if let Some(var_274) = &input.html {
        let mut object_275 = object.key("Html").start_object();
        crate::json_ser::serialize_structure_content(&mut object_275, var_274);
        object_275.finish();
    }
}

pub fn serialize_structure_replacement_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ReplacementTemplate,
) {
    if let Some(var_276) = &input.replacement_template_data {
        object.key("ReplacementTemplateData").string(var_276);
    }
}
