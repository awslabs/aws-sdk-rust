...
pub fn ser_topic_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TopicFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
