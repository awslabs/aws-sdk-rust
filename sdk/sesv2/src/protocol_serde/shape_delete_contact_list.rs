...
pub fn de_delete_contact_list_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_contact_list::DeleteContactListOutput, crate::operation::delete_contact_list::DeleteContactListError>
{
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_contact_list_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::delete_contact_list::DeleteContactListOutput, crate::operation::delete_contact_list::DeleteContactListError>
