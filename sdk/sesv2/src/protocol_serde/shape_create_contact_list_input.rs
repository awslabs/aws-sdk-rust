...
pub fn ser_create_contact_list_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateContactListInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
