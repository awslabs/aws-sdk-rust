...
) -> Result<Option<crate::types::ExportJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ExportSourceType" => {
                            builder = builder.set_export_source_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ExportSourceType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "JobStatus" => {
