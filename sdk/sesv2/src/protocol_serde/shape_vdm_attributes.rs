            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DashboardAttributes" => {
                            builder = builder.set_dashboard_attributes(crate::protocol_serde::shape_dashboard_attributes::de_dashboard_attributes(
                                tokens, _value,
                            )?);
                        }
                        "GuardianAttributes" => {
                            builder = builder
                                .set_guardian_attributes(crate::protocol_serde::shape_guardian_attributes::de_guardian_attributes(tokens, _value)?);
                        }
