...
> {
    Ok({
        ...
        crate::serde_util::get_suppressed_destination_output_correct_errors(output).build()
    })
}
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "SuppressedDestination" => {
                    builder =
                        builder.set_suppressed_destination(crate::protocol_serde::shape_suppressed_destination::de_suppressed_destination(tokens)?);
                }
