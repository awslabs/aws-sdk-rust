...
pub fn de_create_export_job_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_export_job::de_create_export_job(_response_body, output)
            .map_err(crate::operation::create_export_job::CreateExportJobError::unhandled)?;
...
pub fn ser_create_export_job_input(
...
pub(crate) fn de_create_export_job(
    value: &[u8],
    mut builder: crate::operation::create_export_job::builders::CreateExportJobOutputBuilder,
) -> Result<crate::operation::create_export_job::builders::CreateExportJobOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
