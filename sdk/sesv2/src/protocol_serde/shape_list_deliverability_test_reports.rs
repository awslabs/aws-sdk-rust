...
pub fn de_list_deliverability_test_reports_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListDeliverabilityTestReportsOutput, crate::error::ListDeliverabilityTestReportsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListDeliverabilityTestReportsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_deliverability_test_reports_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListDeliverabilityTestReportsOutput, crate::error::ListDeliverabilityTestReportsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_deliverability_test_reports(value: &[u8], mut builder: crate::output::list_deliverability_test_reports_output::Builder) -> Result<crate::output::list_deliverability_test_reports_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
