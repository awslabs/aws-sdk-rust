        ...
        "BadRequestException" => {
            crate::operation::get_dedicated_ip::GetDedicatedIpError::BadRequestException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_dedicated_ip::GetDedicatedIpError::unhandled)?;
        ...
        "NotFoundException" => {
            crate::operation::get_dedicated_ip::GetDedicatedIpError::NotFoundException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_not_found_exception::de_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_dedicated_ip::GetDedicatedIpError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "TooManyRequestsException" => {
            crate::operation::get_dedicated_ip::GetDedicatedIpError::TooManyRequestsException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_too_many_requests_exception::de_too_many_requests_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::get_dedicated_ip::GetDedicatedIpError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
