...
pub fn de_delete_suppressed_destination_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationOutput, crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_suppressed_destination_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationOutput, crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationError> {
    Ok({
        #[allow(unused_mut)]
