            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TopicPreferences" => {
                            builder =
                                builder.set_topic_preferences(crate::protocol_serde::shape_topic_preference_list::de_topic_preference_list(tokens)?);
                        }
                        "TopicDefaultPreferences" => {
                            builder = builder
                                .set_topic_default_preferences(crate::protocol_serde::shape_topic_preference_list::de_topic_preference_list(tokens)?);
                        }
                        "UnsubscribeAll" => {
