...
pub fn ser_create_configuration_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConfigurationSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
