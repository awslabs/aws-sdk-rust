...
pub(crate) fn de_message_insights_data_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MessageInsightsDataSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Include" => {
                                builder = builder.set_include(
                                    crate::protocol_serde::shape_message_insights_filters::de_message_insights_filters(tokens)?
                                );
                            }
                            "Exclude" => {
            ...
            Ok(Some(crate::serde_util::message_insights_data_source_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
