...
pub(crate) fn de_list_of_contacts<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Contact>>, aws_smithy_json::deserialize::error::DeserializeError>
