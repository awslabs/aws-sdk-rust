...
pub fn de_get_domain_statistics_report_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_domain_statistics_report::GetDomainStatisticsReportOutput, crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_domain_statistics_report_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_domain_statistics_report::GetDomainStatisticsReportOutput, crate::operation::get_domain_statistics_report::GetDomainStatisticsReportError> {
    Ok({
        #[allow(unused_mut)]
