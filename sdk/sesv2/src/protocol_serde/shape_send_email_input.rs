...
pub fn ser_send_email_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendEmailInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
