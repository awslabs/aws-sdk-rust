...
> {
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output).map_err(
                        crate::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::unhandled,
                    )?;
        ...
        "NotFoundException" => {
            crate::operation::update_configuration_set_event_destination::UpdateConfigurationSetEventDestinationError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn ser_update_configuration_set_event_destination_input(
    ...
    crate::protocol_serde::shape_update_configuration_set_event_destination_input::ser_update_configuration_set_event_destination_input(
        &mut object,
        input,
    )?;
    object.finish();
