...
pub fn ser_send_custom_verification_email_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendCustomVerificationEmailInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
