...
pub fn ser_send_bulk_email_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendBulkEmailInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
