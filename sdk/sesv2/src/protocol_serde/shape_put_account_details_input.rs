...
pub fn ser_put_account_details_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutAccountDetailsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
