...
pub fn de_create_import_job_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_create_import_job::de_create_import_job(_response_body, output)
            .map_err(crate::operation::create_import_job::CreateImportJobError::unhandled)?;
...
) -> Result<crate::operation::create_import_job::builders::CreateImportJobOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
