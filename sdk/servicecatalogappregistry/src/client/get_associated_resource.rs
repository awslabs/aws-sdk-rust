...
impl super::Client  {
    ...
    ///   - [`application(impl Into<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::application) / [`set_application(Option<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_application): <p> The name, ID, or ARN of the application. </p>
