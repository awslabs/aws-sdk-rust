...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_next_token):<br>required: **false**<br><p>A unique pagination token for each page of results. Make the call again with the returned token to retrieve the next page of results.</p><br>
    ///   - [`resource_tag_status(ResourceItemStatus)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::resource_tag_status) / [`set_resource_tag_status(Option<Vec::<ResourceItemStatus>>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_resource_tag_status):<br>required: **false**<br><p>States whether an application tag is applied, not applied, in the process of being applied, or skipped.</p><br>
    ///   - [`max_results(i32)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return. If the parameter is omitted, it defaults to 25. The value is optional.</p><br>
    ...
    ///   - [`options(Option<Vec::<AssociationOption>>)`](crate::operation::get_associated_resource::GetAssociatedResourceOutput::options): <p>Determines whether an application tag is applied or skipped.</p>
    ///   - [`application_tag_result(Option<ApplicationTagResult>)`](crate::operation::get_associated_resource::GetAssociatedResourceOutput::application_tag_result): <p>The result of the application that's tag applied to a resource.</p>
