...
impl super::Client {
    ...
    ///   - [`attribute_group(impl ::std::convert::Into<String>)`](crate::operation::delete_attribute_group::builders::DeleteAttributeGroupFluentBuilder::attribute_group) / [`set_attribute_group(Option<String>)`](crate::operation::delete_attribute_group::builders::DeleteAttributeGroupFluentBuilder::set_attribute_group): <p> The name, ID, or ARN of the attribute group that holds the attributes to describe the application. </p>
