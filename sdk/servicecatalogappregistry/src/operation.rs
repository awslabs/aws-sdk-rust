...
impl aws_smithy_http::response::ParseStrictResponse for AssociateAttributeGroup {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_associate_attribute_group::de_associate_attribute_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_associate_attribute_group::de_associate_attribute_group_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAttributeGroup {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_attribute_group::de_create_attribute_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_attribute_group::de_create_attribute_group_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAttributeGroup {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_attribute_group::de_delete_attribute_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_attribute_group::de_delete_attribute_group_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetAssociatedResource {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_associated_resource::de_get_associated_resource_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_associated_resource::de_get_associated_resource_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssociatedAttributeGroups {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_associated_attribute_groups::de_list_associated_attribute_groups_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_associated_attribute_groups::de_list_associated_attribute_groups_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttributeGroups {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_attribute_groups::de_list_attribute_groups_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_attribute_groups::de_list_attribute_groups_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttributeGroupsForApplication {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_attribute_groups_for_application::de_list_attribute_groups_for_application_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_attribute_groups_for_application::de_list_attribute_groups_for_application_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for PutConfiguration {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_put_configuration::de_put_configuration_http_error(response)
                     } else {
                        crate::protocol_serde::shape_put_configuration::de_put_configuration_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAttributeGroup {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_attribute_group::de_update_attribute_group_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_attribute_group::de_update_attribute_group_http_response(response)
                     }
                }
            }
