...
impl Client  {
    ...
    pub fn list_associated_attribute_groups(&self) -> fluent_builders::ListAssociatedAttributeGroups {
    ...
    pub fn list_attribute_groups_for_application(&self) -> fluent_builders::ListAttributeGroupsForApplication {
