...
impl Client  {
    ...
    pub fn associate_attribute_group(&self) -> crate::client::fluent_builders::AssociateAttributeGroup {
    ...
    pub fn disassociate_attribute_group(&self) -> crate::client::fluent_builders::DisassociateAttributeGroup {
