...
pub struct Resource  {
    ...
    #[doc(hidden)]pub integrations: std::option::Option<crate::model::ResourceIntegrations>,
}
impl Resource {
    /// <p>The name of the resource.</p>
    pub fn name(&self) -> std::option::Option<& str> {
...
pub struct ResourceIntegrations  {
    ...
    #[doc(hidden)]pub resource_group: std::option::Option<crate::model::ResourceGroup>,
}
...
pub struct ResourceGroup  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::ResourceGroupState>,
