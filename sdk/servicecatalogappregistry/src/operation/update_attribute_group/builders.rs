...
impl UpdateAttributeGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_attribute_group::UpdateAttributeGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_attribute_group::UpdateAttributeGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_attribute_group::UpdateAttributeGroupOutput, crate::operation::update_attribute_group::UpdateAttributeGroupError, Self> {
