...
impl GetApplicationOutputBuilder {
    ...
    ///
    /// <p>A key-value pair that identifies an associated resource.</p>
    pub fn application_tag(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    /// <p>A key-value pair that identifies an associated resource.</p>
    pub fn set_application_tag(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>>) -> Self {
        self.application_tag = input; self
    }
    /// <p>A key-value pair that identifies an associated resource.</p>
