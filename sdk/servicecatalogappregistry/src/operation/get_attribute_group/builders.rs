...
impl GetAttributeGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_attribute_group::GetAttributeGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_attribute_group::GetAttributeGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_attribute_group::GetAttributeGroupOutput, crate::operation::get_attribute_group::GetAttributeGroupError, Self> {
