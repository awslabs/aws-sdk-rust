...
impl GetConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_configuration::GetConfiguration::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("GetConfiguration", "servicecatalogappregistry"),
        );
