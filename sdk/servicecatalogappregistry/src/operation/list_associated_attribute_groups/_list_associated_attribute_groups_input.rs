...
impl ListAssociatedAttributeGroupsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::list_associated_attribute_groups::ListAssociatedAttributeGroupsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
