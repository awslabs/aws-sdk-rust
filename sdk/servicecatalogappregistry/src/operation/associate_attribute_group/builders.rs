...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::associate_attribute_group::AssociateAttributeGroupOutput,
                    crate::operation::associate_attribute_group::AssociateAttributeGroupError,
                > for AssociateAttributeGroupFluentBuilder
            {
                fn send(
                    self,
...
impl AssociateAttributeGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_attribute_group::AssociateAttributeGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_attribute_group::AssociateAttributeGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::associate_attribute_group::AssociateAttributeGroup::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::associate_attribute_group::AssociateAttributeGroup::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_attribute_group::AssociateAttributeGroupOutput, crate::operation::associate_attribute_group::AssociateAttributeGroupError, Self> {
