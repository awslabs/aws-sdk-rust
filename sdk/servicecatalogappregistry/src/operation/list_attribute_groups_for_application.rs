...
impl ListAttributeGroupsForApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_attribute_groups_for_application::ListAttributeGroupsForApplication::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttributeGroupsForApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attribute_groups_for_application::de_list_attribute_groups_for_application_http_response_with_props(
                status, headers, body,
            )
        }
    }
