...
impl ListAttributeGroupsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attribute_groups::ListAttributeGroups::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListAttributeGroups", "servicecatalogappregistry"),
            );
