...
impl ListAssociatedResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_associated_resources::ListAssociatedResourcesInput, ::aws_smithy_types::error::operation::BuildError> {
