...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_attribute_group::de_delete_attribute_group(_response_body, output)
            .map_err(crate::operation::delete_attribute_group::DeleteAttributeGroupError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "attributeGroup" => {
                    builder = builder.set_attribute_group(crate::protocol_serde::shape_attribute_group_summary::de_attribute_group_summary(tokens)?);
                }
