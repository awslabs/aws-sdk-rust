...
pub fn de_associate_resource_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::associate_resource::AssociateResourceOutput, crate::operation::associate_resource::AssociateResourceError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::associate_resource::AssociateResourceOutput, crate::operation::associate_resource::AssociateResourceError>
{
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_resource::de_associate_resource(_response_body, output)
            .map_err(crate::operation::associate_resource::AssociateResourceError::unhandled)?;
...
) -> Result<crate::operation::associate_resource::builders::AssociateResourceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
