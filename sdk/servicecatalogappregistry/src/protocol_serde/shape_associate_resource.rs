...
pub fn de_associate_resource_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssociateResourceOutput, crate::error::AssociateResourceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::AssociateResourceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_resource_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::AssociateResourceOutput, crate::error::AssociateResourceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::associate_resource_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_associate_resource::de_associate_resource(response.body().as_ref(), output).map_err(crate::error::AssociateResourceError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_associate_resource(value: &[u8], mut builder: crate::output::associate_resource_output::Builder) -> Result<crate::output::associate_resource_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
