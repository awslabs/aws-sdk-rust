...
pub fn de_disassociate_attribute_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disassociate_attribute_group::DisassociateAttributeGroupOutput, crate::operation::disassociate_attribute_group::DisassociateAttributeGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::disassociate_attribute_group::DisassociateAttributeGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_attribute_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::disassociate_attribute_group::DisassociateAttributeGroupOutput, crate::operation::disassociate_attribute_group::DisassociateAttributeGroupError> {
    Ok({
        #[allow(unused_mut)]
