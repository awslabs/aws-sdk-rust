...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_attribute_group::DisassociateAttributeGroupError::unhandled)?;
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_attribute_group::de_disassociate_attribute_group(_response_body, output)
            .map_err(crate::operation::disassociate_attribute_group::DisassociateAttributeGroupError::unhandled)?;
