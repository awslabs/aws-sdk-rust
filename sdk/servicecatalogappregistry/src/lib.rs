...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
                    aws_http::user_agent::ApiMetadata::new("servicecatalogappregistry", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Service Catalog App Registry.
pub mod client;
