...
pub fn serialize_structure_crate_input_create_attribute_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAttributeGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_attribute_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAttributeGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
