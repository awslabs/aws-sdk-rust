...
impl ThreatModel {
    /// Creates a new builder-style object to manufacture [`ThreatModel`](crate::types::ThreatModel).
    pub fn builder() -> crate::types::builders::ThreatModelBuilder {
        crate::types::builders::ThreatModelBuilder::default()
    }
}

/// A builder for [`ThreatModel`](crate::types::ThreatModel).
...
impl ThreatModelBuilder {
    ...
    /// Consumes the builder and constructs a [`ThreatModel`](crate::types::ThreatModel).
    /// This method will fail if any of the following fields are not set:
    /// - [`threat_model_id`](crate::types::builders::ThreatModelBuilder::threat_model_id)
    /// - [`agent_space_id`](crate::types::builders::ThreatModelBuilder::agent_space_id)
    /// - [`title`](crate::types::builders::ThreatModelBuilder::title)
    pub fn build(self) -> ::std::result::Result<crate::types::ThreatModel, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::ThreatModel {
            threat_model_id: self.threat_model_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "threat_model_id",
                    "threat_model_id was not specified but it is required when building ThreatModel",
                )
            })?,
            agent_space_id: self.agent_space_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "agent_space_id",
                    "agent_space_id was not specified but it is required when building ThreatModel",
                )
            })?,
            title: self.title.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "title",
                    "title was not specified but it is required when building ThreatModel",
                )
            })?,
