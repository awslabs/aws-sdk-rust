...
/// match skilltype {
///     SkillType::FindingPersonalization => { /* ... */ },
///     SkillType::LoginOptimization => { /* ... */ },
...
impl ::std::convert::From<&str> for SkillType {
    fn from(s: &str) -> Self {
        match s {
            "FINDING_PERSONALIZATION" => SkillType::FindingPersonalization,
            "LOGIN_OPTIMIZATION" => SkillType::LoginOptimization,
            other => SkillType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SkillType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SkillType::from(s))
    }
}
impl SkillType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            SkillType::FindingPersonalization => "FINDING_PERSONALIZATION",
            SkillType::LoginOptimization => "LOGIN_OPTIMIZATION",
...
impl ::std::convert::AsRef<str> for SkillType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for SkillType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SkillType::FindingPersonalization => write!(f, "FINDING_PERSONALIZATION"),
            SkillType::LoginOptimization => write!(f, "LOGIN_OPTIMIZATION"),
