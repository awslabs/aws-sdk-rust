...
/// match providertype {
///     ProviderType::Documentation => { /* ... */ },
///     ProviderType::SourceCode => { /* ... */ },
...
impl ::std::convert::From<&str> for ProviderType {
    fn from(s: &str) -> Self {
        match s {
            "DOCUMENTATION" => ProviderType::Documentation,
            "SOURCE_CODE" => ProviderType::SourceCode,
...
impl ProviderType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ProviderType::Documentation => "DOCUMENTATION",
            ProviderType::SourceCode => "SOURCE_CODE",
...
impl ::std::fmt::Display for ProviderType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ProviderType::Documentation => write!(f, "DOCUMENTATION"),
            ProviderType::SourceCode => write!(f, "SOURCE_CODE"),
