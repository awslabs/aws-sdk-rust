...
impl ::std::convert::From<&str> for ConfidenceLevel {
    fn from(s: &str) -> Self {
        match s {
            "FALSE_POSITIVE" => ConfidenceLevel::FalsePositive,
...
impl ConfidenceLevel {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ConfidenceLevel::FalsePositive => "FALSE_POSITIVE",
            ConfidenceLevel::High => "HIGH",
            ConfidenceLevel::Low => "LOW",
            ConfidenceLevel::Medium => "MEDIUM",
            ConfidenceLevel::Unconfirmed => "UNCONFIRMED",
            ConfidenceLevel::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["FALSE_POSITIVE", "HIGH", "LOW", "MEDIUM", "UNCONFIRMED"]
    }
}
...
impl ::std::fmt::Display for ConfidenceLevel {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ConfidenceLevel::FalsePositive => write!(f, "FALSE_POSITIVE"),
