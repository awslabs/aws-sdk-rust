...
mod batch_get_pentest_job_tasks;

mod batch_get_pentest_jobs;
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_securityagent::Error> {
/// # let client: aws_sdk_securityagent::Client = unimplemented!();
...
mod list_integrated_resources;

mod list_integrations;

mod list_memberships;

mod list_pentest_job_tasks;

mod list_pentest_jobs_for_pentest;
