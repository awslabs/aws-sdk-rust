...
impl ::aws_types::request_id::RequestId for CreateThreatOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl CreateThreatOutput {
    /// Creates a new builder-style object to manufacture [`CreateThreatOutput`](crate::operation::create_threat::CreateThreatOutput).
    pub fn builder() -> crate::operation::create_threat::builders::CreateThreatOutputBuilder {
        crate::operation::create_threat::builders::CreateThreatOutputBuilder::default()
    }
}

/// A builder for [`CreateThreatOutput`](crate::operation::create_threat::CreateThreatOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateThreatOutputBuilder {
...
impl CreateThreatOutputBuilder {
    /// <p>The unique identifier of the created threat.</p>
    ...
    /// Consumes the builder and constructs a [`CreateThreatOutput`](crate::operation::create_threat::CreateThreatOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`threat_id`](crate::operation::create_threat::builders::CreateThreatOutputBuilder::threat_id)
    /// - [`threat_job_id`](crate::operation::create_threat::builders::CreateThreatOutputBuilder::threat_job_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::create_threat::CreateThreatOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::create_threat::CreateThreatOutput {
            threat_id: self.threat_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "threat_id",
                    "threat_id was not specified but it is required when building CreateThreatOutput",
                )
            })?,
            threat_job_id: self.threat_job_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "threat_job_id",
                    "threat_job_id was not specified but it is required when building CreateThreatOutput",
                )
            })?,
            title: self.title,
