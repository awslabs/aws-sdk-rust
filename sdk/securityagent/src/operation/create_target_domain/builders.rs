...
pub use crate::operation::create_target_domain::_create_target_domain_input::CreateTargetDomainInputBuilder;

pub use crate::operation::create_target_domain::_create_target_domain_output::CreateTargetDomainOutputBuilder;

impl crate::operation::create_target_domain::builders::CreateTargetDomainInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.create_target_domain();
...
pub struct CreateTargetDomainFluentBuilder {
    ...
    inner: crate::operation::create_target_domain::builders::CreateTargetDomainInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::create_target_domain::CreateTargetDomainOutput,
        crate::operation::create_target_domain::CreateTargetDomainError,
    > for CreateTargetDomainFluentBuilder
{
    fn send(
        self,
...
impl CreateTargetDomainFluentBuilder {
    /// Creates a new `CreateTargetDomainFluentBuilder`.
    ...
    /// Access the CreateTargetDomain as a reference.
    pub fn as_input(&self) -> &crate::operation::create_target_domain::builders::CreateTargetDomainInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins = crate::operation::create_target_domain::CreateTargetDomain::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::create_target_domain::CreateTargetDomain::orchestrate(&runtime_plugins, input).await
    }
