...
impl UpdateApplicationOutputBuilder {
    ...
    /// - [`application_id`](crate::operation::update_application::builders::UpdateApplicationOutputBuilder::application_id)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::update_application::UpdateApplicationOutput {
            application_id: self.application_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "application_id",
                    "application_id was not specified but it is required when building UpdateApplicationOutput",
                )
            })?,
