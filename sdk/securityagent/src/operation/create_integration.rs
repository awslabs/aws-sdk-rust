...
impl CreateIntegration {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SecurityAgent", "CreateIntegration", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateIntegrationTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("integrationDisplayName") {
            if let ::std::option::Option::Some(value) = input.integration_display_name.as_deref() {
                captured.insert("integrationDisplayName", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/CreateIntegration").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
