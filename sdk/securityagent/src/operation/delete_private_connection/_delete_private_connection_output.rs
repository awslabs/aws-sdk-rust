...
impl DeletePrivateConnectionOutputBuilder {
    ...
    /// - [`r#type`](crate::operation::delete_private_connection::builders::DeletePrivateConnectionOutputBuilder::type)
    ...
    > {
        ::std::result::Result::Ok(crate::operation::delete_private_connection::DeletePrivateConnectionOutput {
            ...
            r#type: self.r#type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "r#type",
                    "r#type was not specified but it is required when building DeletePrivateConnectionOutput",
                )
            })?,
