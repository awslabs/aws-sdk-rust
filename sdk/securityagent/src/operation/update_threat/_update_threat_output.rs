...
impl UpdateThreatOutput {
    /// Creates a new builder-style object to manufacture [`UpdateThreatOutput`](crate::operation::update_threat::UpdateThreatOutput).
...
/// A builder for [`UpdateThreatOutput`](crate::operation::update_threat::UpdateThreatOutput).
...
impl UpdateThreatOutputBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateThreatOutput`](crate::operation::update_threat::UpdateThreatOutput).
    /// This method will fail if any of the following fields are not set:
    /// - [`threat_id`](crate::operation::update_threat::builders::UpdateThreatOutputBuilder::threat_id)
    /// - [`threat_job_id`](crate::operation::update_threat::builders::UpdateThreatOutputBuilder::threat_job_id)
    pub fn build(
        self,
