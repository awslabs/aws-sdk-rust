...
pub(crate) fn reflens_list_actor_messages_output_output_next_token(
    input: &crate::operation::list_actor_messages::ListActorMessagesOutput,
...
pub(crate) fn lens_list_actor_messages_output_output_messages(
    input: crate::operation::list_actor_messages::ListActorMessagesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ActorMessage>> {
