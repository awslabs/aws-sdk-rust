...
//! as a dependency within your Rust project to execute asynchronous code. To add `aws-sdk-securityagent` to
//! your project, add the following to your **Cargo.toml** file:
//!
//! ```toml
//! [dependencies]
//! aws-config = { version = "1.1.7", features = ["behavior-version-latest"] }
//! aws-sdk-securityagent = "1.11.0"
...
//!
//! ```rust,no_run
//! use aws_sdk_securityagent as securityagent;
//!
//! #[::tokio::main]
//! async fn main() -> Result<(), securityagent::Error> {
//!     let config = aws_config::load_from_env().await;
//!     let client = aws_sdk_securityagent::Client::new(&config);
//!
...
//! ```
//!
//! See the [client documentation](https://docs.rs/aws-sdk-securityagent/latest/aws_sdk_securityagent/client/struct.Client.html)
...
//! offered by AWS Security Agent. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Security Agent.
...
/// For example, the [`AddArtifact`](crate::operation::add_artifact) operation has
...
/// Configuration for AWS Security Agent.
pub mod config;
