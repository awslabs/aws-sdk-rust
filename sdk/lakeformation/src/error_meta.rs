...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::get_work_units::GetWorkUnitsError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::list_lf_tags::ListLFTagsError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
