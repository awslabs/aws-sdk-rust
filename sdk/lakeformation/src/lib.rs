...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("lakeformation", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Lake Formation.
pub mod client;
