...
impl ::std::convert::From<&str> for VerificationStatus {
    fn from(s: &str) -> Self {
        match s {
            "NOT_VERIFIED" => VerificationStatus::NotVerified,
            "VERIFICATION_FAILED" => VerificationStatus::VerificationFailed,
...
impl VerificationStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            VerificationStatus::VerificationFailed => "VERIFICATION_FAILED",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["NOT_VERIFIED", "VERIFICATION_FAILED", "VERIFIED"]
    }
}
...
impl ::std::fmt::Display for VerificationStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            VerificationStatus::VerificationFailed => write!(f, "VERIFICATION_FAILED"),
