...
/// Orchestration and serialization glue logic for `AddLFTagsToResource`.
...
impl AddLFTagsToResource {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceInput,
                    ) -> ::std::result::Result<crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddLFTagsToResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddLFTagsToResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddLFTagsToResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddLFTagsToResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddLFTagsToResource")
...
.with_interceptor(AddLFTagsToResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError>::new());
...
#[derive(Debug)]
            struct AddLFTagsToResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddLFTagsToResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_lf_tags_to_resource::de_add_lf_tags_to_resource_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct AddLFTagsToResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddLFTagsToResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/AddLFTagsToResource").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_lf_tags_to_resource::ser_add_lf_tags_to_resource_input(&input)?);
...
#[derive(Debug)]
            struct AddLFTagsToResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddLFTagsToResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddLFTagsToResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddLfTagsToResourceInput>()
                        .ok_or("failed to downcast to AddLfTagsToResourceInput")?;
...
pub enum AddLFTagsToResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddLFTagsToResourceError) for what information is available for the error.")]
...
impl AddLFTagsToResourceError {
    /// Creates the `AddLFTagsToResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddLFTagsToResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddLFTagsToResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError {
...
mod _add_lf_tags_to_resource_output;
