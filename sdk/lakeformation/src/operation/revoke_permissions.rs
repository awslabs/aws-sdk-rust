...
impl RevokePermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::revoke_permissions::RevokePermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_revoke_permissions::de_revoke_permissions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::revoke_permissions::RevokePermissionsError
{
