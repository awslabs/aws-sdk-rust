...
impl RevokePermissionsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_revoke_permissions::ser_revoke_permissions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokePermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_revoke_permissions::de_revoke_permissions_http_response_with_props(status, headers, body)
        }
    }
}
