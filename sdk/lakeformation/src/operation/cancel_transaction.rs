...
impl CancelTransactionInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_transaction::CancelTransaction::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CancelTransaction {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_cancel_transaction::de_cancel_transaction_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_cancel_transaction::de_cancel_transaction_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::cancel_transaction::CancelTransactionError
{
