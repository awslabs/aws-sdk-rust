    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/BatchRevokePermissions")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_revoke_permissions::BatchRevokePermissions::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_revoke_permissions::BatchRevokePermissionsError
{
