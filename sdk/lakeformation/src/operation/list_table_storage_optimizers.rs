...
impl ListTableStorageOptimizersInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_table_storage_optimizers::ListTableStorageOptimizers::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListTableStorageOptimizers {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_table_storage_optimizers::de_list_table_storage_optimizers_http_error(response)
        } else {
            crate::protocol_serde::shape_list_table_storage_optimizers::de_list_table_storage_optimizers_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::list_table_storage_optimizers::ListTableStorageOptimizersError
{
