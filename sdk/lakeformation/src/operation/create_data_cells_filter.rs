...
impl CreateDataCellsFilter {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreateDataCellsFilter",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateDataCellsFilter {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateDataCellsFilter")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateDataCellsFilter")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateDataCellsFilterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_create_data_cells_filter::de_create_data_cells_filter_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_data_cells_filter::de_create_data_cells_filter_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateDataCellsFilterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_data_cells_filter::ser_create_data_cells_filter_input(&input)?,
        );
