...
impl StartTransactionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_transaction::StartTransaction::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTransaction {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_transaction::de_start_transaction_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_transaction::StartTransactionError
{
