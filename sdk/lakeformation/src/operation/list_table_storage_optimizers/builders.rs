...
impl crate::operation::list_table_storage_optimizers::builders::ListTableStorageOptimizersInputBuilder {
...
impl ListTableStorageOptimizersFluentBuilder {
    /// Creates a new `ListTableStorageOptimizersFluentBuilder`.
