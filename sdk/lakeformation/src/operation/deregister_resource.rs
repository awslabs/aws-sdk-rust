...
impl DeregisterResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_resource::DeregisterResource,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_deregister_resource::ser_deregister_resource_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_resource::de_deregister_resource_http_response_with_props(status, headers, body)
        }
    }
}
