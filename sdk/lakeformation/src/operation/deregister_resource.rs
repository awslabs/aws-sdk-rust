...
impl DeregisterResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_resource::DeregisterResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_deregister_resource::de_deregister_resource_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::deregister_resource::DeregisterResourceError
{
