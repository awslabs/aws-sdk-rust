...
impl UpdateTableStorageOptimizerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_table_storage_optimizer::UpdateTableStorageOptimizer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTableStorageOptimizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_table_storage_optimizer::de_update_table_storage_optimizer_http_response_with_props(
                status, headers, body,
            )
        }
    }
