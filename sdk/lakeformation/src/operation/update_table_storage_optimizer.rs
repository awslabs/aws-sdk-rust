    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/UpdateTableStorageOptimizer")
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTableStorageOptimizer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_table_storage_optimizer::de_update_table_storage_optimizer_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateTableStorageOptimizerError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_table_storage_optimizer::UpdateTableStorageOptimizerError
{
