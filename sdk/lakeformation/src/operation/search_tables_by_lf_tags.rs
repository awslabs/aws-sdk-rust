...
impl SearchTablesByLFTags {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::search_tables_by_lf_tags::SearchTablesByLfTagsInput,
                    ) -> ::std::result::Result<crate::operation::search_tables_by_lf_tags::SearchTablesByLfTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_tables_by_lf_tags::SearchTablesByLfTagsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchTablesByLFTags {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchTablesByLFTags");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchTablesByLFTagsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchTablesByLFTagsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchTablesByLFTags")
...
.with_interceptor(SearchTablesByLFTagsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError>::new());
...
#[derive(Debug)]
            struct SearchTablesByLFTagsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchTablesByLFTagsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_tables_by_lf_tags::de_search_tables_by_lf_tags_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct SearchTablesByLFTagsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchTablesByLFTagsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_tables_by_lf_tags::SearchTablesByLfTagsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_tables_by_lf_tags::SearchTablesByLfTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/SearchTablesByLFTags").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_tables_by_lf_tags::ser_search_tables_by_lf_tags_input(&input)?);
...
#[derive(Debug)]
            struct SearchTablesByLFTagsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchTablesByLFTagsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchTablesByLFTagsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchTablesByLfTagsInput>()
                        .ok_or("failed to downcast to SearchTablesByLfTagsInput")?;
...
pub enum SearchTablesByLFTagsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchTablesByLFTagsError) for what information is available for the error.")]
...
impl SearchTablesByLFTagsError {
    /// Creates the `SearchTablesByLFTagsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchTablesByLFTagsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchTablesByLFTagsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_tables_by_lf_tags::SearchTablesByLFTagsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::search_tables_by_lf_tags::_search_tables_by_lf_tags_output::SearchTablesByLfTagsOutput;

pub use crate::operation::search_tables_by_lf_tags::_search_tables_by_lf_tags_input::SearchTablesByLfTagsInput;

mod _search_tables_by_lf_tags_input;

mod _search_tables_by_lf_tags_output;
