...
impl GetTableObjectsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_table_objects::GetTableObjectsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_table_objects::GetTableObjectsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_table_objects::GetTableObjectsOutput, crate::operation::get_table_objects::GetTableObjectsError, Self> {
