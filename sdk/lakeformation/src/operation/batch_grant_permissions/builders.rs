...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::batch_grant_permissions::BatchGrantPermissionsOutput,
                    crate::operation::batch_grant_permissions::BatchGrantPermissionsError,
                > for BatchGrantPermissionsFluentBuilder
            {
                fn send(
                    self,
...
impl BatchGrantPermissionsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::batch_grant_permissions::builders::BatchGrantPermissionsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_grant_permissions::BatchGrantPermissionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_grant_permissions::BatchGrantPermissionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::batch_grant_permissions::BatchGrantPermissions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::batch_grant_permissions::BatchGrantPermissions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_grant_permissions::BatchGrantPermissionsOutput, crate::operation::batch_grant_permissions::BatchGrantPermissionsError, Self> {
