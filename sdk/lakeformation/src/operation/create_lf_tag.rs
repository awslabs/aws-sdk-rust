...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLFTag {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_lf_tag::de_create_lf_tag_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_lf_tag::de_create_lf_tag_http_response_with_props(
                status, headers, body,
            )
        }
    }
