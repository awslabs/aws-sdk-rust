...
impl ListDataCellsFilterInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_data_cells_filter::ListDataCellsFilter::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListDataCellsFilter {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_data_cells_filter::de_list_data_cells_filter_http_error(response)
        } else {
            crate::protocol_serde::shape_list_data_cells_filter::de_list_data_cells_filter_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::list_data_cells_filter::ListDataCellsFilterError
{
