...
impl GetResourceLfTagsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_resource_lf_tags::ser_get_resource_lf_tags_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceLFTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_lf_tags::de_get_resource_lf_tags_http_response_with_props(status, headers, body)
        }
    }
}
