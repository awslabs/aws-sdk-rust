...
impl GetResourceLfTagsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_resource_lf_tags::GetResourceLFTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceLFTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_resource_lf_tags::de_get_resource_lf_tags_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_resource_lf_tags::GetResourceLFTagsError
{
