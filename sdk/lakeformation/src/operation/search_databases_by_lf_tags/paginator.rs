        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTags::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl SearchDatabasesByLfTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_search_databases_by_lf_tags_output_output_database_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
