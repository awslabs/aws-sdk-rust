...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsOutput,
                    crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError,
                > for SearchDatabasesByLFTagsFluentBuilder
            {
                fn send(
                    self,
...
impl SearchDatabasesByLFTagsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTags::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTags::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsOutput, crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::search_databases_by_lf_tags::paginator::SearchDatabasesByLfTagsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
