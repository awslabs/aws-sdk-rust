...
/// Orchestration and serialization glue logic for `AssumeDecoratedRoleWithSAML`.
...
impl AssumeDecoratedRoleWithSAML {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSamlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSamlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssumeDecoratedRoleWithSAML {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AssumeDecoratedRoleWithSAML");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AssumeDecoratedRoleWithSAMLRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AssumeDecoratedRoleWithSAMLResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssumeDecoratedRoleWithSAML")
...
.with_interceptor(AssumeDecoratedRoleWithSAMLEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError>::new());
...
#[derive(Debug)]
            struct AssumeDecoratedRoleWithSAMLResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssumeDecoratedRoleWithSAMLResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_assume_decorated_role_with_saml::de_assume_decorated_role_with_saml_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_assume_decorated_role_with_saml::de_assume_decorated_role_with_saml_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AssumeDecoratedRoleWithSAMLRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssumeDecoratedRoleWithSAMLRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSamlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSamlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/AssumeDecoratedRoleWithSAML").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_assume_decorated_role_with_saml::ser_assume_decorated_role_with_saml_input(&input)?);
...
#[derive(Debug)]
            struct AssumeDecoratedRoleWithSAMLEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssumeDecoratedRoleWithSAMLEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AssumeDecoratedRoleWithSAMLEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AssumeDecoratedRoleWithSamlInput>()
                        .ok_or("failed to downcast to AssumeDecoratedRoleWithSamlInput")?;
...
pub enum AssumeDecoratedRoleWithSAMLError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AssumeDecoratedRoleWithSAMLError) for what information is available for the error.")]
...
impl AssumeDecoratedRoleWithSAMLError {
    /// Creates the `AssumeDecoratedRoleWithSAMLError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssumeDecoratedRoleWithSAMLError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AssumeDecoratedRoleWithSAMLError {
...
impl ::aws_types::request_id::RequestId for crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError {
...
mod _assume_decorated_role_with_saml_output;
