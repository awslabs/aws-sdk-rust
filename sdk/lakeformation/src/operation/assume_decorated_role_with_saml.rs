...
impl AssumeDecoratedRoleWithSamlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAML::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssumeDecoratedRoleWithSAML {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_assume_decorated_role_with_saml::de_assume_decorated_role_with_saml_http_response_with_props(
                status, headers, body,
            )
        }
    }
