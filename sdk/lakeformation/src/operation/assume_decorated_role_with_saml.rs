    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/AssumeDecoratedRoleWithSAML")
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssumeDecoratedRoleWithSAML {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_assume_decorated_role_with_saml::de_assume_decorated_role_with_saml_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AssumeDecoratedRoleWithSAMLError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSAMLError
{
