...
impl GetTableObjectsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_table_objects::GetTableObjects, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_table_objects::ser_get_table_objects_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTableObjects {
    type Output =
        ::std::result::Result<crate::operation::get_table_objects::GetTableObjectsOutput, crate::operation::get_table_objects::GetTableObjectsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_table_objects::de_get_table_objects_http_response_with_props(status, headers, body)
        }
    }
}
