...
impl AddLFTagsToResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_lf_tags_to_resource::AddLfTagsToResourceOutput, crate::operation::add_lf_tags_to_resource::AddLFTagsToResourceError, Self> {
