...
impl StartQueryPlanningInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_query_planning::StartQueryPlanning,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_query_planning::ser_start_query_planning_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartQueryPlanning {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_query_planning::de_start_query_planning_http_response_with_props(status, headers, body)
        }
    }
}
