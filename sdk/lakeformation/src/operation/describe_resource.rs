...
impl DescribeResourceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_resource::DescribeResource, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_resource::ser_describe_resource_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_resource::de_describe_resource_http_response_with_props(status, headers, body)
        }
    }
}
