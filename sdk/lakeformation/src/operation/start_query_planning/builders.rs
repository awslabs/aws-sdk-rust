...
impl StartQueryPlanningFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_query_planning::StartQueryPlanningOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_query_planning::StartQueryPlanningError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_query_planning::StartQueryPlanningOutput, crate::operation::start_query_planning::StartQueryPlanningError, Self> {
