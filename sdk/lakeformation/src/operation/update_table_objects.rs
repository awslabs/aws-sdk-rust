...
impl UpdateTableObjectsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTableObjects`](crate::operation::update_table_objects::UpdateTableObjects)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_table_objects::ser_update_table_objects_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_table_objects::UpdateTableObjects::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTableObjects {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_table_objects::de_update_table_objects_http_response_with_props(status, headers, body)
        }
    }
}
