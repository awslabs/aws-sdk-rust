...
impl ::aws_smithy_http::response::ParseHttpResponse for GetWorkUnitResults {
    ...
    fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
        ...
        ::std::option::Option::Some(crate::protocol_serde::shape_get_work_unit_results::de_get_work_unit_results_op_response(
            response,
        ))
    }
    fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        // if streaming, we only hit this case if its an error
        crate::protocol_serde::shape_get_work_unit_results::de_get_work_unit_results_http_error(
