...
/// Orchestration and serialization glue logic for `GetWorkUnitResults`.
...
impl GetWorkUnitResults {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_work_unit_results::GetWorkUnitResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_work_unit_results::GetWorkUnitResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_work_unit_results::GetWorkUnitResultsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_work_unit_results::GetWorkUnitResultsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetWorkUnitResults {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetWorkUnitResults");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetWorkUnitResultsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetWorkUnitResultsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetWorkUnitResults")
...
.with_interceptor(GetWorkUnitResultsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_work_unit_results::GetWorkUnitResultsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_work_unit_results::GetWorkUnitResultsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_work_unit_results::GetWorkUnitResultsError>::new());
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetWorkUnitResultsResponseDeserializer {
                ...
                ::std::option::Option::Some(crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_get_work_unit_results::de_get_work_unit_results_http_response(response)))
            }
            ...
            crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_get_work_unit_results::de_get_work_unit_results_http_error(response.status().as_u16(), response.headers(), body))
                }
            }
#[derive(Debug)]
            struct GetWorkUnitResultsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetWorkUnitResultsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_work_unit_results::GetWorkUnitResultsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_work_unit_results::GetWorkUnitResultsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/GetWorkUnitResults").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_work_unit_results::ser_get_work_unit_results_input(&input)?);
...
#[derive(Debug)]
            struct GetWorkUnitResultsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetWorkUnitResultsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetWorkUnitResultsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetWorkUnitResultsInput>()
                        .ok_or("failed to downcast to GetWorkUnitResultsInput")?;
...
pub enum GetWorkUnitResultsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetWorkUnitResultsError) for what information is available for the error.")]
...
impl GetWorkUnitResultsError {
    /// Creates the `GetWorkUnitResultsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetWorkUnitResultsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetWorkUnitResultsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_work_unit_results::GetWorkUnitResultsError {
...
mod _get_work_unit_results_output;
