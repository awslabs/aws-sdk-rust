...
pub struct GetQueryStateOutput {
    ...
    /// <ul>
    /// <li>
    /// <p>PENDING: the query is pending.</p></li>
    /// <li>
    /// <p>WORKUNITS_AVAILABLE: some work units are ready for retrieval and execution.</p></li>
    /// <li>
    /// <p>FINISHED: the query planning finished successfully, and all work units are ready for retrieval and execution.</p></li>
    /// <li>
