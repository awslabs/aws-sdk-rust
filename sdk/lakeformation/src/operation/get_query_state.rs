...
impl GetQueryStateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_query_state::GetQueryState,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_query_state::GetQueryState::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryState {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_query_state::de_get_query_state_http_error(
                status, headers, body,
            )
        } else {
