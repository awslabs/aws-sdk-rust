...
impl GetQueryStateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_query_state::GetQueryState, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_query_state::ser_get_query_state_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryState {
    type Output =
        ::std::result::Result<crate::operation::get_query_state::GetQueryStateOutput, crate::operation::get_query_state::GetQueryStateError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_query_state::de_get_query_state_http_response_with_props(status, headers, body)
        }
    }
}
