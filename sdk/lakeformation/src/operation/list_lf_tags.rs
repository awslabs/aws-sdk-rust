...
impl ListLfTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_lf_tags::ListLFTags, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_lf_tags::ser_list_lf_tags_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLFTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_lf_tags::de_list_lf_tags_http_response_with_props(status, headers, body)
        }
    }
}
