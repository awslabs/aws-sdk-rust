...
impl ListLfTagsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_lf_tags::ListLFTags::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLFTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_lf_tags::de_list_lf_tags_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_lf_tags::de_list_lf_tags_http_response_with_props(
                status, headers, body,
            )
        }
    }
