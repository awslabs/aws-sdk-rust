...
impl GetTemporaryGlueTableCredentialsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_temporary_glue_table_credentials::GetTemporaryGlueTableCredentials::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTemporaryGlueTableCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_temporary_glue_table_credentials::de_get_temporary_glue_table_credentials_http_response_with_props(
                status, headers, body,
            )
        }
    }
