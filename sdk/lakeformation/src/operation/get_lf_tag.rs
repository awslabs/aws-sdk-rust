...
impl GetLfTagInput {
    /// Consumes the builder and constructs an Operation<[`GetLFTag`](crate::operation::get_lf_tag::GetLFTag)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_lf_tag::GetLFTag, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_lf_tag::ser_get_lf_tag_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_lf_tag::GetLFTag::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLFTag {
    type Output = ::std::result::Result<crate::operation::get_lf_tag::GetLfTagOutput, crate::operation::get_lf_tag::GetLFTagError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_lf_tag::de_get_lf_tag_http_response_with_props(status, headers, body)
        }
    }
}
