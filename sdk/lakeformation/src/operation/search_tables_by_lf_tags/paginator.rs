        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::search_tables_by_lf_tags::SearchTablesByLFTags::orchestrate(&runtime_plugins, input.clone()).await;
...
impl SearchTablesByLfTagsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_search_tables_by_lf_tags_output_output_table_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
