...
impl GetQueryStatisticsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_query_statistics::ser_get_query_statistics_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_query_statistics::de_get_query_statistics_http_response_with_props(status, headers, body)
        }
    }
}
