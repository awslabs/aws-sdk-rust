...
impl RegisterResourceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_resource::RegisterResource::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_register_resource::de_register_resource_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_resource::RegisterResourceError
{
