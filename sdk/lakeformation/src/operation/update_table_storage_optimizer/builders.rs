...
impl crate::operation::update_table_storage_optimizer::builders::UpdateTableStorageOptimizerInputBuilder {
...
impl UpdateTableStorageOptimizerFluentBuilder {
    /// Creates a new `UpdateTableStorageOptimizerFluentBuilder`.
