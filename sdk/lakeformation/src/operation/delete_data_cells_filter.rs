...
impl DeleteDataCellsFilterInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_data_cells_filter::DeleteDataCellsFilter::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteDataCellsFilter {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_delete_data_cells_filter::de_delete_data_cells_filter_http_error(response)
        } else {
            crate::protocol_serde::shape_delete_data_cells_filter::de_delete_data_cells_filter_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::delete_data_cells_filter::DeleteDataCellsFilterError
{
