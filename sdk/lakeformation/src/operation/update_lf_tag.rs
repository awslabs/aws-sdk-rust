...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLFTag {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_lf_tag::de_update_lf_tag_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_lf_tag::de_update_lf_tag_http_response_with_props(
                status, headers, body,
            )
        }
    }
