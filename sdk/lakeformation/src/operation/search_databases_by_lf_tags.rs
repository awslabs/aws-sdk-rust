...
/// Orchestration and serialization glue logic for `SearchDatabasesByLFTags`.
...
impl SearchDatabasesByLFTags {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchDatabasesByLFTags {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SearchDatabasesByLFTags");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SearchDatabasesByLFTagsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SearchDatabasesByLFTagsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchDatabasesByLFTags")
...
.with_interceptor(SearchDatabasesByLFTagsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError>::new());
...
#[derive(Debug)]
            struct SearchDatabasesByLFTagsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchDatabasesByLFTagsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_search_databases_by_lf_tags::de_search_databases_by_lf_tags_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_search_databases_by_lf_tags::de_search_databases_by_lf_tags_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SearchDatabasesByLFTagsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchDatabasesByLFTagsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::search_databases_by_lf_tags::SearchDatabasesByLfTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/SearchDatabasesByLFTags").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_search_databases_by_lf_tags::ser_search_databases_by_lf_tags_input(&input)?);
...
#[derive(Debug)]
            struct SearchDatabasesByLFTagsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchDatabasesByLFTagsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SearchDatabasesByLFTagsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SearchDatabasesByLfTagsInput>()
                        .ok_or("failed to downcast to SearchDatabasesByLfTagsInput")?;
...
pub enum SearchDatabasesByLFTagsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SearchDatabasesByLFTagsError) for what information is available for the error.")]
...
impl SearchDatabasesByLFTagsError {
    /// Creates the `SearchDatabasesByLFTagsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchDatabasesByLFTagsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SearchDatabasesByLFTagsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::search_databases_by_lf_tags::SearchDatabasesByLFTagsError {
...
mod _search_databases_by_lf_tags_output;
