...
impl GetDataCellsFilterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_data_cells_filter::GetDataCellsFilter,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataCellsFilter {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_data_cells_filter::de_get_data_cells_filter_http_response_with_props(status, headers, body)
        }
    }
}
