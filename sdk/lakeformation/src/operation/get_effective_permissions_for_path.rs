...
/// Orchestration and serialization glue logic for `GetEffectivePermissionsForPath`.
...
impl GetEffectivePermissionsForPath {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetEffectivePermissionsForPath {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetEffectivePermissionsForPath");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetEffectivePermissionsForPathRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetEffectivePermissionsForPathResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEffectivePermissionsForPath")
...
.with_interceptor(GetEffectivePermissionsForPathEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError>::new());
...
#[derive(Debug)]
            struct GetEffectivePermissionsForPathResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetEffectivePermissionsForPathResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_effective_permissions_for_path::de_get_effective_permissions_for_path_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetEffectivePermissionsForPathRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetEffectivePermissionsForPathRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/GetEffectivePermissionsForPath").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_effective_permissions_for_path::ser_get_effective_permissions_for_path_input(&input)?);
...
#[derive(Debug)]
            struct GetEffectivePermissionsForPathEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetEffectivePermissionsForPathEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetEffectivePermissionsForPathEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetEffectivePermissionsForPathInput>()
                        .ok_or("failed to downcast to GetEffectivePermissionsForPathInput")?;
...
pub enum GetEffectivePermissionsForPathError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetEffectivePermissionsForPathError) for what information is available for the error.")]
...
impl GetEffectivePermissionsForPathError {
    /// Creates the `GetEffectivePermissionsForPathError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetEffectivePermissionsForPathError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetEffectivePermissionsForPathError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError {
...
mod _get_effective_permissions_for_path_output;
