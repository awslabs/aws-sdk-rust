...
impl GetEffectivePermissionsForPathInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPath,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/GetEffectivePermissionsForPath")
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEffectivePermissionsForPath {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_effective_permissions_for_path::de_get_effective_permissions_for_path_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetEffectivePermissionsForPathError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_effective_permissions_for_path::GetEffectivePermissionsForPathError
{
