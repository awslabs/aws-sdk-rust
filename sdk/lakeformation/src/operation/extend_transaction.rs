...
impl ExtendTransactionInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::extend_transaction::ExtendTransaction,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::extend_transaction::ExtendTransaction::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ExtendTransaction {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_extend_transaction::de_extend_transaction_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_extend_transaction::de_extend_transaction_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::extend_transaction::ExtendTransactionError
{
