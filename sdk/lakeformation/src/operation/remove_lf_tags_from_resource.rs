...
/// Orchestration and serialization glue logic for `RemoveLFTagsFromResource`.
...
impl RemoveLFTagsFromResource {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::remove_lf_tags_from_resource::RemoveLfTagsFromResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_lf_tags_from_resource::RemoveLfTagsFromResourceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveLFTagsFromResource {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveLFTagsFromResource");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveLFTagsFromResourceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveLFTagsFromResourceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveLFTagsFromResource")
...
.with_interceptor(RemoveLFTagsFromResourceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError>::new());
...
#[derive(Debug)]
            struct RemoveLFTagsFromResourceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveLFTagsFromResourceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_lf_tags_from_resource::de_remove_lf_tags_from_resource_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_lf_tags_from_resource::de_remove_lf_tags_from_resource_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RemoveLFTagsFromResourceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveLFTagsFromResourceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_lf_tags_from_resource::RemoveLfTagsFromResourceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_lf_tags_from_resource::RemoveLfTagsFromResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/RemoveLFTagsFromResource").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_lf_tags_from_resource::ser_remove_lf_tags_from_resource_input(&input)?);
...
#[derive(Debug)]
            struct RemoveLFTagsFromResourceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveLFTagsFromResourceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveLFTagsFromResourceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveLfTagsFromResourceInput>()
                        .ok_or("failed to downcast to RemoveLfTagsFromResourceInput")?;
...
pub enum RemoveLFTagsFromResourceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveLFTagsFromResourceError) for what information is available for the error.")]
...
impl RemoveLFTagsFromResourceError {
    /// Creates the `RemoveLFTagsFromResourceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveLFTagsFromResourceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveLFTagsFromResourceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResourceError {
...
mod _remove_lf_tags_from_resource_output;
