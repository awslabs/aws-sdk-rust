...
impl RemoveLfTagsFromResourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_lf_tags_from_resource::RemoveLFTagsFromResource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveLFTagsFromResource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_lf_tags_from_resource::de_remove_lf_tags_from_resource_http_response_with_props(status, headers, body)
        }
    }
}
