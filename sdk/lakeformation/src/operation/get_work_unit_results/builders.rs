...
impl GetWorkUnitResultsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_work_unit_results::GetWorkUnitResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_work_unit_results::GetWorkUnitResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_work_unit_results::GetWorkUnitResultsOutput, crate::operation::get_work_unit_results::GetWorkUnitResultsError, Self> {
