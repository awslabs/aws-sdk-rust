...
impl GrantPermissionsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::grant_permissions::GrantPermissions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GrantPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_grant_permissions::de_grant_permissions_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::grant_permissions::GrantPermissionsError
{
