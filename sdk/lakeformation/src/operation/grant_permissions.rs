...
impl GrantPermissionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::grant_permissions::GrantPermissions, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_grant_permissions::ser_grant_permissions_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GrantPermissions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_grant_permissions::de_grant_permissions_http_response_with_props(status, headers, body)
        }
    }
}
