...
impl GetDataLakeSettingsFluentBuilder  {
    /// Creates a new `GetDataLakeSettings`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_data_lake_settings::GetDataLakeSettings, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_data_lake_settings::GetDataLakeSettingsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_data_lake_settings::GetDataLakeSettingsOutput, aws_smithy_http::result::SdkError<crate::operation::get_data_lake_settings::GetDataLakeSettingsError>>
                     {
