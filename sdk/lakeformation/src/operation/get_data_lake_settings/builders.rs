...
impl GetDataLakeSettingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_data_lake_settings::GetDataLakeSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_data_lake_settings::GetDataLakeSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_data_lake_settings::GetDataLakeSettingsOutput, crate::operation::get_data_lake_settings::GetDataLakeSettingsError, Self> {
