...
pub fn ser_data_cells_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataCellsFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_cells_filter<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataCellsFilter>, aws_smithy_json::deserialize::error::DeserializeError>
