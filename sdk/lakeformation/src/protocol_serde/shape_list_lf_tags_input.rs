...
pub fn ser_list_lf_tags_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListLfTagsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
