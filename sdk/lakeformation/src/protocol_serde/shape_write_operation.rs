...
pub fn ser_write_operation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WriteOperation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
