...
pub fn ser_table_with_columns_resource(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TableWithColumnsResource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_table_with_columns_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TableWithColumnsResource>, aws_smithy_json::deserialize::error::DeserializeError>
