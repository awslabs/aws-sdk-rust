...
pub(crate) fn de_data_lake_principal_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::DataLakePrincipal>>, aws_smithy_json::deserialize::error::DeserializeError>
