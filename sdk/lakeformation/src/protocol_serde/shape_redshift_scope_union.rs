...
pub fn ser_redshift_scope_union(
    ...
    match input {
        crate::types::RedshiftScopeUnion::RedshiftConnect(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_3.key("RedshiftConnect").start_object();
            crate::protocol_serde::shape_redshift_connect::ser_redshift_connect(&mut object_1, inner)?;
            object_1.finish();
        }
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "RedshiftConnect" => Some(crate::types::RedshiftScopeUnion::RedshiftConnect(
                            crate::protocol_serde::shape_redshift_connect::de_redshift_connect(tokens, _value, depth + 1)?.ok_or_else(|| {
                                ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'RedshiftConnect' cannot be null")
                            })?,
                        )),
                        _ => {
                            ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                            Some(crate::types::RedshiftScopeUnion::Unknown)
                        }
                    };
                }
                other => {
