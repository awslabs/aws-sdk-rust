...
pub fn ser_start_query_planning_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartQueryPlanningInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
