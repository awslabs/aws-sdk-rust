...
) -> Result<Option<crate::types::DataLakeSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AllowExternalDataFiltering" => {
                            builder =
                                builder.set_allow_external_data_filtering(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "AllowFullTableExternalDataAccess" => {
                            builder = builder.set_allow_full_table_external_data_access(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                                tokens.next(),
                            )?);
                        }
...
pub fn ser_data_lake_settings(
        ...
        for item_15 in var_13 {
            {
                ...
                crate::protocol_serde::shape_principal_permissions::ser_principal_permissions(&mut object_16, item_15)?;
                object_16.finish();
            }
        }
        array_14.finish();
    ...
    if let Some(var_25) = &input.allow_full_table_external_data_access {
        object.key("AllowFullTableExternalDataAccess").boolean(*var_25);
    }
        ...
        for item_28 in var_26 {
            {
                ...
                crate::protocol_serde::shape_data_lake_principal::ser_data_lake_principal(&mut object_29, item_28)?;
                object_29.finish();
            }
        }
        array_27.finish();
