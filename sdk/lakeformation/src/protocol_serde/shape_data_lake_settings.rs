...
pub(crate) fn de_data_lake_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataLakeSettings>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_data_lake_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataLakeSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
