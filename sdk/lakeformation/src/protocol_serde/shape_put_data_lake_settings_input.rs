...
pub fn ser_put_data_lake_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutDataLakeSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
