...
pub(crate) fn de_lake_formation_opt_ins_info<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::LakeFormationOptInsInfo>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
