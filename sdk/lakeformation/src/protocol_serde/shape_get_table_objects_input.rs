...
pub fn ser_get_table_objects_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTableObjectsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
