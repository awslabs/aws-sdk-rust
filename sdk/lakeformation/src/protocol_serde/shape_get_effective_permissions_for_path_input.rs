...
pub fn ser_get_effective_permissions_for_path_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetEffectivePermissionsForPathInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
