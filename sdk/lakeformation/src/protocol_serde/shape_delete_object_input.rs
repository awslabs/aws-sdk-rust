...
pub fn ser_delete_object_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::DeleteObjectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
