...
pub fn ser_principal_permissions(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PrincipalPermissions) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_principal_permissions<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PrincipalPermissions>, aws_smithy_json::deserialize::error::DeserializeError>
