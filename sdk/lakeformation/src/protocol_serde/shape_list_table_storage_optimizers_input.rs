...
pub fn ser_list_table_storage_optimizers_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListTableStorageOptimizersInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
