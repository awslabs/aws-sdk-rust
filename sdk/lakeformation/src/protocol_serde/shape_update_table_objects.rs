...
pub fn de_update_table_objects_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_table_objects::UpdateTableObjectsOutput, crate::operation::update_table_objects::UpdateTableObjectsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_table_objects_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::update_table_objects::UpdateTableObjectsOutput, crate::operation::update_table_objects::UpdateTableObjectsError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_update_table_objects_input(input: &crate::operation::update_table_objects::UpdateTableObjectsInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_table_objects_input::ser_update_table_objects_input_input(&mut object, input)?;
    object.finish();
