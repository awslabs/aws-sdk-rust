...
pub fn ser_lf_tag_pair(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LfTagPair) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_lf_tag_pair<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LfTagPair>, aws_smithy_json::deserialize::error::DeserializeError>
