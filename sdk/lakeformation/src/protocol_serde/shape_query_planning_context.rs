...
pub fn ser_query_planning_context(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::QueryPlanningContext) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
