...
pub fn ser_add_object_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AddObjectInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
