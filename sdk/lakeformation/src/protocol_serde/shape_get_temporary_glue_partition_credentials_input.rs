...
pub fn ser_get_temporary_glue_partition_credentials_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetTemporaryGluePartitionCredentialsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
