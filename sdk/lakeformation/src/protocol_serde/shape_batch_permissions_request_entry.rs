...
pub fn ser_batch_permissions_request_entry(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchPermissionsRequestEntry) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_batch_permissions_request_entry<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchPermissionsRequestEntry>, aws_smithy_json::deserialize::error::DeserializeError>
