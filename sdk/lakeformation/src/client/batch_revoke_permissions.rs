...
impl super::Client {
    ...
    ///   - [`entries(BatchPermissionsRequestEntry)`](crate::operation::batch_revoke_permissions::builders::BatchRevokePermissionsFluentBuilder::entries) / [`set_entries(Option<Vec::<BatchPermissionsRequestEntry>>)`](crate::operation::batch_revoke_permissions::builders::BatchRevokePermissionsFluentBuilder::set_entries):<br>required: **true**<br><p>A list of up to 20 entries for resource permissions to be revoked by batch operation to the principal.</p><br>
