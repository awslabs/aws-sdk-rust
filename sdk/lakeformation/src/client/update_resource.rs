...
impl super::Client {
    ...
    ///   - [`expected_resource_owner_account(impl Into<String>)`](crate::operation::update_resource::builders::UpdateResourceFluentBuilder::expected_resource_owner_account) / [`set_expected_resource_owner_account(Option<String>)`](crate::operation::update_resource::builders::UpdateResourceFluentBuilder::set_expected_resource_owner_account):<br>required: **false**<br><p>The Amazon Web Services account that owns the Glue tables associated with specific Amazon S3 locations.</p><br>
