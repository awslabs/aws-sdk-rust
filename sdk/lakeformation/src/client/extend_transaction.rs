...
impl super::Client {
    ...
    pub fn extend_transaction(
        &self,
    ) -> crate::operation::extend_transaction::builders::ExtendTransactionFluentBuilder {
        crate::operation::extend_transaction::builders::ExtendTransactionFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
