...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::search_databases_by_lf_tags::builders::SearchDatabasesByLFTagsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::search_databases_by_lf_tags::builders::SearchDatabasesByLFTagsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return.</p><br>
