...
impl super::Client {
    ...
    ///   - [`lf_tags(LfTagPair)`](crate::operation::add_lf_tags_to_resource::builders::AddLFTagsToResourceFluentBuilder::lf_tags) / [`set_lf_tags(Option<Vec<LfTagPair>>)`](crate::operation::add_lf_tags_to_resource::builders::AddLFTagsToResourceFluentBuilder::set_lf_tags): <p>The LF-tags to attach to the resource.</p>
