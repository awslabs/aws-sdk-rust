...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::add_lf_tags_to_resource::builders::AddLFTagsToResourceFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::add_lf_tags_to_resource::builders::AddLFTagsToResourceFluentBuilder::set_catalog_id): <p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p>
