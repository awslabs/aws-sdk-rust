...
impl super::Client {
    ...
    ///   - [`catalog_id(impl Into<String>)`](crate::operation::get_data_lake_settings::builders::GetDataLakeSettingsFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_data_lake_settings::builders::GetDataLakeSettingsFluentBuilder::set_catalog_id):<br>required: **false**<br><p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment.</p><br>
