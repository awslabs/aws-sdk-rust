...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_resource::builders::DescribeResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::describe_resource::builders::DescribeResourceFluentBuilder::set_resource_arn): <p>The resource ARN.</p>
