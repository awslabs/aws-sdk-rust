...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::describe_resource::builders::DescribeResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::describe_resource::builders::DescribeResourceFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The resource ARN.</p><br>
