...
impl super::Client {
    ...
    ///   - [`catalog_id(impl Into<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::set_catalog_id): <p>The catalog containing the governed table. Defaults to the caller’s account.</p>
    ///   - [`database_name(impl Into<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::set_database_name): <p>The database containing the governed table.</p>
    ///   - [`table_name(impl Into<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::set_table_name): <p>The governed table for which to retrieve objects.</p>
    ///   - [`transaction_id(impl Into<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::transaction_id) / [`set_transaction_id(Option<String>)`](crate::operation::get_table_objects::builders::GetTableObjectsFluentBuilder::set_transaction_id): <p>The transaction ID at which to read the governed table contents. If this transaction has aborted, an error is returned. If not set, defaults to the most recent committed transaction. Cannot be specified along with <code>QueryAsOfTime</code>.</p>
