...
impl super::Client {
    ...
    ///   - [`lf_tags(LfTagPair)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::lf_tags) / [`set_lf_tags(Option<Vec<LfTagPair>>)`](crate::operation::remove_lf_tags_from_resource::builders::RemoveLFTagsFromResourceFluentBuilder::set_lf_tags): <p>The LF-tags to be removed from the resource.</p>
