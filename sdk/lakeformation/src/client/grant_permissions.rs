...
impl super::Client {
    /// Constructs a fluent builder for the [`GrantPermissions`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder) operation.
    ///
    /// - The fluent builder is configurable:
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::set_catalog_id): <p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p>
    ///   - [`principal(DataLakePrincipal)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::principal) / [`set_principal(Option<DataLakePrincipal>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::set_principal): <p>The principal to be granted the permissions on the resource. Supported principals are IAM users or IAM roles, and they are defined by their principal type and their ARN.</p>  <p>Note that if you define a resource with a particular ARN, then later delete, and recreate a resource with that same ARN, the resource maintains the permissions already granted. </p>
    ///   - [`resource(Resource)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::resource) / [`set_resource(Option<Resource>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::set_resource): <p>The resource to which permissions are to be granted. Resources in Lake Formation are the Data Catalog, databases, and tables.</p>
    ///   - [`permissions(Vec<Permission>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::permissions) / [`set_permissions(Option<Vec<Permission>>)`](crate::operation::grant_permissions::builders::GrantPermissionsFluentBuilder::set_permissions): <p>The permissions granted to the principal on the resource. Lake Formation defines privileges to grant and revoke access to metadata in the Data Catalog and data organized in underlying data storage such as Amazon S3. Lake Formation requires that each principal be authorized to perform a specific task on Lake Formation resources. </p>
