...
impl super::Client {
    ...
    ///   - [`saml_assertion(impl ::std::convert::Into<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::saml_assertion) / [`set_saml_assertion(Option<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::set_saml_assertion): <p>A SAML assertion consisting of an assertion statement for the user who needs temporary credentials. This must match the SAML assertion that was issued to IAM. This must be Base64 encoded.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::set_role_arn): <p>The role that represents an IAM principal whose scope down policy allows it to call credential vending APIs such as <code>GetTemporaryTableCredentials</code>. The caller must also have iam:PassRole permission on this role. </p>
    ///   - [`principal_arn(impl ::std::convert::Into<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::principal_arn) / [`set_principal_arn(Option<String>)`](crate::operation::assume_decorated_role_with_saml::builders::AssumeDecoratedRoleWithSAMLFluentBuilder::set_principal_arn): <p>The Amazon Resource Name (ARN) of the SAML provider in IAM that describes the IdP.</p>
