...
impl super::Client {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::get_lf_tag::builders::GetLFTagFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_lf_tag::builders::GetLFTagFluentBuilder::set_catalog_id): <p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p>
    ///   - [`tag_key(impl ::std::convert::Into<String>)`](crate::operation::get_lf_tag::builders::GetLFTagFluentBuilder::tag_key) / [`set_tag_key(Option<String>)`](crate::operation::get_lf_tag::builders::GetLFTagFluentBuilder::set_tag_key): <p>The key-name for the LF-tag.</p>
