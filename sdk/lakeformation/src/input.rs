...
impl DescribeTransactionInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_transaction::ser_describe_transaction_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl GetDataLakeSettingsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_data_lake_settings::ser_get_data_lake_settings_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl GetResourceLfTagsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_resource_lf_tags::ser_get_resource_lf_tags_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl GetWorkUnitResultsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_work_unit_results::ser_get_work_unit_results_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl ListDataCellsFilterInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_data_cells_filter::ser_list_data_cells_filter_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl StartQueryPlanningInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_query_planning::ser_start_query_planning_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateTableObjectsInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_table_objects::ser_update_table_objects_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
