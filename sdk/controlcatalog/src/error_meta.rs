...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_common_controls::ListCommonControlsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_common_controls::ListCommonControlsError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(crate::error::sealed_unhandled::Unhandled {
                meta: ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(&err).clone(),
...
impl From<crate::operation::list_common_controls::ListCommonControlsError> for Error {
    fn from(err: crate::operation::list_common_controls::ListCommonControlsError) -> Self {
        match err {
            crate::operation::list_common_controls::ListCommonControlsError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::list_common_controls::ListCommonControlsError::InternalServerException(inner) => Error::InternalServerException(inner),
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_control_mappings::ListControlMappingsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_control_mappings::ListControlMappingsError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(crate::error::sealed_unhandled::Unhandled {
                meta: ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(&err).clone(),
...
impl From<crate::operation::list_control_mappings::ListControlMappingsError> for Error {
    fn from(err: crate::operation::list_control_mappings::ListControlMappingsError) -> Self {
        match err {
            crate::operation::list_control_mappings::ListControlMappingsError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::list_control_mappings::ListControlMappingsError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::list_control_mappings::ListControlMappingsError::ThrottlingException(inner) => Error::ThrottlingException(inner),
            crate::operation::list_control_mappings::ListControlMappingsError::ValidationException(inner) => Error::ValidationException(inner),
            crate::operation::list_control_mappings::ListControlMappingsError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_objectives::ListObjectivesError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_objectives::ListObjectivesError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(crate::error::sealed_unhandled::Unhandled {
                meta: ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(&err).clone(),
...
impl From<crate::operation::list_objectives::ListObjectivesError> for Error {
    fn from(err: crate::operation::list_objectives::ListObjectivesError) -> Self {
        match err {
            crate::operation::list_objectives::ListObjectivesError::AccessDeniedException(inner) => Error::AccessDeniedException(inner),
            crate::operation::list_objectives::ListObjectivesError::InternalServerException(inner) => Error::InternalServerException(inner),
            crate::operation::list_objectives::ListObjectivesError::ThrottlingException(inner) => Error::ThrottlingException(inner),
            crate::operation::list_objectives::ListObjectivesError::ValidationException(inner) => Error::ValidationException(inner),
            crate::operation::list_objectives::ListObjectivesError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
