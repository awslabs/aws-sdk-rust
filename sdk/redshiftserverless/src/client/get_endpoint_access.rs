...
impl super::Client {
    ...
    ///   - [`endpoint_name(impl Into<String>)`](crate::operation::get_endpoint_access::builders::GetEndpointAccessFluentBuilder::endpoint_name) / [`set_endpoint_name(Option<String>)`](crate::operation::get_endpoint_access::builders::GetEndpointAccessFluentBuilder::set_endpoint_name):<br>required: **true**<br><p>The name of the VPC endpoint to return information for.</p><br>
