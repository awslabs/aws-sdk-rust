...
impl super::Client {
    ...
    ///   - [`table_restore_request_id(impl Into<String>)`](crate::operation::get_table_restore_status::builders::GetTableRestoreStatusFluentBuilder::table_restore_request_id) / [`set_table_restore_request_id(Option<String>)`](crate::operation::get_table_restore_status::builders::GetTableRestoreStatusFluentBuilder::set_table_restore_request_id):<br>required: **true**<br><p>The ID of the <code>RestoreTableFromSnapshot</code> request to return status for.</p><br>
