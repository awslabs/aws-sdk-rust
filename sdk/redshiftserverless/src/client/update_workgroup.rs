...
impl super::Client {
    ...
    ///   - [`workgroup_name(impl ::std::convert::Into<String>)`](crate::operation::update_workgroup::builders::UpdateWorkgroupFluentBuilder::workgroup_name) / [`set_workgroup_name(Option<String>)`](crate::operation::update_workgroup::builders::UpdateWorkgroupFluentBuilder::set_workgroup_name): <p>The name of the workgroup to update. You can't update the name of a workgroup once it is created.</p>
