...
impl super::Client {
    ...
    pub fn create_snapshot_copy_configuration(&self) -> crate::operation::create_snapshot_copy_configuration::builders::CreateSnapshotCopyConfigurationFluentBuilder {
