...
impl super::Client {
    ...
    ///   - [`recovery_point_id(impl Into<String>)`](crate::operation::get_recovery_point::builders::GetRecoveryPointFluentBuilder::recovery_point_id) / [`set_recovery_point_id(Option<String>)`](crate::operation::get_recovery_point::builders::GetRecoveryPointFluentBuilder::set_recovery_point_id):<br>required: **true**<br><p>The unique identifier of the recovery point to return information for.</p><br>
