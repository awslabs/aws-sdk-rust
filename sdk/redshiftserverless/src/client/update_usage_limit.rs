...
impl super::Client {
    ...
    ///   - [`usage_limit_id(impl Into<String>)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::usage_limit_id) / [`set_usage_limit_id(Option<String>)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::set_usage_limit_id):<br>required: **true**<br><p>The identifier of the usage limit to update.</p><br>
    ///   - [`amount(i64)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::amount) / [`set_amount(Option<i64>)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::set_amount):<br>required: **false**<br><p>The new limit amount. If time-based, this amount is in Redshift Processing Units (RPU) consumed per hour. If data-based, this amount is in terabytes (TB) of data transferred between Regions in cross-account sharing. The value must be a positive number.</p><br>
    ///   - [`breach_action(UsageLimitBreachAction)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::breach_action) / [`set_breach_action(Option<UsageLimitBreachAction>)`](crate::operation::update_usage_limit::builders::UpdateUsageLimitFluentBuilder::set_breach_action):<br>required: **false**<br><p>The new action that Amazon Redshift Serverless takes when the limit is reached.</p><br>
