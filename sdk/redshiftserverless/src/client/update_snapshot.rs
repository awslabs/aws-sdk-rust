...
impl super::Client {
    ...
    ///   - [`snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::update_snapshot::builders::UpdateSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::update_snapshot::builders::UpdateSnapshotFluentBuilder::set_snapshot_name): <p>The name of the snapshot.</p>
