...
impl super::Client {
    ...
    ///   - [`workgroup_name(impl Into<String>)`](crate::operation::create_workgroup::builders::CreateWorkgroupFluentBuilder::workgroup_name) / [`set_workgroup_name(Option<String>)`](crate::operation::create_workgroup::builders::CreateWorkgroupFluentBuilder::set_workgroup_name): <p>The name of the created workgroup.</p>
    ///   - [`namespace_name(impl Into<String>)`](crate::operation::create_workgroup::builders::CreateWorkgroupFluentBuilder::namespace_name) / [`set_namespace_name(Option<String>)`](crate::operation::create_workgroup::builders::CreateWorkgroupFluentBuilder::set_namespace_name): <p>The name of the namespace to associate with the workgroup.</p>
