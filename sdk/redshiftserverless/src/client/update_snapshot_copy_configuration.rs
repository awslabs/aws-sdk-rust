...
impl super::Client {
    ...
    pub fn update_snapshot_copy_configuration(&self) -> crate::operation::update_snapshot_copy_configuration::builders::UpdateSnapshotCopyConfigurationFluentBuilder {
