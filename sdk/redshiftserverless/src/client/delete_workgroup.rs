...
impl super::Client {
    ...
    ///   - [`workgroup_name(impl Into<String>)`](crate::operation::delete_workgroup::builders::DeleteWorkgroupFluentBuilder::workgroup_name) / [`set_workgroup_name(Option<String>)`](crate::operation::delete_workgroup::builders::DeleteWorkgroupFluentBuilder::set_workgroup_name):<br>required: **true**<br><p>The name of the workgroup to be deleted.</p><br>
