...
impl super::Client {
    ...
    ///   - [`workgroup_name(impl ::std::convert::Into<String>)`](crate::operation::delete_workgroup::builders::DeleteWorkgroupFluentBuilder::workgroup_name) / [`set_workgroup_name(Option<String>)`](crate::operation::delete_workgroup::builders::DeleteWorkgroupFluentBuilder::set_workgroup_name): <p>The name of the workgroup to be deleted.</p>
