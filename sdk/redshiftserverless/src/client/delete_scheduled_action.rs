...
impl super::Client {
    ...
    /// - On success, responds with [`DeleteScheduledActionOutput`](crate::operation::delete_scheduled_action::DeleteScheduledActionOutput) with field(s):
    ///   - [`scheduled_action(Option<ScheduledActionResponse>)`](crate::operation::delete_scheduled_action::DeleteScheduledActionOutput::scheduled_action): <p>The deleted scheduled action object.</p>
