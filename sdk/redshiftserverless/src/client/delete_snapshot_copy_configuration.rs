...
impl super::Client {
    ...
    pub fn delete_snapshot_copy_configuration(&self) -> crate::operation::delete_snapshot_copy_configuration::builders::DeleteSnapshotCopyConfigurationFluentBuilder {
