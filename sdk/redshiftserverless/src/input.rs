...
impl ListEndpointAccessInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_endpoint_access::ser_list_endpoint_access_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
...
impl UpdateEndpointAccessInput {
    ...
    > {
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_endpoint_access::ser_update_endpoint_access_input(
                &self,
            )?,
        );
        if let Some(content_length) = body.content_length() {
