...
impl ListUsageLimitsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_usage_limits::builders::ListUsageLimitsInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_usage_limits::paginator::ListUsageLimitsPaginator {
        crate::operation::list_usage_limits::paginator::ListUsageLimitsPaginator::new(
            self.handle,
            self.inner,
        )
    }
