...
impl GetNamespaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_namespace::GetNamespace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_namespace::ser_get_namespace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNamespace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_namespace::de_get_namespace_http_response_with_props(status, headers, body)
        }
    }
