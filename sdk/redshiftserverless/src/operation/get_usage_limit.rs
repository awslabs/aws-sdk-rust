...
impl GetUsageLimitInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_usage_limit::GetUsageLimit,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_usage_limit::GetUsageLimit::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUsageLimit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_usage_limit::de_get_usage_limit_http_error(
                status, headers, body,
            )
        } else {
