...
impl GetUsageLimitFluentBuilder  {
    /// Creates a new `GetUsageLimit`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_usage_limit::GetUsageLimitOutput, aws_smithy_http::result::SdkError<crate::operation::get_usage_limit::GetUsageLimitError>>
                     {
