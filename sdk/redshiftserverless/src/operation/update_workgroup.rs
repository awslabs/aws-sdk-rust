...
impl UpdateWorkgroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_workgroup::UpdateWorkgroup, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_workgroup::ser_update_workgroup_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkgroup {
    type Output =
        ::std::result::Result<crate::operation::update_workgroup::UpdateWorkgroupOutput, crate::operation::update_workgroup::UpdateWorkgroupError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_workgroup::de_update_workgroup_http_response_with_props(status, headers, body)
        }
    }
}
