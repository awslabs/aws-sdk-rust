...
impl UpdateWorkgroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_workgroup::UpdateWorkgroup,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workgroup::UpdateWorkgroup::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWorkgroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_workgroup::de_update_workgroup_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_workgroup::UpdateWorkgroupError
{
...
impl ::aws_smithy_types::retry::ProvideErrorKind for UpdateWorkgroupError {
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            Self::InsufficientCapacityException(inner) => {
