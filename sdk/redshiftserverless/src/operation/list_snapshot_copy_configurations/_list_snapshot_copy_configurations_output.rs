...
impl  ListSnapshotCopyConfigurationsOutput  {
    ...
    pub fn snapshot_copy_configurations(&self) -> & [crate::types::SnapshotCopyConfiguration] {
        use std::ops::Deref; self.snapshot_copy_configurations.deref()
    }
}
...
impl ListSnapshotCopyConfigurationsOutputBuilder {
    ...
    /// <p>All of the returned snapshot copy configurations.</p>
    pub fn set_snapshot_copy_configurations(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::SnapshotCopyConfiguration>>) -> Self {
        self.snapshot_copy_configurations = input; self
    }
    /// <p>All of the returned snapshot copy configurations.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_snapshot_copy_configurations::ListSnapshotCopyConfigurationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_snapshot_copy_configurations::ListSnapshotCopyConfigurationsOutput {
                ...
                snapshot_copy_configurations: self.snapshot_copy_configurations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("snapshot_copy_configurations", "snapshot_copy_configurations was not specified but it is required when building ListSnapshotCopyConfigurationsOutput")
                    )?
                ,
