...
impl RestoreTableFromRecoveryPointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_table_from_recovery_point::RestoreTableFromRecoveryPointInput, ::aws_smithy_types::error::operation::BuildError> {
