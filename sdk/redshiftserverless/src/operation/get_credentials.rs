...
impl GetCredentialsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_credentials::GetCredentials, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_credentials::ser_get_credentials_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCredentials {
    type Output =
        ::std::result::Result<crate::operation::get_credentials::GetCredentialsOutput, crate::operation::get_credentials::GetCredentialsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_credentials::de_get_credentials_http_response_with_props(status, headers, body)
        }
    }
