...
impl ListWorkgroupsFluentBuilder  {
    /// Creates a new `ListWorkgroups`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_workgroups::ListWorkgroupsOutput, aws_smithy_http::result::SdkError<crate::operation::list_workgroups::ListWorkgroupsError>>
                     {
