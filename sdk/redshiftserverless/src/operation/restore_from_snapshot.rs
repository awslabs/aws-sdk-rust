...
impl RestoreFromSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`RestoreFromSnapshot`](crate::operation::restore_from_snapshot::RestoreFromSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_from_snapshot::RestoreFromSnapshot, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_from_snapshot::RestoreFromSnapshotInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_from_snapshot::RestoreFromSnapshot::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RestoreFromSnapshot", "redshiftserverless"));
...
impl aws_smithy_http::response::ParseStrictResponse for RestoreFromSnapshot {
                type Output = std::result::Result<crate::operation::restore_from_snapshot::RestoreFromSnapshotOutput, crate::operation::restore_from_snapshot::RestoreFromSnapshotError>;
