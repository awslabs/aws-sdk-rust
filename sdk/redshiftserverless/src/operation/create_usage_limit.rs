...
impl CreateUsageLimitInput {
    /// Consumes the builder and constructs an Operation<[`CreateUsageLimit`](crate::operation::create_usage_limit::CreateUsageLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_usage_limit::CreateUsageLimit, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_usage_limit::CreateUsageLimitInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_usage_limit::ser_create_usage_limit_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_usage_limit::CreateUsageLimit::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateUsageLimit", "redshiftserverless"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateUsageLimit {
                type Output = std::result::Result<crate::operation::create_usage_limit::CreateUsageLimitOutput, crate::operation::create_usage_limit::CreateUsageLimitError>;
