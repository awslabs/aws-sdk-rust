...
impl CreateUsageLimitInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_usage_limit::ser_create_usage_limit_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUsageLimit {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_usage_limit::de_create_usage_limit_http_response_with_props(status, headers, body)
        }
    }
}
