...
impl ListRecoveryPointsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_recovery_points::ser_list_recovery_points_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecoveryPoints {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recovery_points::de_list_recovery_points_http_response_with_props(status, headers, body)
        }
    }
}
