...
impl ListSnapshotsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_snapshots::ListSnapshots,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_snapshots::ListSnapshots::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSnapshots {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_snapshots::de_list_snapshots_http_error(
                status, headers, body,
            )
        } else {
