...
impl ConvertRecoveryPointToSnapshotInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::convert_recovery_point_to_snapshot::ConvertRecoveryPointToSnapshot::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConvertRecoveryPointToSnapshot {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_convert_recovery_point_to_snapshot::de_convert_recovery_point_to_snapshot_http_response_with_props(
                status, headers, body,
            )
        }
    }
