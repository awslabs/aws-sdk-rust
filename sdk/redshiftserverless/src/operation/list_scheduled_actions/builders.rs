...
impl ListScheduledActionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_scheduled_actions::ListScheduledActionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_scheduled_actions::ListScheduledActionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_scheduled_actions::ListScheduledActionsOutput, crate::operation::list_scheduled_actions::ListScheduledActionsError, Self> {
