...
pub fn ser_convert_recovery_point_to_snapshot_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ConvertRecoveryPointToSnapshotInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
