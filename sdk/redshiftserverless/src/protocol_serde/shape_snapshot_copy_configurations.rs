...
pub(crate) fn de_snapshot_copy_configurations<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::SnapshotCopyConfiguration>>, ::aws_smithy_json::deserialize::error::DeserializeError>
