...
pub fn ser_create_workgroup_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWorkgroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
