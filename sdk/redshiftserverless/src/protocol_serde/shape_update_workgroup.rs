...
pub fn de_update_workgroup_http_error(
    ...
    Err(match error_code {
        ...
        "Ipv6CidrBlockNotFoundException" => crate::operation::update_workgroup::UpdateWorkgroupError::Ipv6CidrBlockNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
) -> Result<crate::operation::update_workgroup::builders::UpdateWorkgroupOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
