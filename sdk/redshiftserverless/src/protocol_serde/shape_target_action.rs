...
pub fn ser_target_action(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::TargetAction) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::TargetAction::CreateSnapshot(inner) => {
             {
                #[allow(unused_mut)]
                let mut object_1 = object_3.key("createSnapshot").start_object();
                crate::protocol_serde::shape_create_snapshot_schedule_action_parameters::ser_create_snapshot_schedule_action_parameters(&mut object_1, inner)?;
                object_1.finish();
            }
        },
...
pub(crate) fn de_target_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TargetAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
