...
) -> Result<Option<crate::types::Workgroup>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "configParameters" => {
                            builder =
                                builder.set_config_parameters(crate::protocol_serde::shape_config_parameter_list::de_config_parameter_list(tokens)?);
                        }
                        "securityGroupIds" => {
                            builder = builder
                        ...
                        "status" => {
                            builder = builder.set_status(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::WorkgroupStatus::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "endpoint" => {
                            builder = builder.set_endpoint(crate::protocol_serde::shape_endpoint::de_endpoint(tokens)?);
                        }
                        "publiclyAccessible" => {
