...
pub fn ser_update_workgroup_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWorkgroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
