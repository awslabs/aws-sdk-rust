...
pub(crate) fn de_network_interface_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::NetworkInterface>>, aws_smithy_json::deserialize::error::DeserializeError>
