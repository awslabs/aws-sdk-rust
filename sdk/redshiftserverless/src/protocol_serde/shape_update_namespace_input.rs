...
pub fn ser_update_namespace_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNamespaceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
