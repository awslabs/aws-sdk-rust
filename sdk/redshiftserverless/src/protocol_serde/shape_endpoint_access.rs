...
pub(crate) fn de_endpoint_access<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EndpointAccess>, aws_smithy_json::deserialize::error::DeserializeError>
