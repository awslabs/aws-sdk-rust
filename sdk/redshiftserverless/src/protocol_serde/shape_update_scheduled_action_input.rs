...
pub fn ser_update_scheduled_action_input_input(
    ...
    if let Some(var_9) = &input.start_time {
        object.key("startTime").date_time(var_9, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_10) = &input.end_time {
        object.key("endTime").date_time(var_10, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
