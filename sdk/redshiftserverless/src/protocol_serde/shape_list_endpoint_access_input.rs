...
pub fn ser_list_endpoint_access_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListEndpointAccessInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
