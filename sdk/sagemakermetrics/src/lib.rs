...
//! aws-sdk-sagemakermetrics = "0.45.0"
...
//!     let client = sagemakermetrics::Client::new(&config);
//!
...
//! offered by Amazon SageMaker Metrics Service. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SageMaker Metrics Service.
...
/// let config = aws_sdk_sagemakermetrics::config::Builder::from(&sdk_config)
/// # /*
...
/// For example, the [`BatchPutMetrics`](crate::operation::batch_put_metrics) operation has
/// a [`Client::batch_put_metrics`], function which returns a builder for that operation.
/// The fluent builder ultimately has a `call()` function that returns an async future that
/// returns a result, as illustrated below:
///
/// ```rust,ignore
/// let result = client.batch_put_metrics()
///     .trial_component_name("example")
///     .call()
///     .await;
/// ```
///
...
/// Configuration for Amazon SageMaker Metrics Service.
pub mod config;
