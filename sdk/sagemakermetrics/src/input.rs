...
pub mod batch_put_metrics_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> Result<crate::input::BatchPutMetricsInput, aws_smithy_http::operation::error::BuildError>
        {
            Ok(crate::input::BatchPutMetricsInput {
...
impl BatchPutMetricsInput {
    ...
    > {
        ...
        let mut request = {
            fn uri_base(
                _input: &crate::input::BatchPutMetricsInput,
                output: &mut String,
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::BatchPutMetrics::new(),
        )
