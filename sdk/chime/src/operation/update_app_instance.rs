...
impl UpdateAppInstanceInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_app_instance::ser_update_app_instance_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAppInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_app_instance::de_update_app_instance_http_response_with_props(status, headers, body)
        }
    }
}
