...
impl GetMediaCapturePipelineInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_media_capture_pipeline::GetMediaCapturePipelineInput, ::aws_smithy_types::error::operation::BuildError> {
