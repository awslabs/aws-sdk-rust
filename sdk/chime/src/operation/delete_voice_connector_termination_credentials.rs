    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_voice_connector_termination_credentials::DeleteVoiceConnectorTerminationCredentialsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_voice_connector_termination_credentials::DeleteVoiceConnectorTerminationCredentialsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteVoiceConnectorTerminationCredentials {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteVoiceConnectorTerminationCredentialsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteVoiceConnectorTerminationCredentialsResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteVoiceConnectorTerminationCredentials")
                .with_interceptor(
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteVoiceConnectorTerminationCredentialsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 204 || force_error {
            crate::protocol_serde::shape_delete_voice_connector_termination_credentials::de_delete_voice_connector_termination_credentials_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteVoiceConnectorTerminationCredentialsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_voice_connector_termination_credentials::DeleteVoiceConnectorTerminationCredentialsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_voice_connector_termination_credentials::DeleteVoiceConnectorTerminationCredentialsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_voice_connector_termination_credentials::ser_delete_voice_connector_termination_credentials_input(
                &input,
            )?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::delete_voice_connector_termination_credentials::DeleteVoiceConnectorTerminationCredentialsError
{
