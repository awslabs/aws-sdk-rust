...
impl ::aws_smithy_http::response::ParseStrictResponse
    for DeleteVoiceConnectorTerminationCredentials
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_voice_connector_termination_credentials::de_delete_voice_connector_termination_credentials_http_response_with_props(status, headers, body)
        }
    }
}
