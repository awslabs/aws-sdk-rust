...
impl GetEventsConfigurationFluentBuilder  {
    /// Creates a new `GetEventsConfiguration`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_events_configuration::GetEventsConfigurationOutput, aws_smithy_http::result::SdkError<crate::operation::get_events_configuration::GetEventsConfigurationError>>
                     {
