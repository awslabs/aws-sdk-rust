...
impl GetUserSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_user_settings::GetUserSettings, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUserSettings {
    type Output =
        ::std::result::Result<crate::operation::get_user_settings::GetUserSettingsOutput, crate::operation::get_user_settings::GetUserSettingsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_user_settings::de_get_user_settings_http_response_with_props(status, headers, body)
        }
    }
}
