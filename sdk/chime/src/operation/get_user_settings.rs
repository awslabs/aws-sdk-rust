...
impl GetUserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetUserSettings`](crate::operation::get_user_settings::GetUserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_user_settings::GetUserSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_user_settings::GetUserSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AccountId}/users/{UserId}/settings", AccountId = account_id, UserId = user_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_user_settings::GetUserSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetUserSettings", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetUserSettings {
                type Output = std::result::Result<crate::operation::get_user_settings::GetUserSettingsOutput, crate::operation::get_user_settings::GetUserSettingsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_user_settings::de_get_user_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_user_settings::de_get_user_settings_http_response(response)
                     }
                }
            }
