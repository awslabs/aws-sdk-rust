...
impl RegenerateSecurityTokenInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::regenerate_security_token::RegenerateSecurityTokenInput, ::aws_smithy_types::error::operation::BuildError> {
