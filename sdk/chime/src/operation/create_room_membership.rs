...
impl CreateRoomMembershipInput {
    /// Consumes the builder and constructs an Operation<[`CreateRoomMembership`](crate::operation::create_room_membership::CreateRoomMembership)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_room_membership::CreateRoomMembership, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_room_membership::CreateRoomMembershipInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_room_membership::ser_create_room_membership_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_room_membership::CreateRoomMembership::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateRoomMembership", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRoomMembership {
                type Output = std::result::Result<crate::operation::create_room_membership::CreateRoomMembershipOutput, crate::operation::create_room_membership::CreateRoomMembershipError>;
