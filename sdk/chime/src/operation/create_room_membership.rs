...
impl CreateRoomMembershipInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_room_membership::ser_create_room_membership_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_room_membership::CreateRoomMembership::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_room_membership::CreateRoomMembershipError
{
