...
impl DeleteEventsConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_events_configuration::DeleteEventsConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
