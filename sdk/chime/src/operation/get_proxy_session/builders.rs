...
impl GetProxySessionFluentBuilder  {
    /// Creates a new `GetProxySession`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_proxy_session::GetProxySessionOutput, aws_smithy_http::result::SdkError<crate::operation::get_proxy_session::GetProxySessionError>>
                     {
