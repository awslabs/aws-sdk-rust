...
impl GetAttendeeInput {
    /// Consumes the builder and constructs an Operation<[`GetAttendee`](crate::operation::get_attendee::GetAttendee)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_attendee::GetAttendee, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_attendee::GetAttendeeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_attendee::GetAttendee::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAttendee", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAttendee {
                type Output = std::result::Result<crate::operation::get_attendee::GetAttendeeOutput, crate::operation::get_attendee::GetAttendeeError>;
