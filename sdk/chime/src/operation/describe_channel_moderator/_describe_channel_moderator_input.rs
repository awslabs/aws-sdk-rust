...
impl DescribeChannelModeratorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_channel_moderator::DescribeChannelModeratorInput, ::aws_smithy_types::error::operation::BuildError> {
