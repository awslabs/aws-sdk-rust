...
impl PutVoiceConnectorProxyInput {
    /// Consumes the builder and constructs an Operation<[`PutVoiceConnectorProxy`](crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_voice_connector_proxy::ser_put_voice_connector_proxy_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutVoiceConnectorProxy", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutVoiceConnectorProxy {
                type Output = std::result::Result<crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxyOutput, crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxyError>;
...
impl aws_http::request_id::RequestId for crate::operation::put_voice_connector_proxy::PutVoiceConnectorProxyError {
