...
impl crate::operation::get_voice_connector_group::builders::GetVoiceConnectorGroupInputBuilder {
...
///
/// <p>Retrieves details for the specified Amazon Chime Voice Connector group, such as timestamps,name, and associated <code>VoiceConnectorItems</code>.</p><important>
/// <p><b>This API is is no longer supported and will not be updated.</b> We recommend using the latest version, <a href="https://docs.aws.amazon.com/chime-sdk/latest/APIReference/API_voice-chime_GetVoiceConnectorGroup.html">GetVoiceConnectorGroup</a>, in the Amazon Chime SDK.</p>
...
impl GetVoiceConnectorGroupFluentBuilder {
    /// Creates a new `GetVoiceConnectorGroupFluentBuilder`.
