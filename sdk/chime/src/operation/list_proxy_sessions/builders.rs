...
pub use crate::operation::list_proxy_sessions::_list_proxy_sessions_output::ListProxySessionsOutputBuilder;

pub use crate::operation::list_proxy_sessions::_list_proxy_sessions_input::ListProxySessionsInputBuilder;
...
pub struct ListProxySessionsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_proxy_sessions::builders::ListProxySessionsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_proxy_sessions::ListProxySessionsOutput,
                    crate::operation::list_proxy_sessions::ListProxySessionsError,
                > for ListProxySessionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListProxySessionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_proxy_sessions::ListProxySessionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_proxy_sessions::ListProxySessionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_proxy_sessions::ListProxySessions::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_proxy_sessions::ListProxySessions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_proxy_sessions::ListProxySessionsOutput, crate::operation::list_proxy_sessions::ListProxySessionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_proxy_sessions::paginator::ListProxySessionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
