...
impl UpdateSipMediaApplicationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_sip_media_application::UpdateSipMediaApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSipMediaApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_sip_media_application::de_update_sip_media_application_http_response_with_props(status, headers, body)
        }
    }
