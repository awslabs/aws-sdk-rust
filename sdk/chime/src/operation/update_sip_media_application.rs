...
impl UpdateSipMediaApplicationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSipMediaApplication`](crate::operation::update_sip_media_application::UpdateSipMediaApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_sip_media_application::UpdateSipMediaApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sip_media_application::UpdateSipMediaApplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_sip_media_application::ser_update_sip_media_application_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_sip_media_application::UpdateSipMediaApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSipMediaApplication", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSipMediaApplication {
                type Output = std::result::Result<crate::operation::update_sip_media_application::UpdateSipMediaApplicationOutput, crate::operation::update_sip_media_application::UpdateSipMediaApplicationError>;
