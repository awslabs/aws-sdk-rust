...
/// Orchestration and serialization glue logic for `UpdateSipMediaApplication`.
...
impl UpdateSipMediaApplication {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_sip_media_application::UpdateSipMediaApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_sip_media_application::UpdateSipMediaApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSipMediaApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateSipMediaApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateSipMediaApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateSipMediaApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSipMediaApplication")
...
.with_interceptor(UpdateSipMediaApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationError>::new());
...
#[derive(Debug)]
            struct UpdateSipMediaApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSipMediaApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_sip_media_application::de_update_sip_media_application_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_sip_media_application::de_update_sip_media_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateSipMediaApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSipMediaApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_sip_media_application::UpdateSipMediaApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_sip_media_application::UpdateSipMediaApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_sip_media_application::ser_update_sip_media_application_input(&input)?);
...
#[derive(Debug)]
            struct UpdateSipMediaApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateSipMediaApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateSipMediaApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateSipMediaApplicationInput>()
                        .ok_or("failed to downcast to UpdateSipMediaApplicationInput")?;
...
pub enum UpdateSipMediaApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateSipMediaApplicationError) for what information is available for the error.")]
...
impl UpdateSipMediaApplicationError {
    /// Creates the `UpdateSipMediaApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSipMediaApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateSipMediaApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_sip_media_application::UpdateSipMediaApplicationError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_sip_media_application::_update_sip_media_application_output::UpdateSipMediaApplicationOutput;

pub use crate::operation::update_sip_media_application::_update_sip_media_application_input::UpdateSipMediaApplicationInput;

mod _update_sip_media_application_input;

mod _update_sip_media_application_output;
