...
impl PutEventsConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutEventsConfiguration`](crate::operation::put_events_configuration::PutEventsConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::put_events_configuration::PutEventsConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_events_configuration::PutEventsConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_events_configuration::ser_put_events_configuration_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::put_events_configuration::PutEventsConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("PutEventsConfiguration", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for PutEventsConfiguration {
                type Output = std::result::Result<crate::operation::put_events_configuration::PutEventsConfigurationOutput, crate::operation::put_events_configuration::PutEventsConfigurationError>;
