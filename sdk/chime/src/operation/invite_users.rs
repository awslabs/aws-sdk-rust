...
impl InviteUsersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::invite_users::InviteUsers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for InviteUsers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_invite_users::de_invite_users_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_invite_users::de_invite_users_http_response_with_props(
                status, headers, body,
            )
        }
    }
