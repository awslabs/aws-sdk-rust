...
impl GetSipMediaApplicationInput {
    /// Consumes the builder and constructs an Operation<[`GetSipMediaApplication`](crate::operation::get_sip_media_application::GetSipMediaApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_sip_media_application::GetSipMediaApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_sip_media_application::GetSipMediaApplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_sip_media_application::GetSipMediaApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetSipMediaApplication", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetSipMediaApplication {
                type Output = std::result::Result<crate::operation::get_sip_media_application::GetSipMediaApplicationOutput, crate::operation::get_sip_media_application::GetSipMediaApplicationError>;
