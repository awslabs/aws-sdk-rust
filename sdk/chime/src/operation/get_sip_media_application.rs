...
/// Orchestration and serialization glue logic for `GetSipMediaApplication`.
...
impl GetSipMediaApplication {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_sip_media_application::GetSipMediaApplicationInput,
                    ) -> ::std::result::Result<crate::operation::get_sip_media_application::GetSipMediaApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sip_media_application::GetSipMediaApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_sip_media_application::GetSipMediaApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_sip_media_application::GetSipMediaApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSipMediaApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSipMediaApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSipMediaApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSipMediaApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSipMediaApplication")
...
.with_interceptor(GetSipMediaApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_sip_media_application::GetSipMediaApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_sip_media_application::GetSipMediaApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_sip_media_application::GetSipMediaApplicationError>::new());
...
#[derive(Debug)]
            struct GetSipMediaApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetSipMediaApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_sip_media_application::de_get_sip_media_application_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_sip_media_application::de_get_sip_media_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetSipMediaApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSipMediaApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_sip_media_application::GetSipMediaApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_sip_media_application::GetSipMediaApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetSipMediaApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSipMediaApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetSipMediaApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSipMediaApplicationInput>()
                        .ok_or("failed to downcast to GetSipMediaApplicationInput")?;
...
pub enum GetSipMediaApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSipMediaApplicationError) for what information is available for the error.")]
...
impl GetSipMediaApplicationError {
    /// Creates the `GetSipMediaApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSipMediaApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSipMediaApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_sip_media_application::GetSipMediaApplicationError {
...
mod _get_sip_media_application_output;
