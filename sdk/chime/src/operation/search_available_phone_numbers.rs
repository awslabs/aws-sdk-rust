...
impl SearchAvailablePhoneNumbers {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::search_available_phone_numbers::SearchAvailablePhoneNumbersError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::search_available_phone_numbers::SearchAvailablePhoneNumbersOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime", "SearchAvailablePhoneNumbers", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Chime.SearchAvailablePhoneNumbers",
                "rpc.service" = "Chime",
                "rpc.method" = "SearchAvailablePhoneNumbers",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SearchAvailablePhoneNumbers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SearchAvailablePhoneNumbersRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SearchAvailablePhoneNumbersResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SearchAvailablePhoneNumbers")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SearchAvailablePhoneNumbers")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SearchAvailablePhoneNumbersTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SearchAvailablePhoneNumbersTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SearchAvailablePhoneNumbersTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SearchAvailablePhoneNumbersInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("AreaCode") {
            if let ::std::option::Option::Some(value) = input.area_code.as_deref() {
                captured.insert("AreaCode", value);
            }
        }
        if requested.should_capture("City") {
            if let ::std::option::Option::Some(value) = input.city.as_deref() {
                captured.insert("City", value);
            }
        }
        if requested.should_capture("Country") {
            if let ::std::option::Option::Some(value) = input.country.as_deref() {
                captured.insert("Country", value);
            }
        }
        ...
        if requested.should_capture("TollFreePrefix") {
            if let ::std::option::Option::Some(value) = input.toll_free_prefix.as_deref() {
                captured.insert("TollFreePrefix", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SearchAvailablePhoneNumbersResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_search_available_phone_numbers::de_search_available_phone_numbers_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_search_available_phone_numbers::de_search_available_phone_numbers_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SearchAvailablePhoneNumbersRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::search_available_phone_numbers::SearchAvailablePhoneNumbersInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::search_available_phone_numbers::SearchAvailablePhoneNumbersInput,
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_6) = &_input.phone_number_type {
                    {
                        query.push_kv("phone-number-type", &::aws_smithy_http::query::fmt_string(inner_6.as_str()));
                    }
                }
