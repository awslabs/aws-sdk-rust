...
impl ListMeetingsInput {
    /// Consumes the builder and constructs an Operation<[`ListMeetings`](crate::operation::list_meetings::ListMeetings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_meetings::ListMeetings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_meetings::ListMeetingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/meetings").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_meetings::ListMeetingsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_meetings::ListMeetings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListMeetings", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListMeetings {
                type Output = std::result::Result<crate::operation::list_meetings::ListMeetingsOutput, crate::operation::list_meetings::ListMeetingsError>;
