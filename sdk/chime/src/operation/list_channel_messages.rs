...
/// Orchestration and serialization glue logic for `ListChannelMessages`.
...
impl ListChannelMessages {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_channel_messages::ListChannelMessagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_channel_messages::ListChannelMessagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_channel_messages::ListChannelMessagesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_channel_messages::ListChannelMessagesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelMessages {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListChannelMessages");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListChannelMessagesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListChannelMessagesResponseDeserializer));
...
.with_interceptor(ListChannelMessagesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_channel_messages::ListChannelMessagesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_channel_messages::ListChannelMessagesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_channel_messages::ListChannelMessagesError>::new());
...
#[derive(Debug)]
            struct ListChannelMessagesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChannelMessagesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_channel_messages::de_list_channel_messages_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListChannelMessagesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelMessagesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_channel_messages::ListChannelMessagesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_channel_messages::ListChannelMessagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/channels/{ChannelArn}/messages", ChannelArn = channel_arn).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_channel_messages::ListChannelMessagesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_3) = &_input.not_before {
         {
            query.push_kv("not-before", &::aws_smithy_http::query::fmt_timestamp(inner_3, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_4) = &_input.not_after {
         {
            query.push_kv("not-after", &::aws_smithy_http::query::fmt_timestamp(inner_4, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListChannelMessagesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListChannelMessagesInput>()
                        .ok_or("failed to downcast to ListChannelMessagesInput")?;
...
pub enum ListChannelMessagesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListChannelMessagesError) for what information is available for the error.")]
...
impl ListChannelMessagesError {
    /// Creates the `ListChannelMessagesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListChannelMessagesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListChannelMessagesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_channel_messages::ListChannelMessagesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_channel_messages::_list_channel_messages_output::ListChannelMessagesOutput;

pub use crate::operation::list_channel_messages::_list_channel_messages_input::ListChannelMessagesInput;

mod _list_channel_messages_input;

mod _list_channel_messages_output;
