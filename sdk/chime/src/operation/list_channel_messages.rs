    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_channel_messages::ListChannelMessagesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_channel_messages::ListChannelMessagesOutput>()
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelMessagesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_channel_messages::ListChannelMessagesInput>()
            .expect("correct type");
