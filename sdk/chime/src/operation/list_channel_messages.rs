...
impl ListChannelMessagesInput {
    /// Consumes the builder and constructs an Operation<[`ListChannelMessages`](crate::operation::list_channel_messages::ListChannelMessages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_channel_messages::ListChannelMessages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_channel_messages::ListChannelMessagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_channel_messages::ListChannelMessagesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.sort_order {
                     {
                        query.push_kv("sort-order", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.not_before {
                     {
                        query.push_kv("not-before", &aws_smithy_http::query::fmt_timestamp(inner_3, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_4) = &_input.not_after {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_channel_messages::ListChannelMessages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListChannelMessages", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListChannelMessages {
                type Output = std::result::Result<crate::operation::list_channel_messages::ListChannelMessagesOutput, crate::operation::list_channel_messages::ListChannelMessagesError>;
