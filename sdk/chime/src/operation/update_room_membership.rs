...
impl UpdateRoomMembershipInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRoomMembership`](crate::operation::update_room_membership::UpdateRoomMembership)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_room_membership::UpdateRoomMembership, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_room_membership::UpdateRoomMembershipInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("room_id", "cannot be empty or unset"))?;
                let room_id = aws_smithy_http::label::fmt_string(input_2, aws_smithy_http::label::EncodingStrategy::Default);
                if room_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("room_id", "cannot be empty or unset"))
                            }
                let input_3 = &_input.member_id;
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("member_id", "cannot be empty or unset"))?;
                ...
                write!(output, "/accounts/{AccountId}/rooms/{RoomId}/memberships/{MemberId}", AccountId = account_id, RoomId = room_id, MemberId = member_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_room_membership::ser_update_room_membership_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_room_membership::UpdateRoomMembership::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateRoomMembership", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRoomMembership {
                type Output = std::result::Result<crate::operation::update_room_membership::UpdateRoomMembershipOutput, crate::operation::update_room_membership::UpdateRoomMembershipError>;
