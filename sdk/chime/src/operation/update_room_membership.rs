...
impl UpdateRoomMembershipInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_room_membership::ser_update_room_membership_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_room_membership::UpdateRoomMembership::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_room_membership::UpdateRoomMembershipError
{
