    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAppInstanceStreamingConfigurations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetAppInstanceStreamingConfigurationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetAppInstanceStreamingConfigurationsResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAppInstanceStreamingConfigurationsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_app_instance_streaming_configurations::de_get_app_instance_streaming_configurations_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_app_instance_streaming_configurations::de_get_app_instance_streaming_configurations_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAppInstanceStreamingConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput,
