...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppInstanceStreamingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_app_instance_streaming_configurations::de_get_app_instance_streaming_configurations_http_response_with_props(status, headers, body)
        }
    }
