...
impl GetAppInstanceStreamingConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`GetAppInstanceStreamingConfigurations`](crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurations, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/app-instances/{AppInstanceArn}/streaming-configurations", AppInstanceArn = app_instance_arn).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurations::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetAppInstanceStreamingConfigurations", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetAppInstanceStreamingConfigurations {
                type Output = std::result::Result<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsOutput, crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>;
