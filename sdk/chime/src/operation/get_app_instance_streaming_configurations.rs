...
/// Orchestration and serialization glue logic for `GetAppInstanceStreamingConfigurations`.
...
impl GetAppInstanceStreamingConfigurations {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput,
                    ) -> ::std::result::Result<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAppInstanceStreamingConfigurations {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetAppInstanceStreamingConfigurations");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetAppInstanceStreamingConfigurationsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetAppInstanceStreamingConfigurationsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetAppInstanceStreamingConfigurations")
...
.with_interceptor(GetAppInstanceStreamingConfigurationsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError>::new());
...
#[derive(Debug)]
            struct GetAppInstanceStreamingConfigurationsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAppInstanceStreamingConfigurationsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_app_instance_streaming_configurations::de_get_app_instance_streaming_configurations_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_app_instance_streaming_configurations::de_get_app_instance_streaming_configurations_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetAppInstanceStreamingConfigurationsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAppInstanceStreamingConfigurationsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/app-instances/{AppInstanceArn}/streaming-configurations", AppInstanceArn = app_instance_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetAppInstanceStreamingConfigurationsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetAppInstanceStreamingConfigurationsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetAppInstanceStreamingConfigurationsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetAppInstanceStreamingConfigurationsInput>()
                        .ok_or("failed to downcast to GetAppInstanceStreamingConfigurationsInput")?;
...
pub enum GetAppInstanceStreamingConfigurationsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetAppInstanceStreamingConfigurationsError) for what information is available for the error.")]
...
impl GetAppInstanceStreamingConfigurationsError {
    /// Creates the `GetAppInstanceStreamingConfigurationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAppInstanceStreamingConfigurationsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetAppInstanceStreamingConfigurationsError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetAppInstanceStreamingConfigurationsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_app_instance_streaming_configurations::GetAppInstanceStreamingConfigurationsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_app_instance_streaming_configurations::_get_app_instance_streaming_configurations_output::GetAppInstanceStreamingConfigurationsOutput;

pub use crate::operation::get_app_instance_streaming_configurations::_get_app_instance_streaming_configurations_input::GetAppInstanceStreamingConfigurationsInput;

mod _get_app_instance_streaming_configurations_input;

mod _get_app_instance_streaming_configurations_output;
