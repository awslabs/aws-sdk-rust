...
impl DeleteProxySessionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteProxySession`](crate::operation::delete_proxy_session::DeleteProxySession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_proxy_session::DeleteProxySession, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_proxy_session::DeleteProxySessionInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_proxy_session::DeleteProxySession::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteProxySession", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteProxySession {
                type Output = std::result::Result<crate::operation::delete_proxy_session::DeleteProxySessionOutput, crate::operation::delete_proxy_session::DeleteProxySessionError>;
