...
impl BatchSuspendUserInput {
    /// Consumes the builder and constructs an Operation<[`BatchSuspendUser`](crate::operation::batch_suspend_user::BatchSuspendUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_suspend_user::BatchSuspendUser, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_suspend_user::BatchSuspendUserInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AccountId}/users", AccountId = account_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::batch_suspend_user::BatchSuspendUserInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_suspend_user::ser_batch_suspend_user_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_suspend_user::BatchSuspendUser::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchSuspendUser", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchSuspendUser {
                type Output = std::result::Result<crate::operation::batch_suspend_user::BatchSuspendUserOutput, crate::operation::batch_suspend_user::BatchSuspendUserError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_batch_suspend_user::de_batch_suspend_user_http_error(response)
                     } else {
                        crate::protocol_serde::shape_batch_suspend_user::de_batch_suspend_user_http_response(response)
                     }
                }
            }
