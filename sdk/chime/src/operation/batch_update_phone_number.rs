...
impl BatchUpdatePhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`BatchUpdatePhoneNumber`](crate::operation::batch_update_phone_number::BatchUpdatePhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_update_phone_number::BatchUpdatePhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_update_phone_number::BatchUpdatePhoneNumberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/phone-numbers").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::batch_update_phone_number::BatchUpdatePhoneNumberInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_phone_number::ser_batch_update_phone_number_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_update_phone_number::BatchUpdatePhoneNumber::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchUpdatePhoneNumber", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchUpdatePhoneNumber {
                type Output = std::result::Result<crate::operation::batch_update_phone_number::BatchUpdatePhoneNumberOutput, crate::operation::batch_update_phone_number::BatchUpdatePhoneNumberError>;
