...
impl DisassociatePhoneNumberFromUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUserInput, ::aws_smithy_types::error::operation::BuildError> {
