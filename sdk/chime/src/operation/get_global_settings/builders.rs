...
impl GetGlobalSettingsFluentBuilder  {
    /// Creates a new `GetGlobalSettings`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_global_settings::GetGlobalSettingsOutput, aws_smithy_http::result::SdkError<crate::operation::get_global_settings::GetGlobalSettingsError>>
                     {
