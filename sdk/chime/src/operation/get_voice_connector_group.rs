...
impl GetVoiceConnectorGroupInput {
    /// Consumes the builder and constructs an Operation<[`GetVoiceConnectorGroup`](crate::operation::get_voice_connector_group::GetVoiceConnectorGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_voice_connector_group::GetVoiceConnectorGroup, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_voice_connector_group::GetVoiceConnectorGroupInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_voice_connector_group::GetVoiceConnectorGroup::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetVoiceConnectorGroup", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorGroup {
                type Output = std::result::Result<crate::operation::get_voice_connector_group::GetVoiceConnectorGroupOutput, crate::operation::get_voice_connector_group::GetVoiceConnectorGroupError>;
