...
impl CreateSipMediaApplicationInput {
    /// Consumes the builder and constructs an Operation<[`CreateSipMediaApplication`](crate::operation::create_sip_media_application::CreateSipMediaApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_sip_media_application::CreateSipMediaApplication, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_sip_media_application::CreateSipMediaApplicationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_sip_media_application::ser_create_sip_media_application_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_sip_media_application::CreateSipMediaApplication::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateSipMediaApplication", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateSipMediaApplication {
                type Output = std::result::Result<crate::operation::create_sip_media_application::CreateSipMediaApplicationOutput, crate::operation::create_sip_media_application::CreateSipMediaApplicationError>;
