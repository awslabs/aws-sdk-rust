...
impl CreateSipMediaApplicationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_sip_media_application::CreateSipMediaApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSipMediaApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_sip_media_application::de_create_sip_media_application_http_response_with_props(status, headers, body)
        }
    }
