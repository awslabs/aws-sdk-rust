...
/// Orchestration and serialization glue logic for `CreateSipMediaApplication`.
...
impl CreateSipMediaApplication {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_sip_media_application::CreateSipMediaApplicationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_sip_media_application::CreateSipMediaApplicationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_sip_media_application::CreateSipMediaApplicationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_sip_media_application::CreateSipMediaApplicationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateSipMediaApplication {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateSipMediaApplication");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateSipMediaApplicationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateSipMediaApplicationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateSipMediaApplication")
...
.with_interceptor(CreateSipMediaApplicationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_sip_media_application::CreateSipMediaApplicationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_sip_media_application::CreateSipMediaApplicationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_sip_media_application::CreateSipMediaApplicationError>::new());
...
#[derive(Debug)]
            struct CreateSipMediaApplicationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateSipMediaApplicationResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_create_sip_media_application::de_create_sip_media_application_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_sip_media_application::de_create_sip_media_application_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateSipMediaApplicationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateSipMediaApplicationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_sip_media_application::CreateSipMediaApplicationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_sip_media_application::CreateSipMediaApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/sip-media-applications").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_sip_media_application::ser_create_sip_media_application_input(&input)?);
...
#[derive(Debug)]
            struct CreateSipMediaApplicationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateSipMediaApplicationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateSipMediaApplicationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateSipMediaApplicationInput>()
                        .ok_or("failed to downcast to CreateSipMediaApplicationInput")?;
...
pub enum CreateSipMediaApplicationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateSipMediaApplicationError) for what information is available for the error.")]
...
impl CreateSipMediaApplicationError {
    /// Creates the `CreateSipMediaApplicationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSipMediaApplicationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateSipMediaApplicationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_sip_media_application::CreateSipMediaApplicationError {
...
mod _create_sip_media_application_output;
