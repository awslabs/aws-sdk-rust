...
impl ListUsers {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("chime", "ListUsers", input, runtime_plugins, stop_point).await
    }
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.user_type {
                    {
                        query.push_kv("user-type", &::aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
