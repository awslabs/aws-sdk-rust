...
impl ListUsers {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime", "ListUsers", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListUsers {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListUsers", "Chime"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.user_email {
                    {
                        query.push_kv("user-email", &::aws_smithy_http::query::fmt_string(inner_2));
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.user_type {
                    {
                        query.push_kv("user-type", &::aws_smithy_http::query::fmt_string(inner_3.as_str()));
                    }
                }
