...
impl ListSipMediaApplicationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sip_media_applications::ListSipMediaApplicationsInput, ::aws_smithy_types::error::operation::BuildError> {
