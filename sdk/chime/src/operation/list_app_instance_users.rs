...
impl ListAppInstanceUsersInput {
    /// Consumes the builder and constructs an Operation<[`ListAppInstanceUsers`](crate::operation::list_app_instance_users::ListAppInstanceUsers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_app_instance_users::ListAppInstanceUsers, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_app_instance_users::ListAppInstanceUsersInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/app-instance-users").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_app_instance_users::ListAppInstanceUsersInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.app_instance_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("app_instance_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let endpoint_prefix =
            aws_smithy_http::endpoint::EndpointPrefix::new("identity-")
        ?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_app_instance_users::ListAppInstanceUsers::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAppInstanceUsers", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAppInstanceUsers {
                type Output = std::result::Result<crate::operation::list_app_instance_users::ListAppInstanceUsersOutput, crate::operation::list_app_instance_users::ListAppInstanceUsersError>;
