...
impl ListAppInstanceUsersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_app_instance_users::ListAppInstanceUsers,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAppInstanceUsers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_app_instance_users::de_list_app_instance_users_http_response_with_props(status, headers, body)
        }
    }
