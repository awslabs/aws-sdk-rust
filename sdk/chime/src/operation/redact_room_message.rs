...
impl RedactRoomMessageInput {
    /// Consumes the builder and constructs an Operation<[`RedactRoomMessage`](crate::operation::redact_room_message::RedactRoomMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::redact_room_message::RedactRoomMessage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::redact_room_message::RedactRoomMessageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AccountId}/rooms/{RoomId}/messages/{MessageId}", AccountId = account_id, RoomId = room_id, MessageId = message_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::redact_room_message::RedactRoomMessageInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::redact_room_message::RedactRoomMessage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RedactRoomMessage", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for RedactRoomMessage {
                type Output = std::result::Result<crate::operation::redact_room_message::RedactRoomMessageOutput, crate::operation::redact_room_message::RedactRoomMessageError>;
