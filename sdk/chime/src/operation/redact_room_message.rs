...
impl RedactRoomMessage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::redact_room_message::RedactRoomMessageInput,
                    ) -> ::std::result::Result<crate::operation::redact_room_message::RedactRoomMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::redact_room_message::RedactRoomMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::redact_room_message::RedactRoomMessageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::redact_room_message::RedactRoomMessageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RedactRoomMessage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RedactRoomMessage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RedactRoomMessageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RedactRoomMessageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RedactRoomMessage")
...
.with_interceptor(RedactRoomMessageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::redact_room_message::RedactRoomMessageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::redact_room_message::RedactRoomMessageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::redact_room_message::RedactRoomMessageError>::new());
...
#[derive(Debug)]
            struct RedactRoomMessageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RedactRoomMessageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_redact_room_message::de_redact_room_message_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_redact_room_message::de_redact_room_message_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RedactRoomMessageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RedactRoomMessageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::redact_room_message::RedactRoomMessageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::redact_room_message::RedactRoomMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AccountId}/rooms/{RoomId}/messages/{MessageId}", AccountId = account_id, RoomId = room_id, MessageId = message_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::redact_room_message::RedactRoomMessageInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct RedactRoomMessageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RedactRoomMessageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RedactRoomMessageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RedactRoomMessageInput>()
                        .ok_or("failed to downcast to RedactRoomMessageInput")?;
...
pub enum RedactRoomMessageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RedactRoomMessageError) for what information is available for the error.")]
...
impl RedactRoomMessageError {
    /// Creates the `RedactRoomMessageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RedactRoomMessageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RedactRoomMessageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::redact_room_message::RedactRoomMessageError {
...
mod _redact_room_message_output;
