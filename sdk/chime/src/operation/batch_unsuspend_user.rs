...
impl BatchUnsuspendUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_unsuspend_user::BatchUnsuspendUser,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_unsuspend_user::ser_batch_unsuspend_user_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_unsuspend_user::BatchUnsuspendUser::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_unsuspend_user::BatchUnsuspendUserError
{
