    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_signin_delegate_groups_with_account::AssociateSigninDelegateGroupsWithAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/accounts/{AccountId}", AccountId = account_id)
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSigninDelegateGroupsWithAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_signin_delegate_groups_with_account::de_associate_signin_delegate_groups_with_account_http_response_with_props(status, headers, body)
        }
    }
}
