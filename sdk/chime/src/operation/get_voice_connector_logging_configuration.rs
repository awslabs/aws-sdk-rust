...
impl GetVoiceConnectorLoggingConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetVoiceConnectorLoggingConfiguration`](crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetVoiceConnectorLoggingConfiguration", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorLoggingConfiguration {
    type Output = ::std::result::Result<crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfigurationOutput, crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfigurationError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_connector_logging_configuration::de_get_voice_connector_logging_configuration_http_response_with_props(status, headers, body)
        }
    }
}
