...
impl PutRetentionSettingsInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_retention_settings::ser_put_retention_settings_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_retention_settings::PutRetentionSettings::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::put_retention_settings::PutRetentionSettingsError
{
