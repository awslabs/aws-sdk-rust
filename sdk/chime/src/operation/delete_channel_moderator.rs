...
impl DeleteChannelModerator {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("chime", "DeleteChannelModerator", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteChannelModerator {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteChannelModeratorRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteChannelModeratorResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteChannelModerator", "chime"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteChannelModeratorRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::delete_channel_moderator::DeleteChannelModeratorInput,
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| {
                    ::aws_smithy_types::error::operation::BuildError::missing_field("channel_moderator_arn", "cannot be empty or unset")
                })?;
