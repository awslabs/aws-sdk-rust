...
/// Orchestration and serialization glue logic for `DeleteChannelModerator`.
...
impl DeleteChannelModerator {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_channel_moderator::DeleteChannelModeratorInput,
                    ) -> ::std::result::Result<crate::operation::delete_channel_moderator::DeleteChannelModeratorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_channel_moderator::DeleteChannelModeratorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteChannelModerator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteChannelModerator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteChannelModeratorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteChannelModeratorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteChannelModerator")
...
.with_interceptor(DeleteChannelModeratorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_channel_moderator::DeleteChannelModeratorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_channel_moderator::DeleteChannelModeratorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_channel_moderator::DeleteChannelModeratorError>::new());
...
#[derive(Debug)]
            struct DeleteChannelModeratorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteChannelModeratorResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_channel_moderator::de_delete_channel_moderator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_channel_moderator::de_delete_channel_moderator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteChannelModeratorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteChannelModeratorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_channel_moderator::DeleteChannelModeratorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_channel_moderator::DeleteChannelModeratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.channel_moderator_arn;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("channel_moderator_arn", "cannot be empty or unset"))?;
    let channel_moderator_arn = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if channel_moderator_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("channel_moderator_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/channels/{ChannelArn}/moderators/{ChannelModeratorArn}", ChannelArn = channel_arn, ChannelModeratorArn = channel_moderator_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteChannelModeratorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteChannelModeratorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteChannelModeratorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteChannelModeratorInput>()
                        .ok_or("failed to downcast to DeleteChannelModeratorInput")?;

                    let endpoint_prefix =
    ::aws_smithy_runtime_api::client::endpoint::EndpointPrefix::new("messaging-")
...
pub enum DeleteChannelModeratorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteChannelModeratorError) for what information is available for the error.")]
...
impl DeleteChannelModeratorError {
    /// Creates the `DeleteChannelModeratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteChannelModeratorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteChannelModeratorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_channel_moderator::DeleteChannelModeratorError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_channel_moderator::_delete_channel_moderator_output::DeleteChannelModeratorOutput;

pub use crate::operation::delete_channel_moderator::_delete_channel_moderator_input::DeleteChannelModeratorInput;

mod _delete_channel_moderator_input;

mod _delete_channel_moderator_output;
