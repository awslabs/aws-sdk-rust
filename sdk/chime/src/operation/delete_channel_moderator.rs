...
impl DeleteChannelModeratorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteChannelModerator`](crate::operation::delete_channel_moderator::DeleteChannelModerator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_channel_moderator::DeleteChannelModerator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_channel_moderator::DeleteChannelModeratorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("channel_moderator_arn", "cannot be empty or unset"))?;
        ...
        let endpoint_prefix =
            aws_smithy_http::endpoint::EndpointPrefix::new("messaging-")
        ?;
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_channel_moderator::DeleteChannelModerator::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteChannelModerator", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteChannelModerator {
                type Output = std::result::Result<crate::operation::delete_channel_moderator::DeleteChannelModeratorOutput, crate::operation::delete_channel_moderator::DeleteChannelModeratorError>;
