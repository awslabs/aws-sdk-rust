...
impl GetPhoneNumberSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetPhoneNumberSettings`](crate::operation::get_phone_number_settings::GetPhoneNumberSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_phone_number_settings::GetPhoneNumberSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_phone_number_settings::GetPhoneNumberSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_phone_number_settings::GetPhoneNumberSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPhoneNumberSettings", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPhoneNumberSettings {
                type Output = std::result::Result<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsOutput, crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError>;
