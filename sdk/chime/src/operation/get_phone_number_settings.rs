...
/// Orchestration and serialization glue logic for `GetPhoneNumberSettings`.
...
impl GetPhoneNumberSettings {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_phone_number_settings::GetPhoneNumberSettingsInput,
                    ) -> ::std::result::Result<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPhoneNumberSettings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPhoneNumberSettings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPhoneNumberSettingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPhoneNumberSettingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPhoneNumberSettings")
...
.with_interceptor(GetPhoneNumberSettingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError>::new());
...
#[derive(Debug)]
            struct GetPhoneNumberSettingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPhoneNumberSettingsResponseDeserializer {
...
#[derive(Debug)]
            struct GetPhoneNumberSettingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPhoneNumberSettingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_phone_number_settings::GetPhoneNumberSettingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_phone_number_settings::GetPhoneNumberSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/settings/phone-number").expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetPhoneNumberSettingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPhoneNumberSettingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPhoneNumberSettingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPhoneNumberSettingsInput>()
                        .ok_or("failed to downcast to GetPhoneNumberSettingsInput")?;
...
pub enum GetPhoneNumberSettingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPhoneNumberSettingsError) for what information is available for the error.")]
...
impl GetPhoneNumberSettingsError {
    /// Creates the `GetPhoneNumberSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPhoneNumberSettingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPhoneNumberSettingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_phone_number_settings::GetPhoneNumberSettingsError {
...
mod _get_phone_number_settings_output;
