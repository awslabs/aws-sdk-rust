...
impl ListAttendeeTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListAttendeeTags`](crate::operation::list_attendee_tags::ListAttendeeTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_attendee_tags::ListAttendeeTags, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attendee_tags::ListAttendeeTagsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/meetings/{MeetingId}/attendees/{AttendeeId}/tags", MeetingId = meeting_id, AttendeeId = attendee_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_attendee_tags::ListAttendeeTags::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAttendeeTags", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttendeeTags {
                type Output = std::result::Result<crate::operation::list_attendee_tags::ListAttendeeTagsOutput, crate::operation::list_attendee_tags::ListAttendeeTagsError>;
