...
impl ListAttendeeTagsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_attendee_tags::ListAttendeeTags,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttendeeTags {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_attendee_tags::de_list_attendee_tags_http_response_with_props(status, headers, body)
        }
    }
