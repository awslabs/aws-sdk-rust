...
/// Orchestration and serialization glue logic for `ListAttendeeTags`.
...
impl ListAttendeeTags {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_attendee_tags::ListAttendeeTagsInput,
                    ) -> ::std::result::Result<crate::operation::list_attendee_tags::ListAttendeeTagsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_attendee_tags::ListAttendeeTagsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_attendee_tags::ListAttendeeTagsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_attendee_tags::ListAttendeeTagsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAttendeeTags {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAttendeeTags");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAttendeeTagsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAttendeeTagsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAttendeeTags")
...
.with_interceptor(ListAttendeeTagsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_attendee_tags::ListAttendeeTagsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_attendee_tags::ListAttendeeTagsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_attendee_tags::ListAttendeeTagsError>::new());
...
#[derive(Debug)]
            struct ListAttendeeTagsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAttendeeTagsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_attendee_tags::de_list_attendee_tags_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListAttendeeTagsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAttendeeTagsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_attendee_tags::ListAttendeeTagsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_attendee_tags::ListAttendeeTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/meetings/{MeetingId}/attendees/{AttendeeId}/tags", MeetingId = meeting_id, AttendeeId = attendee_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct ListAttendeeTagsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAttendeeTagsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAttendeeTagsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAttendeeTagsInput>()
                        .ok_or("failed to downcast to ListAttendeeTagsInput")?;
...
pub enum ListAttendeeTagsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAttendeeTagsError) for what information is available for the error.")]
...
impl ListAttendeeTagsError {
    /// Creates the `ListAttendeeTagsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAttendeeTagsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAttendeeTagsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_attendee_tags::ListAttendeeTagsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_attendee_tags::_list_attendee_tags_output::ListAttendeeTagsOutput;

pub use crate::operation::list_attendee_tags::_list_attendee_tags_input::ListAttendeeTagsInput;

mod _list_attendee_tags_input;

mod _list_attendee_tags_output;
