...
impl ListChannelBansInput {
    /// Consumes the builder and constructs an Operation<[`ListChannelBans`](crate::operation::list_channel_bans::ListChannelBans)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_channel_bans::ListChannelBans, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_channel_bans::ListChannelBansInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_channel_bans::ListChannelBansInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_channel_bans::ListChannelBans::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListChannelBans", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListChannelBans {
                type Output = std::result::Result<crate::operation::list_channel_bans::ListChannelBansOutput, crate::operation::list_channel_bans::ListChannelBansError>;
