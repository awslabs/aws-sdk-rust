...
impl DescribeChannelMembershipInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_channel_membership::DescribeChannelMembershipInput, ::aws_smithy_types::error::operation::BuildError> {
