...
impl RestorePhoneNumberFluentBuilder  {
    /// Creates a new `RestorePhoneNumber`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::restore_phone_number::RestorePhoneNumberOutput, aws_smithy_http::result::SdkError<crate::operation::restore_phone_number::RestorePhoneNumberError>>
                     {
