...
impl CreateRoomInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_room::CreateRoom, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_room::ser_create_room_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_room::de_create_room_http_response_with_props(status, headers, body)
        }
    }
