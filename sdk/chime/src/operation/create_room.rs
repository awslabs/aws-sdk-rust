...
impl CreateRoomInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_room::CreateRoom::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRoom {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            crate::protocol_serde::shape_create_room::de_create_room_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_room::de_create_room_http_response_with_props(
                status, headers, body,
            )
        }
    }
