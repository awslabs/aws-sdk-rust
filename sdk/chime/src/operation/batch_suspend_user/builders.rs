...
impl BatchSuspendUserFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_suspend_user::BatchSuspendUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_suspend_user::BatchSuspendUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_suspend_user::BatchSuspendUserOutput, crate::operation::batch_suspend_user::BatchSuspendUserError, Self> {
