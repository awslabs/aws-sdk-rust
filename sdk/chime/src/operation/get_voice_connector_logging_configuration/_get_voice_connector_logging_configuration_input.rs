...
impl GetVoiceConnectorLoggingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_voice_connector_logging_configuration::GetVoiceConnectorLoggingConfigurationInput, ::aws_smithy_types::error::operation::BuildError> {
