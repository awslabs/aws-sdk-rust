...
impl BatchCreateAttendeeInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_create_attendee::ser_batch_create_attendee_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_create_attendee::BatchCreateAttendee::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::batch_create_attendee::BatchCreateAttendeeError
{
