...
/// Orchestration and serialization glue logic for `BatchCreateAttendee`.
...
impl BatchCreateAttendee {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_create_attendee::BatchCreateAttendeeInput,
                    ) -> ::std::result::Result<crate::operation::batch_create_attendee::BatchCreateAttendeeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_create_attendee::BatchCreateAttendeeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_create_attendee::BatchCreateAttendeeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_create_attendee::BatchCreateAttendeeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchCreateAttendee {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchCreateAttendee");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchCreateAttendeeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchCreateAttendeeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCreateAttendee")
...
.with_interceptor(BatchCreateAttendeeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_create_attendee::BatchCreateAttendeeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_create_attendee::BatchCreateAttendeeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_create_attendee::BatchCreateAttendeeError>::new());
...
#[derive(Debug)]
            struct BatchCreateAttendeeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCreateAttendeeResponseDeserializer {
            ...
            let parse_result = if !success && status != 201 || force_error {
                crate::protocol_serde::shape_batch_create_attendee::de_batch_create_attendee_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct BatchCreateAttendeeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchCreateAttendeeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_create_attendee::BatchCreateAttendeeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_create_attendee::BatchCreateAttendeeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::batch_create_attendee::BatchCreateAttendeeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_create_attendee::ser_batch_create_attendee_input(&input)?);
...
#[derive(Debug)]
            struct BatchCreateAttendeeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCreateAttendeeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchCreateAttendeeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchCreateAttendeeInput>()
                        .ok_or("failed to downcast to BatchCreateAttendeeInput")?;
...
pub enum BatchCreateAttendeeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchCreateAttendeeError) for what information is available for the error.")]
...
impl BatchCreateAttendeeError {
    /// Creates the `BatchCreateAttendeeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchCreateAttendeeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchCreateAttendeeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_create_attendee::BatchCreateAttendeeError {
...
mod _batch_create_attendee_output;
