...
impl ::aws_smithy_http::response::ParseStrictResponse for ListChannelsModeratedByAppInstanceUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_channels_moderated_by_app_instance_user::de_list_channels_moderated_by_app_instance_user_http_response_with_props(status, headers, body)
        }
    }
