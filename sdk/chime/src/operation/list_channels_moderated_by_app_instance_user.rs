    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_channels_moderated_by_app_instance_user::ListChannelsModeratedByAppInstanceUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_channels_moderated_by_app_instance_user::ListChannelsModeratedByAppInstanceUserOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListChannelsModeratedByAppInstanceUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListChannelsModeratedByAppInstanceUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListChannelsModeratedByAppInstanceUserResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListChannelsModeratedByAppInstanceUserResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_channels_moderated_by_app_instance_user::de_list_channels_moderated_by_app_instance_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_channels_moderated_by_app_instance_user::de_list_channels_moderated_by_app_instance_user_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListChannelsModeratedByAppInstanceUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_channels_moderated_by_app_instance_user::ListChannelsModeratedByAppInstanceUserInput>()
            .expect("correct type");
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_channels_moderated_by_app_instance_user::ListChannelsModeratedByAppInstanceUserError
{
