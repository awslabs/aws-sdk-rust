...
impl BatchCreateRoomMembershipInput {
    /// Consumes the builder and constructs an Operation<[`BatchCreateRoomMembership`](crate::operation::batch_create_room_membership::BatchCreateRoomMembership)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_create_room_membership::BatchCreateRoomMembership, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::operation::batch_create_room_membership::BatchCreateRoomMembershipInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_create_room_membership::ser_batch_create_room_membership_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_create_room_membership::BatchCreateRoomMembership::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchCreateRoomMembership", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for BatchCreateRoomMembership {
                type Output = std::result::Result<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipOutput, crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError>;
