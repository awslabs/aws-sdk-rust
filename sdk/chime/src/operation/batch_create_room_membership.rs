...
/// Orchestration and serialization glue logic for `BatchCreateRoomMembership`.
...
impl BatchCreateRoomMembership {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchCreateRoomMembership {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchCreateRoomMembership");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchCreateRoomMembershipRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchCreateRoomMembershipResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchCreateRoomMembership")
...
.with_interceptor(BatchCreateRoomMembershipEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError>::new());
...
#[derive(Debug)]
            struct BatchCreateRoomMembershipResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchCreateRoomMembershipResponseDeserializer {
...
#[derive(Debug)]
            struct BatchCreateRoomMembershipRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchCreateRoomMembershipRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_create_room_membership::BatchCreateRoomMembershipInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_create_room_membership::BatchCreateRoomMembershipInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::batch_create_room_membership::BatchCreateRoomMembershipInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_create_room_membership::ser_batch_create_room_membership_input(&input)?);
...
#[derive(Debug)]
            struct BatchCreateRoomMembershipEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchCreateRoomMembershipEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchCreateRoomMembershipEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchCreateRoomMembershipInput>()
                        .ok_or("failed to downcast to BatchCreateRoomMembershipInput")?;
...
pub enum BatchCreateRoomMembershipError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchCreateRoomMembershipError) for what information is available for the error.")]
...
impl BatchCreateRoomMembershipError {
    /// Creates the `BatchCreateRoomMembershipError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchCreateRoomMembershipError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchCreateRoomMembershipError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_create_room_membership::BatchCreateRoomMembershipError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::batch_create_room_membership::_batch_create_room_membership_output::BatchCreateRoomMembershipOutput;

pub use crate::operation::batch_create_room_membership::_batch_create_room_membership_input::BatchCreateRoomMembershipInput;

mod _batch_create_room_membership_input;

mod _batch_create_room_membership_output;
