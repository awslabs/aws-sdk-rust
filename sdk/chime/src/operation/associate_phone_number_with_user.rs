...
impl AssociatePhoneNumberWithUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociatePhoneNumberWithUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_phone_number_with_user::de_associate_phone_number_with_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
