...
impl AssociatePhoneNumberWithUser {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Chime",
            "rpc.method" = "AssociatePhoneNumberWithUser",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociatePhoneNumberWithUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociatePhoneNumberWithUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociatePhoneNumberWithUserResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociatePhoneNumberWithUser")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociatePhoneNumberWithUser")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                AssociatePhoneNumberWithUserTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct AssociatePhoneNumberWithUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AssociatePhoneNumberWithUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<AssociatePhoneNumberWithUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociatePhoneNumberWithUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_phone_number_with_user::de_associate_phone_number_with_user_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_associate_phone_number_with_user::de_associate_phone_number_with_user_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociatePhoneNumberWithUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserInput,
                ...
                ::std::write!(output, "/accounts/{AccountId}/users/{UserId}", AccountId = account_id, UserId = user_id)
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_phone_number_with_user::ser_associate_phone_number_with_user_input(&input)?,
        );
