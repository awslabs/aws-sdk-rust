...
impl DeleteMediaCapturePipelineInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMediaCapturePipeline`](crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipeline, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipelineInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipeline::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteMediaCapturePipeline", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteMediaCapturePipeline {
                type Output = std::result::Result<crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipelineOutput, crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipelineError>;
