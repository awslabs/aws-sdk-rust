...
impl DeleteMediaCapturePipelineInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipeline,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_media_capture_pipeline::DeleteMediaCapturePipeline::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMediaCapturePipeline {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_media_capture_pipeline::de_delete_media_capture_pipeline_http_response_with_props(
                status, headers, body,
            )
        }
    }
