...
impl TagAttendeeInput {
    /// Consumes the builder and constructs an Operation<[`TagAttendee`](crate::operation::tag_attendee::TagAttendee)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_attendee::TagAttendee, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_attendee::TagAttendeeInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::tag_attendee::TagAttendeeInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_attendee::ser_tag_attendee_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_attendee::TagAttendee::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagAttendee", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagAttendee {
                type Output = std::result::Result<crate::operation::tag_attendee::TagAttendeeOutput, crate::operation::tag_attendee::TagAttendeeError>;
