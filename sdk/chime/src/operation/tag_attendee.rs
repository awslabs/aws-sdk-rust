...
impl TagAttendeeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::tag_attendee::TagAttendee::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagAttendee {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_tag_attendee::de_tag_attendee_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_tag_attendee::de_tag_attendee_http_response_with_props(
                status, headers, body,
            )
        }
    }
