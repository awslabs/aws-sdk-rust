...
impl TagAttendeeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_attendee::TagAttendee, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_attendee::ser_tag_attendee_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagAttendee {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_tag_attendee::de_tag_attendee_http_response_with_props(status, headers, body)
        }
    }
}
