...
impl DeleteVoiceConnectorInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_voice_connector::DeleteVoiceConnector,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnector {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_voice_connector::de_delete_voice_connector_http_response_with_props(status, headers, body)
        }
    }
}
