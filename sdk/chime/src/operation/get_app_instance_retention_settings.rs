    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_app_instance_retention_settings::GetAppInstanceRetentionSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_app_instance_retention_settings::GetAppInstanceRetentionSettingsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetAppInstanceRetentionSettings {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetAppInstanceRetentionSettingsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetAppInstanceRetentionSettingsResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetAppInstanceRetentionSettings", "chime"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetAppInstanceRetentionSettingsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_get_app_instance_retention_settings::de_get_app_instance_retention_settings_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetAppInstanceRetentionSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_app_instance_retention_settings::GetAppInstanceRetentionSettingsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::get_app_instance_retention_settings::GetAppInstanceRetentionSettingsInput,
