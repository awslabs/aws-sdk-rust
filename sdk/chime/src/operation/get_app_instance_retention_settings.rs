...
impl GetAppInstanceRetentionSettingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_app_instance_retention_settings::GetAppInstanceRetentionSettings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppInstanceRetentionSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_app_instance_retention_settings::de_get_app_instance_retention_settings_http_response_with_props(
                status, headers, body,
            )
        }
    }
