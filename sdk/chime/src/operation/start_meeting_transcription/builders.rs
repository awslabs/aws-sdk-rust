...
impl StartMeetingTranscriptionFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_meeting_transcription::StartMeetingTranscriptionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_meeting_transcription::StartMeetingTranscriptionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_meeting_transcription::StartMeetingTranscriptionOutput, crate::operation::start_meeting_transcription::StartMeetingTranscriptionError, Self> {
