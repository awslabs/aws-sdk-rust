...
impl UpdateSipMediaApplicationCallInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_sip_media_application_call::UpdateSipMediaApplicationCall::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSipMediaApplicationCall {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_sip_media_application_call::de_update_sip_media_application_call_http_response_with_props(
                status, headers, body,
            )
        }
    }
