    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_sip_media_application_call::UpdateSipMediaApplicationCallError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_sip_media_application_call::UpdateSipMediaApplicationCallOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSipMediaApplicationCall {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateSipMediaApplicationCallRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateSipMediaApplicationCallResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("UpdateSipMediaApplicationCall", "chime"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSipMediaApplicationCallRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_sip_media_application_call::UpdateSipMediaApplicationCallInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::update_sip_media_application_call::UpdateSipMediaApplicationCallInput,
                ...
                let input_2 = input_2
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("transaction_id", "cannot be empty or unset"))?;
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_sip_media_application_call::ser_update_sip_media_application_call_input(&input)?,
        );
