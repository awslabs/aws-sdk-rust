...
impl ValidateE911Address {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::validate_e911_address::ValidateE911AddressOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::validate_e911_address::ValidateE911AddressError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::validate_e911_address::ValidateE911AddressError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::validate_e911_address::ValidateE911AddressOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidateE911Address {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ValidateE911Address");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ValidateE911AddressRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ValidateE911AddressResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ValidateE911Address")
...
.with_interceptor(ValidateE911AddressEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::validate_e911_address::ValidateE911AddressError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::validate_e911_address::ValidateE911AddressError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::validate_e911_address::ValidateE911AddressError>::new());
...
#[derive(Debug)]
            struct ValidateE911AddressResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ValidateE911AddressResponseDeserializer {
            ...
            let parse_result = if !success && status != 202 || force_error {
                crate::protocol_serde::shape_validate_e911_address::de_validate_e911_address_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ValidateE911AddressRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidateE911AddressRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::validate_e911_address::ValidateE911AddressInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::validate_e911_address::ValidateE911AddressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/emergency-calling/address").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_validate_e911_address::ser_validate_e911_address_input(&input)?);
...
#[derive(Debug)]
            struct ValidateE911AddressEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ValidateE911AddressEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ValidateE911AddressEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ValidateE911AddressInput>()
                        .ok_or("failed to downcast to ValidateE911AddressInput")?;
...
pub enum ValidateE911AddressError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ValidateE911AddressError) for what information is available for the error.")]
...
impl ValidateE911AddressError {
    /// Creates the `ValidateE911AddressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ValidateE911AddressError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ValidateE911AddressError {
...
impl ::aws_types::request_id::RequestId for crate::operation::validate_e911_address::ValidateE911AddressError {
