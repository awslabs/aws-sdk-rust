...
impl ValidateE911Address {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::validate_e911_address::ValidateE911AddressError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::validate_e911_address::ValidateE911AddressOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("chime", "ValidateE911Address", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ValidateE911Address {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ValidateE911AddressRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ValidateE911AddressResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ValidateE911Address", "chime"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ValidateE911AddressRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::validate_e911_address::ValidateE911AddressInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::validate_e911_address::ValidateE911AddressInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_validate_e911_address::ser_validate_e911_address_input(
            &input,
        )?);
