    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/emergency-calling/address")
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_validate_e911_address::ser_validate_e911_address_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::validate_e911_address::ValidateE911Address::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::validate_e911_address::ValidateE911AddressError
{
