...
impl ValidateE911AddressInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::validate_e911_address::ValidateE911Address::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ValidateE911Address", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateE911Address {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_validate_e911_address::de_validate_e911_address_http_response_with_props(status, headers, body)
        }
    }
