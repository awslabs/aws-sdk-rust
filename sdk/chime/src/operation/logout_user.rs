...
impl LogoutUserInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::logout_user::LogoutUser,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::logout_user::LogoutUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for LogoutUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_logout_user::de_logout_user_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_logout_user::de_logout_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
