...
impl GetVoiceConnectorProxy {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyInput,
                    ) -> ::std::result::Result<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVoiceConnectorProxy {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetVoiceConnectorProxy");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetVoiceConnectorProxyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetVoiceConnectorProxyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVoiceConnectorProxy")
...
.with_interceptor(GetVoiceConnectorProxyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>::new());
...
#[derive(Debug)]
            struct GetVoiceConnectorProxyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVoiceConnectorProxyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_voice_connector_proxy::de_get_voice_connector_proxy_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetVoiceConnectorProxyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVoiceConnectorProxyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetVoiceConnectorProxyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVoiceConnectorProxyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetVoiceConnectorProxyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetVoiceConnectorProxyInput>()
                        .ok_or("failed to downcast to GetVoiceConnectorProxyInput")?;
...
pub enum GetVoiceConnectorProxyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetVoiceConnectorProxyError) for what information is available for the error.")]
...
impl GetVoiceConnectorProxyError {
    /// Creates the `GetVoiceConnectorProxyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetVoiceConnectorProxyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetVoiceConnectorProxyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_voice_connector_proxy::_get_voice_connector_proxy_output::GetVoiceConnectorProxyOutput;

pub use crate::operation::get_voice_connector_proxy::_get_voice_connector_proxy_input::GetVoiceConnectorProxyInput;

mod _get_voice_connector_proxy_input;

mod _get_voice_connector_proxy_output;
