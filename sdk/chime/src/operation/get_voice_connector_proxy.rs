...
impl GetVoiceConnectorProxyInput {
    /// Consumes the builder and constructs an Operation<[`GetVoiceConnectorProxy`](crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxy::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetVoiceConnectorProxy", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorProxy {
                type Output = std::result::Result<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput, crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>;
