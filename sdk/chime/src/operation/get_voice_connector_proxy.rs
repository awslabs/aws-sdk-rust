...
impl GetVoiceConnectorProxyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorProxy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_connector_proxy::de_get_voice_connector_proxy_http_response_with_props(status, headers, body)
        }
    }
