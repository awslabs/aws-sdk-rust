...
impl UpdateSipRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_sip_rule::UpdateSipRule, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_sip_rule::ser_update_sip_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSipRule {
    type Output =
        ::std::result::Result<crate::operation::update_sip_rule::UpdateSipRuleOutput, crate::operation::update_sip_rule::UpdateSipRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_update_sip_rule::de_update_sip_rule_http_response_with_props(status, headers, body)
        }
    }
}
