...
impl UpdateSipRuleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSipRule`](crate::operation::update_sip_rule::UpdateSipRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_sip_rule::UpdateSipRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sip_rule::UpdateSipRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_sip_rule::ser_update_sip_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_sip_rule::UpdateSipRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSipRule", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSipRule {
                type Output = std::result::Result<crate::operation::update_sip_rule::UpdateSipRuleOutput, crate::operation::update_sip_rule::UpdateSipRuleError>;
