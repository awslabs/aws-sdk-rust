...
impl ListRoomMembershipsInput {
    /// Consumes the builder and constructs an Operation<[`ListRoomMemberships`](crate::operation::list_room_memberships::ListRoomMemberships)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_room_memberships::ListRoomMemberships, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_room_memberships::ListRoomMembershipsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AccountId}/rooms/{RoomId}/memberships", AccountId = account_id, RoomId = room_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_room_memberships::ListRoomMembershipsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_room_memberships::ListRoomMemberships::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListRoomMemberships", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListRoomMemberships {
                type Output = std::result::Result<crate::operation::list_room_memberships::ListRoomMembershipsOutput, crate::operation::list_room_memberships::ListRoomMembershipsError>;
