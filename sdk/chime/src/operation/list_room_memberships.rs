...
impl ListRoomMemberships {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_room_memberships::ListRoomMembershipsInput,
                    ) -> ::std::result::Result<crate::operation::list_room_memberships::ListRoomMembershipsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_room_memberships::ListRoomMembershipsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_room_memberships::ListRoomMembershipsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_room_memberships::ListRoomMembershipsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRoomMemberships {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRoomMemberships");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRoomMembershipsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRoomMembershipsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRoomMemberships")
...
.with_interceptor(ListRoomMembershipsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_room_memberships::ListRoomMembershipsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_room_memberships::ListRoomMembershipsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_room_memberships::ListRoomMembershipsError>::new());
...
#[derive(Debug)]
            struct ListRoomMembershipsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRoomMembershipsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_room_memberships::de_list_room_memberships_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListRoomMembershipsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRoomMembershipsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_room_memberships::ListRoomMembershipsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_room_memberships::ListRoomMembershipsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AccountId}/rooms/{RoomId}/memberships", AccountId = account_id, RoomId = room_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_room_memberships::ListRoomMembershipsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListRoomMembershipsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRoomMembershipsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRoomMembershipsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRoomMembershipsInput>()
                        .ok_or("failed to downcast to ListRoomMembershipsInput")?;
...
pub enum ListRoomMembershipsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRoomMembershipsError) for what information is available for the error.")]
...
impl ListRoomMembershipsError {
    /// Creates the `ListRoomMembershipsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRoomMembershipsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRoomMembershipsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_room_memberships::ListRoomMembershipsError {
...
mod _list_room_memberships_output;
