...
impl DeleteAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_account::DeleteAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_delete_account::de_delete_account_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_account::de_delete_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
