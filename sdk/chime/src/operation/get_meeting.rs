...
impl GetMeetingInput {
    /// Consumes the builder and constructs an Operation<[`GetMeeting`](crate::operation::get_meeting::GetMeeting)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_meeting::GetMeeting, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_meeting::GetMeeting::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMeeting", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMeeting {
    type Output = ::std::result::Result<crate::operation::get_meeting::GetMeetingOutput, crate::operation::get_meeting::GetMeetingError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_meeting::de_get_meeting_http_response_with_props(status, headers, body)
        }
    }
