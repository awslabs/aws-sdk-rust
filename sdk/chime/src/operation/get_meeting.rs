...
impl GetMeetingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_meeting::GetMeeting,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/meetings/{MeetingId}", MeetingId = meeting_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_meeting::GetMeeting::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMeeting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_meeting::de_get_meeting_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_meeting::de_get_meeting_http_response_with_props(
                status, headers, body,
            )
        }
    }
