...
impl DeleteChannelMembershipFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_channel_membership::DeleteChannelMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_channel_membership::DeleteChannelMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_channel_membership::DeleteChannelMembershipOutput, crate::operation::delete_channel_membership::DeleteChannelMembershipError, Self> {
