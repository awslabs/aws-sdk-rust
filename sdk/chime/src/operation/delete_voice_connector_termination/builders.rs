...
pub use crate::operation::delete_voice_connector_termination::_delete_voice_connector_termination_output::DeleteVoiceConnectorTerminationOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput,
                    crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError,
                > for DeleteVoiceConnectorTerminationFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteVoiceConnectorTerminationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTermination::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationOutput, crate::operation::delete_voice_connector_termination::DeleteVoiceConnectorTerminationError, Self> {
