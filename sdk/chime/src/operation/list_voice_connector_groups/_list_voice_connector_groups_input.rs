...
impl ListVoiceConnectorGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_voice_connector_groups::ListVoiceConnectorGroupsInput, ::aws_smithy_types::error::operation::BuildError> {
