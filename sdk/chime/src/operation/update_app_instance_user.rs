...
/// Orchestration and serialization glue logic for `UpdateAppInstanceUser`.
...
impl UpdateAppInstanceUser {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_app_instance_user::UpdateAppInstanceUserOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_app_instance_user::UpdateAppInstanceUserError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_app_instance_user::UpdateAppInstanceUserError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_app_instance_user::UpdateAppInstanceUserOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateAppInstanceUser {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateAppInstanceUser");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateAppInstanceUserRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateAppInstanceUserResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateAppInstanceUser")
...
.with_interceptor(UpdateAppInstanceUserEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_app_instance_user::UpdateAppInstanceUserError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_app_instance_user::UpdateAppInstanceUserError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_app_instance_user::UpdateAppInstanceUserError>::new());
...
#[derive(Debug)]
            struct UpdateAppInstanceUserResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateAppInstanceUserResponseDeserializer {
...
#[derive(Debug)]
            struct UpdateAppInstanceUserRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateAppInstanceUserRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_app_instance_user::UpdateAppInstanceUserInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_app_instance_user::UpdateAppInstanceUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/app-instance-users/{AppInstanceUserArn}", AppInstanceUserArn = app_instance_user_arn).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_app_instance_user::ser_update_app_instance_user_input(&input)?);
...
#[derive(Debug)]
            struct UpdateAppInstanceUserEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateAppInstanceUserEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateAppInstanceUserEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateAppInstanceUserInput>()
                        .ok_or("failed to downcast to UpdateAppInstanceUserInput")?;
...
pub enum UpdateAppInstanceUserError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateAppInstanceUserError) for what information is available for the error.")]
...
impl UpdateAppInstanceUserError {
    /// Creates the `UpdateAppInstanceUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateAppInstanceUserError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateAppInstanceUserError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_app_instance_user::UpdateAppInstanceUserError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::update_app_instance_user::_update_app_instance_user_output::UpdateAppInstanceUserOutput;

pub use crate::operation::update_app_instance_user::_update_app_instance_user_input::UpdateAppInstanceUserInput;

mod _update_app_instance_user_input;

mod _update_app_instance_user_output;
