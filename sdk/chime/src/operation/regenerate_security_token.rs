...
impl RegenerateSecurityToken {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime", "RegenerateSecurityToken", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Chime.RegenerateSecurityToken",
                "rpc.service" = "Chime",
                "rpc.method" = "RegenerateSecurityToken",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegenerateSecurityToken {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RegenerateSecurityTokenRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RegenerateSecurityTokenResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegenerateSecurityToken")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegenerateSecurityToken")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegenerateSecurityTokenTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegenerateSecurityTokenTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegenerateSecurityTokenTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegenerateSecurityTokenInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegenerateSecurityTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_regenerate_security_token::de_regenerate_security_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_regenerate_security_token::de_regenerate_security_token_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegenerateSecurityTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::regenerate_security_token::RegenerateSecurityTokenInput,
                ...
                ::std::write!(output, "/accounts/{AccountId}/bots/{BotId}", AccountId = account_id, BotId = bot_id)
