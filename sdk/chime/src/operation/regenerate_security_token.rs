...
impl RegenerateSecurityTokenInput {
    /// Consumes the builder and constructs an Operation<[`RegenerateSecurityToken`](crate::operation::regenerate_security_token::RegenerateSecurityToken)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::regenerate_security_token::RegenerateSecurityToken, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::regenerate_security_token::RegenerateSecurityTokenInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/accounts/{AccountId}/bots/{BotId}", AccountId = account_id, BotId = bot_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::regenerate_security_token::RegenerateSecurityTokenInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::regenerate_security_token::RegenerateSecurityToken::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RegenerateSecurityToken", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for RegenerateSecurityToken {
                type Output = std::result::Result<crate::operation::regenerate_security_token::RegenerateSecurityTokenOutput, crate::operation::regenerate_security_token::RegenerateSecurityTokenError>;
