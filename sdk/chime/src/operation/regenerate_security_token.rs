...
/// Orchestration and serialization glue logic for `RegenerateSecurityToken`.
...
impl RegenerateSecurityToken {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::regenerate_security_token::RegenerateSecurityTokenInput,
                    ) -> ::std::result::Result<crate::operation::regenerate_security_token::RegenerateSecurityTokenOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::regenerate_security_token::RegenerateSecurityTokenError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RegenerateSecurityToken {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RegenerateSecurityToken");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RegenerateSecurityTokenRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RegenerateSecurityTokenResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegenerateSecurityToken")
...
.with_interceptor(RegenerateSecurityTokenEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::regenerate_security_token::RegenerateSecurityTokenError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::regenerate_security_token::RegenerateSecurityTokenError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::regenerate_security_token::RegenerateSecurityTokenError>::new());
...
#[derive(Debug)]
            struct RegenerateSecurityTokenResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegenerateSecurityTokenResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_regenerate_security_token::de_regenerate_security_token_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RegenerateSecurityTokenRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RegenerateSecurityTokenRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::regenerate_security_token::RegenerateSecurityTokenInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::regenerate_security_token::RegenerateSecurityTokenInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/accounts/{AccountId}/bots/{BotId}", AccountId = account_id, BotId = bot_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::regenerate_security_token::RegenerateSecurityTokenInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct RegenerateSecurityTokenEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegenerateSecurityTokenEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RegenerateSecurityTokenEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RegenerateSecurityTokenInput>()
                        .ok_or("failed to downcast to RegenerateSecurityTokenInput")?;
...
pub enum RegenerateSecurityTokenError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RegenerateSecurityTokenError) for what information is available for the error.")]
...
impl RegenerateSecurityTokenError {
    /// Creates the `RegenerateSecurityTokenError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegenerateSecurityTokenError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RegenerateSecurityTokenError {
...
impl ::aws_types::request_id::RequestId for crate::operation::regenerate_security_token::RegenerateSecurityTokenError {
...
mod _regenerate_security_token_output;
