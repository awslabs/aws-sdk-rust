...
impl UntagMeetingInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::untag_meeting::UntagMeeting,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::untag_meeting::UntagMeeting::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for UntagMeeting {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_untag_meeting::de_untag_meeting_http_error(
                status, headers, body,
            )
        } else {
