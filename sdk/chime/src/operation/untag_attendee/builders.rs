...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::untag_attendee::UntagAttendeeOutput,
                    crate::operation::untag_attendee::UntagAttendeeError,
                > for UntagAttendeeFluentBuilder
            {
                fn send(
                    self,
...
impl UntagAttendeeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::untag_attendee::UntagAttendeeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::untag_attendee::UntagAttendeeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::untag_attendee::UntagAttendee::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::untag_attendee::UntagAttendee::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::untag_attendee::UntagAttendeeOutput, crate::operation::untag_attendee::UntagAttendeeError, Self> {
