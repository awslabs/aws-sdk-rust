...
impl ListRooms {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("chime", "ListRooms", input, runtime_plugins, stop_point).await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRooms {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("ListRooms", "chime"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/accounts/{AccountId}/rooms", AccountId = account_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_rooms::ListRoomsInput,
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.member_id {
                    {
                        query.push_kv("member-id", &::aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
