...
impl ListSupportedPhoneNumberCountriesFluentBuilder {
    ...
    #[doc(hidden)]
                    pub async fn send_middleware(self) -> std::result::Result<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesOutput, aws_smithy_http::result::SdkError<crate::operation::list_supported_phone_number_countries::ListSupportedPhoneNumberCountriesError>>
                     {
        let op = self
            .inner
            .build()
