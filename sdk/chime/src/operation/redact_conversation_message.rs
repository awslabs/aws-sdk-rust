...
/// Orchestration and serialization glue logic for `RedactConversationMessage`.
...
impl RedactConversationMessage {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::redact_conversation_message::RedactConversationMessageInput,
                    ) -> ::std::result::Result<crate::operation::redact_conversation_message::RedactConversationMessageOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::redact_conversation_message::RedactConversationMessageError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::redact_conversation_message::RedactConversationMessageError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::redact_conversation_message::RedactConversationMessageOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RedactConversationMessage {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RedactConversationMessage");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RedactConversationMessageRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RedactConversationMessageResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RedactConversationMessage")
...
.with_interceptor(RedactConversationMessageEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::redact_conversation_message::RedactConversationMessageError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::redact_conversation_message::RedactConversationMessageError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::redact_conversation_message::RedactConversationMessageError>::new());
...
#[derive(Debug)]
            struct RedactConversationMessageResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RedactConversationMessageResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_redact_conversation_message::de_redact_conversation_message_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_redact_conversation_message::de_redact_conversation_message_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RedactConversationMessageRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RedactConversationMessageRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::redact_conversation_message::RedactConversationMessageInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::redact_conversation_message::RedactConversationMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_2 = &_input.conversation_id;
    let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("conversation_id", "cannot be empty or unset"))?;
    let conversation_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
    if conversation_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("conversation_id", "cannot be empty or unset"))
                }
    let input_3 = &_input.message_id;
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("message_id", "cannot be empty or unset"))?;
    let message_id = ::aws_smithy_http::label::fmt_string(input_3, ::aws_smithy_http::label::EncodingStrategy::Default);
    if message_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("message_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/accounts/{AccountId}/conversations/{ConversationId}/messages/{MessageId}", AccountId = account_id, ConversationId = conversation_id, MessageId = message_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::redact_conversation_message::RedactConversationMessageInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct RedactConversationMessageEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RedactConversationMessageEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RedactConversationMessageEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RedactConversationMessageInput>()
                        .ok_or("failed to downcast to RedactConversationMessageInput")?;
...
pub enum RedactConversationMessageError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RedactConversationMessageError) for what information is available for the error.")]
...
impl RedactConversationMessageError {
    /// Creates the `RedactConversationMessageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RedactConversationMessageError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RedactConversationMessageError {
...
impl ::aws_types::request_id::RequestId for crate::operation::redact_conversation_message::RedactConversationMessageError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::redact_conversation_message::_redact_conversation_message_output::RedactConversationMessageOutput;

pub use crate::operation::redact_conversation_message::_redact_conversation_message_input::RedactConversationMessageInput;

mod _redact_conversation_message_input;

mod _redact_conversation_message_output;
