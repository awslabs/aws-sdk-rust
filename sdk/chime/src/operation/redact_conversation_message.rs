...
impl RedactConversationMessageInput {
    /// Consumes the builder and constructs an Operation<[`RedactConversationMessage`](crate::operation::redact_conversation_message::RedactConversationMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::redact_conversation_message::RedactConversationMessage, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::redact_conversation_message::RedactConversationMessageInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("conversation_id", "cannot be empty or unset"))?;
                let conversation_id = aws_smithy_http::label::fmt_string(input_2, aws_smithy_http::label::EncodingStrategy::Default);
                if conversation_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("conversation_id", "cannot be empty or unset"))
                            }
                let input_3 = &_input.message_id;
                let input_3 = input_3.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("message_id", "cannot be empty or unset"))?;
                ...
                write!(output, "/accounts/{AccountId}/conversations/{ConversationId}/messages/{MessageId}", AccountId = account_id, ConversationId = conversation_id, MessageId = message_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::redact_conversation_message::RedactConversationMessageInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::redact_conversation_message::RedactConversationMessage::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RedactConversationMessage", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for RedactConversationMessage {
                type Output = std::result::Result<crate::operation::redact_conversation_message::RedactConversationMessageOutput, crate::operation::redact_conversation_message::RedactConversationMessageError>;
