...
impl RedactConversationMessageInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::redact_conversation_message::RedactConversationMessage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RedactConversationMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_redact_conversation_message::de_redact_conversation_message_http_response_with_props(status, headers, body)
        }
    }
}
