...
impl CreateAccountInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccount`](crate::operation::create_account::CreateAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_account::CreateAccount, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_account::CreateAccountInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_account::ser_create_account_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_account::CreateAccount::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateAccount", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAccount {
                type Output = std::result::Result<crate::operation::create_account::CreateAccountOutput, crate::operation::create_account::CreateAccountError>;
