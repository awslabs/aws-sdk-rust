...
impl crate::operation::delete_app_instance_streaming_configurations::builders::DeleteAppInstanceStreamingConfigurationsInputBuilder {
...
impl DeleteAppInstanceStreamingConfigurationsFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurations::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurations::orchestrate(&runtime_plugins, input)
            .await
    }
