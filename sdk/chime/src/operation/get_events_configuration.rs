...
impl GetEventsConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetEventsConfiguration`](crate::operation::get_events_configuration::GetEventsConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_events_configuration::GetEventsConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_events_configuration::GetEventsConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("bot_id", "cannot be empty or unset"))?;
                ...
                write!(output, "/accounts/{AccountId}/bots/{BotId}/events-configuration", AccountId = account_id, BotId = bot_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_events_configuration::GetEventsConfiguration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetEventsConfiguration", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetEventsConfiguration {
                type Output = std::result::Result<crate::operation::get_events_configuration::GetEventsConfigurationOutput, crate::operation::get_events_configuration::GetEventsConfigurationError>;
