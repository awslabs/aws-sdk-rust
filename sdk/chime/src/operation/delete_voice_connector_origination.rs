...
impl DeleteVoiceConnectorOriginationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOrigination,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorOrigination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_voice_connector_origination::de_delete_voice_connector_origination_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOriginationError
{
