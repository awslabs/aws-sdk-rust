...
impl DeleteVoiceConnectorOriginationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVoiceConnectorOrigination`](crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOrigination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOrigination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOriginationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOrigination::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteVoiceConnectorOrigination", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorOrigination {
                type Output = std::result::Result<crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOriginationOutput, crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOriginationError>;
