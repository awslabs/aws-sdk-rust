...
impl UpdateChannelReadMarkerInput {
    /// Consumes the builder and constructs an Operation<[`UpdateChannelReadMarker`](crate::operation::update_channel_read_marker::UpdateChannelReadMarker)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_channel_read_marker::UpdateChannelReadMarker, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_channel_read_marker::UpdateChannelReadMarkerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_channel_read_marker::UpdateChannelReadMarker::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateChannelReadMarker", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateChannelReadMarker {
                type Output = std::result::Result<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerOutput, crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError>;
