...
/// Orchestration and serialization glue logic for `UpdateChannelReadMarker`.
...
impl UpdateChannelReadMarker {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateChannelReadMarker {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateChannelReadMarker");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateChannelReadMarkerRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateChannelReadMarkerResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateChannelReadMarker")
...
.with_interceptor(UpdateChannelReadMarkerEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError>::new());
...
#[derive(Debug)]
            struct UpdateChannelReadMarkerResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateChannelReadMarkerResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_channel_read_marker::de_update_channel_read_marker_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateChannelReadMarkerRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateChannelReadMarkerRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_channel_read_marker::UpdateChannelReadMarkerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/channels/{ChannelArn}/readMarker", ChannelArn = channel_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct UpdateChannelReadMarkerEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateChannelReadMarkerEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateChannelReadMarkerEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateChannelReadMarkerInput>()
                        .ok_or("failed to downcast to UpdateChannelReadMarkerInput")?;
...
pub enum UpdateChannelReadMarkerError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateChannelReadMarkerError) for what information is available for the error.")]
...
impl UpdateChannelReadMarkerError {
    /// Creates the `UpdateChannelReadMarkerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateChannelReadMarkerError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateChannelReadMarkerError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError {
...
mod _update_channel_read_marker_output;
