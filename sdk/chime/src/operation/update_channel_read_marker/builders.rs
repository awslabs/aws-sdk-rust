...
impl UpdateChannelReadMarkerFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_channel_read_marker::UpdateChannelReadMarkerOutput, crate::operation::update_channel_read_marker::UpdateChannelReadMarkerError, Self> {
