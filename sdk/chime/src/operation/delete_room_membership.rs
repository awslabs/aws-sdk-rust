...
impl DeleteRoomMembershipInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_room_membership::DeleteRoomMembership,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRoomMembership {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_room_membership::de_delete_room_membership_http_response_with_props(status, headers, body)
        }
    }
}
