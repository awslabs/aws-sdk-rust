...
impl GetRetentionSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetRetentionSettings`](crate::operation::get_retention_settings::GetRetentionSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_retention_settings::GetRetentionSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_retention_settings::GetRetentionSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_retention_settings::GetRetentionSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetRetentionSettings", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetRetentionSettings {
                type Output = std::result::Result<crate::operation::get_retention_settings::GetRetentionSettingsOutput, crate::operation::get_retention_settings::GetRetentionSettingsError>;
