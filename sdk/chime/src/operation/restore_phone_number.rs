...
impl RestorePhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`RestorePhoneNumber`](crate::operation::restore_phone_number::RestorePhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::restore_phone_number::RestorePhoneNumber, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_phone_number::RestorePhoneNumberInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::restore_phone_number::RestorePhoneNumberInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::restore_phone_number::RestorePhoneNumber::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("RestorePhoneNumber", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for RestorePhoneNumber {
                type Output = std::result::Result<crate::operation::restore_phone_number::RestorePhoneNumberOutput, crate::operation::restore_phone_number::RestorePhoneNumberError>;
