...
impl GetVoiceConnectorProxyFluentBuilder  {
    /// Creates a new `GetVoiceConnectorProxy`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxy, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput, aws_smithy_http::result::SdkError<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError>>
                     {
