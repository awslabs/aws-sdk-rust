...
impl UpdateAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_account::UpdateAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_account::de_update_account_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_account::de_update_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
