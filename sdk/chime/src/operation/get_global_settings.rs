...
impl GetGlobalSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_global_settings::GetGlobalSettings,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGlobalSettings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_global_settings::de_get_global_settings_http_response_with_props(status, headers, body)
        }
    }
}
