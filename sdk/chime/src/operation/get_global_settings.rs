...
impl GetGlobalSettings {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_global_settings::GetGlobalSettingsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_global_settings::GetGlobalSettingsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Chime", "GetGlobalSettings", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Chime.GetGlobalSettings",
                "rpc.service" = "Chime",
                "rpc.method" = "GetGlobalSettings",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetGlobalSettings")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetGlobalSettingsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_global_settings::de_get_global_settings_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_global_settings::de_get_global_settings_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetGlobalSettingsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_global_settings::GetGlobalSettingsInput>()
            .expect("correct type");
