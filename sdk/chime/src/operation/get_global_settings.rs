...
impl GetGlobalSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetGlobalSettings`](crate::operation::get_global_settings::GetGlobalSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_global_settings::GetGlobalSettings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_global_settings::GetGlobalSettingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_global_settings::GetGlobalSettings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetGlobalSettings", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetGlobalSettings {
                type Output = std::result::Result<crate::operation::get_global_settings::GetGlobalSettingsOutput, crate::operation::get_global_settings::GetGlobalSettingsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_global_settings::de_get_global_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_global_settings::de_get_global_settings_http_response(response)
                     }
                }
            }
