...
impl DisassociatePhoneNumberFromUser {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUserError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUserOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Chime",
            "rpc.method" = "DisassociatePhoneNumberFromUser",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociatePhoneNumberFromUser {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DisassociatePhoneNumberFromUserRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DisassociatePhoneNumberFromUserResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DisassociatePhoneNumberFromUser")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociatePhoneNumberFromUser")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                DisassociatePhoneNumberFromUserTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DisassociatePhoneNumberFromUserTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociatePhoneNumberFromUserTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DisassociatePhoneNumberFromUserInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociatePhoneNumberFromUserResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_disassociate_phone_number_from_user::de_disassociate_phone_number_from_user_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_disassociate_phone_number_from_user::de_disassociate_phone_number_from_user_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociatePhoneNumberFromUserRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUserInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUserInput,
