...
impl DisassociatePhoneNumberFromUserInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_phone_number_from_user::DisassociatePhoneNumberFromUser::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociatePhoneNumberFromUser {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_phone_number_from_user::de_disassociate_phone_number_from_user_http_response_with_props(
                status, headers, body,
            )
        }
    }
