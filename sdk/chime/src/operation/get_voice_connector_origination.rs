...
impl GetVoiceConnectorOrigination {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationInput,
                    ) -> ::std::result::Result<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetVoiceConnectorOrigination {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetVoiceConnectorOrigination");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetVoiceConnectorOriginationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetVoiceConnectorOriginationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetVoiceConnectorOrigination")
...
.with_interceptor(GetVoiceConnectorOriginationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError>::new());
...
#[derive(Debug)]
            struct GetVoiceConnectorOriginationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetVoiceConnectorOriginationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_voice_connector_origination::de_get_voice_connector_origination_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetVoiceConnectorOriginationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetVoiceConnectorOriginationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetVoiceConnectorOriginationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetVoiceConnectorOriginationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetVoiceConnectorOriginationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetVoiceConnectorOriginationInput>()
                        .ok_or("failed to downcast to GetVoiceConnectorOriginationInput")?;
...
pub enum GetVoiceConnectorOriginationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetVoiceConnectorOriginationError) for what information is available for the error.")]
...
impl GetVoiceConnectorOriginationError {
    /// Creates the `GetVoiceConnectorOriginationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetVoiceConnectorOriginationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetVoiceConnectorOriginationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError {
...
mod _get_voice_connector_origination_output;
