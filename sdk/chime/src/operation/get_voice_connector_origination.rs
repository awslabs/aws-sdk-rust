...
impl GetVoiceConnectorOriginationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_voice_connector_origination::GetVoiceConnectorOrigination::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorOrigination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_voice_connector_origination::de_get_voice_connector_origination_http_response_with_props(
                status, headers, body,
            )
        }
    }
