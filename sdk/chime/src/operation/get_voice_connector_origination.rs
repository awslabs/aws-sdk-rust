...
impl GetVoiceConnectorOriginationInput {
    /// Consumes the builder and constructs an Operation<[`GetVoiceConnectorOrigination`](crate::operation::get_voice_connector_origination::GetVoiceConnectorOrigination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_voice_connector_origination::GetVoiceConnectorOrigination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_voice_connector_origination::GetVoiceConnectorOrigination::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetVoiceConnectorOrigination", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorOrigination {
                type Output = std::result::Result<crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationOutput, crate::operation::get_voice_connector_origination::GetVoiceConnectorOriginationError>;
