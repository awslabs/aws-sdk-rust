...
/// Paginator for [`ListAppInstanceUsers`](crate::operation::list_app_instance_users::ListAppInstanceUsers)
pub struct ListAppInstanceUsersPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_app_instance_users::builders::ListAppInstanceUsersInputBuilder,
...
impl ListAppInstanceUsersPaginator {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::list_app_instance_users::ListAppInstanceUsers::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::list_app_instance_users::ListAppInstanceUsers::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_app_instance_users_output_output_next_token(resp);
