...
impl GetRetentionSettingsFluentBuilder  {
    /// Creates a new `GetRetentionSettings`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_retention_settings::GetRetentionSettingsOutput, aws_smithy_http::result::SdkError<crate::operation::get_retention_settings::GetRetentionSettingsError>>
                     {
