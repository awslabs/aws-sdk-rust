...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAppInstanceStreamingConfigurations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_app_instance_streaming_configurations::de_put_app_instance_streaming_configurations_http_response_with_props(status, headers, body)
        }
    }
