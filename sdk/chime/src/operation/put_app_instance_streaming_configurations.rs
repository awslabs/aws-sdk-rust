    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsOutput>()
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutAppInstanceStreamingConfigurations {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutAppInstanceStreamingConfigurationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutAppInstanceStreamingConfigurationsResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutAppInstanceStreamingConfigurationsResponseDeserializer {
    fn deserialize_nonstreaming(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_put_app_instance_streaming_configurations::de_put_app_instance_streaming_configurations_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutAppInstanceStreamingConfigurationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_app_instance_streaming_configurations::ser_put_app_instance_streaming_configurations_input(&input)?,
        );
