...
impl TagMeetingInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::tag_meeting::TagMeeting, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_tag_meeting::ser_tag_meeting_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagMeeting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_tag_meeting::de_tag_meeting_http_response_with_props(status, headers, body)
        }
    }
}
