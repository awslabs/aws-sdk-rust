    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/meetings/{MeetingId}/tags", MeetingId = meeting_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::tag_meeting::TagMeeting::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagMeeting {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            crate::protocol_serde::shape_tag_meeting::de_tag_meeting_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_tag_meeting::de_tag_meeting_http_response_with_props(
                status, headers, body,
            )
        }
    }
