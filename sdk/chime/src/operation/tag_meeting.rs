...
impl TagMeetingInput {
    /// Consumes the builder and constructs an Operation<[`TagMeeting`](crate::operation::tag_meeting::TagMeeting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::tag_meeting::TagMeeting, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_meeting::TagMeetingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/meetings/{MeetingId}/tags", MeetingId = meeting_id).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::tag_meeting::TagMeetingInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_meeting::ser_tag_meeting_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::tag_meeting::TagMeeting::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("TagMeeting", "chime"));
...
impl aws_smithy_http::response::ParseStrictResponse for TagMeeting {
                type Output = std::result::Result<crate::operation::tag_meeting::TagMeetingOutput, crate::operation::tag_meeting::TagMeetingError>;
