...
impl super::Client {
    ...
    ///   - [`sip_rule_id(impl Into<String>)`](crate::operation::get_sip_rule::builders::GetSipRuleFluentBuilder::sip_rule_id) / [`set_sip_rule_id(Option<String>)`](crate::operation::get_sip_rule::builders::GetSipRuleFluentBuilder::set_sip_rule_id):<br>required: **true**<br><p>The SIP rule ID.</p><br>
