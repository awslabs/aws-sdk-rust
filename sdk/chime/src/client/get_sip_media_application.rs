...
impl super::Client {
    ...
    ///   - [`sip_media_application_id(impl ::std::convert::Into<String>)`](crate::operation::get_sip_media_application::builders::GetSipMediaApplicationFluentBuilder::sip_media_application_id) / [`set_sip_media_application_id(Option<String>)`](crate::operation::get_sip_media_application::builders::GetSipMediaApplicationFluentBuilder::set_sip_media_application_id): <p>The SIP media application ID.</p>
