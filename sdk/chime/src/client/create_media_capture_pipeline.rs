...
impl super::Client {
    ...
    ///   - [`source_arn(impl ::std::convert::Into<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::source_arn) / [`set_source_arn(Option<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::set_source_arn): <p>ARN of the source from which the media artifacts are captured.</p>
    ...
    ///   - [`sink_arn(impl ::std::convert::Into<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::sink_arn) / [`set_sink_arn(Option<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::set_sink_arn): <p>The ARN of the sink type.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_media_capture_pipeline::builders::CreateMediaCapturePipelineFluentBuilder::set_client_request_token): <p>The unique identifier for the client request. The token makes the API request idempotent. Use a different token for different media pipeline requests.</p>
