...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_media_capture_pipelines::builders::ListMediaCapturePipelinesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_media_capture_pipelines::builders::ListMediaCapturePipelinesFluentBuilder::set_next_token):<br>required: **false**<br><p>The token used to retrieve the next page of results.</p><br>
