...
impl super::Client {
    ...
    ///   - [`user_id_list(impl Into<String>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::user_id_list) / [`set_user_id_list(Option<Vec<String>>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::set_user_id_list): <p>The request containing the user IDs to suspend.</p>
