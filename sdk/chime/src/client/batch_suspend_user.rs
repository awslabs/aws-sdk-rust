...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::set_account_id):<br>required: **true**<br><p>The Amazon Chime account ID.</p><br>
    ///   - [`user_id_list(impl Into<String>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::user_id_list) / [`set_user_id_list(Option<Vec::<String>>)`](crate::operation::batch_suspend_user::builders::BatchSuspendUserFluentBuilder::set_user_id_list):<br>required: **true**<br><p>The request containing the user IDs to suspend.</p><br>
