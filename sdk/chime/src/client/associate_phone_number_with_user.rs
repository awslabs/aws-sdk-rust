...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::set_user_id): <p>The user ID.</p>
    ///   - [`e164_phone_number(impl ::std::convert::Into<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::e164_phone_number) / [`set_e164_phone_number(Option<String>)`](crate::operation::associate_phone_number_with_user::builders::AssociatePhoneNumberWithUserFluentBuilder::set_e164_phone_number): <p>The phone number, in E.164 format.</p>
