...
impl super::Client {
    ...
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::set_client_request_token): <p>The unique identifier for the client request. Use a different token for different meetings.</p>
    ///   - [`external_meeting_id(impl ::std::convert::Into<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::external_meeting_id) / [`set_external_meeting_id(Option<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::set_external_meeting_id): <p>The external meeting ID.</p>
    ///   - [`meeting_host_id(impl ::std::convert::Into<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::meeting_host_id) / [`set_meeting_host_id(Option<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::set_meeting_host_id): <p>Reserved.</p>
    ///   - [`media_region(impl ::std::convert::Into<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::media_region) / [`set_media_region(Option<String>)`](crate::operation::create_meeting::builders::CreateMeetingFluentBuilder::set_media_region): <p> The Region in which to create the meeting. Default: <code>us-east-1</code>. </p>  <p> Available values: <code>af-south-1</code> , <code>ap-northeast-1</code> , <code>ap-northeast-2</code> , <code>ap-south-1</code> , <code>ap-southeast-1</code> , <code>ap-southeast-2</code> , <code>ca-central-1</code> , <code>eu-central-1</code> , <code>eu-north-1</code> , <code>eu-south-1</code> , <code>eu-west-1</code> , <code>eu-west-2</code> , <code>eu-west-3</code> , <code>sa-east-1</code> , <code>us-east-1</code> , <code>us-east-2</code> , <code>us-west-1</code> , <code>us-west-2</code> . </p>
