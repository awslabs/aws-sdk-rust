...
impl super::Client {
    ...
    ///   - [`app_instance_admin_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_app_instance_admin::builders::DescribeAppInstanceAdminFluentBuilder::app_instance_admin_arn) / [`set_app_instance_admin_arn(Option<String>)`](crate::operation::describe_app_instance_admin::builders::DescribeAppInstanceAdminFluentBuilder::set_app_instance_admin_arn): <p>The ARN of the <code>AppInstanceAdmin</code>.</p>
    ///   - [`app_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_app_instance_admin::builders::DescribeAppInstanceAdminFluentBuilder::app_instance_arn) / [`set_app_instance_arn(Option<String>)`](crate::operation::describe_app_instance_admin::builders::DescribeAppInstanceAdminFluentBuilder::set_app_instance_arn): <p>The ARN of the <code>AppInstance</code>.</p>
