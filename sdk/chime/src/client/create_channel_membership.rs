...
impl super::Client {
    ...
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::create_channel_membership::builders::CreateChannelMembershipFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user that makes the API call.</p>
