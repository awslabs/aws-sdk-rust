...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::batch_update_user::builders::BatchUpdateUserFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::batch_update_user::builders::BatchUpdateUserFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
