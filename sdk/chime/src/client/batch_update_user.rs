...
impl super::Client {
    ...
    ///   - [`update_user_request_items(UpdateUserRequestItem)`](crate::operation::batch_update_user::builders::BatchUpdateUserFluentBuilder::update_user_request_items) / [`set_update_user_request_items(Option<Vec<UpdateUserRequestItem>>)`](crate::operation::batch_update_user::builders::BatchUpdateUserFluentBuilder::set_update_user_request_items): <p>The request containing the user IDs and details to update.</p>
