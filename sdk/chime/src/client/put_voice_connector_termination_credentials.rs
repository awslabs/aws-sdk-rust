...
impl super::Client {
    ...
    ///   - [`credentials(Credential)`](crate::operation::put_voice_connector_termination_credentials::builders::PutVoiceConnectorTerminationCredentialsFluentBuilder::credentials) / [`set_credentials(Option<Vec::<Credential>>)`](crate::operation::put_voice_connector_termination_credentials::builders::PutVoiceConnectorTerminationCredentialsFluentBuilder::set_credentials):<br>required: **false**<br><p>The termination SIP credentials.</p><br>
