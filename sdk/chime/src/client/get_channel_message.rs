...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::set_channel_arn): <p>The ARN of the channel.</p>
    ///   - [`message_id(impl ::std::convert::Into<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::message_id) / [`set_message_id(Option<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::set_message_id): <p>The ID of the message.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::get_channel_message::builders::GetChannelMessageFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user that makes the API call.</p>
