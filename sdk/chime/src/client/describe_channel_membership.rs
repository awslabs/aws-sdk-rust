...
impl super::Client {
    ...
    ///   - [`member_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_channel_membership::builders::DescribeChannelMembershipFluentBuilder::member_arn) / [`set_member_arn(Option<String>)`](crate::operation::describe_channel_membership::builders::DescribeChannelMembershipFluentBuilder::set_member_arn): <p>The ARN of the member.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::describe_channel_membership::builders::DescribeChannelMembershipFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::describe_channel_membership::builders::DescribeChannelMembershipFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user that makes the API call.</p>
