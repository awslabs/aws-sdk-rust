...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl ::std::convert::Into<String>)`](crate::operation::list_proxy_sessions::builders::ListProxySessionsFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::list_proxy_sessions::builders::ListProxySessionsFluentBuilder::set_voice_connector_id): <p>The Amazon Chime voice connector ID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_proxy_sessions::builders::ListProxySessionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_proxy_sessions::builders::ListProxySessionsFluentBuilder::set_next_token): <p>The token to use to retrieve the next page of results.</p>
    ...
    pub fn list_proxy_sessions(
        ...
        crate::operation::list_proxy_sessions::builders::ListProxySessionsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
