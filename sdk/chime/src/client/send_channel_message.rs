...
impl super::Client {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::set_channel_arn): <p>The ARN of the channel.</p>
    ///   - [`content(impl ::std::convert::Into<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::set_content): <p>The content of the message.</p>
    ...
    ///   - [`metadata(impl ::std::convert::Into<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::metadata) / [`set_metadata(Option<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::set_metadata): <p>The optional metadata for each message.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::set_client_request_token): <p>The <code>Idempotency</code> token for each client request.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::send_channel_message::builders::SendChannelMessageFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user that makes the API call.</p>
