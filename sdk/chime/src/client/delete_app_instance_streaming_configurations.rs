...
impl super::Client {
    ...
    pub fn delete_app_instance_streaming_configurations(
        &self,
    ) -> crate::operation::delete_app_instance_streaming_configurations::builders::DeleteAppInstanceStreamingConfigurationsFluentBuilder {
        crate::operation::delete_app_instance_streaming_configurations::builders::DeleteAppInstanceStreamingConfigurationsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
