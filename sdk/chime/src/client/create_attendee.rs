...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::set_tags): <p>The tag key-value pairs.</p>
