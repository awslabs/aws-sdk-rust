...
impl super::Client {
    ...
    ///   - [`meeting_id(impl ::std::convert::Into<String>)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::set_meeting_id): <p>The Amazon Chime SDK meeting ID.</p>
    ///   - [`external_user_id(impl ::std::convert::Into<String>)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::external_user_id) / [`set_external_user_id(Option<String>)`](crate::operation::create_attendee::builders::CreateAttendeeFluentBuilder::set_external_user_id): <p>The Amazon Chime SDK external user ID. An idempotency token. Links the attendee to an identity managed by a builder application.</p>
