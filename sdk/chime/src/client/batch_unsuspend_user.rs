...
impl super::Client {
    ...
    pub fn batch_unsuspend_user(
        &self,
    ) -> crate::operation::batch_unsuspend_user::builders::BatchUnsuspendUserFluentBuilder {
        crate::operation::batch_unsuspend_user::builders::BatchUnsuspendUserFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
