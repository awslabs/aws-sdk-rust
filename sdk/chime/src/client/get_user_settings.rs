...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::get_user_settings::builders::GetUserSettingsFluentBuilder::set_user_id): <p>The user ID.</p>
