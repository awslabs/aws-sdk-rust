...
impl super::Client {
    ...
    ///   - [`meeting_id(impl Into<String>)`](crate::operation::start_meeting_transcription::builders::StartMeetingTranscriptionFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::start_meeting_transcription::builders::StartMeetingTranscriptionFluentBuilder::set_meeting_id):<br>required: **true**<br><p>The unique ID of the meeting being transcribed.</p><br>
    ///   - [`transcription_configuration(TranscriptionConfiguration)`](crate::operation::start_meeting_transcription::builders::StartMeetingTranscriptionFluentBuilder::transcription_configuration) / [`set_transcription_configuration(Option<TranscriptionConfiguration>)`](crate::operation::start_meeting_transcription::builders::StartMeetingTranscriptionFluentBuilder::set_transcription_configuration):<br>required: **true**<br><p>The configuration for the current transcription operation. Must contain <code>EngineTranscribeSettings</code> or <code>EngineTranscribeMedicalSettings</code>.</p><br>
