...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::put_retention_settings::builders::PutRetentionSettingsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::put_retention_settings::builders::PutRetentionSettingsFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
    ...
    pub fn put_retention_settings(
        &self,
    ) -> crate::operation::put_retention_settings::builders::PutRetentionSettingsFluentBuilder {
        crate::operation::put_retention_settings::builders::PutRetentionSettingsFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
