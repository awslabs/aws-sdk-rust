...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::reset_personal_pin::builders::ResetPersonalPINFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::reset_personal_pin::builders::ResetPersonalPINFluentBuilder::set_account_id):<br>required: **true**<br><p>The Amazon Chime account ID.</p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::reset_personal_pin::builders::ResetPersonalPINFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::reset_personal_pin::builders::ResetPersonalPINFluentBuilder::set_user_id):<br>required: **true**<br><p>The user ID.</p><br>
