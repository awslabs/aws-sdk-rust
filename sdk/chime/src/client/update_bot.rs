...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::update_bot::builders::UpdateBotFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::update_bot::builders::UpdateBotFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::update_bot::builders::UpdateBotFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::update_bot::builders::UpdateBotFluentBuilder::set_bot_id): <p>The bot ID.</p>
