...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_app_instances::builders::ListAppInstancesFluentBuilder::set_next_token):<br>required: **false**<br><p>The token passed by previous API requests until you reach the maximum number of <code>AppInstance</code>s.</p><br>
