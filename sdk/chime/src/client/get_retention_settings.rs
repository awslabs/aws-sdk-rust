...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_retention_settings::builders::GetRetentionSettingsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_retention_settings::builders::GetRetentionSettingsFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
