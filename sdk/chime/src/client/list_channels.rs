...
impl super::Client {
    ...
    ///   - [`app_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::app_instance_arn) / [`set_app_instance_arn(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_app_instance_arn): <p>The ARN of the <code>AppInstance</code>.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_next_token): <p>The token passed by previous API calls until all requested channels are returned.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user that makes the API call.</p>
