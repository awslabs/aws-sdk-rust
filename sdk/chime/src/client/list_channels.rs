...
impl super::Client {
    ...
    ///   - [`app_instance_arn(impl Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::app_instance_arn) / [`set_app_instance_arn(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_app_instance_arn):<br>required: **true**<br><p>The ARN of the <code>AppInstance</code>.</p><br>
    ///   - [`privacy(ChannelPrivacy)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::privacy) / [`set_privacy(Option<ChannelPrivacy>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_privacy):<br>required: **false**<br><p>The privacy setting. <code>PUBLIC</code> retrieves all the public channels. <code>PRIVATE</code> retrieves private channels. Only an <code>AppInstanceAdmin</code> can retrieve private channels.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of channels that you want to return.</p><br>
