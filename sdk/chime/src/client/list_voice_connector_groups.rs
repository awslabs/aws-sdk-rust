...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_voice_connector_groups::builders::ListVoiceConnectorGroupsFluentBuilder::set_next_token): <p>The token to use to retrieve the next page of results.</p>
