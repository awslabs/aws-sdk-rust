...
impl super::Client {
    ...
    ///   - [`voice_connector_id(impl ::std::convert::Into<String>)`](crate::operation::list_voice_connector_termination_credentials::builders::ListVoiceConnectorTerminationCredentialsFluentBuilder::voice_connector_id) / [`set_voice_connector_id(Option<String>)`](crate::operation::list_voice_connector_termination_credentials::builders::ListVoiceConnectorTerminationCredentialsFluentBuilder::set_voice_connector_id): <p>The Amazon Chime Voice Connector ID.</p>
    ...
    #[deprecated(note = "Replaced by ListVoiceConnectorTerminationCredentials in the Amazon Chime SDK Voice Namespace")]
