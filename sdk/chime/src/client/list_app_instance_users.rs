...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_app_instance_users::builders::ListAppInstanceUsersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_app_instance_users::builders::ListAppInstanceUsersFluentBuilder::set_next_token): <p>The token passed by previous API calls until all requested users are returned.</p>
    ...
    #[deprecated(note = "Replaced by ListAppInstanceUsers in the Amazon Chime SDK Identity Namespace")]
