...
impl super::Client {
    ...
    ///   - [`voice_connector_group_id(impl Into<String>)`](crate::operation::disassociate_phone_numbers_from_voice_connector_group::builders::DisassociatePhoneNumbersFromVoiceConnectorGroupFluentBuilder::voice_connector_group_id) / [`set_voice_connector_group_id(Option<String>)`](crate::operation::disassociate_phone_numbers_from_voice_connector_group::builders::DisassociatePhoneNumbersFromVoiceConnectorGroupFluentBuilder::set_voice_connector_group_id):<br>required: **true**<br><p>The Amazon Chime Voice Connector group ID.</p><br>
    ///   - [`e164_phone_numbers(impl Into<String>)`](crate::operation::disassociate_phone_numbers_from_voice_connector_group::builders::DisassociatePhoneNumbersFromVoiceConnectorGroupFluentBuilder::e164_phone_numbers) / [`set_e164_phone_numbers(Option<Vec::<String>>)`](crate::operation::disassociate_phone_numbers_from_voice_connector_group::builders::DisassociatePhoneNumbersFromVoiceConnectorGroupFluentBuilder::set_e164_phone_numbers):<br>required: **true**<br><p>List of phone numbers, in E.164 format.</p><br>
    ...
    #[deprecated(note = "Replaced by DisassociatePhoneNumbersFromVoiceConnectorGroup in the Amazon Chime SDK Voice Namespace")]
