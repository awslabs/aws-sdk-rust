...
impl super::Client  {
    ...
    ///   - [`sip_rule_id(impl Into<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::sip_rule_id) / [`set_sip_rule_id(Option<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_sip_rule_id): <p>The SIP rule ID.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_name): <p>The new name for the specified SIP rule.</p>
