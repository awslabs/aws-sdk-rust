...
impl super::Client {
    ...
    ///   - [`disabled(bool)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::disabled) / [`set_disabled(Option<bool>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_disabled):<br>required: **false**<br><p>The new value specified to indicate whether the rule is disabled.</p><br>
    ///   - [`target_applications(SipRuleTargetApplication)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::target_applications) / [`set_target_applications(Option<Vec::<SipRuleTargetApplication>>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_target_applications):<br>required: **false**<br><p>The new value of the list of target applications.</p><br>
