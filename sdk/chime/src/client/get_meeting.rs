...
impl super::Client {
    ...
    ///   - [`meeting_id(impl ::std::convert::Into<String>)`](crate::operation::get_meeting::builders::GetMeetingFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::get_meeting::builders::GetMeetingFluentBuilder::set_meeting_id): <p>The Amazon Chime SDK meeting ID.</p>
