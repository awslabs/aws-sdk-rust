...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_proxy_session::builders::CreateProxySessionFluentBuilder::set_name): <p>The name of the proxy session.</p>
