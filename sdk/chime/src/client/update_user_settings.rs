...
impl super::Client {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::update_user_settings::builders::UpdateUserSettingsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::update_user_settings::builders::UpdateUserSettingsFluentBuilder::set_account_id): <p>The Amazon Chime account ID.</p>
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::update_user_settings::builders::UpdateUserSettingsFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::update_user_settings::builders::UpdateUserSettingsFluentBuilder::set_user_id): <p>The user ID.</p>
