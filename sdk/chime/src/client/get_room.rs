...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::set_account_id):<br>required: **true**<br><p>The Amazon Chime account ID.</p><br>
    ///   - [`room_id(impl Into<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::room_id) / [`set_room_id(Option<String>)`](crate::operation::get_room::builders::GetRoomFluentBuilder::set_room_id):<br>required: **true**<br><p>The room ID.</p><br>
