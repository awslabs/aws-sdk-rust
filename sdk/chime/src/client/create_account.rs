...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_account::builders::CreateAccountFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_account::builders::CreateAccountFluentBuilder::set_name):<br>required: **true**<br><p>The name of the Amazon Chime account.</p><br>
