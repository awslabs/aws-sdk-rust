...
impl super::Client {
    ...
    ///   - [`meeting_id(impl ::std::convert::Into<String>)`](crate::operation::delete_attendee::builders::DeleteAttendeeFluentBuilder::meeting_id) / [`set_meeting_id(Option<String>)`](crate::operation::delete_attendee::builders::DeleteAttendeeFluentBuilder::set_meeting_id): <p>The Amazon Chime SDK meeting ID.</p>
