...
impl super::Client {
    ...
    ///   - [`account_id(impl Into<String>)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::set_account_id):<br>required: **true**<br><p>The Amazon Chime account ID.</p><br>
    ///   - [`room_id(impl Into<String>)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::room_id) / [`set_room_id(Option<String>)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::set_room_id):<br>required: **true**<br><p>The room ID.</p><br>
    ///   - [`membership_item_list(MembershipItem)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::membership_item_list) / [`set_membership_item_list(Option<Vec::<MembershipItem>>)`](crate::operation::batch_create_room_membership::builders::BatchCreateRoomMembershipFluentBuilder::set_membership_item_list):<br>required: **true**<br><p>The list of membership items.</p><br>
