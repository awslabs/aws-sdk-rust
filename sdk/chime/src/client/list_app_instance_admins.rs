...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_app_instance_admins::builders::ListAppInstanceAdminsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_app_instance_admins::builders::ListAppInstanceAdminsFluentBuilder::set_next_token): <p>The token returned from previous API requests until the number of administrators is reached.</p>
    ...
    #[deprecated(
        note = "Replaced by ListAppInstanceAdmins in the Amazon Chime SDK Identity Namespace"
    )]
