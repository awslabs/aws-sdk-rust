...
pub struct GetPhoneNumberSettingsOutput {
    ...
    pub calling_name_updated_timestamp: std::option::Option<smithy_types::Instant>,
}
...
pub mod get_phone_number_settings_output {
    ...
    pub struct Builder {
        ...
        pub(crate) calling_name_updated_timestamp: std::option::Option<smithy_types::Instant>,
    }
    impl Builder {
        /// <p>The default outbound calling name for the account.</p>
        ...
        /// <p>The updated outbound calling name timestamp, in ISO 8601 format.</p>
        pub fn calling_name_updated_timestamp(mut self, input: smithy_types::Instant) -> Self {
