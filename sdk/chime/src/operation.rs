...
impl aws_smithy_http::response::ParseStrictResponse for BatchUnsuspendUser {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_batch_unsuspend_user::de_batch_unsuspend_user_http_error(response)
                     } else {
                        crate::protocol_serde::shape_batch_unsuspend_user::de_batch_unsuspend_user_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for BatchUpdateUser {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_batch_update_user::de_batch_update_user_http_error(response)
                     } else {
                        crate::protocol_serde::shape_batch_update_user::de_batch_update_user_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeletePhoneNumber {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_delete_phone_number::de_delete_phone_number_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_phone_number::de_delete_phone_number_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteProxySession {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_delete_proxy_session::de_delete_proxy_session_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_proxy_session::de_delete_proxy_session_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetPhoneNumber {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        ...
                        crate::protocol_serde::shape_get_phone_number::de_get_phone_number_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAttendeeTags {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_attendee_tags::de_list_attendee_tags_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_attendee_tags::de_list_attendee_tags_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListMeetingTags {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_meeting_tags::de_list_meeting_tags_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_meeting_tags::de_list_meeting_tags_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListPhoneNumbers {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_phone_numbers::de_list_phone_numbers_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_phone_numbers::de_list_phone_numbers_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListRoomMemberships {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_room_memberships::de_list_room_memberships_http_error(response)
                     } else {
...
impl aws_smithy_http::response::ParseStrictResponse for ListVoiceConnectors {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_voice_connectors::de_list_voice_connectors_http_error(response)
                     } else {
...
impl aws_smithy_http::response::ParseStrictResponse for RedactRoomMessage {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_redact_room_message::de_redact_room_message_http_error(response)
                     } else {
                        crate::protocol_serde::shape_redact_room_message::de_redact_room_message_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ResetPersonalPIN {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_reset_personal_pin::de_reset_personal_pin_http_error(response)
                     } else {
                        crate::protocol_serde::shape_reset_personal_pin::de_reset_personal_pin_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateUserSettings {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 204 {
                        crate::protocol_serde::shape_update_user_settings::de_update_user_settings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_user_settings::de_update_user_settings_http_response(response)
                     }
                }
            }
