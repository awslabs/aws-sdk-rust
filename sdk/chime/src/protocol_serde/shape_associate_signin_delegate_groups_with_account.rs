...
pub fn ser_associate_signin_delegate_groups_with_account_input(
    ...
    crate::protocol_serde::shape_associate_signin_delegate_groups_with_account_input::ser_associate_signin_delegate_groups_with_account_input(
        &mut object,
        input,
    )?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_signin_delegate_groups_with_account_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
