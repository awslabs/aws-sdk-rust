...
pub fn de_tag_meeting_http_error(
    ...
    Err(match error_code {
        ...
        "ResourceLimitExceededException" => {
            crate::error::TagMeetingError::ResourceLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ServiceUnavailableException" => {
            crate::error::TagMeetingError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedClientException" => {
            crate::error::TagMeetingError::UnauthorizedClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
