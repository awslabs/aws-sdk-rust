...
pub fn de_list_sip_media_applications_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSipMediaApplicationsOutput, crate::error::ListSipMediaApplicationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListSipMediaApplicationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_sip_media_applications_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListSipMediaApplicationsOutput, crate::error::ListSipMediaApplicationsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_list_sip_media_applications(value: &[u8], mut builder: crate::output::list_sip_media_applications_output::Builder) -> Result<crate::output::list_sip_media_applications_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
