...
pub fn de_list_sip_media_applications_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_sip_media_applications::ListSipMediaApplicationsOutput, crate::operation::list_sip_media_applications::ListSipMediaApplicationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_sip_media_applications::ListSipMediaApplicationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_sip_media_applications_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_sip_media_applications::ListSipMediaApplicationsOutput, crate::operation::list_sip_media_applications::ListSipMediaApplicationsError> {
    Ok({
        #[allow(unused_mut)]
