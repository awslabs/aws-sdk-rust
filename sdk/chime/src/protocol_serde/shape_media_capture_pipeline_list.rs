...
pub(crate) fn de_media_capture_pipeline_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::MediaCapturePipeline>>, aws_smithy_json::deserialize::error::DeserializeError>
