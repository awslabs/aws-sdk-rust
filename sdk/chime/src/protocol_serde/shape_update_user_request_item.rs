...
pub fn ser_update_user_request_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateUserRequestItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
