...
pub(crate) fn de_channel_message<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::ChannelMessage>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Persistence" => {
                                builder = builder.set_persistence(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ChannelMessagePersistenceType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
