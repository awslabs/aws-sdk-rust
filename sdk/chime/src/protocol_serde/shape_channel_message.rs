...
pub(crate) fn de_channel_message<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ChannelMessage>, aws_smithy_json::deserialize::error::DeserializeError>
