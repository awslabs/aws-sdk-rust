...
pub fn de_get_voice_connector_proxy_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput, crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_voice_connector_proxy_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyOutput, crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_voice_connector_proxy::builders::GetVoiceConnectorProxyOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_voice_connector_proxy::de_get_voice_connector_proxy(response.body().as_ref(), output).map_err(crate::operation::get_voice_connector_proxy::GetVoiceConnectorProxyError::unhandled)?;
