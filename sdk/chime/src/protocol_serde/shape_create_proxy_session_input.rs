...
pub fn ser_create_proxy_session_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateProxySessionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
