...
pub fn ser_create_attendee_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAttendeeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
