...
pub fn de_create_channel_ban_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_channel_ban::CreateChannelBanOutput, crate::operation::create_channel_ban::CreateChannelBanError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_channel_ban_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::create_channel_ban::CreateChannelBanOutput, crate::operation::create_channel_ban::CreateChannelBanError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_create_channel_ban_input(input: &crate::operation::create_channel_ban::CreateChannelBanInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
