...
pub fn ser_put_app_instance_streaming_configurations_input(
    ...
    crate::protocol_serde::shape_put_app_instance_streaming_configurations_input::ser_put_app_instance_streaming_configurations_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_put_app_instance_streaming_configurations_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "BadRequestException" => {
            crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::BadRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = crate::protocol_serde::shape_bad_request_exception::de_bad_request_exception_json_err(_response_body, output).map_err(
                        crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::unhandled,
                    )?;
        ...
        "ForbiddenException" => {
            crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::ForbiddenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => {
            crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_app_instance_streaming_configurations_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_app_instance_streaming_configurations::de_put_app_instance_streaming_configurations(
            _response_body,
            output,
        )
        .map_err(crate::operation::put_app_instance_streaming_configurations::PutAppInstanceStreamingConfigurationsError::unhandled)?;
...
pub(crate) fn de_put_app_instance_streaming_configurations(
    value: &[u8],
    mut builder: crate::operation::put_app_instance_streaming_configurations::builders::PutAppInstanceStreamingConfigurationsOutputBuilder,
) -> Result<
    crate::operation::put_app_instance_streaming_configurations::builders::PutAppInstanceStreamingConfigurationsOutputBuilder,
