...
pub fn de_list_sip_rules_http_error(
    ...
    Err(match error_code {
        ...
        "ServiceUnavailableException" => {
            crate::error::ListSipRulesError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "UnauthorizedClientException" => {
            crate::error::ListSipRulesError::UnauthorizedClientException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
pub fn de_list_sip_rules_http_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_list_sip_rules::de_list_sip_rules(
