...
pub fn de_batch_create_channel_membership_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipOutput, crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipError> {
    #[allow(unused_mut)]
...
pub fn ser_batch_create_channel_membership_input(input: &crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_batch_create_channel_membership_input::ser_batch_create_channel_membership_input_input(&mut object, input)?;
    object.finish();
