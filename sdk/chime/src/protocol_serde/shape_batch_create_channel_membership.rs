...
pub fn de_batch_create_channel_membership_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipOutput, crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_create_channel_membership_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipOutput, crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipError> {
    Ok({
        #[allow(unused_mut)]
