...
pub fn ser_update_sip_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateSipRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
