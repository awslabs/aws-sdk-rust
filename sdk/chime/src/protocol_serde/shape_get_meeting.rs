...
pub fn de_get_meeting_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetMeetingOutput, crate::error::GetMeetingError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetMeetingError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "UnauthorizedClientException" => crate::error::GetMeetingError::UnauthorizedClientException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_meeting_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetMeetingOutput, crate::error::GetMeetingError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_meeting_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_meeting::de_get_meeting(response.body().as_ref(), output).map_err(crate::error::GetMeetingError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_meeting(value: &[u8], mut builder: crate::output::get_meeting_output::Builder) -> Result<crate::output::get_meeting_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
