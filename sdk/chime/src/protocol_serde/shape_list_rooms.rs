...
pub fn de_list_rooms_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_rooms::ListRoomsOutput, crate::operation::list_rooms::ListRoomsError> {
    #[allow(unused_mut)]
...
) -> Result<crate::operation::list_rooms::builders::ListRoomsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Rooms" => {
                    builder = builder.set_rooms(crate::protocol_serde::shape_room_list::de_room_list(tokens)?);
                }
