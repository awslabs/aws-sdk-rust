...
pub fn de_list_rooms_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRoomsOutput, crate::error::ListRoomsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ListRoomsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ServiceUnavailableException" => crate::error::ListRoomsError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedClientException" => crate::error::ListRoomsError::UnauthorizedClientException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_rooms_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ListRoomsOutput, crate::error::ListRoomsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::list_rooms_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_rooms::de_list_rooms(response.body().as_ref(), output).map_err(crate::error::ListRoomsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_list_rooms(value: &[u8], mut builder: crate::output::list_rooms_output::Builder) -> Result<crate::output::list_rooms_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
