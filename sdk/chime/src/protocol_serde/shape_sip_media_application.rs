...
pub(crate) fn de_sip_media_application<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SipMediaApplication>, aws_smithy_json::deserialize::error::DeserializeError>
