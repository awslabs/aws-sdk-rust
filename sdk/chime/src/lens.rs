...
pub(crate) fn reflens_structure_crate_output_list_meetings_output_next_token(
    input: &crate::output::ListMeetingsOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
...
pub(crate) fn reflens_structure_crate_output_list_room_memberships_output_next_token(
    input: &crate::output::ListRoomMembershipsOutput,
) -> std::option::Option<&std::string::String> {
    let input = match &input.next_token {
        None => return None,
        Some(t) => t,
