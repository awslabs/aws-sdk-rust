...
impl ::std::convert::From<&str> for ChannelMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ChannelMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ChannelMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ChannelMode::from(s))
    }
}
impl ChannelMode {
...
impl ::std::convert::AsRef<str> for ChannelMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
