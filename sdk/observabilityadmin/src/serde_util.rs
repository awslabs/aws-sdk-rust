...
pub(crate) fn create_dataset_integration_output_output_correct_errors(
...
pub(crate) fn list_dataset_integrations_output_output_correct_errors(
    mut builder: crate::operation::list_dataset_integrations::builders::ListDatasetIntegrationsOutputBuilder,
) -> crate::operation::list_dataset_integrations::builders::ListDatasetIntegrationsOutputBuilder {
    if builder.dataset_integration_summaries.is_none() {
        builder.dataset_integration_summaries = Some(Default::default())
    }
    builder
}
...
pub(crate) fn update_dataset_integration_output_output_correct_errors(
...
pub(crate) fn dataset_integration_summary_correct_errors(
    mut builder: crate::types::builders::DatasetIntegrationSummaryBuilder,
) -> crate::types::builders::DatasetIntegrationSummaryBuilder {
    if builder.arn.is_none() {
        builder.arn = Some(Default::default())
    }
    builder
