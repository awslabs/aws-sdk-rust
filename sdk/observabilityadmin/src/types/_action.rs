...
impl ::std::convert::From<&str> for Action {
    fn from(s: &str) -> Self {
        match s {
            ...
            "COUNT" => Action::Count,
            "EXCLUDED_AS_COUNT" => Action::ExcludedAsCount,
...
impl Action {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Action::Count => "COUNT",
            Action::ExcludedAsCount => "EXCLUDED_AS_COUNT",
...
impl ::std::fmt::Display for Action {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Action::Captcha => write!(f, "CAPTCHA"),
            Action::Challenge => write!(f, "CHALLENGE"),
            Action::Count => write!(f, "COUNT"),
            Action::ExcludedAsCount => write!(f, "EXCLUDED_AS_COUNT"),
