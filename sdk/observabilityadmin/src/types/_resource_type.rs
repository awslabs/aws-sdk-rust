...
///     ResourceType::AwsOtelEnrichment => { /* ... */ },
...
impl ::std::convert::From<&str> for ResourceType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "AWS::CloudWatch::OTelEnrichment" => ResourceType::AwsOtelEnrichment,
...
impl ResourceType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ResourceType::AwsOtelEnrichment => "AWS::CloudWatch::OTelEnrichment",
...
impl ::std::fmt::Display for ResourceType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ResourceType::AwsOtelEnrichment => write!(f, "AWS::CloudWatch::OTelEnrichment"),
