...
pub fn de_stop_telemetry_evaluation_for_organization_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::stop_telemetry_evaluation_for_organization::StopTelemetryEvaluationForOrganizationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::stop_telemetry_evaluation_for_organization::StopTelemetryEvaluationForOrganizationError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
                        ...
                        match crate::protocol_serde::shape_access_denied_exception::de_amzn_error_type_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::stop_telemetry_evaluation_for_organization::StopTelemetryEvaluationForOrganizationError::unhandled("Failed to parse amznErrorType from header `x-amzn-ErrorType`"));
                                                }
                                            }
                                        }
                    );
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::stop_telemetry_evaluation_for_organization::StopTelemetryEvaluationForOrganizationError::unhandled("Failed to parse retryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        _ => crate::operation::stop_telemetry_evaluation_for_organization::StopTelemetryEvaluationForOrganizationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_telemetry_evaluation_for_organization_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
