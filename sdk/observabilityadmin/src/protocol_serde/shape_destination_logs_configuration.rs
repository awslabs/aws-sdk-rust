                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "LogsEncryptionConfiguration" => {
                            builder = builder.set_logs_encryption_configuration(
                                crate::protocol_serde::shape_logs_encryption_configuration::de_logs_encryption_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "BackupConfiguration" => {
                            builder = builder.set_backup_configuration(
                                crate::protocol_serde::shape_logs_backup_configuration::de_logs_backup_configuration(tokens, _value, depth + 1)?,
                            );
                        }
