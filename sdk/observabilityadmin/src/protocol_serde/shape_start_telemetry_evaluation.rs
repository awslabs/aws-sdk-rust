...
pub fn de_start_telemetry_evaluation_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_telemetry_evaluation::StartTelemetryEvaluationError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => crate::operation::start_telemetry_evaluation::StartTelemetryEvaluationError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                ...
                output = output.set_amzn_error_type(
                    crate::protocol_serde::shape_access_denied_exception::de_amzn_error_type_header(_response_headers).map_err(|_| {
                        crate::operation::start_telemetry_evaluation::StartTelemetryEvaluationError::unhandled(
        ...
        "InternalServerException" => crate::operation::start_telemetry_evaluation::StartTelemetryEvaluationError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::start_telemetry_evaluation::StartTelemetryEvaluationError::generic(generic),
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_start_telemetry_evaluation_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::start_telemetry_evaluation::builders::StartTelemetryEvaluationOutputBuilder::default();
