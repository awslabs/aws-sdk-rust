...
pub fn ser_centralization_rule_destination(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::CentralizationRuleDestination,
    ...
    if let Some(var_2) = &input.destination_logs_configuration {
        #[allow(unused_mut)]
        let mut object_3 = object.key("DestinationLogsConfiguration").start_object();
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::CentralizationRuleDestinationBuilder::default();
            loop {
                match tokens.next().transpose()? {
            ...
            Ok(Some(
                crate::serde_util::centralization_rule_destination_correct_errors(builder)
                    .build()
