...
impl aws_smithy_http::response::ParseStrictResponse for ApplyArchiveRule {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_apply_archive_rule::de_apply_archive_rule_http_error(response)
                     } else {
                        crate::protocol_serde::shape_apply_archive_rule::de_apply_archive_rule_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CancelPolicyGeneration {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_policy_generation::de_cancel_policy_generation_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_policy_generation::de_cancel_policy_generation_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAccessPreview {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_access_preview::de_create_access_preview_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_access_preview::de_create_access_preview_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAnalyzer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_analyzer::de_create_analyzer_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_analyzer::de_create_analyzer_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateArchiveRule {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_archive_rule::de_create_archive_rule_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_archive_rule::de_create_archive_rule_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAnalyzer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_analyzer::de_delete_analyzer_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_analyzer::de_delete_analyzer_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccessPreview {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_access_preview::de_get_access_preview_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_access_preview::de_get_access_preview_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetAnalyzedResource {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_analyzed_resource::de_get_analyzed_resource_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_analyzed_resource::de_get_analyzed_resource_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetAnalyzer {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_analyzer::de_get_analyzer_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_analyzer::de_get_analyzer_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetArchiveRule {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_archive_rule::de_get_archive_rule_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_archive_rule::de_get_archive_rule_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetFinding {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_finding::de_get_finding_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_finding::de_get_finding_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetGeneratedPolicy {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_generated_policy::de_get_generated_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_generated_policy::de_get_generated_policy_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessPreviewFindings {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_access_preview_findings::de_list_access_preview_findings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_access_preview_findings::de_list_access_preview_findings_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessPreviews {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_access_previews::de_list_access_previews_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_access_previews::de_list_access_previews_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAnalyzedResources {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_analyzed_resources::de_list_analyzed_resources_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_analyzed_resources::de_list_analyzed_resources_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListAnalyzers {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_analyzers::de_list_analyzers_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_analyzers::de_list_analyzers_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ListPolicyGenerations {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_policy_generations::de_list_policy_generations_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_policy_generations::de_list_policy_generations_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StartPolicyGeneration {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_policy_generation::de_start_policy_generation_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_policy_generation::de_start_policy_generation_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for StartResourceScan {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_start_resource_scan::de_start_resource_scan_http_error(response)
                     } else {
                        crate::protocol_serde::shape_start_resource_scan::de_start_resource_scan_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateArchiveRule {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_archive_rule::de_update_archive_rule_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_archive_rule::de_update_archive_rule_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateFindings {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_findings::de_update_findings_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_findings::de_update_findings_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for ValidatePolicy {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_validate_policy::de_validate_policy_http_error(response)
                     } else {
                        crate::protocol_serde::shape_validate_policy::de_validate_policy_http_response(response)
                     }
                }
            }
