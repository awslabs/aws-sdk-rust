...
pub struct AnalyzerSummary  {
    ...
    #[doc(hidden)]pub last_resource_analyzed: std::option::Option<std::string::String>,
    /// <p>The time at which the most recently analyzed resource was analyzed.</p>
    #[doc(hidden)]pub last_resource_analyzed_at: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AnalyzerStatus>,
    ...
    #[doc(hidden)]pub status_reason: std::option::Option<crate::model::StatusReason>,
}
...
pub struct StatusReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::ReasonCode>,
}
impl StatusReason {
    /// <p>The reason code for the current status of the analyzer.</p>
...
pub struct Criterion  {
    ...
    #[doc(hidden)]pub contains: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ValidatePolicyFinding  {
    ...
    #[doc(hidden)]pub finding_details: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub finding_type: std::option::Option<crate::model::ValidatePolicyFindingType>,
    /// <p>The issue code provides an identifier of the issue associated with this finding.</p>
    #[doc(hidden)]pub issue_code: std::option::Option<std::string::String>,
    /// <p>A link to additional documentation about the type of finding.</p>
    #[doc(hidden)]pub learn_more_link: std::option::Option<std::string::String>,
...
pub struct Location  {
    ...
    #[doc(hidden)]pub path: std::option::Option<std::vec::Vec<crate::model::PathElement>>,
    /// <p>A span in a policy.</p>
    #[doc(hidden)]pub span: std::option::Option<crate::model::Span>,
}
impl Location {
    /// <p>A path in a policy, represented as a sequence of path elements.</p>
...
pub struct Span  {
    ...
    #[doc(hidden)]pub start: std::option::Option<crate::model::Position>,
    /// <p>The end position of the span (exclusive).</p>
    #[doc(hidden)]pub end: std::option::Option<crate::model::Position>,
}
impl Span {
    /// <p>The start position of the span (inclusive).</p>
...
pub struct Position  {
    ...
    #[doc(hidden)]pub line: std::option::Option<i32>,
    /// <p>The column of the position, starting from 0.</p>
    #[doc(hidden)]pub column: std::option::Option<i32>,
...
pub struct Substring  {
    ...
    #[doc(hidden)]pub start: std::option::Option<i32>,
    /// <p>The length of the substring.</p>
    #[doc(hidden)]pub length: std::option::Option<i32>,
}
impl Substring {
    /// <p>The start index of the substring, starting from 0.</p>
...
pub struct CloudTrailDetails  {
    ...
    #[doc(hidden)]pub trails: std::option::Option<std::vec::Vec<crate::model::Trail>>,
...
pub struct Trail  {
    ...
    #[doc(hidden)]pub cloud_trail_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub all_regions: std::option::Option<bool>,
}
impl Trail {
    /// <p>Specifies the ARN of the trail. The format of a trail ARN is <code>arn:aws:cloudtrail:us-east-2:123456789012:trail/MyTrail</code>.</p>
...
pub struct FindingSummary  {
    ...
    #[doc(hidden)]pub principal: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The action in the analyzed policy statement that an external principal has permission to use.</p>
    #[doc(hidden)]pub action: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub is_public: std::option::Option<bool>,
    /// <p>The type of the resource that the external principal has access to.</p>
    #[doc(hidden)]pub resource_type: std::option::Option<crate::model::ResourceType>,
    /// <p>The condition in the analyzed policy statement that resulted in a finding.</p>
    #[doc(hidden)]pub condition: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The time at which the finding was created.</p>
    #[doc(hidden)]pub created_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time at which the resource-based policy that generated the finding was analyzed.</p>
    #[doc(hidden)]pub analyzed_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The time at which the finding was most recently updated.</p>
    #[doc(hidden)]pub updated_at: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The status of the finding.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::FindingStatus>,
    /// <p>The Amazon Web Services account ID that owns the resource.</p>
    #[doc(hidden)]pub resource_owner_account: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub sources: std::option::Option<std::vec::Vec<crate::model::FindingSource>>,
}
impl FindingSummary {
    /// <p>The ID of the finding.</p>
...
pub struct FindingSource  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::FindingSourceType>,
    ...
    #[doc(hidden)]pub detail: std::option::Option<crate::model::FindingSourceDetail>,
}
impl FindingSource {
    /// <p>Indicates the type of access that generated the finding.</p>
...
pub struct AccessPreviewSummary  {
    ...
    /// </ul>
    #[doc(hidden)]pub status: std::option::Option<crate::model::AccessPreviewStatus>,
    ...
    #[doc(hidden)]pub status_reason: std::option::Option<crate::model::AccessPreviewStatusReason>,
}
...
pub struct AccessPreviewStatusReason  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::AccessPreviewStatusReasonCode>,
}
...
pub struct AccessPreviewFinding  {
    ...
    #[doc(hidden)]pub existing_finding_id: std::option::Option<std::string::String>,
    /// <p>The existing status of the finding, provided only for existing findings.</p>
    #[doc(hidden)]pub existing_finding_status: std::option::Option<crate::model::FindingStatus>,
    /// <p>The external principal that has access to a resource within the zone of trust.</p>
    #[doc(hidden)]pub principal: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub change_type: std::option::Option<crate::model::FindingChangeType>,
...
pub struct GeneratedPolicyResult  {
    ...
    #[doc(hidden)]pub properties: std::option::Option<crate::model::GeneratedPolicyProperties>,
    ...
    #[doc(hidden)]pub generated_policies: std::option::Option<std::vec::Vec<crate::model::GeneratedPolicy>>,
}
...
pub struct GeneratedPolicyProperties  {
    ...
    #[doc(hidden)]pub is_complete: std::option::Option<bool>,
    /// <p>The ARN of the IAM entity (user or role) for which you are generating a policy.</p>
    #[doc(hidden)]pub principal_arn: std::option::Option<std::string::String>,
    /// <p>Lists details about the <code>Trail</code> used to generated policy.</p>
    #[doc(hidden)]pub cloud_trail_properties: std::option::Option<crate::model::CloudTrailProperties>,
}
...
pub struct CloudTrailProperties  {
    ...
    #[doc(hidden)]pub trail_properties: std::option::Option<std::vec::Vec<crate::model::TrailProperties>>,
    /// <p>The start of the time range for which IAM Access Analyzer reviews your CloudTrail events. Events with a timestamp before this time are not considered to generate a policy.</p>
    #[doc(hidden)]pub start_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The end of the time range for which IAM Access Analyzer reviews your CloudTrail events. Events with a timestamp after this time are not considered to generate a policy. If this is not included in the request, the default value is the current time.</p>
    #[doc(hidden)]pub end_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct JobDetails  {
    ...
    #[doc(hidden)]pub job_error: std::option::Option<crate::model::JobError>,
}
impl JobDetails {
    /// <p>The <code>JobId</code> that is returned by the <code>StartPolicyGeneration</code> operation. The <code>JobId</code> can be used with <code>GetGeneratedPolicy</code> to retrieve the generated policies or used with <code>CancelPolicyGeneration</code> to cancel the policy generation request.</p>
    pub fn job_id(&self) -> std::option::Option<& str> {
...
pub struct JobError  {
    ...
    #[doc(hidden)]pub code: std::option::Option<crate::model::JobErrorCode>,
...
pub struct AnalyzedResource  {
    ...
    #[doc(hidden)]pub shared_via: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct SqsQueueConfiguration  {
    ...
    #[doc(hidden)]pub queue_policy: std::option::Option<std::string::String>,
}
...
pub struct S3BucketConfiguration  {
    ...
    #[doc(hidden)]pub bucket_policy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub bucket_acl_grants: std::option::Option<std::vec::Vec<crate::model::S3BucketAclGrantConfiguration>>,
    /// <p>The proposed block public access configuration for the Amazon S3 bucket.</p>
    #[doc(hidden)]pub bucket_public_access_block: std::option::Option<crate::model::S3PublicAccessBlockConfiguration>,
    ...
    #[doc(hidden)]pub access_points: std::option::Option<std::collections::HashMap<std::string::String, crate::model::S3AccessPointConfiguration>>,
}
...
impl  std::fmt::Debug for S3BucketConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("bucket_public_access_block", &self.bucket_public_access_block);
...
pub struct S3AccessPointConfiguration  {
    ...
    #[doc(hidden)]pub access_point_policy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub public_access_block: std::option::Option<crate::model::S3PublicAccessBlockConfiguration>,
    ...
    #[doc(hidden)]pub network_origin: std::option::Option<crate::model::NetworkOriginConfiguration>,
}
...
pub struct S3PublicAccessBlockConfiguration  {
    ...
    #[doc(hidden)]pub ignore_public_acls: std::option::Option<bool>,
    /// <p> Specifies whether Amazon S3 should restrict public bucket policies for this bucket. </p>
    #[doc(hidden)]pub restrict_public_buckets: std::option::Option<bool>,
}
...
pub struct S3BucketAclGrantConfiguration  {
    ...
    #[doc(hidden)]pub permission: std::option::Option<crate::model::AclPermission>,
    /// <p>The grantee to whom you’re assigning access rights.</p>
    #[doc(hidden)]pub grantee: std::option::Option<crate::model::AclGrantee>,
}
...
pub struct SecretsManagerSecretConfiguration  {
    ...
    #[doc(hidden)]pub secret_policy: std::option::Option<std::string::String>,
}
...
pub struct KmsKeyConfiguration  {
    ...
    #[doc(hidden)]pub key_policies: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub grants: std::option::Option<std::vec::Vec<crate::model::KmsGrantConfiguration>>,
}
...
pub struct KmsGrantConfiguration  {
    ...
    #[doc(hidden)]pub operations: std::option::Option<std::vec::Vec<crate::model::KmsGrantOperation>>,
    ...
    #[doc(hidden)]pub constraints: std::option::Option<crate::model::KmsGrantConstraints>,
...
pub struct IamRoleConfiguration  {
    ...
    #[doc(hidden)]pub trust_policy: std::option::Option<std::string::String>,
}
