...
impl ApplyArchiveRuleInput {
    ...
    > {
        Ok({
            ...
            let body = crate::operation_ser::serialize_operation_apply_archive_rule(&self)
                .map_err(|err| {
...
impl CreateAccessPreviewInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_access_preview(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl CreateAnalyzerInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_analyzer(&self).map_err(
...
impl CreateArchiveRuleInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_create_archive_rule(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_2 = &self.analyzer_name;
        let input_2 = input_2
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_2, false);
...
impl DeleteAnalyzerInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_3 = &self.analyzer_name;
        let input_3 = input_3
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_3, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
...
impl DeleteArchiveRuleInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_5 = &self.analyzer_name;
        let input_5 = input_5
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_5, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
        ...
        let rule_name = smithy_http::label::fmt_string(input_6, false);
...
impl GetAccessPreviewInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_8 = &self.access_preview_id;
        let input_8 = input_8
            .as_ref()
            .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let access_preview_id = smithy_http::label::fmt_string(input_8, false);
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_9) = &self.analyzer_arn {
            query.push_kv("analyzerArn", &smithy_http::query::fmt_string(&inner_9));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetAnalyzedResourceInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_10) = &self.analyzer_arn {
            query.push_kv("analyzerArn", &smithy_http::query::fmt_string(&inner_10));
        }
...
pub mod get_analyzer_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::GetAnalyzerInput, smithy_http::operation::BuildError>
        {
...
impl GetAnalyzerInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_12 = &self.analyzer_name;
        let input_12 =
            input_12
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_12, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
...
impl GetArchiveRuleInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_13 = &self.analyzer_name;
        let input_13 =
            input_13
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_13, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
        ...
        let rule_name = smithy_http::label::fmt_string(input_14, false);
        if rule_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "rule_name",
                details: "cannot be empty or unset",
...
pub mod get_finding_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::GetFindingInput, smithy_http::operation::BuildError>
        {
...
impl GetFindingInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_16) = &self.analyzer_arn {
            query.push_kv("analyzerArn", &smithy_http::query::fmt_string(&inner_16));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl GetGeneratedPolicyInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        ...
        let job_id = smithy_http::label::fmt_string(input_17, false);
        if job_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "job_id",
                details: "cannot be empty or unset",
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_18) = &self.include_resource_placeholders {
            query.push_kv(
                "includeResourcePlaceholders",
                &smithy_types::primitive::Encoder::from(*inner_18).encode(),
            );
        }
        if let Some(inner_19) = &self.include_service_level_template {
            query.push_kv(
...
impl ListAccessPreviewFindingsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_list_access_preview_findings(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_20 = &self.access_preview_id;
        let input_20 =
            input_20
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let access_preview_id = smithy_http::label::fmt_string(input_20, false);
        if access_preview_id.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "access_preview_id",
                details: "cannot be empty or unset",
...
impl ListAccessPreviewsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_21) = &self.analyzer_arn {
            query.push_kv("analyzerArn", &smithy_http::query::fmt_string(&inner_21));
        }
...
impl ListAnalyzedResourcesInput {
    ...
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_analyzed_resources(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
pub mod list_analyzers_input {
    ...
    impl Builder {
        ...
        pub fn build(
            self,
        ) -> std::result::Result<crate::input::ListAnalyzersInput, smithy_http::operation::BuildError>
        {
...
impl ListAnalyzersInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_26) = &self.r#type {
            query.push_kv("type", &smithy_http::query::fmt_string(&inner_26));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListArchiveRulesInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_27 = &self.analyzer_name;
        let input_27 =
            input_27
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_27, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_29) = &self.max_results {
            query.push_kv(
                "maxResults",
...
impl ListPolicyGenerationsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_30) = &self.principal_arn {
            query.push_kv("principalArn", &smithy_http::query::fmt_string(&inner_30));
        }
...
impl ListTagsForResourceInput {
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_33 = &self.resource_arn;
        let input_33 =
            input_33
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let resource_arn = smithy_http::label::fmt_string(input_33, false);
...
impl StartPolicyGenerationInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_start_policy_generation(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl StartResourceScanInput {
    ...
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_start_resource_scan(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl UpdateArchiveRuleInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_archive_rule(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
    ...
    fn uri_base(&self, output: &mut String) -> Result<(), smithy_http::operation::BuildError> {
        let input_38 = &self.analyzer_name;
        let input_38 =
            input_38
                .as_ref()
                .ok_or(smithy_http::operation::BuildError::MissingField {
        ...
        let analyzer_name = smithy_http::label::fmt_string(input_38, false);
        if analyzer_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "analyzer_name",
                details: "cannot be empty or unset",
        ...
        let rule_name = smithy_http::label::fmt_string(input_39, false);
        if rule_name.is_empty() {
            return Err(smithy_http::operation::BuildError::MissingField {
                field: "rule_name",
                details: "cannot be empty or unset",
...
impl UpdateFindingsInput {
    ...
    > {
        Ok({
            ...
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_findings(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
...
impl ValidatePolicyInput {
    ...
    > {
        Ok({
            let properties = smithy_http::property_bag::SharedPropertyBag::new();
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_validate_policy(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
