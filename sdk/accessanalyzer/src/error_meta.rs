...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_findings_statistics::GetFindingsStatisticsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
    fn from(
        err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_findings_statistics::GetFindingsStatisticsError, R>,
    ) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(crate::error::sealed_unhandled::Unhandled {
...
impl From<crate::operation::get_findings_statistics::GetFindingsStatisticsError> for Error {
    fn from(err: crate::operation::get_findings_statistics::GetFindingsStatisticsError) -> Self {
        match err {
            crate::operation::get_findings_statistics::GetFindingsStatisticsError::AccessDeniedException(inner) => {
                Error::AccessDeniedException(inner)
            }
            crate::operation::get_findings_statistics::GetFindingsStatisticsError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::get_findings_statistics::GetFindingsStatisticsError::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
            crate::operation::get_findings_statistics::GetFindingsStatisticsError::ThrottlingException(inner) => Error::ThrottlingException(inner),
            crate::operation::get_findings_statistics::GetFindingsStatisticsError::ValidationException(inner) => Error::ValidationException(inner),
