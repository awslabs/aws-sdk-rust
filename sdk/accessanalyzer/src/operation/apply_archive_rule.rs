...
impl ApplyArchiveRuleInput {
    /// Consumes the builder and constructs an Operation<[`ApplyArchiveRule`](crate::operation::apply_archive_rule::ApplyArchiveRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::apply_archive_rule::ApplyArchiveRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::apply_archive_rule::ApplyArchiveRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_apply_archive_rule::ser_apply_archive_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::apply_archive_rule::ApplyArchiveRule::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ApplyArchiveRule", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for ApplyArchiveRule {
                type Output = std::result::Result<crate::operation::apply_archive_rule::ApplyArchiveRuleOutput, crate::operation::apply_archive_rule::ApplyArchiveRuleError>;
