...
impl ApplyArchiveRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_apply_archive_rule::ser_apply_archive_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplyArchiveRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_apply_archive_rule::de_apply_archive_rule_http_response_with_props(status, headers, body)
        }
    }
}
