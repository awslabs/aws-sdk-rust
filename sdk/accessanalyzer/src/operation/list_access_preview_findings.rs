...
impl ListAccessPreviewFindingsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_preview_findings::ListAccessPreviewFindings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccessPreviewFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_access_preview_findings::de_list_access_preview_findings_http_response_with_props(status, headers, body)
        }
    }
}
