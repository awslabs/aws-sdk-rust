...
impl ListAccessPreviewFindingsInput {
    /// Consumes the builder and constructs an Operation<[`ListAccessPreviewFindings`](crate::operation::list_access_preview_findings::ListAccessPreviewFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_access_preview_findings::ListAccessPreviewFindings, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_access_preview_findings::ListAccessPreviewFindingsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.access_preview_id;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("access_preview_id", "cannot be empty or unset"))?;
                ...
                if access_preview_id.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("access_preview_id", "cannot be empty or unset"))
                            }
                write!(output, "/access-preview/{accessPreviewId}", accessPreviewId = access_preview_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_access_preview_findings::ser_list_access_preview_findings_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_preview_findings::ListAccessPreviewFindings::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAccessPreviewFindings", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessPreviewFindings {
                type Output = std::result::Result<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsOutput, crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError>;
