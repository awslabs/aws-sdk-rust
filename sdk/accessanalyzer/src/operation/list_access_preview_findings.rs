...
/// Orchestration and serialization glue logic for `ListAccessPreviewFindings`.
...
impl ListAccessPreviewFindings {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAccessPreviewFindings {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAccessPreviewFindings");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAccessPreviewFindingsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAccessPreviewFindingsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAccessPreviewFindings")
...
.with_interceptor(ListAccessPreviewFindingsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError>::new());
...
#[derive(Debug)]
            struct ListAccessPreviewFindingsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAccessPreviewFindingsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_access_preview_findings::de_list_access_preview_findings_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_access_preview_findings::de_list_access_preview_findings_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAccessPreviewFindingsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAccessPreviewFindingsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_access_preview_findings::ListAccessPreviewFindingsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_access_preview_findings::ListAccessPreviewFindingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.access_preview_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("access_preview_id", "cannot be empty or unset"))?;
    let access_preview_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if access_preview_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("access_preview_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/access-preview/{accessPreviewId}", accessPreviewId = access_preview_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_access_preview_findings::ser_list_access_preview_findings_input(&input)?);
...
#[derive(Debug)]
            struct ListAccessPreviewFindingsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAccessPreviewFindingsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAccessPreviewFindingsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAccessPreviewFindingsInput>()
                        .ok_or("failed to downcast to ListAccessPreviewFindingsInput")?;
...
pub enum ListAccessPreviewFindingsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAccessPreviewFindingsError) for what information is available for the error.")]
...
impl ListAccessPreviewFindingsError {
    /// Creates the `ListAccessPreviewFindingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAccessPreviewFindingsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAccessPreviewFindingsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_access_preview_findings::ListAccessPreviewFindingsError {
...
mod _list_access_preview_findings_output;
