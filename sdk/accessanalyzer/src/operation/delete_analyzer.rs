...
impl DeleteAnalyzerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAnalyzer`](crate::operation::delete_analyzer::DeleteAnalyzer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_analyzer::DeleteAnalyzer, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_analyzer::DeleteAnalyzerInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/analyzer/{analyzerName}", analyzerName = analyzer_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_analyzer::DeleteAnalyzerInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_analyzer::DeleteAnalyzer::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteAnalyzer", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAnalyzer {
                type Output = std::result::Result<crate::operation::delete_analyzer::DeleteAnalyzerOutput, crate::operation::delete_analyzer::DeleteAnalyzerError>;
