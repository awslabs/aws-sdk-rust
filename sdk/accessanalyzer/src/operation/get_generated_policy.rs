...
impl GetGeneratedPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_generated_policy::GetGeneratedPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGeneratedPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_generated_policy::de_get_generated_policy_http_response_with_props(status, headers, body)
        }
    }
}
