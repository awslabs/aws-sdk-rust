...
impl GetArchiveRuleInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_archive_rule::GetArchiveRule, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetArchiveRule {
    type Output =
        ::std::result::Result<crate::operation::get_archive_rule::GetArchiveRuleOutput, crate::operation::get_archive_rule::GetArchiveRuleError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_archive_rule::de_get_archive_rule_http_response_with_props(status, headers, body)
        }
    }
}
