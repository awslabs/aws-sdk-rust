...
impl ListArchiveRulesInput {
    /// Consumes the builder and constructs an Operation<[`ListArchiveRules`](crate::operation::list_archive_rules::ListArchiveRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_archive_rules::ListArchiveRules, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_archive_rules::ListArchiveRulesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/analyzer/{analyzerName}/archive-rule", analyzerName = analyzer_name).expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_archive_rules::ListArchiveRulesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_archive_rules::ListArchiveRules::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListArchiveRules", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListArchiveRules {
                type Output = std::result::Result<crate::operation::list_archive_rules::ListArchiveRulesOutput, crate::operation::list_archive_rules::ListArchiveRulesError>;
