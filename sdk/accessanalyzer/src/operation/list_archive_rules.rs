...
impl ListArchiveRulesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_archive_rules::ListArchiveRules,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListArchiveRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_archive_rules::de_list_archive_rules_http_response_with_props(status, headers, body)
        }
    }
}
