    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let analyzer_name = ::aws_smithy_http::label::fmt_string(
                    input_1,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_archive_rules::ListArchiveRules::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListArchiveRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_archive_rules::de_list_archive_rules_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_archive_rules::ListArchiveRulesError
{
