...
impl UpdateFindingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_findings::UpdateFindings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_findings::ser_update_findings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_findings::de_update_findings_http_response_with_props(status, headers, body)
        }
    }
}
