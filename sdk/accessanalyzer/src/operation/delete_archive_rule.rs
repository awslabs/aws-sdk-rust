...
impl DeleteArchiveRuleInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_archive_rule::DeleteArchiveRule::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteArchiveRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_archive_rule::de_delete_archive_rule_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_archive_rule::DeleteArchiveRuleError
{
