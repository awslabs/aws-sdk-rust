...
impl ValidatePolicyInput {
    /// Consumes the builder and constructs an Operation<[`ValidatePolicy`](crate::operation::validate_policy::ValidatePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_policy::ValidatePolicy, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_policy::ValidatePolicyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/policy/validation").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::validate_policy::ValidatePolicyInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::validate_policy::ValidatePolicy::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ValidatePolicy {
                type Output = std::result::Result<crate::operation::validate_policy::ValidatePolicyOutput, crate::operation::validate_policy::ValidatePolicyError>;
