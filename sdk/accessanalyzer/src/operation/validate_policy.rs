...
impl ValidatePolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::validate_policy::ValidatePolicy, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_validate_policy::ser_validate_policy_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidatePolicy {
    type Output =
        ::std::result::Result<crate::operation::validate_policy::ValidatePolicyOutput, crate::operation::validate_policy::ValidatePolicyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_policy::de_validate_policy_http_response_with_props(status, headers, body)
        }
    }
}
