...
impl ListAccessPreviewsInput {
    /// Consumes the builder and constructs an Operation<[`ListAccessPreviews`](crate::operation::list_access_previews::ListAccessPreviews)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_access_previews::ListAccessPreviews, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_access_previews::ListAccessPreviewsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/access-preview").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_access_previews::ListAccessPreviewsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.analyzer_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("analyzer_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_access_previews::ListAccessPreviews::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListAccessPreviews {
                type Output = std::result::Result<crate::operation::list_access_previews::ListAccessPreviewsOutput, crate::operation::list_access_previews::ListAccessPreviewsError>;
