...
impl ListAccessPreviewsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_access_previews::ListAccessPreviews,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccessPreviews {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_access_previews::de_list_access_previews_http_response_with_props(status, headers, body)
        }
    }
}
