...
impl GetFindingFluentBuilder  {
    /// Creates a new `GetFinding`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::get_finding::GetFinding, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::get_finding::GetFindingError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_finding::GetFindingOutput, aws_smithy_http::result::SdkError<crate::operation::get_finding::GetFindingError>>
                     {
