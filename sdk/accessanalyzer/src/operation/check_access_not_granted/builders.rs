...
impl CheckAccessNotGrantedFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::check_access_not_granted::CheckAccessNotGrantedOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::check_access_not_granted::CheckAccessNotGrantedError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::check_access_not_granted::CheckAccessNotGrantedOutput, crate::operation::check_access_not_granted::CheckAccessNotGrantedError, Self> {
