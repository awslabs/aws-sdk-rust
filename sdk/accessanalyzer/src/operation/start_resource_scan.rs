...
impl StartResourceScanInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_resource_scan::ser_start_resource_scan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartResourceScan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_resource_scan::de_start_resource_scan_http_response_with_props(status, headers, body)
        }
    }
}
