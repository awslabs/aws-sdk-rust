...
impl StartResourceScanInput {
    /// Consumes the builder and constructs an Operation<[`StartResourceScan`](crate::operation::start_resource_scan::StartResourceScan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_resource_scan::StartResourceScan, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_resource_scan::StartResourceScanInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_resource_scan::StartResourceScan::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartResourceScan {
                type Output = std::result::Result<crate::operation::start_resource_scan::StartResourceScanOutput, crate::operation::start_resource_scan::StartResourceScanError>;
