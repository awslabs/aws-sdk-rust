...
impl CancelPolicyGenerationInput {
    /// Consumes the builder and constructs an Operation<[`CancelPolicyGeneration`](crate::operation::cancel_policy_generation::CancelPolicyGeneration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::cancel_policy_generation::CancelPolicyGeneration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_policy_generation::CancelPolicyGenerationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                write!(output, "/policy/generation/{jobId}", jobId = job_id).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_policy_generation::CancelPolicyGeneration::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CancelPolicyGeneration", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for CancelPolicyGeneration {
                type Output = std::result::Result<crate::operation::cancel_policy_generation::CancelPolicyGenerationOutput, crate::operation::cancel_policy_generation::CancelPolicyGenerationError>;
