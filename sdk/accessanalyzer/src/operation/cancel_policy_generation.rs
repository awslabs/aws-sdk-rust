    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/policy/generation/{jobId}", jobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_policy_generation::CancelPolicyGeneration::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::cancel_policy_generation::CancelPolicyGenerationError
{
