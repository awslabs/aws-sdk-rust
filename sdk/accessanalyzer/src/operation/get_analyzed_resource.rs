...
impl GetAnalyzedResourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_analyzed_resource::GetAnalyzedResource, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_analyzed_resource::GetAnalyzedResourceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/analyzed-resource").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::get_analyzed_resource::GetAnalyzedResourceInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
