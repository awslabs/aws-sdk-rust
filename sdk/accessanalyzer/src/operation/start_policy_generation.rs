...
impl StartPolicyGenerationInput {
    /// Consumes the builder and constructs an Operation<[`StartPolicyGeneration`](crate::operation::start_policy_generation::StartPolicyGeneration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::start_policy_generation::StartPolicyGeneration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_policy_generation::StartPolicyGenerationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::start_policy_generation::StartPolicyGeneration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for StartPolicyGeneration {
                type Output = std::result::Result<crate::operation::start_policy_generation::StartPolicyGenerationOutput, crate::operation::start_policy_generation::StartPolicyGenerationError>;
