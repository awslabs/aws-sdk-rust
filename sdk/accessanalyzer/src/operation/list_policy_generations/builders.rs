...
impl ListPolicyGenerationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_policy_generations::ListPolicyGenerationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_policy_generations::ListPolicyGenerationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_policy_generations::ListPolicyGenerationsOutput, crate::operation::list_policy_generations::ListPolicyGenerationsError, Self> {
