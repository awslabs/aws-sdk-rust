...
impl GetAnalyzerFluentBuilder  {
    /// Creates a new `GetAnalyzer`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_analyzer::GetAnalyzerOutput, aws_smithy_http::result::SdkError<crate::operation::get_analyzer::GetAnalyzerError>>
                     {
