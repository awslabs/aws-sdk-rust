...
impl CreateAccessPreviewInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_access_preview::ser_create_access_preview_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_access_preview::CreateAccessPreview::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_access_preview::CreateAccessPreviewError
{
