...
impl CreateAccessPreviewInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccessPreview`](crate::operation::create_access_preview::CreateAccessPreview)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_access_preview::CreateAccessPreview, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_access_preview::CreateAccessPreviewInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_access_preview::ser_create_access_preview_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_access_preview::CreateAccessPreview::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateAccessPreview", "accessanalyzer"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAccessPreview {
                type Output = std::result::Result<crate::operation::create_access_preview::CreateAccessPreviewOutput, crate::operation::create_access_preview::CreateAccessPreviewError>;
