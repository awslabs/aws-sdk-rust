...
impl ListAccessPreviewsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_access_previews::paginator::ListAccessPreviewsPaginator {
        crate::operation::list_access_previews::paginator::ListAccessPreviewsPaginator::new(
            self.handle,
            self.inner,
        )
    }
