...
impl CreateArchiveRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_archive_rule::ser_create_archive_rule_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateArchiveRule {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_archive_rule::de_create_archive_rule_http_response_with_props(status, headers, body)
        }
    }
}
