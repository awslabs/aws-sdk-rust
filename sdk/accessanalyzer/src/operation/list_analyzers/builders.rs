...
impl ListAnalyzersFluentBuilder  {
    /// Creates a new `ListAnalyzers`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_analyzers::ListAnalyzersOutput, aws_smithy_http::result::SdkError<crate::operation::list_analyzers::ListAnalyzersError>>
                     {
