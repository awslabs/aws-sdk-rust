        ...
        ::std::result::Result::Ok(
            crate::types::Finding {
                ...
                resource_type: self.resource_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_type", "resource_type was not specified but it is required when building Finding")
                    )?
                ,
                condition: self.condition
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("condition", "condition was not specified but it is required when building Finding")
                    )?
                ,
                ...
                analyzed_at: self.analyzed_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("analyzed_at", "analyzed_at was not specified but it is required when building Finding")
                    )?
                ,
                ...
                resource_owner_account: self.resource_owner_account
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("resource_owner_account", "resource_owner_account was not specified but it is required when building Finding")
                    )?
                ,
                error: self.error
                ,
