...
impl Configuration {
    ...
    pub fn as_ebs_snapshot(&self) -> ::std::result::Result<&crate::types::EbsSnapshotConfiguration, &Self> {
        if let Configuration::EbsSnapshot(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_ecr_repository(&self) -> ::std::result::Result<&crate::types::EcrRepositoryConfiguration, &Self> {
        if let Configuration::EcrRepository(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_efs_file_system(&self) -> ::std::result::Result<&crate::types::EfsFileSystemConfiguration, &Self> {
        if let Configuration::EfsFileSystem(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_iam_role(&self) -> ::std::result::Result<&crate::types::IamRoleConfiguration, &Self> {
        if let Configuration::IamRole(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_kms_key(&self) -> ::std::result::Result<&crate::types::KmsKeyConfiguration, &Self> {
        if let Configuration::KmsKey(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_rds_db_cluster_snapshot(&self) -> ::std::result::Result<&crate::types::RdsDbClusterSnapshotConfiguration, &Self> {
        if let Configuration::RdsDbClusterSnapshot(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_rds_db_snapshot(&self) -> ::std::result::Result<&crate::types::RdsDbSnapshotConfiguration, &Self> {
        if let Configuration::RdsDbSnapshot(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_s3_bucket(&self) -> ::std::result::Result<&crate::types::S3BucketConfiguration, &Self> {
        if let Configuration::S3Bucket(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_s3_express_directory_bucket(&self) -> ::std::result::Result<&crate::types::S3ExpressDirectoryBucketConfiguration, &Self> {
        if let Configuration::S3ExpressDirectoryBucket(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_secrets_manager_secret(&self) -> ::std::result::Result<&crate::types::SecretsManagerSecretConfiguration, &Self> {
        if let Configuration::SecretsManagerSecret(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_sns_topic(&self) -> ::std::result::Result<&crate::types::SnsTopicConfiguration, &Self> {
        if let Configuration::SnsTopic(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_sqs_queue(&self) -> ::std::result::Result<&crate::types::SqsQueueConfiguration, &Self> {
        if let Configuration::SqsQueue(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
