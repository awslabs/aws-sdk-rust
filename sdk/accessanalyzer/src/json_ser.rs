...
pub fn serialize_structure_crate_input_apply_archive_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ApplyArchiveRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_access_preview_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAccessPreviewInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_analyzer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAnalyzerInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_archive_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateArchiveRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_access_preview_findings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAccessPreviewFindingsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_analyzed_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAnalyzedResourcesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_list_findings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFindingsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_policy_generation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartPolicyGenerationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_resource_scan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartResourceScanInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_archive_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateArchiveRuleInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_65, value_66) in var_63 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_criterion(&mut object_67, value_66)?;
                object_67.finish();
            }
        }
        object_64.finish();
...
pub fn serialize_structure_crate_input_update_findings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateFindingsInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_validate_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ValidatePolicyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_78) = &input.validate_policy_resource_type {
        object.key("validatePolicyResourceType").string(var_78.as_str());
    }
    Ok(())
}

pub fn serialize_union_crate_model_configuration(object_10: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Configuration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        crate::model::Configuration::IamRole(inner) => {
             {
                let mut object_79 = object_10.key("iamRole").start_object();
                crate::json_ser::serialize_structure_crate_model_iam_role_configuration(&mut object_79, inner)?;
                object_79.finish();
            }
        },
        crate::model::Configuration::KmsKey(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_kms_key_configuration(&mut object_80, inner)?;
                object_80.finish();
            }
        },
        crate::model::Configuration::SecretsManagerSecret(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_secrets_manager_secret_configuration(&mut object_81, inner)?;
                object_81.finish();
            }
        },
        crate::model::Configuration::S3Bucket(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_s3_bucket_configuration(&mut object_82, inner)?;
                object_82.finish();
            }
        },
        crate::model::Configuration::SqsQueue(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_sqs_queue_configuration(&mut object_83, inner)?;
                object_83.finish();
            }
        },
        crate::model::Configuration::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("Configuration"))
    }
    Ok(())
}

pub fn serialize_structure_crate_model_inline_archive_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InlineArchiveRule) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for (key_87, value_88) in var_85 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_criterion(&mut object_89, value_88)?;
                object_89.finish();
            }
        }
        object_86.finish();
...
pub fn serialize_structure_crate_model_criterion(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Criterion) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_sort_criteria(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SortCriteria) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_cloud_trail_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CloudTrailDetails) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_107) = &input.start_time {
        object.key("startTime").date_time(var_107, aws_smithy_types::date_time::Format::DateTime)?;
    }
    if let Some(var_108) = &input.end_time {
        object.key("endTime").date_time(var_108, aws_smithy_types::date_time::Format::DateTime)?;
    }
    Ok(())
}

pub fn serialize_structure_crate_model_policy_generation_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PolicyGenerationDetails) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_iam_role_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IamRoleConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_kms_key_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KmsKeyConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_117 in var_115 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_kms_grant_configuration(&mut object_118, item_117)?;
                object_118.finish();
            }
        }
        array_116.finish();
...
pub fn serialize_structure_crate_model_secrets_manager_secret_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SecretsManagerSecretConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_s3_bucket_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3BucketConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_124 in var_122 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_s3_bucket_acl_grant_configuration(&mut object_125, item_124)?;
                object_125.finish();
            }
        }
        array_123.finish();
    ...
    if let Some(var_126) = &input.bucket_public_access_block {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_public_access_block_configuration(&mut object_127, var_126)?;
        object_127.finish();
    }
        ...
        for (key_130, value_131) in var_128 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_s3_access_point_configuration(&mut object_132, value_131)?;
                object_132.finish();
            }
        }
        object_129.finish();
...
pub fn serialize_structure_crate_model_sqs_queue_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SqsQueueConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_trail(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Trail) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_kms_grant_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KmsGrantConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_144) = &input.constraints {
        ...
        crate::json_ser::serialize_structure_crate_model_kms_grant_constraints(&mut object_145, var_144)?;
        object_145.finish();
    }
...
pub fn serialize_structure_crate_model_s3_bucket_acl_grant_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3BucketAclGrantConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_s3_public_access_block_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3PublicAccessBlockConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_s3_access_point_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::S3AccessPointConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_153) = &input.public_access_block {
        ...
        crate::json_ser::serialize_structure_crate_model_s3_public_access_block_configuration(&mut object_154, var_153)?;
        object_154.finish();
    }
    if let Some(var_155) = &input.network_origin {
        let mut object_156 = object.key("networkOrigin").start_object();
        crate::json_ser::serialize_union_crate_model_network_origin_configuration(&mut object_156, var_155)?;
        object_156.finish();
    }
    Ok(())
}

pub fn serialize_structure_crate_model_kms_grant_constraints(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::KmsGrantConstraints) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_union_crate_model_acl_grantee(object_149: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AclGrantee) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        ...
        crate::model::AclGrantee::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("AclGrantee"))
    }
    Ok(())
}

pub fn serialize_union_crate_model_network_origin_configuration(object_156: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NetworkOriginConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
    match input {
        crate::model::NetworkOriginConfiguration::VpcConfiguration(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_vpc_configuration(&mut object_165, inner)?;
                object_165.finish();
            }
        },
        crate::model::NetworkOriginConfiguration::InternetConfiguration(inner) => {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_internet_configuration(&mut object_166, inner)?;
                object_166.finish();
            }
        },
        crate::model::NetworkOriginConfiguration::Unknown => return Err(aws_smithy_http::operation::SerializationError::unknown_variant("NetworkOriginConfiguration"))
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_internet_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InternetConfiguration) -> Result<(), aws_smithy_http::operation::SerializationError> {
