...
pub fn serialize_structure_apply_archive_rule_input(
...
pub fn serialize_structure_create_access_preview_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_8, value_9) in var_6 {
            {
                ...
                crate::json_ser::serialize_union_configuration(&mut object_10, value_9);
                object_10.finish();
            }
        }
        object_7.finish();
...
pub fn serialize_structure_create_analyzer_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_14 in var_12 {
            {
                ...
                crate::json_ser::serialize_structure_inline_archive_rule(&mut object_15, item_14);
                object_15.finish();
            }
        }
        array_13.finish();
...
pub fn serialize_structure_create_archive_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_25, value_26) in var_23 {
            {
                ...
                crate::json_ser::serialize_structure_criterion(&mut object_27, value_26);
                object_27.finish();
            }
        }
        object_24.finish();
...
pub fn serialize_structure_list_access_preview_findings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_32, value_33) in var_30 {
            {
                ...
                crate::json_ser::serialize_structure_criterion(&mut object_34, value_33);
                object_34.finish();
            }
        }
        object_31.finish();
...
pub fn serialize_structure_list_analyzed_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_findings_input(
        ...
        for (key_44, value_45) in var_42 {
            {
                ...
                crate::json_ser::serialize_structure_criterion(&mut object_46, value_45);
                object_46.finish();
            }
        }
        object_43.finish();
    ...
    if let Some(var_49) = &input.sort {
        ...
        crate::json_ser::serialize_structure_sort_criteria(&mut object_50, var_49);
        object_50.finish();
    }
}

pub fn serialize_structure_start_policy_generation_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_52) = &input.cloud_trail_details {
        ...
        crate::json_ser::serialize_structure_cloud_trail_details(&mut object_53, var_52);
        object_53.finish();
    }
    if let Some(var_54) = &input.policy_generation_details {
        let mut object_55 = object.key("policyGenerationDetails").start_object();
        crate::json_ser::serialize_structure_policy_generation_details(&mut object_55, var_54);
        object_55.finish();
    }
}

pub fn serialize_structure_start_resource_scan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_archive_rule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_65, value_66) in var_63 {
            {
                ...
                crate::json_ser::serialize_structure_criterion(&mut object_67, value_66);
                object_67.finish();
            }
        }
        object_64.finish();
...
pub fn serialize_structure_validate_policy_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_configuration(
    ...
    match input {
        crate::model::Configuration::IamRole(inner) => {
            ...
            crate::json_ser::serialize_structure_iam_role_configuration(&mut object_78, inner);
            object_78.finish();
        }
        crate::model::Configuration::KmsKey(inner) => {
            let mut object_79 = object_10.key("kmsKey").start_object();
            crate::json_ser::serialize_structure_kms_key_configuration(&mut object_79, inner);
            object_79.finish();
        }
        crate::model::Configuration::SecretsManagerSecret(inner) => {
            let mut object_80 = object_10.key("secretsManagerSecret").start_object();
            crate::json_ser::serialize_structure_secrets_manager_secret_configuration(
                &mut object_80,
                inner,
            );
            object_80.finish();
        ...
        crate::model::Configuration::S3Bucket(inner) => {
            ...
            crate::json_ser::serialize_structure_s3_bucket_configuration(&mut object_81, inner);
            object_81.finish();
        }
        crate::model::Configuration::SqsQueue(inner) => {
            let mut object_82 = object_10.key("sqsQueue").start_object();
            crate::json_ser::serialize_structure_sqs_queue_configuration(&mut object_82, inner);
            object_82.finish();
        }
    }
}

pub fn serialize_structure_inline_archive_rule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for (key_86, value_87) in var_84 {
            {
                ...
                crate::json_ser::serialize_structure_criterion(&mut object_88, value_87);
                object_88.finish();
            }
        }
        object_85.finish();
...
pub fn serialize_structure_criterion(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_cloud_trail_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_103 in var_101 {
            {
                ...
                crate::json_ser::serialize_structure_trail(&mut object_104, item_103);
                object_104.finish();
            }
        }
        array_102.finish();
...
pub fn serialize_structure_policy_generation_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_iam_role_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_kms_key_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_116 in var_114 {
            {
                ...
                crate::json_ser::serialize_structure_kms_grant_configuration(
                    &mut object_117,
                    item_116,
                );
                object_117.finish();
...
pub fn serialize_structure_secrets_manager_secret_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_s3_bucket_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_123 in var_121 {
            {
                ...
                crate::json_ser::serialize_structure_s3_bucket_acl_grant_configuration(
                    &mut object_124,
                    item_123,
                );
                object_124.finish();
    ...
    if let Some(var_125) = &input.bucket_public_access_block {
        ...
        crate::json_ser::serialize_structure_s3_public_access_block_configuration(
            &mut object_126,
            var_125,
        );
        object_126.finish();
        ...
        for (key_129, value_130) in var_127 {
            {
                ...
                crate::json_ser::serialize_structure_s3_access_point_configuration(
                    &mut object_131,
                    value_130,
                );
                object_131.finish();
...
pub fn serialize_structure_sqs_queue_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_trail(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_kms_grant_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_143) = &input.constraints {
        ...
        crate::json_ser::serialize_structure_kms_grant_constraints(&mut object_144, var_143);
        object_144.finish();
    }
...
pub fn serialize_structure_s3_bucket_acl_grant_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_147) = &input.grantee {
        ...
        crate::json_ser::serialize_union_acl_grantee(&mut object_148, var_147);
        object_148.finish();
    }
}

pub fn serialize_structure_s3_public_access_block_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_s3_access_point_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_154) = &input.network_origin {
        ...
        crate::json_ser::serialize_union_network_origin_configuration(&mut object_155, var_154);
        object_155.finish();
    }
}

pub fn serialize_structure_kms_grant_constraints(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_acl_grantee(
...
pub fn serialize_union_network_origin_configuration(
    ...
    match input {
        crate::model::NetworkOriginConfiguration::VpcConfiguration(inner) => {
            ...
            crate::json_ser::serialize_structure_vpc_configuration(&mut object_164, inner);
            object_164.finish();
        }
        crate::model::NetworkOriginConfiguration::InternetConfiguration(inner) => {
            ...
            crate::json_ser::serialize_structure_internet_configuration(&mut object_165, inner);
            object_165.finish();
        }
    }
}
...
pub fn serialize_structure_internet_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
