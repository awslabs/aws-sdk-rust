...
impl super::Client {
    ...
    ///   - [`analyzer_name(impl ::std::convert::Into<String>)`](crate::operation::delete_archive_rule::builders::DeleteArchiveRuleFluentBuilder::analyzer_name) / [`set_analyzer_name(Option<String>)`](crate::operation::delete_archive_rule::builders::DeleteArchiveRuleFluentBuilder::set_analyzer_name): <p>The name of the analyzer that associated with the archive rule to delete.</p>
    ///   - [`rule_name(impl ::std::convert::Into<String>)`](crate::operation::delete_archive_rule::builders::DeleteArchiveRuleFluentBuilder::rule_name) / [`set_rule_name(Option<String>)`](crate::operation::delete_archive_rule::builders::DeleteArchiveRuleFluentBuilder::set_rule_name): <p>The name of the rule to delete.</p>
