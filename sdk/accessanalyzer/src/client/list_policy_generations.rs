...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_policy_generations::builders::ListPolicyGenerationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_policy_generations::builders::ListPolicyGenerationsFluentBuilder::set_next_token): <p>A token used for pagination of results returned.</p>
