...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::validate_policy::builders::ValidatePolicyFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::validate_policy::builders::ValidatePolicyFluentBuilder::set_next_token): <p>A token used for pagination of results returned.</p>
