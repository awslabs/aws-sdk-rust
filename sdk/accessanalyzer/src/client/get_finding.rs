...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl Into<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::analyzer_arn) / [`set_analyzer_arn(impl Into<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::set_analyzer_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> that generated the finding.</p><br>
    ///   - [`id(impl Into<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::id) / [`set_id(impl Into<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the finding to retrieve.</p><br>
