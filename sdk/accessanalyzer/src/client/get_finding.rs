...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_finding::builders::GetFindingFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the finding to retrieve.</p><br>
