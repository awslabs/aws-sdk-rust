...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl ::std::convert::Into<String>)`](crate::operation::get_analyzed_resource::builders::GetAnalyzedResourceFluentBuilder::analyzer_arn) / [`set_analyzer_arn(Option<String>)`](crate::operation::get_analyzed_resource::builders::GetAnalyzedResourceFluentBuilder::set_analyzer_arn): <p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> to retrieve information from.</p>
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::get_analyzed_resource::builders::GetAnalyzedResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_analyzed_resource::builders::GetAnalyzedResourceFluentBuilder::set_resource_arn): <p>The ARN of the resource to retrieve information about.</p>
