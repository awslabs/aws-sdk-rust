...
impl super::Client {
    ...
    ///   - [`filter(impl Into<String>, Criterion)`](crate::operation::list_findings::builders::ListFindingsFluentBuilder::filter) / [`set_filter(Option<HashMap<String, Criterion>>)`](crate::operation::list_findings::builders::ListFindingsFluentBuilder::set_filter): <p>A filter to match for the findings to return.</p>
