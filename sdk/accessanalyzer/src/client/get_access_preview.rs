...
impl super::Client {
    ...
    ///   - [`access_preview_id(impl Into<String>)`](crate::operation::get_access_preview::builders::GetAccessPreviewFluentBuilder::access_preview_id) / [`set_access_preview_id(Option<String>)`](crate::operation::get_access_preview::builders::GetAccessPreviewFluentBuilder::set_access_preview_id):<br>required: **true**<br><p>The unique ID for the access preview.</p><br>
    ///   - [`analyzer_arn(impl Into<String>)`](crate::operation::get_access_preview::builders::GetAccessPreviewFluentBuilder::analyzer_arn) / [`set_analyzer_arn(Option<String>)`](crate::operation::get_access_preview::builders::GetAccessPreviewFluentBuilder::set_analyzer_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> used to generate the access preview.</p><br>
