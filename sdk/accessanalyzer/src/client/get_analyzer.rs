...
impl super::Client {
    ...
    ///   - [`analyzer_name(impl ::std::convert::Into<String>)`](crate::operation::get_analyzer::builders::GetAnalyzerFluentBuilder::analyzer_name) / [`set_analyzer_name(Option<String>)`](crate::operation::get_analyzer::builders::GetAnalyzerFluentBuilder::set_analyzer_name): <p>The name of the analyzer retrieved.</p>
