...
impl super::Client {
    ...
    ///   - [`analyzer_name(impl Into<String>)`](crate::operation::get_analyzer::builders::GetAnalyzerFluentBuilder::analyzer_name) / [`set_analyzer_name(impl Into<String>)`](crate::operation::get_analyzer::builders::GetAnalyzerFluentBuilder::set_analyzer_name):<br>required: **true**<br><p>The name of the analyzer retrieved.</p><br>
