...
impl super::Client {
    ...
    ///   - [`analyzer_name(impl Into<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::analyzer_name) / [`set_analyzer_name(impl Into<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::set_analyzer_name):<br>required: **true**<br><p>The name of the analyzer to retrieve rules from.</p><br>
