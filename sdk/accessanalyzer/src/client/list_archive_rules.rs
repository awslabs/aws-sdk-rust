...
impl super::Client {
    ...
    ///   - [`analyzer_name(impl ::std::convert::Into<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::analyzer_name) / [`set_analyzer_name(Option<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::set_analyzer_name): <p>The name of the analyzer to retrieve rules from.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_archive_rules::builders::ListArchiveRulesFluentBuilder::set_next_token): <p>A token used for pagination of results returned.</p>
