...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl Into<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::analyzer_arn) / [`set_analyzer_arn(impl Into<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::set_analyzer_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> used to generate the access preview.</p><br>
