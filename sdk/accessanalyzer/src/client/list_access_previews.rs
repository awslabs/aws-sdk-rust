...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl ::std::convert::Into<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::analyzer_arn) / [`set_analyzer_arn(Option<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::set_analyzer_arn): <p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> used to generate the access preview.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_access_previews::builders::ListAccessPreviewsFluentBuilder::set_next_token): <p>A token used for pagination of results returned.</p>
