...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl Into<String>)`](crate::operation::start_resource_scan::builders::StartResourceScanFluentBuilder::analyzer_arn) / [`set_analyzer_arn(impl Into<String>)`](crate::operation::start_resource_scan::builders::StartResourceScanFluentBuilder::set_analyzer_arn):<br>required: **true**<br><p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the analyzer</a> to use to scan the policies applied to the specified resource.</p><br>
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::start_resource_scan::builders::StartResourceScanFluentBuilder::resource_arn) / [`set_resource_arn(impl Into<String>)`](crate::operation::start_resource_scan::builders::StartResourceScanFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The ARN of the resource to scan.</p><br>
