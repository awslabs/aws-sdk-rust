...
impl super::Client {
    ...
    ///   - [`analyzer_arn(impl ::std::convert::Into<String>)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::analyzer_arn) / [`set_analyzer_arn(Option<String>)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::set_analyzer_arn): <p>The <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources">ARN of the account analyzer</a> used to generate the access preview. You can only create an access preview for analyzers with an <code>Account</code> type and <code>Active</code> status.</p>
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::set_client_token): <p>A client token.</p>
