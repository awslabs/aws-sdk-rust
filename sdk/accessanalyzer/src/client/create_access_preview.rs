...
impl super::Client {
    ...
    ///   - [`configurations(impl Into<String>, Configuration)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::configurations) / [`set_configurations(Option<HashMap<String, Configuration>>)`](crate::operation::create_access_preview::builders::CreateAccessPreviewFluentBuilder::set_configurations): <p>Access control configuration for your resource that is used to generate the access preview. The access preview includes findings for external access allowed to the resource with the proposed access control configuration. The configuration must contain exactly one element.</p>
