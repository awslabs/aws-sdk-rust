...
) -> Result<Option<crate::types::S3BucketAclGrantConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "permission" => {
                            builder = builder.set_permission(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AclPermission::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "grantee" => {
