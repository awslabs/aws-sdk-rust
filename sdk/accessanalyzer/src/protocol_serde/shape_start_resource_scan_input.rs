...
pub fn ser_start_resource_scan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartResourceScanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
