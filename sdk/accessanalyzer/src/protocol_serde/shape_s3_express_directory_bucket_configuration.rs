                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "accessPoints" => {
                            builder = builder.set_access_points(
                                    crate::protocol_serde::shape_s3_express_directory_access_point_configurations_map::de_s3_express_directory_access_point_configurations_map(tokens, _value, depth + 1)?
                                );
                        }
