...
pub fn ser_inline_archive_rule(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InlineArchiveRule) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
