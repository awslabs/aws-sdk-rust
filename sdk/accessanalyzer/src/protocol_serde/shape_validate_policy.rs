                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::validate_policy::ValidatePolicyError::unhandled(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "findings" => {
                    builder = builder.set_findings(
                        crate::protocol_serde::shape_validate_policy_finding_list::de_validate_policy_finding_list(tokens, _value, depth + 1)?,
                    );
                }
                "nextToken" => {
