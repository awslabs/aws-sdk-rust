            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "path" => {
                            builder = builder.set_path(crate::protocol_serde::shape_path_element_list::de_path_element_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "span" => {
                            builder = builder.set_span(crate::protocol_serde::shape_span::de_span(tokens, _value, depth + 1)?);
                        }
