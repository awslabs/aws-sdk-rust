...
pub fn ser_start_policy_generation_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartPolicyGenerationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
