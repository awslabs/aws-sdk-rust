...
pub(crate) fn de_s3_public_access_block_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::S3PublicAccessBlockConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
