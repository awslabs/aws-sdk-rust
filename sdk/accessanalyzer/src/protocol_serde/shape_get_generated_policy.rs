                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::get_generated_policy::GetGeneratedPolicyError::unhandled(
                ...
                match key.to_unescaped()?.as_ref() {
                    "generatedPolicyResult" => {
                        builder = builder.set_generated_policy_result(
                            crate::protocol_serde::shape_generated_policy_result::de_generated_policy_result(tokens, _value, depth + 1)?,
                        );
                    }
                    "jobDetails" => {
