            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_generated_policy::GetGeneratedPolicyError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_generated_policy_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
) -> Result<crate::operation::get_generated_policy::builders::GetGeneratedPolicyOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "generatedPolicyResult" => {
                    builder = builder
                        .set_generated_policy_result(crate::protocol_serde::shape_generated_policy_result::de_generated_policy_result(tokens)?);
                }
                "jobDetails" => {
