                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "ebsSnapshot" => Some(crate::types::Configuration::EbsSnapshot(
                            crate::protocol_serde::shape_ebs_snapshot_configuration::de_ebs_snapshot_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "ecrRepository" => Some(crate::types::Configuration::EcrRepository(
                            crate::protocol_serde::shape_ecr_repository_configuration::de_ecr_repository_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "iamRole" => Some(crate::types::Configuration::IamRole(
                            crate::protocol_serde::shape_iam_role_configuration::de_iam_role_configuration(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "efsFileSystem" => Some(crate::types::Configuration::EfsFileSystem(
                            crate::protocol_serde::shape_efs_file_system_configuration::de_efs_file_system_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "kmsKey" => Some(crate::types::Configuration::KmsKey(
                            crate::protocol_serde::shape_kms_key_configuration::de_kms_key_configuration(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "rdsDbSnapshot" => Some(crate::types::Configuration::RdsDbSnapshot(
                            crate::protocol_serde::shape_rds_db_snapshot_configuration::de_rds_db_snapshot_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "s3Bucket" => Some(crate::types::Configuration::S3Bucket(
                            crate::protocol_serde::shape_s3_bucket_configuration::de_s3_bucket_configuration(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "snsTopic" => Some(crate::types::Configuration::SnsTopic(
                            crate::protocol_serde::shape_sns_topic_configuration::de_sns_topic_configuration(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "sqsQueue" => Some(crate::types::Configuration::SqsQueue(
                            crate::protocol_serde::shape_sqs_queue_configuration::de_sqs_queue_configuration(tokens, _value, depth + 1)?.ok_or_else(
                        ...
                        "dynamodbStream" => Some(crate::types::Configuration::DynamodbStream(
                            crate::protocol_serde::shape_dynamodb_stream_configuration::de_dynamodb_stream_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "dynamodbTable" => Some(crate::types::Configuration::DynamodbTable(
                            crate::protocol_serde::shape_dynamodb_table_configuration::de_dynamodb_table_configuration(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
