...
pub fn ser_configuration(object_7: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Configuration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::Configuration::S3ExpressDirectoryBucket(inner) => {
             {
                ...
                crate::protocol_serde::shape_s3_express_directory_bucket_configuration::ser_s3_express_directory_bucket_configuration(&mut object_12, inner)?;
                object_12.finish();
            }
        },
                    ...
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "s3ExpressDirectoryBucket" => {
                                Some(crate::types::Configuration::S3ExpressDirectoryBucket(
                                    crate::protocol_serde::shape_s3_express_directory_bucket_configuration::de_s3_express_directory_bucket_configuration(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 's3ExpressDirectoryBucket' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
