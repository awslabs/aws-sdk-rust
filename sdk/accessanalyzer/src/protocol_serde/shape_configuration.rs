...
pub fn ser_configuration(
    ...
    match input {
        crate::types::Configuration::EbsSnapshot(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_5.key("ebsSnapshot").start_object();
        ...
        crate::types::Configuration::EcrRepository(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_5.key("ecrRepository").start_object();
        ...
        crate::types::Configuration::IamRole(inner) => {
            #[allow(unused_mut)]
            let mut object_3 = object_5.key("iamRole").start_object();
        ...
        crate::types::Configuration::EfsFileSystem(inner) => {
            #[allow(unused_mut)]
            let mut object_4 = object_5.key("efsFileSystem").start_object();
        ...
        crate::types::Configuration::KmsKey(inner) => {
            #[allow(unused_mut)]
            let mut object_5 = object_5.key("kmsKey").start_object();
        ...
        crate::types::Configuration::RdsDbClusterSnapshot(inner) => {
            #[allow(unused_mut)]
            let mut object_6 = object_5.key("rdsDbClusterSnapshot").start_object();
        ...
        crate::types::Configuration::RdsDbSnapshot(inner) => {
            #[allow(unused_mut)]
            let mut object_7 = object_5.key("rdsDbSnapshot").start_object();
        ...
        crate::types::Configuration::SecretsManagerSecret(inner) => {
            #[allow(unused_mut)]
            let mut object_8 = object_5.key("secretsManagerSecret").start_object();
        ...
        crate::types::Configuration::S3Bucket(inner) => {
            #[allow(unused_mut)]
            let mut object_9 = object_5.key("s3Bucket").start_object();
        ...
        crate::types::Configuration::SnsTopic(inner) => {
            #[allow(unused_mut)]
            let mut object_10 = object_5.key("snsTopic").start_object();
        ...
        crate::types::Configuration::SqsQueue(inner) => {
            #[allow(unused_mut)]
            let mut object_11 = object_5.key("sqsQueue").start_object();
