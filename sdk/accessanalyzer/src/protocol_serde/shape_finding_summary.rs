...
pub(crate) fn de_finding_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FindingSummary>, aws_smithy_json::deserialize::error::DeserializeError>
