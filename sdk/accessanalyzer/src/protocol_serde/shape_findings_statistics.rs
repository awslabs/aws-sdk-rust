...
) -> Result<Option<crate::types::FindingsStatistics>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "externalAccessFindingsStatistics" => Some(crate::types::FindingsStatistics::ExternalAccessFindingsStatistics(
                            crate::protocol_serde::shape_external_access_findings_statistics::de_external_access_findings_statistics(tokens)?
                                .ok_or_else(|| {
