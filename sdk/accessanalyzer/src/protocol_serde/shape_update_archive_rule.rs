...
) -> std::result::Result<crate::operation::update_archive_rule::UpdateArchiveRuleOutput, crate::operation::update_archive_rule::UpdateArchiveRuleError>
{
    #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::update_archive_rule::UpdateArchiveRuleError::unhandled(
