...
pub fn ser_acl_grantee(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AclGrantee) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
