        ...
        for (key_3, value_4) in var_1 {
            {
                ...
                crate::protocol_serde::shape_rds_db_cluster_snapshot_attribute_value::ser_rds_db_cluster_snapshot_attribute_value(
                    &mut object_5,
                    value_4,
                )?;
                object_5.finish();
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "attributes" => {
                            builder = builder.set_attributes(
                                crate::protocol_serde::shape_rds_db_cluster_snapshot_attributes_map::de_rds_db_cluster_snapshot_attributes_map(
                                    tokens,
                                )?,
                            );
                        }
