...
pub struct SuggestModel  {
    ...
    #[doc(hidden)]pub found: i64,
    /// <p>The documents that match the query string.</p>
    #[doc(hidden)]pub suggestions: std::option::Option<std::vec::Vec<crate::model::SuggestionMatch>>,
}
impl SuggestModel {
    /// <p>The query string specified in the suggest request.</p>
...
pub struct SuggestionMatch  {
    ...
    #[doc(hidden)]pub suggestion: std::option::Option<std::string::String>,
...
pub struct SuggestStatus  {
    ...
    #[doc(hidden)]pub timems: i64,
    /// <p>The encrypted resource ID for the request.</p>
    #[doc(hidden)]pub rid: std::option::Option<std::string::String>,
}
impl SuggestStatus {
    /// <p>How long it took to process the request, in milliseconds.</p>
...
pub struct FieldStats  {
    ...
    #[doc(hidden)]pub min: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub sum_of_squares: f64,
...
pub struct Hits  {
    ...
    #[doc(hidden)]pub hit: std::option::Option<std::vec::Vec<crate::model::Hit>>,
}
impl Hits {
    /// <p>The total number of documents that match the search request.</p>
    pub fn found(&self) -> i64 {
...
pub struct Hit  {
    ...
    #[doc(hidden)]pub fields: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>>,
    /// <p>The expressions returned from a document that matches the search request.</p>
    #[doc(hidden)]pub exprs: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The highlights returned from a document that matches the search request.</p>
    #[doc(hidden)]pub highlights: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl Hit {
    /// <p>The document ID of a document that matches the search request.</p>
    pub fn id(&self) -> std::option::Option<& str> {
