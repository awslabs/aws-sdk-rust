...
pub(crate) fn de_field_stats<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::FieldStats>, aws_smithy_json::deserialize::error::DeserializeError>
