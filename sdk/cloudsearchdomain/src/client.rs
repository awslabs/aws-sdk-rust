...
/// An ergonomic service client for `AmazonCloudSearch2013`.
///
/// This client allows ergonomic access to a `AmazonCloudSearch2013`-shaped service.
...
pub mod fluent_builders {
        ...
        R: smithy_client::retry::NewRequestPolicy,
    {
        ...
        pub fn documents(mut self, inp: smithy_http::byte_stream::ByteStream) -> Self {
