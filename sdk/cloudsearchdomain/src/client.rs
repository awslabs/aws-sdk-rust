    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`SuggestInput`](crate::input::SuggestInput) with field(s):
    ///   - [`query(Option<String>)`](crate::input::SuggestInput::query): <p>Specifies the string for which you want to get suggestions.</p>
    ///   - [`suggester(Option<String>)`](crate::input::SuggestInput::suggester): <p>Specifies the name of the suggester to use to find suggested matches.</p>
    ///   - [`size(i64)`](crate::input::SuggestInput::size): <p>Specifies the maximum number of suggestions to return. </p>
    ...
    ///
    /// - Takes [`UploadDocumentsInput`](crate::input::UploadDocumentsInput) with field(s):
    ///   - [`documents(byte_stream::ByteStream)`](crate::input::UploadDocumentsInput::documents): <p>A batch of documents formatted in JSON or HTML.</p>
    ///   - [`content_type(Option<ContentType>)`](crate::input::UploadDocumentsInput::content_type): <p>The format of the batch you are uploading. Amazon CloudSearch supports two document batch formats:</p>  <ul>   <li>application/json</li>   <li>application/xml</li>  </ul>
