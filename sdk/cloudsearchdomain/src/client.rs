    ...
    C: aws_hyper::SmithyConnector,
{
    ...
    pub fn suggest(&self) -> fluent_builders::Suggest<C> {
        fluent_builders::Suggest::new(self.handle.clone())
    }
    pub fn upload_documents(&self) -> fluent_builders::UploadDocuments<C> {
...
pub mod fluent_builders {
    ...
    impl<C> Search<C> {
        ...
        pub fn cursor(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.cursor(input);
            self
        }
        ...
        pub fn expr(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.expr(input);
            self
        }
        ...
        pub fn filter_query(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.filter_query(input);
            self
        }
        ...
        pub fn highlight(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.highlight(input);
            self
        }
        ...
        pub fn query_options(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.query_options(input);
            self
        }
        ...
        pub fn r#return(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.r#return(input);
            self
        }
        ...
        pub fn stats(mut self, input: impl Into<std::string::String>) -> Self {
            self.inner = self.inner.stats(input);
            self
        }
    ...
    #[derive(std::fmt::Debug)]
    pub struct Suggest<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
    ...
    impl<C> Suggest<C> {
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::SuggestError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
    ...
    #[derive(std::fmt::Debug)]
    pub struct UploadDocuments<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::upload_documents_input::Builder,
    }
    impl<C> UploadDocuments<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
        ...
        pub async fn send(
            ...
            smithy_http::result::SdkError<crate::error::UploadDocumentsError>,
        >
        where
            C: aws_hyper::SmithyConnector,
        {
