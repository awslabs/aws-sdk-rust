...
impl UploadDocumentsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::upload_documents::UploadDocuments, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_documents_input::ser_documents_http_payload(self.documents)?.into_inner(),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadDocuments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_upload_documents::de_upload_documents_http_response_with_props(status, headers, body)
        }
    }
}
