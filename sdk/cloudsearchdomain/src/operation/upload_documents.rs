...
impl UploadDocumentsInput {
    /// Consumes the builder and constructs an Operation<[`UploadDocuments`](crate::operation::upload_documents::UploadDocuments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::upload_documents::UploadDocuments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_documents::UploadDocumentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/2013-01-01/documents/batch").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::upload_documents::UploadDocumentsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::upload_documents::UploadDocuments::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UploadDocuments {
                type Output = std::result::Result<crate::operation::upload_documents::UploadDocumentsOutput, crate::operation::upload_documents::UploadDocumentsError>;
