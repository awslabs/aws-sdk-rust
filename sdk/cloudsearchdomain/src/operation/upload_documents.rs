    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/2013-01-01/documents/batch")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::upload_documents::UploadDocuments::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadDocuments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_upload_documents::de_upload_documents_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::upload_documents::UploadDocumentsError
{
