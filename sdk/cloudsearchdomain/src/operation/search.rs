...
fn uri_query(_input: &crate::operation::search::SearchInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_7 = inner_7.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("query", "cannot be empty or unset"))?;
    if inner_7.is_empty() {
