...
impl SuggestInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::suggest::SuggestError, ::aws_smithy_http::operation::Response>,
    > {
...
impl SuggestFluentBuilder {
    ...
    pub async fn send_middleware(
        self,
    ) -> ::std::result::Result<crate::operation::suggest::SuggestOutput, ::aws_smithy_http::result::SdkError<crate::operation::suggest::SuggestError>>
    {
        let op = self
            .inner
            .build()
