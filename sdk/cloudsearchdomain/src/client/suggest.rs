...
impl super::Client {
    ...
    ///   - [`size(i64)`](crate::operation::suggest::builders::SuggestFluentBuilder::size) / [`set_size(Option<i64>)`](crate::operation::suggest::builders::SuggestFluentBuilder::set_size): <p>Specifies the maximum number of suggestions to return. </p>
