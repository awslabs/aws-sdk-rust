...
impl SearchInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::Search, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            fn uri_query(_input: &crate::input::SearchInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                let inner_6 = inner_6.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("query", "cannot be empty or unset"))?;
                if inner_6.is_empty() {
...
impl SuggestInput {
    ...
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::Suggest, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let params_result = crate::endpoint::Params::builder().set_region(_config.region.as_ref().map(|r|r.as_ref().to_owned()))
        .set_use_dual_stack(_config.use_dual_stack)
        .set_use_fips(_config.use_fips)
        .set_endpoint(_config.endpoint_url
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::SuggestInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2013-01-01/suggest").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::SuggestInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                query.push_kv("format", "sdk");
                query.push_kv("pretty", "true");
                let inner_12 = &_input.query;
                let inner_12 = inner_12.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("query", "cannot be empty or unset"))?;
                if inner_12.is_empty() {
                    return Err(aws_smithy_http::operation::error::BuildError::missing_field("query", "cannot be empty or unset"));
                }
                query.push_kv("q", &aws_smithy_http::query::fmt_string(&inner_12));
                let inner_13 = &_input.suggester;
                let inner_13 = inner_13.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("suggester", "cannot be empty or unset"))?;
...
impl UploadDocumentsInput {
    ...
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::UploadDocuments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        let params_result = crate::endpoint::Params::builder().set_region(_config.region.as_ref().map(|r|r.as_ref().to_owned()))
        .set_use_dual_stack(_config.use_dual_stack)
        .set_use_fips(_config.use_fips)
        .set_endpoint(_config.endpoint_url
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::UploadDocumentsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/2013-01-01/documents/batch").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::input::UploadDocumentsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(&mut output);
                query.push_kv("format", "sdk");
                Ok(())
            }
            ...
            fn update_http_builder(
                ...
                uri_base(input, &mut uri)?;
                uri_query(input, &mut uri)?;
                let builder = crate::protocol_serde::shape_upload_documents::ser_upload_documents_headers(input, builder)?;
        ...
        #[allow(clippy::useless_conversion)]
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_documents_input::ser_documents_http_payload( self.documents)?
            .into_inner()
        );
...
pub mod upload_documents_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::UploadDocumentsInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
pub mod suggest_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::SuggestInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
pub struct SearchInput  {
    ...
    /// </ul>
    #[doc(hidden)]
    pub query_parser: std::option::Option<crate::model::QueryParser>,
