...
impl aws_smithy_http::result::CreateUnhandledError for UploadDocumentsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: UploadDocumentsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
...
impl std::fmt::Display for UploadDocumentsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            UploadDocumentsErrorKind::DocumentServiceException(_inner) =>
            _inner.fmt(f)
            ,
            UploadDocumentsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl UploadDocumentsError {
    ...
    pub fn is_document_service_exception(&self) -> bool {
        matches!(&self.kind, UploadDocumentsErrorKind::DocumentServiceException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for SuggestError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: SuggestErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for SuggestError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SuggestErrorKind::SearchException(_inner) =>
            _inner.fmt(f)
            ,
            SuggestErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl std::fmt::Display for SearchError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            SearchErrorKind::SearchException(_inner) =>
            _inner.fmt(f)
            ,
