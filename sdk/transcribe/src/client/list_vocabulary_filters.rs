...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_vocabulary_filters::builders::ListVocabularyFiltersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_vocabulary_filters::builders::ListVocabularyFiltersFluentBuilder::set_next_token): <p>If your <code>ListVocabularyFilters</code> request returns more results than can be displayed, <code>NextToken</code> is displayed in the response with an associated string. To get the next page of results, copy this string and repeat your request, including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_vocabulary_filters::builders::ListVocabularyFiltersFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_vocabulary_filters::builders::ListVocabularyFiltersFluentBuilder::set_name_contains): <p>Returns only the custom vocabulary filters that contain the specified string. The search is not case sensitive.</p>
