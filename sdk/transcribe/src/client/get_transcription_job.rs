...
impl super::Client {
    ...
    ///   - [`transcription_job_name(impl Into<String>)`](crate::operation::get_transcription_job::builders::GetTranscriptionJobFluentBuilder::transcription_job_name) / [`set_transcription_job_name(Option<String>)`](crate::operation::get_transcription_job::builders::GetTranscriptionJobFluentBuilder::set_transcription_job_name):<br>required: **true**<br><p>The name of the transcription job you want information about. Job names are case sensitive.</p><br>
