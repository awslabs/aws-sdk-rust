...
impl super::Client {
    ...
    ///   - [`vocabulary_filter_name(impl Into<String>)`](crate::operation::delete_vocabulary_filter::builders::DeleteVocabularyFilterFluentBuilder::vocabulary_filter_name) / [`set_vocabulary_filter_name(Option<String>)`](crate::operation::delete_vocabulary_filter::builders::DeleteVocabularyFilterFluentBuilder::set_vocabulary_filter_name):<br>required: **true**<br><p>The name of the custom vocabulary filter you want to delete. Custom vocabulary filter names are case sensitive.</p><br>
