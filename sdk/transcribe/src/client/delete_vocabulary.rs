...
impl super::Client {
    ...
    ///   - [`vocabulary_name(impl Into<String>)`](crate::operation::delete_vocabulary::builders::DeleteVocabularyFluentBuilder::vocabulary_name) / [`set_vocabulary_name(Option<String>)`](crate::operation::delete_vocabulary::builders::DeleteVocabularyFluentBuilder::set_vocabulary_name):<br>required: **true**<br><p>The name of the custom vocabulary you want to delete. Custom vocabulary names are case sensitive.</p><br>
