...
impl super::Client {
    ...
    ///   - [`vocabulary_filter_name(impl ::std::convert::Into<String>)`](crate::operation::get_vocabulary_filter::builders::GetVocabularyFilterFluentBuilder::vocabulary_filter_name) / [`set_vocabulary_filter_name(Option<String>)`](crate::operation::get_vocabulary_filter::builders::GetVocabularyFilterFluentBuilder::set_vocabulary_filter_name): <p>The name of the custom vocabulary filter you want information about. Custom vocabulary filter names are case sensitive.</p>
