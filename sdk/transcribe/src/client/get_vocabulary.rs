...
impl super::Client {
    ...
    ///   - [`data_access_role_arn(Option<String>)`](crate::operation::get_vocabulary::GetVocabularyOutput::data_access_role_arn): <p>The Amazon Resource Name (ARN) of the IAM role used to access the Amazon S3 bucket that contains your input files and, if applicable, the KMS key specified in <code>EncryptionConfiguration</code>.</p>
    ///   - [`encryption_configuration(Option<EncryptionConfiguration>)`](crate::operation::get_vocabulary::GetVocabularyOutput::encryption_configuration): <p>The encryption configuration used for your custom vocabulary.</p>
