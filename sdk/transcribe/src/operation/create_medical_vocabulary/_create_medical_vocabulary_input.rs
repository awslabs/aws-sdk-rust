...
impl CreateMedicalVocabularyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_medical_vocabulary::CreateMedicalVocabularyInput, ::aws_smithy_types::error::operation::BuildError> {
