...
impl ListMedicalTranscriptionJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListMedicalTranscriptionJobs`](crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_medical_transcription_jobs::ser_list_medical_transcription_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListMedicalTranscriptionJobs", "transcribe"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListMedicalTranscriptionJobs {
                type Output = std::result::Result<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsOutput, crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError>;
