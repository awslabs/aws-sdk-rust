...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMedicalTranscriptionJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_medical_transcription_jobs::de_list_medical_transcription_jobs_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListMedicalTranscriptionJobsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError
{
