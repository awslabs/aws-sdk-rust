...
impl ListMedicalTranscriptionJobs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListMedicalTranscriptionJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListMedicalTranscriptionJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListMedicalTranscriptionJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListMedicalTranscriptionJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMedicalTranscriptionJobs")
...
.with_interceptor(ListMedicalTranscriptionJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError>::new());
...
#[derive(Debug)]
            struct ListMedicalTranscriptionJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListMedicalTranscriptionJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_medical_transcription_jobs::de_list_medical_transcription_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListMedicalTranscriptionJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListMedicalTranscriptionJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_medical_transcription_jobs::ser_list_medical_transcription_jobs_input(&input)?);
...
#[derive(Debug)]
            struct ListMedicalTranscriptionJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListMedicalTranscriptionJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListMedicalTranscriptionJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListMedicalTranscriptionJobsInput>()
                        .ok_or("failed to downcast to ListMedicalTranscriptionJobsInput")?;
...
pub enum ListMedicalTranscriptionJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListMedicalTranscriptionJobsError) for what information is available for the error.")]
...
impl ListMedicalTranscriptionJobsError {
    /// Creates the `ListMedicalTranscriptionJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListMedicalTranscriptionJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListMedicalTranscriptionJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError {
...
mod _list_medical_transcription_jobs_output;
