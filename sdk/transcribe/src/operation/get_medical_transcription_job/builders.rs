...
impl GetMedicalTranscriptionJobFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobOutput, crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobError, Self> {
