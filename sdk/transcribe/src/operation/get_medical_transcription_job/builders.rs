...
impl crate::operation::get_medical_transcription_job::builders::GetMedicalTranscriptionJobInputBuilder {
...
impl GetMedicalTranscriptionJobFluentBuilder {
    /// Creates a new `GetMedicalTranscriptionJobFluentBuilder`.
