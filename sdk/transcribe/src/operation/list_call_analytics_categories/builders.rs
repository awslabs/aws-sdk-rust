...
impl ListCallAnalyticsCategoriesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_call_analytics_categories();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesOutput,
                    crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesError,
                > for ListCallAnalyticsCategoriesFluentBuilder
            {
                fn send(
                    self,
...
impl ListCallAnalyticsCategoriesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_call_analytics_categories::ListCallAnalyticsCategories::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesOutput, crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_call_analytics_categories::paginator::ListCallAnalyticsCategoriesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
