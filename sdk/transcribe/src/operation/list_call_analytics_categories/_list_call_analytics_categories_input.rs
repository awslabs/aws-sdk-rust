...
impl ListCallAnalyticsCategoriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_call_analytics_categories::ListCallAnalyticsCategoriesInput, ::aws_smithy_types::error::operation::BuildError> {
