...
impl DeleteMedicalVocabulary {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteMedicalVocabulary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteMedicalVocabulary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteMedicalVocabularyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteMedicalVocabularyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteMedicalVocabulary")
...
.with_interceptor(DeleteMedicalVocabularyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError>::new());
...
#[derive(Debug)]
            struct DeleteMedicalVocabularyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteMedicalVocabularyResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteMedicalVocabularyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteMedicalVocabularyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_medical_vocabulary::ser_delete_medical_vocabulary_input(&input)?);
...
#[derive(Debug)]
            struct DeleteMedicalVocabularyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteMedicalVocabularyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteMedicalVocabularyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteMedicalVocabularyInput>()
                        .ok_or("failed to downcast to DeleteMedicalVocabularyInput")?;
...
pub enum DeleteMedicalVocabularyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteMedicalVocabularyError) for what information is available for the error.")]
...
impl DeleteMedicalVocabularyError {
    /// Creates the `DeleteMedicalVocabularyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteMedicalVocabularyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteMedicalVocabularyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError {
