...
impl DeleteVocabularyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_vocabulary::DeleteVocabulary, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_vocabulary::ser_delete_vocabulary_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVocabulary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_vocabulary::de_delete_vocabulary_http_response_with_props(status, headers, body)
        }
    }
}
