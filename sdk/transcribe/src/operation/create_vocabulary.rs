...
impl CreateVocabularyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_vocabulary::CreateVocabulary, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_vocabulary::ser_create_vocabulary_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVocabulary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_vocabulary::de_create_vocabulary_http_response_with_props(status, headers, body)
        }
    }
}
