...
impl crate::operation::update_vocabulary_filter::builders::UpdateVocabularyFilterInputBuilder {
...
/// <p>You must include either <code>Words</code> or <code>VocabularyFilterFileUri</code> in your request.</p>
...
impl UpdateVocabularyFilterFluentBuilder {
    /// Creates a new `UpdateVocabularyFilterFluentBuilder`.
