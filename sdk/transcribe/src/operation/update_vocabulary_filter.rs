...
impl UpdateVocabularyFilter {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Transcribe", "UpdateVocabularyFilter", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Transcribe.UpdateVocabularyFilter",
                "rpc.service" = "Transcribe",
                "rpc.method" = "UpdateVocabularyFilter",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateVocabularyFilter {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateVocabularyFilterRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateVocabularyFilterResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateVocabularyFilter")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateVocabularyFilter")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateVocabularyFilterTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UpdateVocabularyFilterTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateVocabularyFilterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UpdateVocabularyFilterInput>() else {
        ...
        if requested.should_capture("VocabularyFilterFileUri") {
            if let ::std::option::Option::Some(value) = input.vocabulary_filter_file_uri.as_deref() {
                captured.insert("VocabularyFilterFileUri", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateVocabularyFilterResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_vocabulary_filter::de_update_vocabulary_filter_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_update_vocabulary_filter::de_update_vocabulary_filter_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateVocabularyFilterRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_vocabulary_filter::UpdateVocabularyFilterInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_vocabulary_filter::ser_update_vocabulary_filter_input(&input)?,
        );
