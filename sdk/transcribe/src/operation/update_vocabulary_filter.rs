...
impl UpdateVocabularyFilterInput {
    /// Consumes the builder and constructs an Operation<[`UpdateVocabularyFilter`](crate::operation::update_vocabulary_filter::UpdateVocabularyFilter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_vocabulary_filter::UpdateVocabularyFilter, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_vocabulary_filter::UpdateVocabularyFilterInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_vocabulary_filter::ser_update_vocabulary_filter_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_vocabulary_filter::UpdateVocabularyFilter::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateVocabularyFilter", "transcribe"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateVocabularyFilter`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateVocabularyFilter {
                type Output = std::result::Result<crate::operation::update_vocabulary_filter::UpdateVocabularyFilterOutput, crate::operation::update_vocabulary_filter::UpdateVocabularyFilterError>;
