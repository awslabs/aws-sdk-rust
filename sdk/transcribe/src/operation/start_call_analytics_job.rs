...
/// Orchestration and serialization glue logic for `StartCallAnalyticsJob`.
...
impl StartCallAnalyticsJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::start_call_analytics_job::StartCallAnalyticsJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_call_analytics_job::StartCallAnalyticsJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for StartCallAnalyticsJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("StartCallAnalyticsJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(StartCallAnalyticsJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(StartCallAnalyticsJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("StartCallAnalyticsJob")
...
.with_interceptor(StartCallAnalyticsJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobError>::new());
...
#[derive(Debug)]
            struct StartCallAnalyticsJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for StartCallAnalyticsJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_start_call_analytics_job::de_start_call_analytics_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_start_call_analytics_job::de_start_call_analytics_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct StartCallAnalyticsJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for StartCallAnalyticsJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::start_call_analytics_job::StartCallAnalyticsJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::start_call_analytics_job::StartCallAnalyticsJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_start_call_analytics_job::ser_start_call_analytics_job_input(&input)?);
...
#[derive(Debug)]
            struct StartCallAnalyticsJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for StartCallAnalyticsJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "StartCallAnalyticsJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<StartCallAnalyticsJobInput>()
                        .ok_or("failed to downcast to StartCallAnalyticsJobInput")?;
...
pub enum StartCallAnalyticsJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-StartCallAnalyticsJobError) for what information is available for the error.")]
...
impl StartCallAnalyticsJobError {
    /// Creates the `StartCallAnalyticsJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartCallAnalyticsJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for StartCallAnalyticsJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::start_call_analytics_job::StartCallAnalyticsJobError {
...
mod _start_call_analytics_job_output;
