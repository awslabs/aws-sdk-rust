...
impl StartMedicalScribeJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_medical_scribe_job::StartMedicalScribeJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::start_medical_scribe_job::StartMedicalScribeJobInput {
