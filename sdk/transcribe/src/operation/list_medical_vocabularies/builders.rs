...
impl ListMedicalVocabulariesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_medical_vocabularies::ListMedicalVocabulariesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_medical_vocabularies::ListMedicalVocabulariesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_medical_vocabularies::ListMedicalVocabulariesOutput, crate::operation::list_medical_vocabularies::ListMedicalVocabulariesError, Self> {
