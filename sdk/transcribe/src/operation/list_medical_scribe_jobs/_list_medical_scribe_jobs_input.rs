...
impl ListMedicalScribeJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_medical_scribe_jobs::ListMedicalScribeJobsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_medical_scribe_jobs::ListMedicalScribeJobsInput {
                status: self.status
                ,
