...
impl CreateLanguageModelInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_language_model();
...
/// <ul>
/// <li>
/// <p>If you want a Wideband (audio sample rates over 16,000 Hz) or Narrowband (audio sample rates under 16,000 Hz) base model</p></li>
/// <li>
/// <p>The location of your training and tuning files (this must be an Amazon S3 URI)</p></li>
/// <li>
/// <p>The language of your model</p></li>
/// <li>
/// <p>A unique name for your model</p></li>
/// </ul>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_language_model::CreateLanguageModelOutput,
                    crate::operation::create_language_model::CreateLanguageModelError,
                > for CreateLanguageModelFluentBuilder
            {
                fn send(
                    self,
...
impl CreateLanguageModelFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_language_model::builders::CreateLanguageModelInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_language_model::CreateLanguageModelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_language_model::CreateLanguageModelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_language_model::CreateLanguageModel::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_language_model::CreateLanguageModel::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_language_model::CreateLanguageModelOutput, crate::operation::create_language_model::CreateLanguageModelError, Self> {
    ...
    pub fn get_base_model_name(&self) -> &::std::option::Option<crate::types::BaseModelName> {
        self.inner.get_base_model_name()
    }
