...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCallAnalyticsCategory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_call_analytics_category::de_create_call_analytics_category_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for CreateCallAnalyticsCategoryError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_call_analytics_category::CreateCallAnalyticsCategoryError
{
