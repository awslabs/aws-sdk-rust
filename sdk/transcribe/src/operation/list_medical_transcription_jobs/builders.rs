...
impl ListMedicalTranscriptionJobsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsOutput, crate::operation::list_medical_transcription_jobs::ListMedicalTranscriptionJobsError, Self> {
