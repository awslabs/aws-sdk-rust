...
impl ListLanguageModelsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_language_models::ser_list_language_models_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLanguageModels {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_language_models::de_list_language_models_http_response_with_props(status, headers, body)
        }
    }
}
