...
impl GetVocabularyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_vocabulary::GetVocabulary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVocabulary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_vocabulary::de_get_vocabulary_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_vocabulary::de_get_vocabulary_http_response_with_props(
                status, headers, body,
            )
        }
    }
