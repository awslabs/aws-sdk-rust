...
impl StartTranscriptionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_transcription_job::StartTranscriptionJob,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTranscriptionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_transcription_job::de_start_transcription_job_http_response_with_props(status, headers, body)
        }
    }
}
