...
impl DeleteMedicalTranscriptionJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_medical_transcription_job::DeleteMedicalTranscriptionJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_medical_transcription_job::DeleteMedicalTranscriptionJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMedicalTranscriptionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_medical_transcription_job::de_delete_medical_transcription_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
