...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMedicalTranscriptionJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_medical_transcription_job::de_delete_medical_transcription_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteMedicalTranscriptionJobError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_medical_transcription_job::DeleteMedicalTranscriptionJobError
{
