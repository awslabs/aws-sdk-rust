...
impl UpdateMedicalVocabularyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMedicalVocabulary`](crate::operation::update_medical_vocabulary::UpdateMedicalVocabulary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_medical_vocabulary::UpdateMedicalVocabulary, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_medical_vocabulary::ser_update_medical_vocabulary_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_medical_vocabulary::UpdateMedicalVocabulary::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateMedicalVocabulary", "transcribe"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateMedicalVocabulary`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateMedicalVocabulary {
                type Output = std::result::Result<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyOutput, crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError>;
