...
/// Orchestration and serialization glue logic for `UpdateMedicalVocabulary`.
...
impl UpdateMedicalVocabulary {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateMedicalVocabulary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateMedicalVocabulary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateMedicalVocabularyRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateMedicalVocabularyResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateMedicalVocabulary")
...
.with_interceptor(UpdateMedicalVocabularyEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError>::new());
...
#[derive(Debug)]
            struct UpdateMedicalVocabularyResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateMedicalVocabularyResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_medical_vocabulary::de_update_medical_vocabulary_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct UpdateMedicalVocabularyRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateMedicalVocabularyRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_medical_vocabulary::ser_update_medical_vocabulary_input(&input)?);
...
#[derive(Debug)]
            struct UpdateMedicalVocabularyEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateMedicalVocabularyEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "UpdateMedicalVocabularyEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateMedicalVocabularyInput>()
                        .ok_or("failed to downcast to UpdateMedicalVocabularyInput")?;
...
pub enum UpdateMedicalVocabularyError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateMedicalVocabularyError) for what information is available for the error.")]
...
impl UpdateMedicalVocabularyError {
    /// Creates the `UpdateMedicalVocabularyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateMedicalVocabularyError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateMedicalVocabularyError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError {
...
mod _update_medical_vocabulary_output;
