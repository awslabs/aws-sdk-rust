...
impl DeleteCallAnalyticsCategoryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_call_analytics_category::DeleteCallAnalyticsCategory::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCallAnalyticsCategory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_call_analytics_category::de_delete_call_analytics_category_http_response_with_props(
                status, headers, body,
            )
        }
    }
