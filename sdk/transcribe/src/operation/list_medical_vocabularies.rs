...
impl ListMedicalVocabulariesInput {
    /// Consumes the builder and constructs an Operation<[`ListMedicalVocabularies`](crate::operation::list_medical_vocabularies::ListMedicalVocabularies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_medical_vocabularies::ListMedicalVocabularies, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_medical_vocabularies::ListMedicalVocabulariesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_medical_vocabularies::ListMedicalVocabulariesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_3) = &_input.state_equals {
                     {
                        query.push_kv("StateEquals", &aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                if let Some(inner_4) = &_input.name_contains {
                     {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_medical_vocabularies::ser_list_medical_vocabularies_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_medical_vocabularies::ListMedicalVocabularies::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListMedicalVocabularies", "transcribe"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListMedicalVocabularies {
                type Output = std::result::Result<crate::operation::list_medical_vocabularies::ListMedicalVocabulariesOutput, crate::operation::list_medical_vocabularies::ListMedicalVocabulariesError>;
