...
impl GetMedicalScribeJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_medical_scribe_job::GetMedicalScribeJobInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_medical_scribe_job::GetMedicalScribeJobInput {
