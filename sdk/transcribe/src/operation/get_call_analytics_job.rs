...
/// Orchestration and serialization glue logic for `GetCallAnalyticsJob`.
...
impl GetCallAnalyticsJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_call_analytics_job::GetCallAnalyticsJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_call_analytics_job::GetCallAnalyticsJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetCallAnalyticsJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetCallAnalyticsJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetCallAnalyticsJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetCallAnalyticsJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCallAnalyticsJob")
...
.with_interceptor(GetCallAnalyticsJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobError>::new());
...
#[derive(Debug)]
            struct GetCallAnalyticsJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCallAnalyticsJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_call_analytics_job::de_get_call_analytics_job_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_call_analytics_job::de_get_call_analytics_job_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetCallAnalyticsJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetCallAnalyticsJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_call_analytics_job::GetCallAnalyticsJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_call_analytics_job::GetCallAnalyticsJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_call_analytics_job::ser_get_call_analytics_job_input(&input)?);
...
#[derive(Debug)]
            struct GetCallAnalyticsJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCallAnalyticsJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetCallAnalyticsJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetCallAnalyticsJobInput>()
                        .ok_or("failed to downcast to GetCallAnalyticsJobInput")?;
...
pub enum GetCallAnalyticsJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetCallAnalyticsJobError) for what information is available for the error.")]
...
impl GetCallAnalyticsJobError {
    /// Creates the `GetCallAnalyticsJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCallAnalyticsJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetCallAnalyticsJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_call_analytics_job::GetCallAnalyticsJobError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_call_analytics_job::_get_call_analytics_job_output::GetCallAnalyticsJobOutput;

pub use crate::operation::get_call_analytics_job::_get_call_analytics_job_input::GetCallAnalyticsJobInput;

mod _get_call_analytics_job_input;

mod _get_call_analytics_job_output;
