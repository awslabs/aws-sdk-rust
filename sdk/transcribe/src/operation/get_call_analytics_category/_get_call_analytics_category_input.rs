...
impl GetCallAnalyticsCategoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_call_analytics_category::GetCallAnalyticsCategoryInput, ::aws_smithy_types::error::operation::BuildError> {
