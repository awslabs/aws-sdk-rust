...
impl GetTranscriptionJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_transcription_job::ser_get_transcription_job_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_transcription_job::GetTranscriptionJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_transcription_job::GetTranscriptionJobError
{
