...
impl ListLanguageModelsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_1) = &self.status_equals {
            query.push_kv(
                "         StatusEquals",
                &smithy_http::query::fmt_string(&inner_1),
            );
        }
        if let Some(inner_2) = &self.name_contains {
            query.push_kv("NameContains", &smithy_http::query::fmt_string(&inner_2));
        }
...
impl ListMedicalTranscriptionJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        let mut query = smithy_http::query::Writer::new(&mut output);
        if let Some(inner_5) = &self.status {
            query.push_kv("Status", &smithy_http::query::fmt_string(&inner_5));
        }
        if let Some(inner_6) = &self.job_name_contains {
            query.push_kv("JobNameContains", &smithy_http::query::fmt_string(&inner_6));
        }
...
impl ListMedicalVocabulariesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_12) = &self.name_contains {
            query.push_kv("NameContains", &smithy_http::query::fmt_string(&inner_12));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
...
impl ListTranscriptionJobsInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_14) = &self.job_name_contains {
            query.push_kv(
                "JobNameContains",
...
impl ListVocabulariesInput {
    ...
    fn uri_query(&self, mut output: &mut String) {
        ...
        if let Some(inner_20) = &self.name_contains {
            query.push_kv("NameContains", &smithy_http::query::fmt_string(&inner_20));
        }
    }
    #[allow(clippy::unnecessary_wraps)]
    fn update_http_builder(
