...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_update_medical_vocabulary::de_update_medical_vocabulary(_response_body, output)
            .map_err(crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyError::unhandled)?;
