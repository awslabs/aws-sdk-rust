...
pub fn ser_call_analytics_job_settings(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CallAnalyticsJobSettings) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_call_analytics_job_settings<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CallAnalyticsJobSettings>, aws_smithy_json::deserialize::error::DeserializeError>
