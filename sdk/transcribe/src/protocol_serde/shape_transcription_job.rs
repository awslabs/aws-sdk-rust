...
pub(crate) fn de_transcription_job<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TranscriptionJob>, aws_smithy_json::deserialize::error::DeserializeError>
