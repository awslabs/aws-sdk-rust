...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_medical_transcription_job::de_get_medical_transcription_job(_response_body, output)
            .map_err(crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobError::unhandled)?;
...
pub(crate) fn de_get_medical_transcription_job(
    ...
    crate::operation::get_medical_transcription_job::builders::GetMedicalTranscriptionJobOutputBuilder,
