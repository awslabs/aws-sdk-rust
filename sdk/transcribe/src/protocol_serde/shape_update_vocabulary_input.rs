...
pub fn ser_update_vocabulary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateVocabularyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
