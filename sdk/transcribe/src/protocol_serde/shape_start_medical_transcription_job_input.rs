...
pub fn ser_start_medical_transcription_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartMedicalTranscriptionJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
