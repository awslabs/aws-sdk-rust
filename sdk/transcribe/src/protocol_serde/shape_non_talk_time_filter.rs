...
pub fn ser_non_talk_time_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NonTalkTimeFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_non_talk_time_filter<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::NonTalkTimeFilter>, aws_smithy_json::deserialize::error::DeserializeError>
