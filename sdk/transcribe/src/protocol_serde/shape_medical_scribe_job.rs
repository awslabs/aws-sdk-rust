...
) -> Result<Option<crate::types::MedicalScribeJob>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MedicalScribeOutput" => {
                            builder = builder
                                .set_medical_scribe_output(crate::protocol_serde::shape_medical_scribe_output::de_medical_scribe_output(tokens)?);
                        }
                        "StartTime" => {
                        ...
                        "Settings" => {
                            builder = builder.set_settings(crate::protocol_serde::shape_medical_scribe_settings::de_medical_scribe_settings(tokens)?);
                        }
                        "DataAccessRoleArn" => {
