...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_medical_vocabulary::CreateMedicalVocabularyError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_medical_vocabulary::de_create_medical_vocabulary(_response_body, output)
            .map_err(crate::operation::create_medical_vocabulary::CreateMedicalVocabularyError::unhandled)?;
