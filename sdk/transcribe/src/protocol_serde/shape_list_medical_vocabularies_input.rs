...
pub fn ser_list_medical_vocabularies_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListMedicalVocabulariesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
