...
pub fn ser_start_call_analytics_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartCallAnalyticsJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
