...
pub fn ser_sentiment_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SentimentFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_sentiment_filter<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::SentimentFilter>, aws_smithy_json::deserialize::error::DeserializeError>
