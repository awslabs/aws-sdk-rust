...
pub fn ser_start_transcription_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartTranscriptionJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
