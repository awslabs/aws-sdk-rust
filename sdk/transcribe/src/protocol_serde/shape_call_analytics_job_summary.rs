...
pub(crate) fn de_call_analytics_job_summary<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::CallAnalyticsJobSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
