...
pub fn ser_update_medical_vocabulary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_medical_vocabulary::UpdateMedicalVocabularyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
