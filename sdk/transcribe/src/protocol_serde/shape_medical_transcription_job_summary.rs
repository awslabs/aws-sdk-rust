...
pub(crate) fn de_medical_transcription_job_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MedicalTranscriptionJobSummary>, aws_smithy_json::deserialize::error::DeserializeError>
