...
pub(crate) fn de_transcription_job_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TranscriptionJobSummary>, aws_smithy_json::deserialize::error::DeserializeError>
