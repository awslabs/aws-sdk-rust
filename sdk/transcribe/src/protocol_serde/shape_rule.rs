...
pub fn ser_rule(
    ...
    match input {
        crate::types::Rule::NonTalkTimeFilter(inner) => {
            ...
            crate::protocol_serde::shape_non_talk_time_filter::ser_non_talk_time_filter(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        ...
        crate::types::Rule::InterruptionFilter(inner) => {
            ...
            crate::protocol_serde::shape_interruption_filter::ser_interruption_filter(
                &mut object_2,
                inner,
            )?;
            object_2.finish();
        ...
        crate::types::Rule::TranscriptFilter(inner) => {
            ...
            crate::protocol_serde::shape_transcript_filter::ser_transcript_filter(
                &mut object_3,
                inner,
            )?;
            object_3.finish();
        ...
        crate::types::Rule::SentimentFilter(inner) => {
            ...
            crate::protocol_serde::shape_sentiment_filter::ser_sentiment_filter(
                &mut object_4,
                inner,
            )?;
            object_4.finish();
