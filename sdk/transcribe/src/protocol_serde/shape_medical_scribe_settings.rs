...
pub(crate) fn de_medical_scribe_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MedicalScribeSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
