...
pub fn ser_list_call_analytics_jobs_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_call_analytics_jobs::ListCallAnalyticsJobsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
