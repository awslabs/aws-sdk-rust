...
) -> Result<Option<crate::types::MedicalTranscriptionJob>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Transcript" => {
                            builder = builder.set_transcript(crate::protocol_serde::shape_medical_transcript::de_medical_transcript(tokens)?);
                        }
                        "StartTime" => {
                        ...
                        "Settings" => {
                            builder = builder
                                .set_settings(crate::protocol_serde::shape_medical_transcription_setting::de_medical_transcription_setting(tokens)?);
                        }
                        "ContentIdentificationType" => {
                            builder = builder.set_content_identification_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MedicalContentIdentificationType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Specialty" => {
