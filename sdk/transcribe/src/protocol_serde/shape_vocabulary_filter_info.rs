...
pub(crate) fn de_vocabulary_filter_info<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::VocabularyFilterInfo>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
