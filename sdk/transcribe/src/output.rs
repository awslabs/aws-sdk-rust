...
pub struct UpdateVocabularyFilterOutput  {
    ...
    #[doc(hidden)]pub vocabulary_filter_name: std::option::Option<std::string::String>,
...
pub struct UpdateVocabularyOutput  {
    ...
    #[doc(hidden)]pub vocabulary_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub vocabulary_state: std::option::Option<crate::model::VocabularyState>,
}
...
pub struct UpdateCallAnalyticsCategoryOutput  {
    ...
    #[doc(hidden)]pub category_properties: std::option::Option<crate::model::CategoryProperties>,
}
...
pub struct StartTranscriptionJobOutput  {
    ...
    #[doc(hidden)]pub transcription_job: std::option::Option<crate::model::TranscriptionJob>,
}
...
pub struct StartMedicalTranscriptionJobOutput  {
    ...
    #[doc(hidden)]pub medical_transcription_job: std::option::Option<crate::model::MedicalTranscriptionJob>,
}
...
pub struct StartCallAnalyticsJobOutput  {
    ...
    #[doc(hidden)]pub call_analytics_job: std::option::Option<crate::model::CallAnalyticsJob>,
}
...
pub struct ListVocabularyFiltersOutput  {
    ...
    #[doc(hidden)]pub vocabulary_filters: std::option::Option<std::vec::Vec<crate::model::VocabularyFilterInfo>>,
}
...
pub struct ListVocabulariesOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::VocabularyState>,
    /// <p>If <code>NextToken</code> is present in your response, it indicates that not all results are displayed. To view the next set of results, copy the string associated with the <code>NextToken</code> parameter in your results output, then run your request again including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Provides information about the custom vocabularies that match the criteria specified in your request.</p>
    #[doc(hidden)]pub vocabularies: std::option::Option<std::vec::Vec<crate::model::VocabularyInfo>>,
}
...
pub struct ListTranscriptionJobsOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::TranscriptionJobStatus>,
    /// <p>If <code>NextToken</code> is present in your response, it indicates that not all results are displayed. To view the next set of results, copy the string associated with the <code>NextToken</code> parameter in your results output, then run your request again including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Provides a summary of information about each result.</p>
    #[doc(hidden)]pub transcription_job_summaries: std::option::Option<std::vec::Vec<crate::model::TranscriptionJobSummary>>,
}
...
impl  std::fmt::Debug for ListTranscriptionJobsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status", &self.status);
        formatter.field("next_token", &self.next_token);
        formatter.field("transcription_job_summaries", &self.transcription_job_summaries);
        formatter.finish()
    }
}
...
pub struct ListMedicalTranscriptionJobsOutput  {
    ...
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Provides a summary of information about each result.</p>
    #[doc(hidden)]pub medical_transcription_job_summaries: std::option::Option<std::vec::Vec<crate::model::MedicalTranscriptionJobSummary>>,
}
...
impl  std::fmt::Debug for ListMedicalTranscriptionJobsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status", &self.status);
        formatter.field("next_token", &self.next_token);
        formatter.field("medical_transcription_job_summaries", &self.medical_transcription_job_summaries);
        formatter.finish()
    }
}
...
pub struct ListLanguageModelsOutput  {
    ...
    #[doc(hidden)]pub models: std::option::Option<std::vec::Vec<crate::model::LanguageModel>>,
}
...
pub struct ListCallAnalyticsJobsOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CallAnalyticsJobStatus>,
    /// <p>If <code>NextToken</code> is present in your response, it indicates that not all results are displayed. To view the next set of results, copy the string associated with the <code>NextToken</code> parameter in your results output, then run your request again including <code>NextToken</code> with the value of the copied string. Repeat as needed to view all your results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Provides a summary of information about each result.</p>
    #[doc(hidden)]pub call_analytics_job_summaries: std::option::Option<std::vec::Vec<crate::model::CallAnalyticsJobSummary>>,
}
...
impl  std::fmt::Debug for ListCallAnalyticsJobsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("status", &self.status);
        formatter.field("next_token", &self.next_token);
        formatter.field("call_analytics_job_summaries", &self.call_analytics_job_summaries);
        formatter.finish()
    }
}
...
pub struct ListCallAnalyticsCategoriesOutput  {
    ...
    #[doc(hidden)]pub categories: std::option::Option<std::vec::Vec<crate::model::CategoryProperties>>,
}
...
pub struct GetVocabularyFilterOutput  {
    ...
    #[doc(hidden)]pub download_uri: std::option::Option<std::string::String>,
}
...
pub struct DescribeLanguageModelOutput  {
    ...
    #[doc(hidden)]pub language_model: std::option::Option<crate::model::LanguageModel>,
}
...
pub struct CreateLanguageModelOutput  {
    ...
    #[doc(hidden)]pub language_code: std::option::Option<crate::model::ClmLanguageCode>,
    /// <p>The Amazon Transcribe standard language model, or base model, you specified when creating your custom language model.</p>
    #[doc(hidden)]pub base_model_name: std::option::Option<crate::model::BaseModelName>,
    /// <p>The name of your custom language model.</p>
    #[doc(hidden)]pub model_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub model_status: std::option::Option<crate::model::ModelStatus>,
}
