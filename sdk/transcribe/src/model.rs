...
impl LanguageCode {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "af-ZA", "ar-AE", "ar-SA", "da-DK", "de-CH", "de-DE", "en-AB", "en-AU", "en-GB", "en-IE", "en-IN", "en-NZ", "en-US", "en-WL", "en-ZA", "es-ES", "es-US", "fa-IR", "fr-CA", "fr-FR", "he-IL", "hi-IN", "id-ID", "it-IT", "ja-JP", "ko-KR", "ms-MY", "nl-NL", "pt-BR", "pt-PT", "ru-RU", "ta-IN", "te-IN", "th-TH", "tr-TR", "zh-CN", "zh-TW"
        ]
    }
}
...
pub struct CategoryProperties  {
    ...
    #[doc(hidden)]pub category_name: std::option::Option<std::string::String>,
...
pub struct SentimentFilter  {
    ...
    #[doc(hidden)]pub sentiments: std::option::Option<std::vec::Vec<crate::model::SentimentValue>>,
    ...
    #[doc(hidden)]pub absolute_time_range: std::option::Option<crate::model::AbsoluteTimeRange>,
    ...
    #[doc(hidden)]pub relative_time_range: std::option::Option<crate::model::RelativeTimeRange>,
    ...
    #[doc(hidden)]pub negate: std::option::Option<bool>,
}
...
pub struct RelativeTimeRange  {
    ...
    #[doc(hidden)]pub start_percentage: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub end_percentage: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub first: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub last: std::option::Option<i32>,
}
...
pub struct AbsoluteTimeRange  {
    ...
    #[doc(hidden)]pub first: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub last: std::option::Option<i64>,
}
...
pub struct TranscriptFilter  {
    ...
    #[doc(hidden)]pub transcript_filter_type: std::option::Option<crate::model::TranscriptFilterType>,
...
pub struct InterruptionFilter  {
    ...
    #[doc(hidden)]pub threshold: std::option::Option<i64>,
...
pub struct TranscriptionJob  {
    ...
    #[doc(hidden)]pub transcription_job_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub transcription_job_status: std::option::Option<crate::model::TranscriptionJobStatus>,
    ...
    #[doc(hidden)]pub media_sample_rate_hertz: std::option::Option<i32>,
    /// <p>The format of the input media file.</p>
    #[doc(hidden)]pub media_format: std::option::Option<crate::model::MediaFormat>,
    /// <p>Describes the Amazon S3 location of the media file you want to use in your request.</p>
    #[doc(hidden)]pub media: std::option::Option<crate::model::Media>,
    ...
    #[doc(hidden)]pub model_settings: std::option::Option<crate::model::ModelSettings>,
    ...
    #[doc(hidden)]pub job_execution_settings: std::option::Option<crate::model::JobExecutionSettings>,
    /// <p>Redacts or flags specified personally identifiable information (PII) in your transcript.</p>
    #[doc(hidden)]pub content_redaction: std::option::Option<crate::model::ContentRedaction>,
    /// <p>Indicates whether automatic language identification was enabled (<code>TRUE</code>) for the specified transcription job.</p>
    #[doc(hidden)]pub identify_language: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub identify_multiple_languages: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub language_options: std::option::Option<std::vec::Vec<crate::model::LanguageCode>>,
    ...
    #[doc(hidden)]pub identified_language_score: std::option::Option<f32>,
    ...
    #[doc(hidden)]pub language_codes: std::option::Option<std::vec::Vec<crate::model::LanguageCodeItem>>,
    ...
    #[doc(hidden)]pub subtitles: std::option::Option<crate::model::SubtitlesOutput>,
    ...
    #[doc(hidden)]pub language_id_settings: std::option::Option<std::collections::HashMap<crate::model::LanguageCode, crate::model::LanguageIdSettings>>,
}
...
impl  std::fmt::Debug for TranscriptionJob  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("identify_multiple_languages", &self.identify_multiple_languages);
...
pub struct LanguageIdSettings  {
    ...
    #[doc(hidden)]pub language_model_name: std::option::Option<std::string::String>,
}
...
pub struct SubtitlesOutput  {
    ...
    #[doc(hidden)]pub formats: std::option::Option<std::vec::Vec<crate::model::SubtitleFormat>>,
    ...
    /// </note>
    #[doc(hidden)]pub subtitle_file_uris: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub output_start_index: std::option::Option<i32>,
}
...
pub struct LanguageCodeItem  {
    ...
    #[doc(hidden)]pub duration_in_seconds: std::option::Option<f32>,
}
...
pub struct ContentRedaction  {
    ...
    #[doc(hidden)]pub redaction_type: std::option::Option<crate::model::RedactionType>,
    ...
    #[doc(hidden)]pub redaction_output: std::option::Option<crate::model::RedactionOutput>,
    ...
    #[doc(hidden)]pub pii_entity_types: std::option::Option<std::vec::Vec<crate::model::PiiEntityType>>,
}
...
pub struct JobExecutionSettings  {
    ...
    #[doc(hidden)]pub allow_deferred_execution: std::option::Option<bool>,
...
pub struct Settings  {
    ...
    #[doc(hidden)]pub show_speaker_labels: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub max_speaker_labels: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub channel_identification: std::option::Option<bool>,
    ...
    #[doc(hidden)]pub show_alternatives: std::option::Option<bool>,
    ...
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/transcribe/latest/dg/how-alternatives.html">Alternative transcriptions</a>.</p>
    #[doc(hidden)]pub max_alternatives: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub vocabulary_filter_method: std::option::Option<crate::model::VocabularyFilterMethod>,
}
impl Settings {
    /// <p>The name of the custom vocabulary you want to use in your transcription job request. This name is case sensitive, cannot contain spaces, and must be unique within an Amazon Web Services account.</p>
    pub fn vocabulary_name(&self) -> std::option::Option<& str> {
...
pub struct Transcript  {
    ...
    /// <p>Temporary URIs for service-managed Amazon S3 buckets are only valid for 15 minutes. If you get an <code>AccesDenied</code> error, you can get a new temporary URI by running a <code>GetTranscriptionJob</code> or <code>ListTranscriptionJob</code> request.</p> 
    /// </note>
    #[doc(hidden)]pub transcript_file_uri: std::option::Option<std::string::String>,
    ...
    /// <p>Temporary URIs for service-managed Amazon S3 buckets are only valid for 15 minutes. If you get an <code>AccesDenied</code> error, you can get a new temporary URI by running a <code>GetTranscriptionJob</code> or <code>ListTranscriptionJob</code> request.</p> 
    /// </note>
    #[doc(hidden)]pub redacted_transcript_file_uri: std::option::Option<std::string::String>,
}
impl Transcript {
    /// <p>The Amazon S3 location of your transcript. You can use this URI to access or download your transcript.</p> 
    /// <p>If you included <code>OutputBucketName</code> in your transcription job request, this is the URI of that bucket. If you also included <code>OutputKey</code> in your request, your output is located in the path you specified in your request.</p> 
...
impl  std::fmt::Debug for Transcript  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("redacted_transcript_file_uri", &self.redacted_transcript_file_uri);
        formatter.finish()
    }
}
...
pub struct Media  {
    ...
    #[doc(hidden)]pub media_file_uri: std::option::Option<std::string::String>,
    ...
    /// </important>
    #[doc(hidden)]pub redacted_media_file_uri: std::option::Option<std::string::String>,
}
impl Media {
    /// <p>The Amazon S3 location of the media file you want to transcribe. For example:</p> 
    /// <ul> 
...
pub struct MedicalTranscriptionJob  {
    ...
    #[doc(hidden)]pub medical_transcription_job_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub media: std::option::Option<crate::model::Media>,
    /// <p>Provides you with the Amazon S3 URI you can use to access your transcript.</p>
    #[doc(hidden)]pub transcript: std::option::Option<crate::model::MedicalTranscript>,
    ...
    #[doc(hidden)]pub settings: std::option::Option<crate::model::MedicalTranscriptionSetting>,
    ...
    #[doc(hidden)]pub content_identification_type: std::option::Option<crate::model::MedicalContentIdentificationType>,
    /// <p>Describes the medical specialty represented in your media.</p>
    #[doc(hidden)]pub specialty: std::option::Option<crate::model::Specialty>,
...
impl  std::fmt::Debug for MedicalTranscriptionJob  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("medical_transcription_job_name", &self.medical_transcription_job_name);
        formatter.field("transcription_job_status", &self.transcription_job_status);
        formatter.field("language_code", &self.language_code);
        formatter.field("media_sample_rate_hertz", &self.media_sample_rate_hertz);
        formatter.field("media_format", &self.media_format);
        ...
        formatter.field("failure_reason", &self.failure_reason);
        formatter.field("settings", &self.settings);
        formatter.field("content_identification_type", &self.content_identification_type);
...
pub struct CallAnalyticsJob  {
    ...
    #[doc(hidden)]pub call_analytics_job_name: std::option::Option<std::string::String>,
    /// <p>Provides the status of the specified Call Analytics job.</p> 
    /// <p>If the status is <code>COMPLETED</code>, the job is finished and you can find the results at the location specified in <code>TranscriptFileUri</code> (or <code>RedactedTranscriptFileUri</code>, if you requested transcript redaction). If the status is <code>FAILED</code>, <code>FailureReason</code> provides details on why your transcription job failed.</p>
    #[doc(hidden)]pub call_analytics_job_status: std::option::Option<crate::model::CallAnalyticsJobStatus>,
    ...
    #[doc(hidden)]pub settings: std::option::Option<crate::model::CallAnalyticsJobSettings>,
    ...
    #[doc(hidden)]pub channel_definitions: std::option::Option<std::vec::Vec<crate::model::ChannelDefinition>>,
}
...
pub struct TranscriptionJobSummary  {
    ...
    #[doc(hidden)]pub output_location_type: std::option::Option<crate::model::OutputLocationType>,
...
pub struct LanguageModel  {
    ...
    #[doc(hidden)]pub upgrade_availability: std::option::Option<bool>,
...
pub struct InputDataConfig  {
    ...
    #[doc(hidden)]pub tuning_data_s3_uri: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of an IAM role that has permissions to access the Amazon S3 bucket that contains your input files. If the role you specify doesn’t have the appropriate permissions to access the specified Amazon S3 location, your request fails.</p> 
    /// <p>IAM role ARNs have the format <code>arn:partition:iam::account:role/role-name-with-path</code>. For example: <code>arn:aws:iam::111122223333:role/Admin</code>.</p> 
    /// <p>For more information, see <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html#identifiers-arns">IAM ARNs</a>.</p>
    #[doc(hidden)]pub data_access_role_arn: std::option::Option<std::string::String>,
