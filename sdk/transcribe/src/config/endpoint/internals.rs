...
pub(super) fn resolve_endpoint(
    ...
    if let Some(region) = region {
        ...
        if let Some(partition_result) = partition_resolver.resolve_partition(region.as_ref() as &str, _diagnostic_collector) {
            ...
            if (region.as_ref() as &str) == ("cn-north-1") {
                return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                    .url("https://cn.transcribe.cn-north-1.amazonaws.com.cn".to_string())
                    .build());
            }
            if (region.as_ref() as &str) == ("cn-northwest-1") {
                return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                    .url("https://cn.transcribe.cn-northwest-1.amazonaws.com.cn".to_string())
                    .build());
            }
            return Ok(::aws_smithy_types::endpoint::Endpoint::builder()
                .url({
