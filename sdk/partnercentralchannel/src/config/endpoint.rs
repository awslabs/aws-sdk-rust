...
mod test {
    ...
    fn test_3() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel-fips.global.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel-fips.global.api.aws")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
    ...
    fn test_4() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel.global.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel.global.api.aws")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
    ...
    fn test_5() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel-fips.global.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel-fips.global.api.amazonwebservices.com.cn")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
    ...
    fn test_6() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel.global.api.amazonwebservices.com.cn");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel.global.api.amazonwebservices.com.cn")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
    ...
    fn test_7() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel-fips.us-gov.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel-fips.us-gov.api.aws")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
    ...
    fn test_8() {
        ...
        let resolver = crate::config::endpoint::DefaultResolver::new();
        let endpoint = resolver.resolve_endpoint(&params);
        let endpoint = endpoint.expect("Expected valid endpoint: https://partnercentral-channel.us-gov.api.aws");
        assert_eq!(
            endpoint,
            ::aws_smithy_types::endpoint::Endpoint::builder()
                .url("https://partnercentral-channel.us-gov.api.aws")
                .auth_scheme(
                    ::aws_smithy_types::endpoint::EndpointAuthScheme::with_capacity("sigv4a", 1)
                        .put("signingRegionSet", vec!["*".to_string().into()])
                )
...
/// Endpoint resolver trait specific to Partner Central Channel API
...
const NODES: [crate::endpoint_lib::bdd_interpreter::BddNode; 8] = [
