...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteLoggingConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("DeleteLoggingConfiguration", "wafregional"));
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteLoggingConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_delete_logging_configuration::ser_delete_logging_configuration_input(&input)?,
        );
