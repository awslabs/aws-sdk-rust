...
/// <ul>
/// <li>
/// <p>Whether to insert or delete the <code>RegexPatternString</code>.</p></li>
/// <li>
...
/// <ol>
/// <li>
/// <p>Create a <code>RegexPatternSet.</code> For more information, see <code>CreateRegexPatternSet</code>.</p></li>
/// <li>
...
/// <li>
/// <p>Submit an <code>UpdateRegexPatternSet</code> request to specify the regular expression pattern that you want AWS WAF to watch for.</p></li>
/// </ol>
