...
/// Orchestration and serialization glue logic for `DeleteRateBasedRule`.
...
impl DeleteRateBasedRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteRateBasedRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteRateBasedRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteRateBasedRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteRateBasedRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteRateBasedRule")
...
.with_interceptor(DeleteRateBasedRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError>::new());
...
#[derive(Debug)]
            struct DeleteRateBasedRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteRateBasedRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_rate_based_rule::de_delete_rate_based_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_rate_based_rule::de_delete_rate_based_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteRateBasedRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteRateBasedRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_rate_based_rule::DeleteRateBasedRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_rate_based_rule::DeleteRateBasedRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_rate_based_rule::ser_delete_rate_based_rule_input(&input)?);
...
#[derive(Debug)]
            struct DeleteRateBasedRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteRateBasedRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteRateBasedRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteRateBasedRuleInput>()
                        .ok_or("failed to downcast to DeleteRateBasedRuleInput")?;
...
pub enum DeleteRateBasedRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteRateBasedRuleError) for what information is available for the error.")]
...
impl DeleteRateBasedRuleError {
    /// Creates the `DeleteRateBasedRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteRateBasedRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteRateBasedRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_rate_based_rule::DeleteRateBasedRuleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_rate_based_rule::_delete_rate_based_rule_output::DeleteRateBasedRuleOutput;

pub use crate::operation::delete_rate_based_rule::_delete_rate_based_rule_input::DeleteRateBasedRuleInput;

mod _delete_rate_based_rule_input;

mod _delete_rate_based_rule_output;
