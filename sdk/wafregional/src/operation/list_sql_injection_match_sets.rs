...
impl ListSqlInjectionMatchSetsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSqlInjectionMatchSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_sql_injection_match_sets::de_list_sql_injection_match_sets_http_response_with_props(
                status, headers, body,
            )
        }
    }
