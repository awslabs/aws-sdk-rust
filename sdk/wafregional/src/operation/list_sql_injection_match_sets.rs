...
impl ListSqlInjectionMatchSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListSqlInjectionMatchSets`](crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSqlInjectionMatchSets {
                type Output = std::result::Result<crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSetsOutput, crate::operation::list_sql_injection_match_sets::ListSqlInjectionMatchSetsError>;
