...
impl CreateRegexPatternSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_regex_pattern_set::CreateRegexPatternSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_regex_pattern_set::CreateRegexPatternSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_regex_pattern_set::CreateRegexPatternSetOutput, crate::operation::create_regex_pattern_set::CreateRegexPatternSetError, Self> {
