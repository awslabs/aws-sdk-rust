...
impl UpdateSqlInjectionMatchSetInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSet::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSqlInjectionMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_sql_injection_match_set::de_update_sql_injection_match_set_http_response_with_props(
                status, headers, body,
            )
        }
    }
