...
impl UpdateSqlInjectionMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSqlInjectionMatchSet`](crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_sql_injection_match_set::ser_update_sql_injection_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateSqlInjectionMatchSet", "wafregional"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateSqlInjectionMatchSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateSqlInjectionMatchSet {
                type Output = std::result::Result<crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetOutput, crate::operation::update_sql_injection_match_set::UpdateSqlInjectionMatchSetError>;
