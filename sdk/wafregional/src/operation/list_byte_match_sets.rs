...
impl ListByteMatchSetsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_byte_match_sets::ListByteMatchSets,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_byte_match_sets::ser_list_byte_match_sets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListByteMatchSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_byte_match_sets::de_list_byte_match_sets_http_response_with_props(status, headers, body)
        }
    }
}
