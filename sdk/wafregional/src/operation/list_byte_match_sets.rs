...
impl ListByteMatchSetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_byte_match_sets::ser_list_byte_match_sets_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_byte_match_sets::ListByteMatchSets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListByteMatchSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_byte_match_sets::de_list_byte_match_sets_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_byte_match_sets::ListByteMatchSetsError
{
