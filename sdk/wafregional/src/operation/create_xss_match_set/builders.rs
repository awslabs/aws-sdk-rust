...
impl CreateXssMatchSetInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_xss_match_set();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_xss_match_set::CreateXssMatchSetOutput,
                    crate::operation::create_xss_match_set::CreateXssMatchSetError,
                > for CreateXssMatchSetFluentBuilder
            {
                fn send(
                    self,
...
impl CreateXssMatchSetFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::create_xss_match_set::builders::CreateXssMatchSetInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_xss_match_set::CreateXssMatchSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_xss_match_set::CreateXssMatchSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::create_xss_match_set::CreateXssMatchSet::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_xss_match_set::CreateXssMatchSetOutput, crate::operation::create_xss_match_set::CreateXssMatchSetError, Self> {
