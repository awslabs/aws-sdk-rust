...
impl ListXssMatchSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListXssMatchSets`](crate::operation::list_xss_match_sets::ListXssMatchSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_xss_match_sets::ListXssMatchSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_xss_match_sets::ListXssMatchSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_xss_match_sets::ser_list_xss_match_sets_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_xss_match_sets::ListXssMatchSets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListXssMatchSets {
                type Output = std::result::Result<crate::operation::list_xss_match_sets::ListXssMatchSetsOutput, crate::operation::list_xss_match_sets::ListXssMatchSetsError>;
