...
impl ListXssMatchSetsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_xss_match_sets::ser_list_xss_match_sets_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListXssMatchSets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_xss_match_sets::de_list_xss_match_sets_http_response_with_props(status, headers, body)
        }
    }
}
