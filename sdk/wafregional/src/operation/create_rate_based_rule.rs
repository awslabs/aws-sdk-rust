...
impl CreateRateBasedRuleInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_rate_based_rule::ser_create_rate_based_rule_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_rate_based_rule::CreateRateBasedRule::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_rate_based_rule::CreateRateBasedRuleError
{
