...
impl CreateRateBasedRuleInput {
    /// Consumes the builder and constructs an Operation<[`CreateRateBasedRule`](crate::operation::create_rate_based_rule::CreateRateBasedRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_rate_based_rule::CreateRateBasedRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_rate_based_rule::CreateRateBasedRuleInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_rate_based_rule::ser_create_rate_based_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_rate_based_rule::CreateRateBasedRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRateBasedRule {
                type Output = std::result::Result<crate::operation::create_rate_based_rule::CreateRateBasedRuleOutput, crate::operation::create_rate_based_rule::CreateRateBasedRuleError>;
