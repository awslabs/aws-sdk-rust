...
/// Orchestration and serialization glue logic for `CreateRateBasedRule`.
...
impl CreateRateBasedRule {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_rate_based_rule::CreateRateBasedRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_rate_based_rule::CreateRateBasedRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_rate_based_rule::CreateRateBasedRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_rate_based_rule::CreateRateBasedRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateRateBasedRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateRateBasedRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateRateBasedRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateRateBasedRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateRateBasedRule")
...
.with_interceptor(CreateRateBasedRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_rate_based_rule::CreateRateBasedRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_rate_based_rule::CreateRateBasedRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_rate_based_rule::CreateRateBasedRuleError>::new());
...
#[derive(Debug)]
            struct CreateRateBasedRuleResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateRateBasedRuleResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_rate_based_rule::de_create_rate_based_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_rate_based_rule::de_create_rate_based_rule_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateRateBasedRuleRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateRateBasedRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_rate_based_rule::CreateRateBasedRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_rate_based_rule::CreateRateBasedRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_rate_based_rule::ser_create_rate_based_rule_input(&input)?);
...
#[derive(Debug)]
            struct CreateRateBasedRuleEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateRateBasedRuleEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateRateBasedRuleEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateRateBasedRuleInput>()
                        .ok_or("failed to downcast to CreateRateBasedRuleInput")?;
...
pub enum CreateRateBasedRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateRateBasedRuleError) for what information is available for the error.")]
...
impl CreateRateBasedRuleError {
    /// Creates the `CreateRateBasedRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateRateBasedRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateRateBasedRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_rate_based_rule::CreateRateBasedRuleError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_rate_based_rule::_create_rate_based_rule_output::CreateRateBasedRuleOutput;

pub use crate::operation::create_rate_based_rule::_create_rate_based_rule_input::CreateRateBasedRuleInput;

mod _create_rate_based_rule_input;

mod _create_rate_based_rule_output;
