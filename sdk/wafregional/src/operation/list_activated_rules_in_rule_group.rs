...
impl ::aws_smithy_http::response::ParseStrictResponse for ListActivatedRulesInRuleGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_activated_rules_in_rule_group::de_list_activated_rules_in_rule_group_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_activated_rules_in_rule_group::ListActivatedRulesInRuleGroupError
{
