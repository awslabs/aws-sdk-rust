...
impl ListSubscribedRuleGroupsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput, crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError, Self> {
