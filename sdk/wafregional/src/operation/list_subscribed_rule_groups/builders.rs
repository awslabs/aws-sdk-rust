...
impl ListSubscribedRuleGroupsFluentBuilder  {
    /// Creates a new `ListSubscribedRuleGroups`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput, aws_smithy_http::result::SdkError<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>>
                     {
