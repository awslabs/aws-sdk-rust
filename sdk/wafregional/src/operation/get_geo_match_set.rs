...
impl GetGeoMatchSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_geo_match_set::GetGeoMatchSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_geo_match_set::ser_get_geo_match_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGeoMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_geo_match_set::de_get_geo_match_set_http_response_with_props(status, headers, body)
        }
    }
}
