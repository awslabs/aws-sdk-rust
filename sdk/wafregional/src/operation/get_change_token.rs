...
impl GetChangeTokenInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_change_token::GetChangeToken, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_change_token::ser_get_change_token_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChangeToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_change_token::de_get_change_token_http_response_with_props(status, headers, body)
        }
    }
}
