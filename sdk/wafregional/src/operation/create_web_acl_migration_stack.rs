...
impl CreateWebAclMigrationStackInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStack::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWebACLMigrationStack {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_web_acl_migration_stack::de_create_web_acl_migration_stack_http_response_with_props(
                status, headers, body,
            )
        }
    }
