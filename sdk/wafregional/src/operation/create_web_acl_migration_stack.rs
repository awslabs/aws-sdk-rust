...
/// Orchestration and serialization glue logic for `CreateWebACLMigrationStack`.
...
impl CreateWebACLMigrationStack {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_web_acl_migration_stack::CreateWebAclMigrationStackOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_web_acl_migration_stack::CreateWebAclMigrationStackOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateWebACLMigrationStack {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateWebACLMigrationStack");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateWebACLMigrationStackRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateWebACLMigrationStackResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateWebACLMigrationStack")
...
.with_interceptor(CreateWebACLMigrationStackEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError>::new());
...
#[derive(Debug)]
            struct CreateWebACLMigrationStackResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateWebACLMigrationStackResponseDeserializer {
...
#[derive(Debug)]
            struct CreateWebACLMigrationStackRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateWebACLMigrationStackRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_web_acl_migration_stack::CreateWebAclMigrationStackInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_web_acl_migration_stack::CreateWebAclMigrationStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_web_acl_migration_stack::ser_create_web_acl_migration_stack_input(&input)?);
...
#[derive(Debug)]
            struct CreateWebACLMigrationStackEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateWebACLMigrationStackEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateWebACLMigrationStackEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateWebAclMigrationStackInput>()
                        .ok_or("failed to downcast to CreateWebAclMigrationStackInput")?;
...
pub enum CreateWebACLMigrationStackError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateWebACLMigrationStackError) for what information is available for the error.")]
...
impl CreateWebACLMigrationStackError {
    /// Creates the `CreateWebACLMigrationStackError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateWebACLMigrationStackError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::WafEntityMigrationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateWebACLMigrationStackError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_web_acl_migration_stack::CreateWebACLMigrationStackError {
