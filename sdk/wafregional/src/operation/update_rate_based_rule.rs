...
impl UpdateRateBasedRuleInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_rate_based_rule::ser_update_rate_based_rule_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_rate_based_rule::UpdateRateBasedRule::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_rate_based_rule::UpdateRateBasedRuleError
{
