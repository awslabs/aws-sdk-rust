...
impl UpdateRateBasedRuleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRateBasedRule`](crate::operation::update_rate_based_rule::UpdateRateBasedRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_rate_based_rule::UpdateRateBasedRule, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_rate_based_rule::ser_update_rate_based_rule_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_rate_based_rule::UpdateRateBasedRule::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateRateBasedRule {
                type Output = std::result::Result<crate::operation::update_rate_based_rule::UpdateRateBasedRuleOutput, crate::operation::update_rate_based_rule::UpdateRateBasedRuleError>;
