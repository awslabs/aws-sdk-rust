...
impl UpdateRateBasedRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_rate_based_rule::UpdateRateBasedRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_rate_based_rule::UpdateRateBasedRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_rate_based_rule::UpdateRateBasedRuleOutput, crate::operation::update_rate_based_rule::UpdateRateBasedRuleError, Self> {
