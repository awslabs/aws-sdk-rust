...
impl crate::operation::update_size_constraint_set::builders::UpdateSizeConstraintSetInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.update_size_constraint_set();
...
/// <ul>
/// <li>
/// <p>Whether to insert or delete the object from the array. If you want to change a <code>SizeConstraintSetUpdate</code> object, you delete the existing object and add a new one.</p></li>
/// <li>
/// <p>The part of a web request that you want AWS WAF to evaluate, such as the length of a query string or the length of the <code>User-Agent</code> header.</p></li>
/// <li>
/// <p>Whether to perform any transformations on the request, such as converting it to lowercase, before checking its length. Note that transformations of the request body are not supported because the AWS resource forwards only the first <code>8192</code> bytes of your request to AWS WAF.</p>
/// <p>You can only specify a single type of TextTransformation.</p></li>
/// <li>
/// <p>A <code>ComparisonOperator</code> used for evaluating the selected part of the request against the specified <code>Size</code>, such as equals, greater than, less than, and so on.</p></li>
/// <li>
/// <p>The length, in bytes, that you want AWS WAF to watch for in selected part of the request. The length is computed after applying the transformation.</p></li>
/// </ul>
...
/// <ol>
/// <li>
/// <p>Create a <code>SizeConstraintSet.</code> For more information, see <code>CreateSizeConstraintSet</code>.</p></li>
/// <li>
/// <p>Use <code>GetChangeToken</code> to get the change token that you provide in the <code>ChangeToken</code> parameter of an <code>UpdateSizeConstraintSet</code> request.</p></li>
/// <li>
/// <p>Submit an <code>UpdateSizeConstraintSet</code> request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.</p></li>
/// </ol>
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::update_size_constraint_set::UpdateSizeConstraintSetOutput,
        crate::operation::update_size_constraint_set::UpdateSizeConstraintSetError,
    > for UpdateSizeConstraintSetFluentBuilder
{
    fn send(
        self,
...
impl UpdateSizeConstraintSetFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::update_size_constraint_set::UpdateSizeConstraintSet::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::update_size_constraint_set::UpdateSizeConstraintSet::orchestrate(&runtime_plugins, input).await
    }
