...
impl CreateGeoMatchSetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_geo_match_set::ser_create_geo_match_set_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGeoMatchSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_geo_match_set::de_create_geo_match_set_http_response_with_props(status, headers, body)
        }
    }
}
