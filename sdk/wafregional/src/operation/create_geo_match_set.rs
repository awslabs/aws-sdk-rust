...
impl CreateGeoMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateGeoMatchSet`](crate::operation::create_geo_match_set::CreateGeoMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_geo_match_set::CreateGeoMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_geo_match_set::CreateGeoMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_geo_match_set::ser_create_geo_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_geo_match_set::CreateGeoMatchSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateGeoMatchSet {
                type Output = std::result::Result<crate::operation::create_geo_match_set::CreateGeoMatchSetOutput, crate::operation::create_geo_match_set::CreateGeoMatchSetError>;
