...
impl UpdateXssMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateXssMatchSet`](crate::operation::update_xss_match_set::UpdateXssMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_xss_match_set::UpdateXssMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_xss_match_set::UpdateXssMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_xss_match_set::ser_update_xss_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_xss_match_set::UpdateXssMatchSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateXssMatchSet", "wafregional"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `UpdateXssMatchSet`.
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateXssMatchSet {
                type Output = std::result::Result<crate::operation::update_xss_match_set::UpdateXssMatchSetOutput, crate::operation::update_xss_match_set::UpdateXssMatchSetError>;
