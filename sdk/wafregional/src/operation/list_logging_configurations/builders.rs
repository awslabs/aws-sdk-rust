...
impl ListLoggingConfigurationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_logging_configurations::ListLoggingConfigurationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_logging_configurations::ListLoggingConfigurationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_logging_configurations::ListLoggingConfigurationsOutput, crate::operation::list_logging_configurations::ListLoggingConfigurationsError, Self> {
