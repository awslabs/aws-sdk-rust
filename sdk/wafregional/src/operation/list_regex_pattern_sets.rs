...
/// Orchestration and serialization glue logic for `ListRegexPatternSets`.
...
impl ListRegexPatternSets {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRegexPatternSets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRegexPatternSets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRegexPatternSetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRegexPatternSetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRegexPatternSets")
...
.with_interceptor(ListRegexPatternSetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError>::new());
...
#[derive(Debug)]
            struct ListRegexPatternSetsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRegexPatternSetsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_regex_pattern_sets::de_list_regex_pattern_sets_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_regex_pattern_sets::de_list_regex_pattern_sets_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRegexPatternSetsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRegexPatternSetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_regex_pattern_sets::ListRegexPatternSetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_regex_pattern_sets::ListRegexPatternSetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_regex_pattern_sets::ser_list_regex_pattern_sets_input(&input)?);
...
#[derive(Debug)]
            struct ListRegexPatternSetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRegexPatternSetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRegexPatternSetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRegexPatternSetsInput>()
                        .ok_or("failed to downcast to ListRegexPatternSetsInput")?;
...
pub enum ListRegexPatternSetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRegexPatternSetsError) for what information is available for the error.")]
...
impl ListRegexPatternSetsError {
    /// Creates the `ListRegexPatternSetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRegexPatternSetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRegexPatternSetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_regex_pattern_sets::ListRegexPatternSetsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_regex_pattern_sets::_list_regex_pattern_sets_output::ListRegexPatternSetsOutput;

pub use crate::operation::list_regex_pattern_sets::_list_regex_pattern_sets_input::ListRegexPatternSetsInput;

mod _list_regex_pattern_sets_input;

mod _list_regex_pattern_sets_output;
