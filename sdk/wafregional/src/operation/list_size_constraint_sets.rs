...
impl ListSizeConstraintSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListSizeConstraintSets`](crate::operation::list_size_constraint_sets::ListSizeConstraintSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_size_constraint_sets::ListSizeConstraintSets, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_size_constraint_sets::ListSizeConstraintSetsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_size_constraint_sets::ser_list_size_constraint_sets_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_size_constraint_sets::ListSizeConstraintSets::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListSizeConstraintSets {
                type Output = std::result::Result<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsOutput, crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError>;
