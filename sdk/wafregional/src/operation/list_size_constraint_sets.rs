...
/// Orchestration and serialization glue logic for `ListSizeConstraintSets`.
...
impl ListSizeConstraintSets {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_size_constraint_sets::ListSizeConstraintSetsInput,
                    ) -> ::std::result::Result<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSizeConstraintSets {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSizeConstraintSets");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSizeConstraintSetsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSizeConstraintSetsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSizeConstraintSets")
...
.with_interceptor(ListSizeConstraintSetsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError>::new());
...
#[derive(Debug)]
            struct ListSizeConstraintSetsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSizeConstraintSetsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_size_constraint_sets::de_list_size_constraint_sets_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_size_constraint_sets::de_list_size_constraint_sets_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListSizeConstraintSetsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSizeConstraintSetsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_size_constraint_sets::ListSizeConstraintSetsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_size_constraint_sets::ListSizeConstraintSetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_size_constraint_sets::ser_list_size_constraint_sets_input(&input)?);
...
#[derive(Debug)]
            struct ListSizeConstraintSetsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSizeConstraintSetsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListSizeConstraintSetsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListSizeConstraintSetsInput>()
                        .ok_or("failed to downcast to ListSizeConstraintSetsInput")?;
...
pub enum ListSizeConstraintSetsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSizeConstraintSetsError) for what information is available for the error.")]
...
impl ListSizeConstraintSetsError {
    /// Creates the `ListSizeConstraintSetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListSizeConstraintSetsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSizeConstraintSetsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_size_constraint_sets::ListSizeConstraintSetsError {
...
mod _list_size_constraint_sets_output;
