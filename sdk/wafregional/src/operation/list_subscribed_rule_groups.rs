...
/// Orchestration and serialization glue logic for `ListSubscribedRuleGroups`.
...
impl ListSubscribedRuleGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsInput,
                    ) -> ::std::result::Result<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSubscribedRuleGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListSubscribedRuleGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListSubscribedRuleGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListSubscribedRuleGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSubscribedRuleGroups")
...
.with_interceptor(ListSubscribedRuleGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>::new());
...
#[derive(Debug)]
            struct ListSubscribedRuleGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSubscribedRuleGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_subscribed_rule_groups::de_list_subscribed_rule_groups_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_subscribed_rule_groups::de_list_subscribed_rule_groups_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListSubscribedRuleGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSubscribedRuleGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_subscribed_rule_groups::ser_list_subscribed_rule_groups_input(&input)?);
...
#[derive(Debug)]
            struct ListSubscribedRuleGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSubscribedRuleGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListSubscribedRuleGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListSubscribedRuleGroupsInput>()
                        .ok_or("failed to downcast to ListSubscribedRuleGroupsInput")?;
...
pub enum ListSubscribedRuleGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSubscribedRuleGroupsError) for what information is available for the error.")]
...
impl ListSubscribedRuleGroupsError {
    /// Creates the `ListSubscribedRuleGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListSubscribedRuleGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSubscribedRuleGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError {
...
mod _list_subscribed_rule_groups_output;
