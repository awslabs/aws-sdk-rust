...
impl ListSubscribedRuleGroupsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscribedRuleGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_subscribed_rule_groups::de_list_subscribed_rule_groups_http_response_with_props(status, headers, body)
        }
    }
}
