...
impl ListSubscribedRuleGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListSubscribedRuleGroups`](crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_subscribed_rule_groups::ser_list_subscribed_rule_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListSubscribedRuleGroups", "wafregional"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListSubscribedRuleGroups`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListSubscribedRuleGroups {
                type Output = std::result::Result<crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsOutput, crate::operation::list_subscribed_rule_groups::ListSubscribedRuleGroupsError>;
