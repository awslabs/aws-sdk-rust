...
impl DeleteWebAclInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_web_acl::DeleteWebACL::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWebACL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_web_acl::de_delete_web_acl_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_web_acl::de_delete_web_acl_http_response_with_props(
                status, headers, body,
            )
        }
    }
