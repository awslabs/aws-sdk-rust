...
impl GetRegexMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`GetRegexMatchSet`](crate::operation::get_regex_match_set::GetRegexMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_regex_match_set::GetRegexMatchSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_regex_match_set::GetRegexMatchSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_regex_match_set::ser_get_regex_match_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_regex_match_set::GetRegexMatchSet::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetRegexMatchSet {
                type Output = std::result::Result<crate::operation::get_regex_match_set::GetRegexMatchSetOutput, crate::operation::get_regex_match_set::GetRegexMatchSetError>;
