...
impl DeleteRegexPatternSetFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetOutput, crate::operation::delete_regex_pattern_set::DeleteRegexPatternSetError, Self> {
