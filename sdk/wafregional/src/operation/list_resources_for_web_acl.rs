...
impl ListResourcesForWebACL {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_resources_for_web_acl::ListResourcesForWebACLError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_resources_for_web_acl::ListResourcesForWebAclOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListResourcesForWebACL",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListResourcesForWebACL {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListResourcesForWebACLRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListResourcesForWebACLResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListResourcesForWebACL")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListResourcesForWebACLTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListResourcesForWebACLTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListResourcesForWebACLTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListResourcesForWebAclInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListResourcesForWebACLResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_resources_for_web_acl::de_list_resources_for_web_acl_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_resources_for_web_acl::de_list_resources_for_web_acl_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListResourcesForWebACLRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_resources_for_web_acl::ListResourcesForWebAclInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_resources_for_web_acl::ListResourcesForWebAclInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_resources_for_web_acl::ser_list_resources_for_web_acl_input(&input)?,
        );
