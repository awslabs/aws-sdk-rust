...
pub struct ByteMatchTuple {
    ...
    pub target_string: std::option::Option<smithy_types::Blob>,
    /// <p>Text transformations eliminate some of the unusual formatting that attackers use in web requests in an effort to bypass AWS WAF.
    /// If you specify a transformation, AWS WAF performs the transformation on <code>FieldToMatch</code> before inspecting it for a match.</p>
    /// <p>You can only specify a single type of TextTransformation.</p>      
    /// <p>
...
pub mod byte_match_tuple {
    ...
    pub struct Builder {
        pub(crate) field_to_match: std::option::Option<crate::model::FieldToMatch>,
        pub(crate) target_string: std::option::Option<smithy_types::Blob>,
        pub(crate) text_transformation: std::option::Option<crate::model::TextTransformation>,
    ...
    impl Builder {
        ...
        /// </p>
        /// <p>The value that you want AWS WAF to search for. The SDK automatically base64 encodes the value.</p>
        pub fn target_string(mut self, input: smithy_types::Blob) -> Self {
            self.target_string = Some(input);
            self
        }
        pub fn set_target_string(mut self, input: std::option::Option<smithy_types::Blob>) -> Self {
