            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DefaultAction" => {
                            builder = builder.set_default_action(crate::protocol_serde::shape_waf_action::de_waf_action(tokens)?);
                        }
                        "Rules" => {
                            builder = builder.set_rules(crate::protocol_serde::shape_activated_rules::de_activated_rules(tokens)?);
                        }
                        "WebACLArn" => {
