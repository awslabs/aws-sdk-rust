...
pub fn ser_create_web_acl_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWebAclInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
