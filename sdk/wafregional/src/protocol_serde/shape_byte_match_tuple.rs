...
pub fn ser_byte_match_tuple(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ByteMatchTuple) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_byte_match_tuple<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ByteMatchTuple>, aws_smithy_json::deserialize::error::DeserializeError>
