...
pub(crate) fn de_sql_injection_match_tuple<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::SqlInjectionMatchTuple>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "TextTransformation" => {
                            builder = builder.set_text_transformation(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::TextTransformation::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
