...
pub fn ser_get_sampled_requests_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetSampledRequestsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
