...
pub fn ser_update_geo_match_set_input(
    object: &mut aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::update_geo_match_set::UpdateGeoMatchSetInput,
        ...
        for item_5 in var_3 {
            {
                ...
                crate::protocol_serde::shape_geo_match_set_update::ser_geo_match_set_update(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
