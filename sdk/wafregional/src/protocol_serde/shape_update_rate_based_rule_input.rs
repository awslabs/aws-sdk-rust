...
pub fn ser_update_rate_based_rule_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateRateBasedRuleInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
