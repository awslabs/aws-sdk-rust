...
pub fn ser_byte_match_set_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ByteMatchSetUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
