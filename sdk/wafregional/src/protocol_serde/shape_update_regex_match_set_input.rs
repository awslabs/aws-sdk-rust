...
pub fn ser_update_regex_match_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_regex_match_set::UpdateRegexMatchSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
