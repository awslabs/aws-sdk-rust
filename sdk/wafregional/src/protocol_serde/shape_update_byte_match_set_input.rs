...
pub fn ser_update_byte_match_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateByteMatchSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
