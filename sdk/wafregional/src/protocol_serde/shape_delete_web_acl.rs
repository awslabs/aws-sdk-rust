    ...
    Err(match error_code {
        ...
        "WAFInvalidAccountException" => {
            crate::error::DeleteWebACLError::WafInvalidAccountException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_waf_invalid_account_exception::de_waf_invalid_account_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteWebACLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "WAFNonEmptyEntityException" => {
            crate::error::DeleteWebACLError::WafNonEmptyEntityException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_waf_non_empty_entity_exception::de_waf_non_empty_entity_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteWebACLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "WAFReferencedItemException" => {
            crate::error::DeleteWebACLError::WafReferencedItemException({
                ...
                let mut tmp = {
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_waf_referenced_item_exception::de_waf_referenced_item_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteWebACLError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                };
                if tmp.message.is_none() {
        ...
        "WAFStaleDataException" => crate::error::DeleteWebACLError::WafStaleDataException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_waf_stale_data_exception::de_waf_stale_data_exception_json_err(response.body().as_ref(), output).map_err(crate::error::DeleteWebACLError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
...
pub fn de_delete_web_acl_http_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_delete_web_acl::de_delete_web_acl(
