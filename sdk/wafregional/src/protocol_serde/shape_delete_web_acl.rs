...
pub fn de_delete_web_acl_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_web_acl::de_delete_web_acl(_response_body, output)
            .map_err(crate::operation::delete_web_acl::DeleteWebACLError::unhandled)?;
...
) -> Result<crate::operation::delete_web_acl::builders::DeleteWebAclOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
