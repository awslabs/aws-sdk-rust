...
/// match predicatetype {
///     PredicateType::ByteMatch => { /* ... */ },
///     PredicateType::GeoMatch => { /* ... */ },
///     PredicateType::IpMatch => { /* ... */ },
///     PredicateType::RegexMatch => { /* ... */ },
///     PredicateType::SizeConstraint => { /* ... */ },
///     PredicateType::SqlInjectionMatch => { /* ... */ },
///     PredicateType::XssMatch => { /* ... */ },
///     other @ _ if other.as_str() == "NewFeature" => { /* handles a case for `NewFeature` */ },
///     _ => { /* ... */ },
/// }
/// ```
/// The above code demonstrates that when `predicatetype` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `PredicateType::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `PredicateType::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `PredicateType::NewFeature` is defined.
...
impl ::std::convert::From<&str> for PredicateType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PredicateType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PredicateType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PredicateType::from(s))
    }
}
impl PredicateType {
...
impl ::std::convert::AsRef<str> for PredicateType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
