...
impl  RegexPatternSet  {
    ...
    pub fn regex_pattern_strings(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.regex_pattern_strings.deref()
    }
}
impl RegexPatternSet {
        ...
        ::std::result::Result::Ok(
            crate::types::RegexPatternSet {
                regex_pattern_set_id: self.regex_pattern_set_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("regex_pattern_set_id", "regex_pattern_set_id was not specified but it is required when building RegexPatternSet")
                    )?
                ,
                name: self.name
                ,
                regex_pattern_strings: self.regex_pattern_strings
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("regex_pattern_strings", "regex_pattern_strings was not specified but it is required when building RegexPatternSet")
                    )?
                ,
            }
        )
