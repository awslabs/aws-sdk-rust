...
impl std::fmt::Display for ListResourcesForWebACLError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            ListResourcesForWebACLErrorKind::WafInvalidAccountException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ListResourcesForWebACLError {
    ...
    pub fn is_waf_invalid_account_exception(&self) -> bool {
        matches!(&self.kind, ListResourcesForWebACLErrorKind::WafInvalidAccountException(_))
    }
...
impl std::fmt::Display for GetWebACLForResourceError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GetWebACLForResourceErrorKind::WafInvalidAccountException(_inner) =>
            _inner.fmt(f)
            ,
...
impl GetWebACLForResourceError {
    ...
    pub fn is_waf_invalid_account_exception(&self) -> bool {
        matches!(&self.kind, GetWebACLForResourceErrorKind::WafInvalidAccountException(_))
    }
...
impl std::fmt::Display for DisassociateWebACLError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            DisassociateWebACLErrorKind::WafInvalidAccountException(_inner) =>
            _inner.fmt(f)
            ,
...
impl DisassociateWebACLError {
    ...
    pub fn is_waf_invalid_account_exception(&self) -> bool {
        matches!(&self.kind, DisassociateWebACLErrorKind::WafInvalidAccountException(_))
    }
...
impl std::fmt::Display for AssociateWebACLError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            AssociateWebACLErrorKind::WafInvalidAccountException(_inner) =>
            _inner.fmt(f)
            ,
...
impl AssociateWebACLError {
    ...
    pub fn is_waf_invalid_account_exception(&self) -> bool {
        matches!(&self.kind, AssociateWebACLErrorKind::WafInvalidAccountException(_))
    }
