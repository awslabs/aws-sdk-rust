...
impl super::Client {
    ...
    ///   - [`regex_match_set_id(impl ::std::convert::Into<String>)`](crate::operation::get_regex_match_set::builders::GetRegexMatchSetFluentBuilder::regex_match_set_id) / [`set_regex_match_set_id(Option<String>)`](crate::operation::get_regex_match_set::builders::GetRegexMatchSetFluentBuilder::set_regex_match_set_id): <p>The <code>RegexMatchSetId</code> of the <code>RegexMatchSet</code> that you want to get. <code>RegexMatchSetId</code> is returned by <code>CreateRegexMatchSet</code> and by <code>ListRegexMatchSets</code>.</p>
