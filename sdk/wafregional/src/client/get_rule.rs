...
impl super::Client {
    ...
    ///   - [`rule_id(impl Into<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::rule_id) / [`set_rule_id(Option<String>)`](crate::operation::get_rule::builders::GetRuleFluentBuilder::set_rule_id):<br>required: **true**<br><p>The <code>RuleId</code> of the <code>Rule</code> that you want to get. <code>RuleId</code> is returned by <code>CreateRule</code> and by <code>ListRules</code>.</p><br>
