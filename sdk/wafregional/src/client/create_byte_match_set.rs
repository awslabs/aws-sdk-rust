...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_byte_match_set::builders::CreateByteMatchSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_byte_match_set::builders::CreateByteMatchSetFluentBuilder::set_name): <p>A friendly name or description of the <code>ByteMatchSet</code>. You can't change <code>Name</code> after you create a <code>ByteMatchSet</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::create_byte_match_set::builders::CreateByteMatchSetFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::create_byte_match_set::builders::CreateByteMatchSetFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
