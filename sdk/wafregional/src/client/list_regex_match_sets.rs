...
impl super::Client {
    ...
    ///   - [`limit(i32)`](crate::operation::list_regex_match_sets::builders::ListRegexMatchSetsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_regex_match_sets::builders::ListRegexMatchSetsFluentBuilder::set_limit): <p>Specifies the number of <code>RegexMatchSet</code> objects that you want AWS WAF to return for this request. If you have more <code>RegexMatchSet</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>RegexMatchSet</code> objects.</p>
