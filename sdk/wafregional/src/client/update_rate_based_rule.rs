...
impl super::Client {
    ...
    ///   - [`updates(RuleUpdate)`](crate::operation::update_rate_based_rule::builders::UpdateRateBasedRuleFluentBuilder::updates) / [`set_updates(Option<Vec<RuleUpdate>>)`](crate::operation::update_rate_based_rule::builders::UpdateRateBasedRuleFluentBuilder::set_updates): <p>An array of <code>RuleUpdate</code> objects that you want to insert into or delete from a <code>RateBasedRule</code>. </p>
    ///   - [`rate_limit(i64)`](crate::operation::update_rate_based_rule::builders::UpdateRateBasedRuleFluentBuilder::rate_limit) / [`set_rate_limit(Option<i64>)`](crate::operation::update_rate_based_rule::builders::UpdateRateBasedRuleFluentBuilder::set_rate_limit): <p>The maximum number of requests, which have an identical value in the field specified by the <code>RateKey</code>, allowed in a five-minute period. If the number of requests exceeds the <code>RateLimit</code> and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.</p>
