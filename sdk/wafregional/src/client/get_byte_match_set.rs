...
impl super::Client {
    ...
    ///   - [`byte_match_set_id(impl ::std::convert::Into<String>)`](crate::operation::get_byte_match_set::builders::GetByteMatchSetFluentBuilder::byte_match_set_id) / [`set_byte_match_set_id(Option<String>)`](crate::operation::get_byte_match_set::builders::GetByteMatchSetFluentBuilder::set_byte_match_set_id): <p>The <code>ByteMatchSetId</code> of the <code>ByteMatchSet</code> that you want to get. <code>ByteMatchSetId</code> is returned by <code>CreateByteMatchSet</code> and by <code>ListByteMatchSets</code>.</p>
