...
impl super::Client {
    ...
    ///   - [`next_marker(impl Into<String>)`](crate::operation::list_byte_match_sets::builders::ListByteMatchSetsFluentBuilder::next_marker) / [`set_next_marker(Option<String>)`](crate::operation::list_byte_match_sets::builders::ListByteMatchSetsFluentBuilder::set_next_marker):<br>required: **false**<br><p>If you specify a value for <code>Limit</code> and you have more <code>ByteMatchSets</code> than the value of <code>Limit</code>, AWS WAF returns a <code>NextMarker</code> value in the response that allows you to list another group of <code>ByteMatchSets</code>. For the second and subsequent <code>ListByteMatchSets</code> requests, specify the value of <code>NextMarker</code> from the previous response to get information about another batch of <code>ByteMatchSets</code>.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_byte_match_sets::builders::ListByteMatchSetsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_byte_match_sets::builders::ListByteMatchSetsFluentBuilder::set_limit):<br>required: **false**<br><p>Specifies the number of <code>ByteMatchSet</code> objects that you want AWS WAF to return for this request. If you have more <code>ByteMatchSets</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>ByteMatchSet</code> objects.</p><br>
