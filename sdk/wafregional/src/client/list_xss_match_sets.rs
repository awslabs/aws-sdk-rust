...
impl super::Client {
    ...
    ///   - [`limit(i32)`](crate::operation::list_xss_match_sets::builders::ListXssMatchSetsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_xss_match_sets::builders::ListXssMatchSetsFluentBuilder::set_limit): <p>Specifies the number of <code>XssMatchSet</code> objects that you want AWS WAF to return for this request. If you have more <code>XssMatchSet</code> objects than the number you specify for <code>Limit</code>, the response includes a <code>NextMarker</code> value that you can use to get another batch of <code>Rules</code>.</p>
