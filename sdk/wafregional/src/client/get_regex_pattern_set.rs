...
impl super::Client {
    ...
    ///   - [`regex_pattern_set_id(impl ::std::convert::Into<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::regex_pattern_set_id) / [`set_regex_pattern_set_id(Option<String>)`](crate::operation::get_regex_pattern_set::builders::GetRegexPatternSetFluentBuilder::set_regex_pattern_set_id): <p>The <code>RegexPatternSetId</code> of the <code>RegexPatternSet</code> that you want to get. <code>RegexPatternSetId</code> is returned by <code>CreateRegexPatternSet</code> and by <code>ListRegexPatternSets</code>.</p>
