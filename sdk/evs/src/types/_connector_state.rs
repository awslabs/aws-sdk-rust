...
impl ::std::convert::From<&str> for ConnectorState {
    fn from(s: &str) -> Self {
        match s {
            ...
            "CREATE_FAILED" => ConnectorState::CreateFailed,
            "CREATING" => ConnectorState::Creating,
            "DELETED" => ConnectorState::Deleted,
            "DELETING" => ConnectorState::Deleting,
            "UPDATE_FAILED" => ConnectorState::UpdateFailed,
...
impl ConnectorState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ConnectorState::CreateFailed => "CREATE_FAILED",
            ConnectorState::Creating => "CREATING",
            ConnectorState::Deleted => "DELETED",
            ConnectorState::Deleting => "DELETING",
            ConnectorState::UpdateFailed => "UPDATE_FAILED",
