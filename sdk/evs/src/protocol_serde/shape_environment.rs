            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "licenseInfo" => {
                            builder = builder.set_license_info(crate::protocol_serde::shape_license_info_list::de_license_info_list(tokens)?);
                        }
                        "siteId" => {
                        ...
                        "checks" => {
                            builder = builder.set_checks(crate::protocol_serde::shape_checks_list::de_checks_list(tokens)?);
                        }
                        "connectivityInfo" => {
                            builder = builder.set_connectivity_info(crate::protocol_serde::shape_connectivity_info::de_connectivity_info(tokens)?);
                        }
                        "vcfHostnames" => {
                            builder = builder.set_vcf_hostnames(crate::protocol_serde::shape_vcf_hostnames::de_vcf_hostnames(tokens)?);
                        }
                        "kmsKeyId" => {
                        ...
                        "serviceAccessSecurityGroups" => {
                            builder = builder.set_service_access_security_groups(
                                crate::protocol_serde::shape_service_access_security_groups::de_service_access_security_groups(tokens)?,
                            );
                        }
                        "credentials" => {
                            builder = builder.set_credentials(crate::protocol_serde::shape_secret_list::de_secret_list(tokens)?);
                        }
