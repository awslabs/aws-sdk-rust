...
impl ListEnvironmentsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `environment_summaries`. Queries to the underlying service
...
impl ListEnvironmentsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_environments_output_output_environment_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
