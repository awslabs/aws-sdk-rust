...
pub fn ser_describe_accelerators_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_accelerators::DescribeAcceleratorsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
