...
impl smithy_http::response::ParseStrictResponse for DescribeAcceleratorOfferings {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_accelerator_offerings_error(response)
        } else {
            crate::operation_ser::parse_describe_accelerator_offerings_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DescribeAccelerators {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_accelerators_error(response)
        } else {
            crate::operation_ser::parse_describe_accelerators_response(response)
        }
    }
}
...
impl smithy_http::response::ParseStrictResponse for DescribeAcceleratorTypes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::operation_ser::parse_describe_accelerator_types_error(response)
        } else {
            crate::operation_ser::parse_describe_accelerator_types_response(response)
        }
    }
}
