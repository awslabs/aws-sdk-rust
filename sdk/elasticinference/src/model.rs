...
pub struct AcceleratorType  {
    ...
    #[doc(hidden)]pub accelerator_type_name: std::option::Option<std::string::String>,
    /// <p> The memory information of the Elastic Inference Accelerator type. </p>
    #[doc(hidden)]pub memory_info: std::option::Option<crate::model::MemoryInfo>,
    /// <p> The throughput information of the Elastic Inference Accelerator type. </p>
    #[doc(hidden)]pub throughput_info: std::option::Option<std::vec::Vec<crate::model::KeyValuePair>>,
}
...
pub struct MemoryInfo  {
    ...
    #[doc(hidden)]pub size_in_mi_b: i32,
}
impl MemoryInfo {
    /// <p> The size in mebibytes of the Elastic Inference Accelerator type. </p>
...
pub struct ElasticInferenceAccelerator  {
    ...
    #[doc(hidden)]pub accelerator_health: std::option::Option<crate::model::ElasticInferenceAcceleratorHealth>,
    /// <p> The type of the Elastic Inference Accelerator. </p>
    #[doc(hidden)]pub accelerator_type: std::option::Option<std::string::String>,
    /// <p> The ID of the Elastic Inference Accelerator. </p>
    #[doc(hidden)]pub accelerator_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub attached_resource: std::option::Option<std::string::String>,
}
...
pub struct AcceleratorTypeOffering  {
    ...
    #[doc(hidden)]pub location_type: std::option::Option<crate::model::LocationType>,
