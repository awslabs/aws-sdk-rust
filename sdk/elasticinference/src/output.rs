...
pub struct DescribeAcceleratorsOutput  {
    ...
    #[doc(hidden)]pub accelerator_set: std::option::Option<std::vec::Vec<crate::model::ElasticInferenceAccelerator>>,
...
pub struct DescribeAcceleratorOfferingsOutput  {
    ...
    #[doc(hidden)]pub accelerator_type_offerings: std::option::Option<std::vec::Vec<crate::model::AcceleratorTypeOffering>>,
}
...
impl  std::fmt::Debug for DescribeAcceleratorOfferingsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("accelerator_type_offerings", &self.accelerator_type_offerings);
        formatter.finish()
    }
}
