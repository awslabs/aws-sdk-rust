...
impl aws_smithy_http::result::CreateUnhandledError for DescribeAcceleratorTypesError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeAcceleratorTypesErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeAcceleratorTypesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeAcceleratorTypesErrorKind::InternalServerException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorTypesErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeAcceleratorTypesError {
    /// Creates a new `DescribeAcceleratorTypesError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeAcceleratorTypesErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorTypesErrorKind::InternalServerException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeAcceleratorsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeAcceleratorsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeAcceleratorsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeAcceleratorsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorsErrorKind::InternalServerException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorsErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeAcceleratorsError {
    /// Creates a new `DescribeAcceleratorsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeAcceleratorsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorsErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeAcceleratorsErrorKind::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorsErrorKind::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DescribeAcceleratorsErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorsErrorKind::ResourceNotFoundException(_))
    }
}
...
impl aws_smithy_http::result::CreateUnhandledError for DescribeAcceleratorOfferingsError {
    fn create_unhandled_error(source: Box<dyn std::error::Error + Send + Sync + 'static>) -> Self {
        Self {
            kind: DescribeAcceleratorOfferingsErrorKind::Unhandled(crate::error::Unhandled::new(source)),
            meta: Default::default()
        }
    }
}
...
impl std::fmt::Display for DescribeAcceleratorOfferingsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            DescribeAcceleratorOfferingsErrorKind::BadRequestException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorOfferingsErrorKind::InternalServerException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorOfferingsErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            DescribeAcceleratorOfferingsErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl DescribeAcceleratorOfferingsError {
    /// Creates a new `DescribeAcceleratorOfferingsError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: DescribeAcceleratorOfferingsErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorOfferingsErrorKind::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeAcceleratorOfferingsErrorKind::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorOfferingsErrorKind::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DescribeAcceleratorOfferingsErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, DescribeAcceleratorOfferingsErrorKind::ResourceNotFoundException(_))
    }
}
