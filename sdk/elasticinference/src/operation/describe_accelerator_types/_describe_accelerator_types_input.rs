...
impl DescribeAcceleratorTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_accelerator_types::DescribeAcceleratorTypesInput, ::aws_smithy_types::error::operation::BuildError> {
