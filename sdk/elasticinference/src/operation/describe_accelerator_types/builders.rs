...
impl DescribeAcceleratorTypesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_accelerator_types::DescribeAcceleratorTypesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_accelerator_types::DescribeAcceleratorTypesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_accelerator_types::DescribeAcceleratorTypesOutput, crate::operation::describe_accelerator_types::DescribeAcceleratorTypesError, Self> {
