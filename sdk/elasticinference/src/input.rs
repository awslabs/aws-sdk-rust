...
impl DescribeAcceleratorOfferingsInput {
    ...
    > {
        Ok({
            ...
            let body =
                crate::operation_ser::serialize_operation_crate_operation_describe_accelerator_offerings(&self).map_err(|err|smithy_http::operation::BuildError::SerializationError(err.into()))?
            ;
...
impl DescribeAcceleratorsInput {
    ...
    > {
        Ok({
            ...
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_crate_operation_describe_accelerators(
                    &self,
                )
                .map_err(|err| {
