...
impl AppBuilder {
    ...
    pub fn set_last_drift_evaluation_time(mut self, input: ::std::option::Option<::aws_smithy_types::DateTime>) -> Self {
        self.last_drift_evaluation_time = input; self
    }
    /// <p>Indicates the last time that a drift was evaluated.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::App {
                app_arn: self.app_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_arn", "app_arn was not specified but it is required when building App")
                    )?
                ,
                name: self.name
                    .ok_or_else(||
                ...
                creation_time: self.creation_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("creation_time", "creation_time was not specified but it is required when building App")
                    )?
                ,
                status: self.status
                ,
