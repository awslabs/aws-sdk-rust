...
pub struct ResiliencyScore  {
    ...
    pub component_score: ::std::option::Option<::std::collections::HashMap::<crate::types::ResiliencyScoreType, crate::types::ScoringComponentResiliencyScore>>,
}
impl  ResiliencyScore  {
    ...
    /// <p>The score generated by Resilience Hub for the scoring component after running an assessment.</p>
    /// <p>For example, if the <code>score</code> is 25 points, it indicates the overall score of your application generated by Resilience Hub after running an assessment.</p>
    pub fn component_score(&self) -> ::std::option::Option<& ::std::collections::HashMap::<crate::types::ResiliencyScoreType, crate::types::ScoringComponentResiliencyScore>> {
...
pub struct ResiliencyScoreBuilder {
    ...
    pub(crate) component_score: ::std::option::Option<::std::collections::HashMap::<crate::types::ResiliencyScoreType, crate::types::ScoringComponentResiliencyScore>>,
}
impl ResiliencyScoreBuilder {
    ...
    /// <p>The score generated by Resilience Hub for the scoring component after running an assessment.</p>
    /// <p>For example, if the <code>score</code> is 25 points, it indicates the overall score of your application generated by Resilience Hub after running an assessment.</p>
    pub fn set_component_score(mut self, input: ::std::option::Option<::std::collections::HashMap::<crate::types::ResiliencyScoreType, crate::types::ScoringComponentResiliencyScore>>) -> Self {
        self.component_score = input; self
    }
    /// <p>The score generated by Resilience Hub for the scoring component after running an assessment.</p>
    /// <p>For example, if the <code>score</code> is 25 points, it indicates the overall score of your application generated by Resilience Hub after running an assessment.</p>
    pub fn get_component_score(&self) -> &::std::option::Option<::std::collections::HashMap::<crate::types::ResiliencyScoreType, crate::types::ScoringComponentResiliencyScore>> {
        ...
        ::std::result::Result::Ok(
            crate::types::ResiliencyScore {
                ...
                disruption_score: self.disruption_score
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("disruption_score", "disruption_score was not specified but it is required when building ResiliencyScore")
                    )?
                ,
