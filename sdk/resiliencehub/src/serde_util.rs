...
pub(crate) fn accept_resource_grouping_recommendations_output_output_correct_errors(
...
pub(crate) fn add_draft_app_version_resource_mappings_output_output_correct_errors(
...
pub(crate) fn batch_update_recommendation_status_output_output_correct_errors(
...
pub(crate) fn create_app_version_app_component_output_output_correct_errors(
...
pub(crate) fn create_app_version_resource_output_output_correct_errors(
...
pub(crate) fn create_resiliency_policy_output_output_correct_errors(
...
pub(crate) fn delete_app_assessment_output_output_correct_errors(
...
pub(crate) fn delete_app_version_app_component_output_output_correct_errors(
...
pub(crate) fn delete_app_version_resource_output_output_correct_errors(
...
pub(crate) fn delete_recommendation_template_output_output_correct_errors(
...
pub(crate) fn delete_resiliency_policy_output_output_correct_errors(
...
pub(crate) fn describe_app_assessment_output_output_correct_errors(
...
pub(crate) fn describe_app_version_output_output_correct_errors(
...
pub(crate) fn describe_app_version_app_component_output_output_correct_errors(
...
pub(crate) fn describe_app_version_resource_output_output_correct_errors(
...
pub(crate) fn describe_app_version_resources_resolution_status_output_output_correct_errors(
...
pub(crate) fn describe_app_version_template_output_output_correct_errors(
...
pub(crate) fn describe_draft_app_version_resources_import_status_output_output_correct_errors(
...
pub(crate) fn describe_resource_grouping_recommendation_task_output_output_correct_errors(
    mut builder: crate::operation::describe_resource_grouping_recommendation_task::builders::DescribeResourceGroupingRecommendationTaskOutputBuilder,
    ...
    if builder.grouping_id.is_none() {
        builder.grouping_id = Some(Default::default())
    }
    if builder.status.is_none() {
        builder.status = "no value was set".parse::<crate::types::ResourcesGroupingRecGenStatusType>().ok()
    }
    builder
}

pub(crate) fn import_resources_to_draft_app_version_output_output_correct_errors(
...
pub(crate) fn list_alarm_recommendations_output_output_correct_errors(
...
pub(crate) fn list_app_assessment_compliance_drifts_output_output_correct_errors(
...
pub(crate) fn list_app_component_compliances_output_output_correct_errors(
...
pub(crate) fn list_app_component_recommendations_output_output_correct_errors(
...
pub(crate) fn list_app_input_sources_output_output_correct_errors(
...
pub(crate) fn list_app_version_app_components_output_output_correct_errors(
...
pub(crate) fn list_app_version_resource_mappings_output_output_correct_errors(
...
pub(crate) fn list_app_version_resources_output_output_correct_errors(
...
pub(crate) fn list_app_versions_output_output_correct_errors(
...
pub(crate) fn list_resource_grouping_recommendations_output_output_correct_errors(
    ...
    if builder.grouping_recommendations.is_none() {
        builder.grouping_recommendations = Some(Default::default())
    }
    builder
}

pub(crate) fn list_sop_recommendations_output_output_correct_errors(
...
pub(crate) fn list_suggested_resiliency_policies_output_output_correct_errors(
...
pub(crate) fn list_test_recommendations_output_output_correct_errors(
...
pub(crate) fn list_unsupported_app_version_resources_output_output_correct_errors(
...
pub(crate) fn publish_app_version_output_output_correct_errors(
...
pub(crate) fn reject_resource_grouping_recommendations_output_output_correct_errors(
...
pub(crate) fn resolve_app_version_resources_output_output_correct_errors(
...
pub(crate) fn start_app_assessment_output_output_correct_errors(
...
pub(crate) fn start_resource_grouping_recommendation_task_output_output_correct_errors(
    mut builder: crate::operation::start_resource_grouping_recommendation_task::builders::StartResourceGroupingRecommendationTaskOutputBuilder,
) -> crate::operation::start_resource_grouping_recommendation_task::builders::StartResourceGroupingRecommendationTaskOutputBuilder {
    if builder.app_arn.is_none() {
        builder.app_arn = Some(Default::default())
    }
    if builder.grouping_id.is_none() {
...
pub(crate) fn update_app_version_output_output_correct_errors(
...
pub(crate) fn update_app_version_app_component_output_output_correct_errors(
...
pub(crate) fn update_app_version_resource_output_output_correct_errors(
...
pub(crate) fn update_resiliency_policy_output_output_correct_errors(
...
pub(crate) fn failed_grouping_recommendation_entry_correct_errors(
    mut builder: crate::types::builders::FailedGroupingRecommendationEntryBuilder,
) -> crate::types::builders::FailedGroupingRecommendationEntryBuilder {
    if builder.grouping_recommendation_id.is_none() {
        builder.grouping_recommendation_id = Some(Default::default())
    }
    if builder.error_message.is_none() {
        builder.error_message = Some(Default::default())
    }
...
pub(crate) fn grouping_recommendation_correct_errors(
    mut builder: crate::types::builders::GroupingRecommendationBuilder,
) -> crate::types::builders::GroupingRecommendationBuilder {
    if builder.grouping_recommendation_id.is_none() {
        builder.grouping_recommendation_id = Some(Default::default())
    }
    if builder.grouping_app_component.is_none() {
        builder.grouping_app_component = {
            let builder = crate::types::builders::GroupingAppComponentBuilder::default();
            crate::serde_util::grouping_app_component_correct_errors(builder).build().ok()
        }
    }
    ...
    if builder.recommendation_reasons.is_none() {
        builder.recommendation_reasons = Some(Default::default())
    }
    if builder.status.is_none() {
        builder.status = "no value was set".parse::<crate::types::GroupingRecommendationStatusType>().ok()
    }
    if builder.confidence_level.is_none() {
        builder.confidence_level = "no value was set".parse::<crate::types::GroupingRecommendationConfidenceLevel>().ok()
    }
    if builder.creation_time.is_none() {
        builder.creation_time = Some(::aws_smithy_types::DateTime::from_fractional_secs(0, 0_f64))
    }
...
pub(crate) fn grouping_app_component_correct_errors(
    mut builder: crate::types::builders::GroupingAppComponentBuilder,
) -> crate::types::builders::GroupingAppComponentBuilder {
    if builder.app_component_id.is_none() {
        builder.app_component_id = Some(Default::default())
    }
    if builder.app_component_type.is_none() {
        builder.app_component_type = Some(Default::default())
    }
    if builder.app_component_name.is_none() {
        builder.app_component_name = Some(Default::default())
    }
...
pub(crate) fn grouping_resource_correct_errors(
    mut builder: crate::types::builders::GroupingResourceBuilder,
) -> crate::types::builders::GroupingResourceBuilder {
    ...
    if builder.source_app_component_ids.is_none() {
        builder.source_app_component_ids = Some(Default::default())
    }
    builder
}
