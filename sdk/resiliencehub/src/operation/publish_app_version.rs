...
impl PublishAppVersionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::publish_app_version::PublishAppVersion,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_publish_app_version::ser_publish_app_version_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishAppVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_publish_app_version::de_publish_app_version_http_response_with_props(status, headers, body)
        }
    }
}
