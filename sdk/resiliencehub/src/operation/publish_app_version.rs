...
impl PublishAppVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::publish_app_version::PublishAppVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishAppVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_publish_app_version::de_publish_app_version_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::publish_app_version::PublishAppVersionError
{
