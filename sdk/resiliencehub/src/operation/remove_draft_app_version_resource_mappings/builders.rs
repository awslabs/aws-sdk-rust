...
impl RemoveDraftAppVersionResourceMappingsFluentBuilder {
    ...
    /// Access the RemoveDraftAppVersionResourceMappings as a reference.
    pub fn as_input(&self) -> &crate::operation::remove_draft_app_version_resource_mappings::builders::RemoveDraftAppVersionResourceMappingsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappings::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappings::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappingsOutput, crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappingsError, Self> {
    ...
    pub fn get_eks_source_names(&self) -> &::std::option::Option<::std::vec::Vec::<::std::string::String>> {
        self.inner.get_eks_source_names()
    }
}
