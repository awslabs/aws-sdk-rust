...
impl RemoveDraftAppVersionResourceMappingsFluentBuilder {
    /// Creates a new `RemoveDraftAppVersionResourceMappingsFluentBuilder`.
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::remove_draft_app_version_resource_mappings::builders::RemoveDraftAppVersionResourceMappingsInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappings::operation_runtime_plugins(
                self.handle.runtime_plugins.clone(),
                &self.handle.conf,
                self.config_override,
            );
        crate::operation::remove_draft_app_version_resource_mappings::RemoveDraftAppVersionResourceMappings::orchestrate(&runtime_plugins, input)
            .await
    }
