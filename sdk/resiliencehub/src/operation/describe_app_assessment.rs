...
impl DescribeAppAssessmentInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_app_assessment::DescribeAppAssessment::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAppAssessment {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_app_assessment::de_describe_app_assessment_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_app_assessment::de_describe_app_assessment_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_app_assessment::DescribeAppAssessmentError
{
