...
impl DescribeAppVersionResourceOutputBuilder {
    ...
    pub fn set_physical_resource(mut self, input: ::std::option::Option<crate::types::PhysicalResource>) -> Self {
        self.physical_resource = input; self
    }
    /// <p>Defines a physical resource. A physical resource is a resource that exists in your account. It can be identified using an Amazon Resource Name (ARN) or a Resilience Hub-native identifier.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_app_version_resource::DescribeAppVersionResourceOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::describe_app_version_resource::DescribeAppVersionResourceOutput {
                app_arn: self.app_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_arn", "app_arn was not specified but it is required when building DescribeAppVersionResourceOutput")
                    )?
                ,
                app_version: self.app_version
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("app_version", "app_version was not specified but it is required when building DescribeAppVersionResourceOutput")
                    )?
                ,
