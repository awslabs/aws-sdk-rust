...
impl DescribeAppVersionResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_app_version_resource::DescribeAppVersionResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_app_version_resource::DescribeAppVersionResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_app_version_resource::DescribeAppVersionResourceOutput, crate::operation::describe_app_version_resource::DescribeAppVersionResourceError, Self> {
