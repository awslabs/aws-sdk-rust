...
impl crate::operation::describe_app_version_resource::builders::DescribeAppVersionResourceInputBuilder {
...
impl DescribeAppVersionResourceFluentBuilder {
    /// Creates a new `DescribeAppVersionResourceFluentBuilder`.
