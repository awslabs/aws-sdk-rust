...
pub use crate::operation::resolve_app_version_resources::_resolve_app_version_resources_output::ResolveAppVersionResourcesOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesOutput,
                    crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesError,
                > for ResolveAppVersionResourcesFluentBuilder
            {
                fn send(
                    self,
...
impl ResolveAppVersionResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::resolve_app_version_resources::ResolveAppVersionResources::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::resolve_app_version_resources::ResolveAppVersionResources::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesOutput, crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesError, Self> {
