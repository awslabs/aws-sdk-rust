...
impl ListAppAssessmentsInput {
    /// Consumes the builder and constructs an Operation<[`ListAppAssessments`](crate::operation::list_app_assessments::ListAppAssessments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_app_assessments::ListAppAssessments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_app_assessments::ListAppAssessmentsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                write!(output, "/list-app-assessments").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_app_assessments::ListAppAssessmentsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_app_assessments::ListAppAssessments::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListAppAssessments", "resiliencehub"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListAppAssessments {
                type Output = std::result::Result<crate::operation::list_app_assessments::ListAppAssessmentsOutput, crate::operation::list_app_assessments::ListAppAssessmentsError>;
