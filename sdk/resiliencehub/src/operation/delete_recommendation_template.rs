...
impl DeleteRecommendationTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_recommendation_template::DeleteRecommendationTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRecommendationTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_recommendation_template::de_delete_recommendation_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
