...
impl DescribeAppVersionTemplateInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_app_version_template::DescribeAppVersionTemplate,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_app_version_template::DescribeAppVersionTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAppVersionTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_app_version_template::de_describe_app_version_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
