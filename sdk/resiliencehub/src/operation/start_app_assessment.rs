...
impl StartAppAssessmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_app_assessment::ser_start_app_assessment_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_app_assessment::StartAppAssessment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAppAssessment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_app_assessment::de_start_app_assessment_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_app_assessment::StartAppAssessmentError
{
