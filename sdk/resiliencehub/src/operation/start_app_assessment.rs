...
impl StartAppAssessmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_app_assessment::StartAppAssessment,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_app_assessment::ser_start_app_assessment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAppAssessment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_app_assessment::de_start_app_assessment_http_response_with_props(status, headers, body)
        }
    }
