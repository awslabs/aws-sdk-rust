...
impl DeleteResiliencyPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_resiliency_policy::DeleteResiliencyPolicy,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResiliencyPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_resiliency_policy::de_delete_resiliency_policy_http_response_with_props(status, headers, body)
        }
    }
}
