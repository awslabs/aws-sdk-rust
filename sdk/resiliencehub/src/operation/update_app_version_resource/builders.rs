...
impl UpdateAppVersionResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_app_version_resource::UpdateAppVersionResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_app_version_resource::UpdateAppVersionResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_app_version_resource::UpdateAppVersionResourceOutput, crate::operation::update_app_version_resource::UpdateAppVersionResourceError, Self> {
