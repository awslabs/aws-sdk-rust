...
impl CreateAppVersionAppComponentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_app_version_app_component::CreateAppVersionAppComponentInput, ::aws_smithy_types::error::operation::BuildError> {
