...
impl CreateAppVersionAppComponentInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::create_app_version_app_component::CreateAppVersionAppComponentInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
