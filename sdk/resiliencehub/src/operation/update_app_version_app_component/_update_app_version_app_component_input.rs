...
impl UpdateAppVersionAppComponentInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::update_app_version_app_component::UpdateAppVersionAppComponentInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
