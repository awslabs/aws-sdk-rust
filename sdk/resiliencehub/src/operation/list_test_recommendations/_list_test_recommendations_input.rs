...
impl ListTestRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_test_recommendations::ListTestRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
