...
impl ListAppVersionsInputBuilder {
    ...
    /// - [`app_arn`](crate::operation::list_app_versions::builders::ListAppVersionsInputBuilder::app_arn)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::list_app_versions::ListAppVersionsInput {
            app_arn: self.app_arn.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_arn",
                    "app_arn was not specified but it is required when building ListAppVersionsInput",
                )
            })?,
