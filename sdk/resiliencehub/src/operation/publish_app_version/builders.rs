...
impl PublishAppVersionFluentBuilder  {
    /// Creates a new `PublishAppVersion`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::publish_app_version::PublishAppVersionOutput, aws_smithy_http::result::SdkError<crate::operation::publish_app_version::PublishAppVersionError>>
                     {
