...
impl DeleteAppInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApp`](crate::operation::delete_app::DeleteApp)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_app::DeleteApp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_app::ser_delete_app_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app::DeleteApp::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteApp", "resiliencehub"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApp {
    type Output = ::std::result::Result<crate::operation::delete_app::DeleteAppOutput, crate::operation::delete_app::DeleteAppError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_app::de_delete_app_http_response_with_props(status, headers, body)
        }
    }
}
