...
pub struct BatchUpdateRecommendationStatusOutput {
    ...
    pub successful_entries: ::std::option::Option<::std::vec::Vec<crate::types::BatchUpdateRecommendationStatusSuccessfulEntry>>,
    /// <p>A list of items with error details about each item, which could not be included or excluded.</p>
    pub failed_entries: ::std::option::Option<::std::vec::Vec<crate::types::BatchUpdateRecommendationStatusFailedEntry>>,
...
impl BatchUpdateRecommendationStatusOutput {
    ...
    /// <p>A list of items that were included or excluded.</p>
    pub fn successful_entries(&self) -> ::std::option::Option<&[crate::types::BatchUpdateRecommendationStatusSuccessfulEntry]> {
        self.successful_entries.as_deref()
    }
    /// <p>A list of items with error details about each item, which could not be included or excluded.</p>
    pub fn failed_entries(&self) -> ::std::option::Option<&[crate::types::BatchUpdateRecommendationStatusFailedEntry]> {
        self.failed_entries.as_deref()
    }
}
impl ::aws_http::request_id::RequestId for BatchUpdateRecommendationStatusOutput {
...
impl BatchUpdateRecommendationStatusOutputBuilder {
    ...
    pub fn build(self) -> crate::operation::batch_update_recommendation_status::BatchUpdateRecommendationStatusOutput {
