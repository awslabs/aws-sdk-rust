...
impl ListSuggestedResiliencyPoliciesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_suggested_resiliency_policies::ListSuggestedResiliencyPolicies::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSuggestedResiliencyPolicies {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_suggested_resiliency_policies::de_list_suggested_resiliency_policies_http_response_with_props(
                status, headers, body,
            )
        }
    }
