...
impl ListAppVersionsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_app_versions::ListAppVersions::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListAppVersions {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_app_versions::de_list_app_versions_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_list_app_versions::de_list_app_versions_http_response(
                response,
            )
        }
    }
