...
impl DeleteAppVersionResourceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_app_version_resource::DeleteAppVersionResourceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_app_version_resource::DeleteAppVersionResourceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_app_version_resource::DeleteAppVersionResourceOutput, crate::operation::delete_app_version_resource::DeleteAppVersionResourceError, Self> {
