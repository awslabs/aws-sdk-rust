...
impl CreateRecommendationTemplateInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_recommendation_template::CreateRecommendationTemplate::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for CreateRecommendationTemplate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_recommendation_template::de_create_recommendation_template_http_error(response)
        } else {
            crate::protocol_serde::shape_create_recommendation_template::de_create_recommendation_template_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::create_recommendation_template::CreateRecommendationTemplateError
{
