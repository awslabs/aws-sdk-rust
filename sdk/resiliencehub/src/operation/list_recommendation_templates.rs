...
/// Orchestration and serialization glue logic for `ListRecommendationTemplates`.
...
impl ListRecommendationTemplates {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_recommendation_templates::ListRecommendationTemplatesInput,
                    ) -> ::std::result::Result<crate::operation::list_recommendation_templates::ListRecommendationTemplatesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_recommendation_templates::ListRecommendationTemplatesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRecommendationTemplates {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRecommendationTemplates");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRecommendationTemplatesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRecommendationTemplatesResponseDeserializer));
...
.with_interceptor(ListRecommendationTemplatesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesError>::new());
...
#[derive(Debug)]
            struct ListRecommendationTemplatesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRecommendationTemplatesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_recommendation_templates::de_list_recommendation_templates_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_recommendation_templates::de_list_recommendation_templates_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRecommendationTemplatesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRecommendationTemplatesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_recommendation_templates::ListRecommendationTemplatesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_recommendation_templates::ListRecommendationTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/list-recommendation-templates").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_recommendation_templates::ListRecommendationTemplatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.assessment_arn;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("assessment_arn", "cannot be empty or unset"))?;
    if inner_1.is_empty() {
        return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("assessment_arn", "cannot be empty or unset"));
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRecommendationTemplatesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRecommendationTemplatesInput>()
                        .ok_or("failed to downcast to ListRecommendationTemplatesInput")?;
...
pub enum ListRecommendationTemplatesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRecommendationTemplatesError) for what information is available for the error.")]
...
impl ListRecommendationTemplatesError {
    /// Creates the `ListRecommendationTemplatesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRecommendationTemplatesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRecommendationTemplatesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_recommendation_templates::ListRecommendationTemplatesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_recommendation_templates::_list_recommendation_templates_output::ListRecommendationTemplatesOutput;

pub use crate::operation::list_recommendation_templates::_list_recommendation_templates_input::ListRecommendationTemplatesInput;

mod _list_recommendation_templates_input;

mod _list_recommendation_templates_output;
