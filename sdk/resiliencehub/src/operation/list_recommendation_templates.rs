...
impl ListRecommendationTemplatesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_recommendation_templates::ListRecommendationTemplates::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecommendationTemplates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_recommendation_templates::de_list_recommendation_templates_http_response_with_props(
                status, headers, body,
            )
        }
    }
