...
impl AddDraftAppVersionResourceMappingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::add_draft_app_version_resource_mappings::AddDraftAppVersionResourceMappings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddDraftAppVersionResourceMappings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_draft_app_version_resource_mappings::de_add_draft_app_version_resource_mappings_http_response_with_props(
                status, headers, body,
            )
        }
    }
