...
#[derive(Debug)]
    ...
    ::std::write!(output, "/list-apps").expect("formatting should succeed");
...
fn uri_query(_input: &crate::operation::list_apps::ListAppsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_4) = &_input.app_arn {
         {
            query.push_kv("appArn", &::aws_smithy_http::query::fmt_string(inner_4));
        }
    }
    if let ::std::option::Option::Some(inner_5) = &_input.from_last_assessment_time {
         {
            query.push_kv("fromLastAssessmentTime", &::aws_smithy_http::query::fmt_timestamp(inner_5, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
    if let ::std::option::Option::Some(inner_6) = &_input.to_last_assessment_time {
         {
            query.push_kv("toLastAssessmentTime", &::aws_smithy_http::query::fmt_timestamp(inner_6, ::aws_smithy_types::date_time::Format::DateTime)?);
        }
    }
