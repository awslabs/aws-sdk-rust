...
impl DescribeAppVersionInputBuilder {
    ...
    /// - [`app_arn`](crate::operation::describe_app_version::builders::DescribeAppVersionInputBuilder::app_arn)
    /// - [`app_version`](crate::operation::describe_app_version::builders::DescribeAppVersionInputBuilder::app_version)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::describe_app_version::DescribeAppVersionInput {
            app_arn: self.app_arn.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_arn",
                    "app_arn was not specified but it is required when building DescribeAppVersionInput",
                )
            })?,
            app_version: self.app_version.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "app_version",
                    "app_version was not specified but it is required when building DescribeAppVersionInput",
                )
            })?,
        })
    }
