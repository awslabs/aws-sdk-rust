    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_version_resource::CreateAppVersionResourceError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_version_resource::CreateAppVersionResourceOutput>::assume_from(
                output,
            )
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateAppVersionResourceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateAppVersionResourceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_app_version_resource::CreateAppVersionResourceInput>::assume_from(
                input,
            )
            .expect("correct type")
            .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateAppVersionResourceEndpointParamsInterceptor {
...
pub type CreateAppVersionResourceErrorKind = CreateAppVersionResourceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateAppVersionResourceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_app_version_resource::CreateAppVersionResourceError {
...
impl CreateAppVersionResourceError {
    ...
    /// Creates the `CreateAppVersionResourceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
