...
impl  ListSopRecommendationsOutput  {
    ...
    pub fn sop_recommendations(&self) -> & [crate::types::SopRecommendation] {
        use std::ops::Deref; self.sop_recommendations.deref()
    }
}
...
impl ListSopRecommendationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sop_recommendations::ListSopRecommendationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_sop_recommendations::ListSopRecommendationsOutput {
                ...
                sop_recommendations: self.sop_recommendations
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("sop_recommendations", "sop_recommendations was not specified but it is required when building ListSopRecommendationsOutput")
                    )?
                ,
