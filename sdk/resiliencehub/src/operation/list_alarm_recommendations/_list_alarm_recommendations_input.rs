...
impl ListAlarmRecommendationsInputBuilder {
    ...
    /// - [`assessment_arn`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsInputBuilder::assessment_arn)
    pub fn build(
        self,
    ) -> ::std::result::Result<
        ...
        ::std::result::Result::Ok(crate::operation::list_alarm_recommendations::ListAlarmRecommendationsInput {
            assessment_arn: self.assessment_arn.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "assessment_arn",
                    "assessment_arn was not specified but it is required when building ListAlarmRecommendationsInput",
                )
            })?,
