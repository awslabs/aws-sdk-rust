...
impl ListAlarmRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_alarm_recommendations::ListAlarmRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
