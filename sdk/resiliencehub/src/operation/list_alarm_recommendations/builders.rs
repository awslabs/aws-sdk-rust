...
pub use crate::operation::list_alarm_recommendations::_list_alarm_recommendations_output::ListAlarmRecommendationsOutputBuilder;

pub use crate::operation::list_alarm_recommendations::_list_alarm_recommendations_input::ListAlarmRecommendationsInputBuilder;
...
impl ListAlarmRecommendationsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_alarm_recommendations();
...
impl ListAlarmRecommendationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_alarm_recommendations::ListAlarmRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_alarm_recommendations::ListAlarmRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_alarm_recommendations::ListAlarmRecommendations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_alarm_recommendations::ListAlarmRecommendations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_alarm_recommendations::ListAlarmRecommendationsOutput, crate::operation::list_alarm_recommendations::ListAlarmRecommendationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_alarm_recommendations::paginator::ListAlarmRecommendationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
