...
impl DescribeResiliencyPolicyInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_resiliency_policy::DescribeResiliencyPolicy::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeResiliencyPolicy {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_resiliency_policy::de_describe_resiliency_policy_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_resiliency_policy::de_describe_resiliency_policy_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::describe_resiliency_policy::DescribeResiliencyPolicyError
{
