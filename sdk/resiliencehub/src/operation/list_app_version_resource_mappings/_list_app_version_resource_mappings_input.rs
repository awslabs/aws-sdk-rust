...
impl ListAppVersionResourceMappingsInputBuilder {
    ...
    /// - [`app_arn`](crate::operation::list_app_version_resource_mappings::builders::ListAppVersionResourceMappingsInputBuilder::app_arn)
    /// - [`app_version`](crate::operation::list_app_version_resource_mappings::builders::ListAppVersionResourceMappingsInputBuilder::app_version)
    pub fn build(
        self,
    ) -> ::std::result::Result<
            ...
            crate::operation::list_app_version_resource_mappings::ListAppVersionResourceMappingsInput {
                app_arn: self.app_arn.ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field(
                        "app_arn",
                        "app_arn was not specified but it is required when building ListAppVersionResourceMappingsInput",
                    )
                })?,
                app_version: self.app_version.ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field(
                        "app_version",
                        "app_version was not specified but it is required when building ListAppVersionResourceMappingsInput",
                    )
                })?,
