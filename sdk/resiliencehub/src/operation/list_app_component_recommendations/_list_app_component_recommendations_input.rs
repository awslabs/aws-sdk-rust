...
impl ListAppComponentRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_app_component_recommendations::ListAppComponentRecommendationsInput, ::aws_smithy_types::error::operation::BuildError> {
