...
impl super::Client {
    ...
    ///   - [`compliance_drifts(Option<Vec<ComplianceDrift>>)`](crate::operation::list_app_assessment_compliance_drifts::ListAppAssessmentComplianceDriftsOutput::compliance_drifts): <p>Indicates compliance drifts (recovery time objective (RTO) and recovery point objective (RPO)) detected for an assessed entity.</p>
