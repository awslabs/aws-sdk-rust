...
impl super::Client {
    ...
    ///   - [`status(Option<RecommendationTemplateStatus>)`](crate::operation::delete_recommendation_template::DeleteRecommendationTemplateOutput::status): <p>Status of the action.</p>
