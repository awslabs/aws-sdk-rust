...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_resiliency_policies::builders::ListResiliencyPoliciesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_resiliency_policies::builders::ListResiliencyPoliciesFluentBuilder::set_max_results): <p>Maximum number of results to include in the response. If more results exist than the specified <code>MaxResults</code> value, a token is included in the response so that the remaining results can be retrieved.</p>
