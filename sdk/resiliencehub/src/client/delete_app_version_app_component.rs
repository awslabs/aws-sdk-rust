...
impl super::Client {
    ...
    ///   - [`app_arn(impl Into<String>)`](crate::operation::delete_app_version_app_component::builders::DeleteAppVersionAppComponentFluentBuilder::app_arn) / [`set_app_arn(Option<String>)`](crate::operation::delete_app_version_app_component::builders::DeleteAppVersionAppComponentFluentBuilder::set_app_arn): <p>Amazon Resource Name (ARN) of the Resilience Hub application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.</p>
    ///   - [`id(impl Into<String>)`](crate::operation::delete_app_version_app_component::builders::DeleteAppVersionAppComponentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_app_version_app_component::builders::DeleteAppVersionAppComponentFluentBuilder::set_id): <p>Identifier of the Application Component.</p>
    ...
    ///   - [`app_arn(Option<String>)`](crate::operation::delete_app_version_app_component::DeleteAppVersionAppComponentOutput::app_arn): <p>Amazon Resource Name (ARN) of the Resilience Hub application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.</p>
    ///   - [`app_version(Option<String>)`](crate::operation::delete_app_version_app_component::DeleteAppVersionAppComponentOutput::app_version): <p>Resilience Hub application version.</p>
