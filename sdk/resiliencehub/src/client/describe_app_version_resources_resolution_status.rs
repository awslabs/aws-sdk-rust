...
impl super::Client {
    ...
    ///   - [`status(Option<ResourceResolutionStatusType>)`](crate::operation::describe_app_version_resources_resolution_status::DescribeAppVersionResourcesResolutionStatusOutput::status): <p>Status of the action.</p>
