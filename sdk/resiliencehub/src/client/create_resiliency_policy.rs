...
impl super::Client {
    ...
    ///   - [`policy_name(impl ::std::convert::Into<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::policy_name) / [`set_policy_name(Option<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_policy_name): <p>The name of the policy</p>
    ///   - [`policy_description(impl ::std::convert::Into<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::policy_description) / [`set_policy_description(Option<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_policy_description): <p>The description for the policy.</p>
    ///   - [`data_location_constraint(DataLocationConstraint)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::data_location_constraint) / [`set_data_location_constraint(Option<DataLocationConstraint>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_data_location_constraint): <p>Specifies a high-level geographical location constraint for where your resilience policy data can be stored.</p>
    ///   - [`tier(ResiliencyPolicyTier)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::tier) / [`set_tier(Option<ResiliencyPolicyTier>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_tier): <p>The tier for this resiliency policy, ranging from the highest severity (<code>MissionCritical</code>) to lowest (<code>NonCritical</code>).</p>
    ///   - [`policy(HashMap<DisruptionType, FailurePolicy>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::policy) / [`set_policy(Option<HashMap<DisruptionType, FailurePolicy>>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_policy): <p>The type of resiliency policy to be created, including the recovery time objective (RTO) and recovery point objective (RPO) in seconds.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_client_token): <p>Used for an idempotency token. A client token is a unique, case-sensitive string of up to 64 ASCII characters. You should not reuse the same client token for other API requests.</p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder::set_tags): <p>The tags assigned to the resource. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key/value pair.</p>
    ...
    pub fn create_resiliency_policy(
        &self,
    ) -> crate::operation::create_resiliency_policy::builders::CreateResiliencyPolicyFluentBuilder
    {
