...
impl super::Client {
    ...
    ///   - [`app_arn(impl Into<String>)`](crate::operation::list_app_version_app_components::builders::ListAppVersionAppComponentsFluentBuilder::app_arn) / [`set_app_arn(impl Into<String>)`](crate::operation::list_app_version_app_components::builders::ListAppVersionAppComponentsFluentBuilder::set_app_arn):<br>required: **true**<br><p>Amazon Resource Name (ARN) of the Resilience Hub application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>Amazon Web Services General Reference</i> guide.</p><br>
    ///   - [`app_version(impl Into<String>)`](crate::operation::list_app_version_app_components::builders::ListAppVersionAppComponentsFluentBuilder::app_version) / [`set_app_version(impl Into<String>)`](crate::operation::list_app_version_app_components::builders::ListAppVersionAppComponentsFluentBuilder::set_app_version):<br>required: **true**<br><p>Version of the Application Component.</p><br>
