...
impl super::Client {
    ...
    ///   - [`app_version(Option<String>)`](crate::operation::describe_app_version_app_component::DescribeAppVersionAppComponentOutput::app_version): <p>Resilience Hub application version.</p>
