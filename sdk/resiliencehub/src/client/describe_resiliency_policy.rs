...
impl super::Client {
    ...
    ///   - [`policy_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_resiliency_policy::builders::DescribeResiliencyPolicyFluentBuilder::policy_arn) / [`set_policy_arn(Option<String>)`](crate::operation::describe_resiliency_policy::builders::DescribeResiliencyPolicyFluentBuilder::set_policy_arn): <p>The Amazon Resource Name (ARN) of the resiliency policy. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:resiliency-policy/<code>policy-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.</p>
    ...
    pub fn describe_resiliency_policy(
        &self,
    ) -> crate::operation::describe_resiliency_policy::builders::DescribeResiliencyPolicyFluentBuilder
    {
