...
impl super::Client {
    ...
    ///   - [`assessment_arn(impl Into<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::assessment_arn) / [`set_assessment_arn(Option<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::set_assessment_arn): <p>Amazon Resource Name (ARN) of the assessment. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app-assessment/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.</p>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::set_max_results): <p>Maximum number of results to include in the response. If more results exist than the specified <code>MaxResults</code> value, a token is included in the response so that the remaining results can be retrieved.</p>
