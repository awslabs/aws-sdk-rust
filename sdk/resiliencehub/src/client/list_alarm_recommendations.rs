...
impl super::Client {
    ...
    ///   - [`assessment_arn(impl ::std::convert::Into<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::assessment_arn) / [`set_assessment_arn(Option<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::set_assessment_arn): <p>The Amazon Resource Name (ARN) of the assessment. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app-assessment/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i> guide.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_alarm_recommendations::builders::ListAlarmRecommendationsFluentBuilder::set_next_token): <p>Null, or the token from a previous call to get the next set of results.</p>
