...
/// Types for the `AcceptResourceGroupingRecommendations` operation.
pub mod accept_resource_grouping_recommendations;
...
/// Types for the `DescribeResourceGroupingRecommendationTask` operation.
pub mod describe_resource_grouping_recommendation_task;
...
/// Types for the `ListResourceGroupingRecommendations` operation.
pub mod list_resource_grouping_recommendations;
...
/// Types for the `RejectResourceGroupingRecommendations` operation.
pub mod reject_resource_grouping_recommendations;
