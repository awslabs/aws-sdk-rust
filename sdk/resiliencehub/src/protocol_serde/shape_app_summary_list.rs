...
pub(crate) fn de_app_summary_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::AppSummary>>, aws_smithy_json::deserialize::error::DeserializeError>
