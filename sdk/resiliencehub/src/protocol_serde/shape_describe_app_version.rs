...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_app_version::de_describe_app_version(_response_body, output)
            .map_err(crate::operation::describe_app_version::DescribeAppVersionError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::describe_app_version_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::describe_app_version::DescribeAppVersionError::unhandled)?
    })
}
...
) -> Result<crate::operation::describe_app_version::builders::DescribeAppVersionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
