...
pub fn de_describe_app_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_app_version::DescribeAppVersionOutput, crate::operation::describe_app_version::DescribeAppVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::describe_app_version::DescribeAppVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_app_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::describe_app_version::DescribeAppVersionOutput, crate::operation::describe_app_version::DescribeAppVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_app_version::builders::DescribeAppVersionOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_app_version::de_describe_app_version(response.body().as_ref(), output).map_err(crate::operation::describe_app_version::DescribeAppVersionError::unhandled)?;
