...
pub fn ser_delete_app_version_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_app_version_resource::DeleteAppVersionResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
