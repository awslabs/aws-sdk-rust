...
pub(crate) fn de_unsupported_resource<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UnsupportedResource>, aws_smithy_json::deserialize::error::DeserializeError>
