...
pub fn ser_update_app_version_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_app_version_resource::UpdateAppVersionResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
