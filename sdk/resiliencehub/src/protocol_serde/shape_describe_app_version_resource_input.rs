...
pub fn ser_describe_app_version_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::describe_app_version_resource::DescribeAppVersionResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
