...
pub fn ser_resource_mapping(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceMapping) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_resource_mapping<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ResourceMapping>, aws_smithy_json::deserialize::error::DeserializeError>
