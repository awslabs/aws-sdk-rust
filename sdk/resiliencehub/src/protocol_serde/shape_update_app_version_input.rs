...
pub fn ser_update_app_version_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_app_version::UpdateAppVersionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
