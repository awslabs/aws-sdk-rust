...
pub fn de_list_recommendation_templates_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_recommendation_templates::ListRecommendationTemplatesOutput, crate::operation::list_recommendation_templates::ListRecommendationTemplatesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_recommendation_templates_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_recommendation_templates::ListRecommendationTemplatesOutput, crate::operation::list_recommendation_templates::ListRecommendationTemplatesError> {
    Ok({
        #[allow(unused_mut)]
