...
pub fn ser_create_app_version_resource_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_app_version_resource::CreateAppVersionResourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
