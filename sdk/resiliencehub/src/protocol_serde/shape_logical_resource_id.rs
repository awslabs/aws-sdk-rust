...
pub fn ser_logical_resource_id(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::LogicalResourceId) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_logical_resource_id<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::LogicalResourceId>, aws_smithy_json::deserialize::error::DeserializeError>
