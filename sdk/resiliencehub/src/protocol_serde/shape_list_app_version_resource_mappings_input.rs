...
pub fn ser_list_app_version_resource_mappings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListAppVersionResourceMappingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
