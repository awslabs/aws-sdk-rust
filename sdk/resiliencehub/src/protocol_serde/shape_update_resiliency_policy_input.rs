...
pub fn ser_update_resiliency_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateResiliencyPolicyInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
