...
pub fn ser_list_app_input_sources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_app_input_sources::ListAppInputSourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
