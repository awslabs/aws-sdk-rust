...
pub fn ser_physical_resource_id(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PhysicalResourceId) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_physical_resource_id<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::PhysicalResourceId>, aws_smithy_json::deserialize::error::DeserializeError>
