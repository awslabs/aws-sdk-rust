...
pub fn ser_update_app_version_app_component_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_app_version_app_component::UpdateAppVersionAppComponentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
