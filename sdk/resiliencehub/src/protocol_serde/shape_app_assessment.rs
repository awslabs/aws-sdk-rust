            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "resiliencyScore" => {
                            builder = builder.set_resiliency_score(crate::protocol_serde::shape_resiliency_score::de_resiliency_score(tokens)?);
                        }
                        "compliance" => {
                        ...
                        "policy" => {
                            builder = builder.set_policy(crate::protocol_serde::shape_resiliency_policy::de_resiliency_policy(tokens)?);
                        }
                        "tags" => {
