...
pub fn ser_reject_resource_grouping_recommendations_input_input(
        ...
        for item_4 in var_2 {
            {
                ...
                crate::protocol_serde::shape_reject_grouping_recommendation_entry::ser_reject_grouping_recommendation_entry(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
