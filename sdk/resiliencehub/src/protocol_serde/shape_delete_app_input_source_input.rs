...
pub fn ser_delete_app_input_source_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::delete_app_input_source::DeleteAppInputSourceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
