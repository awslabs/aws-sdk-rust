...
pub struct ResiliencyPolicy  {
    ...
    #[doc(hidden)]pub policy_description: std::option::Option<std::string::String>,
    /// <p>Specifies a high-level geographical location constraint for where your resilience policy data can be stored.</p>
    #[doc(hidden)]pub data_location_constraint: std::option::Option<crate::model::DataLocationConstraint>,
    ...
    #[doc(hidden)]pub tier: std::option::Option<crate::model::ResiliencyPolicyTier>,
    /// <p>Specifies the estimated cost tier of the resiliency policy.</p>
    #[doc(hidden)]pub estimated_cost_tier: std::option::Option<crate::model::EstimatedCostTier>,
    /// <p>The resiliency policy.</p>
    #[doc(hidden)]pub policy: std::option::Option<std::collections::HashMap<crate::model::DisruptionType, crate::model::FailurePolicy>>,
...
pub struct FailurePolicy  {
    ...
    #[doc(hidden)]pub rto_in_secs: i32,
    /// <p>The Recovery Point Objective (RPO), in seconds.</p>
    #[doc(hidden)]pub rpo_in_secs: i32,
}
impl FailurePolicy {
    /// <p>The Recovery Time Objective (RTO), in seconds.</p>
...
pub struct App  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::AppStatusType>,
    /// <p>The current status of compliance for the resiliency policy.</p>
    #[doc(hidden)]pub compliance_status: std::option::Option<crate::model::AppComplianceStatusType>,
    /// <p>The timestamp for the most recent compliance evaluation.</p>
    #[doc(hidden)]pub last_app_compliance_evaluation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The current resiliency score for the application.</p>
    #[doc(hidden)]pub resiliency_score: f64,
    /// <p>The timestamp for the most recent resiliency score evaluation.</p>
    #[doc(hidden)]pub last_resiliency_score_evaluation_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The tags assigned to the resource. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key/value pair.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p> Assessment execution schedule with 'Daily' or 'Disabled' values. </p>
    #[doc(hidden)]pub assessment_schedule: std::option::Option<crate::model::AppAssessmentScheduleType>,
}
impl App {
    /// <p>The Amazon Resource Name (ARN) of the application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i>.</p>
...
pub struct AppAssessment  {
    ...
    #[doc(hidden)]pub app_version: std::option::Option<std::string::String>,
    /// <p>The entity that invoked the assessment.</p>
    #[doc(hidden)]pub invoker: std::option::Option<crate::model::AssessmentInvoker>,
    /// <p>The cost for the application.</p>
    #[doc(hidden)]pub cost: std::option::Option<crate::model::Cost>,
    /// <p>The current resiliency score for the application.</p>
    #[doc(hidden)]pub resiliency_score: std::option::Option<crate::model::ResiliencyScore>,
    /// <p>The application compliance against the resiliency policy.</p>
    #[doc(hidden)]pub compliance: std::option::Option<std::collections::HashMap<crate::model::DisruptionType, crate::model::DisruptionCompliance>>,
    /// <p>The current status of the compliance for the resiliency policy.</p>
    #[doc(hidden)]pub compliance_status: std::option::Option<crate::model::ComplianceStatus>,
    /// <p>The current status of the assessment for the resiliency policy.</p>
    #[doc(hidden)]pub assessment_status: std::option::Option<crate::model::AssessmentStatus>,
    ...
    #[doc(hidden)]pub assessment_arn: std::option::Option<std::string::String>,
    /// <p>The resiliency policy.</p>
    #[doc(hidden)]pub policy: std::option::Option<crate::model::ResiliencyPolicy>,
    /// <p>The tags assigned to the resource. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key/value pair.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p> A resource error object containing a list of errors retrieving an application's resources. </p>
    #[doc(hidden)]pub resource_errors_details: std::option::Option<crate::model::ResourceErrorsDetails>,
}
impl AppAssessment {
    /// <p>The Amazon Resource Name (ARN) of the application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i>.</p>
    pub fn app_arn(&self) -> std::option::Option<& str> {
...
pub struct ResourceErrorsDetails  {
    /// <p> A list of errors retrieving an application's resources. </p>
    #[doc(hidden)]pub resource_errors: std::option::Option<std::vec::Vec<crate::model::ResourceError>>,
    /// <p> This indicates if there are more errors not listed in the resourceErrors list. </p>
    #[doc(hidden)]pub has_more_errors: std::option::Option<bool>,
}
...
pub struct DisruptionCompliance  {
    ...
    #[doc(hidden)]pub achievable_rto_in_secs: i32,
    /// <p>The current RTO, in seconds.</p>
    #[doc(hidden)]pub current_rto_in_secs: i32,
    /// <p>The RTO reference identifier.</p>
    #[doc(hidden)]pub rto_reference_id: std::option::Option<std::string::String>,
    /// <p>The RTO description.</p>
    #[doc(hidden)]pub rto_description: std::option::Option<std::string::String>,
    /// <p>The current RPO, in seconds.</p>
    #[doc(hidden)]pub current_rpo_in_secs: i32,
    /// <p>The RPO reference identifier.</p>
    #[doc(hidden)]pub rpo_reference_id: std::option::Option<std::string::String>,
    /// <p>The RPO description.</p>
    #[doc(hidden)]pub rpo_description: std::option::Option<std::string::String>,
    /// <p>The current status of compliance for the resiliency policy.</p>
    #[doc(hidden)]pub compliance_status: std::option::Option<crate::model::ComplianceStatus>,
    /// <p>The Recovery Point Objective (RPO) that is achievable, in seconds.</p>
    #[doc(hidden)]pub achievable_rpo_in_secs: i32,
...
pub struct ResiliencyScore  {
    ...
    #[doc(hidden)]pub score: f64,
    /// <p>The disruption score for a valid key.</p>
    #[doc(hidden)]pub disruption_score: std::option::Option<std::collections::HashMap<crate::model::DisruptionType, f64>>,
}
...
pub struct Cost  {
    ...
    #[doc(hidden)]pub frequency: std::option::Option<crate::model::CostFrequency>,
}
impl Cost {
    /// <p>The cost amount.</p>
...
pub struct UnsupportedResource  {
    ...
    #[doc(hidden)]pub logical_resource_id: std::option::Option<crate::model::LogicalResourceId>,
    /// <p>The physical resource identifier for the unsupported resource.</p>
    #[doc(hidden)]pub physical_resource_id: std::option::Option<crate::model::PhysicalResourceId>,
...
pub struct PhysicalResourceId  {
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::PhysicalIdentifierType>,
...
pub struct LogicalResourceId  {
    ...
    #[doc(hidden)]pub logical_stack_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub terraform_source_name: std::option::Option<std::string::String>,
}
...
pub struct TestRecommendation  {
    ...
    #[doc(hidden)]pub app_component_name: std::option::Option<std::string::String>,
    /// <p>The name of the test recommendation.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The intent of the test recommendation.</p>
    #[doc(hidden)]pub intent: std::option::Option<std::string::String>,
    /// <p>The level of risk for this test recommendation.</p>
    #[doc(hidden)]pub risk: std::option::Option<crate::model::TestRisk>,
    ...
    #[doc(hidden)]pub items: std::option::Option<std::vec::Vec<crate::model::RecommendationItem>>,
    /// <p>The prerequisite of the test recommendation.</p>
    #[doc(hidden)]pub prerequisite: std::option::Option<std::string::String>,
    /// <p> A list of recommended alarms that are used in the test and must be exported before or with the test. </p>
    #[doc(hidden)]pub depends_on_alarms: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct RecommendationItem  {
    ...
    #[doc(hidden)]pub target_account_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub already_implemented: std::option::Option<bool>,
}
...
pub struct SopRecommendation  {
    ...
    #[doc(hidden)]pub service_type: std::option::Option<crate::model::SopServiceType>,
...
pub struct RecommendationTemplate  {
    ...
    #[doc(hidden)]pub templates_location: std::option::Option<crate::model::S3Location>,
    /// <p>The Amazon Resource Name (ARN) of the assessment. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app-assessment/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i>.</p>
    #[doc(hidden)]pub assessment_arn: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the application. The format for this ARN is: arn:<code>partition</code>:resiliencehub:<code>region</code>:<code>account</code>:app/<code>app-id</code>. For more information about ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html"> Amazon Resource Names (ARNs)</a> in the <i>AWS General Reference</i>.</p>
    #[doc(hidden)]pub app_arn: std::option::Option<std::string::String>,
    /// <p>Identifiers for the recommendations used in the recommendation template.</p>
    #[doc(hidden)]pub recommendation_ids: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub recommendation_types: std::option::Option<std::vec::Vec<crate::model::RenderRecommendationType>>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub format: std::option::Option<crate::model::TemplateFormat>,
    /// <p>The Amazon Resource Name (ARN) for the recommendation template.</p>
    #[doc(hidden)]pub recommendation_template_arn: std::option::Option<std::string::String>,
    /// <p>The message for the recommendation template.</p>
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    /// <p>The status of the action.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::RecommendationTemplateStatus>,
    ...
    #[doc(hidden)]pub needs_replacements: std::option::Option<bool>,
}
...
pub struct PhysicalResource  {
    ...
    #[doc(hidden)]pub app_components: std::option::Option<std::vec::Vec<crate::model::AppComponent>>,
}
...
pub struct ResourceMapping  {
    ...
    #[doc(hidden)]pub app_registry_app_name: std::option::Option<std::string::String>,
    ...
    /// </dd> 
    /// </dl>
    #[doc(hidden)]pub mapping_type: std::option::Option<crate::model::ResourceMappingType>,
...
pub struct ComponentRecommendation  {
    ...
    #[doc(hidden)]pub recommendation_status: std::option::Option<crate::model::RecommendationComplianceStatus>,
    /// <p>The list of recommendations.</p>
    #[doc(hidden)]pub config_recommendations: std::option::Option<std::vec::Vec<crate::model::ConfigRecommendation>>,
}
...
pub struct ConfigRecommendation  {
    ...
    #[doc(hidden)]pub recommendation_compliance: std::option::Option<std::collections::HashMap<crate::model::DisruptionType, crate::model::RecommendationDisruptionCompliance>>,
    /// <p>The type of optimization.</p>
    #[doc(hidden)]pub optimization_type: std::option::Option<crate::model::ConfigRecommendationOptimizationType>,
    /// <p>The name of the recommendation configuration.</p>
    #[doc(hidden)]pub name: std::option::Option<std::string::String>,
    /// <p>The optional description for an app.</p>
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>List of the suggested configuration changes.</p>
    #[doc(hidden)]pub suggested_changes: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The architecture type.</p>
    #[doc(hidden)]pub ha_architecture: std::option::Option<crate::model::HaArchitecture>,
...
impl  std::fmt::Debug for RecommendationDisruptionCompliance  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("expected_compliance_status", &self.expected_compliance_status);
...
pub struct AppComponentCompliance  {
    ...
    #[doc(hidden)]pub message: std::option::Option<std::string::String>,
    /// <p>The status of the action.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ComplianceStatus>,
    /// <p>The current resiliency score for the application.</p>
    #[doc(hidden)]pub resiliency_score: std::option::Option<crate::model::ResiliencyScore>,
}
...
pub struct AlarmRecommendation  {
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::AlarmType>,
...
pub struct TerraformSource  {
    /// <p> The Terraform s3 state file you need to import. </p>
    #[doc(hidden)]pub s3_state_file_url: std::option::Option<std::string::String>,
}
