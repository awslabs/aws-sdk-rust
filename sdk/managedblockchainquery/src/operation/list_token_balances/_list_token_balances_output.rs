...
impl ::aws_http::request_id::RequestId for ListTokenBalancesOutput {
...
impl ListTokenBalancesOutputBuilder {
    ...
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_token_balances::ListTokenBalancesOutput, ::aws_smithy_http::operation::error::BuildError> {
