...
impl ListTransactionEventsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_transaction_events::ListTransactionEventsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_transaction_events::ListTransactionEventsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_transaction_events::ListTransactionEventsOutput, crate::operation::list_transaction_events::ListTransactionEventsError, Self> {
