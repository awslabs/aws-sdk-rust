    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_token_balance::BatchGetTokenBalanceError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_token_balance::BatchGetTokenBalanceOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchGetTokenBalanceResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchGetTokenBalanceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_get_token_balance::BatchGetTokenBalanceInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchGetTokenBalanceEndpointParamsInterceptor {
...
pub type BatchGetTokenBalanceErrorKind = BatchGetTokenBalanceError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for BatchGetTokenBalanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_token_balance::BatchGetTokenBalanceError {
...
impl BatchGetTokenBalanceError {
    ...
    /// Creates the `BatchGetTokenBalanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
