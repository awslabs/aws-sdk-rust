    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_transaction_events::ListTransactionEventsError>::assume_from(
                    err.into(),
                )
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_transaction_events::ListTransactionEventsOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListTransactionEventsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListTransactionEventsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input =
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_transaction_events::ListTransactionEventsInput>::assume_from(input)
                .expect("correct type")
                .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_transaction_events::ser_list_transaction_events_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListTransactionEventsEndpointParamsInterceptor {
...
pub type ListTransactionEventsErrorKind = ListTransactionEventsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListTransactionEventsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_transaction_events::ListTransactionEventsError {
...
impl ListTransactionEventsError {
    ...
    /// Creates the `ListTransactionEventsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
