            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::get_transaction::GetTransactionError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_transaction_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_transaction::GetTransactionOutput, crate::operation::get_transaction::GetTransactionError> {
...
) -> Result<crate::operation::get_transaction::builders::GetTransactionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "transaction" => {
                    builder = builder.set_transaction(crate::protocol_serde::shape_transaction::de_transaction(tokens)?);
                }
