...
pub fn de_list_transactions_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_transactions::ListTransactionsOutput, crate::operation::list_transactions::ListTransactionsError> {
    #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_transactions::ListTransactionsError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_transactions_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_transactions::ListTransactionsOutput, crate::operation::list_transactions::ListTransactionsError> {
    Ok({
        ...
        crate::serde_util::list_transactions_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_transactions::ListTransactionsError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_transactions::builders::ListTransactionsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "transactions" => {
                    builder = builder.set_transactions(crate::protocol_serde::shape_transaction_output_list::de_transaction_output_list(tokens)?);
                }
