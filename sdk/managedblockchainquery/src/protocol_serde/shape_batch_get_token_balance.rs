    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "errors" => {
                    builder = builder
                        .set_errors(crate::protocol_serde::shape_batch_get_token_balance_errors::de_batch_get_token_balance_errors(tokens, _value)?);
                }
                "tokenBalances" => {
                    builder = builder.set_token_balances(
                        crate::protocol_serde::shape_batch_get_token_balance_output_list::de_batch_get_token_balance_output_list(tokens, _value)?,
                    );
                }
