                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::batch_get_token_balance::BatchGetTokenBalanceError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_token_balance_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        ...
        crate::serde_util::batch_get_token_balance_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::batch_get_token_balance::BatchGetTokenBalanceError::unhandled)?
    })
}
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "errors" => {
                    builder = builder.set_errors(
                        crate::protocol_serde::shape_batch_get_token_balance_errors::de_batch_get_token_balance_errors(tokens, _value, depth + 1)?,
                    );
                }
                "tokenBalances" => {
                    builder = builder.set_token_balances(
                        crate::protocol_serde::shape_batch_get_token_balance_output_list::de_batch_get_token_balance_output_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
