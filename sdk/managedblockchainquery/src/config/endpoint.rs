...
mod test {
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-east-1.api.aws");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-east-1.api.aws")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-east-1.amazonaws.com");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-east-1.amazonaws.com")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-east-1.api.aws");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-east-1.api.aws")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-east-1.amazonaws.com");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-east-1.amazonaws.com")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.cn-north-1.api.amazonwebservices.com.cn");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.cn-north-1.api.amazonwebservices.com.cn")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.cn-north-1.amazonaws.com.cn");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.cn-north-1.amazonaws.com.cn")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.cn-north-1.api.amazonwebservices.com.cn");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.cn-north-1.api.amazonwebservices.com.cn")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.cn-north-1.amazonaws.com.cn");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.cn-north-1.amazonaws.com.cn")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-gov-east-1.api.aws");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-gov-east-1.api.aws")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-gov-east-1.amazonaws.com");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-gov-east-1.amazonaws.com")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-gov-east-1.api.aws");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-gov-east-1.api.aws")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-gov-east-1.amazonaws.com");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-gov-east-1.amazonaws.com")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-iso-east-1.c2s.ic.gov");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-iso-east-1.c2s.ic.gov")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-iso-east-1.c2s.ic.gov");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-iso-east-1.c2s.ic.gov")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query-fips.us-isob-east-1.sc2s.sgov.gov");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query-fips.us-isob-east-1.sc2s.sgov.gov")
    .build());
                    }
    ...
    .build().expect("invalid params");
                        ...
                        let endpoint = endpoint.expect("Expected valid endpoint: https://managedblockchain-query.us-isob-east-1.sc2s.sgov.gov");
                                    assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://managedblockchain-query.us-isob-east-1.sc2s.sgov.gov")
    .build());
                    }
...
/// Endpoint resolver trait specific to Amazon Managed Blockchain Query
