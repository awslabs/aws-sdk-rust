...
impl super::Client {
    ...
    ///   - [`owner_filter(OwnerFilter)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::owner_filter) / [`set_owner_filter(Option<OwnerFilter>)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::set_owner_filter): <p>The contract or wallet address on the blockchain network by which to filter the request. You must specify the <code>address</code> property of the <code>ownerFilter</code> when listing balances of tokens owned by the address.</p>
    ///   - [`token_filter(TokenFilter)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::token_filter) / [`set_token_filter(Option<TokenFilter>)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::set_token_filter): <p>The contract address or a token identifier on the blockchain network by which to filter the request. You must specify the contractAddress property of this container when listing tokens minted by a contract.</p> <note>   <p>You must always specify the network property of this container when using this operation.</p>  </note>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::set_next_token): <p>The pagination token that indicates the next set of results to retrieve.</p>
    ///   - [`max_results(i32)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_token_balances::builders::ListTokenBalancesFluentBuilder::set_max_results): <p>The maximum number of token balances to return.</p>
