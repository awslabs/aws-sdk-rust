...
impl super::Client {
    ...
    ///   - [`token_identifier(TokenIdentifier)`](crate::operation::get_token_balance::builders::GetTokenBalanceFluentBuilder::token_identifier) / [`set_token_identifier(Option<TokenIdentifier>)`](crate::operation::get_token_balance::builders::GetTokenBalanceFluentBuilder::set_token_identifier): <p>The container for the identifier for the token, including the unique token ID and its blockchain network.</p>
    ...
    ///   - [`at_blockchain_instant(BlockchainInstant)`](crate::operation::get_token_balance::builders::GetTokenBalanceFluentBuilder::at_blockchain_instant) / [`set_at_blockchain_instant(Option<BlockchainInstant>)`](crate::operation::get_token_balance::builders::GetTokenBalanceFluentBuilder::set_at_blockchain_instant): <p>The time for when the TokenBalance is requested or the current time if a time is not provided in the request.</p> <note>   <p>This time will only be recorded up to the second.</p>  </note>
    ...
    ///   - [`balance(Option<String>)`](crate::operation::get_token_balance::GetTokenBalanceOutput::balance): <p>The container for the token balance.</p>
