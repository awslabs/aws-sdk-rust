...
impl super::Client {
    ...
    ///   - [`owner_identifier(Option<OwnerIdentifier>)`](crate::operation::get_token_balance::GetTokenBalanceOutput::owner_identifier): <p>The container for the owner identifier.</p>
