...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_asset_contracts::builders::ListAssetContractsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_asset_contracts::builders::ListAssetContractsFluentBuilder::set_max_results): <p>The maximum number of contracts to list.</p>
    ...
    ///   - [`contracts(Option<Vec<AssetContract>>)`](crate::operation::list_asset_contracts::ListAssetContractsOutput::contracts): <p>An array of contract objects that contain the properties for each contract.</p>
