...
impl super::Client {
    ...
    ///   - [`address(impl ::std::convert::Into<String>)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::address) / [`set_address(Option<String>)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::set_address): <p>The address (either a contract or wallet), whose transactions are being requested.</p>
    ///   - [`network(QueryNetwork)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::network) / [`set_network(Option<QueryNetwork>)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::set_network): <p>The blockchain network where the transactions occurred.</p>
    ///   - [`from_blockchain_instant(BlockchainInstant)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::from_blockchain_instant) / [`set_from_blockchain_instant(Option<BlockchainInstant>)`](crate::operation::list_transactions::builders::ListTransactionsFluentBuilder::set_from_blockchain_instant): <p>The container for time.</p>
