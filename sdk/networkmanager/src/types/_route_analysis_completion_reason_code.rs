...
RouteAnalysisCompletionReasonCode::TransitGatewayAttachmentNotInTransitGateway => write!(f, "TRANSIT_GATEWAY_ATTACHMENT_NOT_IN_TRANSIT_GATEWAY"),
RouteAnalysisCompletionReasonCode::TransitGatewayAttachmentStableRouteTableNotFound => write!(f, "TRANSIT_GATEWAY_ATTACHMENT_STABLE_ROUTE_TABLE_NOT_FOUND"),
