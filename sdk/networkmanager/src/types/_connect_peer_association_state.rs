...
impl ::std::convert::From<&str> for ConnectPeerAssociationState {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => ConnectPeerAssociationState::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for ConnectPeerAssociationState {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ConnectPeerAssociationState::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for ConnectPeerAssociationState {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
