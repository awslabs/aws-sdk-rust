...
pub fn deser_header_untag_resource_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_59 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_59.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_59.len()
...
pub fn deser_header_untag_resource_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_60 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_60.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_60.len()
...
pub fn deser_header_update_connection_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_61 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_61.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_61.len()
...
pub fn deser_header_update_connection_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_62 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_62.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_62.len()
...
pub fn deser_header_update_device_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_63 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_63.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_63.len()
...
pub fn deser_header_update_device_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_64 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_64.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_64.len()
...
pub fn deser_header_update_global_network_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_65 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_65.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_65.len()
...
pub fn deser_header_update_global_network_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_66 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_66.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_66.len()
...
pub fn deser_header_update_link_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_67 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_67.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_67.len()
...
pub fn deser_header_update_link_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_68 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_68.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_68.len()
...
pub fn deser_header_update_site_internal_server_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_69 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_69.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_69.len()
...
pub fn deser_header_update_site_throttling_exception_retry_after_seconds(
    ...
    let headers = header_map.get_all("Retry-After").iter();
    let var_70 = smithy_http::header::read_many_primitive::<i32>(headers)?;
    if var_70.len() > 1 {
        Err(smithy_http::header::ParseError::new_with_message(format!(
            "expected one item but found {}",
            var_70.len()
