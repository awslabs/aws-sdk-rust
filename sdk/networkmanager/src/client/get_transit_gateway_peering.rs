...
impl super::Client {
    ...
    ///   - [`peering_id(impl ::std::convert::Into<String>)`](crate::operation::get_transit_gateway_peering::builders::GetTransitGatewayPeeringFluentBuilder::peering_id) / [`set_peering_id(Option<String>)`](crate::operation::get_transit_gateway_peering::builders::GetTransitGatewayPeeringFluentBuilder::set_peering_id): <p>The ID of the peering request.</p>
