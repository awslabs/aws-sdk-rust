...
impl super::Client {
    ...
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::reject_attachment::builders::RejectAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::reject_attachment::builders::RejectAttachmentFluentBuilder::set_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
