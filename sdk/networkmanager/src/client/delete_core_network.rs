...
impl super::Client {
    ...
    ///   - [`core_network_id(impl Into<String>)`](crate::operation::delete_core_network::builders::DeleteCoreNetworkFluentBuilder::core_network_id) / [`set_core_network_id(Option<String>)`](crate::operation::delete_core_network::builders::DeleteCoreNetworkFluentBuilder::set_core_network_id):<br>required: **true**<br><p>The network ID of the deleted core network.</p><br>
