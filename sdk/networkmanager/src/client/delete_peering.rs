...
impl super::Client {
    ...
    ///   - [`peering_id(impl Into<String>)`](crate::operation::delete_peering::builders::DeletePeeringFluentBuilder::peering_id) / [`set_peering_id(Option<String>)`](crate::operation::delete_peering::builders::DeletePeeringFluentBuilder::set_peering_id):<br>required: **true**<br><p>The ID of the peering connection to delete.</p><br>
