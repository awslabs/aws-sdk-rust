...
impl super::Client {
    ...
    ///   - [`global_network_id(impl Into<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::set_global_network_id):<br>required: **true**<br><p>The ID of the global network.</p><br>
