...
impl super::Client {
    ...
    ///   - [`connection_ids(impl Into<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::connection_ids) / [`set_connection_ids(Option<Vec<String>>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_connection_ids): <p>One or more connection IDs.</p>
