...
impl super::Client {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ...
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_device_id): <p>The ID of the device.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_connections::builders::GetConnectionsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
