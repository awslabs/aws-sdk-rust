...
impl super::Client {
    ...
    ///   - [`core_network_id(impl ::std::convert::Into<String>)`](crate::operation::get_core_network_change_set::builders::GetCoreNetworkChangeSetFluentBuilder::core_network_id) / [`set_core_network_id(Option<String>)`](crate::operation::get_core_network_change_set::builders::GetCoreNetworkChangeSetFluentBuilder::set_core_network_id): <p>The ID of a core network.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_core_network_change_set::builders::GetCoreNetworkChangeSetFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_core_network_change_set::builders::GetCoreNetworkChangeSetFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
    ...
    pub fn get_core_network_change_set(
        &self,
    ) -> crate::operation::get_core_network_change_set::builders::GetCoreNetworkChangeSetFluentBuilder
    {
