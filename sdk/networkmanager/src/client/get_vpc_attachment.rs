...
impl super::Client {
    ...
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::get_vpc_attachment::builders::GetVpcAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::get_vpc_attachment::builders::GetVpcAttachmentFluentBuilder::set_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
