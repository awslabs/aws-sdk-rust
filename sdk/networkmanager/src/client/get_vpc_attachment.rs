...
impl super::Client {
    ...
    pub fn get_vpc_attachment(
        &self,
    ) -> crate::operation::get_vpc_attachment::builders::GetVpcAttachmentFluentBuilder {
        crate::operation::get_vpc_attachment::builders::GetVpcAttachmentFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
