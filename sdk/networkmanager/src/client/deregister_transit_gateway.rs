...
impl super::Client {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::deregister_transit_gateway::builders::DeregisterTransitGatewayFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::deregister_transit_gateway::builders::DeregisterTransitGatewayFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ///   - [`transit_gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::deregister_transit_gateway::builders::DeregisterTransitGatewayFluentBuilder::transit_gateway_arn) / [`set_transit_gateway_arn(Option<String>)`](crate::operation::deregister_transit_gateway::builders::DeregisterTransitGatewayFluentBuilder::set_transit_gateway_arn): <p>The Amazon Resource Name (ARN) of the transit gateway.</p>
