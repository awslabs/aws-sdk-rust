...
impl super::Client {
    ...
    ///   - [`connect_peer_id(impl Into<String>)`](crate::operation::delete_connect_peer::builders::DeleteConnectPeerFluentBuilder::connect_peer_id) / [`set_connect_peer_id(Option<String>)`](crate::operation::delete_connect_peer::builders::DeleteConnectPeerFluentBuilder::set_connect_peer_id):<br>required: **true**<br><p>The ID of the deleted Connect peer.</p><br>
