...
impl super::Client {
    ...
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::get_site_to_site_vpn_attachment::builders::GetSiteToSiteVpnAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::get_site_to_site_vpn_attachment::builders::GetSiteToSiteVpnAttachmentFluentBuilder::set_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
