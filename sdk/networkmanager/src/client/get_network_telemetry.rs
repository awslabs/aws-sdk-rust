...
impl super::Client {
    ...
    ///   - [`core_network_id(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::core_network_id) / [`set_core_network_id(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_core_network_id): <p>The ID of a core network.</p>
    ...
    ///   - [`aws_region(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::aws_region) / [`set_aws_region(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_aws_region): <p>The Amazon Web Services Region.</p>
    ///   - [`account_id(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_account_id): <p>The Amazon Web Services account ID.</p>
    ///   - [`resource_type(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::resource_type) / [`set_resource_type(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_resource_type): <p>The resource type.</p>  <p>The following are the supported resource types for Direct Connect:</p>  <ul>   <li> <p> <code>dxcon</code> </p> </li>   <li> <p> <code>dx-gateway</code> </p> </li>   <li> <p> <code>dx-vif</code> </p> </li>  </ul>  <p>The following are the supported resource types for Network Manager:</p>  <ul>   <li> <p> <code>connection</code> </p> </li>   <li> <p> <code>device</code> </p> </li>   <li> <p> <code>link</code> </p> </li>   <li> <p> <code>site</code> </p> </li>  </ul>  <p>The following are the supported resource types for Amazon VPC:</p>  <ul>   <li> <p> <code>customer-gateway</code> </p> </li>   <li> <p> <code>transit-gateway</code> </p> </li>   <li> <p> <code>transit-gateway-attachment</code> </p> </li>   <li> <p> <code>transit-gateway-connect-peer</code> </p> </li>   <li> <p> <code>transit-gateway-route-table</code> </p> </li>   <li> <p> <code>vpn-connection</code> </p> </li>  </ul>
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_resource_arn): <p>The ARN of the resource.</p>
    ///   - [`max_results(i32)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_max_results): <p>The maximum number of results to return.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_network_telemetry::builders::GetNetworkTelemetryFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
