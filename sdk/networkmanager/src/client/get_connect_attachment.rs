...
impl super::Client {
    ...
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::get_connect_attachment::builders::GetConnectAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::get_connect_attachment::builders::GetConnectAttachmentFluentBuilder::set_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
