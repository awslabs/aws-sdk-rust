...
impl super::Client {
    ...
    ///   - [`attachment_id(impl ::std::convert::Into<String>)`](crate::operation::update_vpc_attachment::builders::UpdateVpcAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::update_vpc_attachment::builders::UpdateVpcAttachmentFluentBuilder::set_attachment_id): <p>The ID of the attachment.</p>
