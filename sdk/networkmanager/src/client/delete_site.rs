...
impl super::Client {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ///   - [`site_id(impl ::std::convert::Into<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::site_id) / [`set_site_id(Option<String>)`](crate::operation::delete_site::builders::DeleteSiteFluentBuilder::set_site_id): <p>The ID of the site.</p>
