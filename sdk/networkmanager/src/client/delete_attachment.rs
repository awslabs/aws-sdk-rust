...
impl super::Client {
    ...
    ///   - [`attachment_id(impl ::std::convert::Into<String>)`](crate::operation::delete_attachment::builders::DeleteAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::delete_attachment::builders::DeleteAttachmentFluentBuilder::set_attachment_id): <p>The ID of the attachment to delete.</p>
