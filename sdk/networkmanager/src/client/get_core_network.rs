...
impl super::Client {
    ...
    ///   - [`core_network_id(impl Into<String>)`](crate::operation::get_core_network::builders::GetCoreNetworkFluentBuilder::core_network_id) / [`set_core_network_id(Option<String>)`](crate::operation::get_core_network::builders::GetCoreNetworkFluentBuilder::set_core_network_id):<br>required: **true**<br><p>The ID of a core network.</p><br>
