...
impl super::Client {
    ...
    ///   - [`global_network_id(impl Into<String>)`](crate::operation::disassociate_customer_gateway::builders::DisassociateCustomerGatewayFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::disassociate_customer_gateway::builders::DisassociateCustomerGatewayFluentBuilder::set_global_network_id):<br>required: **true**<br><p>The ID of the global network.</p><br>
