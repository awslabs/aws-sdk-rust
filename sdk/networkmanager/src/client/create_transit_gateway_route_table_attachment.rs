...
impl super::Client {
    ...
    ///   - [`routing_policy_label(impl Into<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::routing_policy_label) / [`set_routing_policy_label(Option<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::set_routing_policy_label):<br>required: **false**<br><p>The routing policy label to apply to the Transit Gateway route table attachment for traffic routing decisions.</p><br>
