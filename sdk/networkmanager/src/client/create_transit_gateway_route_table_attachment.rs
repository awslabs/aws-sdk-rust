...
impl super::Client {
    ...
    ///   - [`peering_id(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::peering_id) / [`set_peering_id(Option<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::set_peering_id): <p>The ID of the peer for the </p>
    ///   - [`transit_gateway_route_table_arn(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::transit_gateway_route_table_arn) / [`set_transit_gateway_route_table_arn(Option<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::set_transit_gateway_route_table_arn): <p>The ARN of the transit gateway route table for the attachment request. For example, <code>"TransitGatewayRouteTableArn": "arn:aws:ec2:us-west-2:123456789012:transit-gateway-route-table/tgw-rtb-9876543210123456"</code>.</p>
    ///   - [`tags(Vec<Tag>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::set_tags): <p>The list of key-value tags associated with the request.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentFluentBuilder::set_client_token): <p>The client token associated with the request.</p>
