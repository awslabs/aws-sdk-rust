...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::set_tags): <p>The tags associated with the peer request.</p>
    ...
    ///   - [`subnet_arn(impl Into<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::subnet_arn) / [`set_subnet_arn(Option<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::set_subnet_arn): <p>The subnet ARN for the Connect peer.</p>
