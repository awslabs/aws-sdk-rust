...
impl super::Client {
    ...
    ///   - [`connect_attachment_id(impl ::std::convert::Into<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::connect_attachment_id) / [`set_connect_attachment_id(Option<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::set_connect_attachment_id): <p>The ID of the connection attachment.</p>
    ///   - [`core_network_address(impl ::std::convert::Into<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::core_network_address) / [`set_core_network_address(Option<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::set_core_network_address): <p>A Connect peer core network address.</p>
    ///   - [`peer_address(impl ::std::convert::Into<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::peer_address) / [`set_peer_address(Option<String>)`](crate::operation::create_connect_peer::builders::CreateConnectPeerFluentBuilder::set_peer_address): <p>The Connect peer address.</p>
