...
impl super::Client {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::delete_link::builders::DeleteLinkFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::delete_link::builders::DeleteLinkFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ///   - [`link_id(impl ::std::convert::Into<String>)`](crate::operation::delete_link::builders::DeleteLinkFluentBuilder::link_id) / [`set_link_id(Option<String>)`](crate::operation::delete_link::builders::DeleteLinkFluentBuilder::set_link_id): <p>The ID of the link.</p>
