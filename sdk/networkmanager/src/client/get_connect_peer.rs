...
impl super::Client {
    ...
    ///   - [`connect_peer_id(impl ::std::convert::Into<String>)`](crate::operation::get_connect_peer::builders::GetConnectPeerFluentBuilder::connect_peer_id) / [`set_connect_peer_id(Option<String>)`](crate::operation::get_connect_peer::builders::GetConnectPeerFluentBuilder::set_connect_peer_id): <p>The ID of the Connect peer.</p>
