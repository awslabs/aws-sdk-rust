...
impl super::Client {
    ...
    ///   - [`attachment_id(impl Into<String>)`](crate::operation::accept_attachment::builders::AcceptAttachmentFluentBuilder::attachment_id) / [`set_attachment_id(Option<String>)`](crate::operation::accept_attachment::builders::AcceptAttachmentFluentBuilder::set_attachment_id):<br>required: **true**<br><p>The ID of the attachment.</p><br>
