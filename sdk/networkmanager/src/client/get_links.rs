...
impl super::Client {
    ...
    ///   - [`link_ids(impl Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::link_ids) / [`set_link_ids(Option<Vec<String>>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_link_ids): <p>One or more link IDs. The maximum is 10.</p>
