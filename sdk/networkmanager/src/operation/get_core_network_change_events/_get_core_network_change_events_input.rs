...
impl GetCoreNetworkChangeEventsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_core_network_change_events::GetCoreNetworkChangeEventsInput, ::aws_smithy_types::error::operation::BuildError> {
