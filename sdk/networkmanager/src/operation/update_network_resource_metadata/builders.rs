...
impl crate::operation::update_network_resource_metadata::builders::UpdateNetworkResourceMetadataInputBuilder {
...
impl UpdateNetworkResourceMetadataFluentBuilder {
    /// Creates a new `UpdateNetworkResourceMetadataFluentBuilder`.
