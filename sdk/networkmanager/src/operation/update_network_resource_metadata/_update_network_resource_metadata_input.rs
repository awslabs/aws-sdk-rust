...
impl UpdateNetworkResourceMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_network_resource_metadata::UpdateNetworkResourceMetadataInput, ::aws_smithy_types::error::operation::BuildError> {
