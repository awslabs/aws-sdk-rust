...
impl CreateCoreNetworkInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_core_network::ser_create_core_network_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCoreNetwork {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_core_network::de_create_core_network_http_response_with_props(status, headers, body)
        }
    }
}
