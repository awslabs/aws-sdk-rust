    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_site_to_site_vpn_attachment::CreateSiteToSiteVpnAttachmentError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_site_to_site_vpn_attachment::CreateSiteToSiteVpnAttachmentOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreateSiteToSiteVpnAttachmentResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreateSiteToSiteVpnAttachmentRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreateSiteToSiteVpnAttachmentEndpointParamsInterceptor {
