...
impl GetTransitGatewayConnectPeerAssociationsPaginator {
    ...
    pub fn items(
        self,
    ) -> crate::operation::get_transit_gateway_connect_peer_associations::paginator::GetTransitGatewayConnectPeerAssociationsPaginatorItems {
    ...
    > {
        ...
        let runtime_plugins =
            crate::operation::get_transit_gateway_connect_peer_associations::GetTransitGatewayConnectPeerAssociations::operation_runtime_plugins(
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::get_transit_gateway_connect_peer_associations::GetTransitGatewayConnectPeerAssociations::orchestrate(
                                &runtime_plugins,
                                input.clone(),
                            )
                            .await;
