...
impl GetTransitGatewayConnectPeerAssociationsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_transit_gateway_connect_peer_associations::GetTransitGatewayConnectPeerAssociationsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
