...
impl UpdateLinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_link::UpdateLink, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_link::ser_update_link_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_link::de_update_link_http_response_with_props(status, headers, body)
        }
    }
}
