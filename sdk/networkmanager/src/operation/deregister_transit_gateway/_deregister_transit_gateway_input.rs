...
impl DeregisterTransitGatewayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_transit_gateway::DeregisterTransitGatewayInput, ::aws_smithy_types::error::operation::BuildError> {
