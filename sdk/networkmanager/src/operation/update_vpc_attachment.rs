...
impl UpdateVpcAttachmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_vpc_attachment::ser_update_vpc_attachment_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_vpc_attachment::UpdateVpcAttachment::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_vpc_attachment::UpdateVpcAttachmentError
{
