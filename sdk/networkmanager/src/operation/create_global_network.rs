...
impl CreateGlobalNetworkInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_global_network::ser_create_global_network_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_global_network::CreateGlobalNetwork::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_global_network::CreateGlobalNetworkError
{
