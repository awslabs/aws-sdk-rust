...
impl GetNetworkTelemetryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_network_telemetry::GetNetworkTelemetry,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkTelemetry {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_network_telemetry::de_get_network_telemetry_http_response_with_props(status, headers, body)
        }
    }
}
