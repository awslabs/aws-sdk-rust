...
impl GetNetworkResourceCountsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_network_resource_counts::GetNetworkResourceCountsInput, ::aws_smithy_types::error::operation::BuildError> {
