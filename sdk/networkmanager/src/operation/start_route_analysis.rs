...
impl StartRouteAnalysisInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_route_analysis::ser_start_route_analysis_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRouteAnalysis {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_route_analysis::de_start_route_analysis_http_response_with_props(status, headers, body)
        }
    }
}
