...
impl AssociateLinkInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::associate_link::AssociateLink,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_link::AssociateLink::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateLink {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_associate_link::de_associate_link_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_associate_link::de_associate_link_http_response_with_props(
                status, headers, body,
            )
        }
    }
