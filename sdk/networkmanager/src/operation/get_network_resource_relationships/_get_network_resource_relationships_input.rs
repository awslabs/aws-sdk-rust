...
impl GetNetworkResourceRelationshipsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_network_resource_relationships::GetNetworkResourceRelationshipsInput, ::aws_smithy_types::error::operation::BuildError> {
