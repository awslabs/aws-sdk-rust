...
impl GetNetworkResourceRelationshipsInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_network_resource_relationships::GetNetworkResourceRelationshipsInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
