...
pub use crate::operation::create_transit_gateway_peering::_create_transit_gateway_peering_output::CreateTransitGatewayPeeringOutputBuilder;
...
impl CreateTransitGatewayPeeringInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.create_transit_gateway_peering();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringOutput,
                    crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringError,
                > for CreateTransitGatewayPeeringFluentBuilder
            {
                fn send(
                    self,
...
impl CreateTransitGatewayPeeringFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeering::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeering::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringOutput, crate::operation::create_transit_gateway_peering::CreateTransitGatewayPeeringError, Self> {
