...
impl GetNetworkResourceRelationshipsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_network_resource_relationships::GetNetworkResourceRelationships,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_network_resource_relationships::GetNetworkResourceRelationships::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkResourceRelationships {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_network_resource_relationships::de_get_network_resource_relationships_http_response_with_props(
                status, headers, body,
            )
        }
    }
