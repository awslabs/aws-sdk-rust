...
impl GetLinkAssociationsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_link_associations::GetLinkAssociations,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLinkAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_link_associations::de_get_link_associations_http_response_with_props(status, headers, body)
        }
    }
}
