...
impl GetSitesInputBuilder {
    ...
    pub async fn send_with(
        ...
        ::aws_smithy_http::result::SdkError<crate::operation::get_sites::GetSitesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>,
    > {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_sites::GetSitesOutput, crate::operation::get_sites::GetSitesError>
    for GetSitesFluentBuilder
{
    fn send(
        self,
        config_override: crate::config::Builder,
    ) -> crate::client::customize::internal::BoxFuture<
        crate::client::customize::internal::SendResult<crate::operation::get_sites::GetSitesOutput, crate::operation::get_sites::GetSitesError>,
    > {
...
impl GetSitesFluentBuilder {
    ...
    > {
        ...
        let runtime_plugins = crate::operation::get_sites::GetSites::operation_runtime_plugins(
            self.handle.runtime_plugins.clone(),
            &self.handle.conf,
            self.config_override,
        );
        crate::operation::get_sites::GetSites::orchestrate(&runtime_plugins, input).await
    }

    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
    pub fn customize(
        self,
    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_sites::GetSitesOutput, crate::operation::get_sites::GetSitesError, Self>
    {
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::get_sites::paginator::GetSitesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
