...
impl GetSitesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_sites::GetSitesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_sites::GetSitesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
