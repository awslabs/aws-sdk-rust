...
impl GetSitesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Site, ::aws_smithy_http::result::SdkError<crate::operation::get_sites::GetSitesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_sites_output_sites(page).unwrap_or_default().into_iter())
    }
}
