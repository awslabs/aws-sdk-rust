...
impl UpdateGlobalNetworkInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_global_network::ser_update_global_network_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_global_network::UpdateGlobalNetwork::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::update_global_network::UpdateGlobalNetworkError
{
