...
impl ListOrganizationServiceAccessStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOrganizationServiceAccessStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_organization_service_access_status::de_list_organization_service_access_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
