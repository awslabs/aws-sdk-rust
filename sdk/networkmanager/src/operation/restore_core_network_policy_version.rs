...
impl RestoreCoreNetworkPolicyVersionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersion::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreCoreNetworkPolicyVersion {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_restore_core_network_policy_version::de_restore_core_network_policy_version_http_response_with_props(
                status, headers, body,
            )
        }
    }
