...
impl GetTransitGatewayRegistrationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_transit_gateway_registrations::GetTransitGatewayRegistrations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTransitGatewayRegistrations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_transit_gateway_registrations::de_get_transit_gateway_registrations_http_response_with_props(
                status, headers, body,
            )
        }
    }
