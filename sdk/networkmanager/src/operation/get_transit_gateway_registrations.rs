...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTransitGatewayRegistrations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_transit_gateway_registrations::de_get_transit_gateway_registrations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetTransitGatewayRegistrationsError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_transit_gateway_registrations::GetTransitGatewayRegistrationsError
{
