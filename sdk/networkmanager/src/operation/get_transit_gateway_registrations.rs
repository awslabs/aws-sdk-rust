    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_transit_gateway_registrations::GetTransitGatewayRegistrationsError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_transit_gateway_registrations::GetTransitGatewayRegistrationsOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetTransitGatewayRegistrationsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetTransitGatewayRegistrationsRequestSerializer {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_transit_gateway_registrations::GetTransitGatewayRegistrationsError {
