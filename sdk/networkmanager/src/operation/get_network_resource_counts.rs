...
impl GetNetworkResourceCountsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_network_resource_counts::GetNetworkResourceCounts::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNetworkResourceCounts {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_network_resource_counts::de_get_network_resource_counts_http_response_with_props(status, headers, body)
        }
    }
}
