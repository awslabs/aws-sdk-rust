...
impl crate::operation::create_site_to_site_vpn_attachment::builders::CreateSiteToSiteVpnAttachmentInputBuilder {
...
impl CreateSiteToSiteVpnAttachmentFluentBuilder {
    /// Creates a new `CreateSiteToSiteVpnAttachmentFluentBuilder`.
