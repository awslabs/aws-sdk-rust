...
impl crate::operation::get_transit_gateway_registrations::builders::GetTransitGatewayRegistrationsInputBuilder {
...
impl GetTransitGatewayRegistrationsFluentBuilder {
    /// Creates a new `GetTransitGatewayRegistrationsFluentBuilder`.
