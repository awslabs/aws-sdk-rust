...
impl GetDevicesPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Device, ::aws_smithy_http::result::SdkError<crate::operation::get_devices::GetDevicesError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_devices_output_devices(page).unwrap_or_default().into_iter())
    }
}
