        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp =
                            crate::operation::get_connect_peer_associations::GetConnectPeerAssociations::orchestrate(&runtime_plugins, input.clone())
                                .await;
...
impl GetConnectPeerAssociationsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_connect_peer_associations_output_output_connect_peer_associations(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
