...
impl GetCoreNetworkChangeSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_core_network_change_set::GetCoreNetworkChangeSetInput, ::aws_smithy_types::error::operation::BuildError> {
