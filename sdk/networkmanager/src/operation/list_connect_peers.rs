...
impl ListConnectPeersInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_connect_peers::ListConnectPeers,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConnectPeers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_connect_peers::de_list_connect_peers_http_response_with_props(status, headers, body)
        }
    }
}
