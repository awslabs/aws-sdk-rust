...
impl GetCustomerGatewayAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_customer_gateway_associations::GetCustomerGatewayAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCustomerGatewayAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_customer_gateway_associations::de_get_customer_gateway_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
