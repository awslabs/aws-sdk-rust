...
impl PutCoreNetworkPolicyFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::put_core_network_policy::PutCoreNetworkPolicyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::put_core_network_policy::PutCoreNetworkPolicyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::put_core_network_policy::PutCoreNetworkPolicyOutput, crate::operation::put_core_network_policy::PutCoreNetworkPolicyError, Self> {
