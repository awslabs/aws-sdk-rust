...
impl AcceptAttachmentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::accept_attachment::AcceptAttachmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::accept_attachment::AcceptAttachmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::accept_attachment::AcceptAttachmentOutput, crate::operation::accept_attachment::AcceptAttachmentError, Self> {
