...
impl UpdateNetworkResourceMetadataInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_network_resource_metadata::UpdateNetworkResourceMetadata::new(
            ),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNetworkResourceMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_network_resource_metadata::de_update_network_resource_metadata_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for UpdateNetworkResourceMetadataError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_network_resource_metadata::UpdateNetworkResourceMetadataError
{
