...
impl AssociateTransitGatewayConnectPeerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_transit_gateway_connect_peer::AssociateTransitGatewayConnectPeer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateTransitGatewayConnectPeer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_transit_gateway_connect_peer::de_associate_transit_gateway_connect_peer_http_response_with_props(
                status, headers, body,
            )
        }
    }
