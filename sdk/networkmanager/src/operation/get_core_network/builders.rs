...
impl GetCoreNetworkFluentBuilder  {
    /// Creates a new `GetCoreNetwork`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_core_network::GetCoreNetworkOutput, aws_smithy_http::result::SdkError<crate::operation::get_core_network::GetCoreNetworkError>>
                     {
