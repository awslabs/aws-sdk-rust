...
pub use crate::operation::list_core_network_policy_versions::_list_core_network_policy_versions_output::ListCoreNetworkPolicyVersionsOutputBuilder;

pub use crate::operation::list_core_network_policy_versions::_list_core_network_policy_versions_input::ListCoreNetworkPolicyVersionsInputBuilder;
...
impl ListCoreNetworkPolicyVersionsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_core_network_policy_versions();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsOutput,
                    crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsError,
                > for ListCoreNetworkPolicyVersionsFluentBuilder
            {
                fn send(
                    self,
...
impl ListCoreNetworkPolicyVersionsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersions::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsOutput, crate::operation::list_core_network_policy_versions::ListCoreNetworkPolicyVersionsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_core_network_policy_versions::paginator::ListCoreNetworkPolicyVersionsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
