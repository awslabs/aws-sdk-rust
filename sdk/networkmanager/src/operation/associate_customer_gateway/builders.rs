...
impl AssociateCustomerGatewayFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::associate_customer_gateway::AssociateCustomerGatewayOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::associate_customer_gateway::AssociateCustomerGatewayError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::associate_customer_gateway::AssociateCustomerGatewayOutput, crate::operation::associate_customer_gateway::AssociateCustomerGatewayError, Self> {
