...
impl GetConnectPeerAssociationsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::get_connect_peer_associations::GetConnectPeerAssociations,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_connect_peer_associations::GetConnectPeerAssociations::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetConnectPeerAssociations {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_connect_peer_associations::de_get_connect_peer_associations_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::get_connect_peer_associations::GetConnectPeerAssociationsError
{
