...
impl GetLinksPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Link, ::aws_smithy_http::result::SdkError<crate::operation::get_links::GetLinksError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_links_output_links(page).unwrap_or_default().into_iter())
    }
}
