...
pub fn serialize_structure_crate_input_update_device_input(
    ...
    if let Some(var_62) = &input.aws_location {
        ...
        crate::json_ser::serialize_structure_crate_model_aws_location(&mut object_63, var_62);
        object_63.finish();
    }
    ...
    if let Some(var_65) = &input.location {
        ...
        crate::json_ser::serialize_structure_crate_model_location(&mut object_66, var_65);
        object_66.finish();
    }
...
pub fn serialize_structure_crate_input_update_link_input(
    ...
    if let Some(var_73) = &input.bandwidth {
        ...
        crate::json_ser::serialize_structure_crate_model_bandwidth(&mut object_74, var_73);
        object_74.finish();
    }
...
pub fn serialize_structure_crate_input_update_site_input(
    ...
    if let Some(var_79) = &input.location {
        ...
        crate::json_ser::serialize_structure_crate_model_location(&mut object_80, var_79);
        object_80.finish();
    }
}
