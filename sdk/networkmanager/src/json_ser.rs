...
pub fn serialize_structure_crate_input_associate_connect_peer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateConnectPeerInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_associate_customer_gateway_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateCustomerGatewayInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_associate_link_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateLinkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_associate_transit_gateway_connect_peer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateTransitGatewayConnectPeerInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_connect_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConnectAttachmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_connect_peer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConnectPeerInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_core_network_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCoreNetworkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDeviceInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_global_network_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateGlobalNetworkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_link_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateLinkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_site_to_site_vpn_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateSiteToSiteVpnAttachmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_transit_gateway_peering_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTransitGatewayPeeringInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_transit_gateway_route_table_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateTransitGatewayRouteTableAttachmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_vpc_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateVpcAttachmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_network_routes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetNetworkRoutesInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_put_core_network_policy_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::PutCoreNetworkPolicyInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_register_transit_gateway_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterTransitGatewayInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_organization_service_access_update_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartOrganizationServiceAccessUpdateInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_route_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRouteAnalysisInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_core_network_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCoreNetworkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_global_network_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGlobalNetworkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_link_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateLinkInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_network_resource_metadata_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateNetworkResourceMetadataInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_vpc_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateVpcAttachmentInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_connect_attachment_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConnectAttachmentOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_bgp_options(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BgpOptions) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_aws_location(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsLocation) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_bandwidth(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Bandwidth) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_route_table_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RouteTableIdentifier) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_route_analysis_endpoint_options_specification(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RouteAnalysisEndpointOptionsSpecification) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_core_network_segment_edge_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CoreNetworkSegmentEdgeIdentifier) -> Result<(), aws_smithy_http::operation::SerializationError> {
