...
//! aws-sdk-networkmanager = "0.0.0-local"
...
//! offered by AWS Network Manager. The return value of each of these methods is a "fluent builder",
...
/// Client for calling AWS Network Manager.
...
/// Configuration for AWS Network Manager.
pub mod config;
