...
pub fn ser_start_route_analysis_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartRouteAnalysisInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
