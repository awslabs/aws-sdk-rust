...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::unhandled)?;
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_retry_after_seconds(
                        crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                            crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_restore_core_network_policy_version::de_restore_core_network_policy_version(_response_body, output)
            .map_err(crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "CoreNetworkPolicy" => {
                    builder = builder.set_core_network_policy(crate::protocol_serde::shape_core_network_policy::de_core_network_policy(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
