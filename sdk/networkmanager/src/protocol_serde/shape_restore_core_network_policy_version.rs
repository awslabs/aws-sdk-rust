...
pub fn de_restore_core_network_policy_version_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreCoreNetworkPolicyVersionOutput, crate::error::RestoreCoreNetworkPolicyVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::RestoreCoreNetworkPolicyVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_restore_core_network_policy_version_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RestoreCoreNetworkPolicyVersionOutput, crate::error::RestoreCoreNetworkPolicyVersionError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_restore_core_network_policy_version(value: &[u8], mut builder: crate::output::restore_core_network_policy_version_output::Builder) -> Result<crate::output::restore_core_network_policy_version_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
