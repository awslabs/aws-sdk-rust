...
pub(crate) fn de_transit_gateway_registration_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::TransitGatewayRegistration>>, aws_smithy_json::deserialize::error::DeserializeError>
