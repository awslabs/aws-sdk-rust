...
pub fn de_describe_global_networks_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_global_networks::DescribeGlobalNetworksOutput, crate::operation::describe_global_networks::DescribeGlobalNetworksError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::access_denied_exception_correct_errors(output).build().map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::internal_server_exception_correct_errors(output).build().map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::throttling_exception_correct_errors(output).build().map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::validation_exception_correct_errors(output).build().map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_global_networks_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_global_networks::DescribeGlobalNetworksOutput, crate::operation::describe_global_networks::DescribeGlobalNetworksError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_global_networks::builders::DescribeGlobalNetworksOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_global_networks::de_describe_global_networks(_response_body, output).map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?;
