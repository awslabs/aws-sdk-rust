...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_global_networks::de_describe_global_networks(_response_body, output)
            .map_err(crate::operation::describe_global_networks::DescribeGlobalNetworksError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "GlobalNetworks" => {
                    builder = builder.set_global_networks(crate::protocol_serde::shape_global_network_list::de_global_network_list(tokens, _value)?);
                }
                "NextToken" => {
