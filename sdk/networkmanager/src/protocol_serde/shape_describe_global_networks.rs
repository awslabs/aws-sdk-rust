...
pub fn de_describe_global_networks_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_global_networks::DescribeGlobalNetworksOutput, crate::operation::describe_global_networks::DescribeGlobalNetworksError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_global_networks_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_global_networks::DescribeGlobalNetworksOutput, crate::operation::describe_global_networks::DescribeGlobalNetworksError> {
    Ok({
        #[allow(unused_mut)]
