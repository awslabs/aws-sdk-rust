...
pub fn ser_update_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
