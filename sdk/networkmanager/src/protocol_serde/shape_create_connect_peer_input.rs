...
pub fn ser_create_connect_peer_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConnectPeerInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
