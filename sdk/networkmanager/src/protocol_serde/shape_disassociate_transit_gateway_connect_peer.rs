...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::unhandled("Failed to parse RetryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        "ResourceNotFoundException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_disassociate_transit_gateway_connect_peer::de_disassociate_transit_gateway_connect_peer(
            _response_body,
            output,
        )
        .map_err(crate::operation::disassociate_transit_gateway_connect_peer::DisassociateTransitGatewayConnectPeerError::unhandled)?;
