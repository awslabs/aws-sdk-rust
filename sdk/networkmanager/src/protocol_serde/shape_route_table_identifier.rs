...
pub fn ser_route_table_identifier(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RouteTableIdentifier) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
