...
pub fn ser_create_vpc_attachment_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateVpcAttachmentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
