...
pub fn de_create_transit_gateway_route_table_attachment_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::unhandled(generic),
            )
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                        ...
                        match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                                            ...
                                            ::std::result::Result::Err(err) => {
                                                        ...
                                                        == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                                                {
                                                    ...
                                                    return ::std::result::Result::Err(crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::unhandled("Failed to parse RetryAfterSeconds from header `Retry-After`"));
                                                }
                                            }
                                        }
                    );
        ...
        "ResourceNotFoundException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::ResourceNotFoundException(
                {
                    #[allow(unused_mut)]
                    let mut tmp = {
                        #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_transit_gateway_route_table_attachment_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_create_transit_gateway_route_table_attachment::de_create_transit_gateway_route_table_attachment(
            _response_body,
            output,
        )
        .map_err(crate::operation::create_transit_gateway_route_table_attachment::CreateTransitGatewayRouteTableAttachmentError::unhandled)?;
...
pub fn ser_create_transit_gateway_route_table_attachment_input(
    ...
    crate::protocol_serde::shape_create_transit_gateway_route_table_attachment_input::ser_create_transit_gateway_route_table_attachment_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_create_transit_gateway_route_table_attachment(
    _value: &[u8],
    mut builder: crate::operation::create_transit_gateway_route_table_attachment::builders::CreateTransitGatewayRouteTableAttachmentOutputBuilder,
) -> ::std::result::Result<
