...
pub fn ser_get_network_routes_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetNetworkRoutesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
