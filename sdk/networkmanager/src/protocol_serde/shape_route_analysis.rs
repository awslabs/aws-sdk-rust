                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Source" => {
                            builder = builder.set_source(
                                crate::protocol_serde::shape_route_analysis_endpoint_options::de_route_analysis_endpoint_options(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "ForwardPath" => {
                            builder = builder.set_forward_path(crate::protocol_serde::shape_route_analysis_path::de_route_analysis_path(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ReturnPath" => {
                            builder = builder.set_return_path(crate::protocol_serde::shape_route_analysis_path::de_route_analysis_path(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
