...
pub(crate) fn de_route_analysis<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RouteAnalysis>, aws_smithy_json::deserialize::error::DeserializeError>
