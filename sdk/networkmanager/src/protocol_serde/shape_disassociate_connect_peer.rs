...
pub fn de_disassociate_connect_peer_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateConnectPeerOutput, crate::error::DisassociateConnectPeerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DisassociateConnectPeerError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_connect_peer_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DisassociateConnectPeerOutput, crate::error::DisassociateConnectPeerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::disassociate_connect_peer_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_disassociate_connect_peer::de_disassociate_connect_peer(response.body().as_ref(), output).map_err(crate::error::DisassociateConnectPeerError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_disassociate_connect_peer(value: &[u8], mut builder: crate::output::disassociate_connect_peer_output::Builder) -> Result<crate::output::disassociate_connect_peer_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
