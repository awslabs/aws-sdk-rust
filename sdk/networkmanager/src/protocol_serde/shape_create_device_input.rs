...
pub fn ser_create_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
