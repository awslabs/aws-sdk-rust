    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRDFGraphSummary")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetRDFGraphSummaryEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
pub type GetRDFGraphSummaryErrorKind = GetRDFGraphSummaryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetRDFGraphSummaryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_rdf_graph_summary::GetRDFGraphSummaryError {
...
impl GetRDFGraphSummaryError {
    ...
    /// Creates the `GetRDFGraphSummaryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
