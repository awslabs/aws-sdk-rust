...
pub use crate::operation::start_ml_model_transform_job::_start_ml_model_transform_job_output::StartMlModelTransformJobOutputBuilder;
...
impl StartMlModelTransformJobInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.start_ml_model_transform_job();
...
/// 
/// <p>Creates a new model transform job. See <a href="https://docs.aws.amazon.com/neptune/latest/userguide/machine-learning-model-transform.html">Use a trained model to generate new model artifacts</a>.</p>
...
pub struct StartMLModelTransformJobFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::start_ml_model_transform_job::builders::StartMlModelTransformJobInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::start_ml_model_transform_job::StartMlModelTransformJobOutput,
                    crate::operation::start_ml_model_transform_job::StartMLModelTransformJobError,
                > for StartMLModelTransformJobFluentBuilder
            {
                fn send(
                    self,
...
impl StartMLModelTransformJobFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::start_ml_model_transform_job::builders::StartMlModelTransformJobInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::start_ml_model_transform_job::StartMlModelTransformJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::start_ml_model_transform_job::StartMLModelTransformJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::start_ml_model_transform_job::StartMLModelTransformJob::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::start_ml_model_transform_job::StartMLModelTransformJob::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::start_ml_model_transform_job::StartMlModelTransformJobOutput, crate::operation::start_ml_model_transform_job::StartMLModelTransformJobError, Self> {
    ...
    pub fn custom_model_transform_parameters(mut self, input: crate::types::CustomModelTransformParameters) -> Self {
        self.inner = self.inner.custom_model_transform_parameters(input);
        self
    }
    /// <p>Configuration information for a model transform using a custom model. The <code>customModelTransformParameters</code> object contains the following fields, which must have values compatible with the saved model parameters from the training job:</p>
    pub fn set_custom_model_transform_parameters(mut self, input: ::std::option::Option<crate::types::CustomModelTransformParameters>) -> Self {
        self.inner = self.inner.set_custom_model_transform_parameters(input);
        self
    }
    /// <p>Configuration information for a model transform using a custom model. The <code>customModelTransformParameters</code> object contains the following fields, which must have values compatible with the saved model parameters from the training job:</p>
    pub fn get_custom_model_transform_parameters(&self) -> &::std::option::Option<crate::types::CustomModelTransformParameters> {
        self.inner.get_custom_model_transform_parameters()
    }
    ...
    pub fn base_processing_instance_volume_size_in_gb(mut self, input: i32) -> Self {
        self.inner = self.inner.base_processing_instance_volume_size_in_gb(input);
        self
    }
    /// <p>The disk volume size of the training instance in gigabytes. The default is 0. Both input data and the output model are stored on disk, so the volume size must be large enough to hold both data sets. If not specified or 0, Neptune ML selects a disk volume size based on the recommendation generated in the data processing step.</p>
    pub fn set_base_processing_instance_volume_size_in_gb(mut self, input: ::std::option::Option<i32>) -> Self {
        self.inner = self.inner.set_base_processing_instance_volume_size_in_gb(input);
        self
    }
    /// <p>The disk volume size of the training instance in gigabytes. The default is 0. Both input data and the output model are stored on disk, so the volume size must be large enough to hold both data sets. If not specified or 0, Neptune ML selects a disk volume size based on the recommendation generated in the data processing step.</p>
