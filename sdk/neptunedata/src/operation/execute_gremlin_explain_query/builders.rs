...
impl ExecuteGremlinExplainQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::execute_gremlin_explain_query::ExecuteGremlinExplainQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_gremlin_explain_query::ExecuteGremlinExplainQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::execute_gremlin_explain_query::ExecuteGremlinExplainQueryOutput, crate::operation::execute_gremlin_explain_query::ExecuteGremlinExplainQueryError, Self> {
