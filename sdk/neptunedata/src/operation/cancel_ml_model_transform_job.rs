...
impl CancelMLModelTransformJob {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "neptunedata.CancelMLModelTransformJob",
            "rpc.service" = "neptunedata",
            "rpc.method" = "CancelMLModelTransformJob",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelMLModelTransformJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CancelMLModelTransformJobRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CancelMLModelTransformJobResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CancelMLModelTransformJob")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelMLModelTransformJob")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CancelMLModelTransformJobTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct CancelMLModelTransformJobTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CancelMLModelTransformJobTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<CancelMlModelTransformJobInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CancelMLModelTransformJobResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_cancel_ml_model_transform_job::de_cancel_ml_model_transform_job_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_cancel_ml_model_transform_job::de_cancel_ml_model_transform_job_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CancelMLModelTransformJobRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::cancel_ml_model_transform_job::CancelMlModelTransformJobInput,
