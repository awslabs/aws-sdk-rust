...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelMLModelTransformJob {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelMLModelTransformJob", "neptunedata"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CancelMLModelTransformJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CancelMLModelTransformJobRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelMLModelTransformJobEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelMLModelTransformJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_ml_model_transform_job::CancelMLModelTransformJobError {
...
impl CancelMLModelTransformJobError {
    ...
    /// Creates the `CancelMLModelTransformJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
