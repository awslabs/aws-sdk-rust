...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CancelGremlinQuery {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("CancelGremlinQuery", "neptunedata"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CancelGremlinQuery")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CancelGremlinQueryEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for CancelGremlinQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for CancelGremlinQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("query_id", "cannot be empty or unset"))?;
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CancelGremlinQueryEndpointParamsInterceptor {
...
pub type CancelGremlinQueryErrorKind = CancelGremlinQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelGremlinQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_gremlin_query::CancelGremlinQueryError {
...
impl CancelGremlinQueryError {
    ...
    /// Creates the `CancelGremlinQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
