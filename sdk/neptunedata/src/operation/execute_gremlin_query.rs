    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("neptunedata", "ExecuteGremlinQuery", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                "neptunedata.ExecuteGremlinQuery",
                "rpc.service" = "neptunedata",
                "rpc.method" = "ExecuteGremlinQuery",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ExecuteGremlinQuery")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteGremlinQuery")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ExecuteGremlinQueryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ExecuteGremlinQueryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ExecuteGremlinQueryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ExecuteGremlinQueryInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("gremlinQuery") {
            if let ::std::option::Option::Some(value) = input.gremlin_query.as_deref() {
                captured.insert("gremlinQuery", value);
            }
        }
        if requested.should_capture("serializer") {
            if let ::std::option::Option::Some(value) = input.serializer.as_deref() {
                captured.insert("serializer", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ExecuteGremlinQueryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_execute_gremlin_query::de_execute_gremlin_query_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_execute_gremlin_query::de_execute_gremlin_query_http_response(status, headers, body, _cfg)
        };
