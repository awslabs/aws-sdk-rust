    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteGremlinQuery")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ExecuteGremlinQueryEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ExecuteGremlinQueryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ExecuteGremlinQueryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_gremlin_query::ser_execute_gremlin_query_input(
            &input,
        )?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExecuteGremlinQueryEndpointParamsInterceptor {
...
pub type ExecuteGremlinQueryErrorKind = ExecuteGremlinQueryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ExecuteGremlinQueryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_gremlin_query::ExecuteGremlinQueryError {
...
impl ExecuteGremlinQueryError {
    ...
    /// Creates the `ExecuteGremlinQueryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::CancelledByUserException(e) => e.meta(),
            ...
            Self::QueryLimitExceededException(e) => e.meta(),
            Self::QueryLimitException(e) => e.meta(),
            Self::QueryTooLargeException(e) => e.meta(),
