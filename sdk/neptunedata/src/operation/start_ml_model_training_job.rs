...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for StartMLModelTrainingJobResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for StartMLModelTrainingJobRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for StartMLModelTrainingJobEndpointParamsInterceptor {
...
pub type StartMLModelTrainingJobErrorKind = StartMLModelTrainingJobError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StartMLModelTrainingJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_ml_model_training_job::StartMLModelTrainingJobError {
...
impl StartMLModelTrainingJobError {
    ...
    /// Creates the `StartMLModelTrainingJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
