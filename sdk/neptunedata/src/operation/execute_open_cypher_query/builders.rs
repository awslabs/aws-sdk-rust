...
impl ExecuteOpenCypherQueryFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryOutput, crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError, Self> {
