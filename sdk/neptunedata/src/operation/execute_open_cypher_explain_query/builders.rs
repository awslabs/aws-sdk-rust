...
impl crate::operation::execute_open_cypher_explain_query::builders::ExecuteOpenCypherExplainQueryInputBuilder {
...
impl ExecuteOpenCypherExplainQueryFluentBuilder {
    /// Creates a new `ExecuteOpenCypherExplainQueryFluentBuilder`.
