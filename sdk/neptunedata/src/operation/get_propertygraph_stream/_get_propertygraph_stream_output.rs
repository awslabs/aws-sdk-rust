...
impl GetPropertygraphStreamOutputBuilder {
    ...
    /// <p>Sequence identifier of the last change in the stream response.</p>
    /// <p>An event ID is composed of two fields: a <code>commitNum</code>, which identifies a transaction that changed the graph, and an <code>opNum</code>, which identifies a specific operation within that transaction:</p>
    pub fn set_last_event_id(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, ::std::string::String>>) -> Self {
        self.last_event_id = input; self
    }
    /// <p>Sequence identifier of the last change in the stream response.</p>
    /// <p>An event ID is composed of two fields: a <code>commitNum</code>, which identifies a transaction that changed the graph, and an <code>opNum</code>, which identifies a specific operation within that transaction:</p>
    ...
    pub fn set_last_trx_timestamp_in_millis(mut self, input: ::std::option::Option<i64>) -> Self {
        self.last_trx_timestamp_in_millis = input; self
    }
    /// <p>The time at which the commit for the transaction was requested, in milliseconds from the Unix epoch.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_propertygraph_stream::GetPropertygraphStreamOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_propertygraph_stream::GetPropertygraphStreamOutput {
                last_event_id: self.last_event_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_event_id", "last_event_id was not specified but it is required when building GetPropertygraphStreamOutput")
                    )?
                ,
                last_trx_timestamp_in_millis: self.last_trx_timestamp_in_millis
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_trx_timestamp_in_millis", "last_trx_timestamp_in_millis was not specified but it is required when building GetPropertygraphStreamOutput")
                    )?
                ,
                format: self.format
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("format", "format was not specified but it is required when building GetPropertygraphStreamOutput")
                    )?
                ,
                records: self.records
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("records", "records was not specified but it is required when building GetPropertygraphStreamOutput")
                    )?
                ,
                total_records: self.total_records
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("total_records", "total_records was not specified but it is required when building GetPropertygraphStreamOutput")
                    )?
                ,
