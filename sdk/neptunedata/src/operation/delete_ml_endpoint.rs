    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteMLEndpoint")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(DeleteMLEndpointEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeleteMLEndpointResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteMLEndpointRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteMLEndpointEndpointParamsInterceptor {
...
pub type DeleteMLEndpointErrorKind = DeleteMLEndpointError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteMLEndpointError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_ml_endpoint::DeleteMLEndpointError {
...
impl DeleteMLEndpointError {
    ...
    /// Creates the `DeleteMLEndpointError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
