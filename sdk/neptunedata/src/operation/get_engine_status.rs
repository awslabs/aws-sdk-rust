    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetEngineStatus")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetEngineStatusEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetEngineStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetEngineStatusRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetEngineStatusEndpointParamsInterceptor {
...
pub type GetEngineStatusErrorKind = GetEngineStatusError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetEngineStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_engine_status::GetEngineStatusError {
...
impl GetEngineStatusError {
    ...
    /// Creates the `GetEngineStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
