    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSparqlStream")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetSparqlStreamEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetSparqlStreamResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetSparqlStreamRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetSparqlStreamEndpointParamsInterceptor {
...
pub type GetSparqlStreamErrorKind = GetSparqlStreamError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetSparqlStreamError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_sparql_stream::GetSparqlStreamError {
...
impl GetSparqlStreamError {
    ...
    /// Creates the `GetSparqlStreamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
