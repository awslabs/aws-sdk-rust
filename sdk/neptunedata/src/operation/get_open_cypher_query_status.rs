...
impl GetOpenCypherQueryStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_open_cypher_query_status::GetOpenCypherQueryStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_open_cypher_query_status::GetOpenCypherQueryStatusOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "neptunedata.GetOpenCypherQueryStatus",
            "rpc.service" = "neptunedata",
            "rpc.method" = "GetOpenCypherQueryStatus",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOpenCypherQueryStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetOpenCypherQueryStatusRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetOpenCypherQueryStatusResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetOpenCypherQueryStatus")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOpenCypherQueryStatus")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOpenCypherQueryStatusTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetOpenCypherQueryStatusTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOpenCypherQueryStatusTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOpenCypherQueryStatusInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOpenCypherQueryStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_open_cypher_query_status::de_get_open_cypher_query_status_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_open_cypher_query_status::de_get_open_cypher_query_status_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOpenCypherQueryStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_open_cypher_query_status::GetOpenCypherQueryStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_open_cypher_query_status::GetOpenCypherQueryStatusInput,
