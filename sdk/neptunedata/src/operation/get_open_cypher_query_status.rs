...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOpenCypherQueryStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetOpenCypherQueryStatus", "neptunedata"));
    ...
    fn runtime_components(
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOpenCypherQueryStatus")
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetOpenCypherQueryStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetOpenCypherQueryStatusRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetOpenCypherQueryStatusEndpointParamsInterceptor {
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetOpenCypherQueryStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_open_cypher_query_status::GetOpenCypherQueryStatusError {
...
impl GetOpenCypherQueryStatusError {
    ...
    /// Creates the `GetOpenCypherQueryStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
