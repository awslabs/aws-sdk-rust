...
impl ListOpenCypherQueries {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_open_cypher_queries::ListOpenCypherQueriesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_open_cypher_queries::ListOpenCypherQueriesOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("neptunedata", "ListOpenCypherQueries", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListOpenCypherQueries {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListOpenCypherQueriesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListOpenCypherQueriesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListOpenCypherQueries", "neptunedata"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListOpenCypherQueriesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListOpenCypherQueriesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_open_cypher_queries::ListOpenCypherQueriesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_open_cypher_queries::ListOpenCypherQueriesInput,
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListOpenCypherQueriesEndpointParamsInterceptor {
...
pub type ListOpenCypherQueriesErrorKind = ListOpenCypherQueriesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListOpenCypherQueriesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_open_cypher_queries::ListOpenCypherQueriesError {
...
impl ListOpenCypherQueriesError {
    ...
    /// Creates the `ListOpenCypherQueriesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
