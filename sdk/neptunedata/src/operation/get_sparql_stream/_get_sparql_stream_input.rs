...
impl GetSparqlStreamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_sparql_stream::GetSparqlStreamInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_sparql_stream::GetSparqlStreamInput {
                limit: self.limit
                ,
