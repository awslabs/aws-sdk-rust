...
/// Orchestration and serialization glue logic for `CreateMLEndpoint`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct CreateMLEndpoint;
impl CreateMLEndpoint {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_ml_endpoint::CreateMlEndpointOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_ml_endpoint::CreateMLEndpointError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_ml_endpoint::CreateMLEndpointError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_ml_endpoint::CreateMlEndpointOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateMLEndpoint {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateMLEndpoint");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateMLEndpointRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateMLEndpointResponseDeserializer));
...
.with_interceptor(CreateMLEndpointEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_ml_endpoint::CreateMLEndpointError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_ml_endpoint::CreateMLEndpointError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_ml_endpoint::CreateMLEndpointError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_ml_endpoint::de_create_ml_endpoint_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_ml_endpoint::de_create_ml_endpoint_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateMLEndpointRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateMLEndpointRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_ml_endpoint::CreateMlEndpointInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_ml_endpoint::CreateMlEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/ml/endpoints").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_ml_endpoint::ser_create_ml_endpoint_input(&input)?);
...
#[derive(Debug)]
            struct CreateMLEndpointEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateMLEndpointEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateMLEndpointEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateMlEndpointInput>()
                        .ok_or("failed to downcast to CreateMlEndpointInput")?;
...
/// Error type for the `CreateMLEndpointError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateMLEndpointError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateMLEndpointError) for what information is available for the error.")]
                    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl CreateMLEndpointError {
    /// Creates the `CreateMLEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateMLEndpointError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `CreateMLEndpointError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::ClientTimeoutException`.
    pub fn is_client_timeout_exception(&self) -> bool {
        matches!(self, Self::ClientTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::IllegalArgumentException`.
    pub fn is_illegal_argument_exception(&self) -> bool {
        matches!(self, Self::IllegalArgumentException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::InvalidArgumentException`.
    pub fn is_invalid_argument_exception(&self) -> bool {
        matches!(self, Self::InvalidArgumentException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::MissingParameterException`.
    pub fn is_missing_parameter_exception(&self) -> bool {
        matches!(self, Self::MissingParameterException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::MlResourceNotFoundException`.
    pub fn is_ml_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::MlResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::PreconditionsFailedException`.
    pub fn is_preconditions_failed_exception(&self) -> bool {
        matches!(self, Self::PreconditionsFailedException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `CreateMLEndpointError::UnsupportedOperationException`.
    pub fn is_unsupported_operation_exception(&self) -> bool {
        matches!(self, Self::UnsupportedOperationException(_))
    }
}
impl ::std::error::Error for CreateMLEndpointError {
...
impl ::std::fmt::Display for CreateMLEndpointError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateMLEndpointError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateMLEndpointError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateMLEndpointError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_ml_endpoint::CreateMLEndpointError {
...
mod _create_ml_endpoint_output;
