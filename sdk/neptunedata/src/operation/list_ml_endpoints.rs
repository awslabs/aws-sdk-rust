    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListMLEndpoints")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListMLEndpointsEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListMLEndpointsResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListMLEndpointsRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListMLEndpointsEndpointParamsInterceptor {
...
pub type ListMLEndpointsErrorKind = ListMLEndpointsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListMLEndpointsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_ml_endpoints::ListMLEndpointsError {
...
impl ListMLEndpointsError {
    ...
    /// Creates the `ListMLEndpointsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
