    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ExecuteFastReset")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ExecuteFastResetEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ExecuteFastResetResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ExecuteFastResetRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_execute_fast_reset::ser_execute_fast_reset_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ExecuteFastResetEndpointParamsInterceptor {
...
pub type ExecuteFastResetErrorKind = ExecuteFastResetError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ExecuteFastResetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_fast_reset::ExecuteFastResetError {
...
impl ExecuteFastResetError {
    ...
    /// Creates the `ExecuteFastResetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::ServerShutdownException(e) => e.meta(),
