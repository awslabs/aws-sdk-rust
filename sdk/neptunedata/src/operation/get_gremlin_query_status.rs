...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetGremlinQueryStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetGremlinQueryStatus", "neptunedata"));
...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetGremlinQueryStatusResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetGremlinQueryStatusRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetGremlinQueryStatusEndpointParamsInterceptor {
...
pub type GetGremlinQueryStatusErrorKind = GetGremlinQueryStatusError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetGremlinQueryStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_gremlin_query_status::GetGremlinQueryStatusError {
...
impl GetGremlinQueryStatusError {
    ...
    /// Creates the `GetGremlinQueryStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
