...
pub fn de_delete_sparql_statistics_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_sparql_statistics::DeleteSparqlStatisticsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_sparql_statistics::DeleteSparqlStatisticsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "StatisticsNotAvailableException" => {
            crate::operation::delete_sparql_statistics::DeleteSparqlStatisticsError::StatisticsNotAvailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_sparql_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_sparql_statistics::de_delete_sparql_statistics(_response_body, output)
            .map_err(crate::operation::delete_sparql_statistics::DeleteSparqlStatisticsError::unhandled)?;
...
pub(crate) fn de_delete_sparql_statistics(
    value: &[u8],
    mut builder: crate::operation::delete_sparql_statistics::builders::DeleteSparqlStatisticsOutputBuilder,
) -> Result<
    crate::operation::delete_sparql_statistics::builders::DeleteSparqlStatisticsOutputBuilder,
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(crate::protocol_serde::shape_delete_statistics_value_map::de_delete_statistics_value_map(
                        tokens,
                    )?);
                }
                "status" => {
