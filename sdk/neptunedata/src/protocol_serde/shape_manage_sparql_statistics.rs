...
pub fn de_manage_sparql_statistics_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::manage_sparql_statistics::ManageSparqlStatisticsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::manage_sparql_statistics::ManageSparqlStatisticsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "StatisticsNotAvailableException" => {
            crate::operation::manage_sparql_statistics::ManageSparqlStatisticsError::StatisticsNotAvailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_manage_sparql_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_manage_sparql_statistics::de_manage_sparql_statistics(_response_body, output)
            .map_err(crate::operation::manage_sparql_statistics::ManageSparqlStatisticsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::manage_sparql_statistics_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::manage_sparql_statistics::ManageSparqlStatisticsError::unhandled)?
    })
}
