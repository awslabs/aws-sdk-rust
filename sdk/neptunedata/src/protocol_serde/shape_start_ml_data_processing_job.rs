...
pub fn de_start_ml_data_processing_job_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MLResourceNotFoundException" => {
            crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::MlResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::MlResourceNotFoundExceptionBuilder::default();
                    output = crate::protocol_serde::shape_ml_resource_not_found_exception::de_ml_resource_not_found_exception_json_err(
                        _response_body,
                        output,
                    )
                    .map_err(crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::unhandled)?;
        ...
        "PreconditionsFailedException" => {
            crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_ml_data_processing_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_start_ml_data_processing_job::de_start_ml_data_processing_job(_response_body, output)
            .map_err(crate::operation::start_ml_data_processing_job::StartMLDataProcessingJobError::unhandled)?;
...
pub(crate) fn de_start_ml_data_processing_job(
    value: &[u8],
    mut builder: crate::operation::start_ml_data_processing_job::builders::StartMlDataProcessingJobOutputBuilder,
) -> Result<
    crate::operation::start_ml_data_processing_job::builders::StartMlDataProcessingJobOutputBuilder,
