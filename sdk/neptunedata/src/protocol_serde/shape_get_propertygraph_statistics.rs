...
pub fn de_get_propertygraph_statistics_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReadOnlyViolationException" => {
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::ReadOnlyViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "StatisticsNotAvailableException" => {
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::StatisticsNotAvailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_propertygraph_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        crate::serde_util::get_propertygraph_statistics_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_propertygraph_statistics::GetPropertygraphStatisticsError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(crate::protocol_serde::shape_statistics::de_statistics(tokens, _value, depth + 1)?);
                }
                "status" => {
