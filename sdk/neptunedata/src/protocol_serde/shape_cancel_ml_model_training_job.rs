...
pub fn de_cancel_ml_model_training_job_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MLResourceNotFoundException" => {
            crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::MlResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_ml_model_training_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_ml_model_training_job::de_cancel_ml_model_training_job(_response_body, output)
            .map_err(crate::operation::cancel_ml_model_training_job::CancelMLModelTrainingJobError::unhandled)?;
