...
pub fn de_get_rdf_graph_summary_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_rdf_graph_summary::GetRDFGraphSummaryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_rdf_graph_summary_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_rdf_graph_summary::de_get_rdf_graph_summary(_response_body, output)
            .map_err(crate::operation::get_rdf_graph_summary::GetRDFGraphSummaryError::unhandled)?;
...
pub(crate) fn de_get_rdf_graph_summary(
    value: &[u8],
    mut builder: crate::operation::get_rdf_graph_summary::builders::GetRdfGraphSummaryOutputBuilder,
) -> Result<crate::operation::get_rdf_graph_summary::builders::GetRdfGraphSummaryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(crate::protocol_serde::shape_rdf_graph_summary_value_map::de_rdf_graph_summary_value_map(
                        tokens,
                    )?);
                }
