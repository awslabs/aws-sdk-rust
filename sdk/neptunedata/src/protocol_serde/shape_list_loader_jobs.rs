...
pub fn de_list_loader_jobs_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_loader_jobs::ListLoaderJobsOutput, crate::operation::list_loader_jobs::ListLoaderJobsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_loader_jobs::ListLoaderJobsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_loader_jobs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_loader_jobs::ListLoaderJobsOutput, crate::operation::list_loader_jobs::ListLoaderJobsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_loader_jobs::de_list_loader_jobs(_response_body, output)
            .map_err(crate::operation::list_loader_jobs::ListLoaderJobsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_loader_jobs_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_loader_jobs::ListLoaderJobsError::unhandled)?
    })
}

pub(crate) fn de_list_loader_jobs(
    value: &[u8],
    mut builder: crate::operation::list_loader_jobs::builders::ListLoaderJobsOutputBuilder,
) -> Result<crate::operation::list_loader_jobs::builders::ListLoaderJobsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(crate::protocol_serde::shape_loader_id_result::de_loader_id_result(tokens)?);
                }
                "status" => {
