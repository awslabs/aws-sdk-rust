...
pub fn de_get_propertygraph_summary_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_propertygraph_summary::GetPropertygraphSummaryError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_propertygraph_summary::GetPropertygraphSummaryError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "StatisticsNotAvailableException" => {
            crate::operation::get_propertygraph_summary::GetPropertygraphSummaryError::StatisticsNotAvailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::get_propertygraph_summary::GetPropertygraphSummaryError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_propertygraph_summary_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_propertygraph_summary::de_get_propertygraph_summary(_response_body, output)
            .map_err(crate::operation::get_propertygraph_summary::GetPropertygraphSummaryError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(
                        crate::protocol_serde::shape_propertygraph_summary_value_map::de_propertygraph_summary_value_map(tokens, _value, depth + 1)?,
                    );
                }
