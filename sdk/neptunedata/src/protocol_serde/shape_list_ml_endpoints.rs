...
pub fn de_list_ml_endpoints_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_ml_endpoints::ListMlEndpointsOutput, crate::operation::list_ml_endpoints::ListMLEndpointsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_ml_endpoints::ListMLEndpointsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_ml_endpoints_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_ml_endpoints::ListMlEndpointsOutput, crate::operation::list_ml_endpoints::ListMLEndpointsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_ml_endpoints::de_list_ml_endpoints(_response_body, output)
            .map_err(crate::operation::list_ml_endpoints::ListMLEndpointsError::unhandled)?;
...
pub(crate) fn de_list_ml_endpoints(
    value: &[u8],
    mut builder: crate::operation::list_ml_endpoints::builders::ListMlEndpointsOutputBuilder,
) -> Result<crate::operation::list_ml_endpoints::builders::ListMlEndpointsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
