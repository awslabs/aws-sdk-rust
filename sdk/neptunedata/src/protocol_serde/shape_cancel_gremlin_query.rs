...
pub fn de_cancel_gremlin_query_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_gremlin_query::CancelGremlinQueryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_gremlin_query_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_gremlin_query::de_cancel_gremlin_query(_response_body, output)
            .map_err(crate::operation::cancel_gremlin_query::CancelGremlinQueryError::unhandled)?;
...
pub(crate) fn de_cancel_gremlin_query(
    value: &[u8],
    mut builder: crate::operation::cancel_gremlin_query::builders::CancelGremlinQueryOutputBuilder,
) -> Result<crate::operation::cancel_gremlin_query::builders::CancelGremlinQueryOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
