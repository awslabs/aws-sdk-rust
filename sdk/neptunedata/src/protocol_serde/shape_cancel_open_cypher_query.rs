...
pub fn de_cancel_open_cypher_query_http_error(
...
> {
    ...
    Err(match error_code {
        ...
        "ConcurrentModificationException" => {
            crate::operation::cancel_open_cypher_query::CancelOpenCypherQueryError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_open_cypher_query_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_open_cypher_query::de_cancel_open_cypher_query(_response_body, output)
            .map_err(crate::operation::cancel_open_cypher_query::CancelOpenCypherQueryError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "payload" => {
                    builder = builder.set_payload(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                }
                "status" => {
