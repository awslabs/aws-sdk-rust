...
pub fn de_list_gremlin_queries_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_gremlin_queries::ListGremlinQueriesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_gremlin_queries_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_gremlin_queries::de_list_gremlin_queries(_response_body, output)
            .map_err(crate::operation::list_gremlin_queries::ListGremlinQueriesError::unhandled)?;
...
) -> Result<crate::operation::list_gremlin_queries::builders::ListGremlinQueriesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
