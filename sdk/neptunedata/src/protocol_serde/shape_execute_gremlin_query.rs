...
pub fn de_execute_gremlin_query_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::execute_gremlin_query::ExecuteGremlinQueryError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "QueryLimitExceededException" => crate::operation::execute_gremlin_query::ExecuteGremlinQueryError::QueryLimitExceededException({
            ...
            let mut tmp = {
                ...
                output =
                    crate::protocol_serde::shape_query_limit_exceeded_exception::de_query_limit_exceeded_exception_json_err(_response_body, output)
                        .map_err(crate::operation::execute_gremlin_query::ExecuteGremlinQueryError::unhandled)?;
                let output = output.meta(generic);
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_execute_gremlin_query_http_response(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_execute_gremlin_query::de_execute_gremlin_query(_response_body, output)
            .map_err(crate::operation::execute_gremlin_query::ExecuteGremlinQueryError::unhandled)?;
...
pub fn ser_execute_gremlin_query_input(
    ...
    crate::protocol_serde::shape_execute_gremlin_query_input::ser_execute_gremlin_query_input(&mut object, input)?;
    object.finish();
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "meta" => {
                    builder = builder.set_meta(Some(::aws_smithy_json::deserialize::token::expect_document(tokens)?));
                }
                "requestId" => {
                ...
                "status" => {
                    builder =
                        builder.set_status(crate::protocol_serde::shape_gremlin_query_status_attributes::de_gremlin_query_status_attributes(tokens)?);
                }
