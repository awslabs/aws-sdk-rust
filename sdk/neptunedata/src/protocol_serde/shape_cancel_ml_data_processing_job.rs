...
pub fn de_cancel_ml_data_processing_job_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MLResourceNotFoundException" => {
            crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::MlResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_ml_data_processing_job_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_cancel_ml_data_processing_job::de_cancel_ml_data_processing_job(_response_body, output)
            .map_err(crate::operation::cancel_ml_data_processing_job::CancelMLDataProcessingJobError::unhandled)?;
