...
pub fn de_get_sparql_statistics_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_sparql_statistics::GetSparqlStatisticsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sparql_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_sparql_statistics::de_get_sparql_statistics(_response_body, output)
            .map_err(crate::operation::get_sparql_statistics::GetSparqlStatisticsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_sparql_statistics_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_sparql_statistics::GetSparqlStatisticsError::unhandled)?
    })
}

pub(crate) fn de_get_sparql_statistics(
    value: &[u8],
