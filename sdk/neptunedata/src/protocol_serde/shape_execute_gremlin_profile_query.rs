...
pub fn de_execute_gremlin_profile_query_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "CancelledByUserException" => crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::CancelledByUserException({
            ...
            let mut tmp = {
                ...
                output = crate::protocol_serde::shape_cancelled_by_user_exception::de_cancelled_by_user_exception_json_err(_response_body, output)
                    .map_err(crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::unhandled)?;
                let output = output.meta(generic);
        ...
        "ConcurrentModificationException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ConstraintViolationException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MemoryLimitExceededException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::MemoryLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "QueryLimitExceededException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::QueryLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TimeLimitExceededException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::TimeLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::execute_gremlin_profile_query::ExecuteGremlinProfileQueryError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_execute_gremlin_profile_query_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = output.set_output(crate::protocol_serde::shape_execute_gremlin_profile_query_output::de_output_payload(
            _response_body,
        )?);
