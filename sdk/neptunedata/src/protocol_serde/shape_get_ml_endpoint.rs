...
pub fn de_get_ml_endpoint_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_ml_endpoint::GetMlEndpointOutput, crate::operation::get_ml_endpoint::GetMLEndpointError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_ml_endpoint::GetMLEndpointError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_ml_endpoint_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::get_ml_endpoint::GetMlEndpointOutput, crate::operation::get_ml_endpoint::GetMLEndpointError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_ml_endpoint::de_get_ml_endpoint(_response_body, output)
            .map_err(crate::operation::get_ml_endpoint::GetMLEndpointError::unhandled)?;
...
) -> Result<crate::operation::get_ml_endpoint::builders::GetMlEndpointOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
