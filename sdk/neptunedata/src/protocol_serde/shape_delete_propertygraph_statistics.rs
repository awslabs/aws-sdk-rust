...
pub fn de_delete_propertygraph_statistics_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "IllegalArgumentException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::IllegalArgumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidArgumentException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::InvalidArgumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::InvalidParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MissingParameterException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::MissingParameterException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ReadOnlyViolationException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::ReadOnlyViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "StatisticsNotAvailableException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::StatisticsNotAvailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::TooManyRequestsException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_propertygraph_statistics_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_propertygraph_statistics::de_delete_propertygraph_statistics(_response_body, output)
            .map_err(crate::operation::delete_propertygraph_statistics::DeletePropertygraphStatisticsError::unhandled)?;
