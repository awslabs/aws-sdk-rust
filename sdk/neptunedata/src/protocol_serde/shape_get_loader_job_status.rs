...
pub fn de_get_loader_job_status_http_error(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_loader_job_status_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_get_loader_job_status(
    value: &[u8],
    mut builder: crate::operation::get_loader_job_status::builders::GetLoaderJobStatusOutputBuilder,
) -> Result<crate::operation::get_loader_job_status::builders::GetLoaderJobStatusOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
