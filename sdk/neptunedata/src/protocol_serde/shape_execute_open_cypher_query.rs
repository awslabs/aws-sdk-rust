...
> {
    Ok({
        ...
        crate::serde_util::execute_open_cypher_query_output_correct_errors(output)
            .build()
            .map_err(crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::unhandled)?
    })
}
...
pub fn ser_execute_open_cypher_query_input(
    ...
    crate::protocol_serde::shape_execute_open_cypher_query_input::ser_execute_open_cypher_query_input(&mut object, input)?;
    object.finish();
