...
pub fn de_execute_open_cypher_query_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ConcurrentModificationException" => {
            crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_execute_open_cypher_query_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_execute_open_cypher_query::de_execute_open_cypher_query(_response_body, output)
            .map_err(crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::execute_open_cypher_query_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryError::unhandled)?
    })
}

pub fn ser_execute_open_cypher_query_input(
...
pub(crate) fn de_execute_open_cypher_query(
    value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "results" => {
                    builder = builder.set_results(Some(::aws_smithy_json::deserialize::token::expect_document(tokens)?));
                }
