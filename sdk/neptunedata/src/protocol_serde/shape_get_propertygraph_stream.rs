...
pub fn de_get_propertygraph_stream_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_propertygraph_stream::GetPropertygraphStreamError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_propertygraph_stream::GetPropertygraphStreamError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "StreamRecordsNotFoundException" => {
            crate::operation::get_propertygraph_stream::GetPropertygraphStreamError::StreamRecordsNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_propertygraph_stream_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_propertygraph_stream::de_get_propertygraph_stream(_response_body, output)
            .map_err(crate::operation::get_propertygraph_stream::GetPropertygraphStreamError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::get_propertygraph_stream_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::get_propertygraph_stream::GetPropertygraphStreamError::unhandled)?
    })
}
...
pub(crate) fn de_get_propertygraph_stream(
    _value: &[u8],
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "lastEventId" => {
                    builder = builder.set_last_event_id(crate::protocol_serde::shape_string_valued_map::de_string_valued_map(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
                ...
                "records" => {
                    builder = builder.set_records(crate::protocol_serde::shape_propertygraph_records_list::de_propertygraph_records_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
