...
pub fn de_list_open_cypher_queries_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_open_cypher_queries::ListOpenCypherQueriesError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ConcurrentModificationException" => {
            crate::operation::list_open_cypher_queries::ListOpenCypherQueriesError::ConcurrentModificationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_open_cypher_queries_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_open_cypher_queries::de_list_open_cypher_queries(_response_body, output)
            .map_err(crate::operation::list_open_cypher_queries::ListOpenCypherQueriesError::unhandled)?;
