...
pub fn de_list_ml_model_transform_jobs_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ConstraintViolationException" => {
            crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::ConstraintViolationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "MLResourceNotFoundException" => {
            crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::MlResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "PreconditionsFailedException" => {
            crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::PreconditionsFailedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperationException" => {
            crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::UnsupportedOperationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_ml_model_transform_jobs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_ml_model_transform_jobs::de_list_ml_model_transform_jobs(_response_body, output)
            .map_err(crate::operation::list_ml_model_transform_jobs::ListMLModelTransformJobsError::unhandled)?;
...
pub(crate) fn de_list_ml_model_transform_jobs(
    value: &[u8],
    mut builder: crate::operation::list_ml_model_transform_jobs::builders::ListMlModelTransformJobsOutputBuilder,
) -> Result<
    crate::operation::list_ml_model_transform_jobs::builders::ListMlModelTransformJobsOutputBuilder,
