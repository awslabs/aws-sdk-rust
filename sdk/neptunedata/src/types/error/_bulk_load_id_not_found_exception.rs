...
impl ::aws_http::request_id::RequestId for crate::types::error::BulkLoadIdNotFoundException {
...
impl BulkLoadIdNotFoundExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::BulkLoadIdNotFoundException, ::aws_smithy_http::operation::error::BuildError> {
