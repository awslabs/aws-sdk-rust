...
impl ::aws_http::request_id::RequestId for crate::types::error::UnsupportedOperationException {
...
impl UnsupportedOperationExceptionBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::error::UnsupportedOperationException, ::aws_smithy_http::operation::error::BuildError> {
