...
impl super::Client {
    ...
    ///   - [`status(Option<String>)`](crate::operation::manage_propertygraph_statistics::ManagePropertygraphStatisticsOutput::status): <p>The HTTP return code of the request. If the request succeeded, the code is 200.</p>
