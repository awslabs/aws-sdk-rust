...
impl super::Client {
    ...
    ///   - [`status(Option<String>)`](crate::operation::manage_sparql_statistics::ManageSparqlStatisticsOutput::status): <p>The HTTP return code of the request. If the request succeeded, the code is 200.</p>
