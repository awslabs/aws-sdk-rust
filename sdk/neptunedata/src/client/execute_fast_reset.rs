...
impl super::Client {
    ...
    ///   - [`action(Action)`](crate::operation::execute_fast_reset::builders::ExecuteFastResetFluentBuilder::action) / [`set_action(Option<Action>)`](crate::operation::execute_fast_reset::builders::ExecuteFastResetFluentBuilder::set_action): <p>The fast reset action. One of the following values:</p>  <ul>   <li> <p> <b> <code>initiateDatabaseReset</code> </b> &nbsp; – &nbsp; This action generates a unique token needed to actually perform the fast reset.</p> </li>   <li> <p> <b> <code>performDatabaseReset</code> </b> &nbsp; – &nbsp; This action uses the token generated by the <code>initiateDatabaseReset</code> action to actually perform the fast reset.</p> <p></p> </li>  </ul>
    ///   - [`token(impl Into<String>)`](crate::operation::execute_fast_reset::builders::ExecuteFastResetFluentBuilder::token) / [`set_token(Option<String>)`](crate::operation::execute_fast_reset::builders::ExecuteFastResetFluentBuilder::set_token): <p>The fast-reset token to initiate the reset.</p>
    /// - On success, responds with [`ExecuteFastResetOutput`](crate::operation::execute_fast_reset::ExecuteFastResetOutput) with field(s):
    ///   - [`status(Option<String>)`](crate::operation::execute_fast_reset::ExecuteFastResetOutput::status): <p>The <code>status</code> is only returned for the <code>performDatabaseReset</code> action, and indicates whether or not the fast reset rquest is accepted.</p>
