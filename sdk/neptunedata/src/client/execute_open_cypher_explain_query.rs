...
impl super::Client {
    ...
    ///   - [`results(Option<Blob>)`](crate::operation::execute_open_cypher_explain_query::ExecuteOpenCypherExplainQueryOutput::results): <p>A text blob containing the openCypher <code>explain</code> results.</p>
