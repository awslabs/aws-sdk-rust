...
impl super::Client {
    ...
    ///   - [`include_waiting(bool)`](crate::operation::list_open_cypher_queries::builders::ListOpenCypherQueriesFluentBuilder::include_waiting) / [`set_include_waiting(Option<bool>)`](crate::operation::list_open_cypher_queries::builders::ListOpenCypherQueriesFluentBuilder::set_include_waiting): <p> When set to <code>TRUE</code> and other parameters are not present, causes status information to be returned for waiting queries as well as for running queries.</p>
