...
impl super::Client {
    ...
    ///   - [`open_cypher_query(impl Into<String>)`](crate::operation::execute_open_cypher_query::builders::ExecuteOpenCypherQueryFluentBuilder::open_cypher_query) / [`set_open_cypher_query(Option<String>)`](crate::operation::execute_open_cypher_query::builders::ExecuteOpenCypherQueryFluentBuilder::set_open_cypher_query): <p>The openCypher query string to be executed.</p>
    ///   - [`parameters(impl Into<String>)`](crate::operation::execute_open_cypher_query::builders::ExecuteOpenCypherQueryFluentBuilder::parameters) / [`set_parameters(Option<String>)`](crate::operation::execute_open_cypher_query::builders::ExecuteOpenCypherQueryFluentBuilder::set_parameters): <p>The openCypher query parameters for query execution. See <a href="https://docs.aws.amazon.com/neptune/latest/userguide/opencypher-parameterized-queries.html">Examples of openCypher parameterized queries</a> for more information.</p>
    ...
    ///   - [`results(Option<Document>)`](crate::operation::execute_open_cypher_query::ExecuteOpenCypherQueryOutput::results): <p>The openCypherquery results.</p>
