...
impl super::Client {
    ...
    ///   - [`max_items(i32)`](crate::operation::list_ml_model_training_jobs::builders::ListMLModelTrainingJobsFluentBuilder::max_items) / [`set_max_items(Option<i32>)`](crate::operation::list_ml_model_training_jobs::builders::ListMLModelTrainingJobsFluentBuilder::set_max_items): <p>The maximum number of items to return (from 1 to 1024; the default is 10).</p>
    ///   - [`neptune_iam_role_arn(impl Into<String>)`](crate::operation::list_ml_model_training_jobs::builders::ListMLModelTrainingJobsFluentBuilder::neptune_iam_role_arn) / [`set_neptune_iam_role_arn(Option<String>)`](crate::operation::list_ml_model_training_jobs::builders::ListMLModelTrainingJobsFluentBuilder::set_neptune_iam_role_arn): <p>The ARN of an IAM role that provides Neptune access to SageMaker and Amazon S3 resources. This must be listed in your DB cluster parameter group or an error will occur.</p>
