...
impl super::Client {
    ...
    ///   - [`query_id(impl Into<String>)`](crate::operation::cancel_open_cypher_query::builders::CancelOpenCypherQueryFluentBuilder::query_id) / [`set_query_id(Option<String>)`](crate::operation::cancel_open_cypher_query::builders::CancelOpenCypherQueryFluentBuilder::set_query_id): <p>The unique ID of the openCypher query to cancel.</p>
    ///   - [`silent(bool)`](crate::operation::cancel_open_cypher_query::builders::CancelOpenCypherQueryFluentBuilder::silent) / [`set_silent(Option<bool>)`](crate::operation::cancel_open_cypher_query::builders::CancelOpenCypherQueryFluentBuilder::set_silent): <p>If set to <code>TRUE</code>, causes the cancelation of the openCypher query to happen silently.</p>
