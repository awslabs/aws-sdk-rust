...
impl super::Client {
    ...
    ///   - [`gremlin_query(impl Into<String>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::gremlin_query) / [`set_gremlin_query(Option<String>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::set_gremlin_query): <p>The Gremlin query string to profile.</p>
    ///   - [`results(bool)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::results) / [`set_results(Option<bool>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::set_results): <p>If this flag is set to <code>TRUE</code>, the query results are gathered and displayed as part of the profile report. If <code>FALSE</code>, only the result count is displayed.</p>
    ///   - [`chop(i32)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::chop) / [`set_chop(Option<i32>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::set_chop): <p>If non-zero, causes the results string to be truncated at that number of characters. If set to zero, the string contains all the results.</p>
    ///   - [`serializer(impl Into<String>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::serializer) / [`set_serializer(Option<String>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::set_serializer): <p>If non-null, the gathered results are returned in a serialized response message in the format specified by this parameter. See <a href="https://docs.aws.amazon.com/neptune/latest/userguide/gremlin-profile-api.html">Gremlin profile API in Neptune</a> for more information.</p>
    ///   - [`index_ops(bool)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::index_ops) / [`set_index_ops(Option<bool>)`](crate::operation::execute_gremlin_profile_query::builders::ExecuteGremlinProfileQueryFluentBuilder::set_index_ops): <p>If this flag is set to <code>TRUE</code>, the results include a detailed report of all index operations that took place during query execution and serialization.</p>
