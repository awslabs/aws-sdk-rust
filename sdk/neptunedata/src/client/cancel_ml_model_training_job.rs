...
impl super::Client {
    ...
    ///   - [`clean(bool)`](crate::operation::cancel_ml_model_training_job::builders::CancelMLModelTrainingJobFluentBuilder::clean) / [`set_clean(Option<bool>)`](crate::operation::cancel_ml_model_training_job::builders::CancelMLModelTrainingJobFluentBuilder::set_clean): <p>If set to <code>TRUE</code>, this flag specifies that all Amazon S3 artifacts should be deleted when the job is stopped. The default is <code>FALSE</code>.</p>
