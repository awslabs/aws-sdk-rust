...
impl Builder {
    ...
    /// use aws_sdk_auditmanager::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_auditmanager::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
    ...
    pub fn build(mut self) -> Config {
        ...
        if layer.load::<::aws_smithy_runtime::client::retries::RetryPartition>().is_none() {
            layer.store_put(::aws_smithy_runtime::client::retries::RetryPartition::new("auditmanager"));
        }
        ...
        layer.store_put(::aws_types::SigningService::from_static("auditmanager"));
        layer
