...
impl ::std::convert::From<&str> for AssessmentStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => AssessmentStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for AssessmentStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(AssessmentStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for AssessmentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
