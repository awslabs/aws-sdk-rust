...
pub struct SourceKeyword {
    ...
    /// <ul>
    /// <li> <p> <code>SELECT_FROM_LIST</code> is used when mapping a data source for automated evidence.</p>
    /// <ul>
    /// <li> <p>When <code>keywordInputType</code> is <code>SELECT_FROM_LIST</code>, a keyword must be selected to collect automated evidence. For example, this keyword can be a CloudTrail event name, a rule name for Config, a Security Hub control, or the name of an Amazon Web Services API call.</p> </li>
    /// </ul> </li>
    /// <li> <p> <code>UPLOAD_FILE</code> and <code>INPUT_TEXT</code> are only used when mapping a data source for manual evidence.</p>
    /// <ul>
    /// <li> <p>When <code>keywordInputType</code> is <code>UPLOAD_FILE</code>, a file must be uploaded as manual evidence.</p> </li>
