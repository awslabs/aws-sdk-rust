...
pub struct Evidence {
    ...
    /// <ul>
    /// <li>
    /// <p>Audit Manager classes evidence as non-compliant if Security Hub CSPM reports a <i>Fail</i> result, or if Config reports a <i>Non-compliant</i> result.</p></li>
    /// <li>
    /// <p>Audit Manager classes evidence as compliant if Security Hub CSPM reports a <i>Pass</i> result, or if Config reports a <i>Compliant</i> result.</p></li>
    /// <li>
