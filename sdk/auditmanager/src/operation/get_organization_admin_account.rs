...
impl GetOrganizationAdminAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_organization_admin_account::GetOrganizationAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_organization_admin_account::de_get_organization_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
