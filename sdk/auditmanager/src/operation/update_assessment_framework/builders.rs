...
impl UpdateAssessmentFrameworkFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_assessment_framework::UpdateAssessmentFrameworkOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_assessment_framework::UpdateAssessmentFrameworkError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_assessment_framework::UpdateAssessmentFrameworkOutput, crate::operation::update_assessment_framework::UpdateAssessmentFrameworkError, Self> {
