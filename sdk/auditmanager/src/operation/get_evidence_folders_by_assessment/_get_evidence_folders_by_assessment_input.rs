...
impl GetEvidenceFoldersByAssessmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_evidence_folders_by_assessment::GetEvidenceFoldersByAssessmentInput, ::aws_smithy_types::error::operation::BuildError> {
