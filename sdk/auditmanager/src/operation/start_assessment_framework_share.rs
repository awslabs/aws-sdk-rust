...
impl StartAssessmentFrameworkShareInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_assessment_framework_share::StartAssessmentFrameworkShare::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAssessmentFrameworkShare {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_assessment_framework_share::de_start_assessment_framework_share_http_response_with_props(
                status, headers, body,
            )
        }
    }
