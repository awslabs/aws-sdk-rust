...
impl ValidateAssessmentReportIntegrityInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::validate_assessment_report_integrity::ValidateAssessmentReportIntegrity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::validate_assessment_report_integrity::ValidateAssessmentReportIntegrityInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
