...
impl ValidateAssessmentReportIntegrityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::validate_assessment_report_integrity::ValidateAssessmentReportIntegrity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::validate_assessment_report_integrity::ValidateAssessmentReportIntegrity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ValidateAssessmentReportIntegrity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_validate_assessment_report_integrity::de_validate_assessment_report_integrity_http_response_with_props(
                status, headers, body,
            )
        }
    }
