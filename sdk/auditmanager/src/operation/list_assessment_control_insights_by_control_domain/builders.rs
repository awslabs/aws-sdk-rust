...
impl crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainInputBuilder {
...
impl ListAssessmentControlInsightsByControlDomainFluentBuilder {
    /// Creates a new `ListAssessmentControlInsightsByControlDomainFluentBuilder`.
    ...
    > {
        ...
        crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomain::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
