...
pub use crate::operation::list_assessment_control_insights_by_control_domain::_list_assessment_control_insights_by_control_domain_output::ListAssessmentControlInsightsByControlDomainOutputBuilder;

pub use crate::operation::list_assessment_control_insights_by_control_domain::_list_assessment_control_insights_by_control_domain_input::ListAssessmentControlInsightsByControlDomainInputBuilder;
...
impl ListAssessmentControlInsightsByControlDomainFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomainOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomainError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomain::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomainOutput, crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomainError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_assessment_control_insights_by_control_domain::paginator::ListAssessmentControlInsightsByControlDomainPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
