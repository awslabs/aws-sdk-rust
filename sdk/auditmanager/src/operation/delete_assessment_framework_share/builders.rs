...
impl crate::operation::delete_assessment_framework_share::builders::DeleteAssessmentFrameworkShareInputBuilder {
...
impl DeleteAssessmentFrameworkShareFluentBuilder {
    /// Creates a new `DeleteAssessmentFrameworkShareFluentBuilder`.
