...
impl ListAssessmentFrameworkShareRequests {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAssessmentFrameworkShareRequests {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAssessmentFrameworkShareRequests");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAssessmentFrameworkShareRequestsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAssessmentFrameworkShareRequestsResponseDeserializer));
...
.with_interceptor(ListAssessmentFrameworkShareRequestsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError>::new());
...
#[derive(Debug)]
            struct ListAssessmentFrameworkShareRequestsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAssessmentFrameworkShareRequestsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_assessment_framework_share_requests::de_list_assessment_framework_share_requests_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAssessmentFrameworkShareRequestsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAssessmentFrameworkShareRequestsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/assessmentFrameworkShareRequests").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_1 = &_input.request_type;
    let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("request_type", "cannot be empty or unset"))?;
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAssessmentFrameworkShareRequestsEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAssessmentFrameworkShareRequestsInput>()
                        .ok_or("failed to downcast to ListAssessmentFrameworkShareRequestsInput")?;
...
pub enum ListAssessmentFrameworkShareRequestsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAssessmentFrameworkShareRequestsError) for what information is available for the error.")]
...
impl ListAssessmentFrameworkShareRequestsError {
    /// Creates the `ListAssessmentFrameworkShareRequestsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAssessmentFrameworkShareRequestsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAssessmentFrameworkShareRequestsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsError {
