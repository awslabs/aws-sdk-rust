...
impl crate::operation::validate_assessment_report_integrity::builders::ValidateAssessmentReportIntegrityInputBuilder {
...
impl ValidateAssessmentReportIntegrityFluentBuilder {
    /// Creates a new `ValidateAssessmentReportIntegrityFluentBuilder`.
