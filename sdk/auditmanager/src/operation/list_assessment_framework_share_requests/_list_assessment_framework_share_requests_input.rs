...
impl ListAssessmentFrameworkShareRequestsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_assessment_framework_share_requests::ListAssessmentFrameworkShareRequestsInput, ::aws_smithy_types::error::operation::BuildError> {
