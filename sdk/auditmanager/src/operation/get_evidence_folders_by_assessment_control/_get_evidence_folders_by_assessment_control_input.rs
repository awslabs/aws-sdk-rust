...
impl GetEvidenceFoldersByAssessmentControlInputBuilder {
    ...
    pub fn build(self) -> Result<crate::operation::get_evidence_folders_by_assessment_control::GetEvidenceFoldersByAssessmentControlInput, aws_smithy_http::operation::error::BuildError> {
        Ok(
