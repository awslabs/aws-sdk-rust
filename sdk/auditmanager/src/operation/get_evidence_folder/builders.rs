...
impl GetEvidenceFolderFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_evidence_folder::GetEvidenceFolderOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_evidence_folder::GetEvidenceFolderError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_evidence_folder::GetEvidenceFolderOutput, crate::operation::get_evidence_folder::GetEvidenceFolderError, Self> {
