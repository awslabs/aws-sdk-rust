...
impl CreateControlInput {
    /// Consumes the builder and constructs an Operation<[`CreateControl`](crate::operation::create_control::CreateControl)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_control::CreateControl, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_control::ser_create_control_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_control::CreateControl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateControl {
    type Output = ::std::result::Result<crate::operation::create_control::CreateControlOutput, crate::operation::create_control::CreateControlError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_control::de_create_control_http_response_with_props(status, headers, body)
        }
    }
}
