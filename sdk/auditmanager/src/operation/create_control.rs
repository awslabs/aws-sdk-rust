...
impl CreateControlInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_control::CreateControl::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateControl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_control::de_create_control_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_control::de_create_control_http_response_with_props(
                status, headers, body,
            )
        }
    }
