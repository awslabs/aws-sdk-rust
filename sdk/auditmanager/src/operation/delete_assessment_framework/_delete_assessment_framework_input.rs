...
impl DeleteAssessmentFrameworkInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_assessment_framework::DeleteAssessmentFrameworkInput, ::aws_smithy_types::error::operation::BuildError> {
