...
impl BatchCreateDelegationByAssessmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_create_delegation_by_assessment::BatchCreateDelegationByAssessment,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_create_delegation_by_assessment::BatchCreateDelegationByAssessment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchCreateDelegationByAssessment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_create_delegation_by_assessment::de_batch_create_delegation_by_assessment_http_response_with_props(
                status, headers, body,
            )
        }
    }
