...
impl GetEvidenceByEvidenceFolderInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_evidence_by_evidence_folder::GetEvidenceByEvidenceFolder::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEvidenceByEvidenceFolder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_evidence_by_evidence_folder::de_get_evidence_by_evidence_folder_http_response_with_props(
                status, headers, body,
            )
        }
    }
