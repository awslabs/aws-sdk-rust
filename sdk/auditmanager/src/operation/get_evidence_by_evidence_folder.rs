...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEvidenceByEvidenceFolder {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_evidence_by_evidence_folder::de_get_evidence_by_evidence_folder_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetEvidenceByEvidenceFolderError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_evidence_by_evidence_folder::GetEvidenceByEvidenceFolderError
{
