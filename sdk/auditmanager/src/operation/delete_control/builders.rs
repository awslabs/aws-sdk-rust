...
impl DeleteControlFluentBuilder  {
    /// Creates a new `DeleteControl`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_control::DeleteControlOutput, aws_smithy_http::result::SdkError<crate::operation::delete_control::DeleteControlError>>
                     {
