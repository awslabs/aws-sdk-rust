...
impl ListControlDomainInsightsByAssessmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_control_domain_insights_by_assessment::ListControlDomainInsightsByAssessmentInput, ::aws_smithy_types::error::operation::BuildError> {
