...
impl UpdateSettingsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_settings::UpdateSettings, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_settings::ser_update_settings_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSettings {
    type Output =
        ::std::result::Result<crate::operation::update_settings::UpdateSettingsOutput, crate::operation::update_settings::UpdateSettingsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_settings::de_update_settings_http_response_with_props(status, headers, body)
        }
    }
}
