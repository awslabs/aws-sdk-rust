...
impl ListControlDomainInsightsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_control_domain_insights::ListControlDomainInsights::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListControlDomainInsights {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_control_domain_insights::de_list_control_domain_insights_http_response_with_props(status, headers, body)
        }
    }
}
