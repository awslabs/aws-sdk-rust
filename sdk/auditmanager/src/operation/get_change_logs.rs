...
impl GetChangeLogsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_change_logs::GetChangeLogs,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_change_logs::GetChangeLogs::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChangeLogs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_change_logs::de_get_change_logs_http_error(
                status, headers, body,
            )
        } else {
