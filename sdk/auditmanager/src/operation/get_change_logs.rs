...
impl GetChangeLogsInput {
    /// Consumes the builder and constructs an Operation<[`GetChangeLogs`](crate::operation::get_change_logs::GetChangeLogs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_change_logs::GetChangeLogs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_change_logs::GetChangeLogsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_change_logs::GetChangeLogsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.control_set_id {
                     {
                        query.push_kv("controlSetId", &aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let Some(inner_3) = &_input.control_id {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_change_logs::GetChangeLogs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetChangeLogs {
                type Output = std::result::Result<crate::operation::get_change_logs::GetChangeLogsOutput, crate::operation::get_change_logs::GetChangeLogsError>;
