...
impl GetChangeLogsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_change_logs::GetChangeLogs, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChangeLogs {
    type Output =
        ::std::result::Result<crate::operation::get_change_logs::GetChangeLogsOutput, crate::operation::get_change_logs::GetChangeLogsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_change_logs::de_get_change_logs_http_response_with_props(status, headers, body)
        }
    }
}
