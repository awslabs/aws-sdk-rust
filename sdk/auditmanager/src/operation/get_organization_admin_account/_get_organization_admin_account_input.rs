...
impl GetOrganizationAdminAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_organization_admin_account::GetOrganizationAdminAccountInput, ::aws_smithy_types::error::operation::BuildError> {
