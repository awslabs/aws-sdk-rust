...
/// Orchestration and serialization glue logic for `GetServicesInScope`.
...
impl GetServicesInScope {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_services_in_scope::GetServicesInScopeInput,
                    ) -> ::std::result::Result<crate::operation::get_services_in_scope::GetServicesInScopeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_services_in_scope::GetServicesInScopeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_services_in_scope::GetServicesInScopeError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_services_in_scope::GetServicesInScopeOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetServicesInScope {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetServicesInScope");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetServicesInScopeRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetServicesInScopeResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetServicesInScope")
...
.with_interceptor(GetServicesInScopeEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_services_in_scope::GetServicesInScopeError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_services_in_scope::GetServicesInScopeError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_services_in_scope::GetServicesInScopeError>::new());
...
#[derive(Debug)]
            struct GetServicesInScopeResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetServicesInScopeResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_services_in_scope::de_get_services_in_scope_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetServicesInScopeRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetServicesInScopeRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_services_in_scope::GetServicesInScopeInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_services_in_scope::GetServicesInScopeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetServicesInScopeEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetServicesInScopeEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetServicesInScopeEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetServicesInScopeInput>()
                        .ok_or("failed to downcast to GetServicesInScopeInput")?;
...
pub enum GetServicesInScopeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetServicesInScopeError) for what information is available for the error.")]
...
impl GetServicesInScopeError {
    /// Creates the `GetServicesInScopeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetServicesInScopeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetServicesInScopeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_services_in_scope::GetServicesInScopeError {
...
mod _get_services_in_scope_output;
