...
///
/// <p>Gets a list of the Amazon Web Services from which Audit Manager can collect evidence.</p>
/// <p>Audit Manager defines which Amazon Web Services are in scope for an assessment. Audit Manager infers this scope by examining the assessment’s controls and their data sources, and then mapping this information to one or more of the corresponding Amazon Web Services that are in this list.</p><note>
