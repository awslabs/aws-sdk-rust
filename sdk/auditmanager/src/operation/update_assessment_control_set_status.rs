...
impl UpdateAssessmentControlSetStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_assessment_control_set_status::UpdateAssessmentControlSetStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAssessmentControlSetStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_assessment_control_set_status::de_update_assessment_control_set_status_http_response_with_props(
                status, headers, body,
            )
        }
    }
