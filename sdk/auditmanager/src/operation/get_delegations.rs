...
impl GetDelegationsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_delegations::GetDelegations::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for GetDelegations {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_delegations::de_get_delegations_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_delegations::de_get_delegations_http_response(
                status, headers, body,
            )
        }
    }
