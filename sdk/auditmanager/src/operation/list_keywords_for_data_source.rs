...
impl ListKeywordsForDataSourceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_keywords_for_data_source::ListKeywordsForDataSource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListKeywordsForDataSource {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_keywords_for_data_source::de_list_keywords_for_data_source_http_response_with_props(
                status, headers, body,
            )
        }
    }
