...
impl RegisterOrganizationAdminAccountInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_organization_admin_account::RegisterOrganizationAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_organization_admin_account::de_register_organization_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
