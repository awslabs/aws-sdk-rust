...
impl UpdateAssessmentFrameworkShareInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::update_assessment_framework_share::UpdateAssessmentFrameworkShareOutput, ::aws_smithy_http::result::SdkError<crate::operation::update_assessment_framework_share::UpdateAssessmentFrameworkShareError, ::aws_smithy_http::operation::Response>>
