...
impl DeregisterOrganizationAdminAccountInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::deregister_organization_admin_account::DeregisterOrganizationAdminAccount,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::deregister_organization_admin_account::DeregisterOrganizationAdminAccount::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterOrganizationAdminAccount {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_deregister_organization_admin_account::de_deregister_organization_admin_account_http_response_with_props(
                status, headers, body,
            )
        }
    }
