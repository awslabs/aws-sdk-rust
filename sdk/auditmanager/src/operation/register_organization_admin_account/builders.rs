...
impl RegisterOrganizationAdminAccountFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::register_organization_admin_account::RegisterOrganizationAdminAccountOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::register_organization_admin_account::RegisterOrganizationAdminAccountError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::register_organization_admin_account::RegisterOrganizationAdminAccountOutput, crate::operation::register_organization_admin_account::RegisterOrganizationAdminAccountError, Self> {
