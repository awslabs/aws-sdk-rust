...
impl BatchDeleteDelegationByAssessmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_delete_delegation_by_assessment::BatchDeleteDelegationByAssessment::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteDelegationByAssessment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_delete_delegation_by_assessment::de_batch_delete_delegation_by_assessment_http_response_with_props(
                status, headers, body,
            )
        }
    }
