...
impl super::Client {
    ...
    ///   - [`source(DataSourceType)`](crate::operation::list_keywords_for_data_source::builders::ListKeywordsForDataSourceFluentBuilder::source) / [`set_source(Option<DataSourceType>)`](crate::operation::list_keywords_for_data_source::builders::ListKeywordsForDataSourceFluentBuilder::set_source):<br>required: **true**<br><p>The control mapping data source that the keywords apply to.</p><br>
    ...
    ///   - [`keywords(Option<Vec::<String>>)`](crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceOutput::keywords): <p>The list of keywords for the control mapping source.</p>
