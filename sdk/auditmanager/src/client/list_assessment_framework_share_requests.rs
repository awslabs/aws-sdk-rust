...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_assessment_framework_share_requests::builders::ListAssessmentFrameworkShareRequestsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_assessment_framework_share_requests::builders::ListAssessmentFrameworkShareRequestsFluentBuilder::set_next_token): <p> The pagination token that's used to fetch the next set of results. </p>
