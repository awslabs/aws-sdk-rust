...
impl super::Client {
    ...
    ///   - [`control_domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::control_domain_id) / [`set_control_domain_id(Option<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::set_control_domain_id): <p>The unique identifier for the control domain. </p>
    ///   - [`assessment_id(impl ::std::convert::Into<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::assessment_id) / [`set_assessment_id(Option<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::set_assessment_id): <p>The unique identifier for the active assessment. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::set_next_token): <p>The pagination token that's used to fetch the next set of results. </p>
    ///   - [`max_results(i32)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_assessment_control_insights_by_control_domain::builders::ListAssessmentControlInsightsByControlDomainFluentBuilder::set_max_results): <p>Represents the maximum number of results on a page or for an API request call. </p>
