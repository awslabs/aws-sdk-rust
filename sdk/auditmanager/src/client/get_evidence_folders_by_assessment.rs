...
impl super::Client {
    ...
    ///   - [`assessment_id(impl Into<String>)`](crate::operation::get_evidence_folders_by_assessment::builders::GetEvidenceFoldersByAssessmentFluentBuilder::assessment_id) / [`set_assessment_id(Option<String>)`](crate::operation::get_evidence_folders_by_assessment::builders::GetEvidenceFoldersByAssessmentFluentBuilder::set_assessment_id):<br>required: **true**<br><p>The unique identifier for the assessment.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::get_evidence_folders_by_assessment::builders::GetEvidenceFoldersByAssessmentFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::get_evidence_folders_by_assessment::builders::GetEvidenceFoldersByAssessmentFluentBuilder::set_max_results):<br>required: **false**<br><p>Represents the maximum number of results on a page or for an API request call.</p><br>
