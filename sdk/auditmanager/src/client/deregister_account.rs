...
impl super::Client {
    ...
    pub fn deregister_account(
        &self,
    ) -> crate::operation::deregister_account::builders::DeregisterAccountFluentBuilder {
        crate::operation::deregister_account::builders::DeregisterAccountFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
