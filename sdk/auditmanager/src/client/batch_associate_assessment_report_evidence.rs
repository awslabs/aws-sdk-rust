...
impl super::Client {
    ...
    ///   - [`evidence_ids(impl Into<String>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::evidence_ids) / [`set_evidence_ids(Option<Vec<String>>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::set_evidence_ids): <p> The list of evidence identifiers. </p>
