...
impl super::Client {
    ...
    ///   - [`assessment_id(impl ::std::convert::Into<String>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::assessment_id) / [`set_assessment_id(Option<String>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::set_assessment_id): <p> The identifier for the assessment. </p>
    ///   - [`evidence_folder_id(impl ::std::convert::Into<String>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::evidence_folder_id) / [`set_evidence_folder_id(Option<String>)`](crate::operation::batch_associate_assessment_report_evidence::builders::BatchAssociateAssessmentReportEvidenceFluentBuilder::set_evidence_folder_id): <p> The identifier for the folder that the evidence is stored in. </p>
