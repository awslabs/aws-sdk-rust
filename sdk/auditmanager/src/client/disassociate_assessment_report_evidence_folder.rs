...
impl super::Client {
    ...
    ///   - [`assessment_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_assessment_report_evidence_folder::builders::DisassociateAssessmentReportEvidenceFolderFluentBuilder::assessment_id) / [`set_assessment_id(Option<String>)`](crate::operation::disassociate_assessment_report_evidence_folder::builders::DisassociateAssessmentReportEvidenceFolderFluentBuilder::set_assessment_id): <p> The unique identifier for the assessment. </p>
