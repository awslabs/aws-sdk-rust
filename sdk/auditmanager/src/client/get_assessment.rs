...
impl super::Client {
    ...
    ///   - [`assessment_id(impl ::std::convert::Into<String>)`](crate::operation::get_assessment::builders::GetAssessmentFluentBuilder::assessment_id) / [`set_assessment_id(Option<String>)`](crate::operation::get_assessment::builders::GetAssessmentFluentBuilder::set_assessment_id): <p>The unique identifier for the assessment. </p>
