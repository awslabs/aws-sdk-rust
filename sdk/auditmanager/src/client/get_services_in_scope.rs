...
impl super::Client {
    ...
    pub fn get_services_in_scope(
        &self,
    ) -> crate::operation::get_services_in_scope::builders::GetServicesInScopeFluentBuilder {
        crate::operation::get_services_in_scope::builders::GetServicesInScopeFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
