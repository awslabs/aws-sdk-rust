...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_control::builders::CreateControlFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_control::builders::CreateControlFluentBuilder::set_tags): <p> The tags that are associated with the control. </p>
