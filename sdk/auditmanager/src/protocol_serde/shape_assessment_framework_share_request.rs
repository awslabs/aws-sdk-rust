...
pub(crate) fn de_assessment_framework_share_request<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AssessmentFrameworkShareRequest>, aws_smithy_json::deserialize::error::DeserializeError>
