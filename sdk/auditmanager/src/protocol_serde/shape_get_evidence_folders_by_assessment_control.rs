...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_evidence_folders_by_assessment_control::GetEvidenceFoldersByAssessmentControlError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_evidence_folders_by_assessment_control::GetEvidenceFoldersByAssessmentControlError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        ...
        "ValidationException" => {
            crate::operation::get_evidence_folders_by_assessment_control::GetEvidenceFoldersByAssessmentControlError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_evidence_folders_by_assessment_control::de_get_evidence_folders_by_assessment_control(
            _response_body,
            output,
        )
        .map_err(crate::operation::get_evidence_folders_by_assessment_control::GetEvidenceFoldersByAssessmentControlError::unhandled)?;
                ...
                match key.to_unescaped()?.as_ref() {
                    "evidenceFolders" => {
                        builder = builder.set_evidence_folders(
                            crate::protocol_serde::shape_assessment_evidence_folders::de_assessment_evidence_folders(tokens, _value, depth + 1)?,
                        );
                    }
                    "nextToken" => {
