...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(
        crate::operation::list_assessment_control_insights_by_control_domain::ListAssessmentControlInsightsByControlDomainError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_assessment_control_insights_by_control_domain_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output =
            crate::protocol_serde::shape_list_assessment_control_insights_by_control_domain::de_list_assessment_control_insights_by_control_domain(
                _response_body,
                output,
            )
            .map_err(
