...
pub fn de_batch_import_evidence_to_assessment_control_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_import_evidence_to_assessment_control::BatchImportEvidenceToAssessmentControlError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::batch_import_evidence_to_assessment_control::BatchImportEvidenceToAssessmentControlError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::batch_import_evidence_to_assessment_control::BatchImportEvidenceToAssessmentControlError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::batch_import_evidence_to_assessment_control::BatchImportEvidenceToAssessmentControlError::unhandled,
                        )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_import_evidence_to_assessment_control_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_import_evidence_to_assessment_control::de_batch_import_evidence_to_assessment_control(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_import_evidence_to_assessment_control::BatchImportEvidenceToAssessmentControlError::unhandled)?;
...
pub fn ser_batch_import_evidence_to_assessment_control_input(
    ...
    crate::protocol_serde::shape_batch_import_evidence_to_assessment_control_input::ser_batch_import_evidence_to_assessment_control_input_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub(crate) fn de_batch_import_evidence_to_assessment_control(
    _value: &[u8],
    mut builder: crate::operation::batch_import_evidence_to_assessment_control::builders::BatchImportEvidenceToAssessmentControlOutputBuilder,
) -> ::std::result::Result<
    crate::operation::batch_import_evidence_to_assessment_control::builders::BatchImportEvidenceToAssessmentControlOutputBuilder,
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_import_evidence_to_assessment_control_errors::de_batch_import_evidence_to_assessment_control_errors(tokens, _value, depth + 1)?
                        );
                }
