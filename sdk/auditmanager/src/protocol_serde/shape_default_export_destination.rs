...
pub(crate) fn de_default_export_destination<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::DefaultExportDestination>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::DefaultExportDestinationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        "destinationType" => {
                            builder = builder.set_destination_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ExportDestinationType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "destination" => {
