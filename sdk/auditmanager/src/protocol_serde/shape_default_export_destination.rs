...
pub(crate) fn de_default_export_destination<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DefaultExportDestination>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_destination_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ExportDestinationType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
