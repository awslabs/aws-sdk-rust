...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_keywords_for_data_source_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_keywords_for_data_source::de_list_keywords_for_data_source(_response_body, output)
            .map_err(crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "keywords" => {
                    builder = builder.set_keywords(crate::protocol_serde::shape_keywords::de_keywords(tokens)?);
                }
                "nextToken" => {
