...
pub fn de_list_keywords_for_data_source_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceOutput, crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_keywords_for_data_source_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceOutput, crate::operation::list_keywords_for_data_source::ListKeywordsForDataSourceError> {
    Ok({
        #[allow(unused_mut)]
