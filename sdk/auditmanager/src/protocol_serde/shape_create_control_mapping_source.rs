...
pub fn ser_create_control_mapping_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateControlMappingSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
