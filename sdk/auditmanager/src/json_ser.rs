...
pub fn serialize_structure_associate_assessment_report_evidence_folder_input(
...
pub fn serialize_structure_batch_associate_assessment_report_evidence_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_create_delegation_by_assessment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_8 in var_6 {
            {
                ...
                crate::json_ser::serialize_structure_create_delegation_request(
                    &mut object_9,
                    item_8,
                );
                object_9.finish();
...
pub fn serialize_structure_batch_delete_delegation_by_assessment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_disassociate_assessment_report_evidence_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_import_evidence_to_assessment_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_19 in var_17 {
            {
                ...
                crate::json_ser::serialize_structure_manual_evidence(&mut object_20, item_19);
                object_20.finish();
            }
        }
        array_18.finish();
...
pub fn serialize_structure_create_assessment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_21) = &input.assessment_reports_destination {
        ...
        crate::json_ser::serialize_structure_assessment_reports_destination(&mut object_22, var_21);
        object_22.finish();
    }
        ...
        for item_28 in var_26 {
            {
                ...
                crate::json_ser::serialize_structure_role(&mut object_29, item_28);
                object_29.finish();
            }
        }
        array_27.finish();
    ...
    if let Some(var_30) = &input.scope {
        ...
        crate::json_ser::serialize_structure_scope(&mut object_31, var_30);
        object_31.finish();
    }
...
pub fn serialize_structure_create_assessment_framework_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_39 in var_37 {
            {
                ...
                crate::json_ser::serialize_structure_create_assessment_framework_control_set(
                    &mut object_40,
                    item_39,
                );
                object_40.finish();
...
pub fn serialize_structure_create_assessment_report_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_53 in var_51 {
            {
                ...
                crate::json_ser::serialize_structure_create_control_mapping_source(
                    &mut object_54,
                    item_53,
                );
                object_54.finish();
...
pub fn serialize_structure_deregister_organization_admin_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_disassociate_assessment_report_evidence_folder_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_register_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_register_organization_admin_account_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_assessment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_73) = &input.assessment_reports_destination {
        ...
        crate::json_ser::serialize_structure_assessment_reports_destination(&mut object_74, var_73);
        object_74.finish();
    }
        ...
        for item_77 in var_75 {
            {
                ...
                crate::json_ser::serialize_structure_role(&mut object_78, item_77);
                object_78.finish();
            }
        }
        array_76.finish();
    ...
    if let Some(var_79) = &input.scope {
        ...
        crate::json_ser::serialize_structure_scope(&mut object_80, var_79);
        object_80.finish();
    }
}

pub fn serialize_structure_update_assessment_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_assessment_control_set_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_assessment_framework_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_88 in var_86 {
            {
                ...
                crate::json_ser::serialize_structure_update_assessment_framework_control_set(
                    &mut object_89,
                    item_88,
                );
                object_89.finish();
...
pub fn serialize_structure_update_assessment_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_control_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_97 in var_95 {
            {
                ...
                crate::json_ser::serialize_structure_control_mapping_source(
                    &mut object_98,
                    item_97,
                );
                object_98.finish();
...
pub fn serialize_structure_update_settings_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_102) = &input.default_assessment_reports_destination {
        let mut object_103 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_assessment_reports_destination(
            &mut object_103,
            var_102,
        );
        object_103.finish();
        ...
        for item_106 in var_104 {
            {
                ...
                crate::json_ser::serialize_structure_role(&mut object_107, item_106);
                object_107.finish();
            }
        }
        array_105.finish();
...
pub fn serialize_structure_validate_assessment_report_integrity_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_delegation_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_manual_evidence(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_assessment_reports_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_role(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_scope(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_122 in var_120 {
            {
                ...
                crate::json_ser::serialize_structure_aws_account(&mut object_123, item_122);
                object_123.finish();
            }
        }
        array_121.finish();
        ...
        for item_126 in var_124 {
            {
                ...
                crate::json_ser::serialize_structure_aws_service(&mut object_127, item_126);
                object_127.finish();
            }
        }
        array_125.finish();
...
pub fn serialize_structure_create_assessment_framework_control_set(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_131 in var_129 {
            {
                ...
                crate::json_ser::serialize_structure_create_assessment_framework_control(
                    &mut object_132,
                    item_131,
                );
                object_132.finish();
...
pub fn serialize_structure_create_control_mapping_source(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_137) = &input.source_keyword {
        ...
        crate::json_ser::serialize_structure_source_keyword(&mut object_138, var_137);
        object_138.finish();
    }
...
pub fn serialize_structure_update_assessment_framework_control_set(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_control_mapping_source(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_152) = &input.source_keyword {
        ...
        crate::json_ser::serialize_structure_source_keyword(&mut object_153, var_152);
        object_153.finish();
    }
...
pub fn serialize_structure_aws_account(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_aws_service(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_assessment_framework_control(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_source_keyword(
    object: &mut smithy_json::serialize::JsonObjectWriter,
