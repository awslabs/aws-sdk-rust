...
impl aws_smithy_http::response::ParseStrictResponse for CreateAssessment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_assessment::de_create_assessment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_assessment::de_create_assessment_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteAssessment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_delete_assessment::de_delete_assessment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_delete_assessment::de_delete_assessment_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetAccountStatus {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_account_status::de_get_account_status_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_account_status::de_get_account_status_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetEvidenceFolder {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_evidence_folder::de_get_evidence_folder_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_evidence_folder::de_get_evidence_folder_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetServicesInScope {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_services_in_scope::de_get_services_in_scope_http_error(response)
                     } else {
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateAssessment {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_assessment::de_update_assessment_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_assessment::de_update_assessment_http_response(response)
                     }
                }
            }
