            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "attachments" => {
                            builder =
                                builder.set_attachments(crate::protocol_serde::shape_attachments_output::de_attachments_output(tokens, _value)?);
                        }
                        "sourceAttribution" => {
                            builder = builder
                                .set_source_attribution(crate::protocol_serde::shape_source_attributions::de_source_attributions(tokens, _value)?);
                        }
                        "actionReview" => {
                        ...
                        "actionExecution" => {
                            builder =
                                builder.set_action_execution(crate::protocol_serde::shape_action_execution::de_action_execution(tokens, _value)?);
                        }
