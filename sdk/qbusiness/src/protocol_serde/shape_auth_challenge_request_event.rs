...
pub(crate) fn de_auth_challenge_request_event_payload(
    input: &[u8],
) -> Result<crate::types::AuthChallengeRequestEvent, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
) -> Result<Option<crate::types::AuthChallengeRequestEvent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
