...
pub(crate) fn de_data_sources<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec::<crate::types::DataSource>>, ::aws_smithy_json::deserialize::error::DeserializeError>
