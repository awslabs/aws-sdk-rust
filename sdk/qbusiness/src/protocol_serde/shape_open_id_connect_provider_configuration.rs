...
pub fn ser_open_id_connect_provider_configuration(
    ...
    {
        object.key("secretsRole").string(input.secrets_role.as_str());
    }
    Ok(())
}
    ...
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::OpenIdConnectProviderConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "secretsArn" => {
                            builder = builder.set_secrets_arn(
                        ...
                        "secretsRole" => {
                            builder = builder.set_secrets_role(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| u.into_owned()))
                                    .transpose()?,
                            );
            ...
            Ok(Some(
                crate::serde_util::open_id_connect_provider_configuration_correct_errors(builder)
                    .build()
