                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "imageSourceDetails" => Some(crate::types::SourceDetails::ImageSourceDetails(
                            crate::protocol_serde::shape_image_source_details::de_image_source_details(tokens)?.ok_or_else(|| {
                        ...
                        "audioSourceDetails" => Some(crate::types::SourceDetails::AudioSourceDetails(
                            crate::protocol_serde::shape_audio_source_details::de_audio_source_details(tokens)?.ok_or_else(|| {
                        ...
                        "videoSourceDetails" => Some(crate::types::SourceDetails::VideoSourceDetails(
                            crate::protocol_serde::shape_video_source_details::de_video_source_details(tokens)?.ok_or_else(|| {
