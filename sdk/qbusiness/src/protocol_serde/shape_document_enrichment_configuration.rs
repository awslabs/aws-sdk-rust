        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_inline_document_enrichment_configuration::ser_inline_document_enrichment_configuration(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
...
pub(crate) fn de_document_enrichment_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DocumentEnrichmentConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
