...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::get_data_source::builders::GetDataSourceFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_data_source::builders::GetDataSourceFluentBuilder::set_application_id):<br>required: **true**<br><p>The identifier of the Amazon Q Business application.</p><br>
    ...
    ///   - [`application_id(Option<String>)`](crate::operation::get_data_source::GetDataSourceOutput::application_id): <p>The identifier of the Amazon Q Business application.</p>
    ...
    ///   - [`sync_schedule(Option<String>)`](crate::operation::get_data_source::GetDataSourceOutput::sync_schedule): <p>The schedule for Amazon Q Business to update the index.</p>
    ...
    ///   - [`media_extraction_configuration(Option<MediaExtractionConfiguration>)`](crate::operation::get_data_source::GetDataSourceOutput::media_extraction_configuration): <p>The configuration for extracting information from media in documents for the data source.</p>
