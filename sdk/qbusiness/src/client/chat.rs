...
impl super::Client {
    ...
    ///   - [`user_groups(impl Into<String>)`](crate::operation::chat::builders::ChatFluentBuilder::user_groups) / [`set_user_groups(Option<Vec::<String>>)`](crate::operation::chat::builders::ChatFluentBuilder::set_user_groups):<br>required: **false**<br><p>The group names that a user associated with the chat input belongs to.</p><br>
