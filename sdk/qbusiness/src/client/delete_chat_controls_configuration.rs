...
impl super::Client {
    ...
    pub fn delete_chat_controls_configuration(&self) -> crate::operation::delete_chat_controls_configuration::builders::DeleteChatControlsConfigurationFluentBuilder {
