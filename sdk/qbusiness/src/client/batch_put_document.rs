...
impl super::Client {
    ...
    ///   - [`documents(Document)`](crate::operation::batch_put_document::builders::BatchPutDocumentFluentBuilder::documents) / [`set_documents(Option<Vec::<Document>>)`](crate::operation::batch_put_document::builders::BatchPutDocumentFluentBuilder::set_documents):<br>required: **true**<br><p>One or more documents to add to the index.</p><important>  <p>Ensure that the name of your document doesn't contain any confidential information. Amazon Q Business returns document names in chat responses and citations when relevant.</p> </important><br>
