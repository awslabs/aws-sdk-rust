...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::list_data_sources::builders::ListDataSourcesFluentBuilder::set_application_id):<br>required: **true**<br><p>The identifier of the Amazon Q Business application linked to the data source connectors.</p><br>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::list_data_sources::ListDataSourcesOutput::next_token): <p>If the response is truncated, Amazon Q Business returns this token. You can use this token in a subsequent request to retrieve the next set of data source connectors.</p>
