...
impl super::Client {
    ...
    ///   - [`application_id(impl Into<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::set_application_id):<br>required: **true**<br><p>The identifier of the Amazon Q application linked to the Amazon Q conversation.</p><br>
    ///   - [`user_id(impl Into<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::set_user_id):<br>required: **true**<br><p>The identifier of the user attached to the chat input.</p><br>
    ...
    ///   - [`action_execution(ActionExecution)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::action_execution) / [`set_action_execution(Option<ActionExecution>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::set_action_execution):<br>required: **false**<br><p>A request from an end user to perform an Amazon Q plugin action.</p><br>
    ///   - [`conversation_id(impl Into<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::conversation_id) / [`set_conversation_id(Option<String>)`](crate::operation::chat_sync::builders::ChatSyncFluentBuilder::set_conversation_id):<br>required: **false**<br><p>The identifier of the Amazon Q conversation.</p><br>
    ...
    ///   - [`conversation_id(Option<String>)`](crate::operation::chat_sync::ChatSyncOutput::conversation_id): <p>The identifier of the Amazon Q conversation.</p>
    ...
    ///   - [`system_message_id(Option<String>)`](crate::operation::chat_sync::ChatSyncOutput::system_message_id): <p>The identifier of an Amazon Q AI generated message within the conversation.</p>
    ///   - [`user_message_id(Option<String>)`](crate::operation::chat_sync::ChatSyncOutput::user_message_id): <p>The identifier of an Amazon Q end user text input message within the conversation.</p>
    ///   - [`action_review(Option<ActionReview>)`](crate::operation::chat_sync::ChatSyncOutput::action_review): <p>A request from Amazon Q to the end user for information Amazon Q needs to successfully complete a requested plugin action.</p>
