...
fn uri_query(_input: &crate::operation::list_groups::ListGroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let inner_3 = inner_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("updated_earlier_than", "cannot be empty or unset"))?;
    query.push_kv("updatedEarlierThan", &::aws_smithy_http::query::fmt_timestamp(inner_3, ::aws_smithy_types::date_time::Format::DateTime)?);
