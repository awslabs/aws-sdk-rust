...
impl GetWebExperienceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_web_experience::GetWebExperienceInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_web_experience::GetWebExperienceInput {
