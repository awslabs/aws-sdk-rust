...
/// Orchestration and serialization glue logic for `Chat`.
...
impl Chat {
    ...
    pub(crate) async fn orchestrate(
        ...
        input: crate::operation::chat::ChatInput,
    ) -> ::std::result::Result<
    ...
    > {
        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<
            ...
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >| { err.map_service_error(|err| err.downcast::<crate::operation::chat::ChatError>().expect("correct error type")) };
        ...
        ::std::result::Result::Ok(output.downcast::<crate::operation::chat::ChatOutput>().expect("correct output type"))
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("QBusiness", "Chat", input, runtime_plugins, stop_point).await
    }
        ...
        runtime_plugins = runtime_plugins
            .with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
                |token_provider, input| {
                    let input: &mut crate::operation::chat::ChatInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for Chat {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("Chat");
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("Chat", "QBusiness"));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ChatResponseDeserializer {
    fn deserialize_streaming(
        ...
        ::std::option::Option::Some(crate::protocol_serde::type_erase_result(
            crate::protocol_serde::shape_chat::de_chat_http_response(response),
        ))
    }
    ...
    fn deserialize_nonstreaming(
        ...
        crate::protocol_serde::type_erase_result(crate::protocol_serde::shape_chat::de_chat_http_error(
...
#[derive(Debug)]
struct ChatRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ChatRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::chat::ChatInput>().expect("correct type");
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::chat::ChatInput,
            ...
            fn uri_query(
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.conversation_id {
                    {
                        query.push_kv("conversationId", &::aws_smithy_http::query::fmt_string(inner_5));
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.parent_message_id {
                    {
                        query.push_kv("parentMessageId", &::aws_smithy_http::query::fmt_string(inner_6));
                    }
                }
                if let ::std::option::Option::Some(inner_7) = &_input.client_token {
                    {
        ...
        let body = ::aws_smithy_types::body::SdkBody::from({
            let error_marshaller = crate::event_stream_serde::ChatInputStreamErrorMarshaller::new();
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ChatEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context.input().downcast_ref::<ChatInput>().ok_or("failed to downcast to ChatInput")?;
...
/// Error type for the `ChatError` operation.
#[non_exhaustive]
...
pub enum ChatError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ChatError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ChatError {
    /// Creates the `ChatError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `ChatError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ChatError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ChatError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `ChatError::ExternalResourceException`.
    pub fn is_external_resource_exception(&self) -> bool {
        matches!(self, Self::ExternalResourceException(_))
    }
    /// Returns `true` if the error kind is `ChatError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `ChatError::LicenseNotFoundException`.
    pub fn is_license_not_found_exception(&self) -> bool {
        matches!(self, Self::LicenseNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ChatError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ChatError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ChatError::ValidationException`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ChatError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ChatError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ChatError {
...
impl ::aws_types::request_id::RequestId for crate::operation::chat::ChatError {
