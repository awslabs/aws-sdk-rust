...
impl ChatSyncFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::chat_sync::ChatSyncOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::chat_sync::ChatSyncError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
