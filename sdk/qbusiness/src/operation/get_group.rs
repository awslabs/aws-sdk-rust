...
#[derive(Debug)]
    ...
    ::std::write!(output, "/applications/{applicationId}/indices/{indexId}/groups/{groupName}", applicationId = application_id, indexId = index_id, groupName = group_name).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_group::GetGroupInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
impl GetGroupError {
    ...
    /// Returns `true` if the error kind is `GetGroupError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `GetGroupError::ThrottlingException`.
