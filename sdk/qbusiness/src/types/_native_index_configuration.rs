...
pub struct NativeIndexConfiguration  {
    ...
    pub boosting_override: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::DocumentAttributeBoostingConfiguration>>,
}
impl  NativeIndexConfiguration  {
    ...
    /// <p>Overrides the default boosts applied by Amazon Q to supported document attribute data types.</p>
    pub fn boosting_override(&self) -> ::std::option::Option<& ::std::collections::HashMap::<::std::string::String, crate::types::DocumentAttributeBoostingConfiguration>> {
...
pub struct NativeIndexConfigurationBuilder {
    ...
    pub(crate) boosting_override: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::DocumentAttributeBoostingConfiguration>>,
}
impl NativeIndexConfigurationBuilder {
    ...
    ///
    /// <p>Overrides the default boosts applied by Amazon Q to supported document attribute data types.</p>
    pub fn boosting_override(mut self, k: impl ::std::convert::Into<::std::string::String>, v: crate::types::DocumentAttributeBoostingConfiguration) -> Self {
    ...
    /// <p>Overrides the default boosts applied by Amazon Q to supported document attribute data types.</p>
    pub fn set_boosting_override(mut self, input: ::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::DocumentAttributeBoostingConfiguration>>) -> Self {
        self.boosting_override = input; self
    }
    /// <p>Overrides the default boosts applied by Amazon Q to supported document attribute data types.</p>
    pub fn get_boosting_override(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::DocumentAttributeBoostingConfiguration>> {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::NativeIndexConfiguration, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::NativeIndexConfiguration {
                index_id: self.index_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("index_id", "index_id was not specified but it is required when building NativeIndexConfiguration")
                    )?
                ,
