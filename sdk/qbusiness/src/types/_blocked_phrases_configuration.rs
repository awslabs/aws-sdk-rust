...
pub struct BlockedPhrasesConfiguration {
    /// <p>A list of phrases blocked from a Amazon Q Business web experience chat.</p><note>
    /// <p>Each phrase can contain a maximum of 36 characters. The list can contain a maximum of 20 phrases.</p>
    /// </note>
