...
///     DataSourceStatus::PendingCreation => { /* ... */ },
...
impl ::std::convert::From<&str> for DataSourceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "PENDING_CREATION" => DataSourceStatus::PendingCreation,
...
impl ::std::str::FromStr for DataSourceStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DataSourceStatus::from(s))
    }
}
impl DataSourceStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            DataSourceStatus::PendingCreation => "PENDING_CREATION",
