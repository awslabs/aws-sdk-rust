...
impl  Message  {
    ...
    pub fn source_attribution(&self) -> & [::std::option::Option<crate::types::SourceAttribution>] {
        self.source_attribution.as_deref()
        .unwrap_or_default()
    }
    /// <p>An output event that Amazon Q returns to an user who wants to perform a plugin action during a non-streaming chat conversation. It contains information about the selected action with a list of possible user input fields, some pre-populated by Amazon Q.</p>
...
impl MessageBuilder {
    ...
    /// <p>The source documents used to generate Amazon Q web experience message.</p>
    pub fn set_source_attribution(mut self, input: ::std::option::Option<::std::vec::Vec::<::std::option::Option<crate::types::SourceAttribution>>>) -> Self {
        self.source_attribution = input; self
    }
    /// <p>The source documents used to generate Amazon Q web experience message.</p>
    ...
    pub fn set_action_execution(mut self, input: ::std::option::Option<crate::types::ActionExecution>) -> Self {
        self.action_execution = input; self
    }
    /// <p>Performs an Amazon Q plugin action during a non-streaming chat conversation.</p>
