...
/// Paginator for [`ListBillScenarios`](crate::operation::list_bill_scenarios::ListBillScenarios)
pub struct ListBillScenariosPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_bill_scenarios::builders::ListBillScenariosInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListBillScenariosPaginator {
    ...
    pub fn items(self) -> crate::operation::list_bill_scenarios::paginator::ListBillScenariosPaginatorItems {
        crate::operation::list_bill_scenarios::paginator::ListBillScenariosPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_bill_scenarios::ListBillScenarios::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_bill_scenarios_output_output_next_token(resp);
...
/// Flattened paginator for `ListBillScenariosPaginator`
///
/// This is created with [`.items()`](ListBillScenariosPaginator::items)
pub struct ListBillScenariosPaginatorItems(ListBillScenariosPaginator);

impl ListBillScenariosPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    pub fn send(
        ...
        ::std::result::Result<
            crate::types::BillScenarioSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                crate::operation::list_bill_scenarios::ListBillScenariosError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_bill_scenarios_output_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
