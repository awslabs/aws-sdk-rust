...
pub fn ser_expression(
    ...
    if let Some(var_5) = &input.or {
        let mut array_6 = object.key("or").start_array();
        for item_7 in var_5 {
            {
                #[allow(unused_mut)]
    ...
    if let Some(var_11) = &input.cost_categories {
        #[allow(unused_mut)]
        let mut object_12 = object.key("costCategories").start_object();
        crate::protocol_serde::shape_expression_filter::ser_expression_filter(&mut object_12, var_11)?;
        object_12.finish();
    }
    if let Some(var_13) = &input.dimensions {
        #[allow(unused_mut)]
        let mut object_14 = object.key("dimensions").start_object();
        crate::protocol_serde::shape_expression_filter::ser_expression_filter(&mut object_14, var_13)?;
        object_14.finish();
    }
    if let Some(var_15) = &input.tags {
        #[allow(unused_mut)]
        let mut object_16 = object.key("tags").start_object();
        crate::protocol_serde::shape_expression_filter::ser_expression_filter(&mut object_16, var_15)?;
        object_16.finish();
    }
    Ok(())
}
