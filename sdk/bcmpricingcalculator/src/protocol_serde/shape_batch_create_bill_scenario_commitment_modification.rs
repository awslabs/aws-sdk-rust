...
pub fn de_batch_create_bill_scenario_commitment_modification_http_error(
...
> {
    ...
    Err(match error_code {
        "ConflictException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "DataUnavailableException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::DataUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "AccessDeniedException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::batch_create_bill_scenario_commitment_modification::BatchCreateBillScenarioCommitmentModificationError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_create_bill_scenario_commitment_modification_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::batch_create_bill_scenario_commitment_modification::builders::BatchCreateBillScenarioCommitmentModificationOutputBuilder::default();
        output =
            crate::protocol_serde::shape_batch_create_bill_scenario_commitment_modification::de_batch_create_bill_scenario_commitment_modification(
                _response_body,
                output,
            )
            .map_err(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "items" => {
                    builder = builder.set_items(
                            crate::protocol_serde::shape_batch_create_bill_scenario_commitment_modification_items::de_batch_create_bill_scenario_commitment_modification_items(tokens, _value)?
                        );
                }
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_create_bill_scenario_commitment_modification_errors::de_batch_create_bill_scenario_commitment_modification_errors(tokens, _value)?
                        );
                }
