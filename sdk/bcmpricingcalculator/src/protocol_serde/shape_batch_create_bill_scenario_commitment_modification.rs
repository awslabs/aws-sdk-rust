            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "items" => {
                    builder = builder.set_items(
                            crate::protocol_serde::shape_batch_create_bill_scenario_commitment_modification_items::de_batch_create_bill_scenario_commitment_modification_items(tokens)?
                        );
                }
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_create_bill_scenario_commitment_modification_errors::de_batch_create_bill_scenario_commitment_modification_errors(tokens)?
                        );
                }
