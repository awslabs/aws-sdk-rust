...
pub(crate) fn de_bill_interval<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::BillInterval>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
...
pub fn ser_bill_interval(
    ...
    input: &crate::types::BillInterval,
