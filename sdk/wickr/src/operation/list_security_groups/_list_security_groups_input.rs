...
pub struct ListSecurityGroupsInput {
...
impl ListSecurityGroupsInput {
    /// Creates a new builder-style object to manufacture [`ListSecurityGroupsInput`](crate::operation::list_security_groups::ListSecurityGroupsInput).
    pub fn builder() -> crate::operation::list_security_groups::builders::ListSecurityGroupsInputBuilder {
        crate::operation::list_security_groups::builders::ListSecurityGroupsInputBuilder::default()
    }
}

/// A builder for [`ListSecurityGroupsInput`](crate::operation::list_security_groups::ListSecurityGroupsInput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ListSecurityGroupsInputBuilder {
...
impl ListSecurityGroupsInputBuilder {
    /// <p>The ID of the Wickr network from which to list security groups.</p>
    ...
    /// Consumes the builder and constructs a [`ListSecurityGroupsInput`](crate::operation::list_security_groups::ListSecurityGroupsInput).
    pub fn build(
        self,
    ) -> ::std::result::Result<crate::operation::list_security_groups::ListSecurityGroupsInput, ::aws_smithy_types::error::operation::BuildError>
    {
        ::std::result::Result::Ok(crate::operation::list_security_groups::ListSecurityGroupsInput {
