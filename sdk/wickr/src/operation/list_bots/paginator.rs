...
impl ListBotsPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `bots`. Queries to the underlying service
    /// are dispatched lazily.
    pub fn items(self) -> crate::operation::list_bots::paginator::ListBotsPaginatorItems {
        crate::operation::list_bots::paginator::ListBotsPaginatorItems(self)
    }
...
impl ListBotsPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_bots_output_output_bots(page).unwrap_or_default().into_iter())
    }
}
