...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::set_id):<br>required: **true**<br><p>The ID of a given wireless device which the downlink message packets are being sent.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::set_next_token):<br>required: **false**<br><p>To retrieve the next set of results, the <code>nextToken</code> value from a previous response; otherwise <b>null</b> to receive the first set of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_queued_messages::builders::ListQueuedMessagesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results to return in this operation.</p><br>
