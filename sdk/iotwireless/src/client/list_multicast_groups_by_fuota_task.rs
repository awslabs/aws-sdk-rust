...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::list_multicast_groups_by_fuota_task::builders::ListMulticastGroupsByFuotaTaskFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::list_multicast_groups_by_fuota_task::builders::ListMulticastGroupsByFuotaTaskFluentBuilder::set_id): <p>The ID of a FUOTA task.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_multicast_groups_by_fuota_task::builders::ListMulticastGroupsByFuotaTaskFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_multicast_groups_by_fuota_task::builders::ListMulticastGroupsByFuotaTaskFluentBuilder::set_next_token): <p>To retrieve the next set of results, the <code>nextToken</code> value from a previous response; otherwise <b>null</b> to receive the first set of results.</p>
