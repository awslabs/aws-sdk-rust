...
impl super::Client {
    ...
    pub fn delete_wireless_device(
        &self,
    ) -> crate::operation::delete_wireless_device::builders::DeleteWirelessDeviceFluentBuilder {
        crate::operation::delete_wireless_device::builders::DeleteWirelessDeviceFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
