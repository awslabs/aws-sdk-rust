...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_wireless_device::builders::DeleteWirelessDeviceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_wireless_device::builders::DeleteWirelessDeviceFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the resource to delete.</p><br>
