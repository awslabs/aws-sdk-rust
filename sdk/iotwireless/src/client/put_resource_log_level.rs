...
impl super::Client {
    ...
    ///   - [`resource_identifier(impl Into<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::set_resource_identifier):<br>required: **true**<br><p>The unique identifier of the resource, which can be the wireless gateway ID, the wireless device ID, or the FUOTA task ID.</p><br>
