...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_wireless_gateway_task_definition::builders::GetWirelessGatewayTaskDefinitionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_wireless_gateway_task_definition::builders::GetWirelessGatewayTaskDefinitionFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the resource to get.</p><br>
