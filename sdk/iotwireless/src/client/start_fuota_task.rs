...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::start_fuota_task::builders::StartFuotaTaskFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::start_fuota_task::builders::StartFuotaTaskFluentBuilder::set_id): <p>The ID of a FUOTA task.</p>
