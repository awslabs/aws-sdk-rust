...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_multicast_group::builders::GetMulticastGroupFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_multicast_group::builders::GetMulticastGroupFluentBuilder::set_id): <p>The ID of the multicast group.</p>
