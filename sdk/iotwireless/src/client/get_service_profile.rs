...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_service_profile::builders::GetServiceProfileFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_service_profile::builders::GetServiceProfileFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the resource to get.</p><br>
