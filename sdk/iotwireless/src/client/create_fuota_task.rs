...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::set_name): <p>The name of a FUOTA task.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::set_description): <p>The description of the new resource.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::set_client_request_token): <p>Each resource must have a unique client request token. If you try to create a new resource with the same token as a resource that already exists, an exception occurs. If you omit this value, AWS SDKs will automatically generate a unique client request.</p>
    ...
    ///   - [`fragment_size_bytes(i32)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::fragment_size_bytes) / [`set_fragment_size_bytes(Option<i32>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::set_fragment_size_bytes): <p>The size of each fragment in bytes. Currently only supported in fuota tasks with multicast groups.</p>
    ///   - [`fragment_interval_ms(i32)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::fragment_interval_ms) / [`set_fragment_interval_ms(Option<i32>)`](crate::operation::create_fuota_task::builders::CreateFuotaTaskFluentBuilder::set_fragment_interval_ms): <p>The interval of sending fragments in milliseconds. Currently the interval will be rounded to the nearest second. Note that this interval only controls the timing when the cloud sends the fragments down. The actual delay of receiving fragments at device side depends on the device's class and the communication delay with the cloud.</p>
