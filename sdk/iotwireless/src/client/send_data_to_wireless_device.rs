...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::send_data_to_wireless_device::builders::SendDataToWirelessDeviceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::send_data_to_wireless_device::builders::SendDataToWirelessDeviceFluentBuilder::set_id): <p>The ID of the wireless device to receive the data.</p>
