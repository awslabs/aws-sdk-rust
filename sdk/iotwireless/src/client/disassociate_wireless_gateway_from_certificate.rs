...
impl super::Client {
    ...
    pub fn disassociate_wireless_gateway_from_certificate(
        &self,
    ) -> crate::operation::disassociate_wireless_gateway_from_certificate::builders::DisassociateWirelessGatewayFromCertificateFluentBuilder {
        crate::operation::disassociate_wireless_gateway_from_certificate::builders::DisassociateWirelessGatewayFromCertificateFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
