...
impl super::Client {
    ...
    ///   - [`descriptor(Option<String>)`](crate::operation::get_fuota_task::GetFuotaTaskOutput::descriptor): <p>The Descriptor specifies some metadata about the File being transferred using FUOTA e.g. the software version. It is sent transparently to the device. It is a binary field encoded in base64</p>
