...
impl super::Client {
    ...
    ///   - [`descriptor(Option<String>)`](crate::operation::get_fuota_task::GetFuotaTaskOutput::descriptor): <p>The descriptor is the metadata about the file that is transferred to the device using FUOTA, such as the software version. It is a binary field encoded in base64.</p>
