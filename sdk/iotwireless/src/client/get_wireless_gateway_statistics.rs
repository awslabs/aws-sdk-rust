...
impl super::Client {
    ...
    ///   - [`wireless_gateway_id(impl ::std::convert::Into<String>)`](crate::operation::get_wireless_gateway_statistics::builders::GetWirelessGatewayStatisticsFluentBuilder::wireless_gateway_id) / [`set_wireless_gateway_id(Option<String>)`](crate::operation::get_wireless_gateway_statistics::builders::GetWirelessGatewayStatisticsFluentBuilder::set_wireless_gateway_id): <p>The ID of the wireless gateway for which to get the data.</p>
