...
impl super::Client {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::deregister_wireless_device::builders::DeregisterWirelessDeviceFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::deregister_wireless_device::builders::DeregisterWirelessDeviceFluentBuilder::set_identifier): <p>The identifier of the wireless device to deregister from AWS IoT Wireless.</p>
