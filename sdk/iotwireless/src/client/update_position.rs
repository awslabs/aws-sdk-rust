...
impl super::Client {
    ...
    ///   - [`position(f32)`](crate::operation::update_position::builders::UpdatePositionFluentBuilder::position) / [`set_position(Option<Vec<f32>>)`](crate::operation::update_position::builders::UpdatePositionFluentBuilder::set_position): <p>The position information of the resource.</p>
