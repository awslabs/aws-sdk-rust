...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::get_wireless_gateway::builders::GetWirelessGatewayFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_wireless_gateway::builders::GetWirelessGatewayFluentBuilder::set_identifier):<br>required: **true**<br><p>The identifier of the wireless gateway to get.</p><br>
    ///   - [`identifier_type(WirelessGatewayIdType)`](crate::operation::get_wireless_gateway::builders::GetWirelessGatewayFluentBuilder::identifier_type) / [`set_identifier_type(Option<WirelessGatewayIdType>)`](crate::operation::get_wireless_gateway::builders::GetWirelessGatewayFluentBuilder::set_identifier_type):<br>required: **true**<br><p>The type of identifier used in <code>identifier</code>.</p><br>
