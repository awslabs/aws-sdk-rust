...
impl super::Client {
    ...
    ///   - [`tags(Tag)`](crate::operation::create_destination::builders::CreateDestinationFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_destination::builders::CreateDestinationFluentBuilder::set_tags): <p>The tags to attach to the new destination. Tags are metadata that you can use to manage a resource.</p>
