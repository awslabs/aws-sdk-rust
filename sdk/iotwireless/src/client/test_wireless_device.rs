...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::test_wireless_device::builders::TestWirelessDeviceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::test_wireless_device::builders::TestWirelessDeviceFluentBuilder::set_id): <p>The ID of the wireless device to test.</p>
