...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::get_multicast_group_session::builders::GetMulticastGroupSessionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_multicast_group_session::builders::GetMulticastGroupSessionFluentBuilder::set_id):<br>required: **true**<br><p>The ID of the multicast group.</p><br>
