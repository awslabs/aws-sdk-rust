...
impl super::Client {
    ...
    pub fn get_wireless_gateway_firmware_information(
        &self,
    ) -> crate::operation::get_wireless_gateway_firmware_information::builders::GetWirelessGatewayFirmwareInformationFluentBuilder {
        crate::operation::get_wireless_gateway_firmware_information::builders::GetWirelessGatewayFirmwareInformationFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
