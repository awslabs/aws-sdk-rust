...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::get_fuota_task::GetFuotaTaskError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::get_position::GetPositionError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
