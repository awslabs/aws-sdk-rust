...
impl AssociateWirelessDeviceWithThingInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_wireless_device_with_thing::AssociateWirelessDeviceWithThing::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateWirelessDeviceWithThing {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_associate_wireless_device_with_thing::de_associate_wireless_device_with_thing_http_response_with_props(
                status, headers, body,
            )
        }
    }
