...
impl SendDataToMulticastGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::send_data_to_multicast_group::SendDataToMulticastGroupInput, ::aws_smithy_types::error::operation::BuildError> {
