...
impl StartMulticastGroupSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_multicast_group_session::StartMulticastGroupSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMulticastGroupSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_start_multicast_group_session::de_start_multicast_group_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
