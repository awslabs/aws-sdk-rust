...
impl CreateDestinationInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_destination::ser_create_destination_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDestination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_destination::de_create_destination_http_response_with_props(status, headers, body)
        }
    }
}
