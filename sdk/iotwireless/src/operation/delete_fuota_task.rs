...
/// Orchestration and serialization glue logic for `DeleteFuotaTask`.
...
impl DeleteFuotaTask {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_fuota_task::DeleteFuotaTaskInput,
                    ) -> ::std::result::Result<crate::operation::delete_fuota_task::DeleteFuotaTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_fuota_task::DeleteFuotaTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_fuota_task::DeleteFuotaTaskError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_fuota_task::DeleteFuotaTaskOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFuotaTask {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFuotaTask");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFuotaTaskRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFuotaTaskResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFuotaTask")
...
.with_interceptor(DeleteFuotaTaskEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_fuota_task::DeleteFuotaTaskError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_fuota_task::DeleteFuotaTaskError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_fuota_task::DeleteFuotaTaskError>::new());
...
#[derive(Debug)]
            struct DeleteFuotaTaskResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFuotaTaskResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_fuota_task::de_delete_fuota_task_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_fuota_task::de_delete_fuota_task_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFuotaTaskRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFuotaTaskRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_fuota_task::DeleteFuotaTaskInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_fuota_task::DeleteFuotaTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteFuotaTaskEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFuotaTaskEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFuotaTaskEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFuotaTaskInput>()
                        .ok_or("failed to downcast to DeleteFuotaTaskInput")?;
...
pub enum DeleteFuotaTaskError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFuotaTaskError) for what information is available for the error.")]
...
impl DeleteFuotaTaskError {
    /// Creates the `DeleteFuotaTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFuotaTaskError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFuotaTaskError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_fuota_task::DeleteFuotaTaskError {
