...
impl DeleteQueuedMessages {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_queued_messages::DeleteQueuedMessagesInput,
                    ) -> ::std::result::Result<crate::operation::delete_queued_messages::DeleteQueuedMessagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_queued_messages::DeleteQueuedMessagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_queued_messages::DeleteQueuedMessagesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_queued_messages::DeleteQueuedMessagesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteQueuedMessages {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteQueuedMessages");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteQueuedMessagesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteQueuedMessagesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteQueuedMessages")
...
.with_interceptor(DeleteQueuedMessagesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_queued_messages::DeleteQueuedMessagesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_queued_messages::DeleteQueuedMessagesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_queued_messages::DeleteQueuedMessagesError>::new());
...
#[derive(Debug)]
            struct DeleteQueuedMessagesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteQueuedMessagesResponseDeserializer {
            ...
            let parse_result = if !success && status != 204 || force_error {
                crate::protocol_serde::shape_delete_queued_messages::de_delete_queued_messages_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DeleteQueuedMessagesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteQueuedMessagesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_queued_messages::DeleteQueuedMessagesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_queued_messages::DeleteQueuedMessagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
fn uri_query(_input: &crate::operation::delete_queued_messages::DeleteQueuedMessagesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    let inner_2 = &_input.message_id;
    let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("message_id", "cannot be empty or unset"))?;
    if inner_2.is_empty() {
...
#[derive(Debug)]
            struct DeleteQueuedMessagesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteQueuedMessagesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteQueuedMessagesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteQueuedMessagesInput>()
                        .ok_or("failed to downcast to DeleteQueuedMessagesInput")?;
...
pub enum DeleteQueuedMessagesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteQueuedMessagesError) for what information is available for the error.")]
...
impl DeleteQueuedMessagesError {
    /// Creates the `DeleteQueuedMessagesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteQueuedMessagesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteQueuedMessagesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_queued_messages::DeleteQueuedMessagesError {
...
mod _delete_queued_messages_output;
