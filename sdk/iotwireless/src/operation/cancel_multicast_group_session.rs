...
impl CancelMulticastGroupSessionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::cancel_multicast_group_session::CancelMulticastGroupSession::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelMulticastGroupSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_cancel_multicast_group_session::de_cancel_multicast_group_session_http_response_with_props(
                status, headers, body,
            )
        }
    }
