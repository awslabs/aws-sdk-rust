...
impl GetWirelessGatewayTaskDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_wireless_gateway_task_definition::GetWirelessGatewayTaskDefinition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_wireless_gateway_task_definition::GetWirelessGatewayTaskDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWirelessGatewayTaskDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_wireless_gateway_task_definition::de_get_wireless_gateway_task_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
