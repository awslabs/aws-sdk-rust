...
impl ListPositionConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_position_configurations::ListPositionConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
