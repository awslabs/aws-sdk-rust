...
impl CancelMulticastGroupSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_multicast_group_session::CancelMulticastGroupSessionInput, ::aws_smithy_types::error::operation::BuildError> {
