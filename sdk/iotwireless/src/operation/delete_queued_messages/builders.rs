...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_queued_messages::DeleteQueuedMessagesOutput,
                    crate::operation::delete_queued_messages::DeleteQueuedMessagesError,
                > for DeleteQueuedMessagesFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteQueuedMessagesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_queued_messages::DeleteQueuedMessagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_queued_messages::DeleteQueuedMessagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_queued_messages::DeleteQueuedMessages::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_queued_messages::DeleteQueuedMessages::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_queued_messages::DeleteQueuedMessagesOutput, crate::operation::delete_queued_messages::DeleteQueuedMessagesError, Self> {
