...
impl GetWirelessGatewayStatisticsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_wireless_gateway_statistics::GetWirelessGatewayStatistics::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWirelessGatewayStatistics {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_wireless_gateway_statistics::de_get_wireless_gateway_statistics_http_response_with_props(
                status, headers, body,
            )
        }
    }
