...
impl CreateWirelessDeviceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_wireless_device::CreateWirelessDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_wireless_device::CreateWirelessDeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_wireless_device::CreateWirelessDeviceOutput, crate::operation::create_wireless_device::CreateWirelessDeviceError, Self> {
