...
impl AssociateAwsAccountWithPartnerAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountInput, ::aws_smithy_types::error::operation::BuildError> {
