...
impl CreateWirelessGatewayTaskDefinitionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_wireless_gateway_task_definition::CreateWirelessGatewayTaskDefinition,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_wireless_gateway_task_definition::CreateWirelessGatewayTaskDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWirelessGatewayTaskDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_wireless_gateway_task_definition::de_create_wireless_gateway_task_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
