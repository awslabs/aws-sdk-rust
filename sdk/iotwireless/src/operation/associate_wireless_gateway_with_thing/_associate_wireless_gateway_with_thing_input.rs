...
impl AssociateWirelessGatewayWithThingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_wireless_gateway_with_thing::AssociateWirelessGatewayWithThingInput, ::aws_smithy_types::error::operation::BuildError> {
