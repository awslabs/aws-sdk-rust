...
impl UpdateNetworkAnalyzerConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_network_analyzer_configuration::UpdateNetworkAnalyzerConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNetworkAnalyzerConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_update_network_analyzer_configuration::de_update_network_analyzer_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
