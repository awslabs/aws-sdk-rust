...
impl CreateNetworkAnalyzerConfigurationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_network_analyzer_configuration::CreateNetworkAnalyzerConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNetworkAnalyzerConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_network_analyzer_configuration::de_create_network_analyzer_configuration_http_response_with_props(
                status, headers, body,
            )
        }
    }
