...
impl DisassociateWirelessDeviceFromMulticastGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_wireless_device_from_multicast_group::DisassociateWirelessDeviceFromMulticastGroupInput, ::aws_smithy_types::error::operation::BuildError> {
