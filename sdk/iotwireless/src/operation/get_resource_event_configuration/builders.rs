...
impl crate::operation::get_resource_event_configuration::builders::GetResourceEventConfigurationInputBuilder {
...
impl GetResourceEventConfigurationFluentBuilder {
    /// Creates a new `GetResourceEventConfigurationFluentBuilder`.
