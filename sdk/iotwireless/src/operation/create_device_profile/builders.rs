...
impl CreateDeviceProfileFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_device_profile::CreateDeviceProfileOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_device_profile::CreateDeviceProfileError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_device_profile::CreateDeviceProfileOutput, crate::operation::create_device_profile::CreateDeviceProfileError, Self> {
