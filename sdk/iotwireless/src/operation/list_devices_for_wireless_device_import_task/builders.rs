...
pub use crate::operation::list_devices_for_wireless_device_import_task::_list_devices_for_wireless_device_import_task_output::ListDevicesForWirelessDeviceImportTaskOutputBuilder;

pub use crate::operation::list_devices_for_wireless_device_import_task::_list_devices_for_wireless_device_import_task_input::ListDevicesForWirelessDeviceImportTaskInputBuilder;
...
impl ListDevicesForWirelessDeviceImportTaskInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_devices_for_wireless_device_import_task();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `ListDevicesForWirelessDeviceImportTask`.
/// 
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskOutput,
                    crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskError,
                > for ListDevicesForWirelessDeviceImportTaskFluentBuilder
            {
                fn send(
                    self,
...
impl ListDevicesForWirelessDeviceImportTaskFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTask::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTask::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskOutput, crate::operation::list_devices_for_wireless_device_import_task::ListDevicesForWirelessDeviceImportTaskError, Self> {
