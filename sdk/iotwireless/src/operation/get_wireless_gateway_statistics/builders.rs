...
impl crate::operation::get_wireless_gateway_statistics::builders::GetWirelessGatewayStatisticsInputBuilder {
...
impl GetWirelessGatewayStatisticsFluentBuilder {
    /// Creates a new `GetWirelessGatewayStatisticsFluentBuilder`.
