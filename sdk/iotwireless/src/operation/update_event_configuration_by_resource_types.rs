...
impl UpdateEventConfigurationByResourceTypesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateEventConfigurationByResourceTypes`](crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        assert_ne!(
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/event-configurations-resource-types")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEventConfigurationByResourceTypes {
    type Output = ::std::result::Result<crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesOutput, crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError {
