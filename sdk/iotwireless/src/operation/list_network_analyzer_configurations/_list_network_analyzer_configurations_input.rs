...
impl ListNetworkAnalyzerConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_network_analyzer_configurations::ListNetworkAnalyzerConfigurationsInput, ::aws_smithy_types::error::operation::BuildError> {
