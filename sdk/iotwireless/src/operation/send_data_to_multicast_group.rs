...
impl SendDataToMulticastGroupInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_data_to_multicast_group::SendDataToMulticastGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendDataToMulticastGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_send_data_to_multicast_group::de_send_data_to_multicast_group_http_response_with_props(status, headers, body)
        }
    }
}
