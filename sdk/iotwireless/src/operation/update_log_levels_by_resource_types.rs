...
impl UpdateLogLevelsByResourceTypesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_log_levels_by_resource_types::UpdateLogLevelsByResourceTypes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLogLevelsByResourceTypes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_log_levels_by_resource_types::de_update_log_levels_by_resource_types_http_response_with_props(
                status, headers, body,
            )
        }
    }
