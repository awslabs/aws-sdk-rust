...
impl StartBulkDisassociateWirelessDeviceFromMulticastGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::start_bulk_disassociate_wireless_device_from_multicast_group::StartBulkDisassociateWirelessDeviceFromMulticastGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartBulkDisassociateWirelessDeviceFromMulticastGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_start_bulk_disassociate_wireless_device_from_multicast_group::de_start_bulk_disassociate_wireless_device_from_multicast_group_http_response_with_props(status, headers, body)
        }
    }
}
