...
impl UpdateFuotaTaskInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_fuota_task::UpdateFuotaTask, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_fuota_task::ser_update_fuota_task_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFuotaTask {
    type Output =
        ::std::result::Result<crate::operation::update_fuota_task::UpdateFuotaTaskOutput, crate::operation::update_fuota_task::UpdateFuotaTaskError>;
