...
impl GetMulticastGroupSessionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_multicast_group_session::GetMulticastGroupSession,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_multicast_group_session::GetMulticastGroupSession::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMulticastGroupSession {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_multicast_group_session::de_get_multicast_group_session_http_response_with_props(status, headers, body)
        }
    }
}
