...
impl AssociateWirelessDeviceWithFuotaTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_wireless_device_with_fuota_task::AssociateWirelessDeviceWithFuotaTaskInput, ::aws_smithy_types::error::operation::BuildError> {
