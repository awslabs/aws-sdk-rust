...
impl TestWirelessDevice {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::test_wireless_device::TestWirelessDeviceInput,
                    ) -> ::std::result::Result<crate::operation::test_wireless_device::TestWirelessDeviceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::test_wireless_device::TestWirelessDeviceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::test_wireless_device::TestWirelessDeviceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::test_wireless_device::TestWirelessDeviceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for TestWirelessDevice {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("TestWirelessDevice");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(TestWirelessDeviceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(TestWirelessDeviceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("TestWirelessDevice")
...
.with_interceptor(TestWirelessDeviceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::test_wireless_device::TestWirelessDeviceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::test_wireless_device::TestWirelessDeviceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::test_wireless_device::TestWirelessDeviceError>::new());
...
#[derive(Debug)]
            struct TestWirelessDeviceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for TestWirelessDeviceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_test_wireless_device::de_test_wireless_device_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_test_wireless_device::de_test_wireless_device_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct TestWirelessDeviceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for TestWirelessDeviceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::test_wireless_device::TestWirelessDeviceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::test_wireless_device::TestWirelessDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/wireless-devices/{Id}/test", Id = id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct TestWirelessDeviceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for TestWirelessDeviceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "TestWirelessDeviceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<TestWirelessDeviceInput>()
                        .ok_or("failed to downcast to TestWirelessDeviceInput")?;
...
pub enum TestWirelessDeviceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-TestWirelessDeviceError) for what information is available for the error.")]
...
impl TestWirelessDeviceError {
    /// Creates the `TestWirelessDeviceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `TestWirelessDeviceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for TestWirelessDeviceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::test_wireless_device::TestWirelessDeviceError {
...
mod _test_wireless_device_output;
