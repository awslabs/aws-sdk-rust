...
impl ListServiceProfilesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_service_profiles::ListServiceProfiles,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServiceProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_service_profiles::de_list_service_profiles_http_response_with_props(status, headers, body)
        }
    }
}
