...
impl Builder {
    ...
    /// use aws_sdk_iotwireless::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_iotwireless::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
