...
pub(crate) fn de_position_coordinate<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<f32>>, aws_smithy_json::deserialize::error::DeserializeError>
