...
pub fn de_get_log_levels_by_resource_types_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_log_levels_by_resource_types::GetLogLevelsByResourceTypesOutput, crate::operation::get_log_levels_by_resource_types::GetLogLevelsByResourceTypesError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_log_levels_by_resource_types_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_log_levels_by_resource_types::GetLogLevelsByResourceTypesOutput, crate::operation::get_log_levels_by_resource_types::GetLogLevelsByResourceTypesError> {
    Ok({
        #[allow(unused_mut)]
