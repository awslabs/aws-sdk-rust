...
pub fn ser_create_device_profile_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_device_profile::CreateDeviceProfileInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
