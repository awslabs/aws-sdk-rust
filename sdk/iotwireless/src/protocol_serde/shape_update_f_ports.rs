...
pub fn ser_update_f_ports(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdateFPorts) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
