...
pub fn ser_lo_ra_wan_update_device(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LoRaWanUpdateDevice) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
