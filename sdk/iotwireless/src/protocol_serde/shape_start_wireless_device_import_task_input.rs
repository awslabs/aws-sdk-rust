...
pub fn ser_start_wireless_device_import_task_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_wireless_device_import_task::StartWirelessDeviceImportTaskInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
