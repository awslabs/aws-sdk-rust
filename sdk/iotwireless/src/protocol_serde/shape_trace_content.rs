...
pub(crate) fn de_trace_content<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::TraceContent>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "WirelessDeviceFrameInfo" => {
                            builder = builder.set_wireless_device_frame_info(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::WirelessDeviceFrameInfo::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LogLevel" => {
                        ...
                        "MulticastFrameInfo" => {
                            builder = builder.set_multicast_frame_info(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::MulticastFrameInfo::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
