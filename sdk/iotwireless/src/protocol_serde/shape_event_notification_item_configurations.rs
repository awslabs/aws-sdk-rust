...
pub(crate) fn de_event_notification_item_configurations<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EventNotificationItemConfigurations>, aws_smithy_json::deserialize::error::DeserializeError>
