...
pub fn de_list_event_configurations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_event_configurations::ListEventConfigurationsOutput, crate::operation::list_event_configurations::ListEventConfigurationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_event_configurations::ListEventConfigurationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_event_configurations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_event_configurations::ListEventConfigurationsOutput, crate::operation::list_event_configurations::ListEventConfigurationsError> {
    Ok({
        #[allow(unused_mut)]
