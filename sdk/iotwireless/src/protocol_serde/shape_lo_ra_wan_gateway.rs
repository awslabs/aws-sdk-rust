            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "JoinEuiFilters" => {
                            builder = builder.set_join_eui_filters(crate::protocol_serde::shape_join_eui_filters::de_join_eui_filters(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "NetIdFilters" => {
                            builder = builder.set_net_id_filters(crate::protocol_serde::shape_net_id_filters::de_net_id_filters(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "SubBands" => {
                            builder = builder.set_sub_bands(crate::protocol_serde::shape_sub_bands::de_sub_bands(tokens, _value, depth + 1)?);
                        }
                        "Beaconing" => {
                            builder = builder.set_beaconing(crate::protocol_serde::shape_beaconing::de_beaconing(tokens, _value, depth + 1)?);
                        }
                        "MaxEirp" => {
                            builder = builder
