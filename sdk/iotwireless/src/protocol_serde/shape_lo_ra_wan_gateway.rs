...
pub fn ser_lo_ra_wan_gateway(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LoRaWanGateway) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_lo_ra_wan_gateway<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LoRaWanGateway>, aws_smithy_json::deserialize::error::DeserializeError>
