...
pub fn ser_create_multicast_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_multicast_group::CreateMulticastGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
