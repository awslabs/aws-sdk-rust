        ...
        for item_4 in var_2 {
            {
                ...
                crate::protocol_serde::shape_gateway_list_item::ser_gateway_list_item(
                    &mut object_5,
                    item_4,
                )?;
                object_5.finish();
...
pub(crate) fn de_participating_gateways<'a, I>(
    ...
    Option<crate::types::ParticipatingGateways>,
                        ...
                        .as_ref()
                    {
                        "DownlinkMode" => {
                            builder = builder.set_downlink_mode(
                                ...
                                .map(|s| {
                                    s.to_unescaped()
                                        .map(|u| crate::types::DownlinkMode::from(u.as_ref()))
                                })
                                .transpose()?,
                            );
                        }
