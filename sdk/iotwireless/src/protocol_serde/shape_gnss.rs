...
pub fn ser_gnss(
    ...
    if let Some(var_1) = &input.capture_time {
        object.key("CaptureTime").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_1).into()));
    }
    if let Some(var_2) = &input.capture_time_accuracy {
        object.key("CaptureTimeAccuracy").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_2).into()));
    }
    ...
    if let Some(var_6) = &input.assist_altitude {
        object.key("AssistAltitude").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_6).into()));
    }
