...
) -> Result<Option<crate::types::WirelessGatewayLogOption>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "Type" => {
                            builder = builder.set_type(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::WirelessGatewayType::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "LogLevel" => {
