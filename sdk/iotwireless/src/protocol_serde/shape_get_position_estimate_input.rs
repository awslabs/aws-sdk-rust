...
pub fn ser_get_position_estimate_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPositionEstimateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
