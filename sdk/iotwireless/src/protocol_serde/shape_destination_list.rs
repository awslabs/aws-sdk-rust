...
pub(crate) fn de_destination_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Destinations>>, aws_smithy_json::deserialize::error::DeserializeError>
