...
pub fn ser_lo_ra_wan_device(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::LoRaWanDevice) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_lo_ra_wan_device<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::LoRaWanDevice>, aws_smithy_json::deserialize::error::DeserializeError>
