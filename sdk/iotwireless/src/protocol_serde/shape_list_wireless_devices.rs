...
pub fn de_list_wireless_devices_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_wireless_devices::ListWirelessDevicesOutput, crate::operation::list_wireless_devices::ListWirelessDevicesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_wireless_devices::ListWirelessDevicesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_wireless_devices_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_wireless_devices::ListWirelessDevicesOutput, crate::operation::list_wireless_devices::ListWirelessDevicesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_wireless_devices::builders::ListWirelessDevicesOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_wireless_devices::de_list_wireless_devices(response.body().as_ref(), output).map_err(crate::operation::list_wireless_devices::ListWirelessDevicesError::unhandled)?;
