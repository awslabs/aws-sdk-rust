...
pub fn ser_update_wireless_device_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateWirelessDeviceInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
