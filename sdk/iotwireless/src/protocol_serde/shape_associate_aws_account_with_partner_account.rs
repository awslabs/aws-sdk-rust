...
pub fn ser_associate_aws_account_with_partner_account_input(
    ...
    crate::protocol_serde::shape_associate_aws_account_with_partner_account_input::ser_associate_aws_account_with_partner_account_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
            ...
            crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::unhandled,
                        )?;
        ...
        "ConflictException" => {
            crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::ConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_aws_account_with_partner_account_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_associate_aws_account_with_partner_account::de_associate_aws_account_with_partner_account(
            _response_body,
            output,
        )
        .map_err(crate::operation::associate_aws_account_with_partner_account::AssociateAwsAccountWithPartnerAccountError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Sidewalk" => {
                    builder = builder.set_sidewalk(crate::protocol_serde::shape_sidewalk_account_info::de_sidewalk_account_info(tokens)?);
                }
