...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError::unhandled)?;
    ...
    let error_code = match generic.code() {
        ...
        None => {
            return Err(
                crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError::unhandled(generic),
            )
        }
    };
            ...
            crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError::AccessDeniedException({
                ...
                let mut tmp = {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output)
                        .map_err(
                            crate::operation::update_event_configuration_by_resource_types::UpdateEventConfigurationByResourceTypesError::unhandled,
                        )?;
...
pub fn ser_update_event_configuration_by_resource_types_input(
    ...
    crate::protocol_serde::shape_update_event_configuration_by_resource_types_input::ser_update_event_configuration_by_resource_types_input_input(
        &mut object,
        input,
    )?;
    object.finish();
