...
pub fn ser_cell_towers(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CellTowers) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
