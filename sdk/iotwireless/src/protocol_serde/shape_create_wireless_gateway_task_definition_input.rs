...
pub fn ser_create_wireless_gateway_task_definition_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateWirelessGatewayTaskDefinitionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
     {
