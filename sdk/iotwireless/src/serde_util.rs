...
pub(crate) fn fuota_task_log_option_correct_errors(
    mut builder: crate::types::builders::FuotaTaskLogOptionBuilder,
) -> crate::types::builders::FuotaTaskLogOptionBuilder {
    if builder.r#type.is_none() {
        builder.r#type = "no value was set".parse::<crate::types::FuotaTaskType>().ok()
    }
...
pub(crate) fn fuota_task_event_log_option_correct_errors(
    mut builder: crate::types::builders::FuotaTaskEventLogOptionBuilder,
) -> crate::types::builders::FuotaTaskEventLogOptionBuilder {
    if builder.event.is_none() {
        builder.event = "no value was set".parse::<crate::types::FuotaTaskEvent>().ok()
    }
    if builder.log_level.is_none() {
        builder.log_level = "no value was set".parse::<crate::types::LogLevel>().ok()
    }
