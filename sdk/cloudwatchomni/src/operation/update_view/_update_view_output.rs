...
impl UpdateViewOutputBuilder {
    ...
    /// - [`name`](crate::operation::update_view::builders::UpdateViewOutputBuilder::name)
    /// - [`r#type`](crate::operation::update_view::builders::UpdateViewOutputBuilder::type)
    /// - [`definition`](crate::operation::update_view::builders::UpdateViewOutputBuilder::definition)
    /// - [`created_at`](crate::operation::update_view::builders::UpdateViewOutputBuilder::created_at)
    /// - [`updated_at`](crate::operation::update_view::builders::UpdateViewOutputBuilder::updated_at)
    /// - [`arn`](crate::operation::update_view::builders::UpdateViewOutputBuilder::arn)
    pub fn build(self) -> ::std::result::Result<crate::operation::update_view::UpdateViewOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::operation::update_view::UpdateViewOutput {
            name: self.name.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "name",
                    "name was not specified but it is required when building UpdateViewOutput",
                )
            })?,
            r#type: self.r#type.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "r#type",
                    "r#type was not specified but it is required when building UpdateViewOutput",
                )
            })?,
            ...
            definition: self.definition.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "definition",
                    "definition was not specified but it is required when building UpdateViewOutput",
                )
            })?,
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building UpdateViewOutput",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building UpdateViewOutput",
                )
            })?,
            arn: self.arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "arn",
                    "arn was not specified but it is required when building UpdateViewOutput",
                )
            })?,
