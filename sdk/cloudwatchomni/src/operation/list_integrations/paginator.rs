...
/// Paginator for [`ListIntegrations`](crate::operation::list_integrations::ListIntegrations)
pub struct ListIntegrationsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_integrations::builders::ListIntegrationsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListIntegrationsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_integrations::paginator::ListIntegrationsPaginatorItems {
        crate::operation::list_integrations::paginator::ListIntegrationsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_integrations::ListIntegrations::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_integrations_output_output_next_token(resp);
...
/// Flattened paginator for `ListIntegrationsPaginator`
///
/// This is created with [`.items()`](ListIntegrationsPaginator::items)
pub struct ListIntegrationsPaginatorItems(ListIntegrationsPaginator);

impl ListIntegrationsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_integrations_output_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
