...
/// Paginator for [`ListAccessGrants`](crate::operation::list_access_grants::ListAccessGrants)
pub struct ListAccessGrantsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_access_grants::builders::ListAccessGrantsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListAccessGrantsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_access_grants::paginator::ListAccessGrantsPaginatorItems {
        crate::operation::list_access_grants::paginator::ListAccessGrantsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_access_grants::ListAccessGrants::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_access_grants_output_output_next_token(resp);
...
/// Flattened paginator for `ListAccessGrantsPaginator`
///
/// This is created with [`.items()`](ListAccessGrantsPaginator::items)
pub struct ListAccessGrantsPaginatorItems(ListAccessGrantsPaginator);

impl ListAccessGrantsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    pub fn send(
        ...
        ::std::result::Result<
            crate::types::AccessGrantSummary,
            ::aws_smithy_runtime_api::client::result::SdkError<
                crate::operation::list_access_grants::ListAccessGrantsError,
                ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
            >,
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_access_grants_output_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
