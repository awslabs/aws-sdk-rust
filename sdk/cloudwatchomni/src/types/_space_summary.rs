...
impl SpaceSummaryBuilder {
    ...
    /// - [`space_arn`](crate::types::builders::SpaceSummaryBuilder::space_arn)
    /// - [`region`](crate::types::builders::SpaceSummaryBuilder::region)
    /// - [`owner_account_id`](crate::types::builders::SpaceSummaryBuilder::owner_account_id)
    /// - [`status`](crate::types::builders::SpaceSummaryBuilder::status)
    /// - [`created_at`](crate::types::builders::SpaceSummaryBuilder::created_at)
    /// - [`updated_at`](crate::types::builders::SpaceSummaryBuilder::updated_at)
    pub fn build(self) -> ::std::result::Result<crate::types::SpaceSummary, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(crate::types::SpaceSummary {
            ...
            space_arn: self.space_arn.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "space_arn",
                    "space_arn was not specified but it is required when building SpaceSummary",
                )
            })?,
            ...
            region: self.region.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "region",
                    "region was not specified but it is required when building SpaceSummary",
                )
            })?,
            owner_account_id: self.owner_account_id.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "owner_account_id",
                    "owner_account_id was not specified but it is required when building SpaceSummary",
                )
            })?,
            status: self.status.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "status",
                    "status was not specified but it is required when building SpaceSummary",
                )
            })?,
            ...
            created_at: self.created_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "created_at",
                    "created_at was not specified but it is required when building SpaceSummary",
                )
            })?,
            updated_at: self.updated_at.ok_or_else(|| {
                ::aws_smithy_types::error::operation::BuildError::missing_field(
                    "updated_at",
                    "updated_at was not specified but it is required when building SpaceSummary",
                )
            })?,
        })
    }
