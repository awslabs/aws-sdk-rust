...
impl ::std::convert::From<&str> for SpaceStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            "MOVING" => SpaceStatus::Moving,
            "SUSPENDED" => SpaceStatus::Suspended,
...
impl ::std::fmt::Display for SpaceStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            SpaceStatus::Active => write!(f, "ACTIVE"),
            SpaceStatus::Moving => write!(f, "MOVING"),
            SpaceStatus::Suspended => write!(f, "SUSPENDED"),
