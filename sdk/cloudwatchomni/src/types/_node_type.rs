...
impl ::std::convert::From<&str> for NodeType {
    fn from(s: &str) -> Self {
        match s {
            "REMOTE_SERVICE" => NodeType::RemoteService,
...
impl NodeType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            NodeType::RemoteService => "REMOTE_SERVICE",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["REMOTE_SERVICE", "RESOURCE", "SERVICE"]
    }
}
...
impl ::std::fmt::Display for NodeType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            NodeType::RemoteService => write!(f, "REMOTE_SERVICE"),
