...
///     IdentityProvider::Iam => { /* ... */ },
///     IdentityProvider::Idc => { /* ... */ },
...
///
/// Identity provider type for a domain.
/// Determines which identity mechanisms are active for authentication.
#[non_exhaustive]
#[derive(
...
impl ::std::convert::From<&str> for IdentityProvider {
    fn from(s: &str) -> Self {
        match s {
            "IAM" => IdentityProvider::Iam,
            "IDC" => IdentityProvider::Idc,
...
impl IdentityProvider {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            IdentityProvider::Iam => "IAM",
            IdentityProvider::Idc => "IDC",
...
impl ::std::fmt::Display for IdentityProvider {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            IdentityProvider::Iam => write!(f, "IAM"),
            IdentityProvider::Idc => write!(f, "IDC"),
