...
pub fn de_get_integration_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_integration_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_get_integration_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_get_integration_input::ser_get_integration_input_input(encoder, input)?;
    }
...
pub(crate) fn de_get_integration(
...
) -> ::std::result::Result<crate::operation::get_integration::builders::GetIntegrationOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    ) -> ::std::result::Result<crate::operation::get_integration::builders::GetIntegrationOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
    {
        builder = match decoder.str()?.as_ref() {
            "integration" => builder.set_integration(Some(crate::protocol_serde::shape_integration::de_integration(decoder, depth + 1)?)),
            _ => {
                decoder.skip()?;
                builder
            }
