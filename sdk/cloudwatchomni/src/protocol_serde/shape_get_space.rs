...
pub fn de_get_space_http_response(
    ...
    Ok({
        ...
        crate::serde_util::get_space_output_output_correct_errors(output).build()
    })
}

pub fn ser_get_space_input(
    input: &crate::operation::get_space::GetSpaceInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        let encoder = &mut encoder;
        crate::protocol_serde::shape_get_space_input::ser_get_space_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::get_space::builders::GetSpaceOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
