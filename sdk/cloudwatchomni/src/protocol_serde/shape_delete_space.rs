...
pub fn de_delete_space_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::delete_space::DeleteSpaceError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_space_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_delete_space_input::ser_delete_space_input_input(encoder, input)?;
    }
