...
pub fn ser_list_domains_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_domains_input::ser_list_domains_input_input(encoder, input)?;
    }
...
pub(crate) fn de_list_domains(
...
) -> ::std::result::Result<crate::operation::list_domains::builders::ListDomainsOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    fn pair(
        ...
        builder = match decoder.str()?.as_ref() {
            "items" => builder.set_items(Some(crate::protocol_serde::shape_domain_summary_list::de_domain_summary_list(
                decoder,
                depth + 1,
            )?)),
            "nextToken" => {
