...
) -> std::result::Result<crate::operation::delete_access_grant::DeleteAccessGrantOutput, crate::operation::delete_access_grant::DeleteAccessGrantError>
{
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::delete_access_grant::DeleteAccessGrantError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::delete_access_grant::DeleteAccessGrantError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::delete_access_grant::DeleteAccessGrantError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::delete_access_grant::DeleteAccessGrantError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::delete_access_grant::DeleteAccessGrantError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::delete_access_grant::DeleteAccessGrantError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        _ => crate::operation::delete_access_grant::DeleteAccessGrantError::generic(generic),
    })
}
...
pub fn ser_delete_access_grant_input(
    input: &crate::operation::delete_access_grant::DeleteAccessGrantInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        let encoder = &mut encoder;
        crate::protocol_serde::shape_delete_access_grant_input::ser_delete_access_grant_input_input(encoder, input)?;
    }
