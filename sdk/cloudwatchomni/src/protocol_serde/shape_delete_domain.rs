...
pub fn de_delete_domain_http_error(
    ...
    Err(match error_code {
        ...
        "ConflictException" => crate::operation::delete_domain::DeleteDomainError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_delete_domain_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_delete_domain_input::ser_delete_domain_input_input(encoder, input)?;
    }
