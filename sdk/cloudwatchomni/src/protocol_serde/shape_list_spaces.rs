...
pub fn de_list_spaces_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::list_spaces::ListSpacesError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn ser_list_spaces_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_spaces_input::ser_list_spaces_input_input(encoder, input)?;
    }
...
pub(crate) fn de_list_spaces(
...
) -> ::std::result::Result<crate::operation::list_spaces::builders::ListSpacesOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    fn pair(
        ...
        builder = match decoder.str()?.as_ref() {
            "items" => builder.set_items(Some(crate::protocol_serde::shape_space_summary_list::de_space_summary_list(
                decoder,
                depth + 1,
            )?)),
            "nextToken" => {
