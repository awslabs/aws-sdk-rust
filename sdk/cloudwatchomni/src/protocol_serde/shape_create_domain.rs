...
pub fn de_create_domain_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_domain_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_create_domain_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_create_domain_input::ser_create_domain_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::create_domain::builders::CreateDomainOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
