...
pub fn de_update_space_http_response(
    ...
    Ok({
        ...
        output = crate::protocol_serde::shape_update_space::de_update_space(_response_body, output)
            .map_err(crate::operation::update_space::UpdateSpaceError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::update_space_output_output_correct_errors(output).build()
    })
}
...
pub fn ser_update_space_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_update_space_input::ser_update_space_input_input(encoder, input)?;
    }
    Ok(::aws_smithy_types::body::SdkBody::from(encoder.into_writer()))
}

pub(crate) fn de_update_space(
    value: &[u8],
    mut builder: crate::operation::update_space::builders::UpdateSpaceOutputBuilder,
) -> ::std::result::Result<crate::operation::update_space::builders::UpdateSpaceOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
