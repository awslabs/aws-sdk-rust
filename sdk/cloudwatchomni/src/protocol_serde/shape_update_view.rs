...
pub fn de_update_view_http_error(
...
) -> std::result::Result<crate::operation::update_view::UpdateViewOutput, crate::operation::update_view::UpdateViewError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::update_view::UpdateViewError::unhandled(generic)),
    };

    let _error_message = generic.message().map(|msg| msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::update_view::UpdateViewError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::update_view::UpdateViewError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::update_view::UpdateViewError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::update_view::UpdateViewError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::update_view::UpdateViewError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::update_view::UpdateViewError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
pub fn de_update_view_http_response(
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_view::builders::UpdateViewOutputBuilder::default();
        output = crate::protocol_serde::shape_update_view::de_update_view(_response_body, output)
            .map_err(crate::operation::update_view::UpdateViewError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::update_view_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_view::UpdateViewError::unhandled)?
    })
}
...
pub fn ser_update_view_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_update_view_input::ser_update_view_input_input(encoder, input)?;
    }
...
) -> ::std::result::Result<crate::operation::update_view::builders::UpdateViewOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
