    ...
    fn pair(
        ...
        builder =
            match decoder.str()?.as_ref() {
                ...
                "conflictType" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                    Ok(builder.set_conflict_type(Some(decoder.string()?)))
                })?,
                "resourceId" => {
                    ::aws_smithy_cbor::decode::set_optional(
                        builder,
                        decoder,
                        |builder, decoder| Ok(builder.set_resource_id(Some(decoder.string()?))),
                    )?
                }
