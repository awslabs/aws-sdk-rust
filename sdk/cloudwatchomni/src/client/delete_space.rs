...
impl super::Client {
    ...
    ///   - [`space_id(impl Into<String>)`](crate::operation::delete_space::builders::DeleteSpaceFluentBuilder::space_id) / [`set_space_id(Option<String>)`](crate::operation::delete_space::builders::DeleteSpaceFluentBuilder::set_space_id):<br>required: **true**<br>The unique ID of the space to delete.<br>
