...
impl ListApplicationInstances {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_application_instances::ListApplicationInstancesInput,
                    ) -> ::std::result::Result<crate::operation::list_application_instances::ListApplicationInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_application_instances::ListApplicationInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_application_instances::ListApplicationInstancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_application_instances::ListApplicationInstancesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListApplicationInstances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListApplicationInstances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListApplicationInstancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListApplicationInstancesResponseDeserializer));
...
.with_interceptor(ListApplicationInstancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_application_instances::ListApplicationInstancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_application_instances::ListApplicationInstancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_application_instances::ListApplicationInstancesError>::new());
...
#[derive(Debug)]
            struct ListApplicationInstancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListApplicationInstancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_application_instances::de_list_application_instances_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_application_instances::de_list_application_instances_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListApplicationInstancesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListApplicationInstancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_application_instances::ListApplicationInstancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_application_instances::ListApplicationInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/application-instances").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_application_instances::ListApplicationInstancesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    let mut query = ::aws_smithy_http::query::Writer::new(output);
    if let ::std::option::Option::Some(inner_1) = &_input.device_id {
         {
            query.push_kv("deviceId", &::aws_smithy_http::query::fmt_string(inner_1));
        }
    }
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListApplicationInstancesEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListApplicationInstancesInput>()
                        .ok_or("failed to downcast to ListApplicationInstancesInput")?;
...
pub enum ListApplicationInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListApplicationInstancesError) for what information is available for the error.")]
...
impl ListApplicationInstancesError {
    /// Creates the `ListApplicationInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListApplicationInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListApplicationInstancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_application_instances::ListApplicationInstancesError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_application_instances::_list_application_instances_output::ListApplicationInstancesOutput;

pub use crate::operation::list_application_instances::_list_application_instances_input::ListApplicationInstancesInput;

mod _list_application_instances_input;

mod _list_application_instances_output;
