    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/devices/{DeviceId}", DeviceId = device_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_device_metadata::UpdateDeviceMetadata::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_device_metadata::UpdateDeviceMetadataError
{
