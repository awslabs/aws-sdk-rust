...
impl UpdateDeviceMetadataInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_device_metadata::UpdateDeviceMetadata,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeviceMetadata {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_device_metadata::de_update_device_metadata_http_response_with_props(status, headers, body)
        }
    }
}
