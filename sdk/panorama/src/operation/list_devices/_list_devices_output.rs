...
impl  ListDevicesOutput  {
    ...
    pub fn devices(&self) -> & [crate::types::Device] {
        use std::ops::Deref; self.devices.deref()
    }
    /// <p>A pagination token that's included if more results are available.</p>
        ...
        ::std::result::Result::Ok(
            crate::operation::list_devices::ListDevicesOutput {
                devices: self.devices
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("devices", "devices was not specified but it is required when building ListDevicesOutput")
                    )?
                ,
