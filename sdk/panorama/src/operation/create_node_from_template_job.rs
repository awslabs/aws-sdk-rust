...
impl CreateNodeFromTemplateJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateNodeFromTemplateJob`](crate::operation::create_node_from_template_job::CreateNodeFromTemplateJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJob, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_node_from_template_job::CreateNodeFromTemplateJob::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateNodeFromTemplateJob {
                type Output = std::result::Result<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobOutput, crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_node_from_template_job::de_create_node_from_template_job_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_node_from_template_job::de_create_node_from_template_job_http_response(response)
                     }
                }
            }
