...
/// Orchestration and serialization glue logic for `CreateNodeFromTemplateJob`.
...
impl CreateNodeFromTemplateJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateNodeFromTemplateJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateNodeFromTemplateJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateNodeFromTemplateJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateNodeFromTemplateJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateNodeFromTemplateJob")
...
.with_interceptor(CreateNodeFromTemplateJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError>::new());
...
#[derive(Debug)]
            struct CreateNodeFromTemplateJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateNodeFromTemplateJobResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_node_from_template_job::de_create_node_from_template_job_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct CreateNodeFromTemplateJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateNodeFromTemplateJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_node_from_template_job::ser_create_node_from_template_job_input(&input)?);
...
#[derive(Debug)]
            struct CreateNodeFromTemplateJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateNodeFromTemplateJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateNodeFromTemplateJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateNodeFromTemplateJobInput>()
                        .ok_or("failed to downcast to CreateNodeFromTemplateJobInput")?;
...
pub enum CreateNodeFromTemplateJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateNodeFromTemplateJobError) for what information is available for the error.")]
...
impl CreateNodeFromTemplateJobError {
    /// Creates the `CreateNodeFromTemplateJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateNodeFromTemplateJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateNodeFromTemplateJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError {
...
mod _create_node_from_template_job_output;
