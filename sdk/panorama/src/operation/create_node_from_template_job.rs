...
impl CreateNodeFromTemplateJobInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_node_from_template_job::CreateNodeFromTemplateJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNodeFromTemplateJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_node_from_template_job::de_create_node_from_template_job_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobError
{
