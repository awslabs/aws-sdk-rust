...
impl DescribeApplicationInstanceDetailsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_application_instance_details::DescribeApplicationInstanceDetails,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_application_instance_details::DescribeApplicationInstanceDetails::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplicationInstanceDetails {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_application_instance_details::de_describe_application_instance_details_http_response_with_props(
                status, headers, body,
            )
        }
    }
