    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/nodes/{NodeId}", NodeId = node_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_node::DescribeNode::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNode {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_node::de_describe_node_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_node::de_describe_node_http_response_with_props(
                status, headers, body,
            )
        }
    }
