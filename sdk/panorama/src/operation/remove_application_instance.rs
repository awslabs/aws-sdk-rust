...
impl RemoveApplicationInstance {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_application_instance::RemoveApplicationInstanceInput,
                    ) -> ::std::result::Result<crate::operation::remove_application_instance::RemoveApplicationInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_application_instance::RemoveApplicationInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_application_instance::RemoveApplicationInstanceError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_application_instance::RemoveApplicationInstanceOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveApplicationInstance {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveApplicationInstance");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveApplicationInstanceRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveApplicationInstanceResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveApplicationInstance")
...
.with_interceptor(RemoveApplicationInstanceEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_application_instance::RemoveApplicationInstanceError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_application_instance::RemoveApplicationInstanceError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_application_instance::RemoveApplicationInstanceError>::new());
...
#[derive(Debug)]
            struct RemoveApplicationInstanceResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveApplicationInstanceResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_application_instance::de_remove_application_instance_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_remove_application_instance::de_remove_application_instance_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RemoveApplicationInstanceRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveApplicationInstanceRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_application_instance::RemoveApplicationInstanceInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_application_instance::RemoveApplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/application-instances/{ApplicationInstanceId}", ApplicationInstanceId = application_instance_id).expect("formatting should succeed");
...
#[derive(Debug)]
            struct RemoveApplicationInstanceEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveApplicationInstanceEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveApplicationInstanceEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveApplicationInstanceInput>()
                        .ok_or("failed to downcast to RemoveApplicationInstanceInput")?;
...
pub enum RemoveApplicationInstanceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveApplicationInstanceError) for what information is available for the error.")]
...
impl RemoveApplicationInstanceError {
    /// Creates the `RemoveApplicationInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveApplicationInstanceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveApplicationInstanceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::remove_application_instance::RemoveApplicationInstanceError {
...
mod _remove_application_instance_output;
