...
impl RemoveApplicationInstanceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_application_instance::RemoveApplicationInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveApplicationInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_application_instance::de_remove_application_instance_http_response_with_props(status, headers, body)
        }
    }
}
