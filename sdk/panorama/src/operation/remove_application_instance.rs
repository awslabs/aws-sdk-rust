...
impl RemoveApplicationInstanceInput {
    /// Consumes the builder and constructs an Operation<[`RemoveApplicationInstance`](crate::operation::remove_application_instance::RemoveApplicationInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::remove_application_instance::RemoveApplicationInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_application_instance::RemoveApplicationInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::remove_application_instance::RemoveApplicationInstance::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RemoveApplicationInstance {
                type Output = std::result::Result<crate::operation::remove_application_instance::RemoveApplicationInstanceOutput, crate::operation::remove_application_instance::RemoveApplicationInstanceError>;
