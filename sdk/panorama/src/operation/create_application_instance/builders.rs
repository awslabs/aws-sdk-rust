...
impl CreateApplicationInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_application_instance::CreateApplicationInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_application_instance::CreateApplicationInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_application_instance::CreateApplicationInstanceOutput, crate::operation::create_application_instance::CreateApplicationInstanceError, Self> {
