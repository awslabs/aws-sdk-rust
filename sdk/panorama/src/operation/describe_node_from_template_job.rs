...
impl DescribeNodeFromTemplateJob {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeNodeFromTemplateJob {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeNodeFromTemplateJob");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeNodeFromTemplateJobRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeNodeFromTemplateJobResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeNodeFromTemplateJob")
...
.with_interceptor(DescribeNodeFromTemplateJobEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>::new());
...
#[derive(Debug)]
            struct DescribeNodeFromTemplateJobResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeNodeFromTemplateJobResponseDeserializer {
...
#[derive(Debug)]
            struct DescribeNodeFromTemplateJobRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeNodeFromTemplateJobRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DescribeNodeFromTemplateJobEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeNodeFromTemplateJobEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeNodeFromTemplateJobEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeNodeFromTemplateJobInput>()
                        .ok_or("failed to downcast to DescribeNodeFromTemplateJobInput")?;
...
pub enum DescribeNodeFromTemplateJobError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeNodeFromTemplateJobError) for what information is available for the error.")]
...
impl DescribeNodeFromTemplateJobError {
    /// Creates the `DescribeNodeFromTemplateJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNodeFromTemplateJobError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeNodeFromTemplateJobError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError {
