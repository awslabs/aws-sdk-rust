    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/packages/template-job/{JobId}", JobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJob::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeNodeFromTemplateJobError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError
{
