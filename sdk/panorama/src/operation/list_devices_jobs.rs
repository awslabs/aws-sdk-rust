...
impl ListDevicesJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_devices_jobs::ListDevicesJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDevicesJobs {
    type Output =
        ::std::result::Result<crate::operation::list_devices_jobs::ListDevicesJobsOutput, crate::operation::list_devices_jobs::ListDevicesJobsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_devices_jobs::de_list_devices_jobs_http_response_with_props(status, headers, body)
        }
    }
}
