...
impl CreateJobForDevicesInput {
    /// Consumes the builder and constructs an Operation<[`CreateJobForDevices`](crate::operation::create_job_for_devices::CreateJobForDevices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_job_for_devices::CreateJobForDevices, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_job_for_devices::CreateJobForDevicesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_job_for_devices::ser_create_job_for_devices_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_job_for_devices::CreateJobForDevices::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateJobForDevices {
                type Output = std::result::Result<crate::operation::create_job_for_devices::CreateJobForDevicesOutput, crate::operation::create_job_for_devices::CreateJobForDevicesError>;
