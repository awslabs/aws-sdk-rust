...
impl DescribeApplicationInstanceDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_instance_details::DescribeApplicationInstanceDetailsInput, ::aws_smithy_types::error::operation::BuildError> {
