...
impl ListNodeFromTemplateJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput, ::aws_smithy_types::error::operation::BuildError> {
