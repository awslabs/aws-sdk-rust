...
impl CreateNodeFromTemplateJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_node_from_template_job::CreateNodeFromTemplateJobInput, ::aws_smithy_types::error::operation::BuildError> {
