...
impl SignalApplicationInstanceNodeInstancesInput {
    /// Consumes the builder and constructs an Operation<[`SignalApplicationInstanceNodeInstances`](crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstances::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SignalApplicationInstanceNodeInstances {
                type Output = std::result::Result<crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstancesOutput, crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstancesError>;
