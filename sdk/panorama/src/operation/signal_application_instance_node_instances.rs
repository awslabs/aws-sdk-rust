...
impl ::aws_smithy_http::response::ParseStrictResponse for SignalApplicationInstanceNodeInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_signal_application_instance_node_instances::de_signal_application_instance_node_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
pub type SignalApplicationInstanceNodeInstancesErrorKind =
...
impl ::aws_smithy_http::result::CreateUnhandledError
    for SignalApplicationInstanceNodeInstancesError
{
