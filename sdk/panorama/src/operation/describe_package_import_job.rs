...
impl DescribePackageImportJobInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_package_import_job::DescribePackageImportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePackageImportJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_package_import_job::de_describe_package_import_job_http_response_with_props(status, headers, body)
        }
    }
}
