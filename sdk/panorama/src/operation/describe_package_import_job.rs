    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/packages/import-jobs/{JobId}", JobId = job_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_package_import_job::DescribePackageImportJob::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_package_import_job::DescribePackageImportJobError
{
