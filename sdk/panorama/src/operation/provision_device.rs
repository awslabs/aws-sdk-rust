...
impl ProvisionDeviceInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::provision_device::ProvisionDevice::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ProvisionDevice {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_provision_device::de_provision_device_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::provision_device::ProvisionDeviceError
{
