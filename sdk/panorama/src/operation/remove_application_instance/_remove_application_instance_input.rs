...
impl RemoveApplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_application_instance::RemoveApplicationInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
