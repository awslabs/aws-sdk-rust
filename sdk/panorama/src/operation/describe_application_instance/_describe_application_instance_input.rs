...
impl DescribeApplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_instance::DescribeApplicationInstanceInput, ::aws_smithy_types::error::operation::BuildError> {
