...
impl DescribeApplicationInstanceInputBuilder {
    ...
    /// - [`application_instance_id`](crate::operation::describe_application_instance::builders::DescribeApplicationInstanceInputBuilder::application_instance_id)
    pub fn build(
        self,
    ) -> ::std::result::Result<
        ...
        ::std::result::Result::Ok(crate::operation::describe_application_instance::DescribeApplicationInstanceInput {
            application_instance_id: self.application_instance_id.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    ...
                    "application_instance_id was not specified but it is required when building DescribeApplicationInstanceInput",
                )
            })?,
        })
    }
