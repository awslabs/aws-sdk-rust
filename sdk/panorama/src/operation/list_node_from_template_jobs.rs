...
impl ListNodeFromTemplateJobsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNodeFromTemplateJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_node_from_template_jobs::de_list_node_from_template_jobs_http_response_with_props(status, headers, body)
        }
    }
}
