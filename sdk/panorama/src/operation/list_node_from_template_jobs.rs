...
impl ListNodeFromTemplateJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListNodeFromTemplateJobs`](crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                write!(output, "/packages/template-job").expect("formatting should succeed");
                Ok(())
            }
            fn uri_query(_input: &crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListNodeFromTemplateJobs {
                type Output = std::result::Result<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsOutput, crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_node_from_template_jobs::de_list_node_from_template_jobs_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_node_from_template_jobs::de_list_node_from_template_jobs_http_response(response)
                     }
                }
            }
