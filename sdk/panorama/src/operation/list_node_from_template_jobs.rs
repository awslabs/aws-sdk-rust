...
/// Orchestration and serialization glue logic for `ListNodeFromTemplateJobs`.
...
impl ListNodeFromTemplateJobs {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput,
                    ) -> ::std::result::Result<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListNodeFromTemplateJobs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListNodeFromTemplateJobs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListNodeFromTemplateJobsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListNodeFromTemplateJobsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListNodeFromTemplateJobs")
...
.with_interceptor(ListNodeFromTemplateJobsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError>::new());
...
#[derive(Debug)]
            struct ListNodeFromTemplateJobsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListNodeFromTemplateJobsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_node_from_template_jobs::de_list_node_from_template_jobs_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListNodeFromTemplateJobsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListNodeFromTemplateJobsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/packages/template-job").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListNodeFromTemplateJobsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListNodeFromTemplateJobsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListNodeFromTemplateJobsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListNodeFromTemplateJobsInput>()
                        .ok_or("failed to downcast to ListNodeFromTemplateJobsInput")?;
...
pub enum ListNodeFromTemplateJobsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListNodeFromTemplateJobsError) for what information is available for the error.")]
...
impl ListNodeFromTemplateJobsError {
    /// Creates the `ListNodeFromTemplateJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListNodeFromTemplateJobsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListNodeFromTemplateJobsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_node_from_template_jobs::ListNodeFromTemplateJobsError {
...
mod _list_node_from_template_jobs_output;
