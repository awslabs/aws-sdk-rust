...
pub struct ProvisionDeviceOutput  {
    ...
    #[doc(hidden)]pub certificates: std::option::Option<aws_smithy_types::Blob>,
    /// <p>The device's IoT thing name.</p>
    #[doc(hidden)]pub iot_thing_name: std::option::Option<std::string::String>,
}
...
pub struct ListPackagesOutput  {
    ...
    #[doc(hidden)]pub packages: std::option::Option<std::vec::Vec<crate::model::PackageListItem>>,
...
pub struct ListPackageImportJobsOutput  {
    ...
    #[doc(hidden)]pub package_import_jobs: std::option::Option<std::vec::Vec<crate::model::PackageImportJob>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListNodeFromTemplateJobsOutput  {
    /// <p>A list of jobs.</p>
    #[doc(hidden)]pub node_from_template_jobs: std::option::Option<std::vec::Vec<crate::model::NodeFromTemplateJob>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListDevicesJobsOutput  {
    /// <p>A list of jobs.</p>
    #[doc(hidden)]pub device_jobs: std::option::Option<std::vec::Vec<crate::model::DeviceJob>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApplicationInstancesOutput  {
    ...
    #[doc(hidden)]pub application_instances: std::option::Option<std::vec::Vec<crate::model::ApplicationInstance>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApplicationInstanceNodeInstancesOutput  {
    ...
    #[doc(hidden)]pub node_instances: std::option::Option<std::vec::Vec<crate::model::NodeInstance>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApplicationInstanceDependenciesOutput  {
    ...
    #[doc(hidden)]pub package_objects: std::option::Option<std::vec::Vec<crate::model::PackageObject>>,
    /// <p>A pagination token that's included if more results are available.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct DescribePackageVersionOutput  {
    ...
    #[doc(hidden)]pub package_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub patch_version: std::option::Option<std::string::String>,
    /// <p>Whether the version is the latest available.</p>
    #[doc(hidden)]pub is_latest_patch: bool,
    ...
    #[doc(hidden)]pub registered_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DescribePackageImportJobOutput  {
    ...
    /// <p>The job's type.</p>
    #[doc(hidden)]pub job_type: std::option::Option<crate::model::PackageImportJobType>,
    /// <p>The job's input config.</p>
    #[doc(hidden)]pub input_config: std::option::Option<crate::model::PackageImportJobInputConfig>,
    /// <p>The job's output config.</p>
    #[doc(hidden)]pub output_config: std::option::Option<crate::model::PackageImportJobOutputConfig>,
    /// <p>The job's output.</p>
    #[doc(hidden)]pub output: std::option::Option<crate::model::PackageImportJobOutput>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::PackageImportJobStatus>,
    /// <p>The job's status message.</p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
    /// <p>The job's tags.</p>
    #[doc(hidden)]pub job_tags: std::option::Option<std::vec::Vec<crate::model::JobResourceTags>>,
}
...
pub struct DescribePackageOutput  {
    ...
    #[doc(hidden)]pub storage_location: std::option::Option<crate::model::StorageLocation>,
    /// <p>ARNs of accounts that have read access to the package.</p>
    #[doc(hidden)]pub read_access_principal_arns: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>ARNs of accounts that have write access to the package.</p>
    #[doc(hidden)]pub write_access_principal_arns: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl  std::fmt::Debug for DescribePackageOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("read_access_principal_arns", &self.read_access_principal_arns);
        formatter.field("write_access_principal_arns", &self.write_access_principal_arns);
        formatter.field("created_time", &self.created_time);
        formatter.field("tags", &self.tags);
        formatter.finish()
    }
...
pub struct DescribeNodeFromTemplateJobOutput  {
    ...
    #[doc(hidden)]pub job_id: std::option::Option<std::string::String>,
    /// <p>The job's status.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::NodeFromTemplateJobStatus>,
    /// <p>The job's status message.</p>
    #[doc(hidden)]pub status_message: std::option::Option<std::string::String>,
    /// <p>When the job was created.</p>
    #[doc(hidden)]pub created_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub output_package_name: std::option::Option<std::string::String>,
    /// <p>The job's output package version.</p>
    #[doc(hidden)]pub output_package_version: std::option::Option<std::string::String>,
    /// <p>The node's name.</p>
    #[doc(hidden)]pub node_name: std::option::Option<std::string::String>,
    /// <p>The node's description.</p>
    #[doc(hidden)]pub node_description: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub template_parameters: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The job's tags.</p>
    #[doc(hidden)]pub job_tags: std::option::Option<std::vec::Vec<crate::model::JobResourceTags>>,
}
...
pub struct DescribeNodeOutput  {
    ...
    #[doc(hidden)]pub category: std::option::Option<crate::model::NodeCategory>,
    ...
    #[doc(hidden)]pub node_interface: std::option::Option<crate::model::NodeInterface>,
...
pub struct DescribeDeviceJobOutput  {
    ...
    #[doc(hidden)]pub image_version: std::option::Option<std::string::String>,
    /// <p>The job's status.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::UpdateProgress>,
    /// <p>When the job was created.</p>
    #[doc(hidden)]pub created_time: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct DescribeDeviceOutput  {
    ...
    #[doc(hidden)]pub description: std::option::Option<std::string::String>,
    /// <p>The device's type.</p>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::DeviceType>,
    /// <p>The device's connection status.</p>
    #[doc(hidden)]pub device_connection_status: std::option::Option<crate::model::DeviceConnectionStatus>,
    /// <p>When the device was created.</p>
    #[doc(hidden)]pub created_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The device's provisioning status.</p>
    #[doc(hidden)]pub provisioning_status: std::option::Option<crate::model::DeviceStatus>,
    /// <p>The latest software version available for the device.</p>
    #[doc(hidden)]pub latest_software: std::option::Option<std::string::String>,
    /// <p>The device's current software version.</p>
    #[doc(hidden)]pub current_software: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub networking_configuration: std::option::Option<crate::model::NetworkPayload>,
    /// <p>The device's networking status.</p>
    #[doc(hidden)]pub current_networking_status: std::option::Option<crate::model::NetworkStatus>,
    /// <p>The device's lease expiration time.</p>
    #[doc(hidden)]pub lease_expiration_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>Beta software releases available for the device.</p>
    #[doc(hidden)]pub alternate_softwares: std::option::Option<std::vec::Vec<crate::model::AlternateSoftwareMetadata>>,
    /// <p>The most recent beta software release.</p>
    #[doc(hidden)]pub latest_alternate_software: std::option::Option<std::string::String>,
    /// <p>The device's maker.</p>
    #[doc(hidden)]pub brand: std::option::Option<crate::model::DeviceBrand>,
    /// <p>A device's latest job. Includes the target image version, and the job status.</p>
    #[doc(hidden)]pub latest_device_job: std::option::Option<crate::model::LatestDeviceJob>,
    /// <p>A device's aggregated status. Including the device's connection status, provisioning status, and lease status.</p>
    #[doc(hidden)]pub device_aggregated_status: std::option::Option<crate::model::DeviceAggregatedStatus>,
}
...
pub struct DescribeApplicationInstanceDetailsOutput  {
    ...
    #[doc(hidden)]pub default_runtime_context_device: std::option::Option<std::string::String>,
    /// <p>The application instance's configuration manifest.</p>
    #[doc(hidden)]pub manifest_payload: std::option::Option<crate::model::ManifestPayload>,
    /// <p>Parameter overrides for the configuration manifest.</p>
    #[doc(hidden)]pub manifest_overrides_payload: std::option::Option<crate::model::ManifestOverridesPayload>,
    /// <p>The ID of the application instance that this instance replaced.</p>
    #[doc(hidden)]pub application_instance_id_to_replace: std::option::Option<std::string::String>,
    /// <p>When the application instance was created.</p>
    #[doc(hidden)]pub created_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The application instance's ID.</p>
    #[doc(hidden)]pub application_instance_id: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for DescribeApplicationInstanceDetailsOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("name", &self.name);
        formatter.field("description", &self.description);
        formatter.field("default_runtime_context_device", &self.default_runtime_context_device);
        formatter.field("manifest_payload", &self.manifest_payload);
        formatter.field("manifest_overrides_payload", &self.manifest_overrides_payload);
        formatter.field("application_instance_id_to_replace", &self.application_instance_id_to_replace);
        formatter.field("created_time", &self.created_time);
...
pub struct DescribeApplicationInstanceOutput  {
    ...
    #[doc(hidden)]pub default_runtime_context_device_name: std::option::Option<std::string::String>,
    /// <p>The ID of the application instance that this instance replaced.</p>
    #[doc(hidden)]pub application_instance_id_to_replace: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ApplicationInstanceStatus>,
    /// <p>The application instance's health status.</p>
    #[doc(hidden)]pub health_status: std::option::Option<crate::model::ApplicationInstanceHealthStatus>,
...
impl  std::fmt::Debug for DescribeApplicationInstanceOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("description", &self.description);
        formatter.field("default_runtime_context_device", &self.default_runtime_context_device);
        formatter.field("default_runtime_context_device_name", &self.default_runtime_context_device_name);
        formatter.field("application_instance_id_to_replace", &self.application_instance_id_to_replace);
