...
pub fn ser_create_node_from_template_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateNodeFromTemplateJobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
