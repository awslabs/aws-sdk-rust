...
pub fn de_list_application_instances_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_application_instances::ListApplicationInstancesOutput, crate::operation::list_application_instances::ListApplicationInstancesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_application_instances::ListApplicationInstancesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_application_instances_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_application_instances::ListApplicationInstancesOutput, crate::operation::list_application_instances::ListApplicationInstancesError> {
    Ok({
        #[allow(unused_mut)]
