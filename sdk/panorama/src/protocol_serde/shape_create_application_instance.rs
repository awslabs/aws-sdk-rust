...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::create_application_instance::CreateApplicationInstanceError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "ServiceQuotaExceededException" => {
            crate::operation::create_application_instance::CreateApplicationInstanceError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::create_application_instance_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_application_instance::CreateApplicationInstanceError::unhandled)?
    })
}
