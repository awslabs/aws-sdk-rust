...
pub fn ser_manifest_payload(
    ...
    match input {
        crate::types::ManifestPayload::PayloadData(inner) => {
            object_6.key("PayloadData").string(inner.as_str());
        }
...
) -> Result<Option<crate::types::ManifestPayload>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    variant = match key.to_unescaped()?.as_ref() {
                        "PayloadData" => Some(crate::types::ManifestPayload::PayloadData(
                            ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                ...
                                .transpose()?
                                .ok_or_else(|| {
                                    ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'PayloadData' cannot be null")
                                })?,
                        )),
                        _ => {
