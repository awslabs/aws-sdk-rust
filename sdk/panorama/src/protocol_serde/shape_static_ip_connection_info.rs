...
pub(crate) fn de_static_ip_connection_info<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::StaticIpConnectionInfo>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Dns" => {
                            builder = builder.set_dns(crate::protocol_serde::shape_dns_list::de_dns_list(tokens, _value)?);
                        }
                        "DefaultGateway" => {
