...
pub(crate) fn de_package_import_job_output_config<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::PackageImportJobOutputConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "PackageVersionOutputConfig" => {
                            builder = builder.set_package_version_output_config(
                                crate::protocol_serde::shape_package_version_output_config::de_package_version_output_config(tokens, _value)?,
                            );
                        }
