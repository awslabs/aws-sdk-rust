...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_node_from_template_job_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobOutput, crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError> {
    Ok({
        #[allow(unused_mut)]
