...
pub fn ser_create_job_for_devices_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateJobForDevicesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
