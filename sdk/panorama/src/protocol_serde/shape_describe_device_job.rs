...
pub fn de_describe_device_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeDeviceJobOutput, crate::error::DescribeDeviceJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeDeviceJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_device_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeDeviceJobOutput, crate::error::DescribeDeviceJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_device_job_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_device_job::de_describe_device_job(response.body().as_ref(), output).map_err(crate::error::DescribeDeviceJobError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_device_job(value: &[u8], mut builder: crate::output::describe_device_job_output::Builder) -> Result<crate::output::describe_device_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
