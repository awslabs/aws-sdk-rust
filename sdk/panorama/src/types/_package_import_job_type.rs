...
impl ::std::convert::From<&str> for PackageImportJobType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => PackageImportJobType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for PackageImportJobType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(PackageImportJobType::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for PackageImportJobType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
