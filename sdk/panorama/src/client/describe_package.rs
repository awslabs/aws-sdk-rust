...
impl super::Client {
    ...
    ///   - [`package_id(impl Into<String>)`](crate::operation::describe_package::builders::DescribePackageFluentBuilder::package_id) / [`set_package_id(impl Into<String>)`](crate::operation::describe_package::builders::DescribePackageFluentBuilder::set_package_id):<br>required: **true**<br><p>The package's ID.</p><br>
    /// - On success, responds with [`DescribePackageOutput`](crate::operation::describe_package::DescribePackageOutput) with field(s):
    ///   - [`package_id(String)`](crate::operation::describe_package::DescribePackageOutput::package_id): <p>The package's ID.</p>
