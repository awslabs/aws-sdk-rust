...
impl super::Client {
    ...
    ///   - [`package_id(impl Into<String>)`](crate::operation::describe_package::builders::DescribePackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::describe_package::builders::DescribePackageFluentBuilder::set_package_id):<br>required: **true**<br><p>The package's ID.</p><br>
