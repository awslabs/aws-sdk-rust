...
impl super::Client {
    ...
    ///   - [`package_id(impl Into<String>)`](crate::operation::delete_package::builders::DeletePackageFluentBuilder::package_id) / [`set_package_id(impl Into<String>)`](crate::operation::delete_package::builders::DeletePackageFluentBuilder::set_package_id):<br>required: **true**<br><p>The package's ID.</p><br>
