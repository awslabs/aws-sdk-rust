...
impl super::Client {
    ...
    ///   - [`device_ids(impl Into<String>)`](crate::operation::create_job_for_devices::builders::CreateJobForDevicesFluentBuilder::device_ids) / [`set_device_ids(Vec<String>)`](crate::operation::create_job_for_devices::builders::CreateJobForDevicesFluentBuilder::set_device_ids):<br>required: **true**<br><p>ID of target device.</p><br>
    ...
    ///   - [`job_type(JobType)`](crate::operation::create_job_for_devices::builders::CreateJobForDevicesFluentBuilder::job_type) / [`set_job_type(JobType)`](crate::operation::create_job_for_devices::builders::CreateJobForDevicesFluentBuilder::set_job_type):<br>required: **true**<br><p>The type of job to run.</p><br>
