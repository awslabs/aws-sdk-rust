...
impl super::Client {
    ...
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::list_application_instances::builders::ListApplicationInstancesFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::list_application_instances::builders::ListApplicationInstancesFluentBuilder::set_device_id): <p>The application instances' device ID.</p>
