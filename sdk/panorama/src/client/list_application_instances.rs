...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_application_instances::builders::ListApplicationInstancesFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_application_instances::builders::ListApplicationInstancesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of application instances to return in one page of results.</p><br>
