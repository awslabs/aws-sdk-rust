...
impl super::Client {
    ...
    ///   - [`device_id(impl Into<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::device_id) / [`set_device_id(impl Into<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::set_device_id):<br>required: **true**<br><p>The device's ID.</p><br>
