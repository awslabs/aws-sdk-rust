...
impl super::Client {
    ...
    ///   - [`template_parameters(impl Into<String>, impl Into<String>)`](crate::operation::create_node_from_template_job::builders::CreateNodeFromTemplateJobFluentBuilder::template_parameters) / [`set_template_parameters(Option<HashMap<String, String>>)`](crate::operation::create_node_from_template_job::builders::CreateNodeFromTemplateJobFluentBuilder::set_template_parameters): <p>Template parameters for the node.</p>
    ///   - [`job_tags(JobResourceTags)`](crate::operation::create_node_from_template_job::builders::CreateNodeFromTemplateJobFluentBuilder::job_tags) / [`set_job_tags(Option<Vec<JobResourceTags>>)`](crate::operation::create_node_from_template_job::builders::CreateNodeFromTemplateJobFluentBuilder::set_job_tags): <p>Tags for the job.</p>
