...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::set_name):<br>required: **true**<br><p>A name for the device.</p><br>
