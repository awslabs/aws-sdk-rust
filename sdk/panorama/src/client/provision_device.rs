...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::set_name): <p>A name for the device.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::provision_device::builders::ProvisionDeviceFluentBuilder::set_description): <p>A description for the device.</p>
