...
impl super::Client {
    ...
    ///   - [`package_name(impl Into<String>)`](crate::operation::create_package::builders::CreatePackageFluentBuilder::package_name) / [`set_package_name(impl Into<String>)`](crate::operation::create_package::builders::CreatePackageFluentBuilder::set_package_name):<br>required: **true**<br><p>A name for the package.</p><br>
