...
impl super::Client {
    ...
    ///   - [`application_instance_id(impl Into<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::application_instance_id) / [`set_application_instance_id(impl Into<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::set_application_instance_id):<br>required: **true**<br><p>The application instance's ID.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of application instance dependencies to return in one page of results.</p><br>
