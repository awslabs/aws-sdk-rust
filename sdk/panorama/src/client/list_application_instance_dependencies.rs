...
impl super::Client {
    ...
    ///   - [`application_instance_id(impl ::std::convert::Into<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::application_instance_id) / [`set_application_instance_id(Option<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::set_application_instance_id): <p>The application instance's ID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_application_instance_dependencies::builders::ListApplicationInstanceDependenciesFluentBuilder::set_next_token): <p>Specify the pagination token from a previous request to retrieve the next page of results.</p>
