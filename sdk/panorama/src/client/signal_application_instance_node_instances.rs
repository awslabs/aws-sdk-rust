...
impl super::Client {
    ...
    ///   - [`application_instance_id(impl Into<String>)`](crate::operation::signal_application_instance_node_instances::builders::SignalApplicationInstanceNodeInstancesFluentBuilder::application_instance_id) / [`set_application_instance_id(impl Into<String>)`](crate::operation::signal_application_instance_node_instances::builders::SignalApplicationInstanceNodeInstancesFluentBuilder::set_application_instance_id):<br>required: **true**<br><p>An application instance ID.</p><br>
    ///   - [`node_signals(NodeSignal)`](crate::operation::signal_application_instance_node_instances::builders::SignalApplicationInstanceNodeInstancesFluentBuilder::node_signals) / [`set_node_signals(Vec<NodeSignal>)`](crate::operation::signal_application_instance_node_instances::builders::SignalApplicationInstanceNodeInstancesFluentBuilder::set_node_signals):<br>required: **true**<br><p>A list of signals.</p><br>
    ...
    ///   - [`application_instance_id(String)`](crate::operation::signal_application_instance_node_instances::SignalApplicationInstanceNodeInstancesOutput::application_instance_id): <p>An application instance ID.</p>
