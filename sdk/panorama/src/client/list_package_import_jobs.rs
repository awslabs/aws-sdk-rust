...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_package_import_jobs::builders::ListPackageImportJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_package_import_jobs::builders::ListPackageImportJobsFluentBuilder::set_next_token):<br>required: **false**<br><p>Specify the pagination token from a previous request to retrieve the next page of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_package_import_jobs::builders::ListPackageImportJobsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_package_import_jobs::builders::ListPackageImportJobsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of package import jobs to return in one page of results.</p><br>
    ...
    ///   - [`package_import_jobs(Vec::<PackageImportJob>)`](crate::operation::list_package_import_jobs::ListPackageImportJobsOutput::package_import_jobs): <p>A list of package import jobs.</p>
