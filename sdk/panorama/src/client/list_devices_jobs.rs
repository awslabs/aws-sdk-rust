...
impl super::Client {
    ...
    ///   - [`device_id(impl Into<String>)`](crate::operation::list_devices_jobs::builders::ListDevicesJobsFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::list_devices_jobs::builders::ListDevicesJobsFluentBuilder::set_device_id):<br>required: **false**<br><p>Filter results by the job's target device ID.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_devices_jobs::builders::ListDevicesJobsFluentBuilder::max_results) / [`set_max_results(i32)`](crate::operation::list_devices_jobs::builders::ListDevicesJobsFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of device jobs to return in one page of results.</p><br>
