...
impl super::Client {
    ...
    ///   - [`job_id(impl Into<String>)`](crate::operation::describe_device_job::builders::DescribeDeviceJobFluentBuilder::job_id) / [`set_job_id(Option<String>)`](crate::operation::describe_device_job::builders::DescribeDeviceJobFluentBuilder::set_job_id):<br>required: **true**<br><p>The job's ID.</p><br>
