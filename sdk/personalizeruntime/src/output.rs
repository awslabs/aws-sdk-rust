...
pub struct GetRecommendationsOutput  {
    ...
    #[doc(hidden)]pub item_list: std::option::Option<std::vec::Vec<crate::model::PredictedItem>>,
    /// <p>The ID of the recommendation.</p>
    #[doc(hidden)]pub recommendation_id: std::option::Option<std::string::String>,
}
...
pub mod get_recommendations_output {
    ...
    impl Builder {
        ...
        /// <p>A list of recommendations sorted in descending order by prediction score. There can be a maximum of 500 items in the list.</p>
        pub fn set_item_list(mut self, input: std::option::Option<std::vec::Vec<crate::model::PredictedItem>>) -> Self {
...
pub struct GetPersonalizedRankingOutput  {
    ...
    #[doc(hidden)]pub personalized_ranking: std::option::Option<std::vec::Vec<crate::model::PredictedItem>>,
    /// <p>The ID of the recommendation.</p>
    #[doc(hidden)]pub recommendation_id: std::option::Option<std::string::String>,
}
...
pub mod get_personalized_ranking_output {
    ...
    impl Builder {
        ...
        /// <p>A list of items in order of most likely interest to the user. The maximum is 500.</p>
        pub fn set_personalized_ranking(mut self, input: std::option::Option<std::vec::Vec<crate::model::PredictedItem>>) -> Self {
