...
pub struct PredictedItem  {
    ...
    #[doc(hidden)]pub item_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub score: std::option::Option<f64>,
    /// <p>The name of the promotion that included the predicted item.</p>
    #[doc(hidden)]pub promotion_name: std::option::Option<std::string::String>,
}
impl PredictedItem {
    /// <p>The recommended item ID.</p>
...
pub struct Promotion  {
    ...
    #[doc(hidden)]pub percent_promoted_items: i32,
    ...
    #[doc(hidden)]pub filter_values: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl Promotion {
    /// <p>The name of the promotion.</p>
