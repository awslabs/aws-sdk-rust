...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_action_recommendations::GetActionRecommendationsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_action_recommendations::GetActionRecommendationsError, R>) -> Self {
        match err {
...
impl From<crate::operation::get_action_recommendations::GetActionRecommendationsError> for Error {
    fn from(err: crate::operation::get_action_recommendations::GetActionRecommendationsError) -> Self {
        match err {
            crate::operation::get_action_recommendations::GetActionRecommendationsError::InvalidInputException(inner) => Error::InvalidInputException(inner),
            crate::operation::get_action_recommendations::GetActionRecommendationsError::ResourceNotFoundException(inner) => Error::ResourceNotFoundException(inner),
            crate::operation::get_action_recommendations::GetActionRecommendationsError::Unhandled(inner) => Error::Unhandled(inner),
        }
    }
}
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_personalized_ranking::GetPersonalizedRankingError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_personalized_ranking::GetPersonalizedRankingError, R>) -> Self {
        match err {
            ::aws_smithy_runtime_api::client::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            crate::error::sealed_unhandled::Unhandled {
