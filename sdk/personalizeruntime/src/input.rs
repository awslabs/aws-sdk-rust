...
pub mod get_personalized_ranking_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetPersonalizedRankingInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl GetPersonalizedRankingInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetPersonalizedRanking, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::GetPersonalizedRankingInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::operation_ser::serialize_operation_crate_operation_get_personalized_ranking(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetPersonalizedRanking::new())
