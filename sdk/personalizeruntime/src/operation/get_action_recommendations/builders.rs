...
impl GetActionRecommendationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_action_recommendations::GetActionRecommendationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_action_recommendations::GetActionRecommendationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_action_recommendations::GetActionRecommendationsOutput, crate::operation::get_action_recommendations::GetActionRecommendationsError, Self> {
