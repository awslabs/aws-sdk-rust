...
impl GetRecommendationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_recommendations::ser_get_recommendations_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_recommendations::GetRecommendations::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRecommendations", "personalizeruntime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRecommendations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_recommendations::de_get_recommendations_http_response_with_props(status, headers, body)
        }
    }
}
