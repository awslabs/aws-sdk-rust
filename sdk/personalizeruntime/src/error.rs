...
impl std::fmt::Display for GetRecommendationsError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetRecommendationsErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
...
impl GetRecommendationsError {
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetRecommendationsErrorKind::InvalidInputException(_))
    }
...
impl std::fmt::Display for GetPersonalizedRankingError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            GetPersonalizedRankingErrorKind::InvalidInputException(_inner) =>
            _inner.fmt(f)
            ,
            GetPersonalizedRankingErrorKind::ResourceNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
            GetPersonalizedRankingErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GetPersonalizedRankingError {
    /// Creates a new `GetPersonalizedRankingError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: GetPersonalizedRankingErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(&self.kind, GetPersonalizedRankingErrorKind::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetPersonalizedRankingErrorKind::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(&self.kind, GetPersonalizedRankingErrorKind::ResourceNotFoundException(_))
    }
}
