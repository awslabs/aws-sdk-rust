...
pub fn ser_get_personalized_ranking_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetPersonalizedRankingInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
