...
pub fn serialize_structure_get_personalized_ranking_input(
...
pub fn serialize_structure_get_recommendations_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.num_results != 0 {
        object.key("numResults").number(
            ...
            smithy_types::Number::NegInt((input.num_results).into()),
        );
    }
