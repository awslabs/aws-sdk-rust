...
pub(crate) fn reflens_get_instrumentation_configuration_status_output_output_next_token(
    input: &crate::operation::get_instrumentation_configuration_status::GetInstrumentationConfigurationStatusOutput,
...
pub(crate) fn reflens_list_entity_events_output_output_next_token(
    input: &crate::operation::list_entity_events::ListEntityEventsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn reflens_list_instrumentation_configurations_output_output_next_token(
    input: &crate::operation::list_instrumentation_configurations::ListInstrumentationConfigurationsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_get_instrumentation_configuration_status_output_output_events(
    input: crate::operation::get_instrumentation_configuration_status::GetInstrumentationConfigurationStatusOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::InstrumentationStatusEvent>> {
    let input = input.events;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_entity_events_output_output_change_events(
    input: crate::operation::list_entity_events::ListEntityEventsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ChangeEvent>> {
    let input = input.change_events;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_instrumentation_configurations_output_output_latest_configurations(
    input: crate::operation::list_instrumentation_configurations::ListInstrumentationConfigurationsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::InstrumentationConfigurationWithoutServiceEnv>> {
    let input = input.latest_configurations?;
    ::std::option::Option::Some(input)
}
