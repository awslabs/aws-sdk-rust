...
impl super::Client {
    ...
    ///   - [`sli_config(ServiceLevelIndicatorConfig)`](crate::operation::update_service_level_objective::builders::UpdateServiceLevelObjectiveFluentBuilder::sli_config) / [`set_sli_config(Option<ServiceLevelIndicatorConfig>)`](crate::operation::update_service_level_objective::builders::UpdateServiceLevelObjectiveFluentBuilder::set_sli_config):<br>required: **false**<br><p>A structure that contains information about what performance metric this SLO will monitor.</p><br>
