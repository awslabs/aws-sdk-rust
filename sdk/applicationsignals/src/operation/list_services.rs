...
impl ListServices {
    ...
    > {
        ...
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            ...
            .instrument(::tracing::debug_span!(
                "applicationsignals.ListServices",
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("applicationsignals", "ListServices", input, runtime_plugins, stop_point)
            .await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/services").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_services::ListServicesInput,
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.include_linked_accounts {
                    {
                        query.push_kv("IncludeLinkedAccounts", ::aws_smithy_types::primitive::Encoder::from(*inner_5).encode());
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.aws_account_id {
                    {
                        query.push_kv("AwsAccountId", &::aws_smithy_http::query::fmt_string(inner_6));
                    }
                }
                ::std::result::Result::Ok(())
            }
