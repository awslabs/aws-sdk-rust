...
pub struct ListAuditFindingsInput {
    ...
    pub detail_level: ::std::option::Option<crate::types::DetailLevel>,
...
impl ListAuditFindingsInput {
    ...
    /// <p>The level of details of the audit findings. Supported values: <code>BRIEF</code>, <code>DETAILED</code>.</p>
    pub fn detail_level(&self) -> ::std::option::Option<&crate::types::DetailLevel> {
...
pub struct ListAuditFindingsInputBuilder {
    ...
    pub(crate) detail_level: ::std::option::Option<crate::types::DetailLevel>,
