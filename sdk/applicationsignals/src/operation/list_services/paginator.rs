...
impl ListServicesPaginator {
    ...
    ///
    /// This paginator automatically flattens results using `service_summaries`. Queries to the underlying service
...
impl ListServicesPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_services_output_output_service_summaries(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
