...
pub use crate::operation::list_service_dependencies::_list_service_dependencies_input::ListServiceDependenciesInputBuilder;

pub use crate::operation::list_service_dependencies::_list_service_dependencies_output::ListServiceDependenciesOutputBuilder;

impl crate::operation::list_service_dependencies::builders::ListServiceDependenciesInputBuilder {
    ...
    pub async fn send_with(
        ...
        >,
    > {
        let mut fluent_builder = client.list_service_dependencies();
        fluent_builder.inner = self;
        fluent_builder.send().await
    }
}
/// Fluent builder constructing a request to `ListServiceDependencies`.
///
...
pub struct ListServiceDependenciesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::list_service_dependencies::builders::ListServiceDependenciesInputBuilder,
...
impl
    crate::client::customize::internal::CustomizableSend<
        crate::operation::list_service_dependencies::ListServiceDependenciesOutput,
        crate::operation::list_service_dependencies::ListServiceDependenciesError,
    > for ListServiceDependenciesFluentBuilder
{
    fn send(
        self,
...
impl ListServiceDependenciesFluentBuilder {
    /// Creates a new `ListServiceDependenciesFluentBuilder`.
    ...
    /// Access the ListServiceDependencies as a reference.
    pub fn as_input(&self) -> &crate::operation::list_service_dependencies::builders::ListServiceDependenciesInputBuilder {
        &self.inner
    }
    ...
    > {
        ...
        crate::operation::list_service_dependencies::ListServiceDependencies::orchestrate(&runtime_plugins, input).await
    }
    ...
    ///
    /// Paginators are used by calling [`send().await`](crate::operation::list_service_dependencies::paginator::ListServiceDependenciesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    pub fn into_paginator(self) -> crate::operation::list_service_dependencies::paginator::ListServiceDependenciesPaginator {
        crate::operation::list_service_dependencies::paginator::ListServiceDependenciesPaginator::new(self.handle, self.inner)
    }
