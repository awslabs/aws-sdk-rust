...
impl SsmAutomationBuilder {
    ...
    /// <p>The key-value pair to resolve dynamic parameter values when processing a Systems Manager Automation runbook.</p>
    pub fn get_dynamic_parameters(&self) -> &::std::option::Option<::std::collections::HashMap::<::std::string::String, crate::types::DynamicSsmParameterValue>> {
        ...
        ::std::result::Result::Ok(
            crate::types::SsmAutomation {
                role_arn: self.role_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("role_arn", "role_arn was not specified but it is required when building SsmAutomation")
                    )?
                ,
                document_name: self.document_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("document_name", "document_name was not specified but it is required when building SsmAutomation")
                    )?
                ,
