...
impl Action {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`SsmAutomation`](crate::model::Action::SsmAutomation), extracting the inner [`SsmAutomation`](crate::model::SsmAutomation).
...
pub struct SsmAutomation  {
    ...
    #[doc(hidden)]pub target_account: std::option::Option<crate::model::SsmTargetAccount>,
    /// <p>The key-value pair parameters to use when running the automation document.</p>
    #[doc(hidden)]pub parameters: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<std::string::String>>>,
    /// <p>The key-value pair to resolve dynamic parameter values when processing a Systems Manager Automation runbook.</p>
    #[doc(hidden)]pub dynamic_parameters: std::option::Option<std::collections::HashMap<std::string::String, crate::model::DynamicSsmParameterValue>>,
}
impl SsmAutomation {
    /// <p>The Amazon Resource Name (ARN) of the role that the automation document will assume when running commands.</p>
...
impl DynamicSsmParameterValue {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`Variable`](crate::model::DynamicSsmParameterValue::Variable), extracting the inner [`VariableType`](crate::model::VariableType).
    /// Returns `Err(&Self)` if it can't be converted.
...
impl NotificationTargetItem {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`SnsTopicArn`](crate::model::NotificationTargetItem::SnsTopicArn), extracting the inner [`String`](std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
...
pub struct AddRegionAction  {
    ...
    #[doc(hidden)]pub sse_kms_key_id: std::option::Option<std::string::String>,
}
...
pub struct ItemIdentifier  {
    ...
    #[doc(hidden)]pub value: std::option::Option<crate::model::ItemValue>,
...
impl ItemType {
    ...
    pub fn values() -> &'static [&'static str] {
        &[
            "ANALYSIS", "ATTACHMENT", "AUTOMATION", "INCIDENT", "INVOLVED_RESOURCE", "METRIC", "OTHER", "PARENT"
        ]
    }
}
...
pub struct RelatedItem  {
    /// <p>Details about the related item.</p>
    #[doc(hidden)]pub identifier: std::option::Option<crate::model::ItemIdentifier>,
...
pub struct TriggerDetails  {
    ...
    #[doc(hidden)]pub trigger_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub raw_data: std::option::Option<std::string::String>,
}
impl TriggerDetails {
    /// <p>Identifies the service that sourced the event. All events sourced from within Amazon Web Services begin with "<code>aws.</code>" Customer-generated events can have any value here, as long as it doesn't begin with "<code>aws.</code>" We recommend the use of Java package-name style reverse domain-name strings. </p>
...
pub struct EventSummary  {
    ...
    #[doc(hidden)]pub incident_record_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub event_updated_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct IncidentRecordSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::IncidentRecordStatus>,
    /// <p>Defines the impact to customers and applications.</p>
    #[doc(hidden)]pub impact: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub resolved_time: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>What caused Incident Manager to create the incident.</p>
    #[doc(hidden)]pub incident_record_source: std::option::Option<crate::model::IncidentRecordSource>,
}
...
pub struct TimelineEvent  {
    ...
    #[doc(hidden)]pub event_data: std::option::Option<std::string::String>,
}
impl TimelineEvent {
    /// <p>The Amazon Resource Name (ARN) of the incident that the event occurred during.</p>
    pub fn incident_record_arn(&self) -> std::option::Option<& str> {
...
pub struct IncidentTemplate  {
    ...
    #[doc(hidden)]pub dedupe_string: std::option::Option<std::string::String>,
    /// <p>The Amazon SNS targets that are notified when updates are made to an incident.</p>
    #[doc(hidden)]pub notification_targets: std::option::Option<std::vec::Vec<crate::model::NotificationTargetItem>>,
    /// <p>Tags to apply to an incident when calling the <code>StartIncident</code> API action.</p>
    #[doc(hidden)]pub incident_tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct ResourcePolicy  {
    ...
    #[doc(hidden)]pub ram_resource_share_region: std::option::Option<std::string::String>,
}
impl ResourcePolicy {
    /// <p>The JSON blob that describes the policy.</p>
...
pub struct ReplicationSet  {
    ...
    #[doc(hidden)]pub region_map: std::option::Option<std::collections::HashMap<std::string::String, crate::model::RegionInfo>>,
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ReplicationSetStatus>,
    ...
    #[doc(hidden)]pub deletion_protected: std::option::Option<bool>,
...
pub struct RegionInfo  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::RegionStatus>,
    ...
    #[doc(hidden)]pub status_update_date_time: std::option::Option<aws_smithy_types::DateTime>,
}
impl RegionInfo {
    /// <p>The ID of the KMS key used to encrypt the data in this Amazon Web Services Region.</p>
    pub fn sse_kms_key_id(&self) -> std::option::Option<& str> {
...
pub struct IncidentRecord  {
    ...
    #[doc(hidden)]pub automation_executions: std::option::Option<std::vec::Vec<crate::model::AutomationExecution>>,
    ...
    #[doc(hidden)]pub chat_channel: std::option::Option<crate::model::ChatChannel>,
    /// <p>The Amazon SNS targets that are notified when updates are made to an incident.</p>
    #[doc(hidden)]pub notification_targets: std::option::Option<std::vec::Vec<crate::model::NotificationTargetItem>>,
}
impl IncidentRecord {
...
impl AutomationExecution {
    #[allow(irrefutable_let_patterns)]/// Tries to convert the enum instance into [`SsmExecutionArn`](crate::model::AutomationExecution::SsmExecutionArn), extracting the inner [`String`](std::string::String).
    /// Returns `Err(&Self)` if it can't be converted.
