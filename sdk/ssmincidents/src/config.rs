...
/// Configuration for a aws_sdk_ssmincidents service client.
///
...
impl Builder {
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_ssmincidents::Config::builder();
    ...
    /// impl aws_sdk_ssmincidents::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_ssmincidents::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_ssmincidents::Config::builder()
    ...
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::Config;
    /// use aws_sdk_ssmincidents::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_ssmincidents::config::Config;
    /// use aws_sdk_ssmincidents::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `ssmincidents`
    /// (or `ssmincidents-<region>` if a region is configured).
    /// All SSM Incidents clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::Config;
    /// use aws_sdk_ssmincidents::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::Config;
    /// use aws_sdk_ssmincidents::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::IdentityCache;
    ///
    /// let config = aws_sdk_ssmincidents::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_ssmincidents::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_ssmincidents::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_ssmincidents::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("ssm-incidents"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_ssmincidents::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_ssmincidents::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
        ...
        if input.get_origin("endpoint_url").is_client_config() {
            ...
            builder.set_endpoint_url(
                input
                    .service_config()
                    .and_then(|conf| {
                        conf.load_config(service_config_key("SSM Incidents", "AWS_ENDPOINT_URL", "endpoint_url"))
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "ssmincidents";
    ...
    let scope = "aws-sdk-ssmincidents";
