...
impl super::Client {
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::set_client_token): <p>A token that ensures that a client calls the operation only once with the specified details.</p>
    ...
    ///   - [`event_id(impl Into<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::event_id) / [`set_event_id(Option<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::set_event_id): <p>The ID of the event to update. You can use <code>ListTimelineEvents</code> to find an event's ID.</p>
    ...
    ///   - [`event_type(impl Into<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::event_type) / [`set_event_type(Option<String>)`](crate::operation::update_timeline_event::builders::UpdateTimelineEventFluentBuilder::set_event_type): <p>The type of event. You can update events of type <code>Custom Event</code>.</p>
