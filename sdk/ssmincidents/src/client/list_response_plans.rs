...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_response_plans::builders::ListResponsePlansFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_response_plans::builders::ListResponsePlansFluentBuilder::set_next_token): <p>The pagination token to continue to the next page of results.</p>
