...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the response plan with the attached resource policy. </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_resource_policies::builders::GetResourcePoliciesFluentBuilder::set_next_token): <p>The pagination token to continue to the next page of results.</p>
