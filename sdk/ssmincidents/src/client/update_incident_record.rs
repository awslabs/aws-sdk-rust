...
impl super::Client {
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_client_token): <p>A token that ensures that the operation is called only once with the specified details.</p>
    ///   - [`arn(impl Into<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the incident record you are updating.</p>
    ///   - [`title(impl Into<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::title) / [`set_title(Option<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_title): <p>A brief description of the incident.</p>
    ///   - [`summary(impl Into<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::summary) / [`set_summary(Option<String>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_summary): <p>A longer description of what occurred during the incident.</p>
    ...
    ///   - [`status(IncidentRecordStatus)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::status) / [`set_status(Option<IncidentRecordStatus>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_status): <p>The status of the incident. An incident can be <code>Open</code> or <code>Resolved</code>.</p>
    ///   - [`chat_channel(ChatChannel)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::chat_channel) / [`set_chat_channel(Option<ChatChannel>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_chat_channel): <p>The Chatbot chat channel where responders can collaborate.</p>
    ///   - [`notification_targets(Vec<NotificationTargetItem>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::notification_targets) / [`set_notification_targets(Option<Vec<NotificationTargetItem>>)`](crate::operation::update_incident_record::builders::UpdateIncidentRecordFluentBuilder::set_notification_targets): <p>The Amazon SNS targets that are notified when updates are made to an incident.</p>  <p>Using multiple SNS topics creates redundancy in the event that a Region is down during the incident.</p>
