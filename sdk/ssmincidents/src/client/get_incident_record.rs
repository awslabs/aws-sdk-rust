...
impl super::Client {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_incident_record::builders::GetIncidentRecordFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_incident_record::builders::GetIncidentRecordFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the incident record.</p>
