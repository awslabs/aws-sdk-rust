...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_incident_record::builders::GetIncidentRecordFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::get_incident_record::builders::GetIncidentRecordFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the incident record.</p><br>
