...
impl super::Client {
    ...
    ///   - [`resource_arn(impl Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource_arn) / [`set_resource_arn(impl Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the response plan.</p><br>
    ...
    ///   - [`tags(HashMap<String, String>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>A list of tags for the response plan.</p>
