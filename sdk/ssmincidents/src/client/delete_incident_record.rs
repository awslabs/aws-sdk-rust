...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::delete_incident_record::builders::DeleteIncidentRecordFluentBuilder::arn) / [`set_arn(impl Into<String>)`](crate::operation::delete_incident_record::builders::DeleteIncidentRecordFluentBuilder::set_arn):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the incident record you are deleting.</p><br>
