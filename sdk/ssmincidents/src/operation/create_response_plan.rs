...
impl CreateResponsePlanInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_response_plan::ser_create_response_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResponsePlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_response_plan::de_create_response_plan_http_response_with_props(status, headers, body)
        }
    }
}
