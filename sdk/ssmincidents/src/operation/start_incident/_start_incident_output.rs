...
impl StartIncidentOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_incident::StartIncidentOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::start_incident::StartIncidentOutput {
                incident_record_arn: self.incident_record_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("incident_record_arn", "incident_record_arn was not specified but it is required when building StartIncidentOutput")
                    )?
                ,
