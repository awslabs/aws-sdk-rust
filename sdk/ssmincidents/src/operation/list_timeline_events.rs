...
impl ListTimelineEventsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_timeline_events::ser_list_timeline_events_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTimelineEvents {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_timeline_events::de_list_timeline_events_http_response_with_props(status, headers, body)
        }
    }
}
