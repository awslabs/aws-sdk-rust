...
impl CreateReplicationSetInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_replication_set::ser_create_replication_set_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_replication_set::CreateReplicationSet::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::create_replication_set::CreateReplicationSetError
{
