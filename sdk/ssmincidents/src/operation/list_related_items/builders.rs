...
impl ListRelatedItemsFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_related_items::builders::ListRelatedItemsInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_related_items::paginator::ListRelatedItemsPaginator {
        crate::operation::list_related_items::paginator::ListRelatedItemsPaginator::new(
            self.handle,
            self.inner,
        )
    }
