...
impl GetTimelineEventFluentBuilder  {
    /// Creates a new `GetTimelineEvent`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_timeline_event::GetTimelineEventOutput, aws_smithy_http::result::SdkError<crate::operation::get_timeline_event::GetTimelineEventError>>
                     {
