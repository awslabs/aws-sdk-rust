...
impl UpdateTimelineEventFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_timeline_event::UpdateTimelineEventOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_timeline_event::UpdateTimelineEventError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_timeline_event::UpdateTimelineEventOutput, crate::operation::update_timeline_event::UpdateTimelineEventError, Self> {
