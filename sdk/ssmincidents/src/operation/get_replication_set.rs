...
impl GetReplicationSetInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_replication_set::GetReplicationSet,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReplicationSet {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_replication_set::de_get_replication_set_http_response_with_props(status, headers, body)
        }
    }
}
