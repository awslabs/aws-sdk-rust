...
impl UpdateResponsePlanInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_response_plan::ser_update_response_plan_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResponsePlan {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_update_response_plan::de_update_response_plan_http_response_with_props(status, headers, body)
        }
    }
}
