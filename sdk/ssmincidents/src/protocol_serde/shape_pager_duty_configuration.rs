...
pub(crate) fn de_pager_duty_configuration<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::PagerDutyConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "pagerDutyIncidentConfiguration" => {
                            builder = builder.set_pager_duty_incident_configuration(
                                crate::protocol_serde::shape_pager_duty_incident_configuration::de_pager_duty_incident_configuration(tokens, _value)?,
                            );
                        }
