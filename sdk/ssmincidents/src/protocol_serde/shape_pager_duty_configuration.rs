...
pub fn ser_pager_duty_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PagerDutyConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pager_duty_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PagerDutyConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
