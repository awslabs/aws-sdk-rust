...
pub fn ser_list_incident_records_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_incident_records::ListIncidentRecordsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
