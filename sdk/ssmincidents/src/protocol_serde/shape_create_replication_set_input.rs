...
pub fn ser_create_replication_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateReplicationSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
