...
pub fn ser_incident_template(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::IncidentTemplate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_incident_template<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::IncidentTemplate>, aws_smithy_json::deserialize::error::DeserializeError>
