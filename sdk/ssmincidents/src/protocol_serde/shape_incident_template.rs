...
pub fn ser_incident_template(
     ...
     {
        object.key("impact").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.impact).into()));
    }
...
pub(crate) fn de_incident_template<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IncidentTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::incident_template_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
