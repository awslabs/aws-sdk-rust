...
pub fn ser_integration(object_17: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Integration) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::Integration::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("Integration"))
    }
    Ok(())
}
