...
pub fn ser_integration(object_17: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Integration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
