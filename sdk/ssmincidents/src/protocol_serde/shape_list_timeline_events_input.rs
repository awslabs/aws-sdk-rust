...
pub fn ser_list_timeline_events_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::list_timeline_events::ListTimelineEventsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
