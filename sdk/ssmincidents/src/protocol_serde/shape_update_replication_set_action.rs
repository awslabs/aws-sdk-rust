...
pub fn ser_update_replication_set_action(
    object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::UpdateReplicationSetAction,
) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        crate::types::UpdateReplicationSetAction::AddRegionAction(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_3.key("addRegionAction").start_object();
        ...
        crate::types::UpdateReplicationSetAction::DeleteRegionAction(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_3.key("deleteRegionAction").start_object();
