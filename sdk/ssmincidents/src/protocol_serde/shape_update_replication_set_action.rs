...
pub fn ser_update_replication_set_action(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::UpdateReplicationSetAction) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::UpdateReplicationSetAction::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("UpdateReplicationSetAction"))
    }
    Ok(())
}
