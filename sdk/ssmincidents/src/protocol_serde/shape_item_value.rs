...
pub fn ser_item_value(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ItemValue) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_item_value<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ItemValue>, aws_smithy_json::deserialize::error::DeserializeError>
