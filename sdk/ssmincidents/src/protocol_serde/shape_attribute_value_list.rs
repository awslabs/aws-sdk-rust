...
pub fn ser_attribute_value_list(object_1: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AttributeValueList) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
