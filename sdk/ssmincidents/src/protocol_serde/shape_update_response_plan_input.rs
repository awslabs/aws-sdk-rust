...
pub fn ser_update_response_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateResponsePlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
