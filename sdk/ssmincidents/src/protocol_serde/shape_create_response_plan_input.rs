...
pub fn ser_create_response_plan_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateResponsePlanInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
