...
pub fn ser_chat_channel(object_6: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ChatChannel) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
