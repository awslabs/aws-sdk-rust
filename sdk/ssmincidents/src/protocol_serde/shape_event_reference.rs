...
pub fn ser_event_reference(object_6: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventReference) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_event_reference<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EventReference>, aws_smithy_json::deserialize::error::DeserializeError>
