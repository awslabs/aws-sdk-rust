...
pub fn ser_start_incident_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartIncidentInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
