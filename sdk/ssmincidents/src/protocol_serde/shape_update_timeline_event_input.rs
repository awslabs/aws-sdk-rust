...
pub fn ser_update_timeline_event_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateTimelineEventInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
