...
pub(crate) static API_METADATA: aws_http::user_agent::ApiMetadata =
    aws_http::user_agent::ApiMetadata::new("ssmincidents", crate::PKG_VERSION);
...
/// Client and fluent builders for calling AWS Systems Manager Incident Manager.
pub mod client;
