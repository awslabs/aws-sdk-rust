...
pub fn serialize_structure_create_replication_set_input(
        ...
        for (key_4, value_5) in var_2 {
            {
                ...
                crate::json_ser::serialize_structure_region_map_input_value(&mut object_6, value_5);
                object_6.finish();
            }
        }
        object_3.finish();
...
pub fn serialize_structure_create_response_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_9 in var_7 {
            {
                ...
                crate::json_ser::serialize_union_action(&mut object_10, item_9);
                object_10.finish();
            }
        }
        array_8.finish();
    ...
    if let Some(var_11) = &input.chat_channel {
        ...
        crate::json_ser::serialize_union_chat_channel(&mut object_12, var_11);
        object_12.finish();
    }
    ...
    if let Some(var_18) = &input.incident_template {
        ...
        crate::json_ser::serialize_structure_incident_template(&mut object_19, var_18);
        object_19.finish();
    }
...
pub fn serialize_structure_create_timeline_event_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_incident_record_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_response_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_timeline_event_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_incident_records_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_40 in var_38 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_41, item_40);
                object_41.finish();
            }
        }
        array_39.finish();
...
pub fn serialize_structure_list_related_items_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_replication_sets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_response_plans_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_timeline_events_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_53 in var_51 {
            {
                ...
                crate::json_ser::serialize_structure_filter(&mut object_54, item_53);
                object_54.finish();
            }
        }
        array_52.finish();
...
pub fn serialize_structure_start_incident_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_66 in var_64 {
            {
                ...
                crate::json_ser::serialize_structure_related_item(&mut object_67, item_66);
                object_67.finish();
            }
        }
        array_65.finish();
    ...
    if let Some(var_70) = &input.trigger_details {
        ...
        crate::json_ser::serialize_structure_trigger_details(&mut object_71, var_70);
        object_71.finish();
    }
}
...
pub fn serialize_structure_update_deletion_protection_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_incident_record_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_80) = &input.chat_channel {
        ...
        crate::json_ser::serialize_union_chat_channel(&mut object_81, var_80);
        object_81.finish();
    }
        ...
        for item_86 in var_84 {
            {
                ...
                crate::json_ser::serialize_union_notification_target_item(&mut object_87, item_86);
                object_87.finish();
            }
        }
        array_85.finish();
...
pub fn serialize_structure_update_related_items_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_93) = &input.related_items_update {
        ...
        crate::json_ser::serialize_union_related_items_update(&mut object_94, var_93);
        object_94.finish();
    }
}

pub fn serialize_structure_update_replication_set_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_97 in var_95 {
            {
                ...
                crate::json_ser::serialize_union_update_replication_set_action(
                    &mut object_98,
                    item_97,
                );
                object_98.finish();
...
pub fn serialize_structure_update_response_plan_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_103 in var_101 {
            {
                ...
                crate::json_ser::serialize_union_action(&mut object_104, item_103);
                object_104.finish();
            }
        }
        array_102.finish();
    ...
    if let Some(var_106) = &input.chat_channel {
        ...
        crate::json_ser::serialize_union_chat_channel(&mut object_107, var_106);
        object_107.finish();
    }
        ...
        for item_117 in var_115 {
            {
                ...
                crate::json_ser::serialize_union_notification_target_item(
                    &mut object_118,
                    item_117,
                );
                object_118.finish();
...
pub fn serialize_structure_update_timeline_event_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_region_map_input_value(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_action(
    ...
    match input {
        crate::model::Action::SsmAutomation(inner) => {
            ...
            crate::json_ser::serialize_structure_ssm_automation(&mut object_128, inner);
            object_128.finish();
        }
    }
}

pub fn serialize_union_chat_channel(
    object_12: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ChatChannel,
) {
    match input {
        crate::model::ChatChannel::Empty(inner) => {
            let mut object_129 = object_12.key("empty").start_object();
            crate::json_ser::serialize_structure_empty_chat_channel(&mut object_129, inner);
            object_129.finish();
        }
...
pub fn serialize_structure_incident_template(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_filter(
    ...
    if let Some(var_141) = &input.condition {
        ...
        crate::json_ser::serialize_union_condition(&mut object_142, var_141);
        object_142.finish();
    }
}

pub fn serialize_structure_related_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::RelatedItem,
) {
    if let Some(var_143) = &input.identifier {
        let mut object_144 = object.key("identifier").start_object();
        crate::json_ser::serialize_structure_item_identifier(&mut object_144, var_143);
        object_144.finish();
    }
...
pub fn serialize_structure_trigger_details(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_148) = &input.timestamp {
        object
            .key("timestamp")
            .instant(var_148, smithy_types::instant::Format::EpochSeconds);
    }
...
pub fn serialize_union_notification_target_item(
    object_87: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_related_items_update(
    object_94: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    match input {
        crate::model::RelatedItemsUpdate::ItemToAdd(inner) => {
            ...
            crate::json_ser::serialize_structure_related_item(&mut object_150, inner);
            object_150.finish();
        }
        crate::model::RelatedItemsUpdate::ItemToRemove(inner) => {
            let mut object_151 = object_94.key("itemToRemove").start_object();
            crate::json_ser::serialize_structure_item_identifier(&mut object_151, inner);
            object_151.finish();
        }
    }
}

pub fn serialize_union_update_replication_set_action(
    object_98: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    match input {
        crate::model::UpdateReplicationSetAction::AddRegionAction(inner) => {
            ...
            crate::json_ser::serialize_structure_add_region_action(&mut object_152, inner);
            object_152.finish();
        }
        crate::model::UpdateReplicationSetAction::DeleteRegionAction(inner) => {
            ...
            crate::json_ser::serialize_structure_delete_region_action(&mut object_153, inner);
            object_153.finish();
        }
    }
}

pub fn serialize_structure_ssm_automation(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_empty_chat_channel(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_condition(
    object_142: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    match input {
        ...
        crate::model::Condition::Equals(inner) => {
            ...
            crate::json_ser::serialize_union_attribute_value_list(&mut object_164, inner);
            object_164.finish();
        }
    }
}

pub fn serialize_structure_item_identifier(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::ItemIdentifier,
) {
    if let Some(var_165) = &input.value {
        let mut object_166 = object.key("value").start_object();
        crate::json_ser::serialize_union_item_value(&mut object_166, var_165);
        object_166.finish();
    }
...
pub fn serialize_structure_add_region_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_region_action(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_union_attribute_value_list(
    object_164: &mut smithy_json::serialize::JsonObjectWriter,
            ...
            for item_174 in inner {
                {
                    array_173.value().number(
                        #[allow(clippy::useless_conversion)]
                        smithy_types::Number::NegInt((*item_174).into()),
                    );
                }
            }
            array_173.finish();
...
pub fn serialize_union_item_value(
    object_166: &mut smithy_json::serialize::JsonObjectWriter,
