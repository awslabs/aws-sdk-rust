...
impl ListSchemaVersions {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "IoT Managed Integrations.ListSchemaVersions",
            "rpc.service" = "IoT Managed Integrations",
            "rpc.method" = "ListSchemaVersions",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListSchemaVersions {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListSchemaVersions")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListSchemaVersions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListSchemaVersionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListSchemaVersionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSchemaVersionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListSchemaVersionsInput>() else {
        ...
        if requested.should_capture("SchemaId") {
            if let ::std::option::Option::Some(value) = input.schema_id.as_deref() {
                captured.insert("SchemaId", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListSchemaVersionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_schema_versions::de_list_schema_versions_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListSchemaVersionsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                let input_1 = &_input.r#type;
                let input_1 = input_1
                    .as_ref()
                    .ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "cannot be empty or unset"))?;
                let r#type = ::aws_smithy_http::label::fmt_string(input_1.as_str(), ::aws_smithy_http::label::EncodingStrategy::Default);
                if r#type.is_empty() {
                ...
                ::std::write!(output, "/schema-versions/{Type}", Type = r#type).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::list_schema_versions::ListSchemaVersionsInput,
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.schema_id {
                    {
                        query.push_kv("SchemaIdFilter", &::aws_smithy_http::query::fmt_string(inner_4));
                    }
                }
                if let ::std::option::Option::Some(inner_5) = &_input.namespace {
                    {
                        query.push_kv("NamespaceFilter", &::aws_smithy_http::query::fmt_string(inner_5));
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.visibility {
                    {
                        query.push_kv("VisibilityFilter", &::aws_smithy_http::query::fmt_string(inner_6.as_str()));
                    }
                }
                if let ::std::option::Option::Some(inner_7) = &_input.semantic_version {
                    {
                        query.push_kv("SemanticVersionFilter", &::aws_smithy_http::query::fmt_string(inner_7));
                    }
                }
                ::std::result::Result::Ok(())
            }
...
#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListSchemaVersionsEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "ListSchemaVersionsEndpointParamsInterceptor"
    }
...
pub enum ListSchemaVersionsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListSchemaVersionsError) for what information is available for the error.")]
...
impl ListSchemaVersionsError {
    ...
    /// Creates the `ListSchemaVersionsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ListSchemaVersionsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListSchemaVersionsError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `ListSchemaVersionsError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `ListSchemaVersionsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ListSchemaVersionsError::ValidationException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListSchemaVersionsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_schema_versions::ListSchemaVersionsError {
