...
/// Paginator for [`ListManagedThings`](crate::operation::list_managed_things::ListManagedThings)
pub struct ListManagedThingsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_managed_things::builders::ListManagedThingsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListManagedThingsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_managed_things::paginator::ListManagedThingsPaginatorItems {
        crate::operation::list_managed_things::paginator::ListManagedThingsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_managed_things::ListManagedThings::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_managed_things_output_output_next_token(resp);
...
/// Flattened paginator for `ListManagedThingsPaginator`
///
/// This is created with [`.items()`](ListManagedThingsPaginator::items)
pub struct ListManagedThingsPaginatorItems(ListManagedThingsPaginator);

impl ListManagedThingsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_managed_things_output_output_items(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
