...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::describe_logging_configuration::builders::DescribeLoggingConfigurationFluentBuilder::set_workspace_id):<br>required: **true**<br>The ID of the workspace to vend logs to.<br>
