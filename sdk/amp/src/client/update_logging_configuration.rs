...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::update_logging_configuration::builders::UpdateLoggingConfigurationFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::update_logging_configuration::builders::UpdateLoggingConfigurationFluentBuilder::set_workspace_id):<br>required: **true**<br>The ID of the workspace to vend logs to.<br>
    ///   - [`log_group_arn(impl Into<String>)`](crate::operation::update_logging_configuration::builders::UpdateLoggingConfigurationFluentBuilder::log_group_arn) / [`set_log_group_arn(impl Into<String>)`](crate::operation::update_logging_configuration::builders::UpdateLoggingConfigurationFluentBuilder::set_log_group_arn):<br>required: **true**<br>The ARN of the CW log group to which the vended log data will be published.<br>
