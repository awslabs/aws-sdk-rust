...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_groups_namespace::builders::DeleteRuleGroupsNamespaceFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::delete_rule_groups_namespace::builders::DeleteRuleGroupsNamespaceFluentBuilder::set_workspace_id): The ID of the workspace to delete rule group definition.
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_rule_groups_namespace::builders::DeleteRuleGroupsNamespaceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_rule_groups_namespace::builders::DeleteRuleGroupsNamespaceFluentBuilder::set_name): The rule groups namespace name.
