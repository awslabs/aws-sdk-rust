...
impl super::Client {
    ...
    ///   - [`role_configuration(RoleConfiguration)`](crate::operation::update_scraper::builders::UpdateScraperFluentBuilder::role_configuration) / [`set_role_configuration(Option<RoleConfiguration>)`](crate::operation::update_scraper::builders::UpdateScraperFluentBuilder::set_role_configuration):<br>required: **false**<br><p>The scraper role configuration for the workspace.</p><br>
