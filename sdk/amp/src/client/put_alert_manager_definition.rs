...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::workspace_id) / [`set_workspace_id(impl Into<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::set_workspace_id):<br>required: **true**<br>The ID of the workspace in which to update the alert manager definition.<br>
    ///   - [`data(Blob)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::data) / [`set_data(Blob)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::set_data):<br>required: **true**<br>The alert manager definition data.<br>
