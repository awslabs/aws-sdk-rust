...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::set_workspace_id): The ID of the workspace in which to update the alert manager definition.
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::put_alert_manager_definition::builders::PutAlertManagerDefinitionFluentBuilder::set_client_token): Optional, unique, case-sensitive, user-provided identifier to ensure the idempotency of the request.
