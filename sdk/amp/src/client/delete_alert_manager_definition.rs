...
impl super::Client {
    ...
    ///   - [`workspace_id(impl Into<String>)`](crate::operation::delete_alert_manager_definition::builders::DeleteAlertManagerDefinitionFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::delete_alert_manager_definition::builders::DeleteAlertManagerDefinitionFluentBuilder::set_workspace_id):<br>required: **true**<br>The ID of the workspace in which to delete the alert manager definition.<br>
