...
impl super::Client {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::describe_alert_manager_definition::builders::DescribeAlertManagerDefinitionFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::describe_alert_manager_definition::builders::DescribeAlertManagerDefinitionFluentBuilder::set_workspace_id): The ID of the workspace to describe.
