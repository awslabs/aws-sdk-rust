        ...
        ::std::result::Result::Ok(
            crate::types::LoggingConfigurationMetadata {
                ...
                workspace: self.workspace
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("workspace", "workspace was not specified but it is required when building LoggingConfigurationMetadata")
                    )?
                ,
                log_group_arn: self.log_group_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("log_group_arn", "log_group_arn was not specified but it is required when building LoggingConfigurationMetadata")
                    )?
                ,
                created_at: self.created_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_at", "created_at was not specified but it is required when building LoggingConfigurationMetadata")
                    )?
                ,
                modified_at: self.modified_at
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("modified_at", "modified_at was not specified but it is required when building LoggingConfigurationMetadata")
                    )?
                ,
            }
        )
