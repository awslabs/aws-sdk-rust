...
pub fn ser_source(
    ...
    match input {
        crate::types::Source::EksConfiguration(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_14.key("eksConfiguration").start_object();
        ...
        crate::types::Source::VpcConfiguration(inner) => {
            #[allow(unused_mut)]
            let mut object_2 = object_14.key("vpcConfiguration").start_object();
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "eksConfiguration" => Some(crate::types::Source::EksConfiguration(
                            crate::protocol_serde::shape_eks_configuration::de_eks_configuration(tokens, _value, depth + 1)?.ok_or_else(|| {
