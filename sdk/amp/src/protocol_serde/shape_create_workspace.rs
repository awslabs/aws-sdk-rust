            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::create_workspace::CreateWorkspaceError::unhandled(
...
pub fn de_create_workspace_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_workspace_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_workspace::CreateWorkspaceError::unhandled)?
    })
}
...
) -> Result<crate::operation::create_workspace::builders::CreateWorkspaceOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
