...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::describe_workspace_configuration::DescribeWorkspaceConfigurationError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_retry_after_seconds(
                        crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                            crate::operation::describe_workspace_configuration::DescribeWorkspaceConfigurationError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_workspace_configuration::DescribeWorkspaceConfigurationError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::describe_workspace_configuration::DescribeWorkspaceConfigurationError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
...
> {
    Ok({
        ...
        crate::serde_util::describe_workspace_configuration_output_output_correct_errors(output).build()
    })
}
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "workspaceConfiguration" => {
                    builder = builder.set_workspace_configuration(
                        crate::protocol_serde::shape_workspace_configuration_description::de_workspace_configuration_description(tokens, _value)?,
                    );
                }
