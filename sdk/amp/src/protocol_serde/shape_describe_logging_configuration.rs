            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::describe_logging_configuration::DescribeLoggingConfigurationError::unhandled(
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "loggingConfiguration" => {
                    builder = builder.set_logging_configuration(
                        crate::protocol_serde::shape_logging_configuration_metadata::de_logging_configuration_metadata(tokens, _value, depth + 1)?,
                    );
                }
