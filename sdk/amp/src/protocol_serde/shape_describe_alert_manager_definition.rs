...
> {
    ...
    Err(match error_code {
        ...
        "InternalServerException" => {
            crate::operation::describe_alert_manager_definition::DescribeAlertManagerDefinitionError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    ...
                    output = output.set_retry_after_seconds(
                        crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                            crate::operation::describe_alert_manager_definition::DescribeAlertManagerDefinitionError::unhandled(
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_alert_manager_definition::DescribeAlertManagerDefinitionError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "alertManagerDefinition" => {
                    builder = builder.set_alert_manager_definition(
                        crate::protocol_serde::shape_alert_manager_definition_description::de_alert_manager_definition_description(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
