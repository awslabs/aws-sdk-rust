...
pub fn de_list_rule_groups_namespaces_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesOutput, crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_rule_groups_namespaces_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesOutput, crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesError> {
    Ok({
        #[allow(unused_mut)]
