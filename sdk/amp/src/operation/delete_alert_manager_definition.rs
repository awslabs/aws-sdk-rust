...
impl DeleteAlertManagerDefinitionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinition::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlertManagerDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_alert_manager_definition::de_delete_alert_manager_definition_http_response_with_props(
                status, headers, body,
            )
        }
    }
