...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlertManagerDefinition {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_alert_manager_definition::de_delete_alert_manager_definition_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DeleteAlertManagerDefinitionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError
{
