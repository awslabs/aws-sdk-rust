...
impl DeleteAlertManagerDefinition {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput,
                    ) -> ::std::result::Result<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionOutput>().expect("correct output type"))
                    }
                    ...
                    pub(crate) fn operation_runtime_plugins(
                        ...
                        runtime_plugins = runtime_plugins
                                    ...
                                    let input: &mut crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput = input.downcast_mut().expect("correct type");
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteAlertManagerDefinition {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteAlertManagerDefinition");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteAlertManagerDefinitionRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteAlertManagerDefinitionResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteAlertManagerDefinition")
...
.with_interceptor(DeleteAlertManagerDefinitionEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionError>::new());
...
#[derive(Debug)]
            struct DeleteAlertManagerDefinitionResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteAlertManagerDefinitionResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteAlertManagerDefinitionRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteAlertManagerDefinitionRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.workspace_id;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("workspace_id", "cannot be empty or unset"))?;
    let workspace_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
    if workspace_id.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("workspace_id", "cannot be empty or unset"))
                }
    ::std::write!(output, "/workspaces/{workspaceId}/alertmanager/definition", workspaceId = workspace_id).expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteAlertManagerDefinitionEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteAlertManagerDefinitionEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteAlertManagerDefinitionEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteAlertManagerDefinitionInput>()
                        .ok_or("failed to downcast to DeleteAlertManagerDefinitionInput")?;
...
pub enum DeleteAlertManagerDefinitionError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteAlertManagerDefinitionError) for what information is available for the error.")]
...
impl DeleteAlertManagerDefinitionError {
    /// Creates the `DeleteAlertManagerDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAlertManagerDefinitionError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteAlertManagerDefinitionError {
...
mod _delete_alert_manager_definition_output;
