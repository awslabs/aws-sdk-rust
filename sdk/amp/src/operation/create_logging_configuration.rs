...
impl CreateLoggingConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_logging_configuration::CreateLoggingConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLoggingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_create_logging_configuration::de_create_logging_configuration_http_response_with_props(status, headers, body)
        }
    }
}
