...
impl DeleteLoggingConfigurationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_logging_configuration::DeleteLoggingConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoggingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_logging_configuration::de_delete_logging_configuration_http_response_with_props(status, headers, body)
        }
    }
}
