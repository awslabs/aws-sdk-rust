...
impl UpdateWorkspaceAliasInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_workspace_alias::ser_update_workspace_alias_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_workspace_alias::UpdateWorkspaceAlias::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_workspace_alias::UpdateWorkspaceAliasError
{
