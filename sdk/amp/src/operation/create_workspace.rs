...
impl CreateWorkspaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_workspace::CreateWorkspace, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_workspace::ser_create_workspace_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkspace {
    type Output =
        ::std::result::Result<crate::operation::create_workspace::CreateWorkspaceOutput, crate::operation::create_workspace::CreateWorkspaceError>;
