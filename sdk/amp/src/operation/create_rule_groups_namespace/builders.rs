...
impl CreateRuleGroupsNamespaceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_rule_groups_namespace::CreateRuleGroupsNamespaceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_rule_groups_namespace::CreateRuleGroupsNamespaceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_rule_groups_namespace::CreateRuleGroupsNamespaceOutput, crate::operation::create_rule_groups_namespace::CreateRuleGroupsNamespaceError, Self> {
