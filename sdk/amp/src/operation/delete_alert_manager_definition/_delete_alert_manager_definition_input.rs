...
impl DeleteAlertManagerDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_alert_manager_definition::DeleteAlertManagerDefinitionInput, ::aws_smithy_types::error::operation::BuildError> {
