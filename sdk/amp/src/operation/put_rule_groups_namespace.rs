...
impl PutRuleGroupsNamespaceInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::put_rule_groups_namespace::PutRuleGroupsNamespace,
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRuleGroupsNamespace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_put_rule_groups_namespace::de_put_rule_groups_namespace_http_response_with_props(status, headers, body)
        }
    }
}
