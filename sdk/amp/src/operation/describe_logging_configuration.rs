...
impl DescribeLoggingConfigurationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_logging_configuration::DescribeLoggingConfiguration,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_logging_configuration::DescribeLoggingConfiguration::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoggingConfiguration {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_logging_configuration::de_describe_logging_configuration_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeLoggingConfigurationError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_logging_configuration::DescribeLoggingConfigurationError
{
