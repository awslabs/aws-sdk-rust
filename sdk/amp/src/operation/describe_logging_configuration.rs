...
impl DescribeLoggingConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLoggingConfiguration`](crate::operation::describe_logging_configuration::DescribeLoggingConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_logging_configuration::DescribeLoggingConfiguration, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_logging_configuration::DescribeLoggingConfigurationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_logging_configuration::DescribeLoggingConfiguration::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeLoggingConfiguration {
                type Output = std::result::Result<crate::operation::describe_logging_configuration::DescribeLoggingConfigurationOutput, crate::operation::describe_logging_configuration::DescribeLoggingConfigurationError>;
