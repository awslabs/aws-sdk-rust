...
impl DeleteRuleGroupsNamespaceInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_rule_groups_namespace::DeleteRuleGroupsNamespace::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRuleGroupsNamespace {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 202 {
            ...
            crate::protocol_serde::shape_delete_rule_groups_namespace::de_delete_rule_groups_namespace_http_response_with_props(status, headers, body)
        }
    }
}
