...
pub(crate) fn reflens_list_rule_groups_namespaces_output_next_token(input: &crate::output::ListRuleGroupsNamespacesOutput) -> std::option::Option<& std::string::String> {
...
pub(crate) fn lens_list_rule_groups_namespaces_output_rule_groups_namespaces(input: crate::output::ListRuleGroupsNamespacesOutput) -> std::option::Option<std::vec::Vec<crate::model::RuleGroupsNamespaceSummary>> {
