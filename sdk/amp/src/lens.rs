...
pub(crate) fn reflens_list_anomaly_detectors_output_output_next_token(
...
pub(crate) fn lens_list_anomaly_detectors_output_output_anomaly_detectors(
    input: crate::operation::list_anomaly_detectors::ListAnomalyDetectorsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::AnomalyDetectorSummary>> {
