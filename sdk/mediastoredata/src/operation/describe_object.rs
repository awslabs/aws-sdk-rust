...
impl DescribeObjectInput {
    /// Consumes the builder and constructs an Operation<[`DescribeObject`](crate::operation::describe_object::DescribeObject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_object::DescribeObject, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_object::DescribeObjectInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_object::DescribeObject::new())
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeObject {
                type Output = std::result::Result<crate::operation::describe_object::DescribeObjectOutput, crate::operation::describe_object::DescribeObjectError>;
