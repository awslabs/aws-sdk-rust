...
impl ListItemsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_items::ListItems,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_items::ListItems::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListItems {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_items::de_list_items_http_response_with_props(
                status, headers, body,
            )
        }
    }
