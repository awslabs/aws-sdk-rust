...
pub fn de_list_items_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_items::ListItemsOutput, crate::operation::list_items::ListItemsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_items_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_items::ListItemsOutput, crate::operation::list_items::ListItemsError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_items::de_list_items(_response_body, output)
            .map_err(crate::operation::list_items::ListItemsError::unhandled)?;
...
) -> Result<crate::operation::list_items::builders::ListItemsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
