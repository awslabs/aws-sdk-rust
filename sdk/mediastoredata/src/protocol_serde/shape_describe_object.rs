...
pub fn de_describe_object_http_response(
    ...
    Ok({
        ...
        output = output.set_cache_control(
            match crate::protocol_serde::shape_describe_object_output::de_cache_control_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::describe_object::DescribeObjectError::unhandled(
        ...
        output = output.set_content_length(
            match crate::protocol_serde::shape_describe_object_output::de_content_length_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_describe_object_output::de_content_type_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
        ...
        output = output.set_e_tag(
            match crate::protocol_serde::shape_describe_object_output::de_e_tag_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
        ...
        output = output.set_last_modified(
            match crate::protocol_serde::shape_describe_object_output::de_last_modified_header(_response_headers) {
                ::std::result::Result::Ok(value) => value,
                ::std::result::Result::Err(err) => {
                    let _ = &err;
                    let has_unreadable_value = _response_headers
