...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::put_object::PutObjectError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ContainerNotFoundException" => {
            crate::operation::put_object::PutObjectError::ContainerNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InternalServerError" => {
            crate::operation::put_object::PutObjectError::InternalServerError({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_put_object::de_put_object(_response_body, output)
            .map_err(crate::operation::put_object::PutObjectError::unhandled)?;
...
pub(crate) fn de_put_object(
    ...
    crate::operation::put_object::builders::PutObjectOutputBuilder,
