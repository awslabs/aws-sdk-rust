    ...
    Err(match error_code {
        "ContainerNotFoundException" => crate::error::PutObjectError::ContainerNotFoundException({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_container_not_found_exception::de_container_not_found_exception_json_err(response.body().as_ref(), output).map_err(crate::error::PutObjectError::unhandled)?;
        ...
        "InternalServerError" => crate::error::PutObjectError::InternalServerError({
            ...
            let mut tmp = {
                ...
                let _ = response;
                output = crate::protocol_serde::shape_internal_server_error::de_internal_server_error_json_err(response.body().as_ref(), output).map_err(crate::error::PutObjectError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
            if tmp.message.is_none() {
...
pub fn de_put_object_http_response(
    ...
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_put_object::de_put_object(
...
pub(crate) fn de_put_object(
    ...
    crate::output::put_object_output::Builder,
