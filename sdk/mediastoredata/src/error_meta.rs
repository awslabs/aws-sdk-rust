...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::describe_object::DescribeObjectError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::get_object::GetObjectError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::list_items::ListItemsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
