...
pub fn serialize_structure_crate_input_associate_user_to_permission_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::AssociateUserToPermissionGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_changeset_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateChangesetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_dataset_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDatasetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_17) = &input.owner_info {
        ...
        crate::json_ser::serialize_structure_crate_model_dataset_owner_info(&mut object_18, var_17)?;
        object_18.finish();
    }
    if let Some(var_19) = &input.permission_group_params {
        let mut object_20 = object.key("permissionGroupParams").start_object();
        crate::json_ser::serialize_structure_crate_model_permission_group_params(&mut object_20, var_19)?;
        object_20.finish();
    }
...
pub fn serialize_structure_crate_input_create_data_view_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDataViewInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
    if let Some(var_23) = &input.as_of_timestamp {
        object.key("asOfTimestamp").number(#[allow(clippy::useless_conversion)]aws_smithy_types::Number::NegInt((*var_23).into()));
    }
    ...
    if let Some(var_25) = &input.destination_type_params {
        ...
        crate::json_ser::serialize_structure_crate_model_data_view_destination_type_params(&mut object_26, var_25)?;
        object_26.finish();
    }
...
pub fn serialize_structure_crate_input_create_permission_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePermissionGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_create_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateUserInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_disable_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::DisableUserInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_enable_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::EnableUserInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_get_working_location_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetWorkingLocationInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_reset_user_password_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ResetUserPasswordInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_changeset_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateChangesetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_dataset_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDatasetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_permission_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePermissionGroupInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_update_user_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateUserInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_dataset_owner_info(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DatasetOwnerInfo) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_permission_group_params(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PermissionGroupParams) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_84 in var_82 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_resource_permission(&mut object_85, item_84)?;
                object_85.finish();
            }
        }
        array_83.finish();
...
pub fn serialize_structure_crate_model_schema_union(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SchemaUnion) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_model_data_view_destination_type_params(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataViewDestinationTypeParams) -> Result<(), aws_smithy_http::operation::SerializationError> {
    ...
    if let Some(var_89) = &input.s3_destination_export_file_format {
        object.key("s3DestinationExportFileFormat").string(var_89.as_str());
    }
    if let Some(var_90) = &input.s3_destination_export_file_format_options {
        let mut object_91 = object.key("s3DestinationExportFileFormatOptions").start_object();
...
pub fn serialize_structure_crate_model_resource_permission(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourcePermission) -> Result<(), aws_smithy_http::operation::SerializationError> {
        ...
        for item_97 in var_95 {
             {
                ...
                crate::json_ser::serialize_structure_crate_model_column_definition(&mut object_98, item_97)?;
                object_98.finish();
            }
        }
        array_96.finish();
