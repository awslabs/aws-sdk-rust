...
impl GetProgrammaticAccessCredentialsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_programmatic_access_credentials::GetProgrammaticAccessCredentials::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProgrammaticAccessCredentials {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_programmatic_access_credentials::de_get_programmatic_access_credentials_http_response_with_props(
                status, headers, body,
            )
        }
    }
