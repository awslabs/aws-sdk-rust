...
impl GetExternalDataViewAccessDetailsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsError, ::aws_smithy_http::operation::Response>>
