...
/// <ul>
/// <li>
/// <p>You must retrieve the programmatic credentials.</p></li>
/// <li>
/// <p>You must be a member of a FinSpace user group, where the dataset that you want to access has <code>Read Dataset Data</code> permissions.</p></li>
/// </ul>
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsOutput,
                    crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsError,
                > for GetExternalDataViewAccessDetailsFluentBuilder
            {
                fn send(
                    self,
...
impl GetExternalDataViewAccessDetailsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetails::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetails::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsOutput, crate::operation::get_external_data_view_access_details::GetExternalDataViewAccessDetailsError, Self> {
