...
pub use crate::operation::list_changesets::_list_changesets_output::ListChangesetsOutputBuilder;
...
pub struct ListChangesetsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_changesets::builders::ListChangesetsInputBuilder,
...
impl ListChangesetsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_changesets::ListChangesetsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_changesets::ListChangesetsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_changesets::ListChangesets::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_changesets::ListChangesetsOutput, crate::operation::list_changesets::ListChangesetsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_changesets::paginator::ListChangesetsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
