...
impl UpdatePermissionGroupFluentBuilder  {
    /// Creates a new `UpdatePermissionGroup`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_permission_group::UpdatePermissionGroupOutput, aws_smithy_http::result::SdkError<crate::operation::update_permission_group::UpdatePermissionGroupError>>
                     {
