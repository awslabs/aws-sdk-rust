...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_data_view_http_response(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_data_view::GetDataViewOutput, crate::operation::get_data_view::GetDataViewError> {
    Ok({
        #[allow(unused_mut)]
