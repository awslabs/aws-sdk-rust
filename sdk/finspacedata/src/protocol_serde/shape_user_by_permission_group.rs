...
pub(crate) fn de_user_by_permission_group<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::UserByPermissionGroup>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "apiAccess" => {
                            builder = builder.set_api_access(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ApiAccess::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
