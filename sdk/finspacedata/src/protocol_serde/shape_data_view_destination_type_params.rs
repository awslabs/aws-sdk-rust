...
pub fn ser_data_view_destination_type_params(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DataViewDestinationTypeParams) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_data_view_destination_type_params<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataViewDestinationTypeParams>, aws_smithy_json::deserialize::error::DeserializeError>
