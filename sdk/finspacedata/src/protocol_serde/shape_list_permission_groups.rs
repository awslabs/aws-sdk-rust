...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_permission_groups_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_permission_groups::de_list_permission_groups(_response_body, output)
            .map_err(crate::operation::list_permission_groups::ListPermissionGroupsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "permissionGroups" => {
                    builder = builder.set_permission_groups(crate::protocol_serde::shape_permission_group_list::de_permission_group_list(tokens)?);
                }
