...
pub fn de_list_permission_groups_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_permission_groups::ListPermissionGroupsOutput, crate::operation::list_permission_groups::ListPermissionGroupsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_permission_groups::ListPermissionGroupsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_permission_groups_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_permission_groups::ListPermissionGroupsOutput, crate::operation::list_permission_groups::ListPermissionGroupsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_permission_groups::builders::ListPermissionGroupsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_permission_groups::de_list_permission_groups(response.body().as_ref(), output).map_err(crate::operation::list_permission_groups::ListPermissionGroupsError::unhandled)?;
