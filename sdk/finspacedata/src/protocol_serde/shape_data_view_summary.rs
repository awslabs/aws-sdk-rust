...
pub(crate) fn de_data_view_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DataViewSummary>, aws_smithy_json::deserialize::error::DeserializeError>
