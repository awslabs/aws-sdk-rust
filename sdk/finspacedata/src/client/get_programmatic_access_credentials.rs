...
impl super::Client {
    ...
    ///   - [`duration_in_minutes(i64)`](crate::operation::get_programmatic_access_credentials::builders::GetProgrammaticAccessCredentialsFluentBuilder::duration_in_minutes) / [`set_duration_in_minutes(Option<i64>)`](crate::operation::get_programmatic_access_credentials::builders::GetProgrammaticAccessCredentialsFluentBuilder::set_duration_in_minutes): <p>The time duration in which the credentials remain valid. </p>
