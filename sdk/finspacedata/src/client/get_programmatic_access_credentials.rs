...
impl super::Client {
    ...
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::get_programmatic_access_credentials::builders::GetProgrammaticAccessCredentialsFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::get_programmatic_access_credentials::builders::GetProgrammaticAccessCredentialsFluentBuilder::set_environment_id): <p>The FinSpace environment identifier.</p>
