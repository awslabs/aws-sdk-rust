...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::set_name): <p>The name of the permission group.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::set_description): <p>A brief description for the permission group.</p>
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_permission_group::builders::CreatePermissionGroupFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
