...
impl super::Client {
    ...
    ///   - [`dataset_id(impl Into<String>)`](crate::operation::list_changesets::builders::ListChangesetsFluentBuilder::dataset_id) / [`set_dataset_id(Option<String>)`](crate::operation::list_changesets::builders::ListChangesetsFluentBuilder::set_dataset_id):<br>required: **true**<br><p>The unique identifier for the FinSpace Dataset to which the Changeset belongs.</p><br>
