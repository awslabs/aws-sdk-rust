...
impl super::Client {
    ...
    ///   - [`permission_group_id(impl Into<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::permission_group_id) / [`set_permission_group_id(Option<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::set_permission_group_id): <p>The unique identifier for the permission group to update.</p>
    ///   - [`name(impl Into<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::set_name): <p>The name of the permission group.</p>
    ///   - [`description(impl Into<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::set_description): <p>A brief description for the permission group.</p>
    ...
    ///   - [`client_token(impl Into<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::update_permission_group::builders::UpdatePermissionGroupFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
