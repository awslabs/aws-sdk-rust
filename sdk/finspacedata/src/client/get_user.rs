...
impl super::Client {
    ...
    ///   - [`create_time(i64)`](crate::operation::get_user::GetUserOutput::create_time): <p>The timestamp at which the user was created in FinSpace. The value is determined as epoch time in milliseconds.</p>
    ///   - [`last_enabled_time(i64)`](crate::operation::get_user::GetUserOutput::last_enabled_time): <p>Describes the last time the user was activated. The value is determined as epoch time in milliseconds.</p>
    ///   - [`last_disabled_time(i64)`](crate::operation::get_user::GetUserOutput::last_disabled_time): <p>Describes the last time the user was deactivated. The value is determined as epoch time in milliseconds.</p>
