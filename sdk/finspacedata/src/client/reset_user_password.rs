...
impl super::Client {
    ...
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::reset_user_password::builders::ResetUserPasswordFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::reset_user_password::builders::ResetUserPasswordFluentBuilder::set_user_id): <p>The unique identifier of the user that a temporary password is requested for.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::reset_user_password::builders::ResetUserPasswordFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::reset_user_password::builders::ResetUserPasswordFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
