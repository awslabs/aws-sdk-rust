...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_permission_groups::builders::ListPermissionGroupsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_permission_groups::builders::ListPermissionGroupsFluentBuilder::set_max_results): <p>The maximum number of results per page.</p>
