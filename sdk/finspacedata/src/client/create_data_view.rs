...
impl super::Client {
    ...
    ///   - [`auto_update(bool)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::auto_update) / [`set_auto_update(Option<bool>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::set_auto_update): <p>Flag to indicate Dataview should be updated automatically.</p>
    ///   - [`sort_columns(impl Into<String>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::sort_columns) / [`set_sort_columns(Option<Vec<String>>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::set_sort_columns): <p>Columns to be used for sorting the data.</p>
