...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
    ///   - [`dataset_id(impl ::std::convert::Into<String>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::dataset_id) / [`set_dataset_id(Option<String>)`](crate::operation::create_data_view::builders::CreateDataViewFluentBuilder::set_dataset_id): <p>The unique Dataset identifier that is used to create a Dataview.</p>
