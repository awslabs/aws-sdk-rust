...
impl Builder {
    ...
    /// use aws_sdk_finspacedata::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_finspacedata::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
