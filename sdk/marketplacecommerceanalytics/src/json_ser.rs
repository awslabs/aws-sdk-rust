...
pub fn serialize_structure_crate_input_generate_data_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateDataSetInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
...
pub fn serialize_structure_crate_input_start_support_data_export_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartSupportDataExportInput) -> Result<(), aws_smithy_http::operation::SerializationError> {
