...
pub fn serialize_structure_generate_data_set_input(
    ...
    if let Some(var_2) = &input.data_set_publication_date {
        object
            ...
            .instant(var_2, smithy_types::instant::Format::EpochSeconds);
    }
...
pub fn serialize_structure_start_support_data_export_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
