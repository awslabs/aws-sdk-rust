...
impl std::fmt::Display for StartSupportDataExportError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            StartSupportDataExportErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl StartSupportDataExportError {
    /// Creates a new `StartSupportDataExportError`.
                    ...
                    pub fn unhandled(err: impl Into<Box<dyn std::error::Error + Send + Sync + 'static>>) -> Self {
                        Self {
                            kind: StartSupportDataExportErrorKind::Unhandled(crate::error::Unhandled::new(err.into())),
                            meta: Default::default()
                        }
                    }
    ...
    pub fn is_marketplace_commerce_analytics_exception(&self) -> bool {
        matches!(&self.kind, StartSupportDataExportErrorKind::MarketplaceCommerceAnalyticsException(_))
    }
}
...
impl std::fmt::Display for GenerateDataSetError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match &self.kind {
            ...
            _inner.fmt(f)
            ,
            GenerateDataSetErrorKind::Unhandled(_inner) => {
                _inner.fmt(f)
            }
        }
    }
...
impl GenerateDataSetError {
    ...
    pub fn is_marketplace_commerce_analytics_exception(&self) -> bool {
        matches!(&self.kind, GenerateDataSetErrorKind::MarketplaceCommerceAnalyticsException(_))
    }
}
