...
impl GenerateDataSetInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_data_set::GenerateDataSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_data_set::GenerateDataSetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_data_set::ser_generate_data_set_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_data_set::GenerateDataSet::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GenerateDataSet", "marketplacecommerceanalytics"));
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateDataSet {
                type Output = std::result::Result<crate::operation::generate_data_set::GenerateDataSetOutput, crate::operation::generate_data_set::GenerateDataSetError>;
