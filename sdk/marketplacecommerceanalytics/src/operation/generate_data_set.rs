...
impl GenerateDataSetInput {
    /// Consumes the builder and constructs an Operation<[`GenerateDataSet`](crate::operation::generate_data_set::GenerateDataSet)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::generate_data_set::GenerateDataSet, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_generate_data_set::ser_generate_data_set_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_data_set::GenerateDataSet::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("GenerateDataSet", "marketplacecommerceanalytics"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateDataSet {
    type Output =
        ::std::result::Result<crate::operation::generate_data_set::GenerateDataSetOutput, crate::operation::generate_data_set::GenerateDataSetError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_data_set::de_generate_data_set_http_response_with_props(status, headers, body)
        }
    }
}
