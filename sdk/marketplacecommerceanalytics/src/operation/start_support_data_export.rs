...
impl StartSupportDataExportInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_support_data_export::StartSupportDataExport::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for StartSupportDataExport {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_start_support_data_export::de_start_support_data_export_http_error(response)
        } else {
            crate::protocol_serde::shape_start_support_data_export::de_start_support_data_export_http_response(response)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::start_support_data_export::StartSupportDataExportError
{
