...
pub fn ser_generate_data_set_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GenerateDataSetInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
