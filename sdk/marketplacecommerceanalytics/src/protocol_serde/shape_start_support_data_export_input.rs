...
pub fn ser_start_support_data_export_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::start_support_data_export::StartSupportDataExportInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
