...
pub mod generate_data_set_input {
    ...
    impl Builder {
        ...
        /// </ul> 
        /// <p></p>
        pub fn set_data_set_type(mut self, input: std::option::Option<crate::model::DataSetType>) -> Self {
        ...
        pub fn build(self) -> Result<crate::input::GenerateDataSetInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GenerateDataSetInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GenerateDataSet, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GenerateDataSetInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GenerateDataSet::new())
...
pub mod start_support_data_export_input {
    ...
    impl Builder {
        ...
        /// </ul> 
        /// <p></p>
        pub fn set_data_set_type(mut self, input: std::option::Option<crate::model::SupportDataSetType>) -> Self {
            self.data_set_type = input; self
        }
        ...
        pub fn build(self) -> Result<crate::input::StartSupportDataExportInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl StartSupportDataExportInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::StartSupportDataExport, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        ...
        let mut properties = aws_smithy_http::property_bag::SharedPropertyBag::new();
        #[allow(clippy::useless_conversion)]let body = aws_smithy_http::body::SdkBody::from(
            crate::operation_ser::serialize_operation_crate_operation_start_support_data_export(&self)?
        );
        if let Some(content_length) = body.content_length() {
                                request = aws_smithy_http::header::set_request_header_if_absent(request, http::header::CONTENT_LENGTH, content_length);
                            }
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::StartSupportDataExport::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("StartSupportDataExport", "marketplacecommerceanalytics"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub struct StartSupportDataExportInput  {
    ...
    /// </ul> 
    /// <p></p>
    #[doc(hidden)]pub data_set_type: std::option::Option<crate::model::SupportDataSetType>,
    /// The start date from which to retrieve the data set in UTC. This parameter only affects the customer_support_contacts_data data set type.
    #[doc(hidden)]pub from_date: std::option::Option<aws_smithy_types::DateTime>,
    /// The Amazon Resource Name (ARN) of the Role with an attached permissions policy to interact with the provided AWS services.
    #[doc(hidden)]pub role_name_arn: std::option::Option<std::string::String>,
    /// The name (friendly name, not ARN) of the destination S3 bucket.
    #[doc(hidden)]pub destination_s3_bucket_name: std::option::Option<std::string::String>,
    /// (Optional) The desired S3 prefix for the published data set, similar to a directory path in standard file systems. For example, if given the bucket name "mybucket" and the prefix "myprefix/mydatasets", the output file "outputfile" would be published to "s3://mybucket/myprefix/mydatasets/outputfile". If the prefix directory structure does not exist, it will be created. If no prefix is provided, the data set will be published to the S3 bucket root.
    #[doc(hidden)]pub destination_s3_prefix: std::option::Option<std::string::String>,
    /// Amazon Resource Name (ARN) for the SNS Topic that will be notified when the data set has been published or if an error has occurred.
    #[doc(hidden)]pub sns_topic_arn: std::option::Option<std::string::String>,
    /// (Optional) Key-value pairs which will be returned, unmodified, in the Amazon SNS notification message and the data set metadata file.
    #[doc(hidden)]pub customer_defined_values: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl StartSupportDataExportInput {
    /// <p> Specifies the data set type to be written to the output csv file. The data set types customer_support_contacts_data and test_customer_support_contacts_data both result in a csv file containing the following fields: Product Id, Product Code, Customer Guid, Subscription Guid, Subscription Start Date, Organization, AWS Account Id, Given Name, Surname, Telephone Number, Email, Title, Country Code, ZIP Code, Operation Type, and Operation Time. </p> 
    /// <p> </p>
...
impl  std::fmt::Debug for StartSupportDataExportInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("destination_s3_bucket_name", &self.destination_s3_bucket_name);
...
pub struct GenerateDataSetInput  {
    ...
    /// </ul> 
    /// <p></p>
    #[doc(hidden)]pub data_set_type: std::option::Option<crate::model::DataSetType>,
    /// The date a data set was published. For daily data sets, provide a date with day-level granularity for the desired day. For monthly data sets except those with prefix disbursed_amount, provide a date with month-level granularity for the desired month (the day value will be ignored). For data sets with prefix disbursed_amount, provide a date with day-level granularity for the desired day. For these data sets we will look backwards in time over the range of 31 days until the first data set is found (the latest one).
    #[doc(hidden)]pub data_set_publication_date: std::option::Option<aws_smithy_types::DateTime>,
    /// The Amazon Resource Name (ARN) of the Role with an attached permissions policy to interact with the provided AWS services.
    #[doc(hidden)]pub role_name_arn: std::option::Option<std::string::String>,
    /// The name (friendly name, not ARN) of the destination S3 bucket.
    #[doc(hidden)]pub destination_s3_bucket_name: std::option::Option<std::string::String>,
