...
impl Client  {
    ...
    pub fn generate_data_set(&self) -> crate::client::fluent_builders::GenerateDataSet {
                            crate::client::fluent_builders::GenerateDataSet::new(self.handle.clone())
                        }
    ...
    pub fn start_support_data_export(&self) -> crate::client::fluent_builders::StartSupportDataExport {
                            crate::client::fluent_builders::StartSupportDataExport::new(self.handle.clone())
                        }
}
