    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`StartSupportDataExportInput`](crate::input::StartSupportDataExportInput) with field(s):
    ///   - [`data_set_type(Option<SupportDataSetType>)`](crate::input::StartSupportDataExportInput::data_set_type): <p> Specifies the data set type to be written to the output csv file. The data set types customer_support_contacts_data and test_customer_support_contacts_data both result in a csv file containing the following fields: Product Id, Product Code, Customer Guid, Subscription Guid, Subscription Start Date, Organization, AWS Account Id, Given Name, Surname, Telephone Number, Email, Title, Country Code, ZIP Code, Operation Type, and Operation Time. </p>  <p> </p> <ul>   <li><i>customer_support_contacts_data</i> Customer support contact data. The data set will contain all changes (Creates, Updates, and Deletes) to customer support contact data from the date specified in the from_date parameter.</li>   <li><i>test_customer_support_contacts_data</i> An example data set containing static test data in the same format as customer_support_contacts_data</li>  </ul>  <p></p>
    ///   - [`from_date(Option<DateTime>)`](crate::input::StartSupportDataExportInput::from_date): The start date from which to retrieve the data set in UTC. This parameter only affects the customer_support_contacts_data data set type.
    ///   - [`role_name_arn(Option<String>)`](crate::input::StartSupportDataExportInput::role_name_arn): The Amazon Resource Name (ARN) of the Role with an attached permissions policy to interact with the provided AWS services.
    ///   - [`destination_s3_bucket_name(Option<String>)`](crate::input::StartSupportDataExportInput::destination_s3_bucket_name): The name (friendly name, not ARN) of the destination S3 bucket.
    ///   - [`destination_s3_prefix(Option<String>)`](crate::input::StartSupportDataExportInput::destination_s3_prefix): (Optional) The desired S3 prefix for the published data set, similar to a directory path in standard file systems. For example, if given the bucket name "mybucket" and the prefix "myprefix/mydatasets", the output file "outputfile" would be published to "s3://mybucket/myprefix/mydatasets/outputfile". If the prefix directory structure does not exist, it will be created. If no prefix is provided, the data set will be published to the S3 bucket root.
    ///   - [`sns_topic_arn(Option<String>)`](crate::input::StartSupportDataExportInput::sns_topic_arn): Amazon Resource Name (ARN) for the SNS Topic that will be notified when the data set has been published or if an error has occurred.
    ///   - [`customer_defined_values(Option<HashMap<String, String>>)`](crate::input::StartSupportDataExportInput::customer_defined_values): (Optional) Key-value pairs which will be returned, unmodified, in the Amazon SNS notification message and the data set metadata file.
