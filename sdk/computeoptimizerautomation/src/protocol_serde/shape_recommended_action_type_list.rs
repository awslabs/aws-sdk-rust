...
pub(crate) fn de_recommended_action_type_list(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<::std::vec::Vec<crate::types::RecommendedActionType>, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn member(
        mut list: ::std::vec::Vec<crate::types::RecommendedActionType>,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<::std::vec::Vec<crate::types::RecommendedActionType>, ::aws_smithy_cbor::decode::DeserializeError> {
