...
pub(crate) fn de_forbidden_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ForbiddenExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ForbiddenExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
