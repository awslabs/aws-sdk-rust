    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/ComputeOptimizerAutomationService/operation/ListTagsForResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::OptInRequiredException`.
