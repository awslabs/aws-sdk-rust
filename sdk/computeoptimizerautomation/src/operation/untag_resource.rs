...
impl UntagResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Compute Optimizer Automation.UntagResource",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::untag_resource::UntagResourceInput = input.downcast_mut().expect("correct type");
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/ComputeOptimizerAutomationService/operation/UntagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl UntagResourceError {
    ...
    /// Returns `true` if the error kind is `UntagResourceError::IdempotencyTokenInUseException`.
    pub fn is_idempotency_token_in_use_exception(&self) -> bool {
        matches!(self, Self::IdempotencyTokenInUseException(_))
    }
    /// Returns `true` if the error kind is `UntagResourceError::IdempotentParameterMismatchException`.
    ...
    /// Returns `true` if the error kind is `UntagResourceError::OptInRequiredException`.
