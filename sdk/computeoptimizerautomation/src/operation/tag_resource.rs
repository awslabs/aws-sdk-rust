...
impl TagResource {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Compute Optimizer Automation.TagResource",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::tag_resource::TagResourceInput = input.downcast_mut().expect("correct type");
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/ComputeOptimizerAutomationService/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl TagResourceError {
    ...
    /// Returns `true` if the error kind is `TagResourceError::IdempotencyTokenInUseException`.
    pub fn is_idempotency_token_in_use_exception(&self) -> bool {
        matches!(self, Self::IdempotencyTokenInUseException(_))
    }
    /// Returns `true` if the error kind is `TagResourceError::IdempotentParameterMismatchException`.
    ...
    /// Returns `true` if the error kind is `TagResourceError::OptInRequiredException`.
