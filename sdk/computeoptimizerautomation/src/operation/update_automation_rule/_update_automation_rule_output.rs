...
pub struct UpdateAutomationRuleOutput {
...
impl ::aws_types::request_id::RequestId for UpdateAutomationRuleOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl UpdateAutomationRuleOutput {
    /// Creates a new builder-style object to manufacture [`UpdateAutomationRuleOutput`](crate::operation::update_automation_rule::UpdateAutomationRuleOutput).
    pub fn builder() -> crate::operation::update_automation_rule::builders::UpdateAutomationRuleOutputBuilder {
        crate::operation::update_automation_rule::builders::UpdateAutomationRuleOutputBuilder::default()
    }
}

/// A builder for [`UpdateAutomationRuleOutput`](crate::operation::update_automation_rule::UpdateAutomationRuleOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct UpdateAutomationRuleOutputBuilder {
...
impl UpdateAutomationRuleOutputBuilder {
    /// <p>The ARN of the updated rule.</p>
    ...
    /// Consumes the builder and constructs a [`UpdateAutomationRuleOutput`](crate::operation::update_automation_rule::UpdateAutomationRuleOutput).
    pub fn build(self) -> crate::operation::update_automation_rule::UpdateAutomationRuleOutput {
