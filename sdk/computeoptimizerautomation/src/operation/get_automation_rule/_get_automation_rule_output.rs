...
pub struct GetAutomationRuleOutput {
...
impl ::aws_types::request_id::RequestId for GetAutomationRuleOutput {
    fn request_id(&self) -> Option<&str> {
        self._request_id.as_deref()
    }
}
impl GetAutomationRuleOutput {
    /// Creates a new builder-style object to manufacture [`GetAutomationRuleOutput`](crate::operation::get_automation_rule::GetAutomationRuleOutput).
    pub fn builder() -> crate::operation::get_automation_rule::builders::GetAutomationRuleOutputBuilder {
        crate::operation::get_automation_rule::builders::GetAutomationRuleOutputBuilder::default()
    }
}

/// A builder for [`GetAutomationRuleOutput`](crate::operation::get_automation_rule::GetAutomationRuleOutput).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct GetAutomationRuleOutputBuilder {
...
impl GetAutomationRuleOutputBuilder {
    /// <p>The Amazon Resource Name (ARN) of the automation rule.</p>
    ...
    /// Consumes the builder and constructs a [`GetAutomationRuleOutput`](crate::operation::get_automation_rule::GetAutomationRuleOutput).
    pub fn build(self) -> crate::operation::get_automation_rule::GetAutomationRuleOutput {
        crate::operation::get_automation_rule::GetAutomationRuleOutput {
