...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAccountsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_accounts::de_list_accounts_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_accounts::de_list_accounts_http_response(status, headers, body, _cfg)
        };
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/ComputeOptimizerAutomationService/operation/ListAccounts").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_accounts::ser_list_accounts_input(&input)?);
...
impl ListAccountsError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NotManagementAccountException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
    ...
    /// Returns `true` if the error kind is `ListAccountsError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `ListAccountsError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsError::NotManagementAccountException`.
    pub fn is_not_management_account_exception(&self) -> bool {
        matches!(self, Self::NotManagementAccountException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsError::OptInRequiredException`.
    ...
    /// Returns `true` if the error kind is `ListAccountsError::ThrottlingException`.
...
impl ::std::error::Error for ListAccountsError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::NotManagementAccountException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::std::fmt::Display for ListAccountsError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            Self::NotManagementAccountException(_inner) => _inner.fmt(f),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAccountsError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::NotManagementAccountException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
