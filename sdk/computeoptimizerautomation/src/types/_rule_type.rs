...
impl ::std::convert::From<&str> for RuleType {
    fn from(s: &str) -> Self {
        match s {
            "AccountRule" => RuleType::AccountRule,
            "OrganizationRule" => RuleType::OrganizationalRule,
...
impl RuleType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RuleType::AccountRule => "AccountRule",
            RuleType::OrganizationalRule => "OrganizationRule",
            RuleType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["AccountRule", "OrganizationRule"]
    }
}
...
impl ::std::fmt::Display for RuleType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RuleType::AccountRule => write!(f, "AccountRule"),
            RuleType::OrganizationalRule => write!(f, "OrganizationRule"),
