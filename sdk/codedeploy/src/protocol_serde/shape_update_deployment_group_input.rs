...
pub fn ser_update_deployment_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateDeploymentGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
