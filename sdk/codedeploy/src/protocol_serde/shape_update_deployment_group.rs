...
pub fn ser_update_deployment_group_input(input: &crate::input::UpdateDeploymentGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_update_deployment_group_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateDeploymentGroupOutput, crate::error::UpdateDeploymentGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::UpdateDeploymentGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_deployment_group_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::UpdateDeploymentGroupOutput, crate::error::UpdateDeploymentGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::update_deployment_group_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_update_deployment_group::de_update_deployment_group(response.body().as_ref(), output).map_err(crate::error::UpdateDeploymentGroupError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_update_deployment_group(value: &[u8], mut builder: crate::output::update_deployment_group_output::Builder) -> Result<crate::output::update_deployment_group_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
