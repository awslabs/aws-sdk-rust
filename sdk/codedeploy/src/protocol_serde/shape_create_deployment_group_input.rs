...
pub fn ser_create_deployment_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateDeploymentGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
