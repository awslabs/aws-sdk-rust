...
> {
    ...
    Err(match error_code {
        "InvalidNextTokenException" => {
            crate::operation::list_applications::ListApplicationsError::InvalidNextTokenException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
                    ...
                    let _ = response;
                    output = crate::protocol_serde::shape_invalid_next_token_exception::de_invalid_next_token_exception_json_err(response.body().as_ref(), output).map_err(crate::operation::list_applications::ListApplicationsError::unhandled)?;
