...
pub fn ser_register_application_revision_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::RegisterApplicationRevisionInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
