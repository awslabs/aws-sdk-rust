...
> {
    ...
    .map_err(
        crate::operation::delete_git_hub_account_token::DeleteGitHubAccountTokenError::unhandled,
    )?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_git_hub_account_token_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
pub(crate) fn de_delete_git_hub_account_token(
    value: &[u8],
    mut builder: crate::operation::delete_git_hub_account_token::builders::DeleteGitHubAccountTokenOutputBuilder,
) -> Result<
    crate::operation::delete_git_hub_account_token::builders::DeleteGitHubAccountTokenOutputBuilder,
