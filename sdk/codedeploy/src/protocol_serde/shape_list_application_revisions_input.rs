...
pub fn ser_list_application_revisions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListApplicationRevisionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
