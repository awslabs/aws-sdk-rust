...
pub fn ser_delete_deployment_group_input(
    ...
    crate::protocol_serde::shape_delete_deployment_group_input::ser_delete_deployment_group_input(
        &mut object,
        input,
    )?;
    object.finish();
...
> {
    ...
    let error_code =
        match generic.code() {
            Some(code) => code,
            None => return Err(
                crate::operation::delete_deployment_group::DeleteDeploymentGroupError::unhandled(
                    generic,
                ),
            ),
        };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_deployment_group_http_response_with_props(
    _response_status: u16,
    _response_headers: &http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_deployment_group::de_delete_deployment_group(
            _response_body,
            output,
        )
        .map_err(
