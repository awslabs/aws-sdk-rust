...
pub fn ser_delete_deployment_group_input(input: &crate::operation::delete_deployment_group::DeleteDeploymentGroupInput) -> Result<aws_smithy_http::body::SdkBody, aws_smithy_http::operation::error::SerializationError> {
