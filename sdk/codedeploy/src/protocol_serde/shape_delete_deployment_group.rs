...
pub fn de_delete_deployment_group_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_deployment_group::DeleteDeploymentGroupOutput, crate::operation::delete_deployment_group::DeleteDeploymentGroupError> {
    #[allow(unused_mut)]
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::delete_deployment_group::DeleteDeploymentGroupError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ApplicationNameRequiredException" => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::ApplicationNameRequiredException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "DeploymentGroupNameRequiredException" => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::DeploymentGroupNameRequiredException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidApplicationNameException" => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::InvalidApplicationNameException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidDeploymentGroupNameException" => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::InvalidDeploymentGroupNameException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidRoleException" => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::InvalidRoleException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::delete_deployment_group::DeleteDeploymentGroupError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_deployment_group_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_deployment_group::DeleteDeploymentGroupOutput, crate::operation::delete_deployment_group::DeleteDeploymentGroupError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_delete_deployment_group_input(input: &crate::operation::delete_deployment_group::DeleteDeploymentGroupInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_delete_deployment_group_input::ser_delete_deployment_group_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_delete_deployment_group(value: &[u8], mut builder: crate::operation::delete_deployment_group::builders::DeleteDeploymentGroupOutputBuilder) -> Result<crate::operation::delete_deployment_group::builders::DeleteDeploymentGroupOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
