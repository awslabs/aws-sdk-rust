...
pub(crate) fn de_deployment_info<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DeploymentInfo>, aws_smithy_json::deserialize::error::DeserializeError>
