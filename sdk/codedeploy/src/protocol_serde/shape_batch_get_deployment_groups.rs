...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        "ApplicationDoesNotExistException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::ApplicationDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ApplicationNameRequiredException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::ApplicationNameRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "BatchLimitExceededException" => crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::BatchLimitExceededException({
            ...
            let mut tmp = {
                ...
                output =
                    crate::protocol_serde::shape_batch_limit_exceeded_exception::de_batch_limit_exceeded_exception_json_err(_response_body, output)
                        .map_err(crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::unhandled)?;
                let output = output.meta(generic);
                output.build()
            };
        ...
        "DeploymentConfigDoesNotExistException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::DeploymentConfigDoesNotExistException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "DeploymentGroupNameRequiredException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::DeploymentGroupNameRequiredException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidApplicationNameException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::InvalidApplicationNameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidDeploymentGroupNameException" => {
            crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::InvalidDeploymentGroupNameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_deployment_groups::de_batch_get_deployment_groups(_response_body, output)
            .map_err(crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "deploymentGroupsInfo" => {
                    builder = builder.set_deployment_groups_info(
                        crate::protocol_serde::shape_deployment_group_info_list::de_deployment_group_info_list(tokens, _value, depth + 1)?,
                    );
                }
                "errorMessage" => {
