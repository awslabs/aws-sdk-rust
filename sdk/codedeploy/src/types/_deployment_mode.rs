...
impl ::std::convert::From<&str> for DeploymentMode {
    fn from(s: &str) -> Self {
        match s {
            "RESTART" => DeploymentMode::Restart,
            "STANDARD" => DeploymentMode::Standard,
            other => DeploymentMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DeploymentMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DeploymentMode::from(s))
    }
}
impl DeploymentMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DeploymentMode::Restart => "RESTART",
...
impl ::std::fmt::Display for DeploymentMode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DeploymentMode::Restart => write!(f, "RESTART"),
