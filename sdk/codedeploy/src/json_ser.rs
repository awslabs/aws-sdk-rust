...
pub fn serialize_structure_add_tags_to_on_premises_instances_input(
...
pub fn serialize_structure_batch_get_application_revisions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_11 in var_9 {
            {
                ...
                crate::json_ser::serialize_structure_revision_location(&mut object_12, item_11);
                object_12.finish();
            }
        }
        array_10.finish();
...
pub fn serialize_structure_batch_get_applications_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_deployment_groups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_deployment_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_deployments_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_deployment_targets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_batch_get_on_premises_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_continue_deployment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_deployment_input(
    ...
    if let Some(var_44) = &input.revision {
        ...
        crate::json_ser::serialize_structure_revision_location(&mut object_45, var_44);
        object_45.finish();
    }
    ...
    if let Some(var_48) = &input.target_instances {
        ...
        crate::json_ser::serialize_structure_target_instances(&mut object_49, var_48);
        object_49.finish();
    }
    if let Some(var_50) = &input.auto_rollback_configuration {
        let mut object_51 = object.key("autoRollbackConfiguration").start_object();
        crate::json_ser::serialize_structure_auto_rollback_configuration(&mut object_51, var_50);
        object_51.finish();
    }
...
pub fn serialize_structure_create_deployment_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_54) = &input.minimum_healthy_hosts {
        ...
        crate::json_ser::serialize_structure_minimum_healthy_hosts(&mut object_55, var_54);
        object_55.finish();
    }
    if let Some(var_56) = &input.traffic_routing_config {
        let mut object_57 = object.key("trafficRoutingConfig").start_object();
        crate::json_ser::serialize_structure_traffic_routing_config(&mut object_57, var_56);
        object_57.finish();
    }
...
pub fn serialize_structure_create_deployment_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_64 in var_62 {
            {
                ...
                crate::json_ser::serialize_structure_ec2_tag_filter(&mut object_65, item_64);
                object_65.finish();
            }
        }
        array_63.finish();
        ...
        for item_68 in var_66 {
            {
                ...
                crate::json_ser::serialize_structure_tag_filter(&mut object_69, item_68);
                object_69.finish();
            }
        }
        array_67.finish();
        ...
        for item_76 in var_74 {
            {
                ...
                crate::json_ser::serialize_structure_trigger_config(&mut object_77, item_76);
                object_77.finish();
            }
        }
        array_75.finish();
    ...
    if let Some(var_78) = &input.alarm_configuration {
        ...
        crate::json_ser::serialize_structure_alarm_configuration(&mut object_79, var_78);
        object_79.finish();
    }
    if let Some(var_80) = &input.auto_rollback_configuration {
        let mut object_81 = object.key("autoRollbackConfiguration").start_object();
        crate::json_ser::serialize_structure_auto_rollback_configuration(&mut object_81, var_80);
        object_81.finish();
    }
    ...
    if let Some(var_83) = &input.deployment_style {
        ...
        crate::json_ser::serialize_structure_deployment_style(&mut object_84, var_83);
        object_84.finish();
    }
    if let Some(var_85) = &input.blue_green_deployment_configuration {
        let mut object_86 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_blue_green_deployment_configuration(
            &mut object_86,
            var_85,
        );
        object_86.finish();
    ...
    if let Some(var_87) = &input.load_balancer_info {
        ...
        crate::json_ser::serialize_structure_load_balancer_info(&mut object_88, var_87);
        object_88.finish();
    }
    if let Some(var_89) = &input.ec2_tag_set {
        let mut object_90 = object.key("ec2TagSet").start_object();
        crate::json_ser::serialize_structure_ec2_tag_set(&mut object_90, var_89);
        object_90.finish();
    }
        ...
        for item_93 in var_91 {
            {
                ...
                crate::json_ser::serialize_structure_ecs_service(&mut object_94, item_93);
                object_94.finish();
            }
        }
        array_92.finish();
    ...
    if let Some(var_95) = &input.on_premises_tag_set {
        ...
        crate::json_ser::serialize_structure_on_premises_tag_set(&mut object_96, var_95);
        object_96.finish();
    }
        ...
        for item_99 in var_97 {
            {
                ...
                crate::json_ser::serialize_structure_tag(&mut object_100, item_99);
                object_100.finish();
            }
        }
        array_98.finish();
...
pub fn serialize_structure_delete_deployment_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_deployment_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_git_hub_account_token_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_delete_resources_by_external_id_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_deregister_on_premises_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_application_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_application_revision_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_110) = &input.revision {
        ...
        crate::json_ser::serialize_structure_revision_location(&mut object_111, var_110);
        object_111.finish();
    }
}

pub fn serialize_structure_get_deployment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_deployment_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_deployment_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_deployment_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_deployment_target_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_on_premises_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_application_revisions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_deployment_configs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_deployment_groups_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_deployment_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_deployments_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_146) = &input.create_time_range {
        ...
        crate::json_ser::serialize_structure_time_range(&mut object_147, var_146);
        object_147.finish();
    }
...
pub fn serialize_structure_list_deployment_targets_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_git_hub_account_token_names_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_on_premises_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_161 in var_159 {
            {
                ...
                crate::json_ser::serialize_structure_tag_filter(&mut object_162, item_161);
                object_162.finish();
            }
        }
        array_160.finish();
...
pub fn serialize_structure_put_lifecycle_event_hook_execution_status_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_register_application_revision_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_171) = &input.revision {
        ...
        crate::json_ser::serialize_structure_revision_location(&mut object_172, var_171);
        object_172.finish();
    }
}

pub fn serialize_structure_register_on_premises_instance_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_remove_tags_from_on_premises_instances_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_skip_wait_time_for_instance_termination_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_stop_deployment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_189 in var_187 {
            {
                ...
                crate::json_ser::serialize_structure_tag(&mut object_190, item_189);
                object_190.finish();
            }
        }
        array_188.finish();
...
pub fn serialize_structure_update_deployment_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_203 in var_201 {
            {
                ...
                crate::json_ser::serialize_structure_ec2_tag_filter(&mut object_204, item_203);
                object_204.finish();
            }
        }
        array_202.finish();
        ...
        for item_207 in var_205 {
            {
                ...
                crate::json_ser::serialize_structure_tag_filter(&mut object_208, item_207);
                object_208.finish();
            }
        }
        array_206.finish();
        ...
        for item_215 in var_213 {
            {
                ...
                crate::json_ser::serialize_structure_trigger_config(&mut object_216, item_215);
                object_216.finish();
            }
        }
        array_214.finish();
    ...
    if let Some(var_217) = &input.alarm_configuration {
        ...
        crate::json_ser::serialize_structure_alarm_configuration(&mut object_218, var_217);
        object_218.finish();
    }
    if let Some(var_219) = &input.auto_rollback_configuration {
        ...
        crate::json_ser::serialize_structure_auto_rollback_configuration(&mut object_220, var_219);
        object_220.finish();
    }
    ...
    if let Some(var_222) = &input.deployment_style {
        ...
        crate::json_ser::serialize_structure_deployment_style(&mut object_223, var_222);
        object_223.finish();
    }
    ...
    if let Some(var_226) = &input.load_balancer_info {
        ...
        crate::json_ser::serialize_structure_load_balancer_info(&mut object_227, var_226);
        object_227.finish();
    }
    if let Some(var_228) = &input.ec2_tag_set {
        let mut object_229 = object.key("ec2TagSet").start_object();
        crate::json_ser::serialize_structure_ec2_tag_set(&mut object_229, var_228);
        object_229.finish();
    }
        ...
        for item_232 in var_230 {
            {
                ...
                crate::json_ser::serialize_structure_ecs_service(&mut object_233, item_232);
                object_233.finish();
            }
        }
        array_231.finish();
    ...
    if let Some(var_234) = &input.on_premises_tag_set {
        ...
        crate::json_ser::serialize_structure_on_premises_tag_set(&mut object_235, var_234);
        object_235.finish();
    }
}
...
pub fn serialize_structure_revision_location(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_239) = &input.s3_location {
        ...
        crate::json_ser::serialize_structure_s3_location(&mut object_240, var_239);
        object_240.finish();
    }
    if let Some(var_241) = &input.git_hub_location {
        let mut object_242 = object.key("gitHubLocation").start_object();
        crate::json_ser::serialize_structure_git_hub_location(&mut object_242, var_241);
        object_242.finish();
    }
    if let Some(var_243) = &input.string {
        let mut object_244 = object.key("string").start_object();
        crate::json_ser::serialize_structure_raw_string(&mut object_244, var_243);
        object_244.finish();
    }
    if let Some(var_245) = &input.app_spec_content {
        let mut object_246 = object.key("appSpecContent").start_object();
        crate::json_ser::serialize_structure_app_spec_content(&mut object_246, var_245);
        object_246.finish();
    }
}

pub fn serialize_structure_target_instances(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_249 in var_247 {
            {
                ...
                crate::json_ser::serialize_structure_ec2_tag_filter(&mut object_250, item_249);
                object_250.finish();
            }
        }
        array_248.finish();
    ...
    if let Some(var_254) = &input.ec2_tag_set {
        ...
        crate::json_ser::serialize_structure_ec2_tag_set(&mut object_255, var_254);
        object_255.finish();
    }
}

pub fn serialize_structure_auto_rollback_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_minimum_healthy_hosts(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_traffic_routing_config(
    ...
    if let Some(var_261) = &input.time_based_canary {
        ...
        crate::json_ser::serialize_structure_time_based_canary(&mut object_262, var_261);
        object_262.finish();
    }
    if let Some(var_263) = &input.time_based_linear {
        let mut object_264 = object.key("timeBasedLinear").start_object();
        crate::json_ser::serialize_structure_time_based_linear(&mut object_264, var_263);
        object_264.finish();
    }
}

pub fn serialize_structure_ec2_tag_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_alarm_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_278 in var_276 {
            {
                ...
                crate::json_ser::serialize_structure_alarm(&mut object_279, item_278);
                object_279.finish();
            }
        }
        array_277.finish();
...
pub fn serialize_structure_deployment_style(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_blue_green_deployment_configuration(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_282) = &input.terminate_blue_instances_on_deployment_success {
        let mut object_283 = object
            ...
            .start_object();
        crate::json_ser::serialize_structure_blue_instance_termination_option(
            &mut object_283,
            var_282,
        );
        object_283.finish();
    ...
    if let Some(var_284) = &input.deployment_ready_option {
        ...
        crate::json_ser::serialize_structure_deployment_ready_option(&mut object_285, var_284);
        object_285.finish();
    }
    if let Some(var_286) = &input.green_fleet_provisioning_option {
        ...
        crate::json_ser::serialize_structure_green_fleet_provisioning_option(
            &mut object_287,
            var_286,
        );
        object_287.finish();
...
pub fn serialize_structure_load_balancer_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_290 in var_288 {
            {
                ...
                crate::json_ser::serialize_structure_elb_info(&mut object_291, item_290);
                object_291.finish();
            }
        }
        array_289.finish();
        ...
        for item_294 in var_292 {
            {
                ...
                crate::json_ser::serialize_structure_target_group_info(&mut object_295, item_294);
                object_295.finish();
            }
        }
        array_293.finish();
        ...
        for item_298 in var_296 {
            {
                ...
                crate::json_ser::serialize_structure_target_group_pair_info(
                    &mut object_299,
                    item_298,
                );
                object_299.finish();
...
pub fn serialize_structure_ec2_tag_set(
    object: &mut smithy_json::serialize::JsonObjectWriter,
                ...
                for item_304 in item_302 {
                    {
                        ...
                        crate::json_ser::serialize_structure_ec2_tag_filter(
                            &mut object_305,
                            item_304,
                        );
                        object_305.finish();
...
pub fn serialize_structure_ecs_service(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_on_premises_tag_set(
    object: &mut smithy_json::serialize::JsonObjectWriter,
                ...
                for item_312 in item_310 {
                    {
                        ...
                        crate::json_ser::serialize_structure_tag_filter(&mut object_313, item_312);
                        object_313.finish();
                    }
                }
                array_311.finish();
...
pub fn serialize_structure_git_hub_location(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_raw_string(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_app_spec_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_time_based_canary(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.canary_percentage != 0 {
        object.key("canaryPercentage").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.canary_percentage).into()),
        );
    }
    if input.canary_interval != 0 {
        object.key("canaryInterval").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.canary_interval).into()),
        );
    }
}

pub fn serialize_structure_time_based_linear(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.linear_percentage != 0 {
        object.key("linearPercentage").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.linear_percentage).into()),
        );
    }
    if input.linear_interval != 0 {
        object.key("linearInterval").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.linear_interval).into()),
        );
    }
}
...
pub fn serialize_structure_blue_instance_termination_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.termination_wait_time_in_minutes != 0 {
        object.key("terminationWaitTimeInMinutes").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.termination_wait_time_in_minutes).into()),
        );
    }
}

pub fn serialize_structure_deployment_ready_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if input.wait_time_in_minutes != 0 {
        object.key("waitTimeInMinutes").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((input.wait_time_in_minutes).into()),
        );
    }
}

pub fn serialize_structure_green_fleet_provisioning_option(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_elb_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_target_group_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_target_group_pair_info(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_335 in var_333 {
            {
                ...
                crate::json_ser::serialize_structure_target_group_info(&mut object_336, item_335);
                object_336.finish();
            }
        }
        array_334.finish();
    ...
    if let Some(var_337) = &input.prod_traffic_route {
        ...
        crate::json_ser::serialize_structure_traffic_route(&mut object_338, var_337);
        object_338.finish();
    }
    if let Some(var_339) = &input.test_traffic_route {
        let mut object_340 = object.key("testTrafficRoute").start_object();
        crate::json_ser::serialize_structure_traffic_route(&mut object_340, var_339);
        object_340.finish();
    }
}

pub fn serialize_structure_traffic_route(
    object: &mut smithy_json::serialize::JsonObjectWriter,
