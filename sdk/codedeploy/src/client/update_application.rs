...
impl super::Client {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::update_application::builders::UpdateApplicationFluentBuilder::set_application_name): <p>The current name of the application you want to change.</p>
