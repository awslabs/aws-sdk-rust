...
impl super::Client {
    ...
    ///   - [`instance_name(impl Into<String>)`](crate::operation::deregister_on_premises_instance::builders::DeregisterOnPremisesInstanceFluentBuilder::instance_name) / [`set_instance_name(Option<String>)`](crate::operation::deregister_on_premises_instance::builders::DeregisterOnPremisesInstanceFluentBuilder::set_instance_name):<br>required: **true**<br><p>The name of the on-premises instance to deregister.</p><br>
