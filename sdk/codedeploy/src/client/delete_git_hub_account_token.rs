...
impl super::Client {
    ...
    ///   - [`token_name(impl Into<String>)`](crate::operation::delete_git_hub_account_token::builders::DeleteGitHubAccountTokenFluentBuilder::token_name) / [`set_token_name(Option<String>)`](crate::operation::delete_git_hub_account_token::builders::DeleteGitHubAccountTokenFluentBuilder::set_token_name):<br>required: **false**<br><p>The name of the GitHub account connection to delete.</p><br>
