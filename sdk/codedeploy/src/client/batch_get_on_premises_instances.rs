...
impl super::Client {
    ...
    ///   - [`instance_names(impl Into<String>)`](crate::operation::batch_get_on_premises_instances::builders::BatchGetOnPremisesInstancesFluentBuilder::instance_names) / [`set_instance_names(Option<Vec::<String>>)`](crate::operation::batch_get_on_premises_instances::builders::BatchGetOnPremisesInstancesFluentBuilder::set_instance_names):<br>required: **true**<br><p>The names of the on-premises instances about which to get information. The maximum number of instance names you can specify is 25.</p><br>
