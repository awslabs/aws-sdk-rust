...
impl super::Client {
    ...
    ///   - [`application_name(impl Into<String>)`](crate::operation::list_deployment_groups::builders::ListDeploymentGroupsFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::list_deployment_groups::builders::ListDeploymentGroupsFluentBuilder::set_application_name): <p>The name of an CodeDeploy application associated with the user or Amazon Web Services account.</p>
