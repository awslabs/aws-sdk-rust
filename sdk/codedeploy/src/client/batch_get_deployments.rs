...
impl super::Client {
    ...
    ///   - [`deployment_ids(impl Into<String>)`](crate::operation::batch_get_deployments::builders::BatchGetDeploymentsFluentBuilder::deployment_ids) / [`set_deployment_ids(Option<Vec<String>>)`](crate::operation::batch_get_deployments::builders::BatchGetDeploymentsFluentBuilder::set_deployment_ids): <p> A list of deployment IDs, separated by spaces. The maximum number of deployment IDs you can specify is 25.</p>
