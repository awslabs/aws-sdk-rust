    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AddTagsToOnPremisesInstancesInput`](crate::input::AddTagsToOnPremisesInstancesInput) with field(s):
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::AddTagsToOnPremisesInstancesInput::tags): <p>The tag key-value pairs to add to the on-premises instances.</p>  <p>Keys and values are both required. Keys cannot be null or empty strings. Value-only tags are not allowed.</p>
    ///   - [`instance_names(Option<Vec<String>>)`](crate::input::AddTagsToOnPremisesInstancesInput::instance_names): <p>The names of the on-premises instances to which to add tags.</p>
    ...
    ///
    /// - Takes [`BatchGetApplicationRevisionsInput`](crate::input::BatchGetApplicationRevisionsInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::BatchGetApplicationRevisionsInput::application_name): <p>The name of an AWS CodeDeploy application about which to get revision information.</p>
    ///   - [`revisions(Option<Vec<RevisionLocation>>)`](crate::input::BatchGetApplicationRevisionsInput::revisions): <p>An array of <code>RevisionLocation</code> objects that specify information to get about the application revisions, including type and location. The maximum number of <code>RevisionLocation</code> objects you can specify is 25.</p>
    ...
    ///
    /// - Takes [`BatchGetApplicationsInput`](crate::input::BatchGetApplicationsInput) with field(s):
    ///   - [`application_names(Option<Vec<String>>)`](crate::input::BatchGetApplicationsInput::application_names): <p>A list of application names separated by spaces. The maximum number of application names you can specify is 100.</p>
    ...
    ///
    /// - Takes [`BatchGetDeploymentGroupsInput`](crate::input::BatchGetDeploymentGroupsInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::BatchGetDeploymentGroupsInput::application_name): <p>The name of an AWS CodeDeploy application associated with the applicable IAM user or AWS account.</p>
    ///   - [`deployment_group_names(Option<Vec<String>>)`](crate::input::BatchGetDeploymentGroupsInput::deployment_group_names): <p>The names of the deployment groups.</p>
    ...
    ///
    /// - Takes [`BatchGetDeploymentInstancesInput`](crate::input::BatchGetDeploymentInstancesInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::BatchGetDeploymentInstancesInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`instance_ids(Option<Vec<String>>)`](crate::input::BatchGetDeploymentInstancesInput::instance_ids): <p>The unique IDs of instances used in the deployment. The maximum number of instance IDs you can specify is 25.</p>
    ...
    ///
    /// - Takes [`BatchGetDeploymentsInput`](crate::input::BatchGetDeploymentsInput) with field(s):
    ///   - [`deployment_ids(Option<Vec<String>>)`](crate::input::BatchGetDeploymentsInput::deployment_ids): <p> A list of deployment IDs, separated by spaces. The maximum number of deployment IDs you can specify is 25.</p>
    ...
    ///
    /// - Takes [`BatchGetOnPremisesInstancesInput`](crate::input::BatchGetOnPremisesInstancesInput) with field(s):
    ///   - [`instance_names(Option<Vec<String>>)`](crate::input::BatchGetOnPremisesInstancesInput::instance_names): <p>The names of the on-premises instances about which to get information. The maximum number of instance names you can specify is 25.</p>
    ...
    ///
    /// - Takes [`ContinueDeploymentInput`](crate::input::ContinueDeploymentInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::ContinueDeploymentInput::deployment_id): <p> The unique ID of a blue/green deployment for which you want to start rerouting traffic to the replacement environment. </p>
    ///   - [`deployment_wait_type(Option<DeploymentWaitType>)`](crate::input::ContinueDeploymentInput::deployment_wait_type): <p> The status of the deployment's waiting period. <code>READY_WAIT</code> indicates that the deployment is ready to start shifting traffic. <code>TERMINATION_WAIT</code> indicates that the traffic is shifted, but the original target is not terminated. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::CreateApplicationInput::application_name): <p>The name of the application. This name must be unique with the applicable IAM user or AWS account.</p>
    ///   - [`compute_platform(Option<ComputePlatform>)`](crate::input::CreateApplicationInput::compute_platform): <p> The destination platform type for the deployment (<code>Lambda</code>, <code>Server</code>, or <code>ECS</code>).</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateApplicationInput::tags): <p> The metadata that you apply to CodeDeploy applications to help you organize and categorize them. Each tag consists of a key and an optional value, both of which you define. </p>
    ...
    ///
    /// - Takes [`CreateDeploymentConfigInput`](crate::input::CreateDeploymentConfigInput) with field(s):
    ///   - [`deployment_config_name(Option<String>)`](crate::input::CreateDeploymentConfigInput::deployment_config_name): <p>The name of the deployment configuration to create.</p>
    ///   - [`minimum_healthy_hosts(Option<MinimumHealthyHosts>)`](crate::input::CreateDeploymentConfigInput::minimum_healthy_hosts): <p>The minimum number of healthy instances that should be available at any time during the deployment. There are two parameters expected in the input: type and value.</p>  <p>The type parameter takes either of the following values:</p>  <ul>   <li> <p>HOST_COUNT: The value parameter represents the minimum number of healthy instances as an absolute value.</p> </li>   <li> <p>FLEET_PERCENT: The value parameter represents the minimum number of healthy instances as a percentage of the total number of instances in the deployment. If you specify FLEET_PERCENT, at the start of the deployment, AWS CodeDeploy converts the percentage to the equivalent number of instances and rounds up fractional instances.</p> </li>  </ul>  <p>The value parameter takes an integer.</p>  <p>For example, to set a minimum of 95% healthy instance, specify a type of FLEET_PERCENT and a value of 95.</p>
    ///   - [`traffic_routing_config(Option<TrafficRoutingConfig>)`](crate::input::CreateDeploymentConfigInput::traffic_routing_config): <p>The configuration that specifies how the deployment traffic is routed.</p>
    ///   - [`compute_platform(Option<ComputePlatform>)`](crate::input::CreateDeploymentConfigInput::compute_platform): <p>The destination platform type for the deployment (<code>Lambda</code>, <code>Server</code>, or <code>ECS</code>).</p>
    ...
    ///
    /// - Takes [`CreateDeploymentGroupInput`](crate::input::CreateDeploymentGroupInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::CreateDeploymentGroupInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ///   - [`deployment_group_name(Option<String>)`](crate::input::CreateDeploymentGroupInput::deployment_group_name): <p>The name of a new deployment group for the specified application.</p>
    ///   - [`deployment_config_name(Option<String>)`](crate::input::CreateDeploymentGroupInput::deployment_config_name): <p>If specified, the deployment configuration name can be either one of the predefined configurations provided with AWS CodeDeploy or a custom deployment configuration that you create by calling the create deployment configuration operation.</p>  <p> <code>CodeDeployDefault.OneAtATime</code> is the default deployment configuration. It is used if a configuration isn't specified for the deployment or deployment group.</p>  <p>For more information about the predefined deployment configurations in AWS CodeDeploy, see <a href="https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations.html">Working with Deployment Configurations in CodeDeploy</a> in the <i>AWS CodeDeploy User Guide</i>.</p>
    ///   - [`ec2_tag_filters(Option<Vec<Ec2TagFilter>>)`](crate::input::CreateDeploymentGroupInput::ec2_tag_filters): <p>The Amazon EC2 tags on which to filter. The deployment group includes EC2 instances with any of the specified tags. Cannot be used in the same call as ec2TagSet.</p>
    ///   - [`on_premises_instance_tag_filters(Option<Vec<TagFilter>>)`](crate::input::CreateDeploymentGroupInput::on_premises_instance_tag_filters): <p>The on-premises instance tags on which to filter. The deployment group includes on-premises instances with any of the specified tags. Cannot be used in the same call as <code>OnPremisesTagSet</code>.</p>
    ///   - [`auto_scaling_groups(Option<Vec<String>>)`](crate::input::CreateDeploymentGroupInput::auto_scaling_groups): <p>A list of associated Amazon EC2 Auto Scaling groups.</p>
    ///   - [`service_role_arn(Option<String>)`](crate::input::CreateDeploymentGroupInput::service_role_arn): <p>A service role Amazon Resource Name (ARN) that allows AWS CodeDeploy to act on the user's behalf when interacting with AWS services.</p>
    ///   - [`trigger_configurations(Option<Vec<TriggerConfig>>)`](crate::input::CreateDeploymentGroupInput::trigger_configurations): <p>Information about triggers to create when the deployment group is created. For examples, see <a href="https://docs.aws.amazon.com/codedeploy/latest/userguide/how-to-notify-sns.html">Create a Trigger for an AWS CodeDeploy Event</a> in the <i>AWS CodeDeploy User Guide</i>.</p>
    ///   - [`alarm_configuration(Option<AlarmConfiguration>)`](crate::input::CreateDeploymentGroupInput::alarm_configuration): <p>Information to add about Amazon CloudWatch alarms when the deployment group is created.</p>
    ///   - [`auto_rollback_configuration(Option<AutoRollbackConfiguration>)`](crate::input::CreateDeploymentGroupInput::auto_rollback_configuration): <p>Configuration information for an automatic rollback that is added when a deployment group is created.</p>
    ///   - [`outdated_instances_strategy(Option<OutdatedInstancesStrategy>)`](crate::input::CreateDeploymentGroupInput::outdated_instances_strategy): <p>Indicates what happens when new EC2 instances are launched mid-deployment and do not receive the deployed application revision.</p>  <p>If this option is set to <code>UPDATE</code> or is unspecified, CodeDeploy initiates one or more 'auto-update outdated instances' deployments to apply the deployed application revision to the new EC2 instances.</p>  <p>If this option is set to <code>IGNORE</code>, CodeDeploy does not initiate a deployment to update the new EC2 instances. This may result in instances having different revisions.</p>
    ///   - [`deployment_style(Option<DeploymentStyle>)`](crate::input::CreateDeploymentGroupInput::deployment_style): <p>Information about the type of deployment, in-place or blue/green, that you want to run and whether to route deployment traffic behind a load balancer.</p>
    ///   - [`blue_green_deployment_configuration(Option<BlueGreenDeploymentConfiguration>)`](crate::input::CreateDeploymentGroupInput::blue_green_deployment_configuration): <p>Information about blue/green deployment options for a deployment group.</p>
    ///   - [`load_balancer_info(Option<LoadBalancerInfo>)`](crate::input::CreateDeploymentGroupInput::load_balancer_info): <p>Information about the load balancer used in a deployment.</p>
    ///   - [`ec2_tag_set(Option<Ec2TagSet>)`](crate::input::CreateDeploymentGroupInput::ec2_tag_set): <p>Information about groups of tags applied to EC2 instances. The deployment group includes only EC2 instances identified by all the tag groups. Cannot be used in the same call as <code>ec2TagFilters</code>.</p>
    ///   - [`ecs_services(Option<Vec<EcsService>>)`](crate::input::CreateDeploymentGroupInput::ecs_services): <p> The target Amazon ECS services in the deployment group. This applies only to deployment groups that use the Amazon ECS compute platform. A target Amazon ECS service is specified as an Amazon ECS cluster and service name pair using the format <code>   <clustername>    :    <servicename></servicename>   </clustername></code>. </p>
    ///   - [`on_premises_tag_set(Option<OnPremisesTagSet>)`](crate::input::CreateDeploymentGroupInput::on_premises_tag_set): <p>Information about groups of tags applied to on-premises instances. The deployment group includes only on-premises instances identified by all of the tag groups. Cannot be used in the same call as <code>onPremisesInstanceTagFilters</code>.</p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::CreateDeploymentGroupInput::tags): <p> The metadata that you apply to CodeDeploy deployment groups to help you organize and categorize them. Each tag consists of a key and an optional value, both of which you define. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::DeleteApplicationInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ...
    ///
    /// - Takes [`DeleteDeploymentConfigInput`](crate::input::DeleteDeploymentConfigInput) with field(s):
    ///   - [`deployment_config_name(Option<String>)`](crate::input::DeleteDeploymentConfigInput::deployment_config_name): <p>The name of a deployment configuration associated with the IAM user or AWS account.</p>
    ...
    ///
    /// - Takes [`DeleteDeploymentGroupInput`](crate::input::DeleteDeploymentGroupInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::DeleteDeploymentGroupInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ///   - [`deployment_group_name(Option<String>)`](crate::input::DeleteDeploymentGroupInput::deployment_group_name): <p>The name of a deployment group for the specified application.</p>
    ...
    ///
    /// - Takes [`DeleteGitHubAccountTokenInput`](crate::input::DeleteGitHubAccountTokenInput) with field(s):
    ///   - [`token_name(Option<String>)`](crate::input::DeleteGitHubAccountTokenInput::token_name): <p>The name of the GitHub account connection to delete.</p>
    ...
    ///
    /// - Takes [`DeleteResourcesByExternalIdInput`](crate::input::DeleteResourcesByExternalIdInput) with field(s):
    ///   - [`external_id(Option<String>)`](crate::input::DeleteResourcesByExternalIdInput::external_id): <p>The unique ID of an external resource (for example, a CloudFormation stack ID) that is linked to one or more CodeDeploy resources.</p>
    ...
    ///
    /// - Takes [`DeregisterOnPremisesInstanceInput`](crate::input::DeregisterOnPremisesInstanceInput) with field(s):
    ///   - [`instance_name(Option<String>)`](crate::input::DeregisterOnPremisesInstanceInput::instance_name): <p>The name of the on-premises instance to deregister.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::GetApplicationInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ...
    ///
    /// - Takes [`GetApplicationRevisionInput`](crate::input::GetApplicationRevisionInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::GetApplicationRevisionInput::application_name): <p>The name of the application that corresponds to the revision.</p>
    ///   - [`revision(Option<RevisionLocation>)`](crate::input::GetApplicationRevisionInput::revision): <p>Information about the application revision to get, including type and location.</p>
    ...
    ///   - [`deployment_id(Option<String>)`](crate::input::GetDeploymentInput::deployment_id): <p> The unique ID of a deployment associated with the IAM user or AWS account. </p>
    ...
    ///
    /// - Takes [`GetDeploymentConfigInput`](crate::input::GetDeploymentConfigInput) with field(s):
    ///   - [`deployment_config_name(Option<String>)`](crate::input::GetDeploymentConfigInput::deployment_config_name): <p>The name of a deployment configuration associated with the IAM user or AWS account.</p>
    ...
    ///
    /// - Takes [`GetDeploymentGroupInput`](crate::input::GetDeploymentGroupInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::GetDeploymentGroupInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ///   - [`deployment_group_name(Option<String>)`](crate::input::GetDeploymentGroupInput::deployment_group_name): <p>The name of a deployment group for the specified application.</p>
    ...
    ///
    /// - Takes [`GetDeploymentInstanceInput`](crate::input::GetDeploymentInstanceInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::GetDeploymentInstanceInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`instance_id(Option<String>)`](crate::input::GetDeploymentInstanceInput::instance_id): <p> The unique ID of an instance in the deployment group. </p>
    ...
    ///
    /// - Takes [`GetDeploymentTargetInput`](crate::input::GetDeploymentTargetInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::GetDeploymentTargetInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`target_id(Option<String>)`](crate::input::GetDeploymentTargetInput::target_id): <p> The unique ID of a deployment target. </p>
    ...
    ///
    /// - Takes [`GetOnPremisesInstanceInput`](crate::input::GetOnPremisesInstanceInput) with field(s):
    ///   - [`instance_name(Option<String>)`](crate::input::GetOnPremisesInstanceInput::instance_name): <p> The name of the on-premises instance about which to get information. </p>
    ...
    ///
    /// - Takes [`ListApplicationRevisionsInput`](crate::input::ListApplicationRevisionsInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::ListApplicationRevisionsInput::application_name): <p> The name of an AWS CodeDeploy application associated with the IAM user or AWS account. </p>
    ///   - [`sort_by(Option<ApplicationRevisionSortBy>)`](crate::input::ListApplicationRevisionsInput::sort_by): <p>The column name to use to sort the list results:</p>  <ul>   <li> <p> <code>registerTime</code>: Sort by the time the revisions were registered with AWS CodeDeploy.</p> </li>   <li> <p> <code>firstUsedTime</code>: Sort by the time the revisions were first used in a deployment.</p> </li>   <li> <p> <code>lastUsedTime</code>: Sort by the time the revisions were last used in a deployment.</p> </li>  </ul>  <p> If not specified or set to null, the results are returned in an arbitrary order. </p>
    ///   - [`sort_order(Option<SortOrder>)`](crate::input::ListApplicationRevisionsInput::sort_order): <p> The order in which to sort the list results: </p>  <ul>   <li> <p> <code>ascending</code>: ascending order.</p> </li>   <li> <p> <code>descending</code>: descending order.</p> </li>  </ul>  <p>If not specified, the results are sorted in ascending order.</p>  <p>If set to null, the results are sorted in an arbitrary order.</p>
    ///   - [`s3_bucket(Option<String>)`](crate::input::ListApplicationRevisionsInput::s3_bucket): <p> An Amazon S3 bucket name to limit the search for revisions. </p>  <p> If set to null, all of the user's buckets are searched. </p>
    ///   - [`s3_key_prefix(Option<String>)`](crate::input::ListApplicationRevisionsInput::s3_key_prefix): <p> A key prefix for the set of Amazon S3 objects to limit the search for revisions. </p>
    ///   - [`deployed(Option<ListStateFilterAction>)`](crate::input::ListApplicationRevisionsInput::deployed): <p> Whether to list revisions based on whether the revision is the target revision of a deployment group: </p>  <ul>   <li> <p> <code>include</code>: List revisions that are target revisions of a deployment group.</p> </li>   <li> <p> <code>exclude</code>: Do not list revisions that are target revisions of a deployment group.</p> </li>   <li> <p> <code>ignore</code>: List all revisions.</p> </li>  </ul>
    ///   - [`next_token(Option<String>)`](crate::input::ListApplicationRevisionsInput::next_token): <p>An identifier returned from the previous <code>ListApplicationRevisions</code> call. It can be used to return the next set of applications in the list.</p>
    ...
    ///   - [`next_token(Option<String>)`](crate::input::ListApplicationsInput::next_token): <p>An identifier returned from the previous list applications call. It can be used to return the next set of applications in the list.</p>
    ...
    ///
    /// - Takes [`ListDeploymentConfigsInput`](crate::input::ListDeploymentConfigsInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListDeploymentConfigsInput::next_token): <p>An identifier returned from the previous <code>ListDeploymentConfigs</code> call. It can be used to return the next set of deployment configurations in the list. </p>
    ...
    ///
    /// - Takes [`ListDeploymentGroupsInput`](crate::input::ListDeploymentGroupsInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::ListDeploymentGroupsInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDeploymentGroupsInput::next_token): <p>An identifier returned from the previous list deployment groups call. It can be used to return the next set of deployment groups in the list.</p>
    ...
    ///
    /// - Takes [`ListDeploymentInstancesInput`](crate::input::ListDeploymentInstancesInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::ListDeploymentInstancesInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDeploymentInstancesInput::next_token): <p>An identifier returned from the previous list deployment instances call. It can be used to return the next set of deployment instances in the list.</p>
    ///   - [`instance_status_filter(Option<Vec<InstanceStatus>>)`](crate::input::ListDeploymentInstancesInput::instance_status_filter): <p>A subset of instances to list by status:</p>  <ul>   <li> <p> <code>Pending</code>: Include those instances with pending deployments.</p> </li>   <li> <p> <code>InProgress</code>: Include those instances where deployments are still in progress.</p> </li>   <li> <p> <code>Succeeded</code>: Include those instances with successful deployments.</p> </li>   <li> <p> <code>Failed</code>: Include those instances with failed deployments.</p> </li>   <li> <p> <code>Skipped</code>: Include those instances with skipped deployments.</p> </li>   <li> <p> <code>Unknown</code>: Include those instances with deployments in an unknown state.</p> </li>  </ul>
    ///   - [`instance_type_filter(Option<Vec<InstanceType>>)`](crate::input::ListDeploymentInstancesInput::instance_type_filter): <p>The set of instances in a blue/green deployment, either those in the original environment ("BLUE") or those in the replacement environment ("GREEN"), for which you want to view instance information.</p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::ListDeploymentsInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p> <note>   <p>If <code>applicationName</code> is specified, then <code>deploymentGroupName</code> must be specified. If it is not specified, then <code>deploymentGroupName</code> must not be specified. </p>  </note>
    ///   - [`deployment_group_name(Option<String>)`](crate::input::ListDeploymentsInput::deployment_group_name): <p>The name of a deployment group for the specified application.</p> <note>   <p>If <code>deploymentGroupName</code> is specified, then <code>applicationName</code> must be specified. If it is not specified, then <code>applicationName</code> must not be specified. </p>  </note>
    ///   - [`external_id(Option<String>)`](crate::input::ListDeploymentsInput::external_id): <p>The unique ID of an external resource for returning deployments linked to the external resource.</p>
    ///   - [`include_only_statuses(Option<Vec<DeploymentStatus>>)`](crate::input::ListDeploymentsInput::include_only_statuses): <p>A subset of deployments to list by status:</p>  <ul>   <li> <p> <code>Created</code>: Include created deployments in the resulting list.</p> </li>   <li> <p> <code>Queued</code>: Include queued deployments in the resulting list.</p> </li>   <li> <p> <code>In Progress</code>: Include in-progress deployments in the resulting list.</p> </li>   <li> <p> <code>Succeeded</code>: Include successful deployments in the resulting list.</p> </li>   <li> <p> <code>Failed</code>: Include failed deployments in the resulting list.</p> </li>   <li> <p> <code>Stopped</code>: Include stopped deployments in the resulting list.</p> </li>  </ul>
    ///   - [`create_time_range(Option<TimeRange>)`](crate::input::ListDeploymentsInput::create_time_range): <p>A time range (start and end) for returning a subset of the list of deployments.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDeploymentsInput::next_token): <p>An identifier returned from the previous list deployments call. It can be used to return the next set of deployments in the list.</p>
    ...
    ///
    /// - Takes [`ListDeploymentTargetsInput`](crate::input::ListDeploymentTargetsInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::ListDeploymentTargetsInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListDeploymentTargetsInput::next_token): <p> A token identifier returned from the previous <code>ListDeploymentTargets</code> call. It can be used to return the next set of deployment targets in the list. </p>
    ///   - [`target_filters(Option<HashMap<TargetFilterName, Vec<String>>>)`](crate::input::ListDeploymentTargetsInput::target_filters): <p> A key used to filter the returned targets. The two valid values are:</p>  <ul>   <li> <p> <code>TargetStatus</code> - A <code>TargetStatus</code> filter string can be <code>Failed</code>, <code>InProgress</code>, <code>Pending</code>, <code>Ready</code>, <code>Skipped</code>, <code>Succeeded</code>, or <code>Unknown</code>. </p> </li>   <li> <p> <code>ServerInstanceLabel</code> - A <code>ServerInstanceLabel</code> filter string can be <code>Blue</code> or <code>Green</code>. </p> </li>  </ul>
    ...
    ///
    /// - Takes [`ListGitHubAccountTokenNamesInput`](crate::input::ListGitHubAccountTokenNamesInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::ListGitHubAccountTokenNamesInput::next_token): <p>An identifier returned from the previous <code>ListGitHubAccountTokenNames</code> call. It can be used to return the next set of names in the list. </p>
    ...
    ///
    /// - Takes [`ListOnPremisesInstancesInput`](crate::input::ListOnPremisesInstancesInput) with field(s):
    ///   - [`registration_status(Option<RegistrationStatus>)`](crate::input::ListOnPremisesInstancesInput::registration_status): <p>The registration status of the on-premises instances:</p>  <ul>   <li> <p> <code>Deregistered</code>: Include deregistered on-premises instances in the resulting list.</p> </li>   <li> <p> <code>Registered</code>: Include registered on-premises instances in the resulting list.</p> </li>  </ul>
    ///   - [`tag_filters(Option<Vec<TagFilter>>)`](crate::input::ListOnPremisesInstancesInput::tag_filters): <p>The on-premises instance tags that are used to restrict the on-premises instance names returned.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListOnPremisesInstancesInput::next_token): <p>An identifier returned from the previous list on-premises instances call. It can be used to return the next set of on-premises instances in the list.</p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p> The ARN of a CodeDeploy resource. <code>ListTagsForResource</code> returns all the tags associated with the resource that is identified by the <code>ResourceArn</code>. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListTagsForResourceInput::next_token): <p>An identifier returned from the previous <code>ListTagsForResource</code> call. It can be used to return the next set of applications in the list.</p>
    ...
    ///
    /// - Takes [`PutLifecycleEventHookExecutionStatusInput`](crate::input::PutLifecycleEventHookExecutionStatusInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::PutLifecycleEventHookExecutionStatusInput::deployment_id): <p> The unique ID of a deployment. Pass this ID to a Lambda function that validates a deployment lifecycle event. </p>
    ///   - [`lifecycle_event_hook_execution_id(Option<String>)`](crate::input::PutLifecycleEventHookExecutionStatusInput::lifecycle_event_hook_execution_id): <p> The execution ID of a deployment's lifecycle hook. A deployment lifecycle hook is specified in the <code>hooks</code> section of the AppSpec file. </p>
    ///   - [`status(Option<LifecycleEventStatus>)`](crate::input::PutLifecycleEventHookExecutionStatusInput::status): <p>The result of a Lambda function that validates a deployment lifecycle event. <code>Succeeded</code> and <code>Failed</code> are the only valid values for <code>status</code>.</p>
    ...
    ///
    /// - Takes [`RegisterApplicationRevisionInput`](crate::input::RegisterApplicationRevisionInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::RegisterApplicationRevisionInput::application_name): <p>The name of an AWS CodeDeploy application associated with the IAM user or AWS account.</p>
    ///   - [`description(Option<String>)`](crate::input::RegisterApplicationRevisionInput::description): <p>A comment about the revision.</p>
    ///   - [`revision(Option<RevisionLocation>)`](crate::input::RegisterApplicationRevisionInput::revision): <p>Information about the application revision to register, including type and location.</p>
    ...
    ///
    /// - Takes [`RegisterOnPremisesInstanceInput`](crate::input::RegisterOnPremisesInstanceInput) with field(s):
    ///   - [`instance_name(Option<String>)`](crate::input::RegisterOnPremisesInstanceInput::instance_name): <p>The name of the on-premises instance to register.</p>
    ///   - [`iam_session_arn(Option<String>)`](crate::input::RegisterOnPremisesInstanceInput::iam_session_arn): <p>The ARN of the IAM session to associate with the on-premises instance.</p>
    ///   - [`iam_user_arn(Option<String>)`](crate::input::RegisterOnPremisesInstanceInput::iam_user_arn): <p>The ARN of the IAM user to associate with the on-premises instance.</p>
    ...
    ///
    /// - Takes [`RemoveTagsFromOnPremisesInstancesInput`](crate::input::RemoveTagsFromOnPremisesInstancesInput) with field(s):
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::RemoveTagsFromOnPremisesInstancesInput::tags): <p>The tag key-value pairs to remove from the on-premises instances.</p>
    ///   - [`instance_names(Option<Vec<String>>)`](crate::input::RemoveTagsFromOnPremisesInstancesInput::instance_names): <p>The names of the on-premises instances from which to remove tags.</p>
    ...
    ///
    /// - Takes [`SkipWaitTimeForInstanceTerminationInput`](crate::input::SkipWaitTimeForInstanceTerminationInput) with field(s):
    ///   - [`deployment_id(Option<String>)`](crate::input::SkipWaitTimeForInstanceTerminationInput::deployment_id): <p> The unique ID of a blue/green deployment for which you want to skip the instance termination wait time. </p>
    ...
    ///   - [`deployment_id(Option<String>)`](crate::input::StopDeploymentInput::deployment_id): <p> The unique ID of a deployment. </p>
    ///   - [`auto_rollback_enabled(Option<bool>)`](crate::input::StopDeploymentInput::auto_rollback_enabled): <p> Indicates, when a deployment is stopped, whether instances that have been updated should be rolled back to the previous version of the application revision. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p> The ARN of a resource, such as a CodeDeploy application or deployment group. </p>
    ///   - [`tags(Option<Vec<Tag>>)`](crate::input::TagResourceInput::tags): <p> A list of tags that <code>TagResource</code> associates with a resource. The resource is identified by the <code>ResourceArn</code> input parameter. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p> The Amazon Resource Name (ARN) that specifies from which resource to disassociate the tags with the keys in the <code>TagKeys</code> input parameter. </p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p> A list of keys of <code>Tag</code> objects. The <code>Tag</code> objects identified by the keys are disassociated from the resource specified by the <code>ResourceArn</code> input parameter. </p>
    ...
    ///   - [`application_name(Option<String>)`](crate::input::UpdateApplicationInput::application_name): <p>The current name of the application you want to change.</p>
    ///   - [`new_application_name(Option<String>)`](crate::input::UpdateApplicationInput::new_application_name): <p>The new name to give the application.</p>
    ...
    ///
    /// - Takes [`UpdateDeploymentGroupInput`](crate::input::UpdateDeploymentGroupInput) with field(s):
    ///   - [`application_name(Option<String>)`](crate::input::UpdateDeploymentGroupInput::application_name): <p>The application name that corresponds to the deployment group to update.</p>
    ///   - [`current_deployment_group_name(Option<String>)`](crate::input::UpdateDeploymentGroupInput::current_deployment_group_name): <p>The current name of the deployment group.</p>
    ///   - [`new_deployment_group_name(Option<String>)`](crate::input::UpdateDeploymentGroupInput::new_deployment_group_name): <p>The new name of the deployment group, if you want to change it.</p>
    ///   - [`deployment_config_name(Option<String>)`](crate::input::UpdateDeploymentGroupInput::deployment_config_name): <p>The replacement deployment configuration name to use, if you want to change it.</p>
    ///   - [`ec2_tag_filters(Option<Vec<Ec2TagFilter>>)`](crate::input::UpdateDeploymentGroupInput::ec2_tag_filters): <p>The replacement set of Amazon EC2 tags on which to filter, if you want to change them. To keep the existing tags, enter their names. To remove tags, do not enter any tag names.</p>
    ///   - [`on_premises_instance_tag_filters(Option<Vec<TagFilter>>)`](crate::input::UpdateDeploymentGroupInput::on_premises_instance_tag_filters): <p>The replacement set of on-premises instance tags on which to filter, if you want to change them. To keep the existing tags, enter their names. To remove tags, do not enter any tag names.</p>
    ///   - [`auto_scaling_groups(Option<Vec<String>>)`](crate::input::UpdateDeploymentGroupInput::auto_scaling_groups): <p>The replacement list of Auto Scaling groups to be included in the deployment group, if you want to change them. To keep the Auto Scaling groups, enter their names. To remove Auto Scaling groups, do not enter any Auto Scaling group names.</p>
    ///   - [`service_role_arn(Option<String>)`](crate::input::UpdateDeploymentGroupInput::service_role_arn): <p>A replacement ARN for the service role, if you want to change it.</p>
    ///   - [`trigger_configurations(Option<Vec<TriggerConfig>>)`](crate::input::UpdateDeploymentGroupInput::trigger_configurations): <p>Information about triggers to change when the deployment group is updated. For examples, see <a href="https://docs.aws.amazon.com/codedeploy/latest/userguide/how-to-notify-edit.html">Edit a Trigger in a CodeDeploy Deployment Group</a> in the <i>AWS CodeDeploy User Guide</i>.</p>
    ///   - [`alarm_configuration(Option<AlarmConfiguration>)`](crate::input::UpdateDeploymentGroupInput::alarm_configuration): <p>Information to add or change about Amazon CloudWatch alarms when the deployment group is updated.</p>
    ///   - [`auto_rollback_configuration(Option<AutoRollbackConfiguration>)`](crate::input::UpdateDeploymentGroupInput::auto_rollback_configuration): <p>Information for an automatic rollback configuration that is added or changed when a deployment group is updated.</p>
    ///   - [`outdated_instances_strategy(Option<OutdatedInstancesStrategy>)`](crate::input::UpdateDeploymentGroupInput::outdated_instances_strategy): <p>Indicates what happens when new EC2 instances are launched mid-deployment and do not receive the deployed application revision.</p>  <p>If this option is set to <code>UPDATE</code> or is unspecified, CodeDeploy initiates one or more 'auto-update outdated instances' deployments to apply the deployed application revision to the new EC2 instances.</p>  <p>If this option is set to <code>IGNORE</code>, CodeDeploy does not initiate a deployment to update the new EC2 instances. This may result in instances having different revisions.</p>
    ///   - [`deployment_style(Option<DeploymentStyle>)`](crate::input::UpdateDeploymentGroupInput::deployment_style): <p>Information about the type of deployment, either in-place or blue/green, you want to run and whether to route deployment traffic behind a load balancer.</p>
    ///   - [`blue_green_deployment_configuration(Option<BlueGreenDeploymentConfiguration>)`](crate::input::UpdateDeploymentGroupInput::blue_green_deployment_configuration): <p>Information about blue/green deployment options for a deployment group.</p>
    ///   - [`load_balancer_info(Option<LoadBalancerInfo>)`](crate::input::UpdateDeploymentGroupInput::load_balancer_info): <p>Information about the load balancer used in a deployment.</p>
    ///   - [`ec2_tag_set(Option<Ec2TagSet>)`](crate::input::UpdateDeploymentGroupInput::ec2_tag_set): <p>Information about groups of tags applied to on-premises instances. The deployment group includes only EC2 instances identified by all the tag groups.</p>
    ///   - [`ecs_services(Option<Vec<EcsService>>)`](crate::input::UpdateDeploymentGroupInput::ecs_services): <p> The target Amazon ECS services in the deployment group. This applies only to deployment groups that use the Amazon ECS compute platform. A target Amazon ECS service is specified as an Amazon ECS cluster and service name pair using the format <code>   <clustername>    :    <servicename></servicename>   </clustername></code>. </p>
    ///   - [`on_premises_tag_set(Option<OnPremisesTagSet>)`](crate::input::UpdateDeploymentGroupInput::on_premises_tag_set): <p>Information about an on-premises instance tag set. The deployment group includes only on-premises instances identified by all the tag groups.</p>
