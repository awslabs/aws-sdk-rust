...
impl ListApplicationRevisions {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListApplicationRevisions",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListApplicationRevisions")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListApplicationRevisions")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListApplicationRevisionsTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListApplicationRevisionsTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListApplicationRevisionsTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListApplicationRevisionsInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListApplicationRevisionsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_application_revisions::de_list_application_revisions_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_application_revisions::de_list_application_revisions_http_response(status, headers, body, _cfg)
        };
