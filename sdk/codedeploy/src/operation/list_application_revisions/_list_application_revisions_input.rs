...
impl ListApplicationRevisionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_revisions::ListApplicationRevisionsInput, ::aws_smithy_types::error::operation::BuildError> {
