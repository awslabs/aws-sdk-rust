...
impl RegisterApplicationRevisionInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::register_application_revision::RegisterApplicationRevision::new(),
        )
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RegisterApplicationRevisionError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_application_revision::RegisterApplicationRevisionError
{
