...
impl PutLifecycleEventHookExecutionStatusInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatus::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutLifecycleEventHookExecutionStatus {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_lifecycle_event_hook_execution_status::de_put_lifecycle_event_hook_execution_status_http_response_with_props(status, headers, body)
        }
    }
}
