...
/// Orchestration and serialization glue logic for `PutLifecycleEventHookExecutionStatus`.
...
impl PutLifecycleEventHookExecutionStatus {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatusError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatusOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "PutLifecycleEventHookExecutionStatus",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutLifecycleEventHookExecutionStatus {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutLifecycleEventHookExecutionStatus");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutLifecycleEventHookExecutionStatusRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutLifecycleEventHookExecutionStatusResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutLifecycleEventHookExecutionStatus")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutLifecycleEventHookExecutionStatus")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutLifecycleEventHookExecutionStatusTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                PutLifecycleEventHookExecutionStatusEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct PutLifecycleEventHookExecutionStatusTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutLifecycleEventHookExecutionStatusTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutLifecycleEventHookExecutionStatusInput>() else {
        ...
        if requested.should_capture("lifecycleEventHookExecutionId") {
            if let ::std::option::Option::Some(value) = input.lifecycle_event_hook_execution_id.as_deref() {
                captured.insert("lifecycleEventHookExecutionId", value);
            }
        }
...
#[derive(Debug)]
struct PutLifecycleEventHookExecutionStatusResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutLifecycleEventHookExecutionStatusResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_lifecycle_event_hook_execution_status::de_put_lifecycle_event_hook_execution_status_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_put_lifecycle_event_hook_execution_status::de_put_lifecycle_event_hook_execution_status_http_response(
                status, headers, body,
            )
        };
...
#[derive(Debug)]
struct PutLifecycleEventHookExecutionStatusRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutLifecycleEventHookExecutionStatusRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatusInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatusInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_put_lifecycle_event_hook_execution_status::ser_put_lifecycle_event_hook_execution_status_input(&input)?,
        );
...
#[derive(Debug)]
struct PutLifecycleEventHookExecutionStatusEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutLifecycleEventHookExecutionStatusEndpointParamsInterceptor {
    fn name(&self) -> &'static str {
        "PutLifecycleEventHookExecutionStatusEndpointParamsInterceptor"
    }
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<PutLifecycleEventHookExecutionStatusInput>()
            .ok_or("failed to downcast to PutLifecycleEventHookExecutionStatusInput")?;
...
pub enum PutLifecycleEventHookExecutionStatusError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutLifecycleEventHookExecutionStatusError) for what information is available for the error.")]
...
impl PutLifecycleEventHookExecutionStatusError {
    ...
    /// Creates the `PutLifecycleEventHookExecutionStatusError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidLifecycleEventHookExecutionIdException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InvalidLifecycleEventHookExecutionStatusException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::LifecycleEventAlreadyCompletedException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::UnsupportedActionForDeploymentTypeException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for PutLifecycleEventHookExecutionStatusError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidLifecycleEventHookExecutionIdException(_inner) => ::std::option::Option::Some(_inner),
            Self::InvalidLifecycleEventHookExecutionStatusException(_inner) => ::std::option::Option::Some(_inner),
            Self::LifecycleEventAlreadyCompletedException(_inner) => ::std::option::Option::Some(_inner),
            Self::UnsupportedActionForDeploymentTypeException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutLifecycleEventHookExecutionStatusError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidLifecycleEventHookExecutionIdException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::InvalidLifecycleEventHookExecutionStatusException(_inner) => {
                ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner)
            }
            Self::LifecycleEventAlreadyCompletedException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::UnsupportedActionForDeploymentTypeException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
            Self::Unhandled(_inner) => &_inner.meta,
        }
    }
}
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutLifecycleEventHookExecutionStatusError {
...
impl ::aws_types::request_id::RequestId for crate::operation::put_lifecycle_event_hook_execution_status::PutLifecycleEventHookExecutionStatusError {
