...
impl DeleteGitHubAccountTokenInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_git_hub_account_token::DeleteGitHubAccountToken::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGitHubAccountToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_git_hub_account_token::de_delete_git_hub_account_token_http_response_with_props(status, headers, body)
        }
    }
}
