...
impl AddTagsToOnPremisesInstancesInput {
    /// Consumes the builder and constructs an Operation<[`AddTagsToOnPremisesInstances`](crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_tags_to_on_premises_instances::ser_add_tags_to_on_premises_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("AddTagsToOnPremisesInstances", "codedeploy"));
...
impl aws_smithy_http::response::ParseStrictResponse for AddTagsToOnPremisesInstances {
                type Output = std::result::Result<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesOutput, crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError>;
