...
/// Orchestration and serialization glue logic for `AddTagsToOnPremisesInstances`.
...
impl AddTagsToOnPremisesInstances {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AddTagsToOnPremisesInstances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AddTagsToOnPremisesInstances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(AddTagsToOnPremisesInstancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(AddTagsToOnPremisesInstancesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AddTagsToOnPremisesInstances")
...
.with_interceptor(AddTagsToOnPremisesInstancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError>::new());
...
#[derive(Debug)]
            struct AddTagsToOnPremisesInstancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AddTagsToOnPremisesInstancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_add_tags_to_on_premises_instances::de_add_tags_to_on_premises_instances_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_add_tags_to_on_premises_instances::de_add_tags_to_on_premises_instances_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct AddTagsToOnPremisesInstancesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AddTagsToOnPremisesInstancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_add_tags_to_on_premises_instances::ser_add_tags_to_on_premises_instances_input(&input)?);
...
#[derive(Debug)]
            struct AddTagsToOnPremisesInstancesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for AddTagsToOnPremisesInstancesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "AddTagsToOnPremisesInstancesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<AddTagsToOnPremisesInstancesInput>()
                        .ok_or("failed to downcast to AddTagsToOnPremisesInstancesInput")?;
...
pub enum AddTagsToOnPremisesInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-AddTagsToOnPremisesInstancesError) for what information is available for the error.")]
...
impl AddTagsToOnPremisesInstancesError {
    /// Creates the `AddTagsToOnPremisesInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddTagsToOnPremisesInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for AddTagsToOnPremisesInstancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError {
...
mod _add_tags_to_on_premises_instances_output;
