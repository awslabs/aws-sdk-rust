...
impl ::aws_smithy_http::response::ParseStrictResponse for AddTagsToOnPremisesInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_add_tags_to_on_premises_instances::de_add_tags_to_on_premises_instances_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for AddTagsToOnPremisesInstancesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError
{
