...
impl GetDeploymentTargetInput {
    /// Consumes the builder and constructs an Operation<[`GetDeploymentTarget`](crate::operation::get_deployment_target::GetDeploymentTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_deployment_target::GetDeploymentTarget, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_deployment_target::GetDeploymentTargetInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_deployment_target::ser_get_deployment_target_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_deployment_target::GetDeploymentTarget::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDeploymentTarget", "codedeploy"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDeploymentTarget {
                type Output = std::result::Result<crate::operation::get_deployment_target::GetDeploymentTargetOutput, crate::operation::get_deployment_target::GetDeploymentTargetError>;
