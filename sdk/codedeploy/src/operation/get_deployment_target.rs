...
impl GetDeploymentTargetInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_deployment_target::ser_get_deployment_target_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_deployment_target::GetDeploymentTarget::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_deployment_target::GetDeploymentTargetError
{
