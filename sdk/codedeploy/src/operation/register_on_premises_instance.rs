...
impl RegisterOnPremisesInstance {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RegisterOnPremisesInstance",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RegisterOnPremisesInstance")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RegisterOnPremisesInstance")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RegisterOnPremisesInstanceTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RegisterOnPremisesInstanceTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RegisterOnPremisesInstanceTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RegisterOnPremisesInstanceInput>() else {
        ...
        if requested.should_capture("iamSessionArn") {
            if let ::std::option::Option::Some(value) = input.iam_session_arn.as_deref() {
                captured.insert("iamSessionArn", value);
            }
        }
        if requested.should_capture("iamUserArn") {
            if let ::std::option::Option::Some(value) = input.iam_user_arn.as_deref() {
                captured.insert("iamUserArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RegisterOnPremisesInstanceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_register_on_premises_instance::de_register_on_premises_instance_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_register_on_premises_instance::de_register_on_premises_instance_http_response(status, headers, body, _cfg)
        };
