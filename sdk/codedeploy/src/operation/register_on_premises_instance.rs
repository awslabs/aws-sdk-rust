...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterOnPremisesInstance {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_register_on_premises_instance::de_register_on_premises_instance_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::register_on_premises_instance::RegisterOnPremisesInstanceError
{
