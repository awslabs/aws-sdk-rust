...
impl BatchGetDeploymentInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_deployment_instances::BatchGetDeploymentInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetDeploymentInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_deployment_instances::de_batch_get_deployment_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
