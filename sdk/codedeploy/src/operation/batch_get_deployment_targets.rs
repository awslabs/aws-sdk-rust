...
impl BatchGetDeploymentTargetsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_deployment_targets::BatchGetDeploymentTargets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetDeploymentTargets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_deployment_targets::de_batch_get_deployment_targets_http_response_with_props(status, headers, body)
        }
    }
}
