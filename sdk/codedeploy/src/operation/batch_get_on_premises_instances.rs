...
impl BatchGetOnPremisesInstancesInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetOnPremisesInstances`](crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstances, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_on_premises_instances::ser_batch_get_on_premises_instances_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstances::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchGetOnPremisesInstances", "codedeploy"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `BatchGetOnPremisesInstances`.
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetOnPremisesInstances {
                type Output = std::result::Result<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesOutput, crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError>;
