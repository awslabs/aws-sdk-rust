...
/// Orchestration and serialization glue logic for `BatchGetOnPremisesInstances`.
...
impl BatchGetOnPremisesInstances {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetOnPremisesInstances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchGetOnPremisesInstances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchGetOnPremisesInstancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchGetOnPremisesInstancesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchGetOnPremisesInstances")
...
.with_interceptor(BatchGetOnPremisesInstancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError>::new());
...
#[derive(Debug)]
            struct BatchGetOnPremisesInstancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetOnPremisesInstancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_get_on_premises_instances::de_batch_get_on_premises_instances_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_get_on_premises_instances::de_batch_get_on_premises_instances_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchGetOnPremisesInstancesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetOnPremisesInstancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_get_on_premises_instances::ser_batch_get_on_premises_instances_input(&input)?);
...
#[derive(Debug)]
            struct BatchGetOnPremisesInstancesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchGetOnPremisesInstancesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchGetOnPremisesInstancesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchGetOnPremisesInstancesInput>()
                        .ok_or("failed to downcast to BatchGetOnPremisesInstancesInput")?;
...
pub enum BatchGetOnPremisesInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchGetOnPremisesInstancesError) for what information is available for the error.")]
...
impl BatchGetOnPremisesInstancesError {
    /// Creates the `BatchGetOnPremisesInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchGetOnPremisesInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchGetOnPremisesInstancesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstancesError {
...
mod _batch_get_on_premises_instances_output;
