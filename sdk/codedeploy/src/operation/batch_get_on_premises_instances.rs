...
impl BatchGetOnPremisesInstancesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_on_premises_instances::BatchGetOnPremisesInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetOnPremisesInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_on_premises_instances::de_batch_get_on_premises_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
