...
impl DeleteResourcesByExternalId {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteResourcesByExternalId {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteResourcesByExternalId");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteResourcesByExternalIdRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteResourcesByExternalIdResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteResourcesByExternalId")
...
.with_interceptor(DeleteResourcesByExternalIdEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError>::new());
...
#[derive(Debug)]
            struct DeleteResourcesByExternalIdResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteResourcesByExternalIdResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteResourcesByExternalIdRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteResourcesByExternalIdRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_delete_resources_by_external_id::ser_delete_resources_by_external_id_input(&input)?);
...
#[derive(Debug)]
            struct DeleteResourcesByExternalIdEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteResourcesByExternalIdEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteResourcesByExternalIdEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteResourcesByExternalIdInput>()
                        .ok_or("failed to downcast to DeleteResourcesByExternalIdInput")?;
...
pub enum DeleteResourcesByExternalIdError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteResourcesByExternalIdError) for what information is available for the error.")]
...
impl DeleteResourcesByExternalIdError {
    /// Creates the `DeleteResourcesByExternalIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteResourcesByExternalIdError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteResourcesByExternalIdError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError {
