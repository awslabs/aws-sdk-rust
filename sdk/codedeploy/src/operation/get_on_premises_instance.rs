...
impl GetOnPremisesInstanceInput {
    /// Consumes the builder and constructs an Operation<[`GetOnPremisesInstance`](crate::operation::get_on_premises_instance::GetOnPremisesInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_on_premises_instance::GetOnPremisesInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_on_premises_instance::GetOnPremisesInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_on_premises_instance::GetOnPremisesInstance::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetOnPremisesInstance {
                type Output = std::result::Result<crate::operation::get_on_premises_instance::GetOnPremisesInstanceOutput, crate::operation::get_on_premises_instance::GetOnPremisesInstanceError>;
