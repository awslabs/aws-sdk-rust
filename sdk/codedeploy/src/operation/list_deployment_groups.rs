...
impl ListDeploymentGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListDeploymentGroups`](crate::operation::list_deployment_groups::ListDeploymentGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_deployment_groups::ListDeploymentGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_deployment_groups::ListDeploymentGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_deployment_groups::ser_list_deployment_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_deployment_groups::ListDeploymentGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDeploymentGroups", "codedeploy"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListDeploymentGroups`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListDeploymentGroups {
                type Output = std::result::Result<crate::operation::list_deployment_groups::ListDeploymentGroupsOutput, crate::operation::list_deployment_groups::ListDeploymentGroupsError>;
