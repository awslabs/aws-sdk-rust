...
impl ListDeploymentGroupsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_deployment_groups::ser_list_deployment_groups_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_deployment_groups::ListDeploymentGroups::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_deployment_groups::ListDeploymentGroupsError
{
