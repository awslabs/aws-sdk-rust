...
impl ::aws_smithy_http::response::ParseStrictResponse for SkipWaitTimeForInstanceTermination {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_skip_wait_time_for_instance_termination::de_skip_wait_time_for_instance_termination_http_response_with_props(status, headers, body)
        }
    }
}
