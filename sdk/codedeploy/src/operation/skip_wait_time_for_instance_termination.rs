...
impl SkipWaitTimeForInstanceTerminationInput {
    /// Consumes the builder and constructs an Operation<[`SkipWaitTimeForInstanceTermination`](crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTermination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTermination, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTerminationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTermination::new())
...
impl aws_smithy_http::response::ParseStrictResponse for SkipWaitTimeForInstanceTermination {
                type Output = std::result::Result<crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTerminationOutput, crate::operation::skip_wait_time_for_instance_termination::SkipWaitTimeForInstanceTerminationError>;
