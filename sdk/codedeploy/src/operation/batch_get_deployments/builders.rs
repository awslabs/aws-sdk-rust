...
impl BatchGetDeploymentsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.batch_get_deployments();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::batch_get_deployments::BatchGetDeploymentsOutput,
                    crate::operation::batch_get_deployments::BatchGetDeploymentsError,
                > for BatchGetDeploymentsFluentBuilder
            {
                fn send(
                    self,
...
impl BatchGetDeploymentsFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::batch_get_deployments::builders::BatchGetDeploymentsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_deployments::BatchGetDeploymentsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_deployments::BatchGetDeploymentsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::batch_get_deployments::BatchGetDeployments::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::batch_get_deployments::BatchGetDeployments::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_deployments::BatchGetDeploymentsOutput, crate::operation::batch_get_deployments::BatchGetDeploymentsError, Self> {
