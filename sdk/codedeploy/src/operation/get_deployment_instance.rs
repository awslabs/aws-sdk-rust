...
impl GetDeploymentInstanceInput {
    /// Consumes the builder and constructs an Operation<[`GetDeploymentInstance`](crate::operation::get_deployment_instance::GetDeploymentInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_deployment_instance::GetDeploymentInstance, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_deployment_instance::GetDeploymentInstanceInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_deployment_instance::ser_get_deployment_instance_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_deployment_instance::GetDeploymentInstance::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDeploymentInstance", "codedeploy"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetDeploymentInstance`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetDeploymentInstance {
                type Output = std::result::Result<crate::operation::get_deployment_instance::GetDeploymentInstanceOutput, crate::operation::get_deployment_instance::GetDeploymentInstanceError>;
