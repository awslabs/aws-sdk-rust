...
impl ListDeploymentsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_deployments::ser_list_deployments_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_deployments::ListDeployments::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDeployments", "codedeploy"));
