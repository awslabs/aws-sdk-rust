...
impl ListDeploymentInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_deployment_instances::ListDeploymentInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_deployment_instances::ListDeploymentInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_deployment_instances::ListDeploymentInstancesOutput, crate::operation::list_deployment_instances::ListDeploymentInstancesError, Self> {
