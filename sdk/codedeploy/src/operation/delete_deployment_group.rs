...
impl DeleteDeploymentGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_deployment_group::DeleteDeploymentGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDeploymentGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_deployment_group::de_delete_deployment_group_http_response_with_props(status, headers, body)
        }
    }
}
