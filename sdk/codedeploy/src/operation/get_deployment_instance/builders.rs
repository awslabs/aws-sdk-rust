...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_deployment_instance::GetDeploymentInstanceOutput,
                    crate::operation::get_deployment_instance::GetDeploymentInstanceError,
                > for GetDeploymentInstanceFluentBuilder
            {
                fn send(
                    self,
...
impl GetDeploymentInstanceFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_deployment_instance::GetDeploymentInstanceOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_deployment_instance::GetDeploymentInstanceError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_deployment_instance::GetDeploymentInstanceOutput, crate::operation::get_deployment_instance::GetDeploymentInstanceError, Self> {
