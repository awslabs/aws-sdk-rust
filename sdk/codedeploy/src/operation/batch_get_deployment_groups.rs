...
impl BatchGetDeploymentGroupsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetDeploymentGroups {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_deployment_groups::de_batch_get_deployment_groups_http_response_with_props(status, headers, body)
        }
    }
}
