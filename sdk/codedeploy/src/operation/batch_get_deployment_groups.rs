...
impl BatchGetDeploymentGroupsInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetDeploymentGroups`](crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroups, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_deployment_groups::ser_batch_get_deployment_groups_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroups::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("BatchGetDeploymentGroups", "codedeploy"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `BatchGetDeploymentGroups`.
...
impl aws_smithy_http::response::ParseStrictResponse for BatchGetDeploymentGroups {
                type Output = std::result::Result<crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsOutput, crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsError>;
