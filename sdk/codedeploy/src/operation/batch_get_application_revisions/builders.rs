...
impl crate::operation::batch_get_application_revisions::builders::BatchGetApplicationRevisionsInputBuilder {
...
impl BatchGetApplicationRevisionsFluentBuilder {
    /// Creates a new `BatchGetApplicationRevisionsFluentBuilder`.
