...
impl ContinueDeploymentFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::continue_deployment::ContinueDeploymentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::continue_deployment::ContinueDeploymentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::continue_deployment::ContinueDeploymentOutput, crate::operation::continue_deployment::ContinueDeploymentError, Self> {
