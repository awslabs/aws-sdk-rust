...
impl ListGitHubAccountTokenNamesInput {
    /// Consumes the builder and constructs an Operation<[`ListGitHubAccountTokenNames`](crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNames)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNames, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_git_hub_account_token_names::ser_list_git_hub_account_token_names_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNames::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListGitHubAccountTokenNames", "codedeploy"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListGitHubAccountTokenNames`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListGitHubAccountTokenNames {
                type Output = std::result::Result<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesOutput, crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError>;
