...
/// Orchestration and serialization glue logic for `ListGitHubAccountTokenNames`.
...
impl ListGitHubAccountTokenNames {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesInput,
                    ) -> ::std::result::Result<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListGitHubAccountTokenNames {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListGitHubAccountTokenNames");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListGitHubAccountTokenNamesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListGitHubAccountTokenNamesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListGitHubAccountTokenNames")
...
.with_interceptor(ListGitHubAccountTokenNamesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError>::new());
...
#[derive(Debug)]
            struct ListGitHubAccountTokenNamesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListGitHubAccountTokenNamesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_git_hub_account_token_names::de_list_git_hub_account_token_names_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_git_hub_account_token_names::de_list_git_hub_account_token_names_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListGitHubAccountTokenNamesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListGitHubAccountTokenNamesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_git_hub_account_token_names::ser_list_git_hub_account_token_names_input(&input)?);
...
#[derive(Debug)]
            struct ListGitHubAccountTokenNamesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListGitHubAccountTokenNamesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListGitHubAccountTokenNamesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListGitHubAccountTokenNamesInput>()
                        .ok_or("failed to downcast to ListGitHubAccountTokenNamesInput")?;
...
pub enum ListGitHubAccountTokenNamesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListGitHubAccountTokenNamesError) for what information is available for the error.")]
...
impl ListGitHubAccountTokenNamesError {
    /// Creates the `ListGitHubAccountTokenNamesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListGitHubAccountTokenNamesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::ResourceValidationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListGitHubAccountTokenNamesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError {
...
mod _list_git_hub_account_token_names_output;
