...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGitHubAccountTokenNames {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_git_hub_account_token_names::de_list_git_hub_account_token_names_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListGitHubAccountTokenNamesError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_git_hub_account_token_names::ListGitHubAccountTokenNamesError
{
