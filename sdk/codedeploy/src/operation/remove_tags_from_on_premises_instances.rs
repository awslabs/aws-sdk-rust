...
impl RemoveTagsFromOnPremisesInstances {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesInput,
                    ) -> ::std::result::Result<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RemoveTagsFromOnPremisesInstances {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RemoveTagsFromOnPremisesInstances");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RemoveTagsFromOnPremisesInstancesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RemoveTagsFromOnPremisesInstancesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RemoveTagsFromOnPremisesInstances")
...
.with_interceptor(RemoveTagsFromOnPremisesInstancesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError>::new());
...
#[derive(Debug)]
            struct RemoveTagsFromOnPremisesInstancesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RemoveTagsFromOnPremisesInstancesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_remove_tags_from_on_premises_instances::de_remove_tags_from_on_premises_instances_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct RemoveTagsFromOnPremisesInstancesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RemoveTagsFromOnPremisesInstancesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_remove_tags_from_on_premises_instances::ser_remove_tags_from_on_premises_instances_input(&input)?);
...
#[derive(Debug)]
            struct RemoveTagsFromOnPremisesInstancesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RemoveTagsFromOnPremisesInstancesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RemoveTagsFromOnPremisesInstancesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RemoveTagsFromOnPremisesInstancesInput>()
                        .ok_or("failed to downcast to RemoveTagsFromOnPremisesInstancesInput")?;
...
pub enum RemoveTagsFromOnPremisesInstancesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RemoveTagsFromOnPremisesInstancesError) for what information is available for the error.")]
...
impl RemoveTagsFromOnPremisesInstancesError {
    /// Creates the `RemoveTagsFromOnPremisesInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveTagsFromOnPremisesInstancesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::InstanceLimitExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InstanceNameRequiredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::InstanceNotRegisteredException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RemoveTagsFromOnPremisesInstancesError {
...
mod _remove_tags_from_on_premises_instances_output;
