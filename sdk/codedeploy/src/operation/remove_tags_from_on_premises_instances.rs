...
impl RemoveTagsFromOnPremisesInstancesInput {
    /// Consumes the builder and constructs an Operation<[`RemoveTagsFromOnPremisesInstances`](crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_remove_tags_from_on_premises_instances::ser_remove_tags_from_on_premises_instances_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstances::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemoveTagsFromOnPremisesInstances", "codedeploy"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTagsFromOnPremisesInstances {
    type Output = ::std::result::Result<crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesOutput, crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstancesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_tags_from_on_premises_instances::de_remove_tags_from_on_premises_instances_http_response_with_props(status, headers, body)
        }
    }
}
