...
impl RemoveTagsFromOnPremisesInstancesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstances,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_tags_from_on_premises_instances::RemoveTagsFromOnPremisesInstances::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTagsFromOnPremisesInstances {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_tags_from_on_premises_instances::de_remove_tags_from_on_premises_instances_http_response_with_props(
                status, headers, body,
            )
        }
    }
