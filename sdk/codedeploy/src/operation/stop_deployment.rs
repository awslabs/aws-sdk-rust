...
impl StopDeploymentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_deployment::StopDeployment, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_deployment::ser_stop_deployment_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDeployment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_deployment::de_stop_deployment_http_response_with_props(status, headers, body)
        }
    }
}
