...
impl AddTagsToOnPremisesInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesOutput, crate::operation::add_tags_to_on_premises_instances::AddTagsToOnPremisesInstancesError, Self> {
