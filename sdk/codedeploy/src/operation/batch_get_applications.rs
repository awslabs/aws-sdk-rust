...
impl BatchGetApplications {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_get_applications::BatchGetApplicationsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_get_applications::BatchGetApplicationsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("CodeDeploy", "BatchGetApplications", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "CodeDeploy.BatchGetApplications",
                "rpc.service" = "CodeDeploy",
                "rpc.method" = "BatchGetApplications",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchGetApplications {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            BatchGetApplicationsRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            BatchGetApplicationsResponseDeserializer,
        ));
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchGetApplicationsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_get_applications::de_batch_get_applications_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_get_applications::de_batch_get_applications_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchGetApplicationsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_get_applications::BatchGetApplicationsInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::batch_get_applications::BatchGetApplicationsInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_get_applications::ser_batch_get_applications_input(
            &input,
        )?);
