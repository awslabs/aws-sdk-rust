...
impl ListOnPremisesInstancesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_on_premises_instances::ListOnPremisesInstancesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_on_premises_instances::ListOnPremisesInstancesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_on_premises_instances::ListOnPremisesInstancesOutput, crate::operation::list_on_premises_instances::ListOnPremisesInstancesError, Self> {
