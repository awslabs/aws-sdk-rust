...
impl crate::operation::register_on_premises_instance::builders::RegisterOnPremisesInstanceInputBuilder {
...
impl RegisterOnPremisesInstanceFluentBuilder {
    /// Creates a new `RegisterOnPremisesInstanceFluentBuilder`.
