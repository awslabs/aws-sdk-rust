...
impl super::Client {
    ...
    ///   - [`filters(SearchDevicesFilter)`](crate::operation::search_devices::builders::SearchDevicesFluentBuilder::filters) / [`set_filters(Option<Vec<SearchDevicesFilter>>)`](crate::operation::search_devices::builders::SearchDevicesFluentBuilder::set_filters): <p>The filter values to use to search for a device.</p>
