...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::search_quantum_tasks::builders::SearchQuantumTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_quantum_tasks::builders::SearchQuantumTasksFluentBuilder::set_next_token):<br>required: **false**<br><p>A token used for pagination of results returned in the response. Use the token returned from the previous request to continue search where the previous request ended.</p><br>
    ...
    ///   - [`quantum_tasks(Vec::<QuantumTaskSummary>)`](crate::operation::search_quantum_tasks::SearchQuantumTasksOutput::quantum_tasks): <p>An array of <code>QuantumTaskSummary</code> objects for quantum tasks that match the specified filters.</p>
    ///   - [`next_token(Option<String>)`](crate::operation::search_quantum_tasks::SearchQuantumTasksOutput::next_token): <p>A token used for pagination of results, or null if there are no additional results. Use the token value in a subsequent request to continue search where the previous request ended.</p>
