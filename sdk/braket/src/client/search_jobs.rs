...
impl super::Client {
    ...
    ///   - [`filters(SearchJobsFilter)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::filters) / [`set_filters(Vec<SearchJobsFilter>)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::set_filters):<br>required: **true**<br><p>The filter values to use when searching for a job.</p><br>
