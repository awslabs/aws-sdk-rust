...
impl super::Client {
    ...
    ///   - [`next_token(impl Into<String>)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::set_next_token):<br>required: **false**<br><p>A token used for pagination of results returned in the response. Use the token returned from the previous request to continue search where the previous request ended.</p><br>
    ...
    ///   - [`filters(SearchJobsFilter)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::filters) / [`set_filters(Option<Vec::<SearchJobsFilter>>)`](crate::operation::search_jobs::builders::SearchJobsFluentBuilder::set_filters):<br>required: **true**<br><p>Array of SearchJobsFilter objects to use when searching for hybrid jobs.</p><br>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::search_jobs::SearchJobsOutput::next_token): <p>A token used for pagination of results, or <code>null</code> if there are no additional results. Use the token value in a subsequent request to continue search where the previous request ended.</p>
