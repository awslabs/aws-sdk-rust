...
impl aws_smithy_http::response::ParseStrictResponse for CancelQuantumTask {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_cancel_quantum_task::de_cancel_quantum_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_cancel_quantum_task::de_cancel_quantum_task_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for CreateQuantumTask {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 201 {
                        crate::protocol_serde::shape_create_quantum_task::de_create_quantum_task_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_quantum_task::de_create_quantum_task_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetQuantumTask {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        ...
                        crate::protocol_serde::shape_get_quantum_task::de_get_quantum_task_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for SearchQuantumTasks {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_search_quantum_tasks::de_search_quantum_tasks_http_error(response)
                     } else {
                        crate::protocol_serde::shape_search_quantum_tasks::de_search_quantum_tasks_http_response(response)
                     }
                }
            }
