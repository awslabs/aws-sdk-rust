...
pub fn ser_input_file_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::InputFileConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_input_file_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::InputFileConfig>, aws_smithy_json::deserialize::error::DeserializeError>
