            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "scriptModeConfig" => {
                            builder = builder.set_script_mode_config(crate::protocol_serde::shape_script_mode_config::de_script_mode_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "containerImage" => {
                            builder = builder.set_container_image(crate::protocol_serde::shape_container_image::de_container_image(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
