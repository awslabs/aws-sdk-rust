...
pub struct SearchQuantumTasksOutput  {
    ...
    #[doc(hidden)]pub quantum_tasks: std::option::Option<std::vec::Vec<crate::model::QuantumTaskSummary>>,
...
pub struct CancelQuantumTaskOutput  {
    ...
    #[doc(hidden)]pub cancellation_status: std::option::Option<crate::model::CancellationStatus>,
}
...
pub struct GetJobOutput  {
    ...
    #[doc(hidden)]pub billable_duration: std::option::Option<i32>,
    ...
    #[doc(hidden)]pub events: std::option::Option<std::vec::Vec<crate::model::JobEventDetails>>,
...
pub struct GetDeviceOutput  {
    ...
    #[doc(hidden)]pub device_capabilities: std::option::Option<std::string::String>,
}
