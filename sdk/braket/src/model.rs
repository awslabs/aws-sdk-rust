...
pub struct QuantumTaskSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::QuantumTaskStatus>,
    ...
    #[doc(hidden)]pub output_s3_directory: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ended_at: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct SearchQuantumTasksFilter  {
    ...
    #[doc(hidden)]pub operator: std::option::Option<crate::model::SearchQuantumTasksFilterOperator>,
}
...
pub struct JobSummary  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::JobPrimaryStatus>,
...
pub struct SearchJobsFilter  {
    ...
    #[doc(hidden)]pub operator: std::option::Option<crate::model::SearchJobsFilterOperator>,
}
...
pub struct InstanceConfig  {
    ...
    #[doc(hidden)]pub instance_type: std::option::Option<crate::model::InstanceType>,
    /// <p>The size of the storage volume, in GB, that user wants to provision.</p>
    #[doc(hidden)]pub volume_size_in_gb: std::option::Option<i32>,
...
pub struct JobStoppingCondition  {
    ...
    #[doc(hidden)]pub max_runtime_in_seconds: std::option::Option<i32>,
}
...
pub struct JobCheckpointConfig  {
    ...
    #[doc(hidden)]pub local_path: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub s3_uri: std::option::Option<std::string::String>,
}
...
pub struct DataSource  {
    ...
    #[doc(hidden)]pub s3_data_source: std::option::Option<crate::model::S3DataSource>,
}
impl DataSource {
    /// <p>Information about the data stored in Amazon S3 used by the Amazon Braket job.</p>
...
pub struct AlgorithmSpecification  {
    ...
    #[doc(hidden)]pub script_mode_config: std::option::Option<crate::model::ScriptModeConfig>,
    /// <p>The container image used to create an Amazon Braket job.</p>
    #[doc(hidden)]pub container_image: std::option::Option<crate::model::ContainerImage>,
}
...
pub struct ScriptModeConfig  {
    ...
    #[doc(hidden)]pub entry_point: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub compression_type: std::option::Option<crate::model::CompressionType>,
}
...
pub struct JobEventDetails  {
    ...
    #[doc(hidden)]pub event_type: std::option::Option<crate::model::JobEventType>,
    /// <p>TThe type of event that occurred related to the Amazon Braket job.</p>
    #[doc(hidden)]pub time_of_event: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct DeviceSummary  {
    ...
    #[doc(hidden)]pub device_type: std::option::Option<crate::model::DeviceType>,
    /// <p>The status of the device.</p>
    #[doc(hidden)]pub device_status: std::option::Option<crate::model::DeviceStatus>,
}
impl DeviceSummary {
    /// <p>The ARN of the device.</p>
    pub fn device_arn(&self) -> std::option::Option<& str> {
