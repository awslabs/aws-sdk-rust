...
impl SearchDevicesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_devices::SearchDevices, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_devices::ser_search_devices_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchDevices {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_devices::de_search_devices_http_response_with_props(status, headers, body)
        }
    }
}
