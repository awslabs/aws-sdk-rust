...
impl SearchDevicesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_devices::SearchDevicesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::search_devices::SearchDevicesOutput {
                devices: self.devices
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("devices", "devices was not specified but it is required when building SearchDevicesOutput")
                    )?
                ,
