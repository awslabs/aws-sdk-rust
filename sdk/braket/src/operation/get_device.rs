...
#[derive(Debug)]
    ...
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("device_arn", "cannot be empty or unset"))?;
    ...
    if device_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("device_arn", "cannot be empty or unset"))
                }
