...
impl SearchJobsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::JobSummary, ::aws_smithy_http::result::SdkError<crate::operation::search_jobs::SearchJobsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_search_jobs_output_jobs(page).unwrap_or_default().into_iter())
    }
}
