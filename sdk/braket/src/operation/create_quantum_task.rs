...
impl CreateQuantumTask {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Braket", "CreateQuantumTask", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Braket.CreateQuantumTask",
                "rpc.service" = "Braket",
                "rpc.method" = "CreateQuantumTask",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateQuantumTask")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateQuantumTaskResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 201 || force_error {
            crate::protocol_serde::shape_create_quantum_task::de_create_quantum_task_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_create_quantum_task::de_create_quantum_task_http_response(status, headers, body, _cfg)
        };
