...
impl SearchJobsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::search_jobs::SearchJobs, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_search_jobs::ser_search_jobs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchJobs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_search_jobs::de_search_jobs_http_response_with_props(status, headers, body)
        }
    }
}
