...
impl SearchQuantumTasksInput {
    ...
    > {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_quantum_tasks::ser_search_quantum_tasks_input(
                &self,
            )?,
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_quantum_tasks::SearchQuantumTasks::new(),
        )
...
impl aws_http::request_id::RequestId
    for crate::operation::search_quantum_tasks::SearchQuantumTasksError
{
