...
impl ::std::convert::From<&str> for JobPrimaryStatus {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => JobPrimaryStatus::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for JobPrimaryStatus {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(JobPrimaryStatus::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for JobPrimaryStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
