...
pub(crate) fn reflens_list_environment_vpcs_output_output_next_token(
...
pub(crate) fn lens_list_applications_output_output_application_summary_list(
    input: crate::operation::list_applications::ListApplicationsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ApplicationSummary>> {
    let input = input.application_summary_list?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_environment_vpcs_output_output_environment_vpc_list(
    input: crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::EnvironmentVpc>> {
    let input = input.environment_vpc_list?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_environments_output_output_environment_summary_list(
    input: crate::operation::list_environments::ListEnvironmentsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::EnvironmentSummary>> {
    let input = input.environment_summary_list?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_routes_output_output_route_summary_list(
    input: crate::operation::list_routes::ListRoutesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::RouteSummary>> {
    let input = input.route_summary_list?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_services_output_output_service_summary_list(
    input: crate::operation::list_services::ListServicesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ServiceSummary>> {
    let input = input.service_summary_list?;
    ::std::option::Option::Some(input)
}
