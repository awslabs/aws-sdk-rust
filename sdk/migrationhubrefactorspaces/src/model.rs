...
pub struct ServiceSummary  {
    ...
    #[doc(hidden)]pub url_endpoint: std::option::Option<crate::model::UrlEndpointSummary>,
    /// <p>A summary of the configuration for the Lambda endpoint type. </p>
    #[doc(hidden)]pub lambda_endpoint: std::option::Option<crate::model::LambdaEndpointSummary>,
...
pub struct ErrorResponse  {
    ...
    #[doc(hidden)]pub resource_type: std::option::Option<crate::model::ErrorResourceType>,
    /// <p>Additional details about the error. </p>
    #[doc(hidden)]pub additional_details: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl ErrorResponse {
    /// <p>The error code associated with the error. </p>
...
pub struct UrlEndpointSummary  {
    ...
    #[doc(hidden)]pub health_url: std::option::Option<std::string::String>,
}
...
pub struct EnvironmentVpc  {
    ...
    #[doc(hidden)]pub cidr_blocks: std::option::Option<std::vec::Vec<std::string::String>>,
    /// <p>The name of the VPC at the time it is added to the environment. </p>
    #[doc(hidden)]pub vpc_name: std::option::Option<std::string::String>,
...
pub struct ApplicationSummary  {
    ...
    #[doc(hidden)]pub api_gateway_proxy: std::option::Option<crate::model::ApiGatewayProxySummary>,
...
pub struct ApiGatewayProxySummary  {
    ...
    #[doc(hidden)]pub proxy_url: std::option::Option<std::string::String>,
    /// <p>The resource ID of the API Gateway for the proxy. </p>
    #[doc(hidden)]pub api_gateway_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub nlb_arn: std::option::Option<std::string::String>,
    /// <p>The name of the Network Load Balancer that is configured by the API Gateway proxy. </p>
    #[doc(hidden)]pub nlb_name: std::option::Option<std::string::String>,
    /// <p>The type of API Gateway endpoint created. </p>
    #[doc(hidden)]pub endpoint_type: std::option::Option<crate::model::ApiGatewayEndpointType>,
