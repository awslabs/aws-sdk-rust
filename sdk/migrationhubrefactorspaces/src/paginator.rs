            ...
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            let new_token =
                                crate::lens::reflens_list_environment_vpcs_output_next_token(resp);
                            let is_empty = new_token.map(|token| token.is_empty()).unwrap_or(true);
                            if !is_empty
                                && new_token == input.next_token.as_ref()
                                && self.stop_on_duplicate_token
...
impl ListApplicationsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_applications_output_application_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListEnvironmentsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_environments_output_environment_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListEnvironmentVpcsPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_environment_vpcs_output_environment_vpc_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListRoutesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_routes_output_route_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
...
impl ListServicesPaginatorItems {
    ...
    > + Unpin {
        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_services_output_service_summary_list(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
