                    ...
                    match crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_environment_vpcs::ListEnvironmentVpcsError::unhandled(
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_environment_vpcs::de_list_environment_vpcs(_response_body, output)
            .map_err(crate::operation::list_environment_vpcs::ListEnvironmentVpcsError::unhandled)?;
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "EnvironmentVpcList" => {
                    builder = builder.set_environment_vpc_list(crate::protocol_serde::shape_environment_vpcs::de_environment_vpcs(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
