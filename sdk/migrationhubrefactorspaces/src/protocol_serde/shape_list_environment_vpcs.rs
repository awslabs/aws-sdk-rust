...
pub fn de_list_environment_vpcs_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput, crate::operation::list_environment_vpcs::ListEnvironmentVpcsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_environment_vpcs::ListEnvironmentVpcsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_environment_vpcs_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput, crate::operation::list_environment_vpcs::ListEnvironmentVpcsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_environment_vpcs::builders::ListEnvironmentVpcsOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_list_environment_vpcs::de_list_environment_vpcs(response.body().as_ref(), output).map_err(crate::operation::list_environment_vpcs::ListEnvironmentVpcsError::unhandled)?;
