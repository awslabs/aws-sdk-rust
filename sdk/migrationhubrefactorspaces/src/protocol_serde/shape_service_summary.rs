            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "UrlEndpoint" => {
                            builder = builder.set_url_endpoint(crate::protocol_serde::shape_url_endpoint_summary::de_url_endpoint_summary(tokens)?);
                        }
                        "LambdaEndpoint" => {
                            builder = builder
                                .set_lambda_endpoint(crate::protocol_serde::shape_lambda_endpoint_summary::de_lambda_endpoint_summary(tokens)?);
                        }
                        "State" => {
