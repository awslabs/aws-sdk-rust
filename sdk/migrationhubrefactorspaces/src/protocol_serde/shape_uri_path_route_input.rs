...
pub(crate) fn de_uri_path_route_input<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::UriPathRouteInput>, aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_uri_path_route_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UriPathRouteInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
