...
pub struct UpdateRouteOutput  {
    ...
    #[doc(hidden)]pub state: std::option::Option<crate::model::RouteState>,
...
pub struct ListRoutesOutput  {
    ...
    #[doc(hidden)]pub route_summary_list: std::option::Option<std::vec::Vec<crate::model::RouteSummary>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListEnvironmentVpcsOutput  {
    ...
    #[doc(hidden)]pub environment_vpc_list: std::option::Option<std::vec::Vec<crate::model::EnvironmentVpc>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListEnvironmentsOutput  {
    ...
    #[doc(hidden)]pub environment_summary_list: std::option::Option<std::vec::Vec<crate::model::EnvironmentSummary>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct ListApplicationsOutput  {
    ...
    #[doc(hidden)]pub application_summary_list: std::option::Option<std::vec::Vec<crate::model::ApplicationSummary>>,
    /// <p>The token for the next page of results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetServiceOutput  {
    ...
    #[doc(hidden)]pub created_by_account_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub endpoint_type: std::option::Option<crate::model::ServiceEndpointType>,
    ...
    #[doc(hidden)]pub url_endpoint: std::option::Option<crate::model::UrlEndpointConfig>,
    ...
    #[doc(hidden)]pub lambda_endpoint: std::option::Option<crate::model::LambdaEndpointConfig>,
    /// <p>The current state of the service. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ServiceState>,
    ...
    #[doc(hidden)]pub error: std::option::Option<crate::model::ErrorResponse>,
...
pub struct GetRouteOutput  {
    ...
    #[doc(hidden)]pub route_type: std::option::Option<crate::model::RouteType>,
    /// <p>The unique identifier of the service.</p>
    #[doc(hidden)]pub service_id: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub source_path: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub methods: std::option::Option<std::vec::Vec<crate::model::HttpMethod>>,
    ...
    #[doc(hidden)]pub include_child_paths: std::option::Option<bool>,
    /// <p>A mapping of Amazon API Gateway path resources to resource IDs. </p>
    #[doc(hidden)]pub path_resource_to_id: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The current state of the route. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::RouteState>,
...
pub struct GetEnvironmentOutput  {
    ...
    #[doc(hidden)]pub network_fabric_type: std::option::Option<crate::model::NetworkFabricType>,
    ...
    #[doc(hidden)]pub transit_gateway_id: std::option::Option<std::string::String>,
...
pub struct GetApplicationOutput  {
    ...
    #[doc(hidden)]pub proxy_type: std::option::Option<crate::model::ProxyType>,
    /// <p>The endpoint URL of the API Gateway proxy. </p>
    #[doc(hidden)]pub api_gateway_proxy: std::option::Option<crate::model::ApiGatewayProxyConfig>,
    /// <p>The current state of the application. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ApplicationState>,
...
pub struct CreateServiceOutput  {
    ...
    #[doc(hidden)]pub endpoint_type: std::option::Option<crate::model::ServiceEndpointType>,
    /// <p>The configuration for the URL endpoint type. </p>
    #[doc(hidden)]pub url_endpoint: std::option::Option<crate::model::UrlEndpointInput>,
    /// <p>The configuration for the Lambda endpoint type.</p>
    #[doc(hidden)]pub lambda_endpoint: std::option::Option<crate::model::LambdaEndpointInput>,
    /// <p>The current state of the service. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ServiceState>,
...
pub struct CreateRouteOutput  {
    ...
    #[doc(hidden)]pub uri_path_route: std::option::Option<crate::model::UriPathRouteInput>,
...
pub struct CreateApplicationOutput  {
    ...
    #[doc(hidden)]pub api_gateway_proxy: std::option::Option<crate::model::ApiGatewayProxyInput>,
    /// <p>The current state of the application. </p>
    #[doc(hidden)]pub state: std::option::Option<crate::model::ApplicationState>,
    /// <p>The tags assigned to the application. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key-value pair. </p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
