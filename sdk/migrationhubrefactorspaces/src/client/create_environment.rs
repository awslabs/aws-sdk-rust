...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::name) / [`set_name(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_name):<br>required: **true**<br><p>The name of the environment.</p><br>
    ///   - [`description(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_description):<br>required: **false**<br><p>The description of the environment.</p><br>
    ///   - [`network_fabric_type(NetworkFabricType)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::network_fabric_type) / [`set_network_fabric_type(NetworkFabricType)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_network_fabric_type):<br>required: **true**<br><p>The network fabric type of the environment.</p><br>
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_tags):<br>required: **false**<br><p>The tags to assign to the environment. A tag is a label that you assign to an Amazon Web Services resource. Each tag consists of a key-value pair.</p><br>
    ///   - [`client_token(impl Into<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_environment::builders::CreateEnvironmentFluentBuilder::set_client_token):<br>required: **false**<br><p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p><br>
