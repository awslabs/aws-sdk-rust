...
impl super::Client {
    ...
    ///   - [`environment_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::environment_identifier) / [`set_environment_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_environment_identifier):<br>required: **true**<br><p>The ID of the environment.</p><br>
    ///   - [`application_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::application_identifier) / [`set_application_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_application_identifier):<br>required: **true**<br><p>The ID of the application.</p><br>
    ///   - [`service_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::service_identifier) / [`set_service_identifier(impl Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_service_identifier):<br>required: **true**<br><p>The ID of the service.</p><br>
