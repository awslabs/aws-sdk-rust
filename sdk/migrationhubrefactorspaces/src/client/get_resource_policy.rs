...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::get_resource_policy::builders::GetResourcePolicyFluentBuilder::set_identifier):<br>required: **true**<br><p>The Amazon Resource Name (ARN) of the resource associated with the policy.</p><br>
