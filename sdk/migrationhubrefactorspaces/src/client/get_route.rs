...
impl super::Client {
    ...
    ///   - [`environment_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::environment_identifier) / [`set_environment_identifier(Option<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::set_environment_identifier): <p>The ID of the environment.</p>
    ///   - [`application_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::application_identifier) / [`set_application_identifier(Option<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::set_application_identifier): <p>The ID of the application. </p>
    ///   - [`route_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::route_identifier) / [`set_route_identifier(Option<String>)`](crate::operation::get_route::builders::GetRouteFluentBuilder::set_route_identifier): <p>The ID of the route.</p>
