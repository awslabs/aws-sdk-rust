...
impl super::Client {
    ...
    ///   - [`environment_identifier(impl Into<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::environment_identifier) / [`set_environment_identifier(Option<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::set_environment_identifier):<br>required: **true**<br><p>The ID of the environment in which the route is being updated.</p><br>
    ///   - [`application_identifier(impl Into<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::application_identifier) / [`set_application_identifier(Option<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::set_application_identifier):<br>required: **true**<br><p>The ID of the application within which the route is being updated.</p><br>
    ///   - [`route_identifier(impl Into<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::route_identifier) / [`set_route_identifier(Option<String>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::set_route_identifier):<br>required: **true**<br><p>The unique identifier of the route to update.</p><br>
    ///   - [`activation_state(RouteActivationState)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::activation_state) / [`set_activation_state(Option<RouteActivationState>)`](crate::operation::update_route::builders::UpdateRouteFluentBuilder::set_activation_state):<br>required: **true**<br><p>If set to <code>ACTIVE</code>, traffic is forwarded to this route’s service after the route is updated.</p><br>
