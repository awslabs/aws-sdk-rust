...
impl super::Client {
    ...
    ///   - [`environment_identifier(impl Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::environment_identifier) / [`set_environment_identifier(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_environment_identifier):<br>required: **true**<br><p>The ID of the environment to delete the route from.</p><br>
    ...
    ///   - [`route_identifier(impl Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::route_identifier) / [`set_route_identifier(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_route_identifier):<br>required: **true**<br><p>The ID of the route to delete.</p><br>
