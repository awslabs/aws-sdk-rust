...
impl super::Client {
    ...
    ///   - [`environment_identifier(impl ::std::convert::Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::environment_identifier) / [`set_environment_identifier(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_environment_identifier): <p>The ID of the environment to delete the route from.</p>
    ///   - [`application_identifier(impl ::std::convert::Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::application_identifier) / [`set_application_identifier(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_application_identifier): <p>The ID of the application to delete the route from.</p>
    ///   - [`route_identifier(impl ::std::convert::Into<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::route_identifier) / [`set_route_identifier(Option<String>)`](crate::operation::delete_route::builders::DeleteRouteFluentBuilder::set_route_identifier): <p>The ID of the route to delete.</p>
