...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput,
                    crate::operation::list_environment_vpcs::ListEnvironmentVpcsError,
                > for ListEnvironmentVpcsFluentBuilder
            {
                fn send(
                    self,
...
impl ListEnvironmentVpcsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_environment_vpcs::ListEnvironmentVpcsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_environment_vpcs::ListEnvironmentVpcs::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_environment_vpcs::ListEnvironmentVpcsOutput, crate::operation::list_environment_vpcs::ListEnvironmentVpcsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_environment_vpcs::paginator::ListEnvironmentVpcsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
