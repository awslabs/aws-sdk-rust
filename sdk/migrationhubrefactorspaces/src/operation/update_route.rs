...
impl UpdateRouteInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_route::UpdateRoute, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_route::ser_update_route_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoute {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_route::de_update_route_http_response_with_props(status, headers, body)
        }
    }
}
