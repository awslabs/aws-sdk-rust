...
impl GetApplicationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_application::GetApplication, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_application::GetApplication::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("GetApplication", "migrationhubrefactorspaces"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApplication {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_application::de_get_application_http_response_with_props(status, headers, body)
        }
    }
