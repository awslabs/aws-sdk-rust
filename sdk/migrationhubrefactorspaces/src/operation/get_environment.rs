...
impl GetEnvironmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_environment::GetEnvironment::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("GetEnvironment", "migrationhubrefactorspaces"),
        );
