...
impl GetResourcePolicyInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_policy::GetResourcePolicy::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("GetResourcePolicy", "migrationhubrefactorspaces"),
            );
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourcePolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_resource_policy::de_get_resource_policy_http_response_with_props(status, headers, body)
        }
    }
}
