...
impl DeleteApplicationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_application::DeleteApplication::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DeleteApplication", "migrationhubrefactorspaces"),
        );
