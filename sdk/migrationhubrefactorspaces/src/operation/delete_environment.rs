...
impl DeleteEnvironmentInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_environment::DeleteEnvironment::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("DeleteEnvironment", "migrationhubrefactorspaces"),
        );
