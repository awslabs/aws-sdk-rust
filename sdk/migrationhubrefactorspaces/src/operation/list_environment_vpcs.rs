...
impl ListEnvironmentVpcsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_environment_vpcs::ListEnvironmentVpcs::new()).with_metadata(
                ::aws_smithy_http::operation::Metadata::new("ListEnvironmentVpcs", "migrationhubrefactorspaces"),
            );
