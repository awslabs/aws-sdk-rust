...
impl CreateEnvironmentInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_environment::ser_create_environment_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_environment::CreateEnvironment::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("CreateEnvironment", "migrationhubrefactorspaces"),
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_environment::de_create_environment_http_response_with_props(status, headers, body)
        }
    }
