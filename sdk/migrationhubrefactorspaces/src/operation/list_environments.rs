...
impl ListEnvironmentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_environments::ListEnvironments::new()).with_metadata(
            ::aws_smithy_http::operation::Metadata::new("ListEnvironments", "migrationhubrefactorspaces"),
        );
