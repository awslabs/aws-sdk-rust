...
impl ListRoutesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_routes::ListRoutes::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRoutes {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_routes::de_list_routes_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_routes::de_list_routes_http_response_with_props(
                status, headers, body,
            )
        }
    }
