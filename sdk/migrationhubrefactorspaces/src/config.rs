...
impl Builder {
    ...
    /// use aws_sdk_migrationhubrefactorspaces::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_migrationhubrefactorspaces::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
