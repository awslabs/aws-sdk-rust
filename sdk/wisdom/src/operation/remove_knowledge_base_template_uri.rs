...
impl RemoveKnowledgeBaseTemplateUriInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUri::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveKnowledgeBaseTemplateUri {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_remove_knowledge_base_template_uri::de_remove_knowledge_base_template_uri_http_response_with_props(
                status, headers, body,
            )
        }
    }
