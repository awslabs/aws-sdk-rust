...
impl ListAssistantsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_assistants::ListAssistants::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListAssistants {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_assistants::de_list_assistants_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_assistants::de_list_assistants_http_response(
                status, headers, body,
            )
        }
    }
