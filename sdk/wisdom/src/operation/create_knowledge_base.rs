...
impl CreateKnowledgeBaseInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_knowledge_base::ser_create_knowledge_base_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_knowledge_base::CreateKnowledgeBase::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_knowledge_base::CreateKnowledgeBaseError
{
