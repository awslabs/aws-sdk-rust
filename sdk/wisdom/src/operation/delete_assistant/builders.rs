...
impl DeleteAssistantFluentBuilder  {
    /// Creates a new `DeleteAssistant`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_assistant::DeleteAssistantOutput, aws_smithy_http::result::SdkError<crate::operation::delete_assistant::DeleteAssistantError>>
                     {
