...
impl ListAssistantAssociationsInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_assistant_associations::ListAssistantAssociations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssistantAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_assistant_associations::de_list_assistant_associations_http_response_with_props(status, headers, body)
        }
    }
}
