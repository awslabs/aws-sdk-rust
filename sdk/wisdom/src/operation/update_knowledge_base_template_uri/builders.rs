...
impl UpdateKnowledgeBaseTemplateUriFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUriOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUriError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUriOutput, crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUriError, Self> {
