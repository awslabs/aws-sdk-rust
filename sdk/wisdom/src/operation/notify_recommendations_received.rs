...
impl NotifyRecommendationsReceivedInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::notify_recommendations_received::NotifyRecommendationsReceived::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyRecommendationsReceived {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_notify_recommendations_received::de_notify_recommendations_received_http_response_with_props(
                status, headers, body,
            )
        }
    }
