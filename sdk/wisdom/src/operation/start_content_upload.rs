...
impl StartContentUploadInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_start_content_upload::ser_start_content_upload_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartContentUpload {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_start_content_upload::de_start_content_upload_http_response_with_props(status, headers, body)
        }
    }
