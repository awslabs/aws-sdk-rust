...
impl GetAssistantAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_assistant_association::GetAssistantAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
