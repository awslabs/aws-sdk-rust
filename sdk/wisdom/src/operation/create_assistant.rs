...
impl CreateAssistantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_assistant::CreateAssistant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_assistant::ser_create_assistant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAssistant {
    type Output =
        ::std::result::Result<crate::operation::create_assistant::CreateAssistantOutput, crate::operation::create_assistant::CreateAssistantError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_assistant::de_create_assistant_http_response_with_props(status, headers, body)
        }
    }
}
