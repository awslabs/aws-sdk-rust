...
impl DeleteAssistantAssociationInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_assistant_association::DeleteAssistantAssociation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAssistantAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_assistant_association::de_delete_assistant_association_http_response_with_props(status, headers, body)
        }
    }
}
