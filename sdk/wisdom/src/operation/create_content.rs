...
impl CreateContentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_content::CreateContent,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_content::CreateContent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_content::de_create_content_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_content::de_create_content_http_response_with_props(
                status, headers, body,
            )
        }
    }
