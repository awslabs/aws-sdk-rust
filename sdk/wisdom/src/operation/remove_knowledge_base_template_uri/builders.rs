...
impl RemoveKnowledgeBaseTemplateUriFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriOutput, crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriError, Self> {
