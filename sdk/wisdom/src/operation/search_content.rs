...
impl SearchContentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::search_content::SearchContent,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::search_content::SearchContent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_search_content::de_search_content_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_search_content::de_search_content_http_response_with_props(
                status, headers, body,
            )
        }
    }
