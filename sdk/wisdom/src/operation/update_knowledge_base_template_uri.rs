...
impl UpdateKnowledgeBaseTemplateUriInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUri,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUri::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateKnowledgeBaseTemplateUri {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_knowledge_base_template_uri::de_update_knowledge_base_template_uri_http_response_with_props(
                status, headers, body,
            )
        }
    }
