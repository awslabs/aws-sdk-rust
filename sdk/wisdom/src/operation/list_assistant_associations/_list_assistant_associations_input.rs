...
impl ListAssistantAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_assistant_associations::ListAssistantAssociationsInput, ::aws_smithy_types::error::operation::BuildError> {
