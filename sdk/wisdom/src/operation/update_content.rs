...
impl UpdateContentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_content::UpdateContent,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_content::UpdateContent::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContent {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_content::de_update_content_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_content::de_update_content_http_response_with_props(
                status, headers, body,
            )
        }
    }
