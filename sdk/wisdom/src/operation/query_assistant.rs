...
impl QueryAssistantInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::query_assistant::QueryAssistant, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_query_assistant::ser_query_assistant_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryAssistant {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_query_assistant::de_query_assistant_http_response_with_props(status, headers, body)
        }
    }
