...
impl super::Client {
    ...
    ///   - [`content_id(impl ::std::convert::Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::content_id) / [`set_content_id(Option<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::set_content_id): <p>The identifier of the content. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ///   - [`knowledge_base_id(impl ::std::convert::Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(Option<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::set_knowledge_base_id): <p>The identifier of the knowledge base. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
