...
impl super::Client {
    ...
    ///   - [`content_id(impl Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::content_id) / [`set_content_id(impl Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::set_content_id):<br>required: **true**<br><p>The identifier of the content. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
    ///   - [`knowledge_base_id(impl Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(impl Into<String>)`](crate::operation::get_content_summary::builders::GetContentSummaryFluentBuilder::set_knowledge_base_id):<br>required: **true**<br><p>The identifier of the knowledge base. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
