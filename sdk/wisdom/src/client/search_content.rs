...
impl super::Client {
    ...
    ///   - [`knowledge_base_id(impl Into<String>)`](crate::operation::search_content::builders::SearchContentFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(impl Into<String>)`](crate::operation::search_content::builders::SearchContentFluentBuilder::set_knowledge_base_id):<br>required: **true**<br><p>The identifier of the knowledge base. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
