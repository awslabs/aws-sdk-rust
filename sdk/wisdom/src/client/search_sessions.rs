...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_sessions::builders::SearchSessionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_sessions::builders::SearchSessionsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
    ...
    ///   - [`assistant_id(impl ::std::convert::Into<String>)`](crate::operation::search_sessions::builders::SearchSessionsFluentBuilder::assistant_id) / [`set_assistant_id(Option<String>)`](crate::operation::search_sessions::builders::SearchSessionsFluentBuilder::set_assistant_id): <p>The identifier of the Wisdom assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
