...
impl super::Client {
    ...
    ///   - [`knowledge_base_id(impl ::std::convert::Into<String>)`](crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(Option<String>)`](crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder::set_knowledge_base_id): <p>The identifier of the knowledge base. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ///   - [`content_type(impl ::std::convert::Into<String>)`](crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder::content_type) / [`set_content_type(Option<String>)`](crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder::set_content_type): <p>The type of content to upload.</p>
    ...
    pub fn start_content_upload(
        &self,
    ) -> crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder {
        crate::operation::start_content_upload::builders::StartContentUploadFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
