...
impl super::Client {
    ...
    ///   - [`knowledge_base_id(impl ::std::convert::Into<String>)`](crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(Option<String>)`](crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder::set_knowledge_base_id): <p>The identifier of the knowledge base. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ...
    pub fn get_knowledge_base(
        &self,
    ) -> crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder {
        crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
