...
impl super::Client {
    ...
    ///   - [`knowledge_base_id(impl Into<String>)`](crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder::knowledge_base_id) / [`set_knowledge_base_id(Option<String>)`](crate::operation::get_knowledge_base::builders::GetKnowledgeBaseFluentBuilder::set_knowledge_base_id):<br>required: **true**<br><p>The identifier of the knowledge base. This should not be a QUICK_RESPONSES type knowledge base if you're storing Wisdom Content resource to it. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
