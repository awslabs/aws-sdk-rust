...
impl super::Client {
    ...
    ///   - [`assistant_id(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::assistant_id) / [`set_assistant_id(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_assistant_id):<br>required: **true**<br><p>The identifier of the Wisdom assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p><br>
    ///   - [`query_text(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::query_text) / [`set_query_text(impl Into<String>)`](crate::operation::query_assistant::builders::QueryAssistantFluentBuilder::set_query_text):<br>required: **true**<br><p>The text to search for.</p><br>
