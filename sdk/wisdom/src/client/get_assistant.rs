...
impl super::Client {
    ...
    ///   - [`assistant_id(impl ::std::convert::Into<String>)`](crate::operation::get_assistant::builders::GetAssistantFluentBuilder::assistant_id) / [`set_assistant_id(Option<String>)`](crate::operation::get_assistant::builders::GetAssistantFluentBuilder::set_assistant_id): <p>The identifier of the Wisdom assistant. Can be either the ID or the ARN. URLs cannot contain the ARN.</p>
    ...
    pub fn get_assistant(
        &self,
    ) -> crate::operation::get_assistant::builders::GetAssistantFluentBuilder {
        crate::operation::get_assistant::builders::GetAssistantFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
