...
impl super::Client {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::set_client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. If not provided, the Amazon Web Services SDK populates this field. For more information about idempotency, see <a href="https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/">Making retries safe with idempotent APIs</a>.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::set_name): <p>The name of the knowledge base.</p>
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_knowledge_base::builders::CreateKnowledgeBaseFluentBuilder::set_description): <p>The description.</p>
