...
impl ImportJobDataBuilder {
    ...
    pub fn set_failed_record_report(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.failed_record_report = input; self
    }
    /// <p>The link to donwload the information of resource data that failed to be imported.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::ImportJobData, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::ImportJobData {
                import_job_id: self.import_job_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("import_job_id", "import_job_id was not specified but it is required when building ImportJobData")
                    )?
                ,
                knowledge_base_id: self.knowledge_base_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("knowledge_base_id", "knowledge_base_id was not specified but it is required when building ImportJobData")
                    )?
                ,
                upload_id: self.upload_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("upload_id", "upload_id was not specified but it is required when building ImportJobData")
                    )?
                ,
                knowledge_base_arn: self.knowledge_base_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("knowledge_base_arn", "knowledge_base_arn was not specified but it is required when building ImportJobData")
                    )?
                ,
                import_job_type: self.import_job_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("import_job_type", "import_job_type was not specified but it is required when building ImportJobData")
                    )?
                ,
                status: self.status
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("status", "status was not specified but it is required when building ImportJobData")
                    )?
                ,
                url: self.url
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("url", "url was not specified but it is required when building ImportJobData")
                    )?
                ,
                ...
                url_expiry: self.url_expiry
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("url_expiry", "url_expiry was not specified but it is required when building ImportJobData")
                    )?
                ,
                created_time: self.created_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("created_time", "created_time was not specified but it is required when building ImportJobData")
                    )?
                ,
                last_modified_time: self.last_modified_time
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("last_modified_time", "last_modified_time was not specified but it is required when building ImportJobData")
                    )?
                ,
