...
impl ::std::convert::From<&str> for Priority {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => Priority::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for Priority {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(Priority::from(s))
    }
}
impl Priority {
...
impl ::std::convert::AsRef<str> for Priority {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
