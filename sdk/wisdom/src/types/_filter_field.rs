...
impl ::std::convert::From<&str> for FilterField {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FilterField::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FilterField {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FilterField::from(s))
    }
}
impl FilterField {
...
impl ::std::convert::AsRef<str> for FilterField {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
