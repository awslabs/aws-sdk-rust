        ...
        ::std::result::Result::Ok(
            crate::types::AssistantAssociationSummary {
                assistant_association_id: self.assistant_association_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_association_id", "assistant_association_id was not specified but it is required when building AssistantAssociationSummary")
                    )?
                ,
                assistant_association_arn: self.assistant_association_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_association_arn", "assistant_association_arn was not specified but it is required when building AssistantAssociationSummary")
                    )?
                ,
                assistant_id: self.assistant_id
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_id", "assistant_id was not specified but it is required when building AssistantAssociationSummary")
                    )?
                ,
                assistant_arn: self.assistant_arn
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("assistant_arn", "assistant_arn was not specified but it is required when building AssistantAssociationSummary")
                    )?
                ,
                association_type: self.association_type
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("association_type", "association_type was not specified but it is required when building AssistantAssociationSummary")
                    )?
                ,
