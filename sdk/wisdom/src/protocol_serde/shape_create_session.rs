...
pub fn ser_create_session_input(
    ...
    crate::protocol_serde::shape_create_session_input::ser_create_session_input_input(&mut object, input)?;
    object.finish();
...
) -> Result<crate::operation::create_session::builders::CreateSessionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
