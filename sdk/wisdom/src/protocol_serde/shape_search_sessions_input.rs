...
pub fn ser_search_sessions_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SearchSessionsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
