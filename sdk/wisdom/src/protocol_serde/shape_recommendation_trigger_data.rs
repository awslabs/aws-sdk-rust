...
pub(crate) fn de_recommendation_trigger_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RecommendationTriggerData>, aws_smithy_json::deserialize::error::DeserializeError>
