...
pub(crate) fn de_knowledge_base_data<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KnowledgeBaseData>, aws_smithy_json::deserialize::error::DeserializeError>
