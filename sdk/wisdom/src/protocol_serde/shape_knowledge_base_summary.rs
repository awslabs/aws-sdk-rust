...
pub(crate) fn de_knowledge_base_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::KnowledgeBaseSummary>, aws_smithy_json::deserialize::error::DeserializeError>
