...
pub fn ser_create_assistant_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAssistantInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
