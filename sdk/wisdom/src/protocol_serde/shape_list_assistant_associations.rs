...
pub fn de_list_assistant_associations_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_assistant_associations::ListAssistantAssociationsOutput, crate::operation::list_assistant_associations::ListAssistantAssociationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::list_assistant_associations::ListAssistantAssociationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_assistant_associations_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::list_assistant_associations::ListAssistantAssociationsOutput, crate::operation::list_assistant_associations::ListAssistantAssociationsError> {
    Ok({
        #[allow(unused_mut)]
