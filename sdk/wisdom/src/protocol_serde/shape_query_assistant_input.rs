...
pub fn ser_query_assistant_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::query_assistant::QueryAssistantInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
