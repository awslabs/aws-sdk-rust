...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl ::std::convert::Into<String>)`](crate::operation::get_policy::builders::GetPolicyFluentBuilder::profiling_group_name) / [`set_profiling_group_name(Option<String>)`](crate::operation::get_policy::builders::GetPolicyFluentBuilder::set_profiling_group_name): <p>The name of the profiling group.</p>
