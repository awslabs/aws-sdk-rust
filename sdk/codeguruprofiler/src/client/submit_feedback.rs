...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl ::std::convert::Into<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::profiling_group_name) / [`set_profiling_group_name(Option<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::set_profiling_group_name): <p>The name of the profiling group that is associated with the analysis data.</p>
    ///   - [`anomaly_instance_id(impl ::std::convert::Into<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::anomaly_instance_id) / [`set_anomaly_instance_id(Option<String>)`](crate::operation::submit_feedback::builders::SubmitFeedbackFluentBuilder::set_anomaly_instance_id): <p>The universally unique identifier (UUID) of the <a href="https://docs.aws.amazon.com/codeguru/latest/profiler-api/API_AnomalyInstance.html"> <code>AnomalyInstance</code> </a> object that is included in the analysis data.</p>
