...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::update_profiling_group::builders::UpdateProfilingGroupFluentBuilder::profiling_group_name) / [`set_profiling_group_name(impl Into<String>)`](crate::operation::update_profiling_group::builders::UpdateProfilingGroupFluentBuilder::set_profiling_group_name):<br>required: **true**<br><p>The name of the profiling group to update.</p><br>
