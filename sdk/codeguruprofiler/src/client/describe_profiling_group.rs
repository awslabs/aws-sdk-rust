...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::describe_profiling_group::builders::DescribeProfilingGroupFluentBuilder::profiling_group_name) / [`set_profiling_group_name(impl Into<String>)`](crate::operation::describe_profiling_group::builders::DescribeProfilingGroupFluentBuilder::set_profiling_group_name):<br>required: **true**<br><p> The name of the profiling group to get information about. </p><br>
