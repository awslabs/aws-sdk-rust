...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::profiling_group_name) / [`set_profiling_group_name(Option<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::set_profiling_group_name): <p>The name of the profiling group to grant access to.</p>
