...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::profiling_group_name) / [`set_profiling_group_name(Option<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::set_profiling_group_name):<br>required: **true**<br><p>The name of the profiling group to grant access to.</p><br>
    ...
    ///   - [`principals(impl Into<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::principals) / [`set_principals(Option<Vec::<String>>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::set_principals):<br>required: **true**<br><p>A list ARNs for the roles and users you want to grant access to the profiling group. Wildcards are not are supported in the ARNs.</p><br>
