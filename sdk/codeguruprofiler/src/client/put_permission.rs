...
impl super::Client {
    ...
    ///   - [`principals(impl Into<String>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::principals) / [`set_principals(Option<Vec<String>>)`](crate::operation::put_permission::builders::PutPermissionFluentBuilder::set_principals): <p> A list ARNs for the roles and users you want to grant access to the profiling group. Wildcards are not are supported in the ARNs. </p>
