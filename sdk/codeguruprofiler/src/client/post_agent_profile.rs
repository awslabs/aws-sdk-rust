...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::profiling_group_name) / [`set_profiling_group_name(impl Into<String>)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::set_profiling_group_name):<br>required: **true**<br><p> The name of the profiling group with the aggregated profile that receives the submitted profiling data. </p><br>
    ///   - [`agent_profile(Blob)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::agent_profile) / [`set_agent_profile(Blob)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::set_agent_profile):<br>required: **true**<br><p> The submitted profiling data. </p><br>
