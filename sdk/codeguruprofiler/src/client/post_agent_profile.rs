...
impl super::Client {
    ...
    ///   - [`agent_profile(Blob)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::agent_profile) / [`set_agent_profile(Option<Blob>)`](crate::operation::post_agent_profile::builders::PostAgentProfileFluentBuilder::set_agent_profile):<br>required: **true**<br><p>The submitted profiling data.</p><br>
