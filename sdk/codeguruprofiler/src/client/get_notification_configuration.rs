...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::get_notification_configuration::builders::GetNotificationConfigurationFluentBuilder::profiling_group_name) / [`set_profiling_group_name(impl Into<String>)`](crate::operation::get_notification_configuration::builders::GetNotificationConfigurationFluentBuilder::set_profiling_group_name):<br>required: **true**<br><p>The name of the profiling group we want to get the notification configuration for.</p><br>
