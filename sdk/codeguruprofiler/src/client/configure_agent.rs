...
impl super::Client {
    ...
    ///   - [`profiling_group_name(impl Into<String>)`](crate::operation::configure_agent::builders::ConfigureAgentFluentBuilder::profiling_group_name) / [`set_profiling_group_name(Option<String>)`](crate::operation::configure_agent::builders::ConfigureAgentFluentBuilder::set_profiling_group_name): <p> The name of the profiling group for which the configured agent is collecting profiling data. </p>
    ///   - [`fleet_instance_id(impl Into<String>)`](crate::operation::configure_agent::builders::ConfigureAgentFluentBuilder::fleet_instance_id) / [`set_fleet_instance_id(Option<String>)`](crate::operation::configure_agent::builders::ConfigureAgentFluentBuilder::set_fleet_instance_id): <p> A universally unique identifier (UUID) for a profiling instance. For example, if the profiling instance is an Amazon EC2 instance, it is the instance ID. If it is an AWS Fargate container, it is the container's task ID. </p>
