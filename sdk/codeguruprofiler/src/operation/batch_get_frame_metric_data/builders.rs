...
impl BatchGetFrameMetricDataFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataOutput, crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError, Self> {
