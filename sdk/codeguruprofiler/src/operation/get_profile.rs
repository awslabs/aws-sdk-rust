    ...
    > {
        ...
        let mut request = {
            ...
            > {
                ...
                let builder = crate::protocol_serde::shape_get_profile::ser_get_profile_headers(
                    input, builder,
                )?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_profile::GetProfile::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProfile {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_profile::de_get_profile_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_profile::de_get_profile_http_response_with_props(
                status, headers, body,
            )
        }
    }
