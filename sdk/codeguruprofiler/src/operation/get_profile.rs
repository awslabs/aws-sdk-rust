...
impl GetProfileInput {
    /// Consumes the builder and constructs an Operation<[`GetProfile`](crate::operation::get_profile::GetProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_profile::GetProfile, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_profile::GetProfileInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_profile::GetProfileInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                let mut query = aws_smithy_http::query::Writer::new(output);
                if let Some(inner_2) = &_input.start_time {
                     {
                        query.push_kv("startTime", &aws_smithy_http::query::fmt_timestamp(inner_2, aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let Some(inner_3) = &_input.period {
                     {
                ...
                if let Some(inner_5) = &_input.max_depth {
                    if *inner_5 != 0 {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_profile::GetProfile::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetProfile {
                type Output = std::result::Result<crate::operation::get_profile::GetProfileOutput, crate::operation::get_profile::GetProfileError>;
