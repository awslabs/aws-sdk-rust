...
impl AddNotificationChannelsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::add_notification_channels::AddNotificationChannelsInput, ::aws_smithy_types::error::operation::BuildError> {
