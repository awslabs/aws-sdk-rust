...
impl ListFindingsReportsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_findings_reports::ListFindingsReports::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFindingsReports {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_findings_reports::de_list_findings_reports_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_findings_reports::ListFindingsReportsError
{
