...
impl GetNotificationConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_notification_configuration::GetNotificationConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_notification_configuration::GetNotificationConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_notification_configuration::GetNotificationConfigurationOutput, crate::operation::get_notification_configuration::GetNotificationConfigurationError, Self> {
