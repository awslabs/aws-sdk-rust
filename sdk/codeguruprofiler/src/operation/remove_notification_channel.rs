...
impl RemoveNotificationChannelInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::remove_notification_channel::RemoveNotificationChannel,
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_notification_channel::RemoveNotificationChannel::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveNotificationChannel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_remove_notification_channel::de_remove_notification_channel_http_response_with_props(status, headers, body)
        }
    }
}
