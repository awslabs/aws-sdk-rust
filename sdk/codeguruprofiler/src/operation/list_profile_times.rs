...
impl ListProfileTimesInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_profile_times::ListProfileTimes::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListProfileTimes {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_profile_times::de_list_profile_times_http_error(
                status, headers, body,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_profile_times::ListProfileTimesError
{
