...
impl PostAgentProfileInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::post_agent_profile::PostAgentProfile::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for PostAgentProfile {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 204 {
            crate::protocol_serde::shape_post_agent_profile::de_post_agent_profile_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_post_agent_profile::de_post_agent_profile_http_response(
                response,
            )
        }
    }
...
impl aws_http::request_id::RequestId
    for crate::operation::post_agent_profile::PostAgentProfileError
{
