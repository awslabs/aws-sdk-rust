...
impl DescribeProfilingGroupInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::describe_profiling_group::DescribeProfilingGroup,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProfilingGroup {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_profiling_group::de_describe_profiling_group_http_response_with_props(status, headers, body)
        }
    }
}
