...
impl CreateProfilingGroupFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_profiling_group::CreateProfilingGroupOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_profiling_group::CreateProfilingGroupError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_profiling_group::CreateProfilingGroupOutput, crate::operation::create_profiling_group::CreateProfilingGroupError, Self> {
