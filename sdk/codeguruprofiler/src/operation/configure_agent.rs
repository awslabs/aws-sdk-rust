...
impl ConfigureAgentInput {
    /// Consumes the builder and constructs an Operation<[`ConfigureAgent`](crate::operation::configure_agent::ConfigureAgent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::configure_agent::ConfigureAgent, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::configure_agent::ConfigureAgentInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::configure_agent::ConfigureAgent::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ConfigureAgent {
                type Output = std::result::Result<crate::operation::configure_agent::ConfigureAgentOutput, crate::operation::configure_agent::ConfigureAgentError>;
