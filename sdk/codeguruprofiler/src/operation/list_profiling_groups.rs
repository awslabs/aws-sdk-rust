...
impl ListProfilingGroups {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_profiling_groups::ListProfilingGroupsInput,
                    ) -> ::std::result::Result<crate::operation::list_profiling_groups::ListProfilingGroupsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_profiling_groups::ListProfilingGroupsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_profiling_groups::ListProfilingGroupsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_profiling_groups::ListProfilingGroupsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListProfilingGroups {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListProfilingGroups");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListProfilingGroupsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListProfilingGroupsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListProfilingGroups")
...
.with_interceptor(ListProfilingGroupsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_profiling_groups::ListProfilingGroupsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_profiling_groups::ListProfilingGroupsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_profiling_groups::ListProfilingGroupsError>::new());
...
#[derive(Debug)]
            struct ListProfilingGroupsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListProfilingGroupsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_profiling_groups::de_list_profiling_groups_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListProfilingGroupsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListProfilingGroupsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_profiling_groups::ListProfilingGroupsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_profiling_groups::ListProfilingGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/profilingGroups").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_profiling_groups::ListProfilingGroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    if let ::std::option::Option::Some(inner_3) = &_input.include_description {
         {
            query.push_kv("includeDescription", ::aws_smithy_types::primitive::Encoder::from(*inner_3).encode());
        }
    }
    ::std::result::Result::Ok(())
}
...
#[derive(Debug)]
            struct ListProfilingGroupsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListProfilingGroupsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListProfilingGroupsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListProfilingGroupsInput>()
                        .ok_or("failed to downcast to ListProfilingGroupsInput")?;
...
pub enum ListProfilingGroupsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListProfilingGroupsError) for what information is available for the error.")]
...
impl ListProfilingGroupsError {
    /// Creates the `ListProfilingGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListProfilingGroupsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListProfilingGroupsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_profiling_groups::ListProfilingGroupsError {
...
mod _list_profiling_groups_output;
