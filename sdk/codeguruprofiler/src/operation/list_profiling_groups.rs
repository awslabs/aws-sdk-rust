...
impl ListProfilingGroupsInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_profiling_groups::ListProfilingGroups::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListProfilingGroups {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_profiling_groups::de_list_profiling_groups_http_error(
                response,
            )
        } else {
...
impl aws_http::request_id::RequestId
    for crate::operation::list_profiling_groups::ListProfilingGroupsError
{
