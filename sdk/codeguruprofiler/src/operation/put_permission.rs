...
impl PutPermissionInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::put_permission::PutPermission, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_permission::ser_put_permission_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutPermission {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_put_permission::de_put_permission_http_response_with_props(status, headers, body)
        }
    }
}
