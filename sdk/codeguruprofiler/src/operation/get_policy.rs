...
impl GetPolicyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_policy::GetPolicy,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_policy::GetPolicy::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPolicy {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_policy::de_get_policy_http_response_with_props(
                status, headers, body,
            )
        }
    }
