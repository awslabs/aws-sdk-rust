...
impl SubmitFeedbackInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::submit_feedback::SubmitFeedback, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_submit_feedback::ser_submit_feedback_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubmitFeedback {
    type Output =
        ::std::result::Result<crate::operation::submit_feedback::SubmitFeedbackOutput, crate::operation::submit_feedback::SubmitFeedbackError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_submit_feedback::de_submit_feedback_http_response_with_props(status, headers, body)
        }
    }
}
