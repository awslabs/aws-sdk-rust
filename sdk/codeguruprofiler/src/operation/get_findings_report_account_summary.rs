...
/// Orchestration and serialization glue logic for `GetFindingsReportAccountSummary`.
...
impl GetFindingsReportAccountSummary {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryInput,
                    ) -> ::std::result::Result<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFindingsReportAccountSummary {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetFindingsReportAccountSummary");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetFindingsReportAccountSummaryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetFindingsReportAccountSummaryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFindingsReportAccountSummary")
...
.with_interceptor(GetFindingsReportAccountSummaryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError>::new());
...
#[derive(Debug)]
            struct GetFindingsReportAccountSummaryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFindingsReportAccountSummaryResponseDeserializer {
...
#[derive(Debug)]
            struct GetFindingsReportAccountSummaryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFindingsReportAccountSummaryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/internal/findingsReports").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetFindingsReportAccountSummaryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetFindingsReportAccountSummaryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetFindingsReportAccountSummaryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetFindingsReportAccountSummaryInput>()
                        .ok_or("failed to downcast to GetFindingsReportAccountSummaryInput")?;
...
pub enum GetFindingsReportAccountSummaryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetFindingsReportAccountSummaryError) for what information is available for the error.")]
...
impl GetFindingsReportAccountSummaryError {
    /// Creates the `GetFindingsReportAccountSummaryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFindingsReportAccountSummaryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetFindingsReportAccountSummaryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError {
...
mod _get_findings_report_account_summary_output;
