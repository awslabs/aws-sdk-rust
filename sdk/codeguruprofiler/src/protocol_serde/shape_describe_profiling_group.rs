...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::describe_profiling_group::DescribeProfilingGroupError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = output.set_profiling_group(crate::protocol_serde::shape_describe_profiling_group_output::de_profiling_group_payload(
            _response_body,
        )?);
