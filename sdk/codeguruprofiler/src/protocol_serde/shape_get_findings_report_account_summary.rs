...
> {
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::get_findings_report_account_summary::GetFindingsReportAccountSummaryError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_findings_report_account_summary_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "reportSummaries" => {
                    builder = builder.set_report_summaries(crate::protocol_serde::shape_findings_report_summaries::de_findings_report_summaries(
                        tokens,
                    )?);
                }
