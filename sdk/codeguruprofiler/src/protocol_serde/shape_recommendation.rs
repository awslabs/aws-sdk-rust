            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "pattern" => {
                            builder = builder.set_pattern(crate::protocol_serde::shape_pattern::de_pattern(tokens)?);
                        }
                        "topMatches" => {
                            builder = builder.set_top_matches(crate::protocol_serde::shape_matches::de_matches(tokens)?);
                        }
                        "startTime" => {
