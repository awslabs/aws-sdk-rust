...
pub fn de_remove_permission_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::remove_permission::RemovePermissionOutput, crate::operation::remove_permission::RemovePermissionError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_remove_permission::de_remove_permission(response.body().as_ref(), output).map_err(crate::operation::remove_permission::RemovePermissionError::unhandled)?;
