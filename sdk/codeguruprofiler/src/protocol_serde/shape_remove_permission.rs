...
pub fn de_remove_permission_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::RemovePermissionOutput, crate::error::RemovePermissionError> {
    Ok({
        ...
        let _ = response;
        output = crate::protocol_serde::shape_remove_permission::de_remove_permission(response.body().as_ref(), output).map_err(crate::error::RemovePermissionError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_remove_permission(value: &[u8], mut builder: crate::output::remove_permission_output::Builder) -> Result<crate::output::remove_permission_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
