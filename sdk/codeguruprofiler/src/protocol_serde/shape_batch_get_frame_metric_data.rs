...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError::unhandled(
                generic,
            ))
        }
    };
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_frame_metric_data::de_batch_get_frame_metric_data(_response_body, output)
            .map_err(crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::batch_get_frame_metric_data_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::batch_get_frame_metric_data::BatchGetFrameMetricDataError::unhandled)?
    })
}
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "endTimes" => {
                    builder = builder.set_end_times(crate::protocol_serde::shape_list_of_timestamps::de_list_of_timestamps(tokens)?);
                }
                "frameMetricData" => {
                    builder = builder.set_frame_metric_data(crate::protocol_serde::shape_frame_metric_data::de_frame_metric_data(tokens)?);
                }
                "resolution" => {
