...
pub fn de_profiling_group_payload(body: &[u8]) -> std::result::Result<std::option::Option<crate::types::ProfilingGroupDescription>, crate::operation::describe_profiling_group::DescribeProfilingGroupError> {
    (!body.is_empty()).then(||{
