...
impl Builder {
    ...
    /// use aws_sdk_codeguruprofiler::config::endpoint::{Params as EndpointParams, DefaultResolver};
    ...
    /// };
    /// let config = aws_sdk_codeguruprofiler::Config::builder().endpoint_resolver(prefix_resolver);
    /// ```
