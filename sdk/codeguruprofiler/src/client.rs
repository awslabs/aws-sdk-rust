    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`AddNotificationChannelsInput`](crate::input::AddNotificationChannelsInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::AddNotificationChannelsInput::profiling_group_name): <p>The name of the profiling group that we are setting up notifications for.</p>
    ///   - [`channels(Option<Vec<Channel>>)`](crate::input::AddNotificationChannelsInput::channels): <p>One or 2 channels to report to when anomalies are detected.</p>
    ...
    ///
    /// - Takes [`BatchGetFrameMetricDataInput`](crate::input::BatchGetFrameMetricDataInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::BatchGetFrameMetricDataInput::profiling_group_name): <p> The name of the profiling group associated with the the frame metrics used to return the time series values. </p>
    ...
    ///   - [`end_time(Option<DateTime>)`](crate::input::BatchGetFrameMetricDataInput::end_time): <p> The end time of the time period for the returned time series values. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC. </p>
    ///   - [`period(Option<String>)`](crate::input::BatchGetFrameMetricDataInput::period): <p> The duration of the frame metrics used to return the time series values. Specify using the ISO 8601 format. The maximum period duration is one day (<code>PT24H</code> or <code>P1D</code>). </p>
    ///   - [`target_resolution(Option<AggregationPeriod>)`](crate::input::BatchGetFrameMetricDataInput::target_resolution): <p>The requested resolution of time steps for the returned time series of values. If the requested target resolution is not available due to data not being retained we provide a best effort result by falling back to the most granular available resolution after the target resolution. There are 3 valid values. </p>  <ul>   <li> <p> <code>P1D</code> — 1 day </p> </li>   <li> <p> <code>PT1H</code> — 1 hour </p> </li>   <li> <p> <code>PT5M</code> — 5 minutes </p> </li>  </ul>
    ///   - [`frame_metrics(Option<Vec<FrameMetric>>)`](crate::input::BatchGetFrameMetricDataInput::frame_metrics): <p> The details of the metrics that are used to request a time series of values. The metric includes the name of the frame, the aggregation type to calculate the metric value for the frame, and the thread states to use to get the count for the metric value of the frame.</p>
    ...
    ///
    /// - Takes [`CreateProfilingGroupInput`](crate::input::CreateProfilingGroupInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::CreateProfilingGroupInput::profiling_group_name): <p>The name of the profiling group to create.</p>
    ///   - [`compute_platform(Option<ComputePlatform>)`](crate::input::CreateProfilingGroupInput::compute_platform): <p> The compute platform of the profiling group. Use <code>AWSLambda</code> if your application runs on AWS Lambda. Use <code>Default</code> if your application runs on a compute platform that is not AWS Lambda, such an Amazon EC2 instance, an on-premises server, or a different platform. If not specified, <code>Default</code> is used. </p>
    ///   - [`client_token(Option<String>)`](crate::input::CreateProfilingGroupInput::client_token): <p> Amazon CodeGuru Profiler uses this universally unique identifier (UUID) to prevent the accidental creation of duplicate profiling groups if there are failures and retries. </p>
    ///   - [`agent_orchestration_config(Option<AgentOrchestrationConfig>)`](crate::input::CreateProfilingGroupInput::agent_orchestration_config): <p> Specifies whether profiling is enabled or disabled for the created profiling group. </p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::CreateProfilingGroupInput::tags): <p> A list of tags to add to the created profiling group. </p>
    ...
    ///
    /// - Takes [`DeleteProfilingGroupInput`](crate::input::DeleteProfilingGroupInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::DeleteProfilingGroupInput::profiling_group_name): <p>The name of the profiling group to delete.</p>
    ...
    ///
    /// - Takes [`DescribeProfilingGroupInput`](crate::input::DescribeProfilingGroupInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::DescribeProfilingGroupInput::profiling_group_name): <p> The name of the profiling group to get information about. </p>
    ...
    ///
    /// - Takes [`GetFindingsReportAccountSummaryInput`](crate::input::GetFindingsReportAccountSummaryInput) with field(s):
    ///   - [`next_token(Option<String>)`](crate::input::GetFindingsReportAccountSummaryInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>GetFindingsReportAccountSummary</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. </p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ///   - [`max_results(Option<i32>)`](crate::input::GetFindingsReportAccountSummaryInput::max_results): <p>The maximum number of results returned by <code> GetFindingsReportAccountSummary</code> in paginated output. When this parameter is used, <code>GetFindingsReportAccountSummary</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>GetFindingsReportAccountSummary</code> request with the returned <code>nextToken</code> value.</p>
    ///   - [`daily_reports_only(Option<bool>)`](crate::input::GetFindingsReportAccountSummaryInput::daily_reports_only): <p>A <code>Boolean</code> value indicating whether to only return reports from daily profiles. If set to <code>True</code>, only analysis data from daily profiles is returned. If set to <code>False</code>, analysis data is returned from smaller time windows (for example, one hour).</p>
    ...
    ///
    /// - Takes [`GetNotificationConfigurationInput`](crate::input::GetNotificationConfigurationInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::GetNotificationConfigurationInput::profiling_group_name): <p>The name of the profiling group we want to get the notification configuration for.</p>
    ...
    ///   - [`profiling_group_name(Option<String>)`](crate::input::GetPolicyInput::profiling_group_name): <p>The name of the profiling group.</p>
    ...
    ///   - [`profiling_group_name(Option<String>)`](crate::input::GetProfileInput::profiling_group_name): <p>The name of the profiling group to get.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::GetProfileInput::start_time): <p>The start time of the profile to get. Specify using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC.</p>  <p> If you specify <code>startTime</code>, then you must also specify <code>period</code> or <code>endTime</code>, but not both. </p>
    ///   - [`period(Option<String>)`](crate::input::GetProfileInput::period): <p> Used with <code>startTime</code> or <code>endTime</code> to specify the time range for the returned aggregated profile. Specify using the ISO 8601 format. For example, <code>P1DT1H1M1S</code>. </p>  <p> To get the latest aggregated profile, specify only <code>period</code>. </p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::GetProfileInput::end_time): <p> The end time of the requested profile. Specify using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC. </p>  <p> If you specify <code>endTime</code>, then you must also specify <code>period</code> or <code>startTime</code>, but not both. </p>
    ///   - [`max_depth(Option<i32>)`](crate::input::GetProfileInput::max_depth): <p> The maximum depth of the stacks in the code that is represented in the aggregated profile. For example, if CodeGuru Profiler finds a method <code>A</code>, which calls method <code>B</code>, which calls method <code>C</code>, which calls method <code>D</code>, then the depth is 4. If the <code>maxDepth</code> is set to 2, then the aggregated profile contains representations of methods <code>A</code> and <code>B</code>. </p>
    ///   - [`accept(Option<String>)`](crate::input::GetProfileInput::accept): <p> The format of the returned profiling data. The format maps to the <code>Accept</code> and <code>Content-Type</code> headers of the HTTP request. You can specify one of the following: or the default . </p>  <ul>   <li> <p> <code>application/json</code> — standard JSON format </p> </li>   <li> <p> <code>application/x-amzn-ion</code> — the Amazon Ion data format. For more information, see <a href="http://amzn.github.io/ion-docs/">Amazon Ion</a>. </p> </li>  </ul>
    ...
    ///
    /// - Takes [`ListFindingsReportsInput`](crate::input::ListFindingsReportsInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::ListFindingsReportsInput::profiling_group_name): <p>The name of the profiling group from which to search for analysis data.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::ListFindingsReportsInput::start_time): <p> The start time of the profile to get analysis data about. You must specify <code>startTime</code> and <code>endTime</code>. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC. </p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::ListFindingsReportsInput::end_time): <p> The end time of the profile to get analysis data about. You must specify <code>startTime</code> and <code>endTime</code>. This is specified using the ISO 8601 format. For example, 2020-06-01T13:15:02.001Z represents 1 millisecond past June 1, 2020 1:15:02 PM UTC. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListFindingsReportsInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>ListFindingsReportsRequest</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. </p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ///   - [`max_results(Option<i32>)`](crate::input::ListFindingsReportsInput::max_results): <p>The maximum number of report results returned by <code>ListFindingsReports</code> in paginated output. When this parameter is used, <code>ListFindingsReports</code> only returns <code>maxResults</code> results in a single page along with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListFindingsReports</code> request with the returned <code>nextToken</code> value.</p>
    ///   - [`daily_reports_only(Option<bool>)`](crate::input::ListFindingsReportsInput::daily_reports_only): <p>A <code>Boolean</code> value indicating whether to only return reports from daily profiles. If set to <code>True</code>, only analysis data from daily profiles is returned. If set to <code>False</code>, analysis data is returned from smaller time windows (for example, one hour).</p>
    ...
    ///
    /// - Takes [`ListProfileTimesInput`](crate::input::ListProfileTimesInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::ListProfileTimesInput::profiling_group_name): <p>The name of the profiling group.</p>
    ///   - [`start_time(Option<DateTime>)`](crate::input::ListProfileTimesInput::start_time): <p>The start time of the time range from which to list the profiles.</p>
    ///   - [`end_time(Option<DateTime>)`](crate::input::ListProfileTimesInput::end_time): <p>The end time of the time range from which to list the profiles.</p>
    ///   - [`period(Option<AggregationPeriod>)`](crate::input::ListProfileTimesInput::period): <p> The aggregation period. This specifies the period during which an aggregation profile collects posted agent profiles for a profiling group. There are 3 valid values. </p>  <ul>   <li> <p> <code>P1D</code> — 1 day </p> </li>   <li> <p> <code>PT1H</code> — 1 hour </p> </li>   <li> <p> <code>PT5M</code> — 5 minutes </p> </li>  </ul>
    ///   - [`order_by(Option<OrderBy>)`](crate::input::ListProfileTimesInput::order_by): <p>The order (ascending or descending by start time of the profile) to use when listing profiles. Defaults to <code>TIMESTAMP_DESCENDING</code>. </p>
    ///   - [`max_results(Option<i32>)`](crate::input::ListProfileTimesInput::max_results): <p>The maximum number of profile time results returned by <code>ListProfileTimes</code> in paginated output. When this parameter is used, <code>ListProfileTimes</code> only returns <code>maxResults</code> results in a single page with a <code>nextToken</code> response element. The remaining results of the initial request can be seen by sending another <code>ListProfileTimes</code> request with the returned <code>nextToken</code> value. </p>
    ///   - [`next_token(Option<String>)`](crate::input::ListProfileTimesInput::next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>ListProfileTimes</code> request where <code>maxResults</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value. </p> <note>   <p>This token should be treated as an opaque identifier that is only used to retrieve the next items in a list and not for other programmatic purposes.</p>  </note>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::ListTagsForResourceInput::resource_arn): <p> The Amazon Resource Name (ARN) of the resource that contains the tags to return. </p>
    ...
    ///
    /// - Takes [`PostAgentProfileInput`](crate::input::PostAgentProfileInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::PostAgentProfileInput::profiling_group_name): <p> The name of the profiling group with the aggregated profile that receives the submitted profiling data. </p>
    ///   - [`agent_profile(Option<Blob>)`](crate::input::PostAgentProfileInput::agent_profile): <p> The submitted profiling data. </p>
    ///   - [`profile_token(Option<String>)`](crate::input::PostAgentProfileInput::profile_token): <p> Amazon CodeGuru Profiler uses this universally unique identifier (UUID) to prevent the accidental submission of duplicate profiling data if there are failures and retries. </p>
    ///   - [`content_type(Option<String>)`](crate::input::PostAgentProfileInput::content_type): <p> The format of the submitted profiling data. The format maps to the <code>Accept</code> and <code>Content-Type</code> headers of the HTTP request. You can specify one of the following: or the default . </p>  <ul>   <li> <p> <code>application/json</code> — standard JSON format </p> </li>   <li> <p> <code>application/x-amzn-ion</code> — the Amazon Ion data format. For more information, see <a href="http://amzn.github.io/ion-docs/">Amazon Ion</a>. </p> </li>  </ul>
    ...
    ///   - [`profiling_group_name(Option<String>)`](crate::input::PutPermissionInput::profiling_group_name): <p>The name of the profiling group to grant access to.</p>
    ///   - [`action_group(Option<ActionGroup>)`](crate::input::PutPermissionInput::action_group): <p> Specifies an action group that contains permissions to add to a profiling group resource. One action group is supported, <code>agentPermissions</code>, which grants permission to perform actions required by the profiling agent, <code>ConfigureAgent</code> and <code>PostAgentProfile</code> permissions. </p>
    ///   - [`principals(Option<Vec<String>>)`](crate::input::PutPermissionInput::principals): <p> A list ARNs for the roles and users you want to grant access to the profiling group. Wildcards are not are supported in the ARNs. </p>
    ///   - [`revision_id(Option<String>)`](crate::input::PutPermissionInput::revision_id): <p> A universally unique identifier (UUID) for the revision of the policy you are adding to the profiling group. Do not specify this when you add permissions to a profiling group for the first time. If a policy already exists on the profiling group, you must specify the <code>revisionId</code>. </p>
    ...
    ///   - [`profiling_group_name(Option<String>)`](crate::input::RemoveNotificationChannelInput::profiling_group_name): <p>The name of the profiling group we want to change notification configuration for.</p>
    ///   - [`channel_id(Option<String>)`](crate::input::RemoveNotificationChannelInput::channel_id): <p>The id of the channel that we want to stop receiving notifications.</p>
    ...
    ///   - [`profiling_group_name(Option<String>)`](crate::input::RemovePermissionInput::profiling_group_name): <p>The name of the profiling group.</p>
    ///   - [`action_group(Option<ActionGroup>)`](crate::input::RemovePermissionInput::action_group): <p> Specifies an action group that contains the permissions to remove from a profiling group's resource-based policy. One action group is supported, <code>agentPermissions</code>, which grants <code>ConfigureAgent</code> and <code>PostAgentProfile</code> permissions. </p>
    ///   - [`revision_id(Option<String>)`](crate::input::RemovePermissionInput::revision_id): <p> A universally unique identifier (UUID) for the revision of the resource-based policy from which you want to remove permissions. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::TagResourceInput::resource_arn): <p> The Amazon Resource Name (ARN) of the resource that the tags are added to. </p>
    ///   - [`tags(Option<HashMap<String, String>>)`](crate::input::TagResourceInput::tags): <p> The list of tags that are added to the specified resource. </p>
    ...
    ///   - [`resource_arn(Option<String>)`](crate::input::UntagResourceInput::resource_arn): <p> The Amazon Resource Name (ARN) of the resource that contains the tags to remove. </p>
    ///   - [`tag_keys(Option<Vec<String>>)`](crate::input::UntagResourceInput::tag_keys): <p> A list of tag keys. Existing tags of resources with keys in this list are removed from the specified resource. </p>
    ...
    ///
    /// - Takes [`UpdateProfilingGroupInput`](crate::input::UpdateProfilingGroupInput) with field(s):
    ///   - [`profiling_group_name(Option<String>)`](crate::input::UpdateProfilingGroupInput::profiling_group_name): <p>The name of the profiling group to update.</p>
    ///   - [`agent_orchestration_config(Option<AgentOrchestrationConfig>)`](crate::input::UpdateProfilingGroupInput::agent_orchestration_config): <p> Specifies whether profiling is enabled or disabled for a profiling group. </p>
