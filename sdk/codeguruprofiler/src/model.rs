...
pub struct Channel  {
    ...
    #[doc(hidden)]pub event_publishers: std::option::Option<std::vec::Vec<crate::model::EventPublisher>>,
}
impl Channel {
    /// <p>Unique identifier for each <code>Channel</code> in the notification configuration of a Profiling Group. A random UUID for channelId is used when adding a channel to the notification configuration if not specified in the request.</p>
    ...
    /// <p>List of publishers for different type of events that may be detected in an application from the profile. Anomaly detection is the only event publisher in Profiler.</p>
    pub fn event_publishers(&self) -> std::option::Option<& std::vec::Vec<crate::model::EventPublisher>> {
...
pub mod channel {
    ...
    impl Builder {
        ...
        /// <p>List of publishers for different type of events that may be detected in an application from the profile. Anomaly detection is the only event publisher in Profiler.</p>
        pub fn event_publishers(mut self, input: std::vec::Vec<crate::model::EventPublisher>) -> Self {
...
pub struct FindingsReportSummary  {
    ...
    #[doc(hidden)]pub total_number_of_findings: std::option::Option<i32>,
}
...
pub struct Anomaly  {
    ...
    #[doc(hidden)]pub instances: std::option::Option<std::vec::Vec<crate::model::AnomalyInstance>>,
}
impl Anomaly {
    /// <p> Details about the metric that the analysis used when it detected the anomaly. The metric includes the name of the frame that was analyzed with the type and thread states used to derive the metric value for that frame. </p>
...
pub struct AnomalyInstance  {
    ...
    #[doc(hidden)]pub user_feedback: std::option::Option<crate::model::UserFeedback>,
}
...
pub struct Metric  {
    ...
    #[doc(hidden)]pub frame_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::MetricType>,
    /// <p> The list of application runtime thread states that is used to calculate the metric value for the frame. </p>
    #[doc(hidden)]pub thread_states: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Metric {
    /// <p> The name of the method that appears as a frame in any stack in a profile. </p>
...
pub struct Recommendation  {
    ...
    #[doc(hidden)]pub all_matches_count: std::option::Option<i32>,
    /// <p>How much of the total sample count is potentially affected.</p>
    #[doc(hidden)]pub all_matches_sum: std::option::Option<f64>,
    /// <p>The pattern that analysis recognized in the profile to make this recommendation.</p>
    #[doc(hidden)]pub pattern: std::option::Option<crate::model::Pattern>,
    /// <p>List of the matches with most impact. </p>
    #[doc(hidden)]pub top_matches: std::option::Option<std::vec::Vec<crate::model::Match>>,
...
pub struct Match  {
    ...
    #[doc(hidden)]pub target_frames_index: std::option::Option<i32>,
    /// <p>The location in the profiling graph that contains a recommendation found during analysis.</p>
    #[doc(hidden)]pub frame_address: std::option::Option<std::string::String>,
    /// <p>The value in the profile data that exceeded the recommendation threshold.</p>
    #[doc(hidden)]pub threshold_breach_value: std::option::Option<f64>,
}
impl Match {
    /// <p>The target frame that triggered a match.</p>
...
pub struct Pattern  {
    ...
    #[doc(hidden)]pub resolution_steps: std::option::Option<std::string::String>,
    /// <p>A list of frame names that were searched during the analysis that generated a recommendation.</p>
    #[doc(hidden)]pub target_frames: std::option::Option<std::vec::Vec<std::vec::Vec<std::string::String>>>,
    ...
    #[doc(hidden)]pub threshold_percent: f64,
    /// <p> A list of the different counters used to determine if there is a match. </p>
    #[doc(hidden)]pub counters_to_aggregate: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Pattern {
    /// <p>The universally unique identifier (UUID) of this pattern.</p>
    pub fn id(&self) -> std::option::Option<& str> {
...
pub struct AgentConfiguration  {
    ...
    #[doc(hidden)]pub should_profile: std::option::Option<bool>,
    ...
    /// </ul>
    #[doc(hidden)]pub agent_parameters: std::option::Option<std::collections::HashMap<crate::model::AgentParameterField, std::string::String>>,
}
...
pub struct FrameMetricDatum  {
    ...
    #[doc(hidden)]pub frame_metric: std::option::Option<crate::model::FrameMetric>,
...
pub struct TimestampStructure  {
    ...
    #[doc(hidden)]pub value: std::option::Option<aws_smithy_types::DateTime>,
}
...
pub struct ProfilingGroupDescription  {
    ...
    #[doc(hidden)]pub profiling_status: std::option::Option<crate::model::ProfilingStatus>,
...
pub struct ProfilingStatus  {
    ...
    #[doc(hidden)]pub latest_agent_profile_reported_at: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub latest_aggregated_profile: std::option::Option<crate::model::AggregatedProfileTime>,
    ...
    #[doc(hidden)]pub latest_agent_orchestrated_at: std::option::Option<aws_smithy_types::DateTime>,
}
...
impl  std::fmt::Debug for ProfilingStatus  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("latest_agent_profile_reported_at", &self.latest_agent_profile_reported_at);
        formatter.field("latest_aggregated_profile", &self.latest_aggregated_profile);
        formatter.field("latest_agent_orchestrated_at", &self.latest_agent_orchestrated_at);
        formatter.finish()
    }
}
...
pub struct AgentOrchestrationConfig  {
    /// <p> A <code>Boolean</code> that specifies whether the profiling agent collects profiling data or not. Set to <code>true</code> to enable profiling. </p>
    #[doc(hidden)]pub profiling_enabled: std::option::Option<bool>,
}
