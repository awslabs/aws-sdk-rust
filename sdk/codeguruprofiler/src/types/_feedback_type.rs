...
impl ::std::convert::From<&str> for FeedbackType {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => FeedbackType::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for FeedbackType {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(FeedbackType::from(s))
    }
}
impl FeedbackType {
...
impl ::std::convert::AsRef<str> for FeedbackType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for FeedbackType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            FeedbackType::Unknown(value) => write!(f, "{value}"),
        }
    }
}
