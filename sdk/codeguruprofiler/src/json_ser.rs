...
pub fn serialize_structure_add_notification_channels_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_channel(&mut object_4, item_3);
                object_4.finish();
            }
        }
        array_2.finish();
...
pub fn serialize_structure_batch_get_frame_metric_data_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_7 in var_5 {
            {
                ...
                crate::json_ser::serialize_structure_frame_metric(&mut object_8, item_7);
                object_8.finish();
            }
        }
        array_6.finish();
...
pub fn serialize_structure_configure_agent_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_profiling_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_14) = &input.agent_orchestration_config {
        ...
        crate::json_ser::serialize_structure_agent_orchestration_config(&mut object_15, var_14);
        object_15.finish();
    }
...
pub fn serialize_structure_put_permission_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_profiling_group_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_32) = &input.agent_orchestration_config {
        ...
        crate::json_ser::serialize_structure_agent_orchestration_config(&mut object_33, var_32);
        object_33.finish();
    }
}
...
pub fn serialize_structure_frame_metric(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_agent_orchestration_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
