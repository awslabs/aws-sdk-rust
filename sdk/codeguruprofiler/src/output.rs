...
pub struct ListProfileTimesOutput  {
    ...
    #[doc(hidden)]pub profile_times: std::option::Option<std::vec::Vec<crate::model::ProfileTime>>,
...
pub struct ListFindingsReportsOutput  {
    ...
    #[doc(hidden)]pub findings_report_summaries: std::option::Option<std::vec::Vec<crate::model::FindingsReportSummary>>,
...
pub struct GetRecommendationsOutput  {
    ...
    #[doc(hidden)]pub profile_start_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub profile_end_time: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub anomalies: std::option::Option<std::vec::Vec<crate::model::Anomaly>>,
}
...
pub struct GetProfileOutput  {
    ...
    #[doc(hidden)]pub profile: std::option::Option<aws_smithy_types::Blob>,
...
pub struct ConfigureAgentOutput  {
    ...
    #[doc(hidden)]pub configuration: std::option::Option<crate::model::AgentConfiguration>,
}
...
pub struct BatchGetFrameMetricDataOutput  {
    ...
    /// </ul>
    #[doc(hidden)]pub resolution: std::option::Option<crate::model::AggregationPeriod>,
    ...
    #[doc(hidden)]pub end_times: std::option::Option<std::vec::Vec<crate::model::TimestampStructure>>,
    /// <p>List of instances which remained unprocessed. This will create a missing time step in the list of end times.</p>
    #[doc(hidden)]pub unprocessed_end_times: std::option::Option<std::collections::HashMap<std::string::String, std::vec::Vec<crate::model::TimestampStructure>>>,
    ...
    #[doc(hidden)]pub frame_metric_data: std::option::Option<std::vec::Vec<crate::model::FrameMetricDatum>>,
}
...
pub struct ListProfilingGroupsOutput  {
    ...
    #[doc(hidden)]pub profiling_group_names: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub profiling_groups: std::option::Option<std::vec::Vec<crate::model::ProfilingGroupDescription>>,
...
pub struct CreateProfilingGroupOutput  {
    ...
    #[doc(hidden)]pub profiling_group: std::option::Option<crate::model::ProfilingGroupDescription>,
}
...
pub struct GetFindingsReportAccountSummaryOutput  {
    ...
    #[doc(hidden)]pub report_summaries: std::option::Option<std::vec::Vec<crate::model::FindingsReportSummary>>,
