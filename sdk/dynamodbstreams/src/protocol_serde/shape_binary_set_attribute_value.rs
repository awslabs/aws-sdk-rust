...
pub(crate) fn de_binary_set_attribute_value<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<aws_smithy_types::Blob>>, aws_smithy_json::deserialize::error::DeserializeError>
