...
pub(crate) fn de_stream_record<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::StreamRecord>, aws_smithy_json::deserialize::error::DeserializeError>
