...
pub fn ser_get_records_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetRecordsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
