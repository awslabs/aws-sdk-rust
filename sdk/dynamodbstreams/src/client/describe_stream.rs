...
impl super::Client {
    ...
    ///   - [`shard_filter(ShardFilter)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::shard_filter) / [`set_shard_filter(Option<ShardFilter>)`](crate::operation::describe_stream::builders::DescribeStreamFluentBuilder::set_shard_filter):<br>required: **false**<br><p>This optional field contains the filter definition for the <code>DescribeStream</code> API.</p><br>
