...
impl super::Client {
    ...
    ///   - [`table_name(impl Into<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_table_name):<br>required: **false**<br><p>If this parameter is provided, then only the streams associated with this table name are returned.</p><br>
    ///   - [`limit(i32)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_limit):<br>required: **false**<br><p>The maximum number of streams to return. The upper limit is 100.</p><br>
    ///   - [`exclusive_start_stream_arn(impl Into<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::exclusive_start_stream_arn) / [`set_exclusive_start_stream_arn(Option<String>)`](crate::operation::list_streams::builders::ListStreamsFluentBuilder::set_exclusive_start_stream_arn):<br>required: **false**<br><p>The ARN (Amazon Resource Name) of the first item that this operation will evaluate. Use the value that was returned for <code>LastEvaluatedStreamArn</code> in the previous operation.</p><br>
