...
impl ::std::convert::From<&str> for ReplicationState {
    fn from(s: &str) -> Self {
        match s {
            "InProgress" => ReplicationState::InProgress,
            "InSync" => ReplicationState::InSync,
            "Inconsistent" => ReplicationState::Inconsistent,
...
impl ReplicationState {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ReplicationState::InProgress => "InProgress",
            ReplicationState::InSync => "InSync",
            ReplicationState::Inconsistent => "Inconsistent",
...
impl ::std::fmt::Display for ReplicationState {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ReplicationState::InProgress => write!(f, "InProgress"),
            ReplicationState::InSync => write!(f, "InSync"),
            ReplicationState::Inconsistent => write!(f, "Inconsistent"),
