...
pub struct ListGroupsOutput  {
    ...
    #[doc(hidden)]pub groups: std::option::Option<std::vec::Vec<crate::model::GroupSummary>>,
...
pub struct GetCanaryRunsOutput  {
    ...
    #[doc(hidden)]pub canary_runs: std::option::Option<std::vec::Vec<crate::model::CanaryRun>>,
...
pub struct GetCanaryOutput  {
    ...
    #[doc(hidden)]pub canary: std::option::Option<crate::model::Canary>,
}
...
pub struct DescribeRuntimeVersionsOutput  {
    ...
    #[doc(hidden)]pub runtime_versions: std::option::Option<std::vec::Vec<crate::model::RuntimeVersion>>,
...
pub struct DescribeCanariesLastRunOutput  {
    ...
    #[doc(hidden)]pub canaries_last_run: std::option::Option<std::vec::Vec<crate::model::CanaryLastRun>>,
...
pub struct DescribeCanariesOutput  {
    ...
    #[doc(hidden)]pub canaries: std::option::Option<std::vec::Vec<crate::model::Canary>>,
