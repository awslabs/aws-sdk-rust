...
pub fn serialize_structure_create_canary_input(
    ...
    if let Some(var_2) = &input.code {
        ...
        crate::json_ser::serialize_structure_canary_code_input(&mut object_3, var_2);
        object_3.finish();
    }
    ...
    if let Some(var_7) = &input.run_config {
        ...
        crate::json_ser::serialize_structure_canary_run_config_input(&mut object_8, var_7);
        object_8.finish();
    }
    ...
    if let Some(var_10) = &input.schedule {
        ...
        crate::json_ser::serialize_structure_canary_schedule_input(&mut object_11, var_10);
        object_11.finish();
    }
    ...
    if let Some(var_17) = &input.vpc_config {
        ...
        crate::json_ser::serialize_structure_vpc_config_input(&mut object_18, var_17);
        object_18.finish();
    }
}

pub fn serialize_structure_describe_canaries_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_canaries_last_run_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_describe_runtime_versions_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_canary_runs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_canary_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::input::UpdateCanaryInput,
) {
    if let Some(var_31) = &input.code {
        let mut object_32 = object.key("Code").start_object();
        crate::json_ser::serialize_structure_canary_code_input(&mut object_32, var_31);
        object_32.finish();
    }
    ...
    if let Some(var_35) = &input.run_config {
        ...
        crate::json_ser::serialize_structure_canary_run_config_input(&mut object_36, var_35);
        object_36.finish();
    }
    ...
    if let Some(var_38) = &input.schedule {
        ...
        crate::json_ser::serialize_structure_canary_schedule_input(&mut object_39, var_38);
        object_39.finish();
    }
    ...
    if let Some(var_41) = &input.vpc_config {
        let mut object_42 = object.key("VpcConfig").start_object();
        crate::json_ser::serialize_structure_vpc_config_input(&mut object_42, var_41);
        object_42.finish();
    }
}

pub fn serialize_structure_canary_code_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::CanaryCodeInput,
) {
    if let Some(var_43) = &input.s3_bucket {
        object.key("S3Bucket").string(var_43);
    }
    if let Some(var_44) = &input.s3_key {
        object.key("S3Key").string(var_44);
    }
    if let Some(var_45) = &input.s3_version {
        object.key("S3Version").string(var_45);
    }
    if let Some(var_46) = &input.zip_file {
        object
            .key("ZipFile")
            .string_unchecked(&smithy_types::base64::encode(var_46));
    }
    if let Some(var_47) = &input.handler {
        object.key("Handler").string(var_47);
    }
}

pub fn serialize_structure_canary_run_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::CanaryRunConfigInput,
) {
    if let Some(var_48) = &input.timeout_in_seconds {
        object.key("TimeoutInSeconds").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((*var_48).into()),
        );
    }
    if let Some(var_49) = &input.memory_in_mb {
        object.key("MemoryInMB").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::NegInt((*var_49).into()),
        );
    }
    if let Some(var_50) = &input.active_tracing {
        object.key("ActiveTracing").boolean(*var_50);
    }
    if let Some(var_51) = &input.environment_variables {
        let mut object_52 = object.key("EnvironmentVariables").start_object();
...
pub fn serialize_structure_canary_schedule_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::CanaryScheduleInput,
) {
    if let Some(var_55) = &input.expression {
        object.key("Expression").string(var_55);
    }
    if let Some(var_56) = &input.duration_in_seconds {
...
pub fn serialize_structure_vpc_config_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    input: &crate::model::VpcConfigInput,
) {
    if let Some(var_57) = &input.subnet_ids {
        let mut array_58 = object.key("SubnetIds").start_array();
    ...
    if let Some(var_60) = &input.security_group_ids {
        let mut array_61 = object.key("SecurityGroupIds").start_array();
