...
pub fn ser_update_canary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateCanaryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
