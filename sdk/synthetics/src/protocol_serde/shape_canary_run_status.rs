...
) -> ::std::result::Result<Option<crate::types::CanaryRunStatus>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "State" => {
                            builder = builder.set_state(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::CanaryRunState::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "StateReason" => {
                        ...
                        "StateReasonCode" => {
                            builder = builder.set_state_reason_code(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::CanaryRunStateReasonCode::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "TestResult" => {
