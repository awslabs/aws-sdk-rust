...
pub fn ser_create_canary_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCanaryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
