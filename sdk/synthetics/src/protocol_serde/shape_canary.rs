            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Code" => {
                            builder = builder.set_code(crate::protocol_serde::shape_canary_code_output::de_canary_code_output(tokens)?);
                        }
                        "ExecutionRoleArn" => {
                        ...
                        "Schedule" => {
                            builder = builder.set_schedule(crate::protocol_serde::shape_canary_schedule_output::de_canary_schedule_output(tokens)?);
                        }
                        "RunConfig" => {
                        ...
                        "Status" => {
                            builder = builder.set_status(crate::protocol_serde::shape_canary_status::de_canary_status(tokens)?);
                        }
                        "Timeline" => {
                            builder = builder.set_timeline(crate::protocol_serde::shape_canary_timeline::de_canary_timeline(tokens)?);
                        }
                        "ArtifactS3Location" => {
                        ...
                        "VpcConfig" => {
                            builder = builder.set_vpc_config(crate::protocol_serde::shape_vpc_config_output::de_vpc_config_output(tokens)?);
                        }
                        "VisualReference" => {
                            builder = builder
