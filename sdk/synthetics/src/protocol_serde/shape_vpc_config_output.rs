...
pub(crate) fn de_vpc_config_output<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VpcConfigOutput>, aws_smithy_json::deserialize::error::DeserializeError>
