...
pub fn ser_vpc_config_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::VpcConfigInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
