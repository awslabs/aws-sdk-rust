...
impl crate::operation::get_canary::builders::GetCanaryInputBuilder {
...
impl crate::client::customize::internal::CustomizableSend<crate::operation::get_canary::GetCanaryOutput, crate::operation::get_canary::GetCanaryError>
    for GetCanaryFluentBuilder
{
    fn send(
        ...
        crate::client::customize::internal::SendResult<crate::operation::get_canary::GetCanaryOutput, crate::operation::get_canary::GetCanaryError>,
    > {
        ::std::boxed::Box::pin(async move { self.config_override(config_override).send().await })
    }
}
impl GetCanaryFluentBuilder {
    /// Creates a new `GetCanaryFluentBuilder`.
