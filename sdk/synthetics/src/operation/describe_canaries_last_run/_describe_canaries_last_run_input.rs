...
impl DescribeCanariesLastRunInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_canaries_last_run::DescribeCanariesLastRunInput, ::aws_smithy_types::error::operation::BuildError> {
