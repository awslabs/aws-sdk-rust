...
impl CreateCanaryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_canary::CreateCanary, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_canary::ser_create_canary_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCanary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_canary::de_create_canary_http_response_with_props(status, headers, body)
        }
    }
}
