...
impl UpdateCanaryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_canary::UpdateCanary::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCanary {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_canary::de_update_canary_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_canary::de_update_canary_http_response_with_props(
                status, headers, body,
            )
        }
    }
