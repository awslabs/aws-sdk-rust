...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::start_canary::builders::StartCanaryFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::start_canary::builders::StartCanaryFluentBuilder::set_name):<br>required: **true**<br><p>The name of the canary that you want to run. To find canary names, use <a href="https://docs.aws.amazon.com/AmazonSynthetics/latest/APIReference/API_DescribeCanaries.html">DescribeCanaries</a>.</p><br>
