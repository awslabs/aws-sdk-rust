...
impl super::Client {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::list_associated_groups::builders::ListAssociatedGroupsFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_associated_groups::builders::ListAssociatedGroupsFluentBuilder::set_resource_arn): <p>The ARN of the canary that you want to view groups for.</p>
