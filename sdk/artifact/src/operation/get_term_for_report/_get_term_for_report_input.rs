...
impl GetTermForReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_term_for_report::GetTermForReportInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_term_for_report::GetTermForReportInput {
