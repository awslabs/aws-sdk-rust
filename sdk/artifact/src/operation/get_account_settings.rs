...
impl GetAccountSettings {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("artifact", "GetAccountSettings", input, runtime_plugins, stop_point).await
    }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            fn uri_base(
                ...
                ::std::write!(output, "/v1/account-settings/get").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl GetAccountSettingsError {
    ...
    /// Returns `true` if the error kind is `GetAccountSettingsError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `GetAccountSettingsError::ServiceQuotaExceededException`.
