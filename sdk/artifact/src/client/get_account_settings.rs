...
impl super::Client {
    ...
    ///   - [`account_settings(Option<AccountSettings>)`](crate::operation::get_account_settings::GetAccountSettingsOutput::account_settings): <p>Account settings for the customer.</p>
