...
impl ConfiguredTableAnalysisRulePolicyV1 {
    ...
    pub fn as_aggregation(&self) -> ::std::result::Result<&crate::types::AnalysisRuleAggregation, &Self> {
        if let ConfiguredTableAnalysisRulePolicyV1::Aggregation(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_custom(&self) -> ::std::result::Result<&crate::types::AnalysisRuleCustom, &Self> {
        if let ConfiguredTableAnalysisRulePolicyV1::Custom(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_list(&self) -> ::std::result::Result<&crate::types::AnalysisRuleList, &Self> {
        if let ConfiguredTableAnalysisRulePolicyV1::List(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
