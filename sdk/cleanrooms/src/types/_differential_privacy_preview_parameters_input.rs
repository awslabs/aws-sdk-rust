...
impl DifferentialPrivacyPreviewParametersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::DifferentialPrivacyPreviewParametersInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::DifferentialPrivacyPreviewParametersInput {
                epsilon: self.epsilon
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("epsilon", "epsilon was not specified but it is required when building DifferentialPrivacyPreviewParametersInput")
                    )?
                ,
                users_noise_per_query: self.users_noise_per_query
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("users_noise_per_query", "users_noise_per_query was not specified but it is required when building DifferentialPrivacyPreviewParametersInput")
                    )?
                ,
            }
        )
