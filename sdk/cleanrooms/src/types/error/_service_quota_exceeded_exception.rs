...
impl  ServiceQuotaExceededException  {
    ...
    pub fn quota_name(&self) -> & str {
        use std::ops::Deref; self.quota_name.deref()
    }
    /// <p>The value of the quota.</p>
        ...
        ::std::result::Result::Ok(
            crate::types::error::ServiceQuotaExceededException {
                ...
                quota_name: self.quota_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("quota_name", "quota_name was not specified but it is required when building ServiceQuotaExceededException")
                    )?
                ,
                quota_value: self.quota_value
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("quota_value", "quota_value was not specified but it is required when building ServiceQuotaExceededException")
                    )?
                ,
