...
impl super::Client {
    ...
    ///   - [`membership_identifier(impl Into<String>)`](crate::operation::delete_analysis_template::builders::DeleteAnalysisTemplateFluentBuilder::membership_identifier) / [`set_membership_identifier(impl Into<String>)`](crate::operation::delete_analysis_template::builders::DeleteAnalysisTemplateFluentBuilder::set_membership_identifier):<br>required: **true**<br><p>The identifier for a membership resource.</p><br>
    ///   - [`analysis_template_identifier(impl Into<String>)`](crate::operation::delete_analysis_template::builders::DeleteAnalysisTemplateFluentBuilder::analysis_template_identifier) / [`set_analysis_template_identifier(impl Into<String>)`](crate::operation::delete_analysis_template::builders::DeleteAnalysisTemplateFluentBuilder::set_analysis_template_identifier):<br>required: **true**<br><p>The identifier for the analysis template resource.</p><br>
