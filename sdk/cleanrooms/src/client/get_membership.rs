...
impl super::Client {
    ...
    ///   - [`membership_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_membership::builders::GetMembershipFluentBuilder::membership_identifier) / [`set_membership_identifier(Option<String>)`](crate::operation::get_membership::builders::GetMembershipFluentBuilder::set_membership_identifier): <p>The identifier for a membership resource.</p>
