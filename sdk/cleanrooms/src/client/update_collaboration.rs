...
impl super::Client {
    ...
    ///   - [`collaboration_identifier(impl Into<String>)`](crate::operation::update_collaboration::builders::UpdateCollaborationFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(impl Into<String>)`](crate::operation::update_collaboration::builders::UpdateCollaborationFluentBuilder::set_collaboration_identifier):<br>required: **true**<br><p>The identifier for the collaboration.</p><br>
