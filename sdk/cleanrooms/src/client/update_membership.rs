...
impl super::Client {
    ...
    ///   - [`default_result_configuration(MembershipProtectedQueryResultConfiguration)`](crate::operation::update_membership::builders::UpdateMembershipFluentBuilder::default_result_configuration) / [`set_default_result_configuration(Option<MembershipProtectedQueryResultConfiguration>)`](crate::operation::update_membership::builders::UpdateMembershipFluentBuilder::set_default_result_configuration): <p>The default protected query result configuration as specified by the member who can receive results.</p>
