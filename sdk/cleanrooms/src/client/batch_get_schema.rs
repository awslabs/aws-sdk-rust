...
impl super::Client {
    ...
    ///   - [`names(impl Into<String>)`](crate::operation::batch_get_schema::builders::BatchGetSchemaFluentBuilder::names) / [`set_names(Option<Vec<String>>)`](crate::operation::batch_get_schema::builders::BatchGetSchemaFluentBuilder::set_names): <p>The names for the schema objects to retrieve.&gt;</p>
