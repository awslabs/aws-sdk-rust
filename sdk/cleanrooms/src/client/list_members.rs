...
impl super::Client {
    ...
    ///   - [`collaboration_identifier(impl Into<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(impl Into<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::set_collaboration_identifier):<br>required: **true**<br><p>The identifier of the collaboration in which the members are listed.</p><br>
