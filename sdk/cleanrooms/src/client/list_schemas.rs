...
impl super::Client {
    ...
    ///   - [`collaboration_identifier(impl Into<String>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(impl Into<String>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::set_collaboration_identifier):<br>required: **true**<br><p>A unique identifier for the collaboration that the schema belongs to. Currently accepts a collaboration ID.</p><br>
