...
impl super::Client {
    ...
    ///   - [`schema_type(SchemaType)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::schema_type) / [`set_schema_type(Option<SchemaType>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::set_schema_type):<br>required: **false**<br><p>If present, filter schemas by schema type.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::set_next_token):<br>required: **false**<br><p>The pagination token that's used to fetch the next set of results.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_schemas::builders::ListSchemasFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of results that are returned for an API request call. The service chooses a default number if you don't set one. The service might return a `nextToken` even if the `maxResults` value has not been met.</p><br>
    ...
    ///   - [`next_token(Option<String>)`](crate::operation::list_schemas::ListSchemasOutput::next_token): <p>The pagination token that's used to fetch the next set of results.</p>
