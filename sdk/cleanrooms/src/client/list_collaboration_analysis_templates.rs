...
impl super::Client {
    ...
    ///   - [`collaboration_identifier(impl Into<String>)`](crate::operation::list_collaboration_analysis_templates::builders::ListCollaborationAnalysisTemplatesFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(impl Into<String>)`](crate::operation::list_collaboration_analysis_templates::builders::ListCollaborationAnalysisTemplatesFluentBuilder::set_collaboration_identifier):<br>required: **true**<br><p>A unique identifier for the collaboration that the analysis templates belong to. Currently accepts collaboration ID.</p><br>
