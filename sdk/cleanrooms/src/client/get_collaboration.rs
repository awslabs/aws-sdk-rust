...
impl super::Client {
    ...
    ///   - [`collaboration_identifier(impl Into<String>)`](crate::operation::get_collaboration::builders::GetCollaborationFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(impl Into<String>)`](crate::operation::get_collaboration::builders::GetCollaborationFluentBuilder::set_collaboration_identifier):<br>required: **true**<br><p>The identifier for the collaboration.</p><br>
