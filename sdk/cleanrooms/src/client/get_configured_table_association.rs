...
impl super::Client {
    ...
    ///   - [`membership_identifier(impl Into<String>)`](crate::operation::get_configured_table_association::builders::GetConfiguredTableAssociationFluentBuilder::membership_identifier) / [`set_membership_identifier(Option<String>)`](crate::operation::get_configured_table_association::builders::GetConfiguredTableAssociationFluentBuilder::set_membership_identifier):<br>required: **true**<br><p>A unique identifier for the membership that the configured table association belongs to. Currently accepts the membership ID.</p><br>
