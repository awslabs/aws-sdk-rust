...
impl super::Client {
    ...
    ///   - [`r#type(ProtectedQueryType)`](crate::operation::start_protected_query::builders::StartProtectedQueryFluentBuilder::type) / [`set_type(ProtectedQueryType)`](crate::operation::start_protected_query::builders::StartProtectedQueryFluentBuilder::set_type):<br>required: **true**<br><p>The type of the protected query to be started.</p><br>
    ///   - [`membership_identifier(impl Into<String>)`](crate::operation::start_protected_query::builders::StartProtectedQueryFluentBuilder::membership_identifier) / [`set_membership_identifier(impl Into<String>)`](crate::operation::start_protected_query::builders::StartProtectedQueryFluentBuilder::set_membership_identifier):<br>required: **true**<br><p>A unique identifier for the membership to run this query against. Currently accepts a membership ID.</p><br>
