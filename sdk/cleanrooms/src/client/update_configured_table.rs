...
impl super::Client {
    ...
    ///   - [`configured_table_identifier(impl ::std::convert::Into<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::configured_table_identifier) / [`set_configured_table_identifier(Option<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::set_configured_table_identifier): <p>The identifier for the configured table to update. Currently accepts the configured table ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::set_name): <p>A new name for the configured table.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::set_description): <p>A new description for the configured table.</p>
