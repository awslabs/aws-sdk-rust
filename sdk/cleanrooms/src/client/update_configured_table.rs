...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_configured_table::builders::UpdateConfiguredTableFluentBuilder::set_name):<br>required: **false**<br><p>A new name for the configured table.</p><br>
