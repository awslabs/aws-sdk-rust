...
impl super::Client {
    ...
    ///   - [`configured_table_association_identifier(impl Into<String>)`](crate::operation::delete_configured_table_association::builders::DeleteConfiguredTableAssociationFluentBuilder::configured_table_association_identifier) / [`set_configured_table_association_identifier(Option<String>)`](crate::operation::delete_configured_table_association::builders::DeleteConfiguredTableAssociationFluentBuilder::set_configured_table_association_identifier):<br>required: **true**<br><p>The unique ID for the configured table association to be deleted. Currently accepts the configured table ID.</p><br>
