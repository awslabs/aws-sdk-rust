                    ...
                    variant = match key.as_ref() {
                            "s3" => {
                                Some(crate::types::ProtectedJobOutputConfigurationOutput::S3(
                                    crate::protocol_serde::shape_protected_job_s3_output_configuration_output::de_protected_job_s3_output_configuration_output(tokens)?
                            ...
                            "member" => {
                                Some(crate::types::ProtectedJobOutputConfigurationOutput::Member(
                                    crate::protocol_serde::shape_protected_job_member_output_configuration_output::de_protected_job_member_output_configuration_output(tokens)?
