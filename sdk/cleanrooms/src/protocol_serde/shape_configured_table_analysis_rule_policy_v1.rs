...
pub fn ser_configured_table_analysis_rule_policy_v1(object_1: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ConfiguredTableAnalysisRulePolicyV1) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ConfiguredTableAnalysisRulePolicyV1::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ConfiguredTableAnalysisRulePolicyV1"))
    }
    Ok(())
}
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            ...
                            "custom" => {
                                Some(crate::types::ConfiguredTableAnalysisRulePolicyV1::Custom(
                                    crate::protocol_serde::shape_analysis_rule_custom::de_analysis_rule_custom(tokens)?
