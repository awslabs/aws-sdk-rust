...
pub fn ser_configured_table_analysis_rule_policy_v1(object_1: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ConfiguredTableAnalysisRulePolicyV1) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_configured_table_analysis_rule_policy_v1<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ConfiguredTableAnalysisRulePolicyV1>, aws_smithy_json::deserialize::error::DeserializeError>
