...
pub fn ser_configured_table_analysis_rule_policy_v1(
    ...
    match input {
        crate::types::ConfiguredTableAnalysisRulePolicyV1::List(inner) => {
            ...
            crate::protocol_serde::shape_analysis_rule_list::ser_analysis_rule_list(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        ...
        crate::types::ConfiguredTableAnalysisRulePolicyV1::Aggregation(inner) => {
            ...
            crate::protocol_serde::shape_analysis_rule_aggregation::ser_analysis_rule_aggregation(
                &mut object_2,
                inner,
            )?;
            object_2.finish();
...
pub(crate) fn de_configured_table_analysis_rule_policy_v1<'a, I>(
    ...
    Option<crate::types::ConfiguredTableAnalysisRulePolicyV1>,
