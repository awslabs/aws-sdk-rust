...
pub fn ser_membership_protected_job_output_configuration(
    object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::MembershipProtectedJobOutputConfiguration,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        crate::types::MembershipProtectedJobOutputConfiguration::S3(inner) => {
            #[allow(unused_mut)]
            let mut object_1 = object_2.key("s3").start_object();
            crate::protocol_serde::shape_protected_job_s3_output_configuration_input::ser_protected_job_s3_output_configuration_input(
                &mut object_1,
                inner,
            )?;
            object_1.finish();
        }
        crate::types::MembershipProtectedJobOutputConfiguration::Unknown => {
