...
pub fn ser_start_protected_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::StartProtectedQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
