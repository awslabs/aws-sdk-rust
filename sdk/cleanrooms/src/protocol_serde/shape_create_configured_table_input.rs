...
pub fn ser_create_configured_table_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateConfiguredTableInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
