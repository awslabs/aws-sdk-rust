...
pub fn de_delete_configured_table_association_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociationOutput, crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_configured_table_association_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociationOutput, crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociationError> {
    Ok({
        #[allow(unused_mut)]
