...
pub(crate) fn de_privacy_budget_template_parameters_output<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PrivacyBudgetTemplateParametersOutput>, ::aws_smithy_json::deserialize::error::DeserializeError>
