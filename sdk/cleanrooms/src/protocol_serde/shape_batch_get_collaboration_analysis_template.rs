...
pub fn de_batch_get_collaboration_analysis_template_http_error(
...
> {
    ...
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::batch_get_collaboration_analysis_template::BatchGetCollaborationAnalysisTemplateError::unhandled(generic))
        }
    };
    ...
    Err(match error_code {
        "AccessDeniedException" => {
            crate::operation::batch_get_collaboration_analysis_template::BatchGetCollaborationAnalysisTemplateError::AccessDeniedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => {
            crate::operation::batch_get_collaboration_analysis_template::BatchGetCollaborationAnalysisTemplateError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::operation::batch_get_collaboration_analysis_template::BatchGetCollaborationAnalysisTemplateError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_collaboration_analysis_template_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_batch_get_collaboration_analysis_template::de_batch_get_collaboration_analysis_template(
            _response_body,
            output,
        )
        .map_err(crate::operation::batch_get_collaboration_analysis_template::BatchGetCollaborationAnalysisTemplateError::unhandled)?;
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "collaborationAnalysisTemplates" => {
                    builder = builder.set_collaboration_analysis_templates(
                        crate::protocol_serde::shape_collaboration_analysis_template_list::de_collaboration_analysis_template_list(
                            tokens,
                            _value,
                            depth + 1,
                        )?,
                ...
                "errors" => {
                    builder = builder.set_errors(
                            crate::protocol_serde::shape_batch_get_collaboration_analysis_template_error_list::de_batch_get_collaboration_analysis_template_error_list(tokens, _value, depth + 1)?
                        );
                }
