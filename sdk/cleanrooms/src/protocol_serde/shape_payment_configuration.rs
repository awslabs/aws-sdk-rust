                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "queryCompute" => {
                            builder = builder.set_query_compute(
                                crate::protocol_serde::shape_query_compute_payment_config::de_query_compute_payment_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "machineLearning" => {
                            builder = builder.set_machine_learning(crate::protocol_serde::shape_ml_payment_config::de_ml_payment_config(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "jobCompute" => {
                            builder = builder.set_job_compute(
                                crate::protocol_serde::shape_job_compute_payment_config::de_job_compute_payment_config(tokens, _value, depth + 1)?,
                            );
                        }
