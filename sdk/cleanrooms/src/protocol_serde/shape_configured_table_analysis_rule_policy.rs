...
pub fn ser_configured_table_analysis_rule_policy(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ConfiguredTableAnalysisRulePolicy) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ConfiguredTableAnalysisRulePolicy::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ConfiguredTableAnalysisRulePolicy"))
    }
    Ok(())
}
