...
pub(crate) fn de_protected_query_output<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProtectedQueryOutput>, aws_smithy_json::deserialize::error::DeserializeError>
