...
pub fn ser_analysis_rule_aggregation(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AnalysisRuleAggregation) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_analysis_rule_aggregation<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AnalysisRuleAggregation>, aws_smithy_json::deserialize::error::DeserializeError>
