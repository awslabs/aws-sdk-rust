...
) -> Result<crate::operation::get_membership::builders::GetMembershipOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "membership" => {
                    builder = builder.set_membership(crate::protocol_serde::shape_membership::de_membership(tokens)?);
                }
