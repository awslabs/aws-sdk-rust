...
pub(crate) fn de_analysis_rule_policy<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AnalysisRulePolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "v1" => Some(crate::types::AnalysisRulePolicy::V1(
                            crate::protocol_serde::shape_analysis_rule_policy_v1::de_analysis_rule_policy_v1(tokens, _value, depth + 1)?
