...
pub fn ser_create_collaboration_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateCollaborationInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
