...
) -> Result<Option<crate::types::CollaborationAnalysisTemplate>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "schema" => {
                            builder = builder.set_schema(crate::protocol_serde::shape_analysis_schema::de_analysis_schema(tokens)?);
                        }
                        "format" => {
                            builder = builder.set_format(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::AnalysisFormat::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "source" => {
            ...
            Ok(Some(
                crate::serde_util::collaboration_analysis_template_correct_errors(builder)
                    .build()
