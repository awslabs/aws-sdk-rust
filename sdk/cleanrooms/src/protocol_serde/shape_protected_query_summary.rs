...
pub(crate) fn de_protected_query_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProtectedQuerySummary>, aws_smithy_json::deserialize::error::DeserializeError>
