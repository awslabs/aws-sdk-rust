...
impl  ListCollaborationsOutput  {
    ...
    pub fn collaboration_list(&self) -> & [crate::types::CollaborationSummary] {
        use std::ops::Deref; self.collaboration_list.deref()
    }
}
...
impl ListCollaborationsOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_collaborations::ListCollaborationsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_collaborations::ListCollaborationsOutput {
                ...
                collaboration_list: self.collaboration_list
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("collaboration_list", "collaboration_list was not specified but it is required when building ListCollaborationsOutput")
                    )?
                ,
