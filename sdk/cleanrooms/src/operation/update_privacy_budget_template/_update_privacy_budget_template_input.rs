...
impl UpdatePrivacyBudgetTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_privacy_budget_template::UpdatePrivacyBudgetTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
