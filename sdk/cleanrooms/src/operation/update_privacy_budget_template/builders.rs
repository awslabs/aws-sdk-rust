...
impl UpdatePrivacyBudgetTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_privacy_budget_template::UpdatePrivacyBudgetTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_privacy_budget_template::UpdatePrivacyBudgetTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_privacy_budget_template::UpdatePrivacyBudgetTemplateOutput, crate::operation::update_privacy_budget_template::UpdatePrivacyBudgetTemplateError, Self> {
