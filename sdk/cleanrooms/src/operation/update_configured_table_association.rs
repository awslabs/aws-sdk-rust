...
impl UpdateConfiguredTableAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_configured_table_association::UpdateConfiguredTableAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConfiguredTableAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_configured_table_association::de_update_configured_table_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
