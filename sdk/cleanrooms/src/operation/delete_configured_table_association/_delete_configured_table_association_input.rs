...
impl DeleteConfiguredTableAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
