...
impl  ListPrivacyBudgetsOutput  {
    ...
    pub fn privacy_budget_summaries(&self) -> & [crate::types::PrivacyBudgetSummary] {
        use std::ops::Deref; self.privacy_budget_summaries.deref()
    }
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
...
impl ListPrivacyBudgetsOutputBuilder {
    ...
    pub fn set_privacy_budget_summaries(mut self, input: ::std::option::Option<::std::vec::Vec::<crate::types::PrivacyBudgetSummary>>) -> Self {
        self.privacy_budget_summaries = input; self
    }
    /// <p>An array that summarizes the privacy budgets. The summary includes collaboration information, membership information, privacy budget template information, and privacy budget details.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_privacy_budgets::ListPrivacyBudgetsOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_privacy_budgets::ListPrivacyBudgetsOutput {
                privacy_budget_summaries: self.privacy_budget_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("privacy_budget_summaries", "privacy_budget_summaries was not specified but it is required when building ListPrivacyBudgetsOutput")
                    )?
                ,
