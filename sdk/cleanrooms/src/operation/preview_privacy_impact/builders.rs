...
impl PreviewPrivacyImpactFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::preview_privacy_impact::PreviewPrivacyImpactOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::preview_privacy_impact::PreviewPrivacyImpactError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::preview_privacy_impact::PreviewPrivacyImpactOutput, crate::operation::preview_privacy_impact::PreviewPrivacyImpactError, Self> {
