...
impl ListProtectedQueriesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_protected_queries();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_protected_queries::ListProtectedQueriesOutput,
                    crate::operation::list_protected_queries::ListProtectedQueriesError,
                > for ListProtectedQueriesFluentBuilder
            {
                fn send(
                    self,
...
impl ListProtectedQueriesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_protected_queries::ListProtectedQueriesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_protected_queries::ListProtectedQueriesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_protected_queries::ListProtectedQueries::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_protected_queries::ListProtectedQueriesOutput, crate::operation::list_protected_queries::ListProtectedQueriesError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_protected_queries::paginator::ListProtectedQueriesPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
