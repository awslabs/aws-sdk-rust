...
impl CreateConfiguredTableAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_configured_table_association::CreateConfiguredTableAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConfiguredTableAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_configured_table_association::de_create_configured_table_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
