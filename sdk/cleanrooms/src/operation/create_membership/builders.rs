...
impl CreateMembershipFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_membership::CreateMembershipOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_membership::CreateMembershipError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_membership::CreateMembershipOutput, crate::operation::create_membership::CreateMembershipError, Self> {
