...
impl CreatePrivacyBudgetTemplateFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_privacy_budget_template::CreatePrivacyBudgetTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_privacy_budget_template::CreatePrivacyBudgetTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_privacy_budget_template::CreatePrivacyBudgetTemplateOutput, crate::operation::create_privacy_budget_template::CreatePrivacyBudgetTemplateError, Self> {
