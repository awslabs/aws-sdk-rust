...
/// Orchestration and serialization glue logic for `GetSchemaAnalysisRule`.
...
impl GetSchemaAnalysisRule {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleInput,
                    ) -> ::std::result::Result<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetSchemaAnalysisRule {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetSchemaAnalysisRule");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetSchemaAnalysisRuleRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetSchemaAnalysisRuleResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetSchemaAnalysisRule")
...
.with_interceptor(GetSchemaAnalysisRuleEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError>::new());
...
#[derive(Debug)]
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_schema_analysis_rule::de_get_schema_analysis_rule_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_schema_analysis_rule::de_get_schema_analysis_rule_http_response(status, headers, body)
            };
...
#[derive(Debug)]
            ...
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetSchemaAnalysisRuleRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("r#type", "cannot be empty or unset"))?;
    ...
    ::std::write!(output, "/collaborations/{collaborationIdentifier}/schemas/{name}/analysisRule/{type}", collaborationIdentifier = collaboration_identifier, name = name, type = r#type).expect("formatting should succeed");
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetSchemaAnalysisRuleEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetSchemaAnalysisRuleInput>()
                        .ok_or("failed to downcast to GetSchemaAnalysisRuleInput")?;
...
pub enum GetSchemaAnalysisRuleError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetSchemaAnalysisRuleError) for what information is available for the error.")]
...
impl GetSchemaAnalysisRuleError {
    /// Creates the `GetSchemaAnalysisRuleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaAnalysisRuleError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetSchemaAnalysisRuleError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_schema_analysis_rule::GetSchemaAnalysisRuleError {
...
mod _get_schema_analysis_rule_output;
