...
impl GetConfiguredTableAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_configured_table_association::GetConfiguredTableAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
