...
impl DeleteConfiguredTableAssociationInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_configured_table_association::DeleteConfiguredTableAssociation::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConfiguredTableAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 204 {
            ...
            crate::protocol_serde::shape_delete_configured_table_association::de_delete_configured_table_association_http_response_with_props(
                status, headers, body,
            )
        }
    }
