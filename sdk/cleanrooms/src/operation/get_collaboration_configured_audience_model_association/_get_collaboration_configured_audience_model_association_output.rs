...
impl  GetCollaborationConfiguredAudienceModelAssociationOutput  {
    /// <p>The metadata of the configured audience model association.</p>
    pub fn collaboration_configured_audience_model_association(&self) -> ::std::option::Option<& crate::types::CollaborationConfiguredAudienceModelAssociation> {
...
pub struct GetCollaborationConfiguredAudienceModelAssociationOutputBuilder {
    pub(crate) collaboration_configured_audience_model_association: ::std::option::Option<crate::types::CollaborationConfiguredAudienceModelAssociation>,
    _request_id: Option<String>,
}
impl GetCollaborationConfiguredAudienceModelAssociationOutputBuilder {
    /// <p>The metadata of the configured audience model association.</p>
    /// This field is required.
    pub fn collaboration_configured_audience_model_association(mut self, input: crate::types::CollaborationConfiguredAudienceModelAssociation) -> Self {
        self.collaboration_configured_audience_model_association = ::std::option::Option::Some(input);
        self
    }
    /// <p>The metadata of the configured audience model association.</p>
    pub fn set_collaboration_configured_audience_model_association(mut self, input: ::std::option::Option<crate::types::CollaborationConfiguredAudienceModelAssociation>) -> Self {
        self.collaboration_configured_audience_model_association = input; self
    }
    /// <p>The metadata of the configured audience model association.</p>
    pub fn get_collaboration_configured_audience_model_association(&self) -> &::std::option::Option<crate::types::CollaborationConfiguredAudienceModelAssociation> {
    ...
    pub fn build(self) -> crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationOutput {
