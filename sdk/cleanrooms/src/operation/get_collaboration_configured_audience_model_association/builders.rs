...
pub use crate::operation::get_collaboration_configured_audience_model_association::_get_collaboration_configured_audience_model_association_output::GetCollaborationConfiguredAudienceModelAssociationOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationOutput,
                    crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationError,
                > for GetCollaborationConfiguredAudienceModelAssociationFluentBuilder
            {
                fn send(
                    self,
...
impl GetCollaborationConfiguredAudienceModelAssociationFluentBuilder {
    ...
    /// Access the GetCollaborationConfiguredAudienceModelAssociation as a reference.
    pub fn as_input(&self) -> &crate::operation::get_collaboration_configured_audience_model_association::builders::GetCollaborationConfiguredAudienceModelAssociationInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociation::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociation::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationOutput, crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociationError, Self> {
