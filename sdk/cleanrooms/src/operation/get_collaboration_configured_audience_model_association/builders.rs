...
impl GetCollaborationConfiguredAudienceModelAssociationFluentBuilder {
    /// Creates a new `GetCollaborationConfiguredAudienceModelAssociationFluentBuilder`.
    ...
    > {
        ...
        crate::operation::get_collaboration_configured_audience_model_association::GetCollaborationConfiguredAudienceModelAssociation::orchestrate(
            &runtime_plugins,
            input,
        )
        .await
