...
impl  ListConfiguredTablesOutput  {
    ...
    pub fn configured_table_summaries(&self) -> & [crate::types::ConfiguredTableSummary] {
        use std::ops::Deref; self.configured_table_summaries.deref()
    }
    /// <p>The token value retrieved from a previous call to access the next page of results.</p>
...
impl ListConfiguredTablesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_configured_tables::ListConfiguredTablesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_configured_tables::ListConfiguredTablesOutput {
                configured_table_summaries: self.configured_table_summaries
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("configured_table_summaries", "configured_table_summaries was not specified but it is required when building ListConfiguredTablesOutput")
                    )?
                ,
