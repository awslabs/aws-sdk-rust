...
impl StartProtectedQueryInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_protected_query::ser_start_protected_query_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_protected_query::StartProtectedQuery::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_protected_query::StartProtectedQueryError
{
