...
impl UpdateConfiguredTableAnalysisRuleInputBuilder {
    ...
    /// - [`configured_table_identifier`](crate::operation::update_configured_table_analysis_rule::builders::UpdateConfiguredTableAnalysisRuleInputBuilder::configured_table_identifier)
    /// - [`analysis_rule_type`](crate::operation::update_configured_table_analysis_rule::builders::UpdateConfiguredTableAnalysisRuleInputBuilder::analysis_rule_type)
    pub fn build(
        self,
    ) -> ::std::result::Result<
            ...
            crate::operation::update_configured_table_analysis_rule::UpdateConfiguredTableAnalysisRuleInput {
                configured_table_identifier: self.configured_table_identifier.ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field(
                        ...
                        "configured_table_identifier was not specified but it is required when building UpdateConfiguredTableAnalysisRuleInput",
                    )
                })?,
                analysis_rule_type: self.analysis_rule_type.ok_or_else(|| {
                    ::aws_smithy_http::operation::error::BuildError::missing_field(
                        "analysis_rule_type",
                        "analysis_rule_type was not specified but it is required when building UpdateConfiguredTableAnalysisRuleInput",
                    )
                })?,
