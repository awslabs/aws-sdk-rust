...
impl CreateConfiguredTableAnalysisRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_configured_table_analysis_rule::CreateConfiguredTableAnalysisRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_configured_table_analysis_rule::CreateConfiguredTableAnalysisRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_configured_table_analysis_rule::CreateConfiguredTableAnalysisRuleOutput, crate::operation::create_configured_table_analysis_rule::CreateConfiguredTableAnalysisRuleError, Self> {
