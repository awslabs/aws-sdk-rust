...
impl GetProtectedQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_protected_query::GetProtectedQuery,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProtectedQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_protected_query::de_get_protected_query_http_response_with_props(status, headers, body)
        }
    }
