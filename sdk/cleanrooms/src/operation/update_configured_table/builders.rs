...
impl UpdateConfiguredTableFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_configured_table::UpdateConfiguredTableOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_configured_table::UpdateConfiguredTableError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_configured_table::UpdateConfiguredTableOutput, crate::operation::update_configured_table::UpdateConfiguredTableError, Self> {
