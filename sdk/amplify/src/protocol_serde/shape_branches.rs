...
pub(crate) fn de_branches<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::Branch>>, aws_smithy_json::deserialize::error::DeserializeError>
