            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "customRules" => {
                            builder = builder.set_custom_rules(crate::protocol_serde::shape_custom_rules::de_custom_rules(tokens)?);
                        }
                        "productionBranch" => {
                            builder = builder.set_production_branch(crate::protocol_serde::shape_production_branch::de_production_branch(tokens)?);
                        }
                        "buildSpec" => {
