...
pub fn de_delete_backend_environment_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_backend_environment::DeleteBackendEnvironmentOutput, crate::operation::delete_backend_environment::DeleteBackendEnvironmentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_backend_environment::DeleteBackendEnvironmentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_backend_environment_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_backend_environment::DeleteBackendEnvironmentOutput, crate::operation::delete_backend_environment::DeleteBackendEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
