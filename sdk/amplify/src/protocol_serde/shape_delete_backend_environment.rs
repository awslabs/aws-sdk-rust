...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::delete_backend_environment::DeleteBackendEnvironmentError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::delete_backend_environment::DeleteBackendEnvironmentError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "DependentServiceFailureException" => {
            crate::operation::delete_backend_environment::DeleteBackendEnvironmentError::DependentServiceFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_backend_environment::de_delete_backend_environment(_response_body, output)
            .map_err(crate::operation::delete_backend_environment::DeleteBackendEnvironmentError::unhandled)?;
