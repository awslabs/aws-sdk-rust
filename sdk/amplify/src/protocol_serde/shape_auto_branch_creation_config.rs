...
pub fn ser_auto_branch_creation_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AutoBranchCreationConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_auto_branch_creation_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AutoBranchCreationConfig>, aws_smithy_json::deserialize::error::DeserializeError>
