...
pub fn ser_create_branch_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateBranchInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
