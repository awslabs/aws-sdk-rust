...
pub fn ser_update_app_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAppInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
