...
pub struct Webhook  {
    ...
    #[doc(hidden)]pub webhook_arn: std::option::Option<std::string::String>,
    /// <p> The ID of the webhook. </p>
    #[doc(hidden)]pub webhook_id: std::option::Option<std::string::String>,
    /// <p> The URL of the webhook. </p>
    #[doc(hidden)]pub webhook_url: std::option::Option<std::string::String>,
...
pub struct DomainAssociation  {
    ...
    #[doc(hidden)]pub domain_association_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub certificate_verification_dns_record: std::option::Option<std::string::String>,
    /// <p> The subdomains for the domain association. </p>
    #[doc(hidden)]pub sub_domains: std::option::Option<std::vec::Vec<crate::model::SubDomain>>,
}
...
impl  std::fmt::Debug for DomainAssociation  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("certificate_verification_dns_record", &self.certificate_verification_dns_record);
...
pub mod domain_association {
    ...
    impl Builder {
        ...
        /// <p> The subdomains for the domain association. </p>
        pub fn set_sub_domains(mut self, input: std::option::Option<std::vec::Vec<crate::model::SubDomain>>) -> Self {
...
pub struct SubDomain  {
    ...
    #[doc(hidden)]pub sub_domain_setting: std::option::Option<crate::model::SubDomainSetting>,
    ...
    #[doc(hidden)]pub dns_record: std::option::Option<std::string::String>,
}
impl SubDomain {
    /// <p> Describes the settings for the subdomain. </p>
...
pub mod sub_domain {
    ...
    impl Builder {
        ...
        /// <p> Describes the settings for the subdomain. </p>
        pub fn set_sub_domain_setting(mut self, input: std::option::Option<crate::model::SubDomainSetting>) -> Self {
...
pub struct Branch  {
    ...
    #[doc(hidden)]pub branch_arn: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub custom_domains: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub active_job_id: std::option::Option<std::string::String>,
    /// <p> The total number of jobs that are part of an Amplify app. </p>
    #[doc(hidden)]pub total_number_of_jobs: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub thumbnail_url: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub associated_resources: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub destination_branch: std::option::Option<std::string::String>,
    /// <p> The source branch if the branch is a pull request branch. </p>
    #[doc(hidden)]pub source_branch: std::option::Option<std::string::String>,
...
pub struct App  {
    ...
    #[doc(hidden)]pub default_domain: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub production_branch: std::option::Option<crate::model::ProductionBranch>,
    ...
    #[doc(hidden)]pub repository_clone_method: std::option::Option<crate::model::RepositoryCloneMethod>,
}
impl App {
    /// <p> The unique ID of the Amplify app. </p>
    ...
    /// </note> 
    /// <p>The Amplify service uses this parameter to specify the authentication protocol to use to access the Git repository for an Amplify app. Amplify specifies <code>TOKEN</code> for a GitHub repository, <code>SIGV4</code> for an Amazon Web Services CodeCommit repository, and <code>SSH</code> for GitLab and Bitbucket repositories.</p>
    pub fn repository_clone_method(&self) -> std::option::Option<& crate::model::RepositoryCloneMethod> {
...
pub mod app {
    ...
    pub struct Builder {
        ...
        pub(crate) repository_clone_method: std::option::Option<crate::model::RepositoryCloneMethod>,
    }
    impl Builder {
        /// <p> The unique ID of the Amplify app. </p>
        ...
        /// <p> Describes the information about a production branch of the Amplify app. </p>
        pub fn set_production_branch(mut self, input: std::option::Option<crate::model::ProductionBranch>) -> Self {
        ...
        /// </note> 
        /// <p>The Amplify service uses this parameter to specify the authentication protocol to use to access the Git repository for an Amplify app. Amplify specifies <code>TOKEN</code> for a GitHub repository, <code>SIGV4</code> for an Amazon Web Services CodeCommit repository, and <code>SSH</code> for GitLab and Bitbucket repositories.</p>
        pub fn repository_clone_method(mut self, input: crate::model::RepositoryCloneMethod) -> Self {
        ...
        /// </note> 
        /// <p>The Amplify service uses this parameter to specify the authentication protocol to use to access the Git repository for an Amplify app. Amplify specifies <code>TOKEN</code> for a GitHub repository, <code>SIGV4</code> for an Amazon Web Services CodeCommit repository, and <code>SSH</code> for GitLab and Bitbucket repositories.</p>
        pub fn set_repository_clone_method(mut self, input: std::option::Option<crate::model::RepositoryCloneMethod>) -> Self {
...
pub struct ProductionBranch  {
    ...
    #[doc(hidden)]pub last_deploy_time: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct Artifact  {
    ...
    #[doc(hidden)]pub artifact_file_name: std::option::Option<std::string::String>,
...
pub struct Job  {
    /// <p> Describes the summary for an execution job for an Amplify app. </p>
    #[doc(hidden)]pub summary: std::option::Option<crate::model::JobSummary>,
...
pub struct Step  {
    ...
    #[doc(hidden)]pub step_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub artifacts_url: std::option::Option<std::string::String>,
    /// <p> The URL to the test artifact for the execution step. </p>
    #[doc(hidden)]pub test_artifacts_url: std::option::Option<std::string::String>,
    /// <p> The URL to the test configuration for the execution step. </p>
    #[doc(hidden)]pub test_config_url: std::option::Option<std::string::String>,
    /// <p> The list of screenshot URLs for the execution step, if relevant. </p>
    #[doc(hidden)]pub screenshots: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
