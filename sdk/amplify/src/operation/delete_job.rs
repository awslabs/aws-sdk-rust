...
impl DeleteJobInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_job::DeleteJob,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_job::DeleteJob::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteJob {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_job::de_delete_job_http_response_with_props(
                status, headers, body,
            )
        }
    }
