    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/apps/{appId}/backendenvironments", appId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_backend_environments::ListBackendEnvironments::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_backend_environments::ListBackendEnvironmentsError
{
