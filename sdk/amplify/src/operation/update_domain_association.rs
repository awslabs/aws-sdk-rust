...
impl UpdateDomainAssociationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_domain_association::UpdateDomainAssociation,
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_domain_association::de_update_domain_association_http_response_with_props(status, headers, body)
        }
    }
}
