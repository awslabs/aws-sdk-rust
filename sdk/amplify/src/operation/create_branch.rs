    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/apps/{appId}/branches", appId = app_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_branch::CreateBranch::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBranch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_create_branch::de_create_branch_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_create_branch::de_create_branch_http_response_with_props(
                status, headers, body,
            )
        }
    }
