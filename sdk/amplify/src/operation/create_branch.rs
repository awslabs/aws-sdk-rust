...
impl CreateBranchInput {
    /// Consumes the builder and constructs an Operation<[`CreateBranch`](crate::operation::create_branch::CreateBranch)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_branch::CreateBranch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_branch::ser_create_branch_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_branch::CreateBranch::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBranch {
    type Output = ::std::result::Result<crate::operation::create_branch::CreateBranchOutput, crate::operation::create_branch::CreateBranchError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_branch::de_create_branch_http_response_with_props(status, headers, body)
        }
    }
