...
impl GenerateAccessLogsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_generate_access_logs::ser_generate_access_logs_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateAccessLogs {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_generate_access_logs::de_generate_access_logs_http_response_with_props(status, headers, body)
        }
    }
}
