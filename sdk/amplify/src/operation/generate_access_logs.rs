...
impl GenerateAccessLogsInput {
    /// Consumes the builder and constructs an Operation<[`GenerateAccessLogs`](crate::operation::generate_access_logs::GenerateAccessLogs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::generate_access_logs::GenerateAccessLogs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_access_logs::GenerateAccessLogsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_access_logs::ser_generate_access_logs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::generate_access_logs::GenerateAccessLogs::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GenerateAccessLogs {
                type Output = std::result::Result<crate::operation::generate_access_logs::GenerateAccessLogsOutput, crate::operation::generate_access_logs::GenerateAccessLogsError>;
