...
/// Orchestration and serialization glue logic for `GenerateAccessLogs`.
...
impl GenerateAccessLogs {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::generate_access_logs::GenerateAccessLogsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::generate_access_logs::GenerateAccessLogsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::generate_access_logs::GenerateAccessLogsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::generate_access_logs::GenerateAccessLogsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GenerateAccessLogs {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GenerateAccessLogs");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GenerateAccessLogsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GenerateAccessLogsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GenerateAccessLogs")
...
.with_interceptor(GenerateAccessLogsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::generate_access_logs::GenerateAccessLogsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::generate_access_logs::GenerateAccessLogsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::generate_access_logs::GenerateAccessLogsError>::new());
...
#[derive(Debug)]
            struct GenerateAccessLogsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GenerateAccessLogsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_generate_access_logs::de_generate_access_logs_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_generate_access_logs::de_generate_access_logs_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GenerateAccessLogsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GenerateAccessLogsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::generate_access_logs::GenerateAccessLogsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::generate_access_logs::GenerateAccessLogsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/apps/{appId}/accesslogs", appId = app_id).expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_generate_access_logs::ser_generate_access_logs_input(&input)?);
...
#[derive(Debug)]
            struct GenerateAccessLogsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GenerateAccessLogsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GenerateAccessLogsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GenerateAccessLogsInput>()
                        .ok_or("failed to downcast to GenerateAccessLogsInput")?;
...
pub enum GenerateAccessLogsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GenerateAccessLogsError) for what information is available for the error.")]
...
impl GenerateAccessLogsError {
    /// Creates the `GenerateAccessLogsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateAccessLogsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GenerateAccessLogsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::generate_access_logs::GenerateAccessLogsError {
...
mod _generate_access_logs_output;
