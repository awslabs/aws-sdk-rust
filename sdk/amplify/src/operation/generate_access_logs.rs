    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/apps/{appId}/accesslogs", appId = app_id)
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_access_logs::ser_generate_access_logs_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::generate_access_logs::GenerateAccessLogs::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::generate_access_logs::GenerateAccessLogsError
{
