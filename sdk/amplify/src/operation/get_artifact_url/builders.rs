...
impl GetArtifactUrlFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_artifact_url::GetArtifactUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_artifact_url::GetArtifactUrlError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_artifact_url::GetArtifactUrlOutput, crate::operation::get_artifact_url::GetArtifactUrlError, Self> {
