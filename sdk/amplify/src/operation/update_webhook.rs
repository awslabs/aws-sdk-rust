    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/webhooks/{webhookId}", webhookId = webhook_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_webhook::UpdateWebhook::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWebhook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_webhook::de_update_webhook_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_webhook::de_update_webhook_http_response_with_props(
                status, headers, body,
            )
        }
    }
