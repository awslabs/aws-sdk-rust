...
impl UpdateWebhookInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_webhook::UpdateWebhook, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_webhook::ser_update_webhook_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateWebhook {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_webhook::de_update_webhook_http_response_with_props(status, headers, body)
        }
    }
}
