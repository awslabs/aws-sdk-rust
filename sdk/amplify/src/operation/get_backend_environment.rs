...
impl GetBackendEnvironmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_backend_environment::GetBackendEnvironment,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendEnvironment {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_backend_environment::de_get_backend_environment_http_response_with_props(status, headers, body)
        }
    }
}
