...
impl DeleteBackendEnvironment {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_backend_environment::DeleteBackendEnvironmentInput,
                    ) -> ::std::result::Result<crate::operation::delete_backend_environment::DeleteBackendEnvironmentOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_backend_environment::DeleteBackendEnvironmentError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteBackendEnvironment {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteBackendEnvironment");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteBackendEnvironmentRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteBackendEnvironmentResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteBackendEnvironment")
...
.with_interceptor(DeleteBackendEnvironmentEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentError>::new());
...
#[derive(Debug)]
            struct DeleteBackendEnvironmentResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteBackendEnvironmentResponseDeserializer {
...
#[derive(Debug)]
            struct DeleteBackendEnvironmentRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteBackendEnvironmentRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_backend_environment::DeleteBackendEnvironmentInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_backend_environment::DeleteBackendEnvironmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct DeleteBackendEnvironmentEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteBackendEnvironmentEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteBackendEnvironmentEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteBackendEnvironmentInput>()
                        .ok_or("failed to downcast to DeleteBackendEnvironmentInput")?;
...
pub enum DeleteBackendEnvironmentError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteBackendEnvironmentError) for what information is available for the error.")]
...
impl DeleteBackendEnvironmentError {
    /// Creates the `DeleteBackendEnvironmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteBackendEnvironmentError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteBackendEnvironmentError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_backend_environment::DeleteBackendEnvironmentError {
...
mod _delete_backend_environment_output;
