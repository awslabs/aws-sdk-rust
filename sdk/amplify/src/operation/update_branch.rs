...
impl UpdateBranchInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_branch::UpdateBranch, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_branch::ser_update_branch_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBranch {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_branch::de_update_branch_http_response_with_props(status, headers, body)
        }
    }
