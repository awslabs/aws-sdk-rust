...
impl UpdateAppInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApp`](crate::operation::update_app::UpdateApp)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_app::UpdateApp, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_app::ser_update_app_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_app::UpdateApp::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApp {
    type Output = ::std::result::Result<crate::operation::update_app::UpdateAppOutput, crate::operation::update_app::UpdateAppError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_app::de_update_app_http_response_with_props(status, headers, body)
        }
    }
