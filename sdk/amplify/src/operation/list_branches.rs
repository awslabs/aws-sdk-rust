...
impl ListBranchesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_branches::ListBranches::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBranches {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_branches::de_list_branches_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_branches::de_list_branches_http_response_with_props(
                status, headers, body,
            )
        }
    }
