...
impl CreateDomainAssociationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_domain_association::CreateDomainAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_domain_association::CreateDomainAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_domain_association::CreateDomainAssociationOutput, crate::operation::create_domain_association::CreateDomainAssociationError, Self> {
