...
impl CreateDomainAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_domain_association::CreateDomainAssociationInput, ::aws_smithy_types::error::operation::BuildError> {
