...
impl GetArtifactUrlInput {
    /// Consumes the builder and constructs an Operation<[`GetArtifactUrl`](crate::operation::get_artifact_url::GetArtifactUrl)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_artifact_url::GetArtifactUrl, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_artifact_url::GetArtifactUrl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetArtifactUrl {
    type Output =
        ::std::result::Result<crate::operation::get_artifact_url::GetArtifactUrlOutput, crate::operation::get_artifact_url::GetArtifactUrlError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_artifact_url::de_get_artifact_url_http_response_with_props(status, headers, body)
        }
    }
}
