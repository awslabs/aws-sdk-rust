    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/artifacts/{artifactId}", artifactId = artifact_id)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_artifact_url::GetArtifactUrl::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetArtifactUrl {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_artifact_url::de_get_artifact_url_http_error(
                status, headers, body,
            )
        } else {
