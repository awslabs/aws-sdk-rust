...
impl GetDomainAssociationInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_domain_association::GetDomainAssociation,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDomainAssociation {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_domain_association::de_get_domain_association_http_response_with_props(status, headers, body)
        }
    }
}
