...
impl GetDomainAssociationInput {
    /// Consumes the builder and constructs an Operation<[`GetDomainAssociation`](crate::operation::get_domain_association::GetDomainAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_domain_association::GetDomainAssociation, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_domain_association::GetDomainAssociationInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_domain_association::GetDomainAssociation::new())
...
impl aws_smithy_http::response::ParseStrictResponse for GetDomainAssociation {
                type Output = std::result::Result<crate::operation::get_domain_association::GetDomainAssociationOutput, crate::operation::get_domain_association::GetDomainAssociationError>;
