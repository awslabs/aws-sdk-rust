...
/// Orchestration and serialization glue logic for `GetDomainAssociation`.
...
impl GetDomainAssociation {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_domain_association::GetDomainAssociationInput,
                    ) -> ::std::result::Result<crate::operation::get_domain_association::GetDomainAssociationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_domain_association::GetDomainAssociationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_domain_association::GetDomainAssociationError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_domain_association::GetDomainAssociationOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDomainAssociation {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDomainAssociation");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDomainAssociationRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDomainAssociationResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDomainAssociation")
...
.with_interceptor(GetDomainAssociationEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_domain_association::GetDomainAssociationError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_domain_association::GetDomainAssociationError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_domain_association::GetDomainAssociationError>::new());
...
#[derive(Debug)]
            struct GetDomainAssociationResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDomainAssociationResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_domain_association::de_get_domain_association_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetDomainAssociationRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDomainAssociationRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_domain_association::GetDomainAssociationInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_domain_association::GetDomainAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct GetDomainAssociationEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDomainAssociationEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDomainAssociationEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDomainAssociationInput>()
                        .ok_or("failed to downcast to GetDomainAssociationInput")?;
...
pub enum GetDomainAssociationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDomainAssociationError) for what information is available for the error.")]
...
impl GetDomainAssociationError {
    /// Creates the `GetDomainAssociationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDomainAssociationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDomainAssociationError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_domain_association::GetDomainAssociationError {
...
mod _get_domain_association_output;
