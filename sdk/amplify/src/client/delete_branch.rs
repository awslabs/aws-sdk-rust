...
impl super::Client {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::set_app_id): <p> The unique ID for an Amplify app. </p>
    ///   - [`branch_name(impl ::std::convert::Into<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::delete_branch::builders::DeleteBranchFluentBuilder::set_branch_name): <p> The name for the branch. </p>
