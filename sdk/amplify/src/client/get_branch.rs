...
impl super::Client {
    ...
    ///   - [`branch_name(impl Into<String>)`](crate::operation::get_branch::builders::GetBranchFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::get_branch::builders::GetBranchFluentBuilder::set_branch_name):<br>required: **true**<br><p> The name for the branch. </p><br>
