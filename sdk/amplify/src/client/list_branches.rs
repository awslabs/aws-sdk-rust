...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::list_branches::builders::ListBranchesFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::list_branches::builders::ListBranchesFluentBuilder::set_app_id):<br>required: **true**<br><p>The unique ID for an Amplify app.</p><br>
    ...
    ///   - [`max_results(i32)`](crate::operation::list_branches::builders::ListBranchesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_branches::builders::ListBranchesFluentBuilder::set_max_results):<br>required: **false**<br><p>The maximum number of records to list in a single response.</p><br>
    /// - On success, responds with [`ListBranchesOutput`](crate::operation::list_branches::ListBranchesOutput) with field(s):
    ///   - [`branches(Vec::<Branch>)`](crate::operation::list_branches::ListBranchesOutput::branches): <p>A list of branches for an Amplify app.</p>
