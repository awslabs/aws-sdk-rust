...
impl super::Client {
    ...
    ///   - [`branch_name(impl Into<String>)`](crate::operation::start_job::builders::StartJobFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::start_job::builders::StartJobFluentBuilder::set_branch_name):<br>required: **true**<br><p> The branch name for the job. </p><br>
    ...
    ///   - [`job_reason(impl Into<String>)`](crate::operation::start_job::builders::StartJobFluentBuilder::job_reason) / [`set_job_reason(Option<String>)`](crate::operation::start_job::builders::StartJobFluentBuilder::set_job_reason):<br>required: **false**<br><p> A descriptive reason for starting this job. </p><br>
