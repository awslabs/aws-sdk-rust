...
impl super::Client {
    ...
    ///   - [`branch_name(impl Into<String>)`](crate::operation::get_job::builders::GetJobFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::get_job::builders::GetJobFluentBuilder::set_branch_name):<br>required: **true**<br><p>The name of the branch to use for the job.</p><br>
