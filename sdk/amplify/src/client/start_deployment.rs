...
impl super::Client {
    ...
    ///   - [`branch_name(impl Into<String>)`](crate::operation::start_deployment::builders::StartDeploymentFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::start_deployment::builders::StartDeploymentFluentBuilder::set_branch_name):<br>required: **true**<br><p> The name for the branch, for the job. </p><br>
