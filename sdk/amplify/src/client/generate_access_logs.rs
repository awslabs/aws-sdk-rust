...
impl super::Client {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::generate_access_logs::builders::GenerateAccessLogsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::generate_access_logs::builders::GenerateAccessLogsFluentBuilder::set_domain_name): <p> The name of the domain. </p>
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::generate_access_logs::builders::GenerateAccessLogsFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::generate_access_logs::builders::GenerateAccessLogsFluentBuilder::set_app_id): <p> The unique ID for an Amplify app. </p>
