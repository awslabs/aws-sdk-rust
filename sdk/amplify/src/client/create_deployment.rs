...
impl super::Client {
    ...
    ///   - [`app_id(impl Into<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::set_app_id):<br>required: **true**<br><p> The unique ID for an Amplify app. </p><br>
    ///   - [`branch_name(impl Into<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::set_branch_name):<br>required: **true**<br><p> The name for the branch, for the job. </p><br>
    ...
    ///   - [`file_upload_urls(HashMap::<String, String>)`](crate::operation::create_deployment::CreateDeploymentOutput::file_upload_urls): <p> When the <code>fileMap</code> argument is provided in the request, <code>fileUploadUrls</code> will contain a map of file names to upload URLs. </p>
    ///   - [`zip_upload_url(String)`](crate::operation::create_deployment::CreateDeploymentOutput::zip_upload_url): <p> When the <code>fileMap</code> argument is not provided in the request, this <code>zipUploadUrl</code> is returned. </p>
