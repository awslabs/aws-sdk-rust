...
impl DomainStatus {
    ...
    DomainStatus::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AVAILABLE", "AWAITING_APP_CNAME", "CREATING", "FAILED", "IMPORTING_CUSTOM_CERTIFICATE", "IN_PROGRESS", "PENDING_DEPLOYMENT", "PENDING_VERIFICATION", "REQUESTING_CERTIFICATE", "UPDATING"]
                }
            }
