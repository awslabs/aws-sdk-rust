...
pub fn serialize_structure_create_app_input(
    ...
    if let Some(var_2) = &input.auto_branch_creation_config {
        ...
        crate::json_ser::serialize_structure_auto_branch_creation_config(&mut object_3, var_2);
        object_3.finish();
    }
        ...
        for item_12 in var_10 {
            {
                ...
                crate::json_ser::serialize_structure_custom_rule(&mut object_13, item_12);
                object_13.finish();
            }
        }
        array_11.finish();
...
pub fn serialize_structure_create_backend_environment_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_branch_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_create_domain_association_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_70 in var_68 {
            {
                ...
                crate::json_ser::serialize_structure_sub_domain_setting(&mut object_71, item_70);
                object_71.finish();
            }
        }
        array_69.finish();
...
pub fn serialize_structure_generate_access_logs_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_job_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_81) = &input.commit_time {
        object
            .key("commitTime")
            .instant(var_81, smithy_types::instant::Format::EpochSeconds);
    }
...
pub fn serialize_structure_update_app_input(
    ...
    if let Some(var_90) = &input.auto_branch_creation_config {
        ...
        crate::json_ser::serialize_structure_auto_branch_creation_config(&mut object_91, var_90);
        object_91.finish();
    }
        ...
        for item_100 in var_98 {
            {
                ...
                crate::json_ser::serialize_structure_custom_rule(&mut object_101, item_100);
                object_101.finish();
            }
        }
        array_99.finish();
...
pub fn serialize_structure_update_branch_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_domain_association_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_141 in var_139 {
            {
                ...
                crate::json_ser::serialize_structure_sub_domain_setting(&mut object_142, item_141);
                object_142.finish();
            }
        }
        array_140.finish();
...
pub fn serialize_structure_auto_branch_creation_config(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_custom_rule(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_sub_domain_setting(
    object: &mut smithy_json::serialize::JsonObjectWriter,
