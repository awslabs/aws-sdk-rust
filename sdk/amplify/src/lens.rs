...
pub(crate) fn reflens_list_domain_associations_output_next_token(
    input: &crate::operation::list_domain_associations::ListDomainAssociationsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_list_apps_output_apps(
    input: crate::operation::list_apps::ListAppsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::App>> {
...
pub(crate) fn lens_list_branches_output_branches(
    input: crate::operation::list_branches::ListBranchesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::Branch>> {
    let input = input.branches;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_list_domain_associations_output_domain_associations(
    input: crate::operation::list_domain_associations::ListDomainAssociationsOutput,
...
pub(crate) fn lens_list_jobs_output_job_summaries(
    input: crate::operation::list_jobs::ListJobsOutput,
