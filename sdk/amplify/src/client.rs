...
mod create_backend_environment;

mod create_branch;

mod create_deployment;

mod create_domain_association;
...
/// 
/// ```no_run
/// # async fn wrapper() -> Result<(), aws_sdk_amplify::Error> {
...
mod delete_backend_environment;

mod delete_branch;

mod delete_domain_association;

mod delete_job;

mod delete_webhook;

mod generate_access_logs;

mod get_app;

mod get_artifact_url;

mod get_backend_environment;

mod get_branch;

mod get_domain_association;
...
mod list_backend_environments;

mod list_branches;

mod list_domain_associations;
