...
pub fn de_list_groups_http_error(
    ...
    Err(match error_code {
        ...
        "DirectoryUnavailableException" => crate::operation::list_groups::ListGroupsError::DirectoryUnavailableException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
            ...
            let mut tmp = {
                ...
                output = output.set_retry_after_seconds(
                    crate::protocol_serde::shape_throttling_exception::de_retry_after_seconds_header(_response_headers).map_err(|_| {
                        crate::operation::list_groups::ListGroupsError::unhandled("Failed to parse RetryAfterSeconds from header `Retry-After")
                    })?,
                );
                let output = output.meta(generic);
