...
pub fn ser_create_group_input_input(
    ...
    if let Some(var_2) = &input.group_scope {
        object.key("GroupScope").string(var_2.as_str());
    }
    if let Some(var_3) = &input.group_type {
        object.key("GroupType").string(var_3.as_str());
    }
