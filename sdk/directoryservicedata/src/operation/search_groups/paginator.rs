...
/// Paginator for [`SearchGroups`](crate::operation::search_groups::SearchGroups)
pub struct SearchGroupsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::search_groups::builders::SearchGroupsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl SearchGroupsPaginator {
    ...
    pub fn items(self) -> crate::operation::search_groups::paginator::SearchGroupsPaginatorItems {
        crate::operation::search_groups::paginator::SearchGroupsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::search_groups::SearchGroups::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_search_groups_output_output_next_token(resp);
...
/// Flattened paginator for `SearchGroupsPaginator`
///
/// This is created with [`.items()`](SearchGroupsPaginator::items)
pub struct SearchGroupsPaginatorItems(SearchGroupsPaginator);

impl SearchGroupsPaginatorItems {
    /// Create the pagination stream
    ///
