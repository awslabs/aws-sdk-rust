...
/// Paginator for [`ListQApps`](crate::operation::list_q_apps::ListQApps)
pub struct ListQAppsPaginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::list_q_apps::builders::ListQAppsInputBuilder,
    stop_on_duplicate_token: bool,
}

impl ListQAppsPaginator {
    ...
    pub fn items(self) -> crate::operation::list_q_apps::paginator::ListQAppsPaginatorItems {
        crate::operation::list_q_apps::paginator::ListQAppsPaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::list_q_apps::ListQApps::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_list_q_apps_output_output_next_token(resp);
...
/// Flattened paginator for `ListQAppsPaginator`
///
/// This is created with [`.items()`](ListQAppsPaginator::items)
pub struct ListQAppsPaginatorItems(ListQAppsPaginator);

impl ListQAppsPaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_q_apps_output_output_apps(page).unwrap_or_default().into_iter())
    }
}
