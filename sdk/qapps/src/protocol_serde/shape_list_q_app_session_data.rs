                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_q_app_session_data::ListQAppSessionDataError::unhandled(
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "sessionData" => {
                    builder = builder.set_session_data(crate::protocol_serde::shape_q_app_session_data_list::de_q_app_session_data_list(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
