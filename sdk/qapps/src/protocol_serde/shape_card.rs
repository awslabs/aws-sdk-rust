...
) -> Result<Option<crate::types::Card>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "textInput" => Some(crate::types::Card::TextInput(
                            crate::protocol_serde::shape_text_input_card::de_text_input_card(tokens)?.ok_or_else(|| {
                        ...
                        "qQuery" => Some(crate::types::Card::QQuery(
                            crate::protocol_serde::shape_q_query_card::de_q_query_card(tokens)?.ok_or_else(|| {
                        ...
                        "qPlugin" => Some(crate::types::Card::QPlugin(
                            crate::protocol_serde::shape_q_plugin_card::de_q_plugin_card(tokens)?.ok_or_else(|| {
                        ...
                        "fileUpload" => Some(crate::types::Card::FileUpload(
                            crate::protocol_serde::shape_file_upload_card::de_file_upload_card(tokens)?.ok_or_else(|| {
