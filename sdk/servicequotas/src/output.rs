...
pub struct RequestServiceQuotaIncreaseOutput  {
    ...
    #[doc(hidden)]pub requested_quota: std::option::Option<crate::model::RequestedServiceQuotaChange>,
}
...
pub struct PutServiceQuotaIncreaseRequestIntoTemplateOutput  {
    /// <p>Information about the quota increase request.</p>
    #[doc(hidden)]pub service_quota_increase_request_in_template: std::option::Option<crate::model::ServiceQuotaIncreaseRequestInTemplate>,
}
...
impl  std::fmt::Debug for PutServiceQuotaIncreaseRequestIntoTemplateOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("service_quota_increase_request_in_template", &self.service_quota_increase_request_in_template);
        formatter.finish()
    }
}
...
pub struct ListServicesOutput  {
    ...
    #[doc(hidden)]pub services: std::option::Option<std::vec::Vec<crate::model::ServiceInfo>>,
}
...
pub struct ListServiceQuotasOutput  {
    ...
    #[doc(hidden)]pub quotas: std::option::Option<std::vec::Vec<crate::model::ServiceQuota>>,
}
...
pub struct ListServiceQuotaIncreaseRequestsInTemplateOutput  {
    ...
    #[doc(hidden)]pub service_quota_increase_request_in_template_list: std::option::Option<std::vec::Vec<crate::model::ServiceQuotaIncreaseRequestInTemplate>>,
    /// <p>The token to use to retrieve the next page of results. This value is null when there are no more results to return.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for ListServiceQuotaIncreaseRequestsInTemplateOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("service_quota_increase_request_in_template_list", &self.service_quota_increase_request_in_template_list);
        formatter.field("next_token", &self.next_token);
        formatter.finish()
    }
}
...
pub struct ListRequestedServiceQuotaChangeHistoryByQuotaOutput  {
    ...
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Information about the quota increase requests.</p>
    #[doc(hidden)]pub requested_quotas: std::option::Option<std::vec::Vec<crate::model::RequestedServiceQuotaChange>>,
}
...
pub struct GetServiceQuotaOutput  {
    ...
    #[doc(hidden)]pub quota: std::option::Option<crate::model::ServiceQuota>,
}
...
pub struct GetAssociationForServiceQuotaTemplateOutput  {
    ...
    #[doc(hidden)]pub service_quota_template_association_status: std::option::Option<crate::model::ServiceQuotaTemplateAssociationStatus>,
}
...
impl  std::fmt::Debug for GetAssociationForServiceQuotaTemplateOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("service_quota_template_association_status", &self.service_quota_template_association_status);
        formatter.finish()
    }
}
