...
pub fn serialize_structure_delete_service_quota_increase_request_from_template_input(
...
pub fn serialize_structure_get_aws_default_service_quota_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_requested_service_quota_change_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_service_quota_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_service_quota_increase_request_from_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_aws_default_service_quotas_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_requested_service_quota_change_history_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_requested_service_quota_change_history_by_quota_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_service_quota_increase_requests_in_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_service_quotas_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_put_service_quota_increase_request_into_template_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_37) = &input.desired_value {
        object.key("DesiredValue").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_37).into()),
        );
    }
}

pub fn serialize_structure_request_service_quota_increase_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_40) = &input.desired_value {
        object.key("DesiredValue").number(
            #[allow(clippy::useless_conversion)]
            smithy_types::Number::Float((*var_40).into()),
        );
    }
}
