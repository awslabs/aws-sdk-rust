...
impl super::Client {
    ...
    ///   - [`service_code(impl ::std::convert::Into<String>)`](crate::operation::delete_service_quota_increase_request_from_template::builders::DeleteServiceQuotaIncreaseRequestFromTemplateFluentBuilder::service_code) / [`set_service_code(Option<String>)`](crate::operation::delete_service_quota_increase_request_from_template::builders::DeleteServiceQuotaIncreaseRequestFromTemplateFluentBuilder::set_service_code): <p>The service identifier.</p>
    ///   - [`quota_code(impl ::std::convert::Into<String>)`](crate::operation::delete_service_quota_increase_request_from_template::builders::DeleteServiceQuotaIncreaseRequestFromTemplateFluentBuilder::quota_code) / [`set_quota_code(Option<String>)`](crate::operation::delete_service_quota_increase_request_from_template::builders::DeleteServiceQuotaIncreaseRequestFromTemplateFluentBuilder::set_quota_code): <p>The quota identifier.</p>
