...
impl super::Client  {
    ...
    pub fn delete_service_quota_increase_request_from_template(&self) -> crate::client::fluent_builders::DeleteServiceQuotaIncreaseRequestFromTemplate {
                                crate::client::fluent_builders::DeleteServiceQuotaIncreaseRequestFromTemplate::new(self.handle.clone())
                            }
}
