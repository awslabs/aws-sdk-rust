...
impl super::Client  {
    ...
    pub fn list_service_quota_increase_requests_in_template(&self) -> crate::client::fluent_builders::ListServiceQuotaIncreaseRequestsInTemplate {
                                crate::client::fluent_builders::ListServiceQuotaIncreaseRequestsInTemplate::new(self.handle.clone())
                            }
}
