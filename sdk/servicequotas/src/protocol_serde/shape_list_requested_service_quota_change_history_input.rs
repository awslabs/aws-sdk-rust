...
pub fn ser_list_requested_service_quota_change_history_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListRequestedServiceQuotaChangeHistoryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
