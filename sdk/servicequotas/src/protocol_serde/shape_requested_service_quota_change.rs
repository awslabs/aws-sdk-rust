...
pub(crate) fn de_requested_service_quota_change<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RequestedServiceQuotaChange>, aws_smithy_json::deserialize::error::DeserializeError>
