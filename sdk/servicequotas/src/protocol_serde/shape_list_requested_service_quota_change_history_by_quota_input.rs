...
pub fn ser_list_requested_service_quota_change_history_by_quota_input_input(
    ...
    if let Some(var_6) = &input.quota_requested_at_level {
        object.key("QuotaRequestedAtLevel").string(var_6.as_str());
    }
    Ok(())
}
