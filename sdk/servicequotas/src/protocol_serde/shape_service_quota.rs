                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "UsageMetric" => {
                                builder = builder.set_usage_metric(
                                    crate::protocol_serde::shape_metric_info::de_metric_info(
                                        tokens,
                                    )?,
                                );
                            }
                            "Period" => {
                                builder = builder.set_period(
                                    crate::protocol_serde::shape_quota_period::de_quota_period(
                                        tokens,
                                    )?,
                                );
                            }
                            "ErrorReason" => {
                                builder = builder.set_error_reason(
                                    crate::protocol_serde::shape_error_reason::de_error_reason(
                                        tokens,
                                    )?,
                                );
                            }
