...
) -> Result<Option<crate::types::ServiceQuota>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "UsageMetric" => {
                            builder = builder.set_usage_metric(crate::protocol_serde::shape_metric_info::de_metric_info(tokens)?);
                        }
                        "Period" => {
                            builder = builder.set_period(crate::protocol_serde::shape_quota_period::de_quota_period(tokens)?);
                        }
                        "ErrorReason" => {
