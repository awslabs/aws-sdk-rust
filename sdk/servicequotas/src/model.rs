...
pub struct RequestedServiceQuotaChange  {
    ...
    /// <p>The quota name.</p>
    #[doc(hidden)]pub quota_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub created: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The date and time of the most recent change.</p>
    #[doc(hidden)]pub last_updated: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The IAM identity of the requester.</p>
    #[doc(hidden)]pub requester: std::option::Option<std::string::String>,
    /// <p>The Amazon Resource Name (ARN) of the quota.</p>
    #[doc(hidden)]pub quota_arn: std::option::Option<std::string::String>,
    /// <p>Indicates whether the quota is global.</p>
    #[doc(hidden)]pub global_quota: bool,
...
pub struct ServiceQuota  {
    ...
    #[doc(hidden)]pub quota_name: std::option::Option<std::string::String>,
    /// <p>The quota value.</p>
    #[doc(hidden)]pub value: std::option::Option<f64>,
    /// <p>The unit of measurement.</p>
    #[doc(hidden)]pub unit: std::option::Option<std::string::String>,
    /// <p>Indicates whether the quota value can be increased.</p>
    #[doc(hidden)]pub adjustable: bool,
    /// <p>Indicates whether the quota is global.</p>
    #[doc(hidden)]pub global_quota: bool,
    /// <p>Information about the measurement.</p>
    #[doc(hidden)]pub usage_metric: std::option::Option<crate::model::MetricInfo>,
    /// <p>The period of time.</p>
    #[doc(hidden)]pub period: std::option::Option<crate::model::QuotaPeriod>,
    /// <p>The error code and error reason.</p>
    #[doc(hidden)]pub error_reason: std::option::Option<crate::model::ErrorReason>,
}
impl ServiceQuota {
    /// <p>The service identifier.</p>
    pub fn service_code(&self) -> std::option::Option<& str> {
...
pub struct QuotaPeriod  {
    /// <p>The value.</p>
    #[doc(hidden)]pub period_value: std::option::Option<i32>,
    /// <p>The time unit.</p>
    #[doc(hidden)]pub period_unit: std::option::Option<crate::model::PeriodUnit>,
}
impl QuotaPeriod {
    /// <p>The value.</p>
...
pub struct MetricInfo  {
    ...
    #[doc(hidden)]pub metric_namespace: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub metric_dimensions: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>The metric statistic that we recommend you use when determining quota usage.</p>
    #[doc(hidden)]pub metric_statistic_recommendation: std::option::Option<std::string::String>,
}
impl MetricInfo {
    /// <p>The namespace of the metric.</p>
...
impl  std::fmt::Debug for MetricInfo  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("metric_statistic_recommendation", &self.metric_statistic_recommendation);
        formatter.finish()
    }
}
