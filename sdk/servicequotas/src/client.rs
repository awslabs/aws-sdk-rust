...
impl Client  {
    ...
    pub fn get_association_for_service_quota_template(&self) -> crate::client::fluent_builders::GetAssociationForServiceQuotaTemplate {
                            crate::client::fluent_builders::GetAssociationForServiceQuotaTemplate::new(self.handle.clone())
                        }
    ...
    pub fn get_aws_default_service_quota(&self) -> crate::client::fluent_builders::GetAWSDefaultServiceQuota {
    ...
    pub fn put_service_quota_increase_request_into_template(&self) -> crate::client::fluent_builders::PutServiceQuotaIncreaseRequestIntoTemplate {
                            crate::client::fluent_builders::PutServiceQuotaIncreaseRequestIntoTemplate::new(self.handle.clone())
                        }
