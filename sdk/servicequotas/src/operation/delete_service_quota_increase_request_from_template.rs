...
impl DeleteServiceQuotaIncreaseRequestFromTemplate {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.DeleteServiceQuotaIncreaseRequestFromTemplate",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "DeleteServiceQuotaIncreaseRequestFromTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteServiceQuotaIncreaseRequestFromTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            DeleteServiceQuotaIncreaseRequestFromTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            DeleteServiceQuotaIncreaseRequestFromTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("DeleteServiceQuotaIncreaseRequestFromTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteServiceQuotaIncreaseRequestFromTemplate")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    DeleteServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct DeleteServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<DeleteServiceQuotaIncreaseRequestFromTemplateInput>() else {
        ...
        if requested.should_capture("QuotaCode") {
            if let ::std::option::Option::Some(value) = input.quota_code.as_deref() {
                captured.insert("QuotaCode", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteServiceQuotaIncreaseRequestFromTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_delete_service_quota_increase_request_from_template::de_delete_service_quota_increase_request_from_template_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_delete_service_quota_increase_request_from_template::de_delete_service_quota_increase_request_from_template_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteServiceQuotaIncreaseRequestFromTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::delete_service_quota_increase_request_from_template::DeleteServiceQuotaIncreaseRequestFromTemplateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::delete_service_quota_increase_request_from_template::DeleteServiceQuotaIncreaseRequestFromTemplateInput,
