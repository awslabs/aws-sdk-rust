...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for DeleteServiceQuotaIncreaseRequestFromTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for DeleteServiceQuotaIncreaseRequestFromTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_service_quota_increase_request_from_template::ser_delete_service_quota_increase_request_from_template_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for DeleteServiceQuotaIncreaseRequestFromTemplateEndpointParamsInterceptor {
