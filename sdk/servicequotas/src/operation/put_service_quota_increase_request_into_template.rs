...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for PutServiceQuotaIncreaseRequestIntoTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for PutServiceQuotaIncreaseRequestIntoTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_put_service_quota_increase_request_into_template::ser_put_service_quota_increase_request_into_template_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for PutServiceQuotaIncreaseRequestIntoTemplateEndpointParamsInterceptor {
