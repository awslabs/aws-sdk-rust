...
impl PutServiceQuotaIncreaseRequestIntoTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.PutServiceQuotaIncreaseRequestIntoTemplate",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "PutServiceQuotaIncreaseRequestIntoTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutServiceQuotaIncreaseRequestIntoTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutServiceQuotaIncreaseRequestIntoTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutServiceQuotaIncreaseRequestIntoTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutServiceQuotaIncreaseRequestIntoTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutServiceQuotaIncreaseRequestIntoTemplate")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    PutServiceQuotaIncreaseRequestIntoTemplateTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct PutServiceQuotaIncreaseRequestIntoTemplateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutServiceQuotaIncreaseRequestIntoTemplateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<PutServiceQuotaIncreaseRequestIntoTemplateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutServiceQuotaIncreaseRequestIntoTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_put_service_quota_increase_request_into_template::de_put_service_quota_increase_request_into_template_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_put_service_quota_increase_request_into_template::de_put_service_quota_increase_request_into_template_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutServiceQuotaIncreaseRequestIntoTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateError
{
