...
impl GetServiceQuotaInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_service_quota::GetServiceQuota, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_quota::ser_get_service_quota_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServiceQuota {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_service_quota::de_get_service_quota_http_response_with_props(status, headers, body)
        }
    }
}
