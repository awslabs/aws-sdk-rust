...
impl ListRequestedServiceQuotaChangeHistoryFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::list_requested_service_quota_change_history::builders::ListRequestedServiceQuotaChangeHistoryInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistory::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistory::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput, crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError, Self> {
    ...
    /// Create a paginator for this request
                            ...
                            pub fn into_paginator(self) -> crate::operation::list_requested_service_quota_change_history::paginator::ListRequestedServiceQuotaChangeHistoryPaginator {
                                crate::operation::list_requested_service_quota_change_history::paginator::ListRequestedServiceQuotaChangeHistoryPaginator::new(self.handle, self.inner)
                            }
