...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListRequestedServiceQuotaChangeHistoryByQuotaResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListRequestedServiceQuotaChangeHistoryByQuotaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_requested_service_quota_change_history_by_quota::ser_list_requested_service_quota_change_history_by_quota_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListRequestedServiceQuotaChangeHistoryByQuotaEndpointParamsInterceptor {
