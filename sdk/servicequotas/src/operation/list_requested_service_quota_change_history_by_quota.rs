    ...
    for ListRequestedServiceQuotaChangeHistoryByQuota
{
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_requested_service_quota_change_history_by_quota::de_list_requested_service_quota_change_history_by_quota_http_response_with_props(status, headers, body)
        }
    }
}
