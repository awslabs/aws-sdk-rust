...
impl ListRequestedServiceQuotaChangeHistoryByQuota {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.ListRequestedServiceQuotaChangeHistoryByQuota",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "ListRequestedServiceQuotaChangeHistoryByQuota",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRequestedServiceQuotaChangeHistoryByQuota {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListRequestedServiceQuotaChangeHistoryByQuotaRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListRequestedServiceQuotaChangeHistoryByQuotaResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListRequestedServiceQuotaChangeHistoryByQuota")
                .build()
        ...
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRequestedServiceQuotaChangeHistoryByQuota")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ListRequestedServiceQuotaChangeHistoryByQuotaTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListRequestedServiceQuotaChangeHistoryByQuotaTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRequestedServiceQuotaChangeHistoryByQuotaTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListRequestedServiceQuotaChangeHistoryByQuotaInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRequestedServiceQuotaChangeHistoryByQuotaResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_requested_service_quota_change_history_by_quota::de_list_requested_service_quota_change_history_by_quota_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_requested_service_quota_change_history_by_quota::de_list_requested_service_quota_change_history_by_quota_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRequestedServiceQuotaChangeHistoryByQuotaRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_requested_service_quota_change_history_by_quota::ListRequestedServiceQuotaChangeHistoryByQuotaInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_requested_service_quota_change_history_by_quota::ListRequestedServiceQuotaChangeHistoryByQuotaInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_requested_service_quota_change_history_by_quota::ListRequestedServiceQuotaChangeHistoryByQuotaError
{
