...
impl GetAssociationForServiceQuotaTemplate {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.GetAssociationForServiceQuotaTemplate",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "GetAssociationForServiceQuotaTemplate",
    ...
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetAssociationForServiceQuotaTemplate")
                .build()
