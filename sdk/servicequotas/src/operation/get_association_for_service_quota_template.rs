...
impl GetAssociationForServiceQuotaTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetAssociationForServiceQuotaTemplate`](crate::operation::get_association_for_service_quota_template::GetAssociationForServiceQuotaTemplate)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_association_for_service_quota_template::GetAssociationForServiceQuotaTemplate,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_association_for_service_quota_template::GetAssociationForServiceQuotaTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAssociationForServiceQuotaTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_association_for_service_quota_template::de_get_association_for_service_quota_template_http_response_with_props(status, headers, body)
        }
    }
}
