...
impl DisassociateServiceQuotaTemplate {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateInput,
                    ) -> ::std::result::Result<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisassociateServiceQuotaTemplate {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisassociateServiceQuotaTemplate");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisassociateServiceQuotaTemplateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisassociateServiceQuotaTemplateResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisassociateServiceQuotaTemplate")
...
.with_interceptor(DisassociateServiceQuotaTemplateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError>::new());
...
#[derive(Debug)]
            struct DisassociateServiceQuotaTemplateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisassociateServiceQuotaTemplateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disassociate_service_quota_template::de_disassociate_service_quota_template_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DisassociateServiceQuotaTemplateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisassociateServiceQuotaTemplateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_disassociate_service_quota_template::ser_disassociate_service_quota_template_input(&input)?);
                    
                    ::std::result::Result::Ok(request_builder.body(body).expect("valid request").try_into().unwrap())
                }
            }
#[derive(Debug)]
            struct DisassociateServiceQuotaTemplateEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisassociateServiceQuotaTemplateEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisassociateServiceQuotaTemplateEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisassociateServiceQuotaTemplateInput>()
                        .ok_or("failed to downcast to DisassociateServiceQuotaTemplateInput")?;
...
pub enum DisassociateServiceQuotaTemplateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisassociateServiceQuotaTemplateError) for what information is available for the error.")]
...
impl DisassociateServiceQuotaTemplateError {
    /// Creates the `DisassociateServiceQuotaTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisassociateServiceQuotaTemplateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisassociateServiceQuotaTemplateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError {
...
mod _disassociate_service_quota_template_output;
