...
impl DisassociateServiceQuotaTemplateInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplate,
...
impl aws_smithy_http::response::ParseStrictResponse for DisassociateServiceQuotaTemplate {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_service_quota_template::de_disassociate_service_quota_template_http_response_with_props(status, headers, body)
        }
    }
}
...
impl aws_http::request_id::RequestId
    for crate::operation::disassociate_service_quota_template::DisassociateServiceQuotaTemplateError
{
