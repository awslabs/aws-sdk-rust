...
impl GetServiceQuotaIncreaseRequestFromTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_service_quota_increase_request_from_template::GetServiceQuotaIncreaseRequestFromTemplateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_service_quota_increase_request_from_template::GetServiceQuotaIncreaseRequestFromTemplateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.GetServiceQuotaIncreaseRequestFromTemplate",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "GetServiceQuotaIncreaseRequestFromTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetServiceQuotaIncreaseRequestFromTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetServiceQuotaIncreaseRequestFromTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetServiceQuotaIncreaseRequestFromTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetServiceQuotaIncreaseRequestFromTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetServiceQuotaIncreaseRequestFromTemplate")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    GetServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetServiceQuotaIncreaseRequestFromTemplateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetServiceQuotaIncreaseRequestFromTemplateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetServiceQuotaIncreaseRequestFromTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_service_quota_increase_request_from_template::de_get_service_quota_increase_request_from_template_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_service_quota_increase_request_from_template::de_get_service_quota_increase_request_from_template_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetServiceQuotaIncreaseRequestFromTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_service_quota_increase_request_from_template::GetServiceQuotaIncreaseRequestFromTemplateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_service_quota_increase_request_from_template::GetServiceQuotaIncreaseRequestFromTemplateInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::get_service_quota_increase_request_from_template::GetServiceQuotaIncreaseRequestFromTemplateError
{
