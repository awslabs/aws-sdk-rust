...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for GetServiceQuotaIncreaseRequestFromTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for GetServiceQuotaIncreaseRequestFromTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_service_quota_increase_request_from_template::ser_get_service_quota_increase_request_from_template_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetServiceQuotaIncreaseRequestFromTemplateEndpointParamsInterceptor {
