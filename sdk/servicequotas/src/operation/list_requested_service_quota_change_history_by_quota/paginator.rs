...
/// Flattened paginator for `ListRequestedServiceQuotaChangeHistoryByQuotaPaginator`
                ...
                impl  ListRequestedServiceQuotaChangeHistoryByQuotaPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::types::RequestedServiceQuotaChange, aws_smithy_http::result::SdkError<crate::operation::list_requested_service_quota_change_history_by_quota::ListRequestedServiceQuotaChangeHistoryByQuotaError>>> + Unpin
                     {
