                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token =
                                    crate::lens::reflens_list_requested_service_quota_change_history_by_quota_output_output_next_token(resp);
...
impl ListRequestedServiceQuotaChangeHistoryByQuotaPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_list_requested_service_quota_change_history_by_quota_output_output_requested_quotas(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
