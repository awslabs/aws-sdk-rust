...
impl crate::operation::list_requested_service_quota_change_history_by_quota::builders::ListRequestedServiceQuotaChangeHistoryByQuotaInputBuilder {
...
impl ListRequestedServiceQuotaChangeHistoryByQuotaFluentBuilder {
    ...
    {
        crate::operation::list_requested_service_quota_change_history_by_quota::paginator::ListRequestedServiceQuotaChangeHistoryByQuotaPaginator::new(
            self.handle,
            self.inner,
        )
    }
