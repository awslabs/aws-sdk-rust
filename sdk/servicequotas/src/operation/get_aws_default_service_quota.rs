...
impl GetAwsDefaultServiceQuotaInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuota::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAWSDefaultServiceQuota {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_aws_default_service_quota::de_get_aws_default_service_quota_http_response_with_props(
                status, headers, body,
            )
        }
    }
