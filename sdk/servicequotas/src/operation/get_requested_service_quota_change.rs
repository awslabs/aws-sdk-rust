...
impl GetRequestedServiceQuotaChangeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_requested_service_quota_change::GetRequestedServiceQuotaChange::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRequestedServiceQuotaChange {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_requested_service_quota_change::de_get_requested_service_quota_change_http_response_with_props(
                status, headers, body,
            )
        }
    }
