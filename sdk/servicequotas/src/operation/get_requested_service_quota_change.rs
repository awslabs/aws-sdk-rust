...
impl GetRequestedServiceQuotaChange {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_requested_service_quota_change::GetRequestedServiceQuotaChangeError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_requested_service_quota_change::GetRequestedServiceQuotaChangeOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetRequestedServiceQuotaChange",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetRequestedServiceQuotaChange {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetRequestedServiceQuotaChangeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetRequestedServiceQuotaChangeResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetRequestedServiceQuotaChange")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetRequestedServiceQuotaChange")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetRequestedServiceQuotaChangeTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetRequestedServiceQuotaChangeTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetRequestedServiceQuotaChangeTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetRequestedServiceQuotaChangeInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetRequestedServiceQuotaChangeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_get_requested_service_quota_change::de_get_requested_service_quota_change_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetRequestedServiceQuotaChangeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_requested_service_quota_change::GetRequestedServiceQuotaChangeInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_requested_service_quota_change::GetRequestedServiceQuotaChangeInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_requested_service_quota_change::ser_get_requested_service_quota_change_input(&input)?,
        );
