...
impl ListServiceQuotas {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_service_quotas::ListServiceQuotasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_service_quotas::ListServiceQuotasOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Service Quotas", "ListServiceQuotas", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Service Quotas.ListServiceQuotas",
                "rpc.service" = "Service Quotas",
                "rpc.method" = "ListServiceQuotas",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListServiceQuotas {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListServiceQuotas")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListServiceQuotas")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListServiceQuotasTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListServiceQuotasTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListServiceQuotasTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListServiceQuotasInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListServiceQuotasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_service_quotas::de_list_service_quotas_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_service_quotas::de_list_service_quotas_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListServiceQuotasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_service_quotas::ListServiceQuotasInput>()
            .expect("correct type");
