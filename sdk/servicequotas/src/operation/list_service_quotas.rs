...
impl ListServiceQuotas {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_service_quotas::ListServiceQuotasError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_service_quotas::ListServiceQuotasOutput>::assume_from(output)
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("servicequotas", "ListServiceQuotas", input, runtime_plugins, stop_point)
            .await
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListServiceQuotas {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("ListServiceQuotas", "servicequotas"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListServiceQuotas")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(ListServiceQuotasEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for ListServiceQuotasResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for ListServiceQuotasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::list_service_quotas::ListServiceQuotasInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::list_service_quotas::ListServiceQuotasInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_service_quotas::ser_list_service_quotas_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListServiceQuotasEndpointParamsInterceptor {
