...
impl ::aws_smithy_runtime_api::client::ser_de::ResponseDeserializer for ListServiceQuotaIncreaseRequestsInTemplateResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::ser_de::RequestSerializer for ListServiceQuotaIncreaseRequestsInTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_service_quota_increase_requests_in_template::ser_list_service_quota_increase_requests_in_template_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for ListServiceQuotaIncreaseRequestsInTemplateEndpointParamsInterceptor {
