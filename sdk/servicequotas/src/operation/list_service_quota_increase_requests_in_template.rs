...
impl ListServiceQuotaIncreaseRequestsInTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Service Quotas.ListServiceQuotaIncreaseRequestsInTemplate",
            "rpc.service" = "Service Quotas",
            "rpc.method" = "ListServiceQuotaIncreaseRequestsInTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListServiceQuotaIncreaseRequestsInTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListServiceQuotaIncreaseRequestsInTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListServiceQuotaIncreaseRequestsInTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListServiceQuotaIncreaseRequestsInTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListServiceQuotaIncreaseRequestsInTemplate")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ListServiceQuotaIncreaseRequestsInTemplateTelemetryInputCaptureInterceptor,
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListServiceQuotaIncreaseRequestsInTemplateTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListServiceQuotaIncreaseRequestsInTemplateTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListServiceQuotaIncreaseRequestsInTemplateInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListServiceQuotaIncreaseRequestsInTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_service_quota_increase_requests_in_template::de_list_service_quota_increase_requests_in_template_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_service_quota_increase_requests_in_template::de_list_service_quota_increase_requests_in_template_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListServiceQuotaIncreaseRequestsInTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateInput,
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateError
{
