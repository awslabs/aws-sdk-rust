...
impl ListRequestedServiceQuotaChangeHistoryInput {
    /// Consumes the builder and constructs an Operation<[`ListRequestedServiceQuotaChangeHistory`](crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistory::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRequestedServiceQuotaChangeHistory {
    type Output = ::std::result::Result<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput, crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_requested_service_quota_change_history::de_list_requested_service_quota_change_history_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId for crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError {
