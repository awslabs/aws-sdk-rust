...
impl ListRequestedServiceQuotaChangeHistory {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListRequestedServiceQuotaChangeHistory",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRequestedServiceQuotaChangeHistory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListRequestedServiceQuotaChangeHistoryRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListRequestedServiceQuotaChangeHistoryResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListRequestedServiceQuotaChangeHistory")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRequestedServiceQuotaChangeHistory")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListRequestedServiceQuotaChangeHistoryTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListRequestedServiceQuotaChangeHistoryTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRequestedServiceQuotaChangeHistoryTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListRequestedServiceQuotaChangeHistoryInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRequestedServiceQuotaChangeHistoryResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_requested_service_quota_change_history::de_list_requested_service_quota_change_history_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_requested_service_quota_change_history::de_list_requested_service_quota_change_history_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRequestedServiceQuotaChangeHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_requested_service_quota_change_history::ser_list_requested_service_quota_change_history_input(&input)?,
        );
...
impl ::aws_types::request_id::RequestId
    for crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError
{
