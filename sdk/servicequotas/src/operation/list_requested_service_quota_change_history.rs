...
/// Orchestration and serialization glue logic for `ListRequestedServiceQuotaChangeHistory`.
...
impl ListRequestedServiceQuotaChangeHistory {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListRequestedServiceQuotaChangeHistory {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListRequestedServiceQuotaChangeHistory");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListRequestedServiceQuotaChangeHistoryRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListRequestedServiceQuotaChangeHistoryResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListRequestedServiceQuotaChangeHistory")
...
.with_interceptor(ListRequestedServiceQuotaChangeHistoryEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError>::new());
...
#[derive(Debug)]
            struct ListRequestedServiceQuotaChangeHistoryResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListRequestedServiceQuotaChangeHistoryResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_requested_service_quota_change_history::de_list_requested_service_quota_change_history_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_requested_service_quota_change_history::de_list_requested_service_quota_change_history_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListRequestedServiceQuotaChangeHistoryRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListRequestedServiceQuotaChangeHistoryRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_requested_service_quota_change_history::ser_list_requested_service_quota_change_history_input(&input)?);
...
#[derive(Debug)]
            struct ListRequestedServiceQuotaChangeHistoryEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListRequestedServiceQuotaChangeHistoryEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListRequestedServiceQuotaChangeHistoryEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListRequestedServiceQuotaChangeHistoryInput>()
                        .ok_or("failed to downcast to ListRequestedServiceQuotaChangeHistoryInput")?;
...
pub enum ListRequestedServiceQuotaChangeHistoryError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListRequestedServiceQuotaChangeHistoryError) for what information is available for the error.")]
...
impl ListRequestedServiceQuotaChangeHistoryError {
    /// Creates the `ListRequestedServiceQuotaChangeHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListRequestedServiceQuotaChangeHistoryError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListRequestedServiceQuotaChangeHistoryError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_requested_service_quota_change_history::ListRequestedServiceQuotaChangeHistoryError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_requested_service_quota_change_history::_list_requested_service_quota_change_history_output::ListRequestedServiceQuotaChangeHistoryOutput;

pub use crate::operation::list_requested_service_quota_change_history::_list_requested_service_quota_change_history_input::ListRequestedServiceQuotaChangeHistoryInput;

mod _list_requested_service_quota_change_history_input;

mod _list_requested_service_quota_change_history_output;
