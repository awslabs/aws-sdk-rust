...
impl AssociateServiceQuotaTemplateInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplate::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateServiceQuotaTemplate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_associate_service_quota_template::de_associate_service_quota_template_http_response_with_props(
                status, headers, body,
            )
        }
    }
