...
impl AssociateServiceQuotaTemplate {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "AssociateServiceQuotaTemplate",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for AssociateServiceQuotaTemplate {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            AssociateServiceQuotaTemplateRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            AssociateServiceQuotaTemplateResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("AssociateServiceQuotaTemplate")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("AssociateServiceQuotaTemplate")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for AssociateServiceQuotaTemplateResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_associate_service_quota_template::de_associate_service_quota_template_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_associate_service_quota_template::de_associate_service_quota_template_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for AssociateServiceQuotaTemplateRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_associate_service_quota_template::ser_associate_service_quota_template_input(&input)?,
        );
