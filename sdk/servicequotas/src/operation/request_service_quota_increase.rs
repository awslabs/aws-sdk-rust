...
impl RequestServiceQuotaIncreaseInput {
    /// Consumes the builder and constructs an Operation<[`RequestServiceQuotaIncrease`](crate::operation::request_service_quota_increase::RequestServiceQuotaIncrease)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::request_service_quota_increase::RequestServiceQuotaIncrease, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::request_service_quota_increase::RequestServiceQuotaIncrease::new())
...
impl aws_smithy_http::response::ParseStrictResponse for RequestServiceQuotaIncrease {
                type Output = std::result::Result<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseOutput, crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>;
