...
impl RequestServiceQuotaIncreaseInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::request_service_quota_increase::RequestServiceQuotaIncrease::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestServiceQuotaIncrease {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_response_with_props(
                status, headers, body,
            )
        }
    }
