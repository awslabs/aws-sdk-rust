...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestServiceQuotaIncrease {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for RequestServiceQuotaIncreaseError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError
{
