...
/// Orchestration and serialization glue logic for `RequestServiceQuotaIncrease`.
...
impl RequestServiceQuotaIncrease {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput,
                    ) -> ::std::result::Result<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RequestServiceQuotaIncrease {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("RequestServiceQuotaIncrease");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(RequestServiceQuotaIncreaseRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(RequestServiceQuotaIncreaseResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RequestServiceQuotaIncrease")
...
.with_interceptor(RequestServiceQuotaIncreaseEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>::new());
...
#[derive(Debug)]
            struct RequestServiceQuotaIncreaseResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RequestServiceQuotaIncreaseResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct RequestServiceQuotaIncreaseRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RequestServiceQuotaIncreaseRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_request_service_quota_increase::ser_request_service_quota_increase_input(&input)?);
...
#[derive(Debug)]
            struct RequestServiceQuotaIncreaseEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RequestServiceQuotaIncreaseEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "RequestServiceQuotaIncreaseEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<RequestServiceQuotaIncreaseInput>()
                        .ok_or("failed to downcast to RequestServiceQuotaIncreaseInput")?;
...
pub enum RequestServiceQuotaIncreaseError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-RequestServiceQuotaIncreaseError) for what information is available for the error.")]
...
impl RequestServiceQuotaIncreaseError {
    /// Creates the `RequestServiceQuotaIncreaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RequestServiceQuotaIncreaseError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::QuotaExceededException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for RequestServiceQuotaIncreaseError {
...
impl ::aws_types::request_id::RequestId for crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError {
...
mod _request_service_quota_increase_output;
