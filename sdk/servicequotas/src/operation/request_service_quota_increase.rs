...
impl RequestServiceQuotaIncrease {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "RequestServiceQuotaIncrease",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for RequestServiceQuotaIncrease {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            RequestServiceQuotaIncreaseRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            RequestServiceQuotaIncreaseResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("RequestServiceQuotaIncrease")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("RequestServiceQuotaIncrease")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                RequestServiceQuotaIncreaseTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct RequestServiceQuotaIncreaseTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for RequestServiceQuotaIncreaseTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<RequestServiceQuotaIncreaseInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for RequestServiceQuotaIncreaseResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_request_service_quota_increase::de_request_service_quota_increase_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for RequestServiceQuotaIncreaseRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::request_service_quota_increase::RequestServiceQuotaIncreaseInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_request_service_quota_increase::ser_request_service_quota_increase_input(&input)?,
        );
...
impl ::std::error::Error for RequestServiceQuotaIncreaseError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::QuotaExceededException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RequestServiceQuotaIncreaseError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::QuotaExceededException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
