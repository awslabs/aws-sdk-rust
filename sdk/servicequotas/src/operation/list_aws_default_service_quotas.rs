...
impl ListAWSDefaultServiceQuotas {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "ListAWSDefaultServiceQuotas",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAWSDefaultServiceQuotas {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ListAWSDefaultServiceQuotasRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ListAWSDefaultServiceQuotasResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("ListAWSDefaultServiceQuotas")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAWSDefaultServiceQuotas")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ListAWSDefaultServiceQuotasTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct ListAWSDefaultServiceQuotasTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAWSDefaultServiceQuotasTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<ListAwsDefaultServiceQuotasInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAWSDefaultServiceQuotasResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_list_aws_default_service_quotas::de_list_aws_default_service_quotas_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_list_aws_default_service_quotas::de_list_aws_default_service_quotas_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAWSDefaultServiceQuotasRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_list_aws_default_service_quotas::ser_list_aws_default_service_quotas_input(&input)?,
        );
