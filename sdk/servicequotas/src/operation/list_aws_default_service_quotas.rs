...
impl ListAWSDefaultServiceQuotas {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListAWSDefaultServiceQuotas {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListAWSDefaultServiceQuotas");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListAWSDefaultServiceQuotasRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListAWSDefaultServiceQuotasResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListAWSDefaultServiceQuotas")
...
.with_interceptor(ListAWSDefaultServiceQuotasEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError>::new());
...
#[derive(Debug)]
            struct ListAWSDefaultServiceQuotasResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListAWSDefaultServiceQuotasResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                ...
                crate::protocol_serde::shape_list_aws_default_service_quotas::de_list_aws_default_service_quotas_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListAWSDefaultServiceQuotasRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListAWSDefaultServiceQuotasRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_aws_default_service_quotas::ListAwsDefaultServiceQuotasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_aws_default_service_quotas::ser_list_aws_default_service_quotas_input(&input)?);
...
#[derive(Debug)]
            struct ListAWSDefaultServiceQuotasEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListAWSDefaultServiceQuotasEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListAWSDefaultServiceQuotasEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListAwsDefaultServiceQuotasInput>()
                        .ok_or("failed to downcast to ListAwsDefaultServiceQuotasInput")?;
...
pub enum ListAWSDefaultServiceQuotasError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListAWSDefaultServiceQuotasError) for what information is available for the error.")]
...
impl ListAWSDefaultServiceQuotasError {
    /// Creates the `ListAWSDefaultServiceQuotasError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAWSDefaultServiceQuotasError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListAWSDefaultServiceQuotasError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_aws_default_service_quotas::ListAWSDefaultServiceQuotasError {
