...
impl GetAssociationForServiceQuotaTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_association_for_service_quota_template::GetAssociationForServiceQuotaTemplateInput, ::aws_smithy_types::error::operation::BuildError> {
