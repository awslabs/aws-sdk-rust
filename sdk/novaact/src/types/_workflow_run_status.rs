...
impl ::std::convert::From<&str> for WorkflowRunStatus {
    fn from(s: &str) -> Self {
        match s {
            "DELETING" => WorkflowRunStatus::Deleting,
...
impl WorkflowRunStatus {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            WorkflowRunStatus::Deleting => "DELETING",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["DELETING", "FAILED", "RUNNING", "SUCCEEDED", "TIMED_OUT"]
    }
}
...
impl ::std::fmt::Display for WorkflowRunStatus {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            WorkflowRunStatus::Deleting => write!(f, "DELETING"),
