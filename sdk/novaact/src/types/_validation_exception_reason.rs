...
///     ValidationExceptionReason::GuardrailIntervened => { /* ... */ },
...
impl ::std::convert::From<&str> for ValidationExceptionReason {
    fn from(s: &str) -> Self {
        match s {
            ...
            "GuardrailIntervened" => ValidationExceptionReason::GuardrailIntervened,
...
impl ValidationExceptionReason {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ValidationExceptionReason::GuardrailIntervened => "GuardrailIntervened",
    ...
    pub const fn values() -> &'static [&'static str] {
        &["FieldValidationFailed", "GuardrailIntervened", "InvalidStatus"]
    }
}
...
impl ::std::fmt::Display for ValidationExceptionReason {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ValidationExceptionReason::GuardrailIntervened => write!(f, "GuardrailIntervened"),
