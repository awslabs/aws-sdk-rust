...
pub fn de_list_workflow_runs_http_error(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
) -> std::result::Result<crate::operation::list_workflow_runs::ListWorkflowRunsOutput, crate::operation::list_workflow_runs::ListWorkflowRunsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::list_workflow_runs::ListWorkflowRunsError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => return Err(crate::operation::list_workflow_runs::ListWorkflowRunsError::unhandled(generic)),
    };
    ...
    Err(match error_code {
        ...
        "InternalServerException" => crate::operation::list_workflow_runs::ListWorkflowRunsError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
                    ...
                    match crate::protocol_serde::shape_internal_server_exception::de_retry_after_seconds_header(_response_headers) {
                        ...
                        ::std::result::Result::Err(err) => {
                                    ...
                                    == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                            {
                                ...
                                return ::std::result::Result::Err(crate::operation::list_workflow_runs::ListWorkflowRunsError::unhandled(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_workflow_runs_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
    _cfg: &::aws_smithy_types::config_bag::ConfigBag,
    ...
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_workflow_runs::builders::ListWorkflowRunsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_workflow_runs::de_list_workflow_runs(_response_body, output)
            .map_err(crate::operation::list_workflow_runs::ListWorkflowRunsError::unhandled)?;
        output._set_request_id(::aws_types::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        crate::serde_util::list_workflow_runs_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_workflow_runs::ListWorkflowRunsError::unhandled)?
    })
}

pub fn ser_list_workflow_runs_input(
    input: &crate::operation::list_workflow_runs::ListWorkflowRunsInput,
) -> ::std::result::Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_list_workflow_runs_input::ser_list_workflow_runs_input_input(&mut object, input)?;
    object.finish();
    Ok(::aws_smithy_types::body::SdkBody::from(out))
}

pub(crate) fn de_list_workflow_runs(
    _value: &[u8],
        ...
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "workflowRunSummaries" => {
                    builder = builder.set_workflow_run_summaries(crate::protocol_serde::shape_workflow_run_summaries::de_workflow_run_summaries(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
