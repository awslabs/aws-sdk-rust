...
pub(crate) fn reflens_list_accesses_output_output_next_token(
...
pub(crate) fn reflens_list_agreements_output_output_next_token(
...
pub(crate) fn reflens_list_security_policies_output_output_next_token(
...
pub(crate) fn reflens_list_servers_output_output_next_token(
...
pub(crate) fn reflens_list_web_apps_output_output_next_token(
    input: &crate::operation::list_web_apps::ListWebAppsOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_list_accesses_output_output_accesses(
    input: crate::operation::list_accesses::ListAccessesOutput,
...
pub(crate) fn lens_list_agreements_output_output_agreements(
    input: crate::operation::list_agreements::ListAgreementsOutput,
...
pub(crate) fn lens_list_security_policies_output_output_security_policy_names(
    input: crate::operation::list_security_policies::ListSecurityPoliciesOutput,
...
pub(crate) fn lens_list_servers_output_output_servers(
    input: crate::operation::list_servers::ListServersOutput,
...
pub(crate) fn lens_list_web_apps_output_output_web_apps(
    input: crate::operation::list_web_apps::ListWebAppsOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ListedWebApp>> {
    let input = input.web_apps;
    ::std::option::Option::Some(input)
}
