...
impl super::Client {
    ...
    ///   - [`profile_id(impl Into<String>)`](crate::operation::describe_profile::builders::DescribeProfileFluentBuilder::profile_id) / [`set_profile_id(Option<String>)`](crate::operation::describe_profile::builders::DescribeProfileFluentBuilder::set_profile_id):<br>required: **true**<br><p>The identifier of the profile that you want described.</p><br>
