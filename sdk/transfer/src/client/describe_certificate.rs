...
impl super::Client {
    ...
    ///   - [`certificate_id(impl ::std::convert::Into<String>)`](crate::operation::describe_certificate::builders::DescribeCertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::describe_certificate::builders::DescribeCertificateFluentBuilder::set_certificate_id): <p>An array of identifiers for the imported certificates. You use this identifier for working with profiles and partner profiles.</p>
