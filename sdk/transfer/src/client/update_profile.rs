...
impl super::Client {
    ...
    ///   - [`profile_id(impl ::std::convert::Into<String>)`](crate::operation::update_profile::builders::UpdateProfileFluentBuilder::profile_id) / [`set_profile_id(Option<String>)`](crate::operation::update_profile::builders::UpdateProfileFluentBuilder::set_profile_id): <p>The identifier of the profile object that you are updating.</p>
