...
impl super::Client {
    ...
    ///   - [`server_id(impl Into<String>)`](crate::operation::delete_server::builders::DeleteServerFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::delete_server::builders::DeleteServerFluentBuilder::set_server_id):<br>required: **true**<br><p>A unique system-assigned identifier for a server instance.</p><br>
