...
impl super::Client {
    ...
    ///   - [`server_id(impl ::std::convert::Into<String>)`](crate::operation::describe_host_key::builders::DescribeHostKeyFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::describe_host_key::builders::DescribeHostKeyFluentBuilder::set_server_id): <p>The identifier of the server that contains the host key that you want described.</p>
    ///   - [`host_key_id(impl ::std::convert::Into<String>)`](crate::operation::describe_host_key::builders::DescribeHostKeyFluentBuilder::host_key_id) / [`set_host_key_id(Option<String>)`](crate::operation::describe_host_key::builders::DescribeHostKeyFluentBuilder::set_host_key_id): <p>The identifier of the host key that you want described.</p>
