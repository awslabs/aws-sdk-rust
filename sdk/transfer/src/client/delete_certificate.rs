...
impl super::Client {
    ...
    ///   - [`certificate_id(impl Into<String>)`](crate::operation::delete_certificate::builders::DeleteCertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::delete_certificate::builders::DeleteCertificateFluentBuilder::set_certificate_id):<br>required: **true**<br><p>The identifier of the certificate object that you are deleting.</p><br>
