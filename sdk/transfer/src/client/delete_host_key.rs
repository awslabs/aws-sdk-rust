...
impl super::Client {
    ...
    ///   - [`server_id(impl ::std::convert::Into<String>)`](crate::operation::delete_host_key::builders::DeleteHostKeyFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::delete_host_key::builders::DeleteHostKeyFluentBuilder::set_server_id): <p>The identifier of the server that contains the host key that you are deleting.</p>
