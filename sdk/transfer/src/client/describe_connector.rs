...
impl super::Client {
    ...
    ///   - [`connector_id(impl Into<String>)`](crate::operation::describe_connector::builders::DescribeConnectorFluentBuilder::connector_id) / [`set_connector_id(Option<String>)`](crate::operation::describe_connector::builders::DescribeConnectorFluentBuilder::set_connector_id):<br>required: **true**<br><p>The unique identifier for the connector.</p><br>
