...
impl super::Client {
    ...
    ///   - [`sftp_connection_details(Option<SftpConnectorConnectionDetails>)`](crate::operation::test_connection::TestConnectionOutput::sftp_connection_details): <p>Structure that contains the SFTP connector host key.</p>
