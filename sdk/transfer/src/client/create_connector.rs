...
impl super::Client {
    ...
    ///   - [`url(impl ::std::convert::Into<String>)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::url) / [`set_url(Option<String>)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::set_url): <p>The URL of the partner's AS2 endpoint.</p>
    ///   - [`as2_config(As2ConnectorConfig)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::as2_config) / [`set_as2_config(Option<As2ConnectorConfig>)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::set_as2_config): <p>A structure that contains the parameters for a connector object.</p>
