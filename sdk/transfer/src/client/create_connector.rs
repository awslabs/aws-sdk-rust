...
impl super::Client {
    ...
    ///   - [`url(impl Into<String>)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::url) / [`set_url(Option<String>)`](crate::operation::create_connector::builders::CreateConnectorFluentBuilder::set_url): <p>The URL of the partner's AS2 endpoint.</p>
