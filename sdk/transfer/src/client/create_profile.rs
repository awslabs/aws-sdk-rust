...
impl super::Client {
    ...
    ///   - [`certificate_ids(impl Into<String>)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::certificate_ids) / [`set_certificate_ids(Option<Vec<String>>)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::set_certificate_ids): <p>An array of identifiers for the imported certificates. You use this identifier for working with profiles and partner profiles.</p>
    ///   - [`tags(Tag)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::tags) / [`set_tags(Option<Vec<Tag>>)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::set_tags): <p>Key-value pairs that can be used to group and search for AS2 profiles.</p>
