...
impl super::Client {
    ...
    ///   - [`agreement_id(impl Into<String>)`](crate::operation::describe_agreement::builders::DescribeAgreementFluentBuilder::agreement_id) / [`set_agreement_id(Option<String>)`](crate::operation::describe_agreement::builders::DescribeAgreementFluentBuilder::set_agreement_id):<br>required: **true**<br><p>A unique identifier for the agreement. This identifier is returned when you create an agreement.</p><br>
    ///   - [`server_id(impl Into<String>)`](crate::operation::describe_agreement::builders::DescribeAgreementFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::describe_agreement::builders::DescribeAgreementFluentBuilder::set_server_id):<br>required: **true**<br><p>The server identifier that's associated with the agreement.</p><br>
