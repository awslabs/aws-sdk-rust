...
impl super::Client {
    ...
    ///   - [`connector_id(impl Into<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::connector_id) / [`set_connector_id(Option<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_connector_id): <p>The unique identifier for the connector.</p>
    ///   - [`url(impl Into<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::url) / [`set_url(Option<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_url): <p>The URL of the partner's AS2 endpoint.</p>
