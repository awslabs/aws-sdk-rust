...
impl super::Client {
    ...
    ///   - [`url(impl ::std::convert::Into<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::url) / [`set_url(Option<String>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_url): <p>The URL of the partner's AS2 endpoint.</p>
    ///   - [`as2_config(As2ConnectorConfig)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::as2_config) / [`set_as2_config(Option<As2ConnectorConfig>)`](crate::operation::update_connector::builders::UpdateConnectorFluentBuilder::set_as2_config): <p>A structure that contains the parameters for a connector object.</p>
