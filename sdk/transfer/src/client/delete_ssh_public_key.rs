...
impl super::Client {
    ...
    ///   - [`server_id(impl ::std::convert::Into<String>)`](crate::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::delete_ssh_public_key::builders::DeleteSshPublicKeyFluentBuilder::set_server_id): <p>A system-assigned unique identifier for a file transfer protocol-enabled server instance that has the user assigned to it.</p>
