...
impl DescribeExecutionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_execution::ser_describe_execution_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExecution {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_execution::de_describe_execution_http_response_with_props(status, headers, body)
        }
    }
}
