...
impl ListAgreementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_agreements::ListAgreements, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_agreements::ser_list_agreements_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAgreements {
    type Output =
        ::std::result::Result<crate::operation::list_agreements::ListAgreementsOutput, crate::operation::list_agreements::ListAgreementsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_agreements::de_list_agreements_http_response_with_props(status, headers, body)
        }
    }
}
