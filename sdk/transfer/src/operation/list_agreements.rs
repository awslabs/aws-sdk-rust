...
impl ListAgreementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_agreements::ListAgreements,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_agreements::ListAgreements::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAgreements {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_agreements::de_list_agreements_http_error(
                status, headers, body,
            )
        } else {
