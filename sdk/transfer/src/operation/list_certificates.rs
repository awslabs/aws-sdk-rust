...
impl ListCertificatesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_certificates::ListCertificates, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_certificates::ser_list_certificates_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCertificates {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_certificates::de_list_certificates_http_response_with_props(status, headers, body)
        }
    }
}
