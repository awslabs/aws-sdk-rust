...
impl DescribeServerInput {
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_server::DescribeServer::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeServer {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_server::de_describe_server_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_server::de_describe_server_http_response(
                status, headers, body,
            )
        }
    }
