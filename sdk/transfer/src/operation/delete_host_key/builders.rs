...
impl DeleteHostKeyFluentBuilder  {
    /// Creates a new `DeleteHostKey`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_host_key::DeleteHostKeyOutput, aws_smithy_http::result::SdkError<crate::operation::delete_host_key::DeleteHostKeyError>>
                     {
