...
pub use crate::operation::delete_host_key::_delete_host_key_output::DeleteHostKeyOutputBuilder;
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_host_key::DeleteHostKeyOutput,
                    crate::operation::delete_host_key::DeleteHostKeyError,
                > for DeleteHostKeyFluentBuilder
            {
                fn send(
                    self,
...
impl DeleteHostKeyFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_host_key::builders::DeleteHostKeyInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_host_key::DeleteHostKeyOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_host_key::DeleteHostKeyError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_host_key::DeleteHostKey::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_host_key::DeleteHostKey::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_host_key::DeleteHostKeyOutput, crate::operation::delete_host_key::DeleteHostKeyError, Self> {
