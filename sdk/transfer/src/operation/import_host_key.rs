...
impl ImportHostKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::import_host_key::ImportHostKey,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_host_key::ImportHostKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportHostKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_host_key::de_import_host_key_http_error(
                status, headers, body,
            )
        } else {
