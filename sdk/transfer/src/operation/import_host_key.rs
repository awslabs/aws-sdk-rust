...
impl ImportHostKeyInput {
    /// Consumes the builder and constructs an Operation<[`ImportHostKey`](crate::operation::import_host_key::ImportHostKey)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::import_host_key::ImportHostKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_host_key::ser_import_host_key_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_host_key::ImportHostKey::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportHostKey {
    type Output =
        ::std::result::Result<crate::operation::import_host_key::ImportHostKeyOutput, crate::operation::import_host_key::ImportHostKeyError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_host_key::de_import_host_key_http_response_with_props(status, headers, body)
        }
    }
}
