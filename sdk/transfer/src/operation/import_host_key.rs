...
impl ImportHostKeyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::import_host_key::ImportHostKey, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_host_key::ImportHostKeyInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for ImportHostKey {
                type Output = std::result::Result<crate::operation::import_host_key::ImportHostKeyOutput, crate::operation::import_host_key::ImportHostKeyError>;
