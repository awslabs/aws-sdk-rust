...
impl UpdateAccessFluentBuilder  {
    /// Creates a new `UpdateAccess`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::update_access::UpdateAccessOutput, aws_smithy_http::result::SdkError<crate::operation::update_access::UpdateAccessError>>
                     {
