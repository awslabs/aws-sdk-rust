...
impl TestConnectionInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_connection::ser_test_connection_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::test_connection::TestConnection::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestConnection {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_test_connection::de_test_connection_http_error(
                status, headers, body,
            )
        } else {
