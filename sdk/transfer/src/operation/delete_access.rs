...
impl DeleteAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_access::DeleteAccess, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_access::ser_delete_access_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_access::de_delete_access_http_response_with_props(status, headers, body)
        }
    }
}
