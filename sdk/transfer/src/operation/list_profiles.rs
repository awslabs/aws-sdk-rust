...
impl ListProfilesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_profiles::ListProfiles::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProfiles {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_profiles::de_list_profiles_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_profiles::de_list_profiles_http_response_with_props(
                status, headers, body,
            )
        }
    }
