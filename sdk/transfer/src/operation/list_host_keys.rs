...
impl ListHostKeysInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_host_keys::ListHostKeys, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_host_keys::ser_list_host_keys_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHostKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_host_keys::de_list_host_keys_http_response_with_props(status, headers, body)
        }
    }
}
