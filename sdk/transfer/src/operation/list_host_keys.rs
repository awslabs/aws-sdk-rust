...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHostKeys {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_host_keys::de_list_host_keys_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_host_keys::de_list_host_keys_http_response_with_props(
                status, headers, body,
            )
        }
    }
