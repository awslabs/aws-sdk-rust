...
impl DescribeAgreementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_agreement::DescribeAgreement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgreement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_agreement::de_describe_agreement_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_agreement::DescribeAgreementError
{
