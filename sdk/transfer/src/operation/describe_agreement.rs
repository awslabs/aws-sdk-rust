...
impl DescribeAgreementInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_agreement::ser_describe_agreement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgreement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_agreement::de_describe_agreement_http_response_with_props(status, headers, body)
        }
    }
}
