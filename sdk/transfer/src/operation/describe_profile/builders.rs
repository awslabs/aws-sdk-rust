...
impl DescribeProfileFluentBuilder  {
    /// Creates a new `DescribeProfile`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::describe_profile::DescribeProfileOutput, aws_smithy_http::result::SdkError<crate::operation::describe_profile::DescribeProfileError>>
                     {
