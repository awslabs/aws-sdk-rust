...
impl ImportSshPublicKeyInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::import_ssh_public_key::ImportSshPublicKey::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportSshPublicKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_import_ssh_public_key::de_import_ssh_public_key_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::import_ssh_public_key::ImportSshPublicKeyError
{
