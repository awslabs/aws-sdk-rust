...
impl CreateAgreementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_agreement::CreateAgreement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_agreement::ser_create_agreement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAgreement {
    type Output =
        ::std::result::Result<crate::operation::create_agreement::CreateAgreementOutput, crate::operation::create_agreement::CreateAgreementError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_agreement::de_create_agreement_http_response_with_props(status, headers, body)
        }
    }
}
