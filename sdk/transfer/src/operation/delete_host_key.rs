...
impl DeleteHostKeyInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_host_key::DeleteHostKey, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_host_key::ser_delete_host_key_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteHostKey {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_host_key::de_delete_host_key_http_response_with_props(status, headers, body)
        }
    }
}
