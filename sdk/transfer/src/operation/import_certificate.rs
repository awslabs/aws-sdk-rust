...
impl ImportCertificateInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_import_certificate::ser_import_certificate_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportCertificate {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_import_certificate::de_import_certificate_http_response_with_props(status, headers, body)
        }
    }
}
