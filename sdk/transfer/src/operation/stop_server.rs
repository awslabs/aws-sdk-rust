...
impl StopServerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_server::StopServer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_stop_server::de_stop_server_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_stop_server::de_stop_server_http_response_with_props(
                status, headers, body,
            )
        }
    }
