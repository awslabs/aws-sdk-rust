...
impl StopServerInput {
    /// Consumes the builder and constructs an Operation<[`StopServer`](crate::operation::stop_server::StopServer)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::stop_server::StopServer, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_stop_server::ser_stop_server_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_server::StopServer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopServer {
    type Output = ::std::result::Result<crate::operation::stop_server::StopServerOutput, crate::operation::stop_server::StopServerError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_server::de_stop_server_http_response_with_props(status, headers, body)
        }
    }
}
