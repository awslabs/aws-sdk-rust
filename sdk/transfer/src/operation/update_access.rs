...
impl UpdateAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_access::UpdateAccess, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_access::ser_update_access_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_access::de_update_access_http_response_with_props(status, headers, body)
        }
    }
}
