...
impl UpdateAccessInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::update_access::UpdateAccess,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_access::UpdateAccess::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccess {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_access::de_update_access_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_access::de_update_access_http_response_with_props(
                status, headers, body,
            )
        }
    }
