...
impl StartServerInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_server::StartServer::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartServer {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_start_server::de_start_server_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_start_server::de_start_server_http_response_with_props(
                status, headers, body,
            )
        }
    }
