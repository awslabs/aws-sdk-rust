...
impl  ListSecurityPoliciesOutput  {
    ...
    pub fn security_policy_names(&self) -> & [::std::string::String] {
        use std::ops::Deref; self.security_policy_names.deref()
    }
}
...
impl ListSecurityPoliciesOutputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_security_policies::ListSecurityPoliciesOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_security_policies::ListSecurityPoliciesOutput {
                ...
                security_policy_names: self.security_policy_names
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("security_policy_names", "security_policy_names was not specified but it is required when building ListSecurityPoliciesOutput")
                    )?
                ,
