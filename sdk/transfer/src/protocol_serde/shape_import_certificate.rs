...
pub fn de_import_certificate_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::import_certificate::ImportCertificateOutput, crate::operation::import_certificate::ImportCertificateError>
{
    #[allow(unused_mut)]
...
) -> std::result::Result<crate::operation::import_certificate::ImportCertificateOutput, crate::operation::import_certificate::ImportCertificateError>
{
    Ok({
        ...
        crate::serde_util::import_certificate_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::import_certificate::ImportCertificateError::unhandled)?
    })
}
...
) -> Result<crate::operation::import_certificate::builders::ImportCertificateOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
