...
pub fn ser_create_agreement_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAgreementInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
