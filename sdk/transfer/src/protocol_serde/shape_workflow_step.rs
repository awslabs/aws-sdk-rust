...
pub fn ser_workflow_step(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::WorkflowStep) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_workflow_step<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::WorkflowStep>, aws_smithy_json::deserialize::error::DeserializeError>
