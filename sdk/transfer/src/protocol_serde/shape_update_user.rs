...
pub fn de_update_user_http_response(
    ...
    Ok({
        ...
        crate::serde_util::update_user_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::update_user::UpdateUserError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::update_user::builders::UpdateUserOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
