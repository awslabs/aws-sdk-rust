...
pub fn ser_send_workflow_step_state_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::SendWorkflowStepStateInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
