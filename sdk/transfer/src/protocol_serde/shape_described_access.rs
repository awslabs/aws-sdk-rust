...
pub(crate) fn de_described_access<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DescribedAccess>, aws_smithy_json::deserialize::error::DeserializeError>
