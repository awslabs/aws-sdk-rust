...
pub(crate) fn de_described_user<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DescribedUser>, aws_smithy_json::deserialize::error::DeserializeError>
