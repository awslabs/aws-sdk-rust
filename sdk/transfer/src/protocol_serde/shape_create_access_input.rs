...
pub fn ser_create_access_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateAccessInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
