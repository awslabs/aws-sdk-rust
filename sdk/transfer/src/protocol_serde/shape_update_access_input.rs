...
pub fn ser_update_access_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_access::UpdateAccessInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
