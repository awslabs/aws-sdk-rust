...
pub(crate) fn de_listed_user<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ListedUser>, aws_smithy_json::deserialize::error::DeserializeError>
