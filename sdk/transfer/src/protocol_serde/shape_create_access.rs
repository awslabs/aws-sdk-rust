...
pub fn de_create_access_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::create_access::CreateAccessOutput, crate::operation::create_access::CreateAccessError> {
    #[allow(unused_mut)]
...
pub fn de_create_access_http_response(
    ...
    Ok({
        ...
        crate::serde_util::create_access_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::create_access::CreateAccessError::unhandled)?
    })
}
...
) -> Result<crate::operation::create_access::builders::CreateAccessOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
