                    ...
                    variant = match key.as_ref() {
                            "VpcLattice" => {
                                Some(crate::types::DescribedConnectorEgressConfig::VpcLattice(
                                    crate::protocol_serde::shape_described_connector_vpc_lattice_egress_config::de_described_connector_vpc_lattice_egress_config(tokens)?
                                    .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'VpcLattice' cannot be null"))?
                                ))
                            }
                            _ => {
                                                                              ::aws_smithy_json::deserialize::token::skip_value(tokens)?;
                                                                              Some(crate::types::DescribedConnectorEgressConfig::Unknown)
                                                                            }
                        };
                }
                other => {
