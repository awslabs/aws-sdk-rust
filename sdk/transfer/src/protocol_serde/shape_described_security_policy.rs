...
pub(crate) fn de_described_security_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DescribedSecurityPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
