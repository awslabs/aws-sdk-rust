                        ...
                        match key.to_unescaped()?.as_ref() {
                            "S3FileLocation" => {
                                builder = builder.set_s3_file_location(
                                    crate::protocol_serde::shape_s3_input_file_location::de_s3_input_file_location(tokens, _value, depth + 1)?,
                                );
                            }
                            "EfsFileLocation" => {
                                builder = builder.set_efs_file_location(crate::protocol_serde::shape_efs_file_location::de_efs_file_location(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
