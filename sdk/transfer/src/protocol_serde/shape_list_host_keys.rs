...
pub fn de_list_host_keys_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_host_keys::ListHostKeysOutput, crate::operation::list_host_keys::ListHostKeysError> {
    #[allow(unused_mut)]
...
pub fn de_list_host_keys_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_host_keys_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_host_keys::ListHostKeysError::unhandled)?
    })
}
...
) -> Result<crate::operation::list_host_keys::builders::ListHostKeysOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
