...
pub(crate) fn de_as2_connector_config<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::As2ConnectorConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AsyncMdnConfig" => {
                            builder = builder.set_async_mdn_config(
                                crate::protocol_serde::shape_as2_async_mdn_connector_config::de_as2_async_mdn_connector_config(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
