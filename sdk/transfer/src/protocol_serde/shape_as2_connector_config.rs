...
pub fn ser_as2_connector_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::As2ConnectorConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_as2_connector_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::As2ConnectorConfig>, aws_smithy_json::deserialize::error::DeserializeError>
