...
pub(crate) fn de_described_server<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::DescribedServer>, aws_smithy_json::deserialize::error::DeserializeError>
