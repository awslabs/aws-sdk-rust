...
) -> Result<Option<crate::types::DescribedServer>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>>,
{
    match tokens.next().transpose()? {
        ...
        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ProtocolDetails" => {
                            builder = builder.set_protocol_details(crate::protocol_serde::shape_protocol_details::de_protocol_details(tokens)?);
                        }
                        "Domain" => {
                        ...
                        "EndpointDetails" => {
                            builder = builder.set_endpoint_details(crate::protocol_serde::shape_endpoint_details::de_endpoint_details(tokens)?);
                        }
                        "EndpointType" => {
                        ...
                        "WorkflowDetails" => {
                            builder = builder.set_workflow_details(crate::protocol_serde::shape_workflow_details::de_workflow_details(tokens)?);
                        }
            ...
            Ok(Some(crate::serde_util::described_server_correct_errors(builder).build().map_err(
