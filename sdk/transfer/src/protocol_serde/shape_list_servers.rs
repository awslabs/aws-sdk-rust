...
pub fn de_list_servers_http_error(
    ...
    _response_body: &[u8],
) -> std::result::Result<crate::operation::list_servers::ListServersOutput, crate::operation::list_servers::ListServersError> {
    #[allow(unused_mut)]
...
pub fn de_list_servers_http_response(
    ...
    Ok({
        ...
        crate::serde_util::list_servers_output_output_correct_errors(output)
            .build()
            .map_err(crate::operation::list_servers::ListServersError::unhandled)?
    })
}
...
) -> ::std::result::Result<crate::operation::list_servers::builders::ListServersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "Servers" => {
                    builder = builder.set_servers(crate::protocol_serde::shape_listed_servers::de_listed_servers(tokens, _value, depth + 1)?);
                }
