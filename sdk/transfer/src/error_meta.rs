...
impl<R>
    From<
        ::aws_smithy_http::result::SdkError<crate::operation::list_host_keys::ListHostKeysError, R>,
    > for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::list_servers::ListServersError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl<R>
    From<::aws_smithy_http::result::SdkError<crate::operation::start_server::StartServerError, R>>
    for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::test_connection::TestConnectionError> for Error {
    fn from(err: crate::operation::test_connection::TestConnectionError) -> Self {
        match err {
            crate::operation::test_connection::TestConnectionError::InternalServiceError(inner) => {
                Error::InternalServiceError(inner)
            }
            crate::operation::test_connection::TestConnectionError::InvalidRequestException(
                inner,
            ) => Error::InvalidRequestException(inner),
            crate::operation::test_connection::TestConnectionError::ResourceNotFoundException(
                inner,
            ) => Error::ResourceNotFoundException(inner),
            crate::operation::test_connection::TestConnectionError::ServiceUnavailableException(
                inner,
            ) => Error::ServiceUnavailableException(inner),
            crate::operation::test_connection::TestConnectionError::Unhandled(inner) => {
                Error::Unhandled(inner)
            }
        }
    }
