...
pub struct PosixProfile  {
    ...
    #[doc(hidden)]pub uid: std::option::Option<i64>,
    /// <p>The POSIX group ID used for all EFS operations by this user.</p>
    #[doc(hidden)]pub gid: std::option::Option<i64>,
    /// <p>The secondary POSIX group IDs used for all EFS operations by this user.</p>
    #[doc(hidden)]pub secondary_gids: std::option::Option<std::vec::Vec<i64>>,
}
impl PosixProfile {
    /// <p>The POSIX user ID used for all EFS operations by this user.</p>
...
pub struct HomeDirectoryMapEntry  {
    ...
    #[doc(hidden)]pub entry: std::option::Option<std::string::String>,
...
pub struct WorkflowDetails  {
    ...
    #[doc(hidden)]pub on_upload: std::option::Option<std::vec::Vec<crate::model::WorkflowDetail>>,
}
...
pub struct WorkflowDetail  {
    ...
    #[doc(hidden)]pub execution_role: std::option::Option<std::string::String>,
}
impl WorkflowDetail {
    /// <p>A unique identifier for the workflow.</p>
...
pub struct IdentityProviderDetails  {
    ...
    #[doc(hidden)]pub invocation_role: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub function: std::option::Option<std::string::String>,
}
...
pub struct EndpointDetails  {
    ...
    /// </note>
    #[doc(hidden)]pub address_allocation_ids: std::option::Option<std::vec::Vec<std::string::String>>,
...
pub struct ProtocolDetails  {
    ...
    /// </note>
    #[doc(hidden)]pub passive_ip: std::option::Option<std::string::String>,
    ...
    /// </note> </li> 
    /// </ul>
    #[doc(hidden)]pub tls_session_resumption_mode: std::option::Option<crate::model::TlsSessionResumptionMode>,
    ...
    /// </note>
    #[doc(hidden)]pub set_stat_option: std::option::Option<crate::model::SetStatOption>,
    /// <p>Indicates the transport method for the AS2 messages. Currently, only HTTP is supported.</p>
    #[doc(hidden)]pub as2_transports: std::option::Option<std::vec::Vec<crate::model::As2Transport>>,
}
...
impl  std::fmt::Debug for ProtocolDetails  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("tls_session_resumption_mode", &self.tls_session_resumption_mode);
...
pub struct As2ConnectorConfig  {
    ...
    #[doc(hidden)]pub message_subject: std::option::Option<std::string::String>,
    /// <p>Specifies whether the AS2 file is compressed.</p>
    #[doc(hidden)]pub compression: std::option::Option<crate::model::CompressionEnum>,
    /// <p>The algorithm that is used to encrypt the file.</p>
    #[doc(hidden)]pub encryption_algorithm: std::option::Option<crate::model::EncryptionAlg>,
    /// <p>The algorithm that is used to sign the AS2 messages sent with the connector.</p>
    #[doc(hidden)]pub signing_algorithm: std::option::Option<crate::model::SigningAlg>,
    ...
    /// </note>
    #[doc(hidden)]pub mdn_signing_algorithm: std::option::Option<crate::model::MdnSigningAlg>,
    ...
    /// </ul>
    #[doc(hidden)]pub mdn_response: std::option::Option<crate::model::MdnResponse>,
}
...
pub struct ListedUser  {
    ...
    #[doc(hidden)]pub ssh_public_key_count: std::option::Option<i32>,
...
pub struct ListedServer  {
    ...
    #[doc(hidden)]pub user_count: std::option::Option<i32>,
}
impl ListedServer {
    /// <p>Specifies the unique Amazon Resource Name (ARN) for a server to be listed.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct ListedHostKey  {
    ...
    #[doc(hidden)]pub fingerprint: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub date_imported: std::option::Option<aws_smithy_types::DateTime>,
}
impl ListedHostKey {
    /// <p>Specifies the unique Amazon Resource Name (ARN) of the host key.</p>
    pub fn arn(&self) -> std::option::Option<& str> {
...
pub struct ListedExecution  {
    ...
    #[doc(hidden)]pub initial_file_location: std::option::Option<crate::model::FileLocation>,
    /// <p>A container object for the session details that are associated with a workflow.</p>
    #[doc(hidden)]pub service_metadata: std::option::Option<crate::model::ServiceMetadata>,
    /// <p>The status is one of the execution. Can be in progress, completed, exception encountered, or handling the exception.</p>
    #[doc(hidden)]pub status: std::option::Option<crate::model::ExecutionStatus>,
}
...
pub struct FileLocation  {
    ...
    #[doc(hidden)]pub s3_file_location: std::option::Option<crate::model::S3FileLocation>,
    /// <p>Specifies the Amazon EFS ID and the path for the file being used.</p>
    #[doc(hidden)]pub efs_file_location: std::option::Option<crate::model::EfsFileLocation>,
}
impl FileLocation {
    /// <p>Specifies the S3 details for the file being used, such as bucket, ETag, and so forth.</p>
...
pub struct S3FileLocation  {
    ...
    #[doc(hidden)]pub etag: std::option::Option<std::string::String>,
}
impl S3FileLocation {
    /// <p>Specifies the S3 bucket that contains the file being used.</p>
...
pub struct ListedCertificate  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::CertificateStatusType>,
...
pub struct WorkflowStep  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::WorkflowStepType>,
    ...
    /// </ul>
    #[doc(hidden)]pub copy_step_details: std::option::Option<crate::model::CopyStepDetails>,
    ...
    #[doc(hidden)]pub custom_step_details: std::option::Option<crate::model::CustomStepDetails>,
    /// <p>Details for a step that deletes the file.</p>
    #[doc(hidden)]pub delete_step_details: std::option::Option<crate::model::DeleteStepDetails>,
    /// <p>Details for a step that creates one or more tags.</p> 
    /// <p>You specify one or more tags: each tag contains a key/value pair.</p>
    #[doc(hidden)]pub tag_step_details: std::option::Option<crate::model::TagStepDetails>,
}
impl WorkflowStep {
    /// <p> Currently, the following step types are supported. </p> 
    /// <ul> 
...
pub struct TagStepDetails  {
    ...
    /// </ul>
    #[doc(hidden)]pub source_file_location: std::option::Option<std::string::String>,
}
impl TagStepDetails {
    /// <p>The name of the step, used as an identifier.</p>
...
pub struct CustomStepDetails  {
    ...
    #[doc(hidden)]pub timeout_seconds: std::option::Option<i32>,
    /// <p>Specifies which file to use as input to the workflow step: either the output from the previous step, or the originally uploaded file for the workflow.</p> 
    /// <ul> 
    /// <li> <p>Enter <code>${previous.file}</code> to use the previous file as the input. In this case, this workflow step uses the output file from the previous workflow step as input. This is the default value.</p> </li> 
    /// <li> <p>Enter <code>${original.file}</code> to use the originally-uploaded file location as input for this step.</p> </li> 
...
pub struct CopyStepDetails  {
    ...
    #[doc(hidden)]pub destination_file_location: std::option::Option<crate::model::InputFileLocation>,
    /// <p>A flag that indicates whether or not to overwrite an existing file of the same name. The default is <code>FALSE</code>.</p>
    #[doc(hidden)]pub overwrite_existing: std::option::Option<crate::model::OverwriteExisting>,
    /// <p>Specifies which file to use as input to the workflow step: either the output from the previous step, or the originally uploaded file for the workflow.</p> 
    /// <ul> 
    /// <li> <p>Enter <code>${previous.file}</code> to use the previous file as the input. In this case, this workflow step uses the output file from the previous workflow step as input. This is the default value.</p> </li> 
    /// <li> <p>Enter <code>${original.file}</code> to use the originally-uploaded file location as input for this step.</p> </li> 
...
pub struct InputFileLocation  {
    ...
    #[doc(hidden)]pub s3_file_location: std::option::Option<crate::model::S3InputFileLocation>,
    /// <p>Reserved for future use.</p>
    #[doc(hidden)]pub efs_file_location: std::option::Option<crate::model::EfsFileLocation>,
}
...
pub struct DescribedUser  {
    ...
    #[doc(hidden)]pub ssh_public_keys: std::option::Option<std::vec::Vec<crate::model::SshPublicKey>>,
...
pub struct DescribedServer  {
    ...
    #[doc(hidden)]pub host_key_fingerprint: std::option::Option<std::string::String>,
...
pub struct DescribedSecurityPolicy  {
    ...
    #[doc(hidden)]pub fips: std::option::Option<bool>,
    /// <p>Specifies the name of the security policy that is attached to the server.</p>
    #[doc(hidden)]pub security_policy_name: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub ssh_ciphers: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub ssh_kexs: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub ssh_macs: std::option::Option<std::vec::Vec<std::string::String>>,
    ...
    #[doc(hidden)]pub tls_ciphers: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
pub struct DescribedExecution  {
    ...
    #[doc(hidden)]pub results: std::option::Option<crate::model::ExecutionResults>,
}
...
pub struct ExecutionResults  {
    /// <p>Specifies the details for the steps that are in the specified workflow.</p>
    #[doc(hidden)]pub steps: std::option::Option<std::vec::Vec<crate::model::ExecutionStepResult>>,
    /// <p>Specifies the steps (actions) to take if errors are encountered during execution of the workflow.</p>
    #[doc(hidden)]pub on_exception_steps: std::option::Option<std::vec::Vec<crate::model::ExecutionStepResult>>,
}
...
pub struct ExecutionError  {
    ...
    /// </ul>
    #[doc(hidden)]pub r#type: std::option::Option<crate::model::ExecutionErrorType>,
...
pub struct DescribedCertificate  {
    ...
    #[doc(hidden)]pub serial: std::option::Option<std::string::String>,
    /// <p>The earliest date that the certificate is valid.</p>
    #[doc(hidden)]pub not_before_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The final date that the certificate is valid.</p>
    #[doc(hidden)]pub not_after_date: std::option::Option<aws_smithy_types::DateTime>,
