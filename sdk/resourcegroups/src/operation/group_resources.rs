...
impl GroupResourcesInput {
    /// Consumes the builder and constructs an Operation<[`GroupResources`](crate::operation::group_resources::GroupResources)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::group_resources::GroupResources, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_group_resources::ser_group_resources_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::group_resources::GroupResources::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GroupResources {
    type Output =
        ::std::result::Result<crate::operation::group_resources::GroupResourcesOutput, crate::operation::group_resources::GroupResourcesError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_group_resources::de_group_resources_http_response_with_props(status, headers, body)
        }
    }
}
