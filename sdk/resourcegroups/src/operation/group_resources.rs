...
impl GroupResourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::group_resources::GroupResources,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::group_resources::GroupResources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GroupResources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_group_resources::de_group_resources_http_error(
                status, headers, body,
            )
        } else {
