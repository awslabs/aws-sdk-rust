...
impl UngroupResourcesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::ungroup_resources::UngroupResourcesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::ungroup_resources::UngroupResourcesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::ungroup_resources::UngroupResourcesOutput, crate::operation::ungroup_resources::UngroupResourcesError, Self> {
