...
impl GetGroupQueryInput {
    /// Consumes the builder and constructs an Operation<[`GetGroupQuery`](crate::operation::get_group_query::GetGroupQuery)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_group_query::GetGroupQuery, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_group_query::ser_get_group_query_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_group_query::GetGroupQuery::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupQuery {
    type Output =
        ::std::result::Result<crate::operation::get_group_query::GetGroupQueryOutput, crate::operation::get_group_query::GetGroupQueryError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_group_query::de_get_group_query_http_response_with_props(status, headers, body)
        }
    }
}
