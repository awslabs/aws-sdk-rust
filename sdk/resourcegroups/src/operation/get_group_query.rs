...
impl GetGroupQueryInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_group_query::GetGroupQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_group_query::GetGroupQueryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
...
impl aws_smithy_http::response::ParseStrictResponse for GetGroupQuery {
                type Output = std::result::Result<crate::operation::get_group_query::GetGroupQueryOutput, crate::operation::get_group_query::GetGroupQueryError>;
