...
impl GetGroupQueryInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::get_group_query::GetGroupQuery,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_group_query::GetGroupQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_group_query::de_get_group_query_http_error(
                status, headers, body,
            )
        } else {
