...
impl UngroupResourcesInput {
    /// Consumes the builder and constructs an Operation<[`UngroupResources`](crate::operation::ungroup_resources::UngroupResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ungroup_resources::UngroupResources, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::ungroup_resources::UngroupResourcesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ungroup_resources::UngroupResources::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UngroupResources {
                type Output = std::result::Result<crate::operation::ungroup_resources::UngroupResourcesOutput, crate::operation::ungroup_resources::UngroupResourcesError>;
