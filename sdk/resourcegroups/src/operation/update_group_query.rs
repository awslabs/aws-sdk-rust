...
impl UpdateGroupQueryInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_group_query::UpdateGroupQuery::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGroupQuery {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_group_query::de_update_group_query_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_group_query::UpdateGroupQueryError
{
