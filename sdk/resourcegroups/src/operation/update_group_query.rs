...
impl UpdateGroupQueryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGroupQuery`](crate::operation::update_group_query::UpdateGroupQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_group_query::UpdateGroupQuery, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_group_query::UpdateGroupQueryInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_group_query::UpdateGroupQuery::new())
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateGroupQuery {
                type Output = std::result::Result<crate::operation::update_group_query::UpdateGroupQueryOutput, crate::operation::update_group_query::UpdateGroupQueryError>;
