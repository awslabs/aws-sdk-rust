...
impl TagInput {
    ...
    > {
        ...
        let op =
            aws_smithy_http::operation::Operation::new(request, crate::operation::tag::Tag::new())
...
impl aws_smithy_http::response::ParseStrictResponse for Tag {
    type Output =
        std::result::Result<crate::operation::tag::TagOutput, crate::operation::tag::TagError>;
