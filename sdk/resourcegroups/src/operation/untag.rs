...
impl UntagInput {
    /// Consumes the builder and constructs an Operation<[`Untag`](crate::operation::untag::Untag)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::untag::Untag, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_untag::ser_untag_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag::Untag::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for Untag {
    type Output = ::std::result::Result<crate::operation::untag::UntagOutput, crate::operation::untag::UntagError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_untag::de_untag_http_response_with_props(status, headers, body)
        }
    }
}
