...
pub fn ser_list_group_resources_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListGroupResourcesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
