...
pub(crate) fn reflens_list_group_resources_output_output_next_token(
...
pub(crate) fn lens_list_group_resources_output_output_resource_identifiers(
    input: crate::operation::list_group_resources::ListGroupResourcesOutput,
...
pub(crate) fn lens_list_grouping_statuses_output_output_grouping_statuses(
    ...
    let input = input.grouping_statuses?;
    ::std::option::Option::Some(input)
}
...
pub(crate) fn lens_list_groups_output_output_group_identifiers(
    ...
    let input = input.group_identifiers?;
    ::std::option::Option::Some(input)
}
...
pub(crate) fn lens_list_tag_sync_tasks_output_output_tag_sync_tasks(
    ...
    let input = input.tag_sync_tasks?;
    ::std::option::Option::Some(input)
}

pub(crate) fn lens_search_resources_output_output_resource_identifiers(
    input: crate::operation::search_resources::SearchResourcesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ResourceIdentifier>> {
    let input = input.resource_identifiers?;
    ::std::option::Option::Some(input)
