...
pub(crate) fn lens_list_group_resources_output_resource_identifiers(
    input: crate::operation::list_group_resources::ListGroupResourcesOutput,
...
pub(crate) fn lens_list_groups_output_group_identifiers(
    input: crate::operation::list_groups::ListGroupsOutput,
...
pub(crate) fn lens_search_resources_output_resource_identifiers(
    input: crate::operation::search_resources::SearchResourcesOutput,
) -> ::std::option::Option<::std::vec::Vec<crate::types::ResourceIdentifier>> {
    let input = match input.resource_identifiers {
        ::std::option::Option::None => return ::std::option::Option::None,
