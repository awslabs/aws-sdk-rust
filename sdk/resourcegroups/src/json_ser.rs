...
pub fn serialize_structure_crate_input_update_account_settings_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateAccountSettingsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_56) = &input.group_lifecycle_events_desired_status {
        object.key("GroupLifecycleEventsDesiredStatus").string(var_56.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_group_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGroupInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_58) = &input.group {
        object.key("Group").string(var_58.as_str());
    }
    if let Some(var_59) = &input.group_name {
        object.key("GroupName").string(var_59.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_input_update_group_query_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdateGroupQueryInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if let Some(var_60) = &input.group {
        object.key("Group").string(var_60.as_str());
    }
    if let Some(var_61) = &input.group_name {
        object.key("GroupName").string(var_61.as_str());
    }
    if let Some(var_62) = &input.resource_query {
        #[allow(unused_mut)]
        let mut object_63 = object.key("ResourceQuery").start_object();
        crate::json_ser::serialize_structure_crate_model_resource_query(&mut object_63, var_62)?;
        object_63.finish();
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_group_configuration_item(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GroupConfigurationItem) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_65) = &input.parameters {
        let mut array_66 = object.key("Parameters").start_array();
        for item_67 in var_65 {
             {
                #[allow(unused_mut)]
                let mut object_68 = array_66.value().start_object();
                crate::json_ser::serialize_structure_crate_model_group_configuration_parameter(&mut object_68, item_67)?;
                object_68.finish();
            }
        }
        array_66.finish();
...
pub fn serialize_structure_crate_model_resource_query(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceQuery) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_70) = &input.query {
        object.key("Query").string(var_70.as_str());
    }
    Ok(())
}
...
pub fn serialize_structure_crate_model_group_filter(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GroupFilter) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_76) = &input.values {
        let mut array_77 = object.key("Values").start_array();
