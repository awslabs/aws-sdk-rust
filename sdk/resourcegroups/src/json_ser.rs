...
pub fn serialize_structure_create_group_input(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::json_ser::serialize_structure_group_configuration_item(
                    &mut object_4,
                    item_3,
                );
                object_4.finish();
    ...
    if let Some(var_7) = &input.resource_query {
        ...
        crate::json_ser::serialize_structure_resource_query(&mut object_8, var_7);
        object_8.finish();
    }
...
pub fn serialize_structure_get_group_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_get_group_query_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_group_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_group_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_26 in var_24 {
            {
                ...
                crate::json_ser::serialize_structure_resource_filter(&mut object_27, item_26);
                object_27.finish();
            }
        }
        array_25.finish();
        ...
        for item_34 in var_32 {
            {
                ...
                crate::json_ser::serialize_structure_group_filter(&mut object_35, item_34);
                object_35.finish();
            }
        }
        array_33.finish();
...
pub fn serialize_structure_put_group_configuration_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_search_resources_input(
    ...
    if let Some(var_43) = &input.resource_query {
        ...
        crate::json_ser::serialize_structure_resource_query(&mut object_44, var_43);
        object_44.finish();
    }
}

pub fn serialize_structure_tag_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_ungroup_resources_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_untag_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_update_group_query_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_61) = &input.resource_query {
        ...
        crate::json_ser::serialize_structure_resource_query(&mut object_62, var_61);
        object_62.finish();
    }
}

pub fn serialize_structure_group_configuration_item(
    object: &mut smithy_json::serialize::JsonObjectWriter,
        ...
        for item_66 in var_64 {
            {
                ...
                crate::json_ser::serialize_structure_group_configuration_parameter(
                    &mut object_67,
                    item_66,
                );
                object_67.finish();
...
pub fn serialize_structure_resource_query(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_resource_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_group_filter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_group_configuration_parameter(
    object: &mut smithy_json::serialize::JsonObjectWriter,
