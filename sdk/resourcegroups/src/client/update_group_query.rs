...
impl super::Client {
    ...
    ///   - [`group_name(impl Into<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::set_group_name):<br>required: **false**<br><p>Don't use this parameter. Use <code>Group</code> instead.</p><br>
    ///   - [`group(impl Into<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::group) / [`set_group(Option<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::set_group):<br>required: **false**<br><p>The name or the ARN of the resource group to query.</p><br>
    ///   - [`resource_query(ResourceQuery)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::resource_query) / [`set_resource_query(Option<ResourceQuery>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::set_resource_query):<br>required: **true**<br><p>The resource query to determine which Amazon Web Services resources are members of this resource group.</p><note>  <p>A resource group can contain either a <code>Configuration</code> or a <code>ResourceQuery</code>, but not both.</p> </note><br>
