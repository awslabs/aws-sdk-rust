...
impl super::Client {
    ...
    ///   - [`group(impl Into<String>)`](crate::operation::get_group_configuration::builders::GetGroupConfigurationFluentBuilder::group) / [`set_group(Option<String>)`](crate::operation::get_group_configuration::builders::GetGroupConfigurationFluentBuilder::set_group):<br>required: **false**<br><p>The name or the Amazon resource name (ARN) of the resource group for which you want to retrive the service configuration.</p><br>
