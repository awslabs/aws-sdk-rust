...
impl super::Client {
    ...
    ///   - [`group(impl Into<String>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::group) / [`set_group(Option<String>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::set_group):<br>required: **true**<br><p>The name or the ARN of the resource group from which to remove the resources.</p><br>
    ///   - [`resource_arns(impl Into<String>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::resource_arns) / [`set_resource_arns(Option<Vec::<String>>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::set_resource_arns):<br>required: **true**<br><p>The ARNs of the resources to be removed from the group.</p><br>
