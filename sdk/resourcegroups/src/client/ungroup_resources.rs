...
impl super::Client {
    ...
    ///   - [`resource_arns(impl Into<String>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::resource_arns) / [`set_resource_arns(Option<Vec::<String>>)`](crate::operation::ungroup_resources::builders::UngroupResourcesFluentBuilder::set_resource_arns):<br>required: **true**<br><p>The Amazon resource names (ARNs) of the resources to be removed from the group.</p><br>
