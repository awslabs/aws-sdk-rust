...
impl super::Client {
    ...
    ///   - [`arn(impl Into<String>)`](crate::operation::get_tags::builders::GetTagsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_tags::builders::GetTagsFluentBuilder::set_arn):<br>required: **true**<br><p>The ARN of the resource group whose tags you want to retrieve.</p><br>
