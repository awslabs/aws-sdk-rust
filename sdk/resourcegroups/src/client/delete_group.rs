...
impl super::Client {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_group_name): <p>Deprecated - don't use this parameter. Use <code>Group</code> instead.</p>
    ///   - [`group(impl ::std::convert::Into<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::group) / [`set_group(Option<String>)`](crate::operation::delete_group::builders::DeleteGroupFluentBuilder::set_group): <p>The name or the ARN of the resource group to delete.</p>
