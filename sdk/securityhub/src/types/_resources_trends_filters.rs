...
pub struct ResourcesTrendsFilters {
    ...
    pub composite_filters: ::std::option::Option<::std::vec::Vec<crate::types::ResourcesTrendsCompositeFilter>>,
...
impl ResourcesTrendsFilters {
    ...
    pub fn composite_filters(&self) -> &[crate::types::ResourcesTrendsCompositeFilter] {
...
impl ResourcesTrendsFilters {
    /// Creates a new builder-style object to manufacture [`ResourcesTrendsFilters`](crate::types::ResourcesTrendsFilters).
    pub fn builder() -> crate::types::builders::ResourcesTrendsFiltersBuilder {
        crate::types::builders::ResourcesTrendsFiltersBuilder::default()
    }
}

/// A builder for [`ResourcesTrendsFilters`](crate::types::ResourcesTrendsFilters).
#[derive(::std::clone::Clone, ::std::cmp::PartialEq, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
pub struct ResourcesTrendsFiltersBuilder {
    pub(crate) composite_filters: ::std::option::Option<::std::vec::Vec<crate::types::ResourcesTrendsCompositeFilter>>,
    pub(crate) composite_operator: ::std::option::Option<crate::types::AllowedOperators>,
}
impl ResourcesTrendsFiltersBuilder {
    ...
    ///
    /// <p>A list of composite filters to apply to the resources trend data.</p>
    pub fn composite_filters(mut self, input: crate::types::ResourcesTrendsCompositeFilter) -> Self {
    ...
    /// <p>A list of composite filters to apply to the resources trend data.</p>
    pub fn set_composite_filters(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ResourcesTrendsCompositeFilter>>) -> Self {
        self.composite_filters = input;
        self
    }
    /// <p>A list of composite filters to apply to the resources trend data.</p>
    pub fn get_composite_filters(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::ResourcesTrendsCompositeFilter>> {
    ...
    /// Consumes the builder and constructs a [`ResourcesTrendsFilters`](crate::types::ResourcesTrendsFilters).
    pub fn build(self) -> crate::types::ResourcesTrendsFilters {
        crate::types::ResourcesTrendsFilters {
