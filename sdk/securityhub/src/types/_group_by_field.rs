...
///     GroupByField::ResourcesCloudPartition => { /* ... */ },
///     GroupByField::ResourcesName => { /* ... */ },
///     GroupByField::ResourcesOwnerAccountName => { /* ... */ },
///     GroupByField::ResourcesOwnerAccountUid => { /* ... */ },
///     GroupByField::ResourcesOwnerOrgUid => { /* ... */ },
///     GroupByField::ResourcesProvider => { /* ... */ },
///     GroupByField::ResourcesRegion => { /* ... */ },
...
impl ::std::convert::From<&str> for GroupByField {
    fn from(s: &str) -> Self {
        match s {
            ...
            "resources.cloud_partition" => GroupByField::ResourcesCloudPartition,
            "resources.name" => GroupByField::ResourcesName,
            "resources.owner.account.name" => GroupByField::ResourcesOwnerAccountName,
            "resources.owner.account.uid" => GroupByField::ResourcesOwnerAccountUid,
            "resources.owner.org.uid" => GroupByField::ResourcesOwnerOrgUid,
            "resources.provider" => GroupByField::ResourcesProvider,
            "resources.region" => GroupByField::ResourcesRegion,
...
impl GroupByField {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            GroupByField::ResourcesCloudPartition => "resources.cloud_partition",
            GroupByField::ResourcesName => "resources.name",
            GroupByField::ResourcesOwnerAccountName => "resources.owner.account.name",
            GroupByField::ResourcesOwnerAccountUid => "resources.owner.account.uid",
            GroupByField::ResourcesOwnerOrgUid => "resources.owner.org.uid",
            GroupByField::ResourcesProvider => "resources.provider",
            GroupByField::ResourcesRegion => "resources.region",
...
impl ::std::fmt::Display for GroupByField {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            GroupByField::ResourcesCloudPartition => write!(f, "resources.cloud_partition"),
            GroupByField::ResourcesName => write!(f, "resources.name"),
            GroupByField::ResourcesOwnerAccountName => write!(f, "resources.owner.account.name"),
            GroupByField::ResourcesOwnerAccountUid => write!(f, "resources.owner.account.uid"),
            GroupByField::ResourcesOwnerOrgUid => write!(f, "resources.owner.org.uid"),
            GroupByField::ResourcesProvider => write!(f, "resources.provider"),
            GroupByField::ResourcesRegion => write!(f, "resources.region"),
