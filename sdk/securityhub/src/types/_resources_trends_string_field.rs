...
/// When writing a match expression against `ResourcesTrendsStringField`, it is important to ensure
...
///
/// ```text
/// # let resourcestrendsstringfield = unimplemented!();
/// match resourcestrendsstringfield {
...
/// }
/// ```
/// The above code demonstrates that when `resourcestrendsstringfield` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `ResourcesTrendsStringField::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `ResourcesTrendsStringField::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `ResourcesTrendsStringField::NewFeature` is defined.
/// Specifically, when `resourcestrendsstringfield` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `ResourcesTrendsStringField::NewFeature` also yielding `"NewFeature"`.
///
...
pub enum ResourcesTrendsStringField {
    #[allow(missing_docs)] // documentation missing in model
    AccountId,
    #[allow(missing_docs)] // documentation missing in model
    Region,
...
impl ::std::convert::From<&str> for ResourcesTrendsStringField {
    fn from(s: &str) -> Self {
        match s {
...
impl ::std::str::FromStr for ResourcesTrendsStringField {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(ResourcesTrendsStringField::from(s))
    }
}
impl ResourcesTrendsStringField {
...
impl ::std::fmt::Display for ResourcesTrendsStringField {
