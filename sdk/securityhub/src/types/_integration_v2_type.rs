...
/// When writing a match expression against `IntegrationV2Type`, it is important to ensure
...
/// }
/// ```
/// The above code demonstrates that when `integrationv2type` represents
/// `NewFeature`, the execution path will lead to the second last match arm,
/// even though the enum does not contain a variant `IntegrationV2Type::NewFeature`
/// in the current version of SDK. The reason is that the variable `other`,
/// created by the `@` operator, is bound to
/// `IntegrationV2Type::Unknown(UnknownVariantValue("NewFeature".to_owned()))`
/// and calling `as_str` on it yields `"NewFeature"`.
/// This match expression is forward-compatible when executed with a newer
/// version of SDK where the variant `IntegrationV2Type::NewFeature` is defined.
/// Specifically, when `integrationv2type` represents `NewFeature`,
/// the execution path will hit the second last match arm as before by virtue of
/// calling `as_str` on `IntegrationV2Type::NewFeature` also yielding `"NewFeature"`.
///
...
impl ::std::convert::From<&str> for IntegrationV2Type {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => IntegrationV2Type::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for IntegrationV2Type {
    type Err = ::std::convert::Infallible;

    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(IntegrationV2Type::from(s))
    }
}
impl IntegrationV2Type {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            IntegrationV2Type::Unknown(value) => value.as_str(),
        }
    }
...
impl ::std::convert::AsRef<str> for IntegrationV2Type {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl ::std::fmt::Display for IntegrationV2Type {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            IntegrationV2Type::Unknown(value) => write!(f, "{}", value),
        }
    }
}
