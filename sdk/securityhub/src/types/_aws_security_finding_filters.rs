...
pub struct AwsSecurityFindingFilters {
    ...
    /// <p>For findings from controls, if <code>Compliance.Status</code> is <code>PASSED</code>, then Security Hub CSPM automatically sets the workflow status to <code>RESOLVED</code>.</p></li>
    /// </ul>
