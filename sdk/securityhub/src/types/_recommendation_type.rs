...
impl ::std::convert::From<&str> for RecommendationType {
    fn from(s: &str) -> Self {
        match s {
            "UNUSED_PERMISSION_RECOMMENDATION" => RecommendationType::UnusedPermissionRecommendation,
...
impl RecommendationType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            RecommendationType::UnusedPermissionRecommendation => "UNUSED_PERMISSION_RECOMMENDATION",
...
impl ::std::fmt::Display for RecommendationType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            RecommendationType::UnusedPermissionRecommendation => write!(f, "UNUSED_PERMISSION_RECOMMENDATION"),
