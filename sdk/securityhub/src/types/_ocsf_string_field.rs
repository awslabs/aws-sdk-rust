...
///     OcsfStringField::ResourcesName => { /* ... */ },
///     OcsfStringField::ResourcesOwnerAccountName => { /* ... */ },
///     OcsfStringField::ResourcesOwnerAccountUid => { /* ... */ },
///     OcsfStringField::ResourcesOwnerOrgUid => { /* ... */ },
///     OcsfStringField::ResourcesProvider => { /* ... */ },
...
impl ::std::convert::From<&str> for OcsfStringField {
    fn from(s: &str) -> Self {
        match s {
            ...
            "resources.name" => OcsfStringField::ResourcesName,
            "resources.owner.account.name" => OcsfStringField::ResourcesOwnerAccountName,
            "resources.owner.account.uid" => OcsfStringField::ResourcesOwnerAccountUid,
            "resources.owner.org.uid" => OcsfStringField::ResourcesOwnerOrgUid,
            "resources.provider" => OcsfStringField::ResourcesProvider,
...
impl OcsfStringField {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            OcsfStringField::ResourcesName => "resources.name",
            OcsfStringField::ResourcesOwnerAccountName => "resources.owner.account.name",
            OcsfStringField::ResourcesOwnerAccountUid => "resources.owner.account.uid",
            OcsfStringField::ResourcesOwnerOrgUid => "resources.owner.org.uid",
            OcsfStringField::ResourcesProvider => "resources.provider",
...
impl ::std::fmt::Display for OcsfStringField {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            OcsfStringField::ResourcesName => write!(f, "resources.name"),
            OcsfStringField::ResourcesOwnerAccountName => write!(f, "resources.owner.account.name"),
            OcsfStringField::ResourcesOwnerAccountUid => write!(f, "resources.owner.account.uid"),
            OcsfStringField::ResourcesOwnerOrgUid => write!(f, "resources.owner.org.uid"),
            OcsfStringField::ResourcesProvider => write!(f, "resources.provider"),
