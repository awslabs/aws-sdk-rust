...
impl FirewallPolicyDetailsBuilder {
    ...
    /// <p>The stateful rule groups that are used in the firewall policy.</p>
    pub fn get_stateful_rule_group_references(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::FirewallPolicyStatefulRuleGroupReferencesDetails>> {
    ...
    /// <p>The stateless rule groups that are used in the firewall policy.</p>
    pub fn get_stateless_rule_group_references(&self) -> &::std::option::Option<::std::vec::Vec::<crate::types::FirewallPolicyStatelessRuleGroupReferencesDetails>> {
