...
pub fn ser_aws_ecs_service_network_configuration_aws_vpc_configuration_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ecs_service_network_configuration_aws_vpc_configuration_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEcsServiceNetworkConfigurationAwsVpcConfigurationDetails>, aws_smithy_json::deserialize::error::DeserializeError>
