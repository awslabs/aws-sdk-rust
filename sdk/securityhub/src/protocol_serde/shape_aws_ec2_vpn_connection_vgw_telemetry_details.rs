...
pub fn ser_aws_ec2_vpn_connection_vgw_telemetry_details(
    ...
    if let Some(var_1) = &input.accepted_route_count {
        object.key("AcceptedRouteCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
