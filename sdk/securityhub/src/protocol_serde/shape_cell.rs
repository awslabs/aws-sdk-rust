...
pub fn ser_cell(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Cell) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.column != 0 {
