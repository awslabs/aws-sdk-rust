...
pub(crate) fn de_aws_amazon_mq_broker_ldap_server_metadata_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsAmazonMqBrokerLdapServerMetadataDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
