                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DefaultRouteSettings" => {
                            builder = builder.set_default_route_settings(
                                crate::protocol_serde::shape_aws_api_gateway_v2_route_settings::de_aws_api_gateway_v2_route_settings(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "StageVariables" => {
                            builder = builder.set_stage_variables(crate::protocol_serde::shape_field_map::de_field_map(tokens, _value, depth + 1)?);
                        }
                        "AccessLogSettings" => {
