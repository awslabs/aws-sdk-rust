                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ZoneAwarenessConfig" => {
                            builder = builder.set_zone_awareness_config(
                                    crate::protocol_serde::shape_aws_open_search_service_domain_cluster_config_zone_awareness_config_details::de_aws_open_search_service_domain_cluster_config_zone_awareness_config_details(tokens, _value, depth + 1)?
                                );
                        }
