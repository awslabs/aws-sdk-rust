...
pub(crate) fn de_aws_ec2_volume_attachment<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsEc2VolumeAttachment>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
