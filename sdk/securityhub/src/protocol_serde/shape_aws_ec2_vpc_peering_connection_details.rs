...
pub fn ser_aws_ec2_vpc_peering_connection_details(
    ...
    if let Some(var_1) = &input.accepter_vpc_info {
        ...
        crate::protocol_serde::shape_aws_ec2_vpc_peering_connection_vpc_info_details::ser_aws_ec2_vpc_peering_connection_vpc_info_details(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_6) = &input.status {
        ...
        crate::protocol_serde::shape_aws_ec2_vpc_peering_connection_status_details::ser_aws_ec2_vpc_peering_connection_status_details(
            &mut object_7,
            var_6,
        )?;
        object_7.finish();
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AccepterVpcInfo" => {
                            builder = builder.set_accepter_vpc_info(
                                    crate::protocol_serde::shape_aws_ec2_vpc_peering_connection_vpc_info_details::de_aws_ec2_vpc_peering_connection_vpc_info_details(tokens, _value, depth + 1)?
                                );
                        }
                        "ExpirationTime" => {
                        ...
                        "Status" => {
                            builder = builder.set_status(
                                    crate::protocol_serde::shape_aws_ec2_vpc_peering_connection_status_details::de_aws_ec2_vpc_peering_connection_status_details(tokens, _value, depth + 1)?
                                );
                        }
