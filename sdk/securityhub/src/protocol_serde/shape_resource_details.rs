...
pub fn ser_resource_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ResourceDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
