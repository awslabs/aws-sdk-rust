...
pub(crate) fn de_aws_app_sync_graph_ql_api_log_config_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsAppSyncGraphQlApiLogConfigDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
