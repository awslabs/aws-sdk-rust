                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "TunnelOptions" => {
                            builder = builder.set_tunnel_options(
                                    crate::protocol_serde::shape_aws_ec2_vpn_connection_options_tunnel_options_list::de_aws_ec2_vpn_connection_options_tunnel_options_list(tokens, _value, depth + 1)?
                                );
                        }
