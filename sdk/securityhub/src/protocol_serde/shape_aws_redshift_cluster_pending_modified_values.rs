...
pub fn ser_aws_redshift_cluster_pending_modified_values(
    ...
    if let Some(var_1) = &input.automated_snapshot_retention_period {
        object.key("AutomatedSnapshotRetentionPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_10) = &input.number_of_nodes {
        object.key("NumberOfNodes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
