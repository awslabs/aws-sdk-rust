...
pub fn ser_aws_ecs_task_definition_container_definitions_port_mappings_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEcsTaskDefinitionContainerDefinitionsPortMappingsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ecs_task_definition_container_definitions_port_mappings_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEcsTaskDefinitionContainerDefinitionsPortMappingsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
