...
pub(crate) fn de_cvss<'a, I>(
    ...
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::Cvss>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Adjustments" => {
                            builder = builder.set_adjustments(crate::protocol_serde::shape_adjustment_list::de_adjustment_list(tokens, _value)?);
                        }
