                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "NetworkSourceIpV4" => {
                                builder = builder.set_network_source_ipv4(
                                    crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(tokens)?
                                );
                            }
                            "NetworkSourceIpV6" => {
                                builder = builder.set_network_source_ipv6(
                                    crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(tokens)?
                                );
                            }
                            "NetworkSourcePort" => {
                            ...
                            "NetworkDestinationIpV4" => {
                                builder = builder.set_network_destination_ipv4(
                                    crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(tokens)?
                                );
                            }
                            "NetworkDestinationIpV6" => {
                                builder = builder.set_network_destination_ipv6(
                                    crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(tokens)?
                                );
                            }
