...
pub(crate) fn de_aws_elb_load_balancer_access_log<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsElbLoadBalancerAccessLog>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
