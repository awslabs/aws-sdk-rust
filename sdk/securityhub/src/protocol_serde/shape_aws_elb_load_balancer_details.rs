...
pub fn ser_aws_elb_load_balancer_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsElbLoadBalancerDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_elb_load_balancer_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsElbLoadBalancerDetails>, aws_smithy_json::deserialize::error::DeserializeError>
