...
pub fn ser_aws_ec2_launch_template_data_instance_requirements_details(
    ...
    if let Some(var_37) = &input.on_demand_max_price_percentage_over_lowest_price {
        object.key("OnDemandMaxPricePercentageOverLowestPrice").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_37).into()));
    }
    ...
    if let Some(var_39) = &input.spot_max_price_percentage_over_lowest_price {
        object.key("SpotMaxPricePercentageOverLowestPrice").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_39).into()));
    }
