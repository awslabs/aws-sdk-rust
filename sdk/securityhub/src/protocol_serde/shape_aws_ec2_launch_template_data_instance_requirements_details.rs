...
pub fn ser_aws_ec2_launch_template_data_instance_requirements_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2LaunchTemplateDataInstanceRequirementsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_launch_template_data_instance_requirements_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2LaunchTemplateDataInstanceRequirementsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
