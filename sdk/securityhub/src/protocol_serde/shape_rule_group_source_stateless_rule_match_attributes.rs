...
pub fn ser_rule_group_source_stateless_rule_match_attributes(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleGroupSourceStatelessRuleMatchAttributes) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rule_group_source_stateless_rule_match_attributes<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RuleGroupSourceStatelessRuleMatchAttributes>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::rule_group_source_stateless_rule_match_attributes::Builder::default();
            loop {
                match tokens.next().transpose()? {
