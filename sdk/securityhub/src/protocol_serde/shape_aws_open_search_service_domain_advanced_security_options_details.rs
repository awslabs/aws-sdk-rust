                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MasterUserOptions" => {
                            builder = builder.set_master_user_options(
                                    crate::protocol_serde::shape_aws_open_search_service_domain_master_user_options_details::de_aws_open_search_service_domain_master_user_options_details(tokens, _value, depth + 1)?
                                );
                        }
