...
pub fn ser_aws_open_search_service_domain_advanced_security_options_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.enabled {
