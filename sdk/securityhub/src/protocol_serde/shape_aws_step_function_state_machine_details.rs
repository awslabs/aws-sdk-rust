...
pub(crate) fn de_aws_step_function_state_machine_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsStepFunctionStateMachineDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
