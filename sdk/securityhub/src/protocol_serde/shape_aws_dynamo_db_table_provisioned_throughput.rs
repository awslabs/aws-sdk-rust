...
pub(crate) fn de_aws_dynamo_db_table_provisioned_throughput<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsDynamoDbTableProvisionedThroughput>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
