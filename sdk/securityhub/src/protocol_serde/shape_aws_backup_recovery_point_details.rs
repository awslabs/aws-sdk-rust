                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "CalculatedLifecycle" => {
                            builder = builder.set_calculated_lifecycle(
                                    crate::protocol_serde::shape_aws_backup_recovery_point_calculated_lifecycle_details::de_aws_backup_recovery_point_calculated_lifecycle_details(tokens, _value, depth + 1)?
                                );
                        }
                        "CompletionDate" => {
                        ...
                        "CreatedBy" => {
                            builder = builder.set_created_by(
                                    crate::protocol_serde::shape_aws_backup_recovery_point_created_by_details::de_aws_backup_recovery_point_created_by_details(tokens, _value, depth + 1)?
                                );
                        }
                        "CreationDate" => {
                        ...
                        "Lifecycle" => {
                            builder = builder.set_lifecycle(
                                    crate::protocol_serde::shape_aws_backup_recovery_point_lifecycle_details::de_aws_backup_recovery_point_lifecycle_details(tokens, _value, depth + 1)?
                                );
                        }
                        "RecoveryPointArn" => {
