...
pub fn ser_aws_dynamo_db_table_replica(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsDynamoDbTableReplica) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_dynamo_db_table_replica<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsDynamoDbTableReplica>, aws_smithy_json::deserialize::error::DeserializeError>
