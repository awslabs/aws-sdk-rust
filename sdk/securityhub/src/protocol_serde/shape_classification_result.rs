...
pub fn ser_classification_result(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClassificationResult) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
