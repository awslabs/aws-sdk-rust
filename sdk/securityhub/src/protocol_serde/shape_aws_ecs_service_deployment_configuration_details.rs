                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DeploymentCircuitBreaker" => {
                            builder = builder.set_deployment_circuit_breaker(
                                    crate::protocol_serde::shape_aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details::de_aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details(tokens, _value)?
                                );
                        }
                        "MaximumPercent" => {
