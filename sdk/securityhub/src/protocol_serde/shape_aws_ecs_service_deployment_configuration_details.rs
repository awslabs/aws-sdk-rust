...
pub(crate) fn de_aws_ecs_service_deployment_configuration_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsEcsServiceDeploymentConfigurationDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "DeploymentCircuitBreaker" => {
                            builder = builder.set_deployment_circuit_breaker(
                                    crate::protocol_serde::shape_aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details::de_aws_ecs_service_deployment_configuration_deployment_circuit_breaker_details(tokens, _value, depth + 1)?
                                );
                        }
                        "MaximumPercent" => {
