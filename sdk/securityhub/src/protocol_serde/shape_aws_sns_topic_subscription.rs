...
pub(crate) fn de_aws_sns_topic_subscription<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsSnsTopicSubscription>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
