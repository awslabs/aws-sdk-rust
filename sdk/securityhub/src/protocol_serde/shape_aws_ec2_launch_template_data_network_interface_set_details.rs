...
pub fn ser_aws_ec2_launch_template_data_network_interface_set_details(
    ...
    if let Some(var_5) = &input.device_index {
        object.key("DeviceIndex").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    ...
    if let Some(var_10) = &input.ipv4_prefix_count {
        object.key("Ipv4PrefixCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    ...
    if let Some(var_15) = &input.ipv6_address_count {
        object.key("Ipv6AddressCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_20) = &input.ipv6_prefix_count {
        object.key("Ipv6PrefixCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    ...
    if let Some(var_25) = &input.network_card_index {
        object.key("NetworkCardIndex").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    ...
    if let Some(var_32) = &input.secondary_private_ip_address_count {
        object.key("SecondaryPrivateIpAddressCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_32).into()));
    }
