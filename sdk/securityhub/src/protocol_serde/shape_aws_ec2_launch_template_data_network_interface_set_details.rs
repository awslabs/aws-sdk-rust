...
pub fn ser_aws_ec2_launch_template_data_network_interface_set_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_launch_template_data_network_interface_set_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2LaunchTemplateDataNetworkInterfaceSetDetails>, aws_smithy_json::deserialize::error::DeserializeError>
