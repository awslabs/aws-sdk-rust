...
pub fn ser_aws_ssm_compliance_summary(
    ...
    if let Some(var_2) = &input.compliant_critical_count {
        object.key("CompliantCriticalCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.compliant_high_count {
        object.key("CompliantHighCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    if let Some(var_4) = &input.compliant_medium_count {
        object.key("CompliantMediumCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    ...
    if let Some(var_6) = &input.non_compliant_critical_count {
        object.key("NonCompliantCriticalCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.compliant_informational_count {
        object.key("CompliantInformationalCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.non_compliant_informational_count {
        object.key("NonCompliantInformationalCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    if let Some(var_9) = &input.compliant_unspecified_count {
        object.key("CompliantUnspecifiedCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.non_compliant_low_count {
        object.key("NonCompliantLowCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    if let Some(var_11) = &input.non_compliant_high_count {
        object.key("NonCompliantHighCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.compliant_low_count {
        object.key("CompliantLowCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    ...
    if let Some(var_16) = &input.non_compliant_medium_count {
        object.key("NonCompliantMediumCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    if let Some(var_17) = &input.non_compliant_unspecified_count {
        object.key("NonCompliantUnspecifiedCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
