        ...
        Some(::aws_smithy_json::deserialize::Token::StartArray { .. }) => {
            ...
            loop {
                match tokens.peek() {
                    ...
                    _ => {
                        let value =
                            crate::protocol_serde::shape_aws_certificate_manager_certificate_extended_key_usage::de_aws_certificate_manager_certificate_extended_key_usage(tokens, _value)?
                        ;
