...
pub fn ser_aws_backup_backup_plan_rule_details(
    ...
    if let Some(var_2) = &input.start_window_minutes {
        object.key("StartWindowMinutes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    ...
    if let Some(var_7) = &input.completion_window_minutes {
        object.key("CompletionWindowMinutes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
        ...
        for item_10 in var_8 {
             {
                ...
                crate::protocol_serde::shape_aws_backup_backup_plan_rule_copy_actions_details::ser_aws_backup_backup_plan_rule_copy_actions_details(&mut object_11, item_10)?;
                object_11.finish();
            }
        }
        array_9.finish();
