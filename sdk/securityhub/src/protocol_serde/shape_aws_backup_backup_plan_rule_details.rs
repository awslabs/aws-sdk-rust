                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CopyActions" => {
                                builder = builder.set_copy_actions(
                                    crate::protocol_serde::shape_aws_backup_backup_plan_rule_copy_actions_list::de_aws_backup_backup_plan_rule_copy_actions_list(tokens, _value, depth + 1)?
                                );
                            }
                            "Lifecycle" => {
                                builder = builder.set_lifecycle(
                                    crate::protocol_serde::shape_aws_backup_backup_plan_lifecycle_details::de_aws_backup_backup_plan_lifecycle_details(tokens, _value, depth + 1)?
                                );
                            }
