...
pub fn ser_aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsAutoScalingLaunchConfigurationBlockDeviceMappingsEbsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
