...
pub fn ser_aws_ec2_launch_template_data_block_device_mapping_set_ebs_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2LaunchTemplateDataBlockDeviceMappingSetEbsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_launch_template_data_block_device_mapping_set_ebs_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2LaunchTemplateDataBlockDeviceMappingSetEbsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
