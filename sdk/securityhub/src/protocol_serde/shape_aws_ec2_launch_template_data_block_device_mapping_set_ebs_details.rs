...
pub fn ser_aws_ec2_launch_template_data_block_device_mapping_set_ebs_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsEc2LaunchTemplateDataBlockDeviceMappingSetEbsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
