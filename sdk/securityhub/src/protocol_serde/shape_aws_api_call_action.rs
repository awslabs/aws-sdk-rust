...
pub fn ser_aws_api_call_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsApiCallAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_api_call_action<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsApiCallAction>, aws_smithy_json::deserialize::error::DeserializeError>
