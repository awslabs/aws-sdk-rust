...
pub fn ser_network(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Network) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_network<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Network>, aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_direction(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::NetworkDirection::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
