...
pub fn ser_network(
    ...
    if let Some(var_7) = &input.source_port {
        object.key("SourcePort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    ...
    if let Some(var_12) = &input.destination_port {
        object.key("DestinationPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
