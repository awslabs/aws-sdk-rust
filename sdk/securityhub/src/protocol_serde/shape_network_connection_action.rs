...
pub fn ser_network_connection_action(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::NetworkConnectionAction) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
