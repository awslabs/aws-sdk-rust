...
pub fn ser_aws_rds_db_snapshot_details(
    ...
    if let Some(var_5) = &input.allocated_storage {
        object.key("AllocatedStorage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    ...
    if let Some(var_15) = &input.iops {
        object.key("Iops").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_17) = &input.percent_progress {
        object.key("PercentProgress").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
