...
pub fn ser_aws_open_search_service_domain_service_software_options_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_open_search_service_domain_service_software_options_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
