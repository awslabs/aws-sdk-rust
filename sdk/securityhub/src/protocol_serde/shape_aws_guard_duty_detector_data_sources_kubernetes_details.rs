...
pub(crate) fn de_aws_guard_duty_detector_data_sources_kubernetes_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsGuardDutyDetectorDataSourcesKubernetesDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
