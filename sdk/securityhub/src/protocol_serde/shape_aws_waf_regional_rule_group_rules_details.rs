...
pub fn ser_aws_waf_regional_rule_group_rules_details(
    ...
    if let Some(var_1) = &input.action {
        ...
        crate::protocol_serde::shape_aws_waf_regional_rule_group_rules_action_details::ser_aws_waf_regional_rule_group_rules_action_details(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Action" => {
                            builder = builder.set_action(
                                    crate::protocol_serde::shape_aws_waf_regional_rule_group_rules_action_details::de_aws_waf_regional_rule_group_rules_action_details(tokens, _value, depth + 1)?
                                );
                        }
                        "Priority" => {
