...
pub fn ser_aws_ecs_task_definition_container_definitions_details(
    ...
    if let Some(var_53) = &input.memory {
        object.key("Memory").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_53).into()));
    }
    if let Some(var_54) = &input.memory_reservation {
        object.key("MemoryReservation").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_54).into()));
    }
    ...
    if let Some(var_77) = &input.start_timeout {
        object.key("StartTimeout").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_77).into()));
    }
    if let Some(var_78) = &input.stop_timeout {
        object.key("StopTimeout").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_78).into()));
    }
