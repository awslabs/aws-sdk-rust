...
pub fn ser_aws_ecs_task_definition_container_definitions_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEcsTaskDefinitionContainerDefinitionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ecs_task_definition_container_definitions_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEcsTaskDefinitionContainerDefinitionsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
