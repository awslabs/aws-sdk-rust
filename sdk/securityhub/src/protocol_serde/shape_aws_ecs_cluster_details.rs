...
pub fn ser_aws_ecs_cluster_details(
    ...
    if let Some(var_2) = &input.active_services_count {
        object.key("ActiveServicesCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
        ...
        for item_8 in var_6 {
             {
                ...
                crate::protocol_serde::shape_aws_ecs_cluster_cluster_settings_details::ser_aws_ecs_cluster_cluster_settings_details(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
    ...
    if let Some(var_17) = &input.registered_container_instances_count {
        object.key("RegisteredContainerInstancesCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    if let Some(var_18) = &input.running_tasks_count {
        object.key("RunningTasksCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_18).into()));
    }
