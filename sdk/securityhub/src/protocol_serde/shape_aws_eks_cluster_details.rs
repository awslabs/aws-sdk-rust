                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ResourcesVpcConfig" => {
                            builder = builder.set_resources_vpc_config(
                                    crate::protocol_serde::shape_aws_eks_cluster_resources_vpc_config_details::de_aws_eks_cluster_resources_vpc_config_details(tokens, _value, depth + 1)?
                                );
                        }
                        "RoleArn" => {
                        ...
                        "Logging" => {
                            builder = builder.set_logging(
                                crate::protocol_serde::shape_aws_eks_cluster_logging_details::de_aws_eks_cluster_logging_details(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
