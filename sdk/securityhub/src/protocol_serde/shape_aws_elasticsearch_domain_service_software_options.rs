...
pub(crate) fn de_aws_elasticsearch_domain_service_software_options<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsElasticsearchDomainServiceSoftwareOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
