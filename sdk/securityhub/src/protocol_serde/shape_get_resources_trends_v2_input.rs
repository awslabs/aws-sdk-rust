...
pub fn ser_get_resources_trends_v2_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::get_resources_trends_v2::GetResourcesTrendsV2Input,
    ...
    if let Some(var_2) = &input.filters {
        ...
        crate::protocol_serde::shape_resources_trends_filters::ser_resources_trends_filters(&mut object_3, var_2)?;
        object_3.finish();
    }
