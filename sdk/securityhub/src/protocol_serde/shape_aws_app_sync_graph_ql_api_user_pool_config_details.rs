...
pub(crate) fn de_aws_app_sync_graph_ql_api_user_pool_config_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsAppSyncGraphQlApiUserPoolConfigDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
