...
pub fn ser_aws_rds_db_instance_details(
    ...
    if let Some(var_9) = &input.db_instance_port {
        object.key("DbInstancePort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
        ...
        for item_25 in var_23 {
             {
                ...
                crate::protocol_serde::shape_aws_rds_db_instance_vpc_security_group::ser_aws_rds_db_instance_vpc_security_group(&mut object_26, item_25)?;
                object_26.finish();
            }
        }
        array_24.finish();
    ...
    if let Some(var_31) = &input.allocated_storage {
        object.key("AllocatedStorage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_31).into()));
    }
    ...
    if let Some(var_33) = &input.backup_retention_period {
        object.key("BackupRetentionPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_33).into()));
    }
    ...
    if let Some(var_57) = &input.iops {
        object.key("Iops").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_57).into()));
    }
    ...
    if let Some(var_74) = &input.monitoring_interval {
        object.key("MonitoringInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_74).into()));
    }
    ...
    if let Some(var_76) = &input.promotion_tier {
        object.key("PromotionTier").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_76).into()));
    }
    ...
    if let Some(var_80) = &input.performance_insights_retention_period {
        object.key("PerformanceInsightsRetentionPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_80).into()));
    }
    ...
    if let Some(var_90) = &input.max_allocated_storage {
        object.key("MaxAllocatedStorage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_90).into()));
    }
    Ok(())
}
