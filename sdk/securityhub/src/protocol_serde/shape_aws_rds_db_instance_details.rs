...
pub fn ser_aws_rds_db_instance_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsRdsDbInstanceDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_rds_db_instance_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsRdsDbInstanceDetails>, aws_smithy_json::deserialize::error::DeserializeError>
