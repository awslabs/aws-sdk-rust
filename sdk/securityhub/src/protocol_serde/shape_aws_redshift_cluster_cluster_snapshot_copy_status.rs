...
pub fn ser_aws_redshift_cluster_cluster_snapshot_copy_status(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsRedshiftClusterClusterSnapshotCopyStatus) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_redshift_cluster_cluster_snapshot_copy_status<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsRedshiftClusterClusterSnapshotCopyStatus>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::aws_redshift_cluster_cluster_snapshot_copy_status::Builder::default();
            loop {
                match tokens.next().transpose()? {
