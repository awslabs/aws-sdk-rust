...
pub fn ser_action_remote_ip_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ActionRemoteIpDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_action_remote_ip_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ActionRemoteIpDetails>, aws_smithy_json::deserialize::error::DeserializeError>
