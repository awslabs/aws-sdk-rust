...
pub fn ser_aws_redshift_cluster_details(
    ...
    if let Some(var_2) = &input.automated_snapshot_retention_period {
        object.key("AutomatedSnapshotRetentionPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
        ...
        for item_13 in var_11 {
             {
                ...
                crate::protocol_serde::shape_aws_redshift_cluster_cluster_parameter_group::ser_aws_redshift_cluster_cluster_parameter_group(&mut object_14, item_13)?;
                object_14.finish();
            }
        }
        array_12.finish();
        ...
        for item_19 in var_17 {
             {
                ...
                crate::protocol_serde::shape_aws_redshift_cluster_cluster_security_group::ser_aws_redshift_cluster_cluster_security_group(&mut object_20, item_19)?;
                object_20.finish();
            }
        }
        array_18.finish();
    ...
    if let Some(var_21) = &input.cluster_snapshot_copy_status {
        ...
        crate::protocol_serde::shape_aws_redshift_cluster_cluster_snapshot_copy_status::ser_aws_redshift_cluster_cluster_snapshot_copy_status(&mut object_22, var_21)?;
        object_22.finish();
    }
        ...
        for item_29 in var_27 {
             {
                ...
                crate::protocol_serde::shape_aws_redshift_cluster_deferred_maintenance_window::ser_aws_redshift_cluster_deferred_maintenance_window(&mut object_30, item_29)?;
                object_30.finish();
            }
        }
        array_28.finish();
    ...
    if let Some(var_48) = &input.manual_snapshot_retention_period {
        object.key("ManualSnapshotRetentionPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_48).into()));
    }
    ...
    if let Some(var_52) = &input.number_of_nodes {
        object.key("NumberOfNodes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_52).into()));
    }
    ...
    if let Some(var_56) = &input.pending_modified_values {
        ...
        crate::protocol_serde::shape_aws_redshift_cluster_pending_modified_values::ser_aws_redshift_cluster_pending_modified_values(&mut object_57, var_56)?;
        object_57.finish();
    }
        ...
        for item_69 in var_67 {
             {
                ...
                crate::protocol_serde::shape_aws_redshift_cluster_vpc_security_group::ser_aws_redshift_cluster_vpc_security_group(&mut object_70, item_69)?;
                object_70.finish();
            }
        }
        array_68.finish();
