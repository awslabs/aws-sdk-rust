...
pub fn ser_aws_ec2_network_interface_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2NetworkInterfaceDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_network_interface_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2NetworkInterfaceDetails>, aws_smithy_json::deserialize::error::DeserializeError>
