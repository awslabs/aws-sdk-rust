...
pub fn ser_aws_certificate_manager_certificate_renewal_summary(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsCertificateManagerCertificateRenewalSummary) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_certificate_manager_certificate_renewal_summary<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsCertificateManagerCertificateRenewalSummary>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::aws_certificate_manager_certificate_renewal_summary::Builder::default();
            loop {
                match tokens.next().transpose()? {
