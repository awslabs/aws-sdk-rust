...
pub fn ser_aws_auto_scaling_launch_configuration_block_device_mappings_details(
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Ebs" => {
                            builder = builder.set_ebs(
                                    crate::protocol_serde::shape_aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details::de_aws_auto_scaling_launch_configuration_block_device_mappings_ebs_details(tokens, _value, depth + 1)?
                                );
                        }
                        "NoDevice" => {
                            builder = builder.set_no_device(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "VirtualName" => {
