...
pub fn ser_aws_ecs_task_definition_container_definitions_linux_parameters_details(
    ...
    if let Some(var_8) = &input.max_swap {
        object.key("MaxSwap").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    if let Some(var_9) = &input.shared_memory_size {
        object.key("SharedMemorySize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.swappiness {
        object.key("Swappiness").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
