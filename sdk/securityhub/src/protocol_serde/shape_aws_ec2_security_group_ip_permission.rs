...
pub fn ser_aws_ec2_security_group_ip_permission(
    ...
    if let Some(var_2) = &input.from_port {
        object.key("FromPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.to_port {
        object.key("ToPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
        ...
        for item_6 in var_4 {
             {
                ...
                crate::protocol_serde::shape_aws_ec2_security_group_user_id_group_pair::ser_aws_ec2_security_group_user_id_group_pair(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
        ...
        for item_18 in var_16 {
             {
                ...
                crate::protocol_serde::shape_aws_ec2_security_group_prefix_list_id::ser_aws_ec2_security_group_prefix_list_id(&mut object_19, item_18)?;
                object_19.finish();
            }
        }
        array_17.finish();
