...
pub fn ser_vpc_info_peering_options_details(
...
pub(crate) fn de_vpc_info_peering_options_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::VpcInfoPeeringOptionsDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AllowDnsResolutionFromRemoteVpc" => {
                            builder = builder
                                .set_allow_dns_resolution_from_remote_vpc(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
