...
pub(crate) fn de_vpc_info_peering_options_details<'a, I>(
    ...
    Option<crate::model::VpcInfoPeeringOptionsDetails>,
                    ...
                    Some(aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "AllowEgressFromLocalClassicLinkToRemoteVpc" => {
                                builder = builder
                                    .set_allow_egress_from_local_classic_link_to_remote_vpc(
                                        aws_smithy_json::deserialize::token::expect_bool_or_null(
                                            tokens.next(),
                                        )?,
                                    );
                            ...
                            "AllowEgressFromLocalVpcToRemoteClassicLink" => {
                                builder = builder
                                    .set_allow_egress_from_local_vpc_to_remote_classic_link(
                                        aws_smithy_json::deserialize::token::expect_bool_or_null(
                                            tokens.next(),
                                        )?,
                                    );
