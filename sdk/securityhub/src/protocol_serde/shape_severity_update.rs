...
pub fn ser_severity_update(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::SeverityUpdate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
