...
pub(crate) fn de_aws_athena_work_group_configuration_result_configuration_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsAthenaWorkGroupConfigurationResultConfigurationDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
