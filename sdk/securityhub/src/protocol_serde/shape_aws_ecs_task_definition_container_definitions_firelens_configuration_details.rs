...
pub(crate) fn de_aws_ecs_task_definition_container_definitions_firelens_configuration_details<
    'a,
    I,
>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<
    Option<crate::model::AwsEcsTaskDefinitionContainerDefinitionsFirelensConfigurationDetails>,
