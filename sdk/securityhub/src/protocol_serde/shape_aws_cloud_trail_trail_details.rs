...
pub(crate) fn de_aws_cloud_trail_trail_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsCloudTrailTrailDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
