...
pub fn ser_rule_group_source(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleGroupSource) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_rule_group_source<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RuleGroupSource>, aws_smithy_json::deserialize::error::DeserializeError>
