...
pub(crate) fn de_aws_code_build_project_environment_registry_credential<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::AwsCodeBuildProjectEnvironmentRegistryCredential>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
