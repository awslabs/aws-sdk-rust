...
pub fn ser_aws_msk_cluster_cluster_info_details(
    ...
    if let Some(var_1) = &input.encryption_info {
        ...
        crate::protocol_serde::shape_aws_msk_cluster_cluster_info_encryption_info_details::ser_aws_msk_cluster_cluster_info_encryption_info_details(&mut object_2, var_1)?;
        object_2.finish();
    }
    ...
    if let Some(var_4) = &input.number_of_broker_nodes {
        object.key("NumberOfBrokerNodes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
...
pub(crate) fn de_aws_msk_cluster_cluster_info_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsMskClusterClusterInfoDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
