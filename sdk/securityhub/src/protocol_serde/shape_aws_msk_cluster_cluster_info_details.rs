                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "EncryptionInfo" => {
                            builder = builder.set_encryption_info(
                                    crate::protocol_serde::shape_aws_msk_cluster_cluster_info_encryption_info_details::de_aws_msk_cluster_cluster_info_encryption_info_details(tokens, _value, depth + 1)?
                                );
                        }
                        "CurrentVersion" => {
                        ...
                        "ClientAuthentication" => {
                            builder = builder.set_client_authentication(
                                    crate::protocol_serde::shape_aws_msk_cluster_cluster_info_client_authentication_details::de_aws_msk_cluster_cluster_info_client_authentication_details(tokens, _value, depth + 1)?
                                );
                        }
                        "EnhancedMonitoring" => {
