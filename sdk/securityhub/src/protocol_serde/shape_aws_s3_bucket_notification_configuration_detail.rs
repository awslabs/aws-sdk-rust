...
pub fn ser_aws_s3_bucket_notification_configuration_detail(
...
pub(crate) fn de_aws_s3_bucket_notification_configuration_detail<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsS3BucketNotificationConfigurationDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "Events" => {
                            builder = builder.set_events(
                                    crate::protocol_serde::shape_aws_s3_bucket_notification_configuration_events::de_aws_s3_bucket_notification_configuration_events(tokens, _value, depth + 1)?
                                );
                        }
                        "Filter" => {
                            builder = builder.set_filter(
                                    crate::protocol_serde::shape_aws_s3_bucket_notification_configuration_filter::de_aws_s3_bucket_notification_configuration_filter(tokens, _value, depth + 1)?
                                );
                        }
                        "Destination" => {
