...
pub fn ser_aws_ec2_launch_template_data_details(
    ...
    if let Some(var_22) = &input.enclave_options {
        ...
        crate::protocol_serde::shape_aws_ec2_launch_template_data_enclave_options_details::ser_aws_ec2_launch_template_data_enclave_options_details(&mut object_23, var_22)?;
        object_23.finish();
    }
        ...
        for item_39 in var_37 {
             {
                ...
                crate::protocol_serde::shape_aws_ec2_launch_template_data_license_set_details::ser_aws_ec2_launch_template_data_license_set_details(&mut object_40, item_39)?;
                object_40.finish();
            }
        }
        array_38.finish();
    ...
    if let Some(var_45) = &input.monitoring {
        ...
        crate::protocol_serde::shape_aws_ec2_launch_template_data_monitoring_details::ser_aws_ec2_launch_template_data_monitoring_details(&mut object_46, var_45)?;
        object_46.finish();
    }
    ...
    if let Some(var_51) = &input.placement {
        ...
        crate::protocol_serde::shape_aws_ec2_launch_template_data_placement_details::ser_aws_ec2_launch_template_data_placement_details(&mut object_52, var_51)?;
        object_52.finish();
    }
