...
pub fn ser_aws_cors_configuration(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsCorsConfiguration) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_cors_configuration<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsCorsConfiguration>, aws_smithy_json::deserialize::error::DeserializeError>
