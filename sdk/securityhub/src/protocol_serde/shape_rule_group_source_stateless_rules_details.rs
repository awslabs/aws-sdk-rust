...
pub fn ser_rule_group_source_stateless_rules_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::RuleGroupSourceStatelessRulesDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.priority != 0 {
...
pub(crate) fn de_rule_group_source_stateless_rules_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::RuleGroupSourceStatelessRulesDetails>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::model::rule_group_source_stateless_rules_details::Builder::default();
            loop {
                match tokens.next().transpose()? {
