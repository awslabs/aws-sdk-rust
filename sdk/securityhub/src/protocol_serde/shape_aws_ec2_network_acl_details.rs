                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Associations" => {
                            builder = builder.set_associations(
                                crate::protocol_serde::shape_aws_ec2_network_acl_association_list::de_aws_ec2_network_acl_association_list(
                                    tokens, _value,
                                )?,
                            );
                        }
                        "Entries" => {
                            builder = builder.set_entries(
                                crate::protocol_serde::shape_aws_ec2_network_acl_entry_list::de_aws_ec2_network_acl_entry_list(tokens, _value)?,
                            );
                        }
