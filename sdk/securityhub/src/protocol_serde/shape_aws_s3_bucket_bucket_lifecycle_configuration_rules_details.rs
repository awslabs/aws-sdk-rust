                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "AbortIncompleteMultipartUpload" => {
                            builder = builder.set_abort_incomplete_multipart_upload(
                                    crate::protocol_serde::shape_aws_s3_bucket_bucket_lifecycle_configuration_rules_abort_incomplete_multipart_upload_details::de_aws_s3_bucket_bucket_lifecycle_configuration_rules_abort_incomplete_multipart_upload_details(tokens, _value, depth + 1)?
                                );
                        }
                        "ExpirationDate" => {
                        ...
                        "Filter" => {
                            builder = builder.set_filter(
                                    crate::protocol_serde::shape_aws_s3_bucket_bucket_lifecycle_configuration_rules_filter_details::de_aws_s3_bucket_bucket_lifecycle_configuration_rules_filter_details(tokens, _value, depth + 1)?
                                );
                        }
                        "ID" => {
                        ...
                        "NoncurrentVersionTransitions" => {
                            builder = builder.set_noncurrent_version_transitions(
                                    crate::protocol_serde::shape_aws_s3_bucket_bucket_lifecycle_configuration_rules_noncurrent_version_transitions_list::de_aws_s3_bucket_bucket_lifecycle_configuration_rules_noncurrent_version_transitions_list(tokens, _value, depth + 1)?
                                );
                        }
                        "Prefix" => {
                        ...
                        "Transitions" => {
                            builder = builder.set_transitions(
                                    crate::protocol_serde::shape_aws_s3_bucket_bucket_lifecycle_configuration_rules_transitions_list::de_aws_s3_bucket_bucket_lifecycle_configuration_rules_transitions_list(tokens, _value, depth + 1)?
                                );
                        }
