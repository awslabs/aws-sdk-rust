...
pub fn ser_aws_s3_bucket_bucket_lifecycle_configuration_rules_details(
    ...
    if let Some(var_4) = &input.expiration_in_days {
        object.key("ExpirationInDays").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    ...
    if let Some(var_9) = &input.noncurrent_version_expiration_in_days {
        object.key("NoncurrentVersionExpirationInDays").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
