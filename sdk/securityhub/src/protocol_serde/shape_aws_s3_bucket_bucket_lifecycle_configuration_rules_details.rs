...
pub fn ser_aws_s3_bucket_bucket_lifecycle_configuration_rules_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsS3BucketBucketLifecycleConfigurationRulesDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_s3_bucket_bucket_lifecycle_configuration_rules_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsS3BucketBucketLifecycleConfigurationRulesDetails>, aws_smithy_json::deserialize::error::DeserializeError>
