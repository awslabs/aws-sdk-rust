...
pub fn ser_aws_dms_replication_instance_details(
    ...
    if let Some(var_1) = &input.allocated_storage {
        object.key("AllocatedStorage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
...
pub(crate) fn de_aws_dms_replication_instance_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsDmsReplicationInstanceDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
