...
pub(crate) fn de_aws_dms_replication_instance_details<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsDmsReplicationInstanceDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ReplicationSubnetGroup" => {
                            builder = builder.set_replication_subnet_group(
                                    crate::protocol_serde::shape_aws_dms_replication_instance_replication_subnet_group_details::de_aws_dms_replication_instance_replication_subnet_group_details(tokens, _value, depth + 1)?
                                );
                        }
                        "VpcSecurityGroups" => {
                            builder = builder.set_vpc_security_groups(
                                    crate::protocol_serde::shape_aws_dms_replication_instance_vpc_security_groups_list::de_aws_dms_replication_instance_vpc_security_groups_list(tokens, _value, depth + 1)?
                                );
                        }
