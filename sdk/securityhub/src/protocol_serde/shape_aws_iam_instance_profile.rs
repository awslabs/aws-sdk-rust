...
) -> Result<Option<crate::types::AwsIamInstanceProfile>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Roles" => {
                            builder = builder
                                .set_roles(crate::protocol_serde::shape_aws_iam_instance_profile_roles::de_aws_iam_instance_profile_roles(tokens)?);
                        }
