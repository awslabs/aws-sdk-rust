...
pub(crate) fn de_aws_iam_access_key_session_context_session_issuer<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::AwsIamAccessKeySessionContextSessionIssuer>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
