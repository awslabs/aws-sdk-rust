...
pub(crate) fn de_aws_code_build_project_logs_config_s3_logs_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsCodeBuildProjectLogsConfigS3LogsDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
