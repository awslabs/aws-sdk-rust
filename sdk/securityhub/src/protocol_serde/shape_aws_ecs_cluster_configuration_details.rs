                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "ExecuteCommandConfiguration" => {
                            builder = builder.set_execute_command_configuration(
                                    crate::protocol_serde::shape_aws_ecs_cluster_configuration_execute_command_configuration_details::de_aws_ecs_cluster_configuration_execute_command_configuration_details(tokens, _value)?
                                );
                        }
