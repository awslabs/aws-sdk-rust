...
pub fn ser_aws_ec2_client_vpn_endpoint_details(
    ...
    if let Some(var_9) = &input.vpn_port {
        object.key("VpnPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    ...
    if let Some(var_24) = &input.session_timeout_hours {
        object.key("SessionTimeoutHours").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_24).into()));
    }
...
pub(crate) fn de_aws_ec2_client_vpn_endpoint_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsEc2ClientVpnEndpointDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DnsServer" => {
                                builder = builder.set_dns_server(
                                    crate::protocol_serde::shape_string_list::de_string_list(tokens)?
                                );
                            }
                            "SplitTunnel" => {
                                builder = builder.set_split_tunnel(
