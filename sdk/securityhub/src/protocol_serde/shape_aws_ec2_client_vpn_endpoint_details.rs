            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DnsServer" => {
                            builder = builder.set_dns_server(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                        }
                        "SplitTunnel" => {
                        ...
                        "AuthenticationOptions" => {
                            builder = builder.set_authentication_options(
                                    crate::protocol_serde::shape_aws_ec2_client_vpn_endpoint_authentication_options_list::de_aws_ec2_client_vpn_endpoint_authentication_options_list(tokens, _value, depth + 1)?
                                );
                        }
                        "ConnectionLogOptions" => {
                            builder = builder.set_connection_log_options(
                                    crate::protocol_serde::shape_aws_ec2_client_vpn_endpoint_connection_log_options_details::de_aws_ec2_client_vpn_endpoint_connection_log_options_details(tokens, _value, depth + 1)?
                                );
                        }
                        "SecurityGroupIdSet" => {
                            builder = builder.set_security_group_id_set(crate::protocol_serde::shape_string_list::de_string_list(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "ClientConnectOptions" => {
                            builder = builder.set_client_connect_options(
                                    crate::protocol_serde::shape_aws_ec2_client_vpn_endpoint_client_connect_options_details::de_aws_ec2_client_vpn_endpoint_client_connect_options_details(tokens, _value, depth + 1)?
                                );
                        }
                        "SessionTimeoutHours" => {
                        ...
                        "ClientLoginBannerOptions" => {
                            builder = builder.set_client_login_banner_options(
                                    crate::protocol_serde::shape_aws_ec2_client_vpn_endpoint_client_login_banner_options_details::de_aws_ec2_client_vpn_endpoint_client_login_banner_options_details(tokens, _value, depth + 1)?
                                );
                        }
