...
pub fn ser_aws_events_endpoint_details(
        ...
        for item_7 in var_5 {
             {
                ...
                crate::protocol_serde::shape_aws_events_endpoint_event_buses_details::ser_aws_events_endpoint_event_buses_details(&mut object_8, item_7)?;
                object_8.finish();
            }
        }
        array_6.finish();
    ...
    if let Some(var_10) = &input.replication_config {
        ...
        crate::protocol_serde::shape_aws_events_endpoint_replication_config_details::ser_aws_events_endpoint_replication_config_details(&mut object_11, var_10)?;
        object_11.finish();
    }
    ...
    if let Some(var_13) = &input.routing_config {
        ...
        crate::protocol_serde::shape_aws_events_endpoint_routing_config_details::ser_aws_events_endpoint_routing_config_details(&mut object_14, var_13)?;
        object_14.finish();
    }
...
pub(crate) fn de_aws_events_endpoint_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsEventsEndpointDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
