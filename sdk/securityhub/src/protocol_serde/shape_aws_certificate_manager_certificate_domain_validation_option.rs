...
pub fn ser_aws_certificate_manager_certificate_domain_validation_option(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsCertificateManagerCertificateDomainValidationOption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_certificate_manager_certificate_domain_validation_option<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsCertificateManagerCertificateDomainValidationOption>, aws_smithy_json::deserialize::error::DeserializeError>
