...
pub(crate) fn de_aws_iam_policy_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsIamPolicyDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "IsAttachable" => {
                            builder = builder.set_is_attachable(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "Path" => {
                        ...
                        "PolicyVersionList" => {
                            builder = builder.set_policy_version_list(
                                crate::protocol_serde::shape_aws_iam_policy_version_list::de_aws_iam_policy_version_list(tokens, _value, depth + 1)?,
                            );
                        }
                        "UpdateDate" => {
