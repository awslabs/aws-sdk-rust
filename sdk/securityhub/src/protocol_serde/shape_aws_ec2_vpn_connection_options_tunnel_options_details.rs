...
pub fn ser_aws_ec2_vpn_connection_options_tunnel_options_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2VpnConnectionOptionsTunnelOptionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_vpn_connection_options_tunnel_options_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2VpnConnectionOptionsTunnelOptionsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
