...
pub fn ser_aws_ec2_vpn_connection_options_tunnel_options_details(
    ...
    if let Some(var_1) = &input.dpd_timeout_seconds {
        object.key("DpdTimeoutSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_15) = &input.phase1_lifetime_seconds {
        object.key("Phase1LifetimeSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_25) = &input.phase2_lifetime_seconds {
        object.key("Phase2LifetimeSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    ...
    if let Some(var_27) = &input.rekey_fuzz_percentage {
        object.key("RekeyFuzzPercentage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    if let Some(var_28) = &input.rekey_margin_time_seconds {
        object.key("RekeyMarginTimeSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_28).into()));
    }
    if let Some(var_29) = &input.replay_window_size {
        object.key("ReplayWindowSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_29).into()));
    }
