...
pub fn ser_aws_ecs_service_service_registries_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsEcsServiceServiceRegistriesDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ecs_service_service_registries_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AwsEcsServiceServiceRegistriesDetails>, aws_smithy_json::deserialize::error::DeserializeError>
