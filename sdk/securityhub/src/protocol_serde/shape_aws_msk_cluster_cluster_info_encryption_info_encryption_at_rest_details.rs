...
pub(crate) fn de_aws_msk_cluster_cluster_info_encryption_info_encryption_at_rest_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsMskClusterClusterInfoEncryptionInfoEncryptionAtRestDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
