...
pub(crate) fn de_aws_ecs_task_definition_container_definitions_depends_on_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> Result<Option<crate::types::AwsEcsTaskDefinitionContainerDefinitionsDependsOnDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
