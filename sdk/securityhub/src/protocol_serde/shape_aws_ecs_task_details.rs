                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Volumes" => {
                            builder = builder.set_volumes(
                                crate::protocol_serde::shape_aws_ecs_task_volume_details_list::de_aws_ecs_task_volume_details_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "Containers" => {
                            builder = builder.set_containers(
                                crate::protocol_serde::shape_aws_ecs_container_details_list::de_aws_ecs_container_details_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
