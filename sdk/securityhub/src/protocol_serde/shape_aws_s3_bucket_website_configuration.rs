...
pub fn ser_aws_s3_bucket_website_configuration(
...
pub(crate) fn de_aws_s3_bucket_website_configuration<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsS3BucketWebsiteConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "RedirectAllRequestsTo" => {
                            builder = builder.set_redirect_all_requests_to(
                                    crate::protocol_serde::shape_aws_s3_bucket_website_configuration_redirect_to::de_aws_s3_bucket_website_configuration_redirect_to(tokens, _value, depth + 1)?
                                );
                        }
                        "RoutingRules" => {
                            builder = builder.set_routing_rules(
                                    crate::protocol_serde::shape_aws_s3_bucket_website_configuration_routing_rules::de_aws_s3_bucket_website_configuration_routing_rules(tokens, _value, depth + 1)?
                                );
                        }
