                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Settings" => {
                            builder = builder.set_settings(
                                    crate::protocol_serde::shape_rule_group_source_stateful_rules_rule_options_settings_list::de_rule_group_source_stateful_rules_rule_options_settings_list(tokens, _value, depth + 1)?
                                );
                        }
