...
pub fn ser_aws_cloud_front_distribution_origin_custom_origin_config(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsCloudFrontDistributionOriginCustomOriginConfig) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_cloud_front_distribution_origin_custom_origin_config<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsCloudFrontDistributionOriginCustomOriginConfig>, aws_smithy_json::deserialize::error::DeserializeError>
