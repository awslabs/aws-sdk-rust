...
pub fn ser_aws_cloud_front_distribution_origin_custom_origin_config(
    ...
    if let Some(var_1) = &input.http_port {
        object.key("HttpPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    if let Some(var_2) = &input.https_port {
        object.key("HttpsPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_2).into()));
    }
    if let Some(var_3) = &input.origin_keepalive_timeout {
        object.key("OriginKeepaliveTimeout").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_5) = &input.origin_read_timeout {
        object.key("OriginReadTimeout").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.origin_ssl_protocols {
        #[allow(unused_mut)]
        let mut object_7 = object.key("OriginSslProtocols").start_object();
        crate::protocol_serde::shape_aws_cloud_front_distribution_origin_ssl_protocols::ser_aws_cloud_front_distribution_origin_ssl_protocols(&mut object_7, var_6)?;
        object_7.finish();
    }
    Ok(())
}
