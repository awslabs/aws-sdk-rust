                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "OriginSslProtocols" => {
                            builder = builder.set_origin_ssl_protocols(
                                    crate::protocol_serde::shape_aws_cloud_front_distribution_origin_ssl_protocols::de_aws_cloud_front_distribution_origin_ssl_protocols(tokens, _value, depth + 1)?
                                );
                        }
