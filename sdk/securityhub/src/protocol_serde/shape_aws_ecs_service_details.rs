...
pub fn ser_aws_ecs_service_details(
    ...
    if let Some(var_10) = &input.desired_count {
        object.key("DesiredCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    ...
    if let Some(var_13) = &input.health_check_grace_period_seconds {
        object.key("HealthCheckGracePeriodSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
        ...
        for item_17 in var_15 {
             {
                ...
                crate::protocol_serde::shape_aws_ecs_service_load_balancers_details::ser_aws_ecs_service_load_balancers_details(&mut object_18, item_17)?;
                object_18.finish();
            }
        }
        array_16.finish();
    ...
    if let Some(var_20) = &input.network_configuration {
        ...
        crate::protocol_serde::shape_aws_ecs_service_network_configuration_details::ser_aws_ecs_service_network_configuration_details(&mut object_21, var_20)?;
        object_21.finish();
    }
        ...
        for item_24 in var_22 {
             {
                ...
                crate::protocol_serde::shape_aws_ecs_service_placement_constraints_details::ser_aws_ecs_service_placement_constraints_details(&mut object_25, item_24)?;
                object_25.finish();
            }
        }
        array_23.finish();
        ...
        for item_28 in var_26 {
             {
                ...
                crate::protocol_serde::shape_aws_ecs_service_placement_strategies_details::ser_aws_ecs_service_placement_strategies_details(&mut object_29, item_28)?;
                object_29.finish();
            }
        }
        array_27.finish();
        ...
        for item_38 in var_36 {
             {
                ...
                crate::protocol_serde::shape_aws_ecs_service_service_registries_details::ser_aws_ecs_service_service_registries_details(&mut object_39, item_38)?;
                object_39.finish();
            }
        }
        array_37.finish();
