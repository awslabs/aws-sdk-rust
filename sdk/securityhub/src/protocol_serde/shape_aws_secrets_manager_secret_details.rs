                        ...
                        match key.to_unescaped()?.as_ref() {
                            "RotationRules" => {
                                builder = builder.set_rotation_rules(
                                    crate::protocol_serde::shape_aws_secrets_manager_secret_rotation_rules::de_aws_secrets_manager_secret_rotation_rules(tokens, _value, depth + 1)?
                                );
                            }
                            "RotationOccurredWithinFrequency" => {
                                builder = builder.set_rotation_occurred_within_frequency(::aws_smithy_json::deserialize::token::expect_bool_or_null(
                                    tokens.next(),
                                )?);
                            }
                            "KmsKeyId" => {
                            ...
                            "RotationEnabled" => {
                                builder = builder.set_rotation_enabled(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                            }
                            "RotationLambdaArn" => {
