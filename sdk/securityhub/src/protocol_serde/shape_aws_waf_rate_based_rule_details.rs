...
pub fn ser_aws_waf_rate_based_rule_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsWafRateBasedRuleDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
