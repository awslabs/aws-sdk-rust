...
pub(crate) fn de_aws_waf_rate_based_rule_details<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AwsWafRateBasedRuleDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MatchPredicates" => {
                            builder = builder.set_match_predicates(
                                    crate::protocol_serde::shape_aws_waf_rate_based_rule_match_predicate_list::de_aws_waf_rate_based_rule_match_predicate_list(tokens, _value, depth + 1)?
                                );
                        }
