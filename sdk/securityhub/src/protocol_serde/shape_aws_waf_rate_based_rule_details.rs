...
pub fn ser_aws_waf_rate_based_rule_details(
    ...
    if let Some(var_4) = &input.rate_limit {
        object.key("RateLimit").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
        ...
        for item_8 in var_6 {
             {
                ...
                crate::protocol_serde::shape_aws_waf_rate_based_rule_match_predicate::ser_aws_waf_rate_based_rule_match_predicate(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
...
pub(crate) fn de_aws_waf_rate_based_rule_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsWafRateBasedRuleDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
