...
pub fn ser_update_insight_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::update_insight::UpdateInsightInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
