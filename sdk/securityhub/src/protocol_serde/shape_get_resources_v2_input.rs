...
pub fn ser_get_resources_v2_input_input(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::operation::get_resources_v2::GetResourcesV2Input,
) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    if let Some(var_1) = &input.filters {
        #[allow(unused_mut)]
        let mut object_2 = object.key("Filters").start_object();
        crate::protocol_serde::shape_resources_filters::ser_resources_filters(&mut object_2, var_1)?;
        object_2.finish();
    }
