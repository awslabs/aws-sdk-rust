...
pub fn ser_aws_cloud_formation_stack_details(
    ...
    if let Some(var_7) = &input.drift_information {
        ...
        crate::protocol_serde::shape_aws_cloud_formation_stack_drift_information_details::ser_aws_cloud_formation_stack_drift_information_details(&mut object_8, var_7)?;
        object_8.finish();
    }
        ...
        for item_16 in var_14 {
             {
                ...
                crate::protocol_serde::shape_aws_cloud_formation_stack_outputs_details::ser_aws_cloud_formation_stack_outputs_details(&mut object_17, item_16)?;
                object_17.finish();
            }
        }
        array_15.finish();
    ...
    if let Some(var_23) = &input.timeout_in_minutes {
        object.key("TimeoutInMinutes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_23).into()));
    }
    Ok(())
}
