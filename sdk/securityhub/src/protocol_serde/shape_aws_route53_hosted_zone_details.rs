...
pub(crate) fn de_aws_route53_hosted_zone_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsRoute53HostedZoneDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "HostedZone" => {
                                builder = builder.set_hosted_zone(
                                    crate::protocol_serde::shape_aws_route53_hosted_zone_object_details::de_aws_route53_hosted_zone_object_details(tokens)?
                                );
                            }
                            "Vpcs" => {
