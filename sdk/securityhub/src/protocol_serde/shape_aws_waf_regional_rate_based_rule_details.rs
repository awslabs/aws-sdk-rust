                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "MatchPredicates" => {
                            builder = builder.set_match_predicates(
                                    crate::protocol_serde::shape_aws_waf_regional_rate_based_rule_match_predicate_list::de_aws_waf_regional_rate_based_rule_match_predicate_list(tokens, _value, depth + 1)?
                                );
                        }
