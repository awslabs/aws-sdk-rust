...
pub fn ser_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Range) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    if input.start != 0 {
