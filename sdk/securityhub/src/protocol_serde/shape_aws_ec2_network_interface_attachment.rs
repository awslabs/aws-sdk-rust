...
pub(crate) fn de_aws_ec2_network_interface_attachment<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsEc2NetworkInterfaceAttachment>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
