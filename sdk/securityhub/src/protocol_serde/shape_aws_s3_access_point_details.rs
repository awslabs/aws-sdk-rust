...
pub fn ser_aws_s3_access_point_details(
    ...
    if let Some(var_7) = &input.public_access_block_configuration {
        ...
        crate::protocol_serde::shape_aws_s3_account_public_access_block_details::ser_aws_s3_account_public_access_block_details(&mut object_8, var_7)?;
        object_8.finish();
    }
    if let Some(var_9) = &input.vpc_configuration {
        #[allow(unused_mut)]
        let mut object_10 = object.key("VpcConfiguration").start_object();
        crate::protocol_serde::shape_aws_s3_access_point_vpc_configuration_details::ser_aws_s3_access_point_vpc_configuration_details(&mut object_10, var_9)?;
        object_10.finish();
    }
    Ok(())
}

pub(crate) fn de_aws_s3_access_point_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsS3AccessPointDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
