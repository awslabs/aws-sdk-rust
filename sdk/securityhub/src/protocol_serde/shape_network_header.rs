...
pub fn ser_network_header(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::NetworkHeader) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
