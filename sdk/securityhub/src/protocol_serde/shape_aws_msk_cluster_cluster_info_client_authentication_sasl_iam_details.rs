...
pub(crate) fn de_aws_msk_cluster_cluster_info_client_authentication_sasl_iam_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsMskClusterClusterInfoClientAuthenticationSaslIamDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
