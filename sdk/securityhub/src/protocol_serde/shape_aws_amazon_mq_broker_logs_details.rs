...
pub(crate) fn de_aws_amazon_mq_broker_logs_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsAmazonMqBrokerLogsDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
