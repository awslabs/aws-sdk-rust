...
pub fn ser_aws_waf_regional_rule_details(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::AwsWafRegionalRuleDetails,
        ...
        for item_5 in var_3 {
            {
                ...
                crate::protocol_serde::shape_aws_waf_regional_rule_predicate_list_details::ser_aws_waf_regional_rule_predicate_list_details(
                    &mut object_6,
                    item_5,
                )?;
                object_6.finish();
...
) -> Result<Option<crate::types::AwsWafRegionalRuleDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
