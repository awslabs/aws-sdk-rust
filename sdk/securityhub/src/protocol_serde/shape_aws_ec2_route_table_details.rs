...
pub fn ser_aws_ec2_route_table_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsEc2RouteTableDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_ec2_route_table_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AwsEc2RouteTableDetails>, aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "AssociationSet" => {
                                builder = builder.set_association_set(
                                    crate::protocol_serde::shape_association_set_list::de_association_set_list(tokens)?
                                );
                            }
                            "OwnerId" => {
                            ...
                            "RouteSet" => {
                                builder = builder.set_route_set(
                                    crate::protocol_serde::shape_route_set_list::de_route_set_list(tokens)?
                                );
                            }
                            "VpcId" => {
