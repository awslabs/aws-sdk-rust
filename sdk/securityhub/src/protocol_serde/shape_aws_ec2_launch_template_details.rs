...
pub fn ser_aws_ec2_launch_template_details(
    ...
    if let Some(var_5) = &input.default_version_number {
        object.key("DefaultVersionNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.latest_version_number {
        object.key("LatestVersionNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    Ok(())
}
