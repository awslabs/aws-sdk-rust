...
pub(crate) fn de_aws_ec2_launch_template_data_instance_requirements_baseline_ebs_bandwidth_mbps_details<
    'a,
    I,
>(
    ...
    Option<
        crate::model::AwsEc2LaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbpsDetails,
    >,
