...
pub(crate) fn de_aws_ec2_launch_template_data_instance_requirements_baseline_ebs_bandwidth_mbps_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsEc2LaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbpsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
