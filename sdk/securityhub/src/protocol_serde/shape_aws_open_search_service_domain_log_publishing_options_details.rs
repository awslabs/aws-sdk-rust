...
pub fn ser_aws_open_search_service_domain_log_publishing_options_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AwsOpenSearchServiceDomainLogPublishingOptionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_open_search_service_domain_log_publishing_options_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::AwsOpenSearchServiceDomainLogPublishingOptionsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<aws_smithy_json::deserialize::Token<'a>, aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::AwsOpenSearchServiceDomainLogPublishingOptionsDetailsBuilder::default();
            loop {
                match tokens.next().transpose()? {
