...
pub fn ser_aws_open_search_service_domain_log_publishing_options_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsOpenSearchServiceDomainLogPublishingOptionsDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_open_search_service_domain_log_publishing_options_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsOpenSearchServiceDomainLogPublishingOptionsDetails>, aws_smithy_json::deserialize::error::DeserializeError>
