                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "EnabledStandardIdentifiers" => {
                            builder = builder.set_enabled_standard_identifiers(
                                crate::protocol_serde::shape_enabled_standard_identifier_list::de_enabled_standard_identifier_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
                        ...
                        "SecurityControlsConfiguration" => {
                            builder = builder.set_security_controls_configuration(
                                crate::protocol_serde::shape_security_controls_configuration::de_security_controls_configuration(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
