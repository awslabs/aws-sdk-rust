...
pub(crate) fn de_security_hub_policy<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SecurityHubPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "ServiceEnabled" => {
                                builder = builder.set_service_enabled(
