...
pub fn ser_resources_number_filter(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::ResourcesNumberFilter,
    ...
    if let Some(var_2) = &input.filter {
        ...
        crate::protocol_serde::shape_number_filter::ser_number_filter(&mut object_3, var_2)?;
        object_3.finish();
    }
    Ok(())
}
