...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "InvalidAccessException" => {
            crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::InvalidAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => {
            crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceConflictException" => {
            crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::ResourceConflictException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product(_response_body, output)
            .map_err(crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError::unhandled)?;
