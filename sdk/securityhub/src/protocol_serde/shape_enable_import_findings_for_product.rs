...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_import_findings_for_product_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput, crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn ser_enable_import_findings_for_product_input(input: &crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
