...
pub(crate) fn de_aws_elb_load_balancer_listener<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsElbLoadBalancerListener>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
