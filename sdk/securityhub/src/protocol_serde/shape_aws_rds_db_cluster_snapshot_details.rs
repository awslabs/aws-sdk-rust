                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "DbClusterSnapshotAttributes" => {
                            builder = builder.set_db_cluster_snapshot_attributes(
                                    crate::protocol_serde::shape_aws_rds_db_cluster_snapshot_db_cluster_snapshot_attributes::de_aws_rds_db_cluster_snapshot_db_cluster_snapshot_attributes(tokens, _value, depth + 1)?
                                );
                        }
