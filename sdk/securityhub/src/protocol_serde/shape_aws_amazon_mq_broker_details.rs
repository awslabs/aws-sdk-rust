...
pub fn ser_aws_amazon_mq_broker_details(
    ...
    if let Some(var_6) = &input.encryption_options {
        ...
        crate::protocol_serde::shape_aws_amazon_mq_broker_encryption_options_details::ser_aws_amazon_mq_broker_encryption_options_details(&mut object_7, var_6)?;
        object_7.finish();
    }
    ...
    if let Some(var_12) = &input.ldap_server_metadata {
        ...
        crate::protocol_serde::shape_aws_amazon_mq_broker_ldap_server_metadata_details::ser_aws_amazon_mq_broker_ldap_server_metadata_details(&mut object_13, var_12)?;
        object_13.finish();
    }
...
pub(crate) fn de_aws_amazon_mq_broker_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsAmazonMqBrokerDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
