...
pub fn ser_aws_rds_db_cluster_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsRdsDbClusterDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_rds_db_cluster_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsRdsDbClusterDetails>, aws_smithy_json::deserialize::error::DeserializeError>
