...
pub fn ser_aws_dms_endpoint_details(
    ...
    if let Some(var_10) = &input.port {
        object.key("Port").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
...
pub(crate) fn de_aws_dms_endpoint_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsDmsEndpointDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
