...
pub(crate) fn de_aws_ecs_service_load_balancers_details<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::AwsEcsServiceLoadBalancersDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
