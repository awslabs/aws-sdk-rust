...
pub fn ser_aws_elasticsearch_domain_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsElasticsearchDomainDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_elasticsearch_domain_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsElasticsearchDomainDetails>, aws_smithy_json::deserialize::error::DeserializeError>
