...
pub fn de_get_insight_results_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetInsightResultsOutput, crate::error::GetInsightResultsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::GetInsightResultsError::unhandled)?;
    ...
    Err(match error_code {
        ...
        "ResourceNotFoundException" => crate::error::GetInsightResultsError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_insight_results_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::GetInsightResultsOutput, crate::error::GetInsightResultsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::get_insight_results_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_get_insight_results::de_get_insight_results(response.body().as_ref(), output).map_err(crate::error::GetInsightResultsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_get_insight_results(value: &[u8], mut builder: crate::output::get_insight_results_output::Builder) -> Result<crate::output::get_insight_results_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
