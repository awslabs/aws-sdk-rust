...
pub fn ser_aws_security_finding(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsSecurityFinding) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_security_finding<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsSecurityFinding>, aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "WorkflowState" => {
                                builder = builder.set_workflow_state(
                                    aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::model::WorkflowState::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
