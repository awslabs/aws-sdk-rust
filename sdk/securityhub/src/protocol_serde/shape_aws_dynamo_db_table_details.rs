...
pub fn ser_aws_dynamo_db_table_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsDynamoDbTableDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_aws_dynamo_db_table_details<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AwsDynamoDbTableDetails>, aws_smithy_json::deserialize::error::DeserializeError>
