...
pub fn ser_aws_dynamo_db_table_details(
    ...
    if let Some(var_13) = &input.item_count {
        object.key("ItemCount").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
        ...
        for item_22 in var_20 {
             {
                ...
                crate::protocol_serde::shape_aws_dynamo_db_table_local_secondary_index::ser_aws_dynamo_db_table_local_secondary_index(&mut object_23, item_22)?;
                object_23.finish();
            }
        }
        array_21.finish();
    ...
    if let Some(var_24) = &input.provisioned_throughput {
        ...
        crate::protocol_serde::shape_aws_dynamo_db_table_provisioned_throughput::ser_aws_dynamo_db_table_provisioned_throughput(&mut object_25, var_24)?;
        object_25.finish();
    }
    ...
    if let Some(var_38) = &input.table_size_bytes {
        object.key("TableSizeBytes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_38).into()));
    }
