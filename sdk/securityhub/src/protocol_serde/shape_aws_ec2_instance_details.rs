                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "IpV6Addresses" => {
                                builder =
                                    builder.set_ipv6_addresses(crate::protocol_serde::shape_string_list::de_string_list(tokens, _value, depth + 1)?);
                            }
                            "KeyName" => {
                            ...
                            "NetworkInterfaces" => {
                                builder = builder.set_network_interfaces(
                                    crate::protocol_serde::shape_aws_ec2_instance_network_interfaces_list::de_aws_ec2_instance_network_interfaces_list(tokens, _value, depth + 1)?
                                );
                            }
                            "VirtualizationType" => {
                            ...
                            "MetadataOptions" => {
                                builder = builder.set_metadata_options(
                                    crate::protocol_serde::shape_aws_ec2_instance_metadata_options::de_aws_ec2_instance_metadata_options(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "Monitoring" => {
                                builder = builder.set_monitoring(
                                    crate::protocol_serde::shape_aws_ec2_instance_monitoring_details::de_aws_ec2_instance_monitoring_details(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
