...
pub fn ser_aws_ec2_instance_details(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AwsEc2InstanceDetails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
