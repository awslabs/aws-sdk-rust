...
pub fn de_disassociate_from_administrator_account_http_error(
...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::disassociate_from_administrator_account::DisassociateFromAdministratorAccountError::unhandled)?;
    ...
    Err(match error_code {
        "InternalException" => {
            crate::operation::disassociate_from_administrator_account::DisassociateFromAdministratorAccountError::InternalException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidAccessException" => {
            crate::operation::disassociate_from_administrator_account::DisassociateFromAdministratorAccountError::InvalidAccessException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => {
            crate::operation::disassociate_from_administrator_account::DisassociateFromAdministratorAccountError::InvalidInputException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => {
            crate::operation::disassociate_from_administrator_account::DisassociateFromAdministratorAccountError::LimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_from_administrator_account_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<
