...
pub fn de_describe_standards_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeStandardsOutput, crate::error::DescribeStandardsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DescribeStandardsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_standards_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DescribeStandardsOutput, crate::error::DescribeStandardsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::describe_standards_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_describe_standards::de_describe_standards(response.body().as_ref(), output).map_err(crate::error::DescribeStandardsError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_describe_standards(value: &[u8], mut builder: crate::output::describe_standards_output::Builder) -> Result<crate::output::describe_standards_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
