...
/// Paginator for [`GetResourcesV2`](crate::operation::get_resources_v2::GetResourcesV2)
pub struct GetResourcesV2Paginator {
    handle: std::sync::Arc<crate::client::Handle>,
    builder: crate::operation::get_resources_v2::builders::GetResourcesV2InputBuilder,
    stop_on_duplicate_token: bool,
}

impl GetResourcesV2Paginator {
    ...
    pub fn items(self) -> crate::operation::get_resources_v2::paginator::GetResourcesV2PaginatorItems {
        crate::operation::get_resources_v2::paginator::GetResourcesV2PaginatorItems(self)
    }
        ...
        ::aws_smithy_async::future::pagination_stream::PaginationStream::new(::aws_smithy_async::future::pagination_stream::fn_stream::FnStream::new(
            move |tx| {
                ::std::boxed::Box::pin(async move {
                    ...
                    loop {
                        let resp = crate::operation::get_resources_v2::GetResourcesV2::orchestrate(&runtime_plugins, input.clone()).await;
                        // If the input member is None or it was an error
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_get_resources_v2_output_output_next_token(resp);
...
/// Flattened paginator for `GetResourcesV2Paginator`
///
/// This is created with [`.items()`](GetResourcesV2Paginator::items)
pub struct GetResourcesV2PaginatorItems(GetResourcesV2Paginator);

impl GetResourcesV2PaginatorItems {
    /// Create the pagination stream
    ///
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send()).flat_map(|page| {
            crate::lens::lens_get_resources_v2_output_output_resources(page)
                .unwrap_or_default()
                .into_iter()
        })
    }
