...
impl GetFindingsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_findings::GetFindings::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFindings {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_get_findings::de_get_findings_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_findings::de_get_findings_http_response_with_props(
                status, headers, body,
            )
        }
    }
