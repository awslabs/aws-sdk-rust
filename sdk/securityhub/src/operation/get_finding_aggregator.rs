...
impl GetFindingAggregatorInput {
    /// Consumes the builder and constructs an Operation<[`GetFindingAggregator`](crate::operation::get_finding_aggregator::GetFindingAggregator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_finding_aggregator::GetFindingAggregator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_finding_aggregator::GetFindingAggregatorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.finding_aggregator_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("finding_aggregator_arn", "cannot be empty or unset"))?;
                ...
                if finding_aggregator_arn.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("finding_aggregator_arn", "cannot be empty or unset"))
                            }
                write!(output, "/findingAggregator/get/{FindingAggregatorArn}", FindingAggregatorArn = finding_aggregator_arn).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_finding_aggregator::GetFindingAggregator::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetFindingAggregator", "securityhub"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `GetFindingAggregator`.
...
impl aws_smithy_http::response::ParseStrictResponse for GetFindingAggregator {
                type Output = std::result::Result<crate::operation::get_finding_aggregator::GetFindingAggregatorOutput, crate::operation::get_finding_aggregator::GetFindingAggregatorError>;
