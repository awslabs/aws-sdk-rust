...
/// Orchestration and serialization glue logic for `GetFindingAggregator`.
...
impl GetFindingAggregator {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_finding_aggregator::GetFindingAggregatorInput,
                    ) -> ::std::result::Result<crate::operation::get_finding_aggregator::GetFindingAggregatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_finding_aggregator::GetFindingAggregatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_finding_aggregator::GetFindingAggregatorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_finding_aggregator::GetFindingAggregatorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFindingAggregator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetFindingAggregator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetFindingAggregatorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetFindingAggregatorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFindingAggregator")
...
.with_interceptor(GetFindingAggregatorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_finding_aggregator::GetFindingAggregatorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_finding_aggregator::GetFindingAggregatorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_finding_aggregator::GetFindingAggregatorError>::new());
...
#[derive(Debug)]
            struct GetFindingAggregatorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetFindingAggregatorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_finding_aggregator::de_get_finding_aggregator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_finding_aggregator::de_get_finding_aggregator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetFindingAggregatorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetFindingAggregatorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_finding_aggregator::GetFindingAggregatorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_finding_aggregator::GetFindingAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.finding_aggregator_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("finding_aggregator_arn", "cannot be empty or unset"))?;
    let finding_aggregator_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
    if finding_aggregator_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("finding_aggregator_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/findingAggregator/get/{FindingAggregatorArn}", FindingAggregatorArn = finding_aggregator_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetFindingAggregatorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetFindingAggregatorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetFindingAggregatorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetFindingAggregatorInput>()
                        .ok_or("failed to downcast to GetFindingAggregatorInput")?;
...
pub enum GetFindingAggregatorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetFindingAggregatorError) for what information is available for the error.")]
...
impl GetFindingAggregatorError {
    /// Creates the `GetFindingAggregatorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFindingAggregatorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetFindingAggregatorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_finding_aggregator::GetFindingAggregatorError {
...
mod _get_finding_aggregator_output;
