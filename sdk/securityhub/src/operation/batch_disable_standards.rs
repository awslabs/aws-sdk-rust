...
impl BatchDisableStandardsInput {
    /// Consumes the builder and constructs an Operation<[`BatchDisableStandards`](crate::operation::batch_disable_standards::BatchDisableStandards)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::batch_disable_standards::BatchDisableStandards, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_disable_standards::BatchDisableStandardsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::batch_disable_standards::BatchDisableStandards::new())
...
impl aws_smithy_http::response::ParseStrictResponse for BatchDisableStandards {
                type Output = std::result::Result<crate::operation::batch_disable_standards::BatchDisableStandardsOutput, crate::operation::batch_disable_standards::BatchDisableStandardsError>;
