...
/// Orchestration and serialization glue logic for `BatchDisableStandards`.
...
impl BatchDisableStandards {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::batch_disable_standards::BatchDisableStandardsInput,
                    ) -> ::std::result::Result<crate::operation::batch_disable_standards::BatchDisableStandardsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_disable_standards::BatchDisableStandardsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::batch_disable_standards::BatchDisableStandardsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::batch_disable_standards::BatchDisableStandardsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchDisableStandards {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("BatchDisableStandards");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(BatchDisableStandardsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(BatchDisableStandardsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchDisableStandards")
...
.with_interceptor(BatchDisableStandardsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::batch_disable_standards::BatchDisableStandardsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::batch_disable_standards::BatchDisableStandardsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::batch_disable_standards::BatchDisableStandardsError>::new());
...
#[derive(Debug)]
            struct BatchDisableStandardsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchDisableStandardsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_batch_disable_standards::de_batch_disable_standards_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_batch_disable_standards::de_batch_disable_standards_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct BatchDisableStandardsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchDisableStandardsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::batch_disable_standards::BatchDisableStandardsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::batch_disable_standards::BatchDisableStandardsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/standards/deregister").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_disable_standards::ser_batch_disable_standards_input(&input)?);
...
#[derive(Debug)]
            struct BatchDisableStandardsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for BatchDisableStandardsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "BatchDisableStandardsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<BatchDisableStandardsInput>()
                        .ok_or("failed to downcast to BatchDisableStandardsInput")?;
...
pub enum BatchDisableStandardsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-BatchDisableStandardsError) for what information is available for the error.")]
...
impl BatchDisableStandardsError {
    /// Creates the `BatchDisableStandardsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDisableStandardsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `BatchDisableStandardsError::AccessDeniedException`.
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for BatchDisableStandardsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::batch_disable_standards::BatchDisableStandardsError {
...
mod _batch_disable_standards_output;
