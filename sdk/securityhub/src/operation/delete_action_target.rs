...
/// Orchestration and serialization glue logic for `DeleteActionTarget`.
...
impl DeleteActionTarget {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_action_target::DeleteActionTargetInput,
                    ) -> ::std::result::Result<crate::operation::delete_action_target::DeleteActionTargetOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_action_target::DeleteActionTargetError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_action_target::DeleteActionTargetError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_action_target::DeleteActionTargetOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteActionTarget {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteActionTarget");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteActionTargetRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteActionTargetResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteActionTarget")
...
.with_interceptor(DeleteActionTargetEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_action_target::DeleteActionTargetError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_action_target::DeleteActionTargetError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_action_target::DeleteActionTargetError>::new());
...
#[derive(Debug)]
            struct DeleteActionTargetResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteActionTargetResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_action_target::de_delete_action_target_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_action_target::de_delete_action_target_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteActionTargetRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteActionTargetRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_action_target::DeleteActionTargetInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_action_target::DeleteActionTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.action_target_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("action_target_arn", "cannot be empty or unset"))?;
    ...
    if action_target_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("action_target_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/actionTargets/{ActionTargetArn}", ActionTargetArn = action_target_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteActionTargetEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteActionTargetEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteActionTargetEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteActionTargetInput>()
                        .ok_or("failed to downcast to DeleteActionTargetInput")?;
...
pub enum DeleteActionTargetError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteActionTargetError) for what information is available for the error.")]
...
impl DeleteActionTargetError {
    /// Creates the `DeleteActionTargetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteActionTargetError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteActionTargetError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_action_target::DeleteActionTargetError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::delete_action_target::_delete_action_target_output::DeleteActionTargetOutput;

pub use crate::operation::delete_action_target::_delete_action_target_input::DeleteActionTargetInput;

mod _delete_action_target_input;

mod _delete_action_target_output;
