...
impl DescribeHub {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SecurityHub", "DescribeHub", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeHubTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("HubArn") {
            if let ::std::option::Option::Some(value) = input.hub_arn.as_deref() {
                captured.insert("HubArn", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/accounts").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(
                _input: &crate::operation::describe_hub::DescribeHubInput,
                ...
                if let ::std::option::Option::Some(inner_1) = &_input.hub_arn {
                    {
                        query.push_kv("HubArn", &::aws_smithy_http::query::fmt_string(inner_1));
                    }
                }
                ::std::result::Result::Ok(())
            }
