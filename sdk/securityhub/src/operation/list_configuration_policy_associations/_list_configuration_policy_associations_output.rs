...
impl ListConfigurationPolicyAssociationsOutput {
    ...
    pub fn builder() -> crate::operation::list_configuration_policy_associations::builders::ListConfigurationPolicyAssociationsOutputBuilder {
        crate::operation::list_configuration_policy_associations::builders::ListConfigurationPolicyAssociationsOutputBuilder::default()
    }
}
...
impl ListConfigurationPolicyAssociationsOutputBuilder {
    /// Appends an item to `configuration_policy_association_summaries`.
    ///
    /// To override the contents of this collection use [`set_configuration_policy_association_summaries`](Self::set_configuration_policy_association_summaries).
    ///
    /// <p>An object that contains the details of each configuration policy association that’s returned in a <code>ListConfigurationPolicyAssociations</code> request.</p>
