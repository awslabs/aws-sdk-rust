...
pub use crate::operation::list_configuration_policy_associations::_list_configuration_policy_associations_output::ListConfigurationPolicyAssociationsOutputBuilder;

pub use crate::operation::list_configuration_policy_associations::_list_configuration_policy_associations_input::ListConfigurationPolicyAssociationsInputBuilder;
...
impl ListConfigurationPolicyAssociationsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.list_configuration_policy_associations();
...
pub struct ListConfigurationPolicyAssociationsFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::list_configuration_policy_associations::builders::ListConfigurationPolicyAssociationsInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsOutput,
                    crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsError,
                > for ListConfigurationPolicyAssociationsFluentBuilder
            {
                fn send(
                    self,
...
impl ListConfigurationPolicyAssociationsFluentBuilder {
    ...
    /// Access the ListConfigurationPolicyAssociations as a reference.
    pub fn as_input(&self) -> &crate::operation::list_configuration_policy_associations::builders::ListConfigurationPolicyAssociationsInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsOutput, crate::operation::list_configuration_policy_associations::ListConfigurationPolicyAssociationsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::list_configuration_policy_associations::paginator::ListConfigurationPolicyAssociationsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
                            pub fn into_paginator(self) -> crate::operation::list_configuration_policy_associations::paginator::ListConfigurationPolicyAssociationsPaginator {
                                crate::operation::list_configuration_policy_associations::paginator::ListConfigurationPolicyAssociationsPaginator::new(self.handle, self.inner)
                            }
