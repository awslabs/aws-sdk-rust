                    ...
                    loop {
                        ...
                        let done = match resp {
                            ::std::result::Result::Ok(ref resp) => {
                                let new_token = crate::lens::reflens_get_finding_history_output_next_token(resp);
...
impl GetFindingHistoryPaginatorItems {
    ...
    > {
        ::aws_smithy_async::future::pagination_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_get_finding_history_output_records(page).unwrap_or_default().into_iter())
    }
}
