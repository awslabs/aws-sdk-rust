    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::batch_enable_standards::BatchEnableStandardsError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::batch_enable_standards::BatchEnableStandardsOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SecurityHub", "BatchEnableStandards", input, runtime_plugins, stop_point)
            ...
            .instrument(::tracing::debug_span!(
                ...
                "rpc.method" = "BatchEnableStandards",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchEnableStandards {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("BatchEnableStandards")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchEnableStandards")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for BatchEnableStandardsResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_batch_enable_standards::de_batch_enable_standards_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_batch_enable_standards::de_batch_enable_standards_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for BatchEnableStandardsRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::batch_enable_standards::BatchEnableStandardsInput>()
            .expect("correct type");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_batch_enable_standards::ser_batch_enable_standards_input(
            &input,
        )?);
...
impl BatchEnableStandardsError {
    ...
    /// Returns `true` if the error kind is `BatchEnableStandardsError::AccessDeniedException`.
