...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_standards::DescribeStandardsOutput,
                    crate::operation::describe_standards::DescribeStandardsError,
                > for DescribeStandardsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeStandardsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_standards::DescribeStandardsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_standards::DescribeStandardsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_standards::DescribeStandards::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_standards::DescribeStandardsOutput, crate::operation::describe_standards::DescribeStandardsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_standards::paginator::DescribeStandardsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
