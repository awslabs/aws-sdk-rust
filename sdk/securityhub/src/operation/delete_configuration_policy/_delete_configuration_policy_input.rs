...
impl DeleteConfigurationPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_configuration_policy::DeleteConfigurationPolicyInput, ::aws_smithy_types::error::operation::BuildError> {
