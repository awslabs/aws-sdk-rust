...
impl ListStandardsControlAssociationsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_standards_control_associations::ListStandardsControlAssociations::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStandardsControlAssociations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_standards_control_associations::de_list_standards_control_associations_http_response_with_props(
                status, headers, body,
            )
        }
    }
