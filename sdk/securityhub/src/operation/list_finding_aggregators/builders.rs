...
impl ListFindingAggregatorsFluentBuilder {
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_finding_aggregators::paginator::ListFindingAggregatorsPaginator
    {
        crate::operation::list_finding_aggregators::paginator::ListFindingAggregatorsPaginator::new(
            self.handle,
            self.inner,
        )
    }
