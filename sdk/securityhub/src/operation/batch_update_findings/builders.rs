...
impl BatchUpdateFindingsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_update_findings::BatchUpdateFindingsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_update_findings::BatchUpdateFindingsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_update_findings::BatchUpdateFindingsOutput, crate::operation::batch_update_findings::BatchUpdateFindingsError, Self> {
