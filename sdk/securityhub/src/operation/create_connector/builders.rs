...
impl CreateConnectorFluentBuilder {
    ...
    pub fn provider(mut self, input: crate::types::CspmProviderConfiguration) -> Self {
        self.inner = self.inner.provider(input);
        self
    }
    /// <p>The configuration for the cloud provider to connect to. Currently supports Azure.</p>
    pub fn set_provider(mut self, input: ::std::option::Option<crate::types::CspmProviderConfiguration>) -> Self {
        self.inner = self.inner.set_provider(input);
        self
    }
    /// <p>The configuration for the cloud provider to connect to. Currently supports Azure.</p>
    pub fn get_provider(&self) -> &::std::option::Option<crate::types::CspmProviderConfiguration> {
