...
pub struct CreateConnectorInput {
    ...
    pub provider: ::std::option::Option<crate::types::CspmProviderConfiguration>,
...
impl CreateConnectorInput {
    ...
    /// <p>The configuration for the cloud provider to connect to. Currently supports Azure.</p>
    pub fn provider(&self) -> ::std::option::Option<&crate::types::CspmProviderConfiguration> {
...
pub struct CreateConnectorInputBuilder {
    ...
    pub(crate) provider: ::std::option::Option<crate::types::CspmProviderConfiguration>,
