    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for EnableImportFindingsForProductResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for EnableImportFindingsForProductRequestSerializer {
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for EnableImportFindingsForProductEndpointParamsInterceptor {
