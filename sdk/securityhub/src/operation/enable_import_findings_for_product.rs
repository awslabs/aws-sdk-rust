...
impl EnableImportFindingsForProductInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::enable_import_findings_for_product::EnableImportFindingsForProduct::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableImportFindingsForProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product_http_response_with_props(
                status, headers, body,
            )
        }
    }
