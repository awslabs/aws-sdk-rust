...
impl EnableImportFindingsForProduct {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "EnableImportFindingsForProduct",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableImportFindingsForProduct {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            EnableImportFindingsForProductRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            EnableImportFindingsForProductResponseDeserializer,
        ));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("EnableImportFindingsForProduct")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                EnableImportFindingsForProductTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct EnableImportFindingsForProductTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for EnableImportFindingsForProductTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<EnableImportFindingsForProductInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableImportFindingsForProductResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableImportFindingsForProductRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_enable_import_findings_for_product::ser_enable_import_findings_for_product_input(&input)?,
        );
