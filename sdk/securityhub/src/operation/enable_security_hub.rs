...
impl EnableSecurityHub {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::enable_security_hub::EnableSecurityHubError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::enable_security_hub::EnableSecurityHubOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SecurityHub", "EnableSecurityHub", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SecurityHub.EnableSecurityHub",
                "rpc.service" = "SecurityHub",
                "rpc.method" = "EnableSecurityHub",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for EnableSecurityHub {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            EnableSecurityHubRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            EnableSecurityHubResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("EnableSecurityHub")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for EnableSecurityHubResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_enable_security_hub::de_enable_security_hub_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_enable_security_hub::de_enable_security_hub_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for EnableSecurityHubRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::enable_security_hub::EnableSecurityHubInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::enable_security_hub::EnableSecurityHubInput,
