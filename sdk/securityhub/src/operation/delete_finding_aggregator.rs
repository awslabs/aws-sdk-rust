...
impl DeleteFindingAggregator {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::delete_finding_aggregator::DeleteFindingAggregatorInput,
                    ) -> ::std::result::Result<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DeleteFindingAggregator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DeleteFindingAggregator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DeleteFindingAggregatorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DeleteFindingAggregatorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DeleteFindingAggregator")
...
.with_interceptor(DeleteFindingAggregatorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError>::new());
...
#[derive(Debug)]
            struct DeleteFindingAggregatorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DeleteFindingAggregatorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_delete_finding_aggregator::de_delete_finding_aggregator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_delete_finding_aggregator::de_delete_finding_aggregator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DeleteFindingAggregatorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DeleteFindingAggregatorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::delete_finding_aggregator::DeleteFindingAggregatorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::delete_finding_aggregator::DeleteFindingAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/findingAggregator/delete/{FindingAggregatorArn}", FindingAggregatorArn = finding_aggregator_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DeleteFindingAggregatorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DeleteFindingAggregatorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DeleteFindingAggregatorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DeleteFindingAggregatorInput>()
                        .ok_or("failed to downcast to DeleteFindingAggregatorInput")?;
...
pub enum DeleteFindingAggregatorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DeleteFindingAggregatorError) for what information is available for the error.")]
...
impl DeleteFindingAggregatorError {
    /// Creates the `DeleteFindingAggregatorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFindingAggregatorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DeleteFindingAggregatorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::delete_finding_aggregator::DeleteFindingAggregatorError {
...
mod _delete_finding_aggregator_output;
