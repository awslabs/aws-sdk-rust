...
/// Orchestration and serialization glue logic for `GetInsightResults`.
...
impl GetInsightResults {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_insight_results::GetInsightResultsInput,
                    ) -> ::std::result::Result<crate::operation::get_insight_results::GetInsightResultsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_insight_results::GetInsightResultsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_insight_results::GetInsightResultsError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_insight_results::GetInsightResultsOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetInsightResults {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetInsightResults");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetInsightResultsRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetInsightResultsResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetInsightResults")
...
.with_interceptor(GetInsightResultsEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_insight_results::GetInsightResultsError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_insight_results::GetInsightResultsError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_insight_results::GetInsightResultsError>::new());
...
#[derive(Debug)]
            struct GetInsightResultsResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetInsightResultsResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_insight_results::de_get_insight_results_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_insight_results::de_get_insight_results_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetInsightResultsRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetInsightResultsRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_insight_results::GetInsightResultsInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_insight_results::GetInsightResultsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    ...
    ::std::write!(output, "/insights/results/{InsightArn}", InsightArn = insight_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct GetInsightResultsEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetInsightResultsEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetInsightResultsEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetInsightResultsInput>()
                        .ok_or("failed to downcast to GetInsightResultsInput")?;
...
pub enum GetInsightResultsError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetInsightResultsError) for what information is available for the error.")]
...
impl GetInsightResultsError {
    /// Creates the `GetInsightResultsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetInsightResultsError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetInsightResultsError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_insight_results::GetInsightResultsError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_insight_results::_get_insight_results_output::GetInsightResultsOutput;

pub use crate::operation::get_insight_results::_get_insight_results_input::GetInsightResultsInput;

mod _get_insight_results_input;

mod _get_insight_results_output;
