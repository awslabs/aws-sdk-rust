...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInsight {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_insight::de_update_insight_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_update_insight::de_update_insight_http_response_with_props(
                status, headers, body,
            )
        }
    }
