...
impl UpdateInsightInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_insight::UpdateInsight, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_insight::ser_update_insight_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInsight {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_insight::de_update_insight_http_response_with_props(status, headers, body)
        }
    }
}
