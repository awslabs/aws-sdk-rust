...
impl EnableImportFindingsForProductFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput, crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError, Self> {
