...
impl BatchEnableStandardsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_enable_standards::BatchEnableStandardsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_enable_standards::BatchEnableStandardsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_enable_standards::BatchEnableStandardsOutput, crate::operation::batch_enable_standards::BatchEnableStandardsError, Self> {
