    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/findingAggregator/update")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_finding_aggregator::UpdateFindingAggregator::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_finding_aggregator::UpdateFindingAggregatorError
{
