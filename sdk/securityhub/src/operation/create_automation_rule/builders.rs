...
impl CreateAutomationRuleFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_automation_rule::CreateAutomationRuleOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_automation_rule::CreateAutomationRuleError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_automation_rule::CreateAutomationRuleOutput, crate::operation::create_automation_rule::CreateAutomationRuleError, Self> {
