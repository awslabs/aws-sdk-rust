...
impl CreateFindingAggregatorInput {
    /// Consumes the builder and constructs an Operation<[`CreateFindingAggregator`](crate::operation::create_finding_aggregator::CreateFindingAggregator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_finding_aggregator::CreateFindingAggregator, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_finding_aggregator::CreateFindingAggregatorInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_finding_aggregator::CreateFindingAggregator::new())
...
impl aws_smithy_http::response::ParseStrictResponse for CreateFindingAggregator {
                type Output = std::result::Result<crate::operation::create_finding_aggregator::CreateFindingAggregatorOutput, crate::operation::create_finding_aggregator::CreateFindingAggregatorError>;
