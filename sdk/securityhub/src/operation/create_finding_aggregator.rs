...
/// Orchestration and serialization glue logic for `CreateFindingAggregator`.
...
impl CreateFindingAggregator {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_finding_aggregator::CreateFindingAggregatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_finding_aggregator::CreateFindingAggregatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_finding_aggregator::CreateFindingAggregatorError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_finding_aggregator::CreateFindingAggregatorOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateFindingAggregator {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateFindingAggregator");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateFindingAggregatorRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateFindingAggregatorResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateFindingAggregator")
...
.with_interceptor(CreateFindingAggregatorEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_finding_aggregator::CreateFindingAggregatorError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_finding_aggregator::CreateFindingAggregatorError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_finding_aggregator::CreateFindingAggregatorError>::new());
...
#[derive(Debug)]
            struct CreateFindingAggregatorResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateFindingAggregatorResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_create_finding_aggregator::de_create_finding_aggregator_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_create_finding_aggregator::de_create_finding_aggregator_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct CreateFindingAggregatorRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateFindingAggregatorRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_finding_aggregator::CreateFindingAggregatorInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_finding_aggregator::CreateFindingAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/findingAggregator/create").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_finding_aggregator::ser_create_finding_aggregator_input(&input)?);
...
#[derive(Debug)]
            struct CreateFindingAggregatorEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateFindingAggregatorEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateFindingAggregatorEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateFindingAggregatorInput>()
                        .ok_or("failed to downcast to CreateFindingAggregatorInput")?;
...
pub enum CreateFindingAggregatorError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateFindingAggregatorError) for what information is available for the error.")]
...
impl CreateFindingAggregatorError {
    /// Creates the `CreateFindingAggregatorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFindingAggregatorError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateFindingAggregatorError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_finding_aggregator::CreateFindingAggregatorError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::create_finding_aggregator::_create_finding_aggregator_output::CreateFindingAggregatorOutput;

pub use crate::operation::create_finding_aggregator::_create_finding_aggregator_input::CreateFindingAggregatorInput;

mod _create_finding_aggregator_input;

mod _create_finding_aggregator_output;
