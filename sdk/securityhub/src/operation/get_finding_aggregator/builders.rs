...
impl GetFindingAggregatorFluentBuilder  {
    /// Creates a new `GetFindingAggregator`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_finding_aggregator::GetFindingAggregatorOutput, aws_smithy_http::result::SdkError<crate::operation::get_finding_aggregator::GetFindingAggregatorError>>
                     {
