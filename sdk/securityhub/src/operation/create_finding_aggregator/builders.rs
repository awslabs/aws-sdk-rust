...
impl CreateFindingAggregatorFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_finding_aggregator::CreateFindingAggregatorOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_finding_aggregator::CreateFindingAggregatorError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_finding_aggregator::CreateFindingAggregatorOutput, crate::operation::create_finding_aggregator::CreateFindingAggregatorError, Self> {
