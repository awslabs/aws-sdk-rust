...
impl CreateFindingAggregatorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_finding_aggregator::CreateFindingAggregatorInput, ::aws_smithy_types::error::operation::BuildError> {
