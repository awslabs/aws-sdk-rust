...
impl DisableImportFindingsForProductInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::disable_import_findings_for_product::DisableImportFindingsForProduct,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                let product_subscription_arn = ::aws_smithy_http::label::fmt_string(
                    input_1,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableImportFindingsForProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_import_findings_for_product::de_disable_import_findings_for_product_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_http::request_id::RequestId
    for crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError
{
