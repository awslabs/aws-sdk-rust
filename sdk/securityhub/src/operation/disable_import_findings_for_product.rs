...
impl DisableImportFindingsForProductInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disable_import_findings_for_product::DisableImportFindingsForProduct::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableImportFindingsForProduct {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disable_import_findings_for_product::de_disable_import_findings_for_product_http_response_with_props(
                status, headers, body,
            )
        }
    }
