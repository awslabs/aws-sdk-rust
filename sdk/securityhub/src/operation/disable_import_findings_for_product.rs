...
/// Orchestration and serialization glue logic for `DisableImportFindingsForProduct`.
...
impl DisableImportFindingsForProduct {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DisableImportFindingsForProduct {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DisableImportFindingsForProduct");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DisableImportFindingsForProductRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DisableImportFindingsForProductResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DisableImportFindingsForProduct")
...
.with_interceptor(DisableImportFindingsForProductEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError>::new());
...
#[derive(Debug)]
            struct DisableImportFindingsForProductResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DisableImportFindingsForProductResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_disable_import_findings_for_product::de_disable_import_findings_for_product_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_disable_import_findings_for_product::de_disable_import_findings_for_product_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct DisableImportFindingsForProductRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DisableImportFindingsForProductRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    let input_1 = &_input.product_subscription_arn;
    let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_types::error::operation::BuildError::missing_field("product_subscription_arn", "cannot be empty or unset"))?;
    ...
    if product_subscription_arn.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_types::error::operation::BuildError::missing_field("product_subscription_arn", "cannot be empty or unset"))
                }
    ::std::write!(output, "/productSubscriptions/{ProductSubscriptionArn}", ProductSubscriptionArn = product_subscription_arn).expect("formatting should succeed");
...
#[derive(Debug)]
            struct DisableImportFindingsForProductEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DisableImportFindingsForProductEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DisableImportFindingsForProductEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DisableImportFindingsForProductInput>()
                        .ok_or("failed to downcast to DisableImportFindingsForProductInput")?;
...
pub enum DisableImportFindingsForProductError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DisableImportFindingsForProductError) for what information is available for the error.")]
...
impl DisableImportFindingsForProductError {
    /// Creates the `DisableImportFindingsForProductError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DisableImportFindingsForProductError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DisableImportFindingsForProductError {
...
impl ::aws_types::request_id::RequestId for crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductError {
