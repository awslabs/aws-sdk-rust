...
impl GetFindingHistoryInput {
    /// Consumes the builder and constructs an Operation<[`GetFindingHistory`](crate::operation::get_finding_history::GetFindingHistory)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_finding_history::ser_get_finding_history_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_finding_history::GetFindingHistory::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetFindingHistory", "securityhub"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFindingHistory {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_finding_history::de_get_finding_history_http_response_with_props(status, headers, body)
        }
    }
}
