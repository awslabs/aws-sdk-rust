    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_finding_history::GetFindingHistoryError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_finding_history::GetFindingHistoryOutput>::assume_from(output)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetFindingHistory {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("GetFindingHistory", "securityhub"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetFindingHistory")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(GetFindingHistoryEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for GetFindingHistoryResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for GetFindingHistoryRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::get_finding_history::GetFindingHistoryInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_finding_history::ser_get_finding_history_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for GetFindingHistoryEndpointParamsInterceptor {
...
pub type GetFindingHistoryErrorKind = GetFindingHistoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetFindingHistoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_finding_history::GetFindingHistoryError {
...
impl GetFindingHistoryError {
    ...
    /// Creates the `GetFindingHistoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
