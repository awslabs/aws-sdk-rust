...
impl UpdateSecurityHubConfiguration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UpdateSecurityHubConfiguration",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateSecurityHubConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateSecurityHubConfigurationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateSecurityHubConfigurationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateSecurityHubConfiguration")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateSecurityHubConfiguration")
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateSecurityHubConfigurationResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_update_security_hub_configuration::de_update_security_hub_configuration_http_error(
                status, headers, body, _cfg,
            )
        } else {
            crate::protocol_serde::shape_update_security_hub_configuration::de_update_security_hub_configuration_http_response(
                status, headers, body, _cfg,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateSecurityHubConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_update_security_hub_configuration::ser_update_security_hub_configuration_input(&input)?,
        );
...
impl UpdateSecurityHubConfigurationError {
    ...
    /// Returns `true` if the error kind is `UpdateSecurityHubConfigurationError::AccessDeniedException`.
