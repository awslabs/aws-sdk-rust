...
impl crate::operation::batch_update_automation_rules::builders::BatchUpdateAutomationRulesInputBuilder {
...
impl BatchUpdateAutomationRulesFluentBuilder {
    /// Creates a new `BatchUpdateAutomationRulesFluentBuilder`.
