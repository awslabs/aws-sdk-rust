...
impl ListAutomationRulesInput {
    /// Consumes the builder and constructs an Operation<[`ListAutomationRules`](crate::operation::list_automation_rules::ListAutomationRules)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_automation_rules::ListAutomationRules,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_automation_rules::ListAutomationRules::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAutomationRules", "securityhub"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAutomationRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_automation_rules::de_list_automation_rules_http_response_with_props(status, headers, body)
        }
    }
}
