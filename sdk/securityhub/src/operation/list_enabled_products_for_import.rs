...
/// Orchestration and serialization glue logic for `ListEnabledProductsForImport`.
...
impl ListEnabledProductsForImport {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportInput,
                    ) -> ::std::result::Result<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListEnabledProductsForImport {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListEnabledProductsForImport");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListEnabledProductsForImportRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListEnabledProductsForImportResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListEnabledProductsForImport")
...
.with_interceptor(ListEnabledProductsForImportEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError>::new());
...
#[derive(Debug)]
            struct ListEnabledProductsForImportResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListEnabledProductsForImportResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_enabled_products_for_import::de_list_enabled_products_for_import_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_enabled_products_for_import::de_list_enabled_products_for_import_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListEnabledProductsForImportRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListEnabledProductsForImportRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/productSubscriptions").expect("formatting should succeed");
    ::std::result::Result::Ok(())
}
fn uri_query(_input: &crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
#[derive(Debug)]
            struct ListEnabledProductsForImportEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListEnabledProductsForImportEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListEnabledProductsForImportEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListEnabledProductsForImportInput>()
                        .ok_or("failed to downcast to ListEnabledProductsForImportInput")?;
...
pub enum ListEnabledProductsForImportError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListEnabledProductsForImportError) for what information is available for the error.")]
...
impl ListEnabledProductsForImportError {
    /// Creates the `ListEnabledProductsForImportError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListEnabledProductsForImportError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListEnabledProductsForImportError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_enabled_products_for_import::_list_enabled_products_for_import_output::ListEnabledProductsForImportOutput;

pub use crate::operation::list_enabled_products_for_import::_list_enabled_products_for_import_input::ListEnabledProductsForImportInput;

mod _list_enabled_products_for_import_input;

mod _list_enabled_products_for_import_output;
