...
impl ListEnabledProductsForImportInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_enabled_products_for_import::ListEnabledProductsForImport::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEnabledProductsForImport {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_enabled_products_for_import::de_list_enabled_products_for_import_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for ListEnabledProductsForImportError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_enabled_products_for_import::ListEnabledProductsForImportError
{
