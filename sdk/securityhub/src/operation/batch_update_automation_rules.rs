    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for BatchUpdateAutomationRules {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::SharedRequestSerializer::new(
            BatchUpdateAutomationRulesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::DynResponseDeserializer::new(
            BatchUpdateAutomationRulesResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_http::operation::Metadata::new("BatchUpdateAutomationRules", "securityhub"));
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("BatchUpdateAutomationRules")
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for BatchUpdateAutomationRulesResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for BatchUpdateAutomationRulesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesInput>::assume_from(input).expect("correct type").unwrap();
        ...
        let mut request_builder = {
            fn uri_base(
                _input: &crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_automation_rules::ser_batch_update_automation_rules_input(&input)?,
        );
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for BatchUpdateAutomationRulesEndpointParamsInterceptor {
...
pub type BatchUpdateAutomationRulesErrorKind = BatchUpdateAutomationRulesError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for BatchUpdateAutomationRulesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesError {
...
impl BatchUpdateAutomationRulesError {
    ...
    /// Creates the `BatchUpdateAutomationRulesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
