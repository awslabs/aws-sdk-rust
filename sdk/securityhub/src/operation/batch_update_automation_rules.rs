...
impl BatchUpdateAutomationRulesInput {
    /// Consumes the builder and constructs an Operation<[`BatchUpdateAutomationRules`](crate::operation::batch_update_automation_rules::BatchUpdateAutomationRules)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_update_automation_rules::ser_batch_update_automation_rules_input(&self)?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_update_automation_rules::BatchUpdateAutomationRules::new(),
        )
        .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchUpdateAutomationRules", "securityhub"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpdateAutomationRules {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_update_automation_rules::de_batch_update_automation_rules_http_response_with_props(
                status, headers, body,
            )
        }
    }
