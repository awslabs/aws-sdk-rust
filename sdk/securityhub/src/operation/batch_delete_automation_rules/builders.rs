...
impl BatchDeleteAutomationRulesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_delete_automation_rules::BatchDeleteAutomationRulesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_delete_automation_rules::BatchDeleteAutomationRulesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_delete_automation_rules::BatchDeleteAutomationRulesOutput, crate::operation::batch_delete_automation_rules::BatchDeleteAutomationRulesError, Self> {
