...
impl DeleteInsightInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInsight`](crate::operation::delete_insight::DeleteInsight)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::delete_insight::DeleteInsight, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_insight::DeleteInsightInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
                use std::fmt::Write as _;
                let input_1 = &_input.insight_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| aws_smithy_http::operation::error::BuildError::missing_field("insight_arn", "cannot be empty or unset"))?;
                ...
                if insight_arn.is_empty() {
                                return Err(aws_smithy_http::operation::error::BuildError::missing_field("insight_arn", "cannot be empty or unset"))
                            }
                write!(output, "/insights/{InsightArn}", InsightArn = insight_arn).expect("formatting should succeed");
                Ok(())
            }
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::delete_insight::DeleteInsight::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DeleteInsight", "securityhub"));
...
impl aws_smithy_http::response::ParseStrictResponse for DeleteInsight {
                type Output = std::result::Result<crate::operation::delete_insight::DeleteInsightOutput, crate::operation::delete_insight::DeleteInsightError>;
