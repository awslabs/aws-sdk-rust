...
impl GetEnabledStandardsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_enabled_standards::GetEnabledStandardsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_enabled_standards::GetEnabledStandardsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_enabled_standards::GetEnabledStandardsOutput, crate::operation::get_enabled_standards::GetEnabledStandardsError, Self> {
