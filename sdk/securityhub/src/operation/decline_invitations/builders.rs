...
impl crate::operation::decline_invitations::builders::DeclineInvitationsInputBuilder {
...
/// <p>Only member accounts that aren't part of an Amazon Web Services organization should use this operation. Organization accounts don't receive invitations.</p>
...
impl DeclineInvitationsFluentBuilder {
    /// Creates a new `DeclineInvitationsFluentBuilder`.
