...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::decline_invitations::DeclineInvitationsOutput,
                    crate::operation::decline_invitations::DeclineInvitationsError,
                > for DeclineInvitationsFluentBuilder
            {
                fn send(
                    self,
...
impl DeclineInvitationsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::decline_invitations::DeclineInvitationsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::decline_invitations::DeclineInvitationsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::decline_invitations::DeclineInvitations::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::decline_invitations::DeclineInvitations::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::decline_invitations::DeclineInvitationsOutput, crate::operation::decline_invitations::DeclineInvitationsError, Self> {
