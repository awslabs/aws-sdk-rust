...
impl ListSecurityControlDefinitionsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_security_control_definitions::ListSecurityControlDefinitions,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_security_control_definitions::ListSecurityControlDefinitions::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSecurityControlDefinitions {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_security_control_definitions::de_list_security_control_definitions_http_response_with_props(
                status, headers, body,
            )
        }
    }
