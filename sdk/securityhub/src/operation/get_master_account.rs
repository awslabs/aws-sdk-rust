...
impl GetMasterAccount {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_master_account::GetMasterAccountError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_master_account::GetMasterAccountOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("SecurityHub", "GetMasterAccount", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "SecurityHub.GetMasterAccount",
                "rpc.service" = "SecurityHub",
                "rpc.method" = "GetMasterAccount",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetMasterAccount {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetMasterAccountRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetMasterAccountResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetMasterAccount")
                .build()
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetMasterAccountResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_master_account::de_get_master_account_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_master_account::de_get_master_account_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetMasterAccountRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_master_account::GetMasterAccountInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_master_account::GetMasterAccountInput,
