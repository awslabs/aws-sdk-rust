...
impl DescribeStandardsControlsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(self, client: &crate::Client) -> ::std::result::Result<
                        ...
                        >
                    > {
                        let mut fluent_builder = client.describe_standards_controls();
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::describe_standards_controls::DescribeStandardsControlsOutput,
                    crate::operation::describe_standards_controls::DescribeStandardsControlsError,
                > for DescribeStandardsControlsFluentBuilder
            {
                fn send(
                    self,
...
impl DescribeStandardsControlsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::describe_standards_controls::DescribeStandardsControlsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_standards_controls::DescribeStandardsControlsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        ...
                        crate::operation::describe_standards_controls::DescribeStandardsControls::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::describe_standards_controls::DescribeStandardsControlsOutput, crate::operation::describe_standards_controls::DescribeStandardsControlsError, Self> {
    ...
    /// Create a paginator for this request
                            ///
                            /// Paginators are used by calling [`send().await`](crate::operation::describe_standards_controls::paginator::DescribeStandardsControlsPaginator::send) which returns a [`PaginationStream`](aws_smithy_async::future::pagination_stream::PaginationStream).
    ...
    pub fn get_standards_subscription_arn(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_standards_subscription_arn()
    }
