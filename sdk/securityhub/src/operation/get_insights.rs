...
impl GetInsightsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_insights::GetInsights, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_insights::ser_get_insights_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInsights {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_insights::de_get_insights_http_response_with_props(status, headers, body)
        }
    }
}
