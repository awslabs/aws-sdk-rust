...
impl GetInsightsInput {
    /// Consumes the builder and constructs an Operation<[`GetInsights`](crate::operation::get_insights::GetInsights)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_insights::GetInsights, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_insights::GetInsightsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_insights::ser_get_insights_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_insights::GetInsights::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetInsights", "securityhub"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetInsights {
                type Output = std::result::Result<crate::operation::get_insights::GetInsightsOutput, crate::operation::get_insights::GetInsightsError>;
