...
impl UpdateSecurityHubConfigurationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationOutput, crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationError, Self> {
