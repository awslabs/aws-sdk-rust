...
impl BatchDisableStandardsFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::batch_disable_standards::BatchDisableStandardsOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::batch_disable_standards::BatchDisableStandardsError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::batch_disable_standards::BatchDisableStandardsOutput, crate::operation::batch_disable_standards::BatchDisableStandardsError, Self> {
