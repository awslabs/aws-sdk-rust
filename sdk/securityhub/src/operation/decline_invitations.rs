...
impl DeclineInvitationsInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_decline_invitations::ser_decline_invitations_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeclineInvitations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_decline_invitations::de_decline_invitations_http_response_with_props(status, headers, body)
        }
    }
}
