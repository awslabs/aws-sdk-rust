...
impl super::Client {
    ...
    ///   - [`providers(StandardsProvider)`](crate::operation::get_enabled_standards::builders::GetEnabledStandardsFluentBuilder::providers) / [`set_providers(Option<Vec::<StandardsProvider>>)`](crate::operation::get_enabled_standards::builders::GetEnabledStandardsFluentBuilder::set_providers):<br>required: **false**<br><p>A list of cloud providers to filter the enabled standards by. For example, specify <code>Azure</code> to return only enabled standards that evaluate Azure resources.</p><br>
