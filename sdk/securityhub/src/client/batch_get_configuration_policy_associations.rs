...
impl super::Client {
    ...
    pub fn batch_get_configuration_policy_associations(&self) -> crate::operation::batch_get_configuration_policy_associations::builders::BatchGetConfigurationPolicyAssociationsFluentBuilder {
                                crate::operation::batch_get_configuration_policy_associations::builders::BatchGetConfigurationPolicyAssociationsFluentBuilder::new(self.handle.clone())
                            }
}
