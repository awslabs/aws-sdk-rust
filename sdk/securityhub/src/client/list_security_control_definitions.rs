...
impl super::Client {
    ...
    ///   - [`providers(SecurityControlsProvider)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::providers) / [`set_providers(Option<Vec::<SecurityControlsProvider>>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::set_providers):<br>required: **false**<br><p>A list of cloud providers to filter the security control definitions by. For example, specify <code>Azure</code> to return only controls that evaluate Azure resources.</p><br>
