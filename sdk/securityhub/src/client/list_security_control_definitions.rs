...
impl super::Client {
    ...
    ///   - [`standards_arn(impl ::std::convert::Into<String>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::standards_arn) / [`set_standards_arn(Option<String>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::set_standards_arn): <p> The Amazon Resource Name (ARN) of the standard that you want to view controls for. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::set_next_token): <p> Optional pagination parameter. </p>
    ///   - [`max_results(i32)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_security_control_definitions::builders::ListSecurityControlDefinitionsFluentBuilder::set_max_results): <p> An optional parameter that limits the total results of the API response to the specified number. If this parameter isn't provided in the request, the results include the first 25 security controls that apply to the specified standard. The results also include a <code>NextToken</code> parameter that you can use in a subsequent API call to get the next 25 controls. This repeats until all controls for the standard are returned. </p>
