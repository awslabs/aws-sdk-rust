...
impl super::Client {
    ...
    ///   - [`findings(AwsSecurityFinding)`](crate::operation::batch_import_findings::builders::BatchImportFindingsFluentBuilder::findings) / [`set_findings(Option<Vec::<AwsSecurityFinding>>)`](crate::operation::batch_import_findings::builders::BatchImportFindingsFluentBuilder::set_findings):<br>required: **true**<br><p>A list of findings to import. To successfully import a finding, it must follow the <a href="https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings-format.html">Amazon Web Services Security Finding Format</a>. Maximum of 100 findings per request.</p><br>
    ...
    ///   - [`failed_count(Option<i32>)`](crate::operation::batch_import_findings::BatchImportFindingsOutput::failed_count): <p>The number of findings that failed to import.</p>
    ///   - [`success_count(Option<i32>)`](crate::operation::batch_import_findings::BatchImportFindingsOutput::success_count): <p>The number of findings that were successfully imported.</p>
