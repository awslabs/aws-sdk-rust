...
impl super::Client {
    ...
    ///   - [`admin_accounts(Option<Vec::<AdminAccount>>)`](crate::operation::list_organization_admin_accounts::ListOrganizationAdminAccountsOutput::admin_accounts): <p>The list of Security Hub CSPM administrator accounts.</p>
    ...
    ///   - [`feature(Option<SecurityHubFeature>)`](crate::operation::list_organization_admin_accounts::ListOrganizationAdminAccountsOutput::feature): <p>The feature where the delegated administrator account is listed. Defaults to Security Hub CSPM CSPM if not specified.</p>
