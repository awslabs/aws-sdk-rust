...
impl super::Client {
    ...
    ///   - [`account_details(AccountDetails)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::account_details) / [`set_account_details(Option<Vec::<AccountDetails>>)`](crate::operation::create_members::builders::CreateMembersFluentBuilder::set_account_details):<br>required: **true**<br><p>The list of accounts to associate with the Security Hub CSPM administrator account. For each account, the list includes the account ID and optionally the email address.</p><br>
