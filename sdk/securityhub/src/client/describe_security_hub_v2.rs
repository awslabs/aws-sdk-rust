...
impl super::Client {
    ...
    ///   - [`features(Option<HashMap::<String, FeatureDetail>>)`](crate::operation::describe_security_hub_v2::DescribeSecurityHubV2Output::features): <p>A map of opt-in features and their current status and metadata for the account in the current Region.</p>
