...
impl super::Client {
    ...
    ///   - [`name(impl Into<String>)`](crate::operation::create_insight::builders::CreateInsightFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_insight::builders::CreateInsightFluentBuilder::set_name):<br>required: **true**<br><p>The name of the custom insight to create.</p><br>
