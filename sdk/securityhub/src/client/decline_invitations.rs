...
impl super::Client  {
    ...
    ///   - [`account_ids(Vec<String>)`](crate::operation::decline_invitations::builders::DeclineInvitationsFluentBuilder::account_ids) / [`set_account_ids(Option<Vec<String>>)`](crate::operation::decline_invitations::builders::DeclineInvitationsFluentBuilder::set_account_ids): <p>The list of prospective member account IDs for which to decline an invitation.</p>
