...
impl super::Client {
    ...
    ///   - [`automation_rules_arns(impl Into<String>)`](crate::operation::batch_delete_automation_rules::builders::BatchDeleteAutomationRulesFluentBuilder::automation_rules_arns) / [`set_automation_rules_arns(Option<Vec<String>>)`](crate::operation::batch_delete_automation_rules::builders::BatchDeleteAutomationRulesFluentBuilder::set_automation_rules_arns): <p> A list of Amazon Resource Names (ARNs) for the rules that are to be deleted. </p>
