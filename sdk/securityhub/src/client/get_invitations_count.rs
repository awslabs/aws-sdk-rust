...
impl super::Client {
    ...
    ///   - [`invitations_count(Option<i32>)`](crate::operation::get_invitations_count::GetInvitationsCountOutput::invitations_count): <p>The number of all membership invitations sent to this Security Hub CSPM member account, not including the currently accepted invitation.</p>
