...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_standards::builders::DescribeStandardsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_standards::builders::DescribeStandardsFluentBuilder::set_next_token): <p>The token that is required for pagination. On your first call to the <code>DescribeStandards</code> operation, set the value of this parameter to <code>NULL</code>.</p>  <p>For subsequent calls to the operation, to continue listing data, set the value of this parameter to the value returned from the previous response.</p>
    ///   - [`max_results(i32)`](crate::operation::describe_standards::builders::DescribeStandardsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_standards::builders::DescribeStandardsFluentBuilder::set_max_results): <p>The maximum number of standards to return.</p>
