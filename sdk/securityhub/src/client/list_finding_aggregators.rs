...
impl super::Client {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_finding_aggregators::builders::ListFindingAggregatorsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_finding_aggregators::builders::ListFindingAggregatorsFluentBuilder::set_next_token): <p>The token returned with the previous set of results. Identifies the next set of results to return.</p>
