...
impl super::Client {
    ...
    ///   - [`security_control_id(impl ::std::convert::Into<String>)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::security_control_id) / [`set_security_control_id(Option<String>)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::set_security_control_id): <p> The identifier of the control (identified with <code>SecurityControlId</code>, <code>SecurityControlArn</code>, or a mix of both parameters) that you want to determine the enablement status of in each enabled standard. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::set_next_token): <p> Optional pagination parameter. </p>
    ///   - [`max_results(i32)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_standards_control_associations::builders::ListStandardsControlAssociationsFluentBuilder::set_max_results): <p> An optional parameter that limits the total results of the API response to the specified number. If this parameter isn't provided in the request, the results include the first 25 standard and control associations. The results also include a <code>NextToken</code> parameter that you can use in a subsequent API call to get the next 25 associations. This repeats until all associations for the specified control are returned. The number of results is limited by the number of supported Security Hub standards that you've enabled in the calling account. </p>
