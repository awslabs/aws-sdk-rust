...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::get_members::builders::GetMembersFluentBuilder::account_ids) / [`set_account_ids(Option<Vec::<String>>)`](crate::operation::get_members::builders::GetMembersFluentBuilder::set_account_ids):<br>required: **true**<br><p>The list of account IDs for the Security Hub CSPM member accounts to return the details for.</p><br>
    /// - On success, responds with [`GetMembersOutput`](crate::operation::get_members::GetMembersOutput) with field(s):
    ///   - [`members(Option<Vec::<Member>>)`](crate::operation::get_members::GetMembersOutput::members): <p>The list of details about the Security Hub CSPM member accounts.</p>
