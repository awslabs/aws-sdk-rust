...
impl super::Client {
    ...
    pub fn get_configuration_policy_association(&self) -> crate::operation::get_configuration_policy_association::builders::GetConfigurationPolicyAssociationFluentBuilder {
