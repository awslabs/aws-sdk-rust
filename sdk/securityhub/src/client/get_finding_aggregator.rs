...
impl super::Client {
    ...
    ///   - [`finding_aggregation_region(Option<String>)`](crate::operation::get_finding_aggregator::GetFindingAggregatorOutput::finding_aggregation_region): <p>The home Region. Findings generated in linked Regions are replicated and sent to the home Region.</p>
