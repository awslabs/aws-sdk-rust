...
impl super::Client {
    ...
    ///   - [`insight_arn(impl Into<String>)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::insight_arn) / [`set_insight_arn(Option<String>)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::set_insight_arn):<br>required: **true**<br><p>The ARN of the insight that you want to update.</p><br>
    ///   - [`name(impl Into<String>)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::set_name):<br>required: **false**<br><p>The updated name for the insight.</p><br>
    ///   - [`filters(AwsSecurityFindingFilters)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::filters) / [`set_filters(Option<AwsSecurityFindingFilters>)`](crate::operation::update_insight::builders::UpdateInsightFluentBuilder::set_filters):<br>required: **false**<br><p>The updated filters that define this insight.</p><br>
