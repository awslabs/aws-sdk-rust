...
impl super::Client {
    ...
    ///   - [`master(Option<Invitation>)`](crate::operation::get_master_account::GetMasterAccountOutput::master): <p>A list of details about the Security Hub CSPM administrator account for the current member account.</p>
