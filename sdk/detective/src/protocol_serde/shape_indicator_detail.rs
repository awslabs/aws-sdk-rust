...
pub(crate) fn de_indicator_detail<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IndicatorDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "TTPsObservedDetail" => {
                                builder = builder.set_ttps_observed_detail(
                                    crate::protocol_serde::shape_ttps_observed_detail::de_ttps_observed_detail(tokens)?
                                );
                            }
                            ...
                            "NewGeolocationDetail" => {
                                builder = builder.set_new_geolocation_detail(
                                    crate::protocol_serde::shape_new_geolocation_detail::de_new_geolocation_detail(tokens)?
                                );
                            }
                            "NewAsoDetail" => {
                                builder = builder.set_new_aso_detail(
                                    crate::protocol_serde::shape_new_aso_detail::de_new_aso_detail(tokens)?
                                );
                            }
                            "NewUserAgentDetail" => {
                                builder = builder.set_new_user_agent_detail(
                                    crate::protocol_serde::shape_new_user_agent_detail::de_new_user_agent_detail(tokens)?
                                );
                            }
                            "RelatedFindingDetail" => {
                                builder = builder.set_related_finding_detail(
                                    crate::protocol_serde::shape_related_finding_detail::de_related_finding_detail(tokens)?
                                );
                            }
