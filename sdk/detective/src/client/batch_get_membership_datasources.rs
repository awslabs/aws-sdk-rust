...
impl super::Client {
    ...
    ///   - [`graph_arns(impl Into<String>)`](crate::operation::batch_get_membership_datasources::builders::BatchGetMembershipDatasourcesFluentBuilder::graph_arns) / [`set_graph_arns(Option<Vec::<String>>)`](crate::operation::batch_get_membership_datasources::builders::BatchGetMembershipDatasourcesFluentBuilder::set_graph_arns):<br>required: **true**<br><p>The ARN of the behavior graph.</p><br>
