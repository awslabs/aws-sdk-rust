...
impl super::Client {
    ...
    ///   - [`graph_arn(impl ::std::convert::Into<String>)`](crate::operation::list_datasource_packages::builders::ListDatasourcePackagesFluentBuilder::graph_arn) / [`set_graph_arn(Option<String>)`](crate::operation::list_datasource_packages::builders::ListDatasourcePackagesFluentBuilder::set_graph_arn): <p>The ARN of the behavior graph.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_datasource_packages::builders::ListDatasourcePackagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_datasource_packages::builders::ListDatasourcePackagesFluentBuilder::set_next_token): <p>For requests to get the next page of results, the pagination token that was returned with the previous set of results. The initial request does not include a pagination token.</p>
