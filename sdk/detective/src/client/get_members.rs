...
impl super::Client {
    ...
    ///   - [`account_ids(impl Into<String>)`](crate::operation::get_members::builders::GetMembersFluentBuilder::account_ids) / [`set_account_ids(Option<Vec<String>>)`](crate::operation::get_members::builders::GetMembersFluentBuilder::set_account_ids): <p>The list of Amazon Web Services account identifiers for the member account for which to return member details. You can request details for up to 50 member accounts at a time.</p>  <p>You cannot use <code>GetMembers</code> to retrieve information about member accounts that were removed from the behavior graph.</p>
