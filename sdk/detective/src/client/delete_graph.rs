...
impl super::Client {
    ...
    ///   - [`graph_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_graph::builders::DeleteGraphFluentBuilder::graph_arn) / [`set_graph_arn(Option<String>)`](crate::operation::delete_graph::builders::DeleteGraphFluentBuilder::set_graph_arn): <p>The ARN of the behavior graph to disable.</p>
    ...
    pub fn delete_graph(
        &self,
    ) -> crate::operation::delete_graph::builders::DeleteGraphFluentBuilder {
