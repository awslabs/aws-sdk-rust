...
impl super::Client {
    ...
    ///   - [`graph_arn(impl Into<String>)`](crate::operation::update_datasource_packages::builders::UpdateDatasourcePackagesFluentBuilder::graph_arn) / [`set_graph_arn(Option<String>)`](crate::operation::update_datasource_packages::builders::UpdateDatasourcePackagesFluentBuilder::set_graph_arn):<br>required: **true**<br><p>The ARN of the behavior graph.</p><br>
    ///   - [`datasource_packages(DatasourcePackage)`](crate::operation::update_datasource_packages::builders::UpdateDatasourcePackagesFluentBuilder::datasource_packages) / [`set_datasource_packages(Option<Vec::<DatasourcePackage>>)`](crate::operation::update_datasource_packages::builders::UpdateDatasourcePackagesFluentBuilder::set_datasource_packages):<br>required: **true**<br><p>The data source package to start for the behavior graph.</p><br>
