...
pub(crate) fn reflens_structure_crate_output_list_datasource_packages_output_next_token(input: &crate::output::ListDatasourcePackagesOutput) -> std::option::Option<& std::string::String> {
...
pub(crate) fn reflens_structure_crate_output_list_graphs_output_next_token(input: &crate::output::ListGraphsOutput) -> std::option::Option<& std::string::String> {
                    let input = match &input.next_token {
                            None => return None,
                            Some(t) => t
                        };
