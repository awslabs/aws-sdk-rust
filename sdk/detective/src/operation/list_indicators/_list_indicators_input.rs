...
impl ListIndicatorsInputBuilder {
    ...
    pub fn set_indicator_type(mut self, input: ::std::option::Option<crate::types::IndicatorType>) -> Self {
        self.indicator_type = input; self
    }
    /// <p>For the list of indicators of compromise that are generated by Detective investigations, see <a href="https://docs.aws.amazon.com/detective/latest/userguide/detective-investigations.html">Detective investigations</a>.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_indicators::ListIndicatorsInput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_indicators::ListIndicatorsInput {
