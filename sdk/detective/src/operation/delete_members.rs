...
impl DeleteMembersInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_members::DeleteMembers::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMembers {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_members::de_delete_members_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_members::de_delete_members_http_response_with_props(
                status, headers, body,
            )
        }
    }
