...
impl DeleteMembersInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMembers`](crate::operation::delete_members::DeleteMembers)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_members::DeleteMembers, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_delete_members::ser_delete_members_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_members::DeleteMembers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMembers {
    type Output = ::std::result::Result<crate::operation::delete_members::DeleteMembersOutput, crate::operation::delete_members::DeleteMembersError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_members::de_delete_members_http_response_with_props(status, headers, body)
        }
    }
}
