...
impl ListDatasourcePackagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_datasource_packages::ListDatasourcePackages,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDatasourcePackages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_datasource_packages::de_list_datasource_packages_http_response_with_props(status, headers, body)
        }
    }
}
