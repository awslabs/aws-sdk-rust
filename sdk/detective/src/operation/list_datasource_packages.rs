...
/// Orchestration and serialization glue logic for `ListDatasourcePackages`.
...
impl ListDatasourcePackages {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::list_datasource_packages::ListDatasourcePackagesInput,
                    ) -> ::std::result::Result<crate::operation::list_datasource_packages::ListDatasourcePackagesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_datasource_packages::ListDatasourcePackagesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_datasource_packages::ListDatasourcePackagesError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_datasource_packages::ListDatasourcePackagesOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListDatasourcePackages {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListDatasourcePackages");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListDatasourcePackagesRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListDatasourcePackagesResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListDatasourcePackages")
...
.with_interceptor(ListDatasourcePackagesEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_datasource_packages::ListDatasourcePackagesError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_datasource_packages::ListDatasourcePackagesError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_datasource_packages::ListDatasourcePackagesError>::new());
...
#[derive(Debug)]
            struct ListDatasourcePackagesResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListDatasourcePackagesResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_datasource_packages::de_list_datasource_packages_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_list_datasource_packages::de_list_datasource_packages_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct ListDatasourcePackagesRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListDatasourcePackagesRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_datasource_packages::ListDatasourcePackagesInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_datasource_packages::ListDatasourcePackagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/graph/datasources/list").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_datasource_packages::ser_list_datasource_packages_input(&input)?);
...
#[derive(Debug)]
            struct ListDatasourcePackagesEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListDatasourcePackagesEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListDatasourcePackagesEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListDatasourcePackagesInput>()
                        .ok_or("failed to downcast to ListDatasourcePackagesInput")?;
...
pub enum ListDatasourcePackagesError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListDatasourcePackagesError) for what information is available for the error.")]
...
impl ListDatasourcePackagesError {
    /// Creates the `ListDatasourcePackagesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDatasourcePackagesError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListDatasourcePackagesError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_datasource_packages::ListDatasourcePackagesError {
...
mod _list_datasource_packages_output;
