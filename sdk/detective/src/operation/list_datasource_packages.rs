    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/graph/datasources/list")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_datasource_packages::ListDatasourcePackages::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_datasource_packages::ListDatasourcePackagesError
{
