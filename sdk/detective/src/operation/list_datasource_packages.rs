...
impl ListDatasourcePackagesInput {
    /// Consumes the builder and constructs an Operation<[`ListDatasourcePackages`](crate::operation::list_datasource_packages::ListDatasourcePackages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_datasource_packages::ListDatasourcePackages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_datasource_packages::ListDatasourcePackagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_datasource_packages::ListDatasourcePackages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListDatasourcePackages", "detective"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
}
/// `ParseStrictResponse` impl for `ListDatasourcePackages`.
...
impl aws_smithy_http::response::ParseStrictResponse for ListDatasourcePackages {
                type Output = std::result::Result<crate::operation::list_datasource_packages::ListDatasourcePackagesOutput, crate::operation::list_datasource_packages::ListDatasourcePackagesError>;
