...
impl CreateGraphInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_graph::CreateGraph, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_graph::ser_create_graph_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGraph {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_graph::de_create_graph_http_response_with_props(status, headers, body)
        }
    }
}
