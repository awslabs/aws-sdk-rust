    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/graph/member/monitoringstate")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::start_monitoring_member::StartMonitoringMember::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::start_monitoring_member::StartMonitoringMemberError
{
