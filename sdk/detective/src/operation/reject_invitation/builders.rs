...
impl RejectInvitationFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::reject_invitation::RejectInvitationOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::reject_invitation::RejectInvitationError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::reject_invitation::RejectInvitationOutput, crate::operation::reject_invitation::RejectInvitationError, Self> {
