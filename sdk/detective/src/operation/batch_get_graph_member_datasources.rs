...
impl BatchGetGraphMemberDatasourcesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::batch_get_graph_member_datasources::BatchGetGraphMemberDatasources,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_graph_member_datasources::BatchGetGraphMemberDatasources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetGraphMemberDatasources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_graph_member_datasources::de_batch_get_graph_member_datasources_http_response_with_props(
                status, headers, body,
            )
        }
    }
