...
impl BatchGetMembershipDatasourcesInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::batch_get_membership_datasources::BatchGetMembershipDatasources::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetMembershipDatasources {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_batch_get_membership_datasources::de_batch_get_membership_datasources_http_response_with_props(
                status, headers, body,
            )
        }
    }
