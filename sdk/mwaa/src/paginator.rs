...
/// Flattened paginator for `ListEnvironmentsPaginator`
                ...
                impl  ListEnvironmentsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<std::string::String, aws_smithy_http::result::SdkError<crate::error::ListEnvironmentsError>>> + Unpin
                     {
