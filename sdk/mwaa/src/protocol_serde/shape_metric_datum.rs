...
pub fn ser_metric_datum(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MetricDatum) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
