...
pub fn ser_create_environment_input_input(
    ...
    if let Some(var_13) = &input.max_workers {
        object.key("MaxWorkers").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.min_workers {
        object.key("MinWorkers").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    ...
    if let Some(var_21) = &input.schedulers {
        object.key("Schedulers").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
