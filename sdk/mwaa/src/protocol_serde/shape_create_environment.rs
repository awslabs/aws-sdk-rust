...
pub fn ser_create_environment_input(
    ...
    crate::protocol_serde::shape_create_environment_input::ser_create_environment_input(
        &mut object,
        input,
    )?;
    object.finish();
...
pub fn de_create_environment_http_error(
...
> {
    ...
    Err(match error_code {
        "InternalServerException" => {
            crate::operation::create_environment::CreateEnvironmentError::InternalServerException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ValidationException" => {
            crate::operation::create_environment::CreateEnvironmentError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_environment_http_response(
    response: &http::Response<bytes::Bytes>,
) -> std::result::Result<
    crate::operation::create_environment::CreateEnvironmentOutput,
    crate::operation::create_environment::CreateEnvironmentError,
...
pub(crate) fn de_create_environment(
    value: &[u8],
