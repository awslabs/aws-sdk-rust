...
pub struct CreateWebLoginTokenOutput  {
    ...
    #[doc(hidden)]pub web_token: std::option::Option<std::string::String>,
    /// <p>The Airflow web server hostname for the environment.</p>
    #[doc(hidden)]pub web_server_hostname: std::option::Option<std::string::String>,
}
...
pub struct CreateCliTokenOutput  {
    ...
    #[doc(hidden)]pub cli_token: std::option::Option<std::string::String>,
    /// <p>The Airflow web server hostname for the environment.</p>
    #[doc(hidden)]pub web_server_hostname: std::option::Option<std::string::String>,
}
