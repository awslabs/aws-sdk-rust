...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_cli_token::builders::CreateCliTokenFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_cli_token::builders::CreateCliTokenFluentBuilder::set_name): <p>The name of the Amazon MWAA environment. For example, <code>MyMWAAEnvironment</code>.</p>
