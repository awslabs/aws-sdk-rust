...
impl super::Client {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_web_login_token::builders::CreateWebLoginTokenFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_web_login_token::builders::CreateWebLoginTokenFluentBuilder::set_name): <p>The name of the Amazon MWAA environment. For example, <code>MyMWAAEnvironment</code>.</p>
    ...
    pub fn create_web_login_token(
        &self,
    ) -> crate::operation::create_web_login_token::builders::CreateWebLoginTokenFluentBuilder {
        crate::operation::create_web_login_token::builders::CreateWebLoginTokenFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
