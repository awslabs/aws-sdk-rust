...
impl GetEnvironmentInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_environment::GetEnvironment, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEnvironment {
    type Output =
        ::std::result::Result<crate::operation::get_environment::GetEnvironmentOutput, crate::operation::get_environment::GetEnvironmentError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_environment::de_get_environment_http_response_with_props(status, headers, body)
        }
    }
