...
impl CreateWebLoginTokenInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::create_web_login_token::CreateWebLoginToken,
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWebLoginToken {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_web_login_token::de_create_web_login_token_http_response_with_props(status, headers, body)
        }
    }
