...
pub fn parse_create_cli_token_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateCliTokenOutput, crate::error::CreateCliTokenError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::CreateCliTokenError::unhandled)?;
...
pub fn parse_create_web_login_token_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::CreateWebLoginTokenOutput, crate::error::CreateWebLoginTokenError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::CreateWebLoginTokenError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
...
pub fn parse_publish_metrics_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::PublishMetricsOutput, crate::error::PublishMetricsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::json_deser::parse_http_error_metadata(response).map_err(crate::error::PublishMetricsError::unhandled)?;
    generic_builder = aws_http::request_id::apply_request_id(generic_builder, response.headers());
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
