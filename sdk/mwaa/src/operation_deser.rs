            ...
            crate::error::CreateCliTokenError {
                ...
                kind: crate::error::CreateCliTokenErrorKind::ResourceNotFoundException({
                    ...
                    let mut tmp = {
                        ...
                        let _ = response;
                        output = crate::json_deser::deser_structure_resource_not_found_exceptionjson_err(response.body().as_ref(), output).map_err(crate::error::CreateCliTokenError::unhandled)?;
                        output.build()
                    };
...
pub fn parse_create_cli_token_response(
    ...
    Ok({
        ...
        let _ = response;
        output =
            crate::json_deser::deser_operation_create_cli_token(response.body().as_ref(), output)
                .map_err(crate::error::CreateCliTokenError::unhandled)?;
        output.build()
    })
}
                ...
                kind: crate::error::CreateWebLoginTokenErrorKind::ResourceNotFoundException({
                    ...
                    let mut tmp = {
                        ...
                        let mut output =
                            crate::error::resource_not_found_exception::Builder::default();
                        let _ = response;
                        output = crate::json_deser::deser_structure_resource_not_found_exceptionjson_err(response.body().as_ref(), output).map_err(crate::error::CreateWebLoginTokenError::unhandled)?;
                        output.build()
                    };
                    if (&tmp.message).is_none() {
                        tmp.message = _error_message;
...
> {
    Ok({
        ...
        let _ = response;
        output = crate::json_deser::deser_operation_create_web_login_token(
            response.body().as_ref(),
            output,
        )
        .map_err(crate::error::CreateWebLoginTokenError::unhandled)?;
