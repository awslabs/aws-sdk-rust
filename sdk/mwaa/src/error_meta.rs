...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_cli_token::CreateCliTokenError, R>> for Error
where
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_web_login_token::CreateWebLoginTokenError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
...
impl From<crate::operation::create_web_login_token::CreateWebLoginTokenError> for Error {
    fn from(err: crate::operation::create_web_login_token::CreateWebLoginTokenError) -> Self {
        match err {
            ...
            crate::operation::create_web_login_token::CreateWebLoginTokenError::InternalServerException(inner) => {
                Error::InternalServerException(inner)
            }
            crate::operation::create_web_login_token::CreateWebLoginTokenError::ResourceNotFoundException(inner) => {
...
impl<R> From<::aws_smithy_runtime_api::client::result::SdkError<crate::operation::publish_metrics::PublishMetricsError, R>> for Error
where
    R: Send + Sync + std::fmt::Debug + 'static,
{
