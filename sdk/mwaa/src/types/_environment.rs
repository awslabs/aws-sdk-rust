...
pub struct Environment {
    ...
    /// <ul>
    /// <li>
    /// <p><code>CREATING</code> - The request to create the environment is in progress.</p></li>
    /// <li>
    /// <p><code>CREATING_SNAPSHOT</code> - The request to update environment details, or upgrade the environment version, is in progress and Amazon MWAA is creating a storage volume snapshot of the Amazon RDS database cluster associated with the environment. A database snapshot is a backup created at a specific point in time. Amazon MWAA uses snapshots to recover environment metadata if the process to update or upgrade an environment fails.</p></li>
    /// <li>
    /// <p><code>CREATE_FAILED</code> - The request to create the environment failed and the environment was not created.</p></li>
    /// <li>
    /// <p><code>AVAILABLE</code> - The request was successful and the environment is ready to use.</p></li>
    /// <li>
    /// <p><code>PENDING</code> - The request was successful, but the process to create the environment is paused until you create the required VPC endpoints in your VPC. After you create the VPC endpoints, the process resumes.</p></li>
    /// <li>
    /// <p><code>UPDATING</code> - The request to update the environment is in progress.</p></li>
    /// <li>
    /// <p><code>ROLLING_BACK</code> - The request to update environment details or upgrade the environment version failed and Amazon MWAA is restoring the environment using the latest storage volume snapshot.</p></li>
    /// <li>
    /// <p><code>DELETING</code> - The request to delete the environment is in progress.</p></li>
    /// <li>
    /// <p><code>DELETED</code> - The request to delete the environment is complete, and the environment has been deleted.</p></li>
    /// <li>
    /// <p><code>UNAVAILABLE</code> - The request failed, but the environment did not return to its previous state and is not stable.</p></li>
    /// <li>
    /// <p><code>UPDATE_FAILED</code> - The request to update the environment failed and the environment was restored to its previous state successfully and is ready to use.</p></li>
    /// <li>
    /// <p><code>MAINTENANCE</code> - The environment is undergoing maintenance. Depending on the type of work Amazon MWAA is performing, your environment might be unavailable during this process. Note that as part of the maintenance work, Amazon MWAA performs with a <code>GRACEFUL</code> <a href="https://docs.aws.amazon.com/mwaa/latest/API/API_UpdateEnvironment.html#mwaa-UpdateEnvironment-request-WorkerReplacementStrategy"> <code>workerReplacementStrategy</code> </a>.</p></li>
    /// </ul>
    /// <p>You can review our troubleshooting guide for a list of common errors and their solutions. For more information, refer to <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/troubleshooting.html">Amazon MWAA troubleshooting</a>.</p>
    ...
    /// <p>For more information, refer to <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-dag-import-plugins.html">Installing custom plugins</a>.</p>
    ...
    /// <p>Version IDs are Unicode, UTF-8 encoded, URL-ready, opaque strings that are no more than 1,024 bytes long. The following is an example:</p>
    /// <p><code>3sL4kqtJlcpXroDTDmJ+rmSpXd3dIbrHY+MTRCxf3vjVBH40Nr8X8gdRQBpUMLUo</code></p>
    /// <p>For more information, refer to <a href="https://docs.aws.amazon.com/mwaa/latest/userguide/working-dags-dependencies.html">Installing Python dependencies</a>.</p>
