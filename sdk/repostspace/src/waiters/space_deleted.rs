...
///
/// Fluent builder for the `space_deleted` waiter.
///
...
pub struct SpaceDeletedFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
    inner: crate::operation::get_space::builders::GetSpaceInputBuilder,
}
impl SpaceDeletedFluentBuilder {
    /// Creates a new `SpaceDeletedFluentBuilder`.
    ...
    pub async fn wait(
    ...
    ) -> ::std::result::Result<crate::waiters::space_deleted::SpaceDeletedFinalPoll, crate::waiters::space_deleted::WaitUntilSpaceDeletedError> {
        let input = self
            .inner
            .build()
        ...
        let acceptor =
            move |result: ::std::result::Result<&crate::operation::get_space::GetSpaceOutput, &crate::operation::get_space::GetSpaceError>| {
                ...
                if crate::waiters::matchers::match_get_space_1cce2c05524fb92d4(result) {
                    return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
                }
                // Matches: {"output":{"path":"status","expected":"DELETED","comparator":"stringEquals"}}
                if crate::waiters::matchers::match_get_space_8edac4c36e2a37f69(result) {
                    return ::aws_smithy_runtime::client::waiters::AcceptorState::Success;
                }
                // Matches: {"output":{"path":"status","expected":"DELETE_FAILED","comparator":"stringEquals"}}
                if crate::waiters::matchers::match_get_space_184758db81b6271a8(result) {
                ...
                if crate::waiters::matchers::match_get_space_ac9cf40eec4f10ab5(result) {
...
/// Successful return type for the `space_deleted` waiter.
pub type SpaceDeletedFinalPoll = ::aws_smithy_runtime_api::client::waiters::FinalPoll<
...
/// Error type for the `space_deleted` waiter.
pub type WaitUntilSpaceDeletedError = ::aws_smithy_runtime_api::client::waiters::error::WaiterError<
    crate::operation::get_space::GetSpaceOutput,
    crate::operation::get_space::GetSpaceError,
>;
