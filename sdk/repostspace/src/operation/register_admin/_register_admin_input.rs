...
impl RegisterAdminInput {
    /// Creates a new builder-style object to manufacture [`RegisterAdminInput`](crate::operation::register_admin::RegisterAdminInput).
    pub fn builder() -> crate::operation::register_admin::builders::RegisterAdminInputBuilder {
        crate::operation::register_admin::builders::RegisterAdminInputBuilder::default()
    }
}
