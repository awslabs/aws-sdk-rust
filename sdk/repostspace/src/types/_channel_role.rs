...
impl ::std::convert::From<&str> for ChannelRole {
    fn from(s: &str) -> Self {
        match s {
            "ASKER" => ChannelRole::Asker,
            "EXPERT" => ChannelRole::Expert,
            "MODERATOR" => ChannelRole::Moderator,
            "SUPPORTREQUESTOR" => ChannelRole::Supportrequestor,
...
impl ChannelRole {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ChannelRole::Asker => "ASKER",
            ChannelRole::Expert => "EXPERT",
            ChannelRole::Moderator => "MODERATOR",
            ChannelRole::Supportrequestor => "SUPPORTREQUESTOR",
...
impl ::std::fmt::Display for ChannelRole {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ChannelRole::Asker => write!(f, "ASKER"),
