...
pub struct SendCommandOutput  {
    ...
    #[doc(hidden)]pub start_session: std::option::Option<crate::model::StartSessionResult>,
    /// <p>Contains the details of the started transaction.</p>
    #[doc(hidden)]pub start_transaction: std::option::Option<crate::model::StartTransactionResult>,
    /// <p>Contains the details of the ended session.</p>
    #[doc(hidden)]pub end_session: std::option::Option<crate::model::EndSessionResult>,
    /// <p>Contains the details of the committed transaction.</p>
    #[doc(hidden)]pub commit_transaction: std::option::Option<crate::model::CommitTransactionResult>,
    /// <p>Contains the details of the aborted transaction.</p>
    #[doc(hidden)]pub abort_transaction: std::option::Option<crate::model::AbortTransactionResult>,
    /// <p>Contains the details of the executed statement.</p>
    #[doc(hidden)]pub execute_statement: std::option::Option<crate::model::ExecuteStatementResult>,
    /// <p>Contains the details of the fetched page.</p>
    #[doc(hidden)]pub fetch_page: std::option::Option<crate::model::FetchPageResult>,
}
impl SendCommandOutput {
    ...
    /// <p>Contains the details of the committed transaction.</p>
    pub fn commit_transaction(&self) -> std::option::Option<& crate::model::CommitTransactionResult> {
...
pub mod send_command_output {
    ...
    impl Builder {
        ...
        /// <p>Contains the details of the started session that includes a session token. This <code>SessionToken</code> is required for every subsequent command that is issued during the current session.</p>
        pub fn set_start_session(mut self, input: std::option::Option<crate::model::StartSessionResult>) -> Self {
        ...
        /// <p>Contains the details of the started transaction.</p>
        pub fn set_start_transaction(mut self, input: std::option::Option<crate::model::StartTransactionResult>) -> Self {
        ...
        /// <p>Contains the details of the ended session.</p>
        pub fn set_end_session(mut self, input: std::option::Option<crate::model::EndSessionResult>) -> Self {
        ...
        /// <p>Contains the details of the committed transaction.</p>
        pub fn set_commit_transaction(mut self, input: std::option::Option<crate::model::CommitTransactionResult>) -> Self {
        ...
        /// <p>Contains the details of the aborted transaction.</p>
        pub fn set_abort_transaction(mut self, input: std::option::Option<crate::model::AbortTransactionResult>) -> Self {
        ...
        /// <p>Contains the details of the executed statement.</p>
        pub fn set_execute_statement(mut self, input: std::option::Option<crate::model::ExecuteStatementResult>) -> Self {
