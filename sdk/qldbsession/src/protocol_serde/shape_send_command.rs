...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_command_http_response_with_props(
    _response_status: u16,
    _response_headers: &::http::header::HeaderMap,
    _response_body: &[u8],
) -> std::result::Result<crate::operation::send_command::SendCommandOutput, crate::operation::send_command::SendCommandError> {
...
) -> Result<crate::operation::send_command::builders::SendCommandOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
