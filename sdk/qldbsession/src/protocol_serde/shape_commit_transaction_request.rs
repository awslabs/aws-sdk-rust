...
pub fn ser_commit_transaction_request(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CommitTransactionRequest) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
