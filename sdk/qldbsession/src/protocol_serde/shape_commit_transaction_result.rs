...
pub(crate) fn de_commit_transaction_result<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CommitTransactionResult>, aws_smithy_json::deserialize::error::DeserializeError>
