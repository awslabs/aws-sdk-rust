...
pub(crate) fn de_start_session_result<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::StartSessionResult>, aws_smithy_json::deserialize::error::DeserializeError>
