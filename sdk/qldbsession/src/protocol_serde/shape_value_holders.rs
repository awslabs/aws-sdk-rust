...
pub(crate) fn de_value_holders<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::ValueHolder>>, aws_smithy_json::deserialize::error::DeserializeError>
