    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///   - [`session_token(Option<String>)`](crate::input::SendCommandInput::session_token): <p>Specifies the session token for the current command. A session token is constant throughout the life of the session.</p>  <p>To obtain a session token, run the <code>StartSession</code> command. This <code>SessionToken</code> is required for every subsequent command that is issued during the current session.</p>
    ///   - [`start_session(Option<StartSessionRequest>)`](crate::input::SendCommandInput::start_session): <p>Command to start a new session. A session token is obtained as part of the response.</p>
    ///   - [`start_transaction(Option<StartTransactionRequest>)`](crate::input::SendCommandInput::start_transaction): <p>Command to start a new transaction.</p>
    ///   - [`end_session(Option<EndSessionRequest>)`](crate::input::SendCommandInput::end_session): <p>Command to end the current session.</p>
    ///   - [`commit_transaction(Option<CommitTransactionRequest>)`](crate::input::SendCommandInput::commit_transaction): <p>Command to commit the specified transaction.</p>
    ///   - [`abort_transaction(Option<AbortTransactionRequest>)`](crate::input::SendCommandInput::abort_transaction): <p>Command to abort the current transaction.</p>
    ///   - [`execute_statement(Option<ExecuteStatementRequest>)`](crate::input::SendCommandInput::execute_statement): <p>Command to execute a statement in the specified transaction.</p>
    ///   - [`fetch_page(Option<FetchPageRequest>)`](crate::input::SendCommandInput::fetch_page): <p>Command to fetch a page.</p>
