...
pub mod send_command_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::SendCommandInput, aws_smithy_http::operation::error::BuildError> {
            Ok(
...
impl SendCommandInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::SendCommand, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::input::SendCommandInput, output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
