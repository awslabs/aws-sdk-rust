...
pub fn serialize_structure_send_command_input(
    ...
    if let Some(var_2) = &input.start_session {
        ...
        crate::json_ser::serialize_structure_start_session_request(&mut object_3, var_2);
        object_3.finish();
    }
    if let Some(var_4) = &input.start_transaction {
        let mut object_5 = object.key("StartTransaction").start_object();
        crate::json_ser::serialize_structure_start_transaction_request(&mut object_5, var_4);
        object_5.finish();
    }
    if let Some(var_6) = &input.end_session {
        let mut object_7 = object.key("EndSession").start_object();
        crate::json_ser::serialize_structure_end_session_request(&mut object_7, var_6);
        object_7.finish();
    }
    if let Some(var_8) = &input.commit_transaction {
        let mut object_9 = object.key("CommitTransaction").start_object();
        crate::json_ser::serialize_structure_commit_transaction_request(&mut object_9, var_8);
        object_9.finish();
    }
    if let Some(var_10) = &input.abort_transaction {
        let mut object_11 = object.key("AbortTransaction").start_object();
        crate::json_ser::serialize_structure_abort_transaction_request(&mut object_11, var_10);
        object_11.finish();
    }
    if let Some(var_12) = &input.execute_statement {
        let mut object_13 = object.key("ExecuteStatement").start_object();
        crate::json_ser::serialize_structure_execute_statement_request(&mut object_13, var_12);
        object_13.finish();
    }
    if let Some(var_14) = &input.fetch_page {
        let mut object_15 = object.key("FetchPage").start_object();
        crate::json_ser::serialize_structure_fetch_page_request(&mut object_15, var_14);
        object_15.finish();
    }
}

pub fn serialize_structure_start_session_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_start_transaction_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_end_session_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_commit_transaction_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_abort_transaction_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_execute_statement_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_fetch_page_request(
    object: &mut smithy_json::serialize::JsonObjectWriter,
