...
pub fn parse_create_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::CreatePipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => {
            crate::error::CreatePipeError::ServiceQuotaExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ThrottlingException" => {
            crate::error::CreatePipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => {
            crate::error::CreatePipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
pub fn parse_delete_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::DeletePipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::not_found_exception::Builder::default();
        ...
        "ThrottlingException" => {
            crate::error::DeletePipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::DeletePipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_describe_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::DescribePipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::not_found_exception::Builder::default();
        ...
        "ThrottlingException" => {
            crate::error::DescribePipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::DescribePipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_list_pipes_error(
    ...
    Err(match error_code {
        ...
        "ThrottlingException" => {
            crate::error::ListPipesError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::ListPipesError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_start_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::StartPipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::not_found_exception::Builder::default();
        ...
        "ThrottlingException" => {
            crate::error::StartPipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::StartPipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_stop_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::StopPipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::not_found_exception::Builder::default();
        ...
        "ThrottlingException" => {
            crate::error::StopPipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::StopPipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
...
pub fn parse_update_pipe_error(
    ...
    Err(match error_code {
        ...
        "NotFoundException" => {
            crate::error::UpdatePipeError::NotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::not_found_exception::Builder::default();
        ...
        "ThrottlingException" => {
            crate::error::UpdatePipeError::ThrottlingException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::throttling_exception::Builder::default();
        ...
        "ValidationException" => {
            crate::error::UpdatePipeError::ValidationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output = crate::error::validation_exception::Builder::default();
