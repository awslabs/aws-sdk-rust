...
impl UpdatePipeSourceKinesisStreamParameters {
    /// Creates a new builder-style object to manufacture [`UpdatePipeSourceKinesisStreamParameters`](crate::types::UpdatePipeSourceKinesisStreamParameters).
    pub fn builder() -> crate::types::builders::UpdatePipeSourceKinesisStreamParametersBuilder {
        crate::types::builders::UpdatePipeSourceKinesisStreamParametersBuilder::default()
    }
}
...
impl UpdatePipeSourceKinesisStreamParametersBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdatePipeSourceKinesisStreamParameters`](crate::types::UpdatePipeSourceKinesisStreamParameters).
    pub fn build(self) -> crate::types::UpdatePipeSourceKinesisStreamParameters {
        crate::types::UpdatePipeSourceKinesisStreamParameters {
