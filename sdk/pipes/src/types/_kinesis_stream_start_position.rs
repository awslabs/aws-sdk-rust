...
impl ::std::convert::From<&str> for KinesisStreamStartPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => KinesisStreamStartPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for KinesisStreamStartPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(KinesisStreamStartPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for KinesisStreamStartPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
