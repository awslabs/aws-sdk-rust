...
impl ::std::convert::From<&str> for SelfManagedKafkaStartPosition {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => SelfManagedKafkaStartPosition::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for SelfManagedKafkaStartPosition {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(SelfManagedKafkaStartPosition::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for SelfManagedKafkaStartPosition {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
