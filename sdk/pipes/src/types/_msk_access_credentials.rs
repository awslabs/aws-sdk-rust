...
impl MskAccessCredentials {
    ...
    pub fn as_client_certificate_tls_auth(&self) -> ::std::result::Result<&::std::string::String, &Self> {
        if let MskAccessCredentials::ClientCertificateTlsAuth(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_sasl_scram512_auth(&self) -> ::std::result::Result<&::std::string::String, &Self> {
        if let MskAccessCredentials::SaslScram512Auth(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
