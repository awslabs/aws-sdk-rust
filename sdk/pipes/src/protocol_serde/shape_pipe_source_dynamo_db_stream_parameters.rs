...
pub fn ser_pipe_source_dynamo_db_stream_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PipeSourceDynamoDbStreamParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
