...
pub fn ser_pipe_enrichment_http_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipeEnrichmentHttpParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pipe_enrichment_http_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipeEnrichmentHttpParameters>, aws_smithy_json::deserialize::error::DeserializeError>
