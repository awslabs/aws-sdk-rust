...
pub fn ser_create_pipe_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreatePipeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
