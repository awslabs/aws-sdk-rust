...
pub fn ser_batch_container_overrides(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::BatchContainerOverrides) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_batch_container_overrides<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::BatchContainerOverrides>, aws_smithy_json::deserialize::error::DeserializeError>
