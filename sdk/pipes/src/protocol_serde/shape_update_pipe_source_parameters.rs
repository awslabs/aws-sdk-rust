...
pub fn ser_update_pipe_source_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdatePipeSourceParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
