...
pub fn ser_ecs_task_override(
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_ecs_container_override::ser_ecs_container_override(
                    &mut object_4,
                    item_3,
                )?;
                object_4.finish();
    ...
    if let Some(var_6) = &input.ephemeral_storage {
        ...
        crate::protocol_serde::shape_ecs_ephemeral_storage::ser_ecs_ephemeral_storage(
            &mut object_7,
            var_6,
        )?;
        object_7.finish();
...
pub(crate) fn de_ecs_task_override<'a, I>(
    ...
    Option<crate::types::EcsTaskOverride>,
