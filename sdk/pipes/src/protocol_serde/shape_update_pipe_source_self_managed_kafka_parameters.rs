...
pub fn ser_update_pipe_source_self_managed_kafka_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::UpdatePipeSourceSelfManagedKafkaParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
