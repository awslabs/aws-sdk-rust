...
pub fn ser_ecs_container_override(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EcsContainerOverride) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_ecs_container_override<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::EcsContainerOverride>, aws_smithy_json::deserialize::error::DeserializeError>
