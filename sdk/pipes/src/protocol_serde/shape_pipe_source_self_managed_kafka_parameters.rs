...
pub fn ser_pipe_source_self_managed_kafka_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipeSourceSelfManagedKafkaParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pipe_source_self_managed_kafka_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipeSourceSelfManagedKafkaParameters>, aws_smithy_json::deserialize::error::DeserializeError>
