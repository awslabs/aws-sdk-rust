...
pub fn ser_pipe_source_self_managed_kafka_parameters(
    ...
    if let Some(var_8) = &input.credentials {
        ...
        crate::protocol_serde::shape_self_managed_kafka_access_configuration_credentials::ser_self_managed_kafka_access_configuration_credentials(&mut object_9, var_8)?;
        object_9.finish();
    }
    ...
    if let Some(var_11) = &input.vpc {
        ...
        crate::protocol_serde::shape_self_managed_kafka_access_configuration_vpc::ser_self_managed_kafka_access_configuration_vpc(&mut object_12, var_11)?;
        object_12.finish();
    }
    Ok(())
}
...
pub(crate) fn de_pipe_source_self_managed_kafka_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PipeSourceSelfManagedKafkaParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::pipe_source_self_managed_kafka_parameters_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
