...
pub fn ser_pipe_target_http_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PipeTargetHttpParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pipe_target_http_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::PipeTargetHttpParameters>, aws_smithy_json::deserialize::error::DeserializeError>
