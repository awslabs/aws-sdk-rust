...
pub fn ser_pipe_source_kinesis_stream_parameters(
    ...
    if let Some(var_9) = &input.starting_position_timestamp {
        object.key("StartingPositionTimestamp").date_time(var_9, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    Ok(())
}
...
pub(crate) fn de_pipe_source_kinesis_stream_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PipeSourceKinesisStreamParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::pipe_source_kinesis_stream_parameters_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
