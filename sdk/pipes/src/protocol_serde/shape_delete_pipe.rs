...
pub fn de_delete_pipe_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_pipe::DeletePipeOutput, crate::operation::delete_pipe::DeletePipeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::operation::delete_pipe::DeletePipeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_pipe_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::operation::delete_pipe::DeletePipeOutput, crate::operation::delete_pipe::DeletePipeError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_pipe::builders::DeletePipeOutputBuilder::default();
        let _ = response;
        output = crate::protocol_serde::shape_delete_pipe::de_delete_pipe(response.body().as_ref(), output).map_err(crate::operation::delete_pipe::DeletePipeError::unhandled)?;
