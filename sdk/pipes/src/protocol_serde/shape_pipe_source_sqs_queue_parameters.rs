...
pub(crate) fn de_pipe_source_sqs_queue_parameters<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::PipeSourceSqsQueueParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
