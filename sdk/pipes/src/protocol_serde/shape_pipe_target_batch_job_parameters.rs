...
pub fn ser_pipe_target_batch_job_parameters(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::PipeTargetBatchJobParameters) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_pipe_target_batch_job_parameters<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::PipeTargetBatchJobParameters>, aws_smithy_json::deserialize::error::DeserializeError>
