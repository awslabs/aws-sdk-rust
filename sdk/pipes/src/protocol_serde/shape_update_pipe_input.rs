...
pub fn ser_update_pipe_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::UpdatePipeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
