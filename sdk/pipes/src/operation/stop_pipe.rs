    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/pipes/{Name}/stop", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::stop_pipe::StopPipe::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopPipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_stop_pipe::de_stop_pipe_http_response_with_props(
                status, headers, body,
            )
        }
    }
