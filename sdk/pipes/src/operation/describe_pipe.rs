...
impl DescribePipeInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_pipe::DescribePipe::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_pipe::de_describe_pipe_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_describe_pipe::de_describe_pipe_http_response_with_props(
                status, headers, body,
            )
        }
    }
