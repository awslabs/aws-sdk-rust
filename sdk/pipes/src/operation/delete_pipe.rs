...
impl DeletePipeInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::delete_pipe::DeletePipe,
    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/pipes/{Name}", Name = name)
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::delete_pipe::DeletePipe::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePipe {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_delete_pipe::de_delete_pipe_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_delete_pipe::de_delete_pipe_http_response_with_props(
                status, headers, body,
            )
        }
    }
