...
pub struct PlacementTemplate  {
    ...
    #[doc(hidden)]pub default_attributes: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    /// <p>An object specifying the <code>DeviceTemplate</code> for all placements using this (<code>PlacementTemplate</code>) template.</p>
    #[doc(hidden)]pub device_templates: std::option::Option<std::collections::HashMap<std::string::String, crate::model::DeviceTemplate>>,
}
...
pub struct DeviceTemplate  {
    ...
    #[doc(hidden)]pub callback_overrides: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
impl DeviceTemplate {
    /// <p>The device type, which currently must be <code>"button"</code>.</p>
...
pub struct ProjectSummary  {
    ...
    #[doc(hidden)]pub updated_date: std::option::Option<aws_smithy_types::DateTime>,
...
pub struct PlacementSummary  {
    ...
    #[doc(hidden)]pub placement_name: std::option::Option<std::string::String>,
...
pub struct ProjectDescription  {
    ...
    #[doc(hidden)]pub placement_template: std::option::Option<crate::model::PlacementTemplate>,
    /// <p>The tags (metadata key/value pairs) associated with the project.</p>
    #[doc(hidden)]pub tags: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
