...
/// Paginator for [`ListPlacements`](crate::operation::ListPlacements)
            ...
            impl ListPlacementsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::input::list_placements_input::Builder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::output::ListPlacementsOutput, aws_smithy_http::result::SdkError<crate::error::ListPlacementsError>>> + Unpin
                 {
                    ...
                    aws_smithy_async::future::fn_stream::FnStream::new(move |tx| Box::pin(async move {
                        ...
                        loop {
                            ...
                            let done = match resp {
                                Ok(ref resp) => {
                                    let new_token = crate::lens::reflens_list_placements_output_next_token(resp);
...
/// Flattened paginator for `ListPlacementsPaginator`
                ...
                impl  ListPlacementsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl tokio_stream::Stream<Item = std::result::Result<crate::model::PlacementSummary, aws_smithy_http::result::SdkError<crate::error::ListPlacementsError>>> + Unpin
                     {
                        aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send()).flat_map(|page| crate::lens::lens_list_placements_output_placements(page).unwrap_or_default().into_iter())
                    }
                }
