...
mod associate_device_with_placement;

mod create_placement;
...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_iot1clickprojects::Error> {
/// # let client: aws_sdk_iot1clickprojects::Client = unimplemented!();
...
mod delete_placement;

mod delete_project;

mod describe_placement;

mod describe_project;

mod disassociate_device_from_placement;

mod get_devices_in_placement;
