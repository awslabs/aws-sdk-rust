...
pub struct ListPlacementsOutput  {
    ...
    #[doc(hidden)]pub placements: std::option::Option<std::vec::Vec<crate::model::PlacementSummary>>,
    /// <p>The token used to retrieve the next set of results - will be effectively empty if there are no further results.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
}
...
pub struct GetDevicesInPlacementOutput  {
    ...
    #[doc(hidden)]pub devices: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
}
...
pub struct DescribeProjectOutput  {
    ...
    #[doc(hidden)]pub project: std::option::Option<crate::model::ProjectDescription>,
}
...
pub struct DescribePlacementOutput  {
    ...
    #[doc(hidden)]pub placement: std::option::Option<crate::model::PlacementDescription>,
}
