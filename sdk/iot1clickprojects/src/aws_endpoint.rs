    ...
    aws_endpoint::PartitionResolver::new(
        ...
        .default_endpoint(
            aws_endpoint::partition::endpoint::Metadata {
                uri_template: "projects.iot1click.{region}.amazonaws.com",
        ...
        vec![
            ...
            .default_endpoint(
                aws_endpoint::partition::endpoint::Metadata {
                    uri_template: "projects.iot1click.{region}.amazonaws.com.cn",
                    protocol: aws_endpoint::partition::endpoint::Protocol::Https,
                    signature_versions: aws_endpoint::partition::endpoint::SignatureVersion::V4,
                    credential_scope:
                        aws_endpoint::CredentialScope::builder()
            ...
            .default_endpoint(
                aws_endpoint::partition::endpoint::Metadata {
                    uri_template: "projects.iot1click.{region}.c2s.ic.gov",
                    protocol: aws_endpoint::partition::endpoint::Protocol::Https,
                    signature_versions: aws_endpoint::partition::endpoint::SignatureVersion::V4,
                    credential_scope:
                        aws_endpoint::CredentialScope::builder()
            ...
            .default_endpoint(
                aws_endpoint::partition::endpoint::Metadata {
                    uri_template: "projects.iot1click.{region}.sc2s.sgov.gov",
                    protocol: aws_endpoint::partition::endpoint::Protocol::Https,
                    signature_versions: aws_endpoint::partition::endpoint::SignatureVersion::V4,
                    credential_scope:
                        aws_endpoint::CredentialScope::builder()
