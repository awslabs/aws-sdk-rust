...
pub(crate) fn de_project_description<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ProjectDescription>, aws_smithy_json::deserialize::error::DeserializeError>
