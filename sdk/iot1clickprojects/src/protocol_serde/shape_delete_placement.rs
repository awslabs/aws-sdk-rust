...
pub fn de_delete_placement_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeletePlacementOutput, crate::error::DeletePlacementError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::DeletePlacementError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_placement_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::DeletePlacementOutput, crate::error::DeletePlacementError> {
    Ok({
        #[allow(unused_mut)]
