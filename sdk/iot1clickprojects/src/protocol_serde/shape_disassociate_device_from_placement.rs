...
pub fn de_disassociate_device_from_placement_http_error(_response_status: u16, _response_headers: &http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementOutput, crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError> {
    #[allow(unused_mut)]
