...
pub fn de_disassociate_device_from_placement_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementOutput, crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    crate::serde_util::internal_failure_exception_correct_errors(output).build().map_err(crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::invalid_request_exception_correct_errors(output).build().map_err(crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::resource_not_found_exception_correct_errors(output).build().map_err(crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError::unhandled)?
                }
            ;
            tmp
        }),
            ...
            let mut tmp =
                 {
                    ...
                    let output = output.meta(generic);
                    crate::serde_util::too_many_requests_exception_correct_errors(output).build().map_err(crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError::unhandled)?
                }
            ;
            tmp
        }),
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_device_from_placement_http_response(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementOutput, crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacementError> {
    Ok({
        #[allow(unused_mut)]
