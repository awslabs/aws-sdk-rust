...
impl super::Client {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::get_devices_in_placement::builders::GetDevicesInPlacementFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::get_devices_in_placement::builders::GetDevicesInPlacementFluentBuilder::set_project_name): <p>The name of the project containing the placement.</p>
    ///   - [`placement_name(impl ::std::convert::Into<String>)`](crate::operation::get_devices_in_placement::builders::GetDevicesInPlacementFluentBuilder::placement_name) / [`set_placement_name(Option<String>)`](crate::operation::get_devices_in_placement::builders::GetDevicesInPlacementFluentBuilder::set_placement_name): <p>The name of the placement to get the devices from.</p>
