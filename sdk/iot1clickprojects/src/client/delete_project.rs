...
impl super::Client {
    ...
    ///   - [`project_name(impl Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_project_name):<br>required: **true**<br><p>The name of the empty project to delete.</p><br>
