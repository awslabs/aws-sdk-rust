...
impl super::Client {
    ...
    ///   - [`placement_name(impl ::std::convert::Into<String>)`](crate::operation::create_placement::builders::CreatePlacementFluentBuilder::placement_name) / [`set_placement_name(Option<String>)`](crate::operation::create_placement::builders::CreatePlacementFluentBuilder::set_placement_name): <p>The name of the placement to be created.</p>
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::create_placement::builders::CreatePlacementFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::create_placement::builders::CreatePlacementFluentBuilder::set_project_name): <p>The name of the project in which to create the placement.</p>
