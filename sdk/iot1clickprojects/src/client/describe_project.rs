...
impl super::Client {
    ...
    ///   - [`project_name(impl Into<String>)`](crate::operation::describe_project::builders::DescribeProjectFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::describe_project::builders::DescribeProjectFluentBuilder::set_project_name):<br>required: **true**<br><p>The name of the project to be described.</p><br>
