...
impl super::Client {
    ...
    ///   - [`placement_name(impl ::std::convert::Into<String>)`](crate::operation::update_placement::builders::UpdatePlacementFluentBuilder::placement_name) / [`set_placement_name(Option<String>)`](crate::operation::update_placement::builders::UpdatePlacementFluentBuilder::set_placement_name): <p>The name of the placement to update.</p>
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::update_placement::builders::UpdatePlacementFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::update_placement::builders::UpdatePlacementFluentBuilder::set_project_name): <p>The name of the project containing the placement to be updated.</p>
