...
pub use crate::operation::delete_placement::_delete_placement_output::DeletePlacementOutputBuilder;
...
pub struct DeletePlacementFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_placement::builders::DeletePlacementInputBuilder,
...
impl
                crate::client::customize::internal::CustomizableSend<
                    crate::operation::delete_placement::DeletePlacementOutput,
                    crate::operation::delete_placement::DeletePlacementError,
                > for DeletePlacementFluentBuilder
            {
                fn send(
                    self,
...
impl DeletePlacementFluentBuilder {
    ...
    pub fn as_input(&self) -> &crate::operation::delete_placement::builders::DeletePlacementInputBuilder {
        &self.inner
    }
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::delete_placement::DeletePlacementOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::delete_placement::DeletePlacementError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let input = self.inner.build().map_err(::aws_smithy_runtime_api::client::result::SdkError::construction_failure)?;
                        let runtime_plugins = crate::operation::delete_placement::DeletePlacement::operation_runtime_plugins(
                            self.handle.runtime_plugins.clone(),
                            &self.handle.conf,
                            self.config_override,
                        );
                        crate::operation::delete_placement::DeletePlacement::orchestrate(&runtime_plugins, input).await
                    }
    
                    /// Consumes this builder, creating a customizable operation that can be modified before being sent.
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::delete_placement::DeletePlacementOutput, crate::operation::delete_placement::DeletePlacementError, Self> {
