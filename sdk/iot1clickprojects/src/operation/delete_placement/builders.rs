...
impl DeletePlacementFluentBuilder  {
    /// Creates a new `DeletePlacement`.
                    ...
                    pub async fn customize(self) -> std::result::Result<
                        crate::client::customize::CustomizableOperation<crate::operation::delete_placement::DeletePlacement, aws_http::retry::AwsResponseRetryClassifier,>,
                        aws_smithy_http::result::SdkError<crate::operation::delete_placement::DeletePlacementError>
                    >  {
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::delete_placement::DeletePlacementOutput, aws_smithy_http::result::SdkError<crate::operation::delete_placement::DeletePlacementError>>
                     {
