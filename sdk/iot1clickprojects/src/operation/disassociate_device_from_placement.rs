...
impl DisassociateDeviceFromPlacementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::disassociate_device_from_placement::DisassociateDeviceFromPlacement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDeviceFromPlacement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_disassociate_device_from_placement::de_disassociate_device_from_placement_http_response_with_props(
                status, headers, body,
            )
        }
    }
