...
impl DeletePlacementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::delete_placement::DeletePlacement, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePlacement {
    type Output =
        ::std::result::Result<crate::operation::delete_placement::DeletePlacementOutput, crate::operation::delete_placement::DeletePlacementError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_delete_placement::de_delete_placement_http_response_with_props(status, headers, body)
        }
    }
}
