...
impl ListPlacementsInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::list_placements::ListPlacements, ::aws_http::retry::AwsResponseRetryClassifier>,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPlacements {
    type Output =
        ::std::result::Result<crate::operation::list_placements::ListPlacementsOutput, crate::operation::list_placements::ListPlacementsError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_placements::de_list_placements_http_response_with_props(status, headers, body)
        }
    }
}
