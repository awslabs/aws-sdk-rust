...
impl DescribePlacementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_placement::DescribePlacement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePlacement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_describe_placement::de_describe_placement_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_placement::DescribePlacementError
{
