...
impl UpdatePlacementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::update_placement::UpdatePlacement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_placement::ser_update_placement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePlacement {
    type Output =
        ::std::result::Result<crate::operation::update_placement::UpdatePlacementOutput, crate::operation::update_placement::UpdatePlacementError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_placement::de_update_placement_http_response_with_props(status, headers, body)
        }
    }
}
