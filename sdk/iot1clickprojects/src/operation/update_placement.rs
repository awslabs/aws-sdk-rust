...
impl UpdatePlacementInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_placement::UpdatePlacement::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePlacement {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_update_placement::de_update_placement_http_error(
                status, headers, body,
            )
        } else {
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_placement::UpdatePlacementError
{
