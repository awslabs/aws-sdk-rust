...
impl CreatePlacementInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_placement::CreatePlacement, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_placement::ser_create_placement_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePlacement {
    type Output =
        ::std::result::Result<crate::operation::create_placement::CreatePlacementOutput, crate::operation::create_placement::CreatePlacementError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_placement::de_create_placement_http_response_with_props(status, headers, body)
        }
    }
}
