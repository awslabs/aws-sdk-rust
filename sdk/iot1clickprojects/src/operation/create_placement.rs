    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement::CreatePlacementError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(
            ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement::CreatePlacementOutput>::assume_from(output)
    ...
    fn runtime_components(&self) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
        ...
        ::std::borrow::Cow::Owned(
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePlacement")
                ...
                .with_interceptor(
                    ::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::new(CreatePlacementEndpointParamsInterceptor) as _,
                ),
        )
    }
}
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for CreatePlacementResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for CreatePlacementRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::create_placement::CreatePlacementInput>::assume_from(input)
            .expect("correct type")
            .unwrap();
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_placement::ser_create_placement_input(&input)?);
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for CreatePlacementEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_placement::CreatePlacementError {
