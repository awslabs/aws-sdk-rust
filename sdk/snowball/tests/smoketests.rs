...
//! ```
use aws_sdk_snowball::{config, Client};
/// Smoke tests for the `describe_addresses` operation
#[::tokio::test]
async fn test_describe_addresses_success() {
    ...
    let res = client.describe_addresses().send().await;
