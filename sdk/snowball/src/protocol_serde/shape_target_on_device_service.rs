...
pub fn ser_target_on_device_service(
    ...
    #[allow(unused)] input: &crate::types::TargetOnDeviceService,
    ...
    if let Some(var_2) = &input.transfer_option {
        encoder.str("TransferOption").str(var_2.as_str());
    }
    encoder.end();
    Ok(())
}

pub(crate) fn de_target_on_device_service(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::TargetOnDeviceService, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::TargetOnDeviceServiceBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
