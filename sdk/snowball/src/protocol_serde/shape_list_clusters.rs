...
pub fn ser_list_clusters_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_clusters_input::ser_list_clusters_input_input(encoder, input)?;
    }
...
pub(crate) fn de_list_clusters(
    ...
    ) -> ::std::result::Result<crate::operation::list_clusters::builders::ListClustersOutputBuilder, ::aws_smithy_cbor::decode::DeserializeError>
    {
        builder = match decoder.str()?.as_ref() {
            "ClusterListEntries" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(
