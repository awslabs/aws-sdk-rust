    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "JobMetadata" => {
                    builder = builder.set_job_metadata(crate::protocol_serde::shape_job_metadata::de_job_metadata(tokens, _value)?);
                }
                "SubJobMetadata" => {
                    builder = builder.set_sub_job_metadata(crate::protocol_serde::shape_job_metadata_list::de_job_metadata_list(tokens, _value)?);
                }
