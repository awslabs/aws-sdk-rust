...
pub(crate) fn de_invalid_next_token_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidNextTokenExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidNextTokenExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
