...
pub(crate) fn de_invalid_resource_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidResourceExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidResourceExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
