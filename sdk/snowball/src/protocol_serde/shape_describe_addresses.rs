...
) -> Result<crate::operation::describe_addresses::builders::DescribeAddressesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
    ...
    loop {
        match tokens.next().transpose()? {
            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                "Addresses" => {
                    builder = builder.set_addresses(crate::protocol_serde::shape_address_list::de_address_list(tokens)?);
                }
                "NextToken" => {
