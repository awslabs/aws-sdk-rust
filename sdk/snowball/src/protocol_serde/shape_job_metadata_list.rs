...
pub(crate) fn de_job_metadata_list<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::types::JobMetadata>>, aws_smithy_json::deserialize::error::DeserializeError>
