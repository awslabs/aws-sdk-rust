...
pub(crate) fn de_tgw_on_device_service_configuration<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TgwOnDeviceServiceConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
