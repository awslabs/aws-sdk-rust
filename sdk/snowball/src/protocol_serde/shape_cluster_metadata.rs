...
) -> Result<Option<crate::types::ClusterMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "ShippingOption" => {
                            builder = builder.set_shipping_option(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::ShippingOption::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "Notification" => {
