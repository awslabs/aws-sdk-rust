            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "Resources" => {
                            builder = builder.set_resources(crate::protocol_serde::shape_job_resource::de_job_resource(tokens, _value)?);
                        }
                        "Description" => {
                        ...
                        "ShippingDetails" => {
                            builder =
                                builder.set_shipping_details(crate::protocol_serde::shape_shipping_details::de_shipping_details(tokens, _value)?);
                        }
                        ...
                        "Notification" => {
                            builder = builder.set_notification(crate::protocol_serde::shape_notification::de_notification(tokens, _value)?);
                        }
                        "DataTransferProgress" => {
                            builder =
                                builder.set_data_transfer_progress(crate::protocol_serde::shape_data_transfer::de_data_transfer(tokens, _value)?);
                        }
                        "JobLogInfo" => {
                            builder = builder.set_job_log_info(crate::protocol_serde::shape_job_logs::de_job_logs(tokens, _value)?);
                        }
                        "ClusterId" => {
                        ...
                        "TaxDocuments" => {
                            builder = builder.set_tax_documents(crate::protocol_serde::shape_tax_documents::de_tax_documents(tokens, _value)?);
                        }
                        "DeviceConfiguration" => {
                            builder = builder.set_device_configuration(crate::protocol_serde::shape_device_configuration::de_device_configuration(
                                tokens, _value,
                            )?);
                        }
                        "RemoteManagement" => {
                        ...
                        "OnDeviceServiceConfiguration" => {
                            builder = builder.set_on_device_service_configuration(
                                crate::protocol_serde::shape_on_device_service_configuration::de_on_device_service_configuration(tokens, _value)?,
                            );
                        }
                        "ImpactLevel" => {
                        ...
                        "PickupDetails" => {
                            builder = builder.set_pickup_details(crate::protocol_serde::shape_pickup_details::de_pickup_details(tokens, _value)?);
                        }
                        "SnowballId" => {
