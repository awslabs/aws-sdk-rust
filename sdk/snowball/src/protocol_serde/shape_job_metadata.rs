...
) -> Result<Option<crate::types::JobMetadata>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "JobState" => {
                                builder = builder.set_job_state(
                                    ...
                                    .map(|s| {
                                        s.to_unescaped()
                                            .map(|u| crate::types::JobState::from(u.as_ref()))
                                    })
                                    .transpose()?,
                                );
                            }
                            ...
                            "Resources" => {
                                builder = builder.set_resources(
                                    crate::protocol_serde::shape_job_resource::de_job_resource(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "Notification" => {
                                builder = builder.set_notification(
                                    crate::protocol_serde::shape_notification::de_notification(
                                        tokens,
                                    )?,
                                );
                            }
                            "DataTransferProgress" => {
                                builder = builder.set_data_transfer_progress(
                                    crate::protocol_serde::shape_data_transfer::de_data_transfer(
                                        tokens,
                                    )?,
                                );
                            }
                            ...
                            "TaxDocuments" => {
                                builder = builder.set_tax_documents(
                                    crate::protocol_serde::shape_tax_documents::de_tax_documents(
                                        tokens,
                                    )?,
                                );
                            }
