...
pub(crate) fn de_job_list_entry<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
) -> ::std::result::Result<Option<crate::types::JobListEntry>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "IsMaster" => {
                            builder = builder.set_is_master(::aws_smithy_json::deserialize::token::expect_bool_or_null(tokens.next())?);
                        }
                        "JobType" => {
