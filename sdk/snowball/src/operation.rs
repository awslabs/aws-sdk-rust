...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAddress {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        ...
                        crate::protocol_serde::shape_describe_address::de_describe_address_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetJobUnlockCode {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_job_unlock_code::de_get_job_unlock_code_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_job_unlock_code::de_get_job_unlock_code_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetSnowballUsage {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_snowball_usage::de_get_snowball_usage_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_snowball_usage::de_get_snowball_usage_http_response(response)
                     }
                }
            }
...
impl aws_smithy_http::response::ParseStrictResponse for GetSoftwareUpdates {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_error(response)
                     } else {
                        crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_response(response)
                     }
                }
            }
