...
/// [`cancel_cluster`](crate::client::fluent_builders::CancelCluster).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`create_address`](crate::client::fluent_builders::CreateAddress).
///
...
impl aws_smithy_http::response::ParseStrictResponse for CreateAddress {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_address::de_create_address_http_error(response)
        } else {
            crate::protocol_serde::shape_create_address::de_create_address_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`create_long_term_pricing`](crate::client::fluent_builders::CreateLongTermPricing).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`create_return_shipping_label`](crate::client::fluent_builders::CreateReturnShippingLabel).
///
...
impl aws_smithy_http::response::ParseStrictResponse for CreateReturnShippingLabel {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_create_return_shipping_label::de_create_return_shipping_label_http_error(response)
        } else {
            crate::protocol_serde::shape_create_return_shipping_label::de_create_return_shipping_label_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`describe_address`](crate::client::fluent_builders::DescribeAddress).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAddress {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_address::de_describe_address_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_address::de_describe_address_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`describe_addresses`](crate::client::fluent_builders::DescribeAddresses).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeCluster {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !response.status().is_success() && response.status().as_u16() != 200 {
            ...
            crate::protocol_serde::shape_describe_cluster::de_describe_cluster_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`describe_return_shipping_label`](crate::client::fluent_builders::DescribeReturnShippingLabel).
///
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReturnShippingLabel {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_describe_return_shipping_label::de_describe_return_shipping_label_http_error(response)
        } else {
            crate::protocol_serde::shape_describe_return_shipping_label::de_describe_return_shipping_label_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_job_manifest`](crate::client::fluent_builders::GetJobManifest).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_job_unlock_code`](crate::client::fluent_builders::GetJobUnlockCode).
///
...
impl aws_smithy_http::response::ParseStrictResponse for GetJobUnlockCode {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_job_unlock_code::de_get_job_unlock_code_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_job_unlock_code::de_get_job_unlock_code_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_snowball_usage`](crate::client::fluent_builders::GetSnowballUsage).
///
...
impl aws_smithy_http::response::ParseStrictResponse for GetSnowballUsage {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_snowball_usage::de_get_snowball_usage_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_snowball_usage::de_get_snowball_usage_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`get_software_updates`](crate::client::fluent_builders::GetSoftwareUpdates).
///
...
impl aws_smithy_http::response::ParseStrictResponse for GetSoftwareUpdates {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_error(
                response,
            )
        } else {
            crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_response(
                response,
            )
        }
    }
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_cluster_jobs`](crate::client::fluent_builders::ListClusterJobs).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_compatible_images`](crate::client::fluent_builders::ListCompatibleImages).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`list_long_term_pricing`](crate::client::fluent_builders::ListLongTermPricing).
///
...
impl aws_smithy_http::response::ParseStrictResponse for ListLongTermPricing {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_list_long_term_pricing::de_list_long_term_pricing_http_error(response)
        } else {
            crate::protocol_serde::shape_list_long_term_pricing::de_list_long_term_pricing_http_response(response)
        }
    }
}
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`update_job_shipment_state`](crate::client::fluent_builders::UpdateJobShipmentState).
///
...
///
/// This is usually constructed for you using the the fluent builder returned by
/// [`update_long_term_pricing`](crate::client::fluent_builders::UpdateLongTermPricing).
///
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLongTermPricing {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
        if !response.status().is_success() && response.status().as_u16() != 200 {
            crate::protocol_serde::shape_update_long_term_pricing::de_update_long_term_pricing_http_error(response)
        } else {
            crate::protocol_serde::shape_update_long_term_pricing::de_update_long_term_pricing_http_response(response)
        }
    }
}
