...
impl super::Client {
    ...
    ///   - [`long_term_pricing_id(impl ::std::convert::Into<String>)`](crate::operation::update_long_term_pricing::builders::UpdateLongTermPricingFluentBuilder::long_term_pricing_id) / [`set_long_term_pricing_id(Option<String>)`](crate::operation::update_long_term_pricing::builders::UpdateLongTermPricingFluentBuilder::set_long_term_pricing_id): <p>The ID of the long-term pricing type for the device.</p>
    ///   - [`replacement_job(impl ::std::convert::Into<String>)`](crate::operation::update_long_term_pricing::builders::UpdateLongTermPricingFluentBuilder::replacement_job) / [`set_replacement_job(Option<String>)`](crate::operation::update_long_term_pricing::builders::UpdateLongTermPricingFluentBuilder::set_replacement_job): <p>Specifies that a device that is ordered with long-term pricing should be replaced with a new device.</p>
