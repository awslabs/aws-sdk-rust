...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_addresses::builders::DescribeAddressesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_addresses::builders::DescribeAddressesFluentBuilder::set_max_results):<br>required: **false**<br><p>The number of <code>ADDRESS</code> objects to return.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::describe_addresses::builders::DescribeAddressesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_addresses::builders::DescribeAddressesFluentBuilder::set_next_token):<br>required: **false**<br><p>HTTP requests are stateless. To identify what object comes "next" in the list of <code>ADDRESS</code> objects, you have the option of specifying a value for <code>NextToken</code> as the starting point for your list of returned addresses.</p><br>
