...
impl super::Client {
    ...
    ///   - [`long_term_pricing_type(LongTermPricingType)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::long_term_pricing_type) / [`set_long_term_pricing_type(Option<LongTermPricingType>)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::set_long_term_pricing_type):<br>required: **true**<br><p>The type of long-term pricing option you want for the device, either 1-year or 3-year long-term pricing.</p><br>
    ///   - [`is_long_term_pricing_auto_renew(bool)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::is_long_term_pricing_auto_renew) / [`set_is_long_term_pricing_auto_renew(Option<bool>)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::set_is_long_term_pricing_auto_renew):<br>required: **false**<br><p>Specifies whether the current long-term pricing type for the device should be renewed.</p><br>
    ///   - [`snowball_type(SnowballType)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::snowball_type) / [`set_snowball_type(Option<SnowballType>)`](crate::operation::create_long_term_pricing::builders::CreateLongTermPricingFluentBuilder::set_snowball_type):<br>required: **true**<br><p>The type of Snow Family devices to use for the long-term pricing job.</p><br>
