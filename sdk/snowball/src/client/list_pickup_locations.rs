...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_pickup_locations::builders::ListPickupLocationsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_pickup_locations::builders::ListPickupLocationsFluentBuilder::set_max_results): <p>The maximum number of locations to list per page.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_pickup_locations::builders::ListPickupLocationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_pickup_locations::builders::ListPickupLocationsFluentBuilder::set_next_token): <p>HTTP requests are stateless. To identify what object comes "next" in the list of <code>ListPickupLocationsRequest</code> objects, you have the option of specifying <code>NextToken</code> as the starting point for your returned list.</p>
