...
impl DescribeReturnShippingLabelInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_return_shipping_label::DescribeReturnShippingLabel::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReturnShippingLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_return_shipping_label::de_describe_return_shipping_label_http_response_with_props(
                status, headers, body,
            )
        }
    }
