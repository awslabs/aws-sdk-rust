...
impl DescribeReturnShippingLabel {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelInput,
                    ) -> ::std::result::Result<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for DescribeReturnShippingLabel {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DescribeReturnShippingLabel");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(DescribeReturnShippingLabelRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(DescribeReturnShippingLabelResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("DescribeReturnShippingLabel")
...
.with_interceptor(DescribeReturnShippingLabelEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError>::new());
...
#[derive(Debug)]
            struct DescribeReturnShippingLabelResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for DescribeReturnShippingLabelResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_describe_return_shipping_label::de_describe_return_shipping_label_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct DescribeReturnShippingLabelRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for DescribeReturnShippingLabelRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_describe_return_shipping_label::ser_describe_return_shipping_label_input(&input)?);
...
#[derive(Debug)]
            struct DescribeReturnShippingLabelEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for DescribeReturnShippingLabelEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "DescribeReturnShippingLabelEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<DescribeReturnShippingLabelInput>()
                        .ok_or("failed to downcast to DescribeReturnShippingLabelInput")?;
...
pub enum DescribeReturnShippingLabelError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-DescribeReturnShippingLabelError) for what information is available for the error.")]
...
impl DescribeReturnShippingLabelError {
    /// Creates the `DescribeReturnShippingLabelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeReturnShippingLabelError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for DescribeReturnShippingLabelError {
...
impl ::aws_types::request_id::RequestId for crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError {
...
mod _describe_return_shipping_label_output;
