...
impl DescribeReturnShippingLabelInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReturnShippingLabel`](crate::operation::describe_return_shipping_label::DescribeReturnShippingLabel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabel, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_return_shipping_label::ser_describe_return_shipping_label_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_return_shipping_label::DescribeReturnShippingLabel::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeReturnShippingLabel", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeReturnShippingLabel {
                type Output = std::result::Result<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelOutput, crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError>;
