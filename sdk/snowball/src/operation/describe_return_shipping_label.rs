...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReturnShippingLabel {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_return_shipping_label::de_describe_return_shipping_label_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for DescribeReturnShippingLabelError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelError
{
