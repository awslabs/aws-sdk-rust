...
impl CancelClusterInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_cluster::CancelCluster, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_cluster::ser_cancel_cluster_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelCluster {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_cluster::de_cancel_cluster_http_response_with_props(status, headers, body)
        }
    }
}
