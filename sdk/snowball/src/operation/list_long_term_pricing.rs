...
impl ListLongTermPricingInput {
    /// Consumes the builder and constructs an Operation<[`ListLongTermPricing`](crate::operation::list_long_term_pricing::ListLongTermPricing)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_long_term_pricing::ListLongTermPricing, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_long_term_pricing::ListLongTermPricingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_long_term_pricing::ser_list_long_term_pricing_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_long_term_pricing::ListLongTermPricing::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListLongTermPricing", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListLongTermPricing {
                type Output = std::result::Result<crate::operation::list_long_term_pricing::ListLongTermPricingOutput, crate::operation::list_long_term_pricing::ListLongTermPricingError>;
