...
/// Orchestration and serialization glue logic for `ListLongTermPricing`.
...
impl ListLongTermPricing {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::list_long_term_pricing::ListLongTermPricingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_long_term_pricing::ListLongTermPricingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::list_long_term_pricing::ListLongTermPricingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::list_long_term_pricing::ListLongTermPricingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for ListLongTermPricing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("ListLongTermPricing");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(ListLongTermPricingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(ListLongTermPricingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("ListLongTermPricing")
...
.with_interceptor(ListLongTermPricingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::list_long_term_pricing::ListLongTermPricingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::list_long_term_pricing::ListLongTermPricingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::list_long_term_pricing::ListLongTermPricingError>::new());
...
#[derive(Debug)]
            struct ListLongTermPricingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ListLongTermPricingResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_list_long_term_pricing::de_list_long_term_pricing_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct ListLongTermPricingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ListLongTermPricingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::list_long_term_pricing::ListLongTermPricingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::list_long_term_pricing::ListLongTermPricingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_list_long_term_pricing::ser_list_long_term_pricing_input(&input)?);
...
#[derive(Debug)]
            struct ListLongTermPricingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ListLongTermPricingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "ListLongTermPricingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<ListLongTermPricingInput>()
                        .ok_or("failed to downcast to ListLongTermPricingInput")?;
...
pub enum ListLongTermPricingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ListLongTermPricingError) for what information is available for the error.")]
...
impl ListLongTermPricingError {
    /// Creates the `ListLongTermPricingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListLongTermPricingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ListLongTermPricingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::list_long_term_pricing::ListLongTermPricingError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::list_long_term_pricing::_list_long_term_pricing_output::ListLongTermPricingOutput;

pub use crate::operation::list_long_term_pricing::_list_long_term_pricing_input::ListLongTermPricingInput;

mod _list_long_term_pricing_input;

mod _list_long_term_pricing_output;
