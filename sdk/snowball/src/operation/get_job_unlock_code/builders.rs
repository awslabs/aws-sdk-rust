...
impl GetJobUnlockCodeFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::get_job_unlock_code::GetJobUnlockCodeOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_job_unlock_code::GetJobUnlockCodeError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::get_job_unlock_code::GetJobUnlockCodeOutput, crate::operation::get_job_unlock_code::GetJobUnlockCodeError, Self> {
