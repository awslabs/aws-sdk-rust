...
impl ListCompatibleImagesInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::list_compatible_images::ListCompatibleImages,
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCompatibleImages {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_compatible_images::de_list_compatible_images_http_response_with_props(status, headers, body)
        }
    }
}
