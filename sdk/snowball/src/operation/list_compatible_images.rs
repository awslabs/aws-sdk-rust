...
impl ListCompatibleImagesInput {
    /// Consumes the builder and constructs an Operation<[`ListCompatibleImages`](crate::operation::list_compatible_images::ListCompatibleImages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_compatible_images::ListCompatibleImages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_compatible_images::ListCompatibleImagesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compatible_images::ser_list_compatible_images_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_compatible_images::ListCompatibleImages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListCompatibleImages", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListCompatibleImages {
                type Output = std::result::Result<crate::operation::list_compatible_images::ListCompatibleImagesOutput, crate::operation::list_compatible_images::ListCompatibleImagesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_list_compatible_images::de_list_compatible_images_http_error(response)
                     } else {
                        crate::protocol_serde::shape_list_compatible_images::de_list_compatible_images_http_response(response)
                     }
                }
            }
