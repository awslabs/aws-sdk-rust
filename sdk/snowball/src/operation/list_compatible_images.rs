...
impl ListCompatibleImagesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compatible_images::ser_list_compatible_images_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_compatible_images::ListCompatibleImages::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::list_compatible_images::ListCompatibleImagesError
{
