...
impl CreateLongTermPricingInput {
    /// Consumes the builder and constructs an Operation<[`CreateLongTermPricing`](crate::operation::create_long_term_pricing::CreateLongTermPricing)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_long_term_pricing::CreateLongTermPricing, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_long_term_pricing::CreateLongTermPricingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_long_term_pricing::ser_create_long_term_pricing_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_long_term_pricing::CreateLongTermPricing::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateLongTermPricing", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateLongTermPricing {
                type Output = std::result::Result<crate::operation::create_long_term_pricing::CreateLongTermPricingOutput, crate::operation::create_long_term_pricing::CreateLongTermPricingError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_create_long_term_pricing::de_create_long_term_pricing_http_error(response)
                     } else {
                        crate::protocol_serde::shape_create_long_term_pricing::de_create_long_term_pricing_http_response(response)
                     }
                }
            }
