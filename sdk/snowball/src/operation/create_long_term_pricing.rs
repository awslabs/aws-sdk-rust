...
/// Orchestration and serialization glue logic for `CreateLongTermPricing`.
...
impl CreateLongTermPricing {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::create_long_term_pricing::CreateLongTermPricingOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_long_term_pricing::CreateLongTermPricingError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::create_long_term_pricing::CreateLongTermPricingError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::create_long_term_pricing::CreateLongTermPricingOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateLongTermPricing {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateLongTermPricing");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(CreateLongTermPricingRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(CreateLongTermPricingResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateLongTermPricing")
...
.with_interceptor(CreateLongTermPricingEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::create_long_term_pricing::CreateLongTermPricingError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::create_long_term_pricing::CreateLongTermPricingError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::create_long_term_pricing::CreateLongTermPricingError>::new());
...
#[derive(Debug)]
            struct CreateLongTermPricingResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateLongTermPricingResponseDeserializer {
...
#[derive(Debug)]
            struct CreateLongTermPricingRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateLongTermPricingRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::create_long_term_pricing::CreateLongTermPricingInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::create_long_term_pricing::CreateLongTermPricingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_long_term_pricing::ser_create_long_term_pricing_input(&input)?);
...
#[derive(Debug)]
            struct CreateLongTermPricingEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateLongTermPricingEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "CreateLongTermPricingEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<CreateLongTermPricingInput>()
                        .ok_or("failed to downcast to CreateLongTermPricingInput")?;
...
pub enum CreateLongTermPricingError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateLongTermPricingError) for what information is available for the error.")]
...
impl CreateLongTermPricingError {
    /// Creates the `CreateLongTermPricingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateLongTermPricingError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateLongTermPricingError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_long_term_pricing::CreateLongTermPricingError {
...
mod _create_long_term_pricing_output;
