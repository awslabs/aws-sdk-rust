...
impl DescribeJobInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_job::ser_describe_job_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_job::DescribeJob::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeJob", "snowball"));
