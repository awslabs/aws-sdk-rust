...
impl CancelJobInput {
    /// Consumes the builder and constructs an Operation<[`CancelJob`](crate::operation::cancel_job::CancelJob)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::cancel_job::CancelJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_cancel_job::ser_cancel_job_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_job::CancelJob::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelJob", "snowball"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelJob {
    type Output = ::std::result::Result<crate::operation::cancel_job::CancelJobOutput, crate::operation::cancel_job::CancelJobError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_cancel_job::de_cancel_job_http_response_with_props(status, headers, body)
        }
    }
}
