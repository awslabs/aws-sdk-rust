...
impl ListPickupLocationsInput {
    /// Consumes the builder and constructs an Operation<[`ListPickupLocations`](crate::operation::list_pickup_locations::ListPickupLocations)>
    #[allow(unused_mut)]
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_pickup_locations::ListPickupLocations::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPickupLocations", "snowball"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPickupLocations {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_list_pickup_locations::de_list_pickup_locations_http_response_with_props(status, headers, body)
        }
    }
}
