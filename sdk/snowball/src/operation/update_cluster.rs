...
impl UpdateCluster {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Snowball", "UpdateCluster", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateCluster {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateCluster", "Snowball"));
...
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateClusterTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        if requested.should_capture("AddressId") {
            if let ::std::option::Option::Some(value) = input.address_id.as_deref() {
                captured.insert("AddressId", value);
            }
        }
        if requested.should_capture("ForwardingAddressId") {
            if let ::std::option::Option::Some(value) = input.forwarding_address_id.as_deref() {
                captured.insert("ForwardingAddressId", value);
            }
        }
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/AWSIESnowballJobManagementService/operation/UpdateCluster").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl UpdateClusterError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidInputCombinationException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::std::error::Error for UpdateClusterError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            ...
            Self::InvalidInputCombinationException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateClusterError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidInputCombinationException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
