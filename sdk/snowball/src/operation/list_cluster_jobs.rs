...
impl ListClusterJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListClusterJobs`](crate::operation::list_cluster_jobs::ListClusterJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_cluster_jobs::ListClusterJobs, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_cluster_jobs::ListClusterJobsInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_cluster_jobs::ser_list_cluster_jobs_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_cluster_jobs::ListClusterJobs::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListClusterJobs", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for ListClusterJobs {
                type Output = std::result::Result<crate::operation::list_cluster_jobs::ListClusterJobsOutput, crate::operation::list_cluster_jobs::ListClusterJobsError>;
