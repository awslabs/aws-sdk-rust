...
impl ListClusterJobsInput {
    ...
    pub async fn make_operation(
        ...
        aws_smithy_http::operation::Operation<
            crate::operation::list_cluster_jobs::ListClusterJobs,
    ...
    > {
        ...
        let op = aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_cluster_jobs::ListClusterJobs::new(),
        )
...
impl aws_smithy_http::response::ParseStrictResponse for ListClusterJobs {
    ...
    fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_cluster_jobs::de_list_cluster_jobs_http_error(
                status, headers, body,
            )
        } else {
