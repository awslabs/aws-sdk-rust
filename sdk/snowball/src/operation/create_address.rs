...
impl CreateAddressInput {
    /// Consumes the builder and constructs an Operation<[`CreateAddress`](crate::operation::create_address::CreateAddress)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_address::CreateAddress, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_address::ser_create_address_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_address::CreateAddress::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAddress {
    type Output = ::std::result::Result<crate::operation::create_address::CreateAddressOutput, crate::operation::create_address::CreateAddressError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_create_address::de_create_address_http_response_with_props(status, headers, body)
        }
    }
}
