...
impl DescribeAddressesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_addresses::ser_describe_addresses_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAddresses {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_addresses::de_describe_addresses_http_response_with_props(status, headers, body)
        }
    }
}
