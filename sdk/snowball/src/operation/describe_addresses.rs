...
impl DescribeAddressesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAddresses`](crate::operation::describe_addresses::DescribeAddresses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_addresses::DescribeAddresses, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_addresses::DescribeAddressesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_addresses::ser_describe_addresses_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_addresses::DescribeAddresses::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeAddresses", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeAddresses {
                type Output = std::result::Result<crate::operation::describe_addresses::DescribeAddressesOutput, crate::operation::describe_addresses::DescribeAddressesError>;
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     tracing::debug!(request_id = ?aws_http::request_id::RequestId::request_id(response));
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_describe_addresses::de_describe_addresses_http_error(response)
                     } else {
                        crate::protocol_serde::shape_describe_addresses::de_describe_addresses_http_response(response)
                     }
                }
            }
