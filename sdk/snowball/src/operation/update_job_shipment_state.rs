...
impl UpdateJobShipmentStateInput {
    /// Consumes the builder and constructs an Operation<[`UpdateJobShipmentState`](crate::operation::update_job_shipment_state::UpdateJobShipmentState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_job_shipment_state::UpdateJobShipmentState, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_job_shipment_state::UpdateJobShipmentStateInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_job_shipment_state::ser_update_job_shipment_state_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_job_shipment_state::UpdateJobShipmentState::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateJobShipmentState", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateJobShipmentState {
                type Output = std::result::Result<crate::operation::update_job_shipment_state::UpdateJobShipmentStateOutput, crate::operation::update_job_shipment_state::UpdateJobShipmentStateError>;
