...
/// Orchestration and serialization glue logic for `UpdateJobShipmentState`.
...
impl UpdateJobShipmentState {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::update_job_shipment_state::UpdateJobShipmentStateOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_job_shipment_state::UpdateJobShipmentStateError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateJobShipmentState {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateJobShipmentState");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(UpdateJobShipmentStateRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(UpdateJobShipmentStateResponseDeserializer));
...
.with_interceptor(UpdateJobShipmentStateEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateError>::new());
...
#[derive(Debug)]
            struct UpdateJobShipmentStateResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateJobShipmentStateResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_update_job_shipment_state::de_update_job_shipment_state_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_update_job_shipment_state::de_update_job_shipment_state_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct UpdateJobShipmentStateRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateJobShipmentStateRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::update_job_shipment_state::UpdateJobShipmentStateInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::update_job_shipment_state::UpdateJobShipmentStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_job_shipment_state::ser_update_job_shipment_state_input(&input)?);
            ...
            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateJobShipmentStateEndpointParamsInterceptor {
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<UpdateJobShipmentStateInput>()
                        .ok_or("failed to downcast to UpdateJobShipmentStateInput")?;
...
pub enum UpdateJobShipmentStateError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateJobShipmentStateError) for what information is available for the error.")]
...
impl UpdateJobShipmentStateError {
    /// Creates the `UpdateJobShipmentStateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateJobShipmentStateError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateJobShipmentStateError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_job_shipment_state::UpdateJobShipmentStateError {
...
mod _update_job_shipment_state_output;
