...
impl aws_smithy_http::response::ParseStrictResponse for UpdateJobShipmentState {
                ...
                fn parse(&self, response: &http::Response<bytes::Bytes>) -> Self::Output {
                     ...
                     if !response.status().is_success() && response.status().as_u16() != 200 {
                        crate::protocol_serde::shape_update_job_shipment_state::de_update_job_shipment_state_http_error(response)
                     } else {
                        crate::protocol_serde::shape_update_job_shipment_state::de_update_job_shipment_state_http_response(response)
                     }
                }
            }
