...
impl UpdateLongTermPricingInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLongTermPricing`](crate::operation::update_long_term_pricing::UpdateLongTermPricing)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_long_term_pricing::UpdateLongTermPricing, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_long_term_pricing::UpdateLongTermPricingInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_long_term_pricing::ser_update_long_term_pricing_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_long_term_pricing::UpdateLongTermPricing::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateLongTermPricing", "snowball"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateLongTermPricing {
                type Output = std::result::Result<crate::operation::update_long_term_pricing::UpdateLongTermPricingOutput, crate::operation::update_long_term_pricing::UpdateLongTermPricingError>;
