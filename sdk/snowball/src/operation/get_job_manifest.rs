...
impl GetJobManifestInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_job_manifest::GetJobManifest, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_job_manifest::ser_get_job_manifest_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobManifest {
    type Output =
        ::std::result::Result<crate::operation::get_job_manifest::GetJobManifestOutput, crate::operation::get_job_manifest::GetJobManifestError>;
