...
impl GetSoftwareUpdatesFluentBuilder  {
    /// Creates a new `GetSoftwareUpdates`.
                    ...
                    pub async fn send(self) -> std::result::Result<crate::operation::get_software_updates::GetSoftwareUpdatesOutput, aws_smithy_http::result::SdkError<crate::operation::get_software_updates::GetSoftwareUpdatesError>>
                     {
