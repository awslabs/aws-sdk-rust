...
pub struct ListLongTermPricingOutput  {
    ...
    #[doc(hidden)]pub long_term_pricing_entries: std::option::Option<std::vec::Vec<crate::model::LongTermPricingListEntry>>,
...
pub struct ListJobsOutput  {
    ...
    #[doc(hidden)]pub job_list_entries: std::option::Option<std::vec::Vec<crate::model::JobListEntry>>,
...
pub struct ListCompatibleImagesOutput  {
    ...
    #[doc(hidden)]pub compatible_images: std::option::Option<std::vec::Vec<crate::model::CompatibleImage>>,
...
pub struct ListClustersOutput  {
    ...
    #[doc(hidden)]pub cluster_list_entries: std::option::Option<std::vec::Vec<crate::model::ClusterListEntry>>,
...
pub struct GetSoftwareUpdatesOutput  {
    ...
    #[doc(hidden)]pub updates_uri: std::option::Option<std::string::String>,
}
...
pub struct GetSnowballUsageOutput  {
    ...
    #[doc(hidden)]pub snowball_limit: std::option::Option<i32>,
    /// <p>The number of Snow devices that this account is currently using.</p>
    #[doc(hidden)]pub snowballs_in_use: std::option::Option<i32>,
}
...
pub struct GetJobUnlockCodeOutput  {
    ...
    #[doc(hidden)]pub unlock_code: std::option::Option<std::string::String>,
}
...
pub struct GetJobManifestOutput  {
    ...
    #[doc(hidden)]pub manifest_uri: std::option::Option<std::string::String>,
}
...
pub struct DescribeReturnShippingLabelOutput  {
    ...
    #[doc(hidden)]pub status: std::option::Option<crate::model::ShippingLabelStatus>,
    ...
    #[doc(hidden)]pub return_shipping_label_uri: std::option::Option<std::string::String>,
}
...
pub struct DescribeJobOutput  {
    ...
    #[doc(hidden)]pub job_metadata: std::option::Option<crate::model::JobMetadata>,
    ...
    #[doc(hidden)]pub sub_job_metadata: std::option::Option<std::vec::Vec<crate::model::JobMetadata>>,
}
...
pub struct DescribeClusterOutput  {
    ...
    #[doc(hidden)]pub cluster_metadata: std::option::Option<crate::model::ClusterMetadata>,
}
