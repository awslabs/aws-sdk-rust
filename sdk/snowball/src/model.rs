...
pub struct OnDeviceServiceConfiguration  {
    ...
    #[doc(hidden)]pub nfs_on_device_service: std::option::Option<crate::model::NfsOnDeviceServiceConfiguration>,
    /// <p>Represents the Storage Gateway service Tape Gateway type on a Snow Family device.</p>
    #[doc(hidden)]pub tgw_on_device_service: std::option::Option<crate::model::TgwOnDeviceServiceConfiguration>,
}
...
pub struct TgwOnDeviceServiceConfiguration  {
    ...
    #[doc(hidden)]pub storage_limit: i32,
    /// <p>The scale unit of the virtual tapes on the device.</p>
    #[doc(hidden)]pub storage_unit: std::option::Option<crate::model::StorageUnit>,
}
...
pub struct JobResource  {
    ...
    #[doc(hidden)]pub s3_resources: std::option::Option<std::vec::Vec<crate::model::S3Resource>>,
    /// <p>The Python-language Lambda functions for this job.</p>
    #[doc(hidden)]pub lambda_resources: std::option::Option<std::vec::Vec<crate::model::LambdaResource>>,
    /// <p>The Amazon Machine Images (AMIs) associated with this job.</p>
    #[doc(hidden)]pub ec2_ami_resources: std::option::Option<std::vec::Vec<crate::model::Ec2AmiResource>>,
}
impl JobResource {
    /// <p>An array of <code>S3Resource</code> objects.</p>
...
pub struct Ec2AmiResource  {
    ...
    #[doc(hidden)]pub snowball_ami_id: std::option::Option<std::string::String>,
}
impl Ec2AmiResource {
    /// <p>The ID of the AMI in Amazon EC2.</p>
...
pub struct LambdaResource  {
    ...
    #[doc(hidden)]pub event_triggers: std::option::Option<std::vec::Vec<crate::model::EventTriggerDefinition>>,
}
impl LambdaResource {
    /// <p>An Amazon Resource Name (ARN) that represents an Lambda function to be triggered by PUT object actions on the associated local Amazon S3 resource.</p>
...
pub struct EventTriggerDefinition  {
    ...
    #[doc(hidden)]pub event_resource_arn: std::option::Option<std::string::String>,
}
...
pub struct S3Resource  {
    ...
    #[doc(hidden)]pub key_range: std::option::Option<crate::model::KeyRange>,
    ...
    #[doc(hidden)]pub target_on_device_services: std::option::Option<std::vec::Vec<crate::model::TargetOnDeviceService>>,
}
impl S3Resource {
    /// <p>The Amazon Resource Name (ARN) of an Amazon S3 bucket.</p>
...
pub struct TargetOnDeviceService  {
    ...
    #[doc(hidden)]pub service_name: std::option::Option<crate::model::DeviceServiceName>,
    ...
    #[doc(hidden)]pub transfer_option: std::option::Option<crate::model::TransferOption>,
}
...
pub struct KeyRange  {
    ...
    #[doc(hidden)]pub begin_marker: std::option::Option<std::string::String>,
    /// <p>The key that ends an optional key range for an export job. Ranges are inclusive and UTF-8 binary sorted.</p>
    #[doc(hidden)]pub end_marker: std::option::Option<std::string::String>,
}
impl KeyRange {
    /// <p>The key that starts an optional key range for an export job. Ranges are inclusive and UTF-8 binary sorted.</p>
...
pub struct Notification  {
    ...
    #[doc(hidden)]pub job_states_to_notify: std::option::Option<std::vec::Vec<crate::model::JobState>>,
    /// <p>Any change in job state will trigger a notification for this job.</p>
    #[doc(hidden)]pub notify_all: bool,
}
impl Notification {
    /// <p>The new SNS <code>TopicArn</code> that you want to associate with this job. You can create Amazon Resource Names (ARNs) for topics by using the <a href="https://docs.aws.amazon.com/sns/latest/api/API_CreateTopic.html">CreateTopic</a> Amazon SNS API action.</p> 
    /// <p>You can subscribe email addresses to an Amazon SNS topic through the Amazon Web Services Management Console, or by using the <a href="https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html">Subscribe</a> Amazon Simple Notification Service (Amazon SNS) API action.</p>
...
pub struct LongTermPricingListEntry  {
    ...
    #[doc(hidden)]pub long_term_pricing_end_date: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The start date of the long-term pricing contract.</p>
    #[doc(hidden)]pub long_term_pricing_start_date: std::option::Option<aws_smithy_types::DateTime>,
    ...
    #[doc(hidden)]pub current_active_job: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub long_term_pricing_status: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub job_ids: std::option::Option<std::vec::Vec<std::string::String>>,
}
...
impl  std::fmt::Debug for LongTermPricingListEntry  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("long_term_pricing_end_date", &self.long_term_pricing_end_date);
        formatter.field("long_term_pricing_start_date", &self.long_term_pricing_start_date);
...
pub struct JobListEntry  {
    ...
    #[doc(hidden)]pub job_state: std::option::Option<crate::model::JobState>,
...
pub struct ClusterListEntry  {
    ...
    #[doc(hidden)]pub cluster_state: std::option::Option<crate::model::ClusterState>,
...
pub struct JobMetadata  {
    ...
    #[doc(hidden)]pub shipping_details: std::option::Option<crate::model::ShippingDetails>,
    ...
    #[doc(hidden)]pub data_transfer_progress: std::option::Option<crate::model::DataTransfer>,
    ...
    #[doc(hidden)]pub job_log_info: std::option::Option<crate::model::JobLogs>,
...
pub struct DeviceConfiguration  {
    ...
    #[doc(hidden)]pub snowcone_device_configuration: std::option::Option<crate::model::SnowconeDeviceConfiguration>,
}
...
impl  std::fmt::Debug for DeviceConfiguration  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("snowcone_device_configuration", &self.snowcone_device_configuration);
        formatter.finish()
    }
}
...
pub struct SnowconeDeviceConfiguration  {
    ...
    #[doc(hidden)]pub wireless_connection: std::option::Option<crate::model::WirelessConnection>,
}
...
pub struct WirelessConnection  {
    ...
    #[doc(hidden)]pub is_wifi_enabled: bool,
}
...
pub struct TaxDocuments  {
    ...
    #[doc(hidden)]pub ind: std::option::Option<crate::model::IndTaxDocuments>,
}
impl TaxDocuments {
    /// <p>The tax documents required in Amazon Web Services Region in India.</p>
...
pub struct IndTaxDocuments  {
    ...
    #[doc(hidden)]pub gstin: std::option::Option<std::string::String>,
}
...
pub struct JobLogs  {
    ...
    #[doc(hidden)]pub job_completion_report_uri: std::option::Option<std::string::String>,
    /// <p>A link to an Amazon S3 presigned URL where the job success log is located.</p>
    #[doc(hidden)]pub job_success_log_uri: std::option::Option<std::string::String>,
    /// <p>A link to an Amazon S3 presigned URL where the job failure log is located.</p>
    #[doc(hidden)]pub job_failure_log_uri: std::option::Option<std::string::String>,
}
impl JobLogs {
    /// <p>A link to an Amazon S3 presigned URL where the job completion report is located.</p>
...
pub struct DataTransfer  {
    ...
    #[doc(hidden)]pub objects_transferred: i64,
    ...
    #[doc(hidden)]pub total_objects: i64,
}
impl DataTransfer {
    /// <p>The number of bytes transferred between a Snow device and Amazon S3.</p>
...
pub struct ShippingDetails  {
    ...
    #[doc(hidden)]pub inbound_shipment: std::option::Option<crate::model::Shipment>,
    ...
    #[doc(hidden)]pub outbound_shipment: std::option::Option<crate::model::Shipment>,
}
...
pub struct Address  {
    ...
    #[doc(hidden)]pub prefecture_or_district: std::option::Option<std::string::String>,
    /// <p>This field is no longer used and the value is ignored.</p>
    #[doc(hidden)]pub landmark: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub is_restricted: bool,
}
impl Address {
    /// <p>The unique ID for an address.</p>
    pub fn address_id(&self) -> std::option::Option<& str> {
