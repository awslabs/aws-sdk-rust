...
impl From<crate::error::GetIdError> for Error {
    fn from(err: crate::error::GetIdError) -> Self {
        match err.kind {
            ...
            crate::error::GetIdErrorKind::Unhandled(inner) => {
                Error::Unhandled(crate::error::Unhandled::new(inner.into()))
            }
        }
    }
...
impl From<crate::error::GetOpenIdTokenError> for Error {
    fn from(err: crate::error::GetOpenIdTokenError) -> Self {
        match err.kind {
            ...
            crate::error::GetOpenIdTokenErrorKind::Unhandled(inner) => {
                Error::Unhandled(crate::error::Unhandled::new(inner.into()))
            }
        }
    }
...
impl From<crate::error::GetPrincipalTagAttributeMapError> for Error {
    fn from(err: crate::error::GetPrincipalTagAttributeMapError) -> Self {
        match err.kind {
            crate::error::GetPrincipalTagAttributeMapErrorKind::InternalErrorException(inner) => {
                Error::InternalErrorException(inner)
            }
            crate::error::GetPrincipalTagAttributeMapErrorKind::InvalidParameterException(
                inner,
            ) => Error::InvalidParameterException(inner),
            crate::error::GetPrincipalTagAttributeMapErrorKind::NotAuthorizedException(inner) => {
                Error::NotAuthorizedException(inner)
            }
            crate::error::GetPrincipalTagAttributeMapErrorKind::ResourceNotFoundException(
                inner,
            ) => Error::ResourceNotFoundException(inner),
            crate::error::GetPrincipalTagAttributeMapErrorKind::TooManyRequestsException(inner) => {
                Error::TooManyRequestsException(inner)
            }
...
impl From<crate::error::LookupDeveloperIdentityError> for Error {
    fn from(err: crate::error::LookupDeveloperIdentityError) -> Self {
        match err.kind {
            ...
            crate::error::LookupDeveloperIdentityErrorKind::InvalidParameterException(inner) => {
                Error::InvalidParameterException(inner)
            }
            crate::error::LookupDeveloperIdentityErrorKind::NotAuthorizedException(inner) => {
                Error::NotAuthorizedException(inner)
            }
            crate::error::LookupDeveloperIdentityErrorKind::ResourceConflictException(inner) => {
                Error::ResourceConflictException(inner)
            }
            crate::error::LookupDeveloperIdentityErrorKind::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
...
impl From<crate::error::MergeDeveloperIdentitiesError> for Error {
    fn from(err: crate::error::MergeDeveloperIdentitiesError) -> Self {
        match err.kind {
            ...
            crate::error::MergeDeveloperIdentitiesErrorKind::InvalidParameterException(inner) => {
                Error::InvalidParameterException(inner)
            }
            crate::error::MergeDeveloperIdentitiesErrorKind::NotAuthorizedException(inner) => {
                Error::NotAuthorizedException(inner)
            }
            crate::error::MergeDeveloperIdentitiesErrorKind::ResourceConflictException(inner) => {
                Error::ResourceConflictException(inner)
            }
            crate::error::MergeDeveloperIdentitiesErrorKind::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
            crate::error::MergeDeveloperIdentitiesErrorKind::TooManyRequestsException(inner) => {
                Error::TooManyRequestsException(inner)
            }
...
impl From<crate::error::SetIdentityPoolRolesError> for Error {
    fn from(err: crate::error::SetIdentityPoolRolesError) -> Self {
        match err.kind {
            crate::error::SetIdentityPoolRolesErrorKind::ConcurrentModificationException(inner) => {
...
impl From<crate::error::SetPrincipalTagAttributeMapError> for Error {
    fn from(err: crate::error::SetPrincipalTagAttributeMapError) -> Self {
        match err.kind {
            crate::error::SetPrincipalTagAttributeMapErrorKind::InternalErrorException(inner) => {
                Error::InternalErrorException(inner)
            }
            crate::error::SetPrincipalTagAttributeMapErrorKind::InvalidParameterException(
                inner,
            ) => Error::InvalidParameterException(inner),
            crate::error::SetPrincipalTagAttributeMapErrorKind::NotAuthorizedException(inner) => {
                Error::NotAuthorizedException(inner)
            }
            crate::error::SetPrincipalTagAttributeMapErrorKind::ResourceNotFoundException(
                inner,
            ) => Error::ResourceNotFoundException(inner),
            crate::error::SetPrincipalTagAttributeMapErrorKind::TooManyRequestsException(inner) => {
                Error::TooManyRequestsException(inner)
            }
...
impl From<crate::error::UnlinkDeveloperIdentityError> for Error {
    fn from(err: crate::error::UnlinkDeveloperIdentityError) -> Self {
        match err.kind {
            ...
            crate::error::UnlinkDeveloperIdentityErrorKind::InvalidParameterException(inner) => {
                Error::InvalidParameterException(inner)
            }
            crate::error::UnlinkDeveloperIdentityErrorKind::NotAuthorizedException(inner) => {
                Error::NotAuthorizedException(inner)
            }
            crate::error::UnlinkDeveloperIdentityErrorKind::ResourceConflictException(inner) => {
                Error::ResourceConflictException(inner)
            }
            crate::error::UnlinkDeveloperIdentityErrorKind::ResourceNotFoundException(inner) => {
                Error::ResourceNotFoundException(inner)
            }
...
impl From<crate::error::UnlinkIdentityError> for Error {
    fn from(err: crate::error::UnlinkIdentityError) -> Self {
        match err.kind {
            ...
            crate::error::UnlinkIdentityErrorKind::Unhandled(inner) => {
                Error::Unhandled(crate::error::Unhandled::new(inner.into()))
            }
        }
    }
...
impl From<crate::error::UpdateIdentityPoolError> for Error {
    fn from(err: crate::error::UpdateIdentityPoolError) -> Self {
        match err.kind {
            crate::error::UpdateIdentityPoolErrorKind::ConcurrentModificationException(inner) => {
                Error::ConcurrentModificationException(inner)
            }
