...
pub fn ser_get_id_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::get_id::GetIdInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
