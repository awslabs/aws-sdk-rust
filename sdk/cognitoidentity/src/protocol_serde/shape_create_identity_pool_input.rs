...
pub fn ser_create_identity_pool_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateIdentityPoolInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
