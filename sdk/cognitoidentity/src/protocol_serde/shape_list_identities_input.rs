...
pub fn ser_list_identities_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListIdentitiesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
