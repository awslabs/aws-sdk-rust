...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
        Some(code) => code,
        None => {
            return Err(crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError::unhandled(
                generic,
            ))
        }
    };
    ...
    Err(match error_code {
        ...
        "InvalidIdentityPoolConfigurationException" => {
            crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError::InvalidIdentityPoolConfigurationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_credentials_for_identity::de_get_credentials_for_identity(_response_body, output)
            .map_err(crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError::unhandled)?;
...
pub(crate) fn de_get_credentials_for_identity(
    value: &[u8],
    mut builder: crate::operation::get_credentials_for_identity::builders::GetCredentialsForIdentityOutputBuilder,
) -> Result<
    crate::operation::get_credentials_for_identity::builders::GetCredentialsForIdentityOutputBuilder,
