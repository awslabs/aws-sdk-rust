...
impl GetCredentialsForIdentityInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_credentials_for_identity::GetCredentialsForIdentity::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCredentialsForIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_credentials_for_identity::de_get_credentials_for_identity_http_response_with_props(status, headers, body)
        }
    }
}
