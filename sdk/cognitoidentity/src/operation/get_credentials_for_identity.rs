...
impl GetCredentialsForIdentityInput {
    /// Consumes the builder and constructs an Operation<[`GetCredentialsForIdentity`](crate::operation::get_credentials_for_identity::GetCredentialsForIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_credentials_for_identity::GetCredentialsForIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_credentials_for_identity::GetCredentialsForIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_credentials_for_identity::ser_get_credentials_for_identity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_credentials_for_identity::GetCredentialsForIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetCredentialsForIdentity", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetCredentialsForIdentity {
                type Output = std::result::Result<crate::operation::get_credentials_for_identity::GetCredentialsForIdentityOutput, crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError>;
