...
impl GetCredentialsForIdentityInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_credentials_for_identity::GetCredentialsForIdentity::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_credentials_for_identity::GetCredentialsForIdentityError
{
