...
impl GetCredentialsForIdentity {
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Cognito Identity",
            "rpc.method" = "GetCredentialsForIdentity",
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetCredentialsForIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetCredentialsForIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetCredentialsForIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetCredentialsForIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetCredentialsForIdentityInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("IdentityId") {
            if let ::std::option::Option::Some(value) = input.identity_id.as_deref() {
                captured.insert("IdentityId", value);
            }
        }
        if requested.should_capture("CustomRoleArn") {
            if let ::std::option::Option::Some(value) = input.custom_role_arn.as_deref() {
                captured.insert("CustomRoleArn", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetCredentialsForIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_credentials_for_identity::de_get_credentials_for_identity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_credentials_for_identity::de_get_credentials_for_identity_http_response(status, headers, body, _cfg)
        };
