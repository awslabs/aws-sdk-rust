...
impl GetOpenIdTokenForDeveloperIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetOpenIdTokenForDeveloperIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOpenIdTokenForDeveloperIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetOpenIdTokenForDeveloperIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetOpenIdTokenForDeveloperIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetOpenIdTokenForDeveloperIdentity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOpenIdTokenForDeveloperIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOpenIdTokenForDeveloperIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetOpenIdTokenForDeveloperIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOpenIdTokenForDeveloperIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOpenIdTokenForDeveloperIdentityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOpenIdTokenForDeveloperIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_open_id_token_for_developer_identity::de_get_open_id_token_for_developer_identity_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_get_open_id_token_for_developer_identity::de_get_open_id_token_for_developer_identity_http_response(
                status, headers, body,
            )
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOpenIdTokenForDeveloperIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_open_id_token_for_developer_identity::ser_get_open_id_token_for_developer_identity_input(&input)?,
        );
...
impl ::std::error::Error for GetOpenIdTokenForDeveloperIdentityError {
    fn source(&self) -> ::std::option::Option<&(dyn ::std::error::Error + 'static)> {
        match self {
            Self::DeveloperUserAlreadyRegisteredException(_inner) => ::std::option::Option::Some(_inner),
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetOpenIdTokenForDeveloperIdentityError {
    fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            Self::DeveloperUserAlreadyRegisteredException(_inner) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(_inner),
