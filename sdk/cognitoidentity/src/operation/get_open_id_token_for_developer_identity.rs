...
impl GetOpenIdTokenForDeveloperIdentityInput {
    /// Consumes the builder and constructs an Operation<[`GetOpenIdTokenForDeveloperIdentity`](crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError>{
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_open_id_token_for_developer_identity::ser_get_open_id_token_for_developer_identity_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentity::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetOpenIdTokenForDeveloperIdentity", "cognitoidentity"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOpenIdTokenForDeveloperIdentity {
    type Output = ::std::result::Result<crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityOutput, crate::operation::get_open_id_token_for_developer_identity::GetOpenIdTokenForDeveloperIdentityError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_open_id_token_for_developer_identity::de_get_open_id_token_for_developer_identity_http_response_with_props(status, headers, body)
        }
    }
}
