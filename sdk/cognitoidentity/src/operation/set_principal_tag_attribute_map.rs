...
impl SetPrincipalTagAttributeMapInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMap::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetPrincipalTagAttributeMap {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_set_principal_tag_attribute_map::de_set_principal_tag_attribute_map_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for SetPrincipalTagAttributeMapError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError
{
