...
impl SetPrincipalTagAttributeMapInput {
    /// Consumes the builder and constructs an Operation<[`SetPrincipalTagAttributeMap`](crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMap)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMap, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_principal_tag_attribute_map::ser_set_principal_tag_attribute_map_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMap::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("SetPrincipalTagAttributeMap", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for SetPrincipalTagAttributeMap {
                type Output = std::result::Result<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapOutput, crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>;
