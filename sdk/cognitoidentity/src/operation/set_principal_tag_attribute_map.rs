    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                    ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>::assume_from(err.into())
        ...
        ::std::result::Result::Ok(::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapOutput>::assume_from(output).expect("correct output type").unwrap())
    }
...
impl ::aws_smithy_runtime_api::client::orchestrator::ResponseDeserializer for SetPrincipalTagAttributeMapResponseDeserializer {
...
impl ::aws_smithy_runtime_api::client::orchestrator::RequestSerializer for SetPrincipalTagAttributeMapRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = ::aws_smithy_types::type_erasure::TypedBox::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapInput>::assume_from(input).expect("correct type").unwrap();
...
impl ::aws_smithy_runtime_api::client::interceptors::Interceptor for SetPrincipalTagAttributeMapEndpointParamsInterceptor {
...
impl ::aws_http::request_id::RequestId for crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError {
