...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetPrincipalTagAttributeMapResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_principal_tag_attribute_map::de_set_principal_tag_attribute_map_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_principal_tag_attribute_map::de_set_principal_tag_attribute_map_http_response(
