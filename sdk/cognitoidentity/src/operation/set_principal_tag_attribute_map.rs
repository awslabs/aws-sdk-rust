...
impl SetPrincipalTagAttributeMap {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapInput,
                    ) -> ::std::result::Result<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetPrincipalTagAttributeMap {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("SetPrincipalTagAttributeMap");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(SetPrincipalTagAttributeMapRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(SetPrincipalTagAttributeMapResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetPrincipalTagAttributeMap")
...
.with_interceptor(SetPrincipalTagAttributeMapEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError>::new());
...
#[derive(Debug)]
            struct SetPrincipalTagAttributeMapResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetPrincipalTagAttributeMapResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_set_principal_tag_attribute_map::de_set_principal_tag_attribute_map_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_set_principal_tag_attribute_map::de_set_principal_tag_attribute_map_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct SetPrincipalTagAttributeMapRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetPrincipalTagAttributeMapRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_principal_tag_attribute_map::ser_set_principal_tag_attribute_map_input(&input)?);
...
#[derive(Debug)]
            struct SetPrincipalTagAttributeMapEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetPrincipalTagAttributeMapEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "SetPrincipalTagAttributeMapEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<SetPrincipalTagAttributeMapInput>()
                        .ok_or("failed to downcast to SetPrincipalTagAttributeMapInput")?;
...
pub enum SetPrincipalTagAttributeMapError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-SetPrincipalTagAttributeMapError) for what information is available for the error.")]
...
impl SetPrincipalTagAttributeMapError {
    /// Creates the `SetPrincipalTagAttributeMapError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SetPrincipalTagAttributeMapError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for SetPrincipalTagAttributeMapError {
...
impl ::aws_types::request_id::RequestId for crate::operation::set_principal_tag_attribute_map::SetPrincipalTagAttributeMapError {
...
mod _set_principal_tag_attribute_map_output;
