...
impl UnlinkIdentityFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::unlink_identity::UnlinkIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::unlink_identity::UnlinkIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::unlink_identity::UnlinkIdentityOutput, crate::operation::unlink_identity::UnlinkIdentityError, Self> {
