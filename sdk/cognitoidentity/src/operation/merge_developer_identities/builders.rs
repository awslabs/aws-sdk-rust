...
impl MergeDeveloperIdentitiesFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput, crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError, Self> {
