...
impl SetIdentityPoolRoles {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::set_identity_pool_roles::SetIdentityPoolRolesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::set_identity_pool_roles::SetIdentityPoolRolesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "SetIdentityPoolRoles",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for SetIdentityPoolRoles {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            SetIdentityPoolRolesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            SetIdentityPoolRolesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("SetIdentityPoolRoles")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("SetIdentityPoolRoles")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                SetIdentityPoolRolesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct SetIdentityPoolRolesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for SetIdentityPoolRolesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<SetIdentityPoolRolesInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for SetIdentityPoolRolesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_set_identity_pool_roles::de_set_identity_pool_roles_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_set_identity_pool_roles::de_set_identity_pool_roles_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for SetIdentityPoolRolesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::set_identity_pool_roles::SetIdentityPoolRolesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::set_identity_pool_roles::SetIdentityPoolRolesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_set_identity_pool_roles::ser_set_identity_pool_roles_input(
            &input,
        )?);
