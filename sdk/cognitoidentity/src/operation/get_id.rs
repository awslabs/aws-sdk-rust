...
impl GetIdInput {
    /// Consumes the builder and constructs an Operation<[`GetId`](crate::operation::get_id::GetId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_id::GetId, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_id::GetIdInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_id::ser_get_id_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_id::GetId::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetId", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetId {
                type Output = std::result::Result<crate::operation::get_id::GetIdOutput, crate::operation::get_id::GetIdError>;
