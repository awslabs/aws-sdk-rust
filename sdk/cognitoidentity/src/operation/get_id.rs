...
impl GetIdInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::get_id::GetId, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_get_id::ser_get_id_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetId {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_id::de_get_id_http_response_with_props(status, headers, body)
        }
    }
}
