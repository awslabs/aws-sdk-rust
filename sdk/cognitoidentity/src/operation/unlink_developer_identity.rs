...
impl UnlinkDeveloperIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "UnlinkDeveloperIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UnlinkDeveloperIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UnlinkDeveloperIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UnlinkDeveloperIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UnlinkDeveloperIdentity")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UnlinkDeveloperIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UnlinkDeveloperIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct UnlinkDeveloperIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UnlinkDeveloperIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<UnlinkDeveloperIdentityInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UnlinkDeveloperIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_unlink_developer_identity::de_unlink_developer_identity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_unlink_developer_identity::de_unlink_developer_identity_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UnlinkDeveloperIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_unlink_developer_identity::ser_unlink_developer_identity_input(&input)?,
        );
