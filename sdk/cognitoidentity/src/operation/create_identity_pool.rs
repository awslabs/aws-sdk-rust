...
impl CreateIdentityPoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_identity_pool::ser_create_identity_pool_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::create_identity_pool::CreateIdentityPool::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::create_identity_pool::CreateIdentityPoolError
{
