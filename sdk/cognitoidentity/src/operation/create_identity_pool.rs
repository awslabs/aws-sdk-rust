...
impl CreateIdentityPoolInput {
    /// Consumes the builder and constructs an Operation<[`CreateIdentityPool`](crate::operation::create_identity_pool::CreateIdentityPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::create_identity_pool::CreateIdentityPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_identity_pool::CreateIdentityPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_identity_pool::ser_create_identity_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::create_identity_pool::CreateIdentityPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("CreateIdentityPool", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for CreateIdentityPool {
                type Output = std::result::Result<crate::operation::create_identity_pool::CreateIdentityPoolOutput, crate::operation::create_identity_pool::CreateIdentityPoolError>;
