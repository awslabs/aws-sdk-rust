...
impl UnlinkIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<
            crate::operation::unlink_identity::UnlinkIdentity,
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::unlink_identity::UnlinkIdentity::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnlinkIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_unlink_identity::de_unlink_identity_http_error(
                status, headers, body,
            )
        } else {
