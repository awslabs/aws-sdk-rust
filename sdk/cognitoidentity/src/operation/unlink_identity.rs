...
impl UnlinkIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::unlink_identity::UnlinkIdentity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_unlink_identity::ser_unlink_identity_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnlinkIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_unlink_identity::de_unlink_identity_http_response_with_props(status, headers, body)
        }
    }
}
