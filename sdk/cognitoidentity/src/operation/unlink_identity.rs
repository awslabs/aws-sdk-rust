...
impl UnlinkIdentityInput {
    /// Consumes the builder and constructs an Operation<[`UnlinkIdentity`](crate::operation::unlink_identity::UnlinkIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::unlink_identity::UnlinkIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unlink_identity::UnlinkIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_unlink_identity::ser_unlink_identity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::unlink_identity::UnlinkIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UnlinkIdentity", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for UnlinkIdentity {
                type Output = std::result::Result<crate::operation::unlink_identity::UnlinkIdentityOutput, crate::operation::unlink_identity::UnlinkIdentityError>;
