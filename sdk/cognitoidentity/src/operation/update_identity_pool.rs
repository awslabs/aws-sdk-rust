...
impl UpdateIdentityPoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_update_identity_pool::ser_update_identity_pool_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIdentityPool {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_update_identity_pool::de_update_identity_pool_http_response_with_props(status, headers, body)
        }
    }
}
