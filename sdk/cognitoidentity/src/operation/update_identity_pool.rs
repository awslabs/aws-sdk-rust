...
impl UpdateIdentityPoolInput {
    /// Consumes the builder and constructs an Operation<[`UpdateIdentityPool`](crate::operation::update_identity_pool::UpdateIdentityPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::update_identity_pool::UpdateIdentityPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_identity_pool::UpdateIdentityPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_identity_pool::ser_update_identity_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::update_identity_pool::UpdateIdentityPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("UpdateIdentityPool", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for UpdateIdentityPool {
                type Output = std::result::Result<crate::operation::update_identity_pool::UpdateIdentityPoolOutput, crate::operation::update_identity_pool::UpdateIdentityPoolError>;
