...
impl UpdateIdentityPoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_identity_pool::ser_update_identity_pool_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::update_identity_pool::UpdateIdentityPool::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::update_identity_pool::UpdateIdentityPoolError
{
