...
impl GetPrincipalTagAttributeMapInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMap::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPrincipalTagAttributeMap {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_principal_tag_attribute_map::de_get_principal_tag_attribute_map_http_response_with_props(status, headers, body)
        }
    }
}
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata
    for GetPrincipalTagAttributeMapError
{
...
impl ::aws_http::request_id::RequestId
    for crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError
{
