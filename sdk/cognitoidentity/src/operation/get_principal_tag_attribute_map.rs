...
/// Orchestration and serialization glue logic for `GetPrincipalTagAttributeMap`.
...
impl GetPrincipalTagAttributeMap {
    ...
    pub(crate) async fn orchestrate(
                        ...
                        input: crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput,
                    ) -> ::std::result::Result<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPrincipalTagAttributeMap {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetPrincipalTagAttributeMap");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetPrincipalTagAttributeMapRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetPrincipalTagAttributeMapResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPrincipalTagAttributeMap")
...
.with_interceptor(GetPrincipalTagAttributeMapEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>::new());
...
#[derive(Debug)]
            struct GetPrincipalTagAttributeMapResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPrincipalTagAttributeMapResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_principal_tag_attribute_map::de_get_principal_tag_attribute_map_http_error(status, headers, body)
            } else {
...
#[derive(Debug)]
            struct GetPrincipalTagAttributeMapRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPrincipalTagAttributeMapRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_principal_tag_attribute_map::ser_get_principal_tag_attribute_map_input(&input)?);
...
#[derive(Debug)]
            struct GetPrincipalTagAttributeMapEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPrincipalTagAttributeMapEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetPrincipalTagAttributeMapEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetPrincipalTagAttributeMapInput>()
                        .ok_or("failed to downcast to GetPrincipalTagAttributeMapInput")?;
...
pub enum GetPrincipalTagAttributeMapError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetPrincipalTagAttributeMapError) for what information is available for the error.")]
...
impl GetPrincipalTagAttributeMapError {
    /// Creates the `GetPrincipalTagAttributeMapError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPrincipalTagAttributeMapError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetPrincipalTagAttributeMapError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError {
...
mod _get_principal_tag_attribute_map_output;
