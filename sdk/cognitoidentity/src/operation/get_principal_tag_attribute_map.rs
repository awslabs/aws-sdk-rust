...
impl GetPrincipalTagAttributeMap {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "GetPrincipalTagAttributeMap",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetPrincipalTagAttributeMap {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetPrincipalTagAttributeMapRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetPrincipalTagAttributeMapResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetPrincipalTagAttributeMap")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetPrincipalTagAttributeMap")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetPrincipalTagAttributeMapTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetPrincipalTagAttributeMapTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetPrincipalTagAttributeMapTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetPrincipalTagAttributeMapInput>() else {
        ...
        if requested.should_capture("IdentityProviderName") {
            if let ::std::option::Option::Some(value) = input.identity_provider_name.as_deref() {
                captured.insert("IdentityProviderName", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetPrincipalTagAttributeMapResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_principal_tag_attribute_map::de_get_principal_tag_attribute_map_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_principal_tag_attribute_map::de_get_principal_tag_attribute_map_http_response(
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetPrincipalTagAttributeMapRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_principal_tag_attribute_map::ser_get_principal_tag_attribute_map_input(&input)?,
        );
