...
impl GetPrincipalTagAttributeMapInput {
    /// Consumes the builder and constructs an Operation<[`GetPrincipalTagAttributeMap`](crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMap)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMap, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_principal_tag_attribute_map::ser_get_principal_tag_attribute_map_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMap::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetPrincipalTagAttributeMap", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetPrincipalTagAttributeMap {
                type Output = std::result::Result<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapOutput, crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapError>;
