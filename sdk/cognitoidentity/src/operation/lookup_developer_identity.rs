...
impl LookupDeveloperIdentity {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "LookupDeveloperIdentity",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LookupDeveloperIdentity {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            LookupDeveloperIdentityRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            LookupDeveloperIdentityResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("LookupDeveloperIdentity")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("LookupDeveloperIdentity")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                LookupDeveloperIdentityTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct LookupDeveloperIdentityTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for LookupDeveloperIdentityTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<LookupDeveloperIdentityInput>() else {
        ...
        if requested.should_capture("DeveloperUserIdentifier") {
            if let ::std::option::Option::Some(value) = input.developer_user_identifier.as_deref() {
                captured.insert("DeveloperUserIdentifier", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LookupDeveloperIdentityResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_lookup_developer_identity::de_lookup_developer_identity_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_lookup_developer_identity::de_lookup_developer_identity_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for LookupDeveloperIdentityRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::lookup_developer_identity::LookupDeveloperIdentityInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_lookup_developer_identity::ser_lookup_developer_identity_input(&input)?,
        );
