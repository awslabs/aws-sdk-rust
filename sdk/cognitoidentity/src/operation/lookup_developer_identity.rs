...
/// Orchestration and serialization glue logic for `LookupDeveloperIdentity`.
...
impl LookupDeveloperIdentity {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::lookup_developer_identity::LookupDeveloperIdentityOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for LookupDeveloperIdentity {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("LookupDeveloperIdentity");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(LookupDeveloperIdentityRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(LookupDeveloperIdentityResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("LookupDeveloperIdentity")
...
.with_interceptor(LookupDeveloperIdentityEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>::new());
...
#[derive(Debug)]
            struct LookupDeveloperIdentityResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for LookupDeveloperIdentityResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_lookup_developer_identity::de_lookup_developer_identity_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_lookup_developer_identity::de_lookup_developer_identity_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct LookupDeveloperIdentityRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for LookupDeveloperIdentityRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::lookup_developer_identity::LookupDeveloperIdentityInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::lookup_developer_identity::LookupDeveloperIdentityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_lookup_developer_identity::ser_lookup_developer_identity_input(&input)?);
...
#[derive(Debug)]
            struct LookupDeveloperIdentityEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for LookupDeveloperIdentityEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "LookupDeveloperIdentityEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<LookupDeveloperIdentityInput>()
                        .ok_or("failed to downcast to LookupDeveloperIdentityInput")?;
...
pub enum LookupDeveloperIdentityError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-LookupDeveloperIdentityError) for what information is available for the error.")]
...
impl LookupDeveloperIdentityError {
    /// Creates the `LookupDeveloperIdentityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `LookupDeveloperIdentityError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for LookupDeveloperIdentityError {
...
impl ::aws_types::request_id::RequestId for crate::operation::lookup_developer_identity::LookupDeveloperIdentityError {
...
mod _lookup_developer_identity_output;
