...
impl LookupDeveloperIdentityInput {
    /// Consumes the builder and constructs an Operation<[`LookupDeveloperIdentity`](crate::operation::lookup_developer_identity::LookupDeveloperIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::lookup_developer_identity::LookupDeveloperIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::lookup_developer_identity::LookupDeveloperIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_lookup_developer_identity::ser_lookup_developer_identity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::lookup_developer_identity::LookupDeveloperIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("LookupDeveloperIdentity", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for LookupDeveloperIdentity {
                type Output = std::result::Result<crate::operation::lookup_developer_identity::LookupDeveloperIdentityOutput, crate::operation::lookup_developer_identity::LookupDeveloperIdentityError>;
