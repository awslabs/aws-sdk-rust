...
impl GetOpenIdToken {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_open_id_token::GetOpenIdTokenError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_open_id_token::GetOpenIdTokenOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Cognito Identity", "GetOpenIdToken", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "Cognito Identity.GetOpenIdToken",
                "rpc.service" = "Cognito Identity",
                "rpc.method" = "GetOpenIdToken",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetOpenIdToken {
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetOpenIdToken")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetOpenIdTokenTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetOpenIdTokenTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetOpenIdTokenTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetOpenIdTokenInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetOpenIdTokenResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_open_id_token::de_get_open_id_token_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_open_id_token::de_get_open_id_token_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetOpenIdTokenRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_open_id_token::GetOpenIdTokenInput>()
            .expect("correct type");
