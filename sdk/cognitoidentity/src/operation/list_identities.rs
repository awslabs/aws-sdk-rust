...
impl ListIdentitiesInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_list_identities::ser_list_identities_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_identities::ListIdentities::new())
            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIdentities", "cognitoidentity"));
