...
impl DescribeIdentityPoolInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_identity_pool::ser_describe_identity_pool_input(
                &self,
            )?,
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::describe_identity_pool::DescribeIdentityPool::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::describe_identity_pool::DescribeIdentityPoolError
{
