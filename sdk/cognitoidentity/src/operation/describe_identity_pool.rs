...
impl DescribeIdentityPoolInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIdentityPool`](crate::operation::describe_identity_pool::DescribeIdentityPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_identity_pool::DescribeIdentityPool, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_identity_pool::DescribeIdentityPoolInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_identity_pool::ser_describe_identity_pool_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_identity_pool::DescribeIdentityPool::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeIdentityPool", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeIdentityPool {
                type Output = std::result::Result<crate::operation::describe_identity_pool::DescribeIdentityPoolOutput, crate::operation::describe_identity_pool::DescribeIdentityPoolError>;
