...
impl MergeDeveloperIdentities {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "MergeDeveloperIdentities",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for MergeDeveloperIdentities {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            MergeDeveloperIdentitiesRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            MergeDeveloperIdentitiesResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("MergeDeveloperIdentities")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("MergeDeveloperIdentities")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                MergeDeveloperIdentitiesTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct MergeDeveloperIdentitiesTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for MergeDeveloperIdentitiesTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<MergeDeveloperIdentitiesInput>() else {
            // A mismatched input is not this interceptor's concern; skip quietly.
            return ::std::result::Result::Ok(());
        };

        let mut captured = ::aws_smithy_types::telemetry::CapturedTelemetryAttributes::default();
        if requested.should_capture("SourceUserIdentifier") {
            if let ::std::option::Option::Some(value) = input.source_user_identifier.as_deref() {
                captured.insert("SourceUserIdentifier", value);
            }
        }
        if requested.should_capture("DestinationUserIdentifier") {
            if let ::std::option::Option::Some(value) = input.destination_user_identifier.as_deref() {
                captured.insert("DestinationUserIdentifier", value);
            }
        }
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for MergeDeveloperIdentitiesResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_merge_developer_identities::de_merge_developer_identities_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_merge_developer_identities::de_merge_developer_identities_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for MergeDeveloperIdentitiesRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_merge_developer_identities::ser_merge_developer_identities_input(&input)?,
        );
