...
impl DescribeIdentityInput {
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::describe_identity::DescribeIdentity, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_describe_identity::ser_describe_identity_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIdentity {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_describe_identity::de_describe_identity_http_response_with_props(status, headers, body)
        }
    }
}
