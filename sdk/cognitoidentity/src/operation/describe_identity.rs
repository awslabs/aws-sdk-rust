...
impl DescribeIdentityInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIdentity`](crate::operation::describe_identity::DescribeIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::describe_identity::DescribeIdentity, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_identity::DescribeIdentityInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_identity::ser_describe_identity_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::describe_identity::DescribeIdentity::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("DescribeIdentity", "cognitoidentity"));
...
impl aws_smithy_http::response::ParseStrictResponse for DescribeIdentity {
                type Output = std::result::Result<crate::operation::describe_identity::DescribeIdentityOutput, crate::operation::describe_identity::DescribeIdentityError>;
