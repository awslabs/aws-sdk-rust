...
impl CreateIdentityPoolInput {
    ...
    > {
        Ok({
            ...
            let body = crate::operation_ser::serialize_operation_create_identity_pool(&self)
                .map_err(|err| {
...
impl DeleteIdentitiesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_delete_identities(&self).map_err(
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.DeleteIdentities");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl DeleteIdentityPoolInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_delete_identity_pool(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl DescribeIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_describe_identity(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.DescribeIdentity");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl DescribeIdentityPoolInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_describe_identity_pool(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl GetCredentialsForIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_credentials_for_identity(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
...
impl GetIdInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_get_id(&self).map_err(|err| {
                smithy_http::operation::BuildError::SerializationError(err.into())
            })?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
            ...
            let op =
                smithy_http::operation::Operation::new(request, crate::operation::GetId::new())
                    .with_metadata(smithy_http::operation::Metadata::new(
                        "GetId",
                        "cognitoidentity",
                    ));
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.GetId");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl GetIdentityPoolRolesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_get_identity_pool_roles(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl GetOpenIdTokenInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_get_open_id_token(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.GetOpenIdToken");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl GetOpenIdTokenForDeveloperIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_open_id_token_for_developer_identity(
                    &self,
                )
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
...
impl GetPrincipalTagAttributeMapInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_get_principal_tag_attribute_map(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
...
impl ListIdentitiesInput {
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.ListIdentities");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl ListIdentityPoolsInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_list_identity_pools(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl LookupDeveloperIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_lookup_developer_identity(&self)
                .map_err(|err| {
                smithy_http::operation::BuildError::SerializationError(err.into())
            })?;
            let request = Self::assemble(request, body);
...
impl MergeDeveloperIdentitiesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_merge_developer_identities(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl SetIdentityPoolRolesInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_set_identity_pool_roles(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
...
impl SetPrincipalTagAttributeMapInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body =
                crate::operation_ser::serialize_operation_set_principal_tag_attribute_map(&self)
                    .map_err(|err| {
                        smithy_http::operation::BuildError::SerializationError(err.into())
                    })?;
            let request = Self::assemble(request, body);
...
impl TagResourceInput {
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.TagResource");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl UnlinkDeveloperIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_unlink_developer_identity(&self)
                .map_err(|err| {
                smithy_http::operation::BuildError::SerializationError(err.into())
            })?;
            let request = Self::assemble(request, body);
...
impl UnlinkIdentityInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_unlink_identity(&self).map_err(
                |err| smithy_http::operation::BuildError::SerializationError(err.into()),
            )?;
            let request = Self::assemble(request, body);
            #[allow(unused_mut)]
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.UnlinkIdentity");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl UntagResourceInput {
    ...
    fn request_builder_base(
        ...
        let builder = http::request::Builder::new();
        let builder = builder.header("Content-Type", "application/x-amz-json-1.1");
        let builder = builder.header("x-amz-target", "AWSCognitoIdentityService.UntagResource");
        self.update_http_builder(builder)
    }
    fn assemble(
        mut builder: http::request::Builder,
...
impl UpdateIdentityPoolInput {
    ...
    > {
        Ok({
            let request = self.request_builder_base()?;
            let body = crate::operation_ser::serialize_operation_update_identity_pool(&self)
                .map_err(|err| {
                    smithy_http::operation::BuildError::SerializationError(err.into())
                })?;
            let request = Self::assemble(request, body);
