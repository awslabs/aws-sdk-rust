                ...
                ref_val if ref_val >= 100_000_000 => {
                    return match (ref_val - 100_000_000) as usize {
                        ...
                        4 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cognito-identity-fips.us-east-1.amazonaws.com".to_string())
                                .build(),
                        ),
                        5 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cognito-identity-fips.us-east-2.amazonaws.com".to_string())
                                .build(),
                        ),
                        6 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cognito-identity-fips.us-west-1.amazonaws.com".to_string())
                                .build(),
                        ),
                        7 => ::std::result::Result::Ok(
                            ::aws_smithy_types::endpoint::Endpoint::builder()
                                .url("https://cognito-identity-fips.us-west-2.amazonaws.com".to_string())
                                .build(),
                        ),
                        8 => {
