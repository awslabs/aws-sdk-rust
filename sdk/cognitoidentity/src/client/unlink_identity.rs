...
impl super::Client {
    ...
    ///   - [`identity_id(impl ::std::convert::Into<String>)`](crate::operation::unlink_identity::builders::UnlinkIdentityFluentBuilder::identity_id) / [`set_identity_id(Option<String>)`](crate::operation::unlink_identity::builders::UnlinkIdentityFluentBuilder::set_identity_id): <p>A unique identifier in the format REGION:GUID.</p>
