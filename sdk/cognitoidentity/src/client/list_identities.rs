...
impl super::Client {
    ...
    ///   - [`identity_pool_id(impl Into<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::identity_pool_id) / [`set_identity_pool_id(Option<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_identity_pool_id):<br>required: **true**<br><p>An identity pool ID in the format REGION:GUID.</p><br>
    ///   - [`max_results(i32)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_max_results):<br>required: **true**<br><p>The maximum number of identities to return.</p><br>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_next_token):<br>required: **false**<br><p>A pagination token.</p><br>
