...
impl super::Client {
    ...
    ///   - [`identity_pool_id(impl ::std::convert::Into<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::identity_pool_id) / [`set_identity_pool_id(Option<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_identity_pool_id): <p>An identity pool ID in the format REGION:GUID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_next_token): <p>A pagination token.</p>
