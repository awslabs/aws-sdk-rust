...
impl super::Client {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_max_results): <p>The maximum number of identities to return.</p>
    ...
    ///   - [`hide_disabled(bool)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::hide_disabled) / [`set_hide_disabled(Option<bool>)`](crate::operation::list_identities::builders::ListIdentitiesFluentBuilder::set_hide_disabled): <p>An optional boolean parameter that allows you to hide disabled identities. If omitted, the ListIdentities API will include disabled identities in the response.</p>
