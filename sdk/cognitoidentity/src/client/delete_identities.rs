...
impl super::Client {
    ...
    ///   - [`identity_ids_to_delete(impl Into<String>)`](crate::operation::delete_identities::builders::DeleteIdentitiesFluentBuilder::identity_ids_to_delete) / [`set_identity_ids_to_delete(Option<Vec::<String>>)`](crate::operation::delete_identities::builders::DeleteIdentitiesFluentBuilder::set_identity_ids_to_delete):<br>required: **true**<br><p>A list of 1-60 identities that you want to delete.</p><br>
