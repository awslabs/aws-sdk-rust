...
impl  AssumeRoleForPodIdentityOutput  {
    ...
    pub fn audience(&self) -> & str {
        use std::ops::Deref; self.audience.deref()
    }
    /// <p>The Amazon Resource Name (ARN) and ID of the EKS Pod Identity association.</p>
...
impl AssumeRoleForPodIdentityOutputBuilder {
    ...
    pub fn set_pod_identity_association(mut self, input: ::std::option::Option<crate::types::PodIdentityAssociation>) -> Self {
        self.pod_identity_association = input; self
    }
    /// <p>The Amazon Resource Name (ARN) and ID of the EKS Pod Identity association.</p>
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::assume_role_for_pod_identity::AssumeRoleForPodIdentityOutput, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::assume_role_for_pod_identity::AssumeRoleForPodIdentityOutput {
                ...
                audience: self.audience
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("audience", "audience was not specified but it is required when building AssumeRoleForPodIdentityOutput")
                    )?
                ,
