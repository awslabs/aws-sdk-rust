...
///     ErrorCode::ServiceQuotaExceededError => { /* ... */ },
...
impl ::std::convert::From<&str> for ErrorCode {
    fn from(s: &str) -> Self {
        match s {
            ...
            "INTERNAL_SERVICE_ERROR" => ErrorCode::InternalServiceError,
            "RESOURCE_NOT_FOUND_ERROR" => ErrorCode::ResourceNotFoundError,
            "SERVICE_QUOTA_EXCEEDED_ERROR" => ErrorCode::ServiceQuotaExceededError,
...
impl ErrorCode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            ErrorCode::ServiceQuotaExceededError => "SERVICE_QUOTA_EXCEEDED_ERROR",
...
impl ::std::fmt::Display for ErrorCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            ErrorCode::InternalServiceError => write!(f, "INTERNAL_SERVICE_ERROR"),
            ErrorCode::ResourceNotFoundError => write!(f, "RESOURCE_NOT_FOUND_ERROR"),
            ErrorCode::ServiceQuotaExceededError => write!(f, "SERVICE_QUOTA_EXCEEDED_ERROR"),
