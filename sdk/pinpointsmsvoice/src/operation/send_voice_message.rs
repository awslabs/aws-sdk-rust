    ...
    > {
        ...
        let mut request = {
            ...
            ) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError>
            {
                ...
                ::std::write!(output, "/v1/sms-voice/voice/message")
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::send_voice_message::SendVoiceMessage::new(),
        )
...
impl ::aws_http::request_id::RequestId
    for crate::operation::send_voice_message::SendVoiceMessageError
{
