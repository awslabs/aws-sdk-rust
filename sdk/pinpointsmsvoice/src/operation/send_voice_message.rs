...
impl SendVoiceMessageInput {
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_send_voice_message::ser_send_voice_message_input(&self)?);
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendVoiceMessage {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_send_voice_message::de_send_voice_message_http_response_with_props(status, headers, body)
        }
    }
}
