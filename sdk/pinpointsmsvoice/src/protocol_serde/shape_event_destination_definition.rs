...
pub fn ser_event_destination_definition(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::EventDestinationDefinition) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
