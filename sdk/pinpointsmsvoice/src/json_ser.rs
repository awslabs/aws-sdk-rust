...
pub fn serialize_structure_create_configuration_set_event_destination_input(
    ...
    if let Some(var_2) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_3, var_2);
        object_3.finish();
    }
...
pub fn serialize_structure_send_voice_message_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_7) = &input.content {
        ...
        crate::json_ser::serialize_structure_voice_message_content(&mut object_8, var_7);
        object_8.finish();
    }
...
pub fn serialize_structure_update_configuration_set_event_destination_input(
    ...
    if let Some(var_11) = &input.event_destination {
        ...
        crate::json_ser::serialize_structure_event_destination_definition(&mut object_12, var_11);
        object_12.finish();
    }
}
...
pub fn serialize_structure_event_destination_definition(
    ...
    if let Some(var_13) = &input.cloud_watch_logs_destination {
        ...
        crate::json_ser::serialize_structure_cloud_watch_logs_destination(&mut object_14, var_13);
        object_14.finish();
    }
    if input.enabled {
    ...
    if let Some(var_15) = &input.kinesis_firehose_destination {
        ...
        crate::json_ser::serialize_structure_kinesis_firehose_destination(&mut object_16, var_15);
        object_16.finish();
    }
    ...
    if let Some(var_20) = &input.sns_destination {
        ...
        crate::json_ser::serialize_structure_sns_destination(&mut object_21, var_20);
        object_21.finish();
    }
}

pub fn serialize_structure_voice_message_content(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_22) = &input.call_instructions_message {
        ...
        crate::json_ser::serialize_structure_call_instructions_message_type(&mut object_23, var_22);
        object_23.finish();
    }
    if let Some(var_24) = &input.plain_text_message {
        let mut object_25 = object.key("PlainTextMessage").start_object();
        crate::json_ser::serialize_structure_plain_text_message_type(&mut object_25, var_24);
        object_25.finish();
    }
    if let Some(var_26) = &input.ssml_message {
        let mut object_27 = object.key("SSMLMessage").start_object();
        crate::json_ser::serialize_structure_ssml_message_type(&mut object_27, var_26);
        object_27.finish();
    }
}

pub fn serialize_structure_cloud_watch_logs_destination(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_call_instructions_message_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_plain_text_message_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_ssml_message_type(
    object: &mut smithy_json::serialize::JsonObjectWriter,
