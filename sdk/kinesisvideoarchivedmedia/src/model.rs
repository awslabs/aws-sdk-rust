...
pub struct Fragment  {
    ...
    #[doc(hidden)]pub fragment_size_in_bytes: i64,
    /// <p>The timestamp from the producer corresponding to the fragment.</p>
    #[doc(hidden)]pub producer_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The timestamp from the AWS server corresponding to the fragment.</p>
    #[doc(hidden)]pub server_timestamp: std::option::Option<aws_smithy_types::DateTime>,
    /// <p>The playback duration or other time value associated with the fragment.</p>
    #[doc(hidden)]pub fragment_length_in_milliseconds: i64,
}
impl Fragment {
    /// <p>The unique identifier of the fragment. This value monotonically increases based on the ingestion order.</p>
...
impl  std::fmt::Debug for Fragment  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("fragment_length_in_milliseconds", &self.fragment_length_in_milliseconds);
        formatter.finish()
    }
}
...
pub struct FragmentSelector  {
    ...
    #[doc(hidden)]pub fragment_selector_type: std::option::Option<crate::model::FragmentSelectorType>,
    /// <p>The range of timestamps to return.</p>
    #[doc(hidden)]pub timestamp_range: std::option::Option<crate::model::TimestampRange>,
}
...
pub struct Image  {
    ...
    /// </ul>
    #[doc(hidden)]pub error: std::option::Option<crate::model::ImageError>,
    /// <p>An attribute of the <code>Image</code> object that is Base64 encoded.</p>
    #[doc(hidden)]pub image_content: std::option::Option<std::string::String>,
}
impl Image {
    /// <p>An attribute of the <code>Image</code> object that is used to extract an image from the video stream. This field is used to manage gaps on images or to better understand the pagination window.</p>
...
pub struct HlsFragmentSelector  {
    ...
    #[doc(hidden)]pub fragment_selector_type: std::option::Option<crate::model::HlsFragmentSelectorType>,
    ...
    #[doc(hidden)]pub timestamp_range: std::option::Option<crate::model::HlsTimestampRange>,
}
...
pub struct DashFragmentSelector  {
    ...
    /// <p>The default is <code>SERVER_TIMESTAMP</code>.</p>
    #[doc(hidden)]pub fragment_selector_type: std::option::Option<crate::model::DashFragmentSelectorType>,
    /// <p>The start and end of the timestamp range for the requested media.</p> 
    /// <p>This value should not be present if <code>PlaybackType</code> is <code>LIVE</code>.</p>
    #[doc(hidden)]pub timestamp_range: std::option::Option<crate::model::DashTimestampRange>,
}
...
pub struct ClipFragmentSelector  {
    /// <p>The origin of the timestamps to use (Server or Producer).</p>
    #[doc(hidden)]pub fragment_selector_type: std::option::Option<crate::model::ClipFragmentSelectorType>,
    /// <p>The range of timestamps to return.</p>
    #[doc(hidden)]pub timestamp_range: std::option::Option<crate::model::ClipTimestampRange>,
}
