...
pub mod get_clip_input {
    ...
    impl Builder {
        ...
        /// <p>The time range of the requested clip and the source of the timestamps.</p>
        pub fn set_clip_fragment_selector(mut self, input: std::option::Option<crate::model::ClipFragmentSelector>) -> Self {
            self.clip_fragment_selector = input; self
        }
        /// Consumes the builder and constructs a [`GetClipInput`](crate::input::GetClipInput).
        pub fn build(self) -> Result<crate::input::GetClipInput, aws_smithy_http::operation::BuildError> {
            Ok(
                crate::input::GetClipInput {
...
impl GetClipInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetClip, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetClipInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetClip::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetClip", "kinesisvideoarchivedmedia"));
...
pub mod get_dash_streaming_session_url_input {
    ...
    pub struct Builder {
        ...
        pub(crate) display_fragment_timestamp: std::option::Option<crate::model::DashDisplayFragmentTimestamp>,
        pub(crate) display_fragment_number: std::option::Option<crate::model::DashDisplayFragmentNumber>,
    ...
    impl Builder {
        ...
        /// <p>In all playback modes, if <code>FragmentSelectorType</code> is <code>PRODUCER_TIMESTAMP</code>, and if there are multiple fragments with the same start timestamp, the fragment that has the larger fragment number (that is, the newer fragment) is included in the MPEG-DASH manifest. The other fragments are not included. Fragments that have different timestamps but have overlapping durations are still included in the MPEG-DASH manifest. This can lead to unexpected behavior in the media player.</p> 
        /// <p>The default is <code>LIVE</code>.</p>
        pub fn set_playback_mode(mut self, input: std::option::Option<crate::model::DashPlaybackMode>) -> Self {
        ...
        pub fn display_fragment_timestamp(mut self, input: crate::model::DashDisplayFragmentTimestamp) -> Self {
            self.display_fragment_timestamp = Some(input);
            self
        }
        /// <p>Per the MPEG-DASH specification, the wall-clock time of fragments in the manifest file can be derived using attributes in the manifest itself. However, typically, MPEG-DASH compatible media players do not properly handle gaps in the media timeline. Kinesis Video Streams adjusts the media timeline in the manifest file to enable playback of media with discontinuities. Therefore, the wall-clock time derived from the manifest file may be inaccurate. If DisplayFragmentTimestamp is set to <code>ALWAYS</code>, the accurate fragment timestamp is added to each S element in the manifest file with the attribute name “kvs:ts”. A custom MPEG-DASH media player is necessary to leverage this custom attribute.</p> 
        /// <p>The default value is <code>NEVER</code>. When <code>DASHFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>DASHFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
        pub fn set_display_fragment_timestamp(mut self, input: std::option::Option<crate::model::DashDisplayFragmentTimestamp>) -> Self {
        ...
        pub fn display_fragment_number(mut self, input: crate::model::DashDisplayFragmentNumber) -> Self {
            self.display_fragment_number = Some(input);
            self
        }
        /// <p>Fragments are identified in the manifest file based on their sequence number in the session. If DisplayFragmentNumber is set to <code>ALWAYS</code>, the Kinesis Video Streams fragment number is added to each S element in the manifest file with the attribute name “kvs:fn”. These fragment numbers can be used for logging or for use with other APIs (e.g. <code>GetMedia</code> and <code>GetMediaForFragmentList</code>). A custom MPEG-DASH media player is necessary to leverage these this custom attribute.</p> 
        /// <p>The default value is <code>NEVER</code>.</p>
        pub fn set_display_fragment_number(mut self, input: std::option::Option<crate::model::DashDisplayFragmentNumber>) -> Self {
        ...
        /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
        /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
        pub fn set_dash_fragment_selector(mut self, input: std::option::Option<crate::model::DashFragmentSelector>) -> Self {
        ...
        pub fn build(self) -> Result<crate::input::GetDashStreamingSessionUrlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetDashStreamingSessionUrlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetDASHStreamingSessionURL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetDashStreamingSessionUrlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetDASHStreamingSessionURL::new())
...
pub mod get_hls_streaming_session_url_input {
    ...
    pub struct Builder {
        ...
        pub(crate) display_fragment_timestamp: std::option::Option<crate::model::HlsDisplayFragmentTimestamp>,
        pub(crate) expires: std::option::Option<i32>,
    ...
    impl Builder {
        ...
        /// <p>In all playback modes, if <code>FragmentSelectorType</code> is <code>PRODUCER_TIMESTAMP</code>, and if there are multiple fragments with the same start timestamp, the fragment that has the largest fragment number (that is, the newest fragment) is included in the HLS media playlist. The other fragments are not included. Fragments that have different timestamps but have overlapping durations are still included in the HLS media playlist. This can lead to unexpected behavior in the media player.</p> 
        /// <p>The default is <code>LIVE</code>.</p>
        pub fn set_playback_mode(mut self, input: std::option::Option<crate::model::HlsPlaybackMode>) -> Self {
            self.playback_mode = input; self
        }
        /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
        /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
        ...
        /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
        /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
        pub fn set_hls_fragment_selector(mut self, input: std::option::Option<crate::model::HlsFragmentSelector>) -> Self {
        ...
        /// <p>Specifies which format should be used for packaging the media. Specifying the <code>FRAGMENTED_MP4</code> container format packages the media into MP4 fragments (fMP4 or CMAF). This is the recommended packaging because there is minimal packaging overhead. The other container format option is <code>MPEG_TS</code>. HLS has supported MPEG TS chunks since it was released and is sometimes the only supported packaging on older HLS players. MPEG TS typically has a 5-25 percent packaging overhead. This means MPEG TS typically requires 5-25 percent more bandwidth and cost than fMP4.</p> 
        /// <p>The default is <code>FRAGMENTED_MP4</code>.</p>
        pub fn set_container_format(mut self, input: std::option::Option<crate::model::ContainerFormat>) -> Self {
        ...
        /// </ul> 
        /// <p>The default is <code>ALWAYS</code> when <code>HLSFragmentSelector</code> is set to <code>SERVER_TIMESTAMP</code>, and <code>NEVER</code> when it is set to <code>PRODUCER_TIMESTAMP</code>.</p>
        pub fn set_discontinuity_mode(mut self, input: std::option::Option<crate::model::HlsDiscontinuityMode>) -> Self {
        ...
        pub fn display_fragment_timestamp(mut self, input: crate::model::HlsDisplayFragmentTimestamp) -> Self {
            self.display_fragment_timestamp = Some(input);
            self
        }
        /// <p>Specifies when the fragment start timestamps should be included in the HLS media playlist. Typically, media players report the playhead position as a time relative to the start of the first fragment in the playback session. However, when the start timestamps are included in the HLS media playlist, some media players might report the current playhead as an absolute time based on the fragment timestamps. This can be useful for creating a playback experience that shows viewers the wall-clock time of the media.</p> 
        /// <p>The default is <code>NEVER</code>. When <code>HLSFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>HLSFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
        pub fn set_display_fragment_timestamp(mut self, input: std::option::Option<crate::model::HlsDisplayFragmentTimestamp>) -> Self {
            self.display_fragment_timestamp = input; self
        }
        /// <p>The time in seconds until the requested session expires. This value can be between 300 (5 minutes) and 43200 (12 hours).</p> 
        ...
        pub fn build(self) -> Result<crate::input::GetHlsStreamingSessionUrlInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetHlsStreamingSessionUrlInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetHLSStreamingSessionURL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetHlsStreamingSessionUrlInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetHLSStreamingSessionURL::new())
...
pub mod get_images_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetImagesInput, aws_smithy_http::operation::BuildError> {
            Ok(
                crate::input::GetImagesInput {
                    stream_name: self.stream_name
                    ,
                    stream_arn: self.stream_arn
                    ,
...
impl GetImagesInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetImages, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetImagesInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetImages::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetImages", "kinesisvideoarchivedmedia"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod get_media_for_fragment_list_input {
    ...
    impl Builder {
        ...
        pub fn build(self) -> Result<crate::input::GetMediaForFragmentListInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl GetMediaForFragmentListInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::GetMediaForFragmentList, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::GetMediaForFragmentListInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        let mut properties = aws_smithy_http::property_bag::SharedPropertyBag::new();
        #[allow(clippy::useless_conversion)]let body = aws_smithy_http::body::SdkBody::from(
            crate::operation_ser::serialize_operation_crate_operation_get_media_for_fragment_list(&self)?
        );
        if let Some(content_length) = body.content_length() {
                                request = aws_smithy_http::header::set_request_header_if_absent(request, http::header::CONTENT_LENGTH, content_length);
                            }
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::GetMediaForFragmentList::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetMediaForFragmentList", "kinesisvideoarchivedmedia"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub mod list_fragments_input {
    ...
    impl Builder {
        ...
        /// <p>Describes the timestamp range and timestamp origin for the range of fragments to return.</p>
        pub fn set_fragment_selector(mut self, input: std::option::Option<crate::model::FragmentSelector>) -> Self {
            self.fragment_selector = input; self
        }
        /// Consumes the builder and constructs a [`ListFragmentsInput`](crate::input::ListFragmentsInput).
        pub fn build(self) -> Result<crate::input::ListFragmentsInput, aws_smithy_http::operation::BuildError> {
            Ok(
...
impl ListFragmentsInput {
    ...
    #[allow(unused_mut)]#[allow(clippy::let_and_return)]#[allow(clippy::needless_borrow)]pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::ListFragments, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::BuildError> {
        let mut request = {
            fn uri_base(_input: &crate::input::ListFragmentsInput, output: &mut String) -> Result<(), aws_smithy_http::operation::BuildError> {
        ...
        aws_http::auth::set_provider(&mut request.properties_mut(), _config.credentials_provider.clone());
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::ListFragments::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("ListFragments", "kinesisvideoarchivedmedia"));
        let op = op.with_retry_classifier(aws_http::retry::AwsResponseRetryClassifier::new());
        Ok(op)
    }
...
pub struct ListFragmentsInput  {
    ...
    /// <p>The total number of fragments to return. If the total number of fragments available is more than the value specified in <code>max-results</code>, then a <code>ListFragmentsOutput$NextToken</code> is provided in the output that you can use to resume pagination.</p>
    #[doc(hidden)]pub max_results: std::option::Option<i64>,
    /// <p>A token to specify where to start paginating. This is the <code>ListFragmentsOutput$NextToken</code> from a previously truncated response.</p>
    #[doc(hidden)]pub next_token: std::option::Option<std::string::String>,
    /// <p>Describes the timestamp range and timestamp origin for the range of fragments to return.</p>
    #[doc(hidden)]pub fragment_selector: std::option::Option<crate::model::FragmentSelector>,
}
impl ListFragmentsInput {
    /// <p>The name of the stream from which to retrieve a fragment list. Specify either this parameter or the <code>StreamARN</code> parameter.</p>
...
pub struct GetMediaForFragmentListInput  {
    ...
    #[doc(hidden)]pub stream_arn: std::option::Option<std::string::String>,
    /// <p>A list of the numbers of fragments for which to retrieve media. You retrieve these values with <code>ListFragments</code>.</p>
    #[doc(hidden)]pub fragments: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl GetMediaForFragmentListInput {
    /// <p>The name of the stream from which to retrieve fragment media. Specify either this parameter or the <code>StreamARN</code> parameter.</p>
    pub fn stream_name(&self) -> std::option::Option<& str> {
...
pub struct GetHlsStreamingSessionUrlInput  {
    ...
    /// <p>In all playback modes, if <code>FragmentSelectorType</code> is <code>PRODUCER_TIMESTAMP</code>, and if there are multiple fragments with the same start timestamp, the fragment that has the largest fragment number (that is, the newest fragment) is included in the HLS media playlist. The other fragments are not included. Fragments that have different timestamps but have overlapping durations are still included in the HLS media playlist. This can lead to unexpected behavior in the media player.</p> 
    /// <p>The default is <code>LIVE</code>.</p>
    #[doc(hidden)]pub playback_mode: std::option::Option<crate::model::HlsPlaybackMode>,
    /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
    /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
    #[doc(hidden)]pub hls_fragment_selector: std::option::Option<crate::model::HlsFragmentSelector>,
    /// <p>Specifies which format should be used for packaging the media. Specifying the <code>FRAGMENTED_MP4</code> container format packages the media into MP4 fragments (fMP4 or CMAF). This is the recommended packaging because there is minimal packaging overhead. The other container format option is <code>MPEG_TS</code>. HLS has supported MPEG TS chunks since it was released and is sometimes the only supported packaging on older HLS players. MPEG TS typically has a 5-25 percent packaging overhead. This means MPEG TS typically requires 5-25 percent more bandwidth and cost than fMP4.</p> 
    /// <p>The default is <code>FRAGMENTED_MP4</code>.</p>
    #[doc(hidden)]pub container_format: std::option::Option<crate::model::ContainerFormat>,
    /// <p>Specifies when flags marking discontinuities between fragments are added to the media playlists.</p> 
    /// <p>Media players typically build a timeline of media content to play, based on the timestamps of each fragment. This means that if there is any overlap or gap between fragments (as is typical if <code>HLSFragmentSelector</code> is set to <code>SERVER_TIMESTAMP</code>), the media player timeline will also have small gaps between fragments in some places, and will overwrite frames in other places. Gaps in the media player timeline can cause playback to stall and overlaps can cause playback to be jittery. When there are discontinuity flags between fragments, the media player is expected to reset the timeline, resulting in the next fragment being played immediately after the previous fragment. </p> 
    /// <p>The following modes are supported:</p> 
    /// <ul> 
    ...
    /// </ul> 
    /// <p>The default is <code>ALWAYS</code> when <code>HLSFragmentSelector</code> is set to <code>SERVER_TIMESTAMP</code>, and <code>NEVER</code> when it is set to <code>PRODUCER_TIMESTAMP</code>.</p>
    #[doc(hidden)]pub discontinuity_mode: std::option::Option<crate::model::HlsDiscontinuityMode>,
    /// <p>Specifies when the fragment start timestamps should be included in the HLS media playlist. Typically, media players report the playhead position as a time relative to the start of the first fragment in the playback session. However, when the start timestamps are included in the HLS media playlist, some media players might report the current playhead as an absolute time based on the fragment timestamps. This can be useful for creating a playback experience that shows viewers the wall-clock time of the media.</p> 
    /// <p>The default is <code>NEVER</code>. When <code>HLSFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>HLSFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
    #[doc(hidden)]pub display_fragment_timestamp: std::option::Option<crate::model::HlsDisplayFragmentTimestamp>,
    /// <p>The time in seconds until the requested session expires. This value can be between 300 (5 minutes) and 43200 (12 hours).</p> 
    /// <p>When a session expires, no new calls to <code>GetHLSMasterPlaylist</code>, <code>GetHLSMediaPlaylist</code>, <code>GetMP4InitFragment</code>, <code>GetMP4MediaFragment</code>, or <code>GetTSFragment</code> can be made for that session.</p> 
    /// <p>The default is 300 (5 minutes).</p>
    #[doc(hidden)]pub expires: std::option::Option<i32>,
    /// <p>The maximum number of fragments that are returned in the HLS media playlists.</p> 
    /// <p>When the <code>PlaybackMode</code> is <code>LIVE</code>, the most recent fragments are returned up to this value. When the <code>PlaybackMode</code> is <code>ON_DEMAND</code>, the oldest fragments are returned, up to this maximum number.</p> 
    /// <p>When there are a higher number of fragments available in a live HLS media playlist, video players often buffer content before starting playback. Increasing the buffer size increases the playback latency, but it decreases the likelihood that rebuffering will occur during playback. We recommend that a live HLS media playlist have a minimum of 3 fragments and a maximum of 10 fragments.</p> 
    /// <p>The default is 5 fragments if <code>PlaybackMode</code> is <code>LIVE</code> or <code>LIVE_REPLAY</code>, and 1,000 if <code>PlaybackMode</code> is <code>ON_DEMAND</code>. </p> 
    /// <p>The maximum value of 5,000 fragments corresponds to more than 80 minutes of video on streams with 1-second fragments, and more than 13 hours of video on streams with 10-second fragments.</p>
    #[doc(hidden)]pub max_media_playlist_fragment_results: std::option::Option<i64>,
}
impl GetHlsStreamingSessionUrlInput {
    /// <p>The name of the stream for which to retrieve the HLS master playlist URL.</p> 
    /// <p>You must specify either the <code>StreamName</code> or the <code>StreamARN</code>.</p>
    ...
    /// <p>Specifies when the fragment start timestamps should be included in the HLS media playlist. Typically, media players report the playhead position as a time relative to the start of the first fragment in the playback session. However, when the start timestamps are included in the HLS media playlist, some media players might report the current playhead as an absolute time based on the fragment timestamps. This can be useful for creating a playback experience that shows viewers the wall-clock time of the media.</p> 
    /// <p>The default is <code>NEVER</code>. When <code>HLSFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>HLSFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
    pub fn display_fragment_timestamp(&self) -> std::option::Option<& crate::model::HlsDisplayFragmentTimestamp> {
...
impl  std::fmt::Debug for GetHlsStreamingSessionUrlInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("display_fragment_timestamp", &self.display_fragment_timestamp);
        formatter.field("expires", &self.expires);
        formatter.field("max_media_playlist_fragment_results", &self.max_media_playlist_fragment_results);
        formatter.finish()
    }
}
...
pub struct GetDashStreamingSessionUrlInput  {
    ...
    /// <p>In all playback modes, if <code>FragmentSelectorType</code> is <code>PRODUCER_TIMESTAMP</code>, and if there are multiple fragments with the same start timestamp, the fragment that has the larger fragment number (that is, the newer fragment) is included in the MPEG-DASH manifest. The other fragments are not included. Fragments that have different timestamps but have overlapping durations are still included in the MPEG-DASH manifest. This can lead to unexpected behavior in the media player.</p> 
    /// <p>The default is <code>LIVE</code>.</p>
    #[doc(hidden)]pub playback_mode: std::option::Option<crate::model::DashPlaybackMode>,
    /// <p>Per the MPEG-DASH specification, the wall-clock time of fragments in the manifest file can be derived using attributes in the manifest itself. However, typically, MPEG-DASH compatible media players do not properly handle gaps in the media timeline. Kinesis Video Streams adjusts the media timeline in the manifest file to enable playback of media with discontinuities. Therefore, the wall-clock time derived from the manifest file may be inaccurate. If DisplayFragmentTimestamp is set to <code>ALWAYS</code>, the accurate fragment timestamp is added to each S element in the manifest file with the attribute name “kvs:ts”. A custom MPEG-DASH media player is necessary to leverage this custom attribute.</p> 
    /// <p>The default value is <code>NEVER</code>. When <code>DASHFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>DASHFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
    #[doc(hidden)]pub display_fragment_timestamp: std::option::Option<crate::model::DashDisplayFragmentTimestamp>,
    /// <p>Fragments are identified in the manifest file based on their sequence number in the session. If DisplayFragmentNumber is set to <code>ALWAYS</code>, the Kinesis Video Streams fragment number is added to each S element in the manifest file with the attribute name “kvs:fn”. These fragment numbers can be used for logging or for use with other APIs (e.g. <code>GetMedia</code> and <code>GetMediaForFragmentList</code>). A custom MPEG-DASH media player is necessary to leverage these this custom attribute.</p> 
    /// <p>The default value is <code>NEVER</code>.</p>
    #[doc(hidden)]pub display_fragment_number: std::option::Option<crate::model::DashDisplayFragmentNumber>,
    /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
    /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
    #[doc(hidden)]pub dash_fragment_selector: std::option::Option<crate::model::DashFragmentSelector>,
    /// <p>The time in seconds until the requested session expires. This value can be between 300 (5 minutes) and 43200 (12 hours).</p> 
    /// <p>When a session expires, no new calls to <code>GetDashManifest</code>, <code>GetMP4InitFragment</code>, or <code>GetMP4MediaFragment</code> can be made for that session.</p> 
    /// <p>The default is 300 (5 minutes).</p>
    #[doc(hidden)]pub expires: std::option::Option<i32>,
    ...
    /// <p>The default is 5 fragments if <code>PlaybackMode</code> is <code>LIVE</code> or <code>LIVE_REPLAY</code>, and 1,000 if <code>PlaybackMode</code> is <code>ON_DEMAND</code>. </p> 
    /// <p>The maximum value of 1,000 fragments corresponds to more than 16 minutes of video on streams with 1-second fragments, and more than 2 1/2 hours of video on streams with 10-second fragments.</p>
    #[doc(hidden)]pub max_manifest_fragment_results: std::option::Option<i64>,
}
impl GetDashStreamingSessionUrlInput {
    /// <p>The name of the stream for which to retrieve the MPEG-DASH manifest URL.</p> 
    /// <p>You must specify either the <code>StreamName</code> or the <code>StreamARN</code>.</p>
    ...
    /// <p>Per the MPEG-DASH specification, the wall-clock time of fragments in the manifest file can be derived using attributes in the manifest itself. However, typically, MPEG-DASH compatible media players do not properly handle gaps in the media timeline. Kinesis Video Streams adjusts the media timeline in the manifest file to enable playback of media with discontinuities. Therefore, the wall-clock time derived from the manifest file may be inaccurate. If DisplayFragmentTimestamp is set to <code>ALWAYS</code>, the accurate fragment timestamp is added to each S element in the manifest file with the attribute name “kvs:ts”. A custom MPEG-DASH media player is necessary to leverage this custom attribute.</p> 
    /// <p>The default value is <code>NEVER</code>. When <code>DASHFragmentSelector</code> is <code>SERVER_TIMESTAMP</code>, the timestamps will be the server start timestamps. Similarly, when <code>DASHFragmentSelector</code> is <code>PRODUCER_TIMESTAMP</code>, the timestamps will be the producer start timestamps. </p>
    pub fn display_fragment_timestamp(&self) -> std::option::Option<& crate::model::DashDisplayFragmentTimestamp> {
        self.display_fragment_timestamp.as_ref()
    }
    /// <p>Fragments are identified in the manifest file based on their sequence number in the session. If DisplayFragmentNumber is set to <code>ALWAYS</code>, the Kinesis Video Streams fragment number is added to each S element in the manifest file with the attribute name “kvs:fn”. These fragment numbers can be used for logging or for use with other APIs (e.g. <code>GetMedia</code> and <code>GetMediaForFragmentList</code>). A custom MPEG-DASH media player is necessary to leverage these this custom attribute.</p> 
    /// <p>The default value is <code>NEVER</code>.</p>
    pub fn display_fragment_number(&self) -> std::option::Option<& crate::model::DashDisplayFragmentNumber> {
        self.display_fragment_number.as_ref()
    }
    /// <p>The time range of the requested fragment and the source of the timestamps.</p> 
    /// <p>This parameter is required if <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>. This parameter is optional if PlaybackMode is<code></code> <code>LIVE</code>. If <code>PlaybackMode</code> is <code>LIVE</code>, the <code>FragmentSelectorType</code> can be set, but the <code>TimestampRange</code> should not be set. If <code>PlaybackMode</code> is <code>ON_DEMAND</code> or <code>LIVE_REPLAY</code>, both <code>FragmentSelectorType</code> and <code>TimestampRange</code> must be set.</p>
    pub fn dash_fragment_selector(&self) -> std::option::Option<& crate::model::DashFragmentSelector> {
...
impl  std::fmt::Debug for GetDashStreamingSessionUrlInput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("expires", &self.expires);
        formatter.field("max_manifest_fragment_results", &self.max_manifest_fragment_results);
        formatter.finish()
    }
}
...
pub struct GetClipInput  {
    ...
    #[doc(hidden)]pub stream_arn: std::option::Option<std::string::String>,
    /// <p>The time range of the requested clip and the source of the timestamps.</p>
    #[doc(hidden)]pub clip_fragment_selector: std::option::Option<crate::model::ClipFragmentSelector>,
}
impl GetClipInput {
    /// <p>The name of the stream for which to retrieve the media clip. </p> 
    /// <p>You must specify either the StreamName or the StreamARN. </p>
    ...
    /// <p>The time range of the requested clip and the source of the timestamps.</p>
    pub fn clip_fragment_selector(&self) -> std::option::Option<& crate::model::ClipFragmentSelector> {
