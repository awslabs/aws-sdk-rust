...
pub fn ser_get_images_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetImagesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
