...
pub fn ser_fragment_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::FragmentSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
