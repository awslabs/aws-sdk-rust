...
pub fn de_get_clip_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::get_clip::GetClipOutput, crate::operation::get_clip::GetClipError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_clip_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_clip::GetClipOutput, crate::operation::get_clip::GetClipError> {
    #[allow(unused_mut)]
...
pub fn ser_get_clip_input(input: &crate::operation::get_clip::GetClipInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
