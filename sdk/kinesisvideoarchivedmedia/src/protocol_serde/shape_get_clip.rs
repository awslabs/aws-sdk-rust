...
pub fn de_get_clip_http_response(
    ...
    Ok({
        ...
        output = output.set_content_type(
            match crate::protocol_serde::shape_get_clip_output::de_content_type_header(_response_headers) {
                ...
                ::std::result::Result::Err(err) => {
                            ...
                            == ::std::option::Option::Some(&::aws_smithy_runtime_api::http::NonUtf8HeaderHandling::Skip)
                    {
                        ...
                        return ::std::result::Result::Err(crate::operation::get_clip::GetClipError::unhandled(
