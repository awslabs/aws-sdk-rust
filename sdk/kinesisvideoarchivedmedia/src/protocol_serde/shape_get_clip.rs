...
> {
    ...
    crate::protocol_serde::shape_get_clip::de_get_clip_http_response_with_props(
        response,
        &properties,
    )
}
...
> {
    ...
    Err(match error_code {
        "ClientLimitExceededException" => {
            crate::operation::get_clip::GetClipError::ClientLimitExceededException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidArgumentException" => {
            crate::operation::get_clip::GetClipError::InvalidArgumentException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "InvalidCodecPrivateDataException" => {
            crate::operation::get_clip::GetClipError::InvalidCodecPrivateDataException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidMediaFrameException" => {
            crate::operation::get_clip::GetClipError::InvalidMediaFrameException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "MissingCodecPrivateDataException" => {
            crate::operation::get_clip::GetClipError::MissingCodecPrivateDataException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "NoDataRetentionException" => {
            crate::operation::get_clip::GetClipError::NoDataRetentionException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "NotAuthorizedException" => {
            crate::operation::get_clip::GetClipError::NotAuthorizedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
        ...
        "ResourceNotFoundException" => {
            crate::operation::get_clip::GetClipError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
                    let mut output =
    ...
    Ok({
        ...
        output = output.set_content_type(
            crate::protocol_serde::shape_get_clip_output::de_content_type_header(_response_headers)
                .map_err(|_| {
                    crate::operation::get_clip::GetClipError::unhandled(
                        "Failed to parse ContentType from header `Content-Type",
                    )
                })?,
        );
        output = output.set_payload(Some(
            crate::protocol_serde::shape_get_clip_output::de_payload_payload(_response_body)?,
        ));
