...
pub fn de_payload_payload(body: &mut ::aws_smithy_types::body::SdkBody) -> std::result::Result<::aws_smithy_types::byte_stream::ByteStream, crate::operation::get_media_for_fragment_list::GetMediaForFragmentListError> {
