...
pub fn ser_dash_timestamp_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashTimestampRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
