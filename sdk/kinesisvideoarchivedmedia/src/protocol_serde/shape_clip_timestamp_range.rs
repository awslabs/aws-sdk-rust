...
pub fn ser_clip_timestamp_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ClipTimestampRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
