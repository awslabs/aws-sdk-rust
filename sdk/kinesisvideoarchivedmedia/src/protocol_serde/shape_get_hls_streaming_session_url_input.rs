...
pub fn ser_get_hls_streaming_session_url_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetHlsStreamingSessionUrlInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
