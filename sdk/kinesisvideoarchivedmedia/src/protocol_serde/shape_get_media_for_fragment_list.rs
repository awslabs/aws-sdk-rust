...
pub fn de_get_media_for_fragment_list_http_response(response: &mut ::aws_smithy_runtime_api::http::Response) -> std::result::Result<crate::operation::get_media_for_fragment_list::GetMediaForFragmentListOutput, crate::operation::get_media_for_fragment_list::GetMediaForFragmentListError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_media_for_fragment_list_http_error(_response_status: u16, _response_headers: &::aws_smithy_runtime_api::http::Headers, _response_body: &[u8]) -> std::result::Result<crate::operation::get_media_for_fragment_list::GetMediaForFragmentListOutput, crate::operation::get_media_for_fragment_list::GetMediaForFragmentListError> {
    #[allow(unused_mut)]
...
pub fn ser_get_media_for_fragment_list_input(input: &crate::operation::get_media_for_fragment_list::GetMediaForFragmentListInput) -> Result<::aws_smithy_types::body::SdkBody, ::aws_smithy_types::error::operation::SerializationError> {
