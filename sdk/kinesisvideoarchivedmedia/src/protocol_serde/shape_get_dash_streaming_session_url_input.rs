...
pub fn ser_get_dash_streaming_session_url_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetDashStreamingSessionUrlInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
