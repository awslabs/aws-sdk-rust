...
impl GetHlsStreamingSessionUrlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_hls_streaming_session_url::GetHlsStreamingSessionUrlInput, ::aws_smithy_types::error::operation::BuildError> {
