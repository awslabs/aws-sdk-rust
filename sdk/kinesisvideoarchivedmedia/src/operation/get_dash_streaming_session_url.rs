...
impl GetDASHStreamingSessionURL {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.service" = "Kinesis Video Archived Media",
            "rpc.method" = "GetDASHStreamingSessionURL",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDASHStreamingSessionURL {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            GetDASHStreamingSessionURLRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            GetDASHStreamingSessionURLResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("GetDASHStreamingSessionURL")
                .build()
    ...
    fn runtime_components(
        ...
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDASHStreamingSessionURL")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                GetDASHStreamingSessionURLTelemetryInputCaptureInterceptor,
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
...
#[derive(Debug)]
struct GetDASHStreamingSessionURLTelemetryInputCaptureInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDASHStreamingSessionURLTelemetryInputCaptureInterceptor {
    ...
    fn read_before_execution(
        ...
        let ::std::option::Option::Some(input) = context.input().downcast_ref::<GetDashStreamingSessionUrlInput>() else {
...
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDASHStreamingSessionURLResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_get_dash_streaming_session_url::de_get_dash_streaming_session_url_http_error(status, headers, body, _cfg)
        } else {
            crate::protocol_serde::shape_get_dash_streaming_session_url::de_get_dash_streaming_session_url_http_response(status, headers, body, _cfg)
        };
...
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDASHStreamingSessionURLRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_get_dash_streaming_session_url::ser_get_dash_streaming_session_url_input(&input)?,
        );
