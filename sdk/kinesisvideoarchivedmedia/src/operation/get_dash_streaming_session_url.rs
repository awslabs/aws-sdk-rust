...
/// Orchestration and serialization glue logic for `GetDASHStreamingSessionURL`.
...
impl GetDASHStreamingSessionURL {
    ...
    pub(crate) async fn orchestrate(
                    ...
                    ) -> ::std::result::Result<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<::aws_smithy_runtime_api::client::interceptors::context::Error, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>| {
                            err.map_service_error(|err| {
                                err.downcast::<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>().expect("correct error type")
                            })
                        };
                        ...
                        ::std::result::Result::Ok(output.downcast::<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlOutput>().expect("correct output type"))
                    }
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for GetDASHStreamingSessionURL {
                fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
                    let mut cfg = ::aws_smithy_types::config_bag::Layer::new("GetDASHStreamingSessionURL");

                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(GetDASHStreamingSessionURLRequestSerializer));
                    cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(GetDASHStreamingSessionURLResponseDeserializer));
...
let mut signing_options = ::aws_runtime::auth::SigningOptions::default();
                ...
                fn runtime_components(&self, _: &::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder) -> ::std::borrow::Cow<'_, ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder> {
                    #[allow(unused_mut)]
                    let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("GetDASHStreamingSessionURL")
...
.with_interceptor(GetDASHStreamingSessionURLEndpointParamsInterceptor)
                            .with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::TransientErrorClassifier::<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>::new())
.with_retry_classifier(::aws_smithy_runtime::client::retries::classifiers::ModeledAsRetryableClassifier::<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>::new())
.with_retry_classifier(::aws_runtime::retries::classifiers::AwsErrorCodeClassifier::<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>::new());
...
#[derive(Debug)]
            struct GetDASHStreamingSessionURLResponseDeserializer;
            impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for GetDASHStreamingSessionURLResponseDeserializer {
            ...
            let parse_result = if !success && status != 200 || force_error {
                crate::protocol_serde::shape_get_dash_streaming_session_url::de_get_dash_streaming_session_url_http_error(status, headers, body)
            } else {
                crate::protocol_serde::shape_get_dash_streaming_session_url::de_get_dash_streaming_session_url_http_response(status, headers, body)
            };
            crate::protocol_serde::type_erase_result(parse_result)
                }
            }
#[derive(Debug)]
            struct GetDASHStreamingSessionURLRequestSerializer;
            impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for GetDASHStreamingSessionURLRequestSerializer {
                ...
                fn serialize_input(&self, input: ::aws_smithy_runtime_api::client::interceptors::context::Input, _cfg: &mut ::aws_smithy_types::config_bag::ConfigBag) -> ::std::result::Result<::aws_smithy_runtime_api::client::orchestrator::HttpRequest, ::aws_smithy_runtime_api::box_error::BoxError> {
                    let input = input.downcast::<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlInput>().expect("correct type");
                    ...
                    let mut request_builder = {
                        fn uri_base(_input: &crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
    use ::std::fmt::Write as _;
    ::std::write!(output, "/getDASHStreamingSessionURL").expect("formatting should succeed");
...
builder
                    ...
                    let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_get_dash_streaming_session_url::ser_get_dash_streaming_session_url_input(&input)?);
...
#[derive(Debug)]
            struct GetDASHStreamingSessionURLEndpointParamsInterceptor;

            impl ::aws_smithy_runtime_api::client::interceptors::Intercept for GetDASHStreamingSessionURLEndpointParamsInterceptor {
                fn name(&self) -> &'static str {
                    "GetDASHStreamingSessionURLEndpointParamsInterceptor"
                }
                ...
                fn read_before_execution(
                    ...
                    let _input = context.input()
                        .downcast_ref::<GetDashStreamingSessionUrlInput>()
                        .ok_or("failed to downcast to GetDashStreamingSessionUrlInput")?;
...
pub enum GetDASHStreamingSessionURLError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-GetDASHStreamingSessionURLError) for what information is available for the error.")]
...
impl GetDASHStreamingSessionURLError {
    /// Creates the `GetDASHStreamingSessionURLError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDASHStreamingSessionURLError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        match self {
            ...
            Self::InvalidCodecPrivateDataException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            Self::MissingCodecPrivateDataException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
            ...
            Self::UnsupportedStreamMediaTypeException(e) => ::aws_smithy_types::error::metadata::ProvideErrorMetadata::meta(e),
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for GetDASHStreamingSessionURLError {
...
impl ::aws_types::request_id::RequestId for crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError {
                                fn request_id(&self) -> Option<&str> {
                                    self.meta().request_id()
                                }
                            }

pub use crate::operation::get_dash_streaming_session_url::_get_dash_streaming_session_url_output::GetDashStreamingSessionUrlOutput;

pub use crate::operation::get_dash_streaming_session_url::_get_dash_streaming_session_url_input::GetDashStreamingSessionUrlInput;

mod _get_dash_streaming_session_url_input;

mod _get_dash_streaming_session_url_output;
