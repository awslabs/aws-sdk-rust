...
impl GetDashStreamingSessionUrlInput {
    /// Consumes the builder and constructs an Operation<[`GetDASHStreamingSessionURL`](crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_dash_streaming_session_url::ser_get_dash_streaming_session_url_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURL::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetDASHStreamingSessionURL", "kinesisvideoarchivedmedia"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetDASHStreamingSessionURL {
                type Output = std::result::Result<crate::operation::get_dash_streaming_session_url::GetDashStreamingSessionUrlOutput, crate::operation::get_dash_streaming_session_url::GetDASHStreamingSessionURLError>;
