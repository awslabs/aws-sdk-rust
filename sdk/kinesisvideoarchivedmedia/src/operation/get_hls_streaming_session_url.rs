...
impl GetHlsStreamingSessionUrlInput {
    /// Consumes the builder and constructs an Operation<[`GetHLSStreamingSessionURL`](crate::operation::get_hls_streaming_session_url::GetHLSStreamingSessionURL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::get_hls_streaming_session_url::GetHLSStreamingSessionURL, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_hls_streaming_session_url::GetHlsStreamingSessionUrlInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
        ...
        let body = aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_hls_streaming_session_url::ser_get_hls_streaming_session_url_input(&self)?
        );
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::get_hls_streaming_session_url::GetHLSStreamingSessionURL::new())
                            .with_metadata(aws_smithy_http::operation::Metadata::new("GetHLSStreamingSessionURL", "kinesisvideoarchivedmedia"));
...
impl aws_smithy_http::response::ParseStrictResponse for GetHLSStreamingSessionURL {
                type Output = std::result::Result<crate::operation::get_hls_streaming_session_url::GetHlsStreamingSessionUrlOutput, crate::operation::get_hls_streaming_session_url::GetHLSStreamingSessionURLError>;
