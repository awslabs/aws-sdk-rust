...
impl GetHlsStreamingSessionUrlInput {
    ...
    > {
        ...
        let op =
            ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_hls_streaming_session_url::GetHLSStreamingSessionURL::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHLSStreamingSessionURL {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            ...
            crate::protocol_serde::shape_get_hls_streaming_session_url::de_get_hls_streaming_session_url_http_response_with_props(
                status, headers, body,
            )
        }
    }
