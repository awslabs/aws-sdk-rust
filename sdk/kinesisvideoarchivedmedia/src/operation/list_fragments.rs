...
impl ListFragmentsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_fragments::ListFragments::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFragments {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_fragments::de_list_fragments_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_fragments::de_list_fragments_http_response_with_props(
                status, headers, body,
            )
        }
    }
