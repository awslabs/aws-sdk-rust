...
pub fn serialize_structure_get_clip_input(
    ...
    if let Some(var_1) = &input.clip_fragment_selector {
        ...
        crate::json_ser::serialize_structure_clip_fragment_selector(&mut object_2, var_1);
        object_2.finish();
    }
...
pub fn serialize_structure_get_dash_streaming_session_url_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_5) = &input.dash_fragment_selector {
        ...
        crate::json_ser::serialize_structure_dash_fragment_selector(&mut object_6, var_5);
        object_6.finish();
    }
...
pub fn serialize_structure_get_hls_streaming_session_url_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_18) = &input.hls_fragment_selector {
        ...
        crate::json_ser::serialize_structure_hls_fragment_selector(&mut object_19, var_18);
        object_19.finish();
    }
...
pub fn serialize_structure_get_media_for_fragment_list_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_list_fragments_input(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_29) = &input.fragment_selector {
        ...
        crate::json_ser::serialize_structure_fragment_selector(&mut object_30, var_29);
        object_30.finish();
    }
...
pub fn serialize_structure_clip_fragment_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_36) = &input.timestamp_range {
        ...
        crate::json_ser::serialize_structure_clip_timestamp_range(&mut object_37, var_36);
        object_37.finish();
    }
}

pub fn serialize_structure_dash_fragment_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_39) = &input.timestamp_range {
        ...
        crate::json_ser::serialize_structure_dash_timestamp_range(&mut object_40, var_39);
        object_40.finish();
    }
}

pub fn serialize_structure_hls_fragment_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_42) = &input.timestamp_range {
        ...
        crate::json_ser::serialize_structure_hls_timestamp_range(&mut object_43, var_42);
        object_43.finish();
    }
}

pub fn serialize_structure_fragment_selector(
    object: &mut smithy_json::serialize::JsonObjectWriter,
    ...
    if let Some(var_45) = &input.timestamp_range {
        ...
        crate::json_ser::serialize_structure_timestamp_range(&mut object_46, var_45);
        object_46.finish();
    }
}

pub fn serialize_structure_clip_timestamp_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_dash_timestamp_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_hls_timestamp_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
...
pub fn serialize_structure_timestamp_range(
    object: &mut smithy_json::serialize::JsonObjectWriter,
