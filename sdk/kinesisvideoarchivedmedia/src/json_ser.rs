...
pub fn serialize_structure_crate_input_get_clip_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetClipInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_get_dash_streaming_session_url_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetDashStreamingSessionUrlInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_get_hls_streaming_session_url_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetHlsStreamingSessionUrlInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_get_images_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetImagesInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_get_media_for_fragment_list_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::GetMediaForFragmentListInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_input_list_fragments_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::ListFragmentsInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_clip_fragment_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClipFragmentSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dash_fragment_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashFragmentSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_hls_fragment_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsFragmentSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_fragment_selector(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::FragmentSelector) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_clip_timestamp_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClipTimestampRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_dash_timestamp_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::DashTimestampRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub fn serialize_structure_crate_model_hls_timestamp_range(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HlsTimestampRange) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
