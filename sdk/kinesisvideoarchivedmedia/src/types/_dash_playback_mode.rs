...
impl ::std::convert::From<&str> for DashPlaybackMode {
    fn from(s: &str) -> Self {
        match s {
            ...
            other => DashPlaybackMode::Unknown(crate::primitives::sealed_enum_unknown::UnknownVariantValue(other.to_owned())),
        }
    }
}
impl ::std::str::FromStr for DashPlaybackMode {
    ...
    fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
        ::std::result::Result::Ok(DashPlaybackMode::from(s))
    }
}
...
impl ::std::convert::AsRef<str> for DashPlaybackMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
