        ...
        ::std::result::Result::Ok(
            crate::types::ClipTimestampRange {
                start_timestamp: self.start_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("start_timestamp", "start_timestamp was not specified but it is required when building ClipTimestampRange")
                    )?
                ,
                end_timestamp: self.end_timestamp
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("end_timestamp", "end_timestamp was not specified but it is required when building ClipTimestampRange")
                    )?
                ,
            }
        )
