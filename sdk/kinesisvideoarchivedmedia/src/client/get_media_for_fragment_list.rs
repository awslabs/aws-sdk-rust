...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::get_media_for_fragment_list::builders::GetMediaForFragmentListFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::get_media_for_fragment_list::builders::GetMediaForFragmentListFluentBuilder::set_stream_name): <p>The name of the stream from which to retrieve fragment media. Specify either this parameter or the <code>StreamARN</code> parameter.</p>
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::get_media_for_fragment_list::builders::GetMediaForFragmentListFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::get_media_for_fragment_list::builders::GetMediaForFragmentListFluentBuilder::set_stream_arn): <p>The Amazon Resource Name (ARN) of the stream from which to retrieve fragment media. Specify either this parameter or the <code>StreamName</code> parameter.</p>
