...
impl super::Client {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::get_clip::builders::GetClipFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::get_clip::builders::GetClipFluentBuilder::set_stream_name): <p>The name of the stream for which to retrieve the media clip. </p>  <p>You must specify either the StreamName or the StreamARN. </p>
    ///   - [`stream_arn(impl ::std::convert::Into<String>)`](crate::operation::get_clip::builders::GetClipFluentBuilder::stream_arn) / [`set_stream_arn(Option<String>)`](crate::operation::get_clip::builders::GetClipFluentBuilder::set_stream_arn): <p>The Amazon Resource Name (ARN) of the stream for which to retrieve the media clip. </p>  <p>You must specify either the StreamName or the StreamARN. </p>
