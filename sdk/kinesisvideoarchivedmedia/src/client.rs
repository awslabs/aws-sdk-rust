...
{
    pub fn get_clip(&self) -> fluent_builders::GetClip<C> {
        fluent_builders::GetClip::new(self.handle.clone())
    }
    pub fn get_dash_streaming_session_url(&self) -> fluent_builders::GetDASHStreamingSessionURL<C> {
        fluent_builders::GetDASHStreamingSessionURL::new(self.handle.clone())
    }
    pub fn get_hls_streaming_session_url(&self) -> fluent_builders::GetHLSStreamingSessionURL<C> {
        fluent_builders::GetHLSStreamingSessionURL::new(self.handle.clone())
    }
    pub fn get_media_for_fragment_list(&self) -> fluent_builders::GetMediaForFragmentList<C> {
        fluent_builders::GetMediaForFragmentList::new(self.handle.clone())
    }
    pub fn list_fragments(&self) -> fluent_builders::ListFragments<C> {
        fluent_builders::ListFragments::new(self.handle.clone())
    }
}
pub mod fluent_builders {
    #[derive(std::fmt::Debug)]
    pub struct GetClip<C = aws_hyper::DynConnector> {
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetDASHStreamingSessionURL<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_dash_streaming_session_url_input::Builder,
    }
    impl<C> GetDASHStreamingSessionURL<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetHLSStreamingSessionURL<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_hls_streaming_session_url_input::Builder,
    }
    impl<C> GetHLSStreamingSessionURL<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct GetMediaForFragmentList<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::get_media_for_fragment_list_input::Builder,
    }
    impl<C> GetMediaForFragmentList<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
    ...
    #[derive(std::fmt::Debug)]
    pub struct ListFragments<C = aws_hyper::DynConnector> {
        handle: std::sync::Arc<super::Handle<C>>,
        inner: crate::input::list_fragments_input::Builder,
    }
    impl<C> ListFragments<C> {
        pub(crate) fn new(handle: std::sync::Arc<super::Handle<C>>) -> Self {
            Self {
                handle,
                inner: Default::default(),
