    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    ///
    /// - Takes [`GetClipInput`](crate::input::GetClipInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::GetClipInput::stream_name): <p>The name of the stream for which to retrieve the media clip. </p>  <p>You must specify either the StreamName or the StreamARN. </p>
    ///   - [`stream_arn(Option<String>)`](crate::input::GetClipInput::stream_arn): <p>The Amazon Resource Name (ARN) of the stream for which to retrieve the media clip. </p>  <p>You must specify either the StreamName or the StreamARN. </p>
    ///   - [`clip_fragment_selector(Option<ClipFragmentSelector>)`](crate::input::GetClipInput::clip_fragment_selector): <p>The time range of the requested clip and the source of the timestamps.</p>
    ...
    ///
    /// - Takes [`GetMediaForFragmentListInput`](crate::input::GetMediaForFragmentListInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::GetMediaForFragmentListInput::stream_name): <p>The name of the stream from which to retrieve fragment media. Specify either this parameter or the <code>StreamARN</code> parameter.</p>
    ///   - [`stream_arn(Option<String>)`](crate::input::GetMediaForFragmentListInput::stream_arn): <p>The Amazon Resource Name (ARN) of the stream from which to retrieve fragment media. Specify either this parameter or the <code>StreamName</code> parameter.</p>
    ///   - [`fragments(Option<Vec<String>>)`](crate::input::GetMediaForFragmentListInput::fragments): <p>A list of the numbers of fragments for which to retrieve media. You retrieve these values with <code>ListFragments</code>.</p>
    ...
    ///
    /// - Takes [`ListFragmentsInput`](crate::input::ListFragmentsInput) with field(s):
    ///   - [`stream_name(Option<String>)`](crate::input::ListFragmentsInput::stream_name): <p>The name of the stream from which to retrieve a fragment list. Specify either this parameter or the <code>StreamARN</code> parameter.</p>
    ///   - [`stream_arn(Option<String>)`](crate::input::ListFragmentsInput::stream_arn): <p>The Amazon Resource Name (ARN) of the stream from which to retrieve a fragment list. Specify either this parameter or the <code>StreamName</code> parameter.</p>
    ///   - [`max_results(Option<i64>)`](crate::input::ListFragmentsInput::max_results): <p>The total number of fragments to return. If the total number of fragments available is more than the value specified in <code>max-results</code>, then a <code>ListFragmentsOutput$NextToken</code> is provided in the output that you can use to resume pagination.</p>
    ///   - [`next_token(Option<String>)`](crate::input::ListFragmentsInput::next_token): <p>A token to specify where to start paginating. This is the <code>ListFragmentsOutput$NextToken</code> from a previously truncated response.</p>
    ///   - [`fragment_selector(Option<FragmentSelector>)`](crate::input::ListFragmentsInput::fragment_selector): <p>Describes the timestamp range and timestamp origin for the range of fragments to return.</p>
