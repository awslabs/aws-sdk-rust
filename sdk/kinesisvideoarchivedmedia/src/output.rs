...
pub struct ListFragmentsOutput  {
    ...
    #[doc(hidden)]pub fragments: std::option::Option<std::vec::Vec<crate::model::Fragment>>,
...
#[allow(missing_docs)] // documentation missing in model
#[non_exhaustive]pub struct GetMediaForFragmentListOutput  {
...
pub struct GetHlsStreamingSessionUrlOutput  {
    ...
    #[doc(hidden)]pub hls_streaming_session_url: std::option::Option<std::string::String>,
}
...
pub struct GetDashStreamingSessionUrlOutput  {
    ...
    #[doc(hidden)]pub dash_streaming_session_url: std::option::Option<std::string::String>,
}
...
impl  std::fmt::Debug for GetDashStreamingSessionUrlOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("dash_streaming_session_url", &self.dash_streaming_session_url);
        formatter.finish()
    }
}
