...
pub(crate) fn deser_structure_crate_error_invalid_media_frame_exception_json_err(
    ...
    crate::error::invalid_media_frame_exception::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
pub(crate) fn deser_operation_crate_operation_list_fragments(
    ...
    crate::output::list_fragments_output::Builder,
    aws_smithy_json::deserialize::error::DeserializeError,
> {
    let mut tokens_owned =
        aws_smithy_json::deserialize::json_token_iter(crate::json_deser::or_empty_doc(value))
...
pub(crate) fn deser_structure_crate_model_fragment<'a, I>(
    tokens: &mut std::iter::Peekable<I>,
) -> Result<Option<crate::model::Fragment>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
            aws_smithy_json::deserialize::Token<'a>,
