...
pub(crate) fn deser_header_get_clip_get_clip_output_content_type(
...
pub(crate) fn deser_header_get_media_for_fragment_list_get_media_for_fragment_list_output_content_type(
    header_map: &http::HeaderMap,
) -> std::result::Result<
    std::option::Option<std::string::String>,
    aws_smithy_http::header::ParseError,
