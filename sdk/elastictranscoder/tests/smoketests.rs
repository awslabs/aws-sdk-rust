...
//! ```
use aws_sdk_elastictranscoder::{config, Client};
/// Smoke tests for the `list_presets` operation
#[::tokio::test]
async fn test_list_presets_success() {
    ...
    let res = client.list_presets().send().await;
