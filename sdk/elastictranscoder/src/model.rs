...
pub struct PipelineOutputConfig  {
    ...
    #[doc(hidden)]pub storage_class: std::option::Option<std::string::String>,
...
pub struct Permission  {
    ...
    /// <li> <p> <code>Group</code>: One of the following predefined Amazon S3 groups: <code>AllUsers</code>, <code>AuthenticatedUsers</code>, or <code>LogDelivery</code>.</p> </li> 
    /// </ul>
    #[doc(hidden)]pub grantee_type: std::option::Option<std::string::String>,
    ...
    /// <li> <p> <code>FULL_CONTROL</code>: The grantee has READ, READ_ACP, and WRITE_ACP permissions for the thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.</p> </li> 
    /// </ul>
    #[doc(hidden)]pub access: std::option::Option<std::vec::Vec<std::string::String>>,
}
impl Permission {
    /// <p>The type of value that appears in the Grantee object:</p> 
    /// <ul> 
...
pub struct Notifications  {
    ...
    #[doc(hidden)]pub progressing: std::option::Option<std::string::String>,
...
pub struct Thumbnails  {
    ...
    #[doc(hidden)]pub aspect_ratio: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub max_width: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub max_height: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub sizing_policy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub padding_policy: std::option::Option<std::string::String>,
}
impl Thumbnails {
    /// <p>The format of thumbnails, if any. Valid values are <code>jpg</code> and <code>png</code>. </p> 
    /// <p>You specify whether you want Elastic Transcoder to create thumbnails when you create a job.</p>
...
pub struct VideoParameters  {
    ...
    #[doc(hidden)]pub codec_options: std::option::Option<std::collections::HashMap<std::string::String, std::string::String>>,
    ...
    #[doc(hidden)]pub keyframes_max_dist: std::option::Option<std::string::String>,
    /// <p>Applicable only when the value of Video:Codec is one of <code>H.264</code>, <code>MPEG2</code>, or <code>VP8</code>.</p> 
    ...
    /// </important>
    #[doc(hidden)]pub fixed_gop: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub bit_rate: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub frame_rate: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub max_frame_rate: std::option::Option<std::string::String>,
    /// <important> 
    ...
    #[doc(hidden)]pub display_aspect_ratio: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub watermarks: std::option::Option<std::vec::Vec<crate::model::PresetWatermark>>,
}
...
pub mod video_parameters {
    ...
    impl Builder {
        ...
        /// <p>Watermarks can be in .png or .jpg format. If you want to display a watermark that is not rectangular, use the .png format, which supports transparency.</p> 
        /// <p>When you create a job that uses this preset, you specify the .png or .jpg graphics that you want Elastic Transcoder to include in the transcoded videos. You can specify fewer graphics in the job than you specify watermark settings in the preset, which allows you to use the same preset for up to four watermarks that have different dimensions.</p>
        pub fn set_watermarks(mut self, input: std::option::Option<std::vec::Vec<crate::model::PresetWatermark>>) -> Self {
...
pub struct PresetWatermark  {
    ...
    /// </ul>
    #[doc(hidden)]pub horizontal_align: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub horizontal_offset: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub vertical_align: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub vertical_offset: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub opacity: std::option::Option<std::string::String>,
...
pub struct AudioParameters  {
    ...
    #[doc(hidden)]pub channels: std::option::Option<std::string::String>,
    ...
    /// </ul>
    #[doc(hidden)]pub audio_packing_mode: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub codec_options: std::option::Option<crate::model::AudioCodecOptions>,
}
...
pub mod audio_parameters {
    ...
    impl Builder {
        ...
        /// <p> <code>auto</code>, <code>AAC-LC</code>, <code>HE-AAC</code>, <code>HE-AACv2</code> </p> 
        /// <p>If you specify <code>auto</code>, Elastic Transcoder chooses a profile based on the bit rate of the output file.</p>
        pub fn set_codec_options(mut self, input: std::option::Option<crate::model::AudioCodecOptions>) -> Self {
            self.codec_options = input; self
        }
...
pub struct AudioCodecOptions  {
    ...
    /// </note>
    #[doc(hidden)]pub profile: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub bit_depth: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub bit_order: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub signed: std::option::Option<std::string::String>,
}
...
pub struct Job  {
    ...
    #[doc(hidden)]pub output: std::option::Option<crate::model::JobOutput>,
    ...
    #[doc(hidden)]pub outputs: std::option::Option<std::vec::Vec<crate::model::JobOutput>>,
    ...
    #[doc(hidden)]pub playlists: std::option::Option<std::vec::Vec<crate::model::Playlist>>,
    ...
    #[doc(hidden)]pub timing: std::option::Option<crate::model::Timing>,
}
impl Job {
    /// <p>The identifier that Elastic Transcoder assigned to the job. You use this value to get settings for the job or to delete the job.</p>
    pub fn id(&self) -> std::option::Option<& str> {
...
pub mod job {
    ...
    impl Builder {
        ...
        /// <p>Information about the output files. We recommend that you use the <code>Outputs</code> syntax for all jobs, even when you want Elastic Transcoder to transcode a file into only one format. Do not use both the <code>Outputs</code> and <code>Output</code> syntaxes in the same request. You can create a maximum of 30 outputs per job. </p> 
        /// <p>If you specify more than one output for a job, Elastic Transcoder creates the files for each output in the order in which you specify them in the job.</p>
        pub fn set_outputs(mut self, input: std::option::Option<std::vec::Vec<crate::model::JobOutput>>) -> Self {
        ...
        /// <p>If you specify a preset in <code>PresetId</code> for which the value of <code>Container</code> is fmp4 (Fragmented MP4) or ts (MPEG-TS), <code>Playlists</code> contains information about the master playlists that you want Elastic Transcoder to create.</p> 
        /// <p>The maximum number of master playlists in a job is 30.</p>
        pub fn set_playlists(mut self, input: std::option::Option<std::vec::Vec<crate::model::Playlist>>) -> Self {
...
pub struct Timing  {
    ...
    #[doc(hidden)]pub submit_time_millis: std::option::Option<i64>,
    /// <p>The time the job began transcoding, in epoch milliseconds.</p>
    #[doc(hidden)]pub start_time_millis: std::option::Option<i64>,
    /// <p>The time the job finished transcoding, in epoch milliseconds.</p>
    #[doc(hidden)]pub finish_time_millis: std::option::Option<i64>,
}
impl Timing {
    /// <p>The time the job was submitted to Elastic Transcoder, in epoch milliseconds.</p>
...
pub struct Playlist  {
    ...
    #[doc(hidden)]pub output_keys: std::option::Option<std::vec::Vec<std::string::String>>,
...
impl Playlist {
    ...
    /// <p>The HLS content protection settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
    pub fn hls_content_protection(&self) -> std::option::Option<& crate::model::HlsContentProtection> {
...
pub mod playlist {
    ...
    impl Builder {
        ...
        /// <p>The HLS content protection settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
        pub fn set_hls_content_protection(mut self, input: std::option::Option<crate::model::HlsContentProtection>) -> Self {
        ...
        /// <p>The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
        pub fn set_play_ready_drm(mut self, input: std::option::Option<crate::model::PlayReadyDrm>) -> Self {
...
pub struct PlayReadyDrm  {
    ...
    #[doc(hidden)]pub key_md5: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub initialization_vector: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub license_acquisition_url: std::option::Option<std::string::String>,
}
impl PlayReadyDrm {
    /// <p>The type of DRM, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.</p>
    pub fn format(&self) -> std::option::Option<& str> {
...
pub struct HlsContentProtection  {
    ...
    #[doc(hidden)]pub key_storage_policy: std::option::Option<std::string::String>,
}
...
pub struct JobOutput  {
    ...
    #[doc(hidden)]pub thumbnail_pattern: std::option::Option<std::string::String>,
    /// <p>The encryption settings, if any, that you want Elastic Transcoder to apply to your thumbnail.</p>
    #[doc(hidden)]pub thumbnail_encryption: std::option::Option<crate::model::Encryption>,
    ...
    #[doc(hidden)]pub rotate: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub preset_id: std::option::Option<std::string::String>,
    /// <important> 
    /// <p>(Outputs in Fragmented MP4 or MPEG-TS format only.</p> 
    /// </important> 
    ...
    #[doc(hidden)]pub segment_duration: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub file_size: std::option::Option<i64>,
    ...
    #[doc(hidden)]pub watermarks: std::option::Option<std::vec::Vec<crate::model::JobWatermark>>,
    /// <p>The album art to be associated with the output file, if any.</p>
    #[doc(hidden)]pub album_art: std::option::Option<crate::model::JobAlbumArt>,
    ...
    #[deprecated]#[doc(hidden)]pub composition: std::option::Option<std::vec::Vec<crate::model::Clip>>,
    ...
    #[doc(hidden)]pub captions: std::option::Option<crate::model::Captions>,
    ...
    #[doc(hidden)]pub applied_color_space_conversion: std::option::Option<std::string::String>,
}
impl JobOutput {
    /// <p>A sequential counter, starting with 1, that identifies an output among the outputs from the current job. In the Output syntax, this value is always 1.</p>
    pub fn id(&self) -> std::option::Option<& str> {
    ...
    /// <p>You can create an output file that contains an excerpt from the input file. This excerpt, called a clip, can come from the beginning, middle, or end of the file. The Composition object contains settings for the clips that make up an output file. For the current release, you can only specify settings for a single clip per output file. The Composition object cannot be null.</p>
    #[deprecated]pub fn composition(&self) -> std::option::Option<& [crate::model::Clip]> {
...
impl  std::fmt::Debug for JobOutput  {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        formatter.field("applied_color_space_conversion", &self.applied_color_space_conversion);
        formatter.finish()
    }
}
...
pub mod job_output {
    ...
    impl Builder {
        ...
        /// <p>The encryption settings, if any, that you want Elastic Transcoder to apply to your thumbnail.</p>
        pub fn set_thumbnail_encryption(mut self, input: std::option::Option<crate::model::Encryption>) -> Self {
        ...
        /// <p>Information about the watermarks that you want Elastic Transcoder to add to the video during transcoding. You can specify up to four watermarks for each output. Settings for each watermark must be defined in the preset that you specify in <code>Preset</code> for the current output.</p> 
        /// <p>Watermarks are added to the output video in the sequence in which you list them in the job output—the first watermark in the list is added to the output video first, the second watermark in the list is added next, and so on. As a result, if the settings in a preset cause Elastic Transcoder to place all watermarks in the same location, the second watermark that you add covers the first one, the third one covers the second, and the fourth one covers the third.</p>
        pub fn set_watermarks(mut self, input: std::option::Option<std::vec::Vec<crate::model::JobWatermark>>) -> Self {
            self.watermarks = input; self
        }
        /// <p>The album art to be associated with the output file, if any.</p>
        ...
        /// <p>The album art to be associated with the output file, if any.</p>
        pub fn set_album_art(mut self, input: std::option::Option<crate::model::JobAlbumArt>) -> Self {
        ...
        ///
        /// <p>You can create an output file that contains an excerpt from the input file. This excerpt, called a clip, can come from the beginning, middle, or end of the file. The Composition object contains settings for the clips that make up an output file. For the current release, you can only specify settings for a single clip per output file. The Composition object cannot be null.</p>
        #[deprecated]pub fn composition(mut self, input: crate::model::Clip) -> Self {
        ...
        /// <p>You can create an output file that contains an excerpt from the input file. This excerpt, called a clip, can come from the beginning, middle, or end of the file. The Composition object contains settings for the clips that make up an output file. For the current release, you can only specify settings for a single clip per output file. The Composition object cannot be null.</p>
        #[deprecated]pub fn set_composition(mut self, input: std::option::Option<std::vec::Vec<crate::model::Clip>>) -> Self {
...
pub struct Captions  {
    ...
    #[deprecated]#[doc(hidden)]pub merge_policy: std::option::Option<std::string::String>,
    ...
    #[deprecated]#[doc(hidden)]pub caption_sources: std::option::Option<std::vec::Vec<crate::model::CaptionSource>>,
    /// <p>The array of file formats for the output captions. If you leave this value blank, Elastic Transcoder returns an error.</p>
    #[doc(hidden)]pub caption_formats: std::option::Option<std::vec::Vec<crate::model::CaptionFormat>>,
}
impl Captions {
    /// <p>A policy that determines how Elastic Transcoder handles the existence of multiple captions.</p> 
    /// <ul> 
    ...
    /// </ul> 
    /// <p> <code>MergePolicy</code> cannot be null.</p>
    #[deprecated]pub fn merge_policy(&self) -> std::option::Option<& str> {
        self.merge_policy.as_deref()
    }
    /// <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
    #[deprecated]pub fn caption_sources(&self) -> std::option::Option<& [crate::model::CaptionSource]> {
...
pub mod captions {
    ...
    impl Builder {
        ...
        /// </ul> 
        /// <p> <code>MergePolicy</code> cannot be null.</p>
        #[deprecated]pub fn merge_policy(mut self, input: impl Into<std::string::String>) -> Self {
        ...
        /// </ul> 
        /// <p> <code>MergePolicy</code> cannot be null.</p>
        #[deprecated]pub fn set_merge_policy(mut self, input: std::option::Option<std::string::String>) -> Self {
        ...
        ///
        /// <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
        #[deprecated]pub fn caption_sources(mut self, input: crate::model::CaptionSource) -> Self {
        ...
        /// <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
        #[deprecated]pub fn set_caption_sources(mut self, input: std::option::Option<std::vec::Vec<crate::model::CaptionSource>>) -> Self {
        ...
        /// <p>The array of file formats for the output captions. If you leave this value blank, Elastic Transcoder returns an error.</p>
        pub fn set_caption_formats(mut self, input: std::option::Option<std::vec::Vec<crate::model::CaptionFormat>>) -> Self {
...
pub struct CaptionSource  {
    ...
    #[doc(hidden)]pub time_offset: std::option::Option<std::string::String>,
...
pub struct Clip  {
    ...
    #[doc(hidden)]pub time_span: std::option::Option<crate::model::TimeSpan>,
}
impl Clip {
    /// <p>Settings that determine when a clip begins and how long it lasts.</p>
...
pub struct JobAlbumArt  {
    ...
    /// </ul>
    #[doc(hidden)]pub merge_policy: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub artwork: std::option::Option<std::vec::Vec<crate::model::Artwork>>,
}
impl JobAlbumArt {
    /// <p>A policy that determines how Elastic Transcoder handles the existence of multiple album artwork files.</p> 
    /// <ul> 
...
pub mod job_album_art {
    ...
    impl Builder {
        ...
        /// <p>The file to be used as album art. There can be multiple artworks associated with an audio file, to a maximum of 20. Valid formats are <code>.jpg</code> and <code>.png</code> </p>
        pub fn set_artwork(mut self, input: std::option::Option<std::vec::Vec<crate::model::Artwork>>) -> Self {
...
pub struct Artwork  {
    ...
    #[doc(hidden)]pub input_key: std::option::Option<std::string::String>,
    ...
    #[doc(hidden)]pub album_art_format: std::option::Option<std::string::String>,
...
pub struct JobWatermark  {
    ...
    #[doc(hidden)]pub preset_watermark_id: std::option::Option<std::string::String>,
...
pub struct JobInput  {
    ...
    #[doc(hidden)]pub interlaced: std::option::Option<std::string::String>,
    ...
    /// <p>For more information on embedded files, see the Subtitles Wikipedia page.</p> 
    /// <p>For more information on sidecar files, see the Extensible Metadata Platform and Sidecar file Wikipedia pages.</p>
    #[doc(hidden)]pub input_captions: std::option::Option<crate::model::InputCaptions>,
    /// <p>The detected properties of the input file.</p>
    #[doc(hidden)]pub detected_properties: std::option::Option<crate::model::DetectedProperties>,
}
impl JobInput {
    /// <p> The name of the file to transcode. Elsewhere in the body of the JSON block is the the ID of the pipeline to use for processing the job. The <code>InputBucket</code> object in that pipeline tells Elastic Transcoder which Amazon S3 bucket to get the file from. </p> 
    /// <p>If the file name includes a prefix, such as <code>cooking/lasagna.mpg</code>, include the prefix in the key. If the file isn't in the specified bucket, Elastic Transcoder returns an error.</p>
...
pub mod job_input {
    ...
    impl Builder {
        ...
        /// <p>For more information on embedded files, see the Subtitles Wikipedia page.</p> 
        /// <p>For more information on sidecar files, see the Extensible Metadata Platform and Sidecar file Wikipedia pages.</p>
        pub fn set_input_captions(mut self, input: std::option::Option<crate::model::InputCaptions>) -> Self {
        ...
        /// <p>The detected properties of the input file.</p>
        pub fn set_detected_properties(mut self, input: std::option::Option<crate::model::DetectedProperties>) -> Self {
...
pub struct InputCaptions  {
    ...
    #[doc(hidden)]pub merge_policy: std::option::Option<std::string::String>,
    /// <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
    #[doc(hidden)]pub caption_sources: std::option::Option<std::vec::Vec<crate::model::CaptionSource>>,
}
impl InputCaptions {
    /// <p>A policy that determines how Elastic Transcoder handles the existence of multiple captions.</p> 
    /// <ul> 
...
pub mod input_captions {
    ...
    impl Builder {
        ...
        /// <p>Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave <code>CaptionSources</code> blank.</p>
        pub fn set_caption_sources(mut self, input: std::option::Option<std::vec::Vec<crate::model::CaptionSource>>) -> Self {
            self.caption_sources = input; self
        }
