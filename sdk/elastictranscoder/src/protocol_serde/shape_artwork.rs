...
pub fn ser_artwork(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Artwork) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_artwork<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Artwork>, aws_smithy_json::deserialize::error::DeserializeError>
