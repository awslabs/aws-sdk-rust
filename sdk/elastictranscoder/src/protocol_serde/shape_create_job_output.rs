...
pub fn ser_create_job_output(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CreateJobOutput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
