...
pub fn ser_job_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::JobInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_job_input<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::JobInput>, aws_smithy_json::deserialize::error::DeserializeError>
