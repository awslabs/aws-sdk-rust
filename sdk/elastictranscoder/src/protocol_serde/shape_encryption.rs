...
pub fn ser_encryption(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Encryption) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_encryption<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Encryption>, aws_smithy_json::deserialize::error::DeserializeError>
