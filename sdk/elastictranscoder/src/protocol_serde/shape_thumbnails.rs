...
pub fn ser_thumbnails(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Thumbnails) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_thumbnails<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Thumbnails>, aws_smithy_json::deserialize::error::DeserializeError>
