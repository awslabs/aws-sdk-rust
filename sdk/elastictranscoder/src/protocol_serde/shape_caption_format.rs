...
pub fn ser_caption_format(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::CaptionFormat) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_caption_format<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::CaptionFormat>, aws_smithy_json::deserialize::error::DeserializeError>
