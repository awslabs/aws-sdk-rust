        ...
        for item_20 in var_18 {
            {
                ...
                crate::protocol_serde::shape_preset_watermark::ser_preset_watermark(
                    &mut object_21,
                    item_20,
                )?;
                object_21.finish();
...
pub(crate) fn de_video_parameters<'a, I>(
    ...
    Option<crate::types::VideoParameters>,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "CodecOptions" => {
                                builder = builder.set_codec_options(
                                    crate::protocol_serde::shape_codec_options::de_codec_options(
                                        tokens,
                                    )?,
                                );
                            }
