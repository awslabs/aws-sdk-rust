...
pub(crate) fn de_job_outputs<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<std::vec::Vec<crate::model::JobOutput>>, aws_smithy_json::deserialize::error::DeserializeError>
