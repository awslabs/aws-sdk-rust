...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_list_jobs_by_pipeline::de_list_jobs_by_pipeline(_response_body, output)
            .map_err(crate::operation::list_jobs_by_pipeline::ListJobsByPipelineError::unhandled)?;
...
) -> Result<crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError>
{
