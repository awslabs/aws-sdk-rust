...
pub fn de_read_job_http_error(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ReadJobOutput, crate::error::ReadJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(response).map_err(crate::error::ReadJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_read_job_http_response(response: &http::Response<bytes::Bytes>) -> std::result::Result<crate::output::ReadJobOutput, crate::error::ReadJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::output::read_job_output::Builder::default();
        let _ = response;
        output = crate::protocol_serde::shape_read_job::de_read_job(response.body().as_ref(), output).map_err(crate::error::ReadJobError::unhandled)?;
        output._set_request_id(aws_http::request_id::RequestId::request_id(response).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_read_job(value: &[u8], mut builder: crate::output::read_job_output::Builder) -> Result<crate::output::read_job_output::Builder, aws_smithy_json::deserialize::error::DeserializeError> {
