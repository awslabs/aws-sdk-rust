        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.page_token = crate::lens::reflens_structure_crate_output_list_jobs_by_pipeline_output_next_page_token(resp).cloned();
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.page_token = crate::lens::reflens_structure_crate_output_list_jobs_by_status_output_next_page_token(resp).cloned();
                            input.page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.page_token = crate::lens::reflens_structure_crate_output_list_pipelines_output_next_page_token(resp).cloned();
                            input.page_token.is_none()
                        }
                        Err(_) => true,
                    };
        ...
        aws_smithy_async::future::fn_stream::FnStream::new(move |tx| {
            Box::pin(async move {
                ...
                loop {
                    ...
                    let done = match resp {
                        Ok(ref resp) => {
                            input.page_token = crate::lens::reflens_structure_crate_output_list_presets_output_next_page_token(resp).cloned();
                            input.page_token.is_none()
                        }
                        Err(_) => true,
                    };
