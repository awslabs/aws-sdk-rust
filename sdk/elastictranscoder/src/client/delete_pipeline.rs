...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::delete_pipeline::builders::DeletePipelineFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_pipeline::builders::DeletePipelineFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the pipeline that you want to delete.</p><br>
