...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::read_job::builders::ReadJobFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::read_job::builders::ReadJobFluentBuilder::set_id): <p>The identifier of the job for which you want to get detailed information.</p>
