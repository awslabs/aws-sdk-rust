...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_preset::builders::DeletePresetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_preset::builders::DeletePresetFluentBuilder::set_id): <p>The identifier of the preset for which you want to get detailed information.</p>
