...
impl super::Client {
    ...
    ///   - [`pipeline_id(impl ::std::convert::Into<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::pipeline_id) / [`set_pipeline_id(Option<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::set_pipeline_id): <p>The ID of the pipeline for which you want to get job information.</p>
    ///   - [`ascending(impl ::std::convert::Into<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::ascending) / [`set_ascending(Option<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::set_ascending): <p> To list jobs in chronological order by the date and time that they were submitted, enter <code>true</code>. To list jobs in reverse chronological order, enter <code>false</code>. </p>
    ///   - [`page_token(impl ::std::convert::Into<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::set_page_token): <p> When Elastic Transcoder returns more than one page of results, use <code>pageToken</code> in subsequent <code>GET</code> requests to get each successive page of results. </p>
    ...
    pub fn list_jobs_by_pipeline(
        &self,
    ) -> crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder {
        crate::operation::list_jobs_by_pipeline::builders::ListJobsByPipelineFluentBuilder::new(
            self.handle.clone(),
        )
    }
}
