...
impl super::Client {
    ...
    ///   - [`topics(impl Into<String>)`](crate::operation::test_role::builders::TestRoleFluentBuilder::topics) / [`set_topics(Option<Vec<String>>)`](crate::operation::test_role::builders::TestRoleFluentBuilder::set_topics): <p>The ARNs of one or more Amazon Simple Notification Service (Amazon SNS) topics that you want the action to send a test notification to.</p>
