...
impl super::Client {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::read_pipeline::builders::ReadPipelineFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::read_pipeline::builders::ReadPipelineFluentBuilder::set_id): <p>The identifier of the pipeline to read.</p>
