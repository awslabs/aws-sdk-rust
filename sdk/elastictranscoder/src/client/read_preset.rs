...
impl super::Client {
    ...
    ///   - [`id(impl Into<String>)`](crate::operation::read_preset::builders::ReadPresetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::read_preset::builders::ReadPresetFluentBuilder::set_id):<br>required: **true**<br><p>The identifier of the preset for which you want to get detailed information.</p><br>
