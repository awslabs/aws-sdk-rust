...
impl super::Client {
    ...
    ///   - [`status(impl Into<String>)`](crate::operation::list_jobs_by_status::builders::ListJobsByStatusFluentBuilder::status) / [`set_status(Option<String>)`](crate::operation::list_jobs_by_status::builders::ListJobsByStatusFluentBuilder::set_status):<br>required: **true**<br><p>To get information about all of the jobs associated with the current AWS account that have a given status, specify the following status: <code>Submitted</code>, <code>Progressing</code>, <code>Complete</code>, <code>Canceled</code>, or <code>Error</code>.</p><br>
