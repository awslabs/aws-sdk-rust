...
impl super::Client {
    ...
    ///   - [`description(impl Into<String>)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::set_description):<br>required: **false**<br><p>A description of the preset.</p><br>
    ...
    ///   - [`video(VideoParameters)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::video) / [`set_video(Option<VideoParameters>)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::set_video):<br>required: **false**<br><p>A section of the request body that specifies the video parameters.</p><br>
    ///   - [`audio(AudioParameters)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::audio) / [`set_audio(Option<AudioParameters>)`](crate::operation::create_preset::builders::CreatePresetFluentBuilder::set_audio):<br>required: **false**<br><p>A section of the request body that specifies the audio parameters.</p><br>
