...
impl ListPresetsPaginatorItems {
    ...
    pub fn send(
        ...
        Item = ::std::result::Result<crate::types::Preset, ::aws_smithy_http::result::SdkError<crate::operation::list_presets::ListPresetsError>>,
    > + ::std::marker::Unpin {
        ::aws_smithy_async::future::fn_stream::TryFlatMap::new(self.0.send())
            .flat_map(|page| crate::lens::lens_list_presets_output_presets(page).unwrap_or_default().into_iter())
    }
}
