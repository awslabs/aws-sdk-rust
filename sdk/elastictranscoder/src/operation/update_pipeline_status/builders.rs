...
impl UpdatePipelineStatusFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::update_pipeline_status::UpdatePipelineStatusOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::update_pipeline_status::UpdatePipelineStatusError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::update_pipeline_status::UpdatePipelineStatusOutput, crate::operation::update_pipeline_status::UpdatePipelineStatusError, Self> {
