...
impl ListPresetsInput {
    ...
    > {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(
            request,
            crate::operation::list_presets::ListPresets::new(),
        )
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPresets {
    ...
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 200 {
            crate::protocol_serde::shape_list_presets::de_list_presets_http_error(
                status, headers, body,
            )
        } else {
            crate::protocol_serde::shape_list_presets::de_list_presets_http_response_with_props(
                status, headers, body,
            )
        }
    }
