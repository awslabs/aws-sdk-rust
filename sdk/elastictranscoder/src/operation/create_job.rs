...
impl CreateJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateJob`](crate::operation::create_job::CreateJob)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(
        ...
        ::aws_smithy_http::operation::Operation<crate::operation::create_job::CreateJob, ::aws_http::retry::AwsResponseRetryClassifier>,
    ...
    > {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(crate::protocol_serde::shape_create_job::ser_create_job_input(&self)?);
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_job::CreateJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateJob {
    type Output = ::std::result::Result<crate::operation::create_job::CreateJobOutput, crate::operation::create_job::CreateJobError>;
    fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
        ...
        if !success && status != 201 {
            ...
            crate::protocol_serde::shape_create_job::de_create_job_http_response_with_props(status, headers, body)
        }
    }
}
