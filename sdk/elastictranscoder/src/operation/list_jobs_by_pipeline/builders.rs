...
impl ListJobsByPipelineFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::list_jobs_by_pipeline::ListJobsByPipelineOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::list_jobs_by_pipeline::ListJobsByPipelineError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::list_jobs_by_pipeline::ListJobsByPipelineOutput, crate::operation::list_jobs_by_pipeline::ListJobsByPipelineError, Self> {
