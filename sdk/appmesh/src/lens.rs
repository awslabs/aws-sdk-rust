...
pub(crate) fn reflens_list_gateway_routes_output_output_next_token(
...
pub(crate) fn reflens_list_meshes_output_output_next_token(
...
pub(crate) fn reflens_list_routes_output_output_next_token(
...
pub(crate) fn reflens_list_virtual_gateways_output_output_next_token(
...
pub(crate) fn reflens_list_virtual_nodes_output_output_next_token(
...
pub(crate) fn reflens_list_virtual_routers_output_output_next_token(
...
pub(crate) fn reflens_list_virtual_services_output_output_next_token(
...
pub(crate) fn lens_list_gateway_routes_output_output_gateway_routes(
    input: crate::operation::list_gateway_routes::ListGatewayRoutesOutput,
...
pub(crate) fn lens_list_meshes_output_output_meshes(
    input: crate::operation::list_meshes::ListMeshesOutput,
...
pub(crate) fn lens_list_routes_output_output_routes(
    input: crate::operation::list_routes::ListRoutesOutput,
...
pub(crate) fn lens_list_virtual_gateways_output_output_virtual_gateways(
    input: crate::operation::list_virtual_gateways::ListVirtualGatewaysOutput,
...
pub(crate) fn lens_list_virtual_nodes_output_output_virtual_nodes(
    input: crate::operation::list_virtual_nodes::ListVirtualNodesOutput,
...
pub(crate) fn lens_list_virtual_routers_output_output_virtual_routers(
    input: crate::operation::list_virtual_routers::ListVirtualRoutersOutput,
...
pub(crate) fn lens_list_virtual_services_output_output_virtual_services(
    input: crate::operation::list_virtual_services::ListVirtualServicesOutput,
