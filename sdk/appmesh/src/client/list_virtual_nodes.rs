...
impl super::Client {
    ...
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::list_virtual_nodes::builders::ListVirtualNodesFluentBuilder::mesh_name) / [`set_mesh_name(Option<String>)`](crate::operation::list_virtual_nodes::builders::ListVirtualNodesFluentBuilder::set_mesh_name): <p>The name of the service mesh to list virtual nodes in.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_virtual_nodes::builders::ListVirtualNodesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_virtual_nodes::builders::ListVirtualNodesFluentBuilder::set_next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>ListVirtualNodes</code> request where <code>limit</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value.</p>
