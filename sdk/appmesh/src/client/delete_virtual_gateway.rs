...
impl super::Client {
    ...
    ///   - [`virtual_gateway_name(impl Into<String>)`](crate::operation::delete_virtual_gateway::builders::DeleteVirtualGatewayFluentBuilder::virtual_gateway_name) / [`set_virtual_gateway_name(impl Into<String>)`](crate::operation::delete_virtual_gateway::builders::DeleteVirtualGatewayFluentBuilder::set_virtual_gateway_name):<br>required: **true**<br><p>The name of the virtual gateway to delete.</p><br>
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::delete_virtual_gateway::builders::DeleteVirtualGatewayFluentBuilder::mesh_name) / [`set_mesh_name(impl Into<String>)`](crate::operation::delete_virtual_gateway::builders::DeleteVirtualGatewayFluentBuilder::set_mesh_name):<br>required: **true**<br><p>The name of the service mesh to delete the virtual gateway from.</p><br>
