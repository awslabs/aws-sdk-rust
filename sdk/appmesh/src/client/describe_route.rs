...
impl super::Client {
    ...
    ///   - [`route_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::route_name) / [`set_route_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::set_route_name):<br>required: **true**<br><p>The name of the route to describe.</p><br>
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::mesh_name) / [`set_mesh_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::set_mesh_name):<br>required: **true**<br><p>The name of the service mesh that the route resides in.</p><br>
    ...
    ///   - [`virtual_router_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::virtual_router_name) / [`set_virtual_router_name(impl Into<String>)`](crate::operation::describe_route::builders::DescribeRouteFluentBuilder::set_virtual_router_name):<br>required: **true**<br><p>The name of the virtual router that the route is associated with.</p><br>
