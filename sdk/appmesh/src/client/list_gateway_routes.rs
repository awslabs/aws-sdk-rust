...
impl super::Client {
    ...
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::mesh_name) / [`set_mesh_name(Option<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::set_mesh_name): <p>The name of the service mesh to list gateway routes in.</p>
    ///   - [`virtual_gateway_name(impl Into<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::virtual_gateway_name) / [`set_virtual_gateway_name(Option<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::set_virtual_gateway_name): <p>The name of the virtual gateway to list gateway routes in.</p>
    ///   - [`next_token(impl Into<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_gateway_routes::builders::ListGatewayRoutesFluentBuilder::set_next_token): <p>The <code>nextToken</code> value returned from a previous paginated <code>ListGatewayRoutes</code> request where <code>limit</code> was used and the results exceeded the value of that parameter. Pagination continues from the end of the previous results that returned the <code>nextToken</code> value.</p>
