...
impl super::Client {
    ...
    ///   - [`virtual_service_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::virtual_service_name) / [`set_virtual_service_name(Option<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::set_virtual_service_name):<br>required: **true**<br><p>The name of the virtual service to delete.</p><br>
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::mesh_name) / [`set_mesh_name(Option<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::set_mesh_name):<br>required: **true**<br><p>The name of the service mesh to delete the virtual service in.</p><br>
