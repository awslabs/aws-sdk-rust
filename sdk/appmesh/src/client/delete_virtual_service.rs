...
impl super::Client {
    ...
    ///   - [`virtual_service_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::virtual_service_name) / [`set_virtual_service_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::set_virtual_service_name):<br>required: **true**<br><p>The name of the virtual service to delete.</p><br>
    ///   - [`mesh_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::mesh_name) / [`set_mesh_name(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::set_mesh_name):<br>required: **true**<br><p>The name of the service mesh to delete the virtual service in.</p><br>
    ///   - [`mesh_owner(impl Into<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::mesh_owner) / [`set_mesh_owner(Option<String>)`](crate::operation::delete_virtual_service::builders::DeleteVirtualServiceFluentBuilder::set_mesh_owner):<br>required: **false**<br><p>The Amazon Web Services IAM account ID of the service mesh owner. If the account ID is not your own, then it's the ID of the account that shared the mesh with your account. For more information about mesh sharing, see <a href="https://docs.aws.amazon.com/app-mesh/latest/userguide/sharing.html">Working with shared meshes</a>.</p><br>
