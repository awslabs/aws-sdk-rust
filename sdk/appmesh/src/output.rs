...
pub struct ListMeshesOutput  {
    ...
    #[doc(hidden)]pub meshes: std::option::Option<std::vec::Vec<crate::model::MeshRef>>,
...
pub struct CreateMeshOutput  {
    ...
    #[doc(hidden)]pub mesh: std::option::Option<crate::model::MeshData>,
}
...
pub struct ListVirtualServicesOutput  {
    ...
    #[doc(hidden)]pub virtual_services: std::option::Option<std::vec::Vec<crate::model::VirtualServiceRef>>,
...
pub struct CreateVirtualServiceOutput  {
    ...
    #[doc(hidden)]pub virtual_service: std::option::Option<crate::model::VirtualServiceData>,
}
...
pub struct ListVirtualRoutersOutput  {
    ...
    #[doc(hidden)]pub virtual_routers: std::option::Option<std::vec::Vec<crate::model::VirtualRouterRef>>,
...
pub struct CreateVirtualRouterOutput  {
    ...
    #[doc(hidden)]pub virtual_router: std::option::Option<crate::model::VirtualRouterData>,
}
...
pub struct ListRoutesOutput  {
    ...
    #[doc(hidden)]pub routes: std::option::Option<std::vec::Vec<crate::model::RouteRef>>,
...
pub struct CreateRouteOutput  {
    ...
    #[doc(hidden)]pub route: std::option::Option<crate::model::RouteData>,
}
...
pub struct ListVirtualNodesOutput  {
    ...
    #[doc(hidden)]pub virtual_nodes: std::option::Option<std::vec::Vec<crate::model::VirtualNodeRef>>,
...
pub struct CreateVirtualNodeOutput  {
    ...
    #[doc(hidden)]pub virtual_node: std::option::Option<crate::model::VirtualNodeData>,
}
...
pub struct ListVirtualGatewaysOutput  {
    ...
    #[doc(hidden)]pub virtual_gateways: std::option::Option<std::vec::Vec<crate::model::VirtualGatewayRef>>,
...
pub struct CreateVirtualGatewayOutput  {
    ...
    #[doc(hidden)]pub virtual_gateway: std::option::Option<crate::model::VirtualGatewayData>,
}
...
pub struct ListGatewayRoutesOutput  {
    ...
    #[doc(hidden)]pub gateway_routes: std::option::Option<std::vec::Vec<crate::model::GatewayRouteRef>>,
...
pub struct CreateGatewayRouteOutput  {
    ...
    #[doc(hidden)]pub gateway_route: std::option::Option<crate::model::GatewayRouteData>,
}
