...
impl ServiceDiscovery {
    ...
    pub fn as_aws_cloud_map(&self) -> ::std::result::Result<&crate::types::AwsCloudMapServiceDiscovery, &Self> {
        if let ServiceDiscovery::AwsCloudMap(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_dns(&self) -> ::std::result::Result<&crate::types::DnsServiceDiscovery, &Self> {
        if let ServiceDiscovery::Dns(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
