...
impl VirtualGatewayListenerTlsSdsCertificateBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::types::VirtualGatewayListenerTlsSdsCertificate, ::aws_smithy_types::error::operation::BuildError> {
        ::std::result::Result::Ok(
            crate::types::VirtualGatewayListenerTlsSdsCertificate {
                secret_name: self.secret_name
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("secret_name", "secret_name was not specified but it is required when building VirtualGatewayListenerTlsSdsCertificate")
                    )?
                ,
            }
        )
