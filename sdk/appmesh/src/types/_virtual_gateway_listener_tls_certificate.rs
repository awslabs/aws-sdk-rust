...
impl VirtualGatewayListenerTlsCertificate {
    ...
    pub fn as_acm(&self) -> ::std::result::Result<&crate::types::VirtualGatewayListenerTlsAcmCertificate, &Self> {
        if let VirtualGatewayListenerTlsCertificate::Acm(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_file(&self) -> ::std::result::Result<&crate::types::VirtualGatewayListenerTlsFileCertificate, &Self> {
        if let VirtualGatewayListenerTlsCertificate::File(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
    ...
    pub fn as_sds(&self) -> ::std::result::Result<&crate::types::VirtualGatewayListenerTlsSdsCertificate, &Self> {
        if let VirtualGatewayListenerTlsCertificate::Sds(val) = &self { ::std::result::Result::Ok(val) } else { ::std::result::Result::Err(self) }
    }
