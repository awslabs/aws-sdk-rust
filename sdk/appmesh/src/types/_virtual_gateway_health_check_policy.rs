        ...
        ::std::result::Result::Ok(
            crate::types::VirtualGatewayHealthCheckPolicy {
                timeout_millis: self.timeout_millis
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("timeout_millis", "timeout_millis was not specified but it is required when building VirtualGatewayHealthCheckPolicy")
                    )?
                ,
                interval_millis: self.interval_millis
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("interval_millis", "interval_millis was not specified but it is required when building VirtualGatewayHealthCheckPolicy")
                    )?
                ,
                protocol: self.protocol
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("protocol", "protocol was not specified but it is required when building VirtualGatewayHealthCheckPolicy")
                    )?
                ,
                port: self.port
                ,
                ...
                healthy_threshold: self.healthy_threshold
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("healthy_threshold", "healthy_threshold was not specified but it is required when building VirtualGatewayHealthCheckPolicy")
                    )?
                ,
                unhealthy_threshold: self.unhealthy_threshold
                    .ok_or_else(||
                        ::aws_smithy_types::error::operation::BuildError::missing_field("unhealthy_threshold", "unhealthy_threshold was not specified but it is required when building VirtualGatewayHealthCheckPolicy")
                    )?
                ,
            }
        )
