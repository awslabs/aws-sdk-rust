...
pub fn ser_create_virtual_node_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::operation::create_virtual_node::CreateVirtualNodeInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
