...
pub fn ser_service_discovery(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ServiceDiscovery) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ServiceDiscovery::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ServiceDiscovery"))
    }
    Ok(())
}
