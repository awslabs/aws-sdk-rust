...
pub fn ser_service_discovery(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ServiceDiscovery) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_service_discovery<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ServiceDiscovery>, aws_smithy_json::deserialize::error::DeserializeError>
