...
pub fn ser_mesh_spec(
    ...
    if let Some(var_3) = &input.service_discovery {
        ...
        crate::protocol_serde::shape_mesh_service_discovery::ser_mesh_service_discovery(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
) -> Result<Option<crate::types::MeshSpec>, aws_smithy_json::deserialize::error::DeserializeError>
where
    I: Iterator<
        Item = Result<
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "egressFilter" => {
                                builder = builder.set_egress_filter(
                                    crate::protocol_serde::shape_egress_filter::de_egress_filter(
                                        tokens,
                                    )?,
                                );
                            }
