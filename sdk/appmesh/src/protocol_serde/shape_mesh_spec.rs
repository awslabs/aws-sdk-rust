...
pub fn ser_mesh_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::MeshSpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_mesh_spec<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::MeshSpec>, aws_smithy_json::deserialize::error::DeserializeError>
