...
pub fn ser_header_match_method(object_4: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HeaderMatchMethod) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_header_match_method<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HeaderMatchMethod>, aws_smithy_json::deserialize::error::DeserializeError>
