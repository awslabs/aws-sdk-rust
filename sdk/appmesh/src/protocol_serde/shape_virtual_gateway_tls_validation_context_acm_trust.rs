...
pub(crate) fn de_virtual_gateway_tls_validation_context_acm_trust<'a, I>(
    ...
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::VirtualGatewayTlsValidationContextAcmTrust>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        "certificateAuthorityArns" => {
                            builder = builder.set_certificate_authority_arns(
                                    crate::protocol_serde::shape_virtual_gateway_certificate_authority_arns::de_virtual_gateway_certificate_authority_arns(tokens, _value, depth + 1)?
                                );
                        }
