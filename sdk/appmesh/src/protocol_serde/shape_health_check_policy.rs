...
) -> ::std::result::Result<Option<crate::types::HealthCheckPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                        ...
                        "protocol" => {
                            builder = builder.set_protocol(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::PortProtocol::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "port" => {
