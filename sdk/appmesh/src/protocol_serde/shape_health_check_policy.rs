...
pub fn ser_health_check_policy(
     ...
     {
        object.key("timeoutMillis").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.timeout_millis).into()));
    }
     {
        object.key("intervalMillis").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((input.interval_millis).into()));
    }
     {
...
pub(crate) fn de_health_check_policy<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::HealthCheckPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
    ...
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
            ...
            Ok(Some(crate::serde_util::health_check_policy_correct_errors(builder).build().map_err(|err|::aws_smithy_json::deserialize::error::DeserializeError::custom_source("Response was invalid", err))?))
        }
        _ => {
