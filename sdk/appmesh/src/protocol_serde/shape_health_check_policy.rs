...
pub fn ser_health_check_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HealthCheckPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_health_check_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HealthCheckPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
