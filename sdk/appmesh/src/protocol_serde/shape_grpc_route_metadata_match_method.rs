...
pub fn ser_grpc_route_metadata_match_method(object_4: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GrpcRouteMetadataMatchMethod) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_grpc_route_metadata_match_method<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GrpcRouteMetadataMatchMethod>, aws_smithy_json::deserialize::error::DeserializeError>
