...
pub fn ser_client_policy_tls(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ClientPolicyTls) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_client_policy_tls<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ClientPolicyTls>, aws_smithy_json::deserialize::error::DeserializeError>
