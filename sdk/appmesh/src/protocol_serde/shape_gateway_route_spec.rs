...
pub fn ser_gateway_route_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GatewayRouteSpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
