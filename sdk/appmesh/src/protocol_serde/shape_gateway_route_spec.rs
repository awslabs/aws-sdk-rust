...
pub fn ser_gateway_route_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::GatewayRouteSpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_gateway_route_spec<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::GatewayRouteSpec>, aws_smithy_json::deserialize::error::DeserializeError>
