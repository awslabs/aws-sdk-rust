...
pub fn ser_http_retry_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::HttpRetryPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_http_retry_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::HttpRetryPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
