...
) -> ::std::result::Result<Option<crate::types::GrpcGatewayRouteMetadata>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "match" => {
                            builder = builder.set_match(crate::protocol_serde::shape_grpc_metadata_match_method::de_grpc_metadata_match_method(
                                tokens,
                            )?);
                        }
