            ...
            loop {
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "tls" => {
                            builder = builder.set_tls(crate::protocol_serde::shape_listener_tls::de_listener_tls(tokens, _value, depth + 1)?);
                        }
                        "healthCheck" => {
                            builder = builder.set_health_check(crate::protocol_serde::shape_health_check_policy::de_health_check_policy(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "timeout" => {
                            builder = builder.set_timeout(crate::protocol_serde::shape_listener_timeout::de_listener_timeout(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "outlierDetection" => {
                            builder = builder.set_outlier_detection(crate::protocol_serde::shape_outlier_detection::de_outlier_detection(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
                        ...
                        "connectionPool" => {
                            builder = builder.set_connection_pool(
                                crate::protocol_serde::shape_virtual_node_connection_pool::de_virtual_node_connection_pool(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?,
