...
pub fn ser_listener(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Listener) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
