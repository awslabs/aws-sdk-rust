...
pub fn ser_access_log(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AccessLog) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
