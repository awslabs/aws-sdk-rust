...
pub(crate) fn de_access_log<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::AccessLog>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "file" => Some(crate::types::AccessLog::File(
                            crate::protocol_serde::shape_file_access_log::de_file_access_log(tokens, _value, depth + 1)?
