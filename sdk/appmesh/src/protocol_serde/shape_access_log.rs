...
pub fn ser_access_log(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::AccessLog) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_access_log<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::AccessLog>, aws_smithy_json::deserialize::error::DeserializeError>
