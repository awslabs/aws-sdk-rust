...
pub fn ser_grpc_retry_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GrpcRetryPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_grpc_retry_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::GrpcRetryPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
