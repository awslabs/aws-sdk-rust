...
pub fn ser_listener_timeout(object_8: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ListenerTimeout) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ListenerTimeout::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ListenerTimeout"))
    }
    Ok(())
}
