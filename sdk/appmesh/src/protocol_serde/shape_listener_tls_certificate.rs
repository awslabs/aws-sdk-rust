...
pub fn ser_listener_tls_certificate(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ListenerTlsCertificate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::ListenerTlsCertificate::Unknown => return Err(aws_smithy_http::operation::error::SerializationError::unknown_variant("ListenerTlsCertificate"))
    }
    Ok(())
}
