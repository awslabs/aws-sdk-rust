...
pub fn ser_listener_tls_certificate(object_2: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ListenerTlsCertificate) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
        ...
        crate::types::ListenerTlsCertificate::Unknown => return Err(::aws_smithy_types::error::operation::SerializationError::unknown_variant("ListenerTlsCertificate"))
    }
    Ok(())
}

pub(crate) fn de_listener_tls_certificate<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ListenerTlsCertificate>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        variant = match key.as_ref() {
                            "acm" => {
                                Some(crate::types::ListenerTlsCertificate::Acm(
                            ...
                            "file" => {
                                Some(crate::types::ListenerTlsCertificate::File(
                            ...
                            "sds" => {
                                Some(crate::types::ListenerTlsCertificate::Sds(
