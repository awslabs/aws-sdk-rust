...
pub fn ser_listener_tls_certificate(object_3: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::ListenerTlsCertificate) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_listener_tls_certificate<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::ListenerTlsCertificate>, aws_smithy_json::deserialize::error::DeserializeError>
