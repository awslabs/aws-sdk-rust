...
pub fn ser_create_mesh_input(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::input::CreateMeshInput) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
