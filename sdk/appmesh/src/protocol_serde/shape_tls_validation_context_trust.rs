...
pub fn ser_tls_validation_context_trust(object_2: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::TlsValidationContextTrust) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_tls_validation_context_trust<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::TlsValidationContextTrust>, aws_smithy_json::deserialize::error::DeserializeError>
