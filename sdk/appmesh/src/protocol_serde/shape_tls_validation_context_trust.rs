...
pub(crate) fn de_tls_validation_context_trust<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
) -> ::std::result::Result<Option<crate::types::TlsValidationContextTrust>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "acm" => Some(crate::types::TlsValidationContextTrust::Acm(
                            crate::protocol_serde::shape_tls_validation_context_acm_trust::de_tls_validation_context_acm_trust(tokens, _value)?
                                .ok_or_else(|| ::aws_smithy_json::deserialize::error::DeserializeError::custom("value for 'acm' cannot be null"))?,
                        )),
                        "file" => Some(crate::types::TlsValidationContextTrust::File(
                        ...
                        "sds" => Some(crate::types::TlsValidationContextTrust::Sds(
