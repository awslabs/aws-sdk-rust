...
pub fn ser_outlier_detection(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::OutlierDetection) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_outlier_detection<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::OutlierDetection>, aws_smithy_json::deserialize::error::DeserializeError>
