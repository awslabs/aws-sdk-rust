...
pub fn ser_grpc_gateway_route(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::GrpcGatewayRoute) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
