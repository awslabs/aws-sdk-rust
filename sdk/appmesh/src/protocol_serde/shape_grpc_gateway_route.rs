...
pub fn ser_grpc_gateway_route(
    ...
    if let Some(var_1) = &input.r#match {
        ...
        crate::protocol_serde::shape_grpc_gateway_route_match::ser_grpc_gateway_route_match(
            &mut object_2,
            var_1,
        )?;
        object_2.finish();
    ...
    if let Some(var_3) = &input.action {
        ...
        crate::protocol_serde::shape_grpc_gateway_route_action::ser_grpc_gateway_route_action(
            &mut object_4,
            var_3,
        )?;
        object_4.finish();
...
pub(crate) fn de_grpc_gateway_route<'a, I>(
    ...
    Option<crate::types::GrpcGatewayRoute>,
