...
pub fn ser_virtual_gateway_client_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::VirtualGatewayClientPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_virtual_gateway_client_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::types::VirtualGatewayClientPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
