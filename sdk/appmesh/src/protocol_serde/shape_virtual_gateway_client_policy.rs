...
pub fn ser_virtual_gateway_client_policy(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VirtualGatewayClientPolicy) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_virtual_gateway_client_policy<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VirtualGatewayClientPolicy>, aws_smithy_json::deserialize::error::DeserializeError>
