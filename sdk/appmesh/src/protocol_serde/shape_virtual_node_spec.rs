...
pub fn ser_virtual_node_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VirtualNodeSpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_virtual_node_spec<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VirtualNodeSpec>, aws_smithy_json::deserialize::error::DeserializeError>
