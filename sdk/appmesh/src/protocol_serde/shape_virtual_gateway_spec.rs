...
pub fn ser_virtual_gateway_spec(object: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::VirtualGatewaySpec) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
...
pub(crate) fn de_virtual_gateway_spec<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::VirtualGatewaySpec>, aws_smithy_json::deserialize::error::DeserializeError>
