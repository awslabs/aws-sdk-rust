                        ...
                        match key.to_unescaped()?.as_ref() {
                            "backendDefaults" => {
                                builder = builder.set_backend_defaults(
                                    crate::protocol_serde::shape_virtual_gateway_backend_defaults::de_virtual_gateway_backend_defaults(
                                        tokens,
                                        _value,
                                        depth + 1,
                                    )?,
                            ...
                            "listeners" => {
                                builder = builder.set_listeners(
                                    crate::protocol_serde::shape_virtual_gateway_listeners::de_virtual_gateway_listeners(tokens, _value, depth + 1)?,
                                );
                            }
                            "logging" => {
