...
) -> Result<Option<crate::types::HttpRouteMatch>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "scheme" => {
                            builder = builder.set_scheme(
                                ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?
                                    .map(|s| s.to_unescaped().map(|u| crate::types::HttpScheme::from(u.as_ref())))
                                    .transpose()?,
                            );
                        }
                        "headers" => {
