...
pub fn ser_backend(object_10: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::Backend) -> Result<(), ::aws_smithy_types::error::operation::SerializationError> {
    match input {
