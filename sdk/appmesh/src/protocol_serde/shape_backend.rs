...
pub fn ser_backend(object_10: &mut aws_smithy_json::serialize::JsonObjectWriter, input: &crate::model::Backend) -> Result<(), aws_smithy_http::operation::error::SerializationError> {
    match input {
...
pub(crate) fn de_backend<'a, I>(tokens: &mut std::iter::Peekable<I>) -> Result<Option<crate::model::Backend>, aws_smithy_json::deserialize::error::DeserializeError>
