...
impl DescribeVirtualGatewayInputBuilder {
    ...
    /// - [`virtual_gateway_name`](crate::operation::describe_virtual_gateway::builders::DescribeVirtualGatewayInputBuilder::virtual_gateway_name)
    /// - [`mesh_name`](crate::operation::describe_virtual_gateway::builders::DescribeVirtualGatewayInputBuilder::mesh_name)
    pub fn build(
        self,
        ...
        ::std::result::Result::Ok(crate::operation::describe_virtual_gateway::DescribeVirtualGatewayInput {
            virtual_gateway_name: self.virtual_gateway_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    ...
                    "virtual_gateway_name was not specified but it is required when building DescribeVirtualGatewayInput",
                )
            })?,
            mesh_name: self.mesh_name.ok_or_else(|| {
                ::aws_smithy_http::operation::error::BuildError::missing_field(
                    "mesh_name",
                    "mesh_name was not specified but it is required when building DescribeVirtualGatewayInput",
                )
            })?,
