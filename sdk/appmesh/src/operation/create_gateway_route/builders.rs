...
impl CreateGatewayRouteFluentBuilder {
    ...
    /// Sends the request and returns the response.
                    ...
                    pub async fn send(self) -> ::std::result::Result<crate::operation::create_gateway_route::CreateGatewayRouteOutput, ::aws_smithy_runtime_api::client::result::SdkError<crate::operation::create_gateway_route::CreateGatewayRouteError, ::aws_smithy_runtime_api::client::orchestrator::HttpResponse>> {
                    ...
                    pub fn customize(
                        self,
                    ) -> crate::client::customize::CustomizableOperation<crate::operation::create_gateway_route::CreateGatewayRouteOutput, crate::operation::create_gateway_route::CreateGatewayRouteError, Self> {
