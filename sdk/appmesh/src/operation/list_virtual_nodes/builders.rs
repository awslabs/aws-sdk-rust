...
impl ListVirtualNodesFluentBuilder {
    ...
    pub fn as_input(
        &self,
    ) -> &crate::operation::list_virtual_nodes::builders::ListVirtualNodesInputBuilder {
        &self.inner
    }
    ...
    pub fn into_paginator(
        self,
    ) -> crate::operation::list_virtual_nodes::paginator::ListVirtualNodesPaginator {
        crate::operation::list_virtual_nodes::paginator::ListVirtualNodesPaginator::new(
            self.handle,
            self.inner,
        )
    }
