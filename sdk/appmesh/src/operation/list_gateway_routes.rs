...
impl ListGatewayRoutesInput {
    /// Consumes the builder and constructs an Operation<[`ListGatewayRoutes`](crate::operation::list_gateway_routes::ListGatewayRoutes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> std::result::Result<aws_smithy_http::operation::Operation<crate::operation::list_gateway_routes::ListGatewayRoutes, aws_http::retry::AwsResponseRetryClassifier>, aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_gateway_routes::ListGatewayRoutesInput, output: &mut String) -> std::result::Result<(), aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_gateway_routes::ListGatewayRoutesInput, mut output: &mut String) -> Result<(), aws_smithy_http::operation::error::BuildError> {
                ...
                if let Some(inner_5) = &_input.mesh_owner {
                     {
        ...
        let op = aws_smithy_http::operation::Operation::new(request, crate::operation::list_gateway_routes::ListGatewayRoutes::new())
...
impl aws_smithy_http::response::ParseStrictResponse for ListGatewayRoutes {
                type Output = std::result::Result<crate::operation::list_gateway_routes::ListGatewayRoutesOutput, crate::operation::list_gateway_routes::ListGatewayRoutesError>;
